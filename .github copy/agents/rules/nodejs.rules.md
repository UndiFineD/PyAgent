---
agent: "nodejs"
description: "Fallback rules and operational constraints for the nodejs agent."
---

# Base Rules: nodejs

These rules act as a resilient fallback for the `@nodejs` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@nodejs`. 
