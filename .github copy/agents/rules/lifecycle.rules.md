---
agent: "lifecycle"
description: "Fallback rules and operational constraints for the lifecycle agent."
---

# Base Rules: lifecycle

These rules act as a resilient fallback for the `@lifecycle` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@lifecycle`. 
