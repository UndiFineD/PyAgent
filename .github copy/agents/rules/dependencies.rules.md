---
agent: "dependencies"
description: "Fallback rules and operational constraints for the dependencies agent."
---

# Base Rules: dependencies

These rules act as a resilient fallback for the `@dependencies` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@dependencies`. 
