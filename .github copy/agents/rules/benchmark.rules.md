---
agent: "benchmark"
description: "Fallback rules and operational constraints for the benchmark agent."
---

# Base Rules: benchmark

These rules act as a resilient fallback for the `@benchmark` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@benchmark`. 
