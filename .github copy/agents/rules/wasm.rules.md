---
agent: "wasm"
description: "Fallback rules and operational constraints for the wasm agent."
---

# Base Rules: wasm

These rules act as a resilient fallback for the `@wasm` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@wasm`. 
