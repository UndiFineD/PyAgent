...
description: "Fallback rules and operational constraints for the circuit_breaker agent."
---

# Base Rules: circuit_breaker

These rules act as a resilient fallback for the `@circuit_breaker` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@circuit_breaker`. 
