---
agent: "teacher"
description: "Fallback rules and operational constraints for the teacher agent."
---

# Base Rules: teacher

These rules act as a resilient fallback for the `@teacher` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@teacher`. 
