---
agent: "ssh"
description: "Fallback rules and operational constraints for the ssh agent."
---

# Base Rules: ssh

These rules act as a resilient fallback for the `@ssh` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@ssh`. 
