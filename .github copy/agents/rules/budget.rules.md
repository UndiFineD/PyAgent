---
agent: "budget"
description: "Fallback rules and operational constraints for the budget agent."
---

# Base Rules: budget

These rules act as a resilient fallback for the `@budget` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@budget`. 
