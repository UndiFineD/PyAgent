---
agent: "architecture"
description: "Fallback rules and operational constraints for the architecture agent."
---

# Base Rules: architecture

These rules act as a resilient fallback for the `@architecture` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@architecture`. 
