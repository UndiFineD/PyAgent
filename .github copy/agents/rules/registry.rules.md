---
agent: "registry"
description: "Fallback rules and operational constraints for the registry agent."
---

# Base Rules: registry

These rules act as a resilient fallback for the `@registry` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@registry`. 
