---
agent: "failure_recovery"
description: "Fallback rules and operational constraints for the failure_recovery agent."
---

# Base Rules: failure_recovery

These rules act as a resilient fallback for the `@failure_recovery` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@failure_recovery`. 
