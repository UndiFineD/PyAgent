---
agent: "plugin"
description: "Fallback rules and operational constraints for the plugin agent."
---

# Base Rules: plugin

These rules act as a resilient fallback for the `@plugin` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@plugin`. 
