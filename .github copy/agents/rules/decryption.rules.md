---
agent: "decryption"
description: "Fallback rules and operational constraints for the decryption agent."
---

# Base Rules: decryption

These rules act as a resilient fallback for the `@decryption` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@decryption`. 
