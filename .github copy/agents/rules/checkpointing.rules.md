---
agent: "checkpointing"
description: "Fallback rules and operational constraints for the checkpointing agent."
---

# Base Rules: checkpointing

These rules act as a resilient fallback for the `@checkpointing` agent.
...
4. **Scope Strictness**:
    Do not perform tasks outside the explicit capabilities of `@checkpointing`.
