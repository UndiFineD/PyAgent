---
agent: "todolist"
description: "Fallback rules and operational constraints for the todolist agent."
---

# Base Rules: todolist

These rules act as a resilient fallback for the `@todolist` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@todolist`. 
