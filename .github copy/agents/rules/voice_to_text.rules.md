---
agent: "voice_to_text"
description: "Fallback rules and operational constraints for the voice_to_text agent."
---

# Base Rules: voice_to_text

These rules act as a resilient fallback for the `@voice_to_text` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@voice_to_text`. 
