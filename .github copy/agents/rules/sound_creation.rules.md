---
agent: "sound_creation"
description: "Fallback rules and operational constraints for the sound_creation agent."
---

# Base Rules: sound_creation

These rules act as a resilient fallback for the `@sound_creation` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@sound_creation`. 
