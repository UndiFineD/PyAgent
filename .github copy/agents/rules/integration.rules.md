---
agent: "integration"
description: "Fallback rules and operational constraints for the integration agent."
---

# Base Rules: integration

These rules act as a resilient fallback for the `@integration` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@integration`. 
