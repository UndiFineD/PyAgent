---
agent: "deduplication"
description: "Fallback rules and operational constraints for the deduplication agent."
---

# Base Rules: deduplication

These rules act as a resilient fallback for the `@deduplication` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@deduplication`. 
