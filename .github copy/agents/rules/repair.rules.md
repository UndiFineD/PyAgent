---
agent: "repair"
description: "Fallback rules and operational constraints for the repair agent."
---

# Base Rules: repair

These rules act as a resilient fallback for the `@repair` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@repair`. 
