---
agent: "precommit"
description: "Fallback rules and operational constraints for the precommit agent."
---

# Base Rules: precommit

These rules act as a resilient fallback for the `@precommit` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@precommit`. 
