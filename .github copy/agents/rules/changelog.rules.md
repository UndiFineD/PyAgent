---
agent: "changelog"
description: "Fallback rules and operational constraints for the changelog agent."
---

# Base Rules: changelog

These rules act as a resilient fallback for the `@changelog` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@changelog`. 
