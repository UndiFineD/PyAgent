---
agent: "html5"
description: "Fallback rules and operational constraints for the html5 agent."
---

# Base Rules: html5

These rules act as a resilient fallback for the `@html5` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@html5`. 
