---
agent: "logging"
description: "Fallback rules and operational constraints for the logging agent."
---

# Base Rules: logging

These rules act as a resilient fallback for the `@logging` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@logging`. 
