---
agent: "mixin"
description: "Fallback rules and operational constraints for the mixin agent."
---

# Base Rules: mixin

These rules act as a resilient fallback for the `@mixin` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@mixin`. 
