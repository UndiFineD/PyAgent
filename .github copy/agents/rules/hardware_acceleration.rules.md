---
agent: "hardware_acceleration"
description: "Fallback rules and operational constraints for the hardware_acceleration agent."
---

# Base Rules: hardware_acceleration

These rules act as a resilient fallback for the `@hardware_acceleration` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@hardware_acceleration`. 
