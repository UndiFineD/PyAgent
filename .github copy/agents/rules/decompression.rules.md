---
agent: "decompression"
description: "Fallback rules and operational constraints for the decompression agent."
---

# Base Rules: decompression

These rules act as a resilient fallback for the `@decompression` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@decompression`. 
