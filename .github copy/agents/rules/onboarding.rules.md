---
agent: "onboarding"
description: "Fallback rules and operational constraints for the onboarding agent."
---

# Base Rules: onboarding

These rules act as a resilient fallback for the `@onboarding` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@onboarding`. 
