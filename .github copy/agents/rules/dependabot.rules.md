---
agent: "dependabot"
description: "Fallback rules and operational constraints for the dependabot agent."
---

# Base Rules: dependabot

These rules act as a resilient fallback for the `@dependabot` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@dependabot`. 
