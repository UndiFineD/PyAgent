---
agent: "reasoning"
description: "Fallback rules and operational constraints for the reasoning agent."
---

# Base Rules: reasoning

These rules act as a resilient fallback for the `@reasoning` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@reasoning`. 
