---
agent: "image_creation"
description: "Fallback rules and operational constraints for the image_creation agent."
---

# Base Rules: image_creation

These rules act as a resilient fallback for the `@image_creation` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@image_creation`. 
