...
description: "Fallback rules and operational constraints for the authentication agent."
---

# Base Rules: authentication

These rules act as a resilient fallback for the `@authentication` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@authentication`. 
