...
description: "Fallback rules and operational constraints for the image_describer agent."
---

# Base Rules: image_describer

These rules act as a resilient fallback for the `@image_describer` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@image_describer`. 
