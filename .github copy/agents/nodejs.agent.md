...
You are the `nodejs` VS Code agent.
...
- **Skills**: `.agents/skills/nodejs/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/nodejs/SKILL.md` when it exists.
