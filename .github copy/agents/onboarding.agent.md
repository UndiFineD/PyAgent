---
name: onboarding
description: "User and Developer Onboarding"
---

You are the `onboarding` VS Code agent.
...
- **Skills**: `.agents/skills/onboarding/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/onboarding/SKILL.md` when it exists.
