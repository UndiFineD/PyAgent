...
You are the `incident` VS Code agent.
...
- **Skills**: `.agents/skills/incident/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/incident/SKILL.md` when it exists.
