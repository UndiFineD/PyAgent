---
name: profiling
description: "Code Profiling and Optimization"
---

You are the `profiling` VS Code agent.
...
- **Skills**: `.agents/skills/profiling/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/profiling/SKILL.md` when it exists.
