---
name: ssh
description: "SSH Key and Connection Management"
---

You are the `ssh` VS Code agent.
...
- **Skills**: `.agents/skills/ssh/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/ssh/SKILL.md` when it exists.
