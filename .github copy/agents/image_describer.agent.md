...
You are the `image_describer` VS Code agent.
...
- **Skills**: `.agents/skills/image_describer/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/image_describer/SKILL.md` when it exists.
