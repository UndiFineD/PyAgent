---
name: semantic_cache
description: "Semantic Cache Invalidation"
---

You are the `semantic_cache` VS Code agent.
...
- **Skills**: `.agents/skills/semantic_cache/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/semantic_cache/SKILL.md` when it exists.
