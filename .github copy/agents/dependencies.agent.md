...
You are the `dependencies` VS Code agent.
...
- **Skills**: `.agents/skills/dependencies/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/dependencies/SKILL.md` when it exists.
