...
from src.classes.specialized.InfrastructureRepairAgent import InfrastructureRepairAgent


def test_evolution_and_repair():
    ...
    repair_agent = InfrastructureRepairAgent(str(root / "src/classes/specialized/InfrastructureRepairAgent.py"))
