...
def main():
    ...
    privacy_files = ["src/classes/fleet/FleetManager.py", "requirements.txt"]
    ...
    security_findings = fleet.security_audit_agent.scan_file(os.path.join(root, "src/classes/fleet/FleetManager.py"))
    ...
    quality_res = fleet.code_quality_agent.analyze_file_quality(os.path.join(root, "src/classes/fleet/FleetManager.py"))
