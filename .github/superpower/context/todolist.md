# PyAgent Project List (Non-Source Items)
...
- Create project root structure with necessary directories (`/`, `src/`, `tests/`, `.github/`)
- Implement project configuration files (`pyproject.toml`, `.gitignore`, `pytest.ini`)
- Set up basic project scaffolding including main module and entry points (`src/__init__.py` etc.)

## Documentation & Assets

*(see design/documentation_assets.md for full plan)*

- Create comprehensive project documentation (`README.md`, `CONTRIBUTING.md`)
- Develop API documentation for all components
- Create project architecture diagrams
- Generate project setup and installation guide (`docs/installation/`)
- Write developer onboarding documentation (`docs/onboarding.md`)
- Create release notes template (`docs/release_notes_template.md`)
- Develop contribution guidelines (`CONTRIBUTING.md`, `.github/` templates)

## Testing Infrastructure

*(see design/testing_infrastructure.md for full plan)*

- Implement test suite structure with test directories (`tests/`, `tests/tools/`, `tests/structure/`)
- Create test configuration files (`pytest.ini`, `conftest.py`)
- Set up test environment with required dependencies (`requirements-ci.txt`, `.venv`)
- Develop test data generation scripts (`scripts/generate_test_data.py`)
- Create test coverage configuration
- Implement CI/CD pipeline configuration (`.github/workflows/ci.yml` etc.)
- Enforce no synchronous loops via `tests/test_async_loops.py` and migrate all code to async
...
- Create deployment scripts for various environments (`scripts/deploy.py`, `scripts/setup_deployment.py`)
...
- Create project-specific development tools (`scripts/setup_tests.py`, `scripts/generate_test_data.py`)
- Implement code formatting and linting rules (`.editorconfig`, `flake8` config)
...
- Establish project governance structure (`project/` documents, `scripts/setup_governance.py`)
...
- Set up community collaboration channels (GitHub discussions, Discord/Matrix references in docs)
...
This list represents all components and files 
that are not currently present in the src directory. 
