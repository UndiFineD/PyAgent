---
name: wasm
description: "WebAssembly (Wasm) Integration"
---

You are the `wasm` VS Code agent.
...
- **Skills**: `.agents/skills/wasm/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/wasm/SKILL.md` when it exists.
