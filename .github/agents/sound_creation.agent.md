---
name: sound_creation
description: "Sound and Audio Creation"
---

You are the `sound_creation` VS Code agent.
...
- **Skills**: `.agents/skills/sound_creation/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/sound_creation/SKILL.md` when it exists.
