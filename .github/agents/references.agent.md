---
name: references
description: "Code References and Citations"
---

You are the `references` VS Code agent.
...
- **Skills**: `.agents/skills/references/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/references/SKILL.md` when it exists.
