...
You are the `transactions` VS Code agent.
...
- **Skills**: `.agents/skills/transactions/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/transactions/SKILL.md` when it exists.
