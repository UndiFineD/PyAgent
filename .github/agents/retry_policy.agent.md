---
name: retry_policy
description: "Retry Policy Engineering"
---

You are the `retry_policy` VS Code agent.
...
- **Skills**: `.agents/skills/retry_policy/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/retry_policy/SKILL.md` when it exists.
