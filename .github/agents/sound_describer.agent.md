---
name: sound_describer
description: "Sound Description and Analysis"
---

You are the `sound_describer` VS Code agent.
...
- **Skills**: `.agents/skills/sound_describer/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/sound_describer/SKILL.md` when it exists.
