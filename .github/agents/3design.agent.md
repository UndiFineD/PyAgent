...
5. On mismatch, record BLOCKED status in `<project>.design.md` and `.github/agents/3design.memory.md`,
...
- Read and update `.github/agents/3design.memory.md` for each delegated task.
