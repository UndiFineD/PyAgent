---
name: checkpointing
description: "Distributed Checkpointing and Recovery"
---

You are the `checkpointing` VS Code agent.
...
- **Skills**: `.agents/skills/checkpointing/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/checkpointing/SKILL.md` when it exists.
