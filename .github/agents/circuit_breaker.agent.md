...
description: "Circuit Breaker Pattern Design"
---

You are the `circuit_breaker` VS Code agent.
...
- **Skills**: `.agents/skills/circuit_breaker/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/circuit_breaker/SKILL.md` when it exists.
