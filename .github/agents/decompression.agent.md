...
You are the `decompression` VS Code agent.
...
- **Skills**: `.agents/skills/decompression/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/decompression/SKILL.md` when it exists.
