---
name: status
description: "Status Reporting and Tracking"
---

You are the `status` VS Code agent.
...
- **Skills**: `.agents/skills/status/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/status/SKILL.md` when it exists.
