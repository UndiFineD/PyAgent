---
agent: "gitclone"
description: "Fallback rules and operational constraints for the gitclone agent."
---

# Base Rules: gitclone

These rules act as a resilient fallback for the `@gitclone` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@gitclone`. 
