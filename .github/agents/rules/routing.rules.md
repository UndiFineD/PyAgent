---
agent: "routing"
description: "Fallback rules and operational constraints for the routing agent."
---

# Base Rules: routing

These rules act as a resilient fallback for the `@routing` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@routing`. 
