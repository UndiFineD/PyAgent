---
agent: "filesystem"
description: "Fallback rules and operational constraints for the filesystem agent."
---

# Base Rules: filesystem

These rules act as a resilient fallback for the `@filesystem` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@filesystem`. 
