...
description: "Fallback rules and operational constraints for the error_handling agent."
---

# Base Rules: error_handling

These rules act as a resilient fallback for the `@error_handling` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@error_handling`. 
