---
agent: "context"
description: "Fallback rules and operational constraints for the context agent."
---

# Base Rules: context

These rules act as a resilient fallback for the `@context` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@context`. 
