---
agent: "task_queue"
description: "Fallback rules and operational constraints for the task_queue agent."
---

# Base Rules: task_queue

These rules act as a resilient fallback for the `@task_queue` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@task_queue`. 
