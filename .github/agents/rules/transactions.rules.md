---
agent: "transactions"
description: "Fallback rules and operational constraints for the transactions agent."
---

# Base Rules: transactions

These rules act as a resilient fallback for the `@transactions` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@transactions`. 
