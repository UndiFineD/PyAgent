---
agent: "standup"
description: "Fallback rules and operational constraints for the standup agent."
---

# Base Rules: standup

These rules act as a resilient fallback for the `@standup` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@standup`. 
