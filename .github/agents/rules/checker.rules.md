---
agent: "checker"
description: "Fallback rules and operational constraints for the checker agent."
---

# Base Rules: checker

These rules act as a resilient fallback for the `@checker` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@checker`. 
