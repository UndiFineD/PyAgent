---
agent: "10idea"
description: "Fallback rules and operational constraints for the 10idea agent."
---

# Base Rules: 10idea

These rules act as a resilient fallback for the `@10idea` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@10idea`. 
