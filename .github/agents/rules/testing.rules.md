---
agent: "testing"
description: "Fallback rules and operational constraints for the testing agent."
---

# Base Rules: testing

These rules act as a resilient fallback for the `@testing` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@testing`. 
