---
agent: "design"
description: "Fallback rules and operational constraints for the design agent."
---

# Base Rules: design

These rules act as a resilient fallback for the `@design` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@design`. 
