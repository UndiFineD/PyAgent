---
agent: "rust"
description: "Fallback rules and operational constraints for the rust agent."
---

# Base Rules: rust

These rules act as a resilient fallback for the `@rust` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@rust`. 
