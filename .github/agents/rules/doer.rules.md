---
agent: "doer"
description: "Fallback rules and operational constraints for the doer agent."
---

# Base Rules: doer

These rules act as a resilient fallback for the `@doer` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@doer`. 
