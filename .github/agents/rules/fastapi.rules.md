---
agent: "fastapi"
description: "Fallback rules and operational constraints for the fastapi agent."
---

# Base Rules: fastapi

These rules act as a resilient fallback for the `@fastapi` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@fastapi`. 
