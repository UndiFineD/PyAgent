---
agent: "sound_describer"
description: "Fallback rules and operational constraints for the sound_describer agent."
---

# Base Rules: sound_describer

These rules act as a resilient fallback for the `@sound_describer` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@sound_describer`. 
