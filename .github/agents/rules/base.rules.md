---
agent: "base"
description: "Fallback rules and operational constraints for the base agent."
---

# Base Rules: base

These rules act as a resilient fallback for the `@base` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@base`. 
