---
agent: "event_handler"
description: "Fallback rules and operational constraints for the event_handler agent."
---

# Base Rules: event_handler

These rules act as a resilient fallback for the `@event_handler` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@event_handler`. 
