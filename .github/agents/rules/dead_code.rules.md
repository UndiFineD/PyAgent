---
agent: "dead_code"
description: "Fallback rules and operational constraints for the dead_code agent."
---

# Base Rules: dead_code

These rules act as a resilient fallback for the `@dead_code` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@dead_code`. 
