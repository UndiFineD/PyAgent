---
agent: "retry_policy"
description: "Fallback rules and operational constraints for the retry_policy agent."
---

# Base Rules: retry_policy

These rules act as a resilient fallback for the `@retry_policy` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@retry_policy`. 
