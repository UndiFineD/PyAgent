---
agent: "compression"
description: "Fallback rules and operational constraints for the compression agent."
---

# Base Rules: compression

These rules act as a resilient fallback for the `@compression` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@compression`. 
