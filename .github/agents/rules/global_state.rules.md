---
agent: "global_state"
description: "Fallback rules and operational constraints for the global_state agent."
---

# Base Rules: global_state

These rules act as a resilient fallback for the `@global_state` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@global_state`. 
