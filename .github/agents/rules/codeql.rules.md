---
agent: "codeql"
description: "Fallback rules and operational constraints for the codeql agent."
---

# Base Rules: codeql

These rules act as a resilient fallback for the `@codeql` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@codeql`. 
