---
agent: "encryption"
description: "Fallback rules and operational constraints for the encryption agent."
---

# Base Rules: encryption

These rules act as a resilient fallback for the `@encryption` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@encryption`. 
