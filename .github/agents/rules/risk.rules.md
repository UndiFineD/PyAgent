---
agent: "risk"
description: "Fallback rules and operational constraints for the risk agent."
---

# Base Rules: risk

These rules act as a resilient fallback for the `@risk` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@risk`. 
