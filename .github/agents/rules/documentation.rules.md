---
agent: "documentation"
description: "Fallback rules and operational constraints for the documentation agent."
---

# Base Rules: documentation

These rules act as a resilient fallback for the `@documentation` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@documentation`. 
