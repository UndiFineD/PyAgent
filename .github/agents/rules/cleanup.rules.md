---
agent: "cleanup"
description: "Fallback rules and operational constraints for the cleanup agent."
---

# Base Rules: cleanup

These rules act as a resilient fallback for the `@cleanup` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@cleanup`. 
