---
agent: "javascript"
description: "Fallback rules and operational constraints for the javascript agent."
---

# Base Rules: javascript

These rules act as a resilient fallback for the `@javascript` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@javascript`. 
