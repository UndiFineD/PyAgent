---
agent: "css"
description: "Fallback rules and operational constraints for the css agent."
---

# Base Rules: css

These rules act as a resilient fallback for the `@css` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@css`. 
