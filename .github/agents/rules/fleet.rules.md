---
agent: "fleet"
description: "Fallback rules and operational constraints for the fleet agent."
---

# Base Rules: fleet

These rules act as a resilient fallback for the `@fleet` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@fleet`. 
