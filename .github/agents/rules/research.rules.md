---
agent: "research"
description: "Fallback rules and operational constraints for the research agent."
---

# Base Rules: research

These rules act as a resilient fallback for the `@research` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@research`. 
