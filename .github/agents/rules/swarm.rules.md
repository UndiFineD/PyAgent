---
agent: "swarm"
description: "Fallback rules and operational constraints for the swarm agent."
---

# Base Rules: swarm

These rules act as a resilient fallback for the `@swarm` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@swarm`. 
