---
agent: "status"
description: "Fallback rules and operational constraints for the status agent."
---

# Base Rules: status

These rules act as a resilient fallback for the `@status` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@status`. 
