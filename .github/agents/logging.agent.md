---
name: logging
description: "Logging Strategy and Implementation"
---

You are the `logging` VS Code agent.
...
- **Skills**: `.agents/skills/logging/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/logging/SKILL.md` when it exists.
