---
name: sprint_review
description: "Sprint Review Coordinator"
---

You are the `sprint_review` VS Code agent.
...
- **Skills**: `.agents/skills/sprint_review/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/sprint_review/SKILL.md` when it exists.
