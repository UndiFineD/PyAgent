...
You are the `hardening` VS Code agent.
...
- **Skills**: `.agents/skills/hardening/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/hardening/SKILL.md` when it exists.
