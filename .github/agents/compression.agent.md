...
You are the `compression` VS Code agent.
...
- **Skills**: `.agents/skills/compression/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/compression/SKILL.md` when it exists.
