# INCIDENT-RESPONSE-AUTOMATION - References & Code Mapping

## Purpose
This document maps incident-response-automation to existing PyAgent implementations to avoid code duplication.
