# MUTATION-TESTING-FRAMEWORK - References & Code Mapping

## Purpose
This document maps mutation-testing-framework to existing PyAgent implementations to avoid code duplication.
