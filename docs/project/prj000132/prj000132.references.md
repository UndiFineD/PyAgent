# KUBERNETES-DEPLOYMENT-VALIDATION - References & Code Mapping

## Purpose
This document maps kubernetes-deployment-validation to existing PyAgent implementations to avoid code duplication.
