...
- [ ] T4 - Complete security handoff evidence | Files: async-runtime.ql.md | Acceptance: scan result and disposition recorded
- [ ] T5 - Complete git handoff on project branch | Files: async-runtime.git.md | Acceptance: expected branch observed and project match PASS
...
| M3 | Security and git closeout | T4-T5 | IN_PROGRESS |
