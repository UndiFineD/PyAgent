...
## Project Identity
**Project ID:** prj0000133
**Short name:** rust-criterion-benchmarks
**Project folder:** docs/project/prj0000133-rust-criterion-benchmarks/

## Idea Source
- Idea file: docs/project/ideas/idea000017-rust-criterion-benchmarks.md
- Idea source tag: idea000017

## Project Overview
Initialize a lightweight project boundary for rust-criterion-benchmarks, seeded from idea000017-rust-criterion-benchmarks. This batch-start artifact establishes ID assignment, initial lane placement, and rollout readiness for downstream discovery/design/plan work.
...
## Branch Plan
**Expected branch:** prj0000133-rust-criterion-benchmarks
**Batch bootstrap branch:** prj0000126-next-24-ideas-rollout
**Scope boundary:** docs/project/prj0000133-rust-criterion-benchmarks/, docs/project/kanban.json, data/projects.json, data/nextproject.md, and @1project memory/log files only.
