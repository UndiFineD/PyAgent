# TERRAFORM-COMPLIANCE-CHECKS - References & Code Mapping

## Purpose
This document maps terraform-compliance-checks to existing PyAgent implementations to avoid code duplication.
