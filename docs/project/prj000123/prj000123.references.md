# SQL-INJECTION-PREVENTION - References & Code Mapping

## Purpose
This document maps sql-injection-prevention to existing PyAgent implementations to avoid code duplication.
