...
## Idea summary
This idea is derived from docs/setup.md and targets setup improvements in area Platform. The goal is to convert documentation guidance into an actionable project slice with clear ownership, measurable outcomes, and safe rollout boundaries.
