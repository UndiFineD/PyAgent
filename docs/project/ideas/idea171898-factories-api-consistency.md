# idea171898 - -factories API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/models/_factories.py` with objective: Normalize interfaces and reduce behavioral drift.
