# idea081480 - web-security-scanner-core-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/security/web_security_scanner_core_test.py` with objective: Normalize interfaces and reduce behavioral drift.
