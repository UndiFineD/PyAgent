# idea171880 - metrics-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/metrics_core.py` with objective: Normalize interfaces and reduce behavioral drift.
