# idea169904 - configloader API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/agent/ConfigLoader.py` with objective: Normalize interfaces and reduce behavioral drift.
