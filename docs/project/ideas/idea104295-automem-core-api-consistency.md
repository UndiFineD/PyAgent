# idea104295 - automem-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/memory/automem_core.py` with objective: Normalize interfaces and reduce behavioral drift.
