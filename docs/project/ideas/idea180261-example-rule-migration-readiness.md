# idea180261 - example-rule Migration Readiness

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/rules/example_rule.py` with objective: Prepare component for future migration or modernization.
