# idea194363 - transport-layer API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/voyager/transport_layer.py` with objective: Normalize interfaces and reduce behavioral drift.
