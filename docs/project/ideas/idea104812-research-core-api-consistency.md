# idea104812 - research-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/specialists/research_core.py` with objective: Normalize interfaces and reduce behavioral drift.
