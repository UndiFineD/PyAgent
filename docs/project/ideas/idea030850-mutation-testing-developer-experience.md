# idea030850 - mutation-testing Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/agent_tests/mutation_testing.py` with objective: Reduce friction for contributors and operators.
