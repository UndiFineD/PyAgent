# idea180852 - connectivity-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/connectivity_core.py` with objective: Normalize interfaces and reduce behavioral drift.
