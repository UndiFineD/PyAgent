# idea082357 - agent-card-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/models/agent_card_test.py` with objective: Normalize interfaces and reduce behavioral drift.
