# idea167658 - agentpriorityqueue.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/AgentPriorityQueue.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
