# idea101723 - video-analyzer-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/video_analyzer_core.py` with objective: Normalize interfaces and reduce behavioral drift.
