# idea198719 - idl-scraper API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/toolkit/rpc/rpc_toolkit/idl_scraper/idl_scraper.py` with objective: Normalize interfaces and reduce behavioral drift.
