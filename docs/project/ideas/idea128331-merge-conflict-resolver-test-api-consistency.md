# idea128331 - merge-conflict-resolver-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/cognitive/context/utils/merge_conflict_resolver_test.py` with objective: Normalize interfaces and reduce behavioral drift.
