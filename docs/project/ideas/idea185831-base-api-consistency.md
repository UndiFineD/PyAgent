# idea185831 - base API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/quantization/engine/base.py` with objective: Normalize interfaces and reduce behavioral drift.
