# idea111453 - async-scheduler-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/scheduling/priority/async_scheduler_test.py` with objective: Normalize interfaces and reduce behavioral drift.
