# idea176184 - theory-of-mind-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/core/theory_of_mind_core.py` with objective: Normalize interfaces and reduce behavioral drift.
