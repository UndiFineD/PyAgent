# idea174353 - cpugpubuffer.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/structures/CpuGpuBuffer.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
