# idea187137 - request API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/lifecycle/request.py` with objective: Normalize interfaces and reduce behavioral drift.
