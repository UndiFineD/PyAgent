# idea147272 - derived-metric-calculator-description API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/derived_metric_calculator_description.md` with objective: Normalize interfaces and reduce behavioral drift.
