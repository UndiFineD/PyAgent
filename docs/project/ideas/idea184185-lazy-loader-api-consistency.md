# idea184185 - lazy-loader API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/lazy_loader.py` with objective: Normalize interfaces and reduce behavioral drift.
