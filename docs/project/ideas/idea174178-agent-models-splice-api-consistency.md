# idea174178 - agent-models.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/models/agent_models.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
