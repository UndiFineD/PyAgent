# idea173241 - micro-batch-context.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/core/micro_batch_context.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
