# idea162808 - matching API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/text/matching.rs` with objective: Normalize interfaces and reduce behavioral drift.
