# idea118064 - sandbox-core-test Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/sandbox/core/sandbox_core_test.py` with objective: Reduce security exposure and harden boundaries.
