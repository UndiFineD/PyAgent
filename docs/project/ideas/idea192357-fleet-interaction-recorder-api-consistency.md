# idea192357 - fleet-interaction-recorder API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/fleet/fleet_interaction_recorder.py` with objective: Normalize interfaces and reduce behavioral drift.
