# idea095156 - rust-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/rust_core.py` with objective: Normalize interfaces and reduce behavioral drift.
