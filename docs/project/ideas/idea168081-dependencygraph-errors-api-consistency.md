# idea168081 - dependencygraph.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/DependencyGraph.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
