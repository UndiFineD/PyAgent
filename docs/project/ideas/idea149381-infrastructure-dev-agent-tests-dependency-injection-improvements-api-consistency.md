# idea149381 - infrastructure-dev-agent-tests-dependency-injection-improvements API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/infrastructure_dev_agent_tests_dependency_injection_improvements.md` with objective: Normalize interfaces and reduce behavioral drift.
