# idea122170 - auto-debugger-orchestrator-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/orchestration/healing/auto_debugger_orchestrator_test.py` with objective: Normalize interfaces and reduce behavioral drift.
