# idea144087 - run-refactor-with-warnings-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/run_refactor_with_warnings_test.py` with objective: Normalize interfaces and reduce behavioral drift.
