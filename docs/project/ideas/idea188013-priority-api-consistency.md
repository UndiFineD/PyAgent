# idea188013 - priority API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/request_queue/queues/priority.py` with objective: Normalize interfaces and reduce behavioral drift.
