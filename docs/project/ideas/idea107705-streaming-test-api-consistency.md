# idea107705 - streaming-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/tensorizer/core/streaming_test.py` with objective: Normalize interfaces and reduce behavioral drift.
