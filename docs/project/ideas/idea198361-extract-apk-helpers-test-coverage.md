# idea198361 - extract-apk-helpers Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/scanners/mobile/android_scanner/utils/extract_apk_helpers.py` with objective: Increase deterministic test coverage and reliability.
