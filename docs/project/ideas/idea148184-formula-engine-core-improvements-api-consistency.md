# idea148184 - formula-engine-core-improvements API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/formula_engine_core_improvements.md` with objective: Normalize interfaces and reduce behavioral drift.
