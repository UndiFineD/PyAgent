# idea161561 - foundation-models API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/key/foundation_models.md` with objective: Normalize interfaces and reduce behavioral drift.
