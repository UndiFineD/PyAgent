# idea195910 - merge-conflict.suggested API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/cognitive/context/models/merge_conflict.suggested.py` with objective: Normalize interfaces and reduce behavioral drift.
