# idea169792 - agent-test-utils.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/agent_test_utils.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
