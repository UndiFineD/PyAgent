# idea120381 - mcp-connector.suggested Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/fleet/mcp_connector.suggested.py` with objective: Reduce friction for contributors and operators.
