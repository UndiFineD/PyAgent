# idea029402 - rejection-sampler-test Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/sampling/rejection_sampler_test.py` with objective: Increase deterministic test coverage and reliability.
