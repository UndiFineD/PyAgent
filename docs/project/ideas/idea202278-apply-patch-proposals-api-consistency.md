# idea202278 - apply-patch-proposals API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/apply_patch_proposals.py` with objective: Normalize interfaces and reduce behavioral drift.
