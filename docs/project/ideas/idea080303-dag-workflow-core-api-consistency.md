# idea080303 - dag-workflow-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/core/dag_workflow_core.py` with objective: Normalize interfaces and reduce behavioral drift.
