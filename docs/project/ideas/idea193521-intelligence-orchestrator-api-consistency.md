# idea193521 - intelligence-orchestrator API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/orchestration/intel/intelligence_orchestrator.py` with objective: Normalize interfaces and reduce behavioral drift.
