# idea188714 - grammar-compiler API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/structured/grammar_compiler.py` with objective: Normalize interfaces and reduce behavioral drift.
