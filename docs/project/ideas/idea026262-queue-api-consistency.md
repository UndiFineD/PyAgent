# idea026262 - queue API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/workflow/queue.py` with objective: Normalize interfaces and reduce behavioral drift.
