# idea005329 - prompt-old2 Hardening

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/work/prompt-old2.txt` with objective: Reduce defects and improve safety posture.
