# idea184411 - architect-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/specialists/architect_core.py` with objective: Normalize interfaces and reduce behavioral drift.
