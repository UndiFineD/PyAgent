# idea174636 - storage-base API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/knowledge/storage_base.py` with objective: Normalize interfaces and reduce behavioral drift.
