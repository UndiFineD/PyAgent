# idea194270 - types API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/parallel/dp/types.py` with objective: Normalize interfaces and reduce behavioral drift.
