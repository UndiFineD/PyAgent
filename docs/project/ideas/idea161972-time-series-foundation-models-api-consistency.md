# idea161972 - time-series-foundation-models API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/key/time_series_foundation_models.md` with objective: Normalize interfaces and reduce behavioral drift.
