# idea128851 - idiom-extractor-agent Hardening

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/cognitive/idiom_extractor_agent.py` with objective: Reduce defects and improve safety posture.
