# idea048284 - test-core-runtime API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/test_core_runtime.py` with objective: Normalize interfaces and reduce behavioral drift.
