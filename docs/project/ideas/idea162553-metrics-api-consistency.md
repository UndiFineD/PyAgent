# idea162553 - metrics API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/metrics.rs` with objective: Normalize interfaces and reduce behavioral drift.
