# idea084068 - benchmarking API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/utils/benchmarking.py` with objective: Normalize interfaces and reduce behavioral drift.
