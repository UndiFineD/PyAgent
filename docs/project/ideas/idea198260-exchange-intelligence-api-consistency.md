# idea198260 - exchange-intelligence API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/scanners/exchange_intelligence.py` with objective: Normalize interfaces and reduce behavioral drift.
