# idea161966 - text-to-sql API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/key/text_to_sql.md` with objective: Normalize interfaces and reduce behavioral drift.
