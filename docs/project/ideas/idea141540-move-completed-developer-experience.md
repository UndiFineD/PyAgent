# idea141540 - move-completed Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/move_completed.py` with objective: Reduce friction for contributors and operators.
