# idea180262 - example-rule Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/rules/example_rule.py` with objective: Improve logs, metrics, and debugging visibility.
