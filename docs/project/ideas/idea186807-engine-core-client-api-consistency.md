# idea186807 - engine-core-client API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/engine_core_client.py` with objective: Normalize interfaces and reduce behavioral drift.
