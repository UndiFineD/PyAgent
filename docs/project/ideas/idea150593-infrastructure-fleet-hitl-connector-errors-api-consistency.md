# idea150593 - infrastructure-fleet-hitl-connector-errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/infrastructure_fleet_hitl_connector_errors.md` with objective: Normalize interfaces and reduce behavioral drift.
