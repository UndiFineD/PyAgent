# idea180340 - external-refactor-scan API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/external_refactor_scan.py` with objective: Normalize interfaces and reduce behavioral drift.
