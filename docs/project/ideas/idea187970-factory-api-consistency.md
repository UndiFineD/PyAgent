# idea187970 - factory API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/request_queue/factory.py` with objective: Normalize interfaces and reduce behavioral drift.
