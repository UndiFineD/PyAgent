# idea115881 - mock-response-type-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/mock_response_type_test.py` with objective: Normalize interfaces and reduce behavioral drift.
