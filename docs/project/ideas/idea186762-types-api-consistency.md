# idea186762 - types API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/engine_client/types.py` with objective: Normalize interfaces and reduce behavioral drift.
