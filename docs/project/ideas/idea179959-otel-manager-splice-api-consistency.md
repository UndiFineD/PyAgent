# idea179959 - otel-manager.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/stats/exporters/otel_manager.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
