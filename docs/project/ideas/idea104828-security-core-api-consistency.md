# idea104828 - security-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/specialists/security_core.py` with objective: Normalize interfaces and reduce behavioral drift.
