# idea029320 - beam-search-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/sampling/beam_search_test.py` with objective: Normalize interfaces and reduce behavioral drift.
