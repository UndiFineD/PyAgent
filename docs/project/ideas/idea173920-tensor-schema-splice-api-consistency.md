# idea173920 - tensor-schema.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/validation/tensor_schema.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
