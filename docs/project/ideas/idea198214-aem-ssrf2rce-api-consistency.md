# idea198214 - aem-ssrf2rce API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/scanners/cms/aem_ssrf2rce.py` with objective: Normalize interfaces and reduce behavioral drift.
