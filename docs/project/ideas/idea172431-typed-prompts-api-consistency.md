# idea172431 - typed-prompts API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/types/typed_prompts.py` with objective: Normalize interfaces and reduce behavioral drift.
