# idea185120 - request-batcher API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/backend/request_batcher.py` with objective: Normalize interfaces and reduce behavioral drift.
