# idea168657 - metrictype.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/MetricType.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
