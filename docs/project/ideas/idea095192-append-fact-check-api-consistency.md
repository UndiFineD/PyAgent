# idea095192 - append-fact-check API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/append_fact_check.py` with objective: Normalize interfaces and reduce behavioral drift.
