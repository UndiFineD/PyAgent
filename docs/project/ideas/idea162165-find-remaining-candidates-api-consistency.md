# idea162165 - find-remaining-candidates API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `plugins/find_remaining_candidates.py` with objective: Normalize interfaces and reduce behavioral drift.
