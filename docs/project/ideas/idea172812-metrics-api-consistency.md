# idea172812 - metrics API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/core_logic/metrics.py` with objective: Normalize interfaces and reduce behavioral drift.
