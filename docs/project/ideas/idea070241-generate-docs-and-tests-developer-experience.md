# idea070241 - generate-docs-and-tests Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts-old/generate_docs_and_tests.py` with objective: Reduce friction for contributors and operators.
