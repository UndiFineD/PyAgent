# idea141594 - kpi API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/pm/kpi.py` with objective: Normalize interfaces and reduce behavioral drift.
