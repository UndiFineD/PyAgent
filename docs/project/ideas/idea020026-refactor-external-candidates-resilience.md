# idea020026 - refactor-external-candidates Resilience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/refactor_external_candidates.py` with objective: Improve fault tolerance and recovery behavior.
