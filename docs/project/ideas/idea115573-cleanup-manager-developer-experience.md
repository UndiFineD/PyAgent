# idea115573 - cleanup-manager Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/cleanup_manager.py` with objective: Reduce friction for contributors and operators.
