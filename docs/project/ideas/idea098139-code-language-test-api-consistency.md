# idea098139 - code-language-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/types/code_language_test.py` with objective: Normalize interfaces and reduce behavioral drift.
