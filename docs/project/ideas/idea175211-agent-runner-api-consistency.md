# idea175211 - agent-runner API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/interface/ui/gui/agent_runner.py` with objective: Normalize interfaces and reduce behavioral drift.
