# idea104335 - semantic-decay-advanced-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/memory/semantic_decay_advanced_test.py` with objective: Normalize interfaces and reduce behavioral drift.
