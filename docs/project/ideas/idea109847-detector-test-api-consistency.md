# idea109847 - detector-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/models/registry/detector_test.py` with objective: Normalize interfaces and reduce behavioral drift.
