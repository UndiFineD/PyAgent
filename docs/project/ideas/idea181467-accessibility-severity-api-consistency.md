# idea181467 - accessibility-severity API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/types/accessibility_severity.py` with objective: Normalize interfaces and reduce behavioral drift.
