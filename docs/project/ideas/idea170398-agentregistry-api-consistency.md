# idea170398 - agentregistry API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/fleet/AgentRegistry.py` with objective: Normalize interfaces and reduce behavioral drift.
