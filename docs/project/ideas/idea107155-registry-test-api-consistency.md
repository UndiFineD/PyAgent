# idea107155 - registry-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/lora/manager/registry_test.py` with objective: Normalize interfaces and reduce behavioral drift.
