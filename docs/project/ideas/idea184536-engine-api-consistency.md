# idea184536 - engine API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/inference/engine.py` with objective: Normalize interfaces and reduce behavioral drift.
