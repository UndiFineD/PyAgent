# idea113679 - mutation-testing-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/agent_tests/mutation_testing_test.py` with objective: Normalize interfaces and reduce behavioral drift.
