# idea191280 - sandbox-core Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/sandbox/core/sandbox_core.py` with objective: Reduce security exposure and harden boundaries.
