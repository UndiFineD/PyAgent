# idea173413 - agent-metrics API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/managers/agent_metrics.py` with objective: Normalize interfaces and reduce behavioral drift.
