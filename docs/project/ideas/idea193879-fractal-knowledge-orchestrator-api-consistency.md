# idea193879 - fractal-knowledge-orchestrator API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/orchestration/swarm/fractal_knowledge_orchestrator.py` with objective: Normalize interfaces and reduce behavioral drift.
