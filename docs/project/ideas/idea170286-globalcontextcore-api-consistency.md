# idea170286 - globalcontextcore API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/context/GlobalContextCore.py` with objective: Normalize interfaces and reduce behavioral drift.
