# idea171589 - shellexecutor API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/ShellExecutor.py` with objective: Normalize interfaces and reduce behavioral drift.
