# idea095672 - test-quotas Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/test_quotas.py` with objective: Reduce friction for contributors and operators.
