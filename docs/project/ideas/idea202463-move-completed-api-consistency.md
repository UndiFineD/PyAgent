# idea202463 - move-completed API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/move_completed.py` with objective: Normalize interfaces and reduce behavioral drift.
