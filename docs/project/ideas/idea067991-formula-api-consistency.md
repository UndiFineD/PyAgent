# idea067991 - formula API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_lib/src/formula.rs` with objective: Normalize interfaces and reduce behavioral drift.
