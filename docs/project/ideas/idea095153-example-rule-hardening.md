# idea095153 - example-rule Hardening

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/rules/example_rule.py` with objective: Reduce defects and improve safety posture.
