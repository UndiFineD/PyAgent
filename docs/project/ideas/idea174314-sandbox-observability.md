# idea174314 - sandbox Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/sandbox.py` with objective: Improve logs, metrics, and debugging visibility.
