# idea097267 - multimodal-encoders API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/multimodal_encoders.py` with objective: Normalize interfaces and reduce behavioral drift.
