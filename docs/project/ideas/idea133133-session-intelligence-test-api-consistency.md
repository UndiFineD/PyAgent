# idea133133 - session-intelligence-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/scanners/session_intelligence_test.py` with objective: Normalize interfaces and reduce behavioral drift.
