# idea184741 - ab-tester API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/backend/ab_tester.py` with objective: Normalize interfaces and reduce behavioral drift.
