# idea079499 - telemetry-collector Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/utils/telemetry_collector.py` with objective: Reduce friction for contributors and operators.
