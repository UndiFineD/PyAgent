# idea088080 - migration-manager Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/development/migration_manager.py` with objective: Reduce friction for contributors and operators.
