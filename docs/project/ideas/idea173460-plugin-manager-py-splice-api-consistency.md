# idea173460 - plugin-manager.py.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/managers/plugin_manager.py.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
