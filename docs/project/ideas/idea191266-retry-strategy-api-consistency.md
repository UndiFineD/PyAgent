# idea191266 - retry-strategy API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/resilience/retry_strategy.py` with objective: Normalize interfaces and reduce behavioral drift.
