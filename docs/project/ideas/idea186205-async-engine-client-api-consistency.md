# idea186205 - async-engine-client API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/async_engine_client.py` with objective: Normalize interfaces and reduce behavioral drift.
