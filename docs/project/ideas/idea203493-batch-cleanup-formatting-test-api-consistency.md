# idea203493 - batch-cleanup-formatting-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/batch_cleanup_formatting_test.py` with objective: Normalize interfaces and reduce behavioral drift.
