# idea141554 - move-external-to-src Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/move_external_to_src.py` with objective: Reduce security exposure and harden boundaries.
