# idea029702 - metadata-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/speculative/spec_decode/metadata_test.py` with objective: Normalize interfaces and reduce behavioral drift.
