# idea161903 - sampling-strategies API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/key/sampling_strategies.md` with objective: Normalize interfaces and reduce behavioral drift.
