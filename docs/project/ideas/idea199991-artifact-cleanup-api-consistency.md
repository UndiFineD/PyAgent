# idea199991 - artifact-cleanup API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/maintenance/artifact_cleanup.py` with objective: Normalize interfaces and reduce behavioral drift.
