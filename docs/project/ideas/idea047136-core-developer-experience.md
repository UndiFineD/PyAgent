# idea047136 - core Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/mcp/core.py` with objective: Reduce friction for contributors and operators.
