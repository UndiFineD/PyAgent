# idea073485 - subagentrunner API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/backend/SubagentRunner.py` with objective: Normalize interfaces and reduce behavioral drift.
