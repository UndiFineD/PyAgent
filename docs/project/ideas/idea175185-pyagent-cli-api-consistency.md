# idea175185 - pyagent-cli API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/interface/ui/cli/pyagent_cli.py` with objective: Normalize interfaces and reduce behavioral drift.
