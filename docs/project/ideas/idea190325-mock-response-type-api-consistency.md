# idea190325 - mock-response-type API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/mock_response_type.py` with objective: Normalize interfaces and reduce behavioral drift.
