# idea184658 - proposers API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/inference/speculation/engine/proposers.py` with objective: Normalize interfaces and reduce behavioral drift.
