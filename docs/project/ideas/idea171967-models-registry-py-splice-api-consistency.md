# idea171967 - models-registry.py.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/models_registry.py.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
