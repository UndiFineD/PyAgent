# idea023828 - model-manager-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/model_manager_core.py` with objective: Normalize interfaces and reduce behavioral drift.
