# idea180377 - run-full-pipeline.py Hardening

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/run_full_pipeline.py.bak` with objective: Reduce defects and improve safety posture.
