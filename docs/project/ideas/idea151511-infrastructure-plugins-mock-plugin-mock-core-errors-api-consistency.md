# idea151511 - infrastructure-plugins-mock-plugin-mock-core-errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/infrastructure_plugins_mock_plugin_mock_core_errors.md` with objective: Normalize interfaces and reduce behavioral drift.
