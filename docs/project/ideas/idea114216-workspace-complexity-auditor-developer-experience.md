# idea114216 - workspace-complexity-auditor Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/scripts/analysis/workspace_complexity_auditor.py` with objective: Reduce friction for contributors and operators.
