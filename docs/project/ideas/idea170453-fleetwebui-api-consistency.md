# idea170453 - fleetwebui API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/fleet/FleetWebUI.py` with objective: Normalize interfaces and reduce behavioral drift.
