# idea112033 - ebnf-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/structured/ebnf_test.py` with objective: Normalize interfaces and reduce behavioral drift.
