# idea169509 - testoutputformatter.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/TestOutputFormatter.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
