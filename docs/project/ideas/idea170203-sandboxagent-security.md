# idea170203 - sandboxagent Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/coder/SandboxAgent.py` with objective: Reduce security exposure and harden boundaries.
