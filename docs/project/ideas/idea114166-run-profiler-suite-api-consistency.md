# idea114166 - run-profiler-suite API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/scripts/analysis/run_profiler_suite.py` with objective: Normalize interfaces and reduce behavioral drift.
