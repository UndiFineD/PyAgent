# idea095559 - move-external-to-src Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/move_external_to_src.py` with objective: Reduce friction for contributors and operators.
