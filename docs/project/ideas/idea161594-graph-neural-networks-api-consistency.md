# idea161594 - graph-neural-networks API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/key/graph_neural_networks.md` with objective: Normalize interfaces and reduce behavioral drift.
