# idea190715 - base API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/mcp/base.py` with objective: Normalize interfaces and reduce behavioral drift.
