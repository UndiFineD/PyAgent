# idea188615 - verification API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/speculative/spec_decode/verification.py` with objective: Normalize interfaces and reduce behavioral drift.
