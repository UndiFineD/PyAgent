# idea197956 - red-queen-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/core/red_queen_core.py` with objective: Normalize interfaces and reduce behavioral drift.
