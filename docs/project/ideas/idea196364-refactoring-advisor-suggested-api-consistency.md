# idea196364 - refactoring-advisor.suggested API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/cognitive/context/utils/refactoring_advisor.suggested.py` with objective: Normalize interfaces and reduce behavioral drift.
