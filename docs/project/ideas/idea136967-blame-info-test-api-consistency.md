# idea136967 - blame-info-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/observability/errors/blame_info_test.py` with objective: Normalize interfaces and reduce behavioral drift.
