# idea193797 - audit-logger API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/orchestration/swarm/audit_logger.py` with objective: Normalize interfaces and reduce behavioral drift.
