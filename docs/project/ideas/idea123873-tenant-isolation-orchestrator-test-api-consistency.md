# idea123873 - tenant-isolation-orchestrator-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/orchestration/system/tenant_isolation_orchestrator_test.py` with objective: Normalize interfaces and reduce behavioral drift.
