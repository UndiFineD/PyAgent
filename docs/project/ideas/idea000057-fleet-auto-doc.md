...
## Idea summary
This idea is derived from docs/FLEET_AUTO_DOC.md and targets fleet auto doc improvements in area Architecture. The goal is to convert documentation guidance into an actionable project slice with clear ownership, measurable outcomes, and safe rollout boundaries.
