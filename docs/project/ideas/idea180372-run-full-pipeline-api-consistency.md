# idea180372 - run-full-pipeline API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/run_full_pipeline.py` with objective: Normalize interfaces and reduce behavioral drift.
