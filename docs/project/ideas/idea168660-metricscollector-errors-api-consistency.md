# idea168660 - metricscollector.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/MetricsCollector.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
