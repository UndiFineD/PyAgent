# idea072987 - basic-fixes API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/auto_fix/rules/basic_fixes.py` with objective: Normalize interfaces and reduce behavioral drift.
