# idea180441 - agent-knowledge API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/agent_knowledge.py` with objective: Normalize interfaces and reduce behavioral drift.
