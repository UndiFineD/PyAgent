# idea184020 - filesystem-skill API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/skills/filesystem_skill.py` with objective: Normalize interfaces and reduce behavioral drift.
