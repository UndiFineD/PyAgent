# idea172512 - agent-template API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/utils/agent_template.py` with objective: Normalize interfaces and reduce behavioral drift.
