# idea188728 - grammar-matcher API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/structured/grammar_matcher.py` with objective: Normalize interfaces and reduce behavioral drift.
