# idea136096 - prompt-templates Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/cognitive/prompt_templates.py` with objective: Reduce friction for contributors and operators.
