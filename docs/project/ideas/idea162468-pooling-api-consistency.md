# idea162468 - pooling API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/inference/pooling.rs` with objective: Normalize interfaces and reduce behavioral drift.
