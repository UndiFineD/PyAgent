# idea163316 - neural API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_lib/src/neural.rs` with objective: Normalize interfaces and reduce behavioral drift.
