# idea162873 - utm-ports API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/transport/utm_ports.rs` with objective: Normalize interfaces and reduce behavioral drift.
