# idea178052 - orchestrator-features API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/swarm/orchestrator_features.py` with objective: Normalize interfaces and reduce behavioral drift.
