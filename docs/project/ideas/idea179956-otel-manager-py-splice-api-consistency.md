# idea179956 - otel-manager.py.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/stats/exporters/otel_manager.py.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
