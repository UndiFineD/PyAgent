# idea101674 - subdomain-permutation-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/subdomain_permutation_core.py` with objective: Normalize interfaces and reduce behavioral drift.
