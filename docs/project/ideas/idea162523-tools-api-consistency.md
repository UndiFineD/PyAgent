# idea162523 - tools API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/inference/tools.rs` with objective: Normalize interfaces and reduce behavioral drift.
