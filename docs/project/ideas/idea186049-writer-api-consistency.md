# idea186049 - writer API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/tensorizer/core/writer.py` with objective: Normalize interfaces and reduce behavioral drift.
