# idea080563 - metrics-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/core/metrics_test.py` with objective: Normalize interfaces and reduce behavioral drift.
