# idea202222 - prioritization API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/roadmap/prioritization.py` with objective: Normalize interfaces and reduce behavioral drift.
