# idea095594 - refactor-external-candidates Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/refactor_external_candidates.py` with objective: Reduce security exposure and harden boundaries.
