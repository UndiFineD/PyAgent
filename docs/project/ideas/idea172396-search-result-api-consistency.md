# idea172396 - search-result API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/types/search_result.py` with objective: Normalize interfaces and reduce behavioral drift.
