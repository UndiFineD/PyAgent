# idea161930 - speculative-decoding API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/key/speculative_decoding.md` with objective: Normalize interfaces and reduce behavioral drift.
