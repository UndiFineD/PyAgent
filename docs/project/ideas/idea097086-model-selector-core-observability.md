# idea097086 - model-selector-core Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/model_selector_core.py` with objective: Improve logs, metrics, and debugging visibility.
