# idea176059 - cross-repo-context API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/context/utils/cross_repo_context.py` with objective: Normalize interfaces and reduce behavioral drift.
