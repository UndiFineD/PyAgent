# idea193874 - fleet-cleanup Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/orchestration/swarm/fleet_cleanup.py` with objective: Improve logs, metrics, and debugging visibility.
