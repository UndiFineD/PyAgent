...
## Idea summary
This idea is derived from docs/improvement_audit_plan.md and targets improvement audit plan improvements in area Quality. The goal is to convert documentation guidance into an actionable project slice with clear ownership, measurable outcomes, and safe rollout boundaries.
...
## Source references
- docs/improvement_audit_plan.md
