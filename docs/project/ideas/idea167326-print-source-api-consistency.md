# idea167326 - print-source API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts-old/print_source.py` with objective: Normalize interfaces and reduce behavioral drift.
