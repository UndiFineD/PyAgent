# idea-025 - global-state-management

Planned project mapping: None yet

## Idea summary
This idea focuses on global state management in area 4 – Frontend. The current signal indicates priority P3, impact H, and urgency M. The SWOT tag is O (Opportunity to improve capability).

## Problem statement
Each of the 10 app windows manages its own local state. No Zustand/Redux store exists for cross-window coordination (shared WebSocket session, unified notifications).
