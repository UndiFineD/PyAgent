# idea197138 - bash-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/development/core/bash_core.py` with objective: Normalize interfaces and reduce behavioral drift.
