# idea184174 - vector-store API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/knowledge/vector_store.py` with objective: Normalize interfaces and reduce behavioral drift.
