# idea174356 - flatlogprobs.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/structures/FlatLogprobs.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
