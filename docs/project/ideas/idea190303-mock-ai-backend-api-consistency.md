# idea190303 - mock-ai-backend API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/mock_ai_backend.py` with objective: Normalize interfaces and reduce behavioral drift.
