# idea023131 - active-directory-threat-hunting-core Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/active_directory_threat_hunting_core.py` with objective: Reduce friction for contributors and operators.
