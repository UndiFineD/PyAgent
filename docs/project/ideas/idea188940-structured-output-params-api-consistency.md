# idea188940 - structured-output-params API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/structured/structured_output_params.py` with objective: Normalize interfaces and reduce behavioral drift.
