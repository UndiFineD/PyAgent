# idea169260 - signalregistry.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/SignalRegistry.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
