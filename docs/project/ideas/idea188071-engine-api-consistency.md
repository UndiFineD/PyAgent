# idea188071 - engine API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/sampling/engine.py` with objective: Normalize interfaces and reduce behavioral drift.
