# idea170480 - mcpconnector Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/fleet/MCPConnector.py` with objective: Improve logs, metrics, and debugging visibility.
