# idea175167 - core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/interface/slash_commands/core.py` with objective: Normalize interfaces and reduce behavioral drift.
