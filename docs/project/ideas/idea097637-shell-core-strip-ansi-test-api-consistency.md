# idea097637 - shell-core-strip-ansi-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/shell_core_strip_ansi_test.py` with objective: Normalize interfaces and reduce behavioral drift.
