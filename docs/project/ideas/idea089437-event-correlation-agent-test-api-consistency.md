# idea089437 - event-correlation-agent-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/security/event_correlation_agent_test.py` with objective: Normalize interfaces and reduce behavioral drift.
