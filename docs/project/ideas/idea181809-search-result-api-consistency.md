# idea181809 - search-result API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/types/search_result.py` with objective: Normalize interfaces and reduce behavioral drift.
