# idea095822 - conftest API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/conftest.py` with objective: Normalize interfaces and reduce behavioral drift.
