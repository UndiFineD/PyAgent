# idea095615 - run-full-pipeline Resilience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/run_full_pipeline.py` with objective: Improve fault tolerance and recovery behavior.
