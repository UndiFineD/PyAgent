# idea175047 - speculative-engine API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/inference/speculation/speculative_engine.py` with objective: Normalize interfaces and reduce behavioral drift.
