# idea202505 - risk API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/pm/risk.py` with objective: Normalize interfaces and reduce behavioral drift.
