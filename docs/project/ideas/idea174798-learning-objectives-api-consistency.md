# idea174798 - learning-objectives API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/rl/learning_objectives.py` with objective: Normalize interfaces and reduce behavioral drift.
