# idea180127 - scheduler-stats.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/stats/scheduler_stats.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
