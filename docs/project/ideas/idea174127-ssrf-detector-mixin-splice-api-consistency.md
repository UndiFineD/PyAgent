# idea174127 - ssrf-detector-mixin.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/mixins/ssrf_detector_mixin.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
