# idea162121 - prompt-old Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/work/prompt-old.txt` with objective: Increase deterministic test coverage and reliability.

## Problem statement
Legacy file `docs/work/prompt-old.txt` from v3.7.0 may contain latent quality risks, drift, or missing modernization opportunities.
...
## Research findings
Static signals: size=75059 bytes, function_like_tokens=1, todo_like_tokens=0, has_test_signal=True.
