# idea171430 - formulaenginecore API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/stats/FormulaEngineCore.py` with objective: Normalize interfaces and reduce behavioral drift.
