# idea181606 - diff-view-mode API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/types/diff_view_mode.py` with objective: Normalize interfaces and reduce behavioral drift.
