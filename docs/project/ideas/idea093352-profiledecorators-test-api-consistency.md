# idea093352 - profiledecorators-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/profiling/ProfileDecorators_test.py` with objective: Normalize interfaces and reduce behavioral drift.
