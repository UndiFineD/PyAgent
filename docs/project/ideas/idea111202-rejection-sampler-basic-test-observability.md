# idea111202 - rejection-sampler-basic-test Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/sampling/rejection_sampler_basic_test.py` with objective: Improve logs, metrics, and debugging visibility.
