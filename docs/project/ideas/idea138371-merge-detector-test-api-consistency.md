# idea138371 - merge-detector-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/observability/improvements/merge_detector_test.py` with objective: Normalize interfaces and reduce behavioral drift.
