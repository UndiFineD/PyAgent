# idea143417 - test-core-task-queue API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/test_core_task_queue.py` with objective: Normalize interfaces and reduce behavioral drift.
