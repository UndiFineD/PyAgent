# idea175354 - benchmark-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/analysis/core/benchmark_core.py` with objective: Normalize interfaces and reduce behavioral drift.
