# idea174830 - reward-functions.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/rl/reward_functions.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
