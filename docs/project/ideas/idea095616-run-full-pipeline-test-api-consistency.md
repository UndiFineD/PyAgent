# idea095616 - run-full-pipeline-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/run_full_pipeline_test.py` with objective: Normalize interfaces and reduce behavioral drift.
