# idea203635 - inspect-lint-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/inspect_lint_test.py` with objective: Normalize interfaces and reduce behavioral drift.
