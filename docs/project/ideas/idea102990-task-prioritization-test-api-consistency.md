# idea102990 - task-prioritization-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/task_prioritization_test.py` with objective: Normalize interfaces and reduce behavioral drift.
