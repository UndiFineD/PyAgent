# idea048174 - test-dev-tools-dirs Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/structure/test_dev_tools_dirs.py` with objective: Reduce friction for contributors and operators.
