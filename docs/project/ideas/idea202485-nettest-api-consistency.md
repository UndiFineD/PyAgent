# idea202485 - nettest API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/nettest.py` with objective: Normalize interfaces and reduce behavioral drift.
