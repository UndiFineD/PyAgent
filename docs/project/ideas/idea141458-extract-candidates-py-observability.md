# idea141458 - extract-candidates.py Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/extract_candidates.py.bak` with objective: Improve logs, metrics, and debugging visibility.
