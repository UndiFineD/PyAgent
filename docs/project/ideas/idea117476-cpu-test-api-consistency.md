# idea117476 - cpu-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/platform/cpu_test.py` with objective: Normalize interfaces and reduce behavioral drift.
