# idea184305 - action-space API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/rl/action_space.py` with objective: Normalize interfaces and reduce behavioral drift.
