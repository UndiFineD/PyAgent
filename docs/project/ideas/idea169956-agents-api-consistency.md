# idea169956 - agents API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/agent_tests/agents.py` with objective: Normalize interfaces and reduce behavioral drift.
