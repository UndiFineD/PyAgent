# idea162513 - stats API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/inference/stats.rs` with objective: Normalize interfaces and reduce behavioral drift.
