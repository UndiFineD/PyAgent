# idea115537 - baseline-manager API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/baseline_manager.py` with objective: Normalize interfaces and reduce behavioral drift.
