# idea175102 - parser API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/interface/commands/parser.py` with objective: Normalize interfaces and reduce behavioral drift.
