# idea144111 - top-offenders-test Resilience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/top_offenders_test.py` with objective: Improve fault tolerance and recovery behavior.
