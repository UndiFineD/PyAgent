# idea170528 - tenantcore API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/fleet/TenantCore.py` with objective: Normalize interfaces and reduce behavioral drift.
