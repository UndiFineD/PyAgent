# idea180937 - formula-core.py.manual-fix Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/formula_core.py.manual_fix.bak` with objective: Improve logs, metrics, and debugging visibility.
