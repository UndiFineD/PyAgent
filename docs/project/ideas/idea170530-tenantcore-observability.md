# idea170530 - tenantcore Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/fleet/TenantCore.py` with objective: Improve logs, metrics, and debugging visibility.
