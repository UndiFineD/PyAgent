# idea103537 - prompt-loader-mixin Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/mixins/prompt_loader_mixin.py` with objective: Reduce friction for contributors and operators.
