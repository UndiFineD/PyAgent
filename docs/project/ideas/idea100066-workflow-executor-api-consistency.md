# idea100066 - workflow-executor API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/lifecycle/workflow_executor.py` with objective: Normalize interfaces and reduce behavioral drift.
