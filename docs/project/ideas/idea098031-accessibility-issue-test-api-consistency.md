# idea098031 - accessibility-issue-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/types/accessibility_issue_test.py` with objective: Normalize interfaces and reduce behavioral drift.
