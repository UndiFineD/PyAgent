# idea097031 - lesson-core-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/lesson_core_test.py` with objective: Normalize interfaces and reduce behavioral drift.
