# idea104108 - mcp-tool API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/integrations/mcp/mcp_tool.py` with objective: Normalize interfaces and reduce behavioral drift.
