# idea066951 - check-tx API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/check_tx.py` with objective: Normalize interfaces and reduce behavioral drift.
