# idea194551 - registry API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/interface/commands/registry.py` with objective: Normalize interfaces and reduce behavioral drift.
