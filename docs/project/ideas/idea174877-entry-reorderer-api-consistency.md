# idea174877 - entry-reorderer API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/utils/entry_reorderer.py` with objective: Normalize interfaces and reduce behavioral drift.
