# idea104176 - graph-store-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/knowledge/graph_store_test.py` with objective: Normalize interfaces and reduce behavioral drift.
