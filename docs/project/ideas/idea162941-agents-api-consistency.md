# idea162941 - agents API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_lib/src/agents.rs` with objective: Normalize interfaces and reduce behavioral drift.
