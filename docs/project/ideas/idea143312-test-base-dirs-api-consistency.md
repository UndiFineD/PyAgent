# idea143312 - test-base-dirs API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/structure/test_base_dirs.py` with objective: Normalize interfaces and reduce behavioral drift.
