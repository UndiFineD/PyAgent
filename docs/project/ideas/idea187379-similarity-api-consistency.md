# idea187379 - similarity API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/models/similarity.py` with objective: Normalize interfaces and reduce behavioral drift.
