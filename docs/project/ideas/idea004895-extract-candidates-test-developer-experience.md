# idea004895 - extract-candidates-test Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/extract_candidates_test.py` with objective: Reduce friction for contributors and operators.
