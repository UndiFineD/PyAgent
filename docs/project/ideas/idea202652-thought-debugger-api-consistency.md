# idea202652 - thought-debugger API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/userspace/interface/cli/thought_debugger.py` with objective: Normalize interfaces and reduce behavioral drift.
