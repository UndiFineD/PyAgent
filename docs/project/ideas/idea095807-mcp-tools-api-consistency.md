# idea095807 - mcp-tools API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/chat/mcp_tools.py` with objective: Normalize interfaces and reduce behavioral drift.
