# idea176231 - idiom-extractor-agent Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/idiom_extractor_agent.py` with objective: Improve logs, metrics, and debugging visibility.
