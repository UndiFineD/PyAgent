# idea184312 - environment API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/rl/environment.py` with objective: Normalize interfaces and reduce behavioral drift.
