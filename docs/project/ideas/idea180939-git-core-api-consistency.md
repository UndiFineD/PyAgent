# idea180939 - git-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/git_core.py` with objective: Normalize interfaces and reduce behavioral drift.
