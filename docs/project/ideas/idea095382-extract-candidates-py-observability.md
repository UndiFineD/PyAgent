# idea095382 - extract-candidates.py Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/extract_candidates.py.bak` with objective: Improve logs, metrics, and debugging visibility.
