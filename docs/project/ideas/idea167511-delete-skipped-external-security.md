# idea167511 - delete-skipped-external Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts/delete_skipped_external.py` with objective: Reduce security exposure and harden boundaries.
