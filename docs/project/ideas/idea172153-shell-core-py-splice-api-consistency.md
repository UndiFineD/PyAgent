# idea172153 - shell-core.py.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/shell_core.py.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
