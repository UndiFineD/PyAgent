# idea175308 - topology-viewer Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/interface/ui/web/topology_viewer.html` with objective: Improve logs, metrics, and debugging visibility.
