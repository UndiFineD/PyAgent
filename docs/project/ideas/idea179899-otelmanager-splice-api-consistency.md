# idea179899 - otelmanager.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/stats/exporters/OTelManager.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
