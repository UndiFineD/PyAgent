# idea109183 - input-preprocessor-features-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/inputs/input_preprocessor_features_test.py` with objective: Normalize interfaces and reduce behavioral drift.
