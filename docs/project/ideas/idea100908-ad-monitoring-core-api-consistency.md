# idea100908 - ad-monitoring-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/ad_monitoring_core.py` with objective: Normalize interfaces and reduce behavioral drift.
