# idea192773 - rl-selector API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/fleet/rl_selector.py` with objective: Normalize interfaces and reduce behavioral drift.
