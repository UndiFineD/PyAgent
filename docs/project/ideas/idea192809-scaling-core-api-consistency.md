# idea192809 - scaling-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/fleet/scaling_core.py` with objective: Normalize interfaces and reduce behavioral drift.
