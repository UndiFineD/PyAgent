# idea172221 - accessibility-issue-type API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/types/accessibility_issue_type.py` with objective: Normalize interfaces and reduce behavioral drift.
