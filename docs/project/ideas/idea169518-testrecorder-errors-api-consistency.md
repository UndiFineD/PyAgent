# idea169518 - testrecorder.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/TestRecorder.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
