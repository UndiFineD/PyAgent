...
## Idea summary
This idea is derived from docs/CORE_DESIGN_GUIDE.md and targets core design guide improvements in area Governance. The goal is to convert documentation guidance into an actionable project slice with clear ownership, measurable outcomes, and safe rollout boundaries.
