# idea095501 - fix-hardcoded-paths API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/fix_hardcoded_paths.py` with objective: Normalize interfaces and reduce behavioral drift.
