# idea162793 - analysis API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/text/analysis.rs` with objective: Normalize interfaces and reduce behavioral drift.
