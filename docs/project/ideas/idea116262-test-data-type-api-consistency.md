# idea116262 - test-data-type API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/test_data_type.py` with objective: Normalize interfaces and reduce behavioral drift.
