# idea103821 - module-loader API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/registry/module_loader.py` with objective: Normalize interfaces and reduce behavioral drift.
