# idea167661 - agentregistry.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/AgentRegistry.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
