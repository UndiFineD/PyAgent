# idea148178 - formula-engine-core-description API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/formula_engine_core_description.md` with objective: Normalize interfaces and reduce behavioral drift.
