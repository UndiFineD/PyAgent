# idea205903 - rag-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/rag_core.py` with objective: Normalize interfaces and reduce behavioral drift.
