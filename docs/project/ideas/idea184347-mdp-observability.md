# idea184347 - mdp Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/rl/mdp.py` with objective: Improve logs, metrics, and debugging visibility.
