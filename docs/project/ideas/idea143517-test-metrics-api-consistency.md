# idea143517 - test-metrics API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/test_metrics.py` with objective: Normalize interfaces and reduce behavioral drift.
