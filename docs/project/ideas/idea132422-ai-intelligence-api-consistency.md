# idea132422 - ai-intelligence API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/scanners/ai_intelligence.py` with objective: Normalize interfaces and reduce behavioral drift.
