# idea172969 - async-pipeline-core.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/async_pipeline_core.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
