# idea160784 - token-cost-core-errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/token_cost_core_errors.md` with objective: Normalize interfaces and reduce behavioral drift.
