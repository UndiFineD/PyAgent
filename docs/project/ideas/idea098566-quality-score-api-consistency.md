# idea098566 - quality-score API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/types/quality_score.py` with objective: Normalize interfaces and reduce behavioral drift.
