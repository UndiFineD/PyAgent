# idea172797 - resiliencecore API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/core/ResilienceCore.py` with objective: Normalize interfaces and reduce behavioral drift.
