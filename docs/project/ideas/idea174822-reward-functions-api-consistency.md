# idea174822 - reward-functions API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/rl/reward_functions.py` with objective: Normalize interfaces and reduce behavioral drift.
