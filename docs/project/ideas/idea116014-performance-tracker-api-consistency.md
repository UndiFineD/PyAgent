# idea116014 - performance-tracker API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/performance_tracker.py` with objective: Normalize interfaces and reduce behavioral drift.
