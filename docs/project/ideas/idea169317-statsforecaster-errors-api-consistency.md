# idea169317 - statsforecaster.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/StatsForecaster.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
