# idea067525 - crypto API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/security/crypto.rs` with objective: Normalize interfaces and reduce behavioral drift.
