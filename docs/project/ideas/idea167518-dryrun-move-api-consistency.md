# idea167518 - dryrun-move API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts/dryrun_move.py` with objective: Normalize interfaces and reduce behavioral drift.
