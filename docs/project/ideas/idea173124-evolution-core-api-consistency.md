# idea173124 - evolution-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/core/evolution_core.py` with objective: Normalize interfaces and reduce behavioral drift.
