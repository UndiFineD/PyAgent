# idea173006 - agent-card-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/core/agent_card_core.py` with objective: Normalize interfaces and reduce behavioral drift.
