# idea161384 - beam-search API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/key/beam_search.md` with objective: Normalize interfaces and reduce behavioral drift.
