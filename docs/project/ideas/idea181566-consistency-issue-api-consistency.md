# idea181566 - consistency-issue API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/types/consistency_issue.py` with objective: Normalize interfaces and reduce behavioral drift.
