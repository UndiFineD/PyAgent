# idea067435 - inference-utils API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/neural/inference_utils.rs` with objective: Normalize interfaces and reduce behavioral drift.
