# idea152315 - logic-agents-cognitive-context-engines-context-compressor-core-errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/logic_agents_cognitive_context_engines_context_compressor_core_errors.md` with objective: Normalize interfaces and reduce behavioral drift.
