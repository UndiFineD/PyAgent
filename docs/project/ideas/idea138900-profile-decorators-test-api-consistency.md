# idea138900 - profile-decorators-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/observability/profiling/profile_decorators_test.py` with objective: Normalize interfaces and reduce behavioral drift.
