# idea066756 - prompt-old Hardening

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/prompt/prompt-old.txt` with objective: Reduce defects and improve safety posture.

## Problem statement
Legacy file `docs/prompt/prompt-old.txt` from v3.7.0 may contain latent quality risks, drift, or missing modernization opportunities.
...
## Research findings
Static signals: size=60749 bytes, function_like_tokens=1, todo_like_tokens=0, has_test_signal=True.
