# idea188604 - metadata API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/speculative/spec_decode/metadata.py` with objective: Normalize interfaces and reduce behavioral drift.
