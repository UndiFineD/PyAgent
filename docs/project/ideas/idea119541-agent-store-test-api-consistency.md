# idea119541 - agent-store-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/fleet/agent_store_test.py` with objective: Normalize interfaces and reduce behavioral drift.
