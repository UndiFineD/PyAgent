# idea167257 - debug-import API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts-old/debug_import.py` with objective: Normalize interfaces and reduce behavioral drift.
