# idea143367 - test-chat-mcp API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/test_chat_mcp.py` with objective: Normalize interfaces and reduce behavioral drift.
