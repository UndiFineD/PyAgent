# idea167841 - capabilitydiscovery.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/CapabilityDiscovery.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
