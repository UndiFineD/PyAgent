# idea107415 - gptq-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/quantization/engine/gptq_test.py` with objective: Normalize interfaces and reduce behavioral drift.
