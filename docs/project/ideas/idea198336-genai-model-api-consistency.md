# idea198336 - genai-model API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/scanners/mobile/android_scanner/models/genai_model.py` with objective: Normalize interfaces and reduce behavioral drift.
