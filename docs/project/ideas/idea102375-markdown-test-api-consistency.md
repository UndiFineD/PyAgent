# idea102375 - markdown-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/parsers/reasoning/implementations/markdown_test.py` with objective: Normalize interfaces and reduce behavioral drift.
