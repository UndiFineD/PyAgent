# idea185958 - ops API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/ssm/mamba/ops.py` with objective: Normalize interfaces and reduce behavioral drift.
