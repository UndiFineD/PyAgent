# idea152672 - logic-agents-cognitive-context-utils-context-exporter-description API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/logic_agents_cognitive_context_utils_context_exporter_description.md` with objective: Normalize interfaces and reduce behavioral drift.
