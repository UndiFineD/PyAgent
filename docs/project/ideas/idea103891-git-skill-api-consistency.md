# idea103891 - git-skill API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/skills/git_skill.py` with objective: Normalize interfaces and reduce behavioral drift.
