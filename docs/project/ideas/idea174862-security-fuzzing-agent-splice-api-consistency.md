# idea174862 - security-fuzzing-agent.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/specialists/security_fuzzing_agent.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
