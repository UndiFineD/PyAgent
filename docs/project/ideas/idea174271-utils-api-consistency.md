# idea174271 - utils API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/parsers/reasoning/utils.py` with objective: Normalize interfaces and reduce behavioral drift.
