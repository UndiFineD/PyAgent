# idea181252 - search-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/search_core.py` with objective: Normalize interfaces and reduce behavioral drift.
