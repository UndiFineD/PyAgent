# idea020934 - model-selector-core Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/model_selector_core.py` with objective: Reduce friction for contributors and operators.
