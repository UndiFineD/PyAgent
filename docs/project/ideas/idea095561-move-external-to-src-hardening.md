# idea095561 - move-external-to-src Hardening

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/move_external_to_src.py` with objective: Reduce defects and improve safety posture.
