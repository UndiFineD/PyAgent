# idea180268 - scheduling.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/scheduling.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
