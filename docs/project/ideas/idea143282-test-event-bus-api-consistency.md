# idea143282 - test-event-bus API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/runtime/test_event_bus.py` with objective: Normalize interfaces and reduce behavioral drift.
