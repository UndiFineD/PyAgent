# idea185708 - weights API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/lora/manager/weights.py` with objective: Normalize interfaces and reduce behavioral drift.
