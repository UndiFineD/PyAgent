# idea118179 - granite-parser-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/tools/parser/granite_parser_test.py` with objective: Normalize interfaces and reduce behavioral drift.
