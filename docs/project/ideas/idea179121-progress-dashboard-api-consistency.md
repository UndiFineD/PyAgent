# idea179121 - progress-dashboard API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/improvements/progress_dashboard.py` with objective: Normalize interfaces and reduce behavioral drift.
