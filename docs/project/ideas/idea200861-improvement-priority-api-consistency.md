# idea200861 - improvement-priority API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/observability/improvements/improvement_priority.py` with objective: Normalize interfaces and reduce behavioral drift.
