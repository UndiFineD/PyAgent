# idea174733 - cort-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/reasoning/cort_core.py` with objective: Normalize interfaces and reduce behavioral drift.
