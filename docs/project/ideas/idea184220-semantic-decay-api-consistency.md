# idea184220 - semantic-decay API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/memory/semantic_decay.py` with objective: Normalize interfaces and reduce behavioral drift.
