# idea201536 - report-format API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/observability/reports/report_format.py` with objective: Normalize interfaces and reduce behavioral drift.
