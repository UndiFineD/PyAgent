# idea180153 - streaming.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/stats/streaming.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
