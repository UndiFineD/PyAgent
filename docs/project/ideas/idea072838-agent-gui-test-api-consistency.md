# idea072838 - agent-gui-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/agent_gui_test.py` with objective: Normalize interfaces and reduce behavioral drift.
