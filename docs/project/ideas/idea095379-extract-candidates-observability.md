# idea095379 - extract-candidates Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/extract_candidates.py` with objective: Improve logs, metrics, and debugging visibility.
