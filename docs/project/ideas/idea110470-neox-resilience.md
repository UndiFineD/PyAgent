# idea110470 - neox Resilience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/position/rotary/neox.py` with objective: Improve fault tolerance and recovery behavior.
