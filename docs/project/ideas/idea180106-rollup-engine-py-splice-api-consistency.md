# idea180106 - rollup-engine.py.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/stats/rollup_engine.py.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
