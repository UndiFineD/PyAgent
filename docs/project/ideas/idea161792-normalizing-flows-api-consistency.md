# idea161792 - normalizing-flows API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/key/normalizing_flows.md` with objective: Normalize interfaces and reduce behavioral drift.
