# idea117052 - sse API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/mcp/sse.py` with objective: Normalize interfaces and reduce behavioral drift.
