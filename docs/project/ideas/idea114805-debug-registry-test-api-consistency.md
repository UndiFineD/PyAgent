# idea114805 - debug-registry-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/scripts/management/debug_registry_test.py` with objective: Normalize interfaces and reduce behavioral drift.
