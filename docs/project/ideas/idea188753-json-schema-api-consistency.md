# idea188753 - json-schema API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/structured/json_schema.py` with objective: Normalize interfaces and reduce behavioral drift.
