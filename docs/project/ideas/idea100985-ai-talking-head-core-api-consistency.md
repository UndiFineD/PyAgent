# idea100985 - ai-talking-head-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/ai_talking_head_core.py` with objective: Normalize interfaces and reduce behavioral drift.
