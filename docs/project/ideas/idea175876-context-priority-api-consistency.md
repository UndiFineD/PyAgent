# idea175876 - context-priority API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/context/models/context_priority.py` with objective: Normalize interfaces and reduce behavioral drift.
