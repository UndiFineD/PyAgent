# idea196353 - refactoring-advisor API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/cognitive/context/utils/refactoring_advisor.py` with objective: Normalize interfaces and reduce behavioral drift.
