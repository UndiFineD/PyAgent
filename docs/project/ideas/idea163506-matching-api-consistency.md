# idea163506 - matching API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_lib/src/text/matching.rs` with objective: Normalize interfaces and reduce behavioral drift.
