# idea187130 - queue API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/lifecycle/queue.py` with objective: Normalize interfaces and reduce behavioral drift.
