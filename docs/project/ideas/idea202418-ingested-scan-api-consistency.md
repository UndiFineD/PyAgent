# idea202418 - ingested-scan API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/ingested_scan.py` with objective: Normalize interfaces and reduce behavioral drift.
