# idea066825 - prompt-old Hardening

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/work/prompt-old.txt` with objective: Reduce defects and improve safety posture.
