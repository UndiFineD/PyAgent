# idea143427 - test-cort API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/test_cort.py` with objective: Normalize interfaces and reduce behavioral drift.
