# idea173899 - tts-service.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/tts_service.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
