# idea187963 - enums API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/request_queue/enums.py` with objective: Normalize interfaces and reduce behavioral drift.
