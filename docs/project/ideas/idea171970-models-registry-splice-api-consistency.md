# idea171970 - models-registry.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/models_registry.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
