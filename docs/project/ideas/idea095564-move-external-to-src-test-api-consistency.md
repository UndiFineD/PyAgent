# idea095564 - move-external-to-src-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/move_external_to_src_test.py` with objective: Normalize interfaces and reduce behavioral drift.
