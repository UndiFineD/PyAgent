# idea132530 - aem-ssrf2rce Hardening

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/scanners/cms/aem_ssrf2rce.py` with objective: Reduce defects and improve safety posture.
