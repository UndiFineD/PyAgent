# idea086321 - contextcompressor API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/context/utils/ContextCompressor.py` with objective: Normalize interfaces and reduce behavioral drift.
