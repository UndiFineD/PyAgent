# idea208095 - check-rust-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `check_rust_core.py` with objective: Normalize interfaces and reduce behavioral drift.
