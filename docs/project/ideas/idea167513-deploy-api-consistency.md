# idea167513 - deploy API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts/deploy.py` with objective: Normalize interfaces and reduce behavioral drift.
