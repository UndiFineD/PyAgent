# idea047169 - move-external-to-src-test Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/move_external_to_src_test.py` with objective: Reduce friction for contributors and operators.
