...
## Problem statement
FastAPI auto-generates an OpenAPI spec at runtime but no `openapi.json` is committed or built in CI. `docs/api/index.md` is a mkdocstrings placeholder never rendered, making the API undiscoverable.
