# idea172796 - pruningcore.splice Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/core/PruningCore.splice.md` with objective: Increase deterministic test coverage and reliability.
