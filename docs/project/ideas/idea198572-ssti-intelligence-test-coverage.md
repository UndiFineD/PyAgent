# idea198572 - ssti-intelligence Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/scanners/ssti_intelligence.py` with objective: Increase deterministic test coverage and reliability.
