# idea143332 - test-data-script API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/structure/test_data_script.py` with objective: Normalize interfaces and reduce behavioral drift.
