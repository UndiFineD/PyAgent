# idea026120 - mcp-core Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/specialists/mcp_core.py` with objective: Reduce friction for contributors and operators.
