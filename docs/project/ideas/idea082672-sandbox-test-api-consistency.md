# idea082672 - sandbox-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/sandbox_test.py` with objective: Normalize interfaces and reduce behavioral drift.
