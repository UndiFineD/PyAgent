# idea163526 - stats API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_lib/src/text/stats.rs` with objective: Normalize interfaces and reduce behavioral drift.
