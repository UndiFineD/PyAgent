# idea189090 - pool API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/tokenization/pool.py` with objective: Normalize interfaces and reduce behavioral drift.
