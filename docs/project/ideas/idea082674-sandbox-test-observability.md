# idea082674 - sandbox-test Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/sandbox_test.py` with objective: Improve logs, metrics, and debugging visibility.
