# idea143931 - delete-skipped-external-test Resilience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/delete_skipped_external_test.py` with objective: Improve fault tolerance and recovery behavior.
