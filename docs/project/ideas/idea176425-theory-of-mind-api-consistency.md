# idea176425 - theory-of-mind API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/theory_of_mind.py` with objective: Normalize interfaces and reduce behavioral drift.
