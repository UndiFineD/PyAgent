# idea132516 - aem-server Resilience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/scanners/cms/aem_server.py` with objective: Improve fault tolerance and recovery behavior.
