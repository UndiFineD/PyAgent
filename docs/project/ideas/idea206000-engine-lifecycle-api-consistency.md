# idea206000 - engine-lifecycle API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/engine_lifecycle.py` with objective: Normalize interfaces and reduce behavioral drift.
