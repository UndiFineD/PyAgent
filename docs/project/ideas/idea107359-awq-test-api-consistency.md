# idea107359 - awq-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/quantization/engine/awq_test.py` with objective: Normalize interfaces and reduce behavioral drift.
