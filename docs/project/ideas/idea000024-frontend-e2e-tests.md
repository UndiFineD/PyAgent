# idea-024 - frontend-e2e-tests

Planned project mapping: None yet

## Idea summary
This idea focuses on frontend e2e tests in area 4 – Frontend. The current signal indicates priority P3, impact H, and urgency M. The SWOT tag is W (Weakness in current implementation).

## Problem statement
The frontend has only 2 Vitest unit tests covering ~2% of 10 app windows and 6 components. No Playwright or Cypress E2E suite exists.
