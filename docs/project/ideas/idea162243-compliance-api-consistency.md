# idea162243 - compliance API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/agents/compliance.rs` with objective: Normalize interfaces and reduce behavioral drift.
