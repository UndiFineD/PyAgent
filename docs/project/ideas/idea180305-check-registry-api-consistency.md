# idea180305 - check-registry API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/check_registry.py` with objective: Normalize interfaces and reduce behavioral drift.
