# idea106330 - request-priority-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/backend/request_priority_test.py` with objective: Normalize interfaces and reduce behavioral drift.
