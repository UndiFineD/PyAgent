# idea194310 - topology-reporter API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/topology_reporter.py` with objective: Normalize interfaces and reduce behavioral drift.
