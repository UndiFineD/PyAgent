# idea186953 - iteration-metrics API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/iteration_metrics.py` with objective: Normalize interfaces and reduce behavioral drift.
