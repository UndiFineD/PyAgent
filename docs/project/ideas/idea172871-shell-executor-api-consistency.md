# idea172871 - shell-executor API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/execution/shell_executor.py` with objective: Normalize interfaces and reduce behavioral drift.
