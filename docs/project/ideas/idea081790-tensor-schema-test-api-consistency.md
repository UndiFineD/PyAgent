# idea081790 - tensor-schema-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/validation/tensor_schema_test.py` with objective: Normalize interfaces and reduce behavioral drift.
