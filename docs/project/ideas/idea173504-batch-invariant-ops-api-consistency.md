# idea173504 - batch-invariant-ops API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/math/batch_invariant_ops.py` with objective: Normalize interfaces and reduce behavioral drift.
