# idea047009 - apply-ast-patches-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/apply_ast_patches_test.py` with objective: Normalize interfaces and reduce behavioral drift.
