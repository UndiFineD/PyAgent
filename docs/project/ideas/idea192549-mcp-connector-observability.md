# idea192549 - mcp-connector Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/fleet/mcp_connector.py` with objective: Improve logs, metrics, and debugging visibility.
