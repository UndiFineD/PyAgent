# idea149654 - infrastructure-dev-scripts-debug-registry-improvements API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/infrastructure_dev_scripts_debug_registry_improvements.md` with objective: Normalize interfaces and reduce behavioral drift.
