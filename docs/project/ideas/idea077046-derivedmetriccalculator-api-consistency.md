# idea077046 - derivedmetriccalculator API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/stats/DerivedMetricCalculator.py` with objective: Normalize interfaces and reduce behavioral drift.
