# idea179691 - requestmetrics.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/stats/RequestMetrics.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
