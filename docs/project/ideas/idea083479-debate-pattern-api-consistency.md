# idea083479 - debate-pattern API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/work_patterns/debate_pattern.py` with objective: Normalize interfaces and reduce behavioral drift.
