# idea025987 - runtime API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/runtime.py` with objective: Normalize interfaces and reduce behavioral drift.
