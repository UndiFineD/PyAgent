# idea191856 - group API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/distributed/tp/group.py` with objective: Normalize interfaces and reduce behavioral drift.
