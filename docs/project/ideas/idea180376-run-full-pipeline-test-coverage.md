# idea180376 - run-full-pipeline Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/run_full_pipeline.py` with objective: Increase deterministic test coverage and reliability.
