# idea104449 - signal-module-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/modules/signal_module_test.py` with objective: Normalize interfaces and reduce behavioral drift.
