# idea120401 - mcp-connector-test Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/fleet/mcp_connector_test.py` with objective: Improve logs, metrics, and debugging visibility.
