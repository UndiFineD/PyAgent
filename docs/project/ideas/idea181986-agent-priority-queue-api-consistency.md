# idea181986 - agent-priority-queue API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/utils/agent_priority_queue.py` with objective: Normalize interfaces and reduce behavioral drift.
