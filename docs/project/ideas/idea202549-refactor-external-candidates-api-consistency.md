# idea202549 - refactor-external-candidates API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/refactor_external_candidates.py` with objective: Normalize interfaces and reduce behavioral drift.
