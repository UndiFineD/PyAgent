# idea086796 - memory-consolidator-core-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/core/memory_consolidator_core_test.py` with objective: Normalize interfaces and reduce behavioral drift.
