# idea190704 - adapter API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/mcp/adapter.py` with objective: Normalize interfaces and reduce behavioral drift.
