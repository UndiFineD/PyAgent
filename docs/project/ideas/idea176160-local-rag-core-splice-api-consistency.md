# idea176160 - local-rag-core.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/core/local_rag_core.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
