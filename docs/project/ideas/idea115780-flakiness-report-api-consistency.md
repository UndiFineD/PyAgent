# idea115780 - flakiness-report API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/flakiness_report.py` with objective: Normalize interfaces and reduce behavioral drift.
