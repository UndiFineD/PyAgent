# idea144097 - test-decode-suggestions-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/test_decode_suggestions_test.py` with objective: Normalize interfaces and reduce behavioral drift.
