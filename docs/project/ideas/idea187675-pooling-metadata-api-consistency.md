# idea187675 - pooling-metadata API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/pooling/pooling_metadata.py` with objective: Normalize interfaces and reduce behavioral drift.
