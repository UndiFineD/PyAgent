...
## Idea summary
This idea is derived from docs/transaction-manager-architecture.md and targets transaction manager architecture improvements in area Runtime. The goal is to convert documentation guidance into an actionable project slice with clear ownership, measurable outcomes, and safe rollout boundaries.
