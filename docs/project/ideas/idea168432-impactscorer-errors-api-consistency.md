# idea168432 - impactscorer.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/ImpactScorer.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
