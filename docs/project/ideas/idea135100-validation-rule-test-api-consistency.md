# idea135100 - validation-rule-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/swarm/validation_rule_test.py` with objective: Normalize interfaces and reduce behavioral drift.
