# idea197255 - markdown-agent API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/development/markdown_agent.py` with objective: Normalize interfaces and reduce behavioral drift.
