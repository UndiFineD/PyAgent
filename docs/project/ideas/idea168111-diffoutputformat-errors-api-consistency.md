# idea168111 - diffoutputformat.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/DiffOutputFormat.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
