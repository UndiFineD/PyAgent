# idea193913 - meta-optimizer API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/orchestration/swarm/meta_optimizer.py` with objective: Normalize interfaces and reduce behavioral drift.
