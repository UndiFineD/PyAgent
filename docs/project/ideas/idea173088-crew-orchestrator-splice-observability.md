# idea173088 - crew-orchestrator.splice Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/core/crew_orchestrator.splice.md` with objective: Improve logs, metrics, and debugging visibility.
