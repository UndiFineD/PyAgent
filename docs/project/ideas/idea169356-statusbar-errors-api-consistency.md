# idea169356 - statusbar.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/StatusBar.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
