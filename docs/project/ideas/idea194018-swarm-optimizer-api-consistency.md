# idea194018 - swarm-optimizer API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/orchestration/swarm/swarm_optimizer.py` with objective: Normalize interfaces and reduce behavioral drift.
