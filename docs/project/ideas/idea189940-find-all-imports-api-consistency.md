# idea189940 - find-all-imports API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/scripts/management/find_all_imports.py` with objective: Normalize interfaces and reduce behavioral drift.
