# idea070292 - run-pytest API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts-old/root-cleanup-2026-03-08/run_pytest.py` with objective: Normalize interfaces and reduce behavioral drift.
