# idea143647 - test-workflow-engine API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/test_workflow_engine.py` with objective: Normalize interfaces and reduce behavioral drift.
