# idea162017 - world-models API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/key/world_models.md` with objective: Normalize interfaces and reduce behavioral drift.
