# idea180093 - request-metrics.py.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/stats/request_metrics.py.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
