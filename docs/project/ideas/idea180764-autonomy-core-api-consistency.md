# idea180764 - autonomy-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/autonomy_core.py` with objective: Normalize interfaces and reduce behavioral drift.
