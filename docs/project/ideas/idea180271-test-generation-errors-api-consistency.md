# idea180271 - test-generation.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/test_generation.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
