# idea092189 - suppressionrule-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/errors/SuppressionRule_test.py` with objective: Normalize interfaces and reduce behavioral drift.
