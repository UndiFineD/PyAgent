# idea167252 - check-imports API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts-old/check_imports.py` with objective: Normalize interfaces and reduce behavioral drift.
