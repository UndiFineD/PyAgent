# idea186154 - manager API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/adapters/lora/manager.py` with objective: Normalize interfaces and reduce behavioral drift.
