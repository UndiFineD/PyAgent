# idea162278 - pruning API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/agents/pruning.rs` with objective: Normalize interfaces and reduce behavioral drift.
