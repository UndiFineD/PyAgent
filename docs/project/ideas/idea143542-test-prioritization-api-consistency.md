# idea143542 - test-prioritization API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/test_prioritization.py` with objective: Normalize interfaces and reduce behavioral drift.
