# idea183453 - web-security-scanner-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/security/web_security_scanner_core.py` with objective: Normalize interfaces and reduce behavioral drift.
