# idea186312 - sdpa API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/attention/backend/sdpa.py` with objective: Normalize interfaces and reduce behavioral drift.
