# idea116248 - test-data-seeder API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/test_data_seeder.py` with objective: Normalize interfaces and reduce behavioral drift.
