# idea070549 - delete-skipped-external Resilience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts/delete_skipped_external.py` with objective: Improve fault tolerance and recovery behavior.
