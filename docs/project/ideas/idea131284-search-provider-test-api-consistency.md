# idea131284 - search-provider-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/intelligence/search_provider_test.py` with objective: Normalize interfaces and reduce behavioral drift.
