# idea185423 - usage-record API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/backend/usage_record.py` with objective: Normalize interfaces and reduce behavioral drift.
