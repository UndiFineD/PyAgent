# idea100930 - advanced-web-scanning-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/advanced_web_scanning_core.py` with objective: Normalize interfaces and reduce behavioral drift.
