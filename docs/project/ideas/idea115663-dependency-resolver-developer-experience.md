# idea115663 - dependency-resolver Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/dependency_resolver.py` with objective: Reduce friction for contributors and operators.
