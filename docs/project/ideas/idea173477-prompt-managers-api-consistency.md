# idea173477 - prompt-managers API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/managers/prompt_managers.py` with objective: Normalize interfaces and reduce behavioral drift.
