# idea066887 - find-remaining-candidates Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `plugins/find_remaining_candidates.py` with objective: Reduce friction for contributors and operators.
