# idea203625 - fix-unterminated-strings-aggressive API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/fix_unterminated_strings_aggressive.py` with objective: Normalize interfaces and reduce behavioral drift.
