# idea099577 - test-runner API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/utils/test_runner.py` with objective: Normalize interfaces and reduce behavioral drift.
