# idea194040 - swarm-training API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/orchestration/swarm/swarm_training.py` with objective: Normalize interfaces and reduce behavioral drift.
