# idea175657 - knowledge-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/context/engines/knowledge_core.py` with objective: Normalize interfaces and reduce behavioral drift.
