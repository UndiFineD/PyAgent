# idea174882 - monorepo-aggregator API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/utils/monorepo_aggregator.py` with objective: Normalize interfaces and reduce behavioral drift.
