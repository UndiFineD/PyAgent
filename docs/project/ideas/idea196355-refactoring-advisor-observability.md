# idea196355 - refactoring-advisor Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/cognitive/context/utils/refactoring_advisor.py` with objective: Improve logs, metrics, and debugging visibility.
