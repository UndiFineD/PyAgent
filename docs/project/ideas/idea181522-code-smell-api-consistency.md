# idea181522 - code-smell API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/types/code_smell.py` with objective: Normalize interfaces and reduce behavioral drift.
