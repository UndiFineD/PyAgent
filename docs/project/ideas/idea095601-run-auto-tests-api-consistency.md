# idea095601 - run-auto-tests API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/run_auto_tests.py` with objective: Normalize interfaces and reduce behavioral drift.
