# idea175225 - bmad-manager API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/interface/ui/gui/bmad_manager.py` with objective: Normalize interfaces and reduce behavioral drift.
