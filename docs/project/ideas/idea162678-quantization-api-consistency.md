# idea162678 - quantization API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/quantlora/quantization.rs` with objective: Normalize interfaces and reduce behavioral drift.
