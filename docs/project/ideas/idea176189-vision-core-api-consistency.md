# idea176189 - vision-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/core/vision_core.py` with objective: Normalize interfaces and reduce behavioral drift.
