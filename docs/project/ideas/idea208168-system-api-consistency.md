# idea208168 - system API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `data/prompts/mcp/system.md` with objective: Normalize interfaces and reduce behavioral drift.
