# idea025768 - semantic-decay-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/memory/semantic_decay_test.py` with objective: Normalize interfaces and reduce behavioral drift.
