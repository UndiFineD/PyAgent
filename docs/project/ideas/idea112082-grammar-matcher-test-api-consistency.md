# idea112082 - grammar-matcher-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/structured/grammar_matcher_test.py` with objective: Normalize interfaces and reduce behavioral drift.
