# idea198218 - aem-ssrf2rce Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/scanners/cms/aem_ssrf2rce.py` with objective: Increase deterministic test coverage and reliability.
