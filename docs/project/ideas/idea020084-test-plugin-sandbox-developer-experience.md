# idea020084 - test-plugin-sandbox Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/test_plugin_sandbox.py` with objective: Reduce friction for contributors and operators.
