# idea175301 - py-agent-web API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/interface/ui/web/py_agent_web.py` with objective: Normalize interfaces and reduce behavioral drift.
