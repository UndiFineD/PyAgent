# idea182887 - maestro-threat-model-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/maestro_threat_model_core.py` with objective: Normalize interfaces and reduce behavioral drift.
