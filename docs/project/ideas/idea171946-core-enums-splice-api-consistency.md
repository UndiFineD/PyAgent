# idea171946 - core-enums.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/models/core_enums.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
