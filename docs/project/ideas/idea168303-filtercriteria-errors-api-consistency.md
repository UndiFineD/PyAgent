# idea168303 - filtercriteria.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/FilterCriteria.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
