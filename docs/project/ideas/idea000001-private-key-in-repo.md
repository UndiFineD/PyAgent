...
## Problem statement
`rust_core/2026-03-11-keys.priv` is a private cryptographic key committed to the repository. Any clone leaks the secret; rotate immediately and add a pre-commit secret-scan hook.
