# idea124847 - loader API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/interface/slash_commands/loader.py` with objective: Normalize interfaces and reduce behavioral drift.
