# idea174591 - env-config API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/config/env_config.py` with objective: Normalize interfaces and reduce behavioral drift.
