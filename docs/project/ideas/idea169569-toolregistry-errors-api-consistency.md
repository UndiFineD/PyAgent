# idea169569 - toolregistry.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/ToolRegistry.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
