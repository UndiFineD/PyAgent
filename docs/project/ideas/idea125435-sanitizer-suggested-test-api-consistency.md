# idea125435 - sanitizer.suggested-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/android/core/sanitizer.suggested_test.py` with objective: Normalize interfaces and reduce behavioral drift.
