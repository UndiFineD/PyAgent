# idea084028 - loop-analyzer-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/specialists/loop_analyzer_test.py` with objective: Normalize interfaces and reduce behavioral drift.
