# idea019669 - apply-ast-patches Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/apply_ast_patches.py` with objective: Reduce friction for contributors and operators.
