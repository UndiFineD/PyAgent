# idea184260 - doc-gen-module API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/modules/doc_gen_module.py` with objective: Normalize interfaces and reduce behavioral drift.
