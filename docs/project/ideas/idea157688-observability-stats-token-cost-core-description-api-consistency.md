# idea157688 - observability-stats-token-cost-core-description API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/observability_stats_token_cost_core_description.md` with objective: Normalize interfaces and reduce behavioral drift.
