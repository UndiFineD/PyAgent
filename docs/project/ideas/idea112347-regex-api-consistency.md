# idea112347 - regex API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/structured/regex.py` with objective: Normalize interfaces and reduce behavioral drift.
