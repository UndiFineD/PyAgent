# idea173292 - resilience-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/core/resilience_core.py` with objective: Normalize interfaces and reduce behavioral drift.
