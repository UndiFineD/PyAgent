# idea167508 - delete-skipped-external API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts/delete_skipped_external.py` with objective: Normalize interfaces and reduce behavioral drift.
