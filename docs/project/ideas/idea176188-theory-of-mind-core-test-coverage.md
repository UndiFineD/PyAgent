# idea176188 - theory-of-mind-core Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/core/theory_of_mind_core.py` with objective: Increase deterministic test coverage and reliability.
