# idea070580 - run-refactor-with-warnings API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts/run_refactor_with_warnings.py` with objective: Normalize interfaces and reduce behavioral drift.
