# idea170114 - pluginmanager API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/base_agent/managers/PluginManager.py` with objective: Normalize interfaces and reduce behavioral drift.
