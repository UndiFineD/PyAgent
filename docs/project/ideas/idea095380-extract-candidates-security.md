# idea095380 - extract-candidates Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/extract_candidates.py` with objective: Reduce security exposure and harden boundaries.
