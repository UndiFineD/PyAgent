# idea180322 - core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/download_agent/core.py` with objective: Normalize interfaces and reduce behavioral drift.
