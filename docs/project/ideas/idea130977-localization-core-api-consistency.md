# idea130977 - localization-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/intelligence/core/localization_core.py` with objective: Normalize interfaces and reduce behavioral drift.
