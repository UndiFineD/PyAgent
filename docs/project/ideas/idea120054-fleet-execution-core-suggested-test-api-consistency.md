# idea120054 - fleet-execution-core.suggested-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/fleet/fleet_execution_core.suggested_test.py` with objective: Normalize interfaces and reduce behavioral drift.
