# idea047209 - run-auto-tests Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/run_auto_tests.py` with objective: Reduce friction for contributors and operators.
