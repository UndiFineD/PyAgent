# idea132532 - aem-ssrf2rce Resilience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/scanners/cms/aem_ssrf2rce.py` with objective: Improve fault tolerance and recovery behavior.
