# idea174674 - consensusmodule API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/modules/ConsensusModule.py` with objective: Normalize interfaces and reduce behavioral drift.
