# idea143447 - test-dryrun-lists-moves API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/test_dryrun_lists_moves.py` with objective: Normalize interfaces and reduce behavioral drift.
