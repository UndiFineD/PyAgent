# idea180364 - move-external-to-src Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/move_external_to_src.py` with objective: Increase deterministic test coverage and reliability.
