# idea161967 - text-to-sql Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/key/text_to_sql.md` with objective: Improve logs, metrics, and debugging visibility.
