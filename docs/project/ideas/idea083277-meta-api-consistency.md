# idea083277 - meta API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/utils/jsontree/meta.py` with objective: Normalize interfaces and reduce behavioral drift.
