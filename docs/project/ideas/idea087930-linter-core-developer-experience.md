# idea087930 - linter-core Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/development/core/linter_core.py` with objective: Reduce friction for contributors and operators.
