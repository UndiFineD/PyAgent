# idea174619 - graph-store API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/knowledge/graph_store.py` with objective: Normalize interfaces and reduce behavioral drift.
