# idea185317 - system-capability API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/backend/system_capability.py` with objective: Normalize interfaces and reduce behavioral drift.
