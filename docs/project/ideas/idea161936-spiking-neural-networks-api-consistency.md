# idea161936 - spiking-neural-networks API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/key/spiking_neural_networks.md` with objective: Normalize interfaces and reduce behavioral drift.
