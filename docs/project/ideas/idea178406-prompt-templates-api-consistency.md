# idea178406 - prompt-templates API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/cognitive/prompt_templates.py` with objective: Normalize interfaces and reduce behavioral drift.
