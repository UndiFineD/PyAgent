# idea173884 - task-prioritization API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/task_prioritization.py` with objective: Normalize interfaces and reduce behavioral drift.
