# idea190123 - import-refactorer API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/scripts/refactoring/import_refactorer.py` with objective: Normalize interfaces and reduce behavioral drift.
