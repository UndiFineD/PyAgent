# idea101288 - formatting-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/formatting_test.py` with objective: Normalize interfaces and reduce behavioral drift.
