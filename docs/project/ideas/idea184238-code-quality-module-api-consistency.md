# idea184238 - code-quality-module API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/modules/code_quality_module.py` with objective: Normalize interfaces and reduce behavioral drift.
