# idea190260 - dependency-resolver API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/dependency_resolver.py` with objective: Normalize interfaces and reduce behavioral drift.
