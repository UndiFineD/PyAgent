# idea186024 - reader API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/tensorizer/core/reader.py` with objective: Normalize interfaces and reduce behavioral drift.
