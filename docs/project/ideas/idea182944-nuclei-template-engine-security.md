# idea182944 - nuclei-template-engine Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/nuclei_template_engine.py` with objective: Reduce security exposure and harden boundaries.
