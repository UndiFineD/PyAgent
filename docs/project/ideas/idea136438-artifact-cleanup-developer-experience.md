# idea136438 - artifact-cleanup Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/maintenance/artifact_cleanup.py` with objective: Reduce friction for contributors and operators.
