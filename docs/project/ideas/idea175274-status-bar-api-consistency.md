# idea175274 - status-bar API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/interface/ui/gui/status_bar.py` with objective: Normalize interfaces and reduce behavioral drift.
