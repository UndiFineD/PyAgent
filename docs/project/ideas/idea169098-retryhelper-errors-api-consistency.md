# idea169098 - retryhelper.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/RetryHelper.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
