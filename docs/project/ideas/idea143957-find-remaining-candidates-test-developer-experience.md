# idea143957 - find-remaining-candidates-test Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/find_remaining_candidates_test.py` with objective: Reduce friction for contributors and operators.
