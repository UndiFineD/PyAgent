# idea198000 - event-correlation-agent API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/event_correlation_agent.py` with objective: Normalize interfaces and reduce behavioral drift.
