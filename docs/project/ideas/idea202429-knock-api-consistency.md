# idea202429 - knock API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/knock.py` with objective: Normalize interfaces and reduce behavioral drift.
