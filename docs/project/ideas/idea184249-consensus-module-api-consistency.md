# idea184249 - consensus-module API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/modules/consensus_module.py` with objective: Normalize interfaces and reduce behavioral drift.
