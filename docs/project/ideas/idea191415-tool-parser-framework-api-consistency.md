# idea191415 - tool-parser-framework API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/tools/tool_parser_framework.py` with objective: Normalize interfaces and reduce behavioral drift.
