# idea193017 - workflow-state API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/fleet/workflow_state.py` with objective: Normalize interfaces and reduce behavioral drift.
