# idea182896 - mcp-validator-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/mcp_validator_core.py` with objective: Normalize interfaces and reduce behavioral drift.
