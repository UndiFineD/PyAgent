# idea175946 - semantic-search-result API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/context/models/semantic_search_result.py` with objective: Normalize interfaces and reduce behavioral drift.
