# idea175026 - proposals.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/inference/speculation/engine/proposals.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
