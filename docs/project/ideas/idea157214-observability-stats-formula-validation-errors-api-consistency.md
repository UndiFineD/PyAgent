# idea157214 - observability-stats-formula-validation-errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/observability_stats_formula_validation_errors.md` with objective: Normalize interfaces and reduce behavioral drift.
