# idea072977 - logger API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/auto_fix/logger.py` with objective: Normalize interfaces and reduce behavioral drift.
