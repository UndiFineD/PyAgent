# idea096538 - auction-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/auction_core.py` with objective: Normalize interfaces and reduce behavioral drift.
