# idea143677 - test-metrics-collector API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/tools/test_metrics_collector.py` with objective: Normalize interfaces and reduce behavioral drift.
