# idea189630 - visualize-swarm-graph API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/scripts/analysis/visualize_swarm_graph.py` with objective: Normalize interfaces and reduce behavioral drift.
