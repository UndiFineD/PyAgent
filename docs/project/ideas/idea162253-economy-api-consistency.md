# idea162253 - economy API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/agents/economy.rs` with objective: Normalize interfaces and reduce behavioral drift.
