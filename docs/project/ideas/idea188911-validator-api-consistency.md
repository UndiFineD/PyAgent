# idea188911 - validator API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/structured/params/validator.py` with objective: Normalize interfaces and reduce behavioral drift.
