# idea098164 - code-smell Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/types/code_smell.py` with objective: Reduce friction for contributors and operators.
