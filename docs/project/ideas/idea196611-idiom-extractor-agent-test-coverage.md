# idea196611 - idiom-extractor-agent Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/cognitive/idiom_extractor_agent.py` with objective: Increase deterministic test coverage and reliability.
