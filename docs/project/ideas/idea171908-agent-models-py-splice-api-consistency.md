# idea171908 - agent-models.py.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/models/agent_models.py.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
