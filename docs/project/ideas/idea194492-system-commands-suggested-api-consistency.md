# idea194492 - system-commands.suggested API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/interface/commands/builtins/system_commands.suggested.py` with objective: Normalize interfaces and reduce behavioral drift.
