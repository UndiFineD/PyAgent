# idea162140 - metrics-bench API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `performance/metrics_bench.py` with objective: Normalize interfaces and reduce behavioral drift.
