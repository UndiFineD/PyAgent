# idea187813 - models API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/prompt_renderer/models.py` with objective: Normalize interfaces and reduce behavioral drift.
