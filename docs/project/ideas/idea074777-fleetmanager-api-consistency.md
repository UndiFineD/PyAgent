# idea074777 - fleetmanager API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/fleet/FleetManager.py` with objective: Normalize interfaces and reduce behavioral drift.
