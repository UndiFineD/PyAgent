# idea143928 - delete-skipped-external-test Documentation

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/delete_skipped_external_test.py` with objective: Improve docs and operational guidance quality.
