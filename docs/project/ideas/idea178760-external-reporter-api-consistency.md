# idea178760 - external-reporter API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/errors/external_reporter.py` with objective: Normalize interfaces and reduce behavioral drift.
