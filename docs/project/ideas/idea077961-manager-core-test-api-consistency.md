# idea077961 - manager-core-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/manager_core_test.py` with objective: Normalize interfaces and reduce behavioral drift.
