# idea202474 - move-external-to-src.py.auto-fix Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/move_external_to_src.py.auto_fix.bak` with objective: Improve logs, metrics, and debugging visibility.
