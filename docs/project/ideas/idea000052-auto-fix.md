...
## Idea summary
This idea is derived from docs/auto_fix.md and targets auto fix improvements in area Architecture. The goal is to convert documentation guidance into an actionable project slice with clear ownership, measurable outcomes, and safe rollout boundaries.
