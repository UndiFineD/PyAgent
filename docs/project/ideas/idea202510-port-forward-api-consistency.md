# idea202510 - port-forward API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/port_forward.py` with objective: Normalize interfaces and reduce behavioral drift.
