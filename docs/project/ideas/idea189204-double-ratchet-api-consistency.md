# idea189204 - double-ratchet API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/security/encryption/double_ratchet.py` with objective: Normalize interfaces and reduce behavioral drift.
