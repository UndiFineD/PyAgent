# idea173153 - formatting API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/core/formatting.py` with objective: Normalize interfaces and reduce behavioral drift.
