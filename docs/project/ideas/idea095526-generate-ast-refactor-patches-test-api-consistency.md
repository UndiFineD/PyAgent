# idea095526 - generate-ast-refactor-patches-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/generate_ast_refactor_patches_test.py` with objective: Normalize interfaces and reduce behavioral drift.
