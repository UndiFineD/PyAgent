# idea178466 - direct-strategy API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/strategies/direct_strategy.py` with objective: Normalize interfaces and reduce behavioral drift.
