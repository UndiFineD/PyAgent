# idea070565 - generate-test-data API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts/generate_test_data.py` with objective: Normalize interfaces and reduce behavioral drift.
