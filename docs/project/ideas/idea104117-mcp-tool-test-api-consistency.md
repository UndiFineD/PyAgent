# idea104117 - mcp-tool-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/integrations/mcp/mcp_tool_test.py` with objective: Normalize interfaces and reduce behavioral drift.
