# idea203192 - widget-logger API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/userspace/interface/ui/gui/widget_logger.py` with objective: Normalize interfaces and reduce behavioral drift.
