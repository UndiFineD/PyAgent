# idea206716 - system Hardening

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `data/prompts/analyst/system.md` with objective: Reduce defects and improve safety posture.
