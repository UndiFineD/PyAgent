# idea171938 - core-enums API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/models/core_enums.py` with objective: Normalize interfaces and reduce behavioral drift.
