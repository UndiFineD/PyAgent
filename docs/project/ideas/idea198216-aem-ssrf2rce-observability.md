# idea198216 - aem-ssrf2rce Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/scanners/cms/aem_ssrf2rce.py` with objective: Improve logs, metrics, and debugging visibility.
