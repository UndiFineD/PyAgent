# idea132810 - extract-apk-helpers-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/scanners/mobile/android_scanner/utils/extract_apk_helpers_test.py` with objective: Normalize interfaces and reduce behavioral drift.
