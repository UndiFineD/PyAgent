# idea095372 - external-refactor-scan-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/external_refactor_scan_test.py` with objective: Normalize interfaces and reduce behavioral drift.
