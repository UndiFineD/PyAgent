# idea180975 - knowledge-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/knowledge_core.py` with objective: Normalize interfaces and reduce behavioral drift.
