# idea194738 - registry API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/interface/slash_commands/registry.py` with objective: Normalize interfaces and reduce behavioral drift.
