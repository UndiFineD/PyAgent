# idea196609 - idiom-extractor-agent Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/cognitive/idiom_extractor_agent.py` with objective: Improve logs, metrics, and debugging visibility.
