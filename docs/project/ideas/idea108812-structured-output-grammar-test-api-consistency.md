# idea108812 - structured-output-grammar-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/decoding/structured_output_grammar_test.py` with objective: Normalize interfaces and reduce behavioral drift.
