# idea191013 - cpu API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/platform/cpu.py` with objective: Normalize interfaces and reduce behavioral drift.
