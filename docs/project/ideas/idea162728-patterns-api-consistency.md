# idea162728 - patterns API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/security/patterns.rs` with objective: Normalize interfaces and reduce behavioral drift.
