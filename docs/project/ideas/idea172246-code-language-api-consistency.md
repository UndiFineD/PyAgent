# idea172246 - code-language API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/types/code_language.py` with objective: Normalize interfaces and reduce behavioral drift.
