# idea020927 - manager-core-test Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/manager_core_test.py` with objective: Reduce friction for contributors and operators.
