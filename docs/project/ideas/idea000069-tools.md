...
## Idea summary
This idea is derived from docs/tools.md and targets tools improvements in area Tooling. The goal is to convert documentation guidance into an actionable project slice with clear ownership, measurable outcomes, and safe rollout boundaries.
