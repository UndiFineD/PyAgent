# idea115726 - fixture-factory API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/fixture_factory.py` with objective: Normalize interfaces and reduce behavioral drift.
