# idea026362 - proposals-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/inference/speculation/engine/proposals_test.py` with objective: Normalize interfaces and reduce behavioral drift.
