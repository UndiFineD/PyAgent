# idea161807 - onnx API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/key/onnx.md` with objective: Normalize interfaces and reduce behavioral drift.
