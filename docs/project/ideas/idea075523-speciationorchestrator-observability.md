# idea075523 - speciationorchestrator Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/orchestration/SpeciationOrchestrator.py` with objective: Improve logs, metrics, and debugging visibility.
