# idea169704 - agent-coder API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/agent_coder.py` with objective: Normalize interfaces and reduce behavioral drift.
