# idea188084 - kernels Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/sampling/kernels.py` with objective: Improve logs, metrics, and debugging visibility.
