# idea174514 - validationrulemanager API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/utils/ValidationRuleManager.py` with objective: Normalize interfaces and reduce behavioral drift.
