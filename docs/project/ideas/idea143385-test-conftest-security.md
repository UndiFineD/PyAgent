# idea143385 - test-conftest Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/test_conftest.py` with objective: Reduce security exposure and harden boundaries.
