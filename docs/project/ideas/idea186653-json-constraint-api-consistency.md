# idea186653 - json-constraint API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/decoding/grammar/json_constraint.py` with objective: Normalize interfaces and reduce behavioral drift.
