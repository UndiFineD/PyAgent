# idea162348 - autonomy API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/base/autonomy.rs` with objective: Normalize interfaces and reduce behavioral drift.
