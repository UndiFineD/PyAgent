# idea129512 - theory-of-mind-test Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/cognitive/theory_of_mind_test.py` with objective: Increase deterministic test coverage and reliability.
