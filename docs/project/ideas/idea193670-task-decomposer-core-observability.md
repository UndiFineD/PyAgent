# idea193670 - task-decomposer-core Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/orchestration/intel/task_decomposer_core.py` with objective: Improve logs, metrics, and debugging visibility.
