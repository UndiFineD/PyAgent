# idea141680 - run-auto-tests-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/run_auto_tests_test.py` with objective: Normalize interfaces and reduce behavioral drift.
