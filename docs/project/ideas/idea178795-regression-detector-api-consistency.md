# idea178795 - regression-detector API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/errors/regression_detector.py` with objective: Normalize interfaces and reduce behavioral drift.
