# idea192207 - gpu-monitor-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/fleet/core/gpu_monitor_core.py` with objective: Normalize interfaces and reduce behavioral drift.
