# idea161471 - decision-transformers API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/key/decision_transformers.md` with objective: Normalize interfaces and reduce behavioral drift.
