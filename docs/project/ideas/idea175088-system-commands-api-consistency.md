# idea175088 - system-commands API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/interface/commands/builtins/system_commands.py` with objective: Normalize interfaces and reduce behavioral drift.
