# idea125116 - consistency-agent-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/analysis/consistency_agent_test.py` with objective: Normalize interfaces and reduce behavioral drift.
