# idea205816 - fix-indentation API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts-old/fix_indentation.py` with objective: Normalize interfaces and reduce behavioral drift.
