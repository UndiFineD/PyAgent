# idea201422 - export-format API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/observability/reports/export_format.py` with objective: Normalize interfaces and reduce behavioral drift.
