# idea202267 - apply-ast-patches API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/apply_ast_patches.py` with objective: Normalize interfaces and reduce behavioral drift.
