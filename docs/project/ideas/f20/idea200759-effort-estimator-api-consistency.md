# idea200759 - effort-estimator API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/observability/improvements/effort_estimator.py` with objective: Normalize interfaces and reduce behavioral drift.
