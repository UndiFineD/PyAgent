# idea206110 - top-k-top-p-sampler API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/sampling/top_k_top_p_sampler.py` with objective: Normalize interfaces and reduce behavioral drift.
