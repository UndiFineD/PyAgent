# idea202458 - metrics API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/metrics.py` with objective: Normalize interfaces and reduce behavioral drift.
