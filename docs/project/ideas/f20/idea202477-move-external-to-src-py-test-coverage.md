# idea202477 - move-external-to-src.py Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/move_external_to_src.py.bak` with objective: Increase deterministic test coverage and reliability.
