# idea202804 - agent-column API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/userspace/interface/ui/gui/agent_column.py` with objective: Normalize interfaces and reduce behavioral drift.
