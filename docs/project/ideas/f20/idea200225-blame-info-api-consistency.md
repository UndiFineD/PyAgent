# idea200225 - blame-info API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/observability/errors/blame_info.py` with objective: Normalize interfaces and reduce behavioral drift.
