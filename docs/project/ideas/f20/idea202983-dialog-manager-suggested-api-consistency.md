# idea202983 - dialog-manager.suggested API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/userspace/interface/ui/gui/dialog_manager.suggested.py` with objective: Normalize interfaces and reduce behavioral drift.
