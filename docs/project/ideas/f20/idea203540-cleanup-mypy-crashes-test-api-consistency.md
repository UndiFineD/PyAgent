# idea203540 - cleanup-mypy-crashes-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/cleanup_mypy_crashes_test.py` with objective: Normalize interfaces and reduce behavioral drift.
