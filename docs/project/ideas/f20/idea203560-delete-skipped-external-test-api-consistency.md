# idea203560 - delete-skipped-external-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/delete_skipped_external_test.py` with objective: Normalize interfaces and reduce behavioral drift.
