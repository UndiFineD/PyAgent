# idea203545 - cleanup-repo API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/cleanup_repo.py` with objective: Normalize interfaces and reduce behavioral drift.
