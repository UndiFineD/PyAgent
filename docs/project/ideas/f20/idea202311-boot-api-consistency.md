# idea202311 - boot API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/boot.py` with objective: Normalize interfaces and reduce behavioral drift.
