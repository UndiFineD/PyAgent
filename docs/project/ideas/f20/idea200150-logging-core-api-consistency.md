# idea200150 - logging-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/observability/core/logging_core.py` with objective: Normalize interfaces and reduce behavioral drift.
