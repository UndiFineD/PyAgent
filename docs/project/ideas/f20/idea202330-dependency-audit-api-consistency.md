# idea202330 - dependency-audit API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/dependency_audit.py` with objective: Normalize interfaces and reduce behavioral drift.
