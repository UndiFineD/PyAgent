# idea206518 - bridge API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/mcp/bridge.py` with objective: Normalize interfaces and reduce behavioral drift.
