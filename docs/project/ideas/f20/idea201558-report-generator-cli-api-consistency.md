# idea201558 - report-generator-cli API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/observability/reports/report_generator_cli.py` with objective: Normalize interfaces and reduce behavioral drift.
