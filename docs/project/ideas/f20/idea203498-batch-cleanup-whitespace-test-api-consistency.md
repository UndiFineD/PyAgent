# idea203498 - batch-cleanup-whitespace-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/batch_cleanup_whitespace_test.py` with objective: Normalize interfaces and reduce behavioral drift.
