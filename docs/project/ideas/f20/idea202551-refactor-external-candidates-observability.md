# idea202551 - refactor-external-candidates Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/refactor_external_candidates.py` with objective: Improve logs, metrics, and debugging visibility.
