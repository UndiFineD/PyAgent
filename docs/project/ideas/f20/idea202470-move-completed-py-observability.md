# idea202470 - move-completed.py Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/move_completed.py.bak` with objective: Improve logs, metrics, and debugging visibility.
