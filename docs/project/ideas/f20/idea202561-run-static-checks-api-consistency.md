# idea202561 - run-static-checks API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/run_static_checks.py` with objective: Normalize interfaces and reduce behavioral drift.
