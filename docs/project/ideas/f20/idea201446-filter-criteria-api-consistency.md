# idea201446 - filter-criteria API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/observability/reports/filter_criteria.py` with objective: Normalize interfaces and reduce behavioral drift.
