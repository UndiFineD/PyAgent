# idea202583 - self-heal API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/self_heal.py` with objective: Normalize interfaces and reduce behavioral drift.
