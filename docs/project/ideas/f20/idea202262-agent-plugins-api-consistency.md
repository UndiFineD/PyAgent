# idea202262 - agent-plugins API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/agent_plugins.py` with objective: Normalize interfaces and reduce behavioral drift.
