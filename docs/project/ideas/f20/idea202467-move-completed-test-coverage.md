# idea202467 - move-completed Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/move_completed.py` with objective: Increase deterministic test coverage and reliability.
