# idea202873 - agent-runner.suggested API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/userspace/interface/ui/gui/agent_runner.suggested.py` with objective: Normalize interfaces and reduce behavioral drift.
