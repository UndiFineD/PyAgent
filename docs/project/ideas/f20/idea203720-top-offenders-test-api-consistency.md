# idea203720 - top-offenders-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/top_offenders_test.py` with objective: Normalize interfaces and reduce behavioral drift.
