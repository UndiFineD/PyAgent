# idea174968 - pooling API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/inference/execution/model_runner/pooling.py` with objective: Normalize interfaces and reduce behavioral drift.
