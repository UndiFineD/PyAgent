# idea004920 - move-completed-test Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/move_completed_test.py` with objective: Reduce friction for contributors and operators.
