# idea163011 - redqueen API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_lib/src/agents/redqueen.rs` with objective: Normalize interfaces and reduce behavioral drift.
