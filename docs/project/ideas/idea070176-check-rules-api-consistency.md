# idea070176 - check-rules API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts-old/check_rules.py` with objective: Normalize interfaces and reduce behavioral drift.
