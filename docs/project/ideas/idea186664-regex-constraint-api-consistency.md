# idea186664 - regex-constraint API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/decoding/grammar/regex_constraint.py` with objective: Normalize interfaces and reduce behavioral drift.
