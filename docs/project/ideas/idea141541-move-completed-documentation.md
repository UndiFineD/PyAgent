# idea141541 - move-completed Documentation

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/move_completed.py` with objective: Improve docs and operational guidance quality.
