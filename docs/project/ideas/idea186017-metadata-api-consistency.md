# idea186017 - metadata API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/tensorizer/core/metadata.py` with objective: Normalize interfaces and reduce behavioral drift.
