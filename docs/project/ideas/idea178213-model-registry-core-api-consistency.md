# idea178213 - model-registry-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/system/core/model_registry_core.py` with objective: Normalize interfaces and reduce behavioral drift.
