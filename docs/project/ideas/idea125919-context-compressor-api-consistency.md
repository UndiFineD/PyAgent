# idea125919 - context-compressor API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/cognitive/context/engines/context_compressor.py` with objective: Normalize interfaces and reduce behavioral drift.
