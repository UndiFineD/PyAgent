# idea175081 - base.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/interface/commands/base.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
