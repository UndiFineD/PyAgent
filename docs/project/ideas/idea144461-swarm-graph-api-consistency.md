# idea144461 - swarm-graph API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/architecture/swarm_graph.md` with objective: Normalize interfaces and reduce behavioral drift.
