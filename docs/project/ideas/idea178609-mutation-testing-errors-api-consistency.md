# idea178609 - mutation-testing.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/mutation_testing.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
