# idea032185 - flakiness-detector Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/flakiness_detector.py` with objective: Reduce friction for contributors and operators.
