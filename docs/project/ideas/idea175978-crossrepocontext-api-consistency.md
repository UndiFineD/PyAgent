# idea175978 - crossrepocontext API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/context/utils/CrossRepoContext.py` with objective: Normalize interfaces and reduce behavioral drift.
