# idea168930 - regressiondetector.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/RegressionDetector.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
