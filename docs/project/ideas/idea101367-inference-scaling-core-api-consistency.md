# idea101367 - inference-scaling-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/inference_scaling_core.py` with objective: Normalize interfaces and reduce behavioral drift.
