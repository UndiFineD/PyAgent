# idea175018 - proposals API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/inference/speculation/engine/proposals.py` with objective: Normalize interfaces and reduce behavioral drift.
