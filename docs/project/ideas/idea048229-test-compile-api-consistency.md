# idea048229 - test-compile API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/test_compile.py` with objective: Normalize interfaces and reduce behavioral drift.
