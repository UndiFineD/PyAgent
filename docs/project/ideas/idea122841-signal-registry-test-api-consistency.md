# idea122841 - signal-registry-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/orchestration/signals/signal_registry_test.py` with objective: Normalize interfaces and reduce behavioral drift.
