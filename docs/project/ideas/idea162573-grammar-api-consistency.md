# idea162573 - grammar API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/multimodal/grammar.rs` with objective: Normalize interfaces and reduce behavioral drift.
