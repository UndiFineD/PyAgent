# idea181624 - feed-format API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/types/feed_format.py` with objective: Normalize interfaces and reduce behavioral drift.
