# idea162823 - search API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/text/search.rs` with objective: Normalize interfaces and reduce behavioral drift.
