# idea082783 - flatlogprobs API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/structures/FlatLogprobs.py` with objective: Normalize interfaces and reduce behavioral drift.
