# idea167601 - agentassertions.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/AgentAssertions.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
