# idea182370 - agent-delegator API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/execution/agent_delegator.py` with objective: Normalize interfaces and reduce behavioral drift.
