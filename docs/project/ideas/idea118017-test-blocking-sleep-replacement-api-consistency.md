# idea118017 - test-blocking-sleep-replacement API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/resilience/test_blocking_sleep_replacement.py` with objective: Normalize interfaces and reduce behavioral drift.
