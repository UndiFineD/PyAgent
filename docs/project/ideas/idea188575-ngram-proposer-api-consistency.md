# idea188575 - ngram-proposer API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/speculative/ngram_proposer.py` with objective: Normalize interfaces and reduce behavioral drift.
