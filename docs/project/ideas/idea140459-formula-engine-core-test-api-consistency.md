# idea140459 - formula-engine-core-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/observability/stats/engine/formula_engine_core_test.py` with objective: Normalize interfaces and reduce behavioral drift.
