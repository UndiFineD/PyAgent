# idea080789 - tenant-isolation-core-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/core/tenant_isolation_core_test.py` with objective: Normalize interfaces and reduce behavioral drift.
