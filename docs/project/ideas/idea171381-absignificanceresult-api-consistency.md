# idea171381 - absignificanceresult API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/stats/ABSignificanceResult.py` with objective: Normalize interfaces and reduce behavioral drift.
