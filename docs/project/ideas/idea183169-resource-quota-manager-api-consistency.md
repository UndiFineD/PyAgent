# idea183169 - resource-quota-manager API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/managers/resource_quota_manager.py` with objective: Normalize interfaces and reduce behavioral drift.
