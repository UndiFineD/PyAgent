# idea047093 - extract-candidates Resilience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/extract_candidates.py` with objective: Improve fault tolerance and recovery behavior.
