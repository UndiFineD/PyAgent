# idea157197 - observability-stats-formula-engine-core-errors Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/observability_stats_formula_engine_core_errors.md` with objective: Improve logs, metrics, and debugging visibility.
