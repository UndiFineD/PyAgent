# idea188280 - types API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/scheduling/chunked_prefill/types.py` with objective: Normalize interfaces and reduce behavioral drift.
