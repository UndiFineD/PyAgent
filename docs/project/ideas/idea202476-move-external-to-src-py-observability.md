# idea202476 - move-external-to-src.py Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/move_external_to_src.py.bak` with objective: Improve logs, metrics, and debugging visibility.
