# idea070545 - delete-skipped-external Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts/delete_skipped_external.py` with objective: Reduce friction for contributors and operators.
