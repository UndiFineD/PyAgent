# idea026175 - task-queue API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/task_queue.py` with objective: Normalize interfaces and reduce behavioral drift.
