# idea175951 - shared-context API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/context/models/shared_context.py` with objective: Normalize interfaces and reduce behavioral drift.
