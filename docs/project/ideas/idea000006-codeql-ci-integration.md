...
## Problem statement
A `codeql/` directory containing custom Python and Rust queries exists but is never executed in CI. Wiring it into a CodeQL workflow would activate static security analysis for free.
