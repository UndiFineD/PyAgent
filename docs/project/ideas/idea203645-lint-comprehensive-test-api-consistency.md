# idea203645 - lint-comprehensive-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/lint_comprehensive_test.py` with objective: Normalize interfaces and reduce behavioral drift.
