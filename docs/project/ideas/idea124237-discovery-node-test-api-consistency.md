# idea124237 - discovery-node-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/voyager/discovery_node_test.py` with objective: Normalize interfaces and reduce behavioral drift.
