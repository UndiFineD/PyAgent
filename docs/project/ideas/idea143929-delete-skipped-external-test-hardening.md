# idea143929 - delete-skipped-external-test Hardening

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/delete_skipped_external_test.py` with objective: Reduce defects and improve safety posture.
