# idea150597 - infrastructure-fleet-hitl-connector-improvements Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/infrastructure_fleet_hitl_connector_improvements.md` with objective: Improve logs, metrics, and debugging visibility.
