# idea143412 - test-core-quality API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/test_core_quality.py` with objective: Normalize interfaces and reduce behavioral drift.
