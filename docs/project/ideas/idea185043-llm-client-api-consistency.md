# idea185043 - llm-client API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/backend/llm_client.py` with objective: Normalize interfaces and reduce behavioral drift.
