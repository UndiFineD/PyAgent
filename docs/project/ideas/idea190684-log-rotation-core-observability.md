# idea190684 - log-rotation-core Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/logging/core/log_rotation_core.py` with objective: Improve logs, metrics, and debugging visibility.
