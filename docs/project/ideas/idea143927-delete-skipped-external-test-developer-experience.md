# idea143927 - delete-skipped-external-test Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/delete_skipped_external_test.py` with objective: Reduce friction for contributors and operators.
