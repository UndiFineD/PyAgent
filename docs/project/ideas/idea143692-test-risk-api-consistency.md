# idea143692 - test-risk API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/tools/test_risk.py` with objective: Normalize interfaces and reduce behavioral drift.
