# idea170303 - graphcore API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/context/GraphCore.py` with objective: Normalize interfaces and reduce behavioral drift.
