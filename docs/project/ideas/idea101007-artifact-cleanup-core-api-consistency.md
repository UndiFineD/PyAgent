# idea101007 - artifact-cleanup-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/artifact_cleanup_core.py` with objective: Normalize interfaces and reduce behavioral drift.
