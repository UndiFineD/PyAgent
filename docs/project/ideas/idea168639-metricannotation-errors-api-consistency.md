# idea168639 - metricannotation.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/MetricAnnotation.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
