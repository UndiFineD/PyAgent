# idea091869 - template-collector Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/tools/nuclei/template_collector.py` with objective: Reduce friction for contributors and operators.
