# idea180375 - run-full-pipeline Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/run_full_pipeline.py` with objective: Reduce security exposure and harden boundaries.
