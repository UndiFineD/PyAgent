# idea085544 - context-compressor-core-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/context/engines/context_compressor_core_test.py` with objective: Normalize interfaces and reduce behavioral drift.
