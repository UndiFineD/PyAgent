# idea121286 - workflow-state.suggested-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/fleet/workflow_state.suggested_test.py` with objective: Normalize interfaces and reduce behavioral drift.
