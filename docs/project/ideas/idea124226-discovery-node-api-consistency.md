# idea124226 - discovery-node API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/voyager/discovery_node.py` with objective: Normalize interfaces and reduce behavioral drift.
