# idea143387 - test-core-agent-registry API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/test_core_agent_registry.py` with objective: Normalize interfaces and reduce behavioral drift.
