# idea144378 - dockerfile Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `deploy/Dockerfile.coder-node` with objective: Improve logs, metrics, and debugging visibility.
