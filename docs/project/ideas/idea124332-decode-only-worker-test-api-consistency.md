# idea124332 - decode-only-worker-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/worker/decode_only_worker_test.py` with objective: Normalize interfaces and reduce behavioral drift.
