# idea114132 - run-autonomous-fleet-healing-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/scripts/analysis/run_autonomous_fleet_healing_test.py` with objective: Normalize interfaces and reduce behavioral drift.
