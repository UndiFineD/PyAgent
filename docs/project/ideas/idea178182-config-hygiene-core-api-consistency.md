# idea178182 - config-hygiene-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/system/core/config_hygiene_core.py` with objective: Normalize interfaces and reduce behavioral drift.
