# idea169395 - suppressionrule.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/SuppressionRule.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
