# idea149591 - infrastructure-dev-scripts-debug-market-improvements API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/infrastructure_dev_scripts_debug_market_improvements.md` with objective: Normalize interfaces and reduce behavioral drift.
