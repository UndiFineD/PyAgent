# idea176125 - localragcore.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/core/LocalRAGCore.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
