# idea143377 - test-chat-utils API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/test_chat_utils.py` with objective: Normalize interfaces and reduce behavioral drift.
