# idea116007 - performance-metric-type-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/performance_metric_type_test.py` with objective: Normalize interfaces and reduce behavioral drift.
