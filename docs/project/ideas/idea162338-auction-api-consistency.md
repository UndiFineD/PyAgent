# idea162338 - auction API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/auction.rs` with objective: Normalize interfaces and reduce behavioral drift.
