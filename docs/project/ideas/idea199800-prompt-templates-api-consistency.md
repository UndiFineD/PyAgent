# idea199800 - prompt-templates API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/cognitive/prompt_templates.py` with objective: Normalize interfaces and reduce behavioral drift.
