# idea114139 - run-benchmarks API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/scripts/analysis/run_benchmarks.py` with objective: Normalize interfaces and reduce behavioral drift.
