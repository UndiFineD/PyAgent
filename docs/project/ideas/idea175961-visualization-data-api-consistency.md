# idea175961 - visualization-data API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/context/models/visualization_data.py` with objective: Normalize interfaces and reduce behavioral drift.
