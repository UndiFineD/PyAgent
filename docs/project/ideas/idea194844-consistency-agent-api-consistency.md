# idea194844 - consistency-agent API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/analysis/consistency_agent.py` with objective: Normalize interfaces and reduce behavioral drift.
