# idea047100 - extract-candidates-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/extract_candidates_test.py` with objective: Normalize interfaces and reduce behavioral drift.
