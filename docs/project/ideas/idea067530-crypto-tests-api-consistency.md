# idea067530 - crypto-tests API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/security/crypto/crypto_tests.rs` with objective: Normalize interfaces and reduce behavioral drift.
