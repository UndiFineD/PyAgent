# idea026122 - mcp-core Hardening

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/specialists/mcp_core.py` with objective: Reduce defects and improve safety posture.
