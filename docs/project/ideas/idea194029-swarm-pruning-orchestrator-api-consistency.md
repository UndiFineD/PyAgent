# idea194029 - swarm-pruning-orchestrator API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/orchestration/swarm/swarm_pruning_orchestrator.py` with objective: Normalize interfaces and reduce behavioral drift.
