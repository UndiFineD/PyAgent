# idea194065 - tool-discovery API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/orchestration/swarm/tool_discovery.py` with objective: Normalize interfaces and reduce behavioral drift.
