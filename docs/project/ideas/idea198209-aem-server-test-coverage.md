# idea198209 - aem-server Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/scanners/cms/aem_server.py` with objective: Increase deterministic test coverage and reliability.
