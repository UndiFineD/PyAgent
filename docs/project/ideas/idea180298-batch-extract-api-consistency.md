# idea180298 - batch-extract API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/batch_extract.py` with objective: Normalize interfaces and reduce behavioral drift.
