# idea176299 - metacognitive-monitor API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/metacognitive_monitor.py` with objective: Normalize interfaces and reduce behavioral drift.
