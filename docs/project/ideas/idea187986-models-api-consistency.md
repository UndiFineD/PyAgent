# idea187986 - models API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/request_queue/models.py` with objective: Normalize interfaces and reduce behavioral drift.
