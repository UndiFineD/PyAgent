# idea111527 - priority-scheduler-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/scheduling/priority_scheduler_test.py` with objective: Normalize interfaces and reduce behavioral drift.
