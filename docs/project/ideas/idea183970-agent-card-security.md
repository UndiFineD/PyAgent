# idea183970 - agent-card Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/models/agent_card.py` with objective: Reduce security exposure and harden boundaries.
