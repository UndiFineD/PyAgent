# idea180374 - run-full-pipeline Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/run_full_pipeline.py` with objective: Improve logs, metrics, and debugging visibility.
