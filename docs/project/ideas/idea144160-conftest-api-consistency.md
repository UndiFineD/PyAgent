# idea144160 - conftest API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `conftest.py` with objective: Normalize interfaces and reduce behavioral drift.
