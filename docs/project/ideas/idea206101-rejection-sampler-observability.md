# idea206101 - rejection-sampler Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/sampling/rejection_sampler.py` with objective: Improve logs, metrics, and debugging visibility.
