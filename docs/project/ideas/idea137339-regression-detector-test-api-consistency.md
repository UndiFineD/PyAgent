# idea137339 - regression-detector-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/observability/errors/regression_detector_test.py` with objective: Normalize interfaces and reduce behavioral drift.
