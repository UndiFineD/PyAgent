# idea206143 - run-fleet-self-improvement API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/scripts/analysis/run_fleet_self_improvement.py` with objective: Normalize interfaces and reduce behavioral drift.
