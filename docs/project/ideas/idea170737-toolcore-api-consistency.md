# idea170737 - toolcore API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/orchestration/ToolCore.py` with objective: Normalize interfaces and reduce behavioral drift.
