# idea025717 - memory API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/memory.py` with objective: Normalize interfaces and reduce behavioral drift.
