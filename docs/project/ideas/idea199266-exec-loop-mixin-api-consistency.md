# idea199266 - exec-loop-mixin API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/swarm/mixins/exec_loop_mixin.py` with objective: Normalize interfaces and reduce behavioral drift.
