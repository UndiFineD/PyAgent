# idea114105 - ruff-complexity-parser Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/scripts/analysis/ruff_complexity_parser.py` with objective: Reduce friction for contributors and operators.
