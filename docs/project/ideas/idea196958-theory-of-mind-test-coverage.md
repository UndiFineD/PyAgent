# idea196958 - theory-of-mind Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/cognitive/theory_of_mind.py` with objective: Increase deterministic test coverage and reliability.
