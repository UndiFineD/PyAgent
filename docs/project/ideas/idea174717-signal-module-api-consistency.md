# idea174717 - signal-module API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/modules/signal_module.py` with objective: Normalize interfaces and reduce behavioral drift.
