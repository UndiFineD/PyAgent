# idea170491 - pluginmanager API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/fleet/PluginManager.py` with objective: Normalize interfaces and reduce behavioral drift.
