# idea180360 - move-external-to-src API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/move_external_to_src.py` with objective: Normalize interfaces and reduce behavioral drift.
