# idea188608 - metadata Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/speculative/spec_decode/metadata.py` with objective: Increase deterministic test coverage and reliability.
