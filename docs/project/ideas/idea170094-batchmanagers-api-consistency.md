# idea170094 - batchmanagers API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/base_agent/managers/BatchManagers.py` with objective: Normalize interfaces and reduce behavioral drift.
