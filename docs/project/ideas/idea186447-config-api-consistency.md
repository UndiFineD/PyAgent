# idea186447 - config API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/chat_templates/registry/config.py` with objective: Normalize interfaces and reduce behavioral drift.
