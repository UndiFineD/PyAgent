# idea186456 - jinja API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/chat_templates/registry/jinja.py` with objective: Normalize interfaces and reduce behavioral drift.
