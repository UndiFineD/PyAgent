# idea114673 - debug-market Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/scripts/management/debug_market.py` with objective: Reduce friction for contributors and operators.
