# idea152792 - logic-agents-cognitive-core-theory-of-mind-core-errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/logic_agents_cognitive_core_theory_of_mind_core_errors.md` with objective: Normalize interfaces and reduce behavioral drift.
