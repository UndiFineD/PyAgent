# idea180260 - example-rule API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/rules/example_rule.py` with objective: Normalize interfaces and reduce behavioral drift.
