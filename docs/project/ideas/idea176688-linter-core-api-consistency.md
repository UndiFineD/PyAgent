# idea176688 - linter-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/development/core/linter_core.py` with objective: Normalize interfaces and reduce behavioral drift.
