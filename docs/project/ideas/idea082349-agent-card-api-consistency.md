# idea082349 - agent-card API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/models/agent_card.py` with objective: Normalize interfaces and reduce behavioral drift.
