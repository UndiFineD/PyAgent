...
## Problem statement
`Cargo.toml` includes an `amd_npu` feature flag but no documentation, test, or CI coverage exists for it. Documenting activation steps would make this a usable capability.
