# idea185820 - awq API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/quantization/engine/awq.py` with objective: Normalize interfaces and reduce behavioral drift.
