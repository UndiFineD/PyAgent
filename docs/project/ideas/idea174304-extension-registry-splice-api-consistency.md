# idea174304 - extension-registry.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/registry/extension_registry.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
