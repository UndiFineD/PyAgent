# idea172216 - accessibility-issue API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/types/accessibility_issue.py` with objective: Normalize interfaces and reduce behavioral drift.
