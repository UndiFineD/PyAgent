# idea196526 - quantum-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/cognitive/core/quantum_core.py` with objective: Normalize interfaces and reduce behavioral drift.
