# idea163221 - tokenizer API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_lib/src/inference/tokenizer.rs` with objective: Normalize interfaces and reduce behavioral drift.
