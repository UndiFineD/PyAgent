# idea099032 - agent-priority-queue-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/utils/agent_priority_queue_test.py` with objective: Normalize interfaces and reduce behavioral drift.
