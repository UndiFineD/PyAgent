# idea178237 - core-expansion-agent API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/system/core_expansion_agent.py` with objective: Normalize interfaces and reduce behavioral drift.
