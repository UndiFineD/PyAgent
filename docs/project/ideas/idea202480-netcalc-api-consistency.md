# idea202480 - netcalc API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/netcalc.py` with objective: Normalize interfaces and reduce behavioral drift.
