# idea184514 - compile API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/importer/compile.py` with objective: Normalize interfaces and reduce behavioral drift.
