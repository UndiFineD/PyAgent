# idea188633 - speculative-decoder API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/speculative/speculative_decoder.py` with objective: Normalize interfaces and reduce behavioral drift.
