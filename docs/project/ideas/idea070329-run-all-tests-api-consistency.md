# idea070329 - run-all-tests API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts-old/run_all_tests.py` with objective: Normalize interfaces and reduce behavioral drift.
