# idea172159 - signal-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/signal_core.py` with objective: Normalize interfaces and reduce behavioral drift.
