# idea184023 - filesystem-skill Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/skills/filesystem_skill.py` with objective: Reduce security exposure and harden boundaries.
