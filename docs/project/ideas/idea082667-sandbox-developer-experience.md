# idea082667 - sandbox Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/sandbox.py` with objective: Reduce friction for contributors and operators.
