# idea143315 - test-base-dirs Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/structure/test_base_dirs.py` with objective: Reduce security exposure and harden boundaries.
