# idea120962 - schema-manager.suggested-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/fleet/schema_manager.suggested_test.py` with objective: Normalize interfaces and reduce behavioral drift.
