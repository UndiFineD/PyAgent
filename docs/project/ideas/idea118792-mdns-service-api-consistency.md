# idea118792 - mdns-service API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/discovery/mdns_service.py` with objective: Normalize interfaces and reduce behavioral drift.
