# idea173703 - sandbox-manager Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/sandbox_manager.py` with objective: Reduce security exposure and harden boundaries.
