# idea189980 - repair-fleet-v2 API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/scripts/management/repair_fleet_v2.py` with objective: Normalize interfaces and reduce behavioral drift.
