# idea136107 - prompt-templates-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/cognitive/prompt_templates_test.py` with objective: Normalize interfaces and reduce behavioral drift.
