# idea170488 - orchestratorregistry.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/fleet/OrchestratorRegistry.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
