# idea180362 - move-external-to-src Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/move_external_to_src.py` with objective: Improve logs, metrics, and debugging visibility.
