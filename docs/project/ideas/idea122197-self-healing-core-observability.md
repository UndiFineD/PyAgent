# idea122197 - self-healing-core Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/orchestration/healing/self_healing_core.py` with objective: Improve logs, metrics, and debugging visibility.
