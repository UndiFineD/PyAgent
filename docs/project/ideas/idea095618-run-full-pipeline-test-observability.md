# idea095618 - run-full-pipeline-test Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/run_full_pipeline_test.py` with objective: Improve logs, metrics, and debugging visibility.
