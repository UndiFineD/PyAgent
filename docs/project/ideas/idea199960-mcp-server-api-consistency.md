# idea199960 - mcp-server API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/tools/mcp_server.py` with objective: Normalize interfaces and reduce behavioral drift.
