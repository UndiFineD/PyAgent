# idea188082 - kernels API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/sampling/kernels.py` with objective: Normalize interfaces and reduce behavioral drift.
