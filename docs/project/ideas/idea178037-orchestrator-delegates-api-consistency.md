# idea178037 - orchestrator-delegates API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/swarm/orchestrator_delegates.py` with objective: Normalize interfaces and reduce behavioral drift.
