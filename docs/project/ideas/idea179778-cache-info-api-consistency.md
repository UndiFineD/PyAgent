# idea179778 - cache-info API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/stats/cache_info.py` with objective: Normalize interfaces and reduce behavioral drift.
