# idea180096 - request-metrics.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/stats/request_metrics.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
