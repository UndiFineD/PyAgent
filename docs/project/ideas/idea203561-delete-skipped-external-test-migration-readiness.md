# idea203561 - delete-skipped-external-test Migration Readiness

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/delete_skipped_external_test.py` with objective: Prepare component for future migration or modernization.
