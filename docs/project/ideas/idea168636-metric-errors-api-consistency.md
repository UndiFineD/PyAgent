# idea168636 - metric.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/Metric.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
