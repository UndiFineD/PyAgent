# idea158213 - quality-score-errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/quality_score_errors.md` with objective: Normalize interfaces and reduce behavioral drift.
