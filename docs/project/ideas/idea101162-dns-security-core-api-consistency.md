# idea101162 - dns-security-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/dns_security_core.py` with objective: Normalize interfaces and reduce behavioral drift.
