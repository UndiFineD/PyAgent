# idea206044 - weight-loader API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/loading/weight_loader.py` with objective: Normalize interfaces and reduce behavioral drift.
