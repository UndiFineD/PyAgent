# idea009033 - derivedmetriccalculator Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/stats/DerivedMetricCalculator.py` with objective: Reduce friction for contributors and operators.
