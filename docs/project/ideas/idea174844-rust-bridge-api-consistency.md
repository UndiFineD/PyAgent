# idea174844 - rust-bridge API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/rust_bridge.py` with objective: Normalize interfaces and reduce behavioral drift.
