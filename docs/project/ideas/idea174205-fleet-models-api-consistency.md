# idea174205 - fleet-models API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/models/fleet_models.py` with objective: Normalize interfaces and reduce behavioral drift.
