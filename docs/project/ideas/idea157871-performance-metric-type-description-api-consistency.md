# idea157871 - performance-metric-type-description API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/autodoc/performance_metric_type_description.md` with objective: Normalize interfaces and reduce behavioral drift.
