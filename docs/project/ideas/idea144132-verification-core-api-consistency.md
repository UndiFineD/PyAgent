# idea144132 - verification-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `verification_core.py` with objective: Normalize interfaces and reduce behavioral drift.
