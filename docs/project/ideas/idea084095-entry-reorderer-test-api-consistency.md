# idea084095 - entry-reorderer-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/utils/entry_reorderer_test.py` with objective: Normalize interfaces and reduce behavioral drift.
