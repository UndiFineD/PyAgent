# idea108444 - jinja-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/chat_templates/registry/jinja_test.py` with objective: Normalize interfaces and reduce behavioral drift.
