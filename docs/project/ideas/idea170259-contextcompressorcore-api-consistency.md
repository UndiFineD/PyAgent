# idea170259 - contextcompressorcore API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/context/ContextCompressorCore.py` with objective: Normalize interfaces and reduce behavioral drift.
