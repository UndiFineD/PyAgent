# idea180255 - pyagent-cli API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/pyagent_cli.py` with objective: Normalize interfaces and reduce behavioral drift.
