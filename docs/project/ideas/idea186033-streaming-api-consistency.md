# idea186033 - streaming API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/tensorizer/core/streaming.py` with objective: Normalize interfaces and reduce behavioral drift.
