# idea100864 - active-directory-analysis-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/active_directory_analysis_core.py` with objective: Normalize interfaces and reduce behavioral drift.
