# idea203675 - recheck-offenders-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/recheck_offenders_test.py` with objective: Normalize interfaces and reduce behavioral drift.
