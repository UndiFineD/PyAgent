# idea101329 - guardrail-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/core/guardrail_core.py` with objective: Normalize interfaces and reduce behavioral drift.
