# idea189171 - lazy API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/lazy.py` with objective: Normalize interfaces and reduce behavioral drift.
