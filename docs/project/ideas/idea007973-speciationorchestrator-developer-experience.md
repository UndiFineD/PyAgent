# idea007973 - speciationorchestrator Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/orchestration/SpeciationOrchestrator.py` with objective: Reduce friction for contributors and operators.
