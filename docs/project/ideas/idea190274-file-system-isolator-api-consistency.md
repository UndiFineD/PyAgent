# idea190274 - file-system-isolator API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/file_system_isolator.py` with objective: Normalize interfaces and reduce behavioral drift.
