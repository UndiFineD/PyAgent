# idea181298 - signal-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/signal_core.py` with objective: Normalize interfaces and reduce behavioral drift.
