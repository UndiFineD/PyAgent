# idea097486 - resilience-retry-default-sleep-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/resilience_retry_default_sleep_test.py` with objective: Normalize interfaces and reduce behavioral drift.
