# idea178501 - mcp-server API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/tools/mcp_server.py` with objective: Normalize interfaces and reduce behavioral drift.
