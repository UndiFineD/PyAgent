# idea070546 - delete-skipped-external Documentation

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts/delete_skipped_external.py` with objective: Improve docs and operational guidance quality.
