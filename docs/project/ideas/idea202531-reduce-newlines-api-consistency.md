# idea202531 - reduce-newlines API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/reduce_newlines.py` with objective: Normalize interfaces and reduce behavioral drift.
