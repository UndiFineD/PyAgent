# idea081432 - sandbox-manager Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/sandbox_manager.py` with objective: Reduce friction for contributors and operators.
