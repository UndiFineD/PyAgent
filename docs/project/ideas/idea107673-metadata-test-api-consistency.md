# idea107673 - metadata-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/tensorizer/core/metadata_test.py` with objective: Normalize interfaces and reduce behavioral drift.
