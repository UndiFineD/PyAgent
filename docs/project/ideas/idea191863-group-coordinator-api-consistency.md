# idea191863 - group-coordinator API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/distributed/tp/group_coordinator.py` with objective: Normalize interfaces and reduce behavioral drift.
