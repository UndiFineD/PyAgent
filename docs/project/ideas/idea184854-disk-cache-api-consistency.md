# idea184854 - disk-cache API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/backend/disk_cache.py` with objective: Normalize interfaces and reduce behavioral drift.
