# idea187741 - gptj API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/position/rotary/gptj.py` with objective: Normalize interfaces and reduce behavioral drift.
