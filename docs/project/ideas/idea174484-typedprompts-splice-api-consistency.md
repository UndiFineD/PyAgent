# idea174484 - typedprompts.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/types/TypedPrompts.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
