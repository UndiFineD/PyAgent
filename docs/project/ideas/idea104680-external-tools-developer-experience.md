# idea104680 - external-tools Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/security/external_tools.py` with objective: Reduce friction for contributors and operators.
