...
## Problem statement
`copilot-instructions.md` mandates a mixin architecture in `src/core/base/mixins/`, but that directory does not exist. `src/core/base/__init__.py` is a near-empty placeholder.
