# idea143682 - test-plugin-loader API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/tools/test_plugin_loader.py` with objective: Normalize interfaces and reduce behavioral drift.
