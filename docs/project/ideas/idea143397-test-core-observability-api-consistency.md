# idea143397 - test-core-observability API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/test_core_observability.py` with objective: Normalize interfaces and reduce behavioral drift.
