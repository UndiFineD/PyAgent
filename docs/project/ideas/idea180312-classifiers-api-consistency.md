# idea180312 - classifiers API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/download_agent/Classifiers.py` with objective: Normalize interfaces and reduce behavioral drift.
