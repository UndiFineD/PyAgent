# idea095563 - move-external-to-src Resilience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/move_external_to_src.py` with objective: Improve fault tolerance and recovery behavior.
