# idea087894 - tooldraftingcore API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/development/core/ToolDraftingCore.py` with objective: Normalize interfaces and reduce behavioral drift.
