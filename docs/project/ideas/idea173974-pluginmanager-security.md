# idea173974 - pluginmanager Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/managers/PluginManager.py` with objective: Reduce security exposure and harden boundaries.
