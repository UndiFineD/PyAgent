# idea170651 - rlselector API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/orchestration/RLSelector.py` with objective: Normalize interfaces and reduce behavioral drift.
