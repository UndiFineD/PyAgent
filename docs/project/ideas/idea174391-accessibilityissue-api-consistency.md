# idea174391 - accessibilityissue API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/types/AccessibilityIssue.py` with objective: Normalize interfaces and reduce behavioral drift.
