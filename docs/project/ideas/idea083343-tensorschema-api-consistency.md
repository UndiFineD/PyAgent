# idea083343 - tensorschema API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/validation/TensorSchema.py` with objective: Normalize interfaces and reduce behavioral drift.
