# idea143902 - conftest API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/conftest.py` with objective: Normalize interfaces and reduce behavioral drift.
