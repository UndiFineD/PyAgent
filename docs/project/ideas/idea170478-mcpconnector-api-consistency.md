# idea170478 - mcpconnector API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/fleet/MCPConnector.py` with objective: Normalize interfaces and reduce behavioral drift.
