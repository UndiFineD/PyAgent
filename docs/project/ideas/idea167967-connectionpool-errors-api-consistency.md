# idea167967 - connectionpool.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/ConnectionPool.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
