# idea163176 - pooling API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_lib/src/inference/pooling.rs` with objective: Normalize interfaces and reduce behavioral drift.
