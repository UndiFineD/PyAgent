# idea175578 - context-compressor API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/context/engines/context_compressor.py` with objective: Normalize interfaces and reduce behavioral drift.
