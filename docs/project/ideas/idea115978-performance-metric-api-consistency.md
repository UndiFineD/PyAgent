# idea115978 - performance-metric API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/test_utils/performance_metric.py` with objective: Normalize interfaces and reduce behavioral drift.
