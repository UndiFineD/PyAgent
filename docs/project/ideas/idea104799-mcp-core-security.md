# idea104799 - mcp-core Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/specialists/mcp_core.py` with objective: Reduce security exposure and harden boundaries.
