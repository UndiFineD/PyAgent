# idea095551 - move-completed Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/move_completed.py` with objective: Improve logs, metrics, and debugging visibility.
