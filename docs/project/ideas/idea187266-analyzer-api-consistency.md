# idea187266 - analyzer API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/logprobs/processor/analyzer.py` with objective: Normalize interfaces and reduce behavioral drift.
