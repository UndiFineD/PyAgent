# idea184633 - config API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/inference/speculation/engine/config.py` with objective: Normalize interfaces and reduce behavioral drift.
