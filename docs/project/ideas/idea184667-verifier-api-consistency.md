# idea184667 - verifier API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/inference/speculation/engine/verifier.py` with objective: Normalize interfaces and reduce behavioral drift.
