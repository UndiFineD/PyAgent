# idea168975 - reportformat.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/ReportFormat.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
