# idea118050 - sandbox-core Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/sandbox/core/sandbox_core.py` with objective: Reduce friction for contributors and operators.
