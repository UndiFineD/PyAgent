# idea021272 - shell-core-strip-ansi-test Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/shell_core_strip_ansi_test.py` with objective: Reduce friction for contributors and operators.
