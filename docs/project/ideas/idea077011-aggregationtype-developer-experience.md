# idea077011 - aggregationtype Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/stats/AggregationType.py` with objective: Reduce friction for contributors and operators.
