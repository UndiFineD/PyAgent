# idea206088 - advanced-sampling-params API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/sampling/advanced_sampling_params.py` with objective: Normalize interfaces and reduce behavioral drift.
