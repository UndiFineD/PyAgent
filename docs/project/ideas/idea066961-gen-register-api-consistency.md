# idea066961 - gen-register API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/gen_register.py` with objective: Normalize interfaces and reduce behavioral drift.
