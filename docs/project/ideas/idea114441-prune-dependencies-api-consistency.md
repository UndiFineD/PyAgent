# idea114441 - prune-dependencies API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/services/dev/scripts/maintenance/prune_dependencies.py` with objective: Normalize interfaces and reduce behavioral drift.
