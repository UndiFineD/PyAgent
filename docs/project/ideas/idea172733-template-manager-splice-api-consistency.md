# idea172733 - template-manager.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/utils/template_manager.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
