# idea173955 - voice-agent-orchestrator.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/voice_agent_orchestrator.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
