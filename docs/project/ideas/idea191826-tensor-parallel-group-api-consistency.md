# idea191826 - tensor-parallel-group API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/distributed/tensor_parallel_group.py` with objective: Normalize interfaces and reduce behavioral drift.
