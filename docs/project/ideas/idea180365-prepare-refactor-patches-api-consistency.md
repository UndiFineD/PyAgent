# idea180365 - prepare-refactor-patches API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/prepare_refactor_patches.py` with objective: Normalize interfaces and reduce behavioral drift.
