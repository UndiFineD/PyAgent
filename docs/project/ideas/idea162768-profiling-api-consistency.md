# idea162768 - profiling API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/stats/profiling.rs` with objective: Normalize interfaces and reduce behavioral drift.
