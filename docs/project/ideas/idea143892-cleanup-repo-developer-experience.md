# idea143892 - cleanup-repo Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/cleanup_repo.py` with objective: Reduce friction for contributors and operators.
