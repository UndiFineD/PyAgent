# idea171395 - aggregationtype API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/stats/AggregationType.py` with objective: Normalize interfaces and reduce behavioral drift.
