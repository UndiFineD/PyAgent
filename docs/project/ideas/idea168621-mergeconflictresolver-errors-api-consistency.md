# idea168621 - mergeconflictresolver.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/MergeConflictResolver.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
