# idea090489 - agentic-patterns API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/swarm/agentic_patterns.py` with objective: Normalize interfaces and reduce behavioral drift.
