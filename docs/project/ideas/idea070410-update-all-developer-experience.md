# idea070410 - update-all Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `scripts-old/todolist/update_all.py` with objective: Reduce friction for contributors and operators.
