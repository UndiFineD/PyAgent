# idea172311 - grouping-strategy API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/types/grouping_strategy.py` with objective: Normalize interfaces and reduce behavioral drift.
