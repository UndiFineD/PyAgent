# idea077056 - formulaengine API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/stats/FormulaEngine.py` with objective: Normalize interfaces and reduce behavioral drift.
