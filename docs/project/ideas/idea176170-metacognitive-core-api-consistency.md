# idea176170 - metacognitive-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/cognitive/core/metacognitive_core.py` with objective: Normalize interfaces and reduce behavioral drift.
