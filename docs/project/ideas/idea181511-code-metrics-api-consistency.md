# idea181511 - code-metrics API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/types/code_metrics.py` with objective: Normalize interfaces and reduce behavioral drift.
