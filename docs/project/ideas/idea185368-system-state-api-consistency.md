# idea185368 - system-state API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/backend/system_state.py` with objective: Normalize interfaces and reduce behavioral drift.
