# idea173326 - swarm-orchestrator-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/core/swarm_orchestrator_core.py` with objective: Normalize interfaces and reduce behavioral drift.
