# idea171857 - lesson-core.py.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/lesson_core.py.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
