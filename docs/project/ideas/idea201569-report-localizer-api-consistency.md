# idea201569 - report-localizer API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/observability/reports/report_localizer.py` with objective: Normalize interfaces and reduce behavioral drift.
