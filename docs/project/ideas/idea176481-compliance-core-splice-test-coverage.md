# idea176481 - compliance-core.splice Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/compliance/core/compliance_core.splice.md` with objective: Increase deterministic test coverage and reliability.
