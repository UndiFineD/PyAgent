# idea067175 - connectivity API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/connectivity.rs` with objective: Normalize interfaces and reduce behavioral drift.
