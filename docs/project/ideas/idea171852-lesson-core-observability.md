# idea171852 - lesson-core Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/lesson_core.py` with objective: Improve logs, metrics, and debugging visibility.
