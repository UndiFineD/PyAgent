# idea178239 - core-expansion-agent Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/system/core_expansion_agent.py` with objective: Improve logs, metrics, and debugging visibility.
