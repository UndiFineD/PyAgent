# idea186424 - chat-template-registry API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/chat_templates/chat_template_registry.py` with objective: Normalize interfaces and reduce behavioral drift.
