# idea199506 - entropy-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/system/core/entropy_core.py` with objective: Normalize interfaces and reduce behavioral drift.
