# idea183321 - tool-parser API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/logic/parsers/tool_parser.py` with objective: Normalize interfaces and reduce behavioral drift.
