# idea181798 - review-finding API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/types/review_finding.py` with objective: Normalize interfaces and reduce behavioral drift.
