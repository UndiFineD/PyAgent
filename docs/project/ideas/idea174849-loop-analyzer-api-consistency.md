# idea174849 - loop-analyzer API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/specialists/loop_analyzer.py` with objective: Normalize interfaces and reduce behavioral drift.
