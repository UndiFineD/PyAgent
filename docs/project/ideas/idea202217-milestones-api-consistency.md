# idea202217 - milestones API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/roadmap/milestones.py` with objective: Normalize interfaces and reduce behavioral drift.
