# idea200227 - blame-info Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/observability/errors/blame_info.py` with objective: Improve logs, metrics, and debugging visibility.
