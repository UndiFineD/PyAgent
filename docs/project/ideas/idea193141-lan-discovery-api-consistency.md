# idea193141 - lan-discovery API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/network/lan_discovery.py` with objective: Normalize interfaces and reduce behavioral drift.
