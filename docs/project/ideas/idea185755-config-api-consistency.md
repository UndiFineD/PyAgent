# idea185755 - config API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/compute/moe/fused/config.py` with objective: Normalize interfaces and reduce behavioral drift.
