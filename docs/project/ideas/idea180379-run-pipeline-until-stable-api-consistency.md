# idea180379 - run-pipeline-until-stable API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/run_pipeline_until_stable.py` with objective: Normalize interfaces and reduce behavioral drift.
