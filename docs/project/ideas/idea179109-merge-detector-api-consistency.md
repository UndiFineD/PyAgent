# idea179109 - merge-detector API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/improvements/merge_detector.py` with objective: Normalize interfaces and reduce behavioral drift.
