# idea143930 - delete-skipped-external-test Performance

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/delete_skipped_external_test.py` with objective: Improve runtime performance and resource efficiency.
