# idea195007 - sanitizer API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/android/core/sanitizer.py` with objective: Normalize interfaces and reduce behavioral drift.
