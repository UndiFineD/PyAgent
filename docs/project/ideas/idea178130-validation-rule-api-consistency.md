# idea178130 - validation-rule API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/logic/agents/swarm/validation_rule.py` with objective: Normalize interfaces and reduce behavioral drift.
