# idea099115 - diff-generator API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/utils/diff_generator.py` with objective: Normalize interfaces and reduce behavioral drift.
