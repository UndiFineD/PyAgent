# idea080733 - session-lock-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/core/session_lock_core.py` with objective: Normalize interfaces and reduce behavioral drift.
