# idea182095 - iteration API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/utils/jsontree/iteration.py` with objective: Normalize interfaces and reduce behavioral drift.
