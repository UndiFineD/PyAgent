# idea180845 - config-loader API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/config_loader.py` with objective: Normalize interfaces and reduce behavioral drift.
