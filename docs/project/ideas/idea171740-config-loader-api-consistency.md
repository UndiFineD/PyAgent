# idea171740 - config-loader API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/config_loader.py` with objective: Normalize interfaces and reduce behavioral drift.
