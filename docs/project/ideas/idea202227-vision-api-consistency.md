# idea202227 - vision API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/roadmap/vision.py` with objective: Normalize interfaces and reduce behavioral drift.
