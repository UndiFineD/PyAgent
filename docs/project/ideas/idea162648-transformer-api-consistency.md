# idea162648 - transformer API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `rust_core/src/neural/transformer.rs` with objective: Normalize interfaces and reduce behavioral drift.
