# idea110479 - neox-test Test Coverage

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/position/rotary/neox_test.py` with objective: Increase deterministic test coverage and reliability.
