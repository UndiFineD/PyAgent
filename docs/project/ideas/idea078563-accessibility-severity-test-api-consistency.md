# idea078563 - accessibility-severity-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/types/accessibility_severity_test.py` with objective: Normalize interfaces and reduce behavioral drift.
