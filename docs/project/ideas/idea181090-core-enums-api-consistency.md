# idea181090 - core-enums API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/base/common/models/core_enums.py` with objective: Normalize interfaces and reduce behavioral drift.
