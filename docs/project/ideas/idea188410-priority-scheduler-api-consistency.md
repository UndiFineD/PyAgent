# idea188410 - priority-scheduler API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/scheduling/priority_scheduler.py` with objective: Normalize interfaces and reduce behavioral drift.
