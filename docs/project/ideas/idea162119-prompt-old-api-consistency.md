# idea162119 - prompt-old API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `docs/work/prompt-old.txt` with objective: Normalize interfaces and reduce behavioral drift.
