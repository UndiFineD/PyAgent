# idea188380 - deadline API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/scheduling/priority/deadline.py` with objective: Normalize interfaces and reduce behavioral drift.
