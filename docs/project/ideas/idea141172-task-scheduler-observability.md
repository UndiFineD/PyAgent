# idea141172 - task-scheduler Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/swarm/task_scheduler.py` with objective: Improve logs, metrics, and debugging visibility.
