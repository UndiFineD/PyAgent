# idea206322 - aem-hacker Security

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/security/scanners/cms/aem_hacker.py` with objective: Reduce security exposure and harden boundaries.
