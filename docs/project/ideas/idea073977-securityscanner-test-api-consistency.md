# idea073977 - securityscanner-test API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/classes/coder/SecurityScanner_test.py` with objective: Normalize interfaces and reduce behavioral drift.
