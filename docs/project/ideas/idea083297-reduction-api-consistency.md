# idea083297 - reduction API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/utils/jsontree/reduction.py` with objective: Normalize interfaces and reduce behavioral drift.
