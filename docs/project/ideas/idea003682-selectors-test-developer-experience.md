# idea003682 - selectors-test Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/scheduling/disaggregated/selectors_test.py` with objective: Reduce friction for contributors and operators.
