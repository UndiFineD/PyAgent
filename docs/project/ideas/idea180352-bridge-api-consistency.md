# idea180352 - bridge API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/tools/mcp/bridge.py` with objective: Normalize interfaces and reduce behavioral drift.
