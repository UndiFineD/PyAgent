# idea194199 - rss-collector API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/swarm/osint/rss_collector.py` with objective: Normalize interfaces and reduce behavioral drift.
