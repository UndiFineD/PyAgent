# idea141460 - extract-candidates.py.manual-fix Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/extract_candidates.py.manual_fix.bak` with objective: Improve logs, metrics, and debugging visibility.
