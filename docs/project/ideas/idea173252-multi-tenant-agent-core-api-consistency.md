# idea173252 - multi-tenant-agent-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/core/multi_tenant_agent_core.py` with objective: Normalize interfaces and reduce behavioral drift.
