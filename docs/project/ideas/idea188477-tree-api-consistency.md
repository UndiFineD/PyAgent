# idea188477 - tree API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/speculative/decoder/tree.py` with objective: Normalize interfaces and reduce behavioral drift.
