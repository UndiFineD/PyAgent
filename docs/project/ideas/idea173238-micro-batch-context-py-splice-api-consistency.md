# idea173238 - micro-batch-context.py.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/logic/core/micro_batch_context.py.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
