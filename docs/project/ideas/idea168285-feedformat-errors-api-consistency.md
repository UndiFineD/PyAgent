# idea168285 - feedformat.errors API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/FeedFormat.errors.md` with objective: Normalize interfaces and reduce behavioral drift.
