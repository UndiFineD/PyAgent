# idea077850 - git-core Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/core/base/common/git_core.py` with objective: Reduce friction for contributors and operators.
