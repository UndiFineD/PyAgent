# idea143382 - test-conftest API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tests/test_conftest.py` with objective: Normalize interfaces and reduce behavioral drift.
