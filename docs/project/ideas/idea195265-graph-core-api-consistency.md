# idea195265 - graph-core API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/logic/agents/cognitive/context/engines/graph_core.py` with objective: Normalize interfaces and reduce behavioral drift.
