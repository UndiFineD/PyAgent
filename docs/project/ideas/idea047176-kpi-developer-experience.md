# idea047176 - kpi Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/tools/pm/kpi.py` with objective: Reduce friction for contributors and operators.
