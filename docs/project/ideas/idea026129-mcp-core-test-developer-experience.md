# idea026129 - mcp-core-test Developer Experience

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/specialists/mcp_core_test.py` with objective: Reduce friction for contributors and operators.
