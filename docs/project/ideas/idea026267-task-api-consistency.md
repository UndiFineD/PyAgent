# idea026267 - task API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/core/workflow/task.py` with objective: Normalize interfaces and reduce behavioral drift.
