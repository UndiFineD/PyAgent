# idea186323 - batch-dcp-wrapper API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/infrastructure/engine/attention/batch_dcp_wrapper.py` with objective: Normalize interfaces and reduce behavioral drift.
