# idea179278 - profile-decorators.splice API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src-old/observability/profiling/profile_decorators.splice.md` with objective: Normalize interfaces and reduce behavioral drift.
