# idea141170 - task-scheduler API Consistency

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `src/swarm/task_scheduler.py` with objective: Normalize interfaces and reduce behavioral drift.
