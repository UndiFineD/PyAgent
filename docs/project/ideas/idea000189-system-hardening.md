# idea000189 - system Hardening

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `data/prompts/research/system.md` with objective: Reduce defects and improve safety posture.
