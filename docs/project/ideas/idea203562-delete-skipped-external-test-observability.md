# idea203562 - delete-skipped-external-test Observability

Planned project mapping: none yet

## Idea summary
Generate a focused improvement initiative for `tools/delete_skipped_external_test.py` with objective: Improve logs, metrics, and debugging visibility.
