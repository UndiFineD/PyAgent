# OBSERVABILITY-METRICS-COLLECTION - References & Code Mapping

## Purpose
This document maps observability-metrics-collection to existing PyAgent implementations to avoid code duplication.
