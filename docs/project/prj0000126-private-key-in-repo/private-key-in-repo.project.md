...
## Project Identity
**Project ID:** prj0000126
**Short name:** private-key-in-repo
**Project folder:** docs/project/prj0000126-private-key-in-repo/

## Idea Source
- Idea file: docs/project/ideas/idea000001-private-key-in-repo.md
- Idea source tag: idea000001

## Project Overview
Initialize a lightweight project boundary for private-key-in-repo, seeded from idea000001-private-key-in-repo. This batch-start artifact establishes ID assignment, initial lane placement, and rollout readiness for downstream discovery/design/plan work.
...
## Branch Plan
**Expected branch:** prj0000126-private-key-in-repo
**Batch bootstrap branch:** prj0000126-next-24-ideas-rollout
**Scope boundary:** docs/project/prj0000126-private-key-in-repo/, docs/project/kanban.json, data/projects.json, data/nextproject.md, and @1project memory/log files only.
