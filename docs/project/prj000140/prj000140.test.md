# SLA-MONITORING-ALERTS - Test Plan & Results
...
- Focus: SLA calculation, threshold alerts, reporting
...
```bash
# Unit tests only
pytest tests/devops/test_sla-monitoring.py -v

# Integration tests
pytest tests/devops/test_sla-monitoring_integration.py -v

# With coverage
pytest tests/devops/ --cov=src/devops/sla-monitoring
```
