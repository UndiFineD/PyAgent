# Project prj000209: Service Mesh - sidecar Proxy

## Vision
Lightweight sidecar proxy for service-to-service communication

## Goals
1. **Implement core functionality**: Develop lightweight sidecar proxy for service-to-service communication for PyAgent
...
- **Focus Areas**: Service discovery, Load balancing, Circuit breaker, Retries
- **Reference**: `src/`
