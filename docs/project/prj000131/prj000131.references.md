# CONTAINER-SCANNING-SECURITY - References & Code Mapping

## Purpose
This document maps container-scanning-security to existing PyAgent implementations to avoid code duplication.
