# CHAOS-TESTING-FRAMEWORK - Test Plan & Results
...
- Focus: Failure injection, recovery validation, SLA checks
...
```bash
# Unit tests only
pytest tests/testing/test_chaos-tests.py -v

# Integration tests
pytest tests/testing/test_chaos-tests_integration.py -v

# With coverage
pytest tests/testing/ --cov=src/testing/chaos-tests
```
