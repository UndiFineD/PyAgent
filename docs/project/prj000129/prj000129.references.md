# PERFORMANCE-REGRESSION-TESTING - References & Code Mapping

## Purpose
This document maps performance-regression-testing to existing PyAgent implementations to avoid code duplication.
