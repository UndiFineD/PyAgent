# TRACING-DISTRIBUTED-SYSTEM - Implementation Plan

## Overview
This document outlines the implementation strategy for tracing-distributed-system in PyAgent.
...
- Write unit tests (Trace propagation, span context, sampling)
