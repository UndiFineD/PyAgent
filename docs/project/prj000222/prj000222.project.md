# Project prj000222: Stream Processing - Operators

## Vision
Stream operators for transformation and aggregation

## Goals
1. **Implement core functionality**: Develop stream operators for transformation and aggregation for PyAgent
...
- **Focus Areas**: Map, Filter, FlatMap, Reduce, Aggregate
- **Reference**: `src/`
