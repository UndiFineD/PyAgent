...
- [x] T0 — Survey: read every target file before editing
...
|---|---|---|---|
| M1 | Survey complete | T0 | DONE |
| M2 | Upstream agents updated | T1–T4 | DONE |
| M3 | Downstream agents updated | T5–T9 | DONE |
| M4 | Validation passes | — | DONE |
