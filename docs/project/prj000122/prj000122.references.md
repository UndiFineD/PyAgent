# TLS-CERTIFICATE-PINNING - References & Code Mapping

## Purpose
This document maps tls-certificate-pinning to existing PyAgent implementations to avoid code duplication.
