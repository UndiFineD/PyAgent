...
## Related Documents
- Link to design/project docs or issue tracking the change.
...
## Consolidated architecture context (generated)

The consolidated architecture content is generated into:

- `docs/architecture/Architecture.generated.md`

To regenerate it, run:

```powershell
python scripts/generate_llms_architecture.py --output docs/architecture/Architecture.generated.md
```

The generated file is intended for agent consumption and is **not** meant to be edited directly.



---
# Source: docs/architecture/Code.md
---
...
This file defines the role of design documentation and where it should live.

## Purpose
- Clarify what belongs in design artifacts versus implementation or planning artifacts.

## Where to write design docs
- Design should be documented in `docs/project/prjXXX-*/plan.md` and `docs/project/prjXXX-*/brainstorm.md`.
- Use `docs/architecture/archive/` for deep dive reference materials when a design decision is already captured there.



---
# Source: docs/architecture/Exec.md
---
...
---
# Source: docs/architecture/Git.md
---

# Git

This document defines the repository workflow and branching conventions.

## Key points
- CI is managed by `.github/workflows/ci.yml` (unit tests, dashboard generation, CodeQL checks).
- Branching strategy and PR conventions should be documented in `CONTRIBUTING.md`.

## When to update
- When the workflow pipeline changes, or when branch naming/contribution conventions change.



---
# Source: docs/architecture/Plan.md
---

# Plan

This file explains where implementation planning happens.

## Purpose
- Provide a consistent location for agents to find the current executable plan.

## Where plans live
- Each active project maintains a `docs/project/prjXXX-*/plan.md` with tasks, milestones, and acceptance criteria.

## When to update
- When project scope changes or new implementation work is added.



---
# Source: docs/architecture/Projects.md
---

# Projects

This file is a stable landing page for the **project portfolio** inside this repository.

## Purpose
- Provide a consistent, agent-readable place to find the list of active projects
- Encourage agents to write or update `docs/project/prjXXX-*` folders when new work is proposed or started

## How to use
- New projects should create a `docs/project/prjNNN-name/` folder with:
  - `brainstorm.md` (intent + reasoning)
  - `plan.md` (execution plan)

## Where to find existing projects
- See the `docs/project/` directory for all current project folders.



---
# Source: docs/architecture/PyAgent.md
---
...
---
# Source: docs/architecture/Ql.md
---

# Ql

This file describes how security scanning is configured.

## Key points
- CodeQL analysis runs via `.github/workflows/ci.yml`.
- Security policies and allowed permissions are managed in GitHub workflow YAML.

## When to update
- When workflow permissions or CodeQL queries change.



---
# Source: docs/architecture/Test.md
---

# Test

This file helps orient agents and contributors to the test strategy.

## Purpose
- Identify where tests are located and how they are structured.

## Where tests live
- Implementation tests: `tests/` (unit, integration, e2e)
- Testing strategy and infrastructure planning: `docs/project/prj023-testing_infrastructure/`

## When to update
- When test requirements or CI behavior changes.



---
# Source: docs/architecture/Think.md
---

# Think

This document is a **placeholder for reasoning and exploration guidance**.

## Purpose
- Guide agents on where to record high-level analysis and decision reasoning.
- Ensure decisions are traceable via project artifacts.

## Where to record thinking
- Use `docs/project/prjXXX-*/brainstorm.md` for exploration, option comparison, and rationale.

## When to update
- When a new architectural direction is being evaluated.
- When a major design trade-off is made and should be recorded.



---
# Source: docs/architecture/todolist.md
---

# PyAgent To‑Do (High‑Level)

This page tracks the most important remaining work items for the PyAgent repo.

## ✅ Completed (recent)
- Moved “superpower” brainstorm/plan documents into `docs/project/prjXXX-*`.
...
- [ ] Convert remaining project plans into actionable issue/PR templates.
- [ ] Add a lightweight summary index in `docs/project/` for easy navigation.
- [ ] Build automated validation that ensures docs and code paths remain aligned (e.g., ensure `rust_core/` is referenced where needed).

---

## Where to look for deep context
- `docs/project/prjXXX-*` — project-level plans and brainstorm docs (source of truth)
- `docs/architecture/` — architecture overviews

 - directory_refactor_proposal.md (docs/work/directory_refactor_proposal.md)
 ...
 - prompt.txt (docs/work/prompt.txt)
 ...
 - line 223: BaseAgent.py decomposed → BaseAgent.py (src/core/base/BaseAgent.py) + BaseAgentCore.py (src/core/base/BaseAgentCore.py) (Core/Shell)
 - line 224: metrics_engine.py decomposed → metrics_engine.py (src/core/base/metrics_engine.py) + MetricsCore.py (src/core/base/MetricsCore.py) (Core/Shell)
 - line 235: VisionCore.py line 29: Implement pixel analysis (TODO in docstring)
 - line 236: acceleration.py (src-old/core/base/acceleration.py) line 34: Update Rust core import path
 - line 237: delegation.py (src-old/core/base/delegation.py) line 71: Move to centralized ModuleLoader
 - line 240: AgentAPIServer.py (src/api/AgentAPIServer.py) line 49: TelemetryManger → TelemetryManager
 - line 243: ArchitectAgent.py (src-old/classes/specialized/ArchitectAgent.py)
 - line 244: observability/reports/utils.py (src-old/classes/reports/utils.py)
 - line 245: FleetExecutionCore.py (src/infrastructure/fleet/FleetExecutionCore.py)

│  │  │  └─ reminder.md (docs/work/reminder.md)
...
rust_core\multimodal\audio.rs
 - line 129: : Implement FFT and Mel filterbank application

rust_core\multimodal\text\analysis.rs
 - line 31: function count

rust_core\multimodal\formula.rs
 - line 8: : Integrate 'evalexpr' or 'meval' crate for robust parsing.

src-old\classes\agent
 - Agent.py (src-old/classes/agent/Agent.py)
 ...
 - AgentCommandHandler.py (src-old/classes/agent/AgentCommandHandler.py)
 ...
 - AgentCore.py (src-old/classes/agent/AgentCore.py)
 ...
 - AgentFileManager.py (src-old/classes/agent/AgentFileManager.py)
 - line 76: All classes have docstrings
 - line 77: All public methods have docstrings
 - line 78: Type hints are present
 - line 79: pytest tests cover main functionality
 ...
 - AgentGitHandler.py (src-old/classes/agent/AgentGitHandler.py)
 ...
 - AgentMetrics.py (src-old/classes/agent/AgentMetrics.py)
 ...
 - AgentPluginBase.py (src-old/classes/agent/AgentPluginBase.py)
 ...
 - AgentUpdateManager.py (src-old/classes/agent/AgentUpdateManager.py)
 - line 72: All classes have docstrings
 - line 73: All public methods have docstrings
 - line 74: Type hints are present
 - line 75: pytest tests cover main functionality
 ...
 - CircuitBreaker.py (src-old/classes/agent/CircuitBreaker.py)
 ...
 - ConfigLoader.py (src-old/classes/agent/ConfigLoader.py)
 ...
 - DiffGenerator.py (src/core/base/utils/DiffGenerator.py)
 - line 71: All classes have docstrings
 - line 72: All public methods have docstrings
 - line 73: Type hints are present
 - line 74: pytest tests cover main functionality
 ...
 - FileLockManager.py (src-old/classes/agent/FileLockManager.py)
 ...
 - HealthChecker.py (src-old/classes/agent/HealthChecker.py)
 - line 83: All classes have docstrings
 - line 84: All public methods have docstrings
 - line 85: Type hints are present
 - line 86: pytest tests cover main functionality
 ...
 - IncrementalProcessor.py (src-old/classes/agent/IncrementalProcessor.py)
 ...
 - LongTermMemory.py (src/logic/agents/cognitive/LongTermMemory.py)
 - line 68: All classes have docstrings
 - line 69: All public methods have docstrings
 - line 70: Type hints are present
 - line 71: pytest tests cover main functionality
 ...
 - NotificationCore.py (src-old/classes/agent/NotificationCore.py)
 ...
 - NotificationManager.py (src-old/classes/agent/NotificationManager.py)
 ...
 - ParallelProcessor.py (src-old/classes/agent/ParallelProcessor.py)
 - line 68: All classes have docstrings
 - line 69: All public methods have docstrings
 - line 70: Type hints are present
 - line 71: pytest tests cover main functionality
 ...
 - cli.py (src/classes/agent/cli.py)
...
│   - line 67: Proper separation of concerns
 ...
 - api
 - APICore.py (src-old/classes/api/APICore.py)
 ...
 - AgentAPIServer.py (src-old/classes/api/AgentAPIServer.py)
 ...
 - FleetLoadBalancer.py (src-old/classes/api/FleetLoadBalancer.py)
 ...
 - PublicAPIEngine.py (src-old/classes/api/PublicAPIEngine.py)
...
│  │  │  │  └─ SaaSGateway.py (src-old/classes/api/SaaSGateway.py)
...
│   - line 74: Proper separation of concerns
 ...
 - backend
 - ConnectionPool.py (src-old/classes/backend/ConnectionPool.py)
 - line 76: All classes have docstrings
 - line 77: All public methods have docstrings
 - line 78: Type hints are present
 - line 79: pytest tests cover main functionality
 ...
 - LLMClient.py (src-old/classes/backend/LLMClient.py)
 - line 79: All classes have docstrings
 - line 80: All public methods have docstrings
 - line 81: Type hints are present
 - line 82: pytest tests cover main functionality
 ...
 - LocalContextRecorder.py (src-old/classes/backend/LocalContextRecorder.py)
 - line 74: All classes have docstrings
 - line 75: All public methods have docstrings
 - line 76: Type hints are present
 - line 77: pytest tests cover main functionality
 ...
 - RunnerBackends.py (src-old/classes/backend/RunnerBackends.py)
 - line 69: All classes have docstrings
 - line 70: All public methods have docstrings
 - line 71: Type hints are present
 - line 72: pytest tests cover main functionality
 ...
 - SqlAgent.py (src-old/classes/backend/SqlAgent.py)
 - line 77: All classes have docstrings
 - line 78: All public methods have docstrings
 - line 79: Type hints are present
 - line 80: pytest tests cover main functionality
 ...
 - SubagentRunner.py (src-old/classes/backend/SubagentRunner.py)
 - line 79: All classes have docstrings
 - line 80: All public methods have docstrings
 - line 81: Type hints are present
 - line 82: pytest tests cover main functionality
...
│   - line 78: Proper separation of concerns
 ...
 - base_agent
 - managers
 - AuthManager.py (src-old/classes/base_agent/managers/AuthManager.py)
...
│   - line 72: Proper separation of concerns
 ...
 - AuthManagers.py (src-old/classes/base_agent/managers/AuthManagers.py)
...
│   - line 88: Proper separation of concerns
 ...
 - BatchManagers.py (src-old/classes/base_agent/managers/BatchManagers.py)
...
│   - line 96: Proper separation of concerns
 ...
 - ConversationManagers.py (src-old/classes/base_agent/managers/ConversationManagers.py)
│   - line 64: All classes have docstrings
│   - line 65: All public methods have docstrings
│   - line 66: Type hints are present
│   - line 67: pytest tests cover main functionality
...
│   - line 71: Proper separation of concerns
 ...
 - OrchestrationManagers.py (src-old/classes/base_agent/managers/OrchestrationManagers.py)
...
│   - line 90: Proper separation of concerns
 ...
 - ProcessorManagers.py (src-old/classes/base_agent/managers/ProcessorManagers.py)
...
│   - line 106: Proper separation of concerns
 ...
 - PromptManagers.py (src-old/classes/base_agent/managers/PromptManagers.py)
...
│   - line 98: Proper separation of concerns
 ...
 - SystemManagers.py (src-old/classes/base_agent/managers/SystemManagers.py)
...
│  │   - line 69: Proper separation of concerns
 ...
 - ConnectivityManager.py (src-old/classes/base_agent/ConnectivityManager.py)
 - line 72: All classes have docstrings
 - line 73: All public methods have docstrings
 - line 74: Type hints are present
 - line 75: pytest tests cover main functionality
...
│   - line 77: Proper separation of concerns
 ...
 - TheoryOfMind.py (src-old/classes/cognitive/TheoryOfMind.py)
 - line 65: All classes have docstrings
 - line 66: All public methods have docstrings
 - line 67: Type hints are present
 - line 68: pytest tests cover main functionality
...
│  │  │  │  └─ TheoryOfMindCore.py (src-old/classes/cognitive/TheoryOfMindCore.py)
 - line 64: All classes have docstrings
 - line 65: All public methods have docstrings
 - line 66: Type hints are present
 - line 67: pytest tests cover main functionality
...
│   - line 71: Proper separation of concerns
 ...
 - context
 - BranchComparison.py (src-old/classes/context/BranchComparison.py)
 - line 73: All classes have docstrings
 - line 74: All public methods have docstrings
 - line 75: Type hints are present
 - line 76: pytest tests cover main functionality
 ...
 - ConflictResolution.py (src-old/classes/context/ConflictResolution.py)
 - line 68: All classes have docstrings
 - line 69: All public methods have docstrings
 - line 70: Type hints are present
 - line 71: pytest tests cover main functionality
 ...
 - ContextAnnotation.py (src-old/classes/context/ContextAnnotation.py)
 - line 66: All classes have docstrings
 - line 67: All public methods have docstrings
 - line 68: Type hints are present
 - line 69: pytest tests cover main functionality
 ...
 - ContextCompressor.py (src-old/classes/context/ContextCompressor.py)
 - line 64: All classes have docstrings
 - line 65: All public methods have docstrings
 - line 66: Type hints are present
 - line 67: pytest tests cover main functionality
 ...
 - ContextCompressorCore.py (src-old/classes/context/ContextCompressorCore.py)
 - line 64: All classes have docstrings
 - line 65: All public methods have docstrings
 - line 66: Type hints are present
 - line 67: pytest tests cover main functionality
 ...
 - ContextDiff.py (src-old/classes/context/ContextDiff.py)
 - line 74: All classes have docstrings
 - line 75: All public methods have docstrings
 - line 76: Type hints are present
 - line 77: pytest tests cover main functionality
 ...
 - ContextExporter.py (src-old/classes/context/ContextExporter.py)
 - line 72: All classes have docstrings
 - line 73: All public methods have docstrings
 - line 74: Type hints are present
 - line 75: pytest tests cover main functionality
 ...
 - ContextInheritance.py (src-old/classes/context/ContextInheritance.py)
 - line 74: All classes have docstrings
 - line 75: All public methods have docstrings
 - line 76: Type hints are present
 - line 77: pytest tests cover main functionality
 ...
 - ContextPriority.py (src-old/classes/context/ContextPriority.py)
 - line 68: All classes have docstrings
 - line 69: All public methods have docstrings
 - line 70: Type hints are present
 - line 71: pytest tests cover main functionality
 ...
 - ContextRecommendation.py (src-old/classes/context/ContextRecommendation.py)
 - line 72: All classes have docstrings
 - line 73: All public methods have docstrings
 - line 74: Type hints are present
 - line 75: pytest tests cover main functionality
 ...
 - ContextRecommender.py (src-old/classes/context/ContextRecommender.py)
 - line 70: All classes have docstrings
 - line 71: All public methods have docstrings
 - line 72: Type hints are present
 - line 73: pytest tests cover main functionality
 ...
 - ContextTag.py (src-old/classes/context/ContextTag.py)
 - line 66: All classes have docstrings
 - line 67: All public methods have docstrings
 - line 68: Type hints are present
 - line 69: pytest tests cover main functionality
 ...
 - ContextTemplate.py (src-old/classes/context/ContextTemplate.py)
 - line 66: All classes have docstrings
 - line 67: All public methods have docstrings
 - line 68: Type hints are present
 - line 69: pytest tests cover main functionality
 ...
 - ContextVersion.py (src-old/classes/context/ContextVersion.py)
 - line 66: All classes have docstrings
 - line 67: All public methods have docstrings
 - line 68: Type hints are present
 - line 69: pytest tests cover main functionality
 ...
 - ContextVisualizer.py (src-old/classes/context/ContextVisualizer.py)
 - line 77: All classes have docstrings
 - line 78: All public methods have docstrings
 - line 79: Type hints are present
 - line 80: pytest tests cover main functionality
 ...
 - CrossRepoContext.py (src-old/classes/context/CrossRepoContext.py)
 - line 73: All classes have docstrings
 - line 74: All public methods have docstrings
 - line 75: Type hints are present
 - line 76: pytest tests cover main functionality
 ...
 - ExportFormat.py (src-old/classes/context/ExportFormat.py)
 - line 68: All classes have docstrings
 - line 69: All public methods have docstrings
 - line 70: Type hints are present
 - line 71: pytest tests cover main functionality
 ...
 - ExportedContext.py (src-old/classes/context/ExportedContext.py)
 - line 72: All classes have docstrings
 - line 73: All public methods have docstrings
 - line 74: Type hints are present
 - line 75: pytest tests cover main functionality
 ...
 - FileCategory.py (src-old/classes/context/FileCategory.py)
 - line 68: All classes have docstrings
 - line 69: All public methods have docstrings
 - line 70: Type hints are present
 - line 71: pytest tests cover main functionality
 ...
 - GeneratedCode.py (src-old/classes/context/GeneratedCode.py)
 - line 72: All classes have docstrings
 - line 73: All public methods have docstrings
 - line 74: Type hints are present
 - line 75: pytest tests cover main functionality
 ...
 - GlobalContextCore.py (src-old/classes/context/GlobalContextCore.py)
 - line 68: All classes have docstrings
 - line 69: All public methods have docstrings
 - line 70: Type hints are present
 - line 71: pytest tests cover main functionality
 ...
 - GlobalContextEngine.py (src-old/classes/context/GlobalContextEngine.py)
 - line 67: All classes have docstrings
 - line 68: All public methods have docstrings
 - line 69: Type hints are present
 - line 70: pytest tests cover main functionality
 ...
 - GraphContextEngine.py (src-old/classes/context/GraphContextEngine.py)
 - line 68: All classes have docstrings
 - line 69: All public methods have docstrings
 - line 70: Type hints are present
 - line 71: pytest tests cover main functionality
 ...
 - GraphCore.py (src-old/classes/context/GraphCore.py)
 - line 76: All classes have docstrings
 - line 77: All public methods have docstrings
 - line 78: Type hints are present
 - line 79: pytest tests cover main functionality
 ...
 - InheritanceMode.py (src-old/classes/context/InheritanceMode.py)
 - line 68: All classes have docstrings
 - line 69: All public methods have docstrings
 - line 70: Type hints are present
 - line 71: pytest tests cover main functionality
 ...
 - InheritedContext.py (src-old/classes/context/InheritedContext.py)
 - line 72: All classes have docstrings
 - line 73: All public methods have docstrings
 - line 74: Type hints are present
 - line 75: pytest tests cover main functionality
 ...
 - KnowledgeAgent.py (src-old/classes/context/KnowledgeAgent.py)
 - line 81: All classes have docstrings
 - line 82: All public methods have docstrings
 - line 83: Type hints are present
 - line 84: pytest tests cover main functionality
 ...
 - KnowledgeCore.py (src-old/classes/context/KnowledgeCore.py)
 - line 72: All classes have docstrings
 - line 73: All public methods have docstrings
 - line 74: Type hints are present
 - line 75: pytest tests cover main functionality
...
│  │  │  │  └─ MemoryConsolidationAgent.py (src-old/classes/context/MemoryConsolidationAgent.py)
 - line 71: All classes have docstrings
 - line 72: All public methods have docstrings
 - line 73: Type hints are present
 - line 74: pytest tests cover main functionality
...
│   - line 70: Proper separation of concerns
 ...
 - ArchitectAgent.py (src-old/classes/specialized/ArchitectAgent.py)
 - line 68: All classes have docstrings
 - line 69: All public methods have docstrings
 - line 70: Type hints are present
 - line 71: pytest tests cover main functionality
