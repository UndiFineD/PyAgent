...
def test_imports_and_symbols():
    ...
    assert hasattr(
        mod, "log_softmax_batch_invariant"
    ), "log_softmax_batch_invariant missing"
    ...
    assert hasattr(
        mod, "layer_norm_batch_invariant"
    ), "layer_norm_batch_invariant missing"
    assert hasattr(mod, "rms_norm_batch_invariant"), "rms_norm_batch_invariant missing"
    assert hasattr(
        mod, "attention_score_batch_invariant"
    ), "attention_score_batch_invariant missing"
    assert hasattr(
        mod, "attention_output_batch_invariant"
    ), "attention_output_batch_invariant missing"
