...
## Source: src-old/core/base/logic/managers/conversation_managers.description.md
...
## Source: src-old/core/base/logic/managers/conversation_managers.improvements.md
