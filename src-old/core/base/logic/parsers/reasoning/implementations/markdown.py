...
## Source: src-old/core/base/logic/parsers/reasoning/implementations/markdown.description.md
...
## Source: src-old/core/base/logic/parsers/reasoning/implementations/markdown.improvements.md
