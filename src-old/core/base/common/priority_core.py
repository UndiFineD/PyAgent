...
## Source: src-old/core/base/common/priority_core.description.md
...
## Source: src-old/core/base/common/priority_core.improvements.md

# Improvements: src/core/base/common/priority_core.py
