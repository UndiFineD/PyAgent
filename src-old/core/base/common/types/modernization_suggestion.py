...
## Source: src-old/core/base/common/types/modernization_suggestion.description.md

# Description: src/core/base/common/types/modernization_suggestion.py
...
Top-level members:
- Classes: ModernizationSuggestion

Notes:
- This description was auto-generated by scripts/generate_docs_for_src.py
## Source: src-old/core/base/common/types/modernization_suggestion.improvements.md
