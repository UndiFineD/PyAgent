...
## Source: src-old/core/base/common/types/migration_status.description.md

# Description: src/core/base/common/types/migration_status.py
...
## Source: src-old/core/base/common/types/migration_status.improvements.md
