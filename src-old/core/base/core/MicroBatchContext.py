...
## Source: src-old/core/base/core/MicroBatchContext.improvements.md
...
### Testing
- [!] **Missing test file** - Create `MicroBatchContext_test.py` with pytest tests
...
class MicroBatchContext(Generic[T]):
    ...
    def stats(self) -> dict[str, Any]:
        ...
        completed = sum(
            1 for mb in self._micro_batches if mb.state == MicroBatchState.COMPLETED
        )
