...
## Source: src-old/observability/stats/exporters/ObservabilityEngine.improvements.md
...
PrometheusExporter = resilient_import(
...
MetricsExporter = resilient_import(
    "src.classes.stats.MetricsExporter", "MetricsExporter"
)
...
class ObservabilityEngine:
    ...
    def end_trace(
        ...
        self.prometheus.record_metric(
            "agent_latency_ms", metric.duration_ms, {"agent": agent_name}
        )
        self.prometheus.record_metric(
            "agent_cost_usd", metric.estimated_cost, {"agent": agent_name}
        )
        self.save()
