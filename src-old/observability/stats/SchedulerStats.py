...
## Source: src-old/observability/stats/SchedulerStats.description.md
...
## Source: src-old/observability/stats/SchedulerStats.improvements.md

# Improvements for SchedulerStats

**File**: `src\observability\stats\SchedulerStats.py`  
**Analysis Date**: 2026-03-01 00:18  
**Size**: 502 lines (large)  
**Complexity**: 41 score (complex)
...
### Testing
- [!] **Missing test file** - Create `SchedulerStats_test.py` with pytest tests

### Code Organization
- [TIP] **8 classes in one file** - Consider splitting into separate modules

### File Complexity
- [!] **Large file** (502 lines) - Consider refactoring
...
class SchedulerStats:
    ...
    def clone(self) -> SchedulerStats:
        ...
        return SchedulerStats(
            ...
            spec_decoding_stats=(
                self.spec_decoding_stats.clone() if self.spec_decoding_stats else None
            ),
    ...
    def get_averages(self) -> dict[str, float]:
        ...
        return {
            ...
            "avg_prefix_hit_rate": sum(
                s.prefix_cache_stats.hit_rate for s in self._history
            )
            / n,
        }
