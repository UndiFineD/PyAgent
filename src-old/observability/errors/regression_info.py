...
## Source: src-old/observability/errors/regression_info.description.md
...
## Source: src-old/observability/errors/regression_info.improvements.md

# Improvements: src/observability/errors/regression_info.py
