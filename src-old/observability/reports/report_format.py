...
## Source: src-old/observability/reports/report_format.description.md

# Description: src/observability/reports/report_format.py

Module purpose:
- Defines `ReportFormat` enum representing output formats supported by the reporting tools.

Public symbols:
- `ReportFormat` (Enum): MARKDOWN, JSON, HTML
## Source: src-old/observability/reports/report_format.improvements.md

# Improvements: src/observability/reports/report_format.py
