...
## Source: src-old/inference/speculation/engine/config.description.md
...
## Source: src-old/inference/speculation/engine/config.improvements.md
...
r"""Configuration and enums regarding speculative decoding."""
