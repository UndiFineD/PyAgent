...
## Source: src-old/logic/agents/cognitive/evolutionary_prompt_agent.description.md
...
## Source: src-old/logic/agents/cognitive/evolutionary_prompt_agent.improvements.md
