...
## Source: src-old/logic/agents/cognitive/context/knowledge_base.description.md
...
## Source: src-old/logic/agents/cognitive/context/knowledge_base.improvements.md
