...
## Source: src-old/logic/agents/cognitive/context/engines/context_compressor_core.description.md
...
## Source: src-old/logic/agents/cognitive/context/engines/context_compressor_core.improvements.md
