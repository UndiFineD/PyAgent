...
## Source: src-old/logic/agents/cognitive/context/engines/core_mixins/core_summary_mixin.description.md
...
## Source: src-old/logic/agents/cognitive/context/engines/core_mixins/core_summary_mixin.improvements.md
