...
## Source: src-old/logic/agents/cognitive/context/engines/context_compressor.description.md
...
## Source: src-old/logic/agents/cognitive/context/engines/context_compressor.improvements.md
