...
## Source: src-old/logic/agents/cognitive/context/engines/memory_core.description.md
...
## Source: src-old/logic/agents/cognitive/context/engines/memory_core.improvements.md
