...
**File**: `src\logic\agents\cognitive\context\models\VisualizationType.py`  
**Type**: Python Module  
...
## Source: src-old/logic/agents/cognitive/context/models/VisualizationType.improvements.md
