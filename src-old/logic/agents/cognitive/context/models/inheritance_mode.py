...
## Source: src-old/logic/agents/cognitive/context/models/inheritance_mode.description.md
...
## Source: src-old/logic/agents/cognitive/context/models/inheritance_mode.improvements.md
