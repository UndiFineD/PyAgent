...
## Source: src-old/logic/agents/cognitive/context/models/visualization_type.description.md
...
## Source: src-old/logic/agents/cognitive/context/models/visualization_type.improvements.md
