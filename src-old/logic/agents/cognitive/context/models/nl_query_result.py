...
## Source: src-old/logic/agents/cognitive/context/models/nl_query_result.description.md
...
## Source: src-old/logic/agents/cognitive/context/models/nl_query_result.improvements.md
