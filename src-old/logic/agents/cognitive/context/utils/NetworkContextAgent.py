...
## Source: src-old/logic/agents/cognitive/context/utils/NetworkContextAgent.description.md
...
## Source: src-old/logic/agents/cognitive/context/utils/NetworkContextAgent.improvements.md
