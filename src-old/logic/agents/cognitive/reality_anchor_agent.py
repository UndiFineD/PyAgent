...
## Source: src-old/logic/agents/cognitive/reality_anchor_agent.improvements.md
...
r"""Agent specializing in zero-hallucination execution by cross-referencing factual claims."""
