...
## Source: src-old/logic/agents/cognitive/personality_core_agent.improvements.md

# Improvements: src/logic/agents/cognitive/personality_core_agent.py
...
r"""Agent for managing emotional intelligence and communication style of the fleet."""
