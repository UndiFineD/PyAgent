...
## Source: src-old/logic/agents/cognitive/knowledge_graph_assistant.description.md
...
## Source: src-old/logic/agents/cognitive/knowledge_graph_assistant.improvements.md
