...
## Source: src-old/logic/agents/cognitive/proactive_agent.improvements.md

# Improvements: src/logic/agents/cognitive/proactive_agent.py
...
r"""Agent specializing in proactive task management and recurring workflows."""
