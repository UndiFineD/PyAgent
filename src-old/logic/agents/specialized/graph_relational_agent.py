...
## Source: src-old/logic/agents/specialized/graph_relational_agent.description.md
...
## Source: src-old/logic/agents/specialized/graph_relational_agent.improvements.md
