...
Python module containing implementation for TechDebtCore.
...
**Methods** (2):
- `analyze_ast_debt(tree)`
- `identify_hotspots(reports, limit)`
...
## Source: src-old/logic/agents/development/TechDebtCore.improvements.md
...
### Testing
- [!] **Missing test file** - Create `TechDebtCore_test.py` with pytest tests
