...
## Source: src-old/logic/agents/development/yaml_agent.description.md
...
## Source: src-old/logic/agents/development/yaml_agent.improvements.md
...
r"""Agent specializing in YAML configuration files."""
