...
## Source: src-old/logic/agents/development/tool_synthesis_agent.description.md
...
## Source: src-old/logic/agents/development/tool_synthesis_agent.improvements.md
