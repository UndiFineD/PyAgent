...
## Source: src-old/logic/agents/development/mixins/agent/AgentStyleMixin.description.md
...
## Source: src-old/logic/agents/development/mixins/agent/AgentStyleMixin.improvements.md
