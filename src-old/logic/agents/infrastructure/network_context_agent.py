...
## Source: src-old/logic/agents/infrastructure/network_context_agent.description.md
...
## Source: src-old/logic/agents/infrastructure/network_context_agent.improvements.md
