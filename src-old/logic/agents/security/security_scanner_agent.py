...
# Description: src/logic/agents/security/security_scanner_agent.py
...
Top-level members:
- Classes: SecurityScannerAgent

Notes:
- This description was auto-generated by scripts/generate_docs_for_src.py
## Source: src-old/logic/agents/security/security_scanner_agent.improvements.md

# Improvements: src/logic/agents/security/security_scanner_agent.py
