...
## Source: src-old/logic/agents/security/security_guard_agent.description.md
...
## Source: src-old/logic/agents/security/security_guard_agent.improvements.md

# Improvements: src/logic/agents/security/security_guard_agent.py
