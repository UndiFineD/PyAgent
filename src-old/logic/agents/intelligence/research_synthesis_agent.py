...
## Source: src-old/logic/agents/intelligence/research_synthesis_agent.description.md
...
## Source: src-old/logic/agents/intelligence/research_synthesis_agent.improvements.md
