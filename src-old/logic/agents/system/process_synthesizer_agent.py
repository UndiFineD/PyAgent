...
## Source: src-old/logic/agents/system/process_synthesizer_agent.description.md
...
## Source: src-old/logic/agents/system/process_synthesizer_agent.improvements.md
