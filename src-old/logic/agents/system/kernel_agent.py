...
## Source: src-old/logic/agents/system/kernel_agent.description.md
...
## Source: src-old/logic/agents/system/kernel_agent.improvements.md

# Improvements: src/logic/agents/system/kernel_agent.py
