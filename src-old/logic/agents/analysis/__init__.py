...
## Source: src-old/logic/agents/analysis/__init__.description.md

# Description: src/logic/agents/analysis/__init__.py

Module docstring (if present):

    Auto-generated module discovery for Analysis.
...
## Source: src-old/logic/agents/analysis/__init__.improvements.md

# Improvements: src/logic/agents/analysis/__init__.py
...
r"""Auto-generated module discovery for Analysis."""
