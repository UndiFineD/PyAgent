...
## Source: src-old/logic/agents/specialists/web_search_essay_agent.description.md
...
## Source: src-old/logic/agents/specialists/web_search_essay_agent.improvements.md
