...
## Source: src-old/logic/agents/swarm/inter_fleet_identity_agent.description.md
...
## Source: src-old/logic/agents/swarm/inter_fleet_identity_agent.improvements.md
