...
## Source: src-old/interface/ui/gui/header_panel.description.md
...
## Source: src-old/interface/ui/gui/header_panel.improvements.md
...
r"""Header Panel component for the PyAgent GUI."""
