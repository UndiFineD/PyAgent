...
## Source: src-old/interface/ui/gui/dialog_manager.description.md
...
## Source: src-old/interface/ui/gui/dialog_manager.improvements.md

# Improvements: src/interface/ui/gui/dialog_manager.py
