## Issues found by ruffAgent at 20260115-1622
...
F401 [*] `src.core.base.registry.AgentRegistry` imported but unused
  --> src\core\base\delegation.py:29:36
   |
27 | import logging
28 | from pathlib import Path
29 | from src.core.base.registry import AgentRegistry
   |                                    ^^^^^^^^^^^^^
30 | from src.core.base.ModuleLoader import ModuleLoader
31 | from src.core.base.models import CascadeContext, AgentPriority
   |
help: Remove unused import: `src.core.base.registry.AgentRegistry`
...
F821 Undefined name `value`
  --> src\observability\stats\ab_engine.py:94:43
   |
92 |             comp.metrics_a[metric_name] = value
93 |         elif version.lower() == "b":
94 |             comp.metrics_b[metric_name] = value
...
F401 `.ProfilingCore.ProfilingCore` imported but unused; consider removing, adding to `__all__`, or using a redundant alias
 --> src\observability\stats\core\__init__.py:1:28
  |
1 | from .ProfilingCore import ProfilingCore, ProfileStats
  |                            ^^^^^^^^^^^^^
2 | from .StabilityCore import StabilityCore, FleetMetrics
3 | from .TracingCore import TracingCore
  |
...
F401 `.ProfilingCore.ProfileStats` imported but unused; consider removing, adding to `__all__`, or using a redundant alias
 --> src\observability\stats\core\__init__.py:1:43
  |
1 | from .ProfilingCore import ProfilingCore, ProfileStats
  |                                           ^^^^^^^^^^^^
2 | from .StabilityCore import StabilityCore, FleetMetrics
...
F401 `.TracingCore.TracingCore` imported but unused; consider removing, adding to `__all__`, or using a redundant alias
 --> src\observability\stats\core\__init__.py:3:26
  |
1 | from .ProfilingCore import ProfilingCore, ProfileStats
2 | from .StabilityCore import StabilityCore, FleetMetrics
3 | from .TracingCore import TracingCore
...
Found 548 errors.
[*] 1 fixable with the `--fix` option (66 hidden fixes can be enabled with the `--unsafe-fixes` option).
