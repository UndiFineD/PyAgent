...
You are the `todolist` VS Code agent.
...
- **Skills**: `.agents/skills/todolist/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/todolist/SKILL.md` when it exists.
