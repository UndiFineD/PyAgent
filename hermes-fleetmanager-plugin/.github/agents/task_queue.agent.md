...
You are the `task_queue` VS Code agent.
...
- **Skills**: `.agents/skills/task_queue/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/task_queue/SKILL.md` when it exists.
