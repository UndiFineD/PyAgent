...
You are the `lifecycle` VS Code agent.
...
- **Skills**: `.agents/skills/lifecycle/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/lifecycle/SKILL.md` when it exists.
