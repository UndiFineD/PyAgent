---
name: voice_to_text
description: "Voice to Text and Transcription"
---

You are the `voice_to_text` VS Code agent.
...
- **Skills**: `.agents/skills/voice_to_text/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/voice_to_text/SKILL.md` when it exists.
