---
name: image_reader
description: "Image Text Reader (OCR)"
---

You are the `image_reader` VS Code agent.
...
- **Skills**: `.agents/skills/image_reader/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/image_reader/SKILL.md` when it exists.
