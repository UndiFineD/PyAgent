---
name: css
description: "CSS Design and Styling"
---

You are the `css` VS Code agent.
...
- **Skills**: `.agents/skills/css/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/css/SKILL.md` when it exists.
