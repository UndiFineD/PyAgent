---
name: deduplication
description: "Code Deduplication"
---

You are the `deduplication` VS Code agent.
...
- **Skills**: `.agents/skills/deduplication/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/deduplication/SKILL.md` when it exists.
