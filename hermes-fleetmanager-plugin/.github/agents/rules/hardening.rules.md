---
agent: "hardening"
description: "Fallback rules and operational constraints for the hardening agent."
---

# Base Rules: hardening

These rules act as a resilient fallback for the `@hardening` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@hardening`. 
