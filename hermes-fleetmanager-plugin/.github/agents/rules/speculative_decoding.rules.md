---
agent: "speculative_decoding"
description: "Fallback rules and operational constraints for the speculative_decoding agent."
---

# Base Rules: speculative_decoding

These rules act as a resilient fallback for the `@speculative_decoding` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@speculative_decoding`. 
