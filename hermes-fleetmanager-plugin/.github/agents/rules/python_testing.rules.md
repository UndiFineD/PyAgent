---
agent: "python_testing"
description: "Fallback rules and operational constraints for the python_testing agent."
---

# Base Rules: python_testing

These rules act as a resilient fallback for the `@python_testing` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@python_testing`. 
