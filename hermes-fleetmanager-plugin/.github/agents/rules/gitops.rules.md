---
agent: "gitops"
description: "Fallback rules and operational constraints for the gitops agent."
---

# Base Rules: gitops

These rules act as a resilient fallback for the `@gitops` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@gitops`. 
