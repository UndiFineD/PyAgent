---
agent: "rules"
description: "Fallback rules and operational constraints for the rules agent."
---

# Base Rules: rules

These rules act as a resilient fallback for the `@rules` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@rules`. 
