---
agent: "workflow"
description: "Fallback rules and operational constraints for the workflow agent."
---

# Base Rules: workflow

These rules act as a resilient fallback for the `@workflow` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@workflow`. 
