---
agent: "agentwriter"
description: "Fallback rules and operational constraints for the agentwriter agent."
---

# Base Rules: agentwriter

These rules act as a resilient fallback for the `@agentwriter` agent.
...
4. **Scope Strictness**:
    Do not perform tasks outside the explicit capabilities of `@agentwriter`.
