...
description: "Fallback rules and operational constraints for the semantic_cache agent."
---

# Base Rules: semantic_cache

These rules act as a resilient fallback for the `@semantic_cache` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@semantic_cache`. 
