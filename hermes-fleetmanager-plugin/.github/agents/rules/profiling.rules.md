---
agent: "profiling"
description: "Fallback rules and operational constraints for the profiling agent."
---

# Base Rules: profiling

These rules act as a resilient fallback for the `@profiling` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@profiling`. 
