---
agent: "distributed_tx"
description: "Fallback rules and operational constraints for the distributed_tx agent."
---

# Base Rules: distributed_tx

These rules act as a resilient fallback for the `@distributed_tx` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@distributed_tx`. 
