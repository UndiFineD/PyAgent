---
agent: "coding"
description: "Fallback rules and operational constraints for the coding agent."
---

# Base Rules: coding

These rules act as a resilient fallback for the `@coding` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@coding`. 
