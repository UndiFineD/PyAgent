---
agent: "image_reader"
description: "Fallback rules and operational constraints for the image_reader agent."
---

# Base Rules: image_reader

These rules act as a resilient fallback for the `@image_reader` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@image_reader`. 
