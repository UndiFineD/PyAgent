---
agent: "security"
description: "Fallback rules and operational constraints for the security agent."
---

# Base Rules: security

These rules act as a resilient fallback for the `@security` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@security`. 
