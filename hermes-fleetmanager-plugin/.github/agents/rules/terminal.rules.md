---
agent: "terminal"
description: "Fallback rules and operational constraints for the terminal agent."
---

# Base Rules: terminal

These rules act as a resilient fallback for the `@terminal` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@terminal`. 
