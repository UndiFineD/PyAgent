---
agent: "coordinator"
description: "Fallback rules and operational constraints for the coordinator agent."
---

# Base Rules: coordinator

These rules act as a resilient fallback for the `@coordinator` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@coordinator`. 
