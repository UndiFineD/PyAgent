---
agent: "nebulaos"
description: "Fallback rules and operational constraints for the nebulaos agent."
---

# Base Rules: nebulaos

These rules act as a resilient fallback for the `@nebulaos` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@nebulaos`. 
