---
agent: "sprint_review"
description: "Fallback rules and operational constraints for the sprint_review agent."
---

# Base Rules: sprint_review

These rules act as a resilient fallback for the `@sprint_review` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@sprint_review`. 
