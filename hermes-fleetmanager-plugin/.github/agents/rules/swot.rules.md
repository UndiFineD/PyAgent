---
agent: "swot"
description: "Fallback rules and operational constraints for the swot agent."
---

# Base Rules: swot

These rules act as a resilient fallback for the `@swot` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@swot`. 
