---
agent: "setup"
description: "Fallback rules and operational constraints for the setup agent."
---

# Base Rules: setup

These rules act as a resilient fallback for the `@setup` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@setup`. 
