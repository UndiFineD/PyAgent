---
agent: "priority"
description: "Fallback rules and operational constraints for the priority agent."
---

# Base Rules: priority

These rules act as a resilient fallback for the `@priority` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@priority`. 
