---
agent: "execution"
description: "Fallback rules and operational constraints for the execution agent."
---

# Base Rules: execution

These rules act as a resilient fallback for the `@execution` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@execution`. 
