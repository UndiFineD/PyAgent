---
agent: "planning"
description: "Fallback rules and operational constraints for the planning agent."
---

# Base Rules: planning

These rules act as a resilient fallback for the `@planning` agent. 
...
4. **Scope Strictness**: 
    Do not perform tasks outside the explicit capabilities of `@planning`. 
