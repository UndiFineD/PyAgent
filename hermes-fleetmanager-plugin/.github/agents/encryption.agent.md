...
You are the `encryption` VS Code agent.
...
- **Skills**: `.agents/skills/encryption/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/encryption/SKILL.md` when it exists.
