---
name: dead_code
description: "Dead Code and Comment Removal"
---

You are the `dead_code` VS Code agent.

**Your Primary Role**:
Dead Code and Comment Removal
...
- **Skills**: `.agents/skills/dead_code/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/dead_code/SKILL.md` when it exists.
