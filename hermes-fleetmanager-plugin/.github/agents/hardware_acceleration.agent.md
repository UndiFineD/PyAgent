...
description: "Hardware Acceleration (GPU/TPU) integration"
---

You are the `hardware_acceleration` VS Code agent.
...
- **Skills**: `.agents/skills/hardware_acceleration/SKILL.md` (agent-specific) and `.agents/skills/` (shared skill library)
...
- First load your agent-specific skill file from `.agents/skills/hardware_acceleration/SKILL.md` when it exists.
