...
@Data
public class Idea27745Config {
    private String name = "idea_027745";
 ...
 */
@Slf4j
public class Idea27745Service {
    private static final int IDEA_ID = 27745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27745Service() {
        this(new Idea27745Config());
    }

    public Idea27745Service(Idea27745Config config) {
        this.config = config != null ? config : new Idea27745Config();
