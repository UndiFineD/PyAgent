...
@Data
public class Idea27728Config {
    private String name = "idea_027728";
 ...
 */
@Slf4j
public class Idea27728Service {
    private static final int IDEA_ID = 27728;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27728Service() {
        this(new Idea27728Config());
    }

    public Idea27728Service(Idea27728Config config) {
        this.config = config != null ? config : new Idea27728Config();
