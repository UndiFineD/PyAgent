...
@Data
public class Idea27599Config {
    private String name = "idea_027599";
 ...
 */
@Slf4j
public class Idea27599Service {
    private static final int IDEA_ID = 27599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27599Service() {
        this(new Idea27599Config());
    }

    public Idea27599Service(Idea27599Config config) {
        this.config = config != null ? config : new Idea27599Config();
