...
@Data
public class Idea27741Config {
    private String name = "idea_027741";
 ...
 */
@Slf4j
public class Idea27741Service {
    private static final int IDEA_ID = 27741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27741Service() {
        this(new Idea27741Config());
    }

    public Idea27741Service(Idea27741Config config) {
        this.config = config != null ? config : new Idea27741Config();
