...
@Data
public class Idea27604Config {
    private String name = "idea_027604";
 ...
 */
@Slf4j
public class Idea27604Service {
    private static final int IDEA_ID = 27604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27604Service() {
        this(new Idea27604Config());
    }

    public Idea27604Service(Idea27604Config config) {
        this.config = config != null ? config : new Idea27604Config();
