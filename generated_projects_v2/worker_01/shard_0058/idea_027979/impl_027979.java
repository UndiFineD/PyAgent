...
@Data
public class Idea27979Config {
    private String name = "idea_027979";
 ...
 */
@Slf4j
public class Idea27979Service {
    private static final int IDEA_ID = 27979;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27979Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27979Service() {
        this(new Idea27979Config());
    }

    public Idea27979Service(Idea27979Config config) {
        this.config = config != null ? config : new Idea27979Config();
