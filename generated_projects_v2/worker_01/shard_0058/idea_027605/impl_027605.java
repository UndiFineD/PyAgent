...
@Data
public class Idea27605Config {
    private String name = "idea_027605";
 ...
 */
@Slf4j
public class Idea27605Service {
    private static final int IDEA_ID = 27605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27605Service() {
        this(new Idea27605Config());
    }

    public Idea27605Service(Idea27605Config config) {
        this.config = config != null ? config : new Idea27605Config();
