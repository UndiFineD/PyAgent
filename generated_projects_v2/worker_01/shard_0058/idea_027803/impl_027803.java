...
@Data
public class Idea27803Config {
    private String name = "idea_027803";
 ...
 */
@Slf4j
public class Idea27803Service {
    private static final int IDEA_ID = 27803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27803Service() {
        this(new Idea27803Config());
    }

    public Idea27803Service(Idea27803Config config) {
        this.config = config != null ? config : new Idea27803Config();
