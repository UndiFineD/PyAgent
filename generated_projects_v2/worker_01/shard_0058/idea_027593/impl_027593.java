...
@Data
public class Idea27593Config {
    private String name = "idea_027593";
 ...
 */
@Slf4j
public class Idea27593Service {
    private static final int IDEA_ID = 27593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27593Service() {
        this(new Idea27593Config());
    }

    public Idea27593Service(Idea27593Config config) {
        this.config = config != null ? config : new Idea27593Config();
