...
@Data
public class Idea27795Config {
    private String name = "idea_027795";
 ...
 */
@Slf4j
public class Idea27795Service {
    private static final int IDEA_ID = 27795;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27795Service() {
        this(new Idea27795Config());
    }

    public Idea27795Service(Idea27795Config config) {
        this.config = config != null ? config : new Idea27795Config();
