...
@Data
public class Idea27710Config {
    private String name = "idea_027710";
 ...
 */
@Slf4j
public class Idea27710Service {
    private static final int IDEA_ID = 27710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27710Service() {
        this(new Idea27710Config());
    }

    public Idea27710Service(Idea27710Config config) {
        this.config = config != null ? config : new Idea27710Config();
