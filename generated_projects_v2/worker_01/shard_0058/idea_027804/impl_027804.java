...
@Data
public class Idea27804Config {
    private String name = "idea_027804";
 ...
 */
@Slf4j
public class Idea27804Service {
    private static final int IDEA_ID = 27804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27804Service() {
        this(new Idea27804Config());
    }

    public Idea27804Service(Idea27804Config config) {
        this.config = config != null ? config : new Idea27804Config();
