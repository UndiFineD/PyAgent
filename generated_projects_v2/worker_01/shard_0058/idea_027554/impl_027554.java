...
@Data
public class Idea27554Config {
    private String name = "idea_027554";
 ...
 */
@Slf4j
public class Idea27554Service {
    private static final int IDEA_ID = 27554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27554Service() {
        this(new Idea27554Config());
    }

    public Idea27554Service(Idea27554Config config) {
        this.config = config != null ? config : new Idea27554Config();
