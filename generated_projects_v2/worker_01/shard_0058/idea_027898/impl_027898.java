...
@Data
public class Idea27898Config {
    private String name = "idea_027898";
 ...
 */
@Slf4j
public class Idea27898Service {
    private static final int IDEA_ID = 27898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27898Service() {
        this(new Idea27898Config());
    }

    public Idea27898Service(Idea27898Config config) {
        this.config = config != null ? config : new Idea27898Config();
