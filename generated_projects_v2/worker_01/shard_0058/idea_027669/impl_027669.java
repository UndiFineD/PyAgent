...
@Data
public class Idea27669Config {
    private String name = "idea_027669";
 ...
 */
@Slf4j
public class Idea27669Service {
    private static final int IDEA_ID = 27669;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27669Service() {
        this(new Idea27669Config());
    }

    public Idea27669Service(Idea27669Config config) {
        this.config = config != null ? config : new Idea27669Config();
