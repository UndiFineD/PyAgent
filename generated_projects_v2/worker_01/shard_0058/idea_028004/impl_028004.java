...
@Data
public class Idea28004Config {
    private String name = "idea_028004";
 ...
 */
@Slf4j
public class Idea28004Service {
    private static final int IDEA_ID = 28004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28004Service() {
        this(new Idea28004Config());
    }

    public Idea28004Service(Idea28004Config config) {
        this.config = config != null ? config : new Idea28004Config();
