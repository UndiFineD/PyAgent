...
@Data
public class Idea27561Config {
    private String name = "idea_027561";
 ...
 */
@Slf4j
public class Idea27561Service {
    private static final int IDEA_ID = 27561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27561Service() {
        this(new Idea27561Config());
    }

    public Idea27561Service(Idea27561Config config) {
        this.config = config != null ? config : new Idea27561Config();
