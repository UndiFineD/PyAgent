...
@Data
public class Idea27789Config {
    private String name = "idea_027789";
 ...
 */
@Slf4j
public class Idea27789Service {
    private static final int IDEA_ID = 27789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27789Service() {
        this(new Idea27789Config());
    }

    public Idea27789Service(Idea27789Config config) {
        this.config = config != null ? config : new Idea27789Config();
