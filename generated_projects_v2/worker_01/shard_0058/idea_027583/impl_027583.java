...
@Data
public class Idea27583Config {
    private String name = "idea_027583";
 ...
 */
@Slf4j
public class Idea27583Service {
    private static final int IDEA_ID = 27583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27583Service() {
        this(new Idea27583Config());
    }

    public Idea27583Service(Idea27583Config config) {
        this.config = config != null ? config : new Idea27583Config();
