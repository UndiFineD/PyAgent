...
@Data
public class Idea27997Config {
    private String name = "idea_027997";
 ...
 */
@Slf4j
public class Idea27997Service {
    private static final int IDEA_ID = 27997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27997Service() {
        this(new Idea27997Config());
    }

    public Idea27997Service(Idea27997Config config) {
        this.config = config != null ? config : new Idea27997Config();
