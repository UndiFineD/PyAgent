...
@Data
public class Idea27784Config {
    private String name = "idea_027784";
 ...
 */
@Slf4j
public class Idea27784Service {
    private static final int IDEA_ID = 27784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27784Service() {
        this(new Idea27784Config());
    }

    public Idea27784Service(Idea27784Config config) {
        this.config = config != null ? config : new Idea27784Config();
