...
@Data
public class Idea27861Config {
    private String name = "idea_027861";
 ...
 */
@Slf4j
public class Idea27861Service {
    private static final int IDEA_ID = 27861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27861Service() {
        this(new Idea27861Config());
    }

    public Idea27861Service(Idea27861Config config) {
        this.config = config != null ? config : new Idea27861Config();
