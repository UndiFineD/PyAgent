...
@Data
public class Idea27730Config {
    private String name = "idea_027730";
 ...
 */
@Slf4j
public class Idea27730Service {
    private static final int IDEA_ID = 27730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27730Service() {
        this(new Idea27730Config());
    }

    public Idea27730Service(Idea27730Config config) {
        this.config = config != null ? config : new Idea27730Config();
