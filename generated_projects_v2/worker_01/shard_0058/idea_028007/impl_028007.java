...
@Data
public class Idea28007Config {
    private String name = "idea_028007";
 ...
 */
@Slf4j
public class Idea28007Service {
    private static final int IDEA_ID = 28007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28007Service() {
        this(new Idea28007Config());
    }

    public Idea28007Service(Idea28007Config config) {
        this.config = config != null ? config : new Idea28007Config();
