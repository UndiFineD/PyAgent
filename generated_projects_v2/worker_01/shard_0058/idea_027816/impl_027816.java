...
@Data
public class Idea27816Config {
    private String name = "idea_027816";
 ...
 */
@Slf4j
public class Idea27816Service {
    private static final int IDEA_ID = 27816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27816Service() {
        this(new Idea27816Config());
    }

    public Idea27816Service(Idea27816Config config) {
        this.config = config != null ? config : new Idea27816Config();
