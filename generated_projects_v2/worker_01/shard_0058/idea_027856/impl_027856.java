...
@Data
public class Idea27856Config {
    private String name = "idea_027856";
 ...
 */
@Slf4j
public class Idea27856Service {
    private static final int IDEA_ID = 27856;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27856Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27856Service() {
        this(new Idea27856Config());
    }

    public Idea27856Service(Idea27856Config config) {
        this.config = config != null ? config : new Idea27856Config();
