...
@Data
public class Idea27815Config {
    private String name = "idea_027815";
 ...
 */
@Slf4j
public class Idea27815Service {
    private static final int IDEA_ID = 27815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27815Service() {
        this(new Idea27815Config());
    }

    public Idea27815Service(Idea27815Config config) {
        this.config = config != null ? config : new Idea27815Config();
