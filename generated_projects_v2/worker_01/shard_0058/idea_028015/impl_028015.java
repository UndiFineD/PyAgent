...
@Data
public class Idea28015Config {
    private String name = "idea_028015";
 ...
 */
@Slf4j
public class Idea28015Service {
    private static final int IDEA_ID = 28015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28015Service() {
        this(new Idea28015Config());
    }

    public Idea28015Service(Idea28015Config config) {
        this.config = config != null ? config : new Idea28015Config();
