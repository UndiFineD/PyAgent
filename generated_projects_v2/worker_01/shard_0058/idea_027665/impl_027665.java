...
@Data
public class Idea27665Config {
    private String name = "idea_027665";
 ...
 */
@Slf4j
public class Idea27665Service {
    private static final int IDEA_ID = 27665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27665Service() {
        this(new Idea27665Config());
    }

    public Idea27665Service(Idea27665Config config) {
        this.config = config != null ? config : new Idea27665Config();
