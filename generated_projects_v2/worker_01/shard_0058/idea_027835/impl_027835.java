...
@Data
public class Idea27835Config {
    private String name = "idea_027835";
 ...
 */
@Slf4j
public class Idea27835Service {
    private static final int IDEA_ID = 27835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27835Service() {
        this(new Idea27835Config());
    }

    public Idea27835Service(Idea27835Config config) {
        this.config = config != null ? config : new Idea27835Config();
