...
@Data
public class Idea27857Config {
    private String name = "idea_027857";
 ...
 */
@Slf4j
public class Idea27857Service {
    private static final int IDEA_ID = 27857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27857Service() {
        this(new Idea27857Config());
    }

    public Idea27857Service(Idea27857Config config) {
        this.config = config != null ? config : new Idea27857Config();
