...
@Data
public class Idea27577Config {
    private String name = "idea_027577";
 ...
 */
@Slf4j
public class Idea27577Service {
    private static final int IDEA_ID = 27577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27577Service() {
        this(new Idea27577Config());
    }

    public Idea27577Service(Idea27577Config config) {
        this.config = config != null ? config : new Idea27577Config();
