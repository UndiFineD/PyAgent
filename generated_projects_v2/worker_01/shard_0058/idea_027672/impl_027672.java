...
@Data
public class Idea27672Config {
    private String name = "idea_027672";
 ...
 */
@Slf4j
public class Idea27672Service {
    private static final int IDEA_ID = 27672;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27672Service() {
        this(new Idea27672Config());
    }

    public Idea27672Service(Idea27672Config config) {
        this.config = config != null ? config : new Idea27672Config();
