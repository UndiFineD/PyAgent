...
@Data
public class Idea27776Config {
    private String name = "idea_027776";
 ...
 */
@Slf4j
public class Idea27776Service {
    private static final int IDEA_ID = 27776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27776Service() {
        this(new Idea27776Config());
    }

    public Idea27776Service(Idea27776Config config) {
        this.config = config != null ? config : new Idea27776Config();
