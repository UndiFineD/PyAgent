...
@Data
public class Idea27626Config {
    private String name = "idea_027626";
 ...
 */
@Slf4j
public class Idea27626Service {
    private static final int IDEA_ID = 27626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27626Service() {
        this(new Idea27626Config());
    }

    public Idea27626Service(Idea27626Config config) {
        this.config = config != null ? config : new Idea27626Config();
