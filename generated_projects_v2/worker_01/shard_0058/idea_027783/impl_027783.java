...
@Data
public class Idea27783Config {
    private String name = "idea_027783";
 ...
 */
@Slf4j
public class Idea27783Service {
    private static final int IDEA_ID = 27783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27783Service() {
        this(new Idea27783Config());
    }

    public Idea27783Service(Idea27783Config config) {
        this.config = config != null ? config : new Idea27783Config();
