...
@Data
public class Idea28019Config {
    private String name = "idea_028019";
 ...
 */
@Slf4j
public class Idea28019Service {
    private static final int IDEA_ID = 28019;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28019Service() {
        this(new Idea28019Config());
    }

    public Idea28019Service(Idea28019Config config) {
        this.config = config != null ? config : new Idea28019Config();
