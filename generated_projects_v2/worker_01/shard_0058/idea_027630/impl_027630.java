...
@Data
public class Idea27630Config {
    private String name = "idea_027630";
 ...
 */
@Slf4j
public class Idea27630Service {
    private static final int IDEA_ID = 27630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27630Service() {
        this(new Idea27630Config());
    }

    public Idea27630Service(Idea27630Config config) {
        this.config = config != null ? config : new Idea27630Config();
