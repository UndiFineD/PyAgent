...
@Data
public class Idea27891Config {
    private String name = "idea_027891";
 ...
 */
@Slf4j
public class Idea27891Service {
    private static final int IDEA_ID = 27891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27891Service() {
        this(new Idea27891Config());
    }

    public Idea27891Service(Idea27891Config config) {
        this.config = config != null ? config : new Idea27891Config();
