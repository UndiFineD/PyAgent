...
@Data
public class Idea27871Config {
    private String name = "idea_027871";
 ...
 */
@Slf4j
public class Idea27871Service {
    private static final int IDEA_ID = 27871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27871Service() {
        this(new Idea27871Config());
    }

    public Idea27871Service(Idea27871Config config) {
        this.config = config != null ? config : new Idea27871Config();
