...
@Data
public class Idea27679Config {
    private String name = "idea_027679";
 ...
 */
@Slf4j
public class Idea27679Service {
    private static final int IDEA_ID = 27679;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27679Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27679Service() {
        this(new Idea27679Config());
    }

    public Idea27679Service(Idea27679Config config) {
        this.config = config != null ? config : new Idea27679Config();
