...
@Data
public class Idea27963Config {
    private String name = "idea_027963";
 ...
 */
@Slf4j
public class Idea27963Service {
    private static final int IDEA_ID = 27963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27963Service() {
        this(new Idea27963Config());
    }

    public Idea27963Service(Idea27963Config config) {
        this.config = config != null ? config : new Idea27963Config();
