...
@Data
public class Idea27739Config {
    private String name = "idea_027739";
 ...
 */
@Slf4j
public class Idea27739Service {
    private static final int IDEA_ID = 27739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27739Service() {
        this(new Idea27739Config());
    }

    public Idea27739Service(Idea27739Config config) {
        this.config = config != null ? config : new Idea27739Config();
