...
@Data
public class Idea27718Config {
    private String name = "idea_027718";
 ...
 */
@Slf4j
public class Idea27718Service {
    private static final int IDEA_ID = 27718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27718Service() {
        this(new Idea27718Config());
    }

    public Idea27718Service(Idea27718Config config) {
        this.config = config != null ? config : new Idea27718Config();
