...
@Data
public class Idea27589Config {
    private String name = "idea_027589";
 ...
 */
@Slf4j
public class Idea27589Service {
    private static final int IDEA_ID = 27589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27589Service() {
        this(new Idea27589Config());
    }

    public Idea27589Service(Idea27589Config config) {
        this.config = config != null ? config : new Idea27589Config();
