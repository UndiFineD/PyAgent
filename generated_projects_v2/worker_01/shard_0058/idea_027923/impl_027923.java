...
@Data
public class Idea27923Config {
    private String name = "idea_027923";
 ...
 */
@Slf4j
public class Idea27923Service {
    private static final int IDEA_ID = 27923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27923Service() {
        this(new Idea27923Config());
    }

    public Idea27923Service(Idea27923Config config) {
        this.config = config != null ? config : new Idea27923Config();
