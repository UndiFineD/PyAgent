...
@Data
public class Idea27892Config {
    private String name = "idea_027892";
 ...
 */
@Slf4j
public class Idea27892Service {
    private static final int IDEA_ID = 27892;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27892Service() {
        this(new Idea27892Config());
    }

    public Idea27892Service(Idea27892Config config) {
        this.config = config != null ? config : new Idea27892Config();
