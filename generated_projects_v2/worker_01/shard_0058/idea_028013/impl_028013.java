...
@Data
public class Idea28013Config {
    private String name = "idea_028013";
 ...
 */
@Slf4j
public class Idea28013Service {
    private static final int IDEA_ID = 28013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28013Service() {
        this(new Idea28013Config());
    }

    public Idea28013Service(Idea28013Config config) {
        this.config = config != null ? config : new Idea28013Config();
