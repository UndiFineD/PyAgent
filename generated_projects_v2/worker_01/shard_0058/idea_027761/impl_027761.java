...
@Data
public class Idea27761Config {
    private String name = "idea_027761";
 ...
 */
@Slf4j
public class Idea27761Service {
    private static final int IDEA_ID = 27761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27761Service() {
        this(new Idea27761Config());
    }

    public Idea27761Service(Idea27761Config config) {
        this.config = config != null ? config : new Idea27761Config();
