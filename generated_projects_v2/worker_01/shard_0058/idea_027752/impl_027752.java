...
@Data
public class Idea27752Config {
    private String name = "idea_027752";
 ...
 */
@Slf4j
public class Idea27752Service {
    private static final int IDEA_ID = 27752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27752Service() {
        this(new Idea27752Config());
    }

    public Idea27752Service(Idea27752Config config) {
        this.config = config != null ? config : new Idea27752Config();
