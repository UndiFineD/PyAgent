...
@Data
public class Idea27744Config {
    private String name = "idea_027744";
 ...
 */
@Slf4j
public class Idea27744Service {
    private static final int IDEA_ID = 27744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27744Service() {
        this(new Idea27744Config());
    }

    public Idea27744Service(Idea27744Config config) {
        this.config = config != null ? config : new Idea27744Config();
