...
@Data
public class Idea27785Config {
    private String name = "idea_027785";
 ...
 */
@Slf4j
public class Idea27785Service {
    private static final int IDEA_ID = 27785;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27785Service() {
        this(new Idea27785Config());
    }

    public Idea27785Service(Idea27785Config config) {
        this.config = config != null ? config : new Idea27785Config();
