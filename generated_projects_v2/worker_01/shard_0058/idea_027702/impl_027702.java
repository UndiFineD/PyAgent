...
@Data
public class Idea27702Config {
    private String name = "idea_027702";
 ...
 */
@Slf4j
public class Idea27702Service {
    private static final int IDEA_ID = 27702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27702Service() {
        this(new Idea27702Config());
    }

    public Idea27702Service(Idea27702Config config) {
        this.config = config != null ? config : new Idea27702Config();
