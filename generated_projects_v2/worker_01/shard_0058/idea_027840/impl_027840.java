...
@Data
public class Idea27840Config {
    private String name = "idea_027840";
 ...
 */
@Slf4j
public class Idea27840Service {
    private static final int IDEA_ID = 27840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27840Service() {
        this(new Idea27840Config());
    }

    public Idea27840Service(Idea27840Config config) {
        this.config = config != null ? config : new Idea27840Config();
