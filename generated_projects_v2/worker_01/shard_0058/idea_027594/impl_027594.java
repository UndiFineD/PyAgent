...
@Data
public class Idea27594Config {
    private String name = "idea_027594";
 ...
 */
@Slf4j
public class Idea27594Service {
    private static final int IDEA_ID = 27594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27594Service() {
        this(new Idea27594Config());
    }

    public Idea27594Service(Idea27594Config config) {
        this.config = config != null ? config : new Idea27594Config();
