...
@Data
public class Idea27705Config {
    private String name = "idea_027705";
 ...
 */
@Slf4j
public class Idea27705Service {
    private static final int IDEA_ID = 27705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27705Service() {
        this(new Idea27705Config());
    }

    public Idea27705Service(Idea27705Config config) {
        this.config = config != null ? config : new Idea27705Config();
