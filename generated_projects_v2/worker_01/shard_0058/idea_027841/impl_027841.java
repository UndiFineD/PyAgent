...
@Data
public class Idea27841Config {
    private String name = "idea_027841";
 ...
 */
@Slf4j
public class Idea27841Service {
    private static final int IDEA_ID = 27841;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27841Service() {
        this(new Idea27841Config());
    }

    public Idea27841Service(Idea27841Config config) {
        this.config = config != null ? config : new Idea27841Config();
