...
@Data
public class Idea27955Config {
    private String name = "idea_027955";
 ...
 */
@Slf4j
public class Idea27955Service {
    private static final int IDEA_ID = 27955;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27955Service() {
        this(new Idea27955Config());
    }

    public Idea27955Service(Idea27955Config config) {
        this.config = config != null ? config : new Idea27955Config();
