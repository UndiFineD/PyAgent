...
@Data
public class Idea27610Config {
    private String name = "idea_027610";
 ...
 */
@Slf4j
public class Idea27610Service {
    private static final int IDEA_ID = 27610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27610Service() {
        this(new Idea27610Config());
    }

    public Idea27610Service(Idea27610Config config) {
        this.config = config != null ? config : new Idea27610Config();
