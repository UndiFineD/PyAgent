...
@Data
public class Idea27991Config {
    private String name = "idea_027991";
 ...
 */
@Slf4j
public class Idea27991Service {
    private static final int IDEA_ID = 27991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27991Service() {
        this(new Idea27991Config());
    }

    public Idea27991Service(Idea27991Config config) {
        this.config = config != null ? config : new Idea27991Config();
