...
@Data
public class Idea27915Config {
    private String name = "idea_027915";
 ...
 */
@Slf4j
public class Idea27915Service {
    private static final int IDEA_ID = 27915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27915Service() {
        this(new Idea27915Config());
    }

    public Idea27915Service(Idea27915Config config) {
        this.config = config != null ? config : new Idea27915Config();
