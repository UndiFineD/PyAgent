...
@Data
public class Idea27699Config {
    private String name = "idea_027699";
 ...
 */
@Slf4j
public class Idea27699Service {
    private static final int IDEA_ID = 27699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27699Service() {
        this(new Idea27699Config());
    }

    public Idea27699Service(Idea27699Config config) {
        this.config = config != null ? config : new Idea27699Config();
