...
@Data
public class Idea27849Config {
    private String name = "idea_027849";
 ...
 */
@Slf4j
public class Idea27849Service {
    private static final int IDEA_ID = 27849;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27849Service() {
        this(new Idea27849Config());
    }

    public Idea27849Service(Idea27849Config config) {
        this.config = config != null ? config : new Idea27849Config();
