...
@Data
public class Idea27601Config {
    private String name = "idea_027601";
 ...
 */
@Slf4j
public class Idea27601Service {
    private static final int IDEA_ID = 27601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27601Service() {
        this(new Idea27601Config());
    }

    public Idea27601Service(Idea27601Config config) {
        this.config = config != null ? config : new Idea27601Config();
