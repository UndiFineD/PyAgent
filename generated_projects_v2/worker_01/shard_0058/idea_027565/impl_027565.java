...
@Data
public class Idea27565Config {
    private String name = "idea_027565";
 ...
 */
@Slf4j
public class Idea27565Service {
    private static final int IDEA_ID = 27565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27565Service() {
        this(new Idea27565Config());
    }

    public Idea27565Service(Idea27565Config config) {
        this.config = config != null ? config : new Idea27565Config();
