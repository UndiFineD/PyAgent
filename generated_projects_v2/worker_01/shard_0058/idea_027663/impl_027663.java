...
@Data
public class Idea27663Config {
    private String name = "idea_027663";
 ...
 */
@Slf4j
public class Idea27663Service {
    private static final int IDEA_ID = 27663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27663Service() {
        this(new Idea27663Config());
    }

    public Idea27663Service(Idea27663Config config) {
        this.config = config != null ? config : new Idea27663Config();
