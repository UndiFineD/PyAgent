...
@Data
public class Idea27852Config {
    private String name = "idea_027852";
 ...
 */
@Slf4j
public class Idea27852Service {
    private static final int IDEA_ID = 27852;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27852Service() {
        this(new Idea27852Config());
    }

    public Idea27852Service(Idea27852Config config) {
        this.config = config != null ? config : new Idea27852Config();
