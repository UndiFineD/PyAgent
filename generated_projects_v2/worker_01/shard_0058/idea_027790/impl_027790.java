...
@Data
public class Idea27790Config {
    private String name = "idea_027790";
 ...
 */
@Slf4j
public class Idea27790Service {
    private static final int IDEA_ID = 27790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27790Service() {
        this(new Idea27790Config());
    }

    public Idea27790Service(Idea27790Config config) {
        this.config = config != null ? config : new Idea27790Config();
