...
@Data
public class Idea27597Config {
    private String name = "idea_027597";
 ...
 */
@Slf4j
public class Idea27597Service {
    private static final int IDEA_ID = 27597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27597Service() {
        this(new Idea27597Config());
    }

    public Idea27597Service(Idea27597Config config) {
        this.config = config != null ? config : new Idea27597Config();
