...
@Data
public class Idea27996Config {
    private String name = "idea_027996";
 ...
 */
@Slf4j
public class Idea27996Service {
    private static final int IDEA_ID = 27996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27996Service() {
        this(new Idea27996Config());
    }

    public Idea27996Service(Idea27996Config config) {
        this.config = config != null ? config : new Idea27996Config();
