...
@Data
public class Idea27550Config {
    private String name = "idea_027550";
 ...
 */
@Slf4j
public class Idea27550Service {
    private static final int IDEA_ID = 27550;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27550Service() {
        this(new Idea27550Config());
    }

    public Idea27550Service(Idea27550Config config) {
        this.config = config != null ? config : new Idea27550Config();
