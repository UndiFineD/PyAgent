...
@Data
public class Idea27767Config {
    private String name = "idea_027767";
 ...
 */
@Slf4j
public class Idea27767Service {
    private static final int IDEA_ID = 27767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27767Service() {
        this(new Idea27767Config());
    }

    public Idea27767Service(Idea27767Config config) {
        this.config = config != null ? config : new Idea27767Config();
