...
@Data
public class Idea27742Config {
    private String name = "idea_027742";
 ...
 */
@Slf4j
public class Idea27742Service {
    private static final int IDEA_ID = 27742;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27742Service() {
        this(new Idea27742Config());
    }

    public Idea27742Service(Idea27742Config config) {
        this.config = config != null ? config : new Idea27742Config();
