...
@Data
public class Idea27943Config {
    private String name = "idea_027943";
 ...
 */
@Slf4j
public class Idea27943Service {
    private static final int IDEA_ID = 27943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27943Service() {
        this(new Idea27943Config());
    }

    public Idea27943Service(Idea27943Config config) {
        this.config = config != null ? config : new Idea27943Config();
