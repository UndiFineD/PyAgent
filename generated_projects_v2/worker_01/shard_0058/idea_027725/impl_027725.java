...
@Data
public class Idea27725Config {
    private String name = "idea_027725";
 ...
 */
@Slf4j
public class Idea27725Service {
    private static final int IDEA_ID = 27725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27725Service() {
        this(new Idea27725Config());
    }

    public Idea27725Service(Idea27725Config config) {
        this.config = config != null ? config : new Idea27725Config();
