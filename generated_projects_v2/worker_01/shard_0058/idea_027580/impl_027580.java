...
@Data
public class Idea27580Config {
    private String name = "idea_027580";
 ...
 */
@Slf4j
public class Idea27580Service {
    private static final int IDEA_ID = 27580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27580Service() {
        this(new Idea27580Config());
    }

    public Idea27580Service(Idea27580Config config) {
        this.config = config != null ? config : new Idea27580Config();
