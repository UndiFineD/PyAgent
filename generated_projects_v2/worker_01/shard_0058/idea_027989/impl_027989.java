...
@Data
public class Idea27989Config {
    private String name = "idea_027989";
 ...
 */
@Slf4j
public class Idea27989Service {
    private static final int IDEA_ID = 27989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27989Service() {
        this(new Idea27989Config());
    }

    public Idea27989Service(Idea27989Config config) {
        this.config = config != null ? config : new Idea27989Config();
