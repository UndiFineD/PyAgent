...
@Data
public class Idea27711Config {
    private String name = "idea_027711";
 ...
 */
@Slf4j
public class Idea27711Service {
    private static final int IDEA_ID = 27711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27711Service() {
        this(new Idea27711Config());
    }

    public Idea27711Service(Idea27711Config config) {
        this.config = config != null ? config : new Idea27711Config();
