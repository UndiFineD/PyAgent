...
@Data
public class Idea27572Config {
    private String name = "idea_027572";
 ...
 */
@Slf4j
public class Idea27572Service {
    private static final int IDEA_ID = 27572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27572Service() {
        this(new Idea27572Config());
    }

    public Idea27572Service(Idea27572Config config) {
        this.config = config != null ? config : new Idea27572Config();
