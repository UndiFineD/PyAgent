...
@Data
public class Idea27607Config {
    private String name = "idea_027607";
 ...
 */
@Slf4j
public class Idea27607Service {
    private static final int IDEA_ID = 27607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27607Service() {
        this(new Idea27607Config());
    }

    public Idea27607Service(Idea27607Config config) {
        this.config = config != null ? config : new Idea27607Config();
