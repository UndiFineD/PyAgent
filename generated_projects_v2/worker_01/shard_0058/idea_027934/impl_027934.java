...
@Data
public class Idea27934Config {
    private String name = "idea_027934";
 ...
 */
@Slf4j
public class Idea27934Service {
    private static final int IDEA_ID = 27934;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27934Service() {
        this(new Idea27934Config());
    }

    public Idea27934Service(Idea27934Config config) {
        this.config = config != null ? config : new Idea27934Config();
