...
@Data
public class Idea28010Config {
    private String name = "idea_028010";
 ...
 */
@Slf4j
public class Idea28010Service {
    private static final int IDEA_ID = 28010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28010Service() {
        this(new Idea28010Config());
    }

    public Idea28010Service(Idea28010Config config) {
        this.config = config != null ? config : new Idea28010Config();
