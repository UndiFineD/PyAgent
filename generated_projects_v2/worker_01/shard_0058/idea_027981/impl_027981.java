...
@Data
public class Idea27981Config {
    private String name = "idea_027981";
 ...
 */
@Slf4j
public class Idea27981Service {
    private static final int IDEA_ID = 27981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27981Service() {
        this(new Idea27981Config());
    }

    public Idea27981Service(Idea27981Config config) {
        this.config = config != null ? config : new Idea27981Config();
