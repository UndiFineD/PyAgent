...
@Data
public class Idea27999Config {
    private String name = "idea_027999";
 ...
 */
@Slf4j
public class Idea27999Service {
    private static final int IDEA_ID = 27999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27999Service() {
        this(new Idea27999Config());
    }

    public Idea27999Service(Idea27999Config config) {
        this.config = config != null ? config : new Idea27999Config();
