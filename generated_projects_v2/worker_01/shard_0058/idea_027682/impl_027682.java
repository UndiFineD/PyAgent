...
@Data
public class Idea27682Config {
    private String name = "idea_027682";
 ...
 */
@Slf4j
public class Idea27682Service {
    private static final int IDEA_ID = 27682;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27682Service() {
        this(new Idea27682Config());
    }

    public Idea27682Service(Idea27682Config config) {
        this.config = config != null ? config : new Idea27682Config();
