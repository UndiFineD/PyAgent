...
@Data
public class Idea27896Config {
    private String name = "idea_027896";
 ...
 */
@Slf4j
public class Idea27896Service {
    private static final int IDEA_ID = 27896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27896Service() {
        this(new Idea27896Config());
    }

    public Idea27896Service(Idea27896Config config) {
        this.config = config != null ? config : new Idea27896Config();
