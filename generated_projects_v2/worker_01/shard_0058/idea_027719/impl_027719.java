...
@Data
public class Idea27719Config {
    private String name = "idea_027719";
 ...
 */
@Slf4j
public class Idea27719Service {
    private static final int IDEA_ID = 27719;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27719Service() {
        this(new Idea27719Config());
    }

    public Idea27719Service(Idea27719Config config) {
        this.config = config != null ? config : new Idea27719Config();
