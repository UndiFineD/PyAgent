...
@Data
public class Idea27660Config {
    private String name = "idea_027660";
 ...
 */
@Slf4j
public class Idea27660Service {
    private static final int IDEA_ID = 27660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27660Service() {
        this(new Idea27660Config());
    }

    public Idea27660Service(Idea27660Config config) {
        this.config = config != null ? config : new Idea27660Config();
