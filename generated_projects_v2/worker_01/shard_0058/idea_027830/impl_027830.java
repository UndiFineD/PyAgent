...
@Data
public class Idea27830Config {
    private String name = "idea_027830";
 ...
 */
@Slf4j
public class Idea27830Service {
    private static final int IDEA_ID = 27830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27830Service() {
        this(new Idea27830Config());
    }

    public Idea27830Service(Idea27830Config config) {
        this.config = config != null ? config : new Idea27830Config();
