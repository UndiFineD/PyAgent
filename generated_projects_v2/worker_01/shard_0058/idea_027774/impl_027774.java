...
@Data
public class Idea27774Config {
    private String name = "idea_027774";
 ...
 */
@Slf4j
public class Idea27774Service {
    private static final int IDEA_ID = 27774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27774Service() {
        this(new Idea27774Config());
    }

    public Idea27774Service(Idea27774Config config) {
        this.config = config != null ? config : new Idea27774Config();
