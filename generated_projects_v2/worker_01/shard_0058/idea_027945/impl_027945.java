...
@Data
public class Idea27945Config {
    private String name = "idea_027945";
 ...
 */
@Slf4j
public class Idea27945Service {
    private static final int IDEA_ID = 27945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27945Service() {
        this(new Idea27945Config());
    }

    public Idea27945Service(Idea27945Config config) {
        this.config = config != null ? config : new Idea27945Config();
