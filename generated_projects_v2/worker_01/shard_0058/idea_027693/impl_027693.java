...
@Data
public class Idea27693Config {
    private String name = "idea_027693";
 ...
 */
@Slf4j
public class Idea27693Service {
    private static final int IDEA_ID = 27693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27693Service() {
        this(new Idea27693Config());
    }

    public Idea27693Service(Idea27693Config config) {
        this.config = config != null ? config : new Idea27693Config();
