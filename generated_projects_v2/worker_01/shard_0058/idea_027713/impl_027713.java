...
@Data
public class Idea27713Config {
    private String name = "idea_027713";
 ...
 */
@Slf4j
public class Idea27713Service {
    private static final int IDEA_ID = 27713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27713Service() {
        this(new Idea27713Config());
    }

    public Idea27713Service(Idea27713Config config) {
        this.config = config != null ? config : new Idea27713Config();
