...
@Data
public class Idea27768Config {
    private String name = "idea_027768";
 ...
 */
@Slf4j
public class Idea27768Service {
    private static final int IDEA_ID = 27768;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27768Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27768Service() {
        this(new Idea27768Config());
    }

    public Idea27768Service(Idea27768Config config) {
        this.config = config != null ? config : new Idea27768Config();
