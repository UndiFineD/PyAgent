...
@Data
public class Idea27993Config {
    private String name = "idea_027993";
 ...
 */
@Slf4j
public class Idea27993Service {
    private static final int IDEA_ID = 27993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27993Service() {
        this(new Idea27993Config());
    }

    public Idea27993Service(Idea27993Config config) {
        this.config = config != null ? config : new Idea27993Config();
