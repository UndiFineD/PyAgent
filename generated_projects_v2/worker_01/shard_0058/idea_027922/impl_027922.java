...
@Data
public class Idea27922Config {
    private String name = "idea_027922";
 ...
 */
@Slf4j
public class Idea27922Service {
    private static final int IDEA_ID = 27922;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27922Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27922Service() {
        this(new Idea27922Config());
    }

    public Idea27922Service(Idea27922Config config) {
        this.config = config != null ? config : new Idea27922Config();
