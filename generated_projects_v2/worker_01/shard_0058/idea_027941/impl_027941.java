...
@Data
public class Idea27941Config {
    private String name = "idea_027941";
 ...
 */
@Slf4j
public class Idea27941Service {
    private static final int IDEA_ID = 27941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27941Service() {
        this(new Idea27941Config());
    }

    public Idea27941Service(Idea27941Config config) {
        this.config = config != null ? config : new Idea27941Config();
