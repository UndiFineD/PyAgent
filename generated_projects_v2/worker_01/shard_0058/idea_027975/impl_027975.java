...
@Data
public class Idea27975Config {
    private String name = "idea_027975";
 ...
 */
@Slf4j
public class Idea27975Service {
    private static final int IDEA_ID = 27975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27975Service() {
        this(new Idea27975Config());
    }

    public Idea27975Service(Idea27975Config config) {
        this.config = config != null ? config : new Idea27975Config();
