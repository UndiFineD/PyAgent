...
@Data
public class Idea27905Config {
    private String name = "idea_027905";
 ...
 */
@Slf4j
public class Idea27905Service {
    private static final int IDEA_ID = 27905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27905Service() {
        this(new Idea27905Config());
    }

    public Idea27905Service(Idea27905Config config) {
        this.config = config != null ? config : new Idea27905Config();
