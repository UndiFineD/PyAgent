...
@Data
public class Idea28000Config {
    private String name = "idea_028000";
 ...
 */
@Slf4j
public class Idea28000Service {
    private static final int IDEA_ID = 28000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28000Service() {
        this(new Idea28000Config());
    }

    public Idea28000Service(Idea28000Config config) {
        this.config = config != null ? config : new Idea28000Config();
