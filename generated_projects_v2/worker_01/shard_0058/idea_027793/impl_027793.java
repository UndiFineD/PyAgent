...
@Data
public class Idea27793Config {
    private String name = "idea_027793";
 ...
 */
@Slf4j
public class Idea27793Service {
    private static final int IDEA_ID = 27793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27793Service() {
        this(new Idea27793Config());
    }

    public Idea27793Service(Idea27793Config config) {
        this.config = config != null ? config : new Idea27793Config();
