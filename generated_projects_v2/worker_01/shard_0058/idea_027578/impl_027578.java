...
@Data
public class Idea27578Config {
    private String name = "idea_027578";
 ...
 */
@Slf4j
public class Idea27578Service {
    private static final int IDEA_ID = 27578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27578Service() {
        this(new Idea27578Config());
    }

    public Idea27578Service(Idea27578Config config) {
        this.config = config != null ? config : new Idea27578Config();
