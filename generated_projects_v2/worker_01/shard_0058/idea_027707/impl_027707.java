...
@Data
public class Idea27707Config {
    private String name = "idea_027707";
 ...
 */
@Slf4j
public class Idea27707Service {
    private static final int IDEA_ID = 27707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27707Service() {
        this(new Idea27707Config());
    }

    public Idea27707Service(Idea27707Config config) {
        this.config = config != null ? config : new Idea27707Config();
