...
@Data
public class Idea27655Config {
    private String name = "idea_027655";
 ...
 */
@Slf4j
public class Idea27655Service {
    private static final int IDEA_ID = 27655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27655Service() {
        this(new Idea27655Config());
    }

    public Idea27655Service(Idea27655Config config) {
        this.config = config != null ? config : new Idea27655Config();
