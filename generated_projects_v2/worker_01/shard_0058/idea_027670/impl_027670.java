...
@Data
public class Idea27670Config {
    private String name = "idea_027670";
 ...
 */
@Slf4j
public class Idea27670Service {
    private static final int IDEA_ID = 27670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27670Service() {
        this(new Idea27670Config());
    }

    public Idea27670Service(Idea27670Config config) {
        this.config = config != null ? config : new Idea27670Config();
