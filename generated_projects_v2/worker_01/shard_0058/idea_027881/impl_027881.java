...
@Data
public class Idea27881Config {
    private String name = "idea_027881";
 ...
 */
@Slf4j
public class Idea27881Service {
    private static final int IDEA_ID = 27881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27881Service() {
        this(new Idea27881Config());
    }

    public Idea27881Service(Idea27881Config config) {
        this.config = config != null ? config : new Idea27881Config();
