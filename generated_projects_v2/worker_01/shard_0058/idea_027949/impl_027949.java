...
@Data
public class Idea27949Config {
    private String name = "idea_027949";
 ...
 */
@Slf4j
public class Idea27949Service {
    private static final int IDEA_ID = 27949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27949Service() {
        this(new Idea27949Config());
    }

    public Idea27949Service(Idea27949Config config) {
        this.config = config != null ? config : new Idea27949Config();
