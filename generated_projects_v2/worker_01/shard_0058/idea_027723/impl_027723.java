...
@Data
public class Idea27723Config {
    private String name = "idea_027723";
 ...
 */
@Slf4j
public class Idea27723Service {
    private static final int IDEA_ID = 27723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27723Service() {
        this(new Idea27723Config());
    }

    public Idea27723Service(Idea27723Config config) {
        this.config = config != null ? config : new Idea27723Config();
