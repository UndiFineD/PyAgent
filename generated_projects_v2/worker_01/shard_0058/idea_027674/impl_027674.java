...
@Data
public class Idea27674Config {
    private String name = "idea_027674";
 ...
 */
@Slf4j
public class Idea27674Service {
    private static final int IDEA_ID = 27674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27674Service() {
        this(new Idea27674Config());
    }

    public Idea27674Service(Idea27674Config config) {
        this.config = config != null ? config : new Idea27674Config();
