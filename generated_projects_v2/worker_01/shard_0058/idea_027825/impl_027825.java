...
@Data
public class Idea27825Config {
    private String name = "idea_027825";
 ...
 */
@Slf4j
public class Idea27825Service {
    private static final int IDEA_ID = 27825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27825Service() {
        this(new Idea27825Config());
    }

    public Idea27825Service(Idea27825Config config) {
        this.config = config != null ? config : new Idea27825Config();
