...
@Data
public class Idea27985Config {
    private String name = "idea_027985";
 ...
 */
@Slf4j
public class Idea27985Service {
    private static final int IDEA_ID = 27985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27985Service() {
        this(new Idea27985Config());
    }

    public Idea27985Service(Idea27985Config config) {
        this.config = config != null ? config : new Idea27985Config();
