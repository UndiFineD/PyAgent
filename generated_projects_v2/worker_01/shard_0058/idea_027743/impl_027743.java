...
@Data
public class Idea27743Config {
    private String name = "idea_027743";
 ...
 */
@Slf4j
public class Idea27743Service {
    private static final int IDEA_ID = 27743;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27743Service() {
        this(new Idea27743Config());
    }

    public Idea27743Service(Idea27743Config config) {
        this.config = config != null ? config : new Idea27743Config();
