...
@Data
public class Idea27563Config {
    private String name = "idea_027563";
 ...
 */
@Slf4j
public class Idea27563Service {
    private static final int IDEA_ID = 27563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27563Service() {
        this(new Idea27563Config());
    }

    public Idea27563Service(Idea27563Config config) {
        this.config = config != null ? config : new Idea27563Config();
