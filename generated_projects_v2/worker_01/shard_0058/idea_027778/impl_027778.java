...
@Data
public class Idea27778Config {
    private String name = "idea_027778";
 ...
 */
@Slf4j
public class Idea27778Service {
    private static final int IDEA_ID = 27778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27778Service() {
        this(new Idea27778Config());
    }

    public Idea27778Service(Idea27778Config config) {
        this.config = config != null ? config : new Idea27778Config();
