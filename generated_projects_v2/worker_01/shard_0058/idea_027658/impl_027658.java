...
@Data
public class Idea27658Config {
    private String name = "idea_027658";
 ...
 */
@Slf4j
public class Idea27658Service {
    private static final int IDEA_ID = 27658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27658Service() {
        this(new Idea27658Config());
    }

    public Idea27658Service(Idea27658Config config) {
        this.config = config != null ? config : new Idea27658Config();
