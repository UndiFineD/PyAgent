...
@Data
public class Idea27940Config {
    private String name = "idea_027940";
 ...
 */
@Slf4j
public class Idea27940Service {
    private static final int IDEA_ID = 27940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27940Service() {
        this(new Idea27940Config());
    }

    public Idea27940Service(Idea27940Config config) {
        this.config = config != null ? config : new Idea27940Config();
