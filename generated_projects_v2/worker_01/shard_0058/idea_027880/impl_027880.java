...
@Data
public class Idea27880Config {
    private String name = "idea_027880";
 ...
 */
@Slf4j
public class Idea27880Service {
    private static final int IDEA_ID = 27880;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27880Service() {
        this(new Idea27880Config());
    }

    public Idea27880Service(Idea27880Config config) {
        this.config = config != null ? config : new Idea27880Config();
