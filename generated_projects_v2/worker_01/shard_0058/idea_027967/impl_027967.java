...
@Data
public class Idea27967Config {
    private String name = "idea_027967";
 ...
 */
@Slf4j
public class Idea27967Service {
    private static final int IDEA_ID = 27967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27967Service() {
        this(new Idea27967Config());
    }

    public Idea27967Service(Idea27967Config config) {
        this.config = config != null ? config : new Idea27967Config();
