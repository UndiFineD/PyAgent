...
@Data
public class Idea27797Config {
    private String name = "idea_027797";
 ...
 */
@Slf4j
public class Idea27797Service {
    private static final int IDEA_ID = 27797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27797Service() {
        this(new Idea27797Config());
    }

    public Idea27797Service(Idea27797Config config) {
        this.config = config != null ? config : new Idea27797Config();
