...
@Data
public class Idea27843Config {
    private String name = "idea_027843";
 ...
 */
@Slf4j
public class Idea27843Service {
    private static final int IDEA_ID = 27843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27843Service() {
        this(new Idea27843Config());
    }

    public Idea27843Service(Idea27843Config config) {
        this.config = config != null ? config : new Idea27843Config();
