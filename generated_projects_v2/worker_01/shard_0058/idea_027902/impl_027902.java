...
@Data
public class Idea27902Config {
    private String name = "idea_027902";
 ...
 */
@Slf4j
public class Idea27902Service {
    private static final int IDEA_ID = 27902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27902Service() {
        this(new Idea27902Config());
    }

    public Idea27902Service(Idea27902Config config) {
        this.config = config != null ? config : new Idea27902Config();
