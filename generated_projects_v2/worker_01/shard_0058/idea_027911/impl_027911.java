...
@Data
public class Idea27911Config {
    private String name = "idea_027911";
 ...
 */
@Slf4j
public class Idea27911Service {
    private static final int IDEA_ID = 27911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27911Service() {
        this(new Idea27911Config());
    }

    public Idea27911Service(Idea27911Config config) {
        this.config = config != null ? config : new Idea27911Config();
