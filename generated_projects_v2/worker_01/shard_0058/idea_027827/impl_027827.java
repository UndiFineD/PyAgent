...
@Data
public class Idea27827Config {
    private String name = "idea_027827";
 ...
 */
@Slf4j
public class Idea27827Service {
    private static final int IDEA_ID = 27827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27827Service() {
        this(new Idea27827Config());
    }

    public Idea27827Service(Idea27827Config config) {
        this.config = config != null ? config : new Idea27827Config();
