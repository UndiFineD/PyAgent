...
@Data
public class Idea27939Config {
    private String name = "idea_027939";
 ...
 */
@Slf4j
public class Idea27939Service {
    private static final int IDEA_ID = 27939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27939Service() {
        this(new Idea27939Config());
    }

    public Idea27939Service(Idea27939Config config) {
        this.config = config != null ? config : new Idea27939Config();
