...
@Data
public class Idea27811Config {
    private String name = "idea_027811";
 ...
 */
@Slf4j
public class Idea27811Service {
    private static final int IDEA_ID = 27811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27811Service() {
        this(new Idea27811Config());
    }

    public Idea27811Service(Idea27811Config config) {
        this.config = config != null ? config : new Idea27811Config();
