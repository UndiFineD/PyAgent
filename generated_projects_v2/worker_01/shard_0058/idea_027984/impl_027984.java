...
@Data
public class Idea27984Config {
    private String name = "idea_027984";
 ...
 */
@Slf4j
public class Idea27984Service {
    private static final int IDEA_ID = 27984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27984Service() {
        this(new Idea27984Config());
    }

    public Idea27984Service(Idea27984Config config) {
        this.config = config != null ? config : new Idea27984Config();
