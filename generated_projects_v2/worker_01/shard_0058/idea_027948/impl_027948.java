...
@Data
public class Idea27948Config {
    private String name = "idea_027948";
 ...
 */
@Slf4j
public class Idea27948Service {
    private static final int IDEA_ID = 27948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27948Service() {
        this(new Idea27948Config());
    }

    public Idea27948Service(Idea27948Config config) {
        this.config = config != null ? config : new Idea27948Config();
