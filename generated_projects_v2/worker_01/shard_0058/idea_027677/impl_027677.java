...
@Data
public class Idea27677Config {
    private String name = "idea_027677";
 ...
 */
@Slf4j
public class Idea27677Service {
    private static final int IDEA_ID = 27677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27677Service() {
        this(new Idea27677Config());
    }

    public Idea27677Service(Idea27677Config config) {
        this.config = config != null ? config : new Idea27677Config();
