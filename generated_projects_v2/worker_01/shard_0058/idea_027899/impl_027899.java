...
@Data
public class Idea27899Config {
    private String name = "idea_027899";
 ...
 */
@Slf4j
public class Idea27899Service {
    private static final int IDEA_ID = 27899;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27899Service() {
        this(new Idea27899Config());
    }

    public Idea27899Service(Idea27899Config config) {
        this.config = config != null ? config : new Idea27899Config();
