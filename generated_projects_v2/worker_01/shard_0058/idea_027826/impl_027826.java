...
@Data
public class Idea27826Config {
    private String name = "idea_027826";
 ...
 */
@Slf4j
public class Idea27826Service {
    private static final int IDEA_ID = 27826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27826Service() {
        this(new Idea27826Config());
    }

    public Idea27826Service(Idea27826Config config) {
        this.config = config != null ? config : new Idea27826Config();
