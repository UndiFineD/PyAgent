...
@Data
public class Idea27900Config {
    private String name = "idea_027900";
 ...
 */
@Slf4j
public class Idea27900Service {
    private static final int IDEA_ID = 27900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27900Service() {
        this(new Idea27900Config());
    }

    public Idea27900Service(Idea27900Config config) {
        this.config = config != null ? config : new Idea27900Config();
