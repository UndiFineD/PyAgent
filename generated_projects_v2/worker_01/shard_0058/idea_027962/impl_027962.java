...
@Data
public class Idea27962Config {
    private String name = "idea_027962";
 ...
 */
@Slf4j
public class Idea27962Service {
    private static final int IDEA_ID = 27962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27962Service() {
        this(new Idea27962Config());
    }

    public Idea27962Service(Idea27962Config config) {
        this.config = config != null ? config : new Idea27962Config();
