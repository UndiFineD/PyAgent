...
@Data
public class Idea27575Config {
    private String name = "idea_027575";
 ...
 */
@Slf4j
public class Idea27575Service {
    private static final int IDEA_ID = 27575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27575Service() {
        this(new Idea27575Config());
    }

    public Idea27575Service(Idea27575Config config) {
        this.config = config != null ? config : new Idea27575Config();
