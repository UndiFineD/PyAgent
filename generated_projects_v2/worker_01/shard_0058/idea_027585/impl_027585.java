...
@Data
public class Idea27585Config {
    private String name = "idea_027585";
 ...
 */
@Slf4j
public class Idea27585Service {
    private static final int IDEA_ID = 27585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27585Service() {
        this(new Idea27585Config());
    }

    public Idea27585Service(Idea27585Config config) {
        this.config = config != null ? config : new Idea27585Config();
