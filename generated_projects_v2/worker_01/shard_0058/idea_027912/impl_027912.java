...
@Data
public class Idea27912Config {
    private String name = "idea_027912";
 ...
 */
@Slf4j
public class Idea27912Service {
    private static final int IDEA_ID = 27912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27912Service() {
        this(new Idea27912Config());
    }

    public Idea27912Service(Idea27912Config config) {
        this.config = config != null ? config : new Idea27912Config();
