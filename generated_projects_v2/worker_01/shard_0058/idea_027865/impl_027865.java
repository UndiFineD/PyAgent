...
@Data
public class Idea27865Config {
    private String name = "idea_027865";
 ...
 */
@Slf4j
public class Idea27865Service {
    private static final int IDEA_ID = 27865;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27865Service() {
        this(new Idea27865Config());
    }

    public Idea27865Service(Idea27865Config config) {
        this.config = config != null ? config : new Idea27865Config();
