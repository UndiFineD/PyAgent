...
@Data
public class Idea27595Config {
    private String name = "idea_027595";
 ...
 */
@Slf4j
public class Idea27595Service {
    private static final int IDEA_ID = 27595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27595Service() {
        this(new Idea27595Config());
    }

    public Idea27595Service(Idea27595Config config) {
        this.config = config != null ? config : new Idea27595Config();
