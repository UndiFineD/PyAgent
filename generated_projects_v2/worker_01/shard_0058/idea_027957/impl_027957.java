...
@Data
public class Idea27957Config {
    private String name = "idea_027957";
 ...
 */
@Slf4j
public class Idea27957Service {
    private static final int IDEA_ID = 27957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27957Service() {
        this(new Idea27957Config());
    }

    public Idea27957Service(Idea27957Config config) {
        this.config = config != null ? config : new Idea27957Config();
