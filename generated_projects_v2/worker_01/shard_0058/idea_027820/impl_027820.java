...
@Data
public class Idea27820Config {
    private String name = "idea_027820";
 ...
 */
@Slf4j
public class Idea27820Service {
    private static final int IDEA_ID = 27820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27820Service() {
        this(new Idea27820Config());
    }

    public Idea27820Service(Idea27820Config config) {
        this.config = config != null ? config : new Idea27820Config();
