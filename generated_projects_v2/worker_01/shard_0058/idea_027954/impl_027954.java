...
@Data
public class Idea27954Config {
    private String name = "idea_027954";
 ...
 */
@Slf4j
public class Idea27954Service {
    private static final int IDEA_ID = 27954;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27954Service() {
        this(new Idea27954Config());
    }

    public Idea27954Service(Idea27954Config config) {
        this.config = config != null ? config : new Idea27954Config();
