...
@Data
public class Idea27786Config {
    private String name = "idea_027786";
 ...
 */
@Slf4j
public class Idea27786Service {
    private static final int IDEA_ID = 27786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27786Service() {
        this(new Idea27786Config());
    }

    public Idea27786Service(Idea27786Config config) {
        this.config = config != null ? config : new Idea27786Config();
