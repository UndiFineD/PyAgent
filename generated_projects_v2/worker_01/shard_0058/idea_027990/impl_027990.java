...
@Data
public class Idea27990Config {
    private String name = "idea_027990";
 ...
 */
@Slf4j
public class Idea27990Service {
    private static final int IDEA_ID = 27990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27990Service() {
        this(new Idea27990Config());
    }

    public Idea27990Service(Idea27990Config config) {
        this.config = config != null ? config : new Idea27990Config();
