...
@Data
public class Idea27933Config {
    private String name = "idea_027933";
 ...
 */
@Slf4j
public class Idea27933Service {
    private static final int IDEA_ID = 27933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27933Service() {
        this(new Idea27933Config());
    }

    public Idea27933Service(Idea27933Config config) {
        this.config = config != null ? config : new Idea27933Config();
