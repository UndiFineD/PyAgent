...
@Data
public class Idea27769Config {
    private String name = "idea_027769";
 ...
 */
@Slf4j
public class Idea27769Service {
    private static final int IDEA_ID = 27769;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27769Service() {
        this(new Idea27769Config());
    }

    public Idea27769Service(Idea27769Config config) {
        this.config = config != null ? config : new Idea27769Config();
