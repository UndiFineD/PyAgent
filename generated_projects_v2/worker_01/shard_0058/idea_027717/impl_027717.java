...
@Data
public class Idea27717Config {
    private String name = "idea_027717";
 ...
 */
@Slf4j
public class Idea27717Service {
    private static final int IDEA_ID = 27717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27717Service() {
        this(new Idea27717Config());
    }

    public Idea27717Service(Idea27717Config config) {
        this.config = config != null ? config : new Idea27717Config();
