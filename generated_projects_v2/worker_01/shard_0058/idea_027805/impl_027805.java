...
@Data
public class Idea27805Config {
    private String name = "idea_027805";
 ...
 */
@Slf4j
public class Idea27805Service {
    private static final int IDEA_ID = 27805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27805Service() {
        this(new Idea27805Config());
    }

    public Idea27805Service(Idea27805Config config) {
        this.config = config != null ? config : new Idea27805Config();
