...
@Data
public class Idea27732Config {
    private String name = "idea_027732";
 ...
 */
@Slf4j
public class Idea27732Service {
    private static final int IDEA_ID = 27732;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27732Service() {
        this(new Idea27732Config());
    }

    public Idea27732Service(Idea27732Config config) {
        this.config = config != null ? config : new Idea27732Config();
