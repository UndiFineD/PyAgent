...
@Data
public class Idea27884Config {
    private String name = "idea_027884";
 ...
 */
@Slf4j
public class Idea27884Service {
    private static final int IDEA_ID = 27884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27884Service() {
        this(new Idea27884Config());
    }

    public Idea27884Service(Idea27884Config config) {
        this.config = config != null ? config : new Idea27884Config();
