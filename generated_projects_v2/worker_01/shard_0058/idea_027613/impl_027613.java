...
@Data
public class Idea27613Config {
    private String name = "idea_027613";
 ...
 */
@Slf4j
public class Idea27613Service {
    private static final int IDEA_ID = 27613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27613Service() {
        this(new Idea27613Config());
    }

    public Idea27613Service(Idea27613Config config) {
        this.config = config != null ? config : new Idea27613Config();
