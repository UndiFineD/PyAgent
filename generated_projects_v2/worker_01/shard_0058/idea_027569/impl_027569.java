...
@Data
public class Idea27569Config {
    private String name = "idea_027569";
 ...
 */
@Slf4j
public class Idea27569Service {
    private static final int IDEA_ID = 27569;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27569Service() {
        this(new Idea27569Config());
    }

    public Idea27569Service(Idea27569Config config) {
        this.config = config != null ? config : new Idea27569Config();
