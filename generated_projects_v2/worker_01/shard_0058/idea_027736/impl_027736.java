...
@Data
public class Idea27736Config {
    private String name = "idea_027736";
 ...
 */
@Slf4j
public class Idea27736Service {
    private static final int IDEA_ID = 27736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27736Service() {
        this(new Idea27736Config());
    }

    public Idea27736Service(Idea27736Config config) {
        this.config = config != null ? config : new Idea27736Config();
