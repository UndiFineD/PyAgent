...
@Data
public class Idea27615Config {
    private String name = "idea_027615";
 ...
 */
@Slf4j
public class Idea27615Service {
    private static final int IDEA_ID = 27615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27615Service() {
        this(new Idea27615Config());
    }

    public Idea27615Service(Idea27615Config config) {
        this.config = config != null ? config : new Idea27615Config();
