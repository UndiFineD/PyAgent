...
@Data
public class Idea27748Config {
    private String name = "idea_027748";
 ...
 */
@Slf4j
public class Idea27748Service {
    private static final int IDEA_ID = 27748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27748Service() {
        this(new Idea27748Config());
    }

    public Idea27748Service(Idea27748Config config) {
        this.config = config != null ? config : new Idea27748Config();
