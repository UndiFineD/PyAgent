...
@Data
public class Idea27959Config {
    private String name = "idea_027959";
 ...
 */
@Slf4j
public class Idea27959Service {
    private static final int IDEA_ID = 27959;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27959Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27959Service() {
        this(new Idea27959Config());
    }

    public Idea27959Service(Idea27959Config config) {
        this.config = config != null ? config : new Idea27959Config();
