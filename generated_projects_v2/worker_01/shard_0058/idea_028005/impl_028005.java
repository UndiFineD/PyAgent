...
@Data
public class Idea28005Config {
    private String name = "idea_028005";
 ...
 */
@Slf4j
public class Idea28005Service {
    private static final int IDEA_ID = 28005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28005Service() {
        this(new Idea28005Config());
    }

    public Idea28005Service(Idea28005Config config) {
        this.config = config != null ? config : new Idea28005Config();
