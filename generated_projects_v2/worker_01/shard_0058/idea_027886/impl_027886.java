...
@Data
public class Idea27886Config {
    private String name = "idea_027886";
 ...
 */
@Slf4j
public class Idea27886Service {
    private static final int IDEA_ID = 27886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27886Service() {
        this(new Idea27886Config());
    }

    public Idea27886Service(Idea27886Config config) {
        this.config = config != null ? config : new Idea27886Config();
