...
@Data
public class Idea27652Config {
    private String name = "idea_027652";
 ...
 */
@Slf4j
public class Idea27652Service {
    private static final int IDEA_ID = 27652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27652Service() {
        this(new Idea27652Config());
    }

    public Idea27652Service(Idea27652Config config) {
        this.config = config != null ? config : new Idea27652Config();
