...
@Data
public class Idea27819Config {
    private String name = "idea_027819";
 ...
 */
@Slf4j
public class Idea27819Service {
    private static final int IDEA_ID = 27819;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27819Service() {
        this(new Idea27819Config());
    }

    public Idea27819Service(Idea27819Config config) {
        this.config = config != null ? config : new Idea27819Config();
