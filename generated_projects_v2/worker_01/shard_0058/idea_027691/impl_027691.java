...
@Data
public class Idea27691Config {
    private String name = "idea_027691";
 ...
 */
@Slf4j
public class Idea27691Service {
    private static final int IDEA_ID = 27691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27691Service() {
        this(new Idea27691Config());
    }

    public Idea27691Service(Idea27691Config config) {
        this.config = config != null ? config : new Idea27691Config();
