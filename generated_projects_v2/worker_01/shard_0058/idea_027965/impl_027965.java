...
@Data
public class Idea27965Config {
    private String name = "idea_027965";
 ...
 */
@Slf4j
public class Idea27965Service {
    private static final int IDEA_ID = 27965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27965Service() {
        this(new Idea27965Config());
    }

    public Idea27965Service(Idea27965Config config) {
        this.config = config != null ? config : new Idea27965Config();
