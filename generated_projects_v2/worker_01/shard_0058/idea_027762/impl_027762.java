...
@Data
public class Idea27762Config {
    private String name = "idea_027762";
 ...
 */
@Slf4j
public class Idea27762Service {
    private static final int IDEA_ID = 27762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27762Service() {
        this(new Idea27762Config());
    }

    public Idea27762Service(Idea27762Config config) {
        this.config = config != null ? config : new Idea27762Config();
