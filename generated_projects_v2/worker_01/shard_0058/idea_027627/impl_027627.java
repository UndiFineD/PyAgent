...
@Data
public class Idea27627Config {
    private String name = "idea_027627";
 ...
 */
@Slf4j
public class Idea27627Service {
    private static final int IDEA_ID = 27627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27627Service() {
        this(new Idea27627Config());
    }

    public Idea27627Service(Idea27627Config config) {
        this.config = config != null ? config : new Idea27627Config();
