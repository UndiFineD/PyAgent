...
@Data
public class Idea27629Config {
    private String name = "idea_027629";
 ...
 */
@Slf4j
public class Idea27629Service {
    private static final int IDEA_ID = 27629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27629Service() {
        this(new Idea27629Config());
    }

    public Idea27629Service(Idea27629Config config) {
        this.config = config != null ? config : new Idea27629Config();
