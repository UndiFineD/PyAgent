...
@Data
public class Idea27579Config {
    private String name = "idea_027579";
 ...
 */
@Slf4j
public class Idea27579Service {
    private static final int IDEA_ID = 27579;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27579Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27579Service() {
        this(new Idea27579Config());
    }

    public Idea27579Service(Idea27579Config config) {
        this.config = config != null ? config : new Idea27579Config();
