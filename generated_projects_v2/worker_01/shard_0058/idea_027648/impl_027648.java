...
@Data
public class Idea27648Config {
    private String name = "idea_027648";
 ...
 */
@Slf4j
public class Idea27648Service {
    private static final int IDEA_ID = 27648;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27648Service() {
        this(new Idea27648Config());
    }

    public Idea27648Service(Idea27648Config config) {
        this.config = config != null ? config : new Idea27648Config();
