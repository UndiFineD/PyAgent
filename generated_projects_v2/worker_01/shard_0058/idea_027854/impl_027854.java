...
@Data
public class Idea27854Config {
    private String name = "idea_027854";
 ...
 */
@Slf4j
public class Idea27854Service {
    private static final int IDEA_ID = 27854;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27854Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27854Service() {
        this(new Idea27854Config());
    }

    public Idea27854Service(Idea27854Config config) {
        this.config = config != null ? config : new Idea27854Config();
