...
@Data
public class Idea27930Config {
    private String name = "idea_027930";
 ...
 */
@Slf4j
public class Idea27930Service {
    private static final int IDEA_ID = 27930;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27930Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27930Service() {
        this(new Idea27930Config());
    }

    public Idea27930Service(Idea27930Config config) {
        this.config = config != null ? config : new Idea27930Config();
