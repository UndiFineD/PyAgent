...
@Data
public class Idea27821Config {
    private String name = "idea_027821";
 ...
 */
@Slf4j
public class Idea27821Service {
    private static final int IDEA_ID = 27821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27821Service() {
        this(new Idea27821Config());
    }

    public Idea27821Service(Idea27821Config config) {
        this.config = config != null ? config : new Idea27821Config();
