...
@Data
public class Idea27588Config {
    private String name = "idea_027588";
 ...
 */
@Slf4j
public class Idea27588Service {
    private static final int IDEA_ID = 27588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27588Service() {
        this(new Idea27588Config());
    }

    public Idea27588Service(Idea27588Config config) {
        this.config = config != null ? config : new Idea27588Config();
