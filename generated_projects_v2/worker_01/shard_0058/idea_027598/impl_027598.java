...
@Data
public class Idea27598Config {
    private String name = "idea_027598";
 ...
 */
@Slf4j
public class Idea27598Service {
    private static final int IDEA_ID = 27598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27598Service() {
        this(new Idea27598Config());
    }

    public Idea27598Service(Idea27598Config config) {
        this.config = config != null ? config : new Idea27598Config();
