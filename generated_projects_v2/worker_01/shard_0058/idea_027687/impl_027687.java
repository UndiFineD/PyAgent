...
@Data
public class Idea27687Config {
    private String name = "idea_027687";
 ...
 */
@Slf4j
public class Idea27687Service {
    private static final int IDEA_ID = 27687;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27687Service() {
        this(new Idea27687Config());
    }

    public Idea27687Service(Idea27687Config config) {
        this.config = config != null ? config : new Idea27687Config();
