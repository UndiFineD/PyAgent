...
@Data
public class Idea27942Config {
    private String name = "idea_027942";
 ...
 */
@Slf4j
public class Idea27942Service {
    private static final int IDEA_ID = 27942;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27942Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27942Service() {
        this(new Idea27942Config());
    }

    public Idea27942Service(Idea27942Config config) {
        this.config = config != null ? config : new Idea27942Config();
