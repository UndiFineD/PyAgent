...
@Data
public class Idea27734Config {
    private String name = "idea_027734";
 ...
 */
@Slf4j
public class Idea27734Service {
    private static final int IDEA_ID = 27734;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27734Service() {
        this(new Idea27734Config());
    }

    public Idea27734Service(Idea27734Config config) {
        this.config = config != null ? config : new Idea27734Config();
