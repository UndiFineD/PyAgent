...
@Data
public class Idea27842Config {
    private String name = "idea_027842";
 ...
 */
@Slf4j
public class Idea27842Service {
    private static final int IDEA_ID = 27842;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27842Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27842Service() {
        this(new Idea27842Config());
    }

    public Idea27842Service(Idea27842Config config) {
        this.config = config != null ? config : new Idea27842Config();
