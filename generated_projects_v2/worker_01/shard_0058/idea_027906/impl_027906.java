...
@Data
public class Idea27906Config {
    private String name = "idea_027906";
 ...
 */
@Slf4j
public class Idea27906Service {
    private static final int IDEA_ID = 27906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27906Service() {
        this(new Idea27906Config());
    }

    public Idea27906Service(Idea27906Config config) {
        this.config = config != null ? config : new Idea27906Config();
