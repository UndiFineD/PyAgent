...
@Data
public class Idea27960Config {
    private String name = "idea_027960";
 ...
 */
@Slf4j
public class Idea27960Service {
    private static final int IDEA_ID = 27960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27960Service() {
        this(new Idea27960Config());
    }

    public Idea27960Service(Idea27960Config config) {
        this.config = config != null ? config : new Idea27960Config();
