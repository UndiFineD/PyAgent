...
@Data
public class Idea27813Config {
    private String name = "idea_027813";
 ...
 */
@Slf4j
public class Idea27813Service {
    private static final int IDEA_ID = 27813;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27813Service() {
        this(new Idea27813Config());
    }

    public Idea27813Service(Idea27813Config config) {
        this.config = config != null ? config : new Idea27813Config();
