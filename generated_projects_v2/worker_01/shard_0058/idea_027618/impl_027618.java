...
@Data
public class Idea27618Config {
    private String name = "idea_027618";
 ...
 */
@Slf4j
public class Idea27618Service {
    private static final int IDEA_ID = 27618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27618Service() {
        this(new Idea27618Config());
    }

    public Idea27618Service(Idea27618Config config) {
        this.config = config != null ? config : new Idea27618Config();
