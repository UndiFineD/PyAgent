...
@Data
public class Idea27792Config {
    private String name = "idea_027792";
 ...
 */
@Slf4j
public class Idea27792Service {
    private static final int IDEA_ID = 27792;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27792Service() {
        this(new Idea27792Config());
    }

    public Idea27792Service(Idea27792Config config) {
        this.config = config != null ? config : new Idea27792Config();
