...
@Data
public class Idea27973Config {
    private String name = "idea_027973";
 ...
 */
@Slf4j
public class Idea27973Service {
    private static final int IDEA_ID = 27973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27973Service() {
        this(new Idea27973Config());
    }

    public Idea27973Service(Idea27973Config config) {
        this.config = config != null ? config : new Idea27973Config();
