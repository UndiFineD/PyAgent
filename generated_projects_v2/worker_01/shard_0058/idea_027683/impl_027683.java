...
@Data
public class Idea27683Config {
    private String name = "idea_027683";
 ...
 */
@Slf4j
public class Idea27683Service {
    private static final int IDEA_ID = 27683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27683Service() {
        this(new Idea27683Config());
    }

    public Idea27683Service(Idea27683Config config) {
        this.config = config != null ? config : new Idea27683Config();
