...
@Data
public class Idea27662Config {
    private String name = "idea_027662";
 ...
 */
@Slf4j
public class Idea27662Service {
    private static final int IDEA_ID = 27662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27662Service() {
        this(new Idea27662Config());
    }

    public Idea27662Service(Idea27662Config config) {
        this.config = config != null ? config : new Idea27662Config();
