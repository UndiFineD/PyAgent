...
@Data
public class Idea27727Config {
    private String name = "idea_027727";
 ...
 */
@Slf4j
public class Idea27727Service {
    private static final int IDEA_ID = 27727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27727Service() {
        this(new Idea27727Config());
    }

    public Idea27727Service(Idea27727Config config) {
        this.config = config != null ? config : new Idea27727Config();
