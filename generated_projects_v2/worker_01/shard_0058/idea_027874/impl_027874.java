...
@Data
public class Idea27874Config {
    private String name = "idea_027874";
 ...
 */
@Slf4j
public class Idea27874Service {
    private static final int IDEA_ID = 27874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27874Service() {
        this(new Idea27874Config());
    }

    public Idea27874Service(Idea27874Config config) {
        this.config = config != null ? config : new Idea27874Config();
