...
@Data
public class Idea27738Config {
    private String name = "idea_027738";
 ...
 */
@Slf4j
public class Idea27738Service {
    private static final int IDEA_ID = 27738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27738Service() {
        this(new Idea27738Config());
    }

    public Idea27738Service(Idea27738Config config) {
        this.config = config != null ? config : new Idea27738Config();
