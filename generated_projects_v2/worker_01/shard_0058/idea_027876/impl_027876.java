...
@Data
public class Idea27876Config {
    private String name = "idea_027876";
 ...
 */
@Slf4j
public class Idea27876Service {
    private static final int IDEA_ID = 27876;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27876Service() {
        this(new Idea27876Config());
    }

    public Idea27876Service(Idea27876Config config) {
        this.config = config != null ? config : new Idea27876Config();
