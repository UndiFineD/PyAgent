...
@Data
public class Idea27951Config {
    private String name = "idea_027951";
 ...
 */
@Slf4j
public class Idea27951Service {
    private static final int IDEA_ID = 27951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27951Service() {
        this(new Idea27951Config());
    }

    public Idea27951Service(Idea27951Config config) {
        this.config = config != null ? config : new Idea27951Config();
