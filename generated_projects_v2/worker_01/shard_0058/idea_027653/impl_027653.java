...
@Data
public class Idea27653Config {
    private String name = "idea_027653";
 ...
 */
@Slf4j
public class Idea27653Service {
    private static final int IDEA_ID = 27653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27653Service() {
        this(new Idea27653Config());
    }

    public Idea27653Service(Idea27653Config config) {
        this.config = config != null ? config : new Idea27653Config();
