...
@Data
public class Idea27573Config {
    private String name = "idea_027573";
 ...
 */
@Slf4j
public class Idea27573Service {
    private static final int IDEA_ID = 27573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27573Service() {
        this(new Idea27573Config());
    }

    public Idea27573Service(Idea27573Config config) {
        this.config = config != null ? config : new Idea27573Config();
