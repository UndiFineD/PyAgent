...
@Data
public class Idea27587Config {
    private String name = "idea_027587";
 ...
 */
@Slf4j
public class Idea27587Service {
    private static final int IDEA_ID = 27587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27587Service() {
        this(new Idea27587Config());
    }

    public Idea27587Service(Idea27587Config config) {
        this.config = config != null ? config : new Idea27587Config();
