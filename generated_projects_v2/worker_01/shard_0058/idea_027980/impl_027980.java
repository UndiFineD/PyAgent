...
@Data
public class Idea27980Config {
    private String name = "idea_027980";
 ...
 */
@Slf4j
public class Idea27980Service {
    private static final int IDEA_ID = 27980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27980Service() {
        this(new Idea27980Config());
    }

    public Idea27980Service(Idea27980Config config) {
        this.config = config != null ? config : new Idea27980Config();
