...
@Data
public class Idea27704Config {
    private String name = "idea_027704";
 ...
 */
@Slf4j
public class Idea27704Service {
    private static final int IDEA_ID = 27704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27704Service() {
        this(new Idea27704Config());
    }

    public Idea27704Service(Idea27704Config config) {
        this.config = config != null ? config : new Idea27704Config();
