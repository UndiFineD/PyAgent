...
@Data
public class Idea27635Config {
    private String name = "idea_027635";
 ...
 */
@Slf4j
public class Idea27635Service {
    private static final int IDEA_ID = 27635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27635Service() {
        this(new Idea27635Config());
    }

    public Idea27635Service(Idea27635Config config) {
        this.config = config != null ? config : new Idea27635Config();
