...
@Data
public class Idea27964Config {
    private String name = "idea_027964";
 ...
 */
@Slf4j
public class Idea27964Service {
    private static final int IDEA_ID = 27964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27964Service() {
        this(new Idea27964Config());
    }

    public Idea27964Service(Idea27964Config config) {
        this.config = config != null ? config : new Idea27964Config();
