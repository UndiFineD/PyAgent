...
@Data
public class Idea27809Config {
    private String name = "idea_027809";
 ...
 */
@Slf4j
public class Idea27809Service {
    private static final int IDEA_ID = 27809;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27809Service() {
        this(new Idea27809Config());
    }

    public Idea27809Service(Idea27809Config config) {
        this.config = config != null ? config : new Idea27809Config();
