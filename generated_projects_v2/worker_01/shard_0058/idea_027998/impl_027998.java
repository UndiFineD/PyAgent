...
@Data
public class Idea27998Config {
    private String name = "idea_027998";
 ...
 */
@Slf4j
public class Idea27998Service {
    private static final int IDEA_ID = 27998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27998Service() {
        this(new Idea27998Config());
    }

    public Idea27998Service(Idea27998Config config) {
        this.config = config != null ? config : new Idea27998Config();
