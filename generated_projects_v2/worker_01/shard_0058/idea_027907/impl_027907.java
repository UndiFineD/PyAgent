...
@Data
public class Idea27907Config {
    private String name = "idea_027907";
 ...
 */
@Slf4j
public class Idea27907Service {
    private static final int IDEA_ID = 27907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27907Service() {
        this(new Idea27907Config());
    }

    public Idea27907Service(Idea27907Config config) {
        this.config = config != null ? config : new Idea27907Config();
