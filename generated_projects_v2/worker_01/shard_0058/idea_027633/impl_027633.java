...
@Data
public class Idea27633Config {
    private String name = "idea_027633";
 ...
 */
@Slf4j
public class Idea27633Service {
    private static final int IDEA_ID = 27633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27633Service() {
        this(new Idea27633Config());
    }

    public Idea27633Service(Idea27633Config config) {
        this.config = config != null ? config : new Idea27633Config();
