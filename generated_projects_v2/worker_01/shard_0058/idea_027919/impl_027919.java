...
@Data
public class Idea27919Config {
    private String name = "idea_027919";
 ...
 */
@Slf4j
public class Idea27919Service {
    private static final int IDEA_ID = 27919;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27919Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27919Service() {
        this(new Idea27919Config());
    }

    public Idea27919Service(Idea27919Config config) {
        this.config = config != null ? config : new Idea27919Config();
