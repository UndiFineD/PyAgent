...
@Data
public class Idea27574Config {
    private String name = "idea_027574";
 ...
 */
@Slf4j
public class Idea27574Service {
    private static final int IDEA_ID = 27574;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27574Service() {
        this(new Idea27574Config());
    }

    public Idea27574Service(Idea27574Config config) {
        this.config = config != null ? config : new Idea27574Config();
