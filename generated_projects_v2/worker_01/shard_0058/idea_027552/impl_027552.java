...
@Data
public class Idea27552Config {
    private String name = "idea_027552";
 ...
 */
@Slf4j
public class Idea27552Service {
    private static final int IDEA_ID = 27552;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27552Service() {
        this(new Idea27552Config());
    }

    public Idea27552Service(Idea27552Config config) {
        this.config = config != null ? config : new Idea27552Config();
