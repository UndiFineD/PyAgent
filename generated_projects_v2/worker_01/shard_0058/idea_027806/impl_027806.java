...
@Data
public class Idea27806Config {
    private String name = "idea_027806";
 ...
 */
@Slf4j
public class Idea27806Service {
    private static final int IDEA_ID = 27806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27806Service() {
        this(new Idea27806Config());
    }

    public Idea27806Service(Idea27806Config config) {
        this.config = config != null ? config : new Idea27806Config();
