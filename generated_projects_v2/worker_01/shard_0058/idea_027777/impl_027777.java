...
@Data
public class Idea27777Config {
    private String name = "idea_027777";
 ...
 */
@Slf4j
public class Idea27777Service {
    private static final int IDEA_ID = 27777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27777Service() {
        this(new Idea27777Config());
    }

    public Idea27777Service(Idea27777Config config) {
        this.config = config != null ? config : new Idea27777Config();
