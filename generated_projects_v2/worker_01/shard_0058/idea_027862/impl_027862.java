...
@Data
public class Idea27862Config {
    private String name = "idea_027862";
 ...
 */
@Slf4j
public class Idea27862Service {
    private static final int IDEA_ID = 27862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27862Service() {
        this(new Idea27862Config());
    }

    public Idea27862Service(Idea27862Config config) {
        this.config = config != null ? config : new Idea27862Config();
