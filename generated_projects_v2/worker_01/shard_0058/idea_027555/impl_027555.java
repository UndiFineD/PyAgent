...
@Data
public class Idea27555Config {
    private String name = "idea_027555";
 ...
 */
@Slf4j
public class Idea27555Service {
    private static final int IDEA_ID = 27555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27555Service() {
        this(new Idea27555Config());
    }

    public Idea27555Service(Idea27555Config config) {
        this.config = config != null ? config : new Idea27555Config();
