...
@Data
public class Idea27611Config {
    private String name = "idea_027611";
 ...
 */
@Slf4j
public class Idea27611Service {
    private static final int IDEA_ID = 27611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27611Service() {
        this(new Idea27611Config());
    }

    public Idea27611Service(Idea27611Config config) {
        this.config = config != null ? config : new Idea27611Config();
