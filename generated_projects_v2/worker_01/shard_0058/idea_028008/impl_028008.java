...
@Data
public class Idea28008Config {
    private String name = "idea_028008";
 ...
 */
@Slf4j
public class Idea28008Service {
    private static final int IDEA_ID = 28008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28008Service() {
        this(new Idea28008Config());
    }

    public Idea28008Service(Idea28008Config config) {
        this.config = config != null ? config : new Idea28008Config();
