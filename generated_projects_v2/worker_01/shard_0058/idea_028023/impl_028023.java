...
@Data
public class Idea28023Config {
    private String name = "idea_028023";
 ...
 */
@Slf4j
public class Idea28023Service {
    private static final int IDEA_ID = 28023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28023Service() {
        this(new Idea28023Config());
    }

    public Idea28023Service(Idea28023Config config) {
        this.config = config != null ? config : new Idea28023Config();
