...
@Data
public class Idea27639Config {
    private String name = "idea_027639";
 ...
 */
@Slf4j
public class Idea27639Service {
    private static final int IDEA_ID = 27639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27639Service() {
        this(new Idea27639Config());
    }

    public Idea27639Service(Idea27639Config config) {
        this.config = config != null ? config : new Idea27639Config();
