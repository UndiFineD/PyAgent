...
@Data
public class Idea27927Config {
    private String name = "idea_027927";
 ...
 */
@Slf4j
public class Idea27927Service {
    private static final int IDEA_ID = 27927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27927Service() {
        this(new Idea27927Config());
    }

    public Idea27927Service(Idea27927Config config) {
        this.config = config != null ? config : new Idea27927Config();
