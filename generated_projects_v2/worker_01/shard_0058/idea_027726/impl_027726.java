...
@Data
public class Idea27726Config {
    private String name = "idea_027726";
 ...
 */
@Slf4j
public class Idea27726Service {
    private static final int IDEA_ID = 27726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27726Service() {
        this(new Idea27726Config());
    }

    public Idea27726Service(Idea27726Config config) {
        this.config = config != null ? config : new Idea27726Config();
