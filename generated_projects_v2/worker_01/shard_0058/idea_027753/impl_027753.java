...
@Data
public class Idea27753Config {
    private String name = "idea_027753";
 ...
 */
@Slf4j
public class Idea27753Service {
    private static final int IDEA_ID = 27753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27753Service() {
        this(new Idea27753Config());
    }

    public Idea27753Service(Idea27753Config config) {
        this.config = config != null ? config : new Idea27753Config();
