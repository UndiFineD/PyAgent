...
@Data
public class Idea27971Config {
    private String name = "idea_027971";
 ...
 */
@Slf4j
public class Idea27971Service {
    private static final int IDEA_ID = 27971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27971Service() {
        this(new Idea27971Config());
    }

    public Idea27971Service(Idea27971Config config) {
        this.config = config != null ? config : new Idea27971Config();
