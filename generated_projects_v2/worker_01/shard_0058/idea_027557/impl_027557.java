...
@Data
public class Idea27557Config {
    private String name = "idea_027557";
 ...
 */
@Slf4j
public class Idea27557Service {
    private static final int IDEA_ID = 27557;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27557Service() {
        this(new Idea27557Config());
    }

    public Idea27557Service(Idea27557Config config) {
        this.config = config != null ? config : new Idea27557Config();
