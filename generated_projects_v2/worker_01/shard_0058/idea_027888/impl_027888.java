...
@Data
public class Idea27888Config {
    private String name = "idea_027888";
 ...
 */
@Slf4j
public class Idea27888Service {
    private static final int IDEA_ID = 27888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27888Service() {
        this(new Idea27888Config());
    }

    public Idea27888Service(Idea27888Config config) {
        this.config = config != null ? config : new Idea27888Config();
