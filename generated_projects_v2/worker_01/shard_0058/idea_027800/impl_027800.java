...
@Data
public class Idea27800Config {
    private String name = "idea_027800";
 ...
 */
@Slf4j
public class Idea27800Service {
    private static final int IDEA_ID = 27800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27800Service() {
        this(new Idea27800Config());
    }

    public Idea27800Service(Idea27800Config config) {
        this.config = config != null ? config : new Idea27800Config();
