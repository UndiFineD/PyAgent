...
@Data
public class Idea27836Config {
    private String name = "idea_027836";
 ...
 */
@Slf4j
public class Idea27836Service {
    private static final int IDEA_ID = 27836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27836Service() {
        this(new Idea27836Config());
    }

    public Idea27836Service(Idea27836Config config) {
        this.config = config != null ? config : new Idea27836Config();
