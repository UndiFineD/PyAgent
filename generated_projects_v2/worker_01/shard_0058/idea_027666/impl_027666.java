...
@Data
public class Idea27666Config {
    private String name = "idea_027666";
 ...
 */
@Slf4j
public class Idea27666Service {
    private static final int IDEA_ID = 27666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27666Service() {
        this(new Idea27666Config());
    }

    public Idea27666Service(Idea27666Config config) {
        this.config = config != null ? config : new Idea27666Config();
