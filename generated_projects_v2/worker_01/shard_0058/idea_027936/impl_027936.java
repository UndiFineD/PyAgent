...
@Data
public class Idea27936Config {
    private String name = "idea_027936";
 ...
 */
@Slf4j
public class Idea27936Service {
    private static final int IDEA_ID = 27936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27936Service() {
        this(new Idea27936Config());
    }

    public Idea27936Service(Idea27936Config config) {
        this.config = config != null ? config : new Idea27936Config();
