...
@Data
public class Idea27656Config {
    private String name = "idea_027656";
 ...
 */
@Slf4j
public class Idea27656Service {
    private static final int IDEA_ID = 27656;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27656Service() {
        this(new Idea27656Config());
    }

    public Idea27656Service(Idea27656Config config) {
        this.config = config != null ? config : new Idea27656Config();
