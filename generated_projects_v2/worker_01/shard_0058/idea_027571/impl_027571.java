...
@Data
public class Idea27571Config {
    private String name = "idea_027571";
 ...
 */
@Slf4j
public class Idea27571Service {
    private static final int IDEA_ID = 27571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27571Service() {
        this(new Idea27571Config());
    }

    public Idea27571Service(Idea27571Config config) {
        this.config = config != null ? config : new Idea27571Config();
