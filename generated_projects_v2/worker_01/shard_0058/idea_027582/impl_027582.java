...
@Data
public class Idea27582Config {
    private String name = "idea_027582";
 ...
 */
@Slf4j
public class Idea27582Service {
    private static final int IDEA_ID = 27582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27582Service() {
        this(new Idea27582Config());
    }

    public Idea27582Service(Idea27582Config config) {
        this.config = config != null ? config : new Idea27582Config();
