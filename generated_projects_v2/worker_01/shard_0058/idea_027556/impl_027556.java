...
@Data
public class Idea27556Config {
    private String name = "idea_027556";
 ...
 */
@Slf4j
public class Idea27556Service {
    private static final int IDEA_ID = 27556;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27556Service() {
        this(new Idea27556Config());
    }

    public Idea27556Service(Idea27556Config config) {
        this.config = config != null ? config : new Idea27556Config();
