...
@Data
public class Idea27983Config {
    private String name = "idea_027983";
 ...
 */
@Slf4j
public class Idea27983Service {
    private static final int IDEA_ID = 27983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27983Service() {
        this(new Idea27983Config());
    }

    public Idea27983Service(Idea27983Config config) {
        this.config = config != null ? config : new Idea27983Config();
