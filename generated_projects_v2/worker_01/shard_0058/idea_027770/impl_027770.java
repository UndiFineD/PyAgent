...
@Data
public class Idea27770Config {
    private String name = "idea_027770";
 ...
 */
@Slf4j
public class Idea27770Service {
    private static final int IDEA_ID = 27770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27770Service() {
        this(new Idea27770Config());
    }

    public Idea27770Service(Idea27770Config config) {
        this.config = config != null ? config : new Idea27770Config();
