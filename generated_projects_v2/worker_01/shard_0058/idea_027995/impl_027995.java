...
@Data
public class Idea27995Config {
    private String name = "idea_027995";
 ...
 */
@Slf4j
public class Idea27995Service {
    private static final int IDEA_ID = 27995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27995Service() {
        this(new Idea27995Config());
    }

    public Idea27995Service(Idea27995Config config) {
        this.config = config != null ? config : new Idea27995Config();
