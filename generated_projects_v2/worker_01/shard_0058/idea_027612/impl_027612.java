...
@Data
public class Idea27612Config {
    private String name = "idea_027612";
 ...
 */
@Slf4j
public class Idea27612Service {
    private static final int IDEA_ID = 27612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27612Service() {
        this(new Idea27612Config());
    }

    public Idea27612Service(Idea27612Config config) {
        this.config = config != null ? config : new Idea27612Config();
