...
@Data
public class Idea27755Config {
    private String name = "idea_027755";
 ...
 */
@Slf4j
public class Idea27755Service {
    private static final int IDEA_ID = 27755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27755Service() {
        this(new Idea27755Config());
    }

    public Idea27755Service(Idea27755Config config) {
        this.config = config != null ? config : new Idea27755Config();
