...
@Data
public class Idea27982Config {
    private String name = "idea_027982";
 ...
 */
@Slf4j
public class Idea27982Service {
    private static final int IDEA_ID = 27982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27982Service() {
        this(new Idea27982Config());
    }

    public Idea27982Service(Idea27982Config config) {
        this.config = config != null ? config : new Idea27982Config();
