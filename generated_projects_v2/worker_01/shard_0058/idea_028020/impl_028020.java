...
@Data
public class Idea28020Config {
    private String name = "idea_028020";
 ...
 */
@Slf4j
public class Idea28020Service {
    private static final int IDEA_ID = 28020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28020Service() {
        this(new Idea28020Config());
    }

    public Idea28020Service(Idea28020Config config) {
        this.config = config != null ? config : new Idea28020Config();
