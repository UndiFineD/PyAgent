...
@Data
public class Idea28014Config {
    private String name = "idea_028014";
 ...
 */
@Slf4j
public class Idea28014Service {
    private static final int IDEA_ID = 28014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28014Service() {
        this(new Idea28014Config());
    }

    public Idea28014Service(Idea28014Config config) {
        this.config = config != null ? config : new Idea28014Config();
