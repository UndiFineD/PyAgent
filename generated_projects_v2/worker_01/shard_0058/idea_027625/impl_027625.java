...
@Data
public class Idea27625Config {
    private String name = "idea_027625";
 ...
 */
@Slf4j
public class Idea27625Service {
    private static final int IDEA_ID = 27625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27625Service() {
        this(new Idea27625Config());
    }

    public Idea27625Service(Idea27625Config config) {
        this.config = config != null ? config : new Idea27625Config();
