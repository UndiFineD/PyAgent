...
@Data
public class Idea27654Config {
    private String name = "idea_027654";
 ...
 */
@Slf4j
public class Idea27654Service {
    private static final int IDEA_ID = 27654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27654Service() {
        this(new Idea27654Config());
    }

    public Idea27654Service(Idea27654Config config) {
        this.config = config != null ? config : new Idea27654Config();
