...
@Data
public class Idea27828Config {
    private String name = "idea_027828";
 ...
 */
@Slf4j
public class Idea27828Service {
    private static final int IDEA_ID = 27828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27828Service() {
        this(new Idea27828Config());
    }

    public Idea27828Service(Idea27828Config config) {
        this.config = config != null ? config : new Idea27828Config();
