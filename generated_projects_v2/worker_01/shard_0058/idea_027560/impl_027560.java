...
@Data
public class Idea27560Config {
    private String name = "idea_027560";
 ...
 */
@Slf4j
public class Idea27560Service {
    private static final int IDEA_ID = 27560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27560Service() {
        this(new Idea27560Config());
    }

    public Idea27560Service(Idea27560Config config) {
        this.config = config != null ? config : new Idea27560Config();
