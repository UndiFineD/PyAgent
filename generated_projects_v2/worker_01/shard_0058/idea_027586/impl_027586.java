...
@Data
public class Idea27586Config {
    private String name = "idea_027586";
 ...
 */
@Slf4j
public class Idea27586Service {
    private static final int IDEA_ID = 27586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27586Service() {
        this(new Idea27586Config());
    }

    public Idea27586Service(Idea27586Config config) {
        this.config = config != null ? config : new Idea27586Config();
