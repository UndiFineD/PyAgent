...
@Data
public class Idea27913Config {
    private String name = "idea_027913";
 ...
 */
@Slf4j
public class Idea27913Service {
    private static final int IDEA_ID = 27913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27913Service() {
        this(new Idea27913Config());
    }

    public Idea27913Service(Idea27913Config config) {
        this.config = config != null ? config : new Idea27913Config();
