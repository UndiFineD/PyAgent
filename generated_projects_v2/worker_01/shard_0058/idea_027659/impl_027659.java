...
@Data
public class Idea27659Config {
    private String name = "idea_027659";
 ...
 */
@Slf4j
public class Idea27659Service {
    private static final int IDEA_ID = 27659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27659Service() {
        this(new Idea27659Config());
    }

    public Idea27659Service(Idea27659Config config) {
        this.config = config != null ? config : new Idea27659Config();
