...
@Data
public class Idea28018Config {
    private String name = "idea_028018";
 ...
 */
@Slf4j
public class Idea28018Service {
    private static final int IDEA_ID = 28018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28018Service() {
        this(new Idea28018Config());
    }

    public Idea28018Service(Idea28018Config config) {
        this.config = config != null ? config : new Idea28018Config();
