...
@Data
public class Idea27966Config {
    private String name = "idea_027966";
 ...
 */
@Slf4j
public class Idea27966Service {
    private static final int IDEA_ID = 27966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27966Service() {
        this(new Idea27966Config());
    }

    public Idea27966Service(Idea27966Config config) {
        this.config = config != null ? config : new Idea27966Config();
