...
@Data
public class Idea26932Config {
    private String name = "idea_026932";
 ...
 */
@Slf4j
public class Idea26932Service {
    private static final int IDEA_ID = 26932;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26932Service() {
        this(new Idea26932Config());
    }

    public Idea26932Service(Idea26932Config config) {
        this.config = config != null ? config : new Idea26932Config();
