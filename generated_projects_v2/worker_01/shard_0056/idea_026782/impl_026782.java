...
@Data
public class Idea26782Config {
    private String name = "idea_026782";
 ...
 */
@Slf4j
public class Idea26782Service {
    private static final int IDEA_ID = 26782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26782Service() {
        this(new Idea26782Config());
    }

    public Idea26782Service(Idea26782Config config) {
        this.config = config != null ? config : new Idea26782Config();
