...
@Data
public class Idea27024Config {
    private String name = "idea_027024";
 ...
 */
@Slf4j
public class Idea27024Service {
    private static final int IDEA_ID = 27024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27024Service() {
        this(new Idea27024Config());
    }

    public Idea27024Service(Idea27024Config config) {
        this.config = config != null ? config : new Idea27024Config();
