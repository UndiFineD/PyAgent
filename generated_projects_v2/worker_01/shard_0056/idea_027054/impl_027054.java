...
@Data
public class Idea27054Config {
    private String name = "idea_027054";
 ...
 */
@Slf4j
public class Idea27054Service {
    private static final int IDEA_ID = 27054;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27054Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27054Service() {
        this(new Idea27054Config());
    }

    public Idea27054Service(Idea27054Config config) {
        this.config = config != null ? config : new Idea27054Config();
