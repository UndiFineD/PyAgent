...
@Data
public class Idea26888Config {
    private String name = "idea_026888";
 ...
 */
@Slf4j
public class Idea26888Service {
    private static final int IDEA_ID = 26888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26888Service() {
        this(new Idea26888Config());
    }

    public Idea26888Service(Idea26888Config config) {
        this.config = config != null ? config : new Idea26888Config();
