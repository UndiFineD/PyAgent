...
@Data
public class Idea27014Config {
    private String name = "idea_027014";
 ...
 */
@Slf4j
public class Idea27014Service {
    private static final int IDEA_ID = 27014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27014Service() {
        this(new Idea27014Config());
    }

    public Idea27014Service(Idea27014Config config) {
        this.config = config != null ? config : new Idea27014Config();
