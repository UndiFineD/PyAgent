...
@Data
public class Idea26845Config {
    private String name = "idea_026845";
 ...
 */
@Slf4j
public class Idea26845Service {
    private static final int IDEA_ID = 26845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26845Service() {
        this(new Idea26845Config());
    }

    public Idea26845Service(Idea26845Config config) {
        this.config = config != null ? config : new Idea26845Config();
