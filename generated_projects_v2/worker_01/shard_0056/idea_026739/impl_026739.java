...
@Data
public class Idea26739Config {
    private String name = "idea_026739";
 ...
 */
@Slf4j
public class Idea26739Service {
    private static final int IDEA_ID = 26739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26739Service() {
        this(new Idea26739Config());
    }

    public Idea26739Service(Idea26739Config config) {
        this.config = config != null ? config : new Idea26739Config();
