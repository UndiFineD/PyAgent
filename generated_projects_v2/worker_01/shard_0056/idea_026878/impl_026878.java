...
@Data
public class Idea26878Config {
    private String name = "idea_026878";
 ...
 */
@Slf4j
public class Idea26878Service {
    private static final int IDEA_ID = 26878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26878Service() {
        this(new Idea26878Config());
    }

    public Idea26878Service(Idea26878Config config) {
        this.config = config != null ? config : new Idea26878Config();
