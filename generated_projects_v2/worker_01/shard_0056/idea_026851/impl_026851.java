...
@Data
public class Idea26851Config {
    private String name = "idea_026851";
 ...
 */
@Slf4j
public class Idea26851Service {
    private static final int IDEA_ID = 26851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26851Service() {
        this(new Idea26851Config());
    }

    public Idea26851Service(Idea26851Config config) {
        this.config = config != null ? config : new Idea26851Config();
