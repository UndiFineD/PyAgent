...
@Data
public class Idea26694Config {
    private String name = "idea_026694";
 ...
 */
@Slf4j
public class Idea26694Service {
    private static final int IDEA_ID = 26694;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26694Service() {
        this(new Idea26694Config());
    }

    public Idea26694Service(Idea26694Config config) {
        this.config = config != null ? config : new Idea26694Config();
