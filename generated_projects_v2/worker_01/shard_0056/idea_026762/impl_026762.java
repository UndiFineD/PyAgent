...
@Data
public class Idea26762Config {
    private String name = "idea_026762";
 ...
 */
@Slf4j
public class Idea26762Service {
    private static final int IDEA_ID = 26762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26762Service() {
        this(new Idea26762Config());
    }

    public Idea26762Service(Idea26762Config config) {
        this.config = config != null ? config : new Idea26762Config();
