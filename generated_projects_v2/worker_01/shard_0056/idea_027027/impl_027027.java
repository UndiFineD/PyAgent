...
@Data
public class Idea27027Config {
    private String name = "idea_027027";
 ...
 */
@Slf4j
public class Idea27027Service {
    private static final int IDEA_ID = 27027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27027Service() {
        this(new Idea27027Config());
    }

    public Idea27027Service(Idea27027Config config) {
        this.config = config != null ? config : new Idea27027Config();
