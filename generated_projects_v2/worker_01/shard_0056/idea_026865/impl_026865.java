...
@Data
public class Idea26865Config {
    private String name = "idea_026865";
 ...
 */
@Slf4j
public class Idea26865Service {
    private static final int IDEA_ID = 26865;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26865Service() {
        this(new Idea26865Config());
    }

    public Idea26865Service(Idea26865Config config) {
        this.config = config != null ? config : new Idea26865Config();
