...
@Data
public class Idea26666Config {
    private String name = "idea_026666";
 ...
 */
@Slf4j
public class Idea26666Service {
    private static final int IDEA_ID = 26666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26666Service() {
        this(new Idea26666Config());
    }

    public Idea26666Service(Idea26666Config config) {
        this.config = config != null ? config : new Idea26666Config();
