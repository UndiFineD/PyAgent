...
@Data
public class Idea26685Config {
    private String name = "idea_026685";
 ...
 */
@Slf4j
public class Idea26685Service {
    private static final int IDEA_ID = 26685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26685Service() {
        this(new Idea26685Config());
    }

    public Idea26685Service(Idea26685Config config) {
        this.config = config != null ? config : new Idea26685Config();
