...
@Data
public class Idea26665Config {
    private String name = "idea_026665";
 ...
 */
@Slf4j
public class Idea26665Service {
    private static final int IDEA_ID = 26665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26665Service() {
        this(new Idea26665Config());
    }

    public Idea26665Service(Idea26665Config config) {
        this.config = config != null ? config : new Idea26665Config();
