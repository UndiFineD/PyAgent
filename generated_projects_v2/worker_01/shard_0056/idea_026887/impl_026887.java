...
@Data
public class Idea26887Config {
    private String name = "idea_026887";
 ...
 */
@Slf4j
public class Idea26887Service {
    private static final int IDEA_ID = 26887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26887Service() {
        this(new Idea26887Config());
    }

    public Idea26887Service(Idea26887Config config) {
        this.config = config != null ? config : new Idea26887Config();
