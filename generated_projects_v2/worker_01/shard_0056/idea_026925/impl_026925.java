...
@Data
public class Idea26925Config {
    private String name = "idea_026925";
 ...
 */
@Slf4j
public class Idea26925Service {
    private static final int IDEA_ID = 26925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26925Service() {
        this(new Idea26925Config());
    }

    public Idea26925Service(Idea26925Config config) {
        this.config = config != null ? config : new Idea26925Config();
