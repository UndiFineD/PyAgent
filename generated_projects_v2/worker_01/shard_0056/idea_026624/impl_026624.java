...
@Data
public class Idea26624Config {
    private String name = "idea_026624";
 ...
 */
@Slf4j
public class Idea26624Service {
    private static final int IDEA_ID = 26624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26624Service() {
        this(new Idea26624Config());
    }

    public Idea26624Service(Idea26624Config config) {
        this.config = config != null ? config : new Idea26624Config();
