...
@Data
public class Idea26668Config {
    private String name = "idea_026668";
 ...
 */
@Slf4j
public class Idea26668Service {
    private static final int IDEA_ID = 26668;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26668Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26668Service() {
        this(new Idea26668Config());
    }

    public Idea26668Service(Idea26668Config config) {
        this.config = config != null ? config : new Idea26668Config();
