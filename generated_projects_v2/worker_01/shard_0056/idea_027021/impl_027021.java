...
@Data
public class Idea27021Config {
    private String name = "idea_027021";
 ...
 */
@Slf4j
public class Idea27021Service {
    private static final int IDEA_ID = 27021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27021Service() {
        this(new Idea27021Config());
    }

    public Idea27021Service(Idea27021Config config) {
        this.config = config != null ? config : new Idea27021Config();
