...
@Data
public class Idea26820Config {
    private String name = "idea_026820";
 ...
 */
@Slf4j
public class Idea26820Service {
    private static final int IDEA_ID = 26820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26820Service() {
        this(new Idea26820Config());
    }

    public Idea26820Service(Idea26820Config config) {
        this.config = config != null ? config : new Idea26820Config();
