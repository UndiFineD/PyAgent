...
@Data
public class Idea26923Config {
    private String name = "idea_026923";
 ...
 */
@Slf4j
public class Idea26923Service {
    private static final int IDEA_ID = 26923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26923Service() {
        this(new Idea26923Config());
    }

    public Idea26923Service(Idea26923Config config) {
        this.config = config != null ? config : new Idea26923Config();
