...
@Data
public class Idea26883Config {
    private String name = "idea_026883";
 ...
 */
@Slf4j
public class Idea26883Service {
    private static final int IDEA_ID = 26883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26883Service() {
        this(new Idea26883Config());
    }

    public Idea26883Service(Idea26883Config config) {
        this.config = config != null ? config : new Idea26883Config();
