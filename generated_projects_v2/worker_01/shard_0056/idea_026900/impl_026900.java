...
@Data
public class Idea26900Config {
    private String name = "idea_026900";
 ...
 */
@Slf4j
public class Idea26900Service {
    private static final int IDEA_ID = 26900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26900Service() {
        this(new Idea26900Config());
    }

    public Idea26900Service(Idea26900Config config) {
        this.config = config != null ? config : new Idea26900Config();
