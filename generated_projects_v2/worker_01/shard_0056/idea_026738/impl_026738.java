...
@Data
public class Idea26738Config {
    private String name = "idea_026738";
 ...
 */
@Slf4j
public class Idea26738Service {
    private static final int IDEA_ID = 26738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26738Service() {
        this(new Idea26738Config());
    }

    public Idea26738Service(Idea26738Config config) {
        this.config = config != null ? config : new Idea26738Config();
