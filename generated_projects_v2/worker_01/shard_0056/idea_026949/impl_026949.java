...
@Data
public class Idea26949Config {
    private String name = "idea_026949";
 ...
 */
@Slf4j
public class Idea26949Service {
    private static final int IDEA_ID = 26949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26949Service() {
        this(new Idea26949Config());
    }

    public Idea26949Service(Idea26949Config config) {
        this.config = config != null ? config : new Idea26949Config();
