...
@Data
public class Idea26807Config {
    private String name = "idea_026807";
 ...
 */
@Slf4j
public class Idea26807Service {
    private static final int IDEA_ID = 26807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26807Service() {
        this(new Idea26807Config());
    }

    public Idea26807Service(Idea26807Config config) {
        this.config = config != null ? config : new Idea26807Config();
