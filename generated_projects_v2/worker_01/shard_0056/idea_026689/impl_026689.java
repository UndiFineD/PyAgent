...
@Data
public class Idea26689Config {
    private String name = "idea_026689";
 ...
 */
@Slf4j
public class Idea26689Service {
    private static final int IDEA_ID = 26689;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26689Service() {
        this(new Idea26689Config());
    }

    public Idea26689Service(Idea26689Config config) {
        this.config = config != null ? config : new Idea26689Config();
