...
@Data
public class Idea26817Config {
    private String name = "idea_026817";
 ...
 */
@Slf4j
public class Idea26817Service {
    private static final int IDEA_ID = 26817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26817Service() {
        this(new Idea26817Config());
    }

    public Idea26817Service(Idea26817Config config) {
        this.config = config != null ? config : new Idea26817Config();
