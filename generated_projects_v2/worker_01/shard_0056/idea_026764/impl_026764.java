...
@Data
public class Idea26764Config {
    private String name = "idea_026764";
 ...
 */
@Slf4j
public class Idea26764Service {
    private static final int IDEA_ID = 26764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26764Service() {
        this(new Idea26764Config());
    }

    public Idea26764Service(Idea26764Config config) {
        this.config = config != null ? config : new Idea26764Config();
