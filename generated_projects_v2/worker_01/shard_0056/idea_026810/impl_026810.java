...
@Data
public class Idea26810Config {
    private String name = "idea_026810";
 ...
 */
@Slf4j
public class Idea26810Service {
    private static final int IDEA_ID = 26810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26810Service() {
        this(new Idea26810Config());
    }

    public Idea26810Service(Idea26810Config config) {
        this.config = config != null ? config : new Idea26810Config();
