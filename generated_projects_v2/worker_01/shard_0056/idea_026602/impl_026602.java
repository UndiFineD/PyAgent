...
@Data
public class Idea26602Config {
    private String name = "idea_026602";
 ...
 */
@Slf4j
public class Idea26602Service {
    private static final int IDEA_ID = 26602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26602Service() {
        this(new Idea26602Config());
    }

    public Idea26602Service(Idea26602Config config) {
        this.config = config != null ? config : new Idea26602Config();
