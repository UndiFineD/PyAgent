...
@Data
public class Idea26735Config {
    private String name = "idea_026735";
 ...
 */
@Slf4j
public class Idea26735Service {
    private static final int IDEA_ID = 26735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26735Service() {
        this(new Idea26735Config());
    }

    public Idea26735Service(Idea26735Config config) {
        this.config = config != null ? config : new Idea26735Config();
