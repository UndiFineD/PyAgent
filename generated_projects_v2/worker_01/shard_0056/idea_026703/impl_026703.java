...
@Data
public class Idea26703Config {
    private String name = "idea_026703";
 ...
 */
@Slf4j
public class Idea26703Service {
    private static final int IDEA_ID = 26703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26703Service() {
        this(new Idea26703Config());
    }

    public Idea26703Service(Idea26703Config config) {
        this.config = config != null ? config : new Idea26703Config();
