...
@Data
public class Idea26611Config {
    private String name = "idea_026611";
 ...
 */
@Slf4j
public class Idea26611Service {
    private static final int IDEA_ID = 26611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26611Service() {
        this(new Idea26611Config());
    }

    public Idea26611Service(Idea26611Config config) {
        this.config = config != null ? config : new Idea26611Config();
