...
@Data
public class Idea26869Config {
    private String name = "idea_026869";
 ...
 */
@Slf4j
public class Idea26869Service {
    private static final int IDEA_ID = 26869;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26869Service() {
        this(new Idea26869Config());
    }

    public Idea26869Service(Idea26869Config config) {
        this.config = config != null ? config : new Idea26869Config();
