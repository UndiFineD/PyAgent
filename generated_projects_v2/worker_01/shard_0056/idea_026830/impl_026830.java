...
@Data
public class Idea26830Config {
    private String name = "idea_026830";
 ...
 */
@Slf4j
public class Idea26830Service {
    private static final int IDEA_ID = 26830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26830Service() {
        this(new Idea26830Config());
    }

    public Idea26830Service(Idea26830Config config) {
        this.config = config != null ? config : new Idea26830Config();
