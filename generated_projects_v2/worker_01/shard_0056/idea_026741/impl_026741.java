...
@Data
public class Idea26741Config {
    private String name = "idea_026741";
 ...
 */
@Slf4j
public class Idea26741Service {
    private static final int IDEA_ID = 26741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26741Service() {
        this(new Idea26741Config());
    }

    public Idea26741Service(Idea26741Config config) {
        this.config = config != null ? config : new Idea26741Config();
