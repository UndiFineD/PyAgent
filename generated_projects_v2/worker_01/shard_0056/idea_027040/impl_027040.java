...
@Data
public class Idea27040Config {
    private String name = "idea_027040";
 ...
 */
@Slf4j
public class Idea27040Service {
    private static final int IDEA_ID = 27040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27040Service() {
        this(new Idea27040Config());
    }

    public Idea27040Service(Idea27040Config config) {
        this.config = config != null ? config : new Idea27040Config();
