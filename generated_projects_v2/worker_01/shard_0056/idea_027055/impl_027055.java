...
@Data
public class Idea27055Config {
    private String name = "idea_027055";
 ...
 */
@Slf4j
public class Idea27055Service {
    private static final int IDEA_ID = 27055;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27055Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27055Service() {
        this(new Idea27055Config());
    }

    public Idea27055Service(Idea27055Config config) {
        this.config = config != null ? config : new Idea27055Config();
