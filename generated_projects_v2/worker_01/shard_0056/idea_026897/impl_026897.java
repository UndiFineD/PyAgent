...
@Data
public class Idea26897Config {
    private String name = "idea_026897";
 ...
 */
@Slf4j
public class Idea26897Service {
    private static final int IDEA_ID = 26897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26897Service() {
        this(new Idea26897Config());
    }

    public Idea26897Service(Idea26897Config config) {
        this.config = config != null ? config : new Idea26897Config();
