...
@Data
public class Idea26842Config {
    private String name = "idea_026842";
 ...
 */
@Slf4j
public class Idea26842Service {
    private static final int IDEA_ID = 26842;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26842Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26842Service() {
        this(new Idea26842Config());
    }

    public Idea26842Service(Idea26842Config config) {
        this.config = config != null ? config : new Idea26842Config();
