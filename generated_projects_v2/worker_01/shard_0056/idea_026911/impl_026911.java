...
@Data
public class Idea26911Config {
    private String name = "idea_026911";
 ...
 */
@Slf4j
public class Idea26911Service {
    private static final int IDEA_ID = 26911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26911Service() {
        this(new Idea26911Config());
    }

    public Idea26911Service(Idea26911Config config) {
        this.config = config != null ? config : new Idea26911Config();
