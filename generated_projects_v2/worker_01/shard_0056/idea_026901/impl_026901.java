...
@Data
public class Idea26901Config {
    private String name = "idea_026901";
 ...
 */
@Slf4j
public class Idea26901Service {
    private static final int IDEA_ID = 26901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26901Service() {
        this(new Idea26901Config());
    }

    public Idea26901Service(Idea26901Config config) {
        this.config = config != null ? config : new Idea26901Config();
