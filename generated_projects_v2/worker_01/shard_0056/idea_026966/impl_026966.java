...
@Data
public class Idea26966Config {
    private String name = "idea_026966";
 ...
 */
@Slf4j
public class Idea26966Service {
    private static final int IDEA_ID = 26966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26966Service() {
        this(new Idea26966Config());
    }

    public Idea26966Service(Idea26966Config config) {
        this.config = config != null ? config : new Idea26966Config();
