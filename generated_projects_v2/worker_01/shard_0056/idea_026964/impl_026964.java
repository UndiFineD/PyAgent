...
@Data
public class Idea26964Config {
    private String name = "idea_026964";
 ...
 */
@Slf4j
public class Idea26964Service {
    private static final int IDEA_ID = 26964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26964Service() {
        this(new Idea26964Config());
    }

    public Idea26964Service(Idea26964Config config) {
        this.config = config != null ? config : new Idea26964Config();
