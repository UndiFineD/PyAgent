...
@Data
public class Idea26681Config {
    private String name = "idea_026681";
 ...
 */
@Slf4j
public class Idea26681Service {
    private static final int IDEA_ID = 26681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26681Service() {
        this(new Idea26681Config());
    }

    public Idea26681Service(Idea26681Config config) {
        this.config = config != null ? config : new Idea26681Config();
