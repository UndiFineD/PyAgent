...
@Data
public class Idea26663Config {
    private String name = "idea_026663";
 ...
 */
@Slf4j
public class Idea26663Service {
    private static final int IDEA_ID = 26663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26663Service() {
        this(new Idea26663Config());
    }

    public Idea26663Service(Idea26663Config config) {
        this.config = config != null ? config : new Idea26663Config();
