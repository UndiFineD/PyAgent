...
@Data
public class Idea26984Config {
    private String name = "idea_026984";
 ...
 */
@Slf4j
public class Idea26984Service {
    private static final int IDEA_ID = 26984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26984Service() {
        this(new Idea26984Config());
    }

    public Idea26984Service(Idea26984Config config) {
        this.config = config != null ? config : new Idea26984Config();
