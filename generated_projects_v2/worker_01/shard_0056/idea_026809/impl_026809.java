...
@Data
public class Idea26809Config {
    private String name = "idea_026809";
 ...
 */
@Slf4j
public class Idea26809Service {
    private static final int IDEA_ID = 26809;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26809Service() {
        this(new Idea26809Config());
    }

    public Idea26809Service(Idea26809Config config) {
        this.config = config != null ? config : new Idea26809Config();
