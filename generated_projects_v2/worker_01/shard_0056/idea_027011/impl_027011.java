...
@Data
public class Idea27011Config {
    private String name = "idea_027011";
 ...
 */
@Slf4j
public class Idea27011Service {
    private static final int IDEA_ID = 27011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27011Service() {
        this(new Idea27011Config());
    }

    public Idea27011Service(Idea27011Config config) {
        this.config = config != null ? config : new Idea27011Config();
