...
@Data
public class Idea26713Config {
    private String name = "idea_026713";
 ...
 */
@Slf4j
public class Idea26713Service {
    private static final int IDEA_ID = 26713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26713Service() {
        this(new Idea26713Config());
    }

    public Idea26713Service(Idea26713Config config) {
        this.config = config != null ? config : new Idea26713Config();
