...
@Data
public class Idea26892Config {
    private String name = "idea_026892";
 ...
 */
@Slf4j
public class Idea26892Service {
    private static final int IDEA_ID = 26892;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26892Service() {
        this(new Idea26892Config());
    }

    public Idea26892Service(Idea26892Config config) {
        this.config = config != null ? config : new Idea26892Config();
