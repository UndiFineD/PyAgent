...
@Data
public class Idea26701Config {
    private String name = "idea_026701";
 ...
 */
@Slf4j
public class Idea26701Service {
    private static final int IDEA_ID = 26701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26701Service() {
        this(new Idea26701Config());
    }

    public Idea26701Service(Idea26701Config config) {
        this.config = config != null ? config : new Idea26701Config();
