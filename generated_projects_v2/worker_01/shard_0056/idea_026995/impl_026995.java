...
@Data
public class Idea26995Config {
    private String name = "idea_026995";
 ...
 */
@Slf4j
public class Idea26995Service {
    private static final int IDEA_ID = 26995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26995Service() {
        this(new Idea26995Config());
    }

    public Idea26995Service(Idea26995Config config) {
        this.config = config != null ? config : new Idea26995Config();
