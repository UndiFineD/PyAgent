...
@Data
public class Idea26778Config {
    private String name = "idea_026778";
 ...
 */
@Slf4j
public class Idea26778Service {
    private static final int IDEA_ID = 26778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26778Service() {
        this(new Idea26778Config());
    }

    public Idea26778Service(Idea26778Config config) {
        this.config = config != null ? config : new Idea26778Config();
