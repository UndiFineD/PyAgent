...
@Data
public class Idea26957Config {
    private String name = "idea_026957";
 ...
 */
@Slf4j
public class Idea26957Service {
    private static final int IDEA_ID = 26957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26957Service() {
        this(new Idea26957Config());
    }

    public Idea26957Service(Idea26957Config config) {
        this.config = config != null ? config : new Idea26957Config();
