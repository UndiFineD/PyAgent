...
@Data
public class Idea26616Config {
    private String name = "idea_026616";
 ...
 */
@Slf4j
public class Idea26616Service {
    private static final int IDEA_ID = 26616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26616Service() {
        this(new Idea26616Config());
    }

    public Idea26616Service(Idea26616Config config) {
        this.config = config != null ? config : new Idea26616Config();
