...
@Data
public class Idea26937Config {
    private String name = "idea_026937";
 ...
 */
@Slf4j
public class Idea26937Service {
    private static final int IDEA_ID = 26937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26937Service() {
        this(new Idea26937Config());
    }

    public Idea26937Service(Idea26937Config config) {
        this.config = config != null ? config : new Idea26937Config();
