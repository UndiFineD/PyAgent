...
@Data
public class Idea27017Config {
    private String name = "idea_027017";
 ...
 */
@Slf4j
public class Idea27017Service {
    private static final int IDEA_ID = 27017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27017Service() {
        this(new Idea27017Config());
    }

    public Idea27017Service(Idea27017Config config) {
        this.config = config != null ? config : new Idea27017Config();
