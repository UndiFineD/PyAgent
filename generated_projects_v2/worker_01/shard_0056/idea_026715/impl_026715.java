...
@Data
public class Idea26715Config {
    private String name = "idea_026715";
 ...
 */
@Slf4j
public class Idea26715Service {
    private static final int IDEA_ID = 26715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26715Service() {
        this(new Idea26715Config());
    }

    public Idea26715Service(Idea26715Config config) {
        this.config = config != null ? config : new Idea26715Config();
