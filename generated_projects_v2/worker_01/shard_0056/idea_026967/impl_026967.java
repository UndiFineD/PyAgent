...
@Data
public class Idea26967Config {
    private String name = "idea_026967";
 ...
 */
@Slf4j
public class Idea26967Service {
    private static final int IDEA_ID = 26967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26967Service() {
        this(new Idea26967Config());
    }

    public Idea26967Service(Idea26967Config config) {
        this.config = config != null ? config : new Idea26967Config();
