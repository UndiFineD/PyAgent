...
@Data
public class Idea26758Config {
    private String name = "idea_026758";
 ...
 */
@Slf4j
public class Idea26758Service {
    private static final int IDEA_ID = 26758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26758Service() {
        this(new Idea26758Config());
    }

    public Idea26758Service(Idea26758Config config) {
        this.config = config != null ? config : new Idea26758Config();
