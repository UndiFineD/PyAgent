...
@Data
public class Idea26895Config {
    private String name = "idea_026895";
 ...
 */
@Slf4j
public class Idea26895Service {
    private static final int IDEA_ID = 26895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26895Service() {
        this(new Idea26895Config());
    }

    public Idea26895Service(Idea26895Config config) {
        this.config = config != null ? config : new Idea26895Config();
