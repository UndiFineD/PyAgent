...
@Data
public class Idea26716Config {
    private String name = "idea_026716";
 ...
 */
@Slf4j
public class Idea26716Service {
    private static final int IDEA_ID = 26716;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26716Service() {
        this(new Idea26716Config());
    }

    public Idea26716Service(Idea26716Config config) {
        this.config = config != null ? config : new Idea26716Config();
