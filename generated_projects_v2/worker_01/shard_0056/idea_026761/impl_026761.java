...
@Data
public class Idea26761Config {
    private String name = "idea_026761";
 ...
 */
@Slf4j
public class Idea26761Service {
    private static final int IDEA_ID = 26761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26761Service() {
        this(new Idea26761Config());
    }

    public Idea26761Service(Idea26761Config config) {
        this.config = config != null ? config : new Idea26761Config();
