...
@Data
public class Idea26700Config {
    private String name = "idea_026700";
 ...
 */
@Slf4j
public class Idea26700Service {
    private static final int IDEA_ID = 26700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26700Service() {
        this(new Idea26700Config());
    }

    public Idea26700Service(Idea26700Config config) {
        this.config = config != null ? config : new Idea26700Config();
