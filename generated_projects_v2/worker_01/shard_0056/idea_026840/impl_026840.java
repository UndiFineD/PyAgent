...
@Data
public class Idea26840Config {
    private String name = "idea_026840";
 ...
 */
@Slf4j
public class Idea26840Service {
    private static final int IDEA_ID = 26840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26840Service() {
        this(new Idea26840Config());
    }

    public Idea26840Service(Idea26840Config config) {
        this.config = config != null ? config : new Idea26840Config();
