...
@Data
public class Idea26614Config {
    private String name = "idea_026614";
 ...
 */
@Slf4j
public class Idea26614Service {
    private static final int IDEA_ID = 26614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26614Service() {
        this(new Idea26614Config());
    }

    public Idea26614Service(Idea26614Config config) {
        this.config = config != null ? config : new Idea26614Config();
