...
@Data
public class Idea26789Config {
    private String name = "idea_026789";
 ...
 */
@Slf4j
public class Idea26789Service {
    private static final int IDEA_ID = 26789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26789Service() {
        this(new Idea26789Config());
    }

    public Idea26789Service(Idea26789Config config) {
        this.config = config != null ? config : new Idea26789Config();
