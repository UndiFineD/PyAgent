...
@Data
public class Idea27058Config {
    private String name = "idea_027058";
 ...
 */
@Slf4j
public class Idea27058Service {
    private static final int IDEA_ID = 27058;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27058Service() {
        this(new Idea27058Config());
    }

    public Idea27058Service(Idea27058Config config) {
        this.config = config != null ? config : new Idea27058Config();
