...
@Data
public class Idea27068Config {
    private String name = "idea_027068";
 ...
 */
@Slf4j
public class Idea27068Service {
    private static final int IDEA_ID = 27068;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27068Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27068Service() {
        this(new Idea27068Config());
    }

    public Idea27068Service(Idea27068Config config) {
        this.config = config != null ? config : new Idea27068Config();
