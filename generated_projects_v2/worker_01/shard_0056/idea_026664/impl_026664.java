...
@Data
public class Idea26664Config {
    private String name = "idea_026664";
 ...
 */
@Slf4j
public class Idea26664Service {
    private static final int IDEA_ID = 26664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26664Service() {
        this(new Idea26664Config());
    }

    public Idea26664Service(Idea26664Config config) {
        this.config = config != null ? config : new Idea26664Config();
