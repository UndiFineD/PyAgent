...
@Data
public class Idea26829Config {
    private String name = "idea_026829";
 ...
 */
@Slf4j
public class Idea26829Service {
    private static final int IDEA_ID = 26829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26829Service() {
        this(new Idea26829Config());
    }

    public Idea26829Service(Idea26829Config config) {
        this.config = config != null ? config : new Idea26829Config();
