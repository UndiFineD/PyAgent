...
@Data
public class Idea26768Config {
    private String name = "idea_026768";
 ...
 */
@Slf4j
public class Idea26768Service {
    private static final int IDEA_ID = 26768;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26768Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26768Service() {
        this(new Idea26768Config());
    }

    public Idea26768Service(Idea26768Config config) {
        this.config = config != null ? config : new Idea26768Config();
