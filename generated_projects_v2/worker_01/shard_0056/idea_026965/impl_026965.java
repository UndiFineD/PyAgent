...
@Data
public class Idea26965Config {
    private String name = "idea_026965";
 ...
 */
@Slf4j
public class Idea26965Service {
    private static final int IDEA_ID = 26965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26965Service() {
        this(new Idea26965Config());
    }

    public Idea26965Service(Idea26965Config config) {
        this.config = config != null ? config : new Idea26965Config();
