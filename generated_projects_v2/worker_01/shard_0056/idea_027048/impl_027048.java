...
@Data
public class Idea27048Config {
    private String name = "idea_027048";
 ...
 */
@Slf4j
public class Idea27048Service {
    private static final int IDEA_ID = 27048;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27048Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27048Service() {
        this(new Idea27048Config());
    }

    public Idea27048Service(Idea27048Config config) {
        this.config = config != null ? config : new Idea27048Config();
