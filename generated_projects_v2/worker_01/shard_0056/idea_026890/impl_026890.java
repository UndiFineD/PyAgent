...
@Data
public class Idea26890Config {
    private String name = "idea_026890";
 ...
 */
@Slf4j
public class Idea26890Service {
    private static final int IDEA_ID = 26890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26890Service() {
        this(new Idea26890Config());
    }

    public Idea26890Service(Idea26890Config config) {
        this.config = config != null ? config : new Idea26890Config();
