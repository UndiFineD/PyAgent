...
@Data
public class Idea26776Config {
    private String name = "idea_026776";
 ...
 */
@Slf4j
public class Idea26776Service {
    private static final int IDEA_ID = 26776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26776Service() {
        this(new Idea26776Config());
    }

    public Idea26776Service(Idea26776Config config) {
        this.config = config != null ? config : new Idea26776Config();
