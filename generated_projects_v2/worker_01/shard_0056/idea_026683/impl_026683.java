...
@Data
public class Idea26683Config {
    private String name = "idea_026683";
 ...
 */
@Slf4j
public class Idea26683Service {
    private static final int IDEA_ID = 26683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26683Service() {
        this(new Idea26683Config());
    }

    public Idea26683Service(Idea26683Config config) {
        this.config = config != null ? config : new Idea26683Config();
