...
@Data
public class Idea26619Config {
    private String name = "idea_026619";
 ...
 */
@Slf4j
public class Idea26619Service {
    private static final int IDEA_ID = 26619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26619Service() {
        this(new Idea26619Config());
    }

    public Idea26619Service(Idea26619Config config) {
        this.config = config != null ? config : new Idea26619Config();
