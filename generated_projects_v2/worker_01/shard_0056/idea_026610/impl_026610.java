...
@Data
public class Idea26610Config {
    private String name = "idea_026610";
 ...
 */
@Slf4j
public class Idea26610Service {
    private static final int IDEA_ID = 26610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26610Service() {
        this(new Idea26610Config());
    }

    public Idea26610Service(Idea26610Config config) {
        this.config = config != null ? config : new Idea26610Config();
