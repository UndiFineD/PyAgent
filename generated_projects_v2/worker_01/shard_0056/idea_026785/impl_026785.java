...
@Data
public class Idea26785Config {
    private String name = "idea_026785";
 ...
 */
@Slf4j
public class Idea26785Service {
    private static final int IDEA_ID = 26785;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26785Service() {
        this(new Idea26785Config());
    }

    public Idea26785Service(Idea26785Config config) {
        this.config = config != null ? config : new Idea26785Config();
