...
@Data
public class Idea26988Config {
    private String name = "idea_026988";
 ...
 */
@Slf4j
public class Idea26988Service {
    private static final int IDEA_ID = 26988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26988Service() {
        this(new Idea26988Config());
    }

    public Idea26988Service(Idea26988Config config) {
        this.config = config != null ? config : new Idea26988Config();
