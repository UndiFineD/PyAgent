...
@Data
public class Idea26708Config {
    private String name = "idea_026708";
 ...
 */
@Slf4j
public class Idea26708Service {
    private static final int IDEA_ID = 26708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26708Service() {
        this(new Idea26708Config());
    }

    public Idea26708Service(Idea26708Config config) {
        this.config = config != null ? config : new Idea26708Config();
