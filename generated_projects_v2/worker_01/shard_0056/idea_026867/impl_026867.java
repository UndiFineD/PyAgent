...
@Data
public class Idea26867Config {
    private String name = "idea_026867";
 ...
 */
@Slf4j
public class Idea26867Service {
    private static final int IDEA_ID = 26867;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26867Service() {
        this(new Idea26867Config());
    }

    public Idea26867Service(Idea26867Config config) {
        this.config = config != null ? config : new Idea26867Config();
