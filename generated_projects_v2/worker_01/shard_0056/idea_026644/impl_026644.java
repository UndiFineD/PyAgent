...
@Data
public class Idea26644Config {
    private String name = "idea_026644";
 ...
 */
@Slf4j
public class Idea26644Service {
    private static final int IDEA_ID = 26644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26644Service() {
        this(new Idea26644Config());
    }

    public Idea26644Service(Idea26644Config config) {
        this.config = config != null ? config : new Idea26644Config();
