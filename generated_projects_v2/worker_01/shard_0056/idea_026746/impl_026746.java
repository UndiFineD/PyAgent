...
@Data
public class Idea26746Config {
    private String name = "idea_026746";
 ...
 */
@Slf4j
public class Idea26746Service {
    private static final int IDEA_ID = 26746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26746Service() {
        this(new Idea26746Config());
    }

    public Idea26746Service(Idea26746Config config) {
        this.config = config != null ? config : new Idea26746Config();
