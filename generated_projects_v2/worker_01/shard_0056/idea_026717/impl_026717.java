...
@Data
public class Idea26717Config {
    private String name = "idea_026717";
 ...
 */
@Slf4j
public class Idea26717Service {
    private static final int IDEA_ID = 26717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26717Service() {
        this(new Idea26717Config());
    }

    public Idea26717Service(Idea26717Config config) {
        this.config = config != null ? config : new Idea26717Config();
