...
@Data
public class Idea27067Config {
    private String name = "idea_027067";
 ...
 */
@Slf4j
public class Idea27067Service {
    private static final int IDEA_ID = 27067;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27067Service() {
        this(new Idea27067Config());
    }

    public Idea27067Service(Idea27067Config config) {
        this.config = config != null ? config : new Idea27067Config();
