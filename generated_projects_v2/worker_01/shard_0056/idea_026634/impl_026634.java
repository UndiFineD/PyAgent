...
@Data
public class Idea26634Config {
    private String name = "idea_026634";
 ...
 */
@Slf4j
public class Idea26634Service {
    private static final int IDEA_ID = 26634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26634Service() {
        this(new Idea26634Config());
    }

    public Idea26634Service(Idea26634Config config) {
        this.config = config != null ? config : new Idea26634Config();
