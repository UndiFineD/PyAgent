...
@Data
public class Idea26968Config {
    private String name = "idea_026968";
 ...
 */
@Slf4j
public class Idea26968Service {
    private static final int IDEA_ID = 26968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26968Service() {
        this(new Idea26968Config());
    }

    public Idea26968Service(Idea26968Config config) {
        this.config = config != null ? config : new Idea26968Config();
