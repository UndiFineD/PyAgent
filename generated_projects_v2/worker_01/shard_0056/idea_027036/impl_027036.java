...
@Data
public class Idea27036Config {
    private String name = "idea_027036";
 ...
 */
@Slf4j
public class Idea27036Service {
    private static final int IDEA_ID = 27036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27036Service() {
        this(new Idea27036Config());
    }

    public Idea27036Service(Idea27036Config config) {
        this.config = config != null ? config : new Idea27036Config();
