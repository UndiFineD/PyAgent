...
@Data
public class Idea26652Config {
    private String name = "idea_026652";
 ...
 */
@Slf4j
public class Idea26652Service {
    private static final int IDEA_ID = 26652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26652Service() {
        this(new Idea26652Config());
    }

    public Idea26652Service(Idea26652Config config) {
        this.config = config != null ? config : new Idea26652Config();
