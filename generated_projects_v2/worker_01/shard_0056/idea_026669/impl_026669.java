...
@Data
public class Idea26669Config {
    private String name = "idea_026669";
 ...
 */
@Slf4j
public class Idea26669Service {
    private static final int IDEA_ID = 26669;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26669Service() {
        this(new Idea26669Config());
    }

    public Idea26669Service(Idea26669Config config) {
        this.config = config != null ? config : new Idea26669Config();
