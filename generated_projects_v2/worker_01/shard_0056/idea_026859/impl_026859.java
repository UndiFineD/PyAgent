...
@Data
public class Idea26859Config {
    private String name = "idea_026859";
 ...
 */
@Slf4j
public class Idea26859Service {
    private static final int IDEA_ID = 26859;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26859Service() {
        this(new Idea26859Config());
    }

    public Idea26859Service(Idea26859Config config) {
        this.config = config != null ? config : new Idea26859Config();
