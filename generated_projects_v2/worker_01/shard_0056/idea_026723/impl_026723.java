...
@Data
public class Idea26723Config {
    private String name = "idea_026723";
 ...
 */
@Slf4j
public class Idea26723Service {
    private static final int IDEA_ID = 26723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26723Service() {
        this(new Idea26723Config());
    }

    public Idea26723Service(Idea26723Config config) {
        this.config = config != null ? config : new Idea26723Config();
