...
@Data
public class Idea27008Config {
    private String name = "idea_027008";
 ...
 */
@Slf4j
public class Idea27008Service {
    private static final int IDEA_ID = 27008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27008Service() {
        this(new Idea27008Config());
    }

    public Idea27008Service(Idea27008Config config) {
        this.config = config != null ? config : new Idea27008Config();
