...
@Data
public class Idea27059Config {
    private String name = "idea_027059";
 ...
 */
@Slf4j
public class Idea27059Service {
    private static final int IDEA_ID = 27059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27059Service() {
        this(new Idea27059Config());
    }

    public Idea27059Service(Idea27059Config config) {
        this.config = config != null ? config : new Idea27059Config();
