...
@Data
public class Idea26733Config {
    private String name = "idea_026733";
 ...
 */
@Slf4j
public class Idea26733Service {
    private static final int IDEA_ID = 26733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26733Service() {
        this(new Idea26733Config());
    }

    public Idea26733Service(Idea26733Config config) {
        this.config = config != null ? config : new Idea26733Config();
