...
@Data
public class Idea26857Config {
    private String name = "idea_026857";
 ...
 */
@Slf4j
public class Idea26857Service {
    private static final int IDEA_ID = 26857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26857Service() {
        this(new Idea26857Config());
    }

    public Idea26857Service(Idea26857Config config) {
        this.config = config != null ? config : new Idea26857Config();
