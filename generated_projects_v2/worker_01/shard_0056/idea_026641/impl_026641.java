...
@Data
public class Idea26641Config {
    private String name = "idea_026641";
 ...
 */
@Slf4j
public class Idea26641Service {
    private static final int IDEA_ID = 26641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26641Service() {
        this(new Idea26641Config());
    }

    public Idea26641Service(Idea26641Config config) {
        this.config = config != null ? config : new Idea26641Config();
