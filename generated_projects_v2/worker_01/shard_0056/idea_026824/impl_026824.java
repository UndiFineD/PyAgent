...
@Data
public class Idea26824Config {
    private String name = "idea_026824";
 ...
 */
@Slf4j
public class Idea26824Service {
    private static final int IDEA_ID = 26824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26824Service() {
        this(new Idea26824Config());
    }

    public Idea26824Service(Idea26824Config config) {
        this.config = config != null ? config : new Idea26824Config();
