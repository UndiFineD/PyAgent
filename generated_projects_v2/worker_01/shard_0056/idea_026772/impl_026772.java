...
@Data
public class Idea26772Config {
    private String name = "idea_026772";
 ...
 */
@Slf4j
public class Idea26772Service {
    private static final int IDEA_ID = 26772;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26772Service() {
        this(new Idea26772Config());
    }

    public Idea26772Service(Idea26772Config config) {
        this.config = config != null ? config : new Idea26772Config();
