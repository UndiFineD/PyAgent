...
@Data
public class Idea26693Config {
    private String name = "idea_026693";
 ...
 */
@Slf4j
public class Idea26693Service {
    private static final int IDEA_ID = 26693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26693Service() {
        this(new Idea26693Config());
    }

    public Idea26693Service(Idea26693Config config) {
        this.config = config != null ? config : new Idea26693Config();
