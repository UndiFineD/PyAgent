...
@Data
public class Idea26702Config {
    private String name = "idea_026702";
 ...
 */
@Slf4j
public class Idea26702Service {
    private static final int IDEA_ID = 26702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26702Service() {
        this(new Idea26702Config());
    }

    public Idea26702Service(Idea26702Config config) {
        this.config = config != null ? config : new Idea26702Config();
