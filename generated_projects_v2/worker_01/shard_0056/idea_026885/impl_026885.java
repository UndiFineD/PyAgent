...
@Data
public class Idea26885Config {
    private String name = "idea_026885";
 ...
 */
@Slf4j
public class Idea26885Service {
    private static final int IDEA_ID = 26885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26885Service() {
        this(new Idea26885Config());
    }

    public Idea26885Service(Idea26885Config config) {
        this.config = config != null ? config : new Idea26885Config();
