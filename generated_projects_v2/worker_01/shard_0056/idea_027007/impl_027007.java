...
@Data
public class Idea27007Config {
    private String name = "idea_027007";
 ...
 */
@Slf4j
public class Idea27007Service {
    private static final int IDEA_ID = 27007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27007Service() {
        this(new Idea27007Config());
    }

    public Idea27007Service(Idea27007Config config) {
        this.config = config != null ? config : new Idea27007Config();
