...
@Data
public class Idea26629Config {
    private String name = "idea_026629";
 ...
 */
@Slf4j
public class Idea26629Service {
    private static final int IDEA_ID = 26629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26629Service() {
        this(new Idea26629Config());
    }

    public Idea26629Service(Idea26629Config config) {
        this.config = config != null ? config : new Idea26629Config();
