...
@Data
public class Idea26974Config {
    private String name = "idea_026974";
 ...
 */
@Slf4j
public class Idea26974Service {
    private static final int IDEA_ID = 26974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26974Service() {
        this(new Idea26974Config());
    }

    public Idea26974Service(Idea26974Config config) {
        this.config = config != null ? config : new Idea26974Config();
