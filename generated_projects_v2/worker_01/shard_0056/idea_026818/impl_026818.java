...
@Data
public class Idea26818Config {
    private String name = "idea_026818";
 ...
 */
@Slf4j
public class Idea26818Service {
    private static final int IDEA_ID = 26818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26818Service() {
        this(new Idea26818Config());
    }

    public Idea26818Service(Idea26818Config config) {
        this.config = config != null ? config : new Idea26818Config();
