...
@Data
public class Idea26921Config {
    private String name = "idea_026921";
 ...
 */
@Slf4j
public class Idea26921Service {
    private static final int IDEA_ID = 26921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26921Service() {
        this(new Idea26921Config());
    }

    public Idea26921Service(Idea26921Config config) {
        this.config = config != null ? config : new Idea26921Config();
