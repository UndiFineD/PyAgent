...
@Data
public class Idea26781Config {
    private String name = "idea_026781";
 ...
 */
@Slf4j
public class Idea26781Service {
    private static final int IDEA_ID = 26781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26781Service() {
        this(new Idea26781Config());
    }

    public Idea26781Service(Idea26781Config config) {
        this.config = config != null ? config : new Idea26781Config();
