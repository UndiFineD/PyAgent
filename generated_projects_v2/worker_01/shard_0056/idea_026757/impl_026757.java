...
@Data
public class Idea26757Config {
    private String name = "idea_026757";
 ...
 */
@Slf4j
public class Idea26757Service {
    private static final int IDEA_ID = 26757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26757Service() {
        this(new Idea26757Config());
    }

    public Idea26757Service(Idea26757Config config) {
        this.config = config != null ? config : new Idea26757Config();
