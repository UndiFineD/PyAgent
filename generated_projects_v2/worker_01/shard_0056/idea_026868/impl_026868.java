...
@Data
public class Idea26868Config {
    private String name = "idea_026868";
 ...
 */
@Slf4j
public class Idea26868Service {
    private static final int IDEA_ID = 26868;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26868Service() {
        this(new Idea26868Config());
    }

    public Idea26868Service(Idea26868Config config) {
        this.config = config != null ? config : new Idea26868Config();
