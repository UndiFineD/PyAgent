...
@Data
public class Idea26953Config {
    private String name = "idea_026953";
 ...
 */
@Slf4j
public class Idea26953Service {
    private static final int IDEA_ID = 26953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26953Service() {
        this(new Idea26953Config());
    }

    public Idea26953Service(Idea26953Config config) {
        this.config = config != null ? config : new Idea26953Config();
