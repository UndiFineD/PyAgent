...
@Data
public class Idea26752Config {
    private String name = "idea_026752";
 ...
 */
@Slf4j
public class Idea26752Service {
    private static final int IDEA_ID = 26752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26752Service() {
        this(new Idea26752Config());
    }

    public Idea26752Service(Idea26752Config config) {
        this.config = config != null ? config : new Idea26752Config();
