...
@Data
public class Idea26727Config {
    private String name = "idea_026727";
 ...
 */
@Slf4j
public class Idea26727Service {
    private static final int IDEA_ID = 26727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26727Service() {
        this(new Idea26727Config());
    }

    public Idea26727Service(Idea26727Config config) {
        this.config = config != null ? config : new Idea26727Config();
