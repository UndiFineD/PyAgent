...
@Data
public class Idea26816Config {
    private String name = "idea_026816";
 ...
 */
@Slf4j
public class Idea26816Service {
    private static final int IDEA_ID = 26816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26816Service() {
        this(new Idea26816Config());
    }

    public Idea26816Service(Idea26816Config config) {
        this.config = config != null ? config : new Idea26816Config();
