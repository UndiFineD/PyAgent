...
@Data
public class Idea26729Config {
    private String name = "idea_026729";
 ...
 */
@Slf4j
public class Idea26729Service {
    private static final int IDEA_ID = 26729;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26729Service() {
        this(new Idea26729Config());
    }

    public Idea26729Service(Idea26729Config config) {
        this.config = config != null ? config : new Idea26729Config();
