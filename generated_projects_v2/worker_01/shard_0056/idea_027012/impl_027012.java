...
@Data
public class Idea27012Config {
    private String name = "idea_027012";
 ...
 */
@Slf4j
public class Idea27012Service {
    private static final int IDEA_ID = 27012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27012Service() {
        this(new Idea27012Config());
    }

    public Idea27012Service(Idea27012Config config) {
        this.config = config != null ? config : new Idea27012Config();
