...
@Data
public class Idea26800Config {
    private String name = "idea_026800";
 ...
 */
@Slf4j
public class Idea26800Service {
    private static final int IDEA_ID = 26800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26800Service() {
        this(new Idea26800Config());
    }

    public Idea26800Service(Idea26800Config config) {
        this.config = config != null ? config : new Idea26800Config();
