...
@Data
public class Idea26688Config {
    private String name = "idea_026688";
 ...
 */
@Slf4j
public class Idea26688Service {
    private static final int IDEA_ID = 26688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26688Service() {
        this(new Idea26688Config());
    }

    public Idea26688Service(Idea26688Config config) {
        this.config = config != null ? config : new Idea26688Config();
