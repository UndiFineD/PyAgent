...
@Data
public class Idea26714Config {
    private String name = "idea_026714";
 ...
 */
@Slf4j
public class Idea26714Service {
    private static final int IDEA_ID = 26714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26714Service() {
        this(new Idea26714Config());
    }

    public Idea26714Service(Idea26714Config config) {
        this.config = config != null ? config : new Idea26714Config();
