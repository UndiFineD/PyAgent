...
@Data
public class Idea26719Config {
    private String name = "idea_026719";
 ...
 */
@Slf4j
public class Idea26719Service {
    private static final int IDEA_ID = 26719;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26719Service() {
        this(new Idea26719Config());
    }

    public Idea26719Service(Idea26719Config config) {
        this.config = config != null ? config : new Idea26719Config();
