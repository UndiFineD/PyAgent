...
@Data
public class Idea26944Config {
    private String name = "idea_026944";
 ...
 */
@Slf4j
public class Idea26944Service {
    private static final int IDEA_ID = 26944;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26944Service() {
        this(new Idea26944Config());
    }

    public Idea26944Service(Idea26944Config config) {
        this.config = config != null ? config : new Idea26944Config();
