...
@Data
public class Idea26730Config {
    private String name = "idea_026730";
 ...
 */
@Slf4j
public class Idea26730Service {
    private static final int IDEA_ID = 26730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26730Service() {
        this(new Idea26730Config());
    }

    public Idea26730Service(Idea26730Config config) {
        this.config = config != null ? config : new Idea26730Config();
