...
@Data
public class Idea26779Config {
    private String name = "idea_026779";
 ...
 */
@Slf4j
public class Idea26779Service {
    private static final int IDEA_ID = 26779;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26779Service() {
        this(new Idea26779Config());
    }

    public Idea26779Service(Idea26779Config config) {
        this.config = config != null ? config : new Idea26779Config();
