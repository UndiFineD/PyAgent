...
@Data
public class Idea26747Config {
    private String name = "idea_026747";
 ...
 */
@Slf4j
public class Idea26747Service {
    private static final int IDEA_ID = 26747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26747Service() {
        this(new Idea26747Config());
    }

    public Idea26747Service(Idea26747Config config) {
        this.config = config != null ? config : new Idea26747Config();
