...
@Data
public class Idea27072Config {
    private String name = "idea_027072";
 ...
 */
@Slf4j
public class Idea27072Service {
    private static final int IDEA_ID = 27072;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27072Service() {
        this(new Idea27072Config());
    }

    public Idea27072Service(Idea27072Config config) {
        this.config = config != null ? config : new Idea27072Config();
