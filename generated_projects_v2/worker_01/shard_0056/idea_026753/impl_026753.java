...
@Data
public class Idea26753Config {
    private String name = "idea_026753";
 ...
 */
@Slf4j
public class Idea26753Service {
    private static final int IDEA_ID = 26753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26753Service() {
        this(new Idea26753Config());
    }

    public Idea26753Service(Idea26753Config config) {
        this.config = config != null ? config : new Idea26753Config();
