...
@Data
public class Idea27016Config {
    private String name = "idea_027016";
 ...
 */
@Slf4j
public class Idea27016Service {
    private static final int IDEA_ID = 27016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27016Service() {
        this(new Idea27016Config());
    }

    public Idea27016Service(Idea27016Config config) {
        this.config = config != null ? config : new Idea27016Config();
