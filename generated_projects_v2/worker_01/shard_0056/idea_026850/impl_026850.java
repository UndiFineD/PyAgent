...
@Data
public class Idea26850Config {
    private String name = "idea_026850";
 ...
 */
@Slf4j
public class Idea26850Service {
    private static final int IDEA_ID = 26850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26850Service() {
        this(new Idea26850Config());
    }

    public Idea26850Service(Idea26850Config config) {
        this.config = config != null ? config : new Idea26850Config();
