...
@Data
public class Idea26870Config {
    private String name = "idea_026870";
 ...
 */
@Slf4j
public class Idea26870Service {
    private static final int IDEA_ID = 26870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26870Service() {
        this(new Idea26870Config());
    }

    public Idea26870Service(Idea26870Config config) {
        this.config = config != null ? config : new Idea26870Config();
