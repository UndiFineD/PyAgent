...
@Data
public class Idea26823Config {
    private String name = "idea_026823";
 ...
 */
@Slf4j
public class Idea26823Service {
    private static final int IDEA_ID = 26823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26823Service() {
        this(new Idea26823Config());
    }

    public Idea26823Service(Idea26823Config config) {
        this.config = config != null ? config : new Idea26823Config();
