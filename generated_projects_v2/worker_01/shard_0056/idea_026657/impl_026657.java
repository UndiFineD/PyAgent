...
@Data
public class Idea26657Config {
    private String name = "idea_026657";
 ...
 */
@Slf4j
public class Idea26657Service {
    private static final int IDEA_ID = 26657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26657Service() {
        this(new Idea26657Config());
    }

    public Idea26657Service(Idea26657Config config) {
        this.config = config != null ? config : new Idea26657Config();
