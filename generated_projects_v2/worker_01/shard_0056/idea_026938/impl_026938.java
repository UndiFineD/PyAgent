...
@Data
public class Idea26938Config {
    private String name = "idea_026938";
 ...
 */
@Slf4j
public class Idea26938Service {
    private static final int IDEA_ID = 26938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26938Service() {
        this(new Idea26938Config());
    }

    public Idea26938Service(Idea26938Config config) {
        this.config = config != null ? config : new Idea26938Config();
