...
@Data
public class Idea26795Config {
    private String name = "idea_026795";
 ...
 */
@Slf4j
public class Idea26795Service {
    private static final int IDEA_ID = 26795;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26795Service() {
        this(new Idea26795Config());
    }

    public Idea26795Service(Idea26795Config config) {
        this.config = config != null ? config : new Idea26795Config();
