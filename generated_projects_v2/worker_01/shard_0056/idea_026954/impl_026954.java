...
@Data
public class Idea26954Config {
    private String name = "idea_026954";
 ...
 */
@Slf4j
public class Idea26954Service {
    private static final int IDEA_ID = 26954;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26954Service() {
        this(new Idea26954Config());
    }

    public Idea26954Service(Idea26954Config config) {
        this.config = config != null ? config : new Idea26954Config();
