...
@Data
public class Idea26848Config {
    private String name = "idea_026848";
 ...
 */
@Slf4j
public class Idea26848Service {
    private static final int IDEA_ID = 26848;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26848Service() {
        this(new Idea26848Config());
    }

    public Idea26848Service(Idea26848Config config) {
        this.config = config != null ? config : new Idea26848Config();
