...
@Data
public class Idea26637Config {
    private String name = "idea_026637";
 ...
 */
@Slf4j
public class Idea26637Service {
    private static final int IDEA_ID = 26637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26637Service() {
        this(new Idea26637Config());
    }

    public Idea26637Service(Idea26637Config config) {
        this.config = config != null ? config : new Idea26637Config();
