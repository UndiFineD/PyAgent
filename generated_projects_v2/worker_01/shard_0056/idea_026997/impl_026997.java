...
@Data
public class Idea26997Config {
    private String name = "idea_026997";
 ...
 */
@Slf4j
public class Idea26997Service {
    private static final int IDEA_ID = 26997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26997Service() {
        this(new Idea26997Config());
    }

    public Idea26997Service(Idea26997Config config) {
        this.config = config != null ? config : new Idea26997Config();
