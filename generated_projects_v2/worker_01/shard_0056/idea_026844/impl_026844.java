...
@Data
public class Idea26844Config {
    private String name = "idea_026844";
 ...
 */
@Slf4j
public class Idea26844Service {
    private static final int IDEA_ID = 26844;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26844Service() {
        this(new Idea26844Config());
    }

    public Idea26844Service(Idea26844Config config) {
        this.config = config != null ? config : new Idea26844Config();
