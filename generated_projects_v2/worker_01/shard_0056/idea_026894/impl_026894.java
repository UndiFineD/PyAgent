...
@Data
public class Idea26894Config {
    private String name = "idea_026894";
 ...
 */
@Slf4j
public class Idea26894Service {
    private static final int IDEA_ID = 26894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26894Service() {
        this(new Idea26894Config());
    }

    public Idea26894Service(Idea26894Config config) {
        this.config = config != null ? config : new Idea26894Config();
