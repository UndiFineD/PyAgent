...
@Data
public class Idea26933Config {
    private String name = "idea_026933";
 ...
 */
@Slf4j
public class Idea26933Service {
    private static final int IDEA_ID = 26933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26933Service() {
        this(new Idea26933Config());
    }

    public Idea26933Service(Idea26933Config config) {
        this.config = config != null ? config : new Idea26933Config();
