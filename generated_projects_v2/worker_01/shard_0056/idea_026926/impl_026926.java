...
@Data
public class Idea26926Config {
    private String name = "idea_026926";
 ...
 */
@Slf4j
public class Idea26926Service {
    private static final int IDEA_ID = 26926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26926Service() {
        this(new Idea26926Config());
    }

    public Idea26926Service(Idea26926Config config) {
        this.config = config != null ? config : new Idea26926Config();
