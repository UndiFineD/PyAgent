...
@Data
public class Idea26862Config {
    private String name = "idea_026862";
 ...
 */
@Slf4j
public class Idea26862Service {
    private static final int IDEA_ID = 26862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26862Service() {
        this(new Idea26862Config());
    }

    public Idea26862Service(Idea26862Config config) {
        this.config = config != null ? config : new Idea26862Config();
