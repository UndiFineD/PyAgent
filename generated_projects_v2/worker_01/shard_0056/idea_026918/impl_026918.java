...
@Data
public class Idea26918Config {
    private String name = "idea_026918";
 ...
 */
@Slf4j
public class Idea26918Service {
    private static final int IDEA_ID = 26918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26918Service() {
        this(new Idea26918Config());
    }

    public Idea26918Service(Idea26918Config config) {
        this.config = config != null ? config : new Idea26918Config();
