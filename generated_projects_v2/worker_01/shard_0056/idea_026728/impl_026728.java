...
@Data
public class Idea26728Config {
    private String name = "idea_026728";
 ...
 */
@Slf4j
public class Idea26728Service {
    private static final int IDEA_ID = 26728;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26728Service() {
        this(new Idea26728Config());
    }

    public Idea26728Service(Idea26728Config config) {
        this.config = config != null ? config : new Idea26728Config();
