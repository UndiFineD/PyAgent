...
@Data
public class Idea27037Config {
    private String name = "idea_027037";
 ...
 */
@Slf4j
public class Idea27037Service {
    private static final int IDEA_ID = 27037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27037Service() {
        this(new Idea27037Config());
    }

    public Idea27037Service(Idea27037Config config) {
        this.config = config != null ? config : new Idea27037Config();
