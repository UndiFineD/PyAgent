...
@Data
public class Idea26834Config {
    private String name = "idea_026834";
 ...
 */
@Slf4j
public class Idea26834Service {
    private static final int IDEA_ID = 26834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26834Service() {
        this(new Idea26834Config());
    }

    public Idea26834Service(Idea26834Config config) {
        this.config = config != null ? config : new Idea26834Config();
