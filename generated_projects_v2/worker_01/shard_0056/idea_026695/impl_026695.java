...
@Data
public class Idea26695Config {
    private String name = "idea_026695";
 ...
 */
@Slf4j
public class Idea26695Service {
    private static final int IDEA_ID = 26695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26695Service() {
        this(new Idea26695Config());
    }

    public Idea26695Service(Idea26695Config config) {
        this.config = config != null ? config : new Idea26695Config();
