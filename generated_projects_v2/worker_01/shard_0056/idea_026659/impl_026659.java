...
@Data
public class Idea26659Config {
    private String name = "idea_026659";
 ...
 */
@Slf4j
public class Idea26659Service {
    private static final int IDEA_ID = 26659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26659Service() {
        this(new Idea26659Config());
    }

    public Idea26659Service(Idea26659Config config) {
        this.config = config != null ? config : new Idea26659Config();
