...
@Data
public class Idea26686Config {
    private String name = "idea_026686";
 ...
 */
@Slf4j
public class Idea26686Service {
    private static final int IDEA_ID = 26686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26686Service() {
        this(new Idea26686Config());
    }

    public Idea26686Service(Idea26686Config config) {
        this.config = config != null ? config : new Idea26686Config();
