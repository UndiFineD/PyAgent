...
@Data
public class Idea26615Config {
    private String name = "idea_026615";
 ...
 */
@Slf4j
public class Idea26615Service {
    private static final int IDEA_ID = 26615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26615Service() {
        this(new Idea26615Config());
    }

    public Idea26615Service(Idea26615Config config) {
        this.config = config != null ? config : new Idea26615Config();
