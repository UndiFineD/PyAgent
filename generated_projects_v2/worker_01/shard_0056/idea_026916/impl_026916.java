...
@Data
public class Idea26916Config {
    private String name = "idea_026916";
 ...
 */
@Slf4j
public class Idea26916Service {
    private static final int IDEA_ID = 26916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26916Service() {
        this(new Idea26916Config());
    }

    public Idea26916Service(Idea26916Config config) {
        this.config = config != null ? config : new Idea26916Config();
