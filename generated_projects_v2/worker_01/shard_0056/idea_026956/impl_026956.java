...
@Data
public class Idea26956Config {
    private String name = "idea_026956";
 ...
 */
@Slf4j
public class Idea26956Service {
    private static final int IDEA_ID = 26956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26956Service() {
        this(new Idea26956Config());
    }

    public Idea26956Service(Idea26956Config config) {
        this.config = config != null ? config : new Idea26956Config();
