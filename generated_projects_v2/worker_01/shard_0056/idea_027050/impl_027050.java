...
@Data
public class Idea27050Config {
    private String name = "idea_027050";
 ...
 */
@Slf4j
public class Idea27050Service {
    private static final int IDEA_ID = 27050;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27050Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27050Service() {
        this(new Idea27050Config());
    }

    public Idea27050Service(Idea27050Config config) {
        this.config = config != null ? config : new Idea27050Config();
