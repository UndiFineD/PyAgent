...
@Data
public class Idea26792Config {
    private String name = "idea_026792";
 ...
 */
@Slf4j
public class Idea26792Service {
    private static final int IDEA_ID = 26792;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26792Service() {
        this(new Idea26792Config());
    }

    public Idea26792Service(Idea26792Config config) {
        this.config = config != null ? config : new Idea26792Config();
