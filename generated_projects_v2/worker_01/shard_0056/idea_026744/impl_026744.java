...
@Data
public class Idea26744Config {
    private String name = "idea_026744";
 ...
 */
@Slf4j
public class Idea26744Service {
    private static final int IDEA_ID = 26744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26744Service() {
        this(new Idea26744Config());
    }

    public Idea26744Service(Idea26744Config config) {
        this.config = config != null ? config : new Idea26744Config();
