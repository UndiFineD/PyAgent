...
@Data
public class Idea26833Config {
    private String name = "idea_026833";
 ...
 */
@Slf4j
public class Idea26833Service {
    private static final int IDEA_ID = 26833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26833Service() {
        this(new Idea26833Config());
    }

    public Idea26833Service(Idea26833Config config) {
        this.config = config != null ? config : new Idea26833Config();
