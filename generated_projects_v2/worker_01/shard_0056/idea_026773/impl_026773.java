...
@Data
public class Idea26773Config {
    private String name = "idea_026773";
 ...
 */
@Slf4j
public class Idea26773Service {
    private static final int IDEA_ID = 26773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26773Service() {
        this(new Idea26773Config());
    }

    public Idea26773Service(Idea26773Config config) {
        this.config = config != null ? config : new Idea26773Config();
