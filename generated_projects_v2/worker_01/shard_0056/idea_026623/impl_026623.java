...
@Data
public class Idea26623Config {
    private String name = "idea_026623";
 ...
 */
@Slf4j
public class Idea26623Service {
    private static final int IDEA_ID = 26623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26623Service() {
        this(new Idea26623Config());
    }

    public Idea26623Service(Idea26623Config config) {
        this.config = config != null ? config : new Idea26623Config();
