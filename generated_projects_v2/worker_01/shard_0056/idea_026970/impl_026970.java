...
@Data
public class Idea26970Config {
    private String name = "idea_026970";
 ...
 */
@Slf4j
public class Idea26970Service {
    private static final int IDEA_ID = 26970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26970Service() {
        this(new Idea26970Config());
    }

    public Idea26970Service(Idea26970Config config) {
        this.config = config != null ? config : new Idea26970Config();
