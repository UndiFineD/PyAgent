...
@Data
public class Idea26642Config {
    private String name = "idea_026642";
 ...
 */
@Slf4j
public class Idea26642Service {
    private static final int IDEA_ID = 26642;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26642Service() {
        this(new Idea26642Config());
    }

    public Idea26642Service(Idea26642Config config) {
        this.config = config != null ? config : new Idea26642Config();
