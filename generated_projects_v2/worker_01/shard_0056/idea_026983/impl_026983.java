...
@Data
public class Idea26983Config {
    private String name = "idea_026983";
 ...
 */
@Slf4j
public class Idea26983Service {
    private static final int IDEA_ID = 26983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26983Service() {
        this(new Idea26983Config());
    }

    public Idea26983Service(Idea26983Config config) {
        this.config = config != null ? config : new Idea26983Config();
