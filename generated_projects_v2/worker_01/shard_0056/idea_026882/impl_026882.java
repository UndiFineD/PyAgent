...
@Data
public class Idea26882Config {
    private String name = "idea_026882";
 ...
 */
@Slf4j
public class Idea26882Service {
    private static final int IDEA_ID = 26882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26882Service() {
        this(new Idea26882Config());
    }

    public Idea26882Service(Idea26882Config config) {
        this.config = config != null ? config : new Idea26882Config();
