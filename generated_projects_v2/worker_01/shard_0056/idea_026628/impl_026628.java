...
@Data
public class Idea26628Config {
    private String name = "idea_026628";
 ...
 */
@Slf4j
public class Idea26628Service {
    private static final int IDEA_ID = 26628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26628Service() {
        this(new Idea26628Config());
    }

    public Idea26628Service(Idea26628Config config) {
        this.config = config != null ? config : new Idea26628Config();
