...
@Data
public class Idea26680Config {
    private String name = "idea_026680";
 ...
 */
@Slf4j
public class Idea26680Service {
    private static final int IDEA_ID = 26680;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26680Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26680Service() {
        this(new Idea26680Config());
    }

    public Idea26680Service(Idea26680Config config) {
        this.config = config != null ? config : new Idea26680Config();
