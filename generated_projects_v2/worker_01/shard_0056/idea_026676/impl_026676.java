...
@Data
public class Idea26676Config {
    private String name = "idea_026676";
 ...
 */
@Slf4j
public class Idea26676Service {
    private static final int IDEA_ID = 26676;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26676Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26676Service() {
        this(new Idea26676Config());
    }

    public Idea26676Service(Idea26676Config config) {
        this.config = config != null ? config : new Idea26676Config();
