...
@Data
public class Idea26951Config {
    private String name = "idea_026951";
 ...
 */
@Slf4j
public class Idea26951Service {
    private static final int IDEA_ID = 26951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26951Service() {
        this(new Idea26951Config());
    }

    public Idea26951Service(Idea26951Config config) {
        this.config = config != null ? config : new Idea26951Config();
