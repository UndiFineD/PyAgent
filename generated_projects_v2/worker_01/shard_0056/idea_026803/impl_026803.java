...
@Data
public class Idea26803Config {
    private String name = "idea_026803";
 ...
 */
@Slf4j
public class Idea26803Service {
    private static final int IDEA_ID = 26803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26803Service() {
        this(new Idea26803Config());
    }

    public Idea26803Service(Idea26803Config config) {
        this.config = config != null ? config : new Idea26803Config();
