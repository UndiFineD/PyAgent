...
@Data
public class Idea27063Config {
    private String name = "idea_027063";
 ...
 */
@Slf4j
public class Idea27063Service {
    private static final int IDEA_ID = 27063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27063Service() {
        this(new Idea27063Config());
    }

    public Idea27063Service(Idea27063Config config) {
        this.config = config != null ? config : new Idea27063Config();
