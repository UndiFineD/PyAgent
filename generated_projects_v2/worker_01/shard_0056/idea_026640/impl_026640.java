...
@Data
public class Idea26640Config {
    private String name = "idea_026640";
 ...
 */
@Slf4j
public class Idea26640Service {
    private static final int IDEA_ID = 26640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26640Service() {
        this(new Idea26640Config());
    }

    public Idea26640Service(Idea26640Config config) {
        this.config = config != null ? config : new Idea26640Config();
