...
@Data
public class Idea26846Config {
    private String name = "idea_026846";
 ...
 */
@Slf4j
public class Idea26846Service {
    private static final int IDEA_ID = 26846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26846Service() {
        this(new Idea26846Config());
    }

    public Idea26846Service(Idea26846Config config) {
        this.config = config != null ? config : new Idea26846Config();
