...
@Data
public class Idea26877Config {
    private String name = "idea_026877";
 ...
 */
@Slf4j
public class Idea26877Service {
    private static final int IDEA_ID = 26877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26877Service() {
        this(new Idea26877Config());
    }

    public Idea26877Service(Idea26877Config config) {
        this.config = config != null ? config : new Idea26877Config();
