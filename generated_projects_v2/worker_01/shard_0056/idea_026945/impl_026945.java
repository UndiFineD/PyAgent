...
@Data
public class Idea26945Config {
    private String name = "idea_026945";
 ...
 */
@Slf4j
public class Idea26945Service {
    private static final int IDEA_ID = 26945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26945Service() {
        this(new Idea26945Config());
    }

    public Idea26945Service(Idea26945Config config) {
        this.config = config != null ? config : new Idea26945Config();
