...
@Data
public class Idea26763Config {
    private String name = "idea_026763";
 ...
 */
@Slf4j
public class Idea26763Service {
    private static final int IDEA_ID = 26763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26763Service() {
        this(new Idea26763Config());
    }

    public Idea26763Service(Idea26763Config config) {
        this.config = config != null ? config : new Idea26763Config();
