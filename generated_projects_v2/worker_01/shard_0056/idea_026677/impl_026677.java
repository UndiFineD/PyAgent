...
@Data
public class Idea26677Config {
    private String name = "idea_026677";
 ...
 */
@Slf4j
public class Idea26677Service {
    private static final int IDEA_ID = 26677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26677Service() {
        this(new Idea26677Config());
    }

    public Idea26677Service(Idea26677Config config) {
        this.config = config != null ? config : new Idea26677Config();
