...
@Data
public class Idea26608Config {
    private String name = "idea_026608";
 ...
 */
@Slf4j
public class Idea26608Service {
    private static final int IDEA_ID = 26608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26608Service() {
        this(new Idea26608Config());
    }

    public Idea26608Service(Idea26608Config config) {
        this.config = config != null ? config : new Idea26608Config();
