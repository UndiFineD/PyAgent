...
@Data
public class Idea26767Config {
    private String name = "idea_026767";
 ...
 */
@Slf4j
public class Idea26767Service {
    private static final int IDEA_ID = 26767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26767Service() {
        this(new Idea26767Config());
    }

    public Idea26767Service(Idea26767Config config) {
        this.config = config != null ? config : new Idea26767Config();
