...
@Data
public class Idea26607Config {
    private String name = "idea_026607";
 ...
 */
@Slf4j
public class Idea26607Service {
    private static final int IDEA_ID = 26607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26607Service() {
        this(new Idea26607Config());
    }

    public Idea26607Service(Idea26607Config config) {
        this.config = config != null ? config : new Idea26607Config();
