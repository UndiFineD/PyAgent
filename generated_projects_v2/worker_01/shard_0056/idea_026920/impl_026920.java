...
@Data
public class Idea26920Config {
    private String name = "idea_026920";
 ...
 */
@Slf4j
public class Idea26920Service {
    private static final int IDEA_ID = 26920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26920Service() {
        this(new Idea26920Config());
    }

    public Idea26920Service(Idea26920Config config) {
        this.config = config != null ? config : new Idea26920Config();
