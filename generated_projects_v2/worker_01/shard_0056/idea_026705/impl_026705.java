...
@Data
public class Idea26705Config {
    private String name = "idea_026705";
 ...
 */
@Slf4j
public class Idea26705Service {
    private static final int IDEA_ID = 26705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26705Service() {
        this(new Idea26705Config());
    }

    public Idea26705Service(Idea26705Config config) {
        this.config = config != null ? config : new Idea26705Config();
