...
@Data
public class Idea26939Config {
    private String name = "idea_026939";
 ...
 */
@Slf4j
public class Idea26939Service {
    private static final int IDEA_ID = 26939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26939Service() {
        this(new Idea26939Config());
    }

    public Idea26939Service(Idea26939Config config) {
        this.config = config != null ? config : new Idea26939Config();
