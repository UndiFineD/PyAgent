...
@Data
public class Idea27038Config {
    private String name = "idea_027038";
 ...
 */
@Slf4j
public class Idea27038Service {
    private static final int IDEA_ID = 27038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27038Service() {
        this(new Idea27038Config());
    }

    public Idea27038Service(Idea27038Config config) {
        this.config = config != null ? config : new Idea27038Config();
