...
@Data
public class Idea27002Config {
    private String name = "idea_027002";
 ...
 */
@Slf4j
public class Idea27002Service {
    private static final int IDEA_ID = 27002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27002Service() {
        this(new Idea27002Config());
    }

    public Idea27002Service(Idea27002Config config) {
        this.config = config != null ? config : new Idea27002Config();
