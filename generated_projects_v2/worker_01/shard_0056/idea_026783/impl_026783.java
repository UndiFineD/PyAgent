...
@Data
public class Idea26783Config {
    private String name = "idea_026783";
 ...
 */
@Slf4j
public class Idea26783Service {
    private static final int IDEA_ID = 26783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26783Service() {
        this(new Idea26783Config());
    }

    public Idea26783Service(Idea26783Config config) {
        this.config = config != null ? config : new Idea26783Config();
