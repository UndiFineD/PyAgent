...
@Data
public class Idea26903Config {
    private String name = "idea_026903";
 ...
 */
@Slf4j
public class Idea26903Service {
    private static final int IDEA_ID = 26903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26903Service() {
        this(new Idea26903Config());
    }

    public Idea26903Service(Idea26903Config config) {
        this.config = config != null ? config : new Idea26903Config();
