...
@Data
public class Idea26796Config {
    private String name = "idea_026796";
 ...
 */
@Slf4j
public class Idea26796Service {
    private static final int IDEA_ID = 26796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26796Service() {
        this(new Idea26796Config());
    }

    public Idea26796Service(Idea26796Config config) {
        this.config = config != null ? config : new Idea26796Config();
