...
@Data
public class Idea26726Config {
    private String name = "idea_026726";
 ...
 */
@Slf4j
public class Idea26726Service {
    private static final int IDEA_ID = 26726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26726Service() {
        this(new Idea26726Config());
    }

    public Idea26726Service(Idea26726Config config) {
        this.config = config != null ? config : new Idea26726Config();
