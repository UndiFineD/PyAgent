...
@Data
public class Idea26606Config {
    private String name = "idea_026606";
 ...
 */
@Slf4j
public class Idea26606Service {
    private static final int IDEA_ID = 26606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26606Service() {
        this(new Idea26606Config());
    }

    public Idea26606Service(Idea26606Config config) {
        this.config = config != null ? config : new Idea26606Config();
