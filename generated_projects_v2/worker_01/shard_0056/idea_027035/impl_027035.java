...
@Data
public class Idea27035Config {
    private String name = "idea_027035";
 ...
 */
@Slf4j
public class Idea27035Service {
    private static final int IDEA_ID = 27035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27035Service() {
        this(new Idea27035Config());
    }

    public Idea27035Service(Idea27035Config config) {
        this.config = config != null ? config : new Idea27035Config();
