...
@Data
public class Idea26618Config {
    private String name = "idea_026618";
 ...
 */
@Slf4j
public class Idea26618Service {
    private static final int IDEA_ID = 26618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26618Service() {
        this(new Idea26618Config());
    }

    public Idea26618Service(Idea26618Config config) {
        this.config = config != null ? config : new Idea26618Config();
