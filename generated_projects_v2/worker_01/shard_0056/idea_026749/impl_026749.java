...
@Data
public class Idea26749Config {
    private String name = "idea_026749";
 ...
 */
@Slf4j
public class Idea26749Service {
    private static final int IDEA_ID = 26749;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26749Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26749Service() {
        this(new Idea26749Config());
    }

    public Idea26749Service(Idea26749Config config) {
        this.config = config != null ? config : new Idea26749Config();
