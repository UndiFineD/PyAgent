...
@Data
public class Idea26707Config {
    private String name = "idea_026707";
 ...
 */
@Slf4j
public class Idea26707Service {
    private static final int IDEA_ID = 26707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26707Service() {
        this(new Idea26707Config());
    }

    public Idea26707Service(Idea26707Config config) {
        this.config = config != null ? config : new Idea26707Config();
