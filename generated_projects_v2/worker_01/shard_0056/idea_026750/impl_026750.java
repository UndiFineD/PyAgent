...
@Data
public class Idea26750Config {
    private String name = "idea_026750";
 ...
 */
@Slf4j
public class Idea26750Service {
    private static final int IDEA_ID = 26750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26750Service() {
        this(new Idea26750Config());
    }

    public Idea26750Service(Idea26750Config config) {
        this.config = config != null ? config : new Idea26750Config();
