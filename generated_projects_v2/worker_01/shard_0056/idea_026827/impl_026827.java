...
@Data
public class Idea26827Config {
    private String name = "idea_026827";
 ...
 */
@Slf4j
public class Idea26827Service {
    private static final int IDEA_ID = 26827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26827Service() {
        this(new Idea26827Config());
    }

    public Idea26827Service(Idea26827Config config) {
        this.config = config != null ? config : new Idea26827Config();
