...
@Data
public class Idea26626Config {
    private String name = "idea_026626";
 ...
 */
@Slf4j
public class Idea26626Service {
    private static final int IDEA_ID = 26626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26626Service() {
        this(new Idea26626Config());
    }

    public Idea26626Service(Idea26626Config config) {
        this.config = config != null ? config : new Idea26626Config();
