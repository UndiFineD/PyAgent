...
@Data
public class Idea26650Config {
    private String name = "idea_026650";
 ...
 */
@Slf4j
public class Idea26650Service {
    private static final int IDEA_ID = 26650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26650Service() {
        this(new Idea26650Config());
    }

    public Idea26650Service(Idea26650Config config) {
        this.config = config != null ? config : new Idea26650Config();
