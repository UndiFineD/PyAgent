...
@Data
public class Idea26819Config {
    private String name = "idea_026819";
 ...
 */
@Slf4j
public class Idea26819Service {
    private static final int IDEA_ID = 26819;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26819Service() {
        this(new Idea26819Config());
    }

    public Idea26819Service(Idea26819Config config) {
        this.config = config != null ? config : new Idea26819Config();
