...
@Data
public class Idea26808Config {
    private String name = "idea_026808";
 ...
 */
@Slf4j
public class Idea26808Service {
    private static final int IDEA_ID = 26808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26808Service() {
        this(new Idea26808Config());
    }

    public Idea26808Service(Idea26808Config config) {
        this.config = config != null ? config : new Idea26808Config();
