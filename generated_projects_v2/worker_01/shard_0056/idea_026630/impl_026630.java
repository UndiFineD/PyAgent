...
@Data
public class Idea26630Config {
    private String name = "idea_026630";
 ...
 */
@Slf4j
public class Idea26630Service {
    private static final int IDEA_ID = 26630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26630Service() {
        this(new Idea26630Config());
    }

    public Idea26630Service(Idea26630Config config) {
        this.config = config != null ? config : new Idea26630Config();
