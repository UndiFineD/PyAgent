...
@Data
public class Idea26853Config {
    private String name = "idea_026853";
 ...
 */
@Slf4j
public class Idea26853Service {
    private static final int IDEA_ID = 26853;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26853Service() {
        this(new Idea26853Config());
    }

    public Idea26853Service(Idea26853Config config) {
        this.config = config != null ? config : new Idea26853Config();
