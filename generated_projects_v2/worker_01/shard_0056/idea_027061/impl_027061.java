...
@Data
public class Idea27061Config {
    private String name = "idea_027061";
 ...
 */
@Slf4j
public class Idea27061Service {
    private static final int IDEA_ID = 27061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27061Service() {
        this(new Idea27061Config());
    }

    public Idea27061Service(Idea27061Config config) {
        this.config = config != null ? config : new Idea27061Config();
