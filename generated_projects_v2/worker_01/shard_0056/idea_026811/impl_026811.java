...
@Data
public class Idea26811Config {
    private String name = "idea_026811";
 ...
 */
@Slf4j
public class Idea26811Service {
    private static final int IDEA_ID = 26811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26811Service() {
        this(new Idea26811Config());
    }

    public Idea26811Service(Idea26811Config config) {
        this.config = config != null ? config : new Idea26811Config();
