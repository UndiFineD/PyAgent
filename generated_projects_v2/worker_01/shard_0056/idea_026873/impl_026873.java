...
@Data
public class Idea26873Config {
    private String name = "idea_026873";
 ...
 */
@Slf4j
public class Idea26873Service {
    private static final int IDEA_ID = 26873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26873Service() {
        this(new Idea26873Config());
    }

    public Idea26873Service(Idea26873Config config) {
        this.config = config != null ? config : new Idea26873Config();
