...
@Data
public class Idea26924Config {
    private String name = "idea_026924";
 ...
 */
@Slf4j
public class Idea26924Service {
    private static final int IDEA_ID = 26924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26924Service() {
        this(new Idea26924Config());
    }

    public Idea26924Service(Idea26924Config config) {
        this.config = config != null ? config : new Idea26924Config();
