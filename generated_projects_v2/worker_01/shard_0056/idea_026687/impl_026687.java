...
@Data
public class Idea26687Config {
    private String name = "idea_026687";
 ...
 */
@Slf4j
public class Idea26687Service {
    private static final int IDEA_ID = 26687;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26687Service() {
        this(new Idea26687Config());
    }

    public Idea26687Service(Idea26687Config config) {
        this.config = config != null ? config : new Idea26687Config();
