...
@Data
public class Idea27060Config {
    private String name = "idea_027060";
 ...
 */
@Slf4j
public class Idea27060Service {
    private static final int IDEA_ID = 27060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27060Service() {
        this(new Idea27060Config());
    }

    public Idea27060Service(Idea27060Config config) {
        this.config = config != null ? config : new Idea27060Config();
