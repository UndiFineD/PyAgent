...
@Data
public class Idea26625Config {
    private String name = "idea_026625";
 ...
 */
@Slf4j
public class Idea26625Service {
    private static final int IDEA_ID = 26625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26625Service() {
        this(new Idea26625Config());
    }

    public Idea26625Service(Idea26625Config config) {
        this.config = config != null ? config : new Idea26625Config();
