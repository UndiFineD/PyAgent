...
@Data
public class Idea26977Config {
    private String name = "idea_026977";
 ...
 */
@Slf4j
public class Idea26977Service {
    private static final int IDEA_ID = 26977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26977Service() {
        this(new Idea26977Config());
    }

    public Idea26977Service(Idea26977Config config) {
        this.config = config != null ? config : new Idea26977Config();
