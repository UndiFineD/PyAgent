...
@Data
public class Idea26784Config {
    private String name = "idea_026784";
 ...
 */
@Slf4j
public class Idea26784Service {
    private static final int IDEA_ID = 26784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26784Service() {
        this(new Idea26784Config());
    }

    public Idea26784Service(Idea26784Config config) {
        this.config = config != null ? config : new Idea26784Config();
