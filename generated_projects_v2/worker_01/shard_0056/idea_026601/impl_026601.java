...
@Data
public class Idea26601Config {
    private String name = "idea_026601";
 ...
 */
@Slf4j
public class Idea26601Service {
    private static final int IDEA_ID = 26601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26601Service() {
        this(new Idea26601Config());
    }

    public Idea26601Service(Idea26601Config config) {
        this.config = config != null ? config : new Idea26601Config();
