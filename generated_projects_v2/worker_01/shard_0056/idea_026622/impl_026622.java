...
@Data
public class Idea26622Config {
    private String name = "idea_026622";
 ...
 */
@Slf4j
public class Idea26622Service {
    private static final int IDEA_ID = 26622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26622Service() {
        this(new Idea26622Config());
    }

    public Idea26622Service(Idea26622Config config) {
        this.config = config != null ? config : new Idea26622Config();
