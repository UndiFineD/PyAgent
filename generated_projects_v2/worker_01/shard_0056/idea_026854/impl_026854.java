...
@Data
public class Idea26854Config {
    private String name = "idea_026854";
 ...
 */
@Slf4j
public class Idea26854Service {
    private static final int IDEA_ID = 26854;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26854Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26854Service() {
        this(new Idea26854Config());
    }

    public Idea26854Service(Idea26854Config config) {
        this.config = config != null ? config : new Idea26854Config();
