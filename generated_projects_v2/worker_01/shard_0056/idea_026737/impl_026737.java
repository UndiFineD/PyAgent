...
@Data
public class Idea26737Config {
    private String name = "idea_026737";
 ...
 */
@Slf4j
public class Idea26737Service {
    private static final int IDEA_ID = 26737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26737Service() {
        this(new Idea26737Config());
    }

    public Idea26737Service(Idea26737Config config) {
        this.config = config != null ? config : new Idea26737Config();
