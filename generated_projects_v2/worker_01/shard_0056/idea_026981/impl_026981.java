...
@Data
public class Idea26981Config {
    private String name = "idea_026981";
 ...
 */
@Slf4j
public class Idea26981Service {
    private static final int IDEA_ID = 26981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26981Service() {
        this(new Idea26981Config());
    }

    public Idea26981Service(Idea26981Config config) {
        this.config = config != null ? config : new Idea26981Config();
