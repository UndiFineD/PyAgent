...
@Data
public class Idea26960Config {
    private String name = "idea_026960";
 ...
 */
@Slf4j
public class Idea26960Service {
    private static final int IDEA_ID = 26960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26960Service() {
        this(new Idea26960Config());
    }

    public Idea26960Service(Idea26960Config config) {
        this.config = config != null ? config : new Idea26960Config();
