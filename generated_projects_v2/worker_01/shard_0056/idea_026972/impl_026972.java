...
@Data
public class Idea26972Config {
    private String name = "idea_026972";
 ...
 */
@Slf4j
public class Idea26972Service {
    private static final int IDEA_ID = 26972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26972Service() {
        this(new Idea26972Config());
    }

    public Idea26972Service(Idea26972Config config) {
        this.config = config != null ? config : new Idea26972Config();
