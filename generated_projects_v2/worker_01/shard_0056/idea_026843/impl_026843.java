...
@Data
public class Idea26843Config {
    private String name = "idea_026843";
 ...
 */
@Slf4j
public class Idea26843Service {
    private static final int IDEA_ID = 26843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26843Service() {
        this(new Idea26843Config());
    }

    public Idea26843Service(Idea26843Config config) {
        this.config = config != null ? config : new Idea26843Config();
