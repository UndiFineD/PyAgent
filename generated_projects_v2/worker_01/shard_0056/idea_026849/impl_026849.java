...
@Data
public class Idea26849Config {
    private String name = "idea_026849";
 ...
 */
@Slf4j
public class Idea26849Service {
    private static final int IDEA_ID = 26849;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26849Service() {
        this(new Idea26849Config());
    }

    public Idea26849Service(Idea26849Config config) {
        this.config = config != null ? config : new Idea26849Config();
