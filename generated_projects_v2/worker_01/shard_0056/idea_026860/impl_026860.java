...
@Data
public class Idea26860Config {
    private String name = "idea_026860";
 ...
 */
@Slf4j
public class Idea26860Service {
    private static final int IDEA_ID = 26860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26860Service() {
        this(new Idea26860Config());
    }

    public Idea26860Service(Idea26860Config config) {
        this.config = config != null ? config : new Idea26860Config();
