...
@Data
public class Idea26825Config {
    private String name = "idea_026825";
 ...
 */
@Slf4j
public class Idea26825Service {
    private static final int IDEA_ID = 26825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26825Service() {
        this(new Idea26825Config());
    }

    public Idea26825Service(Idea26825Config config) {
        this.config = config != null ? config : new Idea26825Config();
