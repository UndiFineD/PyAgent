...
@Data
public class Idea26721Config {
    private String name = "idea_026721";
 ...
 */
@Slf4j
public class Idea26721Service {
    private static final int IDEA_ID = 26721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26721Service() {
        this(new Idea26721Config());
    }

    public Idea26721Service(Idea26721Config config) {
        this.config = config != null ? config : new Idea26721Config();
