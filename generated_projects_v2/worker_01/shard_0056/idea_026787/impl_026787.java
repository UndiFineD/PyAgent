...
@Data
public class Idea26787Config {
    private String name = "idea_026787";
 ...
 */
@Slf4j
public class Idea26787Service {
    private static final int IDEA_ID = 26787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26787Service() {
        this(new Idea26787Config());
    }

    public Idea26787Service(Idea26787Config config) {
        this.config = config != null ? config : new Idea26787Config();
