...
@Data
public class Idea26691Config {
    private String name = "idea_026691";
 ...
 */
@Slf4j
public class Idea26691Service {
    private static final int IDEA_ID = 26691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26691Service() {
        this(new Idea26691Config());
    }

    public Idea26691Service(Idea26691Config config) {
        this.config = config != null ? config : new Idea26691Config();
