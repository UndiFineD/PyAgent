...
@Data
public class Idea26836Config {
    private String name = "idea_026836";
 ...
 */
@Slf4j
public class Idea26836Service {
    private static final int IDEA_ID = 26836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26836Service() {
        this(new Idea26836Config());
    }

    public Idea26836Service(Idea26836Config config) {
        this.config = config != null ? config : new Idea26836Config();
