...
@Data
public class Idea26706Config {
    private String name = "idea_026706";
 ...
 */
@Slf4j
public class Idea26706Service {
    private static final int IDEA_ID = 26706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26706Service() {
        this(new Idea26706Config());
    }

    public Idea26706Service(Idea26706Config config) {
        this.config = config != null ? config : new Idea26706Config();
