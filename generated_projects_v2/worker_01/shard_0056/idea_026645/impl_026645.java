...
@Data
public class Idea26645Config {
    private String name = "idea_026645";
 ...
 */
@Slf4j
public class Idea26645Service {
    private static final int IDEA_ID = 26645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26645Service() {
        this(new Idea26645Config());
    }

    public Idea26645Service(Idea26645Config config) {
        this.config = config != null ? config : new Idea26645Config();
