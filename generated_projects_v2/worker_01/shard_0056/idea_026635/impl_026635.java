...
@Data
public class Idea26635Config {
    private String name = "idea_026635";
 ...
 */
@Slf4j
public class Idea26635Service {
    private static final int IDEA_ID = 26635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26635Service() {
        this(new Idea26635Config());
    }

    public Idea26635Service(Idea26635Config config) {
        this.config = config != null ? config : new Idea26635Config();
