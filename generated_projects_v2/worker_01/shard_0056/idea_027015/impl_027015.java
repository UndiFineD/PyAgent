...
@Data
public class Idea27015Config {
    private String name = "idea_027015";
 ...
 */
@Slf4j
public class Idea27015Service {
    private static final int IDEA_ID = 27015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27015Service() {
        this(new Idea27015Config());
    }

    public Idea27015Service(Idea27015Config config) {
        this.config = config != null ? config : new Idea27015Config();
