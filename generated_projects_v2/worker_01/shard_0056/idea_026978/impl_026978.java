...
@Data
public class Idea26978Config {
    private String name = "idea_026978";
 ...
 */
@Slf4j
public class Idea26978Service {
    private static final int IDEA_ID = 26978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26978Service() {
        this(new Idea26978Config());
    }

    public Idea26978Service(Idea26978Config config) {
        this.config = config != null ? config : new Idea26978Config();
