...
@Data
public class Idea26904Config {
    private String name = "idea_026904";
 ...
 */
@Slf4j
public class Idea26904Service {
    private static final int IDEA_ID = 26904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26904Service() {
        this(new Idea26904Config());
    }

    public Idea26904Service(Idea26904Config config) {
        this.config = config != null ? config : new Idea26904Config();
