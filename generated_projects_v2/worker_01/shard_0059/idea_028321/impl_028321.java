...
@Data
public class Idea28321Config {
    private String name = "idea_028321";
 ...
 */
@Slf4j
public class Idea28321Service {
    private static final int IDEA_ID = 28321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28321Service() {
        this(new Idea28321Config());
    }

    public Idea28321Service(Idea28321Config config) {
        this.config = config != null ? config : new Idea28321Config();
