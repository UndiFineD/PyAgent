...
@Data
public class Idea28286Config {
    private String name = "idea_028286";
 ...
 */
@Slf4j
public class Idea28286Service {
    private static final int IDEA_ID = 28286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28286Service() {
        this(new Idea28286Config());
    }

    public Idea28286Service(Idea28286Config config) {
        this.config = config != null ? config : new Idea28286Config();
