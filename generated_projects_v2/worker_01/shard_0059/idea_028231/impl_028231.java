...
@Data
public class Idea28231Config {
    private String name = "idea_028231";
 ...
 */
@Slf4j
public class Idea28231Service {
    private static final int IDEA_ID = 28231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28231Service() {
        this(new Idea28231Config());
    }

    public Idea28231Service(Idea28231Config config) {
        this.config = config != null ? config : new Idea28231Config();
