...
@Data
public class Idea28085Config {
    private String name = "idea_028085";
 ...
 */
@Slf4j
public class Idea28085Service {
    private static final int IDEA_ID = 28085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28085Service() {
        this(new Idea28085Config());
    }

    public Idea28085Service(Idea28085Config config) {
        this.config = config != null ? config : new Idea28085Config();
