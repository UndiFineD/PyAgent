...
@Data
public class Idea28474Config {
    private String name = "idea_028474";
 ...
 */
@Slf4j
public class Idea28474Service {
    private static final int IDEA_ID = 28474;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28474Service() {
        this(new Idea28474Config());
    }

    public Idea28474Service(Idea28474Config config) {
        this.config = config != null ? config : new Idea28474Config();
