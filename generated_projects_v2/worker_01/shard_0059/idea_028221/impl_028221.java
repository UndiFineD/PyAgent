...
@Data
public class Idea28221Config {
    private String name = "idea_028221";
 ...
 */
@Slf4j
public class Idea28221Service {
    private static final int IDEA_ID = 28221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28221Service() {
        this(new Idea28221Config());
    }

    public Idea28221Service(Idea28221Config config) {
        this.config = config != null ? config : new Idea28221Config();
