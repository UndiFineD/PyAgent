...
@Data
public class Idea28253Config {
    private String name = "idea_028253";
 ...
 */
@Slf4j
public class Idea28253Service {
    private static final int IDEA_ID = 28253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28253Service() {
        this(new Idea28253Config());
    }

    public Idea28253Service(Idea28253Config config) {
        this.config = config != null ? config : new Idea28253Config();
