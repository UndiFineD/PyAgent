...
@Data
public class Idea28081Config {
    private String name = "idea_028081";
 ...
 */
@Slf4j
public class Idea28081Service {
    private static final int IDEA_ID = 28081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28081Service() {
        this(new Idea28081Config());
    }

    public Idea28081Service(Idea28081Config config) {
        this.config = config != null ? config : new Idea28081Config();
