...
@Data
public class Idea28233Config {
    private String name = "idea_028233";
 ...
 */
@Slf4j
public class Idea28233Service {
    private static final int IDEA_ID = 28233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28233Service() {
        this(new Idea28233Config());
    }

    public Idea28233Service(Idea28233Config config) {
        this.config = config != null ? config : new Idea28233Config();
