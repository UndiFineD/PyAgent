...
@Data
public class Idea28088Config {
    private String name = "idea_028088";
 ...
 */
@Slf4j
public class Idea28088Service {
    private static final int IDEA_ID = 28088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28088Service() {
        this(new Idea28088Config());
    }

    public Idea28088Service(Idea28088Config config) {
        this.config = config != null ? config : new Idea28088Config();
