...
@Data
public class Idea28331Config {
    private String name = "idea_028331";
 ...
 */
@Slf4j
public class Idea28331Service {
    private static final int IDEA_ID = 28331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28331Service() {
        this(new Idea28331Config());
    }

    public Idea28331Service(Idea28331Config config) {
        this.config = config != null ? config : new Idea28331Config();
