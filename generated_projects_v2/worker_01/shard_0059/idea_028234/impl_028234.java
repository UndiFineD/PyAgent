...
@Data
public class Idea28234Config {
    private String name = "idea_028234";
 ...
 */
@Slf4j
public class Idea28234Service {
    private static final int IDEA_ID = 28234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28234Service() {
        this(new Idea28234Config());
    }

    public Idea28234Service(Idea28234Config config) {
        this.config = config != null ? config : new Idea28234Config();
