...
@Data
public class Idea28495Config {
    private String name = "idea_028495";
 ...
 */
@Slf4j
public class Idea28495Service {
    private static final int IDEA_ID = 28495;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28495Service() {
        this(new Idea28495Config());
    }

    public Idea28495Service(Idea28495Config config) {
        this.config = config != null ? config : new Idea28495Config();
