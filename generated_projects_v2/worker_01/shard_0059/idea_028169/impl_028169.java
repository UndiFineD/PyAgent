...
@Data
public class Idea28169Config {
    private String name = "idea_028169";
 ...
 */
@Slf4j
public class Idea28169Service {
    private static final int IDEA_ID = 28169;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28169Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28169Service() {
        this(new Idea28169Config());
    }

    public Idea28169Service(Idea28169Config config) {
        this.config = config != null ? config : new Idea28169Config();
