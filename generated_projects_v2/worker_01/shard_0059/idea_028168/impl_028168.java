...
@Data
public class Idea28168Config {
    private String name = "idea_028168";
 ...
 */
@Slf4j
public class Idea28168Service {
    private static final int IDEA_ID = 28168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28168Service() {
        this(new Idea28168Config());
    }

    public Idea28168Service(Idea28168Config config) {
        this.config = config != null ? config : new Idea28168Config();
