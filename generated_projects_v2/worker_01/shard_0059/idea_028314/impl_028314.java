...
@Data
public class Idea28314Config {
    private String name = "idea_028314";
 ...
 */
@Slf4j
public class Idea28314Service {
    private static final int IDEA_ID = 28314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28314Service() {
        this(new Idea28314Config());
    }

    public Idea28314Service(Idea28314Config config) {
        this.config = config != null ? config : new Idea28314Config();
