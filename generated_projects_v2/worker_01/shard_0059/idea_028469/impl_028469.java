...
@Data
public class Idea28469Config {
    private String name = "idea_028469";
 ...
 */
@Slf4j
public class Idea28469Service {
    private static final int IDEA_ID = 28469;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28469Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28469Service() {
        this(new Idea28469Config());
    }

    public Idea28469Service(Idea28469Config config) {
        this.config = config != null ? config : new Idea28469Config();
