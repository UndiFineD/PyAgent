...
@Data
public class Idea28238Config {
    private String name = "idea_028238";
 ...
 */
@Slf4j
public class Idea28238Service {
    private static final int IDEA_ID = 28238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28238Service() {
        this(new Idea28238Config());
    }

    public Idea28238Service(Idea28238Config config) {
        this.config = config != null ? config : new Idea28238Config();
