...
@Data
public class Idea28112Config {
    private String name = "idea_028112";
 ...
 */
@Slf4j
public class Idea28112Service {
    private static final int IDEA_ID = 28112;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28112Service() {
        this(new Idea28112Config());
    }

    public Idea28112Service(Idea28112Config config) {
        this.config = config != null ? config : new Idea28112Config();
