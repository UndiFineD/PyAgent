...
@Data
public class Idea28219Config {
    private String name = "idea_028219";
 ...
 */
@Slf4j
public class Idea28219Service {
    private static final int IDEA_ID = 28219;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28219Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28219Service() {
        this(new Idea28219Config());
    }

    public Idea28219Service(Idea28219Config config) {
        this.config = config != null ? config : new Idea28219Config();
