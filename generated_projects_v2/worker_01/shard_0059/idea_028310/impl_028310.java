...
@Data
public class Idea28310Config {
    private String name = "idea_028310";
 ...
 */
@Slf4j
public class Idea28310Service {
    private static final int IDEA_ID = 28310;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28310Service() {
        this(new Idea28310Config());
    }

    public Idea28310Service(Idea28310Config config) {
        this.config = config != null ? config : new Idea28310Config();
