...
@Data
public class Idea28375Config {
    private String name = "idea_028375";
 ...
 */
@Slf4j
public class Idea28375Service {
    private static final int IDEA_ID = 28375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28375Service() {
        this(new Idea28375Config());
    }

    public Idea28375Service(Idea28375Config config) {
        this.config = config != null ? config : new Idea28375Config();
