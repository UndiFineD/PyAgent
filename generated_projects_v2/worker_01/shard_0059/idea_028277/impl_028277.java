...
@Data
public class Idea28277Config {
    private String name = "idea_028277";
 ...
 */
@Slf4j
public class Idea28277Service {
    private static final int IDEA_ID = 28277;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28277Service() {
        this(new Idea28277Config());
    }

    public Idea28277Service(Idea28277Config config) {
        this.config = config != null ? config : new Idea28277Config();
