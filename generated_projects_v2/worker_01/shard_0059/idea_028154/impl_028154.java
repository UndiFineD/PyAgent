...
@Data
public class Idea28154Config {
    private String name = "idea_028154";
 ...
 */
@Slf4j
public class Idea28154Service {
    private static final int IDEA_ID = 28154;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28154Service() {
        this(new Idea28154Config());
    }

    public Idea28154Service(Idea28154Config config) {
        this.config = config != null ? config : new Idea28154Config();
