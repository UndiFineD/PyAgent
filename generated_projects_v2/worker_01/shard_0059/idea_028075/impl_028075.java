...
@Data
public class Idea28075Config {
    private String name = "idea_028075";
 ...
 */
@Slf4j
public class Idea28075Service {
    private static final int IDEA_ID = 28075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28075Service() {
        this(new Idea28075Config());
    }

    public Idea28075Service(Idea28075Config config) {
        this.config = config != null ? config : new Idea28075Config();
