...
@Data
public class Idea28066Config {
    private String name = "idea_028066";
 ...
 */
@Slf4j
public class Idea28066Service {
    private static final int IDEA_ID = 28066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28066Service() {
        this(new Idea28066Config());
    }

    public Idea28066Service(Idea28066Config config) {
        this.config = config != null ? config : new Idea28066Config();
