...
@Data
public class Idea28374Config {
    private String name = "idea_028374";
 ...
 */
@Slf4j
public class Idea28374Service {
    private static final int IDEA_ID = 28374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28374Service() {
        this(new Idea28374Config());
    }

    public Idea28374Service(Idea28374Config config) {
        this.config = config != null ? config : new Idea28374Config();
