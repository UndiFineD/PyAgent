...
@Data
public class Idea28349Config {
    private String name = "idea_028349";
 ...
 */
@Slf4j
public class Idea28349Service {
    private static final int IDEA_ID = 28349;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28349Service() {
        this(new Idea28349Config());
    }

    public Idea28349Service(Idea28349Config config) {
        this.config = config != null ? config : new Idea28349Config();
