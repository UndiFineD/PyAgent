...
@Data
public class Idea28236Config {
    private String name = "idea_028236";
 ...
 */
@Slf4j
public class Idea28236Service {
    private static final int IDEA_ID = 28236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28236Service() {
        this(new Idea28236Config());
    }

    public Idea28236Service(Idea28236Config config) {
        this.config = config != null ? config : new Idea28236Config();
