...
@Data
public class Idea28119Config {
    private String name = "idea_028119";
 ...
 */
@Slf4j
public class Idea28119Service {
    private static final int IDEA_ID = 28119;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28119Service() {
        this(new Idea28119Config());
    }

    public Idea28119Service(Idea28119Config config) {
        this.config = config != null ? config : new Idea28119Config();
