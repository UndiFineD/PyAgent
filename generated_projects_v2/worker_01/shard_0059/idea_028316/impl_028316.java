...
@Data
public class Idea28316Config {
    private String name = "idea_028316";
 ...
 */
@Slf4j
public class Idea28316Service {
    private static final int IDEA_ID = 28316;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28316Service() {
        this(new Idea28316Config());
    }

    public Idea28316Service(Idea28316Config config) {
        this.config = config != null ? config : new Idea28316Config();
