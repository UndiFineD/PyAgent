...
@Data
public class Idea28220Config {
    private String name = "idea_028220";
 ...
 */
@Slf4j
public class Idea28220Service {
    private static final int IDEA_ID = 28220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28220Service() {
        this(new Idea28220Config());
    }

    public Idea28220Service(Idea28220Config config) {
        this.config = config != null ? config : new Idea28220Config();
