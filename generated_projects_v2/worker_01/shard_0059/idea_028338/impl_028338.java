...
@Data
public class Idea28338Config {
    private String name = "idea_028338";
 ...
 */
@Slf4j
public class Idea28338Service {
    private static final int IDEA_ID = 28338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28338Service() {
        this(new Idea28338Config());
    }

    public Idea28338Service(Idea28338Config config) {
        this.config = config != null ? config : new Idea28338Config();
