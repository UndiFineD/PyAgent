...
@Data
public class Idea28412Config {
    private String name = "idea_028412";
 ...
 */
@Slf4j
public class Idea28412Service {
    private static final int IDEA_ID = 28412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28412Service() {
        this(new Idea28412Config());
    }

    public Idea28412Service(Idea28412Config config) {
        this.config = config != null ? config : new Idea28412Config();
