...
@Data
public class Idea28184Config {
    private String name = "idea_028184";
 ...
 */
@Slf4j
public class Idea28184Service {
    private static final int IDEA_ID = 28184;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28184Service() {
        this(new Idea28184Config());
    }

    public Idea28184Service(Idea28184Config config) {
        this.config = config != null ? config : new Idea28184Config();
