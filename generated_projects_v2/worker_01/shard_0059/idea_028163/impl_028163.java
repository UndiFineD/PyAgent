...
@Data
public class Idea28163Config {
    private String name = "idea_028163";
 ...
 */
@Slf4j
public class Idea28163Service {
    private static final int IDEA_ID = 28163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28163Service() {
        this(new Idea28163Config());
    }

    public Idea28163Service(Idea28163Config config) {
        this.config = config != null ? config : new Idea28163Config();
