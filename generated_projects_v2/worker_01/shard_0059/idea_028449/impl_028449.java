...
@Data
public class Idea28449Config {
    private String name = "idea_028449";
 ...
 */
@Slf4j
public class Idea28449Service {
    private static final int IDEA_ID = 28449;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28449Service() {
        this(new Idea28449Config());
    }

    public Idea28449Service(Idea28449Config config) {
        this.config = config != null ? config : new Idea28449Config();
