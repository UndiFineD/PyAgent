...
@Data
public class Idea28267Config {
    private String name = "idea_028267";
 ...
 */
@Slf4j
public class Idea28267Service {
    private static final int IDEA_ID = 28267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28267Service() {
        this(new Idea28267Config());
    }

    public Idea28267Service(Idea28267Config config) {
        this.config = config != null ? config : new Idea28267Config();
