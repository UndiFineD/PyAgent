...
@Data
public class Idea28247Config {
    private String name = "idea_028247";
 ...
 */
@Slf4j
public class Idea28247Service {
    private static final int IDEA_ID = 28247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28247Service() {
        this(new Idea28247Config());
    }

    public Idea28247Service(Idea28247Config config) {
        this.config = config != null ? config : new Idea28247Config();
