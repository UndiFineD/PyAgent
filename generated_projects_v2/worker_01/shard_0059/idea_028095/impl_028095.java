...
@Data
public class Idea28095Config {
    private String name = "idea_028095";
 ...
 */
@Slf4j
public class Idea28095Service {
    private static final int IDEA_ID = 28095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28095Service() {
        this(new Idea28095Config());
    }

    public Idea28095Service(Idea28095Config config) {
        this.config = config != null ? config : new Idea28095Config();
