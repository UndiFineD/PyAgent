...
@Data
public class Idea28200Config {
    private String name = "idea_028200";
 ...
 */
@Slf4j
public class Idea28200Service {
    private static final int IDEA_ID = 28200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28200Service() {
        this(new Idea28200Config());
    }

    public Idea28200Service(Idea28200Config config) {
        this.config = config != null ? config : new Idea28200Config();
