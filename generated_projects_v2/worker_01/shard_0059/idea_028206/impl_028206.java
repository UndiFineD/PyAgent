...
@Data
public class Idea28206Config {
    private String name = "idea_028206";
 ...
 */
@Slf4j
public class Idea28206Service {
    private static final int IDEA_ID = 28206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28206Service() {
        this(new Idea28206Config());
    }

    public Idea28206Service(Idea28206Config config) {
        this.config = config != null ? config : new Idea28206Config();
