...
@Data
public class Idea28458Config {
    private String name = "idea_028458";
 ...
 */
@Slf4j
public class Idea28458Service {
    private static final int IDEA_ID = 28458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28458Service() {
        this(new Idea28458Config());
    }

    public Idea28458Service(Idea28458Config config) {
        this.config = config != null ? config : new Idea28458Config();
