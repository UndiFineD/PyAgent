...
@Data
public class Idea28025Config {
    private String name = "idea_028025";
 ...
 */
@Slf4j
public class Idea28025Service {
    private static final int IDEA_ID = 28025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28025Service() {
        this(new Idea28025Config());
    }

    public Idea28025Service(Idea28025Config config) {
        this.config = config != null ? config : new Idea28025Config();
