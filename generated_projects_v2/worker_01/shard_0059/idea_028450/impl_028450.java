...
@Data
public class Idea28450Config {
    private String name = "idea_028450";
 ...
 */
@Slf4j
public class Idea28450Service {
    private static final int IDEA_ID = 28450;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28450Service() {
        this(new Idea28450Config());
    }

    public Idea28450Service(Idea28450Config config) {
        this.config = config != null ? config : new Idea28450Config();
