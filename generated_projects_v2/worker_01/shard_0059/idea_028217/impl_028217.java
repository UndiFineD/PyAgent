...
@Data
public class Idea28217Config {
    private String name = "idea_028217";
 ...
 */
@Slf4j
public class Idea28217Service {
    private static final int IDEA_ID = 28217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28217Service() {
        this(new Idea28217Config());
    }

    public Idea28217Service(Idea28217Config config) {
        this.config = config != null ? config : new Idea28217Config();
