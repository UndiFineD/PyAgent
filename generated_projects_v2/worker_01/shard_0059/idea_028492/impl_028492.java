...
@Data
public class Idea28492Config {
    private String name = "idea_028492";
 ...
 */
@Slf4j
public class Idea28492Service {
    private static final int IDEA_ID = 28492;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28492Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28492Service() {
        this(new Idea28492Config());
    }

    public Idea28492Service(Idea28492Config config) {
        this.config = config != null ? config : new Idea28492Config();
