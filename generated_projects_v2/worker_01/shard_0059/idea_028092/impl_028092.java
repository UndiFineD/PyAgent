...
@Data
public class Idea28092Config {
    private String name = "idea_028092";
 ...
 */
@Slf4j
public class Idea28092Service {
    private static final int IDEA_ID = 28092;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28092Service() {
        this(new Idea28092Config());
    }

    public Idea28092Service(Idea28092Config config) {
        this.config = config != null ? config : new Idea28092Config();
