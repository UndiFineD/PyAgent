...
@Data
public class Idea28466Config {
    private String name = "idea_028466";
 ...
 */
@Slf4j
public class Idea28466Service {
    private static final int IDEA_ID = 28466;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28466Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28466Service() {
        this(new Idea28466Config());
    }

    public Idea28466Service(Idea28466Config config) {
        this.config = config != null ? config : new Idea28466Config();
