...
@Data
public class Idea28057Config {
    private String name = "idea_028057";
 ...
 */
@Slf4j
public class Idea28057Service {
    private static final int IDEA_ID = 28057;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28057Service() {
        this(new Idea28057Config());
    }

    public Idea28057Service(Idea28057Config config) {
        this.config = config != null ? config : new Idea28057Config();
