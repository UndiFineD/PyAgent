...
@Data
public class Idea28249Config {
    private String name = "idea_028249";
 ...
 */
@Slf4j
public class Idea28249Service {
    private static final int IDEA_ID = 28249;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28249Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28249Service() {
        this(new Idea28249Config());
    }

    public Idea28249Service(Idea28249Config config) {
        this.config = config != null ? config : new Idea28249Config();
