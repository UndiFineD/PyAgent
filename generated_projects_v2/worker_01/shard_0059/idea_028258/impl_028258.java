...
@Data
public class Idea28258Config {
    private String name = "idea_028258";
 ...
 */
@Slf4j
public class Idea28258Service {
    private static final int IDEA_ID = 28258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28258Service() {
        this(new Idea28258Config());
    }

    public Idea28258Service(Idea28258Config config) {
        this.config = config != null ? config : new Idea28258Config();
