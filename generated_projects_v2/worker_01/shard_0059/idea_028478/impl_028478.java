...
@Data
public class Idea28478Config {
    private String name = "idea_028478";
 ...
 */
@Slf4j
public class Idea28478Service {
    private static final int IDEA_ID = 28478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28478Service() {
        this(new Idea28478Config());
    }

    public Idea28478Service(Idea28478Config config) {
        this.config = config != null ? config : new Idea28478Config();
