...
@Data
public class Idea28477Config {
    private String name = "idea_028477";
 ...
 */
@Slf4j
public class Idea28477Service {
    private static final int IDEA_ID = 28477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28477Service() {
        this(new Idea28477Config());
    }

    public Idea28477Service(Idea28477Config config) {
        this.config = config != null ? config : new Idea28477Config();
