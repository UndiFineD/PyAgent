...
@Data
public class Idea28397Config {
    private String name = "idea_028397";
 ...
 */
@Slf4j
public class Idea28397Service {
    private static final int IDEA_ID = 28397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28397Service() {
        this(new Idea28397Config());
    }

    public Idea28397Service(Idea28397Config config) {
        this.config = config != null ? config : new Idea28397Config();
