...
@Data
public class Idea28136Config {
    private String name = "idea_028136";
 ...
 */
@Slf4j
public class Idea28136Service {
    private static final int IDEA_ID = 28136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28136Service() {
        this(new Idea28136Config());
    }

    public Idea28136Service(Idea28136Config config) {
        this.config = config != null ? config : new Idea28136Config();
