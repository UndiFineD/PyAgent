...
@Data
public class Idea28118Config {
    private String name = "idea_028118";
 ...
 */
@Slf4j
public class Idea28118Service {
    private static final int IDEA_ID = 28118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28118Service() {
        this(new Idea28118Config());
    }

    public Idea28118Service(Idea28118Config config) {
        this.config = config != null ? config : new Idea28118Config();
