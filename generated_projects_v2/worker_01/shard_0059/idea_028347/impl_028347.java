...
@Data
public class Idea28347Config {
    private String name = "idea_028347";
 ...
 */
@Slf4j
public class Idea28347Service {
    private static final int IDEA_ID = 28347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28347Service() {
        this(new Idea28347Config());
    }

    public Idea28347Service(Idea28347Config config) {
        this.config = config != null ? config : new Idea28347Config();
