...
@Data
public class Idea28043Config {
    private String name = "idea_028043";
 ...
 */
@Slf4j
public class Idea28043Service {
    private static final int IDEA_ID = 28043;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28043Service() {
        this(new Idea28043Config());
    }

    public Idea28043Service(Idea28043Config config) {
        this.config = config != null ? config : new Idea28043Config();
