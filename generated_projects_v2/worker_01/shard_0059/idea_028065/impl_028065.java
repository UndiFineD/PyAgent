...
@Data
public class Idea28065Config {
    private String name = "idea_028065";
 ...
 */
@Slf4j
public class Idea28065Service {
    private static final int IDEA_ID = 28065;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28065Service() {
        this(new Idea28065Config());
    }

    public Idea28065Service(Idea28065Config config) {
        this.config = config != null ? config : new Idea28065Config();
