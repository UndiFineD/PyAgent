...
@Data
public class Idea28429Config {
    private String name = "idea_028429";
 ...
 */
@Slf4j
public class Idea28429Service {
    private static final int IDEA_ID = 28429;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28429Service() {
        this(new Idea28429Config());
    }

    public Idea28429Service(Idea28429Config config) {
        this.config = config != null ? config : new Idea28429Config();
