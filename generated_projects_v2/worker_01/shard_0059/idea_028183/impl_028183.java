...
@Data
public class Idea28183Config {
    private String name = "idea_028183";
 ...
 */
@Slf4j
public class Idea28183Service {
    private static final int IDEA_ID = 28183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28183Service() {
        this(new Idea28183Config());
    }

    public Idea28183Service(Idea28183Config config) {
        this.config = config != null ? config : new Idea28183Config();
