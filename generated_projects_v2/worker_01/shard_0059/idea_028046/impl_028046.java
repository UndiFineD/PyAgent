...
@Data
public class Idea28046Config {
    private String name = "idea_028046";
 ...
 */
@Slf4j
public class Idea28046Service {
    private static final int IDEA_ID = 28046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28046Service() {
        this(new Idea28046Config());
    }

    public Idea28046Service(Idea28046Config config) {
        this.config = config != null ? config : new Idea28046Config();
