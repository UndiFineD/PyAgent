...
@Data
public class Idea28042Config {
    private String name = "idea_028042";
 ...
 */
@Slf4j
public class Idea28042Service {
    private static final int IDEA_ID = 28042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28042Service() {
        this(new Idea28042Config());
    }

    public Idea28042Service(Idea28042Config config) {
        this.config = config != null ? config : new Idea28042Config();
