...
@Data
public class Idea28246Config {
    private String name = "idea_028246";
 ...
 */
@Slf4j
public class Idea28246Service {
    private static final int IDEA_ID = 28246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28246Service() {
        this(new Idea28246Config());
    }

    public Idea28246Service(Idea28246Config config) {
        this.config = config != null ? config : new Idea28246Config();
