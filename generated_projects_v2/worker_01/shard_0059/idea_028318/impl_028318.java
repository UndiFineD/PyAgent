...
@Data
public class Idea28318Config {
    private String name = "idea_028318";
 ...
 */
@Slf4j
public class Idea28318Service {
    private static final int IDEA_ID = 28318;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28318Service() {
        this(new Idea28318Config());
    }

    public Idea28318Service(Idea28318Config config) {
        this.config = config != null ? config : new Idea28318Config();
