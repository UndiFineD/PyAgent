...
@Data
public class Idea28205Config {
    private String name = "idea_028205";
 ...
 */
@Slf4j
public class Idea28205Service {
    private static final int IDEA_ID = 28205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28205Service() {
        this(new Idea28205Config());
    }

    public Idea28205Service(Idea28205Config config) {
        this.config = config != null ? config : new Idea28205Config();
