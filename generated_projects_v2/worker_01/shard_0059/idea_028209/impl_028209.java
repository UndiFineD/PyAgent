...
@Data
public class Idea28209Config {
    private String name = "idea_028209";
 ...
 */
@Slf4j
public class Idea28209Service {
    private static final int IDEA_ID = 28209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28209Service() {
        this(new Idea28209Config());
    }

    public Idea28209Service(Idea28209Config config) {
        this.config = config != null ? config : new Idea28209Config();
