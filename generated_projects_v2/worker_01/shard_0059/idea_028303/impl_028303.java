...
@Data
public class Idea28303Config {
    private String name = "idea_028303";
 ...
 */
@Slf4j
public class Idea28303Service {
    private static final int IDEA_ID = 28303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28303Service() {
        this(new Idea28303Config());
    }

    public Idea28303Service(Idea28303Config config) {
        this.config = config != null ? config : new Idea28303Config();
