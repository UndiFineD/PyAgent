...
@Data
public class Idea28487Config {
    private String name = "idea_028487";
 ...
 */
@Slf4j
public class Idea28487Service {
    private static final int IDEA_ID = 28487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28487Service() {
        this(new Idea28487Config());
    }

    public Idea28487Service(Idea28487Config config) {
        this.config = config != null ? config : new Idea28487Config();
