...
@Data
public class Idea28365Config {
    private String name = "idea_028365";
 ...
 */
@Slf4j
public class Idea28365Service {
    private static final int IDEA_ID = 28365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28365Service() {
        this(new Idea28365Config());
    }

    public Idea28365Service(Idea28365Config config) {
        this.config = config != null ? config : new Idea28365Config();
