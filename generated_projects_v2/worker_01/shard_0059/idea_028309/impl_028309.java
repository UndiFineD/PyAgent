...
@Data
public class Idea28309Config {
    private String name = "idea_028309";
 ...
 */
@Slf4j
public class Idea28309Service {
    private static final int IDEA_ID = 28309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28309Service() {
        this(new Idea28309Config());
    }

    public Idea28309Service(Idea28309Config config) {
        this.config = config != null ? config : new Idea28309Config();
