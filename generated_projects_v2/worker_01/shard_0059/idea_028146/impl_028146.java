...
@Data
public class Idea28146Config {
    private String name = "idea_028146";
 ...
 */
@Slf4j
public class Idea28146Service {
    private static final int IDEA_ID = 28146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28146Service() {
        this(new Idea28146Config());
    }

    public Idea28146Service(Idea28146Config config) {
        this.config = config != null ? config : new Idea28146Config();
