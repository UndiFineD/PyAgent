...
@Data
public class Idea28153Config {
    private String name = "idea_028153";
 ...
 */
@Slf4j
public class Idea28153Service {
    private static final int IDEA_ID = 28153;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28153Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28153Service() {
        this(new Idea28153Config());
    }

    public Idea28153Service(Idea28153Config config) {
        this.config = config != null ? config : new Idea28153Config();
