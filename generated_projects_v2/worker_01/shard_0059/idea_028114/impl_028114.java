...
@Data
public class Idea28114Config {
    private String name = "idea_028114";
 ...
 */
@Slf4j
public class Idea28114Service {
    private static final int IDEA_ID = 28114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28114Service() {
        this(new Idea28114Config());
    }

    public Idea28114Service(Idea28114Config config) {
        this.config = config != null ? config : new Idea28114Config();
