...
@Data
public class Idea28202Config {
    private String name = "idea_028202";
 ...
 */
@Slf4j
public class Idea28202Service {
    private static final int IDEA_ID = 28202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28202Service() {
        this(new Idea28202Config());
    }

    public Idea28202Service(Idea28202Config config) {
        this.config = config != null ? config : new Idea28202Config();
