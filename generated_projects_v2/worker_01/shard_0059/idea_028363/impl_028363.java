...
@Data
public class Idea28363Config {
    private String name = "idea_028363";
 ...
 */
@Slf4j
public class Idea28363Service {
    private static final int IDEA_ID = 28363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28363Service() {
        this(new Idea28363Config());
    }

    public Idea28363Service(Idea28363Config config) {
        this.config = config != null ? config : new Idea28363Config();
