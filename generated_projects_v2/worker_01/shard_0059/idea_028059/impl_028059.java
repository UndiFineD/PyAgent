...
@Data
public class Idea28059Config {
    private String name = "idea_028059";
 ...
 */
@Slf4j
public class Idea28059Service {
    private static final int IDEA_ID = 28059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28059Service() {
        this(new Idea28059Config());
    }

    public Idea28059Service(Idea28059Config config) {
        this.config = config != null ? config : new Idea28059Config();
