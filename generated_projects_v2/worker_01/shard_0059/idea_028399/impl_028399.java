...
@Data
public class Idea28399Config {
    private String name = "idea_028399";
 ...
 */
@Slf4j
public class Idea28399Service {
    private static final int IDEA_ID = 28399;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28399Service() {
        this(new Idea28399Config());
    }

    public Idea28399Service(Idea28399Config config) {
        this.config = config != null ? config : new Idea28399Config();
