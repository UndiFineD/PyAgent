...
@Data
public class Idea28455Config {
    private String name = "idea_028455";
 ...
 */
@Slf4j
public class Idea28455Service {
    private static final int IDEA_ID = 28455;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28455Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28455Service() {
        this(new Idea28455Config());
    }

    public Idea28455Service(Idea28455Config config) {
        this.config = config != null ? config : new Idea28455Config();
