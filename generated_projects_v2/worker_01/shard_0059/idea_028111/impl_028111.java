...
@Data
public class Idea28111Config {
    private String name = "idea_028111";
 ...
 */
@Slf4j
public class Idea28111Service {
    private static final int IDEA_ID = 28111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28111Service() {
        this(new Idea28111Config());
    }

    public Idea28111Service(Idea28111Config config) {
        this.config = config != null ? config : new Idea28111Config();
