...
@Data
public class Idea28408Config {
    private String name = "idea_028408";
 ...
 */
@Slf4j
public class Idea28408Service {
    private static final int IDEA_ID = 28408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28408Service() {
        this(new Idea28408Config());
    }

    public Idea28408Service(Idea28408Config config) {
        this.config = config != null ? config : new Idea28408Config();
