...
@Data
public class Idea28120Config {
    private String name = "idea_028120";
 ...
 */
@Slf4j
public class Idea28120Service {
    private static final int IDEA_ID = 28120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28120Service() {
        this(new Idea28120Config());
    }

    public Idea28120Service(Idea28120Config config) {
        this.config = config != null ? config : new Idea28120Config();
