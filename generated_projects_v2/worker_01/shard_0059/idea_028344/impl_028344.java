...
@Data
public class Idea28344Config {
    private String name = "idea_028344";
 ...
 */
@Slf4j
public class Idea28344Service {
    private static final int IDEA_ID = 28344;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28344Service() {
        this(new Idea28344Config());
    }

    public Idea28344Service(Idea28344Config config) {
        this.config = config != null ? config : new Idea28344Config();
