...
@Data
public class Idea28134Config {
    private String name = "idea_028134";
 ...
 */
@Slf4j
public class Idea28134Service {
    private static final int IDEA_ID = 28134;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28134Service() {
        this(new Idea28134Config());
    }

    public Idea28134Service(Idea28134Config config) {
        this.config = config != null ? config : new Idea28134Config();
