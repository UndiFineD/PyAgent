...
@Data
public class Idea28479Config {
    private String name = "idea_028479";
 ...
 */
@Slf4j
public class Idea28479Service {
    private static final int IDEA_ID = 28479;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28479Service() {
        this(new Idea28479Config());
    }

    public Idea28479Service(Idea28479Config config) {
        this.config = config != null ? config : new Idea28479Config();
