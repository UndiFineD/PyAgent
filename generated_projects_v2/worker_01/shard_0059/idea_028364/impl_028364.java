...
@Data
public class Idea28364Config {
    private String name = "idea_028364";
 ...
 */
@Slf4j
public class Idea28364Service {
    private static final int IDEA_ID = 28364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28364Service() {
        this(new Idea28364Config());
    }

    public Idea28364Service(Idea28364Config config) {
        this.config = config != null ? config : new Idea28364Config();
