...
@Data
public class Idea28307Config {
    private String name = "idea_028307";
 ...
 */
@Slf4j
public class Idea28307Service {
    private static final int IDEA_ID = 28307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28307Service() {
        this(new Idea28307Config());
    }

    public Idea28307Service(Idea28307Config config) {
        this.config = config != null ? config : new Idea28307Config();
