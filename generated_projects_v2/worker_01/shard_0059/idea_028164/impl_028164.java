...
@Data
public class Idea28164Config {
    private String name = "idea_028164";
 ...
 */
@Slf4j
public class Idea28164Service {
    private static final int IDEA_ID = 28164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28164Service() {
        this(new Idea28164Config());
    }

    public Idea28164Service(Idea28164Config config) {
        this.config = config != null ? config : new Idea28164Config();
