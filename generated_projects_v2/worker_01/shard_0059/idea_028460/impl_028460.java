...
@Data
public class Idea28460Config {
    private String name = "idea_028460";
 ...
 */
@Slf4j
public class Idea28460Service {
    private static final int IDEA_ID = 28460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28460Service() {
        this(new Idea28460Config());
    }

    public Idea28460Service(Idea28460Config config) {
        this.config = config != null ? config : new Idea28460Config();
