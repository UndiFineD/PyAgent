...
@Data
public class Idea28128Config {
    private String name = "idea_028128";
 ...
 */
@Slf4j
public class Idea28128Service {
    private static final int IDEA_ID = 28128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28128Service() {
        this(new Idea28128Config());
    }

    public Idea28128Service(Idea28128Config config) {
        this.config = config != null ? config : new Idea28128Config();
