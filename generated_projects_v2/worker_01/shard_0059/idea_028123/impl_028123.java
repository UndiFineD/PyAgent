...
@Data
public class Idea28123Config {
    private String name = "idea_028123";
 ...
 */
@Slf4j
public class Idea28123Service {
    private static final int IDEA_ID = 28123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28123Service() {
        this(new Idea28123Config());
    }

    public Idea28123Service(Idea28123Config config) {
        this.config = config != null ? config : new Idea28123Config();
