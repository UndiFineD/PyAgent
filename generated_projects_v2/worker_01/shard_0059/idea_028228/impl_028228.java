...
@Data
public class Idea28228Config {
    private String name = "idea_028228";
 ...
 */
@Slf4j
public class Idea28228Service {
    private static final int IDEA_ID = 28228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28228Service() {
        this(new Idea28228Config());
    }

    public Idea28228Service(Idea28228Config config) {
        this.config = config != null ? config : new Idea28228Config();
