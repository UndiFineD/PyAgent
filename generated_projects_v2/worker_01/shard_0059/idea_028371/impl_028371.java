...
@Data
public class Idea28371Config {
    private String name = "idea_028371";
 ...
 */
@Slf4j
public class Idea28371Service {
    private static final int IDEA_ID = 28371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28371Service() {
        this(new Idea28371Config());
    }

    public Idea28371Service(Idea28371Config config) {
        this.config = config != null ? config : new Idea28371Config();
