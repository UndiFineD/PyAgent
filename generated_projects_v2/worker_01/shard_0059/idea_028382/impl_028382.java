...
@Data
public class Idea28382Config {
    private String name = "idea_028382";
 ...
 */
@Slf4j
public class Idea28382Service {
    private static final int IDEA_ID = 28382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28382Service() {
        this(new Idea28382Config());
    }

    public Idea28382Service(Idea28382Config config) {
        this.config = config != null ? config : new Idea28382Config();
