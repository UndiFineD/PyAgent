...
@Data
public class Idea28061Config {
    private String name = "idea_028061";
 ...
 */
@Slf4j
public class Idea28061Service {
    private static final int IDEA_ID = 28061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28061Service() {
        this(new Idea28061Config());
    }

    public Idea28061Service(Idea28061Config config) {
        this.config = config != null ? config : new Idea28061Config();
