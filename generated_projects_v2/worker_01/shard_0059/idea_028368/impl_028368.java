...
@Data
public class Idea28368Config {
    private String name = "idea_028368";
 ...
 */
@Slf4j
public class Idea28368Service {
    private static final int IDEA_ID = 28368;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28368Service() {
        this(new Idea28368Config());
    }

    public Idea28368Service(Idea28368Config config) {
        this.config = config != null ? config : new Idea28368Config();
