...
@Data
public class Idea28237Config {
    private String name = "idea_028237";
 ...
 */
@Slf4j
public class Idea28237Service {
    private static final int IDEA_ID = 28237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28237Service() {
        this(new Idea28237Config());
    }

    public Idea28237Service(Idea28237Config config) {
        this.config = config != null ? config : new Idea28237Config();
