...
@Data
public class Idea28176Config {
    private String name = "idea_028176";
 ...
 */
@Slf4j
public class Idea28176Service {
    private static final int IDEA_ID = 28176;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28176Service() {
        this(new Idea28176Config());
    }

    public Idea28176Service(Idea28176Config config) {
        this.config = config != null ? config : new Idea28176Config();
