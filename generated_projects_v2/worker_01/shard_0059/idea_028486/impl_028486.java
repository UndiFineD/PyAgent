...
@Data
public class Idea28486Config {
    private String name = "idea_028486";
 ...
 */
@Slf4j
public class Idea28486Service {
    private static final int IDEA_ID = 28486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28486Service() {
        this(new Idea28486Config());
    }

    public Idea28486Service(Idea28486Config config) {
        this.config = config != null ? config : new Idea28486Config();
