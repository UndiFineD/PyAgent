...
@Data
public class Idea28067Config {
    private String name = "idea_028067";
 ...
 */
@Slf4j
public class Idea28067Service {
    private static final int IDEA_ID = 28067;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28067Service() {
        this(new Idea28067Config());
    }

    public Idea28067Service(Idea28067Config config) {
        this.config = config != null ? config : new Idea28067Config();
