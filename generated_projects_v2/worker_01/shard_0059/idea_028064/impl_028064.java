...
@Data
public class Idea28064Config {
    private String name = "idea_028064";
 ...
 */
@Slf4j
public class Idea28064Service {
    private static final int IDEA_ID = 28064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28064Service() {
        this(new Idea28064Config());
    }

    public Idea28064Service(Idea28064Config config) {
        this.config = config != null ? config : new Idea28064Config();
