...
@Data
public class Idea28122Config {
    private String name = "idea_028122";
 ...
 */
@Slf4j
public class Idea28122Service {
    private static final int IDEA_ID = 28122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28122Service() {
        this(new Idea28122Config());
    }

    public Idea28122Service(Idea28122Config config) {
        this.config = config != null ? config : new Idea28122Config();
