...
@Data
public class Idea28366Config {
    private String name = "idea_028366";
 ...
 */
@Slf4j
public class Idea28366Service {
    private static final int IDEA_ID = 28366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28366Service() {
        this(new Idea28366Config());
    }

    public Idea28366Service(Idea28366Config config) {
        this.config = config != null ? config : new Idea28366Config();
