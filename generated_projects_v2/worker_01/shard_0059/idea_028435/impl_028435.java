...
@Data
public class Idea28435Config {
    private String name = "idea_028435";
 ...
 */
@Slf4j
public class Idea28435Service {
    private static final int IDEA_ID = 28435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28435Service() {
        this(new Idea28435Config());
    }

    public Idea28435Service(Idea28435Config config) {
        this.config = config != null ? config : new Idea28435Config();
