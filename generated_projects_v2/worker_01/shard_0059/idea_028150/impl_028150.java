...
@Data
public class Idea28150Config {
    private String name = "idea_028150";
 ...
 */
@Slf4j
public class Idea28150Service {
    private static final int IDEA_ID = 28150;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28150Service() {
        this(new Idea28150Config());
    }

    public Idea28150Service(Idea28150Config config) {
        this.config = config != null ? config : new Idea28150Config();
