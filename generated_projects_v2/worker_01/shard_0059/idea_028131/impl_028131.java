...
@Data
public class Idea28131Config {
    private String name = "idea_028131";
 ...
 */
@Slf4j
public class Idea28131Service {
    private static final int IDEA_ID = 28131;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28131Service() {
        this(new Idea28131Config());
    }

    public Idea28131Service(Idea28131Config config) {
        this.config = config != null ? config : new Idea28131Config();
