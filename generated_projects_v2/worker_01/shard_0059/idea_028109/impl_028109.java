...
@Data
public class Idea28109Config {
    private String name = "idea_028109";
 ...
 */
@Slf4j
public class Idea28109Service {
    private static final int IDEA_ID = 28109;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28109Service() {
        this(new Idea28109Config());
    }

    public Idea28109Service(Idea28109Config config) {
        this.config = config != null ? config : new Idea28109Config();
