...
@Data
public class Idea28115Config {
    private String name = "idea_028115";
 ...
 */
@Slf4j
public class Idea28115Service {
    private static final int IDEA_ID = 28115;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28115Service() {
        this(new Idea28115Config());
    }

    public Idea28115Service(Idea28115Config config) {
        this.config = config != null ? config : new Idea28115Config();
