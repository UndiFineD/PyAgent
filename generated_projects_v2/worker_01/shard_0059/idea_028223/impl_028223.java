...
@Data
public class Idea28223Config {
    private String name = "idea_028223";
 ...
 */
@Slf4j
public class Idea28223Service {
    private static final int IDEA_ID = 28223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28223Service() {
        this(new Idea28223Config());
    }

    public Idea28223Service(Idea28223Config config) {
        this.config = config != null ? config : new Idea28223Config();
