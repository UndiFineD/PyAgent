...
@Data
public class Idea28370Config {
    private String name = "idea_028370";
 ...
 */
@Slf4j
public class Idea28370Service {
    private static final int IDEA_ID = 28370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28370Service() {
        this(new Idea28370Config());
    }

    public Idea28370Service(Idea28370Config config) {
        this.config = config != null ? config : new Idea28370Config();
