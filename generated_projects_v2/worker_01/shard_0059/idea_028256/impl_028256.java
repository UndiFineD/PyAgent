...
@Data
public class Idea28256Config {
    private String name = "idea_028256";
 ...
 */
@Slf4j
public class Idea28256Service {
    private static final int IDEA_ID = 28256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28256Service() {
        this(new Idea28256Config());
    }

    public Idea28256Service(Idea28256Config config) {
        this.config = config != null ? config : new Idea28256Config();
