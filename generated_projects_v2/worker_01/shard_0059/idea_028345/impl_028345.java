...
@Data
public class Idea28345Config {
    private String name = "idea_028345";
 ...
 */
@Slf4j
public class Idea28345Service {
    private static final int IDEA_ID = 28345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28345Service() {
        this(new Idea28345Config());
    }

    public Idea28345Service(Idea28345Config config) {
        this.config = config != null ? config : new Idea28345Config();
