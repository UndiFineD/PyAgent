...
@Data
public class Idea28369Config {
    private String name = "idea_028369";
 ...
 */
@Slf4j
public class Idea28369Service {
    private static final int IDEA_ID = 28369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28369Service() {
        this(new Idea28369Config());
    }

    public Idea28369Service(Idea28369Config config) {
        this.config = config != null ? config : new Idea28369Config();
