...
@Data
public class Idea28403Config {
    private String name = "idea_028403";
 ...
 */
@Slf4j
public class Idea28403Service {
    private static final int IDEA_ID = 28403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28403Service() {
        this(new Idea28403Config());
    }

    public Idea28403Service(Idea28403Config config) {
        this.config = config != null ? config : new Idea28403Config();
