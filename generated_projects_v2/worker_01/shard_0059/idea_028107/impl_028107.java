...
@Data
public class Idea28107Config {
    private String name = "idea_028107";
 ...
 */
@Slf4j
public class Idea28107Service {
    private static final int IDEA_ID = 28107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28107Service() {
        this(new Idea28107Config());
    }

    public Idea28107Service(Idea28107Config config) {
        this.config = config != null ? config : new Idea28107Config();
