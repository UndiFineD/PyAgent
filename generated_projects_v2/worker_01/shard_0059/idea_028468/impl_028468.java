...
@Data
public class Idea28468Config {
    private String name = "idea_028468";
 ...
 */
@Slf4j
public class Idea28468Service {
    private static final int IDEA_ID = 28468;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28468Service() {
        this(new Idea28468Config());
    }

    public Idea28468Service(Idea28468Config config) {
        this.config = config != null ? config : new Idea28468Config();
