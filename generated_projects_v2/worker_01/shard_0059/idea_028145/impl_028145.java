...
@Data
public class Idea28145Config {
    private String name = "idea_028145";
 ...
 */
@Slf4j
public class Idea28145Service {
    private static final int IDEA_ID = 28145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28145Service() {
        this(new Idea28145Config());
    }

    public Idea28145Service(Idea28145Config config) {
        this.config = config != null ? config : new Idea28145Config();
