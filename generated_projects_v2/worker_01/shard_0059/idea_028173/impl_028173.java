...
@Data
public class Idea28173Config {
    private String name = "idea_028173";
 ...
 */
@Slf4j
public class Idea28173Service {
    private static final int IDEA_ID = 28173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28173Service() {
        this(new Idea28173Config());
    }

    public Idea28173Service(Idea28173Config config) {
        this.config = config != null ? config : new Idea28173Config();
