...
@Data
public class Idea28103Config {
    private String name = "idea_028103";
 ...
 */
@Slf4j
public class Idea28103Service {
    private static final int IDEA_ID = 28103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28103Service() {
        this(new Idea28103Config());
    }

    public Idea28103Service(Idea28103Config config) {
        this.config = config != null ? config : new Idea28103Config();
