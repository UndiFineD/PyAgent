...
@Data
public class Idea28132Config {
    private String name = "idea_028132";
 ...
 */
@Slf4j
public class Idea28132Service {
    private static final int IDEA_ID = 28132;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28132Service() {
        this(new Idea28132Config());
    }

    public Idea28132Service(Idea28132Config config) {
        this.config = config != null ? config : new Idea28132Config();
