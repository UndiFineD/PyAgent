...
@Data
public class Idea28034Config {
    private String name = "idea_028034";
 ...
 */
@Slf4j
public class Idea28034Service {
    private static final int IDEA_ID = 28034;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28034Service() {
        this(new Idea28034Config());
    }

    public Idea28034Service(Idea28034Config config) {
        this.config = config != null ? config : new Idea28034Config();
