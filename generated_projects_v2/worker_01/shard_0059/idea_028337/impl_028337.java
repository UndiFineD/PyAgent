...
@Data
public class Idea28337Config {
    private String name = "idea_028337";
 ...
 */
@Slf4j
public class Idea28337Service {
    private static final int IDEA_ID = 28337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28337Service() {
        this(new Idea28337Config());
    }

    public Idea28337Service(Idea28337Config config) {
        this.config = config != null ? config : new Idea28337Config();
