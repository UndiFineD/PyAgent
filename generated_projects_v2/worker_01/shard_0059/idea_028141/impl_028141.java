...
@Data
public class Idea28141Config {
    private String name = "idea_028141";
 ...
 */
@Slf4j
public class Idea28141Service {
    private static final int IDEA_ID = 28141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28141Service() {
        this(new Idea28141Config());
    }

    public Idea28141Service(Idea28141Config config) {
        this.config = config != null ? config : new Idea28141Config();
