...
@Data
public class Idea28464Config {
    private String name = "idea_028464";
 ...
 */
@Slf4j
public class Idea28464Service {
    private static final int IDEA_ID = 28464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28464Service() {
        this(new Idea28464Config());
    }

    public Idea28464Service(Idea28464Config config) {
        this.config = config != null ? config : new Idea28464Config();
