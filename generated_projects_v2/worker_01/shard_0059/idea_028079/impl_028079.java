...
@Data
public class Idea28079Config {
    private String name = "idea_028079";
 ...
 */
@Slf4j
public class Idea28079Service {
    private static final int IDEA_ID = 28079;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28079Service() {
        this(new Idea28079Config());
    }

    public Idea28079Service(Idea28079Config config) {
        this.config = config != null ? config : new Idea28079Config();
