...
@Data
public class Idea28175Config {
    private String name = "idea_028175";
 ...
 */
@Slf4j
public class Idea28175Service {
    private static final int IDEA_ID = 28175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28175Service() {
        this(new Idea28175Config());
    }

    public Idea28175Service(Idea28175Config config) {
        this.config = config != null ? config : new Idea28175Config();
