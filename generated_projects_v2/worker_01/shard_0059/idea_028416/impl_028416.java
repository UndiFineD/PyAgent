...
@Data
public class Idea28416Config {
    private String name = "idea_028416";
 ...
 */
@Slf4j
public class Idea28416Service {
    private static final int IDEA_ID = 28416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28416Service() {
        this(new Idea28416Config());
    }

    public Idea28416Service(Idea28416Config config) {
        this.config = config != null ? config : new Idea28416Config();
