...
@Data
public class Idea28262Config {
    private String name = "idea_028262";
 ...
 */
@Slf4j
public class Idea28262Service {
    private static final int IDEA_ID = 28262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28262Service() {
        this(new Idea28262Config());
    }

    public Idea28262Service(Idea28262Config config) {
        this.config = config != null ? config : new Idea28262Config();
