...
@Data
public class Idea28078Config {
    private String name = "idea_028078";
 ...
 */
@Slf4j
public class Idea28078Service {
    private static final int IDEA_ID = 28078;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28078Service() {
        this(new Idea28078Config());
    }

    public Idea28078Service(Idea28078Config config) {
        this.config = config != null ? config : new Idea28078Config();
