...
@Data
public class Idea28190Config {
    private String name = "idea_028190";
 ...
 */
@Slf4j
public class Idea28190Service {
    private static final int IDEA_ID = 28190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28190Service() {
        this(new Idea28190Config());
    }

    public Idea28190Service(Idea28190Config config) {
        this.config = config != null ? config : new Idea28190Config();
