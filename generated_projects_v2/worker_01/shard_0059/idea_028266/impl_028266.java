...
@Data
public class Idea28266Config {
    private String name = "idea_028266";
 ...
 */
@Slf4j
public class Idea28266Service {
    private static final int IDEA_ID = 28266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28266Service() {
        this(new Idea28266Config());
    }

    public Idea28266Service(Idea28266Config config) {
        this.config = config != null ? config : new Idea28266Config();
