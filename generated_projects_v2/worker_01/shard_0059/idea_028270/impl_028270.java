...
@Data
public class Idea28270Config {
    private String name = "idea_028270";
 ...
 */
@Slf4j
public class Idea28270Service {
    private static final int IDEA_ID = 28270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28270Service() {
        this(new Idea28270Config());
    }

    public Idea28270Service(Idea28270Config config) {
        this.config = config != null ? config : new Idea28270Config();
