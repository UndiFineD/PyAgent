...
@Data
public class Idea28230Config {
    private String name = "idea_028230";
 ...
 */
@Slf4j
public class Idea28230Service {
    private static final int IDEA_ID = 28230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28230Service() {
        this(new Idea28230Config());
    }

    public Idea28230Service(Idea28230Config config) {
        this.config = config != null ? config : new Idea28230Config();
