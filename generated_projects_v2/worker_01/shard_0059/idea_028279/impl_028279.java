...
@Data
public class Idea28279Config {
    private String name = "idea_028279";
 ...
 */
@Slf4j
public class Idea28279Service {
    private static final int IDEA_ID = 28279;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28279Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28279Service() {
        this(new Idea28279Config());
    }

    public Idea28279Service(Idea28279Config config) {
        this.config = config != null ? config : new Idea28279Config();
