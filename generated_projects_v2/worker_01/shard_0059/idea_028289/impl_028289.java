...
@Data
public class Idea28289Config {
    private String name = "idea_028289";
 ...
 */
@Slf4j
public class Idea28289Service {
    private static final int IDEA_ID = 28289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28289Service() {
        this(new Idea28289Config());
    }

    public Idea28289Service(Idea28289Config config) {
        this.config = config != null ? config : new Idea28289Config();
