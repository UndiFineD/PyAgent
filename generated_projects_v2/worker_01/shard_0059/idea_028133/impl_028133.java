...
@Data
public class Idea28133Config {
    private String name = "idea_028133";
 ...
 */
@Slf4j
public class Idea28133Service {
    private static final int IDEA_ID = 28133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28133Service() {
        this(new Idea28133Config());
    }

    public Idea28133Service(Idea28133Config config) {
        this.config = config != null ? config : new Idea28133Config();
