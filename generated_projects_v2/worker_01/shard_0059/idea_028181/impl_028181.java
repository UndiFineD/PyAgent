...
@Data
public class Idea28181Config {
    private String name = "idea_028181";
 ...
 */
@Slf4j
public class Idea28181Service {
    private static final int IDEA_ID = 28181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28181Service() {
        this(new Idea28181Config());
    }

    public Idea28181Service(Idea28181Config config) {
        this.config = config != null ? config : new Idea28181Config();
