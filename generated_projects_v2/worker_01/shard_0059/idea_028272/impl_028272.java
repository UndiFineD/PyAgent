...
@Data
public class Idea28272Config {
    private String name = "idea_028272";
 ...
 */
@Slf4j
public class Idea28272Service {
    private static final int IDEA_ID = 28272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28272Service() {
        this(new Idea28272Config());
    }

    public Idea28272Service(Idea28272Config config) {
        this.config = config != null ? config : new Idea28272Config();
