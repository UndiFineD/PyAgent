...
@Data
public class Idea28070Config {
    private String name = "idea_028070";
 ...
 */
@Slf4j
public class Idea28070Service {
    private static final int IDEA_ID = 28070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28070Service() {
        this(new Idea28070Config());
    }

    public Idea28070Service(Idea28070Config config) {
        this.config = config != null ? config : new Idea28070Config();
