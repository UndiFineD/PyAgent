...
@Data
public class Idea28130Config {
    private String name = "idea_028130";
 ...
 */
@Slf4j
public class Idea28130Service {
    private static final int IDEA_ID = 28130;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28130Service() {
        this(new Idea28130Config());
    }

    public Idea28130Service(Idea28130Config config) {
        this.config = config != null ? config : new Idea28130Config();
