...
@Data
public class Idea28073Config {
    private String name = "idea_028073";
 ...
 */
@Slf4j
public class Idea28073Service {
    private static final int IDEA_ID = 28073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28073Service() {
        this(new Idea28073Config());
    }

    public Idea28073Service(Idea28073Config config) {
        this.config = config != null ? config : new Idea28073Config();
