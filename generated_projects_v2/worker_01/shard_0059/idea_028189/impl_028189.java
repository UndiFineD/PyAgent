...
@Data
public class Idea28189Config {
    private String name = "idea_028189";
 ...
 */
@Slf4j
public class Idea28189Service {
    private static final int IDEA_ID = 28189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28189Service() {
        this(new Idea28189Config());
    }

    public Idea28189Service(Idea28189Config config) {
        this.config = config != null ? config : new Idea28189Config();
