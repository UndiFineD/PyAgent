...
@Data
public class Idea28263Config {
    private String name = "idea_028263";
 ...
 */
@Slf4j
public class Idea28263Service {
    private static final int IDEA_ID = 28263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28263Service() {
        this(new Idea28263Config());
    }

    public Idea28263Service(Idea28263Config config) {
        this.config = config != null ? config : new Idea28263Config();
