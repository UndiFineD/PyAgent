...
@Data
public class Idea28129Config {
    private String name = "idea_028129";
 ...
 */
@Slf4j
public class Idea28129Service {
    private static final int IDEA_ID = 28129;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28129Service() {
        this(new Idea28129Config());
    }

    public Idea28129Service(Idea28129Config config) {
        this.config = config != null ? config : new Idea28129Config();
