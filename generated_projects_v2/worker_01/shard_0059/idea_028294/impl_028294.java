...
@Data
public class Idea28294Config {
    private String name = "idea_028294";
 ...
 */
@Slf4j
public class Idea28294Service {
    private static final int IDEA_ID = 28294;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28294Service() {
        this(new Idea28294Config());
    }

    public Idea28294Service(Idea28294Config config) {
        this.config = config != null ? config : new Idea28294Config();
