...
@Data
public class Idea28322Config {
    private String name = "idea_028322";
 ...
 */
@Slf4j
public class Idea28322Service {
    private static final int IDEA_ID = 28322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28322Service() {
        this(new Idea28322Config());
    }

    public Idea28322Service(Idea28322Config config) {
        this.config = config != null ? config : new Idea28322Config();
