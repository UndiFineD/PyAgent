...
@Data
public class Idea28299Config {
    private String name = "idea_028299";
 ...
 */
@Slf4j
public class Idea28299Service {
    private static final int IDEA_ID = 28299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28299Service() {
        this(new Idea28299Config());
    }

    public Idea28299Service(Idea28299Config config) {
        this.config = config != null ? config : new Idea28299Config();
