...
@Data
public class Idea28269Config {
    private String name = "idea_028269";
 ...
 */
@Slf4j
public class Idea28269Service {
    private static final int IDEA_ID = 28269;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28269Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28269Service() {
        this(new Idea28269Config());
    }

    public Idea28269Service(Idea28269Config config) {
        this.config = config != null ? config : new Idea28269Config();
