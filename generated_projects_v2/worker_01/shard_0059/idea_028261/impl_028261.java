...
@Data
public class Idea28261Config {
    private String name = "idea_028261";
 ...
 */
@Slf4j
public class Idea28261Service {
    private static final int IDEA_ID = 28261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28261Service() {
        this(new Idea28261Config());
    }

    public Idea28261Service(Idea28261Config config) {
        this.config = config != null ? config : new Idea28261Config();
