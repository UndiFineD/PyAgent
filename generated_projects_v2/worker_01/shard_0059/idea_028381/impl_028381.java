...
@Data
public class Idea28381Config {
    private String name = "idea_028381";
 ...
 */
@Slf4j
public class Idea28381Service {
    private static final int IDEA_ID = 28381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28381Service() {
        this(new Idea28381Config());
    }

    public Idea28381Service(Idea28381Config config) {
        this.config = config != null ? config : new Idea28381Config();
