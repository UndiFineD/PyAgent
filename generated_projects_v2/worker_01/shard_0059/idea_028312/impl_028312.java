...
@Data
public class Idea28312Config {
    private String name = "idea_028312";
 ...
 */
@Slf4j
public class Idea28312Service {
    private static final int IDEA_ID = 28312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28312Service() {
        this(new Idea28312Config());
    }

    public Idea28312Service(Idea28312Config config) {
        this.config = config != null ? config : new Idea28312Config();
