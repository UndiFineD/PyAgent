...
@Data
public class Idea28413Config {
    private String name = "idea_028413";
 ...
 */
@Slf4j
public class Idea28413Service {
    private static final int IDEA_ID = 28413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28413Service() {
        this(new Idea28413Config());
    }

    public Idea28413Service(Idea28413Config config) {
        this.config = config != null ? config : new Idea28413Config();
