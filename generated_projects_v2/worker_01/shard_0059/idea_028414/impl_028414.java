...
@Data
public class Idea28414Config {
    private String name = "idea_028414";
 ...
 */
@Slf4j
public class Idea28414Service {
    private static final int IDEA_ID = 28414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28414Service() {
        this(new Idea28414Config());
    }

    public Idea28414Service(Idea28414Config config) {
        this.config = config != null ? config : new Idea28414Config();
