...
@Data
public class Idea28330Config {
    private String name = "idea_028330";
 ...
 */
@Slf4j
public class Idea28330Service {
    private static final int IDEA_ID = 28330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28330Service() {
        this(new Idea28330Config());
    }

    public Idea28330Service(Idea28330Config config) {
        this.config = config != null ? config : new Idea28330Config();
