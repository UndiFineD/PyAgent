...
@Data
public class Idea28166Config {
    private String name = "idea_028166";
 ...
 */
@Slf4j
public class Idea28166Service {
    private static final int IDEA_ID = 28166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28166Service() {
        this(new Idea28166Config());
    }

    public Idea28166Service(Idea28166Config config) {
        this.config = config != null ? config : new Idea28166Config();
