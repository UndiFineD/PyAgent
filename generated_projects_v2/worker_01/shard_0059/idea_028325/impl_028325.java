...
@Data
public class Idea28325Config {
    private String name = "idea_028325";
 ...
 */
@Slf4j
public class Idea28325Service {
    private static final int IDEA_ID = 28325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28325Service() {
        this(new Idea28325Config());
    }

    public Idea28325Service(Idea28325Config config) {
        this.config = config != null ? config : new Idea28325Config();
