...
@Data
public class Idea28348Config {
    private String name = "idea_028348";
 ...
 */
@Slf4j
public class Idea28348Service {
    private static final int IDEA_ID = 28348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28348Service() {
        this(new Idea28348Config());
    }

    public Idea28348Service(Idea28348Config config) {
        this.config = config != null ? config : new Idea28348Config();
