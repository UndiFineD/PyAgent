...
@Data
public class Idea28167Config {
    private String name = "idea_028167";
 ...
 */
@Slf4j
public class Idea28167Service {
    private static final int IDEA_ID = 28167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28167Service() {
        this(new Idea28167Config());
    }

    public Idea28167Service(Idea28167Config config) {
        this.config = config != null ? config : new Idea28167Config();
