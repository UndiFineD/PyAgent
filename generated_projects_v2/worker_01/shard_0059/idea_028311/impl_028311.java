...
@Data
public class Idea28311Config {
    private String name = "idea_028311";
 ...
 */
@Slf4j
public class Idea28311Service {
    private static final int IDEA_ID = 28311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28311Service() {
        this(new Idea28311Config());
    }

    public Idea28311Service(Idea28311Config config) {
        this.config = config != null ? config : new Idea28311Config();
