...
@Data
public class Idea28305Config {
    private String name = "idea_028305";
 ...
 */
@Slf4j
public class Idea28305Service {
    private static final int IDEA_ID = 28305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28305Service() {
        this(new Idea28305Config());
    }

    public Idea28305Service(Idea28305Config config) {
        this.config = config != null ? config : new Idea28305Config();
