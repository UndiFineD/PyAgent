...
@Data
public class Idea28056Config {
    private String name = "idea_028056";
 ...
 */
@Slf4j
public class Idea28056Service {
    private static final int IDEA_ID = 28056;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28056Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28056Service() {
        this(new Idea28056Config());
    }

    public Idea28056Service(Idea28056Config config) {
        this.config = config != null ? config : new Idea28056Config();
