...
@Data
public class Idea28496Config {
    private String name = "idea_028496";
 ...
 */
@Slf4j
public class Idea28496Service {
    private static final int IDEA_ID = 28496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28496Service() {
        this(new Idea28496Config());
    }

    public Idea28496Service(Idea28496Config config) {
        this.config = config != null ? config : new Idea28496Config();
