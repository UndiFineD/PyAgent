...
@Data
public class Idea28147Config {
    private String name = "idea_028147";
 ...
 */
@Slf4j
public class Idea28147Service {
    private static final int IDEA_ID = 28147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28147Service() {
        this(new Idea28147Config());
    }

    public Idea28147Service(Idea28147Config config) {
        this.config = config != null ? config : new Idea28147Config();
