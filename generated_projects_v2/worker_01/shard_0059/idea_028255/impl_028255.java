...
@Data
public class Idea28255Config {
    private String name = "idea_028255";
 ...
 */
@Slf4j
public class Idea28255Service {
    private static final int IDEA_ID = 28255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28255Service() {
        this(new Idea28255Config());
    }

    public Idea28255Service(Idea28255Config config) {
        this.config = config != null ? config : new Idea28255Config();
