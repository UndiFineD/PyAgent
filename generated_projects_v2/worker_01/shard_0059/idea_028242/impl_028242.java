...
@Data
public class Idea28242Config {
    private String name = "idea_028242";
 ...
 */
@Slf4j
public class Idea28242Service {
    private static final int IDEA_ID = 28242;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28242Service() {
        this(new Idea28242Config());
    }

    public Idea28242Service(Idea28242Config config) {
        this.config = config != null ? config : new Idea28242Config();
