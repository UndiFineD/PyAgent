...
@Data
public class Idea28226Config {
    private String name = "idea_028226";
 ...
 */
@Slf4j
public class Idea28226Service {
    private static final int IDEA_ID = 28226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28226Service() {
        this(new Idea28226Config());
    }

    public Idea28226Service(Idea28226Config config) {
        this.config = config != null ? config : new Idea28226Config();
