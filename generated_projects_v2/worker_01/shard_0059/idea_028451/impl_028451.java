...
@Data
public class Idea28451Config {
    private String name = "idea_028451";
 ...
 */
@Slf4j
public class Idea28451Service {
    private static final int IDEA_ID = 28451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28451Service() {
        this(new Idea28451Config());
    }

    public Idea28451Service(Idea28451Config config) {
        this.config = config != null ? config : new Idea28451Config();
