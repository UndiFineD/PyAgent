...
@Data
public class Idea28334Config {
    private String name = "idea_028334";
 ...
 */
@Slf4j
public class Idea28334Service {
    private static final int IDEA_ID = 28334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28334Service() {
        this(new Idea28334Config());
    }

    public Idea28334Service(Idea28334Config config) {
        this.config = config != null ? config : new Idea28334Config();
