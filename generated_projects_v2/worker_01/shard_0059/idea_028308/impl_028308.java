...
@Data
public class Idea28308Config {
    private String name = "idea_028308";
 ...
 */
@Slf4j
public class Idea28308Service {
    private static final int IDEA_ID = 28308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28308Service() {
        this(new Idea28308Config());
    }

    public Idea28308Service(Idea28308Config config) {
        this.config = config != null ? config : new Idea28308Config();
