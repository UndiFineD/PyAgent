...
@Data
public class Idea28058Config {
    private String name = "idea_028058";
 ...
 */
@Slf4j
public class Idea28058Service {
    private static final int IDEA_ID = 28058;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28058Service() {
        this(new Idea28058Config());
    }

    public Idea28058Service(Idea28058Config config) {
        this.config = config != null ? config : new Idea28058Config();
