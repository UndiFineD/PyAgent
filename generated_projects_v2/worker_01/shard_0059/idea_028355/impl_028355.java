...
@Data
public class Idea28355Config {
    private String name = "idea_028355";
 ...
 */
@Slf4j
public class Idea28355Service {
    private static final int IDEA_ID = 28355;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28355Service() {
        this(new Idea28355Config());
    }

    public Idea28355Service(Idea28355Config config) {
        this.config = config != null ? config : new Idea28355Config();
