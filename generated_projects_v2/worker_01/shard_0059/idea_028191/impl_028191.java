...
@Data
public class Idea28191Config {
    private String name = "idea_028191";
 ...
 */
@Slf4j
public class Idea28191Service {
    private static final int IDEA_ID = 28191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28191Service() {
        this(new Idea28191Config());
    }

    public Idea28191Service(Idea28191Config config) {
        this.config = config != null ? config : new Idea28191Config();
