...
@Data
public class Idea28394Config {
    private String name = "idea_028394";
 ...
 */
@Slf4j
public class Idea28394Service {
    private static final int IDEA_ID = 28394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28394Service() {
        this(new Idea28394Config());
    }

    public Idea28394Service(Idea28394Config config) {
        this.config = config != null ? config : new Idea28394Config();
