...
@Data
public class Idea28434Config {
    private String name = "idea_028434";
 ...
 */
@Slf4j
public class Idea28434Service {
    private static final int IDEA_ID = 28434;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28434Service() {
        this(new Idea28434Config());
    }

    public Idea28434Service(Idea28434Config config) {
        this.config = config != null ? config : new Idea28434Config();
