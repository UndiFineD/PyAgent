...
@Data
public class Idea28091Config {
    private String name = "idea_028091";
 ...
 */
@Slf4j
public class Idea28091Service {
    private static final int IDEA_ID = 28091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28091Service() {
        this(new Idea28091Config());
    }

    public Idea28091Service(Idea28091Config config) {
        this.config = config != null ? config : new Idea28091Config();
