...
@Data
public class Idea28126Config {
    private String name = "idea_028126";
 ...
 */
@Slf4j
public class Idea28126Service {
    private static final int IDEA_ID = 28126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28126Service() {
        this(new Idea28126Config());
    }

    public Idea28126Service(Idea28126Config config) {
        this.config = config != null ? config : new Idea28126Config();
