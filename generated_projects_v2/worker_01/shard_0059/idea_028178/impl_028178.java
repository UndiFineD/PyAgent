...
@Data
public class Idea28178Config {
    private String name = "idea_028178";
 ...
 */
@Slf4j
public class Idea28178Service {
    private static final int IDEA_ID = 28178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28178Service() {
        this(new Idea28178Config());
    }

    public Idea28178Service(Idea28178Config config) {
        this.config = config != null ? config : new Idea28178Config();
