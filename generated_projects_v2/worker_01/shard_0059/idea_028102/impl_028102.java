...
@Data
public class Idea28102Config {
    private String name = "idea_028102";
 ...
 */
@Slf4j
public class Idea28102Service {
    private static final int IDEA_ID = 28102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28102Service() {
        this(new Idea28102Config());
    }

    public Idea28102Service(Idea28102Config config) {
        this.config = config != null ? config : new Idea28102Config();
