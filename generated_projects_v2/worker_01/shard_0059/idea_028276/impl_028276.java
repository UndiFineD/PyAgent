...
@Data
public class Idea28276Config {
    private String name = "idea_028276";
 ...
 */
@Slf4j
public class Idea28276Service {
    private static final int IDEA_ID = 28276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28276Service() {
        this(new Idea28276Config());
    }

    public Idea28276Service(Idea28276Config config) {
        this.config = config != null ? config : new Idea28276Config();
