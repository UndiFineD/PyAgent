...
@Data
public class Idea28193Config {
    private String name = "idea_028193";
 ...
 */
@Slf4j
public class Idea28193Service {
    private static final int IDEA_ID = 28193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28193Service() {
        this(new Idea28193Config());
    }

    public Idea28193Service(Idea28193Config config) {
        this.config = config != null ? config : new Idea28193Config();
