...
@Data
public class Idea28281Config {
    private String name = "idea_028281";
 ...
 */
@Slf4j
public class Idea28281Service {
    private static final int IDEA_ID = 28281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28281Service() {
        this(new Idea28281Config());
    }

    public Idea28281Service(Idea28281Config config) {
        this.config = config != null ? config : new Idea28281Config();
