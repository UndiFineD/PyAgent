...
@Data
public class Idea28048Config {
    private String name = "idea_028048";
 ...
 */
@Slf4j
public class Idea28048Service {
    private static final int IDEA_ID = 28048;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28048Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28048Service() {
        this(new Idea28048Config());
    }

    public Idea28048Service(Idea28048Config config) {
        this.config = config != null ? config : new Idea28048Config();
