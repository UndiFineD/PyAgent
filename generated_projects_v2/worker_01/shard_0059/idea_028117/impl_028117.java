...
@Data
public class Idea28117Config {
    private String name = "idea_028117";
 ...
 */
@Slf4j
public class Idea28117Service {
    private static final int IDEA_ID = 28117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28117Service() {
        this(new Idea28117Config());
    }

    public Idea28117Service(Idea28117Config config) {
        this.config = config != null ? config : new Idea28117Config();
