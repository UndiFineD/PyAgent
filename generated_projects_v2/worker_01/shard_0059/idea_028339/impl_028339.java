...
@Data
public class Idea28339Config {
    private String name = "idea_028339";
 ...
 */
@Slf4j
public class Idea28339Service {
    private static final int IDEA_ID = 28339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28339Service() {
        this(new Idea28339Config());
    }

    public Idea28339Service(Idea28339Config config) {
        this.config = config != null ? config : new Idea28339Config();
