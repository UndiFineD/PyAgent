...
@Data
public class Idea28498Config {
    private String name = "idea_028498";
 ...
 */
@Slf4j
public class Idea28498Service {
    private static final int IDEA_ID = 28498;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28498Service() {
        this(new Idea28498Config());
    }

    public Idea28498Service(Idea28498Config config) {
        this.config = config != null ? config : new Idea28498Config();
