...
@Data
public class Idea28441Config {
    private String name = "idea_028441";
 ...
 */
@Slf4j
public class Idea28441Service {
    private static final int IDEA_ID = 28441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28441Service() {
        this(new Idea28441Config());
    }

    public Idea28441Service(Idea28441Config config) {
        this.config = config != null ? config : new Idea28441Config();
