...
@Data
public class Idea28301Config {
    private String name = "idea_028301";
 ...
 */
@Slf4j
public class Idea28301Service {
    private static final int IDEA_ID = 28301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28301Service() {
        this(new Idea28301Config());
    }

    public Idea28301Service(Idea28301Config config) {
        this.config = config != null ? config : new Idea28301Config();
