...
@Data
public class Idea28038Config {
    private String name = "idea_028038";
 ...
 */
@Slf4j
public class Idea28038Service {
    private static final int IDEA_ID = 28038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28038Service() {
        this(new Idea28038Config());
    }

    public Idea28038Service(Idea28038Config config) {
        this.config = config != null ? config : new Idea28038Config();
