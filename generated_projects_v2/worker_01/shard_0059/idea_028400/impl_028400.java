...
@Data
public class Idea28400Config {
    private String name = "idea_028400";
 ...
 */
@Slf4j
public class Idea28400Service {
    private static final int IDEA_ID = 28400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28400Service() {
        this(new Idea28400Config());
    }

    public Idea28400Service(Idea28400Config config) {
        this.config = config != null ? config : new Idea28400Config();
