...
@Data
public class Idea28203Config {
    private String name = "idea_028203";
 ...
 */
@Slf4j
public class Idea28203Service {
    private static final int IDEA_ID = 28203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28203Service() {
        this(new Idea28203Config());
    }

    public Idea28203Service(Idea28203Config config) {
        this.config = config != null ? config : new Idea28203Config();
