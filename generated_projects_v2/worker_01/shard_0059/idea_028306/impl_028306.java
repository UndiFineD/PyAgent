...
@Data
public class Idea28306Config {
    private String name = "idea_028306";
 ...
 */
@Slf4j
public class Idea28306Service {
    private static final int IDEA_ID = 28306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28306Service() {
        this(new Idea28306Config());
    }

    public Idea28306Service(Idea28306Config config) {
        this.config = config != null ? config : new Idea28306Config();
