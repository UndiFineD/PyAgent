...
@Data
public class Idea28417Config {
    private String name = "idea_028417";
 ...
 */
@Slf4j
public class Idea28417Service {
    private static final int IDEA_ID = 28417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28417Service() {
        this(new Idea28417Config());
    }

    public Idea28417Service(Idea28417Config config) {
        this.config = config != null ? config : new Idea28417Config();
