...
@Data
public class Idea28411Config {
    private String name = "idea_028411";
 ...
 */
@Slf4j
public class Idea28411Service {
    private static final int IDEA_ID = 28411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28411Service() {
        this(new Idea28411Config());
    }

    public Idea28411Service(Idea28411Config config) {
        this.config = config != null ? config : new Idea28411Config();
