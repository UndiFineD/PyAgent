...
@Data
public class Idea28438Config {
    private String name = "idea_028438";
 ...
 */
@Slf4j
public class Idea28438Service {
    private static final int IDEA_ID = 28438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28438Service() {
        this(new Idea28438Config());
    }

    public Idea28438Service(Idea28438Config config) {
        this.config = config != null ? config : new Idea28438Config();
