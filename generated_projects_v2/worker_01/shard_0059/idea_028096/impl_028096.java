...
@Data
public class Idea28096Config {
    private String name = "idea_028096";
 ...
 */
@Slf4j
public class Idea28096Service {
    private static final int IDEA_ID = 28096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28096Service() {
        this(new Idea28096Config());
    }

    public Idea28096Service(Idea28096Config config) {
        this.config = config != null ? config : new Idea28096Config();
