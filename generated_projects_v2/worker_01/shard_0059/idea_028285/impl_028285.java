...
@Data
public class Idea28285Config {
    private String name = "idea_028285";
 ...
 */
@Slf4j
public class Idea28285Service {
    private static final int IDEA_ID = 28285;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28285Service() {
        this(new Idea28285Config());
    }

    public Idea28285Service(Idea28285Config config) {
        this.config = config != null ? config : new Idea28285Config();
