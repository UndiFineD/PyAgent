...
@Data
public class Idea28161Config {
    private String name = "idea_028161";
 ...
 */
@Slf4j
public class Idea28161Service {
    private static final int IDEA_ID = 28161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28161Service() {
        this(new Idea28161Config());
    }

    public Idea28161Service(Idea28161Config config) {
        this.config = config != null ? config : new Idea28161Config();
