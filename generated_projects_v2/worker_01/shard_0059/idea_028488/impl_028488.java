...
@Data
public class Idea28488Config {
    private String name = "idea_028488";
 ...
 */
@Slf4j
public class Idea28488Service {
    private static final int IDEA_ID = 28488;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28488Service() {
        this(new Idea28488Config());
    }

    public Idea28488Service(Idea28488Config config) {
        this.config = config != null ? config : new Idea28488Config();
