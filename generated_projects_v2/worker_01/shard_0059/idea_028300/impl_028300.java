...
@Data
public class Idea28300Config {
    private String name = "idea_028300";
 ...
 */
@Slf4j
public class Idea28300Service {
    private static final int IDEA_ID = 28300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28300Service() {
        this(new Idea28300Config());
    }

    public Idea28300Service(Idea28300Config config) {
        this.config = config != null ? config : new Idea28300Config();
