...
@Data
public class Idea28084Config {
    private String name = "idea_028084";
 ...
 */
@Slf4j
public class Idea28084Service {
    private static final int IDEA_ID = 28084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28084Service() {
        this(new Idea28084Config());
    }

    public Idea28084Service(Idea28084Config config) {
        this.config = config != null ? config : new Idea28084Config();
