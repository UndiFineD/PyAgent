...
@Data
public class Idea28360Config {
    private String name = "idea_028360";
 ...
 */
@Slf4j
public class Idea28360Service {
    private static final int IDEA_ID = 28360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28360Service() {
        this(new Idea28360Config());
    }

    public Idea28360Service(Idea28360Config config) {
        this.config = config != null ? config : new Idea28360Config();
