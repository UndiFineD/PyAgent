...
@Data
public class Idea28182Config {
    private String name = "idea_028182";
 ...
 */
@Slf4j
public class Idea28182Service {
    private static final int IDEA_ID = 28182;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28182Service() {
        this(new Idea28182Config());
    }

    public Idea28182Service(Idea28182Config config) {
        this.config = config != null ? config : new Idea28182Config();
