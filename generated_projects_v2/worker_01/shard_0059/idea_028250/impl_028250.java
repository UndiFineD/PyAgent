...
@Data
public class Idea28250Config {
    private String name = "idea_028250";
 ...
 */
@Slf4j
public class Idea28250Service {
    private static final int IDEA_ID = 28250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28250Service() {
        this(new Idea28250Config());
    }

    public Idea28250Service(Idea28250Config config) {
        this.config = config != null ? config : new Idea28250Config();
