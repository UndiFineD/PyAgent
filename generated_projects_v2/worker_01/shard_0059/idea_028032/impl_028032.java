...
@Data
public class Idea28032Config {
    private String name = "idea_028032";
 ...
 */
@Slf4j
public class Idea28032Service {
    private static final int IDEA_ID = 28032;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28032Service() {
        this(new Idea28032Config());
    }

    public Idea28032Service(Idea28032Config config) {
        this.config = config != null ? config : new Idea28032Config();
