...
@Data
public class Idea28385Config {
    private String name = "idea_028385";
 ...
 */
@Slf4j
public class Idea28385Service {
    private static final int IDEA_ID = 28385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28385Service() {
        this(new Idea28385Config());
    }

    public Idea28385Service(Idea28385Config config) {
        this.config = config != null ? config : new Idea28385Config();
