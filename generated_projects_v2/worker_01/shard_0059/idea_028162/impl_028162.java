...
@Data
public class Idea28162Config {
    private String name = "idea_028162";
 ...
 */
@Slf4j
public class Idea28162Service {
    private static final int IDEA_ID = 28162;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28162Service() {
        this(new Idea28162Config());
    }

    public Idea28162Service(Idea28162Config config) {
        this.config = config != null ? config : new Idea28162Config();
