...
@Data
public class Idea28483Config {
    private String name = "idea_028483";
 ...
 */
@Slf4j
public class Idea28483Service {
    private static final int IDEA_ID = 28483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28483Service() {
        this(new Idea28483Config());
    }

    public Idea28483Service(Idea28483Config config) {
        this.config = config != null ? config : new Idea28483Config();
