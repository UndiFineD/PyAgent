...
@Data
public class Idea28494Config {
    private String name = "idea_028494";
 ...
 */
@Slf4j
public class Idea28494Service {
    private static final int IDEA_ID = 28494;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28494Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28494Service() {
        this(new Idea28494Config());
    }

    public Idea28494Service(Idea28494Config config) {
        this.config = config != null ? config : new Idea28494Config();
