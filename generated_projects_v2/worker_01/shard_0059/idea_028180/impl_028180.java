...
@Data
public class Idea28180Config {
    private String name = "idea_028180";
 ...
 */
@Slf4j
public class Idea28180Service {
    private static final int IDEA_ID = 28180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28180Service() {
        this(new Idea28180Config());
    }

    public Idea28180Service(Idea28180Config config) {
        this.config = config != null ? config : new Idea28180Config();
