...
@Data
public class Idea28332Config {
    private String name = "idea_028332";
 ...
 */
@Slf4j
public class Idea28332Service {
    private static final int IDEA_ID = 28332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28332Service() {
        this(new Idea28332Config());
    }

    public Idea28332Service(Idea28332Config config) {
        this.config = config != null ? config : new Idea28332Config();
