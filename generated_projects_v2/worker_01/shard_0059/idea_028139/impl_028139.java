...
@Data
public class Idea28139Config {
    private String name = "idea_028139";
 ...
 */
@Slf4j
public class Idea28139Service {
    private static final int IDEA_ID = 28139;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28139Service() {
        this(new Idea28139Config());
    }

    public Idea28139Service(Idea28139Config config) {
        this.config = config != null ? config : new Idea28139Config();
