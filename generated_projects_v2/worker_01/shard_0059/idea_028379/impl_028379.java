...
@Data
public class Idea28379Config {
    private String name = "idea_028379";
 ...
 */
@Slf4j
public class Idea28379Service {
    private static final int IDEA_ID = 28379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28379Service() {
        this(new Idea28379Config());
    }

    public Idea28379Service(Idea28379Config config) {
        this.config = config != null ? config : new Idea28379Config();
