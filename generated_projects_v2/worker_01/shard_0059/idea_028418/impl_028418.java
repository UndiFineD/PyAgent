...
@Data
public class Idea28418Config {
    private String name = "idea_028418";
 ...
 */
@Slf4j
public class Idea28418Service {
    private static final int IDEA_ID = 28418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28418Service() {
        this(new Idea28418Config());
    }

    public Idea28418Service(Idea28418Config config) {
        this.config = config != null ? config : new Idea28418Config();
