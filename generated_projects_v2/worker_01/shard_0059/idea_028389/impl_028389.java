...
@Data
public class Idea28389Config {
    private String name = "idea_028389";
 ...
 */
@Slf4j
public class Idea28389Service {
    private static final int IDEA_ID = 28389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28389Service() {
        this(new Idea28389Config());
    }

    public Idea28389Service(Idea28389Config config) {
        this.config = config != null ? config : new Idea28389Config();
