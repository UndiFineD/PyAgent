...
@Data
public class Idea28390Config {
    private String name = "idea_028390";
 ...
 */
@Slf4j
public class Idea28390Service {
    private static final int IDEA_ID = 28390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28390Service() {
        this(new Idea28390Config());
    }

    public Idea28390Service(Idea28390Config config) {
        this.config = config != null ? config : new Idea28390Config();
