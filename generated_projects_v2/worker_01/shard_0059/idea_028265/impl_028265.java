...
@Data
public class Idea28265Config {
    private String name = "idea_028265";
 ...
 */
@Slf4j
public class Idea28265Service {
    private static final int IDEA_ID = 28265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28265Service() {
        this(new Idea28265Config());
    }

    public Idea28265Service(Idea28265Config config) {
        this.config = config != null ? config : new Idea28265Config();
