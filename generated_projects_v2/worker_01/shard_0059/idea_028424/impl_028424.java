...
@Data
public class Idea28424Config {
    private String name = "idea_028424";
 ...
 */
@Slf4j
public class Idea28424Service {
    private static final int IDEA_ID = 28424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28424Service() {
        this(new Idea28424Config());
    }

    public Idea28424Service(Idea28424Config config) {
        this.config = config != null ? config : new Idea28424Config();
