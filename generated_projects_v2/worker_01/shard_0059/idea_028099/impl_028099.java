...
@Data
public class Idea28099Config {
    private String name = "idea_028099";
 ...
 */
@Slf4j
public class Idea28099Service {
    private static final int IDEA_ID = 28099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28099Service() {
        this(new Idea28099Config());
    }

    public Idea28099Service(Idea28099Config config) {
        this.config = config != null ? config : new Idea28099Config();
