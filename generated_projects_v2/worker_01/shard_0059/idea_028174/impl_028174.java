...
@Data
public class Idea28174Config {
    private String name = "idea_028174";
 ...
 */
@Slf4j
public class Idea28174Service {
    private static final int IDEA_ID = 28174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28174Service() {
        this(new Idea28174Config());
    }

    public Idea28174Service(Idea28174Config config) {
        this.config = config != null ? config : new Idea28174Config();
