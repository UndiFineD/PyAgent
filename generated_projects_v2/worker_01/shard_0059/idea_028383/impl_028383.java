...
@Data
public class Idea28383Config {
    private String name = "idea_028383";
 ...
 */
@Slf4j
public class Idea28383Service {
    private static final int IDEA_ID = 28383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28383Service() {
        this(new Idea28383Config());
    }

    public Idea28383Service(Idea28383Config config) {
        this.config = config != null ? config : new Idea28383Config();
