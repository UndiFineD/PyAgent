...
@Data
public class Idea28151Config {
    private String name = "idea_028151";
 ...
 */
@Slf4j
public class Idea28151Service {
    private static final int IDEA_ID = 28151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28151Service() {
        this(new Idea28151Config());
    }

    public Idea28151Service(Idea28151Config config) {
        this.config = config != null ? config : new Idea28151Config();
