...
@Data
public class Idea28179Config {
    private String name = "idea_028179";
 ...
 */
@Slf4j
public class Idea28179Service {
    private static final int IDEA_ID = 28179;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28179Service() {
        this(new Idea28179Config());
    }

    public Idea28179Service(Idea28179Config config) {
        this.config = config != null ? config : new Idea28179Config();
