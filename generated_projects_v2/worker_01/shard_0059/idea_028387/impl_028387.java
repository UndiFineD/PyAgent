...
@Data
public class Idea28387Config {
    private String name = "idea_028387";
 ...
 */
@Slf4j
public class Idea28387Service {
    private static final int IDEA_ID = 28387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28387Service() {
        this(new Idea28387Config());
    }

    public Idea28387Service(Idea28387Config config) {
        this.config = config != null ? config : new Idea28387Config();
