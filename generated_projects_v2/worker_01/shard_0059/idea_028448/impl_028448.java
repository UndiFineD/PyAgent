...
@Data
public class Idea28448Config {
    private String name = "idea_028448";
 ...
 */
@Slf4j
public class Idea28448Service {
    private static final int IDEA_ID = 28448;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28448Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28448Service() {
        this(new Idea28448Config());
    }

    public Idea28448Service(Idea28448Config config) {
        this.config = config != null ? config : new Idea28448Config();
