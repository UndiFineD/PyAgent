...
@Data
public class Idea28052Config {
    private String name = "idea_028052";
 ...
 */
@Slf4j
public class Idea28052Service {
    private static final int IDEA_ID = 28052;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28052Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28052Service() {
        this(new Idea28052Config());
    }

    public Idea28052Service(Idea28052Config config) {
        this.config = config != null ? config : new Idea28052Config();
