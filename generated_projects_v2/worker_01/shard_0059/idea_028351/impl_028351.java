...
@Data
public class Idea28351Config {
    private String name = "idea_028351";
 ...
 */
@Slf4j
public class Idea28351Service {
    private static final int IDEA_ID = 28351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28351Service() {
        this(new Idea28351Config());
    }

    public Idea28351Service(Idea28351Config config) {
        this.config = config != null ? config : new Idea28351Config();
