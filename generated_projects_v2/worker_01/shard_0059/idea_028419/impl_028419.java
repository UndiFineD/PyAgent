...
@Data
public class Idea28419Config {
    private String name = "idea_028419";
 ...
 */
@Slf4j
public class Idea28419Service {
    private static final int IDEA_ID = 28419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28419Service() {
        this(new Idea28419Config());
    }

    public Idea28419Service(Idea28419Config config) {
        this.config = config != null ? config : new Idea28419Config();
