...
@Data
public class Idea28186Config {
    private String name = "idea_028186";
 ...
 */
@Slf4j
public class Idea28186Service {
    private static final int IDEA_ID = 28186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28186Service() {
        this(new Idea28186Config());
    }

    public Idea28186Service(Idea28186Config config) {
        this.config = config != null ? config : new Idea28186Config();
