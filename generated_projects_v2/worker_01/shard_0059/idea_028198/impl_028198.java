...
@Data
public class Idea28198Config {
    private String name = "idea_028198";
 ...
 */
@Slf4j
public class Idea28198Service {
    private static final int IDEA_ID = 28198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28198Service() {
        this(new Idea28198Config());
    }

    public Idea28198Service(Idea28198Config config) {
        this.config = config != null ? config : new Idea28198Config();
