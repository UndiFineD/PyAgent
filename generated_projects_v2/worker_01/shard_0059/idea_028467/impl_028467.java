...
@Data
public class Idea28467Config {
    private String name = "idea_028467";
 ...
 */
@Slf4j
public class Idea28467Service {
    private static final int IDEA_ID = 28467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28467Service() {
        this(new Idea28467Config());
    }

    public Idea28467Service(Idea28467Config config) {
        this.config = config != null ? config : new Idea28467Config();
