...
@Data
public class Idea28252Config {
    private String name = "idea_028252";
 ...
 */
@Slf4j
public class Idea28252Service {
    private static final int IDEA_ID = 28252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28252Service() {
        this(new Idea28252Config());
    }

    public Idea28252Service(Idea28252Config config) {
        this.config = config != null ? config : new Idea28252Config();
