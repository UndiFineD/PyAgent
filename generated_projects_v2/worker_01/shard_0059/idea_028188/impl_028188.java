...
@Data
public class Idea28188Config {
    private String name = "idea_028188";
 ...
 */
@Slf4j
public class Idea28188Service {
    private static final int IDEA_ID = 28188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28188Service() {
        this(new Idea28188Config());
    }

    public Idea28188Service(Idea28188Config config) {
        this.config = config != null ? config : new Idea28188Config();
