...
@Data
public class Idea28116Config {
    private String name = "idea_028116";
 ...
 */
@Slf4j
public class Idea28116Service {
    private static final int IDEA_ID = 28116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28116Service() {
        this(new Idea28116Config());
    }

    public Idea28116Service(Idea28116Config config) {
        this.config = config != null ? config : new Idea28116Config();
