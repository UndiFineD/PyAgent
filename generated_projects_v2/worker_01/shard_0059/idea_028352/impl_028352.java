...
@Data
public class Idea28352Config {
    private String name = "idea_028352";
 ...
 */
@Slf4j
public class Idea28352Service {
    private static final int IDEA_ID = 28352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28352Service() {
        this(new Idea28352Config());
    }

    public Idea28352Service(Idea28352Config config) {
        this.config = config != null ? config : new Idea28352Config();
