...
@Data
public class Idea28089Config {
    private String name = "idea_028089";
 ...
 */
@Slf4j
public class Idea28089Service {
    private static final int IDEA_ID = 28089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28089Service() {
        this(new Idea28089Config());
    }

    public Idea28089Service(Idea28089Config config) {
        this.config = config != null ? config : new Idea28089Config();
