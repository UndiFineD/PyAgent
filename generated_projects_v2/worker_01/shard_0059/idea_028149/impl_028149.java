...
@Data
public class Idea28149Config {
    private String name = "idea_028149";
 ...
 */
@Slf4j
public class Idea28149Service {
    private static final int IDEA_ID = 28149;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28149Service() {
        this(new Idea28149Config());
    }

    public Idea28149Service(Idea28149Config config) {
        this.config = config != null ? config : new Idea28149Config();
