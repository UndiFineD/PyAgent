...
@Data
public class Idea28284Config {
    private String name = "idea_028284";
 ...
 */
@Slf4j
public class Idea28284Service {
    private static final int IDEA_ID = 28284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28284Service() {
        this(new Idea28284Config());
    }

    public Idea28284Service(Idea28284Config config) {
        this.config = config != null ? config : new Idea28284Config();
