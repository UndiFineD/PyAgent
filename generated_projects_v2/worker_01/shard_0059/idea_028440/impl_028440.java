...
@Data
public class Idea28440Config {
    private String name = "idea_028440";
 ...
 */
@Slf4j
public class Idea28440Service {
    private static final int IDEA_ID = 28440;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28440Service() {
        this(new Idea28440Config());
    }

    public Idea28440Service(Idea28440Config config) {
        this.config = config != null ? config : new Idea28440Config();
