...
@Data
public class Idea28239Config {
    private String name = "idea_028239";
 ...
 */
@Slf4j
public class Idea28239Service {
    private static final int IDEA_ID = 28239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28239Service() {
        this(new Idea28239Config());
    }

    public Idea28239Service(Idea28239Config config) {
        this.config = config != null ? config : new Idea28239Config();
