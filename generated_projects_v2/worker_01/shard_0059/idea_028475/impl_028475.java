...
@Data
public class Idea28475Config {
    private String name = "idea_028475";
 ...
 */
@Slf4j
public class Idea28475Service {
    private static final int IDEA_ID = 28475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28475Service() {
        this(new Idea28475Config());
    }

    public Idea28475Service(Idea28475Config config) {
        this.config = config != null ? config : new Idea28475Config();
