...
@Data
public class Idea28077Config {
    private String name = "idea_028077";
 ...
 */
@Slf4j
public class Idea28077Service {
    private static final int IDEA_ID = 28077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28077Service() {
        this(new Idea28077Config());
    }

    public Idea28077Service(Idea28077Config config) {
        this.config = config != null ? config : new Idea28077Config();
