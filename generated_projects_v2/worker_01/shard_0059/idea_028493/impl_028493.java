...
@Data
public class Idea28493Config {
    private String name = "idea_028493";
 ...
 */
@Slf4j
public class Idea28493Service {
    private static final int IDEA_ID = 28493;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28493Service() {
        this(new Idea28493Config());
    }

    public Idea28493Service(Idea28493Config config) {
        this.config = config != null ? config : new Idea28493Config();
