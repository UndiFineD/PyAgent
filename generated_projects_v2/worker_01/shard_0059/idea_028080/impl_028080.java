...
@Data
public class Idea28080Config {
    private String name = "idea_028080";
 ...
 */
@Slf4j
public class Idea28080Service {
    private static final int IDEA_ID = 28080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28080Service() {
        this(new Idea28080Config());
    }

    public Idea28080Service(Idea28080Config config) {
        this.config = config != null ? config : new Idea28080Config();
