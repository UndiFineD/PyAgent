...
@Data
public class Idea28245Config {
    private String name = "idea_028245";
 ...
 */
@Slf4j
public class Idea28245Service {
    private static final int IDEA_ID = 28245;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28245Service() {
        this(new Idea28245Config());
    }

    public Idea28245Service(Idea28245Config config) {
        this.config = config != null ? config : new Idea28245Config();
