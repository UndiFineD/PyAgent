...
@Data
public class Idea28105Config {
    private String name = "idea_028105";
 ...
 */
@Slf4j
public class Idea28105Service {
    private static final int IDEA_ID = 28105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28105Service() {
        this(new Idea28105Config());
    }

    public Idea28105Service(Idea28105Config config) {
        this.config = config != null ? config : new Idea28105Config();
