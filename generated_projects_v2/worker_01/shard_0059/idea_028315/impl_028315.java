...
@Data
public class Idea28315Config {
    private String name = "idea_028315";
 ...
 */
@Slf4j
public class Idea28315Service {
    private static final int IDEA_ID = 28315;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28315Service() {
        this(new Idea28315Config());
    }

    public Idea28315Service(Idea28315Config config) {
        this.config = config != null ? config : new Idea28315Config();
