...
@Data
public class Idea28108Config {
    private String name = "idea_028108";
 ...
 */
@Slf4j
public class Idea28108Service {
    private static final int IDEA_ID = 28108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28108Service() {
        this(new Idea28108Config());
    }

    public Idea28108Service(Idea28108Config config) {
        this.config = config != null ? config : new Idea28108Config();
