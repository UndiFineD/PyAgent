...
@Data
public class Idea28177Config {
    private String name = "idea_028177";
 ...
 */
@Slf4j
public class Idea28177Service {
    private static final int IDEA_ID = 28177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28177Service() {
        this(new Idea28177Config());
    }

    public Idea28177Service(Idea28177Config config) {
        this.config = config != null ? config : new Idea28177Config();
