...
@Data
public class Idea28049Config {
    private String name = "idea_028049";
 ...
 */
@Slf4j
public class Idea28049Service {
    private static final int IDEA_ID = 28049;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28049Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28049Service() {
        this(new Idea28049Config());
    }

    public Idea28049Service(Idea28049Config config) {
        this.config = config != null ? config : new Idea28049Config();
