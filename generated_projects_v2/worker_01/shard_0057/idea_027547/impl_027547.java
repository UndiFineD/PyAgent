...
@Data
public class Idea27547Config {
    private String name = "idea_027547";
 ...
 */
@Slf4j
public class Idea27547Service {
    private static final int IDEA_ID = 27547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27547Service() {
        this(new Idea27547Config());
    }

    public Idea27547Service(Idea27547Config config) {
        this.config = config != null ? config : new Idea27547Config();
