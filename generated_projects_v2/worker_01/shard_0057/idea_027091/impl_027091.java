...
@Data
public class Idea27091Config {
    private String name = "idea_027091";
 ...
 */
@Slf4j
public class Idea27091Service {
    private static final int IDEA_ID = 27091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27091Service() {
        this(new Idea27091Config());
    }

    public Idea27091Service(Idea27091Config config) {
        this.config = config != null ? config : new Idea27091Config();
