...
@Data
public class Idea27118Config {
    private String name = "idea_027118";
 ...
 */
@Slf4j
public class Idea27118Service {
    private static final int IDEA_ID = 27118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27118Service() {
        this(new Idea27118Config());
    }

    public Idea27118Service(Idea27118Config config) {
        this.config = config != null ? config : new Idea27118Config();
