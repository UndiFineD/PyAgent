...
@Data
public class Idea27419Config {
    private String name = "idea_027419";
 ...
 */
@Slf4j
public class Idea27419Service {
    private static final int IDEA_ID = 27419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27419Service() {
        this(new Idea27419Config());
    }

    public Idea27419Service(Idea27419Config config) {
        this.config = config != null ? config : new Idea27419Config();
