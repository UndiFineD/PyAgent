...
@Data
public class Idea27367Config {
    private String name = "idea_027367";
 ...
 */
@Slf4j
public class Idea27367Service {
    private static final int IDEA_ID = 27367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27367Service() {
        this(new Idea27367Config());
    }

    public Idea27367Service(Idea27367Config config) {
        this.config = config != null ? config : new Idea27367Config();
