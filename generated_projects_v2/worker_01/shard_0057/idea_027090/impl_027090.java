...
@Data
public class Idea27090Config {
    private String name = "idea_027090";
 ...
 */
@Slf4j
public class Idea27090Service {
    private static final int IDEA_ID = 27090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27090Service() {
        this(new Idea27090Config());
    }

    public Idea27090Service(Idea27090Config config) {
        this.config = config != null ? config : new Idea27090Config();
