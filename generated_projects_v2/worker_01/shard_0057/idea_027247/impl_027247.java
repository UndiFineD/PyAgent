...
@Data
public class Idea27247Config {
    private String name = "idea_027247";
 ...
 */
@Slf4j
public class Idea27247Service {
    private static final int IDEA_ID = 27247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27247Service() {
        this(new Idea27247Config());
    }

    public Idea27247Service(Idea27247Config config) {
        this.config = config != null ? config : new Idea27247Config();
