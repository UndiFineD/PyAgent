...
@Data
public class Idea27222Config {
    private String name = "idea_027222";
 ...
 */
@Slf4j
public class Idea27222Service {
    private static final int IDEA_ID = 27222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27222Service() {
        this(new Idea27222Config());
    }

    public Idea27222Service(Idea27222Config config) {
        this.config = config != null ? config : new Idea27222Config();
