...
@Data
public class Idea27480Config {
    private String name = "idea_027480";
 ...
 */
@Slf4j
public class Idea27480Service {
    private static final int IDEA_ID = 27480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27480Service() {
        this(new Idea27480Config());
    }

    public Idea27480Service(Idea27480Config config) {
        this.config = config != null ? config : new Idea27480Config();
