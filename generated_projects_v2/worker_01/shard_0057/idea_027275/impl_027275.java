...
@Data
public class Idea27275Config {
    private String name = "idea_027275";
 ...
 */
@Slf4j
public class Idea27275Service {
    private static final int IDEA_ID = 27275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27275Service() {
        this(new Idea27275Config());
    }

    public Idea27275Service(Idea27275Config config) {
        this.config = config != null ? config : new Idea27275Config();
