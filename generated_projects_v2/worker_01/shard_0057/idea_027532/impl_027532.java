...
@Data
public class Idea27532Config {
    private String name = "idea_027532";
 ...
 */
@Slf4j
public class Idea27532Service {
    private static final int IDEA_ID = 27532;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27532Service() {
        this(new Idea27532Config());
    }

    public Idea27532Service(Idea27532Config config) {
        this.config = config != null ? config : new Idea27532Config();
