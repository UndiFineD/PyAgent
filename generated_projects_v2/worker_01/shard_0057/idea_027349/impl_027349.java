...
@Data
public class Idea27349Config {
    private String name = "idea_027349";
 ...
 */
@Slf4j
public class Idea27349Service {
    private static final int IDEA_ID = 27349;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27349Service() {
        this(new Idea27349Config());
    }

    public Idea27349Service(Idea27349Config config) {
        this.config = config != null ? config : new Idea27349Config();
