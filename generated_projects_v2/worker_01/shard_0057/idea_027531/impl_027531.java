...
@Data
public class Idea27531Config {
    private String name = "idea_027531";
 ...
 */
@Slf4j
public class Idea27531Service {
    private static final int IDEA_ID = 27531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27531Service() {
        this(new Idea27531Config());
    }

    public Idea27531Service(Idea27531Config config) {
        this.config = config != null ? config : new Idea27531Config();
