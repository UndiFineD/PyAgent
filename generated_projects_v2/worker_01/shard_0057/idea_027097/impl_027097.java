...
@Data
public class Idea27097Config {
    private String name = "idea_027097";
 ...
 */
@Slf4j
public class Idea27097Service {
    private static final int IDEA_ID = 27097;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27097Service() {
        this(new Idea27097Config());
    }

    public Idea27097Service(Idea27097Config config) {
        this.config = config != null ? config : new Idea27097Config();
