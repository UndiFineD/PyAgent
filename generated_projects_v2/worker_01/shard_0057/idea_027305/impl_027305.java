...
@Data
public class Idea27305Config {
    private String name = "idea_027305";
 ...
 */
@Slf4j
public class Idea27305Service {
    private static final int IDEA_ID = 27305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27305Service() {
        this(new Idea27305Config());
    }

    public Idea27305Service(Idea27305Config config) {
        this.config = config != null ? config : new Idea27305Config();
