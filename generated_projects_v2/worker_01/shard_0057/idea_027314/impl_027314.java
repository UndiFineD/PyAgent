...
@Data
public class Idea27314Config {
    private String name = "idea_027314";
 ...
 */
@Slf4j
public class Idea27314Service {
    private static final int IDEA_ID = 27314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27314Service() {
        this(new Idea27314Config());
    }

    public Idea27314Service(Idea27314Config config) {
        this.config = config != null ? config : new Idea27314Config();
