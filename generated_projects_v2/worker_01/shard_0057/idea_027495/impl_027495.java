...
@Data
public class Idea27495Config {
    private String name = "idea_027495";
 ...
 */
@Slf4j
public class Idea27495Service {
    private static final int IDEA_ID = 27495;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27495Service() {
        this(new Idea27495Config());
    }

    public Idea27495Service(Idea27495Config config) {
        this.config = config != null ? config : new Idea27495Config();
