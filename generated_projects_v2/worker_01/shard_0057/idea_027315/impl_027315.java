...
@Data
public class Idea27315Config {
    private String name = "idea_027315";
 ...
 */
@Slf4j
public class Idea27315Service {
    private static final int IDEA_ID = 27315;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27315Service() {
        this(new Idea27315Config());
    }

    public Idea27315Service(Idea27315Config config) {
        this.config = config != null ? config : new Idea27315Config();
