...
@Data
public class Idea27360Config {
    private String name = "idea_027360";
 ...
 */
@Slf4j
public class Idea27360Service {
    private static final int IDEA_ID = 27360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27360Service() {
        this(new Idea27360Config());
    }

    public Idea27360Service(Idea27360Config config) {
        this.config = config != null ? config : new Idea27360Config();
