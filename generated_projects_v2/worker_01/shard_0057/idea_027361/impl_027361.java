...
@Data
public class Idea27361Config {
    private String name = "idea_027361";
 ...
 */
@Slf4j
public class Idea27361Service {
    private static final int IDEA_ID = 27361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27361Service() {
        this(new Idea27361Config());
    }

    public Idea27361Service(Idea27361Config config) {
        this.config = config != null ? config : new Idea27361Config();
