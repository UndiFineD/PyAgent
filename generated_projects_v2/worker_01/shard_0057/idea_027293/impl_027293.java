...
@Data
public class Idea27293Config {
    private String name = "idea_027293";
 ...
 */
@Slf4j
public class Idea27293Service {
    private static final int IDEA_ID = 27293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27293Service() {
        this(new Idea27293Config());
    }

    public Idea27293Service(Idea27293Config config) {
        this.config = config != null ? config : new Idea27293Config();
