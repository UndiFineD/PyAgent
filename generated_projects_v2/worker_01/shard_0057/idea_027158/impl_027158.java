...
@Data
public class Idea27158Config {
    private String name = "idea_027158";
 ...
 */
@Slf4j
public class Idea27158Service {
    private static final int IDEA_ID = 27158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27158Service() {
        this(new Idea27158Config());
    }

    public Idea27158Service(Idea27158Config config) {
        this.config = config != null ? config : new Idea27158Config();
