...
@Data
public class Idea27242Config {
    private String name = "idea_027242";
 ...
 */
@Slf4j
public class Idea27242Service {
    private static final int IDEA_ID = 27242;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27242Service() {
        this(new Idea27242Config());
    }

    public Idea27242Service(Idea27242Config config) {
        this.config = config != null ? config : new Idea27242Config();
