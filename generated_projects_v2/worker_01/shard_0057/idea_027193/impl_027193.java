...
@Data
public class Idea27193Config {
    private String name = "idea_027193";
 ...
 */
@Slf4j
public class Idea27193Service {
    private static final int IDEA_ID = 27193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27193Service() {
        this(new Idea27193Config());
    }

    public Idea27193Service(Idea27193Config config) {
        this.config = config != null ? config : new Idea27193Config();
