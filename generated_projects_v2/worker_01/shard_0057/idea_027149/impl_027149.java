...
@Data
public class Idea27149Config {
    private String name = "idea_027149";
 ...
 */
@Slf4j
public class Idea27149Service {
    private static final int IDEA_ID = 27149;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27149Service() {
        this(new Idea27149Config());
    }

    public Idea27149Service(Idea27149Config config) {
        this.config = config != null ? config : new Idea27149Config();
