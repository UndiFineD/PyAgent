...
@Data
public class Idea27100Config {
    private String name = "idea_027100";
 ...
 */
@Slf4j
public class Idea27100Service {
    private static final int IDEA_ID = 27100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27100Service() {
        this(new Idea27100Config());
    }

    public Idea27100Service(Idea27100Config config) {
        this.config = config != null ? config : new Idea27100Config();
