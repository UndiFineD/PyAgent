...
@Data
public class Idea27405Config {
    private String name = "idea_027405";
 ...
 */
@Slf4j
public class Idea27405Service {
    private static final int IDEA_ID = 27405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27405Service() {
        this(new Idea27405Config());
    }

    public Idea27405Service(Idea27405Config config) {
        this.config = config != null ? config : new Idea27405Config();
