...
@Data
public class Idea27546Config {
    private String name = "idea_027546";
 ...
 */
@Slf4j
public class Idea27546Service {
    private static final int IDEA_ID = 27546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27546Service() {
        this(new Idea27546Config());
    }

    public Idea27546Service(Idea27546Config config) {
        this.config = config != null ? config : new Idea27546Config();
