...
@Data
public class Idea27105Config {
    private String name = "idea_027105";
 ...
 */
@Slf4j
public class Idea27105Service {
    private static final int IDEA_ID = 27105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27105Service() {
        this(new Idea27105Config());
    }

    public Idea27105Service(Idea27105Config config) {
        this.config = config != null ? config : new Idea27105Config();
