...
@Data
public class Idea27292Config {
    private String name = "idea_027292";
 ...
 */
@Slf4j
public class Idea27292Service {
    private static final int IDEA_ID = 27292;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27292Service() {
        this(new Idea27292Config());
    }

    public Idea27292Service(Idea27292Config config) {
        this.config = config != null ? config : new Idea27292Config();
