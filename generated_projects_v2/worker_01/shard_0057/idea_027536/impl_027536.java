...
@Data
public class Idea27536Config {
    private String name = "idea_027536";
 ...
 */
@Slf4j
public class Idea27536Service {
    private static final int IDEA_ID = 27536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27536Service() {
        this(new Idea27536Config());
    }

    public Idea27536Service(Idea27536Config config) {
        this.config = config != null ? config : new Idea27536Config();
