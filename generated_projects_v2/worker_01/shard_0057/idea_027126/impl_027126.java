...
@Data
public class Idea27126Config {
    private String name = "idea_027126";
 ...
 */
@Slf4j
public class Idea27126Service {
    private static final int IDEA_ID = 27126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27126Service() {
        this(new Idea27126Config());
    }

    public Idea27126Service(Idea27126Config config) {
        this.config = config != null ? config : new Idea27126Config();
