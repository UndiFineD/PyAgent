...
@Data
public class Idea27173Config {
    private String name = "idea_027173";
 ...
 */
@Slf4j
public class Idea27173Service {
    private static final int IDEA_ID = 27173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27173Service() {
        this(new Idea27173Config());
    }

    public Idea27173Service(Idea27173Config config) {
        this.config = config != null ? config : new Idea27173Config();
