...
@Data
public class Idea27194Config {
    private String name = "idea_027194";
 ...
 */
@Slf4j
public class Idea27194Service {
    private static final int IDEA_ID = 27194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27194Service() {
        this(new Idea27194Config());
    }

    public Idea27194Service(Idea27194Config config) {
        this.config = config != null ? config : new Idea27194Config();
