...
@Data
public class Idea27216Config {
    private String name = "idea_027216";
 ...
 */
@Slf4j
public class Idea27216Service {
    private static final int IDEA_ID = 27216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27216Service() {
        this(new Idea27216Config());
    }

    public Idea27216Service(Idea27216Config config) {
        this.config = config != null ? config : new Idea27216Config();
