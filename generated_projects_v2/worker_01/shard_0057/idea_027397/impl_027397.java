...
@Data
public class Idea27397Config {
    private String name = "idea_027397";
 ...
 */
@Slf4j
public class Idea27397Service {
    private static final int IDEA_ID = 27397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27397Service() {
        this(new Idea27397Config());
    }

    public Idea27397Service(Idea27397Config config) {
        this.config = config != null ? config : new Idea27397Config();
