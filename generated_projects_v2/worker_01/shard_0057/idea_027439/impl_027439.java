...
@Data
public class Idea27439Config {
    private String name = "idea_027439";
 ...
 */
@Slf4j
public class Idea27439Service {
    private static final int IDEA_ID = 27439;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27439Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27439Service() {
        this(new Idea27439Config());
    }

    public Idea27439Service(Idea27439Config config) {
        this.config = config != null ? config : new Idea27439Config();
