...
@Data
public class Idea27458Config {
    private String name = "idea_027458";
 ...
 */
@Slf4j
public class Idea27458Service {
    private static final int IDEA_ID = 27458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27458Service() {
        this(new Idea27458Config());
    }

    public Idea27458Service(Idea27458Config config) {
        this.config = config != null ? config : new Idea27458Config();
