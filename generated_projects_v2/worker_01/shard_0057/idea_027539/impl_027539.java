...
@Data
public class Idea27539Config {
    private String name = "idea_027539";
 ...
 */
@Slf4j
public class Idea27539Service {
    private static final int IDEA_ID = 27539;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27539Service() {
        this(new Idea27539Config());
    }

    public Idea27539Service(Idea27539Config config) {
        this.config = config != null ? config : new Idea27539Config();
