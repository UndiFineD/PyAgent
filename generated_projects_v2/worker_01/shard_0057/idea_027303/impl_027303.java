...
@Data
public class Idea27303Config {
    private String name = "idea_027303";
 ...
 */
@Slf4j
public class Idea27303Service {
    private static final int IDEA_ID = 27303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27303Service() {
        this(new Idea27303Config());
    }

    public Idea27303Service(Idea27303Config config) {
        this.config = config != null ? config : new Idea27303Config();
