...
@Data
public class Idea27225Config {
    private String name = "idea_027225";
 ...
 */
@Slf4j
public class Idea27225Service {
    private static final int IDEA_ID = 27225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27225Service() {
        this(new Idea27225Config());
    }

    public Idea27225Service(Idea27225Config config) {
        this.config = config != null ? config : new Idea27225Config();
