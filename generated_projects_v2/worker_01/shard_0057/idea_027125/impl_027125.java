...
@Data
public class Idea27125Config {
    private String name = "idea_027125";
 ...
 */
@Slf4j
public class Idea27125Service {
    private static final int IDEA_ID = 27125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27125Service() {
        this(new Idea27125Config());
    }

    public Idea27125Service(Idea27125Config config) {
        this.config = config != null ? config : new Idea27125Config();
