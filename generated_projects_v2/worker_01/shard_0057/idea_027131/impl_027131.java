...
@Data
public class Idea27131Config {
    private String name = "idea_027131";
 ...
 */
@Slf4j
public class Idea27131Service {
    private static final int IDEA_ID = 27131;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27131Service() {
        this(new Idea27131Config());
    }

    public Idea27131Service(Idea27131Config config) {
        this.config = config != null ? config : new Idea27131Config();
