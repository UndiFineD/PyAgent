...
@Data
public class Idea27106Config {
    private String name = "idea_027106";
 ...
 */
@Slf4j
public class Idea27106Service {
    private static final int IDEA_ID = 27106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27106Service() {
        this(new Idea27106Config());
    }

    public Idea27106Service(Idea27106Config config) {
        this.config = config != null ? config : new Idea27106Config();
