...
@Data
public class Idea27288Config {
    private String name = "idea_027288";
 ...
 */
@Slf4j
public class Idea27288Service {
    private static final int IDEA_ID = 27288;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27288Service() {
        this(new Idea27288Config());
    }

    public Idea27288Service(Idea27288Config config) {
        this.config = config != null ? config : new Idea27288Config();
