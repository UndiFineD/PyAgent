...
@Data
public class Idea27504Config {
    private String name = "idea_027504";
 ...
 */
@Slf4j
public class Idea27504Service {
    private static final int IDEA_ID = 27504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27504Service() {
        this(new Idea27504Config());
    }

    public Idea27504Service(Idea27504Config config) {
        this.config = config != null ? config : new Idea27504Config();
