...
@Data
public class Idea27278Config {
    private String name = "idea_027278";
 ...
 */
@Slf4j
public class Idea27278Service {
    private static final int IDEA_ID = 27278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27278Service() {
        this(new Idea27278Config());
    }

    public Idea27278Service(Idea27278Config config) {
        this.config = config != null ? config : new Idea27278Config();
