...
@Data
public class Idea27164Config {
    private String name = "idea_027164";
 ...
 */
@Slf4j
public class Idea27164Service {
    private static final int IDEA_ID = 27164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27164Service() {
        this(new Idea27164Config());
    }

    public Idea27164Service(Idea27164Config config) {
        this.config = config != null ? config : new Idea27164Config();
