...
@Data
public class Idea27514Config {
    private String name = "idea_027514";
 ...
 */
@Slf4j
public class Idea27514Service {
    private static final int IDEA_ID = 27514;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27514Service() {
        this(new Idea27514Config());
    }

    public Idea27514Service(Idea27514Config config) {
        this.config = config != null ? config : new Idea27514Config();
