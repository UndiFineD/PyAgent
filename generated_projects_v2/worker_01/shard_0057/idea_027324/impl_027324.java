...
@Data
public class Idea27324Config {
    private String name = "idea_027324";
 ...
 */
@Slf4j
public class Idea27324Service {
    private static final int IDEA_ID = 27324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27324Service() {
        this(new Idea27324Config());
    }

    public Idea27324Service(Idea27324Config config) {
        this.config = config != null ? config : new Idea27324Config();
