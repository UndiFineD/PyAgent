...
@Data
public class Idea27432Config {
    private String name = "idea_027432";
 ...
 */
@Slf4j
public class Idea27432Service {
    private static final int IDEA_ID = 27432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27432Service() {
        this(new Idea27432Config());
    }

    public Idea27432Service(Idea27432Config config) {
        this.config = config != null ? config : new Idea27432Config();
