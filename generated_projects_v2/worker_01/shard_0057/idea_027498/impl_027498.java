...
@Data
public class Idea27498Config {
    private String name = "idea_027498";
 ...
 */
@Slf4j
public class Idea27498Service {
    private static final int IDEA_ID = 27498;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27498Service() {
        this(new Idea27498Config());
    }

    public Idea27498Service(Idea27498Config config) {
        this.config = config != null ? config : new Idea27498Config();
