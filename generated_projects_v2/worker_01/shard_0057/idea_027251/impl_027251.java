...
@Data
public class Idea27251Config {
    private String name = "idea_027251";
 ...
 */
@Slf4j
public class Idea27251Service {
    private static final int IDEA_ID = 27251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27251Service() {
        this(new Idea27251Config());
    }

    public Idea27251Service(Idea27251Config config) {
        this.config = config != null ? config : new Idea27251Config();
