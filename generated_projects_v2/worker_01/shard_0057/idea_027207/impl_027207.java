...
@Data
public class Idea27207Config {
    private String name = "idea_027207";
 ...
 */
@Slf4j
public class Idea27207Service {
    private static final int IDEA_ID = 27207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27207Service() {
        this(new Idea27207Config());
    }

    public Idea27207Service(Idea27207Config config) {
        this.config = config != null ? config : new Idea27207Config();
