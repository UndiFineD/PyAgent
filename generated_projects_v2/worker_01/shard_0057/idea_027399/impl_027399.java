...
@Data
public class Idea27399Config {
    private String name = "idea_027399";
 ...
 */
@Slf4j
public class Idea27399Service {
    private static final int IDEA_ID = 27399;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27399Service() {
        this(new Idea27399Config());
    }

    public Idea27399Service(Idea27399Config config) {
        this.config = config != null ? config : new Idea27399Config();
