...
@Data
public class Idea27123Config {
    private String name = "idea_027123";
 ...
 */
@Slf4j
public class Idea27123Service {
    private static final int IDEA_ID = 27123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27123Service() {
        this(new Idea27123Config());
    }

    public Idea27123Service(Idea27123Config config) {
        this.config = config != null ? config : new Idea27123Config();
