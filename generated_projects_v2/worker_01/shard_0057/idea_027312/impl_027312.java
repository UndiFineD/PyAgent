...
@Data
public class Idea27312Config {
    private String name = "idea_027312";
 ...
 */
@Slf4j
public class Idea27312Service {
    private static final int IDEA_ID = 27312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27312Service() {
        this(new Idea27312Config());
    }

    public Idea27312Service(Idea27312Config config) {
        this.config = config != null ? config : new Idea27312Config();
