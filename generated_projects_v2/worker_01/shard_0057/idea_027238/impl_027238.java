...
@Data
public class Idea27238Config {
    private String name = "idea_027238";
 ...
 */
@Slf4j
public class Idea27238Service {
    private static final int IDEA_ID = 27238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27238Service() {
        this(new Idea27238Config());
    }

    public Idea27238Service(Idea27238Config config) {
        this.config = config != null ? config : new Idea27238Config();
