...
@Data
public class Idea27252Config {
    private String name = "idea_027252";
 ...
 */
@Slf4j
public class Idea27252Service {
    private static final int IDEA_ID = 27252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27252Service() {
        this(new Idea27252Config());
    }

    public Idea27252Service(Idea27252Config config) {
        this.config = config != null ? config : new Idea27252Config();
