...
@Data
public class Idea27274Config {
    private String name = "idea_027274";
 ...
 */
@Slf4j
public class Idea27274Service {
    private static final int IDEA_ID = 27274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27274Service() {
        this(new Idea27274Config());
    }

    public Idea27274Service(Idea27274Config config) {
        this.config = config != null ? config : new Idea27274Config();
