...
@Data
public class Idea27220Config {
    private String name = "idea_027220";
 ...
 */
@Slf4j
public class Idea27220Service {
    private static final int IDEA_ID = 27220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27220Service() {
        this(new Idea27220Config());
    }

    public Idea27220Service(Idea27220Config config) {
        this.config = config != null ? config : new Idea27220Config();
