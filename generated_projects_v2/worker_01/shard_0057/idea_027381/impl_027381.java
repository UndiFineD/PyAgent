...
@Data
public class Idea27381Config {
    private String name = "idea_027381";
 ...
 */
@Slf4j
public class Idea27381Service {
    private static final int IDEA_ID = 27381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27381Service() {
        this(new Idea27381Config());
    }

    public Idea27381Service(Idea27381Config config) {
        this.config = config != null ? config : new Idea27381Config();
