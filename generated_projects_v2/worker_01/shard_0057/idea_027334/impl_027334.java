...
@Data
public class Idea27334Config {
    private String name = "idea_027334";
 ...
 */
@Slf4j
public class Idea27334Service {
    private static final int IDEA_ID = 27334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27334Service() {
        this(new Idea27334Config());
    }

    public Idea27334Service(Idea27334Config config) {
        this.config = config != null ? config : new Idea27334Config();
