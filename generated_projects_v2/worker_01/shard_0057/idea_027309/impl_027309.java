...
@Data
public class Idea27309Config {
    private String name = "idea_027309";
 ...
 */
@Slf4j
public class Idea27309Service {
    private static final int IDEA_ID = 27309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27309Service() {
        this(new Idea27309Config());
    }

    public Idea27309Service(Idea27309Config config) {
        this.config = config != null ? config : new Idea27309Config();
