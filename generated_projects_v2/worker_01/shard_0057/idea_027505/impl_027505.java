...
@Data
public class Idea27505Config {
    private String name = "idea_027505";
 ...
 */
@Slf4j
public class Idea27505Service {
    private static final int IDEA_ID = 27505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27505Service() {
        this(new Idea27505Config());
    }

    public Idea27505Service(Idea27505Config config) {
        this.config = config != null ? config : new Idea27505Config();
