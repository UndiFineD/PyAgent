...
@Data
public class Idea27421Config {
    private String name = "idea_027421";
 ...
 */
@Slf4j
public class Idea27421Service {
    private static final int IDEA_ID = 27421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27421Service() {
        this(new Idea27421Config());
    }

    public Idea27421Service(Idea27421Config config) {
        this.config = config != null ? config : new Idea27421Config();
