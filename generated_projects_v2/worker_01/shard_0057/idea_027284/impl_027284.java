...
@Data
public class Idea27284Config {
    private String name = "idea_027284";
 ...
 */
@Slf4j
public class Idea27284Service {
    private static final int IDEA_ID = 27284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27284Service() {
        this(new Idea27284Config());
    }

    public Idea27284Service(Idea27284Config config) {
        this.config = config != null ? config : new Idea27284Config();
