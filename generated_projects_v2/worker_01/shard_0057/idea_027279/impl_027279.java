...
@Data
public class Idea27279Config {
    private String name = "idea_027279";
 ...
 */
@Slf4j
public class Idea27279Service {
    private static final int IDEA_ID = 27279;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27279Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27279Service() {
        this(new Idea27279Config());
    }

    public Idea27279Service(Idea27279Config config) {
        this.config = config != null ? config : new Idea27279Config();
