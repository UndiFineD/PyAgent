...
@Data
public class Idea27151Config {
    private String name = "idea_027151";
 ...
 */
@Slf4j
public class Idea27151Service {
    private static final int IDEA_ID = 27151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27151Service() {
        this(new Idea27151Config());
    }

    public Idea27151Service(Idea27151Config config) {
        this.config = config != null ? config : new Idea27151Config();
