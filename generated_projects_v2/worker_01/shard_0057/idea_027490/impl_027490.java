...
@Data
public class Idea27490Config {
    private String name = "idea_027490";
 ...
 */
@Slf4j
public class Idea27490Service {
    private static final int IDEA_ID = 27490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27490Service() {
        this(new Idea27490Config());
    }

    public Idea27490Service(Idea27490Config config) {
        this.config = config != null ? config : new Idea27490Config();
