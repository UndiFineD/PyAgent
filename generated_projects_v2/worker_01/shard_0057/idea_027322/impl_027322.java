...
@Data
public class Idea27322Config {
    private String name = "idea_027322";
 ...
 */
@Slf4j
public class Idea27322Service {
    private static final int IDEA_ID = 27322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27322Service() {
        this(new Idea27322Config());
    }

    public Idea27322Service(Idea27322Config config) {
        this.config = config != null ? config : new Idea27322Config();
