...
@Data
public class Idea27171Config {
    private String name = "idea_027171";
 ...
 */
@Slf4j
public class Idea27171Service {
    private static final int IDEA_ID = 27171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27171Service() {
        this(new Idea27171Config());
    }

    public Idea27171Service(Idea27171Config config) {
        this.config = config != null ? config : new Idea27171Config();
