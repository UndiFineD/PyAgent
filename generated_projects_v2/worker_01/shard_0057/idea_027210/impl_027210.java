...
@Data
public class Idea27210Config {
    private String name = "idea_027210";
 ...
 */
@Slf4j
public class Idea27210Service {
    private static final int IDEA_ID = 27210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27210Service() {
        this(new Idea27210Config());
    }

    public Idea27210Service(Idea27210Config config) {
        this.config = config != null ? config : new Idea27210Config();
