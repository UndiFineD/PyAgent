...
@Data
public class Idea27384Config {
    private String name = "idea_027384";
 ...
 */
@Slf4j
public class Idea27384Service {
    private static final int IDEA_ID = 27384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27384Service() {
        this(new Idea27384Config());
    }

    public Idea27384Service(Idea27384Config config) {
        this.config = config != null ? config : new Idea27384Config();
