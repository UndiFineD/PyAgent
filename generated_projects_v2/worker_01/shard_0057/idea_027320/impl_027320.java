...
@Data
public class Idea27320Config {
    private String name = "idea_027320";
 ...
 */
@Slf4j
public class Idea27320Service {
    private static final int IDEA_ID = 27320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27320Service() {
        this(new Idea27320Config());
    }

    public Idea27320Service(Idea27320Config config) {
        this.config = config != null ? config : new Idea27320Config();
