...
@Data
public class Idea27451Config {
    private String name = "idea_027451";
 ...
 */
@Slf4j
public class Idea27451Service {
    private static final int IDEA_ID = 27451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27451Service() {
        this(new Idea27451Config());
    }

    public Idea27451Service(Idea27451Config config) {
        this.config = config != null ? config : new Idea27451Config();
