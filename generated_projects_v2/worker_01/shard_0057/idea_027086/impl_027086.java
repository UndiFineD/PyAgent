...
@Data
public class Idea27086Config {
    private String name = "idea_027086";
 ...
 */
@Slf4j
public class Idea27086Service {
    private static final int IDEA_ID = 27086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27086Service() {
        this(new Idea27086Config());
    }

    public Idea27086Service(Idea27086Config config) {
        this.config = config != null ? config : new Idea27086Config();
