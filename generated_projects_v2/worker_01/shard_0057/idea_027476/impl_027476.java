...
@Data
public class Idea27476Config {
    private String name = "idea_027476";
 ...
 */
@Slf4j
public class Idea27476Service {
    private static final int IDEA_ID = 27476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27476Service() {
        this(new Idea27476Config());
    }

    public Idea27476Service(Idea27476Config config) {
        this.config = config != null ? config : new Idea27476Config();
