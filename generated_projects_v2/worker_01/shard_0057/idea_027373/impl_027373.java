...
@Data
public class Idea27373Config {
    private String name = "idea_027373";
 ...
 */
@Slf4j
public class Idea27373Service {
    private static final int IDEA_ID = 27373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27373Service() {
        this(new Idea27373Config());
    }

    public Idea27373Service(Idea27373Config config) {
        this.config = config != null ? config : new Idea27373Config();
