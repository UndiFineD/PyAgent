...
@Data
public class Idea27174Config {
    private String name = "idea_027174";
 ...
 */
@Slf4j
public class Idea27174Service {
    private static final int IDEA_ID = 27174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27174Service() {
        this(new Idea27174Config());
    }

    public Idea27174Service(Idea27174Config config) {
        this.config = config != null ? config : new Idea27174Config();
