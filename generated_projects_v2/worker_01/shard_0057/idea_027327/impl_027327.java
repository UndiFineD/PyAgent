...
@Data
public class Idea27327Config {
    private String name = "idea_027327";
 ...
 */
@Slf4j
public class Idea27327Service {
    private static final int IDEA_ID = 27327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27327Service() {
        this(new Idea27327Config());
    }

    public Idea27327Service(Idea27327Config config) {
        this.config = config != null ? config : new Idea27327Config();
