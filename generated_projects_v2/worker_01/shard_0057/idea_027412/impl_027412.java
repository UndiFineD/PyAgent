...
@Data
public class Idea27412Config {
    private String name = "idea_027412";
 ...
 */
@Slf4j
public class Idea27412Service {
    private static final int IDEA_ID = 27412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27412Service() {
        this(new Idea27412Config());
    }

    public Idea27412Service(Idea27412Config config) {
        this.config = config != null ? config : new Idea27412Config();
