...
@Data
public class Idea27377Config {
    private String name = "idea_027377";
 ...
 */
@Slf4j
public class Idea27377Service {
    private static final int IDEA_ID = 27377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27377Service() {
        this(new Idea27377Config());
    }

    public Idea27377Service(Idea27377Config config) {
        this.config = config != null ? config : new Idea27377Config();
