...
@Data
public class Idea27101Config {
    private String name = "idea_027101";
 ...
 */
@Slf4j
public class Idea27101Service {
    private static final int IDEA_ID = 27101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27101Service() {
        this(new Idea27101Config());
    }

    public Idea27101Service(Idea27101Config config) {
        this.config = config != null ? config : new Idea27101Config();
