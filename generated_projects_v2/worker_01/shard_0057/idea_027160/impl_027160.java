...
@Data
public class Idea27160Config {
    private String name = "idea_027160";
 ...
 */
@Slf4j
public class Idea27160Service {
    private static final int IDEA_ID = 27160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27160Service() {
        this(new Idea27160Config());
    }

    public Idea27160Service(Idea27160Config config) {
        this.config = config != null ? config : new Idea27160Config();
