...
@Data
public class Idea27489Config {
    private String name = "idea_027489";
 ...
 */
@Slf4j
public class Idea27489Service {
    private static final int IDEA_ID = 27489;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27489Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27489Service() {
        this(new Idea27489Config());
    }

    public Idea27489Service(Idea27489Config config) {
        this.config = config != null ? config : new Idea27489Config();
