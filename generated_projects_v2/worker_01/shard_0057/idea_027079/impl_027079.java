...
@Data
public class Idea27079Config {
    private String name = "idea_027079";
 ...
 */
@Slf4j
public class Idea27079Service {
    private static final int IDEA_ID = 27079;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27079Service() {
        this(new Idea27079Config());
    }

    public Idea27079Service(Idea27079Config config) {
        this.config = config != null ? config : new Idea27079Config();
