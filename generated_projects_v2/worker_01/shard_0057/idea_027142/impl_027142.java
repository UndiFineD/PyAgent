...
@Data
public class Idea27142Config {
    private String name = "idea_027142";
 ...
 */
@Slf4j
public class Idea27142Service {
    private static final int IDEA_ID = 27142;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27142Service() {
        this(new Idea27142Config());
    }

    public Idea27142Service(Idea27142Config config) {
        this.config = config != null ? config : new Idea27142Config();
