...
@Data
public class Idea27219Config {
    private String name = "idea_027219";
 ...
 */
@Slf4j
public class Idea27219Service {
    private static final int IDEA_ID = 27219;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27219Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27219Service() {
        this(new Idea27219Config());
    }

    public Idea27219Service(Idea27219Config config) {
        this.config = config != null ? config : new Idea27219Config();
