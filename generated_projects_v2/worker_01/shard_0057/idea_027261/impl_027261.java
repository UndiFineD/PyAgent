...
@Data
public class Idea27261Config {
    private String name = "idea_027261";
 ...
 */
@Slf4j
public class Idea27261Service {
    private static final int IDEA_ID = 27261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27261Service() {
        this(new Idea27261Config());
    }

    public Idea27261Service(Idea27261Config config) {
        this.config = config != null ? config : new Idea27261Config();
