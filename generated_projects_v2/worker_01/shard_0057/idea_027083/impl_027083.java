...
@Data
public class Idea27083Config {
    private String name = "idea_027083";
 ...
 */
@Slf4j
public class Idea27083Service {
    private static final int IDEA_ID = 27083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27083Service() {
        this(new Idea27083Config());
    }

    public Idea27083Service(Idea27083Config config) {
        this.config = config != null ? config : new Idea27083Config();
