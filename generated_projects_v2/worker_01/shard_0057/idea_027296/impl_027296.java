...
@Data
public class Idea27296Config {
    private String name = "idea_027296";
 ...
 */
@Slf4j
public class Idea27296Service {
    private static final int IDEA_ID = 27296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27296Service() {
        this(new Idea27296Config());
    }

    public Idea27296Service(Idea27296Config config) {
        this.config = config != null ? config : new Idea27296Config();
