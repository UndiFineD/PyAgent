...
@Data
public class Idea27486Config {
    private String name = "idea_027486";
 ...
 */
@Slf4j
public class Idea27486Service {
    private static final int IDEA_ID = 27486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27486Service() {
        this(new Idea27486Config());
    }

    public Idea27486Service(Idea27486Config config) {
        this.config = config != null ? config : new Idea27486Config();
