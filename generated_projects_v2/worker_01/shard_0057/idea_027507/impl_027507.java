...
@Data
public class Idea27507Config {
    private String name = "idea_027507";
 ...
 */
@Slf4j
public class Idea27507Service {
    private static final int IDEA_ID = 27507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27507Service() {
        this(new Idea27507Config());
    }

    public Idea27507Service(Idea27507Config config) {
        this.config = config != null ? config : new Idea27507Config();
