...
@Data
public class Idea27538Config {
    private String name = "idea_027538";
 ...
 */
@Slf4j
public class Idea27538Service {
    private static final int IDEA_ID = 27538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27538Service() {
        this(new Idea27538Config());
    }

    public Idea27538Service(Idea27538Config config) {
        this.config = config != null ? config : new Idea27538Config();
