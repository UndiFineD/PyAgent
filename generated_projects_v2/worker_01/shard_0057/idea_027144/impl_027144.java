...
@Data
public class Idea27144Config {
    private String name = "idea_027144";
 ...
 */
@Slf4j
public class Idea27144Service {
    private static final int IDEA_ID = 27144;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27144Service() {
        this(new Idea27144Config());
    }

    public Idea27144Service(Idea27144Config config) {
        this.config = config != null ? config : new Idea27144Config();
