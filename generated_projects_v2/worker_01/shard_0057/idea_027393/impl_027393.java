...
@Data
public class Idea27393Config {
    private String name = "idea_027393";
 ...
 */
@Slf4j
public class Idea27393Service {
    private static final int IDEA_ID = 27393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27393Service() {
        this(new Idea27393Config());
    }

    public Idea27393Service(Idea27393Config config) {
        this.config = config != null ? config : new Idea27393Config();
