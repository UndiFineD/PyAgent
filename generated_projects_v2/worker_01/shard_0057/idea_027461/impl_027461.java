...
@Data
public class Idea27461Config {
    private String name = "idea_027461";
 ...
 */
@Slf4j
public class Idea27461Service {
    private static final int IDEA_ID = 27461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27461Service() {
        this(new Idea27461Config());
    }

    public Idea27461Service(Idea27461Config config) {
        this.config = config != null ? config : new Idea27461Config();
