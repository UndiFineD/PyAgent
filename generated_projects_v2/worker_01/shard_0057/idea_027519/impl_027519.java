...
@Data
public class Idea27519Config {
    private String name = "idea_027519";
 ...
 */
@Slf4j
public class Idea27519Service {
    private static final int IDEA_ID = 27519;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27519Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27519Service() {
        this(new Idea27519Config());
    }

    public Idea27519Service(Idea27519Config config) {
        this.config = config != null ? config : new Idea27519Config();
