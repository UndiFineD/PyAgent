...
@Data
public class Idea27337Config {
    private String name = "idea_027337";
 ...
 */
@Slf4j
public class Idea27337Service {
    private static final int IDEA_ID = 27337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27337Service() {
        this(new Idea27337Config());
    }

    public Idea27337Service(Idea27337Config config) {
        this.config = config != null ? config : new Idea27337Config();
