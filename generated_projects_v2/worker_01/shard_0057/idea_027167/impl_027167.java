...
@Data
public class Idea27167Config {
    private String name = "idea_027167";
 ...
 */
@Slf4j
public class Idea27167Service {
    private static final int IDEA_ID = 27167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27167Service() {
        this(new Idea27167Config());
    }

    public Idea27167Service(Idea27167Config config) {
        this.config = config != null ? config : new Idea27167Config();
