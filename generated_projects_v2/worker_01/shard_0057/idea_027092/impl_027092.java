...
@Data
public class Idea27092Config {
    private String name = "idea_027092";
 ...
 */
@Slf4j
public class Idea27092Service {
    private static final int IDEA_ID = 27092;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27092Service() {
        this(new Idea27092Config());
    }

    public Idea27092Service(Idea27092Config config) {
        this.config = config != null ? config : new Idea27092Config();
