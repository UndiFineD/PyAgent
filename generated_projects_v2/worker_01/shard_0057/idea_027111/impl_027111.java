...
@Data
public class Idea27111Config {
    private String name = "idea_027111";
 ...
 */
@Slf4j
public class Idea27111Service {
    private static final int IDEA_ID = 27111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27111Service() {
        this(new Idea27111Config());
    }

    public Idea27111Service(Idea27111Config config) {
        this.config = config != null ? config : new Idea27111Config();
