...
@Data
public class Idea27400Config {
    private String name = "idea_027400";
 ...
 */
@Slf4j
public class Idea27400Service {
    private static final int IDEA_ID = 27400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27400Service() {
        this(new Idea27400Config());
    }

    public Idea27400Service(Idea27400Config config) {
        this.config = config != null ? config : new Idea27400Config();
