...
@Data
public class Idea27202Config {
    private String name = "idea_027202";
 ...
 */
@Slf4j
public class Idea27202Service {
    private static final int IDEA_ID = 27202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27202Service() {
        this(new Idea27202Config());
    }

    public Idea27202Service(Idea27202Config config) {
        this.config = config != null ? config : new Idea27202Config();
