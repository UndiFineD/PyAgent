...
@Data
public class Idea27483Config {
    private String name = "idea_027483";
 ...
 */
@Slf4j
public class Idea27483Service {
    private static final int IDEA_ID = 27483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27483Service() {
        this(new Idea27483Config());
    }

    public Idea27483Service(Idea27483Config config) {
        this.config = config != null ? config : new Idea27483Config();
