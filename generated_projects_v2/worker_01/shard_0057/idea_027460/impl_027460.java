...
@Data
public class Idea27460Config {
    private String name = "idea_027460";
 ...
 */
@Slf4j
public class Idea27460Service {
    private static final int IDEA_ID = 27460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27460Service() {
        this(new Idea27460Config());
    }

    public Idea27460Service(Idea27460Config config) {
        this.config = config != null ? config : new Idea27460Config();
