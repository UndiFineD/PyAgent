...
@Data
public class Idea27246Config {
    private String name = "idea_027246";
 ...
 */
@Slf4j
public class Idea27246Service {
    private static final int IDEA_ID = 27246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27246Service() {
        this(new Idea27246Config());
    }

    public Idea27246Service(Idea27246Config config) {
        this.config = config != null ? config : new Idea27246Config();
