...
@Data
public class Idea27369Config {
    private String name = "idea_027369";
 ...
 */
@Slf4j
public class Idea27369Service {
    private static final int IDEA_ID = 27369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27369Service() {
        this(new Idea27369Config());
    }

    public Idea27369Service(Idea27369Config config) {
        this.config = config != null ? config : new Idea27369Config();
