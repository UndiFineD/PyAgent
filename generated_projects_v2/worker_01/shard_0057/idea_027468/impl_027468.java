...
@Data
public class Idea27468Config {
    private String name = "idea_027468";
 ...
 */
@Slf4j
public class Idea27468Service {
    private static final int IDEA_ID = 27468;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27468Service() {
        this(new Idea27468Config());
    }

    public Idea27468Service(Idea27468Config config) {
        this.config = config != null ? config : new Idea27468Config();
