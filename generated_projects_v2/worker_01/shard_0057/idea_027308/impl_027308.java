...
@Data
public class Idea27308Config {
    private String name = "idea_027308";
 ...
 */
@Slf4j
public class Idea27308Service {
    private static final int IDEA_ID = 27308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27308Service() {
        this(new Idea27308Config());
    }

    public Idea27308Service(Idea27308Config config) {
        this.config = config != null ? config : new Idea27308Config();
