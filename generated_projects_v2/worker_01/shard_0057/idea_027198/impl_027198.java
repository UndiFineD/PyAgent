...
@Data
public class Idea27198Config {
    private String name = "idea_027198";
 ...
 */
@Slf4j
public class Idea27198Service {
    private static final int IDEA_ID = 27198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27198Service() {
        this(new Idea27198Config());
    }

    public Idea27198Service(Idea27198Config config) {
        this.config = config != null ? config : new Idea27198Config();
