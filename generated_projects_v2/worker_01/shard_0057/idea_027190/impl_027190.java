...
@Data
public class Idea27190Config {
    private String name = "idea_027190";
 ...
 */
@Slf4j
public class Idea27190Service {
    private static final int IDEA_ID = 27190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27190Service() {
        this(new Idea27190Config());
    }

    public Idea27190Service(Idea27190Config config) {
        this.config = config != null ? config : new Idea27190Config();
