...
@Data
public class Idea27374Config {
    private String name = "idea_027374";
 ...
 */
@Slf4j
public class Idea27374Service {
    private static final int IDEA_ID = 27374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27374Service() {
        this(new Idea27374Config());
    }

    public Idea27374Service(Idea27374Config config) {
        this.config = config != null ? config : new Idea27374Config();
