...
@Data
public class Idea27441Config {
    private String name = "idea_027441";
 ...
 */
@Slf4j
public class Idea27441Service {
    private static final int IDEA_ID = 27441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27441Service() {
        this(new Idea27441Config());
    }

    public Idea27441Service(Idea27441Config config) {
        this.config = config != null ? config : new Idea27441Config();
