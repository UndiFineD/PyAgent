...
@Data
public class Idea27545Config {
    private String name = "idea_027545";
 ...
 */
@Slf4j
public class Idea27545Service {
    private static final int IDEA_ID = 27545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27545Service() {
        this(new Idea27545Config());
    }

    public Idea27545Service(Idea27545Config config) {
        this.config = config != null ? config : new Idea27545Config();
