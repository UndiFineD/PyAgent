...
@Data
public class Idea27280Config {
    private String name = "idea_027280";
 ...
 */
@Slf4j
public class Idea27280Service {
    private static final int IDEA_ID = 27280;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27280Service() {
        this(new Idea27280Config());
    }

    public Idea27280Service(Idea27280Config config) {
        this.config = config != null ? config : new Idea27280Config();
