...
@Data
public class Idea27510Config {
    private String name = "idea_027510";
 ...
 */
@Slf4j
public class Idea27510Service {
    private static final int IDEA_ID = 27510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27510Service() {
        this(new Idea27510Config());
    }

    public Idea27510Service(Idea27510Config config) {
        this.config = config != null ? config : new Idea27510Config();
