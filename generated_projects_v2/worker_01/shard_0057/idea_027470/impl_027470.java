...
@Data
public class Idea27470Config {
    private String name = "idea_027470";
 ...
 */
@Slf4j
public class Idea27470Service {
    private static final int IDEA_ID = 27470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27470Service() {
        this(new Idea27470Config());
    }

    public Idea27470Service(Idea27470Config config) {
        this.config = config != null ? config : new Idea27470Config();
