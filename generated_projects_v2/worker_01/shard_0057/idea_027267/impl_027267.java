...
@Data
public class Idea27267Config {
    private String name = "idea_027267";
 ...
 */
@Slf4j
public class Idea27267Service {
    private static final int IDEA_ID = 27267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27267Service() {
        this(new Idea27267Config());
    }

    public Idea27267Service(Idea27267Config config) {
        this.config = config != null ? config : new Idea27267Config();
