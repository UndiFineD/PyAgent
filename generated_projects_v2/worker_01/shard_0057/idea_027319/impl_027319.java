...
@Data
public class Idea27319Config {
    private String name = "idea_027319";
 ...
 */
@Slf4j
public class Idea27319Service {
    private static final int IDEA_ID = 27319;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27319Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27319Service() {
        this(new Idea27319Config());
    }

    public Idea27319Service(Idea27319Config config) {
        this.config = config != null ? config : new Idea27319Config();
