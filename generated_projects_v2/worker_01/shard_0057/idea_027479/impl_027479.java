...
@Data
public class Idea27479Config {
    private String name = "idea_027479";
 ...
 */
@Slf4j
public class Idea27479Service {
    private static final int IDEA_ID = 27479;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27479Service() {
        this(new Idea27479Config());
    }

    public Idea27479Service(Idea27479Config config) {
        this.config = config != null ? config : new Idea27479Config();
