...
@Data
public class Idea27120Config {
    private String name = "idea_027120";
 ...
 */
@Slf4j
public class Idea27120Service {
    private static final int IDEA_ID = 27120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27120Service() {
        this(new Idea27120Config());
    }

    public Idea27120Service(Idea27120Config config) {
        this.config = config != null ? config : new Idea27120Config();
