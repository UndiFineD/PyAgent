...
@Data
public class Idea27516Config {
    private String name = "idea_027516";
 ...
 */
@Slf4j
public class Idea27516Service {
    private static final int IDEA_ID = 27516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27516Service() {
        this(new Idea27516Config());
    }

    public Idea27516Service(Idea27516Config config) {
        this.config = config != null ? config : new Idea27516Config();
