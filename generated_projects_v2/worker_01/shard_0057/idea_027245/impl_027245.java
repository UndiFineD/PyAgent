...
@Data
public class Idea27245Config {
    private String name = "idea_027245";
 ...
 */
@Slf4j
public class Idea27245Service {
    private static final int IDEA_ID = 27245;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27245Service() {
        this(new Idea27245Config());
    }

    public Idea27245Service(Idea27245Config config) {
        this.config = config != null ? config : new Idea27245Config();
