...
@Data
public class Idea27266Config {
    private String name = "idea_027266";
 ...
 */
@Slf4j
public class Idea27266Service {
    private static final int IDEA_ID = 27266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27266Service() {
        this(new Idea27266Config());
    }

    public Idea27266Service(Idea27266Config config) {
        this.config = config != null ? config : new Idea27266Config();
