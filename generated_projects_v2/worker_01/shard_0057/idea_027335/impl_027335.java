...
@Data
public class Idea27335Config {
    private String name = "idea_027335";
 ...
 */
@Slf4j
public class Idea27335Service {
    private static final int IDEA_ID = 27335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27335Service() {
        this(new Idea27335Config());
    }

    public Idea27335Service(Idea27335Config config) {
        this.config = config != null ? config : new Idea27335Config();
