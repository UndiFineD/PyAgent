...
@Data
public class Idea27301Config {
    private String name = "idea_027301";
 ...
 */
@Slf4j
public class Idea27301Service {
    private static final int IDEA_ID = 27301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27301Service() {
        this(new Idea27301Config());
    }

    public Idea27301Service(Idea27301Config config) {
        this.config = config != null ? config : new Idea27301Config();
