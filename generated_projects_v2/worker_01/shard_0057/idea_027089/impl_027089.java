...
@Data
public class Idea27089Config {
    private String name = "idea_027089";
 ...
 */
@Slf4j
public class Idea27089Service {
    private static final int IDEA_ID = 27089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27089Service() {
        this(new Idea27089Config());
    }

    public Idea27089Service(Idea27089Config config) {
        this.config = config != null ? config : new Idea27089Config();
