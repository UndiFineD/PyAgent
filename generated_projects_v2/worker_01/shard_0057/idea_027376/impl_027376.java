...
@Data
public class Idea27376Config {
    private String name = "idea_027376";
 ...
 */
@Slf4j
public class Idea27376Service {
    private static final int IDEA_ID = 27376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27376Service() {
        this(new Idea27376Config());
    }

    public Idea27376Service(Idea27376Config config) {
        this.config = config != null ? config : new Idea27376Config();
