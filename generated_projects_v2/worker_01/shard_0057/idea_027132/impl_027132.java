...
@Data
public class Idea27132Config {
    private String name = "idea_027132";
 ...
 */
@Slf4j
public class Idea27132Service {
    private static final int IDEA_ID = 27132;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27132Service() {
        this(new Idea27132Config());
    }

    public Idea27132Service(Idea27132Config config) {
        this.config = config != null ? config : new Idea27132Config();
