...
@Data
public class Idea27082Config {
    private String name = "idea_027082";
 ...
 */
@Slf4j
public class Idea27082Service {
    private static final int IDEA_ID = 27082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27082Service() {
        this(new Idea27082Config());
    }

    public Idea27082Service(Idea27082Config config) {
        this.config = config != null ? config : new Idea27082Config();
