...
@Data
public class Idea27455Config {
    private String name = "idea_027455";
 ...
 */
@Slf4j
public class Idea27455Service {
    private static final int IDEA_ID = 27455;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27455Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27455Service() {
        this(new Idea27455Config());
    }

    public Idea27455Service(Idea27455Config config) {
        this.config = config != null ? config : new Idea27455Config();
