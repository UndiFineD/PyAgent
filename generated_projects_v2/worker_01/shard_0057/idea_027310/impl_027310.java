...
@Data
public class Idea27310Config {
    private String name = "idea_027310";
 ...
 */
@Slf4j
public class Idea27310Service {
    private static final int IDEA_ID = 27310;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27310Service() {
        this(new Idea27310Config());
    }

    public Idea27310Service(Idea27310Config config) {
        this.config = config != null ? config : new Idea27310Config();
