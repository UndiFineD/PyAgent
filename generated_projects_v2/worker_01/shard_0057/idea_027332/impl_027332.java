...
@Data
public class Idea27332Config {
    private String name = "idea_027332";
 ...
 */
@Slf4j
public class Idea27332Service {
    private static final int IDEA_ID = 27332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27332Service() {
        this(new Idea27332Config());
    }

    public Idea27332Service(Idea27332Config config) {
        this.config = config != null ? config : new Idea27332Config();
