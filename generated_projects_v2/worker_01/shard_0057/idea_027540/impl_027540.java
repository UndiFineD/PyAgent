...
@Data
public class Idea27540Config {
    private String name = "idea_027540";
 ...
 */
@Slf4j
public class Idea27540Service {
    private static final int IDEA_ID = 27540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27540Service() {
        this(new Idea27540Config());
    }

    public Idea27540Service(Idea27540Config config) {
        this.config = config != null ? config : new Idea27540Config();
