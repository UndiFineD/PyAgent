...
@Data
public class Idea27440Config {
    private String name = "idea_027440";
 ...
 */
@Slf4j
public class Idea27440Service {
    private static final int IDEA_ID = 27440;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27440Service() {
        this(new Idea27440Config());
    }

    public Idea27440Service(Idea27440Config config) {
        this.config = config != null ? config : new Idea27440Config();
