...
@Data
public class Idea27156Config {
    private String name = "idea_027156";
 ...
 */
@Slf4j
public class Idea27156Service {
    private static final int IDEA_ID = 27156;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27156Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27156Service() {
        this(new Idea27156Config());
    }

    public Idea27156Service(Idea27156Config config) {
        this.config = config != null ? config : new Idea27156Config();
