...
@Data
public class Idea27088Config {
    private String name = "idea_027088";
 ...
 */
@Slf4j
public class Idea27088Service {
    private static final int IDEA_ID = 27088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27088Service() {
        this(new Idea27088Config());
    }

    public Idea27088Service(Idea27088Config config) {
        this.config = config != null ? config : new Idea27088Config();
