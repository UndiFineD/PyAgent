...
@Data
public class Idea27449Config {
    private String name = "idea_027449";
 ...
 */
@Slf4j
public class Idea27449Service {
    private static final int IDEA_ID = 27449;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27449Service() {
        this(new Idea27449Config());
    }

    public Idea27449Service(Idea27449Config config) {
        this.config = config != null ? config : new Idea27449Config();
