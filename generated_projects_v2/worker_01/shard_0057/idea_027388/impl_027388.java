...
@Data
public class Idea27388Config {
    private String name = "idea_027388";
 ...
 */
@Slf4j
public class Idea27388Service {
    private static final int IDEA_ID = 27388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27388Service() {
        this(new Idea27388Config());
    }

    public Idea27388Service(Idea27388Config config) {
        this.config = config != null ? config : new Idea27388Config();
