...
@Data
public class Idea27537Config {
    private String name = "idea_027537";
 ...
 */
@Slf4j
public class Idea27537Service {
    private static final int IDEA_ID = 27537;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27537Service() {
        this(new Idea27537Config());
    }

    public Idea27537Service(Idea27537Config config) {
        this.config = config != null ? config : new Idea27537Config();
