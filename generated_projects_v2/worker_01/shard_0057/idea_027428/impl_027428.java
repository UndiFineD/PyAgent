...
@Data
public class Idea27428Config {
    private String name = "idea_027428";
 ...
 */
@Slf4j
public class Idea27428Service {
    private static final int IDEA_ID = 27428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27428Service() {
        this(new Idea27428Config());
    }

    public Idea27428Service(Idea27428Config config) {
        this.config = config != null ? config : new Idea27428Config();
