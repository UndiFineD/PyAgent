...
@Data
public class Idea27140Config {
    private String name = "idea_027140";
 ...
 */
@Slf4j
public class Idea27140Service {
    private static final int IDEA_ID = 27140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27140Service() {
        this(new Idea27140Config());
    }

    public Idea27140Service(Idea27140Config config) {
        this.config = config != null ? config : new Idea27140Config();
