...
@Data
public class Idea27351Config {
    private String name = "idea_027351";
 ...
 */
@Slf4j
public class Idea27351Service {
    private static final int IDEA_ID = 27351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27351Service() {
        this(new Idea27351Config());
    }

    public Idea27351Service(Idea27351Config config) {
        this.config = config != null ? config : new Idea27351Config();
