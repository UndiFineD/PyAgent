...
@Data
public class Idea27413Config {
    private String name = "idea_027413";
 ...
 */
@Slf4j
public class Idea27413Service {
    private static final int IDEA_ID = 27413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27413Service() {
        this(new Idea27413Config());
    }

    public Idea27413Service(Idea27413Config config) {
        this.config = config != null ? config : new Idea27413Config();
