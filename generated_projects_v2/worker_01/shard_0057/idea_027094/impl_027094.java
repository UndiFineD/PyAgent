...
@Data
public class Idea27094Config {
    private String name = "idea_027094";
 ...
 */
@Slf4j
public class Idea27094Service {
    private static final int IDEA_ID = 27094;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27094Service() {
        this(new Idea27094Config());
    }

    public Idea27094Service(Idea27094Config config) {
        this.config = config != null ? config : new Idea27094Config();
