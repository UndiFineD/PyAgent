...
@Data
public class Idea27404Config {
    private String name = "idea_027404";
 ...
 */
@Slf4j
public class Idea27404Service {
    private static final int IDEA_ID = 27404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27404Service() {
        this(new Idea27404Config());
    }

    public Idea27404Service(Idea27404Config config) {
        this.config = config != null ? config : new Idea27404Config();
