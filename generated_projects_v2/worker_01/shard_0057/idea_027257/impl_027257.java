...
@Data
public class Idea27257Config {
    private String name = "idea_027257";
 ...
 */
@Slf4j
public class Idea27257Service {
    private static final int IDEA_ID = 27257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27257Service() {
        this(new Idea27257Config());
    }

    public Idea27257Service(Idea27257Config config) {
        this.config = config != null ? config : new Idea27257Config();
