...
@Data
public class Idea27250Config {
    private String name = "idea_027250";
 ...
 */
@Slf4j
public class Idea27250Service {
    private static final int IDEA_ID = 27250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27250Service() {
        this(new Idea27250Config());
    }

    public Idea27250Service(Idea27250Config config) {
        this.config = config != null ? config : new Idea27250Config();
