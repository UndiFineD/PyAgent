...
@Data
public class Idea27453Config {
    private String name = "idea_027453";
 ...
 */
@Slf4j
public class Idea27453Service {
    private static final int IDEA_ID = 27453;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27453Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27453Service() {
        this(new Idea27453Config());
    }

    public Idea27453Service(Idea27453Config config) {
        this.config = config != null ? config : new Idea27453Config();
