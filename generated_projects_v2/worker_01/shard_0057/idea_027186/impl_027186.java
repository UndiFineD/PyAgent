...
@Data
public class Idea27186Config {
    private String name = "idea_027186";
 ...
 */
@Slf4j
public class Idea27186Service {
    private static final int IDEA_ID = 27186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27186Service() {
        this(new Idea27186Config());
    }

    public Idea27186Service(Idea27186Config config) {
        this.config = config != null ? config : new Idea27186Config();
