...
@Data
public class Idea27359Config {
    private String name = "idea_027359";
 ...
 */
@Slf4j
public class Idea27359Service {
    private static final int IDEA_ID = 27359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27359Service() {
        this(new Idea27359Config());
    }

    public Idea27359Service(Idea27359Config config) {
        this.config = config != null ? config : new Idea27359Config();
