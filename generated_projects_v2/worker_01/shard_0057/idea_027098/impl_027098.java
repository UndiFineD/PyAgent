...
@Data
public class Idea27098Config {
    private String name = "idea_027098";
 ...
 */
@Slf4j
public class Idea27098Service {
    private static final int IDEA_ID = 27098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27098Service() {
        this(new Idea27098Config());
    }

    public Idea27098Service(Idea27098Config config) {
        this.config = config != null ? config : new Idea27098Config();
