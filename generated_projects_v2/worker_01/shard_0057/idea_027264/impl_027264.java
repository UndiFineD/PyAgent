...
@Data
public class Idea27264Config {
    private String name = "idea_027264";
 ...
 */
@Slf4j
public class Idea27264Service {
    private static final int IDEA_ID = 27264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27264Service() {
        this(new Idea27264Config());
    }

    public Idea27264Service(Idea27264Config config) {
        this.config = config != null ? config : new Idea27264Config();
