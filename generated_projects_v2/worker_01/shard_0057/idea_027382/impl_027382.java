...
@Data
public class Idea27382Config {
    private String name = "idea_027382";
 ...
 */
@Slf4j
public class Idea27382Service {
    private static final int IDEA_ID = 27382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27382Service() {
        this(new Idea27382Config());
    }

    public Idea27382Service(Idea27382Config config) {
        this.config = config != null ? config : new Idea27382Config();
