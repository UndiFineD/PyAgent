...
@Data
public class Idea27134Config {
    private String name = "idea_027134";
 ...
 */
@Slf4j
public class Idea27134Service {
    private static final int IDEA_ID = 27134;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27134Service() {
        this(new Idea27134Config());
    }

    public Idea27134Service(Idea27134Config config) {
        this.config = config != null ? config : new Idea27134Config();
