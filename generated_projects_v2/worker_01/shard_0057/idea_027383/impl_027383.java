...
@Data
public class Idea27383Config {
    private String name = "idea_027383";
 ...
 */
@Slf4j
public class Idea27383Service {
    private static final int IDEA_ID = 27383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27383Service() {
        this(new Idea27383Config());
    }

    public Idea27383Service(Idea27383Config config) {
        this.config = config != null ? config : new Idea27383Config();
