...
@Data
public class Idea27179Config {
    private String name = "idea_027179";
 ...
 */
@Slf4j
public class Idea27179Service {
    private static final int IDEA_ID = 27179;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27179Service() {
        this(new Idea27179Config());
    }

    public Idea27179Service(Idea27179Config config) {
        this.config = config != null ? config : new Idea27179Config();
