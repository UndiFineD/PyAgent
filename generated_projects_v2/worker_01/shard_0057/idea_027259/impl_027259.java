...
@Data
public class Idea27259Config {
    private String name = "idea_027259";
 ...
 */
@Slf4j
public class Idea27259Service {
    private static final int IDEA_ID = 27259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27259Service() {
        this(new Idea27259Config());
    }

    public Idea27259Service(Idea27259Config config) {
        this.config = config != null ? config : new Idea27259Config();
