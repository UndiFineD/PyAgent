...
@Data
public class Idea27403Config {
    private String name = "idea_027403";
 ...
 */
@Slf4j
public class Idea27403Service {
    private static final int IDEA_ID = 27403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27403Service() {
        this(new Idea27403Config());
    }

    public Idea27403Service(Idea27403Config config) {
        this.config = config != null ? config : new Idea27403Config();
