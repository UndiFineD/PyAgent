...
@Data
public class Idea27172Config {
    private String name = "idea_027172";
 ...
 */
@Slf4j
public class Idea27172Service {
    private static final int IDEA_ID = 27172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27172Service() {
        this(new Idea27172Config());
    }

    public Idea27172Service(Idea27172Config config) {
        this.config = config != null ? config : new Idea27172Config();
