...
@Data
public class Idea27456Config {
    private String name = "idea_027456";
 ...
 */
@Slf4j
public class Idea27456Service {
    private static final int IDEA_ID = 27456;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27456Service() {
        this(new Idea27456Config());
    }

    public Idea27456Service(Idea27456Config config) {
        this.config = config != null ? config : new Idea27456Config();
