...
@Data
public class Idea27465Config {
    private String name = "idea_027465";
 ...
 */
@Slf4j
public class Idea27465Service {
    private static final int IDEA_ID = 27465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27465Service() {
        this(new Idea27465Config());
    }

    public Idea27465Service(Idea27465Config config) {
        this.config = config != null ? config : new Idea27465Config();
