...
@Data
public class Idea27506Config {
    private String name = "idea_027506";
 ...
 */
@Slf4j
public class Idea27506Service {
    private static final int IDEA_ID = 27506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27506Service() {
        this(new Idea27506Config());
    }

    public Idea27506Service(Idea27506Config config) {
        this.config = config != null ? config : new Idea27506Config();
