...
@Data
public class Idea27390Config {
    private String name = "idea_027390";
 ...
 */
@Slf4j
public class Idea27390Service {
    private static final int IDEA_ID = 27390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27390Service() {
        this(new Idea27390Config());
    }

    public Idea27390Service(Idea27390Config config) {
        this.config = config != null ? config : new Idea27390Config();
