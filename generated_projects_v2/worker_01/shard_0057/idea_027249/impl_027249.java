...
@Data
public class Idea27249Config {
    private String name = "idea_027249";
 ...
 */
@Slf4j
public class Idea27249Service {
    private static final int IDEA_ID = 27249;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27249Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27249Service() {
        this(new Idea27249Config());
    }

    public Idea27249Service(Idea27249Config config) {
        this.config = config != null ? config : new Idea27249Config();
