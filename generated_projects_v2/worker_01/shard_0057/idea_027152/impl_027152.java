...
@Data
public class Idea27152Config {
    private String name = "idea_027152";
 ...
 */
@Slf4j
public class Idea27152Service {
    private static final int IDEA_ID = 27152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27152Service() {
        this(new Idea27152Config());
    }

    public Idea27152Service(Idea27152Config config) {
        this.config = config != null ? config : new Idea27152Config();
