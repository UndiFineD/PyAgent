...
@Data
public class Idea27352Config {
    private String name = "idea_027352";
 ...
 */
@Slf4j
public class Idea27352Service {
    private static final int IDEA_ID = 27352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27352Service() {
        this(new Idea27352Config());
    }

    public Idea27352Service(Idea27352Config config) {
        this.config = config != null ? config : new Idea27352Config();
