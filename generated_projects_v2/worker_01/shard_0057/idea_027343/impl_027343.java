...
@Data
public class Idea27343Config {
    private String name = "idea_027343";
 ...
 */
@Slf4j
public class Idea27343Service {
    private static final int IDEA_ID = 27343;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27343Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27343Service() {
        this(new Idea27343Config());
    }

    public Idea27343Service(Idea27343Config config) {
        this.config = config != null ? config : new Idea27343Config();
