...
@Data
public class Idea27350Config {
    private String name = "idea_027350";
 ...
 */
@Slf4j
public class Idea27350Service {
    private static final int IDEA_ID = 27350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27350Service() {
        this(new Idea27350Config());
    }

    public Idea27350Service(Idea27350Config config) {
        this.config = config != null ? config : new Idea27350Config();
