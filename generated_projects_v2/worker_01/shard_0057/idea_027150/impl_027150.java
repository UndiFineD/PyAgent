...
@Data
public class Idea27150Config {
    private String name = "idea_027150";
 ...
 */
@Slf4j
public class Idea27150Service {
    private static final int IDEA_ID = 27150;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27150Service() {
        this(new Idea27150Config());
    }

    public Idea27150Service(Idea27150Config config) {
        this.config = config != null ? config : new Idea27150Config();
