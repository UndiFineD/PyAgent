...
@Data
public class Idea27093Config {
    private String name = "idea_027093";
 ...
 */
@Slf4j
public class Idea27093Service {
    private static final int IDEA_ID = 27093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27093Service() {
        this(new Idea27093Config());
    }

    public Idea27093Service(Idea27093Config config) {
        this.config = config != null ? config : new Idea27093Config();
