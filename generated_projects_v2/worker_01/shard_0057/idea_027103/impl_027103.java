...
@Data
public class Idea27103Config {
    private String name = "idea_027103";
 ...
 */
@Slf4j
public class Idea27103Service {
    private static final int IDEA_ID = 27103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27103Service() {
        this(new Idea27103Config());
    }

    public Idea27103Service(Idea27103Config config) {
        this.config = config != null ? config : new Idea27103Config();
