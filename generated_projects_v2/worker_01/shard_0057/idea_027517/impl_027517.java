...
@Data
public class Idea27517Config {
    private String name = "idea_027517";
 ...
 */
@Slf4j
public class Idea27517Service {
    private static final int IDEA_ID = 27517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27517Service() {
        this(new Idea27517Config());
    }

    public Idea27517Service(Idea27517Config config) {
        this.config = config != null ? config : new Idea27517Config();
