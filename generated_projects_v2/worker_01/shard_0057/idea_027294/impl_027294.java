...
@Data
public class Idea27294Config {
    private String name = "idea_027294";
 ...
 */
@Slf4j
public class Idea27294Service {
    private static final int IDEA_ID = 27294;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27294Service() {
        this(new Idea27294Config());
    }

    public Idea27294Service(Idea27294Config config) {
        this.config = config != null ? config : new Idea27294Config();
