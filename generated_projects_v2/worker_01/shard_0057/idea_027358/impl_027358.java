...
@Data
public class Idea27358Config {
    private String name = "idea_027358";
 ...
 */
@Slf4j
public class Idea27358Service {
    private static final int IDEA_ID = 27358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27358Service() {
        this(new Idea27358Config());
    }

    public Idea27358Service(Idea27358Config config) {
        this.config = config != null ? config : new Idea27358Config();
