...
@Data
public class Idea27104Config {
    private String name = "idea_027104";
 ...
 */
@Slf4j
public class Idea27104Service {
    private static final int IDEA_ID = 27104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27104Service() {
        this(new Idea27104Config());
    }

    public Idea27104Service(Idea27104Config config) {
        this.config = config != null ? config : new Idea27104Config();
