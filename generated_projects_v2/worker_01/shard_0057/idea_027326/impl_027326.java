...
@Data
public class Idea27326Config {
    private String name = "idea_027326";
 ...
 */
@Slf4j
public class Idea27326Service {
    private static final int IDEA_ID = 27326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27326Service() {
        this(new Idea27326Config());
    }

    public Idea27326Service(Idea27326Config config) {
        this.config = config != null ? config : new Idea27326Config();
