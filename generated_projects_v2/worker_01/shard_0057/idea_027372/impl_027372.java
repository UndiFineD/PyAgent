...
@Data
public class Idea27372Config {
    private String name = "idea_027372";
 ...
 */
@Slf4j
public class Idea27372Service {
    private static final int IDEA_ID = 27372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27372Service() {
        this(new Idea27372Config());
    }

    public Idea27372Service(Idea27372Config config) {
        this.config = config != null ? config : new Idea27372Config();
