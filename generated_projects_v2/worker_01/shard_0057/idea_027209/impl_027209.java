...
@Data
public class Idea27209Config {
    private String name = "idea_027209";
 ...
 */
@Slf4j
public class Idea27209Service {
    private static final int IDEA_ID = 27209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27209Service() {
        this(new Idea27209Config());
    }

    public Idea27209Service(Idea27209Config config) {
        this.config = config != null ? config : new Idea27209Config();
