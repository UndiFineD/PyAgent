...
@Data
public class Idea27084Config {
    private String name = "idea_027084";
 ...
 */
@Slf4j
public class Idea27084Service {
    private static final int IDEA_ID = 27084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27084Service() {
        this(new Idea27084Config());
    }

    public Idea27084Service(Idea27084Config config) {
        this.config = config != null ? config : new Idea27084Config();
