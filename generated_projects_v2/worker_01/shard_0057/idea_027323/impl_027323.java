...
@Data
public class Idea27323Config {
    private String name = "idea_027323";
 ...
 */
@Slf4j
public class Idea27323Service {
    private static final int IDEA_ID = 27323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27323Service() {
        this(new Idea27323Config());
    }

    public Idea27323Service(Idea27323Config config) {
        this.config = config != null ? config : new Idea27323Config();
