...
@Data
public class Idea27411Config {
    private String name = "idea_027411";
 ...
 */
@Slf4j
public class Idea27411Service {
    private static final int IDEA_ID = 27411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27411Service() {
        this(new Idea27411Config());
    }

    public Idea27411Service(Idea27411Config config) {
        this.config = config != null ? config : new Idea27411Config();
