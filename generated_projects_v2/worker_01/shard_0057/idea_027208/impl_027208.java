...
@Data
public class Idea27208Config {
    private String name = "idea_027208";
 ...
 */
@Slf4j
public class Idea27208Service {
    private static final int IDEA_ID = 27208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27208Service() {
        this(new Idea27208Config());
    }

    public Idea27208Service(Idea27208Config config) {
        this.config = config != null ? config : new Idea27208Config();
