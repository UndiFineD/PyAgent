...
@Data
public class Idea27180Config {
    private String name = "idea_027180";
 ...
 */
@Slf4j
public class Idea27180Service {
    private static final int IDEA_ID = 27180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27180Service() {
        this(new Idea27180Config());
    }

    public Idea27180Service(Idea27180Config config) {
        this.config = config != null ? config : new Idea27180Config();
