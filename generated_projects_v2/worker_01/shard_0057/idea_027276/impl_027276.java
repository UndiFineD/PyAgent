...
@Data
public class Idea27276Config {
    private String name = "idea_027276";
 ...
 */
@Slf4j
public class Idea27276Service {
    private static final int IDEA_ID = 27276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27276Service() {
        this(new Idea27276Config());
    }

    public Idea27276Service(Idea27276Config config) {
        this.config = config != null ? config : new Idea27276Config();
