...
@Data
public class Idea27110Config {
    private String name = "idea_027110";
 ...
 */
@Slf4j
public class Idea27110Service {
    private static final int IDEA_ID = 27110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27110Service() {
        this(new Idea27110Config());
    }

    public Idea27110Service(Idea27110Config config) {
        this.config = config != null ? config : new Idea27110Config();
