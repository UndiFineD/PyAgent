...
@Data
public class Idea27485Config {
    private String name = "idea_027485";
 ...
 */
@Slf4j
public class Idea27485Service {
    private static final int IDEA_ID = 27485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27485Service() {
        this(new Idea27485Config());
    }

    public Idea27485Service(Idea27485Config config) {
        this.config = config != null ? config : new Idea27485Config();
