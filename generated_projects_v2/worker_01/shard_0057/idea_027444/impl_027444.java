...
@Data
public class Idea27444Config {
    private String name = "idea_027444";
 ...
 */
@Slf4j
public class Idea27444Service {
    private static final int IDEA_ID = 27444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27444Service() {
        this(new Idea27444Config());
    }

    public Idea27444Service(Idea27444Config config) {
        this.config = config != null ? config : new Idea27444Config();
