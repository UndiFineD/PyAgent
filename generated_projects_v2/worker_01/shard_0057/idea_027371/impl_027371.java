...
@Data
public class Idea27371Config {
    private String name = "idea_027371";
 ...
 */
@Slf4j
public class Idea27371Service {
    private static final int IDEA_ID = 27371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27371Service() {
        this(new Idea27371Config());
    }

    public Idea27371Service(Idea27371Config config) {
        this.config = config != null ? config : new Idea27371Config();
