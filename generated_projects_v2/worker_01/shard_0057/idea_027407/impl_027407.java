...
@Data
public class Idea27407Config {
    private String name = "idea_027407";
 ...
 */
@Slf4j
public class Idea27407Service {
    private static final int IDEA_ID = 27407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27407Service() {
        this(new Idea27407Config());
    }

    public Idea27407Service(Idea27407Config config) {
        this.config = config != null ? config : new Idea27407Config();
