...
@Data
public class Idea27378Config {
    private String name = "idea_027378";
 ...
 */
@Slf4j
public class Idea27378Service {
    private static final int IDEA_ID = 27378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27378Service() {
        this(new Idea27378Config());
    }

    public Idea27378Service(Idea27378Config config) {
        this.config = config != null ? config : new Idea27378Config();
