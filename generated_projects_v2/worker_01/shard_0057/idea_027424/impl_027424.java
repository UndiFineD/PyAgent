...
@Data
public class Idea27424Config {
    private String name = "idea_027424";
 ...
 */
@Slf4j
public class Idea27424Service {
    private static final int IDEA_ID = 27424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27424Service() {
        this(new Idea27424Config());
    }

    public Idea27424Service(Idea27424Config config) {
        this.config = config != null ? config : new Idea27424Config();
