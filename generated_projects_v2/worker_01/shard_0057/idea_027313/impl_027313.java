...
@Data
public class Idea27313Config {
    private String name = "idea_027313";
 ...
 */
@Slf4j
public class Idea27313Service {
    private static final int IDEA_ID = 27313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27313Service() {
        this(new Idea27313Config());
    }

    public Idea27313Service(Idea27313Config config) {
        this.config = config != null ? config : new Idea27313Config();
