...
@Data
public class Idea27085Config {
    private String name = "idea_027085";
 ...
 */
@Slf4j
public class Idea27085Service {
    private static final int IDEA_ID = 27085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27085Service() {
        this(new Idea27085Config());
    }

    public Idea27085Service(Idea27085Config config) {
        this.config = config != null ? config : new Idea27085Config();
