...
@Data
public class Idea27122Config {
    private String name = "idea_027122";
 ...
 */
@Slf4j
public class Idea27122Service {
    private static final int IDEA_ID = 27122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27122Service() {
        this(new Idea27122Config());
    }

    public Idea27122Service(Idea27122Config config) {
        this.config = config != null ? config : new Idea27122Config();
