...
@Data
public class Idea27187Config {
    private String name = "idea_027187";
 ...
 */
@Slf4j
public class Idea27187Service {
    private static final int IDEA_ID = 27187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27187Service() {
        this(new Idea27187Config());
    }

    public Idea27187Service(Idea27187Config config) {
        this.config = config != null ? config : new Idea27187Config();
