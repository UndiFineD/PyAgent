...
@Data
public class Idea27435Config {
    private String name = "idea_027435";
 ...
 */
@Slf4j
public class Idea27435Service {
    private static final int IDEA_ID = 27435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27435Service() {
        this(new Idea27435Config());
    }

    public Idea27435Service(Idea27435Config config) {
        this.config = config != null ? config : new Idea27435Config();
