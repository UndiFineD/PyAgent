...
@Data
public class Idea27183Config {
    private String name = "idea_027183";
 ...
 */
@Slf4j
public class Idea27183Service {
    private static final int IDEA_ID = 27183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27183Service() {
        this(new Idea27183Config());
    }

    public Idea27183Service(Idea27183Config config) {
        this.config = config != null ? config : new Idea27183Config();
