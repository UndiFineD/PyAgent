...
@Data
public class Idea27503Config {
    private String name = "idea_027503";
 ...
 */
@Slf4j
public class Idea27503Service {
    private static final int IDEA_ID = 27503;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27503Service() {
        this(new Idea27503Config());
    }

    public Idea27503Service(Idea27503Config config) {
        this.config = config != null ? config : new Idea27503Config();
