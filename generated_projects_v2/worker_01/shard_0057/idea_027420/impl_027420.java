...
@Data
public class Idea27420Config {
    private String name = "idea_027420";
 ...
 */
@Slf4j
public class Idea27420Service {
    private static final int IDEA_ID = 27420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27420Service() {
        this(new Idea27420Config());
    }

    public Idea27420Service(Idea27420Config config) {
        this.config = config != null ? config : new Idea27420Config();
