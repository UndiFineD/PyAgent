...
@Data
public class Idea27502Config {
    private String name = "idea_027502";
 ...
 */
@Slf4j
public class Idea27502Service {
    private static final int IDEA_ID = 27502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27502Service() {
        this(new Idea27502Config());
    }

    public Idea27502Service(Idea27502Config config) {
        this.config = config != null ? config : new Idea27502Config();
