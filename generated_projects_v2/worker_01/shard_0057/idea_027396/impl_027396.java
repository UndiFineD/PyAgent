...
@Data
public class Idea27396Config {
    private String name = "idea_027396";
 ...
 */
@Slf4j
public class Idea27396Service {
    private static final int IDEA_ID = 27396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27396Service() {
        this(new Idea27396Config());
    }

    public Idea27396Service(Idea27396Config config) {
        this.config = config != null ? config : new Idea27396Config();
