...
@Data
public class Idea27426Config {
    private String name = "idea_027426";
 ...
 */
@Slf4j
public class Idea27426Service {
    private static final int IDEA_ID = 27426;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27426Service() {
        this(new Idea27426Config());
    }

    public Idea27426Service(Idea27426Config config) {
        this.config = config != null ? config : new Idea27426Config();
