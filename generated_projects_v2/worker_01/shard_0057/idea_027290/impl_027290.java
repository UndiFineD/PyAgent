...
@Data
public class Idea27290Config {
    private String name = "idea_027290";
 ...
 */
@Slf4j
public class Idea27290Service {
    private static final int IDEA_ID = 27290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27290Service() {
        this(new Idea27290Config());
    }

    public Idea27290Service(Idea27290Config config) {
        this.config = config != null ? config : new Idea27290Config();
