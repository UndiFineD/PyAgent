...
@Data
public class Idea27380Config {
    private String name = "idea_027380";
 ...
 */
@Slf4j
public class Idea27380Service {
    private static final int IDEA_ID = 27380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27380Service() {
        this(new Idea27380Config());
    }

    public Idea27380Service(Idea27380Config config) {
        this.config = config != null ? config : new Idea27380Config();
