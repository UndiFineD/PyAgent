...
@Data
public class Idea27129Config {
    private String name = "idea_027129";
 ...
 */
@Slf4j
public class Idea27129Service {
    private static final int IDEA_ID = 27129;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27129Service() {
        this(new Idea27129Config());
    }

    public Idea27129Service(Idea27129Config config) {
        this.config = config != null ? config : new Idea27129Config();
