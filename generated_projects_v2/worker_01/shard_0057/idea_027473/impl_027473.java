...
@Data
public class Idea27473Config {
    private String name = "idea_027473";
 ...
 */
@Slf4j
public class Idea27473Service {
    private static final int IDEA_ID = 27473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27473Service() {
        this(new Idea27473Config());
    }

    public Idea27473Service(Idea27473Config config) {
        this.config = config != null ? config : new Idea27473Config();
