...
@Data
public class Idea27270Config {
    private String name = "idea_027270";
 ...
 */
@Slf4j
public class Idea27270Service {
    private static final int IDEA_ID = 27270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27270Service() {
        this(new Idea27270Config());
    }

    public Idea27270Service(Idea27270Config config) {
        this.config = config != null ? config : new Idea27270Config();
