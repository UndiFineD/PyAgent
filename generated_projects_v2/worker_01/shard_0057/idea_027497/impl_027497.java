...
@Data
public class Idea27497Config {
    private String name = "idea_027497";
 ...
 */
@Slf4j
public class Idea27497Service {
    private static final int IDEA_ID = 27497;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27497Service() {
        this(new Idea27497Config());
    }

    public Idea27497Service(Idea27497Config config) {
        this.config = config != null ? config : new Idea27497Config();
