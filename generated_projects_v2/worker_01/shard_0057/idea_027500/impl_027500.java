...
@Data
public class Idea27500Config {
    private String name = "idea_027500";
 ...
 */
@Slf4j
public class Idea27500Service {
    private static final int IDEA_ID = 27500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27500Service() {
        this(new Idea27500Config());
    }

    public Idea27500Service(Idea27500Config config) {
        this.config = config != null ? config : new Idea27500Config();
