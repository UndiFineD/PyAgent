...
@Data
public class Idea27387Config {
    private String name = "idea_027387";
 ...
 */
@Slf4j
public class Idea27387Service {
    private static final int IDEA_ID = 27387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27387Service() {
        this(new Idea27387Config());
    }

    public Idea27387Service(Idea27387Config config) {
        this.config = config != null ? config : new Idea27387Config();
