...
@Data
public class Idea27311Config {
    private String name = "idea_027311";
 ...
 */
@Slf4j
public class Idea27311Service {
    private static final int IDEA_ID = 27311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27311Service() {
        this(new Idea27311Config());
    }

    public Idea27311Service(Idea27311Config config) {
        this.config = config != null ? config : new Idea27311Config();
