...
@Data
public class Idea27385Config {
    private String name = "idea_027385";
 ...
 */
@Slf4j
public class Idea27385Service {
    private static final int IDEA_ID = 27385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27385Service() {
        this(new Idea27385Config());
    }

    public Idea27385Service(Idea27385Config config) {
        this.config = config != null ? config : new Idea27385Config();
