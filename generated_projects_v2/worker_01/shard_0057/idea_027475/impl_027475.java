...
@Data
public class Idea27475Config {
    private String name = "idea_027475";
 ...
 */
@Slf4j
public class Idea27475Service {
    private static final int IDEA_ID = 27475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27475Service() {
        this(new Idea27475Config());
    }

    public Idea27475Service(Idea27475Config config) {
        this.config = config != null ? config : new Idea27475Config();
