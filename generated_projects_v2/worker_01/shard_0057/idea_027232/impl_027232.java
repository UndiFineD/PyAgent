...
@Data
public class Idea27232Config {
    private String name = "idea_027232";
 ...
 */
@Slf4j
public class Idea27232Service {
    private static final int IDEA_ID = 27232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27232Service() {
        this(new Idea27232Config());
    }

    public Idea27232Service(Idea27232Config config) {
        this.config = config != null ? config : new Idea27232Config();
