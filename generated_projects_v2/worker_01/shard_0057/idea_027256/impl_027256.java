...
@Data
public class Idea27256Config {
    private String name = "idea_027256";
 ...
 */
@Slf4j
public class Idea27256Service {
    private static final int IDEA_ID = 27256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27256Service() {
        this(new Idea27256Config());
    }

    public Idea27256Service(Idea27256Config config) {
        this.config = config != null ? config : new Idea27256Config();
