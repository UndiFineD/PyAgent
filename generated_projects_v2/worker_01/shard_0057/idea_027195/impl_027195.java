...
@Data
public class Idea27195Config {
    private String name = "idea_027195";
 ...
 */
@Slf4j
public class Idea27195Service {
    private static final int IDEA_ID = 27195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27195Service() {
        this(new Idea27195Config());
    }

    public Idea27195Service(Idea27195Config config) {
        this.config = config != null ? config : new Idea27195Config();
