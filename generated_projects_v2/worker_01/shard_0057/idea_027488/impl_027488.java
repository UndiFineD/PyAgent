...
@Data
public class Idea27488Config {
    private String name = "idea_027488";
 ...
 */
@Slf4j
public class Idea27488Service {
    private static final int IDEA_ID = 27488;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27488Service() {
        this(new Idea27488Config());
    }

    public Idea27488Service(Idea27488Config config) {
        this.config = config != null ? config : new Idea27488Config();
