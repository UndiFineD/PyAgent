...
@Data
public class Idea27289Config {
    private String name = "idea_027289";
 ...
 */
@Slf4j
public class Idea27289Service {
    private static final int IDEA_ID = 27289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27289Service() {
        this(new Idea27289Config());
    }

    public Idea27289Service(Idea27289Config config) {
        this.config = config != null ? config : new Idea27289Config();
