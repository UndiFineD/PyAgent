...
@Data
public class Idea27467Config {
    private String name = "idea_027467";
 ...
 */
@Slf4j
public class Idea27467Service {
    private static final int IDEA_ID = 27467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27467Service() {
        this(new Idea27467Config());
    }

    public Idea27467Service(Idea27467Config config) {
        this.config = config != null ? config : new Idea27467Config();
