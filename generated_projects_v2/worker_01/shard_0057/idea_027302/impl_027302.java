...
@Data
public class Idea27302Config {
    private String name = "idea_027302";
 ...
 */
@Slf4j
public class Idea27302Service {
    private static final int IDEA_ID = 27302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27302Service() {
        this(new Idea27302Config());
    }

    public Idea27302Service(Idea27302Config config) {
        this.config = config != null ? config : new Idea27302Config();
