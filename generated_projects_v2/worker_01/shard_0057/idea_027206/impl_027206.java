...
@Data
public class Idea27206Config {
    private String name = "idea_027206";
 ...
 */
@Slf4j
public class Idea27206Service {
    private static final int IDEA_ID = 27206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27206Service() {
        this(new Idea27206Config());
    }

    public Idea27206Service(Idea27206Config config) {
        this.config = config != null ? config : new Idea27206Config();
