...
@Data
public class Idea27265Config {
    private String name = "idea_027265";
 ...
 */
@Slf4j
public class Idea27265Service {
    private static final int IDEA_ID = 27265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27265Service() {
        this(new Idea27265Config());
    }

    public Idea27265Service(Idea27265Config config) {
        this.config = config != null ? config : new Idea27265Config();
