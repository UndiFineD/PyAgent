...
@Data
public class Idea27472Config {
    private String name = "idea_027472";
 ...
 */
@Slf4j
public class Idea27472Service {
    private static final int IDEA_ID = 27472;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea27472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea27472Service() {
        this(new Idea27472Config());
    }

    public Idea27472Service(Idea27472Config config) {
        this.config = config != null ? config : new Idea27472Config();
