...
@Data
public class Idea25119Config {
    private String name = "idea_025119";
 ...
 */
@Slf4j
public class Idea25119Service {
    private static final int IDEA_ID = 25119;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25119Service() {
        this(new Idea25119Config());
    }

    public Idea25119Service(Idea25119Config config) {
        this.config = config != null ? config : new Idea25119Config();
