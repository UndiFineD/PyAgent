...
@Data
public class Idea25110Config {
    private String name = "idea_025110";
 ...
 */
@Slf4j
public class Idea25110Service {
    private static final int IDEA_ID = 25110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25110Service() {
        this(new Idea25110Config());
    }

    public Idea25110Service(Idea25110Config config) {
        this.config = config != null ? config : new Idea25110Config();
