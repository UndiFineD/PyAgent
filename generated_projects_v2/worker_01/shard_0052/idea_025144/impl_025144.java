...
@Data
public class Idea25144Config {
    private String name = "idea_025144";
 ...
 */
@Slf4j
public class Idea25144Service {
    private static final int IDEA_ID = 25144;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25144Service() {
        this(new Idea25144Config());
    }

    public Idea25144Service(Idea25144Config config) {
        this.config = config != null ? config : new Idea25144Config();
