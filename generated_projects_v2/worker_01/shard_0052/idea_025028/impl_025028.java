...
@Data
public class Idea25028Config {
    private String name = "idea_025028";
 ...
 */
@Slf4j
public class Idea25028Service {
    private static final int IDEA_ID = 25028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25028Service() {
        this(new Idea25028Config());
    }

    public Idea25028Service(Idea25028Config config) {
        this.config = config != null ? config : new Idea25028Config();
