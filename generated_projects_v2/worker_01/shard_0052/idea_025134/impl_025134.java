...
@Data
public class Idea25134Config {
    private String name = "idea_025134";
 ...
 */
@Slf4j
public class Idea25134Service {
    private static final int IDEA_ID = 25134;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25134Service() {
        this(new Idea25134Config());
    }

    public Idea25134Service(Idea25134Config config) {
        this.config = config != null ? config : new Idea25134Config();
