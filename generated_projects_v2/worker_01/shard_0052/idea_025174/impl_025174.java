...
@Data
public class Idea25174Config {
    private String name = "idea_025174";
 ...
 */
@Slf4j
public class Idea25174Service {
    private static final int IDEA_ID = 25174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25174Service() {
        this(new Idea25174Config());
    }

    public Idea25174Service(Idea25174Config config) {
        this.config = config != null ? config : new Idea25174Config();
