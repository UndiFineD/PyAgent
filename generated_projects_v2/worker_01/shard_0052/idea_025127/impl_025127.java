...
@Data
public class Idea25127Config {
    private String name = "idea_025127";
 ...
 */
@Slf4j
public class Idea25127Service {
    private static final int IDEA_ID = 25127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25127Service() {
        this(new Idea25127Config());
    }

    public Idea25127Service(Idea25127Config config) {
        this.config = config != null ? config : new Idea25127Config();
