...
@Data
public class Idea25155Config {
    private String name = "idea_025155";
 ...
 */
@Slf4j
public class Idea25155Service {
    private static final int IDEA_ID = 25155;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25155Service() {
        this(new Idea25155Config());
    }

    public Idea25155Service(Idea25155Config config) {
        this.config = config != null ? config : new Idea25155Config();
