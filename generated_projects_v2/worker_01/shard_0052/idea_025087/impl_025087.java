...
@Data
public class Idea25087Config {
    private String name = "idea_025087";
 ...
 */
@Slf4j
public class Idea25087Service {
    private static final int IDEA_ID = 25087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25087Service() {
        this(new Idea25087Config());
    }

    public Idea25087Service(Idea25087Config config) {
        this.config = config != null ? config : new Idea25087Config();
