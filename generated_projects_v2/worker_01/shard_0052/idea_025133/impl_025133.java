...
@Data
public class Idea25133Config {
    private String name = "idea_025133";
 ...
 */
@Slf4j
public class Idea25133Service {
    private static final int IDEA_ID = 25133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25133Service() {
        this(new Idea25133Config());
    }

    public Idea25133Service(Idea25133Config config) {
        this.config = config != null ? config : new Idea25133Config();
