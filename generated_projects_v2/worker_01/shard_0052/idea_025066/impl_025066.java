...
@Data
public class Idea25066Config {
    private String name = "idea_025066";
 ...
 */
@Slf4j
public class Idea25066Service {
    private static final int IDEA_ID = 25066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25066Service() {
        this(new Idea25066Config());
    }

    public Idea25066Service(Idea25066Config config) {
        this.config = config != null ? config : new Idea25066Config();
