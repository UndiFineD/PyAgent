...
@Data
public class Idea25001Config {
    private String name = "idea_025001";
 ...
 */
@Slf4j
public class Idea25001Service {
    private static final int IDEA_ID = 25001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25001Service() {
        this(new Idea25001Config());
    }

    public Idea25001Service(Idea25001Config config) {
        this.config = config != null ? config : new Idea25001Config();
