...
@Data
public class Idea25023Config {
    private String name = "idea_025023";
 ...
 */
@Slf4j
public class Idea25023Service {
    private static final int IDEA_ID = 25023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25023Service() {
        this(new Idea25023Config());
    }

    public Idea25023Service(Idea25023Config config) {
        this.config = config != null ? config : new Idea25023Config();
