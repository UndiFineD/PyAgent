...
@Data
public class Idea25145Config {
    private String name = "idea_025145";
 ...
 */
@Slf4j
public class Idea25145Service {
    private static final int IDEA_ID = 25145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25145Service() {
        this(new Idea25145Config());
    }

    public Idea25145Service(Idea25145Config config) {
        this.config = config != null ? config : new Idea25145Config();
