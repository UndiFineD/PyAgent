...
@Data
public class Idea25012Config {
    private String name = "idea_025012";
 ...
 */
@Slf4j
public class Idea25012Service {
    private static final int IDEA_ID = 25012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25012Service() {
        this(new Idea25012Config());
    }

    public Idea25012Service(Idea25012Config config) {
        this.config = config != null ? config : new Idea25012Config();
