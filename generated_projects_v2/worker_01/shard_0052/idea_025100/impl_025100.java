...
@Data
public class Idea25100Config {
    private String name = "idea_025100";
 ...
 */
@Slf4j
public class Idea25100Service {
    private static final int IDEA_ID = 25100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25100Service() {
        this(new Idea25100Config());
    }

    public Idea25100Service(Idea25100Config config) {
        this.config = config != null ? config : new Idea25100Config();
