...
@Data
public class Idea25053Config {
    private String name = "idea_025053";
 ...
 */
@Slf4j
public class Idea25053Service {
    private static final int IDEA_ID = 25053;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25053Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25053Service() {
        this(new Idea25053Config());
    }

    public Idea25053Service(Idea25053Config config) {
        this.config = config != null ? config : new Idea25053Config();
