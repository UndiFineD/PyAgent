...
@Data
public class Idea25161Config {
    private String name = "idea_025161";
 ...
 */
@Slf4j
public class Idea25161Service {
    private static final int IDEA_ID = 25161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25161Service() {
        this(new Idea25161Config());
    }

    public Idea25161Service(Idea25161Config config) {
        this.config = config != null ? config : new Idea25161Config();
