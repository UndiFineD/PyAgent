...
@Data
public class Idea25116Config {
    private String name = "idea_025116";
 ...
 */
@Slf4j
public class Idea25116Service {
    private static final int IDEA_ID = 25116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25116Service() {
        this(new Idea25116Config());
    }

    public Idea25116Service(Idea25116Config config) {
        this.config = config != null ? config : new Idea25116Config();
