...
@Data
public class Idea25016Config {
    private String name = "idea_025016";
 ...
 */
@Slf4j
public class Idea25016Service {
    private static final int IDEA_ID = 25016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25016Service() {
        this(new Idea25016Config());
    }

    public Idea25016Service(Idea25016Config config) {
        this.config = config != null ? config : new Idea25016Config();
