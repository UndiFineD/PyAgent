...
@Data
public class Idea25138Config {
    private String name = "idea_025138";
 ...
 */
@Slf4j
public class Idea25138Service {
    private static final int IDEA_ID = 25138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25138Service() {
        this(new Idea25138Config());
    }

    public Idea25138Service(Idea25138Config config) {
        this.config = config != null ? config : new Idea25138Config();
