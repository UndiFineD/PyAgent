...
@Data
public class Idea25080Config {
    private String name = "idea_025080";
 ...
 */
@Slf4j
public class Idea25080Service {
    private static final int IDEA_ID = 25080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25080Service() {
        this(new Idea25080Config());
    }

    public Idea25080Service(Idea25080Config config) {
        this.config = config != null ? config : new Idea25080Config();
