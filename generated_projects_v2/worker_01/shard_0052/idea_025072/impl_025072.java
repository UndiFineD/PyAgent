...
@Data
public class Idea25072Config {
    private String name = "idea_025072";
 ...
 */
@Slf4j
public class Idea25072Service {
    private static final int IDEA_ID = 25072;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25072Service() {
        this(new Idea25072Config());
    }

    public Idea25072Service(Idea25072Config config) {
        this.config = config != null ? config : new Idea25072Config();
