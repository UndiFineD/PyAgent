...
@Data
public class Idea25031Config {
    private String name = "idea_025031";
 ...
 */
@Slf4j
public class Idea25031Service {
    private static final int IDEA_ID = 25031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25031Service() {
        this(new Idea25031Config());
    }

    public Idea25031Service(Idea25031Config config) {
        this.config = config != null ? config : new Idea25031Config();
