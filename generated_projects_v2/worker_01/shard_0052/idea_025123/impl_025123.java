...
@Data
public class Idea25123Config {
    private String name = "idea_025123";
 ...
 */
@Slf4j
public class Idea25123Service {
    private static final int IDEA_ID = 25123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25123Service() {
        this(new Idea25123Config());
    }

    public Idea25123Service(Idea25123Config config) {
        this.config = config != null ? config : new Idea25123Config();
