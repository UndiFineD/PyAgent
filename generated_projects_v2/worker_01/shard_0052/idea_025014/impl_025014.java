...
@Data
public class Idea25014Config {
    private String name = "idea_025014";
 ...
 */
@Slf4j
public class Idea25014Service {
    private static final int IDEA_ID = 25014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25014Service() {
        this(new Idea25014Config());
    }

    public Idea25014Service(Idea25014Config config) {
        this.config = config != null ? config : new Idea25014Config();
