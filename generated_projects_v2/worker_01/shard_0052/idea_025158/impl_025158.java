...
@Data
public class Idea25158Config {
    private String name = "idea_025158";
 ...
 */
@Slf4j
public class Idea25158Service {
    private static final int IDEA_ID = 25158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25158Service() {
        this(new Idea25158Config());
    }

    public Idea25158Service(Idea25158Config config) {
        this.config = config != null ? config : new Idea25158Config();
