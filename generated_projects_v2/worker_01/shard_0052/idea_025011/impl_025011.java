...
@Data
public class Idea25011Config {
    private String name = "idea_025011";
 ...
 */
@Slf4j
public class Idea25011Service {
    private static final int IDEA_ID = 25011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25011Service() {
        this(new Idea25011Config());
    }

    public Idea25011Service(Idea25011Config config) {
        this.config = config != null ? config : new Idea25011Config();
