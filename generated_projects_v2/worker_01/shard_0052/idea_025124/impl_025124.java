...
@Data
public class Idea25124Config {
    private String name = "idea_025124";
 ...
 */
@Slf4j
public class Idea25124Service {
    private static final int IDEA_ID = 25124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25124Service() {
        this(new Idea25124Config());
    }

    public Idea25124Service(Idea25124Config config) {
        this.config = config != null ? config : new Idea25124Config();
