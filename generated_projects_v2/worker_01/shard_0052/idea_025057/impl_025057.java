...
@Data
public class Idea25057Config {
    private String name = "idea_025057";
 ...
 */
@Slf4j
public class Idea25057Service {
    private static final int IDEA_ID = 25057;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25057Service() {
        this(new Idea25057Config());
    }

    public Idea25057Service(Idea25057Config config) {
        this.config = config != null ? config : new Idea25057Config();
