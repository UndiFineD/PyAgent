...
@Data
public class Idea25092Config {
    private String name = "idea_025092";
 ...
 */
@Slf4j
public class Idea25092Service {
    private static final int IDEA_ID = 25092;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25092Service() {
        this(new Idea25092Config());
    }

    public Idea25092Service(Idea25092Config config) {
        this.config = config != null ? config : new Idea25092Config();
