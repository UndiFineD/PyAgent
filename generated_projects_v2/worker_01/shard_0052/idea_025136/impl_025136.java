...
@Data
public class Idea25136Config {
    private String name = "idea_025136";
 ...
 */
@Slf4j
public class Idea25136Service {
    private static final int IDEA_ID = 25136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25136Service() {
        this(new Idea25136Config());
    }

    public Idea25136Service(Idea25136Config config) {
        this.config = config != null ? config : new Idea25136Config();
