...
@Data
public class Idea25018Config {
    private String name = "idea_025018";
 ...
 */
@Slf4j
public class Idea25018Service {
    private static final int IDEA_ID = 25018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25018Service() {
        this(new Idea25018Config());
    }

    public Idea25018Service(Idea25018Config config) {
        this.config = config != null ? config : new Idea25018Config();
