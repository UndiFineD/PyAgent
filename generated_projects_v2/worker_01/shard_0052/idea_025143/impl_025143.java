...
@Data
public class Idea25143Config {
    private String name = "idea_025143";
 ...
 */
@Slf4j
public class Idea25143Service {
    private static final int IDEA_ID = 25143;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25143Service() {
        this(new Idea25143Config());
    }

    public Idea25143Service(Idea25143Config config) {
        this.config = config != null ? config : new Idea25143Config();
