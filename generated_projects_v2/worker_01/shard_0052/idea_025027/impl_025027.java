...
@Data
public class Idea25027Config {
    private String name = "idea_025027";
 ...
 */
@Slf4j
public class Idea25027Service {
    private static final int IDEA_ID = 25027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25027Service() {
        this(new Idea25027Config());
    }

    public Idea25027Service(Idea25027Config config) {
        this.config = config != null ? config : new Idea25027Config();
