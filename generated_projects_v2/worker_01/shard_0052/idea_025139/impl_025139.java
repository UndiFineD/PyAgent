...
@Data
public class Idea25139Config {
    private String name = "idea_025139";
 ...
 */
@Slf4j
public class Idea25139Service {
    private static final int IDEA_ID = 25139;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25139Service() {
        this(new Idea25139Config());
    }

    public Idea25139Service(Idea25139Config config) {
        this.config = config != null ? config : new Idea25139Config();
