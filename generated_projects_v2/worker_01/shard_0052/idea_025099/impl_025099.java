...
@Data
public class Idea25099Config {
    private String name = "idea_025099";
 ...
 */
@Slf4j
public class Idea25099Service {
    private static final int IDEA_ID = 25099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25099Service() {
        this(new Idea25099Config());
    }

    public Idea25099Service(Idea25099Config config) {
        this.config = config != null ? config : new Idea25099Config();
