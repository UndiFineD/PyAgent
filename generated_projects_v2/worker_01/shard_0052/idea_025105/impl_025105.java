...
@Data
public class Idea25105Config {
    private String name = "idea_025105";
 ...
 */
@Slf4j
public class Idea25105Service {
    private static final int IDEA_ID = 25105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25105Service() {
        this(new Idea25105Config());
    }

    public Idea25105Service(Idea25105Config config) {
        this.config = config != null ? config : new Idea25105Config();
