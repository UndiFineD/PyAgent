...
@Data
public class Idea25102Config {
    private String name = "idea_025102";
 ...
 */
@Slf4j
public class Idea25102Service {
    private static final int IDEA_ID = 25102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25102Service() {
        this(new Idea25102Config());
    }

    public Idea25102Service(Idea25102Config config) {
        this.config = config != null ? config : new Idea25102Config();
