...
@Data
public class Idea25068Config {
    private String name = "idea_025068";
 ...
 */
@Slf4j
public class Idea25068Service {
    private static final int IDEA_ID = 25068;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25068Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25068Service() {
        this(new Idea25068Config());
    }

    public Idea25068Service(Idea25068Config config) {
        this.config = config != null ? config : new Idea25068Config();
