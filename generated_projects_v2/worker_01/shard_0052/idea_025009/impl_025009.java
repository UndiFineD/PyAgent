...
@Data
public class Idea25009Config {
    private String name = "idea_025009";
 ...
 */
@Slf4j
public class Idea25009Service {
    private static final int IDEA_ID = 25009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25009Service() {
        this(new Idea25009Config());
    }

    public Idea25009Service(Idea25009Config config) {
        this.config = config != null ? config : new Idea25009Config();
