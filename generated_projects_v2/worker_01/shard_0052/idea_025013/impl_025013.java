...
@Data
public class Idea25013Config {
    private String name = "idea_025013";
 ...
 */
@Slf4j
public class Idea25013Service {
    private static final int IDEA_ID = 25013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25013Service() {
        this(new Idea25013Config());
    }

    public Idea25013Service(Idea25013Config config) {
        this.config = config != null ? config : new Idea25013Config();
