...
@Data
public class Idea25083Config {
    private String name = "idea_025083";
 ...
 */
@Slf4j
public class Idea25083Service {
    private static final int IDEA_ID = 25083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25083Service() {
        this(new Idea25083Config());
    }

    public Idea25083Service(Idea25083Config config) {
        this.config = config != null ? config : new Idea25083Config();
