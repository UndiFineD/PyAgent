...
@Data
public class Idea25008Config {
    private String name = "idea_025008";
 ...
 */
@Slf4j
public class Idea25008Service {
    private static final int IDEA_ID = 25008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25008Service() {
        this(new Idea25008Config());
    }

    public Idea25008Service(Idea25008Config config) {
        this.config = config != null ? config : new Idea25008Config();
