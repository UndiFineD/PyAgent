...
@Data
public class Idea25147Config {
    private String name = "idea_025147";
 ...
 */
@Slf4j
public class Idea25147Service {
    private static final int IDEA_ID = 25147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25147Service() {
        this(new Idea25147Config());
    }

    public Idea25147Service(Idea25147Config config) {
        this.config = config != null ? config : new Idea25147Config();
