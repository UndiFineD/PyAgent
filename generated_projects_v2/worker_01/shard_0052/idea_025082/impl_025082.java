...
@Data
public class Idea25082Config {
    private String name = "idea_025082";
 ...
 */
@Slf4j
public class Idea25082Service {
    private static final int IDEA_ID = 25082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25082Service() {
        this(new Idea25082Config());
    }

    public Idea25082Service(Idea25082Config config) {
        this.config = config != null ? config : new Idea25082Config();
