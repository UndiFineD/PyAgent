...
@Data
public class Idea25109Config {
    private String name = "idea_025109";
 ...
 */
@Slf4j
public class Idea25109Service {
    private static final int IDEA_ID = 25109;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25109Service() {
        this(new Idea25109Config());
    }

    public Idea25109Service(Idea25109Config config) {
        this.config = config != null ? config : new Idea25109Config();
