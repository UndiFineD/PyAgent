...
@Data
public class Idea25007Config {
    private String name = "idea_025007";
 ...
 */
@Slf4j
public class Idea25007Service {
    private static final int IDEA_ID = 25007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25007Service() {
        this(new Idea25007Config());
    }

    public Idea25007Service(Idea25007Config config) {
        this.config = config != null ? config : new Idea25007Config();
