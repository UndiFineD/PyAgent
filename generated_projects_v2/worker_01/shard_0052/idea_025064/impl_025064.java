...
@Data
public class Idea25064Config {
    private String name = "idea_025064";
 ...
 */
@Slf4j
public class Idea25064Service {
    private static final int IDEA_ID = 25064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25064Service() {
        this(new Idea25064Config());
    }

    public Idea25064Service(Idea25064Config config) {
        this.config = config != null ? config : new Idea25064Config();
