...
@Data
public class Idea25073Config {
    private String name = "idea_025073";
 ...
 */
@Slf4j
public class Idea25073Service {
    private static final int IDEA_ID = 25073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25073Service() {
        this(new Idea25073Config());
    }

    public Idea25073Service(Idea25073Config config) {
        this.config = config != null ? config : new Idea25073Config();
