...
@Data
public class Idea25101Config {
    private String name = "idea_025101";
 ...
 */
@Slf4j
public class Idea25101Service {
    private static final int IDEA_ID = 25101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25101Service() {
        this(new Idea25101Config());
    }

    public Idea25101Service(Idea25101Config config) {
        this.config = config != null ? config : new Idea25101Config();
