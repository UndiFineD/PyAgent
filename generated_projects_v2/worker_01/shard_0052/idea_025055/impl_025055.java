...
@Data
public class Idea25055Config {
    private String name = "idea_025055";
 ...
 */
@Slf4j
public class Idea25055Service {
    private static final int IDEA_ID = 25055;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25055Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25055Service() {
        this(new Idea25055Config());
    }

    public Idea25055Service(Idea25055Config config) {
        this.config = config != null ? config : new Idea25055Config();
