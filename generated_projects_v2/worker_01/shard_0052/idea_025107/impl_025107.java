...
@Data
public class Idea25107Config {
    private String name = "idea_025107";
 ...
 */
@Slf4j
public class Idea25107Service {
    private static final int IDEA_ID = 25107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25107Service() {
        this(new Idea25107Config());
    }

    public Idea25107Service(Idea25107Config config) {
        this.config = config != null ? config : new Idea25107Config();
