...
@Data
public class Idea25010Config {
    private String name = "idea_025010";
 ...
 */
@Slf4j
public class Idea25010Service {
    private static final int IDEA_ID = 25010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25010Service() {
        this(new Idea25010Config());
    }

    public Idea25010Service(Idea25010Config config) {
        this.config = config != null ? config : new Idea25010Config();
