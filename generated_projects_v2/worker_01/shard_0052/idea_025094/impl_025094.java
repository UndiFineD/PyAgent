...
@Data
public class Idea25094Config {
    private String name = "idea_025094";
 ...
 */
@Slf4j
public class Idea25094Service {
    private static final int IDEA_ID = 25094;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25094Service() {
        this(new Idea25094Config());
    }

    public Idea25094Service(Idea25094Config config) {
        this.config = config != null ? config : new Idea25094Config();
