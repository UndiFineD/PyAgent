...
@Data
public class Idea25079Config {
    private String name = "idea_025079";
 ...
 */
@Slf4j
public class Idea25079Service {
    private static final int IDEA_ID = 25079;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25079Service() {
        this(new Idea25079Config());
    }

    public Idea25079Service(Idea25079Config config) {
        this.config = config != null ? config : new Idea25079Config();
