...
@Data
public class Idea25048Config {
    private String name = "idea_025048";
 ...
 */
@Slf4j
public class Idea25048Service {
    private static final int IDEA_ID = 25048;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25048Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25048Service() {
        this(new Idea25048Config());
    }

    public Idea25048Service(Idea25048Config config) {
        this.config = config != null ? config : new Idea25048Config();
