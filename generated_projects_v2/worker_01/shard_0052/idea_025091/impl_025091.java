...
@Data
public class Idea25091Config {
    private String name = "idea_025091";
 ...
 */
@Slf4j
public class Idea25091Service {
    private static final int IDEA_ID = 25091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25091Service() {
        this(new Idea25091Config());
    }

    public Idea25091Service(Idea25091Config config) {
        this.config = config != null ? config : new Idea25091Config();
