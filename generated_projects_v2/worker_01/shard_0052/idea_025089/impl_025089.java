...
@Data
public class Idea25089Config {
    private String name = "idea_025089";
 ...
 */
@Slf4j
public class Idea25089Service {
    private static final int IDEA_ID = 25089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25089Service() {
        this(new Idea25089Config());
    }

    public Idea25089Service(Idea25089Config config) {
        this.config = config != null ? config : new Idea25089Config();
