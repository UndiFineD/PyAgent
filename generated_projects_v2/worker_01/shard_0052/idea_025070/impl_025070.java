...
@Data
public class Idea25070Config {
    private String name = "idea_025070";
 ...
 */
@Slf4j
public class Idea25070Service {
    private static final int IDEA_ID = 25070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25070Service() {
        this(new Idea25070Config());
    }

    public Idea25070Service(Idea25070Config config) {
        this.config = config != null ? config : new Idea25070Config();
