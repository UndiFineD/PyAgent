...
@Data
public class Idea25003Config {
    private String name = "idea_025003";
 ...
 */
@Slf4j
public class Idea25003Service {
    private static final int IDEA_ID = 25003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25003Service() {
        this(new Idea25003Config());
    }

    public Idea25003Service(Idea25003Config config) {
        this.config = config != null ? config : new Idea25003Config();
