...
@Data
public class Idea25157Config {
    private String name = "idea_025157";
 ...
 */
@Slf4j
public class Idea25157Service {
    private static final int IDEA_ID = 25157;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25157Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25157Service() {
        this(new Idea25157Config());
    }

    public Idea25157Service(Idea25157Config config) {
        this.config = config != null ? config : new Idea25157Config();
