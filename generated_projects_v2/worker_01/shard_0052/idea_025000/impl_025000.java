...
@Data
public class Idea25000Config {
    private String name = "idea_025000";
 ...
 */
@Slf4j
public class Idea25000Service {
    private static final int IDEA_ID = 25000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25000Service() {
        this(new Idea25000Config());
    }

    public Idea25000Service(Idea25000Config config) {
        this.config = config != null ? config : new Idea25000Config();
