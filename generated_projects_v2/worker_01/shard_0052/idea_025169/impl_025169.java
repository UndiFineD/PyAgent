...
@Data
public class Idea25169Config {
    private String name = "idea_025169";
 ...
 */
@Slf4j
public class Idea25169Service {
    private static final int IDEA_ID = 25169;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25169Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25169Service() {
        this(new Idea25169Config());
    }

    public Idea25169Service(Idea25169Config config) {
        this.config = config != null ? config : new Idea25169Config();
