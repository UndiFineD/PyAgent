...
@Data
public class Idea25096Config {
    private String name = "idea_025096";
 ...
 */
@Slf4j
public class Idea25096Service {
    private static final int IDEA_ID = 25096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25096Service() {
        this(new Idea25096Config());
    }

    public Idea25096Service(Idea25096Config config) {
        this.config = config != null ? config : new Idea25096Config();
