...
@Data
public class Idea25153Config {
    private String name = "idea_025153";
 ...
 */
@Slf4j
public class Idea25153Service {
    private static final int IDEA_ID = 25153;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25153Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25153Service() {
        this(new Idea25153Config());
    }

    public Idea25153Service(Idea25153Config config) {
        this.config = config != null ? config : new Idea25153Config();
