...
@Data
public class Idea25120Config {
    private String name = "idea_025120";
 ...
 */
@Slf4j
public class Idea25120Service {
    private static final int IDEA_ID = 25120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25120Service() {
        this(new Idea25120Config());
    }

    public Idea25120Service(Idea25120Config config) {
        this.config = config != null ? config : new Idea25120Config();
