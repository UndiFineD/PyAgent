...
@Data
public class Idea25076Config {
    private String name = "idea_025076";
 ...
 */
@Slf4j
public class Idea25076Service {
    private static final int IDEA_ID = 25076;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25076Service() {
        this(new Idea25076Config());
    }

    public Idea25076Service(Idea25076Config config) {
        this.config = config != null ? config : new Idea25076Config();
