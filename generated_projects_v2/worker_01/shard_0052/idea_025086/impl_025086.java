...
@Data
public class Idea25086Config {
    private String name = "idea_025086";
 ...
 */
@Slf4j
public class Idea25086Service {
    private static final int IDEA_ID = 25086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25086Service() {
        this(new Idea25086Config());
    }

    public Idea25086Service(Idea25086Config config) {
        this.config = config != null ? config : new Idea25086Config();
