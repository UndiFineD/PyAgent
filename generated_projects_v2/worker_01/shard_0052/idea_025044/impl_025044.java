...
@Data
public class Idea25044Config {
    private String name = "idea_025044";
 ...
 */
@Slf4j
public class Idea25044Service {
    private static final int IDEA_ID = 25044;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25044Service() {
        this(new Idea25044Config());
    }

    public Idea25044Service(Idea25044Config config) {
        this.config = config != null ? config : new Idea25044Config();
