...
@Data
public class Idea25131Config {
    private String name = "idea_025131";
 ...
 */
@Slf4j
public class Idea25131Service {
    private static final int IDEA_ID = 25131;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25131Service() {
        this(new Idea25131Config());
    }

    public Idea25131Service(Idea25131Config config) {
        this.config = config != null ? config : new Idea25131Config();
