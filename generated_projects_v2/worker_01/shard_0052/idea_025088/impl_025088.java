...
@Data
public class Idea25088Config {
    private String name = "idea_025088";
 ...
 */
@Slf4j
public class Idea25088Service {
    private static final int IDEA_ID = 25088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25088Service() {
        this(new Idea25088Config());
    }

    public Idea25088Service(Idea25088Config config) {
        this.config = config != null ? config : new Idea25088Config();
