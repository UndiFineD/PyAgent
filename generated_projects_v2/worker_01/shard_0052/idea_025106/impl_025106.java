...
@Data
public class Idea25106Config {
    private String name = "idea_025106";
 ...
 */
@Slf4j
public class Idea25106Service {
    private static final int IDEA_ID = 25106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25106Service() {
        this(new Idea25106Config());
    }

    public Idea25106Service(Idea25106Config config) {
        this.config = config != null ? config : new Idea25106Config();
