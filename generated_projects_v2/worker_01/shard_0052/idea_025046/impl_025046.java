...
@Data
public class Idea25046Config {
    private String name = "idea_025046";
 ...
 */
@Slf4j
public class Idea25046Service {
    private static final int IDEA_ID = 25046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25046Service() {
        this(new Idea25046Config());
    }

    public Idea25046Service(Idea25046Config config) {
        this.config = config != null ? config : new Idea25046Config();
