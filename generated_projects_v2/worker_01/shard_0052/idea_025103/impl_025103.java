...
@Data
public class Idea25103Config {
    private String name = "idea_025103";
 ...
 */
@Slf4j
public class Idea25103Service {
    private static final int IDEA_ID = 25103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25103Service() {
        this(new Idea25103Config());
    }

    public Idea25103Service(Idea25103Config config) {
        this.config = config != null ? config : new Idea25103Config();
