...
@Data
public class Idea25054Config {
    private String name = "idea_025054";
 ...
 */
@Slf4j
public class Idea25054Service {
    private static final int IDEA_ID = 25054;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25054Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25054Service() {
        this(new Idea25054Config());
    }

    public Idea25054Service(Idea25054Config config) {
        this.config = config != null ? config : new Idea25054Config();
