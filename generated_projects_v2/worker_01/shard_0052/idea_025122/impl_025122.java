...
@Data
public class Idea25122Config {
    private String name = "idea_025122";
 ...
 */
@Slf4j
public class Idea25122Service {
    private static final int IDEA_ID = 25122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25122Service() {
        this(new Idea25122Config());
    }

    public Idea25122Service(Idea25122Config config) {
        this.config = config != null ? config : new Idea25122Config();
