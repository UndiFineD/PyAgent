...
@Data
public class Idea25150Config {
    private String name = "idea_025150";
 ...
 */
@Slf4j
public class Idea25150Service {
    private static final int IDEA_ID = 25150;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25150Service() {
        this(new Idea25150Config());
    }

    public Idea25150Service(Idea25150Config config) {
        this.config = config != null ? config : new Idea25150Config();
