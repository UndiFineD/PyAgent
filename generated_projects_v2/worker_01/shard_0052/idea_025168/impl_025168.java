...
@Data
public class Idea25168Config {
    private String name = "idea_025168";
 ...
 */
@Slf4j
public class Idea25168Service {
    private static final int IDEA_ID = 25168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25168Service() {
        this(new Idea25168Config());
    }

    public Idea25168Service(Idea25168Config config) {
        this.config = config != null ? config : new Idea25168Config();
