...
@Data
public class Idea25140Config {
    private String name = "idea_025140";
 ...
 */
@Slf4j
public class Idea25140Service {
    private static final int IDEA_ID = 25140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25140Service() {
        this(new Idea25140Config());
    }

    public Idea25140Service(Idea25140Config config) {
        this.config = config != null ? config : new Idea25140Config();
