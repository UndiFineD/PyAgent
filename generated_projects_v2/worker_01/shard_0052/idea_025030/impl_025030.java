...
@Data
public class Idea25030Config {
    private String name = "idea_025030";
 ...
 */
@Slf4j
public class Idea25030Service {
    private static final int IDEA_ID = 25030;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25030Service() {
        this(new Idea25030Config());
    }

    public Idea25030Service(Idea25030Config config) {
        this.config = config != null ? config : new Idea25030Config();
