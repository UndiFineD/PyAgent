...
@Data
public class Idea25164Config {
    private String name = "idea_025164";
 ...
 */
@Slf4j
public class Idea25164Service {
    private static final int IDEA_ID = 25164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25164Service() {
        this(new Idea25164Config());
    }

    public Idea25164Service(Idea25164Config config) {
        this.config = config != null ? config : new Idea25164Config();
