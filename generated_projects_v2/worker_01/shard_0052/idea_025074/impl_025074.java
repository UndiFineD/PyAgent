...
@Data
public class Idea25074Config {
    private String name = "idea_025074";
 ...
 */
@Slf4j
public class Idea25074Service {
    private static final int IDEA_ID = 25074;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25074Service() {
        this(new Idea25074Config());
    }

    public Idea25074Service(Idea25074Config config) {
        this.config = config != null ? config : new Idea25074Config();
