...
@Data
public class Idea25154Config {
    private String name = "idea_025154";
 ...
 */
@Slf4j
public class Idea25154Service {
    private static final int IDEA_ID = 25154;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25154Service() {
        this(new Idea25154Config());
    }

    public Idea25154Service(Idea25154Config config) {
        this.config = config != null ? config : new Idea25154Config();
