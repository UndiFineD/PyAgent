...
@Data
public class Idea25163Config {
    private String name = "idea_025163";
 ...
 */
@Slf4j
public class Idea25163Service {
    private static final int IDEA_ID = 25163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25163Service() {
        this(new Idea25163Config());
    }

    public Idea25163Service(Idea25163Config config) {
        this.config = config != null ? config : new Idea25163Config();
