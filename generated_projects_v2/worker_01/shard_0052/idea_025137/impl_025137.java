...
@Data
public class Idea25137Config {
    private String name = "idea_025137";
 ...
 */
@Slf4j
public class Idea25137Service {
    private static final int IDEA_ID = 25137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25137Service() {
        this(new Idea25137Config());
    }

    public Idea25137Service(Idea25137Config config) {
        this.config = config != null ? config : new Idea25137Config();
