...
@Data
public class Idea25673Config {
    private String name = "idea_025673";
 ...
 */
@Slf4j
public class Idea25673Service {
    private static final int IDEA_ID = 25673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25673Service() {
        this(new Idea25673Config());
    }

    public Idea25673Service(Idea25673Config config) {
        this.config = config != null ? config : new Idea25673Config();
