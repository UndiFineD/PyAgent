...
@Data
public class Idea25708Config {
    private String name = "idea_025708";
 ...
 */
@Slf4j
public class Idea25708Service {
    private static final int IDEA_ID = 25708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25708Service() {
        this(new Idea25708Config());
    }

    public Idea25708Service(Idea25708Config config) {
        this.config = config != null ? config : new Idea25708Config();
