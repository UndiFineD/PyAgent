...
@Data
public class Idea25692Config {
    private String name = "idea_025692";
 ...
 */
@Slf4j
public class Idea25692Service {
    private static final int IDEA_ID = 25692;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25692Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25692Service() {
        this(new Idea25692Config());
    }

    public Idea25692Service(Idea25692Config config) {
        this.config = config != null ? config : new Idea25692Config();
