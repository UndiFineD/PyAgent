...
@Data
public class Idea25687Config {
    private String name = "idea_025687";
 ...
 */
@Slf4j
public class Idea25687Service {
    private static final int IDEA_ID = 25687;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25687Service() {
        this(new Idea25687Config());
    }

    public Idea25687Service(Idea25687Config config) {
        this.config = config != null ? config : new Idea25687Config();
