...
@Data
public class Idea25963Config {
    private String name = "idea_025963";
 ...
 */
@Slf4j
public class Idea25963Service {
    private static final int IDEA_ID = 25963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25963Service() {
        this(new Idea25963Config());
    }

    public Idea25963Service(Idea25963Config config) {
        this.config = config != null ? config : new Idea25963Config();
