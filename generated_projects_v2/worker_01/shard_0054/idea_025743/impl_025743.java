...
@Data
public class Idea25743Config {
    private String name = "idea_025743";
 ...
 */
@Slf4j
public class Idea25743Service {
    private static final int IDEA_ID = 25743;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25743Service() {
        this(new Idea25743Config());
    }

    public Idea25743Service(Idea25743Config config) {
        this.config = config != null ? config : new Idea25743Config();
