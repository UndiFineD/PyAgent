...
@Data
public class Idea25783Config {
    private String name = "idea_025783";
 ...
 */
@Slf4j
public class Idea25783Service {
    private static final int IDEA_ID = 25783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25783Service() {
        this(new Idea25783Config());
    }

    public Idea25783Service(Idea25783Config config) {
        this.config = config != null ? config : new Idea25783Config();
