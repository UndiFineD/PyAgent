...
@Data
public class Idea25682Config {
    private String name = "idea_025682";
 ...
 */
@Slf4j
public class Idea25682Service {
    private static final int IDEA_ID = 25682;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25682Service() {
        this(new Idea25682Config());
    }

    public Idea25682Service(Idea25682Config config) {
        this.config = config != null ? config : new Idea25682Config();
