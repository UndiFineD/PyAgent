...
@Data
public class Idea25863Config {
    private String name = "idea_025863";
 ...
 */
@Slf4j
public class Idea25863Service {
    private static final int IDEA_ID = 25863;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25863Service() {
        this(new Idea25863Config());
    }

    public Idea25863Service(Idea25863Config config) {
        this.config = config != null ? config : new Idea25863Config();
