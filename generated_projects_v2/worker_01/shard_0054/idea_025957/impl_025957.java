...
@Data
public class Idea25957Config {
    private String name = "idea_025957";
 ...
 */
@Slf4j
public class Idea25957Service {
    private static final int IDEA_ID = 25957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25957Service() {
        this(new Idea25957Config());
    }

    public Idea25957Service(Idea25957Config config) {
        this.config = config != null ? config : new Idea25957Config();
