...
@Data
public class Idea25772Config {
    private String name = "idea_025772";
 ...
 */
@Slf4j
public class Idea25772Service {
    private static final int IDEA_ID = 25772;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25772Service() {
        this(new Idea25772Config());
    }

    public Idea25772Service(Idea25772Config config) {
        this.config = config != null ? config : new Idea25772Config();
