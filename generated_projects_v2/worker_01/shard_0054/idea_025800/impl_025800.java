...
@Data
public class Idea25800Config {
    private String name = "idea_025800";
 ...
 */
@Slf4j
public class Idea25800Service {
    private static final int IDEA_ID = 25800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25800Service() {
        this(new Idea25800Config());
    }

    public Idea25800Service(Idea25800Config config) {
        this.config = config != null ? config : new Idea25800Config();
