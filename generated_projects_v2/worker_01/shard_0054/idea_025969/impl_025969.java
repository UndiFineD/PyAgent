...
@Data
public class Idea25969Config {
    private String name = "idea_025969";
 ...
 */
@Slf4j
public class Idea25969Service {
    private static final int IDEA_ID = 25969;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25969Service() {
        this(new Idea25969Config());
    }

    public Idea25969Service(Idea25969Config config) {
        this.config = config != null ? config : new Idea25969Config();
