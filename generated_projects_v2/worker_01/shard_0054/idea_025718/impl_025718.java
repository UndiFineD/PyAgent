...
@Data
public class Idea25718Config {
    private String name = "idea_025718";
 ...
 */
@Slf4j
public class Idea25718Service {
    private static final int IDEA_ID = 25718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25718Service() {
        this(new Idea25718Config());
    }

    public Idea25718Service(Idea25718Config config) {
        this.config = config != null ? config : new Idea25718Config();
