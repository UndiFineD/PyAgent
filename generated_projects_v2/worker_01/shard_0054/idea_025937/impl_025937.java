...
@Data
public class Idea25937Config {
    private String name = "idea_025937";
 ...
 */
@Slf4j
public class Idea25937Service {
    private static final int IDEA_ID = 25937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25937Service() {
        this(new Idea25937Config());
    }

    public Idea25937Service(Idea25937Config config) {
        this.config = config != null ? config : new Idea25937Config();
