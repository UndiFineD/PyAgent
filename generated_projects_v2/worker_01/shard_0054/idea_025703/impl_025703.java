...
@Data
public class Idea25703Config {
    private String name = "idea_025703";
 ...
 */
@Slf4j
public class Idea25703Service {
    private static final int IDEA_ID = 25703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25703Service() {
        this(new Idea25703Config());
    }

    public Idea25703Service(Idea25703Config config) {
        this.config = config != null ? config : new Idea25703Config();
