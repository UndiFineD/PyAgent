...
@Data
public class Idea25814Config {
    private String name = "idea_025814";
 ...
 */
@Slf4j
public class Idea25814Service {
    private static final int IDEA_ID = 25814;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25814Service() {
        this(new Idea25814Config());
    }

    public Idea25814Service(Idea25814Config config) {
        this.config = config != null ? config : new Idea25814Config();
