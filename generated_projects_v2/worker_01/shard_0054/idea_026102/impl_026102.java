...
@Data
public class Idea26102Config {
    private String name = "idea_026102";
 ...
 */
@Slf4j
public class Idea26102Service {
    private static final int IDEA_ID = 26102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26102Service() {
        this(new Idea26102Config());
    }

    public Idea26102Service(Idea26102Config config) {
        this.config = config != null ? config : new Idea26102Config();
