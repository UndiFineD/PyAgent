...
@Data
public class Idea25928Config {
    private String name = "idea_025928";
 ...
 */
@Slf4j
public class Idea25928Service {
    private static final int IDEA_ID = 25928;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25928Service() {
        this(new Idea25928Config());
    }

    public Idea25928Service(Idea25928Config config) {
        this.config = config != null ? config : new Idea25928Config();
