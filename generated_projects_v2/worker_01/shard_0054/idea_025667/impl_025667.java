...
@Data
public class Idea25667Config {
    private String name = "idea_025667";
 ...
 */
@Slf4j
public class Idea25667Service {
    private static final int IDEA_ID = 25667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25667Service() {
        this(new Idea25667Config());
    }

    public Idea25667Service(Idea25667Config config) {
        this.config = config != null ? config : new Idea25667Config();
