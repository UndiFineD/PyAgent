...
@Data
public class Idea25791Config {
    private String name = "idea_025791";
 ...
 */
@Slf4j
public class Idea25791Service {
    private static final int IDEA_ID = 25791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25791Service() {
        this(new Idea25791Config());
    }

    public Idea25791Service(Idea25791Config config) {
        this.config = config != null ? config : new Idea25791Config();
