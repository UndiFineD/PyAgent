...
@Data
public class Idea25900Config {
    private String name = "idea_025900";
 ...
 */
@Slf4j
public class Idea25900Service {
    private static final int IDEA_ID = 25900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25900Service() {
        this(new Idea25900Config());
    }

    public Idea25900Service(Idea25900Config config) {
        this.config = config != null ? config : new Idea25900Config();
