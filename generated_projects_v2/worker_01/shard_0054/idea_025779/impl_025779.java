...
@Data
public class Idea25779Config {
    private String name = "idea_025779";
 ...
 */
@Slf4j
public class Idea25779Service {
    private static final int IDEA_ID = 25779;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25779Service() {
        this(new Idea25779Config());
    }

    public Idea25779Service(Idea25779Config config) {
        this.config = config != null ? config : new Idea25779Config();
