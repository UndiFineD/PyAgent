...
@Data
public class Idea25664Config {
    private String name = "idea_025664";
 ...
 */
@Slf4j
public class Idea25664Service {
    private static final int IDEA_ID = 25664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25664Service() {
        this(new Idea25664Config());
    }

    public Idea25664Service(Idea25664Config config) {
        this.config = config != null ? config : new Idea25664Config();
