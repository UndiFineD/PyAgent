...
@Data
public class Idea26092Config {
    private String name = "idea_026092";
 ...
 */
@Slf4j
public class Idea26092Service {
    private static final int IDEA_ID = 26092;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26092Service() {
        this(new Idea26092Config());
    }

    public Idea26092Service(Idea26092Config config) {
        this.config = config != null ? config : new Idea26092Config();
