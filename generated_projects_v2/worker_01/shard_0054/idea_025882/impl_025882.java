...
@Data
public class Idea25882Config {
    private String name = "idea_025882";
 ...
 */
@Slf4j
public class Idea25882Service {
    private static final int IDEA_ID = 25882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25882Service() {
        this(new Idea25882Config());
    }

    public Idea25882Service(Idea25882Config config) {
        this.config = config != null ? config : new Idea25882Config();
