...
@Data
public class Idea25655Config {
    private String name = "idea_025655";
 ...
 */
@Slf4j
public class Idea25655Service {
    private static final int IDEA_ID = 25655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25655Service() {
        this(new Idea25655Config());
    }

    public Idea25655Service(Idea25655Config config) {
        this.config = config != null ? config : new Idea25655Config();
