...
@Data
public class Idea25799Config {
    private String name = "idea_025799";
 ...
 */
@Slf4j
public class Idea25799Service {
    private static final int IDEA_ID = 25799;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25799Service() {
        this(new Idea25799Config());
    }

    public Idea25799Service(Idea25799Config config) {
        this.config = config != null ? config : new Idea25799Config();
