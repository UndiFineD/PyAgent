...
@Data
public class Idea25660Config {
    private String name = "idea_025660";
 ...
 */
@Slf4j
public class Idea25660Service {
    private static final int IDEA_ID = 25660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25660Service() {
        this(new Idea25660Config());
    }

    public Idea25660Service(Idea25660Config config) {
        this.config = config != null ? config : new Idea25660Config();
