...
@Data
public class Idea26016Config {
    private String name = "idea_026016";
 ...
 */
@Slf4j
public class Idea26016Service {
    private static final int IDEA_ID = 26016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26016Service() {
        this(new Idea26016Config());
    }

    public Idea26016Service(Idea26016Config config) {
        this.config = config != null ? config : new Idea26016Config();
