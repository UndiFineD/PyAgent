...
@Data
public class Idea25894Config {
    private String name = "idea_025894";
 ...
 */
@Slf4j
public class Idea25894Service {
    private static final int IDEA_ID = 25894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25894Service() {
        this(new Idea25894Config());
    }

    public Idea25894Service(Idea25894Config config) {
        this.config = config != null ? config : new Idea25894Config();
