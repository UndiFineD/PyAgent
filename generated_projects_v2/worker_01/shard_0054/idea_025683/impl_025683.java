...
@Data
public class Idea25683Config {
    private String name = "idea_025683";
 ...
 */
@Slf4j
public class Idea25683Service {
    private static final int IDEA_ID = 25683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25683Service() {
        this(new Idea25683Config());
    }

    public Idea25683Service(Idea25683Config config) {
        this.config = config != null ? config : new Idea25683Config();
