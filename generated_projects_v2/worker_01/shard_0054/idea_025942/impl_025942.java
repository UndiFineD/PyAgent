...
@Data
public class Idea25942Config {
    private String name = "idea_025942";
 ...
 */
@Slf4j
public class Idea25942Service {
    private static final int IDEA_ID = 25942;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25942Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25942Service() {
        this(new Idea25942Config());
    }

    public Idea25942Service(Idea25942Config config) {
        this.config = config != null ? config : new Idea25942Config();
