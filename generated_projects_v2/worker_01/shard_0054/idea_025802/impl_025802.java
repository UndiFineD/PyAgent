...
@Data
public class Idea25802Config {
    private String name = "idea_025802";
 ...
 */
@Slf4j
public class Idea25802Service {
    private static final int IDEA_ID = 25802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25802Service() {
        this(new Idea25802Config());
    }

    public Idea25802Service(Idea25802Config config) {
        this.config = config != null ? config : new Idea25802Config();
