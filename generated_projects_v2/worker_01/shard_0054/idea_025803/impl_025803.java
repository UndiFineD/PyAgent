...
@Data
public class Idea25803Config {
    private String name = "idea_025803";
 ...
 */
@Slf4j
public class Idea25803Service {
    private static final int IDEA_ID = 25803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25803Service() {
        this(new Idea25803Config());
    }

    public Idea25803Service(Idea25803Config config) {
        this.config = config != null ? config : new Idea25803Config();
