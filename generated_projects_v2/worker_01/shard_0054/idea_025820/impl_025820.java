...
@Data
public class Idea25820Config {
    private String name = "idea_025820";
 ...
 */
@Slf4j
public class Idea25820Service {
    private static final int IDEA_ID = 25820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25820Service() {
        this(new Idea25820Config());
    }

    public Idea25820Service(Idea25820Config config) {
        this.config = config != null ? config : new Idea25820Config();
