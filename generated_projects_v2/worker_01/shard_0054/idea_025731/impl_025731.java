...
@Data
public class Idea25731Config {
    private String name = "idea_025731";
 ...
 */
@Slf4j
public class Idea25731Service {
    private static final int IDEA_ID = 25731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25731Service() {
        this(new Idea25731Config());
    }

    public Idea25731Service(Idea25731Config config) {
        this.config = config != null ? config : new Idea25731Config();
