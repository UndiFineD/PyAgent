...
@Data
public class Idea25977Config {
    private String name = "idea_025977";
 ...
 */
@Slf4j
public class Idea25977Service {
    private static final int IDEA_ID = 25977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25977Service() {
        this(new Idea25977Config());
    }

    public Idea25977Service(Idea25977Config config) {
        this.config = config != null ? config : new Idea25977Config();
