...
@Data
public class Idea25828Config {
    private String name = "idea_025828";
 ...
 */
@Slf4j
public class Idea25828Service {
    private static final int IDEA_ID = 25828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25828Service() {
        this(new Idea25828Config());
    }

    public Idea25828Service(Idea25828Config config) {
        this.config = config != null ? config : new Idea25828Config();
