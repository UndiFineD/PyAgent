...
@Data
public class Idea25676Config {
    private String name = "idea_025676";
 ...
 */
@Slf4j
public class Idea25676Service {
    private static final int IDEA_ID = 25676;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25676Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25676Service() {
        this(new Idea25676Config());
    }

    public Idea25676Service(Idea25676Config config) {
        this.config = config != null ? config : new Idea25676Config();
