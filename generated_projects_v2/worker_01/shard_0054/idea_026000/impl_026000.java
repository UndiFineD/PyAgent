...
@Data
public class Idea26000Config {
    private String name = "idea_026000";
 ...
 */
@Slf4j
public class Idea26000Service {
    private static final int IDEA_ID = 26000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26000Service() {
        this(new Idea26000Config());
    }

    public Idea26000Service(Idea26000Config config) {
        this.config = config != null ? config : new Idea26000Config();
