...
@Data
public class Idea25686Config {
    private String name = "idea_025686";
 ...
 */
@Slf4j
public class Idea25686Service {
    private static final int IDEA_ID = 25686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25686Service() {
        this(new Idea25686Config());
    }

    public Idea25686Service(Idea25686Config config) {
        this.config = config != null ? config : new Idea25686Config();
