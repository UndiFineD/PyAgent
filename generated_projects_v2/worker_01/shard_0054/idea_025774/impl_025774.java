...
@Data
public class Idea25774Config {
    private String name = "idea_025774";
 ...
 */
@Slf4j
public class Idea25774Service {
    private static final int IDEA_ID = 25774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25774Service() {
        this(new Idea25774Config());
    }

    public Idea25774Service(Idea25774Config config) {
        this.config = config != null ? config : new Idea25774Config();
