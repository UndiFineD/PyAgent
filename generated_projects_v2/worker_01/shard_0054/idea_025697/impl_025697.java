...
@Data
public class Idea25697Config {
    private String name = "idea_025697";
 ...
 */
@Slf4j
public class Idea25697Service {
    private static final int IDEA_ID = 25697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25697Service() {
        this(new Idea25697Config());
    }

    public Idea25697Service(Idea25697Config config) {
        this.config = config != null ? config : new Idea25697Config();
