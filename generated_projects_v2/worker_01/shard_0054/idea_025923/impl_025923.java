...
@Data
public class Idea25923Config {
    private String name = "idea_025923";
 ...
 */
@Slf4j
public class Idea25923Service {
    private static final int IDEA_ID = 25923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25923Service() {
        this(new Idea25923Config());
    }

    public Idea25923Service(Idea25923Config config) {
        this.config = config != null ? config : new Idea25923Config();
