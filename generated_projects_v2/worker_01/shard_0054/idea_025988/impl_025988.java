...
@Data
public class Idea25988Config {
    private String name = "idea_025988";
 ...
 */
@Slf4j
public class Idea25988Service {
    private static final int IDEA_ID = 25988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25988Service() {
        this(new Idea25988Config());
    }

    public Idea25988Service(Idea25988Config config) {
        this.config = config != null ? config : new Idea25988Config();
