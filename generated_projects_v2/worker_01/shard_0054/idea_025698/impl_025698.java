...
@Data
public class Idea25698Config {
    private String name = "idea_025698";
 ...
 */
@Slf4j
public class Idea25698Service {
    private static final int IDEA_ID = 25698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25698Service() {
        this(new Idea25698Config());
    }

    public Idea25698Service(Idea25698Config config) {
        this.config = config != null ? config : new Idea25698Config();
