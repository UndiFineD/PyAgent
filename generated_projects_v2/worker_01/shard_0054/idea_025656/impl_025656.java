...
@Data
public class Idea25656Config {
    private String name = "idea_025656";
 ...
 */
@Slf4j
public class Idea25656Service {
    private static final int IDEA_ID = 25656;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25656Service() {
        this(new Idea25656Config());
    }

    public Idea25656Service(Idea25656Config config) {
        this.config = config != null ? config : new Idea25656Config();
