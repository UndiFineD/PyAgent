...
@Data
public class Idea26003Config {
    private String name = "idea_026003";
 ...
 */
@Slf4j
public class Idea26003Service {
    private static final int IDEA_ID = 26003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26003Service() {
        this(new Idea26003Config());
    }

    public Idea26003Service(Idea26003Config config) {
        this.config = config != null ? config : new Idea26003Config();
