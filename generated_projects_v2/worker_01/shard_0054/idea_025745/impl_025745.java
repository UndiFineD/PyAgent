...
@Data
public class Idea25745Config {
    private String name = "idea_025745";
 ...
 */
@Slf4j
public class Idea25745Service {
    private static final int IDEA_ID = 25745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25745Service() {
        this(new Idea25745Config());
    }

    public Idea25745Service(Idea25745Config config) {
        this.config = config != null ? config : new Idea25745Config();
