...
@Data
public class Idea25694Config {
    private String name = "idea_025694";
 ...
 */
@Slf4j
public class Idea25694Service {
    private static final int IDEA_ID = 25694;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25694Service() {
        this(new Idea25694Config());
    }

    public Idea25694Service(Idea25694Config config) {
        this.config = config != null ? config : new Idea25694Config();
