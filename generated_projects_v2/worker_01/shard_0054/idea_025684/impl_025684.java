...
@Data
public class Idea25684Config {
    private String name = "idea_025684";
 ...
 */
@Slf4j
public class Idea25684Service {
    private static final int IDEA_ID = 25684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25684Service() {
        this(new Idea25684Config());
    }

    public Idea25684Service(Idea25684Config config) {
        this.config = config != null ? config : new Idea25684Config();
