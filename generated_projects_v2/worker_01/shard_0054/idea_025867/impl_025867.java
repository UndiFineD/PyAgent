...
@Data
public class Idea25867Config {
    private String name = "idea_025867";
 ...
 */
@Slf4j
public class Idea25867Service {
    private static final int IDEA_ID = 25867;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25867Service() {
        this(new Idea25867Config());
    }

    public Idea25867Service(Idea25867Config config) {
        this.config = config != null ? config : new Idea25867Config();
