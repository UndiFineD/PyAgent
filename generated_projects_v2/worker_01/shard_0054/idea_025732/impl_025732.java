...
@Data
public class Idea25732Config {
    private String name = "idea_025732";
 ...
 */
@Slf4j
public class Idea25732Service {
    private static final int IDEA_ID = 25732;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25732Service() {
        this(new Idea25732Config());
    }

    public Idea25732Service(Idea25732Config config) {
        this.config = config != null ? config : new Idea25732Config();
