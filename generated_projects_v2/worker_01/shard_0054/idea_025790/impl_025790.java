...
@Data
public class Idea25790Config {
    private String name = "idea_025790";
 ...
 */
@Slf4j
public class Idea25790Service {
    private static final int IDEA_ID = 25790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25790Service() {
        this(new Idea25790Config());
    }

    public Idea25790Service(Idea25790Config config) {
        this.config = config != null ? config : new Idea25790Config();
