...
@Data
public class Idea25738Config {
    private String name = "idea_025738";
 ...
 */
@Slf4j
public class Idea25738Service {
    private static final int IDEA_ID = 25738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25738Service() {
        this(new Idea25738Config());
    }

    public Idea25738Service(Idea25738Config config) {
        this.config = config != null ? config : new Idea25738Config();
