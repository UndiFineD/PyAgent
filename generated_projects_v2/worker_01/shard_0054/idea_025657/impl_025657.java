...
@Data
public class Idea25657Config {
    private String name = "idea_025657";
 ...
 */
@Slf4j
public class Idea25657Service {
    private static final int IDEA_ID = 25657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25657Service() {
        this(new Idea25657Config());
    }

    public Idea25657Service(Idea25657Config config) {
        this.config = config != null ? config : new Idea25657Config();
