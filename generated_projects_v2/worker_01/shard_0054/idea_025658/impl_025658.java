...
@Data
public class Idea25658Config {
    private String name = "idea_025658";
 ...
 */
@Slf4j
public class Idea25658Service {
    private static final int IDEA_ID = 25658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25658Service() {
        this(new Idea25658Config());
    }

    public Idea25658Service(Idea25658Config config) {
        this.config = config != null ? config : new Idea25658Config();
