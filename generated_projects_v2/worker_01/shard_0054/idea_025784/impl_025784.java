...
@Data
public class Idea25784Config {
    private String name = "idea_025784";
 ...
 */
@Slf4j
public class Idea25784Service {
    private static final int IDEA_ID = 25784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25784Service() {
        this(new Idea25784Config());
    }

    public Idea25784Service(Idea25784Config config) {
        this.config = config != null ? config : new Idea25784Config();
