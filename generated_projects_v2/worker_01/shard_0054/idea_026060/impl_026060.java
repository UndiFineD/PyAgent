...
@Data
public class Idea26060Config {
    private String name = "idea_026060";
 ...
 */
@Slf4j
public class Idea26060Service {
    private static final int IDEA_ID = 26060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26060Service() {
        this(new Idea26060Config());
    }

    public Idea26060Service(Idea26060Config config) {
        this.config = config != null ? config : new Idea26060Config();
