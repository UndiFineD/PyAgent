...
@Data
public class Idea26123Config {
    private String name = "idea_026123";
 ...
 */
@Slf4j
public class Idea26123Service {
    private static final int IDEA_ID = 26123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26123Service() {
        this(new Idea26123Config());
    }

    public Idea26123Service(Idea26123Config config) {
        this.config = config != null ? config : new Idea26123Config();
