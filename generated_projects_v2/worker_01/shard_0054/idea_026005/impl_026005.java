...
@Data
public class Idea26005Config {
    private String name = "idea_026005";
 ...
 */
@Slf4j
public class Idea26005Service {
    private static final int IDEA_ID = 26005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26005Service() {
        this(new Idea26005Config());
    }

    public Idea26005Service(Idea26005Config config) {
        this.config = config != null ? config : new Idea26005Config();
