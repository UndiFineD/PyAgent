...
@Data
public class Idea26088Config {
    private String name = "idea_026088";
 ...
 */
@Slf4j
public class Idea26088Service {
    private static final int IDEA_ID = 26088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26088Service() {
        this(new Idea26088Config());
    }

    public Idea26088Service(Idea26088Config config) {
        this.config = config != null ? config : new Idea26088Config();
