...
@Data
public class Idea25948Config {
    private String name = "idea_025948";
 ...
 */
@Slf4j
public class Idea25948Service {
    private static final int IDEA_ID = 25948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25948Service() {
        this(new Idea25948Config());
    }

    public Idea25948Service(Idea25948Config config) {
        this.config = config != null ? config : new Idea25948Config();
