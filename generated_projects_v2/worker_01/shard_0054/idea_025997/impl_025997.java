...
@Data
public class Idea25997Config {
    private String name = "idea_025997";
 ...
 */
@Slf4j
public class Idea25997Service {
    private static final int IDEA_ID = 25997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25997Service() {
        this(new Idea25997Config());
    }

    public Idea25997Service(Idea25997Config config) {
        this.config = config != null ? config : new Idea25997Config();
