...
@Data
public class Idea26104Config {
    private String name = "idea_026104";
 ...
 */
@Slf4j
public class Idea26104Service {
    private static final int IDEA_ID = 26104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26104Service() {
        this(new Idea26104Config());
    }

    public Idea26104Service(Idea26104Config config) {
        this.config = config != null ? config : new Idea26104Config();
