...
@Data
public class Idea25839Config {
    private String name = "idea_025839";
 ...
 */
@Slf4j
public class Idea25839Service {
    private static final int IDEA_ID = 25839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25839Service() {
        this(new Idea25839Config());
    }

    public Idea25839Service(Idea25839Config config) {
        this.config = config != null ? config : new Idea25839Config();
