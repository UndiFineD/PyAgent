...
@Data
public class Idea25775Config {
    private String name = "idea_025775";
 ...
 */
@Slf4j
public class Idea25775Service {
    private static final int IDEA_ID = 25775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25775Service() {
        this(new Idea25775Config());
    }

    public Idea25775Service(Idea25775Config config) {
        this.config = config != null ? config : new Idea25775Config();
