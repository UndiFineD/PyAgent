...
@Data
public class Idea25653Config {
    private String name = "idea_025653";
 ...
 */
@Slf4j
public class Idea25653Service {
    private static final int IDEA_ID = 25653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25653Service() {
        this(new Idea25653Config());
    }

    public Idea25653Service(Idea25653Config config) {
        this.config = config != null ? config : new Idea25653Config();
