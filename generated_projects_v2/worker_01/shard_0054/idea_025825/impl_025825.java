...
@Data
public class Idea25825Config {
    private String name = "idea_025825";
 ...
 */
@Slf4j
public class Idea25825Service {
    private static final int IDEA_ID = 25825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25825Service() {
        this(new Idea25825Config());
    }

    public Idea25825Service(Idea25825Config config) {
        this.config = config != null ? config : new Idea25825Config();
