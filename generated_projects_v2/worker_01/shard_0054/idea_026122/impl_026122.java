...
@Data
public class Idea26122Config {
    private String name = "idea_026122";
 ...
 */
@Slf4j
public class Idea26122Service {
    private static final int IDEA_ID = 26122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26122Service() {
        this(new Idea26122Config());
    }

    public Idea26122Service(Idea26122Config config) {
        this.config = config != null ? config : new Idea26122Config();
