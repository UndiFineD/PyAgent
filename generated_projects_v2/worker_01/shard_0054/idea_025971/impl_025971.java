...
@Data
public class Idea25971Config {
    private String name = "idea_025971";
 ...
 */
@Slf4j
public class Idea25971Service {
    private static final int IDEA_ID = 25971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25971Service() {
        this(new Idea25971Config());
    }

    public Idea25971Service(Idea25971Config config) {
        this.config = config != null ? config : new Idea25971Config();
