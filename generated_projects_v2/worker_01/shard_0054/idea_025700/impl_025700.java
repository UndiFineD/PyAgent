...
@Data
public class Idea25700Config {
    private String name = "idea_025700";
 ...
 */
@Slf4j
public class Idea25700Service {
    private static final int IDEA_ID = 25700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25700Service() {
        this(new Idea25700Config());
    }

    public Idea25700Service(Idea25700Config config) {
        this.config = config != null ? config : new Idea25700Config();
