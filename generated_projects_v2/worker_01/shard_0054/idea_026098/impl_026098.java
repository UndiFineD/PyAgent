...
@Data
public class Idea26098Config {
    private String name = "idea_026098";
 ...
 */
@Slf4j
public class Idea26098Service {
    private static final int IDEA_ID = 26098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26098Service() {
        this(new Idea26098Config());
    }

    public Idea26098Service(Idea26098Config config) {
        this.config = config != null ? config : new Idea26098Config();
