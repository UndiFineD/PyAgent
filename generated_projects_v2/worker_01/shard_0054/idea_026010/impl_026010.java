...
@Data
public class Idea26010Config {
    private String name = "idea_026010";
 ...
 */
@Slf4j
public class Idea26010Service {
    private static final int IDEA_ID = 26010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26010Service() {
        this(new Idea26010Config());
    }

    public Idea26010Service(Idea26010Config config) {
        this.config = config != null ? config : new Idea26010Config();
