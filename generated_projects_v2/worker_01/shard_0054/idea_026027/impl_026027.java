...
@Data
public class Idea26027Config {
    private String name = "idea_026027";
 ...
 */
@Slf4j
public class Idea26027Service {
    private static final int IDEA_ID = 26027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26027Service() {
        this(new Idea26027Config());
    }

    public Idea26027Service(Idea26027Config config) {
        this.config = config != null ? config : new Idea26027Config();
