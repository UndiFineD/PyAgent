...
@Data
public class Idea25947Config {
    private String name = "idea_025947";
 ...
 */
@Slf4j
public class Idea25947Service {
    private static final int IDEA_ID = 25947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25947Service() {
        this(new Idea25947Config());
    }

    public Idea25947Service(Idea25947Config config) {
        this.config = config != null ? config : new Idea25947Config();
