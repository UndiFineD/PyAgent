...
@Data
public class Idea25761Config {
    private String name = "idea_025761";
 ...
 */
@Slf4j
public class Idea25761Service {
    private static final int IDEA_ID = 25761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25761Service() {
        this(new Idea25761Config());
    }

    public Idea25761Service(Idea25761Config config) {
        this.config = config != null ? config : new Idea25761Config();
