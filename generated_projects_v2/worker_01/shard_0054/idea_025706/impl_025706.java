...
@Data
public class Idea25706Config {
    private String name = "idea_025706";
 ...
 */
@Slf4j
public class Idea25706Service {
    private static final int IDEA_ID = 25706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25706Service() {
        this(new Idea25706Config());
    }

    public Idea25706Service(Idea25706Config config) {
        this.config = config != null ? config : new Idea25706Config();
