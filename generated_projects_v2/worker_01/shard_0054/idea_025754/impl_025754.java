...
@Data
public class Idea25754Config {
    private String name = "idea_025754";
 ...
 */
@Slf4j
public class Idea25754Service {
    private static final int IDEA_ID = 25754;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25754Service() {
        this(new Idea25754Config());
    }

    public Idea25754Service(Idea25754Config config) {
        this.config = config != null ? config : new Idea25754Config();
