...
@Data
public class Idea25685Config {
    private String name = "idea_025685";
 ...
 */
@Slf4j
public class Idea25685Service {
    private static final int IDEA_ID = 25685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25685Service() {
        this(new Idea25685Config());
    }

    public Idea25685Service(Idea25685Config config) {
        this.config = config != null ? config : new Idea25685Config();
