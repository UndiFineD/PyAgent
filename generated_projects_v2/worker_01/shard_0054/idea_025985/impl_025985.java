...
@Data
public class Idea25985Config {
    private String name = "idea_025985";
 ...
 */
@Slf4j
public class Idea25985Service {
    private static final int IDEA_ID = 25985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25985Service() {
        this(new Idea25985Config());
    }

    public Idea25985Service(Idea25985Config config) {
        this.config = config != null ? config : new Idea25985Config();
