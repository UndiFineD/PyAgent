...
@Data
public class Idea26018Config {
    private String name = "idea_026018";
 ...
 */
@Slf4j
public class Idea26018Service {
    private static final int IDEA_ID = 26018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26018Service() {
        this(new Idea26018Config());
    }

    public Idea26018Service(Idea26018Config config) {
        this.config = config != null ? config : new Idea26018Config();
