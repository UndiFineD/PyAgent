...
@Data
public class Idea25680Config {
    private String name = "idea_025680";
 ...
 */
@Slf4j
public class Idea25680Service {
    private static final int IDEA_ID = 25680;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25680Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25680Service() {
        this(new Idea25680Config());
    }

    public Idea25680Service(Idea25680Config config) {
        this.config = config != null ? config : new Idea25680Config();
