...
@Data
public class Idea25823Config {
    private String name = "idea_025823";
 ...
 */
@Slf4j
public class Idea25823Service {
    private static final int IDEA_ID = 25823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25823Service() {
        this(new Idea25823Config());
    }

    public Idea25823Service(Idea25823Config config) {
        this.config = config != null ? config : new Idea25823Config();
