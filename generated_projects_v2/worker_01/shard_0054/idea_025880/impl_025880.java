...
@Data
public class Idea25880Config {
    private String name = "idea_025880";
 ...
 */
@Slf4j
public class Idea25880Service {
    private static final int IDEA_ID = 25880;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25880Service() {
        this(new Idea25880Config());
    }

    public Idea25880Service(Idea25880Config config) {
        this.config = config != null ? config : new Idea25880Config();
