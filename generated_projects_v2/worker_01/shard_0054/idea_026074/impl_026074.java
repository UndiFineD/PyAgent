...
@Data
public class Idea26074Config {
    private String name = "idea_026074";
 ...
 */
@Slf4j
public class Idea26074Service {
    private static final int IDEA_ID = 26074;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26074Service() {
        this(new Idea26074Config());
    }

    public Idea26074Service(Idea26074Config config) {
        this.config = config != null ? config : new Idea26074Config();
