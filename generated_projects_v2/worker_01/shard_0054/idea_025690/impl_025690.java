...
@Data
public class Idea25690Config {
    private String name = "idea_025690";
 ...
 */
@Slf4j
public class Idea25690Service {
    private static final int IDEA_ID = 25690;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25690Service() {
        this(new Idea25690Config());
    }

    public Idea25690Service(Idea25690Config config) {
        this.config = config != null ? config : new Idea25690Config();
