...
@Data
public class Idea25701Config {
    private String name = "idea_025701";
 ...
 */
@Slf4j
public class Idea25701Service {
    private static final int IDEA_ID = 25701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25701Service() {
        this(new Idea25701Config());
    }

    public Idea25701Service(Idea25701Config config) {
        this.config = config != null ? config : new Idea25701Config();
