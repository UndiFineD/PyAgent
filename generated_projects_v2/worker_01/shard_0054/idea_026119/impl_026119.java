...
@Data
public class Idea26119Config {
    private String name = "idea_026119";
 ...
 */
@Slf4j
public class Idea26119Service {
    private static final int IDEA_ID = 26119;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26119Service() {
        this(new Idea26119Config());
    }

    public Idea26119Service(Idea26119Config config) {
        this.config = config != null ? config : new Idea26119Config();
