...
@Data
public class Idea25830Config {
    private String name = "idea_025830";
 ...
 */
@Slf4j
public class Idea25830Service {
    private static final int IDEA_ID = 25830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25830Service() {
        this(new Idea25830Config());
    }

    public Idea25830Service(Idea25830Config config) {
        this.config = config != null ? config : new Idea25830Config();
