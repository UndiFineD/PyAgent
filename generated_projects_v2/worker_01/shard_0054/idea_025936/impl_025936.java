...
@Data
public class Idea25936Config {
    private String name = "idea_025936";
 ...
 */
@Slf4j
public class Idea25936Service {
    private static final int IDEA_ID = 25936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25936Service() {
        this(new Idea25936Config());
    }

    public Idea25936Service(Idea25936Config config) {
        this.config = config != null ? config : new Idea25936Config();
