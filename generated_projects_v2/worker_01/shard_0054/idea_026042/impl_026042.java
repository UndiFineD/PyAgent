...
@Data
public class Idea26042Config {
    private String name = "idea_026042";
 ...
 */
@Slf4j
public class Idea26042Service {
    private static final int IDEA_ID = 26042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26042Service() {
        this(new Idea26042Config());
    }

    public Idea26042Service(Idea26042Config config) {
        this.config = config != null ? config : new Idea26042Config();
