...
@Data
public class Idea25811Config {
    private String name = "idea_025811";
 ...
 */
@Slf4j
public class Idea25811Service {
    private static final int IDEA_ID = 25811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25811Service() {
        this(new Idea25811Config());
    }

    public Idea25811Service(Idea25811Config config) {
        this.config = config != null ? config : new Idea25811Config();
