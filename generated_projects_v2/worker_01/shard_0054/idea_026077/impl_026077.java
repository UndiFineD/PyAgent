...
@Data
public class Idea26077Config {
    private String name = "idea_026077";
 ...
 */
@Slf4j
public class Idea26077Service {
    private static final int IDEA_ID = 26077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26077Service() {
        this(new Idea26077Config());
    }

    public Idea26077Service(Idea26077Config config) {
        this.config = config != null ? config : new Idea26077Config();
