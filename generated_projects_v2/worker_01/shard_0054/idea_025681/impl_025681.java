...
@Data
public class Idea25681Config {
    private String name = "idea_025681";
 ...
 */
@Slf4j
public class Idea25681Service {
    private static final int IDEA_ID = 25681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25681Service() {
        this(new Idea25681Config());
    }

    public Idea25681Service(Idea25681Config config) {
        this.config = config != null ? config : new Idea25681Config();
