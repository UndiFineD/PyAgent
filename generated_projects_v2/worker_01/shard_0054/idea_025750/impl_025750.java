...
@Data
public class Idea25750Config {
    private String name = "idea_025750";
 ...
 */
@Slf4j
public class Idea25750Service {
    private static final int IDEA_ID = 25750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25750Service() {
        this(new Idea25750Config());
    }

    public Idea25750Service(Idea25750Config config) {
        this.config = config != null ? config : new Idea25750Config();
