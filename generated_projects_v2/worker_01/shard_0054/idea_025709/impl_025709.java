...
@Data
public class Idea25709Config {
    private String name = "idea_025709";
 ...
 */
@Slf4j
public class Idea25709Service {
    private static final int IDEA_ID = 25709;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25709Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25709Service() {
        this(new Idea25709Config());
    }

    public Idea25709Service(Idea25709Config config) {
        this.config = config != null ? config : new Idea25709Config();
