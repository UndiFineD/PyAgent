...
@Data
public class Idea25893Config {
    private String name = "idea_025893";
 ...
 */
@Slf4j
public class Idea25893Service {
    private static final int IDEA_ID = 25893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25893Service() {
        this(new Idea25893Config());
    }

    public Idea25893Service(Idea25893Config config) {
        this.config = config != null ? config : new Idea25893Config();
