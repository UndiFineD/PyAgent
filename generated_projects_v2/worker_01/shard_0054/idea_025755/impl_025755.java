...
@Data
public class Idea25755Config {
    private String name = "idea_025755";
 ...
 */
@Slf4j
public class Idea25755Service {
    private static final int IDEA_ID = 25755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25755Service() {
        this(new Idea25755Config());
    }

    public Idea25755Service(Idea25755Config config) {
        this.config = config != null ? config : new Idea25755Config();
