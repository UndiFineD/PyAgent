...
@Data
public class Idea25986Config {
    private String name = "idea_025986";
 ...
 */
@Slf4j
public class Idea25986Service {
    private static final int IDEA_ID = 25986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25986Service() {
        this(new Idea25986Config());
    }

    public Idea25986Service(Idea25986Config config) {
        this.config = config != null ? config : new Idea25986Config();
