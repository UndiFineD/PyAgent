...
@Data
public class Idea26090Config {
    private String name = "idea_026090";
 ...
 */
@Slf4j
public class Idea26090Service {
    private static final int IDEA_ID = 26090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26090Service() {
        this(new Idea26090Config());
    }

    public Idea26090Service(Idea26090Config config) {
        this.config = config != null ? config : new Idea26090Config();
