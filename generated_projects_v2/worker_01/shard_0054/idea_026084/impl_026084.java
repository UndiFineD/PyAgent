...
@Data
public class Idea26084Config {
    private String name = "idea_026084";
 ...
 */
@Slf4j
public class Idea26084Service {
    private static final int IDEA_ID = 26084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26084Service() {
        this(new Idea26084Config());
    }

    public Idea26084Service(Idea26084Config config) {
        this.config = config != null ? config : new Idea26084Config();
