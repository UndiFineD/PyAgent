...
@Data
public class Idea25756Config {
    private String name = "idea_025756";
 ...
 */
@Slf4j
public class Idea25756Service {
    private static final int IDEA_ID = 25756;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25756Service() {
        this(new Idea25756Config());
    }

    public Idea25756Service(Idea25756Config config) {
        this.config = config != null ? config : new Idea25756Config();
