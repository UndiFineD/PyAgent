...
@Data
public class Idea26099Config {
    private String name = "idea_026099";
 ...
 */
@Slf4j
public class Idea26099Service {
    private static final int IDEA_ID = 26099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26099Service() {
        this(new Idea26099Config());
    }

    public Idea26099Service(Idea26099Config config) {
        this.config = config != null ? config : new Idea26099Config();
