...
@Data
public class Idea25770Config {
    private String name = "idea_025770";
 ...
 */
@Slf4j
public class Idea25770Service {
    private static final int IDEA_ID = 25770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25770Service() {
        this(new Idea25770Config());
    }

    public Idea25770Service(Idea25770Config config) {
        this.config = config != null ? config : new Idea25770Config();
