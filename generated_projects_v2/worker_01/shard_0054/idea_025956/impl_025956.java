...
@Data
public class Idea25956Config {
    private String name = "idea_025956";
 ...
 */
@Slf4j
public class Idea25956Service {
    private static final int IDEA_ID = 25956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25956Service() {
        this(new Idea25956Config());
    }

    public Idea25956Service(Idea25956Config config) {
        this.config = config != null ? config : new Idea25956Config();
