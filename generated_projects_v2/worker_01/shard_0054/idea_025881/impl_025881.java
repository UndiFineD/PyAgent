...
@Data
public class Idea25881Config {
    private String name = "idea_025881";
 ...
 */
@Slf4j
public class Idea25881Service {
    private static final int IDEA_ID = 25881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25881Service() {
        this(new Idea25881Config());
    }

    public Idea25881Service(Idea25881Config config) {
        this.config = config != null ? config : new Idea25881Config();
