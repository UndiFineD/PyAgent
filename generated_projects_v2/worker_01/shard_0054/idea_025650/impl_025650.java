...
@Data
public class Idea25650Config {
    private String name = "idea_025650";
 ...
 */
@Slf4j
public class Idea25650Service {
    private static final int IDEA_ID = 25650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25650Service() {
        this(new Idea25650Config());
    }

    public Idea25650Service(Idea25650Config config) {
        this.config = config != null ? config : new Idea25650Config();
