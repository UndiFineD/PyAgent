...
@Data
public class Idea26004Config {
    private String name = "idea_026004";
 ...
 */
@Slf4j
public class Idea26004Service {
    private static final int IDEA_ID = 26004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26004Service() {
        this(new Idea26004Config());
    }

    public Idea26004Service(Idea26004Config config) {
        this.config = config != null ? config : new Idea26004Config();
