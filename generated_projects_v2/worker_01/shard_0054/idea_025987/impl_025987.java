...
@Data
public class Idea25987Config {
    private String name = "idea_025987";
 ...
 */
@Slf4j
public class Idea25987Service {
    private static final int IDEA_ID = 25987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25987Service() {
        this(new Idea25987Config());
    }

    public Idea25987Service(Idea25987Config config) {
        this.config = config != null ? config : new Idea25987Config();
