...
@Data
public class Idea25763Config {
    private String name = "idea_025763";
 ...
 */
@Slf4j
public class Idea25763Service {
    private static final int IDEA_ID = 25763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25763Service() {
        this(new Idea25763Config());
    }

    public Idea25763Service(Idea25763Config config) {
        this.config = config != null ? config : new Idea25763Config();
