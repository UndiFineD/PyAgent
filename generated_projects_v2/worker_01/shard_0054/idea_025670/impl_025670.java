...
@Data
public class Idea25670Config {
    private String name = "idea_025670";
 ...
 */
@Slf4j
public class Idea25670Service {
    private static final int IDEA_ID = 25670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25670Service() {
        this(new Idea25670Config());
    }

    public Idea25670Service(Idea25670Config config) {
        this.config = config != null ? config : new Idea25670Config();
