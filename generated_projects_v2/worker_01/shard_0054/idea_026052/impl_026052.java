...
@Data
public class Idea26052Config {
    private String name = "idea_026052";
 ...
 */
@Slf4j
public class Idea26052Service {
    private static final int IDEA_ID = 26052;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26052Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26052Service() {
        this(new Idea26052Config());
    }

    public Idea26052Service(Idea26052Config config) {
        this.config = config != null ? config : new Idea26052Config();
