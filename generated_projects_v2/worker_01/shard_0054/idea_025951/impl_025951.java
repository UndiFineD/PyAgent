...
@Data
public class Idea25951Config {
    private String name = "idea_025951";
 ...
 */
@Slf4j
public class Idea25951Service {
    private static final int IDEA_ID = 25951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25951Service() {
        this(new Idea25951Config());
    }

    public Idea25951Service(Idea25951Config config) {
        this.config = config != null ? config : new Idea25951Config();
