...
@Data
public class Idea25884Config {
    private String name = "idea_025884";
 ...
 */
@Slf4j
public class Idea25884Service {
    private static final int IDEA_ID = 25884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25884Service() {
        this(new Idea25884Config());
    }

    public Idea25884Service(Idea25884Config config) {
        this.config = config != null ? config : new Idea25884Config();
