...
@Data
public class Idea25961Config {
    private String name = "idea_025961";
 ...
 */
@Slf4j
public class Idea25961Service {
    private static final int IDEA_ID = 25961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25961Service() {
        this(new Idea25961Config());
    }

    public Idea25961Service(Idea25961Config config) {
        this.config = config != null ? config : new Idea25961Config();
