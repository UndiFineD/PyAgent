...
@Data
public class Idea26009Config {
    private String name = "idea_026009";
 ...
 */
@Slf4j
public class Idea26009Service {
    private static final int IDEA_ID = 26009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26009Service() {
        this(new Idea26009Config());
    }

    public Idea26009Service(Idea26009Config config) {
        this.config = config != null ? config : new Idea26009Config();
