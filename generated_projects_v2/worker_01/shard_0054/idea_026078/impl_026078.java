...
@Data
public class Idea26078Config {
    private String name = "idea_026078";
 ...
 */
@Slf4j
public class Idea26078Service {
    private static final int IDEA_ID = 26078;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26078Service() {
        this(new Idea26078Config());
    }

    public Idea26078Service(Idea26078Config config) {
        this.config = config != null ? config : new Idea26078Config();
