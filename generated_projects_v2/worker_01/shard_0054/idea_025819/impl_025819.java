...
@Data
public class Idea25819Config {
    private String name = "idea_025819";
 ...
 */
@Slf4j
public class Idea25819Service {
    private static final int IDEA_ID = 25819;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25819Service() {
        this(new Idea25819Config());
    }

    public Idea25819Service(Idea25819Config config) {
        this.config = config != null ? config : new Idea25819Config();
