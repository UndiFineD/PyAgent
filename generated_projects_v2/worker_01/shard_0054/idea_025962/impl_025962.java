...
@Data
public class Idea25962Config {
    private String name = "idea_025962";
 ...
 */
@Slf4j
public class Idea25962Service {
    private static final int IDEA_ID = 25962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25962Service() {
        this(new Idea25962Config());
    }

    public Idea25962Service(Idea25962Config config) {
        this.config = config != null ? config : new Idea25962Config();
