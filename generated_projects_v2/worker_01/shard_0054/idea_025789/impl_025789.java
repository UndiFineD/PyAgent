...
@Data
public class Idea25789Config {
    private String name = "idea_025789";
 ...
 */
@Slf4j
public class Idea25789Service {
    private static final int IDEA_ID = 25789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25789Service() {
        this(new Idea25789Config());
    }

    public Idea25789Service(Idea25789Config config) {
        this.config = config != null ? config : new Idea25789Config();
