...
@Data
public class Idea26020Config {
    private String name = "idea_026020";
 ...
 */
@Slf4j
public class Idea26020Service {
    private static final int IDEA_ID = 26020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26020Service() {
        this(new Idea26020Config());
    }

    public Idea26020Service(Idea26020Config config) {
        this.config = config != null ? config : new Idea26020Config();
