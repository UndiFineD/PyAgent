...
@Data
public class Idea25866Config {
    private String name = "idea_025866";
 ...
 */
@Slf4j
public class Idea25866Service {
    private static final int IDEA_ID = 25866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25866Service() {
        this(new Idea25866Config());
    }

    public Idea25866Service(Idea25866Config config) {
        this.config = config != null ? config : new Idea25866Config();
