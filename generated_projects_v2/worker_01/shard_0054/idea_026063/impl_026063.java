...
@Data
public class Idea26063Config {
    private String name = "idea_026063";
 ...
 */
@Slf4j
public class Idea26063Service {
    private static final int IDEA_ID = 26063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26063Service() {
        this(new Idea26063Config());
    }

    public Idea26063Service(Idea26063Config config) {
        this.config = config != null ? config : new Idea26063Config();
