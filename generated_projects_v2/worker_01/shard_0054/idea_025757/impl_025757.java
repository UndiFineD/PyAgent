...
@Data
public class Idea25757Config {
    private String name = "idea_025757";
 ...
 */
@Slf4j
public class Idea25757Service {
    private static final int IDEA_ID = 25757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25757Service() {
        this(new Idea25757Config());
    }

    public Idea25757Service(Idea25757Config config) {
        this.config = config != null ? config : new Idea25757Config();
