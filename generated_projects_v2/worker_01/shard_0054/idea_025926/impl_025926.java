...
@Data
public class Idea25926Config {
    private String name = "idea_025926";
 ...
 */
@Slf4j
public class Idea25926Service {
    private static final int IDEA_ID = 25926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25926Service() {
        this(new Idea25926Config());
    }

    public Idea25926Service(Idea25926Config config) {
        this.config = config != null ? config : new Idea25926Config();
