...
@Data
public class Idea26059Config {
    private String name = "idea_026059";
 ...
 */
@Slf4j
public class Idea26059Service {
    private static final int IDEA_ID = 26059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26059Service() {
        this(new Idea26059Config());
    }

    public Idea26059Service(Idea26059Config config) {
        this.config = config != null ? config : new Idea26059Config();
