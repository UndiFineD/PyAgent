...
@Data
public class Idea25865Config {
    private String name = "idea_025865";
 ...
 */
@Slf4j
public class Idea25865Service {
    private static final int IDEA_ID = 25865;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25865Service() {
        this(new Idea25865Config());
    }

    public Idea25865Service(Idea25865Config config) {
        this.config = config != null ? config : new Idea25865Config();
