...
@Data
public class Idea25844Config {
    private String name = "idea_025844";
 ...
 */
@Slf4j
public class Idea25844Service {
    private static final int IDEA_ID = 25844;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25844Service() {
        this(new Idea25844Config());
    }

    public Idea25844Service(Idea25844Config config) {
        this.config = config != null ? config : new Idea25844Config();
