...
@Data
public class Idea25724Config {
    private String name = "idea_025724";
 ...
 */
@Slf4j
public class Idea25724Service {
    private static final int IDEA_ID = 25724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25724Service() {
        this(new Idea25724Config());
    }

    public Idea25724Service(Idea25724Config config) {
        this.config = config != null ? config : new Idea25724Config();
