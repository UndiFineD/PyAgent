...
@Data
public class Idea25693Config {
    private String name = "idea_025693";
 ...
 */
@Slf4j
public class Idea25693Service {
    private static final int IDEA_ID = 25693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25693Service() {
        this(new Idea25693Config());
    }

    public Idea25693Service(Idea25693Config config) {
        this.config = config != null ? config : new Idea25693Config();
