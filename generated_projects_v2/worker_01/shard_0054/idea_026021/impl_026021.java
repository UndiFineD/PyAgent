...
@Data
public class Idea26021Config {
    private String name = "idea_026021";
 ...
 */
@Slf4j
public class Idea26021Service {
    private static final int IDEA_ID = 26021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26021Service() {
        this(new Idea26021Config());
    }

    public Idea26021Service(Idea26021Config config) {
        this.config = config != null ? config : new Idea26021Config();
