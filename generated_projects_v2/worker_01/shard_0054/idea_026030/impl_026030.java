...
@Data
public class Idea26030Config {
    private String name = "idea_026030";
 ...
 */
@Slf4j
public class Idea26030Service {
    private static final int IDEA_ID = 26030;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26030Service() {
        this(new Idea26030Config());
    }

    public Idea26030Service(Idea26030Config config) {
        this.config = config != null ? config : new Idea26030Config();
