...
@Data
public class Idea25904Config {
    private String name = "idea_025904";
 ...
 */
@Slf4j
public class Idea25904Service {
    private static final int IDEA_ID = 25904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25904Service() {
        this(new Idea25904Config());
    }

    public Idea25904Service(Idea25904Config config) {
        this.config = config != null ? config : new Idea25904Config();
