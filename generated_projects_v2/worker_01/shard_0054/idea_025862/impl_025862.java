...
@Data
public class Idea25862Config {
    private String name = "idea_025862";
 ...
 */
@Slf4j
public class Idea25862Service {
    private static final int IDEA_ID = 25862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25862Service() {
        this(new Idea25862Config());
    }

    public Idea25862Service(Idea25862Config config) {
        this.config = config != null ? config : new Idea25862Config();
