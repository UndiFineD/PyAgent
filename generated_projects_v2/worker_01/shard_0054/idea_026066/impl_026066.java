...
@Data
public class Idea26066Config {
    private String name = "idea_026066";
 ...
 */
@Slf4j
public class Idea26066Service {
    private static final int IDEA_ID = 26066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26066Service() {
        this(new Idea26066Config());
    }

    public Idea26066Service(Idea26066Config config) {
        this.config = config != null ? config : new Idea26066Config();
