...
@Data
public class Idea25868Config {
    private String name = "idea_025868";
 ...
 */
@Slf4j
public class Idea25868Service {
    private static final int IDEA_ID = 25868;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25868Service() {
        this(new Idea25868Config());
    }

    public Idea25868Service(Idea25868Config config) {
        this.config = config != null ? config : new Idea25868Config();
