...
@Data
public class Idea25752Config {
    private String name = "idea_025752";
 ...
 */
@Slf4j
public class Idea25752Service {
    private static final int IDEA_ID = 25752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25752Service() {
        this(new Idea25752Config());
    }

    public Idea25752Service(Idea25752Config config) {
        this.config = config != null ? config : new Idea25752Config();
