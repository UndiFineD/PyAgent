...
@Data
public class Idea26103Config {
    private String name = "idea_026103";
 ...
 */
@Slf4j
public class Idea26103Service {
    private static final int IDEA_ID = 26103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26103Service() {
        this(new Idea26103Config());
    }

    public Idea26103Service(Idea26103Config config) {
        this.config = config != null ? config : new Idea26103Config();
