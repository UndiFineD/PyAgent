...
@Data
public class Idea25807Config {
    private String name = "idea_025807";
 ...
 */
@Slf4j
public class Idea25807Service {
    private static final int IDEA_ID = 25807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25807Service() {
        this(new Idea25807Config());
    }

    public Idea25807Service(Idea25807Config config) {
        this.config = config != null ? config : new Idea25807Config();
