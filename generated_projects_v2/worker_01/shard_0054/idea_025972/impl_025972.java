...
@Data
public class Idea25972Config {
    private String name = "idea_025972";
 ...
 */
@Slf4j
public class Idea25972Service {
    private static final int IDEA_ID = 25972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25972Service() {
        this(new Idea25972Config());
    }

    public Idea25972Service(Idea25972Config config) {
        this.config = config != null ? config : new Idea25972Config();
