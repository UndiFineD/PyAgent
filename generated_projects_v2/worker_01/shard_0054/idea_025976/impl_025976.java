...
@Data
public class Idea25976Config {
    private String name = "idea_025976";
 ...
 */
@Slf4j
public class Idea25976Service {
    private static final int IDEA_ID = 25976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25976Service() {
        this(new Idea25976Config());
    }

    public Idea25976Service(Idea25976Config config) {
        this.config = config != null ? config : new Idea25976Config();
