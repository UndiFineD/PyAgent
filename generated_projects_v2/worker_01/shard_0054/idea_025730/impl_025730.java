...
@Data
public class Idea25730Config {
    private String name = "idea_025730";
 ...
 */
@Slf4j
public class Idea25730Service {
    private static final int IDEA_ID = 25730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25730Service() {
        this(new Idea25730Config());
    }

    public Idea25730Service(Idea25730Config config) {
        this.config = config != null ? config : new Idea25730Config();
