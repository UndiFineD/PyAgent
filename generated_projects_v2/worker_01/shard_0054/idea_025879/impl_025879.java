...
@Data
public class Idea25879Config {
    private String name = "idea_025879";
 ...
 */
@Slf4j
public class Idea25879Service {
    private static final int IDEA_ID = 25879;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25879Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25879Service() {
        this(new Idea25879Config());
    }

    public Idea25879Service(Idea25879Config config) {
        this.config = config != null ? config : new Idea25879Config();
