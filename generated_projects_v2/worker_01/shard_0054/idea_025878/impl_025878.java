...
@Data
public class Idea25878Config {
    private String name = "idea_025878";
 ...
 */
@Slf4j
public class Idea25878Service {
    private static final int IDEA_ID = 25878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25878Service() {
        this(new Idea25878Config());
    }

    public Idea25878Service(Idea25878Config config) {
        this.config = config != null ? config : new Idea25878Config();
