...
@Data
public class Idea25992Config {
    private String name = "idea_025992";
 ...
 */
@Slf4j
public class Idea25992Service {
    private static final int IDEA_ID = 25992;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25992Service() {
        this(new Idea25992Config());
    }

    public Idea25992Service(Idea25992Config config) {
        this.config = config != null ? config : new Idea25992Config();
