...
@Data
public class Idea25821Config {
    private String name = "idea_025821";
 ...
 */
@Slf4j
public class Idea25821Service {
    private static final int IDEA_ID = 25821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25821Service() {
        this(new Idea25821Config());
    }

    public Idea25821Service(Idea25821Config config) {
        this.config = config != null ? config : new Idea25821Config();
