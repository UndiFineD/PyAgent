...
@Data
public class Idea25955Config {
    private String name = "idea_025955";
 ...
 */
@Slf4j
public class Idea25955Service {
    private static final int IDEA_ID = 25955;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25955Service() {
        this(new Idea25955Config());
    }

    public Idea25955Service(Idea25955Config config) {
        this.config = config != null ? config : new Idea25955Config();
