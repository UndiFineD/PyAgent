...
@Data
public class Idea25851Config {
    private String name = "idea_025851";
 ...
 */
@Slf4j
public class Idea25851Service {
    private static final int IDEA_ID = 25851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25851Service() {
        this(new Idea25851Config());
    }

    public Idea25851Service(Idea25851Config config) {
        this.config = config != null ? config : new Idea25851Config();
