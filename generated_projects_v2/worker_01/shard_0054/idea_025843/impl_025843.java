...
@Data
public class Idea25843Config {
    private String name = "idea_025843";
 ...
 */
@Slf4j
public class Idea25843Service {
    private static final int IDEA_ID = 25843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25843Service() {
        this(new Idea25843Config());
    }

    public Idea25843Service(Idea25843Config config) {
        this.config = config != null ? config : new Idea25843Config();
