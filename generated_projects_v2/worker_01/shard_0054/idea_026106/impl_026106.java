...
@Data
public class Idea26106Config {
    private String name = "idea_026106";
 ...
 */
@Slf4j
public class Idea26106Service {
    private static final int IDEA_ID = 26106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26106Service() {
        this(new Idea26106Config());
    }

    public Idea26106Service(Idea26106Config config) {
        this.config = config != null ? config : new Idea26106Config();
