...
@Data
public class Idea25901Config {
    private String name = "idea_025901";
 ...
 */
@Slf4j
public class Idea25901Service {
    private static final int IDEA_ID = 25901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25901Service() {
        this(new Idea25901Config());
    }

    public Idea25901Service(Idea25901Config config) {
        this.config = config != null ? config : new Idea25901Config();
