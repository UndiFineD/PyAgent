...
@Data
public class Idea26113Config {
    private String name = "idea_026113";
 ...
 */
@Slf4j
public class Idea26113Service {
    private static final int IDEA_ID = 26113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26113Service() {
        this(new Idea26113Config());
    }

    public Idea26113Service(Idea26113Config config) {
        this.config = config != null ? config : new Idea26113Config();
