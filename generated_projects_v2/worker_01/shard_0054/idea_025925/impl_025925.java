...
@Data
public class Idea25925Config {
    private String name = "idea_025925";
 ...
 */
@Slf4j
public class Idea25925Service {
    private static final int IDEA_ID = 25925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25925Service() {
        this(new Idea25925Config());
    }

    public Idea25925Service(Idea25925Config config) {
        this.config = config != null ? config : new Idea25925Config();
