...
@Data
public class Idea26081Config {
    private String name = "idea_026081";
 ...
 */
@Slf4j
public class Idea26081Service {
    private static final int IDEA_ID = 26081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26081Service() {
        this(new Idea26081Config());
    }

    public Idea26081Service(Idea26081Config config) {
        this.config = config != null ? config : new Idea26081Config();
