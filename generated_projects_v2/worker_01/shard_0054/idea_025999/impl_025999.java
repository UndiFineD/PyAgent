...
@Data
public class Idea25999Config {
    private String name = "idea_025999";
 ...
 */
@Slf4j
public class Idea25999Service {
    private static final int IDEA_ID = 25999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25999Service() {
        this(new Idea25999Config());
    }

    public Idea25999Service(Idea25999Config config) {
        this.config = config != null ? config : new Idea25999Config();
