...
@Data
public class Idea25748Config {
    private String name = "idea_025748";
 ...
 */
@Slf4j
public class Idea25748Service {
    private static final int IDEA_ID = 25748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25748Service() {
        this(new Idea25748Config());
    }

    public Idea25748Service(Idea25748Config config) {
        this.config = config != null ? config : new Idea25748Config();
