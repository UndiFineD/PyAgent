...
@Data
public class Idea25916Config {
    private String name = "idea_025916";
 ...
 */
@Slf4j
public class Idea25916Service {
    private static final int IDEA_ID = 25916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25916Service() {
        this(new Idea25916Config());
    }

    public Idea25916Service(Idea25916Config config) {
        this.config = config != null ? config : new Idea25916Config();
