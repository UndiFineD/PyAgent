...
@Data
public class Idea25895Config {
    private String name = "idea_025895";
 ...
 */
@Slf4j
public class Idea25895Service {
    private static final int IDEA_ID = 25895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25895Service() {
        this(new Idea25895Config());
    }

    public Idea25895Service(Idea25895Config config) {
        this.config = config != null ? config : new Idea25895Config();
