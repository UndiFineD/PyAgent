...
@Data
public class Idea25671Config {
    private String name = "idea_025671";
 ...
 */
@Slf4j
public class Idea25671Service {
    private static final int IDEA_ID = 25671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25671Service() {
        this(new Idea25671Config());
    }

    public Idea25671Service(Idea25671Config config) {
        this.config = config != null ? config : new Idea25671Config();
