...
@Data
public class Idea25716Config {
    private String name = "idea_025716";
 ...
 */
@Slf4j
public class Idea25716Service {
    private static final int IDEA_ID = 25716;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25716Service() {
        this(new Idea25716Config());
    }

    public Idea25716Service(Idea25716Config config) {
        this.config = config != null ? config : new Idea25716Config();
