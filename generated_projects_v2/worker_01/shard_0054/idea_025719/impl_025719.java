...
@Data
public class Idea25719Config {
    private String name = "idea_025719";
 ...
 */
@Slf4j
public class Idea25719Service {
    private static final int IDEA_ID = 25719;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25719Service() {
        this(new Idea25719Config());
    }

    public Idea25719Service(Idea25719Config config) {
        this.config = config != null ? config : new Idea25719Config();
