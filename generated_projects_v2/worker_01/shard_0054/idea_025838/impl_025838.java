...
@Data
public class Idea25838Config {
    private String name = "idea_025838";
 ...
 */
@Slf4j
public class Idea25838Service {
    private static final int IDEA_ID = 25838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25838Service() {
        this(new Idea25838Config());
    }

    public Idea25838Service(Idea25838Config config) {
        this.config = config != null ? config : new Idea25838Config();
