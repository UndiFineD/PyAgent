...
@Data
public class Idea25998Config {
    private String name = "idea_025998";
 ...
 */
@Slf4j
public class Idea25998Service {
    private static final int IDEA_ID = 25998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25998Service() {
        this(new Idea25998Config());
    }

    public Idea25998Service(Idea25998Config config) {
        this.config = config != null ? config : new Idea25998Config();
