...
@Data
public class Idea25889Config {
    private String name = "idea_025889";
 ...
 */
@Slf4j
public class Idea25889Service {
    private static final int IDEA_ID = 25889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25889Service() {
        this(new Idea25889Config());
    }

    public Idea25889Service(Idea25889Config config) {
        this.config = config != null ? config : new Idea25889Config();
