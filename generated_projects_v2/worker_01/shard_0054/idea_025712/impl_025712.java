...
@Data
public class Idea25712Config {
    private String name = "idea_025712";
 ...
 */
@Slf4j
public class Idea25712Service {
    private static final int IDEA_ID = 25712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25712Service() {
        this(new Idea25712Config());
    }

    public Idea25712Service(Idea25712Config config) {
        this.config = config != null ? config : new Idea25712Config();
