...
@Data
public class Idea26079Config {
    private String name = "idea_026079";
 ...
 */
@Slf4j
public class Idea26079Service {
    private static final int IDEA_ID = 26079;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26079Service() {
        this(new Idea26079Config());
    }

    public Idea26079Service(Idea26079Config config) {
        this.config = config != null ? config : new Idea26079Config();
