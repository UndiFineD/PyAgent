...
@Data
public class Idea25695Config {
    private String name = "idea_025695";
 ...
 */
@Slf4j
public class Idea25695Service {
    private static final int IDEA_ID = 25695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25695Service() {
        this(new Idea25695Config());
    }

    public Idea25695Service(Idea25695Config config) {
        this.config = config != null ? config : new Idea25695Config();
