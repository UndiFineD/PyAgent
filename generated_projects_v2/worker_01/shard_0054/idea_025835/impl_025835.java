...
@Data
public class Idea25835Config {
    private String name = "idea_025835";
 ...
 */
@Slf4j
public class Idea25835Service {
    private static final int IDEA_ID = 25835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25835Service() {
        this(new Idea25835Config());
    }

    public Idea25835Service(Idea25835Config config) {
        this.config = config != null ? config : new Idea25835Config();
