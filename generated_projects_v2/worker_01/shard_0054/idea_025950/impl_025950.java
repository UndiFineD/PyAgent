...
@Data
public class Idea25950Config {
    private String name = "idea_025950";
 ...
 */
@Slf4j
public class Idea25950Service {
    private static final int IDEA_ID = 25950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25950Service() {
        this(new Idea25950Config());
    }

    public Idea25950Service(Idea25950Config config) {
        this.config = config != null ? config : new Idea25950Config();
