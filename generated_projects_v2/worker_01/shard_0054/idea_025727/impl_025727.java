...
@Data
public class Idea25727Config {
    private String name = "idea_025727";
 ...
 */
@Slf4j
public class Idea25727Service {
    private static final int IDEA_ID = 25727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25727Service() {
        this(new Idea25727Config());
    }

    public Idea25727Service(Idea25727Config config) {
        this.config = config != null ? config : new Idea25727Config();
