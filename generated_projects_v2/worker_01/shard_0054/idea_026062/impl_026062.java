...
@Data
public class Idea26062Config {
    private String name = "idea_026062";
 ...
 */
@Slf4j
public class Idea26062Service {
    private static final int IDEA_ID = 26062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26062Service() {
        this(new Idea26062Config());
    }

    public Idea26062Service(Idea26062Config config) {
        this.config = config != null ? config : new Idea26062Config();
