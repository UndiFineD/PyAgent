...
@Data
public class Idea26108Config {
    private String name = "idea_026108";
 ...
 */
@Slf4j
public class Idea26108Service {
    private static final int IDEA_ID = 26108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26108Service() {
        this(new Idea26108Config());
    }

    public Idea26108Service(Idea26108Config config) {
        this.config = config != null ? config : new Idea26108Config();
