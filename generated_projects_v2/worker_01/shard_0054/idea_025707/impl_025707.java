...
@Data
public class Idea25707Config {
    private String name = "idea_025707";
 ...
 */
@Slf4j
public class Idea25707Service {
    private static final int IDEA_ID = 25707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25707Service() {
        this(new Idea25707Config());
    }

    public Idea25707Service(Idea25707Config config) {
        this.config = config != null ? config : new Idea25707Config();
