...
@Data
public class Idea26034Config {
    private String name = "idea_026034";
 ...
 */
@Slf4j
public class Idea26034Service {
    private static final int IDEA_ID = 26034;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26034Service() {
        this(new Idea26034Config());
    }

    public Idea26034Service(Idea26034Config config) {
        this.config = config != null ? config : new Idea26034Config();
