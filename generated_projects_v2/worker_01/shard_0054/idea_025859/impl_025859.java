...
@Data
public class Idea25859Config {
    private String name = "idea_025859";
 ...
 */
@Slf4j
public class Idea25859Service {
    private static final int IDEA_ID = 25859;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25859Service() {
        this(new Idea25859Config());
    }

    public Idea25859Service(Idea25859Config config) {
        this.config = config != null ? config : new Idea25859Config();
