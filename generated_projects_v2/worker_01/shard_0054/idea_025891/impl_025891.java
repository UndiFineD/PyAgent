...
@Data
public class Idea25891Config {
    private String name = "idea_025891";
 ...
 */
@Slf4j
public class Idea25891Service {
    private static final int IDEA_ID = 25891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25891Service() {
        this(new Idea25891Config());
    }

    public Idea25891Service(Idea25891Config config) {
        this.config = config != null ? config : new Idea25891Config();
