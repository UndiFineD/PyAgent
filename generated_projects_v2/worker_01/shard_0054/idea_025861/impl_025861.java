...
@Data
public class Idea25861Config {
    private String name = "idea_025861";
 ...
 */
@Slf4j
public class Idea25861Service {
    private static final int IDEA_ID = 25861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25861Service() {
        this(new Idea25861Config());
    }

    public Idea25861Service(Idea25861Config config) {
        this.config = config != null ? config : new Idea25861Config();
