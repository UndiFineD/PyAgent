...
@Data
public class Idea25898Config {
    private String name = "idea_025898";
 ...
 */
@Slf4j
public class Idea25898Service {
    private static final int IDEA_ID = 25898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25898Service() {
        this(new Idea25898Config());
    }

    public Idea25898Service(Idea25898Config config) {
        this.config = config != null ? config : new Idea25898Config();
