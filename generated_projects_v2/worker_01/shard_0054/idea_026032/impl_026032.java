...
@Data
public class Idea26032Config {
    private String name = "idea_026032";
 ...
 */
@Slf4j
public class Idea26032Service {
    private static final int IDEA_ID = 26032;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26032Service() {
        this(new Idea26032Config());
    }

    public Idea26032Service(Idea26032Config config) {
        this.config = config != null ? config : new Idea26032Config();
