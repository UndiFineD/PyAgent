...
@Data
public class Idea25913Config {
    private String name = "idea_025913";
 ...
 */
@Slf4j
public class Idea25913Service {
    private static final int IDEA_ID = 25913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25913Service() {
        this(new Idea25913Config());
    }

    public Idea25913Service(Idea25913Config config) {
        this.config = config != null ? config : new Idea25913Config();
