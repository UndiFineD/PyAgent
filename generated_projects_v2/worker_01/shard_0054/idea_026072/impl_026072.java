...
@Data
public class Idea26072Config {
    private String name = "idea_026072";
 ...
 */
@Slf4j
public class Idea26072Service {
    private static final int IDEA_ID = 26072;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26072Service() {
        this(new Idea26072Config());
    }

    public Idea26072Service(Idea26072Config config) {
        this.config = config != null ? config : new Idea26072Config();
