...
@Data
public class Idea26008Config {
    private String name = "idea_026008";
 ...
 */
@Slf4j
public class Idea26008Service {
    private static final int IDEA_ID = 26008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26008Service() {
        this(new Idea26008Config());
    }

    public Idea26008Service(Idea26008Config config) {
        this.config = config != null ? config : new Idea26008Config();
