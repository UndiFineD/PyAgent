...
@Data
public class Idea25679Config {
    private String name = "idea_025679";
 ...
 */
@Slf4j
public class Idea25679Service {
    private static final int IDEA_ID = 25679;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25679Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25679Service() {
        this(new Idea25679Config());
    }

    public Idea25679Service(Idea25679Config config) {
        this.config = config != null ? config : new Idea25679Config();
