...
@Data
public class Idea25920Config {
    private String name = "idea_025920";
 ...
 */
@Slf4j
public class Idea25920Service {
    private static final int IDEA_ID = 25920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25920Service() {
        this(new Idea25920Config());
    }

    public Idea25920Service(Idea25920Config config) {
        this.config = config != null ? config : new Idea25920Config();
