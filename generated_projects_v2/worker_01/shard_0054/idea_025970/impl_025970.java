...
@Data
public class Idea25970Config {
    private String name = "idea_025970";
 ...
 */
@Slf4j
public class Idea25970Service {
    private static final int IDEA_ID = 25970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25970Service() {
        this(new Idea25970Config());
    }

    public Idea25970Service(Idea25970Config config) {
        this.config = config != null ? config : new Idea25970Config();
