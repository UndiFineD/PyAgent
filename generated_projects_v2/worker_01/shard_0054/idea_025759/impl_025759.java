...
@Data
public class Idea25759Config {
    private String name = "idea_025759";
 ...
 */
@Slf4j
public class Idea25759Service {
    private static final int IDEA_ID = 25759;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25759Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25759Service() {
        this(new Idea25759Config());
    }

    public Idea25759Service(Idea25759Config config) {
        this.config = config != null ? config : new Idea25759Config();
