...
@Data
public class Idea26110Config {
    private String name = "idea_026110";
 ...
 */
@Slf4j
public class Idea26110Service {
    private static final int IDEA_ID = 26110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26110Service() {
        this(new Idea26110Config());
    }

    public Idea26110Service(Idea26110Config config) {
        this.config = config != null ? config : new Idea26110Config();
