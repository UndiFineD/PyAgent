...
@Data
public class Idea25981Config {
    private String name = "idea_025981";
 ...
 */
@Slf4j
public class Idea25981Service {
    private static final int IDEA_ID = 25981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25981Service() {
        this(new Idea25981Config());
    }

    public Idea25981Service(Idea25981Config config) {
        this.config = config != null ? config : new Idea25981Config();
