...
@Data
public class Idea26054Config {
    private String name = "idea_026054";
 ...
 */
@Slf4j
public class Idea26054Service {
    private static final int IDEA_ID = 26054;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26054Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26054Service() {
        this(new Idea26054Config());
    }

    public Idea26054Service(Idea26054Config config) {
        this.config = config != null ? config : new Idea26054Config();
