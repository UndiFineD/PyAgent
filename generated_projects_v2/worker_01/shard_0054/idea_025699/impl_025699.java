...
@Data
public class Idea25699Config {
    private String name = "idea_025699";
 ...
 */
@Slf4j
public class Idea25699Service {
    private static final int IDEA_ID = 25699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25699Service() {
        this(new Idea25699Config());
    }

    public Idea25699Service(Idea25699Config config) {
        this.config = config != null ? config : new Idea25699Config();
