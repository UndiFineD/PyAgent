...
@Data
public class Idea25792Config {
    private String name = "idea_025792";
 ...
 */
@Slf4j
public class Idea25792Service {
    private static final int IDEA_ID = 25792;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25792Service() {
        this(new Idea25792Config());
    }

    public Idea25792Service(Idea25792Config config) {
        this.config = config != null ? config : new Idea25792Config();
