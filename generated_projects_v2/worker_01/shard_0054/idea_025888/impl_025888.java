...
@Data
public class Idea25888Config {
    private String name = "idea_025888";
 ...
 */
@Slf4j
public class Idea25888Service {
    private static final int IDEA_ID = 25888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25888Service() {
        this(new Idea25888Config());
    }

    public Idea25888Service(Idea25888Config config) {
        this.config = config != null ? config : new Idea25888Config();
