...
@Data
public class Idea25760Config {
    private String name = "idea_025760";
 ...
 */
@Slf4j
public class Idea25760Service {
    private static final int IDEA_ID = 25760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25760Service() {
        this(new Idea25760Config());
    }

    public Idea25760Service(Idea25760Config config) {
        this.config = config != null ? config : new Idea25760Config();
