...
@Data
public class Idea25874Config {
    private String name = "idea_025874";
 ...
 */
@Slf4j
public class Idea25874Service {
    private static final int IDEA_ID = 25874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25874Service() {
        this(new Idea25874Config());
    }

    public Idea25874Service(Idea25874Config config) {
        this.config = config != null ? config : new Idea25874Config();
