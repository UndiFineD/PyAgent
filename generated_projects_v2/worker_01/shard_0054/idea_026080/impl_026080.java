...
@Data
public class Idea26080Config {
    private String name = "idea_026080";
 ...
 */
@Slf4j
public class Idea26080Service {
    private static final int IDEA_ID = 26080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26080Service() {
        this(new Idea26080Config());
    }

    public Idea26080Service(Idea26080Config config) {
        this.config = config != null ? config : new Idea26080Config();
