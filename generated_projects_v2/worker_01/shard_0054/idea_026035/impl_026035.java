...
@Data
public class Idea26035Config {
    private String name = "idea_026035";
 ...
 */
@Slf4j
public class Idea26035Service {
    private static final int IDEA_ID = 26035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26035Service() {
        this(new Idea26035Config());
    }

    public Idea26035Service(Idea26035Config config) {
        this.config = config != null ? config : new Idea26035Config();
