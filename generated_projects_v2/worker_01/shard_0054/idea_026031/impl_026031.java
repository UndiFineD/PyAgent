...
@Data
public class Idea26031Config {
    private String name = "idea_026031";
 ...
 */
@Slf4j
public class Idea26031Service {
    private static final int IDEA_ID = 26031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26031Service() {
        this(new Idea26031Config());
    }

    public Idea26031Service(Idea26031Config config) {
        this.config = config != null ? config : new Idea26031Config();
