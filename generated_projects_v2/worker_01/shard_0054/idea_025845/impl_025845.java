...
@Data
public class Idea25845Config {
    private String name = "idea_025845";
 ...
 */
@Slf4j
public class Idea25845Service {
    private static final int IDEA_ID = 25845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25845Service() {
        this(new Idea25845Config());
    }

    public Idea25845Service(Idea25845Config config) {
        this.config = config != null ? config : new Idea25845Config();
