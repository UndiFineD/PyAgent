...
@Data
public class Idea25710Config {
    private String name = "idea_025710";
 ...
 */
@Slf4j
public class Idea25710Service {
    private static final int IDEA_ID = 25710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25710Service() {
        this(new Idea25710Config());
    }

    public Idea25710Service(Idea25710Config config) {
        this.config = config != null ? config : new Idea25710Config();
