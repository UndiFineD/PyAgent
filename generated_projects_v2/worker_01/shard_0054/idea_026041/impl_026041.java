...
@Data
public class Idea26041Config {
    private String name = "idea_026041";
 ...
 */
@Slf4j
public class Idea26041Service {
    private static final int IDEA_ID = 26041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26041Service() {
        this(new Idea26041Config());
    }

    public Idea26041Service(Idea26041Config config) {
        this.config = config != null ? config : new Idea26041Config();
