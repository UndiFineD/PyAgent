...
@Data
public class Idea25965Config {
    private String name = "idea_025965";
 ...
 */
@Slf4j
public class Idea25965Service {
    private static final int IDEA_ID = 25965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25965Service() {
        this(new Idea25965Config());
    }

    public Idea25965Service(Idea25965Config config) {
        this.config = config != null ? config : new Idea25965Config();
