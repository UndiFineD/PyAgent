...
@Data
public class Idea25714Config {
    private String name = "idea_025714";
 ...
 */
@Slf4j
public class Idea25714Service {
    private static final int IDEA_ID = 25714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25714Service() {
        this(new Idea25714Config());
    }

    public Idea25714Service(Idea25714Config config) {
        this.config = config != null ? config : new Idea25714Config();
