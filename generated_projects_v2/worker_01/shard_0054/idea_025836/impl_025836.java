...
@Data
public class Idea25836Config {
    private String name = "idea_025836";
 ...
 */
@Slf4j
public class Idea25836Service {
    private static final int IDEA_ID = 25836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25836Service() {
        this(new Idea25836Config());
    }

    public Idea25836Service(Idea25836Config config) {
        this.config = config != null ? config : new Idea25836Config();
