...
@Data
public class Idea25837Config {
    private String name = "idea_025837";
 ...
 */
@Slf4j
public class Idea25837Service {
    private static final int IDEA_ID = 25837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25837Service() {
        this(new Idea25837Config());
    }

    public Idea25837Service(Idea25837Config config) {
        this.config = config != null ? config : new Idea25837Config();
