...
@Data
public class Idea25949Config {
    private String name = "idea_025949";
 ...
 */
@Slf4j
public class Idea25949Service {
    private static final int IDEA_ID = 25949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25949Service() {
        this(new Idea25949Config());
    }

    public Idea25949Service(Idea25949Config config) {
        this.config = config != null ? config : new Idea25949Config();
