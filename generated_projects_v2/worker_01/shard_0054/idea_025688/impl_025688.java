...
@Data
public class Idea25688Config {
    private String name = "idea_025688";
 ...
 */
@Slf4j
public class Idea25688Service {
    private static final int IDEA_ID = 25688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25688Service() {
        this(new Idea25688Config());
    }

    public Idea25688Service(Idea25688Config config) {
        this.config = config != null ? config : new Idea25688Config();
