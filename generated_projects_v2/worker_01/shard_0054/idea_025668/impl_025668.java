...
@Data
public class Idea25668Config {
    private String name = "idea_025668";
 ...
 */
@Slf4j
public class Idea25668Service {
    private static final int IDEA_ID = 25668;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25668Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25668Service() {
        this(new Idea25668Config());
    }

    public Idea25668Service(Idea25668Config config) {
        this.config = config != null ? config : new Idea25668Config();
