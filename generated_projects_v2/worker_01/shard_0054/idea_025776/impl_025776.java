...
@Data
public class Idea25776Config {
    private String name = "idea_025776";
 ...
 */
@Slf4j
public class Idea25776Service {
    private static final int IDEA_ID = 25776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25776Service() {
        this(new Idea25776Config());
    }

    public Idea25776Service(Idea25776Config config) {
        this.config = config != null ? config : new Idea25776Config();
