...
@Data
public class Idea25968Config {
    private String name = "idea_025968";
 ...
 */
@Slf4j
public class Idea25968Service {
    private static final int IDEA_ID = 25968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25968Service() {
        this(new Idea25968Config());
    }

    public Idea25968Service(Idea25968Config config) {
        this.config = config != null ? config : new Idea25968Config();
