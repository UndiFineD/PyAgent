...
@Data
public class Idea25702Config {
    private String name = "idea_025702";
 ...
 */
@Slf4j
public class Idea25702Service {
    private static final int IDEA_ID = 25702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25702Service() {
        this(new Idea25702Config());
    }

    public Idea25702Service(Idea25702Config config) {
        this.config = config != null ? config : new Idea25702Config();
