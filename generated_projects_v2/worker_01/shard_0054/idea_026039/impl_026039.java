...
@Data
public class Idea26039Config {
    private String name = "idea_026039";
 ...
 */
@Slf4j
public class Idea26039Service {
    private static final int IDEA_ID = 26039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26039Service() {
        this(new Idea26039Config());
    }

    public Idea26039Service(Idea26039Config config) {
        this.config = config != null ? config : new Idea26039Config();
