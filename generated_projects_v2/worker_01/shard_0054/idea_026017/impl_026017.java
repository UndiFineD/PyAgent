...
@Data
public class Idea26017Config {
    private String name = "idea_026017";
 ...
 */
@Slf4j
public class Idea26017Service {
    private static final int IDEA_ID = 26017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26017Service() {
        this(new Idea26017Config());
    }

    public Idea26017Service(Idea26017Config config) {
        this.config = config != null ? config : new Idea26017Config();
