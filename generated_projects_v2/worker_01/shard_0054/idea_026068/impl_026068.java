...
@Data
public class Idea26068Config {
    private String name = "idea_026068";
 ...
 */
@Slf4j
public class Idea26068Service {
    private static final int IDEA_ID = 26068;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26068Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26068Service() {
        this(new Idea26068Config());
    }

    public Idea26068Service(Idea26068Config config) {
        this.config = config != null ? config : new Idea26068Config();
