...
@Data
public class Idea25905Config {
    private String name = "idea_025905";
 ...
 */
@Slf4j
public class Idea25905Service {
    private static final int IDEA_ID = 25905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25905Service() {
        this(new Idea25905Config());
    }

    public Idea25905Service(Idea25905Config config) {
        this.config = config != null ? config : new Idea25905Config();
