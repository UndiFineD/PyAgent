...
@Data
public class Idea26024Config {
    private String name = "idea_026024";
 ...
 */
@Slf4j
public class Idea26024Service {
    private static final int IDEA_ID = 26024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26024Service() {
        this(new Idea26024Config());
    }

    public Idea26024Service(Idea26024Config config) {
        this.config = config != null ? config : new Idea26024Config();
