...
@Data
public class Idea25813Config {
    private String name = "idea_025813";
 ...
 */
@Slf4j
public class Idea25813Service {
    private static final int IDEA_ID = 25813;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25813Service() {
        this(new Idea25813Config());
    }

    public Idea25813Service(Idea25813Config config) {
        this.config = config != null ? config : new Idea25813Config();
