...
@Data
public class Idea25696Config {
    private String name = "idea_025696";
 ...
 */
@Slf4j
public class Idea25696Service {
    private static final int IDEA_ID = 25696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25696Service() {
        this(new Idea25696Config());
    }

    public Idea25696Service(Idea25696Config config) {
        this.config = config != null ? config : new Idea25696Config();
