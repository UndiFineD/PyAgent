...
@Data
public class Idea26076Config {
    private String name = "idea_026076";
 ...
 */
@Slf4j
public class Idea26076Service {
    private static final int IDEA_ID = 26076;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26076Service() {
        this(new Idea26076Config());
    }

    public Idea26076Service(Idea26076Config config) {
        this.config = config != null ? config : new Idea26076Config();
