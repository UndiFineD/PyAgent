...
@Data
public class Idea25853Config {
    private String name = "idea_025853";
 ...
 */
@Slf4j
public class Idea25853Service {
    private static final int IDEA_ID = 25853;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25853Service() {
        this(new Idea25853Config());
    }

    public Idea25853Service(Idea25853Config config) {
        this.config = config != null ? config : new Idea25853Config();
