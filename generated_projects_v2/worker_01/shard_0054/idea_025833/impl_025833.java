...
@Data
public class Idea25833Config {
    private String name = "idea_025833";
 ...
 */
@Slf4j
public class Idea25833Service {
    private static final int IDEA_ID = 25833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25833Service() {
        this(new Idea25833Config());
    }

    public Idea25833Service(Idea25833Config config) {
        this.config = config != null ? config : new Idea25833Config();
