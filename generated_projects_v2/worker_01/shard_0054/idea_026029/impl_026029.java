...
@Data
public class Idea26029Config {
    private String name = "idea_026029";
 ...
 */
@Slf4j
public class Idea26029Service {
    private static final int IDEA_ID = 26029;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26029Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26029Service() {
        this(new Idea26029Config());
    }

    public Idea26029Service(Idea26029Config config) {
        this.config = config != null ? config : new Idea26029Config();
