...
@Data
public class Idea25737Config {
    private String name = "idea_025737";
 ...
 */
@Slf4j
public class Idea25737Service {
    private static final int IDEA_ID = 25737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25737Service() {
        this(new Idea25737Config());
    }

    public Idea25737Service(Idea25737Config config) {
        this.config = config != null ? config : new Idea25737Config();
