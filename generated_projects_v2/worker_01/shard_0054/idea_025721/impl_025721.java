...
@Data
public class Idea25721Config {
    private String name = "idea_025721";
 ...
 */
@Slf4j
public class Idea25721Service {
    private static final int IDEA_ID = 25721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25721Service() {
        this(new Idea25721Config());
    }

    public Idea25721Service(Idea25721Config config) {
        this.config = config != null ? config : new Idea25721Config();
