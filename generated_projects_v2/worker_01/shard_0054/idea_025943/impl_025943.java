...
@Data
public class Idea25943Config {
    private String name = "idea_025943";
 ...
 */
@Slf4j
public class Idea25943Service {
    private static final int IDEA_ID = 25943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25943Service() {
        this(new Idea25943Config());
    }

    public Idea25943Service(Idea25943Config config) {
        this.config = config != null ? config : new Idea25943Config();
