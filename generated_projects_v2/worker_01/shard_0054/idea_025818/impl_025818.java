...
@Data
public class Idea25818Config {
    private String name = "idea_025818";
 ...
 */
@Slf4j
public class Idea25818Service {
    private static final int IDEA_ID = 25818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25818Service() {
        this(new Idea25818Config());
    }

    public Idea25818Service(Idea25818Config config) {
        this.config = config != null ? config : new Idea25818Config();
