...
@Data
public class Idea25993Config {
    private String name = "idea_025993";
 ...
 */
@Slf4j
public class Idea25993Service {
    private static final int IDEA_ID = 25993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25993Service() {
        this(new Idea25993Config());
    }

    public Idea25993Service(Idea25993Config config) {
        this.config = config != null ? config : new Idea25993Config();
