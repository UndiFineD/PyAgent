...
@Data
public class Idea25777Config {
    private String name = "idea_025777";
 ...
 */
@Slf4j
public class Idea25777Service {
    private static final int IDEA_ID = 25777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25777Service() {
        this(new Idea25777Config());
    }

    public Idea25777Service(Idea25777Config config) {
        this.config = config != null ? config : new Idea25777Config();
