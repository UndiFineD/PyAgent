...
@Data
public class Idea26046Config {
    private String name = "idea_026046";
 ...
 */
@Slf4j
public class Idea26046Service {
    private static final int IDEA_ID = 26046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26046Service() {
        this(new Idea26046Config());
    }

    public Idea26046Service(Idea26046Config config) {
        this.config = config != null ? config : new Idea26046Config();
