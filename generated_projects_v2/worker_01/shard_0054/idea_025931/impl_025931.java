...
@Data
public class Idea25931Config {
    private String name = "idea_025931";
 ...
 */
@Slf4j
public class Idea25931Service {
    private static final int IDEA_ID = 25931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25931Service() {
        this(new Idea25931Config());
    }

    public Idea25931Service(Idea25931Config config) {
        this.config = config != null ? config : new Idea25931Config();
