...
@Data
public class Idea25915Config {
    private String name = "idea_025915";
 ...
 */
@Slf4j
public class Idea25915Service {
    private static final int IDEA_ID = 25915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25915Service() {
        this(new Idea25915Config());
    }

    public Idea25915Service(Idea25915Config config) {
        this.config = config != null ? config : new Idea25915Config();
