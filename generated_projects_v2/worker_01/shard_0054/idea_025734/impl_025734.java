...
@Data
public class Idea25734Config {
    private String name = "idea_025734";
 ...
 */
@Slf4j
public class Idea25734Service {
    private static final int IDEA_ID = 25734;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25734Service() {
        this(new Idea25734Config());
    }

    public Idea25734Service(Idea25734Config config) {
        this.config = config != null ? config : new Idea25734Config();
