...
@Data
public class Idea26028Config {
    private String name = "idea_026028";
 ...
 */
@Slf4j
public class Idea26028Service {
    private static final int IDEA_ID = 26028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26028Service() {
        this(new Idea26028Config());
    }

    public Idea26028Service(Idea26028Config config) {
        this.config = config != null ? config : new Idea26028Config();
