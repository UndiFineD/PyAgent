...
@Data
public class Idea26043Config {
    private String name = "idea_026043";
 ...
 */
@Slf4j
public class Idea26043Service {
    private static final int IDEA_ID = 26043;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26043Service() {
        this(new Idea26043Config());
    }

    public Idea26043Service(Idea26043Config config) {
        this.config = config != null ? config : new Idea26043Config();
