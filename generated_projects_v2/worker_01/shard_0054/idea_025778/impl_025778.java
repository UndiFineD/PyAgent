...
@Data
public class Idea25778Config {
    private String name = "idea_025778";
 ...
 */
@Slf4j
public class Idea25778Service {
    private static final int IDEA_ID = 25778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25778Service() {
        this(new Idea25778Config());
    }

    public Idea25778Service(Idea25778Config config) {
        this.config = config != null ? config : new Idea25778Config();
