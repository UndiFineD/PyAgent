...
@Data
public class Idea25911Config {
    private String name = "idea_025911";
 ...
 */
@Slf4j
public class Idea25911Service {
    private static final int IDEA_ID = 25911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25911Service() {
        this(new Idea25911Config());
    }

    public Idea25911Service(Idea25911Config config) {
        this.config = config != null ? config : new Idea25911Config();
