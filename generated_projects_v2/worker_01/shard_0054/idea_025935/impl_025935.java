...
@Data
public class Idea25935Config {
    private String name = "idea_025935";
 ...
 */
@Slf4j
public class Idea25935Service {
    private static final int IDEA_ID = 25935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25935Service() {
        this(new Idea25935Config());
    }

    public Idea25935Service(Idea25935Config config) {
        this.config = config != null ? config : new Idea25935Config();
