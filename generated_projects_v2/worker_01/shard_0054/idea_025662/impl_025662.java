...
@Data
public class Idea25662Config {
    private String name = "idea_025662";
 ...
 */
@Slf4j
public class Idea25662Service {
    private static final int IDEA_ID = 25662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25662Service() {
        this(new Idea25662Config());
    }

    public Idea25662Service(Idea25662Config config) {
        this.config = config != null ? config : new Idea25662Config();
