...
@Data
public class Idea25840Config {
    private String name = "idea_025840";
 ...
 */
@Slf4j
public class Idea25840Service {
    private static final int IDEA_ID = 25840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25840Service() {
        this(new Idea25840Config());
    }

    public Idea25840Service(Idea25840Config config) {
        this.config = config != null ? config : new Idea25840Config();
