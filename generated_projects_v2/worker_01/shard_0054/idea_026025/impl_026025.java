...
@Data
public class Idea26025Config {
    private String name = "idea_026025";
 ...
 */
@Slf4j
public class Idea26025Service {
    private static final int IDEA_ID = 26025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26025Service() {
        this(new Idea26025Config());
    }

    public Idea26025Service(Idea26025Config config) {
        this.config = config != null ? config : new Idea26025Config();
