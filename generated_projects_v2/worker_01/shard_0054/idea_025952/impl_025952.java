...
@Data
public class Idea25952Config {
    private String name = "idea_025952";
 ...
 */
@Slf4j
public class Idea25952Service {
    private static final int IDEA_ID = 25952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25952Service() {
        this(new Idea25952Config());
    }

    public Idea25952Service(Idea25952Config config) {
        this.config = config != null ? config : new Idea25952Config();
