...
@Data
public class Idea25500Config {
    private String name = "idea_025500";
 ...
 */
@Slf4j
public class Idea25500Service {
    private static final int IDEA_ID = 25500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25500Service() {
        this(new Idea25500Config());
    }

    public Idea25500Service(Idea25500Config config) {
        this.config = config != null ? config : new Idea25500Config();
