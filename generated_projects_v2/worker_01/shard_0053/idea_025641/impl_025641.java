...
@Data
public class Idea25641Config {
    private String name = "idea_025641";
 ...
 */
@Slf4j
public class Idea25641Service {
    private static final int IDEA_ID = 25641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25641Service() {
        this(new Idea25641Config());
    }

    public Idea25641Service(Idea25641Config config) {
        this.config = config != null ? config : new Idea25641Config();
