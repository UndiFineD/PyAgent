...
@Data
public class Idea25503Config {
    private String name = "idea_025503";
 ...
 */
@Slf4j
public class Idea25503Service {
    private static final int IDEA_ID = 25503;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25503Service() {
        this(new Idea25503Config());
    }

    public Idea25503Service(Idea25503Config config) {
        this.config = config != null ? config : new Idea25503Config();
