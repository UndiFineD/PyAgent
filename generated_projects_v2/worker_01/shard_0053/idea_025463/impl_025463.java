...
@Data
public class Idea25463Config {
    private String name = "idea_025463";
 ...
 */
@Slf4j
public class Idea25463Service {
    private static final int IDEA_ID = 25463;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25463Service() {
        this(new Idea25463Config());
    }

    public Idea25463Service(Idea25463Config config) {
        this.config = config != null ? config : new Idea25463Config();
