...
@Data
public class Idea25237Config {
    private String name = "idea_025237";
 ...
 */
@Slf4j
public class Idea25237Service {
    private static final int IDEA_ID = 25237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25237Service() {
        this(new Idea25237Config());
    }

    public Idea25237Service(Idea25237Config config) {
        this.config = config != null ? config : new Idea25237Config();
