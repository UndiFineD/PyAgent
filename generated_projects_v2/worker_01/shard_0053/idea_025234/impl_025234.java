...
@Data
public class Idea25234Config {
    private String name = "idea_025234";
 ...
 */
@Slf4j
public class Idea25234Service {
    private static final int IDEA_ID = 25234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25234Service() {
        this(new Idea25234Config());
    }

    public Idea25234Service(Idea25234Config config) {
        this.config = config != null ? config : new Idea25234Config();
