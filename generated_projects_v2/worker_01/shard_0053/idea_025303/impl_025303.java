...
@Data
public class Idea25303Config {
    private String name = "idea_025303";
 ...
 */
@Slf4j
public class Idea25303Service {
    private static final int IDEA_ID = 25303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25303Service() {
        this(new Idea25303Config());
    }

    public Idea25303Service(Idea25303Config config) {
        this.config = config != null ? config : new Idea25303Config();
