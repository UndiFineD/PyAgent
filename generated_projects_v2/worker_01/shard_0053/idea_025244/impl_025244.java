...
@Data
public class Idea25244Config {
    private String name = "idea_025244";
 ...
 */
@Slf4j
public class Idea25244Service {
    private static final int IDEA_ID = 25244;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25244Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25244Service() {
        this(new Idea25244Config());
    }

    public Idea25244Service(Idea25244Config config) {
        this.config = config != null ? config : new Idea25244Config();
