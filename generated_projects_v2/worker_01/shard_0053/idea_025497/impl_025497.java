...
@Data
public class Idea25497Config {
    private String name = "idea_025497";
 ...
 */
@Slf4j
public class Idea25497Service {
    private static final int IDEA_ID = 25497;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25497Service() {
        this(new Idea25497Config());
    }

    public Idea25497Service(Idea25497Config config) {
        this.config = config != null ? config : new Idea25497Config();
