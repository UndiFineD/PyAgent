...
@Data
public class Idea25265Config {
    private String name = "idea_025265";
 ...
 */
@Slf4j
public class Idea25265Service {
    private static final int IDEA_ID = 25265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25265Service() {
        this(new Idea25265Config());
    }

    public Idea25265Service(Idea25265Config config) {
        this.config = config != null ? config : new Idea25265Config();
