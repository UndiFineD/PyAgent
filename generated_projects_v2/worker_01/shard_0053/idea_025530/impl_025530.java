...
@Data
public class Idea25530Config {
    private String name = "idea_025530";
 ...
 */
@Slf4j
public class Idea25530Service {
    private static final int IDEA_ID = 25530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25530Service() {
        this(new Idea25530Config());
    }

    public Idea25530Service(Idea25530Config config) {
        this.config = config != null ? config : new Idea25530Config();
