...
@Data
public class Idea25582Config {
    private String name = "idea_025582";
 ...
 */
@Slf4j
public class Idea25582Service {
    private static final int IDEA_ID = 25582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25582Service() {
        this(new Idea25582Config());
    }

    public Idea25582Service(Idea25582Config config) {
        this.config = config != null ? config : new Idea25582Config();
