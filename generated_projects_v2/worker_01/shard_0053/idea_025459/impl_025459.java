...
@Data
public class Idea25459Config {
    private String name = "idea_025459";
 ...
 */
@Slf4j
public class Idea25459Service {
    private static final int IDEA_ID = 25459;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25459Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25459Service() {
        this(new Idea25459Config());
    }

    public Idea25459Service(Idea25459Config config) {
        this.config = config != null ? config : new Idea25459Config();
