...
@Data
public class Idea25403Config {
    private String name = "idea_025403";
 ...
 */
@Slf4j
public class Idea25403Service {
    private static final int IDEA_ID = 25403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25403Service() {
        this(new Idea25403Config());
    }

    public Idea25403Service(Idea25403Config config) {
        this.config = config != null ? config : new Idea25403Config();
