...
@Data
public class Idea25583Config {
    private String name = "idea_025583";
 ...
 */
@Slf4j
public class Idea25583Service {
    private static final int IDEA_ID = 25583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25583Service() {
        this(new Idea25583Config());
    }

    public Idea25583Service(Idea25583Config config) {
        this.config = config != null ? config : new Idea25583Config();
