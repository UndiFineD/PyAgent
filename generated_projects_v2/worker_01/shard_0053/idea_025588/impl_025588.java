...
@Data
public class Idea25588Config {
    private String name = "idea_025588";
 ...
 */
@Slf4j
public class Idea25588Service {
    private static final int IDEA_ID = 25588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25588Service() {
        this(new Idea25588Config());
    }

    public Idea25588Service(Idea25588Config config) {
        this.config = config != null ? config : new Idea25588Config();
