...
@Data
public class Idea25228Config {
    private String name = "idea_025228";
 ...
 */
@Slf4j
public class Idea25228Service {
    private static final int IDEA_ID = 25228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25228Service() {
        this(new Idea25228Config());
    }

    public Idea25228Service(Idea25228Config config) {
        this.config = config != null ? config : new Idea25228Config();
