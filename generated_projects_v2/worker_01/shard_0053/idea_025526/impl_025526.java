...
@Data
public class Idea25526Config {
    private String name = "idea_025526";
 ...
 */
@Slf4j
public class Idea25526Service {
    private static final int IDEA_ID = 25526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25526Service() {
        this(new Idea25526Config());
    }

    public Idea25526Service(Idea25526Config config) {
        this.config = config != null ? config : new Idea25526Config();
