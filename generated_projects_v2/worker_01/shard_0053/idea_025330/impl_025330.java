...
@Data
public class Idea25330Config {
    private String name = "idea_025330";
 ...
 */
@Slf4j
public class Idea25330Service {
    private static final int IDEA_ID = 25330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25330Service() {
        this(new Idea25330Config());
    }

    public Idea25330Service(Idea25330Config config) {
        this.config = config != null ? config : new Idea25330Config();
