...
@Data
public class Idea25253Config {
    private String name = "idea_025253";
 ...
 */
@Slf4j
public class Idea25253Service {
    private static final int IDEA_ID = 25253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25253Service() {
        this(new Idea25253Config());
    }

    public Idea25253Service(Idea25253Config config) {
        this.config = config != null ? config : new Idea25253Config();
