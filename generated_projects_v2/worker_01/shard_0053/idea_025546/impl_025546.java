...
@Data
public class Idea25546Config {
    private String name = "idea_025546";
 ...
 */
@Slf4j
public class Idea25546Service {
    private static final int IDEA_ID = 25546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25546Service() {
        this(new Idea25546Config());
    }

    public Idea25546Service(Idea25546Config config) {
        this.config = config != null ? config : new Idea25546Config();
