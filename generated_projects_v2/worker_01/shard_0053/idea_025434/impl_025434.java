...
@Data
public class Idea25434Config {
    private String name = "idea_025434";
 ...
 */
@Slf4j
public class Idea25434Service {
    private static final int IDEA_ID = 25434;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25434Service() {
        this(new Idea25434Config());
    }

    public Idea25434Service(Idea25434Config config) {
        this.config = config != null ? config : new Idea25434Config();
