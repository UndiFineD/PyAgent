...
@Data
public class Idea25196Config {
    private String name = "idea_025196";
 ...
 */
@Slf4j
public class Idea25196Service {
    private static final int IDEA_ID = 25196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25196Service() {
        this(new Idea25196Config());
    }

    public Idea25196Service(Idea25196Config config) {
        this.config = config != null ? config : new Idea25196Config();
