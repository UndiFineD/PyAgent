...
@Data
public class Idea25319Config {
    private String name = "idea_025319";
 ...
 */
@Slf4j
public class Idea25319Service {
    private static final int IDEA_ID = 25319;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25319Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25319Service() {
        this(new Idea25319Config());
    }

    public Idea25319Service(Idea25319Config config) {
        this.config = config != null ? config : new Idea25319Config();
