...
@Data
public class Idea25294Config {
    private String name = "idea_025294";
 ...
 */
@Slf4j
public class Idea25294Service {
    private static final int IDEA_ID = 25294;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25294Service() {
        this(new Idea25294Config());
    }

    public Idea25294Service(Idea25294Config config) {
        this.config = config != null ? config : new Idea25294Config();
