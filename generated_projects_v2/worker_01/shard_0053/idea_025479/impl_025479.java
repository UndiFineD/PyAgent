...
@Data
public class Idea25479Config {
    private String name = "idea_025479";
 ...
 */
@Slf4j
public class Idea25479Service {
    private static final int IDEA_ID = 25479;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25479Service() {
        this(new Idea25479Config());
    }

    public Idea25479Service(Idea25479Config config) {
        this.config = config != null ? config : new Idea25479Config();
