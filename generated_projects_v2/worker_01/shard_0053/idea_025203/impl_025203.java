...
@Data
public class Idea25203Config {
    private String name = "idea_025203";
 ...
 */
@Slf4j
public class Idea25203Service {
    private static final int IDEA_ID = 25203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25203Service() {
        this(new Idea25203Config());
    }

    public Idea25203Service(Idea25203Config config) {
        this.config = config != null ? config : new Idea25203Config();
