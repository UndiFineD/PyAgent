...
@Data
public class Idea25400Config {
    private String name = "idea_025400";
 ...
 */
@Slf4j
public class Idea25400Service {
    private static final int IDEA_ID = 25400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25400Service() {
        this(new Idea25400Config());
    }

    public Idea25400Service(Idea25400Config config) {
        this.config = config != null ? config : new Idea25400Config();
