...
@Data
public class Idea25379Config {
    private String name = "idea_025379";
 ...
 */
@Slf4j
public class Idea25379Service {
    private static final int IDEA_ID = 25379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25379Service() {
        this(new Idea25379Config());
    }

    public Idea25379Service(Idea25379Config config) {
        this.config = config != null ? config : new Idea25379Config();
