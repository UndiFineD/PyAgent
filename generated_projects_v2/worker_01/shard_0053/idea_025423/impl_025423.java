...
@Data
public class Idea25423Config {
    private String name = "idea_025423";
 ...
 */
@Slf4j
public class Idea25423Service {
    private static final int IDEA_ID = 25423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25423Service() {
        this(new Idea25423Config());
    }

    public Idea25423Service(Idea25423Config config) {
        this.config = config != null ? config : new Idea25423Config();
