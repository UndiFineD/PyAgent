...
@Data
public class Idea25179Config {
    private String name = "idea_025179";
 ...
 */
@Slf4j
public class Idea25179Service {
    private static final int IDEA_ID = 25179;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25179Service() {
        this(new Idea25179Config());
    }

    public Idea25179Service(Idea25179Config config) {
        this.config = config != null ? config : new Idea25179Config();
