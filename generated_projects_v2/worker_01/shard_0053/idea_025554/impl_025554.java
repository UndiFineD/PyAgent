...
@Data
public class Idea25554Config {
    private String name = "idea_025554";
 ...
 */
@Slf4j
public class Idea25554Service {
    private static final int IDEA_ID = 25554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25554Service() {
        this(new Idea25554Config());
    }

    public Idea25554Service(Idea25554Config config) {
        this.config = config != null ? config : new Idea25554Config();
