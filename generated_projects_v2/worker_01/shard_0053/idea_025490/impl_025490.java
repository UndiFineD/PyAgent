...
@Data
public class Idea25490Config {
    private String name = "idea_025490";
 ...
 */
@Slf4j
public class Idea25490Service {
    private static final int IDEA_ID = 25490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25490Service() {
        this(new Idea25490Config());
    }

    public Idea25490Service(Idea25490Config config) {
        this.config = config != null ? config : new Idea25490Config();
