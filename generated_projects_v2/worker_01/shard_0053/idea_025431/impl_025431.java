...
@Data
public class Idea25431Config {
    private String name = "idea_025431";
 ...
 */
@Slf4j
public class Idea25431Service {
    private static final int IDEA_ID = 25431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25431Service() {
        this(new Idea25431Config());
    }

    public Idea25431Service(Idea25431Config config) {
        this.config = config != null ? config : new Idea25431Config();
