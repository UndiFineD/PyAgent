...
@Data
public class Idea25612Config {
    private String name = "idea_025612";
 ...
 */
@Slf4j
public class Idea25612Service {
    private static final int IDEA_ID = 25612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25612Service() {
        this(new Idea25612Config());
    }

    public Idea25612Service(Idea25612Config config) {
        this.config = config != null ? config : new Idea25612Config();
