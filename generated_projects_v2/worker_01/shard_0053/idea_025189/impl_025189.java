...
@Data
public class Idea25189Config {
    private String name = "idea_025189";
 ...
 */
@Slf4j
public class Idea25189Service {
    private static final int IDEA_ID = 25189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25189Service() {
        this(new Idea25189Config());
    }

    public Idea25189Service(Idea25189Config config) {
        this.config = config != null ? config : new Idea25189Config();
