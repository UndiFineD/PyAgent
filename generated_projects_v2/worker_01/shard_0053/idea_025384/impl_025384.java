...
@Data
public class Idea25384Config {
    private String name = "idea_025384";
 ...
 */
@Slf4j
public class Idea25384Service {
    private static final int IDEA_ID = 25384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25384Service() {
        this(new Idea25384Config());
    }

    public Idea25384Service(Idea25384Config config) {
        this.config = config != null ? config : new Idea25384Config();
