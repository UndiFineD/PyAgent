...
@Data
public class Idea25595Config {
    private String name = "idea_025595";
 ...
 */
@Slf4j
public class Idea25595Service {
    private static final int IDEA_ID = 25595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25595Service() {
        this(new Idea25595Config());
    }

    public Idea25595Service(Idea25595Config config) {
        this.config = config != null ? config : new Idea25595Config();
