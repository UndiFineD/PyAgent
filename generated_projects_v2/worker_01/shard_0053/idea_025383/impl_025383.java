...
@Data
public class Idea25383Config {
    private String name = "idea_025383";
 ...
 */
@Slf4j
public class Idea25383Service {
    private static final int IDEA_ID = 25383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25383Service() {
        this(new Idea25383Config());
    }

    public Idea25383Service(Idea25383Config config) {
        this.config = config != null ? config : new Idea25383Config();
