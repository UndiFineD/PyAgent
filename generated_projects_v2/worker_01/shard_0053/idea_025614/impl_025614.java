...
@Data
public class Idea25614Config {
    private String name = "idea_025614";
 ...
 */
@Slf4j
public class Idea25614Service {
    private static final int IDEA_ID = 25614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25614Service() {
        this(new Idea25614Config());
    }

    public Idea25614Service(Idea25614Config config) {
        this.config = config != null ? config : new Idea25614Config();
