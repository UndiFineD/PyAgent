...
@Data
public class Idea25307Config {
    private String name = "idea_025307";
 ...
 */
@Slf4j
public class Idea25307Service {
    private static final int IDEA_ID = 25307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25307Service() {
        this(new Idea25307Config());
    }

    public Idea25307Service(Idea25307Config config) {
        this.config = config != null ? config : new Idea25307Config();
