...
@Data
public class Idea25454Config {
    private String name = "idea_025454";
 ...
 */
@Slf4j
public class Idea25454Service {
    private static final int IDEA_ID = 25454;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25454Service() {
        this(new Idea25454Config());
    }

    public Idea25454Service(Idea25454Config config) {
        this.config = config != null ? config : new Idea25454Config();
