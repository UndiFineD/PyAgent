...
@Data
public class Idea25358Config {
    private String name = "idea_025358";
 ...
 */
@Slf4j
public class Idea25358Service {
    private static final int IDEA_ID = 25358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25358Service() {
        this(new Idea25358Config());
    }

    public Idea25358Service(Idea25358Config config) {
        this.config = config != null ? config : new Idea25358Config();
