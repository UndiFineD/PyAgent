...
@Data
public class Idea25252Config {
    private String name = "idea_025252";
 ...
 */
@Slf4j
public class Idea25252Service {
    private static final int IDEA_ID = 25252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25252Service() {
        this(new Idea25252Config());
    }

    public Idea25252Service(Idea25252Config config) {
        this.config = config != null ? config : new Idea25252Config();
