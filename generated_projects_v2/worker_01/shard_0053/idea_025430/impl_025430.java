...
@Data
public class Idea25430Config {
    private String name = "idea_025430";
 ...
 */
@Slf4j
public class Idea25430Service {
    private static final int IDEA_ID = 25430;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25430Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25430Service() {
        this(new Idea25430Config());
    }

    public Idea25430Service(Idea25430Config config) {
        this.config = config != null ? config : new Idea25430Config();
