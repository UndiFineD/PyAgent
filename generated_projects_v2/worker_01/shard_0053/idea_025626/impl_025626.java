...
@Data
public class Idea25626Config {
    private String name = "idea_025626";
 ...
 */
@Slf4j
public class Idea25626Service {
    private static final int IDEA_ID = 25626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25626Service() {
        this(new Idea25626Config());
    }

    public Idea25626Service(Idea25626Config config) {
        this.config = config != null ? config : new Idea25626Config();
