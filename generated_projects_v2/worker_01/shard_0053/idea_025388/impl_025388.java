...
@Data
public class Idea25388Config {
    private String name = "idea_025388";
 ...
 */
@Slf4j
public class Idea25388Service {
    private static final int IDEA_ID = 25388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25388Service() {
        this(new Idea25388Config());
    }

    public Idea25388Service(Idea25388Config config) {
        this.config = config != null ? config : new Idea25388Config();
