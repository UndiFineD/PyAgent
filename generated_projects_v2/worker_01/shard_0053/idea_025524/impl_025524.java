...
@Data
public class Idea25524Config {
    private String name = "idea_025524";
 ...
 */
@Slf4j
public class Idea25524Service {
    private static final int IDEA_ID = 25524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25524Service() {
        this(new Idea25524Config());
    }

    public Idea25524Service(Idea25524Config config) {
        this.config = config != null ? config : new Idea25524Config();
