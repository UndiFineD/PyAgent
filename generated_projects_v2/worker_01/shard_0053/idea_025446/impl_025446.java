...
@Data
public class Idea25446Config {
    private String name = "idea_025446";
 ...
 */
@Slf4j
public class Idea25446Service {
    private static final int IDEA_ID = 25446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25446Service() {
        this(new Idea25446Config());
    }

    public Idea25446Service(Idea25446Config config) {
        this.config = config != null ? config : new Idea25446Config();
