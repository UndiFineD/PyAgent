...
@Data
public class Idea25573Config {
    private String name = "idea_025573";
 ...
 */
@Slf4j
public class Idea25573Service {
    private static final int IDEA_ID = 25573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25573Service() {
        this(new Idea25573Config());
    }

    public Idea25573Service(Idea25573Config config) {
        this.config = config != null ? config : new Idea25573Config();
