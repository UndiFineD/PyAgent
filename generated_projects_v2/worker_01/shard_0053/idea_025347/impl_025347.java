...
@Data
public class Idea25347Config {
    private String name = "idea_025347";
 ...
 */
@Slf4j
public class Idea25347Service {
    private static final int IDEA_ID = 25347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25347Service() {
        this(new Idea25347Config());
    }

    public Idea25347Service(Idea25347Config config) {
        this.config = config != null ? config : new Idea25347Config();
