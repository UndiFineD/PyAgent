...
@Data
public class Idea25375Config {
    private String name = "idea_025375";
 ...
 */
@Slf4j
public class Idea25375Service {
    private static final int IDEA_ID = 25375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25375Service() {
        this(new Idea25375Config());
    }

    public Idea25375Service(Idea25375Config config) {
        this.config = config != null ? config : new Idea25375Config();
