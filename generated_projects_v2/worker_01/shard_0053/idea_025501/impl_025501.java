...
@Data
public class Idea25501Config {
    private String name = "idea_025501";
 ...
 */
@Slf4j
public class Idea25501Service {
    private static final int IDEA_ID = 25501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25501Service() {
        this(new Idea25501Config());
    }

    public Idea25501Service(Idea25501Config config) {
        this.config = config != null ? config : new Idea25501Config();
