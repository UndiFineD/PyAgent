...
@Data
public class Idea25178Config {
    private String name = "idea_025178";
 ...
 */
@Slf4j
public class Idea25178Service {
    private static final int IDEA_ID = 25178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25178Service() {
        this(new Idea25178Config());
    }

    public Idea25178Service(Idea25178Config config) {
        this.config = config != null ? config : new Idea25178Config();
