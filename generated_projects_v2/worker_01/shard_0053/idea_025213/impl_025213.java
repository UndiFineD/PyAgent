...
@Data
public class Idea25213Config {
    private String name = "idea_025213";
 ...
 */
@Slf4j
public class Idea25213Service {
    private static final int IDEA_ID = 25213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25213Service() {
        this(new Idea25213Config());
    }

    public Idea25213Service(Idea25213Config config) {
        this.config = config != null ? config : new Idea25213Config();
