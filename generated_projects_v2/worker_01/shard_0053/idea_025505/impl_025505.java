...
@Data
public class Idea25505Config {
    private String name = "idea_025505";
 ...
 */
@Slf4j
public class Idea25505Service {
    private static final int IDEA_ID = 25505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25505Service() {
        this(new Idea25505Config());
    }

    public Idea25505Service(Idea25505Config config) {
        this.config = config != null ? config : new Idea25505Config();
