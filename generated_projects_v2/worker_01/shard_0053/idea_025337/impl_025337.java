...
@Data
public class Idea25337Config {
    private String name = "idea_025337";
 ...
 */
@Slf4j
public class Idea25337Service {
    private static final int IDEA_ID = 25337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25337Service() {
        this(new Idea25337Config());
    }

    public Idea25337Service(Idea25337Config config) {
        this.config = config != null ? config : new Idea25337Config();
