...
@Data
public class Idea25396Config {
    private String name = "idea_025396";
 ...
 */
@Slf4j
public class Idea25396Service {
    private static final int IDEA_ID = 25396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25396Service() {
        this(new Idea25396Config());
    }

    public Idea25396Service(Idea25396Config config) {
        this.config = config != null ? config : new Idea25396Config();
