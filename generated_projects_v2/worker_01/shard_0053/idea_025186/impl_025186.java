...
@Data
public class Idea25186Config {
    private String name = "idea_025186";
 ...
 */
@Slf4j
public class Idea25186Service {
    private static final int IDEA_ID = 25186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25186Service() {
        this(new Idea25186Config());
    }

    public Idea25186Service(Idea25186Config config) {
        this.config = config != null ? config : new Idea25186Config();
