...
@Data
public class Idea25378Config {
    private String name = "idea_025378";
 ...
 */
@Slf4j
public class Idea25378Service {
    private static final int IDEA_ID = 25378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25378Service() {
        this(new Idea25378Config());
    }

    public Idea25378Service(Idea25378Config config) {
        this.config = config != null ? config : new Idea25378Config();
