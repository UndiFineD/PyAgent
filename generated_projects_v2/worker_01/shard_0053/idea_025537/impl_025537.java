...
@Data
public class Idea25537Config {
    private String name = "idea_025537";
 ...
 */
@Slf4j
public class Idea25537Service {
    private static final int IDEA_ID = 25537;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25537Service() {
        this(new Idea25537Config());
    }

    public Idea25537Service(Idea25537Config config) {
        this.config = config != null ? config : new Idea25537Config();
