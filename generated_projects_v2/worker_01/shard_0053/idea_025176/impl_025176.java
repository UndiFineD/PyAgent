...
@Data
public class Idea25176Config {
    private String name = "idea_025176";
 ...
 */
@Slf4j
public class Idea25176Service {
    private static final int IDEA_ID = 25176;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25176Service() {
        this(new Idea25176Config());
    }

    public Idea25176Service(Idea25176Config config) {
        this.config = config != null ? config : new Idea25176Config();
