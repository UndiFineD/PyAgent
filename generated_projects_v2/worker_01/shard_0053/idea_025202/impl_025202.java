...
@Data
public class Idea25202Config {
    private String name = "idea_025202";
 ...
 */
@Slf4j
public class Idea25202Service {
    private static final int IDEA_ID = 25202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25202Service() {
        this(new Idea25202Config());
    }

    public Idea25202Service(Idea25202Config config) {
        this.config = config != null ? config : new Idea25202Config();
