...
@Data
public class Idea25402Config {
    private String name = "idea_025402";
 ...
 */
@Slf4j
public class Idea25402Service {
    private static final int IDEA_ID = 25402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25402Service() {
        this(new Idea25402Config());
    }

    public Idea25402Service(Idea25402Config config) {
        this.config = config != null ? config : new Idea25402Config();
