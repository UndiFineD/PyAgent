...
@Data
public class Idea25321Config {
    private String name = "idea_025321";
 ...
 */
@Slf4j
public class Idea25321Service {
    private static final int IDEA_ID = 25321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25321Service() {
        this(new Idea25321Config());
    }

    public Idea25321Service(Idea25321Config config) {
        this.config = config != null ? config : new Idea25321Config();
