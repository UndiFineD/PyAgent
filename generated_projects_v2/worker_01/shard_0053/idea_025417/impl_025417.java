...
@Data
public class Idea25417Config {
    private String name = "idea_025417";
 ...
 */
@Slf4j
public class Idea25417Service {
    private static final int IDEA_ID = 25417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25417Service() {
        this(new Idea25417Config());
    }

    public Idea25417Service(Idea25417Config config) {
        this.config = config != null ? config : new Idea25417Config();
