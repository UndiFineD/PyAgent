...
@Data
public class Idea25376Config {
    private String name = "idea_025376";
 ...
 */
@Slf4j
public class Idea25376Service {
    private static final int IDEA_ID = 25376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25376Service() {
        this(new Idea25376Config());
    }

    public Idea25376Service(Idea25376Config config) {
        this.config = config != null ? config : new Idea25376Config();
