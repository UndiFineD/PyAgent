...
@Data
public class Idea25269Config {
    private String name = "idea_025269";
 ...
 */
@Slf4j
public class Idea25269Service {
    private static final int IDEA_ID = 25269;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25269Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25269Service() {
        this(new Idea25269Config());
    }

    public Idea25269Service(Idea25269Config config) {
        this.config = config != null ? config : new Idea25269Config();
