...
@Data
public class Idea25308Config {
    private String name = "idea_025308";
 ...
 */
@Slf4j
public class Idea25308Service {
    private static final int IDEA_ID = 25308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25308Service() {
        this(new Idea25308Config());
    }

    public Idea25308Service(Idea25308Config config) {
        this.config = config != null ? config : new Idea25308Config();
