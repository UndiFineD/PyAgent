...
@Data
public class Idea25635Config {
    private String name = "idea_025635";
 ...
 */
@Slf4j
public class Idea25635Service {
    private static final int IDEA_ID = 25635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25635Service() {
        this(new Idea25635Config());
    }

    public Idea25635Service(Idea25635Config config) {
        this.config = config != null ? config : new Idea25635Config();
