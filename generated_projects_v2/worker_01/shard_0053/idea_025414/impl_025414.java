...
@Data
public class Idea25414Config {
    private String name = "idea_025414";
 ...
 */
@Slf4j
public class Idea25414Service {
    private static final int IDEA_ID = 25414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25414Service() {
        this(new Idea25414Config());
    }

    public Idea25414Service(Idea25414Config config) {
        this.config = config != null ? config : new Idea25414Config();
