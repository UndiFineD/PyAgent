...
@Data
public class Idea25589Config {
    private String name = "idea_025589";
 ...
 */
@Slf4j
public class Idea25589Service {
    private static final int IDEA_ID = 25589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25589Service() {
        this(new Idea25589Config());
    }

    public Idea25589Service(Idea25589Config config) {
        this.config = config != null ? config : new Idea25589Config();
