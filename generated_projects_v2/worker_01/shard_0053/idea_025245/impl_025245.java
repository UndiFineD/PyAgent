...
@Data
public class Idea25245Config {
    private String name = "idea_025245";
 ...
 */
@Slf4j
public class Idea25245Service {
    private static final int IDEA_ID = 25245;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25245Service() {
        this(new Idea25245Config());
    }

    public Idea25245Service(Idea25245Config config) {
        this.config = config != null ? config : new Idea25245Config();
