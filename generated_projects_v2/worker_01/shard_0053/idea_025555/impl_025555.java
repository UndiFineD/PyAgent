...
@Data
public class Idea25555Config {
    private String name = "idea_025555";
 ...
 */
@Slf4j
public class Idea25555Service {
    private static final int IDEA_ID = 25555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25555Service() {
        this(new Idea25555Config());
    }

    public Idea25555Service(Idea25555Config config) {
        this.config = config != null ? config : new Idea25555Config();
