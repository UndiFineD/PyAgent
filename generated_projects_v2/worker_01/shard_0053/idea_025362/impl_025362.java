...
@Data
public class Idea25362Config {
    private String name = "idea_025362";
 ...
 */
@Slf4j
public class Idea25362Service {
    private static final int IDEA_ID = 25362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25362Service() {
        this(new Idea25362Config());
    }

    public Idea25362Service(Idea25362Config config) {
        this.config = config != null ? config : new Idea25362Config();
