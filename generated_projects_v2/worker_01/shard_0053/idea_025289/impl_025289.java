...
@Data
public class Idea25289Config {
    private String name = "idea_025289";
 ...
 */
@Slf4j
public class Idea25289Service {
    private static final int IDEA_ID = 25289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25289Service() {
        this(new Idea25289Config());
    }

    public Idea25289Service(Idea25289Config config) {
        this.config = config != null ? config : new Idea25289Config();
