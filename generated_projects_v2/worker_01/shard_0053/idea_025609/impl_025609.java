...
@Data
public class Idea25609Config {
    private String name = "idea_025609";
 ...
 */
@Slf4j
public class Idea25609Service {
    private static final int IDEA_ID = 25609;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25609Service() {
        this(new Idea25609Config());
    }

    public Idea25609Service(Idea25609Config config) {
        this.config = config != null ? config : new Idea25609Config();
