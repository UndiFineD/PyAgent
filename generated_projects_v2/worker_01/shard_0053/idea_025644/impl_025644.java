...
@Data
public class Idea25644Config {
    private String name = "idea_025644";
 ...
 */
@Slf4j
public class Idea25644Service {
    private static final int IDEA_ID = 25644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25644Service() {
        this(new Idea25644Config());
    }

    public Idea25644Service(Idea25644Config config) {
        this.config = config != null ? config : new Idea25644Config();
