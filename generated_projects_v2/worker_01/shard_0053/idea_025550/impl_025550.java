...
@Data
public class Idea25550Config {
    private String name = "idea_025550";
 ...
 */
@Slf4j
public class Idea25550Service {
    private static final int IDEA_ID = 25550;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25550Service() {
        this(new Idea25550Config());
    }

    public Idea25550Service(Idea25550Config config) {
        this.config = config != null ? config : new Idea25550Config();
