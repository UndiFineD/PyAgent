...
@Data
public class Idea25229Config {
    private String name = "idea_025229";
 ...
 */
@Slf4j
public class Idea25229Service {
    private static final int IDEA_ID = 25229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25229Service() {
        this(new Idea25229Config());
    }

    public Idea25229Service(Idea25229Config config) {
        this.config = config != null ? config : new Idea25229Config();
