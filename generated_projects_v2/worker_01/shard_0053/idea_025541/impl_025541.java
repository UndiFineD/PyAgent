...
@Data
public class Idea25541Config {
    private String name = "idea_025541";
 ...
 */
@Slf4j
public class Idea25541Service {
    private static final int IDEA_ID = 25541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25541Service() {
        this(new Idea25541Config());
    }

    public Idea25541Service(Idea25541Config config) {
        this.config = config != null ? config : new Idea25541Config();
