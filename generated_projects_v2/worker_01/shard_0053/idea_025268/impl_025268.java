...
@Data
public class Idea25268Config {
    private String name = "idea_025268";
 ...
 */
@Slf4j
public class Idea25268Service {
    private static final int IDEA_ID = 25268;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25268Service() {
        this(new Idea25268Config());
    }

    public Idea25268Service(Idea25268Config config) {
        this.config = config != null ? config : new Idea25268Config();
