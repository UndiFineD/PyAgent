...
@Data
public class Idea25594Config {
    private String name = "idea_025594";
 ...
 */
@Slf4j
public class Idea25594Service {
    private static final int IDEA_ID = 25594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25594Service() {
        this(new Idea25594Config());
    }

    public Idea25594Service(Idea25594Config config) {
        this.config = config != null ? config : new Idea25594Config();
