...
@Data
public class Idea25621Config {
    private String name = "idea_025621";
 ...
 */
@Slf4j
public class Idea25621Service {
    private static final int IDEA_ID = 25621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25621Service() {
        this(new Idea25621Config());
    }

    public Idea25621Service(Idea25621Config config) {
        this.config = config != null ? config : new Idea25621Config();
