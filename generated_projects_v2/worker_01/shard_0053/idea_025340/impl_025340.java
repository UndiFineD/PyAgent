...
@Data
public class Idea25340Config {
    private String name = "idea_025340";
 ...
 */
@Slf4j
public class Idea25340Service {
    private static final int IDEA_ID = 25340;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25340Service() {
        this(new Idea25340Config());
    }

    public Idea25340Service(Idea25340Config config) {
        this.config = config != null ? config : new Idea25340Config();
