...
@Data
public class Idea25469Config {
    private String name = "idea_025469";
 ...
 */
@Slf4j
public class Idea25469Service {
    private static final int IDEA_ID = 25469;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25469Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25469Service() {
        this(new Idea25469Config());
    }

    public Idea25469Service(Idea25469Config config) {
        this.config = config != null ? config : new Idea25469Config();
