...
@Data
public class Idea25556Config {
    private String name = "idea_025556";
 ...
 */
@Slf4j
public class Idea25556Service {
    private static final int IDEA_ID = 25556;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25556Service() {
        this(new Idea25556Config());
    }

    public Idea25556Service(Idea25556Config config) {
        this.config = config != null ? config : new Idea25556Config();
