...
@Data
public class Idea25335Config {
    private String name = "idea_025335";
 ...
 */
@Slf4j
public class Idea25335Service {
    private static final int IDEA_ID = 25335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25335Service() {
        this(new Idea25335Config());
    }

    public Idea25335Service(Idea25335Config config) {
        this.config = config != null ? config : new Idea25335Config();
