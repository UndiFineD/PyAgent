...
@Data
public class Idea25473Config {
    private String name = "idea_025473";
 ...
 */
@Slf4j
public class Idea25473Service {
    private static final int IDEA_ID = 25473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25473Service() {
        this(new Idea25473Config());
    }

    public Idea25473Service(Idea25473Config config) {
        this.config = config != null ? config : new Idea25473Config();
