...
@Data
public class Idea25451Config {
    private String name = "idea_025451";
 ...
 */
@Slf4j
public class Idea25451Service {
    private static final int IDEA_ID = 25451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25451Service() {
        this(new Idea25451Config());
    }

    public Idea25451Service(Idea25451Config config) {
        this.config = config != null ? config : new Idea25451Config();
