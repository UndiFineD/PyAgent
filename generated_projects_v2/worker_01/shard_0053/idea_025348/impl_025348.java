...
@Data
public class Idea25348Config {
    private String name = "idea_025348";
 ...
 */
@Slf4j
public class Idea25348Service {
    private static final int IDEA_ID = 25348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25348Service() {
        this(new Idea25348Config());
    }

    public Idea25348Service(Idea25348Config config) {
        this.config = config != null ? config : new Idea25348Config();
