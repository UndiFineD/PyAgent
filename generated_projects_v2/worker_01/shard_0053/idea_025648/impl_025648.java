...
@Data
public class Idea25648Config {
    private String name = "idea_025648";
 ...
 */
@Slf4j
public class Idea25648Service {
    private static final int IDEA_ID = 25648;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25648Service() {
        this(new Idea25648Config());
    }

    public Idea25648Service(Idea25648Config config) {
        this.config = config != null ? config : new Idea25648Config();
