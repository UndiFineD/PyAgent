...
@Data
public class Idea25544Config {
    private String name = "idea_025544";
 ...
 */
@Slf4j
public class Idea25544Service {
    private static final int IDEA_ID = 25544;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25544Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25544Service() {
        this(new Idea25544Config());
    }

    public Idea25544Service(Idea25544Config config) {
        this.config = config != null ? config : new Idea25544Config();
