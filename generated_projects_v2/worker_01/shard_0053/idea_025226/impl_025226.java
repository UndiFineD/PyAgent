...
@Data
public class Idea25226Config {
    private String name = "idea_025226";
 ...
 */
@Slf4j
public class Idea25226Service {
    private static final int IDEA_ID = 25226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25226Service() {
        this(new Idea25226Config());
    }

    public Idea25226Service(Idea25226Config config) {
        this.config = config != null ? config : new Idea25226Config();
