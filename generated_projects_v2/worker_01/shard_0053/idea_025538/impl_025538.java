...
@Data
public class Idea25538Config {
    private String name = "idea_025538";
 ...
 */
@Slf4j
public class Idea25538Service {
    private static final int IDEA_ID = 25538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25538Service() {
        this(new Idea25538Config());
    }

    public Idea25538Service(Idea25538Config config) {
        this.config = config != null ? config : new Idea25538Config();
