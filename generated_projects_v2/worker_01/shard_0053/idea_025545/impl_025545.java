...
@Data
public class Idea25545Config {
    private String name = "idea_025545";
 ...
 */
@Slf4j
public class Idea25545Service {
    private static final int IDEA_ID = 25545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25545Service() {
        this(new Idea25545Config());
    }

    public Idea25545Service(Idea25545Config config) {
        this.config = config != null ? config : new Idea25545Config();
