...
@Data
public class Idea25564Config {
    private String name = "idea_025564";
 ...
 */
@Slf4j
public class Idea25564Service {
    private static final int IDEA_ID = 25564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25564Service() {
        this(new Idea25564Config());
    }

    public Idea25564Service(Idea25564Config config) {
        this.config = config != null ? config : new Idea25564Config();
