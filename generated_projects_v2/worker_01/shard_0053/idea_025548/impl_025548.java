...
@Data
public class Idea25548Config {
    private String name = "idea_025548";
 ...
 */
@Slf4j
public class Idea25548Service {
    private static final int IDEA_ID = 25548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25548Service() {
        this(new Idea25548Config());
    }

    public Idea25548Service(Idea25548Config config) {
        this.config = config != null ? config : new Idea25548Config();
