...
@Data
public class Idea25411Config {
    private String name = "idea_025411";
 ...
 */
@Slf4j
public class Idea25411Service {
    private static final int IDEA_ID = 25411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25411Service() {
        this(new Idea25411Config());
    }

    public Idea25411Service(Idea25411Config config) {
        this.config = config != null ? config : new Idea25411Config();
