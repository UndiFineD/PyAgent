...
@Data
public class Idea25317Config {
    private String name = "idea_025317";
 ...
 */
@Slf4j
public class Idea25317Service {
    private static final int IDEA_ID = 25317;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25317Service() {
        this(new Idea25317Config());
    }

    public Idea25317Service(Idea25317Config config) {
        this.config = config != null ? config : new Idea25317Config();
