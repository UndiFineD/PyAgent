...
@Data
public class Idea25562Config {
    private String name = "idea_025562";
 ...
 */
@Slf4j
public class Idea25562Service {
    private static final int IDEA_ID = 25562;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25562Service() {
        this(new Idea25562Config());
    }

    public Idea25562Service(Idea25562Config config) {
        this.config = config != null ? config : new Idea25562Config();
