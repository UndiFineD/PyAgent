...
@Data
public class Idea25201Config {
    private String name = "idea_025201";
 ...
 */
@Slf4j
public class Idea25201Service {
    private static final int IDEA_ID = 25201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25201Service() {
        this(new Idea25201Config());
    }

    public Idea25201Service(Idea25201Config config) {
        this.config = config != null ? config : new Idea25201Config();
