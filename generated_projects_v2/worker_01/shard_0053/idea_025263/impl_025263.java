...
@Data
public class Idea25263Config {
    private String name = "idea_025263";
 ...
 */
@Slf4j
public class Idea25263Service {
    private static final int IDEA_ID = 25263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25263Service() {
        this(new Idea25263Config());
    }

    public Idea25263Service(Idea25263Config config) {
        this.config = config != null ? config : new Idea25263Config();
