...
@Data
public class Idea25575Config {
    private String name = "idea_025575";
 ...
 */
@Slf4j
public class Idea25575Service {
    private static final int IDEA_ID = 25575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25575Service() {
        this(new Idea25575Config());
    }

    public Idea25575Service(Idea25575Config config) {
        this.config = config != null ? config : new Idea25575Config();
