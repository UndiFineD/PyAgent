...
@Data
public class Idea25401Config {
    private String name = "idea_025401";
 ...
 */
@Slf4j
public class Idea25401Service {
    private static final int IDEA_ID = 25401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25401Service() {
        this(new Idea25401Config());
    }

    public Idea25401Service(Idea25401Config config) {
        this.config = config != null ? config : new Idea25401Config();
