...
@Data
public class Idea25346Config {
    private String name = "idea_025346";
 ...
 */
@Slf4j
public class Idea25346Service {
    private static final int IDEA_ID = 25346;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25346Service() {
        this(new Idea25346Config());
    }

    public Idea25346Service(Idea25346Config config) {
        this.config = config != null ? config : new Idea25346Config();
