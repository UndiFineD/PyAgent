...
@Data
public class Idea25491Config {
    private String name = "idea_025491";
 ...
 */
@Slf4j
public class Idea25491Service {
    private static final int IDEA_ID = 25491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25491Service() {
        this(new Idea25491Config());
    }

    public Idea25491Service(Idea25491Config config) {
        this.config = config != null ? config : new Idea25491Config();
