...
@Data
public class Idea25387Config {
    private String name = "idea_025387";
 ...
 */
@Slf4j
public class Idea25387Service {
    private static final int IDEA_ID = 25387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25387Service() {
        this(new Idea25387Config());
    }

    public Idea25387Service(Idea25387Config config) {
        this.config = config != null ? config : new Idea25387Config();
