...
@Data
public class Idea25421Config {
    private String name = "idea_025421";
 ...
 */
@Slf4j
public class Idea25421Service {
    private static final int IDEA_ID = 25421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25421Service() {
        this(new Idea25421Config());
    }

    public Idea25421Service(Idea25421Config config) {
        this.config = config != null ? config : new Idea25421Config();
