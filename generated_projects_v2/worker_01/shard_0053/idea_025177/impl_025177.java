...
@Data
public class Idea25177Config {
    private String name = "idea_025177";
 ...
 */
@Slf4j
public class Idea25177Service {
    private static final int IDEA_ID = 25177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25177Service() {
        this(new Idea25177Config());
    }

    public Idea25177Service(Idea25177Config config) {
        this.config = config != null ? config : new Idea25177Config();
