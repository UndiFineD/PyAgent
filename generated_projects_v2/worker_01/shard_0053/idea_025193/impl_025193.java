...
@Data
public class Idea25193Config {
    private String name = "idea_025193";
 ...
 */
@Slf4j
public class Idea25193Service {
    private static final int IDEA_ID = 25193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25193Service() {
        this(new Idea25193Config());
    }

    public Idea25193Service(Idea25193Config config) {
        this.config = config != null ? config : new Idea25193Config();
