...
@Data
public class Idea25412Config {
    private String name = "idea_025412";
 ...
 */
@Slf4j
public class Idea25412Service {
    private static final int IDEA_ID = 25412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25412Service() {
        this(new Idea25412Config());
    }

    public Idea25412Service(Idea25412Config config) {
        this.config = config != null ? config : new Idea25412Config();
