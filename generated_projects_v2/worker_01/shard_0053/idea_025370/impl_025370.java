...
@Data
public class Idea25370Config {
    private String name = "idea_025370";
 ...
 */
@Slf4j
public class Idea25370Service {
    private static final int IDEA_ID = 25370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25370Service() {
        this(new Idea25370Config());
    }

    public Idea25370Service(Idea25370Config config) {
        this.config = config != null ? config : new Idea25370Config();
