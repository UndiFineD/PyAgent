...
@Data
public class Idea25563Config {
    private String name = "idea_025563";
 ...
 */
@Slf4j
public class Idea25563Service {
    private static final int IDEA_ID = 25563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25563Service() {
        this(new Idea25563Config());
    }

    public Idea25563Service(Idea25563Config config) {
        this.config = config != null ? config : new Idea25563Config();
