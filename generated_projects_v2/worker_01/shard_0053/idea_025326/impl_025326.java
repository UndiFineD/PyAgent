...
@Data
public class Idea25326Config {
    private String name = "idea_025326";
 ...
 */
@Slf4j
public class Idea25326Service {
    private static final int IDEA_ID = 25326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25326Service() {
        this(new Idea25326Config());
    }

    public Idea25326Service(Idea25326Config config) {
        this.config = config != null ? config : new Idea25326Config();
