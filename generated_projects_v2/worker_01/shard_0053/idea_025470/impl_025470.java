...
@Data
public class Idea25470Config {
    private String name = "idea_025470";
 ...
 */
@Slf4j
public class Idea25470Service {
    private static final int IDEA_ID = 25470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25470Service() {
        this(new Idea25470Config());
    }

    public Idea25470Service(Idea25470Config config) {
        this.config = config != null ? config : new Idea25470Config();
