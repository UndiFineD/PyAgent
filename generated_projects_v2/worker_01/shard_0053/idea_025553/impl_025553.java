...
@Data
public class Idea25553Config {
    private String name = "idea_025553";
 ...
 */
@Slf4j
public class Idea25553Service {
    private static final int IDEA_ID = 25553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25553Service() {
        this(new Idea25553Config());
    }

    public Idea25553Service(Idea25553Config config) {
        this.config = config != null ? config : new Idea25553Config();
