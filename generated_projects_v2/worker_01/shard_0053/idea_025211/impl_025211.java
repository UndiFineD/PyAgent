...
@Data
public class Idea25211Config {
    private String name = "idea_025211";
 ...
 */
@Slf4j
public class Idea25211Service {
    private static final int IDEA_ID = 25211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25211Service() {
        this(new Idea25211Config());
    }

    public Idea25211Service(Idea25211Config config) {
        this.config = config != null ? config : new Idea25211Config();
