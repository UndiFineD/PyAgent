...
@Data
public class Idea25215Config {
    private String name = "idea_025215";
 ...
 */
@Slf4j
public class Idea25215Service {
    private static final int IDEA_ID = 25215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25215Service() {
        this(new Idea25215Config());
    }

    public Idea25215Service(Idea25215Config config) {
        this.config = config != null ? config : new Idea25215Config();
