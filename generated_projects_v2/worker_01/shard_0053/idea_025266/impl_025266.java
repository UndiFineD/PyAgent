...
@Data
public class Idea25266Config {
    private String name = "idea_025266";
 ...
 */
@Slf4j
public class Idea25266Service {
    private static final int IDEA_ID = 25266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25266Service() {
        this(new Idea25266Config());
    }

    public Idea25266Service(Idea25266Config config) {
        this.config = config != null ? config : new Idea25266Config();
