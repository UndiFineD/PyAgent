...
@Data
public class Idea25385Config {
    private String name = "idea_025385";
 ...
 */
@Slf4j
public class Idea25385Service {
    private static final int IDEA_ID = 25385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25385Service() {
        this(new Idea25385Config());
    }

    public Idea25385Service(Idea25385Config config) {
        this.config = config != null ? config : new Idea25385Config();
