...
@Data
public class Idea25220Config {
    private String name = "idea_025220";
 ...
 */
@Slf4j
public class Idea25220Service {
    private static final int IDEA_ID = 25220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25220Service() {
        this(new Idea25220Config());
    }

    public Idea25220Service(Idea25220Config config) {
        this.config = config != null ? config : new Idea25220Config();
