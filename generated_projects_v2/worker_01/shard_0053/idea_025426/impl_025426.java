...
@Data
public class Idea25426Config {
    private String name = "idea_025426";
 ...
 */
@Slf4j
public class Idea25426Service {
    private static final int IDEA_ID = 25426;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25426Service() {
        this(new Idea25426Config());
    }

    public Idea25426Service(Idea25426Config config) {
        this.config = config != null ? config : new Idea25426Config();
