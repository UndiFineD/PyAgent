...
@Data
public class Idea25187Config {
    private String name = "idea_025187";
 ...
 */
@Slf4j
public class Idea25187Service {
    private static final int IDEA_ID = 25187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25187Service() {
        this(new Idea25187Config());
    }

    public Idea25187Service(Idea25187Config config) {
        this.config = config != null ? config : new Idea25187Config();
