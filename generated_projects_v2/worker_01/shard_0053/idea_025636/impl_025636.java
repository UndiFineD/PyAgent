...
@Data
public class Idea25636Config {
    private String name = "idea_025636";
 ...
 */
@Slf4j
public class Idea25636Service {
    private static final int IDEA_ID = 25636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25636Service() {
        this(new Idea25636Config());
    }

    public Idea25636Service(Idea25636Config config) {
        this.config = config != null ? config : new Idea25636Config();
