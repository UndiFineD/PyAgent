...
@Data
public class Idea25355Config {
    private String name = "idea_025355";
 ...
 */
@Slf4j
public class Idea25355Service {
    private static final int IDEA_ID = 25355;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25355Service() {
        this(new Idea25355Config());
    }

    public Idea25355Service(Idea25355Config config) {
        this.config = config != null ? config : new Idea25355Config();
