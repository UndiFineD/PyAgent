...
@Data
public class Idea25508Config {
    private String name = "idea_025508";
 ...
 */
@Slf4j
public class Idea25508Service {
    private static final int IDEA_ID = 25508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25508Service() {
        this(new Idea25508Config());
    }

    public Idea25508Service(Idea25508Config config) {
        this.config = config != null ? config : new Idea25508Config();
