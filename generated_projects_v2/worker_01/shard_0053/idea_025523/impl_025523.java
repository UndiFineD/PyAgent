...
@Data
public class Idea25523Config {
    private String name = "idea_025523";
 ...
 */
@Slf4j
public class Idea25523Service {
    private static final int IDEA_ID = 25523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25523Service() {
        this(new Idea25523Config());
    }

    public Idea25523Service(Idea25523Config config) {
        this.config = config != null ? config : new Idea25523Config();
