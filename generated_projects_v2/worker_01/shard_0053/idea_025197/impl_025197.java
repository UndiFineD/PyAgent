...
@Data
public class Idea25197Config {
    private String name = "idea_025197";
 ...
 */
@Slf4j
public class Idea25197Service {
    private static final int IDEA_ID = 25197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25197Service() {
        this(new Idea25197Config());
    }

    public Idea25197Service(Idea25197Config config) {
        this.config = config != null ? config : new Idea25197Config();
