...
@Data
public class Idea25361Config {
    private String name = "idea_025361";
 ...
 */
@Slf4j
public class Idea25361Service {
    private static final int IDEA_ID = 25361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25361Service() {
        this(new Idea25361Config());
    }

    public Idea25361Service(Idea25361Config config) {
        this.config = config != null ? config : new Idea25361Config();
