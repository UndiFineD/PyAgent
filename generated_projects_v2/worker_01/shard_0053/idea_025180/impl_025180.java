...
@Data
public class Idea25180Config {
    private String name = "idea_025180";
 ...
 */
@Slf4j
public class Idea25180Service {
    private static final int IDEA_ID = 25180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25180Service() {
        this(new Idea25180Config());
    }

    public Idea25180Service(Idea25180Config config) {
        this.config = config != null ? config : new Idea25180Config();
