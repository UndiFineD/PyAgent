...
@Data
public class Idea25572Config {
    private String name = "idea_025572";
 ...
 */
@Slf4j
public class Idea25572Service {
    private static final int IDEA_ID = 25572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25572Service() {
        this(new Idea25572Config());
    }

    public Idea25572Service(Idea25572Config config) {
        this.config = config != null ? config : new Idea25572Config();
