...
@Data
public class Idea25341Config {
    private String name = "idea_025341";
 ...
 */
@Slf4j
public class Idea25341Service {
    private static final int IDEA_ID = 25341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25341Service() {
        this(new Idea25341Config());
    }

    public Idea25341Service(Idea25341Config config) {
        this.config = config != null ? config : new Idea25341Config();
