...
@Data
public class Idea25342Config {
    private String name = "idea_025342";
 ...
 */
@Slf4j
public class Idea25342Service {
    private static final int IDEA_ID = 25342;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25342Service() {
        this(new Idea25342Config());
    }

    public Idea25342Service(Idea25342Config config) {
        this.config = config != null ? config : new Idea25342Config();
