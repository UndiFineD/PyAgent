...
@Data
public class Idea25293Config {
    private String name = "idea_025293";
 ...
 */
@Slf4j
public class Idea25293Service {
    private static final int IDEA_ID = 25293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25293Service() {
        this(new Idea25293Config());
    }

    public Idea25293Service(Idea25293Config config) {
        this.config = config != null ? config : new Idea25293Config();
