...
@Data
public class Idea25287Config {
    private String name = "idea_025287";
 ...
 */
@Slf4j
public class Idea25287Service {
    private static final int IDEA_ID = 25287;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25287Service() {
        this(new Idea25287Config());
    }

    public Idea25287Service(Idea25287Config config) {
        this.config = config != null ? config : new Idea25287Config();
