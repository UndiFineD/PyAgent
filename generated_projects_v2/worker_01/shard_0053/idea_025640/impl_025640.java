...
@Data
public class Idea25640Config {
    private String name = "idea_025640";
 ...
 */
@Slf4j
public class Idea25640Service {
    private static final int IDEA_ID = 25640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25640Service() {
        this(new Idea25640Config());
    }

    public Idea25640Service(Idea25640Config config) {
        this.config = config != null ? config : new Idea25640Config();
