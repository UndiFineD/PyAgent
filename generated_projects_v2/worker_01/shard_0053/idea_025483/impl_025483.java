...
@Data
public class Idea25483Config {
    private String name = "idea_025483";
 ...
 */
@Slf4j
public class Idea25483Service {
    private static final int IDEA_ID = 25483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25483Service() {
        this(new Idea25483Config());
    }

    public Idea25483Service(Idea25483Config config) {
        this.config = config != null ? config : new Idea25483Config();
