...
@Data
public class Idea25499Config {
    private String name = "idea_025499";
 ...
 */
@Slf4j
public class Idea25499Service {
    private static final int IDEA_ID = 25499;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25499Service() {
        this(new Idea25499Config());
    }

    public Idea25499Service(Idea25499Config config) {
        this.config = config != null ? config : new Idea25499Config();
