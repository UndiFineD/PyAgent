...
@Data
public class Idea25188Config {
    private String name = "idea_025188";
 ...
 */
@Slf4j
public class Idea25188Service {
    private static final int IDEA_ID = 25188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25188Service() {
        this(new Idea25188Config());
    }

    public Idea25188Service(Idea25188Config config) {
        this.config = config != null ? config : new Idea25188Config();
