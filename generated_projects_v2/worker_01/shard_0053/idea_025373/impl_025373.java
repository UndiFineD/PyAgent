...
@Data
public class Idea25373Config {
    private String name = "idea_025373";
 ...
 */
@Slf4j
public class Idea25373Service {
    private static final int IDEA_ID = 25373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25373Service() {
        this(new Idea25373Config());
    }

    public Idea25373Service(Idea25373Config config) {
        this.config = config != null ? config : new Idea25373Config();
