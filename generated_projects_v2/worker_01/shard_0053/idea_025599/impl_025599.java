...
@Data
public class Idea25599Config {
    private String name = "idea_025599";
 ...
 */
@Slf4j
public class Idea25599Service {
    private static final int IDEA_ID = 25599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25599Service() {
        this(new Idea25599Config());
    }

    public Idea25599Service(Idea25599Config config) {
        this.config = config != null ? config : new Idea25599Config();
