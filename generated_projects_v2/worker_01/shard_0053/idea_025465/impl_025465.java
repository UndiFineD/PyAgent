...
@Data
public class Idea25465Config {
    private String name = "idea_025465";
 ...
 */
@Slf4j
public class Idea25465Service {
    private static final int IDEA_ID = 25465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25465Service() {
        this(new Idea25465Config());
    }

    public Idea25465Service(Idea25465Config config) {
        this.config = config != null ? config : new Idea25465Config();
