...
@Data
public class Idea25580Config {
    private String name = "idea_025580";
 ...
 */
@Slf4j
public class Idea25580Service {
    private static final int IDEA_ID = 25580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25580Service() {
        this(new Idea25580Config());
    }

    public Idea25580Service(Idea25580Config config) {
        this.config = config != null ? config : new Idea25580Config();
