...
@Data
public class Idea25420Config {
    private String name = "idea_025420";
 ...
 */
@Slf4j
public class Idea25420Service {
    private static final int IDEA_ID = 25420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25420Service() {
        this(new Idea25420Config());
    }

    public Idea25420Service(Idea25420Config config) {
        this.config = config != null ? config : new Idea25420Config();
