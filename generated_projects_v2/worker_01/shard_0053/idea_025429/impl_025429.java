...
@Data
public class Idea25429Config {
    private String name = "idea_025429";
 ...
 */
@Slf4j
public class Idea25429Service {
    private static final int IDEA_ID = 25429;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25429Service() {
        this(new Idea25429Config());
    }

    public Idea25429Service(Idea25429Config config) {
        this.config = config != null ? config : new Idea25429Config();
