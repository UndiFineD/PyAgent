...
@Data
public class Idea25425Config {
    private String name = "idea_025425";
 ...
 */
@Slf4j
public class Idea25425Service {
    private static final int IDEA_ID = 25425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25425Service() {
        this(new Idea25425Config());
    }

    public Idea25425Service(Idea25425Config config) {
        this.config = config != null ? config : new Idea25425Config();
