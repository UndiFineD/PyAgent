...
@Data
public class Idea25235Config {
    private String name = "idea_025235";
 ...
 */
@Slf4j
public class Idea25235Service {
    private static final int IDEA_ID = 25235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25235Service() {
        this(new Idea25235Config());
    }

    public Idea25235Service(Idea25235Config config) {
        this.config = config != null ? config : new Idea25235Config();
