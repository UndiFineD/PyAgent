...
@Data
public class Idea25267Config {
    private String name = "idea_025267";
 ...
 */
@Slf4j
public class Idea25267Service {
    private static final int IDEA_ID = 25267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25267Service() {
        this(new Idea25267Config());
    }

    public Idea25267Service(Idea25267Config config) {
        this.config = config != null ? config : new Idea25267Config();
