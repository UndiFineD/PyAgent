...
@Data
public class Idea25558Config {
    private String name = "idea_025558";
 ...
 */
@Slf4j
public class Idea25558Service {
    private static final int IDEA_ID = 25558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25558Service() {
        this(new Idea25558Config());
    }

    public Idea25558Service(Idea25558Config config) {
        this.config = config != null ? config : new Idea25558Config();
