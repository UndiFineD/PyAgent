...
@Data
public class Idea25601Config {
    private String name = "idea_025601";
 ...
 */
@Slf4j
public class Idea25601Service {
    private static final int IDEA_ID = 25601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25601Service() {
        this(new Idea25601Config());
    }

    public Idea25601Service(Idea25601Config config) {
        this.config = config != null ? config : new Idea25601Config();
