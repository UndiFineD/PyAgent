...
@Data
public class Idea25256Config {
    private String name = "idea_025256";
 ...
 */
@Slf4j
public class Idea25256Service {
    private static final int IDEA_ID = 25256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25256Service() {
        this(new Idea25256Config());
    }

    public Idea25256Service(Idea25256Config config) {
        this.config = config != null ? config : new Idea25256Config();
