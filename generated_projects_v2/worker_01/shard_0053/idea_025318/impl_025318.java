...
@Data
public class Idea25318Config {
    private String name = "idea_025318";
 ...
 */
@Slf4j
public class Idea25318Service {
    private static final int IDEA_ID = 25318;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25318Service() {
        this(new Idea25318Config());
    }

    public Idea25318Service(Idea25318Config config) {
        this.config = config != null ? config : new Idea25318Config();
