...
@Data
public class Idea25495Config {
    private String name = "idea_025495";
 ...
 */
@Slf4j
public class Idea25495Service {
    private static final int IDEA_ID = 25495;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25495Service() {
        this(new Idea25495Config());
    }

    public Idea25495Service(Idea25495Config config) {
        this.config = config != null ? config : new Idea25495Config();
