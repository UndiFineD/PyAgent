...
@Data
public class Idea25354Config {
    private String name = "idea_025354";
 ...
 */
@Slf4j
public class Idea25354Service {
    private static final int IDEA_ID = 25354;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25354Service() {
        this(new Idea25354Config());
    }

    public Idea25354Service(Idea25354Config config) {
        this.config = config != null ? config : new Idea25354Config();
