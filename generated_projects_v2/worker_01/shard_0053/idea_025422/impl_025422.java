...
@Data
public class Idea25422Config {
    private String name = "idea_025422";
 ...
 */
@Slf4j
public class Idea25422Service {
    private static final int IDEA_ID = 25422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25422Service() {
        this(new Idea25422Config());
    }

    public Idea25422Service(Idea25422Config config) {
        this.config = config != null ? config : new Idea25422Config();
