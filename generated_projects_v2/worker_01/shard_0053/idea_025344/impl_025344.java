...
@Data
public class Idea25344Config {
    private String name = "idea_025344";
 ...
 */
@Slf4j
public class Idea25344Service {
    private static final int IDEA_ID = 25344;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25344Service() {
        this(new Idea25344Config());
    }

    public Idea25344Service(Idea25344Config config) {
        this.config = config != null ? config : new Idea25344Config();
