...
@Data
public class Idea25248Config {
    private String name = "idea_025248";
 ...
 */
@Slf4j
public class Idea25248Service {
    private static final int IDEA_ID = 25248;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25248Service() {
        this(new Idea25248Config());
    }

    public Idea25248Service(Idea25248Config config) {
        this.config = config != null ? config : new Idea25248Config();
