...
@Data
public class Idea25333Config {
    private String name = "idea_025333";
 ...
 */
@Slf4j
public class Idea25333Service {
    private static final int IDEA_ID = 25333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25333Service() {
        this(new Idea25333Config());
    }

    public Idea25333Service(Idea25333Config config) {
        this.config = config != null ? config : new Idea25333Config();
