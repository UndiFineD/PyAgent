...
@Data
public class Idea25242Config {
    private String name = "idea_025242";
 ...
 */
@Slf4j
public class Idea25242Service {
    private static final int IDEA_ID = 25242;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25242Service() {
        this(new Idea25242Config());
    }

    public Idea25242Service(Idea25242Config config) {
        this.config = config != null ? config : new Idea25242Config();
