...
@Data
public class Idea25227Config {
    private String name = "idea_025227";
 ...
 */
@Slf4j
public class Idea25227Service {
    private static final int IDEA_ID = 25227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25227Service() {
        this(new Idea25227Config());
    }

    public Idea25227Service(Idea25227Config config) {
        this.config = config != null ? config : new Idea25227Config();
