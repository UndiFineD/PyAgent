...
@Data
public class Idea25281Config {
    private String name = "idea_025281";
 ...
 */
@Slf4j
public class Idea25281Service {
    private static final int IDEA_ID = 25281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25281Service() {
        this(new Idea25281Config());
    }

    public Idea25281Service(Idea25281Config config) {
        this.config = config != null ? config : new Idea25281Config();
