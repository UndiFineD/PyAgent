...
@Data
public class Idea25306Config {
    private String name = "idea_025306";
 ...
 */
@Slf4j
public class Idea25306Service {
    private static final int IDEA_ID = 25306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25306Service() {
        this(new Idea25306Config());
    }

    public Idea25306Service(Idea25306Config config) {
        this.config = config != null ? config : new Idea25306Config();
