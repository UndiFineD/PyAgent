...
@Data
public class Idea25395Config {
    private String name = "idea_025395";
 ...
 */
@Slf4j
public class Idea25395Service {
    private static final int IDEA_ID = 25395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25395Service() {
        this(new Idea25395Config());
    }

    public Idea25395Service(Idea25395Config config) {
        this.config = config != null ? config : new Idea25395Config();
