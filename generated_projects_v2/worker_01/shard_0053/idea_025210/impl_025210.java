...
@Data
public class Idea25210Config {
    private String name = "idea_025210";
 ...
 */
@Slf4j
public class Idea25210Service {
    private static final int IDEA_ID = 25210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25210Service() {
        this(new Idea25210Config());
    }

    public Idea25210Service(Idea25210Config config) {
        this.config = config != null ? config : new Idea25210Config();
