...
@Data
public class Idea25592Config {
    private String name = "idea_025592";
 ...
 */
@Slf4j
public class Idea25592Service {
    private static final int IDEA_ID = 25592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25592Service() {
        this(new Idea25592Config());
    }

    public Idea25592Service(Idea25592Config config) {
        this.config = config != null ? config : new Idea25592Config();
