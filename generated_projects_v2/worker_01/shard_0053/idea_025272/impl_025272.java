...
@Data
public class Idea25272Config {
    private String name = "idea_025272";
 ...
 */
@Slf4j
public class Idea25272Service {
    private static final int IDEA_ID = 25272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25272Service() {
        this(new Idea25272Config());
    }

    public Idea25272Service(Idea25272Config config) {
        this.config = config != null ? config : new Idea25272Config();
