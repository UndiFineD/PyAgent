...
@Data
public class Idea25593Config {
    private String name = "idea_025593";
 ...
 */
@Slf4j
public class Idea25593Service {
    private static final int IDEA_ID = 25593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25593Service() {
        this(new Idea25593Config());
    }

    public Idea25593Service(Idea25593Config config) {
        this.config = config != null ? config : new Idea25593Config();
