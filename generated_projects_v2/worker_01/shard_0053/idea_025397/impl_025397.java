...
@Data
public class Idea25397Config {
    private String name = "idea_025397";
 ...
 */
@Slf4j
public class Idea25397Service {
    private static final int IDEA_ID = 25397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25397Service() {
        this(new Idea25397Config());
    }

    public Idea25397Service(Idea25397Config config) {
        this.config = config != null ? config : new Idea25397Config();
