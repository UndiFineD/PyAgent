...
@Data
public class Idea25351Config {
    private String name = "idea_025351";
 ...
 */
@Slf4j
public class Idea25351Service {
    private static final int IDEA_ID = 25351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25351Service() {
        this(new Idea25351Config());
    }

    public Idea25351Service(Idea25351Config config) {
        this.config = config != null ? config : new Idea25351Config();
