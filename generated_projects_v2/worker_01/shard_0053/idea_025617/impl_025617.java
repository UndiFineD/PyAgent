...
@Data
public class Idea25617Config {
    private String name = "idea_025617";
 ...
 */
@Slf4j
public class Idea25617Service {
    private static final int IDEA_ID = 25617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25617Service() {
        this(new Idea25617Config());
    }

    public Idea25617Service(Idea25617Config config) {
        this.config = config != null ? config : new Idea25617Config();
