...
@Data
public class Idea25452Config {
    private String name = "idea_025452";
 ...
 */
@Slf4j
public class Idea25452Service {
    private static final int IDEA_ID = 25452;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25452Service() {
        this(new Idea25452Config());
    }

    public Idea25452Service(Idea25452Config config) {
        this.config = config != null ? config : new Idea25452Config();
