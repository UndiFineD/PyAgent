...
@Data
public class Idea25468Config {
    private String name = "idea_025468";
 ...
 */
@Slf4j
public class Idea25468Service {
    private static final int IDEA_ID = 25468;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25468Service() {
        this(new Idea25468Config());
    }

    public Idea25468Service(Idea25468Config config) {
        this.config = config != null ? config : new Idea25468Config();
