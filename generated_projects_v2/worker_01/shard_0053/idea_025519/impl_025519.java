...
@Data
public class Idea25519Config {
    private String name = "idea_025519";
 ...
 */
@Slf4j
public class Idea25519Service {
    private static final int IDEA_ID = 25519;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25519Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25519Service() {
        this(new Idea25519Config());
    }

    public Idea25519Service(Idea25519Config config) {
        this.config = config != null ? config : new Idea25519Config();
