...
@Data
public class Idea25204Config {
    private String name = "idea_025204";
 ...
 */
@Slf4j
public class Idea25204Service {
    private static final int IDEA_ID = 25204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25204Service() {
        this(new Idea25204Config());
    }

    public Idea25204Service(Idea25204Config config) {
        this.config = config != null ? config : new Idea25204Config();
