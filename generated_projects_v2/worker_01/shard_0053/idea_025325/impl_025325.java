...
@Data
public class Idea25325Config {
    private String name = "idea_025325";
 ...
 */
@Slf4j
public class Idea25325Service {
    private static final int IDEA_ID = 25325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25325Service() {
        this(new Idea25325Config());
    }

    public Idea25325Service(Idea25325Config config) {
        this.config = config != null ? config : new Idea25325Config();
