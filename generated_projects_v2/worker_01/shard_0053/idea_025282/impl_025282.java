...
@Data
public class Idea25282Config {
    private String name = "idea_025282";
 ...
 */
@Slf4j
public class Idea25282Service {
    private static final int IDEA_ID = 25282;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25282Service() {
        this(new Idea25282Config());
    }

    public Idea25282Service(Idea25282Config config) {
        this.config = config != null ? config : new Idea25282Config();
