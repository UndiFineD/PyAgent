...
@Data
public class Idea25292Config {
    private String name = "idea_025292";
 ...
 */
@Slf4j
public class Idea25292Service {
    private static final int IDEA_ID = 25292;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25292Service() {
        this(new Idea25292Config());
    }

    public Idea25292Service(Idea25292Config config) {
        this.config = config != null ? config : new Idea25292Config();
