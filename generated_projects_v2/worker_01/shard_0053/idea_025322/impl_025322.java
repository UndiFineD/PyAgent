...
@Data
public class Idea25322Config {
    private String name = "idea_025322";
 ...
 */
@Slf4j
public class Idea25322Service {
    private static final int IDEA_ID = 25322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25322Service() {
        this(new Idea25322Config());
    }

    public Idea25322Service(Idea25322Config config) {
        this.config = config != null ? config : new Idea25322Config();
