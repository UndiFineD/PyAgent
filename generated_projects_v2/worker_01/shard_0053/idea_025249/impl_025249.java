...
@Data
public class Idea25249Config {
    private String name = "idea_025249";
 ...
 */
@Slf4j
public class Idea25249Service {
    private static final int IDEA_ID = 25249;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25249Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25249Service() {
        this(new Idea25249Config());
    }

    public Idea25249Service(Idea25249Config config) {
        this.config = config != null ? config : new Idea25249Config();
