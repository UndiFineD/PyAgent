...
@Data
public class Idea25444Config {
    private String name = "idea_025444";
 ...
 */
@Slf4j
public class Idea25444Service {
    private static final int IDEA_ID = 25444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25444Service() {
        this(new Idea25444Config());
    }

    public Idea25444Service(Idea25444Config config) {
        this.config = config != null ? config : new Idea25444Config();
