...
@Data
public class Idea25585Config {
    private String name = "idea_025585";
 ...
 */
@Slf4j
public class Idea25585Service {
    private static final int IDEA_ID = 25585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25585Service() {
        this(new Idea25585Config());
    }

    public Idea25585Service(Idea25585Config config) {
        this.config = config != null ? config : new Idea25585Config();
