...
@Data
public class Idea25416Config {
    private String name = "idea_025416";
 ...
 */
@Slf4j
public class Idea25416Service {
    private static final int IDEA_ID = 25416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25416Service() {
        this(new Idea25416Config());
    }

    public Idea25416Service(Idea25416Config config) {
        this.config = config != null ? config : new Idea25416Config();
