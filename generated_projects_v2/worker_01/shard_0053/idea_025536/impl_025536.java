...
@Data
public class Idea25536Config {
    private String name = "idea_025536";
 ...
 */
@Slf4j
public class Idea25536Service {
    private static final int IDEA_ID = 25536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25536Service() {
        this(new Idea25536Config());
    }

    public Idea25536Service(Idea25536Config config) {
        this.config = config != null ? config : new Idea25536Config();
