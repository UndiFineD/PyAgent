...
@Data
public class Idea25200Config {
    private String name = "idea_025200";
 ...
 */
@Slf4j
public class Idea25200Service {
    private static final int IDEA_ID = 25200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25200Service() {
        this(new Idea25200Config());
    }

    public Idea25200Service(Idea25200Config config) {
        this.config = config != null ? config : new Idea25200Config();
