...
@Data
public class Idea25597Config {
    private String name = "idea_025597";
 ...
 */
@Slf4j
public class Idea25597Service {
    private static final int IDEA_ID = 25597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25597Service() {
        this(new Idea25597Config());
    }

    public Idea25597Service(Idea25597Config config) {
        this.config = config != null ? config : new Idea25597Config();
