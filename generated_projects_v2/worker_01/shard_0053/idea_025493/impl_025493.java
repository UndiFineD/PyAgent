...
@Data
public class Idea25493Config {
    private String name = "idea_025493";
 ...
 */
@Slf4j
public class Idea25493Service {
    private static final int IDEA_ID = 25493;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25493Service() {
        this(new Idea25493Config());
    }

    public Idea25493Service(Idea25493Config config) {
        this.config = config != null ? config : new Idea25493Config();
