...
@Data
public class Idea25338Config {
    private String name = "idea_025338";
 ...
 */
@Slf4j
public class Idea25338Service {
    private static final int IDEA_ID = 25338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25338Service() {
        this(new Idea25338Config());
    }

    public Idea25338Service(Idea25338Config config) {
        this.config = config != null ? config : new Idea25338Config();
