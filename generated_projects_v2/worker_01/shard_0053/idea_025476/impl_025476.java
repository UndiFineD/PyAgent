...
@Data
public class Idea25476Config {
    private String name = "idea_025476";
 ...
 */
@Slf4j
public class Idea25476Service {
    private static final int IDEA_ID = 25476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25476Service() {
        this(new Idea25476Config());
    }

    public Idea25476Service(Idea25476Config config) {
        this.config = config != null ? config : new Idea25476Config();
