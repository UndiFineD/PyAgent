...
@Data
public class Idea25504Config {
    private String name = "idea_025504";
 ...
 */
@Slf4j
public class Idea25504Service {
    private static final int IDEA_ID = 25504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25504Service() {
        this(new Idea25504Config());
    }

    public Idea25504Service(Idea25504Config config) {
        this.config = config != null ? config : new Idea25504Config();
