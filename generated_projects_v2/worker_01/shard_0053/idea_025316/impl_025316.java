...
@Data
public class Idea25316Config {
    private String name = "idea_025316";
 ...
 */
@Slf4j
public class Idea25316Service {
    private static final int IDEA_ID = 25316;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25316Service() {
        this(new Idea25316Config());
    }

    public Idea25316Service(Idea25316Config config) {
        this.config = config != null ? config : new Idea25316Config();
