...
@Data
public class Idea25241Config {
    private String name = "idea_025241";
 ...
 */
@Slf4j
public class Idea25241Service {
    private static final int IDEA_ID = 25241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25241Service() {
        this(new Idea25241Config());
    }

    public Idea25241Service(Idea25241Config config) {
        this.config = config != null ? config : new Idea25241Config();
