...
@Data
public class Idea25390Config {
    private String name = "idea_025390";
 ...
 */
@Slf4j
public class Idea25390Service {
    private static final int IDEA_ID = 25390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25390Service() {
        this(new Idea25390Config());
    }

    public Idea25390Service(Idea25390Config config) {
        this.config = config != null ? config : new Idea25390Config();
