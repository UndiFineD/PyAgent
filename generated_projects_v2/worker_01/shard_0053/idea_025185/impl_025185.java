...
@Data
public class Idea25185Config {
    private String name = "idea_025185";
 ...
 */
@Slf4j
public class Idea25185Service {
    private static final int IDEA_ID = 25185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25185Service() {
        this(new Idea25185Config());
    }

    public Idea25185Service(Idea25185Config config) {
        this.config = config != null ? config : new Idea25185Config();
