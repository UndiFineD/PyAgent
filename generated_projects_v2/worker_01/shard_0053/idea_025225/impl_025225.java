...
@Data
public class Idea25225Config {
    private String name = "idea_025225";
 ...
 */
@Slf4j
public class Idea25225Service {
    private static final int IDEA_ID = 25225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25225Service() {
        this(new Idea25225Config());
    }

    public Idea25225Service(Idea25225Config config) {
        this.config = config != null ? config : new Idea25225Config();
