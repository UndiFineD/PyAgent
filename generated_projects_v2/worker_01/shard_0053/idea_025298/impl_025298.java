...
@Data
public class Idea25298Config {
    private String name = "idea_025298";
 ...
 */
@Slf4j
public class Idea25298Service {
    private static final int IDEA_ID = 25298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25298Service() {
        this(new Idea25298Config());
    }

    public Idea25298Service(Idea25298Config config) {
        this.config = config != null ? config : new Idea25298Config();
