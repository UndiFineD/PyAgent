...
@Data
public class Idea25494Config {
    private String name = "idea_025494";
 ...
 */
@Slf4j
public class Idea25494Service {
    private static final int IDEA_ID = 25494;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25494Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25494Service() {
        this(new Idea25494Config());
    }

    public Idea25494Service(Idea25494Config config) {
        this.config = config != null ? config : new Idea25494Config();
