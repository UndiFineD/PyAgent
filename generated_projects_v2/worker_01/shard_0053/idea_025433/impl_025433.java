...
@Data
public class Idea25433Config {
    private String name = "idea_025433";
 ...
 */
@Slf4j
public class Idea25433Service {
    private static final int IDEA_ID = 25433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25433Service() {
        this(new Idea25433Config());
    }

    public Idea25433Service(Idea25433Config config) {
        this.config = config != null ? config : new Idea25433Config();
