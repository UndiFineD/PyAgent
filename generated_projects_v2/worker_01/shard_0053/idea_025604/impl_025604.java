...
@Data
public class Idea25604Config {
    private String name = "idea_025604";
 ...
 */
@Slf4j
public class Idea25604Service {
    private static final int IDEA_ID = 25604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25604Service() {
        this(new Idea25604Config());
    }

    public Idea25604Service(Idea25604Config config) {
        this.config = config != null ? config : new Idea25604Config();
