...
@Data
public class Idea25586Config {
    private String name = "idea_025586";
 ...
 */
@Slf4j
public class Idea25586Service {
    private static final int IDEA_ID = 25586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25586Service() {
        this(new Idea25586Config());
    }

    public Idea25586Service(Idea25586Config config) {
        this.config = config != null ? config : new Idea25586Config();
