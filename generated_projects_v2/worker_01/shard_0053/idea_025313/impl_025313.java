...
@Data
public class Idea25313Config {
    private String name = "idea_025313";
 ...
 */
@Slf4j
public class Idea25313Service {
    private static final int IDEA_ID = 25313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25313Service() {
        this(new Idea25313Config());
    }

    public Idea25313Service(Idea25313Config config) {
        this.config = config != null ? config : new Idea25313Config();
