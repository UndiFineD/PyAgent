...
@Data
public class Idea25399Config {
    private String name = "idea_025399";
 ...
 */
@Slf4j
public class Idea25399Service {
    private static final int IDEA_ID = 25399;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25399Service() {
        this(new Idea25399Config());
    }

    public Idea25399Service(Idea25399Config config) {
        this.config = config != null ? config : new Idea25399Config();
