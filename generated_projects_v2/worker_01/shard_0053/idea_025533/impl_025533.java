...
@Data
public class Idea25533Config {
    private String name = "idea_025533";
 ...
 */
@Slf4j
public class Idea25533Service {
    private static final int IDEA_ID = 25533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25533Service() {
        this(new Idea25533Config());
    }

    public Idea25533Service(Idea25533Config config) {
        this.config = config != null ? config : new Idea25533Config();
