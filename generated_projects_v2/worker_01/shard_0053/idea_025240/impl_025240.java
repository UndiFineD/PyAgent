...
@Data
public class Idea25240Config {
    private String name = "idea_025240";
 ...
 */
@Slf4j
public class Idea25240Service {
    private static final int IDEA_ID = 25240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25240Service() {
        this(new Idea25240Config());
    }

    public Idea25240Service(Idea25240Config config) {
        this.config = config != null ? config : new Idea25240Config();
