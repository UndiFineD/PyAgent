...
@Data
public class Idea25310Config {
    private String name = "idea_025310";
 ...
 */
@Slf4j
public class Idea25310Service {
    private static final int IDEA_ID = 25310;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25310Service() {
        this(new Idea25310Config());
    }

    public Idea25310Service(Idea25310Config config) {
        this.config = config != null ? config : new Idea25310Config();
