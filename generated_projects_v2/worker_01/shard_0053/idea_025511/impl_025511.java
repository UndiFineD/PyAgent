...
@Data
public class Idea25511Config {
    private String name = "idea_025511";
 ...
 */
@Slf4j
public class Idea25511Service {
    private static final int IDEA_ID = 25511;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25511Service() {
        this(new Idea25511Config());
    }

    public Idea25511Service(Idea25511Config config) {
        this.config = config != null ? config : new Idea25511Config();
