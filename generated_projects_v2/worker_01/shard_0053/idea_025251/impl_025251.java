...
@Data
public class Idea25251Config {
    private String name = "idea_025251";
 ...
 */
@Slf4j
public class Idea25251Service {
    private static final int IDEA_ID = 25251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25251Service() {
        this(new Idea25251Config());
    }

    public Idea25251Service(Idea25251Config config) {
        this.config = config != null ? config : new Idea25251Config();
