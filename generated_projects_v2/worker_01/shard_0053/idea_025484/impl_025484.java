...
@Data
public class Idea25484Config {
    private String name = "idea_025484";
 ...
 */
@Slf4j
public class Idea25484Service {
    private static final int IDEA_ID = 25484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25484Service() {
        this(new Idea25484Config());
    }

    public Idea25484Service(Idea25484Config config) {
        this.config = config != null ? config : new Idea25484Config();
