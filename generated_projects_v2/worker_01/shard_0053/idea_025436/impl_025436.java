...
@Data
public class Idea25436Config {
    private String name = "idea_025436";
 ...
 */
@Slf4j
public class Idea25436Service {
    private static final int IDEA_ID = 25436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25436Service() {
        this(new Idea25436Config());
    }

    public Idea25436Service(Idea25436Config config) {
        this.config = config != null ? config : new Idea25436Config();
