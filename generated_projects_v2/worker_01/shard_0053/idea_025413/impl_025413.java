...
@Data
public class Idea25413Config {
    private String name = "idea_025413";
 ...
 */
@Slf4j
public class Idea25413Service {
    private static final int IDEA_ID = 25413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25413Service() {
        this(new Idea25413Config());
    }

    public Idea25413Service(Idea25413Config config) {
        this.config = config != null ? config : new Idea25413Config();
