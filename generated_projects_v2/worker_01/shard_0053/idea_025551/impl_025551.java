...
@Data
public class Idea25551Config {
    private String name = "idea_025551";
 ...
 */
@Slf4j
public class Idea25551Service {
    private static final int IDEA_ID = 25551;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25551Service() {
        this(new Idea25551Config());
    }

    public Idea25551Service(Idea25551Config config) {
        this.config = config != null ? config : new Idea25551Config();
