...
@Data
public class Idea25557Config {
    private String name = "idea_025557";
 ...
 */
@Slf4j
public class Idea25557Service {
    private static final int IDEA_ID = 25557;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25557Service() {
        this(new Idea25557Config());
    }

    public Idea25557Service(Idea25557Config config) {
        this.config = config != null ? config : new Idea25557Config();
