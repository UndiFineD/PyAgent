...
@Data
public class Idea25285Config {
    private String name = "idea_025285";
 ...
 */
@Slf4j
public class Idea25285Service {
    private static final int IDEA_ID = 25285;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25285Service() {
        this(new Idea25285Config());
    }

    public Idea25285Service(Idea25285Config config) {
        this.config = config != null ? config : new Idea25285Config();
