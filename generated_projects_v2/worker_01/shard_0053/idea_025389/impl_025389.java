...
@Data
public class Idea25389Config {
    private String name = "idea_025389";
 ...
 */
@Slf4j
public class Idea25389Service {
    private static final int IDEA_ID = 25389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25389Service() {
        this(new Idea25389Config());
    }

    public Idea25389Service(Idea25389Config config) {
        this.config = config != null ? config : new Idea25389Config();
