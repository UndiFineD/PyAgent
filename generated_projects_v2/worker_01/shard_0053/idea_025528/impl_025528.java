...
@Data
public class Idea25528Config {
    private String name = "idea_025528";
 ...
 */
@Slf4j
public class Idea25528Service {
    private static final int IDEA_ID = 25528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25528Service() {
        this(new Idea25528Config());
    }

    public Idea25528Service(Idea25528Config config) {
        this.config = config != null ? config : new Idea25528Config();
