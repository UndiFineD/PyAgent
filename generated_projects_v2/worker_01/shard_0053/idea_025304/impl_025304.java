...
@Data
public class Idea25304Config {
    private String name = "idea_025304";
 ...
 */
@Slf4j
public class Idea25304Service {
    private static final int IDEA_ID = 25304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25304Service() {
        this(new Idea25304Config());
    }

    public Idea25304Service(Idea25304Config config) {
        this.config = config != null ? config : new Idea25304Config();
