...
@Data
public class Idea25634Config {
    private String name = "idea_025634";
 ...
 */
@Slf4j
public class Idea25634Service {
    private static final int IDEA_ID = 25634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25634Service() {
        this(new Idea25634Config());
    }

    public Idea25634Service(Idea25634Config config) {
        this.config = config != null ? config : new Idea25634Config();
