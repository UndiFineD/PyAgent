...
@Data
public class Idea25458Config {
    private String name = "idea_025458";
 ...
 */
@Slf4j
public class Idea25458Service {
    private static final int IDEA_ID = 25458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25458Service() {
        this(new Idea25458Config());
    }

    public Idea25458Service(Idea25458Config config) {
        this.config = config != null ? config : new Idea25458Config();
