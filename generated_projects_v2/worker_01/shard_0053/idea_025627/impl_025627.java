...
@Data
public class Idea25627Config {
    private String name = "idea_025627";
 ...
 */
@Slf4j
public class Idea25627Service {
    private static final int IDEA_ID = 25627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25627Service() {
        this(new Idea25627Config());
    }

    public Idea25627Service(Idea25627Config config) {
        this.config = config != null ? config : new Idea25627Config();
