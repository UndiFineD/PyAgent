...
@Data
public class Idea25467Config {
    private String name = "idea_025467";
 ...
 */
@Slf4j
public class Idea25467Service {
    private static final int IDEA_ID = 25467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25467Service() {
        this(new Idea25467Config());
    }

    public Idea25467Service(Idea25467Config config) {
        this.config = config != null ? config : new Idea25467Config();
