...
@Data
public class Idea25356Config {
    private String name = "idea_025356";
 ...
 */
@Slf4j
public class Idea25356Service {
    private static final int IDEA_ID = 25356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25356Service() {
        this(new Idea25356Config());
    }

    public Idea25356Service(Idea25356Config config) {
        this.config = config != null ? config : new Idea25356Config();
