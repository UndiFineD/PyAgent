...
@Data
public class Idea25603Config {
    private String name = "idea_025603";
 ...
 */
@Slf4j
public class Idea25603Service {
    private static final int IDEA_ID = 25603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25603Service() {
        this(new Idea25603Config());
    }

    public Idea25603Service(Idea25603Config config) {
        this.config = config != null ? config : new Idea25603Config();
