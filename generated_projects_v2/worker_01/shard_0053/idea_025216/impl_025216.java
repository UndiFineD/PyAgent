...
@Data
public class Idea25216Config {
    private String name = "idea_025216";
 ...
 */
@Slf4j
public class Idea25216Service {
    private static final int IDEA_ID = 25216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25216Service() {
        this(new Idea25216Config());
    }

    public Idea25216Service(Idea25216Config config) {
        this.config = config != null ? config : new Idea25216Config();
