...
@Data
public class Idea25288Config {
    private String name = "idea_025288";
 ...
 */
@Slf4j
public class Idea25288Service {
    private static final int IDEA_ID = 25288;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25288Service() {
        this(new Idea25288Config());
    }

    public Idea25288Service(Idea25288Config config) {
        this.config = config != null ? config : new Idea25288Config();
