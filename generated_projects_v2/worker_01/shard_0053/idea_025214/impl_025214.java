...
@Data
public class Idea25214Config {
    private String name = "idea_025214";
 ...
 */
@Slf4j
public class Idea25214Service {
    private static final int IDEA_ID = 25214;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25214Service() {
        this(new Idea25214Config());
    }

    public Idea25214Service(Idea25214Config config) {
        this.config = config != null ? config : new Idea25214Config();
