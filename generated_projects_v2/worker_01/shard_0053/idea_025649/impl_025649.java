...
@Data
public class Idea25649Config {
    private String name = "idea_025649";
 ...
 */
@Slf4j
public class Idea25649Service {
    private static final int IDEA_ID = 25649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25649Service() {
        this(new Idea25649Config());
    }

    public Idea25649Service(Idea25649Config config) {
        this.config = config != null ? config : new Idea25649Config();
