...
@Data
public class Idea25605Config {
    private String name = "idea_025605";
 ...
 */
@Slf4j
public class Idea25605Service {
    private static final int IDEA_ID = 25605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25605Service() {
        this(new Idea25605Config());
    }

    public Idea25605Service(Idea25605Config config) {
        this.config = config != null ? config : new Idea25605Config();
