...
@Data
public class Idea25632Config {
    private String name = "idea_025632";
 ...
 */
@Slf4j
public class Idea25632Service {
    private static final int IDEA_ID = 25632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25632Service() {
        this(new Idea25632Config());
    }

    public Idea25632Service(Idea25632Config config) {
        this.config = config != null ? config : new Idea25632Config();
