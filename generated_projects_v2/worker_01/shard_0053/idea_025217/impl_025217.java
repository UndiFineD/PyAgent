...
@Data
public class Idea25217Config {
    private String name = "idea_025217";
 ...
 */
@Slf4j
public class Idea25217Service {
    private static final int IDEA_ID = 25217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25217Service() {
        this(new Idea25217Config());
    }

    public Idea25217Service(Idea25217Config config) {
        this.config = config != null ? config : new Idea25217Config();
