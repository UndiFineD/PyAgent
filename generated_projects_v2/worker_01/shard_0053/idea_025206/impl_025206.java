...
@Data
public class Idea25206Config {
    private String name = "idea_025206";
 ...
 */
@Slf4j
public class Idea25206Service {
    private static final int IDEA_ID = 25206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25206Service() {
        this(new Idea25206Config());
    }

    public Idea25206Service(Idea25206Config config) {
        this.config = config != null ? config : new Idea25206Config();
