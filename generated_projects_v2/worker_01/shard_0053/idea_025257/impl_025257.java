...
@Data
public class Idea25257Config {
    private String name = "idea_025257";
 ...
 */
@Slf4j
public class Idea25257Service {
    private static final int IDEA_ID = 25257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25257Service() {
        this(new Idea25257Config());
    }

    public Idea25257Service(Idea25257Config config) {
        this.config = config != null ? config : new Idea25257Config();
