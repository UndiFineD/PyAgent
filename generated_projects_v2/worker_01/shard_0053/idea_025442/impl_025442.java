...
@Data
public class Idea25442Config {
    private String name = "idea_025442";
 ...
 */
@Slf4j
public class Idea25442Service {
    private static final int IDEA_ID = 25442;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25442Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25442Service() {
        this(new Idea25442Config());
    }

    public Idea25442Service(Idea25442Config config) {
        this.config = config != null ? config : new Idea25442Config();
