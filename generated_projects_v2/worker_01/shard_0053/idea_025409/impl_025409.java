...
@Data
public class Idea25409Config {
    private String name = "idea_025409";
 ...
 */
@Slf4j
public class Idea25409Service {
    private static final int IDEA_ID = 25409;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25409Service() {
        this(new Idea25409Config());
    }

    public Idea25409Service(Idea25409Config config) {
        this.config = config != null ? config : new Idea25409Config();
