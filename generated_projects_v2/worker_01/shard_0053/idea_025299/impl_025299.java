...
@Data
public class Idea25299Config {
    private String name = "idea_025299";
 ...
 */
@Slf4j
public class Idea25299Service {
    private static final int IDEA_ID = 25299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25299Service() {
        this(new Idea25299Config());
    }

    public Idea25299Service(Idea25299Config config) {
        this.config = config != null ? config : new Idea25299Config();
