...
@Data
public class Idea25549Config {
    private String name = "idea_025549";
 ...
 */
@Slf4j
public class Idea25549Service {
    private static final int IDEA_ID = 25549;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25549Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25549Service() {
        this(new Idea25549Config());
    }

    public Idea25549Service(Idea25549Config config) {
        this.config = config != null ? config : new Idea25549Config();
