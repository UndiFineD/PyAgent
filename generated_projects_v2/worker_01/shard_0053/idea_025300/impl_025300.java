...
@Data
public class Idea25300Config {
    private String name = "idea_025300";
 ...
 */
@Slf4j
public class Idea25300Service {
    private static final int IDEA_ID = 25300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25300Service() {
        this(new Idea25300Config());
    }

    public Idea25300Service(Idea25300Config config) {
        this.config = config != null ? config : new Idea25300Config();
