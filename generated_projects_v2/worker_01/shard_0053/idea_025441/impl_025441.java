...
@Data
public class Idea25441Config {
    private String name = "idea_025441";
 ...
 */
@Slf4j
public class Idea25441Service {
    private static final int IDEA_ID = 25441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea25441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea25441Service() {
        this(new Idea25441Config());
    }

    public Idea25441Service(Idea25441Config config) {
        this.config = config != null ? config : new Idea25441Config();
