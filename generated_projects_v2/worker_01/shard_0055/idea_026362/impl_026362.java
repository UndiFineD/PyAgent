...
@Data
public class Idea26362Config {
    private String name = "idea_026362";
 ...
 */
@Slf4j
public class Idea26362Service {
    private static final int IDEA_ID = 26362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26362Service() {
        this(new Idea26362Config());
    }

    public Idea26362Service(Idea26362Config config) {
        this.config = config != null ? config : new Idea26362Config();
