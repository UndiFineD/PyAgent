...
@Data
public class Idea26502Config {
    private String name = "idea_026502";
 ...
 */
@Slf4j
public class Idea26502Service {
    private static final int IDEA_ID = 26502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26502Service() {
        this(new Idea26502Config());
    }

    public Idea26502Service(Idea26502Config config) {
        this.config = config != null ? config : new Idea26502Config();
