...
@Data
public class Idea26395Config {
    private String name = "idea_026395";
 ...
 */
@Slf4j
public class Idea26395Service {
    private static final int IDEA_ID = 26395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26395Service() {
        this(new Idea26395Config());
    }

    public Idea26395Service(Idea26395Config config) {
        this.config = config != null ? config : new Idea26395Config();
