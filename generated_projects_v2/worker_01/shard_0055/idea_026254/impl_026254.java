...
@Data
public class Idea26254Config {
    private String name = "idea_026254";
 ...
 */
@Slf4j
public class Idea26254Service {
    private static final int IDEA_ID = 26254;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26254Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26254Service() {
        this(new Idea26254Config());
    }

    public Idea26254Service(Idea26254Config config) {
        this.config = config != null ? config : new Idea26254Config();
