...
@Data
public class Idea26551Config {
    private String name = "idea_026551";
 ...
 */
@Slf4j
public class Idea26551Service {
    private static final int IDEA_ID = 26551;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26551Service() {
        this(new Idea26551Config());
    }

    public Idea26551Service(Idea26551Config config) {
        this.config = config != null ? config : new Idea26551Config();
