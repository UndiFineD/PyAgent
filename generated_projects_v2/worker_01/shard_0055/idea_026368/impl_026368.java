...
@Data
public class Idea26368Config {
    private String name = "idea_026368";
 ...
 */
@Slf4j
public class Idea26368Service {
    private static final int IDEA_ID = 26368;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26368Service() {
        this(new Idea26368Config());
    }

    public Idea26368Service(Idea26368Config config) {
        this.config = config != null ? config : new Idea26368Config();
