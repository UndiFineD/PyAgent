...
@Data
public class Idea26198Config {
    private String name = "idea_026198";
 ...
 */
@Slf4j
public class Idea26198Service {
    private static final int IDEA_ID = 26198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26198Service() {
        this(new Idea26198Config());
    }

    public Idea26198Service(Idea26198Config config) {
        this.config = config != null ? config : new Idea26198Config();
