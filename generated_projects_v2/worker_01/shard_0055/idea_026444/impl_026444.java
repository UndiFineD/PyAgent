...
@Data
public class Idea26444Config {
    private String name = "idea_026444";
 ...
 */
@Slf4j
public class Idea26444Service {
    private static final int IDEA_ID = 26444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26444Service() {
        this(new Idea26444Config());
    }

    public Idea26444Service(Idea26444Config config) {
        this.config = config != null ? config : new Idea26444Config();
