...
@Data
public class Idea26223Config {
    private String name = "idea_026223";
 ...
 */
@Slf4j
public class Idea26223Service {
    private static final int IDEA_ID = 26223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26223Service() {
        this(new Idea26223Config());
    }

    public Idea26223Service(Idea26223Config config) {
        this.config = config != null ? config : new Idea26223Config();
