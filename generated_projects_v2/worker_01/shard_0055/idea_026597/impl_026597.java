...
@Data
public class Idea26597Config {
    private String name = "idea_026597";
 ...
 */
@Slf4j
public class Idea26597Service {
    private static final int IDEA_ID = 26597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26597Service() {
        this(new Idea26597Config());
    }

    public Idea26597Service(Idea26597Config config) {
        this.config = config != null ? config : new Idea26597Config();
