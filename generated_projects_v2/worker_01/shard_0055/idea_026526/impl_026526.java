...
@Data
public class Idea26526Config {
    private String name = "idea_026526";
 ...
 */
@Slf4j
public class Idea26526Service {
    private static final int IDEA_ID = 26526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26526Service() {
        this(new Idea26526Config());
    }

    public Idea26526Service(Idea26526Config config) {
        this.config = config != null ? config : new Idea26526Config();
