...
@Data
public class Idea26352Config {
    private String name = "idea_026352";
 ...
 */
@Slf4j
public class Idea26352Service {
    private static final int IDEA_ID = 26352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26352Service() {
        this(new Idea26352Config());
    }

    public Idea26352Service(Idea26352Config config) {
        this.config = config != null ? config : new Idea26352Config();
