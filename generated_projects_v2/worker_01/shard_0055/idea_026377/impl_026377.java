...
@Data
public class Idea26377Config {
    private String name = "idea_026377";
 ...
 */
@Slf4j
public class Idea26377Service {
    private static final int IDEA_ID = 26377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26377Service() {
        this(new Idea26377Config());
    }

    public Idea26377Service(Idea26377Config config) {
        this.config = config != null ? config : new Idea26377Config();
