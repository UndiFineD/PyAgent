...
@Data
public class Idea26344Config {
    private String name = "idea_026344";
 ...
 */
@Slf4j
public class Idea26344Service {
    private static final int IDEA_ID = 26344;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26344Service() {
        this(new Idea26344Config());
    }

    public Idea26344Service(Idea26344Config config) {
        this.config = config != null ? config : new Idea26344Config();
