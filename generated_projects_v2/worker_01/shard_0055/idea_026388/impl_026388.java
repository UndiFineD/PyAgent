...
@Data
public class Idea26388Config {
    private String name = "idea_026388";
 ...
 */
@Slf4j
public class Idea26388Service {
    private static final int IDEA_ID = 26388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26388Service() {
        this(new Idea26388Config());
    }

    public Idea26388Service(Idea26388Config config) {
        this.config = config != null ? config : new Idea26388Config();
