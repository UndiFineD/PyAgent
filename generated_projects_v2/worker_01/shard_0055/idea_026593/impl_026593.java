...
@Data
public class Idea26593Config {
    private String name = "idea_026593";
 ...
 */
@Slf4j
public class Idea26593Service {
    private static final int IDEA_ID = 26593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26593Service() {
        this(new Idea26593Config());
    }

    public Idea26593Service(Idea26593Config config) {
        this.config = config != null ? config : new Idea26593Config();
