...
@Data
public class Idea26419Config {
    private String name = "idea_026419";
 ...
 */
@Slf4j
public class Idea26419Service {
    private static final int IDEA_ID = 26419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26419Service() {
        this(new Idea26419Config());
    }

    public Idea26419Service(Idea26419Config config) {
        this.config = config != null ? config : new Idea26419Config();
