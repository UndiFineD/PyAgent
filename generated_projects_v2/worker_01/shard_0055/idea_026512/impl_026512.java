...
@Data
public class Idea26512Config {
    private String name = "idea_026512";
 ...
 */
@Slf4j
public class Idea26512Service {
    private static final int IDEA_ID = 26512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26512Service() {
        this(new Idea26512Config());
    }

    public Idea26512Service(Idea26512Config config) {
        this.config = config != null ? config : new Idea26512Config();
