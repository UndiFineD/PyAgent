...
@Data
public class Idea26543Config {
    private String name = "idea_026543";
 ...
 */
@Slf4j
public class Idea26543Service {
    private static final int IDEA_ID = 26543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26543Service() {
        this(new Idea26543Config());
    }

    public Idea26543Service(Idea26543Config config) {
        this.config = config != null ? config : new Idea26543Config();
