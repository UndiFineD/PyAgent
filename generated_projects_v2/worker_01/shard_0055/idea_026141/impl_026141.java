...
@Data
public class Idea26141Config {
    private String name = "idea_026141";
 ...
 */
@Slf4j
public class Idea26141Service {
    private static final int IDEA_ID = 26141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26141Service() {
        this(new Idea26141Config());
    }

    public Idea26141Service(Idea26141Config config) {
        this.config = config != null ? config : new Idea26141Config();
