...
@Data
public class Idea26428Config {
    private String name = "idea_026428";
 ...
 */
@Slf4j
public class Idea26428Service {
    private static final int IDEA_ID = 26428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26428Service() {
        this(new Idea26428Config());
    }

    public Idea26428Service(Idea26428Config config) {
        this.config = config != null ? config : new Idea26428Config();
