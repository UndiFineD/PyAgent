...
@Data
public class Idea26247Config {
    private String name = "idea_026247";
 ...
 */
@Slf4j
public class Idea26247Service {
    private static final int IDEA_ID = 26247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26247Service() {
        this(new Idea26247Config());
    }

    public Idea26247Service(Idea26247Config config) {
        this.config = config != null ? config : new Idea26247Config();
