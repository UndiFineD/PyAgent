...
@Data
public class Idea26577Config {
    private String name = "idea_026577";
 ...
 */
@Slf4j
public class Idea26577Service {
    private static final int IDEA_ID = 26577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26577Service() {
        this(new Idea26577Config());
    }

    public Idea26577Service(Idea26577Config config) {
        this.config = config != null ? config : new Idea26577Config();
