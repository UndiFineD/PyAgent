...
@Data
public class Idea26557Config {
    private String name = "idea_026557";
 ...
 */
@Slf4j
public class Idea26557Service {
    private static final int IDEA_ID = 26557;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26557Service() {
        this(new Idea26557Config());
    }

    public Idea26557Service(Idea26557Config config) {
        this.config = config != null ? config : new Idea26557Config();
