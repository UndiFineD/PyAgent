...
@Data
public class Idea26266Config {
    private String name = "idea_026266";
 ...
 */
@Slf4j
public class Idea26266Service {
    private static final int IDEA_ID = 26266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26266Service() {
        this(new Idea26266Config());
    }

    public Idea26266Service(Idea26266Config config) {
        this.config = config != null ? config : new Idea26266Config();
