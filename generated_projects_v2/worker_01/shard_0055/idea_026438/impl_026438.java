...
@Data
public class Idea26438Config {
    private String name = "idea_026438";
 ...
 */
@Slf4j
public class Idea26438Service {
    private static final int IDEA_ID = 26438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26438Service() {
        this(new Idea26438Config());
    }

    public Idea26438Service(Idea26438Config config) {
        this.config = config != null ? config : new Idea26438Config();
