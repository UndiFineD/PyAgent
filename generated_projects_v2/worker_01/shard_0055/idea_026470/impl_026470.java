...
@Data
public class Idea26470Config {
    private String name = "idea_026470";
 ...
 */
@Slf4j
public class Idea26470Service {
    private static final int IDEA_ID = 26470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26470Service() {
        this(new Idea26470Config());
    }

    public Idea26470Service(Idea26470Config config) {
        this.config = config != null ? config : new Idea26470Config();
