...
@Data
public class Idea26555Config {
    private String name = "idea_026555";
 ...
 */
@Slf4j
public class Idea26555Service {
    private static final int IDEA_ID = 26555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26555Service() {
        this(new Idea26555Config());
    }

    public Idea26555Service(Idea26555Config config) {
        this.config = config != null ? config : new Idea26555Config();
