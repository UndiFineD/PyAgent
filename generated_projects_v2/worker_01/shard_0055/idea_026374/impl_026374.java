...
@Data
public class Idea26374Config {
    private String name = "idea_026374";
 ...
 */
@Slf4j
public class Idea26374Service {
    private static final int IDEA_ID = 26374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26374Service() {
        this(new Idea26374Config());
    }

    public Idea26374Service(Idea26374Config config) {
        this.config = config != null ? config : new Idea26374Config();
