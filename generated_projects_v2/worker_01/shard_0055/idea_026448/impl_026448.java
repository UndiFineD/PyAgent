...
@Data
public class Idea26448Config {
    private String name = "idea_026448";
 ...
 */
@Slf4j
public class Idea26448Service {
    private static final int IDEA_ID = 26448;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26448Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26448Service() {
        this(new Idea26448Config());
    }

    public Idea26448Service(Idea26448Config config) {
        this.config = config != null ? config : new Idea26448Config();
