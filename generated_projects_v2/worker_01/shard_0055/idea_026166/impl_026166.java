...
@Data
public class Idea26166Config {
    private String name = "idea_026166";
 ...
 */
@Slf4j
public class Idea26166Service {
    private static final int IDEA_ID = 26166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26166Service() {
        this(new Idea26166Config());
    }

    public Idea26166Service(Idea26166Config config) {
        this.config = config != null ? config : new Idea26166Config();
