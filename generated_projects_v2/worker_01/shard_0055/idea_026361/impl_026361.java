...
@Data
public class Idea26361Config {
    private String name = "idea_026361";
 ...
 */
@Slf4j
public class Idea26361Service {
    private static final int IDEA_ID = 26361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26361Service() {
        this(new Idea26361Config());
    }

    public Idea26361Service(Idea26361Config config) {
        this.config = config != null ? config : new Idea26361Config();
