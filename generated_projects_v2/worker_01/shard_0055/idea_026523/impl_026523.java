...
@Data
public class Idea26523Config {
    private String name = "idea_026523";
 ...
 */
@Slf4j
public class Idea26523Service {
    private static final int IDEA_ID = 26523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26523Service() {
        this(new Idea26523Config());
    }

    public Idea26523Service(Idea26523Config config) {
        this.config = config != null ? config : new Idea26523Config();
