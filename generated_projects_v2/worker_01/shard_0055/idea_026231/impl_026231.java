...
@Data
public class Idea26231Config {
    private String name = "idea_026231";
 ...
 */
@Slf4j
public class Idea26231Service {
    private static final int IDEA_ID = 26231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26231Service() {
        this(new Idea26231Config());
    }

    public Idea26231Service(Idea26231Config config) {
        this.config = config != null ? config : new Idea26231Config();
