...
@Data
public class Idea26423Config {
    private String name = "idea_026423";
 ...
 */
@Slf4j
public class Idea26423Service {
    private static final int IDEA_ID = 26423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26423Service() {
        this(new Idea26423Config());
    }

    public Idea26423Service(Idea26423Config config) {
        this.config = config != null ? config : new Idea26423Config();
