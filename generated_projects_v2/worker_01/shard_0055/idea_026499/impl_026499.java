...
@Data
public class Idea26499Config {
    private String name = "idea_026499";
 ...
 */
@Slf4j
public class Idea26499Service {
    private static final int IDEA_ID = 26499;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26499Service() {
        this(new Idea26499Config());
    }

    public Idea26499Service(Idea26499Config config) {
        this.config = config != null ? config : new Idea26499Config();
