...
@Data
public class Idea26436Config {
    private String name = "idea_026436";
 ...
 */
@Slf4j
public class Idea26436Service {
    private static final int IDEA_ID = 26436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26436Service() {
        this(new Idea26436Config());
    }

    public Idea26436Service(Idea26436Config config) {
        this.config = config != null ? config : new Idea26436Config();
