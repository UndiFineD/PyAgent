...
@Data
public class Idea26246Config {
    private String name = "idea_026246";
 ...
 */
@Slf4j
public class Idea26246Service {
    private static final int IDEA_ID = 26246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26246Service() {
        this(new Idea26246Config());
    }

    public Idea26246Service(Idea26246Config config) {
        this.config = config != null ? config : new Idea26246Config();
