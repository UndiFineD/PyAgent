...
@Data
public class Idea26403Config {
    private String name = "idea_026403";
 ...
 */
@Slf4j
public class Idea26403Service {
    private static final int IDEA_ID = 26403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26403Service() {
        this(new Idea26403Config());
    }

    public Idea26403Service(Idea26403Config config) {
        this.config = config != null ? config : new Idea26403Config();
