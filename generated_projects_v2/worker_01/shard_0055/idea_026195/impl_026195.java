...
@Data
public class Idea26195Config {
    private String name = "idea_026195";
 ...
 */
@Slf4j
public class Idea26195Service {
    private static final int IDEA_ID = 26195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26195Service() {
        this(new Idea26195Config());
    }

    public Idea26195Service(Idea26195Config config) {
        this.config = config != null ? config : new Idea26195Config();
