...
@Data
public class Idea26343Config {
    private String name = "idea_026343";
 ...
 */
@Slf4j
public class Idea26343Service {
    private static final int IDEA_ID = 26343;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26343Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26343Service() {
        this(new Idea26343Config());
    }

    public Idea26343Service(Idea26343Config config) {
        this.config = config != null ? config : new Idea26343Config();
