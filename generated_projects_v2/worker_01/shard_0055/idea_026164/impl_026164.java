...
@Data
public class Idea26164Config {
    private String name = "idea_026164";
 ...
 */
@Slf4j
public class Idea26164Service {
    private static final int IDEA_ID = 26164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26164Service() {
        this(new Idea26164Config());
    }

    public Idea26164Service(Idea26164Config config) {
        this.config = config != null ? config : new Idea26164Config();
