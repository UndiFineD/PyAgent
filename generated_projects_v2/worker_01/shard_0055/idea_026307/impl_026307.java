...
@Data
public class Idea26307Config {
    private String name = "idea_026307";
 ...
 */
@Slf4j
public class Idea26307Service {
    private static final int IDEA_ID = 26307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26307Service() {
        this(new Idea26307Config());
    }

    public Idea26307Service(Idea26307Config config) {
        this.config = config != null ? config : new Idea26307Config();
