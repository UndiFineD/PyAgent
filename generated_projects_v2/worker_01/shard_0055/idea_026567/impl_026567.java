...
@Data
public class Idea26567Config {
    private String name = "idea_026567";
 ...
 */
@Slf4j
public class Idea26567Service {
    private static final int IDEA_ID = 26567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26567Service() {
        this(new Idea26567Config());
    }

    public Idea26567Service(Idea26567Config config) {
        this.config = config != null ? config : new Idea26567Config();
