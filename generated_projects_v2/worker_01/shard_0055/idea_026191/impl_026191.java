...
@Data
public class Idea26191Config {
    private String name = "idea_026191";
 ...
 */
@Slf4j
public class Idea26191Service {
    private static final int IDEA_ID = 26191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26191Service() {
        this(new Idea26191Config());
    }

    public Idea26191Service(Idea26191Config config) {
        this.config = config != null ? config : new Idea26191Config();
