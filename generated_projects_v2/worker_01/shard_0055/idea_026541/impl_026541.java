...
@Data
public class Idea26541Config {
    private String name = "idea_026541";
 ...
 */
@Slf4j
public class Idea26541Service {
    private static final int IDEA_ID = 26541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26541Service() {
        this(new Idea26541Config());
    }

    public Idea26541Service(Idea26541Config config) {
        this.config = config != null ? config : new Idea26541Config();
