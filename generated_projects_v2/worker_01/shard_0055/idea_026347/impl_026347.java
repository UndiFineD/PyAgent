...
@Data
public class Idea26347Config {
    private String name = "idea_026347";
 ...
 */
@Slf4j
public class Idea26347Service {
    private static final int IDEA_ID = 26347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26347Service() {
        this(new Idea26347Config());
    }

    public Idea26347Service(Idea26347Config config) {
        this.config = config != null ? config : new Idea26347Config();
