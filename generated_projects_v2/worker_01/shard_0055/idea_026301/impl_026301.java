...
@Data
public class Idea26301Config {
    private String name = "idea_026301";
 ...
 */
@Slf4j
public class Idea26301Service {
    private static final int IDEA_ID = 26301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26301Service() {
        this(new Idea26301Config());
    }

    public Idea26301Service(Idea26301Config config) {
        this.config = config != null ? config : new Idea26301Config();
