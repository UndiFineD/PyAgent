...
@Data
public class Idea26351Config {
    private String name = "idea_026351";
 ...
 */
@Slf4j
public class Idea26351Service {
    private static final int IDEA_ID = 26351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26351Service() {
        this(new Idea26351Config());
    }

    public Idea26351Service(Idea26351Config config) {
        this.config = config != null ? config : new Idea26351Config();
