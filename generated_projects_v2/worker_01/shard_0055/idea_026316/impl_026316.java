...
@Data
public class Idea26316Config {
    private String name = "idea_026316";
 ...
 */
@Slf4j
public class Idea26316Service {
    private static final int IDEA_ID = 26316;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26316Service() {
        this(new Idea26316Config());
    }

    public Idea26316Service(Idea26316Config config) {
        this.config = config != null ? config : new Idea26316Config();
