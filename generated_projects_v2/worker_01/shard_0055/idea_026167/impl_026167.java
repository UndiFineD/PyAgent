...
@Data
public class Idea26167Config {
    private String name = "idea_026167";
 ...
 */
@Slf4j
public class Idea26167Service {
    private static final int IDEA_ID = 26167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26167Service() {
        this(new Idea26167Config());
    }

    public Idea26167Service(Idea26167Config config) {
        this.config = config != null ? config : new Idea26167Config();
