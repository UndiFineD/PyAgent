...
@Data
public class Idea26383Config {
    private String name = "idea_026383";
 ...
 */
@Slf4j
public class Idea26383Service {
    private static final int IDEA_ID = 26383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26383Service() {
        this(new Idea26383Config());
    }

    public Idea26383Service(Idea26383Config config) {
        this.config = config != null ? config : new Idea26383Config();
