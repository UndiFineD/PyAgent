...
@Data
public class Idea26336Config {
    private String name = "idea_026336";
 ...
 */
@Slf4j
public class Idea26336Service {
    private static final int IDEA_ID = 26336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26336Service() {
        this(new Idea26336Config());
    }

    public Idea26336Service(Idea26336Config config) {
        this.config = config != null ? config : new Idea26336Config();
