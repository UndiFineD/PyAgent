...
@Data
public class Idea26386Config {
    private String name = "idea_026386";
 ...
 */
@Slf4j
public class Idea26386Service {
    private static final int IDEA_ID = 26386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26386Service() {
        this(new Idea26386Config());
    }

    public Idea26386Service(Idea26386Config config) {
        this.config = config != null ? config : new Idea26386Config();
