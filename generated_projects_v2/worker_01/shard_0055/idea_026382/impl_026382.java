...
@Data
public class Idea26382Config {
    private String name = "idea_026382";
 ...
 */
@Slf4j
public class Idea26382Service {
    private static final int IDEA_ID = 26382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26382Service() {
        this(new Idea26382Config());
    }

    public Idea26382Service(Idea26382Config config) {
        this.config = config != null ? config : new Idea26382Config();
