...
@Data
public class Idea26284Config {
    private String name = "idea_026284";
 ...
 */
@Slf4j
public class Idea26284Service {
    private static final int IDEA_ID = 26284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26284Service() {
        this(new Idea26284Config());
    }

    public Idea26284Service(Idea26284Config config) {
        this.config = config != null ? config : new Idea26284Config();
