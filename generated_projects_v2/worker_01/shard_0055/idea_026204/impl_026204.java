...
@Data
public class Idea26204Config {
    private String name = "idea_026204";
 ...
 */
@Slf4j
public class Idea26204Service {
    private static final int IDEA_ID = 26204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26204Service() {
        this(new Idea26204Config());
    }

    public Idea26204Service(Idea26204Config config) {
        this.config = config != null ? config : new Idea26204Config();
