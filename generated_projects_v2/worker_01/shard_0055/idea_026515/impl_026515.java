...
@Data
public class Idea26515Config {
    private String name = "idea_026515";
 ...
 */
@Slf4j
public class Idea26515Service {
    private static final int IDEA_ID = 26515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26515Service() {
        this(new Idea26515Config());
    }

    public Idea26515Service(Idea26515Config config) {
        this.config = config != null ? config : new Idea26515Config();
