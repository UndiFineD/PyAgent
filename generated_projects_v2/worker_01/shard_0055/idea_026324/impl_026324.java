...
@Data
public class Idea26324Config {
    private String name = "idea_026324";
 ...
 */
@Slf4j
public class Idea26324Service {
    private static final int IDEA_ID = 26324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26324Service() {
        this(new Idea26324Config());
    }

    public Idea26324Service(Idea26324Config config) {
        this.config = config != null ? config : new Idea26324Config();
