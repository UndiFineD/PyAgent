...
@Data
public class Idea26171Config {
    private String name = "idea_026171";
 ...
 */
@Slf4j
public class Idea26171Service {
    private static final int IDEA_ID = 26171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26171Service() {
        this(new Idea26171Config());
    }

    public Idea26171Service(Idea26171Config config) {
        this.config = config != null ? config : new Idea26171Config();
