...
@Data
public class Idea26451Config {
    private String name = "idea_026451";
 ...
 */
@Slf4j
public class Idea26451Service {
    private static final int IDEA_ID = 26451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26451Service() {
        this(new Idea26451Config());
    }

    public Idea26451Service(Idea26451Config config) {
        this.config = config != null ? config : new Idea26451Config();
