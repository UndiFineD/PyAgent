...
@Data
public class Idea26181Config {
    private String name = "idea_026181";
 ...
 */
@Slf4j
public class Idea26181Service {
    private static final int IDEA_ID = 26181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26181Service() {
        this(new Idea26181Config());
    }

    public Idea26181Service(Idea26181Config config) {
        this.config = config != null ? config : new Idea26181Config();
