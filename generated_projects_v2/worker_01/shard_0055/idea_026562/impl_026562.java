...
@Data
public class Idea26562Config {
    private String name = "idea_026562";
 ...
 */
@Slf4j
public class Idea26562Service {
    private static final int IDEA_ID = 26562;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26562Service() {
        this(new Idea26562Config());
    }

    public Idea26562Service(Idea26562Config config) {
        this.config = config != null ? config : new Idea26562Config();
