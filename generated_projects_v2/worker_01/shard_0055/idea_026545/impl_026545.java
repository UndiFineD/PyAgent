...
@Data
public class Idea26545Config {
    private String name = "idea_026545";
 ...
 */
@Slf4j
public class Idea26545Service {
    private static final int IDEA_ID = 26545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26545Service() {
        this(new Idea26545Config());
    }

    public Idea26545Service(Idea26545Config config) {
        this.config = config != null ? config : new Idea26545Config();
