...
@Data
public class Idea26429Config {
    private String name = "idea_026429";
 ...
 */
@Slf4j
public class Idea26429Service {
    private static final int IDEA_ID = 26429;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26429Service() {
        this(new Idea26429Config());
    }

    public Idea26429Service(Idea26429Config config) {
        this.config = config != null ? config : new Idea26429Config();
