...
@Data
public class Idea26265Config {
    private String name = "idea_026265";
 ...
 */
@Slf4j
public class Idea26265Service {
    private static final int IDEA_ID = 26265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26265Service() {
        this(new Idea26265Config());
    }

    public Idea26265Service(Idea26265Config config) {
        this.config = config != null ? config : new Idea26265Config();
