...
@Data
public class Idea26342Config {
    private String name = "idea_026342";
 ...
 */
@Slf4j
public class Idea26342Service {
    private static final int IDEA_ID = 26342;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26342Service() {
        this(new Idea26342Config());
    }

    public Idea26342Service(Idea26342Config config) {
        this.config = config != null ? config : new Idea26342Config();
