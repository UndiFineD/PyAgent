...
@Data
public class Idea26505Config {
    private String name = "idea_026505";
 ...
 */
@Slf4j
public class Idea26505Service {
    private static final int IDEA_ID = 26505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26505Service() {
        this(new Idea26505Config());
    }

    public Idea26505Service(Idea26505Config config) {
        this.config = config != null ? config : new Idea26505Config();
