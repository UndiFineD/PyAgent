...
@Data
public class Idea26154Config {
    private String name = "idea_026154";
 ...
 */
@Slf4j
public class Idea26154Service {
    private static final int IDEA_ID = 26154;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26154Service() {
        this(new Idea26154Config());
    }

    public Idea26154Service(Idea26154Config config) {
        this.config = config != null ? config : new Idea26154Config();
