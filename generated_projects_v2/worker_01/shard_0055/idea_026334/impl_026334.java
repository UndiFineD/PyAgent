...
@Data
public class Idea26334Config {
    private String name = "idea_026334";
 ...
 */
@Slf4j
public class Idea26334Service {
    private static final int IDEA_ID = 26334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26334Service() {
        this(new Idea26334Config());
    }

    public Idea26334Service(Idea26334Config config) {
        this.config = config != null ? config : new Idea26334Config();
