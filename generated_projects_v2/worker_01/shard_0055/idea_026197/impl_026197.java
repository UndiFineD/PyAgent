...
@Data
public class Idea26197Config {
    private String name = "idea_026197";
 ...
 */
@Slf4j
public class Idea26197Service {
    private static final int IDEA_ID = 26197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26197Service() {
        this(new Idea26197Config());
    }

    public Idea26197Service(Idea26197Config config) {
        this.config = config != null ? config : new Idea26197Config();
