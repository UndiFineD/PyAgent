...
@Data
public class Idea26590Config {
    private String name = "idea_026590";
 ...
 */
@Slf4j
public class Idea26590Service {
    private static final int IDEA_ID = 26590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26590Service() {
        this(new Idea26590Config());
    }

    public Idea26590Service(Idea26590Config config) {
        this.config = config != null ? config : new Idea26590Config();
