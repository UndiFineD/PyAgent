...
@Data
public class Idea26252Config {
    private String name = "idea_026252";
 ...
 */
@Slf4j
public class Idea26252Service {
    private static final int IDEA_ID = 26252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26252Service() {
        this(new Idea26252Config());
    }

    public Idea26252Service(Idea26252Config config) {
        this.config = config != null ? config : new Idea26252Config();
