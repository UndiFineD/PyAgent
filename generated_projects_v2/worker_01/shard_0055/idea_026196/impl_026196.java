...
@Data
public class Idea26196Config {
    private String name = "idea_026196";
 ...
 */
@Slf4j
public class Idea26196Service {
    private static final int IDEA_ID = 26196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26196Service() {
        this(new Idea26196Config());
    }

    public Idea26196Service(Idea26196Config config) {
        this.config = config != null ? config : new Idea26196Config();
