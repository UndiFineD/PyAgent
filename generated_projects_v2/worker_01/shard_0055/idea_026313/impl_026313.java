...
@Data
public class Idea26313Config {
    private String name = "idea_026313";
 ...
 */
@Slf4j
public class Idea26313Service {
    private static final int IDEA_ID = 26313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26313Service() {
        this(new Idea26313Config());
    }

    public Idea26313Service(Idea26313Config config) {
        this.config = config != null ? config : new Idea26313Config();
