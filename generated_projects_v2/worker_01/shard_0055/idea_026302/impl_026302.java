...
@Data
public class Idea26302Config {
    private String name = "idea_026302";
 ...
 */
@Slf4j
public class Idea26302Service {
    private static final int IDEA_ID = 26302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26302Service() {
        this(new Idea26302Config());
    }

    public Idea26302Service(Idea26302Config config) {
        this.config = config != null ? config : new Idea26302Config();
