...
@Data
public class Idea26384Config {
    private String name = "idea_026384";
 ...
 */
@Slf4j
public class Idea26384Service {
    private static final int IDEA_ID = 26384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26384Service() {
        this(new Idea26384Config());
    }

    public Idea26384Service(Idea26384Config config) {
        this.config = config != null ? config : new Idea26384Config();
