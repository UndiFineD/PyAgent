...
@Data
public class Idea26435Config {
    private String name = "idea_026435";
 ...
 */
@Slf4j
public class Idea26435Service {
    private static final int IDEA_ID = 26435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26435Service() {
        this(new Idea26435Config());
    }

    public Idea26435Service(Idea26435Config config) {
        this.config = config != null ? config : new Idea26435Config();
