...
@Data
public class Idea26385Config {
    private String name = "idea_026385";
 ...
 */
@Slf4j
public class Idea26385Service {
    private static final int IDEA_ID = 26385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26385Service() {
        this(new Idea26385Config());
    }

    public Idea26385Service(Idea26385Config config) {
        this.config = config != null ? config : new Idea26385Config();
