...
@Data
public class Idea26288Config {
    private String name = "idea_026288";
 ...
 */
@Slf4j
public class Idea26288Service {
    private static final int IDEA_ID = 26288;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26288Service() {
        this(new Idea26288Config());
    }

    public Idea26288Service(Idea26288Config config) {
        this.config = config != null ? config : new Idea26288Config();
