...
@Data
public class Idea26450Config {
    private String name = "idea_026450";
 ...
 */
@Slf4j
public class Idea26450Service {
    private static final int IDEA_ID = 26450;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26450Service() {
        this(new Idea26450Config());
    }

    public Idea26450Service(Idea26450Config config) {
        this.config = config != null ? config : new Idea26450Config();
