...
@Data
public class Idea26371Config {
    private String name = "idea_026371";
 ...
 */
@Slf4j
public class Idea26371Service {
    private static final int IDEA_ID = 26371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26371Service() {
        this(new Idea26371Config());
    }

    public Idea26371Service(Idea26371Config config) {
        this.config = config != null ? config : new Idea26371Config();
