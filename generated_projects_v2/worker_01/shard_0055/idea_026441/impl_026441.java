...
@Data
public class Idea26441Config {
    private String name = "idea_026441";
 ...
 */
@Slf4j
public class Idea26441Service {
    private static final int IDEA_ID = 26441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26441Service() {
        this(new Idea26441Config());
    }

    public Idea26441Service(Idea26441Config config) {
        this.config = config != null ? config : new Idea26441Config();
