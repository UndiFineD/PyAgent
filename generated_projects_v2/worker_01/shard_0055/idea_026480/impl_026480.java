...
@Data
public class Idea26480Config {
    private String name = "idea_026480";
 ...
 */
@Slf4j
public class Idea26480Service {
    private static final int IDEA_ID = 26480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26480Service() {
        this(new Idea26480Config());
    }

    public Idea26480Service(Idea26480Config config) {
        this.config = config != null ? config : new Idea26480Config();
