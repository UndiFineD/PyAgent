...
@Data
public class Idea26466Config {
    private String name = "idea_026466";
 ...
 */
@Slf4j
public class Idea26466Service {
    private static final int IDEA_ID = 26466;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26466Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26466Service() {
        this(new Idea26466Config());
    }

    public Idea26466Service(Idea26466Config config) {
        this.config = config != null ? config : new Idea26466Config();
