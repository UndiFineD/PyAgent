...
@Data
public class Idea26585Config {
    private String name = "idea_026585";
 ...
 */
@Slf4j
public class Idea26585Service {
    private static final int IDEA_ID = 26585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26585Service() {
        this(new Idea26585Config());
    }

    public Idea26585Service(Idea26585Config config) {
        this.config = config != null ? config : new Idea26585Config();
