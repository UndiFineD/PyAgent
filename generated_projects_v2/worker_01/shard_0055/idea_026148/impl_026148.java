...
@Data
public class Idea26148Config {
    private String name = "idea_026148";
 ...
 */
@Slf4j
public class Idea26148Service {
    private static final int IDEA_ID = 26148;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26148Service() {
        this(new Idea26148Config());
    }

    public Idea26148Service(Idea26148Config config) {
        this.config = config != null ? config : new Idea26148Config();
