...
@Data
public class Idea26425Config {
    private String name = "idea_026425";
 ...
 */
@Slf4j
public class Idea26425Service {
    private static final int IDEA_ID = 26425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26425Service() {
        this(new Idea26425Config());
    }

    public Idea26425Service(Idea26425Config config) {
        this.config = config != null ? config : new Idea26425Config();
