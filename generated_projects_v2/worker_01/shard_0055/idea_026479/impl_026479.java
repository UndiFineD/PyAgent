...
@Data
public class Idea26479Config {
    private String name = "idea_026479";
 ...
 */
@Slf4j
public class Idea26479Service {
    private static final int IDEA_ID = 26479;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26479Service() {
        this(new Idea26479Config());
    }

    public Idea26479Service(Idea26479Config config) {
        this.config = config != null ? config : new Idea26479Config();
