...
@Data
public class Idea26314Config {
    private String name = "idea_026314";
 ...
 */
@Slf4j
public class Idea26314Service {
    private static final int IDEA_ID = 26314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26314Service() {
        this(new Idea26314Config());
    }

    public Idea26314Service(Idea26314Config config) {
        this.config = config != null ? config : new Idea26314Config();
