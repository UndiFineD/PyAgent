...
@Data
public class Idea26579Config {
    private String name = "idea_026579";
 ...
 */
@Slf4j
public class Idea26579Service {
    private static final int IDEA_ID = 26579;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26579Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26579Service() {
        this(new Idea26579Config());
    }

    public Idea26579Service(Idea26579Config config) {
        this.config = config != null ? config : new Idea26579Config();
