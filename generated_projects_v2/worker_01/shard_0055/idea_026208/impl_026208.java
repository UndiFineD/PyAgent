...
@Data
public class Idea26208Config {
    private String name = "idea_026208";
 ...
 */
@Slf4j
public class Idea26208Service {
    private static final int IDEA_ID = 26208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26208Service() {
        this(new Idea26208Config());
    }

    public Idea26208Service(Idea26208Config config) {
        this.config = config != null ? config : new Idea26208Config();
