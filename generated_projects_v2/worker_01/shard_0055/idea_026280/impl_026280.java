...
@Data
public class Idea26280Config {
    private String name = "idea_026280";
 ...
 */
@Slf4j
public class Idea26280Service {
    private static final int IDEA_ID = 26280;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26280Service() {
        this(new Idea26280Config());
    }

    public Idea26280Service(Idea26280Config config) {
        this.config = config != null ? config : new Idea26280Config();
