...
@Data
public class Idea26547Config {
    private String name = "idea_026547";
 ...
 */
@Slf4j
public class Idea26547Service {
    private static final int IDEA_ID = 26547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26547Service() {
        this(new Idea26547Config());
    }

    public Idea26547Service(Idea26547Config config) {
        this.config = config != null ? config : new Idea26547Config();
