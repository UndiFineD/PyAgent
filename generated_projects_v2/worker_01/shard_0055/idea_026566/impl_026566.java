...
@Data
public class Idea26566Config {
    private String name = "idea_026566";
 ...
 */
@Slf4j
public class Idea26566Service {
    private static final int IDEA_ID = 26566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26566Service() {
        this(new Idea26566Config());
    }

    public Idea26566Service(Idea26566Config config) {
        this.config = config != null ? config : new Idea26566Config();
