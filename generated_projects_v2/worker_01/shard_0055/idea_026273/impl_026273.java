...
@Data
public class Idea26273Config {
    private String name = "idea_026273";
 ...
 */
@Slf4j
public class Idea26273Service {
    private static final int IDEA_ID = 26273;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26273Service() {
        this(new Idea26273Config());
    }

    public Idea26273Service(Idea26273Config config) {
        this.config = config != null ? config : new Idea26273Config();
