...
@Data
public class Idea26408Config {
    private String name = "idea_026408";
 ...
 */
@Slf4j
public class Idea26408Service {
    private static final int IDEA_ID = 26408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26408Service() {
        this(new Idea26408Config());
    }

    public Idea26408Service(Idea26408Config config) {
        this.config = config != null ? config : new Idea26408Config();
