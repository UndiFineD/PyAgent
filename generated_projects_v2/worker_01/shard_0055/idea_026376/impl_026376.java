...
@Data
public class Idea26376Config {
    private String name = "idea_026376";
 ...
 */
@Slf4j
public class Idea26376Service {
    private static final int IDEA_ID = 26376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26376Service() {
        this(new Idea26376Config());
    }

    public Idea26376Service(Idea26376Config config) {
        this.config = config != null ? config : new Idea26376Config();
