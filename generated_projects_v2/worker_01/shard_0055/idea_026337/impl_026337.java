...
@Data
public class Idea26337Config {
    private String name = "idea_026337";
 ...
 */
@Slf4j
public class Idea26337Service {
    private static final int IDEA_ID = 26337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26337Service() {
        this(new Idea26337Config());
    }

    public Idea26337Service(Idea26337Config config) {
        this.config = config != null ? config : new Idea26337Config();
