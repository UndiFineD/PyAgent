...
@Data
public class Idea26219Config {
    private String name = "idea_026219";
 ...
 */
@Slf4j
public class Idea26219Service {
    private static final int IDEA_ID = 26219;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26219Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26219Service() {
        this(new Idea26219Config());
    }

    public Idea26219Service(Idea26219Config config) {
        this.config = config != null ? config : new Idea26219Config();
