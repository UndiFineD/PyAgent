...
@Data
public class Idea26220Config {
    private String name = "idea_026220";
 ...
 */
@Slf4j
public class Idea26220Service {
    private static final int IDEA_ID = 26220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26220Service() {
        this(new Idea26220Config());
    }

    public Idea26220Service(Idea26220Config config) {
        this.config = config != null ? config : new Idea26220Config();
