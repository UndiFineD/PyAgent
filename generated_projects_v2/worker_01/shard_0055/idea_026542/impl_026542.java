...
@Data
public class Idea26542Config {
    private String name = "idea_026542";
 ...
 */
@Slf4j
public class Idea26542Service {
    private static final int IDEA_ID = 26542;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26542Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26542Service() {
        this(new Idea26542Config());
    }

    public Idea26542Service(Idea26542Config config) {
        this.config = config != null ? config : new Idea26542Config();
