...
@Data
public class Idea26518Config {
    private String name = "idea_026518";
 ...
 */
@Slf4j
public class Idea26518Service {
    private static final int IDEA_ID = 26518;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26518Service() {
        this(new Idea26518Config());
    }

    public Idea26518Service(Idea26518Config config) {
        this.config = config != null ? config : new Idea26518Config();
