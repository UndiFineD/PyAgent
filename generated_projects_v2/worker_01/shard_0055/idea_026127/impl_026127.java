...
@Data
public class Idea26127Config {
    private String name = "idea_026127";
 ...
 */
@Slf4j
public class Idea26127Service {
    private static final int IDEA_ID = 26127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26127Service() {
        this(new Idea26127Config());
    }

    public Idea26127Service(Idea26127Config config) {
        this.config = config != null ? config : new Idea26127Config();
