...
@Data
public class Idea26238Config {
    private String name = "idea_026238";
 ...
 */
@Slf4j
public class Idea26238Service {
    private static final int IDEA_ID = 26238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26238Service() {
        this(new Idea26238Config());
    }

    public Idea26238Service(Idea26238Config config) {
        this.config = config != null ? config : new Idea26238Config();
