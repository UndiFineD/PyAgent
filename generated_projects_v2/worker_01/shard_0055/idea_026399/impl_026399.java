...
@Data
public class Idea26399Config {
    private String name = "idea_026399";
 ...
 */
@Slf4j
public class Idea26399Service {
    private static final int IDEA_ID = 26399;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26399Service() {
        this(new Idea26399Config());
    }

    public Idea26399Service(Idea26399Config config) {
        this.config = config != null ? config : new Idea26399Config();
