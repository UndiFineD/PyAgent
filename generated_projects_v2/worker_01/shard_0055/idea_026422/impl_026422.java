...
@Data
public class Idea26422Config {
    private String name = "idea_026422";
 ...
 */
@Slf4j
public class Idea26422Service {
    private static final int IDEA_ID = 26422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26422Service() {
        this(new Idea26422Config());
    }

    public Idea26422Service(Idea26422Config config) {
        this.config = config != null ? config : new Idea26422Config();
