...
@Data
public class Idea26233Config {
    private String name = "idea_026233";
 ...
 */
@Slf4j
public class Idea26233Service {
    private static final int IDEA_ID = 26233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26233Service() {
        this(new Idea26233Config());
    }

    public Idea26233Service(Idea26233Config config) {
        this.config = config != null ? config : new Idea26233Config();
