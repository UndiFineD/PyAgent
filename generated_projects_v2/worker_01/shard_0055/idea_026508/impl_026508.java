...
@Data
public class Idea26508Config {
    private String name = "idea_026508";
 ...
 */
@Slf4j
public class Idea26508Service {
    private static final int IDEA_ID = 26508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26508Service() {
        this(new Idea26508Config());
    }

    public Idea26508Service(Idea26508Config config) {
        this.config = config != null ? config : new Idea26508Config();
