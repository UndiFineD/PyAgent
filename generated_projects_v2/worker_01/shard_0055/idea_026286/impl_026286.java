...
@Data
public class Idea26286Config {
    private String name = "idea_026286";
 ...
 */
@Slf4j
public class Idea26286Service {
    private static final int IDEA_ID = 26286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26286Service() {
        this(new Idea26286Config());
    }

    public Idea26286Service(Idea26286Config config) {
        this.config = config != null ? config : new Idea26286Config();
