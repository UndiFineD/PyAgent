...
@Data
public class Idea26467Config {
    private String name = "idea_026467";
 ...
 */
@Slf4j
public class Idea26467Service {
    private static final int IDEA_ID = 26467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26467Service() {
        this(new Idea26467Config());
    }

    public Idea26467Service(Idea26467Config config) {
        this.config = config != null ? config : new Idea26467Config();
