...
@Data
public class Idea26564Config {
    private String name = "idea_026564";
 ...
 */
@Slf4j
public class Idea26564Service {
    private static final int IDEA_ID = 26564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26564Service() {
        this(new Idea26564Config());
    }

    public Idea26564Service(Idea26564Config config) {
        this.config = config != null ? config : new Idea26564Config();
