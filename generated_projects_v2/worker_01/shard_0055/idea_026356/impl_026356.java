...
@Data
public class Idea26356Config {
    private String name = "idea_026356";
 ...
 */
@Slf4j
public class Idea26356Service {
    private static final int IDEA_ID = 26356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26356Service() {
        this(new Idea26356Config());
    }

    public Idea26356Service(Idea26356Config config) {
        this.config = config != null ? config : new Idea26356Config();
