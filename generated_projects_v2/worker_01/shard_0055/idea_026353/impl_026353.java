...
@Data
public class Idea26353Config {
    private String name = "idea_026353";
 ...
 */
@Slf4j
public class Idea26353Service {
    private static final int IDEA_ID = 26353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26353Service() {
        this(new Idea26353Config());
    }

    public Idea26353Service(Idea26353Config config) {
        this.config = config != null ? config : new Idea26353Config();
