...
@Data
public class Idea26534Config {
    private String name = "idea_026534";
 ...
 */
@Slf4j
public class Idea26534Service {
    private static final int IDEA_ID = 26534;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26534Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26534Service() {
        this(new Idea26534Config());
    }

    public Idea26534Service(Idea26534Config config) {
        this.config = config != null ? config : new Idea26534Config();
