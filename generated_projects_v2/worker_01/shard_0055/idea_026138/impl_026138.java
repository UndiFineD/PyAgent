...
@Data
public class Idea26138Config {
    private String name = "idea_026138";
 ...
 */
@Slf4j
public class Idea26138Service {
    private static final int IDEA_ID = 26138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26138Service() {
        this(new Idea26138Config());
    }

    public Idea26138Service(Idea26138Config config) {
        this.config = config != null ? config : new Idea26138Config();
