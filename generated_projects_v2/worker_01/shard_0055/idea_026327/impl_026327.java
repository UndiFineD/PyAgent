...
@Data
public class Idea26327Config {
    private String name = "idea_026327";
 ...
 */
@Slf4j
public class Idea26327Service {
    private static final int IDEA_ID = 26327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26327Service() {
        this(new Idea26327Config());
    }

    public Idea26327Service(Idea26327Config config) {
        this.config = config != null ? config : new Idea26327Config();
