...
@Data
public class Idea26431Config {
    private String name = "idea_026431";
 ...
 */
@Slf4j
public class Idea26431Service {
    private static final int IDEA_ID = 26431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26431Service() {
        this(new Idea26431Config());
    }

    public Idea26431Service(Idea26431Config config) {
        this.config = config != null ? config : new Idea26431Config();
