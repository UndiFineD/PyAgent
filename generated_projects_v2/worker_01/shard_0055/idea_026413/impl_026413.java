...
@Data
public class Idea26413Config {
    private String name = "idea_026413";
 ...
 */
@Slf4j
public class Idea26413Service {
    private static final int IDEA_ID = 26413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26413Service() {
        this(new Idea26413Config());
    }

    public Idea26413Service(Idea26413Config config) {
        this.config = config != null ? config : new Idea26413Config();
