...
@Data
public class Idea26312Config {
    private String name = "idea_026312";
 ...
 */
@Slf4j
public class Idea26312Service {
    private static final int IDEA_ID = 26312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26312Service() {
        this(new Idea26312Config());
    }

    public Idea26312Service(Idea26312Config config) {
        this.config = config != null ? config : new Idea26312Config();
