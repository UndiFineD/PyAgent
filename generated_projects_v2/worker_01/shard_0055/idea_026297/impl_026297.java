...
@Data
public class Idea26297Config {
    private String name = "idea_026297";
 ...
 */
@Slf4j
public class Idea26297Service {
    private static final int IDEA_ID = 26297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26297Service() {
        this(new Idea26297Config());
    }

    public Idea26297Service(Idea26297Config config) {
        this.config = config != null ? config : new Idea26297Config();
