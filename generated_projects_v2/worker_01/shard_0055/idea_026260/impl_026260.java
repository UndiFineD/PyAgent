...
@Data
public class Idea26260Config {
    private String name = "idea_026260";
 ...
 */
@Slf4j
public class Idea26260Service {
    private static final int IDEA_ID = 26260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26260Service() {
        this(new Idea26260Config());
    }

    public Idea26260Service(Idea26260Config config) {
        this.config = config != null ? config : new Idea26260Config();
