...
@Data
public class Idea26468Config {
    private String name = "idea_026468";
 ...
 */
@Slf4j
public class Idea26468Service {
    private static final int IDEA_ID = 26468;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26468Service() {
        this(new Idea26468Config());
    }

    public Idea26468Service(Idea26468Config config) {
        this.config = config != null ? config : new Idea26468Config();
