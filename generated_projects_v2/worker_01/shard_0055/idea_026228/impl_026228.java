...
@Data
public class Idea26228Config {
    private String name = "idea_026228";
 ...
 */
@Slf4j
public class Idea26228Service {
    private static final int IDEA_ID = 26228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26228Service() {
        this(new Idea26228Config());
    }

    public Idea26228Service(Idea26228Config config) {
        this.config = config != null ? config : new Idea26228Config();
