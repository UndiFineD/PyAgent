...
@Data
public class Idea26158Config {
    private String name = "idea_026158";
 ...
 */
@Slf4j
public class Idea26158Service {
    private static final int IDEA_ID = 26158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26158Service() {
        this(new Idea26158Config());
    }

    public Idea26158Service(Idea26158Config config) {
        this.config = config != null ? config : new Idea26158Config();
