...
@Data
public class Idea26294Config {
    private String name = "idea_026294";
 ...
 */
@Slf4j
public class Idea26294Service {
    private static final int IDEA_ID = 26294;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26294Service() {
        this(new Idea26294Config());
    }

    public Idea26294Service(Idea26294Config config) {
        this.config = config != null ? config : new Idea26294Config();
