...
@Data
public class Idea26482Config {
    private String name = "idea_026482";
 ...
 */
@Slf4j
public class Idea26482Service {
    private static final int IDEA_ID = 26482;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26482Service() {
        this(new Idea26482Config());
    }

    public Idea26482Service(Idea26482Config config) {
        this.config = config != null ? config : new Idea26482Config();
