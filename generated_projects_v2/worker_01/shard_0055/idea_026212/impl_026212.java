...
@Data
public class Idea26212Config {
    private String name = "idea_026212";
 ...
 */
@Slf4j
public class Idea26212Service {
    private static final int IDEA_ID = 26212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26212Service() {
        this(new Idea26212Config());
    }

    public Idea26212Service(Idea26212Config config) {
        this.config = config != null ? config : new Idea26212Config();
