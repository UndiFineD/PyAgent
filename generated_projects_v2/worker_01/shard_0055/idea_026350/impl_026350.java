...
@Data
public class Idea26350Config {
    private String name = "idea_026350";
 ...
 */
@Slf4j
public class Idea26350Service {
    private static final int IDEA_ID = 26350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26350Service() {
        this(new Idea26350Config());
    }

    public Idea26350Service(Idea26350Config config) {
        this.config = config != null ? config : new Idea26350Config();
