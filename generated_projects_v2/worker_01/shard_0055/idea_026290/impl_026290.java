...
@Data
public class Idea26290Config {
    private String name = "idea_026290";
 ...
 */
@Slf4j
public class Idea26290Service {
    private static final int IDEA_ID = 26290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26290Service() {
        this(new Idea26290Config());
    }

    public Idea26290Service(Idea26290Config config) {
        this.config = config != null ? config : new Idea26290Config();
