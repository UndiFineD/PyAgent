...
@Data
public class Idea26152Config {
    private String name = "idea_026152";
 ...
 */
@Slf4j
public class Idea26152Service {
    private static final int IDEA_ID = 26152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26152Service() {
        this(new Idea26152Config());
    }

    public Idea26152Service(Idea26152Config config) {
        this.config = config != null ? config : new Idea26152Config();
