...
@Data
public class Idea26381Config {
    private String name = "idea_026381";
 ...
 */
@Slf4j
public class Idea26381Service {
    private static final int IDEA_ID = 26381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26381Service() {
        this(new Idea26381Config());
    }

    public Idea26381Service(Idea26381Config config) {
        this.config = config != null ? config : new Idea26381Config();
