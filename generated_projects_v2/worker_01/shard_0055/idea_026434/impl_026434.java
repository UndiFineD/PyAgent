...
@Data
public class Idea26434Config {
    private String name = "idea_026434";
 ...
 */
@Slf4j
public class Idea26434Service {
    private static final int IDEA_ID = 26434;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26434Service() {
        this(new Idea26434Config());
    }

    public Idea26434Service(Idea26434Config config) {
        this.config = config != null ? config : new Idea26434Config();
