...
@Data
public class Idea26162Config {
    private String name = "idea_026162";
 ...
 */
@Slf4j
public class Idea26162Service {
    private static final int IDEA_ID = 26162;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26162Service() {
        this(new Idea26162Config());
    }

    public Idea26162Service(Idea26162Config config) {
        this.config = config != null ? config : new Idea26162Config();
