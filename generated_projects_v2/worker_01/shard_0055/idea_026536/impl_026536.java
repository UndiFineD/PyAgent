...
@Data
public class Idea26536Config {
    private String name = "idea_026536";
 ...
 */
@Slf4j
public class Idea26536Service {
    private static final int IDEA_ID = 26536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26536Service() {
        this(new Idea26536Config());
    }

    public Idea26536Service(Idea26536Config config) {
        this.config = config != null ? config : new Idea26536Config();
