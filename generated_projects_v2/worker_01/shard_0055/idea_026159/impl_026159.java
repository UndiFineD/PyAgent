...
@Data
public class Idea26159Config {
    private String name = "idea_026159";
 ...
 */
@Slf4j
public class Idea26159Service {
    private static final int IDEA_ID = 26159;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26159Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26159Service() {
        this(new Idea26159Config());
    }

    public Idea26159Service(Idea26159Config config) {
        this.config = config != null ? config : new Idea26159Config();
