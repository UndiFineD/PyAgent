...
@Data
public class Idea26373Config {
    private String name = "idea_026373";
 ...
 */
@Slf4j
public class Idea26373Service {
    private static final int IDEA_ID = 26373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26373Service() {
        this(new Idea26373Config());
    }

    public Idea26373Service(Idea26373Config config) {
        this.config = config != null ? config : new Idea26373Config();
