...
@Data
public class Idea26225Config {
    private String name = "idea_026225";
 ...
 */
@Slf4j
public class Idea26225Service {
    private static final int IDEA_ID = 26225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26225Service() {
        this(new Idea26225Config());
    }

    public Idea26225Service(Idea26225Config config) {
        this.config = config != null ? config : new Idea26225Config();
