...
@Data
public class Idea26175Config {
    private String name = "idea_026175";
 ...
 */
@Slf4j
public class Idea26175Service {
    private static final int IDEA_ID = 26175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26175Service() {
        this(new Idea26175Config());
    }

    public Idea26175Service(Idea26175Config config) {
        this.config = config != null ? config : new Idea26175Config();
