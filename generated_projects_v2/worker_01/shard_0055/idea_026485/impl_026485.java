...
@Data
public class Idea26485Config {
    private String name = "idea_026485";
 ...
 */
@Slf4j
public class Idea26485Service {
    private static final int IDEA_ID = 26485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26485Service() {
        this(new Idea26485Config());
    }

    public Idea26485Service(Idea26485Config config) {
        this.config = config != null ? config : new Idea26485Config();
