...
@Data
public class Idea26293Config {
    private String name = "idea_026293";
 ...
 */
@Slf4j
public class Idea26293Service {
    private static final int IDEA_ID = 26293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26293Service() {
        this(new Idea26293Config());
    }

    public Idea26293Service(Idea26293Config config) {
        this.config = config != null ? config : new Idea26293Config();
