...
@Data
public class Idea26170Config {
    private String name = "idea_026170";
 ...
 */
@Slf4j
public class Idea26170Service {
    private static final int IDEA_ID = 26170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26170Service() {
        this(new Idea26170Config());
    }

    public Idea26170Service(Idea26170Config config) {
        this.config = config != null ? config : new Idea26170Config();
