...
@Data
public class Idea26592Config {
    private String name = "idea_026592";
 ...
 */
@Slf4j
public class Idea26592Service {
    private static final int IDEA_ID = 26592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26592Service() {
        this(new Idea26592Config());
    }

    public Idea26592Service(Idea26592Config config) {
        this.config = config != null ? config : new Idea26592Config();
