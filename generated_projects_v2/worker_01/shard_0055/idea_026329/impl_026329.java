...
@Data
public class Idea26329Config {
    private String name = "idea_026329";
 ...
 */
@Slf4j
public class Idea26329Service {
    private static final int IDEA_ID = 26329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26329Service() {
        this(new Idea26329Config());
    }

    public Idea26329Service(Idea26329Config config) {
        this.config = config != null ? config : new Idea26329Config();
