...
@Data
public class Idea26554Config {
    private String name = "idea_026554";
 ...
 */
@Slf4j
public class Idea26554Service {
    private static final int IDEA_ID = 26554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26554Service() {
        this(new Idea26554Config());
    }

    public Idea26554Service(Idea26554Config config) {
        this.config = config != null ? config : new Idea26554Config();
