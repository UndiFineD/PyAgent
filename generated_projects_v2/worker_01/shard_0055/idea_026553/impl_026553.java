...
@Data
public class Idea26553Config {
    private String name = "idea_026553";
 ...
 */
@Slf4j
public class Idea26553Service {
    private static final int IDEA_ID = 26553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26553Service() {
        this(new Idea26553Config());
    }

    public Idea26553Service(Idea26553Config config) {
        this.config = config != null ? config : new Idea26553Config();
