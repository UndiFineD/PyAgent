...
@Data
public class Idea26475Config {
    private String name = "idea_026475";
 ...
 */
@Slf4j
public class Idea26475Service {
    private static final int IDEA_ID = 26475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26475Service() {
        this(new Idea26475Config());
    }

    public Idea26475Service(Idea26475Config config) {
        this.config = config != null ? config : new Idea26475Config();
