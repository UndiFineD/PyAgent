...
@Data
public class Idea26445Config {
    private String name = "idea_026445";
 ...
 */
@Slf4j
public class Idea26445Service {
    private static final int IDEA_ID = 26445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26445Service() {
        this(new Idea26445Config());
    }

    public Idea26445Service(Idea26445Config config) {
        this.config = config != null ? config : new Idea26445Config();
