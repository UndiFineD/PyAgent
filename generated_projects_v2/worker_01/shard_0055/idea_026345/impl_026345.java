...
@Data
public class Idea26345Config {
    private String name = "idea_026345";
 ...
 */
@Slf4j
public class Idea26345Service {
    private static final int IDEA_ID = 26345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26345Service() {
        this(new Idea26345Config());
    }

    public Idea26345Service(Idea26345Config config) {
        this.config = config != null ? config : new Idea26345Config();
