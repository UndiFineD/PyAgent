...
@Data
public class Idea26206Config {
    private String name = "idea_026206";
 ...
 */
@Slf4j
public class Idea26206Service {
    private static final int IDEA_ID = 26206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26206Service() {
        this(new Idea26206Config());
    }

    public Idea26206Service(Idea26206Config config) {
        this.config = config != null ? config : new Idea26206Config();
