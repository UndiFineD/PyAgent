...
@Data
public class Idea26584Config {
    private String name = "idea_026584";
 ...
 */
@Slf4j
public class Idea26584Service {
    private static final int IDEA_ID = 26584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26584Service() {
        this(new Idea26584Config());
    }

    public Idea26584Service(Idea26584Config config) {
        this.config = config != null ? config : new Idea26584Config();
