...
@Data
public class Idea26576Config {
    private String name = "idea_026576";
 ...
 */
@Slf4j
public class Idea26576Service {
    private static final int IDEA_ID = 26576;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26576Service() {
        this(new Idea26576Config());
    }

    public Idea26576Service(Idea26576Config config) {
        this.config = config != null ? config : new Idea26576Config();
