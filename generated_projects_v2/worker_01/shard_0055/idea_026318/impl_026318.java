...
@Data
public class Idea26318Config {
    private String name = "idea_026318";
 ...
 */
@Slf4j
public class Idea26318Service {
    private static final int IDEA_ID = 26318;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26318Service() {
        this(new Idea26318Config());
    }

    public Idea26318Service(Idea26318Config config) {
        this.config = config != null ? config : new Idea26318Config();
