...
@Data
public class Idea26155Config {
    private String name = "idea_026155";
 ...
 */
@Slf4j
public class Idea26155Service {
    private static final int IDEA_ID = 26155;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26155Service() {
        this(new Idea26155Config());
    }

    public Idea26155Service(Idea26155Config config) {
        this.config = config != null ? config : new Idea26155Config();
