...
@Data
public class Idea26572Config {
    private String name = "idea_026572";
 ...
 */
@Slf4j
public class Idea26572Service {
    private static final int IDEA_ID = 26572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26572Service() {
        this(new Idea26572Config());
    }

    public Idea26572Service(Idea26572Config config) {
        this.config = config != null ? config : new Idea26572Config();
