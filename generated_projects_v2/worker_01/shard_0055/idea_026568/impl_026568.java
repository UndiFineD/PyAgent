...
@Data
public class Idea26568Config {
    private String name = "idea_026568";
 ...
 */
@Slf4j
public class Idea26568Service {
    private static final int IDEA_ID = 26568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26568Service() {
        this(new Idea26568Config());
    }

    public Idea26568Service(Idea26568Config config) {
        this.config = config != null ? config : new Idea26568Config();
