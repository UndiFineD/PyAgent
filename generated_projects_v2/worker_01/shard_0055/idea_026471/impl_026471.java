...
@Data
public class Idea26471Config {
    private String name = "idea_026471";
 ...
 */
@Slf4j
public class Idea26471Service {
    private static final int IDEA_ID = 26471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26471Service() {
        this(new Idea26471Config());
    }

    public Idea26471Service(Idea26471Config config) {
        this.config = config != null ? config : new Idea26471Config();
