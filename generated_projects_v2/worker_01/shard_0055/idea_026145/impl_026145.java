...
@Data
public class Idea26145Config {
    private String name = "idea_026145";
 ...
 */
@Slf4j
public class Idea26145Service {
    private static final int IDEA_ID = 26145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26145Service() {
        this(new Idea26145Config());
    }

    public Idea26145Service(Idea26145Config config) {
        this.config = config != null ? config : new Idea26145Config();
