...
@Data
public class Idea26165Config {
    private String name = "idea_026165";
 ...
 */
@Slf4j
public class Idea26165Service {
    private static final int IDEA_ID = 26165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26165Service() {
        this(new Idea26165Config());
    }

    public Idea26165Service(Idea26165Config config) {
        this.config = config != null ? config : new Idea26165Config();
