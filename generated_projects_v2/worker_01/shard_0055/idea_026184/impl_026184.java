...
@Data
public class Idea26184Config {
    private String name = "idea_026184";
 ...
 */
@Slf4j
public class Idea26184Service {
    private static final int IDEA_ID = 26184;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26184Service() {
        this(new Idea26184Config());
    }

    public Idea26184Service(Idea26184Config config) {
        this.config = config != null ? config : new Idea26184Config();
