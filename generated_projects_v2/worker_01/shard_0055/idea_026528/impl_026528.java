...
@Data
public class Idea26528Config {
    private String name = "idea_026528";
 ...
 */
@Slf4j
public class Idea26528Service {
    private static final int IDEA_ID = 26528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26528Service() {
        this(new Idea26528Config());
    }

    public Idea26528Service(Idea26528Config config) {
        this.config = config != null ? config : new Idea26528Config();
