...
@Data
public class Idea26245Config {
    private String name = "idea_026245";
 ...
 */
@Slf4j
public class Idea26245Service {
    private static final int IDEA_ID = 26245;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26245Service() {
        this(new Idea26245Config());
    }

    public Idea26245Service(Idea26245Config config) {
        this.config = config != null ? config : new Idea26245Config();
