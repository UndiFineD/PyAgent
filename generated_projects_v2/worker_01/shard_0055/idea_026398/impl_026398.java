...
@Data
public class Idea26398Config {
    private String name = "idea_026398";
 ...
 */
@Slf4j
public class Idea26398Service {
    private static final int IDEA_ID = 26398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26398Service() {
        this(new Idea26398Config());
    }

    public Idea26398Service(Idea26398Config config) {
        this.config = config != null ? config : new Idea26398Config();
