...
@Data
public class Idea26510Config {
    private String name = "idea_026510";
 ...
 */
@Slf4j
public class Idea26510Service {
    private static final int IDEA_ID = 26510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26510Service() {
        this(new Idea26510Config());
    }

    public Idea26510Service(Idea26510Config config) {
        this.config = config != null ? config : new Idea26510Config();
