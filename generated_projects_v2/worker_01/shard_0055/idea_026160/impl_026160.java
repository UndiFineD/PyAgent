...
@Data
public class Idea26160Config {
    private String name = "idea_026160";
 ...
 */
@Slf4j
public class Idea26160Service {
    private static final int IDEA_ID = 26160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26160Service() {
        this(new Idea26160Config());
    }

    public Idea26160Service(Idea26160Config config) {
        this.config = config != null ? config : new Idea26160Config();
