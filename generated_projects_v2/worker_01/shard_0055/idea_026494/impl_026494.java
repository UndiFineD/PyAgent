...
@Data
public class Idea26494Config {
    private String name = "idea_026494";
 ...
 */
@Slf4j
public class Idea26494Service {
    private static final int IDEA_ID = 26494;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26494Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26494Service() {
        this(new Idea26494Config());
    }

    public Idea26494Service(Idea26494Config config) {
        this.config = config != null ? config : new Idea26494Config();
