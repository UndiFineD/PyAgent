...
@Data
public class Idea26365Config {
    private String name = "idea_026365";
 ...
 */
@Slf4j
public class Idea26365Service {
    private static final int IDEA_ID = 26365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26365Service() {
        this(new Idea26365Config());
    }

    public Idea26365Service(Idea26365Config config) {
        this.config = config != null ? config : new Idea26365Config();
