...
@Data
public class Idea26339Config {
    private String name = "idea_026339";
 ...
 */
@Slf4j
public class Idea26339Service {
    private static final int IDEA_ID = 26339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26339Service() {
        this(new Idea26339Config());
    }

    public Idea26339Service(Idea26339Config config) {
        this.config = config != null ? config : new Idea26339Config();
