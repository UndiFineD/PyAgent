...
@Data
public class Idea26200Config {
    private String name = "idea_026200";
 ...
 */
@Slf4j
public class Idea26200Service {
    private static final int IDEA_ID = 26200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26200Service() {
        this(new Idea26200Config());
    }

    public Idea26200Service(Idea26200Config config) {
        this.config = config != null ? config : new Idea26200Config();
