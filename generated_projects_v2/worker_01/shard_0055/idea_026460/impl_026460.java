...
@Data
public class Idea26460Config {
    private String name = "idea_026460";
 ...
 */
@Slf4j
public class Idea26460Service {
    private static final int IDEA_ID = 26460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26460Service() {
        this(new Idea26460Config());
    }

    public Idea26460Service(Idea26460Config config) {
        this.config = config != null ? config : new Idea26460Config();
