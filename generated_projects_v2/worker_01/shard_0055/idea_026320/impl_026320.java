...
@Data
public class Idea26320Config {
    private String name = "idea_026320";
 ...
 */
@Slf4j
public class Idea26320Service {
    private static final int IDEA_ID = 26320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26320Service() {
        this(new Idea26320Config());
    }

    public Idea26320Service(Idea26320Config config) {
        this.config = config != null ? config : new Idea26320Config();
