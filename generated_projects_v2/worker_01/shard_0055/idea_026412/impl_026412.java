...
@Data
public class Idea26412Config {
    private String name = "idea_026412";
 ...
 */
@Slf4j
public class Idea26412Service {
    private static final int IDEA_ID = 26412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26412Service() {
        this(new Idea26412Config());
    }

    public Idea26412Service(Idea26412Config config) {
        this.config = config != null ? config : new Idea26412Config();
