...
@Data
public class Idea26378Config {
    private String name = "idea_026378";
 ...
 */
@Slf4j
public class Idea26378Service {
    private static final int IDEA_ID = 26378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26378Service() {
        this(new Idea26378Config());
    }

    public Idea26378Service(Idea26378Config config) {
        this.config = config != null ? config : new Idea26378Config();
