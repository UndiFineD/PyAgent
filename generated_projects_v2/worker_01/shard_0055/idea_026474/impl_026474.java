...
@Data
public class Idea26474Config {
    private String name = "idea_026474";
 ...
 */
@Slf4j
public class Idea26474Service {
    private static final int IDEA_ID = 26474;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26474Service() {
        this(new Idea26474Config());
    }

    public Idea26474Service(Idea26474Config config) {
        this.config = config != null ? config : new Idea26474Config();
