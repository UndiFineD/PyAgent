...
@Data
public class Idea26483Config {
    private String name = "idea_026483";
 ...
 */
@Slf4j
public class Idea26483Service {
    private static final int IDEA_ID = 26483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26483Service() {
        this(new Idea26483Config());
    }

    public Idea26483Service(Idea26483Config config) {
        this.config = config != null ? config : new Idea26483Config();
