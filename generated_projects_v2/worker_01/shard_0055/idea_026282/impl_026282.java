...
@Data
public class Idea26282Config {
    private String name = "idea_026282";
 ...
 */
@Slf4j
public class Idea26282Service {
    private static final int IDEA_ID = 26282;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26282Service() {
        this(new Idea26282Config());
    }

    public Idea26282Service(Idea26282Config config) {
        this.config = config != null ? config : new Idea26282Config();
