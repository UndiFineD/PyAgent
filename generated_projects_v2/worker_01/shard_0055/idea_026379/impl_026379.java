...
@Data
public class Idea26379Config {
    private String name = "idea_026379";
 ...
 */
@Slf4j
public class Idea26379Service {
    private static final int IDEA_ID = 26379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26379Service() {
        this(new Idea26379Config());
    }

    public Idea26379Service(Idea26379Config config) {
        this.config = config != null ? config : new Idea26379Config();
