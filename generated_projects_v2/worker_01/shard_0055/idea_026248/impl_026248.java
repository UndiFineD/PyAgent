...
@Data
public class Idea26248Config {
    private String name = "idea_026248";
 ...
 */
@Slf4j
public class Idea26248Service {
    private static final int IDEA_ID = 26248;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26248Service() {
        this(new Idea26248Config());
    }

    public Idea26248Service(Idea26248Config config) {
        this.config = config != null ? config : new Idea26248Config();
