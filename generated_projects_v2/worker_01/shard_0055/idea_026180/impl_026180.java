...
@Data
public class Idea26180Config {
    private String name = "idea_026180";
 ...
 */
@Slf4j
public class Idea26180Service {
    private static final int IDEA_ID = 26180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26180Service() {
        this(new Idea26180Config());
    }

    public Idea26180Service(Idea26180Config config) {
        this.config = config != null ? config : new Idea26180Config();
