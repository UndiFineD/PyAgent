...
@Data
public class Idea26452Config {
    private String name = "idea_026452";
 ...
 */
@Slf4j
public class Idea26452Service {
    private static final int IDEA_ID = 26452;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26452Service() {
        this(new Idea26452Config());
    }

    public Idea26452Service(Idea26452Config config) {
        this.config = config != null ? config : new Idea26452Config();
