...
@Data
public class Idea26278Config {
    private String name = "idea_026278";
 ...
 */
@Slf4j
public class Idea26278Service {
    private static final int IDEA_ID = 26278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26278Service() {
        this(new Idea26278Config());
    }

    public Idea26278Service(Idea26278Config config) {
        this.config = config != null ? config : new Idea26278Config();
