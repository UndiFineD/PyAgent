...
@Data
public class Idea26490Config {
    private String name = "idea_026490";
 ...
 */
@Slf4j
public class Idea26490Service {
    private static final int IDEA_ID = 26490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26490Service() {
        this(new Idea26490Config());
    }

    public Idea26490Service(Idea26490Config config) {
        this.config = config != null ? config : new Idea26490Config();
