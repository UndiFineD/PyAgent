...
@Data
public class Idea26311Config {
    private String name = "idea_026311";
 ...
 */
@Slf4j
public class Idea26311Service {
    private static final int IDEA_ID = 26311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26311Service() {
        this(new Idea26311Config());
    }

    public Idea26311Service(Idea26311Config config) {
        this.config = config != null ? config : new Idea26311Config();
