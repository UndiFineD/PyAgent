...
@Data
public class Idea26277Config {
    private String name = "idea_026277";
 ...
 */
@Slf4j
public class Idea26277Service {
    private static final int IDEA_ID = 26277;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26277Service() {
        this(new Idea26277Config());
    }

    public Idea26277Service(Idea26277Config config) {
        this.config = config != null ? config : new Idea26277Config();
