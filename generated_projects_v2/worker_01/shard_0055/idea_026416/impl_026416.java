...
@Data
public class Idea26416Config {
    private String name = "idea_026416";
 ...
 */
@Slf4j
public class Idea26416Service {
    private static final int IDEA_ID = 26416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26416Service() {
        this(new Idea26416Config());
    }

    public Idea26416Service(Idea26416Config config) {
        this.config = config != null ? config : new Idea26416Config();
