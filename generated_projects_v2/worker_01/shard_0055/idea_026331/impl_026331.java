...
@Data
public class Idea26331Config {
    private String name = "idea_026331";
 ...
 */
@Slf4j
public class Idea26331Service {
    private static final int IDEA_ID = 26331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26331Service() {
        this(new Idea26331Config());
    }

    public Idea26331Service(Idea26331Config config) {
        this.config = config != null ? config : new Idea26331Config();
