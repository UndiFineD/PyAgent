...
@Data
public class Idea26354Config {
    private String name = "idea_026354";
 ...
 */
@Slf4j
public class Idea26354Service {
    private static final int IDEA_ID = 26354;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26354Service() {
        this(new Idea26354Config());
    }

    public Idea26354Service(Idea26354Config config) {
        this.config = config != null ? config : new Idea26354Config();
