...
@Data
public class Idea26454Config {
    private String name = "idea_026454";
 ...
 */
@Slf4j
public class Idea26454Service {
    private static final int IDEA_ID = 26454;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26454Service() {
        this(new Idea26454Config());
    }

    public Idea26454Service(Idea26454Config config) {
        this.config = config != null ? config : new Idea26454Config();
