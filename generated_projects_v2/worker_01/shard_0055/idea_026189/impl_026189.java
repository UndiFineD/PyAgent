...
@Data
public class Idea26189Config {
    private String name = "idea_026189";
 ...
 */
@Slf4j
public class Idea26189Service {
    private static final int IDEA_ID = 26189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26189Service() {
        this(new Idea26189Config());
    }

    public Idea26189Service(Idea26189Config config) {
        this.config = config != null ? config : new Idea26189Config();
