...
@Data
public class Idea26270Config {
    private String name = "idea_026270";
 ...
 */
@Slf4j
public class Idea26270Service {
    private static final int IDEA_ID = 26270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26270Service() {
        this(new Idea26270Config());
    }

    public Idea26270Service(Idea26270Config config) {
        this.config = config != null ? config : new Idea26270Config();
