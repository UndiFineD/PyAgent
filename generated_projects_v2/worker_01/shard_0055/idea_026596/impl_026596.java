...
@Data
public class Idea26596Config {
    private String name = "idea_026596";
 ...
 */
@Slf4j
public class Idea26596Service {
    private static final int IDEA_ID = 26596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26596Service() {
        this(new Idea26596Config());
    }

    public Idea26596Service(Idea26596Config config) {
        this.config = config != null ? config : new Idea26596Config();
