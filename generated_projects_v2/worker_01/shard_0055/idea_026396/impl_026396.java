...
@Data
public class Idea26396Config {
    private String name = "idea_026396";
 ...
 */
@Slf4j
public class Idea26396Service {
    private static final int IDEA_ID = 26396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26396Service() {
        this(new Idea26396Config());
    }

    public Idea26396Service(Idea26396Config config) {
        this.config = config != null ? config : new Idea26396Config();
