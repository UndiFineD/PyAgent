...
@Data
public class Idea26521Config {
    private String name = "idea_026521";
 ...
 */
@Slf4j
public class Idea26521Service {
    private static final int IDEA_ID = 26521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26521Service() {
        this(new Idea26521Config());
    }

    public Idea26521Service(Idea26521Config config) {
        this.config = config != null ? config : new Idea26521Config();
