...
@Data
public class Idea26569Config {
    private String name = "idea_026569";
 ...
 */
@Slf4j
public class Idea26569Service {
    private static final int IDEA_ID = 26569;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26569Service() {
        this(new Idea26569Config());
    }

    public Idea26569Service(Idea26569Config config) {
        this.config = config != null ? config : new Idea26569Config();
