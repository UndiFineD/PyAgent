...
@Data
public class Idea26128Config {
    private String name = "idea_026128";
 ...
 */
@Slf4j
public class Idea26128Service {
    private static final int IDEA_ID = 26128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26128Service() {
        this(new Idea26128Config());
    }

    public Idea26128Service(Idea26128Config config) {
        this.config = config != null ? config : new Idea26128Config();
