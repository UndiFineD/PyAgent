...
@Data
public class Idea26411Config {
    private String name = "idea_026411";
 ...
 */
@Slf4j
public class Idea26411Service {
    private static final int IDEA_ID = 26411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26411Service() {
        this(new Idea26411Config());
    }

    public Idea26411Service(Idea26411Config config) {
        this.config = config != null ? config : new Idea26411Config();
