...
@Data
public class Idea26529Config {
    private String name = "idea_026529";
 ...
 */
@Slf4j
public class Idea26529Service {
    private static final int IDEA_ID = 26529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26529Service() {
        this(new Idea26529Config());
    }

    public Idea26529Service(Idea26529Config config) {
        this.config = config != null ? config : new Idea26529Config();
