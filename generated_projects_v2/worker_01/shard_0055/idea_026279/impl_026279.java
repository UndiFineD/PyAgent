...
@Data
public class Idea26279Config {
    private String name = "idea_026279";
 ...
 */
@Slf4j
public class Idea26279Service {
    private static final int IDEA_ID = 26279;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26279Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26279Service() {
        this(new Idea26279Config());
    }

    public Idea26279Service(Idea26279Config config) {
        this.config = config != null ? config : new Idea26279Config();
