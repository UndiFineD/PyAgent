...
@Data
public class Idea26129Config {
    private String name = "idea_026129";
 ...
 */
@Slf4j
public class Idea26129Service {
    private static final int IDEA_ID = 26129;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26129Service() {
        this(new Idea26129Config());
    }

    public Idea26129Service(Idea26129Config config) {
        this.config = config != null ? config : new Idea26129Config();
