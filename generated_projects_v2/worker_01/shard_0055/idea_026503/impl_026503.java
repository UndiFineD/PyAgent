...
@Data
public class Idea26503Config {
    private String name = "idea_026503";
 ...
 */
@Slf4j
public class Idea26503Service {
    private static final int IDEA_ID = 26503;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26503Service() {
        this(new Idea26503Config());
    }

    public Idea26503Service(Idea26503Config config) {
        this.config = config != null ? config : new Idea26503Config();
