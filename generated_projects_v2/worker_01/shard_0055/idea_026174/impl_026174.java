...
@Data
public class Idea26174Config {
    private String name = "idea_026174";
 ...
 */
@Slf4j
public class Idea26174Service {
    private static final int IDEA_ID = 26174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26174Service() {
        this(new Idea26174Config());
    }

    public Idea26174Service(Idea26174Config config) {
        this.config = config != null ? config : new Idea26174Config();
