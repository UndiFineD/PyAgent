...
@Data
public class Idea26229Config {
    private String name = "idea_026229";
 ...
 */
@Slf4j
public class Idea26229Service {
    private static final int IDEA_ID = 26229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26229Service() {
        this(new Idea26229Config());
    }

    public Idea26229Service(Idea26229Config config) {
        this.config = config != null ? config : new Idea26229Config();
