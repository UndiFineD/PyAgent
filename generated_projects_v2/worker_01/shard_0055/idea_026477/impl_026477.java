...
@Data
public class Idea26477Config {
    private String name = "idea_026477";
 ...
 */
@Slf4j
public class Idea26477Service {
    private static final int IDEA_ID = 26477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26477Service() {
        this(new Idea26477Config());
    }

    public Idea26477Service(Idea26477Config config) {
        this.config = config != null ? config : new Idea26477Config();
