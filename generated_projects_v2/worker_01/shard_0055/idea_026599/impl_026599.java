...
@Data
public class Idea26599Config {
    private String name = "idea_026599";
 ...
 */
@Slf4j
public class Idea26599Service {
    private static final int IDEA_ID = 26599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26599Service() {
        this(new Idea26599Config());
    }

    public Idea26599Service(Idea26599Config config) {
        this.config = config != null ? config : new Idea26599Config();
