...
@Data
public class Idea26539Config {
    private String name = "idea_026539";
 ...
 */
@Slf4j
public class Idea26539Service {
    private static final int IDEA_ID = 26539;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26539Service() {
        this(new Idea26539Config());
    }

    public Idea26539Service(Idea26539Config config) {
        this.config = config != null ? config : new Idea26539Config();
