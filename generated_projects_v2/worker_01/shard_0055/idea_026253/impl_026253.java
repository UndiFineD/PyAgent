...
@Data
public class Idea26253Config {
    private String name = "idea_026253";
 ...
 */
@Slf4j
public class Idea26253Service {
    private static final int IDEA_ID = 26253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26253Service() {
        this(new Idea26253Config());
    }

    public Idea26253Service(Idea26253Config config) {
        this.config = config != null ? config : new Idea26253Config();
