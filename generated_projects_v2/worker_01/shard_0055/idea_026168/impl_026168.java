...
@Data
public class Idea26168Config {
    private String name = "idea_026168";
 ...
 */
@Slf4j
public class Idea26168Service {
    private static final int IDEA_ID = 26168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26168Service() {
        this(new Idea26168Config());
    }

    public Idea26168Service(Idea26168Config config) {
        this.config = config != null ? config : new Idea26168Config();
