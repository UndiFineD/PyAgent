...
@Data
public class Idea26404Config {
    private String name = "idea_026404";
 ...
 */
@Slf4j
public class Idea26404Service {
    private static final int IDEA_ID = 26404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26404Service() {
        this(new Idea26404Config());
    }

    public Idea26404Service(Idea26404Config config) {
        this.config = config != null ? config : new Idea26404Config();
