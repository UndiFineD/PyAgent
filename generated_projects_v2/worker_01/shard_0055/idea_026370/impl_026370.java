...
@Data
public class Idea26370Config {
    private String name = "idea_026370";
 ...
 */
@Slf4j
public class Idea26370Service {
    private static final int IDEA_ID = 26370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26370Service() {
        this(new Idea26370Config());
    }

    public Idea26370Service(Idea26370Config config) {
        this.config = config != null ? config : new Idea26370Config();
