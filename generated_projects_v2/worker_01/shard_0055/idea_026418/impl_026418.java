...
@Data
public class Idea26418Config {
    private String name = "idea_026418";
 ...
 */
@Slf4j
public class Idea26418Service {
    private static final int IDEA_ID = 26418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26418Service() {
        this(new Idea26418Config());
    }

    public Idea26418Service(Idea26418Config config) {
        this.config = config != null ? config : new Idea26418Config();
