...
@Data
public class Idea26520Config {
    private String name = "idea_026520";
 ...
 */
@Slf4j
public class Idea26520Service {
    private static final int IDEA_ID = 26520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26520Service() {
        this(new Idea26520Config());
    }

    public Idea26520Service(Idea26520Config config) {
        this.config = config != null ? config : new Idea26520Config();
