...
@Data
public class Idea26406Config {
    private String name = "idea_026406";
 ...
 */
@Slf4j
public class Idea26406Service {
    private static final int IDEA_ID = 26406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26406Service() {
        this(new Idea26406Config());
    }

    public Idea26406Service(Idea26406Config config) {
        this.config = config != null ? config : new Idea26406Config();
