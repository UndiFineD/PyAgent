...
@Data
public class Idea26369Config {
    private String name = "idea_026369";
 ...
 */
@Slf4j
public class Idea26369Service {
    private static final int IDEA_ID = 26369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26369Service() {
        this(new Idea26369Config());
    }

    public Idea26369Service(Idea26369Config config) {
        this.config = config != null ? config : new Idea26369Config();
