...
@Data
public class Idea26150Config {
    private String name = "idea_026150";
 ...
 */
@Slf4j
public class Idea26150Service {
    private static final int IDEA_ID = 26150;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26150Service() {
        this(new Idea26150Config());
    }

    public Idea26150Service(Idea26150Config config) {
        this.config = config != null ? config : new Idea26150Config();
