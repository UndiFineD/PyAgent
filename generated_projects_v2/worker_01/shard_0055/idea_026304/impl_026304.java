...
@Data
public class Idea26304Config {
    private String name = "idea_026304";
 ...
 */
@Slf4j
public class Idea26304Service {
    private static final int IDEA_ID = 26304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26304Service() {
        this(new Idea26304Config());
    }

    public Idea26304Service(Idea26304Config config) {
        this.config = config != null ? config : new Idea26304Config();
