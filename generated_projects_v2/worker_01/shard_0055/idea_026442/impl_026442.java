...
@Data
public class Idea26442Config {
    private String name = "idea_026442";
 ...
 */
@Slf4j
public class Idea26442Service {
    private static final int IDEA_ID = 26442;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26442Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26442Service() {
        this(new Idea26442Config());
    }

    public Idea26442Service(Idea26442Config config) {
        this.config = config != null ? config : new Idea26442Config();
