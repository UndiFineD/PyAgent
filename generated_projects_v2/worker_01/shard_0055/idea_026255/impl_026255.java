...
@Data
public class Idea26255Config {
    private String name = "idea_026255";
 ...
 */
@Slf4j
public class Idea26255Service {
    private static final int IDEA_ID = 26255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26255Service() {
        this(new Idea26255Config());
    }

    public Idea26255Service(Idea26255Config config) {
        this.config = config != null ? config : new Idea26255Config();
