...
@Data
public class Idea26227Config {
    private String name = "idea_026227";
 ...
 */
@Slf4j
public class Idea26227Service {
    private static final int IDEA_ID = 26227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26227Service() {
        this(new Idea26227Config());
    }

    public Idea26227Service(Idea26227Config config) {
        this.config = config != null ? config : new Idea26227Config();
