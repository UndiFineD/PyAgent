...
@Data
public class Idea26481Config {
    private String name = "idea_026481";
 ...
 */
@Slf4j
public class Idea26481Service {
    private static final int IDEA_ID = 26481;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26481Service() {
        this(new Idea26481Config());
    }

    public Idea26481Service(Idea26481Config config) {
        this.config = config != null ? config : new Idea26481Config();
