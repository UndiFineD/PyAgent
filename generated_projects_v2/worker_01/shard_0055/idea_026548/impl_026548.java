...
@Data
public class Idea26548Config {
    private String name = "idea_026548";
 ...
 */
@Slf4j
public class Idea26548Service {
    private static final int IDEA_ID = 26548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26548Service() {
        this(new Idea26548Config());
    }

    public Idea26548Service(Idea26548Config config) {
        this.config = config != null ? config : new Idea26548Config();
