...
@Data
public class Idea26291Config {
    private String name = "idea_026291";
 ...
 */
@Slf4j
public class Idea26291Service {
    private static final int IDEA_ID = 26291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26291Service() {
        this(new Idea26291Config());
    }

    public Idea26291Service(Idea26291Config config) {
        this.config = config != null ? config : new Idea26291Config();
