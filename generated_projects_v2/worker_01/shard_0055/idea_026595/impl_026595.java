...
@Data
public class Idea26595Config {
    private String name = "idea_026595";
 ...
 */
@Slf4j
public class Idea26595Service {
    private static final int IDEA_ID = 26595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26595Service() {
        this(new Idea26595Config());
    }

    public Idea26595Service(Idea26595Config config) {
        this.config = config != null ? config : new Idea26595Config();
