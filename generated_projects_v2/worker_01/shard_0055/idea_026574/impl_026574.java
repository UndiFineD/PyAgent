...
@Data
public class Idea26574Config {
    private String name = "idea_026574";
 ...
 */
@Slf4j
public class Idea26574Service {
    private static final int IDEA_ID = 26574;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26574Service() {
        this(new Idea26574Config());
    }

    public Idea26574Service(Idea26574Config config) {
        this.config = config != null ? config : new Idea26574Config();
