...
@Data
public class Idea26267Config {
    private String name = "idea_026267";
 ...
 */
@Slf4j
public class Idea26267Service {
    private static final int IDEA_ID = 26267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26267Service() {
        this(new Idea26267Config());
    }

    public Idea26267Service(Idea26267Config config) {
        this.config = config != null ? config : new Idea26267Config();
