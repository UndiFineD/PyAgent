...
@Data
public class Idea26323Config {
    private String name = "idea_026323";
 ...
 */
@Slf4j
public class Idea26323Service {
    private static final int IDEA_ID = 26323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26323Service() {
        this(new Idea26323Config());
    }

    public Idea26323Service(Idea26323Config config) {
        this.config = config != null ? config : new Idea26323Config();
