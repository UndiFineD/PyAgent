...
@Data
public class Idea26272Config {
    private String name = "idea_026272";
 ...
 */
@Slf4j
public class Idea26272Service {
    private static final int IDEA_ID = 26272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26272Service() {
        this(new Idea26272Config());
    }

    public Idea26272Service(Idea26272Config config) {
        this.config = config != null ? config : new Idea26272Config();
