...
@Data
public class Idea26262Config {
    private String name = "idea_026262";
 ...
 */
@Slf4j
public class Idea26262Service {
    private static final int IDEA_ID = 26262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26262Service() {
        this(new Idea26262Config());
    }

    public Idea26262Service(Idea26262Config config) {
        this.config = config != null ? config : new Idea26262Config();
