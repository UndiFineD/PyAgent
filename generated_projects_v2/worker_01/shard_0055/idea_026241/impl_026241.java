...
@Data
public class Idea26241Config {
    private String name = "idea_026241";
 ...
 */
@Slf4j
public class Idea26241Service {
    private static final int IDEA_ID = 26241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26241Service() {
        this(new Idea26241Config());
    }

    public Idea26241Service(Idea26241Config config) {
        this.config = config != null ? config : new Idea26241Config();
