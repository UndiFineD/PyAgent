...
@Data
public class Idea26446Config {
    private String name = "idea_026446";
 ...
 */
@Slf4j
public class Idea26446Service {
    private static final int IDEA_ID = 26446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26446Service() {
        this(new Idea26446Config());
    }

    public Idea26446Service(Idea26446Config config) {
        this.config = config != null ? config : new Idea26446Config();
