...
@Data
public class Idea26589Config {
    private String name = "idea_026589";
 ...
 */
@Slf4j
public class Idea26589Service {
    private static final int IDEA_ID = 26589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26589Service() {
        this(new Idea26589Config());
    }

    public Idea26589Service(Idea26589Config config) {
        this.config = config != null ? config : new Idea26589Config();
