...
@Data
public class Idea26177Config {
    private String name = "idea_026177";
 ...
 */
@Slf4j
public class Idea26177Service {
    private static final int IDEA_ID = 26177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26177Service() {
        this(new Idea26177Config());
    }

    public Idea26177Service(Idea26177Config config) {
        this.config = config != null ? config : new Idea26177Config();
