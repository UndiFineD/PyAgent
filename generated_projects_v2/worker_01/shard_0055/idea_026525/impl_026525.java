...
@Data
public class Idea26525Config {
    private String name = "idea_026525";
 ...
 */
@Slf4j
public class Idea26525Service {
    private static final int IDEA_ID = 26525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26525Service() {
        this(new Idea26525Config());
    }

    public Idea26525Service(Idea26525Config config) {
        this.config = config != null ? config : new Idea26525Config();
