...
@Data
public class Idea26142Config {
    private String name = "idea_026142";
 ...
 */
@Slf4j
public class Idea26142Service {
    private static final int IDEA_ID = 26142;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26142Service() {
        this(new Idea26142Config());
    }

    public Idea26142Service(Idea26142Config config) {
        this.config = config != null ? config : new Idea26142Config();
