...
@Data
public class Idea26457Config {
    private String name = "idea_026457";
 ...
 */
@Slf4j
public class Idea26457Service {
    private static final int IDEA_ID = 26457;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26457Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26457Service() {
        this(new Idea26457Config());
    }

    public Idea26457Service(Idea26457Config config) {
        this.config = config != null ? config : new Idea26457Config();
