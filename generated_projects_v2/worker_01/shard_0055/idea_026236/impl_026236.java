...
@Data
public class Idea26236Config {
    private String name = "idea_026236";
 ...
 */
@Slf4j
public class Idea26236Service {
    private static final int IDEA_ID = 26236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26236Service() {
        this(new Idea26236Config());
    }

    public Idea26236Service(Idea26236Config config) {
        this.config = config != null ? config : new Idea26236Config();
