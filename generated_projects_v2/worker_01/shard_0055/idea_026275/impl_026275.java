...
@Data
public class Idea26275Config {
    private String name = "idea_026275";
 ...
 */
@Slf4j
public class Idea26275Service {
    private static final int IDEA_ID = 26275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26275Service() {
        this(new Idea26275Config());
    }

    public Idea26275Service(Idea26275Config config) {
        this.config = config != null ? config : new Idea26275Config();
