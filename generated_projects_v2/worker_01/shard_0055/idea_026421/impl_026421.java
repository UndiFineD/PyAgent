...
@Data
public class Idea26421Config {
    private String name = "idea_026421";
 ...
 */
@Slf4j
public class Idea26421Service {
    private static final int IDEA_ID = 26421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26421Service() {
        this(new Idea26421Config());
    }

    public Idea26421Service(Idea26421Config config) {
        this.config = config != null ? config : new Idea26421Config();
