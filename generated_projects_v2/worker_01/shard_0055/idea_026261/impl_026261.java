...
@Data
public class Idea26261Config {
    private String name = "idea_026261";
 ...
 */
@Slf4j
public class Idea26261Service {
    private static final int IDEA_ID = 26261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26261Service() {
        this(new Idea26261Config());
    }

    public Idea26261Service(Idea26261Config config) {
        this.config = config != null ? config : new Idea26261Config();
