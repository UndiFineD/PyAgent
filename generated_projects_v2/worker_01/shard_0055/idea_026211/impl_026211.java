...
@Data
public class Idea26211Config {
    private String name = "idea_026211";
 ...
 */
@Slf4j
public class Idea26211Service {
    private static final int IDEA_ID = 26211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26211Service() {
        this(new Idea26211Config());
    }

    public Idea26211Service(Idea26211Config config) {
        this.config = config != null ? config : new Idea26211Config();
