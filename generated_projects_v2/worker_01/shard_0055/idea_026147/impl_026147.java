...
@Data
public class Idea26147Config {
    private String name = "idea_026147";
 ...
 */
@Slf4j
public class Idea26147Service {
    private static final int IDEA_ID = 26147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26147Service() {
        this(new Idea26147Config());
    }

    public Idea26147Service(Idea26147Config config) {
        this.config = config != null ? config : new Idea26147Config();
