...
@Data
public class Idea26394Config {
    private String name = "idea_026394";
 ...
 */
@Slf4j
public class Idea26394Service {
    private static final int IDEA_ID = 26394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26394Service() {
        this(new Idea26394Config());
    }

    public Idea26394Service(Idea26394Config config) {
        this.config = config != null ? config : new Idea26394Config();
