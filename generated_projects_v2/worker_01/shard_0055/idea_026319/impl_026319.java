...
@Data
public class Idea26319Config {
    private String name = "idea_026319";
 ...
 */
@Slf4j
public class Idea26319Service {
    private static final int IDEA_ID = 26319;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea26319Config config;
    private final Map<String, ProcessResult> cache;

    public Idea26319Service() {
        this(new Idea26319Config());
    }

    public Idea26319Service(Idea26319Config config) {
        this.config = config != null ? config : new Idea26319Config();
