...
@Data
public class Idea31695Config {
    private String name = "idea_031695";
 ...
 */
@Slf4j
public class Idea31695Service {
    private static final int IDEA_ID = 31695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31695Service() {
        this(new Idea31695Config());
    }

    public Idea31695Service(Idea31695Config config) {
        this.config = config != null ? config : new Idea31695Config();
