...
@Data
public class Idea31724Config {
    private String name = "idea_031724";
 ...
 */
@Slf4j
public class Idea31724Service {
    private static final int IDEA_ID = 31724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31724Service() {
        this(new Idea31724Config());
    }

    public Idea31724Service(Idea31724Config config) {
        this.config = config != null ? config : new Idea31724Config();
