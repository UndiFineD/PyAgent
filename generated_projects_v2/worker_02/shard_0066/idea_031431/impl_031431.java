...
@Data
public class Idea31431Config {
    private String name = "idea_031431";
 ...
 */
@Slf4j
public class Idea31431Service {
    private static final int IDEA_ID = 31431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31431Service() {
        this(new Idea31431Config());
    }

    public Idea31431Service(Idea31431Config config) {
        this.config = config != null ? config : new Idea31431Config();
