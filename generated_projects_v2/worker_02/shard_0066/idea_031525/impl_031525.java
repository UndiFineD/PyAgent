...
@Data
public class Idea31525Config {
    private String name = "idea_031525";
 ...
 */
@Slf4j
public class Idea31525Service {
    private static final int IDEA_ID = 31525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31525Service() {
        this(new Idea31525Config());
    }

    public Idea31525Service(Idea31525Config config) {
        this.config = config != null ? config : new Idea31525Config();
