...
@Data
public class Idea31490Config {
    private String name = "idea_031490";
 ...
 */
@Slf4j
public class Idea31490Service {
    private static final int IDEA_ID = 31490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31490Service() {
        this(new Idea31490Config());
    }

    public Idea31490Service(Idea31490Config config) {
        this.config = config != null ? config : new Idea31490Config();
