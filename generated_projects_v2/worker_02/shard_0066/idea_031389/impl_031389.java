...
@Data
public class Idea31389Config {
    private String name = "idea_031389";
 ...
 */
@Slf4j
public class Idea31389Service {
    private static final int IDEA_ID = 31389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31389Service() {
        this(new Idea31389Config());
    }

    public Idea31389Service(Idea31389Config config) {
        this.config = config != null ? config : new Idea31389Config();
