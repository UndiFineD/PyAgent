...
@Data
public class Idea31699Config {
    private String name = "idea_031699";
 ...
 */
@Slf4j
public class Idea31699Service {
    private static final int IDEA_ID = 31699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31699Service() {
        this(new Idea31699Config());
    }

    public Idea31699Service(Idea31699Config config) {
        this.config = config != null ? config : new Idea31699Config();
