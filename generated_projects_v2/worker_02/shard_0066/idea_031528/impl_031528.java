...
@Data
public class Idea31528Config {
    private String name = "idea_031528";
 ...
 */
@Slf4j
public class Idea31528Service {
    private static final int IDEA_ID = 31528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31528Service() {
        this(new Idea31528Config());
    }

    public Idea31528Service(Idea31528Config config) {
        this.config = config != null ? config : new Idea31528Config();
