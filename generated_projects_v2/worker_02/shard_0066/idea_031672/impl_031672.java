...
@Data
public class Idea31672Config {
    private String name = "idea_031672";
 ...
 */
@Slf4j
public class Idea31672Service {
    private static final int IDEA_ID = 31672;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31672Service() {
        this(new Idea31672Config());
    }

    public Idea31672Service(Idea31672Config config) {
        this.config = config != null ? config : new Idea31672Config();
