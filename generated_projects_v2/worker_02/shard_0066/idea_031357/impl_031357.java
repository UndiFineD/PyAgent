...
@Data
public class Idea31357Config {
    private String name = "idea_031357";
 ...
 */
@Slf4j
public class Idea31357Service {
    private static final int IDEA_ID = 31357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31357Service() {
        this(new Idea31357Config());
    }

    public Idea31357Service(Idea31357Config config) {
        this.config = config != null ? config : new Idea31357Config();
