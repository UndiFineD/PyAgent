...
@Data
public class Idea31630Config {
    private String name = "idea_031630";
 ...
 */
@Slf4j
public class Idea31630Service {
    private static final int IDEA_ID = 31630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31630Service() {
        this(new Idea31630Config());
    }

    public Idea31630Service(Idea31630Config config) {
        this.config = config != null ? config : new Idea31630Config();
