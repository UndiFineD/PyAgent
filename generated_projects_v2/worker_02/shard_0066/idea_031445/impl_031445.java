...
@Data
public class Idea31445Config {
    private String name = "idea_031445";
 ...
 */
@Slf4j
public class Idea31445Service {
    private static final int IDEA_ID = 31445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31445Service() {
        this(new Idea31445Config());
    }

    public Idea31445Service(Idea31445Config config) {
        this.config = config != null ? config : new Idea31445Config();
