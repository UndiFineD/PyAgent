...
@Data
public class Idea31671Config {
    private String name = "idea_031671";
 ...
 */
@Slf4j
public class Idea31671Service {
    private static final int IDEA_ID = 31671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31671Service() {
        this(new Idea31671Config());
    }

    public Idea31671Service(Idea31671Config config) {
        this.config = config != null ? config : new Idea31671Config();
