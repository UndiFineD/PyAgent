...
@Data
public class Idea31486Config {
    private String name = "idea_031486";
 ...
 */
@Slf4j
public class Idea31486Service {
    private static final int IDEA_ID = 31486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31486Service() {
        this(new Idea31486Config());
    }

    public Idea31486Service(Idea31486Config config) {
        this.config = config != null ? config : new Idea31486Config();
