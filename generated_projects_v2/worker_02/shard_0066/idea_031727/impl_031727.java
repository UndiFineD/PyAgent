...
@Data
public class Idea31727Config {
    private String name = "idea_031727";
 ...
 */
@Slf4j
public class Idea31727Service {
    private static final int IDEA_ID = 31727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31727Service() {
        this(new Idea31727Config());
    }

    public Idea31727Service(Idea31727Config config) {
        this.config = config != null ? config : new Idea31727Config();
