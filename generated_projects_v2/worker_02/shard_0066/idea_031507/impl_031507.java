...
@Data
public class Idea31507Config {
    private String name = "idea_031507";
 ...
 */
@Slf4j
public class Idea31507Service {
    private static final int IDEA_ID = 31507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31507Service() {
        this(new Idea31507Config());
    }

    public Idea31507Service(Idea31507Config config) {
        this.config = config != null ? config : new Idea31507Config();
