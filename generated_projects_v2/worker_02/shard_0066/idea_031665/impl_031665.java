...
@Data
public class Idea31665Config {
    private String name = "idea_031665";
 ...
 */
@Slf4j
public class Idea31665Service {
    private static final int IDEA_ID = 31665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31665Service() {
        this(new Idea31665Config());
    }

    public Idea31665Service(Idea31665Config config) {
        this.config = config != null ? config : new Idea31665Config();
