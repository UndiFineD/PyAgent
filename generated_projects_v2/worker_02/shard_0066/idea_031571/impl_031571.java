...
@Data
public class Idea31571Config {
    private String name = "idea_031571";
 ...
 */
@Slf4j
public class Idea31571Service {
    private static final int IDEA_ID = 31571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31571Service() {
        this(new Idea31571Config());
    }

    public Idea31571Service(Idea31571Config config) {
        this.config = config != null ? config : new Idea31571Config();
