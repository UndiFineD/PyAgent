...
@Data
public class Idea31395Config {
    private String name = "idea_031395";
 ...
 */
@Slf4j
public class Idea31395Service {
    private static final int IDEA_ID = 31395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31395Service() {
        this(new Idea31395Config());
    }

    public Idea31395Service(Idea31395Config config) {
        this.config = config != null ? config : new Idea31395Config();
