...
@Data
public class Idea31588Config {
    private String name = "idea_031588";
 ...
 */
@Slf4j
public class Idea31588Service {
    private static final int IDEA_ID = 31588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31588Service() {
        this(new Idea31588Config());
    }

    public Idea31588Service(Idea31588Config config) {
        this.config = config != null ? config : new Idea31588Config();
