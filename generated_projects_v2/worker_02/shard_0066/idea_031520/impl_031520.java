...
@Data
public class Idea31520Config {
    private String name = "idea_031520";
 ...
 */
@Slf4j
public class Idea31520Service {
    private static final int IDEA_ID = 31520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31520Service() {
        this(new Idea31520Config());
    }

    public Idea31520Service(Idea31520Config config) {
        this.config = config != null ? config : new Idea31520Config();
