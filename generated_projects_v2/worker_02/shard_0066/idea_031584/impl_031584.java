...
@Data
public class Idea31584Config {
    private String name = "idea_031584";
 ...
 */
@Slf4j
public class Idea31584Service {
    private static final int IDEA_ID = 31584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31584Service() {
        this(new Idea31584Config());
    }

    public Idea31584Service(Idea31584Config config) {
        this.config = config != null ? config : new Idea31584Config();
