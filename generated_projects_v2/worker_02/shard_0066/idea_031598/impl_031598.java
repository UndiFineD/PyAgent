...
@Data
public class Idea31598Config {
    private String name = "idea_031598";
 ...
 */
@Slf4j
public class Idea31598Service {
    private static final int IDEA_ID = 31598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31598Service() {
        this(new Idea31598Config());
    }

    public Idea31598Service(Idea31598Config config) {
        this.config = config != null ? config : new Idea31598Config();
