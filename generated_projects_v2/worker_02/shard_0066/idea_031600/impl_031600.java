...
@Data
public class Idea31600Config {
    private String name = "idea_031600";
 ...
 */
@Slf4j
public class Idea31600Service {
    private static final int IDEA_ID = 31600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31600Service() {
        this(new Idea31600Config());
    }

    public Idea31600Service(Idea31600Config config) {
        this.config = config != null ? config : new Idea31600Config();
