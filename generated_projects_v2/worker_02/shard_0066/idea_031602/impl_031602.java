...
@Data
public class Idea31602Config {
    private String name = "idea_031602";
 ...
 */
@Slf4j
public class Idea31602Service {
    private static final int IDEA_ID = 31602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31602Service() {
        this(new Idea31602Config());
    }

    public Idea31602Service(Idea31602Config config) {
        this.config = config != null ? config : new Idea31602Config();
