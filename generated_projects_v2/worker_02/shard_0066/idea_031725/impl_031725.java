...
@Data
public class Idea31725Config {
    private String name = "idea_031725";
 ...
 */
@Slf4j
public class Idea31725Service {
    private static final int IDEA_ID = 31725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31725Service() {
        this(new Idea31725Config());
    }

    public Idea31725Service(Idea31725Config config) {
        this.config = config != null ? config : new Idea31725Config();
