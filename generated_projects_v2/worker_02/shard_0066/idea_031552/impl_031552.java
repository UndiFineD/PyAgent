...
@Data
public class Idea31552Config {
    private String name = "idea_031552";
 ...
 */
@Slf4j
public class Idea31552Service {
    private static final int IDEA_ID = 31552;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31552Service() {
        this(new Idea31552Config());
    }

    public Idea31552Service(Idea31552Config config) {
        this.config = config != null ? config : new Idea31552Config();
