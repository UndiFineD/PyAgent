...
@Data
public class Idea31771Config {
    private String name = "idea_031771";
 ...
 */
@Slf4j
public class Idea31771Service {
    private static final int IDEA_ID = 31771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31771Service() {
        this(new Idea31771Config());
    }

    public Idea31771Service(Idea31771Config config) {
        this.config = config != null ? config : new Idea31771Config();
