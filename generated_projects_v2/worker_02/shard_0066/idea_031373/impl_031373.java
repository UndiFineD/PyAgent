...
@Data
public class Idea31373Config {
    private String name = "idea_031373";
 ...
 */
@Slf4j
public class Idea31373Service {
    private static final int IDEA_ID = 31373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31373Service() {
        this(new Idea31373Config());
    }

    public Idea31373Service(Idea31373Config config) {
        this.config = config != null ? config : new Idea31373Config();
