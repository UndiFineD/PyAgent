...
@Data
public class Idea31807Config {
    private String name = "idea_031807";
 ...
 */
@Slf4j
public class Idea31807Service {
    private static final int IDEA_ID = 31807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31807Service() {
        this(new Idea31807Config());
    }

    public Idea31807Service(Idea31807Config config) {
        this.config = config != null ? config : new Idea31807Config();
