...
@Data
public class Idea31610Config {
    private String name = "idea_031610";
 ...
 */
@Slf4j
public class Idea31610Service {
    private static final int IDEA_ID = 31610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31610Service() {
        this(new Idea31610Config());
    }

    public Idea31610Service(Idea31610Config config) {
        this.config = config != null ? config : new Idea31610Config();
