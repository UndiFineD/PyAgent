...
@Data
public class Idea31590Config {
    private String name = "idea_031590";
 ...
 */
@Slf4j
public class Idea31590Service {
    private static final int IDEA_ID = 31590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31590Service() {
        this(new Idea31590Config());
    }

    public Idea31590Service(Idea31590Config config) {
        this.config = config != null ? config : new Idea31590Config();
