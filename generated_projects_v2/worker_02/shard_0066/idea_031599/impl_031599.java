...
@Data
public class Idea31599Config {
    private String name = "idea_031599";
 ...
 */
@Slf4j
public class Idea31599Service {
    private static final int IDEA_ID = 31599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31599Service() {
        this(new Idea31599Config());
    }

    public Idea31599Service(Idea31599Config config) {
        this.config = config != null ? config : new Idea31599Config();
