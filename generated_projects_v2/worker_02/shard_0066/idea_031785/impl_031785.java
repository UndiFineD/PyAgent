...
@Data
public class Idea31785Config {
    private String name = "idea_031785";
 ...
 */
@Slf4j
public class Idea31785Service {
    private static final int IDEA_ID = 31785;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31785Service() {
        this(new Idea31785Config());
    }

    public Idea31785Service(Idea31785Config config) {
        this.config = config != null ? config : new Idea31785Config();
