...
@Data
public class Idea31612Config {
    private String name = "idea_031612";
 ...
 */
@Slf4j
public class Idea31612Service {
    private static final int IDEA_ID = 31612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31612Service() {
        this(new Idea31612Config());
    }

    public Idea31612Service(Idea31612Config config) {
        this.config = config != null ? config : new Idea31612Config();
