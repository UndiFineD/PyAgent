...
@Data
public class Idea31765Config {
    private String name = "idea_031765";
 ...
 */
@Slf4j
public class Idea31765Service {
    private static final int IDEA_ID = 31765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31765Service() {
        this(new Idea31765Config());
    }

    public Idea31765Service(Idea31765Config config) {
        this.config = config != null ? config : new Idea31765Config();
