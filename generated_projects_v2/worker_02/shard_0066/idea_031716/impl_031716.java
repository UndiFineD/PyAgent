...
@Data
public class Idea31716Config {
    private String name = "idea_031716";
 ...
 */
@Slf4j
public class Idea31716Service {
    private static final int IDEA_ID = 31716;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31716Service() {
        this(new Idea31716Config());
    }

    public Idea31716Service(Idea31716Config config) {
        this.config = config != null ? config : new Idea31716Config();
