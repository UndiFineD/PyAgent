...
@Data
public class Idea31757Config {
    private String name = "idea_031757";
 ...
 */
@Slf4j
public class Idea31757Service {
    private static final int IDEA_ID = 31757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31757Service() {
        this(new Idea31757Config());
    }

    public Idea31757Service(Idea31757Config config) {
        this.config = config != null ? config : new Idea31757Config();
