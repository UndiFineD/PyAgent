...
@Data
public class Idea31480Config {
    private String name = "idea_031480";
 ...
 */
@Slf4j
public class Idea31480Service {
    private static final int IDEA_ID = 31480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31480Service() {
        this(new Idea31480Config());
    }

    public Idea31480Service(Idea31480Config config) {
        this.config = config != null ? config : new Idea31480Config();
