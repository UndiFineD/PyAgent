...
@Data
public class Idea31621Config {
    private String name = "idea_031621";
 ...
 */
@Slf4j
public class Idea31621Service {
    private static final int IDEA_ID = 31621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31621Service() {
        this(new Idea31621Config());
    }

    public Idea31621Service(Idea31621Config config) {
        this.config = config != null ? config : new Idea31621Config();
