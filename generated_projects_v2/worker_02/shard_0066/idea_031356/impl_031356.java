...
@Data
public class Idea31356Config {
    private String name = "idea_031356";
 ...
 */
@Slf4j
public class Idea31356Service {
    private static final int IDEA_ID = 31356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31356Service() {
        this(new Idea31356Config());
    }

    public Idea31356Service(Idea31356Config config) {
        this.config = config != null ? config : new Idea31356Config();
