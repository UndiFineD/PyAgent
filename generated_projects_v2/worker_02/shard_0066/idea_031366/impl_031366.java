...
@Data
public class Idea31366Config {
    private String name = "idea_031366";
 ...
 */
@Slf4j
public class Idea31366Service {
    private static final int IDEA_ID = 31366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31366Service() {
        this(new Idea31366Config());
    }

    public Idea31366Service(Idea31366Config config) {
        this.config = config != null ? config : new Idea31366Config();
