...
@Data
public class Idea31620Config {
    private String name = "idea_031620";
 ...
 */
@Slf4j
public class Idea31620Service {
    private static final int IDEA_ID = 31620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31620Service() {
        this(new Idea31620Config());
    }

    public Idea31620Service(Idea31620Config config) {
        this.config = config != null ? config : new Idea31620Config();
