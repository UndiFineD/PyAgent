...
@Data
public class Idea31795Config {
    private String name = "idea_031795";
 ...
 */
@Slf4j
public class Idea31795Service {
    private static final int IDEA_ID = 31795;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31795Service() {
        this(new Idea31795Config());
    }

    public Idea31795Service(Idea31795Config config) {
        this.config = config != null ? config : new Idea31795Config();
