...
@Data
public class Idea31512Config {
    private String name = "idea_031512";
 ...
 */
@Slf4j
public class Idea31512Service {
    private static final int IDEA_ID = 31512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31512Service() {
        this(new Idea31512Config());
    }

    public Idea31512Service(Idea31512Config config) {
        this.config = config != null ? config : new Idea31512Config();
