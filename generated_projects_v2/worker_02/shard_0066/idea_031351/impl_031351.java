...
@Data
public class Idea31351Config {
    private String name = "idea_031351";
 ...
 */
@Slf4j
public class Idea31351Service {
    private static final int IDEA_ID = 31351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31351Service() {
        this(new Idea31351Config());
    }

    public Idea31351Service(Idea31351Config config) {
        this.config = config != null ? config : new Idea31351Config();
