...
@Data
public class Idea31790Config {
    private String name = "idea_031790";
 ...
 */
@Slf4j
public class Idea31790Service {
    private static final int IDEA_ID = 31790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31790Service() {
        this(new Idea31790Config());
    }

    public Idea31790Service(Idea31790Config config) {
        this.config = config != null ? config : new Idea31790Config();
