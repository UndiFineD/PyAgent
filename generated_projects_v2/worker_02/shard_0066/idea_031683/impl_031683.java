...
@Data
public class Idea31683Config {
    private String name = "idea_031683";
 ...
 */
@Slf4j
public class Idea31683Service {
    private static final int IDEA_ID = 31683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31683Service() {
        this(new Idea31683Config());
    }

    public Idea31683Service(Idea31683Config config) {
        this.config = config != null ? config : new Idea31683Config();
