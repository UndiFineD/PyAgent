...
@Data
public class Idea31483Config {
    private String name = "idea_031483";
 ...
 */
@Slf4j
public class Idea31483Service {
    private static final int IDEA_ID = 31483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31483Service() {
        this(new Idea31483Config());
    }

    public Idea31483Service(Idea31483Config config) {
        this.config = config != null ? config : new Idea31483Config();
