...
@Data
public class Idea31402Config {
    private String name = "idea_031402";
 ...
 */
@Slf4j
public class Idea31402Service {
    private static final int IDEA_ID = 31402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31402Service() {
        this(new Idea31402Config());
    }

    public Idea31402Service(Idea31402Config config) {
        this.config = config != null ? config : new Idea31402Config();
