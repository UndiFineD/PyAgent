...
@Data
public class Idea31736Config {
    private String name = "idea_031736";
 ...
 */
@Slf4j
public class Idea31736Service {
    private static final int IDEA_ID = 31736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31736Service() {
        this(new Idea31736Config());
    }

    public Idea31736Service(Idea31736Config config) {
        this.config = config != null ? config : new Idea31736Config();
