...
@Data
public class Idea31516Config {
    private String name = "idea_031516";
 ...
 */
@Slf4j
public class Idea31516Service {
    private static final int IDEA_ID = 31516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31516Service() {
        this(new Idea31516Config());
    }

    public Idea31516Service(Idea31516Config config) {
        this.config = config != null ? config : new Idea31516Config();
