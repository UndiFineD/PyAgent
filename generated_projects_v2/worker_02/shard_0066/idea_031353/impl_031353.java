...
@Data
public class Idea31353Config {
    private String name = "idea_031353";
 ...
 */
@Slf4j
public class Idea31353Service {
    private static final int IDEA_ID = 31353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31353Service() {
        this(new Idea31353Config());
    }

    public Idea31353Service(Idea31353Config config) {
        this.config = config != null ? config : new Idea31353Config();
