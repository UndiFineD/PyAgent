...
@Data
public class Idea31371Config {
    private String name = "idea_031371";
 ...
 */
@Slf4j
public class Idea31371Service {
    private static final int IDEA_ID = 31371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31371Service() {
        this(new Idea31371Config());
    }

    public Idea31371Service(Idea31371Config config) {
        this.config = config != null ? config : new Idea31371Config();
