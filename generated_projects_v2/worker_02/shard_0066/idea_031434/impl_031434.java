...
@Data
public class Idea31434Config {
    private String name = "idea_031434";
 ...
 */
@Slf4j
public class Idea31434Service {
    private static final int IDEA_ID = 31434;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31434Service() {
        this(new Idea31434Config());
    }

    public Idea31434Service(Idea31434Config config) {
        this.config = config != null ? config : new Idea31434Config();
