...
@Data
public class Idea31796Config {
    private String name = "idea_031796";
 ...
 */
@Slf4j
public class Idea31796Service {
    private static final int IDEA_ID = 31796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31796Service() {
        this(new Idea31796Config());
    }

    public Idea31796Service(Idea31796Config config) {
        this.config = config != null ? config : new Idea31796Config();
