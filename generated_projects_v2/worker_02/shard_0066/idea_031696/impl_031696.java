...
@Data
public class Idea31696Config {
    private String name = "idea_031696";
 ...
 */
@Slf4j
public class Idea31696Service {
    private static final int IDEA_ID = 31696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31696Service() {
        this(new Idea31696Config());
    }

    public Idea31696Service(Idea31696Config config) {
        this.config = config != null ? config : new Idea31696Config();
