...
@Data
public class Idea31709Config {
    private String name = "idea_031709";
 ...
 */
@Slf4j
public class Idea31709Service {
    private static final int IDEA_ID = 31709;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31709Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31709Service() {
        this(new Idea31709Config());
    }

    public Idea31709Service(Idea31709Config config) {
        this.config = config != null ? config : new Idea31709Config();
