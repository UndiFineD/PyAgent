...
@Data
public class Idea31363Config {
    private String name = "idea_031363";
 ...
 */
@Slf4j
public class Idea31363Service {
    private static final int IDEA_ID = 31363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31363Service() {
        this(new Idea31363Config());
    }

    public Idea31363Service(Idea31363Config config) {
        this.config = config != null ? config : new Idea31363Config();
