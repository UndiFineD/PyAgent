...
@Data
public class Idea31475Config {
    private String name = "idea_031475";
 ...
 */
@Slf4j
public class Idea31475Service {
    private static final int IDEA_ID = 31475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31475Service() {
        this(new Idea31475Config());
    }

    public Idea31475Service(Idea31475Config config) {
        this.config = config != null ? config : new Idea31475Config();
