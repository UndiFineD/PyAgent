...
@Data
public class Idea31745Config {
    private String name = "idea_031745";
 ...
 */
@Slf4j
public class Idea31745Service {
    private static final int IDEA_ID = 31745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31745Service() {
        this(new Idea31745Config());
    }

    public Idea31745Service(Idea31745Config config) {
        this.config = config != null ? config : new Idea31745Config();
