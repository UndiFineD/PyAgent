...
@Data
public class Idea31515Config {
    private String name = "idea_031515";
 ...
 */
@Slf4j
public class Idea31515Service {
    private static final int IDEA_ID = 31515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31515Service() {
        this(new Idea31515Config());
    }

    public Idea31515Service(Idea31515Config config) {
        this.config = config != null ? config : new Idea31515Config();
