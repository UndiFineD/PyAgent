...
@Data
public class Idea31412Config {
    private String name = "idea_031412";
 ...
 */
@Slf4j
public class Idea31412Service {
    private static final int IDEA_ID = 31412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31412Service() {
        this(new Idea31412Config());
    }

    public Idea31412Service(Idea31412Config config) {
        this.config = config != null ? config : new Idea31412Config();
