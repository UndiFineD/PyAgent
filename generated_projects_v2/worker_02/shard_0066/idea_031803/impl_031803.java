...
@Data
public class Idea31803Config {
    private String name = "idea_031803";
 ...
 */
@Slf4j
public class Idea31803Service {
    private static final int IDEA_ID = 31803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31803Service() {
        this(new Idea31803Config());
    }

    public Idea31803Service(Idea31803Config config) {
        this.config = config != null ? config : new Idea31803Config();
