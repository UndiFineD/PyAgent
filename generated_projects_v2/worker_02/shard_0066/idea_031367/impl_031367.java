...
@Data
public class Idea31367Config {
    private String name = "idea_031367";
 ...
 */
@Slf4j
public class Idea31367Service {
    private static final int IDEA_ID = 31367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31367Service() {
        this(new Idea31367Config());
    }

    public Idea31367Service(Idea31367Config config) {
        this.config = config != null ? config : new Idea31367Config();
