...
@Data
public class Idea31368Config {
    private String name = "idea_031368";
 ...
 */
@Slf4j
public class Idea31368Service {
    private static final int IDEA_ID = 31368;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31368Service() {
        this(new Idea31368Config());
    }

    public Idea31368Service(Idea31368Config config) {
        this.config = config != null ? config : new Idea31368Config();
