...
@Data
public class Idea31606Config {
    private String name = "idea_031606";
 ...
 */
@Slf4j
public class Idea31606Service {
    private static final int IDEA_ID = 31606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31606Service() {
        this(new Idea31606Config());
    }

    public Idea31606Service(Idea31606Config config) {
        this.config = config != null ? config : new Idea31606Config();
