...
@Data
public class Idea31637Config {
    private String name = "idea_031637";
 ...
 */
@Slf4j
public class Idea31637Service {
    private static final int IDEA_ID = 31637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31637Service() {
        this(new Idea31637Config());
    }

    public Idea31637Service(Idea31637Config config) {
        this.config = config != null ? config : new Idea31637Config();
