...
@Data
public class Idea31627Config {
    private String name = "idea_031627";
 ...
 */
@Slf4j
public class Idea31627Service {
    private static final int IDEA_ID = 31627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31627Service() {
        this(new Idea31627Config());
    }

    public Idea31627Service(Idea31627Config config) {
        this.config = config != null ? config : new Idea31627Config();
