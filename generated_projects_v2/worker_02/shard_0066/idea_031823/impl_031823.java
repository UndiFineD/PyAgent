...
@Data
public class Idea31823Config {
    private String name = "idea_031823";
 ...
 */
@Slf4j
public class Idea31823Service {
    private static final int IDEA_ID = 31823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31823Service() {
        this(new Idea31823Config());
    }

    public Idea31823Service(Idea31823Config config) {
        this.config = config != null ? config : new Idea31823Config();
