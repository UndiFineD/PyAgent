...
@Data
public class Idea31421Config {
    private String name = "idea_031421";
 ...
 */
@Slf4j
public class Idea31421Service {
    private static final int IDEA_ID = 31421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31421Service() {
        this(new Idea31421Config());
    }

    public Idea31421Service(Idea31421Config config) {
        this.config = config != null ? config : new Idea31421Config();
