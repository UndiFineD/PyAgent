...
@Data
public class Idea31485Config {
    private String name = "idea_031485";
 ...
 */
@Slf4j
public class Idea31485Service {
    private static final int IDEA_ID = 31485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31485Service() {
        this(new Idea31485Config());
    }

    public Idea31485Service(Idea31485Config config) {
        this.config = config != null ? config : new Idea31485Config();
