...
@Data
public class Idea31361Config {
    private String name = "idea_031361";
 ...
 */
@Slf4j
public class Idea31361Service {
    private static final int IDEA_ID = 31361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31361Service() {
        this(new Idea31361Config());
    }

    public Idea31361Service(Idea31361Config config) {
        this.config = config != null ? config : new Idea31361Config();
