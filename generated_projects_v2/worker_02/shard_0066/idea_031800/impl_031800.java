...
@Data
public class Idea31800Config {
    private String name = "idea_031800";
 ...
 */
@Slf4j
public class Idea31800Service {
    private static final int IDEA_ID = 31800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31800Service() {
        this(new Idea31800Config());
    }

    public Idea31800Service(Idea31800Config config) {
        this.config = config != null ? config : new Idea31800Config();
