...
@Data
public class Idea31438Config {
    private String name = "idea_031438";
 ...
 */
@Slf4j
public class Idea31438Service {
    private static final int IDEA_ID = 31438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31438Service() {
        this(new Idea31438Config());
    }

    public Idea31438Service(Idea31438Config config) {
        this.config = config != null ? config : new Idea31438Config();
