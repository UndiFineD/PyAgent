...
@Data
public class Idea31682Config {
    private String name = "idea_031682";
 ...
 */
@Slf4j
public class Idea31682Service {
    private static final int IDEA_ID = 31682;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31682Service() {
        this(new Idea31682Config());
    }

    public Idea31682Service(Idea31682Config config) {
        this.config = config != null ? config : new Idea31682Config();
