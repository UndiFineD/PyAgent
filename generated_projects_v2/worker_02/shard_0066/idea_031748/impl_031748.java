...
@Data
public class Idea31748Config {
    private String name = "idea_031748";
 ...
 */
@Slf4j
public class Idea31748Service {
    private static final int IDEA_ID = 31748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31748Service() {
        this(new Idea31748Config());
    }

    public Idea31748Service(Idea31748Config config) {
        this.config = config != null ? config : new Idea31748Config();
