...
@Data
public class Idea31585Config {
    private String name = "idea_031585";
 ...
 */
@Slf4j
public class Idea31585Service {
    private static final int IDEA_ID = 31585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31585Service() {
        this(new Idea31585Config());
    }

    public Idea31585Service(Idea31585Config config) {
        this.config = config != null ? config : new Idea31585Config();
