...
@Data
public class Idea31589Config {
    private String name = "idea_031589";
 ...
 */
@Slf4j
public class Idea31589Service {
    private static final int IDEA_ID = 31589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31589Service() {
        this(new Idea31589Config());
    }

    public Idea31589Service(Idea31589Config config) {
        this.config = config != null ? config : new Idea31589Config();
