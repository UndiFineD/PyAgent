...
@Data
public class Idea31711Config {
    private String name = "idea_031711";
 ...
 */
@Slf4j
public class Idea31711Service {
    private static final int IDEA_ID = 31711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31711Service() {
        this(new Idea31711Config());
    }

    public Idea31711Service(Idea31711Config config) {
        this.config = config != null ? config : new Idea31711Config();
