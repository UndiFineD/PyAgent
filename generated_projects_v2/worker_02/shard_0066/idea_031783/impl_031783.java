...
@Data
public class Idea31783Config {
    private String name = "idea_031783";
 ...
 */
@Slf4j
public class Idea31783Service {
    private static final int IDEA_ID = 31783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31783Service() {
        this(new Idea31783Config());
    }

    public Idea31783Service(Idea31783Config config) {
        this.config = config != null ? config : new Idea31783Config();
