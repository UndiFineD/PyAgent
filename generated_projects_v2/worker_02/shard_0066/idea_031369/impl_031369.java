...
@Data
public class Idea31369Config {
    private String name = "idea_031369";
 ...
 */
@Slf4j
public class Idea31369Service {
    private static final int IDEA_ID = 31369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31369Service() {
        this(new Idea31369Config());
    }

    public Idea31369Service(Idea31369Config config) {
        this.config = config != null ? config : new Idea31369Config();
