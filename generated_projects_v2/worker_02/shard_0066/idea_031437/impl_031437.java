...
@Data
public class Idea31437Config {
    private String name = "idea_031437";
 ...
 */
@Slf4j
public class Idea31437Service {
    private static final int IDEA_ID = 31437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31437Service() {
        this(new Idea31437Config());
    }

    public Idea31437Service(Idea31437Config config) {
        this.config = config != null ? config : new Idea31437Config();
