...
@Data
public class Idea31735Config {
    private String name = "idea_031735";
 ...
 */
@Slf4j
public class Idea31735Service {
    private static final int IDEA_ID = 31735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31735Service() {
        this(new Idea31735Config());
    }

    public Idea31735Service(Idea31735Config config) {
        this.config = config != null ? config : new Idea31735Config();
