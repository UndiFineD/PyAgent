...
@Data
public class Idea31382Config {
    private String name = "idea_031382";
 ...
 */
@Slf4j
public class Idea31382Service {
    private static final int IDEA_ID = 31382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31382Service() {
        this(new Idea31382Config());
    }

    public Idea31382Service(Idea31382Config config) {
        this.config = config != null ? config : new Idea31382Config();
