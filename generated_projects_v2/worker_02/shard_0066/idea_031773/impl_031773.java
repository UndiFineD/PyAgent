...
@Data
public class Idea31773Config {
    private String name = "idea_031773";
 ...
 */
@Slf4j
public class Idea31773Service {
    private static final int IDEA_ID = 31773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31773Service() {
        this(new Idea31773Config());
    }

    public Idea31773Service(Idea31773Config config) {
        this.config = config != null ? config : new Idea31773Config();
