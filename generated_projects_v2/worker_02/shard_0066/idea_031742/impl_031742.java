...
@Data
public class Idea31742Config {
    private String name = "idea_031742";
 ...
 */
@Slf4j
public class Idea31742Service {
    private static final int IDEA_ID = 31742;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31742Service() {
        this(new Idea31742Config());
    }

    public Idea31742Service(Idea31742Config config) {
        this.config = config != null ? config : new Idea31742Config();
