...
@Data
public class Idea31484Config {
    private String name = "idea_031484";
 ...
 */
@Slf4j
public class Idea31484Service {
    private static final int IDEA_ID = 31484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31484Service() {
        this(new Idea31484Config());
    }

    public Idea31484Service(Idea31484Config config) {
        this.config = config != null ? config : new Idea31484Config();
