...
@Data
public class Idea31383Config {
    private String name = "idea_031383";
 ...
 */
@Slf4j
public class Idea31383Service {
    private static final int IDEA_ID = 31383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31383Service() {
        this(new Idea31383Config());
    }

    public Idea31383Service(Idea31383Config config) {
        this.config = config != null ? config : new Idea31383Config();
