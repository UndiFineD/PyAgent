...
@Data
public class Idea31784Config {
    private String name = "idea_031784";
 ...
 */
@Slf4j
public class Idea31784Service {
    private static final int IDEA_ID = 31784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31784Service() {
        this(new Idea31784Config());
    }

    public Idea31784Service(Idea31784Config config) {
        this.config = config != null ? config : new Idea31784Config();
