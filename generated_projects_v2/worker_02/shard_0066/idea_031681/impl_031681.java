...
@Data
public class Idea31681Config {
    private String name = "idea_031681";
 ...
 */
@Slf4j
public class Idea31681Service {
    private static final int IDEA_ID = 31681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31681Service() {
        this(new Idea31681Config());
    }

    public Idea31681Service(Idea31681Config config) {
        this.config = config != null ? config : new Idea31681Config();
