...
@Data
public class Idea31362Config {
    private String name = "idea_031362";
 ...
 */
@Slf4j
public class Idea31362Service {
    private static final int IDEA_ID = 31362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31362Service() {
        this(new Idea31362Config());
    }

    public Idea31362Service(Idea31362Config config) {
        this.config = config != null ? config : new Idea31362Config();
