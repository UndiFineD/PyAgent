...
@Data
public class Idea31651Config {
    private String name = "idea_031651";
 ...
 */
@Slf4j
public class Idea31651Service {
    private static final int IDEA_ID = 31651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31651Service() {
        this(new Idea31651Config());
    }

    public Idea31651Service(Idea31651Config config) {
        this.config = config != null ? config : new Idea31651Config();
