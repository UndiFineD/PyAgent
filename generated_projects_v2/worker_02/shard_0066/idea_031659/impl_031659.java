...
@Data
public class Idea31659Config {
    private String name = "idea_031659";
 ...
 */
@Slf4j
public class Idea31659Service {
    private static final int IDEA_ID = 31659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31659Service() {
        this(new Idea31659Config());
    }

    public Idea31659Service(Idea31659Config config) {
        this.config = config != null ? config : new Idea31659Config();
