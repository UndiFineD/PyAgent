...
@Data
public class Idea31597Config {
    private String name = "idea_031597";
 ...
 */
@Slf4j
public class Idea31597Service {
    private static final int IDEA_ID = 31597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31597Service() {
        this(new Idea31597Config());
    }

    public Idea31597Service(Idea31597Config config) {
        this.config = config != null ? config : new Idea31597Config();
