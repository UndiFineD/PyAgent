...
@Data
public class Idea31441Config {
    private String name = "idea_031441";
 ...
 */
@Slf4j
public class Idea31441Service {
    private static final int IDEA_ID = 31441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31441Service() {
        this(new Idea31441Config());
    }

    public Idea31441Service(Idea31441Config config) {
        this.config = config != null ? config : new Idea31441Config();
