...
@Data
public class Idea31652Config {
    private String name = "idea_031652";
 ...
 */
@Slf4j
public class Idea31652Service {
    private static final int IDEA_ID = 31652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31652Service() {
        this(new Idea31652Config());
    }

    public Idea31652Service(Idea31652Config config) {
        this.config = config != null ? config : new Idea31652Config();
