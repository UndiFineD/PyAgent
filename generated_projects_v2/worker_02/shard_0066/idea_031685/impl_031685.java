...
@Data
public class Idea31685Config {
    private String name = "idea_031685";
 ...
 */
@Slf4j
public class Idea31685Service {
    private static final int IDEA_ID = 31685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31685Service() {
        this(new Idea31685Config());
    }

    public Idea31685Service(Idea31685Config config) {
        this.config = config != null ? config : new Idea31685Config();
