...
@Data
public class Idea31805Config {
    private String name = "idea_031805";
 ...
 */
@Slf4j
public class Idea31805Service {
    private static final int IDEA_ID = 31805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31805Service() {
        this(new Idea31805Config());
    }

    public Idea31805Service(Idea31805Config config) {
        this.config = config != null ? config : new Idea31805Config();
