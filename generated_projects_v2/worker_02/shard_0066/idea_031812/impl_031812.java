...
@Data
public class Idea31812Config {
    private String name = "idea_031812";
 ...
 */
@Slf4j
public class Idea31812Service {
    private static final int IDEA_ID = 31812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31812Service() {
        this(new Idea31812Config());
    }

    public Idea31812Service(Idea31812Config config) {
        this.config = config != null ? config : new Idea31812Config();
