...
@Data
public class Idea31559Config {
    private String name = "idea_031559";
 ...
 */
@Slf4j
public class Idea31559Service {
    private static final int IDEA_ID = 31559;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31559Service() {
        this(new Idea31559Config());
    }

    public Idea31559Service(Idea31559Config config) {
        this.config = config != null ? config : new Idea31559Config();
