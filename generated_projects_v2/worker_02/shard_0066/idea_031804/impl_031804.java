...
@Data
public class Idea31804Config {
    private String name = "idea_031804";
 ...
 */
@Slf4j
public class Idea31804Service {
    private static final int IDEA_ID = 31804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31804Service() {
        this(new Idea31804Config());
    }

    public Idea31804Service(Idea31804Config config) {
        this.config = config != null ? config : new Idea31804Config();
