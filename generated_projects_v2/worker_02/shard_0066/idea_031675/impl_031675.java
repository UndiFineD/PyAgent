...
@Data
public class Idea31675Config {
    private String name = "idea_031675";
 ...
 */
@Slf4j
public class Idea31675Service {
    private static final int IDEA_ID = 31675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31675Service() {
        this(new Idea31675Config());
    }

    public Idea31675Service(Idea31675Config config) {
        this.config = config != null ? config : new Idea31675Config();
