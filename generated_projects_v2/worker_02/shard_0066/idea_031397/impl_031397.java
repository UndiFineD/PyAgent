...
@Data
public class Idea31397Config {
    private String name = "idea_031397";
 ...
 */
@Slf4j
public class Idea31397Service {
    private static final int IDEA_ID = 31397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31397Service() {
        this(new Idea31397Config());
    }

    public Idea31397Service(Idea31397Config config) {
        this.config = config != null ? config : new Idea31397Config();
