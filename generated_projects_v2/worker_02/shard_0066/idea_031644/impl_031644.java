...
@Data
public class Idea31644Config {
    private String name = "idea_031644";
 ...
 */
@Slf4j
public class Idea31644Service {
    private static final int IDEA_ID = 31644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31644Service() {
        this(new Idea31644Config());
    }

    public Idea31644Service(Idea31644Config config) {
        this.config = config != null ? config : new Idea31644Config();
