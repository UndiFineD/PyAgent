...
@Data
public class Idea31708Config {
    private String name = "idea_031708";
 ...
 */
@Slf4j
public class Idea31708Service {
    private static final int IDEA_ID = 31708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31708Service() {
        this(new Idea31708Config());
    }

    public Idea31708Service(Idea31708Config config) {
        this.config = config != null ? config : new Idea31708Config();
