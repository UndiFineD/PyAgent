...
@Data
public class Idea31746Config {
    private String name = "idea_031746";
 ...
 */
@Slf4j
public class Idea31746Service {
    private static final int IDEA_ID = 31746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31746Service() {
        this(new Idea31746Config());
    }

    public Idea31746Service(Idea31746Config config) {
        this.config = config != null ? config : new Idea31746Config();
