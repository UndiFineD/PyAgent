...
@Data
public class Idea31753Config {
    private String name = "idea_031753";
 ...
 */
@Slf4j
public class Idea31753Service {
    private static final int IDEA_ID = 31753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31753Service() {
        this(new Idea31753Config());
    }

    public Idea31753Service(Idea31753Config config) {
        this.config = config != null ? config : new Idea31753Config();
