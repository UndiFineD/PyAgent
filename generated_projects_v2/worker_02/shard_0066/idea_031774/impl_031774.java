...
@Data
public class Idea31774Config {
    private String name = "idea_031774";
 ...
 */
@Slf4j
public class Idea31774Service {
    private static final int IDEA_ID = 31774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31774Service() {
        this(new Idea31774Config());
    }

    public Idea31774Service(Idea31774Config config) {
        this.config = config != null ? config : new Idea31774Config();
