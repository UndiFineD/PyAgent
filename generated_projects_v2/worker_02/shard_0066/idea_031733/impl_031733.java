...
@Data
public class Idea31733Config {
    private String name = "idea_031733";
 ...
 */
@Slf4j
public class Idea31733Service {
    private static final int IDEA_ID = 31733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31733Service() {
        this(new Idea31733Config());
    }

    public Idea31733Service(Idea31733Config config) {
        this.config = config != null ? config : new Idea31733Config();
