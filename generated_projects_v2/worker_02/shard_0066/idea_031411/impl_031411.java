...
@Data
public class Idea31411Config {
    private String name = "idea_031411";
 ...
 */
@Slf4j
public class Idea31411Service {
    private static final int IDEA_ID = 31411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31411Service() {
        this(new Idea31411Config());
    }

    public Idea31411Service(Idea31411Config config) {
        this.config = config != null ? config : new Idea31411Config();
