...
@Data
public class Idea31693Config {
    private String name = "idea_031693";
 ...
 */
@Slf4j
public class Idea31693Service {
    private static final int IDEA_ID = 31693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31693Service() {
        this(new Idea31693Config());
    }

    public Idea31693Service(Idea31693Config config) {
        this.config = config != null ? config : new Idea31693Config();
