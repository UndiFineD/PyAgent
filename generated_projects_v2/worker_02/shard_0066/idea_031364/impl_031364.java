...
@Data
public class Idea31364Config {
    private String name = "idea_031364";
 ...
 */
@Slf4j
public class Idea31364Service {
    private static final int IDEA_ID = 31364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31364Service() {
        this(new Idea31364Config());
    }

    public Idea31364Service(Idea31364Config config) {
        this.config = config != null ? config : new Idea31364Config();
