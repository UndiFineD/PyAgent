...
@Data
public class Idea31406Config {
    private String name = "idea_031406";
 ...
 */
@Slf4j
public class Idea31406Service {
    private static final int IDEA_ID = 31406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31406Service() {
        this(new Idea31406Config());
    }

    public Idea31406Service(Idea31406Config config) {
        this.config = config != null ? config : new Idea31406Config();
