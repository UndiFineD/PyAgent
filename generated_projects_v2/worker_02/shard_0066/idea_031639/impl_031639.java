...
@Data
public class Idea31639Config {
    private String name = "idea_031639";
 ...
 */
@Slf4j
public class Idea31639Service {
    private static final int IDEA_ID = 31639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31639Service() {
        this(new Idea31639Config());
    }

    public Idea31639Service(Idea31639Config config) {
        this.config = config != null ? config : new Idea31639Config();
