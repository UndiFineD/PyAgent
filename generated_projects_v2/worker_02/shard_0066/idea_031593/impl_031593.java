...
@Data
public class Idea31593Config {
    private String name = "idea_031593";
 ...
 */
@Slf4j
public class Idea31593Service {
    private static final int IDEA_ID = 31593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31593Service() {
        this(new Idea31593Config());
    }

    public Idea31593Service(Idea31593Config config) {
        this.config = config != null ? config : new Idea31593Config();
