...
@Data
public class Idea31634Config {
    private String name = "idea_031634";
 ...
 */
@Slf4j
public class Idea31634Service {
    private static final int IDEA_ID = 31634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31634Service() {
        this(new Idea31634Config());
    }

    public Idea31634Service(Idea31634Config config) {
        this.config = config != null ? config : new Idea31634Config();
