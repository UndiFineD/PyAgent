...
@Data
public class Idea31821Config {
    private String name = "idea_031821";
 ...
 */
@Slf4j
public class Idea31821Service {
    private static final int IDEA_ID = 31821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31821Service() {
        this(new Idea31821Config());
    }

    public Idea31821Service(Idea31821Config config) {
        this.config = config != null ? config : new Idea31821Config();
