...
@Data
public class Idea31768Config {
    private String name = "idea_031768";
 ...
 */
@Slf4j
public class Idea31768Service {
    private static final int IDEA_ID = 31768;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31768Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31768Service() {
        this(new Idea31768Config());
    }

    public Idea31768Service(Idea31768Config config) {
        this.config = config != null ? config : new Idea31768Config();
