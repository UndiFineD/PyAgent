...
@Data
public class Idea31522Config {
    private String name = "idea_031522";
 ...
 */
@Slf4j
public class Idea31522Service {
    private static final int IDEA_ID = 31522;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31522Service() {
        this(new Idea31522Config());
    }

    public Idea31522Service(Idea31522Config config) {
        this.config = config != null ? config : new Idea31522Config();
