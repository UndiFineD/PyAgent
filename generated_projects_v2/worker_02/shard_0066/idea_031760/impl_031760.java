...
@Data
public class Idea31760Config {
    private String name = "idea_031760";
 ...
 */
@Slf4j
public class Idea31760Service {
    private static final int IDEA_ID = 31760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31760Service() {
        this(new Idea31760Config());
    }

    public Idea31760Service(Idea31760Config config) {
        this.config = config != null ? config : new Idea31760Config();
