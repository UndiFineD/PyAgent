...
@Data
public class Idea31350Config {
    private String name = "idea_031350";
 ...
 */
@Slf4j
public class Idea31350Service {
    private static final int IDEA_ID = 31350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31350Service() {
        this(new Idea31350Config());
    }

    public Idea31350Service(Idea31350Config config) {
        this.config = config != null ? config : new Idea31350Config();
