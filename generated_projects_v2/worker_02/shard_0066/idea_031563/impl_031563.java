...
@Data
public class Idea31563Config {
    private String name = "idea_031563";
 ...
 */
@Slf4j
public class Idea31563Service {
    private static final int IDEA_ID = 31563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31563Service() {
        this(new Idea31563Config());
    }

    public Idea31563Service(Idea31563Config config) {
        this.config = config != null ? config : new Idea31563Config();
