...
@Data
public class Idea31581Config {
    private String name = "idea_031581";
 ...
 */
@Slf4j
public class Idea31581Service {
    private static final int IDEA_ID = 31581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31581Service() {
        this(new Idea31581Config());
    }

    public Idea31581Service(Idea31581Config config) {
        this.config = config != null ? config : new Idea31581Config();
