...
@Data
public class Idea31653Config {
    private String name = "idea_031653";
 ...
 */
@Slf4j
public class Idea31653Service {
    private static final int IDEA_ID = 31653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31653Service() {
        this(new Idea31653Config());
    }

    public Idea31653Service(Idea31653Config config) {
        this.config = config != null ? config : new Idea31653Config();
