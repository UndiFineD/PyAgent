...
@Data
public class Idea31615Config {
    private String name = "idea_031615";
 ...
 */
@Slf4j
public class Idea31615Service {
    private static final int IDEA_ID = 31615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31615Service() {
        this(new Idea31615Config());
    }

    public Idea31615Service(Idea31615Config config) {
        this.config = config != null ? config : new Idea31615Config();
