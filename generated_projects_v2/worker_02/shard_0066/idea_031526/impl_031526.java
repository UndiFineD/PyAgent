...
@Data
public class Idea31526Config {
    private String name = "idea_031526";
 ...
 */
@Slf4j
public class Idea31526Service {
    private static final int IDEA_ID = 31526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31526Service() {
        this(new Idea31526Config());
    }

    public Idea31526Service(Idea31526Config config) {
        this.config = config != null ? config : new Idea31526Config();
