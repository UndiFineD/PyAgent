...
@Data
public class Idea31401Config {
    private String name = "idea_031401";
 ...
 */
@Slf4j
public class Idea31401Service {
    private static final int IDEA_ID = 31401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31401Service() {
        this(new Idea31401Config());
    }

    public Idea31401Service(Idea31401Config config) {
        this.config = config != null ? config : new Idea31401Config();
