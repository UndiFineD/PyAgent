...
@Data
public class Idea31394Config {
    private String name = "idea_031394";
 ...
 */
@Slf4j
public class Idea31394Service {
    private static final int IDEA_ID = 31394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31394Service() {
        this(new Idea31394Config());
    }

    public Idea31394Service(Idea31394Config config) {
        this.config = config != null ? config : new Idea31394Config();
