...
@Data
public class Idea31704Config {
    private String name = "idea_031704";
 ...
 */
@Slf4j
public class Idea31704Service {
    private static final int IDEA_ID = 31704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31704Service() {
        this(new Idea31704Config());
    }

    public Idea31704Service(Idea31704Config config) {
        this.config = config != null ? config : new Idea31704Config();
