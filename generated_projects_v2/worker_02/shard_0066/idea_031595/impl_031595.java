...
@Data
public class Idea31595Config {
    private String name = "idea_031595";
 ...
 */
@Slf4j
public class Idea31595Service {
    private static final int IDEA_ID = 31595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31595Service() {
        this(new Idea31595Config());
    }

    public Idea31595Service(Idea31595Config config) {
        this.config = config != null ? config : new Idea31595Config();
