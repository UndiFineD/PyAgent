...
@Data
public class Idea31677Config {
    private String name = "idea_031677";
 ...
 */
@Slf4j
public class Idea31677Service {
    private static final int IDEA_ID = 31677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31677Service() {
        this(new Idea31677Config());
    }

    public Idea31677Service(Idea31677Config config) {
        this.config = config != null ? config : new Idea31677Config();
