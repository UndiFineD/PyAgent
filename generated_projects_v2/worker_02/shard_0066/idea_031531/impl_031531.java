...
@Data
public class Idea31531Config {
    private String name = "idea_031531";
 ...
 */
@Slf4j
public class Idea31531Service {
    private static final int IDEA_ID = 31531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31531Service() {
        this(new Idea31531Config());
    }

    public Idea31531Service(Idea31531Config config) {
        this.config = config != null ? config : new Idea31531Config();
