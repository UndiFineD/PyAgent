...
@Data
public class Idea31513Config {
    private String name = "idea_031513";
 ...
 */
@Slf4j
public class Idea31513Service {
    private static final int IDEA_ID = 31513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31513Service() {
        this(new Idea31513Config());
    }

    public Idea31513Service(Idea31513Config config) {
        this.config = config != null ? config : new Idea31513Config();
