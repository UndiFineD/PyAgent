...
@Data
public class Idea31463Config {
    private String name = "idea_031463";
 ...
 */
@Slf4j
public class Idea31463Service {
    private static final int IDEA_ID = 31463;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31463Service() {
        this(new Idea31463Config());
    }

    public Idea31463Service(Idea31463Config config) {
        this.config = config != null ? config : new Idea31463Config();
