...
@Data
public class Idea31789Config {
    private String name = "idea_031789";
 ...
 */
@Slf4j
public class Idea31789Service {
    private static final int IDEA_ID = 31789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31789Service() {
        this(new Idea31789Config());
    }

    public Idea31789Service(Idea31789Config config) {
        this.config = config != null ? config : new Idea31789Config();
