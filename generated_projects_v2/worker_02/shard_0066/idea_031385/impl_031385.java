...
@Data
public class Idea31385Config {
    private String name = "idea_031385";
 ...
 */
@Slf4j
public class Idea31385Service {
    private static final int IDEA_ID = 31385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31385Service() {
        this(new Idea31385Config());
    }

    public Idea31385Service(Idea31385Config config) {
        this.config = config != null ? config : new Idea31385Config();
