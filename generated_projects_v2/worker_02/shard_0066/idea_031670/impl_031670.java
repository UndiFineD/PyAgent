...
@Data
public class Idea31670Config {
    private String name = "idea_031670";
 ...
 */
@Slf4j
public class Idea31670Service {
    private static final int IDEA_ID = 31670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31670Service() {
        this(new Idea31670Config());
    }

    public Idea31670Service(Idea31670Config config) {
        this.config = config != null ? config : new Idea31670Config();
