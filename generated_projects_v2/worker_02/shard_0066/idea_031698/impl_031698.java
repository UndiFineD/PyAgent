...
@Data
public class Idea31698Config {
    private String name = "idea_031698";
 ...
 */
@Slf4j
public class Idea31698Service {
    private static final int IDEA_ID = 31698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31698Service() {
        this(new Idea31698Config());
    }

    public Idea31698Service(Idea31698Config config) {
        this.config = config != null ? config : new Idea31698Config();
