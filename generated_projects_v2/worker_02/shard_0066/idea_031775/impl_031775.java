...
@Data
public class Idea31775Config {
    private String name = "idea_031775";
 ...
 */
@Slf4j
public class Idea31775Service {
    private static final int IDEA_ID = 31775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31775Service() {
        this(new Idea31775Config());
    }

    public Idea31775Service(Idea31775Config config) {
        this.config = config != null ? config : new Idea31775Config();
