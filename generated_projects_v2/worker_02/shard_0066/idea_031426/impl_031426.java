...
@Data
public class Idea31426Config {
    private String name = "idea_031426";
 ...
 */
@Slf4j
public class Idea31426Service {
    private static final int IDEA_ID = 31426;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31426Service() {
        this(new Idea31426Config());
    }

    public Idea31426Service(Idea31426Config config) {
        this.config = config != null ? config : new Idea31426Config();
