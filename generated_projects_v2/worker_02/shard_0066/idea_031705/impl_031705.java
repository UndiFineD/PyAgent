...
@Data
public class Idea31705Config {
    private String name = "idea_031705";
 ...
 */
@Slf4j
public class Idea31705Service {
    private static final int IDEA_ID = 31705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31705Service() {
        this(new Idea31705Config());
    }

    public Idea31705Service(Idea31705Config config) {
        this.config = config != null ? config : new Idea31705Config();
