...
@Data
public class Idea31797Config {
    private String name = "idea_031797";
 ...
 */
@Slf4j
public class Idea31797Service {
    private static final int IDEA_ID = 31797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31797Service() {
        this(new Idea31797Config());
    }

    public Idea31797Service(Idea31797Config config) {
        this.config = config != null ? config : new Idea31797Config();
