...
@Data
public class Idea31678Config {
    private String name = "idea_031678";
 ...
 */
@Slf4j
public class Idea31678Service {
    private static final int IDEA_ID = 31678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31678Service() {
        this(new Idea31678Config());
    }

    public Idea31678Service(Idea31678Config config) {
        this.config = config != null ? config : new Idea31678Config();
