...
@Data
public class Idea31761Config {
    private String name = "idea_031761";
 ...
 */
@Slf4j
public class Idea31761Service {
    private static final int IDEA_ID = 31761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31761Service() {
        this(new Idea31761Config());
    }

    public Idea31761Service(Idea31761Config config) {
        this.config = config != null ? config : new Idea31761Config();
