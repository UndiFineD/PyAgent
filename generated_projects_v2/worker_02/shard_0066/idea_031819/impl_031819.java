...
@Data
public class Idea31819Config {
    private String name = "idea_031819";
 ...
 */
@Slf4j
public class Idea31819Service {
    private static final int IDEA_ID = 31819;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31819Service() {
        this(new Idea31819Config());
    }

    public Idea31819Service(Idea31819Config config) {
        this.config = config != null ? config : new Idea31819Config();
