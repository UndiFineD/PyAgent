...
@Data
public class Idea31755Config {
    private String name = "idea_031755";
 ...
 */
@Slf4j
public class Idea31755Service {
    private static final int IDEA_ID = 31755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31755Service() {
        this(new Idea31755Config());
    }

    public Idea31755Service(Idea31755Config config) {
        this.config = config != null ? config : new Idea31755Config();
