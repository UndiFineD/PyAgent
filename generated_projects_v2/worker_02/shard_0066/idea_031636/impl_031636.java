...
@Data
public class Idea31636Config {
    private String name = "idea_031636";
 ...
 */
@Slf4j
public class Idea31636Service {
    private static final int IDEA_ID = 31636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31636Service() {
        this(new Idea31636Config());
    }

    public Idea31636Service(Idea31636Config config) {
        this.config = config != null ? config : new Idea31636Config();
