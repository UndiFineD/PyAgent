...
@Data
public class Idea31663Config {
    private String name = "idea_031663";
 ...
 */
@Slf4j
public class Idea31663Service {
    private static final int IDEA_ID = 31663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31663Service() {
        this(new Idea31663Config());
    }

    public Idea31663Service(Idea31663Config config) {
        this.config = config != null ? config : new Idea31663Config();
