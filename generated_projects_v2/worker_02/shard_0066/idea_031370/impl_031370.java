...
@Data
public class Idea31370Config {
    private String name = "idea_031370";
 ...
 */
@Slf4j
public class Idea31370Service {
    private static final int IDEA_ID = 31370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31370Service() {
        this(new Idea31370Config());
    }

    public Idea31370Service(Idea31370Config config) {
        this.config = config != null ? config : new Idea31370Config();
