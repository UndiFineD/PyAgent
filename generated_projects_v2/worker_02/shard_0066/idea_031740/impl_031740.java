...
@Data
public class Idea31740Config {
    private String name = "idea_031740";
 ...
 */
@Slf4j
public class Idea31740Service {
    private static final int IDEA_ID = 31740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31740Service() {
        this(new Idea31740Config());
    }

    public Idea31740Service(Idea31740Config config) {
        this.config = config != null ? config : new Idea31740Config();
