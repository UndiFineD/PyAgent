...
@Data
public class Idea31417Config {
    private String name = "idea_031417";
 ...
 */
@Slf4j
public class Idea31417Service {
    private static final int IDEA_ID = 31417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31417Service() {
        this(new Idea31417Config());
    }

    public Idea31417Service(Idea31417Config config) {
        this.config = config != null ? config : new Idea31417Config();
