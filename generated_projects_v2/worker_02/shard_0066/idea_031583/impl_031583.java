...
@Data
public class Idea31583Config {
    private String name = "idea_031583";
 ...
 */
@Slf4j
public class Idea31583Service {
    private static final int IDEA_ID = 31583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31583Service() {
        this(new Idea31583Config());
    }

    public Idea31583Service(Idea31583Config config) {
        this.config = config != null ? config : new Idea31583Config();
