...
@Data
public class Idea31809Config {
    private String name = "idea_031809";
 ...
 */
@Slf4j
public class Idea31809Service {
    private static final int IDEA_ID = 31809;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31809Service() {
        this(new Idea31809Config());
    }

    public Idea31809Service(Idea31809Config config) {
        this.config = config != null ? config : new Idea31809Config();
