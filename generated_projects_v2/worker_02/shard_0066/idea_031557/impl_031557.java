...
@Data
public class Idea31557Config {
    private String name = "idea_031557";
 ...
 */
@Slf4j
public class Idea31557Service {
    private static final int IDEA_ID = 31557;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31557Service() {
        this(new Idea31557Config());
    }

    public Idea31557Service(Idea31557Config config) {
        this.config = config != null ? config : new Idea31557Config();
