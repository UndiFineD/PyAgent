...
@Data
public class Idea31436Config {
    private String name = "idea_031436";
 ...
 */
@Slf4j
public class Idea31436Service {
    private static final int IDEA_ID = 31436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31436Service() {
        this(new Idea31436Config());
    }

    public Idea31436Service(Idea31436Config config) {
        this.config = config != null ? config : new Idea31436Config();
