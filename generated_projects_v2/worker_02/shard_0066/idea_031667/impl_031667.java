...
@Data
public class Idea31667Config {
    private String name = "idea_031667";
 ...
 */
@Slf4j
public class Idea31667Service {
    private static final int IDEA_ID = 31667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31667Service() {
        this(new Idea31667Config());
    }

    public Idea31667Service(Idea31667Config config) {
        this.config = config != null ? config : new Idea31667Config();
