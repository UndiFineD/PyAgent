...
@Data
public class Idea31508Config {
    private String name = "idea_031508";
 ...
 */
@Slf4j
public class Idea31508Service {
    private static final int IDEA_ID = 31508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31508Service() {
        this(new Idea31508Config());
    }

    public Idea31508Service(Idea31508Config config) {
        this.config = config != null ? config : new Idea31508Config();
