...
@Data
public class Idea31554Config {
    private String name = "idea_031554";
 ...
 */
@Slf4j
public class Idea31554Service {
    private static final int IDEA_ID = 31554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31554Service() {
        this(new Idea31554Config());
    }

    public Idea31554Service(Idea31554Config config) {
        this.config = config != null ? config : new Idea31554Config();
