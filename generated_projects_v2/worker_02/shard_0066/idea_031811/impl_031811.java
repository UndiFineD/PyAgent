...
@Data
public class Idea31811Config {
    private String name = "idea_031811";
 ...
 */
@Slf4j
public class Idea31811Service {
    private static final int IDEA_ID = 31811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31811Service() {
        this(new Idea31811Config());
    }

    public Idea31811Service(Idea31811Config config) {
        this.config = config != null ? config : new Idea31811Config();
