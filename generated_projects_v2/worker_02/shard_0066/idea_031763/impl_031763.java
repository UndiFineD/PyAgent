...
@Data
public class Idea31763Config {
    private String name = "idea_031763";
 ...
 */
@Slf4j
public class Idea31763Service {
    private static final int IDEA_ID = 31763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31763Service() {
        this(new Idea31763Config());
    }

    public Idea31763Service(Idea31763Config config) {
        this.config = config != null ? config : new Idea31763Config();
