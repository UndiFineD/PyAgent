...
@Data
public class Idea31688Config {
    private String name = "idea_031688";
 ...
 */
@Slf4j
public class Idea31688Service {
    private static final int IDEA_ID = 31688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31688Service() {
        this(new Idea31688Config());
    }

    public Idea31688Service(Idea31688Config config) {
        this.config = config != null ? config : new Idea31688Config();
