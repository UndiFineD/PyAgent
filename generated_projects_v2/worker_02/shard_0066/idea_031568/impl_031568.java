...
@Data
public class Idea31568Config {
    private String name = "idea_031568";
 ...
 */
@Slf4j
public class Idea31568Service {
    private static final int IDEA_ID = 31568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31568Service() {
        this(new Idea31568Config());
    }

    public Idea31568Service(Idea31568Config config) {
        this.config = config != null ? config : new Idea31568Config();
