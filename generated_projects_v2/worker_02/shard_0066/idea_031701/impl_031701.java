...
@Data
public class Idea31701Config {
    private String name = "idea_031701";
 ...
 */
@Slf4j
public class Idea31701Service {
    private static final int IDEA_ID = 31701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31701Service() {
        this(new Idea31701Config());
    }

    public Idea31701Service(Idea31701Config config) {
        this.config = config != null ? config : new Idea31701Config();
