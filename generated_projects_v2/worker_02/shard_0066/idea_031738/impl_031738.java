...
@Data
public class Idea31738Config {
    private String name = "idea_031738";
 ...
 */
@Slf4j
public class Idea31738Service {
    private static final int IDEA_ID = 31738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31738Service() {
        this(new Idea31738Config());
    }

    public Idea31738Service(Idea31738Config config) {
        this.config = config != null ? config : new Idea31738Config();
