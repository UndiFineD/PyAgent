...
@Data
public class Idea31432Config {
    private String name = "idea_031432";
 ...
 */
@Slf4j
public class Idea31432Service {
    private static final int IDEA_ID = 31432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31432Service() {
        this(new Idea31432Config());
    }

    public Idea31432Service(Idea31432Config config) {
        this.config = config != null ? config : new Idea31432Config();
