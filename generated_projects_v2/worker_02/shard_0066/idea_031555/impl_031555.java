...
@Data
public class Idea31555Config {
    private String name = "idea_031555";
 ...
 */
@Slf4j
public class Idea31555Service {
    private static final int IDEA_ID = 31555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31555Service() {
        this(new Idea31555Config());
    }

    public Idea31555Service(Idea31555Config config) {
        this.config = config != null ? config : new Idea31555Config();
