...
@Data
public class Idea31447Config {
    private String name = "idea_031447";
 ...
 */
@Slf4j
public class Idea31447Service {
    private static final int IDEA_ID = 31447;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31447Service() {
        this(new Idea31447Config());
    }

    public Idea31447Service(Idea31447Config config) {
        this.config = config != null ? config : new Idea31447Config();
