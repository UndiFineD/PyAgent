...
@Data
public class Idea31444Config {
    private String name = "idea_031444";
 ...
 */
@Slf4j
public class Idea31444Service {
    private static final int IDEA_ID = 31444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31444Service() {
        this(new Idea31444Config());
    }

    public Idea31444Service(Idea31444Config config) {
        this.config = config != null ? config : new Idea31444Config();
