...
@Data
public class Idea31518Config {
    private String name = "idea_031518";
 ...
 */
@Slf4j
public class Idea31518Service {
    private static final int IDEA_ID = 31518;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31518Service() {
        this(new Idea31518Config());
    }

    public Idea31518Service(Idea31518Config config) {
        this.config = config != null ? config : new Idea31518Config();
