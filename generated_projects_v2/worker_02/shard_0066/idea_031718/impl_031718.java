...
@Data
public class Idea31718Config {
    private String name = "idea_031718";
 ...
 */
@Slf4j
public class Idea31718Service {
    private static final int IDEA_ID = 31718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31718Service() {
        this(new Idea31718Config());
    }

    public Idea31718Service(Idea31718Config config) {
        this.config = config != null ? config : new Idea31718Config();
