...
@Data
public class Idea31569Config {
    private String name = "idea_031569";
 ...
 */
@Slf4j
public class Idea31569Service {
    private static final int IDEA_ID = 31569;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31569Service() {
        this(new Idea31569Config());
    }

    public Idea31569Service(Idea31569Config config) {
        this.config = config != null ? config : new Idea31569Config();
