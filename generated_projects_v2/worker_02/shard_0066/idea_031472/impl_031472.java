...
@Data
public class Idea31472Config {
    private String name = "idea_031472";
 ...
 */
@Slf4j
public class Idea31472Service {
    private static final int IDEA_ID = 31472;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31472Service() {
        this(new Idea31472Config());
    }

    public Idea31472Service(Idea31472Config config) {
        this.config = config != null ? config : new Idea31472Config();
