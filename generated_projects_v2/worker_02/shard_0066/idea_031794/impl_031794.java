...
@Data
public class Idea31794Config {
    private String name = "idea_031794";
 ...
 */
@Slf4j
public class Idea31794Service {
    private static final int IDEA_ID = 31794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31794Service() {
        this(new Idea31794Config());
    }

    public Idea31794Service(Idea31794Config config) {
        this.config = config != null ? config : new Idea31794Config();
