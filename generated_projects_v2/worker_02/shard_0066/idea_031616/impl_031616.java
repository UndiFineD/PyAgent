...
@Data
public class Idea31616Config {
    private String name = "idea_031616";
 ...
 */
@Slf4j
public class Idea31616Service {
    private static final int IDEA_ID = 31616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31616Service() {
        this(new Idea31616Config());
    }

    public Idea31616Service(Idea31616Config config) {
        this.config = config != null ? config : new Idea31616Config();
