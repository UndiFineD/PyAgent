...
@Data
public class Idea31386Config {
    private String name = "idea_031386";
 ...
 */
@Slf4j
public class Idea31386Service {
    private static final int IDEA_ID = 31386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31386Service() {
        this(new Idea31386Config());
    }

    public Idea31386Service(Idea31386Config config) {
        this.config = config != null ? config : new Idea31386Config();
