...
@Data
public class Idea31407Config {
    private String name = "idea_031407";
 ...
 */
@Slf4j
public class Idea31407Service {
    private static final int IDEA_ID = 31407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31407Service() {
        this(new Idea31407Config());
    }

    public Idea31407Service(Idea31407Config config) {
        this.config = config != null ? config : new Idea31407Config();
