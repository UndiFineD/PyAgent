...
@Data
public class Idea31467Config {
    private String name = "idea_031467";
 ...
 */
@Slf4j
public class Idea31467Service {
    private static final int IDEA_ID = 31467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31467Service() {
        this(new Idea31467Config());
    }

    public Idea31467Service(Idea31467Config config) {
        this.config = config != null ? config : new Idea31467Config();
