...
@Data
public class Idea31810Config {
    private String name = "idea_031810";
 ...
 */
@Slf4j
public class Idea31810Service {
    private static final int IDEA_ID = 31810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31810Service() {
        this(new Idea31810Config());
    }

    public Idea31810Service(Idea31810Config config) {
        this.config = config != null ? config : new Idea31810Config();
