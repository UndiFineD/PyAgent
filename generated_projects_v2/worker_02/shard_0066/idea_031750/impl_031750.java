...
@Data
public class Idea31750Config {
    private String name = "idea_031750";
 ...
 */
@Slf4j
public class Idea31750Service {
    private static final int IDEA_ID = 31750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31750Service() {
        this(new Idea31750Config());
    }

    public Idea31750Service(Idea31750Config config) {
        this.config = config != null ? config : new Idea31750Config();
