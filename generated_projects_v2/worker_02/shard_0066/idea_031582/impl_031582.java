...
@Data
public class Idea31582Config {
    private String name = "idea_031582";
 ...
 */
@Slf4j
public class Idea31582Service {
    private static final int IDEA_ID = 31582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31582Service() {
        this(new Idea31582Config());
    }

    public Idea31582Service(Idea31582Config config) {
        this.config = config != null ? config : new Idea31582Config();
