...
@Data
public class Idea31664Config {
    private String name = "idea_031664";
 ...
 */
@Slf4j
public class Idea31664Service {
    private static final int IDEA_ID = 31664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31664Service() {
        this(new Idea31664Config());
    }

    public Idea31664Service(Idea31664Config config) {
        this.config = config != null ? config : new Idea31664Config();
