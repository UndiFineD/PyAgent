...
@Data
public class Idea31691Config {
    private String name = "idea_031691";
 ...
 */
@Slf4j
public class Idea31691Service {
    private static final int IDEA_ID = 31691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31691Service() {
        this(new Idea31691Config());
    }

    public Idea31691Service(Idea31691Config config) {
        this.config = config != null ? config : new Idea31691Config();
