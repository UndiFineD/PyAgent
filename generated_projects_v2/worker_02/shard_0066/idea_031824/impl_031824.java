...
@Data
public class Idea31824Config {
    private String name = "idea_031824";
 ...
 */
@Slf4j
public class Idea31824Service {
    private static final int IDEA_ID = 31824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31824Service() {
        this(new Idea31824Config());
    }

    public Idea31824Service(Idea31824Config config) {
        this.config = config != null ? config : new Idea31824Config();
