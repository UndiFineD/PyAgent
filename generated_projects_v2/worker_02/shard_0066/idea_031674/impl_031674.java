...
@Data
public class Idea31674Config {
    private String name = "idea_031674";
 ...
 */
@Slf4j
public class Idea31674Service {
    private static final int IDEA_ID = 31674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31674Service() {
        this(new Idea31674Config());
    }

    public Idea31674Service(Idea31674Config config) {
        this.config = config != null ? config : new Idea31674Config();
