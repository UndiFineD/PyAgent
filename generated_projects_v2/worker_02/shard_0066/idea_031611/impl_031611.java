...
@Data
public class Idea31611Config {
    private String name = "idea_031611";
 ...
 */
@Slf4j
public class Idea31611Service {
    private static final int IDEA_ID = 31611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31611Service() {
        this(new Idea31611Config());
    }

    public Idea31611Service(Idea31611Config config) {
        this.config = config != null ? config : new Idea31611Config();
