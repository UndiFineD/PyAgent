...
@Data
public class Idea31706Config {
    private String name = "idea_031706";
 ...
 */
@Slf4j
public class Idea31706Service {
    private static final int IDEA_ID = 31706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31706Service() {
        this(new Idea31706Config());
    }

    public Idea31706Service(Idea31706Config config) {
        this.config = config != null ? config : new Idea31706Config();
