...
@Data
public class Idea31396Config {
    private String name = "idea_031396";
 ...
 */
@Slf4j
public class Idea31396Service {
    private static final int IDEA_ID = 31396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31396Service() {
        this(new Idea31396Config());
    }

    public Idea31396Service(Idea31396Config config) {
        this.config = config != null ? config : new Idea31396Config();
