...
@Data
public class Idea31777Config {
    private String name = "idea_031777";
 ...
 */
@Slf4j
public class Idea31777Service {
    private static final int IDEA_ID = 31777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31777Service() {
        this(new Idea31777Config());
    }

    public Idea31777Service(Idea31777Config config) {
        this.config = config != null ? config : new Idea31777Config();
