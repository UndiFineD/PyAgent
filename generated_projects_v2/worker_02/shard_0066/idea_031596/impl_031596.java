...
@Data
public class Idea31596Config {
    private String name = "idea_031596";
 ...
 */
@Slf4j
public class Idea31596Service {
    private static final int IDEA_ID = 31596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31596Service() {
        this(new Idea31596Config());
    }

    public Idea31596Service(Idea31596Config config) {
        this.config = config != null ? config : new Idea31596Config();
