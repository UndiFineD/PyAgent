...
@Data
public class Idea31501Config {
    private String name = "idea_031501";
 ...
 */
@Slf4j
public class Idea31501Service {
    private static final int IDEA_ID = 31501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31501Service() {
        this(new Idea31501Config());
    }

    public Idea31501Service(Idea31501Config config) {
        this.config = config != null ? config : new Idea31501Config();
