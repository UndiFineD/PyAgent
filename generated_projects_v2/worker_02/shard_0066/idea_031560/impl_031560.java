...
@Data
public class Idea31560Config {
    private String name = "idea_031560";
 ...
 */
@Slf4j
public class Idea31560Service {
    private static final int IDEA_ID = 31560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31560Service() {
        this(new Idea31560Config());
    }

    public Idea31560Service(Idea31560Config config) {
        this.config = config != null ? config : new Idea31560Config();
