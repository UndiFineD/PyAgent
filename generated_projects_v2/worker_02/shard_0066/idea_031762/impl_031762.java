...
@Data
public class Idea31762Config {
    private String name = "idea_031762";
 ...
 */
@Slf4j
public class Idea31762Service {
    private static final int IDEA_ID = 31762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31762Service() {
        this(new Idea31762Config());
    }

    public Idea31762Service(Idea31762Config config) {
        this.config = config != null ? config : new Idea31762Config();
