...
@Data
public class Idea31594Config {
    private String name = "idea_031594";
 ...
 */
@Slf4j
public class Idea31594Service {
    private static final int IDEA_ID = 31594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31594Service() {
        this(new Idea31594Config());
    }

    public Idea31594Service(Idea31594Config config) {
        this.config = config != null ? config : new Idea31594Config();
