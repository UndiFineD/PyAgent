...
@Data
public class Idea31477Config {
    private String name = "idea_031477";
 ...
 */
@Slf4j
public class Idea31477Service {
    private static final int IDEA_ID = 31477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31477Service() {
        this(new Idea31477Config());
    }

    public Idea31477Service(Idea31477Config config) {
        this.config = config != null ? config : new Idea31477Config();
