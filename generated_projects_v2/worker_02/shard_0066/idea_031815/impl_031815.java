...
@Data
public class Idea31815Config {
    private String name = "idea_031815";
 ...
 */
@Slf4j
public class Idea31815Service {
    private static final int IDEA_ID = 31815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31815Service() {
        this(new Idea31815Config());
    }

    public Idea31815Service(Idea31815Config config) {
        this.config = config != null ? config : new Idea31815Config();
