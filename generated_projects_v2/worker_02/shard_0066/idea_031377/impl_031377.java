...
@Data
public class Idea31377Config {
    private String name = "idea_031377";
 ...
 */
@Slf4j
public class Idea31377Service {
    private static final int IDEA_ID = 31377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31377Service() {
        this(new Idea31377Config());
    }

    public Idea31377Service(Idea31377Config config) {
        this.config = config != null ? config : new Idea31377Config();
