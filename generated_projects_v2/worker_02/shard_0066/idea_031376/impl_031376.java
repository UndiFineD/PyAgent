...
@Data
public class Idea31376Config {
    private String name = "idea_031376";
 ...
 */
@Slf4j
public class Idea31376Service {
    private static final int IDEA_ID = 31376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31376Service() {
        this(new Idea31376Config());
    }

    public Idea31376Service(Idea31376Config config) {
        this.config = config != null ? config : new Idea31376Config();
