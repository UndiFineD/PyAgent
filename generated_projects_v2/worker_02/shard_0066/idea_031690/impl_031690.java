...
@Data
public class Idea31690Config {
    private String name = "idea_031690";
 ...
 */
@Slf4j
public class Idea31690Service {
    private static final int IDEA_ID = 31690;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31690Service() {
        this(new Idea31690Config());
    }

    public Idea31690Service(Idea31690Config config) {
        this.config = config != null ? config : new Idea31690Config();
