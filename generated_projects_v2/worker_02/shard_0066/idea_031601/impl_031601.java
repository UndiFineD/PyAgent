...
@Data
public class Idea31601Config {
    private String name = "idea_031601";
 ...
 */
@Slf4j
public class Idea31601Service {
    private static final int IDEA_ID = 31601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31601Service() {
        this(new Idea31601Config());
    }

    public Idea31601Service(Idea31601Config config) {
        this.config = config != null ? config : new Idea31601Config();
