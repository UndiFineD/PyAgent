...
@Data
public class Idea31786Config {
    private String name = "idea_031786";
 ...
 */
@Slf4j
public class Idea31786Service {
    private static final int IDEA_ID = 31786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31786Service() {
        this(new Idea31786Config());
    }

    public Idea31786Service(Idea31786Config config) {
        this.config = config != null ? config : new Idea31786Config();
