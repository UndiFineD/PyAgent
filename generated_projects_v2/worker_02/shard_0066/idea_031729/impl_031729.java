...
@Data
public class Idea31729Config {
    private String name = "idea_031729";
 ...
 */
@Slf4j
public class Idea31729Service {
    private static final int IDEA_ID = 31729;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31729Service() {
        this(new Idea31729Config());
    }

    public Idea31729Service(Idea31729Config config) {
        this.config = config != null ? config : new Idea31729Config();
