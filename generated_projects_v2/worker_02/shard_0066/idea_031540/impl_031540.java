...
@Data
public class Idea31540Config {
    private String name = "idea_031540";
 ...
 */
@Slf4j
public class Idea31540Service {
    private static final int IDEA_ID = 31540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31540Service() {
        this(new Idea31540Config());
    }

    public Idea31540Service(Idea31540Config config) {
        this.config = config != null ? config : new Idea31540Config();
