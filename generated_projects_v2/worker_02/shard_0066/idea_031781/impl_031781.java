...
@Data
public class Idea31781Config {
    private String name = "idea_031781";
 ...
 */
@Slf4j
public class Idea31781Service {
    private static final int IDEA_ID = 31781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31781Service() {
        this(new Idea31781Config());
    }

    public Idea31781Service(Idea31781Config config) {
        this.config = config != null ? config : new Idea31781Config();
