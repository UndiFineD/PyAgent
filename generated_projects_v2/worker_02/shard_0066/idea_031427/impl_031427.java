...
@Data
public class Idea31427Config {
    private String name = "idea_031427";
 ...
 */
@Slf4j
public class Idea31427Service {
    private static final int IDEA_ID = 31427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31427Service() {
        this(new Idea31427Config());
    }

    public Idea31427Service(Idea31427Config config) {
        this.config = config != null ? config : new Idea31427Config();
