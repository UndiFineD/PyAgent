...
@Data
public class Idea30136Config {
    private String name = "idea_030136";
 ...
 */
@Slf4j
public class Idea30136Service {
    private static final int IDEA_ID = 30136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30136Service() {
        this(new Idea30136Config());
    }

    public Idea30136Service(Idea30136Config config) {
        this.config = config != null ? config : new Idea30136Config();
