...
@Data
public class Idea30310Config {
    private String name = "idea_030310";
 ...
 */
@Slf4j
public class Idea30310Service {
    private static final int IDEA_ID = 30310;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30310Service() {
        this(new Idea30310Config());
    }

    public Idea30310Service(Idea30310Config config) {
        this.config = config != null ? config : new Idea30310Config();
