...
@Data
public class Idea29965Config {
    private String name = "idea_029965";
 ...
 */
@Slf4j
public class Idea29965Service {
    private static final int IDEA_ID = 29965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29965Service() {
        this(new Idea29965Config());
    }

    public Idea29965Service(Idea29965Config config) {
        this.config = config != null ? config : new Idea29965Config();
