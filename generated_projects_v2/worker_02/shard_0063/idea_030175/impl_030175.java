...
@Data
public class Idea30175Config {
    private String name = "idea_030175";
 ...
 */
@Slf4j
public class Idea30175Service {
    private static final int IDEA_ID = 30175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30175Service() {
        this(new Idea30175Config());
    }

    public Idea30175Service(Idea30175Config config) {
        this.config = config != null ? config : new Idea30175Config();
