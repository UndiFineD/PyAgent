...
@Data
public class Idea29961Config {
    private String name = "idea_029961";
 ...
 */
@Slf4j
public class Idea29961Service {
    private static final int IDEA_ID = 29961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29961Service() {
        this(new Idea29961Config());
    }

    public Idea29961Service(Idea29961Config config) {
        this.config = config != null ? config : new Idea29961Config();
