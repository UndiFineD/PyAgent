...
@Data
public class Idea30244Config {
    private String name = "idea_030244";
 ...
 */
@Slf4j
public class Idea30244Service {
    private static final int IDEA_ID = 30244;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30244Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30244Service() {
        this(new Idea30244Config());
    }

    public Idea30244Service(Idea30244Config config) {
        this.config = config != null ? config : new Idea30244Config();
