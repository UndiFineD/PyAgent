...
@Data
public class Idea30021Config {
    private String name = "idea_030021";
 ...
 */
@Slf4j
public class Idea30021Service {
    private static final int IDEA_ID = 30021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30021Service() {
        this(new Idea30021Config());
    }

    public Idea30021Service(Idea30021Config config) {
        this.config = config != null ? config : new Idea30021Config();
