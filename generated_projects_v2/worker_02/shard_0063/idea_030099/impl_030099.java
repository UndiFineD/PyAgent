...
@Data
public class Idea30099Config {
    private String name = "idea_030099";
 ...
 */
@Slf4j
public class Idea30099Service {
    private static final int IDEA_ID = 30099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30099Service() {
        this(new Idea30099Config());
    }

    public Idea30099Service(Idea30099Config config) {
        this.config = config != null ? config : new Idea30099Config();
