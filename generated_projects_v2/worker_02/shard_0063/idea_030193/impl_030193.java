...
@Data
public class Idea30193Config {
    private String name = "idea_030193";
 ...
 */
@Slf4j
public class Idea30193Service {
    private static final int IDEA_ID = 30193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30193Service() {
        this(new Idea30193Config());
    }

    public Idea30193Service(Idea30193Config config) {
        this.config = config != null ? config : new Idea30193Config();
