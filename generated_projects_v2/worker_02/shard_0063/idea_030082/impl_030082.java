...
@Data
public class Idea30082Config {
    private String name = "idea_030082";
 ...
 */
@Slf4j
public class Idea30082Service {
    private static final int IDEA_ID = 30082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30082Service() {
        this(new Idea30082Config());
    }

    public Idea30082Service(Idea30082Config config) {
        this.config = config != null ? config : new Idea30082Config();
