...
@Data
public class Idea29969Config {
    private String name = "idea_029969";
 ...
 */
@Slf4j
public class Idea29969Service {
    private static final int IDEA_ID = 29969;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29969Service() {
        this(new Idea29969Config());
    }

    public Idea29969Service(Idea29969Config config) {
        this.config = config != null ? config : new Idea29969Config();
