...
@Data
public class Idea29981Config {
    private String name = "idea_029981";
 ...
 */
@Slf4j
public class Idea29981Service {
    private static final int IDEA_ID = 29981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29981Service() {
        this(new Idea29981Config());
    }

    public Idea29981Service(Idea29981Config config) {
        this.config = config != null ? config : new Idea29981Config();
