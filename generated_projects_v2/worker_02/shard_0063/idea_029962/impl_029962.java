...
@Data
public class Idea29962Config {
    private String name = "idea_029962";
 ...
 */
@Slf4j
public class Idea29962Service {
    private static final int IDEA_ID = 29962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29962Service() {
        this(new Idea29962Config());
    }

    public Idea29962Service(Idea29962Config config) {
        this.config = config != null ? config : new Idea29962Config();
