...
@Data
public class Idea30356Config {
    private String name = "idea_030356";
 ...
 */
@Slf4j
public class Idea30356Service {
    private static final int IDEA_ID = 30356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30356Service() {
        this(new Idea30356Config());
    }

    public Idea30356Service(Idea30356Config config) {
        this.config = config != null ? config : new Idea30356Config();
