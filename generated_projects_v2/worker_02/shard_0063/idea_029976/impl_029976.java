...
@Data
public class Idea29976Config {
    private String name = "idea_029976";
 ...
 */
@Slf4j
public class Idea29976Service {
    private static final int IDEA_ID = 29976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29976Service() {
        this(new Idea29976Config());
    }

    public Idea29976Service(Idea29976Config config) {
        this.config = config != null ? config : new Idea29976Config();
