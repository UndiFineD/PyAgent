...
@Data
public class Idea30130Config {
    private String name = "idea_030130";
 ...
 */
@Slf4j
public class Idea30130Service {
    private static final int IDEA_ID = 30130;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30130Service() {
        this(new Idea30130Config());
    }

    public Idea30130Service(Idea30130Config config) {
        this.config = config != null ? config : new Idea30130Config();
