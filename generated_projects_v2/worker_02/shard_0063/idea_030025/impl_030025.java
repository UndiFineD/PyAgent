...
@Data
public class Idea30025Config {
    private String name = "idea_030025";
 ...
 */
@Slf4j
public class Idea30025Service {
    private static final int IDEA_ID = 30025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30025Service() {
        this(new Idea30025Config());
    }

    public Idea30025Service(Idea30025Config config) {
        this.config = config != null ? config : new Idea30025Config();
