...
@Data
public class Idea29983Config {
    private String name = "idea_029983";
 ...
 */
@Slf4j
public class Idea29983Service {
    private static final int IDEA_ID = 29983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29983Service() {
        this(new Idea29983Config());
    }

    public Idea29983Service(Idea29983Config config) {
        this.config = config != null ? config : new Idea29983Config();
