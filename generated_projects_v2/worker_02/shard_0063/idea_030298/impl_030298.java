...
@Data
public class Idea30298Config {
    private String name = "idea_030298";
 ...
 */
@Slf4j
public class Idea30298Service {
    private static final int IDEA_ID = 30298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30298Service() {
        this(new Idea30298Config());
    }

    public Idea30298Service(Idea30298Config config) {
        this.config = config != null ? config : new Idea30298Config();
