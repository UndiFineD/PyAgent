...
@Data
public class Idea30350Config {
    private String name = "idea_030350";
 ...
 */
@Slf4j
public class Idea30350Service {
    private static final int IDEA_ID = 30350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30350Service() {
        this(new Idea30350Config());
    }

    public Idea30350Service(Idea30350Config config) {
        this.config = config != null ? config : new Idea30350Config();
