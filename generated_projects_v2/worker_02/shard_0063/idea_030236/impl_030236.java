...
@Data
public class Idea30236Config {
    private String name = "idea_030236";
 ...
 */
@Slf4j
public class Idea30236Service {
    private static final int IDEA_ID = 30236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30236Service() {
        this(new Idea30236Config());
    }

    public Idea30236Service(Idea30236Config config) {
        this.config = config != null ? config : new Idea30236Config();
