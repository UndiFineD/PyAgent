...
@Data
public class Idea30311Config {
    private String name = "idea_030311";
 ...
 */
@Slf4j
public class Idea30311Service {
    private static final int IDEA_ID = 30311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30311Service() {
        this(new Idea30311Config());
    }

    public Idea30311Service(Idea30311Config config) {
        this.config = config != null ? config : new Idea30311Config();
