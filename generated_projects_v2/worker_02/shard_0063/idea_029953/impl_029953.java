...
@Data
public class Idea29953Config {
    private String name = "idea_029953";
 ...
 */
@Slf4j
public class Idea29953Service {
    private static final int IDEA_ID = 29953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29953Service() {
        this(new Idea29953Config());
    }

    public Idea29953Service(Idea29953Config config) {
        this.config = config != null ? config : new Idea29953Config();
