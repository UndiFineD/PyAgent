...
@Data
public class Idea30388Config {
    private String name = "idea_030388";
 ...
 */
@Slf4j
public class Idea30388Service {
    private static final int IDEA_ID = 30388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30388Service() {
        this(new Idea30388Config());
    }

    public Idea30388Service(Idea30388Config config) {
        this.config = config != null ? config : new Idea30388Config();
