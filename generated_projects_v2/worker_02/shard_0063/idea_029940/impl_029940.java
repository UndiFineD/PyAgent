...
@Data
public class Idea29940Config {
    private String name = "idea_029940";
 ...
 */
@Slf4j
public class Idea29940Service {
    private static final int IDEA_ID = 29940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29940Service() {
        this(new Idea29940Config());
    }

    public Idea29940Service(Idea29940Config config) {
        this.config = config != null ? config : new Idea29940Config();
