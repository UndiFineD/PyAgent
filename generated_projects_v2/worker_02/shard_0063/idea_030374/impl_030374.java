...
@Data
public class Idea30374Config {
    private String name = "idea_030374";
 ...
 */
@Slf4j
public class Idea30374Service {
    private static final int IDEA_ID = 30374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30374Service() {
        this(new Idea30374Config());
    }

    public Idea30374Service(Idea30374Config config) {
        this.config = config != null ? config : new Idea30374Config();
