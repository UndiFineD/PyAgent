...
@Data
public class Idea30120Config {
    private String name = "idea_030120";
 ...
 */
@Slf4j
public class Idea30120Service {
    private static final int IDEA_ID = 30120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30120Service() {
        this(new Idea30120Config());
    }

    public Idea30120Service(Idea30120Config config) {
        this.config = config != null ? config : new Idea30120Config();
