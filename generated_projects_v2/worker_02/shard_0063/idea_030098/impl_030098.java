...
@Data
public class Idea30098Config {
    private String name = "idea_030098";
 ...
 */
@Slf4j
public class Idea30098Service {
    private static final int IDEA_ID = 30098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30098Service() {
        this(new Idea30098Config());
    }

    public Idea30098Service(Idea30098Config config) {
        this.config = config != null ? config : new Idea30098Config();
