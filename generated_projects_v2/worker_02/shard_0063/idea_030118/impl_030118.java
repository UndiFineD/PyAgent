...
@Data
public class Idea30118Config {
    private String name = "idea_030118";
 ...
 */
@Slf4j
public class Idea30118Service {
    private static final int IDEA_ID = 30118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30118Service() {
        this(new Idea30118Config());
    }

    public Idea30118Service(Idea30118Config config) {
        this.config = config != null ? config : new Idea30118Config();
