...
@Data
public class Idea30265Config {
    private String name = "idea_030265";
 ...
 */
@Slf4j
public class Idea30265Service {
    private static final int IDEA_ID = 30265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30265Service() {
        this(new Idea30265Config());
    }

    public Idea30265Service(Idea30265Config config) {
        this.config = config != null ? config : new Idea30265Config();
