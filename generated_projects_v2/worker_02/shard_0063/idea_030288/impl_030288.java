...
@Data
public class Idea30288Config {
    private String name = "idea_030288";
 ...
 */
@Slf4j
public class Idea30288Service {
    private static final int IDEA_ID = 30288;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30288Service() {
        this(new Idea30288Config());
    }

    public Idea30288Service(Idea30288Config config) {
        this.config = config != null ? config : new Idea30288Config();
