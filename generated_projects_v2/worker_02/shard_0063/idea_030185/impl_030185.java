...
@Data
public class Idea30185Config {
    private String name = "idea_030185";
 ...
 */
@Slf4j
public class Idea30185Service {
    private static final int IDEA_ID = 30185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30185Service() {
        this(new Idea30185Config());
    }

    public Idea30185Service(Idea30185Config config) {
        this.config = config != null ? config : new Idea30185Config();
