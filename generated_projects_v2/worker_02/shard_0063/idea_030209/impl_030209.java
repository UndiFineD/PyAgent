...
@Data
public class Idea30209Config {
    private String name = "idea_030209";
 ...
 */
@Slf4j
public class Idea30209Service {
    private static final int IDEA_ID = 30209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30209Service() {
        this(new Idea30209Config());
    }

    public Idea30209Service(Idea30209Config config) {
        this.config = config != null ? config : new Idea30209Config();
