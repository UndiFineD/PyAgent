...
@Data
public class Idea29986Config {
    private String name = "idea_029986";
 ...
 */
@Slf4j
public class Idea29986Service {
    private static final int IDEA_ID = 29986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29986Service() {
        this(new Idea29986Config());
    }

    public Idea29986Service(Idea29986Config config) {
        this.config = config != null ? config : new Idea29986Config();
