...
@Data
public class Idea30037Config {
    private String name = "idea_030037";
 ...
 */
@Slf4j
public class Idea30037Service {
    private static final int IDEA_ID = 30037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30037Service() {
        this(new Idea30037Config());
    }

    public Idea30037Service(Idea30037Config config) {
        this.config = config != null ? config : new Idea30037Config();
