...
@Data
public class Idea30331Config {
    private String name = "idea_030331";
 ...
 */
@Slf4j
public class Idea30331Service {
    private static final int IDEA_ID = 30331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30331Service() {
        this(new Idea30331Config());
    }

    public Idea30331Service(Idea30331Config config) {
        this.config = config != null ? config : new Idea30331Config();
