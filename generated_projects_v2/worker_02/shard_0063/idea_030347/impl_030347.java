...
@Data
public class Idea30347Config {
    private String name = "idea_030347";
 ...
 */
@Slf4j
public class Idea30347Service {
    private static final int IDEA_ID = 30347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30347Service() {
        this(new Idea30347Config());
    }

    public Idea30347Service(Idea30347Config config) {
        this.config = config != null ? config : new Idea30347Config();
