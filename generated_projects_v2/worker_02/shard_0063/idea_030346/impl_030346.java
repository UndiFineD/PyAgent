...
@Data
public class Idea30346Config {
    private String name = "idea_030346";
 ...
 */
@Slf4j
public class Idea30346Service {
    private static final int IDEA_ID = 30346;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30346Service() {
        this(new Idea30346Config());
    }

    public Idea30346Service(Idea30346Config config) {
        this.config = config != null ? config : new Idea30346Config();
