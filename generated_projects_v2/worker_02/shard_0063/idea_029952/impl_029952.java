...
@Data
public class Idea29952Config {
    private String name = "idea_029952";
 ...
 */
@Slf4j
public class Idea29952Service {
    private static final int IDEA_ID = 29952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29952Service() {
        this(new Idea29952Config());
    }

    public Idea29952Service(Idea29952Config config) {
        this.config = config != null ? config : new Idea29952Config();
