...
@Data
public class Idea30318Config {
    private String name = "idea_030318";
 ...
 */
@Slf4j
public class Idea30318Service {
    private static final int IDEA_ID = 30318;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30318Service() {
        this(new Idea30318Config());
    }

    public Idea30318Service(Idea30318Config config) {
        this.config = config != null ? config : new Idea30318Config();
