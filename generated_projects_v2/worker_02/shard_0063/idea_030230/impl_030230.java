...
@Data
public class Idea30230Config {
    private String name = "idea_030230";
 ...
 */
@Slf4j
public class Idea30230Service {
    private static final int IDEA_ID = 30230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30230Service() {
        this(new Idea30230Config());
    }

    public Idea30230Service(Idea30230Config config) {
        this.config = config != null ? config : new Idea30230Config();
