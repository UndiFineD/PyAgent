...
@Data
public class Idea30364Config {
    private String name = "idea_030364";
 ...
 */
@Slf4j
public class Idea30364Service {
    private static final int IDEA_ID = 30364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30364Service() {
        this(new Idea30364Config());
    }

    public Idea30364Service(Idea30364Config config) {
        this.config = config != null ? config : new Idea30364Config();
