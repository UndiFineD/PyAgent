...
@Data
public class Idea30213Config {
    private String name = "idea_030213";
 ...
 */
@Slf4j
public class Idea30213Service {
    private static final int IDEA_ID = 30213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30213Service() {
        this(new Idea30213Config());
    }

    public Idea30213Service(Idea30213Config config) {
        this.config = config != null ? config : new Idea30213Config();
