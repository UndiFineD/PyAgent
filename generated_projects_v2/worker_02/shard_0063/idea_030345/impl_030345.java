...
@Data
public class Idea30345Config {
    private String name = "idea_030345";
 ...
 */
@Slf4j
public class Idea30345Service {
    private static final int IDEA_ID = 30345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30345Service() {
        this(new Idea30345Config());
    }

    public Idea30345Service(Idea30345Config config) {
        this.config = config != null ? config : new Idea30345Config();
