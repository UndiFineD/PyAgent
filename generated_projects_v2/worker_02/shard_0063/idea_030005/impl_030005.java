...
@Data
public class Idea30005Config {
    private String name = "idea_030005";
 ...
 */
@Slf4j
public class Idea30005Service {
    private static final int IDEA_ID = 30005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30005Service() {
        this(new Idea30005Config());
    }

    public Idea30005Service(Idea30005Config config) {
        this.config = config != null ? config : new Idea30005Config();
