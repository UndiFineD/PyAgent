...
@Data
public class Idea30006Config {
    private String name = "idea_030006";
 ...
 */
@Slf4j
public class Idea30006Service {
    private static final int IDEA_ID = 30006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30006Service() {
        this(new Idea30006Config());
    }

    public Idea30006Service(Idea30006Config config) {
        this.config = config != null ? config : new Idea30006Config();
