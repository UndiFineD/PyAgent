...
@Data
public class Idea30300Config {
    private String name = "idea_030300";
 ...
 */
@Slf4j
public class Idea30300Service {
    private static final int IDEA_ID = 30300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30300Service() {
        this(new Idea30300Config());
    }

    public Idea30300Service(Idea30300Config config) {
        this.config = config != null ? config : new Idea30300Config();
