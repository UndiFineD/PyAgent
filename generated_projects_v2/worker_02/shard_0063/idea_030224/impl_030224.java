...
@Data
public class Idea30224Config {
    private String name = "idea_030224";
 ...
 */
@Slf4j
public class Idea30224Service {
    private static final int IDEA_ID = 30224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30224Service() {
        this(new Idea30224Config());
    }

    public Idea30224Service(Idea30224Config config) {
        this.config = config != null ? config : new Idea30224Config();
