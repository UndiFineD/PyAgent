...
@Data
public class Idea30196Config {
    private String name = "idea_030196";
 ...
 */
@Slf4j
public class Idea30196Service {
    private static final int IDEA_ID = 30196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30196Service() {
        this(new Idea30196Config());
    }

    public Idea30196Service(Idea30196Config config) {
        this.config = config != null ? config : new Idea30196Config();
