...
@Data
public class Idea29945Config {
    private String name = "idea_029945";
 ...
 */
@Slf4j
public class Idea29945Service {
    private static final int IDEA_ID = 29945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29945Service() {
        this(new Idea29945Config());
    }

    public Idea29945Service(Idea29945Config config) {
        this.config = config != null ? config : new Idea29945Config();
