...
@Data
public class Idea30147Config {
    private String name = "idea_030147";
 ...
 */
@Slf4j
public class Idea30147Service {
    private static final int IDEA_ID = 30147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30147Service() {
        this(new Idea30147Config());
    }

    public Idea30147Service(Idea30147Config config) {
        this.config = config != null ? config : new Idea30147Config();
