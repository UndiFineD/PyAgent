...
@Data
public class Idea30239Config {
    private String name = "idea_030239";
 ...
 */
@Slf4j
public class Idea30239Service {
    private static final int IDEA_ID = 30239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30239Service() {
        this(new Idea30239Config());
    }

    public Idea30239Service(Idea30239Config config) {
        this.config = config != null ? config : new Idea30239Config();
