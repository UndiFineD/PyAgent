...
@Data
public class Idea30158Config {
    private String name = "idea_030158";
 ...
 */
@Slf4j
public class Idea30158Service {
    private static final int IDEA_ID = 30158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30158Service() {
        this(new Idea30158Config());
    }

    public Idea30158Service(Idea30158Config config) {
        this.config = config != null ? config : new Idea30158Config();
