...
@Data
public class Idea29955Config {
    private String name = "idea_029955";
 ...
 */
@Slf4j
public class Idea29955Service {
    private static final int IDEA_ID = 29955;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29955Service() {
        this(new Idea29955Config());
    }

    public Idea29955Service(Idea29955Config config) {
        this.config = config != null ? config : new Idea29955Config();
