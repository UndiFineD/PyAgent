...
@Data
public class Idea30016Config {
    private String name = "idea_030016";
 ...
 */
@Slf4j
public class Idea30016Service {
    private static final int IDEA_ID = 30016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30016Service() {
        this(new Idea30016Config());
    }

    public Idea30016Service(Idea30016Config config) {
        this.config = config != null ? config : new Idea30016Config();
