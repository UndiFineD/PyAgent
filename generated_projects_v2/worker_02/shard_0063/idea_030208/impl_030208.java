...
@Data
public class Idea30208Config {
    private String name = "idea_030208";
 ...
 */
@Slf4j
public class Idea30208Service {
    private static final int IDEA_ID = 30208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30208Service() {
        this(new Idea30208Config());
    }

    public Idea30208Service(Idea30208Config config) {
        this.config = config != null ? config : new Idea30208Config();
