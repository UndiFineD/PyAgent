...
@Data
public class Idea29941Config {
    private String name = "idea_029941";
 ...
 */
@Slf4j
public class Idea29941Service {
    private static final int IDEA_ID = 29941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29941Service() {
        this(new Idea29941Config());
    }

    public Idea29941Service(Idea29941Config config) {
        this.config = config != null ? config : new Idea29941Config();
