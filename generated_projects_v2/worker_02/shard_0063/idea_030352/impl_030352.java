...
@Data
public class Idea30352Config {
    private String name = "idea_030352";
 ...
 */
@Slf4j
public class Idea30352Service {
    private static final int IDEA_ID = 30352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30352Service() {
        this(new Idea30352Config());
    }

    public Idea30352Service(Idea30352Config config) {
        this.config = config != null ? config : new Idea30352Config();
