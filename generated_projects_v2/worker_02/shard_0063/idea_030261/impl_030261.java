...
@Data
public class Idea30261Config {
    private String name = "idea_030261";
 ...
 */
@Slf4j
public class Idea30261Service {
    private static final int IDEA_ID = 30261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30261Service() {
        this(new Idea30261Config());
    }

    public Idea30261Service(Idea30261Config config) {
        this.config = config != null ? config : new Idea30261Config();
