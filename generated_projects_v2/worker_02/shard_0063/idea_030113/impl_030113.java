...
@Data
public class Idea30113Config {
    private String name = "idea_030113";
 ...
 */
@Slf4j
public class Idea30113Service {
    private static final int IDEA_ID = 30113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30113Service() {
        this(new Idea30113Config());
    }

    public Idea30113Service(Idea30113Config config) {
        this.config = config != null ? config : new Idea30113Config();
