...
@Data
public class Idea30390Config {
    private String name = "idea_030390";
 ...
 */
@Slf4j
public class Idea30390Service {
    private static final int IDEA_ID = 30390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30390Service() {
        this(new Idea30390Config());
    }

    public Idea30390Service(Idea30390Config config) {
        this.config = config != null ? config : new Idea30390Config();
