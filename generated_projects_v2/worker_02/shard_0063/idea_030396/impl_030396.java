...
@Data
public class Idea30396Config {
    private String name = "idea_030396";
 ...
 */
@Slf4j
public class Idea30396Service {
    private static final int IDEA_ID = 30396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30396Service() {
        this(new Idea30396Config());
    }

    public Idea30396Service(Idea30396Config config) {
        this.config = config != null ? config : new Idea30396Config();
