...
@Data
public class Idea30278Config {
    private String name = "idea_030278";
 ...
 */
@Slf4j
public class Idea30278Service {
    private static final int IDEA_ID = 30278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30278Service() {
        this(new Idea30278Config());
    }

    public Idea30278Service(Idea30278Config config) {
        this.config = config != null ? config : new Idea30278Config();
