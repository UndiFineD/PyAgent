...
@Data
public class Idea30222Config {
    private String name = "idea_030222";
 ...
 */
@Slf4j
public class Idea30222Service {
    private static final int IDEA_ID = 30222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30222Service() {
        this(new Idea30222Config());
    }

    public Idea30222Service(Idea30222Config config) {
        this.config = config != null ? config : new Idea30222Config();
