...
@Data
public class Idea30172Config {
    private String name = "idea_030172";
 ...
 */
@Slf4j
public class Idea30172Service {
    private static final int IDEA_ID = 30172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30172Service() {
        this(new Idea30172Config());
    }

    public Idea30172Service(Idea30172Config config) {
        this.config = config != null ? config : new Idea30172Config();
