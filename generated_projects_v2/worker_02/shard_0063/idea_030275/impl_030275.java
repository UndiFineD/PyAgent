...
@Data
public class Idea30275Config {
    private String name = "idea_030275";
 ...
 */
@Slf4j
public class Idea30275Service {
    private static final int IDEA_ID = 30275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30275Service() {
        this(new Idea30275Config());
    }

    public Idea30275Service(Idea30275Config config) {
        this.config = config != null ? config : new Idea30275Config();
