...
@Data
public class Idea30355Config {
    private String name = "idea_030355";
 ...
 */
@Slf4j
public class Idea30355Service {
    private static final int IDEA_ID = 30355;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30355Service() {
        this(new Idea30355Config());
    }

    public Idea30355Service(Idea30355Config config) {
        this.config = config != null ? config : new Idea30355Config();
