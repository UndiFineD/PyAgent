...
@Data
public class Idea29935Config {
    private String name = "idea_029935";
 ...
 */
@Slf4j
public class Idea29935Service {
    private static final int IDEA_ID = 29935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29935Service() {
        this(new Idea29935Config());
    }

    public Idea29935Service(Idea29935Config config) {
        this.config = config != null ? config : new Idea29935Config();
