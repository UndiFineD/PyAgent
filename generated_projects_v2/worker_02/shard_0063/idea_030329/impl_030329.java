...
@Data
public class Idea30329Config {
    private String name = "idea_030329";
 ...
 */
@Slf4j
public class Idea30329Service {
    private static final int IDEA_ID = 30329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30329Service() {
        this(new Idea30329Config());
    }

    public Idea30329Service(Idea30329Config config) {
        this.config = config != null ? config : new Idea30329Config();
