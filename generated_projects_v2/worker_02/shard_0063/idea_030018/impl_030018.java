...
@Data
public class Idea30018Config {
    private String name = "idea_030018";
 ...
 */
@Slf4j
public class Idea30018Service {
    private static final int IDEA_ID = 30018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30018Service() {
        this(new Idea30018Config());
    }

    public Idea30018Service(Idea30018Config config) {
        this.config = config != null ? config : new Idea30018Config();
