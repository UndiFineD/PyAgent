...
@Data
public class Idea30340Config {
    private String name = "idea_030340";
 ...
 */
@Slf4j
public class Idea30340Service {
    private static final int IDEA_ID = 30340;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30340Service() {
        this(new Idea30340Config());
    }

    public Idea30340Service(Idea30340Config config) {
        this.config = config != null ? config : new Idea30340Config();
