...
@Data
public class Idea30376Config {
    private String name = "idea_030376";
 ...
 */
@Slf4j
public class Idea30376Service {
    private static final int IDEA_ID = 30376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30376Service() {
        this(new Idea30376Config());
    }

    public Idea30376Service(Idea30376Config config) {
        this.config = config != null ? config : new Idea30376Config();
