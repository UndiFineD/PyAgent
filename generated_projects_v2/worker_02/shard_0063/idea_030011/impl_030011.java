...
@Data
public class Idea30011Config {
    private String name = "idea_030011";
 ...
 */
@Slf4j
public class Idea30011Service {
    private static final int IDEA_ID = 30011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30011Service() {
        this(new Idea30011Config());
    }

    public Idea30011Service(Idea30011Config config) {
        this.config = config != null ? config : new Idea30011Config();
