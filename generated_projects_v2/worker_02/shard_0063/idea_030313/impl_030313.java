...
@Data
public class Idea30313Config {
    private String name = "idea_030313";
 ...
 */
@Slf4j
public class Idea30313Service {
    private static final int IDEA_ID = 30313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30313Service() {
        this(new Idea30313Config());
    }

    public Idea30313Service(Idea30313Config config) {
        this.config = config != null ? config : new Idea30313Config();
