...
@Data
public class Idea30127Config {
    private String name = "idea_030127";
 ...
 */
@Slf4j
public class Idea30127Service {
    private static final int IDEA_ID = 30127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30127Service() {
        this(new Idea30127Config());
    }

    public Idea30127Service(Idea30127Config config) {
        this.config = config != null ? config : new Idea30127Config();
