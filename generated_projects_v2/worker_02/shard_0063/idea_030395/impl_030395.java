...
@Data
public class Idea30395Config {
    private String name = "idea_030395";
 ...
 */
@Slf4j
public class Idea30395Service {
    private static final int IDEA_ID = 30395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30395Service() {
        this(new Idea30395Config());
    }

    public Idea30395Service(Idea30395Config config) {
        this.config = config != null ? config : new Idea30395Config();
