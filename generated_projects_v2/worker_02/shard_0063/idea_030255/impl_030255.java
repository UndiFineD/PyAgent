...
@Data
public class Idea30255Config {
    private String name = "idea_030255";
 ...
 */
@Slf4j
public class Idea30255Service {
    private static final int IDEA_ID = 30255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30255Service() {
        this(new Idea30255Config());
    }

    public Idea30255Service(Idea30255Config config) {
        this.config = config != null ? config : new Idea30255Config();
