...
@Data
public class Idea29985Config {
    private String name = "idea_029985";
 ...
 */
@Slf4j
public class Idea29985Service {
    private static final int IDEA_ID = 29985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29985Service() {
        this(new Idea29985Config());
    }

    public Idea29985Service(Idea29985Config config) {
        this.config = config != null ? config : new Idea29985Config();
