...
@Data
public class Idea30386Config {
    private String name = "idea_030386";
 ...
 */
@Slf4j
public class Idea30386Service {
    private static final int IDEA_ID = 30386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30386Service() {
        this(new Idea30386Config());
    }

    public Idea30386Service(Idea30386Config config) {
        this.config = config != null ? config : new Idea30386Config();
