...
@Data
public class Idea30285Config {
    private String name = "idea_030285";
 ...
 */
@Slf4j
public class Idea30285Service {
    private static final int IDEA_ID = 30285;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30285Service() {
        this(new Idea30285Config());
    }

    public Idea30285Service(Idea30285Config config) {
        this.config = config != null ? config : new Idea30285Config();
