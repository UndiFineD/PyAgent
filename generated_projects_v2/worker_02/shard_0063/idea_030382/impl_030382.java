...
@Data
public class Idea30382Config {
    private String name = "idea_030382";
 ...
 */
@Slf4j
public class Idea30382Service {
    private static final int IDEA_ID = 30382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30382Service() {
        this(new Idea30382Config());
    }

    public Idea30382Service(Idea30382Config config) {
        this.config = config != null ? config : new Idea30382Config();
