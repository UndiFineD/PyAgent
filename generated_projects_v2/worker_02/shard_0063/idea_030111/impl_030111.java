...
@Data
public class Idea30111Config {
    private String name = "idea_030111";
 ...
 */
@Slf4j
public class Idea30111Service {
    private static final int IDEA_ID = 30111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30111Service() {
        this(new Idea30111Config());
    }

    public Idea30111Service(Idea30111Config config) {
        this.config = config != null ? config : new Idea30111Config();
