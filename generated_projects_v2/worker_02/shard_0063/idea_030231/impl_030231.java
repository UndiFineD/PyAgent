...
@Data
public class Idea30231Config {
    private String name = "idea_030231";
 ...
 */
@Slf4j
public class Idea30231Service {
    private static final int IDEA_ID = 30231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30231Service() {
        this(new Idea30231Config());
    }

    public Idea30231Service(Idea30231Config config) {
        this.config = config != null ? config : new Idea30231Config();
