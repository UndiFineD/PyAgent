...
@Data
public class Idea30186Config {
    private String name = "idea_030186";
 ...
 */
@Slf4j
public class Idea30186Service {
    private static final int IDEA_ID = 30186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30186Service() {
        this(new Idea30186Config());
    }

    public Idea30186Service(Idea30186Config config) {
        this.config = config != null ? config : new Idea30186Config();
