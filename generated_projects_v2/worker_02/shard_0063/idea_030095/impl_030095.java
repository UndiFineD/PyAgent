...
@Data
public class Idea30095Config {
    private String name = "idea_030095";
 ...
 */
@Slf4j
public class Idea30095Service {
    private static final int IDEA_ID = 30095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30095Service() {
        this(new Idea30095Config());
    }

    public Idea30095Service(Idea30095Config config) {
        this.config = config != null ? config : new Idea30095Config();
