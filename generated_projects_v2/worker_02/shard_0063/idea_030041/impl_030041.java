...
@Data
public class Idea30041Config {
    private String name = "idea_030041";
 ...
 */
@Slf4j
public class Idea30041Service {
    private static final int IDEA_ID = 30041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30041Service() {
        this(new Idea30041Config());
    }

    public Idea30041Service(Idea30041Config config) {
        this.config = config != null ? config : new Idea30041Config();
