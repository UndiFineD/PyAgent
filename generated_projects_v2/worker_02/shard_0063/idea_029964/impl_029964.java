...
@Data
public class Idea29964Config {
    private String name = "idea_029964";
 ...
 */
@Slf4j
public class Idea29964Service {
    private static final int IDEA_ID = 29964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29964Service() {
        this(new Idea29964Config());
    }

    public Idea29964Service(Idea29964Config config) {
        this.config = config != null ? config : new Idea29964Config();
