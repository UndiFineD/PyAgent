...
@Data
public class Idea30112Config {
    private String name = "idea_030112";
 ...
 */
@Slf4j
public class Idea30112Service {
    private static final int IDEA_ID = 30112;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30112Service() {
        this(new Idea30112Config());
    }

    public Idea30112Service(Idea30112Config config) {
        this.config = config != null ? config : new Idea30112Config();
