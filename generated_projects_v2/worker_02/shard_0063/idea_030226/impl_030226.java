...
@Data
public class Idea30226Config {
    private String name = "idea_030226";
 ...
 */
@Slf4j
public class Idea30226Service {
    private static final int IDEA_ID = 30226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30226Service() {
        this(new Idea30226Config());
    }

    public Idea30226Service(Idea30226Config config) {
        this.config = config != null ? config : new Idea30226Config();
