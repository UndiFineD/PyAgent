...
@Data
public class Idea30341Config {
    private String name = "idea_030341";
 ...
 */
@Slf4j
public class Idea30341Service {
    private static final int IDEA_ID = 30341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30341Service() {
        this(new Idea30341Config());
    }

    public Idea30341Service(Idea30341Config config) {
        this.config = config != null ? config : new Idea30341Config();
