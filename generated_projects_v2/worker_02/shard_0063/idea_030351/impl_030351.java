...
@Data
public class Idea30351Config {
    private String name = "idea_030351";
 ...
 */
@Slf4j
public class Idea30351Service {
    private static final int IDEA_ID = 30351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30351Service() {
        this(new Idea30351Config());
    }

    public Idea30351Service(Idea30351Config config) {
        this.config = config != null ? config : new Idea30351Config();
