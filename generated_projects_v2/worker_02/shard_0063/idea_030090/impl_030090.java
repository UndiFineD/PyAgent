...
@Data
public class Idea30090Config {
    private String name = "idea_030090";
 ...
 */
@Slf4j
public class Idea30090Service {
    private static final int IDEA_ID = 30090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30090Service() {
        this(new Idea30090Config());
    }

    public Idea30090Service(Idea30090Config config) {
        this.config = config != null ? config : new Idea30090Config();
