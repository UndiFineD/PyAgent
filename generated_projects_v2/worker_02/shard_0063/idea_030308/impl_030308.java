...
@Data
public class Idea30308Config {
    private String name = "idea_030308";
 ...
 */
@Slf4j
public class Idea30308Service {
    private static final int IDEA_ID = 30308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30308Service() {
        this(new Idea30308Config());
    }

    public Idea30308Service(Idea30308Config config) {
        this.config = config != null ? config : new Idea30308Config();
