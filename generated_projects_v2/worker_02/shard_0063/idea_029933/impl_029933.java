...
@Data
public class Idea29933Config {
    private String name = "idea_029933";
 ...
 */
@Slf4j
public class Idea29933Service {
    private static final int IDEA_ID = 29933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29933Service() {
        this(new Idea29933Config());
    }

    public Idea29933Service(Idea29933Config config) {
        this.config = config != null ? config : new Idea29933Config();
