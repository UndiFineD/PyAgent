...
@Data
public class Idea30150Config {
    private String name = "idea_030150";
 ...
 */
@Slf4j
public class Idea30150Service {
    private static final int IDEA_ID = 30150;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30150Service() {
        this(new Idea30150Config());
    }

    public Idea30150Service(Idea30150Config config) {
        this.config = config != null ? config : new Idea30150Config();
