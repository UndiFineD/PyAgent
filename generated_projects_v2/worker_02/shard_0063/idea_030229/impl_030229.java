...
@Data
public class Idea30229Config {
    private String name = "idea_030229";
 ...
 */
@Slf4j
public class Idea30229Service {
    private static final int IDEA_ID = 30229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30229Service() {
        this(new Idea30229Config());
    }

    public Idea30229Service(Idea30229Config config) {
        this.config = config != null ? config : new Idea30229Config();
