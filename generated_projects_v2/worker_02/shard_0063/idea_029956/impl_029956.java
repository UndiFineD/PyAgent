...
@Data
public class Idea29956Config {
    private String name = "idea_029956";
 ...
 */
@Slf4j
public class Idea29956Service {
    private static final int IDEA_ID = 29956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29956Service() {
        this(new Idea29956Config());
    }

    public Idea29956Service(Idea29956Config config) {
        this.config = config != null ? config : new Idea29956Config();
