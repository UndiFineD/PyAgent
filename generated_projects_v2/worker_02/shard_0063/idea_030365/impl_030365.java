...
@Data
public class Idea30365Config {
    private String name = "idea_030365";
 ...
 */
@Slf4j
public class Idea30365Service {
    private static final int IDEA_ID = 30365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30365Service() {
        this(new Idea30365Config());
    }

    public Idea30365Service(Idea30365Config config) {
        this.config = config != null ? config : new Idea30365Config();
