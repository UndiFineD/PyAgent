...
@Data
public class Idea30210Config {
    private String name = "idea_030210";
 ...
 */
@Slf4j
public class Idea30210Service {
    private static final int IDEA_ID = 30210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30210Service() {
        this(new Idea30210Config());
    }

    public Idea30210Service(Idea30210Config config) {
        this.config = config != null ? config : new Idea30210Config();
