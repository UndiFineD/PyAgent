...
@Data
public class Idea30106Config {
    private String name = "idea_030106";
 ...
 */
@Slf4j
public class Idea30106Service {
    private static final int IDEA_ID = 30106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30106Service() {
        this(new Idea30106Config());
    }

    public Idea30106Service(Idea30106Config config) {
        this.config = config != null ? config : new Idea30106Config();
