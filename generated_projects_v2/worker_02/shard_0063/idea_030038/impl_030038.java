...
@Data
public class Idea30038Config {
    private String name = "idea_030038";
 ...
 */
@Slf4j
public class Idea30038Service {
    private static final int IDEA_ID = 30038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30038Service() {
        this(new Idea30038Config());
    }

    public Idea30038Service(Idea30038Config config) {
        this.config = config != null ? config : new Idea30038Config();
