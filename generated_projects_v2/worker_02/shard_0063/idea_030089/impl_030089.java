...
@Data
public class Idea30089Config {
    private String name = "idea_030089";
 ...
 */
@Slf4j
public class Idea30089Service {
    private static final int IDEA_ID = 30089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30089Service() {
        this(new Idea30089Config());
    }

    public Idea30089Service(Idea30089Config config) {
        this.config = config != null ? config : new Idea30089Config();
