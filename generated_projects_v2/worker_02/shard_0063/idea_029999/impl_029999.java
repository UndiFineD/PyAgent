...
@Data
public class Idea29999Config {
    private String name = "idea_029999";
 ...
 */
@Slf4j
public class Idea29999Service {
    private static final int IDEA_ID = 29999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29999Service() {
        this(new Idea29999Config());
    }

    public Idea29999Service(Idea29999Config config) {
        this.config = config != null ? config : new Idea29999Config();
