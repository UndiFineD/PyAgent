...
@Data
public class Idea30177Config {
    private String name = "idea_030177";
 ...
 */
@Slf4j
public class Idea30177Service {
    private static final int IDEA_ID = 30177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30177Service() {
        this(new Idea30177Config());
    }

    public Idea30177Service(Idea30177Config config) {
        this.config = config != null ? config : new Idea30177Config();
