...
@Data
public class Idea29958Config {
    private String name = "idea_029958";
 ...
 */
@Slf4j
public class Idea29958Service {
    private static final int IDEA_ID = 29958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29958Service() {
        this(new Idea29958Config());
    }

    public Idea29958Service(Idea29958Config config) {
        this.config = config != null ? config : new Idea29958Config();
