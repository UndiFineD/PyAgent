...
@Data
public class Idea30107Config {
    private String name = "idea_030107";
 ...
 */
@Slf4j
public class Idea30107Service {
    private static final int IDEA_ID = 30107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30107Service() {
        this(new Idea30107Config());
    }

    public Idea30107Service(Idea30107Config config) {
        this.config = config != null ? config : new Idea30107Config();
