...
@Data
public class Idea30166Config {
    private String name = "idea_030166";
 ...
 */
@Slf4j
public class Idea30166Service {
    private static final int IDEA_ID = 30166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30166Service() {
        this(new Idea30166Config());
    }

    public Idea30166Service(Idea30166Config config) {
        this.config = config != null ? config : new Idea30166Config();
