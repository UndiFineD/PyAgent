...
@Data
public class Idea29929Config {
    private String name = "idea_029929";
 ...
 */
@Slf4j
public class Idea29929Service {
    private static final int IDEA_ID = 29929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29929Service() {
        this(new Idea29929Config());
    }

    public Idea29929Service(Idea29929Config config) {
        this.config = config != null ? config : new Idea29929Config();
