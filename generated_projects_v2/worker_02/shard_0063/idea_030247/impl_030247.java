...
@Data
public class Idea30247Config {
    private String name = "idea_030247";
 ...
 */
@Slf4j
public class Idea30247Service {
    private static final int IDEA_ID = 30247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30247Service() {
        this(new Idea30247Config());
    }

    public Idea30247Service(Idea30247Config config) {
        this.config = config != null ? config : new Idea30247Config();
