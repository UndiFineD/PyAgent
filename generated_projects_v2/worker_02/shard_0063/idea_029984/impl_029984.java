...
@Data
public class Idea29984Config {
    private String name = "idea_029984";
 ...
 */
@Slf4j
public class Idea29984Service {
    private static final int IDEA_ID = 29984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29984Service() {
        this(new Idea29984Config());
    }

    public Idea29984Service(Idea29984Config config) {
        this.config = config != null ? config : new Idea29984Config();
