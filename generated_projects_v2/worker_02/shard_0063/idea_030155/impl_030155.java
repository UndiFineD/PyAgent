...
@Data
public class Idea30155Config {
    private String name = "idea_030155";
 ...
 */
@Slf4j
public class Idea30155Service {
    private static final int IDEA_ID = 30155;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30155Service() {
        this(new Idea30155Config());
    }

    public Idea30155Service(Idea30155Config config) {
        this.config = config != null ? config : new Idea30155Config();
