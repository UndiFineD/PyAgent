...
@Data
public class Idea29972Config {
    private String name = "idea_029972";
 ...
 */
@Slf4j
public class Idea29972Service {
    private static final int IDEA_ID = 29972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29972Service() {
        this(new Idea29972Config());
    }

    public Idea29972Service(Idea29972Config config) {
        this.config = config != null ? config : new Idea29972Config();
