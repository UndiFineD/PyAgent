...
@Data
public class Idea30028Config {
    private String name = "idea_030028";
 ...
 */
@Slf4j
public class Idea30028Service {
    private static final int IDEA_ID = 30028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30028Service() {
        this(new Idea30028Config());
    }

    public Idea30028Service(Idea30028Config config) {
        this.config = config != null ? config : new Idea30028Config();
