...
@Data
public class Idea30391Config {
    private String name = "idea_030391";
 ...
 */
@Slf4j
public class Idea30391Service {
    private static final int IDEA_ID = 30391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30391Service() {
        this(new Idea30391Config());
    }

    public Idea30391Service(Idea30391Config config) {
        this.config = config != null ? config : new Idea30391Config();
