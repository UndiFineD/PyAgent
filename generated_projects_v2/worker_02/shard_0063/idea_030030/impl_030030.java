...
@Data
public class Idea30030Config {
    private String name = "idea_030030";
 ...
 */
@Slf4j
public class Idea30030Service {
    private static final int IDEA_ID = 30030;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30030Service() {
        this(new Idea30030Config());
    }

    public Idea30030Service(Idea30030Config config) {
        this.config = config != null ? config : new Idea30030Config();
