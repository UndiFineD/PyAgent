...
@Data
public class Idea30339Config {
    private String name = "idea_030339";
 ...
 */
@Slf4j
public class Idea30339Service {
    private static final int IDEA_ID = 30339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30339Service() {
        this(new Idea30339Config());
    }

    public Idea30339Service(Idea30339Config config) {
        this.config = config != null ? config : new Idea30339Config();
