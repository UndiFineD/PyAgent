...
@Data
public class Idea30119Config {
    private String name = "idea_030119";
 ...
 */
@Slf4j
public class Idea30119Service {
    private static final int IDEA_ID = 30119;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30119Service() {
        this(new Idea30119Config());
    }

    public Idea30119Service(Idea30119Config config) {
        this.config = config != null ? config : new Idea30119Config();
