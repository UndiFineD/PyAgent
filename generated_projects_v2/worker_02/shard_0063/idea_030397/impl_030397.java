...
@Data
public class Idea30397Config {
    private String name = "idea_030397";
 ...
 */
@Slf4j
public class Idea30397Service {
    private static final int IDEA_ID = 30397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30397Service() {
        this(new Idea30397Config());
    }

    public Idea30397Service(Idea30397Config config) {
        this.config = config != null ? config : new Idea30397Config();
