...
@Data
public class Idea30170Config {
    private String name = "idea_030170";
 ...
 */
@Slf4j
public class Idea30170Service {
    private static final int IDEA_ID = 30170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30170Service() {
        this(new Idea30170Config());
    }

    public Idea30170Service(Idea30170Config config) {
        this.config = config != null ? config : new Idea30170Config();
