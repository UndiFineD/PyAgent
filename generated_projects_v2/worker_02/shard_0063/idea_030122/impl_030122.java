...
@Data
public class Idea30122Config {
    private String name = "idea_030122";
 ...
 */
@Slf4j
public class Idea30122Service {
    private static final int IDEA_ID = 30122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30122Service() {
        this(new Idea30122Config());
    }

    public Idea30122Service(Idea30122Config config) {
        this.config = config != null ? config : new Idea30122Config();
