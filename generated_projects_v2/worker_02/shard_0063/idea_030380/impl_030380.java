...
@Data
public class Idea30380Config {
    private String name = "idea_030380";
 ...
 */
@Slf4j
public class Idea30380Service {
    private static final int IDEA_ID = 30380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30380Service() {
        this(new Idea30380Config());
    }

    public Idea30380Service(Idea30380Config config) {
        this.config = config != null ? config : new Idea30380Config();
