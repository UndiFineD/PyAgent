...
@Data
public class Idea30000Config {
    private String name = "idea_030000";
 ...
 */
@Slf4j
public class Idea30000Service {
    private static final int IDEA_ID = 30000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30000Service() {
        this(new Idea30000Config());
    }

    public Idea30000Service(Idea30000Config config) {
        this.config = config != null ? config : new Idea30000Config();
