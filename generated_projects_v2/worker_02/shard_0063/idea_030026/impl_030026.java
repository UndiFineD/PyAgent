...
@Data
public class Idea30026Config {
    private String name = "idea_030026";
 ...
 */
@Slf4j
public class Idea30026Service {
    private static final int IDEA_ID = 30026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30026Service() {
        this(new Idea30026Config());
    }

    public Idea30026Service(Idea30026Config config) {
        this.config = config != null ? config : new Idea30026Config();
