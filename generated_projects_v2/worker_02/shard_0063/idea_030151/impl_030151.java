...
@Data
public class Idea30151Config {
    private String name = "idea_030151";
 ...
 */
@Slf4j
public class Idea30151Service {
    private static final int IDEA_ID = 30151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30151Service() {
        this(new Idea30151Config());
    }

    public Idea30151Service(Idea30151Config config) {
        this.config = config != null ? config : new Idea30151Config();
