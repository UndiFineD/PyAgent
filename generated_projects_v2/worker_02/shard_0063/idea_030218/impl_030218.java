...
@Data
public class Idea30218Config {
    private String name = "idea_030218";
 ...
 */
@Slf4j
public class Idea30218Service {
    private static final int IDEA_ID = 30218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30218Service() {
        this(new Idea30218Config());
    }

    public Idea30218Service(Idea30218Config config) {
        this.config = config != null ? config : new Idea30218Config();
