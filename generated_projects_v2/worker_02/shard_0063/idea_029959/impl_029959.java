...
@Data
public class Idea29959Config {
    private String name = "idea_029959";
 ...
 */
@Slf4j
public class Idea29959Service {
    private static final int IDEA_ID = 29959;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29959Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29959Service() {
        this(new Idea29959Config());
    }

    public Idea29959Service(Idea29959Config config) {
        this.config = config != null ? config : new Idea29959Config();
