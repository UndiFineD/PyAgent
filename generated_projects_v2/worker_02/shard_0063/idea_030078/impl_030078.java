...
@Data
public class Idea30078Config {
    private String name = "idea_030078";
 ...
 */
@Slf4j
public class Idea30078Service {
    private static final int IDEA_ID = 30078;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30078Service() {
        this(new Idea30078Config());
    }

    public Idea30078Service(Idea30078Config config) {
        this.config = config != null ? config : new Idea30078Config();
