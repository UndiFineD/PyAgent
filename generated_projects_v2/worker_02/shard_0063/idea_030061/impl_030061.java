...
@Data
public class Idea30061Config {
    private String name = "idea_030061";
 ...
 */
@Slf4j
public class Idea30061Service {
    private static final int IDEA_ID = 30061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30061Service() {
        this(new Idea30061Config());
    }

    public Idea30061Service(Idea30061Config config) {
        this.config = config != null ? config : new Idea30061Config();
