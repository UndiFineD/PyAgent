...
@Data
public class Idea30373Config {
    private String name = "idea_030373";
 ...
 */
@Slf4j
public class Idea30373Service {
    private static final int IDEA_ID = 30373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30373Service() {
        this(new Idea30373Config());
    }

    public Idea30373Service(Idea30373Config config) {
        this.config = config != null ? config : new Idea30373Config();
