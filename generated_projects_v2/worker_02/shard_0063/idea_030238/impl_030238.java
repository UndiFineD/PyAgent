...
@Data
public class Idea30238Config {
    private String name = "idea_030238";
 ...
 */
@Slf4j
public class Idea30238Service {
    private static final int IDEA_ID = 30238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30238Service() {
        this(new Idea30238Config());
    }

    public Idea30238Service(Idea30238Config config) {
        this.config = config != null ? config : new Idea30238Config();
