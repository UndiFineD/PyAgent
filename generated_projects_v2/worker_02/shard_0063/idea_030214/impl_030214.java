...
@Data
public class Idea30214Config {
    private String name = "idea_030214";
 ...
 */
@Slf4j
public class Idea30214Service {
    private static final int IDEA_ID = 30214;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30214Service() {
        this(new Idea30214Config());
    }

    public Idea30214Service(Idea30214Config config) {
        this.config = config != null ? config : new Idea30214Config();
