...
@Data
public class Idea30154Config {
    private String name = "idea_030154";
 ...
 */
@Slf4j
public class Idea30154Service {
    private static final int IDEA_ID = 30154;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30154Service() {
        this(new Idea30154Config());
    }

    public Idea30154Service(Idea30154Config config) {
        this.config = config != null ? config : new Idea30154Config();
