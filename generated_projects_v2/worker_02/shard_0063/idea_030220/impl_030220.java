...
@Data
public class Idea30220Config {
    private String name = "idea_030220";
 ...
 */
@Slf4j
public class Idea30220Service {
    private static final int IDEA_ID = 30220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30220Service() {
        this(new Idea30220Config());
    }

    public Idea30220Service(Idea30220Config config) {
        this.config = config != null ? config : new Idea30220Config();
