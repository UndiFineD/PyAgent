...
@Data
public class Idea30240Config {
    private String name = "idea_030240";
 ...
 */
@Slf4j
public class Idea30240Service {
    private static final int IDEA_ID = 30240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30240Service() {
        this(new Idea30240Config());
    }

    public Idea30240Service(Idea30240Config config) {
        this.config = config != null ? config : new Idea30240Config();
