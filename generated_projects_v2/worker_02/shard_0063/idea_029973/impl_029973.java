...
@Data
public class Idea29973Config {
    private String name = "idea_029973";
 ...
 */
@Slf4j
public class Idea29973Service {
    private static final int IDEA_ID = 29973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29973Service() {
        this(new Idea29973Config());
    }

    public Idea29973Service(Idea29973Config config) {
        this.config = config != null ? config : new Idea29973Config();
