...
@Data
public class Idea30013Config {
    private String name = "idea_030013";
 ...
 */
@Slf4j
public class Idea30013Service {
    private static final int IDEA_ID = 30013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30013Service() {
        this(new Idea30013Config());
    }

    public Idea30013Service(Idea30013Config config) {
        this.config = config != null ? config : new Idea30013Config();
