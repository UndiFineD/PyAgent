...
@Data
public class Idea30062Config {
    private String name = "idea_030062";
 ...
 */
@Slf4j
public class Idea30062Service {
    private static final int IDEA_ID = 30062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30062Service() {
        this(new Idea30062Config());
    }

    public Idea30062Service(Idea30062Config config) {
        this.config = config != null ? config : new Idea30062Config();
