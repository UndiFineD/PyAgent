...
@Data
public class Idea30139Config {
    private String name = "idea_030139";
 ...
 */
@Slf4j
public class Idea30139Service {
    private static final int IDEA_ID = 30139;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30139Service() {
        this(new Idea30139Config());
    }

    public Idea30139Service(Idea30139Config config) {
        this.config = config != null ? config : new Idea30139Config();
