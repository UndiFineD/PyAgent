...
@Data
public class Idea30116Config {
    private String name = "idea_030116";
 ...
 */
@Slf4j
public class Idea30116Service {
    private static final int IDEA_ID = 30116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30116Service() {
        this(new Idea30116Config());
    }

    public Idea30116Service(Idea30116Config config) {
        this.config = config != null ? config : new Idea30116Config();
