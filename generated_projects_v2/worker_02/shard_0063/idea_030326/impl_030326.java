...
@Data
public class Idea30326Config {
    private String name = "idea_030326";
 ...
 */
@Slf4j
public class Idea30326Service {
    private static final int IDEA_ID = 30326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30326Service() {
        this(new Idea30326Config());
    }

    public Idea30326Service(Idea30326Config config) {
        this.config = config != null ? config : new Idea30326Config();
