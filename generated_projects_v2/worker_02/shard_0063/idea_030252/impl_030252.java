...
@Data
public class Idea30252Config {
    private String name = "idea_030252";
 ...
 */
@Slf4j
public class Idea30252Service {
    private static final int IDEA_ID = 30252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30252Service() {
        this(new Idea30252Config());
    }

    public Idea30252Service(Idea30252Config config) {
        this.config = config != null ? config : new Idea30252Config();
