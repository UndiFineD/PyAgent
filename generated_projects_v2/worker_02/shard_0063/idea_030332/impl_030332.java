...
@Data
public class Idea30332Config {
    private String name = "idea_030332";
 ...
 */
@Slf4j
public class Idea30332Service {
    private static final int IDEA_ID = 30332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30332Service() {
        this(new Idea30332Config());
    }

    public Idea30332Service(Idea30332Config config) {
        this.config = config != null ? config : new Idea30332Config();
