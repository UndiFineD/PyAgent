...
@Data
public class Idea30007Config {
    private String name = "idea_030007";
 ...
 */
@Slf4j
public class Idea30007Service {
    private static final int IDEA_ID = 30007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30007Service() {
        this(new Idea30007Config());
    }

    public Idea30007Service(Idea30007Config config) {
        this.config = config != null ? config : new Idea30007Config();
