...
@Data
public class Idea30267Config {
    private String name = "idea_030267";
 ...
 */
@Slf4j
public class Idea30267Service {
    private static final int IDEA_ID = 30267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30267Service() {
        this(new Idea30267Config());
    }

    public Idea30267Service(Idea30267Config config) {
        this.config = config != null ? config : new Idea30267Config();
