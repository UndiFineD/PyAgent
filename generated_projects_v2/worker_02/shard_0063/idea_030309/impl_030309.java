...
@Data
public class Idea30309Config {
    private String name = "idea_030309";
 ...
 */
@Slf4j
public class Idea30309Service {
    private static final int IDEA_ID = 30309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30309Service() {
        this(new Idea30309Config());
    }

    public Idea30309Service(Idea30309Config config) {
        this.config = config != null ? config : new Idea30309Config();
