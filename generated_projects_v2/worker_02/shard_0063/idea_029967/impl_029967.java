...
@Data
public class Idea29967Config {
    private String name = "idea_029967";
 ...
 */
@Slf4j
public class Idea29967Service {
    private static final int IDEA_ID = 29967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29967Service() {
        this(new Idea29967Config());
    }

    public Idea29967Service(Idea29967Config config) {
        this.config = config != null ? config : new Idea29967Config();
