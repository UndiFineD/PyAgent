...
@Data
public class Idea29998Config {
    private String name = "idea_029998";
 ...
 */
@Slf4j
public class Idea29998Service {
    private static final int IDEA_ID = 29998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29998Service() {
        this(new Idea29998Config());
    }

    public Idea29998Service(Idea29998Config config) {
        this.config = config != null ? config : new Idea29998Config();
