...
@Data
public class Idea29948Config {
    private String name = "idea_029948";
 ...
 */
@Slf4j
public class Idea29948Service {
    private static final int IDEA_ID = 29948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29948Service() {
        this(new Idea29948Config());
    }

    public Idea29948Service(Idea29948Config config) {
        this.config = config != null ? config : new Idea29948Config();
