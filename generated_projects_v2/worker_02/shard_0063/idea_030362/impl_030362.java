...
@Data
public class Idea30362Config {
    private String name = "idea_030362";
 ...
 */
@Slf4j
public class Idea30362Service {
    private static final int IDEA_ID = 30362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30362Service() {
        this(new Idea30362Config());
    }

    public Idea30362Service(Idea30362Config config) {
        this.config = config != null ? config : new Idea30362Config();
