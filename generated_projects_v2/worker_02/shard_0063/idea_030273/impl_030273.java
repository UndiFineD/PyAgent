...
@Data
public class Idea30273Config {
    private String name = "idea_030273";
 ...
 */
@Slf4j
public class Idea30273Service {
    private static final int IDEA_ID = 30273;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30273Service() {
        this(new Idea30273Config());
    }

    public Idea30273Service(Idea30273Config config) {
        this.config = config != null ? config : new Idea30273Config();
