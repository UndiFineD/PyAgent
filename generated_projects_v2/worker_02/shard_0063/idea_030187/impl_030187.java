...
@Data
public class Idea30187Config {
    private String name = "idea_030187";
 ...
 */
@Slf4j
public class Idea30187Service {
    private static final int IDEA_ID = 30187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30187Service() {
        this(new Idea30187Config());
    }

    public Idea30187Service(Idea30187Config config) {
        this.config = config != null ? config : new Idea30187Config();
