...
@Data
public class Idea30325Config {
    private String name = "idea_030325";
 ...
 */
@Slf4j
public class Idea30325Service {
    private static final int IDEA_ID = 30325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30325Service() {
        this(new Idea30325Config());
    }

    public Idea30325Service(Idea30325Config config) {
        this.config = config != null ? config : new Idea30325Config();
