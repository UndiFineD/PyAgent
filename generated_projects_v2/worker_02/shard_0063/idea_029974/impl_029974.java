...
@Data
public class Idea29974Config {
    private String name = "idea_029974";
 ...
 */
@Slf4j
public class Idea29974Service {
    private static final int IDEA_ID = 29974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29974Service() {
        this(new Idea29974Config());
    }

    public Idea29974Service(Idea29974Config config) {
        this.config = config != null ? config : new Idea29974Config();
