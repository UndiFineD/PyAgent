...
@Data
public class Idea30223Config {
    private String name = "idea_030223";
 ...
 */
@Slf4j
public class Idea30223Service {
    private static final int IDEA_ID = 30223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30223Service() {
        this(new Idea30223Config());
    }

    public Idea30223Service(Idea30223Config config) {
        this.config = config != null ? config : new Idea30223Config();
