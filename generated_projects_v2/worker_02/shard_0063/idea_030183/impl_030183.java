...
@Data
public class Idea30183Config {
    private String name = "idea_030183";
 ...
 */
@Slf4j
public class Idea30183Service {
    private static final int IDEA_ID = 30183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30183Service() {
        this(new Idea30183Config());
    }

    public Idea30183Service(Idea30183Config config) {
        this.config = config != null ? config : new Idea30183Config();
