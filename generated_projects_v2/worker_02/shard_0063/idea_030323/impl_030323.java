...
@Data
public class Idea30323Config {
    private String name = "idea_030323";
 ...
 */
@Slf4j
public class Idea30323Service {
    private static final int IDEA_ID = 30323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30323Service() {
        this(new Idea30323Config());
    }

    public Idea30323Service(Idea30323Config config) {
        this.config = config != null ? config : new Idea30323Config();
