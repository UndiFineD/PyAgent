...
@Data
public class Idea30103Config {
    private String name = "idea_030103";
 ...
 */
@Slf4j
public class Idea30103Service {
    private static final int IDEA_ID = 30103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30103Service() {
        this(new Idea30103Config());
    }

    public Idea30103Service(Idea30103Config config) {
        this.config = config != null ? config : new Idea30103Config();
