...
@Data
public class Idea30295Config {
    private String name = "idea_030295";
 ...
 */
@Slf4j
public class Idea30295Service {
    private static final int IDEA_ID = 30295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30295Service() {
        this(new Idea30295Config());
    }

    public Idea30295Service(Idea30295Config config) {
        this.config = config != null ? config : new Idea30295Config();
