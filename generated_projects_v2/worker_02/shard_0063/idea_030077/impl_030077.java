...
@Data
public class Idea30077Config {
    private String name = "idea_030077";
 ...
 */
@Slf4j
public class Idea30077Service {
    private static final int IDEA_ID = 30077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30077Service() {
        this(new Idea30077Config());
    }

    public Idea30077Service(Idea30077Config config) {
        this.config = config != null ? config : new Idea30077Config();
