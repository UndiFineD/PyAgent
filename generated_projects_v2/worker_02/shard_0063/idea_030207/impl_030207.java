...
@Data
public class Idea30207Config {
    private String name = "idea_030207";
 ...
 */
@Slf4j
public class Idea30207Service {
    private static final int IDEA_ID = 30207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30207Service() {
        this(new Idea30207Config());
    }

    public Idea30207Service(Idea30207Config config) {
        this.config = config != null ? config : new Idea30207Config();
