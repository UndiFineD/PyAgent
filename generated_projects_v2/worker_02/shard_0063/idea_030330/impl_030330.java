...
@Data
public class Idea30330Config {
    private String name = "idea_030330";
 ...
 */
@Slf4j
public class Idea30330Service {
    private static final int IDEA_ID = 30330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30330Service() {
        this(new Idea30330Config());
    }

    public Idea30330Service(Idea30330Config config) {
        this.config = config != null ? config : new Idea30330Config();
