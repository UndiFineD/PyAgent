...
@Data
public class Idea30387Config {
    private String name = "idea_030387";
 ...
 */
@Slf4j
public class Idea30387Service {
    private static final int IDEA_ID = 30387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30387Service() {
        this(new Idea30387Config());
    }

    public Idea30387Service(Idea30387Config config) {
        this.config = config != null ? config : new Idea30387Config();
