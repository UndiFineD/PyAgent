...
@Data
public class Idea30372Config {
    private String name = "idea_030372";
 ...
 */
@Slf4j
public class Idea30372Service {
    private static final int IDEA_ID = 30372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30372Service() {
        this(new Idea30372Config());
    }

    public Idea30372Service(Idea30372Config config) {
        this.config = config != null ? config : new Idea30372Config();
