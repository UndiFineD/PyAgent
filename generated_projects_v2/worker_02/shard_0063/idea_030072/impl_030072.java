...
@Data
public class Idea30072Config {
    private String name = "idea_030072";
 ...
 */
@Slf4j
public class Idea30072Service {
    private static final int IDEA_ID = 30072;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30072Service() {
        this(new Idea30072Config());
    }

    public Idea30072Service(Idea30072Config config) {
        this.config = config != null ? config : new Idea30072Config();
