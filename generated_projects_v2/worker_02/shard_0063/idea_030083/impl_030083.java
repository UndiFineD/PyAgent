...
@Data
public class Idea30083Config {
    private String name = "idea_030083";
 ...
 */
@Slf4j
public class Idea30083Service {
    private static final int IDEA_ID = 30083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30083Service() {
        this(new Idea30083Config());
    }

    public Idea30083Service(Idea30083Config config) {
        this.config = config != null ? config : new Idea30083Config();
