...
@Data
public class Idea30100Config {
    private String name = "idea_030100";
 ...
 */
@Slf4j
public class Idea30100Service {
    private static final int IDEA_ID = 30100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30100Service() {
        this(new Idea30100Config());
    }

    public Idea30100Service(Idea30100Config config) {
        this.config = config != null ? config : new Idea30100Config();
