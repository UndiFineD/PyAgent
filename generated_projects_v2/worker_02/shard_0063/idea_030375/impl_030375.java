...
@Data
public class Idea30375Config {
    private String name = "idea_030375";
 ...
 */
@Slf4j
public class Idea30375Service {
    private static final int IDEA_ID = 30375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30375Service() {
        this(new Idea30375Config());
    }

    public Idea30375Service(Idea30375Config config) {
        this.config = config != null ? config : new Idea30375Config();
