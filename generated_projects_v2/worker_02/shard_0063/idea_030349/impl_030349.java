...
@Data
public class Idea30349Config {
    private String name = "idea_030349";
 ...
 */
@Slf4j
public class Idea30349Service {
    private static final int IDEA_ID = 30349;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30349Service() {
        this(new Idea30349Config());
    }

    public Idea30349Service(Idea30349Config config) {
        this.config = config != null ? config : new Idea30349Config();
