...
@Data
public class Idea30031Config {
    private String name = "idea_030031";
 ...
 */
@Slf4j
public class Idea30031Service {
    private static final int IDEA_ID = 30031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30031Service() {
        this(new Idea30031Config());
    }

    public Idea30031Service(Idea30031Config config) {
        this.config = config != null ? config : new Idea30031Config();
