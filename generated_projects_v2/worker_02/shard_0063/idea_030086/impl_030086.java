...
@Data
public class Idea30086Config {
    private String name = "idea_030086";
 ...
 */
@Slf4j
public class Idea30086Service {
    private static final int IDEA_ID = 30086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30086Service() {
        this(new Idea30086Config());
    }

    public Idea30086Service(Idea30086Config config) {
        this.config = config != null ? config : new Idea30086Config();
