...
@Data
public class Idea30383Config {
    private String name = "idea_030383";
 ...
 */
@Slf4j
public class Idea30383Service {
    private static final int IDEA_ID = 30383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30383Service() {
        this(new Idea30383Config());
    }

    public Idea30383Service(Idea30383Config config) {
        this.config = config != null ? config : new Idea30383Config();
