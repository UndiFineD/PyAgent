...
@Data
public class Idea30258Config {
    private String name = "idea_030258";
 ...
 */
@Slf4j
public class Idea30258Service {
    private static final int IDEA_ID = 30258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30258Service() {
        this(new Idea30258Config());
    }

    public Idea30258Service(Idea30258Config config) {
        this.config = config != null ? config : new Idea30258Config();
