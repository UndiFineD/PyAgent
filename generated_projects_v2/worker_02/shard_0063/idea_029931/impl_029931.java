...
@Data
public class Idea29931Config {
    private String name = "idea_029931";
 ...
 */
@Slf4j
public class Idea29931Service {
    private static final int IDEA_ID = 29931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29931Service() {
        this(new Idea29931Config());
    }

    public Idea29931Service(Idea29931Config config) {
        this.config = config != null ? config : new Idea29931Config();
