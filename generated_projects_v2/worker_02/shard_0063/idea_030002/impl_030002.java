...
@Data
public class Idea30002Config {
    private String name = "idea_030002";
 ...
 */
@Slf4j
public class Idea30002Service {
    private static final int IDEA_ID = 30002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30002Service() {
        this(new Idea30002Config());
    }

    public Idea30002Service(Idea30002Config config) {
        this.config = config != null ? config : new Idea30002Config();
