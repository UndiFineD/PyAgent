...
@Data
public class Idea30022Config {
    private String name = "idea_030022";
 ...
 */
@Slf4j
public class Idea30022Service {
    private static final int IDEA_ID = 30022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30022Service() {
        this(new Idea30022Config());
    }

    public Idea30022Service(Idea30022Config config) {
        this.config = config != null ? config : new Idea30022Config();
