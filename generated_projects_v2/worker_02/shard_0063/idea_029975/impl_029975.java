...
@Data
public class Idea29975Config {
    private String name = "idea_029975";
 ...
 */
@Slf4j
public class Idea29975Service {
    private static final int IDEA_ID = 29975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29975Service() {
        this(new Idea29975Config());
    }

    public Idea29975Service(Idea29975Config config) {
        this.config = config != null ? config : new Idea29975Config();
