...
@Data
public class Idea30191Config {
    private String name = "idea_030191";
 ...
 */
@Slf4j
public class Idea30191Service {
    private static final int IDEA_ID = 30191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30191Service() {
        this(new Idea30191Config());
    }

    public Idea30191Service(Idea30191Config config) {
        this.config = config != null ? config : new Idea30191Config();
