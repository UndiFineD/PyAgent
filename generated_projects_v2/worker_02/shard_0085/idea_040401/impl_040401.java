...
@Data
public class Idea40401Config {
    private String name = "idea_040401";
 ...
 */
@Slf4j
public class Idea40401Service {
    private static final int IDEA_ID = 40401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40401Service() {
        this(new Idea40401Config());
    }

    public Idea40401Service(Idea40401Config config) {
        this.config = config != null ? config : new Idea40401Config();
