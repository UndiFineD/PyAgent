...
@Data
public class Idea40716Config {
    private String name = "idea_040716";
 ...
 */
@Slf4j
public class Idea40716Service {
    private static final int IDEA_ID = 40716;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40716Service() {
        this(new Idea40716Config());
    }

    public Idea40716Service(Idea40716Config config) {
        this.config = config != null ? config : new Idea40716Config();
