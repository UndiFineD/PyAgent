...
@Data
public class Idea40378Config {
    private String name = "idea_040378";
 ...
 */
@Slf4j
public class Idea40378Service {
    private static final int IDEA_ID = 40378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40378Service() {
        this(new Idea40378Config());
    }

    public Idea40378Service(Idea40378Config config) {
        this.config = config != null ? config : new Idea40378Config();
