...
@Data
public class Idea40438Config {
    private String name = "idea_040438";
 ...
 */
@Slf4j
public class Idea40438Service {
    private static final int IDEA_ID = 40438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40438Service() {
        this(new Idea40438Config());
    }

    public Idea40438Service(Idea40438Config config) {
        this.config = config != null ? config : new Idea40438Config();
