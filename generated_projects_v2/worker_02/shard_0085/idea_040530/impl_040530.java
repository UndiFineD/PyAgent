...
@Data
public class Idea40530Config {
    private String name = "idea_040530";
 ...
 */
@Slf4j
public class Idea40530Service {
    private static final int IDEA_ID = 40530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40530Service() {
        this(new Idea40530Config());
    }

    public Idea40530Service(Idea40530Config config) {
        this.config = config != null ? config : new Idea40530Config();
