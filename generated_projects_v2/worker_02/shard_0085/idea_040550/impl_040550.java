...
@Data
public class Idea40550Config {
    private String name = "idea_040550";
 ...
 */
@Slf4j
public class Idea40550Service {
    private static final int IDEA_ID = 40550;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40550Service() {
        this(new Idea40550Config());
    }

    public Idea40550Service(Idea40550Config config) {
        this.config = config != null ? config : new Idea40550Config();
