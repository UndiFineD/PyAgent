...
@Data
public class Idea40581Config {
    private String name = "idea_040581";
 ...
 */
@Slf4j
public class Idea40581Service {
    private static final int IDEA_ID = 40581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40581Service() {
        this(new Idea40581Config());
    }

    public Idea40581Service(Idea40581Config config) {
        this.config = config != null ? config : new Idea40581Config();
