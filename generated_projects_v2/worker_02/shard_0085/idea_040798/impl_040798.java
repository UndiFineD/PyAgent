...
@Data
public class Idea40798Config {
    private String name = "idea_040798";
 ...
 */
@Slf4j
public class Idea40798Service {
    private static final int IDEA_ID = 40798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40798Service() {
        this(new Idea40798Config());
    }

    public Idea40798Service(Idea40798Config config) {
        this.config = config != null ? config : new Idea40798Config();
