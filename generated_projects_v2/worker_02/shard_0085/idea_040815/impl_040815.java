...
@Data
public class Idea40815Config {
    private String name = "idea_040815";
 ...
 */
@Slf4j
public class Idea40815Service {
    private static final int IDEA_ID = 40815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40815Service() {
        this(new Idea40815Config());
    }

    public Idea40815Service(Idea40815Config config) {
        this.config = config != null ? config : new Idea40815Config();
