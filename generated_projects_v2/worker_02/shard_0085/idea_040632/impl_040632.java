...
@Data
public class Idea40632Config {
    private String name = "idea_040632";
 ...
 */
@Slf4j
public class Idea40632Service {
    private static final int IDEA_ID = 40632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40632Service() {
        this(new Idea40632Config());
    }

    public Idea40632Service(Idea40632Config config) {
        this.config = config != null ? config : new Idea40632Config();
