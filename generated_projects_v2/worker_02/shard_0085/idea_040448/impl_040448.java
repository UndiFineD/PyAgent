...
@Data
public class Idea40448Config {
    private String name = "idea_040448";
 ...
 */
@Slf4j
public class Idea40448Service {
    private static final int IDEA_ID = 40448;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40448Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40448Service() {
        this(new Idea40448Config());
    }

    public Idea40448Service(Idea40448Config config) {
        this.config = config != null ? config : new Idea40448Config();
