...
@Data
public class Idea40545Config {
    private String name = "idea_040545";
 ...
 */
@Slf4j
public class Idea40545Service {
    private static final int IDEA_ID = 40545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40545Service() {
        this(new Idea40545Config());
    }

    public Idea40545Service(Idea40545Config config) {
        this.config = config != null ? config : new Idea40545Config();
