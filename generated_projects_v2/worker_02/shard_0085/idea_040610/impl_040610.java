...
@Data
public class Idea40610Config {
    private String name = "idea_040610";
 ...
 */
@Slf4j
public class Idea40610Service {
    private static final int IDEA_ID = 40610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40610Service() {
        this(new Idea40610Config());
    }

    public Idea40610Service(Idea40610Config config) {
        this.config = config != null ? config : new Idea40610Config();
