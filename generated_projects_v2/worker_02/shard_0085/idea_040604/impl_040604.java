...
@Data
public class Idea40604Config {
    private String name = "idea_040604";
 ...
 */
@Slf4j
public class Idea40604Service {
    private static final int IDEA_ID = 40604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40604Service() {
        this(new Idea40604Config());
    }

    public Idea40604Service(Idea40604Config config) {
        this.config = config != null ? config : new Idea40604Config();
