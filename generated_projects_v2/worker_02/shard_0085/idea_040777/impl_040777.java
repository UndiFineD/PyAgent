...
@Data
public class Idea40777Config {
    private String name = "idea_040777";
 ...
 */
@Slf4j
public class Idea40777Service {
    private static final int IDEA_ID = 40777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40777Service() {
        this(new Idea40777Config());
    }

    public Idea40777Service(Idea40777Config config) {
        this.config = config != null ? config : new Idea40777Config();
