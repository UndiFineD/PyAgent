...
@Data
public class Idea40732Config {
    private String name = "idea_040732";
 ...
 */
@Slf4j
public class Idea40732Service {
    private static final int IDEA_ID = 40732;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40732Service() {
        this(new Idea40732Config());
    }

    public Idea40732Service(Idea40732Config config) {
        this.config = config != null ? config : new Idea40732Config();
