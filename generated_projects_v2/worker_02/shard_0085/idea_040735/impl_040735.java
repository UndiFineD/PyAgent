...
@Data
public class Idea40735Config {
    private String name = "idea_040735";
 ...
 */
@Slf4j
public class Idea40735Service {
    private static final int IDEA_ID = 40735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40735Service() {
        this(new Idea40735Config());
    }

    public Idea40735Service(Idea40735Config config) {
        this.config = config != null ? config : new Idea40735Config();
