...
@Data
public class Idea40765Config {
    private String name = "idea_040765";
 ...
 */
@Slf4j
public class Idea40765Service {
    private static final int IDEA_ID = 40765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40765Service() {
        this(new Idea40765Config());
    }

    public Idea40765Service(Idea40765Config config) {
        this.config = config != null ? config : new Idea40765Config();
