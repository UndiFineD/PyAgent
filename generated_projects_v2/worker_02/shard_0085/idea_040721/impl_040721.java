...
@Data
public class Idea40721Config {
    private String name = "idea_040721";
 ...
 */
@Slf4j
public class Idea40721Service {
    private static final int IDEA_ID = 40721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40721Service() {
        this(new Idea40721Config());
    }

    public Idea40721Service(Idea40721Config config) {
        this.config = config != null ? config : new Idea40721Config();
