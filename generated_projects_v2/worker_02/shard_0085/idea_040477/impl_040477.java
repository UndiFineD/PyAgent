...
@Data
public class Idea40477Config {
    private String name = "idea_040477";
 ...
 */
@Slf4j
public class Idea40477Service {
    private static final int IDEA_ID = 40477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40477Service() {
        this(new Idea40477Config());
    }

    public Idea40477Service(Idea40477Config config) {
        this.config = config != null ? config : new Idea40477Config();
