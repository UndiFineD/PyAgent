...
@Data
public class Idea40737Config {
    private String name = "idea_040737";
 ...
 */
@Slf4j
public class Idea40737Service {
    private static final int IDEA_ID = 40737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40737Service() {
        this(new Idea40737Config());
    }

    public Idea40737Service(Idea40737Config config) {
        this.config = config != null ? config : new Idea40737Config();
