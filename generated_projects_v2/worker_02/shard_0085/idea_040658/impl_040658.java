...
@Data
public class Idea40658Config {
    private String name = "idea_040658";
 ...
 */
@Slf4j
public class Idea40658Service {
    private static final int IDEA_ID = 40658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40658Service() {
        this(new Idea40658Config());
    }

    public Idea40658Service(Idea40658Config config) {
        this.config = config != null ? config : new Idea40658Config();
