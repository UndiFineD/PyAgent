...
@Data
public class Idea40585Config {
    private String name = "idea_040585";
 ...
 */
@Slf4j
public class Idea40585Service {
    private static final int IDEA_ID = 40585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40585Service() {
        this(new Idea40585Config());
    }

    public Idea40585Service(Idea40585Config config) {
        this.config = config != null ? config : new Idea40585Config();
