...
@Data
public class Idea40386Config {
    private String name = "idea_040386";
 ...
 */
@Slf4j
public class Idea40386Service {
    private static final int IDEA_ID = 40386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40386Service() {
        this(new Idea40386Config());
    }

    public Idea40386Service(Idea40386Config config) {
        this.config = config != null ? config : new Idea40386Config();
