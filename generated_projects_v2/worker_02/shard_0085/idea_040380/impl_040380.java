...
@Data
public class Idea40380Config {
    private String name = "idea_040380";
 ...
 */
@Slf4j
public class Idea40380Service {
    private static final int IDEA_ID = 40380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40380Service() {
        this(new Idea40380Config());
    }

    public Idea40380Service(Idea40380Config config) {
        this.config = config != null ? config : new Idea40380Config();
