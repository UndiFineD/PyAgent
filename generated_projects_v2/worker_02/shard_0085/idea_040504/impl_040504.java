...
@Data
public class Idea40504Config {
    private String name = "idea_040504";
 ...
 */
@Slf4j
public class Idea40504Service {
    private static final int IDEA_ID = 40504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40504Service() {
        this(new Idea40504Config());
    }

    public Idea40504Service(Idea40504Config config) {
        this.config = config != null ? config : new Idea40504Config();
