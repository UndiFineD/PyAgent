...
@Data
public class Idea40468Config {
    private String name = "idea_040468";
 ...
 */
@Slf4j
public class Idea40468Service {
    private static final int IDEA_ID = 40468;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40468Service() {
        this(new Idea40468Config());
    }

    public Idea40468Service(Idea40468Config config) {
        this.config = config != null ? config : new Idea40468Config();
