...
@Data
public class Idea40623Config {
    private String name = "idea_040623";
 ...
 */
@Slf4j
public class Idea40623Service {
    private static final int IDEA_ID = 40623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40623Service() {
        this(new Idea40623Config());
    }

    public Idea40623Service(Idea40623Config config) {
        this.config = config != null ? config : new Idea40623Config();
