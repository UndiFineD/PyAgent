...
@Data
public class Idea40769Config {
    private String name = "idea_040769";
 ...
 */
@Slf4j
public class Idea40769Service {
    private static final int IDEA_ID = 40769;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40769Service() {
        this(new Idea40769Config());
    }

    public Idea40769Service(Idea40769Config config) {
        this.config = config != null ? config : new Idea40769Config();
