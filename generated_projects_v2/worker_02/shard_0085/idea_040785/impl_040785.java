...
@Data
public class Idea40785Config {
    private String name = "idea_040785";
 ...
 */
@Slf4j
public class Idea40785Service {
    private static final int IDEA_ID = 40785;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40785Service() {
        this(new Idea40785Config());
    }

    public Idea40785Service(Idea40785Config config) {
        this.config = config != null ? config : new Idea40785Config();
