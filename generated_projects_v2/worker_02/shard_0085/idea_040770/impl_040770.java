...
@Data
public class Idea40770Config {
    private String name = "idea_040770";
 ...
 */
@Slf4j
public class Idea40770Service {
    private static final int IDEA_ID = 40770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40770Service() {
        this(new Idea40770Config());
    }

    public Idea40770Service(Idea40770Config config) {
        this.config = config != null ? config : new Idea40770Config();
