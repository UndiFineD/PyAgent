...
@Data
public class Idea40556Config {
    private String name = "idea_040556";
 ...
 */
@Slf4j
public class Idea40556Service {
    private static final int IDEA_ID = 40556;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40556Service() {
        this(new Idea40556Config());
    }

    public Idea40556Service(Idea40556Config config) {
        this.config = config != null ? config : new Idea40556Config();
