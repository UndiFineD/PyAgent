...
@Data
public class Idea40476Config {
    private String name = "idea_040476";
 ...
 */
@Slf4j
public class Idea40476Service {
    private static final int IDEA_ID = 40476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40476Service() {
        this(new Idea40476Config());
    }

    public Idea40476Service(Idea40476Config config) {
        this.config = config != null ? config : new Idea40476Config();
