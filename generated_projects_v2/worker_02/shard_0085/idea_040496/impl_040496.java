...
@Data
public class Idea40496Config {
    private String name = "idea_040496";
 ...
 */
@Slf4j
public class Idea40496Service {
    private static final int IDEA_ID = 40496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40496Service() {
        this(new Idea40496Config());
    }

    public Idea40496Service(Idea40496Config config) {
        this.config = config != null ? config : new Idea40496Config();
