...
@Data
public class Idea40733Config {
    private String name = "idea_040733";
 ...
 */
@Slf4j
public class Idea40733Service {
    private static final int IDEA_ID = 40733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40733Service() {
        this(new Idea40733Config());
    }

    public Idea40733Service(Idea40733Config config) {
        this.config = config != null ? config : new Idea40733Config();
