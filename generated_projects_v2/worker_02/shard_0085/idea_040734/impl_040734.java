...
@Data
public class Idea40734Config {
    private String name = "idea_040734";
 ...
 */
@Slf4j
public class Idea40734Service {
    private static final int IDEA_ID = 40734;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40734Service() {
        this(new Idea40734Config());
    }

    public Idea40734Service(Idea40734Config config) {
        this.config = config != null ? config : new Idea40734Config();
