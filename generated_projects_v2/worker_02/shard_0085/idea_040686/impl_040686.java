...
@Data
public class Idea40686Config {
    private String name = "idea_040686";
 ...
 */
@Slf4j
public class Idea40686Service {
    private static final int IDEA_ID = 40686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40686Service() {
        this(new Idea40686Config());
    }

    public Idea40686Service(Idea40686Config config) {
        this.config = config != null ? config : new Idea40686Config();
