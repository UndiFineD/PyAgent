...
@Data
public class Idea40487Config {
    private String name = "idea_040487";
 ...
 */
@Slf4j
public class Idea40487Service {
    private static final int IDEA_ID = 40487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40487Service() {
        this(new Idea40487Config());
    }

    public Idea40487Service(Idea40487Config config) {
        this.config = config != null ? config : new Idea40487Config();
