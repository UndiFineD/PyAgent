...
@Data
public class Idea40731Config {
    private String name = "idea_040731";
 ...
 */
@Slf4j
public class Idea40731Service {
    private static final int IDEA_ID = 40731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40731Service() {
        this(new Idea40731Config());
    }

    public Idea40731Service(Idea40731Config config) {
        this.config = config != null ? config : new Idea40731Config();
