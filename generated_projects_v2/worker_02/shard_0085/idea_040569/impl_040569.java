...
@Data
public class Idea40569Config {
    private String name = "idea_040569";
 ...
 */
@Slf4j
public class Idea40569Service {
    private static final int IDEA_ID = 40569;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40569Service() {
        this(new Idea40569Config());
    }

    public Idea40569Service(Idea40569Config config) {
        this.config = config != null ? config : new Idea40569Config();
