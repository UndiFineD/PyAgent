...
@Data
public class Idea40638Config {
    private String name = "idea_040638";
 ...
 */
@Slf4j
public class Idea40638Service {
    private static final int IDEA_ID = 40638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40638Service() {
        this(new Idea40638Config());
    }

    public Idea40638Service(Idea40638Config config) {
        this.config = config != null ? config : new Idea40638Config();
