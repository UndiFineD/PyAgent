...
@Data
public class Idea40845Config {
    private String name = "idea_040845";
 ...
 */
@Slf4j
public class Idea40845Service {
    private static final int IDEA_ID = 40845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40845Service() {
        this(new Idea40845Config());
    }

    public Idea40845Service(Idea40845Config config) {
        this.config = config != null ? config : new Idea40845Config();
