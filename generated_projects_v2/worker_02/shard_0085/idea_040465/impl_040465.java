...
@Data
public class Idea40465Config {
    private String name = "idea_040465";
 ...
 */
@Slf4j
public class Idea40465Service {
    private static final int IDEA_ID = 40465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40465Service() {
        this(new Idea40465Config());
    }

    public Idea40465Service(Idea40465Config config) {
        this.config = config != null ? config : new Idea40465Config();
