...
@Data
public class Idea40601Config {
    private String name = "idea_040601";
 ...
 */
@Slf4j
public class Idea40601Service {
    private static final int IDEA_ID = 40601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40601Service() {
        this(new Idea40601Config());
    }

    public Idea40601Service(Idea40601Config config) {
        this.config = config != null ? config : new Idea40601Config();
