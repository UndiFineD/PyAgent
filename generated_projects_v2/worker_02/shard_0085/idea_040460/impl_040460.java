...
@Data
public class Idea40460Config {
    private String name = "idea_040460";
 ...
 */
@Slf4j
public class Idea40460Service {
    private static final int IDEA_ID = 40460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40460Service() {
        this(new Idea40460Config());
    }

    public Idea40460Service(Idea40460Config config) {
        this.config = config != null ? config : new Idea40460Config();
