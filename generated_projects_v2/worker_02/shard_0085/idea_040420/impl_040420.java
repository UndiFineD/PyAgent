...
@Data
public class Idea40420Config {
    private String name = "idea_040420";
 ...
 */
@Slf4j
public class Idea40420Service {
    private static final int IDEA_ID = 40420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40420Service() {
        this(new Idea40420Config());
    }

    public Idea40420Service(Idea40420Config config) {
        this.config = config != null ? config : new Idea40420Config();
