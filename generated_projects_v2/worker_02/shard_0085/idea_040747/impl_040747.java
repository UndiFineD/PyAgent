...
@Data
public class Idea40747Config {
    private String name = "idea_040747";
 ...
 */
@Slf4j
public class Idea40747Service {
    private static final int IDEA_ID = 40747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40747Service() {
        this(new Idea40747Config());
    }

    public Idea40747Service(Idea40747Config config) {
        this.config = config != null ? config : new Idea40747Config();
