...
@Data
public class Idea40823Config {
    private String name = "idea_040823";
 ...
 */
@Slf4j
public class Idea40823Service {
    private static final int IDEA_ID = 40823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40823Service() {
        this(new Idea40823Config());
    }

    public Idea40823Service(Idea40823Config config) {
        this.config = config != null ? config : new Idea40823Config();
