...
@Data
public class Idea40800Config {
    private String name = "idea_040800";
 ...
 */
@Slf4j
public class Idea40800Service {
    private static final int IDEA_ID = 40800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40800Service() {
        this(new Idea40800Config());
    }

    public Idea40800Service(Idea40800Config config) {
        this.config = config != null ? config : new Idea40800Config();
