...
@Data
public class Idea40523Config {
    private String name = "idea_040523";
 ...
 */
@Slf4j
public class Idea40523Service {
    private static final int IDEA_ID = 40523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40523Service() {
        this(new Idea40523Config());
    }

    public Idea40523Service(Idea40523Config config) {
        this.config = config != null ? config : new Idea40523Config();
