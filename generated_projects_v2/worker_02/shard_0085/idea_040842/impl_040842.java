...
@Data
public class Idea40842Config {
    private String name = "idea_040842";
 ...
 */
@Slf4j
public class Idea40842Service {
    private static final int IDEA_ID = 40842;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40842Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40842Service() {
        this(new Idea40842Config());
    }

    public Idea40842Service(Idea40842Config config) {
        this.config = config != null ? config : new Idea40842Config();
