...
@Data
public class Idea40655Config {
    private String name = "idea_040655";
 ...
 */
@Slf4j
public class Idea40655Service {
    private static final int IDEA_ID = 40655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40655Service() {
        this(new Idea40655Config());
    }

    public Idea40655Service(Idea40655Config config) {
        this.config = config != null ? config : new Idea40655Config();
