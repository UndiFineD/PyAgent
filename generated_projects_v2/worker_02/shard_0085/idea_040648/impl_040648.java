...
@Data
public class Idea40648Config {
    private String name = "idea_040648";
 ...
 */
@Slf4j
public class Idea40648Service {
    private static final int IDEA_ID = 40648;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40648Service() {
        this(new Idea40648Config());
    }

    public Idea40648Service(Idea40648Config config) {
        this.config = config != null ? config : new Idea40648Config();
