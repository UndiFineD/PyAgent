...
@Data
public class Idea40461Config {
    private String name = "idea_040461";
 ...
 */
@Slf4j
public class Idea40461Service {
    private static final int IDEA_ID = 40461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40461Service() {
        this(new Idea40461Config());
    }

    public Idea40461Service(Idea40461Config config) {
        this.config = config != null ? config : new Idea40461Config();
