...
@Data
public class Idea40508Config {
    private String name = "idea_040508";
 ...
 */
@Slf4j
public class Idea40508Service {
    private static final int IDEA_ID = 40508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40508Service() {
        this(new Idea40508Config());
    }

    public Idea40508Service(Idea40508Config config) {
        this.config = config != null ? config : new Idea40508Config();
