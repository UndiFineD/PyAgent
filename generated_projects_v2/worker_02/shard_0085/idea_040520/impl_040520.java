...
@Data
public class Idea40520Config {
    private String name = "idea_040520";
 ...
 */
@Slf4j
public class Idea40520Service {
    private static final int IDEA_ID = 40520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40520Service() {
        this(new Idea40520Config());
    }

    public Idea40520Service(Idea40520Config config) {
        this.config = config != null ? config : new Idea40520Config();
