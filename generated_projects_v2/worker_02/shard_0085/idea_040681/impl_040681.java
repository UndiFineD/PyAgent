...
@Data
public class Idea40681Config {
    private String name = "idea_040681";
 ...
 */
@Slf4j
public class Idea40681Service {
    private static final int IDEA_ID = 40681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40681Service() {
        this(new Idea40681Config());
    }

    public Idea40681Service(Idea40681Config config) {
        this.config = config != null ? config : new Idea40681Config();
