...
@Data
public class Idea40719Config {
    private String name = "idea_040719";
 ...
 */
@Slf4j
public class Idea40719Service {
    private static final int IDEA_ID = 40719;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40719Service() {
        this(new Idea40719Config());
    }

    public Idea40719Service(Idea40719Config config) {
        this.config = config != null ? config : new Idea40719Config();
