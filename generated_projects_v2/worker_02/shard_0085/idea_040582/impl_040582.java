...
@Data
public class Idea40582Config {
    private String name = "idea_040582";
 ...
 */
@Slf4j
public class Idea40582Service {
    private static final int IDEA_ID = 40582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40582Service() {
        this(new Idea40582Config());
    }

    public Idea40582Service(Idea40582Config config) {
        this.config = config != null ? config : new Idea40582Config();
