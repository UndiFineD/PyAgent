...
@Data
public class Idea40590Config {
    private String name = "idea_040590";
 ...
 */
@Slf4j
public class Idea40590Service {
    private static final int IDEA_ID = 40590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40590Service() {
        this(new Idea40590Config());
    }

    public Idea40590Service(Idea40590Config config) {
        this.config = config != null ? config : new Idea40590Config();
