...
@Data
public class Idea40432Config {
    private String name = "idea_040432";
 ...
 */
@Slf4j
public class Idea40432Service {
    private static final int IDEA_ID = 40432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40432Service() {
        this(new Idea40432Config());
    }

    public Idea40432Service(Idea40432Config config) {
        this.config = config != null ? config : new Idea40432Config();
