...
@Data
public class Idea40395Config {
    private String name = "idea_040395";
 ...
 */
@Slf4j
public class Idea40395Service {
    private static final int IDEA_ID = 40395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40395Service() {
        this(new Idea40395Config());
    }

    public Idea40395Service(Idea40395Config config) {
        this.config = config != null ? config : new Idea40395Config();
