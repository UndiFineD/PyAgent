...
@Data
public class Idea40567Config {
    private String name = "idea_040567";
 ...
 */
@Slf4j
public class Idea40567Service {
    private static final int IDEA_ID = 40567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40567Service() {
        this(new Idea40567Config());
    }

    public Idea40567Service(Idea40567Config config) {
        this.config = config != null ? config : new Idea40567Config();
