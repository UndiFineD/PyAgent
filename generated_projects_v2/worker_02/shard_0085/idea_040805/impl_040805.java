...
@Data
public class Idea40805Config {
    private String name = "idea_040805";
 ...
 */
@Slf4j
public class Idea40805Service {
    private static final int IDEA_ID = 40805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40805Service() {
        this(new Idea40805Config());
    }

    public Idea40805Service(Idea40805Config config) {
        this.config = config != null ? config : new Idea40805Config();
