...
@Data
public class Idea40698Config {
    private String name = "idea_040698";
 ...
 */
@Slf4j
public class Idea40698Service {
    private static final int IDEA_ID = 40698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40698Service() {
        this(new Idea40698Config());
    }

    public Idea40698Service(Idea40698Config config) {
        this.config = config != null ? config : new Idea40698Config();
