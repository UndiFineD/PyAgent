...
@Data
public class Idea40599Config {
    private String name = "idea_040599";
 ...
 */
@Slf4j
public class Idea40599Service {
    private static final int IDEA_ID = 40599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40599Service() {
        this(new Idea40599Config());
    }

    public Idea40599Service(Idea40599Config config) {
        this.config = config != null ? config : new Idea40599Config();
