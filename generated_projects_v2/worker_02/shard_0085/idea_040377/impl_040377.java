...
@Data
public class Idea40377Config {
    private String name = "idea_040377";
 ...
 */
@Slf4j
public class Idea40377Service {
    private static final int IDEA_ID = 40377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40377Service() {
        this(new Idea40377Config());
    }

    public Idea40377Service(Idea40377Config config) {
        this.config = config != null ? config : new Idea40377Config();
