...
@Data
public class Idea40534Config {
    private String name = "idea_040534";
 ...
 */
@Slf4j
public class Idea40534Service {
    private static final int IDEA_ID = 40534;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40534Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40534Service() {
        this(new Idea40534Config());
    }

    public Idea40534Service(Idea40534Config config) {
        this.config = config != null ? config : new Idea40534Config();
