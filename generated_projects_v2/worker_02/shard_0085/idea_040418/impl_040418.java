...
@Data
public class Idea40418Config {
    private String name = "idea_040418";
 ...
 */
@Slf4j
public class Idea40418Service {
    private static final int IDEA_ID = 40418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40418Service() {
        this(new Idea40418Config());
    }

    public Idea40418Service(Idea40418Config config) {
        this.config = config != null ? config : new Idea40418Config();
