...
@Data
public class Idea40817Config {
    private String name = "idea_040817";
 ...
 */
@Slf4j
public class Idea40817Service {
    private static final int IDEA_ID = 40817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40817Service() {
        this(new Idea40817Config());
    }

    public Idea40817Service(Idea40817Config config) {
        this.config = config != null ? config : new Idea40817Config();
