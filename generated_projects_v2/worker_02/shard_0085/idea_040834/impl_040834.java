...
@Data
public class Idea40834Config {
    private String name = "idea_040834";
 ...
 */
@Slf4j
public class Idea40834Service {
    private static final int IDEA_ID = 40834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40834Service() {
        this(new Idea40834Config());
    }

    public Idea40834Service(Idea40834Config config) {
        this.config = config != null ? config : new Idea40834Config();
