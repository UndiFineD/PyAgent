...
@Data
public class Idea40600Config {
    private String name = "idea_040600";
 ...
 */
@Slf4j
public class Idea40600Service {
    private static final int IDEA_ID = 40600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40600Service() {
        this(new Idea40600Config());
    }

    public Idea40600Service(Idea40600Config config) {
        this.config = config != null ? config : new Idea40600Config();
