...
@Data
public class Idea40469Config {
    private String name = "idea_040469";
 ...
 */
@Slf4j
public class Idea40469Service {
    private static final int IDEA_ID = 40469;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40469Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40469Service() {
        this(new Idea40469Config());
    }

    public Idea40469Service(Idea40469Config config) {
        this.config = config != null ? config : new Idea40469Config();
