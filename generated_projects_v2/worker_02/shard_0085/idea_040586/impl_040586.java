...
@Data
public class Idea40586Config {
    private String name = "idea_040586";
 ...
 */
@Slf4j
public class Idea40586Service {
    private static final int IDEA_ID = 40586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40586Service() {
        this(new Idea40586Config());
    }

    public Idea40586Service(Idea40586Config config) {
        this.config = config != null ? config : new Idea40586Config();
