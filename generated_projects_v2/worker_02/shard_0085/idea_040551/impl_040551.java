...
@Data
public class Idea40551Config {
    private String name = "idea_040551";
 ...
 */
@Slf4j
public class Idea40551Service {
    private static final int IDEA_ID = 40551;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40551Service() {
        this(new Idea40551Config());
    }

    public Idea40551Service(Idea40551Config config) {
        this.config = config != null ? config : new Idea40551Config();
