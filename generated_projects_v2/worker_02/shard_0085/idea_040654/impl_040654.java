...
@Data
public class Idea40654Config {
    private String name = "idea_040654";
 ...
 */
@Slf4j
public class Idea40654Service {
    private static final int IDEA_ID = 40654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40654Service() {
        this(new Idea40654Config());
    }

    public Idea40654Service(Idea40654Config config) {
        this.config = config != null ? config : new Idea40654Config();
