...
@Data
public class Idea40649Config {
    private String name = "idea_040649";
 ...
 */
@Slf4j
public class Idea40649Service {
    private static final int IDEA_ID = 40649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40649Service() {
        this(new Idea40649Config());
    }

    public Idea40649Service(Idea40649Config config) {
        this.config = config != null ? config : new Idea40649Config();
