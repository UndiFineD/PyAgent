...
@Data
public class Idea40773Config {
    private String name = "idea_040773";
 ...
 */
@Slf4j
public class Idea40773Service {
    private static final int IDEA_ID = 40773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40773Service() {
        this(new Idea40773Config());
    }

    public Idea40773Service(Idea40773Config config) {
        this.config = config != null ? config : new Idea40773Config();
