...
@Data
public class Idea40741Config {
    private String name = "idea_040741";
 ...
 */
@Slf4j
public class Idea40741Service {
    private static final int IDEA_ID = 40741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40741Service() {
        this(new Idea40741Config());
    }

    public Idea40741Service(Idea40741Config config) {
        this.config = config != null ? config : new Idea40741Config();
