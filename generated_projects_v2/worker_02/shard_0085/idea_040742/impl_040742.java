...
@Data
public class Idea40742Config {
    private String name = "idea_040742";
 ...
 */
@Slf4j
public class Idea40742Service {
    private static final int IDEA_ID = 40742;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40742Service() {
        this(new Idea40742Config());
    }

    public Idea40742Service(Idea40742Config config) {
        this.config = config != null ? config : new Idea40742Config();
