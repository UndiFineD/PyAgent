...
@Data
public class Idea40406Config {
    private String name = "idea_040406";
 ...
 */
@Slf4j
public class Idea40406Service {
    private static final int IDEA_ID = 40406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40406Service() {
        this(new Idea40406Config());
    }

    public Idea40406Service(Idea40406Config config) {
        this.config = config != null ? config : new Idea40406Config();
