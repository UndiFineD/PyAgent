...
@Data
public class Idea40502Config {
    private String name = "idea_040502";
 ...
 */
@Slf4j
public class Idea40502Service {
    private static final int IDEA_ID = 40502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40502Service() {
        this(new Idea40502Config());
    }

    public Idea40502Service(Idea40502Config config) {
        this.config = config != null ? config : new Idea40502Config();
