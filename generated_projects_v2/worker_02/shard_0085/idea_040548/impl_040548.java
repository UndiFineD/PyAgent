...
@Data
public class Idea40548Config {
    private String name = "idea_040548";
 ...
 */
@Slf4j
public class Idea40548Service {
    private static final int IDEA_ID = 40548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40548Service() {
        this(new Idea40548Config());
    }

    public Idea40548Service(Idea40548Config config) {
        this.config = config != null ? config : new Idea40548Config();
