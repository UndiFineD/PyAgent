...
@Data
public class Idea40806Config {
    private String name = "idea_040806";
 ...
 */
@Slf4j
public class Idea40806Service {
    private static final int IDEA_ID = 40806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40806Service() {
        this(new Idea40806Config());
    }

    public Idea40806Service(Idea40806Config config) {
        this.config = config != null ? config : new Idea40806Config();
