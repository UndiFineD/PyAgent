...
@Data
public class Idea40554Config {
    private String name = "idea_040554";
 ...
 */
@Slf4j
public class Idea40554Service {
    private static final int IDEA_ID = 40554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40554Service() {
        this(new Idea40554Config());
    }

    public Idea40554Service(Idea40554Config config) {
        this.config = config != null ? config : new Idea40554Config();
