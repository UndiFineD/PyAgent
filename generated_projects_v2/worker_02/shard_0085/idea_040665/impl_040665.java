...
@Data
public class Idea40665Config {
    private String name = "idea_040665";
 ...
 */
@Slf4j
public class Idea40665Service {
    private static final int IDEA_ID = 40665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40665Service() {
        this(new Idea40665Config());
    }

    public Idea40665Service(Idea40665Config config) {
        this.config = config != null ? config : new Idea40665Config();
