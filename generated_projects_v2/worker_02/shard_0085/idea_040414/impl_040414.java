...
@Data
public class Idea40414Config {
    private String name = "idea_040414";
 ...
 */
@Slf4j
public class Idea40414Service {
    private static final int IDEA_ID = 40414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40414Service() {
        this(new Idea40414Config());
    }

    public Idea40414Service(Idea40414Config config) {
        this.config = config != null ? config : new Idea40414Config();
