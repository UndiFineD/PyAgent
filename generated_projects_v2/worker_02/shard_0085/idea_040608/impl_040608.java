...
@Data
public class Idea40608Config {
    private String name = "idea_040608";
 ...
 */
@Slf4j
public class Idea40608Service {
    private static final int IDEA_ID = 40608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40608Service() {
        this(new Idea40608Config());
    }

    public Idea40608Service(Idea40608Config config) {
        this.config = config != null ? config : new Idea40608Config();
