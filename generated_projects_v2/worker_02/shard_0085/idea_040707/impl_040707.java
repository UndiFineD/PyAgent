...
@Data
public class Idea40707Config {
    private String name = "idea_040707";
 ...
 */
@Slf4j
public class Idea40707Service {
    private static final int IDEA_ID = 40707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40707Service() {
        this(new Idea40707Config());
    }

    public Idea40707Service(Idea40707Config config) {
        this.config = config != null ? config : new Idea40707Config();
