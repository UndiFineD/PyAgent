...
@Data
public class Idea40793Config {
    private String name = "idea_040793";
 ...
 */
@Slf4j
public class Idea40793Service {
    private static final int IDEA_ID = 40793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40793Service() {
        this(new Idea40793Config());
    }

    public Idea40793Service(Idea40793Config config) {
        this.config = config != null ? config : new Idea40793Config();
