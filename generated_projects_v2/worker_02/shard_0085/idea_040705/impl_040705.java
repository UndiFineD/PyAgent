...
@Data
public class Idea40705Config {
    private String name = "idea_040705";
 ...
 */
@Slf4j
public class Idea40705Service {
    private static final int IDEA_ID = 40705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40705Service() {
        this(new Idea40705Config());
    }

    public Idea40705Service(Idea40705Config config) {
        this.config = config != null ? config : new Idea40705Config();
