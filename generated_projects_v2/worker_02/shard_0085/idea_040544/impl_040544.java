...
@Data
public class Idea40544Config {
    private String name = "idea_040544";
 ...
 */
@Slf4j
public class Idea40544Service {
    private static final int IDEA_ID = 40544;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40544Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40544Service() {
        this(new Idea40544Config());
    }

    public Idea40544Service(Idea40544Config config) {
        this.config = config != null ? config : new Idea40544Config();
