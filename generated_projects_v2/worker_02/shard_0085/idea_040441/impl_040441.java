...
@Data
public class Idea40441Config {
    private String name = "idea_040441";
 ...
 */
@Slf4j
public class Idea40441Service {
    private static final int IDEA_ID = 40441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40441Service() {
        this(new Idea40441Config());
    }

    public Idea40441Service(Idea40441Config config) {
        this.config = config != null ? config : new Idea40441Config();
