...
@Data
public class Idea40549Config {
    private String name = "idea_040549";
 ...
 */
@Slf4j
public class Idea40549Service {
    private static final int IDEA_ID = 40549;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40549Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40549Service() {
        this(new Idea40549Config());
    }

    public Idea40549Service(Idea40549Config config) {
        this.config = config != null ? config : new Idea40549Config();
