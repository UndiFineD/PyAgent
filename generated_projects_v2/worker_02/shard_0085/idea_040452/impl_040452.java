...
@Data
public class Idea40452Config {
    private String name = "idea_040452";
 ...
 */
@Slf4j
public class Idea40452Service {
    private static final int IDEA_ID = 40452;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40452Service() {
        this(new Idea40452Config());
    }

    public Idea40452Service(Idea40452Config config) {
        this.config = config != null ? config : new Idea40452Config();
