...
@Data
public class Idea40429Config {
    private String name = "idea_040429";
 ...
 */
@Slf4j
public class Idea40429Service {
    private static final int IDEA_ID = 40429;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40429Service() {
        this(new Idea40429Config());
    }

    public Idea40429Service(Idea40429Config config) {
        this.config = config != null ? config : new Idea40429Config();
