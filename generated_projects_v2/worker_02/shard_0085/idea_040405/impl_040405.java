...
@Data
public class Idea40405Config {
    private String name = "idea_040405";
 ...
 */
@Slf4j
public class Idea40405Service {
    private static final int IDEA_ID = 40405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40405Service() {
        this(new Idea40405Config());
    }

    public Idea40405Service(Idea40405Config config) {
        this.config = config != null ? config : new Idea40405Config();
