...
@Data
public class Idea40598Config {
    private String name = "idea_040598";
 ...
 */
@Slf4j
public class Idea40598Service {
    private static final int IDEA_ID = 40598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40598Service() {
        this(new Idea40598Config());
    }

    public Idea40598Service(Idea40598Config config) {
        this.config = config != null ? config : new Idea40598Config();
