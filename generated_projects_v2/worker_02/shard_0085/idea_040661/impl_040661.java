...
@Data
public class Idea40661Config {
    private String name = "idea_040661";
 ...
 */
@Slf4j
public class Idea40661Service {
    private static final int IDEA_ID = 40661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40661Service() {
        this(new Idea40661Config());
    }

    public Idea40661Service(Idea40661Config config) {
        this.config = config != null ? config : new Idea40661Config();
