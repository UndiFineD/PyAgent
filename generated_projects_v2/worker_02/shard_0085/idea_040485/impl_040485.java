...
@Data
public class Idea40485Config {
    private String name = "idea_040485";
 ...
 */
@Slf4j
public class Idea40485Service {
    private static final int IDEA_ID = 40485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40485Service() {
        this(new Idea40485Config());
    }

    public Idea40485Service(Idea40485Config config) {
        this.config = config != null ? config : new Idea40485Config();
