...
@Data
public class Idea40410Config {
    private String name = "idea_040410";
 ...
 */
@Slf4j
public class Idea40410Service {
    private static final int IDEA_ID = 40410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40410Service() {
        this(new Idea40410Config());
    }

    public Idea40410Service(Idea40410Config config) {
        this.config = config != null ? config : new Idea40410Config();
