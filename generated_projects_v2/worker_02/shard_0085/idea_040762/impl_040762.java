...
@Data
public class Idea40762Config {
    private String name = "idea_040762";
 ...
 */
@Slf4j
public class Idea40762Service {
    private static final int IDEA_ID = 40762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40762Service() {
        this(new Idea40762Config());
    }

    public Idea40762Service(Idea40762Config config) {
        this.config = config != null ? config : new Idea40762Config();
