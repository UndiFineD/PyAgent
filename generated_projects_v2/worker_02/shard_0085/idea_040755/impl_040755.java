...
@Data
public class Idea40755Config {
    private String name = "idea_040755";
 ...
 */
@Slf4j
public class Idea40755Service {
    private static final int IDEA_ID = 40755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40755Service() {
        this(new Idea40755Config());
    }

    public Idea40755Service(Idea40755Config config) {
        this.config = config != null ? config : new Idea40755Config();
