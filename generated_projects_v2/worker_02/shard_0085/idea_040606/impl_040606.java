...
@Data
public class Idea40606Config {
    private String name = "idea_040606";
 ...
 */
@Slf4j
public class Idea40606Service {
    private static final int IDEA_ID = 40606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40606Service() {
        this(new Idea40606Config());
    }

    public Idea40606Service(Idea40606Config config) {
        this.config = config != null ? config : new Idea40606Config();
