...
@Data
public class Idea40791Config {
    private String name = "idea_040791";
 ...
 */
@Slf4j
public class Idea40791Service {
    private static final int IDEA_ID = 40791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40791Service() {
        this(new Idea40791Config());
    }

    public Idea40791Service(Idea40791Config config) {
        this.config = config != null ? config : new Idea40791Config();
