...
@Data
public class Idea40616Config {
    private String name = "idea_040616";
 ...
 */
@Slf4j
public class Idea40616Service {
    private static final int IDEA_ID = 40616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40616Service() {
        this(new Idea40616Config());
    }

    public Idea40616Service(Idea40616Config config) {
        this.config = config != null ? config : new Idea40616Config();
