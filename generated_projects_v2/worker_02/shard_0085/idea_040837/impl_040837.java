...
@Data
public class Idea40837Config {
    private String name = "idea_040837";
 ...
 */
@Slf4j
public class Idea40837Service {
    private static final int IDEA_ID = 40837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40837Service() {
        this(new Idea40837Config());
    }

    public Idea40837Service(Idea40837Config config) {
        this.config = config != null ? config : new Idea40837Config();
