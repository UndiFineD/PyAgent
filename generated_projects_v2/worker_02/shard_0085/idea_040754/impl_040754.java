...
@Data
public class Idea40754Config {
    private String name = "idea_040754";
 ...
 */
@Slf4j
public class Idea40754Service {
    private static final int IDEA_ID = 40754;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40754Service() {
        this(new Idea40754Config());
    }

    public Idea40754Service(Idea40754Config config) {
        this.config = config != null ? config : new Idea40754Config();
