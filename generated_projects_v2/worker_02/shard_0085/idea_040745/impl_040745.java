...
@Data
public class Idea40745Config {
    private String name = "idea_040745";
 ...
 */
@Slf4j
public class Idea40745Service {
    private static final int IDEA_ID = 40745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40745Service() {
        this(new Idea40745Config());
    }

    public Idea40745Service(Idea40745Config config) {
        this.config = config != null ? config : new Idea40745Config();
