...
@Data
public class Idea40814Config {
    private String name = "idea_040814";
 ...
 */
@Slf4j
public class Idea40814Service {
    private static final int IDEA_ID = 40814;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40814Service() {
        this(new Idea40814Config());
    }

    public Idea40814Service(Idea40814Config config) {
        this.config = config != null ? config : new Idea40814Config();
