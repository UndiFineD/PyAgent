...
@Data
public class Idea40677Config {
    private String name = "idea_040677";
 ...
 */
@Slf4j
public class Idea40677Service {
    private static final int IDEA_ID = 40677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40677Service() {
        this(new Idea40677Config());
    }

    public Idea40677Service(Idea40677Config config) {
        this.config = config != null ? config : new Idea40677Config();
