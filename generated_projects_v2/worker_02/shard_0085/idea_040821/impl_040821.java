...
@Data
public class Idea40821Config {
    private String name = "idea_040821";
 ...
 */
@Slf4j
public class Idea40821Service {
    private static final int IDEA_ID = 40821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40821Service() {
        this(new Idea40821Config());
    }

    public Idea40821Service(Idea40821Config config) {
        this.config = config != null ? config : new Idea40821Config();
