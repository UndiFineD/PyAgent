...
@Data
public class Idea40513Config {
    private String name = "idea_040513";
 ...
 */
@Slf4j
public class Idea40513Service {
    private static final int IDEA_ID = 40513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40513Service() {
        this(new Idea40513Config());
    }

    public Idea40513Service(Idea40513Config config) {
        this.config = config != null ? config : new Idea40513Config();
