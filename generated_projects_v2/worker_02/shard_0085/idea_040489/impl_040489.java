...
@Data
public class Idea40489Config {
    private String name = "idea_040489";
 ...
 */
@Slf4j
public class Idea40489Service {
    private static final int IDEA_ID = 40489;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40489Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40489Service() {
        this(new Idea40489Config());
    }

    public Idea40489Service(Idea40489Config config) {
        this.config = config != null ? config : new Idea40489Config();
