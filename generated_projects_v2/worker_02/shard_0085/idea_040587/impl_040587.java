...
@Data
public class Idea40587Config {
    private String name = "idea_040587";
 ...
 */
@Slf4j
public class Idea40587Service {
    private static final int IDEA_ID = 40587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40587Service() {
        this(new Idea40587Config());
    }

    public Idea40587Service(Idea40587Config config) {
        this.config = config != null ? config : new Idea40587Config();
