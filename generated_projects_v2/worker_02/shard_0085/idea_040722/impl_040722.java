...
@Data
public class Idea40722Config {
    private String name = "idea_040722";
 ...
 */
@Slf4j
public class Idea40722Service {
    private static final int IDEA_ID = 40722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40722Service() {
        this(new Idea40722Config());
    }

    public Idea40722Service(Idea40722Config config) {
        this.config = config != null ? config : new Idea40722Config();
