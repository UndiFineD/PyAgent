...
@Data
public class Idea40388Config {
    private String name = "idea_040388";
 ...
 */
@Slf4j
public class Idea40388Service {
    private static final int IDEA_ID = 40388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40388Service() {
        this(new Idea40388Config());
    }

    public Idea40388Service(Idea40388Config config) {
        this.config = config != null ? config : new Idea40388Config();
