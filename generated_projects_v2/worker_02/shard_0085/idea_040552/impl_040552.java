...
@Data
public class Idea40552Config {
    private String name = "idea_040552";
 ...
 */
@Slf4j
public class Idea40552Service {
    private static final int IDEA_ID = 40552;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40552Service() {
        this(new Idea40552Config());
    }

    public Idea40552Service(Idea40552Config config) {
        this.config = config != null ? config : new Idea40552Config();
