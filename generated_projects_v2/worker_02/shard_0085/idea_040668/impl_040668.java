...
@Data
public class Idea40668Config {
    private String name = "idea_040668";
 ...
 */
@Slf4j
public class Idea40668Service {
    private static final int IDEA_ID = 40668;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40668Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40668Service() {
        this(new Idea40668Config());
    }

    public Idea40668Service(Idea40668Config config) {
        this.config = config != null ? config : new Idea40668Config();
