...
@Data
public class Idea40451Config {
    private String name = "idea_040451";
 ...
 */
@Slf4j
public class Idea40451Service {
    private static final int IDEA_ID = 40451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40451Service() {
        this(new Idea40451Config());
    }

    public Idea40451Service(Idea40451Config config) {
        this.config = config != null ? config : new Idea40451Config();
