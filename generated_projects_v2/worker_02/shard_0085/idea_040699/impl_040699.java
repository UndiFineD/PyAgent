...
@Data
public class Idea40699Config {
    private String name = "idea_040699";
 ...
 */
@Slf4j
public class Idea40699Service {
    private static final int IDEA_ID = 40699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40699Service() {
        this(new Idea40699Config());
    }

    public Idea40699Service(Idea40699Config config) {
        this.config = config != null ? config : new Idea40699Config();
