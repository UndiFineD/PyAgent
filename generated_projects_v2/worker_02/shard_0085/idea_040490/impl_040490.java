...
@Data
public class Idea40490Config {
    private String name = "idea_040490";
 ...
 */
@Slf4j
public class Idea40490Service {
    private static final int IDEA_ID = 40490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40490Service() {
        this(new Idea40490Config());
    }

    public Idea40490Service(Idea40490Config config) {
        this.config = config != null ? config : new Idea40490Config();
