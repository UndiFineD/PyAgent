...
@Data
public class Idea40720Config {
    private String name = "idea_040720";
 ...
 */
@Slf4j
public class Idea40720Service {
    private static final int IDEA_ID = 40720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40720Service() {
        this(new Idea40720Config());
    }

    public Idea40720Service(Idea40720Config config) {
        this.config = config != null ? config : new Idea40720Config();
