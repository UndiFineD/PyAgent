...
@Data
public class Idea40643Config {
    private String name = "idea_040643";
 ...
 */
@Slf4j
public class Idea40643Service {
    private static final int IDEA_ID = 40643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40643Service() {
        this(new Idea40643Config());
    }

    public Idea40643Service(Idea40643Config config) {
        this.config = config != null ? config : new Idea40643Config();
