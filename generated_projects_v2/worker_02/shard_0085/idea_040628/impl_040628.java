...
@Data
public class Idea40628Config {
    private String name = "idea_040628";
 ...
 */
@Slf4j
public class Idea40628Service {
    private static final int IDEA_ID = 40628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40628Service() {
        this(new Idea40628Config());
    }

    public Idea40628Service(Idea40628Config config) {
        this.config = config != null ? config : new Idea40628Config();
