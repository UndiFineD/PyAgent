...
@Data
public class Idea40515Config {
    private String name = "idea_040515";
 ...
 */
@Slf4j
public class Idea40515Service {
    private static final int IDEA_ID = 40515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40515Service() {
        this(new Idea40515Config());
    }

    public Idea40515Service(Idea40515Config config) {
        this.config = config != null ? config : new Idea40515Config();
