...
@Data
public class Idea40839Config {
    private String name = "idea_040839";
 ...
 */
@Slf4j
public class Idea40839Service {
    private static final int IDEA_ID = 40839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40839Service() {
        this(new Idea40839Config());
    }

    public Idea40839Service(Idea40839Config config) {
        this.config = config != null ? config : new Idea40839Config();
