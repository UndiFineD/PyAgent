...
@Data
public class Idea40847Config {
    private String name = "idea_040847";
 ...
 */
@Slf4j
public class Idea40847Service {
    private static final int IDEA_ID = 40847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40847Service() {
        this(new Idea40847Config());
    }

    public Idea40847Service(Idea40847Config config) {
        this.config = config != null ? config : new Idea40847Config();
