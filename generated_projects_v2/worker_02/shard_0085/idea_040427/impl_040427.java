...
@Data
public class Idea40427Config {
    private String name = "idea_040427";
 ...
 */
@Slf4j
public class Idea40427Service {
    private static final int IDEA_ID = 40427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40427Service() {
        this(new Idea40427Config());
    }

    public Idea40427Service(Idea40427Config config) {
        this.config = config != null ? config : new Idea40427Config();
