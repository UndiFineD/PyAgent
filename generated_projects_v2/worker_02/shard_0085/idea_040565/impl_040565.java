...
@Data
public class Idea40565Config {
    private String name = "idea_040565";
 ...
 */
@Slf4j
public class Idea40565Service {
    private static final int IDEA_ID = 40565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40565Service() {
        this(new Idea40565Config());
    }

    public Idea40565Service(Idea40565Config config) {
        this.config = config != null ? config : new Idea40565Config();
