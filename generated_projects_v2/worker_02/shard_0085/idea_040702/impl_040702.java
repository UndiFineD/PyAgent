...
@Data
public class Idea40702Config {
    private String name = "idea_040702";
 ...
 */
@Slf4j
public class Idea40702Service {
    private static final int IDEA_ID = 40702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40702Service() {
        this(new Idea40702Config());
    }

    public Idea40702Service(Idea40702Config config) {
        this.config = config != null ? config : new Idea40702Config();
