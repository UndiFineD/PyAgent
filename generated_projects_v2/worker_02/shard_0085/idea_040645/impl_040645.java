...
@Data
public class Idea40645Config {
    private String name = "idea_040645";
 ...
 */
@Slf4j
public class Idea40645Service {
    private static final int IDEA_ID = 40645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40645Service() {
        this(new Idea40645Config());
    }

    public Idea40645Service(Idea40645Config config) {
        this.config = config != null ? config : new Idea40645Config();
