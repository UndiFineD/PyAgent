...
@Data
public class Idea40763Config {
    private String name = "idea_040763";
 ...
 */
@Slf4j
public class Idea40763Service {
    private static final int IDEA_ID = 40763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40763Service() {
        this(new Idea40763Config());
    }

    public Idea40763Service(Idea40763Config config) {
        this.config = config != null ? config : new Idea40763Config();
