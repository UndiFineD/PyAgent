...
@Data
public class Idea40816Config {
    private String name = "idea_040816";
 ...
 */
@Slf4j
public class Idea40816Service {
    private static final int IDEA_ID = 40816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40816Service() {
        this(new Idea40816Config());
    }

    public Idea40816Service(Idea40816Config config) {
        this.config = config != null ? config : new Idea40816Config();
