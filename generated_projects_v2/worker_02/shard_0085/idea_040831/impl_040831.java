...
@Data
public class Idea40831Config {
    private String name = "idea_040831";
 ...
 */
@Slf4j
public class Idea40831Service {
    private static final int IDEA_ID = 40831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40831Service() {
        this(new Idea40831Config());
    }

    public Idea40831Service(Idea40831Config config) {
        this.config = config != null ? config : new Idea40831Config();
