...
@Data
public class Idea40828Config {
    private String name = "idea_040828";
 ...
 */
@Slf4j
public class Idea40828Service {
    private static final int IDEA_ID = 40828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40828Service() {
        this(new Idea40828Config());
    }

    public Idea40828Service(Idea40828Config config) {
        this.config = config != null ? config : new Idea40828Config();
