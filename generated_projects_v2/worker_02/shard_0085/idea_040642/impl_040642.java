...
@Data
public class Idea40642Config {
    private String name = "idea_040642";
 ...
 */
@Slf4j
public class Idea40642Service {
    private static final int IDEA_ID = 40642;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40642Service() {
        this(new Idea40642Config());
    }

    public Idea40642Service(Idea40642Config config) {
        this.config = config != null ? config : new Idea40642Config();
