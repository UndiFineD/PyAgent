...
@Data
public class Idea40619Config {
    private String name = "idea_040619";
 ...
 */
@Slf4j
public class Idea40619Service {
    private static final int IDEA_ID = 40619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40619Service() {
        this(new Idea40619Config());
    }

    public Idea40619Service(Idea40619Config config) {
        this.config = config != null ? config : new Idea40619Config();
