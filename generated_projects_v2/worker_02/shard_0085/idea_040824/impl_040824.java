...
@Data
public class Idea40824Config {
    private String name = "idea_040824";
 ...
 */
@Slf4j
public class Idea40824Service {
    private static final int IDEA_ID = 40824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40824Service() {
        this(new Idea40824Config());
    }

    public Idea40824Service(Idea40824Config config) {
        this.config = config != null ? config : new Idea40824Config();
