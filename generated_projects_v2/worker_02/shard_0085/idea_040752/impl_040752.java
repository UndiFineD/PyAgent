...
@Data
public class Idea40752Config {
    private String name = "idea_040752";
 ...
 */
@Slf4j
public class Idea40752Service {
    private static final int IDEA_ID = 40752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40752Service() {
        this(new Idea40752Config());
    }

    public Idea40752Service(Idea40752Config config) {
        this.config = config != null ? config : new Idea40752Config();
