...
@Data
public class Idea40775Config {
    private String name = "idea_040775";
 ...
 */
@Slf4j
public class Idea40775Service {
    private static final int IDEA_ID = 40775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40775Service() {
        this(new Idea40775Config());
    }

    public Idea40775Service(Idea40775Config config) {
        this.config = config != null ? config : new Idea40775Config();
