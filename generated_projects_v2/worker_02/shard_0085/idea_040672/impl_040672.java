...
@Data
public class Idea40672Config {
    private String name = "idea_040672";
 ...
 */
@Slf4j
public class Idea40672Service {
    private static final int IDEA_ID = 40672;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40672Service() {
        this(new Idea40672Config());
    }

    public Idea40672Service(Idea40672Config config) {
        this.config = config != null ? config : new Idea40672Config();
