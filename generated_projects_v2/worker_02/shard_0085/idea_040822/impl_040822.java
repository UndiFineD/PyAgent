...
@Data
public class Idea40822Config {
    private String name = "idea_040822";
 ...
 */
@Slf4j
public class Idea40822Service {
    private static final int IDEA_ID = 40822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40822Service() {
        this(new Idea40822Config());
    }

    public Idea40822Service(Idea40822Config config) {
        this.config = config != null ? config : new Idea40822Config();
