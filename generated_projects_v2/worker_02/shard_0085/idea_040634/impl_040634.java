...
@Data
public class Idea40634Config {
    private String name = "idea_040634";
 ...
 */
@Slf4j
public class Idea40634Service {
    private static final int IDEA_ID = 40634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40634Service() {
        this(new Idea40634Config());
    }

    public Idea40634Service(Idea40634Config config) {
        this.config = config != null ? config : new Idea40634Config();
