...
@Data
public class Idea40666Config {
    private String name = "idea_040666";
 ...
 */
@Slf4j
public class Idea40666Service {
    private static final int IDEA_ID = 40666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40666Service() {
        this(new Idea40666Config());
    }

    public Idea40666Service(Idea40666Config config) {
        this.config = config != null ? config : new Idea40666Config();
