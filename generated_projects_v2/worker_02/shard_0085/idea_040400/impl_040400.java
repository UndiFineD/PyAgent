...
@Data
public class Idea40400Config {
    private String name = "idea_040400";
 ...
 */
@Slf4j
public class Idea40400Service {
    private static final int IDEA_ID = 40400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40400Service() {
        this(new Idea40400Config());
    }

    public Idea40400Service(Idea40400Config config) {
        this.config = config != null ? config : new Idea40400Config();
