...
@Data
public class Idea40501Config {
    private String name = "idea_040501";
 ...
 */
@Slf4j
public class Idea40501Service {
    private static final int IDEA_ID = 40501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40501Service() {
        this(new Idea40501Config());
    }

    public Idea40501Service(Idea40501Config config) {
        this.config = config != null ? config : new Idea40501Config();
