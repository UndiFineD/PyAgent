...
@Data
public class Idea40561Config {
    private String name = "idea_040561";
 ...
 */
@Slf4j
public class Idea40561Service {
    private static final int IDEA_ID = 40561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40561Service() {
        this(new Idea40561Config());
    }

    public Idea40561Service(Idea40561Config config) {
        this.config = config != null ? config : new Idea40561Config();
