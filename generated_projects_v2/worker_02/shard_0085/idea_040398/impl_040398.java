...
@Data
public class Idea40398Config {
    private String name = "idea_040398";
 ...
 */
@Slf4j
public class Idea40398Service {
    private static final int IDEA_ID = 40398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40398Service() {
        this(new Idea40398Config());
    }

    public Idea40398Service(Idea40398Config config) {
        this.config = config != null ? config : new Idea40398Config();
