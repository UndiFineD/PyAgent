...
@Data
public class Idea40514Config {
    private String name = "idea_040514";
 ...
 */
@Slf4j
public class Idea40514Service {
    private static final int IDEA_ID = 40514;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40514Service() {
        this(new Idea40514Config());
    }

    public Idea40514Service(Idea40514Config config) {
        this.config = config != null ? config : new Idea40514Config();
