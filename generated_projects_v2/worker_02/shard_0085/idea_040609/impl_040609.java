...
@Data
public class Idea40609Config {
    private String name = "idea_040609";
 ...
 */
@Slf4j
public class Idea40609Service {
    private static final int IDEA_ID = 40609;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40609Service() {
        this(new Idea40609Config());
    }

    public Idea40609Service(Idea40609Config config) {
        this.config = config != null ? config : new Idea40609Config();
