...
@Data
public class Idea40458Config {
    private String name = "idea_040458";
 ...
 */
@Slf4j
public class Idea40458Service {
    private static final int IDEA_ID = 40458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40458Service() {
        this(new Idea40458Config());
    }

    public Idea40458Service(Idea40458Config config) {
        this.config = config != null ? config : new Idea40458Config();
