...
@Data
public class Idea40830Config {
    private String name = "idea_040830";
 ...
 */
@Slf4j
public class Idea40830Service {
    private static final int IDEA_ID = 40830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40830Service() {
        this(new Idea40830Config());
    }

    public Idea40830Service(Idea40830Config config) {
        this.config = config != null ? config : new Idea40830Config();
