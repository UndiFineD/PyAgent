...
@Data
public class Idea40774Config {
    private String name = "idea_040774";
 ...
 */
@Slf4j
public class Idea40774Service {
    private static final int IDEA_ID = 40774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40774Service() {
        this(new Idea40774Config());
    }

    public Idea40774Service(Idea40774Config config) {
        this.config = config != null ? config : new Idea40774Config();
