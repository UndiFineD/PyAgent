...
@Data
public class Idea40781Config {
    private String name = "idea_040781";
 ...
 */
@Slf4j
public class Idea40781Service {
    private static final int IDEA_ID = 40781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40781Service() {
        this(new Idea40781Config());
    }

    public Idea40781Service(Idea40781Config config) {
        this.config = config != null ? config : new Idea40781Config();
