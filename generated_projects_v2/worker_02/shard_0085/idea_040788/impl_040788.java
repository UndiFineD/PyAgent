...
@Data
public class Idea40788Config {
    private String name = "idea_040788";
 ...
 */
@Slf4j
public class Idea40788Service {
    private static final int IDEA_ID = 40788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40788Service() {
        this(new Idea40788Config());
    }

    public Idea40788Service(Idea40788Config config) {
        this.config = config != null ? config : new Idea40788Config();
