...
@Data
public class Idea40576Config {
    private String name = "idea_040576";
 ...
 */
@Slf4j
public class Idea40576Service {
    private static final int IDEA_ID = 40576;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40576Service() {
        this(new Idea40576Config());
    }

    public Idea40576Service(Idea40576Config config) {
        this.config = config != null ? config : new Idea40576Config();
