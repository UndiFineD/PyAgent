...
@Data
public class Idea40547Config {
    private String name = "idea_040547";
 ...
 */
@Slf4j
public class Idea40547Service {
    private static final int IDEA_ID = 40547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40547Service() {
        this(new Idea40547Config());
    }

    public Idea40547Service(Idea40547Config config) {
        this.config = config != null ? config : new Idea40547Config();
