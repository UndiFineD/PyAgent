...
@Data
public class Idea40474Config {
    private String name = "idea_040474";
 ...
 */
@Slf4j
public class Idea40474Service {
    private static final int IDEA_ID = 40474;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40474Service() {
        this(new Idea40474Config());
    }

    public Idea40474Service(Idea40474Config config) {
        this.config = config != null ? config : new Idea40474Config();
