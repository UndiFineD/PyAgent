...
@Data
public class Idea40802Config {
    private String name = "idea_040802";
 ...
 */
@Slf4j
public class Idea40802Service {
    private static final int IDEA_ID = 40802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40802Service() {
        this(new Idea40802Config());
    }

    public Idea40802Service(Idea40802Config config) {
        this.config = config != null ? config : new Idea40802Config();
