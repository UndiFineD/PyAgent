...
@Data
public class Idea40667Config {
    private String name = "idea_040667";
 ...
 */
@Slf4j
public class Idea40667Service {
    private static final int IDEA_ID = 40667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40667Service() {
        this(new Idea40667Config());
    }

    public Idea40667Service(Idea40667Config config) {
        this.config = config != null ? config : new Idea40667Config();
