...
@Data
public class Idea40546Config {
    private String name = "idea_040546";
 ...
 */
@Slf4j
public class Idea40546Service {
    private static final int IDEA_ID = 40546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40546Service() {
        this(new Idea40546Config());
    }

    public Idea40546Service(Idea40546Config config) {
        this.config = config != null ? config : new Idea40546Config();
