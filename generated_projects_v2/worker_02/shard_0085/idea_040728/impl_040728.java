...
@Data
public class Idea40728Config {
    private String name = "idea_040728";
 ...
 */
@Slf4j
public class Idea40728Service {
    private static final int IDEA_ID = 40728;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40728Service() {
        this(new Idea40728Config());
    }

    public Idea40728Service(Idea40728Config config) {
        this.config = config != null ? config : new Idea40728Config();
