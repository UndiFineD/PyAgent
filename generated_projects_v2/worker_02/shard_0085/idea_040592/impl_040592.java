...
@Data
public class Idea40592Config {
    private String name = "idea_040592";
 ...
 */
@Slf4j
public class Idea40592Service {
    private static final int IDEA_ID = 40592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40592Service() {
        this(new Idea40592Config());
    }

    public Idea40592Service(Idea40592Config config) {
        this.config = config != null ? config : new Idea40592Config();
