...
@Data
public class Idea40759Config {
    private String name = "idea_040759";
 ...
 */
@Slf4j
public class Idea40759Service {
    private static final int IDEA_ID = 40759;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40759Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40759Service() {
        this(new Idea40759Config());
    }

    public Idea40759Service(Idea40759Config config) {
        this.config = config != null ? config : new Idea40759Config();
