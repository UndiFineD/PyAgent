...
@Data
public class Idea40624Config {
    private String name = "idea_040624";
 ...
 */
@Slf4j
public class Idea40624Service {
    private static final int IDEA_ID = 40624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40624Service() {
        this(new Idea40624Config());
    }

    public Idea40624Service(Idea40624Config config) {
        this.config = config != null ? config : new Idea40624Config();
