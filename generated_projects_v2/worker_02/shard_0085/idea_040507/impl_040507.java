...
@Data
public class Idea40507Config {
    private String name = "idea_040507";
 ...
 */
@Slf4j
public class Idea40507Service {
    private static final int IDEA_ID = 40507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40507Service() {
        this(new Idea40507Config());
    }

    public Idea40507Service(Idea40507Config config) {
        this.config = config != null ? config : new Idea40507Config();
