...
@Data
public class Idea40717Config {
    private String name = "idea_040717";
 ...
 */
@Slf4j
public class Idea40717Service {
    private static final int IDEA_ID = 40717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40717Service() {
        this(new Idea40717Config());
    }

    public Idea40717Service(Idea40717Config config) {
        this.config = config != null ? config : new Idea40717Config();
