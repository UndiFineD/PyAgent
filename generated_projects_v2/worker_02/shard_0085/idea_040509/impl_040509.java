...
@Data
public class Idea40509Config {
    private String name = "idea_040509";
 ...
 */
@Slf4j
public class Idea40509Service {
    private static final int IDEA_ID = 40509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40509Service() {
        this(new Idea40509Config());
    }

    public Idea40509Service(Idea40509Config config) {
        this.config = config != null ? config : new Idea40509Config();
