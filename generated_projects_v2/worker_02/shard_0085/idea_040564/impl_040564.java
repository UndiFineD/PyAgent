...
@Data
public class Idea40564Config {
    private String name = "idea_040564";
 ...
 */
@Slf4j
public class Idea40564Service {
    private static final int IDEA_ID = 40564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40564Service() {
        this(new Idea40564Config());
    }

    public Idea40564Service(Idea40564Config config) {
        this.config = config != null ? config : new Idea40564Config();
