...
@Data
public class Idea40557Config {
    private String name = "idea_040557";
 ...
 */
@Slf4j
public class Idea40557Service {
    private static final int IDEA_ID = 40557;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40557Service() {
        this(new Idea40557Config());
    }

    public Idea40557Service(Idea40557Config config) {
        this.config = config != null ? config : new Idea40557Config();
