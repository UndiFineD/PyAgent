...
@Data
public class Idea40480Config {
    private String name = "idea_040480";
 ...
 */
@Slf4j
public class Idea40480Service {
    private static final int IDEA_ID = 40480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40480Service() {
        this(new Idea40480Config());
    }

    public Idea40480Service(Idea40480Config config) {
        this.config = config != null ? config : new Idea40480Config();
