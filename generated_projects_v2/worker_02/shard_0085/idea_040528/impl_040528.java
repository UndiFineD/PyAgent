...
@Data
public class Idea40528Config {
    private String name = "idea_040528";
 ...
 */
@Slf4j
public class Idea40528Service {
    private static final int IDEA_ID = 40528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40528Service() {
        this(new Idea40528Config());
    }

    public Idea40528Service(Idea40528Config config) {
        this.config = config != null ? config : new Idea40528Config();
