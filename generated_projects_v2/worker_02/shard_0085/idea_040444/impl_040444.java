...
@Data
public class Idea40444Config {
    private String name = "idea_040444";
 ...
 */
@Slf4j
public class Idea40444Service {
    private static final int IDEA_ID = 40444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40444Service() {
        this(new Idea40444Config());
    }

    public Idea40444Service(Idea40444Config config) {
        this.config = config != null ? config : new Idea40444Config();
