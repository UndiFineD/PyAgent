...
@Data
public class Idea40457Config {
    private String name = "idea_040457";
 ...
 */
@Slf4j
public class Idea40457Service {
    private static final int IDEA_ID = 40457;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40457Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40457Service() {
        this(new Idea40457Config());
    }

    public Idea40457Service(Idea40457Config config) {
        this.config = config != null ? config : new Idea40457Config();
