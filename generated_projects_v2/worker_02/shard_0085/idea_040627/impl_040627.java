...
@Data
public class Idea40627Config {
    private String name = "idea_040627";
 ...
 */
@Slf4j
public class Idea40627Service {
    private static final int IDEA_ID = 40627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40627Service() {
        this(new Idea40627Config());
    }

    public Idea40627Service(Idea40627Config config) {
        this.config = config != null ? config : new Idea40627Config();
