...
@Data
public class Idea40636Config {
    private String name = "idea_040636";
 ...
 */
@Slf4j
public class Idea40636Service {
    private static final int IDEA_ID = 40636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40636Service() {
        this(new Idea40636Config());
    }

    public Idea40636Service(Idea40636Config config) {
        this.config = config != null ? config : new Idea40636Config();
