...
@Data
public class Idea40766Config {
    private String name = "idea_040766";
 ...
 */
@Slf4j
public class Idea40766Service {
    private static final int IDEA_ID = 40766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40766Service() {
        this(new Idea40766Config());
    }

    public Idea40766Service(Idea40766Config config) {
        this.config = config != null ? config : new Idea40766Config();
