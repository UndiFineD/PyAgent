...
@Data
public class Idea40664Config {
    private String name = "idea_040664";
 ...
 */
@Slf4j
public class Idea40664Service {
    private static final int IDEA_ID = 40664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40664Service() {
        this(new Idea40664Config());
    }

    public Idea40664Service(Idea40664Config config) {
        this.config = config != null ? config : new Idea40664Config();
