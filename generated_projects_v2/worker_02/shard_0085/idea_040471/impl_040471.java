...
@Data
public class Idea40471Config {
    private String name = "idea_040471";
 ...
 */
@Slf4j
public class Idea40471Service {
    private static final int IDEA_ID = 40471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40471Service() {
        this(new Idea40471Config());
    }

    public Idea40471Service(Idea40471Config config) {
        this.config = config != null ? config : new Idea40471Config();
