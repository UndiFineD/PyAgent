...
@Data
public class Idea40710Config {
    private String name = "idea_040710";
 ...
 */
@Slf4j
public class Idea40710Service {
    private static final int IDEA_ID = 40710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40710Service() {
        this(new Idea40710Config());
    }

    public Idea40710Service(Idea40710Config config) {
        this.config = config != null ? config : new Idea40710Config();
