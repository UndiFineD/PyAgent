...
@Data
public class Idea40846Config {
    private String name = "idea_040846";
 ...
 */
@Slf4j
public class Idea40846Service {
    private static final int IDEA_ID = 40846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40846Service() {
        this(new Idea40846Config());
    }

    public Idea40846Service(Idea40846Config config) {
        this.config = config != null ? config : new Idea40846Config();
