...
@Data
public class Idea40591Config {
    private String name = "idea_040591";
 ...
 */
@Slf4j
public class Idea40591Service {
    private static final int IDEA_ID = 40591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40591Service() {
        this(new Idea40591Config());
    }

    public Idea40591Service(Idea40591Config config) {
        this.config = config != null ? config : new Idea40591Config();
