...
@Data
public class Idea40639Config {
    private String name = "idea_040639";
 ...
 */
@Slf4j
public class Idea40639Service {
    private static final int IDEA_ID = 40639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40639Service() {
        this(new Idea40639Config());
    }

    public Idea40639Service(Idea40639Config config) {
        this.config = config != null ? config : new Idea40639Config();
