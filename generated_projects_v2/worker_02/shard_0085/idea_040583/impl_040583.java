...
@Data
public class Idea40583Config {
    private String name = "idea_040583";
 ...
 */
@Slf4j
public class Idea40583Service {
    private static final int IDEA_ID = 40583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40583Service() {
        this(new Idea40583Config());
    }

    public Idea40583Service(Idea40583Config config) {
        this.config = config != null ? config : new Idea40583Config();
