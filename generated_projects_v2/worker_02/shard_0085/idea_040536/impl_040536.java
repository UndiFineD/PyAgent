...
@Data
public class Idea40536Config {
    private String name = "idea_040536";
 ...
 */
@Slf4j
public class Idea40536Service {
    private static final int IDEA_ID = 40536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40536Service() {
        this(new Idea40536Config());
    }

    public Idea40536Service(Idea40536Config config) {
        this.config = config != null ? config : new Idea40536Config();
