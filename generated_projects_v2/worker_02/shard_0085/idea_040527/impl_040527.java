...
@Data
public class Idea40527Config {
    private String name = "idea_040527";
 ...
 */
@Slf4j
public class Idea40527Service {
    private static final int IDEA_ID = 40527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40527Service() {
        this(new Idea40527Config());
    }

    public Idea40527Service(Idea40527Config config) {
        this.config = config != null ? config : new Idea40527Config();
