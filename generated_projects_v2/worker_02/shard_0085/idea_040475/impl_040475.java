...
@Data
public class Idea40475Config {
    private String name = "idea_040475";
 ...
 */
@Slf4j
public class Idea40475Service {
    private static final int IDEA_ID = 40475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40475Service() {
        this(new Idea40475Config());
    }

    public Idea40475Service(Idea40475Config config) {
        this.config = config != null ? config : new Idea40475Config();
