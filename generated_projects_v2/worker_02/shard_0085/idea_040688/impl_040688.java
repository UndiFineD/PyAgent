...
@Data
public class Idea40688Config {
    private String name = "idea_040688";
 ...
 */
@Slf4j
public class Idea40688Service {
    private static final int IDEA_ID = 40688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40688Service() {
        this(new Idea40688Config());
    }

    public Idea40688Service(Idea40688Config config) {
        this.config = config != null ? config : new Idea40688Config();
