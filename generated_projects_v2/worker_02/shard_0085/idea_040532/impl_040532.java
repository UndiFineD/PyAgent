...
@Data
public class Idea40532Config {
    private String name = "idea_040532";
 ...
 */
@Slf4j
public class Idea40532Service {
    private static final int IDEA_ID = 40532;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40532Service() {
        this(new Idea40532Config());
    }

    public Idea40532Service(Idea40532Config config) {
        this.config = config != null ? config : new Idea40532Config();
