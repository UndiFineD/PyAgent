...
@Data
public class Idea40483Config {
    private String name = "idea_040483";
 ...
 */
@Slf4j
public class Idea40483Service {
    private static final int IDEA_ID = 40483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40483Service() {
        this(new Idea40483Config());
    }

    public Idea40483Service(Idea40483Config config) {
        this.config = config != null ? config : new Idea40483Config();
