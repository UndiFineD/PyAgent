...
@Data
public class Idea40397Config {
    private String name = "idea_040397";
 ...
 */
@Slf4j
public class Idea40397Service {
    private static final int IDEA_ID = 40397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40397Service() {
        this(new Idea40397Config());
    }

    public Idea40397Service(Idea40397Config config) {
        this.config = config != null ? config : new Idea40397Config();
