...
@Data
public class Idea40784Config {
    private String name = "idea_040784";
 ...
 */
@Slf4j
public class Idea40784Service {
    private static final int IDEA_ID = 40784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40784Service() {
        this(new Idea40784Config());
    }

    public Idea40784Service(Idea40784Config config) {
        this.config = config != null ? config : new Idea40784Config();
