...
@Data
public class Idea40652Config {
    private String name = "idea_040652";
 ...
 */
@Slf4j
public class Idea40652Service {
    private static final int IDEA_ID = 40652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40652Service() {
        this(new Idea40652Config());
    }

    public Idea40652Service(Idea40652Config config) {
        this.config = config != null ? config : new Idea40652Config();
