...
@Data
public class Idea40588Config {
    private String name = "idea_040588";
 ...
 */
@Slf4j
public class Idea40588Service {
    private static final int IDEA_ID = 40588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40588Service() {
        this(new Idea40588Config());
    }

    public Idea40588Service(Idea40588Config config) {
        this.config = config != null ? config : new Idea40588Config();
