...
@Data
public class Idea40818Config {
    private String name = "idea_040818";
 ...
 */
@Slf4j
public class Idea40818Service {
    private static final int IDEA_ID = 40818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40818Service() {
        this(new Idea40818Config());
    }

    public Idea40818Service(Idea40818Config config) {
        this.config = config != null ? config : new Idea40818Config();
