...
@Data
public class Idea40575Config {
    private String name = "idea_040575";
 ...
 */
@Slf4j
public class Idea40575Service {
    private static final int IDEA_ID = 40575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40575Service() {
        this(new Idea40575Config());
    }

    public Idea40575Service(Idea40575Config config) {
        this.config = config != null ? config : new Idea40575Config();
