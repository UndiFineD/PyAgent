...
@Data
public class Idea40811Config {
    private String name = "idea_040811";
 ...
 */
@Slf4j
public class Idea40811Service {
    private static final int IDEA_ID = 40811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40811Service() {
        this(new Idea40811Config());
    }

    public Idea40811Service(Idea40811Config config) {
        this.config = config != null ? config : new Idea40811Config();
