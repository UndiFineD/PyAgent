...
@Data
public class Idea40456Config {
    private String name = "idea_040456";
 ...
 */
@Slf4j
public class Idea40456Service {
    private static final int IDEA_ID = 40456;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40456Service() {
        this(new Idea40456Config());
    }

    public Idea40456Service(Idea40456Config config) {
        this.config = config != null ? config : new Idea40456Config();
