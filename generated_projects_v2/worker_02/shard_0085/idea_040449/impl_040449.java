...
@Data
public class Idea40449Config {
    private String name = "idea_040449";
 ...
 */
@Slf4j
public class Idea40449Service {
    private static final int IDEA_ID = 40449;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40449Service() {
        this(new Idea40449Config());
    }

    public Idea40449Service(Idea40449Config config) {
        this.config = config != null ? config : new Idea40449Config();
