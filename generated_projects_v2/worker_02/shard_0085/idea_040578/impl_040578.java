...
@Data
public class Idea40578Config {
    private String name = "idea_040578";
 ...
 */
@Slf4j
public class Idea40578Service {
    private static final int IDEA_ID = 40578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40578Service() {
        this(new Idea40578Config());
    }

    public Idea40578Service(Idea40578Config config) {
        this.config = config != null ? config : new Idea40578Config();
