...
@Data
public class Idea40435Config {
    private String name = "idea_040435";
 ...
 */
@Slf4j
public class Idea40435Service {
    private static final int IDEA_ID = 40435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40435Service() {
        this(new Idea40435Config());
    }

    public Idea40435Service(Idea40435Config config) {
        this.config = config != null ? config : new Idea40435Config();
