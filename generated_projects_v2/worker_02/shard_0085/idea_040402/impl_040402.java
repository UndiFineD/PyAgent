...
@Data
public class Idea40402Config {
    private String name = "idea_040402";
 ...
 */
@Slf4j
public class Idea40402Service {
    private static final int IDEA_ID = 40402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40402Service() {
        this(new Idea40402Config());
    }

    public Idea40402Service(Idea40402Config config) {
        this.config = config != null ? config : new Idea40402Config();
