...
@Data
public class Idea40653Config {
    private String name = "idea_040653";
 ...
 */
@Slf4j
public class Idea40653Service {
    private static final int IDEA_ID = 40653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40653Service() {
        this(new Idea40653Config());
    }

    public Idea40653Service(Idea40653Config config) {
        this.config = config != null ? config : new Idea40653Config();
