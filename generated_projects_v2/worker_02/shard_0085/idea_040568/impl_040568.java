...
@Data
public class Idea40568Config {
    private String name = "idea_040568";
 ...
 */
@Slf4j
public class Idea40568Service {
    private static final int IDEA_ID = 40568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40568Service() {
        this(new Idea40568Config());
    }

    public Idea40568Service(Idea40568Config config) {
        this.config = config != null ? config : new Idea40568Config();
