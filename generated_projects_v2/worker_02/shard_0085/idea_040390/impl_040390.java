...
@Data
public class Idea40390Config {
    private String name = "idea_040390";
 ...
 */
@Slf4j
public class Idea40390Service {
    private static final int IDEA_ID = 40390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40390Service() {
        this(new Idea40390Config());
    }

    public Idea40390Service(Idea40390Config config) {
        this.config = config != null ? config : new Idea40390Config();
