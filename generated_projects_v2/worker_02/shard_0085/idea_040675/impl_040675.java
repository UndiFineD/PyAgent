...
@Data
public class Idea40675Config {
    private String name = "idea_040675";
 ...
 */
@Slf4j
public class Idea40675Service {
    private static final int IDEA_ID = 40675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40675Service() {
        this(new Idea40675Config());
    }

    public Idea40675Service(Idea40675Config config) {
        this.config = config != null ? config : new Idea40675Config();
