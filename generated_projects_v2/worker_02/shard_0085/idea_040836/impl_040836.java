...
@Data
public class Idea40836Config {
    private String name = "idea_040836";
 ...
 */
@Slf4j
public class Idea40836Service {
    private static final int IDEA_ID = 40836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40836Service() {
        this(new Idea40836Config());
    }

    public Idea40836Service(Idea40836Config config) {
        this.config = config != null ? config : new Idea40836Config();
