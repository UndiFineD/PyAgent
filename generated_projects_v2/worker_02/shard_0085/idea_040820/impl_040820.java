...
@Data
public class Idea40820Config {
    private String name = "idea_040820";
 ...
 */
@Slf4j
public class Idea40820Service {
    private static final int IDEA_ID = 40820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40820Service() {
        this(new Idea40820Config());
    }

    public Idea40820Service(Idea40820Config config) {
        this.config = config != null ? config : new Idea40820Config();
