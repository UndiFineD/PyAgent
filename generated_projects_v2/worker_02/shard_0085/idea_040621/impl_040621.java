...
@Data
public class Idea40621Config {
    private String name = "idea_040621";
 ...
 */
@Slf4j
public class Idea40621Service {
    private static final int IDEA_ID = 40621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40621Service() {
        this(new Idea40621Config());
    }

    public Idea40621Service(Idea40621Config config) {
        this.config = config != null ? config : new Idea40621Config();
