...
@Data
public class Idea40760Config {
    private String name = "idea_040760";
 ...
 */
@Slf4j
public class Idea40760Service {
    private static final int IDEA_ID = 40760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40760Service() {
        this(new Idea40760Config());
    }

    public Idea40760Service(Idea40760Config config) {
        this.config = config != null ? config : new Idea40760Config();
