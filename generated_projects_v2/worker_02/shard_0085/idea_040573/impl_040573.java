...
@Data
public class Idea40573Config {
    private String name = "idea_040573";
 ...
 */
@Slf4j
public class Idea40573Service {
    private static final int IDEA_ID = 40573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40573Service() {
        this(new Idea40573Config());
    }

    public Idea40573Service(Idea40573Config config) {
        this.config = config != null ? config : new Idea40573Config();
