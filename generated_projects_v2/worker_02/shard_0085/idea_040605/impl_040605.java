...
@Data
public class Idea40605Config {
    private String name = "idea_040605";
 ...
 */
@Slf4j
public class Idea40605Service {
    private static final int IDEA_ID = 40605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40605Service() {
        this(new Idea40605Config());
    }

    public Idea40605Service(Idea40605Config config) {
        this.config = config != null ? config : new Idea40605Config();
