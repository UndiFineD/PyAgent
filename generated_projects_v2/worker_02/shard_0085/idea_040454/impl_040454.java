...
@Data
public class Idea40454Config {
    private String name = "idea_040454";
 ...
 */
@Slf4j
public class Idea40454Service {
    private static final int IDEA_ID = 40454;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40454Service() {
        this(new Idea40454Config());
    }

    public Idea40454Service(Idea40454Config config) {
        this.config = config != null ? config : new Idea40454Config();
