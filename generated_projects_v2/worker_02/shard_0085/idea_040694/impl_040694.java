...
@Data
public class Idea40694Config {
    private String name = "idea_040694";
 ...
 */
@Slf4j
public class Idea40694Service {
    private static final int IDEA_ID = 40694;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40694Service() {
        this(new Idea40694Config());
    }

    public Idea40694Service(Idea40694Config config) {
        this.config = config != null ? config : new Idea40694Config();
