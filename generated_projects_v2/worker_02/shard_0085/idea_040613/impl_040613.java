...
@Data
public class Idea40613Config {
    private String name = "idea_040613";
 ...
 */
@Slf4j
public class Idea40613Service {
    private static final int IDEA_ID = 40613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40613Service() {
        this(new Idea40613Config());
    }

    public Idea40613Service(Idea40613Config config) {
        this.config = config != null ? config : new Idea40613Config();
