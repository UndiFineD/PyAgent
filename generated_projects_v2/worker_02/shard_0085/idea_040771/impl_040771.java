...
@Data
public class Idea40771Config {
    private String name = "idea_040771";
 ...
 */
@Slf4j
public class Idea40771Service {
    private static final int IDEA_ID = 40771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40771Service() {
        this(new Idea40771Config());
    }

    public Idea40771Service(Idea40771Config config) {
        this.config = config != null ? config : new Idea40771Config();
