...
@Data
public class Idea40651Config {
    private String name = "idea_040651";
 ...
 */
@Slf4j
public class Idea40651Service {
    private static final int IDEA_ID = 40651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40651Service() {
        this(new Idea40651Config());
    }

    public Idea40651Service(Idea40651Config config) {
        this.config = config != null ? config : new Idea40651Config();
