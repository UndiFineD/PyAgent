...
@Data
public class Idea40529Config {
    private String name = "idea_040529";
 ...
 */
@Slf4j
public class Idea40529Service {
    private static final int IDEA_ID = 40529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40529Service() {
        this(new Idea40529Config());
    }

    public Idea40529Service(Idea40529Config config) {
        this.config = config != null ? config : new Idea40529Config();
