...
@Data
public class Idea40433Config {
    private String name = "idea_040433";
 ...
 */
@Slf4j
public class Idea40433Service {
    private static final int IDEA_ID = 40433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40433Service() {
        this(new Idea40433Config());
    }

    public Idea40433Service(Idea40433Config config) {
        this.config = config != null ? config : new Idea40433Config();
