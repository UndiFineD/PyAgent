...
@Data
public class Idea40684Config {
    private String name = "idea_040684";
 ...
 */
@Slf4j
public class Idea40684Service {
    private static final int IDEA_ID = 40684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40684Service() {
        this(new Idea40684Config());
    }

    public Idea40684Service(Idea40684Config config) {
        this.config = config != null ? config : new Idea40684Config();
