...
@Data
public class Idea40387Config {
    private String name = "idea_040387";
 ...
 */
@Slf4j
public class Idea40387Service {
    private static final int IDEA_ID = 40387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40387Service() {
        this(new Idea40387Config());
    }

    public Idea40387Service(Idea40387Config config) {
        this.config = config != null ? config : new Idea40387Config();
