...
@Data
public class Idea40697Config {
    private String name = "idea_040697";
 ...
 */
@Slf4j
public class Idea40697Service {
    private static final int IDEA_ID = 40697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40697Service() {
        this(new Idea40697Config());
    }

    public Idea40697Service(Idea40697Config config) {
        this.config = config != null ? config : new Idea40697Config();
