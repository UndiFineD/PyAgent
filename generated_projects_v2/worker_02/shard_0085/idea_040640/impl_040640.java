...
@Data
public class Idea40640Config {
    private String name = "idea_040640";
 ...
 */
@Slf4j
public class Idea40640Service {
    private static final int IDEA_ID = 40640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40640Service() {
        this(new Idea40640Config());
    }

    public Idea40640Service(Idea40640Config config) {
        this.config = config != null ? config : new Idea40640Config();
