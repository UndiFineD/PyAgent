...
@Data
public class Idea40470Config {
    private String name = "idea_040470";
 ...
 */
@Slf4j
public class Idea40470Service {
    private static final int IDEA_ID = 40470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40470Service() {
        this(new Idea40470Config());
    }

    public Idea40470Service(Idea40470Config config) {
        this.config = config != null ? config : new Idea40470Config();
