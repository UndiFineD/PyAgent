...
@Data
public class Idea40683Config {
    private String name = "idea_040683";
 ...
 */
@Slf4j
public class Idea40683Service {
    private static final int IDEA_ID = 40683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40683Service() {
        this(new Idea40683Config());
    }

    public Idea40683Service(Idea40683Config config) {
        this.config = config != null ? config : new Idea40683Config();
