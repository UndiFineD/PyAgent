...
@Data
public class Idea40749Config {
    private String name = "idea_040749";
 ...
 */
@Slf4j
public class Idea40749Service {
    private static final int IDEA_ID = 40749;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40749Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40749Service() {
        this(new Idea40749Config());
    }

    public Idea40749Service(Idea40749Config config) {
        this.config = config != null ? config : new Idea40749Config();
