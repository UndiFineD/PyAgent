...
@Data
public class Idea40812Config {
    private String name = "idea_040812";
 ...
 */
@Slf4j
public class Idea40812Service {
    private static final int IDEA_ID = 40812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40812Service() {
        this(new Idea40812Config());
    }

    public Idea40812Service(Idea40812Config config) {
        this.config = config != null ? config : new Idea40812Config();
