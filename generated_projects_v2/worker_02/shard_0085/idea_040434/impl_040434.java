...
@Data
public class Idea40434Config {
    private String name = "idea_040434";
 ...
 */
@Slf4j
public class Idea40434Service {
    private static final int IDEA_ID = 40434;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40434Service() {
        this(new Idea40434Config());
    }

    public Idea40434Service(Idea40434Config config) {
        this.config = config != null ? config : new Idea40434Config();
