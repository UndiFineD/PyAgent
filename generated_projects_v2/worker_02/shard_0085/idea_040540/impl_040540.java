...
@Data
public class Idea40540Config {
    private String name = "idea_040540";
 ...
 */
@Slf4j
public class Idea40540Service {
    private static final int IDEA_ID = 40540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40540Service() {
        this(new Idea40540Config());
    }

    public Idea40540Service(Idea40540Config config) {
        this.config = config != null ? config : new Idea40540Config();
