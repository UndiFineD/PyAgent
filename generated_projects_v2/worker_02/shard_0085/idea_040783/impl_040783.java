...
@Data
public class Idea40783Config {
    private String name = "idea_040783";
 ...
 */
@Slf4j
public class Idea40783Service {
    private static final int IDEA_ID = 40783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40783Service() {
        this(new Idea40783Config());
    }

    public Idea40783Service(Idea40783Config config) {
        this.config = config != null ? config : new Idea40783Config();
