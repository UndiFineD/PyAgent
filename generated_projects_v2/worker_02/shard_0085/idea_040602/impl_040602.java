...
@Data
public class Idea40602Config {
    private String name = "idea_040602";
 ...
 */
@Slf4j
public class Idea40602Service {
    private static final int IDEA_ID = 40602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40602Service() {
        this(new Idea40602Config());
    }

    public Idea40602Service(Idea40602Config config) {
        this.config = config != null ? config : new Idea40602Config();
