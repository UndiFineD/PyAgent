...
@Data
public class Idea40407Config {
    private String name = "idea_040407";
 ...
 */
@Slf4j
public class Idea40407Service {
    private static final int IDEA_ID = 40407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40407Service() {
        this(new Idea40407Config());
    }

    public Idea40407Service(Idea40407Config config) {
        this.config = config != null ? config : new Idea40407Config();
