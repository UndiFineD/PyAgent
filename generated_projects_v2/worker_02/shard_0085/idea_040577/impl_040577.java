...
@Data
public class Idea40577Config {
    private String name = "idea_040577";
 ...
 */
@Slf4j
public class Idea40577Service {
    private static final int IDEA_ID = 40577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40577Service() {
        this(new Idea40577Config());
    }

    public Idea40577Service(Idea40577Config config) {
        this.config = config != null ? config : new Idea40577Config();
