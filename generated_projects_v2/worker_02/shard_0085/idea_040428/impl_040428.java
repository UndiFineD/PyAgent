...
@Data
public class Idea40428Config {
    private String name = "idea_040428";
 ...
 */
@Slf4j
public class Idea40428Service {
    private static final int IDEA_ID = 40428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40428Service() {
        this(new Idea40428Config());
    }

    public Idea40428Service(Idea40428Config config) {
        this.config = config != null ? config : new Idea40428Config();
