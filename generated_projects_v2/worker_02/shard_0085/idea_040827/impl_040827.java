...
@Data
public class Idea40827Config {
    private String name = "idea_040827";
 ...
 */
@Slf4j
public class Idea40827Service {
    private static final int IDEA_ID = 40827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40827Service() {
        this(new Idea40827Config());
    }

    public Idea40827Service(Idea40827Config config) {
        this.config = config != null ? config : new Idea40827Config();
