...
@Data
public class Idea40618Config {
    private String name = "idea_040618";
 ...
 */
@Slf4j
public class Idea40618Service {
    private static final int IDEA_ID = 40618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40618Service() {
        this(new Idea40618Config());
    }

    public Idea40618Service(Idea40618Config config) {
        this.config = config != null ? config : new Idea40618Config();
