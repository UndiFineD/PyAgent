...
@Data
public class Idea31235Config {
    private String name = "idea_031235";
 ...
 */
@Slf4j
public class Idea31235Service {
    private static final int IDEA_ID = 31235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31235Service() {
        this(new Idea31235Config());
    }

    public Idea31235Service(Idea31235Config config) {
        this.config = config != null ? config : new Idea31235Config();
