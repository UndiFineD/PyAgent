...
@Data
public class Idea31217Config {
    private String name = "idea_031217";
 ...
 */
@Slf4j
public class Idea31217Service {
    private static final int IDEA_ID = 31217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31217Service() {
        this(new Idea31217Config());
    }

    public Idea31217Service(Idea31217Config config) {
        this.config = config != null ? config : new Idea31217Config();
