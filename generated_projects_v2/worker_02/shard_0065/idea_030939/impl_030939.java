...
@Data
public class Idea30939Config {
    private String name = "idea_030939";
 ...
 */
@Slf4j
public class Idea30939Service {
    private static final int IDEA_ID = 30939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30939Service() {
        this(new Idea30939Config());
    }

    public Idea30939Service(Idea30939Config config) {
        this.config = config != null ? config : new Idea30939Config();
