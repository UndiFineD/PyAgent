...
@Data
public class Idea31312Config {
    private String name = "idea_031312";
 ...
 */
@Slf4j
public class Idea31312Service {
    private static final int IDEA_ID = 31312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31312Service() {
        this(new Idea31312Config());
    }

    public Idea31312Service(Idea31312Config config) {
        this.config = config != null ? config : new Idea31312Config();
