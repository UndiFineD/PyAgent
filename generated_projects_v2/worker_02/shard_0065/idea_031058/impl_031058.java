...
@Data
public class Idea31058Config {
    private String name = "idea_031058";
 ...
 */
@Slf4j
public class Idea31058Service {
    private static final int IDEA_ID = 31058;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31058Service() {
        this(new Idea31058Config());
    }

    public Idea31058Service(Idea31058Config config) {
        this.config = config != null ? config : new Idea31058Config();
