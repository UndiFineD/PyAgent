...
@Data
public class Idea30969Config {
    private String name = "idea_030969";
 ...
 */
@Slf4j
public class Idea30969Service {
    private static final int IDEA_ID = 30969;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30969Service() {
        this(new Idea30969Config());
    }

    public Idea30969Service(Idea30969Config config) {
        this.config = config != null ? config : new Idea30969Config();
