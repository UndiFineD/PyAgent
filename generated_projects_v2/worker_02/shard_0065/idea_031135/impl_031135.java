...
@Data
public class Idea31135Config {
    private String name = "idea_031135";
 ...
 */
@Slf4j
public class Idea31135Service {
    private static final int IDEA_ID = 31135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31135Service() {
        this(new Idea31135Config());
    }

    public Idea31135Service(Idea31135Config config) {
        this.config = config != null ? config : new Idea31135Config();
