...
@Data
public class Idea31252Config {
    private String name = "idea_031252";
 ...
 */
@Slf4j
public class Idea31252Service {
    private static final int IDEA_ID = 31252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31252Service() {
        this(new Idea31252Config());
    }

    public Idea31252Service(Idea31252Config config) {
        this.config = config != null ? config : new Idea31252Config();
