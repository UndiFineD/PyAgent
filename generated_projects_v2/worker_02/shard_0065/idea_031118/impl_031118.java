...
@Data
public class Idea31118Config {
    private String name = "idea_031118";
 ...
 */
@Slf4j
public class Idea31118Service {
    private static final int IDEA_ID = 31118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31118Service() {
        this(new Idea31118Config());
    }

    public Idea31118Service(Idea31118Config config) {
        this.config = config != null ? config : new Idea31118Config();
