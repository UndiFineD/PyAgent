...
@Data
public class Idea30955Config {
    private String name = "idea_030955";
 ...
 */
@Slf4j
public class Idea30955Service {
    private static final int IDEA_ID = 30955;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30955Service() {
        this(new Idea30955Config());
    }

    public Idea30955Service(Idea30955Config config) {
        this.config = config != null ? config : new Idea30955Config();
