...
@Data
public class Idea30993Config {
    private String name = "idea_030993";
 ...
 */
@Slf4j
public class Idea30993Service {
    private static final int IDEA_ID = 30993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30993Service() {
        this(new Idea30993Config());
    }

    public Idea30993Service(Idea30993Config config) {
        this.config = config != null ? config : new Idea30993Config();
