...
@Data
public class Idea31011Config {
    private String name = "idea_031011";
 ...
 */
@Slf4j
public class Idea31011Service {
    private static final int IDEA_ID = 31011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31011Service() {
        this(new Idea31011Config());
    }

    public Idea31011Service(Idea31011Config config) {
        this.config = config != null ? config : new Idea31011Config();
