...
@Data
public class Idea30998Config {
    private String name = "idea_030998";
 ...
 */
@Slf4j
public class Idea30998Service {
    private static final int IDEA_ID = 30998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30998Service() {
        this(new Idea30998Config());
    }

    public Idea30998Service(Idea30998Config config) {
        this.config = config != null ? config : new Idea30998Config();
