...
@Data
public class Idea31270Config {
    private String name = "idea_031270";
 ...
 */
@Slf4j
public class Idea31270Service {
    private static final int IDEA_ID = 31270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31270Service() {
        this(new Idea31270Config());
    }

    public Idea31270Service(Idea31270Config config) {
        this.config = config != null ? config : new Idea31270Config();
