...
@Data
public class Idea31089Config {
    private String name = "idea_031089";
 ...
 */
@Slf4j
public class Idea31089Service {
    private static final int IDEA_ID = 31089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31089Service() {
        this(new Idea31089Config());
    }

    public Idea31089Service(Idea31089Config config) {
        this.config = config != null ? config : new Idea31089Config();
