...
@Data
public class Idea31128Config {
    private String name = "idea_031128";
 ...
 */
@Slf4j
public class Idea31128Service {
    private static final int IDEA_ID = 31128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31128Service() {
        this(new Idea31128Config());
    }

    public Idea31128Service(Idea31128Config config) {
        this.config = config != null ? config : new Idea31128Config();
