...
@Data
public class Idea31064Config {
    private String name = "idea_031064";
 ...
 */
@Slf4j
public class Idea31064Service {
    private static final int IDEA_ID = 31064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31064Service() {
        this(new Idea31064Config());
    }

    public Idea31064Service(Idea31064Config config) {
        this.config = config != null ? config : new Idea31064Config();
