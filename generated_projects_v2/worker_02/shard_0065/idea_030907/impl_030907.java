...
@Data
public class Idea30907Config {
    private String name = "idea_030907";
 ...
 */
@Slf4j
public class Idea30907Service {
    private static final int IDEA_ID = 30907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30907Service() {
        this(new Idea30907Config());
    }

    public Idea30907Service(Idea30907Config config) {
        this.config = config != null ? config : new Idea30907Config();
