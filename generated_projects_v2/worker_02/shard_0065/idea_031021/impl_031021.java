...
@Data
public class Idea31021Config {
    private String name = "idea_031021";
 ...
 */
@Slf4j
public class Idea31021Service {
    private static final int IDEA_ID = 31021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31021Service() {
        this(new Idea31021Config());
    }

    public Idea31021Service(Idea31021Config config) {
        this.config = config != null ? config : new Idea31021Config();
