...
@Data
public class Idea31337Config {
    private String name = "idea_031337";
 ...
 */
@Slf4j
public class Idea31337Service {
    private static final int IDEA_ID = 31337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31337Service() {
        this(new Idea31337Config());
    }

    public Idea31337Service(Idea31337Config config) {
        this.config = config != null ? config : new Idea31337Config();
