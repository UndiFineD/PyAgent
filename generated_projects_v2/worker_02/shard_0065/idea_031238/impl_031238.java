...
@Data
public class Idea31238Config {
    private String name = "idea_031238";
 ...
 */
@Slf4j
public class Idea31238Service {
    private static final int IDEA_ID = 31238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31238Service() {
        this(new Idea31238Config());
    }

    public Idea31238Service(Idea31238Config config) {
        this.config = config != null ? config : new Idea31238Config();
