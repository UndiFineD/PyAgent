...
@Data
public class Idea30877Config {
    private String name = "idea_030877";
 ...
 */
@Slf4j
public class Idea30877Service {
    private static final int IDEA_ID = 30877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30877Service() {
        this(new Idea30877Config());
    }

    public Idea30877Service(Idea30877Config config) {
        this.config = config != null ? config : new Idea30877Config();
