...
@Data
public class Idea30883Config {
    private String name = "idea_030883";
 ...
 */
@Slf4j
public class Idea30883Service {
    private static final int IDEA_ID = 30883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30883Service() {
        this(new Idea30883Config());
    }

    public Idea30883Service(Idea30883Config config) {
        this.config = config != null ? config : new Idea30883Config();
