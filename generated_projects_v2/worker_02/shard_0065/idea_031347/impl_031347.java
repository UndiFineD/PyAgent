...
@Data
public class Idea31347Config {
    private String name = "idea_031347";
 ...
 */
@Slf4j
public class Idea31347Service {
    private static final int IDEA_ID = 31347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31347Service() {
        this(new Idea31347Config());
    }

    public Idea31347Service(Idea31347Config config) {
        this.config = config != null ? config : new Idea31347Config();
