...
@Data
public class Idea30917Config {
    private String name = "idea_030917";
 ...
 */
@Slf4j
public class Idea30917Service {
    private static final int IDEA_ID = 30917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30917Service() {
        this(new Idea30917Config());
    }

    public Idea30917Service(Idea30917Config config) {
        this.config = config != null ? config : new Idea30917Config();
