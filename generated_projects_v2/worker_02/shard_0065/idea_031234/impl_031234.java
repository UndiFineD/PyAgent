...
@Data
public class Idea31234Config {
    private String name = "idea_031234";
 ...
 */
@Slf4j
public class Idea31234Service {
    private static final int IDEA_ID = 31234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31234Service() {
        this(new Idea31234Config());
    }

    public Idea31234Service(Idea31234Config config) {
        this.config = config != null ? config : new Idea31234Config();
