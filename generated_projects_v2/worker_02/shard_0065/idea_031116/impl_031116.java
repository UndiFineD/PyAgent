...
@Data
public class Idea31116Config {
    private String name = "idea_031116";
 ...
 */
@Slf4j
public class Idea31116Service {
    private static final int IDEA_ID = 31116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31116Service() {
        this(new Idea31116Config());
    }

    public Idea31116Service(Idea31116Config config) {
        this.config = config != null ? config : new Idea31116Config();
