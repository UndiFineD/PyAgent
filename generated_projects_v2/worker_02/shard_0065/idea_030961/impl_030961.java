...
@Data
public class Idea30961Config {
    private String name = "idea_030961";
 ...
 */
@Slf4j
public class Idea30961Service {
    private static final int IDEA_ID = 30961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30961Service() {
        this(new Idea30961Config());
    }

    public Idea30961Service(Idea30961Config config) {
        this.config = config != null ? config : new Idea30961Config();
