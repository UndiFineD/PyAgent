...
@Data
public class Idea31031Config {
    private String name = "idea_031031";
 ...
 */
@Slf4j
public class Idea31031Service {
    private static final int IDEA_ID = 31031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31031Service() {
        this(new Idea31031Config());
    }

    public Idea31031Service(Idea31031Config config) {
        this.config = config != null ? config : new Idea31031Config();
