...
@Data
public class Idea31124Config {
    private String name = "idea_031124";
 ...
 */
@Slf4j
public class Idea31124Service {
    private static final int IDEA_ID = 31124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31124Service() {
        this(new Idea31124Config());
    }

    public Idea31124Service(Idea31124Config config) {
        this.config = config != null ? config : new Idea31124Config();
