...
@Data
public class Idea31293Config {
    private String name = "idea_031293";
 ...
 */
@Slf4j
public class Idea31293Service {
    private static final int IDEA_ID = 31293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31293Service() {
        this(new Idea31293Config());
    }

    public Idea31293Service(Idea31293Config config) {
        this.config = config != null ? config : new Idea31293Config();
