...
@Data
public class Idea31339Config {
    private String name = "idea_031339";
 ...
 */
@Slf4j
public class Idea31339Service {
    private static final int IDEA_ID = 31339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31339Service() {
        this(new Idea31339Config());
    }

    public Idea31339Service(Idea31339Config config) {
        this.config = config != null ? config : new Idea31339Config();
