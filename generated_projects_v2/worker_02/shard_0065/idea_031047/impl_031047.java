...
@Data
public class Idea31047Config {
    private String name = "idea_031047";
 ...
 */
@Slf4j
public class Idea31047Service {
    private static final int IDEA_ID = 31047;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31047Service() {
        this(new Idea31047Config());
    }

    public Idea31047Service(Idea31047Config config) {
        this.config = config != null ? config : new Idea31047Config();
