...
@Data
public class Idea31256Config {
    private String name = "idea_031256";
 ...
 */
@Slf4j
public class Idea31256Service {
    private static final int IDEA_ID = 31256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31256Service() {
        this(new Idea31256Config());
    }

    public Idea31256Service(Idea31256Config config) {
        this.config = config != null ? config : new Idea31256Config();
