...
@Data
public class Idea31123Config {
    private String name = "idea_031123";
 ...
 */
@Slf4j
public class Idea31123Service {
    private static final int IDEA_ID = 31123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31123Service() {
        this(new Idea31123Config());
    }

    public Idea31123Service(Idea31123Config config) {
        this.config = config != null ? config : new Idea31123Config();
