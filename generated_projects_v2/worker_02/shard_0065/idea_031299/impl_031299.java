...
@Data
public class Idea31299Config {
    private String name = "idea_031299";
 ...
 */
@Slf4j
public class Idea31299Service {
    private static final int IDEA_ID = 31299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31299Service() {
        this(new Idea31299Config());
    }

    public Idea31299Service(Idea31299Config config) {
        this.config = config != null ? config : new Idea31299Config();
