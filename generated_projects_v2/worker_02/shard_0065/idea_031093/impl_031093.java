...
@Data
public class Idea31093Config {
    private String name = "idea_031093";
 ...
 */
@Slf4j
public class Idea31093Service {
    private static final int IDEA_ID = 31093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31093Service() {
        this(new Idea31093Config());
    }

    public Idea31093Service(Idea31093Config config) {
        this.config = config != null ? config : new Idea31093Config();
