...
@Data
public class Idea31173Config {
    private String name = "idea_031173";
 ...
 */
@Slf4j
public class Idea31173Service {
    private static final int IDEA_ID = 31173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31173Service() {
        this(new Idea31173Config());
    }

    public Idea31173Service(Idea31173Config config) {
        this.config = config != null ? config : new Idea31173Config();
