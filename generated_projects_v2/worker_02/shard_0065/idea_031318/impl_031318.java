...
@Data
public class Idea31318Config {
    private String name = "idea_031318";
 ...
 */
@Slf4j
public class Idea31318Service {
    private static final int IDEA_ID = 31318;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31318Service() {
        this(new Idea31318Config());
    }

    public Idea31318Service(Idea31318Config config) {
        this.config = config != null ? config : new Idea31318Config();
