...
@Data
public class Idea31183Config {
    private String name = "idea_031183";
 ...
 */
@Slf4j
public class Idea31183Service {
    private static final int IDEA_ID = 31183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31183Service() {
        this(new Idea31183Config());
    }

    public Idea31183Service(Idea31183Config config) {
        this.config = config != null ? config : new Idea31183Config();
