...
@Data
public class Idea30900Config {
    private String name = "idea_030900";
 ...
 */
@Slf4j
public class Idea30900Service {
    private static final int IDEA_ID = 30900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30900Service() {
        this(new Idea30900Config());
    }

    public Idea30900Service(Idea30900Config config) {
        this.config = config != null ? config : new Idea30900Config();
