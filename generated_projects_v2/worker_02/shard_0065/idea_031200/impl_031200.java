...
@Data
public class Idea31200Config {
    private String name = "idea_031200";
 ...
 */
@Slf4j
public class Idea31200Service {
    private static final int IDEA_ID = 31200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31200Service() {
        this(new Idea31200Config());
    }

    public Idea31200Service(Idea31200Config config) {
        this.config = config != null ? config : new Idea31200Config();
