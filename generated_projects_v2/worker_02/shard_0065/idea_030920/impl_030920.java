...
@Data
public class Idea30920Config {
    private String name = "idea_030920";
 ...
 */
@Slf4j
public class Idea30920Service {
    private static final int IDEA_ID = 30920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30920Service() {
        this(new Idea30920Config());
    }

    public Idea30920Service(Idea30920Config config) {
        this.config = config != null ? config : new Idea30920Config();
