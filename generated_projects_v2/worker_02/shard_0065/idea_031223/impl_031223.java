...
@Data
public class Idea31223Config {
    private String name = "idea_031223";
 ...
 */
@Slf4j
public class Idea31223Service {
    private static final int IDEA_ID = 31223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31223Service() {
        this(new Idea31223Config());
    }

    public Idea31223Service(Idea31223Config config) {
        this.config = config != null ? config : new Idea31223Config();
