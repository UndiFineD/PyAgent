...
@Data
public class Idea31012Config {
    private String name = "idea_031012";
 ...
 */
@Slf4j
public class Idea31012Service {
    private static final int IDEA_ID = 31012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31012Service() {
        this(new Idea31012Config());
    }

    public Idea31012Service(Idea31012Config config) {
        this.config = config != null ? config : new Idea31012Config();
