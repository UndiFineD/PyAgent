...
@Data
public class Idea31041Config {
    private String name = "idea_031041";
 ...
 */
@Slf4j
public class Idea31041Service {
    private static final int IDEA_ID = 31041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31041Service() {
        this(new Idea31041Config());
    }

    public Idea31041Service(Idea31041Config config) {
        this.config = config != null ? config : new Idea31041Config();
