...
@Data
public class Idea31324Config {
    private String name = "idea_031324";
 ...
 */
@Slf4j
public class Idea31324Service {
    private static final int IDEA_ID = 31324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31324Service() {
        this(new Idea31324Config());
    }

    public Idea31324Service(Idea31324Config config) {
        this.config = config != null ? config : new Idea31324Config();
