...
@Data
public class Idea31287Config {
    private String name = "idea_031287";
 ...
 */
@Slf4j
public class Idea31287Service {
    private static final int IDEA_ID = 31287;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31287Service() {
        this(new Idea31287Config());
    }

    public Idea31287Service(Idea31287Config config) {
        this.config = config != null ? config : new Idea31287Config();
