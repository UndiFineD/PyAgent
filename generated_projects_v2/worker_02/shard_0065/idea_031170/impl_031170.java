...
@Data
public class Idea31170Config {
    private String name = "idea_031170";
 ...
 */
@Slf4j
public class Idea31170Service {
    private static final int IDEA_ID = 31170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31170Service() {
        this(new Idea31170Config());
    }

    public Idea31170Service(Idea31170Config config) {
        this.config = config != null ? config : new Idea31170Config();
