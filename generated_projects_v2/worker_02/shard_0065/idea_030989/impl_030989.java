...
@Data
public class Idea30989Config {
    private String name = "idea_030989";
 ...
 */
@Slf4j
public class Idea30989Service {
    private static final int IDEA_ID = 30989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30989Service() {
        this(new Idea30989Config());
    }

    public Idea30989Service(Idea30989Config config) {
        this.config = config != null ? config : new Idea30989Config();
