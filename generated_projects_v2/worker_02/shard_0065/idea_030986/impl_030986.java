...
@Data
public class Idea30986Config {
    private String name = "idea_030986";
 ...
 */
@Slf4j
public class Idea30986Service {
    private static final int IDEA_ID = 30986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30986Service() {
        this(new Idea30986Config());
    }

    public Idea30986Service(Idea30986Config config) {
        this.config = config != null ? config : new Idea30986Config();
