...
@Data
public class Idea31125Config {
    private String name = "idea_031125";
 ...
 */
@Slf4j
public class Idea31125Service {
    private static final int IDEA_ID = 31125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31125Service() {
        this(new Idea31125Config());
    }

    public Idea31125Service(Idea31125Config config) {
        this.config = config != null ? config : new Idea31125Config();
