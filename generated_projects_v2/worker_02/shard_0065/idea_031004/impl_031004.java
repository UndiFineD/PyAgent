...
@Data
public class Idea31004Config {
    private String name = "idea_031004";
 ...
 */
@Slf4j
public class Idea31004Service {
    private static final int IDEA_ID = 31004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31004Service() {
        this(new Idea31004Config());
    }

    public Idea31004Service(Idea31004Config config) {
        this.config = config != null ? config : new Idea31004Config();
