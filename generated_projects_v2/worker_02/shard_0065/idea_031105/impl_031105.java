...
@Data
public class Idea31105Config {
    private String name = "idea_031105";
 ...
 */
@Slf4j
public class Idea31105Service {
    private static final int IDEA_ID = 31105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31105Service() {
        this(new Idea31105Config());
    }

    public Idea31105Service(Idea31105Config config) {
        this.config = config != null ? config : new Idea31105Config();
