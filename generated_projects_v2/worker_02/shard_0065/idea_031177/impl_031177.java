...
@Data
public class Idea31177Config {
    private String name = "idea_031177";
 ...
 */
@Slf4j
public class Idea31177Service {
    private static final int IDEA_ID = 31177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31177Service() {
        this(new Idea31177Config());
    }

    public Idea31177Service(Idea31177Config config) {
        this.config = config != null ? config : new Idea31177Config();
