...
@Data
public class Idea31306Config {
    private String name = "idea_031306";
 ...
 */
@Slf4j
public class Idea31306Service {
    private static final int IDEA_ID = 31306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31306Service() {
        this(new Idea31306Config());
    }

    public Idea31306Service(Idea31306Config config) {
        this.config = config != null ? config : new Idea31306Config();
