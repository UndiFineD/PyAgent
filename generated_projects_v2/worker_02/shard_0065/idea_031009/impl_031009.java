...
@Data
public class Idea31009Config {
    private String name = "idea_031009";
 ...
 */
@Slf4j
public class Idea31009Service {
    private static final int IDEA_ID = 31009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31009Service() {
        this(new Idea31009Config());
    }

    public Idea31009Service(Idea31009Config config) {
        this.config = config != null ? config : new Idea31009Config();
