...
@Data
public class Idea30913Config {
    private String name = "idea_030913";
 ...
 */
@Slf4j
public class Idea30913Service {
    private static final int IDEA_ID = 30913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30913Service() {
        this(new Idea30913Config());
    }

    public Idea30913Service(Idea30913Config config) {
        this.config = config != null ? config : new Idea30913Config();
