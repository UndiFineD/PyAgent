...
@Data
public class Idea31010Config {
    private String name = "idea_031010";
 ...
 */
@Slf4j
public class Idea31010Service {
    private static final int IDEA_ID = 31010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31010Service() {
        this(new Idea31010Config());
    }

    public Idea31010Service(Idea31010Config config) {
        this.config = config != null ? config : new Idea31010Config();
