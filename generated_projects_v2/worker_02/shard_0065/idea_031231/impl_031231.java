...
@Data
public class Idea31231Config {
    private String name = "idea_031231";
 ...
 */
@Slf4j
public class Idea31231Service {
    private static final int IDEA_ID = 31231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31231Service() {
        this(new Idea31231Config());
    }

    public Idea31231Service(Idea31231Config config) {
        this.config = config != null ? config : new Idea31231Config();
