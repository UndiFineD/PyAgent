...
@Data
public class Idea31302Config {
    private String name = "idea_031302";
 ...
 */
@Slf4j
public class Idea31302Service {
    private static final int IDEA_ID = 31302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31302Service() {
        this(new Idea31302Config());
    }

    public Idea31302Service(Idea31302Config config) {
        this.config = config != null ? config : new Idea31302Config();
