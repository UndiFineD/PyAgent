...
@Data
public class Idea31195Config {
    private String name = "idea_031195";
 ...
 */
@Slf4j
public class Idea31195Service {
    private static final int IDEA_ID = 31195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31195Service() {
        this(new Idea31195Config());
    }

    public Idea31195Service(Idea31195Config config) {
        this.config = config != null ? config : new Idea31195Config();
