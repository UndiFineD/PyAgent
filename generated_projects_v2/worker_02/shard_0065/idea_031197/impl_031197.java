...
@Data
public class Idea31197Config {
    private String name = "idea_031197";
 ...
 */
@Slf4j
public class Idea31197Service {
    private static final int IDEA_ID = 31197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31197Service() {
        this(new Idea31197Config());
    }

    public Idea31197Service(Idea31197Config config) {
        this.config = config != null ? config : new Idea31197Config();
