...
@Data
public class Idea31112Config {
    private String name = "idea_031112";
 ...
 */
@Slf4j
public class Idea31112Service {
    private static final int IDEA_ID = 31112;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31112Service() {
        this(new Idea31112Config());
    }

    public Idea31112Service(Idea31112Config config) {
        this.config = config != null ? config : new Idea31112Config();
