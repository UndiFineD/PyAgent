...
@Data
public class Idea30911Config {
    private String name = "idea_030911";
 ...
 */
@Slf4j
public class Idea30911Service {
    private static final int IDEA_ID = 30911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30911Service() {
        this(new Idea30911Config());
    }

    public Idea30911Service(Idea30911Config config) {
        this.config = config != null ? config : new Idea30911Config();
