...
@Data
public class Idea31314Config {
    private String name = "idea_031314";
 ...
 */
@Slf4j
public class Idea31314Service {
    private static final int IDEA_ID = 31314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31314Service() {
        this(new Idea31314Config());
    }

    public Idea31314Service(Idea31314Config config) {
        this.config = config != null ? config : new Idea31314Config();
