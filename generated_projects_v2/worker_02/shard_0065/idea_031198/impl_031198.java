...
@Data
public class Idea31198Config {
    private String name = "idea_031198";
 ...
 */
@Slf4j
public class Idea31198Service {
    private static final int IDEA_ID = 31198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31198Service() {
        this(new Idea31198Config());
    }

    public Idea31198Service(Idea31198Config config) {
        this.config = config != null ? config : new Idea31198Config();
