...
@Data
public class Idea30896Config {
    private String name = "idea_030896";
 ...
 */
@Slf4j
public class Idea30896Service {
    private static final int IDEA_ID = 30896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30896Service() {
        this(new Idea30896Config());
    }

    public Idea30896Service(Idea30896Config config) {
        this.config = config != null ? config : new Idea30896Config();
