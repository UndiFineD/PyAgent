...
@Data
public class Idea31227Config {
    private String name = "idea_031227";
 ...
 */
@Slf4j
public class Idea31227Service {
    private static final int IDEA_ID = 31227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31227Service() {
        this(new Idea31227Config());
    }

    public Idea31227Service(Idea31227Config config) {
        this.config = config != null ? config : new Idea31227Config();
