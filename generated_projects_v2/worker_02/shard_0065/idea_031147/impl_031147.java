...
@Data
public class Idea31147Config {
    private String name = "idea_031147";
 ...
 */
@Slf4j
public class Idea31147Service {
    private static final int IDEA_ID = 31147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31147Service() {
        this(new Idea31147Config());
    }

    public Idea31147Service(Idea31147Config config) {
        this.config = config != null ? config : new Idea31147Config();
