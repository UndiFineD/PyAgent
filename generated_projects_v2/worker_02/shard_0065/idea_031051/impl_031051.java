...
@Data
public class Idea31051Config {
    private String name = "idea_031051";
 ...
 */
@Slf4j
public class Idea31051Service {
    private static final int IDEA_ID = 31051;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31051Service() {
        this(new Idea31051Config());
    }

    public Idea31051Service(Idea31051Config config) {
        this.config = config != null ? config : new Idea31051Config();
