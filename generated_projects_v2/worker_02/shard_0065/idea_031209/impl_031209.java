...
@Data
public class Idea31209Config {
    private String name = "idea_031209";
 ...
 */
@Slf4j
public class Idea31209Service {
    private static final int IDEA_ID = 31209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31209Service() {
        this(new Idea31209Config());
    }

    public Idea31209Service(Idea31209Config config) {
        this.config = config != null ? config : new Idea31209Config();
