...
@Data
public class Idea31320Config {
    private String name = "idea_031320";
 ...
 */
@Slf4j
public class Idea31320Service {
    private static final int IDEA_ID = 31320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31320Service() {
        this(new Idea31320Config());
    }

    public Idea31320Service(Idea31320Config config) {
        this.config = config != null ? config : new Idea31320Config();
