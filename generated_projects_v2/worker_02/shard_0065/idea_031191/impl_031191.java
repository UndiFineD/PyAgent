...
@Data
public class Idea31191Config {
    private String name = "idea_031191";
 ...
 */
@Slf4j
public class Idea31191Service {
    private static final int IDEA_ID = 31191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31191Service() {
        this(new Idea31191Config());
    }

    public Idea31191Service(Idea31191Config config) {
        this.config = config != null ? config : new Idea31191Config();
