...
@Data
public class Idea31082Config {
    private String name = "idea_031082";
 ...
 */
@Slf4j
public class Idea31082Service {
    private static final int IDEA_ID = 31082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31082Service() {
        this(new Idea31082Config());
    }

    public Idea31082Service(Idea31082Config config) {
        this.config = config != null ? config : new Idea31082Config();
