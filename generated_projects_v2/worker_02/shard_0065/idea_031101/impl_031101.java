...
@Data
public class Idea31101Config {
    private String name = "idea_031101";
 ...
 */
@Slf4j
public class Idea31101Service {
    private static final int IDEA_ID = 31101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31101Service() {
        this(new Idea31101Config());
    }

    public Idea31101Service(Idea31101Config config) {
        this.config = config != null ? config : new Idea31101Config();
