...
@Data
public class Idea31073Config {
    private String name = "idea_031073";
 ...
 */
@Slf4j
public class Idea31073Service {
    private static final int IDEA_ID = 31073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31073Service() {
        this(new Idea31073Config());
    }

    public Idea31073Service(Idea31073Config config) {
        this.config = config != null ? config : new Idea31073Config();
