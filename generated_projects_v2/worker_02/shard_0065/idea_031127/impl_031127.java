...
@Data
public class Idea31127Config {
    private String name = "idea_031127";
 ...
 */
@Slf4j
public class Idea31127Service {
    private static final int IDEA_ID = 31127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31127Service() {
        this(new Idea31127Config());
    }

    public Idea31127Service(Idea31127Config config) {
        this.config = config != null ? config : new Idea31127Config();
