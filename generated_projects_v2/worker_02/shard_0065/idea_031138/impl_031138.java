...
@Data
public class Idea31138Config {
    private String name = "idea_031138";
 ...
 */
@Slf4j
public class Idea31138Service {
    private static final int IDEA_ID = 31138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31138Service() {
        this(new Idea31138Config());
    }

    public Idea31138Service(Idea31138Config config) {
        this.config = config != null ? config : new Idea31138Config();
