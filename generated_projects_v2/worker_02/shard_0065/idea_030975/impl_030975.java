...
@Data
public class Idea30975Config {
    private String name = "idea_030975";
 ...
 */
@Slf4j
public class Idea30975Service {
    private static final int IDEA_ID = 30975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30975Service() {
        this(new Idea30975Config());
    }

    public Idea30975Service(Idea30975Config config) {
        this.config = config != null ? config : new Idea30975Config();
