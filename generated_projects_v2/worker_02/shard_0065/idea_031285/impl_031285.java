...
@Data
public class Idea31285Config {
    private String name = "idea_031285";
 ...
 */
@Slf4j
public class Idea31285Service {
    private static final int IDEA_ID = 31285;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31285Service() {
        this(new Idea31285Config());
    }

    public Idea31285Service(Idea31285Config config) {
        this.config = config != null ? config : new Idea31285Config();
