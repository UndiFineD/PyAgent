...
@Data
public class Idea31091Config {
    private String name = "idea_031091";
 ...
 */
@Slf4j
public class Idea31091Service {
    private static final int IDEA_ID = 31091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31091Service() {
        this(new Idea31091Config());
    }

    public Idea31091Service(Idea31091Config config) {
        this.config = config != null ? config : new Idea31091Config();
