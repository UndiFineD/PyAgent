...
@Data
public class Idea31107Config {
    private String name = "idea_031107";
 ...
 */
@Slf4j
public class Idea31107Service {
    private static final int IDEA_ID = 31107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31107Service() {
        this(new Idea31107Config());
    }

    public Idea31107Service(Idea31107Config config) {
        this.config = config != null ? config : new Idea31107Config();
