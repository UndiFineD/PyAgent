...
@Data
public class Idea31017Config {
    private String name = "idea_031017";
 ...
 */
@Slf4j
public class Idea31017Service {
    private static final int IDEA_ID = 31017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31017Service() {
        this(new Idea31017Config());
    }

    public Idea31017Service(Idea31017Config config) {
        this.config = config != null ? config : new Idea31017Config();
