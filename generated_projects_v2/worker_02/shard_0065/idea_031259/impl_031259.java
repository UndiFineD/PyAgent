...
@Data
public class Idea31259Config {
    private String name = "idea_031259";
 ...
 */
@Slf4j
public class Idea31259Service {
    private static final int IDEA_ID = 31259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31259Service() {
        this(new Idea31259Config());
    }

    public Idea31259Service(Idea31259Config config) {
        this.config = config != null ? config : new Idea31259Config();
