...
@Data
public class Idea31141Config {
    private String name = "idea_031141";
 ...
 */
@Slf4j
public class Idea31141Service {
    private static final int IDEA_ID = 31141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31141Service() {
        this(new Idea31141Config());
    }

    public Idea31141Service(Idea31141Config config) {
        this.config = config != null ? config : new Idea31141Config();
