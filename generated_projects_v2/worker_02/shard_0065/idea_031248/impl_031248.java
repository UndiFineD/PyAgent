...
@Data
public class Idea31248Config {
    private String name = "idea_031248";
 ...
 */
@Slf4j
public class Idea31248Service {
    private static final int IDEA_ID = 31248;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31248Service() {
        this(new Idea31248Config());
    }

    public Idea31248Service(Idea31248Config config) {
        this.config = config != null ? config : new Idea31248Config();
