...
@Data
public class Idea30923Config {
    private String name = "idea_030923";
 ...
 */
@Slf4j
public class Idea30923Service {
    private static final int IDEA_ID = 30923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30923Service() {
        this(new Idea30923Config());
    }

    public Idea30923Service(Idea30923Config config) {
        this.config = config != null ? config : new Idea30923Config();
