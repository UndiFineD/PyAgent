...
@Data
public class Idea31171Config {
    private String name = "idea_031171";
 ...
 */
@Slf4j
public class Idea31171Service {
    private static final int IDEA_ID = 31171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31171Service() {
        this(new Idea31171Config());
    }

    public Idea31171Service(Idea31171Config config) {
        this.config = config != null ? config : new Idea31171Config();
