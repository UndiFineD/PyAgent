...
@Data
public class Idea31126Config {
    private String name = "idea_031126";
 ...
 */
@Slf4j
public class Idea31126Service {
    private static final int IDEA_ID = 31126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31126Service() {
        this(new Idea31126Config());
    }

    public Idea31126Service(Idea31126Config config) {
        this.config = config != null ? config : new Idea31126Config();
