...
@Data
public class Idea30964Config {
    private String name = "idea_030964";
 ...
 */
@Slf4j
public class Idea30964Service {
    private static final int IDEA_ID = 30964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30964Service() {
        this(new Idea30964Config());
    }

    public Idea30964Service(Idea30964Config config) {
        this.config = config != null ? config : new Idea30964Config();
