...
@Data
public class Idea30938Config {
    private String name = "idea_030938";
 ...
 */
@Slf4j
public class Idea30938Service {
    private static final int IDEA_ID = 30938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30938Service() {
        this(new Idea30938Config());
    }

    public Idea30938Service(Idea30938Config config) {
        this.config = config != null ? config : new Idea30938Config();
