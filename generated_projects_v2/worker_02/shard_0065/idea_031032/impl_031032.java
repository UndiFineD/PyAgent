...
@Data
public class Idea31032Config {
    private String name = "idea_031032";
 ...
 */
@Slf4j
public class Idea31032Service {
    private static final int IDEA_ID = 31032;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31032Service() {
        this(new Idea31032Config());
    }

    public Idea31032Service(Idea31032Config config) {
        this.config = config != null ? config : new Idea31032Config();
