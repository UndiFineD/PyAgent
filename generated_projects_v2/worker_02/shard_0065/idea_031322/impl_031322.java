...
@Data
public class Idea31322Config {
    private String name = "idea_031322";
 ...
 */
@Slf4j
public class Idea31322Service {
    private static final int IDEA_ID = 31322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31322Service() {
        this(new Idea31322Config());
    }

    public Idea31322Service(Idea31322Config config) {
        this.config = config != null ? config : new Idea31322Config();
