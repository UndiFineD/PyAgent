...
@Data
public class Idea31280Config {
    private String name = "idea_031280";
 ...
 */
@Slf4j
public class Idea31280Service {
    private static final int IDEA_ID = 31280;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31280Service() {
        this(new Idea31280Config());
    }

    public Idea31280Service(Idea31280Config config) {
        this.config = config != null ? config : new Idea31280Config();
