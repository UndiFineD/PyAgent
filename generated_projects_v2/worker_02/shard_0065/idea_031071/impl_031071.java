...
@Data
public class Idea31071Config {
    private String name = "idea_031071";
 ...
 */
@Slf4j
public class Idea31071Service {
    private static final int IDEA_ID = 31071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31071Service() {
        this(new Idea31071Config());
    }

    public Idea31071Service(Idea31071Config config) {
        this.config = config != null ? config : new Idea31071Config();
