...
@Data
public class Idea31229Config {
    private String name = "idea_031229";
 ...
 */
@Slf4j
public class Idea31229Service {
    private static final int IDEA_ID = 31229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31229Service() {
        this(new Idea31229Config());
    }

    public Idea31229Service(Idea31229Config config) {
        this.config = config != null ? config : new Idea31229Config();
