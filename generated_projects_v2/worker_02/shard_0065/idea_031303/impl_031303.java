...
@Data
public class Idea31303Config {
    private String name = "idea_031303";
 ...
 */
@Slf4j
public class Idea31303Service {
    private static final int IDEA_ID = 31303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31303Service() {
        this(new Idea31303Config());
    }

    public Idea31303Service(Idea31303Config config) {
        this.config = config != null ? config : new Idea31303Config();
