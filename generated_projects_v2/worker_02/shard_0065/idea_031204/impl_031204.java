...
@Data
public class Idea31204Config {
    private String name = "idea_031204";
 ...
 */
@Slf4j
public class Idea31204Service {
    private static final int IDEA_ID = 31204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31204Service() {
        this(new Idea31204Config());
    }

    public Idea31204Service(Idea31204Config config) {
        this.config = config != null ? config : new Idea31204Config();
