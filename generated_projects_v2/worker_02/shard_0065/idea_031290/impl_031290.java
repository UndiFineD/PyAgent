...
@Data
public class Idea31290Config {
    private String name = "idea_031290";
 ...
 */
@Slf4j
public class Idea31290Service {
    private static final int IDEA_ID = 31290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31290Service() {
        this(new Idea31290Config());
    }

    public Idea31290Service(Idea31290Config config) {
        this.config = config != null ? config : new Idea31290Config();
