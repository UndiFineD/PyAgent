...
@Data
public class Idea30988Config {
    private String name = "idea_030988";
 ...
 */
@Slf4j
public class Idea30988Service {
    private static final int IDEA_ID = 30988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30988Service() {
        this(new Idea30988Config());
    }

    public Idea30988Service(Idea30988Config config) {
        this.config = config != null ? config : new Idea30988Config();
