...
@Data
public class Idea31121Config {
    private String name = "idea_031121";
 ...
 */
@Slf4j
public class Idea31121Service {
    private static final int IDEA_ID = 31121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31121Service() {
        this(new Idea31121Config());
    }

    public Idea31121Service(Idea31121Config config) {
        this.config = config != null ? config : new Idea31121Config();
