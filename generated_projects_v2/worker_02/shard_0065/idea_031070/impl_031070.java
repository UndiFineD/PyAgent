...
@Data
public class Idea31070Config {
    private String name = "idea_031070";
 ...
 */
@Slf4j
public class Idea31070Service {
    private static final int IDEA_ID = 31070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31070Service() {
        this(new Idea31070Config());
    }

    public Idea31070Service(Idea31070Config config) {
        this.config = config != null ? config : new Idea31070Config();
