...
@Data
public class Idea31211Config {
    private String name = "idea_031211";
 ...
 */
@Slf4j
public class Idea31211Service {
    private static final int IDEA_ID = 31211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31211Service() {
        this(new Idea31211Config());
    }

    public Idea31211Service(Idea31211Config config) {
        this.config = config != null ? config : new Idea31211Config();
