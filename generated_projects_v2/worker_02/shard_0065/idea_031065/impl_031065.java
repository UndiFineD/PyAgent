...
@Data
public class Idea31065Config {
    private String name = "idea_031065";
 ...
 */
@Slf4j
public class Idea31065Service {
    private static final int IDEA_ID = 31065;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31065Service() {
        this(new Idea31065Config());
    }

    public Idea31065Service(Idea31065Config config) {
        this.config = config != null ? config : new Idea31065Config();
