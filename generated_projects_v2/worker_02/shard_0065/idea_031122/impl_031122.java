...
@Data
public class Idea31122Config {
    private String name = "idea_031122";
 ...
 */
@Slf4j
public class Idea31122Service {
    private static final int IDEA_ID = 31122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31122Service() {
        this(new Idea31122Config());
    }

    public Idea31122Service(Idea31122Config config) {
        this.config = config != null ? config : new Idea31122Config();
