...
@Data
public class Idea30929Config {
    private String name = "idea_030929";
 ...
 */
@Slf4j
public class Idea30929Service {
    private static final int IDEA_ID = 30929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30929Service() {
        this(new Idea30929Config());
    }

    public Idea30929Service(Idea30929Config config) {
        this.config = config != null ? config : new Idea30929Config();
