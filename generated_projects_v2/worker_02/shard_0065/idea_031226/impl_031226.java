...
@Data
public class Idea31226Config {
    private String name = "idea_031226";
 ...
 */
@Slf4j
public class Idea31226Service {
    private static final int IDEA_ID = 31226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31226Service() {
        this(new Idea31226Config());
    }

    public Idea31226Service(Idea31226Config config) {
        this.config = config != null ? config : new Idea31226Config();
