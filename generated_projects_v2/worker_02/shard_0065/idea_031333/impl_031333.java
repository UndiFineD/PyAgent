...
@Data
public class Idea31333Config {
    private String name = "idea_031333";
 ...
 */
@Slf4j
public class Idea31333Service {
    private static final int IDEA_ID = 31333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31333Service() {
        this(new Idea31333Config());
    }

    public Idea31333Service(Idea31333Config config) {
        this.config = config != null ? config : new Idea31333Config();
