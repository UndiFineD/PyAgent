...
@Data
public class Idea30914Config {
    private String name = "idea_030914";
 ...
 */
@Slf4j
public class Idea30914Service {
    private static final int IDEA_ID = 30914;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30914Service() {
        this(new Idea30914Config());
    }

    public Idea30914Service(Idea30914Config config) {
        this.config = config != null ? config : new Idea30914Config();
