...
@Data
public class Idea31272Config {
    private String name = "idea_031272";
 ...
 */
@Slf4j
public class Idea31272Service {
    private static final int IDEA_ID = 31272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31272Service() {
        this(new Idea31272Config());
    }

    public Idea31272Service(Idea31272Config config) {
        this.config = config != null ? config : new Idea31272Config();
