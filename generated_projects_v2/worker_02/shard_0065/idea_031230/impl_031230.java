...
@Data
public class Idea31230Config {
    private String name = "idea_031230";
 ...
 */
@Slf4j
public class Idea31230Service {
    private static final int IDEA_ID = 31230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31230Service() {
        this(new Idea31230Config());
    }

    public Idea31230Service(Idea31230Config config) {
        this.config = config != null ? config : new Idea31230Config();
