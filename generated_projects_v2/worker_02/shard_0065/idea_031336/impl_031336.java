...
@Data
public class Idea31336Config {
    private String name = "idea_031336";
 ...
 */
@Slf4j
public class Idea31336Service {
    private static final int IDEA_ID = 31336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31336Service() {
        this(new Idea31336Config());
    }

    public Idea31336Service(Idea31336Config config) {
        this.config = config != null ? config : new Idea31336Config();
