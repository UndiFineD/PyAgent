...
@Data
public class Idea31026Config {
    private String name = "idea_031026";
 ...
 */
@Slf4j
public class Idea31026Service {
    private static final int IDEA_ID = 31026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31026Service() {
        this(new Idea31026Config());
    }

    public Idea31026Service(Idea31026Config config) {
        this.config = config != null ? config : new Idea31026Config();
