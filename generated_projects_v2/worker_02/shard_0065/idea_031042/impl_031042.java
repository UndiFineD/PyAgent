...
@Data
public class Idea31042Config {
    private String name = "idea_031042";
 ...
 */
@Slf4j
public class Idea31042Service {
    private static final int IDEA_ID = 31042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31042Service() {
        this(new Idea31042Config());
    }

    public Idea31042Service(Idea31042Config config) {
        this.config = config != null ? config : new Idea31042Config();
