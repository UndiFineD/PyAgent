...
@Data
public class Idea31102Config {
    private String name = "idea_031102";
 ...
 */
@Slf4j
public class Idea31102Service {
    private static final int IDEA_ID = 31102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31102Service() {
        this(new Idea31102Config());
    }

    public Idea31102Service(Idea31102Config config) {
        this.config = config != null ? config : new Idea31102Config();
