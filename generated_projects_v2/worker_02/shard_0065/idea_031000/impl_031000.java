...
@Data
public class Idea31000Config {
    private String name = "idea_031000";
 ...
 */
@Slf4j
public class Idea31000Service {
    private static final int IDEA_ID = 31000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31000Service() {
        this(new Idea31000Config());
    }

    public Idea31000Service(Idea31000Config config) {
        this.config = config != null ? config : new Idea31000Config();
