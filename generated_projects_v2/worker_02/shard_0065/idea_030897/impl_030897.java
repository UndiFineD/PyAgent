...
@Data
public class Idea30897Config {
    private String name = "idea_030897";
 ...
 */
@Slf4j
public class Idea30897Service {
    private static final int IDEA_ID = 30897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30897Service() {
        this(new Idea30897Config());
    }

    public Idea30897Service(Idea30897Config config) {
        this.config = config != null ? config : new Idea30897Config();
