...
@Data
public class Idea31072Config {
    private String name = "idea_031072";
 ...
 */
@Slf4j
public class Idea31072Service {
    private static final int IDEA_ID = 31072;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31072Service() {
        this(new Idea31072Config());
    }

    public Idea31072Service(Idea31072Config config) {
        this.config = config != null ? config : new Idea31072Config();
