...
@Data
public class Idea30889Config {
    private String name = "idea_030889";
 ...
 */
@Slf4j
public class Idea30889Service {
    private static final int IDEA_ID = 30889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30889Service() {
        this(new Idea30889Config());
    }

    public Idea30889Service(Idea30889Config config) {
        this.config = config != null ? config : new Idea30889Config();
