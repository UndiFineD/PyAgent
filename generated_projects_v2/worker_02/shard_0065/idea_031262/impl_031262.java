...
@Data
public class Idea31262Config {
    private String name = "idea_031262";
 ...
 */
@Slf4j
public class Idea31262Service {
    private static final int IDEA_ID = 31262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31262Service() {
        this(new Idea31262Config());
    }

    public Idea31262Service(Idea31262Config config) {
        this.config = config != null ? config : new Idea31262Config();
