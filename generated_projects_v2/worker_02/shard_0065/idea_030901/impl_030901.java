...
@Data
public class Idea30901Config {
    private String name = "idea_030901";
 ...
 */
@Slf4j
public class Idea30901Service {
    private static final int IDEA_ID = 30901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30901Service() {
        this(new Idea30901Config());
    }

    public Idea30901Service(Idea30901Config config) {
        this.config = config != null ? config : new Idea30901Config();
