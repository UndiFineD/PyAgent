...
@Data
public class Idea31113Config {
    private String name = "idea_031113";
 ...
 */
@Slf4j
public class Idea31113Service {
    private static final int IDEA_ID = 31113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31113Service() {
        this(new Idea31113Config());
    }

    public Idea31113Service(Idea31113Config config) {
        this.config = config != null ? config : new Idea31113Config();
