...
@Data
public class Idea31278Config {
    private String name = "idea_031278";
 ...
 */
@Slf4j
public class Idea31278Service {
    private static final int IDEA_ID = 31278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31278Service() {
        this(new Idea31278Config());
    }

    public Idea31278Service(Idea31278Config config) {
        this.config = config != null ? config : new Idea31278Config();
