...
@Data
public class Idea31120Config {
    private String name = "idea_031120";
 ...
 */
@Slf4j
public class Idea31120Service {
    private static final int IDEA_ID = 31120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31120Service() {
        this(new Idea31120Config());
    }

    public Idea31120Service(Idea31120Config config) {
        this.config = config != null ? config : new Idea31120Config();
