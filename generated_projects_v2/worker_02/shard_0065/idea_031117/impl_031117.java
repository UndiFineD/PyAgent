...
@Data
public class Idea31117Config {
    private String name = "idea_031117";
 ...
 */
@Slf4j
public class Idea31117Service {
    private static final int IDEA_ID = 31117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31117Service() {
        this(new Idea31117Config());
    }

    public Idea31117Service(Idea31117Config config) {
        this.config = config != null ? config : new Idea31117Config();
