...
@Data
public class Idea30890Config {
    private String name = "idea_030890";
 ...
 */
@Slf4j
public class Idea30890Service {
    private static final int IDEA_ID = 30890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30890Service() {
        this(new Idea30890Config());
    }

    public Idea30890Service(Idea30890Config config) {
        this.config = config != null ? config : new Idea30890Config();
