...
@Data
public class Idea31161Config {
    private String name = "idea_031161";
 ...
 */
@Slf4j
public class Idea31161Service {
    private static final int IDEA_ID = 31161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31161Service() {
        this(new Idea31161Config());
    }

    public Idea31161Service(Idea31161Config config) {
        this.config = config != null ? config : new Idea31161Config();
