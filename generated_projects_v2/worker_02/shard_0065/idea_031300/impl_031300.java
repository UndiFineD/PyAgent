...
@Data
public class Idea31300Config {
    private String name = "idea_031300";
 ...
 */
@Slf4j
public class Idea31300Service {
    private static final int IDEA_ID = 31300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31300Service() {
        this(new Idea31300Config());
    }

    public Idea31300Service(Idea31300Config config) {
        this.config = config != null ? config : new Idea31300Config();
