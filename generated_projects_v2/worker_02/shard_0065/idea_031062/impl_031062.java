...
@Data
public class Idea31062Config {
    private String name = "idea_031062";
 ...
 */
@Slf4j
public class Idea31062Service {
    private static final int IDEA_ID = 31062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31062Service() {
        this(new Idea31062Config());
    }

    public Idea31062Service(Idea31062Config config) {
        this.config = config != null ? config : new Idea31062Config();
