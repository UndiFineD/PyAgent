...
@Data
public class Idea31046Config {
    private String name = "idea_031046";
 ...
 */
@Slf4j
public class Idea31046Service {
    private static final int IDEA_ID = 31046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31046Service() {
        this(new Idea31046Config());
    }

    public Idea31046Service(Idea31046Config config) {
        this.config = config != null ? config : new Idea31046Config();
