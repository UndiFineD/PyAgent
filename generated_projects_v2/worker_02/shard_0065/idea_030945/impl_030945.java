...
@Data
public class Idea30945Config {
    private String name = "idea_030945";
 ...
 */
@Slf4j
public class Idea30945Service {
    private static final int IDEA_ID = 30945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30945Service() {
        this(new Idea30945Config());
    }

    public Idea30945Service(Idea30945Config config) {
        this.config = config != null ? config : new Idea30945Config();
