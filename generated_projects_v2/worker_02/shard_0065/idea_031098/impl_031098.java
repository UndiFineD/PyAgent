...
@Data
public class Idea31098Config {
    private String name = "idea_031098";
 ...
 */
@Slf4j
public class Idea31098Service {
    private static final int IDEA_ID = 31098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31098Service() {
        this(new Idea31098Config());
    }

    public Idea31098Service(Idea31098Config config) {
        this.config = config != null ? config : new Idea31098Config();
