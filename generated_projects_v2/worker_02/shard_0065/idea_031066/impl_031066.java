...
@Data
public class Idea31066Config {
    private String name = "idea_031066";
 ...
 */
@Slf4j
public class Idea31066Service {
    private static final int IDEA_ID = 31066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31066Service() {
        this(new Idea31066Config());
    }

    public Idea31066Service(Idea31066Config config) {
        this.config = config != null ? config : new Idea31066Config();
