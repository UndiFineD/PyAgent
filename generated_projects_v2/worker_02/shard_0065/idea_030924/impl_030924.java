...
@Data
public class Idea30924Config {
    private String name = "idea_030924";
 ...
 */
@Slf4j
public class Idea30924Service {
    private static final int IDEA_ID = 30924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30924Service() {
        this(new Idea30924Config());
    }

    public Idea30924Service(Idea30924Config config) {
        this.config = config != null ? config : new Idea30924Config();
