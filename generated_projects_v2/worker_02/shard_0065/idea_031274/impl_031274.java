...
@Data
public class Idea31274Config {
    private String name = "idea_031274";
 ...
 */
@Slf4j
public class Idea31274Service {
    private static final int IDEA_ID = 31274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31274Service() {
        this(new Idea31274Config());
    }

    public Idea31274Service(Idea31274Config config) {
        this.config = config != null ? config : new Idea31274Config();
