...
@Data
public class Idea31078Config {
    private String name = "idea_031078";
 ...
 */
@Slf4j
public class Idea31078Service {
    private static final int IDEA_ID = 31078;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31078Service() {
        this(new Idea31078Config());
    }

    public Idea31078Service(Idea31078Config config) {
        this.config = config != null ? config : new Idea31078Config();
