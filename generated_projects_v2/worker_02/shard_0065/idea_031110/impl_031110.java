...
@Data
public class Idea31110Config {
    private String name = "idea_031110";
 ...
 */
@Slf4j
public class Idea31110Service {
    private static final int IDEA_ID = 31110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31110Service() {
        this(new Idea31110Config());
    }

    public Idea31110Service(Idea31110Config config) {
        this.config = config != null ? config : new Idea31110Config();
