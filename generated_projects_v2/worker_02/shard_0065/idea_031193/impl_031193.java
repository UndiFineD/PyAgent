...
@Data
public class Idea31193Config {
    private String name = "idea_031193";
 ...
 */
@Slf4j
public class Idea31193Service {
    private static final int IDEA_ID = 31193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31193Service() {
        this(new Idea31193Config());
    }

    public Idea31193Service(Idea31193Config config) {
        this.config = config != null ? config : new Idea31193Config();
