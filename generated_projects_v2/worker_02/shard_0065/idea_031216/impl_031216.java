...
@Data
public class Idea31216Config {
    private String name = "idea_031216";
 ...
 */
@Slf4j
public class Idea31216Service {
    private static final int IDEA_ID = 31216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31216Service() {
        this(new Idea31216Config());
    }

    public Idea31216Service(Idea31216Config config) {
        this.config = config != null ? config : new Idea31216Config();
