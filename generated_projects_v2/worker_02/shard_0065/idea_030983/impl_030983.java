...
@Data
public class Idea30983Config {
    private String name = "idea_030983";
 ...
 */
@Slf4j
public class Idea30983Service {
    private static final int IDEA_ID = 30983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30983Service() {
        this(new Idea30983Config());
    }

    public Idea30983Service(Idea30983Config config) {
        this.config = config != null ? config : new Idea30983Config();
