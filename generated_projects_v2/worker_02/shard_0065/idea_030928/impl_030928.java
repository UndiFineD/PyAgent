...
@Data
public class Idea30928Config {
    private String name = "idea_030928";
 ...
 */
@Slf4j
public class Idea30928Service {
    private static final int IDEA_ID = 30928;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30928Service() {
        this(new Idea30928Config());
    }

    public Idea30928Service(Idea30928Config config) {
        this.config = config != null ? config : new Idea30928Config();
