...
@Data
public class Idea30887Config {
    private String name = "idea_030887";
 ...
 */
@Slf4j
public class Idea30887Service {
    private static final int IDEA_ID = 30887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30887Service() {
        this(new Idea30887Config());
    }

    public Idea30887Service(Idea30887Config config) {
        this.config = config != null ? config : new Idea30887Config();
