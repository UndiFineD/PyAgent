...
@Data
public class Idea30933Config {
    private String name = "idea_030933";
 ...
 */
@Slf4j
public class Idea30933Service {
    private static final int IDEA_ID = 30933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30933Service() {
        this(new Idea30933Config());
    }

    public Idea30933Service(Idea30933Config config) {
        this.config = config != null ? config : new Idea30933Config();
