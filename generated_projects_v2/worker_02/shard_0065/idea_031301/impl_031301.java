...
@Data
public class Idea31301Config {
    private String name = "idea_031301";
 ...
 */
@Slf4j
public class Idea31301Service {
    private static final int IDEA_ID = 31301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31301Service() {
        this(new Idea31301Config());
    }

    public Idea31301Service(Idea31301Config config) {
        this.config = config != null ? config : new Idea31301Config();
