...
@Data
public class Idea30893Config {
    private String name = "idea_030893";
 ...
 */
@Slf4j
public class Idea30893Service {
    private static final int IDEA_ID = 30893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30893Service() {
        this(new Idea30893Config());
    }

    public Idea30893Service(Idea30893Config config) {
        this.config = config != null ? config : new Idea30893Config();
