...
@Data
public class Idea30898Config {
    private String name = "idea_030898";
 ...
 */
@Slf4j
public class Idea30898Service {
    private static final int IDEA_ID = 30898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30898Service() {
        this(new Idea30898Config());
    }

    public Idea30898Service(Idea30898Config config) {
        this.config = config != null ? config : new Idea30898Config();
