...
@Data
public class Idea30967Config {
    private String name = "idea_030967";
 ...
 */
@Slf4j
public class Idea30967Service {
    private static final int IDEA_ID = 30967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30967Service() {
        this(new Idea30967Config());
    }

    public Idea30967Service(Idea30967Config config) {
        this.config = config != null ? config : new Idea30967Config();
