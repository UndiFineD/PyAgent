...
@Data
public class Idea31298Config {
    private String name = "idea_031298";
 ...
 */
@Slf4j
public class Idea31298Service {
    private static final int IDEA_ID = 31298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31298Service() {
        this(new Idea31298Config());
    }

    public Idea31298Service(Idea31298Config config) {
        this.config = config != null ? config : new Idea31298Config();
