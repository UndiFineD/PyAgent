...
@Data
public class Idea30903Config {
    private String name = "idea_030903";
 ...
 */
@Slf4j
public class Idea30903Service {
    private static final int IDEA_ID = 30903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30903Service() {
        this(new Idea30903Config());
    }

    public Idea30903Service(Idea30903Config config) {
        this.config = config != null ? config : new Idea30903Config();
