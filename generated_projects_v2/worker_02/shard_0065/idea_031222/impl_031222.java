...
@Data
public class Idea31222Config {
    private String name = "idea_031222";
 ...
 */
@Slf4j
public class Idea31222Service {
    private static final int IDEA_ID = 31222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31222Service() {
        this(new Idea31222Config());
    }

    public Idea31222Service(Idea31222Config config) {
        this.config = config != null ? config : new Idea31222Config();
