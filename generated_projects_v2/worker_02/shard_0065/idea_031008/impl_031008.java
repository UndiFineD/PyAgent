...
@Data
public class Idea31008Config {
    private String name = "idea_031008";
 ...
 */
@Slf4j
public class Idea31008Service {
    private static final int IDEA_ID = 31008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31008Service() {
        this(new Idea31008Config());
    }

    public Idea31008Service(Idea31008Config config) {
        this.config = config != null ? config : new Idea31008Config();
