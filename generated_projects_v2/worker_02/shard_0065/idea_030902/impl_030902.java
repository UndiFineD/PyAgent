...
@Data
public class Idea30902Config {
    private String name = "idea_030902";
 ...
 */
@Slf4j
public class Idea30902Service {
    private static final int IDEA_ID = 30902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30902Service() {
        this(new Idea30902Config());
    }

    public Idea30902Service(Idea30902Config config) {
        this.config = config != null ? config : new Idea30902Config();
