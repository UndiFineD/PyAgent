...
@Data
public class Idea30977Config {
    private String name = "idea_030977";
 ...
 */
@Slf4j
public class Idea30977Service {
    private static final int IDEA_ID = 30977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30977Service() {
        this(new Idea30977Config());
    }

    public Idea30977Service(Idea30977Config config) {
        this.config = config != null ? config : new Idea30977Config();
