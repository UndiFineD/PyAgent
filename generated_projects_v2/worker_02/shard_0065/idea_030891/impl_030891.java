...
@Data
public class Idea30891Config {
    private String name = "idea_030891";
 ...
 */
@Slf4j
public class Idea30891Service {
    private static final int IDEA_ID = 30891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30891Service() {
        this(new Idea30891Config());
    }

    public Idea30891Service(Idea30891Config config) {
        this.config = config != null ? config : new Idea30891Config();
