...
@Data
public class Idea31218Config {
    private String name = "idea_031218";
 ...
 */
@Slf4j
public class Idea31218Service {
    private static final int IDEA_ID = 31218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31218Service() {
        this(new Idea31218Config());
    }

    public Idea31218Service(Idea31218Config config) {
        this.config = config != null ? config : new Idea31218Config();
