...
@Data
public class Idea30941Config {
    private String name = "idea_030941";
 ...
 */
@Slf4j
public class Idea30941Service {
    private static final int IDEA_ID = 30941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30941Service() {
        this(new Idea30941Config());
    }

    public Idea30941Service(Idea30941Config config) {
        this.config = config != null ? config : new Idea30941Config();
