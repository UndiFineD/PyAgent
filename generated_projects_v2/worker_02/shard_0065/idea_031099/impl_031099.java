...
@Data
public class Idea31099Config {
    private String name = "idea_031099";
 ...
 */
@Slf4j
public class Idea31099Service {
    private static final int IDEA_ID = 31099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31099Service() {
        this(new Idea31099Config());
    }

    public Idea31099Service(Idea31099Config config) {
        this.config = config != null ? config : new Idea31099Config();
