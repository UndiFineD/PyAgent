...
@Data
public class Idea31088Config {
    private String name = "idea_031088";
 ...
 */
@Slf4j
public class Idea31088Service {
    private static final int IDEA_ID = 31088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31088Service() {
        this(new Idea31088Config());
    }

    public Idea31088Service(Idea31088Config config) {
        this.config = config != null ? config : new Idea31088Config();
