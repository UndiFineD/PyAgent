...
@Data
public class Idea31247Config {
    private String name = "idea_031247";
 ...
 */
@Slf4j
public class Idea31247Service {
    private static final int IDEA_ID = 31247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31247Service() {
        this(new Idea31247Config());
    }

    public Idea31247Service(Idea31247Config config) {
        this.config = config != null ? config : new Idea31247Config();
