...
@Data
public class Idea30943Config {
    private String name = "idea_030943";
 ...
 */
@Slf4j
public class Idea30943Service {
    private static final int IDEA_ID = 30943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30943Service() {
        this(new Idea30943Config());
    }

    public Idea30943Service(Idea30943Config config) {
        this.config = config != null ? config : new Idea30943Config();
