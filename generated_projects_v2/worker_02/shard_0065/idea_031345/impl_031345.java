...
@Data
public class Idea31345Config {
    private String name = "idea_031345";
 ...
 */
@Slf4j
public class Idea31345Service {
    private static final int IDEA_ID = 31345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31345Service() {
        this(new Idea31345Config());
    }

    public Idea31345Service(Idea31345Config config) {
        this.config = config != null ? config : new Idea31345Config();
