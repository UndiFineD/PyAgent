...
@Data
public class Idea31201Config {
    private String name = "idea_031201";
 ...
 */
@Slf4j
public class Idea31201Service {
    private static final int IDEA_ID = 31201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31201Service() {
        this(new Idea31201Config());
    }

    public Idea31201Service(Idea31201Config config) {
        this.config = config != null ? config : new Idea31201Config();
