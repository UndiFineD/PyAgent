...
@Data
public class Idea31090Config {
    private String name = "idea_031090";
 ...
 */
@Slf4j
public class Idea31090Service {
    private static final int IDEA_ID = 31090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31090Service() {
        this(new Idea31090Config());
    }

    public Idea31090Service(Idea31090Config config) {
        this.config = config != null ? config : new Idea31090Config();
