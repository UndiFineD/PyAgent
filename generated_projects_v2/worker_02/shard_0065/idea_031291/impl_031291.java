...
@Data
public class Idea31291Config {
    private String name = "idea_031291";
 ...
 */
@Slf4j
public class Idea31291Service {
    private static final int IDEA_ID = 31291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31291Service() {
        this(new Idea31291Config());
    }

    public Idea31291Service(Idea31291Config config) {
        this.config = config != null ? config : new Idea31291Config();
