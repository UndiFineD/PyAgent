...
@Data
public class Idea31045Config {
    private String name = "idea_031045";
 ...
 */
@Slf4j
public class Idea31045Service {
    private static final int IDEA_ID = 31045;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31045Service() {
        this(new Idea31045Config());
    }

    public Idea31045Service(Idea31045Config config) {
        this.config = config != null ? config : new Idea31045Config();
