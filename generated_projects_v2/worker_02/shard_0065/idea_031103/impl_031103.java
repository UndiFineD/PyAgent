...
@Data
public class Idea31103Config {
    private String name = "idea_031103";
 ...
 */
@Slf4j
public class Idea31103Service {
    private static final int IDEA_ID = 31103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31103Service() {
        this(new Idea31103Config());
    }

    public Idea31103Service(Idea31103Config config) {
        this.config = config != null ? config : new Idea31103Config();
