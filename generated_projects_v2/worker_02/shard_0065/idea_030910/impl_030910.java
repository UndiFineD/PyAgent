...
@Data
public class Idea30910Config {
    private String name = "idea_030910";
 ...
 */
@Slf4j
public class Idea30910Service {
    private static final int IDEA_ID = 30910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30910Service() {
        this(new Idea30910Config());
    }

    public Idea30910Service(Idea30910Config config) {
        this.config = config != null ? config : new Idea30910Config();
