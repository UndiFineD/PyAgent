...
@Data
public class Idea31267Config {
    private String name = "idea_031267";
 ...
 */
@Slf4j
public class Idea31267Service {
    private static final int IDEA_ID = 31267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31267Service() {
        this(new Idea31267Config());
    }

    public Idea31267Service(Idea31267Config config) {
        this.config = config != null ? config : new Idea31267Config();
