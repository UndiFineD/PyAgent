...
@Data
public class Idea31044Config {
    private String name = "idea_031044";
 ...
 */
@Slf4j
public class Idea31044Service {
    private static final int IDEA_ID = 31044;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31044Service() {
        this(new Idea31044Config());
    }

    public Idea31044Service(Idea31044Config config) {
        this.config = config != null ? config : new Idea31044Config();
