...
@Data
public class Idea31207Config {
    private String name = "idea_031207";
 ...
 */
@Slf4j
public class Idea31207Service {
    private static final int IDEA_ID = 31207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31207Service() {
        this(new Idea31207Config());
    }

    public Idea31207Service(Idea31207Config config) {
        this.config = config != null ? config : new Idea31207Config();
