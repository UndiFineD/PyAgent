...
@Data
public class Idea30987Config {
    private String name = "idea_030987";
 ...
 */
@Slf4j
public class Idea30987Service {
    private static final int IDEA_ID = 30987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30987Service() {
        this(new Idea30987Config());
    }

    public Idea30987Service(Idea30987Config config) {
        this.config = config != null ? config : new Idea30987Config();
