...
@Data
public class Idea31313Config {
    private String name = "idea_031313";
 ...
 */
@Slf4j
public class Idea31313Service {
    private static final int IDEA_ID = 31313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31313Service() {
        this(new Idea31313Config());
    }

    public Idea31313Service(Idea31313Config config) {
        this.config = config != null ? config : new Idea31313Config();
