...
@Data
public class Idea31037Config {
    private String name = "idea_031037";
 ...
 */
@Slf4j
public class Idea31037Service {
    private static final int IDEA_ID = 31037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31037Service() {
        this(new Idea31037Config());
    }

    public Idea31037Service(Idea31037Config config) {
        this.config = config != null ? config : new Idea31037Config();
