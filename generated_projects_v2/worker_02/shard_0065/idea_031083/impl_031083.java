...
@Data
public class Idea31083Config {
    private String name = "idea_031083";
 ...
 */
@Slf4j
public class Idea31083Service {
    private static final int IDEA_ID = 31083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31083Service() {
        this(new Idea31083Config());
    }

    public Idea31083Service(Idea31083Config config) {
        this.config = config != null ? config : new Idea31083Config();
