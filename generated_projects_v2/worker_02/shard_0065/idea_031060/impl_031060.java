...
@Data
public class Idea31060Config {
    private String name = "idea_031060";
 ...
 */
@Slf4j
public class Idea31060Service {
    private static final int IDEA_ID = 31060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31060Service() {
        this(new Idea31060Config());
    }

    public Idea31060Service(Idea31060Config config) {
        this.config = config != null ? config : new Idea31060Config();
