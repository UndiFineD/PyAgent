...
@Data
public class Idea31250Config {
    private String name = "idea_031250";
 ...
 */
@Slf4j
public class Idea31250Service {
    private static final int IDEA_ID = 31250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31250Service() {
        this(new Idea31250Config());
    }

    public Idea31250Service(Idea31250Config config) {
        this.config = config != null ? config : new Idea31250Config();
