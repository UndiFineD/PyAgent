...
@Data
public class Idea31024Config {
    private String name = "idea_031024";
 ...
 */
@Slf4j
public class Idea31024Service {
    private static final int IDEA_ID = 31024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31024Service() {
        this(new Idea31024Config());
    }

    public Idea31024Service(Idea31024Config config) {
        this.config = config != null ? config : new Idea31024Config();
