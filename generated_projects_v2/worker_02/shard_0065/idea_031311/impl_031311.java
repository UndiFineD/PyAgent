...
@Data
public class Idea31311Config {
    private String name = "idea_031311";
 ...
 */
@Slf4j
public class Idea31311Service {
    private static final int IDEA_ID = 31311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31311Service() {
        this(new Idea31311Config());
    }

    public Idea31311Service(Idea31311Config config) {
        this.config = config != null ? config : new Idea31311Config();
