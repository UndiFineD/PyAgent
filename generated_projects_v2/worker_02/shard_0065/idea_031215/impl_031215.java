...
@Data
public class Idea31215Config {
    private String name = "idea_031215";
 ...
 */
@Slf4j
public class Idea31215Service {
    private static final int IDEA_ID = 31215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31215Service() {
        this(new Idea31215Config());
    }

    public Idea31215Service(Idea31215Config config) {
        this.config = config != null ? config : new Idea31215Config();
