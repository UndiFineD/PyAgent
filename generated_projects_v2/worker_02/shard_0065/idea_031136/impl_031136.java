...
@Data
public class Idea31136Config {
    private String name = "idea_031136";
 ...
 */
@Slf4j
public class Idea31136Service {
    private static final int IDEA_ID = 31136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31136Service() {
        this(new Idea31136Config());
    }

    public Idea31136Service(Idea31136Config config) {
        this.config = config != null ? config : new Idea31136Config();
