...
@Data
public class Idea31263Config {
    private String name = "idea_031263";
 ...
 */
@Slf4j
public class Idea31263Service {
    private static final int IDEA_ID = 31263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31263Service() {
        this(new Idea31263Config());
    }

    public Idea31263Service(Idea31263Config config) {
        this.config = config != null ? config : new Idea31263Config();
