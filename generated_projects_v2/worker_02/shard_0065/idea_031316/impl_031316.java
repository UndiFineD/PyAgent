...
@Data
public class Idea31316Config {
    private String name = "idea_031316";
 ...
 */
@Slf4j
public class Idea31316Service {
    private static final int IDEA_ID = 31316;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31316Service() {
        this(new Idea31316Config());
    }

    public Idea31316Service(Idea31316Config config) {
        this.config = config != null ? config : new Idea31316Config();
