...
@Data
public class Idea31029Config {
    private String name = "idea_031029";
 ...
 */
@Slf4j
public class Idea31029Service {
    private static final int IDEA_ID = 31029;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31029Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31029Service() {
        this(new Idea31029Config());
    }

    public Idea31029Service(Idea31029Config config) {
        this.config = config != null ? config : new Idea31029Config();
