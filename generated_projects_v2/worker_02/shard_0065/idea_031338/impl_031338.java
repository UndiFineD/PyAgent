...
@Data
public class Idea31338Config {
    private String name = "idea_031338";
 ...
 */
@Slf4j
public class Idea31338Service {
    private static final int IDEA_ID = 31338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31338Service() {
        this(new Idea31338Config());
    }

    public Idea31338Service(Idea31338Config config) {
        this.config = config != null ? config : new Idea31338Config();
