...
@Data
public class Idea30937Config {
    private String name = "idea_030937";
 ...
 */
@Slf4j
public class Idea30937Service {
    private static final int IDEA_ID = 30937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30937Service() {
        this(new Idea30937Config());
    }

    public Idea30937Service(Idea30937Config config) {
        this.config = config != null ? config : new Idea30937Config();
