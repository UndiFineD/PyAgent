...
@Data
public class Idea31015Config {
    private String name = "idea_031015";
 ...
 */
@Slf4j
public class Idea31015Service {
    private static final int IDEA_ID = 31015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31015Service() {
        this(new Idea31015Config());
    }

    public Idea31015Service(Idea31015Config config) {
        this.config = config != null ? config : new Idea31015Config();
