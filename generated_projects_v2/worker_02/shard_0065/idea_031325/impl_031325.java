...
@Data
public class Idea31325Config {
    private String name = "idea_031325";
 ...
 */
@Slf4j
public class Idea31325Service {
    private static final int IDEA_ID = 31325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31325Service() {
        this(new Idea31325Config());
    }

    public Idea31325Service(Idea31325Config config) {
        this.config = config != null ? config : new Idea31325Config();
