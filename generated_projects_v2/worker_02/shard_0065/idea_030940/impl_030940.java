...
@Data
public class Idea30940Config {
    private String name = "idea_030940";
 ...
 */
@Slf4j
public class Idea30940Service {
    private static final int IDEA_ID = 30940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30940Service() {
        this(new Idea30940Config());
    }

    public Idea30940Service(Idea30940Config config) {
        this.config = config != null ? config : new Idea30940Config();
