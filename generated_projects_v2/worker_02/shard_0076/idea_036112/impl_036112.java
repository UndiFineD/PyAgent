...
@Data
public class Idea36112Config {
    private String name = "idea_036112";
 ...
 */
@Slf4j
public class Idea36112Service {
    private static final int IDEA_ID = 36112;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36112Service() {
        this(new Idea36112Config());
    }

    public Idea36112Service(Idea36112Config config) {
        this.config = config != null ? config : new Idea36112Config();
