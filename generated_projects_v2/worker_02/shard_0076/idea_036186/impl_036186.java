...
@Data
public class Idea36186Config {
    private String name = "idea_036186";
 ...
 */
@Slf4j
public class Idea36186Service {
    private static final int IDEA_ID = 36186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36186Service() {
        this(new Idea36186Config());
    }

    public Idea36186Service(Idea36186Config config) {
        this.config = config != null ? config : new Idea36186Config();
