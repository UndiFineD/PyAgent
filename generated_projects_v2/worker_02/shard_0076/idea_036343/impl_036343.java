...
@Data
public class Idea36343Config {
    private String name = "idea_036343";
 ...
 */
@Slf4j
public class Idea36343Service {
    private static final int IDEA_ID = 36343;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36343Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36343Service() {
        this(new Idea36343Config());
    }

    public Idea36343Service(Idea36343Config config) {
        this.config = config != null ? config : new Idea36343Config();
