...
@Data
public class Idea36246Config {
    private String name = "idea_036246";
 ...
 */
@Slf4j
public class Idea36246Service {
    private static final int IDEA_ID = 36246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36246Service() {
        this(new Idea36246Config());
    }

    public Idea36246Service(Idea36246Config config) {
        this.config = config != null ? config : new Idea36246Config();
