...
@Data
public class Idea36451Config {
    private String name = "idea_036451";
 ...
 */
@Slf4j
public class Idea36451Service {
    private static final int IDEA_ID = 36451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36451Service() {
        this(new Idea36451Config());
    }

    public Idea36451Service(Idea36451Config config) {
        this.config = config != null ? config : new Idea36451Config();
