...
@Data
public class Idea36261Config {
    private String name = "idea_036261";
 ...
 */
@Slf4j
public class Idea36261Service {
    private static final int IDEA_ID = 36261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36261Service() {
        this(new Idea36261Config());
    }

    public Idea36261Service(Idea36261Config config) {
        this.config = config != null ? config : new Idea36261Config();
