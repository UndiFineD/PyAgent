...
@Data
public class Idea36182Config {
    private String name = "idea_036182";
 ...
 */
@Slf4j
public class Idea36182Service {
    private static final int IDEA_ID = 36182;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36182Service() {
        this(new Idea36182Config());
    }

    public Idea36182Service(Idea36182Config config) {
        this.config = config != null ? config : new Idea36182Config();
