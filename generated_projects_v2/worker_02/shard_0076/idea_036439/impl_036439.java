...
@Data
public class Idea36439Config {
    private String name = "idea_036439";
 ...
 */
@Slf4j
public class Idea36439Service {
    private static final int IDEA_ID = 36439;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36439Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36439Service() {
        this(new Idea36439Config());
    }

    public Idea36439Service(Idea36439Config config) {
        this.config = config != null ? config : new Idea36439Config();
