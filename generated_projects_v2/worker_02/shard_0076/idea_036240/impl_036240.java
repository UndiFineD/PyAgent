...
@Data
public class Idea36240Config {
    private String name = "idea_036240";
 ...
 */
@Slf4j
public class Idea36240Service {
    private static final int IDEA_ID = 36240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36240Service() {
        this(new Idea36240Config());
    }

    public Idea36240Service(Idea36240Config config) {
        this.config = config != null ? config : new Idea36240Config();
