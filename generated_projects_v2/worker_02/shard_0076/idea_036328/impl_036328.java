...
@Data
public class Idea36328Config {
    private String name = "idea_036328";
 ...
 */
@Slf4j
public class Idea36328Service {
    private static final int IDEA_ID = 36328;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36328Service() {
        this(new Idea36328Config());
    }

    public Idea36328Service(Idea36328Config config) {
        this.config = config != null ? config : new Idea36328Config();
