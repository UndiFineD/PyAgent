...
@Data
public class Idea36281Config {
    private String name = "idea_036281";
 ...
 */
@Slf4j
public class Idea36281Service {
    private static final int IDEA_ID = 36281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36281Service() {
        this(new Idea36281Config());
    }

    public Idea36281Service(Idea36281Config config) {
        this.config = config != null ? config : new Idea36281Config();
