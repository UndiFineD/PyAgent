...
@Data
public class Idea36211Config {
    private String name = "idea_036211";
 ...
 */
@Slf4j
public class Idea36211Service {
    private static final int IDEA_ID = 36211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36211Service() {
        this(new Idea36211Config());
    }

    public Idea36211Service(Idea36211Config config) {
        this.config = config != null ? config : new Idea36211Config();
