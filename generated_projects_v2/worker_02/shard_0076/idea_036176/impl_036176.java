...
@Data
public class Idea36176Config {
    private String name = "idea_036176";
 ...
 */
@Slf4j
public class Idea36176Service {
    private static final int IDEA_ID = 36176;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36176Service() {
        this(new Idea36176Config());
    }

    public Idea36176Service(Idea36176Config config) {
        this.config = config != null ? config : new Idea36176Config();
