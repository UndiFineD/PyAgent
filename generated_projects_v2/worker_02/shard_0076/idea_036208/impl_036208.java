...
@Data
public class Idea36208Config {
    private String name = "idea_036208";
 ...
 */
@Slf4j
public class Idea36208Service {
    private static final int IDEA_ID = 36208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36208Service() {
        this(new Idea36208Config());
    }

    public Idea36208Service(Idea36208Config config) {
        this.config = config != null ? config : new Idea36208Config();
