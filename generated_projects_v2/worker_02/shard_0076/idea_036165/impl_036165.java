...
@Data
public class Idea36165Config {
    private String name = "idea_036165";
 ...
 */
@Slf4j
public class Idea36165Service {
    private static final int IDEA_ID = 36165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36165Service() {
        this(new Idea36165Config());
    }

    public Idea36165Service(Idea36165Config config) {
        this.config = config != null ? config : new Idea36165Config();
