...
@Data
public class Idea36546Config {
    private String name = "idea_036546";
 ...
 */
@Slf4j
public class Idea36546Service {
    private static final int IDEA_ID = 36546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36546Service() {
        this(new Idea36546Config());
    }

    public Idea36546Service(Idea36546Config config) {
        this.config = config != null ? config : new Idea36546Config();
