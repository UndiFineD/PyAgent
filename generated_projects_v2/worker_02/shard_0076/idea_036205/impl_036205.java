...
@Data
public class Idea36205Config {
    private String name = "idea_036205";
 ...
 */
@Slf4j
public class Idea36205Service {
    private static final int IDEA_ID = 36205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36205Service() {
        this(new Idea36205Config());
    }

    public Idea36205Service(Idea36205Config config) {
        this.config = config != null ? config : new Idea36205Config();
