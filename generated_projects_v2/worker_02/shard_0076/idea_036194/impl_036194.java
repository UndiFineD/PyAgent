...
@Data
public class Idea36194Config {
    private String name = "idea_036194";
 ...
 */
@Slf4j
public class Idea36194Service {
    private static final int IDEA_ID = 36194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36194Service() {
        this(new Idea36194Config());
    }

    public Idea36194Service(Idea36194Config config) {
        this.config = config != null ? config : new Idea36194Config();
