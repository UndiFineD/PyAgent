...
@Data
public class Idea36464Config {
    private String name = "idea_036464";
 ...
 */
@Slf4j
public class Idea36464Service {
    private static final int IDEA_ID = 36464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36464Service() {
        this(new Idea36464Config());
    }

    public Idea36464Service(Idea36464Config config) {
        this.config = config != null ? config : new Idea36464Config();
