...
@Data
public class Idea36374Config {
    private String name = "idea_036374";
 ...
 */
@Slf4j
public class Idea36374Service {
    private static final int IDEA_ID = 36374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36374Service() {
        this(new Idea36374Config());
    }

    public Idea36374Service(Idea36374Config config) {
        this.config = config != null ? config : new Idea36374Config();
