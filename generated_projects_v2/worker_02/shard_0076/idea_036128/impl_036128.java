...
@Data
public class Idea36128Config {
    private String name = "idea_036128";
 ...
 */
@Slf4j
public class Idea36128Service {
    private static final int IDEA_ID = 36128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36128Service() {
        this(new Idea36128Config());
    }

    public Idea36128Service(Idea36128Config config) {
        this.config = config != null ? config : new Idea36128Config();
