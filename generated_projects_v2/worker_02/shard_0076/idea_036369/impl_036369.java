...
@Data
public class Idea36369Config {
    private String name = "idea_036369";
 ...
 */
@Slf4j
public class Idea36369Service {
    private static final int IDEA_ID = 36369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36369Service() {
        this(new Idea36369Config());
    }

    public Idea36369Service(Idea36369Config config) {
        this.config = config != null ? config : new Idea36369Config();
