...
@Data
public class Idea36520Config {
    private String name = "idea_036520";
 ...
 */
@Slf4j
public class Idea36520Service {
    private static final int IDEA_ID = 36520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36520Service() {
        this(new Idea36520Config());
    }

    public Idea36520Service(Idea36520Config config) {
        this.config = config != null ? config : new Idea36520Config();
