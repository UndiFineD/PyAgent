...
@Data
public class Idea36291Config {
    private String name = "idea_036291";
 ...
 */
@Slf4j
public class Idea36291Service {
    private static final int IDEA_ID = 36291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36291Service() {
        this(new Idea36291Config());
    }

    public Idea36291Service(Idea36291Config config) {
        this.config = config != null ? config : new Idea36291Config();
