...
@Data
public class Idea36152Config {
    private String name = "idea_036152";
 ...
 */
@Slf4j
public class Idea36152Service {
    private static final int IDEA_ID = 36152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36152Service() {
        this(new Idea36152Config());
    }

    public Idea36152Service(Idea36152Config config) {
        this.config = config != null ? config : new Idea36152Config();
