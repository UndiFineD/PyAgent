...
@Data
public class Idea36347Config {
    private String name = "idea_036347";
 ...
 */
@Slf4j
public class Idea36347Service {
    private static final int IDEA_ID = 36347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36347Service() {
        this(new Idea36347Config());
    }

    public Idea36347Service(Idea36347Config config) {
        this.config = config != null ? config : new Idea36347Config();
