...
@Data
public class Idea36195Config {
    private String name = "idea_036195";
 ...
 */
@Slf4j
public class Idea36195Service {
    private static final int IDEA_ID = 36195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36195Service() {
        this(new Idea36195Config());
    }

    public Idea36195Service(Idea36195Config config) {
        this.config = config != null ? config : new Idea36195Config();
