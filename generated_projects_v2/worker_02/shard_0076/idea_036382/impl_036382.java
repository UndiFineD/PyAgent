...
@Data
public class Idea36382Config {
    private String name = "idea_036382";
 ...
 */
@Slf4j
public class Idea36382Service {
    private static final int IDEA_ID = 36382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36382Service() {
        this(new Idea36382Config());
    }

    public Idea36382Service(Idea36382Config config) {
        this.config = config != null ? config : new Idea36382Config();
