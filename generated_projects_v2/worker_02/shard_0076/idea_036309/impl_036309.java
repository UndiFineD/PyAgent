...
@Data
public class Idea36309Config {
    private String name = "idea_036309";
 ...
 */
@Slf4j
public class Idea36309Service {
    private static final int IDEA_ID = 36309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36309Service() {
        this(new Idea36309Config());
    }

    public Idea36309Service(Idea36309Config config) {
        this.config = config != null ? config : new Idea36309Config();
