...
@Data
public class Idea36288Config {
    private String name = "idea_036288";
 ...
 */
@Slf4j
public class Idea36288Service {
    private static final int IDEA_ID = 36288;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36288Service() {
        this(new Idea36288Config());
    }

    public Idea36288Service(Idea36288Config config) {
        this.config = config != null ? config : new Idea36288Config();
