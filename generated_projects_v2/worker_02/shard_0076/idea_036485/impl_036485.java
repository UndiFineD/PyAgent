...
@Data
public class Idea36485Config {
    private String name = "idea_036485";
 ...
 */
@Slf4j
public class Idea36485Service {
    private static final int IDEA_ID = 36485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36485Service() {
        this(new Idea36485Config());
    }

    public Idea36485Service(Idea36485Config config) {
        this.config = config != null ? config : new Idea36485Config();
