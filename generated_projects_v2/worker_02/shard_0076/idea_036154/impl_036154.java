...
@Data
public class Idea36154Config {
    private String name = "idea_036154";
 ...
 */
@Slf4j
public class Idea36154Service {
    private static final int IDEA_ID = 36154;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36154Service() {
        this(new Idea36154Config());
    }

    public Idea36154Service(Idea36154Config config) {
        this.config = config != null ? config : new Idea36154Config();
