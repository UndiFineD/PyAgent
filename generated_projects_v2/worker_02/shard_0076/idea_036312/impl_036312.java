...
@Data
public class Idea36312Config {
    private String name = "idea_036312";
 ...
 */
@Slf4j
public class Idea36312Service {
    private static final int IDEA_ID = 36312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36312Service() {
        this(new Idea36312Config());
    }

    public Idea36312Service(Idea36312Config config) {
        this.config = config != null ? config : new Idea36312Config();
