...
@Data
public class Idea36118Config {
    private String name = "idea_036118";
 ...
 */
@Slf4j
public class Idea36118Service {
    private static final int IDEA_ID = 36118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36118Service() {
        this(new Idea36118Config());
    }

    public Idea36118Service(Idea36118Config config) {
        this.config = config != null ? config : new Idea36118Config();
