...
@Data
public class Idea36539Config {
    private String name = "idea_036539";
 ...
 */
@Slf4j
public class Idea36539Service {
    private static final int IDEA_ID = 36539;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36539Service() {
        this(new Idea36539Config());
    }

    public Idea36539Service(Idea36539Config config) {
        this.config = config != null ? config : new Idea36539Config();
