...
@Data
public class Idea36371Config {
    private String name = "idea_036371";
 ...
 */
@Slf4j
public class Idea36371Service {
    private static final int IDEA_ID = 36371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36371Service() {
        this(new Idea36371Config());
    }

    public Idea36371Service(Idea36371Config config) {
        this.config = config != null ? config : new Idea36371Config();
