...
@Data
public class Idea36131Config {
    private String name = "idea_036131";
 ...
 */
@Slf4j
public class Idea36131Service {
    private static final int IDEA_ID = 36131;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36131Service() {
        this(new Idea36131Config());
    }

    public Idea36131Service(Idea36131Config config) {
        this.config = config != null ? config : new Idea36131Config();
