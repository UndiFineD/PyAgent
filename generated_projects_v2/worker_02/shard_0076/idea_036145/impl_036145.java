...
@Data
public class Idea36145Config {
    private String name = "idea_036145";
 ...
 */
@Slf4j
public class Idea36145Service {
    private static final int IDEA_ID = 36145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36145Service() {
        this(new Idea36145Config());
    }

    public Idea36145Service(Idea36145Config config) {
        this.config = config != null ? config : new Idea36145Config();
