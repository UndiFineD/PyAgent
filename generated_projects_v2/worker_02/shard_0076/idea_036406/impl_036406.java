...
@Data
public class Idea36406Config {
    private String name = "idea_036406";
 ...
 */
@Slf4j
public class Idea36406Service {
    private static final int IDEA_ID = 36406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36406Service() {
        this(new Idea36406Config());
    }

    public Idea36406Service(Idea36406Config config) {
        this.config = config != null ? config : new Idea36406Config();
