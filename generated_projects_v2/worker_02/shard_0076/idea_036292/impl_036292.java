...
@Data
public class Idea36292Config {
    private String name = "idea_036292";
 ...
 */
@Slf4j
public class Idea36292Service {
    private static final int IDEA_ID = 36292;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36292Service() {
        this(new Idea36292Config());
    }

    public Idea36292Service(Idea36292Config config) {
        this.config = config != null ? config : new Idea36292Config();
