...
@Data
public class Idea36218Config {
    private String name = "idea_036218";
 ...
 */
@Slf4j
public class Idea36218Service {
    private static final int IDEA_ID = 36218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36218Service() {
        this(new Idea36218Config());
    }

    public Idea36218Service(Idea36218Config config) {
        this.config = config != null ? config : new Idea36218Config();
