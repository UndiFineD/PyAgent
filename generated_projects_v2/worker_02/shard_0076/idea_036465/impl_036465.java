...
@Data
public class Idea36465Config {
    private String name = "idea_036465";
 ...
 */
@Slf4j
public class Idea36465Service {
    private static final int IDEA_ID = 36465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36465Service() {
        this(new Idea36465Config());
    }

    public Idea36465Service(Idea36465Config config) {
        this.config = config != null ? config : new Idea36465Config();
