...
@Data
public class Idea36536Config {
    private String name = "idea_036536";
 ...
 */
@Slf4j
public class Idea36536Service {
    private static final int IDEA_ID = 36536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36536Service() {
        this(new Idea36536Config());
    }

    public Idea36536Service(Idea36536Config config) {
        this.config = config != null ? config : new Idea36536Config();
