...
@Data
public class Idea36274Config {
    private String name = "idea_036274";
 ...
 */
@Slf4j
public class Idea36274Service {
    private static final int IDEA_ID = 36274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36274Service() {
        this(new Idea36274Config());
    }

    public Idea36274Service(Idea36274Config config) {
        this.config = config != null ? config : new Idea36274Config();
