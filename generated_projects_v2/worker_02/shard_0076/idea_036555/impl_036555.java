...
@Data
public class Idea36555Config {
    private String name = "idea_036555";
 ...
 */
@Slf4j
public class Idea36555Service {
    private static final int IDEA_ID = 36555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36555Service() {
        this(new Idea36555Config());
    }

    public Idea36555Service(Idea36555Config config) {
        this.config = config != null ? config : new Idea36555Config();
