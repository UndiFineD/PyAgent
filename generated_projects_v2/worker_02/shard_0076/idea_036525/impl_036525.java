...
@Data
public class Idea36525Config {
    private String name = "idea_036525";
 ...
 */
@Slf4j
public class Idea36525Service {
    private static final int IDEA_ID = 36525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36525Service() {
        this(new Idea36525Config());
    }

    public Idea36525Service(Idea36525Config config) {
        this.config = config != null ? config : new Idea36525Config();
