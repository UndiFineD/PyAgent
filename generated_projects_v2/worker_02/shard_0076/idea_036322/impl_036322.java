...
@Data
public class Idea36322Config {
    private String name = "idea_036322";
 ...
 */
@Slf4j
public class Idea36322Service {
    private static final int IDEA_ID = 36322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36322Service() {
        this(new Idea36322Config());
    }

    public Idea36322Service(Idea36322Config config) {
        this.config = config != null ? config : new Idea36322Config();
