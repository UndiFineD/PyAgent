...
@Data
public class Idea36531Config {
    private String name = "idea_036531";
 ...
 */
@Slf4j
public class Idea36531Service {
    private static final int IDEA_ID = 36531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36531Service() {
        this(new Idea36531Config());
    }

    public Idea36531Service(Idea36531Config config) {
        this.config = config != null ? config : new Idea36531Config();
