...
@Data
public class Idea36238Config {
    private String name = "idea_036238";
 ...
 */
@Slf4j
public class Idea36238Service {
    private static final int IDEA_ID = 36238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36238Service() {
        this(new Idea36238Config());
    }

    public Idea36238Service(Idea36238Config config) {
        this.config = config != null ? config : new Idea36238Config();
