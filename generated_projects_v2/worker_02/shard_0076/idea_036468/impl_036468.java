...
@Data
public class Idea36468Config {
    private String name = "idea_036468";
 ...
 */
@Slf4j
public class Idea36468Service {
    private static final int IDEA_ID = 36468;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36468Service() {
        this(new Idea36468Config());
    }

    public Idea36468Service(Idea36468Config config) {
        this.config = config != null ? config : new Idea36468Config();
