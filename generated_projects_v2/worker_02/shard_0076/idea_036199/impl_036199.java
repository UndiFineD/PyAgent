...
@Data
public class Idea36199Config {
    private String name = "idea_036199";
 ...
 */
@Slf4j
public class Idea36199Service {
    private static final int IDEA_ID = 36199;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36199Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36199Service() {
        this(new Idea36199Config());
    }

    public Idea36199Service(Idea36199Config config) {
        this.config = config != null ? config : new Idea36199Config();
