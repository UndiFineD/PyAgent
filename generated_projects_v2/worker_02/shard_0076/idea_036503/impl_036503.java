...
@Data
public class Idea36503Config {
    private String name = "idea_036503";
 ...
 */
@Slf4j
public class Idea36503Service {
    private static final int IDEA_ID = 36503;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36503Service() {
        this(new Idea36503Config());
    }

    public Idea36503Service(Idea36503Config config) {
        this.config = config != null ? config : new Idea36503Config();
