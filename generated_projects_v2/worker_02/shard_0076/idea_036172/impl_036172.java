...
@Data
public class Idea36172Config {
    private String name = "idea_036172";
 ...
 */
@Slf4j
public class Idea36172Service {
    private static final int IDEA_ID = 36172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36172Service() {
        this(new Idea36172Config());
    }

    public Idea36172Service(Idea36172Config config) {
        this.config = config != null ? config : new Idea36172Config();
