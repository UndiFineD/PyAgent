...
@Data
public class Idea36245Config {
    private String name = "idea_036245";
 ...
 */
@Slf4j
public class Idea36245Service {
    private static final int IDEA_ID = 36245;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36245Service() {
        this(new Idea36245Config());
    }

    public Idea36245Service(Idea36245Config config) {
        this.config = config != null ? config : new Idea36245Config();
