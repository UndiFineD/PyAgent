...
@Data
public class Idea36561Config {
    private String name = "idea_036561";
 ...
 */
@Slf4j
public class Idea36561Service {
    private static final int IDEA_ID = 36561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36561Service() {
        this(new Idea36561Config());
    }

    public Idea36561Service(Idea36561Config config) {
        this.config = config != null ? config : new Idea36561Config();
