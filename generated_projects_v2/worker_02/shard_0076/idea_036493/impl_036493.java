...
@Data
public class Idea36493Config {
    private String name = "idea_036493";
 ...
 */
@Slf4j
public class Idea36493Service {
    private static final int IDEA_ID = 36493;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36493Service() {
        this(new Idea36493Config());
    }

    public Idea36493Service(Idea36493Config config) {
        this.config = config != null ? config : new Idea36493Config();
