...
@Data
public class Idea36395Config {
    private String name = "idea_036395";
 ...
 */
@Slf4j
public class Idea36395Service {
    private static final int IDEA_ID = 36395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36395Service() {
        this(new Idea36395Config());
    }

    public Idea36395Service(Idea36395Config config) {
        this.config = config != null ? config : new Idea36395Config();
