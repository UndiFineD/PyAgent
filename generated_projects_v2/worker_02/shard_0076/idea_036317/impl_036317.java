...
@Data
public class Idea36317Config {
    private String name = "idea_036317";
 ...
 */
@Slf4j
public class Idea36317Service {
    private static final int IDEA_ID = 36317;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36317Service() {
        this(new Idea36317Config());
    }

    public Idea36317Service(Idea36317Config config) {
        this.config = config != null ? config : new Idea36317Config();
