...
@Data
public class Idea36554Config {
    private String name = "idea_036554";
 ...
 */
@Slf4j
public class Idea36554Service {
    private static final int IDEA_ID = 36554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36554Service() {
        this(new Idea36554Config());
    }

    public Idea36554Service(Idea36554Config config) {
        this.config = config != null ? config : new Idea36554Config();
