...
@Data
public class Idea36289Config {
    private String name = "idea_036289";
 ...
 */
@Slf4j
public class Idea36289Service {
    private static final int IDEA_ID = 36289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36289Service() {
        this(new Idea36289Config());
    }

    public Idea36289Service(Idea36289Config config) {
        this.config = config != null ? config : new Idea36289Config();
