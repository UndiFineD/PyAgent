...
@Data
public class Idea36373Config {
    private String name = "idea_036373";
 ...
 */
@Slf4j
public class Idea36373Service {
    private static final int IDEA_ID = 36373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36373Service() {
        this(new Idea36373Config());
    }

    public Idea36373Service(Idea36373Config config) {
        this.config = config != null ? config : new Idea36373Config();
