...
@Data
public class Idea36333Config {
    private String name = "idea_036333";
 ...
 */
@Slf4j
public class Idea36333Service {
    private static final int IDEA_ID = 36333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36333Service() {
        this(new Idea36333Config());
    }

    public Idea36333Service(Idea36333Config config) {
        this.config = config != null ? config : new Idea36333Config();
