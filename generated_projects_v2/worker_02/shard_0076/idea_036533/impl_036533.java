...
@Data
public class Idea36533Config {
    private String name = "idea_036533";
 ...
 */
@Slf4j
public class Idea36533Service {
    private static final int IDEA_ID = 36533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36533Service() {
        this(new Idea36533Config());
    }

    public Idea36533Service(Idea36533Config config) {
        this.config = config != null ? config : new Idea36533Config();
