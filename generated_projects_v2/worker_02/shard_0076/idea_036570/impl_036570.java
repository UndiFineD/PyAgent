...
@Data
public class Idea36570Config {
    private String name = "idea_036570";
 ...
 */
@Slf4j
public class Idea36570Service {
    private static final int IDEA_ID = 36570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36570Service() {
        this(new Idea36570Config());
    }

    public Idea36570Service(Idea36570Config config) {
        this.config = config != null ? config : new Idea36570Config();
