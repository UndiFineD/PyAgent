...
@Data
public class Idea36282Config {
    private String name = "idea_036282";
 ...
 */
@Slf4j
public class Idea36282Service {
    private static final int IDEA_ID = 36282;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36282Service() {
        this(new Idea36282Config());
    }

    public Idea36282Service(Idea36282Config config) {
        this.config = config != null ? config : new Idea36282Config();
