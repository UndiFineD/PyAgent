...
@Data
public class Idea36425Config {
    private String name = "idea_036425";
 ...
 */
@Slf4j
public class Idea36425Service {
    private static final int IDEA_ID = 36425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36425Service() {
        this(new Idea36425Config());
    }

    public Idea36425Service(Idea36425Config config) {
        this.config = config != null ? config : new Idea36425Config();
