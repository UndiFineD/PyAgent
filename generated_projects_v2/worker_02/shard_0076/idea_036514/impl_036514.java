...
@Data
public class Idea36514Config {
    private String name = "idea_036514";
 ...
 */
@Slf4j
public class Idea36514Service {
    private static final int IDEA_ID = 36514;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36514Service() {
        this(new Idea36514Config());
    }

    public Idea36514Service(Idea36514Config config) {
        this.config = config != null ? config : new Idea36514Config();
