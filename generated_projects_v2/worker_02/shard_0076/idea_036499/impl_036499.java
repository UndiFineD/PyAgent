...
@Data
public class Idea36499Config {
    private String name = "idea_036499";
 ...
 */
@Slf4j
public class Idea36499Service {
    private static final int IDEA_ID = 36499;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36499Service() {
        this(new Idea36499Config());
    }

    public Idea36499Service(Idea36499Config config) {
        this.config = config != null ? config : new Idea36499Config();
