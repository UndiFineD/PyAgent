...
@Data
public class Idea36542Config {
    private String name = "idea_036542";
 ...
 */
@Slf4j
public class Idea36542Service {
    private static final int IDEA_ID = 36542;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36542Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36542Service() {
        this(new Idea36542Config());
    }

    public Idea36542Service(Idea36542Config config) {
        this.config = config != null ? config : new Idea36542Config();
