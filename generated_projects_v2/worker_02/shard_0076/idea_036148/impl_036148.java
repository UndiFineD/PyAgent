...
@Data
public class Idea36148Config {
    private String name = "idea_036148";
 ...
 */
@Slf4j
public class Idea36148Service {
    private static final int IDEA_ID = 36148;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36148Service() {
        this(new Idea36148Config());
    }

    public Idea36148Service(Idea36148Config config) {
        this.config = config != null ? config : new Idea36148Config();
