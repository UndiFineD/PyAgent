...
@Data
public class Idea36127Config {
    private String name = "idea_036127";
 ...
 */
@Slf4j
public class Idea36127Service {
    private static final int IDEA_ID = 36127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36127Service() {
        this(new Idea36127Config());
    }

    public Idea36127Service(Idea36127Config config) {
        this.config = config != null ? config : new Idea36127Config();
