...
@Data
public class Idea36390Config {
    private String name = "idea_036390";
 ...
 */
@Slf4j
public class Idea36390Service {
    private static final int IDEA_ID = 36390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36390Service() {
        this(new Idea36390Config());
    }

    public Idea36390Service(Idea36390Config config) {
        this.config = config != null ? config : new Idea36390Config();
