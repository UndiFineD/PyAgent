...
@Data
public class Idea36220Config {
    private String name = "idea_036220";
 ...
 */
@Slf4j
public class Idea36220Service {
    private static final int IDEA_ID = 36220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36220Service() {
        this(new Idea36220Config());
    }

    public Idea36220Service(Idea36220Config config) {
        this.config = config != null ? config : new Idea36220Config();
