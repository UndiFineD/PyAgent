...
@Data
public class Idea36210Config {
    private String name = "idea_036210";
 ...
 */
@Slf4j
public class Idea36210Service {
    private static final int IDEA_ID = 36210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36210Service() {
        this(new Idea36210Config());
    }

    public Idea36210Service(Idea36210Config config) {
        this.config = config != null ? config : new Idea36210Config();
