...
@Data
public class Idea36133Config {
    private String name = "idea_036133";
 ...
 */
@Slf4j
public class Idea36133Service {
    private static final int IDEA_ID = 36133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36133Service() {
        this(new Idea36133Config());
    }

    public Idea36133Service(Idea36133Config config) {
        this.config = config != null ? config : new Idea36133Config();
