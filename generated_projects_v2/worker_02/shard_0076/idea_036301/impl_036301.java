...
@Data
public class Idea36301Config {
    private String name = "idea_036301";
 ...
 */
@Slf4j
public class Idea36301Service {
    private static final int IDEA_ID = 36301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36301Service() {
        this(new Idea36301Config());
    }

    public Idea36301Service(Idea36301Config config) {
        this.config = config != null ? config : new Idea36301Config();
