...
@Data
public class Idea36198Config {
    private String name = "idea_036198";
 ...
 */
@Slf4j
public class Idea36198Service {
    private static final int IDEA_ID = 36198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36198Service() {
        this(new Idea36198Config());
    }

    public Idea36198Service(Idea36198Config config) {
        this.config = config != null ? config : new Idea36198Config();
