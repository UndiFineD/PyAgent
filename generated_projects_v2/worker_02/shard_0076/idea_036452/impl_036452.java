...
@Data
public class Idea36452Config {
    private String name = "idea_036452";
 ...
 */
@Slf4j
public class Idea36452Service {
    private static final int IDEA_ID = 36452;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36452Service() {
        this(new Idea36452Config());
    }

    public Idea36452Service(Idea36452Config config) {
        this.config = config != null ? config : new Idea36452Config();
