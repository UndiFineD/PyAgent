...
@Data
public class Idea36180Config {
    private String name = "idea_036180";
 ...
 */
@Slf4j
public class Idea36180Service {
    private static final int IDEA_ID = 36180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36180Service() {
        this(new Idea36180Config());
    }

    public Idea36180Service(Idea36180Config config) {
        this.config = config != null ? config : new Idea36180Config();
