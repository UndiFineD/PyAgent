...
@Data
public class Idea36140Config {
    private String name = "idea_036140";
 ...
 */
@Slf4j
public class Idea36140Service {
    private static final int IDEA_ID = 36140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36140Service() {
        this(new Idea36140Config());
    }

    public Idea36140Service(Idea36140Config config) {
        this.config = config != null ? config : new Idea36140Config();
