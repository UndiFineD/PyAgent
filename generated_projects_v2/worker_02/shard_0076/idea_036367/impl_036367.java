...
@Data
public class Idea36367Config {
    private String name = "idea_036367";
 ...
 */
@Slf4j
public class Idea36367Service {
    private static final int IDEA_ID = 36367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36367Service() {
        this(new Idea36367Config());
    }

    public Idea36367Service(Idea36367Config config) {
        this.config = config != null ? config : new Idea36367Config();
