...
@Data
public class Idea36504Config {
    private String name = "idea_036504";
 ...
 */
@Slf4j
public class Idea36504Service {
    private static final int IDEA_ID = 36504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36504Service() {
        this(new Idea36504Config());
    }

    public Idea36504Service(Idea36504Config config) {
        this.config = config != null ? config : new Idea36504Config();
