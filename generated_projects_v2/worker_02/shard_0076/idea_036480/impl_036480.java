...
@Data
public class Idea36480Config {
    private String name = "idea_036480";
 ...
 */
@Slf4j
public class Idea36480Service {
    private static final int IDEA_ID = 36480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36480Service() {
        this(new Idea36480Config());
    }

    public Idea36480Service(Idea36480Config config) {
        this.config = config != null ? config : new Idea36480Config();
