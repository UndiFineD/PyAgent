...
@Data
public class Idea36421Config {
    private String name = "idea_036421";
 ...
 */
@Slf4j
public class Idea36421Service {
    private static final int IDEA_ID = 36421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36421Service() {
        this(new Idea36421Config());
    }

    public Idea36421Service(Idea36421Config config) {
        this.config = config != null ? config : new Idea36421Config();
