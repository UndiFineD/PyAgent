...
@Data
public class Idea36430Config {
    private String name = "idea_036430";
 ...
 */
@Slf4j
public class Idea36430Service {
    private static final int IDEA_ID = 36430;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36430Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36430Service() {
        this(new Idea36430Config());
    }

    public Idea36430Service(Idea36430Config config) {
        this.config = config != null ? config : new Idea36430Config();
