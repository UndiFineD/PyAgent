...
@Data
public class Idea36232Config {
    private String name = "idea_036232";
 ...
 */
@Slf4j
public class Idea36232Service {
    private static final int IDEA_ID = 36232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36232Service() {
        this(new Idea36232Config());
    }

    public Idea36232Service(Idea36232Config config) {
        this.config = config != null ? config : new Idea36232Config();
