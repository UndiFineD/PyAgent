...
@Data
public class Idea36454Config {
    private String name = "idea_036454";
 ...
 */
@Slf4j
public class Idea36454Service {
    private static final int IDEA_ID = 36454;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36454Service() {
        this(new Idea36454Config());
    }

    public Idea36454Service(Idea36454Config config) {
        this.config = config != null ? config : new Idea36454Config();
