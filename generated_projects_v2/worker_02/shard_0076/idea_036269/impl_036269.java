...
@Data
public class Idea36269Config {
    private String name = "idea_036269";
 ...
 */
@Slf4j
public class Idea36269Service {
    private static final int IDEA_ID = 36269;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36269Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36269Service() {
        this(new Idea36269Config());
    }

    public Idea36269Service(Idea36269Config config) {
        this.config = config != null ? config : new Idea36269Config();
