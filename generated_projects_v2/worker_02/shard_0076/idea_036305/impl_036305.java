...
@Data
public class Idea36305Config {
    private String name = "idea_036305";
 ...
 */
@Slf4j
public class Idea36305Service {
    private static final int IDEA_ID = 36305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36305Service() {
        this(new Idea36305Config());
    }

    public Idea36305Service(Idea36305Config config) {
        this.config = config != null ? config : new Idea36305Config();
