...
@Data
public class Idea36358Config {
    private String name = "idea_036358";
 ...
 */
@Slf4j
public class Idea36358Service {
    private static final int IDEA_ID = 36358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36358Service() {
        this(new Idea36358Config());
    }

    public Idea36358Service(Idea36358Config config) {
        this.config = config != null ? config : new Idea36358Config();
