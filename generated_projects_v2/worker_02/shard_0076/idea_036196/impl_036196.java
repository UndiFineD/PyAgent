...
@Data
public class Idea36196Config {
    private String name = "idea_036196";
 ...
 */
@Slf4j
public class Idea36196Service {
    private static final int IDEA_ID = 36196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36196Service() {
        this(new Idea36196Config());
    }

    public Idea36196Service(Idea36196Config config) {
        this.config = config != null ? config : new Idea36196Config();
