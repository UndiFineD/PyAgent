...
@Data
public class Idea36434Config {
    private String name = "idea_036434";
 ...
 */
@Slf4j
public class Idea36434Service {
    private static final int IDEA_ID = 36434;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36434Service() {
        this(new Idea36434Config());
    }

    public Idea36434Service(Idea36434Config config) {
        this.config = config != null ? config : new Idea36434Config();
