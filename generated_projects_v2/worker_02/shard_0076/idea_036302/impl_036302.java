...
@Data
public class Idea36302Config {
    private String name = "idea_036302";
 ...
 */
@Slf4j
public class Idea36302Service {
    private static final int IDEA_ID = 36302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36302Service() {
        this(new Idea36302Config());
    }

    public Idea36302Service(Idea36302Config config) {
        this.config = config != null ? config : new Idea36302Config();
