...
@Data
public class Idea36168Config {
    private String name = "idea_036168";
 ...
 */
@Slf4j
public class Idea36168Service {
    private static final int IDEA_ID = 36168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36168Service() {
        this(new Idea36168Config());
    }

    public Idea36168Service(Idea36168Config config) {
        this.config = config != null ? config : new Idea36168Config();
