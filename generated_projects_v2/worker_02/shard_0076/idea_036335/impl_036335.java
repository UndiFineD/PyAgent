...
@Data
public class Idea36335Config {
    private String name = "idea_036335";
 ...
 */
@Slf4j
public class Idea36335Service {
    private static final int IDEA_ID = 36335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36335Service() {
        this(new Idea36335Config());
    }

    public Idea36335Service(Idea36335Config config) {
        this.config = config != null ? config : new Idea36335Config();
