...
@Data
public class Idea36206Config {
    private String name = "idea_036206";
 ...
 */
@Slf4j
public class Idea36206Service {
    private static final int IDEA_ID = 36206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36206Service() {
        this(new Idea36206Config());
    }

    public Idea36206Service(Idea36206Config config) {
        this.config = config != null ? config : new Idea36206Config();
