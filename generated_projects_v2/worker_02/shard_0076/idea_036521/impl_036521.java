...
@Data
public class Idea36521Config {
    private String name = "idea_036521";
 ...
 */
@Slf4j
public class Idea36521Service {
    private static final int IDEA_ID = 36521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36521Service() {
        this(new Idea36521Config());
    }

    public Idea36521Service(Idea36521Config config) {
        this.config = config != null ? config : new Idea36521Config();
