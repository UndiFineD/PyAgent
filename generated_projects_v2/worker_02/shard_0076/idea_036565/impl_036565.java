...
@Data
public class Idea36565Config {
    private String name = "idea_036565";
 ...
 */
@Slf4j
public class Idea36565Service {
    private static final int IDEA_ID = 36565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36565Service() {
        this(new Idea36565Config());
    }

    public Idea36565Service(Idea36565Config config) {
        this.config = config != null ? config : new Idea36565Config();
