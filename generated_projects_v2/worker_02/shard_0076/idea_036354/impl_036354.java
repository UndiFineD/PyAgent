...
@Data
public class Idea36354Config {
    private String name = "idea_036354";
 ...
 */
@Slf4j
public class Idea36354Service {
    private static final int IDEA_ID = 36354;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36354Service() {
        this(new Idea36354Config());
    }

    public Idea36354Service(Idea36354Config config) {
        this.config = config != null ? config : new Idea36354Config();
