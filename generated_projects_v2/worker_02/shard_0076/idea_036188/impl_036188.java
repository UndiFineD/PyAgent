...
@Data
public class Idea36188Config {
    private String name = "idea_036188";
 ...
 */
@Slf4j
public class Idea36188Service {
    private static final int IDEA_ID = 36188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36188Service() {
        this(new Idea36188Config());
    }

    public Idea36188Service(Idea36188Config config) {
        this.config = config != null ? config : new Idea36188Config();
