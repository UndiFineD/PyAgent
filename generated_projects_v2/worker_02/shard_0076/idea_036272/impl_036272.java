...
@Data
public class Idea36272Config {
    private String name = "idea_036272";
 ...
 */
@Slf4j
public class Idea36272Service {
    private static final int IDEA_ID = 36272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36272Service() {
        this(new Idea36272Config());
    }

    public Idea36272Service(Idea36272Config config) {
        this.config = config != null ? config : new Idea36272Config();
