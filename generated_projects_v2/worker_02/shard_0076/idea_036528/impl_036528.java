...
@Data
public class Idea36528Config {
    private String name = "idea_036528";
 ...
 */
@Slf4j
public class Idea36528Service {
    private static final int IDEA_ID = 36528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36528Service() {
        this(new Idea36528Config());
    }

    public Idea36528Service(Idea36528Config config) {
        this.config = config != null ? config : new Idea36528Config();
