...
@Data
public class Idea36225Config {
    private String name = "idea_036225";
 ...
 */
@Slf4j
public class Idea36225Service {
    private static final int IDEA_ID = 36225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36225Service() {
        this(new Idea36225Config());
    }

    public Idea36225Service(Idea36225Config config) {
        this.config = config != null ? config : new Idea36225Config();
