...
@Data
public class Idea36388Config {
    private String name = "idea_036388";
 ...
 */
@Slf4j
public class Idea36388Service {
    private static final int IDEA_ID = 36388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36388Service() {
        this(new Idea36388Config());
    }

    public Idea36388Service(Idea36388Config config) {
        this.config = config != null ? config : new Idea36388Config();
