...
@Data
public class Idea36415Config {
    private String name = "idea_036415";
 ...
 */
@Slf4j
public class Idea36415Service {
    private static final int IDEA_ID = 36415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36415Service() {
        this(new Idea36415Config());
    }

    public Idea36415Service(Idea36415Config config) {
        this.config = config != null ? config : new Idea36415Config();
