...
@Data
public class Idea36376Config {
    private String name = "idea_036376";
 ...
 */
@Slf4j
public class Idea36376Service {
    private static final int IDEA_ID = 36376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36376Service() {
        this(new Idea36376Config());
    }

    public Idea36376Service(Idea36376Config config) {
        this.config = config != null ? config : new Idea36376Config();
