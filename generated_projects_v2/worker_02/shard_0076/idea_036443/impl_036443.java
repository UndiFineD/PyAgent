...
@Data
public class Idea36443Config {
    private String name = "idea_036443";
 ...
 */
@Slf4j
public class Idea36443Service {
    private static final int IDEA_ID = 36443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36443Service() {
        this(new Idea36443Config());
    }

    public Idea36443Service(Idea36443Config config) {
        this.config = config != null ? config : new Idea36443Config();
