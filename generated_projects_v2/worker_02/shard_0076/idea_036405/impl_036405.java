...
@Data
public class Idea36405Config {
    private String name = "idea_036405";
 ...
 */
@Slf4j
public class Idea36405Service {
    private static final int IDEA_ID = 36405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36405Service() {
        this(new Idea36405Config());
    }

    public Idea36405Service(Idea36405Config config) {
        this.config = config != null ? config : new Idea36405Config();
