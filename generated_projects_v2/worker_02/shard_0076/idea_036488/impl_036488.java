...
@Data
public class Idea36488Config {
    private String name = "idea_036488";
 ...
 */
@Slf4j
public class Idea36488Service {
    private static final int IDEA_ID = 36488;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36488Service() {
        this(new Idea36488Config());
    }

    public Idea36488Service(Idea36488Config config) {
        this.config = config != null ? config : new Idea36488Config();
