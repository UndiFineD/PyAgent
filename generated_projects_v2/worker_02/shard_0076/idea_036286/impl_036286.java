...
@Data
public class Idea36286Config {
    private String name = "idea_036286";
 ...
 */
@Slf4j
public class Idea36286Service {
    private static final int IDEA_ID = 36286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36286Service() {
        this(new Idea36286Config());
    }

    public Idea36286Service(Idea36286Config config) {
        this.config = config != null ? config : new Idea36286Config();
