...
@Data
public class Idea36491Config {
    private String name = "idea_036491";
 ...
 */
@Slf4j
public class Idea36491Service {
    private static final int IDEA_ID = 36491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36491Service() {
        this(new Idea36491Config());
    }

    public Idea36491Service(Idea36491Config config) {
        this.config = config != null ? config : new Idea36491Config();
