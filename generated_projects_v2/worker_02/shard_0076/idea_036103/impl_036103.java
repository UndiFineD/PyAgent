...
@Data
public class Idea36103Config {
    private String name = "idea_036103";
 ...
 */
@Slf4j
public class Idea36103Service {
    private static final int IDEA_ID = 36103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36103Service() {
        this(new Idea36103Config());
    }

    public Idea36103Service(Idea36103Config config) {
        this.config = config != null ? config : new Idea36103Config();
