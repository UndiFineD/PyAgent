...
@Data
public class Idea36156Config {
    private String name = "idea_036156";
 ...
 */
@Slf4j
public class Idea36156Service {
    private static final int IDEA_ID = 36156;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36156Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36156Service() {
        this(new Idea36156Config());
    }

    public Idea36156Service(Idea36156Config config) {
        this.config = config != null ? config : new Idea36156Config();
