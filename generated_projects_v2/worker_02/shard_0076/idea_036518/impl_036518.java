...
@Data
public class Idea36518Config {
    private String name = "idea_036518";
 ...
 */
@Slf4j
public class Idea36518Service {
    private static final int IDEA_ID = 36518;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36518Service() {
        this(new Idea36518Config());
    }

    public Idea36518Service(Idea36518Config config) {
        this.config = config != null ? config : new Idea36518Config();
