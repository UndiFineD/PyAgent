...
@Data
public class Idea36224Config {
    private String name = "idea_036224";
 ...
 */
@Slf4j
public class Idea36224Service {
    private static final int IDEA_ID = 36224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36224Service() {
        this(new Idea36224Config());
    }

    public Idea36224Service(Idea36224Config config) {
        this.config = config != null ? config : new Idea36224Config();
