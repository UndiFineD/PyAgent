...
@Data
public class Idea36472Config {
    private String name = "idea_036472";
 ...
 */
@Slf4j
public class Idea36472Service {
    private static final int IDEA_ID = 36472;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36472Service() {
        this(new Idea36472Config());
    }

    public Idea36472Service(Idea36472Config config) {
        this.config = config != null ? config : new Idea36472Config();
