...
@Data
public class Idea36389Config {
    private String name = "idea_036389";
 ...
 */
@Slf4j
public class Idea36389Service {
    private static final int IDEA_ID = 36389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36389Service() {
        this(new Idea36389Config());
    }

    public Idea36389Service(Idea36389Config config) {
        this.config = config != null ? config : new Idea36389Config();
