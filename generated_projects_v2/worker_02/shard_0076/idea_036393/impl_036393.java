...
@Data
public class Idea36393Config {
    private String name = "idea_036393";
 ...
 */
@Slf4j
public class Idea36393Service {
    private static final int IDEA_ID = 36393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36393Service() {
        this(new Idea36393Config());
    }

    public Idea36393Service(Idea36393Config config) {
        this.config = config != null ? config : new Idea36393Config();
