...
@Data
public class Idea36400Config {
    private String name = "idea_036400";
 ...
 */
@Slf4j
public class Idea36400Service {
    private static final int IDEA_ID = 36400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36400Service() {
        this(new Idea36400Config());
    }

    public Idea36400Service(Idea36400Config config) {
        this.config = config != null ? config : new Idea36400Config();
