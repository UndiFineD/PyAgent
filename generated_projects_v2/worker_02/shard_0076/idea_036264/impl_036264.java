...
@Data
public class Idea36264Config {
    private String name = "idea_036264";
 ...
 */
@Slf4j
public class Idea36264Service {
    private static final int IDEA_ID = 36264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36264Service() {
        this(new Idea36264Config());
    }

    public Idea36264Service(Idea36264Config config) {
        this.config = config != null ? config : new Idea36264Config();
