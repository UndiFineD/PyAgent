...
@Data
public class Idea36308Config {
    private String name = "idea_036308";
 ...
 */
@Slf4j
public class Idea36308Service {
    private static final int IDEA_ID = 36308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36308Service() {
        this(new Idea36308Config());
    }

    public Idea36308Service(Idea36308Config config) {
        this.config = config != null ? config : new Idea36308Config();
