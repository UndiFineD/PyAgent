...
@Data
public class Idea36471Config {
    private String name = "idea_036471";
 ...
 */
@Slf4j
public class Idea36471Service {
    private static final int IDEA_ID = 36471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36471Service() {
        this(new Idea36471Config());
    }

    public Idea36471Service(Idea36471Config config) {
        this.config = config != null ? config : new Idea36471Config();
