...
@Data
public class Idea36320Config {
    private String name = "idea_036320";
 ...
 */
@Slf4j
public class Idea36320Service {
    private static final int IDEA_ID = 36320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36320Service() {
        this(new Idea36320Config());
    }

    public Idea36320Service(Idea36320Config config) {
        this.config = config != null ? config : new Idea36320Config();
