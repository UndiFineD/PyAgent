...
@Data
public class Idea36223Config {
    private String name = "idea_036223";
 ...
 */
@Slf4j
public class Idea36223Service {
    private static final int IDEA_ID = 36223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36223Service() {
        this(new Idea36223Config());
    }

    public Idea36223Service(Idea36223Config config) {
        this.config = config != null ? config : new Idea36223Config();
