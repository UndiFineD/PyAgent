...
@Data
public class Idea36249Config {
    private String name = "idea_036249";
 ...
 */
@Slf4j
public class Idea36249Service {
    private static final int IDEA_ID = 36249;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36249Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36249Service() {
        this(new Idea36249Config());
    }

    public Idea36249Service(Idea36249Config config) {
        this.config = config != null ? config : new Idea36249Config();
