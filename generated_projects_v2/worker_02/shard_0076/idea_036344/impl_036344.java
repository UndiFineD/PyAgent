...
@Data
public class Idea36344Config {
    private String name = "idea_036344";
 ...
 */
@Slf4j
public class Idea36344Service {
    private static final int IDEA_ID = 36344;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36344Service() {
        this(new Idea36344Config());
    }

    public Idea36344Service(Idea36344Config config) {
        this.config = config != null ? config : new Idea36344Config();
