...
@Data
public class Idea36427Config {
    private String name = "idea_036427";
 ...
 */
@Slf4j
public class Idea36427Service {
    private static final int IDEA_ID = 36427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36427Service() {
        this(new Idea36427Config());
    }

    public Idea36427Service(Idea36427Config config) {
        this.config = config != null ? config : new Idea36427Config();
