...
@Data
public class Idea36283Config {
    private String name = "idea_036283";
 ...
 */
@Slf4j
public class Idea36283Service {
    private static final int IDEA_ID = 36283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36283Service() {
        this(new Idea36283Config());
    }

    public Idea36283Service(Idea36283Config config) {
        this.config = config != null ? config : new Idea36283Config();
