...
@Data
public class Idea36523Config {
    private String name = "idea_036523";
 ...
 */
@Slf4j
public class Idea36523Service {
    private static final int IDEA_ID = 36523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36523Service() {
        this(new Idea36523Config());
    }

    public Idea36523Service(Idea36523Config config) {
        this.config = config != null ? config : new Idea36523Config();
