...
@Data
public class Idea36424Config {
    private String name = "idea_036424";
 ...
 */
@Slf4j
public class Idea36424Service {
    private static final int IDEA_ID = 36424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36424Service() {
        this(new Idea36424Config());
    }

    public Idea36424Service(Idea36424Config config) {
        this.config = config != null ? config : new Idea36424Config();
