...
@Data
public class Idea36508Config {
    private String name = "idea_036508";
 ...
 */
@Slf4j
public class Idea36508Service {
    private static final int IDEA_ID = 36508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36508Service() {
        this(new Idea36508Config());
    }

    public Idea36508Service(Idea36508Config config) {
        this.config = config != null ? config : new Idea36508Config();
