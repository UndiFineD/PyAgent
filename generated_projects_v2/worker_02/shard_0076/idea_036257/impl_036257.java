...
@Data
public class Idea36257Config {
    private String name = "idea_036257";
 ...
 */
@Slf4j
public class Idea36257Service {
    private static final int IDEA_ID = 36257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36257Service() {
        this(new Idea36257Config());
    }

    public Idea36257Service(Idea36257Config config) {
        this.config = config != null ? config : new Idea36257Config();
