...
@Data
public class Idea36361Config {
    private String name = "idea_036361";
 ...
 */
@Slf4j
public class Idea36361Service {
    private static final int IDEA_ID = 36361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36361Service() {
        this(new Idea36361Config());
    }

    public Idea36361Service(Idea36361Config config) {
        this.config = config != null ? config : new Idea36361Config();
