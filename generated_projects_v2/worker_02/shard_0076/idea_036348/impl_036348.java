...
@Data
public class Idea36348Config {
    private String name = "idea_036348";
 ...
 */
@Slf4j
public class Idea36348Service {
    private static final int IDEA_ID = 36348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36348Service() {
        this(new Idea36348Config());
    }

    public Idea36348Service(Idea36348Config config) {
        this.config = config != null ? config : new Idea36348Config();
