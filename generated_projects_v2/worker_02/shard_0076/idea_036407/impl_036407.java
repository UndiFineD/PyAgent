...
@Data
public class Idea36407Config {
    private String name = "idea_036407";
 ...
 */
@Slf4j
public class Idea36407Service {
    private static final int IDEA_ID = 36407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36407Service() {
        this(new Idea36407Config());
    }

    public Idea36407Service(Idea36407Config config) {
        this.config = config != null ? config : new Idea36407Config();
