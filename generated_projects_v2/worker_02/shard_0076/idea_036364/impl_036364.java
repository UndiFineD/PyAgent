...
@Data
public class Idea36364Config {
    private String name = "idea_036364";
 ...
 */
@Slf4j
public class Idea36364Service {
    private static final int IDEA_ID = 36364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36364Service() {
        this(new Idea36364Config());
    }

    public Idea36364Service(Idea36364Config config) {
        this.config = config != null ? config : new Idea36364Config();
