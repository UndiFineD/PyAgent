...
@Data
public class Idea36410Config {
    private String name = "idea_036410";
 ...
 */
@Slf4j
public class Idea36410Service {
    private static final int IDEA_ID = 36410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36410Service() {
        this(new Idea36410Config());
    }

    public Idea36410Service(Idea36410Config config) {
        this.config = config != null ? config : new Idea36410Config();
