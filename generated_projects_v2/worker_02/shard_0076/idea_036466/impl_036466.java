...
@Data
public class Idea36466Config {
    private String name = "idea_036466";
 ...
 */
@Slf4j
public class Idea36466Service {
    private static final int IDEA_ID = 36466;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36466Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36466Service() {
        this(new Idea36466Config());
    }

    public Idea36466Service(Idea36466Config config) {
        this.config = config != null ? config : new Idea36466Config();
