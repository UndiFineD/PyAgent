...
@Data
public class Idea36215Config {
    private String name = "idea_036215";
 ...
 */
@Slf4j
public class Idea36215Service {
    private static final int IDEA_ID = 36215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36215Service() {
        this(new Idea36215Config());
    }

    public Idea36215Service(Idea36215Config config) {
        this.config = config != null ? config : new Idea36215Config();
