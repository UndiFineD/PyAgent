...
@Data
public class Idea36330Config {
    private String name = "idea_036330";
 ...
 */
@Slf4j
public class Idea36330Service {
    private static final int IDEA_ID = 36330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36330Service() {
        this(new Idea36330Config());
    }

    public Idea36330Service(Idea36330Config config) {
        this.config = config != null ? config : new Idea36330Config();
