...
@Data
public class Idea36446Config {
    private String name = "idea_036446";
 ...
 */
@Slf4j
public class Idea36446Service {
    private static final int IDEA_ID = 36446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36446Service() {
        this(new Idea36446Config());
    }

    public Idea36446Service(Idea36446Config config) {
        this.config = config != null ? config : new Idea36446Config();
