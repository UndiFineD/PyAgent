...
@Data
public class Idea36326Config {
    private String name = "idea_036326";
 ...
 */
@Slf4j
public class Idea36326Service {
    private static final int IDEA_ID = 36326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36326Service() {
        this(new Idea36326Config());
    }

    public Idea36326Service(Idea36326Config config) {
        this.config = config != null ? config : new Idea36326Config();
