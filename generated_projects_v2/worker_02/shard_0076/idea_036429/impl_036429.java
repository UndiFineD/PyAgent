...
@Data
public class Idea36429Config {
    private String name = "idea_036429";
 ...
 */
@Slf4j
public class Idea36429Service {
    private static final int IDEA_ID = 36429;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36429Service() {
        this(new Idea36429Config());
    }

    public Idea36429Service(Idea36429Config config) {
        this.config = config != null ? config : new Idea36429Config();
