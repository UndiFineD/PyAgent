...
@Data
public class Idea36355Config {
    private String name = "idea_036355";
 ...
 */
@Slf4j
public class Idea36355Service {
    private static final int IDEA_ID = 36355;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36355Service() {
        this(new Idea36355Config());
    }

    public Idea36355Service(Idea36355Config config) {
        this.config = config != null ? config : new Idea36355Config();
