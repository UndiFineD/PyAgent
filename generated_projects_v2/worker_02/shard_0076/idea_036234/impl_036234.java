...
@Data
public class Idea36234Config {
    private String name = "idea_036234";
 ...
 */
@Slf4j
public class Idea36234Service {
    private static final int IDEA_ID = 36234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36234Service() {
        this(new Idea36234Config());
    }

    public Idea36234Service(Idea36234Config config) {
        this.config = config != null ? config : new Idea36234Config();
