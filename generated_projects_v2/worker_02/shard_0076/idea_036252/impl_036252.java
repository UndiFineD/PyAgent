...
@Data
public class Idea36252Config {
    private String name = "idea_036252";
 ...
 */
@Slf4j
public class Idea36252Service {
    private static final int IDEA_ID = 36252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36252Service() {
        this(new Idea36252Config());
    }

    public Idea36252Service(Idea36252Config config) {
        this.config = config != null ? config : new Idea36252Config();
