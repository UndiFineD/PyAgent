...
@Data
public class Idea36398Config {
    private String name = "idea_036398";
 ...
 */
@Slf4j
public class Idea36398Service {
    private static final int IDEA_ID = 36398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36398Service() {
        this(new Idea36398Config());
    }

    public Idea36398Service(Idea36398Config config) {
        this.config = config != null ? config : new Idea36398Config();
