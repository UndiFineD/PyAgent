...
@Data
public class Idea36460Config {
    private String name = "idea_036460";
 ...
 */
@Slf4j
public class Idea36460Service {
    private static final int IDEA_ID = 36460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36460Service() {
        this(new Idea36460Config());
    }

    public Idea36460Service(Idea36460Config config) {
        this.config = config != null ? config : new Idea36460Config();
