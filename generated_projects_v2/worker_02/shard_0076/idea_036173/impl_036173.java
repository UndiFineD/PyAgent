...
@Data
public class Idea36173Config {
    private String name = "idea_036173";
 ...
 */
@Slf4j
public class Idea36173Service {
    private static final int IDEA_ID = 36173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36173Service() {
        this(new Idea36173Config());
    }

    public Idea36173Service(Idea36173Config config) {
        this.config = config != null ? config : new Idea36173Config();
