...
@Data
public class Idea36329Config {
    private String name = "idea_036329";
 ...
 */
@Slf4j
public class Idea36329Service {
    private static final int IDEA_ID = 36329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36329Service() {
        this(new Idea36329Config());
    }

    public Idea36329Service(Idea36329Config config) {
        this.config = config != null ? config : new Idea36329Config();
