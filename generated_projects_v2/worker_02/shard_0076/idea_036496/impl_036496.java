...
@Data
public class Idea36496Config {
    private String name = "idea_036496";
 ...
 */
@Slf4j
public class Idea36496Service {
    private static final int IDEA_ID = 36496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36496Service() {
        this(new Idea36496Config());
    }

    public Idea36496Service(Idea36496Config config) {
        this.config = config != null ? config : new Idea36496Config();
