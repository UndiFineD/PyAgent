...
@Data
public class Idea36262Config {
    private String name = "idea_036262";
 ...
 */
@Slf4j
public class Idea36262Service {
    private static final int IDEA_ID = 36262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36262Service() {
        this(new Idea36262Config());
    }

    public Idea36262Service(Idea36262Config config) {
        this.config = config != null ? config : new Idea36262Config();
