...
@Data
public class Idea36475Config {
    private String name = "idea_036475";
 ...
 */
@Slf4j
public class Idea36475Service {
    private static final int IDEA_ID = 36475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36475Service() {
        this(new Idea36475Config());
    }

    public Idea36475Service(Idea36475Config config) {
        this.config = config != null ? config : new Idea36475Config();
