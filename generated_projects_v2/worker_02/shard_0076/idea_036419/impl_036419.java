...
@Data
public class Idea36419Config {
    private String name = "idea_036419";
 ...
 */
@Slf4j
public class Idea36419Service {
    private static final int IDEA_ID = 36419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36419Service() {
        this(new Idea36419Config());
    }

    public Idea36419Service(Idea36419Config config) {
        this.config = config != null ? config : new Idea36419Config();
