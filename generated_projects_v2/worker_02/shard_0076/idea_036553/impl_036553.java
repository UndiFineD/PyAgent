...
@Data
public class Idea36553Config {
    private String name = "idea_036553";
 ...
 */
@Slf4j
public class Idea36553Service {
    private static final int IDEA_ID = 36553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36553Service() {
        this(new Idea36553Config());
    }

    public Idea36553Service(Idea36553Config config) {
        this.config = config != null ? config : new Idea36553Config();
