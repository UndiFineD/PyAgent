...
@Data
public class Idea36486Config {
    private String name = "idea_036486";
 ...
 */
@Slf4j
public class Idea36486Service {
    private static final int IDEA_ID = 36486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36486Service() {
        this(new Idea36486Config());
    }

    public Idea36486Service(Idea36486Config config) {
        this.config = config != null ? config : new Idea36486Config();
