...
@Data
public class Idea36437Config {
    private String name = "idea_036437";
 ...
 */
@Slf4j
public class Idea36437Service {
    private static final int IDEA_ID = 36437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36437Service() {
        this(new Idea36437Config());
    }

    public Idea36437Service(Idea36437Config config) {
        this.config = config != null ? config : new Idea36437Config();
