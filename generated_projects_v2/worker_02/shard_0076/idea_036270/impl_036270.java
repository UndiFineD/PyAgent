...
@Data
public class Idea36270Config {
    private String name = "idea_036270";
 ...
 */
@Slf4j
public class Idea36270Service {
    private static final int IDEA_ID = 36270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36270Service() {
        this(new Idea36270Config());
    }

    public Idea36270Service(Idea36270Config config) {
        this.config = config != null ? config : new Idea36270Config();
