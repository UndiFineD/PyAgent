...
@Data
public class Idea36459Config {
    private String name = "idea_036459";
 ...
 */
@Slf4j
public class Idea36459Service {
    private static final int IDEA_ID = 36459;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36459Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36459Service() {
        this(new Idea36459Config());
    }

    public Idea36459Service(Idea36459Config config) {
        this.config = config != null ? config : new Idea36459Config();
