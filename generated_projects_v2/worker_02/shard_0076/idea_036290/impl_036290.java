...
@Data
public class Idea36290Config {
    private String name = "idea_036290";
 ...
 */
@Slf4j
public class Idea36290Service {
    private static final int IDEA_ID = 36290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36290Service() {
        this(new Idea36290Config());
    }

    public Idea36290Service(Idea36290Config config) {
        this.config = config != null ? config : new Idea36290Config();
