...
@Data
public class Idea36571Config {
    private String name = "idea_036571";
 ...
 */
@Slf4j
public class Idea36571Service {
    private static final int IDEA_ID = 36571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36571Service() {
        this(new Idea36571Config());
    }

    public Idea36571Service(Idea36571Config config) {
        this.config = config != null ? config : new Idea36571Config();
