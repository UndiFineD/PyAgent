...
@Data
public class Idea36318Config {
    private String name = "idea_036318";
 ...
 */
@Slf4j
public class Idea36318Service {
    private static final int IDEA_ID = 36318;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36318Service() {
        this(new Idea36318Config());
    }

    public Idea36318Service(Idea36318Config config) {
        this.config = config != null ? config : new Idea36318Config();
