...
@Data
public class Idea36440Config {
    private String name = "idea_036440";
 ...
 */
@Slf4j
public class Idea36440Service {
    private static final int IDEA_ID = 36440;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36440Service() {
        this(new Idea36440Config());
    }

    public Idea36440Service(Idea36440Config config) {
        this.config = config != null ? config : new Idea36440Config();
