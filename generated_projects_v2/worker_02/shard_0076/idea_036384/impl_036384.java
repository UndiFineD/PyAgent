...
@Data
public class Idea36384Config {
    private String name = "idea_036384";
 ...
 */
@Slf4j
public class Idea36384Service {
    private static final int IDEA_ID = 36384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36384Service() {
        this(new Idea36384Config());
    }

    public Idea36384Service(Idea36384Config config) {
        this.config = config != null ? config : new Idea36384Config();
