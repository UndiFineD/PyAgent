...
@Data
public class Idea36432Config {
    private String name = "idea_036432";
 ...
 */
@Slf4j
public class Idea36432Service {
    private static final int IDEA_ID = 36432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36432Service() {
        this(new Idea36432Config());
    }

    public Idea36432Service(Idea36432Config config) {
        this.config = config != null ? config : new Idea36432Config();
