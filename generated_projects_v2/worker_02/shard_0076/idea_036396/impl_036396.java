...
@Data
public class Idea36396Config {
    private String name = "idea_036396";
 ...
 */
@Slf4j
public class Idea36396Service {
    private static final int IDEA_ID = 36396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36396Service() {
        this(new Idea36396Config());
    }

    public Idea36396Service(Idea36396Config config) {
        this.config = config != null ? config : new Idea36396Config();
