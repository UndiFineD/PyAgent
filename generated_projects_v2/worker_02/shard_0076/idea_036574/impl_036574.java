...
@Data
public class Idea36574Config {
    private String name = "idea_036574";
 ...
 */
@Slf4j
public class Idea36574Service {
    private static final int IDEA_ID = 36574;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36574Service() {
        this(new Idea36574Config());
    }

    public Idea36574Service(Idea36574Config config) {
        this.config = config != null ? config : new Idea36574Config();
