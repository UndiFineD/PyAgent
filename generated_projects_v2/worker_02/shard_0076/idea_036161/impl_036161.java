...
@Data
public class Idea36161Config {
    private String name = "idea_036161";
 ...
 */
@Slf4j
public class Idea36161Service {
    private static final int IDEA_ID = 36161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36161Service() {
        this(new Idea36161Config());
    }

    public Idea36161Service(Idea36161Config config) {
        this.config = config != null ? config : new Idea36161Config();
