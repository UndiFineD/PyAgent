...
@Data
public class Idea36244Config {
    private String name = "idea_036244";
 ...
 */
@Slf4j
public class Idea36244Service {
    private static final int IDEA_ID = 36244;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36244Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36244Service() {
        this(new Idea36244Config());
    }

    public Idea36244Service(Idea36244Config config) {
        this.config = config != null ? config : new Idea36244Config();
