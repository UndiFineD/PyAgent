...
@Data
public class Idea36212Config {
    private String name = "idea_036212";
 ...
 */
@Slf4j
public class Idea36212Service {
    private static final int IDEA_ID = 36212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36212Service() {
        this(new Idea36212Config());
    }

    public Idea36212Service(Idea36212Config config) {
        this.config = config != null ? config : new Idea36212Config();
