...
@Data
public class Idea36567Config {
    private String name = "idea_036567";
 ...
 */
@Slf4j
public class Idea36567Service {
    private static final int IDEA_ID = 36567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36567Service() {
        this(new Idea36567Config());
    }

    public Idea36567Service(Idea36567Config config) {
        this.config = config != null ? config : new Idea36567Config();
