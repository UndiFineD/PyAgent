...
@Data
public class Idea36481Config {
    private String name = "idea_036481";
 ...
 */
@Slf4j
public class Idea36481Service {
    private static final int IDEA_ID = 36481;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36481Service() {
        this(new Idea36481Config());
    }

    public Idea36481Service(Idea36481Config config) {
        this.config = config != null ? config : new Idea36481Config();
