...
@Data
public class Idea36170Config {
    private String name = "idea_036170";
 ...
 */
@Slf4j
public class Idea36170Service {
    private static final int IDEA_ID = 36170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36170Service() {
        this(new Idea36170Config());
    }

    public Idea36170Service(Idea36170Config config) {
        this.config = config != null ? config : new Idea36170Config();
