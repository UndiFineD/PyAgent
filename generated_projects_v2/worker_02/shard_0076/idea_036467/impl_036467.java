...
@Data
public class Idea36467Config {
    private String name = "idea_036467";
 ...
 */
@Slf4j
public class Idea36467Service {
    private static final int IDEA_ID = 36467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36467Service() {
        this(new Idea36467Config());
    }

    public Idea36467Service(Idea36467Config config) {
        this.config = config != null ? config : new Idea36467Config();
