...
@Data
public class Idea36538Config {
    private String name = "idea_036538";
 ...
 */
@Slf4j
public class Idea36538Service {
    private static final int IDEA_ID = 36538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36538Service() {
        this(new Idea36538Config());
    }

    public Idea36538Service(Idea36538Config config) {
        this.config = config != null ? config : new Idea36538Config();
