...
@Data
public class Idea36362Config {
    private String name = "idea_036362";
 ...
 */
@Slf4j
public class Idea36362Service {
    private static final int IDEA_ID = 36362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36362Service() {
        this(new Idea36362Config());
    }

    public Idea36362Service(Idea36362Config config) {
        this.config = config != null ? config : new Idea36362Config();
