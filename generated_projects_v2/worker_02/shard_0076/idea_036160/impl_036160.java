...
@Data
public class Idea36160Config {
    private String name = "idea_036160";
 ...
 */
@Slf4j
public class Idea36160Service {
    private static final int IDEA_ID = 36160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36160Service() {
        this(new Idea36160Config());
    }

    public Idea36160Service(Idea36160Config config) {
        this.config = config != null ? config : new Idea36160Config();
