...
@Data
public class Idea36411Config {
    private String name = "idea_036411";
 ...
 */
@Slf4j
public class Idea36411Service {
    private static final int IDEA_ID = 36411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36411Service() {
        this(new Idea36411Config());
    }

    public Idea36411Service(Idea36411Config config) {
        this.config = config != null ? config : new Idea36411Config();
