...
@Data
public class Idea36543Config {
    private String name = "idea_036543";
 ...
 */
@Slf4j
public class Idea36543Service {
    private static final int IDEA_ID = 36543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36543Service() {
        this(new Idea36543Config());
    }

    public Idea36543Service(Idea36543Config config) {
        this.config = config != null ? config : new Idea36543Config();
