...
@Data
public class Idea36144Config {
    private String name = "idea_036144";
 ...
 */
@Slf4j
public class Idea36144Service {
    private static final int IDEA_ID = 36144;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36144Service() {
        this(new Idea36144Config());
    }

    public Idea36144Service(Idea36144Config config) {
        this.config = config != null ? config : new Idea36144Config();
