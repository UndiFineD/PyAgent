...
@Data
public class Idea36192Config {
    private String name = "idea_036192";
 ...
 */
@Slf4j
public class Idea36192Service {
    private static final int IDEA_ID = 36192;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36192Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36192Service() {
        this(new Idea36192Config());
    }

    public Idea36192Service(Idea36192Config config) {
        this.config = config != null ? config : new Idea36192Config();
