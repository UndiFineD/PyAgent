...
@Data
public class Idea36299Config {
    private String name = "idea_036299";
 ...
 */
@Slf4j
public class Idea36299Service {
    private static final int IDEA_ID = 36299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36299Service() {
        this(new Idea36299Config());
    }

    public Idea36299Service(Idea36299Config config) {
        this.config = config != null ? config : new Idea36299Config();
