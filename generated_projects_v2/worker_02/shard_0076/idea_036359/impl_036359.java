...
@Data
public class Idea36359Config {
    private String name = "idea_036359";
 ...
 */
@Slf4j
public class Idea36359Service {
    private static final int IDEA_ID = 36359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36359Service() {
        this(new Idea36359Config());
    }

    public Idea36359Service(Idea36359Config config) {
        this.config = config != null ? config : new Idea36359Config();
