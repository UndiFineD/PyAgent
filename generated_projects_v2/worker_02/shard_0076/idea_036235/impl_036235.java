...
@Data
public class Idea36235Config {
    private String name = "idea_036235";
 ...
 */
@Slf4j
public class Idea36235Service {
    private static final int IDEA_ID = 36235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36235Service() {
        this(new Idea36235Config());
    }

    public Idea36235Service(Idea36235Config config) {
        this.config = config != null ? config : new Idea36235Config();
