...
@Data
public class Idea36387Config {
    private String name = "idea_036387";
 ...
 */
@Slf4j
public class Idea36387Service {
    private static final int IDEA_ID = 36387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36387Service() {
        this(new Idea36387Config());
    }

    public Idea36387Service(Idea36387Config config) {
        this.config = config != null ? config : new Idea36387Config();
