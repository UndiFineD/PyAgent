...
@Data
public class Idea36524Config {
    private String name = "idea_036524";
 ...
 */
@Slf4j
public class Idea36524Service {
    private static final int IDEA_ID = 36524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36524Service() {
        this(new Idea36524Config());
    }

    public Idea36524Service(Idea36524Config config) {
        this.config = config != null ? config : new Idea36524Config();
