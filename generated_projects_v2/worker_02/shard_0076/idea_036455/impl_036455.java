...
@Data
public class Idea36455Config {
    private String name = "idea_036455";
 ...
 */
@Slf4j
public class Idea36455Service {
    private static final int IDEA_ID = 36455;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36455Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36455Service() {
        this(new Idea36455Config());
    }

    public Idea36455Service(Idea36455Config config) {
        this.config = config != null ? config : new Idea36455Config();
