...
@Data
public class Idea36242Config {
    private String name = "idea_036242";
 ...
 */
@Slf4j
public class Idea36242Service {
    private static final int IDEA_ID = 36242;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36242Service() {
        this(new Idea36242Config());
    }

    public Idea36242Service(Idea36242Config config) {
        this.config = config != null ? config : new Idea36242Config();
