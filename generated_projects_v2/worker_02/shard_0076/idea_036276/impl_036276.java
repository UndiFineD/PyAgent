...
@Data
public class Idea36276Config {
    private String name = "idea_036276";
 ...
 */
@Slf4j
public class Idea36276Service {
    private static final int IDEA_ID = 36276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36276Service() {
        this(new Idea36276Config());
    }

    public Idea36276Service(Idea36276Config config) {
        this.config = config != null ? config : new Idea36276Config();
