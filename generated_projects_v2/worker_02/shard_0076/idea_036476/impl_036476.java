...
@Data
public class Idea36476Config {
    private String name = "idea_036476";
 ...
 */
@Slf4j
public class Idea36476Service {
    private static final int IDEA_ID = 36476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36476Service() {
        this(new Idea36476Config());
    }

    public Idea36476Service(Idea36476Config config) {
        this.config = config != null ? config : new Idea36476Config();
