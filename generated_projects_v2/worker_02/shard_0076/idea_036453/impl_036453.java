...
@Data
public class Idea36453Config {
    private String name = "idea_036453";
 ...
 */
@Slf4j
public class Idea36453Service {
    private static final int IDEA_ID = 36453;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36453Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36453Service() {
        this(new Idea36453Config());
    }

    public Idea36453Service(Idea36453Config config) {
        this.config = config != null ? config : new Idea36453Config();
