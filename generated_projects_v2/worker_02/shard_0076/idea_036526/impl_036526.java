...
@Data
public class Idea36526Config {
    private String name = "idea_036526";
 ...
 */
@Slf4j
public class Idea36526Service {
    private static final int IDEA_ID = 36526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36526Service() {
        this(new Idea36526Config());
    }

    public Idea36526Service(Idea36526Config config) {
        this.config = config != null ? config : new Idea36526Config();
