...
@Data
public class Idea36353Config {
    private String name = "idea_036353";
 ...
 */
@Slf4j
public class Idea36353Service {
    private static final int IDEA_ID = 36353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36353Service() {
        this(new Idea36353Config());
    }

    public Idea36353Service(Idea36353Config config) {
        this.config = config != null ? config : new Idea36353Config();
