...
@Data
public class Idea36111Config {
    private String name = "idea_036111";
 ...
 */
@Slf4j
public class Idea36111Service {
    private static final int IDEA_ID = 36111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36111Service() {
        this(new Idea36111Config());
    }

    public Idea36111Service(Idea36111Config config) {
        this.config = config != null ? config : new Idea36111Config();
