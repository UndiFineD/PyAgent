...
@Data
public class Idea36166Config {
    private String name = "idea_036166";
 ...
 */
@Slf4j
public class Idea36166Service {
    private static final int IDEA_ID = 36166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36166Service() {
        this(new Idea36166Config());
    }

    public Idea36166Service(Idea36166Config config) {
        this.config = config != null ? config : new Idea36166Config();
