...
@Data
public class Idea36174Config {
    private String name = "idea_036174";
 ...
 */
@Slf4j
public class Idea36174Service {
    private static final int IDEA_ID = 36174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36174Service() {
        this(new Idea36174Config());
    }

    public Idea36174Service(Idea36174Config config) {
        this.config = config != null ? config : new Idea36174Config();
