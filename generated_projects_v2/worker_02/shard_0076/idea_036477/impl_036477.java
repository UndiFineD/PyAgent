...
@Data
public class Idea36477Config {
    private String name = "idea_036477";
 ...
 */
@Slf4j
public class Idea36477Service {
    private static final int IDEA_ID = 36477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36477Service() {
        this(new Idea36477Config());
    }

    public Idea36477Service(Idea36477Config config) {
        this.config = config != null ? config : new Idea36477Config();
