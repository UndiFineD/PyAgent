...
@Data
public class Idea36175Config {
    private String name = "idea_036175";
 ...
 */
@Slf4j
public class Idea36175Service {
    private static final int IDEA_ID = 36175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36175Service() {
        this(new Idea36175Config());
    }

    public Idea36175Service(Idea36175Config config) {
        this.config = config != null ? config : new Idea36175Config();
