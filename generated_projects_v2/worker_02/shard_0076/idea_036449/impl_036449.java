...
@Data
public class Idea36449Config {
    private String name = "idea_036449";
 ...
 */
@Slf4j
public class Idea36449Service {
    private static final int IDEA_ID = 36449;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36449Service() {
        this(new Idea36449Config());
    }

    public Idea36449Service(Idea36449Config config) {
        this.config = config != null ? config : new Idea36449Config();
