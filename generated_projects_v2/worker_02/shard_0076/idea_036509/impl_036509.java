...
@Data
public class Idea36509Config {
    private String name = "idea_036509";
 ...
 */
@Slf4j
public class Idea36509Service {
    private static final int IDEA_ID = 36509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36509Service() {
        this(new Idea36509Config());
    }

    public Idea36509Service(Idea36509Config config) {
        this.config = config != null ? config : new Idea36509Config();
