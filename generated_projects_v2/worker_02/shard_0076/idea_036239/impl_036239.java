...
@Data
public class Idea36239Config {
    private String name = "idea_036239";
 ...
 */
@Slf4j
public class Idea36239Service {
    private static final int IDEA_ID = 36239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36239Service() {
        this(new Idea36239Config());
    }

    public Idea36239Service(Idea36239Config config) {
        this.config = config != null ? config : new Idea36239Config();
