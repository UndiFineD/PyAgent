...
@Data
public class Idea36171Config {
    private String name = "idea_036171";
 ...
 */
@Slf4j
public class Idea36171Service {
    private static final int IDEA_ID = 36171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36171Service() {
        this(new Idea36171Config());
    }

    public Idea36171Service(Idea36171Config config) {
        this.config = config != null ? config : new Idea36171Config();
