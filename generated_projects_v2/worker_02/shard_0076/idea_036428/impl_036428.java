...
@Data
public class Idea36428Config {
    private String name = "idea_036428";
 ...
 */
@Slf4j
public class Idea36428Service {
    private static final int IDEA_ID = 36428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36428Service() {
        this(new Idea36428Config());
    }

    public Idea36428Service(Idea36428Config config) {
        this.config = config != null ? config : new Idea36428Config();
