...
@Data
public class Idea36285Config {
    private String name = "idea_036285";
 ...
 */
@Slf4j
public class Idea36285Service {
    private static final int IDEA_ID = 36285;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36285Service() {
        this(new Idea36285Config());
    }

    public Idea36285Service(Idea36285Config config) {
        this.config = config != null ? config : new Idea36285Config();
