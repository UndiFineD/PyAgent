...
@Data
public class Idea36386Config {
    private String name = "idea_036386";
 ...
 */
@Slf4j
public class Idea36386Service {
    private static final int IDEA_ID = 36386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36386Service() {
        this(new Idea36386Config());
    }

    public Idea36386Service(Idea36386Config config) {
        this.config = config != null ? config : new Idea36386Config();
