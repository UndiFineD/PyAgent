...
@Data
public class Idea36519Config {
    private String name = "idea_036519";
 ...
 */
@Slf4j
public class Idea36519Service {
    private static final int IDEA_ID = 36519;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36519Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36519Service() {
        this(new Idea36519Config());
    }

    public Idea36519Service(Idea36519Config config) {
        this.config = config != null ? config : new Idea36519Config();
