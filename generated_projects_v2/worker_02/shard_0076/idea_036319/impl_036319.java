...
@Data
public class Idea36319Config {
    private String name = "idea_036319";
 ...
 */
@Slf4j
public class Idea36319Service {
    private static final int IDEA_ID = 36319;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36319Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36319Service() {
        this(new Idea36319Config());
    }

    public Idea36319Service(Idea36319Config config) {
        this.config = config != null ? config : new Idea36319Config();
