...
@Data
public class Idea36284Config {
    private String name = "idea_036284";
 ...
 */
@Slf4j
public class Idea36284Service {
    private static final int IDEA_ID = 36284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36284Service() {
        this(new Idea36284Config());
    }

    public Idea36284Service(Idea36284Config config) {
        this.config = config != null ? config : new Idea36284Config();
