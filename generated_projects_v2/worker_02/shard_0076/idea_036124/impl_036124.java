...
@Data
public class Idea36124Config {
    private String name = "idea_036124";
 ...
 */
@Slf4j
public class Idea36124Service {
    private static final int IDEA_ID = 36124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36124Service() {
        this(new Idea36124Config());
    }

    public Idea36124Service(Idea36124Config config) {
        this.config = config != null ? config : new Idea36124Config();
