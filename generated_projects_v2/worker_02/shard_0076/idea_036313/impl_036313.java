...
@Data
public class Idea36313Config {
    private String name = "idea_036313";
 ...
 */
@Slf4j
public class Idea36313Service {
    private static final int IDEA_ID = 36313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36313Service() {
        this(new Idea36313Config());
    }

    public Idea36313Service(Idea36313Config config) {
        this.config = config != null ? config : new Idea36313Config();
