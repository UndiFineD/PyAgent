...
@Data
public class Idea36222Config {
    private String name = "idea_036222";
 ...
 */
@Slf4j
public class Idea36222Service {
    private static final int IDEA_ID = 36222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36222Service() {
        this(new Idea36222Config());
    }

    public Idea36222Service(Idea36222Config config) {
        this.config = config != null ? config : new Idea36222Config();
