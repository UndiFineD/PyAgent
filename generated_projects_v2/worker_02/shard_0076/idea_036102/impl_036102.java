...
@Data
public class Idea36102Config {
    private String name = "idea_036102";
 ...
 */
@Slf4j
public class Idea36102Service {
    private static final int IDEA_ID = 36102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36102Service() {
        this(new Idea36102Config());
    }

    public Idea36102Service(Idea36102Config config) {
        this.config = config != null ? config : new Idea36102Config();
