...
@Data
public class Idea36377Config {
    private String name = "idea_036377";
 ...
 */
@Slf4j
public class Idea36377Service {
    private static final int IDEA_ID = 36377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36377Service() {
        this(new Idea36377Config());
    }

    public Idea36377Service(Idea36377Config config) {
        this.config = config != null ? config : new Idea36377Config();
