...
@Data
public class Idea36258Config {
    private String name = "idea_036258";
 ...
 */
@Slf4j
public class Idea36258Service {
    private static final int IDEA_ID = 36258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36258Service() {
        this(new Idea36258Config());
    }

    public Idea36258Service(Idea36258Config config) {
        this.config = config != null ? config : new Idea36258Config();
