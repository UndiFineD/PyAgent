...
@Data
public class Idea36532Config {
    private String name = "idea_036532";
 ...
 */
@Slf4j
public class Idea36532Service {
    private static final int IDEA_ID = 36532;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36532Service() {
        this(new Idea36532Config());
    }

    public Idea36532Service(Idea36532Config config) {
        this.config = config != null ? config : new Idea36532Config();
