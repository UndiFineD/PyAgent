...
@Data
public class Idea36162Config {
    private String name = "idea_036162";
 ...
 */
@Slf4j
public class Idea36162Service {
    private static final int IDEA_ID = 36162;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36162Service() {
        this(new Idea36162Config());
    }

    public Idea36162Service(Idea36162Config config) {
        this.config = config != null ? config : new Idea36162Config();
