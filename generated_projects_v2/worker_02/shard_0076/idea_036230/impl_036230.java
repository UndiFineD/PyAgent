...
@Data
public class Idea36230Config {
    private String name = "idea_036230";
 ...
 */
@Slf4j
public class Idea36230Service {
    private static final int IDEA_ID = 36230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36230Service() {
        this(new Idea36230Config());
    }

    public Idea36230Service(Idea36230Config config) {
        this.config = config != null ? config : new Idea36230Config();
