...
@Data
public class Idea36181Config {
    private String name = "idea_036181";
 ...
 */
@Slf4j
public class Idea36181Service {
    private static final int IDEA_ID = 36181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36181Service() {
        this(new Idea36181Config());
    }

    public Idea36181Service(Idea36181Config config) {
        this.config = config != null ? config : new Idea36181Config();
