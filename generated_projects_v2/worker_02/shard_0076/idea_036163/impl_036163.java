...
@Data
public class Idea36163Config {
    private String name = "idea_036163";
 ...
 */
@Slf4j
public class Idea36163Service {
    private static final int IDEA_ID = 36163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36163Service() {
        this(new Idea36163Config());
    }

    public Idea36163Service(Idea36163Config config) {
        this.config = config != null ? config : new Idea36163Config();
