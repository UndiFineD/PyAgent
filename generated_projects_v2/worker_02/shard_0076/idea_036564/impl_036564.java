...
@Data
public class Idea36564Config {
    private String name = "idea_036564";
 ...
 */
@Slf4j
public class Idea36564Service {
    private static final int IDEA_ID = 36564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36564Service() {
        this(new Idea36564Config());
    }

    public Idea36564Service(Idea36564Config config) {
        this.config = config != null ? config : new Idea36564Config();
