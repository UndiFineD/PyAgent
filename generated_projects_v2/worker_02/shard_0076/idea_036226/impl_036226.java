...
@Data
public class Idea36226Config {
    private String name = "idea_036226";
 ...
 */
@Slf4j
public class Idea36226Service {
    private static final int IDEA_ID = 36226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36226Service() {
        this(new Idea36226Config());
    }

    public Idea36226Service(Idea36226Config config) {
        this.config = config != null ? config : new Idea36226Config();
