...
@Data
public class Idea36392Config {
    private String name = "idea_036392";
 ...
 */
@Slf4j
public class Idea36392Service {
    private static final int IDEA_ID = 36392;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36392Service() {
        this(new Idea36392Config());
    }

    public Idea36392Service(Idea36392Config config) {
        this.config = config != null ? config : new Idea36392Config();
