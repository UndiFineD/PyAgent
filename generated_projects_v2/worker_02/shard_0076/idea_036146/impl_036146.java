...
@Data
public class Idea36146Config {
    private String name = "idea_036146";
 ...
 */
@Slf4j
public class Idea36146Service {
    private static final int IDEA_ID = 36146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36146Service() {
        this(new Idea36146Config());
    }

    public Idea36146Service(Idea36146Config config) {
        this.config = config != null ? config : new Idea36146Config();
