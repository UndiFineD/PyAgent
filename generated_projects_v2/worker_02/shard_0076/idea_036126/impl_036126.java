...
@Data
public class Idea36126Config {
    private String name = "idea_036126";
 ...
 */
@Slf4j
public class Idea36126Service {
    private static final int IDEA_ID = 36126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36126Service() {
        this(new Idea36126Config());
    }

    public Idea36126Service(Idea36126Config config) {
        this.config = config != null ? config : new Idea36126Config();
