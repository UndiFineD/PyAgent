...
@Data
public class Idea36557Config {
    private String name = "idea_036557";
 ...
 */
@Slf4j
public class Idea36557Service {
    private static final int IDEA_ID = 36557;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36557Service() {
        this(new Idea36557Config());
    }

    public Idea36557Service(Idea36557Config config) {
        this.config = config != null ? config : new Idea36557Config();
