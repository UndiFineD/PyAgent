...
@Data
public class Idea36273Config {
    private String name = "idea_036273";
 ...
 */
@Slf4j
public class Idea36273Service {
    private static final int IDEA_ID = 36273;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36273Service() {
        this(new Idea36273Config());
    }

    public Idea36273Service(Idea36273Config config) {
        this.config = config != null ? config : new Idea36273Config();
