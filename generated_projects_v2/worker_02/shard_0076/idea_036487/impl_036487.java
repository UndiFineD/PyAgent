...
@Data
public class Idea36487Config {
    private String name = "idea_036487";
 ...
 */
@Slf4j
public class Idea36487Service {
    private static final int IDEA_ID = 36487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36487Service() {
        this(new Idea36487Config());
    }

    public Idea36487Service(Idea36487Config config) {
        this.config = config != null ? config : new Idea36487Config();
