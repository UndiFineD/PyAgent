...
@Data
public class Idea36341Config {
    private String name = "idea_036341";
 ...
 */
@Slf4j
public class Idea36341Service {
    private static final int IDEA_ID = 36341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36341Service() {
        this(new Idea36341Config());
    }

    public Idea36341Service(Idea36341Config config) {
        this.config = config != null ? config : new Idea36341Config();
