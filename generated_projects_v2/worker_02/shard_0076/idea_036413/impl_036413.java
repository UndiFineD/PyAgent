...
@Data
public class Idea36413Config {
    private String name = "idea_036413";
 ...
 */
@Slf4j
public class Idea36413Service {
    private static final int IDEA_ID = 36413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36413Service() {
        this(new Idea36413Config());
    }

    public Idea36413Service(Idea36413Config config) {
        this.config = config != null ? config : new Idea36413Config();
