...
@Data
public class Idea36143Config {
    private String name = "idea_036143";
 ...
 */
@Slf4j
public class Idea36143Service {
    private static final int IDEA_ID = 36143;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36143Service() {
        this(new Idea36143Config());
    }

    public Idea36143Service(Idea36143Config config) {
        this.config = config != null ? config : new Idea36143Config();
