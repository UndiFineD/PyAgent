...
@Data
public class Idea36297Config {
    private String name = "idea_036297";
 ...
 */
@Slf4j
public class Idea36297Service {
    private static final int IDEA_ID = 36297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36297Service() {
        this(new Idea36297Config());
    }

    public Idea36297Service(Idea36297Config config) {
        this.config = config != null ? config : new Idea36297Config();
