...
@Data
public class Idea36142Config {
    private String name = "idea_036142";
 ...
 */
@Slf4j
public class Idea36142Service {
    private static final int IDEA_ID = 36142;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36142Service() {
        this(new Idea36142Config());
    }

    public Idea36142Service(Idea36142Config config) {
        this.config = config != null ? config : new Idea36142Config();
