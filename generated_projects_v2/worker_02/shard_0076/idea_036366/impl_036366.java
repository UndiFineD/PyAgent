...
@Data
public class Idea36366Config {
    private String name = "idea_036366";
 ...
 */
@Slf4j
public class Idea36366Service {
    private static final int IDEA_ID = 36366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36366Service() {
        this(new Idea36366Config());
    }

    public Idea36366Service(Idea36366Config config) {
        this.config = config != null ? config : new Idea36366Config();
