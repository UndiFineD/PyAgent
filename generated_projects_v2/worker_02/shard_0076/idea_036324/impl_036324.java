...
@Data
public class Idea36324Config {
    private String name = "idea_036324";
 ...
 */
@Slf4j
public class Idea36324Service {
    private static final int IDEA_ID = 36324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36324Service() {
        this(new Idea36324Config());
    }

    public Idea36324Service(Idea36324Config config) {
        this.config = config != null ? config : new Idea36324Config();
