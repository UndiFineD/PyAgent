...
@Data
public class Idea36337Config {
    private String name = "idea_036337";
 ...
 */
@Slf4j
public class Idea36337Service {
    private static final int IDEA_ID = 36337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36337Service() {
        this(new Idea36337Config());
    }

    public Idea36337Service(Idea36337Config config) {
        this.config = config != null ? config : new Idea36337Config();
