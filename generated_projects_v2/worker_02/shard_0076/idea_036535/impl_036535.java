...
@Data
public class Idea36535Config {
    private String name = "idea_036535";
 ...
 */
@Slf4j
public class Idea36535Service {
    private static final int IDEA_ID = 36535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36535Service() {
        this(new Idea36535Config());
    }

    public Idea36535Service(Idea36535Config config) {
        this.config = config != null ? config : new Idea36535Config();
