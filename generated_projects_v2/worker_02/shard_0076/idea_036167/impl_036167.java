...
@Data
public class Idea36167Config {
    private String name = "idea_036167";
 ...
 */
@Slf4j
public class Idea36167Service {
    private static final int IDEA_ID = 36167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36167Service() {
        this(new Idea36167Config());
    }

    public Idea36167Service(Idea36167Config config) {
        this.config = config != null ? config : new Idea36167Config();
