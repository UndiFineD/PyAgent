...
@Data
public class Idea36209Config {
    private String name = "idea_036209";
 ...
 */
@Slf4j
public class Idea36209Service {
    private static final int IDEA_ID = 36209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36209Service() {
        this(new Idea36209Config());
    }

    public Idea36209Service(Idea36209Config config) {
        this.config = config != null ? config : new Idea36209Config();
