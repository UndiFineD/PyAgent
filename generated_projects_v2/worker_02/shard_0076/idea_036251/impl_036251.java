...
@Data
public class Idea36251Config {
    private String name = "idea_036251";
 ...
 */
@Slf4j
public class Idea36251Service {
    private static final int IDEA_ID = 36251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36251Service() {
        this(new Idea36251Config());
    }

    public Idea36251Service(Idea36251Config config) {
        this.config = config != null ? config : new Idea36251Config();
