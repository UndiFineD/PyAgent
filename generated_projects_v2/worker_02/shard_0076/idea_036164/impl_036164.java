...
@Data
public class Idea36164Config {
    private String name = "idea_036164";
 ...
 */
@Slf4j
public class Idea36164Service {
    private static final int IDEA_ID = 36164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36164Service() {
        this(new Idea36164Config());
    }

    public Idea36164Service(Idea36164Config config) {
        this.config = config != null ? config : new Idea36164Config();
