...
@Data
public class Idea36294Config {
    private String name = "idea_036294";
 ...
 */
@Slf4j
public class Idea36294Service {
    private static final int IDEA_ID = 36294;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36294Service() {
        this(new Idea36294Config());
    }

    public Idea36294Service(Idea36294Config config) {
        this.config = config != null ? config : new Idea36294Config();
