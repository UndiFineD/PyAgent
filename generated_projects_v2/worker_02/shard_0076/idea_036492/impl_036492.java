...
@Data
public class Idea36492Config {
    private String name = "idea_036492";
 ...
 */
@Slf4j
public class Idea36492Service {
    private static final int IDEA_ID = 36492;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36492Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36492Service() {
        this(new Idea36492Config());
    }

    public Idea36492Service(Idea36492Config config) {
        this.config = config != null ? config : new Idea36492Config();
