...
@Data
public class Idea36311Config {
    private String name = "idea_036311";
 ...
 */
@Slf4j
public class Idea36311Service {
    private static final int IDEA_ID = 36311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36311Service() {
        this(new Idea36311Config());
    }

    public Idea36311Service(Idea36311Config config) {
        this.config = config != null ? config : new Idea36311Config();
