...
@Data
public class Idea36303Config {
    private String name = "idea_036303";
 ...
 */
@Slf4j
public class Idea36303Service {
    private static final int IDEA_ID = 36303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36303Service() {
        this(new Idea36303Config());
    }

    public Idea36303Service(Idea36303Config config) {
        this.config = config != null ? config : new Idea36303Config();
