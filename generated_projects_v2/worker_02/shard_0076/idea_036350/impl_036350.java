...
@Data
public class Idea36350Config {
    private String name = "idea_036350";
 ...
 */
@Slf4j
public class Idea36350Service {
    private static final int IDEA_ID = 36350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36350Service() {
        this(new Idea36350Config());
    }

    public Idea36350Service(Idea36350Config config) {
        this.config = config != null ? config : new Idea36350Config();
