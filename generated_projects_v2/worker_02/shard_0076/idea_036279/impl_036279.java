...
@Data
public class Idea36279Config {
    private String name = "idea_036279";
 ...
 */
@Slf4j
public class Idea36279Service {
    private static final int IDEA_ID = 36279;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36279Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36279Service() {
        this(new Idea36279Config());
    }

    public Idea36279Service(Idea36279Config config) {
        this.config = config != null ? config : new Idea36279Config();
