...
@Data
public class Idea38367Config {
    private String name = "idea_038367";
 ...
 */
@Slf4j
public class Idea38367Service {
    private static final int IDEA_ID = 38367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38367Service() {
        this(new Idea38367Config());
    }

    public Idea38367Service(Idea38367Config config) {
        this.config = config != null ? config : new Idea38367Config();
