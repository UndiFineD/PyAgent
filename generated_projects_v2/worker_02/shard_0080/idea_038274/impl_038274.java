...
@Data
public class Idea38274Config {
    private String name = "idea_038274";
 ...
 */
@Slf4j
public class Idea38274Service {
    private static final int IDEA_ID = 38274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38274Service() {
        this(new Idea38274Config());
    }

    public Idea38274Service(Idea38274Config config) {
        this.config = config != null ? config : new Idea38274Config();
