...
@Data
public class Idea38323Config {
    private String name = "idea_038323";
 ...
 */
@Slf4j
public class Idea38323Service {
    private static final int IDEA_ID = 38323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38323Service() {
        this(new Idea38323Config());
    }

    public Idea38323Service(Idea38323Config config) {
        this.config = config != null ? config : new Idea38323Config();
