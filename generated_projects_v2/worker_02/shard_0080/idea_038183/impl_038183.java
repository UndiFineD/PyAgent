...
@Data
public class Idea38183Config {
    private String name = "idea_038183";
 ...
 */
@Slf4j
public class Idea38183Service {
    private static final int IDEA_ID = 38183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38183Service() {
        this(new Idea38183Config());
    }

    public Idea38183Service(Idea38183Config config) {
        this.config = config != null ? config : new Idea38183Config();
