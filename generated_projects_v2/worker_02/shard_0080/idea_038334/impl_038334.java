...
@Data
public class Idea38334Config {
    private String name = "idea_038334";
 ...
 */
@Slf4j
public class Idea38334Service {
    private static final int IDEA_ID = 38334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38334Service() {
        this(new Idea38334Config());
    }

    public Idea38334Service(Idea38334Config config) {
        this.config = config != null ? config : new Idea38334Config();
