...
@Data
public class Idea38267Config {
    private String name = "idea_038267";
 ...
 */
@Slf4j
public class Idea38267Service {
    private static final int IDEA_ID = 38267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38267Service() {
        this(new Idea38267Config());
    }

    public Idea38267Service(Idea38267Config config) {
        this.config = config != null ? config : new Idea38267Config();
