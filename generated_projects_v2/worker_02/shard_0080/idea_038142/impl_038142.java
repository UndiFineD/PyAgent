...
@Data
public class Idea38142Config {
    private String name = "idea_038142";
 ...
 */
@Slf4j
public class Idea38142Service {
    private static final int IDEA_ID = 38142;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38142Service() {
        this(new Idea38142Config());
    }

    public Idea38142Service(Idea38142Config config) {
        this.config = config != null ? config : new Idea38142Config();
