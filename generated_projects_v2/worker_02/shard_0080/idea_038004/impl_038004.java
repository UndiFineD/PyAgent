...
@Data
public class Idea38004Config {
    private String name = "idea_038004";
 ...
 */
@Slf4j
public class Idea38004Service {
    private static final int IDEA_ID = 38004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38004Service() {
        this(new Idea38004Config());
    }

    public Idea38004Service(Idea38004Config config) {
        this.config = config != null ? config : new Idea38004Config();
