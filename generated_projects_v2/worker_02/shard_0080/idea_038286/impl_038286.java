...
@Data
public class Idea38286Config {
    private String name = "idea_038286";
 ...
 */
@Slf4j
public class Idea38286Service {
    private static final int IDEA_ID = 38286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38286Service() {
        this(new Idea38286Config());
    }

    public Idea38286Service(Idea38286Config config) {
        this.config = config != null ? config : new Idea38286Config();
