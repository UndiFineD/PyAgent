...
@Data
public class Idea38355Config {
    private String name = "idea_038355";
 ...
 */
@Slf4j
public class Idea38355Service {
    private static final int IDEA_ID = 38355;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38355Service() {
        this(new Idea38355Config());
    }

    public Idea38355Service(Idea38355Config config) {
        this.config = config != null ? config : new Idea38355Config();
