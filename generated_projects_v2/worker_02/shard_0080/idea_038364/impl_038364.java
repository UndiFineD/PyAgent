...
@Data
public class Idea38364Config {
    private String name = "idea_038364";
 ...
 */
@Slf4j
public class Idea38364Service {
    private static final int IDEA_ID = 38364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38364Service() {
        this(new Idea38364Config());
    }

    public Idea38364Service(Idea38364Config config) {
        this.config = config != null ? config : new Idea38364Config();
