...
@Data
public class Idea38299Config {
    private String name = "idea_038299";
 ...
 */
@Slf4j
public class Idea38299Service {
    private static final int IDEA_ID = 38299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38299Service() {
        this(new Idea38299Config());
    }

    public Idea38299Service(Idea38299Config config) {
        this.config = config != null ? config : new Idea38299Config();
