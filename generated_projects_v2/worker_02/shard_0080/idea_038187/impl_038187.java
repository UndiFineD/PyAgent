...
@Data
public class Idea38187Config {
    private String name = "idea_038187";
 ...
 */
@Slf4j
public class Idea38187Service {
    private static final int IDEA_ID = 38187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38187Service() {
        this(new Idea38187Config());
    }

    public Idea38187Service(Idea38187Config config) {
        this.config = config != null ? config : new Idea38187Config();
