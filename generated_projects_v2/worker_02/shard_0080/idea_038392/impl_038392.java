...
@Data
public class Idea38392Config {
    private String name = "idea_038392";
 ...
 */
@Slf4j
public class Idea38392Service {
    private static final int IDEA_ID = 38392;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38392Service() {
        this(new Idea38392Config());
    }

    public Idea38392Service(Idea38392Config config) {
        this.config = config != null ? config : new Idea38392Config();
