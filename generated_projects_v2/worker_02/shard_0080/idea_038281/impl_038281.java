...
@Data
public class Idea38281Config {
    private String name = "idea_038281";
 ...
 */
@Slf4j
public class Idea38281Service {
    private static final int IDEA_ID = 38281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38281Service() {
        this(new Idea38281Config());
    }

    public Idea38281Service(Idea38281Config config) {
        this.config = config != null ? config : new Idea38281Config();
