...
@Data
public class Idea38296Config {
    private String name = "idea_038296";
 ...
 */
@Slf4j
public class Idea38296Service {
    private static final int IDEA_ID = 38296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38296Service() {
        this(new Idea38296Config());
    }

    public Idea38296Service(Idea38296Config config) {
        this.config = config != null ? config : new Idea38296Config();
