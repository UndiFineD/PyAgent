...
@Data
public class Idea38260Config {
    private String name = "idea_038260";
 ...
 */
@Slf4j
public class Idea38260Service {
    private static final int IDEA_ID = 38260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38260Service() {
        this(new Idea38260Config());
    }

    public Idea38260Service(Idea38260Config config) {
        this.config = config != null ? config : new Idea38260Config();
