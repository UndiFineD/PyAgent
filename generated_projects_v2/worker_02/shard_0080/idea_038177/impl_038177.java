...
@Data
public class Idea38177Config {
    private String name = "idea_038177";
 ...
 */
@Slf4j
public class Idea38177Service {
    private static final int IDEA_ID = 38177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38177Service() {
        this(new Idea38177Config());
    }

    public Idea38177Service(Idea38177Config config) {
        this.config = config != null ? config : new Idea38177Config();
