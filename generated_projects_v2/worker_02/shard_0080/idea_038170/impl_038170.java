...
@Data
public class Idea38170Config {
    private String name = "idea_038170";
 ...
 */
@Slf4j
public class Idea38170Service {
    private static final int IDEA_ID = 38170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38170Service() {
        this(new Idea38170Config());
    }

    public Idea38170Service(Idea38170Config config) {
        this.config = config != null ? config : new Idea38170Config();
