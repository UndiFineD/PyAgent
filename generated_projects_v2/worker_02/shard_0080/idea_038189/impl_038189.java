...
@Data
public class Idea38189Config {
    private String name = "idea_038189";
 ...
 */
@Slf4j
public class Idea38189Service {
    private static final int IDEA_ID = 38189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38189Service() {
        this(new Idea38189Config());
    }

    public Idea38189Service(Idea38189Config config) {
        this.config = config != null ? config : new Idea38189Config();
