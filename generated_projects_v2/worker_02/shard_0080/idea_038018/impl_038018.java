...
@Data
public class Idea38018Config {
    private String name = "idea_038018";
 ...
 */
@Slf4j
public class Idea38018Service {
    private static final int IDEA_ID = 38018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38018Service() {
        this(new Idea38018Config());
    }

    public Idea38018Service(Idea38018Config config) {
        this.config = config != null ? config : new Idea38018Config();
