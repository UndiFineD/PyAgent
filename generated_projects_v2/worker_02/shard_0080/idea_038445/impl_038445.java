...
@Data
public class Idea38445Config {
    private String name = "idea_038445";
 ...
 */
@Slf4j
public class Idea38445Service {
    private static final int IDEA_ID = 38445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38445Service() {
        this(new Idea38445Config());
    }

    public Idea38445Service(Idea38445Config config) {
        this.config = config != null ? config : new Idea38445Config();
