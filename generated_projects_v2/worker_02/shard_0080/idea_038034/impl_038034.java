...
@Data
public class Idea38034Config {
    private String name = "idea_038034";
 ...
 */
@Slf4j
public class Idea38034Service {
    private static final int IDEA_ID = 38034;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38034Service() {
        this(new Idea38034Config());
    }

    public Idea38034Service(Idea38034Config config) {
        this.config = config != null ? config : new Idea38034Config();
