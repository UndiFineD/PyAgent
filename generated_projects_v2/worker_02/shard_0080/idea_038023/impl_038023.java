...
@Data
public class Idea38023Config {
    private String name = "idea_038023";
 ...
 */
@Slf4j
public class Idea38023Service {
    private static final int IDEA_ID = 38023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38023Service() {
        this(new Idea38023Config());
    }

    public Idea38023Service(Idea38023Config config) {
        this.config = config != null ? config : new Idea38023Config();
