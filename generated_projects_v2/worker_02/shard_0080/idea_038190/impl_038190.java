...
@Data
public class Idea38190Config {
    private String name = "idea_038190";
 ...
 */
@Slf4j
public class Idea38190Service {
    private static final int IDEA_ID = 38190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38190Service() {
        this(new Idea38190Config());
    }

    public Idea38190Service(Idea38190Config config) {
        this.config = config != null ? config : new Idea38190Config();
