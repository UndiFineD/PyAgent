...
@Data
public class Idea38426Config {
    private String name = "idea_038426";
 ...
 */
@Slf4j
public class Idea38426Service {
    private static final int IDEA_ID = 38426;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38426Service() {
        this(new Idea38426Config());
    }

    public Idea38426Service(Idea38426Config config) {
        this.config = config != null ? config : new Idea38426Config();
