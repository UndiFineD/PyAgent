...
@Data
public class Idea38376Config {
    private String name = "idea_038376";
 ...
 */
@Slf4j
public class Idea38376Service {
    private static final int IDEA_ID = 38376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38376Service() {
        this(new Idea38376Config());
    }

    public Idea38376Service(Idea38376Config config) {
        this.config = config != null ? config : new Idea38376Config();
