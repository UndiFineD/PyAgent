...
@Data
public class Idea38237Config {
    private String name = "idea_038237";
 ...
 */
@Slf4j
public class Idea38237Service {
    private static final int IDEA_ID = 38237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38237Service() {
        this(new Idea38237Config());
    }

    public Idea38237Service(Idea38237Config config) {
        this.config = config != null ? config : new Idea38237Config();
