...
@Data
public class Idea38324Config {
    private String name = "idea_038324";
 ...
 */
@Slf4j
public class Idea38324Service {
    private static final int IDEA_ID = 38324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38324Service() {
        this(new Idea38324Config());
    }

    public Idea38324Service(Idea38324Config config) {
        this.config = config != null ? config : new Idea38324Config();
