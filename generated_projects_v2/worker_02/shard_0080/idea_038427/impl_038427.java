...
@Data
public class Idea38427Config {
    private String name = "idea_038427";
 ...
 */
@Slf4j
public class Idea38427Service {
    private static final int IDEA_ID = 38427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38427Service() {
        this(new Idea38427Config());
    }

    public Idea38427Service(Idea38427Config config) {
        this.config = config != null ? config : new Idea38427Config();
