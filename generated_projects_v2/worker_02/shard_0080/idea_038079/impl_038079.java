...
@Data
public class Idea38079Config {
    private String name = "idea_038079";
 ...
 */
@Slf4j
public class Idea38079Service {
    private static final int IDEA_ID = 38079;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38079Service() {
        this(new Idea38079Config());
    }

    public Idea38079Service(Idea38079Config config) {
        this.config = config != null ? config : new Idea38079Config();
