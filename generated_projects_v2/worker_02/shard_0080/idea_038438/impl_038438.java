...
@Data
public class Idea38438Config {
    private String name = "idea_038438";
 ...
 */
@Slf4j
public class Idea38438Service {
    private static final int IDEA_ID = 38438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38438Service() {
        this(new Idea38438Config());
    }

    public Idea38438Service(Idea38438Config config) {
        this.config = config != null ? config : new Idea38438Config();
