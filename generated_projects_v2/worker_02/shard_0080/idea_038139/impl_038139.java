...
@Data
public class Idea38139Config {
    private String name = "idea_038139";
 ...
 */
@Slf4j
public class Idea38139Service {
    private static final int IDEA_ID = 38139;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38139Service() {
        this(new Idea38139Config());
    }

    public Idea38139Service(Idea38139Config config) {
        this.config = config != null ? config : new Idea38139Config();
