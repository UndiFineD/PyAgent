...
@Data
public class Idea38464Config {
    private String name = "idea_038464";
 ...
 */
@Slf4j
public class Idea38464Service {
    private static final int IDEA_ID = 38464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38464Service() {
        this(new Idea38464Config());
    }

    public Idea38464Service(Idea38464Config config) {
        this.config = config != null ? config : new Idea38464Config();
