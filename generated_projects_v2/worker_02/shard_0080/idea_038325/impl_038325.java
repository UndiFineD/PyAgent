...
@Data
public class Idea38325Config {
    private String name = "idea_038325";
 ...
 */
@Slf4j
public class Idea38325Service {
    private static final int IDEA_ID = 38325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38325Service() {
        this(new Idea38325Config());
    }

    public Idea38325Service(Idea38325Config config) {
        this.config = config != null ? config : new Idea38325Config();
