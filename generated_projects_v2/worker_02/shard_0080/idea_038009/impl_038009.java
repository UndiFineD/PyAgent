...
@Data
public class Idea38009Config {
    private String name = "idea_038009";
 ...
 */
@Slf4j
public class Idea38009Service {
    private static final int IDEA_ID = 38009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38009Service() {
        this(new Idea38009Config());
    }

    public Idea38009Service(Idea38009Config config) {
        this.config = config != null ? config : new Idea38009Config();
