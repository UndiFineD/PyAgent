...
@Data
public class Idea38022Config {
    private String name = "idea_038022";
 ...
 */
@Slf4j
public class Idea38022Service {
    private static final int IDEA_ID = 38022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38022Service() {
        this(new Idea38022Config());
    }

    public Idea38022Service(Idea38022Config config) {
        this.config = config != null ? config : new Idea38022Config();
