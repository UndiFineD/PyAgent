...
@Data
public class Idea38251Config {
    private String name = "idea_038251";
 ...
 */
@Slf4j
public class Idea38251Service {
    private static final int IDEA_ID = 38251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38251Service() {
        this(new Idea38251Config());
    }

    public Idea38251Service(Idea38251Config config) {
        this.config = config != null ? config : new Idea38251Config();
