...
@Data
public class Idea38094Config {
    private String name = "idea_038094";
 ...
 */
@Slf4j
public class Idea38094Service {
    private static final int IDEA_ID = 38094;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38094Service() {
        this(new Idea38094Config());
    }

    public Idea38094Service(Idea38094Config config) {
        this.config = config != null ? config : new Idea38094Config();
