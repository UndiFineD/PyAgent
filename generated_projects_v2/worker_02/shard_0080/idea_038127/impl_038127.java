...
@Data
public class Idea38127Config {
    private String name = "idea_038127";
 ...
 */
@Slf4j
public class Idea38127Service {
    private static final int IDEA_ID = 38127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38127Service() {
        this(new Idea38127Config());
    }

    public Idea38127Service(Idea38127Config config) {
        this.config = config != null ? config : new Idea38127Config();
