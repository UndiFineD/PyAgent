...
@Data
public class Idea38206Config {
    private String name = "idea_038206";
 ...
 */
@Slf4j
public class Idea38206Service {
    private static final int IDEA_ID = 38206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38206Service() {
        this(new Idea38206Config());
    }

    public Idea38206Service(Idea38206Config config) {
        this.config = config != null ? config : new Idea38206Config();
