...
@Data
public class Idea38160Config {
    private String name = "idea_038160";
 ...
 */
@Slf4j
public class Idea38160Service {
    private static final int IDEA_ID = 38160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38160Service() {
        this(new Idea38160Config());
    }

    public Idea38160Service(Idea38160Config config) {
        this.config = config != null ? config : new Idea38160Config();
