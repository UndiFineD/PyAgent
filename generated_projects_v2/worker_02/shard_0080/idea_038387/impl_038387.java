...
@Data
public class Idea38387Config {
    private String name = "idea_038387";
 ...
 */
@Slf4j
public class Idea38387Service {
    private static final int IDEA_ID = 38387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38387Service() {
        this(new Idea38387Config());
    }

    public Idea38387Service(Idea38387Config config) {
        this.config = config != null ? config : new Idea38387Config();
