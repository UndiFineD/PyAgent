...
@Data
public class Idea38212Config {
    private String name = "idea_038212";
 ...
 */
@Slf4j
public class Idea38212Service {
    private static final int IDEA_ID = 38212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38212Service() {
        this(new Idea38212Config());
    }

    public Idea38212Service(Idea38212Config config) {
        this.config = config != null ? config : new Idea38212Config();
