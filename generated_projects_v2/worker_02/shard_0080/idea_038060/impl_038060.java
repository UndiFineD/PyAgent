...
@Data
public class Idea38060Config {
    private String name = "idea_038060";
 ...
 */
@Slf4j
public class Idea38060Service {
    private static final int IDEA_ID = 38060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38060Service() {
        this(new Idea38060Config());
    }

    public Idea38060Service(Idea38060Config config) {
        this.config = config != null ? config : new Idea38060Config();
