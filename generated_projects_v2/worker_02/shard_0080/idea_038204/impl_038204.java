...
@Data
public class Idea38204Config {
    private String name = "idea_038204";
 ...
 */
@Slf4j
public class Idea38204Service {
    private static final int IDEA_ID = 38204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38204Service() {
        this(new Idea38204Config());
    }

    public Idea38204Service(Idea38204Config config) {
        this.config = config != null ? config : new Idea38204Config();
