...
@Data
public class Idea38279Config {
    private String name = "idea_038279";
 ...
 */
@Slf4j
public class Idea38279Service {
    private static final int IDEA_ID = 38279;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38279Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38279Service() {
        this(new Idea38279Config());
    }

    public Idea38279Service(Idea38279Config config) {
        this.config = config != null ? config : new Idea38279Config();
