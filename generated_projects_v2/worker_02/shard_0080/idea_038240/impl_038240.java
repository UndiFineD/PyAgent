...
@Data
public class Idea38240Config {
    private String name = "idea_038240";
 ...
 */
@Slf4j
public class Idea38240Service {
    private static final int IDEA_ID = 38240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38240Service() {
        this(new Idea38240Config());
    }

    public Idea38240Service(Idea38240Config config) {
        this.config = config != null ? config : new Idea38240Config();
