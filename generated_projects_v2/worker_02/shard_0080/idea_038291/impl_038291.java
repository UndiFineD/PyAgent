...
@Data
public class Idea38291Config {
    private String name = "idea_038291";
 ...
 */
@Slf4j
public class Idea38291Service {
    private static final int IDEA_ID = 38291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38291Service() {
        this(new Idea38291Config());
    }

    public Idea38291Service(Idea38291Config config) {
        this.config = config != null ? config : new Idea38291Config();
