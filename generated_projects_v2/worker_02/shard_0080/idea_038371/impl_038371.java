...
@Data
public class Idea38371Config {
    private String name = "idea_038371";
 ...
 */
@Slf4j
public class Idea38371Service {
    private static final int IDEA_ID = 38371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38371Service() {
        this(new Idea38371Config());
    }

    public Idea38371Service(Idea38371Config config) {
        this.config = config != null ? config : new Idea38371Config();
