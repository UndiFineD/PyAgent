...
@Data
public class Idea38220Config {
    private String name = "idea_038220";
 ...
 */
@Slf4j
public class Idea38220Service {
    private static final int IDEA_ID = 38220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38220Service() {
        this(new Idea38220Config());
    }

    public Idea38220Service(Idea38220Config config) {
        this.config = config != null ? config : new Idea38220Config();
