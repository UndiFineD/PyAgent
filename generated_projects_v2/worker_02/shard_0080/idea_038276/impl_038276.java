...
@Data
public class Idea38276Config {
    private String name = "idea_038276";
 ...
 */
@Slf4j
public class Idea38276Service {
    private static final int IDEA_ID = 38276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38276Service() {
        this(new Idea38276Config());
    }

    public Idea38276Service(Idea38276Config config) {
        this.config = config != null ? config : new Idea38276Config();
