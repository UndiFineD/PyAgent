...
@Data
public class Idea38393Config {
    private String name = "idea_038393";
 ...
 */
@Slf4j
public class Idea38393Service {
    private static final int IDEA_ID = 38393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38393Service() {
        this(new Idea38393Config());
    }

    public Idea38393Service(Idea38393Config config) {
        this.config = config != null ? config : new Idea38393Config();
