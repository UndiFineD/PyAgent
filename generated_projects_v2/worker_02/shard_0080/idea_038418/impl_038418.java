...
@Data
public class Idea38418Config {
    private String name = "idea_038418";
 ...
 */
@Slf4j
public class Idea38418Service {
    private static final int IDEA_ID = 38418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38418Service() {
        this(new Idea38418Config());
    }

    public Idea38418Service(Idea38418Config config) {
        this.config = config != null ? config : new Idea38418Config();
