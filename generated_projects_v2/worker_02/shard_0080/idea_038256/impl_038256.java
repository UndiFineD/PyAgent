...
@Data
public class Idea38256Config {
    private String name = "idea_038256";
 ...
 */
@Slf4j
public class Idea38256Service {
    private static final int IDEA_ID = 38256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38256Service() {
        this(new Idea38256Config());
    }

    public Idea38256Service(Idea38256Config config) {
        this.config = config != null ? config : new Idea38256Config();
