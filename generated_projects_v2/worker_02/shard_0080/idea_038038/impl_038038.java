...
@Data
public class Idea38038Config {
    private String name = "idea_038038";
 ...
 */
@Slf4j
public class Idea38038Service {
    private static final int IDEA_ID = 38038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38038Service() {
        this(new Idea38038Config());
    }

    public Idea38038Service(Idea38038Config config) {
        this.config = config != null ? config : new Idea38038Config();
