...
@Data
public class Idea38402Config {
    private String name = "idea_038402";
 ...
 */
@Slf4j
public class Idea38402Service {
    private static final int IDEA_ID = 38402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38402Service() {
        this(new Idea38402Config());
    }

    public Idea38402Service(Idea38402Config config) {
        this.config = config != null ? config : new Idea38402Config();
