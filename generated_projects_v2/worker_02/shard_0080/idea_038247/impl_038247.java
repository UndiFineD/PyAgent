...
@Data
public class Idea38247Config {
    private String name = "idea_038247";
 ...
 */
@Slf4j
public class Idea38247Service {
    private static final int IDEA_ID = 38247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38247Service() {
        this(new Idea38247Config());
    }

    public Idea38247Service(Idea38247Config config) {
        this.config = config != null ? config : new Idea38247Config();
