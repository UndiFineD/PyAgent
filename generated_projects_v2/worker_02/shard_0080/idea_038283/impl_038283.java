...
@Data
public class Idea38283Config {
    private String name = "idea_038283";
 ...
 */
@Slf4j
public class Idea38283Service {
    private static final int IDEA_ID = 38283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38283Service() {
        this(new Idea38283Config());
    }

    public Idea38283Service(Idea38283Config config) {
        this.config = config != null ? config : new Idea38283Config();
