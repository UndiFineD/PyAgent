...
@Data
public class Idea38309Config {
    private String name = "idea_038309";
 ...
 */
@Slf4j
public class Idea38309Service {
    private static final int IDEA_ID = 38309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38309Service() {
        this(new Idea38309Config());
    }

    public Idea38309Service(Idea38309Config config) {
        this.config = config != null ? config : new Idea38309Config();
