...
@Data
public class Idea38292Config {
    private String name = "idea_038292";
 ...
 */
@Slf4j
public class Idea38292Service {
    private static final int IDEA_ID = 38292;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38292Service() {
        this(new Idea38292Config());
    }

    public Idea38292Service(Idea38292Config config) {
        this.config = config != null ? config : new Idea38292Config();
