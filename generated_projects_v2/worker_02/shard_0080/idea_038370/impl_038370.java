...
@Data
public class Idea38370Config {
    private String name = "idea_038370";
 ...
 */
@Slf4j
public class Idea38370Service {
    private static final int IDEA_ID = 38370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38370Service() {
        this(new Idea38370Config());
    }

    public Idea38370Service(Idea38370Config config) {
        this.config = config != null ? config : new Idea38370Config();
