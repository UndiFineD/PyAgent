...
@Data
public class Idea38042Config {
    private String name = "idea_038042";
 ...
 */
@Slf4j
public class Idea38042Service {
    private static final int IDEA_ID = 38042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38042Service() {
        this(new Idea38042Config());
    }

    public Idea38042Service(Idea38042Config config) {
        this.config = config != null ? config : new Idea38042Config();
