...
@Data
public class Idea38201Config {
    private String name = "idea_038201";
 ...
 */
@Slf4j
public class Idea38201Service {
    private static final int IDEA_ID = 38201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38201Service() {
        this(new Idea38201Config());
    }

    public Idea38201Service(Idea38201Config config) {
        this.config = config != null ? config : new Idea38201Config();
