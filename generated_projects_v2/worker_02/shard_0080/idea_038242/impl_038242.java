...
@Data
public class Idea38242Config {
    private String name = "idea_038242";
 ...
 */
@Slf4j
public class Idea38242Service {
    private static final int IDEA_ID = 38242;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38242Service() {
        this(new Idea38242Config());
    }

    public Idea38242Service(Idea38242Config config) {
        this.config = config != null ? config : new Idea38242Config();
