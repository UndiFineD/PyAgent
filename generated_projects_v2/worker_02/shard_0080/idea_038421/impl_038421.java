...
@Data
public class Idea38421Config {
    private String name = "idea_038421";
 ...
 */
@Slf4j
public class Idea38421Service {
    private static final int IDEA_ID = 38421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38421Service() {
        this(new Idea38421Config());
    }

    public Idea38421Service(Idea38421Config config) {
        this.config = config != null ? config : new Idea38421Config();
