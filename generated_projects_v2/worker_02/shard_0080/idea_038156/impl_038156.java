...
@Data
public class Idea38156Config {
    private String name = "idea_038156";
 ...
 */
@Slf4j
public class Idea38156Service {
    private static final int IDEA_ID = 38156;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38156Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38156Service() {
        this(new Idea38156Config());
    }

    public Idea38156Service(Idea38156Config config) {
        this.config = config != null ? config : new Idea38156Config();
