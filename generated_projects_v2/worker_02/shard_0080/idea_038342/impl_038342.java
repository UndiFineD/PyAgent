...
@Data
public class Idea38342Config {
    private String name = "idea_038342";
 ...
 */
@Slf4j
public class Idea38342Service {
    private static final int IDEA_ID = 38342;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38342Service() {
        this(new Idea38342Config());
    }

    public Idea38342Service(Idea38342Config config) {
        this.config = config != null ? config : new Idea38342Config();
