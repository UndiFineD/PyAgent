...
@Data
public class Idea38195Config {
    private String name = "idea_038195";
 ...
 */
@Slf4j
public class Idea38195Service {
    private static final int IDEA_ID = 38195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38195Service() {
        this(new Idea38195Config());
    }

    public Idea38195Service(Idea38195Config config) {
        this.config = config != null ? config : new Idea38195Config();
