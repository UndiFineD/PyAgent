...
@Data
public class Idea38199Config {
    private String name = "idea_038199";
 ...
 */
@Slf4j
public class Idea38199Service {
    private static final int IDEA_ID = 38199;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38199Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38199Service() {
        this(new Idea38199Config());
    }

    public Idea38199Service(Idea38199Config config) {
        this.config = config != null ? config : new Idea38199Config();
