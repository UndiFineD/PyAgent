...
@Data
public class Idea38255Config {
    private String name = "idea_038255";
 ...
 */
@Slf4j
public class Idea38255Service {
    private static final int IDEA_ID = 38255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38255Service() {
        this(new Idea38255Config());
    }

    public Idea38255Service(Idea38255Config config) {
        this.config = config != null ? config : new Idea38255Config();
