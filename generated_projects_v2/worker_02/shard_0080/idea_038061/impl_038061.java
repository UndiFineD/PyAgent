...
@Data
public class Idea38061Config {
    private String name = "idea_038061";
 ...
 */
@Slf4j
public class Idea38061Service {
    private static final int IDEA_ID = 38061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38061Service() {
        this(new Idea38061Config());
    }

    public Idea38061Service(Idea38061Config config) {
        this.config = config != null ? config : new Idea38061Config();
