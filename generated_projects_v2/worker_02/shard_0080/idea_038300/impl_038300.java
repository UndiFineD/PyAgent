...
@Data
public class Idea38300Config {
    private String name = "idea_038300";
 ...
 */
@Slf4j
public class Idea38300Service {
    private static final int IDEA_ID = 38300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38300Service() {
        this(new Idea38300Config());
    }

    public Idea38300Service(Idea38300Config config) {
        this.config = config != null ? config : new Idea38300Config();
