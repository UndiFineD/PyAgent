...
@Data
public class Idea38179Config {
    private String name = "idea_038179";
 ...
 */
@Slf4j
public class Idea38179Service {
    private static final int IDEA_ID = 38179;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38179Service() {
        this(new Idea38179Config());
    }

    public Idea38179Service(Idea38179Config config) {
        this.config = config != null ? config : new Idea38179Config();
