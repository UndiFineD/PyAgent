...
@Data
public class Idea38185Config {
    private String name = "idea_038185";
 ...
 */
@Slf4j
public class Idea38185Service {
    private static final int IDEA_ID = 38185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38185Service() {
        this(new Idea38185Config());
    }

    public Idea38185Service(Idea38185Config config) {
        this.config = config != null ? config : new Idea38185Config();
