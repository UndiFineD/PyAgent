...
@Data
public class Idea38332Config {
    private String name = "idea_038332";
 ...
 */
@Slf4j
public class Idea38332Service {
    private static final int IDEA_ID = 38332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38332Service() {
        this(new Idea38332Config());
    }

    public Idea38332Service(Idea38332Config config) {
        this.config = config != null ? config : new Idea38332Config();
