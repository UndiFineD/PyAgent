...
@Data
public class Idea38314Config {
    private String name = "idea_038314";
 ...
 */
@Slf4j
public class Idea38314Service {
    private static final int IDEA_ID = 38314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38314Service() {
        this(new Idea38314Config());
    }

    public Idea38314Service(Idea38314Config config) {
        this.config = config != null ? config : new Idea38314Config();
