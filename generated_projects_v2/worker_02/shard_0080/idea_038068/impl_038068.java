...
@Data
public class Idea38068Config {
    private String name = "idea_038068";
 ...
 */
@Slf4j
public class Idea38068Service {
    private static final int IDEA_ID = 38068;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38068Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38068Service() {
        this(new Idea38068Config());
    }

    public Idea38068Service(Idea38068Config config) {
        this.config = config != null ? config : new Idea38068Config();
