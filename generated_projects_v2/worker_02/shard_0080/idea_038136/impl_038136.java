...
@Data
public class Idea38136Config {
    private String name = "idea_038136";
 ...
 */
@Slf4j
public class Idea38136Service {
    private static final int IDEA_ID = 38136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38136Service() {
        this(new Idea38136Config());
    }

    public Idea38136Service(Idea38136Config config) {
        this.config = config != null ? config : new Idea38136Config();
