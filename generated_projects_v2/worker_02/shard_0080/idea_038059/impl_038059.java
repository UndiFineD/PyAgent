...
@Data
public class Idea38059Config {
    private String name = "idea_038059";
 ...
 */
@Slf4j
public class Idea38059Service {
    private static final int IDEA_ID = 38059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38059Service() {
        this(new Idea38059Config());
    }

    public Idea38059Service(Idea38059Config config) {
        this.config = config != null ? config : new Idea38059Config();
