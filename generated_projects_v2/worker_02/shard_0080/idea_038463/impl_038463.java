...
@Data
public class Idea38463Config {
    private String name = "idea_038463";
 ...
 */
@Slf4j
public class Idea38463Service {
    private static final int IDEA_ID = 38463;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38463Service() {
        this(new Idea38463Config());
    }

    public Idea38463Service(Idea38463Config config) {
        this.config = config != null ? config : new Idea38463Config();
