...
@Data
public class Idea38235Config {
    private String name = "idea_038235";
 ...
 */
@Slf4j
public class Idea38235Service {
    private static final int IDEA_ID = 38235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38235Service() {
        this(new Idea38235Config());
    }

    public Idea38235Service(Idea38235Config config) {
        this.config = config != null ? config : new Idea38235Config();
