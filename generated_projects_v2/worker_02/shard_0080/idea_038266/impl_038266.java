...
@Data
public class Idea38266Config {
    private String name = "idea_038266";
 ...
 */
@Slf4j
public class Idea38266Service {
    private static final int IDEA_ID = 38266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38266Service() {
        this(new Idea38266Config());
    }

    public Idea38266Service(Idea38266Config config) {
        this.config = config != null ? config : new Idea38266Config();
