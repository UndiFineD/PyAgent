...
@Data
public class Idea38471Config {
    private String name = "idea_038471";
 ...
 */
@Slf4j
public class Idea38471Service {
    private static final int IDEA_ID = 38471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38471Service() {
        this(new Idea38471Config());
    }

    public Idea38471Service(Idea38471Config config) {
        this.config = config != null ? config : new Idea38471Config();
