...
@Data
public class Idea38096Config {
    private String name = "idea_038096";
 ...
 */
@Slf4j
public class Idea38096Service {
    private static final int IDEA_ID = 38096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38096Service() {
        this(new Idea38096Config());
    }

    public Idea38096Service(Idea38096Config config) {
        this.config = config != null ? config : new Idea38096Config();
