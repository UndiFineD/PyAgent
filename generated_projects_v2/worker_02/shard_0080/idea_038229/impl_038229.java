...
@Data
public class Idea38229Config {
    private String name = "idea_038229";
 ...
 */
@Slf4j
public class Idea38229Service {
    private static final int IDEA_ID = 38229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38229Service() {
        this(new Idea38229Config());
    }

    public Idea38229Service(Idea38229Config config) {
        this.config = config != null ? config : new Idea38229Config();
