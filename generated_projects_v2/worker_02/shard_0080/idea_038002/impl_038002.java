...
@Data
public class Idea38002Config {
    private String name = "idea_038002";
 ...
 */
@Slf4j
public class Idea38002Service {
    private static final int IDEA_ID = 38002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38002Service() {
        this(new Idea38002Config());
    }

    public Idea38002Service(Idea38002Config config) {
        this.config = config != null ? config : new Idea38002Config();
