...
@Data
public class Idea38143Config {
    private String name = "idea_038143";
 ...
 */
@Slf4j
public class Idea38143Service {
    private static final int IDEA_ID = 38143;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38143Service() {
        this(new Idea38143Config());
    }

    public Idea38143Service(Idea38143Config config) {
        this.config = config != null ? config : new Idea38143Config();
