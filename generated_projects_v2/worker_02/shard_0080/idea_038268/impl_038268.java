...
@Data
public class Idea38268Config {
    private String name = "idea_038268";
 ...
 */
@Slf4j
public class Idea38268Service {
    private static final int IDEA_ID = 38268;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38268Service() {
        this(new Idea38268Config());
    }

    public Idea38268Service(Idea38268Config config) {
        this.config = config != null ? config : new Idea38268Config();
