...
@Data
public class Idea38412Config {
    private String name = "idea_038412";
 ...
 */
@Slf4j
public class Idea38412Service {
    private static final int IDEA_ID = 38412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38412Service() {
        this(new Idea38412Config());
    }

    public Idea38412Service(Idea38412Config config) {
        this.config = config != null ? config : new Idea38412Config();
