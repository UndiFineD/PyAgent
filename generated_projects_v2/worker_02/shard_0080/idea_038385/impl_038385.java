...
@Data
public class Idea38385Config {
    private String name = "idea_038385";
 ...
 */
@Slf4j
public class Idea38385Service {
    private static final int IDEA_ID = 38385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38385Service() {
        this(new Idea38385Config());
    }

    public Idea38385Service(Idea38385Config config) {
        this.config = config != null ? config : new Idea38385Config();
