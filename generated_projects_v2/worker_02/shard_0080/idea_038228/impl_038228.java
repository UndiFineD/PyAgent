...
@Data
public class Idea38228Config {
    private String name = "idea_038228";
 ...
 */
@Slf4j
public class Idea38228Service {
    private static final int IDEA_ID = 38228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38228Service() {
        this(new Idea38228Config());
    }

    public Idea38228Service(Idea38228Config config) {
        this.config = config != null ? config : new Idea38228Config();
