...
@Data
public class Idea38043Config {
    private String name = "idea_038043";
 ...
 */
@Slf4j
public class Idea38043Service {
    private static final int IDEA_ID = 38043;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38043Service() {
        this(new Idea38043Config());
    }

    public Idea38043Service(Idea38043Config config) {
        this.config = config != null ? config : new Idea38043Config();
