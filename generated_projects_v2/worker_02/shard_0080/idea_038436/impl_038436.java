...
@Data
public class Idea38436Config {
    private String name = "idea_038436";
 ...
 */
@Slf4j
public class Idea38436Service {
    private static final int IDEA_ID = 38436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38436Service() {
        this(new Idea38436Config());
    }

    public Idea38436Service(Idea38436Config config) {
        this.config = config != null ? config : new Idea38436Config();
