...
@Data
public class Idea38357Config {
    private String name = "idea_038357";
 ...
 */
@Slf4j
public class Idea38357Service {
    private static final int IDEA_ID = 38357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38357Service() {
        this(new Idea38357Config());
    }

    public Idea38357Service(Idea38357Config config) {
        this.config = config != null ? config : new Idea38357Config();
