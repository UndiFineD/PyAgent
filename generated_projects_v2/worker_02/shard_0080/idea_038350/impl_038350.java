...
@Data
public class Idea38350Config {
    private String name = "idea_038350";
 ...
 */
@Slf4j
public class Idea38350Service {
    private static final int IDEA_ID = 38350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38350Service() {
        this(new Idea38350Config());
    }

    public Idea38350Service(Idea38350Config config) {
        this.config = config != null ? config : new Idea38350Config();
