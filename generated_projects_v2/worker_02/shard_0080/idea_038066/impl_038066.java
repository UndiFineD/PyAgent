...
@Data
public class Idea38066Config {
    private String name = "idea_038066";
 ...
 */
@Slf4j
public class Idea38066Service {
    private static final int IDEA_ID = 38066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38066Service() {
        this(new Idea38066Config());
    }

    public Idea38066Service(Idea38066Config config) {
        this.config = config != null ? config : new Idea38066Config();
