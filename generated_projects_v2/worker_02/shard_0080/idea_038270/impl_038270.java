...
@Data
public class Idea38270Config {
    private String name = "idea_038270";
 ...
 */
@Slf4j
public class Idea38270Service {
    private static final int IDEA_ID = 38270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38270Service() {
        this(new Idea38270Config());
    }

    public Idea38270Service(Idea38270Config config) {
        this.config = config != null ? config : new Idea38270Config();
