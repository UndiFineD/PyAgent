...
@Data
public class Idea38104Config {
    private String name = "idea_038104";
 ...
 */
@Slf4j
public class Idea38104Service {
    private static final int IDEA_ID = 38104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38104Service() {
        this(new Idea38104Config());
    }

    public Idea38104Service(Idea38104Config config) {
        this.config = config != null ? config : new Idea38104Config();
