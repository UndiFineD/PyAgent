...
@Data
public class Idea38082Config {
    private String name = "idea_038082";
 ...
 */
@Slf4j
public class Idea38082Service {
    private static final int IDEA_ID = 38082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38082Service() {
        this(new Idea38082Config());
    }

    public Idea38082Service(Idea38082Config config) {
        this.config = config != null ? config : new Idea38082Config();
