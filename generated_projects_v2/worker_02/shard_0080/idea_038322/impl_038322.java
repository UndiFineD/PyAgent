...
@Data
public class Idea38322Config {
    private String name = "idea_038322";
 ...
 */
@Slf4j
public class Idea38322Service {
    private static final int IDEA_ID = 38322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38322Service() {
        this(new Idea38322Config());
    }

    public Idea38322Service(Idea38322Config config) {
        this.config = config != null ? config : new Idea38322Config();
