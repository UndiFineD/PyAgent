...
@Data
public class Idea38214Config {
    private String name = "idea_038214";
 ...
 */
@Slf4j
public class Idea38214Service {
    private static final int IDEA_ID = 38214;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38214Service() {
        this(new Idea38214Config());
    }

    public Idea38214Service(Idea38214Config config) {
        this.config = config != null ? config : new Idea38214Config();
