...
@Data
public class Idea38016Config {
    private String name = "idea_038016";
 ...
 */
@Slf4j
public class Idea38016Service {
    private static final int IDEA_ID = 38016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38016Service() {
        this(new Idea38016Config());
    }

    public Idea38016Service(Idea38016Config config) {
        this.config = config != null ? config : new Idea38016Config();
