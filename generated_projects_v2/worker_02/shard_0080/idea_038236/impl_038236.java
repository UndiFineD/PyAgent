...
@Data
public class Idea38236Config {
    private String name = "idea_038236";
 ...
 */
@Slf4j
public class Idea38236Service {
    private static final int IDEA_ID = 38236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38236Service() {
        this(new Idea38236Config());
    }

    public Idea38236Service(Idea38236Config config) {
        this.config = config != null ? config : new Idea38236Config();
