...
@Data
public class Idea38453Config {
    private String name = "idea_038453";
 ...
 */
@Slf4j
public class Idea38453Service {
    private static final int IDEA_ID = 38453;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38453Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38453Service() {
        this(new Idea38453Config());
    }

    public Idea38453Service(Idea38453Config config) {
        this.config = config != null ? config : new Idea38453Config();
