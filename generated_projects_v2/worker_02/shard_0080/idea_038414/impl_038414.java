...
@Data
public class Idea38414Config {
    private String name = "idea_038414";
 ...
 */
@Slf4j
public class Idea38414Service {
    private static final int IDEA_ID = 38414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38414Service() {
        this(new Idea38414Config());
    }

    public Idea38414Service(Idea38414Config config) {
        this.config = config != null ? config : new Idea38414Config();
