...
@Data
public class Idea38407Config {
    private String name = "idea_038407";
 ...
 */
@Slf4j
public class Idea38407Service {
    private static final int IDEA_ID = 38407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38407Service() {
        this(new Idea38407Config());
    }

    public Idea38407Service(Idea38407Config config) {
        this.config = config != null ? config : new Idea38407Config();
