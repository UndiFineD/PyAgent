...
@Data
public class Idea38354Config {
    private String name = "idea_038354";
 ...
 */
@Slf4j
public class Idea38354Service {
    private static final int IDEA_ID = 38354;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38354Service() {
        this(new Idea38354Config());
    }

    public Idea38354Service(Idea38354Config config) {
        this.config = config != null ? config : new Idea38354Config();
