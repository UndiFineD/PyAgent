...
@Data
public class Idea38406Config {
    private String name = "idea_038406";
 ...
 */
@Slf4j
public class Idea38406Service {
    private static final int IDEA_ID = 38406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38406Service() {
        this(new Idea38406Config());
    }

    public Idea38406Service(Idea38406Config config) {
        this.config = config != null ? config : new Idea38406Config();
