...
@Data
public class Idea38326Config {
    private String name = "idea_038326";
 ...
 */
@Slf4j
public class Idea38326Service {
    private static final int IDEA_ID = 38326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38326Service() {
        this(new Idea38326Config());
    }

    public Idea38326Service(Idea38326Config config) {
        this.config = config != null ? config : new Idea38326Config();
