...
@Data
public class Idea38012Config {
    private String name = "idea_038012";
 ...
 */
@Slf4j
public class Idea38012Service {
    private static final int IDEA_ID = 38012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38012Service() {
        this(new Idea38012Config());
    }

    public Idea38012Service(Idea38012Config config) {
        this.config = config != null ? config : new Idea38012Config();
