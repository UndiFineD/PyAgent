...
@Data
public class Idea38447Config {
    private String name = "idea_038447";
 ...
 */
@Slf4j
public class Idea38447Service {
    private static final int IDEA_ID = 38447;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38447Service() {
        this(new Idea38447Config());
    }

    public Idea38447Service(Idea38447Config config) {
        this.config = config != null ? config : new Idea38447Config();
