...
@Data
public class Idea38162Config {
    private String name = "idea_038162";
 ...
 */
@Slf4j
public class Idea38162Service {
    private static final int IDEA_ID = 38162;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38162Service() {
        this(new Idea38162Config());
    }

    public Idea38162Service(Idea38162Config config) {
        this.config = config != null ? config : new Idea38162Config();
