...
@Data
public class Idea38111Config {
    private String name = "idea_038111";
 ...
 */
@Slf4j
public class Idea38111Service {
    private static final int IDEA_ID = 38111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38111Service() {
        this(new Idea38111Config());
    }

    public Idea38111Service(Idea38111Config config) {
        this.config = config != null ? config : new Idea38111Config();
