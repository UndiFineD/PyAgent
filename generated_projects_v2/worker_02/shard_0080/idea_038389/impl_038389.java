...
@Data
public class Idea38389Config {
    private String name = "idea_038389";
 ...
 */
@Slf4j
public class Idea38389Service {
    private static final int IDEA_ID = 38389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38389Service() {
        this(new Idea38389Config());
    }

    public Idea38389Service(Idea38389Config config) {
        this.config = config != null ? config : new Idea38389Config();
