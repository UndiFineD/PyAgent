...
@Data
public class Idea38397Config {
    private String name = "idea_038397";
 ...
 */
@Slf4j
public class Idea38397Service {
    private static final int IDEA_ID = 38397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38397Service() {
        this(new Idea38397Config());
    }

    public Idea38397Service(Idea38397Config config) {
        this.config = config != null ? config : new Idea38397Config();
