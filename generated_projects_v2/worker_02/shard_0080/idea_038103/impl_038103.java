...
@Data
public class Idea38103Config {
    private String name = "idea_038103";
 ...
 */
@Slf4j
public class Idea38103Service {
    private static final int IDEA_ID = 38103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38103Service() {
        this(new Idea38103Config());
    }

    public Idea38103Service(Idea38103Config config) {
        this.config = config != null ? config : new Idea38103Config();
