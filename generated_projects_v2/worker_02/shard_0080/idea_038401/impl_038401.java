...
@Data
public class Idea38401Config {
    private String name = "idea_038401";
 ...
 */
@Slf4j
public class Idea38401Service {
    private static final int IDEA_ID = 38401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38401Service() {
        this(new Idea38401Config());
    }

    public Idea38401Service(Idea38401Config config) {
        this.config = config != null ? config : new Idea38401Config();
