...
@Data
public class Idea38253Config {
    private String name = "idea_038253";
 ...
 */
@Slf4j
public class Idea38253Service {
    private static final int IDEA_ID = 38253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38253Service() {
        this(new Idea38253Config());
    }

    public Idea38253Service(Idea38253Config config) {
        this.config = config != null ? config : new Idea38253Config();
