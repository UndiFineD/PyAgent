...
@Data
public class Idea38105Config {
    private String name = "idea_038105";
 ...
 */
@Slf4j
public class Idea38105Service {
    private static final int IDEA_ID = 38105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38105Service() {
        this(new Idea38105Config());
    }

    public Idea38105Service(Idea38105Config config) {
        this.config = config != null ? config : new Idea38105Config();
