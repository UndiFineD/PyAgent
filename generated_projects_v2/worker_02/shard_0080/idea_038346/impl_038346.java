...
@Data
public class Idea38346Config {
    private String name = "idea_038346";
 ...
 */
@Slf4j
public class Idea38346Service {
    private static final int IDEA_ID = 38346;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38346Service() {
        this(new Idea38346Config());
    }

    public Idea38346Service(Idea38346Config config) {
        this.config = config != null ? config : new Idea38346Config();
