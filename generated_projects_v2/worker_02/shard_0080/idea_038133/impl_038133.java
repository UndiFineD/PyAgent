...
@Data
public class Idea38133Config {
    private String name = "idea_038133";
 ...
 */
@Slf4j
public class Idea38133Service {
    private static final int IDEA_ID = 38133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38133Service() {
        this(new Idea38133Config());
    }

    public Idea38133Service(Idea38133Config config) {
        this.config = config != null ? config : new Idea38133Config();
