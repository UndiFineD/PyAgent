...
@Data
public class Idea38010Config {
    private String name = "idea_038010";
 ...
 */
@Slf4j
public class Idea38010Service {
    private static final int IDEA_ID = 38010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38010Service() {
        this(new Idea38010Config());
    }

    public Idea38010Service(Idea38010Config config) {
        this.config = config != null ? config : new Idea38010Config();
