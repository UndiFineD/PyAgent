...
@Data
public class Idea38200Config {
    private String name = "idea_038200";
 ...
 */
@Slf4j
public class Idea38200Service {
    private static final int IDEA_ID = 38200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38200Service() {
        this(new Idea38200Config());
    }

    public Idea38200Service(Idea38200Config config) {
        this.config = config != null ? config : new Idea38200Config();
