...
@Data
public class Idea38086Config {
    private String name = "idea_038086";
 ...
 */
@Slf4j
public class Idea38086Service {
    private static final int IDEA_ID = 38086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38086Service() {
        this(new Idea38086Config());
    }

    public Idea38086Service(Idea38086Config config) {
        this.config = config != null ? config : new Idea38086Config();
