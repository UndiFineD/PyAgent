...
@Data
public class Idea38077Config {
    private String name = "idea_038077";
 ...
 */
@Slf4j
public class Idea38077Service {
    private static final int IDEA_ID = 38077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38077Service() {
        this(new Idea38077Config());
    }

    public Idea38077Service(Idea38077Config config) {
        this.config = config != null ? config : new Idea38077Config();
