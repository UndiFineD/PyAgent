...
@Data
public class Idea38302Config {
    private String name = "idea_038302";
 ...
 */
@Slf4j
public class Idea38302Service {
    private static final int IDEA_ID = 38302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38302Service() {
        this(new Idea38302Config());
    }

    public Idea38302Service(Idea38302Config config) {
        this.config = config != null ? config : new Idea38302Config();
