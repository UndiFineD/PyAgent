...
@Data
public class Idea38005Config {
    private String name = "idea_038005";
 ...
 */
@Slf4j
public class Idea38005Service {
    private static final int IDEA_ID = 38005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38005Service() {
        this(new Idea38005Config());
    }

    public Idea38005Service(Idea38005Config config) {
        this.config = config != null ? config : new Idea38005Config();
