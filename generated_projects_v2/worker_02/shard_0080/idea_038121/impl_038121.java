...
@Data
public class Idea38121Config {
    private String name = "idea_038121";
 ...
 */
@Slf4j
public class Idea38121Service {
    private static final int IDEA_ID = 38121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38121Service() {
        this(new Idea38121Config());
    }

    public Idea38121Service(Idea38121Config config) {
        this.config = config != null ? config : new Idea38121Config();
