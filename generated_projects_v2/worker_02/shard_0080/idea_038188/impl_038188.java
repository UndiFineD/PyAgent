...
@Data
public class Idea38188Config {
    private String name = "idea_038188";
 ...
 */
@Slf4j
public class Idea38188Service {
    private static final int IDEA_ID = 38188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38188Service() {
        this(new Idea38188Config());
    }

    public Idea38188Service(Idea38188Config config) {
        this.config = config != null ? config : new Idea38188Config();
