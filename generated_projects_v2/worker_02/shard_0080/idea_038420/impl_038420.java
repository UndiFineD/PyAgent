...
@Data
public class Idea38420Config {
    private String name = "idea_038420";
 ...
 */
@Slf4j
public class Idea38420Service {
    private static final int IDEA_ID = 38420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38420Service() {
        this(new Idea38420Config());
    }

    public Idea38420Service(Idea38420Config config) {
        this.config = config != null ? config : new Idea38420Config();
