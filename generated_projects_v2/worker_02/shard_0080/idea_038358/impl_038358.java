...
@Data
public class Idea38358Config {
    private String name = "idea_038358";
 ...
 */
@Slf4j
public class Idea38358Service {
    private static final int IDEA_ID = 38358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38358Service() {
        this(new Idea38358Config());
    }

    public Idea38358Service(Idea38358Config config) {
        this.config = config != null ? config : new Idea38358Config();
