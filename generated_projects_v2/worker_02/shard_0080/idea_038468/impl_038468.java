...
@Data
public class Idea38468Config {
    private String name = "idea_038468";
 ...
 */
@Slf4j
public class Idea38468Service {
    private static final int IDEA_ID = 38468;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38468Service() {
        this(new Idea38468Config());
    }

    public Idea38468Service(Idea38468Config config) {
        this.config = config != null ? config : new Idea38468Config();
