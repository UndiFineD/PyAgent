...
@Data
public class Idea38134Config {
    private String name = "idea_038134";
 ...
 */
@Slf4j
public class Idea38134Service {
    private static final int IDEA_ID = 38134;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38134Service() {
        this(new Idea38134Config());
    }

    public Idea38134Service(Idea38134Config config) {
        this.config = config != null ? config : new Idea38134Config();
