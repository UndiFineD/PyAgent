...
@Data
public class Idea38129Config {
    private String name = "idea_038129";
 ...
 */
@Slf4j
public class Idea38129Service {
    private static final int IDEA_ID = 38129;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38129Service() {
        this(new Idea38129Config());
    }

    public Idea38129Service(Idea38129Config config) {
        this.config = config != null ? config : new Idea38129Config();
