...
@Data
public class Idea38347Config {
    private String name = "idea_038347";
 ...
 */
@Slf4j
public class Idea38347Service {
    private static final int IDEA_ID = 38347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38347Service() {
        this(new Idea38347Config());
    }

    public Idea38347Service(Idea38347Config config) {
        this.config = config != null ? config : new Idea38347Config();
