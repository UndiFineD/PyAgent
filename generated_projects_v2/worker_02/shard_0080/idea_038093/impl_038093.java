...
@Data
public class Idea38093Config {
    private String name = "idea_038093";
 ...
 */
@Slf4j
public class Idea38093Service {
    private static final int IDEA_ID = 38093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38093Service() {
        this(new Idea38093Config());
    }

    public Idea38093Service(Idea38093Config config) {
        this.config = config != null ? config : new Idea38093Config();
