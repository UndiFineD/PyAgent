...
@Data
public class Idea38328Config {
    private String name = "idea_038328";
 ...
 */
@Slf4j
public class Idea38328Service {
    private static final int IDEA_ID = 38328;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38328Service() {
        this(new Idea38328Config());
    }

    public Idea38328Service(Idea38328Config config) {
        this.config = config != null ? config : new Idea38328Config();
