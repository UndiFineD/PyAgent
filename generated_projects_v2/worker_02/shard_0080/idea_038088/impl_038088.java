...
@Data
public class Idea38088Config {
    private String name = "idea_038088";
 ...
 */
@Slf4j
public class Idea38088Service {
    private static final int IDEA_ID = 38088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38088Service() {
        this(new Idea38088Config());
    }

    public Idea38088Service(Idea38088Config config) {
        this.config = config != null ? config : new Idea38088Config();
