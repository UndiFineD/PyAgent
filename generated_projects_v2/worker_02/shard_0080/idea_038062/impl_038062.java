...
@Data
public class Idea38062Config {
    private String name = "idea_038062";
 ...
 */
@Slf4j
public class Idea38062Service {
    private static final int IDEA_ID = 38062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38062Service() {
        this(new Idea38062Config());
    }

    public Idea38062Service(Idea38062Config config) {
        this.config = config != null ? config : new Idea38062Config();
