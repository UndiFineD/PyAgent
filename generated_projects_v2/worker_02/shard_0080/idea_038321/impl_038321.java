...
@Data
public class Idea38321Config {
    private String name = "idea_038321";
 ...
 */
@Slf4j
public class Idea38321Service {
    private static final int IDEA_ID = 38321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38321Service() {
        this(new Idea38321Config());
    }

    public Idea38321Service(Idea38321Config config) {
        this.config = config != null ? config : new Idea38321Config();
