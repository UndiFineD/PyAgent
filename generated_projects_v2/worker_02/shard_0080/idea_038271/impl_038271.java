...
@Data
public class Idea38271Config {
    private String name = "idea_038271";
 ...
 */
@Slf4j
public class Idea38271Service {
    private static final int IDEA_ID = 38271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38271Service() {
        this(new Idea38271Config());
    }

    public Idea38271Service(Idea38271Config config) {
        this.config = config != null ? config : new Idea38271Config();
