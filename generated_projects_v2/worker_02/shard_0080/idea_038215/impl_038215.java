...
@Data
public class Idea38215Config {
    private String name = "idea_038215";
 ...
 */
@Slf4j
public class Idea38215Service {
    private static final int IDEA_ID = 38215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38215Service() {
        this(new Idea38215Config());
    }

    public Idea38215Service(Idea38215Config config) {
        this.config = config != null ? config : new Idea38215Config();
