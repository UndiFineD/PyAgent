...
@Data
public class Idea38014Config {
    private String name = "idea_038014";
 ...
 */
@Slf4j
public class Idea38014Service {
    private static final int IDEA_ID = 38014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38014Service() {
        this(new Idea38014Config());
    }

    public Idea38014Service(Idea38014Config config) {
        this.config = config != null ? config : new Idea38014Config();
