...
@Data
public class Idea38167Config {
    private String name = "idea_038167";
 ...
 */
@Slf4j
public class Idea38167Service {
    private static final int IDEA_ID = 38167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38167Service() {
        this(new Idea38167Config());
    }

    public Idea38167Service(Idea38167Config config) {
        this.config = config != null ? config : new Idea38167Config();
