...
@Data
public class Idea38222Config {
    private String name = "idea_038222";
 ...
 */
@Slf4j
public class Idea38222Service {
    private static final int IDEA_ID = 38222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38222Service() {
        this(new Idea38222Config());
    }

    public Idea38222Service(Idea38222Config config) {
        this.config = config != null ? config : new Idea38222Config();
