...
@Data
public class Idea38381Config {
    private String name = "idea_038381";
 ...
 */
@Slf4j
public class Idea38381Service {
    private static final int IDEA_ID = 38381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38381Service() {
        this(new Idea38381Config());
    }

    public Idea38381Service(Idea38381Config config) {
        this.config = config != null ? config : new Idea38381Config();
