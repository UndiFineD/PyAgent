...
@Data
public class Idea38213Config {
    private String name = "idea_038213";
 ...
 */
@Slf4j
public class Idea38213Service {
    private static final int IDEA_ID = 38213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38213Service() {
        this(new Idea38213Config());
    }

    public Idea38213Service(Idea38213Config config) {
        this.config = config != null ? config : new Idea38213Config();
