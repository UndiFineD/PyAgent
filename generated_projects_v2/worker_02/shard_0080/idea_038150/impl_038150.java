...
@Data
public class Idea38150Config {
    private String name = "idea_038150";
 ...
 */
@Slf4j
public class Idea38150Service {
    private static final int IDEA_ID = 38150;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38150Service() {
        this(new Idea38150Config());
    }

    public Idea38150Service(Idea38150Config config) {
        this.config = config != null ? config : new Idea38150Config();
