...
@Data
public class Idea38081Config {
    private String name = "idea_038081";
 ...
 */
@Slf4j
public class Idea38081Service {
    private static final int IDEA_ID = 38081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38081Service() {
        this(new Idea38081Config());
    }

    public Idea38081Service(Idea38081Config config) {
        this.config = config != null ? config : new Idea38081Config();
