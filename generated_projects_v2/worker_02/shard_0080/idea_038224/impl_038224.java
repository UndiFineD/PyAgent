...
@Data
public class Idea38224Config {
    private String name = "idea_038224";
 ...
 */
@Slf4j
public class Idea38224Service {
    private static final int IDEA_ID = 38224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38224Service() {
        this(new Idea38224Config());
    }

    public Idea38224Service(Idea38224Config config) {
        this.config = config != null ? config : new Idea38224Config();
