...
@Data
public class Idea38374Config {
    private String name = "idea_038374";
 ...
 */
@Slf4j
public class Idea38374Service {
    private static final int IDEA_ID = 38374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38374Service() {
        this(new Idea38374Config());
    }

    public Idea38374Service(Idea38374Config config) {
        this.config = config != null ? config : new Idea38374Config();
