...
@Data
public class Idea38437Config {
    private String name = "idea_038437";
 ...
 */
@Slf4j
public class Idea38437Service {
    private static final int IDEA_ID = 38437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38437Service() {
        this(new Idea38437Config());
    }

    public Idea38437Service(Idea38437Config config) {
        this.config = config != null ? config : new Idea38437Config();
