...
@Data
public class Idea38117Config {
    private String name = "idea_038117";
 ...
 */
@Slf4j
public class Idea38117Service {
    private static final int IDEA_ID = 38117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38117Service() {
        this(new Idea38117Config());
    }

    public Idea38117Service(Idea38117Config config) {
        this.config = config != null ? config : new Idea38117Config();
