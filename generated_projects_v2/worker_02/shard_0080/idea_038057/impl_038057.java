...
@Data
public class Idea38057Config {
    private String name = "idea_038057";
 ...
 */
@Slf4j
public class Idea38057Service {
    private static final int IDEA_ID = 38057;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38057Service() {
        this(new Idea38057Config());
    }

    public Idea38057Service(Idea38057Config config) {
        this.config = config != null ? config : new Idea38057Config();
