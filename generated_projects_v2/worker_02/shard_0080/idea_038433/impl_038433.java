...
@Data
public class Idea38433Config {
    private String name = "idea_038433";
 ...
 */
@Slf4j
public class Idea38433Service {
    private static final int IDEA_ID = 38433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38433Service() {
        this(new Idea38433Config());
    }

    public Idea38433Service(Idea38433Config config) {
        this.config = config != null ? config : new Idea38433Config();
