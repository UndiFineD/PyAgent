...
@Data
public class Idea38430Config {
    private String name = "idea_038430";
 ...
 */
@Slf4j
public class Idea38430Service {
    private static final int IDEA_ID = 38430;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38430Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38430Service() {
        this(new Idea38430Config());
    }

    public Idea38430Service(Idea38430Config config) {
        this.config = config != null ? config : new Idea38430Config();
