...
@Data
public class Idea38244Config {
    private String name = "idea_038244";
 ...
 */
@Slf4j
public class Idea38244Service {
    private static final int IDEA_ID = 38244;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38244Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38244Service() {
        this(new Idea38244Config());
    }

    public Idea38244Service(Idea38244Config config) {
        this.config = config != null ? config : new Idea38244Config();
