...
@Data
public class Idea38107Config {
    private String name = "idea_038107";
 ...
 */
@Slf4j
public class Idea38107Service {
    private static final int IDEA_ID = 38107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38107Service() {
        this(new Idea38107Config());
    }

    public Idea38107Service(Idea38107Config config) {
        this.config = config != null ? config : new Idea38107Config();
