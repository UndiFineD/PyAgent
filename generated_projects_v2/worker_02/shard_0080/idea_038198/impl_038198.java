...
@Data
public class Idea38198Config {
    private String name = "idea_038198";
 ...
 */
@Slf4j
public class Idea38198Service {
    private static final int IDEA_ID = 38198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38198Service() {
        this(new Idea38198Config());
    }

    public Idea38198Service(Idea38198Config config) {
        this.config = config != null ? config : new Idea38198Config();
