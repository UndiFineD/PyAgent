...
@Data
public class Idea38048Config {
    private String name = "idea_038048";
 ...
 */
@Slf4j
public class Idea38048Service {
    private static final int IDEA_ID = 38048;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38048Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38048Service() {
        this(new Idea38048Config());
    }

    public Idea38048Service(Idea38048Config config) {
        this.config = config != null ? config : new Idea38048Config();
