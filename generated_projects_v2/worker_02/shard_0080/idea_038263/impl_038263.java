...
@Data
public class Idea38263Config {
    private String name = "idea_038263";
 ...
 */
@Slf4j
public class Idea38263Service {
    private static final int IDEA_ID = 38263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38263Service() {
        this(new Idea38263Config());
    }

    public Idea38263Service(Idea38263Config config) {
        this.config = config != null ? config : new Idea38263Config();
