...
@Data
public class Idea38058Config {
    private String name = "idea_038058";
 ...
 */
@Slf4j
public class Idea38058Service {
    private static final int IDEA_ID = 38058;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38058Service() {
        this(new Idea38058Config());
    }

    public Idea38058Service(Idea38058Config config) {
        this.config = config != null ? config : new Idea38058Config();
