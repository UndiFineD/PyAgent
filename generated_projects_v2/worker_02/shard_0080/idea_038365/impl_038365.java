...
@Data
public class Idea38365Config {
    private String name = "idea_038365";
 ...
 */
@Slf4j
public class Idea38365Service {
    private static final int IDEA_ID = 38365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38365Service() {
        this(new Idea38365Config());
    }

    public Idea38365Service(Idea38365Config config) {
        this.config = config != null ? config : new Idea38365Config();
