...
@Data
public class Idea38196Config {
    private String name = "idea_038196";
 ...
 */
@Slf4j
public class Idea38196Service {
    private static final int IDEA_ID = 38196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38196Service() {
        this(new Idea38196Config());
    }

    public Idea38196Service(Idea38196Config config) {
        this.config = config != null ? config : new Idea38196Config();
