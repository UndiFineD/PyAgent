...
@Data
public class Idea38441Config {
    private String name = "idea_038441";
 ...
 */
@Slf4j
public class Idea38441Service {
    private static final int IDEA_ID = 38441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38441Service() {
        this(new Idea38441Config());
    }

    public Idea38441Service(Idea38441Config config) {
        this.config = config != null ? config : new Idea38441Config();
