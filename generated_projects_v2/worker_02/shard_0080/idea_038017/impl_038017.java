...
@Data
public class Idea38017Config {
    private String name = "idea_038017";
 ...
 */
@Slf4j
public class Idea38017Service {
    private static final int IDEA_ID = 38017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38017Service() {
        this(new Idea38017Config());
    }

    public Idea38017Service(Idea38017Config config) {
        this.config = config != null ? config : new Idea38017Config();
