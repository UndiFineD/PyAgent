...
@Data
public class Idea38416Config {
    private String name = "idea_038416";
 ...
 */
@Slf4j
public class Idea38416Service {
    private static final int IDEA_ID = 38416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38416Service() {
        this(new Idea38416Config());
    }

    public Idea38416Service(Idea38416Config config) {
        this.config = config != null ? config : new Idea38416Config();
