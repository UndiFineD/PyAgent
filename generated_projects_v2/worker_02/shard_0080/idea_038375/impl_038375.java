...
@Data
public class Idea38375Config {
    private String name = "idea_038375";
 ...
 */
@Slf4j
public class Idea38375Service {
    private static final int IDEA_ID = 38375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38375Service() {
        this(new Idea38375Config());
    }

    public Idea38375Service(Idea38375Config config) {
        this.config = config != null ? config : new Idea38375Config();
