...
@Data
public class Idea38089Config {
    private String name = "idea_038089";
 ...
 */
@Slf4j
public class Idea38089Service {
    private static final int IDEA_ID = 38089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38089Service() {
        this(new Idea38089Config());
    }

    public Idea38089Service(Idea38089Config config) {
        this.config = config != null ? config : new Idea38089Config();
