...
@Data
public class Idea38435Config {
    private String name = "idea_038435";
 ...
 */
@Slf4j
public class Idea38435Service {
    private static final int IDEA_ID = 38435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38435Service() {
        this(new Idea38435Config());
    }

    public Idea38435Service(Idea38435Config config) {
        this.config = config != null ? config : new Idea38435Config();
