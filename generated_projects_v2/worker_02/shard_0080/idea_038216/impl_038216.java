...
@Data
public class Idea38216Config {
    private String name = "idea_038216";
 ...
 */
@Slf4j
public class Idea38216Service {
    private static final int IDEA_ID = 38216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38216Service() {
        this(new Idea38216Config());
    }

    public Idea38216Service(Idea38216Config config) {
        this.config = config != null ? config : new Idea38216Config();
