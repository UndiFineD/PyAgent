...
@Data
public class Idea38264Config {
    private String name = "idea_038264";
 ...
 */
@Slf4j
public class Idea38264Service {
    private static final int IDEA_ID = 38264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38264Service() {
        this(new Idea38264Config());
    }

    public Idea38264Service(Idea38264Config config) {
        this.config = config != null ? config : new Idea38264Config();
