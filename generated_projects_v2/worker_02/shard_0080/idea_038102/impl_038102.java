...
@Data
public class Idea38102Config {
    private String name = "idea_038102";
 ...
 */
@Slf4j
public class Idea38102Service {
    private static final int IDEA_ID = 38102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38102Service() {
        this(new Idea38102Config());
    }

    public Idea38102Service(Idea38102Config config) {
        this.config = config != null ? config : new Idea38102Config();
