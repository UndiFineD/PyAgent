...
@Data
public class Idea38249Config {
    private String name = "idea_038249";
 ...
 */
@Slf4j
public class Idea38249Service {
    private static final int IDEA_ID = 38249;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38249Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38249Service() {
        this(new Idea38249Config());
    }

    public Idea38249Service(Idea38249Config config) {
        this.config = config != null ? config : new Idea38249Config();
