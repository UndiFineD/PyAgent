...
@Data
public class Idea38390Config {
    private String name = "idea_038390";
 ...
 */
@Slf4j
public class Idea38390Service {
    private static final int IDEA_ID = 38390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38390Service() {
        this(new Idea38390Config());
    }

    public Idea38390Service(Idea38390Config config) {
        this.config = config != null ? config : new Idea38390Config();
