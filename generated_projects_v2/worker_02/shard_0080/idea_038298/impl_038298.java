...
@Data
public class Idea38298Config {
    private String name = "idea_038298";
 ...
 */
@Slf4j
public class Idea38298Service {
    private static final int IDEA_ID = 38298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38298Service() {
        this(new Idea38298Config());
    }

    public Idea38298Service(Idea38298Config config) {
        this.config = config != null ? config : new Idea38298Config();
