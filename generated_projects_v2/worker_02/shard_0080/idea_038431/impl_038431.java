...
@Data
public class Idea38431Config {
    private String name = "idea_038431";
 ...
 */
@Slf4j
public class Idea38431Service {
    private static final int IDEA_ID = 38431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38431Service() {
        this(new Idea38431Config());
    }

    public Idea38431Service(Idea38431Config config) {
        this.config = config != null ? config : new Idea38431Config();
