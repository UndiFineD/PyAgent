...
@Data
public class Idea38238Config {
    private String name = "idea_038238";
 ...
 */
@Slf4j
public class Idea38238Service {
    private static final int IDEA_ID = 38238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38238Service() {
        this(new Idea38238Config());
    }

    public Idea38238Service(Idea38238Config config) {
        this.config = config != null ? config : new Idea38238Config();
