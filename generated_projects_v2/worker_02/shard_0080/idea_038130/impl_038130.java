...
@Data
public class Idea38130Config {
    private String name = "idea_038130";
 ...
 */
@Slf4j
public class Idea38130Service {
    private static final int IDEA_ID = 38130;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38130Service() {
        this(new Idea38130Config());
    }

    public Idea38130Service(Idea38130Config config) {
        this.config = config != null ? config : new Idea38130Config();
