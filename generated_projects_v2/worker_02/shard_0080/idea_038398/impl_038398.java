...
@Data
public class Idea38398Config {
    private String name = "idea_038398";
 ...
 */
@Slf4j
public class Idea38398Service {
    private static final int IDEA_ID = 38398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38398Service() {
        this(new Idea38398Config());
    }

    public Idea38398Service(Idea38398Config config) {
        this.config = config != null ? config : new Idea38398Config();
