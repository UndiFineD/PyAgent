...
@Data
public class Idea38175Config {
    private String name = "idea_038175";
 ...
 */
@Slf4j
public class Idea38175Service {
    private static final int IDEA_ID = 38175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38175Service() {
        this(new Idea38175Config());
    }

    public Idea38175Service(Idea38175Config config) {
        this.config = config != null ? config : new Idea38175Config();
