...
@Data
public class Idea38460Config {
    private String name = "idea_038460";
 ...
 */
@Slf4j
public class Idea38460Service {
    private static final int IDEA_ID = 38460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38460Service() {
        this(new Idea38460Config());
    }

    public Idea38460Service(Idea38460Config config) {
        this.config = config != null ? config : new Idea38460Config();
