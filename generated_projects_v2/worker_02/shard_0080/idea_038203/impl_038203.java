...
@Data
public class Idea38203Config {
    private String name = "idea_038203";
 ...
 */
@Slf4j
public class Idea38203Service {
    private static final int IDEA_ID = 38203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38203Service() {
        this(new Idea38203Config());
    }

    public Idea38203Service(Idea38203Config config) {
        this.config = config != null ? config : new Idea38203Config();
