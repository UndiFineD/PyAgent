...
@Data
public class Idea38230Config {
    private String name = "idea_038230";
 ...
 */
@Slf4j
public class Idea38230Service {
    private static final int IDEA_ID = 38230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38230Service() {
        this(new Idea38230Config());
    }

    public Idea38230Service(Idea38230Config config) {
        this.config = config != null ? config : new Idea38230Config();
