...
@Data
public class Idea38245Config {
    private String name = "idea_038245";
 ...
 */
@Slf4j
public class Idea38245Service {
    private static final int IDEA_ID = 38245;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38245Service() {
        this(new Idea38245Config());
    }

    public Idea38245Service(Idea38245Config config) {
        this.config = config != null ? config : new Idea38245Config();
