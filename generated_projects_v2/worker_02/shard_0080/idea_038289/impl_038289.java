...
@Data
public class Idea38289Config {
    private String name = "idea_038289";
 ...
 */
@Slf4j
public class Idea38289Service {
    private static final int IDEA_ID = 38289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38289Service() {
        this(new Idea38289Config());
    }

    public Idea38289Service(Idea38289Config config) {
        this.config = config != null ? config : new Idea38289Config();
