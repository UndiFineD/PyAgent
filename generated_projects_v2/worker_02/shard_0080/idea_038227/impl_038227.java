...
@Data
public class Idea38227Config {
    private String name = "idea_038227";
 ...
 */
@Slf4j
public class Idea38227Service {
    private static final int IDEA_ID = 38227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38227Service() {
        this(new Idea38227Config());
    }

    public Idea38227Service(Idea38227Config config) {
        this.config = config != null ? config : new Idea38227Config();
