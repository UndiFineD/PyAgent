...
@Data
public class Idea38166Config {
    private String name = "idea_038166";
 ...
 */
@Slf4j
public class Idea38166Service {
    private static final int IDEA_ID = 38166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38166Service() {
        this(new Idea38166Config());
    }

    public Idea38166Service(Idea38166Config config) {
        this.config = config != null ? config : new Idea38166Config();
