...
@Data
public class Idea38424Config {
    private String name = "idea_038424";
 ...
 */
@Slf4j
public class Idea38424Service {
    private static final int IDEA_ID = 38424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38424Service() {
        this(new Idea38424Config());
    }

    public Idea38424Service(Idea38424Config config) {
        this.config = config != null ? config : new Idea38424Config();
