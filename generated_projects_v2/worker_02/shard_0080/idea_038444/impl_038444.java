...
@Data
public class Idea38444Config {
    private String name = "idea_038444";
 ...
 */
@Slf4j
public class Idea38444Service {
    private static final int IDEA_ID = 38444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38444Service() {
        this(new Idea38444Config());
    }

    public Idea38444Service(Idea38444Config config) {
        this.config = config != null ? config : new Idea38444Config();
