...
@Data
public class Idea38425Config {
    private String name = "idea_038425";
 ...
 */
@Slf4j
public class Idea38425Service {
    private static final int IDEA_ID = 38425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38425Service() {
        this(new Idea38425Config());
    }

    public Idea38425Service(Idea38425Config config) {
        this.config = config != null ? config : new Idea38425Config();
