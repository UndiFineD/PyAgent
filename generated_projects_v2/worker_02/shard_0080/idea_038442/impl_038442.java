...
@Data
public class Idea38442Config {
    private String name = "idea_038442";
 ...
 */
@Slf4j
public class Idea38442Service {
    private static final int IDEA_ID = 38442;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38442Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38442Service() {
        this(new Idea38442Config());
    }

    public Idea38442Service(Idea38442Config config) {
        this.config = config != null ? config : new Idea38442Config();
