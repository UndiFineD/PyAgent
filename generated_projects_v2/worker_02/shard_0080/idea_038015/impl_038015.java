...
@Data
public class Idea38015Config {
    private String name = "idea_038015";
 ...
 */
@Slf4j
public class Idea38015Service {
    private static final int IDEA_ID = 38015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38015Service() {
        this(new Idea38015Config());
    }

    public Idea38015Service(Idea38015Config config) {
        this.config = config != null ? config : new Idea38015Config();
