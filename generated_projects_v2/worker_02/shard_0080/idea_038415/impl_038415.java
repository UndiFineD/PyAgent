...
@Data
public class Idea38415Config {
    private String name = "idea_038415";
 ...
 */
@Slf4j
public class Idea38415Service {
    private static final int IDEA_ID = 38415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38415Service() {
        this(new Idea38415Config());
    }

    public Idea38415Service(Idea38415Config config) {
        this.config = config != null ? config : new Idea38415Config();
