...
@Data
public class Idea38446Config {
    private String name = "idea_038446";
 ...
 */
@Slf4j
public class Idea38446Service {
    private static final int IDEA_ID = 38446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38446Service() {
        this(new Idea38446Config());
    }

    public Idea38446Service(Idea38446Config config) {
        this.config = config != null ? config : new Idea38446Config();
