...
@Data
public class Idea38307Config {
    private String name = "idea_038307";
 ...
 */
@Slf4j
public class Idea38307Service {
    private static final int IDEA_ID = 38307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38307Service() {
        this(new Idea38307Config());
    }

    public Idea38307Service(Idea38307Config config) {
        this.config = config != null ? config : new Idea38307Config();
