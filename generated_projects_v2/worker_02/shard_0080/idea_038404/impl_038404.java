...
@Data
public class Idea38404Config {
    private String name = "idea_038404";
 ...
 */
@Slf4j
public class Idea38404Service {
    private static final int IDEA_ID = 38404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38404Service() {
        this(new Idea38404Config());
    }

    public Idea38404Service(Idea38404Config config) {
        this.config = config != null ? config : new Idea38404Config();
