...
@Data
public class Idea38265Config {
    private String name = "idea_038265";
 ...
 */
@Slf4j
public class Idea38265Service {
    private static final int IDEA_ID = 38265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38265Service() {
        this(new Idea38265Config());
    }

    public Idea38265Service(Idea38265Config config) {
        this.config = config != null ? config : new Idea38265Config();
