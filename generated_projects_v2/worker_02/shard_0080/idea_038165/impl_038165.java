...
@Data
public class Idea38165Config {
    private String name = "idea_038165";
 ...
 */
@Slf4j
public class Idea38165Service {
    private static final int IDEA_ID = 38165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38165Service() {
        this(new Idea38165Config());
    }

    public Idea38165Service(Idea38165Config config) {
        this.config = config != null ? config : new Idea38165Config();
