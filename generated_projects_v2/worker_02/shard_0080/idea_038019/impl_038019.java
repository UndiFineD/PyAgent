...
@Data
public class Idea38019Config {
    private String name = "idea_038019";
 ...
 */
@Slf4j
public class Idea38019Service {
    private static final int IDEA_ID = 38019;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38019Service() {
        this(new Idea38019Config());
    }

    public Idea38019Service(Idea38019Config config) {
        this.config = config != null ? config : new Idea38019Config();
