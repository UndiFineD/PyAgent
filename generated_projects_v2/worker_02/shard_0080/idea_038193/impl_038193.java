...
@Data
public class Idea38193Config {
    private String name = "idea_038193";
 ...
 */
@Slf4j
public class Idea38193Service {
    private static final int IDEA_ID = 38193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38193Service() {
        this(new Idea38193Config());
    }

    public Idea38193Service(Idea38193Config config) {
        this.config = config != null ? config : new Idea38193Config();
