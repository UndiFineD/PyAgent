...
@Data
public class Idea38125Config {
    private String name = "idea_038125";
 ...
 */
@Slf4j
public class Idea38125Service {
    private static final int IDEA_ID = 38125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38125Service() {
        this(new Idea38125Config());
    }

    public Idea38125Service(Idea38125Config config) {
        this.config = config != null ? config : new Idea38125Config();
