...
@Data
public class Idea38248Config {
    private String name = "idea_038248";
 ...
 */
@Slf4j
public class Idea38248Service {
    private static final int IDEA_ID = 38248;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38248Service() {
        this(new Idea38248Config());
    }

    public Idea38248Service(Idea38248Config config) {
        this.config = config != null ? config : new Idea38248Config();
