...
@Data
public class Idea38054Config {
    private String name = "idea_038054";
 ...
 */
@Slf4j
public class Idea38054Service {
    private static final int IDEA_ID = 38054;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38054Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38054Service() {
        this(new Idea38054Config());
    }

    public Idea38054Service(Idea38054Config config) {
        this.config = config != null ? config : new Idea38054Config();
