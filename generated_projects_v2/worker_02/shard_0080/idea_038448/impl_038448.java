...
@Data
public class Idea38448Config {
    private String name = "idea_038448";
 ...
 */
@Slf4j
public class Idea38448Service {
    private static final int IDEA_ID = 38448;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38448Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38448Service() {
        this(new Idea38448Config());
    }

    public Idea38448Service(Idea38448Config config) {
        this.config = config != null ? config : new Idea38448Config();
