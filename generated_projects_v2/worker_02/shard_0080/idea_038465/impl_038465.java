...
@Data
public class Idea38465Config {
    private String name = "idea_038465";
 ...
 */
@Slf4j
public class Idea38465Service {
    private static final int IDEA_ID = 38465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38465Service() {
        this(new Idea38465Config());
    }

    public Idea38465Service(Idea38465Config config) {
        this.config = config != null ? config : new Idea38465Config();
