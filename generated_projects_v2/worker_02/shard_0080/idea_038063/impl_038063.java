...
@Data
public class Idea38063Config {
    private String name = "idea_038063";
 ...
 */
@Slf4j
public class Idea38063Service {
    private static final int IDEA_ID = 38063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38063Service() {
        this(new Idea38063Config());
    }

    public Idea38063Service(Idea38063Config config) {
        this.config = config != null ? config : new Idea38063Config();
