...
@Data
public class Idea38083Config {
    private String name = "idea_038083";
 ...
 */
@Slf4j
public class Idea38083Service {
    private static final int IDEA_ID = 38083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38083Service() {
        this(new Idea38083Config());
    }

    public Idea38083Service(Idea38083Config config) {
        this.config = config != null ? config : new Idea38083Config();
