...
@Data
public class Idea38036Config {
    private String name = "idea_038036";
 ...
 */
@Slf4j
public class Idea38036Service {
    private static final int IDEA_ID = 38036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38036Service() {
        this(new Idea38036Config());
    }

    public Idea38036Service(Idea38036Config config) {
        this.config = config != null ? config : new Idea38036Config();
