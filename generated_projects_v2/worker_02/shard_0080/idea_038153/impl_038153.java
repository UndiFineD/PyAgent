...
@Data
public class Idea38153Config {
    private String name = "idea_038153";
 ...
 */
@Slf4j
public class Idea38153Service {
    private static final int IDEA_ID = 38153;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38153Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38153Service() {
        this(new Idea38153Config());
    }

    public Idea38153Service(Idea38153Config config) {
        this.config = config != null ? config : new Idea38153Config();
