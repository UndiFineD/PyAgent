...
@Data
public class Idea38099Config {
    private String name = "idea_038099";
 ...
 */
@Slf4j
public class Idea38099Service {
    private static final int IDEA_ID = 38099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38099Service() {
        this(new Idea38099Config());
    }

    public Idea38099Service(Idea38099Config config) {
        this.config = config != null ? config : new Idea38099Config();
