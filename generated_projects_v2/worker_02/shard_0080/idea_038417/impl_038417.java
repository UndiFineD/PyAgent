...
@Data
public class Idea38417Config {
    private String name = "idea_038417";
 ...
 */
@Slf4j
public class Idea38417Service {
    private static final int IDEA_ID = 38417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38417Service() {
        this(new Idea38417Config());
    }

    public Idea38417Service(Idea38417Config config) {
        this.config = config != null ? config : new Idea38417Config();
