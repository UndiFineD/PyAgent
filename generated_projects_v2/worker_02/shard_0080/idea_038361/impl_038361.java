...
@Data
public class Idea38361Config {
    private String name = "idea_038361";
 ...
 */
@Slf4j
public class Idea38361Service {
    private static final int IDEA_ID = 38361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38361Service() {
        this(new Idea38361Config());
    }

    public Idea38361Service(Idea38361Config config) {
        this.config = config != null ? config : new Idea38361Config();
