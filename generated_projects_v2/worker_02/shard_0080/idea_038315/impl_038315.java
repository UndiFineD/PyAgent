...
@Data
public class Idea38315Config {
    private String name = "idea_038315";
 ...
 */
@Slf4j
public class Idea38315Service {
    private static final int IDEA_ID = 38315;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38315Service() {
        this(new Idea38315Config());
    }

    public Idea38315Service(Idea38315Config config) {
        this.config = config != null ? config : new Idea38315Config();
