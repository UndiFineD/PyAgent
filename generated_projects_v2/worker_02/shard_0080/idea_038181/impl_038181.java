...
@Data
public class Idea38181Config {
    private String name = "idea_038181";
 ...
 */
@Slf4j
public class Idea38181Service {
    private static final int IDEA_ID = 38181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38181Service() {
        this(new Idea38181Config());
    }

    public Idea38181Service(Idea38181Config config) {
        this.config = config != null ? config : new Idea38181Config();
