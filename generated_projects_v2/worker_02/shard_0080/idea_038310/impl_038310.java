...
@Data
public class Idea38310Config {
    private String name = "idea_038310";
 ...
 */
@Slf4j
public class Idea38310Service {
    private static final int IDEA_ID = 38310;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38310Service() {
        this(new Idea38310Config());
    }

    public Idea38310Service(Idea38310Config config) {
        this.config = config != null ? config : new Idea38310Config();
