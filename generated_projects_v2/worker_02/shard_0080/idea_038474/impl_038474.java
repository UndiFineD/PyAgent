...
@Data
public class Idea38474Config {
    private String name = "idea_038474";
 ...
 */
@Slf4j
public class Idea38474Service {
    private static final int IDEA_ID = 38474;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38474Service() {
        this(new Idea38474Config());
    }

    public Idea38474Service(Idea38474Config config) {
        this.config = config != null ? config : new Idea38474Config();
