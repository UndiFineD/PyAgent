...
@Data
public class Idea38297Config {
    private String name = "idea_038297";
 ...
 */
@Slf4j
public class Idea38297Service {
    private static final int IDEA_ID = 38297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38297Service() {
        this(new Idea38297Config());
    }

    public Idea38297Service(Idea38297Config config) {
        this.config = config != null ? config : new Idea38297Config();
