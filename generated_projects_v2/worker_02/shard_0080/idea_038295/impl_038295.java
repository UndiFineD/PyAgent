...
@Data
public class Idea38295Config {
    private String name = "idea_038295";
 ...
 */
@Slf4j
public class Idea38295Service {
    private static final int IDEA_ID = 38295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38295Service() {
        this(new Idea38295Config());
    }

    public Idea38295Service(Idea38295Config config) {
        this.config = config != null ? config : new Idea38295Config();
