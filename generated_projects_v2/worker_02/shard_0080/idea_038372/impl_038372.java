...
@Data
public class Idea38372Config {
    private String name = "idea_038372";
 ...
 */
@Slf4j
public class Idea38372Service {
    private static final int IDEA_ID = 38372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38372Service() {
        this(new Idea38372Config());
    }

    public Idea38372Service(Idea38372Config config) {
        this.config = config != null ? config : new Idea38372Config();
