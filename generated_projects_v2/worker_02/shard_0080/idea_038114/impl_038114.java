...
@Data
public class Idea38114Config {
    private String name = "idea_038114";
 ...
 */
@Slf4j
public class Idea38114Service {
    private static final int IDEA_ID = 38114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38114Service() {
        this(new Idea38114Config());
    }

    public Idea38114Service(Idea38114Config config) {
        this.config = config != null ? config : new Idea38114Config();
