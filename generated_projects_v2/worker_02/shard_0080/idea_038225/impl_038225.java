...
@Data
public class Idea38225Config {
    private String name = "idea_038225";
 ...
 */
@Slf4j
public class Idea38225Service {
    private static final int IDEA_ID = 38225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38225Service() {
        this(new Idea38225Config());
    }

    public Idea38225Service(Idea38225Config config) {
        this.config = config != null ? config : new Idea38225Config();
