...
@Data
public class Idea38032Config {
    private String name = "idea_038032";
 ...
 */
@Slf4j
public class Idea38032Service {
    private static final int IDEA_ID = 38032;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38032Service() {
        this(new Idea38032Config());
    }

    public Idea38032Service(Idea38032Config config) {
        this.config = config != null ? config : new Idea38032Config();
