...
@Data
public class Idea38035Config {
    private String name = "idea_038035";
 ...
 */
@Slf4j
public class Idea38035Service {
    private static final int IDEA_ID = 38035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38035Service() {
        this(new Idea38035Config());
    }

    public Idea38035Service(Idea38035Config config) {
        this.config = config != null ? config : new Idea38035Config();
