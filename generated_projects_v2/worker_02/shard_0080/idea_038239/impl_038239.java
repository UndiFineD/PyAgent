...
@Data
public class Idea38239Config {
    private String name = "idea_038239";
 ...
 */
@Slf4j
public class Idea38239Service {
    private static final int IDEA_ID = 38239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38239Service() {
        this(new Idea38239Config());
    }

    public Idea38239Service(Idea38239Config config) {
        this.config = config != null ? config : new Idea38239Config();
