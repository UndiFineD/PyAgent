...
@Data
public class Idea38113Config {
    private String name = "idea_038113";
 ...
 */
@Slf4j
public class Idea38113Service {
    private static final int IDEA_ID = 38113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38113Service() {
        this(new Idea38113Config());
    }

    public Idea38113Service(Idea38113Config config) {
        this.config = config != null ? config : new Idea38113Config();
