...
@Data
public class Idea38027Config {
    private String name = "idea_038027";
 ...
 */
@Slf4j
public class Idea38027Service {
    private static final int IDEA_ID = 38027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38027Service() {
        this(new Idea38027Config());
    }

    public Idea38027Service(Idea38027Config config) {
        this.config = config != null ? config : new Idea38027Config();
