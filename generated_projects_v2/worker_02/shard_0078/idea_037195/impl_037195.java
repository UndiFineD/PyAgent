...
@Data
public class Idea37195Config {
    private String name = "idea_037195";
 ...
 */
@Slf4j
public class Idea37195Service {
    private static final int IDEA_ID = 37195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37195Service() {
        this(new Idea37195Config());
    }

    public Idea37195Service(Idea37195Config config) {
        this.config = config != null ? config : new Idea37195Config();
