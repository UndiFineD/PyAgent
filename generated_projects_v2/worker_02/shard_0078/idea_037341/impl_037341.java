...
@Data
public class Idea37341Config {
    private String name = "idea_037341";
 ...
 */
@Slf4j
public class Idea37341Service {
    private static final int IDEA_ID = 37341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37341Service() {
        this(new Idea37341Config());
    }

    public Idea37341Service(Idea37341Config config) {
        this.config = config != null ? config : new Idea37341Config();
