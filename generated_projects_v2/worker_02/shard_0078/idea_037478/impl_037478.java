...
@Data
public class Idea37478Config {
    private String name = "idea_037478";
 ...
 */
@Slf4j
public class Idea37478Service {
    private static final int IDEA_ID = 37478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37478Service() {
        this(new Idea37478Config());
    }

    public Idea37478Service(Idea37478Config config) {
        this.config = config != null ? config : new Idea37478Config();
