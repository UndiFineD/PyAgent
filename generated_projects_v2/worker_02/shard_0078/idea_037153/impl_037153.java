...
@Data
public class Idea37153Config {
    private String name = "idea_037153";
 ...
 */
@Slf4j
public class Idea37153Service {
    private static final int IDEA_ID = 37153;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37153Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37153Service() {
        this(new Idea37153Config());
    }

    public Idea37153Service(Idea37153Config config) {
        this.config = config != null ? config : new Idea37153Config();
