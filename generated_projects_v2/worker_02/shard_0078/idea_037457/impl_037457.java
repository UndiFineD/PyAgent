...
@Data
public class Idea37457Config {
    private String name = "idea_037457";
 ...
 */
@Slf4j
public class Idea37457Service {
    private static final int IDEA_ID = 37457;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37457Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37457Service() {
        this(new Idea37457Config());
    }

    public Idea37457Service(Idea37457Config config) {
        this.config = config != null ? config : new Idea37457Config();
