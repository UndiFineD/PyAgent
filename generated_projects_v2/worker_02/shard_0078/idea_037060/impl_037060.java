...
@Data
public class Idea37060Config {
    private String name = "idea_037060";
 ...
 */
@Slf4j
public class Idea37060Service {
    private static final int IDEA_ID = 37060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37060Service() {
        this(new Idea37060Config());
    }

    public Idea37060Service(Idea37060Config config) {
        this.config = config != null ? config : new Idea37060Config();
