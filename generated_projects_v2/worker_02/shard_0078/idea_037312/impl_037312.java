...
@Data
public class Idea37312Config {
    private String name = "idea_037312";
 ...
 */
@Slf4j
public class Idea37312Service {
    private static final int IDEA_ID = 37312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37312Service() {
        this(new Idea37312Config());
    }

    public Idea37312Service(Idea37312Config config) {
        this.config = config != null ? config : new Idea37312Config();
