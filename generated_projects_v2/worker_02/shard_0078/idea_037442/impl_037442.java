...
@Data
public class Idea37442Config {
    private String name = "idea_037442";
 ...
 */
@Slf4j
public class Idea37442Service {
    private static final int IDEA_ID = 37442;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37442Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37442Service() {
        this(new Idea37442Config());
    }

    public Idea37442Service(Idea37442Config config) {
        this.config = config != null ? config : new Idea37442Config();
