...
@Data
public class Idea37294Config {
    private String name = "idea_037294";
 ...
 */
@Slf4j
public class Idea37294Service {
    private static final int IDEA_ID = 37294;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37294Service() {
        this(new Idea37294Config());
    }

    public Idea37294Service(Idea37294Config config) {
        this.config = config != null ? config : new Idea37294Config();
