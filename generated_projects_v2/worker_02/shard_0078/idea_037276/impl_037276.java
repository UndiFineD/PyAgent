...
@Data
public class Idea37276Config {
    private String name = "idea_037276";
 ...
 */
@Slf4j
public class Idea37276Service {
    private static final int IDEA_ID = 37276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37276Service() {
        this(new Idea37276Config());
    }

    public Idea37276Service(Idea37276Config config) {
        this.config = config != null ? config : new Idea37276Config();
