...
@Data
public class Idea37463Config {
    private String name = "idea_037463";
 ...
 */
@Slf4j
public class Idea37463Service {
    private static final int IDEA_ID = 37463;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37463Service() {
        this(new Idea37463Config());
    }

    public Idea37463Service(Idea37463Config config) {
        this.config = config != null ? config : new Idea37463Config();
