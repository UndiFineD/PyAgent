...
@Data
public class Idea37345Config {
    private String name = "idea_037345";
 ...
 */
@Slf4j
public class Idea37345Service {
    private static final int IDEA_ID = 37345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37345Service() {
        this(new Idea37345Config());
    }

    public Idea37345Service(Idea37345Config config) {
        this.config = config != null ? config : new Idea37345Config();
