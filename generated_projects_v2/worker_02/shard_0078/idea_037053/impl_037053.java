...
@Data
public class Idea37053Config {
    private String name = "idea_037053";
 ...
 */
@Slf4j
public class Idea37053Service {
    private static final int IDEA_ID = 37053;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37053Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37053Service() {
        this(new Idea37053Config());
    }

    public Idea37053Service(Idea37053Config config) {
        this.config = config != null ? config : new Idea37053Config();
