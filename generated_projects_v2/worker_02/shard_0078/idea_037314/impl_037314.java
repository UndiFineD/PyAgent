...
@Data
public class Idea37314Config {
    private String name = "idea_037314";
 ...
 */
@Slf4j
public class Idea37314Service {
    private static final int IDEA_ID = 37314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37314Service() {
        this(new Idea37314Config());
    }

    public Idea37314Service(Idea37314Config config) {
        this.config = config != null ? config : new Idea37314Config();
