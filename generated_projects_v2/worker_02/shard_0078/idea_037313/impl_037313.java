...
@Data
public class Idea37313Config {
    private String name = "idea_037313";
 ...
 */
@Slf4j
public class Idea37313Service {
    private static final int IDEA_ID = 37313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37313Service() {
        this(new Idea37313Config());
    }

    public Idea37313Service(Idea37313Config config) {
        this.config = config != null ? config : new Idea37313Config();
