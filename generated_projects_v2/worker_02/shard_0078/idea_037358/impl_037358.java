...
@Data
public class Idea37358Config {
    private String name = "idea_037358";
 ...
 */
@Slf4j
public class Idea37358Service {
    private static final int IDEA_ID = 37358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37358Service() {
        this(new Idea37358Config());
    }

    public Idea37358Service(Idea37358Config config) {
        this.config = config != null ? config : new Idea37358Config();
