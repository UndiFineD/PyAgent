...
@Data
public class Idea37350Config {
    private String name = "idea_037350";
 ...
 */
@Slf4j
public class Idea37350Service {
    private static final int IDEA_ID = 37350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37350Service() {
        this(new Idea37350Config());
    }

    public Idea37350Service(Idea37350Config config) {
        this.config = config != null ? config : new Idea37350Config();
