...
@Data
public class Idea37176Config {
    private String name = "idea_037176";
 ...
 */
@Slf4j
public class Idea37176Service {
    private static final int IDEA_ID = 37176;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37176Service() {
        this(new Idea37176Config());
    }

    public Idea37176Service(Idea37176Config config) {
        this.config = config != null ? config : new Idea37176Config();
