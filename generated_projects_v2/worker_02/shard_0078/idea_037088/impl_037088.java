...
@Data
public class Idea37088Config {
    private String name = "idea_037088";
 ...
 */
@Slf4j
public class Idea37088Service {
    private static final int IDEA_ID = 37088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37088Service() {
        this(new Idea37088Config());
    }

    public Idea37088Service(Idea37088Config config) {
        this.config = config != null ? config : new Idea37088Config();
