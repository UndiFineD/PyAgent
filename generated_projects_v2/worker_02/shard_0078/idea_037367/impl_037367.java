...
@Data
public class Idea37367Config {
    private String name = "idea_037367";
 ...
 */
@Slf4j
public class Idea37367Service {
    private static final int IDEA_ID = 37367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37367Service() {
        this(new Idea37367Config());
    }

    public Idea37367Service(Idea37367Config config) {
        this.config = config != null ? config : new Idea37367Config();
