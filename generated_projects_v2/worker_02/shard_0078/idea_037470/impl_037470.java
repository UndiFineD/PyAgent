...
@Data
public class Idea37470Config {
    private String name = "idea_037470";
 ...
 */
@Slf4j
public class Idea37470Service {
    private static final int IDEA_ID = 37470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37470Service() {
        this(new Idea37470Config());
    }

    public Idea37470Service(Idea37470Config config) {
        this.config = config != null ? config : new Idea37470Config();
