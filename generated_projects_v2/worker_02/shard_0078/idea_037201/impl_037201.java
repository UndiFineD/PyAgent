...
@Data
public class Idea37201Config {
    private String name = "idea_037201";
 ...
 */
@Slf4j
public class Idea37201Service {
    private static final int IDEA_ID = 37201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37201Service() {
        this(new Idea37201Config());
    }

    public Idea37201Service(Idea37201Config config) {
        this.config = config != null ? config : new Idea37201Config();
