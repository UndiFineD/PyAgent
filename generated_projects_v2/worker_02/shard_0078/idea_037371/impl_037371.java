...
@Data
public class Idea37371Config {
    private String name = "idea_037371";
 ...
 */
@Slf4j
public class Idea37371Service {
    private static final int IDEA_ID = 37371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37371Service() {
        this(new Idea37371Config());
    }

    public Idea37371Service(Idea37371Config config) {
        this.config = config != null ? config : new Idea37371Config();
