...
@Data
public class Idea37243Config {
    private String name = "idea_037243";
 ...
 */
@Slf4j
public class Idea37243Service {
    private static final int IDEA_ID = 37243;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37243Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37243Service() {
        this(new Idea37243Config());
    }

    public Idea37243Service(Idea37243Config config) {
        this.config = config != null ? config : new Idea37243Config();
