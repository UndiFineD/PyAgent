...
@Data
public class Idea37208Config {
    private String name = "idea_037208";
 ...
 */
@Slf4j
public class Idea37208Service {
    private static final int IDEA_ID = 37208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37208Service() {
        this(new Idea37208Config());
    }

    public Idea37208Service(Idea37208Config config) {
        this.config = config != null ? config : new Idea37208Config();
