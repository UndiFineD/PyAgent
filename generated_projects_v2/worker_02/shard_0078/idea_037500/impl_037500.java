...
@Data
public class Idea37500Config {
    private String name = "idea_037500";
 ...
 */
@Slf4j
public class Idea37500Service {
    private static final int IDEA_ID = 37500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37500Service() {
        this(new Idea37500Config());
    }

    public Idea37500Service(Idea37500Config config) {
        this.config = config != null ? config : new Idea37500Config();
