...
@Data
public class Idea37102Config {
    private String name = "idea_037102";
 ...
 */
@Slf4j
public class Idea37102Service {
    private static final int IDEA_ID = 37102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37102Service() {
        this(new Idea37102Config());
    }

    public Idea37102Service(Idea37102Config config) {
        this.config = config != null ? config : new Idea37102Config();
