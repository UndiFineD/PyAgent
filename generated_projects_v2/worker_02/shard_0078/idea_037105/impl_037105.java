...
@Data
public class Idea37105Config {
    private String name = "idea_037105";
 ...
 */
@Slf4j
public class Idea37105Service {
    private static final int IDEA_ID = 37105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37105Service() {
        this(new Idea37105Config());
    }

    public Idea37105Service(Idea37105Config config) {
        this.config = config != null ? config : new Idea37105Config();
