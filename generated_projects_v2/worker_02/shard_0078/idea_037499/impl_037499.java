...
@Data
public class Idea37499Config {
    private String name = "idea_037499";
 ...
 */
@Slf4j
public class Idea37499Service {
    private static final int IDEA_ID = 37499;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37499Service() {
        this(new Idea37499Config());
    }

    public Idea37499Service(Idea37499Config config) {
        this.config = config != null ? config : new Idea37499Config();
