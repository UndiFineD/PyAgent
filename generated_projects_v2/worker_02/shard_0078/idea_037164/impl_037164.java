...
@Data
public class Idea37164Config {
    private String name = "idea_037164";
 ...
 */
@Slf4j
public class Idea37164Service {
    private static final int IDEA_ID = 37164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37164Service() {
        this(new Idea37164Config());
    }

    public Idea37164Service(Idea37164Config config) {
        this.config = config != null ? config : new Idea37164Config();
