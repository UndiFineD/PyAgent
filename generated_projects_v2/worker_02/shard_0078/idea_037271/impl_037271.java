...
@Data
public class Idea37271Config {
    private String name = "idea_037271";
 ...
 */
@Slf4j
public class Idea37271Service {
    private static final int IDEA_ID = 37271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37271Service() {
        this(new Idea37271Config());
    }

    public Idea37271Service(Idea37271Config config) {
        this.config = config != null ? config : new Idea37271Config();
