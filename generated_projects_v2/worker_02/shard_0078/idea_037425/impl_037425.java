...
@Data
public class Idea37425Config {
    private String name = "idea_037425";
 ...
 */
@Slf4j
public class Idea37425Service {
    private static final int IDEA_ID = 37425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37425Service() {
        this(new Idea37425Config());
    }

    public Idea37425Service(Idea37425Config config) {
        this.config = config != null ? config : new Idea37425Config();
