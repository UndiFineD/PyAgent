...
@Data
public class Idea37138Config {
    private String name = "idea_037138";
 ...
 */
@Slf4j
public class Idea37138Service {
    private static final int IDEA_ID = 37138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37138Service() {
        this(new Idea37138Config());
    }

    public Idea37138Service(Idea37138Config config) {
        this.config = config != null ? config : new Idea37138Config();
