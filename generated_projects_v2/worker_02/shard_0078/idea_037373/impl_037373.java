...
@Data
public class Idea37373Config {
    private String name = "idea_037373";
 ...
 */
@Slf4j
public class Idea37373Service {
    private static final int IDEA_ID = 37373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37373Service() {
        this(new Idea37373Config());
    }

    public Idea37373Service(Idea37373Config config) {
        this.config = config != null ? config : new Idea37373Config();
