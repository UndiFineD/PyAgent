...
@Data
public class Idea37343Config {
    private String name = "idea_037343";
 ...
 */
@Slf4j
public class Idea37343Service {
    private static final int IDEA_ID = 37343;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37343Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37343Service() {
        this(new Idea37343Config());
    }

    public Idea37343Service(Idea37343Config config) {
        this.config = config != null ? config : new Idea37343Config();
