...
@Data
public class Idea37198Config {
    private String name = "idea_037198";
 ...
 */
@Slf4j
public class Idea37198Service {
    private static final int IDEA_ID = 37198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37198Service() {
        this(new Idea37198Config());
    }

    public Idea37198Service(Idea37198Config config) {
        this.config = config != null ? config : new Idea37198Config();
