...
@Data
public class Idea37501Config {
    private String name = "idea_037501";
 ...
 */
@Slf4j
public class Idea37501Service {
    private static final int IDEA_ID = 37501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37501Service() {
        this(new Idea37501Config());
    }

    public Idea37501Service(Idea37501Config config) {
        this.config = config != null ? config : new Idea37501Config();
