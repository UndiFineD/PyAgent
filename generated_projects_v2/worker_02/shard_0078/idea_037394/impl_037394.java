...
@Data
public class Idea37394Config {
    private String name = "idea_037394";
 ...
 */
@Slf4j
public class Idea37394Service {
    private static final int IDEA_ID = 37394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37394Service() {
        this(new Idea37394Config());
    }

    public Idea37394Service(Idea37394Config config) {
        this.config = config != null ? config : new Idea37394Config();
