...
@Data
public class Idea37187Config {
    private String name = "idea_037187";
 ...
 */
@Slf4j
public class Idea37187Service {
    private static final int IDEA_ID = 37187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37187Service() {
        this(new Idea37187Config());
    }

    public Idea37187Service(Idea37187Config config) {
        this.config = config != null ? config : new Idea37187Config();
