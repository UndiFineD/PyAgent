...
@Data
public class Idea37357Config {
    private String name = "idea_037357";
 ...
 */
@Slf4j
public class Idea37357Service {
    private static final int IDEA_ID = 37357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37357Service() {
        this(new Idea37357Config());
    }

    public Idea37357Service(Idea37357Config config) {
        this.config = config != null ? config : new Idea37357Config();
