...
@Data
public class Idea37207Config {
    private String name = "idea_037207";
 ...
 */
@Slf4j
public class Idea37207Service {
    private static final int IDEA_ID = 37207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37207Service() {
        this(new Idea37207Config());
    }

    public Idea37207Service(Idea37207Config config) {
        this.config = config != null ? config : new Idea37207Config();
