...
@Data
public class Idea37132Config {
    private String name = "idea_037132";
 ...
 */
@Slf4j
public class Idea37132Service {
    private static final int IDEA_ID = 37132;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37132Service() {
        this(new Idea37132Config());
    }

    public Idea37132Service(Idea37132Config config) {
        this.config = config != null ? config : new Idea37132Config();
