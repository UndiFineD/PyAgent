...
@Data
public class Idea37454Config {
    private String name = "idea_037454";
 ...
 */
@Slf4j
public class Idea37454Service {
    private static final int IDEA_ID = 37454;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37454Service() {
        this(new Idea37454Config());
    }

    public Idea37454Service(Idea37454Config config) {
        this.config = config != null ? config : new Idea37454Config();
