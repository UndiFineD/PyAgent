...
@Data
public class Idea37258Config {
    private String name = "idea_037258";
 ...
 */
@Slf4j
public class Idea37258Service {
    private static final int IDEA_ID = 37258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37258Service() {
        this(new Idea37258Config());
    }

    public Idea37258Service(Idea37258Config config) {
        this.config = config != null ? config : new Idea37258Config();
