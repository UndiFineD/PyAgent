...
@Data
public class Idea37307Config {
    private String name = "idea_037307";
 ...
 */
@Slf4j
public class Idea37307Service {
    private static final int IDEA_ID = 37307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37307Service() {
        this(new Idea37307Config());
    }

    public Idea37307Service(Idea37307Config config) {
        this.config = config != null ? config : new Idea37307Config();
