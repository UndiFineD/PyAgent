...
@Data
public class Idea37285Config {
    private String name = "idea_037285";
 ...
 */
@Slf4j
public class Idea37285Service {
    private static final int IDEA_ID = 37285;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37285Service() {
        this(new Idea37285Config());
    }

    public Idea37285Service(Idea37285Config config) {
        this.config = config != null ? config : new Idea37285Config();
