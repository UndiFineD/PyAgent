...
@Data
public class Idea37275Config {
    private String name = "idea_037275";
 ...
 */
@Slf4j
public class Idea37275Service {
    private static final int IDEA_ID = 37275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37275Service() {
        this(new Idea37275Config());
    }

    public Idea37275Service(Idea37275Config config) {
        this.config = config != null ? config : new Idea37275Config();
