...
@Data
public class Idea37451Config {
    private String name = "idea_037451";
 ...
 */
@Slf4j
public class Idea37451Service {
    private static final int IDEA_ID = 37451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37451Service() {
        this(new Idea37451Config());
    }

    public Idea37451Service(Idea37451Config config) {
        this.config = config != null ? config : new Idea37451Config();
