...
@Data
public class Idea37362Config {
    private String name = "idea_037362";
 ...
 */
@Slf4j
public class Idea37362Service {
    private static final int IDEA_ID = 37362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37362Service() {
        this(new Idea37362Config());
    }

    public Idea37362Service(Idea37362Config config) {
        this.config = config != null ? config : new Idea37362Config();
