...
@Data
public class Idea37206Config {
    private String name = "idea_037206";
 ...
 */
@Slf4j
public class Idea37206Service {
    private static final int IDEA_ID = 37206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37206Service() {
        this(new Idea37206Config());
    }

    public Idea37206Service(Idea37206Config config) {
        this.config = config != null ? config : new Idea37206Config();
