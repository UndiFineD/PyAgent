...
@Data
public class Idea37170Config {
    private String name = "idea_037170";
 ...
 */
@Slf4j
public class Idea37170Service {
    private static final int IDEA_ID = 37170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37170Service() {
        this(new Idea37170Config());
    }

    public Idea37170Service(Idea37170Config config) {
        this.config = config != null ? config : new Idea37170Config();
