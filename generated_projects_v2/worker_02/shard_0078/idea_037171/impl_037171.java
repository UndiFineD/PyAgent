...
@Data
public class Idea37171Config {
    private String name = "idea_037171";
 ...
 */
@Slf4j
public class Idea37171Service {
    private static final int IDEA_ID = 37171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37171Service() {
        this(new Idea37171Config());
    }

    public Idea37171Service(Idea37171Config config) {
        this.config = config != null ? config : new Idea37171Config();
