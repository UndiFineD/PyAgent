...
@Data
public class Idea37330Config {
    private String name = "idea_037330";
 ...
 */
@Slf4j
public class Idea37330Service {
    private static final int IDEA_ID = 37330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37330Service() {
        this(new Idea37330Config());
    }

    public Idea37330Service(Idea37330Config config) {
        this.config = config != null ? config : new Idea37330Config();
