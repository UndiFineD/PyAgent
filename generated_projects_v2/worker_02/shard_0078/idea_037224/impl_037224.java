...
@Data
public class Idea37224Config {
    private String name = "idea_037224";
 ...
 */
@Slf4j
public class Idea37224Service {
    private static final int IDEA_ID = 37224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37224Service() {
        this(new Idea37224Config());
    }

    public Idea37224Service(Idea37224Config config) {
        this.config = config != null ? config : new Idea37224Config();
