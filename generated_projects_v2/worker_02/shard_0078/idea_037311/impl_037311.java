...
@Data
public class Idea37311Config {
    private String name = "idea_037311";
 ...
 */
@Slf4j
public class Idea37311Service {
    private static final int IDEA_ID = 37311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37311Service() {
        this(new Idea37311Config());
    }

    public Idea37311Service(Idea37311Config config) {
        this.config = config != null ? config : new Idea37311Config();
