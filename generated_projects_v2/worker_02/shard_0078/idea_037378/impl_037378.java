...
@Data
public class Idea37378Config {
    private String name = "idea_037378";
 ...
 */
@Slf4j
public class Idea37378Service {
    private static final int IDEA_ID = 37378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37378Service() {
        this(new Idea37378Config());
    }

    public Idea37378Service(Idea37378Config config) {
        this.config = config != null ? config : new Idea37378Config();
