...
@Data
public class Idea37308Config {
    private String name = "idea_037308";
 ...
 */
@Slf4j
public class Idea37308Service {
    private static final int IDEA_ID = 37308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37308Service() {
        this(new Idea37308Config());
    }

    public Idea37308Service(Idea37308Config config) {
        this.config = config != null ? config : new Idea37308Config();
