...
@Data
public class Idea37460Config {
    private String name = "idea_037460";
 ...
 */
@Slf4j
public class Idea37460Service {
    private static final int IDEA_ID = 37460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37460Service() {
        this(new Idea37460Config());
    }

    public Idea37460Service(Idea37460Config config) {
        this.config = config != null ? config : new Idea37460Config();
