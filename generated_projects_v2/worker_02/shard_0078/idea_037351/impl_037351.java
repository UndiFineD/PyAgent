...
@Data
public class Idea37351Config {
    private String name = "idea_037351";
 ...
 */
@Slf4j
public class Idea37351Service {
    private static final int IDEA_ID = 37351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37351Service() {
        this(new Idea37351Config());
    }

    public Idea37351Service(Idea37351Config config) {
        this.config = config != null ? config : new Idea37351Config();
