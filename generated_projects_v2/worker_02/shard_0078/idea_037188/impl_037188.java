...
@Data
public class Idea37188Config {
    private String name = "idea_037188";
 ...
 */
@Slf4j
public class Idea37188Service {
    private static final int IDEA_ID = 37188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37188Service() {
        this(new Idea37188Config());
    }

    public Idea37188Service(Idea37188Config config) {
        this.config = config != null ? config : new Idea37188Config();
