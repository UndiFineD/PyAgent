...
@Data
public class Idea37435Config {
    private String name = "idea_037435";
 ...
 */
@Slf4j
public class Idea37435Service {
    private static final int IDEA_ID = 37435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37435Service() {
        this(new Idea37435Config());
    }

    public Idea37435Service(Idea37435Config config) {
        this.config = config != null ? config : new Idea37435Config();
