...
@Data
public class Idea37194Config {
    private String name = "idea_037194";
 ...
 */
@Slf4j
public class Idea37194Service {
    private static final int IDEA_ID = 37194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37194Service() {
        this(new Idea37194Config());
    }

    public Idea37194Service(Idea37194Config config) {
        this.config = config != null ? config : new Idea37194Config();
