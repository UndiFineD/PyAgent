...
@Data
public class Idea37082Config {
    private String name = "idea_037082";
 ...
 */
@Slf4j
public class Idea37082Service {
    private static final int IDEA_ID = 37082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37082Service() {
        this(new Idea37082Config());
    }

    public Idea37082Service(Idea37082Config config) {
        this.config = config != null ? config : new Idea37082Config();
