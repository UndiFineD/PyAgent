...
@Data
public class Idea37262Config {
    private String name = "idea_037262";
 ...
 */
@Slf4j
public class Idea37262Service {
    private static final int IDEA_ID = 37262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37262Service() {
        this(new Idea37262Config());
    }

    public Idea37262Service(Idea37262Config config) {
        this.config = config != null ? config : new Idea37262Config();
