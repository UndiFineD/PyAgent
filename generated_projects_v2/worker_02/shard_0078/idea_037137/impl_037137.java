...
@Data
public class Idea37137Config {
    private String name = "idea_037137";
 ...
 */
@Slf4j
public class Idea37137Service {
    private static final int IDEA_ID = 37137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37137Service() {
        this(new Idea37137Config());
    }

    public Idea37137Service(Idea37137Config config) {
        this.config = config != null ? config : new Idea37137Config();
