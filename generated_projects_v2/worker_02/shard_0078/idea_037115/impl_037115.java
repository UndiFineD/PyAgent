...
@Data
public class Idea37115Config {
    private String name = "idea_037115";
 ...
 */
@Slf4j
public class Idea37115Service {
    private static final int IDEA_ID = 37115;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37115Service() {
        this(new Idea37115Config());
    }

    public Idea37115Service(Idea37115Config config) {
        this.config = config != null ? config : new Idea37115Config();
