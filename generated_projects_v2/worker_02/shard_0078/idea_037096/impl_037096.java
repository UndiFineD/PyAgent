...
@Data
public class Idea37096Config {
    private String name = "idea_037096";
 ...
 */
@Slf4j
public class Idea37096Service {
    private static final int IDEA_ID = 37096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37096Service() {
        this(new Idea37096Config());
    }

    public Idea37096Service(Idea37096Config config) {
        this.config = config != null ? config : new Idea37096Config();
