...
@Data
public class Idea37462Config {
    private String name = "idea_037462";
 ...
 */
@Slf4j
public class Idea37462Service {
    private static final int IDEA_ID = 37462;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37462Service() {
        this(new Idea37462Config());
    }

    public Idea37462Service(Idea37462Config config) {
        this.config = config != null ? config : new Idea37462Config();
