...
@Data
public class Idea37160Config {
    private String name = "idea_037160";
 ...
 */
@Slf4j
public class Idea37160Service {
    private static final int IDEA_ID = 37160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37160Service() {
        this(new Idea37160Config());
    }

    public Idea37160Service(Idea37160Config config) {
        this.config = config != null ? config : new Idea37160Config();
