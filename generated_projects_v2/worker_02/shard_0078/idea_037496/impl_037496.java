...
@Data
public class Idea37496Config {
    private String name = "idea_037496";
 ...
 */
@Slf4j
public class Idea37496Service {
    private static final int IDEA_ID = 37496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37496Service() {
        this(new Idea37496Config());
    }

    public Idea37496Service(Idea37496Config config) {
        this.config = config != null ? config : new Idea37496Config();
