...
@Data
public class Idea37209Config {
    private String name = "idea_037209";
 ...
 */
@Slf4j
public class Idea37209Service {
    private static final int IDEA_ID = 37209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37209Service() {
        this(new Idea37209Config());
    }

    public Idea37209Service(Idea37209Config config) {
        this.config = config != null ? config : new Idea37209Config();
