...
@Data
public class Idea37219Config {
    private String name = "idea_037219";
 ...
 */
@Slf4j
public class Idea37219Service {
    private static final int IDEA_ID = 37219;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37219Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37219Service() {
        this(new Idea37219Config());
    }

    public Idea37219Service(Idea37219Config config) {
        this.config = config != null ? config : new Idea37219Config();
