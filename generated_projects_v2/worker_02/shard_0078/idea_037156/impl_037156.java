...
@Data
public class Idea37156Config {
    private String name = "idea_037156";
 ...
 */
@Slf4j
public class Idea37156Service {
    private static final int IDEA_ID = 37156;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37156Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37156Service() {
        this(new Idea37156Config());
    }

    public Idea37156Service(Idea37156Config config) {
        this.config = config != null ? config : new Idea37156Config();
