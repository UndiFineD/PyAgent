...
@Data
public class Idea37404Config {
    private String name = "idea_037404";
 ...
 */
@Slf4j
public class Idea37404Service {
    private static final int IDEA_ID = 37404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37404Service() {
        this(new Idea37404Config());
    }

    public Idea37404Service(Idea37404Config config) {
        this.config = config != null ? config : new Idea37404Config();
