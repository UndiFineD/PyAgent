...
@Data
public class Idea37387Config {
    private String name = "idea_037387";
 ...
 */
@Slf4j
public class Idea37387Service {
    private static final int IDEA_ID = 37387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37387Service() {
        this(new Idea37387Config());
    }

    public Idea37387Service(Idea37387Config config) {
        this.config = config != null ? config : new Idea37387Config();
