...
@Data
public class Idea37281Config {
    private String name = "idea_037281";
 ...
 */
@Slf4j
public class Idea37281Service {
    private static final int IDEA_ID = 37281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37281Service() {
        this(new Idea37281Config());
    }

    public Idea37281Service(Idea37281Config config) {
        this.config = config != null ? config : new Idea37281Config();
