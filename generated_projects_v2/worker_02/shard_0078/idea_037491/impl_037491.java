...
@Data
public class Idea37491Config {
    private String name = "idea_037491";
 ...
 */
@Slf4j
public class Idea37491Service {
    private static final int IDEA_ID = 37491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37491Service() {
        this(new Idea37491Config());
    }

    public Idea37491Service(Idea37491Config config) {
        this.config = config != null ? config : new Idea37491Config();
