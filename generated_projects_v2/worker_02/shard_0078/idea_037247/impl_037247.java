...
@Data
public class Idea37247Config {
    private String name = "idea_037247";
 ...
 */
@Slf4j
public class Idea37247Service {
    private static final int IDEA_ID = 37247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37247Service() {
        this(new Idea37247Config());
    }

    public Idea37247Service(Idea37247Config config) {
        this.config = config != null ? config : new Idea37247Config();
