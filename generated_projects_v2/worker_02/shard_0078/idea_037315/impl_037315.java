...
@Data
public class Idea37315Config {
    private String name = "idea_037315";
 ...
 */
@Slf4j
public class Idea37315Service {
    private static final int IDEA_ID = 37315;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37315Service() {
        this(new Idea37315Config());
    }

    public Idea37315Service(Idea37315Config config) {
        this.config = config != null ? config : new Idea37315Config();
