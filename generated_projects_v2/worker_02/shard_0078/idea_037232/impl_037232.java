...
@Data
public class Idea37232Config {
    private String name = "idea_037232";
 ...
 */
@Slf4j
public class Idea37232Service {
    private static final int IDEA_ID = 37232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37232Service() {
        this(new Idea37232Config());
    }

    public Idea37232Service(Idea37232Config config) {
        this.config = config != null ? config : new Idea37232Config();
