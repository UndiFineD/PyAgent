...
@Data
public class Idea37467Config {
    private String name = "idea_037467";
 ...
 */
@Slf4j
public class Idea37467Service {
    private static final int IDEA_ID = 37467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37467Service() {
        this(new Idea37467Config());
    }

    public Idea37467Service(Idea37467Config config) {
        this.config = config != null ? config : new Idea37467Config();
