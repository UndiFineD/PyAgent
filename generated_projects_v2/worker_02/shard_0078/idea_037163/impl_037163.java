...
@Data
public class Idea37163Config {
    private String name = "idea_037163";
 ...
 */
@Slf4j
public class Idea37163Service {
    private static final int IDEA_ID = 37163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37163Service() {
        this(new Idea37163Config());
    }

    public Idea37163Service(Idea37163Config config) {
        this.config = config != null ? config : new Idea37163Config();
