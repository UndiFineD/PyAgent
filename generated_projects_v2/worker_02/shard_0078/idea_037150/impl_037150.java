...
@Data
public class Idea37150Config {
    private String name = "idea_037150";
 ...
 */
@Slf4j
public class Idea37150Service {
    private static final int IDEA_ID = 37150;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37150Service() {
        this(new Idea37150Config());
    }

    public Idea37150Service(Idea37150Config config) {
        this.config = config != null ? config : new Idea37150Config();
