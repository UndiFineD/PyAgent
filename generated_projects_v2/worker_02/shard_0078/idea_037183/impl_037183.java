...
@Data
public class Idea37183Config {
    private String name = "idea_037183";
 ...
 */
@Slf4j
public class Idea37183Service {
    private static final int IDEA_ID = 37183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37183Service() {
        this(new Idea37183Config());
    }

    public Idea37183Service(Idea37183Config config) {
        this.config = config != null ? config : new Idea37183Config();
