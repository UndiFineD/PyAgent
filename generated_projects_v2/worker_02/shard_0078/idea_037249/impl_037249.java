...
@Data
public class Idea37249Config {
    private String name = "idea_037249";
 ...
 */
@Slf4j
public class Idea37249Service {
    private static final int IDEA_ID = 37249;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37249Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37249Service() {
        this(new Idea37249Config());
    }

    public Idea37249Service(Idea37249Config config) {
        this.config = config != null ? config : new Idea37249Config();
