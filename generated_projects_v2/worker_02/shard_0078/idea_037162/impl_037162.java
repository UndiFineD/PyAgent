...
@Data
public class Idea37162Config {
    private String name = "idea_037162";
 ...
 */
@Slf4j
public class Idea37162Service {
    private static final int IDEA_ID = 37162;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37162Service() {
        this(new Idea37162Config());
    }

    public Idea37162Service(Idea37162Config config) {
        this.config = config != null ? config : new Idea37162Config();
