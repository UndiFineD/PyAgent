...
@Data
public class Idea37090Config {
    private String name = "idea_037090";
 ...
 */
@Slf4j
public class Idea37090Service {
    private static final int IDEA_ID = 37090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37090Service() {
        this(new Idea37090Config());
    }

    public Idea37090Service(Idea37090Config config) {
        this.config = config != null ? config : new Idea37090Config();
