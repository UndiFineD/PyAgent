...
@Data
public class Idea37215Config {
    private String name = "idea_037215";
 ...
 */
@Slf4j
public class Idea37215Service {
    private static final int IDEA_ID = 37215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37215Service() {
        this(new Idea37215Config());
    }

    public Idea37215Service(Idea37215Config config) {
        this.config = config != null ? config : new Idea37215Config();
