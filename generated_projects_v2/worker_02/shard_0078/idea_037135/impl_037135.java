...
@Data
public class Idea37135Config {
    private String name = "idea_037135";
 ...
 */
@Slf4j
public class Idea37135Service {
    private static final int IDEA_ID = 37135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37135Service() {
        this(new Idea37135Config());
    }

    public Idea37135Service(Idea37135Config config) {
        this.config = config != null ? config : new Idea37135Config();
