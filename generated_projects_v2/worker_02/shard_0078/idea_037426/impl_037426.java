...
@Data
public class Idea37426Config {
    private String name = "idea_037426";
 ...
 */
@Slf4j
public class Idea37426Service {
    private static final int IDEA_ID = 37426;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37426Service() {
        this(new Idea37426Config());
    }

    public Idea37426Service(Idea37426Config config) {
        this.config = config != null ? config : new Idea37426Config();
