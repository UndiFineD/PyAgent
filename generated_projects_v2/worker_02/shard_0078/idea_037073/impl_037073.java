...
@Data
public class Idea37073Config {
    private String name = "idea_037073";
 ...
 */
@Slf4j
public class Idea37073Service {
    private static final int IDEA_ID = 37073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37073Service() {
        this(new Idea37073Config());
    }

    public Idea37073Service(Idea37073Config config) {
        this.config = config != null ? config : new Idea37073Config();
