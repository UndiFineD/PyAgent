...
@Data
public class Idea37339Config {
    private String name = "idea_037339";
 ...
 */
@Slf4j
public class Idea37339Service {
    private static final int IDEA_ID = 37339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37339Service() {
        this(new Idea37339Config());
    }

    public Idea37339Service(Idea37339Config config) {
        this.config = config != null ? config : new Idea37339Config();
