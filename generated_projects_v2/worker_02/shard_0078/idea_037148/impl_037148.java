...
@Data
public class Idea37148Config {
    private String name = "idea_037148";
 ...
 */
@Slf4j
public class Idea37148Service {
    private static final int IDEA_ID = 37148;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37148Service() {
        this(new Idea37148Config());
    }

    public Idea37148Service(Idea37148Config config) {
        this.config = config != null ? config : new Idea37148Config();
