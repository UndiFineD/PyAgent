...
@Data
public class Idea37257Config {
    private String name = "idea_037257";
 ...
 */
@Slf4j
public class Idea37257Service {
    private static final int IDEA_ID = 37257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37257Service() {
        this(new Idea37257Config());
    }

    public Idea37257Service(Idea37257Config config) {
        this.config = config != null ? config : new Idea37257Config();
