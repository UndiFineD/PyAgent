...
@Data
public class Idea37246Config {
    private String name = "idea_037246";
 ...
 */
@Slf4j
public class Idea37246Service {
    private static final int IDEA_ID = 37246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37246Service() {
        this(new Idea37246Config());
    }

    public Idea37246Service(Idea37246Config config) {
        this.config = config != null ? config : new Idea37246Config();
