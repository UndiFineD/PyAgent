...
@Data
public class Idea37520Config {
    private String name = "idea_037520";
 ...
 */
@Slf4j
public class Idea37520Service {
    private static final int IDEA_ID = 37520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37520Service() {
        this(new Idea37520Config());
    }

    public Idea37520Service(Idea37520Config config) {
        this.config = config != null ? config : new Idea37520Config();
