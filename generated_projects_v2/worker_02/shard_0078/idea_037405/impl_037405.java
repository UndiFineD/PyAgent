...
@Data
public class Idea37405Config {
    private String name = "idea_037405";
 ...
 */
@Slf4j
public class Idea37405Service {
    private static final int IDEA_ID = 37405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37405Service() {
        this(new Idea37405Config());
    }

    public Idea37405Service(Idea37405Config config) {
        this.config = config != null ? config : new Idea37405Config();
