...
@Data
public class Idea37284Config {
    private String name = "idea_037284";
 ...
 */
@Slf4j
public class Idea37284Service {
    private static final int IDEA_ID = 37284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37284Service() {
        this(new Idea37284Config());
    }

    public Idea37284Service(Idea37284Config config) {
        this.config = config != null ? config : new Idea37284Config();
