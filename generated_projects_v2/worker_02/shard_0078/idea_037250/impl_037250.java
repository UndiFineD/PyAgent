...
@Data
public class Idea37250Config {
    private String name = "idea_037250";
 ...
 */
@Slf4j
public class Idea37250Service {
    private static final int IDEA_ID = 37250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37250Service() {
        this(new Idea37250Config());
    }

    public Idea37250Service(Idea37250Config config) {
        this.config = config != null ? config : new Idea37250Config();
