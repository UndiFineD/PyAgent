...
@Data
public class Idea37329Config {
    private String name = "idea_037329";
 ...
 */
@Slf4j
public class Idea37329Service {
    private static final int IDEA_ID = 37329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37329Service() {
        this(new Idea37329Config());
    }

    public Idea37329Service(Idea37329Config config) {
        this.config = config != null ? config : new Idea37329Config();
