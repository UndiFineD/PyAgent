...
@Data
public class Idea37495Config {
    private String name = "idea_037495";
 ...
 */
@Slf4j
public class Idea37495Service {
    private static final int IDEA_ID = 37495;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37495Service() {
        this(new Idea37495Config());
    }

    public Idea37495Service(Idea37495Config config) {
        this.config = config != null ? config : new Idea37495Config();
