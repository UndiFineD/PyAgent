...
@Data
public class Idea37124Config {
    private String name = "idea_037124";
 ...
 */
@Slf4j
public class Idea37124Service {
    private static final int IDEA_ID = 37124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37124Service() {
        this(new Idea37124Config());
    }

    public Idea37124Service(Idea37124Config config) {
        this.config = config != null ? config : new Idea37124Config();
