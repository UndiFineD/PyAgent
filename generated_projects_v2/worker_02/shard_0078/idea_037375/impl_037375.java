...
@Data
public class Idea37375Config {
    private String name = "idea_037375";
 ...
 */
@Slf4j
public class Idea37375Service {
    private static final int IDEA_ID = 37375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37375Service() {
        this(new Idea37375Config());
    }

    public Idea37375Service(Idea37375Config config) {
        this.config = config != null ? config : new Idea37375Config();
