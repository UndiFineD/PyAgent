...
@Data
public class Idea37448Config {
    private String name = "idea_037448";
 ...
 */
@Slf4j
public class Idea37448Service {
    private static final int IDEA_ID = 37448;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37448Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37448Service() {
        this(new Idea37448Config());
    }

    public Idea37448Service(Idea37448Config config) {
        this.config = config != null ? config : new Idea37448Config();
