...
@Data
public class Idea37356Config {
    private String name = "idea_037356";
 ...
 */
@Slf4j
public class Idea37356Service {
    private static final int IDEA_ID = 37356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37356Service() {
        this(new Idea37356Config());
    }

    public Idea37356Service(Idea37356Config config) {
        this.config = config != null ? config : new Idea37356Config();
