...
@Data
public class Idea37396Config {
    private String name = "idea_037396";
 ...
 */
@Slf4j
public class Idea37396Service {
    private static final int IDEA_ID = 37396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37396Service() {
        this(new Idea37396Config());
    }

    public Idea37396Service(Idea37396Config config) {
        this.config = config != null ? config : new Idea37396Config();
