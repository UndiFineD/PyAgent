...
@Data
public class Idea37133Config {
    private String name = "idea_037133";
 ...
 */
@Slf4j
public class Idea37133Service {
    private static final int IDEA_ID = 37133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37133Service() {
        this(new Idea37133Config());
    }

    public Idea37133Service(Idea37133Config config) {
        this.config = config != null ? config : new Idea37133Config();
