...
@Data
public class Idea37490Config {
    private String name = "idea_037490";
 ...
 */
@Slf4j
public class Idea37490Service {
    private static final int IDEA_ID = 37490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37490Service() {
        this(new Idea37490Config());
    }

    public Idea37490Service(Idea37490Config config) {
        this.config = config != null ? config : new Idea37490Config();
