...
@Data
public class Idea37485Config {
    private String name = "idea_037485";
 ...
 */
@Slf4j
public class Idea37485Service {
    private static final int IDEA_ID = 37485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37485Service() {
        this(new Idea37485Config());
    }

    public Idea37485Service(Idea37485Config config) {
        this.config = config != null ? config : new Idea37485Config();
