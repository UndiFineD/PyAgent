...
@Data
public class Idea37477Config {
    private String name = "idea_037477";
 ...
 */
@Slf4j
public class Idea37477Service {
    private static final int IDEA_ID = 37477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37477Service() {
        this(new Idea37477Config());
    }

    public Idea37477Service(Idea37477Config config) {
        this.config = config != null ? config : new Idea37477Config();
