...
@Data
public class Idea37231Config {
    private String name = "idea_037231";
 ...
 */
@Slf4j
public class Idea37231Service {
    private static final int IDEA_ID = 37231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37231Service() {
        this(new Idea37231Config());
    }

    public Idea37231Service(Idea37231Config config) {
        this.config = config != null ? config : new Idea37231Config();
