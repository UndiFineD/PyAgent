...
@Data
public class Idea37237Config {
    private String name = "idea_037237";
 ...
 */
@Slf4j
public class Idea37237Service {
    private static final int IDEA_ID = 37237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37237Service() {
        this(new Idea37237Config());
    }

    public Idea37237Service(Idea37237Config config) {
        this.config = config != null ? config : new Idea37237Config();
