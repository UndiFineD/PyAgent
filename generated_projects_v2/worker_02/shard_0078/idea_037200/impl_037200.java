...
@Data
public class Idea37200Config {
    private String name = "idea_037200";
 ...
 */
@Slf4j
public class Idea37200Service {
    private static final int IDEA_ID = 37200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37200Service() {
        this(new Idea37200Config());
    }

    public Idea37200Service(Idea37200Config config) {
        this.config = config != null ? config : new Idea37200Config();
