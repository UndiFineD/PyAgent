...
@Data
public class Idea37158Config {
    private String name = "idea_037158";
 ...
 */
@Slf4j
public class Idea37158Service {
    private static final int IDEA_ID = 37158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37158Service() {
        this(new Idea37158Config());
    }

    public Idea37158Service(Idea37158Config config) {
        this.config = config != null ? config : new Idea37158Config();
