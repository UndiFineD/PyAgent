...
@Data
public class Idea37266Config {
    private String name = "idea_037266";
 ...
 */
@Slf4j
public class Idea37266Service {
    private static final int IDEA_ID = 37266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37266Service() {
        this(new Idea37266Config());
    }

    public Idea37266Service(Idea37266Config config) {
        this.config = config != null ? config : new Idea37266Config();
