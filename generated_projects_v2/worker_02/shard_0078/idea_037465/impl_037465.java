...
@Data
public class Idea37465Config {
    private String name = "idea_037465";
 ...
 */
@Slf4j
public class Idea37465Service {
    private static final int IDEA_ID = 37465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37465Service() {
        this(new Idea37465Config());
    }

    public Idea37465Service(Idea37465Config config) {
        this.config = config != null ? config : new Idea37465Config();
