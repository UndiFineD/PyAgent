...
@Data
public class Idea37283Config {
    private String name = "idea_037283";
 ...
 */
@Slf4j
public class Idea37283Service {
    private static final int IDEA_ID = 37283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37283Service() {
        this(new Idea37283Config());
    }

    public Idea37283Service(Idea37283Config config) {
        this.config = config != null ? config : new Idea37283Config();
