...
@Data
public class Idea37268Config {
    private String name = "idea_037268";
 ...
 */
@Slf4j
public class Idea37268Service {
    private static final int IDEA_ID = 37268;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37268Service() {
        this(new Idea37268Config());
    }

    public Idea37268Service(Idea37268Config config) {
        this.config = config != null ? config : new Idea37268Config();
