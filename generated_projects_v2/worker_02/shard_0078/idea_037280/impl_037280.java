...
@Data
public class Idea37280Config {
    private String name = "idea_037280";
 ...
 */
@Slf4j
public class Idea37280Service {
    private static final int IDEA_ID = 37280;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37280Service() {
        this(new Idea37280Config());
    }

    public Idea37280Service(Idea37280Config config) {
        this.config = config != null ? config : new Idea37280Config();
