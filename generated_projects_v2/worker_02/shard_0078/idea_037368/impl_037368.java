...
@Data
public class Idea37368Config {
    private String name = "idea_037368";
 ...
 */
@Slf4j
public class Idea37368Service {
    private static final int IDEA_ID = 37368;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37368Service() {
        this(new Idea37368Config());
    }

    public Idea37368Service(Idea37368Config config) {
        this.config = config != null ? config : new Idea37368Config();
