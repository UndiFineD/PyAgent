...
@Data
public class Idea37439Config {
    private String name = "idea_037439";
 ...
 */
@Slf4j
public class Idea37439Service {
    private static final int IDEA_ID = 37439;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37439Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37439Service() {
        this(new Idea37439Config());
    }

    public Idea37439Service(Idea37439Config config) {
        this.config = config != null ? config : new Idea37439Config();
