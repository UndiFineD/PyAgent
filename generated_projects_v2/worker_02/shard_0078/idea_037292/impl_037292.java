...
@Data
public class Idea37292Config {
    private String name = "idea_037292";
 ...
 */
@Slf4j
public class Idea37292Service {
    private static final int IDEA_ID = 37292;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37292Service() {
        this(new Idea37292Config());
    }

    public Idea37292Service(Idea37292Config config) {
        this.config = config != null ? config : new Idea37292Config();
