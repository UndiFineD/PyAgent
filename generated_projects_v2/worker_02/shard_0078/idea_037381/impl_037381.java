...
@Data
public class Idea37381Config {
    private String name = "idea_037381";
 ...
 */
@Slf4j
public class Idea37381Service {
    private static final int IDEA_ID = 37381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37381Service() {
        this(new Idea37381Config());
    }

    public Idea37381Service(Idea37381Config config) {
        this.config = config != null ? config : new Idea37381Config();
