...
@Data
public class Idea37169Config {
    private String name = "idea_037169";
 ...
 */
@Slf4j
public class Idea37169Service {
    private static final int IDEA_ID = 37169;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37169Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37169Service() {
        this(new Idea37169Config());
    }

    public Idea37169Service(Idea37169Config config) {
        this.config = config != null ? config : new Idea37169Config();
