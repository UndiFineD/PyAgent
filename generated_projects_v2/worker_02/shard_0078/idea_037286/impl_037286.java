...
@Data
public class Idea37286Config {
    private String name = "idea_037286";
 ...
 */
@Slf4j
public class Idea37286Service {
    private static final int IDEA_ID = 37286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37286Service() {
        this(new Idea37286Config());
    }

    public Idea37286Service(Idea37286Config config) {
        this.config = config != null ? config : new Idea37286Config();
