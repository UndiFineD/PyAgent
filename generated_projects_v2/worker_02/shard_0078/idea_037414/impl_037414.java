...
@Data
public class Idea37414Config {
    private String name = "idea_037414";
 ...
 */
@Slf4j
public class Idea37414Service {
    private static final int IDEA_ID = 37414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37414Service() {
        this(new Idea37414Config());
    }

    public Idea37414Service(Idea37414Config config) {
        this.config = config != null ? config : new Idea37414Config();
