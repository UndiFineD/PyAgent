...
@Data
public class Idea37475Config {
    private String name = "idea_037475";
 ...
 */
@Slf4j
public class Idea37475Service {
    private static final int IDEA_ID = 37475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37475Service() {
        this(new Idea37475Config());
    }

    public Idea37475Service(Idea37475Config config) {
        this.config = config != null ? config : new Idea37475Config();
