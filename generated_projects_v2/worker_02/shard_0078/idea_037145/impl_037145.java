...
@Data
public class Idea37145Config {
    private String name = "idea_037145";
 ...
 */
@Slf4j
public class Idea37145Service {
    private static final int IDEA_ID = 37145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37145Service() {
        this(new Idea37145Config());
    }

    public Idea37145Service(Idea37145Config config) {
        this.config = config != null ? config : new Idea37145Config();
