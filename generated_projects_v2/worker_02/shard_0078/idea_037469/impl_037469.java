...
@Data
public class Idea37469Config {
    private String name = "idea_037469";
 ...
 */
@Slf4j
public class Idea37469Service {
    private static final int IDEA_ID = 37469;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37469Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37469Service() {
        this(new Idea37469Config());
    }

    public Idea37469Service(Idea37469Config config) {
        this.config = config != null ? config : new Idea37469Config();
