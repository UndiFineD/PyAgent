...
@Data
public class Idea37340Config {
    private String name = "idea_037340";
 ...
 */
@Slf4j
public class Idea37340Service {
    private static final int IDEA_ID = 37340;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37340Service() {
        this(new Idea37340Config());
    }

    public Idea37340Service(Idea37340Config config) {
        this.config = config != null ? config : new Idea37340Config();
