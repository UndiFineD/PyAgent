...
@Data
public class Idea37383Config {
    private String name = "idea_037383";
 ...
 */
@Slf4j
public class Idea37383Service {
    private static final int IDEA_ID = 37383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37383Service() {
        this(new Idea37383Config());
    }

    public Idea37383Service(Idea37383Config config) {
        this.config = config != null ? config : new Idea37383Config();
