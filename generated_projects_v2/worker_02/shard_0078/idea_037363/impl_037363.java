...
@Data
public class Idea37363Config {
    private String name = "idea_037363";
 ...
 */
@Slf4j
public class Idea37363Service {
    private static final int IDEA_ID = 37363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37363Service() {
        this(new Idea37363Config());
    }

    public Idea37363Service(Idea37363Config config) {
        this.config = config != null ? config : new Idea37363Config();
