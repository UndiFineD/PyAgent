...
@Data
public class Idea37175Config {
    private String name = "idea_037175";
 ...
 */
@Slf4j
public class Idea37175Service {
    private static final int IDEA_ID = 37175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37175Service() {
        this(new Idea37175Config());
    }

    public Idea37175Service(Idea37175Config config) {
        this.config = config != null ? config : new Idea37175Config();
