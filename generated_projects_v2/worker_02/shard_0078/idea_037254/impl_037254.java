...
@Data
public class Idea37254Config {
    private String name = "idea_037254";
 ...
 */
@Slf4j
public class Idea37254Service {
    private static final int IDEA_ID = 37254;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37254Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37254Service() {
        this(new Idea37254Config());
    }

    public Idea37254Service(Idea37254Config config) {
        this.config = config != null ? config : new Idea37254Config();
