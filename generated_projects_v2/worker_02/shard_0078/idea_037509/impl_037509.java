...
@Data
public class Idea37509Config {
    private String name = "idea_037509";
 ...
 */
@Slf4j
public class Idea37509Service {
    private static final int IDEA_ID = 37509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37509Service() {
        this(new Idea37509Config());
    }

    public Idea37509Service(Idea37509Config config) {
        this.config = config != null ? config : new Idea37509Config();
