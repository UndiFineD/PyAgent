...
@Data
public class Idea37147Config {
    private String name = "idea_037147";
 ...
 */
@Slf4j
public class Idea37147Service {
    private static final int IDEA_ID = 37147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37147Service() {
        this(new Idea37147Config());
    }

    public Idea37147Service(Idea37147Config config) {
        this.config = config != null ? config : new Idea37147Config();
