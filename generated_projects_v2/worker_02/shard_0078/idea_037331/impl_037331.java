...
@Data
public class Idea37331Config {
    private String name = "idea_037331";
 ...
 */
@Slf4j
public class Idea37331Service {
    private static final int IDEA_ID = 37331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37331Service() {
        this(new Idea37331Config());
    }

    public Idea37331Service(Idea37331Config config) {
        this.config = config != null ? config : new Idea37331Config();
