...
@Data
public class Idea37225Config {
    private String name = "idea_037225";
 ...
 */
@Slf4j
public class Idea37225Service {
    private static final int IDEA_ID = 37225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37225Service() {
        this(new Idea37225Config());
    }

    public Idea37225Service(Idea37225Config config) {
        this.config = config != null ? config : new Idea37225Config();
