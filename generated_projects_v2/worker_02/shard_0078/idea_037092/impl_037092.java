...
@Data
public class Idea37092Config {
    private String name = "idea_037092";
 ...
 */
@Slf4j
public class Idea37092Service {
    private static final int IDEA_ID = 37092;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37092Service() {
        this(new Idea37092Config());
    }

    public Idea37092Service(Idea37092Config config) {
        this.config = config != null ? config : new Idea37092Config();
