...
@Data
public class Idea37065Config {
    private String name = "idea_037065";
 ...
 */
@Slf4j
public class Idea37065Service {
    private static final int IDEA_ID = 37065;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37065Service() {
        this(new Idea37065Config());
    }

    public Idea37065Service(Idea37065Config config) {
        this.config = config != null ? config : new Idea37065Config();
