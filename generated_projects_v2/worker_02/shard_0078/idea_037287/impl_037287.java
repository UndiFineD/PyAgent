...
@Data
public class Idea37287Config {
    private String name = "idea_037287";
 ...
 */
@Slf4j
public class Idea37287Service {
    private static final int IDEA_ID = 37287;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37287Service() {
        this(new Idea37287Config());
    }

    public Idea37287Service(Idea37287Config config) {
        this.config = config != null ? config : new Idea37287Config();
