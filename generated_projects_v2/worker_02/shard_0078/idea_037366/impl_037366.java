...
@Data
public class Idea37366Config {
    private String name = "idea_037366";
 ...
 */
@Slf4j
public class Idea37366Service {
    private static final int IDEA_ID = 37366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37366Service() {
        this(new Idea37366Config());
    }

    public Idea37366Service(Idea37366Config config) {
        this.config = config != null ? config : new Idea37366Config();
