...
@Data
public class Idea37423Config {
    private String name = "idea_037423";
 ...
 */
@Slf4j
public class Idea37423Service {
    private static final int IDEA_ID = 37423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37423Service() {
        this(new Idea37423Config());
    }

    public Idea37423Service(Idea37423Config config) {
        this.config = config != null ? config : new Idea37423Config();
