...
@Data
public class Idea37447Config {
    private String name = "idea_037447";
 ...
 */
@Slf4j
public class Idea37447Service {
    private static final int IDEA_ID = 37447;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37447Service() {
        this(new Idea37447Config());
    }

    public Idea37447Service(Idea37447Config config) {
        this.config = config != null ? config : new Idea37447Config();
