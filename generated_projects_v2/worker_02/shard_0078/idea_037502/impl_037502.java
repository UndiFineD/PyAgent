...
@Data
public class Idea37502Config {
    private String name = "idea_037502";
 ...
 */
@Slf4j
public class Idea37502Service {
    private static final int IDEA_ID = 37502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37502Service() {
        this(new Idea37502Config());
    }

    public Idea37502Service(Idea37502Config config) {
        this.config = config != null ? config : new Idea37502Config();
