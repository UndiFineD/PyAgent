...
@Data
public class Idea37255Config {
    private String name = "idea_037255";
 ...
 */
@Slf4j
public class Idea37255Service {
    private static final int IDEA_ID = 37255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37255Service() {
        this(new Idea37255Config());
    }

    public Idea37255Service(Idea37255Config config) {
        this.config = config != null ? config : new Idea37255Config();
