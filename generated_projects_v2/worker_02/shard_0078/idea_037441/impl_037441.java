...
@Data
public class Idea37441Config {
    private String name = "idea_037441";
 ...
 */
@Slf4j
public class Idea37441Service {
    private static final int IDEA_ID = 37441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37441Service() {
        this(new Idea37441Config());
    }

    public Idea37441Service(Idea37441Config config) {
        this.config = config != null ? config : new Idea37441Config();
