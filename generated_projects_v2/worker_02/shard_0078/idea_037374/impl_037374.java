...
@Data
public class Idea37374Config {
    private String name = "idea_037374";
 ...
 */
@Slf4j
public class Idea37374Service {
    private static final int IDEA_ID = 37374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37374Service() {
        this(new Idea37374Config());
    }

    public Idea37374Service(Idea37374Config config) {
        this.config = config != null ? config : new Idea37374Config();
