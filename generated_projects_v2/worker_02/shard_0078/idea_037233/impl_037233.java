...
@Data
public class Idea37233Config {
    private String name = "idea_037233";
 ...
 */
@Slf4j
public class Idea37233Service {
    private static final int IDEA_ID = 37233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37233Service() {
        this(new Idea37233Config());
    }

    public Idea37233Service(Idea37233Config config) {
        this.config = config != null ? config : new Idea37233Config();
