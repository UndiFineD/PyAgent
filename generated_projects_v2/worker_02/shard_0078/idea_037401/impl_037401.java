...
@Data
public class Idea37401Config {
    private String name = "idea_037401";
 ...
 */
@Slf4j
public class Idea37401Service {
    private static final int IDEA_ID = 37401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37401Service() {
        this(new Idea37401Config());
    }

    public Idea37401Service(Idea37401Config config) {
        this.config = config != null ? config : new Idea37401Config();
