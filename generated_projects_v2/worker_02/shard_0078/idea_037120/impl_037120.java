...
@Data
public class Idea37120Config {
    private String name = "idea_037120";
 ...
 */
@Slf4j
public class Idea37120Service {
    private static final int IDEA_ID = 37120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37120Service() {
        this(new Idea37120Config());
    }

    public Idea37120Service(Idea37120Config config) {
        this.config = config != null ? config : new Idea37120Config();
