...
@Data
public class Idea37056Config {
    private String name = "idea_037056";
 ...
 */
@Slf4j
public class Idea37056Service {
    private static final int IDEA_ID = 37056;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37056Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37056Service() {
        this(new Idea37056Config());
    }

    public Idea37056Service(Idea37056Config config) {
        this.config = config != null ? config : new Idea37056Config();
