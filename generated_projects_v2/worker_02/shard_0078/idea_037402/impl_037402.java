...
@Data
public class Idea37402Config {
    private String name = "idea_037402";
 ...
 */
@Slf4j
public class Idea37402Service {
    private static final int IDEA_ID = 37402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37402Service() {
        this(new Idea37402Config());
    }

    public Idea37402Service(Idea37402Config config) {
        this.config = config != null ? config : new Idea37402Config();
