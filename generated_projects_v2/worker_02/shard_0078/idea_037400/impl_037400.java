...
@Data
public class Idea37400Config {
    private String name = "idea_037400";
 ...
 */
@Slf4j
public class Idea37400Service {
    private static final int IDEA_ID = 37400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37400Service() {
        this(new Idea37400Config());
    }

    public Idea37400Service(Idea37400Config config) {
        this.config = config != null ? config : new Idea37400Config();
