...
@Data
public class Idea37118Config {
    private String name = "idea_037118";
 ...
 */
@Slf4j
public class Idea37118Service {
    private static final int IDEA_ID = 37118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37118Service() {
        this(new Idea37118Config());
    }

    public Idea37118Service(Idea37118Config config) {
        this.config = config != null ? config : new Idea37118Config();
