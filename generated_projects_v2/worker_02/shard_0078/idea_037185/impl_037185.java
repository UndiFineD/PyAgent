...
@Data
public class Idea37185Config {
    private String name = "idea_037185";
 ...
 */
@Slf4j
public class Idea37185Service {
    private static final int IDEA_ID = 37185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37185Service() {
        this(new Idea37185Config());
    }

    public Idea37185Service(Idea37185Config config) {
        this.config = config != null ? config : new Idea37185Config();
