...
@Data
public class Idea37317Config {
    private String name = "idea_037317";
 ...
 */
@Slf4j
public class Idea37317Service {
    private static final int IDEA_ID = 37317;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37317Service() {
        this(new Idea37317Config());
    }

    public Idea37317Service(Idea37317Config config) {
        this.config = config != null ? config : new Idea37317Config();
