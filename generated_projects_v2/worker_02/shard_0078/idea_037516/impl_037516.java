...
@Data
public class Idea37516Config {
    private String name = "idea_037516";
 ...
 */
@Slf4j
public class Idea37516Service {
    private static final int IDEA_ID = 37516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37516Service() {
        this(new Idea37516Config());
    }

    public Idea37516Service(Idea37516Config config) {
        this.config = config != null ? config : new Idea37516Config();
