...
@Data
public class Idea37202Config {
    private String name = "idea_037202";
 ...
 */
@Slf4j
public class Idea37202Service {
    private static final int IDEA_ID = 37202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37202Service() {
        this(new Idea37202Config());
    }

    public Idea37202Service(Idea37202Config config) {
        this.config = config != null ? config : new Idea37202Config();
