...
@Data
public class Idea37508Config {
    private String name = "idea_037508";
 ...
 */
@Slf4j
public class Idea37508Service {
    private static final int IDEA_ID = 37508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37508Service() {
        this(new Idea37508Config());
    }

    public Idea37508Service(Idea37508Config config) {
        this.config = config != null ? config : new Idea37508Config();
