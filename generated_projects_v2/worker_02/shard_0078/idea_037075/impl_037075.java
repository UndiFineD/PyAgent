...
@Data
public class Idea37075Config {
    private String name = "idea_037075";
 ...
 */
@Slf4j
public class Idea37075Service {
    private static final int IDEA_ID = 37075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37075Service() {
        this(new Idea37075Config());
    }

    public Idea37075Service(Idea37075Config config) {
        this.config = config != null ? config : new Idea37075Config();
