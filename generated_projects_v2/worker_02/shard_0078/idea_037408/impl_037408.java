...
@Data
public class Idea37408Config {
    private String name = "idea_037408";
 ...
 */
@Slf4j
public class Idea37408Service {
    private static final int IDEA_ID = 37408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37408Service() {
        this(new Idea37408Config());
    }

    public Idea37408Service(Idea37408Config config) {
        this.config = config != null ? config : new Idea37408Config();
