...
@Data
public class Idea37074Config {
    private String name = "idea_037074";
 ...
 */
@Slf4j
public class Idea37074Service {
    private static final int IDEA_ID = 37074;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37074Service() {
        this(new Idea37074Config());
    }

    public Idea37074Service(Idea37074Config config) {
        this.config = config != null ? config : new Idea37074Config();
