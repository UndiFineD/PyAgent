...
@Data
public class Idea37196Config {
    private String name = "idea_037196";
 ...
 */
@Slf4j
public class Idea37196Service {
    private static final int IDEA_ID = 37196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37196Service() {
        this(new Idea37196Config());
    }

    public Idea37196Service(Idea37196Config config) {
        this.config = config != null ? config : new Idea37196Config();
