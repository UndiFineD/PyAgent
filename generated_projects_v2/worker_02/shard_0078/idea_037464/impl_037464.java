...
@Data
public class Idea37464Config {
    private String name = "idea_037464";
 ...
 */
@Slf4j
public class Idea37464Service {
    private static final int IDEA_ID = 37464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37464Service() {
        this(new Idea37464Config());
    }

    public Idea37464Service(Idea37464Config config) {
        this.config = config != null ? config : new Idea37464Config();
