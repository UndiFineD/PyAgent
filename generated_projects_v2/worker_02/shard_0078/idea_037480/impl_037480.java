...
@Data
public class Idea37480Config {
    private String name = "idea_037480";
 ...
 */
@Slf4j
public class Idea37480Service {
    private static final int IDEA_ID = 37480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37480Service() {
        this(new Idea37480Config());
    }

    public Idea37480Service(Idea37480Config config) {
        this.config = config != null ? config : new Idea37480Config();
