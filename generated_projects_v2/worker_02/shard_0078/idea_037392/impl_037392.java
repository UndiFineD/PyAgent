...
@Data
public class Idea37392Config {
    private String name = "idea_037392";
 ...
 */
@Slf4j
public class Idea37392Service {
    private static final int IDEA_ID = 37392;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37392Service() {
        this(new Idea37392Config());
    }

    public Idea37392Service(Idea37392Config config) {
        this.config = config != null ? config : new Idea37392Config();
