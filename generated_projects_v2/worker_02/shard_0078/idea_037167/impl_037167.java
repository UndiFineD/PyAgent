...
@Data
public class Idea37167Config {
    private String name = "idea_037167";
 ...
 */
@Slf4j
public class Idea37167Service {
    private static final int IDEA_ID = 37167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37167Service() {
        this(new Idea37167Config());
    }

    public Idea37167Service(Idea37167Config config) {
        this.config = config != null ? config : new Idea37167Config();
