...
@Data
public class Idea37443Config {
    private String name = "idea_037443";
 ...
 */
@Slf4j
public class Idea37443Service {
    private static final int IDEA_ID = 37443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37443Service() {
        this(new Idea37443Config());
    }

    public Idea37443Service(Idea37443Config config) {
        this.config = config != null ? config : new Idea37443Config();
