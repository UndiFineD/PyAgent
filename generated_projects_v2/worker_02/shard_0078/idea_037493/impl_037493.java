...
@Data
public class Idea37493Config {
    private String name = "idea_037493";
 ...
 */
@Slf4j
public class Idea37493Service {
    private static final int IDEA_ID = 37493;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37493Service() {
        this(new Idea37493Config());
    }

    public Idea37493Service(Idea37493Config config) {
        this.config = config != null ? config : new Idea37493Config();
