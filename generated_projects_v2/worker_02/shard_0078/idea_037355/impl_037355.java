...
@Data
public class Idea37355Config {
    private String name = "idea_037355";
 ...
 */
@Slf4j
public class Idea37355Service {
    private static final int IDEA_ID = 37355;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37355Service() {
        this(new Idea37355Config());
    }

    public Idea37355Service(Idea37355Config config) {
        this.config = config != null ? config : new Idea37355Config();
