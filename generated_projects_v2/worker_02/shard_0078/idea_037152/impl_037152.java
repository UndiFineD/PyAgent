...
@Data
public class Idea37152Config {
    private String name = "idea_037152";
 ...
 */
@Slf4j
public class Idea37152Service {
    private static final int IDEA_ID = 37152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37152Service() {
        this(new Idea37152Config());
    }

    public Idea37152Service(Idea37152Config config) {
        this.config = config != null ? config : new Idea37152Config();
