...
@Data
public class Idea37051Config {
    private String name = "idea_037051";
 ...
 */
@Slf4j
public class Idea37051Service {
    private static final int IDEA_ID = 37051;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37051Service() {
        this(new Idea37051Config());
    }

    public Idea37051Service(Idea37051Config config) {
        this.config = config != null ? config : new Idea37051Config();
