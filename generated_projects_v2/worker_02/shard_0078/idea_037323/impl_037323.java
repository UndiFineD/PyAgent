...
@Data
public class Idea37323Config {
    private String name = "idea_037323";
 ...
 */
@Slf4j
public class Idea37323Service {
    private static final int IDEA_ID = 37323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37323Service() {
        this(new Idea37323Config());
    }

    public Idea37323Service(Idea37323Config config) {
        this.config = config != null ? config : new Idea37323Config();
