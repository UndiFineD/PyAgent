...
@Data
public class Idea37434Config {
    private String name = "idea_037434";
 ...
 */
@Slf4j
public class Idea37434Service {
    private static final int IDEA_ID = 37434;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37434Service() {
        this(new Idea37434Config());
    }

    public Idea37434Service(Idea37434Config config) {
        this.config = config != null ? config : new Idea37434Config();
