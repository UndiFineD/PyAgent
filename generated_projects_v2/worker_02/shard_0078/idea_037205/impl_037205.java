...
@Data
public class Idea37205Config {
    private String name = "idea_037205";
 ...
 */
@Slf4j
public class Idea37205Service {
    private static final int IDEA_ID = 37205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37205Service() {
        this(new Idea37205Config());
    }

    public Idea37205Service(Idea37205Config config) {
        this.config = config != null ? config : new Idea37205Config();
