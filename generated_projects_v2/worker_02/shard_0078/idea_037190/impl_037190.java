...
@Data
public class Idea37190Config {
    private String name = "idea_037190";
 ...
 */
@Slf4j
public class Idea37190Service {
    private static final int IDEA_ID = 37190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37190Service() {
        this(new Idea37190Config());
    }

    public Idea37190Service(Idea37190Config config) {
        this.config = config != null ? config : new Idea37190Config();
