...
@Data
public class Idea37136Config {
    private String name = "idea_037136";
 ...
 */
@Slf4j
public class Idea37136Service {
    private static final int IDEA_ID = 37136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37136Service() {
        this(new Idea37136Config());
    }

    public Idea37136Service(Idea37136Config config) {
        this.config = config != null ? config : new Idea37136Config();
