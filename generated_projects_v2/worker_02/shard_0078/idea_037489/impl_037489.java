...
@Data
public class Idea37489Config {
    private String name = "idea_037489";
 ...
 */
@Slf4j
public class Idea37489Service {
    private static final int IDEA_ID = 37489;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37489Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37489Service() {
        this(new Idea37489Config());
    }

    public Idea37489Service(Idea37489Config config) {
        this.config = config != null ? config : new Idea37489Config();
