...
@Data
public class Idea37398Config {
    private String name = "idea_037398";
 ...
 */
@Slf4j
public class Idea37398Service {
    private static final int IDEA_ID = 37398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37398Service() {
        this(new Idea37398Config());
    }

    public Idea37398Service(Idea37398Config config) {
        this.config = config != null ? config : new Idea37398Config();
