...
@Data
public class Idea37338Config {
    private String name = "idea_037338";
 ...
 */
@Slf4j
public class Idea37338Service {
    private static final int IDEA_ID = 37338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37338Service() {
        this(new Idea37338Config());
    }

    public Idea37338Service(Idea37338Config config) {
        this.config = config != null ? config : new Idea37338Config();
