...
@Data
public class Idea37440Config {
    private String name = "idea_037440";
 ...
 */
@Slf4j
public class Idea37440Service {
    private static final int IDEA_ID = 37440;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37440Service() {
        this(new Idea37440Config());
    }

    public Idea37440Service(Idea37440Config config) {
        this.config = config != null ? config : new Idea37440Config();
