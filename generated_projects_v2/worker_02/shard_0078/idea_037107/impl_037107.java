...
@Data
public class Idea37107Config {
    private String name = "idea_037107";
 ...
 */
@Slf4j
public class Idea37107Service {
    private static final int IDEA_ID = 37107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37107Service() {
        this(new Idea37107Config());
    }

    public Idea37107Service(Idea37107Config config) {
        this.config = config != null ? config : new Idea37107Config();
