...
@Data
public class Idea37265Config {
    private String name = "idea_037265";
 ...
 */
@Slf4j
public class Idea37265Service {
    private static final int IDEA_ID = 37265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37265Service() {
        this(new Idea37265Config());
    }

    public Idea37265Service(Idea37265Config config) {
        this.config = config != null ? config : new Idea37265Config();
