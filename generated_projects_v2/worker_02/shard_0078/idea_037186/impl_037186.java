...
@Data
public class Idea37186Config {
    private String name = "idea_037186";
 ...
 */
@Slf4j
public class Idea37186Service {
    private static final int IDEA_ID = 37186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37186Service() {
        this(new Idea37186Config());
    }

    public Idea37186Service(Idea37186Config config) {
        this.config = config != null ? config : new Idea37186Config();
