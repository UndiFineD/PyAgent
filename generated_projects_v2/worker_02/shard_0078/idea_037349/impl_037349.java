...
@Data
public class Idea37349Config {
    private String name = "idea_037349";
 ...
 */
@Slf4j
public class Idea37349Service {
    private static final int IDEA_ID = 37349;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37349Service() {
        this(new Idea37349Config());
    }

    public Idea37349Service(Idea37349Config config) {
        this.config = config != null ? config : new Idea37349Config();
