...
@Data
public class Idea37494Config {
    private String name = "idea_037494";
 ...
 */
@Slf4j
public class Idea37494Service {
    private static final int IDEA_ID = 37494;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37494Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37494Service() {
        this(new Idea37494Config());
    }

    public Idea37494Service(Idea37494Config config) {
        this.config = config != null ? config : new Idea37494Config();
