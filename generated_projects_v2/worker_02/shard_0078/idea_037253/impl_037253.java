...
@Data
public class Idea37253Config {
    private String name = "idea_037253";
 ...
 */
@Slf4j
public class Idea37253Service {
    private static final int IDEA_ID = 37253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37253Service() {
        this(new Idea37253Config());
    }

    public Idea37253Service(Idea37253Config config) {
        this.config = config != null ? config : new Idea37253Config();
