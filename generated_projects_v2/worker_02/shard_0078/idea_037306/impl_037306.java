...
@Data
public class Idea37306Config {
    private String name = "idea_037306";
 ...
 */
@Slf4j
public class Idea37306Service {
    private static final int IDEA_ID = 37306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37306Service() {
        this(new Idea37306Config());
    }

    public Idea37306Service(Idea37306Config config) {
        this.config = config != null ? config : new Idea37306Config();
