...
@Data
public class Idea37161Config {
    private String name = "idea_037161";
 ...
 */
@Slf4j
public class Idea37161Service {
    private static final int IDEA_ID = 37161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37161Service() {
        this(new Idea37161Config());
    }

    public Idea37161Service(Idea37161Config config) {
        this.config = config != null ? config : new Idea37161Config();
