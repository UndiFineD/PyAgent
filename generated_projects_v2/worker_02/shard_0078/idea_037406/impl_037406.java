...
@Data
public class Idea37406Config {
    private String name = "idea_037406";
 ...
 */
@Slf4j
public class Idea37406Service {
    private static final int IDEA_ID = 37406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37406Service() {
        this(new Idea37406Config());
    }

    public Idea37406Service(Idea37406Config config) {
        this.config = config != null ? config : new Idea37406Config();
