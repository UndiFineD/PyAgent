...
@Data
public class Idea37165Config {
    private String name = "idea_037165";
 ...
 */
@Slf4j
public class Idea37165Service {
    private static final int IDEA_ID = 37165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37165Service() {
        this(new Idea37165Config());
    }

    public Idea37165Service(Idea37165Config config) {
        this.config = config != null ? config : new Idea37165Config();
