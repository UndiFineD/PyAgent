...
@Data
public class Idea37473Config {
    private String name = "idea_037473";
 ...
 */
@Slf4j
public class Idea37473Service {
    private static final int IDEA_ID = 37473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37473Service() {
        this(new Idea37473Config());
    }

    public Idea37473Service(Idea37473Config config) {
        this.config = config != null ? config : new Idea37473Config();
