...
@Data
public class Idea37086Config {
    private String name = "idea_037086";
 ...
 */
@Slf4j
public class Idea37086Service {
    private static final int IDEA_ID = 37086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37086Service() {
        this(new Idea37086Config());
    }

    public Idea37086Service(Idea37086Config config) {
        this.config = config != null ? config : new Idea37086Config();
