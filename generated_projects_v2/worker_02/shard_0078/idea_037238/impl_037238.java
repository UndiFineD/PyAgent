...
@Data
public class Idea37238Config {
    private String name = "idea_037238";
 ...
 */
@Slf4j
public class Idea37238Service {
    private static final int IDEA_ID = 37238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37238Service() {
        this(new Idea37238Config());
    }

    public Idea37238Service(Idea37238Config config) {
        this.config = config != null ? config : new Idea37238Config();
