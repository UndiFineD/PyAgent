...
@Data
public class Idea37101Config {
    private String name = "idea_037101";
 ...
 */
@Slf4j
public class Idea37101Service {
    private static final int IDEA_ID = 37101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37101Service() {
        this(new Idea37101Config());
    }

    public Idea37101Service(Idea37101Config config) {
        this.config = config != null ? config : new Idea37101Config();
