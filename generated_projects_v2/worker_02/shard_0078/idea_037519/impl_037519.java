...
@Data
public class Idea37519Config {
    private String name = "idea_037519";
 ...
 */
@Slf4j
public class Idea37519Service {
    private static final int IDEA_ID = 37519;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37519Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37519Service() {
        this(new Idea37519Config());
    }

    public Idea37519Service(Idea37519Config config) {
        this.config = config != null ? config : new Idea37519Config();
