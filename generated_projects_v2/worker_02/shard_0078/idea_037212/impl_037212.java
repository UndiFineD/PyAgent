...
@Data
public class Idea37212Config {
    private String name = "idea_037212";
 ...
 */
@Slf4j
public class Idea37212Service {
    private static final int IDEA_ID = 37212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37212Service() {
        this(new Idea37212Config());
    }

    public Idea37212Service(Idea37212Config config) {
        this.config = config != null ? config : new Idea37212Config();
