...
@Data
public class Idea37093Config {
    private String name = "idea_037093";
 ...
 */
@Slf4j
public class Idea37093Service {
    private static final int IDEA_ID = 37093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37093Service() {
        this(new Idea37093Config());
    }

    public Idea37093Service(Idea37093Config config) {
        this.config = config != null ? config : new Idea37093Config();
