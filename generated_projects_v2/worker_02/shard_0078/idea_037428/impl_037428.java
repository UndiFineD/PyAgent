...
@Data
public class Idea37428Config {
    private String name = "idea_037428";
 ...
 */
@Slf4j
public class Idea37428Service {
    private static final int IDEA_ID = 37428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37428Service() {
        this(new Idea37428Config());
    }

    public Idea37428Service(Idea37428Config config) {
        this.config = config != null ? config : new Idea37428Config();
