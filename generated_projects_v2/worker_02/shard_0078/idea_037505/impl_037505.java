...
@Data
public class Idea37505Config {
    private String name = "idea_037505";
 ...
 */
@Slf4j
public class Idea37505Service {
    private static final int IDEA_ID = 37505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37505Service() {
        this(new Idea37505Config());
    }

    public Idea37505Service(Idea37505Config config) {
        this.config = config != null ? config : new Idea37505Config();
