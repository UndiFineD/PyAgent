...
@Data
public class Idea37474Config {
    private String name = "idea_037474";
 ...
 */
@Slf4j
public class Idea37474Service {
    private static final int IDEA_ID = 37474;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37474Service() {
        this(new Idea37474Config());
    }

    public Idea37474Service(Idea37474Config config) {
        this.config = config != null ? config : new Idea37474Config();
