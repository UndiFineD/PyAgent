...
@Data
public class Idea37259Config {
    private String name = "idea_037259";
 ...
 */
@Slf4j
public class Idea37259Service {
    private static final int IDEA_ID = 37259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37259Service() {
        this(new Idea37259Config());
    }

    public Idea37259Service(Idea37259Config config) {
        this.config = config != null ? config : new Idea37259Config();
