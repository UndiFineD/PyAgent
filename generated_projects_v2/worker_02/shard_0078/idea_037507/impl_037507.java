...
@Data
public class Idea37507Config {
    private String name = "idea_037507";
 ...
 */
@Slf4j
public class Idea37507Service {
    private static final int IDEA_ID = 37507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37507Service() {
        this(new Idea37507Config());
    }

    public Idea37507Service(Idea37507Config config) {
        this.config = config != null ? config : new Idea37507Config();
