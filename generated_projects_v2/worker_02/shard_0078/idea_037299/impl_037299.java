...
@Data
public class Idea37299Config {
    private String name = "idea_037299";
 ...
 */
@Slf4j
public class Idea37299Service {
    private static final int IDEA_ID = 37299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37299Service() {
        this(new Idea37299Config());
    }

    public Idea37299Service(Idea37299Config config) {
        this.config = config != null ? config : new Idea37299Config();
