...
@Data
public class Idea37515Config {
    private String name = "idea_037515";
 ...
 */
@Slf4j
public class Idea37515Service {
    private static final int IDEA_ID = 37515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37515Service() {
        this(new Idea37515Config());
    }

    public Idea37515Service(Idea37515Config config) {
        this.config = config != null ? config : new Idea37515Config();
