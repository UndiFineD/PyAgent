...
@Data
public class Idea37486Config {
    private String name = "idea_037486";
 ...
 */
@Slf4j
public class Idea37486Service {
    private static final int IDEA_ID = 37486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37486Service() {
        this(new Idea37486Config());
    }

    public Idea37486Service(Idea37486Config config) {
        this.config = config != null ? config : new Idea37486Config();
