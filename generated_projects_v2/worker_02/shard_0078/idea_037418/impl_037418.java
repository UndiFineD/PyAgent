...
@Data
public class Idea37418Config {
    private String name = "idea_037418";
 ...
 */
@Slf4j
public class Idea37418Service {
    private static final int IDEA_ID = 37418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37418Service() {
        this(new Idea37418Config());
    }

    public Idea37418Service(Idea37418Config config) {
        this.config = config != null ? config : new Idea37418Config();
