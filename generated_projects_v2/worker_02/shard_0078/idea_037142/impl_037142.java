...
@Data
public class Idea37142Config {
    private String name = "idea_037142";
 ...
 */
@Slf4j
public class Idea37142Service {
    private static final int IDEA_ID = 37142;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37142Service() {
        this(new Idea37142Config());
    }

    public Idea37142Service(Idea37142Config config) {
        this.config = config != null ? config : new Idea37142Config();
