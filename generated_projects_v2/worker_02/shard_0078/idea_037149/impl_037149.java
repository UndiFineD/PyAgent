...
@Data
public class Idea37149Config {
    private String name = "idea_037149";
 ...
 */
@Slf4j
public class Idea37149Service {
    private static final int IDEA_ID = 37149;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37149Service() {
        this(new Idea37149Config());
    }

    public Idea37149Service(Idea37149Config config) {
        this.config = config != null ? config : new Idea37149Config();
