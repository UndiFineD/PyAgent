...
@Data
public class Idea37310Config {
    private String name = "idea_037310";
 ...
 */
@Slf4j
public class Idea37310Service {
    private static final int IDEA_ID = 37310;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37310Service() {
        this(new Idea37310Config());
    }

    public Idea37310Service(Idea37310Config config) {
        this.config = config != null ? config : new Idea37310Config();
