...
@Data
public class Idea37514Config {
    private String name = "idea_037514";
 ...
 */
@Slf4j
public class Idea37514Service {
    private static final int IDEA_ID = 37514;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37514Service() {
        this(new Idea37514Config());
    }

    public Idea37514Service(Idea37514Config config) {
        this.config = config != null ? config : new Idea37514Config();
