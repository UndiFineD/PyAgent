...
@Data
public class Idea37221Config {
    private String name = "idea_037221";
 ...
 */
@Slf4j
public class Idea37221Service {
    private static final int IDEA_ID = 37221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37221Service() {
        this(new Idea37221Config());
    }

    public Idea37221Service(Idea37221Config config) {
        this.config = config != null ? config : new Idea37221Config();
