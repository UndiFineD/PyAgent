...
@Data
public class Idea37220Config {
    private String name = "idea_037220";
 ...
 */
@Slf4j
public class Idea37220Service {
    private static final int IDEA_ID = 37220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37220Service() {
        this(new Idea37220Config());
    }

    public Idea37220Service(Idea37220Config config) {
        this.config = config != null ? config : new Idea37220Config();
