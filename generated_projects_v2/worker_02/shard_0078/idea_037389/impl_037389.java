...
@Data
public class Idea37389Config {
    private String name = "idea_037389";
 ...
 */
@Slf4j
public class Idea37389Service {
    private static final int IDEA_ID = 37389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37389Service() {
        this(new Idea37389Config());
    }

    public Idea37389Service(Idea37389Config config) {
        this.config = config != null ? config : new Idea37389Config();
