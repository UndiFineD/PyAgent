...
@Data
public class Idea37229Config {
    private String name = "idea_037229";
 ...
 */
@Slf4j
public class Idea37229Service {
    private static final int IDEA_ID = 37229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37229Service() {
        this(new Idea37229Config());
    }

    public Idea37229Service(Idea37229Config config) {
        this.config = config != null ? config : new Idea37229Config();
