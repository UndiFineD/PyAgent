...
@Data
public class Idea37141Config {
    private String name = "idea_037141";
 ...
 */
@Slf4j
public class Idea37141Service {
    private static final int IDEA_ID = 37141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37141Service() {
        this(new Idea37141Config());
    }

    public Idea37141Service(Idea37141Config config) {
        this.config = config != null ? config : new Idea37141Config();
