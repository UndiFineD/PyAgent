...
@Data
public class Idea37151Config {
    private String name = "idea_037151";
 ...
 */
@Slf4j
public class Idea37151Service {
    private static final int IDEA_ID = 37151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37151Service() {
        this(new Idea37151Config());
    }

    public Idea37151Service(Idea37151Config config) {
        this.config = config != null ? config : new Idea37151Config();
