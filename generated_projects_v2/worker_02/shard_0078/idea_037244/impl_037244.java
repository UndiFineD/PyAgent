...
@Data
public class Idea37244Config {
    private String name = "idea_037244";
 ...
 */
@Slf4j
public class Idea37244Service {
    private static final int IDEA_ID = 37244;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37244Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37244Service() {
        this(new Idea37244Config());
    }

    public Idea37244Service(Idea37244Config config) {
        this.config = config != null ? config : new Idea37244Config();
