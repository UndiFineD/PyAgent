...
@Data
public class Idea37242Config {
    private String name = "idea_037242";
 ...
 */
@Slf4j
public class Idea37242Service {
    private static final int IDEA_ID = 37242;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37242Service() {
        this(new Idea37242Config());
    }

    public Idea37242Service(Idea37242Config config) {
        this.config = config != null ? config : new Idea37242Config();
