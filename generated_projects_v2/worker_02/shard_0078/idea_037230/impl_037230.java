...
@Data
public class Idea37230Config {
    private String name = "idea_037230";
 ...
 */
@Slf4j
public class Idea37230Service {
    private static final int IDEA_ID = 37230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37230Service() {
        this(new Idea37230Config());
    }

    public Idea37230Service(Idea37230Config config) {
        this.config = config != null ? config : new Idea37230Config();
