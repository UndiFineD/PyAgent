...
@Data
public class Idea37126Config {
    private String name = "idea_037126";
 ...
 */
@Slf4j
public class Idea37126Service {
    private static final int IDEA_ID = 37126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37126Service() {
        this(new Idea37126Config());
    }

    public Idea37126Service(Idea37126Config config) {
        this.config = config != null ? config : new Idea37126Config();
