...
@Data
public class Idea37488Config {
    private String name = "idea_037488";
 ...
 */
@Slf4j
public class Idea37488Service {
    private static final int IDEA_ID = 37488;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37488Service() {
        this(new Idea37488Config());
    }

    public Idea37488Service(Idea37488Config config) {
        this.config = config != null ? config : new Idea37488Config();
