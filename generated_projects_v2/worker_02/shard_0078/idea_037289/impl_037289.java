...
@Data
public class Idea37289Config {
    private String name = "idea_037289";
 ...
 */
@Slf4j
public class Idea37289Service {
    private static final int IDEA_ID = 37289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37289Service() {
        this(new Idea37289Config());
    }

    public Idea37289Service(Idea37289Config config) {
        this.config = config != null ? config : new Idea37289Config();
