...
@Data
public class Idea37143Config {
    private String name = "idea_037143";
 ...
 */
@Slf4j
public class Idea37143Service {
    private static final int IDEA_ID = 37143;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37143Service() {
        this(new Idea37143Config());
    }

    public Idea37143Service(Idea37143Config config) {
        this.config = config != null ? config : new Idea37143Config();
