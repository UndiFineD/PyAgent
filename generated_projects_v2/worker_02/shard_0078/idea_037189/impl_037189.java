...
@Data
public class Idea37189Config {
    private String name = "idea_037189";
 ...
 */
@Slf4j
public class Idea37189Service {
    private static final int IDEA_ID = 37189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37189Service() {
        this(new Idea37189Config());
    }

    public Idea37189Service(Idea37189Config config) {
        this.config = config != null ? config : new Idea37189Config();
