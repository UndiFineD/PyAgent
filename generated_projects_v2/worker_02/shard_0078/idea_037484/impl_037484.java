...
@Data
public class Idea37484Config {
    private String name = "idea_037484";
 ...
 */
@Slf4j
public class Idea37484Service {
    private static final int IDEA_ID = 37484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37484Service() {
        this(new Idea37484Config());
    }

    public Idea37484Service(Idea37484Config config) {
        this.config = config != null ? config : new Idea37484Config();
