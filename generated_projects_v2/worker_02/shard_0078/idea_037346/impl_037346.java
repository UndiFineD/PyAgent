...
@Data
public class Idea37346Config {
    private String name = "idea_037346";
 ...
 */
@Slf4j
public class Idea37346Service {
    private static final int IDEA_ID = 37346;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37346Service() {
        this(new Idea37346Config());
    }

    public Idea37346Service(Idea37346Config config) {
        this.config = config != null ? config : new Idea37346Config();
