...
@Data
public class Idea37256Config {
    private String name = "idea_037256";
 ...
 */
@Slf4j
public class Idea37256Service {
    private static final int IDEA_ID = 37256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37256Service() {
        this(new Idea37256Config());
    }

    public Idea37256Service(Idea37256Config config) {
        this.config = config != null ? config : new Idea37256Config();
