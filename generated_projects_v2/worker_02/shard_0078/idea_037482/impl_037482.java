...
@Data
public class Idea37482Config {
    private String name = "idea_037482";
 ...
 */
@Slf4j
public class Idea37482Service {
    private static final int IDEA_ID = 37482;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37482Service() {
        this(new Idea37482Config());
    }

    public Idea37482Service(Idea37482Config config) {
        this.config = config != null ? config : new Idea37482Config();
