...
@Data
public class Idea37166Config {
    private String name = "idea_037166";
 ...
 */
@Slf4j
public class Idea37166Service {
    private static final int IDEA_ID = 37166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37166Service() {
        this(new Idea37166Config());
    }

    public Idea37166Service(Idea37166Config config) {
        this.config = config != null ? config : new Idea37166Config();
