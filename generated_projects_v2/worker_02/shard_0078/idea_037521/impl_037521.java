...
@Data
public class Idea37521Config {
    private String name = "idea_037521";
 ...
 */
@Slf4j
public class Idea37521Service {
    private static final int IDEA_ID = 37521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37521Service() {
        this(new Idea37521Config());
    }

    public Idea37521Service(Idea37521Config config) {
        this.config = config != null ? config : new Idea37521Config();
