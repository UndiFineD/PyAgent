...
@Data
public class Idea37100Config {
    private String name = "idea_037100";
 ...
 */
@Slf4j
public class Idea37100Service {
    private static final int IDEA_ID = 37100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37100Service() {
        this(new Idea37100Config());
    }

    public Idea37100Service(Idea37100Config config) {
        this.config = config != null ? config : new Idea37100Config();
