...
@Data
public class Idea42207Config {
    private String name = "idea_042207";
 ...
 */
@Slf4j
public class Idea42207Service {
    private static final int IDEA_ID = 42207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42207Service() {
        this(new Idea42207Config());
    }

    public Idea42207Service(Idea42207Config config) {
        this.config = config != null ? config : new Idea42207Config();
