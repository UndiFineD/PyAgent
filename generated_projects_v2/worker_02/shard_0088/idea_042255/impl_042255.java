...
@Data
public class Idea42255Config {
    private String name = "idea_042255";
 ...
 */
@Slf4j
public class Idea42255Service {
    private static final int IDEA_ID = 42255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42255Service() {
        this(new Idea42255Config());
    }

    public Idea42255Service(Idea42255Config config) {
        this.config = config != null ? config : new Idea42255Config();
