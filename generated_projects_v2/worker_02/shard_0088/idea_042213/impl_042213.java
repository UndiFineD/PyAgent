...
@Data
public class Idea42213Config {
    private String name = "idea_042213";
 ...
 */
@Slf4j
public class Idea42213Service {
    private static final int IDEA_ID = 42213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42213Service() {
        this(new Idea42213Config());
    }

    public Idea42213Service(Idea42213Config config) {
        this.config = config != null ? config : new Idea42213Config();
