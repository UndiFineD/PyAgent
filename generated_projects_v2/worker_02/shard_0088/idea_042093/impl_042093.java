...
@Data
public class Idea42093Config {
    private String name = "idea_042093";
 ...
 */
@Slf4j
public class Idea42093Service {
    private static final int IDEA_ID = 42093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42093Service() {
        this(new Idea42093Config());
    }

    public Idea42093Service(Idea42093Config config) {
        this.config = config != null ? config : new Idea42093Config();
