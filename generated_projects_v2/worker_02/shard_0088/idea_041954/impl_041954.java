...
@Data
public class Idea41954Config {
    private String name = "idea_041954";
 ...
 */
@Slf4j
public class Idea41954Service {
    private static final int IDEA_ID = 41954;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41954Service() {
        this(new Idea41954Config());
    }

    public Idea41954Service(Idea41954Config config) {
        this.config = config != null ? config : new Idea41954Config();
