...
@Data
public class Idea42079Config {
    private String name = "idea_042079";
 ...
 */
@Slf4j
public class Idea42079Service {
    private static final int IDEA_ID = 42079;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42079Service() {
        this(new Idea42079Config());
    }

    public Idea42079Service(Idea42079Config config) {
        this.config = config != null ? config : new Idea42079Config();
