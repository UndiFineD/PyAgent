...
@Data
public class Idea42142Config {
    private String name = "idea_042142";
 ...
 */
@Slf4j
public class Idea42142Service {
    private static final int IDEA_ID = 42142;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42142Service() {
        this(new Idea42142Config());
    }

    public Idea42142Service(Idea42142Config config) {
        this.config = config != null ? config : new Idea42142Config();
