...
@Data
public class Idea41975Config {
    private String name = "idea_041975";
 ...
 */
@Slf4j
public class Idea41975Service {
    private static final int IDEA_ID = 41975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41975Service() {
        this(new Idea41975Config());
    }

    public Idea41975Service(Idea41975Config config) {
        this.config = config != null ? config : new Idea41975Config();
