...
@Data
public class Idea41834Config {
    private String name = "idea_041834";
 ...
 */
@Slf4j
public class Idea41834Service {
    private static final int IDEA_ID = 41834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41834Service() {
        this(new Idea41834Config());
    }

    public Idea41834Service(Idea41834Config config) {
        this.config = config != null ? config : new Idea41834Config();
