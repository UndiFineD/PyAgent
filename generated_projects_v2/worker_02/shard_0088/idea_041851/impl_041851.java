...
@Data
public class Idea41851Config {
    private String name = "idea_041851";
 ...
 */
@Slf4j
public class Idea41851Service {
    private static final int IDEA_ID = 41851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41851Service() {
        this(new Idea41851Config());
    }

    public Idea41851Service(Idea41851Config config) {
        this.config = config != null ? config : new Idea41851Config();
