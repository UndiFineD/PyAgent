...
@Data
public class Idea42028Config {
    private String name = "idea_042028";
 ...
 */
@Slf4j
public class Idea42028Service {
    private static final int IDEA_ID = 42028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42028Service() {
        this(new Idea42028Config());
    }

    public Idea42028Service(Idea42028Config config) {
        this.config = config != null ? config : new Idea42028Config();
