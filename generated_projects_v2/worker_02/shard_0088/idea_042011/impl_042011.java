...
@Data
public class Idea42011Config {
    private String name = "idea_042011";
 ...
 */
@Slf4j
public class Idea42011Service {
    private static final int IDEA_ID = 42011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42011Service() {
        this(new Idea42011Config());
    }

    public Idea42011Service(Idea42011Config config) {
        this.config = config != null ? config : new Idea42011Config();
