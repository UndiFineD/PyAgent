...
@Data
public class Idea41960Config {
    private String name = "idea_041960";
 ...
 */
@Slf4j
public class Idea41960Service {
    private static final int IDEA_ID = 41960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41960Service() {
        this(new Idea41960Config());
    }

    public Idea41960Service(Idea41960Config config) {
        this.config = config != null ? config : new Idea41960Config();
