...
@Data
public class Idea41810Config {
    private String name = "idea_041810";
 ...
 */
@Slf4j
public class Idea41810Service {
    private static final int IDEA_ID = 41810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41810Service() {
        this(new Idea41810Config());
    }

    public Idea41810Service(Idea41810Config config) {
        this.config = config != null ? config : new Idea41810Config();
