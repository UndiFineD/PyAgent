...
@Data
public class Idea42058Config {
    private String name = "idea_042058";
 ...
 */
@Slf4j
public class Idea42058Service {
    private static final int IDEA_ID = 42058;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42058Service() {
        this(new Idea42058Config());
    }

    public Idea42058Service(Idea42058Config config) {
        this.config = config != null ? config : new Idea42058Config();
