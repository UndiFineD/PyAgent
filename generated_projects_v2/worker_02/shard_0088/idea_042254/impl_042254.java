...
@Data
public class Idea42254Config {
    private String name = "idea_042254";
 ...
 */
@Slf4j
public class Idea42254Service {
    private static final int IDEA_ID = 42254;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42254Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42254Service() {
        this(new Idea42254Config());
    }

    public Idea42254Service(Idea42254Config config) {
        this.config = config != null ? config : new Idea42254Config();
