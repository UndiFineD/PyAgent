...
@Data
public class Idea42040Config {
    private String name = "idea_042040";
 ...
 */
@Slf4j
public class Idea42040Service {
    private static final int IDEA_ID = 42040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42040Service() {
        this(new Idea42040Config());
    }

    public Idea42040Service(Idea42040Config config) {
        this.config = config != null ? config : new Idea42040Config();
