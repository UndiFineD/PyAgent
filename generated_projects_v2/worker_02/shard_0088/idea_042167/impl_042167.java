...
@Data
public class Idea42167Config {
    private String name = "idea_042167";
 ...
 */
@Slf4j
public class Idea42167Service {
    private static final int IDEA_ID = 42167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42167Service() {
        this(new Idea42167Config());
    }

    public Idea42167Service(Idea42167Config config) {
        this.config = config != null ? config : new Idea42167Config();
