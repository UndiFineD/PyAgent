...
@Data
public class Idea41991Config {
    private String name = "idea_041991";
 ...
 */
@Slf4j
public class Idea41991Service {
    private static final int IDEA_ID = 41991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41991Service() {
        this(new Idea41991Config());
    }

    public Idea41991Service(Idea41991Config config) {
        this.config = config != null ? config : new Idea41991Config();
