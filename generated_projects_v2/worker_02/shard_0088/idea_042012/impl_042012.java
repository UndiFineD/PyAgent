...
@Data
public class Idea42012Config {
    private String name = "idea_042012";
 ...
 */
@Slf4j
public class Idea42012Service {
    private static final int IDEA_ID = 42012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42012Service() {
        this(new Idea42012Config());
    }

    public Idea42012Service(Idea42012Config config) {
        this.config = config != null ? config : new Idea42012Config();
