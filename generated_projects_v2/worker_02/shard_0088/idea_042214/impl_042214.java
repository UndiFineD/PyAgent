...
@Data
public class Idea42214Config {
    private String name = "idea_042214";
 ...
 */
@Slf4j
public class Idea42214Service {
    private static final int IDEA_ID = 42214;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42214Service() {
        this(new Idea42214Config());
    }

    public Idea42214Service(Idea42214Config config) {
        this.config = config != null ? config : new Idea42214Config();
