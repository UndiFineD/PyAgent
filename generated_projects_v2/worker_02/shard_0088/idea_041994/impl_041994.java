...
@Data
public class Idea41994Config {
    private String name = "idea_041994";
 ...
 */
@Slf4j
public class Idea41994Service {
    private static final int IDEA_ID = 41994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41994Service() {
        this(new Idea41994Config());
    }

    public Idea41994Service(Idea41994Config config) {
        this.config = config != null ? config : new Idea41994Config();
