...
@Data
public class Idea42096Config {
    private String name = "idea_042096";
 ...
 */
@Slf4j
public class Idea42096Service {
    private static final int IDEA_ID = 42096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42096Service() {
        this(new Idea42096Config());
    }

    public Idea42096Service(Idea42096Config config) {
        this.config = config != null ? config : new Idea42096Config();
