...
@Data
public class Idea42235Config {
    private String name = "idea_042235";
 ...
 */
@Slf4j
public class Idea42235Service {
    private static final int IDEA_ID = 42235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42235Service() {
        this(new Idea42235Config());
    }

    public Idea42235Service(Idea42235Config config) {
        this.config = config != null ? config : new Idea42235Config();
