...
@Data
public class Idea41916Config {
    private String name = "idea_041916";
 ...
 */
@Slf4j
public class Idea41916Service {
    private static final int IDEA_ID = 41916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41916Service() {
        this(new Idea41916Config());
    }

    public Idea41916Service(Idea41916Config config) {
        this.config = config != null ? config : new Idea41916Config();
