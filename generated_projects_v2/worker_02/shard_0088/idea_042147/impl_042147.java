...
@Data
public class Idea42147Config {
    private String name = "idea_042147";
 ...
 */
@Slf4j
public class Idea42147Service {
    private static final int IDEA_ID = 42147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42147Service() {
        this(new Idea42147Config());
    }

    public Idea42147Service(Idea42147Config config) {
        this.config = config != null ? config : new Idea42147Config();
