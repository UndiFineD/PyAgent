...
@Data
public class Idea41813Config {
    private String name = "idea_041813";
 ...
 */
@Slf4j
public class Idea41813Service {
    private static final int IDEA_ID = 41813;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41813Service() {
        this(new Idea41813Config());
    }

    public Idea41813Service(Idea41813Config config) {
        this.config = config != null ? config : new Idea41813Config();
