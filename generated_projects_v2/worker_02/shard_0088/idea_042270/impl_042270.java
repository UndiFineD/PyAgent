...
@Data
public class Idea42270Config {
    private String name = "idea_042270";
 ...
 */
@Slf4j
public class Idea42270Service {
    private static final int IDEA_ID = 42270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42270Service() {
        this(new Idea42270Config());
    }

    public Idea42270Service(Idea42270Config config) {
        this.config = config != null ? config : new Idea42270Config();
