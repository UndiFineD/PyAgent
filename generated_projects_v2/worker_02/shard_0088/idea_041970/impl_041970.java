...
@Data
public class Idea41970Config {
    private String name = "idea_041970";
 ...
 */
@Slf4j
public class Idea41970Service {
    private static final int IDEA_ID = 41970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41970Service() {
        this(new Idea41970Config());
    }

    public Idea41970Service(Idea41970Config config) {
        this.config = config != null ? config : new Idea41970Config();
