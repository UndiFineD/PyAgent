...
@Data
public class Idea41964Config {
    private String name = "idea_041964";
 ...
 */
@Slf4j
public class Idea41964Service {
    private static final int IDEA_ID = 41964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41964Service() {
        this(new Idea41964Config());
    }

    public Idea41964Service(Idea41964Config config) {
        this.config = config != null ? config : new Idea41964Config();
