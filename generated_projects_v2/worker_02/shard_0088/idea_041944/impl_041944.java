...
@Data
public class Idea41944Config {
    private String name = "idea_041944";
 ...
 */
@Slf4j
public class Idea41944Service {
    private static final int IDEA_ID = 41944;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41944Service() {
        this(new Idea41944Config());
    }

    public Idea41944Service(Idea41944Config config) {
        this.config = config != null ? config : new Idea41944Config();
