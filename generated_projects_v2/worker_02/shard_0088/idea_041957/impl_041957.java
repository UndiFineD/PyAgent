...
@Data
public class Idea41957Config {
    private String name = "idea_041957";
 ...
 */
@Slf4j
public class Idea41957Service {
    private static final int IDEA_ID = 41957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41957Service() {
        this(new Idea41957Config());
    }

    public Idea41957Service(Idea41957Config config) {
        this.config = config != null ? config : new Idea41957Config();
