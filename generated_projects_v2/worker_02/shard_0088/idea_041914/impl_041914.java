...
@Data
public class Idea41914Config {
    private String name = "idea_041914";
 ...
 */
@Slf4j
public class Idea41914Service {
    private static final int IDEA_ID = 41914;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41914Service() {
        this(new Idea41914Config());
    }

    public Idea41914Service(Idea41914Config config) {
        this.config = config != null ? config : new Idea41914Config();
