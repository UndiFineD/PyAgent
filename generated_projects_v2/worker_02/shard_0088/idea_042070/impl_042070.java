...
@Data
public class Idea42070Config {
    private String name = "idea_042070";
 ...
 */
@Slf4j
public class Idea42070Service {
    private static final int IDEA_ID = 42070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42070Service() {
        this(new Idea42070Config());
    }

    public Idea42070Service(Idea42070Config config) {
        this.config = config != null ? config : new Idea42070Config();
