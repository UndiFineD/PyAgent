...
@Data
public class Idea41820Config {
    private String name = "idea_041820";
 ...
 */
@Slf4j
public class Idea41820Service {
    private static final int IDEA_ID = 41820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41820Service() {
        this(new Idea41820Config());
    }

    public Idea41820Service(Idea41820Config config) {
        this.config = config != null ? config : new Idea41820Config();
