...
@Data
public class Idea41890Config {
    private String name = "idea_041890";
 ...
 */
@Slf4j
public class Idea41890Service {
    private static final int IDEA_ID = 41890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41890Service() {
        this(new Idea41890Config());
    }

    public Idea41890Service(Idea41890Config config) {
        this.config = config != null ? config : new Idea41890Config();
