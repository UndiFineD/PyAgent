...
@Data
public class Idea41974Config {
    private String name = "idea_041974";
 ...
 */
@Slf4j
public class Idea41974Service {
    private static final int IDEA_ID = 41974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41974Service() {
        this(new Idea41974Config());
    }

    public Idea41974Service(Idea41974Config config) {
        this.config = config != null ? config : new Idea41974Config();
