...
@Data
public class Idea41948Config {
    private String name = "idea_041948";
 ...
 */
@Slf4j
public class Idea41948Service {
    private static final int IDEA_ID = 41948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41948Service() {
        this(new Idea41948Config());
    }

    public Idea41948Service(Idea41948Config config) {
        this.config = config != null ? config : new Idea41948Config();
