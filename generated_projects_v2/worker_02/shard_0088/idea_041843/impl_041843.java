...
@Data
public class Idea41843Config {
    private String name = "idea_041843";
 ...
 */
@Slf4j
public class Idea41843Service {
    private static final int IDEA_ID = 41843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41843Service() {
        this(new Idea41843Config());
    }

    public Idea41843Service(Idea41843Config config) {
        this.config = config != null ? config : new Idea41843Config();
