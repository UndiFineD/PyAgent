...
@Data
public class Idea42016Config {
    private String name = "idea_042016";
 ...
 */
@Slf4j
public class Idea42016Service {
    private static final int IDEA_ID = 42016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42016Service() {
        this(new Idea42016Config());
    }

    public Idea42016Service(Idea42016Config config) {
        this.config = config != null ? config : new Idea42016Config();
