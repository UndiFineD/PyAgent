...
@Data
public class Idea41912Config {
    private String name = "idea_041912";
 ...
 */
@Slf4j
public class Idea41912Service {
    private static final int IDEA_ID = 41912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41912Service() {
        this(new Idea41912Config());
    }

    public Idea41912Service(Idea41912Config config) {
        this.config = config != null ? config : new Idea41912Config();
