...
@Data
public class Idea42010Config {
    private String name = "idea_042010";
 ...
 */
@Slf4j
public class Idea42010Service {
    private static final int IDEA_ID = 42010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42010Service() {
        this(new Idea42010Config());
    }

    public Idea42010Service(Idea42010Config config) {
        this.config = config != null ? config : new Idea42010Config();
