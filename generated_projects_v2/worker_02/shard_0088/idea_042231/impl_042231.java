...
@Data
public class Idea42231Config {
    private String name = "idea_042231";
 ...
 */
@Slf4j
public class Idea42231Service {
    private static final int IDEA_ID = 42231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42231Service() {
        this(new Idea42231Config());
    }

    public Idea42231Service(Idea42231Config config) {
        this.config = config != null ? config : new Idea42231Config();
