...
@Data
public class Idea42161Config {
    private String name = "idea_042161";
 ...
 */
@Slf4j
public class Idea42161Service {
    private static final int IDEA_ID = 42161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42161Service() {
        this(new Idea42161Config());
    }

    public Idea42161Service(Idea42161Config config) {
        this.config = config != null ? config : new Idea42161Config();
