...
@Data
public class Idea42169Config {
    private String name = "idea_042169";
 ...
 */
@Slf4j
public class Idea42169Service {
    private static final int IDEA_ID = 42169;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42169Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42169Service() {
        this(new Idea42169Config());
    }

    public Idea42169Service(Idea42169Config config) {
        this.config = config != null ? config : new Idea42169Config();
