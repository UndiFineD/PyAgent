...
@Data
public class Idea42130Config {
    private String name = "idea_042130";
 ...
 */
@Slf4j
public class Idea42130Service {
    private static final int IDEA_ID = 42130;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42130Service() {
        this(new Idea42130Config());
    }

    public Idea42130Service(Idea42130Config config) {
        this.config = config != null ? config : new Idea42130Config();
