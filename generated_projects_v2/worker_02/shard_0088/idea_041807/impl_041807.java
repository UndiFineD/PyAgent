...
@Data
public class Idea41807Config {
    private String name = "idea_041807";
 ...
 */
@Slf4j
public class Idea41807Service {
    private static final int IDEA_ID = 41807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41807Service() {
        this(new Idea41807Config());
    }

    public Idea41807Service(Idea41807Config config) {
        this.config = config != null ? config : new Idea41807Config();
