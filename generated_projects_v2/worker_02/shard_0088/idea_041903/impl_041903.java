...
@Data
public class Idea41903Config {
    private String name = "idea_041903";
 ...
 */
@Slf4j
public class Idea41903Service {
    private static final int IDEA_ID = 41903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41903Service() {
        this(new Idea41903Config());
    }

    public Idea41903Service(Idea41903Config config) {
        this.config = config != null ? config : new Idea41903Config();
