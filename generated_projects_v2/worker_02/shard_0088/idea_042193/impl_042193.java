...
@Data
public class Idea42193Config {
    private String name = "idea_042193";
 ...
 */
@Slf4j
public class Idea42193Service {
    private static final int IDEA_ID = 42193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42193Service() {
        this(new Idea42193Config());
    }

    public Idea42193Service(Idea42193Config config) {
        this.config = config != null ? config : new Idea42193Config();
