...
@Data
public class Idea41989Config {
    private String name = "idea_041989";
 ...
 */
@Slf4j
public class Idea41989Service {
    private static final int IDEA_ID = 41989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41989Service() {
        this(new Idea41989Config());
    }

    public Idea41989Service(Idea41989Config config) {
        this.config = config != null ? config : new Idea41989Config();
