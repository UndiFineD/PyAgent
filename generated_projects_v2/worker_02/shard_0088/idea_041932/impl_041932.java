...
@Data
public class Idea41932Config {
    private String name = "idea_041932";
 ...
 */
@Slf4j
public class Idea41932Service {
    private static final int IDEA_ID = 41932;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41932Service() {
        this(new Idea41932Config());
    }

    public Idea41932Service(Idea41932Config config) {
        this.config = config != null ? config : new Idea41932Config();
