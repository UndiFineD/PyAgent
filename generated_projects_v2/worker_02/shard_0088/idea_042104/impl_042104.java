...
@Data
public class Idea42104Config {
    private String name = "idea_042104";
 ...
 */
@Slf4j
public class Idea42104Service {
    private static final int IDEA_ID = 42104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42104Service() {
        this(new Idea42104Config());
    }

    public Idea42104Service(Idea42104Config config) {
        this.config = config != null ? config : new Idea42104Config();
