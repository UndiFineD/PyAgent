...
@Data
public class Idea42237Config {
    private String name = "idea_042237";
 ...
 */
@Slf4j
public class Idea42237Service {
    private static final int IDEA_ID = 42237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42237Service() {
        this(new Idea42237Config());
    }

    public Idea42237Service(Idea42237Config config) {
        this.config = config != null ? config : new Idea42237Config();
