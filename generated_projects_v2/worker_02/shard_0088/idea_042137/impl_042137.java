...
@Data
public class Idea42137Config {
    private String name = "idea_042137";
 ...
 */
@Slf4j
public class Idea42137Service {
    private static final int IDEA_ID = 42137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42137Service() {
        this(new Idea42137Config());
    }

    public Idea42137Service(Idea42137Config config) {
        this.config = config != null ? config : new Idea42137Config();
