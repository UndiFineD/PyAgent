...
@Data
public class Idea41897Config {
    private String name = "idea_041897";
 ...
 */
@Slf4j
public class Idea41897Service {
    private static final int IDEA_ID = 41897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41897Service() {
        this(new Idea41897Config());
    }

    public Idea41897Service(Idea41897Config config) {
        this.config = config != null ? config : new Idea41897Config();
