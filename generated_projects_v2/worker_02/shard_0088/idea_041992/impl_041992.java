...
@Data
public class Idea41992Config {
    private String name = "idea_041992";
 ...
 */
@Slf4j
public class Idea41992Service {
    private static final int IDEA_ID = 41992;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41992Service() {
        this(new Idea41992Config());
    }

    public Idea41992Service(Idea41992Config config) {
        this.config = config != null ? config : new Idea41992Config();
