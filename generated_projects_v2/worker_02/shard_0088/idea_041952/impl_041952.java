...
@Data
public class Idea41952Config {
    private String name = "idea_041952";
 ...
 */
@Slf4j
public class Idea41952Service {
    private static final int IDEA_ID = 41952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41952Service() {
        this(new Idea41952Config());
    }

    public Idea41952Service(Idea41952Config config) {
        this.config = config != null ? config : new Idea41952Config();
