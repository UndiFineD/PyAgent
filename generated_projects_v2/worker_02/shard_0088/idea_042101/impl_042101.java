...
@Data
public class Idea42101Config {
    private String name = "idea_042101";
 ...
 */
@Slf4j
public class Idea42101Service {
    private static final int IDEA_ID = 42101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42101Service() {
        this(new Idea42101Config());
    }

    public Idea42101Service(Idea42101Config config) {
        this.config = config != null ? config : new Idea42101Config();
