...
@Data
public class Idea42198Config {
    private String name = "idea_042198";
 ...
 */
@Slf4j
public class Idea42198Service {
    private static final int IDEA_ID = 42198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42198Service() {
        this(new Idea42198Config());
    }

    public Idea42198Service(Idea42198Config config) {
        this.config = config != null ? config : new Idea42198Config();
