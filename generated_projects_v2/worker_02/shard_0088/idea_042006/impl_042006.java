...
@Data
public class Idea42006Config {
    private String name = "idea_042006";
 ...
 */
@Slf4j
public class Idea42006Service {
    private static final int IDEA_ID = 42006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42006Service() {
        this(new Idea42006Config());
    }

    public Idea42006Service(Idea42006Config config) {
        this.config = config != null ? config : new Idea42006Config();
