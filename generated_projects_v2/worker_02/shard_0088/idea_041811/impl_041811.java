...
@Data
public class Idea41811Config {
    private String name = "idea_041811";
 ...
 */
@Slf4j
public class Idea41811Service {
    private static final int IDEA_ID = 41811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41811Service() {
        this(new Idea41811Config());
    }

    public Idea41811Service(Idea41811Config config) {
        this.config = config != null ? config : new Idea41811Config();
