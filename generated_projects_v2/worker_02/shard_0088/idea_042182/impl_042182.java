...
@Data
public class Idea42182Config {
    private String name = "idea_042182";
 ...
 */
@Slf4j
public class Idea42182Service {
    private static final int IDEA_ID = 42182;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42182Service() {
        this(new Idea42182Config());
    }

    public Idea42182Service(Idea42182Config config) {
        this.config = config != null ? config : new Idea42182Config();
