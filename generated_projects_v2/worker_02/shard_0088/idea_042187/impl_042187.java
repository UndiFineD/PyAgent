...
@Data
public class Idea42187Config {
    private String name = "idea_042187";
 ...
 */
@Slf4j
public class Idea42187Service {
    private static final int IDEA_ID = 42187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42187Service() {
        this(new Idea42187Config());
    }

    public Idea42187Service(Idea42187Config config) {
        this.config = config != null ? config : new Idea42187Config();
