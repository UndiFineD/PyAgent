...
@Data
public class Idea41879Config {
    private String name = "idea_041879";
 ...
 */
@Slf4j
public class Idea41879Service {
    private static final int IDEA_ID = 41879;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41879Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41879Service() {
        this(new Idea41879Config());
    }

    public Idea41879Service(Idea41879Config config) {
        this.config = config != null ? config : new Idea41879Config();
