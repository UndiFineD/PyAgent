...
@Data
public class Idea41919Config {
    private String name = "idea_041919";
 ...
 */
@Slf4j
public class Idea41919Service {
    private static final int IDEA_ID = 41919;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41919Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41919Service() {
        this(new Idea41919Config());
    }

    public Idea41919Service(Idea41919Config config) {
        this.config = config != null ? config : new Idea41919Config();
