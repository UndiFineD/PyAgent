...
@Data
public class Idea41886Config {
    private String name = "idea_041886";
 ...
 */
@Slf4j
public class Idea41886Service {
    private static final int IDEA_ID = 41886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41886Service() {
        this(new Idea41886Config());
    }

    public Idea41886Service(Idea41886Config config) {
        this.config = config != null ? config : new Idea41886Config();
