...
@Data
public class Idea41978Config {
    private String name = "idea_041978";
 ...
 */
@Slf4j
public class Idea41978Service {
    private static final int IDEA_ID = 41978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41978Service() {
        this(new Idea41978Config());
    }

    public Idea41978Service(Idea41978Config config) {
        this.config = config != null ? config : new Idea41978Config();
