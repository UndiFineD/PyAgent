...
@Data
public class Idea41825Config {
    private String name = "idea_041825";
 ...
 */
@Slf4j
public class Idea41825Service {
    private static final int IDEA_ID = 41825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41825Service() {
        this(new Idea41825Config());
    }

    public Idea41825Service(Idea41825Config config) {
        this.config = config != null ? config : new Idea41825Config();
