...
@Data
public class Idea41816Config {
    private String name = "idea_041816";
 ...
 */
@Slf4j
public class Idea41816Service {
    private static final int IDEA_ID = 41816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41816Service() {
        this(new Idea41816Config());
    }

    public Idea41816Service(Idea41816Config config) {
        this.config = config != null ? config : new Idea41816Config();
