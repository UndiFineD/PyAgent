...
@Data
public class Idea42013Config {
    private String name = "idea_042013";
 ...
 */
@Slf4j
public class Idea42013Service {
    private static final int IDEA_ID = 42013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42013Service() {
        this(new Idea42013Config());
    }

    public Idea42013Service(Idea42013Config config) {
        this.config = config != null ? config : new Idea42013Config();
