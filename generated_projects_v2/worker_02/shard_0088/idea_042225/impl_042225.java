...
@Data
public class Idea42225Config {
    private String name = "idea_042225";
 ...
 */
@Slf4j
public class Idea42225Service {
    private static final int IDEA_ID = 42225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42225Service() {
        this(new Idea42225Config());
    }

    public Idea42225Service(Idea42225Config config) {
        this.config = config != null ? config : new Idea42225Config();
