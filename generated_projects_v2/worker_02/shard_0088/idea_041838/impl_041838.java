...
@Data
public class Idea41838Config {
    private String name = "idea_041838";
 ...
 */
@Slf4j
public class Idea41838Service {
    private static final int IDEA_ID = 41838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41838Service() {
        this(new Idea41838Config());
    }

    public Idea41838Service(Idea41838Config config) {
        this.config = config != null ? config : new Idea41838Config();
