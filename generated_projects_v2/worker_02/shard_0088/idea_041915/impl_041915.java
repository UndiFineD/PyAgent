...
@Data
public class Idea41915Config {
    private String name = "idea_041915";
 ...
 */
@Slf4j
public class Idea41915Service {
    private static final int IDEA_ID = 41915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41915Service() {
        this(new Idea41915Config());
    }

    public Idea41915Service(Idea41915Config config) {
        this.config = config != null ? config : new Idea41915Config();
