...
@Data
public class Idea42205Config {
    private String name = "idea_042205";
 ...
 */
@Slf4j
public class Idea42205Service {
    private static final int IDEA_ID = 42205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42205Service() {
        this(new Idea42205Config());
    }

    public Idea42205Service(Idea42205Config config) {
        this.config = config != null ? config : new Idea42205Config();
