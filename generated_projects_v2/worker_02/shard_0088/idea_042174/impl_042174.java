...
@Data
public class Idea42174Config {
    private String name = "idea_042174";
 ...
 */
@Slf4j
public class Idea42174Service {
    private static final int IDEA_ID = 42174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42174Service() {
        this(new Idea42174Config());
    }

    public Idea42174Service(Idea42174Config config) {
        this.config = config != null ? config : new Idea42174Config();
