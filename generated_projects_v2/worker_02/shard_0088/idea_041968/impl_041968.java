...
@Data
public class Idea41968Config {
    private String name = "idea_041968";
 ...
 */
@Slf4j
public class Idea41968Service {
    private static final int IDEA_ID = 41968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41968Service() {
        this(new Idea41968Config());
    }

    public Idea41968Service(Idea41968Config config) {
        this.config = config != null ? config : new Idea41968Config();
