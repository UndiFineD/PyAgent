...
@Data
public class Idea42218Config {
    private String name = "idea_042218";
 ...
 */
@Slf4j
public class Idea42218Service {
    private static final int IDEA_ID = 42218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42218Service() {
        this(new Idea42218Config());
    }

    public Idea42218Service(Idea42218Config config) {
        this.config = config != null ? config : new Idea42218Config();
