...
@Data
public class Idea41941Config {
    private String name = "idea_041941";
 ...
 */
@Slf4j
public class Idea41941Service {
    private static final int IDEA_ID = 41941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41941Service() {
        this(new Idea41941Config());
    }

    public Idea41941Service(Idea41941Config config) {
        this.config = config != null ? config : new Idea41941Config();
