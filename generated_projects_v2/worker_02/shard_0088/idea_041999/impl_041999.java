...
@Data
public class Idea41999Config {
    private String name = "idea_041999";
 ...
 */
@Slf4j
public class Idea41999Service {
    private static final int IDEA_ID = 41999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41999Service() {
        this(new Idea41999Config());
    }

    public Idea41999Service(Idea41999Config config) {
        this.config = config != null ? config : new Idea41999Config();
