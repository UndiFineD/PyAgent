...
@Data
public class Idea42272Config {
    private String name = "idea_042272";
 ...
 */
@Slf4j
public class Idea42272Service {
    private static final int IDEA_ID = 42272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42272Service() {
        this(new Idea42272Config());
    }

    public Idea42272Service(Idea42272Config config) {
        this.config = config != null ? config : new Idea42272Config();
