...
@Data
public class Idea42141Config {
    private String name = "idea_042141";
 ...
 */
@Slf4j
public class Idea42141Service {
    private static final int IDEA_ID = 42141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42141Service() {
        this(new Idea42141Config());
    }

    public Idea42141Service(Idea42141Config config) {
        this.config = config != null ? config : new Idea42141Config();
