...
@Data
public class Idea41942Config {
    private String name = "idea_041942";
 ...
 */
@Slf4j
public class Idea41942Service {
    private static final int IDEA_ID = 41942;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41942Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41942Service() {
        this(new Idea41942Config());
    }

    public Idea41942Service(Idea41942Config config) {
        this.config = config != null ? config : new Idea41942Config();
