...
@Data
public class Idea42227Config {
    private String name = "idea_042227";
 ...
 */
@Slf4j
public class Idea42227Service {
    private static final int IDEA_ID = 42227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42227Service() {
        this(new Idea42227Config());
    }

    public Idea42227Service(Idea42227Config config) {
        this.config = config != null ? config : new Idea42227Config();
