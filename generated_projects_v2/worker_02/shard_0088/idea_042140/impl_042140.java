...
@Data
public class Idea42140Config {
    private String name = "idea_042140";
 ...
 */
@Slf4j
public class Idea42140Service {
    private static final int IDEA_ID = 42140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42140Service() {
        this(new Idea42140Config());
    }

    public Idea42140Service(Idea42140Config config) {
        this.config = config != null ? config : new Idea42140Config();
