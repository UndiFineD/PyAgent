...
@Data
public class Idea42257Config {
    private String name = "idea_042257";
 ...
 */
@Slf4j
public class Idea42257Service {
    private static final int IDEA_ID = 42257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42257Service() {
        this(new Idea42257Config());
    }

    public Idea42257Service(Idea42257Config config) {
        this.config = config != null ? config : new Idea42257Config();
