...
@Data
public class Idea41828Config {
    private String name = "idea_041828";
 ...
 */
@Slf4j
public class Idea41828Service {
    private static final int IDEA_ID = 41828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41828Service() {
        this(new Idea41828Config());
    }

    public Idea41828Service(Idea41828Config config) {
        this.config = config != null ? config : new Idea41828Config();
