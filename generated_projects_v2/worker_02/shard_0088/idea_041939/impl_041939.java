...
@Data
public class Idea41939Config {
    private String name = "idea_041939";
 ...
 */
@Slf4j
public class Idea41939Service {
    private static final int IDEA_ID = 41939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41939Service() {
        this(new Idea41939Config());
    }

    public Idea41939Service(Idea41939Config config) {
        this.config = config != null ? config : new Idea41939Config();
