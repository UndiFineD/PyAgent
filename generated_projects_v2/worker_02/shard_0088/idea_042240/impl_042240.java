...
@Data
public class Idea42240Config {
    private String name = "idea_042240";
 ...
 */
@Slf4j
public class Idea42240Service {
    private static final int IDEA_ID = 42240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42240Service() {
        this(new Idea42240Config());
    }

    public Idea42240Service(Idea42240Config config) {
        this.config = config != null ? config : new Idea42240Config();
