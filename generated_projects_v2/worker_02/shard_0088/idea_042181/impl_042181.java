...
@Data
public class Idea42181Config {
    private String name = "idea_042181";
 ...
 */
@Slf4j
public class Idea42181Service {
    private static final int IDEA_ID = 42181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42181Service() {
        this(new Idea42181Config());
    }

    public Idea42181Service(Idea42181Config config) {
        this.config = config != null ? config : new Idea42181Config();
