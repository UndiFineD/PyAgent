...
@Data
public class Idea42188Config {
    private String name = "idea_042188";
 ...
 */
@Slf4j
public class Idea42188Service {
    private static final int IDEA_ID = 42188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42188Service() {
        this(new Idea42188Config());
    }

    public Idea42188Service(Idea42188Config config) {
        this.config = config != null ? config : new Idea42188Config();
