...
@Data
public class Idea42190Config {
    private String name = "idea_042190";
 ...
 */
@Slf4j
public class Idea42190Service {
    private static final int IDEA_ID = 42190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42190Service() {
        this(new Idea42190Config());
    }

    public Idea42190Service(Idea42190Config config) {
        this.config = config != null ? config : new Idea42190Config();
