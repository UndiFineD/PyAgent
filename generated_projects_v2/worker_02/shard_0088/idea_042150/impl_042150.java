...
@Data
public class Idea42150Config {
    private String name = "idea_042150";
 ...
 */
@Slf4j
public class Idea42150Service {
    private static final int IDEA_ID = 42150;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42150Service() {
        this(new Idea42150Config());
    }

    public Idea42150Service(Idea42150Config config) {
        this.config = config != null ? config : new Idea42150Config();
