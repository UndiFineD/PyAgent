...
@Data
public class Idea41887Config {
    private String name = "idea_041887";
 ...
 */
@Slf4j
public class Idea41887Service {
    private static final int IDEA_ID = 41887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41887Service() {
        this(new Idea41887Config());
    }

    public Idea41887Service(Idea41887Config config) {
        this.config = config != null ? config : new Idea41887Config();
