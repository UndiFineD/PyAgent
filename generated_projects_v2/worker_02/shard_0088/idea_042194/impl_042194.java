...
@Data
public class Idea42194Config {
    private String name = "idea_042194";
 ...
 */
@Slf4j
public class Idea42194Service {
    private static final int IDEA_ID = 42194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42194Service() {
        this(new Idea42194Config());
    }

    public Idea42194Service(Idea42194Config config) {
        this.config = config != null ? config : new Idea42194Config();
