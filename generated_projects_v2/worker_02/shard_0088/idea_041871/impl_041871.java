...
@Data
public class Idea41871Config {
    private String name = "idea_041871";
 ...
 */
@Slf4j
public class Idea41871Service {
    private static final int IDEA_ID = 41871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41871Service() {
        this(new Idea41871Config());
    }

    public Idea41871Service(Idea41871Config config) {
        this.config = config != null ? config : new Idea41871Config();
