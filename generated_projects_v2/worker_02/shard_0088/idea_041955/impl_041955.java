...
@Data
public class Idea41955Config {
    private String name = "idea_041955";
 ...
 */
@Slf4j
public class Idea41955Service {
    private static final int IDEA_ID = 41955;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41955Service() {
        this(new Idea41955Config());
    }

    public Idea41955Service(Idea41955Config config) {
        this.config = config != null ? config : new Idea41955Config();
