...
@Data
public class Idea41976Config {
    private String name = "idea_041976";
 ...
 */
@Slf4j
public class Idea41976Service {
    private static final int IDEA_ID = 41976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41976Service() {
        this(new Idea41976Config());
    }

    public Idea41976Service(Idea41976Config config) {
        this.config = config != null ? config : new Idea41976Config();
