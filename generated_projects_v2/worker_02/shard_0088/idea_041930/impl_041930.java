...
@Data
public class Idea41930Config {
    private String name = "idea_041930";
 ...
 */
@Slf4j
public class Idea41930Service {
    private static final int IDEA_ID = 41930;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41930Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41930Service() {
        this(new Idea41930Config());
    }

    public Idea41930Service(Idea41930Config config) {
        this.config = config != null ? config : new Idea41930Config();
