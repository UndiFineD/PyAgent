...
@Data
public class Idea42177Config {
    private String name = "idea_042177";
 ...
 */
@Slf4j
public class Idea42177Service {
    private static final int IDEA_ID = 42177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42177Service() {
        this(new Idea42177Config());
    }

    public Idea42177Service(Idea42177Config config) {
        this.config = config != null ? config : new Idea42177Config();
