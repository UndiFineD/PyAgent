...
@Data
public class Idea42005Config {
    private String name = "idea_042005";
 ...
 */
@Slf4j
public class Idea42005Service {
    private static final int IDEA_ID = 42005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42005Service() {
        this(new Idea42005Config());
    }

    public Idea42005Service(Idea42005Config config) {
        this.config = config != null ? config : new Idea42005Config();
