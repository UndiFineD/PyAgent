...
@Data
public class Idea42166Config {
    private String name = "idea_042166";
 ...
 */
@Slf4j
public class Idea42166Service {
    private static final int IDEA_ID = 42166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42166Service() {
        this(new Idea42166Config());
    }

    public Idea42166Service(Idea42166Config config) {
        this.config = config != null ? config : new Idea42166Config();
