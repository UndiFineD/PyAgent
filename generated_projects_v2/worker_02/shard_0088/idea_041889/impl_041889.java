...
@Data
public class Idea41889Config {
    private String name = "idea_041889";
 ...
 */
@Slf4j
public class Idea41889Service {
    private static final int IDEA_ID = 41889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41889Service() {
        this(new Idea41889Config());
    }

    public Idea41889Service(Idea41889Config config) {
        this.config = config != null ? config : new Idea41889Config();
