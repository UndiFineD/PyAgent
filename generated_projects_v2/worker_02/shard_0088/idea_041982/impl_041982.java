...
@Data
public class Idea41982Config {
    private String name = "idea_041982";
 ...
 */
@Slf4j
public class Idea41982Service {
    private static final int IDEA_ID = 41982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41982Service() {
        this(new Idea41982Config());
    }

    public Idea41982Service(Idea41982Config config) {
        this.config = config != null ? config : new Idea41982Config();
