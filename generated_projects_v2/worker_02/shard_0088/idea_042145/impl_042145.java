...
@Data
public class Idea42145Config {
    private String name = "idea_042145";
 ...
 */
@Slf4j
public class Idea42145Service {
    private static final int IDEA_ID = 42145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42145Service() {
        this(new Idea42145Config());
    }

    public Idea42145Service(Idea42145Config config) {
        this.config = config != null ? config : new Idea42145Config();
