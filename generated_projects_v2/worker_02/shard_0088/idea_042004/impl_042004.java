...
@Data
public class Idea42004Config {
    private String name = "idea_042004";
 ...
 */
@Slf4j
public class Idea42004Service {
    private static final int IDEA_ID = 42004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42004Service() {
        this(new Idea42004Config());
    }

    public Idea42004Service(Idea42004Config config) {
        this.config = config != null ? config : new Idea42004Config();
