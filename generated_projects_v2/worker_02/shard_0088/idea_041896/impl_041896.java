...
@Data
public class Idea41896Config {
    private String name = "idea_041896";
 ...
 */
@Slf4j
public class Idea41896Service {
    private static final int IDEA_ID = 41896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41896Service() {
        this(new Idea41896Config());
    }

    public Idea41896Service(Idea41896Config config) {
        this.config = config != null ? config : new Idea41896Config();
