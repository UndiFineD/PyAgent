...
@Data
public class Idea42090Config {
    private String name = "idea_042090";
 ...
 */
@Slf4j
public class Idea42090Service {
    private static final int IDEA_ID = 42090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42090Service() {
        this(new Idea42090Config());
    }

    public Idea42090Service(Idea42090Config config) {
        this.config = config != null ? config : new Idea42090Config();
