...
@Data
public class Idea42175Config {
    private String name = "idea_042175";
 ...
 */
@Slf4j
public class Idea42175Service {
    private static final int IDEA_ID = 42175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42175Service() {
        this(new Idea42175Config());
    }

    public Idea42175Service(Idea42175Config config) {
        this.config = config != null ? config : new Idea42175Config();
