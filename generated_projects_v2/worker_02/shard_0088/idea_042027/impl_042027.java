...
@Data
public class Idea42027Config {
    private String name = "idea_042027";
 ...
 */
@Slf4j
public class Idea42027Service {
    private static final int IDEA_ID = 42027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42027Service() {
        this(new Idea42027Config());
    }

    public Idea42027Service(Idea42027Config config) {
        this.config = config != null ? config : new Idea42027Config();
