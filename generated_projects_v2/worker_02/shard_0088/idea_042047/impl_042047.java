...
@Data
public class Idea42047Config {
    private String name = "idea_042047";
 ...
 */
@Slf4j
public class Idea42047Service {
    private static final int IDEA_ID = 42047;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42047Service() {
        this(new Idea42047Config());
    }

    public Idea42047Service(Idea42047Config config) {
        this.config = config != null ? config : new Idea42047Config();
