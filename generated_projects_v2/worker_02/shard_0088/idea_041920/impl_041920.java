...
@Data
public class Idea41920Config {
    private String name = "idea_041920";
 ...
 */
@Slf4j
public class Idea41920Service {
    private static final int IDEA_ID = 41920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41920Service() {
        this(new Idea41920Config());
    }

    public Idea41920Service(Idea41920Config config) {
        this.config = config != null ? config : new Idea41920Config();
