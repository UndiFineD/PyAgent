...
@Data
public class Idea41858Config {
    private String name = "idea_041858";
 ...
 */
@Slf4j
public class Idea41858Service {
    private static final int IDEA_ID = 41858;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41858Service() {
        this(new Idea41858Config());
    }

    public Idea41858Service(Idea41858Config config) {
        this.config = config != null ? config : new Idea41858Config();
