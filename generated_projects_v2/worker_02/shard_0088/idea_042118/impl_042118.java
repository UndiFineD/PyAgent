...
@Data
public class Idea42118Config {
    private String name = "idea_042118";
 ...
 */
@Slf4j
public class Idea42118Service {
    private static final int IDEA_ID = 42118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42118Service() {
        this(new Idea42118Config());
    }

    public Idea42118Service(Idea42118Config config) {
        this.config = config != null ? config : new Idea42118Config();
