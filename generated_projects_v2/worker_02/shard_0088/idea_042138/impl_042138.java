...
@Data
public class Idea42138Config {
    private String name = "idea_042138";
 ...
 */
@Slf4j
public class Idea42138Service {
    private static final int IDEA_ID = 42138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42138Service() {
        this(new Idea42138Config());
    }

    public Idea42138Service(Idea42138Config config) {
        this.config = config != null ? config : new Idea42138Config();
