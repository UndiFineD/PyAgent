...
@Data
public class Idea42084Config {
    private String name = "idea_042084";
 ...
 */
@Slf4j
public class Idea42084Service {
    private static final int IDEA_ID = 42084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42084Service() {
        this(new Idea42084Config());
    }

    public Idea42084Service(Idea42084Config config) {
        this.config = config != null ? config : new Idea42084Config();
