...
@Data
public class Idea42236Config {
    private String name = "idea_042236";
 ...
 */
@Slf4j
public class Idea42236Service {
    private static final int IDEA_ID = 42236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42236Service() {
        this(new Idea42236Config());
    }

    public Idea42236Service(Idea42236Config config) {
        this.config = config != null ? config : new Idea42236Config();
