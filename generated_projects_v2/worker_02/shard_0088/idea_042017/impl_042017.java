...
@Data
public class Idea42017Config {
    private String name = "idea_042017";
 ...
 */
@Slf4j
public class Idea42017Service {
    private static final int IDEA_ID = 42017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42017Service() {
        this(new Idea42017Config());
    }

    public Idea42017Service(Idea42017Config config) {
        this.config = config != null ? config : new Idea42017Config();
