...
@Data
public class Idea42261Config {
    private String name = "idea_042261";
 ...
 */
@Slf4j
public class Idea42261Service {
    private static final int IDEA_ID = 42261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42261Service() {
        this(new Idea42261Config());
    }

    public Idea42261Service(Idea42261Config config) {
        this.config = config != null ? config : new Idea42261Config();
