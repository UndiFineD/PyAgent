...
@Data
public class Idea41812Config {
    private String name = "idea_041812";
 ...
 */
@Slf4j
public class Idea41812Service {
    private static final int IDEA_ID = 41812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41812Service() {
        this(new Idea41812Config());
    }

    public Idea41812Service(Idea41812Config config) {
        this.config = config != null ? config : new Idea41812Config();
