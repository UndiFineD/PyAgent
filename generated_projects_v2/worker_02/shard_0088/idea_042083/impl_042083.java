...
@Data
public class Idea42083Config {
    private String name = "idea_042083";
 ...
 */
@Slf4j
public class Idea42083Service {
    private static final int IDEA_ID = 42083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42083Service() {
        this(new Idea42083Config());
    }

    public Idea42083Service(Idea42083Config config) {
        this.config = config != null ? config : new Idea42083Config();
