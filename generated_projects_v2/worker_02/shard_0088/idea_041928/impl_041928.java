...
@Data
public class Idea41928Config {
    private String name = "idea_041928";
 ...
 */
@Slf4j
public class Idea41928Service {
    private static final int IDEA_ID = 41928;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41928Service() {
        this(new Idea41928Config());
    }

    public Idea41928Service(Idea41928Config config) {
        this.config = config != null ? config : new Idea41928Config();
