...
@Data
public class Idea42037Config {
    private String name = "idea_042037";
 ...
 */
@Slf4j
public class Idea42037Service {
    private static final int IDEA_ID = 42037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42037Service() {
        this(new Idea42037Config());
    }

    public Idea42037Service(Idea42037Config config) {
        this.config = config != null ? config : new Idea42037Config();
