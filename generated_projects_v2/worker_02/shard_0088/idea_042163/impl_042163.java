...
@Data
public class Idea42163Config {
    private String name = "idea_042163";
 ...
 */
@Slf4j
public class Idea42163Service {
    private static final int IDEA_ID = 42163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42163Service() {
        this(new Idea42163Config());
    }

    public Idea42163Service(Idea42163Config config) {
        this.config = config != null ? config : new Idea42163Config();
