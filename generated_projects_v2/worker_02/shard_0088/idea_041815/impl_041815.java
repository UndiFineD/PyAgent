...
@Data
public class Idea41815Config {
    private String name = "idea_041815";
 ...
 */
@Slf4j
public class Idea41815Service {
    private static final int IDEA_ID = 41815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41815Service() {
        this(new Idea41815Config());
    }

    public Idea41815Service(Idea41815Config config) {
        this.config = config != null ? config : new Idea41815Config();
