...
@Data
public class Idea42208Config {
    private String name = "idea_042208";
 ...
 */
@Slf4j
public class Idea42208Service {
    private static final int IDEA_ID = 42208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42208Service() {
        this(new Idea42208Config());
    }

    public Idea42208Service(Idea42208Config config) {
        this.config = config != null ? config : new Idea42208Config();
