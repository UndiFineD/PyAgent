...
@Data
public class Idea42152Config {
    private String name = "idea_042152";
 ...
 */
@Slf4j
public class Idea42152Service {
    private static final int IDEA_ID = 42152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42152Service() {
        this(new Idea42152Config());
    }

    public Idea42152Service(Idea42152Config config) {
        this.config = config != null ? config : new Idea42152Config();
