...
@Data
public class Idea42041Config {
    private String name = "idea_042041";
 ...
 */
@Slf4j
public class Idea42041Service {
    private static final int IDEA_ID = 42041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42041Service() {
        this(new Idea42041Config());
    }

    public Idea42041Service(Idea42041Config config) {
        this.config = config != null ? config : new Idea42041Config();
