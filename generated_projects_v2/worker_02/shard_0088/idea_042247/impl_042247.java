...
@Data
public class Idea42247Config {
    private String name = "idea_042247";
 ...
 */
@Slf4j
public class Idea42247Service {
    private static final int IDEA_ID = 42247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42247Service() {
        this(new Idea42247Config());
    }

    public Idea42247Service(Idea42247Config config) {
        this.config = config != null ? config : new Idea42247Config();
