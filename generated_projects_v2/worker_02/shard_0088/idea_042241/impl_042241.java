...
@Data
public class Idea42241Config {
    private String name = "idea_042241";
 ...
 */
@Slf4j
public class Idea42241Service {
    private static final int IDEA_ID = 42241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42241Service() {
        this(new Idea42241Config());
    }

    public Idea42241Service(Idea42241Config config) {
        this.config = config != null ? config : new Idea42241Config();
