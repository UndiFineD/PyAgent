...
@Data
public class Idea41894Config {
    private String name = "idea_041894";
 ...
 */
@Slf4j
public class Idea41894Service {
    private static final int IDEA_ID = 41894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41894Service() {
        this(new Idea41894Config());
    }

    public Idea41894Service(Idea41894Config config) {
        this.config = config != null ? config : new Idea41894Config();
