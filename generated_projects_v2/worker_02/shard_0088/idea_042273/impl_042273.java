...
@Data
public class Idea42273Config {
    private String name = "idea_042273";
 ...
 */
@Slf4j
public class Idea42273Service {
    private static final int IDEA_ID = 42273;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42273Service() {
        this(new Idea42273Config());
    }

    public Idea42273Service(Idea42273Config config) {
        this.config = config != null ? config : new Idea42273Config();
