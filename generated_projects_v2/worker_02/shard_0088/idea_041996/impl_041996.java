...
@Data
public class Idea41996Config {
    private String name = "idea_041996";
 ...
 */
@Slf4j
public class Idea41996Service {
    private static final int IDEA_ID = 41996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41996Service() {
        this(new Idea41996Config());
    }

    public Idea41996Service(Idea41996Config config) {
        this.config = config != null ? config : new Idea41996Config();
