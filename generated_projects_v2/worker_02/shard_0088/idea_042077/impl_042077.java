...
@Data
public class Idea42077Config {
    private String name = "idea_042077";
 ...
 */
@Slf4j
public class Idea42077Service {
    private static final int IDEA_ID = 42077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42077Service() {
        this(new Idea42077Config());
    }

    public Idea42077Service(Idea42077Config config) {
        this.config = config != null ? config : new Idea42077Config();
