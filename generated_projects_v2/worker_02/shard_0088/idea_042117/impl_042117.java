...
@Data
public class Idea42117Config {
    private String name = "idea_042117";
 ...
 */
@Slf4j
public class Idea42117Service {
    private static final int IDEA_ID = 42117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42117Service() {
        this(new Idea42117Config());
    }

    public Idea42117Service(Idea42117Config config) {
        this.config = config != null ? config : new Idea42117Config();
