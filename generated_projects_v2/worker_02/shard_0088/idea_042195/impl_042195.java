...
@Data
public class Idea42195Config {
    private String name = "idea_042195";
 ...
 */
@Slf4j
public class Idea42195Service {
    private static final int IDEA_ID = 42195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42195Service() {
        this(new Idea42195Config());
    }

    public Idea42195Service(Idea42195Config config) {
        this.config = config != null ? config : new Idea42195Config();
