...
@Data
public class Idea41981Config {
    private String name = "idea_041981";
 ...
 */
@Slf4j
public class Idea41981Service {
    private static final int IDEA_ID = 41981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41981Service() {
        this(new Idea41981Config());
    }

    public Idea41981Service(Idea41981Config config) {
        this.config = config != null ? config : new Idea41981Config();
