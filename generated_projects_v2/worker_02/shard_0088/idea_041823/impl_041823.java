...
@Data
public class Idea41823Config {
    private String name = "idea_041823";
 ...
 */
@Slf4j
public class Idea41823Service {
    private static final int IDEA_ID = 41823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41823Service() {
        this(new Idea41823Config());
    }

    public Idea41823Service(Idea41823Config config) {
        this.config = config != null ? config : new Idea41823Config();
