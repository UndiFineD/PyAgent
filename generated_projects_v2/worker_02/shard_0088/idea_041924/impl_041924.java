...
@Data
public class Idea41924Config {
    private String name = "idea_041924";
 ...
 */
@Slf4j
public class Idea41924Service {
    private static final int IDEA_ID = 41924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41924Service() {
        this(new Idea41924Config());
    }

    public Idea41924Service(Idea41924Config config) {
        this.config = config != null ? config : new Idea41924Config();
