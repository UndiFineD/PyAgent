...
@Data
public class Idea42259Config {
    private String name = "idea_042259";
 ...
 */
@Slf4j
public class Idea42259Service {
    private static final int IDEA_ID = 42259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42259Service() {
        this(new Idea42259Config());
    }

    public Idea42259Service(Idea42259Config config) {
        this.config = config != null ? config : new Idea42259Config();
