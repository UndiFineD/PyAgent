...
@Data
public class Idea42265Config {
    private String name = "idea_042265";
 ...
 */
@Slf4j
public class Idea42265Service {
    private static final int IDEA_ID = 42265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42265Service() {
        this(new Idea42265Config());
    }

    public Idea42265Service(Idea42265Config config) {
        this.config = config != null ? config : new Idea42265Config();
