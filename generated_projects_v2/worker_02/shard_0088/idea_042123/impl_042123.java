...
@Data
public class Idea42123Config {
    private String name = "idea_042123";
 ...
 */
@Slf4j
public class Idea42123Service {
    private static final int IDEA_ID = 42123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42123Service() {
        this(new Idea42123Config());
    }

    public Idea42123Service(Idea42123Config config) {
        this.config = config != null ? config : new Idea42123Config();
