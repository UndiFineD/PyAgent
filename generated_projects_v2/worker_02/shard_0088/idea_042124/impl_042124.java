...
@Data
public class Idea42124Config {
    private String name = "idea_042124";
 ...
 */
@Slf4j
public class Idea42124Service {
    private static final int IDEA_ID = 42124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42124Service() {
        this(new Idea42124Config());
    }

    public Idea42124Service(Idea42124Config config) {
        this.config = config != null ? config : new Idea42124Config();
