...
@Data
public class Idea41980Config {
    private String name = "idea_041980";
 ...
 */
@Slf4j
public class Idea41980Service {
    private static final int IDEA_ID = 41980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41980Service() {
        this(new Idea41980Config());
    }

    public Idea41980Service(Idea41980Config config) {
        this.config = config != null ? config : new Idea41980Config();
