...
@Data
public class Idea42071Config {
    private String name = "idea_042071";
 ...
 */
@Slf4j
public class Idea42071Service {
    private static final int IDEA_ID = 42071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42071Service() {
        this(new Idea42071Config());
    }

    public Idea42071Service(Idea42071Config config) {
        this.config = config != null ? config : new Idea42071Config();
