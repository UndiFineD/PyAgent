...
@Data
public class Idea42105Config {
    private String name = "idea_042105";
 ...
 */
@Slf4j
public class Idea42105Service {
    private static final int IDEA_ID = 42105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42105Service() {
        this(new Idea42105Config());
    }

    public Idea42105Service(Idea42105Config config) {
        this.config = config != null ? config : new Idea42105Config();
