...
@Data
public class Idea42019Config {
    private String name = "idea_042019";
 ...
 */
@Slf4j
public class Idea42019Service {
    private static final int IDEA_ID = 42019;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42019Service() {
        this(new Idea42019Config());
    }

    public Idea42019Service(Idea42019Config config) {
        this.config = config != null ? config : new Idea42019Config();
