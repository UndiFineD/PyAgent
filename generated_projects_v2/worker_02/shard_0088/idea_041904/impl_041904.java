...
@Data
public class Idea41904Config {
    private String name = "idea_041904";
 ...
 */
@Slf4j
public class Idea41904Service {
    private static final int IDEA_ID = 41904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41904Service() {
        this(new Idea41904Config());
    }

    public Idea41904Service(Idea41904Config config) {
        this.config = config != null ? config : new Idea41904Config();
