...
@Data
public class Idea41883Config {
    private String name = "idea_041883";
 ...
 */
@Slf4j
public class Idea41883Service {
    private static final int IDEA_ID = 41883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41883Service() {
        this(new Idea41883Config());
    }

    public Idea41883Service(Idea41883Config config) {
        this.config = config != null ? config : new Idea41883Config();
