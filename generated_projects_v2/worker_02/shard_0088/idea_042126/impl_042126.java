...
@Data
public class Idea42126Config {
    private String name = "idea_042126";
 ...
 */
@Slf4j
public class Idea42126Service {
    private static final int IDEA_ID = 42126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42126Service() {
        this(new Idea42126Config());
    }

    public Idea42126Service(Idea42126Config config) {
        this.config = config != null ? config : new Idea42126Config();
