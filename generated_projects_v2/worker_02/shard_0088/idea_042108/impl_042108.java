...
@Data
public class Idea42108Config {
    private String name = "idea_042108";
 ...
 */
@Slf4j
public class Idea42108Service {
    private static final int IDEA_ID = 42108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42108Service() {
        this(new Idea42108Config());
    }

    public Idea42108Service(Idea42108Config config) {
        this.config = config != null ? config : new Idea42108Config();
