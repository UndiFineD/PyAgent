...
@Data
public class Idea41893Config {
    private String name = "idea_041893";
 ...
 */
@Slf4j
public class Idea41893Service {
    private static final int IDEA_ID = 41893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41893Service() {
        this(new Idea41893Config());
    }

    public Idea41893Service(Idea41893Config config) {
        this.config = config != null ? config : new Idea41893Config();
