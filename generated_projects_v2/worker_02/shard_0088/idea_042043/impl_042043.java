...
@Data
public class Idea42043Config {
    private String name = "idea_042043";
 ...
 */
@Slf4j
public class Idea42043Service {
    private static final int IDEA_ID = 42043;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42043Service() {
        this(new Idea42043Config());
    }

    public Idea42043Service(Idea42043Config config) {
        this.config = config != null ? config : new Idea42043Config();
