...
@Data
public class Idea41892Config {
    private String name = "idea_041892";
 ...
 */
@Slf4j
public class Idea41892Service {
    private static final int IDEA_ID = 41892;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41892Service() {
        this(new Idea41892Config());
    }

    public Idea41892Service(Idea41892Config config) {
        this.config = config != null ? config : new Idea41892Config();
