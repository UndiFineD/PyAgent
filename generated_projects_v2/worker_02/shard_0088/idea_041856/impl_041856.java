...
@Data
public class Idea41856Config {
    private String name = "idea_041856";
 ...
 */
@Slf4j
public class Idea41856Service {
    private static final int IDEA_ID = 41856;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41856Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41856Service() {
        this(new Idea41856Config());
    }

    public Idea41856Service(Idea41856Config config) {
        this.config = config != null ? config : new Idea41856Config();
