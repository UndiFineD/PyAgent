...
@Data
public class Idea42120Config {
    private String name = "idea_042120";
 ...
 */
@Slf4j
public class Idea42120Service {
    private static final int IDEA_ID = 42120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42120Service() {
        this(new Idea42120Config());
    }

    public Idea42120Service(Idea42120Config config) {
        this.config = config != null ? config : new Idea42120Config();
