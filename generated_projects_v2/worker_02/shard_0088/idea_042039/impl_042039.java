...
@Data
public class Idea42039Config {
    private String name = "idea_042039";
 ...
 */
@Slf4j
public class Idea42039Service {
    private static final int IDEA_ID = 42039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42039Service() {
        this(new Idea42039Config());
    }

    public Idea42039Service(Idea42039Config config) {
        this.config = config != null ? config : new Idea42039Config();
