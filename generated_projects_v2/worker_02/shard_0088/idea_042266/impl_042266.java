...
@Data
public class Idea42266Config {
    private String name = "idea_042266";
 ...
 */
@Slf4j
public class Idea42266Service {
    private static final int IDEA_ID = 42266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42266Service() {
        this(new Idea42266Config());
    }

    public Idea42266Service(Idea42266Config config) {
        this.config = config != null ? config : new Idea42266Config();
