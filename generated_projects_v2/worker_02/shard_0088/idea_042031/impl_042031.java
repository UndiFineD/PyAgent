...
@Data
public class Idea42031Config {
    private String name = "idea_042031";
 ...
 */
@Slf4j
public class Idea42031Service {
    private static final int IDEA_ID = 42031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42031Service() {
        this(new Idea42031Config());
    }

    public Idea42031Service(Idea42031Config config) {
        this.config = config != null ? config : new Idea42031Config();
