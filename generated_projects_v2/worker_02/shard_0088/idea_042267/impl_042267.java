...
@Data
public class Idea42267Config {
    private String name = "idea_042267";
 ...
 */
@Slf4j
public class Idea42267Service {
    private static final int IDEA_ID = 42267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42267Service() {
        this(new Idea42267Config());
    }

    public Idea42267Service(Idea42267Config config) {
        this.config = config != null ? config : new Idea42267Config();
