...
@Data
public class Idea42251Config {
    private String name = "idea_042251";
 ...
 */
@Slf4j
public class Idea42251Service {
    private static final int IDEA_ID = 42251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42251Service() {
        this(new Idea42251Config());
    }

    public Idea42251Service(Idea42251Config config) {
        this.config = config != null ? config : new Idea42251Config();
