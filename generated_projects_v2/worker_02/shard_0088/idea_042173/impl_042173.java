...
@Data
public class Idea42173Config {
    private String name = "idea_042173";
 ...
 */
@Slf4j
public class Idea42173Service {
    private static final int IDEA_ID = 42173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42173Service() {
        this(new Idea42173Config());
    }

    public Idea42173Service(Idea42173Config config) {
        this.config = config != null ? config : new Idea42173Config();
