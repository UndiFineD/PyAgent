...
@Data
public class Idea41958Config {
    private String name = "idea_041958";
 ...
 */
@Slf4j
public class Idea41958Service {
    private static final int IDEA_ID = 41958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41958Service() {
        this(new Idea41958Config());
    }

    public Idea41958Service(Idea41958Config config) {
        this.config = config != null ? config : new Idea41958Config();
