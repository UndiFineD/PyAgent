...
@Data
public class Idea42100Config {
    private String name = "idea_042100";
 ...
 */
@Slf4j
public class Idea42100Service {
    private static final int IDEA_ID = 42100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42100Service() {
        this(new Idea42100Config());
    }

    public Idea42100Service(Idea42100Config config) {
        this.config = config != null ? config : new Idea42100Config();
