...
@Data
public class Idea42200Config {
    private String name = "idea_042200";
 ...
 */
@Slf4j
public class Idea42200Service {
    private static final int IDEA_ID = 42200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42200Service() {
        this(new Idea42200Config());
    }

    public Idea42200Service(Idea42200Config config) {
        this.config = config != null ? config : new Idea42200Config();
