...
@Data
public class Idea42234Config {
    private String name = "idea_042234";
 ...
 */
@Slf4j
public class Idea42234Service {
    private static final int IDEA_ID = 42234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42234Service() {
        this(new Idea42234Config());
    }

    public Idea42234Service(Idea42234Config config) {
        this.config = config != null ? config : new Idea42234Config();
