...
@Data
public class Idea41870Config {
    private String name = "idea_041870";
 ...
 */
@Slf4j
public class Idea41870Service {
    private static final int IDEA_ID = 41870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41870Service() {
        this(new Idea41870Config());
    }

    public Idea41870Service(Idea41870Config config) {
        this.config = config != null ? config : new Idea41870Config();
