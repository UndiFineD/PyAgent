...
@Data
public class Idea42222Config {
    private String name = "idea_042222";
 ...
 */
@Slf4j
public class Idea42222Service {
    private static final int IDEA_ID = 42222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42222Service() {
        this(new Idea42222Config());
    }

    public Idea42222Service(Idea42222Config config) {
        this.config = config != null ? config : new Idea42222Config();
