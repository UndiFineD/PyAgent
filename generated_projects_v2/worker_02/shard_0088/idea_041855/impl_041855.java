...
@Data
public class Idea41855Config {
    private String name = "idea_041855";
 ...
 */
@Slf4j
public class Idea41855Service {
    private static final int IDEA_ID = 41855;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41855Service() {
        this(new Idea41855Config());
    }

    public Idea41855Service(Idea41855Config config) {
        this.config = config != null ? config : new Idea41855Config();
