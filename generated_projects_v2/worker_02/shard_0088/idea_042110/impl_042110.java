...
@Data
public class Idea42110Config {
    private String name = "idea_042110";
 ...
 */
@Slf4j
public class Idea42110Service {
    private static final int IDEA_ID = 42110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42110Service() {
        this(new Idea42110Config());
    }

    public Idea42110Service(Idea42110Config config) {
        this.config = config != null ? config : new Idea42110Config();
