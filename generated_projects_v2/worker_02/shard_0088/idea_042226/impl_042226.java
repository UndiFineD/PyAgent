...
@Data
public class Idea42226Config {
    private String name = "idea_042226";
 ...
 */
@Slf4j
public class Idea42226Service {
    private static final int IDEA_ID = 42226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42226Service() {
        this(new Idea42226Config());
    }

    public Idea42226Service(Idea42226Config config) {
        this.config = config != null ? config : new Idea42226Config();
