...
@Data
public class Idea42075Config {
    private String name = "idea_042075";
 ...
 */
@Slf4j
public class Idea42075Service {
    private static final int IDEA_ID = 42075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42075Service() {
        this(new Idea42075Config());
    }

    public Idea42075Service(Idea42075Config config) {
        this.config = config != null ? config : new Idea42075Config();
