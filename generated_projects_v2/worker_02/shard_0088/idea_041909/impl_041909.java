...
@Data
public class Idea41909Config {
    private String name = "idea_041909";
 ...
 */
@Slf4j
public class Idea41909Service {
    private static final int IDEA_ID = 41909;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41909Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41909Service() {
        this(new Idea41909Config());
    }

    public Idea41909Service(Idea41909Config config) {
        this.config = config != null ? config : new Idea41909Config();
