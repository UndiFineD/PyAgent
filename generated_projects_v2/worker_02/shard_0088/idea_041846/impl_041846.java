...
@Data
public class Idea41846Config {
    private String name = "idea_041846";
 ...
 */
@Slf4j
public class Idea41846Service {
    private static final int IDEA_ID = 41846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41846Service() {
        this(new Idea41846Config());
    }

    public Idea41846Service(Idea41846Config config) {
        this.config = config != null ? config : new Idea41846Config();
