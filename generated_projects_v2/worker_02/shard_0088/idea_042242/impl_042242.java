...
@Data
public class Idea42242Config {
    private String name = "idea_042242";
 ...
 */
@Slf4j
public class Idea42242Service {
    private static final int IDEA_ID = 42242;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42242Service() {
        this(new Idea42242Config());
    }

    public Idea42242Service(Idea42242Config config) {
        this.config = config != null ? config : new Idea42242Config();
