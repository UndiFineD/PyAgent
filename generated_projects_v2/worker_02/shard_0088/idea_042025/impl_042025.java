...
@Data
public class Idea42025Config {
    private String name = "idea_042025";
 ...
 */
@Slf4j
public class Idea42025Service {
    private static final int IDEA_ID = 42025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42025Service() {
        this(new Idea42025Config());
    }

    public Idea42025Service(Idea42025Config config) {
        this.config = config != null ? config : new Idea42025Config();
