...
@Data
public class Idea42258Config {
    private String name = "idea_042258";
 ...
 */
@Slf4j
public class Idea42258Service {
    private static final int IDEA_ID = 42258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42258Service() {
        this(new Idea42258Config());
    }

    public Idea42258Service(Idea42258Config config) {
        this.config = config != null ? config : new Idea42258Config();
