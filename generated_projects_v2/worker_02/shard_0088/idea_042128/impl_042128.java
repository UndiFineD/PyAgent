...
@Data
public class Idea42128Config {
    private String name = "idea_042128";
 ...
 */
@Slf4j
public class Idea42128Service {
    private static final int IDEA_ID = 42128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42128Service() {
        this(new Idea42128Config());
    }

    public Idea42128Service(Idea42128Config config) {
        this.config = config != null ? config : new Idea42128Config();
