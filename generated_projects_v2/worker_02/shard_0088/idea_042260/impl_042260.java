...
@Data
public class Idea42260Config {
    private String name = "idea_042260";
 ...
 */
@Slf4j
public class Idea42260Service {
    private static final int IDEA_ID = 42260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42260Service() {
        this(new Idea42260Config());
    }

    public Idea42260Service(Idea42260Config config) {
        this.config = config != null ? config : new Idea42260Config();
