...
@Data
public class Idea41826Config {
    private String name = "idea_041826";
 ...
 */
@Slf4j
public class Idea41826Service {
    private static final int IDEA_ID = 41826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41826Service() {
        this(new Idea41826Config());
    }

    public Idea41826Service(Idea41826Config config) {
        this.config = config != null ? config : new Idea41826Config();
