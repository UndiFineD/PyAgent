...
@Data
public class Idea41819Config {
    private String name = "idea_041819";
 ...
 */
@Slf4j
public class Idea41819Service {
    private static final int IDEA_ID = 41819;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41819Service() {
        this(new Idea41819Config());
    }

    public Idea41819Service(Idea41819Config config) {
        this.config = config != null ? config : new Idea41819Config();
