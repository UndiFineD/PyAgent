...
@Data
public class Idea41873Config {
    private String name = "idea_041873";
 ...
 */
@Slf4j
public class Idea41873Service {
    private static final int IDEA_ID = 41873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41873Service() {
        this(new Idea41873Config());
    }

    public Idea41873Service(Idea41873Config config) {
        this.config = config != null ? config : new Idea41873Config();
