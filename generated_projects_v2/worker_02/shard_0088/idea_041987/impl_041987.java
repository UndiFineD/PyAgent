...
@Data
public class Idea41987Config {
    private String name = "idea_041987";
 ...
 */
@Slf4j
public class Idea41987Service {
    private static final int IDEA_ID = 41987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41987Service() {
        this(new Idea41987Config());
    }

    public Idea41987Service(Idea41987Config config) {
        this.config = config != null ? config : new Idea41987Config();
