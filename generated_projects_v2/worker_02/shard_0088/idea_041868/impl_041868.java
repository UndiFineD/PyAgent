...
@Data
public class Idea41868Config {
    private String name = "idea_041868";
 ...
 */
@Slf4j
public class Idea41868Service {
    private static final int IDEA_ID = 41868;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41868Service() {
        this(new Idea41868Config());
    }

    public Idea41868Service(Idea41868Config config) {
        this.config = config != null ? config : new Idea41868Config();
