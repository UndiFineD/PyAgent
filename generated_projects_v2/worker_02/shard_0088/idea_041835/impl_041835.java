...
@Data
public class Idea41835Config {
    private String name = "idea_041835";
 ...
 */
@Slf4j
public class Idea41835Service {
    private static final int IDEA_ID = 41835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41835Service() {
        this(new Idea41835Config());
    }

    public Idea41835Service(Idea41835Config config) {
        this.config = config != null ? config : new Idea41835Config();
