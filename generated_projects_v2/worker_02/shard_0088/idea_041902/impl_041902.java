...
@Data
public class Idea41902Config {
    private String name = "idea_041902";
 ...
 */
@Slf4j
public class Idea41902Service {
    private static final int IDEA_ID = 41902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41902Service() {
        this(new Idea41902Config());
    }

    public Idea41902Service(Idea41902Config config) {
        this.config = config != null ? config : new Idea41902Config();
