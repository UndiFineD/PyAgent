...
@Data
public class Idea41934Config {
    private String name = "idea_041934";
 ...
 */
@Slf4j
public class Idea41934Service {
    private static final int IDEA_ID = 41934;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41934Service() {
        this(new Idea41934Config());
    }

    public Idea41934Service(Idea41934Config config) {
        this.config = config != null ? config : new Idea41934Config();
