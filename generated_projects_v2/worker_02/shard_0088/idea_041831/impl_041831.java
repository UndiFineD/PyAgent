...
@Data
public class Idea41831Config {
    private String name = "idea_041831";
 ...
 */
@Slf4j
public class Idea41831Service {
    private static final int IDEA_ID = 41831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41831Service() {
        this(new Idea41831Config());
    }

    public Idea41831Service(Idea41831Config config) {
        this.config = config != null ? config : new Idea41831Config();
