...
@Data
public class Idea42221Config {
    private String name = "idea_042221";
 ...
 */
@Slf4j
public class Idea42221Service {
    private static final int IDEA_ID = 42221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42221Service() {
        this(new Idea42221Config());
    }

    public Idea42221Service(Idea42221Config config) {
        this.config = config != null ? config : new Idea42221Config();
