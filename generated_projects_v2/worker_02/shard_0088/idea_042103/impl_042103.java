...
@Data
public class Idea42103Config {
    private String name = "idea_042103";
 ...
 */
@Slf4j
public class Idea42103Service {
    private static final int IDEA_ID = 42103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42103Service() {
        this(new Idea42103Config());
    }

    public Idea42103Service(Idea42103Config config) {
        this.config = config != null ? config : new Idea42103Config();
