...
@Data
public class Idea41800Config {
    private String name = "idea_041800";
 ...
 */
@Slf4j
public class Idea41800Service {
    private static final int IDEA_ID = 41800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41800Service() {
        this(new Idea41800Config());
    }

    public Idea41800Service(Idea41800Config config) {
        this.config = config != null ? config : new Idea41800Config();
