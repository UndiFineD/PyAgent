...
@Data
public class Idea42095Config {
    private String name = "idea_042095";
 ...
 */
@Slf4j
public class Idea42095Service {
    private static final int IDEA_ID = 42095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42095Service() {
        this(new Idea42095Config());
    }

    public Idea42095Service(Idea42095Config config) {
        this.config = config != null ? config : new Idea42095Config();
