...
@Data
public class Idea41841Config {
    private String name = "idea_041841";
 ...
 */
@Slf4j
public class Idea41841Service {
    private static final int IDEA_ID = 41841;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41841Service() {
        this(new Idea41841Config());
    }

    public Idea41841Service(Idea41841Config config) {
        this.config = config != null ? config : new Idea41841Config();
