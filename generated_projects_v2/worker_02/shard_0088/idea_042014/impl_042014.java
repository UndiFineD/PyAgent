...
@Data
public class Idea42014Config {
    private String name = "idea_042014";
 ...
 */
@Slf4j
public class Idea42014Service {
    private static final int IDEA_ID = 42014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42014Service() {
        this(new Idea42014Config());
    }

    public Idea42014Service(Idea42014Config config) {
        this.config = config != null ? config : new Idea42014Config();
