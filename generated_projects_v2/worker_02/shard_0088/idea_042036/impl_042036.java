...
@Data
public class Idea42036Config {
    private String name = "idea_042036";
 ...
 */
@Slf4j
public class Idea42036Service {
    private static final int IDEA_ID = 42036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42036Service() {
        this(new Idea42036Config());
    }

    public Idea42036Service(Idea42036Config config) {
        this.config = config != null ? config : new Idea42036Config();
