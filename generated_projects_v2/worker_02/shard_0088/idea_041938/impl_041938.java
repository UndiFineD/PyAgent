...
@Data
public class Idea41938Config {
    private String name = "idea_041938";
 ...
 */
@Slf4j
public class Idea41938Service {
    private static final int IDEA_ID = 41938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41938Service() {
        this(new Idea41938Config());
    }

    public Idea41938Service(Idea41938Config config) {
        this.config = config != null ? config : new Idea41938Config();
