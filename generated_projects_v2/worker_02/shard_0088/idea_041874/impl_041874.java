...
@Data
public class Idea41874Config {
    private String name = "idea_041874";
 ...
 */
@Slf4j
public class Idea41874Service {
    private static final int IDEA_ID = 41874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41874Service() {
        this(new Idea41874Config());
    }

    public Idea41874Service(Idea41874Config config) {
        this.config = config != null ? config : new Idea41874Config();
