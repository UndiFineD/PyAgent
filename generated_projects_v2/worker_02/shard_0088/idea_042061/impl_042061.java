...
@Data
public class Idea42061Config {
    private String name = "idea_042061";
 ...
 */
@Slf4j
public class Idea42061Service {
    private static final int IDEA_ID = 42061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42061Service() {
        this(new Idea42061Config());
    }

    public Idea42061Service(Idea42061Config config) {
        this.config = config != null ? config : new Idea42061Config();
