...
@Data
public class Idea42204Config {
    private String name = "idea_042204";
 ...
 */
@Slf4j
public class Idea42204Service {
    private static final int IDEA_ID = 42204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42204Service() {
        this(new Idea42204Config());
    }

    public Idea42204Service(Idea42204Config config) {
        this.config = config != null ? config : new Idea42204Config();
