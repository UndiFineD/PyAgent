...
@Data
public class Idea42256Config {
    private String name = "idea_042256";
 ...
 */
@Slf4j
public class Idea42256Service {
    private static final int IDEA_ID = 42256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42256Service() {
        this(new Idea42256Config());
    }

    public Idea42256Service(Idea42256Config config) {
        this.config = config != null ? config : new Idea42256Config();
