...
@Data
public class Idea41931Config {
    private String name = "idea_041931";
 ...
 */
@Slf4j
public class Idea41931Service {
    private static final int IDEA_ID = 41931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41931Service() {
        this(new Idea41931Config());
    }

    public Idea41931Service(Idea41931Config config) {
        this.config = config != null ? config : new Idea41931Config();
