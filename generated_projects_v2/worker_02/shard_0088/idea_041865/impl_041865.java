...
@Data
public class Idea41865Config {
    private String name = "idea_041865";
 ...
 */
@Slf4j
public class Idea41865Service {
    private static final int IDEA_ID = 41865;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41865Service() {
        this(new Idea41865Config());
    }

    public Idea41865Service(Idea41865Config config) {
        this.config = config != null ? config : new Idea41865Config();
