...
@Data
public class Idea42253Config {
    private String name = "idea_042253";
 ...
 */
@Slf4j
public class Idea42253Service {
    private static final int IDEA_ID = 42253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42253Service() {
        this(new Idea42253Config());
    }

    public Idea42253Service(Idea42253Config config) {
        this.config = config != null ? config : new Idea42253Config();
