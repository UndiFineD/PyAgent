...
@Data
public class Idea41972Config {
    private String name = "idea_041972";
 ...
 */
@Slf4j
public class Idea41972Service {
    private static final int IDEA_ID = 41972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41972Service() {
        this(new Idea41972Config());
    }

    public Idea41972Service(Idea41972Config config) {
        this.config = config != null ? config : new Idea41972Config();
