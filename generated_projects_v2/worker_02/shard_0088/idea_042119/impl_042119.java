...
@Data
public class Idea42119Config {
    private String name = "idea_042119";
 ...
 */
@Slf4j
public class Idea42119Service {
    private static final int IDEA_ID = 42119;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42119Service() {
        this(new Idea42119Config());
    }

    public Idea42119Service(Idea42119Config config) {
        this.config = config != null ? config : new Idea42119Config();
