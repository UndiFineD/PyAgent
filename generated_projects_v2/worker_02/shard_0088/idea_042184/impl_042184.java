...
@Data
public class Idea42184Config {
    private String name = "idea_042184";
 ...
 */
@Slf4j
public class Idea42184Service {
    private static final int IDEA_ID = 42184;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42184Service() {
        this(new Idea42184Config());
    }

    public Idea42184Service(Idea42184Config config) {
        this.config = config != null ? config : new Idea42184Config();
