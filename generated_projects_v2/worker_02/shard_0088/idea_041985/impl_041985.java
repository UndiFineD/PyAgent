...
@Data
public class Idea41985Config {
    private String name = "idea_041985";
 ...
 */
@Slf4j
public class Idea41985Service {
    private static final int IDEA_ID = 41985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41985Service() {
        this(new Idea41985Config());
    }

    public Idea41985Service(Idea41985Config config) {
        this.config = config != null ? config : new Idea41985Config();
