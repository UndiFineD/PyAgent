...
@Data
public class Idea42233Config {
    private String name = "idea_042233";
 ...
 */
@Slf4j
public class Idea42233Service {
    private static final int IDEA_ID = 42233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42233Service() {
        this(new Idea42233Config());
    }

    public Idea42233Service(Idea42233Config config) {
        this.config = config != null ? config : new Idea42233Config();
