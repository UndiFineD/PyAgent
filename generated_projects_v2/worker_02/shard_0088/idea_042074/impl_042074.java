...
@Data
public class Idea42074Config {
    private String name = "idea_042074";
 ...
 */
@Slf4j
public class Idea42074Service {
    private static final int IDEA_ID = 42074;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42074Service() {
        this(new Idea42074Config());
    }

    public Idea42074Service(Idea42074Config config) {
        this.config = config != null ? config : new Idea42074Config();
