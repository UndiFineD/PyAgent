...
@Data
public class Idea42102Config {
    private String name = "idea_042102";
 ...
 */
@Slf4j
public class Idea42102Service {
    private static final int IDEA_ID = 42102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42102Service() {
        this(new Idea42102Config());
    }

    public Idea42102Service(Idea42102Config config) {
        this.config = config != null ? config : new Idea42102Config();
