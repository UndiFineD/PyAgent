...
@Data
public class Idea42155Config {
    private String name = "idea_042155";
 ...
 */
@Slf4j
public class Idea42155Service {
    private static final int IDEA_ID = 42155;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42155Service() {
        this(new Idea42155Config());
    }

    public Idea42155Service(Idea42155Config config) {
        this.config = config != null ? config : new Idea42155Config();
