...
@Data
public class Idea42001Config {
    private String name = "idea_042001";
 ...
 */
@Slf4j
public class Idea42001Service {
    private static final int IDEA_ID = 42001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42001Service() {
        this(new Idea42001Config());
    }

    public Idea42001Service(Idea42001Config config) {
        this.config = config != null ? config : new Idea42001Config();
