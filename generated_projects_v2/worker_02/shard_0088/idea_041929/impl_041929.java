...
@Data
public class Idea41929Config {
    private String name = "idea_041929";
 ...
 */
@Slf4j
public class Idea41929Service {
    private static final int IDEA_ID = 41929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41929Service() {
        this(new Idea41929Config());
    }

    public Idea41929Service(Idea41929Config config) {
        this.config = config != null ? config : new Idea41929Config();
