...
@Data
public class Idea41965Config {
    private String name = "idea_041965";
 ...
 */
@Slf4j
public class Idea41965Service {
    private static final int IDEA_ID = 41965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41965Service() {
        this(new Idea41965Config());
    }

    public Idea41965Service(Idea41965Config config) {
        this.config = config != null ? config : new Idea41965Config();
