...
@Data
public class Idea42086Config {
    private String name = "idea_042086";
 ...
 */
@Slf4j
public class Idea42086Service {
    private static final int IDEA_ID = 42086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42086Service() {
        this(new Idea42086Config());
    }

    public Idea42086Service(Idea42086Config config) {
        this.config = config != null ? config : new Idea42086Config();
