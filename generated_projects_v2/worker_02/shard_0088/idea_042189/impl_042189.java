...
@Data
public class Idea42189Config {
    private String name = "idea_042189";
 ...
 */
@Slf4j
public class Idea42189Service {
    private static final int IDEA_ID = 42189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42189Service() {
        this(new Idea42189Config());
    }

    public Idea42189Service(Idea42189Config config) {
        this.config = config != null ? config : new Idea42189Config();
