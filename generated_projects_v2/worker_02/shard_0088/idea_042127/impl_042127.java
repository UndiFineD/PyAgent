...
@Data
public class Idea42127Config {
    private String name = "idea_042127";
 ...
 */
@Slf4j
public class Idea42127Service {
    private static final int IDEA_ID = 42127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42127Service() {
        this(new Idea42127Config());
    }

    public Idea42127Service(Idea42127Config config) {
        this.config = config != null ? config : new Idea42127Config();
