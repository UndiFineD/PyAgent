...
@Data
public class Idea42203Config {
    private String name = "idea_042203";
 ...
 */
@Slf4j
public class Idea42203Service {
    private static final int IDEA_ID = 42203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42203Service() {
        this(new Idea42203Config());
    }

    public Idea42203Service(Idea42203Config config) {
        this.config = config != null ? config : new Idea42203Config();
