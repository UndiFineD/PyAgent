...
@Data
public class Idea42206Config {
    private String name = "idea_042206";
 ...
 */
@Slf4j
public class Idea42206Service {
    private static final int IDEA_ID = 42206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42206Service() {
        this(new Idea42206Config());
    }

    public Idea42206Service(Idea42206Config config) {
        this.config = config != null ? config : new Idea42206Config();
