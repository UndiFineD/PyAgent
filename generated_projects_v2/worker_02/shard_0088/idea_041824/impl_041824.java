...
@Data
public class Idea41824Config {
    private String name = "idea_041824";
 ...
 */
@Slf4j
public class Idea41824Service {
    private static final int IDEA_ID = 41824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41824Service() {
        this(new Idea41824Config());
    }

    public Idea41824Service(Idea41824Config config) {
        this.config = config != null ? config : new Idea41824Config();
