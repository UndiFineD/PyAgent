...
@Data
public class Idea41953Config {
    private String name = "idea_041953";
 ...
 */
@Slf4j
public class Idea41953Service {
    private static final int IDEA_ID = 41953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41953Service() {
        this(new Idea41953Config());
    }

    public Idea41953Service(Idea41953Config config) {
        this.config = config != null ? config : new Idea41953Config();
