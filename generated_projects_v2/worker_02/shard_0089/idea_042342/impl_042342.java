...
@Data
public class Idea42342Config {
    private String name = "idea_042342";
 ...
 */
@Slf4j
public class Idea42342Service {
    private static final int IDEA_ID = 42342;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42342Service() {
        this(new Idea42342Config());
    }

    public Idea42342Service(Idea42342Config config) {
        this.config = config != null ? config : new Idea42342Config();
