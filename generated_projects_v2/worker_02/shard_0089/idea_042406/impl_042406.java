...
@Data
public class Idea42406Config {
    private String name = "idea_042406";
 ...
 */
@Slf4j
public class Idea42406Service {
    private static final int IDEA_ID = 42406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42406Service() {
        this(new Idea42406Config());
    }

    public Idea42406Service(Idea42406Config config) {
        this.config = config != null ? config : new Idea42406Config();
