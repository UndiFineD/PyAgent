...
@Data
public class Idea42408Config {
    private String name = "idea_042408";
 ...
 */
@Slf4j
public class Idea42408Service {
    private static final int IDEA_ID = 42408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42408Service() {
        this(new Idea42408Config());
    }

    public Idea42408Service(Idea42408Config config) {
        this.config = config != null ? config : new Idea42408Config();
