...
@Data
public class Idea42705Config {
    private String name = "idea_042705";
 ...
 */
@Slf4j
public class Idea42705Service {
    private static final int IDEA_ID = 42705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42705Service() {
        this(new Idea42705Config());
    }

    public Idea42705Service(Idea42705Config config) {
        this.config = config != null ? config : new Idea42705Config();
