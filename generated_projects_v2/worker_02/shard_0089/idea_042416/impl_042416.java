...
@Data
public class Idea42416Config {
    private String name = "idea_042416";
 ...
 */
@Slf4j
public class Idea42416Service {
    private static final int IDEA_ID = 42416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42416Service() {
        this(new Idea42416Config());
    }

    public Idea42416Service(Idea42416Config config) {
        this.config = config != null ? config : new Idea42416Config();
