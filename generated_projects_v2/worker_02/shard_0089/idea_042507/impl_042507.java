...
@Data
public class Idea42507Config {
    private String name = "idea_042507";
 ...
 */
@Slf4j
public class Idea42507Service {
    private static final int IDEA_ID = 42507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42507Service() {
        this(new Idea42507Config());
    }

    public Idea42507Service(Idea42507Config config) {
        this.config = config != null ? config : new Idea42507Config();
