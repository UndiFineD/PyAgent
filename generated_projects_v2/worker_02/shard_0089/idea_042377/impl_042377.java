...
@Data
public class Idea42377Config {
    private String name = "idea_042377";
 ...
 */
@Slf4j
public class Idea42377Service {
    private static final int IDEA_ID = 42377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42377Service() {
        this(new Idea42377Config());
    }

    public Idea42377Service(Idea42377Config config) {
        this.config = config != null ? config : new Idea42377Config();
