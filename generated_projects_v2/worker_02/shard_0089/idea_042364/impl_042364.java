...
@Data
public class Idea42364Config {
    private String name = "idea_042364";
 ...
 */
@Slf4j
public class Idea42364Service {
    private static final int IDEA_ID = 42364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42364Service() {
        this(new Idea42364Config());
    }

    public Idea42364Service(Idea42364Config config) {
        this.config = config != null ? config : new Idea42364Config();
