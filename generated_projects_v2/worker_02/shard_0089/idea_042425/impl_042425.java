...
@Data
public class Idea42425Config {
    private String name = "idea_042425";
 ...
 */
@Slf4j
public class Idea42425Service {
    private static final int IDEA_ID = 42425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42425Service() {
        this(new Idea42425Config());
    }

    public Idea42425Service(Idea42425Config config) {
        this.config = config != null ? config : new Idea42425Config();
