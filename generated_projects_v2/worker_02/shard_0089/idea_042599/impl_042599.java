...
@Data
public class Idea42599Config {
    private String name = "idea_042599";
 ...
 */
@Slf4j
public class Idea42599Service {
    private static final int IDEA_ID = 42599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42599Service() {
        this(new Idea42599Config());
    }

    public Idea42599Service(Idea42599Config config) {
        this.config = config != null ? config : new Idea42599Config();
