...
@Data
public class Idea42523Config {
    private String name = "idea_042523";
 ...
 */
@Slf4j
public class Idea42523Service {
    private static final int IDEA_ID = 42523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42523Service() {
        this(new Idea42523Config());
    }

    public Idea42523Service(Idea42523Config config) {
        this.config = config != null ? config : new Idea42523Config();
