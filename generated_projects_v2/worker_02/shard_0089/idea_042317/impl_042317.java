...
@Data
public class Idea42317Config {
    private String name = "idea_042317";
 ...
 */
@Slf4j
public class Idea42317Service {
    private static final int IDEA_ID = 42317;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42317Service() {
        this(new Idea42317Config());
    }

    public Idea42317Service(Idea42317Config config) {
        this.config = config != null ? config : new Idea42317Config();
