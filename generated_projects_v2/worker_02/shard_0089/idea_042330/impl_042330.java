...
@Data
public class Idea42330Config {
    private String name = "idea_042330";
 ...
 */
@Slf4j
public class Idea42330Service {
    private static final int IDEA_ID = 42330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42330Service() {
        this(new Idea42330Config());
    }

    public Idea42330Service(Idea42330Config config) {
        this.config = config != null ? config : new Idea42330Config();
