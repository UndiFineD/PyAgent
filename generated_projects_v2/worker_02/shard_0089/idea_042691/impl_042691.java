...
@Data
public class Idea42691Config {
    private String name = "idea_042691";
 ...
 */
@Slf4j
public class Idea42691Service {
    private static final int IDEA_ID = 42691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42691Service() {
        this(new Idea42691Config());
    }

    public Idea42691Service(Idea42691Config config) {
        this.config = config != null ? config : new Idea42691Config();
