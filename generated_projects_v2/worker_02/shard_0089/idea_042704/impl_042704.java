...
@Data
public class Idea42704Config {
    private String name = "idea_042704";
 ...
 */
@Slf4j
public class Idea42704Service {
    private static final int IDEA_ID = 42704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42704Service() {
        this(new Idea42704Config());
    }

    public Idea42704Service(Idea42704Config config) {
        this.config = config != null ? config : new Idea42704Config();
