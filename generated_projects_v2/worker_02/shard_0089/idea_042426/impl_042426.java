...
@Data
public class Idea42426Config {
    private String name = "idea_042426";
 ...
 */
@Slf4j
public class Idea42426Service {
    private static final int IDEA_ID = 42426;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42426Service() {
        this(new Idea42426Config());
    }

    public Idea42426Service(Idea42426Config config) {
        this.config = config != null ? config : new Idea42426Config();
