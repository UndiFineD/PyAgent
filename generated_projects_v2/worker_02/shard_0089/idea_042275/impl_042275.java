...
@Data
public class Idea42275Config {
    private String name = "idea_042275";
 ...
 */
@Slf4j
public class Idea42275Service {
    private static final int IDEA_ID = 42275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42275Service() {
        this(new Idea42275Config());
    }

    public Idea42275Service(Idea42275Config config) {
        this.config = config != null ? config : new Idea42275Config();
