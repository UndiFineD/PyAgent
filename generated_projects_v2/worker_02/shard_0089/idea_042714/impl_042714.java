...
@Data
public class Idea42714Config {
    private String name = "idea_042714";
 ...
 */
@Slf4j
public class Idea42714Service {
    private static final int IDEA_ID = 42714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42714Service() {
        this(new Idea42714Config());
    }

    public Idea42714Service(Idea42714Config config) {
        this.config = config != null ? config : new Idea42714Config();
