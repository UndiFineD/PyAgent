...
@Data
public class Idea42301Config {
    private String name = "idea_042301";
 ...
 */
@Slf4j
public class Idea42301Service {
    private static final int IDEA_ID = 42301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42301Service() {
        this(new Idea42301Config());
    }

    public Idea42301Service(Idea42301Config config) {
        this.config = config != null ? config : new Idea42301Config();
