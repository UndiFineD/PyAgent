...
@Data
public class Idea42740Config {
    private String name = "idea_042740";
 ...
 */
@Slf4j
public class Idea42740Service {
    private static final int IDEA_ID = 42740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42740Service() {
        this(new Idea42740Config());
    }

    public Idea42740Service(Idea42740Config config) {
        this.config = config != null ? config : new Idea42740Config();
