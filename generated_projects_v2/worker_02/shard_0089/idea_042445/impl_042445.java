...
@Data
public class Idea42445Config {
    private String name = "idea_042445";
 ...
 */
@Slf4j
public class Idea42445Service {
    private static final int IDEA_ID = 42445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42445Service() {
        this(new Idea42445Config());
    }

    public Idea42445Service(Idea42445Config config) {
        this.config = config != null ? config : new Idea42445Config();
