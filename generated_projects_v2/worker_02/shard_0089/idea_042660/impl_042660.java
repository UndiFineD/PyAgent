...
@Data
public class Idea42660Config {
    private String name = "idea_042660";
 ...
 */
@Slf4j
public class Idea42660Service {
    private static final int IDEA_ID = 42660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42660Service() {
        this(new Idea42660Config());
    }

    public Idea42660Service(Idea42660Config config) {
        this.config = config != null ? config : new Idea42660Config();
