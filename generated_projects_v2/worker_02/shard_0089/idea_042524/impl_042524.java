...
@Data
public class Idea42524Config {
    private String name = "idea_042524";
 ...
 */
@Slf4j
public class Idea42524Service {
    private static final int IDEA_ID = 42524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42524Service() {
        this(new Idea42524Config());
    }

    public Idea42524Service(Idea42524Config config) {
        this.config = config != null ? config : new Idea42524Config();
