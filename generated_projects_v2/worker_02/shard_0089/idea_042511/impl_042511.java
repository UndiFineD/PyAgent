...
@Data
public class Idea42511Config {
    private String name = "idea_042511";
 ...
 */
@Slf4j
public class Idea42511Service {
    private static final int IDEA_ID = 42511;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42511Service() {
        this(new Idea42511Config());
    }

    public Idea42511Service(Idea42511Config config) {
        this.config = config != null ? config : new Idea42511Config();
