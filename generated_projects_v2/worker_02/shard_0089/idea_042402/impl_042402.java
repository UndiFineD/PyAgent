...
@Data
public class Idea42402Config {
    private String name = "idea_042402";
 ...
 */
@Slf4j
public class Idea42402Service {
    private static final int IDEA_ID = 42402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42402Service() {
        this(new Idea42402Config());
    }

    public Idea42402Service(Idea42402Config config) {
        this.config = config != null ? config : new Idea42402Config();
