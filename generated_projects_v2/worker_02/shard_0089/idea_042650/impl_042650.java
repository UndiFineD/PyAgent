...
@Data
public class Idea42650Config {
    private String name = "idea_042650";
 ...
 */
@Slf4j
public class Idea42650Service {
    private static final int IDEA_ID = 42650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42650Service() {
        this(new Idea42650Config());
    }

    public Idea42650Service(Idea42650Config config) {
        this.config = config != null ? config : new Idea42650Config();
