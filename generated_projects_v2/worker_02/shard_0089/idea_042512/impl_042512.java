...
@Data
public class Idea42512Config {
    private String name = "idea_042512";
 ...
 */
@Slf4j
public class Idea42512Service {
    private static final int IDEA_ID = 42512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42512Service() {
        this(new Idea42512Config());
    }

    public Idea42512Service(Idea42512Config config) {
        this.config = config != null ? config : new Idea42512Config();
