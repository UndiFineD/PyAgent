...
@Data
public class Idea42456Config {
    private String name = "idea_042456";
 ...
 */
@Slf4j
public class Idea42456Service {
    private static final int IDEA_ID = 42456;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42456Service() {
        this(new Idea42456Config());
    }

    public Idea42456Service(Idea42456Config config) {
        this.config = config != null ? config : new Idea42456Config();
