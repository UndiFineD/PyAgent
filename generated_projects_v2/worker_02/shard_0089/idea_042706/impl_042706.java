...
@Data
public class Idea42706Config {
    private String name = "idea_042706";
 ...
 */
@Slf4j
public class Idea42706Service {
    private static final int IDEA_ID = 42706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42706Service() {
        this(new Idea42706Config());
    }

    public Idea42706Service(Idea42706Config config) {
        this.config = config != null ? config : new Idea42706Config();
