...
@Data
public class Idea42405Config {
    private String name = "idea_042405";
 ...
 */
@Slf4j
public class Idea42405Service {
    private static final int IDEA_ID = 42405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42405Service() {
        this(new Idea42405Config());
    }

    public Idea42405Service(Idea42405Config config) {
        this.config = config != null ? config : new Idea42405Config();
