...
@Data
public class Idea42345Config {
    private String name = "idea_042345";
 ...
 */
@Slf4j
public class Idea42345Service {
    private static final int IDEA_ID = 42345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42345Service() {
        this(new Idea42345Config());
    }

    public Idea42345Service(Idea42345Config config) {
        this.config = config != null ? config : new Idea42345Config();
