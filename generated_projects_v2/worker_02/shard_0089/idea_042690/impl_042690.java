...
@Data
public class Idea42690Config {
    private String name = "idea_042690";
 ...
 */
@Slf4j
public class Idea42690Service {
    private static final int IDEA_ID = 42690;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42690Service() {
        this(new Idea42690Config());
    }

    public Idea42690Service(Idea42690Config config) {
        this.config = config != null ? config : new Idea42690Config();
