...
@Data
public class Idea42380Config {
    private String name = "idea_042380";
 ...
 */
@Slf4j
public class Idea42380Service {
    private static final int IDEA_ID = 42380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42380Service() {
        this(new Idea42380Config());
    }

    public Idea42380Service(Idea42380Config config) {
        this.config = config != null ? config : new Idea42380Config();
