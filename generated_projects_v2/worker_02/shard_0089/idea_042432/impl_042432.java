...
@Data
public class Idea42432Config {
    private String name = "idea_042432";
 ...
 */
@Slf4j
public class Idea42432Service {
    private static final int IDEA_ID = 42432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42432Service() {
        this(new Idea42432Config());
    }

    public Idea42432Service(Idea42432Config config) {
        this.config = config != null ? config : new Idea42432Config();
