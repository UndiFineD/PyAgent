...
@Data
public class Idea42617Config {
    private String name = "idea_042617";
 ...
 */
@Slf4j
public class Idea42617Service {
    private static final int IDEA_ID = 42617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42617Service() {
        this(new Idea42617Config());
    }

    public Idea42617Service(Idea42617Config config) {
        this.config = config != null ? config : new Idea42617Config();
