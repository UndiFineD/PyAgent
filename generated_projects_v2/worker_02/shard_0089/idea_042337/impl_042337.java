...
@Data
public class Idea42337Config {
    private String name = "idea_042337";
 ...
 */
@Slf4j
public class Idea42337Service {
    private static final int IDEA_ID = 42337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42337Service() {
        this(new Idea42337Config());
    }

    public Idea42337Service(Idea42337Config config) {
        this.config = config != null ? config : new Idea42337Config();
