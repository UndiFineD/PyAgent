...
@Data
public class Idea42323Config {
    private String name = "idea_042323";
 ...
 */
@Slf4j
public class Idea42323Service {
    private static final int IDEA_ID = 42323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42323Service() {
        this(new Idea42323Config());
    }

    public Idea42323Service(Idea42323Config config) {
        this.config = config != null ? config : new Idea42323Config();
