...
@Data
public class Idea42594Config {
    private String name = "idea_042594";
 ...
 */
@Slf4j
public class Idea42594Service {
    private static final int IDEA_ID = 42594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42594Service() {
        this(new Idea42594Config());
    }

    public Idea42594Service(Idea42594Config config) {
        this.config = config != null ? config : new Idea42594Config();
