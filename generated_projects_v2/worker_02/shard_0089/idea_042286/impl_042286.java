...
@Data
public class Idea42286Config {
    private String name = "idea_042286";
 ...
 */
@Slf4j
public class Idea42286Service {
    private static final int IDEA_ID = 42286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42286Service() {
        this(new Idea42286Config());
    }

    public Idea42286Service(Idea42286Config config) {
        this.config = config != null ? config : new Idea42286Config();
