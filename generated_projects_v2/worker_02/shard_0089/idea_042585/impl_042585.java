...
@Data
public class Idea42585Config {
    private String name = "idea_042585";
 ...
 */
@Slf4j
public class Idea42585Service {
    private static final int IDEA_ID = 42585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42585Service() {
        this(new Idea42585Config());
    }

    public Idea42585Service(Idea42585Config config) {
        this.config = config != null ? config : new Idea42585Config();
