...
@Data
public class Idea42297Config {
    private String name = "idea_042297";
 ...
 */
@Slf4j
public class Idea42297Service {
    private static final int IDEA_ID = 42297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42297Service() {
        this(new Idea42297Config());
    }

    public Idea42297Service(Idea42297Config config) {
        this.config = config != null ? config : new Idea42297Config();
