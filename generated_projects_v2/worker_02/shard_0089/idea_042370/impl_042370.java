...
@Data
public class Idea42370Config {
    private String name = "idea_042370";
 ...
 */
@Slf4j
public class Idea42370Service {
    private static final int IDEA_ID = 42370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42370Service() {
        this(new Idea42370Config());
    }

    public Idea42370Service(Idea42370Config config) {
        this.config = config != null ? config : new Idea42370Config();
