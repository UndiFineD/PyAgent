...
@Data
public class Idea42433Config {
    private String name = "idea_042433";
 ...
 */
@Slf4j
public class Idea42433Service {
    private static final int IDEA_ID = 42433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42433Service() {
        this(new Idea42433Config());
    }

    public Idea42433Service(Idea42433Config config) {
        this.config = config != null ? config : new Idea42433Config();
