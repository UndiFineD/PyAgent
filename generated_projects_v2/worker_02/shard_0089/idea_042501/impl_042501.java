...
@Data
public class Idea42501Config {
    private String name = "idea_042501";
 ...
 */
@Slf4j
public class Idea42501Service {
    private static final int IDEA_ID = 42501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42501Service() {
        this(new Idea42501Config());
    }

    public Idea42501Service(Idea42501Config config) {
        this.config = config != null ? config : new Idea42501Config();
