...
@Data
public class Idea42607Config {
    private String name = "idea_042607";
 ...
 */
@Slf4j
public class Idea42607Service {
    private static final int IDEA_ID = 42607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42607Service() {
        this(new Idea42607Config());
    }

    public Idea42607Service(Idea42607Config config) {
        this.config = config != null ? config : new Idea42607Config();
