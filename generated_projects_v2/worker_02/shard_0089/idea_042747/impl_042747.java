...
@Data
public class Idea42747Config {
    private String name = "idea_042747";
 ...
 */
@Slf4j
public class Idea42747Service {
    private static final int IDEA_ID = 42747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42747Service() {
        this(new Idea42747Config());
    }

    public Idea42747Service(Idea42747Config config) {
        this.config = config != null ? config : new Idea42747Config();
