...
@Data
public class Idea42431Config {
    private String name = "idea_042431";
 ...
 */
@Slf4j
public class Idea42431Service {
    private static final int IDEA_ID = 42431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42431Service() {
        this(new Idea42431Config());
    }

    public Idea42431Service(Idea42431Config config) {
        this.config = config != null ? config : new Idea42431Config();
