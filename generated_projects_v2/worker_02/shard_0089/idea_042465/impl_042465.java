...
@Data
public class Idea42465Config {
    private String name = "idea_042465";
 ...
 */
@Slf4j
public class Idea42465Service {
    private static final int IDEA_ID = 42465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42465Service() {
        this(new Idea42465Config());
    }

    public Idea42465Service(Idea42465Config config) {
        this.config = config != null ? config : new Idea42465Config();
