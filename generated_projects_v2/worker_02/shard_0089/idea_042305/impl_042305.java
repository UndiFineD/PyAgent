...
@Data
public class Idea42305Config {
    private String name = "idea_042305";
 ...
 */
@Slf4j
public class Idea42305Service {
    private static final int IDEA_ID = 42305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42305Service() {
        this(new Idea42305Config());
    }

    public Idea42305Service(Idea42305Config config) {
        this.config = config != null ? config : new Idea42305Config();
