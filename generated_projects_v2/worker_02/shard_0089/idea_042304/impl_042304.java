...
@Data
public class Idea42304Config {
    private String name = "idea_042304";
 ...
 */
@Slf4j
public class Idea42304Service {
    private static final int IDEA_ID = 42304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42304Service() {
        this(new Idea42304Config());
    }

    public Idea42304Service(Idea42304Config config) {
        this.config = config != null ? config : new Idea42304Config();
