...
@Data
public class Idea42278Config {
    private String name = "idea_042278";
 ...
 */
@Slf4j
public class Idea42278Service {
    private static final int IDEA_ID = 42278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42278Service() {
        this(new Idea42278Config());
    }

    public Idea42278Service(Idea42278Config config) {
        this.config = config != null ? config : new Idea42278Config();
