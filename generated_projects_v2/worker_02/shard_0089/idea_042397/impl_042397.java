...
@Data
public class Idea42397Config {
    private String name = "idea_042397";
 ...
 */
@Slf4j
public class Idea42397Service {
    private static final int IDEA_ID = 42397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42397Service() {
        this(new Idea42397Config());
    }

    public Idea42397Service(Idea42397Config config) {
        this.config = config != null ? config : new Idea42397Config();
