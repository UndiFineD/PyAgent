...
@Data
public class Idea42532Config {
    private String name = "idea_042532";
 ...
 */
@Slf4j
public class Idea42532Service {
    private static final int IDEA_ID = 42532;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42532Service() {
        this(new Idea42532Config());
    }

    public Idea42532Service(Idea42532Config config) {
        this.config = config != null ? config : new Idea42532Config();
