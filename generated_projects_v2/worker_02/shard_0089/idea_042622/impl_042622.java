...
@Data
public class Idea42622Config {
    private String name = "idea_042622";
 ...
 */
@Slf4j
public class Idea42622Service {
    private static final int IDEA_ID = 42622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42622Service() {
        this(new Idea42622Config());
    }

    public Idea42622Service(Idea42622Config config) {
        this.config = config != null ? config : new Idea42622Config();
