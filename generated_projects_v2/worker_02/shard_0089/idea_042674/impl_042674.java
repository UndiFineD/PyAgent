...
@Data
public class Idea42674Config {
    private String name = "idea_042674";
 ...
 */
@Slf4j
public class Idea42674Service {
    private static final int IDEA_ID = 42674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42674Service() {
        this(new Idea42674Config());
    }

    public Idea42674Service(Idea42674Config config) {
        this.config = config != null ? config : new Idea42674Config();
