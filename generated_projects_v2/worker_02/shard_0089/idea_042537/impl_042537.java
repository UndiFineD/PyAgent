...
@Data
public class Idea42537Config {
    private String name = "idea_042537";
 ...
 */
@Slf4j
public class Idea42537Service {
    private static final int IDEA_ID = 42537;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42537Service() {
        this(new Idea42537Config());
    }

    public Idea42537Service(Idea42537Config config) {
        this.config = config != null ? config : new Idea42537Config();
