...
@Data
public class Idea42398Config {
    private String name = "idea_042398";
 ...
 */
@Slf4j
public class Idea42398Service {
    private static final int IDEA_ID = 42398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42398Service() {
        this(new Idea42398Config());
    }

    public Idea42398Service(Idea42398Config config) {
        this.config = config != null ? config : new Idea42398Config();
