...
@Data
public class Idea42725Config {
    private String name = "idea_042725";
 ...
 */
@Slf4j
public class Idea42725Service {
    private static final int IDEA_ID = 42725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42725Service() {
        this(new Idea42725Config());
    }

    public Idea42725Service(Idea42725Config config) {
        this.config = config != null ? config : new Idea42725Config();
