...
@Data
public class Idea42618Config {
    private String name = "idea_042618";
 ...
 */
@Slf4j
public class Idea42618Service {
    private static final int IDEA_ID = 42618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42618Service() {
        this(new Idea42618Config());
    }

    public Idea42618Service(Idea42618Config config) {
        this.config = config != null ? config : new Idea42618Config();
