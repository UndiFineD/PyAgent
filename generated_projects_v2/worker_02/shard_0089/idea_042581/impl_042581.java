...
@Data
public class Idea42581Config {
    private String name = "idea_042581";
 ...
 */
@Slf4j
public class Idea42581Service {
    private static final int IDEA_ID = 42581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42581Service() {
        this(new Idea42581Config());
    }

    public Idea42581Service(Idea42581Config config) {
        this.config = config != null ? config : new Idea42581Config();
