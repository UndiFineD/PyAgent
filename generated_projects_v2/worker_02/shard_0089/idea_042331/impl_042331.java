...
@Data
public class Idea42331Config {
    private String name = "idea_042331";
 ...
 */
@Slf4j
public class Idea42331Service {
    private static final int IDEA_ID = 42331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42331Service() {
        this(new Idea42331Config());
    }

    public Idea42331Service(Idea42331Config config) {
        this.config = config != null ? config : new Idea42331Config();
