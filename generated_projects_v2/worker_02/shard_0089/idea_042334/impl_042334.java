...
@Data
public class Idea42334Config {
    private String name = "idea_042334";
 ...
 */
@Slf4j
public class Idea42334Service {
    private static final int IDEA_ID = 42334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42334Service() {
        this(new Idea42334Config());
    }

    public Idea42334Service(Idea42334Config config) {
        this.config = config != null ? config : new Idea42334Config();
