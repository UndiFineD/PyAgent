...
@Data
public class Idea42533Config {
    private String name = "idea_042533";
 ...
 */
@Slf4j
public class Idea42533Service {
    private static final int IDEA_ID = 42533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42533Service() {
        this(new Idea42533Config());
    }

    public Idea42533Service(Idea42533Config config) {
        this.config = config != null ? config : new Idea42533Config();
