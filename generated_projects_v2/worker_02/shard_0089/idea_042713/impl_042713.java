...
@Data
public class Idea42713Config {
    private String name = "idea_042713";
 ...
 */
@Slf4j
public class Idea42713Service {
    private static final int IDEA_ID = 42713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42713Service() {
        this(new Idea42713Config());
    }

    public Idea42713Service(Idea42713Config config) {
        this.config = config != null ? config : new Idea42713Config();
