...
@Data
public class Idea42422Config {
    private String name = "idea_042422";
 ...
 */
@Slf4j
public class Idea42422Service {
    private static final int IDEA_ID = 42422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42422Service() {
        this(new Idea42422Config());
    }

    public Idea42422Service(Idea42422Config config) {
        this.config = config != null ? config : new Idea42422Config();
