...
@Data
public class Idea42675Config {
    private String name = "idea_042675";
 ...
 */
@Slf4j
public class Idea42675Service {
    private static final int IDEA_ID = 42675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42675Service() {
        this(new Idea42675Config());
    }

    public Idea42675Service(Idea42675Config config) {
        this.config = config != null ? config : new Idea42675Config();
