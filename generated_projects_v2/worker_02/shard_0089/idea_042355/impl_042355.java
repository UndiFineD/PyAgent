...
@Data
public class Idea42355Config {
    private String name = "idea_042355";
 ...
 */
@Slf4j
public class Idea42355Service {
    private static final int IDEA_ID = 42355;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42355Service() {
        this(new Idea42355Config());
    }

    public Idea42355Service(Idea42355Config config) {
        this.config = config != null ? config : new Idea42355Config();
