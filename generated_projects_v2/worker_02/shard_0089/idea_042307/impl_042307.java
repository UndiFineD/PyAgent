...
@Data
public class Idea42307Config {
    private String name = "idea_042307";
 ...
 */
@Slf4j
public class Idea42307Service {
    private static final int IDEA_ID = 42307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42307Service() {
        this(new Idea42307Config());
    }

    public Idea42307Service(Idea42307Config config) {
        this.config = config != null ? config : new Idea42307Config();
