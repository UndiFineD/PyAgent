...
@Data
public class Idea42516Config {
    private String name = "idea_042516";
 ...
 */
@Slf4j
public class Idea42516Service {
    private static final int IDEA_ID = 42516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42516Service() {
        this(new Idea42516Config());
    }

    public Idea42516Service(Idea42516Config config) {
        this.config = config != null ? config : new Idea42516Config();
