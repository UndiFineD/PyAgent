...
@Data
public class Idea42603Config {
    private String name = "idea_042603";
 ...
 */
@Slf4j
public class Idea42603Service {
    private static final int IDEA_ID = 42603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42603Service() {
        this(new Idea42603Config());
    }

    public Idea42603Service(Idea42603Config config) {
        this.config = config != null ? config : new Idea42603Config();
