...
@Data
public class Idea42376Config {
    private String name = "idea_042376";
 ...
 */
@Slf4j
public class Idea42376Service {
    private static final int IDEA_ID = 42376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42376Service() {
        this(new Idea42376Config());
    }

    public Idea42376Service(Idea42376Config config) {
        this.config = config != null ? config : new Idea42376Config();
