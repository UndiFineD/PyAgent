...
@Data
public class Idea42696Config {
    private String name = "idea_042696";
 ...
 */
@Slf4j
public class Idea42696Service {
    private static final int IDEA_ID = 42696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42696Service() {
        this(new Idea42696Config());
    }

    public Idea42696Service(Idea42696Config config) {
        this.config = config != null ? config : new Idea42696Config();
