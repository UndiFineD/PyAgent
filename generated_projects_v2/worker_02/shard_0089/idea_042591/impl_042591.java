...
@Data
public class Idea42591Config {
    private String name = "idea_042591";
 ...
 */
@Slf4j
public class Idea42591Service {
    private static final int IDEA_ID = 42591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42591Service() {
        this(new Idea42591Config());
    }

    public Idea42591Service(Idea42591Config config) {
        this.config = config != null ? config : new Idea42591Config();
