...
@Data
public class Idea42604Config {
    private String name = "idea_042604";
 ...
 */
@Slf4j
public class Idea42604Service {
    private static final int IDEA_ID = 42604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42604Service() {
        this(new Idea42604Config());
    }

    public Idea42604Service(Idea42604Config config) {
        this.config = config != null ? config : new Idea42604Config();
