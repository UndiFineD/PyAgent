...
@Data
public class Idea42616Config {
    private String name = "idea_042616";
 ...
 */
@Slf4j
public class Idea42616Service {
    private static final int IDEA_ID = 42616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42616Service() {
        this(new Idea42616Config());
    }

    public Idea42616Service(Idea42616Config config) {
        this.config = config != null ? config : new Idea42616Config();
