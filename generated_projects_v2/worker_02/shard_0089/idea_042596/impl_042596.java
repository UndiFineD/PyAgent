...
@Data
public class Idea42596Config {
    private String name = "idea_042596";
 ...
 */
@Slf4j
public class Idea42596Service {
    private static final int IDEA_ID = 42596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42596Service() {
        this(new Idea42596Config());
    }

    public Idea42596Service(Idea42596Config config) {
        this.config = config != null ? config : new Idea42596Config();
