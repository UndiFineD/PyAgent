...
@Data
public class Idea42525Config {
    private String name = "idea_042525";
 ...
 */
@Slf4j
public class Idea42525Service {
    private static final int IDEA_ID = 42525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42525Service() {
        this(new Idea42525Config());
    }

    public Idea42525Service(Idea42525Config config) {
        this.config = config != null ? config : new Idea42525Config();
