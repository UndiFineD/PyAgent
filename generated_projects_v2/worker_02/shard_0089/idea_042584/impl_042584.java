...
@Data
public class Idea42584Config {
    private String name = "idea_042584";
 ...
 */
@Slf4j
public class Idea42584Service {
    private static final int IDEA_ID = 42584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42584Service() {
        this(new Idea42584Config());
    }

    public Idea42584Service(Idea42584Config config) {
        this.config = config != null ? config : new Idea42584Config();
