...
@Data
public class Idea42665Config {
    private String name = "idea_042665";
 ...
 */
@Slf4j
public class Idea42665Service {
    private static final int IDEA_ID = 42665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42665Service() {
        this(new Idea42665Config());
    }

    public Idea42665Service(Idea42665Config config) {
        this.config = config != null ? config : new Idea42665Config();
