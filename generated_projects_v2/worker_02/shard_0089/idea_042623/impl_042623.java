...
@Data
public class Idea42623Config {
    private String name = "idea_042623";
 ...
 */
@Slf4j
public class Idea42623Service {
    private static final int IDEA_ID = 42623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42623Service() {
        this(new Idea42623Config());
    }

    public Idea42623Service(Idea42623Config config) {
        this.config = config != null ? config : new Idea42623Config();
