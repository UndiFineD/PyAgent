...
@Data
public class Idea42460Config {
    private String name = "idea_042460";
 ...
 */
@Slf4j
public class Idea42460Service {
    private static final int IDEA_ID = 42460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42460Service() {
        this(new Idea42460Config());
    }

    public Idea42460Service(Idea42460Config config) {
        this.config = config != null ? config : new Idea42460Config();
