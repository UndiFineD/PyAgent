...
@Data
public class Idea42540Config {
    private String name = "idea_042540";
 ...
 */
@Slf4j
public class Idea42540Service {
    private static final int IDEA_ID = 42540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42540Service() {
        this(new Idea42540Config());
    }

    public Idea42540Service(Idea42540Config config) {
        this.config = config != null ? config : new Idea42540Config();
