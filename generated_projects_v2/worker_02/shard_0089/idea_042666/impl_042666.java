...
@Data
public class Idea42666Config {
    private String name = "idea_042666";
 ...
 */
@Slf4j
public class Idea42666Service {
    private static final int IDEA_ID = 42666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42666Service() {
        this(new Idea42666Config());
    }

    public Idea42666Service(Idea42666Config config) {
        this.config = config != null ? config : new Idea42666Config();
