...
@Data
public class Idea42514Config {
    private String name = "idea_042514";
 ...
 */
@Slf4j
public class Idea42514Service {
    private static final int IDEA_ID = 42514;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42514Service() {
        this(new Idea42514Config());
    }

    public Idea42514Service(Idea42514Config config) {
        this.config = config != null ? config : new Idea42514Config();
