...
@Data
public class Idea42652Config {
    private String name = "idea_042652";
 ...
 */
@Slf4j
public class Idea42652Service {
    private static final int IDEA_ID = 42652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42652Service() {
        this(new Idea42652Config());
    }

    public Idea42652Service(Idea42652Config config) {
        this.config = config != null ? config : new Idea42652Config();
