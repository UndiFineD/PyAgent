...
@Data
public class Idea42631Config {
    private String name = "idea_042631";
 ...
 */
@Slf4j
public class Idea42631Service {
    private static final int IDEA_ID = 42631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42631Service() {
        this(new Idea42631Config());
    }

    public Idea42631Service(Idea42631Config config) {
        this.config = config != null ? config : new Idea42631Config();
