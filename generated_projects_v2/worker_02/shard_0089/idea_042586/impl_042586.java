...
@Data
public class Idea42586Config {
    private String name = "idea_042586";
 ...
 */
@Slf4j
public class Idea42586Service {
    private static final int IDEA_ID = 42586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42586Service() {
        this(new Idea42586Config());
    }

    public Idea42586Service(Idea42586Config config) {
        this.config = config != null ? config : new Idea42586Config();
