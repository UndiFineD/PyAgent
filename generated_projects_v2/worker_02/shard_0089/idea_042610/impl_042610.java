...
@Data
public class Idea42610Config {
    private String name = "idea_042610";
 ...
 */
@Slf4j
public class Idea42610Service {
    private static final int IDEA_ID = 42610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42610Service() {
        this(new Idea42610Config());
    }

    public Idea42610Service(Idea42610Config config) {
        this.config = config != null ? config : new Idea42610Config();
