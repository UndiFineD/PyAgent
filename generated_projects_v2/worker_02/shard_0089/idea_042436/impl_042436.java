...
@Data
public class Idea42436Config {
    private String name = "idea_042436";
 ...
 */
@Slf4j
public class Idea42436Service {
    private static final int IDEA_ID = 42436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42436Service() {
        this(new Idea42436Config());
    }

    public Idea42436Service(Idea42436Config config) {
        this.config = config != null ? config : new Idea42436Config();
