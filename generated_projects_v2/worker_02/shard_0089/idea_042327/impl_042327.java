...
@Data
public class Idea42327Config {
    private String name = "idea_042327";
 ...
 */
@Slf4j
public class Idea42327Service {
    private static final int IDEA_ID = 42327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42327Service() {
        this(new Idea42327Config());
    }

    public Idea42327Service(Idea42327Config config) {
        this.config = config != null ? config : new Idea42327Config();
