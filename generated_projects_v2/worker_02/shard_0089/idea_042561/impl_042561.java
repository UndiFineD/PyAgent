...
@Data
public class Idea42561Config {
    private String name = "idea_042561";
 ...
 */
@Slf4j
public class Idea42561Service {
    private static final int IDEA_ID = 42561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42561Service() {
        this(new Idea42561Config());
    }

    public Idea42561Service(Idea42561Config config) {
        this.config = config != null ? config : new Idea42561Config();
