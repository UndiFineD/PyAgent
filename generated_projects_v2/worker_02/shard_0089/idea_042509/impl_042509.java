...
@Data
public class Idea42509Config {
    private String name = "idea_042509";
 ...
 */
@Slf4j
public class Idea42509Service {
    private static final int IDEA_ID = 42509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42509Service() {
        this(new Idea42509Config());
    }

    public Idea42509Service(Idea42509Config config) {
        this.config = config != null ? config : new Idea42509Config();
