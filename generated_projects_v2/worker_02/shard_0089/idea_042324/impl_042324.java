...
@Data
public class Idea42324Config {
    private String name = "idea_042324";
 ...
 */
@Slf4j
public class Idea42324Service {
    private static final int IDEA_ID = 42324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42324Service() {
        this(new Idea42324Config());
    }

    public Idea42324Service(Idea42324Config config) {
        this.config = config != null ? config : new Idea42324Config();
