...
@Data
public class Idea42442Config {
    private String name = "idea_042442";
 ...
 */
@Slf4j
public class Idea42442Service {
    private static final int IDEA_ID = 42442;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42442Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42442Service() {
        this(new Idea42442Config());
    }

    public Idea42442Service(Idea42442Config config) {
        this.config = config != null ? config : new Idea42442Config();
