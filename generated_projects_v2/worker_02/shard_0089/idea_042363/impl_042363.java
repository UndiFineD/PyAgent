...
@Data
public class Idea42363Config {
    private String name = "idea_042363";
 ...
 */
@Slf4j
public class Idea42363Service {
    private static final int IDEA_ID = 42363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42363Service() {
        this(new Idea42363Config());
    }

    public Idea42363Service(Idea42363Config config) {
        this.config = config != null ? config : new Idea42363Config();
