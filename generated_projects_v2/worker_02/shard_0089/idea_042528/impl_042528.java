...
@Data
public class Idea42528Config {
    private String name = "idea_042528";
 ...
 */
@Slf4j
public class Idea42528Service {
    private static final int IDEA_ID = 42528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42528Service() {
        this(new Idea42528Config());
    }

    public Idea42528Service(Idea42528Config config) {
        this.config = config != null ? config : new Idea42528Config();
