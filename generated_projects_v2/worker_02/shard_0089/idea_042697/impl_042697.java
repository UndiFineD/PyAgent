...
@Data
public class Idea42697Config {
    private String name = "idea_042697";
 ...
 */
@Slf4j
public class Idea42697Service {
    private static final int IDEA_ID = 42697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42697Service() {
        this(new Idea42697Config());
    }

    public Idea42697Service(Idea42697Config config) {
        this.config = config != null ? config : new Idea42697Config();
