...
@Data
public class Idea42609Config {
    private String name = "idea_042609";
 ...
 */
@Slf4j
public class Idea42609Service {
    private static final int IDEA_ID = 42609;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42609Service() {
        this(new Idea42609Config());
    }

    public Idea42609Service(Idea42609Config config) {
        this.config = config != null ? config : new Idea42609Config();
