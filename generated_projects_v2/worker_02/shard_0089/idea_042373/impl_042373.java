...
@Data
public class Idea42373Config {
    private String name = "idea_042373";
 ...
 */
@Slf4j
public class Idea42373Service {
    private static final int IDEA_ID = 42373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42373Service() {
        this(new Idea42373Config());
    }

    public Idea42373Service(Idea42373Config config) {
        this.config = config != null ? config : new Idea42373Config();
