...
@Data
public class Idea42731Config {
    private String name = "idea_042731";
 ...
 */
@Slf4j
public class Idea42731Service {
    private static final int IDEA_ID = 42731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42731Service() {
        this(new Idea42731Config());
    }

    public Idea42731Service(Idea42731Config config) {
        this.config = config != null ? config : new Idea42731Config();
