...
@Data
public class Idea42461Config {
    private String name = "idea_042461";
 ...
 */
@Slf4j
public class Idea42461Service {
    private static final int IDEA_ID = 42461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42461Service() {
        this(new Idea42461Config());
    }

    public Idea42461Service(Idea42461Config config) {
        this.config = config != null ? config : new Idea42461Config();
