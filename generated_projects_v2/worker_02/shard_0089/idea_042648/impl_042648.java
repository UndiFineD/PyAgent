...
@Data
public class Idea42648Config {
    private String name = "idea_042648";
 ...
 */
@Slf4j
public class Idea42648Service {
    private static final int IDEA_ID = 42648;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42648Service() {
        this(new Idea42648Config());
    }

    public Idea42648Service(Idea42648Config config) {
        this.config = config != null ? config : new Idea42648Config();
