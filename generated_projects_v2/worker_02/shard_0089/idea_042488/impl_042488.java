...
@Data
public class Idea42488Config {
    private String name = "idea_042488";
 ...
 */
@Slf4j
public class Idea42488Service {
    private static final int IDEA_ID = 42488;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42488Service() {
        this(new Idea42488Config());
    }

    public Idea42488Service(Idea42488Config config) {
        this.config = config != null ? config : new Idea42488Config();
