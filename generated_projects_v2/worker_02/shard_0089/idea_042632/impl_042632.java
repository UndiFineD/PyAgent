...
@Data
public class Idea42632Config {
    private String name = "idea_042632";
 ...
 */
@Slf4j
public class Idea42632Service {
    private static final int IDEA_ID = 42632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42632Service() {
        this(new Idea42632Config());
    }

    public Idea42632Service(Idea42632Config config) {
        this.config = config != null ? config : new Idea42632Config();
