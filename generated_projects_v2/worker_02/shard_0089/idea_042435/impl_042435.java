...
@Data
public class Idea42435Config {
    private String name = "idea_042435";
 ...
 */
@Slf4j
public class Idea42435Service {
    private static final int IDEA_ID = 42435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42435Service() {
        this(new Idea42435Config());
    }

    public Idea42435Service(Idea42435Config config) {
        this.config = config != null ? config : new Idea42435Config();
