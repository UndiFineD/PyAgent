...
@Data
public class Idea42625Config {
    private String name = "idea_042625";
 ...
 */
@Slf4j
public class Idea42625Service {
    private static final int IDEA_ID = 42625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42625Service() {
        this(new Idea42625Config());
    }

    public Idea42625Service(Idea42625Config config) {
        this.config = config != null ? config : new Idea42625Config();
