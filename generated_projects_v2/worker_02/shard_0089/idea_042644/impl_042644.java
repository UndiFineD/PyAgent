...
@Data
public class Idea42644Config {
    private String name = "idea_042644";
 ...
 */
@Slf4j
public class Idea42644Service {
    private static final int IDEA_ID = 42644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42644Service() {
        this(new Idea42644Config());
    }

    public Idea42644Service(Idea42644Config config) {
        this.config = config != null ? config : new Idea42644Config();
