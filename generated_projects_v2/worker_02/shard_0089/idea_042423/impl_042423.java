...
@Data
public class Idea42423Config {
    private String name = "idea_042423";
 ...
 */
@Slf4j
public class Idea42423Service {
    private static final int IDEA_ID = 42423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42423Service() {
        this(new Idea42423Config());
    }

    public Idea42423Service(Idea42423Config config) {
        this.config = config != null ? config : new Idea42423Config();
