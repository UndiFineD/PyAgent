...
@Data
public class Idea42440Config {
    private String name = "idea_042440";
 ...
 */
@Slf4j
public class Idea42440Service {
    private static final int IDEA_ID = 42440;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42440Service() {
        this(new Idea42440Config());
    }

    public Idea42440Service(Idea42440Config config) {
        this.config = config != null ? config : new Idea42440Config();
