...
@Data
public class Idea42414Config {
    private String name = "idea_042414";
 ...
 */
@Slf4j
public class Idea42414Service {
    private static final int IDEA_ID = 42414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42414Service() {
        this(new Idea42414Config());
    }

    public Idea42414Service(Idea42414Config config) {
        this.config = config != null ? config : new Idea42414Config();
