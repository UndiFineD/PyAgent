...
@Data
public class Idea42418Config {
    private String name = "idea_042418";
 ...
 */
@Slf4j
public class Idea42418Service {
    private static final int IDEA_ID = 42418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42418Service() {
        this(new Idea42418Config());
    }

    public Idea42418Service(Idea42418Config config) {
        this.config = config != null ? config : new Idea42418Config();
