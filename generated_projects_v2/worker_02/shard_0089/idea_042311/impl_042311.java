...
@Data
public class Idea42311Config {
    private String name = "idea_042311";
 ...
 */
@Slf4j
public class Idea42311Service {
    private static final int IDEA_ID = 42311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42311Service() {
        this(new Idea42311Config());
    }

    public Idea42311Service(Idea42311Config config) {
        this.config = config != null ? config : new Idea42311Config();
