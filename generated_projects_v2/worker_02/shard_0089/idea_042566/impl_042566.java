...
@Data
public class Idea42566Config {
    private String name = "idea_042566";
 ...
 */
@Slf4j
public class Idea42566Service {
    private static final int IDEA_ID = 42566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42566Service() {
        this(new Idea42566Config());
    }

    public Idea42566Service(Idea42566Config config) {
        this.config = config != null ? config : new Idea42566Config();
