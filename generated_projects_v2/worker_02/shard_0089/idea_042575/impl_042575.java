...
@Data
public class Idea42575Config {
    private String name = "idea_042575";
 ...
 */
@Slf4j
public class Idea42575Service {
    private static final int IDEA_ID = 42575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42575Service() {
        this(new Idea42575Config());
    }

    public Idea42575Service(Idea42575Config config) {
        this.config = config != null ? config : new Idea42575Config();
