...
@Data
public class Idea42720Config {
    private String name = "idea_042720";
 ...
 */
@Slf4j
public class Idea42720Service {
    private static final int IDEA_ID = 42720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42720Service() {
        this(new Idea42720Config());
    }

    public Idea42720Service(Idea42720Config config) {
        this.config = config != null ? config : new Idea42720Config();
