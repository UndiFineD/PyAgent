...
@Data
public class Idea42637Config {
    private String name = "idea_042637";
 ...
 */
@Slf4j
public class Idea42637Service {
    private static final int IDEA_ID = 42637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42637Service() {
        this(new Idea42637Config());
    }

    public Idea42637Service(Idea42637Config config) {
        this.config = config != null ? config : new Idea42637Config();
