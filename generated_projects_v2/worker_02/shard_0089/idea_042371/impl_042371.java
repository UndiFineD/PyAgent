...
@Data
public class Idea42371Config {
    private String name = "idea_042371";
 ...
 */
@Slf4j
public class Idea42371Service {
    private static final int IDEA_ID = 42371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42371Service() {
        this(new Idea42371Config());
    }

    public Idea42371Service(Idea42371Config config) {
        this.config = config != null ? config : new Idea42371Config();
