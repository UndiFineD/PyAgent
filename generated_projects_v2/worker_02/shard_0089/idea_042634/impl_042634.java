...
@Data
public class Idea42634Config {
    private String name = "idea_042634";
 ...
 */
@Slf4j
public class Idea42634Service {
    private static final int IDEA_ID = 42634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42634Service() {
        this(new Idea42634Config());
    }

    public Idea42634Service(Idea42634Config config) {
        this.config = config != null ? config : new Idea42634Config();
