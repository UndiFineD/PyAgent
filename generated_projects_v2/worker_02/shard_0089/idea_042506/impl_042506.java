...
@Data
public class Idea42506Config {
    private String name = "idea_042506";
 ...
 */
@Slf4j
public class Idea42506Service {
    private static final int IDEA_ID = 42506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42506Service() {
        this(new Idea42506Config());
    }

    public Idea42506Service(Idea42506Config config) {
        this.config = config != null ? config : new Idea42506Config();
