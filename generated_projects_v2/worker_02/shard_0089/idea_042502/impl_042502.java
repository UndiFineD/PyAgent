...
@Data
public class Idea42502Config {
    private String name = "idea_042502";
 ...
 */
@Slf4j
public class Idea42502Service {
    private static final int IDEA_ID = 42502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42502Service() {
        this(new Idea42502Config());
    }

    public Idea42502Service(Idea42502Config config) {
        this.config = config != null ? config : new Idea42502Config();
