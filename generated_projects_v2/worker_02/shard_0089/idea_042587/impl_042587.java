...
@Data
public class Idea42587Config {
    private String name = "idea_042587";
 ...
 */
@Slf4j
public class Idea42587Service {
    private static final int IDEA_ID = 42587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42587Service() {
        this(new Idea42587Config());
    }

    public Idea42587Service(Idea42587Config config) {
        this.config = config != null ? config : new Idea42587Config();
