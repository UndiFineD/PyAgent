...
@Data
public class Idea42382Config {
    private String name = "idea_042382";
 ...
 */
@Slf4j
public class Idea42382Service {
    private static final int IDEA_ID = 42382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42382Service() {
        this(new Idea42382Config());
    }

    public Idea42382Service(Idea42382Config config) {
        this.config = config != null ? config : new Idea42382Config();
