...
@Data
public class Idea42360Config {
    private String name = "idea_042360";
 ...
 */
@Slf4j
public class Idea42360Service {
    private static final int IDEA_ID = 42360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42360Service() {
        this(new Idea42360Config());
    }

    public Idea42360Service(Idea42360Config config) {
        this.config = config != null ? config : new Idea42360Config();
