...
@Data
public class Idea42559Config {
    private String name = "idea_042559";
 ...
 */
@Slf4j
public class Idea42559Service {
    private static final int IDEA_ID = 42559;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42559Service() {
        this(new Idea42559Config());
    }

    public Idea42559Service(Idea42559Config config) {
        this.config = config != null ? config : new Idea42559Config();
