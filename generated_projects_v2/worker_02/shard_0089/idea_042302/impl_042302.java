...
@Data
public class Idea42302Config {
    private String name = "idea_042302";
 ...
 */
@Slf4j
public class Idea42302Service {
    private static final int IDEA_ID = 42302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42302Service() {
        this(new Idea42302Config());
    }

    public Idea42302Service(Idea42302Config config) {
        this.config = config != null ? config : new Idea42302Config();
