...
@Data
public class Idea42513Config {
    private String name = "idea_042513";
 ...
 */
@Slf4j
public class Idea42513Service {
    private static final int IDEA_ID = 42513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42513Service() {
        this(new Idea42513Config());
    }

    public Idea42513Service(Idea42513Config config) {
        this.config = config != null ? config : new Idea42513Config();
