...
@Data
public class Idea42526Config {
    private String name = "idea_042526";
 ...
 */
@Slf4j
public class Idea42526Service {
    private static final int IDEA_ID = 42526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42526Service() {
        this(new Idea42526Config());
    }

    public Idea42526Service(Idea42526Config config) {
        this.config = config != null ? config : new Idea42526Config();
