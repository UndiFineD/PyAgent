...
@Data
public class Idea42375Config {
    private String name = "idea_042375";
 ...
 */
@Slf4j
public class Idea42375Service {
    private static final int IDEA_ID = 42375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42375Service() {
        this(new Idea42375Config());
    }

    public Idea42375Service(Idea42375Config config) {
        this.config = config != null ? config : new Idea42375Config();
