...
@Data
public class Idea42381Config {
    private String name = "idea_042381";
 ...
 */
@Slf4j
public class Idea42381Service {
    private static final int IDEA_ID = 42381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42381Service() {
        this(new Idea42381Config());
    }

    public Idea42381Service(Idea42381Config config) {
        this.config = config != null ? config : new Idea42381Config();
