...
@Data
public class Idea42543Config {
    private String name = "idea_042543";
 ...
 */
@Slf4j
public class Idea42543Service {
    private static final int IDEA_ID = 42543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42543Service() {
        this(new Idea42543Config());
    }

    public Idea42543Service(Idea42543Config config) {
        this.config = config != null ? config : new Idea42543Config();
