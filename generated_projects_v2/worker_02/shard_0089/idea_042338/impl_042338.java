...
@Data
public class Idea42338Config {
    private String name = "idea_042338";
 ...
 */
@Slf4j
public class Idea42338Service {
    private static final int IDEA_ID = 42338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42338Service() {
        this(new Idea42338Config());
    }

    public Idea42338Service(Idea42338Config config) {
        this.config = config != null ? config : new Idea42338Config();
