...
@Data
public class Idea42391Config {
    private String name = "idea_042391";
 ...
 */
@Slf4j
public class Idea42391Service {
    private static final int IDEA_ID = 42391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42391Service() {
        this(new Idea42391Config());
    }

    public Idea42391Service(Idea42391Config config) {
        this.config = config != null ? config : new Idea42391Config();
