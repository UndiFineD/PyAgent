...
@Data
public class Idea42742Config {
    private String name = "idea_042742";
 ...
 */
@Slf4j
public class Idea42742Service {
    private static final int IDEA_ID = 42742;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42742Service() {
        this(new Idea42742Config());
    }

    public Idea42742Service(Idea42742Config config) {
        this.config = config != null ? config : new Idea42742Config();
