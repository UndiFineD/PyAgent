...
@Data
public class Idea42671Config {
    private String name = "idea_042671";
 ...
 */
@Slf4j
public class Idea42671Service {
    private static final int IDEA_ID = 42671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42671Service() {
        this(new Idea42671Config());
    }

    public Idea42671Service(Idea42671Config config) {
        this.config = config != null ? config : new Idea42671Config();
