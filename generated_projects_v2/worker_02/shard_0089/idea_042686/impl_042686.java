...
@Data
public class Idea42686Config {
    private String name = "idea_042686";
 ...
 */
@Slf4j
public class Idea42686Service {
    private static final int IDEA_ID = 42686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42686Service() {
        this(new Idea42686Config());
    }

    public Idea42686Service(Idea42686Config config) {
        this.config = config != null ? config : new Idea42686Config();
