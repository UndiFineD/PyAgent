...
@Data
public class Idea42654Config {
    private String name = "idea_042654";
 ...
 */
@Slf4j
public class Idea42654Service {
    private static final int IDEA_ID = 42654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42654Service() {
        this(new Idea42654Config());
    }

    public Idea42654Service(Idea42654Config config) {
        this.config = config != null ? config : new Idea42654Config();
