...
@Data
public class Idea42546Config {
    private String name = "idea_042546";
 ...
 */
@Slf4j
public class Idea42546Service {
    private static final int IDEA_ID = 42546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42546Service() {
        this(new Idea42546Config());
    }

    public Idea42546Service(Idea42546Config config) {
        this.config = config != null ? config : new Idea42546Config();
