...
@Data
public class Idea42429Config {
    private String name = "idea_042429";
 ...
 */
@Slf4j
public class Idea42429Service {
    private static final int IDEA_ID = 42429;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42429Service() {
        this(new Idea42429Config());
    }

    public Idea42429Service(Idea42429Config config) {
        this.config = config != null ? config : new Idea42429Config();
