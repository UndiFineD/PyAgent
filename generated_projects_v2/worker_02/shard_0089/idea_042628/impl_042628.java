...
@Data
public class Idea42628Config {
    private String name = "idea_042628";
 ...
 */
@Slf4j
public class Idea42628Service {
    private static final int IDEA_ID = 42628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42628Service() {
        this(new Idea42628Config());
    }

    public Idea42628Service(Idea42628Config config) {
        this.config = config != null ? config : new Idea42628Config();
