...
@Data
public class Idea42641Config {
    private String name = "idea_042641";
 ...
 */
@Slf4j
public class Idea42641Service {
    private static final int IDEA_ID = 42641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42641Service() {
        this(new Idea42641Config());
    }

    public Idea42641Service(Idea42641Config config) {
        this.config = config != null ? config : new Idea42641Config();
