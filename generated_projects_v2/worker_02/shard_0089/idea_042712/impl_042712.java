...
@Data
public class Idea42712Config {
    private String name = "idea_042712";
 ...
 */
@Slf4j
public class Idea42712Service {
    private static final int IDEA_ID = 42712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42712Service() {
        this(new Idea42712Config());
    }

    public Idea42712Service(Idea42712Config config) {
        this.config = config != null ? config : new Idea42712Config();
