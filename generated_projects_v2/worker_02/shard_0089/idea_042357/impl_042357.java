...
@Data
public class Idea42357Config {
    private String name = "idea_042357";
 ...
 */
@Slf4j
public class Idea42357Service {
    private static final int IDEA_ID = 42357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42357Service() {
        this(new Idea42357Config());
    }

    public Idea42357Service(Idea42357Config config) {
        this.config = config != null ? config : new Idea42357Config();
