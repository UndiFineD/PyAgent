...
@Data
public class Idea42452Config {
    private String name = "idea_042452";
 ...
 */
@Slf4j
public class Idea42452Service {
    private static final int IDEA_ID = 42452;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42452Service() {
        this(new Idea42452Config());
    }

    public Idea42452Service(Idea42452Config config) {
        this.config = config != null ? config : new Idea42452Config();
