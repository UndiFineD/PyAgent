...
@Data
public class Idea42642Config {
    private String name = "idea_042642";
 ...
 */
@Slf4j
public class Idea42642Service {
    private static final int IDEA_ID = 42642;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42642Service() {
        this(new Idea42642Config());
    }

    public Idea42642Service(Idea42642Config config) {
        this.config = config != null ? config : new Idea42642Config();
