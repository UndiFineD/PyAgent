...
@Data
public class Idea42588Config {
    private String name = "idea_042588";
 ...
 */
@Slf4j
public class Idea42588Service {
    private static final int IDEA_ID = 42588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42588Service() {
        this(new Idea42588Config());
    }

    public Idea42588Service(Idea42588Config config) {
        this.config = config != null ? config : new Idea42588Config();
