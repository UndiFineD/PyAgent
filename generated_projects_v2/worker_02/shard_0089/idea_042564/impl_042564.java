...
@Data
public class Idea42564Config {
    private String name = "idea_042564";
 ...
 */
@Slf4j
public class Idea42564Service {
    private static final int IDEA_ID = 42564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42564Service() {
        this(new Idea42564Config());
    }

    public Idea42564Service(Idea42564Config config) {
        this.config = config != null ? config : new Idea42564Config();
