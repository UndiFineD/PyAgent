...
@Data
public class Idea42399Config {
    private String name = "idea_042399";
 ...
 */
@Slf4j
public class Idea42399Service {
    private static final int IDEA_ID = 42399;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42399Service() {
        this(new Idea42399Config());
    }

    public Idea42399Service(Idea42399Config config) {
        this.config = config != null ? config : new Idea42399Config();
