...
@Data
public class Idea42472Config {
    private String name = "idea_042472";
 ...
 */
@Slf4j
public class Idea42472Service {
    private static final int IDEA_ID = 42472;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42472Service() {
        this(new Idea42472Config());
    }

    public Idea42472Service(Idea42472Config config) {
        this.config = config != null ? config : new Idea42472Config();
