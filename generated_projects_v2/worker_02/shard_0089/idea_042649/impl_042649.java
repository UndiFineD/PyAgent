...
@Data
public class Idea42649Config {
    private String name = "idea_042649";
 ...
 */
@Slf4j
public class Idea42649Service {
    private static final int IDEA_ID = 42649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42649Service() {
        this(new Idea42649Config());
    }

    public Idea42649Service(Idea42649Config config) {
        this.config = config != null ? config : new Idea42649Config();
