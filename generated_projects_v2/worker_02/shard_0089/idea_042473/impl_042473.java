...
@Data
public class Idea42473Config {
    private String name = "idea_042473";
 ...
 */
@Slf4j
public class Idea42473Service {
    private static final int IDEA_ID = 42473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42473Service() {
        this(new Idea42473Config());
    }

    public Idea42473Service(Idea42473Config config) {
        this.config = config != null ? config : new Idea42473Config();
