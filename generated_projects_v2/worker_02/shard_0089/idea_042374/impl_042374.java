...
@Data
public class Idea42374Config {
    private String name = "idea_042374";
 ...
 */
@Slf4j
public class Idea42374Service {
    private static final int IDEA_ID = 42374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42374Service() {
        this(new Idea42374Config());
    }

    public Idea42374Service(Idea42374Config config) {
        this.config = config != null ? config : new Idea42374Config();
