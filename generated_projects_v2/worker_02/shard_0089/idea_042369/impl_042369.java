...
@Data
public class Idea42369Config {
    private String name = "idea_042369";
 ...
 */
@Slf4j
public class Idea42369Service {
    private static final int IDEA_ID = 42369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42369Service() {
        this(new Idea42369Config());
    }

    public Idea42369Service(Idea42369Config config) {
        this.config = config != null ? config : new Idea42369Config();
