...
@Data
public class Idea42600Config {
    private String name = "idea_042600";
 ...
 */
@Slf4j
public class Idea42600Service {
    private static final int IDEA_ID = 42600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42600Service() {
        this(new Idea42600Config());
    }

    public Idea42600Service(Idea42600Config config) {
        this.config = config != null ? config : new Idea42600Config();
