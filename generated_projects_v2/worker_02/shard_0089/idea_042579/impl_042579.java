...
@Data
public class Idea42579Config {
    private String name = "idea_042579";
 ...
 */
@Slf4j
public class Idea42579Service {
    private static final int IDEA_ID = 42579;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42579Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42579Service() {
        this(new Idea42579Config());
    }

    public Idea42579Service(Idea42579Config config) {
        this.config = config != null ? config : new Idea42579Config();
