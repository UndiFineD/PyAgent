...
@Data
public class Idea42636Config {
    private String name = "idea_042636";
 ...
 */
@Slf4j
public class Idea42636Service {
    private static final int IDEA_ID = 42636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42636Service() {
        this(new Idea42636Config());
    }

    public Idea42636Service(Idea42636Config config) {
        this.config = config != null ? config : new Idea42636Config();
