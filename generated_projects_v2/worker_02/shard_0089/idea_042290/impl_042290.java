...
@Data
public class Idea42290Config {
    private String name = "idea_042290";
 ...
 */
@Slf4j
public class Idea42290Service {
    private static final int IDEA_ID = 42290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42290Service() {
        this(new Idea42290Config());
    }

    public Idea42290Service(Idea42290Config config) {
        this.config = config != null ? config : new Idea42290Config();
