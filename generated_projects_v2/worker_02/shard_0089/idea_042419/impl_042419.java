...
@Data
public class Idea42419Config {
    private String name = "idea_042419";
 ...
 */
@Slf4j
public class Idea42419Service {
    private static final int IDEA_ID = 42419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42419Service() {
        this(new Idea42419Config());
    }

    public Idea42419Service(Idea42419Config config) {
        this.config = config != null ? config : new Idea42419Config();
