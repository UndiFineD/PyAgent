...
@Data
public class Idea42298Config {
    private String name = "idea_042298";
 ...
 */
@Slf4j
public class Idea42298Service {
    private static final int IDEA_ID = 42298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42298Service() {
        this(new Idea42298Config());
    }

    public Idea42298Service(Idea42298Config config) {
        this.config = config != null ? config : new Idea42298Config();
