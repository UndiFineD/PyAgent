...
@Data
public class Idea42500Config {
    private String name = "idea_042500";
 ...
 */
@Slf4j
public class Idea42500Service {
    private static final int IDEA_ID = 42500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42500Service() {
        this(new Idea42500Config());
    }

    public Idea42500Service(Idea42500Config config) {
        this.config = config != null ? config : new Idea42500Config();
