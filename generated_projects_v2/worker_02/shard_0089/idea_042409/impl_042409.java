...
@Data
public class Idea42409Config {
    private String name = "idea_042409";
 ...
 */
@Slf4j
public class Idea42409Service {
    private static final int IDEA_ID = 42409;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42409Service() {
        this(new Idea42409Config());
    }

    public Idea42409Service(Idea42409Config config) {
        this.config = config != null ? config : new Idea42409Config();
