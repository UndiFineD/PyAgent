...
@Data
public class Idea42322Config {
    private String name = "idea_042322";
 ...
 */
@Slf4j
public class Idea42322Service {
    private static final int IDEA_ID = 42322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42322Service() {
        this(new Idea42322Config());
    }

    public Idea42322Service(Idea42322Config config) {
        this.config = config != null ? config : new Idea42322Config();
