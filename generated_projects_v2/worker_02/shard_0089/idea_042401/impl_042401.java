...
@Data
public class Idea42401Config {
    private String name = "idea_042401";
 ...
 */
@Slf4j
public class Idea42401Service {
    private static final int IDEA_ID = 42401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42401Service() {
        this(new Idea42401Config());
    }

    public Idea42401Service(Idea42401Config config) {
        this.config = config != null ? config : new Idea42401Config();
