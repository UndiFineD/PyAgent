...
@Data
public class Idea42614Config {
    private String name = "idea_042614";
 ...
 */
@Slf4j
public class Idea42614Service {
    private static final int IDEA_ID = 42614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42614Service() {
        this(new Idea42614Config());
    }

    public Idea42614Service(Idea42614Config config) {
        this.config = config != null ? config : new Idea42614Config();
