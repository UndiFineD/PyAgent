...
@Data
public class Idea42659Config {
    private String name = "idea_042659";
 ...
 */
@Slf4j
public class Idea42659Service {
    private static final int IDEA_ID = 42659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42659Service() {
        this(new Idea42659Config());
    }

    public Idea42659Service(Idea42659Config config) {
        this.config = config != null ? config : new Idea42659Config();
