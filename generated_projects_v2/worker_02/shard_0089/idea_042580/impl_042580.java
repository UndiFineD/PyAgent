...
@Data
public class Idea42580Config {
    private String name = "idea_042580";
 ...
 */
@Slf4j
public class Idea42580Service {
    private static final int IDEA_ID = 42580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42580Service() {
        this(new Idea42580Config());
    }

    public Idea42580Service(Idea42580Config config) {
        this.config = config != null ? config : new Idea42580Config();
