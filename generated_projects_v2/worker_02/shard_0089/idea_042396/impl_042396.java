...
@Data
public class Idea42396Config {
    private String name = "idea_042396";
 ...
 */
@Slf4j
public class Idea42396Service {
    private static final int IDEA_ID = 42396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42396Service() {
        this(new Idea42396Config());
    }

    public Idea42396Service(Idea42396Config config) {
        this.config = config != null ? config : new Idea42396Config();
