...
@Data
public class Idea42745Config {
    private String name = "idea_042745";
 ...
 */
@Slf4j
public class Idea42745Service {
    private static final int IDEA_ID = 42745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42745Service() {
        this(new Idea42745Config());
    }

    public Idea42745Service(Idea42745Config config) {
        this.config = config != null ? config : new Idea42745Config();
