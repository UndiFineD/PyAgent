...
@Data
public class Idea42384Config {
    private String name = "idea_042384";
 ...
 */
@Slf4j
public class Idea42384Service {
    private static final int IDEA_ID = 42384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42384Service() {
        this(new Idea42384Config());
    }

    public Idea42384Service(Idea42384Config config) {
        this.config = config != null ? config : new Idea42384Config();
