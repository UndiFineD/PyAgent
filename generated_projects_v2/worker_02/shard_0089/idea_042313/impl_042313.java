...
@Data
public class Idea42313Config {
    private String name = "idea_042313";
 ...
 */
@Slf4j
public class Idea42313Service {
    private static final int IDEA_ID = 42313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42313Service() {
        this(new Idea42313Config());
    }

    public Idea42313Service(Idea42313Config config) {
        this.config = config != null ? config : new Idea42313Config();
