...
@Data
public class Idea42480Config {
    private String name = "idea_042480";
 ...
 */
@Slf4j
public class Idea42480Service {
    private static final int IDEA_ID = 42480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42480Service() {
        this(new Idea42480Config());
    }

    public Idea42480Service(Idea42480Config config) {
        this.config = config != null ? config : new Idea42480Config();
