...
@Data
public class Idea42562Config {
    private String name = "idea_042562";
 ...
 */
@Slf4j
public class Idea42562Service {
    private static final int IDEA_ID = 42562;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42562Service() {
        this(new Idea42562Config());
    }

    public Idea42562Service(Idea42562Config config) {
        this.config = config != null ? config : new Idea42562Config();
