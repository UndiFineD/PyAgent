...
@Data
public class Idea42411Config {
    private String name = "idea_042411";
 ...
 */
@Slf4j
public class Idea42411Service {
    private static final int IDEA_ID = 42411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42411Service() {
        this(new Idea42411Config());
    }

    public Idea42411Service(Idea42411Config config) {
        this.config = config != null ? config : new Idea42411Config();
