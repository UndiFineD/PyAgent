...
@Data
public class Idea42477Config {
    private String name = "idea_042477";
 ...
 */
@Slf4j
public class Idea42477Service {
    private static final int IDEA_ID = 42477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42477Service() {
        this(new Idea42477Config());
    }

    public Idea42477Service(Idea42477Config config) {
        this.config = config != null ? config : new Idea42477Config();
