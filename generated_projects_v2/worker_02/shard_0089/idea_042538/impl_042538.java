...
@Data
public class Idea42538Config {
    private String name = "idea_042538";
 ...
 */
@Slf4j
public class Idea42538Service {
    private static final int IDEA_ID = 42538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42538Service() {
        this(new Idea42538Config());
    }

    public Idea42538Service(Idea42538Config config) {
        this.config = config != null ? config : new Idea42538Config();
