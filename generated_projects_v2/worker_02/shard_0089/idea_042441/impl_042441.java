...
@Data
public class Idea42441Config {
    private String name = "idea_042441";
 ...
 */
@Slf4j
public class Idea42441Service {
    private static final int IDEA_ID = 42441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42441Service() {
        this(new Idea42441Config());
    }

    public Idea42441Service(Idea42441Config config) {
        this.config = config != null ? config : new Idea42441Config();
