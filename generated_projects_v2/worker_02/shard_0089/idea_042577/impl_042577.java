...
@Data
public class Idea42577Config {
    private String name = "idea_042577";
 ...
 */
@Slf4j
public class Idea42577Service {
    private static final int IDEA_ID = 42577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42577Service() {
        this(new Idea42577Config());
    }

    public Idea42577Service(Idea42577Config config) {
        this.config = config != null ? config : new Idea42577Config();
