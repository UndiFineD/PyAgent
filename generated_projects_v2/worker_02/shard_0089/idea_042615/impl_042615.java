...
@Data
public class Idea42615Config {
    private String name = "idea_042615";
 ...
 */
@Slf4j
public class Idea42615Service {
    private static final int IDEA_ID = 42615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42615Service() {
        this(new Idea42615Config());
    }

    public Idea42615Service(Idea42615Config config) {
        this.config = config != null ? config : new Idea42615Config();
