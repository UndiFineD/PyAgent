...
@Data
public class Idea42643Config {
    private String name = "idea_042643";
 ...
 */
@Slf4j
public class Idea42643Service {
    private static final int IDEA_ID = 42643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42643Service() {
        this(new Idea42643Config());
    }

    public Idea42643Service(Idea42643Config config) {
        this.config = config != null ? config : new Idea42643Config();
