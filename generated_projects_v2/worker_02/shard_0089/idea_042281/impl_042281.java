...
@Data
public class Idea42281Config {
    private String name = "idea_042281";
 ...
 */
@Slf4j
public class Idea42281Service {
    private static final int IDEA_ID = 42281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42281Service() {
        this(new Idea42281Config());
    }

    public Idea42281Service(Idea42281Config config) {
        this.config = config != null ? config : new Idea42281Config();
