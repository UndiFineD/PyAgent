...
@Data
public class Idea42572Config {
    private String name = "idea_042572";
 ...
 */
@Slf4j
public class Idea42572Service {
    private static final int IDEA_ID = 42572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42572Service() {
        this(new Idea42572Config());
    }

    public Idea42572Service(Idea42572Config config) {
        this.config = config != null ? config : new Idea42572Config();
