...
@Data
public class Idea42335Config {
    private String name = "idea_042335";
 ...
 */
@Slf4j
public class Idea42335Service {
    private static final int IDEA_ID = 42335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42335Service() {
        this(new Idea42335Config());
    }

    public Idea42335Service(Idea42335Config config) {
        this.config = config != null ? config : new Idea42335Config();
