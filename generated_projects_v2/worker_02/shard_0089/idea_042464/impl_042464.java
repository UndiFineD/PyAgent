...
@Data
public class Idea42464Config {
    private String name = "idea_042464";
 ...
 */
@Slf4j
public class Idea42464Service {
    private static final int IDEA_ID = 42464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42464Service() {
        this(new Idea42464Config());
    }

    public Idea42464Service(Idea42464Config config) {
        this.config = config != null ? config : new Idea42464Config();
