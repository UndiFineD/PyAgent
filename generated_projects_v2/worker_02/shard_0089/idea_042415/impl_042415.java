...
@Data
public class Idea42415Config {
    private String name = "idea_042415";
 ...
 */
@Slf4j
public class Idea42415Service {
    private static final int IDEA_ID = 42415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42415Service() {
        this(new Idea42415Config());
    }

    public Idea42415Service(Idea42415Config config) {
        this.config = config != null ? config : new Idea42415Config();
