...
@Data
public class Idea42312Config {
    private String name = "idea_042312";
 ...
 */
@Slf4j
public class Idea42312Service {
    private static final int IDEA_ID = 42312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42312Service() {
        this(new Idea42312Config());
    }

    public Idea42312Service(Idea42312Config config) {
        this.config = config != null ? config : new Idea42312Config();
