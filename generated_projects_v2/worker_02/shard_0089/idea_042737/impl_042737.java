...
@Data
public class Idea42737Config {
    private String name = "idea_042737";
 ...
 */
@Slf4j
public class Idea42737Service {
    private static final int IDEA_ID = 42737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42737Service() {
        this(new Idea42737Config());
    }

    public Idea42737Service(Idea42737Config config) {
        this.config = config != null ? config : new Idea42737Config();
