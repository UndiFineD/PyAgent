...
@Data
public class Idea42481Config {
    private String name = "idea_042481";
 ...
 */
@Slf4j
public class Idea42481Service {
    private static final int IDEA_ID = 42481;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42481Service() {
        this(new Idea42481Config());
    }

    public Idea42481Service(Idea42481Config config) {
        this.config = config != null ? config : new Idea42481Config();
