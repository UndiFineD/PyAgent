...
@Data
public class Idea42730Config {
    private String name = "idea_042730";
 ...
 */
@Slf4j
public class Idea42730Service {
    private static final int IDEA_ID = 42730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42730Service() {
        this(new Idea42730Config());
    }

    public Idea42730Service(Idea42730Config config) {
        this.config = config != null ? config : new Idea42730Config();
