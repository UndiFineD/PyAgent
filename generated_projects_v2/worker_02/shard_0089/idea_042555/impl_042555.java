...
@Data
public class Idea42555Config {
    private String name = "idea_042555";
 ...
 */
@Slf4j
public class Idea42555Service {
    private static final int IDEA_ID = 42555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42555Service() {
        this(new Idea42555Config());
    }

    public Idea42555Service(Idea42555Config config) {
        this.config = config != null ? config : new Idea42555Config();
