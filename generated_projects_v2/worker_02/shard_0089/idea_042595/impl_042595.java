...
@Data
public class Idea42595Config {
    private String name = "idea_042595";
 ...
 */
@Slf4j
public class Idea42595Service {
    private static final int IDEA_ID = 42595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42595Service() {
        this(new Idea42595Config());
    }

    public Idea42595Service(Idea42595Config config) {
        this.config = config != null ? config : new Idea42595Config();
