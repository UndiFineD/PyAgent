...
@Data
public class Idea42570Config {
    private String name = "idea_042570";
 ...
 */
@Slf4j
public class Idea42570Service {
    private static final int IDEA_ID = 42570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42570Service() {
        this(new Idea42570Config());
    }

    public Idea42570Service(Idea42570Config config) {
        this.config = config != null ? config : new Idea42570Config();
