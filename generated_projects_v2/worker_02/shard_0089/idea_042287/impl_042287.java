...
@Data
public class Idea42287Config {
    private String name = "idea_042287";
 ...
 */
@Slf4j
public class Idea42287Service {
    private static final int IDEA_ID = 42287;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42287Service() {
        this(new Idea42287Config());
    }

    public Idea42287Service(Idea42287Config config) {
        this.config = config != null ? config : new Idea42287Config();
