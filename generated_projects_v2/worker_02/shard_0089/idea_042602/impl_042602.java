...
@Data
public class Idea42602Config {
    private String name = "idea_042602";
 ...
 */
@Slf4j
public class Idea42602Service {
    private static final int IDEA_ID = 42602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42602Service() {
        this(new Idea42602Config());
    }

    public Idea42602Service(Idea42602Config config) {
        this.config = config != null ? config : new Idea42602Config();
