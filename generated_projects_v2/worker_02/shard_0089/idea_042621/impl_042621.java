...
@Data
public class Idea42621Config {
    private String name = "idea_042621";
 ...
 */
@Slf4j
public class Idea42621Service {
    private static final int IDEA_ID = 42621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42621Service() {
        this(new Idea42621Config());
    }

    public Idea42621Service(Idea42621Config config) {
        this.config = config != null ? config : new Idea42621Config();
