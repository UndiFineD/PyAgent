...
@Data
public class Idea42362Config {
    private String name = "idea_042362";
 ...
 */
@Slf4j
public class Idea42362Service {
    private static final int IDEA_ID = 42362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42362Service() {
        this(new Idea42362Config());
    }

    public Idea42362Service(Idea42362Config config) {
        this.config = config != null ? config : new Idea42362Config();
