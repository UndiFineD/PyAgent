...
@Data
public class Idea42410Config {
    private String name = "idea_042410";
 ...
 */
@Slf4j
public class Idea42410Service {
    private static final int IDEA_ID = 42410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42410Service() {
        this(new Idea42410Config());
    }

    public Idea42410Service(Idea42410Config config) {
        this.config = config != null ? config : new Idea42410Config();
