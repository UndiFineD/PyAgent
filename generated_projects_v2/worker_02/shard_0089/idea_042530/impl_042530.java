...
@Data
public class Idea42530Config {
    private String name = "idea_042530";
 ...
 */
@Slf4j
public class Idea42530Service {
    private static final int IDEA_ID = 42530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42530Service() {
        this(new Idea42530Config());
    }

    public Idea42530Service(Idea42530Config config) {
        this.config = config != null ? config : new Idea42530Config();
