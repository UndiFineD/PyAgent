...
@Data
public class Idea42708Config {
    private String name = "idea_042708";
 ...
 */
@Slf4j
public class Idea42708Service {
    private static final int IDEA_ID = 42708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42708Service() {
        this(new Idea42708Config());
    }

    public Idea42708Service(Idea42708Config config) {
        this.config = config != null ? config : new Idea42708Config();
