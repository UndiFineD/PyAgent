...
@Data
public class Idea42478Config {
    private String name = "idea_042478";
 ...
 */
@Slf4j
public class Idea42478Service {
    private static final int IDEA_ID = 42478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42478Service() {
        this(new Idea42478Config());
    }

    public Idea42478Service(Idea42478Config config) {
        this.config = config != null ? config : new Idea42478Config();
