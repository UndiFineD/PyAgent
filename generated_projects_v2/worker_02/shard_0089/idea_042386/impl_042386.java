...
@Data
public class Idea42386Config {
    private String name = "idea_042386";
 ...
 */
@Slf4j
public class Idea42386Service {
    private static final int IDEA_ID = 42386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42386Service() {
        this(new Idea42386Config());
    }

    public Idea42386Service(Idea42386Config config) {
        this.config = config != null ? config : new Idea42386Config();
