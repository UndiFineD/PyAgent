...
@Data
public class Idea42590Config {
    private String name = "idea_042590";
 ...
 */
@Slf4j
public class Idea42590Service {
    private static final int IDEA_ID = 42590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42590Service() {
        this(new Idea42590Config());
    }

    public Idea42590Service(Idea42590Config config) {
        this.config = config != null ? config : new Idea42590Config();
