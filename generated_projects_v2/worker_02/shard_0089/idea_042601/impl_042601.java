...
@Data
public class Idea42601Config {
    private String name = "idea_042601";
 ...
 */
@Slf4j
public class Idea42601Service {
    private static final int IDEA_ID = 42601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42601Service() {
        this(new Idea42601Config());
    }

    public Idea42601Service(Idea42601Config config) {
        this.config = config != null ? config : new Idea42601Config();
