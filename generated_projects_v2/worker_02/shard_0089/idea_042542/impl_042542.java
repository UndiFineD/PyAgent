...
@Data
public class Idea42542Config {
    private String name = "idea_042542";
 ...
 */
@Slf4j
public class Idea42542Service {
    private static final int IDEA_ID = 42542;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42542Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42542Service() {
        this(new Idea42542Config());
    }

    public Idea42542Service(Idea42542Config config) {
        this.config = config != null ? config : new Idea42542Config();
