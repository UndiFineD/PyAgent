...
@Data
public class Idea42682Config {
    private String name = "idea_042682";
 ...
 */
@Slf4j
public class Idea42682Service {
    private static final int IDEA_ID = 42682;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42682Service() {
        this(new Idea42682Config());
    }

    public Idea42682Service(Idea42682Config config) {
        this.config = config != null ? config : new Idea42682Config();
