...
@Data
public class Idea42428Config {
    private String name = "idea_042428";
 ...
 */
@Slf4j
public class Idea42428Service {
    private static final int IDEA_ID = 42428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42428Service() {
        this(new Idea42428Config());
    }

    public Idea42428Service(Idea42428Config config) {
        this.config = config != null ? config : new Idea42428Config();
