...
@Data
public class Idea42534Config {
    private String name = "idea_042534";
 ...
 */
@Slf4j
public class Idea42534Service {
    private static final int IDEA_ID = 42534;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42534Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42534Service() {
        this(new Idea42534Config());
    }

    public Idea42534Service(Idea42534Config config) {
        this.config = config != null ? config : new Idea42534Config();
