...
@Data
public class Idea42420Config {
    private String name = "idea_042420";
 ...
 */
@Slf4j
public class Idea42420Service {
    private static final int IDEA_ID = 42420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42420Service() {
        this(new Idea42420Config());
    }

    public Idea42420Service(Idea42420Config config) {
        this.config = config != null ? config : new Idea42420Config();
