...
@Data
public class Idea42387Config {
    private String name = "idea_042387";
 ...
 */
@Slf4j
public class Idea42387Service {
    private static final int IDEA_ID = 42387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42387Service() {
        this(new Idea42387Config());
    }

    public Idea42387Service(Idea42387Config config) {
        this.config = config != null ? config : new Idea42387Config();
