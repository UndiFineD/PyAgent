...
@Data
public class Idea42633Config {
    private String name = "idea_042633";
 ...
 */
@Slf4j
public class Idea42633Service {
    private static final int IDEA_ID = 42633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42633Service() {
        this(new Idea42633Config());
    }

    public Idea42633Service(Idea42633Config config) {
        this.config = config != null ? config : new Idea42633Config();
