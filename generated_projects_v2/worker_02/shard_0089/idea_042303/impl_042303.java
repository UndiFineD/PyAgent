...
@Data
public class Idea42303Config {
    private String name = "idea_042303";
 ...
 */
@Slf4j
public class Idea42303Service {
    private static final int IDEA_ID = 42303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42303Service() {
        this(new Idea42303Config());
    }

    public Idea42303Service(Idea42303Config config) {
        this.config = config != null ? config : new Idea42303Config();
