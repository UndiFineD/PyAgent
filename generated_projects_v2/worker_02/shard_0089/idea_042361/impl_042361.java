...
@Data
public class Idea42361Config {
    private String name = "idea_042361";
 ...
 */
@Slf4j
public class Idea42361Service {
    private static final int IDEA_ID = 42361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42361Service() {
        this(new Idea42361Config());
    }

    public Idea42361Service(Idea42361Config config) {
        this.config = config != null ? config : new Idea42361Config();
