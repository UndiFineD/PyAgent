...
@Data
public class Idea42576Config {
    private String name = "idea_042576";
 ...
 */
@Slf4j
public class Idea42576Service {
    private static final int IDEA_ID = 42576;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42576Service() {
        this(new Idea42576Config());
    }

    public Idea42576Service(Idea42576Config config) {
        this.config = config != null ? config : new Idea42576Config();
