...
@Data
public class Idea42466Config {
    private String name = "idea_042466";
 ...
 */
@Slf4j
public class Idea42466Service {
    private static final int IDEA_ID = 42466;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42466Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42466Service() {
        this(new Idea42466Config());
    }

    public Idea42466Service(Idea42466Config config) {
        this.config = config != null ? config : new Idea42466Config();
