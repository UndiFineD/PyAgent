...
@Data
public class Idea42296Config {
    private String name = "idea_042296";
 ...
 */
@Slf4j
public class Idea42296Service {
    private static final int IDEA_ID = 42296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42296Service() {
        this(new Idea42296Config());
    }

    public Idea42296Service(Idea42296Config config) {
        this.config = config != null ? config : new Idea42296Config();
