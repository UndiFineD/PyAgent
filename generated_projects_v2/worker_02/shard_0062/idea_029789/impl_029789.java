...
@Data
public class Idea29789Config {
    private String name = "idea_029789";
 ...
 */
@Slf4j
public class Idea29789Service {
    private static final int IDEA_ID = 29789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29789Service() {
        this(new Idea29789Config());
    }

    public Idea29789Service(Idea29789Config config) {
        this.config = config != null ? config : new Idea29789Config();
