...
@Data
public class Idea29835Config {
    private String name = "idea_029835";
 ...
 */
@Slf4j
public class Idea29835Service {
    private static final int IDEA_ID = 29835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29835Service() {
        this(new Idea29835Config());
    }

    public Idea29835Service(Idea29835Config config) {
        this.config = config != null ? config : new Idea29835Config();
