...
@Data
public class Idea29622Config {
    private String name = "idea_029622";
 ...
 */
@Slf4j
public class Idea29622Service {
    private static final int IDEA_ID = 29622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29622Service() {
        this(new Idea29622Config());
    }

    public Idea29622Service(Idea29622Config config) {
        this.config = config != null ? config : new Idea29622Config();
