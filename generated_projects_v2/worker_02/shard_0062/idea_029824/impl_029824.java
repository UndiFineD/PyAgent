...
@Data
public class Idea29824Config {
    private String name = "idea_029824";
 ...
 */
@Slf4j
public class Idea29824Service {
    private static final int IDEA_ID = 29824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29824Service() {
        this(new Idea29824Config());
    }

    public Idea29824Service(Idea29824Config config) {
        this.config = config != null ? config : new Idea29824Config();
