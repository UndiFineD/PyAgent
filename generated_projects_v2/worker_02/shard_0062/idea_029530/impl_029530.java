...
@Data
public class Idea29530Config {
    private String name = "idea_029530";
 ...
 */
@Slf4j
public class Idea29530Service {
    private static final int IDEA_ID = 29530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29530Service() {
        this(new Idea29530Config());
    }

    public Idea29530Service(Idea29530Config config) {
        this.config = config != null ? config : new Idea29530Config();
