...
@Data
public class Idea29583Config {
    private String name = "idea_029583";
 ...
 */
@Slf4j
public class Idea29583Service {
    private static final int IDEA_ID = 29583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29583Service() {
        this(new Idea29583Config());
    }

    public Idea29583Service(Idea29583Config config) {
        this.config = config != null ? config : new Idea29583Config();
