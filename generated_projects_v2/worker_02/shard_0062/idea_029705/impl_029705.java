...
@Data
public class Idea29705Config {
    private String name = "idea_029705";
 ...
 */
@Slf4j
public class Idea29705Service {
    private static final int IDEA_ID = 29705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29705Service() {
        this(new Idea29705Config());
    }

    public Idea29705Service(Idea29705Config config) {
        this.config = config != null ? config : new Idea29705Config();
