...
@Data
public class Idea29501Config {
    private String name = "idea_029501";
 ...
 */
@Slf4j
public class Idea29501Service {
    private static final int IDEA_ID = 29501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29501Service() {
        this(new Idea29501Config());
    }

    public Idea29501Service(Idea29501Config config) {
        this.config = config != null ? config : new Idea29501Config();
