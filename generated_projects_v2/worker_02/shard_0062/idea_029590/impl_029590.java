...
@Data
public class Idea29590Config {
    private String name = "idea_029590";
 ...
 */
@Slf4j
public class Idea29590Service {
    private static final int IDEA_ID = 29590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29590Service() {
        this(new Idea29590Config());
    }

    public Idea29590Service(Idea29590Config config) {
        this.config = config != null ? config : new Idea29590Config();
