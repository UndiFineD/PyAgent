...
@Data
public class Idea29510Config {
    private String name = "idea_029510";
 ...
 */
@Slf4j
public class Idea29510Service {
    private static final int IDEA_ID = 29510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29510Service() {
        this(new Idea29510Config());
    }

    public Idea29510Service(Idea29510Config config) {
        this.config = config != null ? config : new Idea29510Config();
