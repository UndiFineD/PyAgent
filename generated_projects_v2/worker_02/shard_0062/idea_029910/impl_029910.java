...
@Data
public class Idea29910Config {
    private String name = "idea_029910";
 ...
 */
@Slf4j
public class Idea29910Service {
    private static final int IDEA_ID = 29910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29910Service() {
        this(new Idea29910Config());
    }

    public Idea29910Service(Idea29910Config config) {
        this.config = config != null ? config : new Idea29910Config();
