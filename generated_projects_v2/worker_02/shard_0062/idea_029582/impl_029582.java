...
@Data
public class Idea29582Config {
    private String name = "idea_029582";
 ...
 */
@Slf4j
public class Idea29582Service {
    private static final int IDEA_ID = 29582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29582Service() {
        this(new Idea29582Config());
    }

    public Idea29582Service(Idea29582Config config) {
        this.config = config != null ? config : new Idea29582Config();
