...
@Data
public class Idea29666Config {
    private String name = "idea_029666";
 ...
 */
@Slf4j
public class Idea29666Service {
    private static final int IDEA_ID = 29666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29666Service() {
        this(new Idea29666Config());
    }

    public Idea29666Service(Idea29666Config config) {
        this.config = config != null ? config : new Idea29666Config();
