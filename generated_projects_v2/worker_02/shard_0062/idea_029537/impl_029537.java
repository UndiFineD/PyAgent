...
@Data
public class Idea29537Config {
    private String name = "idea_029537";
 ...
 */
@Slf4j
public class Idea29537Service {
    private static final int IDEA_ID = 29537;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29537Service() {
        this(new Idea29537Config());
    }

    public Idea29537Service(Idea29537Config config) {
        this.config = config != null ? config : new Idea29537Config();
