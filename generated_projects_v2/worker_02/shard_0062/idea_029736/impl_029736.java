...
@Data
public class Idea29736Config {
    private String name = "idea_029736";
 ...
 */
@Slf4j
public class Idea29736Service {
    private static final int IDEA_ID = 29736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29736Service() {
        this(new Idea29736Config());
    }

    public Idea29736Service(Idea29736Config config) {
        this.config = config != null ? config : new Idea29736Config();
