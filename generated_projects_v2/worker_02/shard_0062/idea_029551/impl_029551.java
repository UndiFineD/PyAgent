...
@Data
public class Idea29551Config {
    private String name = "idea_029551";
 ...
 */
@Slf4j
public class Idea29551Service {
    private static final int IDEA_ID = 29551;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29551Service() {
        this(new Idea29551Config());
    }

    public Idea29551Service(Idea29551Config config) {
        this.config = config != null ? config : new Idea29551Config();
