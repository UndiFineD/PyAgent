...
@Data
public class Idea29564Config {
    private String name = "idea_029564";
 ...
 */
@Slf4j
public class Idea29564Service {
    private static final int IDEA_ID = 29564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29564Service() {
        this(new Idea29564Config());
    }

    public Idea29564Service(Idea29564Config config) {
        this.config = config != null ? config : new Idea29564Config();
