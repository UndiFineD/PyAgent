...
@Data
public class Idea29924Config {
    private String name = "idea_029924";
 ...
 */
@Slf4j
public class Idea29924Service {
    private static final int IDEA_ID = 29924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29924Service() {
        this(new Idea29924Config());
    }

    public Idea29924Service(Idea29924Config config) {
        this.config = config != null ? config : new Idea29924Config();
