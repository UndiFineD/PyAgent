...
@Data
public class Idea29644Config {
    private String name = "idea_029644";
 ...
 */
@Slf4j
public class Idea29644Service {
    private static final int IDEA_ID = 29644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29644Service() {
        this(new Idea29644Config());
    }

    public Idea29644Service(Idea29644Config config) {
        this.config = config != null ? config : new Idea29644Config();
