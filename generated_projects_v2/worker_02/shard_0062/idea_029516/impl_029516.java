...
@Data
public class Idea29516Config {
    private String name = "idea_029516";
 ...
 */
@Slf4j
public class Idea29516Service {
    private static final int IDEA_ID = 29516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29516Service() {
        this(new Idea29516Config());
    }

    public Idea29516Service(Idea29516Config config) {
        this.config = config != null ? config : new Idea29516Config();
