...
@Data
public class Idea29471Config {
    private String name = "idea_029471";
 ...
 */
@Slf4j
public class Idea29471Service {
    private static final int IDEA_ID = 29471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29471Service() {
        this(new Idea29471Config());
    }

    public Idea29471Service(Idea29471Config config) {
        this.config = config != null ? config : new Idea29471Config();
