...
@Data
public class Idea29573Config {
    private String name = "idea_029573";
 ...
 */
@Slf4j
public class Idea29573Service {
    private static final int IDEA_ID = 29573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29573Service() {
        this(new Idea29573Config());
    }

    public Idea29573Service(Idea29573Config config) {
        this.config = config != null ? config : new Idea29573Config();
