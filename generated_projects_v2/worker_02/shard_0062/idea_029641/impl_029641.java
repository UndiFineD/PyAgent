...
@Data
public class Idea29641Config {
    private String name = "idea_029641";
 ...
 */
@Slf4j
public class Idea29641Service {
    private static final int IDEA_ID = 29641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29641Service() {
        this(new Idea29641Config());
    }

    public Idea29641Service(Idea29641Config config) {
        this.config = config != null ? config : new Idea29641Config();
