...
@Data
public class Idea29660Config {
    private String name = "idea_029660";
 ...
 */
@Slf4j
public class Idea29660Service {
    private static final int IDEA_ID = 29660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29660Service() {
        this(new Idea29660Config());
    }

    public Idea29660Service(Idea29660Config config) {
        this.config = config != null ? config : new Idea29660Config();
