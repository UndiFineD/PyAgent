...
@Data
public class Idea29698Config {
    private String name = "idea_029698";
 ...
 */
@Slf4j
public class Idea29698Service {
    private static final int IDEA_ID = 29698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29698Service() {
        this(new Idea29698Config());
    }

    public Idea29698Service(Idea29698Config config) {
        this.config = config != null ? config : new Idea29698Config();
