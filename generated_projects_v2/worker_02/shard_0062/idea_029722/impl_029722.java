...
@Data
public class Idea29722Config {
    private String name = "idea_029722";
 ...
 */
@Slf4j
public class Idea29722Service {
    private static final int IDEA_ID = 29722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29722Service() {
        this(new Idea29722Config());
    }

    public Idea29722Service(Idea29722Config config) {
        this.config = config != null ? config : new Idea29722Config();
