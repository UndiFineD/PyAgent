...
@Data
public class Idea29796Config {
    private String name = "idea_029796";
 ...
 */
@Slf4j
public class Idea29796Service {
    private static final int IDEA_ID = 29796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29796Service() {
        this(new Idea29796Config());
    }

    public Idea29796Service(Idea29796Config config) {
        this.config = config != null ? config : new Idea29796Config();
