...
@Data
public class Idea29801Config {
    private String name = "idea_029801";
 ...
 */
@Slf4j
public class Idea29801Service {
    private static final int IDEA_ID = 29801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29801Service() {
        this(new Idea29801Config());
    }

    public Idea29801Service(Idea29801Config config) {
        this.config = config != null ? config : new Idea29801Config();
