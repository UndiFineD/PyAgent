...
@Data
public class Idea29478Config {
    private String name = "idea_029478";
 ...
 */
@Slf4j
public class Idea29478Service {
    private static final int IDEA_ID = 29478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29478Service() {
        this(new Idea29478Config());
    }

    public Idea29478Service(Idea29478Config config) {
        this.config = config != null ? config : new Idea29478Config();
