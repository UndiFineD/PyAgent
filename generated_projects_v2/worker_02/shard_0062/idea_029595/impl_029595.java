...
@Data
public class Idea29595Config {
    private String name = "idea_029595";
 ...
 */
@Slf4j
public class Idea29595Service {
    private static final int IDEA_ID = 29595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29595Service() {
        this(new Idea29595Config());
    }

    public Idea29595Service(Idea29595Config config) {
        this.config = config != null ? config : new Idea29595Config();
