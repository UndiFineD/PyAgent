...
@Data
public class Idea29651Config {
    private String name = "idea_029651";
 ...
 */
@Slf4j
public class Idea29651Service {
    private static final int IDEA_ID = 29651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29651Service() {
        this(new Idea29651Config());
    }

    public Idea29651Service(Idea29651Config config) {
        this.config = config != null ? config : new Idea29651Config();
