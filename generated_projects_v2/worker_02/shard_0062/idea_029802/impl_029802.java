...
@Data
public class Idea29802Config {
    private String name = "idea_029802";
 ...
 */
@Slf4j
public class Idea29802Service {
    private static final int IDEA_ID = 29802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29802Service() {
        this(new Idea29802Config());
    }

    public Idea29802Service(Idea29802Config config) {
        this.config = config != null ? config : new Idea29802Config();
