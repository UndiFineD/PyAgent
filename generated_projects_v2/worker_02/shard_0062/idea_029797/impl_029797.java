...
@Data
public class Idea29797Config {
    private String name = "idea_029797";
 ...
 */
@Slf4j
public class Idea29797Service {
    private static final int IDEA_ID = 29797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29797Service() {
        this(new Idea29797Config());
    }

    public Idea29797Service(Idea29797Config config) {
        this.config = config != null ? config : new Idea29797Config();
