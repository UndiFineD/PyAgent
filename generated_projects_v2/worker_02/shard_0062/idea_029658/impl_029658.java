...
@Data
public class Idea29658Config {
    private String name = "idea_029658";
 ...
 */
@Slf4j
public class Idea29658Service {
    private static final int IDEA_ID = 29658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29658Service() {
        this(new Idea29658Config());
    }

    public Idea29658Service(Idea29658Config config) {
        this.config = config != null ? config : new Idea29658Config();
