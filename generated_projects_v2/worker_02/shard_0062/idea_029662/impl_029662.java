...
@Data
public class Idea29662Config {
    private String name = "idea_029662";
 ...
 */
@Slf4j
public class Idea29662Service {
    private static final int IDEA_ID = 29662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29662Service() {
        this(new Idea29662Config());
    }

    public Idea29662Service(Idea29662Config config) {
        this.config = config != null ? config : new Idea29662Config();
