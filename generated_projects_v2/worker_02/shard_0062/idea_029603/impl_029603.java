...
@Data
public class Idea29603Config {
    private String name = "idea_029603";
 ...
 */
@Slf4j
public class Idea29603Service {
    private static final int IDEA_ID = 29603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29603Service() {
        this(new Idea29603Config());
    }

    public Idea29603Service(Idea29603Config config) {
        this.config = config != null ? config : new Idea29603Config();
