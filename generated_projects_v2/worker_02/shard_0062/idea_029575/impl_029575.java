...
@Data
public class Idea29575Config {
    private String name = "idea_029575";
 ...
 */
@Slf4j
public class Idea29575Service {
    private static final int IDEA_ID = 29575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29575Service() {
        this(new Idea29575Config());
    }

    public Idea29575Service(Idea29575Config config) {
        this.config = config != null ? config : new Idea29575Config();
