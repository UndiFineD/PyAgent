...
@Data
public class Idea29754Config {
    private String name = "idea_029754";
 ...
 */
@Slf4j
public class Idea29754Service {
    private static final int IDEA_ID = 29754;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29754Service() {
        this(new Idea29754Config());
    }

    public Idea29754Service(Idea29754Config config) {
        this.config = config != null ? config : new Idea29754Config();
