...
@Data
public class Idea29803Config {
    private String name = "idea_029803";
 ...
 */
@Slf4j
public class Idea29803Service {
    private static final int IDEA_ID = 29803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29803Service() {
        this(new Idea29803Config());
    }

    public Idea29803Service(Idea29803Config config) {
        this.config = config != null ? config : new Idea29803Config();
