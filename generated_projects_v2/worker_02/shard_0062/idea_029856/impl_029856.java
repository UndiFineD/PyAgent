...
@Data
public class Idea29856Config {
    private String name = "idea_029856";
 ...
 */
@Slf4j
public class Idea29856Service {
    private static final int IDEA_ID = 29856;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29856Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29856Service() {
        this(new Idea29856Config());
    }

    public Idea29856Service(Idea29856Config config) {
        this.config = config != null ? config : new Idea29856Config();
