...
@Data
public class Idea29612Config {
    private String name = "idea_029612";
 ...
 */
@Slf4j
public class Idea29612Service {
    private static final int IDEA_ID = 29612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29612Service() {
        this(new Idea29612Config());
    }

    public Idea29612Service(Idea29612Config config) {
        this.config = config != null ? config : new Idea29612Config();
