...
@Data
public class Idea29807Config {
    private String name = "idea_029807";
 ...
 */
@Slf4j
public class Idea29807Service {
    private static final int IDEA_ID = 29807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29807Service() {
        this(new Idea29807Config());
    }

    public Idea29807Service(Idea29807Config config) {
        this.config = config != null ? config : new Idea29807Config();
