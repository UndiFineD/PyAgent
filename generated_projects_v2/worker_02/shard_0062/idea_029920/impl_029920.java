...
@Data
public class Idea29920Config {
    private String name = "idea_029920";
 ...
 */
@Slf4j
public class Idea29920Service {
    private static final int IDEA_ID = 29920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29920Service() {
        this(new Idea29920Config());
    }

    public Idea29920Service(Idea29920Config config) {
        this.config = config != null ? config : new Idea29920Config();
