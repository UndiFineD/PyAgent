...
@Data
public class Idea29608Config {
    private String name = "idea_029608";
 ...
 */
@Slf4j
public class Idea29608Service {
    private static final int IDEA_ID = 29608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29608Service() {
        this(new Idea29608Config());
    }

    public Idea29608Service(Idea29608Config config) {
        this.config = config != null ? config : new Idea29608Config();
