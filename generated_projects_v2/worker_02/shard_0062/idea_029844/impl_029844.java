...
@Data
public class Idea29844Config {
    private String name = "idea_029844";
 ...
 */
@Slf4j
public class Idea29844Service {
    private static final int IDEA_ID = 29844;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29844Service() {
        this(new Idea29844Config());
    }

    public Idea29844Service(Idea29844Config config) {
        this.config = config != null ? config : new Idea29844Config();
