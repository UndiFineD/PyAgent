...
@Data
public class Idea29873Config {
    private String name = "idea_029873";
 ...
 */
@Slf4j
public class Idea29873Service {
    private static final int IDEA_ID = 29873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29873Service() {
        this(new Idea29873Config());
    }

    public Idea29873Service(Idea29873Config config) {
        this.config = config != null ? config : new Idea29873Config();
