...
@Data
public class Idea29869Config {
    private String name = "idea_029869";
 ...
 */
@Slf4j
public class Idea29869Service {
    private static final int IDEA_ID = 29869;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29869Service() {
        this(new Idea29869Config());
    }

    public Idea29869Service(Idea29869Config config) {
        this.config = config != null ? config : new Idea29869Config();
