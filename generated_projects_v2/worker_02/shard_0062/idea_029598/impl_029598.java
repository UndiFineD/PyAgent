...
@Data
public class Idea29598Config {
    private String name = "idea_029598";
 ...
 */
@Slf4j
public class Idea29598Service {
    private static final int IDEA_ID = 29598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29598Service() {
        this(new Idea29598Config());
    }

    public Idea29598Service(Idea29598Config config) {
        this.config = config != null ? config : new Idea29598Config();
