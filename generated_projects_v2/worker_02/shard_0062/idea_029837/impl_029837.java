...
@Data
public class Idea29837Config {
    private String name = "idea_029837";
 ...
 */
@Slf4j
public class Idea29837Service {
    private static final int IDEA_ID = 29837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29837Service() {
        this(new Idea29837Config());
    }

    public Idea29837Service(Idea29837Config config) {
        this.config = config != null ? config : new Idea29837Config();
