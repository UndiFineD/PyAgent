...
@Data
public class Idea29764Config {
    private String name = "idea_029764";
 ...
 */
@Slf4j
public class Idea29764Service {
    private static final int IDEA_ID = 29764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29764Service() {
        this(new Idea29764Config());
    }

    public Idea29764Service(Idea29764Config config) {
        this.config = config != null ? config : new Idea29764Config();
