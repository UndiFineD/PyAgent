...
@Data
public class Idea29724Config {
    private String name = "idea_029724";
 ...
 */
@Slf4j
public class Idea29724Service {
    private static final int IDEA_ID = 29724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29724Service() {
        this(new Idea29724Config());
    }

    public Idea29724Service(Idea29724Config config) {
        this.config = config != null ? config : new Idea29724Config();
