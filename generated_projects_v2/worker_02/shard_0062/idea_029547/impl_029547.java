...
@Data
public class Idea29547Config {
    private String name = "idea_029547";
 ...
 */
@Slf4j
public class Idea29547Service {
    private static final int IDEA_ID = 29547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29547Service() {
        this(new Idea29547Config());
    }

    public Idea29547Service(Idea29547Config config) {
        this.config = config != null ? config : new Idea29547Config();
