...
@Data
public class Idea29610Config {
    private String name = "idea_029610";
 ...
 */
@Slf4j
public class Idea29610Service {
    private static final int IDEA_ID = 29610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29610Service() {
        this(new Idea29610Config());
    }

    public Idea29610Service(Idea29610Config config) {
        this.config = config != null ? config : new Idea29610Config();
