...
@Data
public class Idea29786Config {
    private String name = "idea_029786";
 ...
 */
@Slf4j
public class Idea29786Service {
    private static final int IDEA_ID = 29786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29786Service() {
        this(new Idea29786Config());
    }

    public Idea29786Service(Idea29786Config config) {
        this.config = config != null ? config : new Idea29786Config();
