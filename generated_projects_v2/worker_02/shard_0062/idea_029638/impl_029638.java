...
@Data
public class Idea29638Config {
    private String name = "idea_029638";
 ...
 */
@Slf4j
public class Idea29638Service {
    private static final int IDEA_ID = 29638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29638Service() {
        this(new Idea29638Config());
    }

    public Idea29638Service(Idea29638Config config) {
        this.config = config != null ? config : new Idea29638Config();
