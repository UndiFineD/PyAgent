...
@Data
public class Idea29913Config {
    private String name = "idea_029913";
 ...
 */
@Slf4j
public class Idea29913Service {
    private static final int IDEA_ID = 29913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29913Service() {
        this(new Idea29913Config());
    }

    public Idea29913Service(Idea29913Config config) {
        this.config = config != null ? config : new Idea29913Config();
