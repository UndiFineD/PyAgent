...
@Data
public class Idea29688Config {
    private String name = "idea_029688";
 ...
 */
@Slf4j
public class Idea29688Service {
    private static final int IDEA_ID = 29688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29688Service() {
        this(new Idea29688Config());
    }

    public Idea29688Service(Idea29688Config config) {
        this.config = config != null ? config : new Idea29688Config();
