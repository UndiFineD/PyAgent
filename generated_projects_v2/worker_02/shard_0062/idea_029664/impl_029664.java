...
@Data
public class Idea29664Config {
    private String name = "idea_029664";
 ...
 */
@Slf4j
public class Idea29664Service {
    private static final int IDEA_ID = 29664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29664Service() {
        this(new Idea29664Config());
    }

    public Idea29664Service(Idea29664Config config) {
        this.config = config != null ? config : new Idea29664Config();
