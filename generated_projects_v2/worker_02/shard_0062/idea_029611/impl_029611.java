...
@Data
public class Idea29611Config {
    private String name = "idea_029611";
 ...
 */
@Slf4j
public class Idea29611Service {
    private static final int IDEA_ID = 29611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29611Service() {
        this(new Idea29611Config());
    }

    public Idea29611Service(Idea29611Config config) {
        this.config = config != null ? config : new Idea29611Config();
