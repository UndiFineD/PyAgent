...
@Data
public class Idea29526Config {
    private String name = "idea_029526";
 ...
 */
@Slf4j
public class Idea29526Service {
    private static final int IDEA_ID = 29526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29526Service() {
        this(new Idea29526Config());
    }

    public Idea29526Service(Idea29526Config config) {
        this.config = config != null ? config : new Idea29526Config();
