...
@Data
public class Idea29820Config {
    private String name = "idea_029820";
 ...
 */
@Slf4j
public class Idea29820Service {
    private static final int IDEA_ID = 29820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29820Service() {
        this(new Idea29820Config());
    }

    public Idea29820Service(Idea29820Config config) {
        this.config = config != null ? config : new Idea29820Config();
