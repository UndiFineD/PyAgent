...
@Data
public class Idea29707Config {
    private String name = "idea_029707";
 ...
 */
@Slf4j
public class Idea29707Service {
    private static final int IDEA_ID = 29707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29707Service() {
        this(new Idea29707Config());
    }

    public Idea29707Service(Idea29707Config config) {
        this.config = config != null ? config : new Idea29707Config();
