...
@Data
public class Idea29821Config {
    private String name = "idea_029821";
 ...
 */
@Slf4j
public class Idea29821Service {
    private static final int IDEA_ID = 29821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29821Service() {
        this(new Idea29821Config());
    }

    public Idea29821Service(Idea29821Config config) {
        this.config = config != null ? config : new Idea29821Config();
