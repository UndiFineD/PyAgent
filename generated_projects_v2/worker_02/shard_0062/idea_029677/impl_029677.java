...
@Data
public class Idea29677Config {
    private String name = "idea_029677";
 ...
 */
@Slf4j
public class Idea29677Service {
    private static final int IDEA_ID = 29677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29677Service() {
        this(new Idea29677Config());
    }

    public Idea29677Service(Idea29677Config config) {
        this.config = config != null ? config : new Idea29677Config();
