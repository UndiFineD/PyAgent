...
@Data
public class Idea29800Config {
    private String name = "idea_029800";
 ...
 */
@Slf4j
public class Idea29800Service {
    private static final int IDEA_ID = 29800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29800Service() {
        this(new Idea29800Config());
    }

    public Idea29800Service(Idea29800Config config) {
        this.config = config != null ? config : new Idea29800Config();
