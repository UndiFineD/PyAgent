...
@Data
public class Idea29592Config {
    private String name = "idea_029592";
 ...
 */
@Slf4j
public class Idea29592Service {
    private static final int IDEA_ID = 29592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29592Service() {
        this(new Idea29592Config());
    }

    public Idea29592Service(Idea29592Config config) {
        this.config = config != null ? config : new Idea29592Config();
