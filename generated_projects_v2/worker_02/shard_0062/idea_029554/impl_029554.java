...
@Data
public class Idea29554Config {
    private String name = "idea_029554";
 ...
 */
@Slf4j
public class Idea29554Service {
    private static final int IDEA_ID = 29554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29554Service() {
        this(new Idea29554Config());
    }

    public Idea29554Service(Idea29554Config config) {
        this.config = config != null ? config : new Idea29554Config();
