...
@Data
public class Idea29756Config {
    private String name = "idea_029756";
 ...
 */
@Slf4j
public class Idea29756Service {
    private static final int IDEA_ID = 29756;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29756Service() {
        this(new Idea29756Config());
    }

    public Idea29756Service(Idea29756Config config) {
        this.config = config != null ? config : new Idea29756Config();
