...
@Data
public class Idea29812Config {
    private String name = "idea_029812";
 ...
 */
@Slf4j
public class Idea29812Service {
    private static final int IDEA_ID = 29812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29812Service() {
        this(new Idea29812Config());
    }

    public Idea29812Service(Idea29812Config config) {
        this.config = config != null ? config : new Idea29812Config();
