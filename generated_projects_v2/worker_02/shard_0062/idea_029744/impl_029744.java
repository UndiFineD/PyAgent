...
@Data
public class Idea29744Config {
    private String name = "idea_029744";
 ...
 */
@Slf4j
public class Idea29744Service {
    private static final int IDEA_ID = 29744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29744Service() {
        this(new Idea29744Config());
    }

    public Idea29744Service(Idea29744Config config) {
        this.config = config != null ? config : new Idea29744Config();
