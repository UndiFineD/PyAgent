...
@Data
public class Idea29858Config {
    private String name = "idea_029858";
 ...
 */
@Slf4j
public class Idea29858Service {
    private static final int IDEA_ID = 29858;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29858Service() {
        this(new Idea29858Config());
    }

    public Idea29858Service(Idea29858Config config) {
        this.config = config != null ? config : new Idea29858Config();
