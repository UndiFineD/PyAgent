...
@Data
public class Idea29497Config {
    private String name = "idea_029497";
 ...
 */
@Slf4j
public class Idea29497Service {
    private static final int IDEA_ID = 29497;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29497Service() {
        this(new Idea29497Config());
    }

    public Idea29497Service(Idea29497Config config) {
        this.config = config != null ? config : new Idea29497Config();
