...
@Data
public class Idea29496Config {
    private String name = "idea_029496";
 ...
 */
@Slf4j
public class Idea29496Service {
    private static final int IDEA_ID = 29496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29496Service() {
        this(new Idea29496Config());
    }

    public Idea29496Service(Idea29496Config config) {
        this.config = config != null ? config : new Idea29496Config();
