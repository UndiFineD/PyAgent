...
@Data
public class Idea29460Config {
    private String name = "idea_029460";
 ...
 */
@Slf4j
public class Idea29460Service {
    private static final int IDEA_ID = 29460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29460Service() {
        this(new Idea29460Config());
    }

    public Idea29460Service(Idea29460Config config) {
        this.config = config != null ? config : new Idea29460Config();
