...
@Data
public class Idea29533Config {
    private String name = "idea_029533";
 ...
 */
@Slf4j
public class Idea29533Service {
    private static final int IDEA_ID = 29533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29533Service() {
        this(new Idea29533Config());
    }

    public Idea29533Service(Idea29533Config config) {
        this.config = config != null ? config : new Idea29533Config();
