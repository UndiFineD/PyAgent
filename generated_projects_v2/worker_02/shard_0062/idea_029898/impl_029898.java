...
@Data
public class Idea29898Config {
    private String name = "idea_029898";
 ...
 */
@Slf4j
public class Idea29898Service {
    private static final int IDEA_ID = 29898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29898Service() {
        this(new Idea29898Config());
    }

    public Idea29898Service(Idea29898Config config) {
        this.config = config != null ? config : new Idea29898Config();
