...
@Data
public class Idea29671Config {
    private String name = "idea_029671";
 ...
 */
@Slf4j
public class Idea29671Service {
    private static final int IDEA_ID = 29671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29671Service() {
        this(new Idea29671Config());
    }

    public Idea29671Service(Idea29671Config config) {
        this.config = config != null ? config : new Idea29671Config();
