...
@Data
public class Idea29831Config {
    private String name = "idea_029831";
 ...
 */
@Slf4j
public class Idea29831Service {
    private static final int IDEA_ID = 29831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29831Service() {
        this(new Idea29831Config());
    }

    public Idea29831Service(Idea29831Config config) {
        this.config = config != null ? config : new Idea29831Config();
