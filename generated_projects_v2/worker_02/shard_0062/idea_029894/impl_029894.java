...
@Data
public class Idea29894Config {
    private String name = "idea_029894";
 ...
 */
@Slf4j
public class Idea29894Service {
    private static final int IDEA_ID = 29894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29894Service() {
        this(new Idea29894Config());
    }

    public Idea29894Service(Idea29894Config config) {
        this.config = config != null ? config : new Idea29894Config();
