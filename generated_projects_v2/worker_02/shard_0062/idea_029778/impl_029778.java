...
@Data
public class Idea29778Config {
    private String name = "idea_029778";
 ...
 */
@Slf4j
public class Idea29778Service {
    private static final int IDEA_ID = 29778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29778Service() {
        this(new Idea29778Config());
    }

    public Idea29778Service(Idea29778Config config) {
        this.config = config != null ? config : new Idea29778Config();
