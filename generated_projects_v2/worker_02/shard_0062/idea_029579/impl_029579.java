...
@Data
public class Idea29579Config {
    private String name = "idea_029579";
 ...
 */
@Slf4j
public class Idea29579Service {
    private static final int IDEA_ID = 29579;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29579Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29579Service() {
        this(new Idea29579Config());
    }

    public Idea29579Service(Idea29579Config config) {
        this.config = config != null ? config : new Idea29579Config();
