...
@Data
public class Idea29563Config {
    private String name = "idea_029563";
 ...
 */
@Slf4j
public class Idea29563Service {
    private static final int IDEA_ID = 29563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29563Service() {
        this(new Idea29563Config());
    }

    public Idea29563Service(Idea29563Config config) {
        this.config = config != null ? config : new Idea29563Config();
