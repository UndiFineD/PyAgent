...
@Data
public class Idea29870Config {
    private String name = "idea_029870";
 ...
 */
@Slf4j
public class Idea29870Service {
    private static final int IDEA_ID = 29870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29870Service() {
        this(new Idea29870Config());
    }

    public Idea29870Service(Idea29870Config config) {
        this.config = config != null ? config : new Idea29870Config();
