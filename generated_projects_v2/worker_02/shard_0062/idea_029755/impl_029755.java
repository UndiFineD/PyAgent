...
@Data
public class Idea29755Config {
    private String name = "idea_029755";
 ...
 */
@Slf4j
public class Idea29755Service {
    private static final int IDEA_ID = 29755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29755Service() {
        this(new Idea29755Config());
    }

    public Idea29755Service(Idea29755Config config) {
        this.config = config != null ? config : new Idea29755Config();
