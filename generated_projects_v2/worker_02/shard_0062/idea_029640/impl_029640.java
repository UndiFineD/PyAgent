...
@Data
public class Idea29640Config {
    private String name = "idea_029640";
 ...
 */
@Slf4j
public class Idea29640Service {
    private static final int IDEA_ID = 29640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29640Service() {
        this(new Idea29640Config());
    }

    public Idea29640Service(Idea29640Config config) {
        this.config = config != null ? config : new Idea29640Config();
