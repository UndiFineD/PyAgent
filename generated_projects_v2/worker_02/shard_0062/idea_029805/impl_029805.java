...
@Data
public class Idea29805Config {
    private String name = "idea_029805";
 ...
 */
@Slf4j
public class Idea29805Service {
    private static final int IDEA_ID = 29805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29805Service() {
        this(new Idea29805Config());
    }

    public Idea29805Service(Idea29805Config config) {
        this.config = config != null ? config : new Idea29805Config();
