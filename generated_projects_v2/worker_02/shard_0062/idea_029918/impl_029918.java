...
@Data
public class Idea29918Config {
    private String name = "idea_029918";
 ...
 */
@Slf4j
public class Idea29918Service {
    private static final int IDEA_ID = 29918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29918Service() {
        this(new Idea29918Config());
    }

    public Idea29918Service(Idea29918Config config) {
        this.config = config != null ? config : new Idea29918Config();
