...
@Data
public class Idea29783Config {
    private String name = "idea_029783";
 ...
 */
@Slf4j
public class Idea29783Service {
    private static final int IDEA_ID = 29783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29783Service() {
        this(new Idea29783Config());
    }

    public Idea29783Service(Idea29783Config config) {
        this.config = config != null ? config : new Idea29783Config();
