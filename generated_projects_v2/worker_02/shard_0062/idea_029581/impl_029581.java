...
@Data
public class Idea29581Config {
    private String name = "idea_029581";
 ...
 */
@Slf4j
public class Idea29581Service {
    private static final int IDEA_ID = 29581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29581Service() {
        this(new Idea29581Config());
    }

    public Idea29581Service(Idea29581Config config) {
        this.config = config != null ? config : new Idea29581Config();
