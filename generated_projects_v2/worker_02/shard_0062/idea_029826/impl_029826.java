...
@Data
public class Idea29826Config {
    private String name = "idea_029826";
 ...
 */
@Slf4j
public class Idea29826Service {
    private static final int IDEA_ID = 29826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29826Service() {
        this(new Idea29826Config());
    }

    public Idea29826Service(Idea29826Config config) {
        this.config = config != null ? config : new Idea29826Config();
