...
@Data
public class Idea29606Config {
    private String name = "idea_029606";
 ...
 */
@Slf4j
public class Idea29606Service {
    private static final int IDEA_ID = 29606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29606Service() {
        this(new Idea29606Config());
    }

    public Idea29606Service(Idea29606Config config) {
        this.config = config != null ? config : new Idea29606Config();
