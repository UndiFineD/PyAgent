...
@Data
public class Idea29741Config {
    private String name = "idea_029741";
 ...
 */
@Slf4j
public class Idea29741Service {
    private static final int IDEA_ID = 29741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29741Service() {
        this(new Idea29741Config());
    }

    public Idea29741Service(Idea29741Config config) {
        this.config = config != null ? config : new Idea29741Config();
