...
@Data
public class Idea29822Config {
    private String name = "idea_029822";
 ...
 */
@Slf4j
public class Idea29822Service {
    private static final int IDEA_ID = 29822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29822Service() {
        this(new Idea29822Config());
    }

    public Idea29822Service(Idea29822Config config) {
        this.config = config != null ? config : new Idea29822Config();
