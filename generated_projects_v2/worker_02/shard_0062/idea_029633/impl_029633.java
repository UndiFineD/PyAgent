...
@Data
public class Idea29633Config {
    private String name = "idea_029633";
 ...
 */
@Slf4j
public class Idea29633Service {
    private static final int IDEA_ID = 29633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29633Service() {
        this(new Idea29633Config());
    }

    public Idea29633Service(Idea29633Config config) {
        this.config = config != null ? config : new Idea29633Config();
