...
@Data
public class Idea29591Config {
    private String name = "idea_029591";
 ...
 */
@Slf4j
public class Idea29591Service {
    private static final int IDEA_ID = 29591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29591Service() {
        this(new Idea29591Config());
    }

    public Idea29591Service(Idea29591Config config) {
        this.config = config != null ? config : new Idea29591Config();
