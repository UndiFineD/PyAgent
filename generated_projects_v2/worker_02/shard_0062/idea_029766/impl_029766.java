...
@Data
public class Idea29766Config {
    private String name = "idea_029766";
 ...
 */
@Slf4j
public class Idea29766Service {
    private static final int IDEA_ID = 29766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29766Service() {
        this(new Idea29766Config());
    }

    public Idea29766Service(Idea29766Config config) {
        this.config = config != null ? config : new Idea29766Config();
