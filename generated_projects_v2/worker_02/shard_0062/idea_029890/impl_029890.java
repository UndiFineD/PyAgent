...
@Data
public class Idea29890Config {
    private String name = "idea_029890";
 ...
 */
@Slf4j
public class Idea29890Service {
    private static final int IDEA_ID = 29890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29890Service() {
        this(new Idea29890Config());
    }

    public Idea29890Service(Idea29890Config config) {
        this.config = config != null ? config : new Idea29890Config();
