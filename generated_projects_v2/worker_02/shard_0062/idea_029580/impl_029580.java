...
@Data
public class Idea29580Config {
    private String name = "idea_029580";
 ...
 */
@Slf4j
public class Idea29580Service {
    private static final int IDEA_ID = 29580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29580Service() {
        this(new Idea29580Config());
    }

    public Idea29580Service(Idea29580Config config) {
        this.config = config != null ? config : new Idea29580Config();
