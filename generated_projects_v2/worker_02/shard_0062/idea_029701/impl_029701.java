...
@Data
public class Idea29701Config {
    private String name = "idea_029701";
 ...
 */
@Slf4j
public class Idea29701Service {
    private static final int IDEA_ID = 29701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29701Service() {
        this(new Idea29701Config());
    }

    public Idea29701Service(Idea29701Config config) {
        this.config = config != null ? config : new Idea29701Config();
