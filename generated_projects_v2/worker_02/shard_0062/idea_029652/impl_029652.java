...
@Data
public class Idea29652Config {
    private String name = "idea_029652";
 ...
 */
@Slf4j
public class Idea29652Service {
    private static final int IDEA_ID = 29652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29652Service() {
        this(new Idea29652Config());
    }

    public Idea29652Service(Idea29652Config config) {
        this.config = config != null ? config : new Idea29652Config();
