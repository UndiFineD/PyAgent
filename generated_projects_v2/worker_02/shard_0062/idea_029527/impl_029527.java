...
@Data
public class Idea29527Config {
    private String name = "idea_029527";
 ...
 */
@Slf4j
public class Idea29527Service {
    private static final int IDEA_ID = 29527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29527Service() {
        this(new Idea29527Config());
    }

    public Idea29527Service(Idea29527Config config) {
        this.config = config != null ? config : new Idea29527Config();
