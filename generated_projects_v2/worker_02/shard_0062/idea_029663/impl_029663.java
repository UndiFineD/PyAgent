...
@Data
public class Idea29663Config {
    private String name = "idea_029663";
 ...
 */
@Slf4j
public class Idea29663Service {
    private static final int IDEA_ID = 29663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29663Service() {
        this(new Idea29663Config());
    }

    public Idea29663Service(Idea29663Config config) {
        this.config = config != null ? config : new Idea29663Config();
