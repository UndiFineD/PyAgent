...
@Data
public class Idea29656Config {
    private String name = "idea_029656";
 ...
 */
@Slf4j
public class Idea29656Service {
    private static final int IDEA_ID = 29656;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29656Service() {
        this(new Idea29656Config());
    }

    public Idea29656Service(Idea29656Config config) {
        this.config = config != null ? config : new Idea29656Config();
