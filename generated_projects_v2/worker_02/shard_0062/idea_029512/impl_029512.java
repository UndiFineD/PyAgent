...
@Data
public class Idea29512Config {
    private String name = "idea_029512";
 ...
 */
@Slf4j
public class Idea29512Service {
    private static final int IDEA_ID = 29512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29512Service() {
        this(new Idea29512Config());
    }

    public Idea29512Service(Idea29512Config config) {
        this.config = config != null ? config : new Idea29512Config();
