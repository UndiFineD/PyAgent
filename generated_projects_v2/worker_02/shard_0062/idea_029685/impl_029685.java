...
@Data
public class Idea29685Config {
    private String name = "idea_029685";
 ...
 */
@Slf4j
public class Idea29685Service {
    private static final int IDEA_ID = 29685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29685Service() {
        this(new Idea29685Config());
    }

    public Idea29685Service(Idea29685Config config) {
        this.config = config != null ? config : new Idea29685Config();
