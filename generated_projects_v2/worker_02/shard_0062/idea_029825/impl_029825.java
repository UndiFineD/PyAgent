...
@Data
public class Idea29825Config {
    private String name = "idea_029825";
 ...
 */
@Slf4j
public class Idea29825Service {
    private static final int IDEA_ID = 29825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29825Service() {
        this(new Idea29825Config());
    }

    public Idea29825Service(Idea29825Config config) {
        this.config = config != null ? config : new Idea29825Config();
