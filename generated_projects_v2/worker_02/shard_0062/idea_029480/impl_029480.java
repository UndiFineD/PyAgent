...
@Data
public class Idea29480Config {
    private String name = "idea_029480";
 ...
 */
@Slf4j
public class Idea29480Service {
    private static final int IDEA_ID = 29480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29480Service() {
        this(new Idea29480Config());
    }

    public Idea29480Service(Idea29480Config config) {
        this.config = config != null ? config : new Idea29480Config();
