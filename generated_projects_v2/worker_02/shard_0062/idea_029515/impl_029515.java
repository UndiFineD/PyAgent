...
@Data
public class Idea29515Config {
    private String name = "idea_029515";
 ...
 */
@Slf4j
public class Idea29515Service {
    private static final int IDEA_ID = 29515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29515Service() {
        this(new Idea29515Config());
    }

    public Idea29515Service(Idea29515Config config) {
        this.config = config != null ? config : new Idea29515Config();
