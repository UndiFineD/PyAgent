...
@Data
public class Idea29706Config {
    private String name = "idea_029706";
 ...
 */
@Slf4j
public class Idea29706Service {
    private static final int IDEA_ID = 29706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29706Service() {
        this(new Idea29706Config());
    }

    public Idea29706Service(Idea29706Config config) {
        this.config = config != null ? config : new Idea29706Config();
