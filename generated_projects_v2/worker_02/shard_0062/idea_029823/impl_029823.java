...
@Data
public class Idea29823Config {
    private String name = "idea_029823";
 ...
 */
@Slf4j
public class Idea29823Service {
    private static final int IDEA_ID = 29823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29823Service() {
        this(new Idea29823Config());
    }

    public Idea29823Service(Idea29823Config config) {
        this.config = config != null ? config : new Idea29823Config();
