...
@Data
public class Idea29734Config {
    private String name = "idea_029734";
 ...
 */
@Slf4j
public class Idea29734Service {
    private static final int IDEA_ID = 29734;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29734Service() {
        this(new Idea29734Config());
    }

    public Idea29734Service(Idea29734Config config) {
        this.config = config != null ? config : new Idea29734Config();
