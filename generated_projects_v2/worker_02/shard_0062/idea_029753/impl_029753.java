...
@Data
public class Idea29753Config {
    private String name = "idea_029753";
 ...
 */
@Slf4j
public class Idea29753Service {
    private static final int IDEA_ID = 29753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29753Service() {
        this(new Idea29753Config());
    }

    public Idea29753Service(Idea29753Config config) {
        this.config = config != null ? config : new Idea29753Config();
