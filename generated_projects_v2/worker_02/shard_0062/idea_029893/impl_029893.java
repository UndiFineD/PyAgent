...
@Data
public class Idea29893Config {
    private String name = "idea_029893";
 ...
 */
@Slf4j
public class Idea29893Service {
    private static final int IDEA_ID = 29893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29893Service() {
        this(new Idea29893Config());
    }

    public Idea29893Service(Idea29893Config config) {
        this.config = config != null ? config : new Idea29893Config();
