...
@Data
public class Idea29770Config {
    private String name = "idea_029770";
 ...
 */
@Slf4j
public class Idea29770Service {
    private static final int IDEA_ID = 29770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29770Service() {
        this(new Idea29770Config());
    }

    public Idea29770Service(Idea29770Config config) {
        this.config = config != null ? config : new Idea29770Config();
