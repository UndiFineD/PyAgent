...
@Data
public class Idea29665Config {
    private String name = "idea_029665";
 ...
 */
@Slf4j
public class Idea29665Service {
    private static final int IDEA_ID = 29665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29665Service() {
        this(new Idea29665Config());
    }

    public Idea29665Service(Idea29665Config config) {
        this.config = config != null ? config : new Idea29665Config();
