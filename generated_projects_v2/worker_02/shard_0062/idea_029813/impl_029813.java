...
@Data
public class Idea29813Config {
    private String name = "idea_029813";
 ...
 */
@Slf4j
public class Idea29813Service {
    private static final int IDEA_ID = 29813;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29813Service() {
        this(new Idea29813Config());
    }

    public Idea29813Service(Idea29813Config config) {
        this.config = config != null ? config : new Idea29813Config();
