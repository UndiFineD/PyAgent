...
@Data
public class Idea29561Config {
    private String name = "idea_029561";
 ...
 */
@Slf4j
public class Idea29561Service {
    private static final int IDEA_ID = 29561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29561Service() {
        this(new Idea29561Config());
    }

    public Idea29561Service(Idea29561Config config) {
        this.config = config != null ? config : new Idea29561Config();
