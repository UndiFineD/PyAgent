...
@Data
public class Idea29798Config {
    private String name = "idea_029798";
 ...
 */
@Slf4j
public class Idea29798Service {
    private static final int IDEA_ID = 29798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29798Service() {
        this(new Idea29798Config());
    }

    public Idea29798Service(Idea29798Config config) {
        this.config = config != null ? config : new Idea29798Config();
