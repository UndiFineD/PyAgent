...
@Data
public class Idea29588Config {
    private String name = "idea_029588";
 ...
 */
@Slf4j
public class Idea29588Service {
    private static final int IDEA_ID = 29588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29588Service() {
        this(new Idea29588Config());
    }

    public Idea29588Service(Idea29588Config config) {
        this.config = config != null ? config : new Idea29588Config();
