...
@Data
public class Idea29696Config {
    private String name = "idea_029696";
 ...
 */
@Slf4j
public class Idea29696Service {
    private static final int IDEA_ID = 29696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29696Service() {
        this(new Idea29696Config());
    }

    public Idea29696Service(Idea29696Config config) {
        this.config = config != null ? config : new Idea29696Config();
