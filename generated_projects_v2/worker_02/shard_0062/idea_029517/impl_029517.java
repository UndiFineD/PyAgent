...
@Data
public class Idea29517Config {
    private String name = "idea_029517";
 ...
 */
@Slf4j
public class Idea29517Service {
    private static final int IDEA_ID = 29517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29517Service() {
        this(new Idea29517Config());
    }

    public Idea29517Service(Idea29517Config config) {
        this.config = config != null ? config : new Idea29517Config();
