...
@Data
public class Idea29541Config {
    private String name = "idea_029541";
 ...
 */
@Slf4j
public class Idea29541Service {
    private static final int IDEA_ID = 29541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29541Service() {
        this(new Idea29541Config());
    }

    public Idea29541Service(Idea29541Config config) {
        this.config = config != null ? config : new Idea29541Config();
