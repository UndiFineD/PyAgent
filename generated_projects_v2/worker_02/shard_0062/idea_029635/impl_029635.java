...
@Data
public class Idea29635Config {
    private String name = "idea_029635";
 ...
 */
@Slf4j
public class Idea29635Service {
    private static final int IDEA_ID = 29635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29635Service() {
        this(new Idea29635Config());
    }

    public Idea29635Service(Idea29635Config config) {
        this.config = config != null ? config : new Idea29635Config();
