...
@Data
public class Idea29697Config {
    private String name = "idea_029697";
 ...
 */
@Slf4j
public class Idea29697Service {
    private static final int IDEA_ID = 29697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29697Service() {
        this(new Idea29697Config());
    }

    public Idea29697Service(Idea29697Config config) {
        this.config = config != null ? config : new Idea29697Config();
