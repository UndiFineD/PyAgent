...
@Data
public class Idea29743Config {
    private String name = "idea_029743";
 ...
 */
@Slf4j
public class Idea29743Service {
    private static final int IDEA_ID = 29743;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29743Service() {
        this(new Idea29743Config());
    }

    public Idea29743Service(Idea29743Config config) {
        this.config = config != null ? config : new Idea29743Config();
