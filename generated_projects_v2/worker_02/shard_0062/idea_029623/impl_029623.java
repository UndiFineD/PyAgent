...
@Data
public class Idea29623Config {
    private String name = "idea_029623";
 ...
 */
@Slf4j
public class Idea29623Service {
    private static final int IDEA_ID = 29623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29623Service() {
        this(new Idea29623Config());
    }

    public Idea29623Service(Idea29623Config config) {
        this.config = config != null ? config : new Idea29623Config();
