...
@Data
public class Idea29597Config {
    private String name = "idea_029597";
 ...
 */
@Slf4j
public class Idea29597Service {
    private static final int IDEA_ID = 29597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29597Service() {
        this(new Idea29597Config());
    }

    public Idea29597Service(Idea29597Config config) {
        this.config = config != null ? config : new Idea29597Config();
