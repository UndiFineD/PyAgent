...
@Data
public class Idea29702Config {
    private String name = "idea_029702";
 ...
 */
@Slf4j
public class Idea29702Service {
    private static final int IDEA_ID = 29702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29702Service() {
        this(new Idea29702Config());
    }

    public Idea29702Service(Idea29702Config config) {
        this.config = config != null ? config : new Idea29702Config();
