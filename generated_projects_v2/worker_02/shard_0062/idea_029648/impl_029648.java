...
@Data
public class Idea29648Config {
    private String name = "idea_029648";
 ...
 */
@Slf4j
public class Idea29648Service {
    private static final int IDEA_ID = 29648;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29648Service() {
        this(new Idea29648Config());
    }

    public Idea29648Service(Idea29648Config config) {
        this.config = config != null ? config : new Idea29648Config();
