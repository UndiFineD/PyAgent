...
@Data
public class Idea29808Config {
    private String name = "idea_029808";
 ...
 */
@Slf4j
public class Idea29808Service {
    private static final int IDEA_ID = 29808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29808Service() {
        this(new Idea29808Config());
    }

    public Idea29808Service(Idea29808Config config) {
        this.config = config != null ? config : new Idea29808Config();
