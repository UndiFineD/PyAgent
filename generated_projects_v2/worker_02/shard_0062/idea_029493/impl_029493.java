...
@Data
public class Idea29493Config {
    private String name = "idea_029493";
 ...
 */
@Slf4j
public class Idea29493Service {
    private static final int IDEA_ID = 29493;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29493Service() {
        this(new Idea29493Config());
    }

    public Idea29493Service(Idea29493Config config) {
        this.config = config != null ? config : new Idea29493Config();
