...
@Data
public class Idea29816Config {
    private String name = "idea_029816";
 ...
 */
@Slf4j
public class Idea29816Service {
    private static final int IDEA_ID = 29816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29816Service() {
        this(new Idea29816Config());
    }

    public Idea29816Service(Idea29816Config config) {
        this.config = config != null ? config : new Idea29816Config();
