...
@Data
public class Idea29490Config {
    private String name = "idea_029490";
 ...
 */
@Slf4j
public class Idea29490Service {
    private static final int IDEA_ID = 29490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29490Service() {
        this(new Idea29490Config());
    }

    public Idea29490Service(Idea29490Config config) {
        this.config = config != null ? config : new Idea29490Config();
