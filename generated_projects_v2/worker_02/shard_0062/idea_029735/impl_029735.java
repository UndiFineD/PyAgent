...
@Data
public class Idea29735Config {
    private String name = "idea_029735";
 ...
 */
@Slf4j
public class Idea29735Service {
    private static final int IDEA_ID = 29735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29735Service() {
        this(new Idea29735Config());
    }

    public Idea29735Service(Idea29735Config config) {
        this.config = config != null ? config : new Idea29735Config();
