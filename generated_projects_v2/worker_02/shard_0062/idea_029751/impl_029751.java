...
@Data
public class Idea29751Config {
    private String name = "idea_029751";
 ...
 */
@Slf4j
public class Idea29751Service {
    private static final int IDEA_ID = 29751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29751Service() {
        this(new Idea29751Config());
    }

    public Idea29751Service(Idea29751Config config) {
        this.config = config != null ? config : new Idea29751Config();
