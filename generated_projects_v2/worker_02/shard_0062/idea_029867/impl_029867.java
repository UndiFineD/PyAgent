...
@Data
public class Idea29867Config {
    private String name = "idea_029867";
 ...
 */
@Slf4j
public class Idea29867Service {
    private static final int IDEA_ID = 29867;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29867Service() {
        this(new Idea29867Config());
    }

    public Idea29867Service(Idea29867Config config) {
        this.config = config != null ? config : new Idea29867Config();
