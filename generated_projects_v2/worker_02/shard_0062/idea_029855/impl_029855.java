...
@Data
public class Idea29855Config {
    private String name = "idea_029855";
 ...
 */
@Slf4j
public class Idea29855Service {
    private static final int IDEA_ID = 29855;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29855Service() {
        this(new Idea29855Config());
    }

    public Idea29855Service(Idea29855Config config) {
        this.config = config != null ? config : new Idea29855Config();
