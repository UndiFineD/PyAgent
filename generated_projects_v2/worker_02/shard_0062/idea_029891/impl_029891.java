...
@Data
public class Idea29891Config {
    private String name = "idea_029891";
 ...
 */
@Slf4j
public class Idea29891Service {
    private static final int IDEA_ID = 29891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29891Service() {
        this(new Idea29891Config());
    }

    public Idea29891Service(Idea29891Config config) {
        this.config = config != null ? config : new Idea29891Config();
