...
@Data
public class Idea29674Config {
    private String name = "idea_029674";
 ...
 */
@Slf4j
public class Idea29674Service {
    private static final int IDEA_ID = 29674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29674Service() {
        this(new Idea29674Config());
    }

    public Idea29674Service(Idea29674Config config) {
        this.config = config != null ? config : new Idea29674Config();
