...
@Data
public class Idea29654Config {
    private String name = "idea_029654";
 ...
 */
@Slf4j
public class Idea29654Service {
    private static final int IDEA_ID = 29654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29654Service() {
        this(new Idea29654Config());
    }

    public Idea29654Service(Idea29654Config config) {
        this.config = config != null ? config : new Idea29654Config();
