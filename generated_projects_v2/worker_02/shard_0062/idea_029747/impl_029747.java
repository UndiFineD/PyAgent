...
@Data
public class Idea29747Config {
    private String name = "idea_029747";
 ...
 */
@Slf4j
public class Idea29747Service {
    private static final int IDEA_ID = 29747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29747Service() {
        this(new Idea29747Config());
    }

    public Idea29747Service(Idea29747Config config) {
        this.config = config != null ? config : new Idea29747Config();
