...
@Data
public class Idea29726Config {
    private String name = "idea_029726";
 ...
 */
@Slf4j
public class Idea29726Service {
    private static final int IDEA_ID = 29726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29726Service() {
        this(new Idea29726Config());
    }

    public Idea29726Service(Idea29726Config config) {
        this.config = config != null ? config : new Idea29726Config();
