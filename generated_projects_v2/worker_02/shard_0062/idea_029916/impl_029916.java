...
@Data
public class Idea29916Config {
    private String name = "idea_029916";
 ...
 */
@Slf4j
public class Idea29916Service {
    private static final int IDEA_ID = 29916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29916Service() {
        this(new Idea29916Config());
    }

    public Idea29916Service(Idea29916Config config) {
        this.config = config != null ? config : new Idea29916Config();
