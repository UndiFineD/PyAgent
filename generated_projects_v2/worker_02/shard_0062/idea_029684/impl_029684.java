...
@Data
public class Idea29684Config {
    private String name = "idea_029684";
 ...
 */
@Slf4j
public class Idea29684Service {
    private static final int IDEA_ID = 29684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29684Service() {
        this(new Idea29684Config());
    }

    public Idea29684Service(Idea29684Config config) {
        this.config = config != null ? config : new Idea29684Config();
