...
@Data
public class Idea29862Config {
    private String name = "idea_029862";
 ...
 */
@Slf4j
public class Idea29862Service {
    private static final int IDEA_ID = 29862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29862Service() {
        this(new Idea29862Config());
    }

    public Idea29862Service(Idea29862Config config) {
        this.config = config != null ? config : new Idea29862Config();
