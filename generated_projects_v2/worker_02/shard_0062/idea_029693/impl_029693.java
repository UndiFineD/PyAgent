...
@Data
public class Idea29693Config {
    private String name = "idea_029693";
 ...
 */
@Slf4j
public class Idea29693Service {
    private static final int IDEA_ID = 29693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29693Service() {
        this(new Idea29693Config());
    }

    public Idea29693Service(Idea29693Config config) {
        this.config = config != null ? config : new Idea29693Config();
