...
@Data
public class Idea29731Config {
    private String name = "idea_029731";
 ...
 */
@Slf4j
public class Idea29731Service {
    private static final int IDEA_ID = 29731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29731Service() {
        this(new Idea29731Config());
    }

    public Idea29731Service(Idea29731Config config) {
        this.config = config != null ? config : new Idea29731Config();
