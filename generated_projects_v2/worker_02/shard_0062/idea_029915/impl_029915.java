...
@Data
public class Idea29915Config {
    private String name = "idea_029915";
 ...
 */
@Slf4j
public class Idea29915Service {
    private static final int IDEA_ID = 29915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29915Service() {
        this(new Idea29915Config());
    }

    public Idea29915Service(Idea29915Config config) {
        this.config = config != null ? config : new Idea29915Config();
