...
@Data
public class Idea29462Config {
    private String name = "idea_029462";
 ...
 */
@Slf4j
public class Idea29462Service {
    private static final int IDEA_ID = 29462;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29462Service() {
        this(new Idea29462Config());
    }

    public Idea29462Service(Idea29462Config config) {
        this.config = config != null ? config : new Idea29462Config();
