...
@Data
public class Idea29710Config {
    private String name = "idea_029710";
 ...
 */
@Slf4j
public class Idea29710Service {
    private static final int IDEA_ID = 29710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29710Service() {
        this(new Idea29710Config());
    }

    public Idea29710Service(Idea29710Config config) {
        this.config = config != null ? config : new Idea29710Config();
