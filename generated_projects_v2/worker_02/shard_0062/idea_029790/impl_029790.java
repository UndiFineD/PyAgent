...
@Data
public class Idea29790Config {
    private String name = "idea_029790";
 ...
 */
@Slf4j
public class Idea29790Service {
    private static final int IDEA_ID = 29790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29790Service() {
        this(new Idea29790Config());
    }

    public Idea29790Service(Idea29790Config config) {
        this.config = config != null ? config : new Idea29790Config();
