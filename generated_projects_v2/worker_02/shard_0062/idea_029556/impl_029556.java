...
@Data
public class Idea29556Config {
    private String name = "idea_029556";
 ...
 */
@Slf4j
public class Idea29556Service {
    private static final int IDEA_ID = 29556;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29556Service() {
        this(new Idea29556Config());
    }

    public Idea29556Service(Idea29556Config config) {
        this.config = config != null ? config : new Idea29556Config();
