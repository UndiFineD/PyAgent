...
@Data
public class Idea29475Config {
    private String name = "idea_029475";
 ...
 */
@Slf4j
public class Idea29475Service {
    private static final int IDEA_ID = 29475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29475Service() {
        this(new Idea29475Config());
    }

    public Idea29475Service(Idea29475Config config) {
        this.config = config != null ? config : new Idea29475Config();
