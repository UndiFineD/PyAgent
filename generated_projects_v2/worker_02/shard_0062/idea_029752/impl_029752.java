...
@Data
public class Idea29752Config {
    private String name = "idea_029752";
 ...
 */
@Slf4j
public class Idea29752Service {
    private static final int IDEA_ID = 29752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29752Service() {
        this(new Idea29752Config());
    }

    public Idea29752Service(Idea29752Config config) {
        this.config = config != null ? config : new Idea29752Config();
