...
@Data
public class Idea29631Config {
    private String name = "idea_029631";
 ...
 */
@Slf4j
public class Idea29631Service {
    private static final int IDEA_ID = 29631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29631Service() {
        this(new Idea29631Config());
    }

    public Idea29631Service(Idea29631Config config) {
        this.config = config != null ? config : new Idea29631Config();
