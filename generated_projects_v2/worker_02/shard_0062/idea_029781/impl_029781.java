...
@Data
public class Idea29781Config {
    private String name = "idea_029781";
 ...
 */
@Slf4j
public class Idea29781Service {
    private static final int IDEA_ID = 29781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29781Service() {
        this(new Idea29781Config());
    }

    public Idea29781Service(Idea29781Config config) {
        this.config = config != null ? config : new Idea29781Config();
