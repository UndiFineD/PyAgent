...
@Data
public class Idea29514Config {
    private String name = "idea_029514";
 ...
 */
@Slf4j
public class Idea29514Service {
    private static final int IDEA_ID = 29514;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29514Service() {
        this(new Idea29514Config());
    }

    public Idea29514Service(Idea29514Config config) {
        this.config = config != null ? config : new Idea29514Config();
