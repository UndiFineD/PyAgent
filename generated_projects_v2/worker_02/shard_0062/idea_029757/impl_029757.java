...
@Data
public class Idea29757Config {
    private String name = "idea_029757";
 ...
 */
@Slf4j
public class Idea29757Service {
    private static final int IDEA_ID = 29757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29757Service() {
        this(new Idea29757Config());
    }

    public Idea29757Service(Idea29757Config config) {
        this.config = config != null ? config : new Idea29757Config();
