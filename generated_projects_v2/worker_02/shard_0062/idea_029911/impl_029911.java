...
@Data
public class Idea29911Config {
    private String name = "idea_029911";
 ...
 */
@Slf4j
public class Idea29911Service {
    private static final int IDEA_ID = 29911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29911Service() {
        this(new Idea29911Config());
    }

    public Idea29911Service(Idea29911Config config) {
        this.config = config != null ? config : new Idea29911Config();
