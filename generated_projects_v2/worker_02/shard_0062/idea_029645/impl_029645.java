...
@Data
public class Idea29645Config {
    private String name = "idea_029645";
 ...
 */
@Slf4j
public class Idea29645Service {
    private static final int IDEA_ID = 29645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29645Service() {
        this(new Idea29645Config());
    }

    public Idea29645Service(Idea29645Config config) {
        this.config = config != null ? config : new Idea29645Config();
