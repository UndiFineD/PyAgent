...
@Data
public class Idea29522Config {
    private String name = "idea_029522";
 ...
 */
@Slf4j
public class Idea29522Service {
    private static final int IDEA_ID = 29522;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29522Service() {
        this(new Idea29522Config());
    }

    public Idea29522Service(Idea29522Config config) {
        this.config = config != null ? config : new Idea29522Config();
