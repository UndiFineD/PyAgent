...
@Data
public class Idea29529Config {
    private String name = "idea_029529";
 ...
 */
@Slf4j
public class Idea29529Service {
    private static final int IDEA_ID = 29529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29529Service() {
        this(new Idea29529Config());
    }

    public Idea29529Service(Idea29529Config config) {
        this.config = config != null ? config : new Idea29529Config();
