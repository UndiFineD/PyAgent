...
@Data
public class Idea29572Config {
    private String name = "idea_029572";
 ...
 */
@Slf4j
public class Idea29572Service {
    private static final int IDEA_ID = 29572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29572Service() {
        this(new Idea29572Config());
    }

    public Idea29572Service(Idea29572Config config) {
        this.config = config != null ? config : new Idea29572Config();
