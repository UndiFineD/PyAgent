...
@Data
public class Idea29780Config {
    private String name = "idea_029780";
 ...
 */
@Slf4j
public class Idea29780Service {
    private static final int IDEA_ID = 29780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29780Service() {
        this(new Idea29780Config());
    }

    public Idea29780Service(Idea29780Config config) {
        this.config = config != null ? config : new Idea29780Config();
