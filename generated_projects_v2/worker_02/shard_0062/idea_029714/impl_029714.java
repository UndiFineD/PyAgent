...
@Data
public class Idea29714Config {
    private String name = "idea_029714";
 ...
 */
@Slf4j
public class Idea29714Service {
    private static final int IDEA_ID = 29714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29714Service() {
        this(new Idea29714Config());
    }

    public Idea29714Service(Idea29714Config config) {
        this.config = config != null ? config : new Idea29714Config();
