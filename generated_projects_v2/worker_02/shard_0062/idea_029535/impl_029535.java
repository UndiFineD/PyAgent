...
@Data
public class Idea29535Config {
    private String name = "idea_029535";
 ...
 */
@Slf4j
public class Idea29535Service {
    private static final int IDEA_ID = 29535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29535Service() {
        this(new Idea29535Config());
    }

    public Idea29535Service(Idea29535Config config) {
        this.config = config != null ? config : new Idea29535Config();
