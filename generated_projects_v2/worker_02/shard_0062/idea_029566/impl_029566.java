...
@Data
public class Idea29566Config {
    private String name = "idea_029566";
 ...
 */
@Slf4j
public class Idea29566Service {
    private static final int IDEA_ID = 29566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29566Service() {
        this(new Idea29566Config());
    }

    public Idea29566Service(Idea29566Config config) {
        this.config = config != null ? config : new Idea29566Config();
