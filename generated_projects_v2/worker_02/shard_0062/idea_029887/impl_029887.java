...
@Data
public class Idea29887Config {
    private String name = "idea_029887";
 ...
 */
@Slf4j
public class Idea29887Service {
    private static final int IDEA_ID = 29887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29887Service() {
        this(new Idea29887Config());
    }

    public Idea29887Service(Idea29887Config config) {
        this.config = config != null ? config : new Idea29887Config();
