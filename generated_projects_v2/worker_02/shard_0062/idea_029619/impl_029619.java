...
@Data
public class Idea29619Config {
    private String name = "idea_029619";
 ...
 */
@Slf4j
public class Idea29619Service {
    private static final int IDEA_ID = 29619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29619Service() {
        this(new Idea29619Config());
    }

    public Idea29619Service(Idea29619Config config) {
        this.config = config != null ? config : new Idea29619Config();
