...
@Data
public class Idea29765Config {
    private String name = "idea_029765";
 ...
 */
@Slf4j
public class Idea29765Service {
    private static final int IDEA_ID = 29765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29765Service() {
        this(new Idea29765Config());
    }

    public Idea29765Service(Idea29765Config config) {
        this.config = config != null ? config : new Idea29765Config();
