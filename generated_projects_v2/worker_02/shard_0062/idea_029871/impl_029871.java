...
@Data
public class Idea29871Config {
    private String name = "idea_029871";
 ...
 */
@Slf4j
public class Idea29871Service {
    private static final int IDEA_ID = 29871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29871Service() {
        this(new Idea29871Config());
    }

    public Idea29871Service(Idea29871Config config) {
        this.config = config != null ? config : new Idea29871Config();
