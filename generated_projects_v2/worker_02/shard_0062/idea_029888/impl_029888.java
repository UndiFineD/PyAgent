...
@Data
public class Idea29888Config {
    private String name = "idea_029888";
 ...
 */
@Slf4j
public class Idea29888Service {
    private static final int IDEA_ID = 29888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29888Service() {
        this(new Idea29888Config());
    }

    public Idea29888Service(Idea29888Config config) {
        this.config = config != null ? config : new Idea29888Config();
