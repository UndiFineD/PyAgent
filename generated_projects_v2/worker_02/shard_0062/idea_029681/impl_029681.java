...
@Data
public class Idea29681Config {
    private String name = "idea_029681";
 ...
 */
@Slf4j
public class Idea29681Service {
    private static final int IDEA_ID = 29681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29681Service() {
        this(new Idea29681Config());
    }

    public Idea29681Service(Idea29681Config config) {
        this.config = config != null ? config : new Idea29681Config();
