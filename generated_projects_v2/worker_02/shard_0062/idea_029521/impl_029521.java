...
@Data
public class Idea29521Config {
    private String name = "idea_029521";
 ...
 */
@Slf4j
public class Idea29521Service {
    private static final int IDEA_ID = 29521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29521Service() {
        this(new Idea29521Config());
    }

    public Idea29521Service(Idea29521Config config) {
        this.config = config != null ? config : new Idea29521Config();
