...
@Data
public class Idea29784Config {
    private String name = "idea_029784";
 ...
 */
@Slf4j
public class Idea29784Service {
    private static final int IDEA_ID = 29784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29784Service() {
        this(new Idea29784Config());
    }

    public Idea29784Service(Idea29784Config config) {
        this.config = config != null ? config : new Idea29784Config();
