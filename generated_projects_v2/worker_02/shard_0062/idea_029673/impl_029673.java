...
@Data
public class Idea29673Config {
    private String name = "idea_029673";
 ...
 */
@Slf4j
public class Idea29673Service {
    private static final int IDEA_ID = 29673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29673Service() {
        this(new Idea29673Config());
    }

    public Idea29673Service(Idea29673Config config) {
        this.config = config != null ? config : new Idea29673Config();
