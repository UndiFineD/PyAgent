...
@Data
public class Idea29896Config {
    private String name = "idea_029896";
 ...
 */
@Slf4j
public class Idea29896Service {
    private static final int IDEA_ID = 29896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29896Service() {
        this(new Idea29896Config());
    }

    public Idea29896Service(Idea29896Config config) {
        this.config = config != null ? config : new Idea29896Config();
