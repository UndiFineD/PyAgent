...
@Data
public class Idea29917Config {
    private String name = "idea_029917";
 ...
 */
@Slf4j
public class Idea29917Service {
    private static final int IDEA_ID = 29917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29917Service() {
        this(new Idea29917Config());
    }

    public Idea29917Service(Idea29917Config config) {
        this.config = config != null ? config : new Idea29917Config();
