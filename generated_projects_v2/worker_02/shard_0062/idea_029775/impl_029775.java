...
@Data
public class Idea29775Config {
    private String name = "idea_029775";
 ...
 */
@Slf4j
public class Idea29775Service {
    private static final int IDEA_ID = 29775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29775Service() {
        this(new Idea29775Config());
    }

    public Idea29775Service(Idea29775Config config) {
        this.config = config != null ? config : new Idea29775Config();
