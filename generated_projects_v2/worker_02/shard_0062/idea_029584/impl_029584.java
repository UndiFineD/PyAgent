...
@Data
public class Idea29584Config {
    private String name = "idea_029584";
 ...
 */
@Slf4j
public class Idea29584Service {
    private static final int IDEA_ID = 29584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29584Service() {
        this(new Idea29584Config());
    }

    public Idea29584Service(Idea29584Config config) {
        this.config = config != null ? config : new Idea29584Config();
