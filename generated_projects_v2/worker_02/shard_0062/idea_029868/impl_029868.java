...
@Data
public class Idea29868Config {
    private String name = "idea_029868";
 ...
 */
@Slf4j
public class Idea29868Service {
    private static final int IDEA_ID = 29868;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29868Service() {
        this(new Idea29868Config());
    }

    public Idea29868Service(Idea29868Config config) {
        this.config = config != null ? config : new Idea29868Config();
