...
@Data
public class Idea29861Config {
    private String name = "idea_029861";
 ...
 */
@Slf4j
public class Idea29861Service {
    private static final int IDEA_ID = 29861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29861Service() {
        this(new Idea29861Config());
    }

    public Idea29861Service(Idea29861Config config) {
        this.config = config != null ? config : new Idea29861Config();
