...
@Data
public class Idea29467Config {
    private String name = "idea_029467";
 ...
 */
@Slf4j
public class Idea29467Service {
    private static final int IDEA_ID = 29467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29467Service() {
        this(new Idea29467Config());
    }

    public Idea29467Service(Idea29467Config config) {
        this.config = config != null ? config : new Idea29467Config();
