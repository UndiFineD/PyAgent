...
@Data
public class Idea29818Config {
    private String name = "idea_029818";
 ...
 */
@Slf4j
public class Idea29818Service {
    private static final int IDEA_ID = 29818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29818Service() {
        this(new Idea29818Config());
    }

    public Idea29818Service(Idea29818Config config) {
        this.config = config != null ? config : new Idea29818Config();
