...
@Data
public class Idea29740Config {
    private String name = "idea_029740";
 ...
 */
@Slf4j
public class Idea29740Service {
    private static final int IDEA_ID = 29740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29740Service() {
        this(new Idea29740Config());
    }

    public Idea29740Service(Idea29740Config config) {
        this.config = config != null ? config : new Idea29740Config();
