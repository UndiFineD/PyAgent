...
@Data
public class Idea29593Config {
    private String name = "idea_029593";
 ...
 */
@Slf4j
public class Idea29593Service {
    private static final int IDEA_ID = 29593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29593Service() {
        this(new Idea29593Config());
    }

    public Idea29593Service(Idea29593Config config) {
        this.config = config != null ? config : new Idea29593Config();
