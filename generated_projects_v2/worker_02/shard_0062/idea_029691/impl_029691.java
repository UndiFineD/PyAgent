...
@Data
public class Idea29691Config {
    private String name = "idea_029691";
 ...
 */
@Slf4j
public class Idea29691Service {
    private static final int IDEA_ID = 29691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29691Service() {
        this(new Idea29691Config());
    }

    public Idea29691Service(Idea29691Config config) {
        this.config = config != null ? config : new Idea29691Config();
