...
@Data
public class Idea29899Config {
    private String name = "idea_029899";
 ...
 */
@Slf4j
public class Idea29899Service {
    private static final int IDEA_ID = 29899;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29899Service() {
        this(new Idea29899Config());
    }

    public Idea29899Service(Idea29899Config config) {
        this.config = config != null ? config : new Idea29899Config();
