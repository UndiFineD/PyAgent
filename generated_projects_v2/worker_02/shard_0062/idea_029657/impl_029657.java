...
@Data
public class Idea29657Config {
    private String name = "idea_029657";
 ...
 */
@Slf4j
public class Idea29657Service {
    private static final int IDEA_ID = 29657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29657Service() {
        this(new Idea29657Config());
    }

    public Idea29657Service(Idea29657Config config) {
        this.config = config != null ? config : new Idea29657Config();
