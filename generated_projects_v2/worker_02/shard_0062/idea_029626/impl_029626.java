...
@Data
public class Idea29626Config {
    private String name = "idea_029626";
 ...
 */
@Slf4j
public class Idea29626Service {
    private static final int IDEA_ID = 29626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29626Service() {
        this(new Idea29626Config());
    }

    public Idea29626Service(Idea29626Config config) {
        this.config = config != null ? config : new Idea29626Config();
