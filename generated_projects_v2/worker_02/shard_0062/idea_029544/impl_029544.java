...
@Data
public class Idea29544Config {
    private String name = "idea_029544";
 ...
 */
@Slf4j
public class Idea29544Service {
    private static final int IDEA_ID = 29544;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29544Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29544Service() {
        this(new Idea29544Config());
    }

    public Idea29544Service(Idea29544Config config) {
        this.config = config != null ? config : new Idea29544Config();
