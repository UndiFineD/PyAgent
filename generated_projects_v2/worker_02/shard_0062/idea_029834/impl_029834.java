...
@Data
public class Idea29834Config {
    private String name = "idea_029834";
 ...
 */
@Slf4j
public class Idea29834Service {
    private static final int IDEA_ID = 29834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29834Service() {
        this(new Idea29834Config());
    }

    public Idea29834Service(Idea29834Config config) {
        this.config = config != null ? config : new Idea29834Config();
