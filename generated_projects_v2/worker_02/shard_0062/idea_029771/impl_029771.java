...
@Data
public class Idea29771Config {
    private String name = "idea_029771";
 ...
 */
@Slf4j
public class Idea29771Service {
    private static final int IDEA_ID = 29771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29771Service() {
        this(new Idea29771Config());
    }

    public Idea29771Service(Idea29771Config config) {
        this.config = config != null ? config : new Idea29771Config();
