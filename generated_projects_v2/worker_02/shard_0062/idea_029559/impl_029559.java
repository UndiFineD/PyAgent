...
@Data
public class Idea29559Config {
    private String name = "idea_029559";
 ...
 */
@Slf4j
public class Idea29559Service {
    private static final int IDEA_ID = 29559;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29559Service() {
        this(new Idea29559Config());
    }

    public Idea29559Service(Idea29559Config config) {
        this.config = config != null ? config : new Idea29559Config();
