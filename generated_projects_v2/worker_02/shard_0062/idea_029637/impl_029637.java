...
@Data
public class Idea29637Config {
    private String name = "idea_029637";
 ...
 */
@Slf4j
public class Idea29637Service {
    private static final int IDEA_ID = 29637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29637Service() {
        this(new Idea29637Config());
    }

    public Idea29637Service(Idea29637Config config) {
        this.config = config != null ? config : new Idea29637Config();
