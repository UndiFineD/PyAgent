...
@Data
public class Idea29528Config {
    private String name = "idea_029528";
 ...
 */
@Slf4j
public class Idea29528Service {
    private static final int IDEA_ID = 29528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29528Service() {
        this(new Idea29528Config());
    }

    public Idea29528Service(Idea29528Config config) {
        this.config = config != null ? config : new Idea29528Config();
