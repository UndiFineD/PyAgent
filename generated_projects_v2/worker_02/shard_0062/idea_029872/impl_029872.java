...
@Data
public class Idea29872Config {
    private String name = "idea_029872";
 ...
 */
@Slf4j
public class Idea29872Service {
    private static final int IDEA_ID = 29872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29872Service() {
        this(new Idea29872Config());
    }

    public Idea29872Service(Idea29872Config config) {
        this.config = config != null ? config : new Idea29872Config();
