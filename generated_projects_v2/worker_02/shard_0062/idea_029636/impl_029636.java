...
@Data
public class Idea29636Config {
    private String name = "idea_029636";
 ...
 */
@Slf4j
public class Idea29636Service {
    private static final int IDEA_ID = 29636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29636Service() {
        this(new Idea29636Config());
    }

    public Idea29636Service(Idea29636Config config) {
        this.config = config != null ? config : new Idea29636Config();
