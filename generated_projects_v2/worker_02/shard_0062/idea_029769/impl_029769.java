...
@Data
public class Idea29769Config {
    private String name = "idea_029769";
 ...
 */
@Slf4j
public class Idea29769Service {
    private static final int IDEA_ID = 29769;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29769Service() {
        this(new Idea29769Config());
    }

    public Idea29769Service(Idea29769Config config) {
        this.config = config != null ? config : new Idea29769Config();
