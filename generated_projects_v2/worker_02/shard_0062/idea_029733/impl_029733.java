...
@Data
public class Idea29733Config {
    private String name = "idea_029733";
 ...
 */
@Slf4j
public class Idea29733Service {
    private static final int IDEA_ID = 29733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29733Service() {
        this(new Idea29733Config());
    }

    public Idea29733Service(Idea29733Config config) {
        this.config = config != null ? config : new Idea29733Config();
