...
@Data
public class Idea29906Config {
    private String name = "idea_029906";
 ...
 */
@Slf4j
public class Idea29906Service {
    private static final int IDEA_ID = 29906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29906Service() {
        this(new Idea29906Config());
    }

    public Idea29906Service(Idea29906Config config) {
        this.config = config != null ? config : new Idea29906Config();
