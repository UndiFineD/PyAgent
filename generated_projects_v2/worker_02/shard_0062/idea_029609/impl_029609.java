...
@Data
public class Idea29609Config {
    private String name = "idea_029609";
 ...
 */
@Slf4j
public class Idea29609Service {
    private static final int IDEA_ID = 29609;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29609Service() {
        this(new Idea29609Config());
    }

    public Idea29609Service(Idea29609Config config) {
        this.config = config != null ? config : new Idea29609Config();
