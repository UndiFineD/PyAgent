...
@Data
public class Idea29788Config {
    private String name = "idea_029788";
 ...
 */
@Slf4j
public class Idea29788Service {
    private static final int IDEA_ID = 29788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29788Service() {
        this(new Idea29788Config());
    }

    public Idea29788Service(Idea29788Config config) {
        this.config = config != null ? config : new Idea29788Config();
