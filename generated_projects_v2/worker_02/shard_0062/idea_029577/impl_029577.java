...
@Data
public class Idea29577Config {
    private String name = "idea_029577";
 ...
 */
@Slf4j
public class Idea29577Service {
    private static final int IDEA_ID = 29577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29577Service() {
        this(new Idea29577Config());
    }

    public Idea29577Service(Idea29577Config config) {
        this.config = config != null ? config : new Idea29577Config();
