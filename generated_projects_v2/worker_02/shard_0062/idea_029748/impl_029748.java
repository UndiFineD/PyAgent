...
@Data
public class Idea29748Config {
    private String name = "idea_029748";
 ...
 */
@Slf4j
public class Idea29748Service {
    private static final int IDEA_ID = 29748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29748Service() {
        this(new Idea29748Config());
    }

    public Idea29748Service(Idea29748Config config) {
        this.config = config != null ? config : new Idea29748Config();
