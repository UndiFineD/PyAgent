...
@Data
public class Idea29594Config {
    private String name = "idea_029594";
 ...
 */
@Slf4j
public class Idea29594Service {
    private static final int IDEA_ID = 29594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29594Service() {
        this(new Idea29594Config());
    }

    public Idea29594Service(Idea29594Config config) {
        this.config = config != null ? config : new Idea29594Config();
