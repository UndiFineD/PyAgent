...
@Data
public class Idea29921Config {
    private String name = "idea_029921";
 ...
 */
@Slf4j
public class Idea29921Service {
    private static final int IDEA_ID = 29921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29921Service() {
        this(new Idea29921Config());
    }

    public Idea29921Service(Idea29921Config config) {
        this.config = config != null ? config : new Idea29921Config();
