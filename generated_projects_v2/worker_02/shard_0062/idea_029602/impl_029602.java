...
@Data
public class Idea29602Config {
    private String name = "idea_029602";
 ...
 */
@Slf4j
public class Idea29602Service {
    private static final int IDEA_ID = 29602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29602Service() {
        this(new Idea29602Config());
    }

    public Idea29602Service(Idea29602Config config) {
        this.config = config != null ? config : new Idea29602Config();
