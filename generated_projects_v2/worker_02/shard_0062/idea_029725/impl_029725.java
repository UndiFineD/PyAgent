...
@Data
public class Idea29725Config {
    private String name = "idea_029725";
 ...
 */
@Slf4j
public class Idea29725Service {
    private static final int IDEA_ID = 29725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29725Service() {
        this(new Idea29725Config());
    }

    public Idea29725Service(Idea29725Config config) {
        this.config = config != null ? config : new Idea29725Config();
