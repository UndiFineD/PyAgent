...
@Data
public class Idea29876Config {
    private String name = "idea_029876";
 ...
 */
@Slf4j
public class Idea29876Service {
    private static final int IDEA_ID = 29876;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29876Service() {
        this(new Idea29876Config());
    }

    public Idea29876Service(Idea29876Config config) {
        this.config = config != null ? config : new Idea29876Config();
