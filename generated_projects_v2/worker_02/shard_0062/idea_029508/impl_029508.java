...
@Data
public class Idea29508Config {
    private String name = "idea_029508";
 ...
 */
@Slf4j
public class Idea29508Service {
    private static final int IDEA_ID = 29508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29508Service() {
        this(new Idea29508Config());
    }

    public Idea29508Service(Idea29508Config config) {
        this.config = config != null ? config : new Idea29508Config();
