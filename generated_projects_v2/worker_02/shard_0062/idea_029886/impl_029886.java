...
@Data
public class Idea29886Config {
    private String name = "idea_029886";
 ...
 */
@Slf4j
public class Idea29886Service {
    private static final int IDEA_ID = 29886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29886Service() {
        this(new Idea29886Config());
    }

    public Idea29886Service(Idea29886Config config) {
        this.config = config != null ? config : new Idea29886Config();
