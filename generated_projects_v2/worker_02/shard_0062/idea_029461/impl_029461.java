...
@Data
public class Idea29461Config {
    private String name = "idea_029461";
 ...
 */
@Slf4j
public class Idea29461Service {
    private static final int IDEA_ID = 29461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29461Service() {
        this(new Idea29461Config());
    }

    public Idea29461Service(Idea29461Config config) {
        this.config = config != null ? config : new Idea29461Config();
