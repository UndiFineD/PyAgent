...
@Data
public class Idea29683Config {
    private String name = "idea_029683";
 ...
 */
@Slf4j
public class Idea29683Service {
    private static final int IDEA_ID = 29683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29683Service() {
        this(new Idea29683Config());
    }

    public Idea29683Service(Idea29683Config config) {
        this.config = config != null ? config : new Idea29683Config();
