...
@Data
public class Idea29791Config {
    private String name = "idea_029791";
 ...
 */
@Slf4j
public class Idea29791Service {
    private static final int IDEA_ID = 29791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29791Service() {
        this(new Idea29791Config());
    }

    public Idea29791Service(Idea29791Config config) {
        this.config = config != null ? config : new Idea29791Config();
