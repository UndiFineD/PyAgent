...
@Data
public class Idea29555Config {
    private String name = "idea_029555";
 ...
 */
@Slf4j
public class Idea29555Service {
    private static final int IDEA_ID = 29555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29555Service() {
        this(new Idea29555Config());
    }

    public Idea29555Service(Idea29555Config config) {
        this.config = config != null ? config : new Idea29555Config();
