...
@Data
public class Idea29768Config {
    private String name = "idea_029768";
 ...
 */
@Slf4j
public class Idea29768Service {
    private static final int IDEA_ID = 29768;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29768Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29768Service() {
        this(new Idea29768Config());
    }

    public Idea29768Service(Idea29768Config config) {
        this.config = config != null ? config : new Idea29768Config();
