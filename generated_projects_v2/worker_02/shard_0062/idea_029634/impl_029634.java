...
@Data
public class Idea29634Config {
    private String name = "idea_029634";
 ...
 */
@Slf4j
public class Idea29634Service {
    private static final int IDEA_ID = 29634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29634Service() {
        this(new Idea29634Config());
    }

    public Idea29634Service(Idea29634Config config) {
        this.config = config != null ? config : new Idea29634Config();
