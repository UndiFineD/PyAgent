...
@Data
public class Idea34385Config {
    private String name = "idea_034385";
 ...
 */
@Slf4j
public class Idea34385Service {
    private static final int IDEA_ID = 34385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34385Service() {
        this(new Idea34385Config());
    }

    public Idea34385Service(Idea34385Config config) {
        this.config = config != null ? config : new Idea34385Config();
