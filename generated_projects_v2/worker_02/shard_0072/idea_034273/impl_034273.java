...
@Data
public class Idea34273Config {
    private String name = "idea_034273";
 ...
 */
@Slf4j
public class Idea34273Service {
    private static final int IDEA_ID = 34273;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34273Service() {
        this(new Idea34273Config());
    }

    public Idea34273Service(Idea34273Config config) {
        this.config = config != null ? config : new Idea34273Config();
