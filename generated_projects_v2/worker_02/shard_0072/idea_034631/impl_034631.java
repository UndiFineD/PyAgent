...
@Data
public class Idea34631Config {
    private String name = "idea_034631";
 ...
 */
@Slf4j
public class Idea34631Service {
    private static final int IDEA_ID = 34631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34631Service() {
        this(new Idea34631Config());
    }

    public Idea34631Service(Idea34631Config config) {
        this.config = config != null ? config : new Idea34631Config();
