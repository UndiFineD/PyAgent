...
@Data
public class Idea34667Config {
    private String name = "idea_034667";
 ...
 */
@Slf4j
public class Idea34667Service {
    private static final int IDEA_ID = 34667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34667Service() {
        this(new Idea34667Config());
    }

    public Idea34667Service(Idea34667Config config) {
        this.config = config != null ? config : new Idea34667Config();
