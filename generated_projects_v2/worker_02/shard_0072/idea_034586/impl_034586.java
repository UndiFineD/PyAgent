...
@Data
public class Idea34586Config {
    private String name = "idea_034586";
 ...
 */
@Slf4j
public class Idea34586Service {
    private static final int IDEA_ID = 34586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34586Service() {
        this(new Idea34586Config());
    }

    public Idea34586Service(Idea34586Config config) {
        this.config = config != null ? config : new Idea34586Config();
