...
@Data
public class Idea34301Config {
    private String name = "idea_034301";
 ...
 */
@Slf4j
public class Idea34301Service {
    private static final int IDEA_ID = 34301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34301Service() {
        this(new Idea34301Config());
    }

    public Idea34301Service(Idea34301Config config) {
        this.config = config != null ? config : new Idea34301Config();
