...
@Data
public class Idea34662Config {
    private String name = "idea_034662";
 ...
 */
@Slf4j
public class Idea34662Service {
    private static final int IDEA_ID = 34662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34662Service() {
        this(new Idea34662Config());
    }

    public Idea34662Service(Idea34662Config config) {
        this.config = config != null ? config : new Idea34662Config();
