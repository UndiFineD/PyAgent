...
@Data
public class Idea34409Config {
    private String name = "idea_034409";
 ...
 */
@Slf4j
public class Idea34409Service {
    private static final int IDEA_ID = 34409;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34409Service() {
        this(new Idea34409Config());
    }

    public Idea34409Service(Idea34409Config config) {
        this.config = config != null ? config : new Idea34409Config();
