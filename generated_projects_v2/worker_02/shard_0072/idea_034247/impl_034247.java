...
@Data
public class Idea34247Config {
    private String name = "idea_034247";
 ...
 */
@Slf4j
public class Idea34247Service {
    private static final int IDEA_ID = 34247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34247Service() {
        this(new Idea34247Config());
    }

    public Idea34247Service(Idea34247Config config) {
        this.config = config != null ? config : new Idea34247Config();
