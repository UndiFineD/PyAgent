...
@Data
public class Idea34627Config {
    private String name = "idea_034627";
 ...
 */
@Slf4j
public class Idea34627Service {
    private static final int IDEA_ID = 34627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34627Service() {
        this(new Idea34627Config());
    }

    public Idea34627Service(Idea34627Config config) {
        this.config = config != null ? config : new Idea34627Config();
