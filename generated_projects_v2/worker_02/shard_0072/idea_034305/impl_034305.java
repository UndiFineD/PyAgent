...
@Data
public class Idea34305Config {
    private String name = "idea_034305";
 ...
 */
@Slf4j
public class Idea34305Service {
    private static final int IDEA_ID = 34305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34305Service() {
        this(new Idea34305Config());
    }

    public Idea34305Service(Idea34305Config config) {
        this.config = config != null ? config : new Idea34305Config();
