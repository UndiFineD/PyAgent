...
@Data
public class Idea34546Config {
    private String name = "idea_034546";
 ...
 */
@Slf4j
public class Idea34546Service {
    private static final int IDEA_ID = 34546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34546Service() {
        this(new Idea34546Config());
    }

    public Idea34546Service(Idea34546Config config) {
        this.config = config != null ? config : new Idea34546Config();
