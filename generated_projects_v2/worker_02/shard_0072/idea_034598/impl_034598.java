...
@Data
public class Idea34598Config {
    private String name = "idea_034598";
 ...
 */
@Slf4j
public class Idea34598Service {
    private static final int IDEA_ID = 34598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34598Service() {
        this(new Idea34598Config());
    }

    public Idea34598Service(Idea34598Config config) {
        this.config = config != null ? config : new Idea34598Config();
