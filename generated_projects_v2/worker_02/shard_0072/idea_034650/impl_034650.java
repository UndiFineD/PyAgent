...
@Data
public class Idea34650Config {
    private String name = "idea_034650";
 ...
 */
@Slf4j
public class Idea34650Service {
    private static final int IDEA_ID = 34650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34650Service() {
        this(new Idea34650Config());
    }

    public Idea34650Service(Idea34650Config config) {
        this.config = config != null ? config : new Idea34650Config();
