...
@Data
public class Idea34336Config {
    private String name = "idea_034336";
 ...
 */
@Slf4j
public class Idea34336Service {
    private static final int IDEA_ID = 34336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34336Service() {
        this(new Idea34336Config());
    }

    public Idea34336Service(Idea34336Config config) {
        this.config = config != null ? config : new Idea34336Config();
