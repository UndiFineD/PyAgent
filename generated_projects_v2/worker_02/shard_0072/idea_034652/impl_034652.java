...
@Data
public class Idea34652Config {
    private String name = "idea_034652";
 ...
 */
@Slf4j
public class Idea34652Service {
    private static final int IDEA_ID = 34652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34652Service() {
        this(new Idea34652Config());
    }

    public Idea34652Service(Idea34652Config config) {
        this.config = config != null ? config : new Idea34652Config();
