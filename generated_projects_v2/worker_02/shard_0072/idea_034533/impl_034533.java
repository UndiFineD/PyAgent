...
@Data
public class Idea34533Config {
    private String name = "idea_034533";
 ...
 */
@Slf4j
public class Idea34533Service {
    private static final int IDEA_ID = 34533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34533Service() {
        this(new Idea34533Config());
    }

    public Idea34533Service(Idea34533Config config) {
        this.config = config != null ? config : new Idea34533Config();
