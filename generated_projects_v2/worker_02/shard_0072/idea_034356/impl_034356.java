...
@Data
public class Idea34356Config {
    private String name = "idea_034356";
 ...
 */
@Slf4j
public class Idea34356Service {
    private static final int IDEA_ID = 34356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34356Service() {
        this(new Idea34356Config());
    }

    public Idea34356Service(Idea34356Config config) {
        this.config = config != null ? config : new Idea34356Config();
