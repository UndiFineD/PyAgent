...
@Data
public class Idea34367Config {
    private String name = "idea_034367";
 ...
 */
@Slf4j
public class Idea34367Service {
    private static final int IDEA_ID = 34367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34367Service() {
        this(new Idea34367Config());
    }

    public Idea34367Service(Idea34367Config config) {
        this.config = config != null ? config : new Idea34367Config();
