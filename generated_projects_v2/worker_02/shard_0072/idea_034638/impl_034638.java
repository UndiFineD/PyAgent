...
@Data
public class Idea34638Config {
    private String name = "idea_034638";
 ...
 */
@Slf4j
public class Idea34638Service {
    private static final int IDEA_ID = 34638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34638Service() {
        this(new Idea34638Config());
    }

    public Idea34638Service(Idea34638Config config) {
        this.config = config != null ? config : new Idea34638Config();
