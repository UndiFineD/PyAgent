...
@Data
public class Idea34509Config {
    private String name = "idea_034509";
 ...
 */
@Slf4j
public class Idea34509Service {
    private static final int IDEA_ID = 34509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34509Service() {
        this(new Idea34509Config());
    }

    public Idea34509Service(Idea34509Config config) {
        this.config = config != null ? config : new Idea34509Config();
