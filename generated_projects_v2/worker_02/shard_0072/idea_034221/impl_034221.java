...
@Data
public class Idea34221Config {
    private String name = "idea_034221";
 ...
 */
@Slf4j
public class Idea34221Service {
    private static final int IDEA_ID = 34221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34221Service() {
        this(new Idea34221Config());
    }

    public Idea34221Service(Idea34221Config config) {
        this.config = config != null ? config : new Idea34221Config();
