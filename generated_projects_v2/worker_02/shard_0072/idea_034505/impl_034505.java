...
@Data
public class Idea34505Config {
    private String name = "idea_034505";
 ...
 */
@Slf4j
public class Idea34505Service {
    private static final int IDEA_ID = 34505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34505Service() {
        this(new Idea34505Config());
    }

    public Idea34505Service(Idea34505Config config) {
        this.config = config != null ? config : new Idea34505Config();
