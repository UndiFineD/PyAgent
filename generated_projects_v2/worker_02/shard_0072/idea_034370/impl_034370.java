...
@Data
public class Idea34370Config {
    private String name = "idea_034370";
 ...
 */
@Slf4j
public class Idea34370Service {
    private static final int IDEA_ID = 34370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34370Service() {
        this(new Idea34370Config());
    }

    public Idea34370Service(Idea34370Config config) {
        this.config = config != null ? config : new Idea34370Config();
