...
@Data
public class Idea34458Config {
    private String name = "idea_034458";
 ...
 */
@Slf4j
public class Idea34458Service {
    private static final int IDEA_ID = 34458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34458Service() {
        this(new Idea34458Config());
    }

    public Idea34458Service(Idea34458Config config) {
        this.config = config != null ? config : new Idea34458Config();
