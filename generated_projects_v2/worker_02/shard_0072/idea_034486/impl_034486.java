...
@Data
public class Idea34486Config {
    private String name = "idea_034486";
 ...
 */
@Slf4j
public class Idea34486Service {
    private static final int IDEA_ID = 34486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34486Service() {
        this(new Idea34486Config());
    }

    public Idea34486Service(Idea34486Config config) {
        this.config = config != null ? config : new Idea34486Config();
