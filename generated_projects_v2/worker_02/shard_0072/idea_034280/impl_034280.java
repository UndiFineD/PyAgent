...
@Data
public class Idea34280Config {
    private String name = "idea_034280";
 ...
 */
@Slf4j
public class Idea34280Service {
    private static final int IDEA_ID = 34280;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34280Service() {
        this(new Idea34280Config());
    }

    public Idea34280Service(Idea34280Config config) {
        this.config = config != null ? config : new Idea34280Config();
