...
@Data
public class Idea34445Config {
    private String name = "idea_034445";
 ...
 */
@Slf4j
public class Idea34445Service {
    private static final int IDEA_ID = 34445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34445Service() {
        this(new Idea34445Config());
    }

    public Idea34445Service(Idea34445Config config) {
        this.config = config != null ? config : new Idea34445Config();
