...
@Data
public class Idea34470Config {
    private String name = "idea_034470";
 ...
 */
@Slf4j
public class Idea34470Service {
    private static final int IDEA_ID = 34470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34470Service() {
        this(new Idea34470Config());
    }

    public Idea34470Service(Idea34470Config config) {
        this.config = config != null ? config : new Idea34470Config();
