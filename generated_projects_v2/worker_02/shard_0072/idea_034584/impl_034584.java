...
@Data
public class Idea34584Config {
    private String name = "idea_034584";
 ...
 */
@Slf4j
public class Idea34584Service {
    private static final int IDEA_ID = 34584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34584Service() {
        this(new Idea34584Config());
    }

    public Idea34584Service(Idea34584Config config) {
        this.config = config != null ? config : new Idea34584Config();
