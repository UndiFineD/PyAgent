...
@Data
public class Idea34473Config {
    private String name = "idea_034473";
 ...
 */
@Slf4j
public class Idea34473Service {
    private static final int IDEA_ID = 34473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34473Service() {
        this(new Idea34473Config());
    }

    public Idea34473Service(Idea34473Config config) {
        this.config = config != null ? config : new Idea34473Config();
