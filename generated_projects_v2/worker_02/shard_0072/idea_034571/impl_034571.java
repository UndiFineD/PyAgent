...
@Data
public class Idea34571Config {
    private String name = "idea_034571";
 ...
 */
@Slf4j
public class Idea34571Service {
    private static final int IDEA_ID = 34571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34571Service() {
        this(new Idea34571Config());
    }

    public Idea34571Service(Idea34571Config config) {
        this.config = config != null ? config : new Idea34571Config();
