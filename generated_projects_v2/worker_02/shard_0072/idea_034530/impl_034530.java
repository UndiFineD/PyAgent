...
@Data
public class Idea34530Config {
    private String name = "idea_034530";
 ...
 */
@Slf4j
public class Idea34530Service {
    private static final int IDEA_ID = 34530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34530Service() {
        this(new Idea34530Config());
    }

    public Idea34530Service(Idea34530Config config) {
        this.config = config != null ? config : new Idea34530Config();
