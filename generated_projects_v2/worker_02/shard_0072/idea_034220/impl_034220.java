...
@Data
public class Idea34220Config {
    private String name = "idea_034220";
 ...
 */
@Slf4j
public class Idea34220Service {
    private static final int IDEA_ID = 34220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34220Service() {
        this(new Idea34220Config());
    }

    public Idea34220Service(Idea34220Config config) {
        this.config = config != null ? config : new Idea34220Config();
