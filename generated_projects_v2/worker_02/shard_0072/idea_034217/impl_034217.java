...
@Data
public class Idea34217Config {
    private String name = "idea_034217";
 ...
 */
@Slf4j
public class Idea34217Service {
    private static final int IDEA_ID = 34217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34217Service() {
        this(new Idea34217Config());
    }

    public Idea34217Service(Idea34217Config config) {
        this.config = config != null ? config : new Idea34217Config();
