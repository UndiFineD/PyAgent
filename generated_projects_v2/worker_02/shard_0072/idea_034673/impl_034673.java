...
@Data
public class Idea34673Config {
    private String name = "idea_034673";
 ...
 */
@Slf4j
public class Idea34673Service {
    private static final int IDEA_ID = 34673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34673Service() {
        this(new Idea34673Config());
    }

    public Idea34673Service(Idea34673Config config) {
        this.config = config != null ? config : new Idea34673Config();
