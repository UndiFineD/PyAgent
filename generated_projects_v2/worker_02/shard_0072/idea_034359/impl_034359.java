...
@Data
public class Idea34359Config {
    private String name = "idea_034359";
 ...
 */
@Slf4j
public class Idea34359Service {
    private static final int IDEA_ID = 34359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34359Service() {
        this(new Idea34359Config());
    }

    public Idea34359Service(Idea34359Config config) {
        this.config = config != null ? config : new Idea34359Config();
