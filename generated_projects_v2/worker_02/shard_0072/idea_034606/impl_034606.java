...
@Data
public class Idea34606Config {
    private String name = "idea_034606";
 ...
 */
@Slf4j
public class Idea34606Service {
    private static final int IDEA_ID = 34606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34606Service() {
        this(new Idea34606Config());
    }

    public Idea34606Service(Idea34606Config config) {
        this.config = config != null ? config : new Idea34606Config();
