...
@Data
public class Idea34344Config {
    private String name = "idea_034344";
 ...
 */
@Slf4j
public class Idea34344Service {
    private static final int IDEA_ID = 34344;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34344Service() {
        this(new Idea34344Config());
    }

    public Idea34344Service(Idea34344Config config) {
        this.config = config != null ? config : new Idea34344Config();
