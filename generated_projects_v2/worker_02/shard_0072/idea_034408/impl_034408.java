...
@Data
public class Idea34408Config {
    private String name = "idea_034408";
 ...
 */
@Slf4j
public class Idea34408Service {
    private static final int IDEA_ID = 34408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34408Service() {
        this(new Idea34408Config());
    }

    public Idea34408Service(Idea34408Config config) {
        this.config = config != null ? config : new Idea34408Config();
