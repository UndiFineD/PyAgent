...
@Data
public class Idea34329Config {
    private String name = "idea_034329";
 ...
 */
@Slf4j
public class Idea34329Service {
    private static final int IDEA_ID = 34329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34329Service() {
        this(new Idea34329Config());
    }

    public Idea34329Service(Idea34329Config config) {
        this.config = config != null ? config : new Idea34329Config();
