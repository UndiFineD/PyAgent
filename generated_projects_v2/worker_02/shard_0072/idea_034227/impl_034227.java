...
@Data
public class Idea34227Config {
    private String name = "idea_034227";
 ...
 */
@Slf4j
public class Idea34227Service {
    private static final int IDEA_ID = 34227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34227Service() {
        this(new Idea34227Config());
    }

    public Idea34227Service(Idea34227Config config) {
        this.config = config != null ? config : new Idea34227Config();
