...
@Data
public class Idea34669Config {
    private String name = "idea_034669";
 ...
 */
@Slf4j
public class Idea34669Service {
    private static final int IDEA_ID = 34669;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34669Service() {
        this(new Idea34669Config());
    }

    public Idea34669Service(Idea34669Config config) {
        this.config = config != null ? config : new Idea34669Config();
