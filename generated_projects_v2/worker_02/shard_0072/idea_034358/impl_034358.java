...
@Data
public class Idea34358Config {
    private String name = "idea_034358";
 ...
 */
@Slf4j
public class Idea34358Service {
    private static final int IDEA_ID = 34358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34358Service() {
        this(new Idea34358Config());
    }

    public Idea34358Service(Idea34358Config config) {
        this.config = config != null ? config : new Idea34358Config();
