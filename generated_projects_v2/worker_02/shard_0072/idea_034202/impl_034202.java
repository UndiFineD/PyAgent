...
@Data
public class Idea34202Config {
    private String name = "idea_034202";
 ...
 */
@Slf4j
public class Idea34202Service {
    private static final int IDEA_ID = 34202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34202Service() {
        this(new Idea34202Config());
    }

    public Idea34202Service(Idea34202Config config) {
        this.config = config != null ? config : new Idea34202Config();
