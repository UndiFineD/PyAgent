...
@Data
public class Idea34333Config {
    private String name = "idea_034333";
 ...
 */
@Slf4j
public class Idea34333Service {
    private static final int IDEA_ID = 34333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34333Service() {
        this(new Idea34333Config());
    }

    public Idea34333Service(Idea34333Config config) {
        this.config = config != null ? config : new Idea34333Config();
