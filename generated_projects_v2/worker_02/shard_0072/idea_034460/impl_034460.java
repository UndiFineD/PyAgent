...
@Data
public class Idea34460Config {
    private String name = "idea_034460";
 ...
 */
@Slf4j
public class Idea34460Service {
    private static final int IDEA_ID = 34460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34460Service() {
        this(new Idea34460Config());
    }

    public Idea34460Service(Idea34460Config config) {
        this.config = config != null ? config : new Idea34460Config();
