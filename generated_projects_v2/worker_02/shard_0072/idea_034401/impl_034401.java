...
@Data
public class Idea34401Config {
    private String name = "idea_034401";
 ...
 */
@Slf4j
public class Idea34401Service {
    private static final int IDEA_ID = 34401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34401Service() {
        this(new Idea34401Config());
    }

    public Idea34401Service(Idea34401Config config) {
        this.config = config != null ? config : new Idea34401Config();
