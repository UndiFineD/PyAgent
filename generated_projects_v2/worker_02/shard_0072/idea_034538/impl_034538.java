...
@Data
public class Idea34538Config {
    private String name = "idea_034538";
 ...
 */
@Slf4j
public class Idea34538Service {
    private static final int IDEA_ID = 34538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34538Service() {
        this(new Idea34538Config());
    }

    public Idea34538Service(Idea34538Config config) {
        this.config = config != null ? config : new Idea34538Config();
