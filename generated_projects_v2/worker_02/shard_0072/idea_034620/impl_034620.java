...
@Data
public class Idea34620Config {
    private String name = "idea_034620";
 ...
 */
@Slf4j
public class Idea34620Service {
    private static final int IDEA_ID = 34620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34620Service() {
        this(new Idea34620Config());
    }

    public Idea34620Service(Idea34620Config config) {
        this.config = config != null ? config : new Idea34620Config();
