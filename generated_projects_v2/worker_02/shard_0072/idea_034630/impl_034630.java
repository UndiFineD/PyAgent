...
@Data
public class Idea34630Config {
    private String name = "idea_034630";
 ...
 */
@Slf4j
public class Idea34630Service {
    private static final int IDEA_ID = 34630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34630Service() {
        this(new Idea34630Config());
    }

    public Idea34630Service(Idea34630Config config) {
        this.config = config != null ? config : new Idea34630Config();
