...
@Data
public class Idea34331Config {
    private String name = "idea_034331";
 ...
 */
@Slf4j
public class Idea34331Service {
    private static final int IDEA_ID = 34331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34331Service() {
        this(new Idea34331Config());
    }

    public Idea34331Service(Idea34331Config config) {
        this.config = config != null ? config : new Idea34331Config();
