...
@Data
public class Idea34348Config {
    private String name = "idea_034348";
 ...
 */
@Slf4j
public class Idea34348Service {
    private static final int IDEA_ID = 34348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34348Service() {
        this(new Idea34348Config());
    }

    public Idea34348Service(Idea34348Config config) {
        this.config = config != null ? config : new Idea34348Config();
