...
@Data
public class Idea34612Config {
    private String name = "idea_034612";
 ...
 */
@Slf4j
public class Idea34612Service {
    private static final int IDEA_ID = 34612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34612Service() {
        this(new Idea34612Config());
    }

    public Idea34612Service(Idea34612Config config) {
        this.config = config != null ? config : new Idea34612Config();
