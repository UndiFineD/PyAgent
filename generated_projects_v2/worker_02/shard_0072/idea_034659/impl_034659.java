...
@Data
public class Idea34659Config {
    private String name = "idea_034659";
 ...
 */
@Slf4j
public class Idea34659Service {
    private static final int IDEA_ID = 34659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34659Service() {
        this(new Idea34659Config());
    }

    public Idea34659Service(Idea34659Config config) {
        this.config = config != null ? config : new Idea34659Config();
