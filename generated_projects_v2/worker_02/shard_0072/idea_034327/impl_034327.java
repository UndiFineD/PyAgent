...
@Data
public class Idea34327Config {
    private String name = "idea_034327";
 ...
 */
@Slf4j
public class Idea34327Service {
    private static final int IDEA_ID = 34327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34327Service() {
        this(new Idea34327Config());
    }

    public Idea34327Service(Idea34327Config config) {
        this.config = config != null ? config : new Idea34327Config();
