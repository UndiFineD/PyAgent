...
@Data
public class Idea34204Config {
    private String name = "idea_034204";
 ...
 */
@Slf4j
public class Idea34204Service {
    private static final int IDEA_ID = 34204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34204Service() {
        this(new Idea34204Config());
    }

    public Idea34204Service(Idea34204Config config) {
        this.config = config != null ? config : new Idea34204Config();
