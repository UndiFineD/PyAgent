...
@Data
public class Idea34604Config {
    private String name = "idea_034604";
 ...
 */
@Slf4j
public class Idea34604Service {
    private static final int IDEA_ID = 34604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34604Service() {
        this(new Idea34604Config());
    }

    public Idea34604Service(Idea34604Config config) {
        this.config = config != null ? config : new Idea34604Config();
