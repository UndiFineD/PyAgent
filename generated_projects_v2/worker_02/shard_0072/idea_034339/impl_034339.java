...
@Data
public class Idea34339Config {
    private String name = "idea_034339";
 ...
 */
@Slf4j
public class Idea34339Service {
    private static final int IDEA_ID = 34339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34339Service() {
        this(new Idea34339Config());
    }

    public Idea34339Service(Idea34339Config config) {
        this.config = config != null ? config : new Idea34339Config();
