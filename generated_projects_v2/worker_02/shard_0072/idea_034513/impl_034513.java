...
@Data
public class Idea34513Config {
    private String name = "idea_034513";
 ...
 */
@Slf4j
public class Idea34513Service {
    private static final int IDEA_ID = 34513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34513Service() {
        this(new Idea34513Config());
    }

    public Idea34513Service(Idea34513Config config) {
        this.config = config != null ? config : new Idea34513Config();
