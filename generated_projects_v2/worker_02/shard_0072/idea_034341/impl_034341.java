...
@Data
public class Idea34341Config {
    private String name = "idea_034341";
 ...
 */
@Slf4j
public class Idea34341Service {
    private static final int IDEA_ID = 34341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34341Service() {
        this(new Idea34341Config());
    }

    public Idea34341Service(Idea34341Config config) {
        this.config = config != null ? config : new Idea34341Config();
