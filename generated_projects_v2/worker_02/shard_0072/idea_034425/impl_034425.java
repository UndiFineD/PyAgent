...
@Data
public class Idea34425Config {
    private String name = "idea_034425";
 ...
 */
@Slf4j
public class Idea34425Service {
    private static final int IDEA_ID = 34425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34425Service() {
        this(new Idea34425Config());
    }

    public Idea34425Service(Idea34425Config config) {
        this.config = config != null ? config : new Idea34425Config();
