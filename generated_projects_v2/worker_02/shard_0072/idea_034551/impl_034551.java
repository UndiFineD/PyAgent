...
@Data
public class Idea34551Config {
    private String name = "idea_034551";
 ...
 */
@Slf4j
public class Idea34551Service {
    private static final int IDEA_ID = 34551;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34551Service() {
        this(new Idea34551Config());
    }

    public Idea34551Service(Idea34551Config config) {
        this.config = config != null ? config : new Idea34551Config();
