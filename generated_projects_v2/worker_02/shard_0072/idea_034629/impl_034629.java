...
@Data
public class Idea34629Config {
    private String name = "idea_034629";
 ...
 */
@Slf4j
public class Idea34629Service {
    private static final int IDEA_ID = 34629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34629Service() {
        this(new Idea34629Config());
    }

    public Idea34629Service(Idea34629Config config) {
        this.config = config != null ? config : new Idea34629Config();
