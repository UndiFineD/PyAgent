...
@Data
public class Idea34250Config {
    private String name = "idea_034250";
 ...
 */
@Slf4j
public class Idea34250Service {
    private static final int IDEA_ID = 34250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34250Service() {
        this(new Idea34250Config());
    }

    public Idea34250Service(Idea34250Config config) {
        this.config = config != null ? config : new Idea34250Config();
