...
@Data
public class Idea34233Config {
    private String name = "idea_034233";
 ...
 */
@Slf4j
public class Idea34233Service {
    private static final int IDEA_ID = 34233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34233Service() {
        this(new Idea34233Config());
    }

    public Idea34233Service(Idea34233Config config) {
        this.config = config != null ? config : new Idea34233Config();
