...
@Data
public class Idea34534Config {
    private String name = "idea_034534";
 ...
 */
@Slf4j
public class Idea34534Service {
    private static final int IDEA_ID = 34534;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34534Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34534Service() {
        this(new Idea34534Config());
    }

    public Idea34534Service(Idea34534Config config) {
        this.config = config != null ? config : new Idea34534Config();
