...
@Data
public class Idea34521Config {
    private String name = "idea_034521";
 ...
 */
@Slf4j
public class Idea34521Service {
    private static final int IDEA_ID = 34521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34521Service() {
        this(new Idea34521Config());
    }

    public Idea34521Service(Idea34521Config config) {
        this.config = config != null ? config : new Idea34521Config();
