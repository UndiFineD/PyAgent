...
@Data
public class Idea34608Config {
    private String name = "idea_034608";
 ...
 */
@Slf4j
public class Idea34608Service {
    private static final int IDEA_ID = 34608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34608Service() {
        this(new Idea34608Config());
    }

    public Idea34608Service(Idea34608Config config) {
        this.config = config != null ? config : new Idea34608Config();
