...
@Data
public class Idea34467Config {
    private String name = "idea_034467";
 ...
 */
@Slf4j
public class Idea34467Service {
    private static final int IDEA_ID = 34467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34467Service() {
        this(new Idea34467Config());
    }

    public Idea34467Service(Idea34467Config config) {
        this.config = config != null ? config : new Idea34467Config();
