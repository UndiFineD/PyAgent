...
@Data
public class Idea34376Config {
    private String name = "idea_034376";
 ...
 */
@Slf4j
public class Idea34376Service {
    private static final int IDEA_ID = 34376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34376Service() {
        this(new Idea34376Config());
    }

    public Idea34376Service(Idea34376Config config) {
        this.config = config != null ? config : new Idea34376Config();
