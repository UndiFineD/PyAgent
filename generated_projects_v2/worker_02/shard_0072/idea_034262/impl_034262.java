...
@Data
public class Idea34262Config {
    private String name = "idea_034262";
 ...
 */
@Slf4j
public class Idea34262Service {
    private static final int IDEA_ID = 34262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34262Service() {
        this(new Idea34262Config());
    }

    public Idea34262Service(Idea34262Config config) {
        this.config = config != null ? config : new Idea34262Config();
