...
@Data
public class Idea34255Config {
    private String name = "idea_034255";
 ...
 */
@Slf4j
public class Idea34255Service {
    private static final int IDEA_ID = 34255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34255Service() {
        this(new Idea34255Config());
    }

    public Idea34255Service(Idea34255Config config) {
        this.config = config != null ? config : new Idea34255Config();
