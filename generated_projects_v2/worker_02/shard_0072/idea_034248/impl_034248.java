...
@Data
public class Idea34248Config {
    private String name = "idea_034248";
 ...
 */
@Slf4j
public class Idea34248Service {
    private static final int IDEA_ID = 34248;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34248Service() {
        this(new Idea34248Config());
    }

    public Idea34248Service(Idea34248Config config) {
        this.config = config != null ? config : new Idea34248Config();
