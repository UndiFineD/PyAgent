...
@Data
public class Idea34655Config {
    private String name = "idea_034655";
 ...
 */
@Slf4j
public class Idea34655Service {
    private static final int IDEA_ID = 34655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34655Service() {
        this(new Idea34655Config());
    }

    public Idea34655Service(Idea34655Config config) {
        this.config = config != null ? config : new Idea34655Config();
