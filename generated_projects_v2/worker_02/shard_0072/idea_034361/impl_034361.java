...
@Data
public class Idea34361Config {
    private String name = "idea_034361";
 ...
 */
@Slf4j
public class Idea34361Service {
    private static final int IDEA_ID = 34361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34361Service() {
        this(new Idea34361Config());
    }

    public Idea34361Service(Idea34361Config config) {
        this.config = config != null ? config : new Idea34361Config();
