...
@Data
public class Idea34435Config {
    private String name = "idea_034435";
 ...
 */
@Slf4j
public class Idea34435Service {
    private static final int IDEA_ID = 34435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34435Service() {
        this(new Idea34435Config());
    }

    public Idea34435Service(Idea34435Config config) {
        this.config = config != null ? config : new Idea34435Config();
