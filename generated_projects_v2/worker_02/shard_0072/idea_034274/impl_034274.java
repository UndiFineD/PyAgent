...
@Data
public class Idea34274Config {
    private String name = "idea_034274";
 ...
 */
@Slf4j
public class Idea34274Service {
    private static final int IDEA_ID = 34274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34274Service() {
        this(new Idea34274Config());
    }

    public Idea34274Service(Idea34274Config config) {
        this.config = config != null ? config : new Idea34274Config();
