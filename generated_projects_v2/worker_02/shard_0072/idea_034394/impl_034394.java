...
@Data
public class Idea34394Config {
    private String name = "idea_034394";
 ...
 */
@Slf4j
public class Idea34394Service {
    private static final int IDEA_ID = 34394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34394Service() {
        this(new Idea34394Config());
    }

    public Idea34394Service(Idea34394Config config) {
        this.config = config != null ? config : new Idea34394Config();
