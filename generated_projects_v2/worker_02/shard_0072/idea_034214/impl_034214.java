...
@Data
public class Idea34214Config {
    private String name = "idea_034214";
 ...
 */
@Slf4j
public class Idea34214Service {
    private static final int IDEA_ID = 34214;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34214Service() {
        this(new Idea34214Config());
    }

    public Idea34214Service(Idea34214Config config) {
        this.config = config != null ? config : new Idea34214Config();
