...
@Data
public class Idea34347Config {
    private String name = "idea_034347";
 ...
 */
@Slf4j
public class Idea34347Service {
    private static final int IDEA_ID = 34347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34347Service() {
        this(new Idea34347Config());
    }

    public Idea34347Service(Idea34347Config config) {
        this.config = config != null ? config : new Idea34347Config();
