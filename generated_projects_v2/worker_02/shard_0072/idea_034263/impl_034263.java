...
@Data
public class Idea34263Config {
    private String name = "idea_034263";
 ...
 */
@Slf4j
public class Idea34263Service {
    private static final int IDEA_ID = 34263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34263Service() {
        this(new Idea34263Config());
    }

    public Idea34263Service(Idea34263Config config) {
        this.config = config != null ? config : new Idea34263Config();
