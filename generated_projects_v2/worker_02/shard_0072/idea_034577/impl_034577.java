...
@Data
public class Idea34577Config {
    private String name = "idea_034577";
 ...
 */
@Slf4j
public class Idea34577Service {
    private static final int IDEA_ID = 34577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34577Service() {
        this(new Idea34577Config());
    }

    public Idea34577Service(Idea34577Config config) {
        this.config = config != null ? config : new Idea34577Config();
