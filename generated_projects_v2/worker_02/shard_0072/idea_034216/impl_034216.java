...
@Data
public class Idea34216Config {
    private String name = "idea_034216";
 ...
 */
@Slf4j
public class Idea34216Service {
    private static final int IDEA_ID = 34216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34216Service() {
        this(new Idea34216Config());
    }

    public Idea34216Service(Idea34216Config config) {
        this.config = config != null ? config : new Idea34216Config();
