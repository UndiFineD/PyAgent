...
@Data
public class Idea34267Config {
    private String name = "idea_034267";
 ...
 */
@Slf4j
public class Idea34267Service {
    private static final int IDEA_ID = 34267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34267Service() {
        this(new Idea34267Config());
    }

    public Idea34267Service(Idea34267Config config) {
        this.config = config != null ? config : new Idea34267Config();
