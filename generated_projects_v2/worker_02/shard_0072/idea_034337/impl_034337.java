...
@Data
public class Idea34337Config {
    private String name = "idea_034337";
 ...
 */
@Slf4j
public class Idea34337Service {
    private static final int IDEA_ID = 34337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34337Service() {
        this(new Idea34337Config());
    }

    public Idea34337Service(Idea34337Config config) {
        this.config = config != null ? config : new Idea34337Config();
