...
@Data
public class Idea34651Config {
    private String name = "idea_034651";
 ...
 */
@Slf4j
public class Idea34651Service {
    private static final int IDEA_ID = 34651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34651Service() {
        this(new Idea34651Config());
    }

    public Idea34651Service(Idea34651Config config) {
        this.config = config != null ? config : new Idea34651Config();
