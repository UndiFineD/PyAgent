...
@Data
public class Idea34602Config {
    private String name = "idea_034602";
 ...
 */
@Slf4j
public class Idea34602Service {
    private static final int IDEA_ID = 34602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34602Service() {
        this(new Idea34602Config());
    }

    public Idea34602Service(Idea34602Config config) {
        this.config = config != null ? config : new Idea34602Config();
