...
@Data
public class Idea34491Config {
    private String name = "idea_034491";
 ...
 */
@Slf4j
public class Idea34491Service {
    private static final int IDEA_ID = 34491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34491Service() {
        this(new Idea34491Config());
    }

    public Idea34491Service(Idea34491Config config) {
        this.config = config != null ? config : new Idea34491Config();
