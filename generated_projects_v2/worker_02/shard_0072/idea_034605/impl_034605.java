...
@Data
public class Idea34605Config {
    private String name = "idea_034605";
 ...
 */
@Slf4j
public class Idea34605Service {
    private static final int IDEA_ID = 34605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34605Service() {
        this(new Idea34605Config());
    }

    public Idea34605Service(Idea34605Config config) {
        this.config = config != null ? config : new Idea34605Config();
