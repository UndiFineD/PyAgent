...
@Data
public class Idea34567Config {
    private String name = "idea_034567";
 ...
 */
@Slf4j
public class Idea34567Service {
    private static final int IDEA_ID = 34567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34567Service() {
        this(new Idea34567Config());
    }

    public Idea34567Service(Idea34567Config config) {
        this.config = config != null ? config : new Idea34567Config();
