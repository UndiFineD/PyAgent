...
@Data
public class Idea34465Config {
    private String name = "idea_034465";
 ...
 */
@Slf4j
public class Idea34465Service {
    private static final int IDEA_ID = 34465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34465Service() {
        this(new Idea34465Config());
    }

    public Idea34465Service(Idea34465Config config) {
        this.config = config != null ? config : new Idea34465Config();
