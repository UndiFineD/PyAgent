...
@Data
public class Idea34657Config {
    private String name = "idea_034657";
 ...
 */
@Slf4j
public class Idea34657Service {
    private static final int IDEA_ID = 34657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34657Service() {
        this(new Idea34657Config());
    }

    public Idea34657Service(Idea34657Config config) {
        this.config = config != null ? config : new Idea34657Config();
