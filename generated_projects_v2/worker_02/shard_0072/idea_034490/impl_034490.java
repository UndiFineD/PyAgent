...
@Data
public class Idea34490Config {
    private String name = "idea_034490";
 ...
 */
@Slf4j
public class Idea34490Service {
    private static final int IDEA_ID = 34490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34490Service() {
        this(new Idea34490Config());
    }

    public Idea34490Service(Idea34490Config config) {
        this.config = config != null ? config : new Idea34490Config();
