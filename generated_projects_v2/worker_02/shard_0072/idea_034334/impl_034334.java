...
@Data
public class Idea34334Config {
    private String name = "idea_034334";
 ...
 */
@Slf4j
public class Idea34334Service {
    private static final int IDEA_ID = 34334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34334Service() {
        this(new Idea34334Config());
    }

    public Idea34334Service(Idea34334Config config) {
        this.config = config != null ? config : new Idea34334Config();
