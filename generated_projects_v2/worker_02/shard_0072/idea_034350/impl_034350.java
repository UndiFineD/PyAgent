...
@Data
public class Idea34350Config {
    private String name = "idea_034350";
 ...
 */
@Slf4j
public class Idea34350Service {
    private static final int IDEA_ID = 34350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34350Service() {
        this(new Idea34350Config());
    }

    public Idea34350Service(Idea34350Config config) {
        this.config = config != null ? config : new Idea34350Config();
