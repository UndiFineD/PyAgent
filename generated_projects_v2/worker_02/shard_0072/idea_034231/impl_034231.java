...
@Data
public class Idea34231Config {
    private String name = "idea_034231";
 ...
 */
@Slf4j
public class Idea34231Service {
    private static final int IDEA_ID = 34231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34231Service() {
        this(new Idea34231Config());
    }

    public Idea34231Service(Idea34231Config config) {
        this.config = config != null ? config : new Idea34231Config();
