...
@Data
public class Idea34508Config {
    private String name = "idea_034508";
 ...
 */
@Slf4j
public class Idea34508Service {
    private static final int IDEA_ID = 34508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34508Service() {
        this(new Idea34508Config());
    }

    public Idea34508Service(Idea34508Config config) {
        this.config = config != null ? config : new Idea34508Config();
