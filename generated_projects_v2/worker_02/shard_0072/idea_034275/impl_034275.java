...
@Data
public class Idea34275Config {
    private String name = "idea_034275";
 ...
 */
@Slf4j
public class Idea34275Service {
    private static final int IDEA_ID = 34275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34275Service() {
        this(new Idea34275Config());
    }

    public Idea34275Service(Idea34275Config config) {
        this.config = config != null ? config : new Idea34275Config();
