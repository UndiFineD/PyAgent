...
@Data
public class Idea34368Config {
    private String name = "idea_034368";
 ...
 */
@Slf4j
public class Idea34368Service {
    private static final int IDEA_ID = 34368;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34368Service() {
        this(new Idea34368Config());
    }

    public Idea34368Service(Idea34368Config config) {
        this.config = config != null ? config : new Idea34368Config();
