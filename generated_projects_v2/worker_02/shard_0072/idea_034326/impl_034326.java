...
@Data
public class Idea34326Config {
    private String name = "idea_034326";
 ...
 */
@Slf4j
public class Idea34326Service {
    private static final int IDEA_ID = 34326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34326Service() {
        this(new Idea34326Config());
    }

    public Idea34326Service(Idea34326Config config) {
        this.config = config != null ? config : new Idea34326Config();
