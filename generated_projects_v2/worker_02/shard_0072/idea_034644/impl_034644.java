...
@Data
public class Idea34644Config {
    private String name = "idea_034644";
 ...
 */
@Slf4j
public class Idea34644Service {
    private static final int IDEA_ID = 34644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34644Service() {
        this(new Idea34644Config());
    }

    public Idea34644Service(Idea34644Config config) {
        this.config = config != null ? config : new Idea34644Config();
