...
@Data
public class Idea34212Config {
    private String name = "idea_034212";
 ...
 */
@Slf4j
public class Idea34212Service {
    private static final int IDEA_ID = 34212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34212Service() {
        this(new Idea34212Config());
    }

    public Idea34212Service(Idea34212Config config) {
        this.config = config != null ? config : new Idea34212Config();
