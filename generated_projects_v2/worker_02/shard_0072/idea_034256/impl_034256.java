...
@Data
public class Idea34256Config {
    private String name = "idea_034256";
 ...
 */
@Slf4j
public class Idea34256Service {
    private static final int IDEA_ID = 34256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34256Service() {
        this(new Idea34256Config());
    }

    public Idea34256Service(Idea34256Config config) {
        this.config = config != null ? config : new Idea34256Config();
