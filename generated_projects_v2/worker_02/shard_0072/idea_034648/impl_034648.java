...
@Data
public class Idea34648Config {
    private String name = "idea_034648";
 ...
 */
@Slf4j
public class Idea34648Service {
    private static final int IDEA_ID = 34648;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34648Service() {
        this(new Idea34648Config());
    }

    public Idea34648Service(Idea34648Config config) {
        this.config = config != null ? config : new Idea34648Config();
