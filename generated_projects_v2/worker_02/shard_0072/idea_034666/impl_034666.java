...
@Data
public class Idea34666Config {
    private String name = "idea_034666";
 ...
 */
@Slf4j
public class Idea34666Service {
    private static final int IDEA_ID = 34666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34666Service() {
        this(new Idea34666Config());
    }

    public Idea34666Service(Idea34666Config config) {
        this.config = config != null ? config : new Idea34666Config();
