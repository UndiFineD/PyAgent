...
@Data
public class Idea34623Config {
    private String name = "idea_034623";
 ...
 */
@Slf4j
public class Idea34623Service {
    private static final int IDEA_ID = 34623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34623Service() {
        this(new Idea34623Config());
    }

    public Idea34623Service(Idea34623Config config) {
        this.config = config != null ? config : new Idea34623Config();
