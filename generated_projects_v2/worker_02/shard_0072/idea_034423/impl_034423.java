...
@Data
public class Idea34423Config {
    private String name = "idea_034423";
 ...
 */
@Slf4j
public class Idea34423Service {
    private static final int IDEA_ID = 34423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34423Service() {
        this(new Idea34423Config());
    }

    public Idea34423Service(Idea34423Config config) {
        this.config = config != null ? config : new Idea34423Config();
