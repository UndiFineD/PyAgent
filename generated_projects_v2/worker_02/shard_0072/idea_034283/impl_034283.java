...
@Data
public class Idea34283Config {
    private String name = "idea_034283";
 ...
 */
@Slf4j
public class Idea34283Service {
    private static final int IDEA_ID = 34283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34283Service() {
        this(new Idea34283Config());
    }

    public Idea34283Service(Idea34283Config config) {
        this.config = config != null ? config : new Idea34283Config();
