...
@Data
public class Idea34360Config {
    private String name = "idea_034360";
 ...
 */
@Slf4j
public class Idea34360Service {
    private static final int IDEA_ID = 34360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34360Service() {
        this(new Idea34360Config());
    }

    public Idea34360Service(Idea34360Config config) {
        this.config = config != null ? config : new Idea34360Config();
