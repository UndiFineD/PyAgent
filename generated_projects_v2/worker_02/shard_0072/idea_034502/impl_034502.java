...
@Data
public class Idea34502Config {
    private String name = "idea_034502";
 ...
 */
@Slf4j
public class Idea34502Service {
    private static final int IDEA_ID = 34502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34502Service() {
        this(new Idea34502Config());
    }

    public Idea34502Service(Idea34502Config config) {
        this.config = config != null ? config : new Idea34502Config();
