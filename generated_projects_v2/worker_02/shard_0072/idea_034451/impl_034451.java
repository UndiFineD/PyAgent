...
@Data
public class Idea34451Config {
    private String name = "idea_034451";
 ...
 */
@Slf4j
public class Idea34451Service {
    private static final int IDEA_ID = 34451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34451Service() {
        this(new Idea34451Config());
    }

    public Idea34451Service(Idea34451Config config) {
        this.config = config != null ? config : new Idea34451Config();
