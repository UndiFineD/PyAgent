...
@Data
public class Idea34277Config {
    private String name = "idea_034277";
 ...
 */
@Slf4j
public class Idea34277Service {
    private static final int IDEA_ID = 34277;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34277Service() {
        this(new Idea34277Config());
    }

    public Idea34277Service(Idea34277Config config) {
        this.config = config != null ? config : new Idea34277Config();
