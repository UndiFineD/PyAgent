...
@Data
public class Idea34404Config {
    private String name = "idea_034404";
 ...
 */
@Slf4j
public class Idea34404Service {
    private static final int IDEA_ID = 34404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34404Service() {
        this(new Idea34404Config());
    }

    public Idea34404Service(Idea34404Config config) {
        this.config = config != null ? config : new Idea34404Config();
