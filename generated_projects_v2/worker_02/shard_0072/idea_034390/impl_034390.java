...
@Data
public class Idea34390Config {
    private String name = "idea_034390";
 ...
 */
@Slf4j
public class Idea34390Service {
    private static final int IDEA_ID = 34390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34390Service() {
        this(new Idea34390Config());
    }

    public Idea34390Service(Idea34390Config config) {
        this.config = config != null ? config : new Idea34390Config();
