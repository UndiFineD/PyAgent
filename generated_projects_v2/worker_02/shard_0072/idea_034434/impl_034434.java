...
@Data
public class Idea34434Config {
    private String name = "idea_034434";
 ...
 */
@Slf4j
public class Idea34434Service {
    private static final int IDEA_ID = 34434;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34434Service() {
        this(new Idea34434Config());
    }

    public Idea34434Service(Idea34434Config config) {
        this.config = config != null ? config : new Idea34434Config();
