...
@Data
public class Idea34489Config {
    private String name = "idea_034489";
 ...
 */
@Slf4j
public class Idea34489Service {
    private static final int IDEA_ID = 34489;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34489Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34489Service() {
        this(new Idea34489Config());
    }

    public Idea34489Service(Idea34489Config config) {
        this.config = config != null ? config : new Idea34489Config();
