...
@Data
public class Idea34665Config {
    private String name = "idea_034665";
 ...
 */
@Slf4j
public class Idea34665Service {
    private static final int IDEA_ID = 34665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34665Service() {
        this(new Idea34665Config());
    }

    public Idea34665Service(Idea34665Config config) {
        this.config = config != null ? config : new Idea34665Config();
