...
@Data
public class Idea34335Config {
    private String name = "idea_034335";
 ...
 */
@Slf4j
public class Idea34335Service {
    private static final int IDEA_ID = 34335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34335Service() {
        this(new Idea34335Config());
    }

    public Idea34335Service(Idea34335Config config) {
        this.config = config != null ? config : new Idea34335Config();
