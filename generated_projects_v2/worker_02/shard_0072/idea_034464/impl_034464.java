...
@Data
public class Idea34464Config {
    private String name = "idea_034464";
 ...
 */
@Slf4j
public class Idea34464Service {
    private static final int IDEA_ID = 34464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34464Service() {
        this(new Idea34464Config());
    }

    public Idea34464Service(Idea34464Config config) {
        this.config = config != null ? config : new Idea34464Config();
