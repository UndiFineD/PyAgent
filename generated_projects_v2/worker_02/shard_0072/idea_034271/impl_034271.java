...
@Data
public class Idea34271Config {
    private String name = "idea_034271";
 ...
 */
@Slf4j
public class Idea34271Service {
    private static final int IDEA_ID = 34271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34271Service() {
        this(new Idea34271Config());
    }

    public Idea34271Service(Idea34271Config config) {
        this.config = config != null ? config : new Idea34271Config();
