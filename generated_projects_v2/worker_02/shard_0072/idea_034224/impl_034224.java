...
@Data
public class Idea34224Config {
    private String name = "idea_034224";
 ...
 */
@Slf4j
public class Idea34224Service {
    private static final int IDEA_ID = 34224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34224Service() {
        this(new Idea34224Config());
    }

    public Idea34224Service(Idea34224Config config) {
        this.config = config != null ? config : new Idea34224Config();
