...
@Data
public class Idea34410Config {
    private String name = "idea_034410";
 ...
 */
@Slf4j
public class Idea34410Service {
    private static final int IDEA_ID = 34410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34410Service() {
        this(new Idea34410Config());
    }

    public Idea34410Service(Idea34410Config config) {
        this.config = config != null ? config : new Idea34410Config();
