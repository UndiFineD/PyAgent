...
@Data
public class Idea34222Config {
    private String name = "idea_034222";
 ...
 */
@Slf4j
public class Idea34222Service {
    private static final int IDEA_ID = 34222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34222Service() {
        this(new Idea34222Config());
    }

    public Idea34222Service(Idea34222Config config) {
        this.config = config != null ? config : new Idea34222Config();
