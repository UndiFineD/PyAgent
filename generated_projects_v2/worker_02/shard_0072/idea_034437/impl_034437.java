...
@Data
public class Idea34437Config {
    private String name = "idea_034437";
 ...
 */
@Slf4j
public class Idea34437Service {
    private static final int IDEA_ID = 34437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34437Service() {
        this(new Idea34437Config());
    }

    public Idea34437Service(Idea34437Config config) {
        this.config = config != null ? config : new Idea34437Config();
