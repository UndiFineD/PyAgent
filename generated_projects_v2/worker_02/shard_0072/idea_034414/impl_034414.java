...
@Data
public class Idea34414Config {
    private String name = "idea_034414";
 ...
 */
@Slf4j
public class Idea34414Service {
    private static final int IDEA_ID = 34414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34414Service() {
        this(new Idea34414Config());
    }

    public Idea34414Service(Idea34414Config config) {
        this.config = config != null ? config : new Idea34414Config();
