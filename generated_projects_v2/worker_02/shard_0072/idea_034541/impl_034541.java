...
@Data
public class Idea34541Config {
    private String name = "idea_034541";
 ...
 */
@Slf4j
public class Idea34541Service {
    private static final int IDEA_ID = 34541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34541Service() {
        this(new Idea34541Config());
    }

    public Idea34541Service(Idea34541Config config) {
        this.config = config != null ? config : new Idea34541Config();
