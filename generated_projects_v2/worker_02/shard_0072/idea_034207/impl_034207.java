...
@Data
public class Idea34207Config {
    private String name = "idea_034207";
 ...
 */
@Slf4j
public class Idea34207Service {
    private static final int IDEA_ID = 34207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34207Service() {
        this(new Idea34207Config());
    }

    public Idea34207Service(Idea34207Config config) {
        this.config = config != null ? config : new Idea34207Config();
