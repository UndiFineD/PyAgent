...
@Data
public class Idea34603Config {
    private String name = "idea_034603";
 ...
 */
@Slf4j
public class Idea34603Service {
    private static final int IDEA_ID = 34603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34603Service() {
        this(new Idea34603Config());
    }

    public Idea34603Service(Idea34603Config config) {
        this.config = config != null ? config : new Idea34603Config();
