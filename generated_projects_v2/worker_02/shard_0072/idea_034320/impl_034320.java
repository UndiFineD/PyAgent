...
@Data
public class Idea34320Config {
    private String name = "idea_034320";
 ...
 */
@Slf4j
public class Idea34320Service {
    private static final int IDEA_ID = 34320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34320Service() {
        this(new Idea34320Config());
    }

    public Idea34320Service(Idea34320Config config) {
        this.config = config != null ? config : new Idea34320Config();
