...
@Data
public class Idea34314Config {
    private String name = "idea_034314";
 ...
 */
@Slf4j
public class Idea34314Service {
    private static final int IDEA_ID = 34314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34314Service() {
        this(new Idea34314Config());
    }

    public Idea34314Service(Idea34314Config config) {
        this.config = config != null ? config : new Idea34314Config();
