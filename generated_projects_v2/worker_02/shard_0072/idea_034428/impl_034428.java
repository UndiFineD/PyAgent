...
@Data
public class Idea34428Config {
    private String name = "idea_034428";
 ...
 */
@Slf4j
public class Idea34428Service {
    private static final int IDEA_ID = 34428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34428Service() {
        this(new Idea34428Config());
    }

    public Idea34428Service(Idea34428Config config) {
        this.config = config != null ? config : new Idea34428Config();
