...
@Data
public class Idea34372Config {
    private String name = "idea_034372";
 ...
 */
@Slf4j
public class Idea34372Service {
    private static final int IDEA_ID = 34372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34372Service() {
        this(new Idea34372Config());
    }

    public Idea34372Service(Idea34372Config config) {
        this.config = config != null ? config : new Idea34372Config();
