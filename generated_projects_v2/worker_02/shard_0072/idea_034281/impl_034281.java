...
@Data
public class Idea34281Config {
    private String name = "idea_034281";
 ...
 */
@Slf4j
public class Idea34281Service {
    private static final int IDEA_ID = 34281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34281Service() {
        this(new Idea34281Config());
    }

    public Idea34281Service(Idea34281Config config) {
        this.config = config != null ? config : new Idea34281Config();
