...
@Data
public class Idea34398Config {
    private String name = "idea_034398";
 ...
 */
@Slf4j
public class Idea34398Service {
    private static final int IDEA_ID = 34398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34398Service() {
        this(new Idea34398Config());
    }

    public Idea34398Service(Idea34398Config config) {
        this.config = config != null ? config : new Idea34398Config();
