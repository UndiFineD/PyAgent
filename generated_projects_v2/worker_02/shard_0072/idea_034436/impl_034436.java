...
@Data
public class Idea34436Config {
    private String name = "idea_034436";
 ...
 */
@Slf4j
public class Idea34436Service {
    private static final int IDEA_ID = 34436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34436Service() {
        this(new Idea34436Config());
    }

    public Idea34436Service(Idea34436Config config) {
        this.config = config != null ? config : new Idea34436Config();
