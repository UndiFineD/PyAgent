...
@Data
public class Idea34441Config {
    private String name = "idea_034441";
 ...
 */
@Slf4j
public class Idea34441Service {
    private static final int IDEA_ID = 34441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34441Service() {
        this(new Idea34441Config());
    }

    public Idea34441Service(Idea34441Config config) {
        this.config = config != null ? config : new Idea34441Config();
