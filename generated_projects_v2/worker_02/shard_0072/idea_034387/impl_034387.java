...
@Data
public class Idea34387Config {
    private String name = "idea_034387";
 ...
 */
@Slf4j
public class Idea34387Service {
    private static final int IDEA_ID = 34387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34387Service() {
        this(new Idea34387Config());
    }

    public Idea34387Service(Idea34387Config config) {
        this.config = config != null ? config : new Idea34387Config();
