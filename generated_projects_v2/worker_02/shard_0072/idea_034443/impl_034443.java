...
@Data
public class Idea34443Config {
    private String name = "idea_034443";
 ...
 */
@Slf4j
public class Idea34443Service {
    private static final int IDEA_ID = 34443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34443Service() {
        this(new Idea34443Config());
    }

    public Idea34443Service(Idea34443Config config) {
        this.config = config != null ? config : new Idea34443Config();
