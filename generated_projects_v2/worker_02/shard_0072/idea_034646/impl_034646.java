...
@Data
public class Idea34646Config {
    private String name = "idea_034646";
 ...
 */
@Slf4j
public class Idea34646Service {
    private static final int IDEA_ID = 34646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34646Service() {
        this(new Idea34646Config());
    }

    public Idea34646Service(Idea34646Config config) {
        this.config = config != null ? config : new Idea34646Config();
