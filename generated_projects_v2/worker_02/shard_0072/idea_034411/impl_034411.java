...
@Data
public class Idea34411Config {
    private String name = "idea_034411";
 ...
 */
@Slf4j
public class Idea34411Service {
    private static final int IDEA_ID = 34411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34411Service() {
        this(new Idea34411Config());
    }

    public Idea34411Service(Idea34411Config config) {
        this.config = config != null ? config : new Idea34411Config();
