...
@Data
public class Idea34478Config {
    private String name = "idea_034478";
 ...
 */
@Slf4j
public class Idea34478Service {
    private static final int IDEA_ID = 34478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34478Service() {
        this(new Idea34478Config());
    }

    public Idea34478Service(Idea34478Config config) {
        this.config = config != null ? config : new Idea34478Config();
