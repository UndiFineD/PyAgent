...
@Data
public class Idea34270Config {
    private String name = "idea_034270";
 ...
 */
@Slf4j
public class Idea34270Service {
    private static final int IDEA_ID = 34270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34270Service() {
        this(new Idea34270Config());
    }

    public Idea34270Service(Idea34270Config config) {
        this.config = config != null ? config : new Idea34270Config();
