...
@Data
public class Idea34265Config {
    private String name = "idea_034265";
 ...
 */
@Slf4j
public class Idea34265Service {
    private static final int IDEA_ID = 34265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34265Service() {
        this(new Idea34265Config());
    }

    public Idea34265Service(Idea34265Config config) {
        this.config = config != null ? config : new Idea34265Config();
