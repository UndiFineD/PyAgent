...
@Data
public class Idea34383Config {
    private String name = "idea_034383";
 ...
 */
@Slf4j
public class Idea34383Service {
    private static final int IDEA_ID = 34383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34383Service() {
        this(new Idea34383Config());
    }

    public Idea34383Service(Idea34383Config config) {
        this.config = config != null ? config : new Idea34383Config();
