...
@Data
public class Idea34211Config {
    private String name = "idea_034211";
 ...
 */
@Slf4j
public class Idea34211Service {
    private static final int IDEA_ID = 34211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34211Service() {
        this(new Idea34211Config());
    }

    public Idea34211Service(Idea34211Config config) {
        this.config = config != null ? config : new Idea34211Config();
