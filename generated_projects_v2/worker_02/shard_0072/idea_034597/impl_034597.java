...
@Data
public class Idea34597Config {
    private String name = "idea_034597";
 ...
 */
@Slf4j
public class Idea34597Service {
    private static final int IDEA_ID = 34597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34597Service() {
        this(new Idea34597Config());
    }

    public Idea34597Service(Idea34597Config config) {
        this.config = config != null ? config : new Idea34597Config();
