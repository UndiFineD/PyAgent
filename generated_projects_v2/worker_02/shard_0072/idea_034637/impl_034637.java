...
@Data
public class Idea34637Config {
    private String name = "idea_034637";
 ...
 */
@Slf4j
public class Idea34637Service {
    private static final int IDEA_ID = 34637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34637Service() {
        this(new Idea34637Config());
    }

    public Idea34637Service(Idea34637Config config) {
        this.config = config != null ? config : new Idea34637Config();
