...
@Data
public class Idea34504Config {
    private String name = "idea_034504";
 ...
 */
@Slf4j
public class Idea34504Service {
    private static final int IDEA_ID = 34504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34504Service() {
        this(new Idea34504Config());
    }

    public Idea34504Service(Idea34504Config config) {
        this.config = config != null ? config : new Idea34504Config();
