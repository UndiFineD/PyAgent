...
@Data
public class Idea34432Config {
    private String name = "idea_034432";
 ...
 */
@Slf4j
public class Idea34432Service {
    private static final int IDEA_ID = 34432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34432Service() {
        this(new Idea34432Config());
    }

    public Idea34432Service(Idea34432Config config) {
        this.config = config != null ? config : new Idea34432Config();
