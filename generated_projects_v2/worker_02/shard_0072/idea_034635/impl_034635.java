...
@Data
public class Idea34635Config {
    private String name = "idea_034635";
 ...
 */
@Slf4j
public class Idea34635Service {
    private static final int IDEA_ID = 34635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34635Service() {
        this(new Idea34635Config());
    }

    public Idea34635Service(Idea34635Config config) {
        this.config = config != null ? config : new Idea34635Config();
