...
@Data
public class Idea34626Config {
    private String name = "idea_034626";
 ...
 */
@Slf4j
public class Idea34626Service {
    private static final int IDEA_ID = 34626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34626Service() {
        this(new Idea34626Config());
    }

    public Idea34626Service(Idea34626Config config) {
        this.config = config != null ? config : new Idea34626Config();
