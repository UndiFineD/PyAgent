...
@Data
public class Idea34433Config {
    private String name = "idea_034433";
 ...
 */
@Slf4j
public class Idea34433Service {
    private static final int IDEA_ID = 34433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34433Service() {
        this(new Idea34433Config());
    }

    public Idea34433Service(Idea34433Config config) {
        this.config = config != null ? config : new Idea34433Config();
