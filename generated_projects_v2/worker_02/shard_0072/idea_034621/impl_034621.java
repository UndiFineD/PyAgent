...
@Data
public class Idea34621Config {
    private String name = "idea_034621";
 ...
 */
@Slf4j
public class Idea34621Service {
    private static final int IDEA_ID = 34621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34621Service() {
        this(new Idea34621Config());
    }

    public Idea34621Service(Idea34621Config config) {
        this.config = config != null ? config : new Idea34621Config();
