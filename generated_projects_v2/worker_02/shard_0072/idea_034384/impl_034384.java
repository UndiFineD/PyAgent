...
@Data
public class Idea34384Config {
    private String name = "idea_034384";
 ...
 */
@Slf4j
public class Idea34384Service {
    private static final int IDEA_ID = 34384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34384Service() {
        this(new Idea34384Config());
    }

    public Idea34384Service(Idea34384Config config) {
        this.config = config != null ? config : new Idea34384Config();
