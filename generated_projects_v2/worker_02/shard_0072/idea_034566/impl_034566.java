...
@Data
public class Idea34566Config {
    private String name = "idea_034566";
 ...
 */
@Slf4j
public class Idea34566Service {
    private static final int IDEA_ID = 34566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34566Service() {
        this(new Idea34566Config());
    }

    public Idea34566Service(Idea34566Config config) {
        this.config = config != null ? config : new Idea34566Config();
