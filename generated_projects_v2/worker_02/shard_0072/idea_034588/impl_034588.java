...
@Data
public class Idea34588Config {
    private String name = "idea_034588";
 ...
 */
@Slf4j
public class Idea34588Service {
    private static final int IDEA_ID = 34588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34588Service() {
        this(new Idea34588Config());
    }

    public Idea34588Service(Idea34588Config config) {
        this.config = config != null ? config : new Idea34588Config();
