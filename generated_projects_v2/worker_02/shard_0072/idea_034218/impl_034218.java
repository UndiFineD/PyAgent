...
@Data
public class Idea34218Config {
    private String name = "idea_034218";
 ...
 */
@Slf4j
public class Idea34218Service {
    private static final int IDEA_ID = 34218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34218Service() {
        this(new Idea34218Config());
    }

    public Idea34218Service(Idea34218Config config) {
        this.config = config != null ? config : new Idea34218Config();
