...
@Data
public class Idea34260Config {
    private String name = "idea_034260";
 ...
 */
@Slf4j
public class Idea34260Service {
    private static final int IDEA_ID = 34260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34260Service() {
        this(new Idea34260Config());
    }

    public Idea34260Service(Idea34260Config config) {
        this.config = config != null ? config : new Idea34260Config();
