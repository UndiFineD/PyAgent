...
@Data
public class Idea34377Config {
    private String name = "idea_034377";
 ...
 */
@Slf4j
public class Idea34377Service {
    private static final int IDEA_ID = 34377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34377Service() {
        this(new Idea34377Config());
    }

    public Idea34377Service(Idea34377Config config) {
        this.config = config != null ? config : new Idea34377Config();
