...
@Data
public class Idea34205Config {
    private String name = "idea_034205";
 ...
 */
@Slf4j
public class Idea34205Service {
    private static final int IDEA_ID = 34205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34205Service() {
        this(new Idea34205Config());
    }

    public Idea34205Service(Idea34205Config config) {
        this.config = config != null ? config : new Idea34205Config();
