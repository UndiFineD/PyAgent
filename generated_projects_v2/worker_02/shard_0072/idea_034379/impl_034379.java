...
@Data
public class Idea34379Config {
    private String name = "idea_034379";
 ...
 */
@Slf4j
public class Idea34379Service {
    private static final int IDEA_ID = 34379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34379Service() {
        this(new Idea34379Config());
    }

    public Idea34379Service(Idea34379Config config) {
        this.config = config != null ? config : new Idea34379Config();
