...
@Data
public class Idea34291Config {
    private String name = "idea_034291";
 ...
 */
@Slf4j
public class Idea34291Service {
    private static final int IDEA_ID = 34291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34291Service() {
        this(new Idea34291Config());
    }

    public Idea34291Service(Idea34291Config config) {
        this.config = config != null ? config : new Idea34291Config();
