...
@Data
public class Idea34575Config {
    private String name = "idea_034575";
 ...
 */
@Slf4j
public class Idea34575Service {
    private static final int IDEA_ID = 34575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34575Service() {
        this(new Idea34575Config());
    }

    public Idea34575Service(Idea34575Config config) {
        this.config = config != null ? config : new Idea34575Config();
