...
@Data
public class Idea34375Config {
    private String name = "idea_034375";
 ...
 */
@Slf4j
public class Idea34375Service {
    private static final int IDEA_ID = 34375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34375Service() {
        this(new Idea34375Config());
    }

    public Idea34375Service(Idea34375Config config) {
        this.config = config != null ? config : new Idea34375Config();
