...
@Data
public class Idea34278Config {
    private String name = "idea_034278";
 ...
 */
@Slf4j
public class Idea34278Service {
    private static final int IDEA_ID = 34278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34278Service() {
        this(new Idea34278Config());
    }

    public Idea34278Service(Idea34278Config config) {
        this.config = config != null ? config : new Idea34278Config();
