...
@Data
public class Idea34307Config {
    private String name = "idea_034307";
 ...
 */
@Slf4j
public class Idea34307Service {
    private static final int IDEA_ID = 34307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34307Service() {
        this(new Idea34307Config());
    }

    public Idea34307Service(Idea34307Config config) {
        this.config = config != null ? config : new Idea34307Config();
