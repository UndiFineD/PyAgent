...
@Data
public class Idea34555Config {
    private String name = "idea_034555";
 ...
 */
@Slf4j
public class Idea34555Service {
    private static final int IDEA_ID = 34555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34555Service() {
        this(new Idea34555Config());
    }

    public Idea34555Service(Idea34555Config config) {
        this.config = config != null ? config : new Idea34555Config();
