...
@Data
public class Idea34590Config {
    private String name = "idea_034590";
 ...
 */
@Slf4j
public class Idea34590Service {
    private static final int IDEA_ID = 34590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34590Service() {
        this(new Idea34590Config());
    }

    public Idea34590Service(Idea34590Config config) {
        this.config = config != null ? config : new Idea34590Config();
