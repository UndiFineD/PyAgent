...
@Data
public class Idea34664Config {
    private String name = "idea_034664";
 ...
 */
@Slf4j
public class Idea34664Service {
    private static final int IDEA_ID = 34664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34664Service() {
        this(new Idea34664Config());
    }

    public Idea34664Service(Idea34664Config config) {
        this.config = config != null ? config : new Idea34664Config();
