...
@Data
public class Idea34532Config {
    private String name = "idea_034532";
 ...
 */
@Slf4j
public class Idea34532Service {
    private static final int IDEA_ID = 34532;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34532Service() {
        this(new Idea34532Config());
    }

    public Idea34532Service(Idea34532Config config) {
        this.config = config != null ? config : new Idea34532Config();
