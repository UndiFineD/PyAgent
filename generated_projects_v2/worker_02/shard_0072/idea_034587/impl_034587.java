...
@Data
public class Idea34587Config {
    private String name = "idea_034587";
 ...
 */
@Slf4j
public class Idea34587Service {
    private static final int IDEA_ID = 34587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34587Service() {
        this(new Idea34587Config());
    }

    public Idea34587Service(Idea34587Config config) {
        this.config = config != null ? config : new Idea34587Config();
