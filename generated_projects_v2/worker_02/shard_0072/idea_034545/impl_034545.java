...
@Data
public class Idea34545Config {
    private String name = "idea_034545";
 ...
 */
@Slf4j
public class Idea34545Service {
    private static final int IDEA_ID = 34545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34545Service() {
        this(new Idea34545Config());
    }

    public Idea34545Service(Idea34545Config config) {
        this.config = config != null ? config : new Idea34545Config();
