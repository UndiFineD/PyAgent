...
@Data
public class Idea34471Config {
    private String name = "idea_034471";
 ...
 */
@Slf4j
public class Idea34471Service {
    private static final int IDEA_ID = 34471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34471Service() {
        this(new Idea34471Config());
    }

    public Idea34471Service(Idea34471Config config) {
        this.config = config != null ? config : new Idea34471Config();
