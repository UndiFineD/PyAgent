...
@Data
public class Idea34656Config {
    private String name = "idea_034656";
 ...
 */
@Slf4j
public class Idea34656Service {
    private static final int IDEA_ID = 34656;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34656Service() {
        this(new Idea34656Config());
    }

    public Idea34656Service(Idea34656Config config) {
        this.config = config != null ? config : new Idea34656Config();
