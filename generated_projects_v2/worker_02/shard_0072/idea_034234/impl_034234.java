...
@Data
public class Idea34234Config {
    private String name = "idea_034234";
 ...
 */
@Slf4j
public class Idea34234Service {
    private static final int IDEA_ID = 34234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34234Service() {
        this(new Idea34234Config());
    }

    public Idea34234Service(Idea34234Config config) {
        this.config = config != null ? config : new Idea34234Config();
