...
@Data
public class Idea34674Config {
    private String name = "idea_034674";
 ...
 */
@Slf4j
public class Idea34674Service {
    private static final int IDEA_ID = 34674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34674Service() {
        this(new Idea34674Config());
    }

    public Idea34674Service(Idea34674Config config) {
        this.config = config != null ? config : new Idea34674Config();
