...
@Data
public class Idea34645Config {
    private String name = "idea_034645";
 ...
 */
@Slf4j
public class Idea34645Service {
    private static final int IDEA_ID = 34645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34645Service() {
        this(new Idea34645Config());
    }

    public Idea34645Service(Idea34645Config config) {
        this.config = config != null ? config : new Idea34645Config();
