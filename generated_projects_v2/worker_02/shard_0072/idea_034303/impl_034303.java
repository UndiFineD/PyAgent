...
@Data
public class Idea34303Config {
    private String name = "idea_034303";
 ...
 */
@Slf4j
public class Idea34303Service {
    private static final int IDEA_ID = 34303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34303Service() {
        this(new Idea34303Config());
    }

    public Idea34303Service(Idea34303Config config) {
        this.config = config != null ? config : new Idea34303Config();
