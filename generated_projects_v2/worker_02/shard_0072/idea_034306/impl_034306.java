...
@Data
public class Idea34306Config {
    private String name = "idea_034306";
 ...
 */
@Slf4j
public class Idea34306Service {
    private static final int IDEA_ID = 34306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34306Service() {
        this(new Idea34306Config());
    }

    public Idea34306Service(Idea34306Config config) {
        this.config = config != null ? config : new Idea34306Config();
