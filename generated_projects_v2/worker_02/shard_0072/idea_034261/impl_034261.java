...
@Data
public class Idea34261Config {
    private String name = "idea_034261";
 ...
 */
@Slf4j
public class Idea34261Service {
    private static final int IDEA_ID = 34261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34261Service() {
        this(new Idea34261Config());
    }

    public Idea34261Service(Idea34261Config config) {
        this.config = config != null ? config : new Idea34261Config();
