...
@Data
public class Idea34351Config {
    private String name = "idea_034351";
 ...
 */
@Slf4j
public class Idea34351Service {
    private static final int IDEA_ID = 34351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34351Service() {
        this(new Idea34351Config());
    }

    public Idea34351Service(Idea34351Config config) {
        this.config = config != null ? config : new Idea34351Config();
