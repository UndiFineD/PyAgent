...
@Data
public class Idea34272Config {
    private String name = "idea_034272";
 ...
 */
@Slf4j
public class Idea34272Service {
    private static final int IDEA_ID = 34272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34272Service() {
        this(new Idea34272Config());
    }

    public Idea34272Service(Idea34272Config config) {
        this.config = config != null ? config : new Idea34272Config();
