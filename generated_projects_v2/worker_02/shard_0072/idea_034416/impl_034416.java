...
@Data
public class Idea34416Config {
    private String name = "idea_034416";
 ...
 */
@Slf4j
public class Idea34416Service {
    private static final int IDEA_ID = 34416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34416Service() {
        this(new Idea34416Config());
    }

    public Idea34416Service(Idea34416Config config) {
        this.config = config != null ? config : new Idea34416Config();
