...
@Data
public class Idea34427Config {
    private String name = "idea_034427";
 ...
 */
@Slf4j
public class Idea34427Service {
    private static final int IDEA_ID = 34427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34427Service() {
        this(new Idea34427Config());
    }

    public Idea34427Service(Idea34427Config config) {
        this.config = config != null ? config : new Idea34427Config();
