...
@Data
public class Idea34601Config {
    private String name = "idea_034601";
 ...
 */
@Slf4j
public class Idea34601Service {
    private static final int IDEA_ID = 34601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34601Service() {
        this(new Idea34601Config());
    }

    public Idea34601Service(Idea34601Config config) {
        this.config = config != null ? config : new Idea34601Config();
