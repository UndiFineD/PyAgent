...
@Data
public class Idea34610Config {
    private String name = "idea_034610";
 ...
 */
@Slf4j
public class Idea34610Service {
    private static final int IDEA_ID = 34610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34610Service() {
        this(new Idea34610Config());
    }

    public Idea34610Service(Idea34610Config config) {
        this.config = config != null ? config : new Idea34610Config();
