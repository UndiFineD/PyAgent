...
@Data
public class Idea28676Config {
    private String name = "idea_028676";
 ...
 */
@Slf4j
public class Idea28676Service {
    private static final int IDEA_ID = 28676;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28676Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28676Service() {
        this(new Idea28676Config());
    }

    public Idea28676Service(Idea28676Config config) {
        this.config = config != null ? config : new Idea28676Config();
