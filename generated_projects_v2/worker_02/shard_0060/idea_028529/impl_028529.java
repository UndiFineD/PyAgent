...
@Data
public class Idea28529Config {
    private String name = "idea_028529";
 ...
 */
@Slf4j
public class Idea28529Service {
    private static final int IDEA_ID = 28529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28529Service() {
        this(new Idea28529Config());
    }

    public Idea28529Service(Idea28529Config config) {
        this.config = config != null ? config : new Idea28529Config();
