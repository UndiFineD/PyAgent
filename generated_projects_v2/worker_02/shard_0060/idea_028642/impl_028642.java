...
@Data
public class Idea28642Config {
    private String name = "idea_028642";
 ...
 */
@Slf4j
public class Idea28642Service {
    private static final int IDEA_ID = 28642;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28642Service() {
        this(new Idea28642Config());
    }

    public Idea28642Service(Idea28642Config config) {
        this.config = config != null ? config : new Idea28642Config();
