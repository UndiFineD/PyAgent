...
@Data
public class Idea28503Config {
    private String name = "idea_028503";
 ...
 */
@Slf4j
public class Idea28503Service {
    private static final int IDEA_ID = 28503;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28503Service() {
        this(new Idea28503Config());
    }

    public Idea28503Service(Idea28503Config config) {
        this.config = config != null ? config : new Idea28503Config();
