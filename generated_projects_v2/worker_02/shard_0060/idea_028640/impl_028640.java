...
@Data
public class Idea28640Config {
    private String name = "idea_028640";
 ...
 */
@Slf4j
public class Idea28640Service {
    private static final int IDEA_ID = 28640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28640Service() {
        this(new Idea28640Config());
    }

    public Idea28640Service(Idea28640Config config) {
        this.config = config != null ? config : new Idea28640Config();
