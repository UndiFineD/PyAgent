...
@Data
public class Idea28813Config {
    private String name = "idea_028813";
 ...
 */
@Slf4j
public class Idea28813Service {
    private static final int IDEA_ID = 28813;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28813Service() {
        this(new Idea28813Config());
    }

    public Idea28813Service(Idea28813Config config) {
        this.config = config != null ? config : new Idea28813Config();
