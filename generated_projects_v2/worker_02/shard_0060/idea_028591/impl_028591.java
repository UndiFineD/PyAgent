...
@Data
public class Idea28591Config {
    private String name = "idea_028591";
 ...
 */
@Slf4j
public class Idea28591Service {
    private static final int IDEA_ID = 28591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28591Service() {
        this(new Idea28591Config());
    }

    public Idea28591Service(Idea28591Config config) {
        this.config = config != null ? config : new Idea28591Config();
