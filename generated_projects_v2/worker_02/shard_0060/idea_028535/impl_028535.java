...
@Data
public class Idea28535Config {
    private String name = "idea_028535";
 ...
 */
@Slf4j
public class Idea28535Service {
    private static final int IDEA_ID = 28535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28535Service() {
        this(new Idea28535Config());
    }

    public Idea28535Service(Idea28535Config config) {
        this.config = config != null ? config : new Idea28535Config();
