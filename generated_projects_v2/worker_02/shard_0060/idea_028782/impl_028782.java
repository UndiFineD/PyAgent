...
@Data
public class Idea28782Config {
    private String name = "idea_028782";
 ...
 */
@Slf4j
public class Idea28782Service {
    private static final int IDEA_ID = 28782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28782Service() {
        this(new Idea28782Config());
    }

    public Idea28782Service(Idea28782Config config) {
        this.config = config != null ? config : new Idea28782Config();
