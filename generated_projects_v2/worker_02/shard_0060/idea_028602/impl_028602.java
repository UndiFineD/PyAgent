...
@Data
public class Idea28602Config {
    private String name = "idea_028602";
 ...
 */
@Slf4j
public class Idea28602Service {
    private static final int IDEA_ID = 28602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28602Service() {
        this(new Idea28602Config());
    }

    public Idea28602Service(Idea28602Config config) {
        this.config = config != null ? config : new Idea28602Config();
