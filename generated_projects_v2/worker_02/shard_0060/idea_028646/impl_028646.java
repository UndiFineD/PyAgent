...
@Data
public class Idea28646Config {
    private String name = "idea_028646";
 ...
 */
@Slf4j
public class Idea28646Service {
    private static final int IDEA_ID = 28646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28646Service() {
        this(new Idea28646Config());
    }

    public Idea28646Service(Idea28646Config config) {
        this.config = config != null ? config : new Idea28646Config();
