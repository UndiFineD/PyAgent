...
@Data
public class Idea28797Config {
    private String name = "idea_028797";
 ...
 */
@Slf4j
public class Idea28797Service {
    private static final int IDEA_ID = 28797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28797Service() {
        this(new Idea28797Config());
    }

    public Idea28797Service(Idea28797Config config) {
        this.config = config != null ? config : new Idea28797Config();
