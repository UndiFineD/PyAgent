...
@Data
public class Idea28711Config {
    private String name = "idea_028711";
 ...
 */
@Slf4j
public class Idea28711Service {
    private static final int IDEA_ID = 28711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28711Service() {
        this(new Idea28711Config());
    }

    public Idea28711Service(Idea28711Config config) {
        this.config = config != null ? config : new Idea28711Config();
