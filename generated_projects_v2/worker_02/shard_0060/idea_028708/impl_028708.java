...
@Data
public class Idea28708Config {
    private String name = "idea_028708";
 ...
 */
@Slf4j
public class Idea28708Service {
    private static final int IDEA_ID = 28708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28708Service() {
        this(new Idea28708Config());
    }

    public Idea28708Service(Idea28708Config config) {
        this.config = config != null ? config : new Idea28708Config();
