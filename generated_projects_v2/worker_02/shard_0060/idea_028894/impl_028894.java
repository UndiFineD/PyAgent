...
@Data
public class Idea28894Config {
    private String name = "idea_028894";
 ...
 */
@Slf4j
public class Idea28894Service {
    private static final int IDEA_ID = 28894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28894Service() {
        this(new Idea28894Config());
    }

    public Idea28894Service(Idea28894Config config) {
        this.config = config != null ? config : new Idea28894Config();
