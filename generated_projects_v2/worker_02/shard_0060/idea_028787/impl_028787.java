...
@Data
public class Idea28787Config {
    private String name = "idea_028787";
 ...
 */
@Slf4j
public class Idea28787Service {
    private static final int IDEA_ID = 28787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28787Service() {
        this(new Idea28787Config());
    }

    public Idea28787Service(Idea28787Config config) {
        this.config = config != null ? config : new Idea28787Config();
