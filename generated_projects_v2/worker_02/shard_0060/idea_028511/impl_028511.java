...
@Data
public class Idea28511Config {
    private String name = "idea_028511";
 ...
 */
@Slf4j
public class Idea28511Service {
    private static final int IDEA_ID = 28511;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28511Service() {
        this(new Idea28511Config());
    }

    public Idea28511Service(Idea28511Config config) {
        this.config = config != null ? config : new Idea28511Config();
