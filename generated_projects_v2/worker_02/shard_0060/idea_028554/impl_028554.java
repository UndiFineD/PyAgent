...
@Data
public class Idea28554Config {
    private String name = "idea_028554";
 ...
 */
@Slf4j
public class Idea28554Service {
    private static final int IDEA_ID = 28554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28554Service() {
        this(new Idea28554Config());
    }

    public Idea28554Service(Idea28554Config config) {
        this.config = config != null ? config : new Idea28554Config();
