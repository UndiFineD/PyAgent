...
@Data
public class Idea28686Config {
    private String name = "idea_028686";
 ...
 */
@Slf4j
public class Idea28686Service {
    private static final int IDEA_ID = 28686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28686Service() {
        this(new Idea28686Config());
    }

    public Idea28686Service(Idea28686Config config) {
        this.config = config != null ? config : new Idea28686Config();
