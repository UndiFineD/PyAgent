...
@Data
public class Idea28799Config {
    private String name = "idea_028799";
 ...
 */
@Slf4j
public class Idea28799Service {
    private static final int IDEA_ID = 28799;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28799Service() {
        this(new Idea28799Config());
    }

    public Idea28799Service(Idea28799Config config) {
        this.config = config != null ? config : new Idea28799Config();
