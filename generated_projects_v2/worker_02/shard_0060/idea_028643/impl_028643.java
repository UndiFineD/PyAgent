...
@Data
public class Idea28643Config {
    private String name = "idea_028643";
 ...
 */
@Slf4j
public class Idea28643Service {
    private static final int IDEA_ID = 28643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28643Service() {
        this(new Idea28643Config());
    }

    public Idea28643Service(Idea28643Config config) {
        this.config = config != null ? config : new Idea28643Config();
