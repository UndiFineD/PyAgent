...
@Data
public class Idea28962Config {
    private String name = "idea_028962";
 ...
 */
@Slf4j
public class Idea28962Service {
    private static final int IDEA_ID = 28962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28962Service() {
        this(new Idea28962Config());
    }

    public Idea28962Service(Idea28962Config config) {
        this.config = config != null ? config : new Idea28962Config();
