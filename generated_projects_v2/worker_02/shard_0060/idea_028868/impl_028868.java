...
@Data
public class Idea28868Config {
    private String name = "idea_028868";
 ...
 */
@Slf4j
public class Idea28868Service {
    private static final int IDEA_ID = 28868;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28868Service() {
        this(new Idea28868Config());
    }

    public Idea28868Service(Idea28868Config config) {
        this.config = config != null ? config : new Idea28868Config();
