...
@Data
public class Idea28777Config {
    private String name = "idea_028777";
 ...
 */
@Slf4j
public class Idea28777Service {
    private static final int IDEA_ID = 28777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28777Service() {
        this(new Idea28777Config());
    }

    public Idea28777Service(Idea28777Config config) {
        this.config = config != null ? config : new Idea28777Config();
