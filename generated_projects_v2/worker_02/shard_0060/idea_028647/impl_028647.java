...
@Data
public class Idea28647Config {
    private String name = "idea_028647";
 ...
 */
@Slf4j
public class Idea28647Service {
    private static final int IDEA_ID = 28647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28647Service() {
        this(new Idea28647Config());
    }

    public Idea28647Service(Idea28647Config config) {
        this.config = config != null ? config : new Idea28647Config();
