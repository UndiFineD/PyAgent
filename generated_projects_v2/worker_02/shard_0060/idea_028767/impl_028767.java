...
@Data
public class Idea28767Config {
    private String name = "idea_028767";
 ...
 */
@Slf4j
public class Idea28767Service {
    private static final int IDEA_ID = 28767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28767Service() {
        this(new Idea28767Config());
    }

    public Idea28767Service(Idea28767Config config) {
        this.config = config != null ? config : new Idea28767Config();
