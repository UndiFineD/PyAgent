...
@Data
public class Idea28713Config {
    private String name = "idea_028713";
 ...
 */
@Slf4j
public class Idea28713Service {
    private static final int IDEA_ID = 28713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28713Service() {
        this(new Idea28713Config());
    }

    public Idea28713Service(Idea28713Config config) {
        this.config = config != null ? config : new Idea28713Config();
