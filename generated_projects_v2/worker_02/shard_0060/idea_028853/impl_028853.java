...
@Data
public class Idea28853Config {
    private String name = "idea_028853";
 ...
 */
@Slf4j
public class Idea28853Service {
    private static final int IDEA_ID = 28853;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28853Service() {
        this(new Idea28853Config());
    }

    public Idea28853Service(Idea28853Config config) {
        this.config = config != null ? config : new Idea28853Config();
