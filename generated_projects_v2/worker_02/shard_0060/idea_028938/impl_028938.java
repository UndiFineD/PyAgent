...
@Data
public class Idea28938Config {
    private String name = "idea_028938";
 ...
 */
@Slf4j
public class Idea28938Service {
    private static final int IDEA_ID = 28938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28938Service() {
        this(new Idea28938Config());
    }

    public Idea28938Service(Idea28938Config config) {
        this.config = config != null ? config : new Idea28938Config();
