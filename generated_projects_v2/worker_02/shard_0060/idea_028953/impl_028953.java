...
@Data
public class Idea28953Config {
    private String name = "idea_028953";
 ...
 */
@Slf4j
public class Idea28953Service {
    private static final int IDEA_ID = 28953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28953Service() {
        this(new Idea28953Config());
    }

    public Idea28953Service(Idea28953Config config) {
        this.config = config != null ? config : new Idea28953Config();
