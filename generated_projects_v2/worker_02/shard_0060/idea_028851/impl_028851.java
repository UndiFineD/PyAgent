...
@Data
public class Idea28851Config {
    private String name = "idea_028851";
 ...
 */
@Slf4j
public class Idea28851Service {
    private static final int IDEA_ID = 28851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28851Service() {
        this(new Idea28851Config());
    }

    public Idea28851Service(Idea28851Config config) {
        this.config = config != null ? config : new Idea28851Config();
