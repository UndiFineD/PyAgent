...
@Data
public class Idea28533Config {
    private String name = "idea_028533";
 ...
 */
@Slf4j
public class Idea28533Service {
    private static final int IDEA_ID = 28533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28533Service() {
        this(new Idea28533Config());
    }

    public Idea28533Service(Idea28533Config config) {
        this.config = config != null ? config : new Idea28533Config();
