...
@Data
public class Idea28673Config {
    private String name = "idea_028673";
 ...
 */
@Slf4j
public class Idea28673Service {
    private static final int IDEA_ID = 28673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28673Service() {
        this(new Idea28673Config());
    }

    public Idea28673Service(Idea28673Config config) {
        this.config = config != null ? config : new Idea28673Config();
