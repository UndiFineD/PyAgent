...
@Data
public class Idea28738Config {
    private String name = "idea_028738";
 ...
 */
@Slf4j
public class Idea28738Service {
    private static final int IDEA_ID = 28738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28738Service() {
        this(new Idea28738Config());
    }

    public Idea28738Service(Idea28738Config config) {
        this.config = config != null ? config : new Idea28738Config();
