...
@Data
public class Idea28504Config {
    private String name = "idea_028504";
 ...
 */
@Slf4j
public class Idea28504Service {
    private static final int IDEA_ID = 28504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28504Service() {
        this(new Idea28504Config());
    }

    public Idea28504Service(Idea28504Config config) {
        this.config = config != null ? config : new Idea28504Config();
