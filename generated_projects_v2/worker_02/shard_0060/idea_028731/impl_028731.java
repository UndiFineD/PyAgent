...
@Data
public class Idea28731Config {
    private String name = "idea_028731";
 ...
 */
@Slf4j
public class Idea28731Service {
    private static final int IDEA_ID = 28731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28731Service() {
        this(new Idea28731Config());
    }

    public Idea28731Service(Idea28731Config config) {
        this.config = config != null ? config : new Idea28731Config();
