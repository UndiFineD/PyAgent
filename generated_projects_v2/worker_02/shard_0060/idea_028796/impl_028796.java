...
@Data
public class Idea28796Config {
    private String name = "idea_028796";
 ...
 */
@Slf4j
public class Idea28796Service {
    private static final int IDEA_ID = 28796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28796Service() {
        this(new Idea28796Config());
    }

    public Idea28796Service(Idea28796Config config) {
        this.config = config != null ? config : new Idea28796Config();
