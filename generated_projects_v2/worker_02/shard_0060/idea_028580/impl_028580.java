...
@Data
public class Idea28580Config {
    private String name = "idea_028580";
 ...
 */
@Slf4j
public class Idea28580Service {
    private static final int IDEA_ID = 28580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28580Service() {
        this(new Idea28580Config());
    }

    public Idea28580Service(Idea28580Config config) {
        this.config = config != null ? config : new Idea28580Config();
