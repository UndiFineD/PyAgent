...
@Data
public class Idea28739Config {
    private String name = "idea_028739";
 ...
 */
@Slf4j
public class Idea28739Service {
    private static final int IDEA_ID = 28739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28739Service() {
        this(new Idea28739Config());
    }

    public Idea28739Service(Idea28739Config config) {
        this.config = config != null ? config : new Idea28739Config();
