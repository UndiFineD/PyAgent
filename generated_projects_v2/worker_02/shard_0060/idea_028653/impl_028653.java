...
@Data
public class Idea28653Config {
    private String name = "idea_028653";
 ...
 */
@Slf4j
public class Idea28653Service {
    private static final int IDEA_ID = 28653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28653Service() {
        this(new Idea28653Config());
    }

    public Idea28653Service(Idea28653Config config) {
        this.config = config != null ? config : new Idea28653Config();
