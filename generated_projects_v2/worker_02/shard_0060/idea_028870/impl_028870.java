...
@Data
public class Idea28870Config {
    private String name = "idea_028870";
 ...
 */
@Slf4j
public class Idea28870Service {
    private static final int IDEA_ID = 28870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28870Service() {
        this(new Idea28870Config());
    }

    public Idea28870Service(Idea28870Config config) {
        this.config = config != null ? config : new Idea28870Config();
