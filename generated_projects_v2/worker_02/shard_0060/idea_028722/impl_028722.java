...
@Data
public class Idea28722Config {
    private String name = "idea_028722";
 ...
 */
@Slf4j
public class Idea28722Service {
    private static final int IDEA_ID = 28722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28722Service() {
        this(new Idea28722Config());
    }

    public Idea28722Service(Idea28722Config config) {
        this.config = config != null ? config : new Idea28722Config();
