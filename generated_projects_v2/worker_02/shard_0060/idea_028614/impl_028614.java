...
@Data
public class Idea28614Config {
    private String name = "idea_028614";
 ...
 */
@Slf4j
public class Idea28614Service {
    private static final int IDEA_ID = 28614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28614Service() {
        this(new Idea28614Config());
    }

    public Idea28614Service(Idea28614Config config) {
        this.config = config != null ? config : new Idea28614Config();
