...
@Data
public class Idea28685Config {
    private String name = "idea_028685";
 ...
 */
@Slf4j
public class Idea28685Service {
    private static final int IDEA_ID = 28685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28685Service() {
        this(new Idea28685Config());
    }

    public Idea28685Service(Idea28685Config config) {
        this.config = config != null ? config : new Idea28685Config();
