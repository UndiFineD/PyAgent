...
@Data
public class Idea28748Config {
    private String name = "idea_028748";
 ...
 */
@Slf4j
public class Idea28748Service {
    private static final int IDEA_ID = 28748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28748Service() {
        this(new Idea28748Config());
    }

    public Idea28748Service(Idea28748Config config) {
        this.config = config != null ? config : new Idea28748Config();
