...
@Data
public class Idea28575Config {
    private String name = "idea_028575";
 ...
 */
@Slf4j
public class Idea28575Service {
    private static final int IDEA_ID = 28575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28575Service() {
        this(new Idea28575Config());
    }

    public Idea28575Service(Idea28575Config config) {
        this.config = config != null ? config : new Idea28575Config();
