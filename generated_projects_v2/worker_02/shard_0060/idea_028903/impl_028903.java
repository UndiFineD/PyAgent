...
@Data
public class Idea28903Config {
    private String name = "idea_028903";
 ...
 */
@Slf4j
public class Idea28903Service {
    private static final int IDEA_ID = 28903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28903Service() {
        this(new Idea28903Config());
    }

    public Idea28903Service(Idea28903Config config) {
        this.config = config != null ? config : new Idea28903Config();
