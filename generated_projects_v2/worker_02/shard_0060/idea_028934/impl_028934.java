...
@Data
public class Idea28934Config {
    private String name = "idea_028934";
 ...
 */
@Slf4j
public class Idea28934Service {
    private static final int IDEA_ID = 28934;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28934Service() {
        this(new Idea28934Config());
    }

    public Idea28934Service(Idea28934Config config) {
        this.config = config != null ? config : new Idea28934Config();
