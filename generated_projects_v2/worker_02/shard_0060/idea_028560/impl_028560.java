...
@Data
public class Idea28560Config {
    private String name = "idea_028560";
 ...
 */
@Slf4j
public class Idea28560Service {
    private static final int IDEA_ID = 28560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28560Service() {
        this(new Idea28560Config());
    }

    public Idea28560Service(Idea28560Config config) {
        this.config = config != null ? config : new Idea28560Config();
