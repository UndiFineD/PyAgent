...
@Data
public class Idea28572Config {
    private String name = "idea_028572";
 ...
 */
@Slf4j
public class Idea28572Service {
    private static final int IDEA_ID = 28572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28572Service() {
        this(new Idea28572Config());
    }

    public Idea28572Service(Idea28572Config config) {
        this.config = config != null ? config : new Idea28572Config();
