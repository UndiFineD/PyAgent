...
@Data
public class Idea28682Config {
    private String name = "idea_028682";
 ...
 */
@Slf4j
public class Idea28682Service {
    private static final int IDEA_ID = 28682;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28682Service() {
        this(new Idea28682Config());
    }

    public Idea28682Service(Idea28682Config config) {
        this.config = config != null ? config : new Idea28682Config();
