...
@Data
public class Idea28921Config {
    private String name = "idea_028921";
 ...
 */
@Slf4j
public class Idea28921Service {
    private static final int IDEA_ID = 28921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28921Service() {
        this(new Idea28921Config());
    }

    public Idea28921Service(Idea28921Config config) {
        this.config = config != null ? config : new Idea28921Config();
