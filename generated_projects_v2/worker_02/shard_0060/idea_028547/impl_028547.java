...
@Data
public class Idea28547Config {
    private String name = "idea_028547";
 ...
 */
@Slf4j
public class Idea28547Service {
    private static final int IDEA_ID = 28547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28547Service() {
        this(new Idea28547Config());
    }

    public Idea28547Service(Idea28547Config config) {
        this.config = config != null ? config : new Idea28547Config();
