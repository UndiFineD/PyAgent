...
@Data
public class Idea28501Config {
    private String name = "idea_028501";
 ...
 */
@Slf4j
public class Idea28501Service {
    private static final int IDEA_ID = 28501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28501Service() {
        this(new Idea28501Config());
    }

    public Idea28501Service(Idea28501Config config) {
        this.config = config != null ? config : new Idea28501Config();
