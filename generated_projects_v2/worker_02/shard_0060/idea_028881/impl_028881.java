...
@Data
public class Idea28881Config {
    private String name = "idea_028881";
 ...
 */
@Slf4j
public class Idea28881Service {
    private static final int IDEA_ID = 28881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28881Service() {
        this(new Idea28881Config());
    }

    public Idea28881Service(Idea28881Config config) {
        this.config = config != null ? config : new Idea28881Config();
