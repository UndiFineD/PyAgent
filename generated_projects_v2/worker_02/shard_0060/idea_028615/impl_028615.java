...
@Data
public class Idea28615Config {
    private String name = "idea_028615";
 ...
 */
@Slf4j
public class Idea28615Service {
    private static final int IDEA_ID = 28615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28615Service() {
        this(new Idea28615Config());
    }

    public Idea28615Service(Idea28615Config config) {
        this.config = config != null ? config : new Idea28615Config();
