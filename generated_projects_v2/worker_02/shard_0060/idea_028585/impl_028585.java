...
@Data
public class Idea28585Config {
    private String name = "idea_028585";
 ...
 */
@Slf4j
public class Idea28585Service {
    private static final int IDEA_ID = 28585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28585Service() {
        this(new Idea28585Config());
    }

    public Idea28585Service(Idea28585Config config) {
        this.config = config != null ? config : new Idea28585Config();
