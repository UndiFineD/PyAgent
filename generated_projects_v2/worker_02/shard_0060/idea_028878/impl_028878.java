...
@Data
public class Idea28878Config {
    private String name = "idea_028878";
 ...
 */
@Slf4j
public class Idea28878Service {
    private static final int IDEA_ID = 28878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28878Service() {
        this(new Idea28878Config());
    }

    public Idea28878Service(Idea28878Config config) {
        this.config = config != null ? config : new Idea28878Config();
