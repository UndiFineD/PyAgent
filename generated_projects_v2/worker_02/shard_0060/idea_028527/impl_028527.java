...
@Data
public class Idea28527Config {
    private String name = "idea_028527";
 ...
 */
@Slf4j
public class Idea28527Service {
    private static final int IDEA_ID = 28527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28527Service() {
        this(new Idea28527Config());
    }

    public Idea28527Service(Idea28527Config config) {
        this.config = config != null ? config : new Idea28527Config();
