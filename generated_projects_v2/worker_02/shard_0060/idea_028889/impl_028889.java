...
@Data
public class Idea28889Config {
    private String name = "idea_028889";
 ...
 */
@Slf4j
public class Idea28889Service {
    private static final int IDEA_ID = 28889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28889Service() {
        this(new Idea28889Config());
    }

    public Idea28889Service(Idea28889Config config) {
        this.config = config != null ? config : new Idea28889Config();
