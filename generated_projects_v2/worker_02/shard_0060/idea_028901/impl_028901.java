...
@Data
public class Idea28901Config {
    private String name = "idea_028901";
 ...
 */
@Slf4j
public class Idea28901Service {
    private static final int IDEA_ID = 28901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28901Service() {
        this(new Idea28901Config());
    }

    public Idea28901Service(Idea28901Config config) {
        this.config = config != null ? config : new Idea28901Config();
