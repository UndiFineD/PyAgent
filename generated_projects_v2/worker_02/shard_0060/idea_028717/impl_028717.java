...
@Data
public class Idea28717Config {
    private String name = "idea_028717";
 ...
 */
@Slf4j
public class Idea28717Service {
    private static final int IDEA_ID = 28717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28717Service() {
        this(new Idea28717Config());
    }

    public Idea28717Service(Idea28717Config config) {
        this.config = config != null ? config : new Idea28717Config();
