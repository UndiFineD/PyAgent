...
@Data
public class Idea28864Config {
    private String name = "idea_028864";
 ...
 */
@Slf4j
public class Idea28864Service {
    private static final int IDEA_ID = 28864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28864Service() {
        this(new Idea28864Config());
    }

    public Idea28864Service(Idea28864Config config) {
        this.config = config != null ? config : new Idea28864Config();
