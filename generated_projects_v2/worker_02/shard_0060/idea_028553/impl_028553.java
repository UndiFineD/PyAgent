...
@Data
public class Idea28553Config {
    private String name = "idea_028553";
 ...
 */
@Slf4j
public class Idea28553Service {
    private static final int IDEA_ID = 28553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28553Service() {
        this(new Idea28553Config());
    }

    public Idea28553Service(Idea28553Config config) {
        this.config = config != null ? config : new Idea28553Config();
