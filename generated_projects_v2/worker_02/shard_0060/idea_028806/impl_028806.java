...
@Data
public class Idea28806Config {
    private String name = "idea_028806";
 ...
 */
@Slf4j
public class Idea28806Service {
    private static final int IDEA_ID = 28806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28806Service() {
        this(new Idea28806Config());
    }

    public Idea28806Service(Idea28806Config config) {
        this.config = config != null ? config : new Idea28806Config();
