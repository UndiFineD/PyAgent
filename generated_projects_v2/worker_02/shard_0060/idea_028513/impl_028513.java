...
@Data
public class Idea28513Config {
    private String name = "idea_028513";
 ...
 */
@Slf4j
public class Idea28513Service {
    private static final int IDEA_ID = 28513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28513Service() {
        this(new Idea28513Config());
    }

    public Idea28513Service(Idea28513Config config) {
        this.config = config != null ? config : new Idea28513Config();
