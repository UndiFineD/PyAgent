...
@Data
public class Idea28598Config {
    private String name = "idea_028598";
 ...
 */
@Slf4j
public class Idea28598Service {
    private static final int IDEA_ID = 28598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28598Service() {
        this(new Idea28598Config());
    }

    public Idea28598Service(Idea28598Config config) {
        this.config = config != null ? config : new Idea28598Config();
