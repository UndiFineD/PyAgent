...
@Data
public class Idea28595Config {
    private String name = "idea_028595";
 ...
 */
@Slf4j
public class Idea28595Service {
    private static final int IDEA_ID = 28595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28595Service() {
        this(new Idea28595Config());
    }

    public Idea28595Service(Idea28595Config config) {
        this.config = config != null ? config : new Idea28595Config();
