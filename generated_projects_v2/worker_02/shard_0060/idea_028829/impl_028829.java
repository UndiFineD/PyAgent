...
@Data
public class Idea28829Config {
    private String name = "idea_028829";
 ...
 */
@Slf4j
public class Idea28829Service {
    private static final int IDEA_ID = 28829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28829Service() {
        this(new Idea28829Config());
    }

    public Idea28829Service(Idea28829Config config) {
        this.config = config != null ? config : new Idea28829Config();
