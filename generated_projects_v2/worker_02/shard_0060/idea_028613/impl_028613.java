...
@Data
public class Idea28613Config {
    private String name = "idea_028613";
 ...
 */
@Slf4j
public class Idea28613Service {
    private static final int IDEA_ID = 28613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28613Service() {
        this(new Idea28613Config());
    }

    public Idea28613Service(Idea28613Config config) {
        this.config = config != null ? config : new Idea28613Config();
