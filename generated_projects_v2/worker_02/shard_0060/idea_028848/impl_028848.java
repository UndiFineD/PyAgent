...
@Data
public class Idea28848Config {
    private String name = "idea_028848";
 ...
 */
@Slf4j
public class Idea28848Service {
    private static final int IDEA_ID = 28848;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28848Service() {
        this(new Idea28848Config());
    }

    public Idea28848Service(Idea28848Config config) {
        this.config = config != null ? config : new Idea28848Config();
