...
@Data
public class Idea28771Config {
    private String name = "idea_028771";
 ...
 */
@Slf4j
public class Idea28771Service {
    private static final int IDEA_ID = 28771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28771Service() {
        this(new Idea28771Config());
    }

    public Idea28771Service(Idea28771Config config) {
        this.config = config != null ? config : new Idea28771Config();
