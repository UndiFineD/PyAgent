...
@Data
public class Idea28904Config {
    private String name = "idea_028904";
 ...
 */
@Slf4j
public class Idea28904Service {
    private static final int IDEA_ID = 28904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28904Service() {
        this(new Idea28904Config());
    }

    public Idea28904Service(Idea28904Config config) {
        this.config = config != null ? config : new Idea28904Config();
