...
@Data
public class Idea28563Config {
    private String name = "idea_028563";
 ...
 */
@Slf4j
public class Idea28563Service {
    private static final int IDEA_ID = 28563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28563Service() {
        this(new Idea28563Config());
    }

    public Idea28563Service(Idea28563Config config) {
        this.config = config != null ? config : new Idea28563Config();
