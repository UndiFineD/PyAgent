...
@Data
public class Idea28808Config {
    private String name = "idea_028808";
 ...
 */
@Slf4j
public class Idea28808Service {
    private static final int IDEA_ID = 28808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28808Service() {
        this(new Idea28808Config());
    }

    public Idea28808Service(Idea28808Config config) {
        this.config = config != null ? config : new Idea28808Config();
