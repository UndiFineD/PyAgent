...
@Data
public class Idea28689Config {
    private String name = "idea_028689";
 ...
 */
@Slf4j
public class Idea28689Service {
    private static final int IDEA_ID = 28689;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28689Service() {
        this(new Idea28689Config());
    }

    public Idea28689Service(Idea28689Config config) {
        this.config = config != null ? config : new Idea28689Config();
