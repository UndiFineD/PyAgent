...
@Data
public class Idea28561Config {
    private String name = "idea_028561";
 ...
 */
@Slf4j
public class Idea28561Service {
    private static final int IDEA_ID = 28561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28561Service() {
        this(new Idea28561Config());
    }

    public Idea28561Service(Idea28561Config config) {
        this.config = config != null ? config : new Idea28561Config();
