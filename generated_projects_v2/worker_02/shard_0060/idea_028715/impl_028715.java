...
@Data
public class Idea28715Config {
    private String name = "idea_028715";
 ...
 */
@Slf4j
public class Idea28715Service {
    private static final int IDEA_ID = 28715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28715Service() {
        this(new Idea28715Config());
    }

    public Idea28715Service(Idea28715Config config) {
        this.config = config != null ? config : new Idea28715Config();
