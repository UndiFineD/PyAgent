...
@Data
public class Idea28775Config {
    private String name = "idea_028775";
 ...
 */
@Slf4j
public class Idea28775Service {
    private static final int IDEA_ID = 28775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28775Service() {
        this(new Idea28775Config());
    }

    public Idea28775Service(Idea28775Config config) {
        this.config = config != null ? config : new Idea28775Config();
