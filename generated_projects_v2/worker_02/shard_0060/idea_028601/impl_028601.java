...
@Data
public class Idea28601Config {
    private String name = "idea_028601";
 ...
 */
@Slf4j
public class Idea28601Service {
    private static final int IDEA_ID = 28601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28601Service() {
        this(new Idea28601Config());
    }

    public Idea28601Service(Idea28601Config config) {
        this.config = config != null ? config : new Idea28601Config();
