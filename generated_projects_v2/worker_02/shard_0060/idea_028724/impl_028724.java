...
@Data
public class Idea28724Config {
    private String name = "idea_028724";
 ...
 */
@Slf4j
public class Idea28724Service {
    private static final int IDEA_ID = 28724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28724Service() {
        this(new Idea28724Config());
    }

    public Idea28724Service(Idea28724Config config) {
        this.config = config != null ? config : new Idea28724Config();
