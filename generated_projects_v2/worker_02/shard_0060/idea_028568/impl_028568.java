...
@Data
public class Idea28568Config {
    private String name = "idea_028568";
 ...
 */
@Slf4j
public class Idea28568Service {
    private static final int IDEA_ID = 28568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28568Service() {
        this(new Idea28568Config());
    }

    public Idea28568Service(Idea28568Config config) {
        this.config = config != null ? config : new Idea28568Config();
