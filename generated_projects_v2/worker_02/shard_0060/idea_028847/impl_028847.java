...
@Data
public class Idea28847Config {
    private String name = "idea_028847";
 ...
 */
@Slf4j
public class Idea28847Service {
    private static final int IDEA_ID = 28847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28847Service() {
        this(new Idea28847Config());
    }

    public Idea28847Service(Idea28847Config config) {
        this.config = config != null ? config : new Idea28847Config();
