...
@Data
public class Idea28564Config {
    private String name = "idea_028564";
 ...
 */
@Slf4j
public class Idea28564Service {
    private static final int IDEA_ID = 28564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28564Service() {
        this(new Idea28564Config());
    }

    public Idea28564Service(Idea28564Config config) {
        this.config = config != null ? config : new Idea28564Config();
