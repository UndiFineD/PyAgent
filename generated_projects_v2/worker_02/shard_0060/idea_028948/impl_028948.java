...
@Data
public class Idea28948Config {
    private String name = "idea_028948";
 ...
 */
@Slf4j
public class Idea28948Service {
    private static final int IDEA_ID = 28948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28948Service() {
        this(new Idea28948Config());
    }

    public Idea28948Service(Idea28948Config config) {
        this.config = config != null ? config : new Idea28948Config();
