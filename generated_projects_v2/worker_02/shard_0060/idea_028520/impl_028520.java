...
@Data
public class Idea28520Config {
    private String name = "idea_028520";
 ...
 */
@Slf4j
public class Idea28520Service {
    private static final int IDEA_ID = 28520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28520Service() {
        this(new Idea28520Config());
    }

    public Idea28520Service(Idea28520Config config) {
        this.config = config != null ? config : new Idea28520Config();
