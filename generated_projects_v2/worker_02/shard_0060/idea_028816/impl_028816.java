...
@Data
public class Idea28816Config {
    private String name = "idea_028816";
 ...
 */
@Slf4j
public class Idea28816Service {
    private static final int IDEA_ID = 28816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28816Service() {
        this(new Idea28816Config());
    }

    public Idea28816Service(Idea28816Config config) {
        this.config = config != null ? config : new Idea28816Config();
