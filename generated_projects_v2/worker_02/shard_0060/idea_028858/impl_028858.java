...
@Data
public class Idea28858Config {
    private String name = "idea_028858";
 ...
 */
@Slf4j
public class Idea28858Service {
    private static final int IDEA_ID = 28858;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28858Service() {
        this(new Idea28858Config());
    }

    public Idea28858Service(Idea28858Config config) {
        this.config = config != null ? config : new Idea28858Config();
