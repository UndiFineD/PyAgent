...
@Data
public class Idea28573Config {
    private String name = "idea_028573";
 ...
 */
@Slf4j
public class Idea28573Service {
    private static final int IDEA_ID = 28573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28573Service() {
        this(new Idea28573Config());
    }

    public Idea28573Service(Idea28573Config config) {
        this.config = config != null ? config : new Idea28573Config();
