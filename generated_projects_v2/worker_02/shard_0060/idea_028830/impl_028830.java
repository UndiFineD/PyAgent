...
@Data
public class Idea28830Config {
    private String name = "idea_028830";
 ...
 */
@Slf4j
public class Idea28830Service {
    private static final int IDEA_ID = 28830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28830Service() {
        this(new Idea28830Config());
    }

    public Idea28830Service(Idea28830Config config) {
        this.config = config != null ? config : new Idea28830Config();
