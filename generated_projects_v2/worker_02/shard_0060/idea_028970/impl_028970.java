...
@Data
public class Idea28970Config {
    private String name = "idea_028970";
 ...
 */
@Slf4j
public class Idea28970Service {
    private static final int IDEA_ID = 28970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28970Service() {
        this(new Idea28970Config());
    }

    public Idea28970Service(Idea28970Config config) {
        this.config = config != null ? config : new Idea28970Config();
