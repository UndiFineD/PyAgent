...
@Data
public class Idea28507Config {
    private String name = "idea_028507";
 ...
 */
@Slf4j
public class Idea28507Service {
    private static final int IDEA_ID = 28507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28507Service() {
        this(new Idea28507Config());
    }

    public Idea28507Service(Idea28507Config config) {
        this.config = config != null ? config : new Idea28507Config();
