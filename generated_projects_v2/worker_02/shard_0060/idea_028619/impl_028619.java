...
@Data
public class Idea28619Config {
    private String name = "idea_028619";
 ...
 */
@Slf4j
public class Idea28619Service {
    private static final int IDEA_ID = 28619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28619Service() {
        this(new Idea28619Config());
    }

    public Idea28619Service(Idea28619Config config) {
        this.config = config != null ? config : new Idea28619Config();
