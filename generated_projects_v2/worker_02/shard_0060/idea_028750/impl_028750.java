...
@Data
public class Idea28750Config {
    private String name = "idea_028750";
 ...
 */
@Slf4j
public class Idea28750Service {
    private static final int IDEA_ID = 28750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28750Service() {
        this(new Idea28750Config());
    }

    public Idea28750Service(Idea28750Config config) {
        this.config = config != null ? config : new Idea28750Config();
