...
@Data
public class Idea28922Config {
    private String name = "idea_028922";
 ...
 */
@Slf4j
public class Idea28922Service {
    private static final int IDEA_ID = 28922;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28922Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28922Service() {
        this(new Idea28922Config());
    }

    public Idea28922Service(Idea28922Config config) {
        this.config = config != null ? config : new Idea28922Config();
