...
@Data
public class Idea28844Config {
    private String name = "idea_028844";
 ...
 */
@Slf4j
public class Idea28844Service {
    private static final int IDEA_ID = 28844;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28844Service() {
        this(new Idea28844Config());
    }

    public Idea28844Service(Idea28844Config config) {
        this.config = config != null ? config : new Idea28844Config();
