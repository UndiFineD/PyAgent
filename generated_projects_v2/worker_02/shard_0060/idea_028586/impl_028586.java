...
@Data
public class Idea28586Config {
    private String name = "idea_028586";
 ...
 */
@Slf4j
public class Idea28586Service {
    private static final int IDEA_ID = 28586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28586Service() {
        this(new Idea28586Config());
    }

    public Idea28586Service(Idea28586Config config) {
        this.config = config != null ? config : new Idea28586Config();
