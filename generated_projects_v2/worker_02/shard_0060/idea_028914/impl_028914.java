...
@Data
public class Idea28914Config {
    private String name = "idea_028914";
 ...
 */
@Slf4j
public class Idea28914Service {
    private static final int IDEA_ID = 28914;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28914Service() {
        this(new Idea28914Config());
    }

    public Idea28914Service(Idea28914Config config) {
        this.config = config != null ? config : new Idea28914Config();
