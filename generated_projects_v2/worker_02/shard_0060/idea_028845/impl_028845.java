...
@Data
public class Idea28845Config {
    private String name = "idea_028845";
 ...
 */
@Slf4j
public class Idea28845Service {
    private static final int IDEA_ID = 28845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28845Service() {
        this(new Idea28845Config());
    }

    public Idea28845Service(Idea28845Config config) {
        this.config = config != null ? config : new Idea28845Config();
