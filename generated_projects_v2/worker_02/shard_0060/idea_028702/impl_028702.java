...
@Data
public class Idea28702Config {
    private String name = "idea_028702";
 ...
 */
@Slf4j
public class Idea28702Service {
    private static final int IDEA_ID = 28702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28702Service() {
        this(new Idea28702Config());
    }

    public Idea28702Service(Idea28702Config config) {
        this.config = config != null ? config : new Idea28702Config();
