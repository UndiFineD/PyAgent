...
@Data
public class Idea28764Config {
    private String name = "idea_028764";
 ...
 */
@Slf4j
public class Idea28764Service {
    private static final int IDEA_ID = 28764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28764Service() {
        this(new Idea28764Config());
    }

    public Idea28764Service(Idea28764Config config) {
        this.config = config != null ? config : new Idea28764Config();
