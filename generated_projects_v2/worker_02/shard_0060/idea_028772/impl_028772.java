...
@Data
public class Idea28772Config {
    private String name = "idea_028772";
 ...
 */
@Slf4j
public class Idea28772Service {
    private static final int IDEA_ID = 28772;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28772Service() {
        this(new Idea28772Config());
    }

    public Idea28772Service(Idea28772Config config) {
        this.config = config != null ? config : new Idea28772Config();
