...
@Data
public class Idea28973Config {
    private String name = "idea_028973";
 ...
 */
@Slf4j
public class Idea28973Service {
    private static final int IDEA_ID = 28973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28973Service() {
        this(new Idea28973Config());
    }

    public Idea28973Service(Idea28973Config config) {
        this.config = config != null ? config : new Idea28973Config();
