...
@Data
public class Idea28762Config {
    private String name = "idea_028762";
 ...
 */
@Slf4j
public class Idea28762Service {
    private static final int IDEA_ID = 28762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28762Service() {
        this(new Idea28762Config());
    }

    public Idea28762Service(Idea28762Config config) {
        this.config = config != null ? config : new Idea28762Config();
