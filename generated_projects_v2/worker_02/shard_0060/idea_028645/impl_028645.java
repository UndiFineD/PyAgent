...
@Data
public class Idea28645Config {
    private String name = "idea_028645";
 ...
 */
@Slf4j
public class Idea28645Service {
    private static final int IDEA_ID = 28645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28645Service() {
        this(new Idea28645Config());
    }

    public Idea28645Service(Idea28645Config config) {
        this.config = config != null ? config : new Idea28645Config();
