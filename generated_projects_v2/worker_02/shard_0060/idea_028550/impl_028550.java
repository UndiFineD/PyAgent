...
@Data
public class Idea28550Config {
    private String name = "idea_028550";
 ...
 */
@Slf4j
public class Idea28550Service {
    private static final int IDEA_ID = 28550;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28550Service() {
        this(new Idea28550Config());
    }

    public Idea28550Service(Idea28550Config config) {
        this.config = config != null ? config : new Idea28550Config();
