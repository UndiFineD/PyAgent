...
@Data
public class Idea28913Config {
    private String name = "idea_028913";
 ...
 */
@Slf4j
public class Idea28913Service {
    private static final int IDEA_ID = 28913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28913Service() {
        this(new Idea28913Config());
    }

    public Idea28913Service(Idea28913Config config) {
        this.config = config != null ? config : new Idea28913Config();
