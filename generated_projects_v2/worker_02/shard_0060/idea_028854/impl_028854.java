...
@Data
public class Idea28854Config {
    private String name = "idea_028854";
 ...
 */
@Slf4j
public class Idea28854Service {
    private static final int IDEA_ID = 28854;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28854Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28854Service() {
        this(new Idea28854Config());
    }

    public Idea28854Service(Idea28854Config config) {
        this.config = config != null ? config : new Idea28854Config();
