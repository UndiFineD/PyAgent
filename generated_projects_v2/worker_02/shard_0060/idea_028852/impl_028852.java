...
@Data
public class Idea28852Config {
    private String name = "idea_028852";
 ...
 */
@Slf4j
public class Idea28852Service {
    private static final int IDEA_ID = 28852;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28852Service() {
        this(new Idea28852Config());
    }

    public Idea28852Service(Idea28852Config config) {
        this.config = config != null ? config : new Idea28852Config();
