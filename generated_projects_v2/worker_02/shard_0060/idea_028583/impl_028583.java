...
@Data
public class Idea28583Config {
    private String name = "idea_028583";
 ...
 */
@Slf4j
public class Idea28583Service {
    private static final int IDEA_ID = 28583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28583Service() {
        this(new Idea28583Config());
    }

    public Idea28583Service(Idea28583Config config) {
        this.config = config != null ? config : new Idea28583Config();
