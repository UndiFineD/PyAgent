...
@Data
public class Idea28963Config {
    private String name = "idea_028963";
 ...
 */
@Slf4j
public class Idea28963Service {
    private static final int IDEA_ID = 28963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28963Service() {
        this(new Idea28963Config());
    }

    public Idea28963Service(Idea28963Config config) {
        this.config = config != null ? config : new Idea28963Config();
