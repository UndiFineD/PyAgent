...
@Data
public class Idea28925Config {
    private String name = "idea_028925";
 ...
 */
@Slf4j
public class Idea28925Service {
    private static final int IDEA_ID = 28925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28925Service() {
        this(new Idea28925Config());
    }

    public Idea28925Service(Idea28925Config config) {
        this.config = config != null ? config : new Idea28925Config();
