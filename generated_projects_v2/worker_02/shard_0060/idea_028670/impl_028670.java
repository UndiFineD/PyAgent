...
@Data
public class Idea28670Config {
    private String name = "idea_028670";
 ...
 */
@Slf4j
public class Idea28670Service {
    private static final int IDEA_ID = 28670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28670Service() {
        this(new Idea28670Config());
    }

    public Idea28670Service(Idea28670Config config) {
        this.config = config != null ? config : new Idea28670Config();
