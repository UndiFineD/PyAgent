...
@Data
public class Idea28534Config {
    private String name = "idea_028534";
 ...
 */
@Slf4j
public class Idea28534Service {
    private static final int IDEA_ID = 28534;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28534Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28534Service() {
        this(new Idea28534Config());
    }

    public Idea28534Service(Idea28534Config config) {
        this.config = config != null ? config : new Idea28534Config();
