...
@Data
public class Idea28846Config {
    private String name = "idea_028846";
 ...
 */
@Slf4j
public class Idea28846Service {
    private static final int IDEA_ID = 28846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28846Service() {
        this(new Idea28846Config());
    }

    public Idea28846Service(Idea28846Config config) {
        this.config = config != null ? config : new Idea28846Config();
