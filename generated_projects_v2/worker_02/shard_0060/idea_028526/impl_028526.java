...
@Data
public class Idea28526Config {
    private String name = "idea_028526";
 ...
 */
@Slf4j
public class Idea28526Service {
    private static final int IDEA_ID = 28526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28526Service() {
        this(new Idea28526Config());
    }

    public Idea28526Service(Idea28526Config config) {
        this.config = config != null ? config : new Idea28526Config();
