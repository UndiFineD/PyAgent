...
@Data
public class Idea28906Config {
    private String name = "idea_028906";
 ...
 */
@Slf4j
public class Idea28906Service {
    private static final int IDEA_ID = 28906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28906Service() {
        this(new Idea28906Config());
    }

    public Idea28906Service(Idea28906Config config) {
        this.config = config != null ? config : new Idea28906Config();
