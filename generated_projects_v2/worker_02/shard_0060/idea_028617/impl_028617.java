...
@Data
public class Idea28617Config {
    private String name = "idea_028617";
 ...
 */
@Slf4j
public class Idea28617Service {
    private static final int IDEA_ID = 28617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28617Service() {
        this(new Idea28617Config());
    }

    public Idea28617Service(Idea28617Config config) {
        this.config = config != null ? config : new Idea28617Config();
