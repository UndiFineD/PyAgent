...
@Data
public class Idea28639Config {
    private String name = "idea_028639";
 ...
 */
@Slf4j
public class Idea28639Service {
    private static final int IDEA_ID = 28639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28639Service() {
        this(new Idea28639Config());
    }

    public Idea28639Service(Idea28639Config config) {
        this.config = config != null ? config : new Idea28639Config();
