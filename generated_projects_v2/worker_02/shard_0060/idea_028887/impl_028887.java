...
@Data
public class Idea28887Config {
    private String name = "idea_028887";
 ...
 */
@Slf4j
public class Idea28887Service {
    private static final int IDEA_ID = 28887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28887Service() {
        this(new Idea28887Config());
    }

    public Idea28887Service(Idea28887Config config) {
        this.config = config != null ? config : new Idea28887Config();
