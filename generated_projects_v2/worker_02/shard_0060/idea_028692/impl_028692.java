...
@Data
public class Idea28692Config {
    private String name = "idea_028692";
 ...
 */
@Slf4j
public class Idea28692Service {
    private static final int IDEA_ID = 28692;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28692Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28692Service() {
        this(new Idea28692Config());
    }

    public Idea28692Service(Idea28692Config config) {
        this.config = config != null ? config : new Idea28692Config();
