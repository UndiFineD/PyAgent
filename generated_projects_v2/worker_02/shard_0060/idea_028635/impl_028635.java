...
@Data
public class Idea28635Config {
    private String name = "idea_028635";
 ...
 */
@Slf4j
public class Idea28635Service {
    private static final int IDEA_ID = 28635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28635Service() {
        this(new Idea28635Config());
    }

    public Idea28635Service(Idea28635Config config) {
        this.config = config != null ? config : new Idea28635Config();
