...
@Data
public class Idea28974Config {
    private String name = "idea_028974";
 ...
 */
@Slf4j
public class Idea28974Service {
    private static final int IDEA_ID = 28974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28974Service() {
        this(new Idea28974Config());
    }

    public Idea28974Service(Idea28974Config config) {
        this.config = config != null ? config : new Idea28974Config();
