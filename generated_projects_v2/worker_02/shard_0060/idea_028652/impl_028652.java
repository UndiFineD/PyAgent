...
@Data
public class Idea28652Config {
    private String name = "idea_028652";
 ...
 */
@Slf4j
public class Idea28652Service {
    private static final int IDEA_ID = 28652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28652Service() {
        this(new Idea28652Config());
    }

    public Idea28652Service(Idea28652Config config) {
        this.config = config != null ? config : new Idea28652Config();
