...
@Data
public class Idea28622Config {
    private String name = "idea_028622";
 ...
 */
@Slf4j
public class Idea28622Service {
    private static final int IDEA_ID = 28622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28622Service() {
        this(new Idea28622Config());
    }

    public Idea28622Service(Idea28622Config config) {
        this.config = config != null ? config : new Idea28622Config();
