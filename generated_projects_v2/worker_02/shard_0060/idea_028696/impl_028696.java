...
@Data
public class Idea28696Config {
    private String name = "idea_028696";
 ...
 */
@Slf4j
public class Idea28696Service {
    private static final int IDEA_ID = 28696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28696Service() {
        this(new Idea28696Config());
    }

    public Idea28696Service(Idea28696Config config) {
        this.config = config != null ? config : new Idea28696Config();
