...
@Data
public class Idea28578Config {
    private String name = "idea_028578";
 ...
 */
@Slf4j
public class Idea28578Service {
    private static final int IDEA_ID = 28578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28578Service() {
        this(new Idea28578Config());
    }

    public Idea28578Service(Idea28578Config config) {
        this.config = config != null ? config : new Idea28578Config();
