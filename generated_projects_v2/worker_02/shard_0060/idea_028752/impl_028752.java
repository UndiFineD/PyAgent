...
@Data
public class Idea28752Config {
    private String name = "idea_028752";
 ...
 */
@Slf4j
public class Idea28752Service {
    private static final int IDEA_ID = 28752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28752Service() {
        this(new Idea28752Config());
    }

    public Idea28752Service(Idea28752Config config) {
        this.config = config != null ? config : new Idea28752Config();
