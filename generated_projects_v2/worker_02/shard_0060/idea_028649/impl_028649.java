...
@Data
public class Idea28649Config {
    private String name = "idea_028649";
 ...
 */
@Slf4j
public class Idea28649Service {
    private static final int IDEA_ID = 28649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28649Service() {
        this(new Idea28649Config());
    }

    public Idea28649Service(Idea28649Config config) {
        this.config = config != null ? config : new Idea28649Config();
