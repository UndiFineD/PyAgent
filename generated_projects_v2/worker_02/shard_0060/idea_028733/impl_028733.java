...
@Data
public class Idea28733Config {
    private String name = "idea_028733";
 ...
 */
@Slf4j
public class Idea28733Service {
    private static final int IDEA_ID = 28733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28733Service() {
        this(new Idea28733Config());
    }

    public Idea28733Service(Idea28733Config config) {
        this.config = config != null ? config : new Idea28733Config();
