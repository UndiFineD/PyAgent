...
@Data
public class Idea28590Config {
    private String name = "idea_028590";
 ...
 */
@Slf4j
public class Idea28590Service {
    private static final int IDEA_ID = 28590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28590Service() {
        this(new Idea28590Config());
    }

    public Idea28590Service(Idea28590Config config) {
        this.config = config != null ? config : new Idea28590Config();
