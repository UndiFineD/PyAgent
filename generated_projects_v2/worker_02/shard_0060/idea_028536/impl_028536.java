...
@Data
public class Idea28536Config {
    private String name = "idea_028536";
 ...
 */
@Slf4j
public class Idea28536Service {
    private static final int IDEA_ID = 28536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28536Service() {
        this(new Idea28536Config());
    }

    public Idea28536Service(Idea28536Config config) {
        this.config = config != null ? config : new Idea28536Config();
