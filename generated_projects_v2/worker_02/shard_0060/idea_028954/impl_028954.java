...
@Data
public class Idea28954Config {
    private String name = "idea_028954";
 ...
 */
@Slf4j
public class Idea28954Service {
    private static final int IDEA_ID = 28954;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28954Service() {
        this(new Idea28954Config());
    }

    public Idea28954Service(Idea28954Config config) {
        this.config = config != null ? config : new Idea28954Config();
