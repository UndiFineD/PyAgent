...
@Data
public class Idea28630Config {
    private String name = "idea_028630";
 ...
 */
@Slf4j
public class Idea28630Service {
    private static final int IDEA_ID = 28630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28630Service() {
        this(new Idea28630Config());
    }

    public Idea28630Service(Idea28630Config config) {
        this.config = config != null ? config : new Idea28630Config();
