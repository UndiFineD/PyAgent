...
@Data
public class Idea28515Config {
    private String name = "idea_028515";
 ...
 */
@Slf4j
public class Idea28515Service {
    private static final int IDEA_ID = 28515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28515Service() {
        this(new Idea28515Config());
    }

    public Idea28515Service(Idea28515Config config) {
        this.config = config != null ? config : new Idea28515Config();
