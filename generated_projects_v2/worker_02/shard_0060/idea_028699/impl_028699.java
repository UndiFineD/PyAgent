...
@Data
public class Idea28699Config {
    private String name = "idea_028699";
 ...
 */
@Slf4j
public class Idea28699Service {
    private static final int IDEA_ID = 28699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28699Service() {
        this(new Idea28699Config());
    }

    public Idea28699Service(Idea28699Config config) {
        this.config = config != null ? config : new Idea28699Config();
