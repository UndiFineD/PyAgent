...
@Data
public class Idea28552Config {
    private String name = "idea_028552";
 ...
 */
@Slf4j
public class Idea28552Service {
    private static final int IDEA_ID = 28552;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28552Service() {
        this(new Idea28552Config());
    }

    public Idea28552Service(Idea28552Config config) {
        this.config = config != null ? config : new Idea28552Config();
