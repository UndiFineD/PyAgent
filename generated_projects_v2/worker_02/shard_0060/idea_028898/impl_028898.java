...
@Data
public class Idea28898Config {
    private String name = "idea_028898";
 ...
 */
@Slf4j
public class Idea28898Service {
    private static final int IDEA_ID = 28898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28898Service() {
        this(new Idea28898Config());
    }

    public Idea28898Service(Idea28898Config config) {
        this.config = config != null ? config : new Idea28898Config();
