...
@Data
public class Idea28833Config {
    private String name = "idea_028833";
 ...
 */
@Slf4j
public class Idea28833Service {
    private static final int IDEA_ID = 28833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28833Service() {
        this(new Idea28833Config());
    }

    public Idea28833Service(Idea28833Config config) {
        this.config = config != null ? config : new Idea28833Config();
