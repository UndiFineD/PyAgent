...
@Data
public class Idea28555Config {
    private String name = "idea_028555";
 ...
 */
@Slf4j
public class Idea28555Service {
    private static final int IDEA_ID = 28555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28555Service() {
        this(new Idea28555Config());
    }

    public Idea28555Service(Idea28555Config config) {
        this.config = config != null ? config : new Idea28555Config();
