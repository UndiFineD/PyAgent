...
@Data
public class Idea28596Config {
    private String name = "idea_028596";
 ...
 */
@Slf4j
public class Idea28596Service {
    private static final int IDEA_ID = 28596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28596Service() {
        this(new Idea28596Config());
    }

    public Idea28596Service(Idea28596Config config) {
        this.config = config != null ? config : new Idea28596Config();
