...
@Data
public class Idea28876Config {
    private String name = "idea_028876";
 ...
 */
@Slf4j
public class Idea28876Service {
    private static final int IDEA_ID = 28876;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28876Service() {
        this(new Idea28876Config());
    }

    public Idea28876Service(Idea28876Config config) {
        this.config = config != null ? config : new Idea28876Config();
