...
@Data
public class Idea28790Config {
    private String name = "idea_028790";
 ...
 */
@Slf4j
public class Idea28790Service {
    private static final int IDEA_ID = 28790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28790Service() {
        this(new Idea28790Config());
    }

    public Idea28790Service(Idea28790Config config) {
        this.config = config != null ? config : new Idea28790Config();
