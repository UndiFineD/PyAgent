...
@Data
public class Idea28521Config {
    private String name = "idea_028521";
 ...
 */
@Slf4j
public class Idea28521Service {
    private static final int IDEA_ID = 28521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28521Service() {
        this(new Idea28521Config());
    }

    public Idea28521Service(Idea28521Config config) {
        this.config = config != null ? config : new Idea28521Config();
