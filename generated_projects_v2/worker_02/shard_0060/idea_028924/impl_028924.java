...
@Data
public class Idea28924Config {
    private String name = "idea_028924";
 ...
 */
@Slf4j
public class Idea28924Service {
    private static final int IDEA_ID = 28924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28924Service() {
        this(new Idea28924Config());
    }

    public Idea28924Service(Idea28924Config config) {
        this.config = config != null ? config : new Idea28924Config();
