...
@Data
public class Idea28539Config {
    private String name = "idea_028539";
 ...
 */
@Slf4j
public class Idea28539Service {
    private static final int IDEA_ID = 28539;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28539Service() {
        this(new Idea28539Config());
    }

    public Idea28539Service(Idea28539Config config) {
        this.config = config != null ? config : new Idea28539Config();
