...
@Data
public class Idea28608Config {
    private String name = "idea_028608";
 ...
 */
@Slf4j
public class Idea28608Service {
    private static final int IDEA_ID = 28608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28608Service() {
        this(new Idea28608Config());
    }

    public Idea28608Service(Idea28608Config config) {
        this.config = config != null ? config : new Idea28608Config();
