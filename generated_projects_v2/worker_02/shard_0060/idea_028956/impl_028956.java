...
@Data
public class Idea28956Config {
    private String name = "idea_028956";
 ...
 */
@Slf4j
public class Idea28956Service {
    private static final int IDEA_ID = 28956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28956Service() {
        this(new Idea28956Config());
    }

    public Idea28956Service(Idea28956Config config) {
        this.config = config != null ? config : new Idea28956Config();
