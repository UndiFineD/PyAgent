...
@Data
public class Idea28576Config {
    private String name = "idea_028576";
 ...
 */
@Slf4j
public class Idea28576Service {
    private static final int IDEA_ID = 28576;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28576Service() {
        this(new Idea28576Config());
    }

    public Idea28576Service(Idea28576Config config) {
        this.config = config != null ? config : new Idea28576Config();
