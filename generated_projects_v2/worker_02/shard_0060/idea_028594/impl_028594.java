...
@Data
public class Idea28594Config {
    private String name = "idea_028594";
 ...
 */
@Slf4j
public class Idea28594Service {
    private static final int IDEA_ID = 28594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28594Service() {
        this(new Idea28594Config());
    }

    public Idea28594Service(Idea28594Config config) {
        this.config = config != null ? config : new Idea28594Config();
