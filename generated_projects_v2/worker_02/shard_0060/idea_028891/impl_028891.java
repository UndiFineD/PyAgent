...
@Data
public class Idea28891Config {
    private String name = "idea_028891";
 ...
 */
@Slf4j
public class Idea28891Service {
    private static final int IDEA_ID = 28891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28891Service() {
        this(new Idea28891Config());
    }

    public Idea28891Service(Idea28891Config config) {
        this.config = config != null ? config : new Idea28891Config();
