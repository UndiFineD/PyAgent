...
@Data
public class Idea28727Config {
    private String name = "idea_028727";
 ...
 */
@Slf4j
public class Idea28727Service {
    private static final int IDEA_ID = 28727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28727Service() {
        this(new Idea28727Config());
    }

    public Idea28727Service(Idea28727Config config) {
        this.config = config != null ? config : new Idea28727Config();
