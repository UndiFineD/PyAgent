...
@Data
public class Idea28634Config {
    private String name = "idea_028634";
 ...
 */
@Slf4j
public class Idea28634Service {
    private static final int IDEA_ID = 28634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28634Service() {
        this(new Idea28634Config());
    }

    public Idea28634Service(Idea28634Config config) {
        this.config = config != null ? config : new Idea28634Config();
