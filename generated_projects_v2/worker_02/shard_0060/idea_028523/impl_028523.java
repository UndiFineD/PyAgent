...
@Data
public class Idea28523Config {
    private String name = "idea_028523";
 ...
 */
@Slf4j
public class Idea28523Service {
    private static final int IDEA_ID = 28523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28523Service() {
        this(new Idea28523Config());
    }

    public Idea28523Service(Idea28523Config config) {
        this.config = config != null ? config : new Idea28523Config();
