...
@Data
public class Idea28879Config {
    private String name = "idea_028879";
 ...
 */
@Slf4j
public class Idea28879Service {
    private static final int IDEA_ID = 28879;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28879Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28879Service() {
        this(new Idea28879Config());
    }

    public Idea28879Service(Idea28879Config config) {
        this.config = config != null ? config : new Idea28879Config();
