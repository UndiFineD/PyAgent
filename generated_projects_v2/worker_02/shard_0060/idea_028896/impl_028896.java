...
@Data
public class Idea28896Config {
    private String name = "idea_028896";
 ...
 */
@Slf4j
public class Idea28896Service {
    private static final int IDEA_ID = 28896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28896Service() {
        this(new Idea28896Config());
    }

    public Idea28896Service(Idea28896Config config) {
        this.config = config != null ? config : new Idea28896Config();
