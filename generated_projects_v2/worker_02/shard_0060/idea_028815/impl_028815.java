...
@Data
public class Idea28815Config {
    private String name = "idea_028815";
 ...
 */
@Slf4j
public class Idea28815Service {
    private static final int IDEA_ID = 28815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28815Service() {
        this(new Idea28815Config());
    }

    public Idea28815Service(Idea28815Config config) {
        this.config = config != null ? config : new Idea28815Config();
