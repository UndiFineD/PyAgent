...
@Data
public class Idea28835Config {
    private String name = "idea_028835";
 ...
 */
@Slf4j
public class Idea28835Service {
    private static final int IDEA_ID = 28835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28835Service() {
        this(new Idea28835Config());
    }

    public Idea28835Service(Idea28835Config config) {
        this.config = config != null ? config : new Idea28835Config();
