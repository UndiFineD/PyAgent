...
@Data
public class Idea28538Config {
    private String name = "idea_028538";
 ...
 */
@Slf4j
public class Idea28538Service {
    private static final int IDEA_ID = 28538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28538Service() {
        this(new Idea28538Config());
    }

    public Idea28538Service(Idea28538Config config) {
        this.config = config != null ? config : new Idea28538Config();
