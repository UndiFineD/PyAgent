...
@Data
public class Idea28834Config {
    private String name = "idea_028834";
 ...
 */
@Slf4j
public class Idea28834Service {
    private static final int IDEA_ID = 28834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28834Service() {
        this(new Idea28834Config());
    }

    public Idea28834Service(Idea28834Config config) {
        this.config = config != null ? config : new Idea28834Config();
