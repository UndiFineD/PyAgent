...
@Data
public class Idea28741Config {
    private String name = "idea_028741";
 ...
 */
@Slf4j
public class Idea28741Service {
    private static final int IDEA_ID = 28741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28741Service() {
        this(new Idea28741Config());
    }

    public Idea28741Service(Idea28741Config config) {
        this.config = config != null ? config : new Idea28741Config();
