...
@Data
public class Idea28597Config {
    private String name = "idea_028597";
 ...
 */
@Slf4j
public class Idea28597Service {
    private static final int IDEA_ID = 28597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28597Service() {
        this(new Idea28597Config());
    }

    public Idea28597Service(Idea28597Config config) {
        this.config = config != null ? config : new Idea28597Config();
