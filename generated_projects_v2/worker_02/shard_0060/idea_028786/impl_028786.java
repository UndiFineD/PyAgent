...
@Data
public class Idea28786Config {
    private String name = "idea_028786";
 ...
 */
@Slf4j
public class Idea28786Service {
    private static final int IDEA_ID = 28786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28786Service() {
        this(new Idea28786Config());
    }

    public Idea28786Service(Idea28786Config config) {
        this.config = config != null ? config : new Idea28786Config();
