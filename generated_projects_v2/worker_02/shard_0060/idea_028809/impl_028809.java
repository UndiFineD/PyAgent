...
@Data
public class Idea28809Config {
    private String name = "idea_028809";
 ...
 */
@Slf4j
public class Idea28809Service {
    private static final int IDEA_ID = 28809;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28809Service() {
        this(new Idea28809Config());
    }

    public Idea28809Service(Idea28809Config config) {
        this.config = config != null ? config : new Idea28809Config();
