...
@Data
public class Idea28947Config {
    private String name = "idea_028947";
 ...
 */
@Slf4j
public class Idea28947Service {
    private static final int IDEA_ID = 28947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28947Service() {
        this(new Idea28947Config());
    }

    public Idea28947Service(Idea28947Config config) {
        this.config = config != null ? config : new Idea28947Config();
