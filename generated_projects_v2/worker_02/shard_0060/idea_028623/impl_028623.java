...
@Data
public class Idea28623Config {
    private String name = "idea_028623";
 ...
 */
@Slf4j
public class Idea28623Service {
    private static final int IDEA_ID = 28623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28623Service() {
        this(new Idea28623Config());
    }

    public Idea28623Service(Idea28623Config config) {
        this.config = config != null ? config : new Idea28623Config();
