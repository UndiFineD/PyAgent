...
@Data
public class Idea28660Config {
    private String name = "idea_028660";
 ...
 */
@Slf4j
public class Idea28660Service {
    private static final int IDEA_ID = 28660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28660Service() {
        this(new Idea28660Config());
    }

    public Idea28660Service(Idea28660Config config) {
        this.config = config != null ? config : new Idea28660Config();
