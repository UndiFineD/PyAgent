...
@Data
public class Idea28789Config {
    private String name = "idea_028789";
 ...
 */
@Slf4j
public class Idea28789Service {
    private static final int IDEA_ID = 28789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28789Service() {
        this(new Idea28789Config());
    }

    public Idea28789Service(Idea28789Config config) {
        this.config = config != null ? config : new Idea28789Config();
