...
@Data
public class Idea28895Config {
    private String name = "idea_028895";
 ...
 */
@Slf4j
public class Idea28895Service {
    private static final int IDEA_ID = 28895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28895Service() {
        this(new Idea28895Config());
    }

    public Idea28895Service(Idea28895Config config) {
        this.config = config != null ? config : new Idea28895Config();
