...
@Data
public class Idea28892Config {
    private String name = "idea_028892";
 ...
 */
@Slf4j
public class Idea28892Service {
    private static final int IDEA_ID = 28892;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28892Service() {
        this(new Idea28892Config());
    }

    public Idea28892Service(Idea28892Config config) {
        this.config = config != null ? config : new Idea28892Config();
