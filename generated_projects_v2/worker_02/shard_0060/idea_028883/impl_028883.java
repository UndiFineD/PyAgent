...
@Data
public class Idea28883Config {
    private String name = "idea_028883";
 ...
 */
@Slf4j
public class Idea28883Service {
    private static final int IDEA_ID = 28883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28883Service() {
        this(new Idea28883Config());
    }

    public Idea28883Service(Idea28883Config config) {
        this.config = config != null ? config : new Idea28883Config();
