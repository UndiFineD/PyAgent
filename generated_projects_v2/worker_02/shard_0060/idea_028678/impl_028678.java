...
@Data
public class Idea28678Config {
    private String name = "idea_028678";
 ...
 */
@Slf4j
public class Idea28678Service {
    private static final int IDEA_ID = 28678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28678Service() {
        this(new Idea28678Config());
    }

    public Idea28678Service(Idea28678Config config) {
        this.config = config != null ? config : new Idea28678Config();
