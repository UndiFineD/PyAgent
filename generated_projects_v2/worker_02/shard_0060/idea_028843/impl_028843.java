...
@Data
public class Idea28843Config {
    private String name = "idea_028843";
 ...
 */
@Slf4j
public class Idea28843Service {
    private static final int IDEA_ID = 28843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28843Service() {
        this(new Idea28843Config());
    }

    public Idea28843Service(Idea28843Config config) {
        this.config = config != null ? config : new Idea28843Config();
