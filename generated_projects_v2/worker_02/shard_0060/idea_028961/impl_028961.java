...
@Data
public class Idea28961Config {
    private String name = "idea_028961";
 ...
 */
@Slf4j
public class Idea28961Service {
    private static final int IDEA_ID = 28961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28961Service() {
        this(new Idea28961Config());
    }

    public Idea28961Service(Idea28961Config config) {
        this.config = config != null ? config : new Idea28961Config();
