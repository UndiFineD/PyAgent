...
@Data
public class Idea28940Config {
    private String name = "idea_028940";
 ...
 */
@Slf4j
public class Idea28940Service {
    private static final int IDEA_ID = 28940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28940Service() {
        this(new Idea28940Config());
    }

    public Idea28940Service(Idea28940Config config) {
        this.config = config != null ? config : new Idea28940Config();
