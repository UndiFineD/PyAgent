...
@Data
public class Idea28814Config {
    private String name = "idea_028814";
 ...
 */
@Slf4j
public class Idea28814Service {
    private static final int IDEA_ID = 28814;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28814Service() {
        this(new Idea28814Config());
    }

    public Idea28814Service(Idea28814Config config) {
        this.config = config != null ? config : new Idea28814Config();
