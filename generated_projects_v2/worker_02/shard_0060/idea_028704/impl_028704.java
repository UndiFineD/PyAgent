...
@Data
public class Idea28704Config {
    private String name = "idea_028704";
 ...
 */
@Slf4j
public class Idea28704Service {
    private static final int IDEA_ID = 28704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28704Service() {
        this(new Idea28704Config());
    }

    public Idea28704Service(Idea28704Config config) {
        this.config = config != null ? config : new Idea28704Config();
