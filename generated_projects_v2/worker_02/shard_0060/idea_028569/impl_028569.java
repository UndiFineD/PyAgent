...
@Data
public class Idea28569Config {
    private String name = "idea_028569";
 ...
 */
@Slf4j
public class Idea28569Service {
    private static final int IDEA_ID = 28569;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28569Service() {
        this(new Idea28569Config());
    }

    public Idea28569Service(Idea28569Config config) {
        this.config = config != null ? config : new Idea28569Config();
