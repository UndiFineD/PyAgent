...
@Data
public class Idea28758Config {
    private String name = "idea_028758";
 ...
 */
@Slf4j
public class Idea28758Service {
    private static final int IDEA_ID = 28758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28758Service() {
        this(new Idea28758Config());
    }

    public Idea28758Service(Idea28758Config config) {
        this.config = config != null ? config : new Idea28758Config();
