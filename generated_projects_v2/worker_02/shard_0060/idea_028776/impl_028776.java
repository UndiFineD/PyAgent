...
@Data
public class Idea28776Config {
    private String name = "idea_028776";
 ...
 */
@Slf4j
public class Idea28776Service {
    private static final int IDEA_ID = 28776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28776Service() {
        this(new Idea28776Config());
    }

    public Idea28776Service(Idea28776Config config) {
        this.config = config != null ? config : new Idea28776Config();
