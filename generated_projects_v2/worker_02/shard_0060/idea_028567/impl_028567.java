...
@Data
public class Idea28567Config {
    private String name = "idea_028567";
 ...
 */
@Slf4j
public class Idea28567Service {
    private static final int IDEA_ID = 28567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28567Service() {
        this(new Idea28567Config());
    }

    public Idea28567Service(Idea28567Config config) {
        this.config = config != null ? config : new Idea28567Config();
