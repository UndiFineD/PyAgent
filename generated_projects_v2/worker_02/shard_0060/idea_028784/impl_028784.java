...
@Data
public class Idea28784Config {
    private String name = "idea_028784";
 ...
 */
@Slf4j
public class Idea28784Service {
    private static final int IDEA_ID = 28784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28784Service() {
        this(new Idea28784Config());
    }

    public Idea28784Service(Idea28784Config config) {
        this.config = config != null ? config : new Idea28784Config();
