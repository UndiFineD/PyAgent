...
@Data
public class Idea28821Config {
    private String name = "idea_028821";
 ...
 */
@Slf4j
public class Idea28821Service {
    private static final int IDEA_ID = 28821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28821Service() {
        this(new Idea28821Config());
    }

    public Idea28821Service(Idea28821Config config) {
        this.config = config != null ? config : new Idea28821Config();
