...
@Data
public class Idea28757Config {
    private String name = "idea_028757";
 ...
 */
@Slf4j
public class Idea28757Service {
    private static final int IDEA_ID = 28757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28757Service() {
        this(new Idea28757Config());
    }

    public Idea28757Service(Idea28757Config config) {
        this.config = config != null ? config : new Idea28757Config();
