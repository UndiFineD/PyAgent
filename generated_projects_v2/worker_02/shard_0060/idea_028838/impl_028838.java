...
@Data
public class Idea28838Config {
    private String name = "idea_028838";
 ...
 */
@Slf4j
public class Idea28838Service {
    private static final int IDEA_ID = 28838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28838Service() {
        this(new Idea28838Config());
    }

    public Idea28838Service(Idea28838Config config) {
        this.config = config != null ? config : new Idea28838Config();
