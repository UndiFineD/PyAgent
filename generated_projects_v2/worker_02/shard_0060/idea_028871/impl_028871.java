...
@Data
public class Idea28871Config {
    private String name = "idea_028871";
 ...
 */
@Slf4j
public class Idea28871Service {
    private static final int IDEA_ID = 28871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28871Service() {
        this(new Idea28871Config());
    }

    public Idea28871Service(Idea28871Config config) {
        this.config = config != null ? config : new Idea28871Config();
