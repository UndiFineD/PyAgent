...
@Data
public class Idea28584Config {
    private String name = "idea_028584";
 ...
 */
@Slf4j
public class Idea28584Service {
    private static final int IDEA_ID = 28584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28584Service() {
        this(new Idea28584Config());
    }

    public Idea28584Service(Idea28584Config config) {
        this.config = config != null ? config : new Idea28584Config();
