...
@Data
public class Idea28514Config {
    private String name = "idea_028514";
 ...
 */
@Slf4j
public class Idea28514Service {
    private static final int IDEA_ID = 28514;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28514Service() {
        this(new Idea28514Config());
    }

    public Idea28514Service(Idea28514Config config) {
        this.config = config != null ? config : new Idea28514Config();
