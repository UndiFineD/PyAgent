...
@Data
public class Idea28517Config {
    private String name = "idea_028517";
 ...
 */
@Slf4j
public class Idea28517Service {
    private static final int IDEA_ID = 28517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28517Service() {
        this(new Idea28517Config());
    }

    public Idea28517Service(Idea28517Config config) {
        this.config = config != null ? config : new Idea28517Config();
