...
@Data
public class Idea28822Config {
    private String name = "idea_028822";
 ...
 */
@Slf4j
public class Idea28822Service {
    private static final int IDEA_ID = 28822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28822Service() {
        this(new Idea28822Config());
    }

    public Idea28822Service(Idea28822Config config) {
        this.config = config != null ? config : new Idea28822Config();
