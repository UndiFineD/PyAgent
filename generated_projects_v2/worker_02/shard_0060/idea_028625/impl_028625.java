...
@Data
public class Idea28625Config {
    private String name = "idea_028625";
 ...
 */
@Slf4j
public class Idea28625Service {
    private static final int IDEA_ID = 28625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28625Service() {
        this(new Idea28625Config());
    }

    public Idea28625Service(Idea28625Config config) {
        this.config = config != null ? config : new Idea28625Config();
