...
@Data
public class Idea28908Config {
    private String name = "idea_028908";
 ...
 */
@Slf4j
public class Idea28908Service {
    private static final int IDEA_ID = 28908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28908Service() {
        this(new Idea28908Config());
    }

    public Idea28908Service(Idea28908Config config) {
        this.config = config != null ? config : new Idea28908Config();
