...
@Data
public class Idea28706Config {
    private String name = "idea_028706";
 ...
 */
@Slf4j
public class Idea28706Service {
    private static final int IDEA_ID = 28706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28706Service() {
        this(new Idea28706Config());
    }

    public Idea28706Service(Idea28706Config config) {
        this.config = config != null ? config : new Idea28706Config();
