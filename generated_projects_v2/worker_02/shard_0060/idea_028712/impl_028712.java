...
@Data
public class Idea28712Config {
    private String name = "idea_028712";
 ...
 */
@Slf4j
public class Idea28712Service {
    private static final int IDEA_ID = 28712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28712Service() {
        this(new Idea28712Config());
    }

    public Idea28712Service(Idea28712Config config) {
        this.config = config != null ? config : new Idea28712Config();
