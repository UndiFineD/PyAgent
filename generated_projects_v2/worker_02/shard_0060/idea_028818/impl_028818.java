...
@Data
public class Idea28818Config {
    private String name = "idea_028818";
 ...
 */
@Slf4j
public class Idea28818Service {
    private static final int IDEA_ID = 28818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28818Service() {
        this(new Idea28818Config());
    }

    public Idea28818Service(Idea28818Config config) {
        this.config = config != null ? config : new Idea28818Config();
