...
@Data
public class Idea28916Config {
    private String name = "idea_028916";
 ...
 */
@Slf4j
public class Idea28916Service {
    private static final int IDEA_ID = 28916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28916Service() {
        this(new Idea28916Config());
    }

    public Idea28916Service(Idea28916Config config) {
        this.config = config != null ? config : new Idea28916Config();
