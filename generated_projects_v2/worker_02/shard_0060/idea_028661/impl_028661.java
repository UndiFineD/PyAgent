...
@Data
public class Idea28661Config {
    private String name = "idea_028661";
 ...
 */
@Slf4j
public class Idea28661Service {
    private static final int IDEA_ID = 28661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28661Service() {
        this(new Idea28661Config());
    }

    public Idea28661Service(Idea28661Config config) {
        this.config = config != null ? config : new Idea28661Config();
