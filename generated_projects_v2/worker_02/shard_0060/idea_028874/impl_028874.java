...
@Data
public class Idea28874Config {
    private String name = "idea_028874";
 ...
 */
@Slf4j
public class Idea28874Service {
    private static final int IDEA_ID = 28874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28874Service() {
        this(new Idea28874Config());
    }

    public Idea28874Service(Idea28874Config config) {
        this.config = config != null ? config : new Idea28874Config();
