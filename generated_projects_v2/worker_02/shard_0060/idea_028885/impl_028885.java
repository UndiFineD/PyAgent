...
@Data
public class Idea28885Config {
    private String name = "idea_028885";
 ...
 */
@Slf4j
public class Idea28885Service {
    private static final int IDEA_ID = 28885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28885Service() {
        this(new Idea28885Config());
    }

    public Idea28885Service(Idea28885Config config) {
        this.config = config != null ? config : new Idea28885Config();
