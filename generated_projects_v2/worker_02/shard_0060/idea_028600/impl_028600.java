...
@Data
public class Idea28600Config {
    private String name = "idea_028600";
 ...
 */
@Slf4j
public class Idea28600Service {
    private static final int IDEA_ID = 28600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28600Service() {
        this(new Idea28600Config());
    }

    public Idea28600Service(Idea28600Config config) {
        this.config = config != null ? config : new Idea28600Config();
