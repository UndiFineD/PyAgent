...
@Data
public class Idea28744Config {
    private String name = "idea_028744";
 ...
 */
@Slf4j
public class Idea28744Service {
    private static final int IDEA_ID = 28744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28744Service() {
        this(new Idea28744Config());
    }

    public Idea28744Service(Idea28744Config config) {
        this.config = config != null ? config : new Idea28744Config();
