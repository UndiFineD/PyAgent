...
@Data
public class Idea28765Config {
    private String name = "idea_028765";
 ...
 */
@Slf4j
public class Idea28765Service {
    private static final int IDEA_ID = 28765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28765Service() {
        this(new Idea28765Config());
    }

    public Idea28765Service(Idea28765Config config) {
        this.config = config != null ? config : new Idea28765Config();
