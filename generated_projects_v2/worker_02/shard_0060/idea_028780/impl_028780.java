...
@Data
public class Idea28780Config {
    private String name = "idea_028780";
 ...
 */
@Slf4j
public class Idea28780Service {
    private static final int IDEA_ID = 28780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28780Service() {
        this(new Idea28780Config());
    }

    public Idea28780Service(Idea28780Config config) {
        this.config = config != null ? config : new Idea28780Config();
