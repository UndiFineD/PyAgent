...
@Data
public class Idea28957Config {
    private String name = "idea_028957";
 ...
 */
@Slf4j
public class Idea28957Service {
    private static final int IDEA_ID = 28957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28957Service() {
        this(new Idea28957Config());
    }

    public Idea28957Service(Idea28957Config config) {
        this.config = config != null ? config : new Idea28957Config();
