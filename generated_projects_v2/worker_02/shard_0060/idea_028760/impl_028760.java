...
@Data
public class Idea28760Config {
    private String name = "idea_028760";
 ...
 */
@Slf4j
public class Idea28760Service {
    private static final int IDEA_ID = 28760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28760Service() {
        this(new Idea28760Config());
    }

    public Idea28760Service(Idea28760Config config) {
        this.config = config != null ? config : new Idea28760Config();
