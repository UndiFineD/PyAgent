...
@Data
public class Idea28951Config {
    private String name = "idea_028951";
 ...
 */
@Slf4j
public class Idea28951Service {
    private static final int IDEA_ID = 28951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28951Service() {
        this(new Idea28951Config());
    }

    public Idea28951Service(Idea28951Config config) {
        this.config = config != null ? config : new Idea28951Config();
