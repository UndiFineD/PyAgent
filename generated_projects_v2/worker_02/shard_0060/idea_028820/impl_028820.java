...
@Data
public class Idea28820Config {
    private String name = "idea_028820";
 ...
 */
@Slf4j
public class Idea28820Service {
    private static final int IDEA_ID = 28820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28820Service() {
        this(new Idea28820Config());
    }

    public Idea28820Service(Idea28820Config config) {
        this.config = config != null ? config : new Idea28820Config();
