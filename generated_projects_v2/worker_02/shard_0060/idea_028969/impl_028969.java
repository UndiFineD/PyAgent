...
@Data
public class Idea28969Config {
    private String name = "idea_028969";
 ...
 */
@Slf4j
public class Idea28969Service {
    private static final int IDEA_ID = 28969;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28969Service() {
        this(new Idea28969Config());
    }

    public Idea28969Service(Idea28969Config config) {
        this.config = config != null ? config : new Idea28969Config();
