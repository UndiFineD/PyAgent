...
@Data
public class Idea28599Config {
    private String name = "idea_028599";
 ...
 */
@Slf4j
public class Idea28599Service {
    private static final int IDEA_ID = 28599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28599Service() {
        this(new Idea28599Config());
    }

    public Idea28599Service(Idea28599Config config) {
        this.config = config != null ? config : new Idea28599Config();
