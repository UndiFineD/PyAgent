...
@Data
public class Idea28803Config {
    private String name = "idea_028803";
 ...
 */
@Slf4j
public class Idea28803Service {
    private static final int IDEA_ID = 28803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28803Service() {
        this(new Idea28803Config());
    }

    public Idea28803Service(Idea28803Config config) {
        this.config = config != null ? config : new Idea28803Config();
