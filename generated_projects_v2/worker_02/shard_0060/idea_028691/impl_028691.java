...
@Data
public class Idea28691Config {
    private String name = "idea_028691";
 ...
 */
@Slf4j
public class Idea28691Service {
    private static final int IDEA_ID = 28691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28691Service() {
        this(new Idea28691Config());
    }

    public Idea28691Service(Idea28691Config config) {
        this.config = config != null ? config : new Idea28691Config();
