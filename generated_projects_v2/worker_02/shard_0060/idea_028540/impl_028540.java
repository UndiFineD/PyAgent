...
@Data
public class Idea28540Config {
    private String name = "idea_028540";
 ...
 */
@Slf4j
public class Idea28540Service {
    private static final int IDEA_ID = 28540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28540Service() {
        this(new Idea28540Config());
    }

    public Idea28540Service(Idea28540Config config) {
        this.config = config != null ? config : new Idea28540Config();
