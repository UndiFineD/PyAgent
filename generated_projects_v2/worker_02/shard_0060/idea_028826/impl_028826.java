...
@Data
public class Idea28826Config {
    private String name = "idea_028826";
 ...
 */
@Slf4j
public class Idea28826Service {
    private static final int IDEA_ID = 28826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28826Service() {
        this(new Idea28826Config());
    }

    public Idea28826Service(Idea28826Config config) {
        this.config = config != null ? config : new Idea28826Config();
