...
@Data
public class Idea28817Config {
    private String name = "idea_028817";
 ...
 */
@Slf4j
public class Idea28817Service {
    private static final int IDEA_ID = 28817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28817Service() {
        this(new Idea28817Config());
    }

    public Idea28817Service(Idea28817Config config) {
        this.config = config != null ? config : new Idea28817Config();
