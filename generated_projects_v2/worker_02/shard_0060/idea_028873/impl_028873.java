...
@Data
public class Idea28873Config {
    private String name = "idea_028873";
 ...
 */
@Slf4j
public class Idea28873Service {
    private static final int IDEA_ID = 28873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28873Service() {
        this(new Idea28873Config());
    }

    public Idea28873Service(Idea28873Config config) {
        this.config = config != null ? config : new Idea28873Config();
