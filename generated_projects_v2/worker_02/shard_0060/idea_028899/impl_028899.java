...
@Data
public class Idea28899Config {
    private String name = "idea_028899";
 ...
 */
@Slf4j
public class Idea28899Service {
    private static final int IDEA_ID = 28899;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28899Service() {
        this(new Idea28899Config());
    }

    public Idea28899Service(Idea28899Config config) {
        this.config = config != null ? config : new Idea28899Config();
