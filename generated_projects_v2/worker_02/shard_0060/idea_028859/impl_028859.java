...
@Data
public class Idea28859Config {
    private String name = "idea_028859";
 ...
 */
@Slf4j
public class Idea28859Service {
    private static final int IDEA_ID = 28859;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28859Service() {
        this(new Idea28859Config());
    }

    public Idea28859Service(Idea28859Config config) {
        this.config = config != null ? config : new Idea28859Config();
