...
@Data
public class Idea28659Config {
    private String name = "idea_028659";
 ...
 */
@Slf4j
public class Idea28659Service {
    private static final int IDEA_ID = 28659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28659Service() {
        this(new Idea28659Config());
    }

    public Idea28659Service(Idea28659Config config) {
        this.config = config != null ? config : new Idea28659Config();
