...
@Data
public class Idea28812Config {
    private String name = "idea_028812";
 ...
 */
@Slf4j
public class Idea28812Service {
    private static final int IDEA_ID = 28812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28812Service() {
        this(new Idea28812Config());
    }

    public Idea28812Service(Idea28812Config config) {
        this.config = config != null ? config : new Idea28812Config();
