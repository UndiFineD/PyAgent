...
@Data
public class Idea28897Config {
    private String name = "idea_028897";
 ...
 */
@Slf4j
public class Idea28897Service {
    private static final int IDEA_ID = 28897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28897Service() {
        this(new Idea28897Config());
    }

    public Idea28897Service(Idea28897Config config) {
        this.config = config != null ? config : new Idea28897Config();
