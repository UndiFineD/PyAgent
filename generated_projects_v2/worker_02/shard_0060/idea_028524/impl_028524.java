...
@Data
public class Idea28524Config {
    private String name = "idea_028524";
 ...
 */
@Slf4j
public class Idea28524Service {
    private static final int IDEA_ID = 28524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28524Service() {
        this(new Idea28524Config());
    }

    public Idea28524Service(Idea28524Config config) {
        this.config = config != null ? config : new Idea28524Config();
