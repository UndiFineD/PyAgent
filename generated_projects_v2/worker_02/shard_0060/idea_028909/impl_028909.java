...
@Data
public class Idea28909Config {
    private String name = "idea_028909";
 ...
 */
@Slf4j
public class Idea28909Service {
    private static final int IDEA_ID = 28909;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28909Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28909Service() {
        this(new Idea28909Config());
    }

    public Idea28909Service(Idea28909Config config) {
        this.config = config != null ? config : new Idea28909Config();
