...
@Data
public class Idea28633Config {
    private String name = "idea_028633";
 ...
 */
@Slf4j
public class Idea28633Service {
    private static final int IDEA_ID = 28633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28633Service() {
        this(new Idea28633Config());
    }

    public Idea28633Service(Idea28633Config config) {
        this.config = config != null ? config : new Idea28633Config();
