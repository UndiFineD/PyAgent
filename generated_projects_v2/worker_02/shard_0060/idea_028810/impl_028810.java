...
@Data
public class Idea28810Config {
    private String name = "idea_028810";
 ...
 */
@Slf4j
public class Idea28810Service {
    private static final int IDEA_ID = 28810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28810Service() {
        this(new Idea28810Config());
    }

    public Idea28810Service(Idea28810Config config) {
        this.config = config != null ? config : new Idea28810Config();
