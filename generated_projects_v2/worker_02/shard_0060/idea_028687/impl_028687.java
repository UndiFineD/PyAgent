...
@Data
public class Idea28687Config {
    private String name = "idea_028687";
 ...
 */
@Slf4j
public class Idea28687Service {
    private static final int IDEA_ID = 28687;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28687Service() {
        this(new Idea28687Config());
    }

    public Idea28687Service(Idea28687Config config) {
        this.config = config != null ? config : new Idea28687Config();
