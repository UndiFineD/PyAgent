...
@Data
public class Idea28664Config {
    private String name = "idea_028664";
 ...
 */
@Slf4j
public class Idea28664Service {
    private static final int IDEA_ID = 28664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28664Service() {
        this(new Idea28664Config());
    }

    public Idea28664Service(Idea28664Config config) {
        this.config = config != null ? config : new Idea28664Config();
