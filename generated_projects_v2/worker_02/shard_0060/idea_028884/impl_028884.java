...
@Data
public class Idea28884Config {
    private String name = "idea_028884";
 ...
 */
@Slf4j
public class Idea28884Service {
    private static final int IDEA_ID = 28884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28884Service() {
        this(new Idea28884Config());
    }

    public Idea28884Service(Idea28884Config config) {
        this.config = config != null ? config : new Idea28884Config();
