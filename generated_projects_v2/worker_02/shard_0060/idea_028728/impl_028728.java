...
@Data
public class Idea28728Config {
    private String name = "idea_028728";
 ...
 */
@Slf4j
public class Idea28728Service {
    private static final int IDEA_ID = 28728;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28728Service() {
        this(new Idea28728Config());
    }

    public Idea28728Service(Idea28728Config config) {
        this.config = config != null ? config : new Idea28728Config();
