...
@Data
public class Idea28737Config {
    private String name = "idea_028737";
 ...
 */
@Slf4j
public class Idea28737Service {
    private static final int IDEA_ID = 28737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28737Service() {
        this(new Idea28737Config());
    }

    public Idea28737Service(Idea28737Config config) {
        this.config = config != null ? config : new Idea28737Config();
