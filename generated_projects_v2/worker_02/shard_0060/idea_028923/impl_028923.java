...
@Data
public class Idea28923Config {
    private String name = "idea_028923";
 ...
 */
@Slf4j
public class Idea28923Service {
    private static final int IDEA_ID = 28923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28923Service() {
        this(new Idea28923Config());
    }

    public Idea28923Service(Idea28923Config config) {
        this.config = config != null ? config : new Idea28923Config();
