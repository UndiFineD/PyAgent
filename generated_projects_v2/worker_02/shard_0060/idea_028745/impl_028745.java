...
@Data
public class Idea28745Config {
    private String name = "idea_028745";
 ...
 */
@Slf4j
public class Idea28745Service {
    private static final int IDEA_ID = 28745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28745Service() {
        this(new Idea28745Config());
    }

    public Idea28745Service(Idea28745Config config) {
        this.config = config != null ? config : new Idea28745Config();
