...
@Data
public class Idea28506Config {
    private String name = "idea_028506";
 ...
 */
@Slf4j
public class Idea28506Service {
    private static final int IDEA_ID = 28506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28506Service() {
        this(new Idea28506Config());
    }

    public Idea28506Service(Idea28506Config config) {
        this.config = config != null ? config : new Idea28506Config();
