...
@Data
public class Idea28516Config {
    private String name = "idea_028516";
 ...
 */
@Slf4j
public class Idea28516Service {
    private static final int IDEA_ID = 28516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28516Service() {
        this(new Idea28516Config());
    }

    public Idea28516Service(Idea28516Config config) {
        this.config = config != null ? config : new Idea28516Config();
