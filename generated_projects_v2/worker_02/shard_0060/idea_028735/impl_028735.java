...
@Data
public class Idea28735Config {
    private String name = "idea_028735";
 ...
 */
@Slf4j
public class Idea28735Service {
    private static final int IDEA_ID = 28735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28735Service() {
        this(new Idea28735Config());
    }

    public Idea28735Service(Idea28735Config config) {
        this.config = config != null ? config : new Idea28735Config();
