...
@Data
public class Idea28919Config {
    private String name = "idea_028919";
 ...
 */
@Slf4j
public class Idea28919Service {
    private static final int IDEA_ID = 28919;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28919Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28919Service() {
        this(new Idea28919Config());
    }

    public Idea28919Service(Idea28919Config config) {
        this.config = config != null ? config : new Idea28919Config();
