...
@Data
public class Idea28574Config {
    private String name = "idea_028574";
 ...
 */
@Slf4j
public class Idea28574Service {
    private static final int IDEA_ID = 28574;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28574Service() {
        this(new Idea28574Config());
    }

    public Idea28574Service(Idea28574Config config) {
        this.config = config != null ? config : new Idea28574Config();
