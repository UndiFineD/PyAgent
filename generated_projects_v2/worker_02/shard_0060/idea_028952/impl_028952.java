...
@Data
public class Idea28952Config {
    private String name = "idea_028952";
 ...
 */
@Slf4j
public class Idea28952Service {
    private static final int IDEA_ID = 28952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28952Service() {
        this(new Idea28952Config());
    }

    public Idea28952Service(Idea28952Config config) {
        this.config = config != null ? config : new Idea28952Config();
