...
@Data
public class Idea28802Config {
    private String name = "idea_028802";
 ...
 */
@Slf4j
public class Idea28802Service {
    private static final int IDEA_ID = 28802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28802Service() {
        this(new Idea28802Config());
    }

    public Idea28802Service(Idea28802Config config) {
        this.config = config != null ? config : new Idea28802Config();
