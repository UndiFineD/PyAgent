...
@Data
public class Idea28672Config {
    private String name = "idea_028672";
 ...
 */
@Slf4j
public class Idea28672Service {
    private static final int IDEA_ID = 28672;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28672Service() {
        this(new Idea28672Config());
    }

    public Idea28672Service(Idea28672Config config) {
        this.config = config != null ? config : new Idea28672Config();
