...
@Data
public class Idea28532Config {
    private String name = "idea_028532";
 ...
 */
@Slf4j
public class Idea28532Service {
    private static final int IDEA_ID = 28532;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28532Service() {
        this(new Idea28532Config());
    }

    public Idea28532Service(Idea28532Config config) {
        this.config = config != null ? config : new Idea28532Config();
