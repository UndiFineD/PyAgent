...
@Data
public class Idea28811Config {
    private String name = "idea_028811";
 ...
 */
@Slf4j
public class Idea28811Service {
    private static final int IDEA_ID = 28811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28811Service() {
        this(new Idea28811Config());
    }

    public Idea28811Service(Idea28811Config config) {
        this.config = config != null ? config : new Idea28811Config();
