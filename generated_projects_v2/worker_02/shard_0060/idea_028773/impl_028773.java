...
@Data
public class Idea28773Config {
    private String name = "idea_028773";
 ...
 */
@Slf4j
public class Idea28773Service {
    private static final int IDEA_ID = 28773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28773Service() {
        this(new Idea28773Config());
    }

    public Idea28773Service(Idea28773Config config) {
        this.config = config != null ? config : new Idea28773Config();
