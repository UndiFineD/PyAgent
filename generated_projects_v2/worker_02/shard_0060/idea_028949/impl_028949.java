...
@Data
public class Idea28949Config {
    private String name = "idea_028949";
 ...
 */
@Slf4j
public class Idea28949Service {
    private static final int IDEA_ID = 28949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28949Service() {
        this(new Idea28949Config());
    }

    public Idea28949Service(Idea28949Config config) {
        this.config = config != null ? config : new Idea28949Config();
