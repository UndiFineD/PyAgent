...
@Data
public class Idea28677Config {
    private String name = "idea_028677";
 ...
 */
@Slf4j
public class Idea28677Service {
    private static final int IDEA_ID = 28677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28677Service() {
        this(new Idea28677Config());
    }

    public Idea28677Service(Idea28677Config config) {
        this.config = config != null ? config : new Idea28677Config();
