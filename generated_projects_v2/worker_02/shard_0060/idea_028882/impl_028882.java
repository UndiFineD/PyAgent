...
@Data
public class Idea28882Config {
    private String name = "idea_028882";
 ...
 */
@Slf4j
public class Idea28882Service {
    private static final int IDEA_ID = 28882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28882Service() {
        this(new Idea28882Config());
    }

    public Idea28882Service(Idea28882Config config) {
        this.config = config != null ? config : new Idea28882Config();
