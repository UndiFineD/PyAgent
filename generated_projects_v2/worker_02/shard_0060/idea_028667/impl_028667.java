...
@Data
public class Idea28667Config {
    private String name = "idea_028667";
 ...
 */
@Slf4j
public class Idea28667Service {
    private static final int IDEA_ID = 28667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28667Service() {
        this(new Idea28667Config());
    }

    public Idea28667Service(Idea28667Config config) {
        this.config = config != null ? config : new Idea28667Config();
