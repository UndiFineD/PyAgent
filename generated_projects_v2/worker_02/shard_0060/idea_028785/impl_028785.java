...
@Data
public class Idea28785Config {
    private String name = "idea_028785";
 ...
 */
@Slf4j
public class Idea28785Service {
    private static final int IDEA_ID = 28785;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28785Service() {
        this(new Idea28785Config());
    }

    public Idea28785Service(Idea28785Config config) {
        this.config = config != null ? config : new Idea28785Config();
