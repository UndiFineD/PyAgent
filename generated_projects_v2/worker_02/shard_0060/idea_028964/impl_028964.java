...
@Data
public class Idea28964Config {
    private String name = "idea_028964";
 ...
 */
@Slf4j
public class Idea28964Service {
    private static final int IDEA_ID = 28964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28964Service() {
        this(new Idea28964Config());
    }

    public Idea28964Service(Idea28964Config config) {
        this.config = config != null ? config : new Idea28964Config();
