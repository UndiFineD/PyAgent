...
@Data
public class Idea28740Config {
    private String name = "idea_028740";
 ...
 */
@Slf4j
public class Idea28740Service {
    private static final int IDEA_ID = 28740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28740Service() {
        this(new Idea28740Config());
    }

    public Idea28740Service(Idea28740Config config) {
        this.config = config != null ? config : new Idea28740Config();
