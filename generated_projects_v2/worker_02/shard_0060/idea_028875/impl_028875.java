...
@Data
public class Idea28875Config {
    private String name = "idea_028875";
 ...
 */
@Slf4j
public class Idea28875Service {
    private static final int IDEA_ID = 28875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28875Service() {
        this(new Idea28875Config());
    }

    public Idea28875Service(Idea28875Config config) {
        this.config = config != null ? config : new Idea28875Config();
