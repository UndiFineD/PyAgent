...
@Data
public class Idea28697Config {
    private String name = "idea_028697";
 ...
 */
@Slf4j
public class Idea28697Service {
    private static final int IDEA_ID = 28697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28697Service() {
        this(new Idea28697Config());
    }

    public Idea28697Service(Idea28697Config config) {
        this.config = config != null ? config : new Idea28697Config();
