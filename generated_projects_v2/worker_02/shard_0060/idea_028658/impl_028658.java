...
@Data
public class Idea28658Config {
    private String name = "idea_028658";
 ...
 */
@Slf4j
public class Idea28658Service {
    private static final int IDEA_ID = 28658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28658Service() {
        this(new Idea28658Config());
    }

    public Idea28658Service(Idea28658Config config) {
        this.config = config != null ? config : new Idea28658Config();
