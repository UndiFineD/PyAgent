...
@Data
public class Idea28763Config {
    private String name = "idea_028763";
 ...
 */
@Slf4j
public class Idea28763Service {
    private static final int IDEA_ID = 28763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28763Service() {
        this(new Idea28763Config());
    }

    public Idea28763Service(Idea28763Config config) {
        this.config = config != null ? config : new Idea28763Config();
