...
@Data
public class Idea28827Config {
    private String name = "idea_028827";
 ...
 */
@Slf4j
public class Idea28827Service {
    private static final int IDEA_ID = 28827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28827Service() {
        this(new Idea28827Config());
    }

    public Idea28827Service(Idea28827Config config) {
        this.config = config != null ? config : new Idea28827Config();
