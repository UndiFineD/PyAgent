...
@Data
public class Idea28705Config {
    private String name = "idea_028705";
 ...
 */
@Slf4j
public class Idea28705Service {
    private static final int IDEA_ID = 28705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28705Service() {
        this(new Idea28705Config());
    }

    public Idea28705Service(Idea28705Config config) {
        this.config = config != null ? config : new Idea28705Config();
