...
@Data
public class Idea28637Config {
    private String name = "idea_028637";
 ...
 */
@Slf4j
public class Idea28637Service {
    private static final int IDEA_ID = 28637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28637Service() {
        this(new Idea28637Config());
    }

    public Idea28637Service(Idea28637Config config) {
        this.config = config != null ? config : new Idea28637Config();
