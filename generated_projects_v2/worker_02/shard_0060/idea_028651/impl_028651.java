...
@Data
public class Idea28651Config {
    private String name = "idea_028651";
 ...
 */
@Slf4j
public class Idea28651Service {
    private static final int IDEA_ID = 28651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28651Service() {
        this(new Idea28651Config());
    }

    public Idea28651Service(Idea28651Config config) {
        this.config = config != null ? config : new Idea28651Config();
