...
@Data
public class Idea28781Config {
    private String name = "idea_028781";
 ...
 */
@Slf4j
public class Idea28781Service {
    private static final int IDEA_ID = 28781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28781Service() {
        this(new Idea28781Config());
    }

    public Idea28781Service(Idea28781Config config) {
        this.config = config != null ? config : new Idea28781Config();
