...
@Data
public class Idea40263Config {
    private String name = "idea_040263";
 ...
 */
@Slf4j
public class Idea40263Service {
    private static final int IDEA_ID = 40263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40263Service() {
        this(new Idea40263Config());
    }

    public Idea40263Service(Idea40263Config config) {
        this.config = config != null ? config : new Idea40263Config();
