...
@Data
public class Idea40185Config {
    private String name = "idea_040185";
 ...
 */
@Slf4j
public class Idea40185Service {
    private static final int IDEA_ID = 40185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40185Service() {
        this(new Idea40185Config());
    }

    public Idea40185Service(Idea40185Config config) {
        this.config = config != null ? config : new Idea40185Config();
