...
@Data
public class Idea40207Config {
    private String name = "idea_040207";
 ...
 */
@Slf4j
public class Idea40207Service {
    private static final int IDEA_ID = 40207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40207Service() {
        this(new Idea40207Config());
    }

    public Idea40207Service(Idea40207Config config) {
        this.config = config != null ? config : new Idea40207Config();
