...
@Data
public class Idea39995Config {
    private String name = "idea_039995";
 ...
 */
@Slf4j
public class Idea39995Service {
    private static final int IDEA_ID = 39995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39995Service() {
        this(new Idea39995Config());
    }

    public Idea39995Service(Idea39995Config config) {
        this.config = config != null ? config : new Idea39995Config();
