...
@Data
public class Idea39903Config {
    private String name = "idea_039903";
 ...
 */
@Slf4j
public class Idea39903Service {
    private static final int IDEA_ID = 39903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39903Service() {
        this(new Idea39903Config());
    }

    public Idea39903Service(Idea39903Config config) {
        this.config = config != null ? config : new Idea39903Config();
