...
@Data
public class Idea40287Config {
    private String name = "idea_040287";
 ...
 */
@Slf4j
public class Idea40287Service {
    private static final int IDEA_ID = 40287;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40287Service() {
        this(new Idea40287Config());
    }

    public Idea40287Service(Idea40287Config config) {
        this.config = config != null ? config : new Idea40287Config();
