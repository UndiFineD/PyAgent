...
@Data
public class Idea40118Config {
    private String name = "idea_040118";
 ...
 */
@Slf4j
public class Idea40118Service {
    private static final int IDEA_ID = 40118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40118Service() {
        this(new Idea40118Config());
    }

    public Idea40118Service(Idea40118Config config) {
        this.config = config != null ? config : new Idea40118Config();
