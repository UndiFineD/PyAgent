...
@Data
public class Idea40055Config {
    private String name = "idea_040055";
 ...
 */
@Slf4j
public class Idea40055Service {
    private static final int IDEA_ID = 40055;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40055Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40055Service() {
        this(new Idea40055Config());
    }

    public Idea40055Service(Idea40055Config config) {
        this.config = config != null ? config : new Idea40055Config();
