...
@Data
public class Idea40333Config {
    private String name = "idea_040333";
 ...
 */
@Slf4j
public class Idea40333Service {
    private static final int IDEA_ID = 40333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40333Service() {
        this(new Idea40333Config());
    }

    public Idea40333Service(Idea40333Config config) {
        this.config = config != null ? config : new Idea40333Config();
