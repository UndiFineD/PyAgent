...
@Data
public class Idea39952Config {
    private String name = "idea_039952";
 ...
 */
@Slf4j
public class Idea39952Service {
    private static final int IDEA_ID = 39952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39952Service() {
        this(new Idea39952Config());
    }

    public Idea39952Service(Idea39952Config config) {
        this.config = config != null ? config : new Idea39952Config();
