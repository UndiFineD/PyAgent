...
@Data
public class Idea40174Config {
    private String name = "idea_040174";
 ...
 */
@Slf4j
public class Idea40174Service {
    private static final int IDEA_ID = 40174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40174Service() {
        this(new Idea40174Config());
    }

    public Idea40174Service(Idea40174Config config) {
        this.config = config != null ? config : new Idea40174Config();
