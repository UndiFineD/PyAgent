...
@Data
public class Idea40195Config {
    private String name = "idea_040195";
 ...
 */
@Slf4j
public class Idea40195Service {
    private static final int IDEA_ID = 40195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40195Service() {
        this(new Idea40195Config());
    }

    public Idea40195Service(Idea40195Config config) {
        this.config = config != null ? config : new Idea40195Config();
