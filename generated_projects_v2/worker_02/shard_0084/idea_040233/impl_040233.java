...
@Data
public class Idea40233Config {
    private String name = "idea_040233";
 ...
 */
@Slf4j
public class Idea40233Service {
    private static final int IDEA_ID = 40233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40233Service() {
        this(new Idea40233Config());
    }

    public Idea40233Service(Idea40233Config config) {
        this.config = config != null ? config : new Idea40233Config();
