...
@Data
public class Idea40001Config {
    private String name = "idea_040001";
 ...
 */
@Slf4j
public class Idea40001Service {
    private static final int IDEA_ID = 40001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40001Service() {
        this(new Idea40001Config());
    }

    public Idea40001Service(Idea40001Config config) {
        this.config = config != null ? config : new Idea40001Config();
