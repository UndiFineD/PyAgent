...
@Data
public class Idea39938Config {
    private String name = "idea_039938";
 ...
 */
@Slf4j
public class Idea39938Service {
    private static final int IDEA_ID = 39938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39938Service() {
        this(new Idea39938Config());
    }

    public Idea39938Service(Idea39938Config config) {
        this.config = config != null ? config : new Idea39938Config();
