...
@Data
public class Idea40277Config {
    private String name = "idea_040277";
 ...
 */
@Slf4j
public class Idea40277Service {
    private static final int IDEA_ID = 40277;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40277Service() {
        this(new Idea40277Config());
    }

    public Idea40277Service(Idea40277Config config) {
        this.config = config != null ? config : new Idea40277Config();
