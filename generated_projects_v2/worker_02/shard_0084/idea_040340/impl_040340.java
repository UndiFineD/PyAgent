...
@Data
public class Idea40340Config {
    private String name = "idea_040340";
 ...
 */
@Slf4j
public class Idea40340Service {
    private static final int IDEA_ID = 40340;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40340Service() {
        this(new Idea40340Config());
    }

    public Idea40340Service(Idea40340Config config) {
        this.config = config != null ? config : new Idea40340Config();
