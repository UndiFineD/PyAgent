...
@Data
public class Idea40120Config {
    private String name = "idea_040120";
 ...
 */
@Slf4j
public class Idea40120Service {
    private static final int IDEA_ID = 40120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40120Service() {
        this(new Idea40120Config());
    }

    public Idea40120Service(Idea40120Config config) {
        this.config = config != null ? config : new Idea40120Config();
