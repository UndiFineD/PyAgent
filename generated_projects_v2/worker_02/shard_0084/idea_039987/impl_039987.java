...
@Data
public class Idea39987Config {
    private String name = "idea_039987";
 ...
 */
@Slf4j
public class Idea39987Service {
    private static final int IDEA_ID = 39987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39987Service() {
        this(new Idea39987Config());
    }

    public Idea39987Service(Idea39987Config config) {
        this.config = config != null ? config : new Idea39987Config();
