...
@Data
public class Idea40224Config {
    private String name = "idea_040224";
 ...
 */
@Slf4j
public class Idea40224Service {
    private static final int IDEA_ID = 40224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40224Service() {
        this(new Idea40224Config());
    }

    public Idea40224Service(Idea40224Config config) {
        this.config = config != null ? config : new Idea40224Config();
