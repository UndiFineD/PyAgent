...
@Data
public class Idea40135Config {
    private String name = "idea_040135";
 ...
 */
@Slf4j
public class Idea40135Service {
    private static final int IDEA_ID = 40135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40135Service() {
        this(new Idea40135Config());
    }

    public Idea40135Service(Idea40135Config config) {
        this.config = config != null ? config : new Idea40135Config();
