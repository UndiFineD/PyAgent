...
@Data
public class Idea40117Config {
    private String name = "idea_040117";
 ...
 */
@Slf4j
public class Idea40117Service {
    private static final int IDEA_ID = 40117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40117Service() {
        this(new Idea40117Config());
    }

    public Idea40117Service(Idea40117Config config) {
        this.config = config != null ? config : new Idea40117Config();
