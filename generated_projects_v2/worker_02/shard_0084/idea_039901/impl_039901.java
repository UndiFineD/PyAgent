...
@Data
public class Idea39901Config {
    private String name = "idea_039901";
 ...
 */
@Slf4j
public class Idea39901Service {
    private static final int IDEA_ID = 39901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39901Service() {
        this(new Idea39901Config());
    }

    public Idea39901Service(Idea39901Config config) {
        this.config = config != null ? config : new Idea39901Config();
