...
@Data
public class Idea40149Config {
    private String name = "idea_040149";
 ...
 */
@Slf4j
public class Idea40149Service {
    private static final int IDEA_ID = 40149;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40149Service() {
        this(new Idea40149Config());
    }

    public Idea40149Service(Idea40149Config config) {
        this.config = config != null ? config : new Idea40149Config();
