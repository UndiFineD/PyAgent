...
@Data
public class Idea40089Config {
    private String name = "idea_040089";
 ...
 */
@Slf4j
public class Idea40089Service {
    private static final int IDEA_ID = 40089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40089Service() {
        this(new Idea40089Config());
    }

    public Idea40089Service(Idea40089Config config) {
        this.config = config != null ? config : new Idea40089Config();
