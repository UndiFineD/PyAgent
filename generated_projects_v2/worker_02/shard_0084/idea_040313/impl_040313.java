...
@Data
public class Idea40313Config {
    private String name = "idea_040313";
 ...
 */
@Slf4j
public class Idea40313Service {
    private static final int IDEA_ID = 40313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40313Service() {
        this(new Idea40313Config());
    }

    public Idea40313Service(Idea40313Config config) {
        this.config = config != null ? config : new Idea40313Config();
