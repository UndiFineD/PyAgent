...
@Data
public class Idea39992Config {
    private String name = "idea_039992";
 ...
 */
@Slf4j
public class Idea39992Service {
    private static final int IDEA_ID = 39992;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39992Service() {
        this(new Idea39992Config());
    }

    public Idea39992Service(Idea39992Config config) {
        this.config = config != null ? config : new Idea39992Config();
