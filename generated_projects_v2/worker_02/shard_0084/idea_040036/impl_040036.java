...
@Data
public class Idea40036Config {
    private String name = "idea_040036";
 ...
 */
@Slf4j
public class Idea40036Service {
    private static final int IDEA_ID = 40036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40036Service() {
        this(new Idea40036Config());
    }

    public Idea40036Service(Idea40036Config config) {
        this.config = config != null ? config : new Idea40036Config();
