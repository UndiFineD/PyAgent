...
@Data
public class Idea40183Config {
    private String name = "idea_040183";
 ...
 */
@Slf4j
public class Idea40183Service {
    private static final int IDEA_ID = 40183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40183Service() {
        this(new Idea40183Config());
    }

    public Idea40183Service(Idea40183Config config) {
        this.config = config != null ? config : new Idea40183Config();
