...
@Data
public class Idea40237Config {
    private String name = "idea_040237";
 ...
 */
@Slf4j
public class Idea40237Service {
    private static final int IDEA_ID = 40237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40237Service() {
        this(new Idea40237Config());
    }

    public Idea40237Service(Idea40237Config config) {
        this.config = config != null ? config : new Idea40237Config();
