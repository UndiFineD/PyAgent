...
@Data
public class Idea40037Config {
    private String name = "idea_040037";
 ...
 */
@Slf4j
public class Idea40037Service {
    private static final int IDEA_ID = 40037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40037Service() {
        this(new Idea40037Config());
    }

    public Idea40037Service(Idea40037Config config) {
        this.config = config != null ? config : new Idea40037Config();
