...
@Data
public class Idea40357Config {
    private String name = "idea_040357";
 ...
 */
@Slf4j
public class Idea40357Service {
    private static final int IDEA_ID = 40357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40357Service() {
        this(new Idea40357Config());
    }

    public Idea40357Service(Idea40357Config config) {
        this.config = config != null ? config : new Idea40357Config();
