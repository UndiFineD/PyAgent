...
@Data
public class Idea40178Config {
    private String name = "idea_040178";
 ...
 */
@Slf4j
public class Idea40178Service {
    private static final int IDEA_ID = 40178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40178Service() {
        this(new Idea40178Config());
    }

    public Idea40178Service(Idea40178Config config) {
        this.config = config != null ? config : new Idea40178Config();
