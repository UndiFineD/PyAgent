...
@Data
public class Idea40105Config {
    private String name = "idea_040105";
 ...
 */
@Slf4j
public class Idea40105Service {
    private static final int IDEA_ID = 40105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40105Service() {
        this(new Idea40105Config());
    }

    public Idea40105Service(Idea40105Config config) {
        this.config = config != null ? config : new Idea40105Config();
