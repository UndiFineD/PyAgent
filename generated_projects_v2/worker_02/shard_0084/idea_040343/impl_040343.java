...
@Data
public class Idea40343Config {
    private String name = "idea_040343";
 ...
 */
@Slf4j
public class Idea40343Service {
    private static final int IDEA_ID = 40343;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40343Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40343Service() {
        this(new Idea40343Config());
    }

    public Idea40343Service(Idea40343Config config) {
        this.config = config != null ? config : new Idea40343Config();
