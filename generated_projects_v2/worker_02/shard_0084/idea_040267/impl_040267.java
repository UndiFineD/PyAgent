...
@Data
public class Idea40267Config {
    private String name = "idea_040267";
 ...
 */
@Slf4j
public class Idea40267Service {
    private static final int IDEA_ID = 40267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40267Service() {
        this(new Idea40267Config());
    }

    public Idea40267Service(Idea40267Config config) {
        this.config = config != null ? config : new Idea40267Config();
