...
@Data
public class Idea39934Config {
    private String name = "idea_039934";
 ...
 */
@Slf4j
public class Idea39934Service {
    private static final int IDEA_ID = 39934;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39934Service() {
        this(new Idea39934Config());
    }

    public Idea39934Service(Idea39934Config config) {
        this.config = config != null ? config : new Idea39934Config();
