...
@Data
public class Idea40353Config {
    private String name = "idea_040353";
 ...
 */
@Slf4j
public class Idea40353Service {
    private static final int IDEA_ID = 40353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40353Service() {
        this(new Idea40353Config());
    }

    public Idea40353Service(Idea40353Config config) {
        this.config = config != null ? config : new Idea40353Config();
