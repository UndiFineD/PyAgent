...
@Data
public class Idea40200Config {
    private String name = "idea_040200";
 ...
 */
@Slf4j
public class Idea40200Service {
    private static final int IDEA_ID = 40200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40200Service() {
        this(new Idea40200Config());
    }

    public Idea40200Service(Idea40200Config config) {
        this.config = config != null ? config : new Idea40200Config();
