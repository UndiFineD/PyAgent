...
@Data
public class Idea40365Config {
    private String name = "idea_040365";
 ...
 */
@Slf4j
public class Idea40365Service {
    private static final int IDEA_ID = 40365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40365Service() {
        this(new Idea40365Config());
    }

    public Idea40365Service(Idea40365Config config) {
        this.config = config != null ? config : new Idea40365Config();
