...
@Data
public class Idea39981Config {
    private String name = "idea_039981";
 ...
 */
@Slf4j
public class Idea39981Service {
    private static final int IDEA_ID = 39981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39981Service() {
        this(new Idea39981Config());
    }

    public Idea39981Service(Idea39981Config config) {
        this.config = config != null ? config : new Idea39981Config();
