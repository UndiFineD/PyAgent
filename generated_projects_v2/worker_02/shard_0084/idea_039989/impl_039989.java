...
@Data
public class Idea39989Config {
    private String name = "idea_039989";
 ...
 */
@Slf4j
public class Idea39989Service {
    private static final int IDEA_ID = 39989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39989Service() {
        this(new Idea39989Config());
    }

    public Idea39989Service(Idea39989Config config) {
        this.config = config != null ? config : new Idea39989Config();
