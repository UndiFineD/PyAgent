...
@Data
public class Idea39939Config {
    private String name = "idea_039939";
 ...
 */
@Slf4j
public class Idea39939Service {
    private static final int IDEA_ID = 39939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39939Service() {
        this(new Idea39939Config());
    }

    public Idea39939Service(Idea39939Config config) {
        this.config = config != null ? config : new Idea39939Config();
