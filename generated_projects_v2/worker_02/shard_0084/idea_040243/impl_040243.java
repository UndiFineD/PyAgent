...
@Data
public class Idea40243Config {
    private String name = "idea_040243";
 ...
 */
@Slf4j
public class Idea40243Service {
    private static final int IDEA_ID = 40243;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40243Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40243Service() {
        this(new Idea40243Config());
    }

    public Idea40243Service(Idea40243Config config) {
        this.config = config != null ? config : new Idea40243Config();
