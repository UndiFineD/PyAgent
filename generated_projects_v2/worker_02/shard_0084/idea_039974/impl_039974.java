...
@Data
public class Idea39974Config {
    private String name = "idea_039974";
 ...
 */
@Slf4j
public class Idea39974Service {
    private static final int IDEA_ID = 39974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39974Service() {
        this(new Idea39974Config());
    }

    public Idea39974Service(Idea39974Config config) {
        this.config = config != null ? config : new Idea39974Config();
