...
@Data
public class Idea40370Config {
    private String name = "idea_040370";
 ...
 */
@Slf4j
public class Idea40370Service {
    private static final int IDEA_ID = 40370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40370Service() {
        this(new Idea40370Config());
    }

    public Idea40370Service(Idea40370Config config) {
        this.config = config != null ? config : new Idea40370Config();
