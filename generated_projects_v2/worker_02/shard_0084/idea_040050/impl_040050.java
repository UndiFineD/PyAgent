...
@Data
public class Idea40050Config {
    private String name = "idea_040050";
 ...
 */
@Slf4j
public class Idea40050Service {
    private static final int IDEA_ID = 40050;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40050Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40050Service() {
        this(new Idea40050Config());
    }

    public Idea40050Service(Idea40050Config config) {
        this.config = config != null ? config : new Idea40050Config();
