...
@Data
public class Idea40356Config {
    private String name = "idea_040356";
 ...
 */
@Slf4j
public class Idea40356Service {
    private static final int IDEA_ID = 40356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40356Service() {
        this(new Idea40356Config());
    }

    public Idea40356Service(Idea40356Config config) {
        this.config = config != null ? config : new Idea40356Config();
