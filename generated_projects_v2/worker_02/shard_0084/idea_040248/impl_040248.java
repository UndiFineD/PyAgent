...
@Data
public class Idea40248Config {
    private String name = "idea_040248";
 ...
 */
@Slf4j
public class Idea40248Service {
    private static final int IDEA_ID = 40248;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40248Service() {
        this(new Idea40248Config());
    }

    public Idea40248Service(Idea40248Config config) {
        this.config = config != null ? config : new Idea40248Config();
