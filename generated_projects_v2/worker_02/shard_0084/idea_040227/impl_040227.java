...
@Data
public class Idea40227Config {
    private String name = "idea_040227";
 ...
 */
@Slf4j
public class Idea40227Service {
    private static final int IDEA_ID = 40227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40227Service() {
        this(new Idea40227Config());
    }

    public Idea40227Service(Idea40227Config config) {
        this.config = config != null ? config : new Idea40227Config();
