...
@Data
public class Idea40332Config {
    private String name = "idea_040332";
 ...
 */
@Slf4j
public class Idea40332Service {
    private static final int IDEA_ID = 40332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40332Service() {
        this(new Idea40332Config());
    }

    public Idea40332Service(Idea40332Config config) {
        this.config = config != null ? config : new Idea40332Config();
