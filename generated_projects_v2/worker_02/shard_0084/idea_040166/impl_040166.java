...
@Data
public class Idea40166Config {
    private String name = "idea_040166";
 ...
 */
@Slf4j
public class Idea40166Service {
    private static final int IDEA_ID = 40166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40166Service() {
        this(new Idea40166Config());
    }

    public Idea40166Service(Idea40166Config config) {
        this.config = config != null ? config : new Idea40166Config();
