...
@Data
public class Idea40290Config {
    private String name = "idea_040290";
 ...
 */
@Slf4j
public class Idea40290Service {
    private static final int IDEA_ID = 40290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40290Service() {
        this(new Idea40290Config());
    }

    public Idea40290Service(Idea40290Config config) {
        this.config = config != null ? config : new Idea40290Config();
