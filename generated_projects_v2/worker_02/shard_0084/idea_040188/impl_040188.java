...
@Data
public class Idea40188Config {
    private String name = "idea_040188";
 ...
 */
@Slf4j
public class Idea40188Service {
    private static final int IDEA_ID = 40188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40188Service() {
        this(new Idea40188Config());
    }

    public Idea40188Service(Idea40188Config config) {
        this.config = config != null ? config : new Idea40188Config();
