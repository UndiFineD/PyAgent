...
@Data
public class Idea39970Config {
    private String name = "idea_039970";
 ...
 */
@Slf4j
public class Idea39970Service {
    private static final int IDEA_ID = 39970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39970Service() {
        this(new Idea39970Config());
    }

    public Idea39970Service(Idea39970Config config) {
        this.config = config != null ? config : new Idea39970Config();
