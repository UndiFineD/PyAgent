...
@Data
public class Idea40270Config {
    private String name = "idea_040270";
 ...
 */
@Slf4j
public class Idea40270Service {
    private static final int IDEA_ID = 40270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40270Service() {
        this(new Idea40270Config());
    }

    public Idea40270Service(Idea40270Config config) {
        this.config = config != null ? config : new Idea40270Config();
