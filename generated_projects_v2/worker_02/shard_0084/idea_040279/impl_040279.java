...
@Data
public class Idea40279Config {
    private String name = "idea_040279";
 ...
 */
@Slf4j
public class Idea40279Service {
    private static final int IDEA_ID = 40279;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40279Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40279Service() {
        this(new Idea40279Config());
    }

    public Idea40279Service(Idea40279Config config) {
        this.config = config != null ? config : new Idea40279Config();
