...
@Data
public class Idea40063Config {
    private String name = "idea_040063";
 ...
 */
@Slf4j
public class Idea40063Service {
    private static final int IDEA_ID = 40063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40063Service() {
        this(new Idea40063Config());
    }

    public Idea40063Service(Idea40063Config config) {
        this.config = config != null ? config : new Idea40063Config();
