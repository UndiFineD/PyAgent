...
@Data
public class Idea39949Config {
    private String name = "idea_039949";
 ...
 */
@Slf4j
public class Idea39949Service {
    private static final int IDEA_ID = 39949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39949Service() {
        this(new Idea39949Config());
    }

    public Idea39949Service(Idea39949Config config) {
        this.config = config != null ? config : new Idea39949Config();
