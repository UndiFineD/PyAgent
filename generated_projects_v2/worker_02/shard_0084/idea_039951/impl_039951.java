...
@Data
public class Idea39951Config {
    private String name = "idea_039951";
 ...
 */
@Slf4j
public class Idea39951Service {
    private static final int IDEA_ID = 39951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39951Service() {
        this(new Idea39951Config());
    }

    public Idea39951Service(Idea39951Config config) {
        this.config = config != null ? config : new Idea39951Config();
