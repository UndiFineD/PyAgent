...
@Data
public class Idea40093Config {
    private String name = "idea_040093";
 ...
 */
@Slf4j
public class Idea40093Service {
    private static final int IDEA_ID = 40093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40093Service() {
        this(new Idea40093Config());
    }

    public Idea40093Service(Idea40093Config config) {
        this.config = config != null ? config : new Idea40093Config();
