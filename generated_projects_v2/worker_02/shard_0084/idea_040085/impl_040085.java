...
@Data
public class Idea40085Config {
    private String name = "idea_040085";
 ...
 */
@Slf4j
public class Idea40085Service {
    private static final int IDEA_ID = 40085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40085Service() {
        this(new Idea40085Config());
    }

    public Idea40085Service(Idea40085Config config) {
        this.config = config != null ? config : new Idea40085Config();
