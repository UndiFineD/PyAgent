...
@Data
public class Idea40230Config {
    private String name = "idea_040230";
 ...
 */
@Slf4j
public class Idea40230Service {
    private static final int IDEA_ID = 40230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40230Service() {
        this(new Idea40230Config());
    }

    public Idea40230Service(Idea40230Config config) {
        this.config = config != null ? config : new Idea40230Config();
