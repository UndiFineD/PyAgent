...
@Data
public class Idea40113Config {
    private String name = "idea_040113";
 ...
 */
@Slf4j
public class Idea40113Service {
    private static final int IDEA_ID = 40113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40113Service() {
        this(new Idea40113Config());
    }

    public Idea40113Service(Idea40113Config config) {
        this.config = config != null ? config : new Idea40113Config();
