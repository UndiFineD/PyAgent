...
@Data
public class Idea40192Config {
    private String name = "idea_040192";
 ...
 */
@Slf4j
public class Idea40192Service {
    private static final int IDEA_ID = 40192;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40192Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40192Service() {
        this(new Idea40192Config());
    }

    public Idea40192Service(Idea40192Config config) {
        this.config = config != null ? config : new Idea40192Config();
