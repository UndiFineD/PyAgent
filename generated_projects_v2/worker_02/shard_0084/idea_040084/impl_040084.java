...
@Data
public class Idea40084Config {
    private String name = "idea_040084";
 ...
 */
@Slf4j
public class Idea40084Service {
    private static final int IDEA_ID = 40084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40084Service() {
        this(new Idea40084Config());
    }

    public Idea40084Service(Idea40084Config config) {
        this.config = config != null ? config : new Idea40084Config();
