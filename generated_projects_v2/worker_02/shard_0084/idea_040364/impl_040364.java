...
@Data
public class Idea40364Config {
    private String name = "idea_040364";
 ...
 */
@Slf4j
public class Idea40364Service {
    private static final int IDEA_ID = 40364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40364Service() {
        this(new Idea40364Config());
    }

    public Idea40364Service(Idea40364Config config) {
        this.config = config != null ? config : new Idea40364Config();
