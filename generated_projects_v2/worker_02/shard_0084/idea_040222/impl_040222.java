...
@Data
public class Idea40222Config {
    private String name = "idea_040222";
 ...
 */
@Slf4j
public class Idea40222Service {
    private static final int IDEA_ID = 40222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40222Service() {
        this(new Idea40222Config());
    }

    public Idea40222Service(Idea40222Config config) {
        this.config = config != null ? config : new Idea40222Config();
