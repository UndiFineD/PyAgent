...
@Data
public class Idea40281Config {
    private String name = "idea_040281";
 ...
 */
@Slf4j
public class Idea40281Service {
    private static final int IDEA_ID = 40281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40281Service() {
        this(new Idea40281Config());
    }

    public Idea40281Service(Idea40281Config config) {
        this.config = config != null ? config : new Idea40281Config();
