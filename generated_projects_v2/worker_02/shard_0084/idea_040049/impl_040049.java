...
@Data
public class Idea40049Config {
    private String name = "idea_040049";
 ...
 */
@Slf4j
public class Idea40049Service {
    private static final int IDEA_ID = 40049;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40049Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40049Service() {
        this(new Idea40049Config());
    }

    public Idea40049Service(Idea40049Config config) {
        this.config = config != null ? config : new Idea40049Config();
