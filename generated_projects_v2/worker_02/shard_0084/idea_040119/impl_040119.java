...
@Data
public class Idea40119Config {
    private String name = "idea_040119";
 ...
 */
@Slf4j
public class Idea40119Service {
    private static final int IDEA_ID = 40119;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40119Service() {
        this(new Idea40119Config());
    }

    public Idea40119Service(Idea40119Config config) {
        this.config = config != null ? config : new Idea40119Config();
