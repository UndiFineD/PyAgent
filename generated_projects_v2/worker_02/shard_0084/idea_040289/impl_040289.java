...
@Data
public class Idea40289Config {
    private String name = "idea_040289";
 ...
 */
@Slf4j
public class Idea40289Service {
    private static final int IDEA_ID = 40289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40289Service() {
        this(new Idea40289Config());
    }

    public Idea40289Service(Idea40289Config config) {
        this.config = config != null ? config : new Idea40289Config();
