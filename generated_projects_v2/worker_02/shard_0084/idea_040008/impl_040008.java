...
@Data
public class Idea40008Config {
    private String name = "idea_040008";
 ...
 */
@Slf4j
public class Idea40008Service {
    private static final int IDEA_ID = 40008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40008Service() {
        this(new Idea40008Config());
    }

    public Idea40008Service(Idea40008Config config) {
        this.config = config != null ? config : new Idea40008Config();
