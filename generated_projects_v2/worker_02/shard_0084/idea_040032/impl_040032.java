...
@Data
public class Idea40032Config {
    private String name = "idea_040032";
 ...
 */
@Slf4j
public class Idea40032Service {
    private static final int IDEA_ID = 40032;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40032Service() {
        this(new Idea40032Config());
    }

    public Idea40032Service(Idea40032Config config) {
        this.config = config != null ? config : new Idea40032Config();
