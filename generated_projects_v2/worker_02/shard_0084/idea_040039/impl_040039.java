...
@Data
public class Idea40039Config {
    private String name = "idea_040039";
 ...
 */
@Slf4j
public class Idea40039Service {
    private static final int IDEA_ID = 40039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40039Service() {
        this(new Idea40039Config());
    }

    public Idea40039Service(Idea40039Config config) {
        this.config = config != null ? config : new Idea40039Config();
