...
@Data
public class Idea40082Config {
    private String name = "idea_040082";
 ...
 */
@Slf4j
public class Idea40082Service {
    private static final int IDEA_ID = 40082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40082Service() {
        this(new Idea40082Config());
    }

    public Idea40082Service(Idea40082Config config) {
        this.config = config != null ? config : new Idea40082Config();
