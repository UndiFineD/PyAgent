...
@Data
public class Idea40043Config {
    private String name = "idea_040043";
 ...
 */
@Slf4j
public class Idea40043Service {
    private static final int IDEA_ID = 40043;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40043Service() {
        this(new Idea40043Config());
    }

    public Idea40043Service(Idea40043Config config) {
        this.config = config != null ? config : new Idea40043Config();
