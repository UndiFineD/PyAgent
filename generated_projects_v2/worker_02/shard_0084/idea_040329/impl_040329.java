...
@Data
public class Idea40329Config {
    private String name = "idea_040329";
 ...
 */
@Slf4j
public class Idea40329Service {
    private static final int IDEA_ID = 40329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40329Service() {
        this(new Idea40329Config());
    }

    public Idea40329Service(Idea40329Config config) {
        this.config = config != null ? config : new Idea40329Config();
