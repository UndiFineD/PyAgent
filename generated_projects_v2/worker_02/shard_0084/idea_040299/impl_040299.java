...
@Data
public class Idea40299Config {
    private String name = "idea_040299";
 ...
 */
@Slf4j
public class Idea40299Service {
    private static final int IDEA_ID = 40299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40299Service() {
        this(new Idea40299Config());
    }

    public Idea40299Service(Idea40299Config config) {
        this.config = config != null ? config : new Idea40299Config();
