...
@Data
public class Idea40239Config {
    private String name = "idea_040239";
 ...
 */
@Slf4j
public class Idea40239Service {
    private static final int IDEA_ID = 40239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40239Service() {
        this(new Idea40239Config());
    }

    public Idea40239Service(Idea40239Config config) {
        this.config = config != null ? config : new Idea40239Config();
