...
@Data
public class Idea40284Config {
    private String name = "idea_040284";
 ...
 */
@Slf4j
public class Idea40284Service {
    private static final int IDEA_ID = 40284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40284Service() {
        this(new Idea40284Config());
    }

    public Idea40284Service(Idea40284Config config) {
        this.config = config != null ? config : new Idea40284Config();
