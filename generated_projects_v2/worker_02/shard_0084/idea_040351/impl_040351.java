...
@Data
public class Idea40351Config {
    private String name = "idea_040351";
 ...
 */
@Slf4j
public class Idea40351Service {
    private static final int IDEA_ID = 40351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40351Service() {
        this(new Idea40351Config());
    }

    public Idea40351Service(Idea40351Config config) {
        this.config = config != null ? config : new Idea40351Config();
