...
@Data
public class Idea39999Config {
    private String name = "idea_039999";
 ...
 */
@Slf4j
public class Idea39999Service {
    private static final int IDEA_ID = 39999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39999Service() {
        this(new Idea39999Config());
    }

    public Idea39999Service(Idea39999Config config) {
        this.config = config != null ? config : new Idea39999Config();
