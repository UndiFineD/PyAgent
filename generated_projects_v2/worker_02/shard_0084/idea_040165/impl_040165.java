...
@Data
public class Idea40165Config {
    private String name = "idea_040165";
 ...
 */
@Slf4j
public class Idea40165Service {
    private static final int IDEA_ID = 40165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40165Service() {
        this(new Idea40165Config());
    }

    public Idea40165Service(Idea40165Config config) {
        this.config = config != null ? config : new Idea40165Config();
