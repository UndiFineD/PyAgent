...
@Data
public class Idea39927Config {
    private String name = "idea_039927";
 ...
 */
@Slf4j
public class Idea39927Service {
    private static final int IDEA_ID = 39927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39927Service() {
        this(new Idea39927Config());
    }

    public Idea39927Service(Idea39927Config config) {
        this.config = config != null ? config : new Idea39927Config();
