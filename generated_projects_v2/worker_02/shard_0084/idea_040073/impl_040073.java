...
@Data
public class Idea40073Config {
    private String name = "idea_040073";
 ...
 */
@Slf4j
public class Idea40073Service {
    private static final int IDEA_ID = 40073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40073Service() {
        this(new Idea40073Config());
    }

    public Idea40073Service(Idea40073Config config) {
        this.config = config != null ? config : new Idea40073Config();
