...
@Data
public class Idea40091Config {
    private String name = "idea_040091";
 ...
 */
@Slf4j
public class Idea40091Service {
    private static final int IDEA_ID = 40091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40091Service() {
        this(new Idea40091Config());
    }

    public Idea40091Service(Idea40091Config config) {
        this.config = config != null ? config : new Idea40091Config();
