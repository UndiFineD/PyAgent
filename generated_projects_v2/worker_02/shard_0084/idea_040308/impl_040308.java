...
@Data
public class Idea40308Config {
    private String name = "idea_040308";
 ...
 */
@Slf4j
public class Idea40308Service {
    private static final int IDEA_ID = 40308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40308Service() {
        this(new Idea40308Config());
    }

    public Idea40308Service(Idea40308Config config) {
        this.config = config != null ? config : new Idea40308Config();
