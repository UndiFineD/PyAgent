...
@Data
public class Idea39980Config {
    private String name = "idea_039980";
 ...
 */
@Slf4j
public class Idea39980Service {
    private static final int IDEA_ID = 39980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39980Service() {
        this(new Idea39980Config());
    }

    public Idea39980Service(Idea39980Config config) {
        this.config = config != null ? config : new Idea39980Config();
