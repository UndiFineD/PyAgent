...
@Data
public class Idea39978Config {
    private String name = "idea_039978";
 ...
 */
@Slf4j
public class Idea39978Service {
    private static final int IDEA_ID = 39978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39978Service() {
        this(new Idea39978Config());
    }

    public Idea39978Service(Idea39978Config config) {
        this.config = config != null ? config : new Idea39978Config();
