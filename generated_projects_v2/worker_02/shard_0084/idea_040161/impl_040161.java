...
@Data
public class Idea40161Config {
    private String name = "idea_040161";
 ...
 */
@Slf4j
public class Idea40161Service {
    private static final int IDEA_ID = 40161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40161Service() {
        this(new Idea40161Config());
    }

    public Idea40161Service(Idea40161Config config) {
        this.config = config != null ? config : new Idea40161Config();
