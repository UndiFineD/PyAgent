...
@Data
public class Idea40086Config {
    private String name = "idea_040086";
 ...
 */
@Slf4j
public class Idea40086Service {
    private static final int IDEA_ID = 40086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40086Service() {
        this(new Idea40086Config());
    }

    public Idea40086Service(Idea40086Config config) {
        this.config = config != null ? config : new Idea40086Config();
