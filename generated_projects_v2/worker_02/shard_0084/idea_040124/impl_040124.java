...
@Data
public class Idea40124Config {
    private String name = "idea_040124";
 ...
 */
@Slf4j
public class Idea40124Service {
    private static final int IDEA_ID = 40124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40124Service() {
        this(new Idea40124Config());
    }

    public Idea40124Service(Idea40124Config config) {
        this.config = config != null ? config : new Idea40124Config();
