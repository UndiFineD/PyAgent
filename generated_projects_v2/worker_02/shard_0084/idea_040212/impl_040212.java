...
@Data
public class Idea40212Config {
    private String name = "idea_040212";
 ...
 */
@Slf4j
public class Idea40212Service {
    private static final int IDEA_ID = 40212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40212Service() {
        this(new Idea40212Config());
    }

    public Idea40212Service(Idea40212Config config) {
        this.config = config != null ? config : new Idea40212Config();
