...
@Data
public class Idea40134Config {
    private String name = "idea_040134";
 ...
 */
@Slf4j
public class Idea40134Service {
    private static final int IDEA_ID = 40134;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40134Service() {
        this(new Idea40134Config());
    }

    public Idea40134Service(Idea40134Config config) {
        this.config = config != null ? config : new Idea40134Config();
