...
@Data
public class Idea40038Config {
    private String name = "idea_040038";
 ...
 */
@Slf4j
public class Idea40038Service {
    private static final int IDEA_ID = 40038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40038Service() {
        this(new Idea40038Config());
    }

    public Idea40038Service(Idea40038Config config) {
        this.config = config != null ? config : new Idea40038Config();
