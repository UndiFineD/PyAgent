...
@Data
public class Idea39990Config {
    private String name = "idea_039990";
 ...
 */
@Slf4j
public class Idea39990Service {
    private static final int IDEA_ID = 39990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39990Service() {
        this(new Idea39990Config());
    }

    public Idea39990Service(Idea39990Config config) {
        this.config = config != null ? config : new Idea39990Config();
