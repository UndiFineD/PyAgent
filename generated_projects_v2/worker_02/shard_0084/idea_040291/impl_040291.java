...
@Data
public class Idea40291Config {
    private String name = "idea_040291";
 ...
 */
@Slf4j
public class Idea40291Service {
    private static final int IDEA_ID = 40291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40291Service() {
        this(new Idea40291Config());
    }

    public Idea40291Service(Idea40291Config config) {
        this.config = config != null ? config : new Idea40291Config();
