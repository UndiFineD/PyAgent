...
@Data
public class Idea40187Config {
    private String name = "idea_040187";
 ...
 */
@Slf4j
public class Idea40187Service {
    private static final int IDEA_ID = 40187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40187Service() {
        this(new Idea40187Config());
    }

    public Idea40187Service(Idea40187Config config) {
        this.config = config != null ? config : new Idea40187Config();
