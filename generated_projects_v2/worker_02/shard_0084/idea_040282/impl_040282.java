...
@Data
public class Idea40282Config {
    private String name = "idea_040282";
 ...
 */
@Slf4j
public class Idea40282Service {
    private static final int IDEA_ID = 40282;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40282Service() {
        this(new Idea40282Config());
    }

    public Idea40282Service(Idea40282Config config) {
        this.config = config != null ? config : new Idea40282Config();
