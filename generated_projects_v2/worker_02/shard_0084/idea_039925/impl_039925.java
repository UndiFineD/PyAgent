...
@Data
public class Idea39925Config {
    private String name = "idea_039925";
 ...
 */
@Slf4j
public class Idea39925Service {
    private static final int IDEA_ID = 39925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39925Service() {
        this(new Idea39925Config());
    }

    public Idea39925Service(Idea39925Config config) {
        this.config = config != null ? config : new Idea39925Config();
