...
@Data
public class Idea40244Config {
    private String name = "idea_040244";
 ...
 */
@Slf4j
public class Idea40244Service {
    private static final int IDEA_ID = 40244;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40244Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40244Service() {
        this(new Idea40244Config());
    }

    public Idea40244Service(Idea40244Config config) {
        this.config = config != null ? config : new Idea40244Config();
