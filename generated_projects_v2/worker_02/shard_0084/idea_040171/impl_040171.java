...
@Data
public class Idea40171Config {
    private String name = "idea_040171";
 ...
 */
@Slf4j
public class Idea40171Service {
    private static final int IDEA_ID = 40171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40171Service() {
        this(new Idea40171Config());
    }

    public Idea40171Service(Idea40171Config config) {
        this.config = config != null ? config : new Idea40171Config();
