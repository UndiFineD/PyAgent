...
@Data
public class Idea40314Config {
    private String name = "idea_040314";
 ...
 */
@Slf4j
public class Idea40314Service {
    private static final int IDEA_ID = 40314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40314Service() {
        this(new Idea40314Config());
    }

    public Idea40314Service(Idea40314Config config) {
        this.config = config != null ? config : new Idea40314Config();
