...
@Data
public class Idea40274Config {
    private String name = "idea_040274";
 ...
 */
@Slf4j
public class Idea40274Service {
    private static final int IDEA_ID = 40274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40274Service() {
        this(new Idea40274Config());
    }

    public Idea40274Service(Idea40274Config config) {
        this.config = config != null ? config : new Idea40274Config();
