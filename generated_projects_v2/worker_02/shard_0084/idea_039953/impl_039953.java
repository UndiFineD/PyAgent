...
@Data
public class Idea39953Config {
    private String name = "idea_039953";
 ...
 */
@Slf4j
public class Idea39953Service {
    private static final int IDEA_ID = 39953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39953Service() {
        this(new Idea39953Config());
    }

    public Idea39953Service(Idea39953Config config) {
        this.config = config != null ? config : new Idea39953Config();
