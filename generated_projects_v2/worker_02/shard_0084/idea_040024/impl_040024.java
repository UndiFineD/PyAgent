...
@Data
public class Idea40024Config {
    private String name = "idea_040024";
 ...
 */
@Slf4j
public class Idea40024Service {
    private static final int IDEA_ID = 40024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40024Service() {
        this(new Idea40024Config());
    }

    public Idea40024Service(Idea40024Config config) {
        this.config = config != null ? config : new Idea40024Config();
