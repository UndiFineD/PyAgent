...
@Data
public class Idea39930Config {
    private String name = "idea_039930";
 ...
 */
@Slf4j
public class Idea39930Service {
    private static final int IDEA_ID = 39930;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39930Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39930Service() {
        this(new Idea39930Config());
    }

    public Idea39930Service(Idea39930Config config) {
        this.config = config != null ? config : new Idea39930Config();
