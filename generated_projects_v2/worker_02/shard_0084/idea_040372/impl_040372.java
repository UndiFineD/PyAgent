...
@Data
public class Idea40372Config {
    private String name = "idea_040372";
 ...
 */
@Slf4j
public class Idea40372Service {
    private static final int IDEA_ID = 40372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40372Service() {
        this(new Idea40372Config());
    }

    public Idea40372Service(Idea40372Config config) {
        this.config = config != null ? config : new Idea40372Config();
