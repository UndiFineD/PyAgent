...
@Data
public class Idea40285Config {
    private String name = "idea_040285";
 ...
 */
@Slf4j
public class Idea40285Service {
    private static final int IDEA_ID = 40285;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40285Service() {
        this(new Idea40285Config());
    }

    public Idea40285Service(Idea40285Config config) {
        this.config = config != null ? config : new Idea40285Config();
