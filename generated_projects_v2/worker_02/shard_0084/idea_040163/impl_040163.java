...
@Data
public class Idea40163Config {
    private String name = "idea_040163";
 ...
 */
@Slf4j
public class Idea40163Service {
    private static final int IDEA_ID = 40163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40163Service() {
        this(new Idea40163Config());
    }

    public Idea40163Service(Idea40163Config config) {
        this.config = config != null ? config : new Idea40163Config();
