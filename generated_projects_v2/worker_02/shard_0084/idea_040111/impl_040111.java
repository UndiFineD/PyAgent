...
@Data
public class Idea40111Config {
    private String name = "idea_040111";
 ...
 */
@Slf4j
public class Idea40111Service {
    private static final int IDEA_ID = 40111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40111Service() {
        this(new Idea40111Config());
    }

    public Idea40111Service(Idea40111Config config) {
        this.config = config != null ? config : new Idea40111Config();
