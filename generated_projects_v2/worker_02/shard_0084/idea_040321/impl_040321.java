...
@Data
public class Idea40321Config {
    private String name = "idea_040321";
 ...
 */
@Slf4j
public class Idea40321Service {
    private static final int IDEA_ID = 40321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40321Service() {
        this(new Idea40321Config());
    }

    public Idea40321Service(Idea40321Config config) {
        this.config = config != null ? config : new Idea40321Config();
