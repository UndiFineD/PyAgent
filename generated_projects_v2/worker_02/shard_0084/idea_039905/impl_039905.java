...
@Data
public class Idea39905Config {
    private String name = "idea_039905";
 ...
 */
@Slf4j
public class Idea39905Service {
    private static final int IDEA_ID = 39905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39905Service() {
        this(new Idea39905Config());
    }

    public Idea39905Service(Idea39905Config config) {
        this.config = config != null ? config : new Idea39905Config();
