...
@Data
public class Idea40225Config {
    private String name = "idea_040225";
 ...
 */
@Slf4j
public class Idea40225Service {
    private static final int IDEA_ID = 40225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40225Service() {
        this(new Idea40225Config());
    }

    public Idea40225Service(Idea40225Config config) {
        this.config = config != null ? config : new Idea40225Config();
