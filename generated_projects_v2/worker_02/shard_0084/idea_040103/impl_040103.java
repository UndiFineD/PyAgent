...
@Data
public class Idea40103Config {
    private String name = "idea_040103";
 ...
 */
@Slf4j
public class Idea40103Service {
    private static final int IDEA_ID = 40103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40103Service() {
        this(new Idea40103Config());
    }

    public Idea40103Service(Idea40103Config config) {
        this.config = config != null ? config : new Idea40103Config();
