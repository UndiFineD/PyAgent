...
@Data
public class Idea40026Config {
    private String name = "idea_040026";
 ...
 */
@Slf4j
public class Idea40026Service {
    private static final int IDEA_ID = 40026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40026Service() {
        this(new Idea40026Config());
    }

    public Idea40026Service(Idea40026Config config) {
        this.config = config != null ? config : new Idea40026Config();
