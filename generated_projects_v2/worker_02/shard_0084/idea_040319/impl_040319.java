...
@Data
public class Idea40319Config {
    private String name = "idea_040319";
 ...
 */
@Slf4j
public class Idea40319Service {
    private static final int IDEA_ID = 40319;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40319Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40319Service() {
        this(new Idea40319Config());
    }

    public Idea40319Service(Idea40319Config config) {
        this.config = config != null ? config : new Idea40319Config();
