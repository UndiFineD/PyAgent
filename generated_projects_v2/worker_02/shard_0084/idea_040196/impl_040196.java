...
@Data
public class Idea40196Config {
    private String name = "idea_040196";
 ...
 */
@Slf4j
public class Idea40196Service {
    private static final int IDEA_ID = 40196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40196Service() {
        this(new Idea40196Config());
    }

    public Idea40196Service(Idea40196Config config) {
        this.config = config != null ? config : new Idea40196Config();
