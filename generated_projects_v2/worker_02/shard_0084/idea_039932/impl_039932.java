...
@Data
public class Idea39932Config {
    private String name = "idea_039932";
 ...
 */
@Slf4j
public class Idea39932Service {
    private static final int IDEA_ID = 39932;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39932Service() {
        this(new Idea39932Config());
    }

    public Idea39932Service(Idea39932Config config) {
        this.config = config != null ? config : new Idea39932Config();
