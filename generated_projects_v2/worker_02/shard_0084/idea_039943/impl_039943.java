...
@Data
public class Idea39943Config {
    private String name = "idea_039943";
 ...
 */
@Slf4j
public class Idea39943Service {
    private static final int IDEA_ID = 39943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39943Service() {
        this(new Idea39943Config());
    }

    public Idea39943Service(Idea39943Config config) {
        this.config = config != null ? config : new Idea39943Config();
