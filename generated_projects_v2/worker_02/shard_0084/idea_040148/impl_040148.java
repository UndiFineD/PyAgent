...
@Data
public class Idea40148Config {
    private String name = "idea_040148";
 ...
 */
@Slf4j
public class Idea40148Service {
    private static final int IDEA_ID = 40148;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40148Service() {
        this(new Idea40148Config());
    }

    public Idea40148Service(Idea40148Config config) {
        this.config = config != null ? config : new Idea40148Config();
