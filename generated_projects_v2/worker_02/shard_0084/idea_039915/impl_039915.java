...
@Data
public class Idea39915Config {
    private String name = "idea_039915";
 ...
 */
@Slf4j
public class Idea39915Service {
    private static final int IDEA_ID = 39915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39915Service() {
        this(new Idea39915Config());
    }

    public Idea39915Service(Idea39915Config config) {
        this.config = config != null ? config : new Idea39915Config();
