...
@Data
public class Idea40122Config {
    private String name = "idea_040122";
 ...
 */
@Slf4j
public class Idea40122Service {
    private static final int IDEA_ID = 40122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40122Service() {
        this(new Idea40122Config());
    }

    public Idea40122Service(Idea40122Config config) {
        this.config = config != null ? config : new Idea40122Config();
