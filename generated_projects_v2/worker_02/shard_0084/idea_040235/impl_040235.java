...
@Data
public class Idea40235Config {
    private String name = "idea_040235";
 ...
 */
@Slf4j
public class Idea40235Service {
    private static final int IDEA_ID = 40235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40235Service() {
        this(new Idea40235Config());
    }

    public Idea40235Service(Idea40235Config config) {
        this.config = config != null ? config : new Idea40235Config();
