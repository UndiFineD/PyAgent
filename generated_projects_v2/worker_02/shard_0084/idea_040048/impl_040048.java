...
@Data
public class Idea40048Config {
    private String name = "idea_040048";
 ...
 */
@Slf4j
public class Idea40048Service {
    private static final int IDEA_ID = 40048;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40048Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40048Service() {
        this(new Idea40048Config());
    }

    public Idea40048Service(Idea40048Config config) {
        this.config = config != null ? config : new Idea40048Config();
