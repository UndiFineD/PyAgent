...
@Data
public class Idea40095Config {
    private String name = "idea_040095";
 ...
 */
@Slf4j
public class Idea40095Service {
    private static final int IDEA_ID = 40095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40095Service() {
        this(new Idea40095Config());
    }

    public Idea40095Service(Idea40095Config config) {
        this.config = config != null ? config : new Idea40095Config();
