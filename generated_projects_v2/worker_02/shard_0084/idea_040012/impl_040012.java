...
@Data
public class Idea40012Config {
    private String name = "idea_040012";
 ...
 */
@Slf4j
public class Idea40012Service {
    private static final int IDEA_ID = 40012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40012Service() {
        this(new Idea40012Config());
    }

    public Idea40012Service(Idea40012Config config) {
        this.config = config != null ? config : new Idea40012Config();
