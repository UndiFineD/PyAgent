...
@Data
public class Idea40009Config {
    private String name = "idea_040009";
 ...
 */
@Slf4j
public class Idea40009Service {
    private static final int IDEA_ID = 40009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40009Service() {
        this(new Idea40009Config());
    }

    public Idea40009Service(Idea40009Config config) {
        this.config = config != null ? config : new Idea40009Config();
