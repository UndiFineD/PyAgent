...
@Data
public class Idea40152Config {
    private String name = "idea_040152";
 ...
 */
@Slf4j
public class Idea40152Service {
    private static final int IDEA_ID = 40152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40152Service() {
        this(new Idea40152Config());
    }

    public Idea40152Service(Idea40152Config config) {
        this.config = config != null ? config : new Idea40152Config();
