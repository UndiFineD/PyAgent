...
@Data
public class Idea40028Config {
    private String name = "idea_040028";
 ...
 */
@Slf4j
public class Idea40028Service {
    private static final int IDEA_ID = 40028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40028Service() {
        this(new Idea40028Config());
    }

    public Idea40028Service(Idea40028Config config) {
        this.config = config != null ? config : new Idea40028Config();
