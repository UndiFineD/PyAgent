...
@Data
public class Idea40367Config {
    private String name = "idea_040367";
 ...
 */
@Slf4j
public class Idea40367Service {
    private static final int IDEA_ID = 40367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40367Service() {
        this(new Idea40367Config());
    }

    public Idea40367Service(Idea40367Config config) {
        this.config = config != null ? config : new Idea40367Config();
