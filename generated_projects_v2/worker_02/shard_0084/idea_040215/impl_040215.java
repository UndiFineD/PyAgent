...
@Data
public class Idea40215Config {
    private String name = "idea_040215";
 ...
 */
@Slf4j
public class Idea40215Service {
    private static final int IDEA_ID = 40215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40215Service() {
        this(new Idea40215Config());
    }

    public Idea40215Service(Idea40215Config config) {
        this.config = config != null ? config : new Idea40215Config();
