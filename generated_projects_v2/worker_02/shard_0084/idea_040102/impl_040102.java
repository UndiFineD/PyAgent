...
@Data
public class Idea40102Config {
    private String name = "idea_040102";
 ...
 */
@Slf4j
public class Idea40102Service {
    private static final int IDEA_ID = 40102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40102Service() {
        this(new Idea40102Config());
    }

    public Idea40102Service(Idea40102Config config) {
        this.config = config != null ? config : new Idea40102Config();
