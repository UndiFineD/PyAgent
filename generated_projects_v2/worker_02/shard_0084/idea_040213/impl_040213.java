...
@Data
public class Idea40213Config {
    private String name = "idea_040213";
 ...
 */
@Slf4j
public class Idea40213Service {
    private static final int IDEA_ID = 40213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40213Service() {
        this(new Idea40213Config());
    }

    public Idea40213Service(Idea40213Config config) {
        this.config = config != null ? config : new Idea40213Config();
