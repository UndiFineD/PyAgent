...
@Data
public class Idea40087Config {
    private String name = "idea_040087";
 ...
 */
@Slf4j
public class Idea40087Service {
    private static final int IDEA_ID = 40087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40087Service() {
        this(new Idea40087Config());
    }

    public Idea40087Service(Idea40087Config config) {
        this.config = config != null ? config : new Idea40087Config();
