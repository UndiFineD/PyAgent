...
@Data
public class Idea40096Config {
    private String name = "idea_040096";
 ...
 */
@Slf4j
public class Idea40096Service {
    private static final int IDEA_ID = 40096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40096Service() {
        this(new Idea40096Config());
    }

    public Idea40096Service(Idea40096Config config) {
        this.config = config != null ? config : new Idea40096Config();
