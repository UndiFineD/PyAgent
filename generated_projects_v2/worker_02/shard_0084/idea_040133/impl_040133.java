...
@Data
public class Idea40133Config {
    private String name = "idea_040133";
 ...
 */
@Slf4j
public class Idea40133Service {
    private static final int IDEA_ID = 40133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40133Service() {
        this(new Idea40133Config());
    }

    public Idea40133Service(Idea40133Config config) {
        this.config = config != null ? config : new Idea40133Config();
