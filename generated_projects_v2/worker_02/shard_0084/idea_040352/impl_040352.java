...
@Data
public class Idea40352Config {
    private String name = "idea_040352";
 ...
 */
@Slf4j
public class Idea40352Service {
    private static final int IDEA_ID = 40352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40352Service() {
        this(new Idea40352Config());
    }

    public Idea40352Service(Idea40352Config config) {
        this.config = config != null ? config : new Idea40352Config();
