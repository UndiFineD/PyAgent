...
@Data
public class Idea40301Config {
    private String name = "idea_040301";
 ...
 */
@Slf4j
public class Idea40301Service {
    private static final int IDEA_ID = 40301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40301Service() {
        this(new Idea40301Config());
    }

    public Idea40301Service(Idea40301Config config) {
        this.config = config != null ? config : new Idea40301Config();
