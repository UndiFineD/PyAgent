...
@Data
public class Idea40310Config {
    private String name = "idea_040310";
 ...
 */
@Slf4j
public class Idea40310Service {
    private static final int IDEA_ID = 40310;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40310Service() {
        this(new Idea40310Config());
    }

    public Idea40310Service(Idea40310Config config) {
        this.config = config != null ? config : new Idea40310Config();
