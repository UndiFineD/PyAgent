...
@Data
public class Idea40169Config {
    private String name = "idea_040169";
 ...
 */
@Slf4j
public class Idea40169Service {
    private static final int IDEA_ID = 40169;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40169Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40169Service() {
        this(new Idea40169Config());
    }

    public Idea40169Service(Idea40169Config config) {
        this.config = config != null ? config : new Idea40169Config();
