...
@Data
public class Idea40334Config {
    private String name = "idea_040334";
 ...
 */
@Slf4j
public class Idea40334Service {
    private static final int IDEA_ID = 40334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40334Service() {
        this(new Idea40334Config());
    }

    public Idea40334Service(Idea40334Config config) {
        this.config = config != null ? config : new Idea40334Config();
