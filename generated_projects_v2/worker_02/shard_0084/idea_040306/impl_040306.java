...
@Data
public class Idea40306Config {
    private String name = "idea_040306";
 ...
 */
@Slf4j
public class Idea40306Service {
    private static final int IDEA_ID = 40306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40306Service() {
        this(new Idea40306Config());
    }

    public Idea40306Service(Idea40306Config config) {
        this.config = config != null ? config : new Idea40306Config();
