...
@Data
public class Idea39944Config {
    private String name = "idea_039944";
 ...
 */
@Slf4j
public class Idea39944Service {
    private static final int IDEA_ID = 39944;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39944Service() {
        this(new Idea39944Config());
    }

    public Idea39944Service(Idea39944Config config) {
        this.config = config != null ? config : new Idea39944Config();
