...
@Data
public class Idea40257Config {
    private String name = "idea_040257";
 ...
 */
@Slf4j
public class Idea40257Service {
    private static final int IDEA_ID = 40257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40257Service() {
        this(new Idea40257Config());
    }

    public Idea40257Service(Idea40257Config config) {
        this.config = config != null ? config : new Idea40257Config();
