...
@Data
public class Idea40168Config {
    private String name = "idea_040168";
 ...
 */
@Slf4j
public class Idea40168Service {
    private static final int IDEA_ID = 40168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40168Service() {
        this(new Idea40168Config());
    }

    public Idea40168Service(Idea40168Config config) {
        this.config = config != null ? config : new Idea40168Config();
