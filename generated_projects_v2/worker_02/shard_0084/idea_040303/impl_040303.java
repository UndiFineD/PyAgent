...
@Data
public class Idea40303Config {
    private String name = "idea_040303";
 ...
 */
@Slf4j
public class Idea40303Service {
    private static final int IDEA_ID = 40303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40303Service() {
        this(new Idea40303Config());
    }

    public Idea40303Service(Idea40303Config config) {
        this.config = config != null ? config : new Idea40303Config();
