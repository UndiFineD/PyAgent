...
@Data
public class Idea40355Config {
    private String name = "idea_040355";
 ...
 */
@Slf4j
public class Idea40355Service {
    private static final int IDEA_ID = 40355;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40355Service() {
        this(new Idea40355Config());
    }

    public Idea40355Service(Idea40355Config config) {
        this.config = config != null ? config : new Idea40355Config();
