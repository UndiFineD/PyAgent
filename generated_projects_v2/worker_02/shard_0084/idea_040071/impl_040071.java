...
@Data
public class Idea40071Config {
    private String name = "idea_040071";
 ...
 */
@Slf4j
public class Idea40071Service {
    private static final int IDEA_ID = 40071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40071Service() {
        this(new Idea40071Config());
    }

    public Idea40071Service(Idea40071Config config) {
        this.config = config != null ? config : new Idea40071Config();
