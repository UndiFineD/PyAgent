...
@Data
public class Idea40094Config {
    private String name = "idea_040094";
 ...
 */
@Slf4j
public class Idea40094Service {
    private static final int IDEA_ID = 40094;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40094Service() {
        this(new Idea40094Config());
    }

    public Idea40094Service(Idea40094Config config) {
        this.config = config != null ? config : new Idea40094Config();
