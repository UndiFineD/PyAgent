...
@Data
public class Idea40104Config {
    private String name = "idea_040104";
 ...
 */
@Slf4j
public class Idea40104Service {
    private static final int IDEA_ID = 40104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40104Service() {
        this(new Idea40104Config());
    }

    public Idea40104Service(Idea40104Config config) {
        this.config = config != null ? config : new Idea40104Config();
