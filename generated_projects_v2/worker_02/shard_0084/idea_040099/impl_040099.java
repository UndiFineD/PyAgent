...
@Data
public class Idea40099Config {
    private String name = "idea_040099";
 ...
 */
@Slf4j
public class Idea40099Service {
    private static final int IDEA_ID = 40099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40099Service() {
        this(new Idea40099Config());
    }

    public Idea40099Service(Idea40099Config config) {
        this.config = config != null ? config : new Idea40099Config();
