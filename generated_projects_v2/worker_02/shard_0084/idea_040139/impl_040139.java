...
@Data
public class Idea40139Config {
    private String name = "idea_040139";
 ...
 */
@Slf4j
public class Idea40139Service {
    private static final int IDEA_ID = 40139;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40139Service() {
        this(new Idea40139Config());
    }

    public Idea40139Service(Idea40139Config config) {
        this.config = config != null ? config : new Idea40139Config();
