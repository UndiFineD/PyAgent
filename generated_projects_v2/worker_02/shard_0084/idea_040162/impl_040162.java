...
@Data
public class Idea40162Config {
    private String name = "idea_040162";
 ...
 */
@Slf4j
public class Idea40162Service {
    private static final int IDEA_ID = 40162;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40162Service() {
        this(new Idea40162Config());
    }

    public Idea40162Service(Idea40162Config config) {
        this.config = config != null ? config : new Idea40162Config();
