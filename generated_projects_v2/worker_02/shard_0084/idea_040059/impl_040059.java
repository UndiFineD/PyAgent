...
@Data
public class Idea40059Config {
    private String name = "idea_040059";
 ...
 */
@Slf4j
public class Idea40059Service {
    private static final int IDEA_ID = 40059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40059Service() {
        this(new Idea40059Config());
    }

    public Idea40059Service(Idea40059Config config) {
        this.config = config != null ? config : new Idea40059Config();
