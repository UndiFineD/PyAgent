...
@Data
public class Idea40366Config {
    private String name = "idea_040366";
 ...
 */
@Slf4j
public class Idea40366Service {
    private static final int IDEA_ID = 40366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40366Service() {
        this(new Idea40366Config());
    }

    public Idea40366Service(Idea40366Config config) {
        this.config = config != null ? config : new Idea40366Config();
