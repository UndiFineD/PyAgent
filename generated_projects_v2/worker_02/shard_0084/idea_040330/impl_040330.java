...
@Data
public class Idea40330Config {
    private String name = "idea_040330";
 ...
 */
@Slf4j
public class Idea40330Service {
    private static final int IDEA_ID = 40330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40330Service() {
        this(new Idea40330Config());
    }

    public Idea40330Service(Idea40330Config config) {
        this.config = config != null ? config : new Idea40330Config();
