...
@Data
public class Idea40072Config {
    private String name = "idea_040072";
 ...
 */
@Slf4j
public class Idea40072Service {
    private static final int IDEA_ID = 40072;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40072Service() {
        this(new Idea40072Config());
    }

    public Idea40072Service(Idea40072Config config) {
        this.config = config != null ? config : new Idea40072Config();
