...
@Data
public class Idea40182Config {
    private String name = "idea_040182";
 ...
 */
@Slf4j
public class Idea40182Service {
    private static final int IDEA_ID = 40182;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40182Service() {
        this(new Idea40182Config());
    }

    public Idea40182Service(Idea40182Config config) {
        this.config = config != null ? config : new Idea40182Config();
