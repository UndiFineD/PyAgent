...
@Data
public class Idea40201Config {
    private String name = "idea_040201";
 ...
 */
@Slf4j
public class Idea40201Service {
    private static final int IDEA_ID = 40201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40201Service() {
        this(new Idea40201Config());
    }

    public Idea40201Service(Idea40201Config config) {
        this.config = config != null ? config : new Idea40201Config();
