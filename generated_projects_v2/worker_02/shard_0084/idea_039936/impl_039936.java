...
@Data
public class Idea39936Config {
    private String name = "idea_039936";
 ...
 */
@Slf4j
public class Idea39936Service {
    private static final int IDEA_ID = 39936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39936Service() {
        this(new Idea39936Config());
    }

    public Idea39936Service(Idea39936Config config) {
        this.config = config != null ? config : new Idea39936Config();
