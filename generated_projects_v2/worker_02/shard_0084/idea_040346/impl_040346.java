...
@Data
public class Idea40346Config {
    private String name = "idea_040346";
 ...
 */
@Slf4j
public class Idea40346Service {
    private static final int IDEA_ID = 40346;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40346Service() {
        this(new Idea40346Config());
    }

    public Idea40346Service(Idea40346Config config) {
        this.config = config != null ? config : new Idea40346Config();
