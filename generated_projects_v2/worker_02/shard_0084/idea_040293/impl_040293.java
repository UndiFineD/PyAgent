...
@Data
public class Idea40293Config {
    private String name = "idea_040293";
 ...
 */
@Slf4j
public class Idea40293Service {
    private static final int IDEA_ID = 40293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40293Service() {
        this(new Idea40293Config());
    }

    public Idea40293Service(Idea40293Config config) {
        this.config = config != null ? config : new Idea40293Config();
