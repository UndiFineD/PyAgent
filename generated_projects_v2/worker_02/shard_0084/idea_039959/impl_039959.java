...
@Data
public class Idea39959Config {
    private String name = "idea_039959";
 ...
 */
@Slf4j
public class Idea39959Service {
    private static final int IDEA_ID = 39959;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39959Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39959Service() {
        this(new Idea39959Config());
    }

    public Idea39959Service(Idea39959Config config) {
        this.config = config != null ? config : new Idea39959Config();
