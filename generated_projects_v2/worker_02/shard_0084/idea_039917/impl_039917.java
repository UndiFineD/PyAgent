...
@Data
public class Idea39917Config {
    private String name = "idea_039917";
 ...
 */
@Slf4j
public class Idea39917Service {
    private static final int IDEA_ID = 39917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39917Service() {
        this(new Idea39917Config());
    }

    public Idea39917Service(Idea39917Config config) {
        this.config = config != null ? config : new Idea39917Config();
