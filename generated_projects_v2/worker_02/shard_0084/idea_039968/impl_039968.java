...
@Data
public class Idea39968Config {
    private String name = "idea_039968";
 ...
 */
@Slf4j
public class Idea39968Service {
    private static final int IDEA_ID = 39968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39968Service() {
        this(new Idea39968Config());
    }

    public Idea39968Service(Idea39968Config config) {
        this.config = config != null ? config : new Idea39968Config();
