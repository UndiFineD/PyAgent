...
@Data
public class Idea40298Config {
    private String name = "idea_040298";
 ...
 */
@Slf4j
public class Idea40298Service {
    private static final int IDEA_ID = 40298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40298Service() {
        this(new Idea40298Config());
    }

    public Idea40298Service(Idea40298Config config) {
        this.config = config != null ? config : new Idea40298Config();
