...
@Data
public class Idea39962Config {
    private String name = "idea_039962";
 ...
 */
@Slf4j
public class Idea39962Service {
    private static final int IDEA_ID = 39962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39962Service() {
        this(new Idea39962Config());
    }

    public Idea39962Service(Idea39962Config config) {
        this.config = config != null ? config : new Idea39962Config();
