...
@Data
public class Idea40327Config {
    private String name = "idea_040327";
 ...
 */
@Slf4j
public class Idea40327Service {
    private static final int IDEA_ID = 40327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40327Service() {
        this(new Idea40327Config());
    }

    public Idea40327Service(Idea40327Config config) {
        this.config = config != null ? config : new Idea40327Config();
