...
@Data
public class Idea40142Config {
    private String name = "idea_040142";
 ...
 */
@Slf4j
public class Idea40142Service {
    private static final int IDEA_ID = 40142;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40142Service() {
        this(new Idea40142Config());
    }

    public Idea40142Service(Idea40142Config config) {
        this.config = config != null ? config : new Idea40142Config();
