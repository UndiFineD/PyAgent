...
@Data
public class Idea40341Config {
    private String name = "idea_040341";
 ...
 */
@Slf4j
public class Idea40341Service {
    private static final int IDEA_ID = 40341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40341Service() {
        this(new Idea40341Config());
    }

    public Idea40341Service(Idea40341Config config) {
        this.config = config != null ? config : new Idea40341Config();
