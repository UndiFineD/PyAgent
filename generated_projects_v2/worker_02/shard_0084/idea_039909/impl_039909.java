...
@Data
public class Idea39909Config {
    private String name = "idea_039909";
 ...
 */
@Slf4j
public class Idea39909Service {
    private static final int IDEA_ID = 39909;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39909Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39909Service() {
        this(new Idea39909Config());
    }

    public Idea39909Service(Idea39909Config config) {
        this.config = config != null ? config : new Idea39909Config();
