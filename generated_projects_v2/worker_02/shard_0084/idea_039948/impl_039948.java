...
@Data
public class Idea39948Config {
    private String name = "idea_039948";
 ...
 */
@Slf4j
public class Idea39948Service {
    private static final int IDEA_ID = 39948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39948Service() {
        this(new Idea39948Config());
    }

    public Idea39948Service(Idea39948Config config) {
        this.config = config != null ? config : new Idea39948Config();
