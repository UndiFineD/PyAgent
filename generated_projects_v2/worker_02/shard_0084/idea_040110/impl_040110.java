...
@Data
public class Idea40110Config {
    private String name = "idea_040110";
 ...
 */
@Slf4j
public class Idea40110Service {
    private static final int IDEA_ID = 40110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40110Service() {
        this(new Idea40110Config());
    }

    public Idea40110Service(Idea40110Config config) {
        this.config = config != null ? config : new Idea40110Config();
