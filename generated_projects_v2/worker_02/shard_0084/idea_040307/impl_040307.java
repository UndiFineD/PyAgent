...
@Data
public class Idea40307Config {
    private String name = "idea_040307";
 ...
 */
@Slf4j
public class Idea40307Service {
    private static final int IDEA_ID = 40307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40307Service() {
        this(new Idea40307Config());
    }

    public Idea40307Service(Idea40307Config config) {
        this.config = config != null ? config : new Idea40307Config();
