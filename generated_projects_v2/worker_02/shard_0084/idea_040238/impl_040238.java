...
@Data
public class Idea40238Config {
    private String name = "idea_040238";
 ...
 */
@Slf4j
public class Idea40238Service {
    private static final int IDEA_ID = 40238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40238Service() {
        this(new Idea40238Config());
    }

    public Idea40238Service(Idea40238Config config) {
        this.config = config != null ? config : new Idea40238Config();
