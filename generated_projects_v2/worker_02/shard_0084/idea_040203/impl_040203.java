...
@Data
public class Idea40203Config {
    private String name = "idea_040203";
 ...
 */
@Slf4j
public class Idea40203Service {
    private static final int IDEA_ID = 40203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40203Service() {
        this(new Idea40203Config());
    }

    public Idea40203Service(Idea40203Config config) {
        this.config = config != null ? config : new Idea40203Config();
