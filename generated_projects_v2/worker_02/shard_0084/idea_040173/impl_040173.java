...
@Data
public class Idea40173Config {
    private String name = "idea_040173";
 ...
 */
@Slf4j
public class Idea40173Service {
    private static final int IDEA_ID = 40173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40173Service() {
        this(new Idea40173Config());
    }

    public Idea40173Service(Idea40173Config config) {
        this.config = config != null ? config : new Idea40173Config();
