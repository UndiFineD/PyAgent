...
@Data
public class Idea40177Config {
    private String name = "idea_040177";
 ...
 */
@Slf4j
public class Idea40177Service {
    private static final int IDEA_ID = 40177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40177Service() {
        this(new Idea40177Config());
    }

    public Idea40177Service(Idea40177Config config) {
        this.config = config != null ? config : new Idea40177Config();
