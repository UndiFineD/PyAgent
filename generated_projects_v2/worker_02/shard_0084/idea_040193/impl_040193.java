...
@Data
public class Idea40193Config {
    private String name = "idea_040193";
 ...
 */
@Slf4j
public class Idea40193Service {
    private static final int IDEA_ID = 40193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40193Service() {
        this(new Idea40193Config());
    }

    public Idea40193Service(Idea40193Config config) {
        this.config = config != null ? config : new Idea40193Config();
