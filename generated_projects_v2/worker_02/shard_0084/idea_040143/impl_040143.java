...
@Data
public class Idea40143Config {
    private String name = "idea_040143";
 ...
 */
@Slf4j
public class Idea40143Service {
    private static final int IDEA_ID = 40143;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40143Service() {
        this(new Idea40143Config());
    }

    public Idea40143Service(Idea40143Config config) {
        this.config = config != null ? config : new Idea40143Config();
