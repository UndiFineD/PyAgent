...
@Data
public class Idea40255Config {
    private String name = "idea_040255";
 ...
 */
@Slf4j
public class Idea40255Service {
    private static final int IDEA_ID = 40255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40255Service() {
        this(new Idea40255Config());
    }

    public Idea40255Service(Idea40255Config config) {
        this.config = config != null ? config : new Idea40255Config();
