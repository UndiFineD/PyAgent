...
@Data
public class Idea40064Config {
    private String name = "idea_040064";
 ...
 */
@Slf4j
public class Idea40064Service {
    private static final int IDEA_ID = 40064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40064Service() {
        this(new Idea40064Config());
    }

    public Idea40064Service(Idea40064Config config) {
        this.config = config != null ? config : new Idea40064Config();
