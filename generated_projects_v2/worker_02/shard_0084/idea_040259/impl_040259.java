...
@Data
public class Idea40259Config {
    private String name = "idea_040259";
 ...
 */
@Slf4j
public class Idea40259Service {
    private static final int IDEA_ID = 40259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40259Service() {
        this(new Idea40259Config());
    }

    public Idea40259Service(Idea40259Config config) {
        this.config = config != null ? config : new Idea40259Config();
