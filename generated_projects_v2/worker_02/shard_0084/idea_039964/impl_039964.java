...
@Data
public class Idea39964Config {
    private String name = "idea_039964";
 ...
 */
@Slf4j
public class Idea39964Service {
    private static final int IDEA_ID = 39964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39964Service() {
        this(new Idea39964Config());
    }

    public Idea39964Service(Idea39964Config config) {
        this.config = config != null ? config : new Idea39964Config();
