...
@Data
public class Idea40052Config {
    private String name = "idea_040052";
 ...
 */
@Slf4j
public class Idea40052Service {
    private static final int IDEA_ID = 40052;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40052Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40052Service() {
        this(new Idea40052Config());
    }

    public Idea40052Service(Idea40052Config config) {
        this.config = config != null ? config : new Idea40052Config();
