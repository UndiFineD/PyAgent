...
@Data
public class Idea40288Config {
    private String name = "idea_040288";
 ...
 */
@Slf4j
public class Idea40288Service {
    private static final int IDEA_ID = 40288;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40288Service() {
        this(new Idea40288Config());
    }

    public Idea40288Service(Idea40288Config config) {
        this.config = config != null ? config : new Idea40288Config();
