...
@Data
public class Idea40141Config {
    private String name = "idea_040141";
 ...
 */
@Slf4j
public class Idea40141Service {
    private static final int IDEA_ID = 40141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40141Service() {
        this(new Idea40141Config());
    }

    public Idea40141Service(Idea40141Config config) {
        this.config = config != null ? config : new Idea40141Config();
