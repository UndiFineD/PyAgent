...
@Data
public class Idea40130Config {
    private String name = "idea_040130";
 ...
 */
@Slf4j
public class Idea40130Service {
    private static final int IDEA_ID = 40130;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40130Service() {
        this(new Idea40130Config());
    }

    public Idea40130Service(Idea40130Config config) {
        this.config = config != null ? config : new Idea40130Config();
