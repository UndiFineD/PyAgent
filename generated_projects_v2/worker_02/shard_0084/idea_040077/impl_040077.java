...
@Data
public class Idea40077Config {
    private String name = "idea_040077";
 ...
 */
@Slf4j
public class Idea40077Service {
    private static final int IDEA_ID = 40077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40077Service() {
        this(new Idea40077Config());
    }

    public Idea40077Service(Idea40077Config config) {
        this.config = config != null ? config : new Idea40077Config();
