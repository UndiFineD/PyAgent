...
@Data
public class Idea39975Config {
    private String name = "idea_039975";
 ...
 */
@Slf4j
public class Idea39975Service {
    private static final int IDEA_ID = 39975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39975Service() {
        this(new Idea39975Config());
    }

    public Idea39975Service(Idea39975Config config) {
        this.config = config != null ? config : new Idea39975Config();
