...
@Data
public class Idea40006Config {
    private String name = "idea_040006";
 ...
 */
@Slf4j
public class Idea40006Service {
    private static final int IDEA_ID = 40006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40006Service() {
        this(new Idea40006Config());
    }

    public Idea40006Service(Idea40006Config config) {
        this.config = config != null ? config : new Idea40006Config();
