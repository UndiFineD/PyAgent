...
@Data
public class Idea40098Config {
    private String name = "idea_040098";
 ...
 */
@Slf4j
public class Idea40098Service {
    private static final int IDEA_ID = 40098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40098Service() {
        this(new Idea40098Config());
    }

    public Idea40098Service(Idea40098Config config) {
        this.config = config != null ? config : new Idea40098Config();
