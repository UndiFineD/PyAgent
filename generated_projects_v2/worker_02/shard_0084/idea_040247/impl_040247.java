...
@Data
public class Idea40247Config {
    private String name = "idea_040247";
 ...
 */
@Slf4j
public class Idea40247Service {
    private static final int IDEA_ID = 40247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40247Service() {
        this(new Idea40247Config());
    }

    public Idea40247Service(Idea40247Config config) {
        this.config = config != null ? config : new Idea40247Config();
