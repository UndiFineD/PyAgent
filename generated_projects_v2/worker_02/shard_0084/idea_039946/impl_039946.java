...
@Data
public class Idea39946Config {
    private String name = "idea_039946";
 ...
 */
@Slf4j
public class Idea39946Service {
    private static final int IDEA_ID = 39946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39946Service() {
        this(new Idea39946Config());
    }

    public Idea39946Service(Idea39946Config config) {
        this.config = config != null ? config : new Idea39946Config();
