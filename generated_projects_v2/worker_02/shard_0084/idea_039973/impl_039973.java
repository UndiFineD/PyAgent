...
@Data
public class Idea39973Config {
    private String name = "idea_039973";
 ...
 */
@Slf4j
public class Idea39973Service {
    private static final int IDEA_ID = 39973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39973Service() {
        this(new Idea39973Config());
    }

    public Idea39973Service(Idea39973Config config) {
        this.config = config != null ? config : new Idea39973Config();
