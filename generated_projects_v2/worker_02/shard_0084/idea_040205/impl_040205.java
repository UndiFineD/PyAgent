...
@Data
public class Idea40205Config {
    private String name = "idea_040205";
 ...
 */
@Slf4j
public class Idea40205Service {
    private static final int IDEA_ID = 40205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40205Service() {
        this(new Idea40205Config());
    }

    public Idea40205Service(Idea40205Config config) {
        this.config = config != null ? config : new Idea40205Config();
