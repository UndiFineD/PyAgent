...
@Data
public class Idea40211Config {
    private String name = "idea_040211";
 ...
 */
@Slf4j
public class Idea40211Service {
    private static final int IDEA_ID = 40211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40211Service() {
        this(new Idea40211Config());
    }

    public Idea40211Service(Idea40211Config config) {
        this.config = config != null ? config : new Idea40211Config();
