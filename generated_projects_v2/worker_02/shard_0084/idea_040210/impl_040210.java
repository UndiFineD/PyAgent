...
@Data
public class Idea40210Config {
    private String name = "idea_040210";
 ...
 */
@Slf4j
public class Idea40210Service {
    private static final int IDEA_ID = 40210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40210Service() {
        this(new Idea40210Config());
    }

    public Idea40210Service(Idea40210Config config) {
        this.config = config != null ? config : new Idea40210Config();
