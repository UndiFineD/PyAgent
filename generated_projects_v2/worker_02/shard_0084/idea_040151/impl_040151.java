...
@Data
public class Idea40151Config {
    private String name = "idea_040151";
 ...
 */
@Slf4j
public class Idea40151Service {
    private static final int IDEA_ID = 40151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40151Service() {
        this(new Idea40151Config());
    }

    public Idea40151Service(Idea40151Config config) {
        this.config = config != null ? config : new Idea40151Config();
