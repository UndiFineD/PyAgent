...
@Data
public class Idea40060Config {
    private String name = "idea_040060";
 ...
 */
@Slf4j
public class Idea40060Service {
    private static final int IDEA_ID = 40060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40060Service() {
        this(new Idea40060Config());
    }

    public Idea40060Service(Idea40060Config config) {
        this.config = config != null ? config : new Idea40060Config();
