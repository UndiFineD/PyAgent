...
@Data
public class Idea40309Config {
    private String name = "idea_040309";
 ...
 */
@Slf4j
public class Idea40309Service {
    private static final int IDEA_ID = 40309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40309Service() {
        this(new Idea40309Config());
    }

    public Idea40309Service(Idea40309Config config) {
        this.config = config != null ? config : new Idea40309Config();
