...
@Data
public class Idea40044Config {
    private String name = "idea_040044";
 ...
 */
@Slf4j
public class Idea40044Service {
    private static final int IDEA_ID = 40044;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40044Service() {
        this(new Idea40044Config());
    }

    public Idea40044Service(Idea40044Config config) {
        this.config = config != null ? config : new Idea40044Config();
