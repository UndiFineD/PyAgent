...
@Data
public class Idea40348Config {
    private String name = "idea_040348";
 ...
 */
@Slf4j
public class Idea40348Service {
    private static final int IDEA_ID = 40348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40348Service() {
        this(new Idea40348Config());
    }

    public Idea40348Service(Idea40348Config config) {
        this.config = config != null ? config : new Idea40348Config();
