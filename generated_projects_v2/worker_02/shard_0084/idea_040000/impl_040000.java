...
@Data
public class Idea40000Config {
    private String name = "idea_040000";
 ...
 */
@Slf4j
public class Idea40000Service {
    private static final int IDEA_ID = 40000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40000Service() {
        this(new Idea40000Config());
    }

    public Idea40000Service(Idea40000Config config) {
        this.config = config != null ? config : new Idea40000Config();
