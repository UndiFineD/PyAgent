...
@Data
public class Idea40265Config {
    private String name = "idea_040265";
 ...
 */
@Slf4j
public class Idea40265Service {
    private static final int IDEA_ID = 40265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40265Service() {
        this(new Idea40265Config());
    }

    public Idea40265Service(Idea40265Config config) {
        this.config = config != null ? config : new Idea40265Config();
