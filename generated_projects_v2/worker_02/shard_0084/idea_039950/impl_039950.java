...
@Data
public class Idea39950Config {
    private String name = "idea_039950";
 ...
 */
@Slf4j
public class Idea39950Service {
    private static final int IDEA_ID = 39950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39950Service() {
        this(new Idea39950Config());
    }

    public Idea39950Service(Idea39950Config config) {
        this.config = config != null ? config : new Idea39950Config();
