...
@Data
public class Idea39911Config {
    private String name = "idea_039911";
 ...
 */
@Slf4j
public class Idea39911Service {
    private static final int IDEA_ID = 39911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39911Service() {
        this(new Idea39911Config());
    }

    public Idea39911Service(Idea39911Config config) {
        this.config = config != null ? config : new Idea39911Config();
