...
@Data
public class Idea40016Config {
    private String name = "idea_040016";
 ...
 */
@Slf4j
public class Idea40016Service {
    private static final int IDEA_ID = 40016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40016Service() {
        this(new Idea40016Config());
    }

    public Idea40016Service(Idea40016Config config) {
        this.config = config != null ? config : new Idea40016Config();
