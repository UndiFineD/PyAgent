...
@Data
public class Idea40160Config {
    private String name = "idea_040160";
 ...
 */
@Slf4j
public class Idea40160Service {
    private static final int IDEA_ID = 40160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40160Service() {
        this(new Idea40160Config());
    }

    public Idea40160Service(Idea40160Config config) {
        this.config = config != null ? config : new Idea40160Config();
