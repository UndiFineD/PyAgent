...
@Data
public class Idea40286Config {
    private String name = "idea_040286";
 ...
 */
@Slf4j
public class Idea40286Service {
    private static final int IDEA_ID = 40286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40286Service() {
        this(new Idea40286Config());
    }

    public Idea40286Service(Idea40286Config config) {
        this.config = config != null ? config : new Idea40286Config();
