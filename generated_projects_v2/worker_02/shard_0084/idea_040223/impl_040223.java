...
@Data
public class Idea40223Config {
    private String name = "idea_040223";
 ...
 */
@Slf4j
public class Idea40223Service {
    private static final int IDEA_ID = 40223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40223Service() {
        this(new Idea40223Config());
    }

    public Idea40223Service(Idea40223Config config) {
        this.config = config != null ? config : new Idea40223Config();
