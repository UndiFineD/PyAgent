...
@Data
public class Idea40070Config {
    private String name = "idea_040070";
 ...
 */
@Slf4j
public class Idea40070Service {
    private static final int IDEA_ID = 40070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40070Service() {
        this(new Idea40070Config());
    }

    public Idea40070Service(Idea40070Config config) {
        this.config = config != null ? config : new Idea40070Config();
