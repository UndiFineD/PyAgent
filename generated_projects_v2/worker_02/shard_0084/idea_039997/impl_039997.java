...
@Data
public class Idea39997Config {
    private String name = "idea_039997";
 ...
 */
@Slf4j
public class Idea39997Service {
    private static final int IDEA_ID = 39997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39997Service() {
        this(new Idea39997Config());
    }

    public Idea39997Service(Idea39997Config config) {
        this.config = config != null ? config : new Idea39997Config();
