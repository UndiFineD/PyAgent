...
@Data
public class Idea39933Config {
    private String name = "idea_039933";
 ...
 */
@Slf4j
public class Idea39933Service {
    private static final int IDEA_ID = 39933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39933Service() {
        this(new Idea39933Config());
    }

    public Idea39933Service(Idea39933Config config) {
        this.config = config != null ? config : new Idea39933Config();
