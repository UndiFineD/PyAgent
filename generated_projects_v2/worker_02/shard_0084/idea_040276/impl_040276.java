...
@Data
public class Idea40276Config {
    private String name = "idea_040276";
 ...
 */
@Slf4j
public class Idea40276Service {
    private static final int IDEA_ID = 40276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40276Service() {
        this(new Idea40276Config());
    }

    public Idea40276Service(Idea40276Config config) {
        this.config = config != null ? config : new Idea40276Config();
