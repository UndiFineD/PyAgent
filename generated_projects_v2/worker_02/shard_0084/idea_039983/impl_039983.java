...
@Data
public class Idea39983Config {
    private String name = "idea_039983";
 ...
 */
@Slf4j
public class Idea39983Service {
    private static final int IDEA_ID = 39983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39983Service() {
        this(new Idea39983Config());
    }

    public Idea39983Service(Idea39983Config config) {
        this.config = config != null ? config : new Idea39983Config();
