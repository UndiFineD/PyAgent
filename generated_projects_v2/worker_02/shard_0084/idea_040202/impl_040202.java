...
@Data
public class Idea40202Config {
    private String name = "idea_040202";
 ...
 */
@Slf4j
public class Idea40202Service {
    private static final int IDEA_ID = 40202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40202Service() {
        this(new Idea40202Config());
    }

    public Idea40202Service(Idea40202Config config) {
        this.config = config != null ? config : new Idea40202Config();
