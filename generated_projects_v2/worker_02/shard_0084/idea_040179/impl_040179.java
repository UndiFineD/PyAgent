...
@Data
public class Idea40179Config {
    private String name = "idea_040179";
 ...
 */
@Slf4j
public class Idea40179Service {
    private static final int IDEA_ID = 40179;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40179Service() {
        this(new Idea40179Config());
    }

    public Idea40179Service(Idea40179Config config) {
        this.config = config != null ? config : new Idea40179Config();
