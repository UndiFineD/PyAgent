...
@Data
public class Idea39906Config {
    private String name = "idea_039906";
 ...
 */
@Slf4j
public class Idea39906Service {
    private static final int IDEA_ID = 39906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39906Service() {
        this(new Idea39906Config());
    }

    public Idea39906Service(Idea39906Config config) {
        this.config = config != null ? config : new Idea39906Config();
