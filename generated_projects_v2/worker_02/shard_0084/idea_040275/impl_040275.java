...
@Data
public class Idea40275Config {
    private String name = "idea_040275";
 ...
 */
@Slf4j
public class Idea40275Service {
    private static final int IDEA_ID = 40275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40275Service() {
        this(new Idea40275Config());
    }

    public Idea40275Service(Idea40275Config config) {
        this.config = config != null ? config : new Idea40275Config();
