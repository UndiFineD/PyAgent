...
@Data
public class Idea39976Config {
    private String name = "idea_039976";
 ...
 */
@Slf4j
public class Idea39976Service {
    private static final int IDEA_ID = 39976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39976Service() {
        this(new Idea39976Config());
    }

    public Idea39976Service(Idea39976Config config) {
        this.config = config != null ? config : new Idea39976Config();
