...
@Data
public class Idea40338Config {
    private String name = "idea_040338";
 ...
 */
@Slf4j
public class Idea40338Service {
    private static final int IDEA_ID = 40338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40338Service() {
        this(new Idea40338Config());
    }

    public Idea40338Service(Idea40338Config config) {
        this.config = config != null ? config : new Idea40338Config();
