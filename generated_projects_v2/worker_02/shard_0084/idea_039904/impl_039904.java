...
@Data
public class Idea39904Config {
    private String name = "idea_039904";
 ...
 */
@Slf4j
public class Idea39904Service {
    private static final int IDEA_ID = 39904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39904Service() {
        this(new Idea39904Config());
    }

    public Idea39904Service(Idea39904Config config) {
        this.config = config != null ? config : new Idea39904Config();
