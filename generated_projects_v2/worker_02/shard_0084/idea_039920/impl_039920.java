...
@Data
public class Idea39920Config {
    private String name = "idea_039920";
 ...
 */
@Slf4j
public class Idea39920Service {
    private static final int IDEA_ID = 39920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39920Service() {
        this(new Idea39920Config());
    }

    public Idea39920Service(Idea39920Config config) {
        this.config = config != null ? config : new Idea39920Config();
