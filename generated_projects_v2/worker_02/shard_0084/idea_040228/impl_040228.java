...
@Data
public class Idea40228Config {
    private String name = "idea_040228";
 ...
 */
@Slf4j
public class Idea40228Service {
    private static final int IDEA_ID = 40228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40228Service() {
        this(new Idea40228Config());
    }

    public Idea40228Service(Idea40228Config config) {
        this.config = config != null ? config : new Idea40228Config();
