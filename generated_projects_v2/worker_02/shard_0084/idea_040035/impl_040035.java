...
@Data
public class Idea40035Config {
    private String name = "idea_040035";
 ...
 */
@Slf4j
public class Idea40035Service {
    private static final int IDEA_ID = 40035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40035Service() {
        this(new Idea40035Config());
    }

    public Idea40035Service(Idea40035Config config) {
        this.config = config != null ? config : new Idea40035Config();
