...
@Data
public class Idea40167Config {
    private String name = "idea_040167";
 ...
 */
@Slf4j
public class Idea40167Service {
    private static final int IDEA_ID = 40167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40167Service() {
        this(new Idea40167Config());
    }

    public Idea40167Service(Idea40167Config config) {
        this.config = config != null ? config : new Idea40167Config();
