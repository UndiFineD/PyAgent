...
@Data
public class Idea40081Config {
    private String name = "idea_040081";
 ...
 */
@Slf4j
public class Idea40081Service {
    private static final int IDEA_ID = 40081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40081Service() {
        this(new Idea40081Config());
    }

    public Idea40081Service(Idea40081Config config) {
        this.config = config != null ? config : new Idea40081Config();
