...
@Data
public class Idea39913Config {
    private String name = "idea_039913";
 ...
 */
@Slf4j
public class Idea39913Service {
    private static final int IDEA_ID = 39913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39913Service() {
        this(new Idea39913Config());
    }

    public Idea39913Service(Idea39913Config config) {
        this.config = config != null ? config : new Idea39913Config();
