...
@Data
public class Idea40181Config {
    private String name = "idea_040181";
 ...
 */
@Slf4j
public class Idea40181Service {
    private static final int IDEA_ID = 40181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40181Service() {
        this(new Idea40181Config());
    }

    public Idea40181Service(Idea40181Config config) {
        this.config = config != null ? config : new Idea40181Config();
