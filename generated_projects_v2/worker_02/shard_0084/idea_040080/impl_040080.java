...
@Data
public class Idea40080Config {
    private String name = "idea_040080";
 ...
 */
@Slf4j
public class Idea40080Service {
    private static final int IDEA_ID = 40080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40080Service() {
        this(new Idea40080Config());
    }

    public Idea40080Service(Idea40080Config config) {
        this.config = config != null ? config : new Idea40080Config();
