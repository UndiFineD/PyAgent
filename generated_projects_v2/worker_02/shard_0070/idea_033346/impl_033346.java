...
@Data
public class Idea33346Config {
    private String name = "idea_033346";
 ...
 */
@Slf4j
public class Idea33346Service {
    private static final int IDEA_ID = 33346;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33346Service() {
        this(new Idea33346Config());
    }

    public Idea33346Service(Idea33346Config config) {
        this.config = config != null ? config : new Idea33346Config();
