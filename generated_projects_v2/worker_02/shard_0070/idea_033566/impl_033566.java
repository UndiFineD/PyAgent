...
@Data
public class Idea33566Config {
    private String name = "idea_033566";
 ...
 */
@Slf4j
public class Idea33566Service {
    private static final int IDEA_ID = 33566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33566Service() {
        this(new Idea33566Config());
    }

    public Idea33566Service(Idea33566Config config) {
        this.config = config != null ? config : new Idea33566Config();
