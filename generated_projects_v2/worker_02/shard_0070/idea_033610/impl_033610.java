...
@Data
public class Idea33610Config {
    private String name = "idea_033610";
 ...
 */
@Slf4j
public class Idea33610Service {
    private static final int IDEA_ID = 33610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33610Service() {
        this(new Idea33610Config());
    }

    public Idea33610Service(Idea33610Config config) {
        this.config = config != null ? config : new Idea33610Config();
