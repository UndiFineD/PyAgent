...
@Data
public class Idea33650Config {
    private String name = "idea_033650";
 ...
 */
@Slf4j
public class Idea33650Service {
    private static final int IDEA_ID = 33650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33650Service() {
        this(new Idea33650Config());
    }

    public Idea33650Service(Idea33650Config config) {
        this.config = config != null ? config : new Idea33650Config();
