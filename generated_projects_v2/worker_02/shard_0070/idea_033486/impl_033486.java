...
@Data
public class Idea33486Config {
    private String name = "idea_033486";
 ...
 */
@Slf4j
public class Idea33486Service {
    private static final int IDEA_ID = 33486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33486Service() {
        this(new Idea33486Config());
    }

    public Idea33486Service(Idea33486Config config) {
        this.config = config != null ? config : new Idea33486Config();
