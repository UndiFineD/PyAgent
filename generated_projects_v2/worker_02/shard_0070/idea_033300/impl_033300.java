...
@Data
public class Idea33300Config {
    private String name = "idea_033300";
 ...
 */
@Slf4j
public class Idea33300Service {
    private static final int IDEA_ID = 33300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33300Service() {
        this(new Idea33300Config());
    }

    public Idea33300Service(Idea33300Config config) {
        this.config = config != null ? config : new Idea33300Config();
