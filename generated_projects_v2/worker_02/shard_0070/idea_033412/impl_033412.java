...
@Data
public class Idea33412Config {
    private String name = "idea_033412";
 ...
 */
@Slf4j
public class Idea33412Service {
    private static final int IDEA_ID = 33412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33412Service() {
        this(new Idea33412Config());
    }

    public Idea33412Service(Idea33412Config config) {
        this.config = config != null ? config : new Idea33412Config();
