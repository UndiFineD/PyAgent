...
@Data
public class Idea33298Config {
    private String name = "idea_033298";
 ...
 */
@Slf4j
public class Idea33298Service {
    private static final int IDEA_ID = 33298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33298Service() {
        this(new Idea33298Config());
    }

    public Idea33298Service(Idea33298Config config) {
        this.config = config != null ? config : new Idea33298Config();
