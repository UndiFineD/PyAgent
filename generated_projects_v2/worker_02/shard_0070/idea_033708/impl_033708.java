...
@Data
public class Idea33708Config {
    private String name = "idea_033708";
 ...
 */
@Slf4j
public class Idea33708Service {
    private static final int IDEA_ID = 33708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33708Service() {
        this(new Idea33708Config());
    }

    public Idea33708Service(Idea33708Config config) {
        this.config = config != null ? config : new Idea33708Config();
