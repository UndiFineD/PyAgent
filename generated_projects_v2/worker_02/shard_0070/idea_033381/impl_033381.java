...
@Data
public class Idea33381Config {
    private String name = "idea_033381";
 ...
 */
@Slf4j
public class Idea33381Service {
    private static final int IDEA_ID = 33381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33381Service() {
        this(new Idea33381Config());
    }

    public Idea33381Service(Idea33381Config config) {
        this.config = config != null ? config : new Idea33381Config();
