...
@Data
public class Idea33435Config {
    private String name = "idea_033435";
 ...
 */
@Slf4j
public class Idea33435Service {
    private static final int IDEA_ID = 33435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33435Service() {
        this(new Idea33435Config());
    }

    public Idea33435Service(Idea33435Config config) {
        this.config = config != null ? config : new Idea33435Config();
