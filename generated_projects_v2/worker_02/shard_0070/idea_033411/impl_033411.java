...
@Data
public class Idea33411Config {
    private String name = "idea_033411";
 ...
 */
@Slf4j
public class Idea33411Service {
    private static final int IDEA_ID = 33411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33411Service() {
        this(new Idea33411Config());
    }

    public Idea33411Service(Idea33411Config config) {
        this.config = config != null ? config : new Idea33411Config();
