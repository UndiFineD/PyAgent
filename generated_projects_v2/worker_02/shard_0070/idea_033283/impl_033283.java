...
@Data
public class Idea33283Config {
    private String name = "idea_033283";
 ...
 */
@Slf4j
public class Idea33283Service {
    private static final int IDEA_ID = 33283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33283Service() {
        this(new Idea33283Config());
    }

    public Idea33283Service(Idea33283Config config) {
        this.config = config != null ? config : new Idea33283Config();
