...
@Data
public class Idea33586Config {
    private String name = "idea_033586";
 ...
 */
@Slf4j
public class Idea33586Service {
    private static final int IDEA_ID = 33586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33586Service() {
        this(new Idea33586Config());
    }

    public Idea33586Service(Idea33586Config config) {
        this.config = config != null ? config : new Idea33586Config();
