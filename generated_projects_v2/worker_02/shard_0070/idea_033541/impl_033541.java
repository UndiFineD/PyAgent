...
@Data
public class Idea33541Config {
    private String name = "idea_033541";
 ...
 */
@Slf4j
public class Idea33541Service {
    private static final int IDEA_ID = 33541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33541Service() {
        this(new Idea33541Config());
    }

    public Idea33541Service(Idea33541Config config) {
        this.config = config != null ? config : new Idea33541Config();
