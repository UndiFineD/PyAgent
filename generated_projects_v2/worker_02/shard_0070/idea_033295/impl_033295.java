...
@Data
public class Idea33295Config {
    private String name = "idea_033295";
 ...
 */
@Slf4j
public class Idea33295Service {
    private static final int IDEA_ID = 33295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33295Service() {
        this(new Idea33295Config());
    }

    public Idea33295Service(Idea33295Config config) {
        this.config = config != null ? config : new Idea33295Config();
