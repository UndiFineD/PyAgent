...
@Data
public class Idea33380Config {
    private String name = "idea_033380";
 ...
 */
@Slf4j
public class Idea33380Service {
    private static final int IDEA_ID = 33380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33380Service() {
        this(new Idea33380Config());
    }

    public Idea33380Service(Idea33380Config config) {
        this.config = config != null ? config : new Idea33380Config();
