...
@Data
public class Idea33674Config {
    private String name = "idea_033674";
 ...
 */
@Slf4j
public class Idea33674Service {
    private static final int IDEA_ID = 33674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33674Service() {
        this(new Idea33674Config());
    }

    public Idea33674Service(Idea33674Config config) {
        this.config = config != null ? config : new Idea33674Config();
