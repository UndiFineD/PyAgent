...
@Data
public class Idea33407Config {
    private String name = "idea_033407";
 ...
 */
@Slf4j
public class Idea33407Service {
    private static final int IDEA_ID = 33407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33407Service() {
        this(new Idea33407Config());
    }

    public Idea33407Service(Idea33407Config config) {
        this.config = config != null ? config : new Idea33407Config();
