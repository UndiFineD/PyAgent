...
@Data
public class Idea33585Config {
    private String name = "idea_033585";
 ...
 */
@Slf4j
public class Idea33585Service {
    private static final int IDEA_ID = 33585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33585Service() {
        this(new Idea33585Config());
    }

    public Idea33585Service(Idea33585Config config) {
        this.config = config != null ? config : new Idea33585Config();
