...
@Data
public class Idea33458Config {
    private String name = "idea_033458";
 ...
 */
@Slf4j
public class Idea33458Service {
    private static final int IDEA_ID = 33458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33458Service() {
        this(new Idea33458Config());
    }

    public Idea33458Service(Idea33458Config config) {
        this.config = config != null ? config : new Idea33458Config();
