...
@Data
public class Idea33678Config {
    private String name = "idea_033678";
 ...
 */
@Slf4j
public class Idea33678Service {
    private static final int IDEA_ID = 33678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33678Service() {
        this(new Idea33678Config());
    }

    public Idea33678Service(Idea33678Config config) {
        this.config = config != null ? config : new Idea33678Config();
