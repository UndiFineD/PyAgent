...
@Data
public class Idea33640Config {
    private String name = "idea_033640";
 ...
 */
@Slf4j
public class Idea33640Service {
    private static final int IDEA_ID = 33640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33640Service() {
        this(new Idea33640Config());
    }

    public Idea33640Service(Idea33640Config config) {
        this.config = config != null ? config : new Idea33640Config();
