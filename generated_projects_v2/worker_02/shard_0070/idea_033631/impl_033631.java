...
@Data
public class Idea33631Config {
    private String name = "idea_033631";
 ...
 */
@Slf4j
public class Idea33631Service {
    private static final int IDEA_ID = 33631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33631Service() {
        this(new Idea33631Config());
    }

    public Idea33631Service(Idea33631Config config) {
        this.config = config != null ? config : new Idea33631Config();
