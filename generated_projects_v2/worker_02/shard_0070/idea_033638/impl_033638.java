...
@Data
public class Idea33638Config {
    private String name = "idea_033638";
 ...
 */
@Slf4j
public class Idea33638Service {
    private static final int IDEA_ID = 33638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33638Service() {
        this(new Idea33638Config());
    }

    public Idea33638Service(Idea33638Config config) {
        this.config = config != null ? config : new Idea33638Config();
