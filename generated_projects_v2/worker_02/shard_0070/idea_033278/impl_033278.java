...
@Data
public class Idea33278Config {
    private String name = "idea_033278";
 ...
 */
@Slf4j
public class Idea33278Service {
    private static final int IDEA_ID = 33278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33278Service() {
        this(new Idea33278Config());
    }

    public Idea33278Service(Idea33278Config config) {
        this.config = config != null ? config : new Idea33278Config();
