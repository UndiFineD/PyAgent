...
@Data
public class Idea33695Config {
    private String name = "idea_033695";
 ...
 */
@Slf4j
public class Idea33695Service {
    private static final int IDEA_ID = 33695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33695Service() {
        this(new Idea33695Config());
    }

    public Idea33695Service(Idea33695Config config) {
        this.config = config != null ? config : new Idea33695Config();
