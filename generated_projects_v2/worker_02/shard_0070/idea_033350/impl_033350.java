...
@Data
public class Idea33350Config {
    private String name = "idea_033350";
 ...
 */
@Slf4j
public class Idea33350Service {
    private static final int IDEA_ID = 33350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33350Service() {
        this(new Idea33350Config());
    }

    public Idea33350Service(Idea33350Config config) {
        this.config = config != null ? config : new Idea33350Config();
