...
@Data
public class Idea33484Config {
    private String name = "idea_033484";
 ...
 */
@Slf4j
public class Idea33484Service {
    private static final int IDEA_ID = 33484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33484Service() {
        this(new Idea33484Config());
    }

    public Idea33484Service(Idea33484Config config) {
        this.config = config != null ? config : new Idea33484Config();
