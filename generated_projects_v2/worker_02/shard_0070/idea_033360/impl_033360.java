...
@Data
public class Idea33360Config {
    private String name = "idea_033360";
 ...
 */
@Slf4j
public class Idea33360Service {
    private static final int IDEA_ID = 33360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33360Service() {
        this(new Idea33360Config());
    }

    public Idea33360Service(Idea33360Config config) {
        this.config = config != null ? config : new Idea33360Config();
