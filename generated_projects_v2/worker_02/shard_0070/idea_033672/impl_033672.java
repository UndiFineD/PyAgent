...
@Data
public class Idea33672Config {
    private String name = "idea_033672";
 ...
 */
@Slf4j
public class Idea33672Service {
    private static final int IDEA_ID = 33672;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33672Service() {
        this(new Idea33672Config());
    }

    public Idea33672Service(Idea33672Config config) {
        this.config = config != null ? config : new Idea33672Config();
