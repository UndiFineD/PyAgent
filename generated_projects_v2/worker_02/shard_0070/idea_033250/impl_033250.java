...
@Data
public class Idea33250Config {
    private String name = "idea_033250";
 ...
 */
@Slf4j
public class Idea33250Service {
    private static final int IDEA_ID = 33250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33250Service() {
        this(new Idea33250Config());
    }

    public Idea33250Service(Idea33250Config config) {
        this.config = config != null ? config : new Idea33250Config();
