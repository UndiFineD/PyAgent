...
@Data
public class Idea33265Config {
    private String name = "idea_033265";
 ...
 */
@Slf4j
public class Idea33265Service {
    private static final int IDEA_ID = 33265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33265Service() {
        this(new Idea33265Config());
    }

    public Idea33265Service(Idea33265Config config) {
        this.config = config != null ? config : new Idea33265Config();
