...
@Data
public class Idea33499Config {
    private String name = "idea_033499";
 ...
 */
@Slf4j
public class Idea33499Service {
    private static final int IDEA_ID = 33499;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33499Service() {
        this(new Idea33499Config());
    }

    public Idea33499Service(Idea33499Config config) {
        this.config = config != null ? config : new Idea33499Config();
