...
@Data
public class Idea33699Config {
    private String name = "idea_033699";
 ...
 */
@Slf4j
public class Idea33699Service {
    private static final int IDEA_ID = 33699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33699Service() {
        this(new Idea33699Config());
    }

    public Idea33699Service(Idea33699Config config) {
        this.config = config != null ? config : new Idea33699Config();
