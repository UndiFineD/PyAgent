...
@Data
public class Idea33595Config {
    private String name = "idea_033595";
 ...
 */
@Slf4j
public class Idea33595Service {
    private static final int IDEA_ID = 33595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33595Service() {
        this(new Idea33595Config());
    }

    public Idea33595Service(Idea33595Config config) {
        this.config = config != null ? config : new Idea33595Config();
