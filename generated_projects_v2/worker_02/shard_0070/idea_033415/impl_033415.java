...
@Data
public class Idea33415Config {
    private String name = "idea_033415";
 ...
 */
@Slf4j
public class Idea33415Service {
    private static final int IDEA_ID = 33415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33415Service() {
        this(new Idea33415Config());
    }

    public Idea33415Service(Idea33415Config config) {
        this.config = config != null ? config : new Idea33415Config();
