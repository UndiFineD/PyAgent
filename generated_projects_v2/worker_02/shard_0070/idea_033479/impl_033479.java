...
@Data
public class Idea33479Config {
    private String name = "idea_033479";
 ...
 */
@Slf4j
public class Idea33479Service {
    private static final int IDEA_ID = 33479;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33479Service() {
        this(new Idea33479Config());
    }

    public Idea33479Service(Idea33479Config config) {
        this.config = config != null ? config : new Idea33479Config();
