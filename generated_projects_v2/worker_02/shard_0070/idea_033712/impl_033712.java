...
@Data
public class Idea33712Config {
    private String name = "idea_033712";
 ...
 */
@Slf4j
public class Idea33712Service {
    private static final int IDEA_ID = 33712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33712Service() {
        this(new Idea33712Config());
    }

    public Idea33712Service(Idea33712Config config) {
        this.config = config != null ? config : new Idea33712Config();
