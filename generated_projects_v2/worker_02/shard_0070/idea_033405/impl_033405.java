...
@Data
public class Idea33405Config {
    private String name = "idea_033405";
 ...
 */
@Slf4j
public class Idea33405Service {
    private static final int IDEA_ID = 33405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33405Service() {
        this(new Idea33405Config());
    }

    public Idea33405Service(Idea33405Config config) {
        this.config = config != null ? config : new Idea33405Config();
