...
@Data
public class Idea33652Config {
    private String name = "idea_033652";
 ...
 */
@Slf4j
public class Idea33652Service {
    private static final int IDEA_ID = 33652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33652Service() {
        this(new Idea33652Config());
    }

    public Idea33652Service(Idea33652Config config) {
        this.config = config != null ? config : new Idea33652Config();
