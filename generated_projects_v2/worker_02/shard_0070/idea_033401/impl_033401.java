...
@Data
public class Idea33401Config {
    private String name = "idea_033401";
 ...
 */
@Slf4j
public class Idea33401Service {
    private static final int IDEA_ID = 33401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33401Service() {
        this(new Idea33401Config());
    }

    public Idea33401Service(Idea33401Config config) {
        this.config = config != null ? config : new Idea33401Config();
