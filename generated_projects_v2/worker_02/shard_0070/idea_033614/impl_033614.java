...
@Data
public class Idea33614Config {
    private String name = "idea_033614";
 ...
 */
@Slf4j
public class Idea33614Service {
    private static final int IDEA_ID = 33614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33614Service() {
        this(new Idea33614Config());
    }

    public Idea33614Service(Idea33614Config config) {
        this.config = config != null ? config : new Idea33614Config();
