...
@Data
public class Idea33423Config {
    private String name = "idea_033423";
 ...
 */
@Slf4j
public class Idea33423Service {
    private static final int IDEA_ID = 33423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33423Service() {
        this(new Idea33423Config());
    }

    public Idea33423Service(Idea33423Config config) {
        this.config = config != null ? config : new Idea33423Config();
