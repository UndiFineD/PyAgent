...
@Data
public class Idea33635Config {
    private String name = "idea_033635";
 ...
 */
@Slf4j
public class Idea33635Service {
    private static final int IDEA_ID = 33635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33635Service() {
        this(new Idea33635Config());
    }

    public Idea33635Service(Idea33635Config config) {
        this.config = config != null ? config : new Idea33635Config();
