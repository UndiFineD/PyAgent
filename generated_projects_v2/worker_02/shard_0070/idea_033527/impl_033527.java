...
@Data
public class Idea33527Config {
    private String name = "idea_033527";
 ...
 */
@Slf4j
public class Idea33527Service {
    private static final int IDEA_ID = 33527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33527Service() {
        this(new Idea33527Config());
    }

    public Idea33527Service(Idea33527Config config) {
        this.config = config != null ? config : new Idea33527Config();
