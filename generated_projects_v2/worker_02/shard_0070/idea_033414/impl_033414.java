...
@Data
public class Idea33414Config {
    private String name = "idea_033414";
 ...
 */
@Slf4j
public class Idea33414Service {
    private static final int IDEA_ID = 33414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33414Service() {
        this(new Idea33414Config());
    }

    public Idea33414Service(Idea33414Config config) {
        this.config = config != null ? config : new Idea33414Config();
