...
@Data
public class Idea33383Config {
    private String name = "idea_033383";
 ...
 */
@Slf4j
public class Idea33383Service {
    private static final int IDEA_ID = 33383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33383Service() {
        this(new Idea33383Config());
    }

    public Idea33383Service(Idea33383Config config) {
        this.config = config != null ? config : new Idea33383Config();
