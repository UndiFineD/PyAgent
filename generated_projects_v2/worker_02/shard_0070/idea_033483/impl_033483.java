...
@Data
public class Idea33483Config {
    private String name = "idea_033483";
 ...
 */
@Slf4j
public class Idea33483Service {
    private static final int IDEA_ID = 33483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33483Service() {
        this(new Idea33483Config());
    }

    public Idea33483Service(Idea33483Config config) {
        this.config = config != null ? config : new Idea33483Config();
