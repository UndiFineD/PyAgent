...
@Data
public class Idea33359Config {
    private String name = "idea_033359";
 ...
 */
@Slf4j
public class Idea33359Service {
    private static final int IDEA_ID = 33359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33359Service() {
        this(new Idea33359Config());
    }

    public Idea33359Service(Idea33359Config config) {
        this.config = config != null ? config : new Idea33359Config();
