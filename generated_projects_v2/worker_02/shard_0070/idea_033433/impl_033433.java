...
@Data
public class Idea33433Config {
    private String name = "idea_033433";
 ...
 */
@Slf4j
public class Idea33433Service {
    private static final int IDEA_ID = 33433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33433Service() {
        this(new Idea33433Config());
    }

    public Idea33433Service(Idea33433Config config) {
        this.config = config != null ? config : new Idea33433Config();
