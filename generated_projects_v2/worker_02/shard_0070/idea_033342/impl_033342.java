...
@Data
public class Idea33342Config {
    private String name = "idea_033342";
 ...
 */
@Slf4j
public class Idea33342Service {
    private static final int IDEA_ID = 33342;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33342Service() {
        this(new Idea33342Config());
    }

    public Idea33342Service(Idea33342Config config) {
        this.config = config != null ? config : new Idea33342Config();
