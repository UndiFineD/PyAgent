...
@Data
public class Idea33466Config {
    private String name = "idea_033466";
 ...
 */
@Slf4j
public class Idea33466Service {
    private static final int IDEA_ID = 33466;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33466Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33466Service() {
        this(new Idea33466Config());
    }

    public Idea33466Service(Idea33466Config config) {
        this.config = config != null ? config : new Idea33466Config();
