...
@Data
public class Idea33417Config {
    private String name = "idea_033417";
 ...
 */
@Slf4j
public class Idea33417Service {
    private static final int IDEA_ID = 33417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33417Service() {
        this(new Idea33417Config());
    }

    public Idea33417Service(Idea33417Config config) {
        this.config = config != null ? config : new Idea33417Config();
