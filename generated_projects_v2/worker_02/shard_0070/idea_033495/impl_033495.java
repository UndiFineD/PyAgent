...
@Data
public class Idea33495Config {
    private String name = "idea_033495";
 ...
 */
@Slf4j
public class Idea33495Service {
    private static final int IDEA_ID = 33495;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33495Service() {
        this(new Idea33495Config());
    }

    public Idea33495Service(Idea33495Config config) {
        this.config = config != null ? config : new Idea33495Config();
