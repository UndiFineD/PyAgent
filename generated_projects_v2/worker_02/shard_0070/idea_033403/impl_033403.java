...
@Data
public class Idea33403Config {
    private String name = "idea_033403";
 ...
 */
@Slf4j
public class Idea33403Service {
    private static final int IDEA_ID = 33403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33403Service() {
        this(new Idea33403Config());
    }

    public Idea33403Service(Idea33403Config config) {
        this.config = config != null ? config : new Idea33403Config();
