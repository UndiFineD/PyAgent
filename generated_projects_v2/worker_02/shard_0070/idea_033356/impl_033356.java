...
@Data
public class Idea33356Config {
    private String name = "idea_033356";
 ...
 */
@Slf4j
public class Idea33356Service {
    private static final int IDEA_ID = 33356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33356Service() {
        this(new Idea33356Config());
    }

    public Idea33356Service(Idea33356Config config) {
        this.config = config != null ? config : new Idea33356Config();
