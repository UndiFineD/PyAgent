...
@Data
public class Idea33369Config {
    private String name = "idea_033369";
 ...
 */
@Slf4j
public class Idea33369Service {
    private static final int IDEA_ID = 33369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33369Service() {
        this(new Idea33369Config());
    }

    public Idea33369Service(Idea33369Config config) {
        this.config = config != null ? config : new Idea33369Config();
