...
@Data
public class Idea33546Config {
    private String name = "idea_033546";
 ...
 */
@Slf4j
public class Idea33546Service {
    private static final int IDEA_ID = 33546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33546Service() {
        this(new Idea33546Config());
    }

    public Idea33546Service(Idea33546Config config) {
        this.config = config != null ? config : new Idea33546Config();
