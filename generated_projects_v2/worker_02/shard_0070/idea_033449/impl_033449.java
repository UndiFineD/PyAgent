...
@Data
public class Idea33449Config {
    private String name = "idea_033449";
 ...
 */
@Slf4j
public class Idea33449Service {
    private static final int IDEA_ID = 33449;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33449Service() {
        this(new Idea33449Config());
    }

    public Idea33449Service(Idea33449Config config) {
        this.config = config != null ? config : new Idea33449Config();
