...
@Data
public class Idea33679Config {
    private String name = "idea_033679";
 ...
 */
@Slf4j
public class Idea33679Service {
    private static final int IDEA_ID = 33679;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33679Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33679Service() {
        this(new Idea33679Config());
    }

    public Idea33679Service(Idea33679Config config) {
        this.config = config != null ? config : new Idea33679Config();
