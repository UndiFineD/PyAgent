...
@Data
public class Idea33626Config {
    private String name = "idea_033626";
 ...
 */
@Slf4j
public class Idea33626Service {
    private static final int IDEA_ID = 33626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33626Service() {
        this(new Idea33626Config());
    }

    public Idea33626Service(Idea33626Config config) {
        this.config = config != null ? config : new Idea33626Config();
