...
@Data
public class Idea33537Config {
    private String name = "idea_033537";
 ...
 */
@Slf4j
public class Idea33537Service {
    private static final int IDEA_ID = 33537;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33537Service() {
        this(new Idea33537Config());
    }

    public Idea33537Service(Idea33537Config config) {
        this.config = config != null ? config : new Idea33537Config();
