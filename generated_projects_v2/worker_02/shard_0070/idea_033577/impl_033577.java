...
@Data
public class Idea33577Config {
    private String name = "idea_033577";
 ...
 */
@Slf4j
public class Idea33577Service {
    private static final int IDEA_ID = 33577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33577Service() {
        this(new Idea33577Config());
    }

    public Idea33577Service(Idea33577Config config) {
        this.config = config != null ? config : new Idea33577Config();
