...
@Data
public class Idea33581Config {
    private String name = "idea_033581";
 ...
 */
@Slf4j
public class Idea33581Service {
    private static final int IDEA_ID = 33581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33581Service() {
        this(new Idea33581Config());
    }

    public Idea33581Service(Idea33581Config config) {
        this.config = config != null ? config : new Idea33581Config();
