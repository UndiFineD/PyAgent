...
@Data
public class Idea33261Config {
    private String name = "idea_033261";
 ...
 */
@Slf4j
public class Idea33261Service {
    private static final int IDEA_ID = 33261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33261Service() {
        this(new Idea33261Config());
    }

    public Idea33261Service(Idea33261Config config) {
        this.config = config != null ? config : new Idea33261Config();
