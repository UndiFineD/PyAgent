...
@Data
public class Idea33669Config {
    private String name = "idea_033669";
 ...
 */
@Slf4j
public class Idea33669Service {
    private static final int IDEA_ID = 33669;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33669Service() {
        this(new Idea33669Config());
    }

    public Idea33669Service(Idea33669Config config) {
        this.config = config != null ? config : new Idea33669Config();
