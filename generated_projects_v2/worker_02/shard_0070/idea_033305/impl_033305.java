...
@Data
public class Idea33305Config {
    private String name = "idea_033305";
 ...
 */
@Slf4j
public class Idea33305Service {
    private static final int IDEA_ID = 33305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33305Service() {
        this(new Idea33305Config());
    }

    public Idea33305Service(Idea33305Config config) {
        this.config = config != null ? config : new Idea33305Config();
