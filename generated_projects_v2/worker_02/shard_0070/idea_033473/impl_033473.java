...
@Data
public class Idea33473Config {
    private String name = "idea_033473";
 ...
 */
@Slf4j
public class Idea33473Service {
    private static final int IDEA_ID = 33473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33473Service() {
        this(new Idea33473Config());
    }

    public Idea33473Service(Idea33473Config config) {
        this.config = config != null ? config : new Idea33473Config();
