...
@Data
public class Idea33625Config {
    private String name = "idea_033625";
 ...
 */
@Slf4j
public class Idea33625Service {
    private static final int IDEA_ID = 33625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33625Service() {
        this(new Idea33625Config());
    }

    public Idea33625Service(Idea33625Config config) {
        this.config = config != null ? config : new Idea33625Config();
