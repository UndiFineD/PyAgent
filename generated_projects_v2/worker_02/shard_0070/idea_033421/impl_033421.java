...
@Data
public class Idea33421Config {
    private String name = "idea_033421";
 ...
 */
@Slf4j
public class Idea33421Service {
    private static final int IDEA_ID = 33421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33421Service() {
        this(new Idea33421Config());
    }

    public Idea33421Service(Idea33421Config config) {
        this.config = config != null ? config : new Idea33421Config();
