...
@Data
public class Idea33512Config {
    private String name = "idea_033512";
 ...
 */
@Slf4j
public class Idea33512Service {
    private static final int IDEA_ID = 33512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33512Service() {
        this(new Idea33512Config());
    }

    public Idea33512Service(Idea33512Config config) {
        this.config = config != null ? config : new Idea33512Config();
