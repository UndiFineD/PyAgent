...
@Data
public class Idea33416Config {
    private String name = "idea_033416";
 ...
 */
@Slf4j
public class Idea33416Service {
    private static final int IDEA_ID = 33416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33416Service() {
        this(new Idea33416Config());
    }

    public Idea33416Service(Idea33416Config config) {
        this.config = config != null ? config : new Idea33416Config();
