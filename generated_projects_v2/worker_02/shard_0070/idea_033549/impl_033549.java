...
@Data
public class Idea33549Config {
    private String name = "idea_033549";
 ...
 */
@Slf4j
public class Idea33549Service {
    private static final int IDEA_ID = 33549;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33549Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33549Service() {
        this(new Idea33549Config());
    }

    public Idea33549Service(Idea33549Config config) {
        this.config = config != null ? config : new Idea33549Config();
