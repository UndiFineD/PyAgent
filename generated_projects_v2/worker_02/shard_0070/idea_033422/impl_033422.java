...
@Data
public class Idea33422Config {
    private String name = "idea_033422";
 ...
 */
@Slf4j
public class Idea33422Service {
    private static final int IDEA_ID = 33422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33422Service() {
        this(new Idea33422Config());
    }

    public Idea33422Service(Idea33422Config config) {
        this.config = config != null ? config : new Idea33422Config();
