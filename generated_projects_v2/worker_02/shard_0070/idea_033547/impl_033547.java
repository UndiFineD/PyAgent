...
@Data
public class Idea33547Config {
    private String name = "idea_033547";
 ...
 */
@Slf4j
public class Idea33547Service {
    private static final int IDEA_ID = 33547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33547Service() {
        this(new Idea33547Config());
    }

    public Idea33547Service(Idea33547Config config) {
        this.config = config != null ? config : new Idea33547Config();
