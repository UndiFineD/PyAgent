...
@Data
public class Idea33628Config {
    private String name = "idea_033628";
 ...
 */
@Slf4j
public class Idea33628Service {
    private static final int IDEA_ID = 33628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33628Service() {
        this(new Idea33628Config());
    }

    public Idea33628Service(Idea33628Config config) {
        this.config = config != null ? config : new Idea33628Config();
