...
@Data
public class Idea33526Config {
    private String name = "idea_033526";
 ...
 */
@Slf4j
public class Idea33526Service {
    private static final int IDEA_ID = 33526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33526Service() {
        this(new Idea33526Config());
    }

    public Idea33526Service(Idea33526Config config) {
        this.config = config != null ? config : new Idea33526Config();
