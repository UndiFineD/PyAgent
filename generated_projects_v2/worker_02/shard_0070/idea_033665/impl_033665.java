...
@Data
public class Idea33665Config {
    private String name = "idea_033665";
 ...
 */
@Slf4j
public class Idea33665Service {
    private static final int IDEA_ID = 33665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33665Service() {
        this(new Idea33665Config());
    }

    public Idea33665Service(Idea33665Config config) {
        this.config = config != null ? config : new Idea33665Config();
