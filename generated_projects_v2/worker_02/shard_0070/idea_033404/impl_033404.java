...
@Data
public class Idea33404Config {
    private String name = "idea_033404";
 ...
 */
@Slf4j
public class Idea33404Service {
    private static final int IDEA_ID = 33404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33404Service() {
        this(new Idea33404Config());
    }

    public Idea33404Service(Idea33404Config config) {
        this.config = config != null ? config : new Idea33404Config();
