...
@Data
public class Idea33329Config {
    private String name = "idea_033329";
 ...
 */
@Slf4j
public class Idea33329Service {
    private static final int IDEA_ID = 33329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33329Service() {
        this(new Idea33329Config());
    }

    public Idea33329Service(Idea33329Config config) {
        this.config = config != null ? config : new Idea33329Config();
