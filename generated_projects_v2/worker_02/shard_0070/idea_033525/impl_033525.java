...
@Data
public class Idea33525Config {
    private String name = "idea_033525";
 ...
 */
@Slf4j
public class Idea33525Service {
    private static final int IDEA_ID = 33525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33525Service() {
        this(new Idea33525Config());
    }

    public Idea33525Service(Idea33525Config config) {
        this.config = config != null ? config : new Idea33525Config();
