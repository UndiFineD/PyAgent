...
@Data
public class Idea33573Config {
    private String name = "idea_033573";
 ...
 */
@Slf4j
public class Idea33573Service {
    private static final int IDEA_ID = 33573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33573Service() {
        this(new Idea33573Config());
    }

    public Idea33573Service(Idea33573Config config) {
        this.config = config != null ? config : new Idea33573Config();
