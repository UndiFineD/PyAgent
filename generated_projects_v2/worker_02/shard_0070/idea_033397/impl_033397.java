...
@Data
public class Idea33397Config {
    private String name = "idea_033397";
 ...
 */
@Slf4j
public class Idea33397Service {
    private static final int IDEA_ID = 33397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33397Service() {
        this(new Idea33397Config());
    }

    public Idea33397Service(Idea33397Config config) {
        this.config = config != null ? config : new Idea33397Config();
