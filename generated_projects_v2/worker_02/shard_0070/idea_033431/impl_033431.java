...
@Data
public class Idea33431Config {
    private String name = "idea_033431";
 ...
 */
@Slf4j
public class Idea33431Service {
    private static final int IDEA_ID = 33431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33431Service() {
        this(new Idea33431Config());
    }

    public Idea33431Service(Idea33431Config config) {
        this.config = config != null ? config : new Idea33431Config();
