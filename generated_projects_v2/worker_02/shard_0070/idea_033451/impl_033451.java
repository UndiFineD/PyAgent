...
@Data
public class Idea33451Config {
    private String name = "idea_033451";
 ...
 */
@Slf4j
public class Idea33451Service {
    private static final int IDEA_ID = 33451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33451Service() {
        this(new Idea33451Config());
    }

    public Idea33451Service(Idea33451Config config) {
        this.config = config != null ? config : new Idea33451Config();
