...
@Data
public class Idea33509Config {
    private String name = "idea_033509";
 ...
 */
@Slf4j
public class Idea33509Service {
    private static final int IDEA_ID = 33509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33509Service() {
        this(new Idea33509Config());
    }

    public Idea33509Service(Idea33509Config config) {
        this.config = config != null ? config : new Idea33509Config();
