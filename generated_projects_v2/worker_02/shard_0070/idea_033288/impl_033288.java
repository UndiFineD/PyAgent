...
@Data
public class Idea33288Config {
    private String name = "idea_033288";
 ...
 */
@Slf4j
public class Idea33288Service {
    private static final int IDEA_ID = 33288;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33288Service() {
        this(new Idea33288Config());
    }

    public Idea33288Service(Idea33288Config config) {
        this.config = config != null ? config : new Idea33288Config();
