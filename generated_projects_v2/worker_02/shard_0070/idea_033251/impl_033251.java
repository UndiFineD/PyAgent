...
@Data
public class Idea33251Config {
    private String name = "idea_033251";
 ...
 */
@Slf4j
public class Idea33251Service {
    private static final int IDEA_ID = 33251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33251Service() {
        this(new Idea33251Config());
    }

    public Idea33251Service(Idea33251Config config) {
        this.config = config != null ? config : new Idea33251Config();
