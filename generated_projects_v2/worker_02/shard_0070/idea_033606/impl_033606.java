...
@Data
public class Idea33606Config {
    private String name = "idea_033606";
 ...
 */
@Slf4j
public class Idea33606Service {
    private static final int IDEA_ID = 33606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33606Service() {
        this(new Idea33606Config());
    }

    public Idea33606Service(Idea33606Config config) {
        this.config = config != null ? config : new Idea33606Config();
