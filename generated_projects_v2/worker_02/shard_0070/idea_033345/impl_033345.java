...
@Data
public class Idea33345Config {
    private String name = "idea_033345";
 ...
 */
@Slf4j
public class Idea33345Service {
    private static final int IDEA_ID = 33345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33345Service() {
        this(new Idea33345Config());
    }

    public Idea33345Service(Idea33345Config config) {
        this.config = config != null ? config : new Idea33345Config();
