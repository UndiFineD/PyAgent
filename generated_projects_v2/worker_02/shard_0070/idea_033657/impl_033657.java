...
@Data
public class Idea33657Config {
    private String name = "idea_033657";
 ...
 */
@Slf4j
public class Idea33657Service {
    private static final int IDEA_ID = 33657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33657Service() {
        this(new Idea33657Config());
    }

    public Idea33657Service(Idea33657Config config) {
        this.config = config != null ? config : new Idea33657Config();
