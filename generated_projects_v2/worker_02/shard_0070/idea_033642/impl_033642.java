...
@Data
public class Idea33642Config {
    private String name = "idea_033642";
 ...
 */
@Slf4j
public class Idea33642Service {
    private static final int IDEA_ID = 33642;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33642Service() {
        this(new Idea33642Config());
    }

    public Idea33642Service(Idea33642Config config) {
        this.config = config != null ? config : new Idea33642Config();
