...
@Data
public class Idea33424Config {
    private String name = "idea_033424";
 ...
 */
@Slf4j
public class Idea33424Service {
    private static final int IDEA_ID = 33424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33424Service() {
        this(new Idea33424Config());
    }

    public Idea33424Service(Idea33424Config config) {
        this.config = config != null ? config : new Idea33424Config();
