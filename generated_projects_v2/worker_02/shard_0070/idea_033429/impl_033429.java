...
@Data
public class Idea33429Config {
    private String name = "idea_033429";
 ...
 */
@Slf4j
public class Idea33429Service {
    private static final int IDEA_ID = 33429;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33429Service() {
        this(new Idea33429Config());
    }

    public Idea33429Service(Idea33429Config config) {
        this.config = config != null ? config : new Idea33429Config();
