...
@Data
public class Idea33379Config {
    private String name = "idea_033379";
 ...
 */
@Slf4j
public class Idea33379Service {
    private static final int IDEA_ID = 33379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33379Service() {
        this(new Idea33379Config());
    }

    public Idea33379Service(Idea33379Config config) {
        this.config = config != null ? config : new Idea33379Config();
