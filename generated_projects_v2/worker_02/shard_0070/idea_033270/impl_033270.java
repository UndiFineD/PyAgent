...
@Data
public class Idea33270Config {
    private String name = "idea_033270";
 ...
 */
@Slf4j
public class Idea33270Service {
    private static final int IDEA_ID = 33270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33270Service() {
        this(new Idea33270Config());
    }

    public Idea33270Service(Idea33270Config config) {
        this.config = config != null ? config : new Idea33270Config();
