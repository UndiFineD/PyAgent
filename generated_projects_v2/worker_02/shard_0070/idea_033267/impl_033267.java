...
@Data
public class Idea33267Config {
    private String name = "idea_033267";
 ...
 */
@Slf4j
public class Idea33267Service {
    private static final int IDEA_ID = 33267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33267Service() {
        this(new Idea33267Config());
    }

    public Idea33267Service(Idea33267Config config) {
        this.config = config != null ? config : new Idea33267Config();
