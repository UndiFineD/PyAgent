...
@Data
public class Idea33618Config {
    private String name = "idea_033618";
 ...
 */
@Slf4j
public class Idea33618Service {
    private static final int IDEA_ID = 33618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33618Service() {
        this(new Idea33618Config());
    }

    public Idea33618Service(Idea33618Config config) {
        this.config = config != null ? config : new Idea33618Config();
