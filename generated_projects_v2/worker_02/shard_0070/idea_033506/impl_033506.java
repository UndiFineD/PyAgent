...
@Data
public class Idea33506Config {
    private String name = "idea_033506";
 ...
 */
@Slf4j
public class Idea33506Service {
    private static final int IDEA_ID = 33506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33506Service() {
        this(new Idea33506Config());
    }

    public Idea33506Service(Idea33506Config config) {
        this.config = config != null ? config : new Idea33506Config();
