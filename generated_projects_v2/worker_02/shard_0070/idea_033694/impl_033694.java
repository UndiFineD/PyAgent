...
@Data
public class Idea33694Config {
    private String name = "idea_033694";
 ...
 */
@Slf4j
public class Idea33694Service {
    private static final int IDEA_ID = 33694;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33694Service() {
        this(new Idea33694Config());
    }

    public Idea33694Service(Idea33694Config config) {
        this.config = config != null ? config : new Idea33694Config();
