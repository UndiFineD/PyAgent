...
@Data
public class Idea33634Config {
    private String name = "idea_033634";
 ...
 */
@Slf4j
public class Idea33634Service {
    private static final int IDEA_ID = 33634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33634Service() {
        this(new Idea33634Config());
    }

    public Idea33634Service(Idea33634Config config) {
        this.config = config != null ? config : new Idea33634Config();
