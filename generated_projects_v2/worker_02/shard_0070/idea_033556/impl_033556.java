...
@Data
public class Idea33556Config {
    private String name = "idea_033556";
 ...
 */
@Slf4j
public class Idea33556Service {
    private static final int IDEA_ID = 33556;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33556Service() {
        this(new Idea33556Config());
    }

    public Idea33556Service(Idea33556Config config) {
        this.config = config != null ? config : new Idea33556Config();
