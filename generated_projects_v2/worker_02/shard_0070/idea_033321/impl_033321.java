...
@Data
public class Idea33321Config {
    private String name = "idea_033321";
 ...
 */
@Slf4j
public class Idea33321Service {
    private static final int IDEA_ID = 33321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33321Service() {
        this(new Idea33321Config());
    }

    public Idea33321Service(Idea33321Config config) {
        this.config = config != null ? config : new Idea33321Config();
