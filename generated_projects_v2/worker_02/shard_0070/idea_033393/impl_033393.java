...
@Data
public class Idea33393Config {
    private String name = "idea_033393";
 ...
 */
@Slf4j
public class Idea33393Service {
    private static final int IDEA_ID = 33393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33393Service() {
        this(new Idea33393Config());
    }

    public Idea33393Service(Idea33393Config config) {
        this.config = config != null ? config : new Idea33393Config();
