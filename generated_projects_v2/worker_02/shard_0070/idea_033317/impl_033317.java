...
@Data
public class Idea33317Config {
    private String name = "idea_033317";
 ...
 */
@Slf4j
public class Idea33317Service {
    private static final int IDEA_ID = 33317;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33317Service() {
        this(new Idea33317Config());
    }

    public Idea33317Service(Idea33317Config config) {
        this.config = config != null ? config : new Idea33317Config();
