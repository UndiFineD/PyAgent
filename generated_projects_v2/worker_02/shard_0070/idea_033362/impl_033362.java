...
@Data
public class Idea33362Config {
    private String name = "idea_033362";
 ...
 */
@Slf4j
public class Idea33362Service {
    private static final int IDEA_ID = 33362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33362Service() {
        this(new Idea33362Config());
    }

    public Idea33362Service(Idea33362Config config) {
        this.config = config != null ? config : new Idea33362Config();
