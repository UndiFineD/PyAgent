...
@Data
public class Idea33384Config {
    private String name = "idea_033384";
 ...
 */
@Slf4j
public class Idea33384Service {
    private static final int IDEA_ID = 33384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33384Service() {
        this(new Idea33384Config());
    }

    public Idea33384Service(Idea33384Config config) {
        this.config = config != null ? config : new Idea33384Config();
