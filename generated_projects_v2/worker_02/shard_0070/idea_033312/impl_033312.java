...
@Data
public class Idea33312Config {
    private String name = "idea_033312";
 ...
 */
@Slf4j
public class Idea33312Service {
    private static final int IDEA_ID = 33312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33312Service() {
        this(new Idea33312Config());
    }

    public Idea33312Service(Idea33312Config config) {
        this.config = config != null ? config : new Idea33312Config();
