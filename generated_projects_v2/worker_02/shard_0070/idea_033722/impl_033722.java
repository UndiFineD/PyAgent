...
@Data
public class Idea33722Config {
    private String name = "idea_033722";
 ...
 */
@Slf4j
public class Idea33722Service {
    private static final int IDEA_ID = 33722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33722Service() {
        this(new Idea33722Config());
    }

    public Idea33722Service(Idea33722Config config) {
        this.config = config != null ? config : new Idea33722Config();
