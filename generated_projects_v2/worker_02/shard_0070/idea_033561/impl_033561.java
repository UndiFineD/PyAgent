...
@Data
public class Idea33561Config {
    private String name = "idea_033561";
 ...
 */
@Slf4j
public class Idea33561Service {
    private static final int IDEA_ID = 33561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33561Service() {
        this(new Idea33561Config());
    }

    public Idea33561Service(Idea33561Config config) {
        this.config = config != null ? config : new Idea33561Config();
