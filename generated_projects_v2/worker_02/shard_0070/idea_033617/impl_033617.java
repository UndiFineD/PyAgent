...
@Data
public class Idea33617Config {
    private String name = "idea_033617";
 ...
 */
@Slf4j
public class Idea33617Service {
    private static final int IDEA_ID = 33617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33617Service() {
        this(new Idea33617Config());
    }

    public Idea33617Service(Idea33617Config config) {
        this.config = config != null ? config : new Idea33617Config();
