...
@Data
public class Idea33605Config {
    private String name = "idea_033605";
 ...
 */
@Slf4j
public class Idea33605Service {
    private static final int IDEA_ID = 33605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33605Service() {
        this(new Idea33605Config());
    }

    public Idea33605Service(Idea33605Config config) {
        this.config = config != null ? config : new Idea33605Config();
