...
@Data
public class Idea33334Config {
    private String name = "idea_033334";
 ...
 */
@Slf4j
public class Idea33334Service {
    private static final int IDEA_ID = 33334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33334Service() {
        this(new Idea33334Config());
    }

    public Idea33334Service(Idea33334Config config) {
        this.config = config != null ? config : new Idea33334Config();
