...
@Data
public class Idea33516Config {
    private String name = "idea_033516";
 ...
 */
@Slf4j
public class Idea33516Service {
    private static final int IDEA_ID = 33516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33516Service() {
        this(new Idea33516Config());
    }

    public Idea33516Service(Idea33516Config config) {
        this.config = config != null ? config : new Idea33516Config();
