...
@Data
public class Idea33348Config {
    private String name = "idea_033348";
 ...
 */
@Slf4j
public class Idea33348Service {
    private static final int IDEA_ID = 33348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33348Service() {
        this(new Idea33348Config());
    }

    public Idea33348Service(Idea33348Config config) {
        this.config = config != null ? config : new Idea33348Config();
