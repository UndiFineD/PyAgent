...
@Data
public class Idea33513Config {
    private String name = "idea_033513";
 ...
 */
@Slf4j
public class Idea33513Service {
    private static final int IDEA_ID = 33513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33513Service() {
        this(new Idea33513Config());
    }

    public Idea33513Service(Idea33513Config config) {
        this.config = config != null ? config : new Idea33513Config();
