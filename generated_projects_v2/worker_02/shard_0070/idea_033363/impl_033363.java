...
@Data
public class Idea33363Config {
    private String name = "idea_033363";
 ...
 */
@Slf4j
public class Idea33363Service {
    private static final int IDEA_ID = 33363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33363Service() {
        this(new Idea33363Config());
    }

    public Idea33363Service(Idea33363Config config) {
        this.config = config != null ? config : new Idea33363Config();
