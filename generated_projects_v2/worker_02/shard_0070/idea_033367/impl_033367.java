...
@Data
public class Idea33367Config {
    private String name = "idea_033367";
 ...
 */
@Slf4j
public class Idea33367Service {
    private static final int IDEA_ID = 33367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33367Service() {
        this(new Idea33367Config());
    }

    public Idea33367Service(Idea33367Config config) {
        this.config = config != null ? config : new Idea33367Config();
