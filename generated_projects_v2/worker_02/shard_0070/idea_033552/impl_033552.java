...
@Data
public class Idea33552Config {
    private String name = "idea_033552";
 ...
 */
@Slf4j
public class Idea33552Service {
    private static final int IDEA_ID = 33552;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33552Service() {
        this(new Idea33552Config());
    }

    public Idea33552Service(Idea33552Config config) {
        this.config = config != null ? config : new Idea33552Config();
