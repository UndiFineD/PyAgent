...
@Data
public class Idea33390Config {
    private String name = "idea_033390";
 ...
 */
@Slf4j
public class Idea33390Service {
    private static final int IDEA_ID = 33390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33390Service() {
        this(new Idea33390Config());
    }

    public Idea33390Service(Idea33390Config config) {
        this.config = config != null ? config : new Idea33390Config();
