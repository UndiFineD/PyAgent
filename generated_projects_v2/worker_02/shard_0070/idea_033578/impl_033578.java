...
@Data
public class Idea33578Config {
    private String name = "idea_033578";
 ...
 */
@Slf4j
public class Idea33578Service {
    private static final int IDEA_ID = 33578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33578Service() {
        this(new Idea33578Config());
    }

    public Idea33578Service(Idea33578Config config) {
        this.config = config != null ? config : new Idea33578Config();
