...
@Data
public class Idea33684Config {
    private String name = "idea_033684";
 ...
 */
@Slf4j
public class Idea33684Service {
    private static final int IDEA_ID = 33684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33684Service() {
        this(new Idea33684Config());
    }

    public Idea33684Service(Idea33684Config config) {
        this.config = config != null ? config : new Idea33684Config();
