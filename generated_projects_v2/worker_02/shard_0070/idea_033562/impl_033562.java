...
@Data
public class Idea33562Config {
    private String name = "idea_033562";
 ...
 */
@Slf4j
public class Idea33562Service {
    private static final int IDEA_ID = 33562;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33562Service() {
        this(new Idea33562Config());
    }

    public Idea33562Service(Idea33562Config config) {
        this.config = config != null ? config : new Idea33562Config();
