...
@Data
public class Idea33720Config {
    private String name = "idea_033720";
 ...
 */
@Slf4j
public class Idea33720Service {
    private static final int IDEA_ID = 33720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33720Service() {
        this(new Idea33720Config());
    }

    public Idea33720Service(Idea33720Config config) {
        this.config = config != null ? config : new Idea33720Config();
