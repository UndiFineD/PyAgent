...
@Data
public class Idea33660Config {
    private String name = "idea_033660";
 ...
 */
@Slf4j
public class Idea33660Service {
    private static final int IDEA_ID = 33660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33660Service() {
        this(new Idea33660Config());
    }

    public Idea33660Service(Idea33660Config config) {
        this.config = config != null ? config : new Idea33660Config();
