...
@Data
public class Idea33627Config {
    private String name = "idea_033627";
 ...
 */
@Slf4j
public class Idea33627Service {
    private static final int IDEA_ID = 33627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33627Service() {
        this(new Idea33627Config());
    }

    public Idea33627Service(Idea33627Config config) {
        this.config = config != null ? config : new Idea33627Config();
