...
@Data
public class Idea33710Config {
    private String name = "idea_033710";
 ...
 */
@Slf4j
public class Idea33710Service {
    private static final int IDEA_ID = 33710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33710Service() {
        this(new Idea33710Config());
    }

    public Idea33710Service(Idea33710Config config) {
        this.config = config != null ? config : new Idea33710Config();
