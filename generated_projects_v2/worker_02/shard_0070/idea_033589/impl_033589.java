...
@Data
public class Idea33589Config {
    private String name = "idea_033589";
 ...
 */
@Slf4j
public class Idea33589Service {
    private static final int IDEA_ID = 33589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33589Service() {
        this(new Idea33589Config());
    }

    public Idea33589Service(Idea33589Config config) {
        this.config = config != null ? config : new Idea33589Config();
