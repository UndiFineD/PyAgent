...
@Data
public class Idea33272Config {
    private String name = "idea_033272";
 ...
 */
@Slf4j
public class Idea33272Service {
    private static final int IDEA_ID = 33272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33272Service() {
        this(new Idea33272Config());
    }

    public Idea33272Service(Idea33272Config config) {
        this.config = config != null ? config : new Idea33272Config();
