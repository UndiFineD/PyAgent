...
@Data
public class Idea33555Config {
    private String name = "idea_033555";
 ...
 */
@Slf4j
public class Idea33555Service {
    private static final int IDEA_ID = 33555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33555Service() {
        this(new Idea33555Config());
    }

    public Idea33555Service(Idea33555Config config) {
        this.config = config != null ? config : new Idea33555Config();
