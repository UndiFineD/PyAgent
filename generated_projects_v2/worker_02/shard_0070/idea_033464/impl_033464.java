...
@Data
public class Idea33464Config {
    private String name = "idea_033464";
 ...
 */
@Slf4j
public class Idea33464Service {
    private static final int IDEA_ID = 33464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33464Service() {
        this(new Idea33464Config());
    }

    public Idea33464Service(Idea33464Config config) {
        this.config = config != null ? config : new Idea33464Config();
