...
@Data
public class Idea33418Config {
    private String name = "idea_033418";
 ...
 */
@Slf4j
public class Idea33418Service {
    private static final int IDEA_ID = 33418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33418Service() {
        this(new Idea33418Config());
    }

    public Idea33418Service(Idea33418Config config) {
        this.config = config != null ? config : new Idea33418Config();
