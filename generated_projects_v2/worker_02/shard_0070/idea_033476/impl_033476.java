...
@Data
public class Idea33476Config {
    private String name = "idea_033476";
 ...
 */
@Slf4j
public class Idea33476Service {
    private static final int IDEA_ID = 33476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33476Service() {
        this(new Idea33476Config());
    }

    public Idea33476Service(Idea33476Config config) {
        this.config = config != null ? config : new Idea33476Config();
