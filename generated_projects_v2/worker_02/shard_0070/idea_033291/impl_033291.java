...
@Data
public class Idea33291Config {
    private String name = "idea_033291";
 ...
 */
@Slf4j
public class Idea33291Service {
    private static final int IDEA_ID = 33291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33291Service() {
        this(new Idea33291Config());
    }

    public Idea33291Service(Idea33291Config config) {
        this.config = config != null ? config : new Idea33291Config();
