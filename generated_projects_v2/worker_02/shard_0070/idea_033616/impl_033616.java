...
@Data
public class Idea33616Config {
    private String name = "idea_033616";
 ...
 */
@Slf4j
public class Idea33616Service {
    private static final int IDEA_ID = 33616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33616Service() {
        this(new Idea33616Config());
    }

    public Idea33616Service(Idea33616Config config) {
        this.config = config != null ? config : new Idea33616Config();
