...
@Data
public class Idea33719Config {
    private String name = "idea_033719";
 ...
 */
@Slf4j
public class Idea33719Service {
    private static final int IDEA_ID = 33719;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33719Service() {
        this(new Idea33719Config());
    }

    public Idea33719Service(Idea33719Config config) {
        this.config = config != null ? config : new Idea33719Config();
