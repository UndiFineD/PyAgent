...
@Data
public class Idea33474Config {
    private String name = "idea_033474";
 ...
 */
@Slf4j
public class Idea33474Service {
    private static final int IDEA_ID = 33474;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33474Service() {
        this(new Idea33474Config());
    }

    public Idea33474Service(Idea33474Config config) {
        this.config = config != null ? config : new Idea33474Config();
