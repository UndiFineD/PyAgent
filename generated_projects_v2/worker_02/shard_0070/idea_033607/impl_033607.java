...
@Data
public class Idea33607Config {
    private String name = "idea_033607";
 ...
 */
@Slf4j
public class Idea33607Service {
    private static final int IDEA_ID = 33607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33607Service() {
        this(new Idea33607Config());
    }

    public Idea33607Service(Idea33607Config config) {
        this.config = config != null ? config : new Idea33607Config();
