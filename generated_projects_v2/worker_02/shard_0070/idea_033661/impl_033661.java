...
@Data
public class Idea33661Config {
    private String name = "idea_033661";
 ...
 */
@Slf4j
public class Idea33661Service {
    private static final int IDEA_ID = 33661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33661Service() {
        this(new Idea33661Config());
    }

    public Idea33661Service(Idea33661Config config) {
        this.config = config != null ? config : new Idea33661Config();
