...
@Data
public class Idea33515Config {
    private String name = "idea_033515";
 ...
 */
@Slf4j
public class Idea33515Service {
    private static final int IDEA_ID = 33515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33515Service() {
        this(new Idea33515Config());
    }

    public Idea33515Service(Idea33515Config config) {
        this.config = config != null ? config : new Idea33515Config();
