...
@Data
public class Idea33691Config {
    private String name = "idea_033691";
 ...
 */
@Slf4j
public class Idea33691Service {
    private static final int IDEA_ID = 33691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33691Service() {
        this(new Idea33691Config());
    }

    public Idea33691Service(Idea33691Config config) {
        this.config = config != null ? config : new Idea33691Config();
