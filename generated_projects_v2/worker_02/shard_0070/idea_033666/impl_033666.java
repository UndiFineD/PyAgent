...
@Data
public class Idea33666Config {
    private String name = "idea_033666";
 ...
 */
@Slf4j
public class Idea33666Service {
    private static final int IDEA_ID = 33666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33666Service() {
        this(new Idea33666Config());
    }

    public Idea33666Service(Idea33666Config config) {
        this.config = config != null ? config : new Idea33666Config();
