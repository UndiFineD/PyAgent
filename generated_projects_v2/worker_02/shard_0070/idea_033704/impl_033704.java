...
@Data
public class Idea33704Config {
    private String name = "idea_033704";
 ...
 */
@Slf4j
public class Idea33704Service {
    private static final int IDEA_ID = 33704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33704Service() {
        this(new Idea33704Config());
    }

    public Idea33704Service(Idea33704Config config) {
        this.config = config != null ? config : new Idea33704Config();
