...
@Data
public class Idea33313Config {
    private String name = "idea_033313";
 ...
 */
@Slf4j
public class Idea33313Service {
    private static final int IDEA_ID = 33313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33313Service() {
        this(new Idea33313Config());
    }

    public Idea33313Service(Idea33313Config config) {
        this.config = config != null ? config : new Idea33313Config();
