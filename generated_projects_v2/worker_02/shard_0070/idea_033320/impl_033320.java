...
@Data
public class Idea33320Config {
    private String name = "idea_033320";
 ...
 */
@Slf4j
public class Idea33320Service {
    private static final int IDEA_ID = 33320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33320Service() {
        this(new Idea33320Config());
    }

    public Idea33320Service(Idea33320Config config) {
        this.config = config != null ? config : new Idea33320Config();
