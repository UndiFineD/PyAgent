...
@Data
public class Idea33584Config {
    private String name = "idea_033584";
 ...
 */
@Slf4j
public class Idea33584Service {
    private static final int IDEA_ID = 33584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33584Service() {
        this(new Idea33584Config());
    }

    public Idea33584Service(Idea33584Config config) {
        this.config = config != null ? config : new Idea33584Config();
