...
@Data
public class Idea33276Config {
    private String name = "idea_033276";
 ...
 */
@Slf4j
public class Idea33276Service {
    private static final int IDEA_ID = 33276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33276Service() {
        this(new Idea33276Config());
    }

    public Idea33276Service(Idea33276Config config) {
        this.config = config != null ? config : new Idea33276Config();
