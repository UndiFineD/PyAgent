...
@Data
public class Idea33715Config {
    private String name = "idea_033715";
 ...
 */
@Slf4j
public class Idea33715Service {
    private static final int IDEA_ID = 33715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33715Service() {
        this(new Idea33715Config());
    }

    public Idea33715Service(Idea33715Config config) {
        this.config = config != null ? config : new Idea33715Config();
