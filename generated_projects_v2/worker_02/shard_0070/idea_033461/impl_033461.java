...
@Data
public class Idea33461Config {
    private String name = "idea_033461";
 ...
 */
@Slf4j
public class Idea33461Service {
    private static final int IDEA_ID = 33461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33461Service() {
        this(new Idea33461Config());
    }

    public Idea33461Service(Idea33461Config config) {
        this.config = config != null ? config : new Idea33461Config();
