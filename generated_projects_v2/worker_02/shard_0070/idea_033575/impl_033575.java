...
@Data
public class Idea33575Config {
    private String name = "idea_033575";
 ...
 */
@Slf4j
public class Idea33575Service {
    private static final int IDEA_ID = 33575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33575Service() {
        this(new Idea33575Config());
    }

    public Idea33575Service(Idea33575Config config) {
        this.config = config != null ? config : new Idea33575Config();
