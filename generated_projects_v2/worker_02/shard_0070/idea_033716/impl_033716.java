...
@Data
public class Idea33716Config {
    private String name = "idea_033716";
 ...
 */
@Slf4j
public class Idea33716Service {
    private static final int IDEA_ID = 33716;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33716Service() {
        this(new Idea33716Config());
    }

    public Idea33716Service(Idea33716Config config) {
        this.config = config != null ? config : new Idea33716Config();
