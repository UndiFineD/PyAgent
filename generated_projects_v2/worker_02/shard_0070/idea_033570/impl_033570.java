...
@Data
public class Idea33570Config {
    private String name = "idea_033570";
 ...
 */
@Slf4j
public class Idea33570Service {
    private static final int IDEA_ID = 33570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33570Service() {
        this(new Idea33570Config());
    }

    public Idea33570Service(Idea33570Config config) {
        this.config = config != null ? config : new Idea33570Config();
