...
@Data
public class Idea33446Config {
    private String name = "idea_033446";
 ...
 */
@Slf4j
public class Idea33446Service {
    private static final int IDEA_ID = 33446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33446Service() {
        this(new Idea33446Config());
    }

    public Idea33446Service(Idea33446Config config) {
        this.config = config != null ? config : new Idea33446Config();
