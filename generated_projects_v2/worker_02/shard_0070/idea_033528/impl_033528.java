...
@Data
public class Idea33528Config {
    private String name = "idea_033528";
 ...
 */
@Slf4j
public class Idea33528Service {
    private static final int IDEA_ID = 33528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33528Service() {
        this(new Idea33528Config());
    }

    public Idea33528Service(Idea33528Config config) {
        this.config = config != null ? config : new Idea33528Config();
