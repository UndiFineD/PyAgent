...
@Data
public class Idea33388Config {
    private String name = "idea_033388";
 ...
 */
@Slf4j
public class Idea33388Service {
    private static final int IDEA_ID = 33388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33388Service() {
        this(new Idea33388Config());
    }

    public Idea33388Service(Idea33388Config config) {
        this.config = config != null ? config : new Idea33388Config();
