...
@Data
public class Idea33645Config {
    private String name = "idea_033645";
 ...
 */
@Slf4j
public class Idea33645Service {
    private static final int IDEA_ID = 33645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33645Service() {
        this(new Idea33645Config());
    }

    public Idea33645Service(Idea33645Config config) {
        this.config = config != null ? config : new Idea33645Config();
