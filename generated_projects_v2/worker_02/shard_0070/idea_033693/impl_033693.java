...
@Data
public class Idea33693Config {
    private String name = "idea_033693";
 ...
 */
@Slf4j
public class Idea33693Service {
    private static final int IDEA_ID = 33693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33693Service() {
        this(new Idea33693Config());
    }

    public Idea33693Service(Idea33693Config config) {
        this.config = config != null ? config : new Idea33693Config();
