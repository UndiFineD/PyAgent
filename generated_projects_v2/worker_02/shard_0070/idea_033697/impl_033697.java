...
@Data
public class Idea33697Config {
    private String name = "idea_033697";
 ...
 */
@Slf4j
public class Idea33697Service {
    private static final int IDEA_ID = 33697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33697Service() {
        this(new Idea33697Config());
    }

    public Idea33697Service(Idea33697Config config) {
        this.config = config != null ? config : new Idea33697Config();
