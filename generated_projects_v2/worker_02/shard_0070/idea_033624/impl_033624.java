...
@Data
public class Idea33624Config {
    private String name = "idea_033624";
 ...
 */
@Slf4j
public class Idea33624Service {
    private static final int IDEA_ID = 33624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33624Service() {
        this(new Idea33624Config());
    }

    public Idea33624Service(Idea33624Config config) {
        this.config = config != null ? config : new Idea33624Config();
