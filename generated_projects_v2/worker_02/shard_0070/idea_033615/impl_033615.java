...
@Data
public class Idea33615Config {
    private String name = "idea_033615";
 ...
 */
@Slf4j
public class Idea33615Service {
    private static final int IDEA_ID = 33615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33615Service() {
        this(new Idea33615Config());
    }

    public Idea33615Service(Idea33615Config config) {
        this.config = config != null ? config : new Idea33615Config();
