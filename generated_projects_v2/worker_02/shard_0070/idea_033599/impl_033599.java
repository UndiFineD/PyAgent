...
@Data
public class Idea33599Config {
    private String name = "idea_033599";
 ...
 */
@Slf4j
public class Idea33599Service {
    private static final int IDEA_ID = 33599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33599Service() {
        this(new Idea33599Config());
    }

    public Idea33599Service(Idea33599Config config) {
        this.config = config != null ? config : new Idea33599Config();
