...
@Data
public class Idea33444Config {
    private String name = "idea_033444";
 ...
 */
@Slf4j
public class Idea33444Service {
    private static final int IDEA_ID = 33444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33444Service() {
        this(new Idea33444Config());
    }

    public Idea33444Service(Idea33444Config config) {
        this.config = config != null ? config : new Idea33444Config();
