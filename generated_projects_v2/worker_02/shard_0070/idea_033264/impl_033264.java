...
@Data
public class Idea33264Config {
    private String name = "idea_033264";
 ...
 */
@Slf4j
public class Idea33264Service {
    private static final int IDEA_ID = 33264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33264Service() {
        this(new Idea33264Config());
    }

    public Idea33264Service(Idea33264Config config) {
        this.config = config != null ? config : new Idea33264Config();
