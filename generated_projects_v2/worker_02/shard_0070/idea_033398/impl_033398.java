...
@Data
public class Idea33398Config {
    private String name = "idea_033398";
 ...
 */
@Slf4j
public class Idea33398Service {
    private static final int IDEA_ID = 33398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33398Service() {
        this(new Idea33398Config());
    }

    public Idea33398Service(Idea33398Config config) {
        this.config = config != null ? config : new Idea33398Config();
