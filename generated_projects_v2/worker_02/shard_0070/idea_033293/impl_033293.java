...
@Data
public class Idea33293Config {
    private String name = "idea_033293";
 ...
 */
@Slf4j
public class Idea33293Service {
    private static final int IDEA_ID = 33293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33293Service() {
        this(new Idea33293Config());
    }

    public Idea33293Service(Idea33293Config config) {
        this.config = config != null ? config : new Idea33293Config();
