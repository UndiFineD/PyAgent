...
@Data
public class Idea33633Config {
    private String name = "idea_033633";
 ...
 */
@Slf4j
public class Idea33633Service {
    private static final int IDEA_ID = 33633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33633Service() {
        this(new Idea33633Config());
    }

    public Idea33633Service(Idea33633Config config) {
        this.config = config != null ? config : new Idea33633Config();
