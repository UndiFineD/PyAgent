...
@Data
public class Idea33655Config {
    private String name = "idea_033655";
 ...
 */
@Slf4j
public class Idea33655Service {
    private static final int IDEA_ID = 33655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33655Service() {
        this(new Idea33655Config());
    }

    public Idea33655Service(Idea33655Config config) {
        this.config = config != null ? config : new Idea33655Config();
