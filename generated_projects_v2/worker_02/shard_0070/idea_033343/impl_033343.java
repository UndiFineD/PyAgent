...
@Data
public class Idea33343Config {
    private String name = "idea_033343";
 ...
 */
@Slf4j
public class Idea33343Service {
    private static final int IDEA_ID = 33343;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33343Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33343Service() {
        this(new Idea33343Config());
    }

    public Idea33343Service(Idea33343Config config) {
        this.config = config != null ? config : new Idea33343Config();
