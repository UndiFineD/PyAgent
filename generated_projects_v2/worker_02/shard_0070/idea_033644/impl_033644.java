...
@Data
public class Idea33644Config {
    private String name = "idea_033644";
 ...
 */
@Slf4j
public class Idea33644Service {
    private static final int IDEA_ID = 33644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33644Service() {
        this(new Idea33644Config());
    }

    public Idea33644Service(Idea33644Config config) {
        this.config = config != null ? config : new Idea33644Config();
