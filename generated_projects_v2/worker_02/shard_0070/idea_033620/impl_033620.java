...
@Data
public class Idea33620Config {
    private String name = "idea_033620";
 ...
 */
@Slf4j
public class Idea33620Service {
    private static final int IDEA_ID = 33620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33620Service() {
        this(new Idea33620Config());
    }

    public Idea33620Service(Idea33620Config config) {
        this.config = config != null ? config : new Idea33620Config();
