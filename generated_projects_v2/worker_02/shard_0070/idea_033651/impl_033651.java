...
@Data
public class Idea33651Config {
    private String name = "idea_033651";
 ...
 */
@Slf4j
public class Idea33651Service {
    private static final int IDEA_ID = 33651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33651Service() {
        this(new Idea33651Config());
    }

    public Idea33651Service(Idea33651Config config) {
        this.config = config != null ? config : new Idea33651Config();
