...
@Data
public class Idea33364Config {
    private String name = "idea_033364";
 ...
 */
@Slf4j
public class Idea33364Service {
    private static final int IDEA_ID = 33364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33364Service() {
        this(new Idea33364Config());
    }

    public Idea33364Service(Idea33364Config config) {
        this.config = config != null ? config : new Idea33364Config();
