...
@Data
public class Idea33685Config {
    private String name = "idea_033685";
 ...
 */
@Slf4j
public class Idea33685Service {
    private static final int IDEA_ID = 33685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33685Service() {
        this(new Idea33685Config());
    }

    public Idea33685Service(Idea33685Config config) {
        this.config = config != null ? config : new Idea33685Config();
