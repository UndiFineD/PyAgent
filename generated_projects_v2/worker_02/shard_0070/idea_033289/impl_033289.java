...
@Data
public class Idea33289Config {
    private String name = "idea_033289";
 ...
 */
@Slf4j
public class Idea33289Service {
    private static final int IDEA_ID = 33289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33289Service() {
        this(new Idea33289Config());
    }

    public Idea33289Service(Idea33289Config config) {
        this.config = config != null ? config : new Idea33289Config();
