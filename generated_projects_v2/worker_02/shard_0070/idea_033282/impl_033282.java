...
@Data
public class Idea33282Config {
    private String name = "idea_033282";
 ...
 */
@Slf4j
public class Idea33282Service {
    private static final int IDEA_ID = 33282;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33282Service() {
        this(new Idea33282Config());
    }

    public Idea33282Service(Idea33282Config config) {
        this.config = config != null ? config : new Idea33282Config();
