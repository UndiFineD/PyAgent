...
@Data
public class Idea33314Config {
    private String name = "idea_033314";
 ...
 */
@Slf4j
public class Idea33314Service {
    private static final int IDEA_ID = 33314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33314Service() {
        this(new Idea33314Config());
    }

    public Idea33314Service(Idea33314Config config) {
        this.config = config != null ? config : new Idea33314Config();
