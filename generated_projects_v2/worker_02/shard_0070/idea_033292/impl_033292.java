...
@Data
public class Idea33292Config {
    private String name = "idea_033292";
 ...
 */
@Slf4j
public class Idea33292Service {
    private static final int IDEA_ID = 33292;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33292Service() {
        this(new Idea33292Config());
    }

    public Idea33292Service(Idea33292Config config) {
        this.config = config != null ? config : new Idea33292Config();
