...
@Data
public class Idea33668Config {
    private String name = "idea_033668";
 ...
 */
@Slf4j
public class Idea33668Service {
    private static final int IDEA_ID = 33668;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33668Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33668Service() {
        this(new Idea33668Config());
    }

    public Idea33668Service(Idea33668Config config) {
        this.config = config != null ? config : new Idea33668Config();
