...
@Data
public class Idea33351Config {
    private String name = "idea_033351";
 ...
 */
@Slf4j
public class Idea33351Service {
    private static final int IDEA_ID = 33351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33351Service() {
        this(new Idea33351Config());
    }

    public Idea33351Service(Idea33351Config config) {
        this.config = config != null ? config : new Idea33351Config();
