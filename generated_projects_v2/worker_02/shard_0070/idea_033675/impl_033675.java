...
@Data
public class Idea33675Config {
    private String name = "idea_033675";
 ...
 */
@Slf4j
public class Idea33675Service {
    private static final int IDEA_ID = 33675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33675Service() {
        this(new Idea33675Config());
    }

    public Idea33675Service(Idea33675Config config) {
        this.config = config != null ? config : new Idea33675Config();
