...
@Data
public class Idea33567Config {
    private String name = "idea_033567";
 ...
 */
@Slf4j
public class Idea33567Service {
    private static final int IDEA_ID = 33567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33567Service() {
        this(new Idea33567Config());
    }

    public Idea33567Service(Idea33567Config config) {
        this.config = config != null ? config : new Idea33567Config();
