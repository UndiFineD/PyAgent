...
@Data
public class Idea33347Config {
    private String name = "idea_033347";
 ...
 */
@Slf4j
public class Idea33347Service {
    private static final int IDEA_ID = 33347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33347Service() {
        this(new Idea33347Config());
    }

    public Idea33347Service(Idea33347Config config) {
        this.config = config != null ? config : new Idea33347Config();
