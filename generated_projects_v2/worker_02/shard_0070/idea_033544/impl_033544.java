...
@Data
public class Idea33544Config {
    private String name = "idea_033544";
 ...
 */
@Slf4j
public class Idea33544Service {
    private static final int IDEA_ID = 33544;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33544Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33544Service() {
        this(new Idea33544Config());
    }

    public Idea33544Service(Idea33544Config config) {
        this.config = config != null ? config : new Idea33544Config();
