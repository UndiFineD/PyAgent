...
@Data
public class Idea33591Config {
    private String name = "idea_033591";
 ...
 */
@Slf4j
public class Idea33591Service {
    private static final int IDEA_ID = 33591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33591Service() {
        this(new Idea33591Config());
    }

    public Idea33591Service(Idea33591Config config) {
        this.config = config != null ? config : new Idea33591Config();
