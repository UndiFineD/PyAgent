...
@Data
public class Idea33296Config {
    private String name = "idea_033296";
 ...
 */
@Slf4j
public class Idea33296Service {
    private static final int IDEA_ID = 33296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33296Service() {
        this(new Idea33296Config());
    }

    public Idea33296Service(Idea33296Config config) {
        this.config = config != null ? config : new Idea33296Config();
