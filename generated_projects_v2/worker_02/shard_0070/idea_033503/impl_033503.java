...
@Data
public class Idea33503Config {
    private String name = "idea_033503";
 ...
 */
@Slf4j
public class Idea33503Service {
    private static final int IDEA_ID = 33503;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33503Service() {
        this(new Idea33503Config());
    }

    public Idea33503Service(Idea33503Config config) {
        this.config = config != null ? config : new Idea33503Config();
