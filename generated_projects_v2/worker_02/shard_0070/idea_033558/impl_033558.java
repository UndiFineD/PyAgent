...
@Data
public class Idea33558Config {
    private String name = "idea_033558";
 ...
 */
@Slf4j
public class Idea33558Service {
    private static final int IDEA_ID = 33558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33558Service() {
        this(new Idea33558Config());
    }

    public Idea33558Service(Idea33558Config config) {
        this.config = config != null ? config : new Idea33558Config();
