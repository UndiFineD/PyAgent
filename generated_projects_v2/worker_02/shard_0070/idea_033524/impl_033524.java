...
@Data
public class Idea33524Config {
    private String name = "idea_033524";
 ...
 */
@Slf4j
public class Idea33524Service {
    private static final int IDEA_ID = 33524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33524Service() {
        this(new Idea33524Config());
    }

    public Idea33524Service(Idea33524Config config) {
        this.config = config != null ? config : new Idea33524Config();
