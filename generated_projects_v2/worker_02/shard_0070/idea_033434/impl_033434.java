...
@Data
public class Idea33434Config {
    private String name = "idea_033434";
 ...
 */
@Slf4j
public class Idea33434Service {
    private static final int IDEA_ID = 33434;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33434Service() {
        this(new Idea33434Config());
    }

    public Idea33434Service(Idea33434Config config) {
        this.config = config != null ? config : new Idea33434Config();
