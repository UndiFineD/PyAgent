...
@Data
public class Idea33522Config {
    private String name = "idea_033522";
 ...
 */
@Slf4j
public class Idea33522Service {
    private static final int IDEA_ID = 33522;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33522Service() {
        this(new Idea33522Config());
    }

    public Idea33522Service(Idea33522Config config) {
        this.config = config != null ? config : new Idea33522Config();
