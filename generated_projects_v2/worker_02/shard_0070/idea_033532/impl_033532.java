...
@Data
public class Idea33532Config {
    private String name = "idea_033532";
 ...
 */
@Slf4j
public class Idea33532Service {
    private static final int IDEA_ID = 33532;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33532Service() {
        this(new Idea33532Config());
    }

    public Idea33532Service(Idea33532Config config) {
        this.config = config != null ? config : new Idea33532Config();
