...
@Data
public class Idea33536Config {
    private String name = "idea_033536";
 ...
 */
@Slf4j
public class Idea33536Service {
    private static final int IDEA_ID = 33536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33536Service() {
        this(new Idea33536Config());
    }

    public Idea33536Service(Idea33536Config config) {
        this.config = config != null ? config : new Idea33536Config();
