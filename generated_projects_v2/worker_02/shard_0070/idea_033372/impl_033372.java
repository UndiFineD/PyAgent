...
@Data
public class Idea33372Config {
    private String name = "idea_033372";
 ...
 */
@Slf4j
public class Idea33372Service {
    private static final int IDEA_ID = 33372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33372Service() {
        this(new Idea33372Config());
    }

    public Idea33372Service(Idea33372Config config) {
        this.config = config != null ? config : new Idea33372Config();
