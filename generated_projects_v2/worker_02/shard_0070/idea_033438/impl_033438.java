...
@Data
public class Idea33438Config {
    private String name = "idea_033438";
 ...
 */
@Slf4j
public class Idea33438Service {
    private static final int IDEA_ID = 33438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33438Service() {
        this(new Idea33438Config());
    }

    public Idea33438Service(Idea33438Config config) {
        this.config = config != null ? config : new Idea33438Config();
