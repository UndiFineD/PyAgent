...
@Data
public class Idea33623Config {
    private String name = "idea_033623";
 ...
 */
@Slf4j
public class Idea33623Service {
    private static final int IDEA_ID = 33623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33623Service() {
        this(new Idea33623Config());
    }

    public Idea33623Service(Idea33623Config config) {
        this.config = config != null ? config : new Idea33623Config();
