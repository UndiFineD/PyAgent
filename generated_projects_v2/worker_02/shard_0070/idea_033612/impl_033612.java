...
@Data
public class Idea33612Config {
    private String name = "idea_033612";
 ...
 */
@Slf4j
public class Idea33612Service {
    private static final int IDEA_ID = 33612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33612Service() {
        this(new Idea33612Config());
    }

    public Idea33612Service(Idea33612Config config) {
        this.config = config != null ? config : new Idea33612Config();
