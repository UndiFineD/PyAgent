...
@Data
public class Idea33365Config {
    private String name = "idea_033365";
 ...
 */
@Slf4j
public class Idea33365Service {
    private static final int IDEA_ID = 33365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33365Service() {
        this(new Idea33365Config());
    }

    public Idea33365Service(Idea33365Config config) {
        this.config = config != null ? config : new Idea33365Config();
