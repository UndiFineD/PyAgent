...
@Data
public class Idea33502Config {
    private String name = "idea_033502";
 ...
 */
@Slf4j
public class Idea33502Service {
    private static final int IDEA_ID = 33502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33502Service() {
        this(new Idea33502Config());
    }

    public Idea33502Service(Idea33502Config config) {
        this.config = config != null ? config : new Idea33502Config();
