...
@Data
public class Idea33326Config {
    private String name = "idea_033326";
 ...
 */
@Slf4j
public class Idea33326Service {
    private static final int IDEA_ID = 33326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33326Service() {
        this(new Idea33326Config());
    }

    public Idea33326Service(Idea33326Config config) {
        this.config = config != null ? config : new Idea33326Config();
