...
@Data
public class Idea33448Config {
    private String name = "idea_033448";
 ...
 */
@Slf4j
public class Idea33448Service {
    private static final int IDEA_ID = 33448;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33448Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33448Service() {
        this(new Idea33448Config());
    }

    public Idea33448Service(Idea33448Config config) {
        this.config = config != null ? config : new Idea33448Config();
