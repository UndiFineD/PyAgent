...
@Data
public class Idea33497Config {
    private String name = "idea_033497";
 ...
 */
@Slf4j
public class Idea33497Service {
    private static final int IDEA_ID = 33497;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33497Service() {
        this(new Idea33497Config());
    }

    public Idea33497Service(Idea33497Config config) {
        this.config = config != null ? config : new Idea33497Config();
