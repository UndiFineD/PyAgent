...
@Data
public class Idea33498Config {
    private String name = "idea_033498";
 ...
 */
@Slf4j
public class Idea33498Service {
    private static final int IDEA_ID = 33498;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33498Service() {
        this(new Idea33498Config());
    }

    public Idea33498Service(Idea33498Config config) {
        this.config = config != null ? config : new Idea33498Config();
