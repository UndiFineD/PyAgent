...
@Data
public class Idea33478Config {
    private String name = "idea_033478";
 ...
 */
@Slf4j
public class Idea33478Service {
    private static final int IDEA_ID = 33478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33478Service() {
        this(new Idea33478Config());
    }

    public Idea33478Service(Idea33478Config config) {
        this.config = config != null ? config : new Idea33478Config();
