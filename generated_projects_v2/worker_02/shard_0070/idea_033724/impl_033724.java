...
@Data
public class Idea33724Config {
    private String name = "idea_033724";
 ...
 */
@Slf4j
public class Idea33724Service {
    private static final int IDEA_ID = 33724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33724Service() {
        this(new Idea33724Config());
    }

    public Idea33724Service(Idea33724Config config) {
        this.config = config != null ? config : new Idea33724Config();
