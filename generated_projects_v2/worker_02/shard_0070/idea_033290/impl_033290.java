...
@Data
public class Idea33290Config {
    private String name = "idea_033290";
 ...
 */
@Slf4j
public class Idea33290Service {
    private static final int IDEA_ID = 33290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33290Service() {
        this(new Idea33290Config());
    }

    public Idea33290Service(Idea33290Config config) {
        this.config = config != null ? config : new Idea33290Config();
