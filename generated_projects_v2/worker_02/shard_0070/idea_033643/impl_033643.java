...
@Data
public class Idea33643Config {
    private String name = "idea_033643";
 ...
 */
@Slf4j
public class Idea33643Service {
    private static final int IDEA_ID = 33643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33643Service() {
        this(new Idea33643Config());
    }

    public Idea33643Service(Idea33643Config config) {
        this.config = config != null ? config : new Idea33643Config();
