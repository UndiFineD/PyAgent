...
@Data
public class Idea33307Config {
    private String name = "idea_033307";
 ...
 */
@Slf4j
public class Idea33307Service {
    private static final int IDEA_ID = 33307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33307Service() {
        this(new Idea33307Config());
    }

    public Idea33307Service(Idea33307Config config) {
        this.config = config != null ? config : new Idea33307Config();
