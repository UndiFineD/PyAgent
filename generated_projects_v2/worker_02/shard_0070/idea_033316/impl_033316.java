...
@Data
public class Idea33316Config {
    private String name = "idea_033316";
 ...
 */
@Slf4j
public class Idea33316Service {
    private static final int IDEA_ID = 33316;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33316Service() {
        this(new Idea33316Config());
    }

    public Idea33316Service(Idea33316Config config) {
        this.config = config != null ? config : new Idea33316Config();
