...
@Data
public class Idea33361Config {
    private String name = "idea_033361";
 ...
 */
@Slf4j
public class Idea33361Service {
    private static final int IDEA_ID = 33361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33361Service() {
        this(new Idea33361Config());
    }

    public Idea33361Service(Idea33361Config config) {
        this.config = config != null ? config : new Idea33361Config();
