...
@Data
public class Idea33471Config {
    private String name = "idea_033471";
 ...
 */
@Slf4j
public class Idea33471Service {
    private static final int IDEA_ID = 33471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33471Service() {
        this(new Idea33471Config());
    }

    public Idea33471Service(Idea33471Config config) {
        this.config = config != null ? config : new Idea33471Config();
