...
@Data
public class Idea33501Config {
    private String name = "idea_033501";
 ...
 */
@Slf4j
public class Idea33501Service {
    private static final int IDEA_ID = 33501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33501Service() {
        this(new Idea33501Config());
    }

    public Idea33501Service(Idea33501Config config) {
        this.config = config != null ? config : new Idea33501Config();
