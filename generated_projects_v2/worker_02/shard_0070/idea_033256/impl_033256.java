...
@Data
public class Idea33256Config {
    private String name = "idea_033256";
 ...
 */
@Slf4j
public class Idea33256Service {
    private static final int IDEA_ID = 33256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33256Service() {
        this(new Idea33256Config());
    }

    public Idea33256Service(Idea33256Config config) {
        this.config = config != null ? config : new Idea33256Config();
