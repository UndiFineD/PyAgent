...
@Data
public class Idea33353Config {
    private String name = "idea_033353";
 ...
 */
@Slf4j
public class Idea33353Service {
    private static final int IDEA_ID = 33353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33353Service() {
        this(new Idea33353Config());
    }

    public Idea33353Service(Idea33353Config config) {
        this.config = config != null ? config : new Idea33353Config();
