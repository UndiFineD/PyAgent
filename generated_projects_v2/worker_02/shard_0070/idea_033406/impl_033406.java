...
@Data
public class Idea33406Config {
    private String name = "idea_033406";
 ...
 */
@Slf4j
public class Idea33406Service {
    private static final int IDEA_ID = 33406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33406Service() {
        this(new Idea33406Config());
    }

    public Idea33406Service(Idea33406Config config) {
        this.config = config != null ? config : new Idea33406Config();
