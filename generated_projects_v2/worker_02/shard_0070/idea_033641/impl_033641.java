...
@Data
public class Idea33641Config {
    private String name = "idea_033641";
 ...
 */
@Slf4j
public class Idea33641Service {
    private static final int IDEA_ID = 33641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33641Service() {
        this(new Idea33641Config());
    }

    public Idea33641Service(Idea33641Config config) {
        this.config = config != null ? config : new Idea33641Config();
