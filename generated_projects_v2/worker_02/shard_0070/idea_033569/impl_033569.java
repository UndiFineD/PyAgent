...
@Data
public class Idea33569Config {
    private String name = "idea_033569";
 ...
 */
@Slf4j
public class Idea33569Service {
    private static final int IDEA_ID = 33569;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33569Service() {
        this(new Idea33569Config());
    }

    public Idea33569Service(Idea33569Config config) {
        this.config = config != null ? config : new Idea33569Config();
