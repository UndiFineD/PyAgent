...
@Data
public class Idea33258Config {
    private String name = "idea_033258";
 ...
 */
@Slf4j
public class Idea33258Service {
    private static final int IDEA_ID = 33258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33258Service() {
        this(new Idea33258Config());
    }

    public Idea33258Service(Idea33258Config config) {
        this.config = config != null ? config : new Idea33258Config();
