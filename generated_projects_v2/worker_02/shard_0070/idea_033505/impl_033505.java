...
@Data
public class Idea33505Config {
    private String name = "idea_033505";
 ...
 */
@Slf4j
public class Idea33505Service {
    private static final int IDEA_ID = 33505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33505Service() {
        this(new Idea33505Config());
    }

    public Idea33505Service(Idea33505Config config) {
        this.config = config != null ? config : new Idea33505Config();
