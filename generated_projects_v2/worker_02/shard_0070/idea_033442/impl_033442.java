...
@Data
public class Idea33442Config {
    private String name = "idea_033442";
 ...
 */
@Slf4j
public class Idea33442Service {
    private static final int IDEA_ID = 33442;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33442Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33442Service() {
        this(new Idea33442Config());
    }

    public Idea33442Service(Idea33442Config config) {
        this.config = config != null ? config : new Idea33442Config();
