...
@Data
public class Idea33490Config {
    private String name = "idea_033490";
 ...
 */
@Slf4j
public class Idea33490Service {
    private static final int IDEA_ID = 33490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33490Service() {
        this(new Idea33490Config());
    }

    public Idea33490Service(Idea33490Config config) {
        this.config = config != null ? config : new Idea33490Config();
