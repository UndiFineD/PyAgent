...
@Data
public class Idea33540Config {
    private String name = "idea_033540";
 ...
 */
@Slf4j
public class Idea33540Service {
    private static final int IDEA_ID = 33540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33540Service() {
        this(new Idea33540Config());
    }

    public Idea33540Service(Idea33540Config config) {
        this.config = config != null ? config : new Idea33540Config();
