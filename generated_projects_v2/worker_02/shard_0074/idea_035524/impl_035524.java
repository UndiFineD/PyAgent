...
@Data
public class Idea35524Config {
    private String name = "idea_035524";
 ...
 */
@Slf4j
public class Idea35524Service {
    private static final int IDEA_ID = 35524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35524Service() {
        this(new Idea35524Config());
    }

    public Idea35524Service(Idea35524Config config) {
        this.config = config != null ? config : new Idea35524Config();
