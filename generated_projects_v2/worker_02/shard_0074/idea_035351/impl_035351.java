...
@Data
public class Idea35351Config {
    private String name = "idea_035351";
 ...
 */
@Slf4j
public class Idea35351Service {
    private static final int IDEA_ID = 35351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35351Service() {
        this(new Idea35351Config());
    }

    public Idea35351Service(Idea35351Config config) {
        this.config = config != null ? config : new Idea35351Config();
