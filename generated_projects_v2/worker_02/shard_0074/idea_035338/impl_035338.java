...
@Data
public class Idea35338Config {
    private String name = "idea_035338";
 ...
 */
@Slf4j
public class Idea35338Service {
    private static final int IDEA_ID = 35338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35338Service() {
        this(new Idea35338Config());
    }

    public Idea35338Service(Idea35338Config config) {
        this.config = config != null ? config : new Idea35338Config();
