...
@Data
public class Idea35150Config {
    private String name = "idea_035150";
 ...
 */
@Slf4j
public class Idea35150Service {
    private static final int IDEA_ID = 35150;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35150Service() {
        this(new Idea35150Config());
    }

    public Idea35150Service(Idea35150Config config) {
        this.config = config != null ? config : new Idea35150Config();
