...
@Data
public class Idea35240Config {
    private String name = "idea_035240";
 ...
 */
@Slf4j
public class Idea35240Service {
    private static final int IDEA_ID = 35240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35240Service() {
        this(new Idea35240Config());
    }

    public Idea35240Service(Idea35240Config config) {
        this.config = config != null ? config : new Idea35240Config();
