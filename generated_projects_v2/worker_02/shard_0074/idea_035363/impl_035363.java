...
@Data
public class Idea35363Config {
    private String name = "idea_035363";
 ...
 */
@Slf4j
public class Idea35363Service {
    private static final int IDEA_ID = 35363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35363Service() {
        this(new Idea35363Config());
    }

    public Idea35363Service(Idea35363Config config) {
        this.config = config != null ? config : new Idea35363Config();
