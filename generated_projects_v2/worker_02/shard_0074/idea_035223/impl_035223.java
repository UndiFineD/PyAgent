...
@Data
public class Idea35223Config {
    private String name = "idea_035223";
 ...
 */
@Slf4j
public class Idea35223Service {
    private static final int IDEA_ID = 35223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35223Service() {
        this(new Idea35223Config());
    }

    public Idea35223Service(Idea35223Config config) {
        this.config = config != null ? config : new Idea35223Config();
