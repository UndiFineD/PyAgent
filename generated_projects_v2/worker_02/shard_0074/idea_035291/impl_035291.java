...
@Data
public class Idea35291Config {
    private String name = "idea_035291";
 ...
 */
@Slf4j
public class Idea35291Service {
    private static final int IDEA_ID = 35291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35291Service() {
        this(new Idea35291Config());
    }

    public Idea35291Service(Idea35291Config config) {
        this.config = config != null ? config : new Idea35291Config();
