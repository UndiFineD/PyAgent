...
@Data
public class Idea35255Config {
    private String name = "idea_035255";
 ...
 */
@Slf4j
public class Idea35255Service {
    private static final int IDEA_ID = 35255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35255Service() {
        this(new Idea35255Config());
    }

    public Idea35255Service(Idea35255Config config) {
        this.config = config != null ? config : new Idea35255Config();
