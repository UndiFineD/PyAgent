...
@Data
public class Idea35330Config {
    private String name = "idea_035330";
 ...
 */
@Slf4j
public class Idea35330Service {
    private static final int IDEA_ID = 35330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35330Service() {
        this(new Idea35330Config());
    }

    public Idea35330Service(Idea35330Config config) {
        this.config = config != null ? config : new Idea35330Config();
