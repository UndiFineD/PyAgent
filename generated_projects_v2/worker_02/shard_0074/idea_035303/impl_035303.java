...
@Data
public class Idea35303Config {
    private String name = "idea_035303";
 ...
 */
@Slf4j
public class Idea35303Service {
    private static final int IDEA_ID = 35303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35303Service() {
        this(new Idea35303Config());
    }

    public Idea35303Service(Idea35303Config config) {
        this.config = config != null ? config : new Idea35303Config();
