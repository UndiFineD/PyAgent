...
@Data
public class Idea35400Config {
    private String name = "idea_035400";
 ...
 */
@Slf4j
public class Idea35400Service {
    private static final int IDEA_ID = 35400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35400Service() {
        this(new Idea35400Config());
    }

    public Idea35400Service(Idea35400Config config) {
        this.config = config != null ? config : new Idea35400Config();
