...
@Data
public class Idea35282Config {
    private String name = "idea_035282";
 ...
 */
@Slf4j
public class Idea35282Service {
    private static final int IDEA_ID = 35282;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35282Service() {
        this(new Idea35282Config());
    }

    public Idea35282Service(Idea35282Config config) {
        this.config = config != null ? config : new Idea35282Config();
