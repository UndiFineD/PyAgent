...
@Data
public class Idea35348Config {
    private String name = "idea_035348";
 ...
 */
@Slf4j
public class Idea35348Service {
    private static final int IDEA_ID = 35348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35348Service() {
        this(new Idea35348Config());
    }

    public Idea35348Service(Idea35348Config config) {
        this.config = config != null ? config : new Idea35348Config();
