...
@Data
public class Idea35186Config {
    private String name = "idea_035186";
 ...
 */
@Slf4j
public class Idea35186Service {
    private static final int IDEA_ID = 35186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35186Service() {
        this(new Idea35186Config());
    }

    public Idea35186Service(Idea35186Config config) {
        this.config = config != null ? config : new Idea35186Config();
