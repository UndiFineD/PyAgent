...
@Data
public class Idea35598Config {
    private String name = "idea_035598";
 ...
 */
@Slf4j
public class Idea35598Service {
    private static final int IDEA_ID = 35598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35598Service() {
        this(new Idea35598Config());
    }

    public Idea35598Service(Idea35598Config config) {
        this.config = config != null ? config : new Idea35598Config();
