...
@Data
public class Idea35241Config {
    private String name = "idea_035241";
 ...
 */
@Slf4j
public class Idea35241Service {
    private static final int IDEA_ID = 35241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35241Service() {
        this(new Idea35241Config());
    }

    public Idea35241Service(Idea35241Config config) {
        this.config = config != null ? config : new Idea35241Config();
