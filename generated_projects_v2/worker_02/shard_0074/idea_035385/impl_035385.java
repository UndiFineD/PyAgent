...
@Data
public class Idea35385Config {
    private String name = "idea_035385";
 ...
 */
@Slf4j
public class Idea35385Service {
    private static final int IDEA_ID = 35385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35385Service() {
        this(new Idea35385Config());
    }

    public Idea35385Service(Idea35385Config config) {
        this.config = config != null ? config : new Idea35385Config();
