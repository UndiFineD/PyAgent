...
@Data
public class Idea35164Config {
    private String name = "idea_035164";
 ...
 */
@Slf4j
public class Idea35164Service {
    private static final int IDEA_ID = 35164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35164Service() {
        this(new Idea35164Config());
    }

    public Idea35164Service(Idea35164Config config) {
        this.config = config != null ? config : new Idea35164Config();
