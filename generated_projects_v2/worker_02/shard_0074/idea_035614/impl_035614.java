...
@Data
public class Idea35614Config {
    private String name = "idea_035614";
 ...
 */
@Slf4j
public class Idea35614Service {
    private static final int IDEA_ID = 35614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35614Service() {
        this(new Idea35614Config());
    }

    public Idea35614Service(Idea35614Config config) {
        this.config = config != null ? config : new Idea35614Config();
