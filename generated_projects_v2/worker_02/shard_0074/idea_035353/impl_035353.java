...
@Data
public class Idea35353Config {
    private String name = "idea_035353";
 ...
 */
@Slf4j
public class Idea35353Service {
    private static final int IDEA_ID = 35353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35353Service() {
        this(new Idea35353Config());
    }

    public Idea35353Service(Idea35353Config config) {
        this.config = config != null ? config : new Idea35353Config();
