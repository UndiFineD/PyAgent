...
@Data
public class Idea35550Config {
    private String name = "idea_035550";
 ...
 */
@Slf4j
public class Idea35550Service {
    private static final int IDEA_ID = 35550;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35550Service() {
        this(new Idea35550Config());
    }

    public Idea35550Service(Idea35550Config config) {
        this.config = config != null ? config : new Idea35550Config();
