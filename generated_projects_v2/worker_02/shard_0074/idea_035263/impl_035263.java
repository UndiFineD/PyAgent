...
@Data
public class Idea35263Config {
    private String name = "idea_035263";
 ...
 */
@Slf4j
public class Idea35263Service {
    private static final int IDEA_ID = 35263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35263Service() {
        this(new Idea35263Config());
    }

    public Idea35263Service(Idea35263Config config) {
        this.config = config != null ? config : new Idea35263Config();
