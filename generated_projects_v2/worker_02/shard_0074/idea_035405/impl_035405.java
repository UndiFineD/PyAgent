...
@Data
public class Idea35405Config {
    private String name = "idea_035405";
 ...
 */
@Slf4j
public class Idea35405Service {
    private static final int IDEA_ID = 35405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35405Service() {
        this(new Idea35405Config());
    }

    public Idea35405Service(Idea35405Config config) {
        this.config = config != null ? config : new Idea35405Config();
