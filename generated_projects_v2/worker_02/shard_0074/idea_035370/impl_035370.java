...
@Data
public class Idea35370Config {
    private String name = "idea_035370";
 ...
 */
@Slf4j
public class Idea35370Service {
    private static final int IDEA_ID = 35370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35370Service() {
        this(new Idea35370Config());
    }

    public Idea35370Service(Idea35370Config config) {
        this.config = config != null ? config : new Idea35370Config();
