...
@Data
public class Idea35509Config {
    private String name = "idea_035509";
 ...
 */
@Slf4j
public class Idea35509Service {
    private static final int IDEA_ID = 35509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35509Service() {
        this(new Idea35509Config());
    }

    public Idea35509Service(Idea35509Config config) {
        this.config = config != null ? config : new Idea35509Config();
