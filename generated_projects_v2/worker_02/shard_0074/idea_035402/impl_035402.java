...
@Data
public class Idea35402Config {
    private String name = "idea_035402";
 ...
 */
@Slf4j
public class Idea35402Service {
    private static final int IDEA_ID = 35402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35402Service() {
        this(new Idea35402Config());
    }

    public Idea35402Service(Idea35402Config config) {
        this.config = config != null ? config : new Idea35402Config();
