...
@Data
public class Idea35538Config {
    private String name = "idea_035538";
 ...
 */
@Slf4j
public class Idea35538Service {
    private static final int IDEA_ID = 35538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35538Service() {
        this(new Idea35538Config());
    }

    public Idea35538Service(Idea35538Config config) {
        this.config = config != null ? config : new Idea35538Config();
