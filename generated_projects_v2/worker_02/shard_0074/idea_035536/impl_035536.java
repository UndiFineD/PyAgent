...
@Data
public class Idea35536Config {
    private String name = "idea_035536";
 ...
 */
@Slf4j
public class Idea35536Service {
    private static final int IDEA_ID = 35536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35536Service() {
        this(new Idea35536Config());
    }

    public Idea35536Service(Idea35536Config config) {
        this.config = config != null ? config : new Idea35536Config();
