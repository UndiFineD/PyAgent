...
@Data
public class Idea35151Config {
    private String name = "idea_035151";
 ...
 */
@Slf4j
public class Idea35151Service {
    private static final int IDEA_ID = 35151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35151Service() {
        this(new Idea35151Config());
    }

    public Idea35151Service(Idea35151Config config) {
        this.config = config != null ? config : new Idea35151Config();
