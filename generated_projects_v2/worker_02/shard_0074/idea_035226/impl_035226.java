...
@Data
public class Idea35226Config {
    private String name = "idea_035226";
 ...
 */
@Slf4j
public class Idea35226Service {
    private static final int IDEA_ID = 35226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35226Service() {
        this(new Idea35226Config());
    }

    public Idea35226Service(Idea35226Config config) {
        this.config = config != null ? config : new Idea35226Config();
