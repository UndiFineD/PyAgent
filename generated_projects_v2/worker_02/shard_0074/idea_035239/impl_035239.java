...
@Data
public class Idea35239Config {
    private String name = "idea_035239";
 ...
 */
@Slf4j
public class Idea35239Service {
    private static final int IDEA_ID = 35239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35239Service() {
        this(new Idea35239Config());
    }

    public Idea35239Service(Idea35239Config config) {
        this.config = config != null ? config : new Idea35239Config();
