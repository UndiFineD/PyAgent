...
@Data
public class Idea35269Config {
    private String name = "idea_035269";
 ...
 */
@Slf4j
public class Idea35269Service {
    private static final int IDEA_ID = 35269;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35269Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35269Service() {
        this(new Idea35269Config());
    }

    public Idea35269Service(Idea35269Config config) {
        this.config = config != null ? config : new Idea35269Config();
