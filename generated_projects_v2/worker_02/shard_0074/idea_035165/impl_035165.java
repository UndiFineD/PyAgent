...
@Data
public class Idea35165Config {
    private String name = "idea_035165";
 ...
 */
@Slf4j
public class Idea35165Service {
    private static final int IDEA_ID = 35165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35165Service() {
        this(new Idea35165Config());
    }

    public Idea35165Service(Idea35165Config config) {
        this.config = config != null ? config : new Idea35165Config();
