...
@Data
public class Idea35196Config {
    private String name = "idea_035196";
 ...
 */
@Slf4j
public class Idea35196Service {
    private static final int IDEA_ID = 35196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35196Service() {
        this(new Idea35196Config());
    }

    public Idea35196Service(Idea35196Config config) {
        this.config = config != null ? config : new Idea35196Config();
