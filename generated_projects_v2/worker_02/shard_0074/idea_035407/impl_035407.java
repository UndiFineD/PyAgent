...
@Data
public class Idea35407Config {
    private String name = "idea_035407";
 ...
 */
@Slf4j
public class Idea35407Service {
    private static final int IDEA_ID = 35407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35407Service() {
        this(new Idea35407Config());
    }

    public Idea35407Service(Idea35407Config config) {
        this.config = config != null ? config : new Idea35407Config();
