...
@Data
public class Idea35567Config {
    private String name = "idea_035567";
 ...
 */
@Slf4j
public class Idea35567Service {
    private static final int IDEA_ID = 35567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35567Service() {
        this(new Idea35567Config());
    }

    public Idea35567Service(Idea35567Config config) {
        this.config = config != null ? config : new Idea35567Config();
