...
@Data
public class Idea35482Config {
    private String name = "idea_035482";
 ...
 */
@Slf4j
public class Idea35482Service {
    private static final int IDEA_ID = 35482;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35482Service() {
        this(new Idea35482Config());
    }

    public Idea35482Service(Idea35482Config config) {
        this.config = config != null ? config : new Idea35482Config();
