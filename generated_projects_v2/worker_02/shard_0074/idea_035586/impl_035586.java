...
@Data
public class Idea35586Config {
    private String name = "idea_035586";
 ...
 */
@Slf4j
public class Idea35586Service {
    private static final int IDEA_ID = 35586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35586Service() {
        this(new Idea35586Config());
    }

    public Idea35586Service(Idea35586Config config) {
        this.config = config != null ? config : new Idea35586Config();
