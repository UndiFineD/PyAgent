...
@Data
public class Idea35398Config {
    private String name = "idea_035398";
 ...
 */
@Slf4j
public class Idea35398Service {
    private static final int IDEA_ID = 35398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35398Service() {
        this(new Idea35398Config());
    }

    public Idea35398Service(Idea35398Config config) {
        this.config = config != null ? config : new Idea35398Config();
