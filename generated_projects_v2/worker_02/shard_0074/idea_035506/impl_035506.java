...
@Data
public class Idea35506Config {
    private String name = "idea_035506";
 ...
 */
@Slf4j
public class Idea35506Service {
    private static final int IDEA_ID = 35506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35506Service() {
        this(new Idea35506Config());
    }

    public Idea35506Service(Idea35506Config config) {
        this.config = config != null ? config : new Idea35506Config();
