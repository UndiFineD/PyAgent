...
@Data
public class Idea35270Config {
    private String name = "idea_035270";
 ...
 */
@Slf4j
public class Idea35270Service {
    private static final int IDEA_ID = 35270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35270Service() {
        this(new Idea35270Config());
    }

    public Idea35270Service(Idea35270Config config) {
        this.config = config != null ? config : new Idea35270Config();
