...
@Data
public class Idea35410Config {
    private String name = "idea_035410";
 ...
 */
@Slf4j
public class Idea35410Service {
    private static final int IDEA_ID = 35410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35410Service() {
        this(new Idea35410Config());
    }

    public Idea35410Service(Idea35410Config config) {
        this.config = config != null ? config : new Idea35410Config();
