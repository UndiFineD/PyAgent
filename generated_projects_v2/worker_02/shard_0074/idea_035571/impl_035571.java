...
@Data
public class Idea35571Config {
    private String name = "idea_035571";
 ...
 */
@Slf4j
public class Idea35571Service {
    private static final int IDEA_ID = 35571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35571Service() {
        this(new Idea35571Config());
    }

    public Idea35571Service(Idea35571Config config) {
        this.config = config != null ? config : new Idea35571Config();
