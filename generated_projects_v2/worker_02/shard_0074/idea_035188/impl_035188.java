...
@Data
public class Idea35188Config {
    private String name = "idea_035188";
 ...
 */
@Slf4j
public class Idea35188Service {
    private static final int IDEA_ID = 35188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35188Service() {
        this(new Idea35188Config());
    }

    public Idea35188Service(Idea35188Config config) {
        this.config = config != null ? config : new Idea35188Config();
