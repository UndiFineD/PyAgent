...
@Data
public class Idea35387Config {
    private String name = "idea_035387";
 ...
 */
@Slf4j
public class Idea35387Service {
    private static final int IDEA_ID = 35387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35387Service() {
        this(new Idea35387Config());
    }

    public Idea35387Service(Idea35387Config config) {
        this.config = config != null ? config : new Idea35387Config();
