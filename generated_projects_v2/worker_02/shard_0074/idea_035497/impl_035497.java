...
@Data
public class Idea35497Config {
    private String name = "idea_035497";
 ...
 */
@Slf4j
public class Idea35497Service {
    private static final int IDEA_ID = 35497;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35497Service() {
        this(new Idea35497Config());
    }

    public Idea35497Service(Idea35497Config config) {
        this.config = config != null ? config : new Idea35497Config();
