...
@Data
public class Idea35198Config {
    private String name = "idea_035198";
 ...
 */
@Slf4j
public class Idea35198Service {
    private static final int IDEA_ID = 35198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35198Service() {
        this(new Idea35198Config());
    }

    public Idea35198Service(Idea35198Config config) {
        this.config = config != null ? config : new Idea35198Config();
