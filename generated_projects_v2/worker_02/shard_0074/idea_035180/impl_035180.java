...
@Data
public class Idea35180Config {
    private String name = "idea_035180";
 ...
 */
@Slf4j
public class Idea35180Service {
    private static final int IDEA_ID = 35180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35180Service() {
        this(new Idea35180Config());
    }

    public Idea35180Service(Idea35180Config config) {
        this.config = config != null ? config : new Idea35180Config();
