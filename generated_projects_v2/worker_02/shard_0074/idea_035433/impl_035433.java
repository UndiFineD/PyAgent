...
@Data
public class Idea35433Config {
    private String name = "idea_035433";
 ...
 */
@Slf4j
public class Idea35433Service {
    private static final int IDEA_ID = 35433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35433Service() {
        this(new Idea35433Config());
    }

    public Idea35433Service(Idea35433Config config) {
        this.config = config != null ? config : new Idea35433Config();
