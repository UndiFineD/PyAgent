...
@Data
public class Idea35271Config {
    private String name = "idea_035271";
 ...
 */
@Slf4j
public class Idea35271Service {
    private static final int IDEA_ID = 35271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35271Service() {
        this(new Idea35271Config());
    }

    public Idea35271Service(Idea35271Config config) {
        this.config = config != null ? config : new Idea35271Config();
