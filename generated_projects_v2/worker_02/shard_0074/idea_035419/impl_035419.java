...
@Data
public class Idea35419Config {
    private String name = "idea_035419";
 ...
 */
@Slf4j
public class Idea35419Service {
    private static final int IDEA_ID = 35419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35419Service() {
        this(new Idea35419Config());
    }

    public Idea35419Service(Idea35419Config config) {
        this.config = config != null ? config : new Idea35419Config();
