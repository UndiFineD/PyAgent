...
@Data
public class Idea35182Config {
    private String name = "idea_035182";
 ...
 */
@Slf4j
public class Idea35182Service {
    private static final int IDEA_ID = 35182;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35182Service() {
        this(new Idea35182Config());
    }

    public Idea35182Service(Idea35182Config config) {
        this.config = config != null ? config : new Idea35182Config();
