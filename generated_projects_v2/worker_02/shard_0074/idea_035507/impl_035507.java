...
@Data
public class Idea35507Config {
    private String name = "idea_035507";
 ...
 */
@Slf4j
public class Idea35507Service {
    private static final int IDEA_ID = 35507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35507Service() {
        this(new Idea35507Config());
    }

    public Idea35507Service(Idea35507Config config) {
        this.config = config != null ? config : new Idea35507Config();
