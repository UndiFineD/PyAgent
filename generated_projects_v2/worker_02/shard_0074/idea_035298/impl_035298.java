...
@Data
public class Idea35298Config {
    private String name = "idea_035298";
 ...
 */
@Slf4j
public class Idea35298Service {
    private static final int IDEA_ID = 35298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35298Service() {
        this(new Idea35298Config());
    }

    public Idea35298Service(Idea35298Config config) {
        this.config = config != null ? config : new Idea35298Config();
