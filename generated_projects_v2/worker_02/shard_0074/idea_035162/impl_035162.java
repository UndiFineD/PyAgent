...
@Data
public class Idea35162Config {
    private String name = "idea_035162";
 ...
 */
@Slf4j
public class Idea35162Service {
    private static final int IDEA_ID = 35162;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35162Service() {
        this(new Idea35162Config());
    }

    public Idea35162Service(Idea35162Config config) {
        this.config = config != null ? config : new Idea35162Config();
