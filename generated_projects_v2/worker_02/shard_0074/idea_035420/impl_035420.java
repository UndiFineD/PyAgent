...
@Data
public class Idea35420Config {
    private String name = "idea_035420";
 ...
 */
@Slf4j
public class Idea35420Service {
    private static final int IDEA_ID = 35420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35420Service() {
        this(new Idea35420Config());
    }

    public Idea35420Service(Idea35420Config config) {
        this.config = config != null ? config : new Idea35420Config();
