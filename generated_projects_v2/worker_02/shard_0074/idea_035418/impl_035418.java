...
@Data
public class Idea35418Config {
    private String name = "idea_035418";
 ...
 */
@Slf4j
public class Idea35418Service {
    private static final int IDEA_ID = 35418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35418Service() {
        this(new Idea35418Config());
    }

    public Idea35418Service(Idea35418Config config) {
        this.config = config != null ? config : new Idea35418Config();
