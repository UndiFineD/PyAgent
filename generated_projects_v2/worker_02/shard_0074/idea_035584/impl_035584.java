...
@Data
public class Idea35584Config {
    private String name = "idea_035584";
 ...
 */
@Slf4j
public class Idea35584Service {
    private static final int IDEA_ID = 35584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35584Service() {
        this(new Idea35584Config());
    }

    public Idea35584Service(Idea35584Config config) {
        this.config = config != null ? config : new Idea35584Config();
