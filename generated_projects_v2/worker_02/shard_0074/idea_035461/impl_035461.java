...
@Data
public class Idea35461Config {
    private String name = "idea_035461";
 ...
 */
@Slf4j
public class Idea35461Service {
    private static final int IDEA_ID = 35461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35461Service() {
        this(new Idea35461Config());
    }

    public Idea35461Service(Idea35461Config config) {
        this.config = config != null ? config : new Idea35461Config();
