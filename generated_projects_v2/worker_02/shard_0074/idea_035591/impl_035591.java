...
@Data
public class Idea35591Config {
    private String name = "idea_035591";
 ...
 */
@Slf4j
public class Idea35591Service {
    private static final int IDEA_ID = 35591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35591Service() {
        this(new Idea35591Config());
    }

    public Idea35591Service(Idea35591Config config) {
        this.config = config != null ? config : new Idea35591Config();
