...
@Data
public class Idea35539Config {
    private String name = "idea_035539";
 ...
 */
@Slf4j
public class Idea35539Service {
    private static final int IDEA_ID = 35539;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35539Service() {
        this(new Idea35539Config());
    }

    public Idea35539Service(Idea35539Config config) {
        this.config = config != null ? config : new Idea35539Config();
