...
@Data
public class Idea35563Config {
    private String name = "idea_035563";
 ...
 */
@Slf4j
public class Idea35563Service {
    private static final int IDEA_ID = 35563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35563Service() {
        this(new Idea35563Config());
    }

    public Idea35563Service(Idea35563Config config) {
        this.config = config != null ? config : new Idea35563Config();
