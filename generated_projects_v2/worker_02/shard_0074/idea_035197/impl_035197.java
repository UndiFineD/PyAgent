...
@Data
public class Idea35197Config {
    private String name = "idea_035197";
 ...
 */
@Slf4j
public class Idea35197Service {
    private static final int IDEA_ID = 35197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35197Service() {
        this(new Idea35197Config());
    }

    public Idea35197Service(Idea35197Config config) {
        this.config = config != null ? config : new Idea35197Config();
