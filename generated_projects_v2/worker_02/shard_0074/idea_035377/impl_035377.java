...
@Data
public class Idea35377Config {
    private String name = "idea_035377";
 ...
 */
@Slf4j
public class Idea35377Service {
    private static final int IDEA_ID = 35377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35377Service() {
        this(new Idea35377Config());
    }

    public Idea35377Service(Idea35377Config config) {
        this.config = config != null ? config : new Idea35377Config();
