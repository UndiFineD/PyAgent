...
@Data
public class Idea35447Config {
    private String name = "idea_035447";
 ...
 */
@Slf4j
public class Idea35447Service {
    private static final int IDEA_ID = 35447;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35447Service() {
        this(new Idea35447Config());
    }

    public Idea35447Service(Idea35447Config config) {
        this.config = config != null ? config : new Idea35447Config();
