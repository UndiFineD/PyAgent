...
@Data
public class Idea35340Config {
    private String name = "idea_035340";
 ...
 */
@Slf4j
public class Idea35340Service {
    private static final int IDEA_ID = 35340;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35340Service() {
        this(new Idea35340Config());
    }

    public Idea35340Service(Idea35340Config config) {
        this.config = config != null ? config : new Idea35340Config();
