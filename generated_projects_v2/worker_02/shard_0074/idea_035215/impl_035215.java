...
@Data
public class Idea35215Config {
    private String name = "idea_035215";
 ...
 */
@Slf4j
public class Idea35215Service {
    private static final int IDEA_ID = 35215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35215Service() {
        this(new Idea35215Config());
    }

    public Idea35215Service(Idea35215Config config) {
        this.config = config != null ? config : new Idea35215Config();
