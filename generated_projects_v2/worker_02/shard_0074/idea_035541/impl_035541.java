...
@Data
public class Idea35541Config {
    private String name = "idea_035541";
 ...
 */
@Slf4j
public class Idea35541Service {
    private static final int IDEA_ID = 35541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35541Service() {
        this(new Idea35541Config());
    }

    public Idea35541Service(Idea35541Config config) {
        this.config = config != null ? config : new Idea35541Config();
