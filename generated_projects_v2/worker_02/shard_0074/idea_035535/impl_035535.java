...
@Data
public class Idea35535Config {
    private String name = "idea_035535";
 ...
 */
@Slf4j
public class Idea35535Service {
    private static final int IDEA_ID = 35535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35535Service() {
        this(new Idea35535Config());
    }

    public Idea35535Service(Idea35535Config config) {
        this.config = config != null ? config : new Idea35535Config();
