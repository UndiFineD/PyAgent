...
@Data
public class Idea35218Config {
    private String name = "idea_035218";
 ...
 */
@Slf4j
public class Idea35218Service {
    private static final int IDEA_ID = 35218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35218Service() {
        this(new Idea35218Config());
    }

    public Idea35218Service(Idea35218Config config) {
        this.config = config != null ? config : new Idea35218Config();
