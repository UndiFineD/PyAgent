...
@Data
public class Idea35236Config {
    private String name = "idea_035236";
 ...
 */
@Slf4j
public class Idea35236Service {
    private static final int IDEA_ID = 35236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35236Service() {
        this(new Idea35236Config());
    }

    public Idea35236Service(Idea35236Config config) {
        this.config = config != null ? config : new Idea35236Config();
