...
@Data
public class Idea35579Config {
    private String name = "idea_035579";
 ...
 */
@Slf4j
public class Idea35579Service {
    private static final int IDEA_ID = 35579;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35579Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35579Service() {
        this(new Idea35579Config());
    }

    public Idea35579Service(Idea35579Config config) {
        this.config = config != null ? config : new Idea35579Config();
