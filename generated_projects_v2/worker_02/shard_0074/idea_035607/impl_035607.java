...
@Data
public class Idea35607Config {
    private String name = "idea_035607";
 ...
 */
@Slf4j
public class Idea35607Service {
    private static final int IDEA_ID = 35607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35607Service() {
        this(new Idea35607Config());
    }

    public Idea35607Service(Idea35607Config config) {
        this.config = config != null ? config : new Idea35607Config();
