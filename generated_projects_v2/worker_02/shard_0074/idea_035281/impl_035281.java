...
@Data
public class Idea35281Config {
    private String name = "idea_035281";
 ...
 */
@Slf4j
public class Idea35281Service {
    private static final int IDEA_ID = 35281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35281Service() {
        this(new Idea35281Config());
    }

    public Idea35281Service(Idea35281Config config) {
        this.config = config != null ? config : new Idea35281Config();
