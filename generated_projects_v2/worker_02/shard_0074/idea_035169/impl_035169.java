...
@Data
public class Idea35169Config {
    private String name = "idea_035169";
 ...
 */
@Slf4j
public class Idea35169Service {
    private static final int IDEA_ID = 35169;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35169Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35169Service() {
        this(new Idea35169Config());
    }

    public Idea35169Service(Idea35169Config config) {
        this.config = config != null ? config : new Idea35169Config();
