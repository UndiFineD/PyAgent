...
@Data
public class Idea35430Config {
    private String name = "idea_035430";
 ...
 */
@Slf4j
public class Idea35430Service {
    private static final int IDEA_ID = 35430;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35430Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35430Service() {
        this(new Idea35430Config());
    }

    public Idea35430Service(Idea35430Config config) {
        this.config = config != null ? config : new Idea35430Config();
