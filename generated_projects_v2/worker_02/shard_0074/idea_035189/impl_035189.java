...
@Data
public class Idea35189Config {
    private String name = "idea_035189";
 ...
 */
@Slf4j
public class Idea35189Service {
    private static final int IDEA_ID = 35189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35189Service() {
        this(new Idea35189Config());
    }

    public Idea35189Service(Idea35189Config config) {
        this.config = config != null ? config : new Idea35189Config();
