...
@Data
public class Idea35184Config {
    private String name = "idea_035184";
 ...
 */
@Slf4j
public class Idea35184Service {
    private static final int IDEA_ID = 35184;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35184Service() {
        this(new Idea35184Config());
    }

    public Idea35184Service(Idea35184Config config) {
        this.config = config != null ? config : new Idea35184Config();
