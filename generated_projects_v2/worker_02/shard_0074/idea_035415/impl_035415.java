...
@Data
public class Idea35415Config {
    private String name = "idea_035415";
 ...
 */
@Slf4j
public class Idea35415Service {
    private static final int IDEA_ID = 35415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35415Service() {
        this(new Idea35415Config());
    }

    public Idea35415Service(Idea35415Config config) {
        this.config = config != null ? config : new Idea35415Config();
