...
@Data
public class Idea35238Config {
    private String name = "idea_035238";
 ...
 */
@Slf4j
public class Idea35238Service {
    private static final int IDEA_ID = 35238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35238Service() {
        this(new Idea35238Config());
    }

    public Idea35238Service(Idea35238Config config) {
        this.config = config != null ? config : new Idea35238Config();
