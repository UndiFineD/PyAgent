...
@Data
public class Idea35168Config {
    private String name = "idea_035168";
 ...
 */
@Slf4j
public class Idea35168Service {
    private static final int IDEA_ID = 35168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35168Service() {
        this(new Idea35168Config());
    }

    public Idea35168Service(Idea35168Config config) {
        this.config = config != null ? config : new Idea35168Config();
