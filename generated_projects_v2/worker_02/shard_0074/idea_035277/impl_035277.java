...
@Data
public class Idea35277Config {
    private String name = "idea_035277";
 ...
 */
@Slf4j
public class Idea35277Service {
    private static final int IDEA_ID = 35277;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35277Service() {
        this(new Idea35277Config());
    }

    public Idea35277Service(Idea35277Config config) {
        this.config = config != null ? config : new Idea35277Config();
