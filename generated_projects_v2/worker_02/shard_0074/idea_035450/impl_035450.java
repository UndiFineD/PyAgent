...
@Data
public class Idea35450Config {
    private String name = "idea_035450";
 ...
 */
@Slf4j
public class Idea35450Service {
    private static final int IDEA_ID = 35450;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35450Service() {
        this(new Idea35450Config());
    }

    public Idea35450Service(Idea35450Config config) {
        this.config = config != null ? config : new Idea35450Config();
