...
@Data
public class Idea35173Config {
    private String name = "idea_035173";
 ...
 */
@Slf4j
public class Idea35173Service {
    private static final int IDEA_ID = 35173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35173Service() {
        this(new Idea35173Config());
    }

    public Idea35173Service(Idea35173Config config) {
        this.config = config != null ? config : new Idea35173Config();
