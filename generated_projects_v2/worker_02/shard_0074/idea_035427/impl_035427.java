...
@Data
public class Idea35427Config {
    private String name = "idea_035427";
 ...
 */
@Slf4j
public class Idea35427Service {
    private static final int IDEA_ID = 35427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35427Service() {
        this(new Idea35427Config());
    }

    public Idea35427Service(Idea35427Config config) {
        this.config = config != null ? config : new Idea35427Config();
