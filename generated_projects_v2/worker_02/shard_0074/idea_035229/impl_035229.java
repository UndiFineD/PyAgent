...
@Data
public class Idea35229Config {
    private String name = "idea_035229";
 ...
 */
@Slf4j
public class Idea35229Service {
    private static final int IDEA_ID = 35229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35229Service() {
        this(new Idea35229Config());
    }

    public Idea35229Service(Idea35229Config config) {
        this.config = config != null ? config : new Idea35229Config();
