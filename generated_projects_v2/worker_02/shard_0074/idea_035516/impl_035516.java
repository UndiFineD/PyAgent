...
@Data
public class Idea35516Config {
    private String name = "idea_035516";
 ...
 */
@Slf4j
public class Idea35516Service {
    private static final int IDEA_ID = 35516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35516Service() {
        this(new Idea35516Config());
    }

    public Idea35516Service(Idea35516Config config) {
        this.config = config != null ? config : new Idea35516Config();
