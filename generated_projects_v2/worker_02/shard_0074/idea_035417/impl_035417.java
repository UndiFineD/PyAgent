...
@Data
public class Idea35417Config {
    private String name = "idea_035417";
 ...
 */
@Slf4j
public class Idea35417Service {
    private static final int IDEA_ID = 35417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35417Service() {
        this(new Idea35417Config());
    }

    public Idea35417Service(Idea35417Config config) {
        this.config = config != null ? config : new Idea35417Config();
