...
@Data
public class Idea35210Config {
    private String name = "idea_035210";
 ...
 */
@Slf4j
public class Idea35210Service {
    private static final int IDEA_ID = 35210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35210Service() {
        this(new Idea35210Config());
    }

    public Idea35210Service(Idea35210Config config) {
        this.config = config != null ? config : new Idea35210Config();
