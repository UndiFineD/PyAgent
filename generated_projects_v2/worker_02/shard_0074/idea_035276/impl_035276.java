...
@Data
public class Idea35276Config {
    private String name = "idea_035276";
 ...
 */
@Slf4j
public class Idea35276Service {
    private static final int IDEA_ID = 35276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35276Service() {
        this(new Idea35276Config());
    }

    public Idea35276Service(Idea35276Config config) {
        this.config = config != null ? config : new Idea35276Config();
