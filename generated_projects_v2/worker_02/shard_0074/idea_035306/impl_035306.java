...
@Data
public class Idea35306Config {
    private String name = "idea_035306";
 ...
 */
@Slf4j
public class Idea35306Service {
    private static final int IDEA_ID = 35306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35306Service() {
        this(new Idea35306Config());
    }

    public Idea35306Service(Idea35306Config config) {
        this.config = config != null ? config : new Idea35306Config();
