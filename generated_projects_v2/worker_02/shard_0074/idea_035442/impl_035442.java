...
@Data
public class Idea35442Config {
    private String name = "idea_035442";
 ...
 */
@Slf4j
public class Idea35442Service {
    private static final int IDEA_ID = 35442;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35442Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35442Service() {
        this(new Idea35442Config());
    }

    public Idea35442Service(Idea35442Config config) {
        this.config = config != null ? config : new Idea35442Config();
