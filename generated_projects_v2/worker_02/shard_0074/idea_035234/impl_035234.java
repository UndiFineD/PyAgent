...
@Data
public class Idea35234Config {
    private String name = "idea_035234";
 ...
 */
@Slf4j
public class Idea35234Service {
    private static final int IDEA_ID = 35234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35234Service() {
        this(new Idea35234Config());
    }

    public Idea35234Service(Idea35234Config config) {
        this.config = config != null ? config : new Idea35234Config();
