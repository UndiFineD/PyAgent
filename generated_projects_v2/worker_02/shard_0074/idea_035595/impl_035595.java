...
@Data
public class Idea35595Config {
    private String name = "idea_035595";
 ...
 */
@Slf4j
public class Idea35595Service {
    private static final int IDEA_ID = 35595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35595Service() {
        this(new Idea35595Config());
    }

    public Idea35595Service(Idea35595Config config) {
        this.config = config != null ? config : new Idea35595Config();
