...
@Data
public class Idea35305Config {
    private String name = "idea_035305";
 ...
 */
@Slf4j
public class Idea35305Service {
    private static final int IDEA_ID = 35305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35305Service() {
        this(new Idea35305Config());
    }

    public Idea35305Service(Idea35305Config config) {
        this.config = config != null ? config : new Idea35305Config();
