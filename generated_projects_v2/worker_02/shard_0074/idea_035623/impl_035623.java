...
@Data
public class Idea35623Config {
    private String name = "idea_035623";
 ...
 */
@Slf4j
public class Idea35623Service {
    private static final int IDEA_ID = 35623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35623Service() {
        this(new Idea35623Config());
    }

    public Idea35623Service(Idea35623Config config) {
        this.config = config != null ? config : new Idea35623Config();
