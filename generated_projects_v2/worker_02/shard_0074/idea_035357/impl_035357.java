...
@Data
public class Idea35357Config {
    private String name = "idea_035357";
 ...
 */
@Slf4j
public class Idea35357Service {
    private static final int IDEA_ID = 35357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35357Service() {
        this(new Idea35357Config());
    }

    public Idea35357Service(Idea35357Config config) {
        this.config = config != null ? config : new Idea35357Config();
