...
@Data
public class Idea35375Config {
    private String name = "idea_035375";
 ...
 */
@Slf4j
public class Idea35375Service {
    private static final int IDEA_ID = 35375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35375Service() {
        this(new Idea35375Config());
    }

    public Idea35375Service(Idea35375Config config) {
        this.config = config != null ? config : new Idea35375Config();
