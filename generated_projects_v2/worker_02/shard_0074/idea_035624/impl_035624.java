...
@Data
public class Idea35624Config {
    private String name = "idea_035624";
 ...
 */
@Slf4j
public class Idea35624Service {
    private static final int IDEA_ID = 35624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35624Service() {
        this(new Idea35624Config());
    }

    public Idea35624Service(Idea35624Config config) {
        this.config = config != null ? config : new Idea35624Config();
