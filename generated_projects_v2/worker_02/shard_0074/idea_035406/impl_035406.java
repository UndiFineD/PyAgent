...
@Data
public class Idea35406Config {
    private String name = "idea_035406";
 ...
 */
@Slf4j
public class Idea35406Service {
    private static final int IDEA_ID = 35406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35406Service() {
        this(new Idea35406Config());
    }

    public Idea35406Service(Idea35406Config config) {
        this.config = config != null ? config : new Idea35406Config();
