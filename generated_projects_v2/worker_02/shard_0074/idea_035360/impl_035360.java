...
@Data
public class Idea35360Config {
    private String name = "idea_035360";
 ...
 */
@Slf4j
public class Idea35360Service {
    private static final int IDEA_ID = 35360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35360Service() {
        this(new Idea35360Config());
    }

    public Idea35360Service(Idea35360Config config) {
        this.config = config != null ? config : new Idea35360Config();
