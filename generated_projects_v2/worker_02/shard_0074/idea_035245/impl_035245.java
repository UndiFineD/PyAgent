...
@Data
public class Idea35245Config {
    private String name = "idea_035245";
 ...
 */
@Slf4j
public class Idea35245Service {
    private static final int IDEA_ID = 35245;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35245Service() {
        this(new Idea35245Config());
    }

    public Idea35245Service(Idea35245Config config) {
        this.config = config != null ? config : new Idea35245Config();
