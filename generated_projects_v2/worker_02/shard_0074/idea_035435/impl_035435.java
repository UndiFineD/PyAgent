...
@Data
public class Idea35435Config {
    private String name = "idea_035435";
 ...
 */
@Slf4j
public class Idea35435Service {
    private static final int IDEA_ID = 35435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35435Service() {
        this(new Idea35435Config());
    }

    public Idea35435Service(Idea35435Config config) {
        this.config = config != null ? config : new Idea35435Config();
