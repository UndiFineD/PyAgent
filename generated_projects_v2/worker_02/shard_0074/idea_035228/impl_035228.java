...
@Data
public class Idea35228Config {
    private String name = "idea_035228";
 ...
 */
@Slf4j
public class Idea35228Service {
    private static final int IDEA_ID = 35228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35228Service() {
        this(new Idea35228Config());
    }

    public Idea35228Service(Idea35228Config config) {
        this.config = config != null ? config : new Idea35228Config();
