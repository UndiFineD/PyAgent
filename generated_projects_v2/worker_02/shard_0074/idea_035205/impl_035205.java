...
@Data
public class Idea35205Config {
    private String name = "idea_035205";
 ...
 */
@Slf4j
public class Idea35205Service {
    private static final int IDEA_ID = 35205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35205Service() {
        this(new Idea35205Config());
    }

    public Idea35205Service(Idea35205Config config) {
        this.config = config != null ? config : new Idea35205Config();
