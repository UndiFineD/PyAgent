...
@Data
public class Idea35290Config {
    private String name = "idea_035290";
 ...
 */
@Slf4j
public class Idea35290Service {
    private static final int IDEA_ID = 35290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35290Service() {
        this(new Idea35290Config());
    }

    public Idea35290Service(Idea35290Config config) {
        this.config = config != null ? config : new Idea35290Config();
