...
@Data
public class Idea35530Config {
    private String name = "idea_035530";
 ...
 */
@Slf4j
public class Idea35530Service {
    private static final int IDEA_ID = 35530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35530Service() {
        this(new Idea35530Config());
    }

    public Idea35530Service(Idea35530Config config) {
        this.config = config != null ? config : new Idea35530Config();
