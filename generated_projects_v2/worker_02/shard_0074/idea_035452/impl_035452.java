...
@Data
public class Idea35452Config {
    private String name = "idea_035452";
 ...
 */
@Slf4j
public class Idea35452Service {
    private static final int IDEA_ID = 35452;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35452Service() {
        this(new Idea35452Config());
    }

    public Idea35452Service(Idea35452Config config) {
        this.config = config != null ? config : new Idea35452Config();
