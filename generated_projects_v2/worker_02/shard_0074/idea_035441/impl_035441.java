...
@Data
public class Idea35441Config {
    private String name = "idea_035441";
 ...
 */
@Slf4j
public class Idea35441Service {
    private static final int IDEA_ID = 35441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35441Service() {
        this(new Idea35441Config());
    }

    public Idea35441Service(Idea35441Config config) {
        this.config = config != null ? config : new Idea35441Config();
