...
@Data
public class Idea35256Config {
    private String name = "idea_035256";
 ...
 */
@Slf4j
public class Idea35256Service {
    private static final int IDEA_ID = 35256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35256Service() {
        this(new Idea35256Config());
    }

    public Idea35256Service(Idea35256Config config) {
        this.config = config != null ? config : new Idea35256Config();
