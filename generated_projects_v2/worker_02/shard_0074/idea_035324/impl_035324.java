...
@Data
public class Idea35324Config {
    private String name = "idea_035324";
 ...
 */
@Slf4j
public class Idea35324Service {
    private static final int IDEA_ID = 35324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35324Service() {
        this(new Idea35324Config());
    }

    public Idea35324Service(Idea35324Config config) {
        this.config = config != null ? config : new Idea35324Config();
