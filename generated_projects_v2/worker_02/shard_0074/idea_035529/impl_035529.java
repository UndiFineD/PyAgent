...
@Data
public class Idea35529Config {
    private String name = "idea_035529";
 ...
 */
@Slf4j
public class Idea35529Service {
    private static final int IDEA_ID = 35529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35529Service() {
        this(new Idea35529Config());
    }

    public Idea35529Service(Idea35529Config config) {
        this.config = config != null ? config : new Idea35529Config();
