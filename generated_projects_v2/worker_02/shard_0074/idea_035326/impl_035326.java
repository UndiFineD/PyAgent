...
@Data
public class Idea35326Config {
    private String name = "idea_035326";
 ...
 */
@Slf4j
public class Idea35326Service {
    private static final int IDEA_ID = 35326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35326Service() {
        this(new Idea35326Config());
    }

    public Idea35326Service(Idea35326Config config) {
        this.config = config != null ? config : new Idea35326Config();
