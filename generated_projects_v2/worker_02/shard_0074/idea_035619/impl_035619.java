...
@Data
public class Idea35619Config {
    private String name = "idea_035619";
 ...
 */
@Slf4j
public class Idea35619Service {
    private static final int IDEA_ID = 35619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35619Service() {
        this(new Idea35619Config());
    }

    public Idea35619Service(Idea35619Config config) {
        this.config = config != null ? config : new Idea35619Config();
