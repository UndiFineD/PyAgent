...
@Data
public class Idea35445Config {
    private String name = "idea_035445";
 ...
 */
@Slf4j
public class Idea35445Service {
    private static final int IDEA_ID = 35445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35445Service() {
        this(new Idea35445Config());
    }

    public Idea35445Service(Idea35445Config config) {
        this.config = config != null ? config : new Idea35445Config();
