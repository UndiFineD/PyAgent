...
@Data
public class Idea35262Config {
    private String name = "idea_035262";
 ...
 */
@Slf4j
public class Idea35262Service {
    private static final int IDEA_ID = 35262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35262Service() {
        this(new Idea35262Config());
    }

    public Idea35262Service(Idea35262Config config) {
        this.config = config != null ? config : new Idea35262Config();
