...
@Data
public class Idea35323Config {
    private String name = "idea_035323";
 ...
 */
@Slf4j
public class Idea35323Service {
    private static final int IDEA_ID = 35323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35323Service() {
        this(new Idea35323Config());
    }

    public Idea35323Service(Idea35323Config config) {
        this.config = config != null ? config : new Idea35323Config();
