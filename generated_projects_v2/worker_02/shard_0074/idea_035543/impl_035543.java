...
@Data
public class Idea35543Config {
    private String name = "idea_035543";
 ...
 */
@Slf4j
public class Idea35543Service {
    private static final int IDEA_ID = 35543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35543Service() {
        this(new Idea35543Config());
    }

    public Idea35543Service(Idea35543Config config) {
        this.config = config != null ? config : new Idea35543Config();
