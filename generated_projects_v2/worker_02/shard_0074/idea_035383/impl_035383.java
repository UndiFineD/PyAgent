...
@Data
public class Idea35383Config {
    private String name = "idea_035383";
 ...
 */
@Slf4j
public class Idea35383Service {
    private static final int IDEA_ID = 35383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35383Service() {
        this(new Idea35383Config());
    }

    public Idea35383Service(Idea35383Config config) {
        this.config = config != null ? config : new Idea35383Config();
