...
@Data
public class Idea35505Config {
    private String name = "idea_035505";
 ...
 */
@Slf4j
public class Idea35505Service {
    private static final int IDEA_ID = 35505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35505Service() {
        this(new Idea35505Config());
    }

    public Idea35505Service(Idea35505Config config) {
        this.config = config != null ? config : new Idea35505Config();
