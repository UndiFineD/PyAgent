...
@Data
public class Idea35592Config {
    private String name = "idea_035592";
 ...
 */
@Slf4j
public class Idea35592Service {
    private static final int IDEA_ID = 35592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35592Service() {
        this(new Idea35592Config());
    }

    public Idea35592Service(Idea35592Config config) {
        this.config = config != null ? config : new Idea35592Config();
