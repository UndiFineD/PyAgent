...
@Data
public class Idea35250Config {
    private String name = "idea_035250";
 ...
 */
@Slf4j
public class Idea35250Service {
    private static final int IDEA_ID = 35250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35250Service() {
        this(new Idea35250Config());
    }

    public Idea35250Service(Idea35250Config config) {
        this.config = config != null ? config : new Idea35250Config();
