...
@Data
public class Idea35411Config {
    private String name = "idea_035411";
 ...
 */
@Slf4j
public class Idea35411Service {
    private static final int IDEA_ID = 35411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35411Service() {
        this(new Idea35411Config());
    }

    public Idea35411Service(Idea35411Config config) {
        this.config = config != null ? config : new Idea35411Config();
