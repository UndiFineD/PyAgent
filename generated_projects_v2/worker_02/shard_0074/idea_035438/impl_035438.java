...
@Data
public class Idea35438Config {
    private String name = "idea_035438";
 ...
 */
@Slf4j
public class Idea35438Service {
    private static final int IDEA_ID = 35438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35438Service() {
        this(new Idea35438Config());
    }

    public Idea35438Service(Idea35438Config config) {
        this.config = config != null ? config : new Idea35438Config();
