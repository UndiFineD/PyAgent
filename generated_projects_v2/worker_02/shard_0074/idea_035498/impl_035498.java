...
@Data
public class Idea35498Config {
    private String name = "idea_035498";
 ...
 */
@Slf4j
public class Idea35498Service {
    private static final int IDEA_ID = 35498;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35498Service() {
        this(new Idea35498Config());
    }

    public Idea35498Service(Idea35498Config config) {
        this.config = config != null ? config : new Idea35498Config();
