...
@Data
public class Idea35192Config {
    private String name = "idea_035192";
 ...
 */
@Slf4j
public class Idea35192Service {
    private static final int IDEA_ID = 35192;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35192Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35192Service() {
        this(new Idea35192Config());
    }

    public Idea35192Service(Idea35192Config config) {
        this.config = config != null ? config : new Idea35192Config();
