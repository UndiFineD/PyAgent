...
@Data
public class Idea35267Config {
    private String name = "idea_035267";
 ...
 */
@Slf4j
public class Idea35267Service {
    private static final int IDEA_ID = 35267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35267Service() {
        this(new Idea35267Config());
    }

    public Idea35267Service(Idea35267Config config) {
        this.config = config != null ? config : new Idea35267Config();
