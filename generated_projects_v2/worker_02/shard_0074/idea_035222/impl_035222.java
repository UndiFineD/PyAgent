...
@Data
public class Idea35222Config {
    private String name = "idea_035222";
 ...
 */
@Slf4j
public class Idea35222Service {
    private static final int IDEA_ID = 35222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35222Service() {
        this(new Idea35222Config());
    }

    public Idea35222Service(Idea35222Config config) {
        this.config = config != null ? config : new Idea35222Config();
