...
@Data
public class Idea35477Config {
    private String name = "idea_035477";
 ...
 */
@Slf4j
public class Idea35477Service {
    private static final int IDEA_ID = 35477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35477Service() {
        this(new Idea35477Config());
    }

    public Idea35477Service(Idea35477Config config) {
        this.config = config != null ? config : new Idea35477Config();
