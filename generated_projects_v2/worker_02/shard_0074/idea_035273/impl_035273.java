...
@Data
public class Idea35273Config {
    private String name = "idea_035273";
 ...
 */
@Slf4j
public class Idea35273Service {
    private static final int IDEA_ID = 35273;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35273Service() {
        this(new Idea35273Config());
    }

    public Idea35273Service(Idea35273Config config) {
        this.config = config != null ? config : new Idea35273Config();
