...
@Data
public class Idea35216Config {
    private String name = "idea_035216";
 ...
 */
@Slf4j
public class Idea35216Service {
    private static final int IDEA_ID = 35216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35216Service() {
        this(new Idea35216Config());
    }

    public Idea35216Service(Idea35216Config config) {
        this.config = config != null ? config : new Idea35216Config();
