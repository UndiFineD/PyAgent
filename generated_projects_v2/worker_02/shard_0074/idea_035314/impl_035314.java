...
@Data
public class Idea35314Config {
    private String name = "idea_035314";
 ...
 */
@Slf4j
public class Idea35314Service {
    private static final int IDEA_ID = 35314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35314Service() {
        this(new Idea35314Config());
    }

    public Idea35314Service(Idea35314Config config) {
        this.config = config != null ? config : new Idea35314Config();
