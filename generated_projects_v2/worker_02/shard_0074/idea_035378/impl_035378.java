...
@Data
public class Idea35378Config {
    private String name = "idea_035378";
 ...
 */
@Slf4j
public class Idea35378Service {
    private static final int IDEA_ID = 35378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35378Service() {
        this(new Idea35378Config());
    }

    public Idea35378Service(Idea35378Config config) {
        this.config = config != null ? config : new Idea35378Config();
