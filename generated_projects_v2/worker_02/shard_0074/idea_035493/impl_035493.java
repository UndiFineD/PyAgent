...
@Data
public class Idea35493Config {
    private String name = "idea_035493";
 ...
 */
@Slf4j
public class Idea35493Service {
    private static final int IDEA_ID = 35493;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35493Service() {
        this(new Idea35493Config());
    }

    public Idea35493Service(Idea35493Config config) {
        this.config = config != null ? config : new Idea35493Config();
