...
@Data
public class Idea35414Config {
    private String name = "idea_035414";
 ...
 */
@Slf4j
public class Idea35414Service {
    private static final int IDEA_ID = 35414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35414Service() {
        this(new Idea35414Config());
    }

    public Idea35414Service(Idea35414Config config) {
        this.config = config != null ? config : new Idea35414Config();
