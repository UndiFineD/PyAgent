...
@Data
public class Idea35359Config {
    private String name = "idea_035359";
 ...
 */
@Slf4j
public class Idea35359Service {
    private static final int IDEA_ID = 35359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35359Service() {
        this(new Idea35359Config());
    }

    public Idea35359Service(Idea35359Config config) {
        this.config = config != null ? config : new Idea35359Config();
