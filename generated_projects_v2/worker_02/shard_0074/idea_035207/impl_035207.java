...
@Data
public class Idea35207Config {
    private String name = "idea_035207";
 ...
 */
@Slf4j
public class Idea35207Service {
    private static final int IDEA_ID = 35207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35207Service() {
        this(new Idea35207Config());
    }

    public Idea35207Service(Idea35207Config config) {
        this.config = config != null ? config : new Idea35207Config();
