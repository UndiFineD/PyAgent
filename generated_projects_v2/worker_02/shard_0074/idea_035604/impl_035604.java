...
@Data
public class Idea35604Config {
    private String name = "idea_035604";
 ...
 */
@Slf4j
public class Idea35604Service {
    private static final int IDEA_ID = 35604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35604Service() {
        this(new Idea35604Config());
    }

    public Idea35604Service(Idea35604Config config) {
        this.config = config != null ? config : new Idea35604Config();
