...
@Data
public class Idea35473Config {
    private String name = "idea_035473";
 ...
 */
@Slf4j
public class Idea35473Service {
    private static final int IDEA_ID = 35473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35473Service() {
        this(new Idea35473Config());
    }

    public Idea35473Service(Idea35473Config config) {
        this.config = config != null ? config : new Idea35473Config();
