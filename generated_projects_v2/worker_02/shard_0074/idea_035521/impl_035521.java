...
@Data
public class Idea35521Config {
    private String name = "idea_035521";
 ...
 */
@Slf4j
public class Idea35521Service {
    private static final int IDEA_ID = 35521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35521Service() {
        this(new Idea35521Config());
    }

    public Idea35521Service(Idea35521Config config) {
        this.config = config != null ? config : new Idea35521Config();
