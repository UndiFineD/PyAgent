...
@Data
public class Idea35157Config {
    private String name = "idea_035157";
 ...
 */
@Slf4j
public class Idea35157Service {
    private static final int IDEA_ID = 35157;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35157Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35157Service() {
        this(new Idea35157Config());
    }

    public Idea35157Service(Idea35157Config config) {
        this.config = config != null ? config : new Idea35157Config();
