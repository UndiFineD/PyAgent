...
@Data
public class Idea35519Config {
    private String name = "idea_035519";
 ...
 */
@Slf4j
public class Idea35519Service {
    private static final int IDEA_ID = 35519;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35519Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35519Service() {
        this(new Idea35519Config());
    }

    public Idea35519Service(Idea35519Config config) {
        this.config = config != null ? config : new Idea35519Config();
