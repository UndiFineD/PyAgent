...
@Data
public class Idea35476Config {
    private String name = "idea_035476";
 ...
 */
@Slf4j
public class Idea35476Service {
    private static final int IDEA_ID = 35476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35476Service() {
        this(new Idea35476Config());
    }

    public Idea35476Service(Idea35476Config config) {
        this.config = config != null ? config : new Idea35476Config();
