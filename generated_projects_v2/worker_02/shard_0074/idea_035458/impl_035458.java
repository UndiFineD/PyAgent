...
@Data
public class Idea35458Config {
    private String name = "idea_035458";
 ...
 */
@Slf4j
public class Idea35458Service {
    private static final int IDEA_ID = 35458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35458Service() {
        this(new Idea35458Config());
    }

    public Idea35458Service(Idea35458Config config) {
        this.config = config != null ? config : new Idea35458Config();
