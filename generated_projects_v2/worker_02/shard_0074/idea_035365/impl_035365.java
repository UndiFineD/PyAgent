...
@Data
public class Idea35365Config {
    private String name = "idea_035365";
 ...
 */
@Slf4j
public class Idea35365Service {
    private static final int IDEA_ID = 35365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35365Service() {
        this(new Idea35365Config());
    }

    public Idea35365Service(Idea35365Config config) {
        this.config = config != null ? config : new Idea35365Config();
