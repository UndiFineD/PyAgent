...
@Data
public class Idea35230Config {
    private String name = "idea_035230";
 ...
 */
@Slf4j
public class Idea35230Service {
    private static final int IDEA_ID = 35230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35230Service() {
        this(new Idea35230Config());
    }

    public Idea35230Service(Idea35230Config config) {
        this.config = config != null ? config : new Idea35230Config();
