...
@Data
public class Idea35399Config {
    private String name = "idea_035399";
 ...
 */
@Slf4j
public class Idea35399Service {
    private static final int IDEA_ID = 35399;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35399Service() {
        this(new Idea35399Config());
    }

    public Idea35399Service(Idea35399Config config) {
        this.config = config != null ? config : new Idea35399Config();
