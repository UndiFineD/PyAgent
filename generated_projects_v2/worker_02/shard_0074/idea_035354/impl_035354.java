...
@Data
public class Idea35354Config {
    private String name = "idea_035354";
 ...
 */
@Slf4j
public class Idea35354Service {
    private static final int IDEA_ID = 35354;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35354Service() {
        this(new Idea35354Config());
    }

    public Idea35354Service(Idea35354Config config) {
        this.config = config != null ? config : new Idea35354Config();
