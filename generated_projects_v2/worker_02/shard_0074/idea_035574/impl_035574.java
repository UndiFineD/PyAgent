...
@Data
public class Idea35574Config {
    private String name = "idea_035574";
 ...
 */
@Slf4j
public class Idea35574Service {
    private static final int IDEA_ID = 35574;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35574Service() {
        this(new Idea35574Config());
    }

    public Idea35574Service(Idea35574Config config) {
        this.config = config != null ? config : new Idea35574Config();
