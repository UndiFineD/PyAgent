...
@Data
public class Idea35367Config {
    private String name = "idea_035367";
 ...
 */
@Slf4j
public class Idea35367Service {
    private static final int IDEA_ID = 35367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35367Service() {
        this(new Idea35367Config());
    }

    public Idea35367Service(Idea35367Config config) {
        this.config = config != null ? config : new Idea35367Config();
