...
@Data
public class Idea35510Config {
    private String name = "idea_035510";
 ...
 */
@Slf4j
public class Idea35510Service {
    private static final int IDEA_ID = 35510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35510Service() {
        this(new Idea35510Config());
    }

    public Idea35510Service(Idea35510Config config) {
        this.config = config != null ? config : new Idea35510Config();
