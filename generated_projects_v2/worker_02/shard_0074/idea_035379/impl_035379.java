...
@Data
public class Idea35379Config {
    private String name = "idea_035379";
 ...
 */
@Slf4j
public class Idea35379Service {
    private static final int IDEA_ID = 35379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35379Service() {
        this(new Idea35379Config());
    }

    public Idea35379Service(Idea35379Config config) {
        this.config = config != null ? config : new Idea35379Config();
