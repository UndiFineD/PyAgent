...
@Data
public class Idea35283Config {
    private String name = "idea_035283";
 ...
 */
@Slf4j
public class Idea35283Service {
    private static final int IDEA_ID = 35283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35283Service() {
        this(new Idea35283Config());
    }

    public Idea35283Service(Idea35283Config config) {
        this.config = config != null ? config : new Idea35283Config();
