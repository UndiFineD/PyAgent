...
@Data
public class Idea35470Config {
    private String name = "idea_035470";
 ...
 */
@Slf4j
public class Idea35470Service {
    private static final int IDEA_ID = 35470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35470Service() {
        this(new Idea35470Config());
    }

    public Idea35470Service(Idea35470Config config) {
        this.config = config != null ? config : new Idea35470Config();
