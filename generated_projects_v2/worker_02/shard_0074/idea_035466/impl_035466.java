...
@Data
public class Idea35466Config {
    private String name = "idea_035466";
 ...
 */
@Slf4j
public class Idea35466Service {
    private static final int IDEA_ID = 35466;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35466Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35466Service() {
        this(new Idea35466Config());
    }

    public Idea35466Service(Idea35466Config config) {
        this.config = config != null ? config : new Idea35466Config();
