...
@Data
public class Idea35257Config {
    private String name = "idea_035257";
 ...
 */
@Slf4j
public class Idea35257Service {
    private static final int IDEA_ID = 35257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35257Service() {
        this(new Idea35257Config());
    }

    public Idea35257Service(Idea35257Config config) {
        this.config = config != null ? config : new Idea35257Config();
