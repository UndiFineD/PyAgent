...
@Data
public class Idea35187Config {
    private String name = "idea_035187";
 ...
 */
@Slf4j
public class Idea35187Service {
    private static final int IDEA_ID = 35187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35187Service() {
        this(new Idea35187Config());
    }

    public Idea35187Service(Idea35187Config config) {
        this.config = config != null ? config : new Idea35187Config();
