...
@Data
public class Idea35512Config {
    private String name = "idea_035512";
 ...
 */
@Slf4j
public class Idea35512Service {
    private static final int IDEA_ID = 35512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35512Service() {
        this(new Idea35512Config());
    }

    public Idea35512Service(Idea35512Config config) {
        this.config = config != null ? config : new Idea35512Config();
