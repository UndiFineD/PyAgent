...
@Data
public class Idea35446Config {
    private String name = "idea_035446";
 ...
 */
@Slf4j
public class Idea35446Service {
    private static final int IDEA_ID = 35446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35446Service() {
        this(new Idea35446Config());
    }

    public Idea35446Service(Idea35446Config config) {
        this.config = config != null ? config : new Idea35446Config();
