...
@Data
public class Idea35597Config {
    private String name = "idea_035597";
 ...
 */
@Slf4j
public class Idea35597Service {
    private static final int IDEA_ID = 35597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35597Service() {
        this(new Idea35597Config());
    }

    public Idea35597Service(Idea35597Config config) {
        this.config = config != null ? config : new Idea35597Config();
