...
@Data
public class Idea35161Config {
    private String name = "idea_035161";
 ...
 */
@Slf4j
public class Idea35161Service {
    private static final int IDEA_ID = 35161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35161Service() {
        this(new Idea35161Config());
    }

    public Idea35161Service(Idea35161Config config) {
        this.config = config != null ? config : new Idea35161Config();
