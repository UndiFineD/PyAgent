...
@Data
public class Idea35484Config {
    private String name = "idea_035484";
 ...
 */
@Slf4j
public class Idea35484Service {
    private static final int IDEA_ID = 35484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35484Service() {
        this(new Idea35484Config());
    }

    public Idea35484Service(Idea35484Config config) {
        this.config = config != null ? config : new Idea35484Config();
