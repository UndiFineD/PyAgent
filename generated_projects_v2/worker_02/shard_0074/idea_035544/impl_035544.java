...
@Data
public class Idea35544Config {
    private String name = "idea_035544";
 ...
 */
@Slf4j
public class Idea35544Service {
    private static final int IDEA_ID = 35544;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35544Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35544Service() {
        this(new Idea35544Config());
    }

    public Idea35544Service(Idea35544Config config) {
        this.config = config != null ? config : new Idea35544Config();
