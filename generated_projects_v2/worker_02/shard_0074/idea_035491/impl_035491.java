...
@Data
public class Idea35491Config {
    private String name = "idea_035491";
 ...
 */
@Slf4j
public class Idea35491Service {
    private static final int IDEA_ID = 35491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35491Service() {
        this(new Idea35491Config());
    }

    public Idea35491Service(Idea35491Config config) {
        this.config = config != null ? config : new Idea35491Config();
