...
@Data
public class Idea35382Config {
    private String name = "idea_035382";
 ...
 */
@Slf4j
public class Idea35382Service {
    private static final int IDEA_ID = 35382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35382Service() {
        this(new Idea35382Config());
    }

    public Idea35382Service(Idea35382Config config) {
        this.config = config != null ? config : new Idea35382Config();
