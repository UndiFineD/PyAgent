...
@Data
public class Idea35554Config {
    private String name = "idea_035554";
 ...
 */
@Slf4j
public class Idea35554Service {
    private static final int IDEA_ID = 35554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35554Service() {
        this(new Idea35554Config());
    }

    public Idea35554Service(Idea35554Config config) {
        this.config = config != null ? config : new Idea35554Config();
