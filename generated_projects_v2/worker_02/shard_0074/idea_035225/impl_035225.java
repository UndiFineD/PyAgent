...
@Data
public class Idea35225Config {
    private String name = "idea_035225";
 ...
 */
@Slf4j
public class Idea35225Service {
    private static final int IDEA_ID = 35225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35225Service() {
        this(new Idea35225Config());
    }

    public Idea35225Service(Idea35225Config config) {
        this.config = config != null ? config : new Idea35225Config();
