...
@Data
public class Idea35313Config {
    private String name = "idea_035313";
 ...
 */
@Slf4j
public class Idea35313Service {
    private static final int IDEA_ID = 35313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35313Service() {
        this(new Idea35313Config());
    }

    public Idea35313Service(Idea35313Config config) {
        this.config = config != null ? config : new Idea35313Config();
