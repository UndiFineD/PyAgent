...
@Data
public class Idea35214Config {
    private String name = "idea_035214";
 ...
 */
@Slf4j
public class Idea35214Service {
    private static final int IDEA_ID = 35214;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35214Service() {
        this(new Idea35214Config());
    }

    public Idea35214Service(Idea35214Config config) {
        this.config = config != null ? config : new Idea35214Config();
