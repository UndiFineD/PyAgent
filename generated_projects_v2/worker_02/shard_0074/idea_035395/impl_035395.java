...
@Data
public class Idea35395Config {
    private String name = "idea_035395";
 ...
 */
@Slf4j
public class Idea35395Service {
    private static final int IDEA_ID = 35395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35395Service() {
        this(new Idea35395Config());
    }

    public Idea35395Service(Idea35395Config config) {
        this.config = config != null ? config : new Idea35395Config();
