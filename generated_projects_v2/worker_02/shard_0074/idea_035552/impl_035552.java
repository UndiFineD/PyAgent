...
@Data
public class Idea35552Config {
    private String name = "idea_035552";
 ...
 */
@Slf4j
public class Idea35552Service {
    private static final int IDEA_ID = 35552;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35552Service() {
        this(new Idea35552Config());
    }

    public Idea35552Service(Idea35552Config config) {
        this.config = config != null ? config : new Idea35552Config();
