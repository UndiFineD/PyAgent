...
@Data
public class Idea35300Config {
    private String name = "idea_035300";
 ...
 */
@Slf4j
public class Idea35300Service {
    private static final int IDEA_ID = 35300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35300Service() {
        this(new Idea35300Config());
    }

    public Idea35300Service(Idea35300Config config) {
        this.config = config != null ? config : new Idea35300Config();
