...
@Data
public class Idea35393Config {
    private String name = "idea_035393";
 ...
 */
@Slf4j
public class Idea35393Service {
    private static final int IDEA_ID = 35393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35393Service() {
        this(new Idea35393Config());
    }

    public Idea35393Service(Idea35393Config config) {
        this.config = config != null ? config : new Idea35393Config();
