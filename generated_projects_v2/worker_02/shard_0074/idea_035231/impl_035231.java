...
@Data
public class Idea35231Config {
    private String name = "idea_035231";
 ...
 */
@Slf4j
public class Idea35231Service {
    private static final int IDEA_ID = 35231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35231Service() {
        this(new Idea35231Config());
    }

    public Idea35231Service(Idea35231Config config) {
        this.config = config != null ? config : new Idea35231Config();
