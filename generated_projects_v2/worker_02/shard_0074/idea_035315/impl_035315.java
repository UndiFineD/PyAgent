...
@Data
public class Idea35315Config {
    private String name = "idea_035315";
 ...
 */
@Slf4j
public class Idea35315Service {
    private static final int IDEA_ID = 35315;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35315Service() {
        this(new Idea35315Config());
    }

    public Idea35315Service(Idea35315Config config) {
        this.config = config != null ? config : new Idea35315Config();
