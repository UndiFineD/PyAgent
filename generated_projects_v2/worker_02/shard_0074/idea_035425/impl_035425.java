...
@Data
public class Idea35425Config {
    private String name = "idea_035425";
 ...
 */
@Slf4j
public class Idea35425Service {
    private static final int IDEA_ID = 35425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35425Service() {
        this(new Idea35425Config());
    }

    public Idea35425Service(Idea35425Config config) {
        this.config = config != null ? config : new Idea35425Config();
