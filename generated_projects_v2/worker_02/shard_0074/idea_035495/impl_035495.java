...
@Data
public class Idea35495Config {
    private String name = "idea_035495";
 ...
 */
@Slf4j
public class Idea35495Service {
    private static final int IDEA_ID = 35495;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35495Service() {
        this(new Idea35495Config());
    }

    public Idea35495Service(Idea35495Config config) {
        this.config = config != null ? config : new Idea35495Config();
