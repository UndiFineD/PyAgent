...
@Data
public class Idea35487Config {
    private String name = "idea_035487";
 ...
 */
@Slf4j
public class Idea35487Service {
    private static final int IDEA_ID = 35487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35487Service() {
        this(new Idea35487Config());
    }

    public Idea35487Service(Idea35487Config config) {
        this.config = config != null ? config : new Idea35487Config();
