...
@Data
public class Idea35602Config {
    private String name = "idea_035602";
 ...
 */
@Slf4j
public class Idea35602Service {
    private static final int IDEA_ID = 35602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35602Service() {
        this(new Idea35602Config());
    }

    public Idea35602Service(Idea35602Config config) {
        this.config = config != null ? config : new Idea35602Config();
