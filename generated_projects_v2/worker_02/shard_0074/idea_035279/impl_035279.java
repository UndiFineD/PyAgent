...
@Data
public class Idea35279Config {
    private String name = "idea_035279";
 ...
 */
@Slf4j
public class Idea35279Service {
    private static final int IDEA_ID = 35279;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35279Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35279Service() {
        this(new Idea35279Config());
    }

    public Idea35279Service(Idea35279Config config) {
        this.config = config != null ? config : new Idea35279Config();
