...
@Data
public class Idea35396Config {
    private String name = "idea_035396";
 ...
 */
@Slf4j
public class Idea35396Service {
    private static final int IDEA_ID = 35396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35396Service() {
        this(new Idea35396Config());
    }

    public Idea35396Service(Idea35396Config config) {
        this.config = config != null ? config : new Idea35396Config();
