...
@Data
public class Idea35335Config {
    private String name = "idea_035335";
 ...
 */
@Slf4j
public class Idea35335Service {
    private static final int IDEA_ID = 35335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35335Service() {
        this(new Idea35335Config());
    }

    public Idea35335Service(Idea35335Config config) {
        this.config = config != null ? config : new Idea35335Config();
