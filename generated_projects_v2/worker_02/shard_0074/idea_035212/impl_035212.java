...
@Data
public class Idea35212Config {
    private String name = "idea_035212";
 ...
 */
@Slf4j
public class Idea35212Service {
    private static final int IDEA_ID = 35212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35212Service() {
        this(new Idea35212Config());
    }

    public Idea35212Service(Idea35212Config config) {
        this.config = config != null ? config : new Idea35212Config();
