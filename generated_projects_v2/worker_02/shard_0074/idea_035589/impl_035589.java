...
@Data
public class Idea35589Config {
    private String name = "idea_035589";
 ...
 */
@Slf4j
public class Idea35589Service {
    private static final int IDEA_ID = 35589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35589Service() {
        this(new Idea35589Config());
    }

    public Idea35589Service(Idea35589Config config) {
        this.config = config != null ? config : new Idea35589Config();
