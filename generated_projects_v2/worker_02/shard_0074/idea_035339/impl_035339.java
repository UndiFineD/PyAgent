...
@Data
public class Idea35339Config {
    private String name = "idea_035339";
 ...
 */
@Slf4j
public class Idea35339Service {
    private static final int IDEA_ID = 35339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35339Service() {
        this(new Idea35339Config());
    }

    public Idea35339Service(Idea35339Config config) {
        this.config = config != null ? config : new Idea35339Config();
