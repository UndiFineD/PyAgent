...
@Data
public class Idea35548Config {
    private String name = "idea_035548";
 ...
 */
@Slf4j
public class Idea35548Service {
    private static final int IDEA_ID = 35548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35548Service() {
        this(new Idea35548Config());
    }

    public Idea35548Service(Idea35548Config config) {
        this.config = config != null ? config : new Idea35548Config();
