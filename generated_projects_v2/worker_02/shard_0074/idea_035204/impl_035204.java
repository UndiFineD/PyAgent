...
@Data
public class Idea35204Config {
    private String name = "idea_035204";
 ...
 */
@Slf4j
public class Idea35204Service {
    private static final int IDEA_ID = 35204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35204Service() {
        this(new Idea35204Config());
    }

    public Idea35204Service(Idea35204Config config) {
        this.config = config != null ? config : new Idea35204Config();
