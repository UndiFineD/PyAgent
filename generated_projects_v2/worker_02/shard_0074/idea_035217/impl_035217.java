...
@Data
public class Idea35217Config {
    private String name = "idea_035217";
 ...
 */
@Slf4j
public class Idea35217Service {
    private static final int IDEA_ID = 35217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35217Service() {
        this(new Idea35217Config());
    }

    public Idea35217Service(Idea35217Config config) {
        this.config = config != null ? config : new Idea35217Config();
