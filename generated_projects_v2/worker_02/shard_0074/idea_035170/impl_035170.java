...
@Data
public class Idea35170Config {
    private String name = "idea_035170";
 ...
 */
@Slf4j
public class Idea35170Service {
    private static final int IDEA_ID = 35170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35170Service() {
        this(new Idea35170Config());
    }

    public Idea35170Service(Idea35170Config config) {
        this.config = config != null ? config : new Idea35170Config();
