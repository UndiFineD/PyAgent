...
@Data
public class Idea35243Config {
    private String name = "idea_035243";
 ...
 */
@Slf4j
public class Idea35243Service {
    private static final int IDEA_ID = 35243;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35243Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35243Service() {
        this(new Idea35243Config());
    }

    public Idea35243Service(Idea35243Config config) {
        this.config = config != null ? config : new Idea35243Config();
