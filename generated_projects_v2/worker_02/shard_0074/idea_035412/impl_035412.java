...
@Data
public class Idea35412Config {
    private String name = "idea_035412";
 ...
 */
@Slf4j
public class Idea35412Service {
    private static final int IDEA_ID = 35412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35412Service() {
        this(new Idea35412Config());
    }

    public Idea35412Service(Idea35412Config config) {
        this.config = config != null ? config : new Idea35412Config();
