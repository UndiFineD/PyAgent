...
@Data
public class Idea35542Config {
    private String name = "idea_035542";
 ...
 */
@Slf4j
public class Idea35542Service {
    private static final int IDEA_ID = 35542;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35542Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35542Service() {
        this(new Idea35542Config());
    }

    public Idea35542Service(Idea35542Config config) {
        this.config = config != null ? config : new Idea35542Config();
