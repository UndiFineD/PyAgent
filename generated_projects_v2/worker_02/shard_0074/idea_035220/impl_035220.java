...
@Data
public class Idea35220Config {
    private String name = "idea_035220";
 ...
 */
@Slf4j
public class Idea35220Service {
    private static final int IDEA_ID = 35220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35220Service() {
        this(new Idea35220Config());
    }

    public Idea35220Service(Idea35220Config config) {
        this.config = config != null ? config : new Idea35220Config();
