...
@Data
public class Idea35389Config {
    private String name = "idea_035389";
 ...
 */
@Slf4j
public class Idea35389Service {
    private static final int IDEA_ID = 35389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35389Service() {
        this(new Idea35389Config());
    }

    public Idea35389Service(Idea35389Config config) {
        this.config = config != null ? config : new Idea35389Config();
