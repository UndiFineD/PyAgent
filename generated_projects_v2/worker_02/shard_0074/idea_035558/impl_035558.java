...
@Data
public class Idea35558Config {
    private String name = "idea_035558";
 ...
 */
@Slf4j
public class Idea35558Service {
    private static final int IDEA_ID = 35558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35558Service() {
        this(new Idea35558Config());
    }

    public Idea35558Service(Idea35558Config config) {
        this.config = config != null ? config : new Idea35558Config();
