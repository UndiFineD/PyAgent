...
@Data
public class Idea35232Config {
    private String name = "idea_035232";
 ...
 */
@Slf4j
public class Idea35232Service {
    private static final int IDEA_ID = 35232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35232Service() {
        this(new Idea35232Config());
    }

    public Idea35232Service(Idea35232Config config) {
        this.config = config != null ? config : new Idea35232Config();
