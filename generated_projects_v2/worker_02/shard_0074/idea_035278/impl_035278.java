...
@Data
public class Idea35278Config {
    private String name = "idea_035278";
 ...
 */
@Slf4j
public class Idea35278Service {
    private static final int IDEA_ID = 35278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35278Service() {
        this(new Idea35278Config());
    }

    public Idea35278Service(Idea35278Config config) {
        this.config = config != null ? config : new Idea35278Config();
