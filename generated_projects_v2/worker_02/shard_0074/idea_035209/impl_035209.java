...
@Data
public class Idea35209Config {
    private String name = "idea_035209";
 ...
 */
@Slf4j
public class Idea35209Service {
    private static final int IDEA_ID = 35209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35209Service() {
        this(new Idea35209Config());
    }

    public Idea35209Service(Idea35209Config config) {
        this.config = config != null ? config : new Idea35209Config();
