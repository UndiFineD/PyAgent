...
@Data
public class Idea35242Config {
    private String name = "idea_035242";
 ...
 */
@Slf4j
public class Idea35242Service {
    private static final int IDEA_ID = 35242;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35242Service() {
        this(new Idea35242Config());
    }

    public Idea35242Service(Idea35242Config config) {
        this.config = config != null ? config : new Idea35242Config();
