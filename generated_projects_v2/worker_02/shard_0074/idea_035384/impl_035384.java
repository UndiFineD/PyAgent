...
@Data
public class Idea35384Config {
    private String name = "idea_035384";
 ...
 */
@Slf4j
public class Idea35384Service {
    private static final int IDEA_ID = 35384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35384Service() {
        this(new Idea35384Config());
    }

    public Idea35384Service(Idea35384Config config) {
        this.config = config != null ? config : new Idea35384Config();
