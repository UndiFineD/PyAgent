...
@Data
public class Idea35289Config {
    private String name = "idea_035289";
 ...
 */
@Slf4j
public class Idea35289Service {
    private static final int IDEA_ID = 35289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35289Service() {
        this(new Idea35289Config());
    }

    public Idea35289Service(Idea35289Config config) {
        this.config = config != null ? config : new Idea35289Config();
