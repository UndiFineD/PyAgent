...
@Data
public class Idea35381Config {
    private String name = "idea_035381";
 ...
 */
@Slf4j
public class Idea35381Service {
    private static final int IDEA_ID = 35381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35381Service() {
        this(new Idea35381Config());
    }

    public Idea35381Service(Idea35381Config config) {
        this.config = config != null ? config : new Idea35381Config();
