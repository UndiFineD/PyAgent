...
@Data
public class Idea35573Config {
    private String name = "idea_035573";
 ...
 */
@Slf4j
public class Idea35573Service {
    private static final int IDEA_ID = 35573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35573Service() {
        this(new Idea35573Config());
    }

    public Idea35573Service(Idea35573Config config) {
        this.config = config != null ? config : new Idea35573Config();
