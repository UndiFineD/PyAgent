...
@Data
public class Idea35155Config {
    private String name = "idea_035155";
 ...
 */
@Slf4j
public class Idea35155Service {
    private static final int IDEA_ID = 35155;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35155Service() {
        this(new Idea35155Config());
    }

    public Idea35155Service(Idea35155Config config) {
        this.config = config != null ? config : new Idea35155Config();
