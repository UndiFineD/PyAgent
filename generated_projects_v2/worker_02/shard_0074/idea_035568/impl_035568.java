...
@Data
public class Idea35568Config {
    private String name = "idea_035568";
 ...
 */
@Slf4j
public class Idea35568Service {
    private static final int IDEA_ID = 35568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35568Service() {
        this(new Idea35568Config());
    }

    public Idea35568Service(Idea35568Config config) {
        this.config = config != null ? config : new Idea35568Config();
