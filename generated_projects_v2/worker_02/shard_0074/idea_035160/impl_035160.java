...
@Data
public class Idea35160Config {
    private String name = "idea_035160";
 ...
 */
@Slf4j
public class Idea35160Service {
    private static final int IDEA_ID = 35160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35160Service() {
        this(new Idea35160Config());
    }

    public Idea35160Service(Idea35160Config config) {
        this.config = config != null ? config : new Idea35160Config();
