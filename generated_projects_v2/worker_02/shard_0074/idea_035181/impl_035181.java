...
@Data
public class Idea35181Config {
    private String name = "idea_035181";
 ...
 */
@Slf4j
public class Idea35181Service {
    private static final int IDEA_ID = 35181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35181Service() {
        this(new Idea35181Config());
    }

    public Idea35181Service(Idea35181Config config) {
        this.config = config != null ? config : new Idea35181Config();
