...
@Data
public class Idea35465Config {
    private String name = "idea_035465";
 ...
 */
@Slf4j
public class Idea35465Service {
    private static final int IDEA_ID = 35465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35465Service() {
        this(new Idea35465Config());
    }

    public Idea35465Service(Idea35465Config config) {
        this.config = config != null ? config : new Idea35465Config();
