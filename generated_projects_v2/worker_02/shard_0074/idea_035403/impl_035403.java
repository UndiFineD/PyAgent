...
@Data
public class Idea35403Config {
    private String name = "idea_035403";
 ...
 */
@Slf4j
public class Idea35403Service {
    private static final int IDEA_ID = 35403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35403Service() {
        this(new Idea35403Config());
    }

    public Idea35403Service(Idea35403Config config) {
        this.config = config != null ? config : new Idea35403Config();
