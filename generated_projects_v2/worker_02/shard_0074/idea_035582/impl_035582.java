...
@Data
public class Idea35582Config {
    private String name = "idea_035582";
 ...
 */
@Slf4j
public class Idea35582Service {
    private static final int IDEA_ID = 35582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35582Service() {
        this(new Idea35582Config());
    }

    public Idea35582Service(Idea35582Config config) {
        this.config = config != null ? config : new Idea35582Config();
