...
@Data
public class Idea35553Config {
    private String name = "idea_035553";
 ...
 */
@Slf4j
public class Idea35553Service {
    private static final int IDEA_ID = 35553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35553Service() {
        this(new Idea35553Config());
    }

    public Idea35553Service(Idea35553Config config) {
        this.config = config != null ? config : new Idea35553Config();
