...
@Data
public class Idea35329Config {
    private String name = "idea_035329";
 ...
 */
@Slf4j
public class Idea35329Service {
    private static final int IDEA_ID = 35329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35329Service() {
        this(new Idea35329Config());
    }

    public Idea35329Service(Idea35329Config config) {
        this.config = config != null ? config : new Idea35329Config();
