...
@Data
public class Idea35307Config {
    private String name = "idea_035307";
 ...
 */
@Slf4j
public class Idea35307Service {
    private static final int IDEA_ID = 35307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35307Service() {
        this(new Idea35307Config());
    }

    public Idea35307Service(Idea35307Config config) {
        this.config = config != null ? config : new Idea35307Config();
