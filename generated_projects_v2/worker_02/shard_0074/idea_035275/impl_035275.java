...
@Data
public class Idea35275Config {
    private String name = "idea_035275";
 ...
 */
@Slf4j
public class Idea35275Service {
    private static final int IDEA_ID = 35275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35275Service() {
        this(new Idea35275Config());
    }

    public Idea35275Service(Idea35275Config config) {
        this.config = config != null ? config : new Idea35275Config();
