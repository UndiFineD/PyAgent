...
@Data
public class Idea35526Config {
    private String name = "idea_035526";
 ...
 */
@Slf4j
public class Idea35526Service {
    private static final int IDEA_ID = 35526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35526Service() {
        this(new Idea35526Config());
    }

    public Idea35526Service(Idea35526Config config) {
        this.config = config != null ? config : new Idea35526Config();
