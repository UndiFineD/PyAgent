...
@Data
public class Idea35572Config {
    private String name = "idea_035572";
 ...
 */
@Slf4j
public class Idea35572Service {
    private static final int IDEA_ID = 35572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35572Service() {
        this(new Idea35572Config());
    }

    public Idea35572Service(Idea35572Config config) {
        this.config = config != null ? config : new Idea35572Config();
