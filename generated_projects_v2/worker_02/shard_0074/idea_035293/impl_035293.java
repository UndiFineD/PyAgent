...
@Data
public class Idea35293Config {
    private String name = "idea_035293";
 ...
 */
@Slf4j
public class Idea35293Service {
    private static final int IDEA_ID = 35293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35293Service() {
        this(new Idea35293Config());
    }

    public Idea35293Service(Idea35293Config config) {
        this.config = config != null ? config : new Idea35293Config();
