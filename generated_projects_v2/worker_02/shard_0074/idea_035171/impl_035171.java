...
@Data
public class Idea35171Config {
    private String name = "idea_035171";
 ...
 */
@Slf4j
public class Idea35171Service {
    private static final int IDEA_ID = 35171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35171Service() {
        this(new Idea35171Config());
    }

    public Idea35171Service(Idea35171Config config) {
        this.config = config != null ? config : new Idea35171Config();
