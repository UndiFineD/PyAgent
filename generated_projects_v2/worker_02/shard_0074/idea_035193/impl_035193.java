...
@Data
public class Idea35193Config {
    private String name = "idea_035193";
 ...
 */
@Slf4j
public class Idea35193Service {
    private static final int IDEA_ID = 35193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35193Service() {
        this(new Idea35193Config());
    }

    public Idea35193Service(Idea35193Config config) {
        this.config = config != null ? config : new Idea35193Config();
