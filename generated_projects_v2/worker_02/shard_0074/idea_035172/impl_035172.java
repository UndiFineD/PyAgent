...
@Data
public class Idea35172Config {
    private String name = "idea_035172";
 ...
 */
@Slf4j
public class Idea35172Service {
    private static final int IDEA_ID = 35172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35172Service() {
        this(new Idea35172Config());
    }

    public Idea35172Service(Idea35172Config config) {
        this.config = config != null ? config : new Idea35172Config();
