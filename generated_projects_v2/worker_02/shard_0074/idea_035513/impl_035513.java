...
@Data
public class Idea35513Config {
    private String name = "idea_035513";
 ...
 */
@Slf4j
public class Idea35513Service {
    private static final int IDEA_ID = 35513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35513Service() {
        this(new Idea35513Config());
    }

    public Idea35513Service(Idea35513Config config) {
        this.config = config != null ? config : new Idea35513Config();
