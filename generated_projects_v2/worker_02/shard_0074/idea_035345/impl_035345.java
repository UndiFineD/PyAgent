...
@Data
public class Idea35345Config {
    private String name = "idea_035345";
 ...
 */
@Slf4j
public class Idea35345Service {
    private static final int IDEA_ID = 35345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35345Service() {
        this(new Idea35345Config());
    }

    public Idea35345Service(Idea35345Config config) {
        this.config = config != null ? config : new Idea35345Config();
