...
@Data
public class Idea35219Config {
    private String name = "idea_035219";
 ...
 */
@Slf4j
public class Idea35219Service {
    private static final int IDEA_ID = 35219;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35219Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35219Service() {
        this(new Idea35219Config());
    }

    public Idea35219Service(Idea35219Config config) {
        this.config = config != null ? config : new Idea35219Config();
