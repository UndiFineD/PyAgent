...
@Data
public class Idea35328Config {
    private String name = "idea_035328";
 ...
 */
@Slf4j
public class Idea35328Service {
    private static final int IDEA_ID = 35328;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35328Service() {
        this(new Idea35328Config());
    }

    public Idea35328Service(Idea35328Config config) {
        this.config = config != null ? config : new Idea35328Config();
