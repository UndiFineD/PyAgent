...
@Data
public class Idea35336Config {
    private String name = "idea_035336";
 ...
 */
@Slf4j
public class Idea35336Service {
    private static final int IDEA_ID = 35336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35336Service() {
        this(new Idea35336Config());
    }

    public Idea35336Service(Idea35336Config config) {
        this.config = config != null ? config : new Idea35336Config();
