...
@Data
public class Idea35622Config {
    private String name = "idea_035622";
 ...
 */
@Slf4j
public class Idea35622Service {
    private static final int IDEA_ID = 35622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35622Service() {
        this(new Idea35622Config());
    }

    public Idea35622Service(Idea35622Config config) {
        this.config = config != null ? config : new Idea35622Config();
