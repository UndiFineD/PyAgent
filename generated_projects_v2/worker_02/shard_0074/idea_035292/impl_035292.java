...
@Data
public class Idea35292Config {
    private String name = "idea_035292";
 ...
 */
@Slf4j
public class Idea35292Service {
    private static final int IDEA_ID = 35292;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35292Service() {
        this(new Idea35292Config());
    }

    public Idea35292Service(Idea35292Config config) {
        this.config = config != null ? config : new Idea35292Config();
