...
@Data
public class Idea35501Config {
    private String name = "idea_035501";
 ...
 */
@Slf4j
public class Idea35501Service {
    private static final int IDEA_ID = 35501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35501Service() {
        this(new Idea35501Config());
    }

    public Idea35501Service(Idea35501Config config) {
        this.config = config != null ? config : new Idea35501Config();
