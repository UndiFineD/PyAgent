...
@Data
public class Idea35467Config {
    private String name = "idea_035467";
 ...
 */
@Slf4j
public class Idea35467Service {
    private static final int IDEA_ID = 35467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35467Service() {
        this(new Idea35467Config());
    }

    public Idea35467Service(Idea35467Config config) {
        this.config = config != null ? config : new Idea35467Config();
