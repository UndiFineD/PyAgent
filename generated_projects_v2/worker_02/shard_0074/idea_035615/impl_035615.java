...
@Data
public class Idea35615Config {
    private String name = "idea_035615";
 ...
 */
@Slf4j
public class Idea35615Service {
    private static final int IDEA_ID = 35615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35615Service() {
        this(new Idea35615Config());
    }

    public Idea35615Service(Idea35615Config config) {
        this.config = config != null ? config : new Idea35615Config();
