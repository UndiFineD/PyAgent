...
@Data
public class Idea35585Config {
    private String name = "idea_035585";
 ...
 */
@Slf4j
public class Idea35585Service {
    private static final int IDEA_ID = 35585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35585Service() {
        this(new Idea35585Config());
    }

    public Idea35585Service(Idea35585Config config) {
        this.config = config != null ? config : new Idea35585Config();
