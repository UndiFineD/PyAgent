...
@Data
public class Idea35520Config {
    private String name = "idea_035520";
 ...
 */
@Slf4j
public class Idea35520Service {
    private static final int IDEA_ID = 35520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35520Service() {
        this(new Idea35520Config());
    }

    public Idea35520Service(Idea35520Config config) {
        this.config = config != null ? config : new Idea35520Config();
