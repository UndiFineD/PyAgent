...
@Data
public class Idea35576Config {
    private String name = "idea_035576";
 ...
 */
@Slf4j
public class Idea35576Service {
    private static final int IDEA_ID = 35576;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35576Service() {
        this(new Idea35576Config());
    }

    public Idea35576Service(Idea35576Config config) {
        this.config = config != null ? config : new Idea35576Config();
