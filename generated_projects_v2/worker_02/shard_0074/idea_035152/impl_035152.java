...
@Data
public class Idea35152Config {
    private String name = "idea_035152";
 ...
 */
@Slf4j
public class Idea35152Service {
    private static final int IDEA_ID = 35152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35152Service() {
        this(new Idea35152Config());
    }

    public Idea35152Service(Idea35152Config config) {
        this.config = config != null ? config : new Idea35152Config();
