...
@Data
public class Idea35194Config {
    private String name = "idea_035194";
 ...
 */
@Slf4j
public class Idea35194Service {
    private static final int IDEA_ID = 35194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35194Service() {
        this(new Idea35194Config());
    }

    public Idea35194Service(Idea35194Config config) {
        this.config = config != null ? config : new Idea35194Config();
