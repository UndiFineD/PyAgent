...
@Data
public class Idea35308Config {
    private String name = "idea_035308";
 ...
 */
@Slf4j
public class Idea35308Service {
    private static final int IDEA_ID = 35308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35308Service() {
        this(new Idea35308Config());
    }

    public Idea35308Service(Idea35308Config config) {
        this.config = config != null ? config : new Idea35308Config();
