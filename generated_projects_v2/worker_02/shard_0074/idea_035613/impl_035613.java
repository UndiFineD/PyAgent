...
@Data
public class Idea35613Config {
    private String name = "idea_035613";
 ...
 */
@Slf4j
public class Idea35613Service {
    private static final int IDEA_ID = 35613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35613Service() {
        this(new Idea35613Config());
    }

    public Idea35613Service(Idea35613Config config) {
        this.config = config != null ? config : new Idea35613Config();
