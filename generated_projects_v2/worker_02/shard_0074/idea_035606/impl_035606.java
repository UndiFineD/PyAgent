...
@Data
public class Idea35606Config {
    private String name = "idea_035606";
 ...
 */
@Slf4j
public class Idea35606Service {
    private static final int IDEA_ID = 35606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35606Service() {
        this(new Idea35606Config());
    }

    public Idea35606Service(Idea35606Config config) {
        this.config = config != null ? config : new Idea35606Config();
