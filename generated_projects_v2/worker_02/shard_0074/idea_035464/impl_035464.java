...
@Data
public class Idea35464Config {
    private String name = "idea_035464";
 ...
 */
@Slf4j
public class Idea35464Service {
    private static final int IDEA_ID = 35464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35464Service() {
        this(new Idea35464Config());
    }

    public Idea35464Service(Idea35464Config config) {
        this.config = config != null ? config : new Idea35464Config();
