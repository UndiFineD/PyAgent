...
@Data
public class Idea35341Config {
    private String name = "idea_035341";
 ...
 */
@Slf4j
public class Idea35341Service {
    private static final int IDEA_ID = 35341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35341Service() {
        this(new Idea35341Config());
    }

    public Idea35341Service(Idea35341Config config) {
        this.config = config != null ? config : new Idea35341Config();
