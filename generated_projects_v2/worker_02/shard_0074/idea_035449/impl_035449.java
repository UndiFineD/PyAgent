...
@Data
public class Idea35449Config {
    private String name = "idea_035449";
 ...
 */
@Slf4j
public class Idea35449Service {
    private static final int IDEA_ID = 35449;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35449Service() {
        this(new Idea35449Config());
    }

    public Idea35449Service(Idea35449Config config) {
        this.config = config != null ? config : new Idea35449Config();
