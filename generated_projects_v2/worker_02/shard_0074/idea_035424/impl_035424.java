...
@Data
public class Idea35424Config {
    private String name = "idea_035424";
 ...
 */
@Slf4j
public class Idea35424Service {
    private static final int IDEA_ID = 35424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35424Service() {
        this(new Idea35424Config());
    }

    public Idea35424Service(Idea35424Config config) {
        this.config = config != null ? config : new Idea35424Config();
