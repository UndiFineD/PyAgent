...
@Data
public class Idea35208Config {
    private String name = "idea_035208";
 ...
 */
@Slf4j
public class Idea35208Service {
    private static final int IDEA_ID = 35208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35208Service() {
        this(new Idea35208Config());
    }

    public Idea35208Service(Idea35208Config config) {
        this.config = config != null ? config : new Idea35208Config();
