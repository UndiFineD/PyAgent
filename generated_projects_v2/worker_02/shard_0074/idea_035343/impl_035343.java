...
@Data
public class Idea35343Config {
    private String name = "idea_035343";
 ...
 */
@Slf4j
public class Idea35343Service {
    private static final int IDEA_ID = 35343;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35343Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35343Service() {
        this(new Idea35343Config());
    }

    public Idea35343Service(Idea35343Config config) {
        this.config = config != null ? config : new Idea35343Config();
