...
@Data
public class Idea35358Config {
    private String name = "idea_035358";
 ...
 */
@Slf4j
public class Idea35358Service {
    private static final int IDEA_ID = 35358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35358Service() {
        this(new Idea35358Config());
    }

    public Idea35358Service(Idea35358Config config) {
        this.config = config != null ? config : new Idea35358Config();
