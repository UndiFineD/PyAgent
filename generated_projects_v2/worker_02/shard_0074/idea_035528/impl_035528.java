...
@Data
public class Idea35528Config {
    private String name = "idea_035528";
 ...
 */
@Slf4j
public class Idea35528Service {
    private static final int IDEA_ID = 35528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35528Service() {
        this(new Idea35528Config());
    }

    public Idea35528Service(Idea35528Config config) {
        this.config = config != null ? config : new Idea35528Config();
