...
@Data
public class Idea29389Config {
    private String name = "idea_029389";
 ...
 */
@Slf4j
public class Idea29389Service {
    private static final int IDEA_ID = 29389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29389Service() {
        this(new Idea29389Config());
    }

    public Idea29389Service(Idea29389Config config) {
        this.config = config != null ? config : new Idea29389Config();
