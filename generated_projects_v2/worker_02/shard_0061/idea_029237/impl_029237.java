...
@Data
public class Idea29237Config {
    private String name = "idea_029237";
 ...
 */
@Slf4j
public class Idea29237Service {
    private static final int IDEA_ID = 29237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29237Service() {
        this(new Idea29237Config());
    }

    public Idea29237Service(Idea29237Config config) {
        this.config = config != null ? config : new Idea29237Config();
