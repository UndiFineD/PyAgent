...
@Data
public class Idea29227Config {
    private String name = "idea_029227";
 ...
 */
@Slf4j
public class Idea29227Service {
    private static final int IDEA_ID = 29227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29227Service() {
        this(new Idea29227Config());
    }

    public Idea29227Service(Idea29227Config config) {
        this.config = config != null ? config : new Idea29227Config();
