...
@Data
public class Idea29206Config {
    private String name = "idea_029206";
 ...
 */
@Slf4j
public class Idea29206Service {
    private static final int IDEA_ID = 29206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29206Service() {
        this(new Idea29206Config());
    }

    public Idea29206Service(Idea29206Config config) {
        this.config = config != null ? config : new Idea29206Config();
