...
@Data
public class Idea29266Config {
    private String name = "idea_029266";
 ...
 */
@Slf4j
public class Idea29266Service {
    private static final int IDEA_ID = 29266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29266Service() {
        this(new Idea29266Config());
    }

    public Idea29266Service(Idea29266Config config) {
        this.config = config != null ? config : new Idea29266Config();
