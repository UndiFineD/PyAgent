...
@Data
public class Idea29315Config {
    private String name = "idea_029315";
 ...
 */
@Slf4j
public class Idea29315Service {
    private static final int IDEA_ID = 29315;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29315Service() {
        this(new Idea29315Config());
    }

    public Idea29315Service(Idea29315Config config) {
        this.config = config != null ? config : new Idea29315Config();
