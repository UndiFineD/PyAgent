...
@Data
public class Idea29357Config {
    private String name = "idea_029357";
 ...
 */
@Slf4j
public class Idea29357Service {
    private static final int IDEA_ID = 29357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29357Service() {
        this(new Idea29357Config());
    }

    public Idea29357Service(Idea29357Config config) {
        this.config = config != null ? config : new Idea29357Config();
