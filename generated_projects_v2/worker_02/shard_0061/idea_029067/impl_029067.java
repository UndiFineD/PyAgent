...
@Data
public class Idea29067Config {
    private String name = "idea_029067";
 ...
 */
@Slf4j
public class Idea29067Service {
    private static final int IDEA_ID = 29067;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29067Service() {
        this(new Idea29067Config());
    }

    public Idea29067Service(Idea29067Config config) {
        this.config = config != null ? config : new Idea29067Config();
