...
@Data
public class Idea29405Config {
    private String name = "idea_029405";
 ...
 */
@Slf4j
public class Idea29405Service {
    private static final int IDEA_ID = 29405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29405Service() {
        this(new Idea29405Config());
    }

    public Idea29405Service(Idea29405Config config) {
        this.config = config != null ? config : new Idea29405Config();
