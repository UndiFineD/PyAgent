...
@Data
public class Idea29173Config {
    private String name = "idea_029173";
 ...
 */
@Slf4j
public class Idea29173Service {
    private static final int IDEA_ID = 29173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29173Service() {
        this(new Idea29173Config());
    }

    public Idea29173Service(Idea29173Config config) {
        this.config = config != null ? config : new Idea29173Config();
