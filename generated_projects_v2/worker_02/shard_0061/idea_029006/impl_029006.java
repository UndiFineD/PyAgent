...
@Data
public class Idea29006Config {
    private String name = "idea_029006";
 ...
 */
@Slf4j
public class Idea29006Service {
    private static final int IDEA_ID = 29006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29006Service() {
        this(new Idea29006Config());
    }

    public Idea29006Service(Idea29006Config config) {
        this.config = config != null ? config : new Idea29006Config();
