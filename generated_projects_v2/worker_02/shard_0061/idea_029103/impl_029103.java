...
@Data
public class Idea29103Config {
    private String name = "idea_029103";
 ...
 */
@Slf4j
public class Idea29103Service {
    private static final int IDEA_ID = 29103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29103Service() {
        this(new Idea29103Config());
    }

    public Idea29103Service(Idea29103Config config) {
        this.config = config != null ? config : new Idea29103Config();
