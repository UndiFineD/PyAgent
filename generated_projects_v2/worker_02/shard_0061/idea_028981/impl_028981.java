...
@Data
public class Idea28981Config {
    private String name = "idea_028981";
 ...
 */
@Slf4j
public class Idea28981Service {
    private static final int IDEA_ID = 28981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28981Service() {
        this(new Idea28981Config());
    }

    public Idea28981Service(Idea28981Config config) {
        this.config = config != null ? config : new Idea28981Config();
