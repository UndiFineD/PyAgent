...
@Data
public class Idea29239Config {
    private String name = "idea_029239";
 ...
 */
@Slf4j
public class Idea29239Service {
    private static final int IDEA_ID = 29239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29239Service() {
        this(new Idea29239Config());
    }

    public Idea29239Service(Idea29239Config config) {
        this.config = config != null ? config : new Idea29239Config();
