...
@Data
public class Idea29241Config {
    private String name = "idea_029241";
 ...
 */
@Slf4j
public class Idea29241Service {
    private static final int IDEA_ID = 29241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29241Service() {
        this(new Idea29241Config());
    }

    public Idea29241Service(Idea29241Config config) {
        this.config = config != null ? config : new Idea29241Config();
