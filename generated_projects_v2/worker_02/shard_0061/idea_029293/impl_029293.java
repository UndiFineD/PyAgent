...
@Data
public class Idea29293Config {
    private String name = "idea_029293";
 ...
 */
@Slf4j
public class Idea29293Service {
    private static final int IDEA_ID = 29293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29293Service() {
        this(new Idea29293Config());
    }

    public Idea29293Service(Idea29293Config config) {
        this.config = config != null ? config : new Idea29293Config();
