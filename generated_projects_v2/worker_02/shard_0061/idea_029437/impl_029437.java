...
@Data
public class Idea29437Config {
    private String name = "idea_029437";
 ...
 */
@Slf4j
public class Idea29437Service {
    private static final int IDEA_ID = 29437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29437Service() {
        this(new Idea29437Config());
    }

    public Idea29437Service(Idea29437Config config) {
        this.config = config != null ? config : new Idea29437Config();
