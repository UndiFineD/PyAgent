...
@Data
public class Idea29107Config {
    private String name = "idea_029107";
 ...
 */
@Slf4j
public class Idea29107Service {
    private static final int IDEA_ID = 29107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29107Service() {
        this(new Idea29107Config());
    }

    public Idea29107Service(Idea29107Config config) {
        this.config = config != null ? config : new Idea29107Config();
