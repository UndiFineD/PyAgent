...
@Data
public class Idea29344Config {
    private String name = "idea_029344";
 ...
 */
@Slf4j
public class Idea29344Service {
    private static final int IDEA_ID = 29344;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29344Service() {
        this(new Idea29344Config());
    }

    public Idea29344Service(Idea29344Config config) {
        this.config = config != null ? config : new Idea29344Config();
