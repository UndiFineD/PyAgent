...
@Data
public class Idea29211Config {
    private String name = "idea_029211";
 ...
 */
@Slf4j
public class Idea29211Service {
    private static final int IDEA_ID = 29211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29211Service() {
        this(new Idea29211Config());
    }

    public Idea29211Service(Idea29211Config config) {
        this.config = config != null ? config : new Idea29211Config();
