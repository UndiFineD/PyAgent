...
@Data
public class Idea29047Config {
    private String name = "idea_029047";
 ...
 */
@Slf4j
public class Idea29047Service {
    private static final int IDEA_ID = 29047;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29047Service() {
        this(new Idea29047Config());
    }

    public Idea29047Service(Idea29047Config config) {
        this.config = config != null ? config : new Idea29047Config();
