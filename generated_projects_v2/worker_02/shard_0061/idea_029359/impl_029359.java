...
@Data
public class Idea29359Config {
    private String name = "idea_029359";
 ...
 */
@Slf4j
public class Idea29359Service {
    private static final int IDEA_ID = 29359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29359Service() {
        this(new Idea29359Config());
    }

    public Idea29359Service(Idea29359Config config) {
        this.config = config != null ? config : new Idea29359Config();
