...
@Data
public class Idea29015Config {
    private String name = "idea_029015";
 ...
 */
@Slf4j
public class Idea29015Service {
    private static final int IDEA_ID = 29015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29015Service() {
        this(new Idea29015Config());
    }

    public Idea29015Service(Idea29015Config config) {
        this.config = config != null ? config : new Idea29015Config();
