...
@Data
public class Idea29212Config {
    private String name = "idea_029212";
 ...
 */
@Slf4j
public class Idea29212Service {
    private static final int IDEA_ID = 29212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29212Service() {
        this(new Idea29212Config());
    }

    public Idea29212Service(Idea29212Config config) {
        this.config = config != null ? config : new Idea29212Config();
