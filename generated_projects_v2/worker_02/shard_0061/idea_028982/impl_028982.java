...
@Data
public class Idea28982Config {
    private String name = "idea_028982";
 ...
 */
@Slf4j
public class Idea28982Service {
    private static final int IDEA_ID = 28982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28982Service() {
        this(new Idea28982Config());
    }

    public Idea28982Service(Idea28982Config config) {
        this.config = config != null ? config : new Idea28982Config();
