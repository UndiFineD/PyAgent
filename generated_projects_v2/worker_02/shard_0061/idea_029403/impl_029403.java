...
@Data
public class Idea29403Config {
    private String name = "idea_029403";
 ...
 */
@Slf4j
public class Idea29403Service {
    private static final int IDEA_ID = 29403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29403Service() {
        this(new Idea29403Config());
    }

    public Idea29403Service(Idea29403Config config) {
        this.config = config != null ? config : new Idea29403Config();
