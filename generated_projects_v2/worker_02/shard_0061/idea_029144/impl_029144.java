...
@Data
public class Idea29144Config {
    private String name = "idea_029144";
 ...
 */
@Slf4j
public class Idea29144Service {
    private static final int IDEA_ID = 29144;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29144Service() {
        this(new Idea29144Config());
    }

    public Idea29144Service(Idea29144Config config) {
        this.config = config != null ? config : new Idea29144Config();
