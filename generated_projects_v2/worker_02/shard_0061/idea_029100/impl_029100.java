...
@Data
public class Idea29100Config {
    private String name = "idea_029100";
 ...
 */
@Slf4j
public class Idea29100Service {
    private static final int IDEA_ID = 29100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29100Service() {
        this(new Idea29100Config());
    }

    public Idea29100Service(Idea29100Config config) {
        this.config = config != null ? config : new Idea29100Config();
