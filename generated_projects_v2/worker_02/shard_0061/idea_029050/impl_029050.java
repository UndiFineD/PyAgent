...
@Data
public class Idea29050Config {
    private String name = "idea_029050";
 ...
 */
@Slf4j
public class Idea29050Service {
    private static final int IDEA_ID = 29050;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29050Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29050Service() {
        this(new Idea29050Config());
    }

    public Idea29050Service(Idea29050Config config) {
        this.config = config != null ? config : new Idea29050Config();
