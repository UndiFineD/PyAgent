...
@Data
public class Idea29390Config {
    private String name = "idea_029390";
 ...
 */
@Slf4j
public class Idea29390Service {
    private static final int IDEA_ID = 29390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29390Service() {
        this(new Idea29390Config());
    }

    public Idea29390Service(Idea29390Config config) {
        this.config = config != null ? config : new Idea29390Config();
