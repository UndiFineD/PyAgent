...
@Data
public class Idea29191Config {
    private String name = "idea_029191";
 ...
 */
@Slf4j
public class Idea29191Service {
    private static final int IDEA_ID = 29191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29191Service() {
        this(new Idea29191Config());
    }

    public Idea29191Service(Idea29191Config config) {
        this.config = config != null ? config : new Idea29191Config();
