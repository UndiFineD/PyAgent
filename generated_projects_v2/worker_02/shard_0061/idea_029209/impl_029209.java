...
@Data
public class Idea29209Config {
    private String name = "idea_029209";
 ...
 */
@Slf4j
public class Idea29209Service {
    private static final int IDEA_ID = 29209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29209Service() {
        this(new Idea29209Config());
    }

    public Idea29209Service(Idea29209Config config) {
        this.config = config != null ? config : new Idea29209Config();
