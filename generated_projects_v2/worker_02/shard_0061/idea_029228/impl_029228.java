...
@Data
public class Idea29228Config {
    private String name = "idea_029228";
 ...
 */
@Slf4j
public class Idea29228Service {
    private static final int IDEA_ID = 29228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29228Service() {
        this(new Idea29228Config());
    }

    public Idea29228Service(Idea29228Config config) {
        this.config = config != null ? config : new Idea29228Config();
