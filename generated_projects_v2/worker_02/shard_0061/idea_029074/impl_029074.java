...
@Data
public class Idea29074Config {
    private String name = "idea_029074";
 ...
 */
@Slf4j
public class Idea29074Service {
    private static final int IDEA_ID = 29074;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29074Service() {
        this(new Idea29074Config());
    }

    public Idea29074Service(Idea29074Config config) {
        this.config = config != null ? config : new Idea29074Config();
