...
@Data
public class Idea29057Config {
    private String name = "idea_029057";
 ...
 */
@Slf4j
public class Idea29057Service {
    private static final int IDEA_ID = 29057;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29057Service() {
        this(new Idea29057Config());
    }

    public Idea29057Service(Idea29057Config config) {
        this.config = config != null ? config : new Idea29057Config();
