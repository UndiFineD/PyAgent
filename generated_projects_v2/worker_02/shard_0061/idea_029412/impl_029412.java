...
@Data
public class Idea29412Config {
    private String name = "idea_029412";
 ...
 */
@Slf4j
public class Idea29412Service {
    private static final int IDEA_ID = 29412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29412Service() {
        this(new Idea29412Config());
    }

    public Idea29412Service(Idea29412Config config) {
        this.config = config != null ? config : new Idea29412Config();
