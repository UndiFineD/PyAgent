...
@Data
public class Idea29005Config {
    private String name = "idea_029005";
 ...
 */
@Slf4j
public class Idea29005Service {
    private static final int IDEA_ID = 29005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29005Service() {
        this(new Idea29005Config());
    }

    public Idea29005Service(Idea29005Config config) {
        this.config = config != null ? config : new Idea29005Config();
