...
@Data
public class Idea29234Config {
    private String name = "idea_029234";
 ...
 */
@Slf4j
public class Idea29234Service {
    private static final int IDEA_ID = 29234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29234Service() {
        this(new Idea29234Config());
    }

    public Idea29234Service(Idea29234Config config) {
        this.config = config != null ? config : new Idea29234Config();
