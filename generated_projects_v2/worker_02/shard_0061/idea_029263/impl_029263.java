...
@Data
public class Idea29263Config {
    private String name = "idea_029263";
 ...
 */
@Slf4j
public class Idea29263Service {
    private static final int IDEA_ID = 29263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29263Service() {
        this(new Idea29263Config());
    }

    public Idea29263Service(Idea29263Config config) {
        this.config = config != null ? config : new Idea29263Config();
