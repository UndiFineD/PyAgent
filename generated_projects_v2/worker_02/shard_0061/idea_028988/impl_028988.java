...
@Data
public class Idea28988Config {
    private String name = "idea_028988";
 ...
 */
@Slf4j
public class Idea28988Service {
    private static final int IDEA_ID = 28988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28988Service() {
        this(new Idea28988Config());
    }

    public Idea28988Service(Idea28988Config config) {
        this.config = config != null ? config : new Idea28988Config();
