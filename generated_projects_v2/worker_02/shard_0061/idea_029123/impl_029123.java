...
@Data
public class Idea29123Config {
    private String name = "idea_029123";
 ...
 */
@Slf4j
public class Idea29123Service {
    private static final int IDEA_ID = 29123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29123Service() {
        this(new Idea29123Config());
    }

    public Idea29123Service(Idea29123Config config) {
        this.config = config != null ? config : new Idea29123Config();
