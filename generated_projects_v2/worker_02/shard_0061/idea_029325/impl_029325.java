...
@Data
public class Idea29325Config {
    private String name = "idea_029325";
 ...
 */
@Slf4j
public class Idea29325Service {
    private static final int IDEA_ID = 29325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29325Service() {
        this(new Idea29325Config());
    }

    public Idea29325Service(Idea29325Config config) {
        this.config = config != null ? config : new Idea29325Config();
