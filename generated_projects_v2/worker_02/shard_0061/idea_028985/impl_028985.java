...
@Data
public class Idea28985Config {
    private String name = "idea_028985";
 ...
 */
@Slf4j
public class Idea28985Service {
    private static final int IDEA_ID = 28985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28985Service() {
        this(new Idea28985Config());
    }

    public Idea28985Service(Idea28985Config config) {
        this.config = config != null ? config : new Idea28985Config();
