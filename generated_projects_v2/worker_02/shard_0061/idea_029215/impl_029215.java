...
@Data
public class Idea29215Config {
    private String name = "idea_029215";
 ...
 */
@Slf4j
public class Idea29215Service {
    private static final int IDEA_ID = 29215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29215Service() {
        this(new Idea29215Config());
    }

    public Idea29215Service(Idea29215Config config) {
        this.config = config != null ? config : new Idea29215Config();
