...
@Data
public class Idea29249Config {
    private String name = "idea_029249";
 ...
 */
@Slf4j
public class Idea29249Service {
    private static final int IDEA_ID = 29249;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29249Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29249Service() {
        this(new Idea29249Config());
    }

    public Idea29249Service(Idea29249Config config) {
        this.config = config != null ? config : new Idea29249Config();
