...
@Data
public class Idea29232Config {
    private String name = "idea_029232";
 ...
 */
@Slf4j
public class Idea29232Service {
    private static final int IDEA_ID = 29232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29232Service() {
        this(new Idea29232Config());
    }

    public Idea29232Service(Idea29232Config config) {
        this.config = config != null ? config : new Idea29232Config();
