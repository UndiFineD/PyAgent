...
@Data
public class Idea29072Config {
    private String name = "idea_029072";
 ...
 */
@Slf4j
public class Idea29072Service {
    private static final int IDEA_ID = 29072;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29072Service() {
        this(new Idea29072Config());
    }

    public Idea29072Service(Idea29072Config config) {
        this.config = config != null ? config : new Idea29072Config();
