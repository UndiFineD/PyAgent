...
@Data
public class Idea29427Config {
    private String name = "idea_029427";
 ...
 */
@Slf4j
public class Idea29427Service {
    private static final int IDEA_ID = 29427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29427Service() {
        this(new Idea29427Config());
    }

    public Idea29427Service(Idea29427Config config) {
        this.config = config != null ? config : new Idea29427Config();
