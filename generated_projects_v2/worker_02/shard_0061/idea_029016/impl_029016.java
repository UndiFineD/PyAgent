...
@Data
public class Idea29016Config {
    private String name = "idea_029016";
 ...
 */
@Slf4j
public class Idea29016Service {
    private static final int IDEA_ID = 29016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29016Service() {
        this(new Idea29016Config());
    }

    public Idea29016Service(Idea29016Config config) {
        this.config = config != null ? config : new Idea29016Config();
