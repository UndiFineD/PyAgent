...
@Data
public class Idea29184Config {
    private String name = "idea_029184";
 ...
 */
@Slf4j
public class Idea29184Service {
    private static final int IDEA_ID = 29184;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29184Service() {
        this(new Idea29184Config());
    }

    public Idea29184Service(Idea29184Config config) {
        this.config = config != null ? config : new Idea29184Config();
