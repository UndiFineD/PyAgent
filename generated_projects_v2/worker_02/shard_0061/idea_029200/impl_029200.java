...
@Data
public class Idea29200Config {
    private String name = "idea_029200";
 ...
 */
@Slf4j
public class Idea29200Service {
    private static final int IDEA_ID = 29200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29200Service() {
        this(new Idea29200Config());
    }

    public Idea29200Service(Idea29200Config config) {
        this.config = config != null ? config : new Idea29200Config();
