...
@Data
public class Idea29059Config {
    private String name = "idea_029059";
 ...
 */
@Slf4j
public class Idea29059Service {
    private static final int IDEA_ID = 29059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29059Service() {
        this(new Idea29059Config());
    }

    public Idea29059Service(Idea29059Config config) {
        this.config = config != null ? config : new Idea29059Config();
