...
@Data
public class Idea29240Config {
    private String name = "idea_029240";
 ...
 */
@Slf4j
public class Idea29240Service {
    private static final int IDEA_ID = 29240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29240Service() {
        this(new Idea29240Config());
    }

    public Idea29240Service(Idea29240Config config) {
        this.config = config != null ? config : new Idea29240Config();
