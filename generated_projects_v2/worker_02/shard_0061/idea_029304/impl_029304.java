...
@Data
public class Idea29304Config {
    private String name = "idea_029304";
 ...
 */
@Slf4j
public class Idea29304Service {
    private static final int IDEA_ID = 29304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29304Service() {
        this(new Idea29304Config());
    }

    public Idea29304Service(Idea29304Config config) {
        this.config = config != null ? config : new Idea29304Config();
