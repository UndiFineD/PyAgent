...
@Data
public class Idea29445Config {
    private String name = "idea_029445";
 ...
 */
@Slf4j
public class Idea29445Service {
    private static final int IDEA_ID = 29445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29445Service() {
        this(new Idea29445Config());
    }

    public Idea29445Service(Idea29445Config config) {
        this.config = config != null ? config : new Idea29445Config();
