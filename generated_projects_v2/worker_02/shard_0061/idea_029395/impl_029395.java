...
@Data
public class Idea29395Config {
    private String name = "idea_029395";
 ...
 */
@Slf4j
public class Idea29395Service {
    private static final int IDEA_ID = 29395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29395Service() {
        this(new Idea29395Config());
    }

    public Idea29395Service(Idea29395Config config) {
        this.config = config != null ? config : new Idea29395Config();
