...
@Data
public class Idea29287Config {
    private String name = "idea_029287";
 ...
 */
@Slf4j
public class Idea29287Service {
    private static final int IDEA_ID = 29287;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29287Service() {
        this(new Idea29287Config());
    }

    public Idea29287Service(Idea29287Config config) {
        this.config = config != null ? config : new Idea29287Config();
