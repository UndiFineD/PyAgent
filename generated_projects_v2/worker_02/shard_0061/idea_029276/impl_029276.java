...
@Data
public class Idea29276Config {
    private String name = "idea_029276";
 ...
 */
@Slf4j
public class Idea29276Service {
    private static final int IDEA_ID = 29276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29276Service() {
        this(new Idea29276Config());
    }

    public Idea29276Service(Idea29276Config config) {
        this.config = config != null ? config : new Idea29276Config();
