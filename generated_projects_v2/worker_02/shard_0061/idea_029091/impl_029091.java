...
@Data
public class Idea29091Config {
    private String name = "idea_029091";
 ...
 */
@Slf4j
public class Idea29091Service {
    private static final int IDEA_ID = 29091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29091Service() {
        this(new Idea29091Config());
    }

    public Idea29091Service(Idea29091Config config) {
        this.config = config != null ? config : new Idea29091Config();
