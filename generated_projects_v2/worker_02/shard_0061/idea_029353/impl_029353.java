...
@Data
public class Idea29353Config {
    private String name = "idea_029353";
 ...
 */
@Slf4j
public class Idea29353Service {
    private static final int IDEA_ID = 29353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29353Service() {
        this(new Idea29353Config());
    }

    public Idea29353Service(Idea29353Config config) {
        this.config = config != null ? config : new Idea29353Config();
