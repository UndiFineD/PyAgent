...
@Data
public class Idea29262Config {
    private String name = "idea_029262";
 ...
 */
@Slf4j
public class Idea29262Service {
    private static final int IDEA_ID = 29262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29262Service() {
        this(new Idea29262Config());
    }

    public Idea29262Service(Idea29262Config config) {
        this.config = config != null ? config : new Idea29262Config();
