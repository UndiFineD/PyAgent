...
@Data
public class Idea29233Config {
    private String name = "idea_029233";
 ...
 */
@Slf4j
public class Idea29233Service {
    private static final int IDEA_ID = 29233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29233Service() {
        this(new Idea29233Config());
    }

    public Idea29233Service(Idea29233Config config) {
        this.config = config != null ? config : new Idea29233Config();
