...
@Data
public class Idea29394Config {
    private String name = "idea_029394";
 ...
 */
@Slf4j
public class Idea29394Service {
    private static final int IDEA_ID = 29394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29394Service() {
        this(new Idea29394Config());
    }

    public Idea29394Service(Idea29394Config config) {
        this.config = config != null ? config : new Idea29394Config();
