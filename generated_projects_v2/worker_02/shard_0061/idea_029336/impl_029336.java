...
@Data
public class Idea29336Config {
    private String name = "idea_029336";
 ...
 */
@Slf4j
public class Idea29336Service {
    private static final int IDEA_ID = 29336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29336Service() {
        this(new Idea29336Config());
    }

    public Idea29336Service(Idea29336Config config) {
        this.config = config != null ? config : new Idea29336Config();
