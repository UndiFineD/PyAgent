...
@Data
public class Idea29116Config {
    private String name = "idea_029116";
 ...
 */
@Slf4j
public class Idea29116Service {
    private static final int IDEA_ID = 29116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29116Service() {
        this(new Idea29116Config());
    }

    public Idea29116Service(Idea29116Config config) {
        this.config = config != null ? config : new Idea29116Config();
