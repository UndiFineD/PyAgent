...
@Data
public class Idea29027Config {
    private String name = "idea_029027";
 ...
 */
@Slf4j
public class Idea29027Service {
    private static final int IDEA_ID = 29027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29027Service() {
        this(new Idea29027Config());
    }

    public Idea29027Service(Idea29027Config config) {
        this.config = config != null ? config : new Idea29027Config();
