...
@Data
public class Idea29058Config {
    private String name = "idea_029058";
 ...
 */
@Slf4j
public class Idea29058Service {
    private static final int IDEA_ID = 29058;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29058Service() {
        this(new Idea29058Config());
    }

    public Idea29058Service(Idea29058Config config) {
        this.config = config != null ? config : new Idea29058Config();
