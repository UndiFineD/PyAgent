...
@Data
public class Idea29098Config {
    private String name = "idea_029098";
 ...
 */
@Slf4j
public class Idea29098Service {
    private static final int IDEA_ID = 29098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29098Service() {
        this(new Idea29098Config());
    }

    public Idea29098Service(Idea29098Config config) {
        this.config = config != null ? config : new Idea29098Config();
