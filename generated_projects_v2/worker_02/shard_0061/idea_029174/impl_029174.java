...
@Data
public class Idea29174Config {
    private String name = "idea_029174";
 ...
 */
@Slf4j
public class Idea29174Service {
    private static final int IDEA_ID = 29174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29174Service() {
        this(new Idea29174Config());
    }

    public Idea29174Service(Idea29174Config config) {
        this.config = config != null ? config : new Idea29174Config();
