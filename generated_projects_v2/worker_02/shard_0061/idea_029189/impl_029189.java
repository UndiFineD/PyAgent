...
@Data
public class Idea29189Config {
    private String name = "idea_029189";
 ...
 */
@Slf4j
public class Idea29189Service {
    private static final int IDEA_ID = 29189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29189Service() {
        this(new Idea29189Config());
    }

    public Idea29189Service(Idea29189Config config) {
        this.config = config != null ? config : new Idea29189Config();
