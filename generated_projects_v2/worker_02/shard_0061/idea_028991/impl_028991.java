...
@Data
public class Idea28991Config {
    private String name = "idea_028991";
 ...
 */
@Slf4j
public class Idea28991Service {
    private static final int IDEA_ID = 28991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28991Service() {
        this(new Idea28991Config());
    }

    public Idea28991Service(Idea28991Config config) {
        this.config = config != null ? config : new Idea28991Config();
