...
@Data
public class Idea29165Config {
    private String name = "idea_029165";
 ...
 */
@Slf4j
public class Idea29165Service {
    private static final int IDEA_ID = 29165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29165Service() {
        this(new Idea29165Config());
    }

    public Idea29165Service(Idea29165Config config) {
        this.config = config != null ? config : new Idea29165Config();
