...
@Data
public class Idea29020Config {
    private String name = "idea_029020";
 ...
 */
@Slf4j
public class Idea29020Service {
    private static final int IDEA_ID = 29020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29020Service() {
        this(new Idea29020Config());
    }

    public Idea29020Service(Idea29020Config config) {
        this.config = config != null ? config : new Idea29020Config();
