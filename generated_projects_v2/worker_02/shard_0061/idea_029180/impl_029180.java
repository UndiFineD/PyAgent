...
@Data
public class Idea29180Config {
    private String name = "idea_029180";
 ...
 */
@Slf4j
public class Idea29180Service {
    private static final int IDEA_ID = 29180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29180Service() {
        this(new Idea29180Config());
    }

    public Idea29180Service(Idea29180Config config) {
        this.config = config != null ? config : new Idea29180Config();
