...
@Data
public class Idea29381Config {
    private String name = "idea_029381";
 ...
 */
@Slf4j
public class Idea29381Service {
    private static final int IDEA_ID = 29381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29381Service() {
        this(new Idea29381Config());
    }

    public Idea29381Service(Idea29381Config config) {
        this.config = config != null ? config : new Idea29381Config();
