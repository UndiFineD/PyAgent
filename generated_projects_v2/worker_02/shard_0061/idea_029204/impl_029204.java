...
@Data
public class Idea29204Config {
    private String name = "idea_029204";
 ...
 */
@Slf4j
public class Idea29204Service {
    private static final int IDEA_ID = 29204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29204Service() {
        this(new Idea29204Config());
    }

    public Idea29204Service(Idea29204Config config) {
        this.config = config != null ? config : new Idea29204Config();
