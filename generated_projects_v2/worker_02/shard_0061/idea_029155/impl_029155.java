...
@Data
public class Idea29155Config {
    private String name = "idea_029155";
 ...
 */
@Slf4j
public class Idea29155Service {
    private static final int IDEA_ID = 29155;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29155Service() {
        this(new Idea29155Config());
    }

    public Idea29155Service(Idea29155Config config) {
        this.config = config != null ? config : new Idea29155Config();
