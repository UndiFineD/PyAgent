...
@Data
public class Idea29420Config {
    private String name = "idea_029420";
 ...
 */
@Slf4j
public class Idea29420Service {
    private static final int IDEA_ID = 29420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29420Service() {
        this(new Idea29420Config());
    }

    public Idea29420Service(Idea29420Config config) {
        this.config = config != null ? config : new Idea29420Config();
