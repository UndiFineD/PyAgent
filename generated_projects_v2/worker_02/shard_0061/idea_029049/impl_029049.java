...
@Data
public class Idea29049Config {
    private String name = "idea_029049";
 ...
 */
@Slf4j
public class Idea29049Service {
    private static final int IDEA_ID = 29049;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29049Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29049Service() {
        this(new Idea29049Config());
    }

    public Idea29049Service(Idea29049Config config) {
        this.config = config != null ? config : new Idea29049Config();
