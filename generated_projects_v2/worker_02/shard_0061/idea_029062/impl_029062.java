...
@Data
public class Idea29062Config {
    private String name = "idea_029062";
 ...
 */
@Slf4j
public class Idea29062Service {
    private static final int IDEA_ID = 29062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29062Service() {
        this(new Idea29062Config());
    }

    public Idea29062Service(Idea29062Config config) {
        this.config = config != null ? config : new Idea29062Config();
