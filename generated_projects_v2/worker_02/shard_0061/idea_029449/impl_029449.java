...
@Data
public class Idea29449Config {
    private String name = "idea_029449";
 ...
 */
@Slf4j
public class Idea29449Service {
    private static final int IDEA_ID = 29449;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29449Service() {
        this(new Idea29449Config());
    }

    public Idea29449Service(Idea29449Config config) {
        this.config = config != null ? config : new Idea29449Config();
