...
@Data
public class Idea29140Config {
    private String name = "idea_029140";
 ...
 */
@Slf4j
public class Idea29140Service {
    private static final int IDEA_ID = 29140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29140Service() {
        this(new Idea29140Config());
    }

    public Idea29140Service(Idea29140Config config) {
        this.config = config != null ? config : new Idea29140Config();
