...
@Data
public class Idea29286Config {
    private String name = "idea_029286";
 ...
 */
@Slf4j
public class Idea29286Service {
    private static final int IDEA_ID = 29286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29286Service() {
        this(new Idea29286Config());
    }

    public Idea29286Service(Idea29286Config config) {
        this.config = config != null ? config : new Idea29286Config();
