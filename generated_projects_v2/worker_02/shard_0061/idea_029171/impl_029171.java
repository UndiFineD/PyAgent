...
@Data
public class Idea29171Config {
    private String name = "idea_029171";
 ...
 */
@Slf4j
public class Idea29171Service {
    private static final int IDEA_ID = 29171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29171Service() {
        this(new Idea29171Config());
    }

    public Idea29171Service(Idea29171Config config) {
        this.config = config != null ? config : new Idea29171Config();
