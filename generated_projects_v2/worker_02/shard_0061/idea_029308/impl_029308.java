...
@Data
public class Idea29308Config {
    private String name = "idea_029308";
 ...
 */
@Slf4j
public class Idea29308Service {
    private static final int IDEA_ID = 29308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29308Service() {
        this(new Idea29308Config());
    }

    public Idea29308Service(Idea29308Config config) {
        this.config = config != null ? config : new Idea29308Config();
