...
@Data
public class Idea29025Config {
    private String name = "idea_029025";
 ...
 */
@Slf4j
public class Idea29025Service {
    private static final int IDEA_ID = 29025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29025Service() {
        this(new Idea29025Config());
    }

    public Idea29025Service(Idea29025Config config) {
        this.config = config != null ? config : new Idea29025Config();
