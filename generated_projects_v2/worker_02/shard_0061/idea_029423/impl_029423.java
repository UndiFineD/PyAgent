...
@Data
public class Idea29423Config {
    private String name = "idea_029423";
 ...
 */
@Slf4j
public class Idea29423Service {
    private static final int IDEA_ID = 29423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29423Service() {
        this(new Idea29423Config());
    }

    public Idea29423Service(Idea29423Config config) {
        this.config = config != null ? config : new Idea29423Config();
