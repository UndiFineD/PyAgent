...
@Data
public class Idea29407Config {
    private String name = "idea_029407";
 ...
 */
@Slf4j
public class Idea29407Service {
    private static final int IDEA_ID = 29407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29407Service() {
        this(new Idea29407Config());
    }

    public Idea29407Service(Idea29407Config config) {
        this.config = config != null ? config : new Idea29407Config();
