...
@Data
public class Idea29115Config {
    private String name = "idea_029115";
 ...
 */
@Slf4j
public class Idea29115Service {
    private static final int IDEA_ID = 29115;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29115Service() {
        this(new Idea29115Config());
    }

    public Idea29115Service(Idea29115Config config) {
        this.config = config != null ? config : new Idea29115Config();
