...
@Data
public class Idea29109Config {
    private String name = "idea_029109";
 ...
 */
@Slf4j
public class Idea29109Service {
    private static final int IDEA_ID = 29109;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29109Service() {
        this(new Idea29109Config());
    }

    public Idea29109Service(Idea29109Config config) {
        this.config = config != null ? config : new Idea29109Config();
