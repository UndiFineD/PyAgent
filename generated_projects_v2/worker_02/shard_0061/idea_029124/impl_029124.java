...
@Data
public class Idea29124Config {
    private String name = "idea_029124";
 ...
 */
@Slf4j
public class Idea29124Service {
    private static final int IDEA_ID = 29124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29124Service() {
        this(new Idea29124Config());
    }

    public Idea29124Service(Idea29124Config config) {
        this.config = config != null ? config : new Idea29124Config();
