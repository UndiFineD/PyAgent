...
@Data
public class Idea29421Config {
    private String name = "idea_029421";
 ...
 */
@Slf4j
public class Idea29421Service {
    private static final int IDEA_ID = 29421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29421Service() {
        this(new Idea29421Config());
    }

    public Idea29421Service(Idea29421Config config) {
        this.config = config != null ? config : new Idea29421Config();
