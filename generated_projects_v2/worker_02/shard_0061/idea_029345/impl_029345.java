...
@Data
public class Idea29345Config {
    private String name = "idea_029345";
 ...
 */
@Slf4j
public class Idea29345Service {
    private static final int IDEA_ID = 29345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29345Service() {
        this(new Idea29345Config());
    }

    public Idea29345Service(Idea29345Config config) {
        this.config = config != null ? config : new Idea29345Config();
