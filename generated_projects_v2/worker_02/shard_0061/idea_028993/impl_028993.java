...
@Data
public class Idea28993Config {
    private String name = "idea_028993";
 ...
 */
@Slf4j
public class Idea28993Service {
    private static final int IDEA_ID = 28993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28993Service() {
        this(new Idea28993Config());
    }

    public Idea28993Service(Idea28993Config config) {
        this.config = config != null ? config : new Idea28993Config();
