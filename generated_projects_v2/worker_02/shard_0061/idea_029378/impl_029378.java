...
@Data
public class Idea29378Config {
    private String name = "idea_029378";
 ...
 */
@Slf4j
public class Idea29378Service {
    private static final int IDEA_ID = 29378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29378Service() {
        this(new Idea29378Config());
    }

    public Idea29378Service(Idea29378Config config) {
        this.config = config != null ? config : new Idea29378Config();
