...
@Data
public class Idea29306Config {
    private String name = "idea_029306";
 ...
 */
@Slf4j
public class Idea29306Service {
    private static final int IDEA_ID = 29306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29306Service() {
        this(new Idea29306Config());
    }

    public Idea29306Service(Idea29306Config config) {
        this.config = config != null ? config : new Idea29306Config();
