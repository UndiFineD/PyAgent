...
@Data
public class Idea29327Config {
    private String name = "idea_029327";
 ...
 */
@Slf4j
public class Idea29327Service {
    private static final int IDEA_ID = 29327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29327Service() {
        this(new Idea29327Config());
    }

    public Idea29327Service(Idea29327Config config) {
        this.config = config != null ? config : new Idea29327Config();
