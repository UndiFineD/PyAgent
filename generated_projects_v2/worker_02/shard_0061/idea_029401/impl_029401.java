...
@Data
public class Idea29401Config {
    private String name = "idea_029401";
 ...
 */
@Slf4j
public class Idea29401Service {
    private static final int IDEA_ID = 29401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29401Service() {
        this(new Idea29401Config());
    }

    public Idea29401Service(Idea29401Config config) {
        this.config = config != null ? config : new Idea29401Config();
