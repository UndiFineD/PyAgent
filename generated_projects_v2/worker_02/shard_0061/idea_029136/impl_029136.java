...
@Data
public class Idea29136Config {
    private String name = "idea_029136";
 ...
 */
@Slf4j
public class Idea29136Service {
    private static final int IDEA_ID = 29136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29136Service() {
        this(new Idea29136Config());
    }

    public Idea29136Service(Idea29136Config config) {
        this.config = config != null ? config : new Idea29136Config();
