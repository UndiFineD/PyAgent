...
@Data
public class Idea29081Config {
    private String name = "idea_029081";
 ...
 */
@Slf4j
public class Idea29081Service {
    private static final int IDEA_ID = 29081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29081Service() {
        this(new Idea29081Config());
    }

    public Idea29081Service(Idea29081Config config) {
        this.config = config != null ? config : new Idea29081Config();
