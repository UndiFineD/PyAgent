...
@Data
public class Idea29029Config {
    private String name = "idea_029029";
 ...
 */
@Slf4j
public class Idea29029Service {
    private static final int IDEA_ID = 29029;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29029Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29029Service() {
        this(new Idea29029Config());
    }

    public Idea29029Service(Idea29029Config config) {
        this.config = config != null ? config : new Idea29029Config();
