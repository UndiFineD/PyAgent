...
@Data
public class Idea29382Config {
    private String name = "idea_029382";
 ...
 */
@Slf4j
public class Idea29382Service {
    private static final int IDEA_ID = 29382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29382Service() {
        this(new Idea29382Config());
    }

    public Idea29382Service(Idea29382Config config) {
        this.config = config != null ? config : new Idea29382Config();
