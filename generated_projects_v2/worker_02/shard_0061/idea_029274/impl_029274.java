...
@Data
public class Idea29274Config {
    private String name = "idea_029274";
 ...
 */
@Slf4j
public class Idea29274Service {
    private static final int IDEA_ID = 29274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29274Service() {
        this(new Idea29274Config());
    }

    public Idea29274Service(Idea29274Config config) {
        this.config = config != null ? config : new Idea29274Config();
