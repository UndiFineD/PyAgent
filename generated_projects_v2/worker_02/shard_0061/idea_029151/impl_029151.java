...
@Data
public class Idea29151Config {
    private String name = "idea_029151";
 ...
 */
@Slf4j
public class Idea29151Service {
    private static final int IDEA_ID = 29151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29151Service() {
        this(new Idea29151Config());
    }

    public Idea29151Service(Idea29151Config config) {
        this.config = config != null ? config : new Idea29151Config();
