...
@Data
public class Idea29018Config {
    private String name = "idea_029018";
 ...
 */
@Slf4j
public class Idea29018Service {
    private static final int IDEA_ID = 29018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29018Service() {
        this(new Idea29018Config());
    }

    public Idea29018Service(Idea29018Config config) {
        this.config = config != null ? config : new Idea29018Config();
