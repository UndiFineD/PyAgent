...
@Data
public class Idea29023Config {
    private String name = "idea_029023";
 ...
 */
@Slf4j
public class Idea29023Service {
    private static final int IDEA_ID = 29023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29023Service() {
        this(new Idea29023Config());
    }

    public Idea29023Service(Idea29023Config config) {
        this.config = config != null ? config : new Idea29023Config();
