...
@Data
public class Idea29261Config {
    private String name = "idea_029261";
 ...
 */
@Slf4j
public class Idea29261Service {
    private static final int IDEA_ID = 29261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29261Service() {
        this(new Idea29261Config());
    }

    public Idea29261Service(Idea29261Config config) {
        this.config = config != null ? config : new Idea29261Config();
