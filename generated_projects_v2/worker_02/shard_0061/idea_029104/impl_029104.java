...
@Data
public class Idea29104Config {
    private String name = "idea_029104";
 ...
 */
@Slf4j
public class Idea29104Service {
    private static final int IDEA_ID = 29104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29104Service() {
        this(new Idea29104Config());
    }

    public Idea29104Service(Idea29104Config config) {
        this.config = config != null ? config : new Idea29104Config();
