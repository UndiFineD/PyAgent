...
@Data
public class Idea28999Config {
    private String name = "idea_028999";
 ...
 */
@Slf4j
public class Idea28999Service {
    private static final int IDEA_ID = 28999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28999Service() {
        this(new Idea28999Config());
    }

    public Idea28999Service(Idea28999Config config) {
        this.config = config != null ? config : new Idea28999Config();
