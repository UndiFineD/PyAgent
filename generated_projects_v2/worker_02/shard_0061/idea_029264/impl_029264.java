...
@Data
public class Idea29264Config {
    private String name = "idea_029264";
 ...
 */
@Slf4j
public class Idea29264Service {
    private static final int IDEA_ID = 29264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29264Service() {
        this(new Idea29264Config());
    }

    public Idea29264Service(Idea29264Config config) {
        this.config = config != null ? config : new Idea29264Config();
