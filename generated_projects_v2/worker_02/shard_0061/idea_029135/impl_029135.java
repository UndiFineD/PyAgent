...
@Data
public class Idea29135Config {
    private String name = "idea_029135";
 ...
 */
@Slf4j
public class Idea29135Service {
    private static final int IDEA_ID = 29135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29135Service() {
        this(new Idea29135Config());
    }

    public Idea29135Service(Idea29135Config config) {
        this.config = config != null ? config : new Idea29135Config();
