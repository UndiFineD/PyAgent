...
@Data
public class Idea29316Config {
    private String name = "idea_029316";
 ...
 */
@Slf4j
public class Idea29316Service {
    private static final int IDEA_ID = 29316;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29316Service() {
        this(new Idea29316Config());
    }

    public Idea29316Service(Idea29316Config config) {
        this.config = config != null ? config : new Idea29316Config();
