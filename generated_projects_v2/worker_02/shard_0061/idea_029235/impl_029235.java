...
@Data
public class Idea29235Config {
    private String name = "idea_029235";
 ...
 */
@Slf4j
public class Idea29235Service {
    private static final int IDEA_ID = 29235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29235Service() {
        this(new Idea29235Config());
    }

    public Idea29235Service(Idea29235Config config) {
        this.config = config != null ? config : new Idea29235Config();
