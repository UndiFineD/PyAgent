...
@Data
public class Idea29281Config {
    private String name = "idea_029281";
 ...
 */
@Slf4j
public class Idea29281Service {
    private static final int IDEA_ID = 29281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29281Service() {
        this(new Idea29281Config());
    }

    public Idea29281Service(Idea29281Config config) {
        this.config = config != null ? config : new Idea29281Config();
