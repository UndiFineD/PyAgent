...
@Data
public class Idea29019Config {
    private String name = "idea_029019";
 ...
 */
@Slf4j
public class Idea29019Service {
    private static final int IDEA_ID = 29019;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29019Service() {
        this(new Idea29019Config());
    }

    public Idea29019Service(Idea29019Config config) {
        this.config = config != null ? config : new Idea29019Config();
