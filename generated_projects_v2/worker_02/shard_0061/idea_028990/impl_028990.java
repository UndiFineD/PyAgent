...
@Data
public class Idea28990Config {
    private String name = "idea_028990";
 ...
 */
@Slf4j
public class Idea28990Service {
    private static final int IDEA_ID = 28990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28990Service() {
        this(new Idea28990Config());
    }

    public Idea28990Service(Idea28990Config config) {
        this.config = config != null ? config : new Idea28990Config();
