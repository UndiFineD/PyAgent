...
@Data
public class Idea29094Config {
    private String name = "idea_029094";
 ...
 */
@Slf4j
public class Idea29094Service {
    private static final int IDEA_ID = 29094;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29094Service() {
        this(new Idea29094Config());
    }

    public Idea29094Service(Idea29094Config config) {
        this.config = config != null ? config : new Idea29094Config();
