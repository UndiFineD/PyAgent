...
@Data
public class Idea29447Config {
    private String name = "idea_029447";
 ...
 */
@Slf4j
public class Idea29447Service {
    private static final int IDEA_ID = 29447;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29447Service() {
        this(new Idea29447Config());
    }

    public Idea29447Service(Idea29447Config config) {
        this.config = config != null ? config : new Idea29447Config();
