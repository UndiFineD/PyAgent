...
@Data
public class Idea29231Config {
    private String name = "idea_029231";
 ...
 */
@Slf4j
public class Idea29231Service {
    private static final int IDEA_ID = 29231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29231Service() {
        this(new Idea29231Config());
    }

    public Idea29231Service(Idea29231Config config) {
        this.config = config != null ? config : new Idea29231Config();
