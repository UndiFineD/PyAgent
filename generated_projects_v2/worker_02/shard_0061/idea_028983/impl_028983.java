...
@Data
public class Idea28983Config {
    private String name = "idea_028983";
 ...
 */
@Slf4j
public class Idea28983Service {
    private static final int IDEA_ID = 28983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28983Service() {
        this(new Idea28983Config());
    }

    public Idea28983Service(Idea28983Config config) {
        this.config = config != null ? config : new Idea28983Config();
