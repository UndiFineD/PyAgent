...
@Data
public class Idea29039Config {
    private String name = "idea_029039";
 ...
 */
@Slf4j
public class Idea29039Service {
    private static final int IDEA_ID = 29039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29039Service() {
        this(new Idea29039Config());
    }

    public Idea29039Service(Idea29039Config config) {
        this.config = config != null ? config : new Idea29039Config();
