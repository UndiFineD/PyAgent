...
@Data
public class Idea29376Config {
    private String name = "idea_029376";
 ...
 */
@Slf4j
public class Idea29376Service {
    private static final int IDEA_ID = 29376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29376Service() {
        this(new Idea29376Config());
    }

    public Idea29376Service(Idea29376Config config) {
        this.config = config != null ? config : new Idea29376Config();
