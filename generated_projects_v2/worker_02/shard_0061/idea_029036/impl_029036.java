...
@Data
public class Idea29036Config {
    private String name = "idea_029036";
 ...
 */
@Slf4j
public class Idea29036Service {
    private static final int IDEA_ID = 29036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29036Service() {
        this(new Idea29036Config());
    }

    public Idea29036Service(Idea29036Config config) {
        this.config = config != null ? config : new Idea29036Config();
