...
@Data
public class Idea28986Config {
    private String name = "idea_028986";
 ...
 */
@Slf4j
public class Idea28986Service {
    private static final int IDEA_ID = 28986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28986Service() {
        this(new Idea28986Config());
    }

    public Idea28986Service(Idea28986Config config) {
        this.config = config != null ? config : new Idea28986Config();
