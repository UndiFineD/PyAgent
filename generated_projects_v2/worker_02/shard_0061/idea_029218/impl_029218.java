...
@Data
public class Idea29218Config {
    private String name = "idea_029218";
 ...
 */
@Slf4j
public class Idea29218Service {
    private static final int IDEA_ID = 29218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29218Service() {
        this(new Idea29218Config());
    }

    public Idea29218Service(Idea29218Config config) {
        this.config = config != null ? config : new Idea29218Config();
