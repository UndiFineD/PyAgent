...
@Data
public class Idea28978Config {
    private String name = "idea_028978";
 ...
 */
@Slf4j
public class Idea28978Service {
    private static final int IDEA_ID = 28978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28978Service() {
        this(new Idea28978Config());
    }

    public Idea28978Service(Idea28978Config config) {
        this.config = config != null ? config : new Idea28978Config();
