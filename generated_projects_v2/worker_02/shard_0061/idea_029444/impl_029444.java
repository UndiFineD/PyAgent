...
@Data
public class Idea29444Config {
    private String name = "idea_029444";
 ...
 */
@Slf4j
public class Idea29444Service {
    private static final int IDEA_ID = 29444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29444Service() {
        this(new Idea29444Config());
    }

    public Idea29444Service(Idea29444Config config) {
        this.config = config != null ? config : new Idea29444Config();
