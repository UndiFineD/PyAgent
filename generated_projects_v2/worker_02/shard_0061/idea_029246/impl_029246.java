...
@Data
public class Idea29246Config {
    private String name = "idea_029246";
 ...
 */
@Slf4j
public class Idea29246Service {
    private static final int IDEA_ID = 29246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29246Service() {
        this(new Idea29246Config());
    }

    public Idea29246Service(Idea29246Config config) {
        this.config = config != null ? config : new Idea29246Config();
