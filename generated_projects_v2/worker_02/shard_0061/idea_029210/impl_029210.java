...
@Data
public class Idea29210Config {
    private String name = "idea_029210";
 ...
 */
@Slf4j
public class Idea29210Service {
    private static final int IDEA_ID = 29210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29210Service() {
        this(new Idea29210Config());
    }

    public Idea29210Service(Idea29210Config config) {
        this.config = config != null ? config : new Idea29210Config();
