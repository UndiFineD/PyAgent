...
@Data
public class Idea29272Config {
    private String name = "idea_029272";
 ...
 */
@Slf4j
public class Idea29272Service {
    private static final int IDEA_ID = 29272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29272Service() {
        this(new Idea29272Config());
    }

    public Idea29272Service(Idea29272Config config) {
        this.config = config != null ? config : new Idea29272Config();
