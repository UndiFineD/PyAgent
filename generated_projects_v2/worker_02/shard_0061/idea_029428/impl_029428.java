...
@Data
public class Idea29428Config {
    private String name = "idea_029428";
 ...
 */
@Slf4j
public class Idea29428Service {
    private static final int IDEA_ID = 29428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29428Service() {
        this(new Idea29428Config());
    }

    public Idea29428Service(Idea29428Config config) {
        this.config = config != null ? config : new Idea29428Config();
