...
@Data
public class Idea29065Config {
    private String name = "idea_029065";
 ...
 */
@Slf4j
public class Idea29065Service {
    private static final int IDEA_ID = 29065;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29065Service() {
        this(new Idea29065Config());
    }

    public Idea29065Service(Idea29065Config config) {
        this.config = config != null ? config : new Idea29065Config();
