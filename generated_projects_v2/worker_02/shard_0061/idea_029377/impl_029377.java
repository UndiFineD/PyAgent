...
@Data
public class Idea29377Config {
    private String name = "idea_029377";
 ...
 */
@Slf4j
public class Idea29377Service {
    private static final int IDEA_ID = 29377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29377Service() {
        this(new Idea29377Config());
    }

    public Idea29377Service(Idea29377Config config) {
        this.config = config != null ? config : new Idea29377Config();
