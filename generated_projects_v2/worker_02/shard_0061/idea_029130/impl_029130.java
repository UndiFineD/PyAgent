...
@Data
public class Idea29130Config {
    private String name = "idea_029130";
 ...
 */
@Slf4j
public class Idea29130Service {
    private static final int IDEA_ID = 29130;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29130Service() {
        this(new Idea29130Config());
    }

    public Idea29130Service(Idea29130Config config) {
        this.config = config != null ? config : new Idea29130Config();
