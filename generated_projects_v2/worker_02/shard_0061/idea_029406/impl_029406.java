...
@Data
public class Idea29406Config {
    private String name = "idea_029406";
 ...
 */
@Slf4j
public class Idea29406Service {
    private static final int IDEA_ID = 29406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29406Service() {
        this(new Idea29406Config());
    }

    public Idea29406Service(Idea29406Config config) {
        this.config = config != null ? config : new Idea29406Config();
