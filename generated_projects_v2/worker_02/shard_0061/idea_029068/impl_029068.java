...
@Data
public class Idea29068Config {
    private String name = "idea_029068";
 ...
 */
@Slf4j
public class Idea29068Service {
    private static final int IDEA_ID = 29068;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29068Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29068Service() {
        this(new Idea29068Config());
    }

    public Idea29068Service(Idea29068Config config) {
        this.config = config != null ? config : new Idea29068Config();
