...
@Data
public class Idea29011Config {
    private String name = "idea_029011";
 ...
 */
@Slf4j
public class Idea29011Service {
    private static final int IDEA_ID = 29011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29011Service() {
        this(new Idea29011Config());
    }

    public Idea29011Service(Idea29011Config config) {
        this.config = config != null ? config : new Idea29011Config();
