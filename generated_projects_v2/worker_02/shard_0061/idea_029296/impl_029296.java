...
@Data
public class Idea29296Config {
    private String name = "idea_029296";
 ...
 */
@Slf4j
public class Idea29296Service {
    private static final int IDEA_ID = 29296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29296Service() {
        this(new Idea29296Config());
    }

    public Idea29296Service(Idea29296Config config) {
        this.config = config != null ? config : new Idea29296Config();
