...
@Data
public class Idea29260Config {
    private String name = "idea_029260";
 ...
 */
@Slf4j
public class Idea29260Service {
    private static final int IDEA_ID = 29260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29260Service() {
        this(new Idea29260Config());
    }

    public Idea29260Service(Idea29260Config config) {
        this.config = config != null ? config : new Idea29260Config();
