...
@Data
public class Idea28995Config {
    private String name = "idea_028995";
 ...
 */
@Slf4j
public class Idea28995Service {
    private static final int IDEA_ID = 28995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28995Service() {
        this(new Idea28995Config());
    }

    public Idea28995Service(Idea28995Config config) {
        this.config = config != null ? config : new Idea28995Config();
