...
@Data
public class Idea29290Config {
    private String name = "idea_029290";
 ...
 */
@Slf4j
public class Idea29290Service {
    private static final int IDEA_ID = 29290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29290Service() {
        this(new Idea29290Config());
    }

    public Idea29290Service(Idea29290Config config) {
        this.config = config != null ? config : new Idea29290Config();
