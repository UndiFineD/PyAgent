...
@Data
public class Idea29435Config {
    private String name = "idea_029435";
 ...
 */
@Slf4j
public class Idea29435Service {
    private static final int IDEA_ID = 29435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29435Service() {
        this(new Idea29435Config());
    }

    public Idea29435Service(Idea29435Config config) {
        this.config = config != null ? config : new Idea29435Config();
