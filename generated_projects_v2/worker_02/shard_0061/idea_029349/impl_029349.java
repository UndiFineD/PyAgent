...
@Data
public class Idea29349Config {
    private String name = "idea_029349";
 ...
 */
@Slf4j
public class Idea29349Service {
    private static final int IDEA_ID = 29349;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29349Service() {
        this(new Idea29349Config());
    }

    public Idea29349Service(Idea29349Config config) {
        this.config = config != null ? config : new Idea29349Config();
