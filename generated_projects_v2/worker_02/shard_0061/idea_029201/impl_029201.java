...
@Data
public class Idea29201Config {
    private String name = "idea_029201";
 ...
 */
@Slf4j
public class Idea29201Service {
    private static final int IDEA_ID = 29201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29201Service() {
        this(new Idea29201Config());
    }

    public Idea29201Service(Idea29201Config config) {
        this.config = config != null ? config : new Idea29201Config();
