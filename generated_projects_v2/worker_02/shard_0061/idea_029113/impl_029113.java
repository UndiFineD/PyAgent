...
@Data
public class Idea29113Config {
    private String name = "idea_029113";
 ...
 */
@Slf4j
public class Idea29113Service {
    private static final int IDEA_ID = 29113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29113Service() {
        this(new Idea29113Config());
    }

    public Idea29113Service(Idea29113Config config) {
        this.config = config != null ? config : new Idea29113Config();
