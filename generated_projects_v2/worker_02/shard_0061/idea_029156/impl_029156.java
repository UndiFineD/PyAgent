...
@Data
public class Idea29156Config {
    private String name = "idea_029156";
 ...
 */
@Slf4j
public class Idea29156Service {
    private static final int IDEA_ID = 29156;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29156Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29156Service() {
        this(new Idea29156Config());
    }

    public Idea29156Service(Idea29156Config config) {
        this.config = config != null ? config : new Idea29156Config();
