...
@Data
public class Idea29102Config {
    private String name = "idea_029102";
 ...
 */
@Slf4j
public class Idea29102Service {
    private static final int IDEA_ID = 29102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29102Service() {
        this(new Idea29102Config());
    }

    public Idea29102Service(Idea29102Config config) {
        this.config = config != null ? config : new Idea29102Config();
