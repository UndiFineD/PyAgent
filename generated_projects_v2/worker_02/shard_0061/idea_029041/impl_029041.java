...
@Data
public class Idea29041Config {
    private String name = "idea_029041";
 ...
 */
@Slf4j
public class Idea29041Service {
    private static final int IDEA_ID = 29041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29041Service() {
        this(new Idea29041Config());
    }

    public Idea29041Service(Idea29041Config config) {
        this.config = config != null ? config : new Idea29041Config();
