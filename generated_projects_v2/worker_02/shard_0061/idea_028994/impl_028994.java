...
@Data
public class Idea28994Config {
    private String name = "idea_028994";
 ...
 */
@Slf4j
public class Idea28994Service {
    private static final int IDEA_ID = 28994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28994Service() {
        this(new Idea28994Config());
    }

    public Idea28994Service(Idea28994Config config) {
        this.config = config != null ? config : new Idea28994Config();
