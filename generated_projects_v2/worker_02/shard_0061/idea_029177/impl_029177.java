...
@Data
public class Idea29177Config {
    private String name = "idea_029177";
 ...
 */
@Slf4j
public class Idea29177Service {
    private static final int IDEA_ID = 29177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29177Service() {
        this(new Idea29177Config());
    }

    public Idea29177Service(Idea29177Config config) {
        this.config = config != null ? config : new Idea29177Config();
