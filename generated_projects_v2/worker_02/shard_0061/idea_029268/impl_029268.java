...
@Data
public class Idea29268Config {
    private String name = "idea_029268";
 ...
 */
@Slf4j
public class Idea29268Service {
    private static final int IDEA_ID = 29268;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29268Service() {
        this(new Idea29268Config());
    }

    public Idea29268Service(Idea29268Config config) {
        this.config = config != null ? config : new Idea29268Config();
