...
@Data
public class Idea29284Config {
    private String name = "idea_029284";
 ...
 */
@Slf4j
public class Idea29284Service {
    private static final int IDEA_ID = 29284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29284Service() {
        this(new Idea29284Config());
    }

    public Idea29284Service(Idea29284Config config) {
        this.config = config != null ? config : new Idea29284Config();
