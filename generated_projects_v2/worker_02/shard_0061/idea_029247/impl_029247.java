...
@Data
public class Idea29247Config {
    private String name = "idea_029247";
 ...
 */
@Slf4j
public class Idea29247Service {
    private static final int IDEA_ID = 29247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29247Service() {
        this(new Idea29247Config());
    }

    public Idea29247Service(Idea29247Config config) {
        this.config = config != null ? config : new Idea29247Config();
