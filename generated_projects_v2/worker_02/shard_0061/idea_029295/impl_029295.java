...
@Data
public class Idea29295Config {
    private String name = "idea_029295";
 ...
 */
@Slf4j
public class Idea29295Service {
    private static final int IDEA_ID = 29295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29295Service() {
        this(new Idea29295Config());
    }

    public Idea29295Service(Idea29295Config config) {
        this.config = config != null ? config : new Idea29295Config();
