...
@Data
public class Idea29410Config {
    private String name = "idea_029410";
 ...
 */
@Slf4j
public class Idea29410Service {
    private static final int IDEA_ID = 29410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29410Service() {
        this(new Idea29410Config());
    }

    public Idea29410Service(Idea29410Config config) {
        this.config = config != null ? config : new Idea29410Config();
