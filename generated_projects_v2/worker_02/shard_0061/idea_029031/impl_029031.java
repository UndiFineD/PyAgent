...
@Data
public class Idea29031Config {
    private String name = "idea_029031";
 ...
 */
@Slf4j
public class Idea29031Service {
    private static final int IDEA_ID = 29031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29031Service() {
        this(new Idea29031Config());
    }

    public Idea29031Service(Idea29031Config config) {
        this.config = config != null ? config : new Idea29031Config();
