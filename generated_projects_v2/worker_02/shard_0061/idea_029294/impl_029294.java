...
@Data
public class Idea29294Config {
    private String name = "idea_029294";
 ...
 */
@Slf4j
public class Idea29294Service {
    private static final int IDEA_ID = 29294;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29294Service() {
        this(new Idea29294Config());
    }

    public Idea29294Service(Idea29294Config config) {
        this.config = config != null ? config : new Idea29294Config();
