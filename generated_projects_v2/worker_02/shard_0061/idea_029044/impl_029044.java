...
@Data
public class Idea29044Config {
    private String name = "idea_029044";
 ...
 */
@Slf4j
public class Idea29044Service {
    private static final int IDEA_ID = 29044;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29044Service() {
        this(new Idea29044Config());
    }

    public Idea29044Service(Idea29044Config config) {
        this.config = config != null ? config : new Idea29044Config();
