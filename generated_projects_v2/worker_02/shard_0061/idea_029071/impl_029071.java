...
@Data
public class Idea29071Config {
    private String name = "idea_029071";
 ...
 */
@Slf4j
public class Idea29071Service {
    private static final int IDEA_ID = 29071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29071Service() {
        this(new Idea29071Config());
    }

    public Idea29071Service(Idea29071Config config) {
        this.config = config != null ? config : new Idea29071Config();
