...
@Data
public class Idea29267Config {
    private String name = "idea_029267";
 ...
 */
@Slf4j
public class Idea29267Service {
    private static final int IDEA_ID = 29267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29267Service() {
        this(new Idea29267Config());
    }

    public Idea29267Service(Idea29267Config config) {
        this.config = config != null ? config : new Idea29267Config();
