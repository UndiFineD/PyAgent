...
@Data
public class Idea29351Config {
    private String name = "idea_029351";
 ...
 */
@Slf4j
public class Idea29351Service {
    private static final int IDEA_ID = 29351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29351Service() {
        this(new Idea29351Config());
    }

    public Idea29351Service(Idea29351Config config) {
        this.config = config != null ? config : new Idea29351Config();
