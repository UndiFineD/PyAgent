...
@Data
public class Idea29302Config {
    private String name = "idea_029302";
 ...
 */
@Slf4j
public class Idea29302Service {
    private static final int IDEA_ID = 29302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29302Service() {
        this(new Idea29302Config());
    }

    public Idea29302Service(Idea29302Config config) {
        this.config = config != null ? config : new Idea29302Config();
