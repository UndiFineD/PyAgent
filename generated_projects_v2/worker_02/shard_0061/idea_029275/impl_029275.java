...
@Data
public class Idea29275Config {
    private String name = "idea_029275";
 ...
 */
@Slf4j
public class Idea29275Service {
    private static final int IDEA_ID = 29275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29275Service() {
        this(new Idea29275Config());
    }

    public Idea29275Service(Idea29275Config config) {
        this.config = config != null ? config : new Idea29275Config();
