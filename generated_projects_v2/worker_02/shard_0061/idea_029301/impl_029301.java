...
@Data
public class Idea29301Config {
    private String name = "idea_029301";
 ...
 */
@Slf4j
public class Idea29301Service {
    private static final int IDEA_ID = 29301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29301Service() {
        this(new Idea29301Config());
    }

    public Idea29301Service(Idea29301Config config) {
        this.config = config != null ? config : new Idea29301Config();
