...
@Data
public class Idea29009Config {
    private String name = "idea_029009";
 ...
 */
@Slf4j
public class Idea29009Service {
    private static final int IDEA_ID = 29009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29009Service() {
        this(new Idea29009Config());
    }

    public Idea29009Service(Idea29009Config config) {
        this.config = config != null ? config : new Idea29009Config();
