...
@Data
public class Idea29083Config {
    private String name = "idea_029083";
 ...
 */
@Slf4j
public class Idea29083Service {
    private static final int IDEA_ID = 29083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29083Service() {
        this(new Idea29083Config());
    }

    public Idea29083Service(Idea29083Config config) {
        this.config = config != null ? config : new Idea29083Config();
