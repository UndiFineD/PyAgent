...
@Data
public class Idea29111Config {
    private String name = "idea_029111";
 ...
 */
@Slf4j
public class Idea29111Service {
    private static final int IDEA_ID = 29111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29111Service() {
        this(new Idea29111Config());
    }

    public Idea29111Service(Idea29111Config config) {
        this.config = config != null ? config : new Idea29111Config();
