...
@Data
public class Idea29007Config {
    private String name = "idea_029007";
 ...
 */
@Slf4j
public class Idea29007Service {
    private static final int IDEA_ID = 29007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29007Service() {
        this(new Idea29007Config());
    }

    public Idea29007Service(Idea29007Config config) {
        this.config = config != null ? config : new Idea29007Config();
