...
@Data
public class Idea29168Config {
    private String name = "idea_029168";
 ...
 */
@Slf4j
public class Idea29168Service {
    private static final int IDEA_ID = 29168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29168Service() {
        this(new Idea29168Config());
    }

    public Idea29168Service(Idea29168Config config) {
        this.config = config != null ? config : new Idea29168Config();
