...
@Data
public class Idea29370Config {
    private String name = "idea_029370";
 ...
 */
@Slf4j
public class Idea29370Service {
    private static final int IDEA_ID = 29370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29370Service() {
        this(new Idea29370Config());
    }

    public Idea29370Service(Idea29370Config config) {
        this.config = config != null ? config : new Idea29370Config();
