...
@Data
public class Idea29269Config {
    private String name = "idea_029269";
 ...
 */
@Slf4j
public class Idea29269Service {
    private static final int IDEA_ID = 29269;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29269Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29269Service() {
        this(new Idea29269Config());
    }

    public Idea29269Service(Idea29269Config config) {
        this.config = config != null ? config : new Idea29269Config();
