...
@Data
public class Idea29064Config {
    private String name = "idea_029064";
 ...
 */
@Slf4j
public class Idea29064Service {
    private static final int IDEA_ID = 29064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29064Service() {
        this(new Idea29064Config());
    }

    public Idea29064Service(Idea29064Config config) {
        this.config = config != null ? config : new Idea29064Config();
