...
@Data
public class Idea29167Config {
    private String name = "idea_029167";
 ...
 */
@Slf4j
public class Idea29167Service {
    private static final int IDEA_ID = 29167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29167Service() {
        this(new Idea29167Config());
    }

    public Idea29167Service(Idea29167Config config) {
        this.config = config != null ? config : new Idea29167Config();
