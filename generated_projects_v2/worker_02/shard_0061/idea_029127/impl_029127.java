...
@Data
public class Idea29127Config {
    private String name = "idea_029127";
 ...
 */
@Slf4j
public class Idea29127Service {
    private static final int IDEA_ID = 29127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29127Service() {
        this(new Idea29127Config());
    }

    public Idea29127Service(Idea29127Config config) {
        this.config = config != null ? config : new Idea29127Config();
