...
@Data
public class Idea29095Config {
    private String name = "idea_029095";
 ...
 */
@Slf4j
public class Idea29095Service {
    private static final int IDEA_ID = 29095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29095Service() {
        this(new Idea29095Config());
    }

    public Idea29095Service(Idea29095Config config) {
        this.config = config != null ? config : new Idea29095Config();
