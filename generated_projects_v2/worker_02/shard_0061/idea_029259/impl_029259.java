...
@Data
public class Idea29259Config {
    private String name = "idea_029259";
 ...
 */
@Slf4j
public class Idea29259Service {
    private static final int IDEA_ID = 29259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29259Service() {
        this(new Idea29259Config());
    }

    public Idea29259Service(Idea29259Config config) {
        this.config = config != null ? config : new Idea29259Config();
