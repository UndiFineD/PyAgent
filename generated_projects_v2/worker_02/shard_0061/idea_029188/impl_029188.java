...
@Data
public class Idea29188Config {
    private String name = "idea_029188";
 ...
 */
@Slf4j
public class Idea29188Service {
    private static final int IDEA_ID = 29188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29188Service() {
        this(new Idea29188Config());
    }

    public Idea29188Service(Idea29188Config config) {
        this.config = config != null ? config : new Idea29188Config();
