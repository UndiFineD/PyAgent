...
@Data
public class Idea29051Config {
    private String name = "idea_029051";
 ...
 */
@Slf4j
public class Idea29051Service {
    private static final int IDEA_ID = 29051;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29051Service() {
        this(new Idea29051Config());
    }

    public Idea29051Service(Idea29051Config config) {
        this.config = config != null ? config : new Idea29051Config();
