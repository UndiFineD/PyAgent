...
@Data
public class Idea29360Config {
    private String name = "idea_029360";
 ...
 */
@Slf4j
public class Idea29360Service {
    private static final int IDEA_ID = 29360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29360Service() {
        this(new Idea29360Config());
    }

    public Idea29360Service(Idea29360Config config) {
        this.config = config != null ? config : new Idea29360Config();
