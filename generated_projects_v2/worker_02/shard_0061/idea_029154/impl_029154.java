...
@Data
public class Idea29154Config {
    private String name = "idea_029154";
 ...
 */
@Slf4j
public class Idea29154Service {
    private static final int IDEA_ID = 29154;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29154Service() {
        this(new Idea29154Config());
    }

    public Idea29154Service(Idea29154Config config) {
        this.config = config != null ? config : new Idea29154Config();
