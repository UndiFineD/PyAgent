...
@Data
public class Idea29383Config {
    private String name = "idea_029383";
 ...
 */
@Slf4j
public class Idea29383Service {
    private static final int IDEA_ID = 29383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29383Service() {
        this(new Idea29383Config());
    }

    public Idea29383Service(Idea29383Config config) {
        this.config = config != null ? config : new Idea29383Config();
