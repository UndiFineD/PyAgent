...
@Data
public class Idea29158Config {
    private String name = "idea_029158";
 ...
 */
@Slf4j
public class Idea29158Service {
    private static final int IDEA_ID = 29158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29158Service() {
        this(new Idea29158Config());
    }

    public Idea29158Service(Idea29158Config config) {
        this.config = config != null ? config : new Idea29158Config();
