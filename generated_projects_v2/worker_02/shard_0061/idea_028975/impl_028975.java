...
@Data
public class Idea28975Config {
    private String name = "idea_028975";
 ...
 */
@Slf4j
public class Idea28975Service {
    private static final int IDEA_ID = 28975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28975Service() {
        this(new Idea28975Config());
    }

    public Idea28975Service(Idea28975Config config) {
        this.config = config != null ? config : new Idea28975Config();
