...
@Data
public class Idea29069Config {
    private String name = "idea_029069";
 ...
 */
@Slf4j
public class Idea29069Service {
    private static final int IDEA_ID = 29069;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29069Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29069Service() {
        this(new Idea29069Config());
    }

    public Idea29069Service(Idea29069Config config) {
        this.config = config != null ? config : new Idea29069Config();
