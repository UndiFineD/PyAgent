...
@Data
public class Idea29292Config {
    private String name = "idea_029292";
 ...
 */
@Slf4j
public class Idea29292Service {
    private static final int IDEA_ID = 29292;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29292Service() {
        this(new Idea29292Config());
    }

    public Idea29292Service(Idea29292Config config) {
        this.config = config != null ? config : new Idea29292Config();
