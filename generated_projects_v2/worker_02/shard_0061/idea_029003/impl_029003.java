...
@Data
public class Idea29003Config {
    private String name = "idea_029003";
 ...
 */
@Slf4j
public class Idea29003Service {
    private static final int IDEA_ID = 29003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29003Service() {
        this(new Idea29003Config());
    }

    public Idea29003Service(Idea29003Config config) {
        this.config = config != null ? config : new Idea29003Config();
