...
@Data
public class Idea29026Config {
    private String name = "idea_029026";
 ...
 */
@Slf4j
public class Idea29026Service {
    private static final int IDEA_ID = 29026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29026Service() {
        this(new Idea29026Config());
    }

    public Idea29026Service(Idea29026Config config) {
        this.config = config != null ? config : new Idea29026Config();
