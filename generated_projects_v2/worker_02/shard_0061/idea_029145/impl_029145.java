...
@Data
public class Idea29145Config {
    private String name = "idea_029145";
 ...
 */
@Slf4j
public class Idea29145Service {
    private static final int IDEA_ID = 29145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29145Service() {
        this(new Idea29145Config());
    }

    public Idea29145Service(Idea29145Config config) {
        this.config = config != null ? config : new Idea29145Config();
