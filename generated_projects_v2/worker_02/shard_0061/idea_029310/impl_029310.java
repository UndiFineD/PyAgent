...
@Data
public class Idea29310Config {
    private String name = "idea_029310";
 ...
 */
@Slf4j
public class Idea29310Service {
    private static final int IDEA_ID = 29310;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29310Service() {
        this(new Idea29310Config());
    }

    public Idea29310Service(Idea29310Config config) {
        this.config = config != null ? config : new Idea29310Config();
