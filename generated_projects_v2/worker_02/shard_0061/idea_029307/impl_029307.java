...
@Data
public class Idea29307Config {
    private String name = "idea_029307";
 ...
 */
@Slf4j
public class Idea29307Service {
    private static final int IDEA_ID = 29307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29307Service() {
        this(new Idea29307Config());
    }

    public Idea29307Service(Idea29307Config config) {
        this.config = config != null ? config : new Idea29307Config();
