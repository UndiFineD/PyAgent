...
@Data
public class Idea29099Config {
    private String name = "idea_029099";
 ...
 */
@Slf4j
public class Idea29099Service {
    private static final int IDEA_ID = 29099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29099Service() {
        this(new Idea29099Config());
    }

    public Idea29099Service(Idea29099Config config) {
        this.config = config != null ? config : new Idea29099Config();
