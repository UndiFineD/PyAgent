...
@Data
public class Idea29160Config {
    private String name = "idea_029160";
 ...
 */
@Slf4j
public class Idea29160Service {
    private static final int IDEA_ID = 29160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29160Service() {
        this(new Idea29160Config());
    }

    public Idea29160Service(Idea29160Config config) {
        this.config = config != null ? config : new Idea29160Config();
