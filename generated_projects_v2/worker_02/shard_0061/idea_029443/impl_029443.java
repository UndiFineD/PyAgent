...
@Data
public class Idea29443Config {
    private String name = "idea_029443";
 ...
 */
@Slf4j
public class Idea29443Service {
    private static final int IDEA_ID = 29443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29443Service() {
        this(new Idea29443Config());
    }

    public Idea29443Service(Idea29443Config config) {
        this.config = config != null ? config : new Idea29443Config();
