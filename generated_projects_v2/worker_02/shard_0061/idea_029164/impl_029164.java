...
@Data
public class Idea29164Config {
    private String name = "idea_029164";
 ...
 */
@Slf4j
public class Idea29164Service {
    private static final int IDEA_ID = 29164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29164Service() {
        this(new Idea29164Config());
    }

    public Idea29164Service(Idea29164Config config) {
        this.config = config != null ? config : new Idea29164Config();
