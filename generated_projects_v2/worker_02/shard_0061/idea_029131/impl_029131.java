...
@Data
public class Idea29131Config {
    private String name = "idea_029131";
 ...
 */
@Slf4j
public class Idea29131Service {
    private static final int IDEA_ID = 29131;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29131Service() {
        this(new Idea29131Config());
    }

    public Idea29131Service(Idea29131Config config) {
        this.config = config != null ? config : new Idea29131Config();
