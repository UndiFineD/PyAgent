...
@Data
public class Idea29328Config {
    private String name = "idea_029328";
 ...
 */
@Slf4j
public class Idea29328Service {
    private static final int IDEA_ID = 29328;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29328Service() {
        this(new Idea29328Config());
    }

    public Idea29328Service(Idea29328Config config) {
        this.config = config != null ? config : new Idea29328Config();
