...
@Data
public class Idea29298Config {
    private String name = "idea_029298";
 ...
 */
@Slf4j
public class Idea29298Service {
    private static final int IDEA_ID = 29298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29298Service() {
        this(new Idea29298Config());
    }

    public Idea29298Service(Idea29298Config config) {
        this.config = config != null ? config : new Idea29298Config();
