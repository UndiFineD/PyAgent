...
@Data
public class Idea29300Config {
    private String name = "idea_029300";
 ...
 */
@Slf4j
public class Idea29300Service {
    private static final int IDEA_ID = 29300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29300Service() {
        this(new Idea29300Config());
    }

    public Idea29300Service(Idea29300Config config) {
        this.config = config != null ? config : new Idea29300Config();
