...
@Data
public class Idea29097Config {
    private String name = "idea_029097";
 ...
 */
@Slf4j
public class Idea29097Service {
    private static final int IDEA_ID = 29097;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29097Service() {
        this(new Idea29097Config());
    }

    public Idea29097Service(Idea29097Config config) {
        this.config = config != null ? config : new Idea29097Config();
