...
@Data
public class Idea29285Config {
    private String name = "idea_029285";
 ...
 */
@Slf4j
public class Idea29285Service {
    private static final int IDEA_ID = 29285;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29285Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29285Service() {
        this(new Idea29285Config());
    }

    public Idea29285Service(Idea29285Config config) {
        this.config = config != null ? config : new Idea29285Config();
