...
@Data
public class Idea29331Config {
    private String name = "idea_029331";
 ...
 */
@Slf4j
public class Idea29331Service {
    private static final int IDEA_ID = 29331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29331Service() {
        this(new Idea29331Config());
    }

    public Idea29331Service(Idea29331Config config) {
        this.config = config != null ? config : new Idea29331Config();
