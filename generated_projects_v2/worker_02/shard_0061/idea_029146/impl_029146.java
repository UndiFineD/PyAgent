...
@Data
public class Idea29146Config {
    private String name = "idea_029146";
 ...
 */
@Slf4j
public class Idea29146Service {
    private static final int IDEA_ID = 29146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29146Service() {
        this(new Idea29146Config());
    }

    public Idea29146Service(Idea29146Config config) {
        this.config = config != null ? config : new Idea29146Config();
