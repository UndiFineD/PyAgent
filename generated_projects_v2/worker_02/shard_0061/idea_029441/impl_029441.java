...
@Data
public class Idea29441Config {
    private String name = "idea_029441";
 ...
 */
@Slf4j
public class Idea29441Service {
    private static final int IDEA_ID = 29441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29441Service() {
        this(new Idea29441Config());
    }

    public Idea29441Service(Idea29441Config config) {
        this.config = config != null ? config : new Idea29441Config();
