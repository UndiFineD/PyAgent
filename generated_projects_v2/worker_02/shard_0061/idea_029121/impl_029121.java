...
@Data
public class Idea29121Config {
    private String name = "idea_029121";
 ...
 */
@Slf4j
public class Idea29121Service {
    private static final int IDEA_ID = 29121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29121Service() {
        this(new Idea29121Config());
    }

    public Idea29121Service(Idea29121Config config) {
        this.config = config != null ? config : new Idea29121Config();
