...
@Data
public class Idea29238Config {
    private String name = "idea_029238";
 ...
 */
@Slf4j
public class Idea29238Service {
    private static final int IDEA_ID = 29238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29238Service() {
        this(new Idea29238Config());
    }

    public Idea29238Service(Idea29238Config config) {
        this.config = config != null ? config : new Idea29238Config();
