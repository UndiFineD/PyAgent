...
@Data
public class Idea29082Config {
    private String name = "idea_029082";
 ...
 */
@Slf4j
public class Idea29082Service {
    private static final int IDEA_ID = 29082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29082Service() {
        this(new Idea29082Config());
    }

    public Idea29082Service(Idea29082Config config) {
        this.config = config != null ? config : new Idea29082Config();
