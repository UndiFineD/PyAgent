...
@Data
public class Idea29114Config {
    private String name = "idea_029114";
 ...
 */
@Slf4j
public class Idea29114Service {
    private static final int IDEA_ID = 29114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29114Service() {
        this(new Idea29114Config());
    }

    public Idea29114Service(Idea29114Config config) {
        this.config = config != null ? config : new Idea29114Config();
