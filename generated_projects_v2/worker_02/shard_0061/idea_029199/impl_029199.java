...
@Data
public class Idea29199Config {
    private String name = "idea_029199";
 ...
 */
@Slf4j
public class Idea29199Service {
    private static final int IDEA_ID = 29199;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29199Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29199Service() {
        this(new Idea29199Config());
    }

    public Idea29199Service(Idea29199Config config) {
        this.config = config != null ? config : new Idea29199Config();
