...
@Data
public class Idea29425Config {
    private String name = "idea_029425";
 ...
 */
@Slf4j
public class Idea29425Service {
    private static final int IDEA_ID = 29425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29425Service() {
        this(new Idea29425Config());
    }

    public Idea29425Service(Idea29425Config config) {
        this.config = config != null ? config : new Idea29425Config();
