...
@Data
public class Idea28998Config {
    private String name = "idea_028998";
 ...
 */
@Slf4j
public class Idea28998Service {
    private static final int IDEA_ID = 28998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea28998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea28998Service() {
        this(new Idea28998Config());
    }

    public Idea28998Service(Idea28998Config config) {
        this.config = config != null ? config : new Idea28998Config();
