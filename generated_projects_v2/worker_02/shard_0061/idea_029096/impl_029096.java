...
@Data
public class Idea29096Config {
    private String name = "idea_029096";
 ...
 */
@Slf4j
public class Idea29096Service {
    private static final int IDEA_ID = 29096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29096Service() {
        this(new Idea29096Config());
    }

    public Idea29096Service(Idea29096Config config) {
        this.config = config != null ? config : new Idea29096Config();
