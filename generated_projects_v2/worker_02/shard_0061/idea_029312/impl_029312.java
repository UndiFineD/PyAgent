...
@Data
public class Idea29312Config {
    private String name = "idea_029312";
 ...
 */
@Slf4j
public class Idea29312Service {
    private static final int IDEA_ID = 29312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29312Service() {
        this(new Idea29312Config());
    }

    public Idea29312Service(Idea29312Config config) {
        this.config = config != null ? config : new Idea29312Config();
