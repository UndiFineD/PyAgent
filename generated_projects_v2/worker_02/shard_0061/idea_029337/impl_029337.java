...
@Data
public class Idea29337Config {
    private String name = "idea_029337";
 ...
 */
@Slf4j
public class Idea29337Service {
    private static final int IDEA_ID = 29337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29337Service() {
        this(new Idea29337Config());
    }

    public Idea29337Service(Idea29337Config config) {
        this.config = config != null ? config : new Idea29337Config();
