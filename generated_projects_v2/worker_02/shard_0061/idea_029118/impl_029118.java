...
@Data
public class Idea29118Config {
    private String name = "idea_029118";
 ...
 */
@Slf4j
public class Idea29118Service {
    private static final int IDEA_ID = 29118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29118Service() {
        this(new Idea29118Config());
    }

    public Idea29118Service(Idea29118Config config) {
        this.config = config != null ? config : new Idea29118Config();
