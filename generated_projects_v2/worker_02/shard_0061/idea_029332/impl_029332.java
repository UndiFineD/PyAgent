...
@Data
public class Idea29332Config {
    private String name = "idea_029332";
 ...
 */
@Slf4j
public class Idea29332Service {
    private static final int IDEA_ID = 29332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29332Service() {
        this(new Idea29332Config());
    }

    public Idea29332Service(Idea29332Config config) {
        this.config = config != null ? config : new Idea29332Config();
