...
@Data
public class Idea29137Config {
    private String name = "idea_029137";
 ...
 */
@Slf4j
public class Idea29137Service {
    private static final int IDEA_ID = 29137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29137Service() {
        this(new Idea29137Config());
    }

    public Idea29137Service(Idea29137Config config) {
        this.config = config != null ? config : new Idea29137Config();
