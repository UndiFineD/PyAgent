...
@Data
public class Idea29147Config {
    private String name = "idea_029147";
 ...
 */
@Slf4j
public class Idea29147Service {
    private static final int IDEA_ID = 29147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29147Service() {
        this(new Idea29147Config());
    }

    public Idea29147Service(Idea29147Config config) {
        this.config = config != null ? config : new Idea29147Config();
