...
@Data
public class Idea29402Config {
    private String name = "idea_029402";
 ...
 */
@Slf4j
public class Idea29402Service {
    private static final int IDEA_ID = 29402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29402Service() {
        this(new Idea29402Config());
    }

    public Idea29402Service(Idea29402Config config) {
        this.config = config != null ? config : new Idea29402Config();
