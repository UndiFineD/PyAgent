...
@Data
public class Idea29352Config {
    private String name = "idea_029352";
 ...
 */
@Slf4j
public class Idea29352Service {
    private static final int IDEA_ID = 29352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29352Service() {
        this(new Idea29352Config());
    }

    public Idea29352Service(Idea29352Config config) {
        this.config = config != null ? config : new Idea29352Config();
