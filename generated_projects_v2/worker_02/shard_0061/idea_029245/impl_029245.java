...
@Data
public class Idea29245Config {
    private String name = "idea_029245";
 ...
 */
@Slf4j
public class Idea29245Service {
    private static final int IDEA_ID = 29245;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea29245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea29245Service() {
        this(new Idea29245Config());
    }

    public Idea29245Service(Idea29245Config config) {
        this.config = config != null ? config : new Idea29245Config();
