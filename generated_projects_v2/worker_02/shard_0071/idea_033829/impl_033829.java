...
@Data
public class Idea33829Config {
    private String name = "idea_033829";
 ...
 */
@Slf4j
public class Idea33829Service {
    private static final int IDEA_ID = 33829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33829Service() {
        this(new Idea33829Config());
    }

    public Idea33829Service(Idea33829Config config) {
        this.config = config != null ? config : new Idea33829Config();
