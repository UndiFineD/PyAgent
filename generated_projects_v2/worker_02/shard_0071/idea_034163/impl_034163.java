...
@Data
public class Idea34163Config {
    private String name = "idea_034163";
 ...
 */
@Slf4j
public class Idea34163Service {
    private static final int IDEA_ID = 34163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34163Service() {
        this(new Idea34163Config());
    }

    public Idea34163Service(Idea34163Config config) {
        this.config = config != null ? config : new Idea34163Config();
