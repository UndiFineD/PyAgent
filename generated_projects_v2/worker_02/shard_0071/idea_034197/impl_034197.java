...
@Data
public class Idea34197Config {
    private String name = "idea_034197";
 ...
 */
@Slf4j
public class Idea34197Service {
    private static final int IDEA_ID = 34197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34197Service() {
        this(new Idea34197Config());
    }

    public Idea34197Service(Idea34197Config config) {
        this.config = config != null ? config : new Idea34197Config();
