...
@Data
public class Idea33799Config {
    private String name = "idea_033799";
 ...
 */
@Slf4j
public class Idea33799Service {
    private static final int IDEA_ID = 33799;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33799Service() {
        this(new Idea33799Config());
    }

    public Idea33799Service(Idea33799Config config) {
        this.config = config != null ? config : new Idea33799Config();
