...
@Data
public class Idea33849Config {
    private String name = "idea_033849";
 ...
 */
@Slf4j
public class Idea33849Service {
    private static final int IDEA_ID = 33849;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33849Service() {
        this(new Idea33849Config());
    }

    public Idea33849Service(Idea33849Config config) {
        this.config = config != null ? config : new Idea33849Config();
