...
@Data
public class Idea33764Config {
    private String name = "idea_033764";
 ...
 */
@Slf4j
public class Idea33764Service {
    private static final int IDEA_ID = 33764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33764Service() {
        this(new Idea33764Config());
    }

    public Idea33764Service(Idea33764Config config) {
        this.config = config != null ? config : new Idea33764Config();
