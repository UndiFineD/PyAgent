...
@Data
public class Idea34129Config {
    private String name = "idea_034129";
 ...
 */
@Slf4j
public class Idea34129Service {
    private static final int IDEA_ID = 34129;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34129Service() {
        this(new Idea34129Config());
    }

    public Idea34129Service(Idea34129Config config) {
        this.config = config != null ? config : new Idea34129Config();
