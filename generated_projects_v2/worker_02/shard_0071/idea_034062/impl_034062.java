...
@Data
public class Idea34062Config {
    private String name = "idea_034062";
 ...
 */
@Slf4j
public class Idea34062Service {
    private static final int IDEA_ID = 34062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34062Service() {
        this(new Idea34062Config());
    }

    public Idea34062Service(Idea34062Config config) {
        this.config = config != null ? config : new Idea34062Config();
