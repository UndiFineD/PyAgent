...
@Data
public class Idea33927Config {
    private String name = "idea_033927";
 ...
 */
@Slf4j
public class Idea33927Service {
    private static final int IDEA_ID = 33927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33927Service() {
        this(new Idea33927Config());
    }

    public Idea33927Service(Idea33927Config config) {
        this.config = config != null ? config : new Idea33927Config();
