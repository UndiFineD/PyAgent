...
@Data
public class Idea33827Config {
    private String name = "idea_033827";
 ...
 */
@Slf4j
public class Idea33827Service {
    private static final int IDEA_ID = 33827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33827Service() {
        this(new Idea33827Config());
    }

    public Idea33827Service(Idea33827Config config) {
        this.config = config != null ? config : new Idea33827Config();
