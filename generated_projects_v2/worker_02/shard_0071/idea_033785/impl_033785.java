...
@Data
public class Idea33785Config {
    private String name = "idea_033785";
 ...
 */
@Slf4j
public class Idea33785Service {
    private static final int IDEA_ID = 33785;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33785Service() {
        this(new Idea33785Config());
    }

    public Idea33785Service(Idea33785Config config) {
        this.config = config != null ? config : new Idea33785Config();
