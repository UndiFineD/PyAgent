...
@Data
public class Idea33898Config {
    private String name = "idea_033898";
 ...
 */
@Slf4j
public class Idea33898Service {
    private static final int IDEA_ID = 33898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33898Service() {
        this(new Idea33898Config());
    }

    public Idea33898Service(Idea33898Config config) {
        this.config = config != null ? config : new Idea33898Config();
