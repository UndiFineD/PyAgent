...
@Data
public class Idea34100Config {
    private String name = "idea_034100";
 ...
 */
@Slf4j
public class Idea34100Service {
    private static final int IDEA_ID = 34100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34100Service() {
        this(new Idea34100Config());
    }

    public Idea34100Service(Idea34100Config config) {
        this.config = config != null ? config : new Idea34100Config();
