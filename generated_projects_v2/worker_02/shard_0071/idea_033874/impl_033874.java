...
@Data
public class Idea33874Config {
    private String name = "idea_033874";
 ...
 */
@Slf4j
public class Idea33874Service {
    private static final int IDEA_ID = 33874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33874Service() {
        this(new Idea33874Config());
    }

    public Idea33874Service(Idea33874Config config) {
        this.config = config != null ? config : new Idea33874Config();
