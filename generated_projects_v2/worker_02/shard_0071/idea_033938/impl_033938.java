...
@Data
public class Idea33938Config {
    private String name = "idea_033938";
 ...
 */
@Slf4j
public class Idea33938Service {
    private static final int IDEA_ID = 33938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33938Service() {
        this(new Idea33938Config());
    }

    public Idea33938Service(Idea33938Config config) {
        this.config = config != null ? config : new Idea33938Config();
