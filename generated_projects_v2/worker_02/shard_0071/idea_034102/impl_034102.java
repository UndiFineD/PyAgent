...
@Data
public class Idea34102Config {
    private String name = "idea_034102";
 ...
 */
@Slf4j
public class Idea34102Service {
    private static final int IDEA_ID = 34102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34102Service() {
        this(new Idea34102Config());
    }

    public Idea34102Service(Idea34102Config config) {
        this.config = config != null ? config : new Idea34102Config();
