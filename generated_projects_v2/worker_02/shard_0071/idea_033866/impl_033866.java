...
@Data
public class Idea33866Config {
    private String name = "idea_033866";
 ...
 */
@Slf4j
public class Idea33866Service {
    private static final int IDEA_ID = 33866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33866Service() {
        this(new Idea33866Config());
    }

    public Idea33866Service(Idea33866Config config) {
        this.config = config != null ? config : new Idea33866Config();
