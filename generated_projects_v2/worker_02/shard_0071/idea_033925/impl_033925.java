...
@Data
public class Idea33925Config {
    private String name = "idea_033925";
 ...
 */
@Slf4j
public class Idea33925Service {
    private static final int IDEA_ID = 33925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33925Service() {
        this(new Idea33925Config());
    }

    public Idea33925Service(Idea33925Config config) {
        this.config = config != null ? config : new Idea33925Config();
