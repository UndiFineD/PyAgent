...
@Data
public class Idea33756Config {
    private String name = "idea_033756";
 ...
 */
@Slf4j
public class Idea33756Service {
    private static final int IDEA_ID = 33756;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33756Service() {
        this(new Idea33756Config());
    }

    public Idea33756Service(Idea33756Config config) {
        this.config = config != null ? config : new Idea33756Config();
