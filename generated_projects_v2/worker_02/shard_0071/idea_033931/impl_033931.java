...
@Data
public class Idea33931Config {
    private String name = "idea_033931";
 ...
 */
@Slf4j
public class Idea33931Service {
    private static final int IDEA_ID = 33931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33931Service() {
        this(new Idea33931Config());
    }

    public Idea33931Service(Idea33931Config config) {
        this.config = config != null ? config : new Idea33931Config();
