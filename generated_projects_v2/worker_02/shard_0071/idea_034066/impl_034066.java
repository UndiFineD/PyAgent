...
@Data
public class Idea34066Config {
    private String name = "idea_034066";
 ...
 */
@Slf4j
public class Idea34066Service {
    private static final int IDEA_ID = 34066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34066Service() {
        this(new Idea34066Config());
    }

    public Idea34066Service(Idea34066Config config) {
        this.config = config != null ? config : new Idea34066Config();
