...
@Data
public class Idea33824Config {
    private String name = "idea_033824";
 ...
 */
@Slf4j
public class Idea33824Service {
    private static final int IDEA_ID = 33824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33824Service() {
        this(new Idea33824Config());
    }

    public Idea33824Service(Idea33824Config config) {
        this.config = config != null ? config : new Idea33824Config();
