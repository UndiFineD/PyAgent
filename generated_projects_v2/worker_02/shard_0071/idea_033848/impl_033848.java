...
@Data
public class Idea33848Config {
    private String name = "idea_033848";
 ...
 */
@Slf4j
public class Idea33848Service {
    private static final int IDEA_ID = 33848;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33848Service() {
        this(new Idea33848Config());
    }

    public Idea33848Service(Idea33848Config config) {
        this.config = config != null ? config : new Idea33848Config();
