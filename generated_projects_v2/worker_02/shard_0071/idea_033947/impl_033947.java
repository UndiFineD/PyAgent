...
@Data
public class Idea33947Config {
    private String name = "idea_033947";
 ...
 */
@Slf4j
public class Idea33947Service {
    private static final int IDEA_ID = 33947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33947Service() {
        this(new Idea33947Config());
    }

    public Idea33947Service(Idea33947Config config) {
        this.config = config != null ? config : new Idea33947Config();
