...
@Data
public class Idea33973Config {
    private String name = "idea_033973";
 ...
 */
@Slf4j
public class Idea33973Service {
    private static final int IDEA_ID = 33973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33973Service() {
        this(new Idea33973Config());
    }

    public Idea33973Service(Idea33973Config config) {
        this.config = config != null ? config : new Idea33973Config();
