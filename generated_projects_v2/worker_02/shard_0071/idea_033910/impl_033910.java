...
@Data
public class Idea33910Config {
    private String name = "idea_033910";
 ...
 */
@Slf4j
public class Idea33910Service {
    private static final int IDEA_ID = 33910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33910Service() {
        this(new Idea33910Config());
    }

    public Idea33910Service(Idea33910Config config) {
        this.config = config != null ? config : new Idea33910Config();
