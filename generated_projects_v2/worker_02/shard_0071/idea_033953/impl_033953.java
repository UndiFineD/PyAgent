...
@Data
public class Idea33953Config {
    private String name = "idea_033953";
 ...
 */
@Slf4j
public class Idea33953Service {
    private static final int IDEA_ID = 33953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33953Service() {
        this(new Idea33953Config());
    }

    public Idea33953Service(Idea33953Config config) {
        this.config = config != null ? config : new Idea33953Config();
