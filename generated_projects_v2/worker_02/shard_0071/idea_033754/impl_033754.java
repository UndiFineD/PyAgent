...
@Data
public class Idea33754Config {
    private String name = "idea_033754";
 ...
 */
@Slf4j
public class Idea33754Service {
    private static final int IDEA_ID = 33754;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33754Service() {
        this(new Idea33754Config());
    }

    public Idea33754Service(Idea33754Config config) {
        this.config = config != null ? config : new Idea33754Config();
