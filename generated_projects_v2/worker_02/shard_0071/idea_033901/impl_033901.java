...
@Data
public class Idea33901Config {
    private String name = "idea_033901";
 ...
 */
@Slf4j
public class Idea33901Service {
    private static final int IDEA_ID = 33901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33901Service() {
        this(new Idea33901Config());
    }

    public Idea33901Service(Idea33901Config config) {
        this.config = config != null ? config : new Idea33901Config();
