...
@Data
public class Idea33867Config {
    private String name = "idea_033867";
 ...
 */
@Slf4j
public class Idea33867Service {
    private static final int IDEA_ID = 33867;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33867Service() {
        this(new Idea33867Config());
    }

    public Idea33867Service(Idea33867Config config) {
        this.config = config != null ? config : new Idea33867Config();
