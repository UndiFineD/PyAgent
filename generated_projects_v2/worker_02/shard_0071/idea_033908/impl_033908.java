...
@Data
public class Idea33908Config {
    private String name = "idea_033908";
 ...
 */
@Slf4j
public class Idea33908Service {
    private static final int IDEA_ID = 33908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33908Service() {
        this(new Idea33908Config());
    }

    public Idea33908Service(Idea33908Config config) {
        this.config = config != null ? config : new Idea33908Config();
