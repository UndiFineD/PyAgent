...
@Data
public class Idea34090Config {
    private String name = "idea_034090";
 ...
 */
@Slf4j
public class Idea34090Service {
    private static final int IDEA_ID = 34090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34090Service() {
        this(new Idea34090Config());
    }

    public Idea34090Service(Idea34090Config config) {
        this.config = config != null ? config : new Idea34090Config();
