...
@Data
public class Idea33941Config {
    private String name = "idea_033941";
 ...
 */
@Slf4j
public class Idea33941Service {
    private static final int IDEA_ID = 33941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33941Service() {
        this(new Idea33941Config());
    }

    public Idea33941Service(Idea33941Config config) {
        this.config = config != null ? config : new Idea33941Config();
