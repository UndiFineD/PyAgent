...
@Data
public class Idea33892Config {
    private String name = "idea_033892";
 ...
 */
@Slf4j
public class Idea33892Service {
    private static final int IDEA_ID = 33892;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33892Service() {
        this(new Idea33892Config());
    }

    public Idea33892Service(Idea33892Config config) {
        this.config = config != null ? config : new Idea33892Config();
