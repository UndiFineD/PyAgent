...
@Data
public class Idea33801Config {
    private String name = "idea_033801";
 ...
 */
@Slf4j
public class Idea33801Service {
    private static final int IDEA_ID = 33801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33801Service() {
        this(new Idea33801Config());
    }

    public Idea33801Service(Idea33801Config config) {
        this.config = config != null ? config : new Idea33801Config();
