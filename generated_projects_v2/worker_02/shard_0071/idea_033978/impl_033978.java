...
@Data
public class Idea33978Config {
    private String name = "idea_033978";
 ...
 */
@Slf4j
public class Idea33978Service {
    private static final int IDEA_ID = 33978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33978Service() {
        this(new Idea33978Config());
    }

    public Idea33978Service(Idea33978Config config) {
        this.config = config != null ? config : new Idea33978Config();
