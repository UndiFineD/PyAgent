...
@Data
public class Idea33868Config {
    private String name = "idea_033868";
 ...
 */
@Slf4j
public class Idea33868Service {
    private static final int IDEA_ID = 33868;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33868Service() {
        this(new Idea33868Config());
    }

    public Idea33868Service(Idea33868Config config) {
        this.config = config != null ? config : new Idea33868Config();
