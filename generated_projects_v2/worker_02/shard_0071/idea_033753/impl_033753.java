...
@Data
public class Idea33753Config {
    private String name = "idea_033753";
 ...
 */
@Slf4j
public class Idea33753Service {
    private static final int IDEA_ID = 33753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33753Service() {
        this(new Idea33753Config());
    }

    public Idea33753Service(Idea33753Config config) {
        this.config = config != null ? config : new Idea33753Config();
