...
@Data
public class Idea33798Config {
    private String name = "idea_033798";
 ...
 */
@Slf4j
public class Idea33798Service {
    private static final int IDEA_ID = 33798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33798Service() {
        this(new Idea33798Config());
    }

    public Idea33798Service(Idea33798Config config) {
        this.config = config != null ? config : new Idea33798Config();
