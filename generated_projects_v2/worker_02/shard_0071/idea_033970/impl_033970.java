...
@Data
public class Idea33970Config {
    private String name = "idea_033970";
 ...
 */
@Slf4j
public class Idea33970Service {
    private static final int IDEA_ID = 33970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33970Service() {
        this(new Idea33970Config());
    }

    public Idea33970Service(Idea33970Config config) {
        this.config = config != null ? config : new Idea33970Config();
