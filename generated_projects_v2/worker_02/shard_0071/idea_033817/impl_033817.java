...
@Data
public class Idea33817Config {
    private String name = "idea_033817";
 ...
 */
@Slf4j
public class Idea33817Service {
    private static final int IDEA_ID = 33817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33817Service() {
        this(new Idea33817Config());
    }

    public Idea33817Service(Idea33817Config config) {
        this.config = config != null ? config : new Idea33817Config();
