...
@Data
public class Idea33983Config {
    private String name = "idea_033983";
 ...
 */
@Slf4j
public class Idea33983Service {
    private static final int IDEA_ID = 33983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33983Service() {
        this(new Idea33983Config());
    }

    public Idea33983Service(Idea33983Config config) {
        this.config = config != null ? config : new Idea33983Config();
