...
@Data
public class Idea33748Config {
    private String name = "idea_033748";
 ...
 */
@Slf4j
public class Idea33748Service {
    private static final int IDEA_ID = 33748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33748Service() {
        this(new Idea33748Config());
    }

    public Idea33748Service(Idea33748Config config) {
        this.config = config != null ? config : new Idea33748Config();
