...
@Data
public class Idea33950Config {
    private String name = "idea_033950";
 ...
 */
@Slf4j
public class Idea33950Service {
    private static final int IDEA_ID = 33950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33950Service() {
        this(new Idea33950Config());
    }

    public Idea33950Service(Idea33950Config config) {
        this.config = config != null ? config : new Idea33950Config();
