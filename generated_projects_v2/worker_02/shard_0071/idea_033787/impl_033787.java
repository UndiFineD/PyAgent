...
@Data
public class Idea33787Config {
    private String name = "idea_033787";
 ...
 */
@Slf4j
public class Idea33787Service {
    private static final int IDEA_ID = 33787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33787Service() {
        this(new Idea33787Config());
    }

    public Idea33787Service(Idea33787Config config) {
        this.config = config != null ? config : new Idea33787Config();
