...
@Data
public class Idea33979Config {
    private String name = "idea_033979";
 ...
 */
@Slf4j
public class Idea33979Service {
    private static final int IDEA_ID = 33979;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33979Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33979Service() {
        this(new Idea33979Config());
    }

    public Idea33979Service(Idea33979Config config) {
        this.config = config != null ? config : new Idea33979Config();
