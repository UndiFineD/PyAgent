...
@Data
public class Idea34173Config {
    private String name = "idea_034173";
 ...
 */
@Slf4j
public class Idea34173Service {
    private static final int IDEA_ID = 34173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34173Service() {
        this(new Idea34173Config());
    }

    public Idea34173Service(Idea34173Config config) {
        this.config = config != null ? config : new Idea34173Config();
