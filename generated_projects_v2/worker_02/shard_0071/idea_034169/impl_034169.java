...
@Data
public class Idea34169Config {
    private String name = "idea_034169";
 ...
 */
@Slf4j
public class Idea34169Service {
    private static final int IDEA_ID = 34169;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34169Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34169Service() {
        this(new Idea34169Config());
    }

    public Idea34169Service(Idea34169Config config) {
        this.config = config != null ? config : new Idea34169Config();
