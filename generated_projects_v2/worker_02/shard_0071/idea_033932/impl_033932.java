...
@Data
public class Idea33932Config {
    private String name = "idea_033932";
 ...
 */
@Slf4j
public class Idea33932Service {
    private static final int IDEA_ID = 33932;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33932Service() {
        this(new Idea33932Config());
    }

    public Idea33932Service(Idea33932Config config) {
        this.config = config != null ? config : new Idea33932Config();
