...
@Data
public class Idea34097Config {
    private String name = "idea_034097";
 ...
 */
@Slf4j
public class Idea34097Service {
    private static final int IDEA_ID = 34097;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34097Service() {
        this(new Idea34097Config());
    }

    public Idea34097Service(Idea34097Config config) {
        this.config = config != null ? config : new Idea34097Config();
