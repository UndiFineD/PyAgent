...
@Data
public class Idea34020Config {
    private String name = "idea_034020";
 ...
 */
@Slf4j
public class Idea34020Service {
    private static final int IDEA_ID = 34020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34020Service() {
        this(new Idea34020Config());
    }

    public Idea34020Service(Idea34020Config config) {
        this.config = config != null ? config : new Idea34020Config();
