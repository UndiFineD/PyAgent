...
@Data
public class Idea33731Config {
    private String name = "idea_033731";
 ...
 */
@Slf4j
public class Idea33731Service {
    private static final int IDEA_ID = 33731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33731Service() {
        this(new Idea33731Config());
    }

    public Idea33731Service(Idea33731Config config) {
        this.config = config != null ? config : new Idea33731Config();
