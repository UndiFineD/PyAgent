...
@Data
public class Idea33955Config {
    private String name = "idea_033955";
 ...
 */
@Slf4j
public class Idea33955Service {
    private static final int IDEA_ID = 33955;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33955Service() {
        this(new Idea33955Config());
    }

    public Idea33955Service(Idea33955Config config) {
        this.config = config != null ? config : new Idea33955Config();
