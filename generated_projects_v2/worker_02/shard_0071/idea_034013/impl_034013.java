...
@Data
public class Idea34013Config {
    private String name = "idea_034013";
 ...
 */
@Slf4j
public class Idea34013Service {
    private static final int IDEA_ID = 34013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34013Service() {
        this(new Idea34013Config());
    }

    public Idea34013Service(Idea34013Config config) {
        this.config = config != null ? config : new Idea34013Config();
