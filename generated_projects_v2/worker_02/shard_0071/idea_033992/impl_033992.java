...
@Data
public class Idea33992Config {
    private String name = "idea_033992";
 ...
 */
@Slf4j
public class Idea33992Service {
    private static final int IDEA_ID = 33992;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33992Service() {
        this(new Idea33992Config());
    }

    public Idea33992Service(Idea33992Config config) {
        this.config = config != null ? config : new Idea33992Config();
