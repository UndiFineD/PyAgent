...
@Data
public class Idea33943Config {
    private String name = "idea_033943";
 ...
 */
@Slf4j
public class Idea33943Service {
    private static final int IDEA_ID = 33943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33943Service() {
        this(new Idea33943Config());
    }

    public Idea33943Service(Idea33943Config config) {
        this.config = config != null ? config : new Idea33943Config();
