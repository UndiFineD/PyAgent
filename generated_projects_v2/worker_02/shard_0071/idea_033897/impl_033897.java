...
@Data
public class Idea33897Config {
    private String name = "idea_033897";
 ...
 */
@Slf4j
public class Idea33897Service {
    private static final int IDEA_ID = 33897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33897Service() {
        this(new Idea33897Config());
    }

    public Idea33897Service(Idea33897Config config) {
        this.config = config != null ? config : new Idea33897Config();
