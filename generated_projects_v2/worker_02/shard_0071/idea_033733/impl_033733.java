...
@Data
public class Idea33733Config {
    private String name = "idea_033733";
 ...
 */
@Slf4j
public class Idea33733Service {
    private static final int IDEA_ID = 33733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33733Service() {
        this(new Idea33733Config());
    }

    public Idea33733Service(Idea33733Config config) {
        this.config = config != null ? config : new Idea33733Config();
