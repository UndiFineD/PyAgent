...
@Data
public class Idea34022Config {
    private String name = "idea_034022";
 ...
 */
@Slf4j
public class Idea34022Service {
    private static final int IDEA_ID = 34022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34022Service() {
        this(new Idea34022Config());
    }

    public Idea34022Service(Idea34022Config config) {
        this.config = config != null ? config : new Idea34022Config();
