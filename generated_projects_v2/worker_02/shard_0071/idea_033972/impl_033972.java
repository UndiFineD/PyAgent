...
@Data
public class Idea33972Config {
    private String name = "idea_033972";
 ...
 */
@Slf4j
public class Idea33972Service {
    private static final int IDEA_ID = 33972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33972Service() {
        this(new Idea33972Config());
    }

    public Idea33972Service(Idea33972Config config) {
        this.config = config != null ? config : new Idea33972Config();
