...
@Data
public class Idea33957Config {
    private String name = "idea_033957";
 ...
 */
@Slf4j
public class Idea33957Service {
    private static final int IDEA_ID = 33957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33957Service() {
        this(new Idea33957Config());
    }

    public Idea33957Service(Idea33957Config config) {
        this.config = config != null ? config : new Idea33957Config();
