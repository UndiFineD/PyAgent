...
@Data
public class Idea33775Config {
    private String name = "idea_033775";
 ...
 */
@Slf4j
public class Idea33775Service {
    private static final int IDEA_ID = 33775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33775Service() {
        this(new Idea33775Config());
    }

    public Idea33775Service(Idea33775Config config) {
        this.config = config != null ? config : new Idea33775Config();
