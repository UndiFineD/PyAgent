...
@Data
public class Idea33902Config {
    private String name = "idea_033902";
 ...
 */
@Slf4j
public class Idea33902Service {
    private static final int IDEA_ID = 33902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33902Service() {
        this(new Idea33902Config());
    }

    public Idea33902Service(Idea33902Config config) {
        this.config = config != null ? config : new Idea33902Config();
