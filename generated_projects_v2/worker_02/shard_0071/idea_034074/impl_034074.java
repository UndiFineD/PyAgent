...
@Data
public class Idea34074Config {
    private String name = "idea_034074";
 ...
 */
@Slf4j
public class Idea34074Service {
    private static final int IDEA_ID = 34074;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34074Service() {
        this(new Idea34074Config());
    }

    public Idea34074Service(Idea34074Config config) {
        this.config = config != null ? config : new Idea34074Config();
