...
@Data
public class Idea33962Config {
    private String name = "idea_033962";
 ...
 */
@Slf4j
public class Idea33962Service {
    private static final int IDEA_ID = 33962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33962Service() {
        this(new Idea33962Config());
    }

    public Idea33962Service(Idea33962Config config) {
        this.config = config != null ? config : new Idea33962Config();
