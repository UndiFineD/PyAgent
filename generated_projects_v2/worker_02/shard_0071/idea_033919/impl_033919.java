...
@Data
public class Idea33919Config {
    private String name = "idea_033919";
 ...
 */
@Slf4j
public class Idea33919Service {
    private static final int IDEA_ID = 33919;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33919Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33919Service() {
        this(new Idea33919Config());
    }

    public Idea33919Service(Idea33919Config config) {
        this.config = config != null ? config : new Idea33919Config();
