...
@Data
public class Idea34019Config {
    private String name = "idea_034019";
 ...
 */
@Slf4j
public class Idea34019Service {
    private static final int IDEA_ID = 34019;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34019Service() {
        this(new Idea34019Config());
    }

    public Idea34019Service(Idea34019Config config) {
        this.config = config != null ? config : new Idea34019Config();
