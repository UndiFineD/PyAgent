...
@Data
public class Idea34126Config {
    private String name = "idea_034126";
 ...
 */
@Slf4j
public class Idea34126Service {
    private static final int IDEA_ID = 34126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34126Service() {
        this(new Idea34126Config());
    }

    public Idea34126Service(Idea34126Config config) {
        this.config = config != null ? config : new Idea34126Config();
