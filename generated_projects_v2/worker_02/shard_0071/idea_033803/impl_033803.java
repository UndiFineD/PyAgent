...
@Data
public class Idea33803Config {
    private String name = "idea_033803";
 ...
 */
@Slf4j
public class Idea33803Service {
    private static final int IDEA_ID = 33803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33803Service() {
        this(new Idea33803Config());
    }

    public Idea33803Service(Idea33803Config config) {
        this.config = config != null ? config : new Idea33803Config();
