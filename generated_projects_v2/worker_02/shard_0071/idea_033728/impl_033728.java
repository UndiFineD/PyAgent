...
@Data
public class Idea33728Config {
    private String name = "idea_033728";
 ...
 */
@Slf4j
public class Idea33728Service {
    private static final int IDEA_ID = 33728;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33728Service() {
        this(new Idea33728Config());
    }

    public Idea33728Service(Idea33728Config config) {
        this.config = config != null ? config : new Idea33728Config();
