...
@Data
public class Idea34164Config {
    private String name = "idea_034164";
 ...
 */
@Slf4j
public class Idea34164Service {
    private static final int IDEA_ID = 34164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34164Service() {
        this(new Idea34164Config());
    }

    public Idea34164Service(Idea34164Config config) {
        this.config = config != null ? config : new Idea34164Config();
