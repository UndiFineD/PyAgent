...
@Data
public class Idea33852Config {
    private String name = "idea_033852";
 ...
 */
@Slf4j
public class Idea33852Service {
    private static final int IDEA_ID = 33852;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33852Service() {
        this(new Idea33852Config());
    }

    public Idea33852Service(Idea33852Config config) {
        this.config = config != null ? config : new Idea33852Config();
