...
@Data
public class Idea33944Config {
    private String name = "idea_033944";
 ...
 */
@Slf4j
public class Idea33944Service {
    private static final int IDEA_ID = 33944;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33944Service() {
        this(new Idea33944Config());
    }

    public Idea33944Service(Idea33944Config config) {
        this.config = config != null ? config : new Idea33944Config();
