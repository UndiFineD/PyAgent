...
@Data
public class Idea34012Config {
    private String name = "idea_034012";
 ...
 */
@Slf4j
public class Idea34012Service {
    private static final int IDEA_ID = 34012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34012Service() {
        this(new Idea34012Config());
    }

    public Idea34012Service(Idea34012Config config) {
        this.config = config != null ? config : new Idea34012Config();
