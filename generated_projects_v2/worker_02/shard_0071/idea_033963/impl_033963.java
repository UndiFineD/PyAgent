...
@Data
public class Idea33963Config {
    private String name = "idea_033963";
 ...
 */
@Slf4j
public class Idea33963Service {
    private static final int IDEA_ID = 33963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33963Service() {
        this(new Idea33963Config());
    }

    public Idea33963Service(Idea33963Config config) {
        this.config = config != null ? config : new Idea33963Config();
