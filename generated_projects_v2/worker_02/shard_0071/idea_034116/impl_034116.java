...
@Data
public class Idea34116Config {
    private String name = "idea_034116";
 ...
 */
@Slf4j
public class Idea34116Service {
    private static final int IDEA_ID = 34116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34116Service() {
        this(new Idea34116Config());
    }

    public Idea34116Service(Idea34116Config config) {
        this.config = config != null ? config : new Idea34116Config();
