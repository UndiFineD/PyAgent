...
@Data
public class Idea33758Config {
    private String name = "idea_033758";
 ...
 */
@Slf4j
public class Idea33758Service {
    private static final int IDEA_ID = 33758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33758Service() {
        this(new Idea33758Config());
    }

    public Idea33758Service(Idea33758Config config) {
        this.config = config != null ? config : new Idea33758Config();
