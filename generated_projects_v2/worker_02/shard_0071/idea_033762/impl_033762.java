...
@Data
public class Idea33762Config {
    private String name = "idea_033762";
 ...
 */
@Slf4j
public class Idea33762Service {
    private static final int IDEA_ID = 33762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33762Service() {
        this(new Idea33762Config());
    }

    public Idea33762Service(Idea33762Config config) {
        this.config = config != null ? config : new Idea33762Config();
