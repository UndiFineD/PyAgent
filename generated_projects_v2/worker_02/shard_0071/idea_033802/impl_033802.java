...
@Data
public class Idea33802Config {
    private String name = "idea_033802";
 ...
 */
@Slf4j
public class Idea33802Service {
    private static final int IDEA_ID = 33802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33802Service() {
        this(new Idea33802Config());
    }

    public Idea33802Service(Idea33802Config config) {
        this.config = config != null ? config : new Idea33802Config();
