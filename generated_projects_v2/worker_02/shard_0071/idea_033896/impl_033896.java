...
@Data
public class Idea33896Config {
    private String name = "idea_033896";
 ...
 */
@Slf4j
public class Idea33896Service {
    private static final int IDEA_ID = 33896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33896Service() {
        this(new Idea33896Config());
    }

    public Idea33896Service(Idea33896Config config) {
        this.config = config != null ? config : new Idea33896Config();
