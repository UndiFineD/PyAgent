...
@Data
public class Idea34181Config {
    private String name = "idea_034181";
 ...
 */
@Slf4j
public class Idea34181Service {
    private static final int IDEA_ID = 34181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34181Service() {
        this(new Idea34181Config());
    }

    public Idea34181Service(Idea34181Config config) {
        this.config = config != null ? config : new Idea34181Config();
