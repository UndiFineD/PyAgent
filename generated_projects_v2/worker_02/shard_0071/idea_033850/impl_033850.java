...
@Data
public class Idea33850Config {
    private String name = "idea_033850";
 ...
 */
@Slf4j
public class Idea33850Service {
    private static final int IDEA_ID = 33850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33850Service() {
        this(new Idea33850Config());
    }

    public Idea33850Service(Idea33850Config config) {
        this.config = config != null ? config : new Idea33850Config();
