...
@Data
public class Idea33792Config {
    private String name = "idea_033792";
 ...
 */
@Slf4j
public class Idea33792Service {
    private static final int IDEA_ID = 33792;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33792Service() {
        this(new Idea33792Config());
    }

    public Idea33792Service(Idea33792Config config) {
        this.config = config != null ? config : new Idea33792Config();
