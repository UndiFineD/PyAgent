...
@Data
public class Idea34039Config {
    private String name = "idea_034039";
 ...
 */
@Slf4j
public class Idea34039Service {
    private static final int IDEA_ID = 34039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34039Service() {
        this(new Idea34039Config());
    }

    public Idea34039Service(Idea34039Config config) {
        this.config = config != null ? config : new Idea34039Config();
