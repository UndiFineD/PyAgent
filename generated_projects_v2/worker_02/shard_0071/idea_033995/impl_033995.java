...
@Data
public class Idea33995Config {
    private String name = "idea_033995";
 ...
 */
@Slf4j
public class Idea33995Service {
    private static final int IDEA_ID = 33995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33995Service() {
        this(new Idea33995Config());
    }

    public Idea33995Service(Idea33995Config config) {
        this.config = config != null ? config : new Idea33995Config();
