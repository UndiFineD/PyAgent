...
@Data
public class Idea33784Config {
    private String name = "idea_033784";
 ...
 */
@Slf4j
public class Idea33784Service {
    private static final int IDEA_ID = 33784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33784Service() {
        this(new Idea33784Config());
    }

    public Idea33784Service(Idea33784Config config) {
        this.config = config != null ? config : new Idea33784Config();
