...
@Data
public class Idea33993Config {
    private String name = "idea_033993";
 ...
 */
@Slf4j
public class Idea33993Service {
    private static final int IDEA_ID = 33993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33993Service() {
        this(new Idea33993Config());
    }

    public Idea33993Service(Idea33993Config config) {
        this.config = config != null ? config : new Idea33993Config();
