...
@Data
public class Idea33987Config {
    private String name = "idea_033987";
 ...
 */
@Slf4j
public class Idea33987Service {
    private static final int IDEA_ID = 33987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33987Service() {
        this(new Idea33987Config());
    }

    public Idea33987Service(Idea33987Config config) {
        this.config = config != null ? config : new Idea33987Config();
