...
@Data
public class Idea34108Config {
    private String name = "idea_034108";
 ...
 */
@Slf4j
public class Idea34108Service {
    private static final int IDEA_ID = 34108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34108Service() {
        this(new Idea34108Config());
    }

    public Idea34108Service(Idea34108Config config) {
        this.config = config != null ? config : new Idea34108Config();
