...
@Data
public class Idea33928Config {
    private String name = "idea_033928";
 ...
 */
@Slf4j
public class Idea33928Service {
    private static final int IDEA_ID = 33928;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33928Service() {
        this(new Idea33928Config());
    }

    public Idea33928Service(Idea33928Config config) {
        this.config = config != null ? config : new Idea33928Config();
