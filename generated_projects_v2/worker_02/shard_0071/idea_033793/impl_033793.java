...
@Data
public class Idea33793Config {
    private String name = "idea_033793";
 ...
 */
@Slf4j
public class Idea33793Service {
    private static final int IDEA_ID = 33793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33793Service() {
        this(new Idea33793Config());
    }

    public Idea33793Service(Idea33793Config config) {
        this.config = config != null ? config : new Idea33793Config();
