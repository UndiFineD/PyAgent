...
@Data
public class Idea33888Config {
    private String name = "idea_033888";
 ...
 */
@Slf4j
public class Idea33888Service {
    private static final int IDEA_ID = 33888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33888Service() {
        this(new Idea33888Config());
    }

    public Idea33888Service(Idea33888Config config) {
        this.config = config != null ? config : new Idea33888Config();
