...
@Data
public class Idea33913Config {
    private String name = "idea_033913";
 ...
 */
@Slf4j
public class Idea33913Service {
    private static final int IDEA_ID = 33913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33913Service() {
        this(new Idea33913Config());
    }

    public Idea33913Service(Idea33913Config config) {
        this.config = config != null ? config : new Idea33913Config();
