...
@Data
public class Idea33767Config {
    private String name = "idea_033767";
 ...
 */
@Slf4j
public class Idea33767Service {
    private static final int IDEA_ID = 33767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33767Service() {
        this(new Idea33767Config());
    }

    public Idea33767Service(Idea33767Config config) {
        this.config = config != null ? config : new Idea33767Config();
