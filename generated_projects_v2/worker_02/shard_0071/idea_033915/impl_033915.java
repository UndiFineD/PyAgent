...
@Data
public class Idea33915Config {
    private String name = "idea_033915";
 ...
 */
@Slf4j
public class Idea33915Service {
    private static final int IDEA_ID = 33915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33915Service() {
        this(new Idea33915Config());
    }

    public Idea33915Service(Idea33915Config config) {
        this.config = config != null ? config : new Idea33915Config();
