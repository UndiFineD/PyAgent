...
@Data
public class Idea33791Config {
    private String name = "idea_033791";
 ...
 */
@Slf4j
public class Idea33791Service {
    private static final int IDEA_ID = 33791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33791Service() {
        this(new Idea33791Config());
    }

    public Idea33791Service(Idea33791Config config) {
        this.config = config != null ? config : new Idea33791Config();
