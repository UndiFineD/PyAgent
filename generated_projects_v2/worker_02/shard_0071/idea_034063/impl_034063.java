...
@Data
public class Idea34063Config {
    private String name = "idea_034063";
 ...
 */
@Slf4j
public class Idea34063Service {
    private static final int IDEA_ID = 34063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34063Service() {
        this(new Idea34063Config());
    }

    public Idea34063Service(Idea34063Config config) {
        this.config = config != null ? config : new Idea34063Config();
