...
@Data
public class Idea34070Config {
    private String name = "idea_034070";
 ...
 */
@Slf4j
public class Idea34070Service {
    private static final int IDEA_ID = 34070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34070Service() {
        this(new Idea34070Config());
    }

    public Idea34070Service(Idea34070Config config) {
        this.config = config != null ? config : new Idea34070Config();
