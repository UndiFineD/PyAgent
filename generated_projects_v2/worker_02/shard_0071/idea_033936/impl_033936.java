...
@Data
public class Idea33936Config {
    private String name = "idea_033936";
 ...
 */
@Slf4j
public class Idea33936Service {
    private static final int IDEA_ID = 33936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33936Service() {
        this(new Idea33936Config());
    }

    public Idea33936Service(Idea33936Config config) {
        this.config = config != null ? config : new Idea33936Config();
