...
@Data
public class Idea34112Config {
    private String name = "idea_034112";
 ...
 */
@Slf4j
public class Idea34112Service {
    private static final int IDEA_ID = 34112;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34112Service() {
        this(new Idea34112Config());
    }

    public Idea34112Service(Idea34112Config config) {
        this.config = config != null ? config : new Idea34112Config();
