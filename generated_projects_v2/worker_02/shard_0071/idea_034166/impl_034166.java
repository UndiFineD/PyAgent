...
@Data
public class Idea34166Config {
    private String name = "idea_034166";
 ...
 */
@Slf4j
public class Idea34166Service {
    private static final int IDEA_ID = 34166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34166Service() {
        this(new Idea34166Config());
    }

    public Idea34166Service(Idea34166Config config) {
        this.config = config != null ? config : new Idea34166Config();
