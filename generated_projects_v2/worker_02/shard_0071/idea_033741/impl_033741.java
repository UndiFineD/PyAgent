...
@Data
public class Idea33741Config {
    private String name = "idea_033741";
 ...
 */
@Slf4j
public class Idea33741Service {
    private static final int IDEA_ID = 33741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33741Service() {
        this(new Idea33741Config());
    }

    public Idea33741Service(Idea33741Config config) {
        this.config = config != null ? config : new Idea33741Config();
