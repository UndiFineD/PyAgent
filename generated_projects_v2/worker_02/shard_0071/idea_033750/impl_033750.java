...
@Data
public class Idea33750Config {
    private String name = "idea_033750";
 ...
 */
@Slf4j
public class Idea33750Service {
    private static final int IDEA_ID = 33750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33750Service() {
        this(new Idea33750Config());
    }

    public Idea33750Service(Idea33750Config config) {
        this.config = config != null ? config : new Idea33750Config();
