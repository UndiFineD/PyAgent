...
@Data
public class Idea33985Config {
    private String name = "idea_033985";
 ...
 */
@Slf4j
public class Idea33985Service {
    private static final int IDEA_ID = 33985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33985Service() {
        this(new Idea33985Config());
    }

    public Idea33985Service(Idea33985Config config) {
        this.config = config != null ? config : new Idea33985Config();
