...
@Data
public class Idea34115Config {
    private String name = "idea_034115";
 ...
 */
@Slf4j
public class Idea34115Service {
    private static final int IDEA_ID = 34115;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34115Service() {
        this(new Idea34115Config());
    }

    public Idea34115Service(Idea34115Config config) {
        this.config = config != null ? config : new Idea34115Config();
