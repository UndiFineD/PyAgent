...
@Data
public class Idea33796Config {
    private String name = "idea_033796";
 ...
 */
@Slf4j
public class Idea33796Service {
    private static final int IDEA_ID = 33796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33796Service() {
        this(new Idea33796Config());
    }

    public Idea33796Service(Idea33796Config config) {
        this.config = config != null ? config : new Idea33796Config();
