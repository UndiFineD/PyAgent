...
@Data
public class Idea34170Config {
    private String name = "idea_034170";
 ...
 */
@Slf4j
public class Idea34170Service {
    private static final int IDEA_ID = 34170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34170Service() {
        this(new Idea34170Config());
    }

    public Idea34170Service(Idea34170Config config) {
        this.config = config != null ? config : new Idea34170Config();
