...
@Data
public class Idea33939Config {
    private String name = "idea_033939";
 ...
 */
@Slf4j
public class Idea33939Service {
    private static final int IDEA_ID = 33939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33939Service() {
        this(new Idea33939Config());
    }

    public Idea33939Service(Idea33939Config config) {
        this.config = config != null ? config : new Idea33939Config();
