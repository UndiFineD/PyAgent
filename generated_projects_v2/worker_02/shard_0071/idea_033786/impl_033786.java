...
@Data
public class Idea33786Config {
    private String name = "idea_033786";
 ...
 */
@Slf4j
public class Idea33786Service {
    private static final int IDEA_ID = 33786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33786Service() {
        this(new Idea33786Config());
    }

    public Idea33786Service(Idea33786Config config) {
        this.config = config != null ? config : new Idea33786Config();
