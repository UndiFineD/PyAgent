...
@Data
public class Idea34136Config {
    private String name = "idea_034136";
 ...
 */
@Slf4j
public class Idea34136Service {
    private static final int IDEA_ID = 34136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34136Service() {
        this(new Idea34136Config());
    }

    public Idea34136Service(Idea34136Config config) {
        this.config = config != null ? config : new Idea34136Config();
