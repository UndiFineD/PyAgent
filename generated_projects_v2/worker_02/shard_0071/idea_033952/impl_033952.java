...
@Data
public class Idea33952Config {
    private String name = "idea_033952";
 ...
 */
@Slf4j
public class Idea33952Service {
    private static final int IDEA_ID = 33952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33952Service() {
        this(new Idea33952Config());
    }

    public Idea33952Service(Idea33952Config config) {
        this.config = config != null ? config : new Idea33952Config();
