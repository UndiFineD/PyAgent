...
@Data
public class Idea33788Config {
    private String name = "idea_033788";
 ...
 */
@Slf4j
public class Idea33788Service {
    private static final int IDEA_ID = 33788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33788Service() {
        this(new Idea33788Config());
    }

    public Idea33788Service(Idea33788Config config) {
        this.config = config != null ? config : new Idea33788Config();
