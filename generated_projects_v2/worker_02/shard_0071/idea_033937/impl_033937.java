...
@Data
public class Idea33937Config {
    private String name = "idea_033937";
 ...
 */
@Slf4j
public class Idea33937Service {
    private static final int IDEA_ID = 33937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33937Service() {
        this(new Idea33937Config());
    }

    public Idea33937Service(Idea33937Config config) {
        this.config = config != null ? config : new Idea33937Config();
