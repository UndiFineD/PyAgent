...
@Data
public class Idea33900Config {
    private String name = "idea_033900";
 ...
 */
@Slf4j
public class Idea33900Service {
    private static final int IDEA_ID = 33900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33900Service() {
        this(new Idea33900Config());
    }

    public Idea33900Service(Idea33900Config config) {
        this.config = config != null ? config : new Idea33900Config();
