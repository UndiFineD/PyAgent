...
@Data
public class Idea33833Config {
    private String name = "idea_033833";
 ...
 */
@Slf4j
public class Idea33833Service {
    private static final int IDEA_ID = 33833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33833Service() {
        this(new Idea33833Config());
    }

    public Idea33833Service(Idea33833Config config) {
        this.config = config != null ? config : new Idea33833Config();
