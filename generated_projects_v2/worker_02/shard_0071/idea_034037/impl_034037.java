...
@Data
public class Idea34037Config {
    private String name = "idea_034037";
 ...
 */
@Slf4j
public class Idea34037Service {
    private static final int IDEA_ID = 34037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34037Service() {
        this(new Idea34037Config());
    }

    public Idea34037Service(Idea34037Config config) {
        this.config = config != null ? config : new Idea34037Config();
