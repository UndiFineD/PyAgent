...
@Data
public class Idea34009Config {
    private String name = "idea_034009";
 ...
 */
@Slf4j
public class Idea34009Service {
    private static final int IDEA_ID = 34009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34009Service() {
        this(new Idea34009Config());
    }

    public Idea34009Service(Idea34009Config config) {
        this.config = config != null ? config : new Idea34009Config();
