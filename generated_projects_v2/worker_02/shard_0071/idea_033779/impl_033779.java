...
@Data
public class Idea33779Config {
    private String name = "idea_033779";
 ...
 */
@Slf4j
public class Idea33779Service {
    private static final int IDEA_ID = 33779;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33779Service() {
        this(new Idea33779Config());
    }

    public Idea33779Service(Idea33779Config config) {
        this.config = config != null ? config : new Idea33779Config();
