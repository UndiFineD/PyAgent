...
@Data
public class Idea34186Config {
    private String name = "idea_034186";
 ...
 */
@Slf4j
public class Idea34186Service {
    private static final int IDEA_ID = 34186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34186Service() {
        this(new Idea34186Config());
    }

    public Idea34186Service(Idea34186Config config) {
        this.config = config != null ? config : new Idea34186Config();
