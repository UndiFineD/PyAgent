...
@Data
public class Idea33740Config {
    private String name = "idea_033740";
 ...
 */
@Slf4j
public class Idea33740Service {
    private static final int IDEA_ID = 33740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33740Service() {
        this(new Idea33740Config());
    }

    public Idea33740Service(Idea33740Config config) {
        this.config = config != null ? config : new Idea33740Config();
