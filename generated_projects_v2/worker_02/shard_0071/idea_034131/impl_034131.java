...
@Data
public class Idea34131Config {
    private String name = "idea_034131";
 ...
 */
@Slf4j
public class Idea34131Service {
    private static final int IDEA_ID = 34131;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34131Service() {
        this(new Idea34131Config());
    }

    public Idea34131Service(Idea34131Config config) {
        this.config = config != null ? config : new Idea34131Config();
