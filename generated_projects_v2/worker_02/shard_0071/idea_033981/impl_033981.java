...
@Data
public class Idea33981Config {
    private String name = "idea_033981";
 ...
 */
@Slf4j
public class Idea33981Service {
    private static final int IDEA_ID = 33981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33981Service() {
        this(new Idea33981Config());
    }

    public Idea33981Service(Idea33981Config config) {
        this.config = config != null ? config : new Idea33981Config();
