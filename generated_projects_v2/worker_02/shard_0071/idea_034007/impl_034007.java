...
@Data
public class Idea34007Config {
    private String name = "idea_034007";
 ...
 */
@Slf4j
public class Idea34007Service {
    private static final int IDEA_ID = 34007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34007Service() {
        this(new Idea34007Config());
    }

    public Idea34007Service(Idea34007Config config) {
        this.config = config != null ? config : new Idea34007Config();
