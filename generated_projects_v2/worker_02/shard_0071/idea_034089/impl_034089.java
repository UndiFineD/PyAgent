...
@Data
public class Idea34089Config {
    private String name = "idea_034089";
 ...
 */
@Slf4j
public class Idea34089Service {
    private static final int IDEA_ID = 34089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34089Service() {
        this(new Idea34089Config());
    }

    public Idea34089Service(Idea34089Config config) {
        this.config = config != null ? config : new Idea34089Config();
