...
@Data
public class Idea34103Config {
    private String name = "idea_034103";
 ...
 */
@Slf4j
public class Idea34103Service {
    private static final int IDEA_ID = 34103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34103Service() {
        this(new Idea34103Config());
    }

    public Idea34103Service(Idea34103Config config) {
        this.config = config != null ? config : new Idea34103Config();
