...
@Data
public class Idea33742Config {
    private String name = "idea_033742";
 ...
 */
@Slf4j
public class Idea33742Service {
    private static final int IDEA_ID = 33742;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33742Service() {
        this(new Idea33742Config());
    }

    public Idea33742Service(Idea33742Config config) {
        this.config = config != null ? config : new Idea33742Config();
