...
@Data
public class Idea33831Config {
    private String name = "idea_033831";
 ...
 */
@Slf4j
public class Idea33831Service {
    private static final int IDEA_ID = 33831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33831Service() {
        this(new Idea33831Config());
    }

    public Idea33831Service(Idea33831Config config) {
        this.config = config != null ? config : new Idea33831Config();
