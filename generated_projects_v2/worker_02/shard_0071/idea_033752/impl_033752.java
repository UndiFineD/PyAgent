...
@Data
public class Idea33752Config {
    private String name = "idea_033752";
 ...
 */
@Slf4j
public class Idea33752Service {
    private static final int IDEA_ID = 33752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33752Service() {
        this(new Idea33752Config());
    }

    public Idea33752Service(Idea33752Config config) {
        this.config = config != null ? config : new Idea33752Config();
