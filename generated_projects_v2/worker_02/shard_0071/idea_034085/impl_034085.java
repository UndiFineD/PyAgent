...
@Data
public class Idea34085Config {
    private String name = "idea_034085";
 ...
 */
@Slf4j
public class Idea34085Service {
    private static final int IDEA_ID = 34085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34085Service() {
        this(new Idea34085Config());
    }

    public Idea34085Service(Idea34085Config config) {
        this.config = config != null ? config : new Idea34085Config();
