...
@Data
public class Idea33926Config {
    private String name = "idea_033926";
 ...
 */
@Slf4j
public class Idea33926Service {
    private static final int IDEA_ID = 33926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33926Service() {
        this(new Idea33926Config());
    }

    public Idea33926Service(Idea33926Config config) {
        this.config = config != null ? config : new Idea33926Config();
