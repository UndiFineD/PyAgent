...
@Data
public class Idea33894Config {
    private String name = "idea_033894";
 ...
 */
@Slf4j
public class Idea33894Service {
    private static final int IDEA_ID = 33894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33894Service() {
        this(new Idea33894Config());
    }

    public Idea33894Service(Idea33894Config config) {
        this.config = config != null ? config : new Idea33894Config();
