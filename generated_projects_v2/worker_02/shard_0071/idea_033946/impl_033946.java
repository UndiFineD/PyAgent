...
@Data
public class Idea33946Config {
    private String name = "idea_033946";
 ...
 */
@Slf4j
public class Idea33946Service {
    private static final int IDEA_ID = 33946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33946Service() {
        this(new Idea33946Config());
    }

    public Idea33946Service(Idea33946Config config) {
        this.config = config != null ? config : new Idea33946Config();
