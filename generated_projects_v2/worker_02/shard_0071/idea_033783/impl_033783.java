...
@Data
public class Idea33783Config {
    private String name = "idea_033783";
 ...
 */
@Slf4j
public class Idea33783Service {
    private static final int IDEA_ID = 33783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33783Service() {
        this(new Idea33783Config());
    }

    public Idea33783Service(Idea33783Config config) {
        this.config = config != null ? config : new Idea33783Config();
