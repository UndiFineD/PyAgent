...
@Data
public class Idea34194Config {
    private String name = "idea_034194";
 ...
 */
@Slf4j
public class Idea34194Service {
    private static final int IDEA_ID = 34194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34194Service() {
        this(new Idea34194Config());
    }

    public Idea34194Service(Idea34194Config config) {
        this.config = config != null ? config : new Idea34194Config();
