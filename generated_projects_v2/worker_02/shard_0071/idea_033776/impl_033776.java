...
@Data
public class Idea33776Config {
    private String name = "idea_033776";
 ...
 */
@Slf4j
public class Idea33776Service {
    private static final int IDEA_ID = 33776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33776Service() {
        this(new Idea33776Config());
    }

    public Idea33776Service(Idea33776Config config) {
        this.config = config != null ? config : new Idea33776Config();
