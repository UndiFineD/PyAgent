...
@Data
public class Idea34106Config {
    private String name = "idea_034106";
 ...
 */
@Slf4j
public class Idea34106Service {
    private static final int IDEA_ID = 34106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34106Service() {
        this(new Idea34106Config());
    }

    public Idea34106Service(Idea34106Config config) {
        this.config = config != null ? config : new Idea34106Config();
