...
@Data
public class Idea34161Config {
    private String name = "idea_034161";
 ...
 */
@Slf4j
public class Idea34161Service {
    private static final int IDEA_ID = 34161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34161Service() {
        this(new Idea34161Config());
    }

    public Idea34161Service(Idea34161Config config) {
        this.config = config != null ? config : new Idea34161Config();
