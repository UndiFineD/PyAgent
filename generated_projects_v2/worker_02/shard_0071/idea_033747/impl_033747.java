...
@Data
public class Idea33747Config {
    private String name = "idea_033747";
 ...
 */
@Slf4j
public class Idea33747Service {
    private static final int IDEA_ID = 33747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33747Service() {
        this(new Idea33747Config());
    }

    public Idea33747Service(Idea33747Config config) {
        this.config = config != null ? config : new Idea33747Config();
