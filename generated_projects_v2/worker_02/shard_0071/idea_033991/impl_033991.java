...
@Data
public class Idea33991Config {
    private String name = "idea_033991";
 ...
 */
@Slf4j
public class Idea33991Service {
    private static final int IDEA_ID = 33991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33991Service() {
        this(new Idea33991Config());
    }

    public Idea33991Service(Idea33991Config config) {
        this.config = config != null ? config : new Idea33991Config();
