...
@Data
public class Idea33877Config {
    private String name = "idea_033877";
 ...
 */
@Slf4j
public class Idea33877Service {
    private static final int IDEA_ID = 33877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33877Service() {
        this(new Idea33877Config());
    }

    public Idea33877Service(Idea33877Config config) {
        this.config = config != null ? config : new Idea33877Config();
