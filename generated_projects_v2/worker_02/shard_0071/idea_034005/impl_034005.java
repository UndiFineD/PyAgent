...
@Data
public class Idea34005Config {
    private String name = "idea_034005";
 ...
 */
@Slf4j
public class Idea34005Service {
    private static final int IDEA_ID = 34005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34005Service() {
        this(new Idea34005Config());
    }

    public Idea34005Service(Idea34005Config config) {
        this.config = config != null ? config : new Idea34005Config();
