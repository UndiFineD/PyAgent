...
@Data
public class Idea33761Config {
    private String name = "idea_033761";
 ...
 */
@Slf4j
public class Idea33761Service {
    private static final int IDEA_ID = 33761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33761Service() {
        this(new Idea33761Config());
    }

    public Idea33761Service(Idea33761Config config) {
        this.config = config != null ? config : new Idea33761Config();
