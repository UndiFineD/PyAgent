...
@Data
public class Idea34088Config {
    private String name = "idea_034088";
 ...
 */
@Slf4j
public class Idea34088Service {
    private static final int IDEA_ID = 34088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34088Service() {
        this(new Idea34088Config());
    }

    public Idea34088Service(Idea34088Config config) {
        this.config = config != null ? config : new Idea34088Config();
