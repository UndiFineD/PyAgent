...
@Data
public class Idea34104Config {
    private String name = "idea_034104";
 ...
 */
@Slf4j
public class Idea34104Service {
    private static final int IDEA_ID = 34104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34104Service() {
        this(new Idea34104Config());
    }

    public Idea34104Service(Idea34104Config config) {
        this.config = config != null ? config : new Idea34104Config();
