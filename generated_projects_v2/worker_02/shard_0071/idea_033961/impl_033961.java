...
@Data
public class Idea33961Config {
    private String name = "idea_033961";
 ...
 */
@Slf4j
public class Idea33961Service {
    private static final int IDEA_ID = 33961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33961Service() {
        this(new Idea33961Config());
    }

    public Idea33961Service(Idea33961Config config) {
        this.config = config != null ? config : new Idea33961Config();
