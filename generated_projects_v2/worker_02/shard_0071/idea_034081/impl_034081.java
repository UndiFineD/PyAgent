...
@Data
public class Idea34081Config {
    private String name = "idea_034081";
 ...
 */
@Slf4j
public class Idea34081Service {
    private static final int IDEA_ID = 34081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34081Service() {
        this(new Idea34081Config());
    }

    public Idea34081Service(Idea34081Config config) {
        this.config = config != null ? config : new Idea34081Config();
