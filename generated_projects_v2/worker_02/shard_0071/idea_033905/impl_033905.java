...
@Data
public class Idea33905Config {
    private String name = "idea_033905";
 ...
 */
@Slf4j
public class Idea33905Service {
    private static final int IDEA_ID = 33905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33905Service() {
        this(new Idea33905Config());
    }

    public Idea33905Service(Idea33905Config config) {
        this.config = config != null ? config : new Idea33905Config();
