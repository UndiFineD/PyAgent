...
@Data
public class Idea33800Config {
    private String name = "idea_033800";
 ...
 */
@Slf4j
public class Idea33800Service {
    private static final int IDEA_ID = 33800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33800Service() {
        this(new Idea33800Config());
    }

    public Idea33800Service(Idea33800Config config) {
        this.config = config != null ? config : new Idea33800Config();
