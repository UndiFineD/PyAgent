...
@Data
public class Idea34025Config {
    private String name = "idea_034025";
 ...
 */
@Slf4j
public class Idea34025Service {
    private static final int IDEA_ID = 34025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34025Service() {
        this(new Idea34025Config());
    }

    public Idea34025Service(Idea34025Config config) {
        this.config = config != null ? config : new Idea34025Config();
