...
@Data
public class Idea33830Config {
    private String name = "idea_033830";
 ...
 */
@Slf4j
public class Idea33830Service {
    private static final int IDEA_ID = 33830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33830Service() {
        this(new Idea33830Config());
    }

    public Idea33830Service(Idea33830Config config) {
        this.config = config != null ? config : new Idea33830Config();
