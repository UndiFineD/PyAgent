...
@Data
public class Idea34003Config {
    private String name = "idea_034003";
 ...
 */
@Slf4j
public class Idea34003Service {
    private static final int IDEA_ID = 34003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34003Service() {
        this(new Idea34003Config());
    }

    public Idea34003Service(Idea34003Config config) {
        this.config = config != null ? config : new Idea34003Config();
