...
@Data
public class Idea33778Config {
    private String name = "idea_033778";
 ...
 */
@Slf4j
public class Idea33778Service {
    private static final int IDEA_ID = 33778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33778Service() {
        this(new Idea33778Config());
    }

    public Idea33778Service(Idea33778Config config) {
        this.config = config != null ? config : new Idea33778Config();
