...
@Data
public class Idea34113Config {
    private String name = "idea_034113";
 ...
 */
@Slf4j
public class Idea34113Service {
    private static final int IDEA_ID = 34113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34113Service() {
        this(new Idea34113Config());
    }

    public Idea34113Service(Idea34113Config config) {
        this.config = config != null ? config : new Idea34113Config();
