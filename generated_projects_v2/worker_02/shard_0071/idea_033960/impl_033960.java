...
@Data
public class Idea33960Config {
    private String name = "idea_033960";
 ...
 */
@Slf4j
public class Idea33960Service {
    private static final int IDEA_ID = 33960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33960Service() {
        this(new Idea33960Config());
    }

    public Idea33960Service(Idea33960Config config) {
        this.config = config != null ? config : new Idea33960Config();
