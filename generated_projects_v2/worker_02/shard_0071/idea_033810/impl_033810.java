...
@Data
public class Idea33810Config {
    private String name = "idea_033810";
 ...
 */
@Slf4j
public class Idea33810Service {
    private static final int IDEA_ID = 33810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33810Service() {
        this(new Idea33810Config());
    }

    public Idea33810Service(Idea33810Config config) {
        this.config = config != null ? config : new Idea33810Config();
