...
@Data
public class Idea33968Config {
    private String name = "idea_033968";
 ...
 */
@Slf4j
public class Idea33968Service {
    private static final int IDEA_ID = 33968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33968Service() {
        this(new Idea33968Config());
    }

    public Idea33968Service(Idea33968Config config) {
        this.config = config != null ? config : new Idea33968Config();
