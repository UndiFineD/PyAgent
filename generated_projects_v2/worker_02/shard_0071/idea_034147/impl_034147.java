...
@Data
public class Idea34147Config {
    private String name = "idea_034147";
 ...
 */
@Slf4j
public class Idea34147Service {
    private static final int IDEA_ID = 34147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34147Service() {
        this(new Idea34147Config());
    }

    public Idea34147Service(Idea34147Config config) {
        this.config = config != null ? config : new Idea34147Config();
