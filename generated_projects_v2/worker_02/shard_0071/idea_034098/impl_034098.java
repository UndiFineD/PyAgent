...
@Data
public class Idea34098Config {
    private String name = "idea_034098";
 ...
 */
@Slf4j
public class Idea34098Service {
    private static final int IDEA_ID = 34098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34098Service() {
        this(new Idea34098Config());
    }

    public Idea34098Service(Idea34098Config config) {
        this.config = config != null ? config : new Idea34098Config();
