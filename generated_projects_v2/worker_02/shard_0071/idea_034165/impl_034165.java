...
@Data
public class Idea34165Config {
    private String name = "idea_034165";
 ...
 */
@Slf4j
public class Idea34165Service {
    private static final int IDEA_ID = 34165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34165Service() {
        this(new Idea34165Config());
    }

    public Idea34165Service(Idea34165Config config) {
        this.config = config != null ? config : new Idea34165Config();
