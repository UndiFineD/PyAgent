...
@Data
public class Idea33814Config {
    private String name = "idea_033814";
 ...
 */
@Slf4j
public class Idea33814Service {
    private static final int IDEA_ID = 33814;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33814Service() {
        this(new Idea33814Config());
    }

    public Idea33814Service(Idea33814Config config) {
        this.config = config != null ? config : new Idea33814Config();
