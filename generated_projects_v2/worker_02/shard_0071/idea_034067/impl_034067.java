...
@Data
public class Idea34067Config {
    private String name = "idea_034067";
 ...
 */
@Slf4j
public class Idea34067Service {
    private static final int IDEA_ID = 34067;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34067Service() {
        this(new Idea34067Config());
    }

    public Idea34067Service(Idea34067Config config) {
        this.config = config != null ? config : new Idea34067Config();
