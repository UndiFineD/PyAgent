...
@Data
public class Idea33884Config {
    private String name = "idea_033884";
 ...
 */
@Slf4j
public class Idea33884Service {
    private static final int IDEA_ID = 33884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33884Service() {
        this(new Idea33884Config());
    }

    public Idea33884Service(Idea33884Config config) {
        this.config = config != null ? config : new Idea33884Config();
