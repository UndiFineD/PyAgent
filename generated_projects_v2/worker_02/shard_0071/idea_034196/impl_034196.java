...
@Data
public class Idea34196Config {
    private String name = "idea_034196";
 ...
 */
@Slf4j
public class Idea34196Service {
    private static final int IDEA_ID = 34196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34196Service() {
        this(new Idea34196Config());
    }

    public Idea34196Service(Idea34196Config config) {
        this.config = config != null ? config : new Idea34196Config();
