...
@Data
public class Idea34017Config {
    private String name = "idea_034017";
 ...
 */
@Slf4j
public class Idea34017Service {
    private static final int IDEA_ID = 34017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34017Service() {
        this(new Idea34017Config());
    }

    public Idea34017Service(Idea34017Config config) {
        this.config = config != null ? config : new Idea34017Config();
