...
@Data
public class Idea33795Config {
    private String name = "idea_033795";
 ...
 */
@Slf4j
public class Idea33795Service {
    private static final int IDEA_ID = 33795;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33795Service() {
        this(new Idea33795Config());
    }

    public Idea33795Service(Idea33795Config config) {
        this.config = config != null ? config : new Idea33795Config();
