...
@Data
public class Idea34014Config {
    private String name = "idea_034014";
 ...
 */
@Slf4j
public class Idea34014Service {
    private static final int IDEA_ID = 34014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34014Service() {
        this(new Idea34014Config());
    }

    public Idea34014Service(Idea34014Config config) {
        this.config = config != null ? config : new Idea34014Config();
