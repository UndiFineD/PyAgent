...
@Data
public class Idea33863Config {
    private String name = "idea_033863";
 ...
 */
@Slf4j
public class Idea33863Service {
    private static final int IDEA_ID = 33863;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33863Service() {
        this(new Idea33863Config());
    }

    public Idea33863Service(Idea33863Config config) {
        this.config = config != null ? config : new Idea33863Config();
