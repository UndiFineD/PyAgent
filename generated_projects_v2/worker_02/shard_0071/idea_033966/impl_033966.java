...
@Data
public class Idea33966Config {
    private String name = "idea_033966";
 ...
 */
@Slf4j
public class Idea33966Service {
    private static final int IDEA_ID = 33966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33966Service() {
        this(new Idea33966Config());
    }

    public Idea33966Service(Idea33966Config config) {
        this.config = config != null ? config : new Idea33966Config();
