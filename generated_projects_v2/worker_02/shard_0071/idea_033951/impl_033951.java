...
@Data
public class Idea33951Config {
    private String name = "idea_033951";
 ...
 */
@Slf4j
public class Idea33951Service {
    private static final int IDEA_ID = 33951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33951Service() {
        this(new Idea33951Config());
    }

    public Idea33951Service(Idea33951Config config) {
        this.config = config != null ? config : new Idea33951Config();
