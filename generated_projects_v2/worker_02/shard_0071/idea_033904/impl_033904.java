...
@Data
public class Idea33904Config {
    private String name = "idea_033904";
 ...
 */
@Slf4j
public class Idea33904Service {
    private static final int IDEA_ID = 33904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33904Service() {
        this(new Idea33904Config());
    }

    public Idea33904Service(Idea33904Config config) {
        this.config = config != null ? config : new Idea33904Config();
