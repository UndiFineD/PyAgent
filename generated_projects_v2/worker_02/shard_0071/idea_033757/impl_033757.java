...
@Data
public class Idea33757Config {
    private String name = "idea_033757";
 ...
 */
@Slf4j
public class Idea33757Service {
    private static final int IDEA_ID = 33757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33757Service() {
        this(new Idea33757Config());
    }

    public Idea33757Service(Idea33757Config config) {
        this.config = config != null ? config : new Idea33757Config();
