...
@Data
public class Idea34031Config {
    private String name = "idea_034031";
 ...
 */
@Slf4j
public class Idea34031Service {
    private static final int IDEA_ID = 34031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34031Service() {
        this(new Idea34031Config());
    }

    public Idea34031Service(Idea34031Config config) {
        this.config = config != null ? config : new Idea34031Config();
