...
@Data
public class Idea34093Config {
    private String name = "idea_034093";
 ...
 */
@Slf4j
public class Idea34093Service {
    private static final int IDEA_ID = 34093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34093Service() {
        this(new Idea34093Config());
    }

    public Idea34093Service(Idea34093Config config) {
        this.config = config != null ? config : new Idea34093Config();
