...
@Data
public class Idea33839Config {
    private String name = "idea_033839";
 ...
 */
@Slf4j
public class Idea33839Service {
    private static final int IDEA_ID = 33839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33839Service() {
        this(new Idea33839Config());
    }

    public Idea33839Service(Idea33839Config config) {
        this.config = config != null ? config : new Idea33839Config();
