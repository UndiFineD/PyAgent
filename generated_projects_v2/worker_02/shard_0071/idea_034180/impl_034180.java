...
@Data
public class Idea34180Config {
    private String name = "idea_034180";
 ...
 */
@Slf4j
public class Idea34180Service {
    private static final int IDEA_ID = 34180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34180Service() {
        this(new Idea34180Config());
    }

    public Idea34180Service(Idea34180Config config) {
        this.config = config != null ? config : new Idea34180Config();
