...
@Data
public class Idea33954Config {
    private String name = "idea_033954";
 ...
 */
@Slf4j
public class Idea33954Service {
    private static final int IDEA_ID = 33954;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33954Service() {
        this(new Idea33954Config());
    }

    public Idea33954Service(Idea33954Config config) {
        this.config = config != null ? config : new Idea33954Config();
