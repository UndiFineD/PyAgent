...
@Data
public class Idea34176Config {
    private String name = "idea_034176";
 ...
 */
@Slf4j
public class Idea34176Service {
    private static final int IDEA_ID = 34176;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34176Service() {
        this(new Idea34176Config());
    }

    public Idea34176Service(Idea34176Config config) {
        this.config = config != null ? config : new Idea34176Config();
