...
@Data
public class Idea33922Config {
    private String name = "idea_033922";
 ...
 */
@Slf4j
public class Idea33922Service {
    private static final int IDEA_ID = 33922;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33922Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33922Service() {
        this(new Idea33922Config());
    }

    public Idea33922Service(Idea33922Config config) {
        this.config = config != null ? config : new Idea33922Config();
