...
@Data
public class Idea34174Config {
    private String name = "idea_034174";
 ...
 */
@Slf4j
public class Idea34174Service {
    private static final int IDEA_ID = 34174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34174Service() {
        this(new Idea34174Config());
    }

    public Idea34174Service(Idea34174Config config) {
        this.config = config != null ? config : new Idea34174Config();
