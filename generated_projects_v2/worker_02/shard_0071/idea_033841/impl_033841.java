...
@Data
public class Idea33841Config {
    private String name = "idea_033841";
 ...
 */
@Slf4j
public class Idea33841Service {
    private static final int IDEA_ID = 33841;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33841Service() {
        this(new Idea33841Config());
    }

    public Idea33841Service(Idea33841Config config) {
        this.config = config != null ? config : new Idea33841Config();
