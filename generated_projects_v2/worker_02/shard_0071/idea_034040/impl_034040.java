...
@Data
public class Idea34040Config {
    private String name = "idea_034040";
 ...
 */
@Slf4j
public class Idea34040Service {
    private static final int IDEA_ID = 34040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34040Service() {
        this(new Idea34040Config());
    }

    public Idea34040Service(Idea34040Config config) {
        this.config = config != null ? config : new Idea34040Config();
