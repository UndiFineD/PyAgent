...
@Data
public class Idea33840Config {
    private String name = "idea_033840";
 ...
 */
@Slf4j
public class Idea33840Service {
    private static final int IDEA_ID = 33840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33840Service() {
        this(new Idea33840Config());
    }

    public Idea33840Service(Idea33840Config config) {
        this.config = config != null ? config : new Idea33840Config();
