...
@Data
public class Idea33812Config {
    private String name = "idea_033812";
 ...
 */
@Slf4j
public class Idea33812Service {
    private static final int IDEA_ID = 33812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33812Service() {
        this(new Idea33812Config());
    }

    public Idea33812Service(Idea33812Config config) {
        this.config = config != null ? config : new Idea33812Config();
