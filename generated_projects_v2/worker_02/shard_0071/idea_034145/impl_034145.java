...
@Data
public class Idea34145Config {
    private String name = "idea_034145";
 ...
 */
@Slf4j
public class Idea34145Service {
    private static final int IDEA_ID = 34145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34145Service() {
        this(new Idea34145Config());
    }

    public Idea34145Service(Idea34145Config config) {
        this.config = config != null ? config : new Idea34145Config();
