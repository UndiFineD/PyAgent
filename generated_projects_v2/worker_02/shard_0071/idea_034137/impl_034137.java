...
@Data
public class Idea34137Config {
    private String name = "idea_034137";
 ...
 */
@Slf4j
public class Idea34137Service {
    private static final int IDEA_ID = 34137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34137Service() {
        this(new Idea34137Config());
    }

    public Idea34137Service(Idea34137Config config) {
        this.config = config != null ? config : new Idea34137Config();
