...
@Data
public class Idea34046Config {
    private String name = "idea_034046";
 ...
 */
@Slf4j
public class Idea34046Service {
    private static final int IDEA_ID = 34046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34046Service() {
        this(new Idea34046Config());
    }

    public Idea34046Service(Idea34046Config config) {
        this.config = config != null ? config : new Idea34046Config();
