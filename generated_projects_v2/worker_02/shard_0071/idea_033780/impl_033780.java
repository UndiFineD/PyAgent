...
@Data
public class Idea33780Config {
    private String name = "idea_033780";
 ...
 */
@Slf4j
public class Idea33780Service {
    private static final int IDEA_ID = 33780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33780Service() {
        this(new Idea33780Config());
    }

    public Idea33780Service(Idea33780Config config) {
        this.config = config != null ? config : new Idea33780Config();
