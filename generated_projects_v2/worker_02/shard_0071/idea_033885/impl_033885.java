...
@Data
public class Idea33885Config {
    private String name = "idea_033885";
 ...
 */
@Slf4j
public class Idea33885Service {
    private static final int IDEA_ID = 33885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33885Service() {
        this(new Idea33885Config());
    }

    public Idea33885Service(Idea33885Config config) {
        this.config = config != null ? config : new Idea33885Config();
