...
@Data
public class Idea33773Config {
    private String name = "idea_033773";
 ...
 */
@Slf4j
public class Idea33773Service {
    private static final int IDEA_ID = 33773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33773Service() {
        this(new Idea33773Config());
    }

    public Idea33773Service(Idea33773Config config) {
        this.config = config != null ? config : new Idea33773Config();
