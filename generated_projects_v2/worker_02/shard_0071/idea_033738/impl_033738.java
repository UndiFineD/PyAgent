...
@Data
public class Idea33738Config {
    private String name = "idea_033738";
 ...
 */
@Slf4j
public class Idea33738Service {
    private static final int IDEA_ID = 33738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33738Service() {
        this(new Idea33738Config());
    }

    public Idea33738Service(Idea33738Config config) {
        this.config = config != null ? config : new Idea33738Config();
