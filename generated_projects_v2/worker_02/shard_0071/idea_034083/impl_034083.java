...
@Data
public class Idea34083Config {
    private String name = "idea_034083";
 ...
 */
@Slf4j
public class Idea34083Service {
    private static final int IDEA_ID = 34083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34083Service() {
        this(new Idea34083Config());
    }

    public Idea34083Service(Idea34083Config config) {
        this.config = config != null ? config : new Idea34083Config();
