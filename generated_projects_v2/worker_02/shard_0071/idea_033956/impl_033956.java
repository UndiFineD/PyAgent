...
@Data
public class Idea33956Config {
    private String name = "idea_033956";
 ...
 */
@Slf4j
public class Idea33956Service {
    private static final int IDEA_ID = 33956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33956Service() {
        this(new Idea33956Config());
    }

    public Idea33956Service(Idea33956Config config) {
        this.config = config != null ? config : new Idea33956Config();
