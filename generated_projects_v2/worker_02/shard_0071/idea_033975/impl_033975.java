...
@Data
public class Idea33975Config {
    private String name = "idea_033975";
 ...
 */
@Slf4j
public class Idea33975Service {
    private static final int IDEA_ID = 33975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33975Service() {
        this(new Idea33975Config());
    }

    public Idea33975Service(Idea33975Config config) {
        this.config = config != null ? config : new Idea33975Config();
