...
@Data
public class Idea34033Config {
    private String name = "idea_034033";
 ...
 */
@Slf4j
public class Idea34033Service {
    private static final int IDEA_ID = 34033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34033Service() {
        this(new Idea34033Config());
    }

    public Idea34033Service(Idea34033Config config) {
        this.config = config != null ? config : new Idea34033Config();
