...
@Data
public class Idea33777Config {
    private String name = "idea_033777";
 ...
 */
@Slf4j
public class Idea33777Service {
    private static final int IDEA_ID = 33777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33777Service() {
        this(new Idea33777Config());
    }

    public Idea33777Service(Idea33777Config config) {
        this.config = config != null ? config : new Idea33777Config();
