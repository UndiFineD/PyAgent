...
@Data
public class Idea33994Config {
    private String name = "idea_033994";
 ...
 */
@Slf4j
public class Idea33994Service {
    private static final int IDEA_ID = 33994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33994Service() {
        this(new Idea33994Config());
    }

    public Idea33994Service(Idea33994Config config) {
        this.config = config != null ? config : new Idea33994Config();
