...
@Data
public class Idea33808Config {
    private String name = "idea_033808";
 ...
 */
@Slf4j
public class Idea33808Service {
    private static final int IDEA_ID = 33808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33808Service() {
        this(new Idea33808Config());
    }

    public Idea33808Service(Idea33808Config config) {
        this.config = config != null ? config : new Idea33808Config();
