...
@Data
public class Idea33878Config {
    private String name = "idea_033878";
 ...
 */
@Slf4j
public class Idea33878Service {
    private static final int IDEA_ID = 33878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33878Service() {
        this(new Idea33878Config());
    }

    public Idea33878Service(Idea33878Config config) {
        this.config = config != null ? config : new Idea33878Config();
