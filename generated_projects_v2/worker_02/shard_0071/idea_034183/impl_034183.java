...
@Data
public class Idea34183Config {
    private String name = "idea_034183";
 ...
 */
@Slf4j
public class Idea34183Service {
    private static final int IDEA_ID = 34183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34183Service() {
        this(new Idea34183Config());
    }

    public Idea34183Service(Idea34183Config config) {
        this.config = config != null ? config : new Idea34183Config();
