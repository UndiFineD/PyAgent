...
@Data
public class Idea34139Config {
    private String name = "idea_034139";
 ...
 */
@Slf4j
public class Idea34139Service {
    private static final int IDEA_ID = 34139;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34139Service() {
        this(new Idea34139Config());
    }

    public Idea34139Service(Idea34139Config config) {
        this.config = config != null ? config : new Idea34139Config();
