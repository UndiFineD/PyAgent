...
@Data
public class Idea33819Config {
    private String name = "idea_033819";
 ...
 */
@Slf4j
public class Idea33819Service {
    private static final int IDEA_ID = 33819;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33819Service() {
        this(new Idea33819Config());
    }

    public Idea33819Service(Idea33819Config config) {
        this.config = config != null ? config : new Idea33819Config();
