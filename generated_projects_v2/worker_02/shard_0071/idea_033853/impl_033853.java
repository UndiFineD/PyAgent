...
@Data
public class Idea33853Config {
    private String name = "idea_033853";
 ...
 */
@Slf4j
public class Idea33853Service {
    private static final int IDEA_ID = 33853;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33853Service() {
        this(new Idea33853Config());
    }

    public Idea33853Service(Idea33853Config config) {
        this.config = config != null ? config : new Idea33853Config();
