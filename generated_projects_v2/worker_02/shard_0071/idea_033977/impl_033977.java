...
@Data
public class Idea33977Config {
    private String name = "idea_033977";
 ...
 */
@Slf4j
public class Idea33977Service {
    private static final int IDEA_ID = 33977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33977Service() {
        this(new Idea33977Config());
    }

    public Idea33977Service(Idea33977Config config) {
        this.config = config != null ? config : new Idea33977Config();
