...
@Data
public class Idea34042Config {
    private String name = "idea_034042";
 ...
 */
@Slf4j
public class Idea34042Service {
    private static final int IDEA_ID = 34042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34042Service() {
        this(new Idea34042Config());
    }

    public Idea34042Service(Idea34042Config config) {
        this.config = config != null ? config : new Idea34042Config();
