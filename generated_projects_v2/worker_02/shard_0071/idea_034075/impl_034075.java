...
@Data
public class Idea34075Config {
    private String name = "idea_034075";
 ...
 */
@Slf4j
public class Idea34075Service {
    private static final int IDEA_ID = 34075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34075Service() {
        this(new Idea34075Config());
    }

    public Idea34075Service(Idea34075Config config) {
        this.config = config != null ? config : new Idea34075Config();
