...
@Data
public class Idea33745Config {
    private String name = "idea_033745";
 ...
 */
@Slf4j
public class Idea33745Service {
    private static final int IDEA_ID = 33745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33745Service() {
        this(new Idea33745Config());
    }

    public Idea33745Service(Idea33745Config config) {
        this.config = config != null ? config : new Idea33745Config();
