...
@Data
public class Idea33971Config {
    private String name = "idea_033971";
 ...
 */
@Slf4j
public class Idea33971Service {
    private static final int IDEA_ID = 33971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33971Service() {
        this(new Idea33971Config());
    }

    public Idea33971Service(Idea33971Config config) {
        this.config = config != null ? config : new Idea33971Config();
