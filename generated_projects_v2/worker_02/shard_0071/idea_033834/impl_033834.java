...
@Data
public class Idea33834Config {
    private String name = "idea_033834";
 ...
 */
@Slf4j
public class Idea33834Service {
    private static final int IDEA_ID = 33834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33834Service() {
        this(new Idea33834Config());
    }

    public Idea33834Service(Idea33834Config config) {
        this.config = config != null ? config : new Idea33834Config();
