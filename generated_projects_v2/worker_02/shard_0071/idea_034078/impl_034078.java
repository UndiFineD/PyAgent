...
@Data
public class Idea34078Config {
    private String name = "idea_034078";
 ...
 */
@Slf4j
public class Idea34078Service {
    private static final int IDEA_ID = 34078;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34078Service() {
        this(new Idea34078Config());
    }

    public Idea34078Service(Idea34078Config config) {
        this.config = config != null ? config : new Idea34078Config();
