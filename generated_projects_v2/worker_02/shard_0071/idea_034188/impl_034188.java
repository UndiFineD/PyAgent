...
@Data
public class Idea34188Config {
    private String name = "idea_034188";
 ...
 */
@Slf4j
public class Idea34188Service {
    private static final int IDEA_ID = 34188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34188Service() {
        this(new Idea34188Config());
    }

    public Idea34188Service(Idea34188Config config) {
        this.config = config != null ? config : new Idea34188Config();
