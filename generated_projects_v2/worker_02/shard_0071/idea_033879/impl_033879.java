...
@Data
public class Idea33879Config {
    private String name = "idea_033879";
 ...
 */
@Slf4j
public class Idea33879Service {
    private static final int IDEA_ID = 33879;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33879Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33879Service() {
        this(new Idea33879Config());
    }

    public Idea33879Service(Idea33879Config config) {
        this.config = config != null ? config : new Idea33879Config();
