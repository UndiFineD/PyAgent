...
@Data
public class Idea34073Config {
    private String name = "idea_034073";
 ...
 */
@Slf4j
public class Idea34073Service {
    private static final int IDEA_ID = 34073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34073Service() {
        this(new Idea34073Config());
    }

    public Idea34073Service(Idea34073Config config) {
        this.config = config != null ? config : new Idea34073Config();
