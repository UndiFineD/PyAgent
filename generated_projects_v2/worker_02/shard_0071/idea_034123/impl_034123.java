...
@Data
public class Idea34123Config {
    private String name = "idea_034123";
 ...
 */
@Slf4j
public class Idea34123Service {
    private static final int IDEA_ID = 34123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34123Service() {
        this(new Idea34123Config());
    }

    public Idea34123Service(Idea34123Config config) {
        this.config = config != null ? config : new Idea34123Config();
