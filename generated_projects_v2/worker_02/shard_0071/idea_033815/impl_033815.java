...
@Data
public class Idea33815Config {
    private String name = "idea_033815";
 ...
 */
@Slf4j
public class Idea33815Service {
    private static final int IDEA_ID = 33815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33815Service() {
        this(new Idea33815Config());
    }

    public Idea33815Service(Idea33815Config config) {
        this.config = config != null ? config : new Idea33815Config();
