...
@Data
public class Idea34047Config {
    private String name = "idea_034047";
 ...
 */
@Slf4j
public class Idea34047Service {
    private static final int IDEA_ID = 34047;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34047Service() {
        this(new Idea34047Config());
    }

    public Idea34047Service(Idea34047Config config) {
        this.config = config != null ? config : new Idea34047Config();
