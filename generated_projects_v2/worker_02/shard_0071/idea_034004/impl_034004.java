...
@Data
public class Idea34004Config {
    private String name = "idea_034004";
 ...
 */
@Slf4j
public class Idea34004Service {
    private static final int IDEA_ID = 34004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34004Service() {
        this(new Idea34004Config());
    }

    public Idea34004Service(Idea34004Config config) {
        this.config = config != null ? config : new Idea34004Config();
