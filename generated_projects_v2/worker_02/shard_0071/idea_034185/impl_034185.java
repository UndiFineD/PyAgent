...
@Data
public class Idea34185Config {
    private String name = "idea_034185";
 ...
 */
@Slf4j
public class Idea34185Service {
    private static final int IDEA_ID = 34185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34185Service() {
        this(new Idea34185Config());
    }

    public Idea34185Service(Idea34185Config config) {
        this.config = config != null ? config : new Idea34185Config();
