...
@Data
public class Idea33855Config {
    private String name = "idea_033855";
 ...
 */
@Slf4j
public class Idea33855Service {
    private static final int IDEA_ID = 33855;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33855Service() {
        this(new Idea33855Config());
    }

    public Idea33855Service(Idea33855Config config) {
        this.config = config != null ? config : new Idea33855Config();
