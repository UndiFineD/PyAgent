...
@Data
public class Idea33864Config {
    private String name = "idea_033864";
 ...
 */
@Slf4j
public class Idea33864Service {
    private static final int IDEA_ID = 33864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33864Service() {
        this(new Idea33864Config());
    }

    public Idea33864Service(Idea33864Config config) {
        this.config = config != null ? config : new Idea33864Config();
