...
@Data
public class Idea34023Config {
    private String name = "idea_034023";
 ...
 */
@Slf4j
public class Idea34023Service {
    private static final int IDEA_ID = 34023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34023Service() {
        this(new Idea34023Config());
    }

    public Idea34023Service(Idea34023Config config) {
        this.config = config != null ? config : new Idea34023Config();
