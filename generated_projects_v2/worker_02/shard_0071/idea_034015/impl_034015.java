...
@Data
public class Idea34015Config {
    private String name = "idea_034015";
 ...
 */
@Slf4j
public class Idea34015Service {
    private static final int IDEA_ID = 34015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34015Service() {
        this(new Idea34015Config());
    }

    public Idea34015Service(Idea34015Config config) {
        this.config = config != null ? config : new Idea34015Config();
