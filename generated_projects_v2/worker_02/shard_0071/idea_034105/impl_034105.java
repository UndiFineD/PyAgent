...
@Data
public class Idea34105Config {
    private String name = "idea_034105";
 ...
 */
@Slf4j
public class Idea34105Service {
    private static final int IDEA_ID = 34105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34105Service() {
        this(new Idea34105Config());
    }

    public Idea34105Service(Idea34105Config config) {
        this.config = config != null ? config : new Idea34105Config();
