...
@Data
public class Idea34149Config {
    private String name = "idea_034149";
 ...
 */
@Slf4j
public class Idea34149Service {
    private static final int IDEA_ID = 34149;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34149Service() {
        this(new Idea34149Config());
    }

    public Idea34149Service(Idea34149Config config) {
        this.config = config != null ? config : new Idea34149Config();
