...
@Data
public class Idea32788Config {
    private String name = "idea_032788";
 ...
 */
@Slf4j
public class Idea32788Service {
    private static final int IDEA_ID = 32788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32788Service() {
        this(new Idea32788Config());
    }

    public Idea32788Service(Idea32788Config config) {
        this.config = config != null ? config : new Idea32788Config();
