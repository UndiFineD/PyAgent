...
@Data
public class Idea33123Config {
    private String name = "idea_033123";
 ...
 */
@Slf4j
public class Idea33123Service {
    private static final int IDEA_ID = 33123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33123Service() {
        this(new Idea33123Config());
    }

    public Idea33123Service(Idea33123Config config) {
        this.config = config != null ? config : new Idea33123Config();
