...
@Data
public class Idea32839Config {
    private String name = "idea_032839";
 ...
 */
@Slf4j
public class Idea32839Service {
    private static final int IDEA_ID = 32839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32839Service() {
        this(new Idea32839Config());
    }

    public Idea32839Service(Idea32839Config config) {
        this.config = config != null ? config : new Idea32839Config();
