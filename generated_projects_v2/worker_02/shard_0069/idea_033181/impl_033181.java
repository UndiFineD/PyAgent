...
@Data
public class Idea33181Config {
    private String name = "idea_033181";
 ...
 */
@Slf4j
public class Idea33181Service {
    private static final int IDEA_ID = 33181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33181Service() {
        this(new Idea33181Config());
    }

    public Idea33181Service(Idea33181Config config) {
        this.config = config != null ? config : new Idea33181Config();
