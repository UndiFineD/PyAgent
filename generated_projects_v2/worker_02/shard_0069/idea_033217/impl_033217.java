...
@Data
public class Idea33217Config {
    private String name = "idea_033217";
 ...
 */
@Slf4j
public class Idea33217Service {
    private static final int IDEA_ID = 33217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33217Service() {
        this(new Idea33217Config());
    }

    public Idea33217Service(Idea33217Config config) {
        this.config = config != null ? config : new Idea33217Config();
