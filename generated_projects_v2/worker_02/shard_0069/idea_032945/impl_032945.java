...
@Data
public class Idea32945Config {
    private String name = "idea_032945";
 ...
 */
@Slf4j
public class Idea32945Service {
    private static final int IDEA_ID = 32945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32945Service() {
        this(new Idea32945Config());
    }

    public Idea32945Service(Idea32945Config config) {
        this.config = config != null ? config : new Idea32945Config();
