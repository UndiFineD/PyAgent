...
@Data
public class Idea33239Config {
    private String name = "idea_033239";
 ...
 */
@Slf4j
public class Idea33239Service {
    private static final int IDEA_ID = 33239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33239Service() {
        this(new Idea33239Config());
    }

    public Idea33239Service(Idea33239Config config) {
        this.config = config != null ? config : new Idea33239Config();
