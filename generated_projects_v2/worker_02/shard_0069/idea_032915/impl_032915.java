...
@Data
public class Idea32915Config {
    private String name = "idea_032915";
 ...
 */
@Slf4j
public class Idea32915Service {
    private static final int IDEA_ID = 32915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32915Service() {
        this(new Idea32915Config());
    }

    public Idea32915Service(Idea32915Config config) {
        this.config = config != null ? config : new Idea32915Config();
