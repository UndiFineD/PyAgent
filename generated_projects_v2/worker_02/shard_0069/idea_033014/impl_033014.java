...
@Data
public class Idea33014Config {
    private String name = "idea_033014";
 ...
 */
@Slf4j
public class Idea33014Service {
    private static final int IDEA_ID = 33014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33014Service() {
        this(new Idea33014Config());
    }

    public Idea33014Service(Idea33014Config config) {
        this.config = config != null ? config : new Idea33014Config();
