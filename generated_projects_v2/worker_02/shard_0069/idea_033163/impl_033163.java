...
@Data
public class Idea33163Config {
    private String name = "idea_033163";
 ...
 */
@Slf4j
public class Idea33163Service {
    private static final int IDEA_ID = 33163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33163Service() {
        this(new Idea33163Config());
    }

    public Idea33163Service(Idea33163Config config) {
        this.config = config != null ? config : new Idea33163Config();
