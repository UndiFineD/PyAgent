...
@Data
public class Idea33016Config {
    private String name = "idea_033016";
 ...
 */
@Slf4j
public class Idea33016Service {
    private static final int IDEA_ID = 33016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33016Service() {
        this(new Idea33016Config());
    }

    public Idea33016Service(Idea33016Config config) {
        this.config = config != null ? config : new Idea33016Config();
