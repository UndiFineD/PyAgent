...
@Data
public class Idea33081Config {
    private String name = "idea_033081";
 ...
 */
@Slf4j
public class Idea33081Service {
    private static final int IDEA_ID = 33081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33081Service() {
        this(new Idea33081Config());
    }

    public Idea33081Service(Idea33081Config config) {
        this.config = config != null ? config : new Idea33081Config();
