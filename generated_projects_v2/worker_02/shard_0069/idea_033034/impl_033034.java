...
@Data
public class Idea33034Config {
    private String name = "idea_033034";
 ...
 */
@Slf4j
public class Idea33034Service {
    private static final int IDEA_ID = 33034;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33034Service() {
        this(new Idea33034Config());
    }

    public Idea33034Service(Idea33034Config config) {
        this.config = config != null ? config : new Idea33034Config();
