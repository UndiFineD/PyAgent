...
@Data
public class Idea32925Config {
    private String name = "idea_032925";
 ...
 */
@Slf4j
public class Idea32925Service {
    private static final int IDEA_ID = 32925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32925Service() {
        this(new Idea32925Config());
    }

    public Idea32925Service(Idea32925Config config) {
        this.config = config != null ? config : new Idea32925Config();
