...
@Data
public class Idea32946Config {
    private String name = "idea_032946";
 ...
 */
@Slf4j
public class Idea32946Service {
    private static final int IDEA_ID = 32946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32946Service() {
        this(new Idea32946Config());
    }

    public Idea32946Service(Idea32946Config config) {
        this.config = config != null ? config : new Idea32946Config();
