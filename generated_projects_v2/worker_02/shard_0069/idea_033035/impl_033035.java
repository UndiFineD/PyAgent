...
@Data
public class Idea33035Config {
    private String name = "idea_033035";
 ...
 */
@Slf4j
public class Idea33035Service {
    private static final int IDEA_ID = 33035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33035Service() {
        this(new Idea33035Config());
    }

    public Idea33035Service(Idea33035Config config) {
        this.config = config != null ? config : new Idea33035Config();
