...
@Data
public class Idea33130Config {
    private String name = "idea_033130";
 ...
 */
@Slf4j
public class Idea33130Service {
    private static final int IDEA_ID = 33130;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33130Service() {
        this(new Idea33130Config());
    }

    public Idea33130Service(Idea33130Config config) {
        this.config = config != null ? config : new Idea33130Config();
