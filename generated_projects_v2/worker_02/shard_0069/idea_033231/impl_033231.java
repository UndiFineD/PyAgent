...
@Data
public class Idea33231Config {
    private String name = "idea_033231";
 ...
 */
@Slf4j
public class Idea33231Service {
    private static final int IDEA_ID = 33231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33231Service() {
        this(new Idea33231Config());
    }

    public Idea33231Service(Idea33231Config config) {
        this.config = config != null ? config : new Idea33231Config();
