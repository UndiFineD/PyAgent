...
@Data
public class Idea33073Config {
    private String name = "idea_033073";
 ...
 */
@Slf4j
public class Idea33073Service {
    private static final int IDEA_ID = 33073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33073Service() {
        this(new Idea33073Config());
    }

    public Idea33073Service(Idea33073Config config) {
        this.config = config != null ? config : new Idea33073Config();
