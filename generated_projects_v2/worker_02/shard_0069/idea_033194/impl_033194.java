...
@Data
public class Idea33194Config {
    private String name = "idea_033194";
 ...
 */
@Slf4j
public class Idea33194Service {
    private static final int IDEA_ID = 33194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33194Service() {
        this(new Idea33194Config());
    }

    public Idea33194Service(Idea33194Config config) {
        this.config = config != null ? config : new Idea33194Config();
