...
@Data
public class Idea32909Config {
    private String name = "idea_032909";
 ...
 */
@Slf4j
public class Idea32909Service {
    private static final int IDEA_ID = 32909;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32909Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32909Service() {
        this(new Idea32909Config());
    }

    public Idea32909Service(Idea32909Config config) {
        this.config = config != null ? config : new Idea32909Config();
