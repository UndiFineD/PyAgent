...
@Data
public class Idea32898Config {
    private String name = "idea_032898";
 ...
 */
@Slf4j
public class Idea32898Service {
    private static final int IDEA_ID = 32898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32898Service() {
        this(new Idea32898Config());
    }

    public Idea32898Service(Idea32898Config config) {
        this.config = config != null ? config : new Idea32898Config();
