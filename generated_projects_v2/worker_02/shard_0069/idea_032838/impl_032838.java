...
@Data
public class Idea32838Config {
    private String name = "idea_032838";
 ...
 */
@Slf4j
public class Idea32838Service {
    private static final int IDEA_ID = 32838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32838Service() {
        this(new Idea32838Config());
    }

    public Idea32838Service(Idea32838Config config) {
        this.config = config != null ? config : new Idea32838Config();
