...
@Data
public class Idea32989Config {
    private String name = "idea_032989";
 ...
 */
@Slf4j
public class Idea32989Service {
    private static final int IDEA_ID = 32989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32989Service() {
        this(new Idea32989Config());
    }

    public Idea32989Service(Idea32989Config config) {
        this.config = config != null ? config : new Idea32989Config();
