...
@Data
public class Idea32924Config {
    private String name = "idea_032924";
 ...
 */
@Slf4j
public class Idea32924Service {
    private static final int IDEA_ID = 32924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32924Service() {
        this(new Idea32924Config());
    }

    public Idea32924Service(Idea32924Config config) {
        this.config = config != null ? config : new Idea32924Config();
