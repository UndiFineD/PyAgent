...
@Data
public class Idea32843Config {
    private String name = "idea_032843";
 ...
 */
@Slf4j
public class Idea32843Service {
    private static final int IDEA_ID = 32843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32843Service() {
        this(new Idea32843Config());
    }

    public Idea32843Service(Idea32843Config config) {
        this.config = config != null ? config : new Idea32843Config();
