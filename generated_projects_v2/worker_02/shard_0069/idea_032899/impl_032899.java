...
@Data
public class Idea32899Config {
    private String name = "idea_032899";
 ...
 */
@Slf4j
public class Idea32899Service {
    private static final int IDEA_ID = 32899;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32899Service() {
        this(new Idea32899Config());
    }

    public Idea32899Service(Idea32899Config config) {
        this.config = config != null ? config : new Idea32899Config();
