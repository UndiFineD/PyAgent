...
@Data
public class Idea32845Config {
    private String name = "idea_032845";
 ...
 */
@Slf4j
public class Idea32845Service {
    private static final int IDEA_ID = 32845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32845Service() {
        this(new Idea32845Config());
    }

    public Idea32845Service(Idea32845Config config) {
        this.config = config != null ? config : new Idea32845Config();
