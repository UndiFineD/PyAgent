...
@Data
public class Idea32974Config {
    private String name = "idea_032974";
 ...
 */
@Slf4j
public class Idea32974Service {
    private static final int IDEA_ID = 32974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32974Service() {
        this(new Idea32974Config());
    }

    public Idea32974Service(Idea32974Config config) {
        this.config = config != null ? config : new Idea32974Config();
