...
@Data
public class Idea33104Config {
    private String name = "idea_033104";
 ...
 */
@Slf4j
public class Idea33104Service {
    private static final int IDEA_ID = 33104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33104Service() {
        this(new Idea33104Config());
    }

    public Idea33104Service(Idea33104Config config) {
        this.config = config != null ? config : new Idea33104Config();
