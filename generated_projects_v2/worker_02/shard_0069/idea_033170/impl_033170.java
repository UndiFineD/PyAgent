...
@Data
public class Idea33170Config {
    private String name = "idea_033170";
 ...
 */
@Slf4j
public class Idea33170Service {
    private static final int IDEA_ID = 33170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33170Service() {
        this(new Idea33170Config());
    }

    public Idea33170Service(Idea33170Config config) {
        this.config = config != null ? config : new Idea33170Config();
