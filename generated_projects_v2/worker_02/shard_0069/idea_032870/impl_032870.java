...
@Data
public class Idea32870Config {
    private String name = "idea_032870";
 ...
 */
@Slf4j
public class Idea32870Service {
    private static final int IDEA_ID = 32870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32870Service() {
        this(new Idea32870Config());
    }

    public Idea32870Service(Idea32870Config config) {
        this.config = config != null ? config : new Idea32870Config();
