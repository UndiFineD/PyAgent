...
@Data
public class Idea33076Config {
    private String name = "idea_033076";
 ...
 */
@Slf4j
public class Idea33076Service {
    private static final int IDEA_ID = 33076;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33076Service() {
        this(new Idea33076Config());
    }

    public Idea33076Service(Idea33076Config config) {
        this.config = config != null ? config : new Idea33076Config();
