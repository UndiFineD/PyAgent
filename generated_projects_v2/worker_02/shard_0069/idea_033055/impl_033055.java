...
@Data
public class Idea33055Config {
    private String name = "idea_033055";
 ...
 */
@Slf4j
public class Idea33055Service {
    private static final int IDEA_ID = 33055;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33055Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33055Service() {
        this(new Idea33055Config());
    }

    public Idea33055Service(Idea33055Config config) {
        this.config = config != null ? config : new Idea33055Config();
