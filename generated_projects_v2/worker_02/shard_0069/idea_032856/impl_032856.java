...
@Data
public class Idea32856Config {
    private String name = "idea_032856";
 ...
 */
@Slf4j
public class Idea32856Service {
    private static final int IDEA_ID = 32856;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32856Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32856Service() {
        this(new Idea32856Config());
    }

    public Idea32856Service(Idea32856Config config) {
        this.config = config != null ? config : new Idea32856Config();
