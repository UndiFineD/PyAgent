...
@Data
public class Idea32984Config {
    private String name = "idea_032984";
 ...
 */
@Slf4j
public class Idea32984Service {
    private static final int IDEA_ID = 32984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32984Service() {
        this(new Idea32984Config());
    }

    public Idea32984Service(Idea32984Config config) {
        this.config = config != null ? config : new Idea32984Config();
