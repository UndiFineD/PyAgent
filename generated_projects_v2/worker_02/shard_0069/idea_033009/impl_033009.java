...
@Data
public class Idea33009Config {
    private String name = "idea_033009";
 ...
 */
@Slf4j
public class Idea33009Service {
    private static final int IDEA_ID = 33009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33009Service() {
        this(new Idea33009Config());
    }

    public Idea33009Service(Idea33009Config config) {
        this.config = config != null ? config : new Idea33009Config();
