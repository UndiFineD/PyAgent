...
@Data
public class Idea33240Config {
    private String name = "idea_033240";
 ...
 */
@Slf4j
public class Idea33240Service {
    private static final int IDEA_ID = 33240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33240Service() {
        this(new Idea33240Config());
    }

    public Idea33240Service(Idea33240Config config) {
        this.config = config != null ? config : new Idea33240Config();
