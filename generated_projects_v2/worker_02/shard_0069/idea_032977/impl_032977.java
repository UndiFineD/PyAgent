...
@Data
public class Idea32977Config {
    private String name = "idea_032977";
 ...
 */
@Slf4j
public class Idea32977Service {
    private static final int IDEA_ID = 32977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32977Service() {
        this(new Idea32977Config());
    }

    public Idea32977Service(Idea32977Config config) {
        this.config = config != null ? config : new Idea32977Config();
