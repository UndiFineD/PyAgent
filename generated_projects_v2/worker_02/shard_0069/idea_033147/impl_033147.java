...
@Data
public class Idea33147Config {
    private String name = "idea_033147";
 ...
 */
@Slf4j
public class Idea33147Service {
    private static final int IDEA_ID = 33147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33147Service() {
        this(new Idea33147Config());
    }

    public Idea33147Service(Idea33147Config config) {
        this.config = config != null ? config : new Idea33147Config();
