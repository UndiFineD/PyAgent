...
@Data
public class Idea32961Config {
    private String name = "idea_032961";
 ...
 */
@Slf4j
public class Idea32961Service {
    private static final int IDEA_ID = 32961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32961Service() {
        this(new Idea32961Config());
    }

    public Idea32961Service(Idea32961Config config) {
        this.config = config != null ? config : new Idea32961Config();
