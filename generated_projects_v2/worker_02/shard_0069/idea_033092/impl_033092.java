...
@Data
public class Idea33092Config {
    private String name = "idea_033092";
 ...
 */
@Slf4j
public class Idea33092Service {
    private static final int IDEA_ID = 33092;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33092Service() {
        this(new Idea33092Config());
    }

    public Idea33092Service(Idea33092Config config) {
        this.config = config != null ? config : new Idea33092Config();
