...
@Data
public class Idea33183Config {
    private String name = "idea_033183";
 ...
 */
@Slf4j
public class Idea33183Service {
    private static final int IDEA_ID = 33183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33183Service() {
        this(new Idea33183Config());
    }

    public Idea33183Service(Idea33183Config config) {
        this.config = config != null ? config : new Idea33183Config();
