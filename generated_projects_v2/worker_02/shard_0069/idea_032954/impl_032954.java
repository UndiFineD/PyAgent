...
@Data
public class Idea32954Config {
    private String name = "idea_032954";
 ...
 */
@Slf4j
public class Idea32954Service {
    private static final int IDEA_ID = 32954;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32954Service() {
        this(new Idea32954Config());
    }

    public Idea32954Service(Idea32954Config config) {
        this.config = config != null ? config : new Idea32954Config();
