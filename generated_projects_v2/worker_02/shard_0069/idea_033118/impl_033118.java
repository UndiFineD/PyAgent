...
@Data
public class Idea33118Config {
    private String name = "idea_033118";
 ...
 */
@Slf4j
public class Idea33118Service {
    private static final int IDEA_ID = 33118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33118Service() {
        this(new Idea33118Config());
    }

    public Idea33118Service(Idea33118Config config) {
        this.config = config != null ? config : new Idea33118Config();
