...
@Data
public class Idea33071Config {
    private String name = "idea_033071";
 ...
 */
@Slf4j
public class Idea33071Service {
    private static final int IDEA_ID = 33071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33071Service() {
        this(new Idea33071Config());
    }

    public Idea33071Service(Idea33071Config config) {
        this.config = config != null ? config : new Idea33071Config();
