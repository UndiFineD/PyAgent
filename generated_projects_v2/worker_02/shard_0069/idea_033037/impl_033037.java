...
@Data
public class Idea33037Config {
    private String name = "idea_033037";
 ...
 */
@Slf4j
public class Idea33037Service {
    private static final int IDEA_ID = 33037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33037Service() {
        this(new Idea33037Config());
    }

    public Idea33037Service(Idea33037Config config) {
        this.config = config != null ? config : new Idea33037Config();
