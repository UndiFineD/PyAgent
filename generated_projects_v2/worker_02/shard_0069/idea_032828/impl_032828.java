...
@Data
public class Idea32828Config {
    private String name = "idea_032828";
 ...
 */
@Slf4j
public class Idea32828Service {
    private static final int IDEA_ID = 32828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32828Service() {
        this(new Idea32828Config());
    }

    public Idea32828Service(Idea32828Config config) {
        this.config = config != null ? config : new Idea32828Config();
