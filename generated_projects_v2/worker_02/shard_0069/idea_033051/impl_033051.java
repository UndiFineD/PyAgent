...
@Data
public class Idea33051Config {
    private String name = "idea_033051";
 ...
 */
@Slf4j
public class Idea33051Service {
    private static final int IDEA_ID = 33051;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33051Service() {
        this(new Idea33051Config());
    }

    public Idea33051Service(Idea33051Config config) {
        this.config = config != null ? config : new Idea33051Config();
