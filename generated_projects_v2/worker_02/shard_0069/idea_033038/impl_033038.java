...
@Data
public class Idea33038Config {
    private String name = "idea_033038";
 ...
 */
@Slf4j
public class Idea33038Service {
    private static final int IDEA_ID = 33038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33038Service() {
        this(new Idea33038Config());
    }

    public Idea33038Service(Idea33038Config config) {
        this.config = config != null ? config : new Idea33038Config();
