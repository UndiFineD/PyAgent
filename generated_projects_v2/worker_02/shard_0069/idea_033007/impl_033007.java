...
@Data
public class Idea33007Config {
    private String name = "idea_033007";
 ...
 */
@Slf4j
public class Idea33007Service {
    private static final int IDEA_ID = 33007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33007Service() {
        this(new Idea33007Config());
    }

    public Idea33007Service(Idea33007Config config) {
        this.config = config != null ? config : new Idea33007Config();
