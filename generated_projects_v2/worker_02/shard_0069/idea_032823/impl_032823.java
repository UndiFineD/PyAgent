...
@Data
public class Idea32823Config {
    private String name = "idea_032823";
 ...
 */
@Slf4j
public class Idea32823Service {
    private static final int IDEA_ID = 32823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32823Service() {
        this(new Idea32823Config());
    }

    public Idea32823Service(Idea32823Config config) {
        this.config = config != null ? config : new Idea32823Config();
