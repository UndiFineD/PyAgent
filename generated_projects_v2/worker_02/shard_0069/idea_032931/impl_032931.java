...
@Data
public class Idea32931Config {
    private String name = "idea_032931";
 ...
 */
@Slf4j
public class Idea32931Service {
    private static final int IDEA_ID = 32931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32931Service() {
        this(new Idea32931Config());
    }

    public Idea32931Service(Idea32931Config config) {
        this.config = config != null ? config : new Idea32931Config();
