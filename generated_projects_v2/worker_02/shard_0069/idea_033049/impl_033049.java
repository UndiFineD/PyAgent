...
@Data
public class Idea33049Config {
    private String name = "idea_033049";
 ...
 */
@Slf4j
public class Idea33049Service {
    private static final int IDEA_ID = 33049;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33049Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33049Service() {
        this(new Idea33049Config());
    }

    public Idea33049Service(Idea33049Config config) {
        this.config = config != null ? config : new Idea33049Config();
