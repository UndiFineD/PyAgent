...
@Data
public class Idea33160Config {
    private String name = "idea_033160";
 ...
 */
@Slf4j
public class Idea33160Service {
    private static final int IDEA_ID = 33160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33160Service() {
        this(new Idea33160Config());
    }

    public Idea33160Service(Idea33160Config config) {
        this.config = config != null ? config : new Idea33160Config();
