...
@Data
public class Idea33164Config {
    private String name = "idea_033164";
 ...
 */
@Slf4j
public class Idea33164Service {
    private static final int IDEA_ID = 33164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33164Service() {
        this(new Idea33164Config());
    }

    public Idea33164Service(Idea33164Config config) {
        this.config = config != null ? config : new Idea33164Config();
