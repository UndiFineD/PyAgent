...
@Data
public class Idea32947Config {
    private String name = "idea_032947";
 ...
 */
@Slf4j
public class Idea32947Service {
    private static final int IDEA_ID = 32947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32947Service() {
        this(new Idea32947Config());
    }

    public Idea32947Service(Idea32947Config config) {
        this.config = config != null ? config : new Idea32947Config();
