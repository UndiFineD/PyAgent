...
@Data
public class Idea32988Config {
    private String name = "idea_032988";
 ...
 */
@Slf4j
public class Idea32988Service {
    private static final int IDEA_ID = 32988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32988Service() {
        this(new Idea32988Config());
    }

    public Idea32988Service(Idea32988Config config) {
        this.config = config != null ? config : new Idea32988Config();
