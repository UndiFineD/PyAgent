...
@Data
public class Idea32938Config {
    private String name = "idea_032938";
 ...
 */
@Slf4j
public class Idea32938Service {
    private static final int IDEA_ID = 32938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32938Service() {
        this(new Idea32938Config());
    }

    public Idea32938Service(Idea32938Config config) {
        this.config = config != null ? config : new Idea32938Config();
