...
@Data
public class Idea33166Config {
    private String name = "idea_033166";
 ...
 */
@Slf4j
public class Idea33166Service {
    private static final int IDEA_ID = 33166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33166Service() {
        this(new Idea33166Config());
    }

    public Idea33166Service(Idea33166Config config) {
        this.config = config != null ? config : new Idea33166Config();
