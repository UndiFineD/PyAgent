...
@Data
public class Idea32776Config {
    private String name = "idea_032776";
 ...
 */
@Slf4j
public class Idea32776Service {
    private static final int IDEA_ID = 32776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32776Service() {
        this(new Idea32776Config());
    }

    public Idea32776Service(Idea32776Config config) {
        this.config = config != null ? config : new Idea32776Config();
