...
@Data
public class Idea33008Config {
    private String name = "idea_033008";
 ...
 */
@Slf4j
public class Idea33008Service {
    private static final int IDEA_ID = 33008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33008Service() {
        this(new Idea33008Config());
    }

    public Idea33008Service(Idea33008Config config) {
        this.config = config != null ? config : new Idea33008Config();
