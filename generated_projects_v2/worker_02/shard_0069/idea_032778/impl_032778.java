...
@Data
public class Idea32778Config {
    private String name = "idea_032778";
 ...
 */
@Slf4j
public class Idea32778Service {
    private static final int IDEA_ID = 32778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32778Service() {
        this(new Idea32778Config());
    }

    public Idea32778Service(Idea32778Config config) {
        this.config = config != null ? config : new Idea32778Config();
