...
@Data
public class Idea33044Config {
    private String name = "idea_033044";
 ...
 */
@Slf4j
public class Idea33044Service {
    private static final int IDEA_ID = 33044;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33044Service() {
        this(new Idea33044Config());
    }

    public Idea33044Service(Idea33044Config config) {
        this.config = config != null ? config : new Idea33044Config();
