...
@Data
public class Idea32908Config {
    private String name = "idea_032908";
 ...
 */
@Slf4j
public class Idea32908Service {
    private static final int IDEA_ID = 32908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32908Service() {
        this(new Idea32908Config());
    }

    public Idea32908Service(Idea32908Config config) {
        this.config = config != null ? config : new Idea32908Config();
