...
@Data
public class Idea33137Config {
    private String name = "idea_033137";
 ...
 */
@Slf4j
public class Idea33137Service {
    private static final int IDEA_ID = 33137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33137Service() {
        this(new Idea33137Config());
    }

    public Idea33137Service(Idea33137Config config) {
        this.config = config != null ? config : new Idea33137Config();
