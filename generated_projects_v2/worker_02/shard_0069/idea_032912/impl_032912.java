...
@Data
public class Idea32912Config {
    private String name = "idea_032912";
 ...
 */
@Slf4j
public class Idea32912Service {
    private static final int IDEA_ID = 32912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32912Service() {
        this(new Idea32912Config());
    }

    public Idea32912Service(Idea32912Config config) {
        this.config = config != null ? config : new Idea32912Config();
