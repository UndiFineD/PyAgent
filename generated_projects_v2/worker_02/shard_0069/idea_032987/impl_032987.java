...
@Data
public class Idea32987Config {
    private String name = "idea_032987";
 ...
 */
@Slf4j
public class Idea32987Service {
    private static final int IDEA_ID = 32987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32987Service() {
        this(new Idea32987Config());
    }

    public Idea32987Service(Idea32987Config config) {
        this.config = config != null ? config : new Idea32987Config();
