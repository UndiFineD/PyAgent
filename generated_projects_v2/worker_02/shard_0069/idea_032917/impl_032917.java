...
@Data
public class Idea32917Config {
    private String name = "idea_032917";
 ...
 */
@Slf4j
public class Idea32917Service {
    private static final int IDEA_ID = 32917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32917Service() {
        this(new Idea32917Config());
    }

    public Idea32917Service(Idea32917Config config) {
        this.config = config != null ? config : new Idea32917Config();
