...
@Data
public class Idea33178Config {
    private String name = "idea_033178";
 ...
 */
@Slf4j
public class Idea33178Service {
    private static final int IDEA_ID = 33178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33178Service() {
        this(new Idea33178Config());
    }

    public Idea33178Service(Idea33178Config config) {
        this.config = config != null ? config : new Idea33178Config();
