...
@Data
public class Idea32923Config {
    private String name = "idea_032923";
 ...
 */
@Slf4j
public class Idea32923Service {
    private static final int IDEA_ID = 32923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32923Service() {
        this(new Idea32923Config());
    }

    public Idea32923Service(Idea32923Config config) {
        this.config = config != null ? config : new Idea32923Config();
