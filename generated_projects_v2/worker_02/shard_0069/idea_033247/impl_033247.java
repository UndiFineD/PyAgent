...
@Data
public class Idea33247Config {
    private String name = "idea_033247";
 ...
 */
@Slf4j
public class Idea33247Service {
    private static final int IDEA_ID = 33247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33247Service() {
        this(new Idea33247Config());
    }

    public Idea33247Service(Idea33247Config config) {
        this.config = config != null ? config : new Idea33247Config();
