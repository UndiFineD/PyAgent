...
@Data
public class Idea33215Config {
    private String name = "idea_033215";
 ...
 */
@Slf4j
public class Idea33215Service {
    private static final int IDEA_ID = 33215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33215Service() {
        this(new Idea33215Config());
    }

    public Idea33215Service(Idea33215Config config) {
        this.config = config != null ? config : new Idea33215Config();
