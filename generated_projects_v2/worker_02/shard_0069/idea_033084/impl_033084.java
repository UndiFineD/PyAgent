...
@Data
public class Idea33084Config {
    private String name = "idea_033084";
 ...
 */
@Slf4j
public class Idea33084Service {
    private static final int IDEA_ID = 33084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33084Service() {
        this(new Idea33084Config());
    }

    public Idea33084Service(Idea33084Config config) {
        this.config = config != null ? config : new Idea33084Config();
