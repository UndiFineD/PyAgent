...
@Data
public class Idea32906Config {
    private String name = "idea_032906";
 ...
 */
@Slf4j
public class Idea32906Service {
    private static final int IDEA_ID = 32906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32906Service() {
        this(new Idea32906Config());
    }

    public Idea32906Service(Idea32906Config config) {
        this.config = config != null ? config : new Idea32906Config();
