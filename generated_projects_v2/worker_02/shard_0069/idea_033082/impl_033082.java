...
@Data
public class Idea33082Config {
    private String name = "idea_033082";
 ...
 */
@Slf4j
public class Idea33082Service {
    private static final int IDEA_ID = 33082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33082Service() {
        this(new Idea33082Config());
    }

    public Idea33082Service(Idea33082Config config) {
        this.config = config != null ? config : new Idea33082Config();
