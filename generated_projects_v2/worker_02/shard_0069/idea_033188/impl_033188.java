...
@Data
public class Idea33188Config {
    private String name = "idea_033188";
 ...
 */
@Slf4j
public class Idea33188Service {
    private static final int IDEA_ID = 33188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33188Service() {
        this(new Idea33188Config());
    }

    public Idea33188Service(Idea33188Config config) {
        this.config = config != null ? config : new Idea33188Config();
