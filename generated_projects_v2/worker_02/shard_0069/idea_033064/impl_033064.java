...
@Data
public class Idea33064Config {
    private String name = "idea_033064";
 ...
 */
@Slf4j
public class Idea33064Service {
    private static final int IDEA_ID = 33064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33064Service() {
        this(new Idea33064Config());
    }

    public Idea33064Service(Idea33064Config config) {
        this.config = config != null ? config : new Idea33064Config();
