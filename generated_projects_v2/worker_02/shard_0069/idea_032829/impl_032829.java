...
@Data
public class Idea32829Config {
    private String name = "idea_032829";
 ...
 */
@Slf4j
public class Idea32829Service {
    private static final int IDEA_ID = 32829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32829Service() {
        this(new Idea32829Config());
    }

    public Idea32829Service(Idea32829Config config) {
        this.config = config != null ? config : new Idea32829Config();
