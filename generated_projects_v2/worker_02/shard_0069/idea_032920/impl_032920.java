...
@Data
public class Idea32920Config {
    private String name = "idea_032920";
 ...
 */
@Slf4j
public class Idea32920Service {
    private static final int IDEA_ID = 32920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32920Service() {
        this(new Idea32920Config());
    }

    public Idea32920Service(Idea32920Config config) {
        this.config = config != null ? config : new Idea32920Config();
