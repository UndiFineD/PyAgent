...
@Data
public class Idea33108Config {
    private String name = "idea_033108";
 ...
 */
@Slf4j
public class Idea33108Service {
    private static final int IDEA_ID = 33108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33108Service() {
        this(new Idea33108Config());
    }

    public Idea33108Service(Idea33108Config config) {
        this.config = config != null ? config : new Idea33108Config();
