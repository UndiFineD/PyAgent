...
@Data
public class Idea33235Config {
    private String name = "idea_033235";
 ...
 */
@Slf4j
public class Idea33235Service {
    private static final int IDEA_ID = 33235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33235Service() {
        this(new Idea33235Config());
    }

    public Idea33235Service(Idea33235Config config) {
        this.config = config != null ? config : new Idea33235Config();
