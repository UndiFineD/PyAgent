...
@Data
public class Idea33042Config {
    private String name = "idea_033042";
 ...
 */
@Slf4j
public class Idea33042Service {
    private static final int IDEA_ID = 33042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33042Service() {
        this(new Idea33042Config());
    }

    public Idea33042Service(Idea33042Config config) {
        this.config = config != null ? config : new Idea33042Config();
