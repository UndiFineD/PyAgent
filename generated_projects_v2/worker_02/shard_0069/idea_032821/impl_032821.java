...
@Data
public class Idea32821Config {
    private String name = "idea_032821";
 ...
 */
@Slf4j
public class Idea32821Service {
    private static final int IDEA_ID = 32821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32821Service() {
        this(new Idea32821Config());
    }

    public Idea32821Service(Idea32821Config config) {
        this.config = config != null ? config : new Idea32821Config();
