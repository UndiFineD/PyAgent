...
@Data
public class Idea32802Config {
    private String name = "idea_032802";
 ...
 */
@Slf4j
public class Idea32802Service {
    private static final int IDEA_ID = 32802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32802Service() {
        this(new Idea32802Config());
    }

    public Idea32802Service(Idea32802Config config) {
        this.config = config != null ? config : new Idea32802Config();
