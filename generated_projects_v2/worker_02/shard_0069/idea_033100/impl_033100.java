...
@Data
public class Idea33100Config {
    private String name = "idea_033100";
 ...
 */
@Slf4j
public class Idea33100Service {
    private static final int IDEA_ID = 33100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33100Service() {
        this(new Idea33100Config());
    }

    public Idea33100Service(Idea33100Config config) {
        this.config = config != null ? config : new Idea33100Config();
