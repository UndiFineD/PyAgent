...
@Data
public class Idea33056Config {
    private String name = "idea_033056";
 ...
 */
@Slf4j
public class Idea33056Service {
    private static final int IDEA_ID = 33056;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33056Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33056Service() {
        this(new Idea33056Config());
    }

    public Idea33056Service(Idea33056Config config) {
        this.config = config != null ? config : new Idea33056Config();
