...
@Data
public class Idea33062Config {
    private String name = "idea_033062";
 ...
 */
@Slf4j
public class Idea33062Service {
    private static final int IDEA_ID = 33062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33062Service() {
        this(new Idea33062Config());
    }

    public Idea33062Service(Idea33062Config config) {
        this.config = config != null ? config : new Idea33062Config();
