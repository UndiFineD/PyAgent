...
@Data
public class Idea33210Config {
    private String name = "idea_033210";
 ...
 */
@Slf4j
public class Idea33210Service {
    private static final int IDEA_ID = 33210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33210Service() {
        this(new Idea33210Config());
    }

    public Idea33210Service(Idea33210Config config) {
        this.config = config != null ? config : new Idea33210Config();
