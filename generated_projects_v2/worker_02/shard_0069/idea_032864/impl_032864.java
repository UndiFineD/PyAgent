...
@Data
public class Idea32864Config {
    private String name = "idea_032864";
 ...
 */
@Slf4j
public class Idea32864Service {
    private static final int IDEA_ID = 32864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32864Service() {
        this(new Idea32864Config());
    }

    public Idea32864Service(Idea32864Config config) {
        this.config = config != null ? config : new Idea32864Config();
