...
@Data
public class Idea33088Config {
    private String name = "idea_033088";
 ...
 */
@Slf4j
public class Idea33088Service {
    private static final int IDEA_ID = 33088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33088Service() {
        this(new Idea33088Config());
    }

    public Idea33088Service(Idea33088Config config) {
        this.config = config != null ? config : new Idea33088Config();
