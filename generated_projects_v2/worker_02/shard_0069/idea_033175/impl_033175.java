...
@Data
public class Idea33175Config {
    private String name = "idea_033175";
 ...
 */
@Slf4j
public class Idea33175Service {
    private static final int IDEA_ID = 33175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33175Service() {
        this(new Idea33175Config());
    }

    public Idea33175Service(Idea33175Config config) {
        this.config = config != null ? config : new Idea33175Config();
