...
@Data
public class Idea32976Config {
    private String name = "idea_032976";
 ...
 */
@Slf4j
public class Idea32976Service {
    private static final int IDEA_ID = 32976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32976Service() {
        this(new Idea32976Config());
    }

    public Idea32976Service(Idea32976Config config) {
        this.config = config != null ? config : new Idea32976Config();
