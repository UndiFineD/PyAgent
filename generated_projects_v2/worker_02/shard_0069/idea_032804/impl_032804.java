...
@Data
public class Idea32804Config {
    private String name = "idea_032804";
 ...
 */
@Slf4j
public class Idea32804Service {
    private static final int IDEA_ID = 32804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32804Service() {
        this(new Idea32804Config());
    }

    public Idea32804Service(Idea32804Config config) {
        this.config = config != null ? config : new Idea32804Config();
