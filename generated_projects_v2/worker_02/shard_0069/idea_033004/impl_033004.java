...
@Data
public class Idea33004Config {
    private String name = "idea_033004";
 ...
 */
@Slf4j
public class Idea33004Service {
    private static final int IDEA_ID = 33004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33004Service() {
        this(new Idea33004Config());
    }

    public Idea33004Service(Idea33004Config config) {
        this.config = config != null ? config : new Idea33004Config();
