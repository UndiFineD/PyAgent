...
@Data
public class Idea32995Config {
    private String name = "idea_032995";
 ...
 */
@Slf4j
public class Idea32995Service {
    private static final int IDEA_ID = 32995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32995Service() {
        this(new Idea32995Config());
    }

    public Idea32995Service(Idea32995Config config) {
        this.config = config != null ? config : new Idea32995Config();
