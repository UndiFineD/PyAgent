...
@Data
public class Idea33185Config {
    private String name = "idea_033185";
 ...
 */
@Slf4j
public class Idea33185Service {
    private static final int IDEA_ID = 33185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33185Service() {
        this(new Idea33185Config());
    }

    public Idea33185Service(Idea33185Config config) {
        this.config = config != null ? config : new Idea33185Config();
