...
@Data
public class Idea32852Config {
    private String name = "idea_032852";
 ...
 */
@Slf4j
public class Idea32852Service {
    private static final int IDEA_ID = 32852;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32852Service() {
        this(new Idea32852Config());
    }

    public Idea32852Service(Idea32852Config config) {
        this.config = config != null ? config : new Idea32852Config();
