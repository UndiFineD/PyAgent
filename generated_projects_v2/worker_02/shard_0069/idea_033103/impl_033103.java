...
@Data
public class Idea33103Config {
    private String name = "idea_033103";
 ...
 */
@Slf4j
public class Idea33103Service {
    private static final int IDEA_ID = 33103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33103Service() {
        this(new Idea33103Config());
    }

    public Idea33103Service(Idea33103Config config) {
        this.config = config != null ? config : new Idea33103Config();
