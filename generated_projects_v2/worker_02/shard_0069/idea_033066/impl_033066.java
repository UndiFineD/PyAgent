...
@Data
public class Idea33066Config {
    private String name = "idea_033066";
 ...
 */
@Slf4j
public class Idea33066Service {
    private static final int IDEA_ID = 33066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33066Service() {
        this(new Idea33066Config());
    }

    public Idea33066Service(Idea33066Config config) {
        this.config = config != null ? config : new Idea33066Config();
