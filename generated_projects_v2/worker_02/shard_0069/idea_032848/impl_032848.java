...
@Data
public class Idea32848Config {
    private String name = "idea_032848";
 ...
 */
@Slf4j
public class Idea32848Service {
    private static final int IDEA_ID = 32848;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32848Service() {
        this(new Idea32848Config());
    }

    public Idea32848Service(Idea32848Config config) {
        this.config = config != null ? config : new Idea32848Config();
