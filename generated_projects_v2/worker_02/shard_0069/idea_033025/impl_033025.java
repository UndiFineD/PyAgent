...
@Data
public class Idea33025Config {
    private String name = "idea_033025";
 ...
 */
@Slf4j
public class Idea33025Service {
    private static final int IDEA_ID = 33025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33025Service() {
        this(new Idea33025Config());
    }

    public Idea33025Service(Idea33025Config config) {
        this.config = config != null ? config : new Idea33025Config();
