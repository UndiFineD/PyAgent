...
@Data
public class Idea32800Config {
    private String name = "idea_032800";
 ...
 */
@Slf4j
public class Idea32800Service {
    private static final int IDEA_ID = 32800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32800Service() {
        this(new Idea32800Config());
    }

    public Idea32800Service(Idea32800Config config) {
        this.config = config != null ? config : new Idea32800Config();
