...
@Data
public class Idea32902Config {
    private String name = "idea_032902";
 ...
 */
@Slf4j
public class Idea32902Service {
    private static final int IDEA_ID = 32902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32902Service() {
        this(new Idea32902Config());
    }

    public Idea32902Service(Idea32902Config config) {
        this.config = config != null ? config : new Idea32902Config();
