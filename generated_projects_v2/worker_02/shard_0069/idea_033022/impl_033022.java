...
@Data
public class Idea33022Config {
    private String name = "idea_033022";
 ...
 */
@Slf4j
public class Idea33022Service {
    private static final int IDEA_ID = 33022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33022Service() {
        this(new Idea33022Config());
    }

    public Idea33022Service(Idea33022Config config) {
        this.config = config != null ? config : new Idea33022Config();
