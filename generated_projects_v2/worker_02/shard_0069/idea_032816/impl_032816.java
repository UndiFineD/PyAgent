...
@Data
public class Idea32816Config {
    private String name = "idea_032816";
 ...
 */
@Slf4j
public class Idea32816Service {
    private static final int IDEA_ID = 32816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32816Service() {
        this(new Idea32816Config());
    }

    public Idea32816Service(Idea32816Config config) {
        this.config = config != null ? config : new Idea32816Config();
