...
@Data
public class Idea33019Config {
    private String name = "idea_033019";
 ...
 */
@Slf4j
public class Idea33019Service {
    private static final int IDEA_ID = 33019;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33019Service() {
        this(new Idea33019Config());
    }

    public Idea33019Service(Idea33019Config config) {
        this.config = config != null ? config : new Idea33019Config();
