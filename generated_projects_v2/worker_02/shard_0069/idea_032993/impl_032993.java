...
@Data
public class Idea32993Config {
    private String name = "idea_032993";
 ...
 */
@Slf4j
public class Idea32993Service {
    private static final int IDEA_ID = 32993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32993Service() {
        this(new Idea32993Config());
    }

    public Idea32993Service(Idea32993Config config) {
        this.config = config != null ? config : new Idea32993Config();
