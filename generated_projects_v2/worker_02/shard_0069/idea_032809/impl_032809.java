...
@Data
public class Idea32809Config {
    private String name = "idea_032809";
 ...
 */
@Slf4j
public class Idea32809Service {
    private static final int IDEA_ID = 32809;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32809Service() {
        this(new Idea32809Config());
    }

    public Idea32809Service(Idea32809Config config) {
        this.config = config != null ? config : new Idea32809Config();
