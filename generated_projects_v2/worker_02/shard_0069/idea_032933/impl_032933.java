...
@Data
public class Idea32933Config {
    private String name = "idea_032933";
 ...
 */
@Slf4j
public class Idea32933Service {
    private static final int IDEA_ID = 32933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32933Service() {
        this(new Idea32933Config());
    }

    public Idea32933Service(Idea32933Config config) {
        this.config = config != null ? config : new Idea32933Config();
