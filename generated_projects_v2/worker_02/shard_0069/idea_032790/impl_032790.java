...
@Data
public class Idea32790Config {
    private String name = "idea_032790";
 ...
 */
@Slf4j
public class Idea32790Service {
    private static final int IDEA_ID = 32790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32790Service() {
        this(new Idea32790Config());
    }

    public Idea32790Service(Idea32790Config config) {
        this.config = config != null ? config : new Idea32790Config();
