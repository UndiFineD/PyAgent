...
@Data
public class Idea33095Config {
    private String name = "idea_033095";
 ...
 */
@Slf4j
public class Idea33095Service {
    private static final int IDEA_ID = 33095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33095Service() {
        this(new Idea33095Config());
    }

    public Idea33095Service(Idea33095Config config) {
        this.config = config != null ? config : new Idea33095Config();
