...
@Data
public class Idea33026Config {
    private String name = "idea_033026";
 ...
 */
@Slf4j
public class Idea33026Service {
    private static final int IDEA_ID = 33026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33026Service() {
        this(new Idea33026Config());
    }

    public Idea33026Service(Idea33026Config config) {
        this.config = config != null ? config : new Idea33026Config();
