...
@Data
public class Idea33202Config {
    private String name = "idea_033202";
 ...
 */
@Slf4j
public class Idea33202Service {
    private static final int IDEA_ID = 33202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33202Service() {
        this(new Idea33202Config());
    }

    public Idea33202Service(Idea33202Config config) {
        this.config = config != null ? config : new Idea33202Config();
