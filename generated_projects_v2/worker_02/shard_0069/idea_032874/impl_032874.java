...
@Data
public class Idea32874Config {
    private String name = "idea_032874";
 ...
 */
@Slf4j
public class Idea32874Service {
    private static final int IDEA_ID = 32874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32874Service() {
        this(new Idea32874Config());
    }

    public Idea32874Service(Idea32874Config config) {
        this.config = config != null ? config : new Idea32874Config();
