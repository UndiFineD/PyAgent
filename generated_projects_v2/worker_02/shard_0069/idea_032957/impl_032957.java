...
@Data
public class Idea32957Config {
    private String name = "idea_032957";
 ...
 */
@Slf4j
public class Idea32957Service {
    private static final int IDEA_ID = 32957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32957Service() {
        this(new Idea32957Config());
    }

    public Idea32957Service(Idea32957Config config) {
        this.config = config != null ? config : new Idea32957Config();
