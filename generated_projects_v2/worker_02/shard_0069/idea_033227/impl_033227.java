...
@Data
public class Idea33227Config {
    private String name = "idea_033227";
 ...
 */
@Slf4j
public class Idea33227Service {
    private static final int IDEA_ID = 33227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33227Service() {
        this(new Idea33227Config());
    }

    public Idea33227Service(Idea33227Config config) {
        this.config = config != null ? config : new Idea33227Config();
