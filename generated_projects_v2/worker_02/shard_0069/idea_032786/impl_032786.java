...
@Data
public class Idea32786Config {
    private String name = "idea_032786";
 ...
 */
@Slf4j
public class Idea32786Service {
    private static final int IDEA_ID = 32786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32786Service() {
        this(new Idea32786Config());
    }

    public Idea32786Service(Idea32786Config config) {
        this.config = config != null ? config : new Idea32786Config();
