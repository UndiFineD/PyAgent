...
@Data
public class Idea32860Config {
    private String name = "idea_032860";
 ...
 */
@Slf4j
public class Idea32860Service {
    private static final int IDEA_ID = 32860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32860Service() {
        this(new Idea32860Config());
    }

    public Idea32860Service(Idea32860Config config) {
        this.config = config != null ? config : new Idea32860Config();
