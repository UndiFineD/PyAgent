...
@Data
public class Idea33110Config {
    private String name = "idea_033110";
 ...
 */
@Slf4j
public class Idea33110Service {
    private static final int IDEA_ID = 33110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33110Service() {
        this(new Idea33110Config());
    }

    public Idea33110Service(Idea33110Config config) {
        this.config = config != null ? config : new Idea33110Config();
