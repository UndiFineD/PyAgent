...
@Data
public class Idea33187Config {
    private String name = "idea_033187";
 ...
 */
@Slf4j
public class Idea33187Service {
    private static final int IDEA_ID = 33187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33187Service() {
        this(new Idea33187Config());
    }

    public Idea33187Service(Idea33187Config config) {
        this.config = config != null ? config : new Idea33187Config();
