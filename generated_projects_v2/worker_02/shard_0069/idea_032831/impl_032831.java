...
@Data
public class Idea32831Config {
    private String name = "idea_032831";
 ...
 */
@Slf4j
public class Idea32831Service {
    private static final int IDEA_ID = 32831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32831Service() {
        this(new Idea32831Config());
    }

    public Idea32831Service(Idea32831Config config) {
        this.config = config != null ? config : new Idea32831Config();
