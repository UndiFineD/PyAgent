...
@Data
public class Idea33248Config {
    private String name = "idea_033248";
 ...
 */
@Slf4j
public class Idea33248Service {
    private static final int IDEA_ID = 33248;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33248Service() {
        this(new Idea33248Config());
    }

    public Idea33248Service(Idea33248Config config) {
        this.config = config != null ? config : new Idea33248Config();
