...
@Data
public class Idea33060Config {
    private String name = "idea_033060";
 ...
 */
@Slf4j
public class Idea33060Service {
    private static final int IDEA_ID = 33060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33060Service() {
        this(new Idea33060Config());
    }

    public Idea33060Service(Idea33060Config config) {
        this.config = config != null ? config : new Idea33060Config();
