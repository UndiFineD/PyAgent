...
@Data
public class Idea33223Config {
    private String name = "idea_033223";
 ...
 */
@Slf4j
public class Idea33223Service {
    private static final int IDEA_ID = 33223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33223Service() {
        this(new Idea33223Config());
    }

    public Idea33223Service(Idea33223Config config) {
        this.config = config != null ? config : new Idea33223Config();
