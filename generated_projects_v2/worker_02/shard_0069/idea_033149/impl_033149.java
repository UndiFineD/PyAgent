...
@Data
public class Idea33149Config {
    private String name = "idea_033149";
 ...
 */
@Slf4j
public class Idea33149Service {
    private static final int IDEA_ID = 33149;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33149Service() {
        this(new Idea33149Config());
    }

    public Idea33149Service(Idea33149Config config) {
        this.config = config != null ? config : new Idea33149Config();
