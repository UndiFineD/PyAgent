...
@Data
public class Idea32871Config {
    private String name = "idea_032871";
 ...
 */
@Slf4j
public class Idea32871Service {
    private static final int IDEA_ID = 32871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32871Service() {
        this(new Idea32871Config());
    }

    public Idea32871Service(Idea32871Config config) {
        this.config = config != null ? config : new Idea32871Config();
