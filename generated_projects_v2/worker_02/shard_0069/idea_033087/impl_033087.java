...
@Data
public class Idea33087Config {
    private String name = "idea_033087";
 ...
 */
@Slf4j
public class Idea33087Service {
    private static final int IDEA_ID = 33087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33087Service() {
        this(new Idea33087Config());
    }

    public Idea33087Service(Idea33087Config config) {
        this.config = config != null ? config : new Idea33087Config();
