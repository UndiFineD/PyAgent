...
@Data
public class Idea33005Config {
    private String name = "idea_033005";
 ...
 */
@Slf4j
public class Idea33005Service {
    private static final int IDEA_ID = 33005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33005Service() {
        this(new Idea33005Config());
    }

    public Idea33005Service(Idea33005Config config) {
        this.config = config != null ? config : new Idea33005Config();
