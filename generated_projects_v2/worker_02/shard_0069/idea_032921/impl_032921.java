...
@Data
public class Idea32921Config {
    private String name = "idea_032921";
 ...
 */
@Slf4j
public class Idea32921Service {
    private static final int IDEA_ID = 32921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32921Service() {
        this(new Idea32921Config());
    }

    public Idea32921Service(Idea32921Config config) {
        this.config = config != null ? config : new Idea32921Config();
