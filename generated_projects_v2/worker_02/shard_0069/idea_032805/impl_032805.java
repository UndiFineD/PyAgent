...
@Data
public class Idea32805Config {
    private String name = "idea_032805";
 ...
 */
@Slf4j
public class Idea32805Service {
    private static final int IDEA_ID = 32805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32805Service() {
        this(new Idea32805Config());
    }

    public Idea32805Service(Idea32805Config config) {
        this.config = config != null ? config : new Idea32805Config();
