...
@Data
public class Idea32834Config {
    private String name = "idea_032834";
 ...
 */
@Slf4j
public class Idea32834Service {
    private static final int IDEA_ID = 32834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32834Service() {
        this(new Idea32834Config());
    }

    public Idea32834Service(Idea32834Config config) {
        this.config = config != null ? config : new Idea32834Config();
