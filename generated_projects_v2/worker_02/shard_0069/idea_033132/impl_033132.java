...
@Data
public class Idea33132Config {
    private String name = "idea_033132";
 ...
 */
@Slf4j
public class Idea33132Service {
    private static final int IDEA_ID = 33132;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33132Service() {
        this(new Idea33132Config());
    }

    public Idea33132Service(Idea33132Config config) {
        this.config = config != null ? config : new Idea33132Config();
