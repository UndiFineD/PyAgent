...
@Data
public class Idea32873Config {
    private String name = "idea_032873";
 ...
 */
@Slf4j
public class Idea32873Service {
    private static final int IDEA_ID = 32873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32873Service() {
        this(new Idea32873Config());
    }

    public Idea32873Service(Idea32873Config config) {
        this.config = config != null ? config : new Idea32873Config();
