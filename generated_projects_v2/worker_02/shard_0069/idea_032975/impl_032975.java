...
@Data
public class Idea32975Config {
    private String name = "idea_032975";
 ...
 */
@Slf4j
public class Idea32975Service {
    private static final int IDEA_ID = 32975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32975Service() {
        this(new Idea32975Config());
    }

    public Idea32975Service(Idea32975Config config) {
        this.config = config != null ? config : new Idea32975Config();
