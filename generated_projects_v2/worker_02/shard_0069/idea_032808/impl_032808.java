...
@Data
public class Idea32808Config {
    private String name = "idea_032808";
 ...
 */
@Slf4j
public class Idea32808Service {
    private static final int IDEA_ID = 32808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32808Service() {
        this(new Idea32808Config());
    }

    public Idea32808Service(Idea32808Config config) {
        this.config = config != null ? config : new Idea32808Config();
