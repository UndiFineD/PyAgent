...
@Data
public class Idea33198Config {
    private String name = "idea_033198";
 ...
 */
@Slf4j
public class Idea33198Service {
    private static final int IDEA_ID = 33198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33198Service() {
        this(new Idea33198Config());
    }

    public Idea33198Service(Idea33198Config config) {
        this.config = config != null ? config : new Idea33198Config();
