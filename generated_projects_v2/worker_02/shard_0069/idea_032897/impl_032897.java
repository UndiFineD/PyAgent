...
@Data
public class Idea32897Config {
    private String name = "idea_032897";
 ...
 */
@Slf4j
public class Idea32897Service {
    private static final int IDEA_ID = 32897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32897Service() {
        this(new Idea32897Config());
    }

    public Idea32897Service(Idea32897Config config) {
        this.config = config != null ? config : new Idea32897Config();
