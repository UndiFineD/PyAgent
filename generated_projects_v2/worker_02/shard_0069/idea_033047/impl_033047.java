...
@Data
public class Idea33047Config {
    private String name = "idea_033047";
 ...
 */
@Slf4j
public class Idea33047Service {
    private static final int IDEA_ID = 33047;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33047Service() {
        this(new Idea33047Config());
    }

    public Idea33047Service(Idea33047Config config) {
        this.config = config != null ? config : new Idea33047Config();
