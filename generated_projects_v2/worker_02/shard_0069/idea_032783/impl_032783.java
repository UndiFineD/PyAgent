...
@Data
public class Idea32783Config {
    private String name = "idea_032783";
 ...
 */
@Slf4j
public class Idea32783Service {
    private static final int IDEA_ID = 32783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32783Service() {
        this(new Idea32783Config());
    }

    public Idea32783Service(Idea32783Config config) {
        this.config = config != null ? config : new Idea32783Config();
