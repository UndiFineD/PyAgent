...
@Data
public class Idea32971Config {
    private String name = "idea_032971";
 ...
 */
@Slf4j
public class Idea32971Service {
    private static final int IDEA_ID = 32971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32971Service() {
        this(new Idea32971Config());
    }

    public Idea32971Service(Idea32971Config config) {
        this.config = config != null ? config : new Idea32971Config();
