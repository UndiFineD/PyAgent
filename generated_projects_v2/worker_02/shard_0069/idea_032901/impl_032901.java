...
@Data
public class Idea32901Config {
    private String name = "idea_032901";
 ...
 */
@Slf4j
public class Idea32901Service {
    private static final int IDEA_ID = 32901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32901Service() {
        this(new Idea32901Config());
    }

    public Idea32901Service(Idea32901Config config) {
        this.config = config != null ? config : new Idea32901Config();
