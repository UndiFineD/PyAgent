...
@Data
public class Idea32910Config {
    private String name = "idea_032910";
 ...
 */
@Slf4j
public class Idea32910Service {
    private static final int IDEA_ID = 32910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32910Service() {
        this(new Idea32910Config());
    }

    public Idea32910Service(Idea32910Config config) {
        this.config = config != null ? config : new Idea32910Config();
