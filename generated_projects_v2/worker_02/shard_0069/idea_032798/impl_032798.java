...
@Data
public class Idea32798Config {
    private String name = "idea_032798";
 ...
 */
@Slf4j
public class Idea32798Service {
    private static final int IDEA_ID = 32798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32798Service() {
        this(new Idea32798Config());
    }

    public Idea32798Service(Idea32798Config config) {
        this.config = config != null ? config : new Idea32798Config();
