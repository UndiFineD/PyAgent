...
@Data
public class Idea32936Config {
    private String name = "idea_032936";
 ...
 */
@Slf4j
public class Idea32936Service {
    private static final int IDEA_ID = 32936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32936Service() {
        this(new Idea32936Config());
    }

    public Idea32936Service(Idea32936Config config) {
        this.config = config != null ? config : new Idea32936Config();
