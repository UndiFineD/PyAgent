...
@Data
public class Idea32982Config {
    private String name = "idea_032982";
 ...
 */
@Slf4j
public class Idea32982Service {
    private static final int IDEA_ID = 32982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32982Service() {
        this(new Idea32982Config());
    }

    public Idea32982Service(Idea32982Config config) {
        this.config = config != null ? config : new Idea32982Config();
