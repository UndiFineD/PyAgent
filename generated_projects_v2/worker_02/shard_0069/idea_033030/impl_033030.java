...
@Data
public class Idea33030Config {
    private String name = "idea_033030";
 ...
 */
@Slf4j
public class Idea33030Service {
    private static final int IDEA_ID = 33030;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33030Service() {
        this(new Idea33030Config());
    }

    public Idea33030Service(Idea33030Config config) {
        this.config = config != null ? config : new Idea33030Config();
