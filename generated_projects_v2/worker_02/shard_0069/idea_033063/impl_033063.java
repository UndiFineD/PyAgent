...
@Data
public class Idea33063Config {
    private String name = "idea_033063";
 ...
 */
@Slf4j
public class Idea33063Service {
    private static final int IDEA_ID = 33063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33063Service() {
        this(new Idea33063Config());
    }

    public Idea33063Service(Idea33063Config config) {
        this.config = config != null ? config : new Idea33063Config();
