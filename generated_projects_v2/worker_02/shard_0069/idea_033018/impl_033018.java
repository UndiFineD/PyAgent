...
@Data
public class Idea33018Config {
    private String name = "idea_033018";
 ...
 */
@Slf4j
public class Idea33018Service {
    private static final int IDEA_ID = 33018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33018Service() {
        this(new Idea33018Config());
    }

    public Idea33018Service(Idea33018Config config) {
        this.config = config != null ? config : new Idea33018Config();
