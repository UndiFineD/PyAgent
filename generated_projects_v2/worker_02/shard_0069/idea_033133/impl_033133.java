...
@Data
public class Idea33133Config {
    private String name = "idea_033133";
 ...
 */
@Slf4j
public class Idea33133Service {
    private static final int IDEA_ID = 33133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33133Service() {
        this(new Idea33133Config());
    }

    public Idea33133Service(Idea33133Config config) {
        this.config = config != null ? config : new Idea33133Config();
