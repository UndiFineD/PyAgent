...
@Data
public class Idea32841Config {
    private String name = "idea_032841";
 ...
 */
@Slf4j
public class Idea32841Service {
    private static final int IDEA_ID = 32841;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32841Service() {
        this(new Idea32841Config());
    }

    public Idea32841Service(Idea32841Config config) {
        this.config = config != null ? config : new Idea32841Config();
