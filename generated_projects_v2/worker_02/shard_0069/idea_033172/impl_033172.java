...
@Data
public class Idea33172Config {
    private String name = "idea_033172";
 ...
 */
@Slf4j
public class Idea33172Service {
    private static final int IDEA_ID = 33172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33172Service() {
        this(new Idea33172Config());
    }

    public Idea33172Service(Idea33172Config config) {
        this.config = config != null ? config : new Idea33172Config();
