...
@Data
public class Idea32869Config {
    private String name = "idea_032869";
 ...
 */
@Slf4j
public class Idea32869Service {
    private static final int IDEA_ID = 32869;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32869Service() {
        this(new Idea32869Config());
    }

    public Idea32869Service(Idea32869Config config) {
        this.config = config != null ? config : new Idea32869Config();
