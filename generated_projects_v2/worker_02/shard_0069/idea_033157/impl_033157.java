...
@Data
public class Idea33157Config {
    private String name = "idea_033157";
 ...
 */
@Slf4j
public class Idea33157Service {
    private static final int IDEA_ID = 33157;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33157Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33157Service() {
        this(new Idea33157Config());
    }

    public Idea33157Service(Idea33157Config config) {
        this.config = config != null ? config : new Idea33157Config();
