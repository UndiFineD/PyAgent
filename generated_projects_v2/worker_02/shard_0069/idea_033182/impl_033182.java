...
@Data
public class Idea33182Config {
    private String name = "idea_033182";
 ...
 */
@Slf4j
public class Idea33182Service {
    private static final int IDEA_ID = 33182;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33182Service() {
        this(new Idea33182Config());
    }

    public Idea33182Service(Idea33182Config config) {
        this.config = config != null ? config : new Idea33182Config();
