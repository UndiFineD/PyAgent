...
@Data
public class Idea32803Config {
    private String name = "idea_032803";
 ...
 */
@Slf4j
public class Idea32803Service {
    private static final int IDEA_ID = 32803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32803Service() {
        this(new Idea32803Config());
    }

    public Idea32803Service(Idea32803Config config) {
        this.config = config != null ? config : new Idea32803Config();
