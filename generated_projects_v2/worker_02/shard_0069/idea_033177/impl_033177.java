...
@Data
public class Idea33177Config {
    private String name = "idea_033177";
 ...
 */
@Slf4j
public class Idea33177Service {
    private static final int IDEA_ID = 33177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33177Service() {
        this(new Idea33177Config());
    }

    public Idea33177Service(Idea33177Config config) {
        this.config = config != null ? config : new Idea33177Config();
