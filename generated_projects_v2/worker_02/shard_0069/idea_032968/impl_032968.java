...
@Data
public class Idea32968Config {
    private String name = "idea_032968";
 ...
 */
@Slf4j
public class Idea32968Service {
    private static final int IDEA_ID = 32968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32968Service() {
        this(new Idea32968Config());
    }

    public Idea32968Service(Idea32968Config config) {
        this.config = config != null ? config : new Idea32968Config();
