...
@Data
public class Idea33203Config {
    private String name = "idea_033203";
 ...
 */
@Slf4j
public class Idea33203Service {
    private static final int IDEA_ID = 33203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33203Service() {
        this(new Idea33203Config());
    }

    public Idea33203Service(Idea33203Config config) {
        this.config = config != null ? config : new Idea33203Config();
