...
@Data
public class Idea33078Config {
    private String name = "idea_033078";
 ...
 */
@Slf4j
public class Idea33078Service {
    private static final int IDEA_ID = 33078;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33078Service() {
        this(new Idea33078Config());
    }

    public Idea33078Service(Idea33078Config config) {
        this.config = config != null ? config : new Idea33078Config();
