...
@Data
public class Idea32882Config {
    private String name = "idea_032882";
 ...
 */
@Slf4j
public class Idea32882Service {
    private static final int IDEA_ID = 32882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32882Service() {
        this(new Idea32882Config());
    }

    public Idea32882Service(Idea32882Config config) {
        this.config = config != null ? config : new Idea32882Config();
