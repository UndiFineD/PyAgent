...
@Data
public class Idea32944Config {
    private String name = "idea_032944";
 ...
 */
@Slf4j
public class Idea32944Service {
    private static final int IDEA_ID = 32944;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32944Service() {
        this(new Idea32944Config());
    }

    public Idea32944Service(Idea32944Config config) {
        this.config = config != null ? config : new Idea32944Config();
