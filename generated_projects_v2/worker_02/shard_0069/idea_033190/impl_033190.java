...
@Data
public class Idea33190Config {
    private String name = "idea_033190";
 ...
 */
@Slf4j
public class Idea33190Service {
    private static final int IDEA_ID = 33190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33190Service() {
        this(new Idea33190Config());
    }

    public Idea33190Service(Idea33190Config config) {
        this.config = config != null ? config : new Idea33190Config();
