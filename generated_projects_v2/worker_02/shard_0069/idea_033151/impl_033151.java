...
@Data
public class Idea33151Config {
    private String name = "idea_033151";
 ...
 */
@Slf4j
public class Idea33151Service {
    private static final int IDEA_ID = 33151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33151Service() {
        this(new Idea33151Config());
    }

    public Idea33151Service(Idea33151Config config) {
        this.config = config != null ? config : new Idea33151Config();
