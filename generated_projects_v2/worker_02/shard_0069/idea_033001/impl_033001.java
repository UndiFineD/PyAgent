...
@Data
public class Idea33001Config {
    private String name = "idea_033001";
 ...
 */
@Slf4j
public class Idea33001Service {
    private static final int IDEA_ID = 33001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33001Service() {
        this(new Idea33001Config());
    }

    public Idea33001Service(Idea33001Config config) {
        this.config = config != null ? config : new Idea33001Config();
