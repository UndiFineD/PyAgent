...
@Data
public class Idea33135Config {
    private String name = "idea_033135";
 ...
 */
@Slf4j
public class Idea33135Service {
    private static final int IDEA_ID = 33135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33135Service() {
        this(new Idea33135Config());
    }

    public Idea33135Service(Idea33135Config config) {
        this.config = config != null ? config : new Idea33135Config();
