...
@Data
public class Idea33032Config {
    private String name = "idea_033032";
 ...
 */
@Slf4j
public class Idea33032Service {
    private static final int IDEA_ID = 33032;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33032Service() {
        this(new Idea33032Config());
    }

    public Idea33032Service(Idea33032Config config) {
        this.config = config != null ? config : new Idea33032Config();
