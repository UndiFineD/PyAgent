...
@Data
public class Idea32824Config {
    private String name = "idea_032824";
 ...
 */
@Slf4j
public class Idea32824Service {
    private static final int IDEA_ID = 32824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32824Service() {
        this(new Idea32824Config());
    }

    public Idea32824Service(Idea32824Config config) {
        this.config = config != null ? config : new Idea32824Config();
