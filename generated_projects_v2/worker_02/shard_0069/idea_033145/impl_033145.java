...
@Data
public class Idea33145Config {
    private String name = "idea_033145";
 ...
 */
@Slf4j
public class Idea33145Service {
    private static final int IDEA_ID = 33145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33145Service() {
        this(new Idea33145Config());
    }

    public Idea33145Service(Idea33145Config config) {
        this.config = config != null ? config : new Idea33145Config();
