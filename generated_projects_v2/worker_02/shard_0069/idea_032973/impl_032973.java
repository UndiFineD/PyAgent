...
@Data
public class Idea32973Config {
    private String name = "idea_032973";
 ...
 */
@Slf4j
public class Idea32973Service {
    private static final int IDEA_ID = 32973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32973Service() {
        this(new Idea32973Config());
    }

    public Idea32973Service(Idea32973Config config) {
        this.config = config != null ? config : new Idea32973Config();
