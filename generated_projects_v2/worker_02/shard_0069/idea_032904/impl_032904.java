...
@Data
public class Idea32904Config {
    private String name = "idea_032904";
 ...
 */
@Slf4j
public class Idea32904Service {
    private static final int IDEA_ID = 32904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32904Service() {
        this(new Idea32904Config());
    }

    public Idea32904Service(Idea32904Config config) {
        this.config = config != null ? config : new Idea32904Config();
