...
@Data
public class Idea33237Config {
    private String name = "idea_033237";
 ...
 */
@Slf4j
public class Idea33237Service {
    private static final int IDEA_ID = 33237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33237Service() {
        this(new Idea33237Config());
    }

    public Idea33237Service(Idea33237Config config) {
        this.config = config != null ? config : new Idea33237Config();
