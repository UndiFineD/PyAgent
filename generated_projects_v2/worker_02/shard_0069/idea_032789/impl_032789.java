...
@Data
public class Idea32789Config {
    private String name = "idea_032789";
 ...
 */
@Slf4j
public class Idea32789Service {
    private static final int IDEA_ID = 32789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32789Service() {
        this(new Idea32789Config());
    }

    public Idea32789Service(Idea32789Config config) {
        this.config = config != null ? config : new Idea32789Config();
