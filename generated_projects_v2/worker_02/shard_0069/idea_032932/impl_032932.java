...
@Data
public class Idea32932Config {
    private String name = "idea_032932";
 ...
 */
@Slf4j
public class Idea32932Service {
    private static final int IDEA_ID = 32932;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32932Service() {
        this(new Idea32932Config());
    }

    public Idea32932Service(Idea32932Config config) {
        this.config = config != null ? config : new Idea32932Config();
