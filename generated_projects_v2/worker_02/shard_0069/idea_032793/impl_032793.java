...
@Data
public class Idea32793Config {
    private String name = "idea_032793";
 ...
 */
@Slf4j
public class Idea32793Service {
    private static final int IDEA_ID = 32793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32793Service() {
        this(new Idea32793Config());
    }

    public Idea32793Service(Idea32793Config config) {
        this.config = config != null ? config : new Idea32793Config();
