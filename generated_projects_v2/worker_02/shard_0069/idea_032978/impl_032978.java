...
@Data
public class Idea32978Config {
    private String name = "idea_032978";
 ...
 */
@Slf4j
public class Idea32978Service {
    private static final int IDEA_ID = 32978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32978Service() {
        this(new Idea32978Config());
    }

    public Idea32978Service(Idea32978Config config) {
        this.config = config != null ? config : new Idea32978Config();
