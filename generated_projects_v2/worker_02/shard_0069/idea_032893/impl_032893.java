...
@Data
public class Idea32893Config {
    private String name = "idea_032893";
 ...
 */
@Slf4j
public class Idea32893Service {
    private static final int IDEA_ID = 32893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32893Service() {
        this(new Idea32893Config());
    }

    public Idea32893Service(Idea32893Config config) {
        this.config = config != null ? config : new Idea32893Config();
