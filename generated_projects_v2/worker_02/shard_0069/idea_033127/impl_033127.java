...
@Data
public class Idea33127Config {
    private String name = "idea_033127";
 ...
 */
@Slf4j
public class Idea33127Service {
    private static final int IDEA_ID = 33127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33127Service() {
        this(new Idea33127Config());
    }

    public Idea33127Service(Idea33127Config config) {
        this.config = config != null ? config : new Idea33127Config();
