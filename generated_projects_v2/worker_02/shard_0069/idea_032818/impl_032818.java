...
@Data
public class Idea32818Config {
    private String name = "idea_032818";
 ...
 */
@Slf4j
public class Idea32818Service {
    private static final int IDEA_ID = 32818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32818Service() {
        this(new Idea32818Config());
    }

    public Idea32818Service(Idea32818Config config) {
        this.config = config != null ? config : new Idea32818Config();
