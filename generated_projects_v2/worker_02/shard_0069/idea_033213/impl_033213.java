...
@Data
public class Idea33213Config {
    private String name = "idea_033213";
 ...
 */
@Slf4j
public class Idea33213Service {
    private static final int IDEA_ID = 33213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33213Service() {
        this(new Idea33213Config());
    }

    public Idea33213Service(Idea33213Config config) {
        this.config = config != null ? config : new Idea33213Config();
