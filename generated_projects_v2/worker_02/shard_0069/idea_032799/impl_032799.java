...
@Data
public class Idea32799Config {
    private String name = "idea_032799";
 ...
 */
@Slf4j
public class Idea32799Service {
    private static final int IDEA_ID = 32799;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32799Service() {
        this(new Idea32799Config());
    }

    public Idea32799Service(Idea32799Config config) {
        this.config = config != null ? config : new Idea32799Config();
