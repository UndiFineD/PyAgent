...
@Data
public class Idea33233Config {
    private String name = "idea_033233";
 ...
 */
@Slf4j
public class Idea33233Service {
    private static final int IDEA_ID = 33233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33233Service() {
        this(new Idea33233Config());
    }

    public Idea33233Service(Idea33233Config config) {
        this.config = config != null ? config : new Idea33233Config();
