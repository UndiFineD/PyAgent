...
@Data
public class Idea32867Config {
    private String name = "idea_032867";
 ...
 */
@Slf4j
public class Idea32867Service {
    private static final int IDEA_ID = 32867;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32867Service() {
        this(new Idea32867Config());
    }

    public Idea32867Service(Idea32867Config config) {
        this.config = config != null ? config : new Idea32867Config();
