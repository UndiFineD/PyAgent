...
@Data
public class Idea33219Config {
    private String name = "idea_033219";
 ...
 */
@Slf4j
public class Idea33219Service {
    private static final int IDEA_ID = 33219;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33219Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33219Service() {
        this(new Idea33219Config());
    }

    public Idea33219Service(Idea33219Config config) {
        this.config = config != null ? config : new Idea33219Config();
