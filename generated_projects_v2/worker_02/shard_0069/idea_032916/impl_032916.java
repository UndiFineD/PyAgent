...
@Data
public class Idea32916Config {
    private String name = "idea_032916";
 ...
 */
@Slf4j
public class Idea32916Service {
    private static final int IDEA_ID = 32916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32916Service() {
        this(new Idea32916Config());
    }

    public Idea32916Service(Idea32916Config config) {
        this.config = config != null ? config : new Idea32916Config();
