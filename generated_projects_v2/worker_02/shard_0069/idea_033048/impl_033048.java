...
@Data
public class Idea33048Config {
    private String name = "idea_033048";
 ...
 */
@Slf4j
public class Idea33048Service {
    private static final int IDEA_ID = 33048;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33048Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33048Service() {
        this(new Idea33048Config());
    }

    public Idea33048Service(Idea33048Config config) {
        this.config = config != null ? config : new Idea33048Config();
