...
@Data
public class Idea33059Config {
    private String name = "idea_033059";
 ...
 */
@Slf4j
public class Idea33059Service {
    private static final int IDEA_ID = 33059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33059Service() {
        this(new Idea33059Config());
    }

    public Idea33059Service(Idea33059Config config) {
        this.config = config != null ? config : new Idea33059Config();
