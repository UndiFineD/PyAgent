...
@Data
public class Idea33003Config {
    private String name = "idea_033003";
 ...
 */
@Slf4j
public class Idea33003Service {
    private static final int IDEA_ID = 33003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33003Service() {
        this(new Idea33003Config());
    }

    public Idea33003Service(Idea33003Config config) {
        this.config = config != null ? config : new Idea33003Config();
