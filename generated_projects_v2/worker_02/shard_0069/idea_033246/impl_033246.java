...
@Data
public class Idea33246Config {
    private String name = "idea_033246";
 ...
 */
@Slf4j
public class Idea33246Service {
    private static final int IDEA_ID = 33246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33246Service() {
        this(new Idea33246Config());
    }

    public Idea33246Service(Idea33246Config config) {
        this.config = config != null ? config : new Idea33246Config();
