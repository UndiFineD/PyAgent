...
@Data
public class Idea33134Config {
    private String name = "idea_033134";
 ...
 */
@Slf4j
public class Idea33134Service {
    private static final int IDEA_ID = 33134;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33134Service() {
        this(new Idea33134Config());
    }

    public Idea33134Service(Idea33134Config config) {
        this.config = config != null ? config : new Idea33134Config();
