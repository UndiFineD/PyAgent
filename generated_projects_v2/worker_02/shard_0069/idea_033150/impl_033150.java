...
@Data
public class Idea33150Config {
    private String name = "idea_033150";
 ...
 */
@Slf4j
public class Idea33150Service {
    private static final int IDEA_ID = 33150;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33150Service() {
        this(new Idea33150Config());
    }

    public Idea33150Service(Idea33150Config config) {
        this.config = config != null ? config : new Idea33150Config();
