...
@Data
public class Idea33033Config {
    private String name = "idea_033033";
 ...
 */
@Slf4j
public class Idea33033Service {
    private static final int IDEA_ID = 33033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33033Service() {
        this(new Idea33033Config());
    }

    public Idea33033Service(Idea33033Config config) {
        this.config = config != null ? config : new Idea33033Config();
