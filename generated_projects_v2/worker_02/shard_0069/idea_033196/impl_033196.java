...
@Data
public class Idea33196Config {
    private String name = "idea_033196";
 ...
 */
@Slf4j
public class Idea33196Service {
    private static final int IDEA_ID = 33196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33196Service() {
        this(new Idea33196Config());
    }

    public Idea33196Service(Idea33196Config config) {
        this.config = config != null ? config : new Idea33196Config();
