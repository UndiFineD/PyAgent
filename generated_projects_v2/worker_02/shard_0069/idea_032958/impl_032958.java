...
@Data
public class Idea32958Config {
    private String name = "idea_032958";
 ...
 */
@Slf4j
public class Idea32958Service {
    private static final int IDEA_ID = 32958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32958Service() {
        this(new Idea32958Config());
    }

    public Idea32958Service(Idea32958Config config) {
        this.config = config != null ? config : new Idea32958Config();
