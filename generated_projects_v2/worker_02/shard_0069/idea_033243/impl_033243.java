...
@Data
public class Idea33243Config {
    private String name = "idea_033243";
 ...
 */
@Slf4j
public class Idea33243Service {
    private static final int IDEA_ID = 33243;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33243Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33243Service() {
        this(new Idea33243Config());
    }

    public Idea33243Service(Idea33243Config config) {
        this.config = config != null ? config : new Idea33243Config();
