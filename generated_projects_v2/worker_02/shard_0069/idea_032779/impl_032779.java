...
@Data
public class Idea32779Config {
    private String name = "idea_032779";
 ...
 */
@Slf4j
public class Idea32779Service {
    private static final int IDEA_ID = 32779;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32779Service() {
        this(new Idea32779Config());
    }

    public Idea32779Service(Idea32779Config config) {
        this.config = config != null ? config : new Idea32779Config();
