...
@Data
public class Idea32992Config {
    private String name = "idea_032992";
 ...
 */
@Slf4j
public class Idea32992Service {
    private static final int IDEA_ID = 32992;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32992Service() {
        this(new Idea32992Config());
    }

    public Idea32992Service(Idea32992Config config) {
        this.config = config != null ? config : new Idea32992Config();
