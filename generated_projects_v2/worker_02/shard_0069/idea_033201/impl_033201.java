...
@Data
public class Idea33201Config {
    private String name = "idea_033201";
 ...
 */
@Slf4j
public class Idea33201Service {
    private static final int IDEA_ID = 33201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33201Service() {
        this(new Idea33201Config());
    }

    public Idea33201Service(Idea33201Config config) {
        this.config = config != null ? config : new Idea33201Config();
