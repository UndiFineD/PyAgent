...
@Data
public class Idea32970Config {
    private String name = "idea_032970";
 ...
 */
@Slf4j
public class Idea32970Service {
    private static final int IDEA_ID = 32970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32970Service() {
        this(new Idea32970Config());
    }

    public Idea32970Service(Idea32970Config config) {
        this.config = config != null ? config : new Idea32970Config();
