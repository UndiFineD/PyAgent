...
@Data
public class Idea32913Config {
    private String name = "idea_032913";
 ...
 */
@Slf4j
public class Idea32913Service {
    private static final int IDEA_ID = 32913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32913Service() {
        this(new Idea32913Config());
    }

    public Idea32913Service(Idea32913Config config) {
        this.config = config != null ? config : new Idea32913Config();
