...
@Data
public class Idea32934Config {
    private String name = "idea_032934";
 ...
 */
@Slf4j
public class Idea32934Service {
    private static final int IDEA_ID = 32934;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32934Service() {
        this(new Idea32934Config());
    }

    public Idea32934Service(Idea32934Config config) {
        this.config = config != null ? config : new Idea32934Config();
