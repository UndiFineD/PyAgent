...
@Data
public class Idea32994Config {
    private String name = "idea_032994";
 ...
 */
@Slf4j
public class Idea32994Service {
    private static final int IDEA_ID = 32994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32994Service() {
        this(new Idea32994Config());
    }

    public Idea32994Service(Idea32994Config config) {
        this.config = config != null ? config : new Idea32994Config();
