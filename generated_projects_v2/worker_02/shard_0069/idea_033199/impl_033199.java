...
@Data
public class Idea33199Config {
    private String name = "idea_033199";
 ...
 */
@Slf4j
public class Idea33199Service {
    private static final int IDEA_ID = 33199;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33199Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33199Service() {
        this(new Idea33199Config());
    }

    public Idea33199Service(Idea33199Config config) {
        this.config = config != null ? config : new Idea33199Config();
