...
@Data
public class Idea33121Config {
    private String name = "idea_033121";
 ...
 */
@Slf4j
public class Idea33121Service {
    private static final int IDEA_ID = 33121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33121Service() {
        this(new Idea33121Config());
    }

    public Idea33121Service(Idea33121Config config) {
        this.config = config != null ? config : new Idea33121Config();
