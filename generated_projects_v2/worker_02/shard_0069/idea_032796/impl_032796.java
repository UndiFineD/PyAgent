...
@Data
public class Idea32796Config {
    private String name = "idea_032796";
 ...
 */
@Slf4j
public class Idea32796Service {
    private static final int IDEA_ID = 32796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32796Service() {
        this(new Idea32796Config());
    }

    public Idea32796Service(Idea32796Config config) {
        this.config = config != null ? config : new Idea32796Config();
