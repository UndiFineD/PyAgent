...
@Data
public class Idea33102Config {
    private String name = "idea_033102";
 ...
 */
@Slf4j
public class Idea33102Service {
    private static final int IDEA_ID = 33102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33102Service() {
        this(new Idea33102Config());
    }

    public Idea33102Service(Idea33102Config config) {
        this.config = config != null ? config : new Idea33102Config();
