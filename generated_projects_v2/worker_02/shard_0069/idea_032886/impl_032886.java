...
@Data
public class Idea32886Config {
    private String name = "idea_032886";
 ...
 */
@Slf4j
public class Idea32886Service {
    private static final int IDEA_ID = 32886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32886Service() {
        this(new Idea32886Config());
    }

    public Idea32886Service(Idea32886Config config) {
        this.config = config != null ? config : new Idea32886Config();
