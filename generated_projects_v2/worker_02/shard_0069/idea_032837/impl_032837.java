...
@Data
public class Idea32837Config {
    private String name = "idea_032837";
 ...
 */
@Slf4j
public class Idea32837Service {
    private static final int IDEA_ID = 32837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32837Service() {
        this(new Idea32837Config());
    }

    public Idea32837Service(Idea32837Config config) {
        this.config = config != null ? config : new Idea32837Config();
