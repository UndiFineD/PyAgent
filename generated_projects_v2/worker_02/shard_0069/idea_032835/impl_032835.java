...
@Data
public class Idea32835Config {
    private String name = "idea_032835";
 ...
 */
@Slf4j
public class Idea32835Service {
    private static final int IDEA_ID = 32835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32835Service() {
        this(new Idea32835Config());
    }

    public Idea32835Service(Idea32835Config config) {
        this.config = config != null ? config : new Idea32835Config();
