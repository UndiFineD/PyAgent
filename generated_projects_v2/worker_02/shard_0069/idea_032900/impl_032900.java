...
@Data
public class Idea32900Config {
    private String name = "idea_032900";
 ...
 */
@Slf4j
public class Idea32900Service {
    private static final int IDEA_ID = 32900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32900Service() {
        this(new Idea32900Config());
    }

    public Idea32900Service(Idea32900Config config) {
        this.config = config != null ? config : new Idea32900Config();
