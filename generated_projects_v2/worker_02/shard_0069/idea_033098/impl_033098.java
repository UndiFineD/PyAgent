...
@Data
public class Idea33098Config {
    private String name = "idea_033098";
 ...
 */
@Slf4j
public class Idea33098Service {
    private static final int IDEA_ID = 33098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33098Service() {
        this(new Idea33098Config());
    }

    public Idea33098Service(Idea33098Config config) {
        this.config = config != null ? config : new Idea33098Config();
