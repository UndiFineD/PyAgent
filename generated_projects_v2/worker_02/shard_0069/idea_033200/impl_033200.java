...
@Data
public class Idea33200Config {
    private String name = "idea_033200";
 ...
 */
@Slf4j
public class Idea33200Service {
    private static final int IDEA_ID = 33200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33200Service() {
        this(new Idea33200Config());
    }

    public Idea33200Service(Idea33200Config config) {
        this.config = config != null ? config : new Idea33200Config();
