...
@Data
public class Idea33089Config {
    private String name = "idea_033089";
 ...
 */
@Slf4j
public class Idea33089Service {
    private static final int IDEA_ID = 33089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33089Service() {
        this(new Idea33089Config());
    }

    public Idea33089Service(Idea33089Config config) {
        this.config = config != null ? config : new Idea33089Config();
