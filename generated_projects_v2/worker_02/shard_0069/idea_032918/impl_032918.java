...
@Data
public class Idea32918Config {
    private String name = "idea_032918";
 ...
 */
@Slf4j
public class Idea32918Service {
    private static final int IDEA_ID = 32918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32918Service() {
        this(new Idea32918Config());
    }

    public Idea32918Service(Idea32918Config config) {
        this.config = config != null ? config : new Idea32918Config();
