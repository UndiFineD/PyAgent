...
@Data
public class Idea33036Config {
    private String name = "idea_033036";
 ...
 */
@Slf4j
public class Idea33036Service {
    private static final int IDEA_ID = 33036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33036Service() {
        this(new Idea33036Config());
    }

    public Idea33036Service(Idea33036Config config) {
        this.config = config != null ? config : new Idea33036Config();
