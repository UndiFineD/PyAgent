...
@Data
public class Idea33024Config {
    private String name = "idea_033024";
 ...
 */
@Slf4j
public class Idea33024Service {
    private static final int IDEA_ID = 33024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33024Service() {
        this(new Idea33024Config());
    }

    public Idea33024Service(Idea33024Config config) {
        this.config = config != null ? config : new Idea33024Config();
