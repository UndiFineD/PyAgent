...
@Data
public class Idea33222Config {
    private String name = "idea_033222";
 ...
 */
@Slf4j
public class Idea33222Service {
    private static final int IDEA_ID = 33222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33222Service() {
        this(new Idea33222Config());
    }

    public Idea33222Service(Idea33222Config config) {
        this.config = config != null ? config : new Idea33222Config();
