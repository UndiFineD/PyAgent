...
@Data
public class Idea32980Config {
    private String name = "idea_032980";
 ...
 */
@Slf4j
public class Idea32980Service {
    private static final int IDEA_ID = 32980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32980Service() {
        this(new Idea32980Config());
    }

    public Idea32980Service(Idea32980Config config) {
        this.config = config != null ? config : new Idea32980Config();
