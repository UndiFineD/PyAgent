...
@Data
public class Idea33174Config {
    private String name = "idea_033174";
 ...
 */
@Slf4j
public class Idea33174Service {
    private static final int IDEA_ID = 33174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33174Service() {
        this(new Idea33174Config());
    }

    public Idea33174Service(Idea33174Config config) {
        this.config = config != null ? config : new Idea33174Config();
