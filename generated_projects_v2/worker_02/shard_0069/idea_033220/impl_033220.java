...
@Data
public class Idea33220Config {
    private String name = "idea_033220";
 ...
 */
@Slf4j
public class Idea33220Service {
    private static final int IDEA_ID = 33220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33220Service() {
        this(new Idea33220Config());
    }

    public Idea33220Service(Idea33220Config config) {
        this.config = config != null ? config : new Idea33220Config();
