...
@Data
public class Idea33211Config {
    private String name = "idea_033211";
 ...
 */
@Slf4j
public class Idea33211Service {
    private static final int IDEA_ID = 33211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33211Service() {
        this(new Idea33211Config());
    }

    public Idea33211Service(Idea33211Config config) {
        this.config = config != null ? config : new Idea33211Config();
