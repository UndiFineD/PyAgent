...
@Data
public class Idea33101Config {
    private String name = "idea_033101";
 ...
 */
@Slf4j
public class Idea33101Service {
    private static final int IDEA_ID = 33101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33101Service() {
        this(new Idea33101Config());
    }

    public Idea33101Service(Idea33101Config config) {
        this.config = config != null ? config : new Idea33101Config();
