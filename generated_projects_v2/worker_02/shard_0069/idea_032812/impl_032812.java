...
@Data
public class Idea32812Config {
    private String name = "idea_032812";
 ...
 */
@Slf4j
public class Idea32812Service {
    private static final int IDEA_ID = 32812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32812Service() {
        this(new Idea32812Config());
    }

    public Idea32812Service(Idea32812Config config) {
        this.config = config != null ? config : new Idea32812Config();
