...
@Data
public class Idea33052Config {
    private String name = "idea_033052";
 ...
 */
@Slf4j
public class Idea33052Service {
    private static final int IDEA_ID = 33052;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33052Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33052Service() {
        this(new Idea33052Config());
    }

    public Idea33052Service(Idea33052Config config) {
        this.config = config != null ? config : new Idea33052Config();
