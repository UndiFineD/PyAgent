...
@Data
public class Idea33226Config {
    private String name = "idea_033226";
 ...
 */
@Slf4j
public class Idea33226Service {
    private static final int IDEA_ID = 33226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33226Service() {
        this(new Idea33226Config());
    }

    public Idea33226Service(Idea33226Config config) {
        this.config = config != null ? config : new Idea33226Config();
