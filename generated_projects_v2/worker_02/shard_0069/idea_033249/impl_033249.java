...
@Data
public class Idea33249Config {
    private String name = "idea_033249";
 ...
 */
@Slf4j
public class Idea33249Service {
    private static final int IDEA_ID = 33249;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33249Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33249Service() {
        this(new Idea33249Config());
    }

    public Idea33249Service(Idea33249Config config) {
        this.config = config != null ? config : new Idea33249Config();
