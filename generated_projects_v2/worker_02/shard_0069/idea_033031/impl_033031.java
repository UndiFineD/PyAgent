...
@Data
public class Idea33031Config {
    private String name = "idea_033031";
 ...
 */
@Slf4j
public class Idea33031Service {
    private static final int IDEA_ID = 33031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33031Service() {
        this(new Idea33031Config());
    }

    public Idea33031Service(Idea33031Config config) {
        this.config = config != null ? config : new Idea33031Config();
