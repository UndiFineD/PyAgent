...
@Data
public class Idea32781Config {
    private String name = "idea_032781";
 ...
 */
@Slf4j
public class Idea32781Service {
    private static final int IDEA_ID = 32781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32781Service() {
        this(new Idea32781Config());
    }

    public Idea32781Service(Idea32781Config config) {
        this.config = config != null ? config : new Idea32781Config();
