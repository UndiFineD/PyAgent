...
@Data
public class Idea32981Config {
    private String name = "idea_032981";
 ...
 */
@Slf4j
public class Idea32981Service {
    private static final int IDEA_ID = 32981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32981Service() {
        this(new Idea32981Config());
    }

    public Idea32981Service(Idea32981Config config) {
        this.config = config != null ? config : new Idea32981Config();
