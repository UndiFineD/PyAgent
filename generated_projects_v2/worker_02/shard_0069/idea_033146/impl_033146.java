...
@Data
public class Idea33146Config {
    private String name = "idea_033146";
 ...
 */
@Slf4j
public class Idea33146Service {
    private static final int IDEA_ID = 33146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea33146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea33146Service() {
        this(new Idea33146Config());
    }

    public Idea33146Service(Idea33146Config config) {
        this.config = config != null ? config : new Idea33146Config();
