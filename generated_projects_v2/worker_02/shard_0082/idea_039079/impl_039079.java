...
@Data
public class Idea39079Config {
    private String name = "idea_039079";
 ...
 */
@Slf4j
public class Idea39079Service {
    private static final int IDEA_ID = 39079;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39079Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39079Service() {
        this(new Idea39079Config());
    }

    public Idea39079Service(Idea39079Config config) {
        this.config = config != null ? config : new Idea39079Config();
