...
@Data
public class Idea39066Config {
    private String name = "idea_039066";
 ...
 */
@Slf4j
public class Idea39066Service {
    private static final int IDEA_ID = 39066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39066Service() {
        this(new Idea39066Config());
    }

    public Idea39066Service(Idea39066Config config) {
        this.config = config != null ? config : new Idea39066Config();
