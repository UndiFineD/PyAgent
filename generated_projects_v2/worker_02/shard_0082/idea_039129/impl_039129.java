...
@Data
public class Idea39129Config {
    private String name = "idea_039129";
 ...
 */
@Slf4j
public class Idea39129Service {
    private static final int IDEA_ID = 39129;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39129Service() {
        this(new Idea39129Config());
    }

    public Idea39129Service(Idea39129Config config) {
        this.config = config != null ? config : new Idea39129Config();
