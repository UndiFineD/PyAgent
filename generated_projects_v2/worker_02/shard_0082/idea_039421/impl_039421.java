...
@Data
public class Idea39421Config {
    private String name = "idea_039421";
 ...
 */
@Slf4j
public class Idea39421Service {
    private static final int IDEA_ID = 39421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39421Service() {
        this(new Idea39421Config());
    }

    public Idea39421Service(Idea39421Config config) {
        this.config = config != null ? config : new Idea39421Config();
