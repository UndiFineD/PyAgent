...
@Data
public class Idea39350Config {
    private String name = "idea_039350";
 ...
 */
@Slf4j
public class Idea39350Service {
    private static final int IDEA_ID = 39350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39350Service() {
        this(new Idea39350Config());
    }

    public Idea39350Service(Idea39350Config config) {
        this.config = config != null ? config : new Idea39350Config();
