...
@Data
public class Idea39005Config {
    private String name = "idea_039005";
 ...
 */
@Slf4j
public class Idea39005Service {
    private static final int IDEA_ID = 39005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39005Service() {
        this(new Idea39005Config());
    }

    public Idea39005Service(Idea39005Config config) {
        this.config = config != null ? config : new Idea39005Config();
