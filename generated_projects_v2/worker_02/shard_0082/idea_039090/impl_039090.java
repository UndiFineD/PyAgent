...
@Data
public class Idea39090Config {
    private String name = "idea_039090";
 ...
 */
@Slf4j
public class Idea39090Service {
    private static final int IDEA_ID = 39090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39090Service() {
        this(new Idea39090Config());
    }

    public Idea39090Service(Idea39090Config config) {
        this.config = config != null ? config : new Idea39090Config();
