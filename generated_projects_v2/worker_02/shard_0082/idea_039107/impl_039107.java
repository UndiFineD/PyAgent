...
@Data
public class Idea39107Config {
    private String name = "idea_039107";
 ...
 */
@Slf4j
public class Idea39107Service {
    private static final int IDEA_ID = 39107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39107Service() {
        this(new Idea39107Config());
    }

    public Idea39107Service(Idea39107Config config) {
        this.config = config != null ? config : new Idea39107Config();
