...
@Data
public class Idea39184Config {
    private String name = "idea_039184";
 ...
 */
@Slf4j
public class Idea39184Service {
    private static final int IDEA_ID = 39184;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39184Service() {
        this(new Idea39184Config());
    }

    public Idea39184Service(Idea39184Config config) {
        this.config = config != null ? config : new Idea39184Config();
