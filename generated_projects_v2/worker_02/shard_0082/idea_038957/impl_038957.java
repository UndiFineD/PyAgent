...
@Data
public class Idea38957Config {
    private String name = "idea_038957";
 ...
 */
@Slf4j
public class Idea38957Service {
    private static final int IDEA_ID = 38957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38957Service() {
        this(new Idea38957Config());
    }

    public Idea38957Service(Idea38957Config config) {
        this.config = config != null ? config : new Idea38957Config();
