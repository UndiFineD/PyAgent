...
@Data
public class Idea39072Config {
    private String name = "idea_039072";
 ...
 */
@Slf4j
public class Idea39072Service {
    private static final int IDEA_ID = 39072;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39072Service() {
        this(new Idea39072Config());
    }

    public Idea39072Service(Idea39072Config config) {
        this.config = config != null ? config : new Idea39072Config();
