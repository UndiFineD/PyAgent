...
@Data
public class Idea39215Config {
    private String name = "idea_039215";
 ...
 */
@Slf4j
public class Idea39215Service {
    private static final int IDEA_ID = 39215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39215Service() {
        this(new Idea39215Config());
    }

    public Idea39215Service(Idea39215Config config) {
        this.config = config != null ? config : new Idea39215Config();
