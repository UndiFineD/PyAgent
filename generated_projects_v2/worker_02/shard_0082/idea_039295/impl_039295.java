...
@Data
public class Idea39295Config {
    private String name = "idea_039295";
 ...
 */
@Slf4j
public class Idea39295Service {
    private static final int IDEA_ID = 39295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39295Service() {
        this(new Idea39295Config());
    }

    public Idea39295Service(Idea39295Config config) {
        this.config = config != null ? config : new Idea39295Config();
