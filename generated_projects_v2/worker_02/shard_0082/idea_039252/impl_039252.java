...
@Data
public class Idea39252Config {
    private String name = "idea_039252";
 ...
 */
@Slf4j
public class Idea39252Service {
    private static final int IDEA_ID = 39252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39252Service() {
        this(new Idea39252Config());
    }

    public Idea39252Service(Idea39252Config config) {
        this.config = config != null ? config : new Idea39252Config();
