...
@Data
public class Idea39257Config {
    private String name = "idea_039257";
 ...
 */
@Slf4j
public class Idea39257Service {
    private static final int IDEA_ID = 39257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39257Service() {
        this(new Idea39257Config());
    }

    public Idea39257Service(Idea39257Config config) {
        this.config = config != null ? config : new Idea39257Config();
