...
@Data
public class Idea38975Config {
    private String name = "idea_038975";
 ...
 */
@Slf4j
public class Idea38975Service {
    private static final int IDEA_ID = 38975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38975Service() {
        this(new Idea38975Config());
    }

    public Idea38975Service(Idea38975Config config) {
        this.config = config != null ? config : new Idea38975Config();
