...
@Data
public class Idea39157Config {
    private String name = "idea_039157";
 ...
 */
@Slf4j
public class Idea39157Service {
    private static final int IDEA_ID = 39157;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39157Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39157Service() {
        this(new Idea39157Config());
    }

    public Idea39157Service(Idea39157Config config) {
        this.config = config != null ? config : new Idea39157Config();
