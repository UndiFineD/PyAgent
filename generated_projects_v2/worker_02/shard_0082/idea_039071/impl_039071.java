...
@Data
public class Idea39071Config {
    private String name = "idea_039071";
 ...
 */
@Slf4j
public class Idea39071Service {
    private static final int IDEA_ID = 39071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39071Service() {
        this(new Idea39071Config());
    }

    public Idea39071Service(Idea39071Config config) {
        this.config = config != null ? config : new Idea39071Config();
