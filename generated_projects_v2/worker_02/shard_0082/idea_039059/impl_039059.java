...
@Data
public class Idea39059Config {
    private String name = "idea_039059";
 ...
 */
@Slf4j
public class Idea39059Service {
    private static final int IDEA_ID = 39059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39059Service() {
        this(new Idea39059Config());
    }

    public Idea39059Service(Idea39059Config config) {
        this.config = config != null ? config : new Idea39059Config();
