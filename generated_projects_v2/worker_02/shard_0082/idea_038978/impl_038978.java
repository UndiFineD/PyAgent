...
@Data
public class Idea38978Config {
    private String name = "idea_038978";
 ...
 */
@Slf4j
public class Idea38978Service {
    private static final int IDEA_ID = 38978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38978Service() {
        this(new Idea38978Config());
    }

    public Idea38978Service(Idea38978Config config) {
        this.config = config != null ? config : new Idea38978Config();
