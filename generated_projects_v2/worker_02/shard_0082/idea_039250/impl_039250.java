...
@Data
public class Idea39250Config {
    private String name = "idea_039250";
 ...
 */
@Slf4j
public class Idea39250Service {
    private static final int IDEA_ID = 39250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39250Service() {
        this(new Idea39250Config());
    }

    public Idea39250Service(Idea39250Config config) {
        this.config = config != null ? config : new Idea39250Config();
