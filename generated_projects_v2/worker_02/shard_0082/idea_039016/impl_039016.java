...
@Data
public class Idea39016Config {
    private String name = "idea_039016";
 ...
 */
@Slf4j
public class Idea39016Service {
    private static final int IDEA_ID = 39016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39016Service() {
        this(new Idea39016Config());
    }

    public Idea39016Service(Idea39016Config config) {
        this.config = config != null ? config : new Idea39016Config();
