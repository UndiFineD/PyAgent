...
@Data
public class Idea39367Config {
    private String name = "idea_039367";
 ...
 */
@Slf4j
public class Idea39367Service {
    private static final int IDEA_ID = 39367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39367Service() {
        this(new Idea39367Config());
    }

    public Idea39367Service(Idea39367Config config) {
        this.config = config != null ? config : new Idea39367Config();
