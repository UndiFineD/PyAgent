...
@Data
public class Idea38992Config {
    private String name = "idea_038992";
 ...
 */
@Slf4j
public class Idea38992Service {
    private static final int IDEA_ID = 38992;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38992Service() {
        this(new Idea38992Config());
    }

    public Idea38992Service(Idea38992Config config) {
        this.config = config != null ? config : new Idea38992Config();
