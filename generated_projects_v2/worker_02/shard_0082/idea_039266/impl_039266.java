...
@Data
public class Idea39266Config {
    private String name = "idea_039266";
 ...
 */
@Slf4j
public class Idea39266Service {
    private static final int IDEA_ID = 39266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39266Service() {
        this(new Idea39266Config());
    }

    public Idea39266Service(Idea39266Config config) {
        this.config = config != null ? config : new Idea39266Config();
