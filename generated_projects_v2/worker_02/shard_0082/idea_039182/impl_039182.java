...
@Data
public class Idea39182Config {
    private String name = "idea_039182";
 ...
 */
@Slf4j
public class Idea39182Service {
    private static final int IDEA_ID = 39182;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39182Service() {
        this(new Idea39182Config());
    }

    public Idea39182Service(Idea39182Config config) {
        this.config = config != null ? config : new Idea39182Config();
