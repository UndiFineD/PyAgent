...
@Data
public class Idea39368Config {
    private String name = "idea_039368";
 ...
 */
@Slf4j
public class Idea39368Service {
    private static final int IDEA_ID = 39368;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39368Service() {
        this(new Idea39368Config());
    }

    public Idea39368Service(Idea39368Config config) {
        this.config = config != null ? config : new Idea39368Config();
