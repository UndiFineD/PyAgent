...
@Data
public class Idea39077Config {
    private String name = "idea_039077";
 ...
 */
@Slf4j
public class Idea39077Service {
    private static final int IDEA_ID = 39077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39077Service() {
        this(new Idea39077Config());
    }

    public Idea39077Service(Idea39077Config config) {
        this.config = config != null ? config : new Idea39077Config();
