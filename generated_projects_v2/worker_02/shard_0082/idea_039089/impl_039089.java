...
@Data
public class Idea39089Config {
    private String name = "idea_039089";
 ...
 */
@Slf4j
public class Idea39089Service {
    private static final int IDEA_ID = 39089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39089Service() {
        this(new Idea39089Config());
    }

    public Idea39089Service(Idea39089Config config) {
        this.config = config != null ? config : new Idea39089Config();
