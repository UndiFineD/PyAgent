...
@Data
public class Idea39324Config {
    private String name = "idea_039324";
 ...
 */
@Slf4j
public class Idea39324Service {
    private static final int IDEA_ID = 39324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39324Service() {
        this(new Idea39324Config());
    }

    public Idea39324Service(Idea39324Config config) {
        this.config = config != null ? config : new Idea39324Config();
