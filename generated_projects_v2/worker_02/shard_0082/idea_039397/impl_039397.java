...
@Data
public class Idea39397Config {
    private String name = "idea_039397";
 ...
 */
@Slf4j
public class Idea39397Service {
    private static final int IDEA_ID = 39397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39397Service() {
        this(new Idea39397Config());
    }

    public Idea39397Service(Idea39397Config config) {
        this.config = config != null ? config : new Idea39397Config();
