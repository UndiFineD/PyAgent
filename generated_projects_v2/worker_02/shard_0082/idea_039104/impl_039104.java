...
@Data
public class Idea39104Config {
    private String name = "idea_039104";
 ...
 */
@Slf4j
public class Idea39104Service {
    private static final int IDEA_ID = 39104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39104Service() {
        this(new Idea39104Config());
    }

    public Idea39104Service(Idea39104Config config) {
        this.config = config != null ? config : new Idea39104Config();
