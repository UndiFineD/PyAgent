...
@Data
public class Idea39272Config {
    private String name = "idea_039272";
 ...
 */
@Slf4j
public class Idea39272Service {
    private static final int IDEA_ID = 39272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39272Service() {
        this(new Idea39272Config());
    }

    public Idea39272Service(Idea39272Config config) {
        this.config = config != null ? config : new Idea39272Config();
