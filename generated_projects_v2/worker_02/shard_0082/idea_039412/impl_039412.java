...
@Data
public class Idea39412Config {
    private String name = "idea_039412";
 ...
 */
@Slf4j
public class Idea39412Service {
    private static final int IDEA_ID = 39412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39412Service() {
        this(new Idea39412Config());
    }

    public Idea39412Service(Idea39412Config config) {
        this.config = config != null ? config : new Idea39412Config();
