...
@Data
public class Idea39208Config {
    private String name = "idea_039208";
 ...
 */
@Slf4j
public class Idea39208Service {
    private static final int IDEA_ID = 39208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39208Service() {
        this(new Idea39208Config());
    }

    public Idea39208Service(Idea39208Config config) {
        this.config = config != null ? config : new Idea39208Config();
