...
@Data
public class Idea39111Config {
    private String name = "idea_039111";
 ...
 */
@Slf4j
public class Idea39111Service {
    private static final int IDEA_ID = 39111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39111Service() {
        this(new Idea39111Config());
    }

    public Idea39111Service(Idea39111Config config) {
        this.config = config != null ? config : new Idea39111Config();
