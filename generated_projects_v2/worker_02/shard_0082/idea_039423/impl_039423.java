...
@Data
public class Idea39423Config {
    private String name = "idea_039423";
 ...
 */
@Slf4j
public class Idea39423Service {
    private static final int IDEA_ID = 39423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39423Service() {
        this(new Idea39423Config());
    }

    public Idea39423Service(Idea39423Config config) {
        this.config = config != null ? config : new Idea39423Config();
