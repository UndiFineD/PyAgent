...
@Data
public class Idea39076Config {
    private String name = "idea_039076";
 ...
 */
@Slf4j
public class Idea39076Service {
    private static final int IDEA_ID = 39076;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39076Service() {
        this(new Idea39076Config());
    }

    public Idea39076Service(Idea39076Config config) {
        this.config = config != null ? config : new Idea39076Config();
