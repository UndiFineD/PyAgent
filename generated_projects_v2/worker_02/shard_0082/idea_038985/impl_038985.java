...
@Data
public class Idea38985Config {
    private String name = "idea_038985";
 ...
 */
@Slf4j
public class Idea38985Service {
    private static final int IDEA_ID = 38985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38985Service() {
        this(new Idea38985Config());
    }

    public Idea38985Service(Idea38985Config config) {
        this.config = config != null ? config : new Idea38985Config();
