...
@Data
public class Idea39227Config {
    private String name = "idea_039227";
 ...
 */
@Slf4j
public class Idea39227Service {
    private static final int IDEA_ID = 39227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39227Service() {
        this(new Idea39227Config());
    }

    public Idea39227Service(Idea39227Config config) {
        this.config = config != null ? config : new Idea39227Config();
