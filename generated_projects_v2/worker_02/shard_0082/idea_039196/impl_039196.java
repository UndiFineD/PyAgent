...
@Data
public class Idea39196Config {
    private String name = "idea_039196";
 ...
 */
@Slf4j
public class Idea39196Service {
    private static final int IDEA_ID = 39196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39196Service() {
        this(new Idea39196Config());
    }

    public Idea39196Service(Idea39196Config config) {
        this.config = config != null ? config : new Idea39196Config();
