...
@Data
public class Idea39226Config {
    private String name = "idea_039226";
 ...
 */
@Slf4j
public class Idea39226Service {
    private static final int IDEA_ID = 39226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39226Service() {
        this(new Idea39226Config());
    }

    public Idea39226Service(Idea39226Config config) {
        this.config = config != null ? config : new Idea39226Config();
