...
@Data
public class Idea39082Config {
    private String name = "idea_039082";
 ...
 */
@Slf4j
public class Idea39082Service {
    private static final int IDEA_ID = 39082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39082Service() {
        this(new Idea39082Config());
    }

    public Idea39082Service(Idea39082Config config) {
        this.config = config != null ? config : new Idea39082Config();
