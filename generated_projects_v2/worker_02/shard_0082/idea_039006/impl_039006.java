...
@Data
public class Idea39006Config {
    private String name = "idea_039006";
 ...
 */
@Slf4j
public class Idea39006Service {
    private static final int IDEA_ID = 39006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39006Service() {
        this(new Idea39006Config());
    }

    public Idea39006Service(Idea39006Config config) {
        this.config = config != null ? config : new Idea39006Config();
