...
@Data
public class Idea39132Config {
    private String name = "idea_039132";
 ...
 */
@Slf4j
public class Idea39132Service {
    private static final int IDEA_ID = 39132;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39132Service() {
        this(new Idea39132Config());
    }

    public Idea39132Service(Idea39132Config config) {
        this.config = config != null ? config : new Idea39132Config();
