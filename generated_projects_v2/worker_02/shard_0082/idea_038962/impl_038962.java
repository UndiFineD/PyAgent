...
@Data
public class Idea38962Config {
    private String name = "idea_038962";
 ...
 */
@Slf4j
public class Idea38962Service {
    private static final int IDEA_ID = 38962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38962Service() {
        this(new Idea38962Config());
    }

    public Idea38962Service(Idea38962Config config) {
        this.config = config != null ? config : new Idea38962Config();
