...
@Data
public class Idea39379Config {
    private String name = "idea_039379";
 ...
 */
@Slf4j
public class Idea39379Service {
    private static final int IDEA_ID = 39379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39379Service() {
        this(new Idea39379Config());
    }

    public Idea39379Service(Idea39379Config config) {
        this.config = config != null ? config : new Idea39379Config();
