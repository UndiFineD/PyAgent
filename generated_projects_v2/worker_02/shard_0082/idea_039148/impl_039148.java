...
@Data
public class Idea39148Config {
    private String name = "idea_039148";
 ...
 */
@Slf4j
public class Idea39148Service {
    private static final int IDEA_ID = 39148;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39148Service() {
        this(new Idea39148Config());
    }

    public Idea39148Service(Idea39148Config config) {
        this.config = config != null ? config : new Idea39148Config();
