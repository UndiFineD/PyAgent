...
@Data
public class Idea39354Config {
    private String name = "idea_039354";
 ...
 */
@Slf4j
public class Idea39354Service {
    private static final int IDEA_ID = 39354;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39354Service() {
        this(new Idea39354Config());
    }

    public Idea39354Service(Idea39354Config config) {
        this.config = config != null ? config : new Idea39354Config();
