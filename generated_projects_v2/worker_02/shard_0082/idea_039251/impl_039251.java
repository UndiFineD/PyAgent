...
@Data
public class Idea39251Config {
    private String name = "idea_039251";
 ...
 */
@Slf4j
public class Idea39251Service {
    private static final int IDEA_ID = 39251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39251Service() {
        this(new Idea39251Config());
    }

    public Idea39251Service(Idea39251Config config) {
        this.config = config != null ? config : new Idea39251Config();
