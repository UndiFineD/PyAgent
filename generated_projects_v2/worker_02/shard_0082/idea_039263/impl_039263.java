...
@Data
public class Idea39263Config {
    private String name = "idea_039263";
 ...
 */
@Slf4j
public class Idea39263Service {
    private static final int IDEA_ID = 39263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39263Service() {
        this(new Idea39263Config());
    }

    public Idea39263Service(Idea39263Config config) {
        this.config = config != null ? config : new Idea39263Config();
