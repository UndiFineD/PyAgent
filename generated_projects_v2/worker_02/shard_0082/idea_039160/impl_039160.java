...
@Data
public class Idea39160Config {
    private String name = "idea_039160";
 ...
 */
@Slf4j
public class Idea39160Service {
    private static final int IDEA_ID = 39160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39160Service() {
        this(new Idea39160Config());
    }

    public Idea39160Service(Idea39160Config config) {
        this.config = config != null ? config : new Idea39160Config();
