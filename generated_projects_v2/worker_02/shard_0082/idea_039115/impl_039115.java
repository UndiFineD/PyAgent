...
@Data
public class Idea39115Config {
    private String name = "idea_039115";
 ...
 */
@Slf4j
public class Idea39115Service {
    private static final int IDEA_ID = 39115;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39115Service() {
        this(new Idea39115Config());
    }

    public Idea39115Service(Idea39115Config config) {
        this.config = config != null ? config : new Idea39115Config();
