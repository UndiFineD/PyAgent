...
@Data
public class Idea39139Config {
    private String name = "idea_039139";
 ...
 */
@Slf4j
public class Idea39139Service {
    private static final int IDEA_ID = 39139;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39139Service() {
        this(new Idea39139Config());
    }

    public Idea39139Service(Idea39139Config config) {
        this.config = config != null ? config : new Idea39139Config();
