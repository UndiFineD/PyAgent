...
@Data
public class Idea39290Config {
    private String name = "idea_039290";
 ...
 */
@Slf4j
public class Idea39290Service {
    private static final int IDEA_ID = 39290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39290Service() {
        this(new Idea39290Config());
    }

    public Idea39290Service(Idea39290Config config) {
        this.config = config != null ? config : new Idea39290Config();
