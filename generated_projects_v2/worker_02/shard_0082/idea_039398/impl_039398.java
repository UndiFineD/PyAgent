...
@Data
public class Idea39398Config {
    private String name = "idea_039398";
 ...
 */
@Slf4j
public class Idea39398Service {
    private static final int IDEA_ID = 39398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39398Service() {
        this(new Idea39398Config());
    }

    public Idea39398Service(Idea39398Config config) {
        this.config = config != null ? config : new Idea39398Config();
