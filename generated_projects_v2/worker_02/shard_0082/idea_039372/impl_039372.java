...
@Data
public class Idea39372Config {
    private String name = "idea_039372";
 ...
 */
@Slf4j
public class Idea39372Service {
    private static final int IDEA_ID = 39372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39372Service() {
        this(new Idea39372Config());
    }

    public Idea39372Service(Idea39372Config config) {
        this.config = config != null ? config : new Idea39372Config();
