...
@Data
public class Idea39332Config {
    private String name = "idea_039332";
 ...
 */
@Slf4j
public class Idea39332Service {
    private static final int IDEA_ID = 39332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39332Service() {
        this(new Idea39332Config());
    }

    public Idea39332Service(Idea39332Config config) {
        this.config = config != null ? config : new Idea39332Config();
