...
@Data
public class Idea39352Config {
    private String name = "idea_039352";
 ...
 */
@Slf4j
public class Idea39352Service {
    private static final int IDEA_ID = 39352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39352Service() {
        this(new Idea39352Config());
    }

    public Idea39352Service(Idea39352Config config) {
        this.config = config != null ? config : new Idea39352Config();
