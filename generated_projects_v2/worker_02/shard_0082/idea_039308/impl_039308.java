...
@Data
public class Idea39308Config {
    private String name = "idea_039308";
 ...
 */
@Slf4j
public class Idea39308Service {
    private static final int IDEA_ID = 39308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39308Service() {
        this(new Idea39308Config());
    }

    public Idea39308Service(Idea39308Config config) {
        this.config = config != null ? config : new Idea39308Config();
