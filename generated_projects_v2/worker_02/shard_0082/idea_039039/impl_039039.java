...
@Data
public class Idea39039Config {
    private String name = "idea_039039";
 ...
 */
@Slf4j
public class Idea39039Service {
    private static final int IDEA_ID = 39039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39039Service() {
        this(new Idea39039Config());
    }

    public Idea39039Service(Idea39039Config config) {
        this.config = config != null ? config : new Idea39039Config();
