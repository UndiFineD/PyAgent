...
@Data
public class Idea39202Config {
    private String name = "idea_039202";
 ...
 */
@Slf4j
public class Idea39202Service {
    private static final int IDEA_ID = 39202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39202Service() {
        this(new Idea39202Config());
    }

    public Idea39202Service(Idea39202Config config) {
        this.config = config != null ? config : new Idea39202Config();
