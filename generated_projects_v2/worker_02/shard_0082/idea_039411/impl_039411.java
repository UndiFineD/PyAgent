...
@Data
public class Idea39411Config {
    private String name = "idea_039411";
 ...
 */
@Slf4j
public class Idea39411Service {
    private static final int IDEA_ID = 39411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39411Service() {
        this(new Idea39411Config());
    }

    public Idea39411Service(Idea39411Config config) {
        this.config = config != null ? config : new Idea39411Config();
