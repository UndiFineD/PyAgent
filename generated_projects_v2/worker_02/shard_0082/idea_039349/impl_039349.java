...
@Data
public class Idea39349Config {
    private String name = "idea_039349";
 ...
 */
@Slf4j
public class Idea39349Service {
    private static final int IDEA_ID = 39349;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39349Service() {
        this(new Idea39349Config());
    }

    public Idea39349Service(Idea39349Config config) {
        this.config = config != null ? config : new Idea39349Config();
