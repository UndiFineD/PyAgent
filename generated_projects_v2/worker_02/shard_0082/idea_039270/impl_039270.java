...
@Data
public class Idea39270Config {
    private String name = "idea_039270";
 ...
 */
@Slf4j
public class Idea39270Service {
    private static final int IDEA_ID = 39270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39270Service() {
        this(new Idea39270Config());
    }

    public Idea39270Service(Idea39270Config config) {
        this.config = config != null ? config : new Idea39270Config();
