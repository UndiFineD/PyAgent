...
@Data
public class Idea39278Config {
    private String name = "idea_039278";
 ...
 */
@Slf4j
public class Idea39278Service {
    private static final int IDEA_ID = 39278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39278Service() {
        this(new Idea39278Config());
    }

    public Idea39278Service(Idea39278Config config) {
        this.config = config != null ? config : new Idea39278Config();
