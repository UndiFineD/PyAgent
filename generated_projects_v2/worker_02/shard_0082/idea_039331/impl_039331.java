...
@Data
public class Idea39331Config {
    private String name = "idea_039331";
 ...
 */
@Slf4j
public class Idea39331Service {
    private static final int IDEA_ID = 39331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39331Service() {
        this(new Idea39331Config());
    }

    public Idea39331Service(Idea39331Config config) {
        this.config = config != null ? config : new Idea39331Config();
