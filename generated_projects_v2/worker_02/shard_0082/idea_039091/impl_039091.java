...
@Data
public class Idea39091Config {
    private String name = "idea_039091";
 ...
 */
@Slf4j
public class Idea39091Service {
    private static final int IDEA_ID = 39091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39091Service() {
        this(new Idea39091Config());
    }

    public Idea39091Service(Idea39091Config config) {
        this.config = config != null ? config : new Idea39091Config();
