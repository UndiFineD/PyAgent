...
@Data
public class Idea38953Config {
    private String name = "idea_038953";
 ...
 */
@Slf4j
public class Idea38953Service {
    private static final int IDEA_ID = 38953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38953Service() {
        this(new Idea38953Config());
    }

    public Idea38953Service(Idea38953Config config) {
        this.config = config != null ? config : new Idea38953Config();
