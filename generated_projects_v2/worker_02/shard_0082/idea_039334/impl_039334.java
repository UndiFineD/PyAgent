...
@Data
public class Idea39334Config {
    private String name = "idea_039334";
 ...
 */
@Slf4j
public class Idea39334Service {
    private static final int IDEA_ID = 39334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39334Service() {
        this(new Idea39334Config());
    }

    public Idea39334Service(Idea39334Config config) {
        this.config = config != null ? config : new Idea39334Config();
