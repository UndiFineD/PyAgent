...
@Data
public class Idea39027Config {
    private String name = "idea_039027";
 ...
 */
@Slf4j
public class Idea39027Service {
    private static final int IDEA_ID = 39027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39027Service() {
        this(new Idea39027Config());
    }

    public Idea39027Service(Idea39027Config config) {
        this.config = config != null ? config : new Idea39027Config();
