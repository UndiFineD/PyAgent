...
@Data
public class Idea39307Config {
    private String name = "idea_039307";
 ...
 */
@Slf4j
public class Idea39307Service {
    private static final int IDEA_ID = 39307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39307Service() {
        this(new Idea39307Config());
    }

    public Idea39307Service(Idea39307Config config) {
        this.config = config != null ? config : new Idea39307Config();
