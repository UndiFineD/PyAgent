...
@Data
public class Idea39330Config {
    private String name = "idea_039330";
 ...
 */
@Slf4j
public class Idea39330Service {
    private static final int IDEA_ID = 39330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39330Service() {
        this(new Idea39330Config());
    }

    public Idea39330Service(Idea39330Config config) {
        this.config = config != null ? config : new Idea39330Config();
