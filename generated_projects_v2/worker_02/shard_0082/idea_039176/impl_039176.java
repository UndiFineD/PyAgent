...
@Data
public class Idea39176Config {
    private String name = "idea_039176";
 ...
 */
@Slf4j
public class Idea39176Service {
    private static final int IDEA_ID = 39176;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39176Service() {
        this(new Idea39176Config());
    }

    public Idea39176Service(Idea39176Config config) {
        this.config = config != null ? config : new Idea39176Config();
