...
@Data
public class Idea39030Config {
    private String name = "idea_039030";
 ...
 */
@Slf4j
public class Idea39030Service {
    private static final int IDEA_ID = 39030;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39030Service() {
        this(new Idea39030Config());
    }

    public Idea39030Service(Idea39030Config config) {
        this.config = config != null ? config : new Idea39030Config();
