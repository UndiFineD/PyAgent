...
@Data
public class Idea39246Config {
    private String name = "idea_039246";
 ...
 */
@Slf4j
public class Idea39246Service {
    private static final int IDEA_ID = 39246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39246Service() {
        this(new Idea39246Config());
    }

    public Idea39246Service(Idea39246Config config) {
        this.config = config != null ? config : new Idea39246Config();
