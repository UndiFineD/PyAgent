...
@Data
public class Idea39100Config {
    private String name = "idea_039100";
 ...
 */
@Slf4j
public class Idea39100Service {
    private static final int IDEA_ID = 39100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39100Service() {
        this(new Idea39100Config());
    }

    public Idea39100Service(Idea39100Config config) {
        this.config = config != null ? config : new Idea39100Config();
