...
@Data
public class Idea39008Config {
    private String name = "idea_039008";
 ...
 */
@Slf4j
public class Idea39008Service {
    private static final int IDEA_ID = 39008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39008Service() {
        this(new Idea39008Config());
    }

    public Idea39008Service(Idea39008Config config) {
        this.config = config != null ? config : new Idea39008Config();
