...
@Data
public class Idea39140Config {
    private String name = "idea_039140";
 ...
 */
@Slf4j
public class Idea39140Service {
    private static final int IDEA_ID = 39140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39140Service() {
        this(new Idea39140Config());
    }

    public Idea39140Service(Idea39140Config config) {
        this.config = config != null ? config : new Idea39140Config();
