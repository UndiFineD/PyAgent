...
@Data
public class Idea39232Config {
    private String name = "idea_039232";
 ...
 */
@Slf4j
public class Idea39232Service {
    private static final int IDEA_ID = 39232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39232Service() {
        this(new Idea39232Config());
    }

    public Idea39232Service(Idea39232Config config) {
        this.config = config != null ? config : new Idea39232Config();
