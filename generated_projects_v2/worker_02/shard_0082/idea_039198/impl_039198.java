...
@Data
public class Idea39198Config {
    private String name = "idea_039198";
 ...
 */
@Slf4j
public class Idea39198Service {
    private static final int IDEA_ID = 39198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39198Service() {
        this(new Idea39198Config());
    }

    public Idea39198Service(Idea39198Config config) {
        this.config = config != null ? config : new Idea39198Config();
