...
@Data
public class Idea39322Config {
    private String name = "idea_039322";
 ...
 */
@Slf4j
public class Idea39322Service {
    private static final int IDEA_ID = 39322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39322Service() {
        this(new Idea39322Config());
    }

    public Idea39322Service(Idea39322Config config) {
        this.config = config != null ? config : new Idea39322Config();
