...
@Data
public class Idea38998Config {
    private String name = "idea_038998";
 ...
 */
@Slf4j
public class Idea38998Service {
    private static final int IDEA_ID = 38998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38998Service() {
        this(new Idea38998Config());
    }

    public Idea38998Service(Idea38998Config config) {
        this.config = config != null ? config : new Idea38998Config();
