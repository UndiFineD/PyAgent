...
@Data
public class Idea39353Config {
    private String name = "idea_039353";
 ...
 */
@Slf4j
public class Idea39353Service {
    private static final int IDEA_ID = 39353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39353Service() {
        this(new Idea39353Config());
    }

    public Idea39353Service(Idea39353Config config) {
        this.config = config != null ? config : new Idea39353Config();
