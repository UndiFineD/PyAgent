...
@Data
public class Idea38967Config {
    private String name = "idea_038967";
 ...
 */
@Slf4j
public class Idea38967Service {
    private static final int IDEA_ID = 38967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38967Service() {
        this(new Idea38967Config());
    }

    public Idea38967Service(Idea38967Config config) {
        this.config = config != null ? config : new Idea38967Config();
