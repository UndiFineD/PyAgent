...
@Data
public class Idea39225Config {
    private String name = "idea_039225";
 ...
 */
@Slf4j
public class Idea39225Service {
    private static final int IDEA_ID = 39225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39225Service() {
        this(new Idea39225Config());
    }

    public Idea39225Service(Idea39225Config config) {
        this.config = config != null ? config : new Idea39225Config();
