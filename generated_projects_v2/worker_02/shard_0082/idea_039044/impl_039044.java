...
@Data
public class Idea39044Config {
    private String name = "idea_039044";
 ...
 */
@Slf4j
public class Idea39044Service {
    private static final int IDEA_ID = 39044;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39044Service() {
        this(new Idea39044Config());
    }

    public Idea39044Service(Idea39044Config config) {
        this.config = config != null ? config : new Idea39044Config();
