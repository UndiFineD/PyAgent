...
@Data
public class Idea39025Config {
    private String name = "idea_039025";
 ...
 */
@Slf4j
public class Idea39025Service {
    private static final int IDEA_ID = 39025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39025Service() {
        this(new Idea39025Config());
    }

    public Idea39025Service(Idea39025Config config) {
        this.config = config != null ? config : new Idea39025Config();
