...
@Data
public class Idea39102Config {
    private String name = "idea_039102";
 ...
 */
@Slf4j
public class Idea39102Service {
    private static final int IDEA_ID = 39102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39102Service() {
        this(new Idea39102Config());
    }

    public Idea39102Service(Idea39102Config config) {
        this.config = config != null ? config : new Idea39102Config();
