...
@Data
public class Idea39060Config {
    private String name = "idea_039060";
 ...
 */
@Slf4j
public class Idea39060Service {
    private static final int IDEA_ID = 39060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39060Service() {
        this(new Idea39060Config());
    }

    public Idea39060Service(Idea39060Config config) {
        this.config = config != null ? config : new Idea39060Config();
