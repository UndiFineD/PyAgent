...
@Data
public class Idea39356Config {
    private String name = "idea_039356";
 ...
 */
@Slf4j
public class Idea39356Service {
    private static final int IDEA_ID = 39356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39356Service() {
        this(new Idea39356Config());
    }

    public Idea39356Service(Idea39356Config config) {
        this.config = config != null ? config : new Idea39356Config();
