...
@Data
public class Idea39128Config {
    private String name = "idea_039128";
 ...
 */
@Slf4j
public class Idea39128Service {
    private static final int IDEA_ID = 39128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39128Service() {
        this(new Idea39128Config());
    }

    public Idea39128Service(Idea39128Config config) {
        this.config = config != null ? config : new Idea39128Config();
