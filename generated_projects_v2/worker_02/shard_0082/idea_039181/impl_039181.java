...
@Data
public class Idea39181Config {
    private String name = "idea_039181";
 ...
 */
@Slf4j
public class Idea39181Service {
    private static final int IDEA_ID = 39181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39181Service() {
        this(new Idea39181Config());
    }

    public Idea39181Service(Idea39181Config config) {
        this.config = config != null ? config : new Idea39181Config();
