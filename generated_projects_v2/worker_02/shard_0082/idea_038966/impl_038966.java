...
@Data
public class Idea38966Config {
    private String name = "idea_038966";
 ...
 */
@Slf4j
public class Idea38966Service {
    private static final int IDEA_ID = 38966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38966Service() {
        this(new Idea38966Config());
    }

    public Idea38966Service(Idea38966Config config) {
        this.config = config != null ? config : new Idea38966Config();
