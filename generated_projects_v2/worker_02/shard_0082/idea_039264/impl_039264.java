...
@Data
public class Idea39264Config {
    private String name = "idea_039264";
 ...
 */
@Slf4j
public class Idea39264Service {
    private static final int IDEA_ID = 39264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39264Service() {
        this(new Idea39264Config());
    }

    public Idea39264Service(Idea39264Config config) {
        this.config = config != null ? config : new Idea39264Config();
