...
@Data
public class Idea39256Config {
    private String name = "idea_039256";
 ...
 */
@Slf4j
public class Idea39256Service {
    private static final int IDEA_ID = 39256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39256Service() {
        this(new Idea39256Config());
    }

    public Idea39256Service(Idea39256Config config) {
        this.config = config != null ? config : new Idea39256Config();
