...
@Data
public class Idea39274Config {
    private String name = "idea_039274";
 ...
 */
@Slf4j
public class Idea39274Service {
    private static final int IDEA_ID = 39274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39274Service() {
        this(new Idea39274Config());
    }

    public Idea39274Service(Idea39274Config config) {
        this.config = config != null ? config : new Idea39274Config();
