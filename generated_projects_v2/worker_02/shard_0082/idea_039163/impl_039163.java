...
@Data
public class Idea39163Config {
    private String name = "idea_039163";
 ...
 */
@Slf4j
public class Idea39163Service {
    private static final int IDEA_ID = 39163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39163Service() {
        this(new Idea39163Config());
    }

    public Idea39163Service(Idea39163Config config) {
        this.config = config != null ? config : new Idea39163Config();
