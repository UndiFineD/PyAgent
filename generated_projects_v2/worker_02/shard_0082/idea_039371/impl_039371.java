...
@Data
public class Idea39371Config {
    private String name = "idea_039371";
 ...
 */
@Slf4j
public class Idea39371Service {
    private static final int IDEA_ID = 39371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39371Service() {
        this(new Idea39371Config());
    }

    public Idea39371Service(Idea39371Config config) {
        this.config = config != null ? config : new Idea39371Config();
