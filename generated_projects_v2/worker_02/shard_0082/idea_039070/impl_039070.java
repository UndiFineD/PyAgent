...
@Data
public class Idea39070Config {
    private String name = "idea_039070";
 ...
 */
@Slf4j
public class Idea39070Service {
    private static final int IDEA_ID = 39070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39070Service() {
        this(new Idea39070Config());
    }

    public Idea39070Service(Idea39070Config config) {
        this.config = config != null ? config : new Idea39070Config();
