...
@Data
public class Idea39407Config {
    private String name = "idea_039407";
 ...
 */
@Slf4j
public class Idea39407Service {
    private static final int IDEA_ID = 39407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39407Service() {
        this(new Idea39407Config());
    }

    public Idea39407Service(Idea39407Config config) {
        this.config = config != null ? config : new Idea39407Config();
