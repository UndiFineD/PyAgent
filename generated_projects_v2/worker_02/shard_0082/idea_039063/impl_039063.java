...
@Data
public class Idea39063Config {
    private String name = "idea_039063";
 ...
 */
@Slf4j
public class Idea39063Service {
    private static final int IDEA_ID = 39063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39063Service() {
        this(new Idea39063Config());
    }

    public Idea39063Service(Idea39063Config config) {
        this.config = config != null ? config : new Idea39063Config();
