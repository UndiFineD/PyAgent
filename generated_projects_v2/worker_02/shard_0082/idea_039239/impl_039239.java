...
@Data
public class Idea39239Config {
    private String name = "idea_039239";
 ...
 */
@Slf4j
public class Idea39239Service {
    private static final int IDEA_ID = 39239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39239Service() {
        this(new Idea39239Config());
    }

    public Idea39239Service(Idea39239Config config) {
        this.config = config != null ? config : new Idea39239Config();
