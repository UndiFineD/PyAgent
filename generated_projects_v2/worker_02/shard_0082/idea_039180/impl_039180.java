...
@Data
public class Idea39180Config {
    private String name = "idea_039180";
 ...
 */
@Slf4j
public class Idea39180Service {
    private static final int IDEA_ID = 39180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39180Service() {
        this(new Idea39180Config());
    }

    public Idea39180Service(Idea39180Config config) {
        this.config = config != null ? config : new Idea39180Config();
