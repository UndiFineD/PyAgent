...
@Data
public class Idea39052Config {
    private String name = "idea_039052";
 ...
 */
@Slf4j
public class Idea39052Service {
    private static final int IDEA_ID = 39052;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39052Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39052Service() {
        this(new Idea39052Config());
    }

    public Idea39052Service(Idea39052Config config) {
        this.config = config != null ? config : new Idea39052Config();
