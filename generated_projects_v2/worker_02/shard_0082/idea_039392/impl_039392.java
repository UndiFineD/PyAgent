...
@Data
public class Idea39392Config {
    private String name = "idea_039392";
 ...
 */
@Slf4j
public class Idea39392Service {
    private static final int IDEA_ID = 39392;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39392Service() {
        this(new Idea39392Config());
    }

    public Idea39392Service(Idea39392Config config) {
        this.config = config != null ? config : new Idea39392Config();
