...
@Data
public class Idea39277Config {
    private String name = "idea_039277";
 ...
 */
@Slf4j
public class Idea39277Service {
    private static final int IDEA_ID = 39277;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39277Service() {
        this(new Idea39277Config());
    }

    public Idea39277Service(Idea39277Config config) {
        this.config = config != null ? config : new Idea39277Config();
