...
@Data
public class Idea39003Config {
    private String name = "idea_039003";
 ...
 */
@Slf4j
public class Idea39003Service {
    private static final int IDEA_ID = 39003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39003Service() {
        this(new Idea39003Config());
    }

    public Idea39003Service(Idea39003Config config) {
        this.config = config != null ? config : new Idea39003Config();
