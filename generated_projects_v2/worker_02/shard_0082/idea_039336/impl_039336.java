...
@Data
public class Idea39336Config {
    private String name = "idea_039336";
 ...
 */
@Slf4j
public class Idea39336Service {
    private static final int IDEA_ID = 39336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39336Service() {
        this(new Idea39336Config());
    }

    public Idea39336Service(Idea39336Config config) {
        this.config = config != null ? config : new Idea39336Config();
