...
@Data
public class Idea39154Config {
    private String name = "idea_039154";
 ...
 */
@Slf4j
public class Idea39154Service {
    private static final int IDEA_ID = 39154;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39154Service() {
        this(new Idea39154Config());
    }

    public Idea39154Service(Idea39154Config config) {
        this.config = config != null ? config : new Idea39154Config();
