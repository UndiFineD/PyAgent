...
@Data
public class Idea38987Config {
    private String name = "idea_038987";
 ...
 */
@Slf4j
public class Idea38987Service {
    private static final int IDEA_ID = 38987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38987Service() {
        this(new Idea38987Config());
    }

    public Idea38987Service(Idea38987Config config) {
        this.config = config != null ? config : new Idea38987Config();
