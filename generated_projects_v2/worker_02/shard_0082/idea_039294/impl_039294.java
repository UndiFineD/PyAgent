...
@Data
public class Idea39294Config {
    private String name = "idea_039294";
 ...
 */
@Slf4j
public class Idea39294Service {
    private static final int IDEA_ID = 39294;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39294Service() {
        this(new Idea39294Config());
    }

    public Idea39294Service(Idea39294Config config) {
        this.config = config != null ? config : new Idea39294Config();
