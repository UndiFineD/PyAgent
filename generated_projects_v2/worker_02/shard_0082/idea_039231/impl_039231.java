...
@Data
public class Idea39231Config {
    private String name = "idea_039231";
 ...
 */
@Slf4j
public class Idea39231Service {
    private static final int IDEA_ID = 39231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39231Service() {
        this(new Idea39231Config());
    }

    public Idea39231Service(Idea39231Config config) {
        this.config = config != null ? config : new Idea39231Config();
