...
@Data
public class Idea39097Config {
    private String name = "idea_039097";
 ...
 */
@Slf4j
public class Idea39097Service {
    private static final int IDEA_ID = 39097;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39097Service() {
        this(new Idea39097Config());
    }

    public Idea39097Service(Idea39097Config config) {
        this.config = config != null ? config : new Idea39097Config();
