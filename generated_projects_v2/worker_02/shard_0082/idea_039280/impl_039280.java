...
@Data
public class Idea39280Config {
    private String name = "idea_039280";
 ...
 */
@Slf4j
public class Idea39280Service {
    private static final int IDEA_ID = 39280;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39280Service() {
        this(new Idea39280Config());
    }

    public Idea39280Service(Idea39280Config config) {
        this.config = config != null ? config : new Idea39280Config();
