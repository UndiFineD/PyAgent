...
@Data
public class Idea38984Config {
    private String name = "idea_038984";
 ...
 */
@Slf4j
public class Idea38984Service {
    private static final int IDEA_ID = 38984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38984Service() {
        this(new Idea38984Config());
    }

    public Idea38984Service(Idea38984Config config) {
        this.config = config != null ? config : new Idea38984Config();
