...
@Data
public class Idea39098Config {
    private String name = "idea_039098";
 ...
 */
@Slf4j
public class Idea39098Service {
    private static final int IDEA_ID = 39098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39098Service() {
        this(new Idea39098Config());
    }

    public Idea39098Service(Idea39098Config config) {
        this.config = config != null ? config : new Idea39098Config();
