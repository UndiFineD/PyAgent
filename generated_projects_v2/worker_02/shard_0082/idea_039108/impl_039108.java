...
@Data
public class Idea39108Config {
    private String name = "idea_039108";
 ...
 */
@Slf4j
public class Idea39108Service {
    private static final int IDEA_ID = 39108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39108Service() {
        this(new Idea39108Config());
    }

    public Idea39108Service(Idea39108Config config) {
        this.config = config != null ? config : new Idea39108Config();
