...
@Data
public class Idea39106Config {
    private String name = "idea_039106";
 ...
 */
@Slf4j
public class Idea39106Service {
    private static final int IDEA_ID = 39106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39106Service() {
        this(new Idea39106Config());
    }

    public Idea39106Service(Idea39106Config config) {
        this.config = config != null ? config : new Idea39106Config();
