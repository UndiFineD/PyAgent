...
@Data
public class Idea39399Config {
    private String name = "idea_039399";
 ...
 */
@Slf4j
public class Idea39399Service {
    private static final int IDEA_ID = 39399;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39399Service() {
        this(new Idea39399Config());
    }

    public Idea39399Service(Idea39399Config config) {
        this.config = config != null ? config : new Idea39399Config();
