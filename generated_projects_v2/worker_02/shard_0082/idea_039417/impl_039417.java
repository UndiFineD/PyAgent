...
@Data
public class Idea39417Config {
    private String name = "idea_039417";
 ...
 */
@Slf4j
public class Idea39417Service {
    private static final int IDEA_ID = 39417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39417Service() {
        this(new Idea39417Config());
    }

    public Idea39417Service(Idea39417Config config) {
        this.config = config != null ? config : new Idea39417Config();
