...
@Data
public class Idea39179Config {
    private String name = "idea_039179";
 ...
 */
@Slf4j
public class Idea39179Service {
    private static final int IDEA_ID = 39179;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39179Service() {
        this(new Idea39179Config());
    }

    public Idea39179Service(Idea39179Config config) {
        this.config = config != null ? config : new Idea39179Config();
