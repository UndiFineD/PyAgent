...
@Data
public class Idea39194Config {
    private String name = "idea_039194";
 ...
 */
@Slf4j
public class Idea39194Service {
    private static final int IDEA_ID = 39194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39194Service() {
        this(new Idea39194Config());
    }

    public Idea39194Service(Idea39194Config config) {
        this.config = config != null ? config : new Idea39194Config();
