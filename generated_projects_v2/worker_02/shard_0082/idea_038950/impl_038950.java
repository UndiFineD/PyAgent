...
@Data
public class Idea38950Config {
    private String name = "idea_038950";
 ...
 */
@Slf4j
public class Idea38950Service {
    private static final int IDEA_ID = 38950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38950Service() {
        this(new Idea38950Config());
    }

    public Idea38950Service(Idea38950Config config) {
        this.config = config != null ? config : new Idea38950Config();
