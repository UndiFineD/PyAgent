...
@Data
public class Idea39391Config {
    private String name = "idea_039391";
 ...
 */
@Slf4j
public class Idea39391Service {
    private static final int IDEA_ID = 39391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39391Service() {
        this(new Idea39391Config());
    }

    public Idea39391Service(Idea39391Config config) {
        this.config = config != null ? config : new Idea39391Config();
