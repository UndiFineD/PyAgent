...
@Data
public class Idea39045Config {
    private String name = "idea_039045";
 ...
 */
@Slf4j
public class Idea39045Service {
    private static final int IDEA_ID = 39045;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39045Service() {
        this(new Idea39045Config());
    }

    public Idea39045Service(Idea39045Config config) {
        this.config = config != null ? config : new Idea39045Config();
