...
@Data
public class Idea39103Config {
    private String name = "idea_039103";
 ...
 */
@Slf4j
public class Idea39103Service {
    private static final int IDEA_ID = 39103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39103Service() {
        this(new Idea39103Config());
    }

    public Idea39103Service(Idea39103Config config) {
        this.config = config != null ? config : new Idea39103Config();
