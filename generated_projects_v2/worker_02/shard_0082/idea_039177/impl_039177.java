...
@Data
public class Idea39177Config {
    private String name = "idea_039177";
 ...
 */
@Slf4j
public class Idea39177Service {
    private static final int IDEA_ID = 39177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39177Service() {
        this(new Idea39177Config());
    }

    public Idea39177Service(Idea39177Config config) {
        this.config = config != null ? config : new Idea39177Config();
