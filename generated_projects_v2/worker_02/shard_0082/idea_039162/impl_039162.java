...
@Data
public class Idea39162Config {
    private String name = "idea_039162";
 ...
 */
@Slf4j
public class Idea39162Service {
    private static final int IDEA_ID = 39162;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39162Service() {
        this(new Idea39162Config());
    }

    public Idea39162Service(Idea39162Config config) {
        this.config = config != null ? config : new Idea39162Config();
