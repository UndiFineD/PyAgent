...
@Data
public class Idea39085Config {
    private String name = "idea_039085";
 ...
 */
@Slf4j
public class Idea39085Service {
    private static final int IDEA_ID = 39085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39085Service() {
        this(new Idea39085Config());
    }

    public Idea39085Service(Idea39085Config config) {
        this.config = config != null ? config : new Idea39085Config();
