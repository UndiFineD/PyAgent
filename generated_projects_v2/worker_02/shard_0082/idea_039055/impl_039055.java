...
@Data
public class Idea39055Config {
    private String name = "idea_039055";
 ...
 */
@Slf4j
public class Idea39055Service {
    private static final int IDEA_ID = 39055;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39055Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39055Service() {
        this(new Idea39055Config());
    }

    public Idea39055Service(Idea39055Config config) {
        this.config = config != null ? config : new Idea39055Config();
