...
@Data
public class Idea39236Config {
    private String name = "idea_039236";
 ...
 */
@Slf4j
public class Idea39236Service {
    private static final int IDEA_ID = 39236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39236Service() {
        this(new Idea39236Config());
    }

    public Idea39236Service(Idea39236Config config) {
        this.config = config != null ? config : new Idea39236Config();
