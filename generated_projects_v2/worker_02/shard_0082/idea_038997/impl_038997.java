...
@Data
public class Idea38997Config {
    private String name = "idea_038997";
 ...
 */
@Slf4j
public class Idea38997Service {
    private static final int IDEA_ID = 38997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38997Service() {
        this(new Idea38997Config());
    }

    public Idea38997Service(Idea38997Config config) {
        this.config = config != null ? config : new Idea38997Config();
