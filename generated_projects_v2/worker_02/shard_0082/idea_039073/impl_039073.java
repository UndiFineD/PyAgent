...
@Data
public class Idea39073Config {
    private String name = "idea_039073";
 ...
 */
@Slf4j
public class Idea39073Service {
    private static final int IDEA_ID = 39073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39073Service() {
        this(new Idea39073Config());
    }

    public Idea39073Service(Idea39073Config config) {
        this.config = config != null ? config : new Idea39073Config();
