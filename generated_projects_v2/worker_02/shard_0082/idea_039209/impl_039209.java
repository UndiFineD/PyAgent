...
@Data
public class Idea39209Config {
    private String name = "idea_039209";
 ...
 */
@Slf4j
public class Idea39209Service {
    private static final int IDEA_ID = 39209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39209Service() {
        this(new Idea39209Config());
    }

    public Idea39209Service(Idea39209Config config) {
        this.config = config != null ? config : new Idea39209Config();
