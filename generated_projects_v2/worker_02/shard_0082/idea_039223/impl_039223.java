...
@Data
public class Idea39223Config {
    private String name = "idea_039223";
 ...
 */
@Slf4j
public class Idea39223Service {
    private static final int IDEA_ID = 39223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39223Service() {
        this(new Idea39223Config());
    }

    public Idea39223Service(Idea39223Config config) {
        this.config = config != null ? config : new Idea39223Config();
