...
@Data
public class Idea39283Config {
    private String name = "idea_039283";
 ...
 */
@Slf4j
public class Idea39283Service {
    private static final int IDEA_ID = 39283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39283Service() {
        this(new Idea39283Config());
    }

    public Idea39283Service(Idea39283Config config) {
        this.config = config != null ? config : new Idea39283Config();
