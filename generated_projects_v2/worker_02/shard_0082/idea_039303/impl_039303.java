...
@Data
public class Idea39303Config {
    private String name = "idea_039303";
 ...
 */
@Slf4j
public class Idea39303Service {
    private static final int IDEA_ID = 39303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39303Service() {
        this(new Idea39303Config());
    }

    public Idea39303Service(Idea39303Config config) {
        this.config = config != null ? config : new Idea39303Config();
