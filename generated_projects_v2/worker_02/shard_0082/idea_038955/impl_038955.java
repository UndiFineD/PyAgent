...
@Data
public class Idea38955Config {
    private String name = "idea_038955";
 ...
 */
@Slf4j
public class Idea38955Service {
    private static final int IDEA_ID = 38955;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38955Service() {
        this(new Idea38955Config());
    }

    public Idea38955Service(Idea38955Config config) {
        this.config = config != null ? config : new Idea38955Config();
