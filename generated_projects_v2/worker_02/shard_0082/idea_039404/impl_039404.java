...
@Data
public class Idea39404Config {
    private String name = "idea_039404";
 ...
 */
@Slf4j
public class Idea39404Service {
    private static final int IDEA_ID = 39404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39404Service() {
        this(new Idea39404Config());
    }

    public Idea39404Service(Idea39404Config config) {
        this.config = config != null ? config : new Idea39404Config();
