...
@Data
public class Idea39121Config {
    private String name = "idea_039121";
 ...
 */
@Slf4j
public class Idea39121Service {
    private static final int IDEA_ID = 39121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39121Service() {
        this(new Idea39121Config());
    }

    public Idea39121Service(Idea39121Config config) {
        this.config = config != null ? config : new Idea39121Config();
