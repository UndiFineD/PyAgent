...
@Data
public class Idea39381Config {
    private String name = "idea_039381";
 ...
 */
@Slf4j
public class Idea39381Service {
    private static final int IDEA_ID = 39381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39381Service() {
        this(new Idea39381Config());
    }

    public Idea39381Service(Idea39381Config config) {
        this.config = config != null ? config : new Idea39381Config();
