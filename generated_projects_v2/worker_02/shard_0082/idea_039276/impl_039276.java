...
@Data
public class Idea39276Config {
    private String name = "idea_039276";
 ...
 */
@Slf4j
public class Idea39276Service {
    private static final int IDEA_ID = 39276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39276Service() {
        this(new Idea39276Config());
    }

    public Idea39276Service(Idea39276Config config) {
        this.config = config != null ? config : new Idea39276Config();
