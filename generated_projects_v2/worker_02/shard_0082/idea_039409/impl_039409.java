...
@Data
public class Idea39409Config {
    private String name = "idea_039409";
 ...
 */
@Slf4j
public class Idea39409Service {
    private static final int IDEA_ID = 39409;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39409Service() {
        this(new Idea39409Config());
    }

    public Idea39409Service(Idea39409Config config) {
        this.config = config != null ? config : new Idea39409Config();
