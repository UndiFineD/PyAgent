...
@Data
public class Idea39001Config {
    private String name = "idea_039001";
 ...
 */
@Slf4j
public class Idea39001Service {
    private static final int IDEA_ID = 39001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39001Service() {
        this(new Idea39001Config());
    }

    public Idea39001Service(Idea39001Config config) {
        this.config = config != null ? config : new Idea39001Config();
