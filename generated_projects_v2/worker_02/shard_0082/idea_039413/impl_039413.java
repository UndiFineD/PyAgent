...
@Data
public class Idea39413Config {
    private String name = "idea_039413";
 ...
 */
@Slf4j
public class Idea39413Service {
    private static final int IDEA_ID = 39413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39413Service() {
        this(new Idea39413Config());
    }

    public Idea39413Service(Idea39413Config config) {
        this.config = config != null ? config : new Idea39413Config();
