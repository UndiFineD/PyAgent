...
@Data
public class Idea39292Config {
    private String name = "idea_039292";
 ...
 */
@Slf4j
public class Idea39292Service {
    private static final int IDEA_ID = 39292;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39292Service() {
        this(new Idea39292Config());
    }

    public Idea39292Service(Idea39292Config config) {
        this.config = config != null ? config : new Idea39292Config();
