...
@Data
public class Idea39007Config {
    private String name = "idea_039007";
 ...
 */
@Slf4j
public class Idea39007Service {
    private static final int IDEA_ID = 39007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39007Service() {
        this(new Idea39007Config());
    }

    public Idea39007Service(Idea39007Config config) {
        this.config = config != null ? config : new Idea39007Config();
