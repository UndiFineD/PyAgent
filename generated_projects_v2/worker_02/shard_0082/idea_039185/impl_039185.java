...
@Data
public class Idea39185Config {
    private String name = "idea_039185";
 ...
 */
@Slf4j
public class Idea39185Service {
    private static final int IDEA_ID = 39185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39185Service() {
        this(new Idea39185Config());
    }

    public Idea39185Service(Idea39185Config config) {
        this.config = config != null ? config : new Idea39185Config();
