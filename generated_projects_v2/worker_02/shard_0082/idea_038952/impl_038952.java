...
@Data
public class Idea38952Config {
    private String name = "idea_038952";
 ...
 */
@Slf4j
public class Idea38952Service {
    private static final int IDEA_ID = 38952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38952Service() {
        this(new Idea38952Config());
    }

    public Idea38952Service(Idea38952Config config) {
        this.config = config != null ? config : new Idea38952Config();
