...
@Data
public class Idea39262Config {
    private String name = "idea_039262";
 ...
 */
@Slf4j
public class Idea39262Service {
    private static final int IDEA_ID = 39262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39262Service() {
        this(new Idea39262Config());
    }

    public Idea39262Service(Idea39262Config config) {
        this.config = config != null ? config : new Idea39262Config();
