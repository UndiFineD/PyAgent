...
@Data
public class Idea38964Config {
    private String name = "idea_038964";
 ...
 */
@Slf4j
public class Idea38964Service {
    private static final int IDEA_ID = 38964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38964Service() {
        this(new Idea38964Config());
    }

    public Idea38964Service(Idea38964Config config) {
        this.config = config != null ? config : new Idea38964Config();
