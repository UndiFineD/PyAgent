...
@Data
public class Idea39210Config {
    private String name = "idea_039210";
 ...
 */
@Slf4j
public class Idea39210Service {
    private static final int IDEA_ID = 39210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39210Service() {
        this(new Idea39210Config());
    }

    public Idea39210Service(Idea39210Config config) {
        this.config = config != null ? config : new Idea39210Config();
