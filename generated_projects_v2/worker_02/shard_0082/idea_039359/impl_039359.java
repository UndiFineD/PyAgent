...
@Data
public class Idea39359Config {
    private String name = "idea_039359";
 ...
 */
@Slf4j
public class Idea39359Service {
    private static final int IDEA_ID = 39359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39359Service() {
        this(new Idea39359Config());
    }

    public Idea39359Service(Idea39359Config config) {
        this.config = config != null ? config : new Idea39359Config();
