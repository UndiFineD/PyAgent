...
@Data
public class Idea39150Config {
    private String name = "idea_039150";
 ...
 */
@Slf4j
public class Idea39150Service {
    private static final int IDEA_ID = 39150;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39150Service() {
        this(new Idea39150Config());
    }

    public Idea39150Service(Idea39150Config config) {
        this.config = config != null ? config : new Idea39150Config();
