...
@Data
public class Idea39125Config {
    private String name = "idea_039125";
 ...
 */
@Slf4j
public class Idea39125Service {
    private static final int IDEA_ID = 39125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39125Service() {
        this(new Idea39125Config());
    }

    public Idea39125Service(Idea39125Config config) {
        this.config = config != null ? config : new Idea39125Config();
