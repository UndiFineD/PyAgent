...
@Data
public class Idea39282Config {
    private String name = "idea_039282";
 ...
 */
@Slf4j
public class Idea39282Service {
    private static final int IDEA_ID = 39282;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39282Service() {
        this(new Idea39282Config());
    }

    public Idea39282Service(Idea39282Config config) {
        this.config = config != null ? config : new Idea39282Config();
