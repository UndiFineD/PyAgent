...
@Data
public class Idea39304Config {
    private String name = "idea_039304";
 ...
 */
@Slf4j
public class Idea39304Service {
    private static final int IDEA_ID = 39304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39304Service() {
        this(new Idea39304Config());
    }

    public Idea39304Service(Idea39304Config config) {
        this.config = config != null ? config : new Idea39304Config();
