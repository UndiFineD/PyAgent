...
@Data
public class Idea39113Config {
    private String name = "idea_039113";
 ...
 */
@Slf4j
public class Idea39113Service {
    private static final int IDEA_ID = 39113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39113Service() {
        this(new Idea39113Config());
    }

    public Idea39113Service(Idea39113Config config) {
        this.config = config != null ? config : new Idea39113Config();
