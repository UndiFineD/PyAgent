...
@Data
public class Idea39326Config {
    private String name = "idea_039326";
 ...
 */
@Slf4j
public class Idea39326Service {
    private static final int IDEA_ID = 39326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39326Service() {
        this(new Idea39326Config());
    }

    public Idea39326Service(Idea39326Config config) {
        this.config = config != null ? config : new Idea39326Config();
