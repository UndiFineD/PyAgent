...
@Data
public class Idea38954Config {
    private String name = "idea_038954";
 ...
 */
@Slf4j
public class Idea38954Service {
    private static final int IDEA_ID = 38954;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38954Service() {
        this(new Idea38954Config());
    }

    public Idea38954Service(Idea38954Config config) {
        this.config = config != null ? config : new Idea38954Config();
