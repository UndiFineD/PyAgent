...
@Data
public class Idea39204Config {
    private String name = "idea_039204";
 ...
 */
@Slf4j
public class Idea39204Service {
    private static final int IDEA_ID = 39204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39204Service() {
        this(new Idea39204Config());
    }

    public Idea39204Service(Idea39204Config config) {
        this.config = config != null ? config : new Idea39204Config();
