...
@Data
public class Idea39124Config {
    private String name = "idea_039124";
 ...
 */
@Slf4j
public class Idea39124Service {
    private static final int IDEA_ID = 39124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39124Service() {
        this(new Idea39124Config());
    }

    public Idea39124Service(Idea39124Config config) {
        this.config = config != null ? config : new Idea39124Config();
