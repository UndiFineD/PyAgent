...
@Data
public class Idea39051Config {
    private String name = "idea_039051";
 ...
 */
@Slf4j
public class Idea39051Service {
    private static final int IDEA_ID = 39051;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39051Service() {
        this(new Idea39051Config());
    }

    public Idea39051Service(Idea39051Config config) {
        this.config = config != null ? config : new Idea39051Config();
