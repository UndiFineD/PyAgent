...
@Data
public class Idea39036Config {
    private String name = "idea_039036";
 ...
 */
@Slf4j
public class Idea39036Service {
    private static final int IDEA_ID = 39036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39036Service() {
        this(new Idea39036Config());
    }

    public Idea39036Service(Idea39036Config config) {
        this.config = config != null ? config : new Idea39036Config();
