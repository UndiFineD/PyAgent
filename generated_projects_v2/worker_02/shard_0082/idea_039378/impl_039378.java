...
@Data
public class Idea39378Config {
    private String name = "idea_039378";
 ...
 */
@Slf4j
public class Idea39378Service {
    private static final int IDEA_ID = 39378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39378Service() {
        this(new Idea39378Config());
    }

    public Idea39378Service(Idea39378Config config) {
        this.config = config != null ? config : new Idea39378Config();
