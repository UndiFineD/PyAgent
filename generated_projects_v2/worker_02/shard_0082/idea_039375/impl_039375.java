...
@Data
public class Idea39375Config {
    private String name = "idea_039375";
 ...
 */
@Slf4j
public class Idea39375Service {
    private static final int IDEA_ID = 39375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39375Service() {
        this(new Idea39375Config());
    }

    public Idea39375Service(Idea39375Config config) {
        this.config = config != null ? config : new Idea39375Config();
