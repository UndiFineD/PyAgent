...
@Data
public class Idea39023Config {
    private String name = "idea_039023";
 ...
 */
@Slf4j
public class Idea39023Service {
    private static final int IDEA_ID = 39023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39023Service() {
        this(new Idea39023Config());
    }

    public Idea39023Service(Idea39023Config config) {
        this.config = config != null ? config : new Idea39023Config();
