...
@Data
public class Idea39374Config {
    private String name = "idea_039374";
 ...
 */
@Slf4j
public class Idea39374Service {
    private static final int IDEA_ID = 39374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39374Service() {
        this(new Idea39374Config());
    }

    public Idea39374Service(Idea39374Config config) {
        this.config = config != null ? config : new Idea39374Config();
