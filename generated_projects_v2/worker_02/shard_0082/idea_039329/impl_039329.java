...
@Data
public class Idea39329Config {
    private String name = "idea_039329";
 ...
 */
@Slf4j
public class Idea39329Service {
    private static final int IDEA_ID = 39329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39329Service() {
        this(new Idea39329Config());
    }

    public Idea39329Service(Idea39329Config config) {
        this.config = config != null ? config : new Idea39329Config();
