...
@Data
public class Idea39022Config {
    private String name = "idea_039022";
 ...
 */
@Slf4j
public class Idea39022Service {
    private static final int IDEA_ID = 39022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39022Service() {
        this(new Idea39022Config());
    }

    public Idea39022Service(Idea39022Config config) {
        this.config = config != null ? config : new Idea39022Config();
