...
@Data
public class Idea39314Config {
    private String name = "idea_039314";
 ...
 */
@Slf4j
public class Idea39314Service {
    private static final int IDEA_ID = 39314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39314Service() {
        this(new Idea39314Config());
    }

    public Idea39314Service(Idea39314Config config) {
        this.config = config != null ? config : new Idea39314Config();
