...
@Data
public class Idea39419Config {
    private String name = "idea_039419";
 ...
 */
@Slf4j
public class Idea39419Service {
    private static final int IDEA_ID = 39419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39419Service() {
        this(new Idea39419Config());
    }

    public Idea39419Service(Idea39419Config config) {
        this.config = config != null ? config : new Idea39419Config();
