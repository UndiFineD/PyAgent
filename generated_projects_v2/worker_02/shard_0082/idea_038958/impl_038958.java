...
@Data
public class Idea38958Config {
    private String name = "idea_038958";
 ...
 */
@Slf4j
public class Idea38958Service {
    private static final int IDEA_ID = 38958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38958Service() {
        this(new Idea38958Config());
    }

    public Idea38958Service(Idea38958Config config) {
        this.config = config != null ? config : new Idea38958Config();
