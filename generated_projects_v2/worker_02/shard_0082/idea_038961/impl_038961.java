...
@Data
public class Idea38961Config {
    private String name = "idea_038961";
 ...
 */
@Slf4j
public class Idea38961Service {
    private static final int IDEA_ID = 38961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38961Service() {
        this(new Idea38961Config());
    }

    public Idea38961Service(Idea38961Config config) {
        this.config = config != null ? config : new Idea38961Config();
