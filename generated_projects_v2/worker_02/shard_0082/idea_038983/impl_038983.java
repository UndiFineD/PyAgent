...
@Data
public class Idea38983Config {
    private String name = "idea_038983";
 ...
 */
@Slf4j
public class Idea38983Service {
    private static final int IDEA_ID = 38983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38983Service() {
        this(new Idea38983Config());
    }

    public Idea38983Service(Idea38983Config config) {
        this.config = config != null ? config : new Idea38983Config();
