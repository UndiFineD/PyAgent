...
@Data
public class Idea39299Config {
    private String name = "idea_039299";
 ...
 */
@Slf4j
public class Idea39299Service {
    private static final int IDEA_ID = 39299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39299Service() {
        this(new Idea39299Config());
    }

    public Idea39299Service(Idea39299Config config) {
        this.config = config != null ? config : new Idea39299Config();
