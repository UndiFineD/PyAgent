...
@Data
public class Idea39237Config {
    private String name = "idea_039237";
 ...
 */
@Slf4j
public class Idea39237Service {
    private static final int IDEA_ID = 39237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39237Service() {
        this(new Idea39237Config());
    }

    public Idea39237Service(Idea39237Config config) {
        this.config = config != null ? config : new Idea39237Config();
