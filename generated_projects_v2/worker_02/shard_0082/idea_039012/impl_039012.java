...
@Data
public class Idea39012Config {
    private String name = "idea_039012";
 ...
 */
@Slf4j
public class Idea39012Service {
    private static final int IDEA_ID = 39012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39012Service() {
        this(new Idea39012Config());
    }

    public Idea39012Service(Idea39012Config config) {
        this.config = config != null ? config : new Idea39012Config();
