...
@Data
public class Idea39028Config {
    private String name = "idea_039028";
 ...
 */
@Slf4j
public class Idea39028Service {
    private static final int IDEA_ID = 39028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39028Service() {
        this(new Idea39028Config());
    }

    public Idea39028Service(Idea39028Config config) {
        this.config = config != null ? config : new Idea39028Config();
