...
@Data
public class Idea39254Config {
    private String name = "idea_039254";
 ...
 */
@Slf4j
public class Idea39254Service {
    private static final int IDEA_ID = 39254;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39254Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39254Service() {
        this(new Idea39254Config());
    }

    public Idea39254Service(Idea39254Config config) {
        this.config = config != null ? config : new Idea39254Config();
