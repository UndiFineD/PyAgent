...
@Data
public class Idea39222Config {
    private String name = "idea_039222";
 ...
 */
@Slf4j
public class Idea39222Service {
    private static final int IDEA_ID = 39222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39222Service() {
        this(new Idea39222Config());
    }

    public Idea39222Service(Idea39222Config config) {
        this.config = config != null ? config : new Idea39222Config();
