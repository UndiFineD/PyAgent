...
@Data
public class Idea38951Config {
    private String name = "idea_038951";
 ...
 */
@Slf4j
public class Idea38951Service {
    private static final int IDEA_ID = 38951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38951Service() {
        this(new Idea38951Config());
    }

    public Idea38951Service(Idea38951Config config) {
        this.config = config != null ? config : new Idea38951Config();
