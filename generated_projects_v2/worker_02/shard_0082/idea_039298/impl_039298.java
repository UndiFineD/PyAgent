...
@Data
public class Idea39298Config {
    private String name = "idea_039298";
 ...
 */
@Slf4j
public class Idea39298Service {
    private static final int IDEA_ID = 39298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39298Service() {
        this(new Idea39298Config());
    }

    public Idea39298Service(Idea39298Config config) {
        this.config = config != null ? config : new Idea39298Config();
