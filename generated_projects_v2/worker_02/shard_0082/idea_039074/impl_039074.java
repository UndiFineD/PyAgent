...
@Data
public class Idea39074Config {
    private String name = "idea_039074";
 ...
 */
@Slf4j
public class Idea39074Service {
    private static final int IDEA_ID = 39074;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39074Service() {
        this(new Idea39074Config());
    }

    public Idea39074Service(Idea39074Config config) {
        this.config = config != null ? config : new Idea39074Config();
