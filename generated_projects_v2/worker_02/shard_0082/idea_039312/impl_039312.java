...
@Data
public class Idea39312Config {
    private String name = "idea_039312";
 ...
 */
@Slf4j
public class Idea39312Service {
    private static final int IDEA_ID = 39312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39312Service() {
        this(new Idea39312Config());
    }

    public Idea39312Service(Idea39312Config config) {
        this.config = config != null ? config : new Idea39312Config();
