...
@Data
public class Idea39386Config {
    private String name = "idea_039386";
 ...
 */
@Slf4j
public class Idea39386Service {
    private static final int IDEA_ID = 39386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39386Service() {
        this(new Idea39386Config());
    }

    public Idea39386Service(Idea39386Config config) {
        this.config = config != null ? config : new Idea39386Config();
