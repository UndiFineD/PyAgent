...
@Data
public class Idea39166Config {
    private String name = "idea_039166";
 ...
 */
@Slf4j
public class Idea39166Service {
    private static final int IDEA_ID = 39166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39166Service() {
        this(new Idea39166Config());
    }

    public Idea39166Service(Idea39166Config config) {
        this.config = config != null ? config : new Idea39166Config();
