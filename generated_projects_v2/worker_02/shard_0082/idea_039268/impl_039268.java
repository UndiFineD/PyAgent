...
@Data
public class Idea39268Config {
    private String name = "idea_039268";
 ...
 */
@Slf4j
public class Idea39268Service {
    private static final int IDEA_ID = 39268;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39268Service() {
        this(new Idea39268Config());
    }

    public Idea39268Service(Idea39268Config config) {
        this.config = config != null ? config : new Idea39268Config();
