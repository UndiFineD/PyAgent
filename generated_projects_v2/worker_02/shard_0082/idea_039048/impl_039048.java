...
@Data
public class Idea39048Config {
    private String name = "idea_039048";
 ...
 */
@Slf4j
public class Idea39048Service {
    private static final int IDEA_ID = 39048;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39048Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39048Service() {
        this(new Idea39048Config());
    }

    public Idea39048Service(Idea39048Config config) {
        this.config = config != null ? config : new Idea39048Config();
