...
@Data
public class Idea39093Config {
    private String name = "idea_039093";
 ...
 */
@Slf4j
public class Idea39093Service {
    private static final int IDEA_ID = 39093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39093Service() {
        this(new Idea39093Config());
    }

    public Idea39093Service(Idea39093Config config) {
        this.config = config != null ? config : new Idea39093Config();
