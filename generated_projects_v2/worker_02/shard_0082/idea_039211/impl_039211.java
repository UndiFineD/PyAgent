...
@Data
public class Idea39211Config {
    private String name = "idea_039211";
 ...
 */
@Slf4j
public class Idea39211Service {
    private static final int IDEA_ID = 39211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39211Service() {
        this(new Idea39211Config());
    }

    public Idea39211Service(Idea39211Config config) {
        this.config = config != null ? config : new Idea39211Config();
