...
@Data
public class Idea38994Config {
    private String name = "idea_038994";
 ...
 */
@Slf4j
public class Idea38994Service {
    private static final int IDEA_ID = 38994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38994Service() {
        this(new Idea38994Config());
    }

    public Idea38994Service(Idea38994Config config) {
        this.config = config != null ? config : new Idea38994Config();
