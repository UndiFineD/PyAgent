...
@Data
public class Idea39117Config {
    private String name = "idea_039117";
 ...
 */
@Slf4j
public class Idea39117Service {
    private static final int IDEA_ID = 39117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39117Service() {
        this(new Idea39117Config());
    }

    public Idea39117Service(Idea39117Config config) {
        this.config = config != null ? config : new Idea39117Config();
