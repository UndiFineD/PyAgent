...
@Data
public class Idea39020Config {
    private String name = "idea_039020";
 ...
 */
@Slf4j
public class Idea39020Service {
    private static final int IDEA_ID = 39020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39020Service() {
        this(new Idea39020Config());
    }

    public Idea39020Service(Idea39020Config config) {
        this.config = config != null ? config : new Idea39020Config();
