...
@Data
public class Idea39186Config {
    private String name = "idea_039186";
 ...
 */
@Slf4j
public class Idea39186Service {
    private static final int IDEA_ID = 39186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39186Service() {
        this(new Idea39186Config());
    }

    public Idea39186Service(Idea39186Config config) {
        this.config = config != null ? config : new Idea39186Config();
