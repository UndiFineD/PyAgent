...
@Data
public class Idea39062Config {
    private String name = "idea_039062";
 ...
 */
@Slf4j
public class Idea39062Service {
    private static final int IDEA_ID = 39062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39062Service() {
        this(new Idea39062Config());
    }

    public Idea39062Service(Idea39062Config config) {
        this.config = config != null ? config : new Idea39062Config();
