...
@Data
public class Idea39320Config {
    private String name = "idea_039320";
 ...
 */
@Slf4j
public class Idea39320Service {
    private static final int IDEA_ID = 39320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39320Service() {
        this(new Idea39320Config());
    }

    public Idea39320Service(Idea39320Config config) {
        this.config = config != null ? config : new Idea39320Config();
