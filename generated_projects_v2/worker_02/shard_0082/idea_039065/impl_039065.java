...
@Data
public class Idea39065Config {
    private String name = "idea_039065";
 ...
 */
@Slf4j
public class Idea39065Service {
    private static final int IDEA_ID = 39065;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39065Service() {
        this(new Idea39065Config());
    }

    public Idea39065Service(Idea39065Config config) {
        this.config = config != null ? config : new Idea39065Config();
