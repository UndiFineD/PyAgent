...
@Data
public class Idea39410Config {
    private String name = "idea_039410";
 ...
 */
@Slf4j
public class Idea39410Service {
    private static final int IDEA_ID = 39410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39410Service() {
        this(new Idea39410Config());
    }

    public Idea39410Service(Idea39410Config config) {
        this.config = config != null ? config : new Idea39410Config();
