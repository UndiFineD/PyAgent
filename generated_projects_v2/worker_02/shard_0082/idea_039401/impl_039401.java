...
@Data
public class Idea39401Config {
    private String name = "idea_039401";
 ...
 */
@Slf4j
public class Idea39401Service {
    private static final int IDEA_ID = 39401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39401Service() {
        this(new Idea39401Config());
    }

    public Idea39401Service(Idea39401Config config) {
        this.config = config != null ? config : new Idea39401Config();
