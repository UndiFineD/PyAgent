...
@Data
public class Idea39288Config {
    private String name = "idea_039288";
 ...
 */
@Slf4j
public class Idea39288Service {
    private static final int IDEA_ID = 39288;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39288Service() {
        this(new Idea39288Config());
    }

    public Idea39288Service(Idea39288Config config) {
        this.config = config != null ? config : new Idea39288Config();
