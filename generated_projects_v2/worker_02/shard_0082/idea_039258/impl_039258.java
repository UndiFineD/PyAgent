...
@Data
public class Idea39258Config {
    private String name = "idea_039258";
 ...
 */
@Slf4j
public class Idea39258Service {
    private static final int IDEA_ID = 39258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39258Service() {
        this(new Idea39258Config());
    }

    public Idea39258Service(Idea39258Config config) {
        this.config = config != null ? config : new Idea39258Config();
