...
@Data
public class Idea39116Config {
    private String name = "idea_039116";
 ...
 */
@Slf4j
public class Idea39116Service {
    private static final int IDEA_ID = 39116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39116Service() {
        this(new Idea39116Config());
    }

    public Idea39116Service(Idea39116Config config) {
        this.config = config != null ? config : new Idea39116Config();
