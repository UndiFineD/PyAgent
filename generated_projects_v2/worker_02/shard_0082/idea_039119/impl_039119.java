...
@Data
public class Idea39119Config {
    private String name = "idea_039119";
 ...
 */
@Slf4j
public class Idea39119Service {
    private static final int IDEA_ID = 39119;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39119Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39119Service() {
        this(new Idea39119Config());
    }

    public Idea39119Service(Idea39119Config config) {
        this.config = config != null ? config : new Idea39119Config();
