...
@Data
public class Idea38963Config {
    private String name = "idea_038963";
 ...
 */
@Slf4j
public class Idea38963Service {
    private static final int IDEA_ID = 38963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38963Service() {
        this(new Idea38963Config());
    }

    public Idea38963Service(Idea38963Config config) {
        this.config = config != null ? config : new Idea38963Config();
