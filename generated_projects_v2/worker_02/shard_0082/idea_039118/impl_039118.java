...
@Data
public class Idea39118Config {
    private String name = "idea_039118";
 ...
 */
@Slf4j
public class Idea39118Service {
    private static final int IDEA_ID = 39118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39118Service() {
        this(new Idea39118Config());
    }

    public Idea39118Service(Idea39118Config config) {
        this.config = config != null ? config : new Idea39118Config();
