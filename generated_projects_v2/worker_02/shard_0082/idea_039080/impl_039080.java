...
@Data
public class Idea39080Config {
    private String name = "idea_039080";
 ...
 */
@Slf4j
public class Idea39080Service {
    private static final int IDEA_ID = 39080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39080Service() {
        this(new Idea39080Config());
    }

    public Idea39080Service(Idea39080Config config) {
        this.config = config != null ? config : new Idea39080Config();
