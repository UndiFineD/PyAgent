...
@Data
public class Idea39207Config {
    private String name = "idea_039207";
 ...
 */
@Slf4j
public class Idea39207Service {
    private static final int IDEA_ID = 39207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39207Service() {
        this(new Idea39207Config());
    }

    public Idea39207Service(Idea39207Config config) {
        this.config = config != null ? config : new Idea39207Config();
