...
@Data
public class Idea39083Config {
    private String name = "idea_039083";
 ...
 */
@Slf4j
public class Idea39083Service {
    private static final int IDEA_ID = 39083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39083Service() {
        this(new Idea39083Config());
    }

    public Idea39083Service(Idea39083Config config) {
        this.config = config != null ? config : new Idea39083Config();
