...
@Data
public class Idea39033Config {
    private String name = "idea_039033";
 ...
 */
@Slf4j
public class Idea39033Service {
    private static final int IDEA_ID = 39033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39033Service() {
        this(new Idea39033Config());
    }

    public Idea39033Service(Idea39033Config config) {
        this.config = config != null ? config : new Idea39033Config();
