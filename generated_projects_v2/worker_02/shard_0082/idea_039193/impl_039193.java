...
@Data
public class Idea39193Config {
    private String name = "idea_039193";
 ...
 */
@Slf4j
public class Idea39193Service {
    private static final int IDEA_ID = 39193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39193Service() {
        this(new Idea39193Config());
    }

    public Idea39193Service(Idea39193Config config) {
        this.config = config != null ? config : new Idea39193Config();
