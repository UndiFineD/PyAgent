...
@Data
public class Idea39040Config {
    private String name = "idea_039040";
 ...
 */
@Slf4j
public class Idea39040Service {
    private static final int IDEA_ID = 39040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39040Service() {
        this(new Idea39040Config());
    }

    public Idea39040Service(Idea39040Config config) {
        this.config = config != null ? config : new Idea39040Config();
