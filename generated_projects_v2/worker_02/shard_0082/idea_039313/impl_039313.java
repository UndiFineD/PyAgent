...
@Data
public class Idea39313Config {
    private String name = "idea_039313";
 ...
 */
@Slf4j
public class Idea39313Service {
    private static final int IDEA_ID = 39313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39313Service() {
        this(new Idea39313Config());
    }

    public Idea39313Service(Idea39313Config config) {
        this.config = config != null ? config : new Idea39313Config();
