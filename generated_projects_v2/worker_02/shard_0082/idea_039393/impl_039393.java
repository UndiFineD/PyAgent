...
@Data
public class Idea39393Config {
    private String name = "idea_039393";
 ...
 */
@Slf4j
public class Idea39393Service {
    private static final int IDEA_ID = 39393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39393Service() {
        this(new Idea39393Config());
    }

    public Idea39393Service(Idea39393Config config) {
        this.config = config != null ? config : new Idea39393Config();
