...
@Data
public class Idea39422Config {
    private String name = "idea_039422";
 ...
 */
@Slf4j
public class Idea39422Service {
    private static final int IDEA_ID = 39422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39422Service() {
        this(new Idea39422Config());
    }

    public Idea39422Service(Idea39422Config config) {
        this.config = config != null ? config : new Idea39422Config();
