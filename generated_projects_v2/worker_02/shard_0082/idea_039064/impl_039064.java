...
@Data
public class Idea39064Config {
    private String name = "idea_039064";
 ...
 */
@Slf4j
public class Idea39064Service {
    private static final int IDEA_ID = 39064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39064Service() {
        this(new Idea39064Config());
    }

    public Idea39064Service(Idea39064Config config) {
        this.config = config != null ? config : new Idea39064Config();
