...
@Data
public class Idea39134Config {
    private String name = "idea_039134";
 ...
 */
@Slf4j
public class Idea39134Service {
    private static final int IDEA_ID = 39134;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39134Service() {
        this(new Idea39134Config());
    }

    public Idea39134Service(Idea39134Config config) {
        this.config = config != null ? config : new Idea39134Config();
