...
@Data
public class Idea39403Config {
    private String name = "idea_039403";
 ...
 */
@Slf4j
public class Idea39403Service {
    private static final int IDEA_ID = 39403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39403Service() {
        this(new Idea39403Config());
    }

    public Idea39403Service(Idea39403Config config) {
        this.config = config != null ? config : new Idea39403Config();
