...
@Data
public class Idea39362Config {
    private String name = "idea_039362";
 ...
 */
@Slf4j
public class Idea39362Service {
    private static final int IDEA_ID = 39362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39362Service() {
        this(new Idea39362Config());
    }

    public Idea39362Service(Idea39362Config config) {
        this.config = config != null ? config : new Idea39362Config();
