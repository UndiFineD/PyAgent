...
@Data
public class Idea39143Config {
    private String name = "idea_039143";
 ...
 */
@Slf4j
public class Idea39143Service {
    private static final int IDEA_ID = 39143;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39143Service() {
        this(new Idea39143Config());
    }

    public Idea39143Service(Idea39143Config config) {
        this.config = config != null ? config : new Idea39143Config();
