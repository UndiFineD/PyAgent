...
@Data
public class Idea38974Config {
    private String name = "idea_038974";
 ...
 */
@Slf4j
public class Idea38974Service {
    private static final int IDEA_ID = 38974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38974Service() {
        this(new Idea38974Config());
    }

    public Idea38974Service(Idea38974Config config) {
        this.config = config != null ? config : new Idea38974Config();
