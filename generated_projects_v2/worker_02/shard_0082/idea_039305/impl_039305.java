...
@Data
public class Idea39305Config {
    private String name = "idea_039305";
 ...
 */
@Slf4j
public class Idea39305Service {
    private static final int IDEA_ID = 39305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39305Service() {
        this(new Idea39305Config());
    }

    public Idea39305Service(Idea39305Config config) {
        this.config = config != null ? config : new Idea39305Config();
