...
@Data
public class Idea39310Config {
    private String name = "idea_039310";
 ...
 */
@Slf4j
public class Idea39310Service {
    private static final int IDEA_ID = 39310;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39310Service() {
        this(new Idea39310Config());
    }

    public Idea39310Service(Idea39310Config config) {
        this.config = config != null ? config : new Idea39310Config();
