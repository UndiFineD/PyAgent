...
@Data
public class Idea39174Config {
    private String name = "idea_039174";
 ...
 */
@Slf4j
public class Idea39174Service {
    private static final int IDEA_ID = 39174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39174Service() {
        this(new Idea39174Config());
    }

    public Idea39174Service(Idea39174Config config) {
        this.config = config != null ? config : new Idea39174Config();
