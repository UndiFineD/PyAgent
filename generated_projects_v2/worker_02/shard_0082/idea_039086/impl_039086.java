...
@Data
public class Idea39086Config {
    private String name = "idea_039086";
 ...
 */
@Slf4j
public class Idea39086Service {
    private static final int IDEA_ID = 39086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39086Service() {
        this(new Idea39086Config());
    }

    public Idea39086Service(Idea39086Config config) {
        this.config = config != null ? config : new Idea39086Config();
