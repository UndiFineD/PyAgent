...
@Data
public class Idea39296Config {
    private String name = "idea_039296";
 ...
 */
@Slf4j
public class Idea39296Service {
    private static final int IDEA_ID = 39296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39296Service() {
        this(new Idea39296Config());
    }

    public Idea39296Service(Idea39296Config config) {
        this.config = config != null ? config : new Idea39296Config();
