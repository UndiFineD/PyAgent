...
@Data
public class Idea39213Config {
    private String name = "idea_039213";
 ...
 */
@Slf4j
public class Idea39213Service {
    private static final int IDEA_ID = 39213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39213Service() {
        this(new Idea39213Config());
    }

    public Idea39213Service(Idea39213Config config) {
        this.config = config != null ? config : new Idea39213Config();
