...
@Data
public class Idea39010Config {
    private String name = "idea_039010";
 ...
 */
@Slf4j
public class Idea39010Service {
    private static final int IDEA_ID = 39010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39010Service() {
        this(new Idea39010Config());
    }

    public Idea39010Service(Idea39010Config config) {
        this.config = config != null ? config : new Idea39010Config();
