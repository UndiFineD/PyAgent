...
@Data
public class Idea38976Config {
    private String name = "idea_038976";
 ...
 */
@Slf4j
public class Idea38976Service {
    private static final int IDEA_ID = 38976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38976Service() {
        this(new Idea38976Config());
    }

    public Idea38976Service(Idea38976Config config) {
        this.config = config != null ? config : new Idea38976Config();
