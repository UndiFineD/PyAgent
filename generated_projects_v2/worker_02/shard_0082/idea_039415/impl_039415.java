...
@Data
public class Idea39415Config {
    private String name = "idea_039415";
 ...
 */
@Slf4j
public class Idea39415Service {
    private static final int IDEA_ID = 39415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39415Service() {
        this(new Idea39415Config());
    }

    public Idea39415Service(Idea39415Config config) {
        this.config = config != null ? config : new Idea39415Config();
