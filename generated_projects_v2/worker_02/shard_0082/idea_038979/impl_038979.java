...
@Data
public class Idea38979Config {
    private String name = "idea_038979";
 ...
 */
@Slf4j
public class Idea38979Service {
    private static final int IDEA_ID = 38979;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38979Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38979Service() {
        this(new Idea38979Config());
    }

    public Idea38979Service(Idea38979Config config) {
        this.config = config != null ? config : new Idea38979Config();
