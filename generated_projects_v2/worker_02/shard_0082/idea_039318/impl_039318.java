...
@Data
public class Idea39318Config {
    private String name = "idea_039318";
 ...
 */
@Slf4j
public class Idea39318Service {
    private static final int IDEA_ID = 39318;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39318Service() {
        this(new Idea39318Config());
    }

    public Idea39318Service(Idea39318Config config) {
        this.config = config != null ? config : new Idea39318Config();
