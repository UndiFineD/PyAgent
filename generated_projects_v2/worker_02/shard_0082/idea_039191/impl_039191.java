...
@Data
public class Idea39191Config {
    private String name = "idea_039191";
 ...
 */
@Slf4j
public class Idea39191Service {
    private static final int IDEA_ID = 39191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39191Service() {
        this(new Idea39191Config());
    }

    public Idea39191Service(Idea39191Config config) {
        this.config = config != null ? config : new Idea39191Config();
