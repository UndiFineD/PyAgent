...
@Data
public class Idea39173Config {
    private String name = "idea_039173";
 ...
 */
@Slf4j
public class Idea39173Service {
    private static final int IDEA_ID = 39173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39173Service() {
        this(new Idea39173Config());
    }

    public Idea39173Service(Idea39173Config config) {
        this.config = config != null ? config : new Idea39173Config();
