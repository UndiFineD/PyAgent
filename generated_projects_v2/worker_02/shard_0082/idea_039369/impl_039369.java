...
@Data
public class Idea39369Config {
    private String name = "idea_039369";
 ...
 */
@Slf4j
public class Idea39369Service {
    private static final int IDEA_ID = 39369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39369Service() {
        this(new Idea39369Config());
    }

    public Idea39369Service(Idea39369Config config) {
        this.config = config != null ? config : new Idea39369Config();
