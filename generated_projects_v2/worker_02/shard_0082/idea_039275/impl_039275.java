...
@Data
public class Idea39275Config {
    private String name = "idea_039275";
 ...
 */
@Slf4j
public class Idea39275Service {
    private static final int IDEA_ID = 39275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39275Service() {
        this(new Idea39275Config());
    }

    public Idea39275Service(Idea39275Config config) {
        this.config = config != null ? config : new Idea39275Config();
