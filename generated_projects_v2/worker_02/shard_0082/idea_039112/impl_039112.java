...
@Data
public class Idea39112Config {
    private String name = "idea_039112";
 ...
 */
@Slf4j
public class Idea39112Service {
    private static final int IDEA_ID = 39112;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39112Service() {
        this(new Idea39112Config());
    }

    public Idea39112Service(Idea39112Config config) {
        this.config = config != null ? config : new Idea39112Config();
