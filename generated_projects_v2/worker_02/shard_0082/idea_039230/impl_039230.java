...
@Data
public class Idea39230Config {
    private String name = "idea_039230";
 ...
 */
@Slf4j
public class Idea39230Service {
    private static final int IDEA_ID = 39230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39230Service() {
        this(new Idea39230Config());
    }

    public Idea39230Service(Idea39230Config config) {
        this.config = config != null ? config : new Idea39230Config();
