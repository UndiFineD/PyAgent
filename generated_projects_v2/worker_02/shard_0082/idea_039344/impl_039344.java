...
@Data
public class Idea39344Config {
    private String name = "idea_039344";
 ...
 */
@Slf4j
public class Idea39344Service {
    private static final int IDEA_ID = 39344;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39344Service() {
        this(new Idea39344Config());
    }

    public Idea39344Service(Idea39344Config config) {
        this.config = config != null ? config : new Idea39344Config();
