...
@Data
public class Idea39168Config {
    private String name = "idea_039168";
 ...
 */
@Slf4j
public class Idea39168Service {
    private static final int IDEA_ID = 39168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39168Service() {
        this(new Idea39168Config());
    }

    public Idea39168Service(Idea39168Config config) {
        this.config = config != null ? config : new Idea39168Config();
