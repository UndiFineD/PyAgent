...
@Data
public class Idea39335Config {
    private String name = "idea_039335";
 ...
 */
@Slf4j
public class Idea39335Service {
    private static final int IDEA_ID = 39335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39335Service() {
        this(new Idea39335Config());
    }

    public Idea39335Service(Idea39335Config config) {
        this.config = config != null ? config : new Idea39335Config();
