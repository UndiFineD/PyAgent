...
@Data
public class Idea39000Config {
    private String name = "idea_039000";
 ...
 */
@Slf4j
public class Idea39000Service {
    private static final int IDEA_ID = 39000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39000Service() {
        this(new Idea39000Config());
    }

    public Idea39000Service(Idea39000Config config) {
        this.config = config != null ? config : new Idea39000Config();
