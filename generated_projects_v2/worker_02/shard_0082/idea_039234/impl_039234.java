...
@Data
public class Idea39234Config {
    private String name = "idea_039234";
 ...
 */
@Slf4j
public class Idea39234Service {
    private static final int IDEA_ID = 39234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39234Service() {
        this(new Idea39234Config());
    }

    public Idea39234Service(Idea39234Config config) {
        this.config = config != null ? config : new Idea39234Config();
