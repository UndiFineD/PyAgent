...
@Data
public class Idea39056Config {
    private String name = "idea_039056";
 ...
 */
@Slf4j
public class Idea39056Service {
    private static final int IDEA_ID = 39056;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39056Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39056Service() {
        this(new Idea39056Config());
    }

    public Idea39056Service(Idea39056Config config) {
        this.config = config != null ? config : new Idea39056Config();
