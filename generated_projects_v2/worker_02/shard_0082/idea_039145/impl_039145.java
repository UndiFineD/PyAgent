...
@Data
public class Idea39145Config {
    private String name = "idea_039145";
 ...
 */
@Slf4j
public class Idea39145Service {
    private static final int IDEA_ID = 39145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39145Service() {
        this(new Idea39145Config());
    }

    public Idea39145Service(Idea39145Config config) {
        this.config = config != null ? config : new Idea39145Config();
