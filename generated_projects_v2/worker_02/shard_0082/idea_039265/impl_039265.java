...
@Data
public class Idea39265Config {
    private String name = "idea_039265";
 ...
 */
@Slf4j
public class Idea39265Service {
    private static final int IDEA_ID = 39265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39265Service() {
        this(new Idea39265Config());
    }

    public Idea39265Service(Idea39265Config config) {
        this.config = config != null ? config : new Idea39265Config();
