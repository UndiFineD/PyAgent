...
@Data
public class Idea39383Config {
    private String name = "idea_039383";
 ...
 */
@Slf4j
public class Idea39383Service {
    private static final int IDEA_ID = 39383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39383Service() {
        this(new Idea39383Config());
    }

    public Idea39383Service(Idea39383Config config) {
        this.config = config != null ? config : new Idea39383Config();
