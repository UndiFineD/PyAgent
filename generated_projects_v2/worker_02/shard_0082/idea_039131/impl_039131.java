...
@Data
public class Idea39131Config {
    private String name = "idea_039131";
 ...
 */
@Slf4j
public class Idea39131Service {
    private static final int IDEA_ID = 39131;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39131Service() {
        this(new Idea39131Config());
    }

    public Idea39131Service(Idea39131Config config) {
        this.config = config != null ? config : new Idea39131Config();
