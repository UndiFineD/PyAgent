...
@Data
public class Idea39018Config {
    private String name = "idea_039018";
 ...
 */
@Slf4j
public class Idea39018Service {
    private static final int IDEA_ID = 39018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39018Service() {
        this(new Idea39018Config());
    }

    public Idea39018Service(Idea39018Config config) {
        this.config = config != null ? config : new Idea39018Config();
