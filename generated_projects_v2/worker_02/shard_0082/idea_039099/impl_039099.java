...
@Data
public class Idea39099Config {
    private String name = "idea_039099";
 ...
 */
@Slf4j
public class Idea39099Service {
    private static final int IDEA_ID = 39099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39099Service() {
        this(new Idea39099Config());
    }

    public Idea39099Service(Idea39099Config config) {
        this.config = config != null ? config : new Idea39099Config();
