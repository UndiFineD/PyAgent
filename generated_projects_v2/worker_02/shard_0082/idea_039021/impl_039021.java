...
@Data
public class Idea39021Config {
    private String name = "idea_039021";
 ...
 */
@Slf4j
public class Idea39021Service {
    private static final int IDEA_ID = 39021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39021Service() {
        this(new Idea39021Config());
    }

    public Idea39021Service(Idea39021Config config) {
        this.config = config != null ? config : new Idea39021Config();
