...
@Data
public class Idea39149Config {
    private String name = "idea_039149";
 ...
 */
@Slf4j
public class Idea39149Service {
    private static final int IDEA_ID = 39149;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39149Service() {
        this(new Idea39149Config());
    }

    public Idea39149Service(Idea39149Config config) {
        this.config = config != null ? config : new Idea39149Config();
