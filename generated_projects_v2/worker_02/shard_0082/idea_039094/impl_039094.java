...
@Data
public class Idea39094Config {
    private String name = "idea_039094";
 ...
 */
@Slf4j
public class Idea39094Service {
    private static final int IDEA_ID = 39094;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39094Service() {
        this(new Idea39094Config());
    }

    public Idea39094Service(Idea39094Config config) {
        this.config = config != null ? config : new Idea39094Config();
