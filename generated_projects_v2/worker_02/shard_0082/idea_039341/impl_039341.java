...
@Data
public class Idea39341Config {
    private String name = "idea_039341";
 ...
 */
@Slf4j
public class Idea39341Service {
    private static final int IDEA_ID = 39341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39341Service() {
        this(new Idea39341Config());
    }

    public Idea39341Service(Idea39341Config config) {
        this.config = config != null ? config : new Idea39341Config();
