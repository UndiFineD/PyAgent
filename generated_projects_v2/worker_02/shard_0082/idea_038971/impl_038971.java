...
@Data
public class Idea38971Config {
    private String name = "idea_038971";
 ...
 */
@Slf4j
public class Idea38971Service {
    private static final int IDEA_ID = 38971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38971Service() {
        this(new Idea38971Config());
    }

    public Idea38971Service(Idea38971Config config) {
        this.config = config != null ? config : new Idea38971Config();
