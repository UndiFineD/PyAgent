...
@Data
public class Idea39315Config {
    private String name = "idea_039315";
 ...
 */
@Slf4j
public class Idea39315Service {
    private static final int IDEA_ID = 39315;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39315Service() {
        this(new Idea39315Config());
    }

    public Idea39315Service(Idea39315Config config) {
        this.config = config != null ? config : new Idea39315Config();
