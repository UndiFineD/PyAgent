...
@Data
public class Idea41500Config {
    private String name = "idea_041500";
 ...
 */
@Slf4j
public class Idea41500Service {
    private static final int IDEA_ID = 41500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41500Service() {
        this(new Idea41500Config());
    }

    public Idea41500Service(Idea41500Config config) {
        this.config = config != null ? config : new Idea41500Config();
