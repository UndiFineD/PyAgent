...
@Data
public class Idea41346Config {
    private String name = "idea_041346";
 ...
 */
@Slf4j
public class Idea41346Service {
    private static final int IDEA_ID = 41346;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41346Service() {
        this(new Idea41346Config());
    }

    public Idea41346Service(Idea41346Config config) {
        this.config = config != null ? config : new Idea41346Config();
