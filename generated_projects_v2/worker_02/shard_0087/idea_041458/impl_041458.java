...
@Data
public class Idea41458Config {
    private String name = "idea_041458";
 ...
 */
@Slf4j
public class Idea41458Service {
    private static final int IDEA_ID = 41458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41458Service() {
        this(new Idea41458Config());
    }

    public Idea41458Service(Idea41458Config config) {
        this.config = config != null ? config : new Idea41458Config();
