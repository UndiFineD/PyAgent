...
@Data
public class Idea41759Config {
    private String name = "idea_041759";
 ...
 */
@Slf4j
public class Idea41759Service {
    private static final int IDEA_ID = 41759;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41759Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41759Service() {
        this(new Idea41759Config());
    }

    public Idea41759Service(Idea41759Config config) {
        this.config = config != null ? config : new Idea41759Config();
