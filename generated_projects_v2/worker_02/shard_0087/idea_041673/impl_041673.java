...
@Data
public class Idea41673Config {
    private String name = "idea_041673";
 ...
 */
@Slf4j
public class Idea41673Service {
    private static final int IDEA_ID = 41673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41673Service() {
        this(new Idea41673Config());
    }

    public Idea41673Service(Idea41673Config config) {
        this.config = config != null ? config : new Idea41673Config();
