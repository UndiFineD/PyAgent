...
@Data
public class Idea41354Config {
    private String name = "idea_041354";
 ...
 */
@Slf4j
public class Idea41354Service {
    private static final int IDEA_ID = 41354;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41354Service() {
        this(new Idea41354Config());
    }

    public Idea41354Service(Idea41354Config config) {
        this.config = config != null ? config : new Idea41354Config();
