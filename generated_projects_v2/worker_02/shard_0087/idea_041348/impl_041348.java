...
@Data
public class Idea41348Config {
    private String name = "idea_041348";
 ...
 */
@Slf4j
public class Idea41348Service {
    private static final int IDEA_ID = 41348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41348Service() {
        this(new Idea41348Config());
    }

    public Idea41348Service(Idea41348Config config) {
        this.config = config != null ? config : new Idea41348Config();
