...
@Data
public class Idea41628Config {
    private String name = "idea_041628";
 ...
 */
@Slf4j
public class Idea41628Service {
    private static final int IDEA_ID = 41628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41628Service() {
        this(new Idea41628Config());
    }

    public Idea41628Service(Idea41628Config config) {
        this.config = config != null ? config : new Idea41628Config();
