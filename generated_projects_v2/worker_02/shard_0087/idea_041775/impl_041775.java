...
@Data
public class Idea41775Config {
    private String name = "idea_041775";
 ...
 */
@Slf4j
public class Idea41775Service {
    private static final int IDEA_ID = 41775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41775Service() {
        this(new Idea41775Config());
    }

    public Idea41775Service(Idea41775Config config) {
        this.config = config != null ? config : new Idea41775Config();
