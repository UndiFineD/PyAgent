...
@Data
public class Idea41696Config {
    private String name = "idea_041696";
 ...
 */
@Slf4j
public class Idea41696Service {
    private static final int IDEA_ID = 41696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41696Service() {
        this(new Idea41696Config());
    }

    public Idea41696Service(Idea41696Config config) {
        this.config = config != null ? config : new Idea41696Config();
