...
@Data
public class Idea41425Config {
    private String name = "idea_041425";
 ...
 */
@Slf4j
public class Idea41425Service {
    private static final int IDEA_ID = 41425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41425Service() {
        this(new Idea41425Config());
    }

    public Idea41425Service(Idea41425Config config) {
        this.config = config != null ? config : new Idea41425Config();
