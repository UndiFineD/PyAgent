...
@Data
public class Idea41748Config {
    private String name = "idea_041748";
 ...
 */
@Slf4j
public class Idea41748Service {
    private static final int IDEA_ID = 41748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41748Service() {
        this(new Idea41748Config());
    }

    public Idea41748Service(Idea41748Config config) {
        this.config = config != null ? config : new Idea41748Config();
