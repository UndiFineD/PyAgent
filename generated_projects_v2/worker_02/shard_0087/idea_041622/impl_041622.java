...
@Data
public class Idea41622Config {
    private String name = "idea_041622";
 ...
 */
@Slf4j
public class Idea41622Service {
    private static final int IDEA_ID = 41622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41622Service() {
        this(new Idea41622Config());
    }

    public Idea41622Service(Idea41622Config config) {
        this.config = config != null ? config : new Idea41622Config();
