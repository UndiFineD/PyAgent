...
@Data
public class Idea41710Config {
    private String name = "idea_041710";
 ...
 */
@Slf4j
public class Idea41710Service {
    private static final int IDEA_ID = 41710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41710Service() {
        this(new Idea41710Config());
    }

    public Idea41710Service(Idea41710Config config) {
        this.config = config != null ? config : new Idea41710Config();
