...
@Data
public class Idea41501Config {
    private String name = "idea_041501";
 ...
 */
@Slf4j
public class Idea41501Service {
    private static final int IDEA_ID = 41501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41501Service() {
        this(new Idea41501Config());
    }

    public Idea41501Service(Idea41501Config config) {
        this.config = config != null ? config : new Idea41501Config();
