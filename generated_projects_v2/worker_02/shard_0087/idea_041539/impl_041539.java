...
@Data
public class Idea41539Config {
    private String name = "idea_041539";
 ...
 */
@Slf4j
public class Idea41539Service {
    private static final int IDEA_ID = 41539;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41539Service() {
        this(new Idea41539Config());
    }

    public Idea41539Service(Idea41539Config config) {
        this.config = config != null ? config : new Idea41539Config();
