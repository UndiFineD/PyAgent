...
@Data
public class Idea41446Config {
    private String name = "idea_041446";
 ...
 */
@Slf4j
public class Idea41446Service {
    private static final int IDEA_ID = 41446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41446Service() {
        this(new Idea41446Config());
    }

    public Idea41446Service(Idea41446Config config) {
        this.config = config != null ? config : new Idea41446Config();
