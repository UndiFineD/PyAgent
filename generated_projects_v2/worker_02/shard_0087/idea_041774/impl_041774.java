...
@Data
public class Idea41774Config {
    private String name = "idea_041774";
 ...
 */
@Slf4j
public class Idea41774Service {
    private static final int IDEA_ID = 41774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41774Service() {
        this(new Idea41774Config());
    }

    public Idea41774Service(Idea41774Config config) {
        this.config = config != null ? config : new Idea41774Config();
