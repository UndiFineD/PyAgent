...
@Data
public class Idea41691Config {
    private String name = "idea_041691";
 ...
 */
@Slf4j
public class Idea41691Service {
    private static final int IDEA_ID = 41691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41691Service() {
        this(new Idea41691Config());
    }

    public Idea41691Service(Idea41691Config config) {
        this.config = config != null ? config : new Idea41691Config();
