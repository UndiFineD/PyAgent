...
@Data
public class Idea41460Config {
    private String name = "idea_041460";
 ...
 */
@Slf4j
public class Idea41460Service {
    private static final int IDEA_ID = 41460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41460Service() {
        this(new Idea41460Config());
    }

    public Idea41460Service(Idea41460Config config) {
        this.config = config != null ? config : new Idea41460Config();
