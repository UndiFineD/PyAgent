...
@Data
public class Idea41415Config {
    private String name = "idea_041415";
 ...
 */
@Slf4j
public class Idea41415Service {
    private static final int IDEA_ID = 41415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41415Service() {
        this(new Idea41415Config());
    }

    public Idea41415Service(Idea41415Config config) {
        this.config = config != null ? config : new Idea41415Config();
