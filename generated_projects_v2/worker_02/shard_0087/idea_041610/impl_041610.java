...
@Data
public class Idea41610Config {
    private String name = "idea_041610";
 ...
 */
@Slf4j
public class Idea41610Service {
    private static final int IDEA_ID = 41610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41610Service() {
        this(new Idea41610Config());
    }

    public Idea41610Service(Idea41610Config config) {
        this.config = config != null ? config : new Idea41610Config();
