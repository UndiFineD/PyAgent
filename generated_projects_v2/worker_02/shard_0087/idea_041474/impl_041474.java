...
@Data
public class Idea41474Config {
    private String name = "idea_041474";
 ...
 */
@Slf4j
public class Idea41474Service {
    private static final int IDEA_ID = 41474;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41474Service() {
        this(new Idea41474Config());
    }

    public Idea41474Service(Idea41474Config config) {
        this.config = config != null ? config : new Idea41474Config();
