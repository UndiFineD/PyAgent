...
@Data
public class Idea41518Config {
    private String name = "idea_041518";
 ...
 */
@Slf4j
public class Idea41518Service {
    private static final int IDEA_ID = 41518;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41518Service() {
        this(new Idea41518Config());
    }

    public Idea41518Service(Idea41518Config config) {
        this.config = config != null ? config : new Idea41518Config();
