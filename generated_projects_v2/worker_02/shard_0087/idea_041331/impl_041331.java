...
@Data
public class Idea41331Config {
    private String name = "idea_041331";
 ...
 */
@Slf4j
public class Idea41331Service {
    private static final int IDEA_ID = 41331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41331Service() {
        this(new Idea41331Config());
    }

    public Idea41331Service(Idea41331Config config) {
        this.config = config != null ? config : new Idea41331Config();
