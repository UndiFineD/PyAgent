...
@Data
public class Idea41660Config {
    private String name = "idea_041660";
 ...
 */
@Slf4j
public class Idea41660Service {
    private static final int IDEA_ID = 41660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41660Service() {
        this(new Idea41660Config());
    }

    public Idea41660Service(Idea41660Config config) {
        this.config = config != null ? config : new Idea41660Config();
