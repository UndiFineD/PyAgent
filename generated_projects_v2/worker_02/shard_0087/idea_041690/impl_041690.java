...
@Data
public class Idea41690Config {
    private String name = "idea_041690";
 ...
 */
@Slf4j
public class Idea41690Service {
    private static final int IDEA_ID = 41690;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41690Service() {
        this(new Idea41690Config());
    }

    public Idea41690Service(Idea41690Config config) {
        this.config = config != null ? config : new Idea41690Config();
