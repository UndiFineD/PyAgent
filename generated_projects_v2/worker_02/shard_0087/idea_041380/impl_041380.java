...
@Data
public class Idea41380Config {
    private String name = "idea_041380";
 ...
 */
@Slf4j
public class Idea41380Service {
    private static final int IDEA_ID = 41380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41380Service() {
        this(new Idea41380Config());
    }

    public Idea41380Service(Idea41380Config config) {
        this.config = config != null ? config : new Idea41380Config();
