...
@Data
public class Idea41492Config {
    private String name = "idea_041492";
 ...
 */
@Slf4j
public class Idea41492Service {
    private static final int IDEA_ID = 41492;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41492Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41492Service() {
        this(new Idea41492Config());
    }

    public Idea41492Service(Idea41492Config config) {
        this.config = config != null ? config : new Idea41492Config();
