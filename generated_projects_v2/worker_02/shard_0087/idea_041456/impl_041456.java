...
@Data
public class Idea41456Config {
    private String name = "idea_041456";
 ...
 */
@Slf4j
public class Idea41456Service {
    private static final int IDEA_ID = 41456;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41456Service() {
        this(new Idea41456Config());
    }

    public Idea41456Service(Idea41456Config config) {
        this.config = config != null ? config : new Idea41456Config();
