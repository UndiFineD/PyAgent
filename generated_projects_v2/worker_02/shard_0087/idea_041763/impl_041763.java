...
@Data
public class Idea41763Config {
    private String name = "idea_041763";
 ...
 */
@Slf4j
public class Idea41763Service {
    private static final int IDEA_ID = 41763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41763Service() {
        this(new Idea41763Config());
    }

    public Idea41763Service(Idea41763Config config) {
        this.config = config != null ? config : new Idea41763Config();
