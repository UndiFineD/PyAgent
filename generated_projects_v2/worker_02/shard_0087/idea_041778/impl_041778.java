...
@Data
public class Idea41778Config {
    private String name = "idea_041778";
 ...
 */
@Slf4j
public class Idea41778Service {
    private static final int IDEA_ID = 41778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41778Service() {
        this(new Idea41778Config());
    }

    public Idea41778Service(Idea41778Config config) {
        this.config = config != null ? config : new Idea41778Config();
