...
@Data
public class Idea41418Config {
    private String name = "idea_041418";
 ...
 */
@Slf4j
public class Idea41418Service {
    private static final int IDEA_ID = 41418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41418Service() {
        this(new Idea41418Config());
    }

    public Idea41418Service(Idea41418Config config) {
        this.config = config != null ? config : new Idea41418Config();
