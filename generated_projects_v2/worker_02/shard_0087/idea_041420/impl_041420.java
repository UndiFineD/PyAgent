...
@Data
public class Idea41420Config {
    private String name = "idea_041420";
 ...
 */
@Slf4j
public class Idea41420Service {
    private static final int IDEA_ID = 41420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41420Service() {
        this(new Idea41420Config());
    }

    public Idea41420Service(Idea41420Config config) {
        this.config = config != null ? config : new Idea41420Config();
