...
@Data
public class Idea41556Config {
    private String name = "idea_041556";
 ...
 */
@Slf4j
public class Idea41556Service {
    private static final int IDEA_ID = 41556;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41556Service() {
        this(new Idea41556Config());
    }

    public Idea41556Service(Idea41556Config config) {
        this.config = config != null ? config : new Idea41556Config();
