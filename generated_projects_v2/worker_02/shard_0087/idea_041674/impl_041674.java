...
@Data
public class Idea41674Config {
    private String name = "idea_041674";
 ...
 */
@Slf4j
public class Idea41674Service {
    private static final int IDEA_ID = 41674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41674Service() {
        this(new Idea41674Config());
    }

    public Idea41674Service(Idea41674Config config) {
        this.config = config != null ? config : new Idea41674Config();
