...
@Data
public class Idea41605Config {
    private String name = "idea_041605";
 ...
 */
@Slf4j
public class Idea41605Service {
    private static final int IDEA_ID = 41605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41605Service() {
        this(new Idea41605Config());
    }

    public Idea41605Service(Idea41605Config config) {
        this.config = config != null ? config : new Idea41605Config();
