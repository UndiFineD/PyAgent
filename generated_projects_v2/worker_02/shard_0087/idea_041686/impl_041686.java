...
@Data
public class Idea41686Config {
    private String name = "idea_041686";
 ...
 */
@Slf4j
public class Idea41686Service {
    private static final int IDEA_ID = 41686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41686Service() {
        this(new Idea41686Config());
    }

    public Idea41686Service(Idea41686Config config) {
        this.config = config != null ? config : new Idea41686Config();
