...
@Data
public class Idea41597Config {
    private String name = "idea_041597";
 ...
 */
@Slf4j
public class Idea41597Service {
    private static final int IDEA_ID = 41597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41597Service() {
        this(new Idea41597Config());
    }

    public Idea41597Service(Idea41597Config config) {
        this.config = config != null ? config : new Idea41597Config();
