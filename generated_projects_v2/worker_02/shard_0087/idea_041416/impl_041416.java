...
@Data
public class Idea41416Config {
    private String name = "idea_041416";
 ...
 */
@Slf4j
public class Idea41416Service {
    private static final int IDEA_ID = 41416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41416Service() {
        this(new Idea41416Config());
    }

    public Idea41416Service(Idea41416Config config) {
        this.config = config != null ? config : new Idea41416Config();
