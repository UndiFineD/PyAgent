...
@Data
public class Idea41642Config {
    private String name = "idea_041642";
 ...
 */
@Slf4j
public class Idea41642Service {
    private static final int IDEA_ID = 41642;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41642Service() {
        this(new Idea41642Config());
    }

    public Idea41642Service(Idea41642Config config) {
        this.config = config != null ? config : new Idea41642Config();
