...
@Data
public class Idea41766Config {
    private String name = "idea_041766";
 ...
 */
@Slf4j
public class Idea41766Service {
    private static final int IDEA_ID = 41766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41766Service() {
        this(new Idea41766Config());
    }

    public Idea41766Service(Idea41766Config config) {
        this.config = config != null ? config : new Idea41766Config();
