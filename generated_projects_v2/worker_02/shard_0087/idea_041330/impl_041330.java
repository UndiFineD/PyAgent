...
@Data
public class Idea41330Config {
    private String name = "idea_041330";
 ...
 */
@Slf4j
public class Idea41330Service {
    private static final int IDEA_ID = 41330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41330Service() {
        this(new Idea41330Config());
    }

    public Idea41330Service(Idea41330Config config) {
        this.config = config != null ? config : new Idea41330Config();
