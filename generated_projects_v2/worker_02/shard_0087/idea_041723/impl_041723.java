...
@Data
public class Idea41723Config {
    private String name = "idea_041723";
 ...
 */
@Slf4j
public class Idea41723Service {
    private static final int IDEA_ID = 41723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41723Service() {
        this(new Idea41723Config());
    }

    public Idea41723Service(Idea41723Config config) {
        this.config = config != null ? config : new Idea41723Config();
