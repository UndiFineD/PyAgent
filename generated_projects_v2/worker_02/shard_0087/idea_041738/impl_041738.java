...
@Data
public class Idea41738Config {
    private String name = "idea_041738";
 ...
 */
@Slf4j
public class Idea41738Service {
    private static final int IDEA_ID = 41738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41738Service() {
        this(new Idea41738Config());
    }

    public Idea41738Service(Idea41738Config config) {
        this.config = config != null ? config : new Idea41738Config();
