...
@Data
public class Idea41601Config {
    private String name = "idea_041601";
 ...
 */
@Slf4j
public class Idea41601Service {
    private static final int IDEA_ID = 41601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41601Service() {
        this(new Idea41601Config());
    }

    public Idea41601Service(Idea41601Config config) {
        this.config = config != null ? config : new Idea41601Config();
