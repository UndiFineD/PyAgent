...
@Data
public class Idea41494Config {
    private String name = "idea_041494";
 ...
 */
@Slf4j
public class Idea41494Service {
    private static final int IDEA_ID = 41494;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41494Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41494Service() {
        this(new Idea41494Config());
    }

    public Idea41494Service(Idea41494Config config) {
        this.config = config != null ? config : new Idea41494Config();
