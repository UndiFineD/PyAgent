...
@Data
public class Idea41571Config {
    private String name = "idea_041571";
 ...
 */
@Slf4j
public class Idea41571Service {
    private static final int IDEA_ID = 41571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41571Service() {
        this(new Idea41571Config());
    }

    public Idea41571Service(Idea41571Config config) {
        this.config = config != null ? config : new Idea41571Config();
