...
@Data
public class Idea41362Config {
    private String name = "idea_041362";
 ...
 */
@Slf4j
public class Idea41362Service {
    private static final int IDEA_ID = 41362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41362Service() {
        this(new Idea41362Config());
    }

    public Idea41362Service(Idea41362Config config) {
        this.config = config != null ? config : new Idea41362Config();
