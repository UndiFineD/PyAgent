...
@Data
public class Idea41475Config {
    private String name = "idea_041475";
 ...
 */
@Slf4j
public class Idea41475Service {
    private static final int IDEA_ID = 41475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41475Service() {
        this(new Idea41475Config());
    }

    public Idea41475Service(Idea41475Config config) {
        this.config = config != null ? config : new Idea41475Config();
