...
@Data
public class Idea41663Config {
    private String name = "idea_041663";
 ...
 */
@Slf4j
public class Idea41663Service {
    private static final int IDEA_ID = 41663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41663Service() {
        this(new Idea41663Config());
    }

    public Idea41663Service(Idea41663Config config) {
        this.config = config != null ? config : new Idea41663Config();
