...
@Data
public class Idea41680Config {
    private String name = "idea_041680";
 ...
 */
@Slf4j
public class Idea41680Service {
    private static final int IDEA_ID = 41680;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41680Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41680Service() {
        this(new Idea41680Config());
    }

    public Idea41680Service(Idea41680Config config) {
        this.config = config != null ? config : new Idea41680Config();
