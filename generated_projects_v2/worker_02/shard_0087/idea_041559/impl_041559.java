...
@Data
public class Idea41559Config {
    private String name = "idea_041559";
 ...
 */
@Slf4j
public class Idea41559Service {
    private static final int IDEA_ID = 41559;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41559Service() {
        this(new Idea41559Config());
    }

    public Idea41559Service(Idea41559Config config) {
        this.config = config != null ? config : new Idea41559Config();
