...
@Data
public class Idea41540Config {
    private String name = "idea_041540";
 ...
 */
@Slf4j
public class Idea41540Service {
    private static final int IDEA_ID = 41540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41540Service() {
        this(new Idea41540Config());
    }

    public Idea41540Service(Idea41540Config config) {
        this.config = config != null ? config : new Idea41540Config();
