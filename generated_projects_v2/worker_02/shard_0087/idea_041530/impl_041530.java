...
@Data
public class Idea41530Config {
    private String name = "idea_041530";
 ...
 */
@Slf4j
public class Idea41530Service {
    private static final int IDEA_ID = 41530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41530Service() {
        this(new Idea41530Config());
    }

    public Idea41530Service(Idea41530Config config) {
        this.config = config != null ? config : new Idea41530Config();
