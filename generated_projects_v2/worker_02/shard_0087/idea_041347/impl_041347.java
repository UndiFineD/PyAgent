...
@Data
public class Idea41347Config {
    private String name = "idea_041347";
 ...
 */
@Slf4j
public class Idea41347Service {
    private static final int IDEA_ID = 41347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41347Service() {
        this(new Idea41347Config());
    }

    public Idea41347Service(Idea41347Config config) {
        this.config = config != null ? config : new Idea41347Config();
