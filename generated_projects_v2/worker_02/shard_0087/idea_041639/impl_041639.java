...
@Data
public class Idea41639Config {
    private String name = "idea_041639";
 ...
 */
@Slf4j
public class Idea41639Service {
    private static final int IDEA_ID = 41639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41639Service() {
        this(new Idea41639Config());
    }

    public Idea41639Service(Idea41639Config config) {
        this.config = config != null ? config : new Idea41639Config();
