...
@Data
public class Idea41404Config {
    private String name = "idea_041404";
 ...
 */
@Slf4j
public class Idea41404Service {
    private static final int IDEA_ID = 41404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41404Service() {
        this(new Idea41404Config());
    }

    public Idea41404Service(Idea41404Config config) {
        this.config = config != null ? config : new Idea41404Config();
