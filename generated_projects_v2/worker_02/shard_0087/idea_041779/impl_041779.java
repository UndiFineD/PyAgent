...
@Data
public class Idea41779Config {
    private String name = "idea_041779";
 ...
 */
@Slf4j
public class Idea41779Service {
    private static final int IDEA_ID = 41779;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41779Service() {
        this(new Idea41779Config());
    }

    public Idea41779Service(Idea41779Config config) {
        this.config = config != null ? config : new Idea41779Config();
