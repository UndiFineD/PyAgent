...
@Data
public class Idea41706Config {
    private String name = "idea_041706";
 ...
 */
@Slf4j
public class Idea41706Service {
    private static final int IDEA_ID = 41706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41706Service() {
        this(new Idea41706Config());
    }

    public Idea41706Service(Idea41706Config config) {
        this.config = config != null ? config : new Idea41706Config();
