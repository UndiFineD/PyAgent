...
@Data
public class Idea41528Config {
    private String name = "idea_041528";
 ...
 */
@Slf4j
public class Idea41528Service {
    private static final int IDEA_ID = 41528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41528Service() {
        this(new Idea41528Config());
    }

    public Idea41528Service(Idea41528Config config) {
        this.config = config != null ? config : new Idea41528Config();
