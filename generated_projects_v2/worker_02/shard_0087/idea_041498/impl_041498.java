...
@Data
public class Idea41498Config {
    private String name = "idea_041498";
 ...
 */
@Slf4j
public class Idea41498Service {
    private static final int IDEA_ID = 41498;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41498Service() {
        this(new Idea41498Config());
    }

    public Idea41498Service(Idea41498Config config) {
        this.config = config != null ? config : new Idea41498Config();
