...
@Data
public class Idea41472Config {
    private String name = "idea_041472";
 ...
 */
@Slf4j
public class Idea41472Service {
    private static final int IDEA_ID = 41472;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41472Service() {
        this(new Idea41472Config());
    }

    public Idea41472Service(Idea41472Config config) {
        this.config = config != null ? config : new Idea41472Config();
