...
@Data
public class Idea41701Config {
    private String name = "idea_041701";
 ...
 */
@Slf4j
public class Idea41701Service {
    private static final int IDEA_ID = 41701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41701Service() {
        this(new Idea41701Config());
    }

    public Idea41701Service(Idea41701Config config) {
        this.config = config != null ? config : new Idea41701Config();
