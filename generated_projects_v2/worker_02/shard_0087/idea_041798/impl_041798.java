...
@Data
public class Idea41798Config {
    private String name = "idea_041798";
 ...
 */
@Slf4j
public class Idea41798Service {
    private static final int IDEA_ID = 41798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41798Service() {
        this(new Idea41798Config());
    }

    public Idea41798Service(Idea41798Config config) {
        this.config = config != null ? config : new Idea41798Config();
