...
@Data
public class Idea41606Config {
    private String name = "idea_041606";
 ...
 */
@Slf4j
public class Idea41606Service {
    private static final int IDEA_ID = 41606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41606Service() {
        this(new Idea41606Config());
    }

    public Idea41606Service(Idea41606Config config) {
        this.config = config != null ? config : new Idea41606Config();
