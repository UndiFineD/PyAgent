...
@Data
public class Idea41676Config {
    private String name = "idea_041676";
 ...
 */
@Slf4j
public class Idea41676Service {
    private static final int IDEA_ID = 41676;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41676Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41676Service() {
        this(new Idea41676Config());
    }

    public Idea41676Service(Idea41676Config config) {
        this.config = config != null ? config : new Idea41676Config();
