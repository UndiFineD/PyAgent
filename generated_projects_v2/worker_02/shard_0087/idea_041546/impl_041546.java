...
@Data
public class Idea41546Config {
    private String name = "idea_041546";
 ...
 */
@Slf4j
public class Idea41546Service {
    private static final int IDEA_ID = 41546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41546Service() {
        this(new Idea41546Config());
    }

    public Idea41546Service(Idea41546Config config) {
        this.config = config != null ? config : new Idea41546Config();
