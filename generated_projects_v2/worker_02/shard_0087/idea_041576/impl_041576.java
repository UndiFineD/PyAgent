...
@Data
public class Idea41576Config {
    private String name = "idea_041576";
 ...
 */
@Slf4j
public class Idea41576Service {
    private static final int IDEA_ID = 41576;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41576Service() {
        this(new Idea41576Config());
    }

    public Idea41576Service(Idea41576Config config) {
        this.config = config != null ? config : new Idea41576Config();
