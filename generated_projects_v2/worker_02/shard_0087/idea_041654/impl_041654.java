...
@Data
public class Idea41654Config {
    private String name = "idea_041654";
 ...
 */
@Slf4j
public class Idea41654Service {
    private static final int IDEA_ID = 41654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41654Service() {
        this(new Idea41654Config());
    }

    public Idea41654Service(Idea41654Config config) {
        this.config = config != null ? config : new Idea41654Config();
