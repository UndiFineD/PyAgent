...
@Data
public class Idea41561Config {
    private String name = "idea_041561";
 ...
 */
@Slf4j
public class Idea41561Service {
    private static final int IDEA_ID = 41561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41561Service() {
        this(new Idea41561Config());
    }

    public Idea41561Service(Idea41561Config config) {
        this.config = config != null ? config : new Idea41561Config();
