...
@Data
public class Idea41568Config {
    private String name = "idea_041568";
 ...
 */
@Slf4j
public class Idea41568Service {
    private static final int IDEA_ID = 41568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41568Service() {
        this(new Idea41568Config());
    }

    public Idea41568Service(Idea41568Config config) {
        this.config = config != null ? config : new Idea41568Config();
