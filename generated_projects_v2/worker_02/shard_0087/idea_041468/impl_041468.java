...
@Data
public class Idea41468Config {
    private String name = "idea_041468";
 ...
 */
@Slf4j
public class Idea41468Service {
    private static final int IDEA_ID = 41468;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41468Service() {
        this(new Idea41468Config());
    }

    public Idea41468Service(Idea41468Config config) {
        this.config = config != null ? config : new Idea41468Config();
