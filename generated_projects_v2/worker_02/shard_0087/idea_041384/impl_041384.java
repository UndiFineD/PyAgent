...
@Data
public class Idea41384Config {
    private String name = "idea_041384";
 ...
 */
@Slf4j
public class Idea41384Service {
    private static final int IDEA_ID = 41384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41384Service() {
        this(new Idea41384Config());
    }

    public Idea41384Service(Idea41384Config config) {
        this.config = config != null ? config : new Idea41384Config();
