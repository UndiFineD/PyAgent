...
@Data
public class Idea41538Config {
    private String name = "idea_041538";
 ...
 */
@Slf4j
public class Idea41538Service {
    private static final int IDEA_ID = 41538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41538Service() {
        this(new Idea41538Config());
    }

    public Idea41538Service(Idea41538Config config) {
        this.config = config != null ? config : new Idea41538Config();
