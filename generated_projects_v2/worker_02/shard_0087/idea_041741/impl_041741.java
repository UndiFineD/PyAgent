...
@Data
public class Idea41741Config {
    private String name = "idea_041741";
 ...
 */
@Slf4j
public class Idea41741Service {
    private static final int IDEA_ID = 41741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41741Service() {
        this(new Idea41741Config());
    }

    public Idea41741Service(Idea41741Config config) {
        this.config = config != null ? config : new Idea41741Config();
