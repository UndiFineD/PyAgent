...
@Data
public class Idea41720Config {
    private String name = "idea_041720";
 ...
 */
@Slf4j
public class Idea41720Service {
    private static final int IDEA_ID = 41720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41720Service() {
        this(new Idea41720Config());
    }

    public Idea41720Service(Idea41720Config config) {
        this.config = config != null ? config : new Idea41720Config();
