...
@Data
public class Idea41328Config {
    private String name = "idea_041328";
 ...
 */
@Slf4j
public class Idea41328Service {
    private static final int IDEA_ID = 41328;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41328Service() {
        this(new Idea41328Config());
    }

    public Idea41328Service(Idea41328Config config) {
        this.config = config != null ? config : new Idea41328Config();
