...
@Data
public class Idea41327Config {
    private String name = "idea_041327";
 ...
 */
@Slf4j
public class Idea41327Service {
    private static final int IDEA_ID = 41327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41327Service() {
        this(new Idea41327Config());
    }

    public Idea41327Service(Idea41327Config config) {
        this.config = config != null ? config : new Idea41327Config();
