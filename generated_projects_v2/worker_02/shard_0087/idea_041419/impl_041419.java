...
@Data
public class Idea41419Config {
    private String name = "idea_041419";
 ...
 */
@Slf4j
public class Idea41419Service {
    private static final int IDEA_ID = 41419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41419Service() {
        this(new Idea41419Config());
    }

    public Idea41419Service(Idea41419Config config) {
        this.config = config != null ? config : new Idea41419Config();
