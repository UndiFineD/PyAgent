...
@Data
public class Idea41467Config {
    private String name = "idea_041467";
 ...
 */
@Slf4j
public class Idea41467Service {
    private static final int IDEA_ID = 41467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41467Service() {
        this(new Idea41467Config());
    }

    public Idea41467Service(Idea41467Config config) {
        this.config = config != null ? config : new Idea41467Config();
