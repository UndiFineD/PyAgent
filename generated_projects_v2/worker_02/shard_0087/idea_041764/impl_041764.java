...
@Data
public class Idea41764Config {
    private String name = "idea_041764";
 ...
 */
@Slf4j
public class Idea41764Service {
    private static final int IDEA_ID = 41764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41764Service() {
        this(new Idea41764Config());
    }

    public Idea41764Service(Idea41764Config config) {
        this.config = config != null ? config : new Idea41764Config();
