...
@Data
public class Idea41397Config {
    private String name = "idea_041397";
 ...
 */
@Slf4j
public class Idea41397Service {
    private static final int IDEA_ID = 41397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41397Service() {
        this(new Idea41397Config());
    }

    public Idea41397Service(Idea41397Config config) {
        this.config = config != null ? config : new Idea41397Config();
