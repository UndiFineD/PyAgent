...
@Data
public class Idea41536Config {
    private String name = "idea_041536";
 ...
 */
@Slf4j
public class Idea41536Service {
    private static final int IDEA_ID = 41536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41536Service() {
        this(new Idea41536Config());
    }

    public Idea41536Service(Idea41536Config config) {
        this.config = config != null ? config : new Idea41536Config();
