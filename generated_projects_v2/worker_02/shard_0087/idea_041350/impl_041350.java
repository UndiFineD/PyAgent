...
@Data
public class Idea41350Config {
    private String name = "idea_041350";
 ...
 */
@Slf4j
public class Idea41350Service {
    private static final int IDEA_ID = 41350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41350Service() {
        this(new Idea41350Config());
    }

    public Idea41350Service(Idea41350Config config) {
        this.config = config != null ? config : new Idea41350Config();
