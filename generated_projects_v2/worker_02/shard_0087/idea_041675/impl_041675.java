...
@Data
public class Idea41675Config {
    private String name = "idea_041675";
 ...
 */
@Slf4j
public class Idea41675Service {
    private static final int IDEA_ID = 41675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41675Service() {
        this(new Idea41675Config());
    }

    public Idea41675Service(Idea41675Config config) {
        this.config = config != null ? config : new Idea41675Config();
