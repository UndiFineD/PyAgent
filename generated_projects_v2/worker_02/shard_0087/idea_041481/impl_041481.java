...
@Data
public class Idea41481Config {
    private String name = "idea_041481";
 ...
 */
@Slf4j
public class Idea41481Service {
    private static final int IDEA_ID = 41481;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41481Service() {
        this(new Idea41481Config());
    }

    public Idea41481Service(Idea41481Config config) {
        this.config = config != null ? config : new Idea41481Config();
