...
@Data
public class Idea41651Config {
    private String name = "idea_041651";
 ...
 */
@Slf4j
public class Idea41651Service {
    private static final int IDEA_ID = 41651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41651Service() {
        this(new Idea41651Config());
    }

    public Idea41651Service(Idea41651Config config) {
        this.config = config != null ? config : new Idea41651Config();
