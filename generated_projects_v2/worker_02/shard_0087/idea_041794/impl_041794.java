...
@Data
public class Idea41794Config {
    private String name = "idea_041794";
 ...
 */
@Slf4j
public class Idea41794Service {
    private static final int IDEA_ID = 41794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41794Service() {
        this(new Idea41794Config());
    }

    public Idea41794Service(Idea41794Config config) {
        this.config = config != null ? config : new Idea41794Config();
