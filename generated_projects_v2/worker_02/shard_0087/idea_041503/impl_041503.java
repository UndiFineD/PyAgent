...
@Data
public class Idea41503Config {
    private String name = "idea_041503";
 ...
 */
@Slf4j
public class Idea41503Service {
    private static final int IDEA_ID = 41503;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41503Service() {
        this(new Idea41503Config());
    }

    public Idea41503Service(Idea41503Config config) {
        this.config = config != null ? config : new Idea41503Config();
