...
@Data
public class Idea41662Config {
    private String name = "idea_041662";
 ...
 */
@Slf4j
public class Idea41662Service {
    private static final int IDEA_ID = 41662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41662Service() {
        this(new Idea41662Config());
    }

    public Idea41662Service(Idea41662Config config) {
        this.config = config != null ? config : new Idea41662Config();
