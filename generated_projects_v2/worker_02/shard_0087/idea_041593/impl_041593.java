...
@Data
public class Idea41593Config {
    private String name = "idea_041593";
 ...
 */
@Slf4j
public class Idea41593Service {
    private static final int IDEA_ID = 41593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41593Service() {
        this(new Idea41593Config());
    }

    public Idea41593Service(Idea41593Config config) {
        this.config = config != null ? config : new Idea41593Config();
