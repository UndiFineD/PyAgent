...
@Data
public class Idea41407Config {
    private String name = "idea_041407";
 ...
 */
@Slf4j
public class Idea41407Service {
    private static final int IDEA_ID = 41407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41407Service() {
        this(new Idea41407Config());
    }

    public Idea41407Service(Idea41407Config config) {
        this.config = config != null ? config : new Idea41407Config();
