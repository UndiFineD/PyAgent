...
@Data
public class Idea41557Config {
    private String name = "idea_041557";
 ...
 */
@Slf4j
public class Idea41557Service {
    private static final int IDEA_ID = 41557;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41557Service() {
        this(new Idea41557Config());
    }

    public Idea41557Service(Idea41557Config config) {
        this.config = config != null ? config : new Idea41557Config();
