...
@Data
public class Idea41369Config {
    private String name = "idea_041369";
 ...
 */
@Slf4j
public class Idea41369Service {
    private static final int IDEA_ID = 41369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41369Service() {
        this(new Idea41369Config());
    }

    public Idea41369Service(Idea41369Config config) {
        this.config = config != null ? config : new Idea41369Config();
