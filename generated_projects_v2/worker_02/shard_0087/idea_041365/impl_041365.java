...
@Data
public class Idea41365Config {
    private String name = "idea_041365";
 ...
 */
@Slf4j
public class Idea41365Service {
    private static final int IDEA_ID = 41365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41365Service() {
        this(new Idea41365Config());
    }

    public Idea41365Service(Idea41365Config config) {
        this.config = config != null ? config : new Idea41365Config();
