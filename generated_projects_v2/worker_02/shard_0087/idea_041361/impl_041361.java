...
@Data
public class Idea41361Config {
    private String name = "idea_041361";
 ...
 */
@Slf4j
public class Idea41361Service {
    private static final int IDEA_ID = 41361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41361Service() {
        this(new Idea41361Config());
    }

    public Idea41361Service(Idea41361Config config) {
        this.config = config != null ? config : new Idea41361Config();
