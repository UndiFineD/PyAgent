...
@Data
public class Idea41421Config {
    private String name = "idea_041421";
 ...
 */
@Slf4j
public class Idea41421Service {
    private static final int IDEA_ID = 41421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41421Service() {
        this(new Idea41421Config());
    }

    public Idea41421Service(Idea41421Config config) {
        this.config = config != null ? config : new Idea41421Config();
