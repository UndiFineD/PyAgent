...
@Data
public class Idea41598Config {
    private String name = "idea_041598";
 ...
 */
@Slf4j
public class Idea41598Service {
    private static final int IDEA_ID = 41598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41598Service() {
        this(new Idea41598Config());
    }

    public Idea41598Service(Idea41598Config config) {
        this.config = config != null ? config : new Idea41598Config();
