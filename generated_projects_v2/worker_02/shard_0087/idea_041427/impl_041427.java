...
@Data
public class Idea41427Config {
    private String name = "idea_041427";
 ...
 */
@Slf4j
public class Idea41427Service {
    private static final int IDEA_ID = 41427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41427Service() {
        this(new Idea41427Config());
    }

    public Idea41427Service(Idea41427Config config) {
        this.config = config != null ? config : new Idea41427Config();
