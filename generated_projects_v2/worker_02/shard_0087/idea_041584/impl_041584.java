...
@Data
public class Idea41584Config {
    private String name = "idea_041584";
 ...
 */
@Slf4j
public class Idea41584Service {
    private static final int IDEA_ID = 41584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41584Service() {
        this(new Idea41584Config());
    }

    public Idea41584Service(Idea41584Config config) {
        this.config = config != null ? config : new Idea41584Config();
