...
@Data
public class Idea41375Config {
    private String name = "idea_041375";
 ...
 */
@Slf4j
public class Idea41375Service {
    private static final int IDEA_ID = 41375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41375Service() {
        this(new Idea41375Config());
    }

    public Idea41375Service(Idea41375Config config) {
        this.config = config != null ? config : new Idea41375Config();
