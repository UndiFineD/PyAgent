...
@Data
public class Idea41633Config {
    private String name = "idea_041633";
 ...
 */
@Slf4j
public class Idea41633Service {
    private static final int IDEA_ID = 41633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41633Service() {
        this(new Idea41633Config());
    }

    public Idea41633Service(Idea41633Config config) {
        this.config = config != null ? config : new Idea41633Config();
