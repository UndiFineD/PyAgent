...
@Data
public class Idea41647Config {
    private String name = "idea_041647";
 ...
 */
@Slf4j
public class Idea41647Service {
    private static final int IDEA_ID = 41647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41647Service() {
        this(new Idea41647Config());
    }

    public Idea41647Service(Idea41647Config config) {
        this.config = config != null ? config : new Idea41647Config();
