...
@Data
public class Idea41379Config {
    private String name = "idea_041379";
 ...
 */
@Slf4j
public class Idea41379Service {
    private static final int IDEA_ID = 41379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41379Service() {
        this(new Idea41379Config());
    }

    public Idea41379Service(Idea41379Config config) {
        this.config = config != null ? config : new Idea41379Config();
