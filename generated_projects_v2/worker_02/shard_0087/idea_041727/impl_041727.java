...
@Data
public class Idea41727Config {
    private String name = "idea_041727";
 ...
 */
@Slf4j
public class Idea41727Service {
    private static final int IDEA_ID = 41727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41727Service() {
        this(new Idea41727Config());
    }

    public Idea41727Service(Idea41727Config config) {
        this.config = config != null ? config : new Idea41727Config();
