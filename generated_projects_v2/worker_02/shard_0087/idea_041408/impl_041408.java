...
@Data
public class Idea41408Config {
    private String name = "idea_041408";
 ...
 */
@Slf4j
public class Idea41408Service {
    private static final int IDEA_ID = 41408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41408Service() {
        this(new Idea41408Config());
    }

    public Idea41408Service(Idea41408Config config) {
        this.config = config != null ? config : new Idea41408Config();
