...
@Data
public class Idea41550Config {
    private String name = "idea_041550";
 ...
 */
@Slf4j
public class Idea41550Service {
    private static final int IDEA_ID = 41550;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41550Service() {
        this(new Idea41550Config());
    }

    public Idea41550Service(Idea41550Config config) {
        this.config = config != null ? config : new Idea41550Config();
