...
@Data
public class Idea41535Config {
    private String name = "idea_041535";
 ...
 */
@Slf4j
public class Idea41535Service {
    private static final int IDEA_ID = 41535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41535Service() {
        this(new Idea41535Config());
    }

    public Idea41535Service(Idea41535Config config) {
        this.config = config != null ? config : new Idea41535Config();
