...
@Data
public class Idea41441Config {
    private String name = "idea_041441";
 ...
 */
@Slf4j
public class Idea41441Service {
    private static final int IDEA_ID = 41441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41441Service() {
        this(new Idea41441Config());
    }

    public Idea41441Service(Idea41441Config config) {
        this.config = config != null ? config : new Idea41441Config();
