...
@Data
public class Idea41549Config {
    private String name = "idea_041549";
 ...
 */
@Slf4j
public class Idea41549Service {
    private static final int IDEA_ID = 41549;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41549Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41549Service() {
        this(new Idea41549Config());
    }

    public Idea41549Service(Idea41549Config config) {
        this.config = config != null ? config : new Idea41549Config();
