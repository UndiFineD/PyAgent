...
@Data
public class Idea41724Config {
    private String name = "idea_041724";
 ...
 */
@Slf4j
public class Idea41724Service {
    private static final int IDEA_ID = 41724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41724Service() {
        this(new Idea41724Config());
    }

    public Idea41724Service(Idea41724Config config) {
        this.config = config != null ? config : new Idea41724Config();
