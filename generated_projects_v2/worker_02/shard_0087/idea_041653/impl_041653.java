...
@Data
public class Idea41653Config {
    private String name = "idea_041653";
 ...
 */
@Slf4j
public class Idea41653Service {
    private static final int IDEA_ID = 41653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41653Service() {
        this(new Idea41653Config());
    }

    public Idea41653Service(Idea41653Config config) {
        this.config = config != null ? config : new Idea41653Config();
