...
@Data
public class Idea41370Config {
    private String name = "idea_041370";
 ...
 */
@Slf4j
public class Idea41370Service {
    private static final int IDEA_ID = 41370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41370Service() {
        this(new Idea41370Config());
    }

    public Idea41370Service(Idea41370Config config) {
        this.config = config != null ? config : new Idea41370Config();
