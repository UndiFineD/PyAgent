...
@Data
public class Idea41443Config {
    private String name = "idea_041443";
 ...
 */
@Slf4j
public class Idea41443Service {
    private static final int IDEA_ID = 41443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41443Service() {
        this(new Idea41443Config());
    }

    public Idea41443Service(Idea41443Config config) {
        this.config = config != null ? config : new Idea41443Config();
