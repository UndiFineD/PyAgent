...
@Data
public class Idea41417Config {
    private String name = "idea_041417";
 ...
 */
@Slf4j
public class Idea41417Service {
    private static final int IDEA_ID = 41417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41417Service() {
        this(new Idea41417Config());
    }

    public Idea41417Service(Idea41417Config config) {
        this.config = config != null ? config : new Idea41417Config();
