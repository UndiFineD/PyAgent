...
@Data
public class Idea41507Config {
    private String name = "idea_041507";
 ...
 */
@Slf4j
public class Idea41507Service {
    private static final int IDEA_ID = 41507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41507Service() {
        this(new Idea41507Config());
    }

    public Idea41507Service(Idea41507Config config) {
        this.config = config != null ? config : new Idea41507Config();
