...
@Data
public class Idea41603Config {
    private String name = "idea_041603";
 ...
 */
@Slf4j
public class Idea41603Service {
    private static final int IDEA_ID = 41603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41603Service() {
        this(new Idea41603Config());
    }

    public Idea41603Service(Idea41603Config config) {
        this.config = config != null ? config : new Idea41603Config();
