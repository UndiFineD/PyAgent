...
@Data
public class Idea41767Config {
    private String name = "idea_041767";
 ...
 */
@Slf4j
public class Idea41767Service {
    private static final int IDEA_ID = 41767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41767Service() {
        this(new Idea41767Config());
    }

    public Idea41767Service(Idea41767Config config) {
        this.config = config != null ? config : new Idea41767Config();
