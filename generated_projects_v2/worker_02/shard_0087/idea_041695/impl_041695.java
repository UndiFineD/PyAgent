...
@Data
public class Idea41695Config {
    private String name = "idea_041695";
 ...
 */
@Slf4j
public class Idea41695Service {
    private static final int IDEA_ID = 41695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41695Service() {
        this(new Idea41695Config());
    }

    public Idea41695Service(Idea41695Config config) {
        this.config = config != null ? config : new Idea41695Config();
