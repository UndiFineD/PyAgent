...
@Data
public class Idea41616Config {
    private String name = "idea_041616";
 ...
 */
@Slf4j
public class Idea41616Service {
    private static final int IDEA_ID = 41616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41616Service() {
        this(new Idea41616Config());
    }

    public Idea41616Service(Idea41616Config config) {
        this.config = config != null ? config : new Idea41616Config();
