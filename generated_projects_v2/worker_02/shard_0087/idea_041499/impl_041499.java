...
@Data
public class Idea41499Config {
    private String name = "idea_041499";
 ...
 */
@Slf4j
public class Idea41499Service {
    private static final int IDEA_ID = 41499;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41499Service() {
        this(new Idea41499Config());
    }

    public Idea41499Service(Idea41499Config config) {
        this.config = config != null ? config : new Idea41499Config();
