...
@Data
public class Idea41442Config {
    private String name = "idea_041442";
 ...
 */
@Slf4j
public class Idea41442Service {
    private static final int IDEA_ID = 41442;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41442Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41442Service() {
        this(new Idea41442Config());
    }

    public Idea41442Service(Idea41442Config config) {
        this.config = config != null ? config : new Idea41442Config();
