...
@Data
public class Idea41465Config {
    private String name = "idea_041465";
 ...
 */
@Slf4j
public class Idea41465Service {
    private static final int IDEA_ID = 41465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41465Service() {
        this(new Idea41465Config());
    }

    public Idea41465Service(Idea41465Config config) {
        this.config = config != null ? config : new Idea41465Config();
