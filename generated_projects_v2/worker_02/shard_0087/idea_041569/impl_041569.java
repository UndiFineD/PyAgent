...
@Data
public class Idea41569Config {
    private String name = "idea_041569";
 ...
 */
@Slf4j
public class Idea41569Service {
    private static final int IDEA_ID = 41569;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41569Service() {
        this(new Idea41569Config());
    }

    public Idea41569Service(Idea41569Config config) {
        this.config = config != null ? config : new Idea41569Config();
