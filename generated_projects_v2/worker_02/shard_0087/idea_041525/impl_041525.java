...
@Data
public class Idea41525Config {
    private String name = "idea_041525";
 ...
 */
@Slf4j
public class Idea41525Service {
    private static final int IDEA_ID = 41525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41525Service() {
        this(new Idea41525Config());
    }

    public Idea41525Service(Idea41525Config config) {
        this.config = config != null ? config : new Idea41525Config();
