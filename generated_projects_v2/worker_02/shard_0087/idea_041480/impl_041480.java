...
@Data
public class Idea41480Config {
    private String name = "idea_041480";
 ...
 */
@Slf4j
public class Idea41480Service {
    private static final int IDEA_ID = 41480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41480Service() {
        this(new Idea41480Config());
    }

    public Idea41480Service(Idea41480Config config) {
        this.config = config != null ? config : new Idea41480Config();
