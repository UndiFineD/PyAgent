...
@Data
public class Idea41699Config {
    private String name = "idea_041699";
 ...
 */
@Slf4j
public class Idea41699Service {
    private static final int IDEA_ID = 41699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41699Service() {
        this(new Idea41699Config());
    }

    public Idea41699Service(Idea41699Config config) {
        this.config = config != null ? config : new Idea41699Config();
