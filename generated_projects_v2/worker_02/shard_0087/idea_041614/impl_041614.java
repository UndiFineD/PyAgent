...
@Data
public class Idea41614Config {
    private String name = "idea_041614";
 ...
 */
@Slf4j
public class Idea41614Service {
    private static final int IDEA_ID = 41614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41614Service() {
        this(new Idea41614Config());
    }

    public Idea41614Service(Idea41614Config config) {
        this.config = config != null ? config : new Idea41614Config();
