...
@Data
public class Idea41459Config {
    private String name = "idea_041459";
 ...
 */
@Slf4j
public class Idea41459Service {
    private static final int IDEA_ID = 41459;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41459Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41459Service() {
        this(new Idea41459Config());
    }

    public Idea41459Service(Idea41459Config config) {
        this.config = config != null ? config : new Idea41459Config();
