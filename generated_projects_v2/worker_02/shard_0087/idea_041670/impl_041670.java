...
@Data
public class Idea41670Config {
    private String name = "idea_041670";
 ...
 */
@Slf4j
public class Idea41670Service {
    private static final int IDEA_ID = 41670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41670Service() {
        this(new Idea41670Config());
    }

    public Idea41670Service(Idea41670Config config) {
        this.config = config != null ? config : new Idea41670Config();
