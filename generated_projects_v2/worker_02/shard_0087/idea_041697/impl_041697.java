...
@Data
public class Idea41697Config {
    private String name = "idea_041697";
 ...
 */
@Slf4j
public class Idea41697Service {
    private static final int IDEA_ID = 41697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41697Service() {
        this(new Idea41697Config());
    }

    public Idea41697Service(Idea41697Config config) {
        this.config = config != null ? config : new Idea41697Config();
