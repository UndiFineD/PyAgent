...
@Data
public class Idea41596Config {
    private String name = "idea_041596";
 ...
 */
@Slf4j
public class Idea41596Service {
    private static final int IDEA_ID = 41596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41596Service() {
        this(new Idea41596Config());
    }

    public Idea41596Service(Idea41596Config config) {
        this.config = config != null ? config : new Idea41596Config();
