...
@Data
public class Idea41744Config {
    private String name = "idea_041744";
 ...
 */
@Slf4j
public class Idea41744Service {
    private static final int IDEA_ID = 41744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41744Service() {
        this(new Idea41744Config());
    }

    public Idea41744Service(Idea41744Config config) {
        this.config = config != null ? config : new Idea41744Config();
