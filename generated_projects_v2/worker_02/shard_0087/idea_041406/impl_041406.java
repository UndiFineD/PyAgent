...
@Data
public class Idea41406Config {
    private String name = "idea_041406";
 ...
 */
@Slf4j
public class Idea41406Service {
    private static final int IDEA_ID = 41406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41406Service() {
        this(new Idea41406Config());
    }

    public Idea41406Service(Idea41406Config config) {
        this.config = config != null ? config : new Idea41406Config();
