...
@Data
public class Idea41505Config {
    private String name = "idea_041505";
 ...
 */
@Slf4j
public class Idea41505Service {
    private static final int IDEA_ID = 41505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41505Service() {
        this(new Idea41505Config());
    }

    public Idea41505Service(Idea41505Config config) {
        this.config = config != null ? config : new Idea41505Config();
