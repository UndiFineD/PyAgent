...
@Data
public class Idea41672Config {
    private String name = "idea_041672";
 ...
 */
@Slf4j
public class Idea41672Service {
    private static final int IDEA_ID = 41672;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41672Service() {
        this(new Idea41672Config());
    }

    public Idea41672Service(Idea41672Config config) {
        this.config = config != null ? config : new Idea41672Config();
