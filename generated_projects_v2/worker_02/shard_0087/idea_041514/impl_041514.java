...
@Data
public class Idea41514Config {
    private String name = "idea_041514";
 ...
 */
@Slf4j
public class Idea41514Service {
    private static final int IDEA_ID = 41514;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41514Service() {
        this(new Idea41514Config());
    }

    public Idea41514Service(Idea41514Config config) {
        this.config = config != null ? config : new Idea41514Config();
