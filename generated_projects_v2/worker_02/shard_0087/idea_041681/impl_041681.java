...
@Data
public class Idea41681Config {
    private String name = "idea_041681";
 ...
 */
@Slf4j
public class Idea41681Service {
    private static final int IDEA_ID = 41681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41681Service() {
        this(new Idea41681Config());
    }

    public Idea41681Service(Idea41681Config config) {
        this.config = config != null ? config : new Idea41681Config();
