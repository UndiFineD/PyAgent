...
@Data
public class Idea41345Config {
    private String name = "idea_041345";
 ...
 */
@Slf4j
public class Idea41345Service {
    private static final int IDEA_ID = 41345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41345Service() {
        this(new Idea41345Config());
    }

    public Idea41345Service(Idea41345Config config) {
        this.config = config != null ? config : new Idea41345Config();
