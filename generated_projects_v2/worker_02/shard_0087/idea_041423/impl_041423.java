...
@Data
public class Idea41423Config {
    private String name = "idea_041423";
 ...
 */
@Slf4j
public class Idea41423Service {
    private static final int IDEA_ID = 41423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41423Service() {
        this(new Idea41423Config());
    }

    public Idea41423Service(Idea41423Config config) {
        this.config = config != null ? config : new Idea41423Config();
