...
@Data
public class Idea41726Config {
    private String name = "idea_041726";
 ...
 */
@Slf4j
public class Idea41726Service {
    private static final int IDEA_ID = 41726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41726Service() {
        this(new Idea41726Config());
    }

    public Idea41726Service(Idea41726Config config) {
        this.config = config != null ? config : new Idea41726Config();
