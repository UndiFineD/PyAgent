...
@Data
public class Idea41401Config {
    private String name = "idea_041401";
 ...
 */
@Slf4j
public class Idea41401Service {
    private static final int IDEA_ID = 41401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41401Service() {
        this(new Idea41401Config());
    }

    public Idea41401Service(Idea41401Config config) {
        this.config = config != null ? config : new Idea41401Config();
