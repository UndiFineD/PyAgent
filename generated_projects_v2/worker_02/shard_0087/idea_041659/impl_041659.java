...
@Data
public class Idea41659Config {
    private String name = "idea_041659";
 ...
 */
@Slf4j
public class Idea41659Service {
    private static final int IDEA_ID = 41659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41659Service() {
        this(new Idea41659Config());
    }

    public Idea41659Service(Idea41659Config config) {
        this.config = config != null ? config : new Idea41659Config();
