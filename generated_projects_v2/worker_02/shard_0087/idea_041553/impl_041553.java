...
@Data
public class Idea41553Config {
    private String name = "idea_041553";
 ...
 */
@Slf4j
public class Idea41553Service {
    private static final int IDEA_ID = 41553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41553Service() {
        this(new Idea41553Config());
    }

    public Idea41553Service(Idea41553Config config) {
        this.config = config != null ? config : new Idea41553Config();
