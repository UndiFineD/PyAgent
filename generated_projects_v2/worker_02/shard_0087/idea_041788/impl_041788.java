...
@Data
public class Idea41788Config {
    private String name = "idea_041788";
 ...
 */
@Slf4j
public class Idea41788Service {
    private static final int IDEA_ID = 41788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41788Service() {
        this(new Idea41788Config());
    }

    public Idea41788Service(Idea41788Config config) {
        this.config = config != null ? config : new Idea41788Config();
