...
@Data
public class Idea41560Config {
    private String name = "idea_041560";
 ...
 */
@Slf4j
public class Idea41560Service {
    private static final int IDEA_ID = 41560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41560Service() {
        this(new Idea41560Config());
    }

    public Idea41560Service(Idea41560Config config) {
        this.config = config != null ? config : new Idea41560Config();
