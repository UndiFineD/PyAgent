...
@Data
public class Idea41390Config {
    private String name = "idea_041390";
 ...
 */
@Slf4j
public class Idea41390Service {
    private static final int IDEA_ID = 41390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41390Service() {
        this(new Idea41390Config());
    }

    public Idea41390Service(Idea41390Config config) {
        this.config = config != null ? config : new Idea41390Config();
