...
@Data
public class Idea41666Config {
    private String name = "idea_041666";
 ...
 */
@Slf4j
public class Idea41666Service {
    private static final int IDEA_ID = 41666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41666Service() {
        this(new Idea41666Config());
    }

    public Idea41666Service(Idea41666Config config) {
        this.config = config != null ? config : new Idea41666Config();
