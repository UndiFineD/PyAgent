...
@Data
public class Idea41751Config {
    private String name = "idea_041751";
 ...
 */
@Slf4j
public class Idea41751Service {
    private static final int IDEA_ID = 41751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41751Service() {
        this(new Idea41751Config());
    }

    public Idea41751Service(Idea41751Config config) {
        this.config = config != null ? config : new Idea41751Config();
