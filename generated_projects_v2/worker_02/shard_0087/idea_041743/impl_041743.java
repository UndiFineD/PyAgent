...
@Data
public class Idea41743Config {
    private String name = "idea_041743";
 ...
 */
@Slf4j
public class Idea41743Service {
    private static final int IDEA_ID = 41743;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41743Service() {
        this(new Idea41743Config());
    }

    public Idea41743Service(Idea41743Config config) {
        this.config = config != null ? config : new Idea41743Config();
