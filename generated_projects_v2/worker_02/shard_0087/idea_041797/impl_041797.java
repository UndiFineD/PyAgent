...
@Data
public class Idea41797Config {
    private String name = "idea_041797";
 ...
 */
@Slf4j
public class Idea41797Service {
    private static final int IDEA_ID = 41797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41797Service() {
        this(new Idea41797Config());
    }

    public Idea41797Service(Idea41797Config config) {
        this.config = config != null ? config : new Idea41797Config();
