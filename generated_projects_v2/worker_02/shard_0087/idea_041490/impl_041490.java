...
@Data
public class Idea41490Config {
    private String name = "idea_041490";
 ...
 */
@Slf4j
public class Idea41490Service {
    private static final int IDEA_ID = 41490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41490Service() {
        this(new Idea41490Config());
    }

    public Idea41490Service(Idea41490Config config) {
        this.config = config != null ? config : new Idea41490Config();
