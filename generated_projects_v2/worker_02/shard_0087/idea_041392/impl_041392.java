...
@Data
public class Idea41392Config {
    private String name = "idea_041392";
 ...
 */
@Slf4j
public class Idea41392Service {
    private static final int IDEA_ID = 41392;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41392Service() {
        this(new Idea41392Config());
    }

    public Idea41392Service(Idea41392Config config) {
        this.config = config != null ? config : new Idea41392Config();
