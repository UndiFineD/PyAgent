...
@Data
public class Idea41410Config {
    private String name = "idea_041410";
 ...
 */
@Slf4j
public class Idea41410Service {
    private static final int IDEA_ID = 41410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41410Service() {
        this(new Idea41410Config());
    }

    public Idea41410Service(Idea41410Config config) {
        this.config = config != null ? config : new Idea41410Config();
