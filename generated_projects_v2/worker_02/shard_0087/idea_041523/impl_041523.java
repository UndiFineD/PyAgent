...
@Data
public class Idea41523Config {
    private String name = "idea_041523";
 ...
 */
@Slf4j
public class Idea41523Service {
    private static final int IDEA_ID = 41523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41523Service() {
        this(new Idea41523Config());
    }

    public Idea41523Service(Idea41523Config config) {
        this.config = config != null ? config : new Idea41523Config();
