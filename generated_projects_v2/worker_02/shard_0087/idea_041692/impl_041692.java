...
@Data
public class Idea41692Config {
    private String name = "idea_041692";
 ...
 */
@Slf4j
public class Idea41692Service {
    private static final int IDEA_ID = 41692;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41692Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41692Service() {
        this(new Idea41692Config());
    }

    public Idea41692Service(Idea41692Config config) {
        this.config = config != null ? config : new Idea41692Config();
