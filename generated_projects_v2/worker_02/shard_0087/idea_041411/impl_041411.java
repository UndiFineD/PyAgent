...
@Data
public class Idea41411Config {
    private String name = "idea_041411";
 ...
 */
@Slf4j
public class Idea41411Service {
    private static final int IDEA_ID = 41411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41411Service() {
        this(new Idea41411Config());
    }

    public Idea41411Service(Idea41411Config config) {
        this.config = config != null ? config : new Idea41411Config();
