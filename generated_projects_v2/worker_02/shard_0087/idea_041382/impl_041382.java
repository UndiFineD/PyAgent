...
@Data
public class Idea41382Config {
    private String name = "idea_041382";
 ...
 */
@Slf4j
public class Idea41382Service {
    private static final int IDEA_ID = 41382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41382Service() {
        this(new Idea41382Config());
    }

    public Idea41382Service(Idea41382Config config) {
        this.config = config != null ? config : new Idea41382Config();
