...
@Data
public class Idea41484Config {
    private String name = "idea_041484";
 ...
 */
@Slf4j
public class Idea41484Service {
    private static final int IDEA_ID = 41484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41484Service() {
        this(new Idea41484Config());
    }

    public Idea41484Service(Idea41484Config config) {
        this.config = config != null ? config : new Idea41484Config();
