...
@Data
public class Idea41760Config {
    private String name = "idea_041760";
 ...
 */
@Slf4j
public class Idea41760Service {
    private static final int IDEA_ID = 41760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41760Service() {
        this(new Idea41760Config());
    }

    public Idea41760Service(Idea41760Config config) {
        this.config = config != null ? config : new Idea41760Config();
