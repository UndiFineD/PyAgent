...
@Data
public class Idea41607Config {
    private String name = "idea_041607";
 ...
 */
@Slf4j
public class Idea41607Service {
    private static final int IDEA_ID = 41607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41607Service() {
        this(new Idea41607Config());
    }

    public Idea41607Service(Idea41607Config config) {
        this.config = config != null ? config : new Idea41607Config();
