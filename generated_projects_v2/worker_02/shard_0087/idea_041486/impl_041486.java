...
@Data
public class Idea41486Config {
    private String name = "idea_041486";
 ...
 */
@Slf4j
public class Idea41486Service {
    private static final int IDEA_ID = 41486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41486Service() {
        this(new Idea41486Config());
    }

    public Idea41486Service(Idea41486Config config) {
        this.config = config != null ? config : new Idea41486Config();
