...
@Data
public class Idea41735Config {
    private String name = "idea_041735";
 ...
 */
@Slf4j
public class Idea41735Service {
    private static final int IDEA_ID = 41735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41735Service() {
        this(new Idea41735Config());
    }

    public Idea41735Service(Idea41735Config config) {
        this.config = config != null ? config : new Idea41735Config();
