...
@Data
public class Idea41545Config {
    private String name = "idea_041545";
 ...
 */
@Slf4j
public class Idea41545Service {
    private static final int IDEA_ID = 41545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41545Service() {
        this(new Idea41545Config());
    }

    public Idea41545Service(Idea41545Config config) {
        this.config = config != null ? config : new Idea41545Config();
