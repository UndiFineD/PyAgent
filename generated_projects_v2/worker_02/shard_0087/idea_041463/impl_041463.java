...
@Data
public class Idea41463Config {
    private String name = "idea_041463";
 ...
 */
@Slf4j
public class Idea41463Service {
    private static final int IDEA_ID = 41463;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41463Service() {
        this(new Idea41463Config());
    }

    public Idea41463Service(Idea41463Config config) {
        this.config = config != null ? config : new Idea41463Config();
