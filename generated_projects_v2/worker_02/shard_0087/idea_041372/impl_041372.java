...
@Data
public class Idea41372Config {
    private String name = "idea_041372";
 ...
 */
@Slf4j
public class Idea41372Service {
    private static final int IDEA_ID = 41372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41372Service() {
        this(new Idea41372Config());
    }

    public Idea41372Service(Idea41372Config config) {
        this.config = config != null ? config : new Idea41372Config();
