...
@Data
public class Idea41449Config {
    private String name = "idea_041449";
 ...
 */
@Slf4j
public class Idea41449Service {
    private static final int IDEA_ID = 41449;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41449Service() {
        this(new Idea41449Config());
    }

    public Idea41449Service(Idea41449Config config) {
        this.config = config != null ? config : new Idea41449Config();
