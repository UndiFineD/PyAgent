...
@Data
public class Idea41599Config {
    private String name = "idea_041599";
 ...
 */
@Slf4j
public class Idea41599Service {
    private static final int IDEA_ID = 41599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41599Service() {
        this(new Idea41599Config());
    }

    public Idea41599Service(Idea41599Config config) {
        this.config = config != null ? config : new Idea41599Config();
