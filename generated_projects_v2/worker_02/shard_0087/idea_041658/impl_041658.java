...
@Data
public class Idea41658Config {
    private String name = "idea_041658";
 ...
 */
@Slf4j
public class Idea41658Service {
    private static final int IDEA_ID = 41658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41658Service() {
        this(new Idea41658Config());
    }

    public Idea41658Service(Idea41658Config config) {
        this.config = config != null ? config : new Idea41658Config();
