...
@Data
public class Idea41583Config {
    private String name = "idea_041583";
 ...
 */
@Slf4j
public class Idea41583Service {
    private static final int IDEA_ID = 41583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41583Service() {
        this(new Idea41583Config());
    }

    public Idea41583Service(Idea41583Config config) {
        this.config = config != null ? config : new Idea41583Config();
