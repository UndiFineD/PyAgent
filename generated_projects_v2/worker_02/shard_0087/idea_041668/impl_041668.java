...
@Data
public class Idea41668Config {
    private String name = "idea_041668";
 ...
 */
@Slf4j
public class Idea41668Service {
    private static final int IDEA_ID = 41668;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41668Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41668Service() {
        this(new Idea41668Config());
    }

    public Idea41668Service(Idea41668Config config) {
        this.config = config != null ? config : new Idea41668Config();
