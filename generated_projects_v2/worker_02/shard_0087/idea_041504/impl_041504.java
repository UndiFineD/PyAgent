...
@Data
public class Idea41504Config {
    private String name = "idea_041504";
 ...
 */
@Slf4j
public class Idea41504Service {
    private static final int IDEA_ID = 41504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41504Service() {
        this(new Idea41504Config());
    }

    public Idea41504Service(Idea41504Config config) {
        this.config = config != null ? config : new Idea41504Config();
