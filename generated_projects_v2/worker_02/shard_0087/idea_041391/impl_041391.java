...
@Data
public class Idea41391Config {
    private String name = "idea_041391";
 ...
 */
@Slf4j
public class Idea41391Service {
    private static final int IDEA_ID = 41391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41391Service() {
        this(new Idea41391Config());
    }

    public Idea41391Service(Idea41391Config config) {
        this.config = config != null ? config : new Idea41391Config();
