...
@Data
public class Idea41698Config {
    private String name = "idea_041698";
 ...
 */
@Slf4j
public class Idea41698Service {
    private static final int IDEA_ID = 41698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41698Service() {
        this(new Idea41698Config());
    }

    public Idea41698Service(Idea41698Config config) {
        this.config = config != null ? config : new Idea41698Config();
