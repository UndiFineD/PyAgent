...
@Data
public class Idea41630Config {
    private String name = "idea_041630";
 ...
 */
@Slf4j
public class Idea41630Service {
    private static final int IDEA_ID = 41630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41630Service() {
        this(new Idea41630Config());
    }

    public Idea41630Service(Idea41630Config config) {
        this.config = config != null ? config : new Idea41630Config();
