...
@Data
public class Idea41796Config {
    private String name = "idea_041796";
 ...
 */
@Slf4j
public class Idea41796Service {
    private static final int IDEA_ID = 41796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41796Service() {
        this(new Idea41796Config());
    }

    public Idea41796Service(Idea41796Config config) {
        this.config = config != null ? config : new Idea41796Config();
