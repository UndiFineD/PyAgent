...
@Data
public class Idea41399Config {
    private String name = "idea_041399";
 ...
 */
@Slf4j
public class Idea41399Service {
    private static final int IDEA_ID = 41399;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41399Service() {
        this(new Idea41399Config());
    }

    public Idea41399Service(Idea41399Config config) {
        this.config = config != null ? config : new Idea41399Config();
