...
@Data
public class Idea41532Config {
    private String name = "idea_041532";
 ...
 */
@Slf4j
public class Idea41532Service {
    private static final int IDEA_ID = 41532;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41532Service() {
        this(new Idea41532Config());
    }

    public Idea41532Service(Idea41532Config config) {
        this.config = config != null ? config : new Idea41532Config();
