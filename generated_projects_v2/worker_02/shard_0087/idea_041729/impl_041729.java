...
@Data
public class Idea41729Config {
    private String name = "idea_041729";
 ...
 */
@Slf4j
public class Idea41729Service {
    private static final int IDEA_ID = 41729;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41729Service() {
        this(new Idea41729Config());
    }

    public Idea41729Service(Idea41729Config config) {
        this.config = config != null ? config : new Idea41729Config();
