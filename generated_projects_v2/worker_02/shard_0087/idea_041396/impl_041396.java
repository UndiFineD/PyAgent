...
@Data
public class Idea41396Config {
    private String name = "idea_041396";
 ...
 */
@Slf4j
public class Idea41396Service {
    private static final int IDEA_ID = 41396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41396Service() {
        this(new Idea41396Config());
    }

    public Idea41396Service(Idea41396Config config) {
        this.config = config != null ? config : new Idea41396Config();
