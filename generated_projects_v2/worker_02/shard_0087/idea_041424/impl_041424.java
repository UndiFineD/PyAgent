...
@Data
public class Idea41424Config {
    private String name = "idea_041424";
 ...
 */
@Slf4j
public class Idea41424Service {
    private static final int IDEA_ID = 41424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41424Service() {
        this(new Idea41424Config());
    }

    public Idea41424Service(Idea41424Config config) {
        this.config = config != null ? config : new Idea41424Config();
