...
@Data
public class Idea41664Config {
    private String name = "idea_041664";
 ...
 */
@Slf4j
public class Idea41664Service {
    private static final int IDEA_ID = 41664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41664Service() {
        this(new Idea41664Config());
    }

    public Idea41664Service(Idea41664Config config) {
        this.config = config != null ? config : new Idea41664Config();
