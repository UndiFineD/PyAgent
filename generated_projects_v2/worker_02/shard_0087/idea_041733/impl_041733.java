...
@Data
public class Idea41733Config {
    private String name = "idea_041733";
 ...
 */
@Slf4j
public class Idea41733Service {
    private static final int IDEA_ID = 41733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41733Service() {
        this(new Idea41733Config());
    }

    public Idea41733Service(Idea41733Config config) {
        this.config = config != null ? config : new Idea41733Config();
