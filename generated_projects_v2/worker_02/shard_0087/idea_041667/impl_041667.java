...
@Data
public class Idea41667Config {
    private String name = "idea_041667";
 ...
 */
@Slf4j
public class Idea41667Service {
    private static final int IDEA_ID = 41667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41667Service() {
        this(new Idea41667Config());
    }

    public Idea41667Service(Idea41667Config config) {
        this.config = config != null ? config : new Idea41667Config();
