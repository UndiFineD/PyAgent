...
@Data
public class Idea41635Config {
    private String name = "idea_041635";
 ...
 */
@Slf4j
public class Idea41635Service {
    private static final int IDEA_ID = 41635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41635Service() {
        this(new Idea41635Config());
    }

    public Idea41635Service(Idea41635Config config) {
        this.config = config != null ? config : new Idea41635Config();
