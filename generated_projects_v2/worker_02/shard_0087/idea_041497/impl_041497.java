...
@Data
public class Idea41497Config {
    private String name = "idea_041497";
 ...
 */
@Slf4j
public class Idea41497Service {
    private static final int IDEA_ID = 41497;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41497Service() {
        this(new Idea41497Config());
    }

    public Idea41497Service(Idea41497Config config) {
        this.config = config != null ? config : new Idea41497Config();
