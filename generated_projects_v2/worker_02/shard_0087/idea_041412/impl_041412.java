...
@Data
public class Idea41412Config {
    private String name = "idea_041412";
 ...
 */
@Slf4j
public class Idea41412Service {
    private static final int IDEA_ID = 41412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41412Service() {
        this(new Idea41412Config());
    }

    public Idea41412Service(Idea41412Config config) {
        this.config = config != null ? config : new Idea41412Config();
