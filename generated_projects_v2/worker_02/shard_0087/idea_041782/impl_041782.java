...
@Data
public class Idea41782Config {
    private String name = "idea_041782";
 ...
 */
@Slf4j
public class Idea41782Service {
    private static final int IDEA_ID = 41782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41782Service() {
        this(new Idea41782Config());
    }

    public Idea41782Service(Idea41782Config config) {
        this.config = config != null ? config : new Idea41782Config();
