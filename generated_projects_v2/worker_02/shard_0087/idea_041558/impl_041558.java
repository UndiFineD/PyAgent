...
@Data
public class Idea41558Config {
    private String name = "idea_041558";
 ...
 */
@Slf4j
public class Idea41558Service {
    private static final int IDEA_ID = 41558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41558Service() {
        this(new Idea41558Config());
    }

    public Idea41558Service(Idea41558Config config) {
        this.config = config != null ? config : new Idea41558Config();
