...
@Data
public class Idea41790Config {
    private String name = "idea_041790";
 ...
 */
@Slf4j
public class Idea41790Service {
    private static final int IDEA_ID = 41790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41790Service() {
        this(new Idea41790Config());
    }

    public Idea41790Service(Idea41790Config config) {
        this.config = config != null ? config : new Idea41790Config();
