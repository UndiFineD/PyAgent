...
@Data
public class Idea41385Config {
    private String name = "idea_041385";
 ...
 */
@Slf4j
public class Idea41385Service {
    private static final int IDEA_ID = 41385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41385Service() {
        this(new Idea41385Config());
    }

    public Idea41385Service(Idea41385Config config) {
        this.config = config != null ? config : new Idea41385Config();
