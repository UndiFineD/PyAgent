...
@Data
public class Idea41669Config {
    private String name = "idea_041669";
 ...
 */
@Slf4j
public class Idea41669Service {
    private static final int IDEA_ID = 41669;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41669Service() {
        this(new Idea41669Config());
    }

    public Idea41669Service(Idea41669Config config) {
        this.config = config != null ? config : new Idea41669Config();
