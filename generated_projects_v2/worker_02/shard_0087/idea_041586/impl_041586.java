...
@Data
public class Idea41586Config {
    private String name = "idea_041586";
 ...
 */
@Slf4j
public class Idea41586Service {
    private static final int IDEA_ID = 41586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41586Service() {
        this(new Idea41586Config());
    }

    public Idea41586Service(Idea41586Config config) {
        this.config = config != null ? config : new Idea41586Config();
