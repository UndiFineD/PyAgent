...
@Data
public class Idea41506Config {
    private String name = "idea_041506";
 ...
 */
@Slf4j
public class Idea41506Service {
    private static final int IDEA_ID = 41506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41506Service() {
        this(new Idea41506Config());
    }

    public Idea41506Service(Idea41506Config config) {
        this.config = config != null ? config : new Idea41506Config();
