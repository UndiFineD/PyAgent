...
@Data
public class Idea41632Config {
    private String name = "idea_041632";
 ...
 */
@Slf4j
public class Idea41632Service {
    private static final int IDEA_ID = 41632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41632Service() {
        this(new Idea41632Config());
    }

    public Idea41632Service(Idea41632Config config) {
        this.config = config != null ? config : new Idea41632Config();
