...
@Data
public class Idea41349Config {
    private String name = "idea_041349";
 ...
 */
@Slf4j
public class Idea41349Service {
    private static final int IDEA_ID = 41349;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41349Service() {
        this(new Idea41349Config());
    }

    public Idea41349Service(Idea41349Config config) {
        this.config = config != null ? config : new Idea41349Config();
