...
@Data
public class Idea41682Config {
    private String name = "idea_041682";
 ...
 */
@Slf4j
public class Idea41682Service {
    private static final int IDEA_ID = 41682;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41682Service() {
        this(new Idea41682Config());
    }

    public Idea41682Service(Idea41682Config config) {
        this.config = config != null ? config : new Idea41682Config();
