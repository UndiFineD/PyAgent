...
@Data
public class Idea41351Config {
    private String name = "idea_041351";
 ...
 */
@Slf4j
public class Idea41351Service {
    private static final int IDEA_ID = 41351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41351Service() {
        this(new Idea41351Config());
    }

    public Idea41351Service(Idea41351Config config) {
        this.config = config != null ? config : new Idea41351Config();
