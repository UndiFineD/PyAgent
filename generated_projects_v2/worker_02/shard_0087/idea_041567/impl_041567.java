...
@Data
public class Idea41567Config {
    private String name = "idea_041567";
 ...
 */
@Slf4j
public class Idea41567Service {
    private static final int IDEA_ID = 41567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41567Service() {
        this(new Idea41567Config());
    }

    public Idea41567Service(Idea41567Config config) {
        this.config = config != null ? config : new Idea41567Config();
