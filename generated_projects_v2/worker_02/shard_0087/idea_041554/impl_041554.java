...
@Data
public class Idea41554Config {
    private String name = "idea_041554";
 ...
 */
@Slf4j
public class Idea41554Service {
    private static final int IDEA_ID = 41554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41554Service() {
        this(new Idea41554Config());
    }

    public Idea41554Service(Idea41554Config config) {
        this.config = config != null ? config : new Idea41554Config();
