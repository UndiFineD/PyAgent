...
@Data
public class Idea41562Config {
    private String name = "idea_041562";
 ...
 */
@Slf4j
public class Idea41562Service {
    private static final int IDEA_ID = 41562;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41562Service() {
        this(new Idea41562Config());
    }

    public Idea41562Service(Idea41562Config config) {
        this.config = config != null ? config : new Idea41562Config();
