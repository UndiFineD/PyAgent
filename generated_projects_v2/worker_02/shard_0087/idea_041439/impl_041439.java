...
@Data
public class Idea41439Config {
    private String name = "idea_041439";
 ...
 */
@Slf4j
public class Idea41439Service {
    private static final int IDEA_ID = 41439;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41439Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41439Service() {
        this(new Idea41439Config());
    }

    public Idea41439Service(Idea41439Config config) {
        this.config = config != null ? config : new Idea41439Config();
