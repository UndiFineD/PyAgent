...
@Data
public class Idea41661Config {
    private String name = "idea_041661";
 ...
 */
@Slf4j
public class Idea41661Service {
    private static final int IDEA_ID = 41661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41661Service() {
        this(new Idea41661Config());
    }

    public Idea41661Service(Idea41661Config config) {
        this.config = config != null ? config : new Idea41661Config();
