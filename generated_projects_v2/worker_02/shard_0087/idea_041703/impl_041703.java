...
@Data
public class Idea41703Config {
    private String name = "idea_041703";
 ...
 */
@Slf4j
public class Idea41703Service {
    private static final int IDEA_ID = 41703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41703Service() {
        this(new Idea41703Config());
    }

    public Idea41703Service(Idea41703Config config) {
        this.config = config != null ? config : new Idea41703Config();
