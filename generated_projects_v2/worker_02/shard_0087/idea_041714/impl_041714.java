...
@Data
public class Idea41714Config {
    private String name = "idea_041714";
 ...
 */
@Slf4j
public class Idea41714Service {
    private static final int IDEA_ID = 41714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41714Service() {
        this(new Idea41714Config());
    }

    public Idea41714Service(Idea41714Config config) {
        this.config = config != null ? config : new Idea41714Config();
