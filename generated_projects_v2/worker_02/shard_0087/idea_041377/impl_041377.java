...
@Data
public class Idea41377Config {
    private String name = "idea_041377";
 ...
 */
@Slf4j
public class Idea41377Service {
    private static final int IDEA_ID = 41377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41377Service() {
        this(new Idea41377Config());
    }

    public Idea41377Service(Idea41377Config config) {
        this.config = config != null ? config : new Idea41377Config();
