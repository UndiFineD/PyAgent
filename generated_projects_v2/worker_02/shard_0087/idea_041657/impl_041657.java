...
@Data
public class Idea41657Config {
    private String name = "idea_041657";
 ...
 */
@Slf4j
public class Idea41657Service {
    private static final int IDEA_ID = 41657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41657Service() {
        this(new Idea41657Config());
    }

    public Idea41657Service(Idea41657Config config) {
        this.config = config != null ? config : new Idea41657Config();
