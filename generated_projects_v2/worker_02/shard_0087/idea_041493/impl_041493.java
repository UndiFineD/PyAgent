...
@Data
public class Idea41493Config {
    private String name = "idea_041493";
 ...
 */
@Slf4j
public class Idea41493Service {
    private static final int IDEA_ID = 41493;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41493Service() {
        this(new Idea41493Config());
    }

    public Idea41493Service(Idea41493Config config) {
        this.config = config != null ? config : new Idea41493Config();
