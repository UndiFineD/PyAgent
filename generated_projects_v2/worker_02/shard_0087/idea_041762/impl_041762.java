...
@Data
public class Idea41762Config {
    private String name = "idea_041762";
 ...
 */
@Slf4j
public class Idea41762Service {
    private static final int IDEA_ID = 41762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41762Service() {
        this(new Idea41762Config());
    }

    public Idea41762Service(Idea41762Config config) {
        this.config = config != null ? config : new Idea41762Config();
