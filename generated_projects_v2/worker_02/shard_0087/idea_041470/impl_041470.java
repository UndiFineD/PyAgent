...
@Data
public class Idea41470Config {
    private String name = "idea_041470";
 ...
 */
@Slf4j
public class Idea41470Service {
    private static final int IDEA_ID = 41470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41470Service() {
        this(new Idea41470Config());
    }

    public Idea41470Service(Idea41470Config config) {
        this.config = config != null ? config : new Idea41470Config();
