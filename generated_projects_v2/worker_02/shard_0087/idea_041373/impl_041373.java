...
@Data
public class Idea41373Config {
    private String name = "idea_041373";
 ...
 */
@Slf4j
public class Idea41373Service {
    private static final int IDEA_ID = 41373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41373Service() {
        this(new Idea41373Config());
    }

    public Idea41373Service(Idea41373Config config) {
        this.config = config != null ? config : new Idea41373Config();
