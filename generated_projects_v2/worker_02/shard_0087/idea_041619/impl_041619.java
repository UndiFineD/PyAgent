...
@Data
public class Idea41619Config {
    private String name = "idea_041619";
 ...
 */
@Slf4j
public class Idea41619Service {
    private static final int IDEA_ID = 41619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41619Service() {
        this(new Idea41619Config());
    }

    public Idea41619Service(Idea41619Config config) {
        this.config = config != null ? config : new Idea41619Config();
