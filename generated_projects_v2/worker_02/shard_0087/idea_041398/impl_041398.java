...
@Data
public class Idea41398Config {
    private String name = "idea_041398";
 ...
 */
@Slf4j
public class Idea41398Service {
    private static final int IDEA_ID = 41398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41398Service() {
        this(new Idea41398Config());
    }

    public Idea41398Service(Idea41398Config config) {
        this.config = config != null ? config : new Idea41398Config();
