...
@Data
public class Idea41638Config {
    private String name = "idea_041638";
 ...
 */
@Slf4j
public class Idea41638Service {
    private static final int IDEA_ID = 41638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41638Service() {
        this(new Idea41638Config());
    }

    public Idea41638Service(Idea41638Config config) {
        this.config = config != null ? config : new Idea41638Config();
