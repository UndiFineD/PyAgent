...
@Data
public class Idea41431Config {
    private String name = "idea_041431";
 ...
 */
@Slf4j
public class Idea41431Service {
    private static final int IDEA_ID = 41431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41431Service() {
        this(new Idea41431Config());
    }

    public Idea41431Service(Idea41431Config config) {
        this.config = config != null ? config : new Idea41431Config();
