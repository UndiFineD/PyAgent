...
@Data
public class Idea41366Config {
    private String name = "idea_041366";
 ...
 */
@Slf4j
public class Idea41366Service {
    private static final int IDEA_ID = 41366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41366Service() {
        this(new Idea41366Config());
    }

    public Idea41366Service(Idea41366Config config) {
        this.config = config != null ? config : new Idea41366Config();
