...
@Data
public class Idea41713Config {
    private String name = "idea_041713";
 ...
 */
@Slf4j
public class Idea41713Service {
    private static final int IDEA_ID = 41713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41713Service() {
        this(new Idea41713Config());
    }

    public Idea41713Service(Idea41713Config config) {
        this.config = config != null ? config : new Idea41713Config();
