...
@Data
public class Idea41689Config {
    private String name = "idea_041689";
 ...
 */
@Slf4j
public class Idea41689Service {
    private static final int IDEA_ID = 41689;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41689Service() {
        this(new Idea41689Config());
    }

    public Idea41689Service(Idea41689Config config) {
        this.config = config != null ? config : new Idea41689Config();
