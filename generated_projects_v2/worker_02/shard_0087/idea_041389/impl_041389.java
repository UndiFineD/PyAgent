...
@Data
public class Idea41389Config {
    private String name = "idea_041389";
 ...
 */
@Slf4j
public class Idea41389Service {
    private static final int IDEA_ID = 41389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41389Service() {
        this(new Idea41389Config());
    }

    public Idea41389Service(Idea41389Config config) {
        this.config = config != null ? config : new Idea41389Config();
