...
@Data
public class Idea41547Config {
    private String name = "idea_041547";
 ...
 */
@Slf4j
public class Idea41547Service {
    private static final int IDEA_ID = 41547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41547Service() {
        this(new Idea41547Config());
    }

    public Idea41547Service(Idea41547Config config) {
        this.config = config != null ? config : new Idea41547Config();
