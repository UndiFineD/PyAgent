...
@Data
public class Idea41715Config {
    private String name = "idea_041715";
 ...
 */
@Slf4j
public class Idea41715Service {
    private static final int IDEA_ID = 41715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41715Service() {
        this(new Idea41715Config());
    }

    public Idea41715Service(Idea41715Config config) {
        this.config = config != null ? config : new Idea41715Config();
