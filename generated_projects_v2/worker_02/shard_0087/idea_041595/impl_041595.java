...
@Data
public class Idea41595Config {
    private String name = "idea_041595";
 ...
 */
@Slf4j
public class Idea41595Service {
    private static final int IDEA_ID = 41595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41595Service() {
        this(new Idea41595Config());
    }

    public Idea41595Service(Idea41595Config config) {
        this.config = config != null ? config : new Idea41595Config();
