...
@Data
public class Idea41326Config {
    private String name = "idea_041326";
 ...
 */
@Slf4j
public class Idea41326Service {
    private static final int IDEA_ID = 41326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41326Service() {
        this(new Idea41326Config());
    }

    public Idea41326Service(Idea41326Config config) {
        this.config = config != null ? config : new Idea41326Config();
