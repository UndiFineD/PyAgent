...
@Data
public class Idea41367Config {
    private String name = "idea_041367";
 ...
 */
@Slf4j
public class Idea41367Service {
    private static final int IDEA_ID = 41367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41367Service() {
        this(new Idea41367Config());
    }

    public Idea41367Service(Idea41367Config config) {
        this.config = config != null ? config : new Idea41367Config();
