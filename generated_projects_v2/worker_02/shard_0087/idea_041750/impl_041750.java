...
@Data
public class Idea41750Config {
    private String name = "idea_041750";
 ...
 */
@Slf4j
public class Idea41750Service {
    private static final int IDEA_ID = 41750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41750Service() {
        this(new Idea41750Config());
    }

    public Idea41750Service(Idea41750Config config) {
        this.config = config != null ? config : new Idea41750Config();
