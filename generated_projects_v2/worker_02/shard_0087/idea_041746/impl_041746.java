...
@Data
public class Idea41746Config {
    private String name = "idea_041746";
 ...
 */
@Slf4j
public class Idea41746Service {
    private static final int IDEA_ID = 41746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41746Service() {
        this(new Idea41746Config());
    }

    public Idea41746Service(Idea41746Config config) {
        this.config = config != null ? config : new Idea41746Config();
