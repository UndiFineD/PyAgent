...
@Data
public class Idea41526Config {
    private String name = "idea_041526";
 ...
 */
@Slf4j
public class Idea41526Service {
    private static final int IDEA_ID = 41526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41526Service() {
        this(new Idea41526Config());
    }

    public Idea41526Service(Idea41526Config config) {
        this.config = config != null ? config : new Idea41526Config();
