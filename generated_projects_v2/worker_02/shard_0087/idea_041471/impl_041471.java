...
@Data
public class Idea41471Config {
    private String name = "idea_041471";
 ...
 */
@Slf4j
public class Idea41471Service {
    private static final int IDEA_ID = 41471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41471Service() {
        this(new Idea41471Config());
    }

    public Idea41471Service(Idea41471Config config) {
        this.config = config != null ? config : new Idea41471Config();
