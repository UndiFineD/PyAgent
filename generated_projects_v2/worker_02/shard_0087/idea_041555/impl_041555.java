...
@Data
public class Idea41555Config {
    private String name = "idea_041555";
 ...
 */
@Slf4j
public class Idea41555Service {
    private static final int IDEA_ID = 41555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41555Service() {
        this(new Idea41555Config());
    }

    public Idea41555Service(Idea41555Config config) {
        this.config = config != null ? config : new Idea41555Config();
