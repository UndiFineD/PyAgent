...
@Data
public class Idea41770Config {
    private String name = "idea_041770";
 ...
 */
@Slf4j
public class Idea41770Service {
    private static final int IDEA_ID = 41770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41770Service() {
        this(new Idea41770Config());
    }

    public Idea41770Service(Idea41770Config config) {
        this.config = config != null ? config : new Idea41770Config();
