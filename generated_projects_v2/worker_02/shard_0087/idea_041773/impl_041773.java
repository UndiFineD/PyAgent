...
@Data
public class Idea41773Config {
    private String name = "idea_041773";
 ...
 */
@Slf4j
public class Idea41773Service {
    private static final int IDEA_ID = 41773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41773Service() {
        this(new Idea41773Config());
    }

    public Idea41773Service(Idea41773Config config) {
        this.config = config != null ? config : new Idea41773Config();
