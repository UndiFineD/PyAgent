...
@Data
public class Idea41712Config {
    private String name = "idea_041712";
 ...
 */
@Slf4j
public class Idea41712Service {
    private static final int IDEA_ID = 41712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41712Service() {
        this(new Idea41712Config());
    }

    public Idea41712Service(Idea41712Config config) {
        this.config = config != null ? config : new Idea41712Config();
