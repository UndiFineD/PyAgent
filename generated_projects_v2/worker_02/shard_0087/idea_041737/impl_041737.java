...
@Data
public class Idea41737Config {
    private String name = "idea_041737";
 ...
 */
@Slf4j
public class Idea41737Service {
    private static final int IDEA_ID = 41737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41737Service() {
        this(new Idea41737Config());
    }

    public Idea41737Service(Idea41737Config config) {
        this.config = config != null ? config : new Idea41737Config();
