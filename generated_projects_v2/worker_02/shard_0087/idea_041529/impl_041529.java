...
@Data
public class Idea41529Config {
    private String name = "idea_041529";
 ...
 */
@Slf4j
public class Idea41529Service {
    private static final int IDEA_ID = 41529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41529Service() {
        this(new Idea41529Config());
    }

    public Idea41529Service(Idea41529Config config) {
        this.config = config != null ? config : new Idea41529Config();
