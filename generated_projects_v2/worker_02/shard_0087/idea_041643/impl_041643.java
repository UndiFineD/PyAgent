...
@Data
public class Idea41643Config {
    private String name = "idea_041643";
 ...
 */
@Slf4j
public class Idea41643Service {
    private static final int IDEA_ID = 41643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41643Service() {
        this(new Idea41643Config());
    }

    public Idea41643Service(Idea41643Config config) {
        this.config = config != null ? config : new Idea41643Config();
