...
@Data
public class Idea41485Config {
    private String name = "idea_041485";
 ...
 */
@Slf4j
public class Idea41485Service {
    private static final int IDEA_ID = 41485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41485Service() {
        this(new Idea41485Config());
    }

    public Idea41485Service(Idea41485Config config) {
        this.config = config != null ? config : new Idea41485Config();
