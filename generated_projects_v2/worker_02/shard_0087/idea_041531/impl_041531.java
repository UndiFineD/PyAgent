...
@Data
public class Idea41531Config {
    private String name = "idea_041531";
 ...
 */
@Slf4j
public class Idea41531Service {
    private static final int IDEA_ID = 41531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41531Service() {
        this(new Idea41531Config());
    }

    public Idea41531Service(Idea41531Config config) {
        this.config = config != null ? config : new Idea41531Config();
