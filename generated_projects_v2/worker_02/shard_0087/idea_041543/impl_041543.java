...
@Data
public class Idea41543Config {
    private String name = "idea_041543";
 ...
 */
@Slf4j
public class Idea41543Service {
    private static final int IDEA_ID = 41543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41543Service() {
        this(new Idea41543Config());
    }

    public Idea41543Service(Idea41543Config config) {
        this.config = config != null ? config : new Idea41543Config();
