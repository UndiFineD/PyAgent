...
@Data
public class Idea41515Config {
    private String name = "idea_041515";
 ...
 */
@Slf4j
public class Idea41515Service {
    private static final int IDEA_ID = 41515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41515Service() {
        this(new Idea41515Config());
    }

    public Idea41515Service(Idea41515Config config) {
        this.config = config != null ? config : new Idea41515Config();
