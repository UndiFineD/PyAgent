...
@Data
public class Idea35722Config {
    private String name = "idea_035722";
 ...
 */
@Slf4j
public class Idea35722Service {
    private static final int IDEA_ID = 35722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35722Service() {
        this(new Idea35722Config());
    }

    public Idea35722Service(Idea35722Config config) {
        this.config = config != null ? config : new Idea35722Config();
