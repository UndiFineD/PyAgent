...
@Data
public class Idea35997Config {
    private String name = "idea_035997";
 ...
 */
@Slf4j
public class Idea35997Service {
    private static final int IDEA_ID = 35997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35997Service() {
        this(new Idea35997Config());
    }

    public Idea35997Service(Idea35997Config config) {
        this.config = config != null ? config : new Idea35997Config();
