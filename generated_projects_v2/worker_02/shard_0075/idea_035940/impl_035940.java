...
@Data
public class Idea35940Config {
    private String name = "idea_035940";
 ...
 */
@Slf4j
public class Idea35940Service {
    private static final int IDEA_ID = 35940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35940Service() {
        this(new Idea35940Config());
    }

    public Idea35940Service(Idea35940Config config) {
        this.config = config != null ? config : new Idea35940Config();
