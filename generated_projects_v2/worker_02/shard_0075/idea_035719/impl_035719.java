...
@Data
public class Idea35719Config {
    private String name = "idea_035719";
 ...
 */
@Slf4j
public class Idea35719Service {
    private static final int IDEA_ID = 35719;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35719Service() {
        this(new Idea35719Config());
    }

    public Idea35719Service(Idea35719Config config) {
        this.config = config != null ? config : new Idea35719Config();
