...
@Data
public class Idea36014Config {
    private String name = "idea_036014";
 ...
 */
@Slf4j
public class Idea36014Service {
    private static final int IDEA_ID = 36014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36014Service() {
        this(new Idea36014Config());
    }

    public Idea36014Service(Idea36014Config config) {
        this.config = config != null ? config : new Idea36014Config();
