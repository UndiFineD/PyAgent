...
@Data
public class Idea35779Config {
    private String name = "idea_035779";
 ...
 */
@Slf4j
public class Idea35779Service {
    private static final int IDEA_ID = 35779;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35779Service() {
        this(new Idea35779Config());
    }

    public Idea35779Service(Idea35779Config config) {
        this.config = config != null ? config : new Idea35779Config();
