...
@Data
public class Idea35932Config {
    private String name = "idea_035932";
 ...
 */
@Slf4j
public class Idea35932Service {
    private static final int IDEA_ID = 35932;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35932Service() {
        this(new Idea35932Config());
    }

    public Idea35932Service(Idea35932Config config) {
        this.config = config != null ? config : new Idea35932Config();
