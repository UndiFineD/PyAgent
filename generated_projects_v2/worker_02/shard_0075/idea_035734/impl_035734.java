...
@Data
public class Idea35734Config {
    private String name = "idea_035734";
 ...
 */
@Slf4j
public class Idea35734Service {
    private static final int IDEA_ID = 35734;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35734Service() {
        this(new Idea35734Config());
    }

    public Idea35734Service(Idea35734Config config) {
        this.config = config != null ? config : new Idea35734Config();
