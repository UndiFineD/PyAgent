...
@Data
public class Idea35989Config {
    private String name = "idea_035989";
 ...
 */
@Slf4j
public class Idea35989Service {
    private static final int IDEA_ID = 35989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35989Service() {
        this(new Idea35989Config());
    }

    public Idea35989Service(Idea35989Config config) {
        this.config = config != null ? config : new Idea35989Config();
