...
@Data
public class Idea36054Config {
    private String name = "idea_036054";
 ...
 */
@Slf4j
public class Idea36054Service {
    private static final int IDEA_ID = 36054;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36054Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36054Service() {
        this(new Idea36054Config());
    }

    public Idea36054Service(Idea36054Config config) {
        this.config = config != null ? config : new Idea36054Config();
