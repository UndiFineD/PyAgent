...
@Data
public class Idea35674Config {
    private String name = "idea_035674";
 ...
 */
@Slf4j
public class Idea35674Service {
    private static final int IDEA_ID = 35674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35674Service() {
        this(new Idea35674Config());
    }

    public Idea35674Service(Idea35674Config config) {
        this.config = config != null ? config : new Idea35674Config();
