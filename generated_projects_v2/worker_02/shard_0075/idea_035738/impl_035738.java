...
@Data
public class Idea35738Config {
    private String name = "idea_035738";
 ...
 */
@Slf4j
public class Idea35738Service {
    private static final int IDEA_ID = 35738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35738Service() {
        this(new Idea35738Config());
    }

    public Idea35738Service(Idea35738Config config) {
        this.config = config != null ? config : new Idea35738Config();
