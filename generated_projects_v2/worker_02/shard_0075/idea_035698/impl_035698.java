...
@Data
public class Idea35698Config {
    private String name = "idea_035698";
 ...
 */
@Slf4j
public class Idea35698Service {
    private static final int IDEA_ID = 35698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35698Service() {
        this(new Idea35698Config());
    }

    public Idea35698Service(Idea35698Config config) {
        this.config = config != null ? config : new Idea35698Config();
