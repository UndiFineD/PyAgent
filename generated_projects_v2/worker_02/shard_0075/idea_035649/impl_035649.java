...
@Data
public class Idea35649Config {
    private String name = "idea_035649";
 ...
 */
@Slf4j
public class Idea35649Service {
    private static final int IDEA_ID = 35649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35649Service() {
        this(new Idea35649Config());
    }

    public Idea35649Service(Idea35649Config config) {
        this.config = config != null ? config : new Idea35649Config();
