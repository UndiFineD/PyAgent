...
@Data
public class Idea35637Config {
    private String name = "idea_035637";
 ...
 */
@Slf4j
public class Idea35637Service {
    private static final int IDEA_ID = 35637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35637Service() {
        this(new Idea35637Config());
    }

    public Idea35637Service(Idea35637Config config) {
        this.config = config != null ? config : new Idea35637Config();
