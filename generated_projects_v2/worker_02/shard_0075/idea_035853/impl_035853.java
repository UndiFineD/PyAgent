...
@Data
public class Idea35853Config {
    private String name = "idea_035853";
 ...
 */
@Slf4j
public class Idea35853Service {
    private static final int IDEA_ID = 35853;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35853Service() {
        this(new Idea35853Config());
    }

    public Idea35853Service(Idea35853Config config) {
        this.config = config != null ? config : new Idea35853Config();
