...
@Data
public class Idea35669Config {
    private String name = "idea_035669";
 ...
 */
@Slf4j
public class Idea35669Service {
    private static final int IDEA_ID = 35669;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35669Service() {
        this(new Idea35669Config());
    }

    public Idea35669Service(Idea35669Config config) {
        this.config = config != null ? config : new Idea35669Config();
