...
@Data
public class Idea36051Config {
    private String name = "idea_036051";
 ...
 */
@Slf4j
public class Idea36051Service {
    private static final int IDEA_ID = 36051;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36051Service() {
        this(new Idea36051Config());
    }

    public Idea36051Service(Idea36051Config config) {
        this.config = config != null ? config : new Idea36051Config();
