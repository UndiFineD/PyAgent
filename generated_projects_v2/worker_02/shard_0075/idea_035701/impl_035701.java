...
@Data
public class Idea35701Config {
    private String name = "idea_035701";
 ...
 */
@Slf4j
public class Idea35701Service {
    private static final int IDEA_ID = 35701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35701Service() {
        this(new Idea35701Config());
    }

    public Idea35701Service(Idea35701Config config) {
        this.config = config != null ? config : new Idea35701Config();
