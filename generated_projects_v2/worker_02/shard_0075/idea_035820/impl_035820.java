...
@Data
public class Idea35820Config {
    private String name = "idea_035820";
 ...
 */
@Slf4j
public class Idea35820Service {
    private static final int IDEA_ID = 35820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35820Service() {
        this(new Idea35820Config());
    }

    public Idea35820Service(Idea35820Config config) {
        this.config = config != null ? config : new Idea35820Config();
