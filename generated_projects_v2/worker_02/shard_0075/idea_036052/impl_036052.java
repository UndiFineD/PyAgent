...
@Data
public class Idea36052Config {
    private String name = "idea_036052";
 ...
 */
@Slf4j
public class Idea36052Service {
    private static final int IDEA_ID = 36052;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36052Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36052Service() {
        this(new Idea36052Config());
    }

    public Idea36052Service(Idea36052Config config) {
        this.config = config != null ? config : new Idea36052Config();
