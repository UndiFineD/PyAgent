...
@Data
public class Idea35972Config {
    private String name = "idea_035972";
 ...
 */
@Slf4j
public class Idea35972Service {
    private static final int IDEA_ID = 35972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35972Service() {
        this(new Idea35972Config());
    }

    public Idea35972Service(Idea35972Config config) {
        this.config = config != null ? config : new Idea35972Config();
