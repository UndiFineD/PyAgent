...
@Data
public class Idea36021Config {
    private String name = "idea_036021";
 ...
 */
@Slf4j
public class Idea36021Service {
    private static final int IDEA_ID = 36021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36021Service() {
        this(new Idea36021Config());
    }

    public Idea36021Service(Idea36021Config config) {
        this.config = config != null ? config : new Idea36021Config();
