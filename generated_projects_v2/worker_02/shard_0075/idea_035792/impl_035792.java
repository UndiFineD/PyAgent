...
@Data
public class Idea35792Config {
    private String name = "idea_035792";
 ...
 */
@Slf4j
public class Idea35792Service {
    private static final int IDEA_ID = 35792;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35792Service() {
        this(new Idea35792Config());
    }

    public Idea35792Service(Idea35792Config config) {
        this.config = config != null ? config : new Idea35792Config();
