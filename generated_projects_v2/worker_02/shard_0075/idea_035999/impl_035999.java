...
@Data
public class Idea35999Config {
    private String name = "idea_035999";
 ...
 */
@Slf4j
public class Idea35999Service {
    private static final int IDEA_ID = 35999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35999Service() {
        this(new Idea35999Config());
    }

    public Idea35999Service(Idea35999Config config) {
        this.config = config != null ? config : new Idea35999Config();
