...
@Data
public class Idea35813Config {
    private String name = "idea_035813";
 ...
 */
@Slf4j
public class Idea35813Service {
    private static final int IDEA_ID = 35813;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35813Service() {
        this(new Idea35813Config());
    }

    public Idea35813Service(Idea35813Config config) {
        this.config = config != null ? config : new Idea35813Config();
