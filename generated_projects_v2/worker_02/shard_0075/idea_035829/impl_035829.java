...
@Data
public class Idea35829Config {
    private String name = "idea_035829";
 ...
 */
@Slf4j
public class Idea35829Service {
    private static final int IDEA_ID = 35829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35829Service() {
        this(new Idea35829Config());
    }

    public Idea35829Service(Idea35829Config config) {
        this.config = config != null ? config : new Idea35829Config();
