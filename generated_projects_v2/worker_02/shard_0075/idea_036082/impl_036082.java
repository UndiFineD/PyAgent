...
@Data
public class Idea36082Config {
    private String name = "idea_036082";
 ...
 */
@Slf4j
public class Idea36082Service {
    private static final int IDEA_ID = 36082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36082Service() {
        this(new Idea36082Config());
    }

    public Idea36082Service(Idea36082Config config) {
        this.config = config != null ? config : new Idea36082Config();
