...
@Data
public class Idea35630Config {
    private String name = "idea_035630";
 ...
 */
@Slf4j
public class Idea35630Service {
    private static final int IDEA_ID = 35630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35630Service() {
        this(new Idea35630Config());
    }

    public Idea35630Service(Idea35630Config config) {
        this.config = config != null ? config : new Idea35630Config();
