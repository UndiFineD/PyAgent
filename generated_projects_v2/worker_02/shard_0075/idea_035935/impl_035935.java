...
@Data
public class Idea35935Config {
    private String name = "idea_035935";
 ...
 */
@Slf4j
public class Idea35935Service {
    private static final int IDEA_ID = 35935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35935Service() {
        this(new Idea35935Config());
    }

    public Idea35935Service(Idea35935Config config) {
        this.config = config != null ? config : new Idea35935Config();
