...
@Data
public class Idea36008Config {
    private String name = "idea_036008";
 ...
 */
@Slf4j
public class Idea36008Service {
    private static final int IDEA_ID = 36008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36008Service() {
        this(new Idea36008Config());
    }

    public Idea36008Service(Idea36008Config config) {
        this.config = config != null ? config : new Idea36008Config();
