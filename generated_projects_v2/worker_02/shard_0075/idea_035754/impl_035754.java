...
@Data
public class Idea35754Config {
    private String name = "idea_035754";
 ...
 */
@Slf4j
public class Idea35754Service {
    private static final int IDEA_ID = 35754;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35754Service() {
        this(new Idea35754Config());
    }

    public Idea35754Service(Idea35754Config config) {
        this.config = config != null ? config : new Idea35754Config();
