...
@Data
public class Idea35863Config {
    private String name = "idea_035863";
 ...
 */
@Slf4j
public class Idea35863Service {
    private static final int IDEA_ID = 35863;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35863Service() {
        this(new Idea35863Config());
    }

    public Idea35863Service(Idea35863Config config) {
        this.config = config != null ? config : new Idea35863Config();
