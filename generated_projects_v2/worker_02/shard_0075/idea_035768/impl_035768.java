...
@Data
public class Idea35768Config {
    private String name = "idea_035768";
 ...
 */
@Slf4j
public class Idea35768Service {
    private static final int IDEA_ID = 35768;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35768Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35768Service() {
        this(new Idea35768Config());
    }

    public Idea35768Service(Idea35768Config config) {
        this.config = config != null ? config : new Idea35768Config();
