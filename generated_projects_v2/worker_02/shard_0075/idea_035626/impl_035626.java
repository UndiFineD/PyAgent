...
@Data
public class Idea35626Config {
    private String name = "idea_035626";
 ...
 */
@Slf4j
public class Idea35626Service {
    private static final int IDEA_ID = 35626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35626Service() {
        this(new Idea35626Config());
    }

    public Idea35626Service(Idea35626Config config) {
        this.config = config != null ? config : new Idea35626Config();
