...
@Data
public class Idea35845Config {
    private String name = "idea_035845";
 ...
 */
@Slf4j
public class Idea35845Service {
    private static final int IDEA_ID = 35845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35845Service() {
        this(new Idea35845Config());
    }

    public Idea35845Service(Idea35845Config config) {
        this.config = config != null ? config : new Idea35845Config();
