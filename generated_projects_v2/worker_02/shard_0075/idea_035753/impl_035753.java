...
@Data
public class Idea35753Config {
    private String name = "idea_035753";
 ...
 */
@Slf4j
public class Idea35753Service {
    private static final int IDEA_ID = 35753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35753Service() {
        this(new Idea35753Config());
    }

    public Idea35753Service(Idea35753Config config) {
        this.config = config != null ? config : new Idea35753Config();
