...
@Data
public class Idea36073Config {
    private String name = "idea_036073";
 ...
 */
@Slf4j
public class Idea36073Service {
    private static final int IDEA_ID = 36073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36073Service() {
        this(new Idea36073Config());
    }

    public Idea36073Service(Idea36073Config config) {
        this.config = config != null ? config : new Idea36073Config();
