...
@Data
public class Idea35926Config {
    private String name = "idea_035926";
 ...
 */
@Slf4j
public class Idea35926Service {
    private static final int IDEA_ID = 35926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35926Service() {
        this(new Idea35926Config());
    }

    public Idea35926Service(Idea35926Config config) {
        this.config = config != null ? config : new Idea35926Config();
