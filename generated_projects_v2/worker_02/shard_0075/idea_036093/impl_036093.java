...
@Data
public class Idea36093Config {
    private String name = "idea_036093";
 ...
 */
@Slf4j
public class Idea36093Service {
    private static final int IDEA_ID = 36093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36093Service() {
        this(new Idea36093Config());
    }

    public Idea36093Service(Idea36093Config config) {
        this.config = config != null ? config : new Idea36093Config();
