...
@Data
public class Idea35789Config {
    private String name = "idea_035789";
 ...
 */
@Slf4j
public class Idea35789Service {
    private static final int IDEA_ID = 35789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35789Service() {
        this(new Idea35789Config());
    }

    public Idea35789Service(Idea35789Config config) {
        this.config = config != null ? config : new Idea35789Config();
