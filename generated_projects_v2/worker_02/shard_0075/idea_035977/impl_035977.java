...
@Data
public class Idea35977Config {
    private String name = "idea_035977";
 ...
 */
@Slf4j
public class Idea35977Service {
    private static final int IDEA_ID = 35977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35977Service() {
        this(new Idea35977Config());
    }

    public Idea35977Service(Idea35977Config config) {
        this.config = config != null ? config : new Idea35977Config();
