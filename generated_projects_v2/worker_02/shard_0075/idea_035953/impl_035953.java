...
@Data
public class Idea35953Config {
    private String name = "idea_035953";
 ...
 */
@Slf4j
public class Idea35953Service {
    private static final int IDEA_ID = 35953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35953Service() {
        this(new Idea35953Config());
    }

    public Idea35953Service(Idea35953Config config) {
        this.config = config != null ? config : new Idea35953Config();
