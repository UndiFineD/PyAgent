...
@Data
public class Idea36027Config {
    private String name = "idea_036027";
 ...
 */
@Slf4j
public class Idea36027Service {
    private static final int IDEA_ID = 36027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36027Service() {
        this(new Idea36027Config());
    }

    public Idea36027Service(Idea36027Config config) {
        this.config = config != null ? config : new Idea36027Config();
