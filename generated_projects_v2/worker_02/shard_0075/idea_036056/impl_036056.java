...
@Data
public class Idea36056Config {
    private String name = "idea_036056";
 ...
 */
@Slf4j
public class Idea36056Service {
    private static final int IDEA_ID = 36056;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36056Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36056Service() {
        this(new Idea36056Config());
    }

    public Idea36056Service(Idea36056Config config) {
        this.config = config != null ? config : new Idea36056Config();
