...
@Data
public class Idea35938Config {
    private String name = "idea_035938";
 ...
 */
@Slf4j
public class Idea35938Service {
    private static final int IDEA_ID = 35938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35938Service() {
        this(new Idea35938Config());
    }

    public Idea35938Service(Idea35938Config config) {
        this.config = config != null ? config : new Idea35938Config();
