...
@Data
public class Idea35906Config {
    private String name = "idea_035906";
 ...
 */
@Slf4j
public class Idea35906Service {
    private static final int IDEA_ID = 35906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35906Service() {
        this(new Idea35906Config());
    }

    public Idea35906Service(Idea35906Config config) {
        this.config = config != null ? config : new Idea35906Config();
