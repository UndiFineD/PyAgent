...
@Data
public class Idea35914Config {
    private String name = "idea_035914";
 ...
 */
@Slf4j
public class Idea35914Service {
    private static final int IDEA_ID = 35914;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35914Service() {
        this(new Idea35914Config());
    }

    public Idea35914Service(Idea35914Config config) {
        this.config = config != null ? config : new Idea35914Config();
