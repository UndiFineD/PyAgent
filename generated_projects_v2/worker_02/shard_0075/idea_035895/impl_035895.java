...
@Data
public class Idea35895Config {
    private String name = "idea_035895";
 ...
 */
@Slf4j
public class Idea35895Service {
    private static final int IDEA_ID = 35895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35895Service() {
        this(new Idea35895Config());
    }

    public Idea35895Service(Idea35895Config config) {
        this.config = config != null ? config : new Idea35895Config();
