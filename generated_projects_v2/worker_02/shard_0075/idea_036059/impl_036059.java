...
@Data
public class Idea36059Config {
    private String name = "idea_036059";
 ...
 */
@Slf4j
public class Idea36059Service {
    private static final int IDEA_ID = 36059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36059Service() {
        this(new Idea36059Config());
    }

    public Idea36059Service(Idea36059Config config) {
        this.config = config != null ? config : new Idea36059Config();
