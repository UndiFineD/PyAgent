...
@Data
public class Idea35651Config {
    private String name = "idea_035651";
 ...
 */
@Slf4j
public class Idea35651Service {
    private static final int IDEA_ID = 35651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35651Service() {
        this(new Idea35651Config());
    }

    public Idea35651Service(Idea35651Config config) {
        this.config = config != null ? config : new Idea35651Config();
