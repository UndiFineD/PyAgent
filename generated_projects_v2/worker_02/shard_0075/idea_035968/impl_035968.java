...
@Data
public class Idea35968Config {
    private String name = "idea_035968";
 ...
 */
@Slf4j
public class Idea35968Service {
    private static final int IDEA_ID = 35968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35968Service() {
        this(new Idea35968Config());
    }

    public Idea35968Service(Idea35968Config config) {
        this.config = config != null ? config : new Idea35968Config();
