...
@Data
public class Idea35761Config {
    private String name = "idea_035761";
 ...
 */
@Slf4j
public class Idea35761Service {
    private static final int IDEA_ID = 35761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35761Service() {
        this(new Idea35761Config());
    }

    public Idea35761Service(Idea35761Config config) {
        this.config = config != null ? config : new Idea35761Config();
