...
@Data
public class Idea36065Config {
    private String name = "idea_036065";
 ...
 */
@Slf4j
public class Idea36065Service {
    private static final int IDEA_ID = 36065;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36065Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36065Service() {
        this(new Idea36065Config());
    }

    public Idea36065Service(Idea36065Config config) {
        this.config = config != null ? config : new Idea36065Config();
