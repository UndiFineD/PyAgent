...
@Data
public class Idea35766Config {
    private String name = "idea_035766";
 ...
 */
@Slf4j
public class Idea35766Service {
    private static final int IDEA_ID = 35766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35766Service() {
        this(new Idea35766Config());
    }

    public Idea35766Service(Idea35766Config config) {
        this.config = config != null ? config : new Idea35766Config();
