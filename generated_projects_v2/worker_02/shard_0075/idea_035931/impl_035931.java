...
@Data
public class Idea35931Config {
    private String name = "idea_035931";
 ...
 */
@Slf4j
public class Idea35931Service {
    private static final int IDEA_ID = 35931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35931Service() {
        this(new Idea35931Config());
    }

    public Idea35931Service(Idea35931Config config) {
        this.config = config != null ? config : new Idea35931Config();
