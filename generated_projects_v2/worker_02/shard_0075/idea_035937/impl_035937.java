...
@Data
public class Idea35937Config {
    private String name = "idea_035937";
 ...
 */
@Slf4j
public class Idea35937Service {
    private static final int IDEA_ID = 35937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35937Service() {
        this(new Idea35937Config());
    }

    public Idea35937Service(Idea35937Config config) {
        this.config = config != null ? config : new Idea35937Config();
