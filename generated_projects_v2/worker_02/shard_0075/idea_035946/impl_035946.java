...
@Data
public class Idea35946Config {
    private String name = "idea_035946";
 ...
 */
@Slf4j
public class Idea35946Service {
    private static final int IDEA_ID = 35946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35946Service() {
        this(new Idea35946Config());
    }

    public Idea35946Service(Idea35946Config config) {
        this.config = config != null ? config : new Idea35946Config();
