...
@Data
public class Idea35742Config {
    private String name = "idea_035742";
 ...
 */
@Slf4j
public class Idea35742Service {
    private static final int IDEA_ID = 35742;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35742Service() {
        this(new Idea35742Config());
    }

    public Idea35742Service(Idea35742Config config) {
        this.config = config != null ? config : new Idea35742Config();
