...
@Data
public class Idea35923Config {
    private String name = "idea_035923";
 ...
 */
@Slf4j
public class Idea35923Service {
    private static final int IDEA_ID = 35923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35923Service() {
        this(new Idea35923Config());
    }

    public Idea35923Service(Idea35923Config config) {
        this.config = config != null ? config : new Idea35923Config();
