...
@Data
public class Idea36067Config {
    private String name = "idea_036067";
 ...
 */
@Slf4j
public class Idea36067Service {
    private static final int IDEA_ID = 36067;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36067Service() {
        this(new Idea36067Config());
    }

    public Idea36067Service(Idea36067Config config) {
        this.config = config != null ? config : new Idea36067Config();
