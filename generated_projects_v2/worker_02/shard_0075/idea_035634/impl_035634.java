...
@Data
public class Idea35634Config {
    private String name = "idea_035634";
 ...
 */
@Slf4j
public class Idea35634Service {
    private static final int IDEA_ID = 35634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35634Service() {
        this(new Idea35634Config());
    }

    public Idea35634Service(Idea35634Config config) {
        this.config = config != null ? config : new Idea35634Config();
