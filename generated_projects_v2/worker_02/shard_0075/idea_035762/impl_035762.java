...
@Data
public class Idea35762Config {
    private String name = "idea_035762";
 ...
 */
@Slf4j
public class Idea35762Service {
    private static final int IDEA_ID = 35762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35762Service() {
        this(new Idea35762Config());
    }

    public Idea35762Service(Idea35762Config config) {
        this.config = config != null ? config : new Idea35762Config();
