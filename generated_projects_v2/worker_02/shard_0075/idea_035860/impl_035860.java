...
@Data
public class Idea35860Config {
    private String name = "idea_035860";
 ...
 */
@Slf4j
public class Idea35860Service {
    private static final int IDEA_ID = 35860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35860Service() {
        this(new Idea35860Config());
    }

    public Idea35860Service(Idea35860Config config) {
        this.config = config != null ? config : new Idea35860Config();
