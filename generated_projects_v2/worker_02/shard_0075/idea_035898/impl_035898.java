...
@Data
public class Idea35898Config {
    private String name = "idea_035898";
 ...
 */
@Slf4j
public class Idea35898Service {
    private static final int IDEA_ID = 35898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35898Service() {
        this(new Idea35898Config());
    }

    public Idea35898Service(Idea35898Config config) {
        this.config = config != null ? config : new Idea35898Config();
