...
@Data
public class Idea36003Config {
    private String name = "idea_036003";
 ...
 */
@Slf4j
public class Idea36003Service {
    private static final int IDEA_ID = 36003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36003Service() {
        this(new Idea36003Config());
    }

    public Idea36003Service(Idea36003Config config) {
        this.config = config != null ? config : new Idea36003Config();
