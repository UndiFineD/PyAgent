...
@Data
public class Idea35807Config {
    private String name = "idea_035807";
 ...
 */
@Slf4j
public class Idea35807Service {
    private static final int IDEA_ID = 35807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35807Service() {
        this(new Idea35807Config());
    }

    public Idea35807Service(Idea35807Config config) {
        this.config = config != null ? config : new Idea35807Config();
