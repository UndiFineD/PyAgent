...
@Data
public class Idea35833Config {
    private String name = "idea_035833";
 ...
 */
@Slf4j
public class Idea35833Service {
    private static final int IDEA_ID = 35833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35833Service() {
        this(new Idea35833Config());
    }

    public Idea35833Service(Idea35833Config config) {
        this.config = config != null ? config : new Idea35833Config();
