...
@Data
public class Idea36035Config {
    private String name = "idea_036035";
 ...
 */
@Slf4j
public class Idea36035Service {
    private static final int IDEA_ID = 36035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36035Service() {
        this(new Idea36035Config());
    }

    public Idea36035Service(Idea36035Config config) {
        this.config = config != null ? config : new Idea36035Config();
