...
@Data
public class Idea35806Config {
    private String name = "idea_035806";
 ...
 */
@Slf4j
public class Idea35806Service {
    private static final int IDEA_ID = 35806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35806Service() {
        this(new Idea35806Config());
    }

    public Idea35806Service(Idea35806Config config) {
        this.config = config != null ? config : new Idea35806Config();
