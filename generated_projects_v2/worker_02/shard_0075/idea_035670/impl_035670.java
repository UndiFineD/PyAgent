...
@Data
public class Idea35670Config {
    private String name = "idea_035670";
 ...
 */
@Slf4j
public class Idea35670Service {
    private static final int IDEA_ID = 35670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35670Service() {
        this(new Idea35670Config());
    }

    public Idea35670Service(Idea35670Config config) {
        this.config = config != null ? config : new Idea35670Config();
