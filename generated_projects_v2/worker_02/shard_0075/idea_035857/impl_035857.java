...
@Data
public class Idea35857Config {
    private String name = "idea_035857";
 ...
 */
@Slf4j
public class Idea35857Service {
    private static final int IDEA_ID = 35857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35857Service() {
        this(new Idea35857Config());
    }

    public Idea35857Service(Idea35857Config config) {
        this.config = config != null ? config : new Idea35857Config();
