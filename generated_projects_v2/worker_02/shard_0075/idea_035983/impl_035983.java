...
@Data
public class Idea35983Config {
    private String name = "idea_035983";
 ...
 */
@Slf4j
public class Idea35983Service {
    private static final int IDEA_ID = 35983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35983Service() {
        this(new Idea35983Config());
    }

    public Idea35983Service(Idea35983Config config) {
        this.config = config != null ? config : new Idea35983Config();
