...
@Data
public class Idea36044Config {
    private String name = "idea_036044";
 ...
 */
@Slf4j
public class Idea36044Service {
    private static final int IDEA_ID = 36044;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36044Service() {
        this(new Idea36044Config());
    }

    public Idea36044Service(Idea36044Config config) {
        this.config = config != null ? config : new Idea36044Config();
