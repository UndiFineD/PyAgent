...
@Data
public class Idea35996Config {
    private String name = "idea_035996";
 ...
 */
@Slf4j
public class Idea35996Service {
    private static final int IDEA_ID = 35996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35996Service() {
        this(new Idea35996Config());
    }

    public Idea35996Service(Idea35996Config config) {
        this.config = config != null ? config : new Idea35996Config();
