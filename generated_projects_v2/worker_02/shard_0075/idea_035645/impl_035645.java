...
@Data
public class Idea35645Config {
    private String name = "idea_035645";
 ...
 */
@Slf4j
public class Idea35645Service {
    private static final int IDEA_ID = 35645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35645Service() {
        this(new Idea35645Config());
    }

    public Idea35645Service(Idea35645Config config) {
        this.config = config != null ? config : new Idea35645Config();
