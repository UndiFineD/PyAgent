...
@Data
public class Idea35847Config {
    private String name = "idea_035847";
 ...
 */
@Slf4j
public class Idea35847Service {
    private static final int IDEA_ID = 35847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35847Service() {
        this(new Idea35847Config());
    }

    public Idea35847Service(Idea35847Config config) {
        this.config = config != null ? config : new Idea35847Config();
