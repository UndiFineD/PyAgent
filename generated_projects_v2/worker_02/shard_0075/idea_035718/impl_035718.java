...
@Data
public class Idea35718Config {
    private String name = "idea_035718";
 ...
 */
@Slf4j
public class Idea35718Service {
    private static final int IDEA_ID = 35718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35718Service() {
        this(new Idea35718Config());
    }

    public Idea35718Service(Idea35718Config config) {
        this.config = config != null ? config : new Idea35718Config();
