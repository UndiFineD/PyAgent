...
@Data
public class Idea35657Config {
    private String name = "idea_035657";
 ...
 */
@Slf4j
public class Idea35657Service {
    private static final int IDEA_ID = 35657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35657Service() {
        this(new Idea35657Config());
    }

    public Idea35657Service(Idea35657Config config) {
        this.config = config != null ? config : new Idea35657Config();
