...
@Data
public class Idea35749Config {
    private String name = "idea_035749";
 ...
 */
@Slf4j
public class Idea35749Service {
    private static final int IDEA_ID = 35749;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35749Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35749Service() {
        this(new Idea35749Config());
    }

    public Idea35749Service(Idea35749Config config) {
        this.config = config != null ? config : new Idea35749Config();
