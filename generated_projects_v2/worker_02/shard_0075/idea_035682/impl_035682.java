...
@Data
public class Idea35682Config {
    private String name = "idea_035682";
 ...
 */
@Slf4j
public class Idea35682Service {
    private static final int IDEA_ID = 35682;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35682Service() {
        this(new Idea35682Config());
    }

    public Idea35682Service(Idea35682Config config) {
        this.config = config != null ? config : new Idea35682Config();
