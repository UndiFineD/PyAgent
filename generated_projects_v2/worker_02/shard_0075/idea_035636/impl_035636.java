...
@Data
public class Idea35636Config {
    private String name = "idea_035636";
 ...
 */
@Slf4j
public class Idea35636Service {
    private static final int IDEA_ID = 35636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35636Service() {
        this(new Idea35636Config());
    }

    public Idea35636Service(Idea35636Config config) {
        this.config = config != null ? config : new Idea35636Config();
