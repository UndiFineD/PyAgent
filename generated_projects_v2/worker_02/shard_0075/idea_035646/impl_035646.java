...
@Data
public class Idea35646Config {
    private String name = "idea_035646";
 ...
 */
@Slf4j
public class Idea35646Service {
    private static final int IDEA_ID = 35646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35646Service() {
        this(new Idea35646Config());
    }

    public Idea35646Service(Idea35646Config config) {
        this.config = config != null ? config : new Idea35646Config();
