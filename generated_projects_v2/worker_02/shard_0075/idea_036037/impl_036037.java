...
@Data
public class Idea36037Config {
    private String name = "idea_036037";
 ...
 */
@Slf4j
public class Idea36037Service {
    private static final int IDEA_ID = 36037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36037Service() {
        this(new Idea36037Config());
    }

    public Idea36037Service(Idea36037Config config) {
        this.config = config != null ? config : new Idea36037Config();
