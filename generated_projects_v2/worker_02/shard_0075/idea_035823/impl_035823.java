...
@Data
public class Idea35823Config {
    private String name = "idea_035823";
 ...
 */
@Slf4j
public class Idea35823Service {
    private static final int IDEA_ID = 35823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35823Service() {
        this(new Idea35823Config());
    }

    public Idea35823Service(Idea35823Config config) {
        this.config = config != null ? config : new Idea35823Config();
