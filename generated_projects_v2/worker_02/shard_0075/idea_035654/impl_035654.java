...
@Data
public class Idea35654Config {
    private String name = "idea_035654";
 ...
 */
@Slf4j
public class Idea35654Service {
    private static final int IDEA_ID = 35654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35654Service() {
        this(new Idea35654Config());
    }

    public Idea35654Service(Idea35654Config config) {
        this.config = config != null ? config : new Idea35654Config();
