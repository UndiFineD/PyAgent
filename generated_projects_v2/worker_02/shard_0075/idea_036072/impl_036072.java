...
@Data
public class Idea36072Config {
    private String name = "idea_036072";
 ...
 */
@Slf4j
public class Idea36072Service {
    private static final int IDEA_ID = 36072;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36072Service() {
        this(new Idea36072Config());
    }

    public Idea36072Service(Idea36072Config config) {
        this.config = config != null ? config : new Idea36072Config();
