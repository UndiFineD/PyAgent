...
@Data
public class Idea35848Config {
    private String name = "idea_035848";
 ...
 */
@Slf4j
public class Idea35848Service {
    private static final int IDEA_ID = 35848;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35848Service() {
        this(new Idea35848Config());
    }

    public Idea35848Service(Idea35848Config config) {
        this.config = config != null ? config : new Idea35848Config();
