...
@Data
public class Idea35949Config {
    private String name = "idea_035949";
 ...
 */
@Slf4j
public class Idea35949Service {
    private static final int IDEA_ID = 35949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35949Service() {
        this(new Idea35949Config());
    }

    public Idea35949Service(Idea35949Config config) {
        this.config = config != null ? config : new Idea35949Config();
