...
@Data
public class Idea35969Config {
    private String name = "idea_035969";
 ...
 */
@Slf4j
public class Idea35969Service {
    private static final int IDEA_ID = 35969;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35969Service() {
        this(new Idea35969Config());
    }

    public Idea35969Service(Idea35969Config config) {
        this.config = config != null ? config : new Idea35969Config();
