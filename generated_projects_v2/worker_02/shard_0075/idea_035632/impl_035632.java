...
@Data
public class Idea35632Config {
    private String name = "idea_035632";
 ...
 */
@Slf4j
public class Idea35632Service {
    private static final int IDEA_ID = 35632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35632Service() {
        this(new Idea35632Config());
    }

    public Idea35632Service(Idea35632Config config) {
        this.config = config != null ? config : new Idea35632Config();
