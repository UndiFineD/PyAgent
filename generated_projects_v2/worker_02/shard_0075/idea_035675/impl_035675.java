...
@Data
public class Idea35675Config {
    private String name = "idea_035675";
 ...
 */
@Slf4j
public class Idea35675Service {
    private static final int IDEA_ID = 35675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35675Service() {
        this(new Idea35675Config());
    }

    public Idea35675Service(Idea35675Config config) {
        this.config = config != null ? config : new Idea35675Config();
