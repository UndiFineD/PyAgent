...
@Data
public class Idea35870Config {
    private String name = "idea_035870";
 ...
 */
@Slf4j
public class Idea35870Service {
    private static final int IDEA_ID = 35870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35870Service() {
        this(new Idea35870Config());
    }

    public Idea35870Service(Idea35870Config config) {
        this.config = config != null ? config : new Idea35870Config();
