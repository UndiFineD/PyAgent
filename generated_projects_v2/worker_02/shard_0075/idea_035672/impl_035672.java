...
@Data
public class Idea35672Config {
    private String name = "idea_035672";
 ...
 */
@Slf4j
public class Idea35672Service {
    private static final int IDEA_ID = 35672;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35672Service() {
        this(new Idea35672Config());
    }

    public Idea35672Service(Idea35672Config config) {
        this.config = config != null ? config : new Idea35672Config();
