...
@Data
public class Idea35818Config {
    private String name = "idea_035818";
 ...
 */
@Slf4j
public class Idea35818Service {
    private static final int IDEA_ID = 35818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35818Service() {
        this(new Idea35818Config());
    }

    public Idea35818Service(Idea35818Config config) {
        this.config = config != null ? config : new Idea35818Config();
