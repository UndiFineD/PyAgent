...
@Data
public class Idea35773Config {
    private String name = "idea_035773";
 ...
 */
@Slf4j
public class Idea35773Service {
    private static final int IDEA_ID = 35773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35773Service() {
        this(new Idea35773Config());
    }

    public Idea35773Service(Idea35773Config config) {
        this.config = config != null ? config : new Idea35773Config();
