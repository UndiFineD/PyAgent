...
@Data
public class Idea35785Config {
    private String name = "idea_035785";
 ...
 */
@Slf4j
public class Idea35785Service {
    private static final int IDEA_ID = 35785;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35785Service() {
        this(new Idea35785Config());
    }

    public Idea35785Service(Idea35785Config config) {
        this.config = config != null ? config : new Idea35785Config();
