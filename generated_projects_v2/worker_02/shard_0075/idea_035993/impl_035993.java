...
@Data
public class Idea35993Config {
    private String name = "idea_035993";
 ...
 */
@Slf4j
public class Idea35993Service {
    private static final int IDEA_ID = 35993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35993Service() {
        this(new Idea35993Config());
    }

    public Idea35993Service(Idea35993Config config) {
        this.config = config != null ? config : new Idea35993Config();
