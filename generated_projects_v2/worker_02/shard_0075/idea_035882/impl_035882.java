...
@Data
public class Idea35882Config {
    private String name = "idea_035882";
 ...
 */
@Slf4j
public class Idea35882Service {
    private static final int IDEA_ID = 35882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35882Service() {
        this(new Idea35882Config());
    }

    public Idea35882Service(Idea35882Config config) {
        this.config = config != null ? config : new Idea35882Config();
