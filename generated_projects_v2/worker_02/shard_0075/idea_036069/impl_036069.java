...
@Data
public class Idea36069Config {
    private String name = "idea_036069";
 ...
 */
@Slf4j
public class Idea36069Service {
    private static final int IDEA_ID = 36069;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36069Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36069Service() {
        this(new Idea36069Config());
    }

    public Idea36069Service(Idea36069Config config) {
        this.config = config != null ? config : new Idea36069Config();
