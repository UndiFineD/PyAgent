...
@Data
public class Idea35911Config {
    private String name = "idea_035911";
 ...
 */
@Slf4j
public class Idea35911Service {
    private static final int IDEA_ID = 35911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35911Service() {
        this(new Idea35911Config());
    }

    public Idea35911Service(Idea35911Config config) {
        this.config = config != null ? config : new Idea35911Config();
