...
@Data
public class Idea35981Config {
    private String name = "idea_035981";
 ...
 */
@Slf4j
public class Idea35981Service {
    private static final int IDEA_ID = 35981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35981Service() {
        this(new Idea35981Config());
    }

    public Idea35981Service(Idea35981Config config) {
        this.config = config != null ? config : new Idea35981Config();
