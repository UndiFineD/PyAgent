...
@Data
public class Idea36057Config {
    private String name = "idea_036057";
 ...
 */
@Slf4j
public class Idea36057Service {
    private static final int IDEA_ID = 36057;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36057Service() {
        this(new Idea36057Config());
    }

    public Idea36057Service(Idea36057Config config) {
        this.config = config != null ? config : new Idea36057Config();
