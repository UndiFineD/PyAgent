...
@Data
public class Idea35679Config {
    private String name = "idea_035679";
 ...
 */
@Slf4j
public class Idea35679Service {
    private static final int IDEA_ID = 35679;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35679Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35679Service() {
        this(new Idea35679Config());
    }

    public Idea35679Service(Idea35679Config config) {
        this.config = config != null ? config : new Idea35679Config();
