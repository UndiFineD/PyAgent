...
@Data
public class Idea36028Config {
    private String name = "idea_036028";
 ...
 */
@Slf4j
public class Idea36028Service {
    private static final int IDEA_ID = 36028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36028Service() {
        this(new Idea36028Config());
    }

    public Idea36028Service(Idea36028Config config) {
        this.config = config != null ? config : new Idea36028Config();
