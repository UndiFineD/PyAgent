...
@Data
public class Idea36070Config {
    private String name = "idea_036070";
 ...
 */
@Slf4j
public class Idea36070Service {
    private static final int IDEA_ID = 36070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36070Service() {
        this(new Idea36070Config());
    }

    public Idea36070Service(Idea36070Config config) {
        this.config = config != null ? config : new Idea36070Config();
