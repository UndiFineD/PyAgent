...
@Data
public class Idea35671Config {
    private String name = "idea_035671";
 ...
 */
@Slf4j
public class Idea35671Service {
    private static final int IDEA_ID = 35671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35671Service() {
        this(new Idea35671Config());
    }

    public Idea35671Service(Idea35671Config config) {
        this.config = config != null ? config : new Idea35671Config();
