...
@Data
public class Idea35662Config {
    private String name = "idea_035662";
 ...
 */
@Slf4j
public class Idea35662Service {
    private static final int IDEA_ID = 35662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35662Service() {
        this(new Idea35662Config());
    }

    public Idea35662Service(Idea35662Config config) {
        this.config = config != null ? config : new Idea35662Config();
