...
@Data
public class Idea36036Config {
    private String name = "idea_036036";
 ...
 */
@Slf4j
public class Idea36036Service {
    private static final int IDEA_ID = 36036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36036Service() {
        this(new Idea36036Config());
    }

    public Idea36036Service(Idea36036Config config) {
        this.config = config != null ? config : new Idea36036Config();
