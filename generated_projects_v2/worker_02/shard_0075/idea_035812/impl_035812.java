...
@Data
public class Idea35812Config {
    private String name = "idea_035812";
 ...
 */
@Slf4j
public class Idea35812Service {
    private static final int IDEA_ID = 35812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35812Service() {
        this(new Idea35812Config());
    }

    public Idea35812Service(Idea35812Config config) {
        this.config = config != null ? config : new Idea35812Config();
