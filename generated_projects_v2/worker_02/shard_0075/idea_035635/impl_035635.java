...
@Data
public class Idea35635Config {
    private String name = "idea_035635";
 ...
 */
@Slf4j
public class Idea35635Service {
    private static final int IDEA_ID = 35635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35635Service() {
        this(new Idea35635Config());
    }

    public Idea35635Service(Idea35635Config config) {
        this.config = config != null ? config : new Idea35635Config();
