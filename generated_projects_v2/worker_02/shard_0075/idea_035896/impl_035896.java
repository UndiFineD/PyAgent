...
@Data
public class Idea35896Config {
    private String name = "idea_035896";
 ...
 */
@Slf4j
public class Idea35896Service {
    private static final int IDEA_ID = 35896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35896Service() {
        this(new Idea35896Config());
    }

    public Idea35896Service(Idea35896Config config) {
        this.config = config != null ? config : new Idea35896Config();
