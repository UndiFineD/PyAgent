...
@Data
public class Idea35640Config {
    private String name = "idea_035640";
 ...
 */
@Slf4j
public class Idea35640Service {
    private static final int IDEA_ID = 35640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35640Service() {
        this(new Idea35640Config());
    }

    public Idea35640Service(Idea35640Config config) {
        this.config = config != null ? config : new Idea35640Config();
