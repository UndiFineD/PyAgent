...
@Data
public class Idea35831Config {
    private String name = "idea_035831";
 ...
 */
@Slf4j
public class Idea35831Service {
    private static final int IDEA_ID = 35831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35831Service() {
        this(new Idea35831Config());
    }

    public Idea35831Service(Idea35831Config config) {
        this.config = config != null ? config : new Idea35831Config();
