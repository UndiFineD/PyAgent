...
@Data
public class Idea35763Config {
    private String name = "idea_035763";
 ...
 */
@Slf4j
public class Idea35763Service {
    private static final int IDEA_ID = 35763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35763Service() {
        this(new Idea35763Config());
    }

    public Idea35763Service(Idea35763Config config) {
        this.config = config != null ? config : new Idea35763Config();
