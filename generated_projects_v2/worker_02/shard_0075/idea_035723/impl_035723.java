...
@Data
public class Idea35723Config {
    private String name = "idea_035723";
 ...
 */
@Slf4j
public class Idea35723Service {
    private static final int IDEA_ID = 35723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35723Service() {
        this(new Idea35723Config());
    }

    public Idea35723Service(Idea35723Config config) {
        this.config = config != null ? config : new Idea35723Config();
