...
@Data
public class Idea35864Config {
    private String name = "idea_035864";
 ...
 */
@Slf4j
public class Idea35864Service {
    private static final int IDEA_ID = 35864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35864Service() {
        this(new Idea35864Config());
    }

    public Idea35864Service(Idea35864Config config) {
        this.config = config != null ? config : new Idea35864Config();
