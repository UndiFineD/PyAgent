...
@Data
public class Idea35827Config {
    private String name = "idea_035827";
 ...
 */
@Slf4j
public class Idea35827Service {
    private static final int IDEA_ID = 35827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35827Service() {
        this(new Idea35827Config());
    }

    public Idea35827Service(Idea35827Config config) {
        this.config = config != null ? config : new Idea35827Config();
