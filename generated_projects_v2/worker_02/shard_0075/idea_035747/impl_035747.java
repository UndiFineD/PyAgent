...
@Data
public class Idea35747Config {
    private String name = "idea_035747";
 ...
 */
@Slf4j
public class Idea35747Service {
    private static final int IDEA_ID = 35747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35747Service() {
        this(new Idea35747Config());
    }

    public Idea35747Service(Idea35747Config config) {
        this.config = config != null ? config : new Idea35747Config();
