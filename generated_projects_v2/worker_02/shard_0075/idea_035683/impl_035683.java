...
@Data
public class Idea35683Config {
    private String name = "idea_035683";
 ...
 */
@Slf4j
public class Idea35683Service {
    private static final int IDEA_ID = 35683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35683Service() {
        this(new Idea35683Config());
    }

    public Idea35683Service(Idea35683Config config) {
        this.config = config != null ? config : new Idea35683Config();
