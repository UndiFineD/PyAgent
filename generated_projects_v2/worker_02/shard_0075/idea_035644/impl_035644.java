...
@Data
public class Idea35644Config {
    private String name = "idea_035644";
 ...
 */
@Slf4j
public class Idea35644Service {
    private static final int IDEA_ID = 35644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35644Service() {
        this(new Idea35644Config());
    }

    public Idea35644Service(Idea35644Config config) {
        this.config = config != null ? config : new Idea35644Config();
