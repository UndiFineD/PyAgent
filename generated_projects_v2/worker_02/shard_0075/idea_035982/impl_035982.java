...
@Data
public class Idea35982Config {
    private String name = "idea_035982";
 ...
 */
@Slf4j
public class Idea35982Service {
    private static final int IDEA_ID = 35982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35982Service() {
        this(new Idea35982Config());
    }

    public Idea35982Service(Idea35982Config config) {
        this.config = config != null ? config : new Idea35982Config();
