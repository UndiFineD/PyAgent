...
@Data
public class Idea35780Config {
    private String name = "idea_035780";
 ...
 */
@Slf4j
public class Idea35780Service {
    private static final int IDEA_ID = 35780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35780Service() {
        this(new Idea35780Config());
    }

    public Idea35780Service(Idea35780Config config) {
        this.config = config != null ? config : new Idea35780Config();
