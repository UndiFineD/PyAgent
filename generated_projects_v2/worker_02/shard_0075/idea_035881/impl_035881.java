...
@Data
public class Idea35881Config {
    private String name = "idea_035881";
 ...
 */
@Slf4j
public class Idea35881Service {
    private static final int IDEA_ID = 35881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35881Service() {
        this(new Idea35881Config());
    }

    public Idea35881Service(Idea35881Config config) {
        this.config = config != null ? config : new Idea35881Config();
