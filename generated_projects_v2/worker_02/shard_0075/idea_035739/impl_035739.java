...
@Data
public class Idea35739Config {
    private String name = "idea_035739";
 ...
 */
@Slf4j
public class Idea35739Service {
    private static final int IDEA_ID = 35739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35739Service() {
        this(new Idea35739Config());
    }

    public Idea35739Service(Idea35739Config config) {
        this.config = config != null ? config : new Idea35739Config();
