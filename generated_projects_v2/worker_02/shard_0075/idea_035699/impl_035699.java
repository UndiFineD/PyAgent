...
@Data
public class Idea35699Config {
    private String name = "idea_035699";
 ...
 */
@Slf4j
public class Idea35699Service {
    private static final int IDEA_ID = 35699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35699Service() {
        this(new Idea35699Config());
    }

    public Idea35699Service(Idea35699Config config) {
        this.config = config != null ? config : new Idea35699Config();
