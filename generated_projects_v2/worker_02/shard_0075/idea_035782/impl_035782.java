...
@Data
public class Idea35782Config {
    private String name = "idea_035782";
 ...
 */
@Slf4j
public class Idea35782Service {
    private static final int IDEA_ID = 35782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35782Service() {
        this(new Idea35782Config());
    }

    public Idea35782Service(Idea35782Config config) {
        this.config = config != null ? config : new Idea35782Config();
