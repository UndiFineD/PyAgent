...
@Data
public class Idea35656Config {
    private String name = "idea_035656";
 ...
 */
@Slf4j
public class Idea35656Service {
    private static final int IDEA_ID = 35656;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35656Service() {
        this(new Idea35656Config());
    }

    public Idea35656Service(Idea35656Config config) {
        this.config = config != null ? config : new Idea35656Config();
