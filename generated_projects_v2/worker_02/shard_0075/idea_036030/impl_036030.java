...
@Data
public class Idea36030Config {
    private String name = "idea_036030";
 ...
 */
@Slf4j
public class Idea36030Service {
    private static final int IDEA_ID = 36030;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36030Service() {
        this(new Idea36030Config());
    }

    public Idea36030Service(Idea36030Config config) {
        this.config = config != null ? config : new Idea36030Config();
