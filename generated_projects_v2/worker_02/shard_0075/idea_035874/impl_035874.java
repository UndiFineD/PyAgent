...
@Data
public class Idea35874Config {
    private String name = "idea_035874";
 ...
 */
@Slf4j
public class Idea35874Service {
    private static final int IDEA_ID = 35874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35874Service() {
        this(new Idea35874Config());
    }

    public Idea35874Service(Idea35874Config config) {
        this.config = config != null ? config : new Idea35874Config();
