...
@Data
public class Idea35694Config {
    private String name = "idea_035694";
 ...
 */
@Slf4j
public class Idea35694Service {
    private static final int IDEA_ID = 35694;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35694Service() {
        this(new Idea35694Config());
    }

    public Idea35694Service(Idea35694Config config) {
        this.config = config != null ? config : new Idea35694Config();
