...
@Data
public class Idea35886Config {
    private String name = "idea_035886";
 ...
 */
@Slf4j
public class Idea35886Service {
    private static final int IDEA_ID = 35886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35886Service() {
        this(new Idea35886Config());
    }

    public Idea35886Service(Idea35886Config config) {
        this.config = config != null ? config : new Idea35886Config();
