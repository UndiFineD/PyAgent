...
@Data
public class Idea36029Config {
    private String name = "idea_036029";
 ...
 */
@Slf4j
public class Idea36029Service {
    private static final int IDEA_ID = 36029;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36029Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36029Service() {
        this(new Idea36029Config());
    }

    public Idea36029Service(Idea36029Config config) {
        this.config = config != null ? config : new Idea36029Config();
