...
@Data
public class Idea35709Config {
    private String name = "idea_035709";
 ...
 */
@Slf4j
public class Idea35709Service {
    private static final int IDEA_ID = 35709;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35709Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35709Service() {
        this(new Idea35709Config());
    }

    public Idea35709Service(Idea35709Config config) {
        this.config = config != null ? config : new Idea35709Config();
