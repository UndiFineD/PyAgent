...
@Data
public class Idea36088Config {
    private String name = "idea_036088";
 ...
 */
@Slf4j
public class Idea36088Service {
    private static final int IDEA_ID = 36088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36088Service() {
        this(new Idea36088Config());
    }

    public Idea36088Service(Idea36088Config config) {
        this.config = config != null ? config : new Idea36088Config();
