...
@Data
public class Idea35808Config {
    private String name = "idea_035808";
 ...
 */
@Slf4j
public class Idea35808Service {
    private static final int IDEA_ID = 35808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35808Service() {
        this(new Idea35808Config());
    }

    public Idea35808Service(Idea35808Config config) {
        this.config = config != null ? config : new Idea35808Config();
