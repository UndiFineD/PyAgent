...
@Data
public class Idea36005Config {
    private String name = "idea_036005";
 ...
 */
@Slf4j
public class Idea36005Service {
    private static final int IDEA_ID = 36005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36005Service() {
        this(new Idea36005Config());
    }

    public Idea36005Service(Idea36005Config config) {
        this.config = config != null ? config : new Idea36005Config();
