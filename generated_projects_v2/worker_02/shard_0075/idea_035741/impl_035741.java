...
@Data
public class Idea35741Config {
    private String name = "idea_035741";
 ...
 */
@Slf4j
public class Idea35741Service {
    private static final int IDEA_ID = 35741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35741Service() {
        this(new Idea35741Config());
    }

    public Idea35741Service(Idea35741Config config) {
        this.config = config != null ? config : new Idea35741Config();
