...
@Data
public class Idea36010Config {
    private String name = "idea_036010";
 ...
 */
@Slf4j
public class Idea36010Service {
    private static final int IDEA_ID = 36010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36010Service() {
        this(new Idea36010Config());
    }

    public Idea36010Service(Idea36010Config config) {
        this.config = config != null ? config : new Idea36010Config();
