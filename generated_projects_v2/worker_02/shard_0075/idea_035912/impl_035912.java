...
@Data
public class Idea35912Config {
    private String name = "idea_035912";
 ...
 */
@Slf4j
public class Idea35912Service {
    private static final int IDEA_ID = 35912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35912Service() {
        this(new Idea35912Config());
    }

    public Idea35912Service(Idea35912Config config) {
        this.config = config != null ? config : new Idea35912Config();
