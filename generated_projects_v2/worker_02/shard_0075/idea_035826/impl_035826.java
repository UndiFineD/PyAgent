...
@Data
public class Idea35826Config {
    private String name = "idea_035826";
 ...
 */
@Slf4j
public class Idea35826Service {
    private static final int IDEA_ID = 35826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35826Service() {
        this(new Idea35826Config());
    }

    public Idea35826Service(Idea35826Config config) {
        this.config = config != null ? config : new Idea35826Config();
