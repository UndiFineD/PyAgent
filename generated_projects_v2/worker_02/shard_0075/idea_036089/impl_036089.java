...
@Data
public class Idea36089Config {
    private String name = "idea_036089";
 ...
 */
@Slf4j
public class Idea36089Service {
    private static final int IDEA_ID = 36089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36089Service() {
        this(new Idea36089Config());
    }

    public Idea36089Service(Idea36089Config config) {
        this.config = config != null ? config : new Idea36089Config();
