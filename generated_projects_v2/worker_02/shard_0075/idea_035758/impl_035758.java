...
@Data
public class Idea35758Config {
    private String name = "idea_035758";
 ...
 */
@Slf4j
public class Idea35758Service {
    private static final int IDEA_ID = 35758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35758Service() {
        this(new Idea35758Config());
    }

    public Idea35758Service(Idea35758Config config) {
        this.config = config != null ? config : new Idea35758Config();
