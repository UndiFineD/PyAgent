...
@Data
public class Idea36047Config {
    private String name = "idea_036047";
 ...
 */
@Slf4j
public class Idea36047Service {
    private static final int IDEA_ID = 36047;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36047Service() {
        this(new Idea36047Config());
    }

    public Idea36047Service(Idea36047Config config) {
        this.config = config != null ? config : new Idea36047Config();
