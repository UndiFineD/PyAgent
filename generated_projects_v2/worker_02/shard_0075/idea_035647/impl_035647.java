...
@Data
public class Idea35647Config {
    private String name = "idea_035647";
 ...
 */
@Slf4j
public class Idea35647Service {
    private static final int IDEA_ID = 35647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35647Service() {
        this(new Idea35647Config());
    }

    public Idea35647Service(Idea35647Config config) {
        this.config = config != null ? config : new Idea35647Config();
