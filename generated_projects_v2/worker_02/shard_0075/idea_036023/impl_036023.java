...
@Data
public class Idea36023Config {
    private String name = "idea_036023";
 ...
 */
@Slf4j
public class Idea36023Service {
    private static final int IDEA_ID = 36023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36023Service() {
        this(new Idea36023Config());
    }

    public Idea36023Service(Idea36023Config config) {
        this.config = config != null ? config : new Idea36023Config();
