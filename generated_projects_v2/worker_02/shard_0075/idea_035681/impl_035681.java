...
@Data
public class Idea35681Config {
    private String name = "idea_035681";
 ...
 */
@Slf4j
public class Idea35681Service {
    private static final int IDEA_ID = 35681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35681Service() {
        this(new Idea35681Config());
    }

    public Idea35681Service(Idea35681Config config) {
        this.config = config != null ? config : new Idea35681Config();
