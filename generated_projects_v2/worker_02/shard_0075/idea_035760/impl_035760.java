...
@Data
public class Idea35760Config {
    private String name = "idea_035760";
 ...
 */
@Slf4j
public class Idea35760Service {
    private static final int IDEA_ID = 35760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35760Service() {
        this(new Idea35760Config());
    }

    public Idea35760Service(Idea35760Config config) {
        this.config = config != null ? config : new Idea35760Config();
