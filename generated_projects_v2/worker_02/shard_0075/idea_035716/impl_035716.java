...
@Data
public class Idea35716Config {
    private String name = "idea_035716";
 ...
 */
@Slf4j
public class Idea35716Service {
    private static final int IDEA_ID = 35716;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35716Service() {
        this(new Idea35716Config());
    }

    public Idea35716Service(Idea35716Config config) {
        this.config = config != null ? config : new Idea35716Config();
