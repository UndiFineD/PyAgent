...
@Data
public class Idea35905Config {
    private String name = "idea_035905";
 ...
 */
@Slf4j
public class Idea35905Service {
    private static final int IDEA_ID = 35905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35905Service() {
        this(new Idea35905Config());
    }

    public Idea35905Service(Idea35905Config config) {
        this.config = config != null ? config : new Idea35905Config();
