...
@Data
public class Idea35843Config {
    private String name = "idea_035843";
 ...
 */
@Slf4j
public class Idea35843Service {
    private static final int IDEA_ID = 35843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35843Service() {
        this(new Idea35843Config());
    }

    public Idea35843Service(Idea35843Config config) {
        this.config = config != null ? config : new Idea35843Config();
