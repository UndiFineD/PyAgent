...
@Data
public class Idea35643Config {
    private String name = "idea_035643";
 ...
 */
@Slf4j
public class Idea35643Service {
    private static final int IDEA_ID = 35643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35643Service() {
        this(new Idea35643Config());
    }

    public Idea35643Service(Idea35643Config config) {
        this.config = config != null ? config : new Idea35643Config();
