...
@Data
public class Idea35787Config {
    private String name = "idea_035787";
 ...
 */
@Slf4j
public class Idea35787Service {
    private static final int IDEA_ID = 35787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35787Service() {
        this(new Idea35787Config());
    }

    public Idea35787Service(Idea35787Config config) {
        this.config = config != null ? config : new Idea35787Config();
