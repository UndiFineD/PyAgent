...
@Data
public class Idea35861Config {
    private String name = "idea_035861";
 ...
 */
@Slf4j
public class Idea35861Service {
    private static final int IDEA_ID = 35861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35861Service() {
        this(new Idea35861Config());
    }

    public Idea35861Service(Idea35861Config config) {
        this.config = config != null ? config : new Idea35861Config();
