...
@Data
public class Idea36018Config {
    private String name = "idea_036018";
 ...
 */
@Slf4j
public class Idea36018Service {
    private static final int IDEA_ID = 36018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36018Service() {
        this(new Idea36018Config());
    }

    public Idea36018Service(Idea36018Config config) {
        this.config = config != null ? config : new Idea36018Config();
