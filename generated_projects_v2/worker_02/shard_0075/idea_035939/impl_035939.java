...
@Data
public class Idea35939Config {
    private String name = "idea_035939";
 ...
 */
@Slf4j
public class Idea35939Service {
    private static final int IDEA_ID = 35939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35939Service() {
        this(new Idea35939Config());
    }

    public Idea35939Service(Idea35939Config config) {
        this.config = config != null ? config : new Idea35939Config();
