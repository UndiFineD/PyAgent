...
@Data
public class Idea35888Config {
    private String name = "idea_035888";
 ...
 */
@Slf4j
public class Idea35888Service {
    private static final int IDEA_ID = 35888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35888Service() {
        this(new Idea35888Config());
    }

    public Idea35888Service(Idea35888Config config) {
        this.config = config != null ? config : new Idea35888Config();
