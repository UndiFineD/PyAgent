...
@Data
public class Idea36043Config {
    private String name = "idea_036043";
 ...
 */
@Slf4j
public class Idea36043Service {
    private static final int IDEA_ID = 36043;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36043Service() {
        this(new Idea36043Config());
    }

    public Idea36043Service(Idea36043Config config) {
        this.config = config != null ? config : new Idea36043Config();
