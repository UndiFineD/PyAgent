...
@Data
public class Idea35663Config {
    private String name = "idea_035663";
 ...
 */
@Slf4j
public class Idea35663Service {
    private static final int IDEA_ID = 35663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35663Service() {
        this(new Idea35663Config());
    }

    public Idea35663Service(Idea35663Config config) {
        this.config = config != null ? config : new Idea35663Config();
