...
@Data
public class Idea35796Config {
    private String name = "idea_035796";
 ...
 */
@Slf4j
public class Idea35796Service {
    private static final int IDEA_ID = 35796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35796Service() {
        this(new Idea35796Config());
    }

    public Idea35796Service(Idea35796Config config) {
        this.config = config != null ? config : new Idea35796Config();
