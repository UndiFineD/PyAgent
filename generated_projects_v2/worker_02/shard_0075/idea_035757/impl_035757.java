...
@Data
public class Idea35757Config {
    private String name = "idea_035757";
 ...
 */
@Slf4j
public class Idea35757Service {
    private static final int IDEA_ID = 35757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35757Service() {
        this(new Idea35757Config());
    }

    public Idea35757Service(Idea35757Config config) {
        this.config = config != null ? config : new Idea35757Config();
