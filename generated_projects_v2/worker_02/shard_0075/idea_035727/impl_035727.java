...
@Data
public class Idea35727Config {
    private String name = "idea_035727";
 ...
 */
@Slf4j
public class Idea35727Service {
    private static final int IDEA_ID = 35727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35727Service() {
        this(new Idea35727Config());
    }

    public Idea35727Service(Idea35727Config config) {
        this.config = config != null ? config : new Idea35727Config();
