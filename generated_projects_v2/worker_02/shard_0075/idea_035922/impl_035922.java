...
@Data
public class Idea35922Config {
    private String name = "idea_035922";
 ...
 */
@Slf4j
public class Idea35922Service {
    private static final int IDEA_ID = 35922;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35922Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35922Service() {
        this(new Idea35922Config());
    }

    public Idea35922Service(Idea35922Config config) {
        this.config = config != null ? config : new Idea35922Config();
