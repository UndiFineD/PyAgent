...
@Data
public class Idea36038Config {
    private String name = "idea_036038";
 ...
 */
@Slf4j
public class Idea36038Service {
    private static final int IDEA_ID = 36038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36038Service() {
        this(new Idea36038Config());
    }

    public Idea36038Service(Idea36038Config config) {
        this.config = config != null ? config : new Idea36038Config();
