...
@Data
public class Idea36080Config {
    private String name = "idea_036080";
 ...
 */
@Slf4j
public class Idea36080Service {
    private static final int IDEA_ID = 36080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36080Service() {
        this(new Idea36080Config());
    }

    public Idea36080Service(Idea36080Config config) {
        this.config = config != null ? config : new Idea36080Config();
