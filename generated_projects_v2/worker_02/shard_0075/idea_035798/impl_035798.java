...
@Data
public class Idea35798Config {
    private String name = "idea_035798";
 ...
 */
@Slf4j
public class Idea35798Service {
    private static final int IDEA_ID = 35798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35798Service() {
        this(new Idea35798Config());
    }

    public Idea35798Service(Idea35798Config config) {
        this.config = config != null ? config : new Idea35798Config();
