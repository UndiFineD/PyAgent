...
@Data
public class Idea36085Config {
    private String name = "idea_036085";
 ...
 */
@Slf4j
public class Idea36085Service {
    private static final int IDEA_ID = 36085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36085Service() {
        this(new Idea36085Config());
    }

    public Idea36085Service(Idea36085Config config) {
        this.config = config != null ? config : new Idea36085Config();
