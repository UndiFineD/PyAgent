...
@Data
public class Idea35810Config {
    private String name = "idea_035810";
 ...
 */
@Slf4j
public class Idea35810Service {
    private static final int IDEA_ID = 35810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35810Service() {
        this(new Idea35810Config());
    }

    public Idea35810Service(Idea35810Config config) {
        this.config = config != null ? config : new Idea35810Config();
