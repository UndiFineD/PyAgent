...
@Data
public class Idea35660Config {
    private String name = "idea_035660";
 ...
 */
@Slf4j
public class Idea35660Service {
    private static final int IDEA_ID = 35660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35660Service() {
        this(new Idea35660Config());
    }

    public Idea35660Service(Idea35660Config config) {
        this.config = config != null ? config : new Idea35660Config();
