...
@Data
public class Idea35775Config {
    private String name = "idea_035775";
 ...
 */
@Slf4j
public class Idea35775Service {
    private static final int IDEA_ID = 35775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35775Service() {
        this(new Idea35775Config());
    }

    public Idea35775Service(Idea35775Config config) {
        this.config = config != null ? config : new Idea35775Config();
