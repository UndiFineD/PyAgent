...
@Data
public class Idea35910Config {
    private String name = "idea_035910";
 ...
 */
@Slf4j
public class Idea35910Service {
    private static final int IDEA_ID = 35910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35910Service() {
        this(new Idea35910Config());
    }

    public Idea35910Service(Idea35910Config config) {
        this.config = config != null ? config : new Idea35910Config();
