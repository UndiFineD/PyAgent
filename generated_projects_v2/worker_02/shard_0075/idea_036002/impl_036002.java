...
@Data
public class Idea36002Config {
    private String name = "idea_036002";
 ...
 */
@Slf4j
public class Idea36002Service {
    private static final int IDEA_ID = 36002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36002Service() {
        this(new Idea36002Config());
    }

    public Idea36002Service(Idea36002Config config) {
        this.config = config != null ? config : new Idea36002Config();
