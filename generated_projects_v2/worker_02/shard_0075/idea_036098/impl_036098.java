...
@Data
public class Idea36098Config {
    private String name = "idea_036098";
 ...
 */
@Slf4j
public class Idea36098Service {
    private static final int IDEA_ID = 36098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36098Service() {
        this(new Idea36098Config());
    }

    public Idea36098Service(Idea36098Config config) {
        this.config = config != null ? config : new Idea36098Config();
