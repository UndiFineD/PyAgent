...
@Data
public class Idea35726Config {
    private String name = "idea_035726";
 ...
 */
@Slf4j
public class Idea35726Service {
    private static final int IDEA_ID = 35726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35726Service() {
        this(new Idea35726Config());
    }

    public Idea35726Service(Idea35726Config config) {
        this.config = config != null ? config : new Idea35726Config();
