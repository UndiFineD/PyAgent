...
@Data
public class Idea36081Config {
    private String name = "idea_036081";
 ...
 */
@Slf4j
public class Idea36081Service {
    private static final int IDEA_ID = 36081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36081Service() {
        this(new Idea36081Config());
    }

    public Idea36081Service(Idea36081Config config) {
        this.config = config != null ? config : new Idea36081Config();
