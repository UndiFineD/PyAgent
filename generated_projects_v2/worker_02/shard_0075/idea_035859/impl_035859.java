...
@Data
public class Idea35859Config {
    private String name = "idea_035859";
 ...
 */
@Slf4j
public class Idea35859Service {
    private static final int IDEA_ID = 35859;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35859Service() {
        this(new Idea35859Config());
    }

    public Idea35859Service(Idea35859Config config) {
        this.config = config != null ? config : new Idea35859Config();
