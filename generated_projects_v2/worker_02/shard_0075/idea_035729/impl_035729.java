...
@Data
public class Idea35729Config {
    private String name = "idea_035729";
 ...
 */
@Slf4j
public class Idea35729Service {
    private static final int IDEA_ID = 35729;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35729Service() {
        this(new Idea35729Config());
    }

    public Idea35729Service(Idea35729Config config) {
        this.config = config != null ? config : new Idea35729Config();
