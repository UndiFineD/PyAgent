...
@Data
public class Idea35764Config {
    private String name = "idea_035764";
 ...
 */
@Slf4j
public class Idea35764Service {
    private static final int IDEA_ID = 35764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35764Service() {
        this(new Idea35764Config());
    }

    public Idea35764Service(Idea35764Config config) {
        this.config = config != null ? config : new Idea35764Config();
