...
@Data
public class Idea35781Config {
    private String name = "idea_035781";
 ...
 */
@Slf4j
public class Idea35781Service {
    private static final int IDEA_ID = 35781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35781Service() {
        this(new Idea35781Config());
    }

    public Idea35781Service(Idea35781Config config) {
        this.config = config != null ? config : new Idea35781Config();
