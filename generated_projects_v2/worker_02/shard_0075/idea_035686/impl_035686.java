...
@Data
public class Idea35686Config {
    private String name = "idea_035686";
 ...
 */
@Slf4j
public class Idea35686Service {
    private static final int IDEA_ID = 35686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35686Service() {
        this(new Idea35686Config());
    }

    public Idea35686Service(Idea35686Config config) {
        this.config = config != null ? config : new Idea35686Config();
