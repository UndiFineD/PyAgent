...
@Data
public class Idea35866Config {
    private String name = "idea_035866";
 ...
 */
@Slf4j
public class Idea35866Service {
    private static final int IDEA_ID = 35866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35866Service() {
        this(new Idea35866Config());
    }

    public Idea35866Service(Idea35866Config config) {
        this.config = config != null ? config : new Idea35866Config();
