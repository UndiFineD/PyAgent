...
@Data
public class Idea35721Config {
    private String name = "idea_035721";
 ...
 */
@Slf4j
public class Idea35721Service {
    private static final int IDEA_ID = 35721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35721Service() {
        this(new Idea35721Config());
    }

    public Idea35721Service(Idea35721Config config) {
        this.config = config != null ? config : new Idea35721Config();
