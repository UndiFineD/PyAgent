...
@Data
public class Idea35700Config {
    private String name = "idea_035700";
 ...
 */
@Slf4j
public class Idea35700Service {
    private static final int IDEA_ID = 35700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35700Service() {
        this(new Idea35700Config());
    }

    public Idea35700Service(Idea35700Config config) {
        this.config = config != null ? config : new Idea35700Config();
