...
@Data
public class Idea35952Config {
    private String name = "idea_035952";
 ...
 */
@Slf4j
public class Idea35952Service {
    private static final int IDEA_ID = 35952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35952Service() {
        this(new Idea35952Config());
    }

    public Idea35952Service(Idea35952Config config) {
        this.config = config != null ? config : new Idea35952Config();
