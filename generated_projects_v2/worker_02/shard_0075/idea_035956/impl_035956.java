...
@Data
public class Idea35956Config {
    private String name = "idea_035956";
 ...
 */
@Slf4j
public class Idea35956Service {
    private static final int IDEA_ID = 35956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35956Service() {
        this(new Idea35956Config());
    }

    public Idea35956Service(Idea35956Config config) {
        this.config = config != null ? config : new Idea35956Config();
