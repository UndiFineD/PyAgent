...
@Data
public class Idea35885Config {
    private String name = "idea_035885";
 ...
 */
@Slf4j
public class Idea35885Service {
    private static final int IDEA_ID = 35885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35885Service() {
        this(new Idea35885Config());
    }

    public Idea35885Service(Idea35885Config config) {
        this.config = config != null ? config : new Idea35885Config();
