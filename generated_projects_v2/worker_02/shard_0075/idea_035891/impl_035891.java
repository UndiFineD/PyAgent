...
@Data
public class Idea35891Config {
    private String name = "idea_035891";
 ...
 */
@Slf4j
public class Idea35891Service {
    private static final int IDEA_ID = 35891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35891Service() {
        this(new Idea35891Config());
    }

    public Idea35891Service(Idea35891Config config) {
        this.config = config != null ? config : new Idea35891Config();
