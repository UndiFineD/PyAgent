...
@Data
public class Idea35835Config {
    private String name = "idea_035835";
 ...
 */
@Slf4j
public class Idea35835Service {
    private static final int IDEA_ID = 35835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35835Service() {
        this(new Idea35835Config());
    }

    public Idea35835Service(Idea35835Config config) {
        this.config = config != null ? config : new Idea35835Config();
