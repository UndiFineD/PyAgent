...
@Data
public class Idea35919Config {
    private String name = "idea_035919";
 ...
 */
@Slf4j
public class Idea35919Service {
    private static final int IDEA_ID = 35919;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35919Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35919Service() {
        this(new Idea35919Config());
    }

    public Idea35919Service(Idea35919Config config) {
        this.config = config != null ? config : new Idea35919Config();
