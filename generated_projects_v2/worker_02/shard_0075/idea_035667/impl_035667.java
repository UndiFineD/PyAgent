...
@Data
public class Idea35667Config {
    private String name = "idea_035667";
 ...
 */
@Slf4j
public class Idea35667Service {
    private static final int IDEA_ID = 35667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35667Service() {
        this(new Idea35667Config());
    }

    public Idea35667Service(Idea35667Config config) {
        this.config = config != null ? config : new Idea35667Config();
