...
@Data
public class Idea35771Config {
    private String name = "idea_035771";
 ...
 */
@Slf4j
public class Idea35771Service {
    private static final int IDEA_ID = 35771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35771Service() {
        this(new Idea35771Config());
    }

    public Idea35771Service(Idea35771Config config) {
        this.config = config != null ? config : new Idea35771Config();
