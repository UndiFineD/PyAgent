...
@Data
public class Idea36097Config {
    private String name = "idea_036097";
 ...
 */
@Slf4j
public class Idea36097Service {
    private static final int IDEA_ID = 36097;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36097Service() {
        this(new Idea36097Config());
    }

    public Idea36097Service(Idea36097Config config) {
        this.config = config != null ? config : new Idea36097Config();
