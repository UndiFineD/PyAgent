...
@Data
public class Idea35790Config {
    private String name = "idea_035790";
 ...
 */
@Slf4j
public class Idea35790Service {
    private static final int IDEA_ID = 35790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35790Service() {
        this(new Idea35790Config());
    }

    public Idea35790Service(Idea35790Config config) {
        this.config = config != null ? config : new Idea35790Config();
