...
@Data
public class Idea36046Config {
    private String name = "idea_036046";
 ...
 */
@Slf4j
public class Idea36046Service {
    private static final int IDEA_ID = 36046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36046Service() {
        this(new Idea36046Config());
    }

    public Idea36046Service(Idea36046Config config) {
        this.config = config != null ? config : new Idea36046Config();
