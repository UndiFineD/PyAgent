...
@Data
public class Idea35641Config {
    private String name = "idea_035641";
 ...
 */
@Slf4j
public class Idea35641Service {
    private static final int IDEA_ID = 35641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35641Service() {
        this(new Idea35641Config());
    }

    public Idea35641Service(Idea35641Config config) {
        this.config = config != null ? config : new Idea35641Config();
