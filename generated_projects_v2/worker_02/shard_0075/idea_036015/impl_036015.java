...
@Data
public class Idea36015Config {
    private String name = "idea_036015";
 ...
 */
@Slf4j
public class Idea36015Service {
    private static final int IDEA_ID = 36015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36015Service() {
        this(new Idea36015Config());
    }

    public Idea36015Service(Idea36015Config config) {
        this.config = config != null ? config : new Idea36015Config();
