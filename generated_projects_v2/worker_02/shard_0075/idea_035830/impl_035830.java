...
@Data
public class Idea35830Config {
    private String name = "idea_035830";
 ...
 */
@Slf4j
public class Idea35830Service {
    private static final int IDEA_ID = 35830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35830Service() {
        this(new Idea35830Config());
    }

    public Idea35830Service(Idea35830Config config) {
        this.config = config != null ? config : new Idea35830Config();
