...
@Data
public class Idea35653Config {
    private String name = "idea_035653";
 ...
 */
@Slf4j
public class Idea35653Service {
    private static final int IDEA_ID = 35653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35653Service() {
        this(new Idea35653Config());
    }

    public Idea35653Service(Idea35653Config config) {
        this.config = config != null ? config : new Idea35653Config();
