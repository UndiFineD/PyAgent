...
@Data
public class Idea36048Config {
    private String name = "idea_036048";
 ...
 */
@Slf4j
public class Idea36048Service {
    private static final int IDEA_ID = 36048;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36048Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36048Service() {
        this(new Idea36048Config());
    }

    public Idea36048Service(Idea36048Config config) {
        this.config = config != null ? config : new Idea36048Config();
