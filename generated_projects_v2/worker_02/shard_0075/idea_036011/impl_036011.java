...
@Data
public class Idea36011Config {
    private String name = "idea_036011";
 ...
 */
@Slf4j
public class Idea36011Service {
    private static final int IDEA_ID = 36011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36011Service() {
        this(new Idea36011Config());
    }

    public Idea36011Service(Idea36011Config config) {
        this.config = config != null ? config : new Idea36011Config();
