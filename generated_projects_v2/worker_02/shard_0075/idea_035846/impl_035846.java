...
@Data
public class Idea35846Config {
    private String name = "idea_035846";
 ...
 */
@Slf4j
public class Idea35846Service {
    private static final int IDEA_ID = 35846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35846Service() {
        this(new Idea35846Config());
    }

    public Idea35846Service(Idea35846Config config) {
        this.config = config != null ? config : new Idea35846Config();
