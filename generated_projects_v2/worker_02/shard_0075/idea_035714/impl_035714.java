...
@Data
public class Idea35714Config {
    private String name = "idea_035714";
 ...
 */
@Slf4j
public class Idea35714Service {
    private static final int IDEA_ID = 35714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35714Service() {
        this(new Idea35714Config());
    }

    public Idea35714Service(Idea35714Config config) {
        this.config = config != null ? config : new Idea35714Config();
