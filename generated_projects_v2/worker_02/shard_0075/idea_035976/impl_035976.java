...
@Data
public class Idea35976Config {
    private String name = "idea_035976";
 ...
 */
@Slf4j
public class Idea35976Service {
    private static final int IDEA_ID = 35976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35976Service() {
        this(new Idea35976Config());
    }

    public Idea35976Service(Idea35976Config config) {
        this.config = config != null ? config : new Idea35976Config();
