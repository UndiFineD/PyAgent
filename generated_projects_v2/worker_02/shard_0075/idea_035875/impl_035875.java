...
@Data
public class Idea35875Config {
    private String name = "idea_035875";
 ...
 */
@Slf4j
public class Idea35875Service {
    private static final int IDEA_ID = 35875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35875Service() {
        this(new Idea35875Config());
    }

    public Idea35875Service(Idea35875Config config) {
        this.config = config != null ? config : new Idea35875Config();
