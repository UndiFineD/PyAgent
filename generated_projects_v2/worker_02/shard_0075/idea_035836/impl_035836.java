...
@Data
public class Idea35836Config {
    private String name = "idea_035836";
 ...
 */
@Slf4j
public class Idea35836Service {
    private static final int IDEA_ID = 35836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35836Service() {
        this(new Idea35836Config());
    }

    public Idea35836Service(Idea35836Config config) {
        this.config = config != null ? config : new Idea35836Config();
