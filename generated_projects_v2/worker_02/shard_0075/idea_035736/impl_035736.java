...
@Data
public class Idea35736Config {
    private String name = "idea_035736";
 ...
 */
@Slf4j
public class Idea35736Service {
    private static final int IDEA_ID = 35736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35736Service() {
        this(new Idea35736Config());
    }

    public Idea35736Service(Idea35736Config config) {
        this.config = config != null ? config : new Idea35736Config();
