...
@Data
public class Idea35688Config {
    private String name = "idea_035688";
 ...
 */
@Slf4j
public class Idea35688Service {
    private static final int IDEA_ID = 35688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35688Service() {
        this(new Idea35688Config());
    }

    public Idea35688Service(Idea35688Config config) {
        this.config = config != null ? config : new Idea35688Config();
