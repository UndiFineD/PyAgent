...
@Data
public class Idea36026Config {
    private String name = "idea_036026";
 ...
 */
@Slf4j
public class Idea36026Service {
    private static final int IDEA_ID = 36026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36026Service() {
        this(new Idea36026Config());
    }

    public Idea36026Service(Idea36026Config config) {
        this.config = config != null ? config : new Idea36026Config();
