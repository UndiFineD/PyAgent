...
@Data
public class Idea35992Config {
    private String name = "idea_035992";
 ...
 */
@Slf4j
public class Idea35992Service {
    private static final int IDEA_ID = 35992;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35992Service() {
        this(new Idea35992Config());
    }

    public Idea35992Service(Idea35992Config config) {
        this.config = config != null ? config : new Idea35992Config();
