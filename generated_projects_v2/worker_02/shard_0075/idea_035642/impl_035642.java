...
@Data
public class Idea35642Config {
    private String name = "idea_035642";
 ...
 */
@Slf4j
public class Idea35642Service {
    private static final int IDEA_ID = 35642;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35642Service() {
        this(new Idea35642Config());
    }

    public Idea35642Service(Idea35642Config config) {
        this.config = config != null ? config : new Idea35642Config();
