...
@Data
public class Idea36099Config {
    private String name = "idea_036099";
 ...
 */
@Slf4j
public class Idea36099Service {
    private static final int IDEA_ID = 36099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36099Service() {
        this(new Idea36099Config());
    }

    public Idea36099Service(Idea36099Config config) {
        this.config = config != null ? config : new Idea36099Config();
