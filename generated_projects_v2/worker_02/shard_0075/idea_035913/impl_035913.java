...
@Data
public class Idea35913Config {
    private String name = "idea_035913";
 ...
 */
@Slf4j
public class Idea35913Service {
    private static final int IDEA_ID = 35913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35913Service() {
        this(new Idea35913Config());
    }

    public Idea35913Service(Idea35913Config config) {
        this.config = config != null ? config : new Idea35913Config();
