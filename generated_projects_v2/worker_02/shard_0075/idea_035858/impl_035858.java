...
@Data
public class Idea35858Config {
    private String name = "idea_035858";
 ...
 */
@Slf4j
public class Idea35858Service {
    private static final int IDEA_ID = 35858;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35858Service() {
        this(new Idea35858Config());
    }

    public Idea35858Service(Idea35858Config config) {
        this.config = config != null ? config : new Idea35858Config();
