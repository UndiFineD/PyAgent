...
@Data
public class Idea35832Config {
    private String name = "idea_035832";
 ...
 */
@Slf4j
public class Idea35832Service {
    private static final int IDEA_ID = 35832;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35832Service() {
        this(new Idea35832Config());
    }

    public Idea35832Service(Idea35832Config config) {
        this.config = config != null ? config : new Idea35832Config();
