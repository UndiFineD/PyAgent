...
@Data
public class Idea35788Config {
    private String name = "idea_035788";
 ...
 */
@Slf4j
public class Idea35788Service {
    private static final int IDEA_ID = 35788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35788Service() {
        this(new Idea35788Config());
    }

    public Idea35788Service(Idea35788Config config) {
        this.config = config != null ? config : new Idea35788Config();
