...
@Data
public class Idea35925Config {
    private String name = "idea_035925";
 ...
 */
@Slf4j
public class Idea35925Service {
    private static final int IDEA_ID = 35925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35925Service() {
        this(new Idea35925Config());
    }

    public Idea35925Service(Idea35925Config config) {
        this.config = config != null ? config : new Idea35925Config();
