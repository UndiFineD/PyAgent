...
@Data
public class Idea35817Config {
    private String name = "idea_035817";
 ...
 */
@Slf4j
public class Idea35817Service {
    private static final int IDEA_ID = 35817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35817Service() {
        this(new Idea35817Config());
    }

    public Idea35817Service(Idea35817Config config) {
        this.config = config != null ? config : new Idea35817Config();
