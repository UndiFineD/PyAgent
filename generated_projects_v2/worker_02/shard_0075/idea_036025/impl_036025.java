...
@Data
public class Idea36025Config {
    private String name = "idea_036025";
 ...
 */
@Slf4j
public class Idea36025Service {
    private static final int IDEA_ID = 36025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36025Service() {
        this(new Idea36025Config());
    }

    public Idea36025Service(Idea36025Config config) {
        this.config = config != null ? config : new Idea36025Config();
