...
@Data
public class Idea35737Config {
    private String name = "idea_035737";
 ...
 */
@Slf4j
public class Idea35737Service {
    private static final int IDEA_ID = 35737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35737Service() {
        this(new Idea35737Config());
    }

    public Idea35737Service(Idea35737Config config) {
        this.config = config != null ? config : new Idea35737Config();
