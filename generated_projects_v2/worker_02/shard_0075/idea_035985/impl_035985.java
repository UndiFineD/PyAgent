...
@Data
public class Idea35985Config {
    private String name = "idea_035985";
 ...
 */
@Slf4j
public class Idea35985Service {
    private static final int IDEA_ID = 35985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35985Service() {
        this(new Idea35985Config());
    }

    public Idea35985Service(Idea35985Config config) {
        this.config = config != null ? config : new Idea35985Config();
