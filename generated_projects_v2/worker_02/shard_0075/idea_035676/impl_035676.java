...
@Data
public class Idea35676Config {
    private String name = "idea_035676";
 ...
 */
@Slf4j
public class Idea35676Service {
    private static final int IDEA_ID = 35676;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35676Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35676Service() {
        this(new Idea35676Config());
    }

    public Idea35676Service(Idea35676Config config) {
        this.config = config != null ? config : new Idea35676Config();
