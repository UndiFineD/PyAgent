...
@Data
public class Idea35873Config {
    private String name = "idea_035873";
 ...
 */
@Slf4j
public class Idea35873Service {
    private static final int IDEA_ID = 35873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35873Service() {
        this(new Idea35873Config());
    }

    public Idea35873Service(Idea35873Config config) {
        this.config = config != null ? config : new Idea35873Config();
