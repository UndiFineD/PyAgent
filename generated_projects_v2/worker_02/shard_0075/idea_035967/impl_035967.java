...
@Data
public class Idea35967Config {
    private String name = "idea_035967";
 ...
 */
@Slf4j
public class Idea35967Service {
    private static final int IDEA_ID = 35967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35967Service() {
        this(new Idea35967Config());
    }

    public Idea35967Service(Idea35967Config config) {
        this.config = config != null ? config : new Idea35967Config();
