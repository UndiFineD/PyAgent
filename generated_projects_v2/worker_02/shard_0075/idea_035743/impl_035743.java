...
@Data
public class Idea35743Config {
    private String name = "idea_035743";
 ...
 */
@Slf4j
public class Idea35743Service {
    private static final int IDEA_ID = 35743;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35743Service() {
        this(new Idea35743Config());
    }

    public Idea35743Service(Idea35743Config config) {
        this.config = config != null ? config : new Idea35743Config();
