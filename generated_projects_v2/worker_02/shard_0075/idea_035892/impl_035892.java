...
@Data
public class Idea35892Config {
    private String name = "idea_035892";
 ...
 */
@Slf4j
public class Idea35892Service {
    private static final int IDEA_ID = 35892;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35892Service() {
        this(new Idea35892Config());
    }

    public Idea35892Service(Idea35892Config config) {
        this.config = config != null ? config : new Idea35892Config();
