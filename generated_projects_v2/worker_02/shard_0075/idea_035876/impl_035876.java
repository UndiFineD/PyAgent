...
@Data
public class Idea35876Config {
    private String name = "idea_035876";
 ...
 */
@Slf4j
public class Idea35876Service {
    private static final int IDEA_ID = 35876;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35876Service() {
        this(new Idea35876Config());
    }

    public Idea35876Service(Idea35876Config config) {
        this.config = config != null ? config : new Idea35876Config();
