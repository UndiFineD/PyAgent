...
@Data
public class Idea36050Config {
    private String name = "idea_036050";
 ...
 */
@Slf4j
public class Idea36050Service {
    private static final int IDEA_ID = 36050;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36050Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36050Service() {
        this(new Idea36050Config());
    }

    public Idea36050Service(Idea36050Config config) {
        this.config = config != null ? config : new Idea36050Config();
