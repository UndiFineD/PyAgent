...
@Data
public class Idea35695Config {
    private String name = "idea_035695";
 ...
 */
@Slf4j
public class Idea35695Service {
    private static final int IDEA_ID = 35695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35695Service() {
        this(new Idea35695Config());
    }

    public Idea35695Service(Idea35695Config config) {
        this.config = config != null ? config : new Idea35695Config();
