...
@Data
public class Idea35842Config {
    private String name = "idea_035842";
 ...
 */
@Slf4j
public class Idea35842Service {
    private static final int IDEA_ID = 35842;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35842Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35842Service() {
        this(new Idea35842Config());
    }

    public Idea35842Service(Idea35842Config config) {
        this.config = config != null ? config : new Idea35842Config();
