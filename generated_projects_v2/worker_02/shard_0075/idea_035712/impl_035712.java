...
@Data
public class Idea35712Config {
    private String name = "idea_035712";
 ...
 */
@Slf4j
public class Idea35712Service {
    private static final int IDEA_ID = 35712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35712Service() {
        this(new Idea35712Config());
    }

    public Idea35712Service(Idea35712Config config) {
        this.config = config != null ? config : new Idea35712Config();
