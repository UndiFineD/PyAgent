...
@Data
public class Idea36031Config {
    private String name = "idea_036031";
 ...
 */
@Slf4j
public class Idea36031Service {
    private static final int IDEA_ID = 36031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36031Service() {
        this(new Idea36031Config());
    }

    public Idea36031Service(Idea36031Config config) {
        this.config = config != null ? config : new Idea36031Config();
