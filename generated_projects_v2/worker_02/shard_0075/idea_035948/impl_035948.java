...
@Data
public class Idea35948Config {
    private String name = "idea_035948";
 ...
 */
@Slf4j
public class Idea35948Service {
    private static final int IDEA_ID = 35948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35948Service() {
        this(new Idea35948Config());
    }

    public Idea35948Service(Idea35948Config config) {
        this.config = config != null ? config : new Idea35948Config();
