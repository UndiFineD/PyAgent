...
@Data
public class Idea35865Config {
    private String name = "idea_035865";
 ...
 */
@Slf4j
public class Idea35865Service {
    private static final int IDEA_ID = 35865;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35865Service() {
        this(new Idea35865Config());
    }

    public Idea35865Service(Idea35865Config config) {
        this.config = config != null ? config : new Idea35865Config();
