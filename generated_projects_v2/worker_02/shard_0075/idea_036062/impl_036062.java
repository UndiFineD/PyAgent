...
@Data
public class Idea36062Config {
    private String name = "idea_036062";
 ...
 */
@Slf4j
public class Idea36062Service {
    private static final int IDEA_ID = 36062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36062Service() {
        this(new Idea36062Config());
    }

    public Idea36062Service(Idea36062Config config) {
        this.config = config != null ? config : new Idea36062Config();
