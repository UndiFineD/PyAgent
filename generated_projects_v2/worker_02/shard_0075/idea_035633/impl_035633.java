...
@Data
public class Idea35633Config {
    private String name = "idea_035633";
 ...
 */
@Slf4j
public class Idea35633Service {
    private static final int IDEA_ID = 35633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35633Service() {
        this(new Idea35633Config());
    }

    public Idea35633Service(Idea35633Config config) {
        this.config = config != null ? config : new Idea35633Config();
