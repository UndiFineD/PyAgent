...
@Data
public class Idea36092Config {
    private String name = "idea_036092";
 ...
 */
@Slf4j
public class Idea36092Service {
    private static final int IDEA_ID = 36092;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36092Service() {
        this(new Idea36092Config());
    }

    public Idea36092Service(Idea36092Config config) {
        this.config = config != null ? config : new Idea36092Config();
