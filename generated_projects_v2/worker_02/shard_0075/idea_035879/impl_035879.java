...
@Data
public class Idea35879Config {
    private String name = "idea_035879";
 ...
 */
@Slf4j
public class Idea35879Service {
    private static final int IDEA_ID = 35879;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35879Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35879Service() {
        this(new Idea35879Config());
    }

    public Idea35879Service(Idea35879Config config) {
        this.config = config != null ? config : new Idea35879Config();
