...
@Data
public class Idea36060Config {
    private String name = "idea_036060";
 ...
 */
@Slf4j
public class Idea36060Service {
    private static final int IDEA_ID = 36060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36060Service() {
        this(new Idea36060Config());
    }

    public Idea36060Service(Idea36060Config config) {
        this.config = config != null ? config : new Idea36060Config();
