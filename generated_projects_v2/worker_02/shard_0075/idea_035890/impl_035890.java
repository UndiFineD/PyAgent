...
@Data
public class Idea35890Config {
    private String name = "idea_035890";
 ...
 */
@Slf4j
public class Idea35890Service {
    private static final int IDEA_ID = 35890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35890Service() {
        this(new Idea35890Config());
    }

    public Idea35890Service(Idea35890Config config) {
        this.config = config != null ? config : new Idea35890Config();
