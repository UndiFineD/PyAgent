...
@Data
public class Idea35871Config {
    private String name = "idea_035871";
 ...
 */
@Slf4j
public class Idea35871Service {
    private static final int IDEA_ID = 35871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35871Service() {
        this(new Idea35871Config());
    }

    public Idea35871Service(Idea35871Config config) {
        this.config = config != null ? config : new Idea35871Config();
