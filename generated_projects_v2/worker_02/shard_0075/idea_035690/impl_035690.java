...
@Data
public class Idea35690Config {
    private String name = "idea_035690";
 ...
 */
@Slf4j
public class Idea35690Service {
    private static final int IDEA_ID = 35690;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35690Service() {
        this(new Idea35690Config());
    }

    public Idea35690Service(Idea35690Config config) {
        this.config = config != null ? config : new Idea35690Config();
