...
@Data
public class Idea36009Config {
    private String name = "idea_036009";
 ...
 */
@Slf4j
public class Idea36009Service {
    private static final int IDEA_ID = 36009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36009Service() {
        this(new Idea36009Config());
    }

    public Idea36009Service(Idea36009Config config) {
        this.config = config != null ? config : new Idea36009Config();
