...
@Data
public class Idea35918Config {
    private String name = "idea_035918";
 ...
 */
@Slf4j
public class Idea35918Service {
    private static final int IDEA_ID = 35918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35918Service() {
        this(new Idea35918Config());
    }

    public Idea35918Service(Idea35918Config config) {
        this.config = config != null ? config : new Idea35918Config();
