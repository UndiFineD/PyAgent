...
@Data
public class Idea35767Config {
    private String name = "idea_035767";
 ...
 */
@Slf4j
public class Idea35767Service {
    private static final int IDEA_ID = 35767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35767Service() {
        this(new Idea35767Config());
    }

    public Idea35767Service(Idea35767Config config) {
        this.config = config != null ? config : new Idea35767Config();
