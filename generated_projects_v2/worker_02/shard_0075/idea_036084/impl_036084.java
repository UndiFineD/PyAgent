...
@Data
public class Idea36084Config {
    private String name = "idea_036084";
 ...
 */
@Slf4j
public class Idea36084Service {
    private static final int IDEA_ID = 36084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36084Service() {
        this(new Idea36084Config());
    }

    public Idea36084Service(Idea36084Config config) {
        this.config = config != null ? config : new Idea36084Config();
