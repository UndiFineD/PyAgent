...
@Data
public class Idea36017Config {
    private String name = "idea_036017";
 ...
 */
@Slf4j
public class Idea36017Service {
    private static final int IDEA_ID = 36017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36017Service() {
        this(new Idea36017Config());
    }

    public Idea36017Service(Idea36017Config config) {
        this.config = config != null ? config : new Idea36017Config();
