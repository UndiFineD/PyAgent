...
@Data
public class Idea35805Config {
    private String name = "idea_035805";
 ...
 */
@Slf4j
public class Idea35805Service {
    private static final int IDEA_ID = 35805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35805Service() {
        this(new Idea35805Config());
    }

    public Idea35805Service(Idea35805Config config) {
        this.config = config != null ? config : new Idea35805Config();
