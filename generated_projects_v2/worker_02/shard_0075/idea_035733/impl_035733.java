...
@Data
public class Idea35733Config {
    private String name = "idea_035733";
 ...
 */
@Slf4j
public class Idea35733Service {
    private static final int IDEA_ID = 35733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35733Service() {
        this(new Idea35733Config());
    }

    public Idea35733Service(Idea35733Config config) {
        this.config = config != null ? config : new Idea35733Config();
