...
@Data
public class Idea35933Config {
    private String name = "idea_035933";
 ...
 */
@Slf4j
public class Idea35933Service {
    private static final int IDEA_ID = 35933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35933Service() {
        this(new Idea35933Config());
    }

    public Idea35933Service(Idea35933Config config) {
        this.config = config != null ? config : new Idea35933Config();
