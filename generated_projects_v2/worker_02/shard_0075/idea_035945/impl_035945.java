...
@Data
public class Idea35945Config {
    private String name = "idea_035945";
 ...
 */
@Slf4j
public class Idea35945Service {
    private static final int IDEA_ID = 35945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35945Service() {
        this(new Idea35945Config());
    }

    public Idea35945Service(Idea35945Config config) {
        this.config = config != null ? config : new Idea35945Config();
