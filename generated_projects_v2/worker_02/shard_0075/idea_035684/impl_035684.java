...
@Data
public class Idea35684Config {
    private String name = "idea_035684";
 ...
 */
@Slf4j
public class Idea35684Service {
    private static final int IDEA_ID = 35684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35684Service() {
        this(new Idea35684Config());
    }

    public Idea35684Service(Idea35684Config config) {
        this.config = config != null ? config : new Idea35684Config();
