...
@Data
public class Idea35894Config {
    private String name = "idea_035894";
 ...
 */
@Slf4j
public class Idea35894Service {
    private static final int IDEA_ID = 35894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35894Service() {
        this(new Idea35894Config());
    }

    public Idea35894Service(Idea35894Config config) {
        this.config = config != null ? config : new Idea35894Config();
