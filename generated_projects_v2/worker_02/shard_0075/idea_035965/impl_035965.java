...
@Data
public class Idea35965Config {
    private String name = "idea_035965";
 ...
 */
@Slf4j
public class Idea35965Service {
    private static final int IDEA_ID = 35965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35965Service() {
        this(new Idea35965Config());
    }

    public Idea35965Service(Idea35965Config config) {
        this.config = config != null ? config : new Idea35965Config();
