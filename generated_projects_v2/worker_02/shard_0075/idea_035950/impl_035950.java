...
@Data
public class Idea35950Config {
    private String name = "idea_035950";
 ...
 */
@Slf4j
public class Idea35950Service {
    private static final int IDEA_ID = 35950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35950Service() {
        this(new Idea35950Config());
    }

    public Idea35950Service(Idea35950Config config) {
        this.config = config != null ? config : new Idea35950Config();
