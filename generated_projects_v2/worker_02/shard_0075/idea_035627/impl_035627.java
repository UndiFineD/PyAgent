...
@Data
public class Idea35627Config {
    private String name = "idea_035627";
 ...
 */
@Slf4j
public class Idea35627Service {
    private static final int IDEA_ID = 35627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35627Service() {
        this(new Idea35627Config());
    }

    public Idea35627Service(Idea35627Config config) {
        this.config = config != null ? config : new Idea35627Config();
