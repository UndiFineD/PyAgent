...
@Data
public class Idea35821Config {
    private String name = "idea_035821";
 ...
 */
@Slf4j
public class Idea35821Service {
    private static final int IDEA_ID = 35821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35821Service() {
        this(new Idea35821Config());
    }

    public Idea35821Service(Idea35821Config config) {
        this.config = config != null ? config : new Idea35821Config();
