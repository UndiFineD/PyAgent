...
@Data
public class Idea35648Config {
    private String name = "idea_035648";
 ...
 */
@Slf4j
public class Idea35648Service {
    private static final int IDEA_ID = 35648;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35648Service() {
        this(new Idea35648Config());
    }

    public Idea35648Service(Idea35648Config config) {
        this.config = config != null ? config : new Idea35648Config();
