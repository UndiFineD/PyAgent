...
@Data
public class Idea36042Config {
    private String name = "idea_036042";
 ...
 */
@Slf4j
public class Idea36042Service {
    private static final int IDEA_ID = 36042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36042Service() {
        this(new Idea36042Config());
    }

    public Idea36042Service(Idea36042Config config) {
        this.config = config != null ? config : new Idea36042Config();
