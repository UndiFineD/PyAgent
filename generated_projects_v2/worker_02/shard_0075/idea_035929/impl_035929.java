...
@Data
public class Idea35929Config {
    private String name = "idea_035929";
 ...
 */
@Slf4j
public class Idea35929Service {
    private static final int IDEA_ID = 35929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35929Service() {
        this(new Idea35929Config());
    }

    public Idea35929Service(Idea35929Config config) {
        this.config = config != null ? config : new Idea35929Config();
