...
@Data
public class Idea35851Config {
    private String name = "idea_035851";
 ...
 */
@Slf4j
public class Idea35851Service {
    private static final int IDEA_ID = 35851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35851Service() {
        this(new Idea35851Config());
    }

    public Idea35851Service(Idea35851Config config) {
        this.config = config != null ? config : new Idea35851Config();
