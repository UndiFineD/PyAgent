...
@Data
public class Idea35744Config {
    private String name = "idea_035744";
 ...
 */
@Slf4j
public class Idea35744Service {
    private static final int IDEA_ID = 35744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35744Service() {
        this(new Idea35744Config());
    }

    public Idea35744Service(Idea35744Config config) {
        this.config = config != null ? config : new Idea35744Config();
