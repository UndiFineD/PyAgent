...
@Data
public class Idea35731Config {
    private String name = "idea_035731";
 ...
 */
@Slf4j
public class Idea35731Service {
    private static final int IDEA_ID = 35731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35731Service() {
        this(new Idea35731Config());
    }

    public Idea35731Service(Idea35731Config config) {
        this.config = config != null ? config : new Idea35731Config();
