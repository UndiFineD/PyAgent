...
@Data
public class Idea35710Config {
    private String name = "idea_035710";
 ...
 */
@Slf4j
public class Idea35710Service {
    private static final int IDEA_ID = 35710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35710Service() {
        this(new Idea35710Config());
    }

    public Idea35710Service(Idea35710Config config) {
        this.config = config != null ? config : new Idea35710Config();
