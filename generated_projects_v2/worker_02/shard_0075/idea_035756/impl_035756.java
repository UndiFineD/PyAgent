...
@Data
public class Idea35756Config {
    private String name = "idea_035756";
 ...
 */
@Slf4j
public class Idea35756Service {
    private static final int IDEA_ID = 35756;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35756Service() {
        this(new Idea35756Config());
    }

    public Idea35756Service(Idea35756Config config) {
        this.config = config != null ? config : new Idea35756Config();
