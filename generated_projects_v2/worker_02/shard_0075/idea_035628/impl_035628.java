...
@Data
public class Idea35628Config {
    private String name = "idea_035628";
 ...
 */
@Slf4j
public class Idea35628Service {
    private static final int IDEA_ID = 35628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35628Service() {
        this(new Idea35628Config());
    }

    public Idea35628Service(Idea35628Config config) {
        this.config = config != null ? config : new Idea35628Config();
