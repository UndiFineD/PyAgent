...
@Data
public class Idea35880Config {
    private String name = "idea_035880";
 ...
 */
@Slf4j
public class Idea35880Service {
    private static final int IDEA_ID = 35880;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35880Service() {
        this(new Idea35880Config());
    }

    public Idea35880Service(Idea35880Config config) {
        this.config = config != null ? config : new Idea35880Config();
