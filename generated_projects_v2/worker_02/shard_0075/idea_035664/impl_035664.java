...
@Data
public class Idea35664Config {
    private String name = "idea_035664";
 ...
 */
@Slf4j
public class Idea35664Service {
    private static final int IDEA_ID = 35664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35664Service() {
        this(new Idea35664Config());
    }

    public Idea35664Service(Idea35664Config config) {
        this.config = config != null ? config : new Idea35664Config();
