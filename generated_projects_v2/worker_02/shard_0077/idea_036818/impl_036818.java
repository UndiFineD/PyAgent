...
@Data
public class Idea36818Config {
    private String name = "idea_036818";
 ...
 */
@Slf4j
public class Idea36818Service {
    private static final int IDEA_ID = 36818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36818Service() {
        this(new Idea36818Config());
    }

    public Idea36818Service(Idea36818Config config) {
        this.config = config != null ? config : new Idea36818Config();
