...
@Data
public class Idea36683Config {
    private String name = "idea_036683";
 ...
 */
@Slf4j
public class Idea36683Service {
    private static final int IDEA_ID = 36683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36683Service() {
        this(new Idea36683Config());
    }

    public Idea36683Service(Idea36683Config config) {
        this.config = config != null ? config : new Idea36683Config();
