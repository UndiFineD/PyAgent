...
@Data
public class Idea37017Config {
    private String name = "idea_037017";
 ...
 */
@Slf4j
public class Idea37017Service {
    private static final int IDEA_ID = 37017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37017Service() {
        this(new Idea37017Config());
    }

    public Idea37017Service(Idea37017Config config) {
        this.config = config != null ? config : new Idea37017Config();
