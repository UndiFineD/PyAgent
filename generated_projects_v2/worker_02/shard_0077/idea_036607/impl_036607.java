...
@Data
public class Idea36607Config {
    private String name = "idea_036607";
 ...
 */
@Slf4j
public class Idea36607Service {
    private static final int IDEA_ID = 36607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36607Service() {
        this(new Idea36607Config());
    }

    public Idea36607Service(Idea36607Config config) {
        this.config = config != null ? config : new Idea36607Config();
