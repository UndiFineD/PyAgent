...
@Data
public class Idea36605Config {
    private String name = "idea_036605";
 ...
 */
@Slf4j
public class Idea36605Service {
    private static final int IDEA_ID = 36605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36605Service() {
        this(new Idea36605Config());
    }

    public Idea36605Service(Idea36605Config config) {
        this.config = config != null ? config : new Idea36605Config();
