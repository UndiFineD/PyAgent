...
@Data
public class Idea36917Config {
    private String name = "idea_036917";
 ...
 */
@Slf4j
public class Idea36917Service {
    private static final int IDEA_ID = 36917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36917Service() {
        this(new Idea36917Config());
    }

    public Idea36917Service(Idea36917Config config) {
        this.config = config != null ? config : new Idea36917Config();
