...
@Data
public class Idea36862Config {
    private String name = "idea_036862";
 ...
 */
@Slf4j
public class Idea36862Service {
    private static final int IDEA_ID = 36862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36862Service() {
        this(new Idea36862Config());
    }

    public Idea36862Service(Idea36862Config config) {
        this.config = config != null ? config : new Idea36862Config();
