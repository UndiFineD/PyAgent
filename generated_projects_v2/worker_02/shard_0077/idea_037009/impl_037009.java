...
@Data
public class Idea37009Config {
    private String name = "idea_037009";
 ...
 */
@Slf4j
public class Idea37009Service {
    private static final int IDEA_ID = 37009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37009Service() {
        this(new Idea37009Config());
    }

    public Idea37009Service(Idea37009Config config) {
        this.config = config != null ? config : new Idea37009Config();
