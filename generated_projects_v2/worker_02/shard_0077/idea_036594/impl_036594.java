...
@Data
public class Idea36594Config {
    private String name = "idea_036594";
 ...
 */
@Slf4j
public class Idea36594Service {
    private static final int IDEA_ID = 36594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36594Service() {
        this(new Idea36594Config());
    }

    public Idea36594Service(Idea36594Config config) {
        this.config = config != null ? config : new Idea36594Config();
