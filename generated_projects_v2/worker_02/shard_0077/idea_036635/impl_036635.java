...
@Data
public class Idea36635Config {
    private String name = "idea_036635";
 ...
 */
@Slf4j
public class Idea36635Service {
    private static final int IDEA_ID = 36635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36635Service() {
        this(new Idea36635Config());
    }

    public Idea36635Service(Idea36635Config config) {
        this.config = config != null ? config : new Idea36635Config();
