...
@Data
public class Idea36716Config {
    private String name = "idea_036716";
 ...
 */
@Slf4j
public class Idea36716Service {
    private static final int IDEA_ID = 36716;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36716Service() {
        this(new Idea36716Config());
    }

    public Idea36716Service(Idea36716Config config) {
        this.config = config != null ? config : new Idea36716Config();
