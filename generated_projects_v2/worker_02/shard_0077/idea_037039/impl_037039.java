...
@Data
public class Idea37039Config {
    private String name = "idea_037039";
 ...
 */
@Slf4j
public class Idea37039Service {
    private static final int IDEA_ID = 37039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37039Service() {
        this(new Idea37039Config());
    }

    public Idea37039Service(Idea37039Config config) {
        this.config = config != null ? config : new Idea37039Config();
