...
@Data
public class Idea36991Config {
    private String name = "idea_036991";
 ...
 */
@Slf4j
public class Idea36991Service {
    private static final int IDEA_ID = 36991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36991Service() {
        this(new Idea36991Config());
    }

    public Idea36991Service(Idea36991Config config) {
        this.config = config != null ? config : new Idea36991Config();
