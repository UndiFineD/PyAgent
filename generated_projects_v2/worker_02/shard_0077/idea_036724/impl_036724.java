...
@Data
public class Idea36724Config {
    private String name = "idea_036724";
 ...
 */
@Slf4j
public class Idea36724Service {
    private static final int IDEA_ID = 36724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36724Service() {
        this(new Idea36724Config());
    }

    public Idea36724Service(Idea36724Config config) {
        this.config = config != null ? config : new Idea36724Config();
