...
@Data
public class Idea36808Config {
    private String name = "idea_036808";
 ...
 */
@Slf4j
public class Idea36808Service {
    private static final int IDEA_ID = 36808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36808Service() {
        this(new Idea36808Config());
    }

    public Idea36808Service(Idea36808Config config) {
        this.config = config != null ? config : new Idea36808Config();
