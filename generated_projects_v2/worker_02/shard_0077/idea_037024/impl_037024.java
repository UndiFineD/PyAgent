...
@Data
public class Idea37024Config {
    private String name = "idea_037024";
 ...
 */
@Slf4j
public class Idea37024Service {
    private static final int IDEA_ID = 37024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37024Service() {
        this(new Idea37024Config());
    }

    public Idea37024Service(Idea37024Config config) {
        this.config = config != null ? config : new Idea37024Config();
