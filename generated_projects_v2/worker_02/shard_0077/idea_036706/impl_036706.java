...
@Data
public class Idea36706Config {
    private String name = "idea_036706";
 ...
 */
@Slf4j
public class Idea36706Service {
    private static final int IDEA_ID = 36706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36706Service() {
        this(new Idea36706Config());
    }

    public Idea36706Service(Idea36706Config config) {
        this.config = config != null ? config : new Idea36706Config();
