...
@Data
public class Idea37049Config {
    private String name = "idea_037049";
 ...
 */
@Slf4j
public class Idea37049Service {
    private static final int IDEA_ID = 37049;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37049Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37049Service() {
        this(new Idea37049Config());
    }

    public Idea37049Service(Idea37049Config config) {
        this.config = config != null ? config : new Idea37049Config();
