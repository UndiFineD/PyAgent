...
@Data
public class Idea36983Config {
    private String name = "idea_036983";
 ...
 */
@Slf4j
public class Idea36983Service {
    private static final int IDEA_ID = 36983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36983Service() {
        this(new Idea36983Config());
    }

    public Idea36983Service(Idea36983Config config) {
        this.config = config != null ? config : new Idea36983Config();
