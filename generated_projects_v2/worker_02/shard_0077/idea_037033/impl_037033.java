...
@Data
public class Idea37033Config {
    private String name = "idea_037033";
 ...
 */
@Slf4j
public class Idea37033Service {
    private static final int IDEA_ID = 37033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37033Service() {
        this(new Idea37033Config());
    }

    public Idea37033Service(Idea37033Config config) {
        this.config = config != null ? config : new Idea37033Config();
