...
@Data
public class Idea36894Config {
    private String name = "idea_036894";
 ...
 */
@Slf4j
public class Idea36894Service {
    private static final int IDEA_ID = 36894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36894Service() {
        this(new Idea36894Config());
    }

    public Idea36894Service(Idea36894Config config) {
        this.config = config != null ? config : new Idea36894Config();
