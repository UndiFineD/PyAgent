...
@Data
public class Idea36837Config {
    private String name = "idea_036837";
 ...
 */
@Slf4j
public class Idea36837Service {
    private static final int IDEA_ID = 36837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36837Service() {
        this(new Idea36837Config());
    }

    public Idea36837Service(Idea36837Config config) {
        this.config = config != null ? config : new Idea36837Config();
