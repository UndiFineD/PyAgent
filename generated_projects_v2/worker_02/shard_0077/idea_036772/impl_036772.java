...
@Data
public class Idea36772Config {
    private String name = "idea_036772";
 ...
 */
@Slf4j
public class Idea36772Service {
    private static final int IDEA_ID = 36772;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36772Service() {
        this(new Idea36772Config());
    }

    public Idea36772Service(Idea36772Config config) {
        this.config = config != null ? config : new Idea36772Config();
