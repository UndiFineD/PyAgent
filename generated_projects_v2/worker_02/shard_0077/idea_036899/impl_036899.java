...
@Data
public class Idea36899Config {
    private String name = "idea_036899";
 ...
 */
@Slf4j
public class Idea36899Service {
    private static final int IDEA_ID = 36899;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36899Service() {
        this(new Idea36899Config());
    }

    public Idea36899Service(Idea36899Config config) {
        this.config = config != null ? config : new Idea36899Config();
