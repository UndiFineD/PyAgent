...
@Data
public class Idea37002Config {
    private String name = "idea_037002";
 ...
 */
@Slf4j
public class Idea37002Service {
    private static final int IDEA_ID = 37002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37002Service() {
        this(new Idea37002Config());
    }

    public Idea37002Service(Idea37002Config config) {
        this.config = config != null ? config : new Idea37002Config();
