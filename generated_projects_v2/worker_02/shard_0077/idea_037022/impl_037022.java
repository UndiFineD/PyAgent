...
@Data
public class Idea37022Config {
    private String name = "idea_037022";
 ...
 */
@Slf4j
public class Idea37022Service {
    private static final int IDEA_ID = 37022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37022Service() {
        this(new Idea37022Config());
    }

    public Idea37022Service(Idea37022Config config) {
        this.config = config != null ? config : new Idea37022Config();
