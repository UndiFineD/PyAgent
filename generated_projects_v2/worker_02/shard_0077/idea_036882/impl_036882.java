...
@Data
public class Idea36882Config {
    private String name = "idea_036882";
 ...
 */
@Slf4j
public class Idea36882Service {
    private static final int IDEA_ID = 36882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36882Service() {
        this(new Idea36882Config());
    }

    public Idea36882Service(Idea36882Config config) {
        this.config = config != null ? config : new Idea36882Config();
