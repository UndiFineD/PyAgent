...
@Data
public class Idea36855Config {
    private String name = "idea_036855";
 ...
 */
@Slf4j
public class Idea36855Service {
    private static final int IDEA_ID = 36855;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36855Service() {
        this(new Idea36855Config());
    }

    public Idea36855Service(Idea36855Config config) {
        this.config = config != null ? config : new Idea36855Config();
