...
@Data
public class Idea36977Config {
    private String name = "idea_036977";
 ...
 */
@Slf4j
public class Idea36977Service {
    private static final int IDEA_ID = 36977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36977Service() {
        this(new Idea36977Config());
    }

    public Idea36977Service(Idea36977Config config) {
        this.config = config != null ? config : new Idea36977Config();
