...
@Data
public class Idea37025Config {
    private String name = "idea_037025";
 ...
 */
@Slf4j
public class Idea37025Service {
    private static final int IDEA_ID = 37025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37025Service() {
        this(new Idea37025Config());
    }

    public Idea37025Service(Idea37025Config config) {
        this.config = config != null ? config : new Idea37025Config();
