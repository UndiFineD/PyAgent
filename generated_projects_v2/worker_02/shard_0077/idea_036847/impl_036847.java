...
@Data
public class Idea36847Config {
    private String name = "idea_036847";
 ...
 */
@Slf4j
public class Idea36847Service {
    private static final int IDEA_ID = 36847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36847Service() {
        this(new Idea36847Config());
    }

    public Idea36847Service(Idea36847Config config) {
        this.config = config != null ? config : new Idea36847Config();
