...
@Data
public class Idea36852Config {
    private String name = "idea_036852";
 ...
 */
@Slf4j
public class Idea36852Service {
    private static final int IDEA_ID = 36852;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36852Service() {
        this(new Idea36852Config());
    }

    public Idea36852Service(Idea36852Config config) {
        this.config = config != null ? config : new Idea36852Config();
