...
@Data
public class Idea36603Config {
    private String name = "idea_036603";
 ...
 */
@Slf4j
public class Idea36603Service {
    private static final int IDEA_ID = 36603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36603Service() {
        this(new Idea36603Config());
    }

    public Idea36603Service(Idea36603Config config) {
        this.config = config != null ? config : new Idea36603Config();
