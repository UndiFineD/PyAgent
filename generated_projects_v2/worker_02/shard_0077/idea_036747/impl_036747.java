...
@Data
public class Idea36747Config {
    private String name = "idea_036747";
 ...
 */
@Slf4j
public class Idea36747Service {
    private static final int IDEA_ID = 36747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36747Service() {
        this(new Idea36747Config());
    }

    public Idea36747Service(Idea36747Config config) {
        this.config = config != null ? config : new Idea36747Config();
