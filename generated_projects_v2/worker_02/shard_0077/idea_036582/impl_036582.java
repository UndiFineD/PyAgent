...
@Data
public class Idea36582Config {
    private String name = "idea_036582";
 ...
 */
@Slf4j
public class Idea36582Service {
    private static final int IDEA_ID = 36582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36582Service() {
        this(new Idea36582Config());
    }

    public Idea36582Service(Idea36582Config config) {
        this.config = config != null ? config : new Idea36582Config();
