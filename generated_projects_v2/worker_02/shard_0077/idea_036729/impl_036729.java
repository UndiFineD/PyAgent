...
@Data
public class Idea36729Config {
    private String name = "idea_036729";
 ...
 */
@Slf4j
public class Idea36729Service {
    private static final int IDEA_ID = 36729;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36729Service() {
        this(new Idea36729Config());
    }

    public Idea36729Service(Idea36729Config config) {
        this.config = config != null ? config : new Idea36729Config();
