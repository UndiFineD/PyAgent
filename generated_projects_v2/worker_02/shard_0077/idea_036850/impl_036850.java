...
@Data
public class Idea36850Config {
    private String name = "idea_036850";
 ...
 */
@Slf4j
public class Idea36850Service {
    private static final int IDEA_ID = 36850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36850Service() {
        this(new Idea36850Config());
    }

    public Idea36850Service(Idea36850Config config) {
        this.config = config != null ? config : new Idea36850Config();
