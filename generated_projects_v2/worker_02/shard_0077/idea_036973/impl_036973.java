...
@Data
public class Idea36973Config {
    private String name = "idea_036973";
 ...
 */
@Slf4j
public class Idea36973Service {
    private static final int IDEA_ID = 36973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36973Service() {
        this(new Idea36973Config());
    }

    public Idea36973Service(Idea36973Config config) {
        this.config = config != null ? config : new Idea36973Config();
