...
@Data
public class Idea36897Config {
    private String name = "idea_036897";
 ...
 */
@Slf4j
public class Idea36897Service {
    private static final int IDEA_ID = 36897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36897Service() {
        this(new Idea36897Config());
    }

    public Idea36897Service(Idea36897Config config) {
        this.config = config != null ? config : new Idea36897Config();
