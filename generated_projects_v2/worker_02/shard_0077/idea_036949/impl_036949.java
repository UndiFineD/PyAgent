...
@Data
public class Idea36949Config {
    private String name = "idea_036949";
 ...
 */
@Slf4j
public class Idea36949Service {
    private static final int IDEA_ID = 36949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36949Service() {
        this(new Idea36949Config());
    }

    public Idea36949Service(Idea36949Config config) {
        this.config = config != null ? config : new Idea36949Config();
