...
@Data
public class Idea36642Config {
    private String name = "idea_036642";
 ...
 */
@Slf4j
public class Idea36642Service {
    private static final int IDEA_ID = 36642;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36642Service() {
        this(new Idea36642Config());
    }

    public Idea36642Service(Idea36642Config config) {
        this.config = config != null ? config : new Idea36642Config();
