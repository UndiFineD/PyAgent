...
@Data
public class Idea36981Config {
    private String name = "idea_036981";
 ...
 */
@Slf4j
public class Idea36981Service {
    private static final int IDEA_ID = 36981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36981Service() {
        this(new Idea36981Config());
    }

    public Idea36981Service(Idea36981Config config) {
        this.config = config != null ? config : new Idea36981Config();
