...
@Data
public class Idea36575Config {
    private String name = "idea_036575";
 ...
 */
@Slf4j
public class Idea36575Service {
    private static final int IDEA_ID = 36575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36575Service() {
        this(new Idea36575Config());
    }

    public Idea36575Service(Idea36575Config config) {
        this.config = config != null ? config : new Idea36575Config();
