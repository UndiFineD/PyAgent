...
@Data
public class Idea36984Config {
    private String name = "idea_036984";
 ...
 */
@Slf4j
public class Idea36984Service {
    private static final int IDEA_ID = 36984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36984Service() {
        this(new Idea36984Config());
    }

    public Idea36984Service(Idea36984Config config) {
        this.config = config != null ? config : new Idea36984Config();
