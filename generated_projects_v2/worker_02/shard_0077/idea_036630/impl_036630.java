...
@Data
public class Idea36630Config {
    private String name = "idea_036630";
 ...
 */
@Slf4j
public class Idea36630Service {
    private static final int IDEA_ID = 36630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36630Service() {
        this(new Idea36630Config());
    }

    public Idea36630Service(Idea36630Config config) {
        this.config = config != null ? config : new Idea36630Config();
