...
@Data
public class Idea37045Config {
    private String name = "idea_037045";
 ...
 */
@Slf4j
public class Idea37045Service {
    private static final int IDEA_ID = 37045;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37045Service() {
        this(new Idea37045Config());
    }

    public Idea37045Service(Idea37045Config config) {
        this.config = config != null ? config : new Idea37045Config();
