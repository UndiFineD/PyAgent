...
@Data
public class Idea36925Config {
    private String name = "idea_036925";
 ...
 */
@Slf4j
public class Idea36925Service {
    private static final int IDEA_ID = 36925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36925Service() {
        this(new Idea36925Config());
    }

    public Idea36925Service(Idea36925Config config) {
        this.config = config != null ? config : new Idea36925Config();
