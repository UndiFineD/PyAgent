...
@Data
public class Idea36784Config {
    private String name = "idea_036784";
 ...
 */
@Slf4j
public class Idea36784Service {
    private static final int IDEA_ID = 36784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36784Service() {
        this(new Idea36784Config());
    }

    public Idea36784Service(Idea36784Config config) {
        this.config = config != null ? config : new Idea36784Config();
