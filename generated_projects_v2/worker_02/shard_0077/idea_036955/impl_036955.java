...
@Data
public class Idea36955Config {
    private String name = "idea_036955";
 ...
 */
@Slf4j
public class Idea36955Service {
    private static final int IDEA_ID = 36955;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36955Service() {
        this(new Idea36955Config());
    }

    public Idea36955Service(Idea36955Config config) {
        this.config = config != null ? config : new Idea36955Config();
