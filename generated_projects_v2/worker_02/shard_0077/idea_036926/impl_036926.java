...
@Data
public class Idea36926Config {
    private String name = "idea_036926";
 ...
 */
@Slf4j
public class Idea36926Service {
    private static final int IDEA_ID = 36926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36926Service() {
        this(new Idea36926Config());
    }

    public Idea36926Service(Idea36926Config config) {
        this.config = config != null ? config : new Idea36926Config();
