...
@Data
public class Idea36811Config {
    private String name = "idea_036811";
 ...
 */
@Slf4j
public class Idea36811Service {
    private static final int IDEA_ID = 36811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36811Service() {
        this(new Idea36811Config());
    }

    public Idea36811Service(Idea36811Config config) {
        this.config = config != null ? config : new Idea36811Config();
