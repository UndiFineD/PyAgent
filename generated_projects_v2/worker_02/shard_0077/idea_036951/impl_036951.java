...
@Data
public class Idea36951Config {
    private String name = "idea_036951";
 ...
 */
@Slf4j
public class Idea36951Service {
    private static final int IDEA_ID = 36951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36951Service() {
        this(new Idea36951Config());
    }

    public Idea36951Service(Idea36951Config config) {
        this.config = config != null ? config : new Idea36951Config();
