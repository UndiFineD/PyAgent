...
@Data
public class Idea36886Config {
    private String name = "idea_036886";
 ...
 */
@Slf4j
public class Idea36886Service {
    private static final int IDEA_ID = 36886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36886Service() {
        this(new Idea36886Config());
    }

    public Idea36886Service(Idea36886Config config) {
        this.config = config != null ? config : new Idea36886Config();
