...
@Data
public class Idea36643Config {
    private String name = "idea_036643";
 ...
 */
@Slf4j
public class Idea36643Service {
    private static final int IDEA_ID = 36643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36643Service() {
        this(new Idea36643Config());
    }

    public Idea36643Service(Idea36643Config config) {
        this.config = config != null ? config : new Idea36643Config();
