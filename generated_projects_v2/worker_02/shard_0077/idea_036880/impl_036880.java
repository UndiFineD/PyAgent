...
@Data
public class Idea36880Config {
    private String name = "idea_036880";
 ...
 */
@Slf4j
public class Idea36880Service {
    private static final int IDEA_ID = 36880;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36880Service() {
        this(new Idea36880Config());
    }

    public Idea36880Service(Idea36880Config config) {
        this.config = config != null ? config : new Idea36880Config();
