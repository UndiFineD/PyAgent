...
@Data
public class Idea36701Config {
    private String name = "idea_036701";
 ...
 */
@Slf4j
public class Idea36701Service {
    private static final int IDEA_ID = 36701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36701Service() {
        this(new Idea36701Config());
    }

    public Idea36701Service(Idea36701Config config) {
        this.config = config != null ? config : new Idea36701Config();
