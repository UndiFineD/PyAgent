...
@Data
public class Idea36959Config {
    private String name = "idea_036959";
 ...
 */
@Slf4j
public class Idea36959Service {
    private static final int IDEA_ID = 36959;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36959Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36959Service() {
        this(new Idea36959Config());
    }

    public Idea36959Service(Idea36959Config config) {
        this.config = config != null ? config : new Idea36959Config();
