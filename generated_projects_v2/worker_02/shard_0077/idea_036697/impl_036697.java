...
@Data
public class Idea36697Config {
    private String name = "idea_036697";
 ...
 */
@Slf4j
public class Idea36697Service {
    private static final int IDEA_ID = 36697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36697Service() {
        this(new Idea36697Config());
    }

    public Idea36697Service(Idea36697Config config) {
        this.config = config != null ? config : new Idea36697Config();
