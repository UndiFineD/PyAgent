...
@Data
public class Idea36944Config {
    private String name = "idea_036944";
 ...
 */
@Slf4j
public class Idea36944Service {
    private static final int IDEA_ID = 36944;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36944Service() {
        this(new Idea36944Config());
    }

    public Idea36944Service(Idea36944Config config) {
        this.config = config != null ? config : new Idea36944Config();
