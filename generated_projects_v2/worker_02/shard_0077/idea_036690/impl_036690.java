...
@Data
public class Idea36690Config {
    private String name = "idea_036690";
 ...
 */
@Slf4j
public class Idea36690Service {
    private static final int IDEA_ID = 36690;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36690Service() {
        this(new Idea36690Config());
    }

    public Idea36690Service(Idea36690Config config) {
        this.config = config != null ? config : new Idea36690Config();
