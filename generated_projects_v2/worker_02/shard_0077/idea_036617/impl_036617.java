...
@Data
public class Idea36617Config {
    private String name = "idea_036617";
 ...
 */
@Slf4j
public class Idea36617Service {
    private static final int IDEA_ID = 36617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36617Service() {
        this(new Idea36617Config());
    }

    public Idea36617Service(Idea36617Config config) {
        this.config = config != null ? config : new Idea36617Config();
