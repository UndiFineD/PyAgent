...
@Data
public class Idea36982Config {
    private String name = "idea_036982";
 ...
 */
@Slf4j
public class Idea36982Service {
    private static final int IDEA_ID = 36982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36982Service() {
        this(new Idea36982Config());
    }

    public Idea36982Service(Idea36982Config config) {
        this.config = config != null ? config : new Idea36982Config();
