...
@Data
public class Idea36861Config {
    private String name = "idea_036861";
 ...
 */
@Slf4j
public class Idea36861Service {
    private static final int IDEA_ID = 36861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36861Service() {
        this(new Idea36861Config());
    }

    public Idea36861Service(Idea36861Config config) {
        this.config = config != null ? config : new Idea36861Config();
