...
@Data
public class Idea36798Config {
    private String name = "idea_036798";
 ...
 */
@Slf4j
public class Idea36798Service {
    private static final int IDEA_ID = 36798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36798Service() {
        this(new Idea36798Config());
    }

    public Idea36798Service(Idea36798Config config) {
        this.config = config != null ? config : new Idea36798Config();
