...
@Data
public class Idea37021Config {
    private String name = "idea_037021";
 ...
 */
@Slf4j
public class Idea37021Service {
    private static final int IDEA_ID = 37021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37021Service() {
        this(new Idea37021Config());
    }

    public Idea37021Service(Idea37021Config config) {
        this.config = config != null ? config : new Idea37021Config();
