...
@Data
public class Idea36995Config {
    private String name = "idea_036995";
 ...
 */
@Slf4j
public class Idea36995Service {
    private static final int IDEA_ID = 36995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36995Service() {
        this(new Idea36995Config());
    }

    public Idea36995Service(Idea36995Config config) {
        this.config = config != null ? config : new Idea36995Config();
