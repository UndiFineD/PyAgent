...
@Data
public class Idea36774Config {
    private String name = "idea_036774";
 ...
 */
@Slf4j
public class Idea36774Service {
    private static final int IDEA_ID = 36774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36774Service() {
        this(new Idea36774Config());
    }

    public Idea36774Service(Idea36774Config config) {
        this.config = config != null ? config : new Idea36774Config();
