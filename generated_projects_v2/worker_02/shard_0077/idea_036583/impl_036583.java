...
@Data
public class Idea36583Config {
    private String name = "idea_036583";
 ...
 */
@Slf4j
public class Idea36583Service {
    private static final int IDEA_ID = 36583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36583Service() {
        this(new Idea36583Config());
    }

    public Idea36583Service(Idea36583Config config) {
        this.config = config != null ? config : new Idea36583Config();
