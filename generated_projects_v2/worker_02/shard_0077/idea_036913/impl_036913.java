...
@Data
public class Idea36913Config {
    private String name = "idea_036913";
 ...
 */
@Slf4j
public class Idea36913Service {
    private static final int IDEA_ID = 36913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36913Service() {
        this(new Idea36913Config());
    }

    public Idea36913Service(Idea36913Config config) {
        this.config = config != null ? config : new Idea36913Config();
