...
@Data
public class Idea36908Config {
    private String name = "idea_036908";
 ...
 */
@Slf4j
public class Idea36908Service {
    private static final int IDEA_ID = 36908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36908Service() {
        this(new Idea36908Config());
    }

    public Idea36908Service(Idea36908Config config) {
        this.config = config != null ? config : new Idea36908Config();
