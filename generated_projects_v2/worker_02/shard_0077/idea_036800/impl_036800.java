...
@Data
public class Idea36800Config {
    private String name = "idea_036800";
 ...
 */
@Slf4j
public class Idea36800Service {
    private static final int IDEA_ID = 36800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36800Service() {
        this(new Idea36800Config());
    }

    public Idea36800Service(Idea36800Config config) {
        this.config = config != null ? config : new Idea36800Config();
