...
@Data
public class Idea37001Config {
    private String name = "idea_037001";
 ...
 */
@Slf4j
public class Idea37001Service {
    private static final int IDEA_ID = 37001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37001Service() {
        this(new Idea37001Config());
    }

    public Idea37001Service(Idea37001Config config) {
        this.config = config != null ? config : new Idea37001Config();
