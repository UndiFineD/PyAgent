...
@Data
public class Idea36970Config {
    private String name = "idea_036970";
 ...
 */
@Slf4j
public class Idea36970Service {
    private static final int IDEA_ID = 36970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36970Service() {
        this(new Idea36970Config());
    }

    public Idea36970Service(Idea36970Config config) {
        this.config = config != null ? config : new Idea36970Config();
