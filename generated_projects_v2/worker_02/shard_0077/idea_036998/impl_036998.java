...
@Data
public class Idea36998Config {
    private String name = "idea_036998";
 ...
 */
@Slf4j
public class Idea36998Service {
    private static final int IDEA_ID = 36998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36998Service() {
        this(new Idea36998Config());
    }

    public Idea36998Service(Idea36998Config config) {
        this.config = config != null ? config : new Idea36998Config();
