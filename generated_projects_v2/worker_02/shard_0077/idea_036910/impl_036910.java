...
@Data
public class Idea36910Config {
    private String name = "idea_036910";
 ...
 */
@Slf4j
public class Idea36910Service {
    private static final int IDEA_ID = 36910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36910Service() {
        this(new Idea36910Config());
    }

    public Idea36910Service(Idea36910Config config) {
        this.config = config != null ? config : new Idea36910Config();
