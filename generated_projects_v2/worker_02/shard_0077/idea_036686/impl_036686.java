...
@Data
public class Idea36686Config {
    private String name = "idea_036686";
 ...
 */
@Slf4j
public class Idea36686Service {
    private static final int IDEA_ID = 36686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36686Service() {
        this(new Idea36686Config());
    }

    public Idea36686Service(Idea36686Config config) {
        this.config = config != null ? config : new Idea36686Config();
