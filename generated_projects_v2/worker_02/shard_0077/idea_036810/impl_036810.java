...
@Data
public class Idea36810Config {
    private String name = "idea_036810";
 ...
 */
@Slf4j
public class Idea36810Service {
    private static final int IDEA_ID = 36810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36810Service() {
        this(new Idea36810Config());
    }

    public Idea36810Service(Idea36810Config config) {
        this.config = config != null ? config : new Idea36810Config();
