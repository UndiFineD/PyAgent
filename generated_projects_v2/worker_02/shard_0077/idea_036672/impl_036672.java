...
@Data
public class Idea36672Config {
    private String name = "idea_036672";
 ...
 */
@Slf4j
public class Idea36672Service {
    private static final int IDEA_ID = 36672;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36672Service() {
        this(new Idea36672Config());
    }

    public Idea36672Service(Idea36672Config config) {
        this.config = config != null ? config : new Idea36672Config();
