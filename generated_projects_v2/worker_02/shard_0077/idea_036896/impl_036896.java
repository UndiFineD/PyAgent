...
@Data
public class Idea36896Config {
    private String name = "idea_036896";
 ...
 */
@Slf4j
public class Idea36896Service {
    private static final int IDEA_ID = 36896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36896Service() {
        this(new Idea36896Config());
    }

    public Idea36896Service(Idea36896Config config) {
        this.config = config != null ? config : new Idea36896Config();
