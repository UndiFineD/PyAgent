...
@Data
public class Idea36826Config {
    private String name = "idea_036826";
 ...
 */
@Slf4j
public class Idea36826Service {
    private static final int IDEA_ID = 36826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36826Service() {
        this(new Idea36826Config());
    }

    public Idea36826Service(Idea36826Config config) {
        this.config = config != null ? config : new Idea36826Config();
