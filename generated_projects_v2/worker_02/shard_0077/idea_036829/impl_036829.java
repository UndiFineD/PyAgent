...
@Data
public class Idea36829Config {
    private String name = "idea_036829";
 ...
 */
@Slf4j
public class Idea36829Service {
    private static final int IDEA_ID = 36829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36829Service() {
        this(new Idea36829Config());
    }

    public Idea36829Service(Idea36829Config config) {
        this.config = config != null ? config : new Idea36829Config();
