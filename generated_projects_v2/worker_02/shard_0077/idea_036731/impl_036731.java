...
@Data
public class Idea36731Config {
    private String name = "idea_036731";
 ...
 */
@Slf4j
public class Idea36731Service {
    private static final int IDEA_ID = 36731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36731Service() {
        this(new Idea36731Config());
    }

    public Idea36731Service(Idea36731Config config) {
        this.config = config != null ? config : new Idea36731Config();
