...
@Data
public class Idea36873Config {
    private String name = "idea_036873";
 ...
 */
@Slf4j
public class Idea36873Service {
    private static final int IDEA_ID = 36873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36873Service() {
        this(new Idea36873Config());
    }

    public Idea36873Service(Idea36873Config config) {
        this.config = config != null ? config : new Idea36873Config();
