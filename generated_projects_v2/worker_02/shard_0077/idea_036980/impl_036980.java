...
@Data
public class Idea36980Config {
    private String name = "idea_036980";
 ...
 */
@Slf4j
public class Idea36980Service {
    private static final int IDEA_ID = 36980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36980Service() {
        this(new Idea36980Config());
    }

    public Idea36980Service(Idea36980Config config) {
        this.config = config != null ? config : new Idea36980Config();
