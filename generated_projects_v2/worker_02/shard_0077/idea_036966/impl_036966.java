...
@Data
public class Idea36966Config {
    private String name = "idea_036966";
 ...
 */
@Slf4j
public class Idea36966Service {
    private static final int IDEA_ID = 36966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36966Service() {
        this(new Idea36966Config());
    }

    public Idea36966Service(Idea36966Config config) {
        this.config = config != null ? config : new Idea36966Config();
