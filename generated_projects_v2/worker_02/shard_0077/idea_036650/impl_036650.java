...
@Data
public class Idea36650Config {
    private String name = "idea_036650";
 ...
 */
@Slf4j
public class Idea36650Service {
    private static final int IDEA_ID = 36650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36650Service() {
        this(new Idea36650Config());
    }

    public Idea36650Service(Idea36650Config config) {
        this.config = config != null ? config : new Idea36650Config();
