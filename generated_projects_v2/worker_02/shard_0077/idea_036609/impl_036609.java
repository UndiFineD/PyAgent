...
@Data
public class Idea36609Config {
    private String name = "idea_036609";
 ...
 */
@Slf4j
public class Idea36609Service {
    private static final int IDEA_ID = 36609;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36609Service() {
        this(new Idea36609Config());
    }

    public Idea36609Service(Idea36609Config config) {
        this.config = config != null ? config : new Idea36609Config();
