...
@Data
public class Idea36651Config {
    private String name = "idea_036651";
 ...
 */
@Slf4j
public class Idea36651Service {
    private static final int IDEA_ID = 36651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36651Service() {
        this(new Idea36651Config());
    }

    public Idea36651Service(Idea36651Config config) {
        this.config = config != null ? config : new Idea36651Config();
