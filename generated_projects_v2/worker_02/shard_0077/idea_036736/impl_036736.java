...
@Data
public class Idea36736Config {
    private String name = "idea_036736";
 ...
 */
@Slf4j
public class Idea36736Service {
    private static final int IDEA_ID = 36736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36736Service() {
        this(new Idea36736Config());
    }

    public Idea36736Service(Idea36736Config config) {
        this.config = config != null ? config : new Idea36736Config();
