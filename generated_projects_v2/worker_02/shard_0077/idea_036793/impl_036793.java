...
@Data
public class Idea36793Config {
    private String name = "idea_036793";
 ...
 */
@Slf4j
public class Idea36793Service {
    private static final int IDEA_ID = 36793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36793Service() {
        this(new Idea36793Config());
    }

    public Idea36793Service(Idea36793Config config) {
        this.config = config != null ? config : new Idea36793Config();
