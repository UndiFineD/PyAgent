...
@Data
public class Idea36721Config {
    private String name = "idea_036721";
 ...
 */
@Slf4j
public class Idea36721Service {
    private static final int IDEA_ID = 36721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36721Service() {
        this(new Idea36721Config());
    }

    public Idea36721Service(Idea36721Config config) {
        this.config = config != null ? config : new Idea36721Config();
