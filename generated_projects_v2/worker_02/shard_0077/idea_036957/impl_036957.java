...
@Data
public class Idea36957Config {
    private String name = "idea_036957";
 ...
 */
@Slf4j
public class Idea36957Service {
    private static final int IDEA_ID = 36957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36957Service() {
        this(new Idea36957Config());
    }

    public Idea36957Service(Idea36957Config config) {
        this.config = config != null ? config : new Idea36957Config();
