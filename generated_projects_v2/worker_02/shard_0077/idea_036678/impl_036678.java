...
@Data
public class Idea36678Config {
    private String name = "idea_036678";
 ...
 */
@Slf4j
public class Idea36678Service {
    private static final int IDEA_ID = 36678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36678Service() {
        this(new Idea36678Config());
    }

    public Idea36678Service(Idea36678Config config) {
        this.config = config != null ? config : new Idea36678Config();
