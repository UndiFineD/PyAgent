...
@Data
public class Idea36759Config {
    private String name = "idea_036759";
 ...
 */
@Slf4j
public class Idea36759Service {
    private static final int IDEA_ID = 36759;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36759Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36759Service() {
        this(new Idea36759Config());
    }

    public Idea36759Service(Idea36759Config config) {
        this.config = config != null ? config : new Idea36759Config();
