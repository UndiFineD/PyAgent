...
@Data
public class Idea37013Config {
    private String name = "idea_037013";
 ...
 */
@Slf4j
public class Idea37013Service {
    private static final int IDEA_ID = 37013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37013Service() {
        this(new Idea37013Config());
    }

    public Idea37013Service(Idea37013Config config) {
        this.config = config != null ? config : new Idea37013Config();
