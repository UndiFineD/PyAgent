...
@Data
public class Idea36902Config {
    private String name = "idea_036902";
 ...
 */
@Slf4j
public class Idea36902Service {
    private static final int IDEA_ID = 36902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36902Service() {
        this(new Idea36902Config());
    }

    public Idea36902Service(Idea36902Config config) {
        this.config = config != null ? config : new Idea36902Config();
