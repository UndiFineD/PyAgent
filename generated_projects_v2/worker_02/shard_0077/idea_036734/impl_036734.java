...
@Data
public class Idea36734Config {
    private String name = "idea_036734";
 ...
 */
@Slf4j
public class Idea36734Service {
    private static final int IDEA_ID = 36734;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36734Service() {
        this(new Idea36734Config());
    }

    public Idea36734Service(Idea36734Config config) {
        this.config = config != null ? config : new Idea36734Config();
