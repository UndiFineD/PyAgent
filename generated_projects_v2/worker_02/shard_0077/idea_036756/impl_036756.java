...
@Data
public class Idea36756Config {
    private String name = "idea_036756";
 ...
 */
@Slf4j
public class Idea36756Service {
    private static final int IDEA_ID = 36756;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36756Service() {
        this(new Idea36756Config());
    }

    public Idea36756Service(Idea36756Config config) {
        this.config = config != null ? config : new Idea36756Config();
