...
@Data
public class Idea36950Config {
    private String name = "idea_036950";
 ...
 */
@Slf4j
public class Idea36950Service {
    private static final int IDEA_ID = 36950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36950Service() {
        this(new Idea36950Config());
    }

    public Idea36950Service(Idea36950Config config) {
        this.config = config != null ? config : new Idea36950Config();
