...
@Data
public class Idea36889Config {
    private String name = "idea_036889";
 ...
 */
@Slf4j
public class Idea36889Service {
    private static final int IDEA_ID = 36889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36889Service() {
        this(new Idea36889Config());
    }

    public Idea36889Service(Idea36889Config config) {
        this.config = config != null ? config : new Idea36889Config();
