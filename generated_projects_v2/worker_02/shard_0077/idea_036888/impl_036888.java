...
@Data
public class Idea36888Config {
    private String name = "idea_036888";
 ...
 */
@Slf4j
public class Idea36888Service {
    private static final int IDEA_ID = 36888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36888Service() {
        this(new Idea36888Config());
    }

    public Idea36888Service(Idea36888Config config) {
        this.config = config != null ? config : new Idea36888Config();
