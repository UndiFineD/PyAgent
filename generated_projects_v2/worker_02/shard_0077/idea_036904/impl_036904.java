...
@Data
public class Idea36904Config {
    private String name = "idea_036904";
 ...
 */
@Slf4j
public class Idea36904Service {
    private static final int IDEA_ID = 36904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36904Service() {
        this(new Idea36904Config());
    }

    public Idea36904Service(Idea36904Config config) {
        this.config = config != null ? config : new Idea36904Config();
