...
@Data
public class Idea36866Config {
    private String name = "idea_036866";
 ...
 */
@Slf4j
public class Idea36866Service {
    private static final int IDEA_ID = 36866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36866Service() {
        this(new Idea36866Config());
    }

    public Idea36866Service(Idea36866Config config) {
        this.config = config != null ? config : new Idea36866Config();
