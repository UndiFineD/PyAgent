...
@Data
public class Idea36792Config {
    private String name = "idea_036792";
 ...
 */
@Slf4j
public class Idea36792Service {
    private static final int IDEA_ID = 36792;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36792Service() {
        this(new Idea36792Config());
    }

    public Idea36792Service(Idea36792Config config) {
        this.config = config != null ? config : new Idea36792Config();
