...
@Data
public class Idea36620Config {
    private String name = "idea_036620";
 ...
 */
@Slf4j
public class Idea36620Service {
    private static final int IDEA_ID = 36620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36620Service() {
        this(new Idea36620Config());
    }

    public Idea36620Service(Idea36620Config config) {
        this.config = config != null ? config : new Idea36620Config();
