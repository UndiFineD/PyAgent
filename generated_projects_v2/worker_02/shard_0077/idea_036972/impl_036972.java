...
@Data
public class Idea36972Config {
    private String name = "idea_036972";
 ...
 */
@Slf4j
public class Idea36972Service {
    private static final int IDEA_ID = 36972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36972Service() {
        this(new Idea36972Config());
    }

    public Idea36972Service(Idea36972Config config) {
        this.config = config != null ? config : new Idea36972Config();
