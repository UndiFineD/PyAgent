...
@Data
public class Idea36997Config {
    private String name = "idea_036997";
 ...
 */
@Slf4j
public class Idea36997Service {
    private static final int IDEA_ID = 36997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36997Service() {
        this(new Idea36997Config());
    }

    public Idea36997Service(Idea36997Config config) {
        this.config = config != null ? config : new Idea36997Config();
