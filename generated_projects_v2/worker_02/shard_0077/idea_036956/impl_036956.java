...
@Data
public class Idea36956Config {
    private String name = "idea_036956";
 ...
 */
@Slf4j
public class Idea36956Service {
    private static final int IDEA_ID = 36956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36956Service() {
        this(new Idea36956Config());
    }

    public Idea36956Service(Idea36956Config config) {
        this.config = config != null ? config : new Idea36956Config();
