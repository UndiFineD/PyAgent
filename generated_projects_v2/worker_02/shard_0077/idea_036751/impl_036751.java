...
@Data
public class Idea36751Config {
    private String name = "idea_036751";
 ...
 */
@Slf4j
public class Idea36751Service {
    private static final int IDEA_ID = 36751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36751Service() {
        this(new Idea36751Config());
    }

    public Idea36751Service(Idea36751Config config) {
        this.config = config != null ? config : new Idea36751Config();
