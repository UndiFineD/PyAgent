...
@Data
public class Idea36934Config {
    private String name = "idea_036934";
 ...
 */
@Slf4j
public class Idea36934Service {
    private static final int IDEA_ID = 36934;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36934Service() {
        this(new Idea36934Config());
    }

    public Idea36934Service(Idea36934Config config) {
        this.config = config != null ? config : new Idea36934Config();
