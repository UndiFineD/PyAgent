...
@Data
public class Idea36778Config {
    private String name = "idea_036778";
 ...
 */
@Slf4j
public class Idea36778Service {
    private static final int IDEA_ID = 36778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36778Service() {
        this(new Idea36778Config());
    }

    public Idea36778Service(Idea36778Config config) {
        this.config = config != null ? config : new Idea36778Config();
