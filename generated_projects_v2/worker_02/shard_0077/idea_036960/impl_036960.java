...
@Data
public class Idea36960Config {
    private String name = "idea_036960";
 ...
 */
@Slf4j
public class Idea36960Service {
    private static final int IDEA_ID = 36960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36960Service() {
        this(new Idea36960Config());
    }

    public Idea36960Service(Idea36960Config config) {
        this.config = config != null ? config : new Idea36960Config();
