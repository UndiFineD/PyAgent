...
@Data
public class Idea36614Config {
    private String name = "idea_036614";
 ...
 */
@Slf4j
public class Idea36614Service {
    private static final int IDEA_ID = 36614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36614Service() {
        this(new Idea36614Config());
    }

    public Idea36614Service(Idea36614Config config) {
        this.config = config != null ? config : new Idea36614Config();
