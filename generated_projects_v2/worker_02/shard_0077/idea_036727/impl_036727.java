...
@Data
public class Idea36727Config {
    private String name = "idea_036727";
 ...
 */
@Slf4j
public class Idea36727Service {
    private static final int IDEA_ID = 36727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36727Service() {
        this(new Idea36727Config());
    }

    public Idea36727Service(Idea36727Config config) {
        this.config = config != null ? config : new Idea36727Config();
