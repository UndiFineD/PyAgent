...
@Data
public class Idea36586Config {
    private String name = "idea_036586";
 ...
 */
@Slf4j
public class Idea36586Service {
    private static final int IDEA_ID = 36586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36586Service() {
        this(new Idea36586Config());
    }

    public Idea36586Service(Idea36586Config config) {
        this.config = config != null ? config : new Idea36586Config();
