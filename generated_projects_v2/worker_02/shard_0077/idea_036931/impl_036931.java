...
@Data
public class Idea36931Config {
    private String name = "idea_036931";
 ...
 */
@Slf4j
public class Idea36931Service {
    private static final int IDEA_ID = 36931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36931Service() {
        this(new Idea36931Config());
    }

    public Idea36931Service(Idea36931Config config) {
        this.config = config != null ? config : new Idea36931Config();
