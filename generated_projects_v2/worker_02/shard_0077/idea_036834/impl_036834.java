...
@Data
public class Idea36834Config {
    private String name = "idea_036834";
 ...
 */
@Slf4j
public class Idea36834Service {
    private static final int IDEA_ID = 36834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36834Service() {
        this(new Idea36834Config());
    }

    public Idea36834Service(Idea36834Config config) {
        this.config = config != null ? config : new Idea36834Config();
