...
@Data
public class Idea36989Config {
    private String name = "idea_036989";
 ...
 */
@Slf4j
public class Idea36989Service {
    private static final int IDEA_ID = 36989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36989Service() {
        this(new Idea36989Config());
    }

    public Idea36989Service(Idea36989Config config) {
        this.config = config != null ? config : new Idea36989Config();
