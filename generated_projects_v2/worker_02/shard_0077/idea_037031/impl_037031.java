...
@Data
public class Idea37031Config {
    private String name = "idea_037031";
 ...
 */
@Slf4j
public class Idea37031Service {
    private static final int IDEA_ID = 37031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37031Service() {
        this(new Idea37031Config());
    }

    public Idea37031Service(Idea37031Config config) {
        this.config = config != null ? config : new Idea37031Config();
