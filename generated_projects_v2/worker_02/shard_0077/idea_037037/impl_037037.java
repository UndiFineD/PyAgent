...
@Data
public class Idea37037Config {
    private String name = "idea_037037";
 ...
 */
@Slf4j
public class Idea37037Service {
    private static final int IDEA_ID = 37037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37037Service() {
        this(new Idea37037Config());
    }

    public Idea37037Service(Idea37037Config config) {
        this.config = config != null ? config : new Idea37037Config();
