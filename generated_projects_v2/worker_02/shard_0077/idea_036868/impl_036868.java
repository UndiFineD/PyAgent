...
@Data
public class Idea36868Config {
    private String name = "idea_036868";
 ...
 */
@Slf4j
public class Idea36868Service {
    private static final int IDEA_ID = 36868;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36868Service() {
        this(new Idea36868Config());
    }

    public Idea36868Service(Idea36868Config config) {
        this.config = config != null ? config : new Idea36868Config();
