...
@Data
public class Idea36649Config {
    private String name = "idea_036649";
 ...
 */
@Slf4j
public class Idea36649Service {
    private static final int IDEA_ID = 36649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36649Service() {
        this(new Idea36649Config());
    }

    public Idea36649Service(Idea36649Config config) {
        this.config = config != null ? config : new Idea36649Config();
