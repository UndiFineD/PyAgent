...
@Data
public class Idea37044Config {
    private String name = "idea_037044";
 ...
 */
@Slf4j
public class Idea37044Service {
    private static final int IDEA_ID = 37044;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37044Service() {
        this(new Idea37044Config());
    }

    public Idea37044Service(Idea37044Config config) {
        this.config = config != null ? config : new Idea37044Config();
