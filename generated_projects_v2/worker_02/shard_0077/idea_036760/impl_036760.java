...
@Data
public class Idea36760Config {
    private String name = "idea_036760";
 ...
 */
@Slf4j
public class Idea36760Service {
    private static final int IDEA_ID = 36760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36760Service() {
        this(new Idea36760Config());
    }

    public Idea36760Service(Idea36760Config config) {
        this.config = config != null ? config : new Idea36760Config();
