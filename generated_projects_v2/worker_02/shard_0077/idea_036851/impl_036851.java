...
@Data
public class Idea36851Config {
    private String name = "idea_036851";
 ...
 */
@Slf4j
public class Idea36851Service {
    private static final int IDEA_ID = 36851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36851Service() {
        this(new Idea36851Config());
    }

    public Idea36851Service(Idea36851Config config) {
        this.config = config != null ? config : new Idea36851Config();
