...
@Data
public class Idea36590Config {
    private String name = "idea_036590";
 ...
 */
@Slf4j
public class Idea36590Service {
    private static final int IDEA_ID = 36590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36590Service() {
        this(new Idea36590Config());
    }

    public Idea36590Service(Idea36590Config config) {
        this.config = config != null ? config : new Idea36590Config();
