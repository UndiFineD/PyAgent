...
@Data
public class Idea36733Config {
    private String name = "idea_036733";
 ...
 */
@Slf4j
public class Idea36733Service {
    private static final int IDEA_ID = 36733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36733Service() {
        this(new Idea36733Config());
    }

    public Idea36733Service(Idea36733Config config) {
        this.config = config != null ? config : new Idea36733Config();
