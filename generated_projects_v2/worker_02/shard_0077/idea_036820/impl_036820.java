...
@Data
public class Idea36820Config {
    private String name = "idea_036820";
 ...
 */
@Slf4j
public class Idea36820Service {
    private static final int IDEA_ID = 36820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36820Service() {
        this(new Idea36820Config());
    }

    public Idea36820Service(Idea36820Config config) {
        this.config = config != null ? config : new Idea36820Config();
