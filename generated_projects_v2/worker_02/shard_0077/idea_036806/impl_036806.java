...
@Data
public class Idea36806Config {
    private String name = "idea_036806";
 ...
 */
@Slf4j
public class Idea36806Service {
    private static final int IDEA_ID = 36806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36806Service() {
        this(new Idea36806Config());
    }

    public Idea36806Service(Idea36806Config config) {
        this.config = config != null ? config : new Idea36806Config();
