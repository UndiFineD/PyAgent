...
@Data
public class Idea36857Config {
    private String name = "idea_036857";
 ...
 */
@Slf4j
public class Idea36857Service {
    private static final int IDEA_ID = 36857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36857Service() {
        this(new Idea36857Config());
    }

    public Idea36857Service(Idea36857Config config) {
        this.config = config != null ? config : new Idea36857Config();
