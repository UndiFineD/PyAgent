...
@Data
public class Idea36782Config {
    private String name = "idea_036782";
 ...
 */
@Slf4j
public class Idea36782Service {
    private static final int IDEA_ID = 36782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36782Service() {
        this(new Idea36782Config());
    }

    public Idea36782Service(Idea36782Config config) {
        this.config = config != null ? config : new Idea36782Config();
