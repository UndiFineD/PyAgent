...
@Data
public class Idea37018Config {
    private String name = "idea_037018";
 ...
 */
@Slf4j
public class Idea37018Service {
    private static final int IDEA_ID = 37018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37018Service() {
        this(new Idea37018Config());
    }

    public Idea37018Service(Idea37018Config config) {
        this.config = config != null ? config : new Idea37018Config();
