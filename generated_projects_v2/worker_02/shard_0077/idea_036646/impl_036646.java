...
@Data
public class Idea36646Config {
    private String name = "idea_036646";
 ...
 */
@Slf4j
public class Idea36646Service {
    private static final int IDEA_ID = 36646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36646Service() {
        this(new Idea36646Config());
    }

    public Idea36646Service(Idea36646Config config) {
        this.config = config != null ? config : new Idea36646Config();
