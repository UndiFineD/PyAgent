...
@Data
public class Idea36828Config {
    private String name = "idea_036828";
 ...
 */
@Slf4j
public class Idea36828Service {
    private static final int IDEA_ID = 36828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36828Service() {
        this(new Idea36828Config());
    }

    public Idea36828Service(Idea36828Config config) {
        this.config = config != null ? config : new Idea36828Config();
