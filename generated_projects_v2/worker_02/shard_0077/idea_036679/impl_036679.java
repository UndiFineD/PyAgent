...
@Data
public class Idea36679Config {
    private String name = "idea_036679";
 ...
 */
@Slf4j
public class Idea36679Service {
    private static final int IDEA_ID = 36679;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36679Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36679Service() {
        this(new Idea36679Config());
    }

    public Idea36679Service(Idea36679Config config) {
        this.config = config != null ? config : new Idea36679Config();
