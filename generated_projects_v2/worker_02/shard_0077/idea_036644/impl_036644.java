...
@Data
public class Idea36644Config {
    private String name = "idea_036644";
 ...
 */
@Slf4j
public class Idea36644Service {
    private static final int IDEA_ID = 36644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36644Service() {
        this(new Idea36644Config());
    }

    public Idea36644Service(Idea36644Config config) {
        this.config = config != null ? config : new Idea36644Config();
