...
@Data
public class Idea36797Config {
    private String name = "idea_036797";
 ...
 */
@Slf4j
public class Idea36797Service {
    private static final int IDEA_ID = 36797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36797Service() {
        this(new Idea36797Config());
    }

    public Idea36797Service(Idea36797Config config) {
        this.config = config != null ? config : new Idea36797Config();
