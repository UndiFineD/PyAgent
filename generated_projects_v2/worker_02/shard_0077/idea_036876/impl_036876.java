...
@Data
public class Idea36876Config {
    private String name = "idea_036876";
 ...
 */
@Slf4j
public class Idea36876Service {
    private static final int IDEA_ID = 36876;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36876Service() {
        this(new Idea36876Config());
    }

    public Idea36876Service(Idea36876Config config) {
        this.config = config != null ? config : new Idea36876Config();
