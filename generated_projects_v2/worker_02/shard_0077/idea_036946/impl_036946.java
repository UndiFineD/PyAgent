...
@Data
public class Idea36946Config {
    private String name = "idea_036946";
 ...
 */
@Slf4j
public class Idea36946Service {
    private static final int IDEA_ID = 36946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36946Service() {
        this(new Idea36946Config());
    }

    public Idea36946Service(Idea36946Config config) {
        this.config = config != null ? config : new Idea36946Config();
