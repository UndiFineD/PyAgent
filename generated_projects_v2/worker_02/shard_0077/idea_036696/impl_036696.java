...
@Data
public class Idea36696Config {
    private String name = "idea_036696";
 ...
 */
@Slf4j
public class Idea36696Service {
    private static final int IDEA_ID = 36696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36696Service() {
        this(new Idea36696Config());
    }

    public Idea36696Service(Idea36696Config config) {
        this.config = config != null ? config : new Idea36696Config();
