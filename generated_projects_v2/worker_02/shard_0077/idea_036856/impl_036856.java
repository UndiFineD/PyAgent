...
@Data
public class Idea36856Config {
    private String name = "idea_036856";
 ...
 */
@Slf4j
public class Idea36856Service {
    private static final int IDEA_ID = 36856;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36856Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36856Service() {
        this(new Idea36856Config());
    }

    public Idea36856Service(Idea36856Config config) {
        this.config = config != null ? config : new Idea36856Config();
