...
@Data
public class Idea36815Config {
    private String name = "idea_036815";
 ...
 */
@Slf4j
public class Idea36815Service {
    private static final int IDEA_ID = 36815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36815Service() {
        this(new Idea36815Config());
    }

    public Idea36815Service(Idea36815Config config) {
        this.config = config != null ? config : new Idea36815Config();
