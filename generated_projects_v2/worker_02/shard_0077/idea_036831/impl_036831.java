...
@Data
public class Idea36831Config {
    private String name = "idea_036831";
 ...
 */
@Slf4j
public class Idea36831Service {
    private static final int IDEA_ID = 36831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36831Service() {
        this(new Idea36831Config());
    }

    public Idea36831Service(Idea36831Config config) {
        this.config = config != null ? config : new Idea36831Config();
