...
@Data
public class Idea36927Config {
    private String name = "idea_036927";
 ...
 */
@Slf4j
public class Idea36927Service {
    private static final int IDEA_ID = 36927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36927Service() {
        this(new Idea36927Config());
    }

    public Idea36927Service(Idea36927Config config) {
        this.config = config != null ? config : new Idea36927Config();
