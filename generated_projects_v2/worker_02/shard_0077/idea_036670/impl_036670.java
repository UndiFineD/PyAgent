...
@Data
public class Idea36670Config {
    private String name = "idea_036670";
 ...
 */
@Slf4j
public class Idea36670Service {
    private static final int IDEA_ID = 36670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36670Service() {
        this(new Idea36670Config());
    }

    public Idea36670Service(Idea36670Config config) {
        this.config = config != null ? config : new Idea36670Config();
