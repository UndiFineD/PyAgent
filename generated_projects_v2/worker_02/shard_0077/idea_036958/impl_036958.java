...
@Data
public class Idea36958Config {
    private String name = "idea_036958";
 ...
 */
@Slf4j
public class Idea36958Service {
    private static final int IDEA_ID = 36958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36958Service() {
        this(new Idea36958Config());
    }

    public Idea36958Service(Idea36958Config config) {
        this.config = config != null ? config : new Idea36958Config();
