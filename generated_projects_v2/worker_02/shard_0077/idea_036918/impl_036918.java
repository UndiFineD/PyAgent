...
@Data
public class Idea36918Config {
    private String name = "idea_036918";
 ...
 */
@Slf4j
public class Idea36918Service {
    private static final int IDEA_ID = 36918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36918Service() {
        this(new Idea36918Config());
    }

    public Idea36918Service(Idea36918Config config) {
        this.config = config != null ? config : new Idea36918Config();
