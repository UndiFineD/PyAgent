...
@Data
public class Idea36710Config {
    private String name = "idea_036710";
 ...
 */
@Slf4j
public class Idea36710Service {
    private static final int IDEA_ID = 36710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36710Service() {
        this(new Idea36710Config());
    }

    public Idea36710Service(Idea36710Config config) {
        this.config = config != null ? config : new Idea36710Config();
