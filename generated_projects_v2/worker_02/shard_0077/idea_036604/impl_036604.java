...
@Data
public class Idea36604Config {
    private String name = "idea_036604";
 ...
 */
@Slf4j
public class Idea36604Service {
    private static final int IDEA_ID = 36604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36604Service() {
        this(new Idea36604Config());
    }

    public Idea36604Service(Idea36604Config config) {
        this.config = config != null ? config : new Idea36604Config();
