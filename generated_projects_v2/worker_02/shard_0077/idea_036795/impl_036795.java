...
@Data
public class Idea36795Config {
    private String name = "idea_036795";
 ...
 */
@Slf4j
public class Idea36795Service {
    private static final int IDEA_ID = 36795;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36795Service() {
        this(new Idea36795Config());
    }

    public Idea36795Service(Idea36795Config config) {
        this.config = config != null ? config : new Idea36795Config();
