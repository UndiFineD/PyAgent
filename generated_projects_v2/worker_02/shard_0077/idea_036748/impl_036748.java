...
@Data
public class Idea36748Config {
    private String name = "idea_036748";
 ...
 */
@Slf4j
public class Idea36748Service {
    private static final int IDEA_ID = 36748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36748Service() {
        this(new Idea36748Config());
    }

    public Idea36748Service(Idea36748Config config) {
        this.config = config != null ? config : new Idea36748Config();
