...
@Data
public class Idea36674Config {
    private String name = "idea_036674";
 ...
 */
@Slf4j
public class Idea36674Service {
    private static final int IDEA_ID = 36674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36674Service() {
        this(new Idea36674Config());
    }

    public Idea36674Service(Idea36674Config config) {
        this.config = config != null ? config : new Idea36674Config();
