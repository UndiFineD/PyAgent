...
@Data
public class Idea36921Config {
    private String name = "idea_036921";
 ...
 */
@Slf4j
public class Idea36921Service {
    private static final int IDEA_ID = 36921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36921Service() {
        this(new Idea36921Config());
    }

    public Idea36921Service(Idea36921Config config) {
        this.config = config != null ? config : new Idea36921Config();
