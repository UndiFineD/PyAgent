...
@Data
public class Idea37011Config {
    private String name = "idea_037011";
 ...
 */
@Slf4j
public class Idea37011Service {
    private static final int IDEA_ID = 37011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37011Service() {
        this(new Idea37011Config());
    }

    public Idea37011Service(Idea37011Config config) {
        this.config = config != null ? config : new Idea37011Config();
