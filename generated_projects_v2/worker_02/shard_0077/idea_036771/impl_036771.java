...
@Data
public class Idea36771Config {
    private String name = "idea_036771";
 ...
 */
@Slf4j
public class Idea36771Service {
    private static final int IDEA_ID = 36771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36771Service() {
        this(new Idea36771Config());
    }

    public Idea36771Service(Idea36771Config config) {
        this.config = config != null ? config : new Idea36771Config();
