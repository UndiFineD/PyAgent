...
@Data
public class Idea36805Config {
    private String name = "idea_036805";
 ...
 */
@Slf4j
public class Idea36805Service {
    private static final int IDEA_ID = 36805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36805Service() {
        this(new Idea36805Config());
    }

    public Idea36805Service(Idea36805Config config) {
        this.config = config != null ? config : new Idea36805Config();
