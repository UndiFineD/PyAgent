...
@Data
public class Idea36638Config {
    private String name = "idea_036638";
 ...
 */
@Slf4j
public class Idea36638Service {
    private static final int IDEA_ID = 36638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36638Service() {
        this(new Idea36638Config());
    }

    public Idea36638Service(Idea36638Config config) {
        this.config = config != null ? config : new Idea36638Config();
