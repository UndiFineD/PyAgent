...
@Data
public class Idea36660Config {
    private String name = "idea_036660";
 ...
 */
@Slf4j
public class Idea36660Service {
    private static final int IDEA_ID = 36660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36660Service() {
        this(new Idea36660Config());
    }

    public Idea36660Service(Idea36660Config config) {
        this.config = config != null ? config : new Idea36660Config();
