...
@Data
public class Idea36830Config {
    private String name = "idea_036830";
 ...
 */
@Slf4j
public class Idea36830Service {
    private static final int IDEA_ID = 36830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36830Service() {
        this(new Idea36830Config());
    }

    public Idea36830Service(Idea36830Config config) {
        this.config = config != null ? config : new Idea36830Config();
