...
@Data
public class Idea36735Config {
    private String name = "idea_036735";
 ...
 */
@Slf4j
public class Idea36735Service {
    private static final int IDEA_ID = 36735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36735Service() {
        this(new Idea36735Config());
    }

    public Idea36735Service(Idea36735Config config) {
        this.config = config != null ? config : new Idea36735Config();
