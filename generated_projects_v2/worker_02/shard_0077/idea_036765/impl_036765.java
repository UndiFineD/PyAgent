...
@Data
public class Idea36765Config {
    private String name = "idea_036765";
 ...
 */
@Slf4j
public class Idea36765Service {
    private static final int IDEA_ID = 36765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36765Service() {
        this(new Idea36765Config());
    }

    public Idea36765Service(Idea36765Config config) {
        this.config = config != null ? config : new Idea36765Config();
