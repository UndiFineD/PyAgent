...
@Data
public class Idea36967Config {
    private String name = "idea_036967";
 ...
 */
@Slf4j
public class Idea36967Service {
    private static final int IDEA_ID = 36967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36967Service() {
        this(new Idea36967Config());
    }

    public Idea36967Service(Idea36967Config config) {
        this.config = config != null ? config : new Idea36967Config();
