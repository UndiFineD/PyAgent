...
@Data
public class Idea36884Config {
    private String name = "idea_036884";
 ...
 */
@Slf4j
public class Idea36884Service {
    private static final int IDEA_ID = 36884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36884Service() {
        this(new Idea36884Config());
    }

    public Idea36884Service(Idea36884Config config) {
        this.config = config != null ? config : new Idea36884Config();
