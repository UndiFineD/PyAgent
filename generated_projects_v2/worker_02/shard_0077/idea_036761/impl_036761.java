...
@Data
public class Idea36761Config {
    private String name = "idea_036761";
 ...
 */
@Slf4j
public class Idea36761Service {
    private static final int IDEA_ID = 36761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36761Service() {
        this(new Idea36761Config());
    }

    public Idea36761Service(Idea36761Config config) {
        this.config = config != null ? config : new Idea36761Config();
