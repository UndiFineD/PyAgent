...
@Data
public class Idea36817Config {
    private String name = "idea_036817";
 ...
 */
@Slf4j
public class Idea36817Service {
    private static final int IDEA_ID = 36817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36817Service() {
        this(new Idea36817Config());
    }

    public Idea36817Service(Idea36817Config config) {
        this.config = config != null ? config : new Idea36817Config();
