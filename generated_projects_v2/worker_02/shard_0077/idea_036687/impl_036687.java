...
@Data
public class Idea36687Config {
    private String name = "idea_036687";
 ...
 */
@Slf4j
public class Idea36687Service {
    private static final int IDEA_ID = 36687;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36687Service() {
        this(new Idea36687Config());
    }

    public Idea36687Service(Idea36687Config config) {
        this.config = config != null ? config : new Idea36687Config();
