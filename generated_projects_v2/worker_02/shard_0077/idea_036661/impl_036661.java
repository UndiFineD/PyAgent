...
@Data
public class Idea36661Config {
    private String name = "idea_036661";
 ...
 */
@Slf4j
public class Idea36661Service {
    private static final int IDEA_ID = 36661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36661Service() {
        this(new Idea36661Config());
    }

    public Idea36661Service(Idea36661Config config) {
        this.config = config != null ? config : new Idea36661Config();
