...
@Data
public class Idea36665Config {
    private String name = "idea_036665";
 ...
 */
@Slf4j
public class Idea36665Service {
    private static final int IDEA_ID = 36665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36665Service() {
        this(new Idea36665Config());
    }

    public Idea36665Service(Idea36665Config config) {
        this.config = config != null ? config : new Idea36665Config();
