...
@Data
public class Idea36932Config {
    private String name = "idea_036932";
 ...
 */
@Slf4j
public class Idea36932Service {
    private static final int IDEA_ID = 36932;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36932Service() {
        this(new Idea36932Config());
    }

    public Idea36932Service(Idea36932Config config) {
        this.config = config != null ? config : new Idea36932Config();
