...
@Data
public class Idea36613Config {
    private String name = "idea_036613";
 ...
 */
@Slf4j
public class Idea36613Service {
    private static final int IDEA_ID = 36613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36613Service() {
        this(new Idea36613Config());
    }

    public Idea36613Service(Idea36613Config config) {
        this.config = config != null ? config : new Idea36613Config();
