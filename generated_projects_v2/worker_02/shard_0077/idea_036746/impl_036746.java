...
@Data
public class Idea36746Config {
    private String name = "idea_036746";
 ...
 */
@Slf4j
public class Idea36746Service {
    private static final int IDEA_ID = 36746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36746Service() {
        this(new Idea36746Config());
    }

    public Idea36746Service(Idea36746Config config) {
        this.config = config != null ? config : new Idea36746Config();
