...
@Data
public class Idea36601Config {
    private String name = "idea_036601";
 ...
 */
@Slf4j
public class Idea36601Service {
    private static final int IDEA_ID = 36601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36601Service() {
        this(new Idea36601Config());
    }

    public Idea36601Service(Idea36601Config config) {
        this.config = config != null ? config : new Idea36601Config();
