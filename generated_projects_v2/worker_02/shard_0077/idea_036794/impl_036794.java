...
@Data
public class Idea36794Config {
    private String name = "idea_036794";
 ...
 */
@Slf4j
public class Idea36794Service {
    private static final int IDEA_ID = 36794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36794Service() {
        this(new Idea36794Config());
    }

    public Idea36794Service(Idea36794Config config) {
        this.config = config != null ? config : new Idea36794Config();
