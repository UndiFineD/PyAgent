...
@Data
public class Idea36668Config {
    private String name = "idea_036668";
 ...
 */
@Slf4j
public class Idea36668Service {
    private static final int IDEA_ID = 36668;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36668Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36668Service() {
        this(new Idea36668Config());
    }

    public Idea36668Service(Idea36668Config config) {
        this.config = config != null ? config : new Idea36668Config();
