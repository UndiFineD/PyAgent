...
@Data
public class Idea36639Config {
    private String name = "idea_036639";
 ...
 */
@Slf4j
public class Idea36639Service {
    private static final int IDEA_ID = 36639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36639Service() {
        this(new Idea36639Config());
    }

    public Idea36639Service(Idea36639Config config) {
        this.config = config != null ? config : new Idea36639Config();
