...
@Data
public class Idea36838Config {
    private String name = "idea_036838";
 ...
 */
@Slf4j
public class Idea36838Service {
    private static final int IDEA_ID = 36838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36838Service() {
        this(new Idea36838Config());
    }

    public Idea36838Service(Idea36838Config config) {
        this.config = config != null ? config : new Idea36838Config();
