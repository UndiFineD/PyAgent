...
@Data
public class Idea36581Config {
    private String name = "idea_036581";
 ...
 */
@Slf4j
public class Idea36581Service {
    private static final int IDEA_ID = 36581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36581Service() {
        this(new Idea36581Config());
    }

    public Idea36581Service(Idea36581Config config) {
        this.config = config != null ? config : new Idea36581Config();
