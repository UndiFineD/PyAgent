...
@Data
public class Idea36963Config {
    private String name = "idea_036963";
 ...
 */
@Slf4j
public class Idea36963Service {
    private static final int IDEA_ID = 36963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36963Service() {
        this(new Idea36963Config());
    }

    public Idea36963Service(Idea36963Config config) {
        this.config = config != null ? config : new Idea36963Config();
