...
@Data
public class Idea37000Config {
    private String name = "idea_037000";
 ...
 */
@Slf4j
public class Idea37000Service {
    private static final int IDEA_ID = 37000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37000Service() {
        this(new Idea37000Config());
    }

    public Idea37000Service(Idea37000Config config) {
        this.config = config != null ? config : new Idea37000Config();
