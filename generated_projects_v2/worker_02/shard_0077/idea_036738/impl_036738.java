...
@Data
public class Idea36738Config {
    private String name = "idea_036738";
 ...
 */
@Slf4j
public class Idea36738Service {
    private static final int IDEA_ID = 36738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36738Service() {
        this(new Idea36738Config());
    }

    public Idea36738Service(Idea36738Config config) {
        this.config = config != null ? config : new Idea36738Config();
