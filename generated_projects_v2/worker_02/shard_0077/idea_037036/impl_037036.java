...
@Data
public class Idea37036Config {
    private String name = "idea_037036";
 ...
 */
@Slf4j
public class Idea37036Service {
    private static final int IDEA_ID = 37036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37036Service() {
        this(new Idea37036Config());
    }

    public Idea37036Service(Idea37036Config config) {
        this.config = config != null ? config : new Idea37036Config();
