...
@Data
public class Idea36621Config {
    private String name = "idea_036621";
 ...
 */
@Slf4j
public class Idea36621Service {
    private static final int IDEA_ID = 36621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36621Service() {
        this(new Idea36621Config());
    }

    public Idea36621Service(Idea36621Config config) {
        this.config = config != null ? config : new Idea36621Config();
