...
@Data
public class Idea36585Config {
    private String name = "idea_036585";
 ...
 */
@Slf4j
public class Idea36585Service {
    private static final int IDEA_ID = 36585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36585Service() {
        this(new Idea36585Config());
    }

    public Idea36585Service(Idea36585Config config) {
        this.config = config != null ? config : new Idea36585Config();
