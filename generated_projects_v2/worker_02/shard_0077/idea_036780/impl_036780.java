...
@Data
public class Idea36780Config {
    private String name = "idea_036780";
 ...
 */
@Slf4j
public class Idea36780Service {
    private static final int IDEA_ID = 36780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36780Service() {
        this(new Idea36780Config());
    }

    public Idea36780Service(Idea36780Config config) {
        this.config = config != null ? config : new Idea36780Config();
