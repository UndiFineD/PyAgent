...
@Data
public class Idea36986Config {
    private String name = "idea_036986";
 ...
 */
@Slf4j
public class Idea36986Service {
    private static final int IDEA_ID = 36986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36986Service() {
        this(new Idea36986Config());
    }

    public Idea36986Service(Idea36986Config config) {
        this.config = config != null ? config : new Idea36986Config();
