...
@Data
public class Idea36655Config {
    private String name = "idea_036655";
 ...
 */
@Slf4j
public class Idea36655Service {
    private static final int IDEA_ID = 36655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36655Service() {
        this(new Idea36655Config());
    }

    public Idea36655Service(Idea36655Config config) {
        this.config = config != null ? config : new Idea36655Config();
