...
@Data
public class Idea36699Config {
    private String name = "idea_036699";
 ...
 */
@Slf4j
public class Idea36699Service {
    private static final int IDEA_ID = 36699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36699Service() {
        this(new Idea36699Config());
    }

    public Idea36699Service(Idea36699Config config) {
        this.config = config != null ? config : new Idea36699Config();
