...
@Data
public class Idea36749Config {
    private String name = "idea_036749";
 ...
 */
@Slf4j
public class Idea36749Service {
    private static final int IDEA_ID = 36749;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36749Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36749Service() {
        this(new Idea36749Config());
    }

    public Idea36749Service(Idea36749Config config) {
        this.config = config != null ? config : new Idea36749Config();
