...
@Data
public class Idea36943Config {
    private String name = "idea_036943";
 ...
 */
@Slf4j
public class Idea36943Service {
    private static final int IDEA_ID = 36943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36943Service() {
        this(new Idea36943Config());
    }

    public Idea36943Service(Idea36943Config config) {
        this.config = config != null ? config : new Idea36943Config();
