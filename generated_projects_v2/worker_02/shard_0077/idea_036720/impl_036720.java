...
@Data
public class Idea36720Config {
    private String name = "idea_036720";
 ...
 */
@Slf4j
public class Idea36720Service {
    private static final int IDEA_ID = 36720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36720Service() {
        this(new Idea36720Config());
    }

    public Idea36720Service(Idea36720Config config) {
        this.config = config != null ? config : new Idea36720Config();
