...
@Data
public class Idea36645Config {
    private String name = "idea_036645";
 ...
 */
@Slf4j
public class Idea36645Service {
    private static final int IDEA_ID = 36645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36645Service() {
        this(new Idea36645Config());
    }

    public Idea36645Service(Idea36645Config config) {
        this.config = config != null ? config : new Idea36645Config();
