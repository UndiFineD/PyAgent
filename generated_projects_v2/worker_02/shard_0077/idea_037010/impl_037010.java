...
@Data
public class Idea37010Config {
    private String name = "idea_037010";
 ...
 */
@Slf4j
public class Idea37010Service {
    private static final int IDEA_ID = 37010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37010Service() {
        this(new Idea37010Config());
    }

    public Idea37010Service(Idea37010Config config) {
        this.config = config != null ? config : new Idea37010Config();
