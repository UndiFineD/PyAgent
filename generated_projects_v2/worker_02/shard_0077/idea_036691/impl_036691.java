...
@Data
public class Idea36691Config {
    private String name = "idea_036691";
 ...
 */
@Slf4j
public class Idea36691Service {
    private static final int IDEA_ID = 36691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36691Service() {
        this(new Idea36691Config());
    }

    public Idea36691Service(Idea36691Config config) {
        this.config = config != null ? config : new Idea36691Config();
