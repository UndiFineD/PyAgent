...
@Data
public class Idea36990Config {
    private String name = "idea_036990";
 ...
 */
@Slf4j
public class Idea36990Service {
    private static final int IDEA_ID = 36990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36990Service() {
        this(new Idea36990Config());
    }

    public Idea36990Service(Idea36990Config config) {
        this.config = config != null ? config : new Idea36990Config();
