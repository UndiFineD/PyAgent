...
@Data
public class Idea36936Config {
    private String name = "idea_036936";
 ...
 */
@Slf4j
public class Idea36936Service {
    private static final int IDEA_ID = 36936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36936Service() {
        this(new Idea36936Config());
    }

    public Idea36936Service(Idea36936Config config) {
        this.config = config != null ? config : new Idea36936Config();
