...
@Data
public class Idea36624Config {
    private String name = "idea_036624";
 ...
 */
@Slf4j
public class Idea36624Service {
    private static final int IDEA_ID = 36624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36624Service() {
        this(new Idea36624Config());
    }

    public Idea36624Service(Idea36624Config config) {
        this.config = config != null ? config : new Idea36624Config();
