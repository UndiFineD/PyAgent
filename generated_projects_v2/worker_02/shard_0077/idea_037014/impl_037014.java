...
@Data
public class Idea37014Config {
    private String name = "idea_037014";
 ...
 */
@Slf4j
public class Idea37014Service {
    private static final int IDEA_ID = 37014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37014Service() {
        this(new Idea37014Config());
    }

    public Idea37014Service(Idea37014Config config) {
        this.config = config != null ? config : new Idea37014Config();
