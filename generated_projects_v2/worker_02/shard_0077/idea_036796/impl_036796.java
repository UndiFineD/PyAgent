...
@Data
public class Idea36796Config {
    private String name = "idea_036796";
 ...
 */
@Slf4j
public class Idea36796Service {
    private static final int IDEA_ID = 36796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36796Service() {
        this(new Idea36796Config());
    }

    public Idea36796Service(Idea36796Config config) {
        this.config = config != null ? config : new Idea36796Config();
