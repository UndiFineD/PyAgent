...
@Data
public class Idea36714Config {
    private String name = "idea_036714";
 ...
 */
@Slf4j
public class Idea36714Service {
    private static final int IDEA_ID = 36714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36714Service() {
        this(new Idea36714Config());
    }

    public Idea36714Service(Idea36714Config config) {
        this.config = config != null ? config : new Idea36714Config();
