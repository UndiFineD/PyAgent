...
@Data
public class Idea36816Config {
    private String name = "idea_036816";
 ...
 */
@Slf4j
public class Idea36816Service {
    private static final int IDEA_ID = 36816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36816Service() {
        this(new Idea36816Config());
    }

    public Idea36816Service(Idea36816Config config) {
        this.config = config != null ? config : new Idea36816Config();
