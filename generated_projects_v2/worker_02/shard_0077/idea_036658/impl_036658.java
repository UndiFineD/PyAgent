...
@Data
public class Idea36658Config {
    private String name = "idea_036658";
 ...
 */
@Slf4j
public class Idea36658Service {
    private static final int IDEA_ID = 36658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36658Service() {
        this(new Idea36658Config());
    }

    public Idea36658Service(Idea36658Config config) {
        this.config = config != null ? config : new Idea36658Config();
