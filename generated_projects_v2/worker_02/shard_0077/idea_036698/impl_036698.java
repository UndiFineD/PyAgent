...
@Data
public class Idea36698Config {
    private String name = "idea_036698";
 ...
 */
@Slf4j
public class Idea36698Service {
    private static final int IDEA_ID = 36698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36698Service() {
        this(new Idea36698Config());
    }

    public Idea36698Service(Idea36698Config config) {
        this.config = config != null ? config : new Idea36698Config();
