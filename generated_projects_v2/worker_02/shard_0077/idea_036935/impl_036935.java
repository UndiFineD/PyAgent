...
@Data
public class Idea36935Config {
    private String name = "idea_036935";
 ...
 */
@Slf4j
public class Idea36935Service {
    private static final int IDEA_ID = 36935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36935Service() {
        this(new Idea36935Config());
    }

    public Idea36935Service(Idea36935Config config) {
        this.config = config != null ? config : new Idea36935Config();
