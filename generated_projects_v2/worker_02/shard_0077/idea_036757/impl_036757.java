...
@Data
public class Idea36757Config {
    private String name = "idea_036757";
 ...
 */
@Slf4j
public class Idea36757Service {
    private static final int IDEA_ID = 36757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36757Service() {
        this(new Idea36757Config());
    }

    public Idea36757Service(Idea36757Config config) {
        this.config = config != null ? config : new Idea36757Config();
