...
@Data
public class Idea36732Config {
    private String name = "idea_036732";
 ...
 */
@Slf4j
public class Idea36732Service {
    private static final int IDEA_ID = 36732;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36732Service() {
        this(new Idea36732Config());
    }

    public Idea36732Service(Idea36732Config config) {
        this.config = config != null ? config : new Idea36732Config();
