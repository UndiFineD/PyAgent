...
@Data
public class Idea36591Config {
    private String name = "idea_036591";
 ...
 */
@Slf4j
public class Idea36591Service {
    private static final int IDEA_ID = 36591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36591Service() {
        this(new Idea36591Config());
    }

    public Idea36591Service(Idea36591Config config) {
        this.config = config != null ? config : new Idea36591Config();
