...
@Data
public class Idea36700Config {
    private String name = "idea_036700";
 ...
 */
@Slf4j
public class Idea36700Service {
    private static final int IDEA_ID = 36700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36700Service() {
        this(new Idea36700Config());
    }

    public Idea36700Service(Idea36700Config config) {
        this.config = config != null ? config : new Idea36700Config();
