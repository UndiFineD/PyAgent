...
@Data
public class Idea36717Config {
    private String name = "idea_036717";
 ...
 */
@Slf4j
public class Idea36717Service {
    private static final int IDEA_ID = 36717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36717Service() {
        this(new Idea36717Config());
    }

    public Idea36717Service(Idea36717Config config) {
        this.config = config != null ? config : new Idea36717Config();
