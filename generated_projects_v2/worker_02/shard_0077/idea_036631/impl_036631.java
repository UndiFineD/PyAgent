...
@Data
public class Idea36631Config {
    private String name = "idea_036631";
 ...
 */
@Slf4j
public class Idea36631Service {
    private static final int IDEA_ID = 36631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36631Service() {
        this(new Idea36631Config());
    }

    public Idea36631Service(Idea36631Config config) {
        this.config = config != null ? config : new Idea36631Config();
