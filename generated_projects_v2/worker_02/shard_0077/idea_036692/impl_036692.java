...
@Data
public class Idea36692Config {
    private String name = "idea_036692";
 ...
 */
@Slf4j
public class Idea36692Service {
    private static final int IDEA_ID = 36692;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36692Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36692Service() {
        this(new Idea36692Config());
    }

    public Idea36692Service(Idea36692Config config) {
        this.config = config != null ? config : new Idea36692Config();
