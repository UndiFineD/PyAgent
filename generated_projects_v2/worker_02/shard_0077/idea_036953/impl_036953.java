...
@Data
public class Idea36953Config {
    private String name = "idea_036953";
 ...
 */
@Slf4j
public class Idea36953Service {
    private static final int IDEA_ID = 36953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36953Service() {
        this(new Idea36953Config());
    }

    public Idea36953Service(Idea36953Config config) {
        this.config = config != null ? config : new Idea36953Config();
