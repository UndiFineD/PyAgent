...
@Data
public class Idea36653Config {
    private String name = "idea_036653";
 ...
 */
@Slf4j
public class Idea36653Service {
    private static final int IDEA_ID = 36653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36653Service() {
        this(new Idea36653Config());
    }

    public Idea36653Service(Idea36653Config config) {
        this.config = config != null ? config : new Idea36653Config();
