...
@Data
public class Idea36872Config {
    private String name = "idea_036872";
 ...
 */
@Slf4j
public class Idea36872Service {
    private static final int IDEA_ID = 36872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36872Service() {
        this(new Idea36872Config());
    }

    public Idea36872Service(Idea36872Config config) {
        this.config = config != null ? config : new Idea36872Config();
