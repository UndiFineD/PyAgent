...
@Data
public class Idea36907Config {
    private String name = "idea_036907";
 ...
 */
@Slf4j
public class Idea36907Service {
    private static final int IDEA_ID = 36907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36907Service() {
        this(new Idea36907Config());
    }

    public Idea36907Service(Idea36907Config config) {
        this.config = config != null ? config : new Idea36907Config();
