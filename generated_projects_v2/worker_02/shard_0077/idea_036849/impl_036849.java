...
@Data
public class Idea36849Config {
    private String name = "idea_036849";
 ...
 */
@Slf4j
public class Idea36849Service {
    private static final int IDEA_ID = 36849;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36849Service() {
        this(new Idea36849Config());
    }

    public Idea36849Service(Idea36849Config config) {
        this.config = config != null ? config : new Idea36849Config();
