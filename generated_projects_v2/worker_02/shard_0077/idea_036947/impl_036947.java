...
@Data
public class Idea36947Config {
    private String name = "idea_036947";
 ...
 */
@Slf4j
public class Idea36947Service {
    private static final int IDEA_ID = 36947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36947Service() {
        this(new Idea36947Config());
    }

    public Idea36947Service(Idea36947Config config) {
        this.config = config != null ? config : new Idea36947Config();
