...
@Data
public class Idea36715Config {
    private String name = "idea_036715";
 ...
 */
@Slf4j
public class Idea36715Service {
    private static final int IDEA_ID = 36715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36715Service() {
        this(new Idea36715Config());
    }

    public Idea36715Service(Idea36715Config config) {
        this.config = config != null ? config : new Idea36715Config();
