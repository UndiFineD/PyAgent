...
@Data
public class Idea36629Config {
    private String name = "idea_036629";
 ...
 */
@Slf4j
public class Idea36629Service {
    private static final int IDEA_ID = 36629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36629Service() {
        this(new Idea36629Config());
    }

    public Idea36629Service(Idea36629Config config) {
        this.config = config != null ? config : new Idea36629Config();
