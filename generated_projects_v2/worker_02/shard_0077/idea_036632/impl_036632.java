...
@Data
public class Idea36632Config {
    private String name = "idea_036632";
 ...
 */
@Slf4j
public class Idea36632Service {
    private static final int IDEA_ID = 36632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36632Service() {
        this(new Idea36632Config());
    }

    public Idea36632Service(Idea36632Config config) {
        this.config = config != null ? config : new Idea36632Config();
