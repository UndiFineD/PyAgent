...
@Data
public class Idea36626Config {
    private String name = "idea_036626";
 ...
 */
@Slf4j
public class Idea36626Service {
    private static final int IDEA_ID = 36626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36626Service() {
        this(new Idea36626Config());
    }

    public Idea36626Service(Idea36626Config config) {
        this.config = config != null ? config : new Idea36626Config();
