...
@Data
public class Idea36893Config {
    private String name = "idea_036893";
 ...
 */
@Slf4j
public class Idea36893Service {
    private static final int IDEA_ID = 36893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36893Service() {
        this(new Idea36893Config());
    }

    public Idea36893Service(Idea36893Config config) {
        this.config = config != null ? config : new Idea36893Config();
