...
@Data
public class Idea36602Config {
    private String name = "idea_036602";
 ...
 */
@Slf4j
public class Idea36602Service {
    private static final int IDEA_ID = 36602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36602Service() {
        this(new Idea36602Config());
    }

    public Idea36602Service(Idea36602Config config) {
        this.config = config != null ? config : new Idea36602Config();
