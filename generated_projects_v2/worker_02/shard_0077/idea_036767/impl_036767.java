...
@Data
public class Idea36767Config {
    private String name = "idea_036767";
 ...
 */
@Slf4j
public class Idea36767Service {
    private static final int IDEA_ID = 36767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36767Service() {
        this(new Idea36767Config());
    }

    public Idea36767Service(Idea36767Config config) {
        this.config = config != null ? config : new Idea36767Config();
