...
@Data
public class Idea36799Config {
    private String name = "idea_036799";
 ...
 */
@Slf4j
public class Idea36799Service {
    private static final int IDEA_ID = 36799;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36799Service() {
        this(new Idea36799Config());
    }

    public Idea36799Service(Idea36799Config config) {
        this.config = config != null ? config : new Idea36799Config();
