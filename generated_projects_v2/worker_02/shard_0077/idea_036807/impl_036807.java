...
@Data
public class Idea36807Config {
    private String name = "idea_036807";
 ...
 */
@Slf4j
public class Idea36807Service {
    private static final int IDEA_ID = 36807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36807Service() {
        this(new Idea36807Config());
    }

    public Idea36807Service(Idea36807Config config) {
        this.config = config != null ? config : new Idea36807Config();
