...
@Data
public class Idea36923Config {
    private String name = "idea_036923";
 ...
 */
@Slf4j
public class Idea36923Service {
    private static final int IDEA_ID = 36923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36923Service() {
        this(new Idea36923Config());
    }

    public Idea36923Service(Idea36923Config config) {
        this.config = config != null ? config : new Idea36923Config();
