...
@Data
public class Idea36766Config {
    private String name = "idea_036766";
 ...
 */
@Slf4j
public class Idea36766Service {
    private static final int IDEA_ID = 36766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36766Service() {
        this(new Idea36766Config());
    }

    public Idea36766Service(Idea36766Config config) {
        this.config = config != null ? config : new Idea36766Config();
