...
@Data
public class Idea36719Config {
    private String name = "idea_036719";
 ...
 */
@Slf4j
public class Idea36719Service {
    private static final int IDEA_ID = 36719;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36719Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36719Service() {
        this(new Idea36719Config());
    }

    public Idea36719Service(Idea36719Config config) {
        this.config = config != null ? config : new Idea36719Config();
