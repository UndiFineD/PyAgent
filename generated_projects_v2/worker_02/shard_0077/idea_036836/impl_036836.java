...
@Data
public class Idea36836Config {
    private String name = "idea_036836";
 ...
 */
@Slf4j
public class Idea36836Service {
    private static final int IDEA_ID = 36836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36836Service() {
        this(new Idea36836Config());
    }

    public Idea36836Service(Idea36836Config config) {
        this.config = config != null ? config : new Idea36836Config();
