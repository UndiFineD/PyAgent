...
@Data
public class Idea36775Config {
    private String name = "idea_036775";
 ...
 */
@Slf4j
public class Idea36775Service {
    private static final int IDEA_ID = 36775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36775Service() {
        this(new Idea36775Config());
    }

    public Idea36775Service(Idea36775Config config) {
        this.config = config != null ? config : new Idea36775Config();
