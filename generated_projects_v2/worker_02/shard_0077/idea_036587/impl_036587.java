...
@Data
public class Idea36587Config {
    private String name = "idea_036587";
 ...
 */
@Slf4j
public class Idea36587Service {
    private static final int IDEA_ID = 36587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea36587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea36587Service() {
        this(new Idea36587Config());
    }

    public Idea36587Service(Idea36587Config config) {
        this.config = config != null ? config : new Idea36587Config();
