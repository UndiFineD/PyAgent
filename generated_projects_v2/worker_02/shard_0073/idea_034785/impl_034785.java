...
@Data
public class Idea34785Config {
    private String name = "idea_034785";
 ...
 */
@Slf4j
public class Idea34785Service {
    private static final int IDEA_ID = 34785;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34785Service() {
        this(new Idea34785Config());
    }

    public Idea34785Service(Idea34785Config config) {
        this.config = config != null ? config : new Idea34785Config();
