...
@Data
public class Idea35020Config {
    private String name = "idea_035020";
 ...
 */
@Slf4j
public class Idea35020Service {
    private static final int IDEA_ID = 35020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35020Service() {
        this(new Idea35020Config());
    }

    public Idea35020Service(Idea35020Config config) {
        this.config = config != null ? config : new Idea35020Config();
