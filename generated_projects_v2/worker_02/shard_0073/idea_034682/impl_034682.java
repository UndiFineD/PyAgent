...
@Data
public class Idea34682Config {
    private String name = "idea_034682";
 ...
 */
@Slf4j
public class Idea34682Service {
    private static final int IDEA_ID = 34682;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34682Service() {
        this(new Idea34682Config());
    }

    public Idea34682Service(Idea34682Config config) {
        this.config = config != null ? config : new Idea34682Config();
