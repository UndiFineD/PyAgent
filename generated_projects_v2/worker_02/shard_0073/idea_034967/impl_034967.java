...
@Data
public class Idea34967Config {
    private String name = "idea_034967";
 ...
 */
@Slf4j
public class Idea34967Service {
    private static final int IDEA_ID = 34967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34967Service() {
        this(new Idea34967Config());
    }

    public Idea34967Service(Idea34967Config config) {
        this.config = config != null ? config : new Idea34967Config();
