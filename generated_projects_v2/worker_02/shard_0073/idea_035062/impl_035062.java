...
@Data
public class Idea35062Config {
    private String name = "idea_035062";
 ...
 */
@Slf4j
public class Idea35062Service {
    private static final int IDEA_ID = 35062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35062Service() {
        this(new Idea35062Config());
    }

    public Idea35062Service(Idea35062Config config) {
        this.config = config != null ? config : new Idea35062Config();
