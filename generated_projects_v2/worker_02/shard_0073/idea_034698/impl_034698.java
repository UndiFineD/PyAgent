...
@Data
public class Idea34698Config {
    private String name = "idea_034698";
 ...
 */
@Slf4j
public class Idea34698Service {
    private static final int IDEA_ID = 34698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34698Service() {
        this(new Idea34698Config());
    }

    public Idea34698Service(Idea34698Config config) {
        this.config = config != null ? config : new Idea34698Config();
