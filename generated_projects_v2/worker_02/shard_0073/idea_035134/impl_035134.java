...
@Data
public class Idea35134Config {
    private String name = "idea_035134";
 ...
 */
@Slf4j
public class Idea35134Service {
    private static final int IDEA_ID = 35134;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35134Service() {
        this(new Idea35134Config());
    }

    public Idea35134Service(Idea35134Config config) {
        this.config = config != null ? config : new Idea35134Config();
