...
@Data
public class Idea34707Config {
    private String name = "idea_034707";
 ...
 */
@Slf4j
public class Idea34707Service {
    private static final int IDEA_ID = 34707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34707Service() {
        this(new Idea34707Config());
    }

    public Idea34707Service(Idea34707Config config) {
        this.config = config != null ? config : new Idea34707Config();
