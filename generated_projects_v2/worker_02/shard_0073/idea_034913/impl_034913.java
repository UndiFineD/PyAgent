...
@Data
public class Idea34913Config {
    private String name = "idea_034913";
 ...
 */
@Slf4j
public class Idea34913Service {
    private static final int IDEA_ID = 34913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34913Service() {
        this(new Idea34913Config());
    }

    public Idea34913Service(Idea34913Config config) {
        this.config = config != null ? config : new Idea34913Config();
