...
@Data
public class Idea34782Config {
    private String name = "idea_034782";
 ...
 */
@Slf4j
public class Idea34782Service {
    private static final int IDEA_ID = 34782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34782Service() {
        this(new Idea34782Config());
    }

    public Idea34782Service(Idea34782Config config) {
        this.config = config != null ? config : new Idea34782Config();
