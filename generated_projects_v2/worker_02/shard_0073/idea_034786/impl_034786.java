...
@Data
public class Idea34786Config {
    private String name = "idea_034786";
 ...
 */
@Slf4j
public class Idea34786Service {
    private static final int IDEA_ID = 34786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34786Service() {
        this(new Idea34786Config());
    }

    public Idea34786Service(Idea34786Config config) {
        this.config = config != null ? config : new Idea34786Config();
