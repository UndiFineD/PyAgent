...
@Data
public class Idea34939Config {
    private String name = "idea_034939";
 ...
 */
@Slf4j
public class Idea34939Service {
    private static final int IDEA_ID = 34939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34939Service() {
        this(new Idea34939Config());
    }

    public Idea34939Service(Idea34939Config config) {
        this.config = config != null ? config : new Idea34939Config();
