...
@Data
public class Idea35095Config {
    private String name = "idea_035095";
 ...
 */
@Slf4j
public class Idea35095Service {
    private static final int IDEA_ID = 35095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35095Service() {
        this(new Idea35095Config());
    }

    public Idea35095Service(Idea35095Config config) {
        this.config = config != null ? config : new Idea35095Config();
