...
@Data
public class Idea35019Config {
    private String name = "idea_035019";
 ...
 */
@Slf4j
public class Idea35019Service {
    private static final int IDEA_ID = 35019;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35019Service() {
        this(new Idea35019Config());
    }

    public Idea35019Service(Idea35019Config config) {
        this.config = config != null ? config : new Idea35019Config();
