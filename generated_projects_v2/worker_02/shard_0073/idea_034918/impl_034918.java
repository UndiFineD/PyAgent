...
@Data
public class Idea34918Config {
    private String name = "idea_034918";
 ...
 */
@Slf4j
public class Idea34918Service {
    private static final int IDEA_ID = 34918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34918Service() {
        this(new Idea34918Config());
    }

    public Idea34918Service(Idea34918Config config) {
        this.config = config != null ? config : new Idea34918Config();
