...
@Data
public class Idea35107Config {
    private String name = "idea_035107";
 ...
 */
@Slf4j
public class Idea35107Service {
    private static final int IDEA_ID = 35107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35107Service() {
        this(new Idea35107Config());
    }

    public Idea35107Service(Idea35107Config config) {
        this.config = config != null ? config : new Idea35107Config();
