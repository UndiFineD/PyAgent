...
@Data
public class Idea35088Config {
    private String name = "idea_035088";
 ...
 */
@Slf4j
public class Idea35088Service {
    private static final int IDEA_ID = 35088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35088Service() {
        this(new Idea35088Config());
    }

    public Idea35088Service(Idea35088Config config) {
        this.config = config != null ? config : new Idea35088Config();
