...
@Data
public class Idea35037Config {
    private String name = "idea_035037";
 ...
 */
@Slf4j
public class Idea35037Service {
    private static final int IDEA_ID = 35037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35037Service() {
        this(new Idea35037Config());
    }

    public Idea35037Service(Idea35037Config config) {
        this.config = config != null ? config : new Idea35037Config();
