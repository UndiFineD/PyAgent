...
@Data
public class Idea35094Config {
    private String name = "idea_035094";
 ...
 */
@Slf4j
public class Idea35094Service {
    private static final int IDEA_ID = 35094;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35094Service() {
        this(new Idea35094Config());
    }

    public Idea35094Service(Idea35094Config config) {
        this.config = config != null ? config : new Idea35094Config();
