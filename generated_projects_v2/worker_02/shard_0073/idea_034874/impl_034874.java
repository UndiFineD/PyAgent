...
@Data
public class Idea34874Config {
    private String name = "idea_034874";
 ...
 */
@Slf4j
public class Idea34874Service {
    private static final int IDEA_ID = 34874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34874Service() {
        this(new Idea34874Config());
    }

    public Idea34874Service(Idea34874Config config) {
        this.config = config != null ? config : new Idea34874Config();
