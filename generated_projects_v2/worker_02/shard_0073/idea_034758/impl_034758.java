...
@Data
public class Idea34758Config {
    private String name = "idea_034758";
 ...
 */
@Slf4j
public class Idea34758Service {
    private static final int IDEA_ID = 34758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34758Service() {
        this(new Idea34758Config());
    }

    public Idea34758Service(Idea34758Config config) {
        this.config = config != null ? config : new Idea34758Config();
