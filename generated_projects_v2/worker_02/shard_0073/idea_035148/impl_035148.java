...
@Data
public class Idea35148Config {
    private String name = "idea_035148";
 ...
 */
@Slf4j
public class Idea35148Service {
    private static final int IDEA_ID = 35148;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35148Service() {
        this(new Idea35148Config());
    }

    public Idea35148Service(Idea35148Config config) {
        this.config = config != null ? config : new Idea35148Config();
