...
@Data
public class Idea35091Config {
    private String name = "idea_035091";
 ...
 */
@Slf4j
public class Idea35091Service {
    private static final int IDEA_ID = 35091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35091Service() {
        this(new Idea35091Config());
    }

    public Idea35091Service(Idea35091Config config) {
        this.config = config != null ? config : new Idea35091Config();
