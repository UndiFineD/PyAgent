...
@Data
public class Idea34881Config {
    private String name = "idea_034881";
 ...
 */
@Slf4j
public class Idea34881Service {
    private static final int IDEA_ID = 34881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34881Service() {
        this(new Idea34881Config());
    }

    public Idea34881Service(Idea34881Config config) {
        this.config = config != null ? config : new Idea34881Config();
