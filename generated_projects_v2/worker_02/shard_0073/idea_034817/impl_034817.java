...
@Data
public class Idea34817Config {
    private String name = "idea_034817";
 ...
 */
@Slf4j
public class Idea34817Service {
    private static final int IDEA_ID = 34817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34817Service() {
        this(new Idea34817Config());
    }

    public Idea34817Service(Idea34817Config config) {
        this.config = config != null ? config : new Idea34817Config();
