...
@Data
public class Idea35137Config {
    private String name = "idea_035137";
 ...
 */
@Slf4j
public class Idea35137Service {
    private static final int IDEA_ID = 35137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35137Service() {
        this(new Idea35137Config());
    }

    public Idea35137Service(Idea35137Config config) {
        this.config = config != null ? config : new Idea35137Config();
