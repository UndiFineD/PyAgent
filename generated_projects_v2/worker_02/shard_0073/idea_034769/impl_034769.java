...
@Data
public class Idea34769Config {
    private String name = "idea_034769";
 ...
 */
@Slf4j
public class Idea34769Service {
    private static final int IDEA_ID = 34769;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34769Service() {
        this(new Idea34769Config());
    }

    public Idea34769Service(Idea34769Config config) {
        this.config = config != null ? config : new Idea34769Config();
