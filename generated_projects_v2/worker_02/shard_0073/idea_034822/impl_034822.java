...
@Data
public class Idea34822Config {
    private String name = "idea_034822";
 ...
 */
@Slf4j
public class Idea34822Service {
    private static final int IDEA_ID = 34822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34822Service() {
        this(new Idea34822Config());
    }

    public Idea34822Service(Idea34822Config config) {
        this.config = config != null ? config : new Idea34822Config();
