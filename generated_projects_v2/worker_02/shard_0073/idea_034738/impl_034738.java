...
@Data
public class Idea34738Config {
    private String name = "idea_034738";
 ...
 */
@Slf4j
public class Idea34738Service {
    private static final int IDEA_ID = 34738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34738Service() {
        this(new Idea34738Config());
    }

    public Idea34738Service(Idea34738Config config) {
        this.config = config != null ? config : new Idea34738Config();
