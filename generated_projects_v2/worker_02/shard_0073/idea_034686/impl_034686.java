...
@Data
public class Idea34686Config {
    private String name = "idea_034686";
 ...
 */
@Slf4j
public class Idea34686Service {
    private static final int IDEA_ID = 34686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34686Service() {
        this(new Idea34686Config());
    }

    public Idea34686Service(Idea34686Config config) {
        this.config = config != null ? config : new Idea34686Config();
