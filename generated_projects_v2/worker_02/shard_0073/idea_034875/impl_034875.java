...
@Data
public class Idea34875Config {
    private String name = "idea_034875";
 ...
 */
@Slf4j
public class Idea34875Service {
    private static final int IDEA_ID = 34875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34875Service() {
        this(new Idea34875Config());
    }

    public Idea34875Service(Idea34875Config config) {
        this.config = config != null ? config : new Idea34875Config();
