...
@Data
public class Idea34906Config {
    private String name = "idea_034906";
 ...
 */
@Slf4j
public class Idea34906Service {
    private static final int IDEA_ID = 34906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34906Service() {
        this(new Idea34906Config());
    }

    public Idea34906Service(Idea34906Config config) {
        this.config = config != null ? config : new Idea34906Config();
