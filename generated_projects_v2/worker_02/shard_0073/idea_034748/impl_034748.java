...
@Data
public class Idea34748Config {
    private String name = "idea_034748";
 ...
 */
@Slf4j
public class Idea34748Service {
    private static final int IDEA_ID = 34748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34748Service() {
        this(new Idea34748Config());
    }

    public Idea34748Service(Idea34748Config config) {
        this.config = config != null ? config : new Idea34748Config();
