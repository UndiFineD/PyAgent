...
@Data
public class Idea34912Config {
    private String name = "idea_034912";
 ...
 */
@Slf4j
public class Idea34912Service {
    private static final int IDEA_ID = 34912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34912Service() {
        this(new Idea34912Config());
    }

    public Idea34912Service(Idea34912Config config) {
        this.config = config != null ? config : new Idea34912Config();
