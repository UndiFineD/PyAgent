...
@Data
public class Idea34950Config {
    private String name = "idea_034950";
 ...
 */
@Slf4j
public class Idea34950Service {
    private static final int IDEA_ID = 34950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34950Service() {
        this(new Idea34950Config());
    }

    public Idea34950Service(Idea34950Config config) {
        this.config = config != null ? config : new Idea34950Config();
