...
@Data
public class Idea35043Config {
    private String name = "idea_035043";
 ...
 */
@Slf4j
public class Idea35043Service {
    private static final int IDEA_ID = 35043;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35043Service() {
        this(new Idea35043Config());
    }

    public Idea35043Service(Idea35043Config config) {
        this.config = config != null ? config : new Idea35043Config();
