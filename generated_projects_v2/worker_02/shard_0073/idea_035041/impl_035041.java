...
@Data
public class Idea35041Config {
    private String name = "idea_035041";
 ...
 */
@Slf4j
public class Idea35041Service {
    private static final int IDEA_ID = 35041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35041Service() {
        this(new Idea35041Config());
    }

    public Idea35041Service(Idea35041Config config) {
        this.config = config != null ? config : new Idea35041Config();
