...
@Data
public class Idea34945Config {
    private String name = "idea_034945";
 ...
 */
@Slf4j
public class Idea34945Service {
    private static final int IDEA_ID = 34945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34945Service() {
        this(new Idea34945Config());
    }

    public Idea34945Service(Idea34945Config config) {
        this.config = config != null ? config : new Idea34945Config();
