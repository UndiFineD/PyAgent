...
@Data
public class Idea35058Config {
    private String name = "idea_035058";
 ...
 */
@Slf4j
public class Idea35058Service {
    private static final int IDEA_ID = 35058;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35058Service() {
        this(new Idea35058Config());
    }

    public Idea35058Service(Idea35058Config config) {
        this.config = config != null ? config : new Idea35058Config();
