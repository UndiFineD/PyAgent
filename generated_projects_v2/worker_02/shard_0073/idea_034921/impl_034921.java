...
@Data
public class Idea34921Config {
    private String name = "idea_034921";
 ...
 */
@Slf4j
public class Idea34921Service {
    private static final int IDEA_ID = 34921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34921Service() {
        this(new Idea34921Config());
    }

    public Idea34921Service(Idea34921Config config) {
        this.config = config != null ? config : new Idea34921Config();
