...
@Data
public class Idea34891Config {
    private String name = "idea_034891";
 ...
 */
@Slf4j
public class Idea34891Service {
    private static final int IDEA_ID = 34891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34891Service() {
        this(new Idea34891Config());
    }

    public Idea34891Service(Idea34891Config config) {
        this.config = config != null ? config : new Idea34891Config();
