...
@Data
public class Idea34689Config {
    private String name = "idea_034689";
 ...
 */
@Slf4j
public class Idea34689Service {
    private static final int IDEA_ID = 34689;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34689Service() {
        this(new Idea34689Config());
    }

    public Idea34689Service(Idea34689Config config) {
        this.config = config != null ? config : new Idea34689Config();
