...
@Data
public class Idea34845Config {
    private String name = "idea_034845";
 ...
 */
@Slf4j
public class Idea34845Service {
    private static final int IDEA_ID = 34845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34845Service() {
        this(new Idea34845Config());
    }

    public Idea34845Service(Idea34845Config config) {
        this.config = config != null ? config : new Idea34845Config();
