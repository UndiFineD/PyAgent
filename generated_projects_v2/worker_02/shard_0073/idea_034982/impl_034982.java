...
@Data
public class Idea34982Config {
    private String name = "idea_034982";
 ...
 */
@Slf4j
public class Idea34982Service {
    private static final int IDEA_ID = 34982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34982Service() {
        this(new Idea34982Config());
    }

    public Idea34982Service(Idea34982Config config) {
        this.config = config != null ? config : new Idea34982Config();
