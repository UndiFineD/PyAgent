...
@Data
public class Idea34760Config {
    private String name = "idea_034760";
 ...
 */
@Slf4j
public class Idea34760Service {
    private static final int IDEA_ID = 34760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34760Service() {
        this(new Idea34760Config());
    }

    public Idea34760Service(Idea34760Config config) {
        this.config = config != null ? config : new Idea34760Config();
