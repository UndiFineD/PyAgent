...
@Data
public class Idea34805Config {
    private String name = "idea_034805";
 ...
 */
@Slf4j
public class Idea34805Service {
    private static final int IDEA_ID = 34805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34805Service() {
        this(new Idea34805Config());
    }

    public Idea34805Service(Idea34805Config config) {
        this.config = config != null ? config : new Idea34805Config();
