...
@Data
public class Idea34971Config {
    private String name = "idea_034971";
 ...
 */
@Slf4j
public class Idea34971Service {
    private static final int IDEA_ID = 34971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34971Service() {
        this(new Idea34971Config());
    }

    public Idea34971Service(Idea34971Config config) {
        this.config = config != null ? config : new Idea34971Config();
