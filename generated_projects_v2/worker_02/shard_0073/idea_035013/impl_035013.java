...
@Data
public class Idea35013Config {
    private String name = "idea_035013";
 ...
 */
@Slf4j
public class Idea35013Service {
    private static final int IDEA_ID = 35013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35013Service() {
        this(new Idea35013Config());
    }

    public Idea35013Service(Idea35013Config config) {
        this.config = config != null ? config : new Idea35013Config();
