...
@Data
public class Idea34938Config {
    private String name = "idea_034938";
 ...
 */
@Slf4j
public class Idea34938Service {
    private static final int IDEA_ID = 34938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34938Service() {
        this(new Idea34938Config());
    }

    public Idea34938Service(Idea34938Config config) {
        this.config = config != null ? config : new Idea34938Config();
