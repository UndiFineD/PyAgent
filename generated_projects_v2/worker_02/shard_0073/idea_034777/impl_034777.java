...
@Data
public class Idea34777Config {
    private String name = "idea_034777";
 ...
 */
@Slf4j
public class Idea34777Service {
    private static final int IDEA_ID = 34777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34777Service() {
        this(new Idea34777Config());
    }

    public Idea34777Service(Idea34777Config config) {
        this.config = config != null ? config : new Idea34777Config();
