...
@Data
public class Idea35034Config {
    private String name = "idea_035034";
 ...
 */
@Slf4j
public class Idea35034Service {
    private static final int IDEA_ID = 35034;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35034Service() {
        this(new Idea35034Config());
    }

    public Idea35034Service(Idea35034Config config) {
        this.config = config != null ? config : new Idea35034Config();
