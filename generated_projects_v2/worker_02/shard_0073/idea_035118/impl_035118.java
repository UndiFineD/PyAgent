...
@Data
public class Idea35118Config {
    private String name = "idea_035118";
 ...
 */
@Slf4j
public class Idea35118Service {
    private static final int IDEA_ID = 35118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35118Service() {
        this(new Idea35118Config());
    }

    public Idea35118Service(Idea35118Config config) {
        this.config = config != null ? config : new Idea35118Config();
