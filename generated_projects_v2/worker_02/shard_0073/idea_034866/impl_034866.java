...
@Data
public class Idea34866Config {
    private String name = "idea_034866";
 ...
 */
@Slf4j
public class Idea34866Service {
    private static final int IDEA_ID = 34866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34866Service() {
        this(new Idea34866Config());
    }

    public Idea34866Service(Idea34866Config config) {
        this.config = config != null ? config : new Idea34866Config();
