...
@Data
public class Idea35080Config {
    private String name = "idea_035080";
 ...
 */
@Slf4j
public class Idea35080Service {
    private static final int IDEA_ID = 35080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35080Service() {
        this(new Idea35080Config());
    }

    public Idea35080Service(Idea35080Config config) {
        this.config = config != null ? config : new Idea35080Config();
