...
@Data
public class Idea35144Config {
    private String name = "idea_035144";
 ...
 */
@Slf4j
public class Idea35144Service {
    private static final int IDEA_ID = 35144;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35144Service() {
        this(new Idea35144Config());
    }

    public Idea35144Service(Idea35144Config config) {
        this.config = config != null ? config : new Idea35144Config();
