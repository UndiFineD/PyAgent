...
@Data
public class Idea34884Config {
    private String name = "idea_034884";
 ...
 */
@Slf4j
public class Idea34884Service {
    private static final int IDEA_ID = 34884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34884Service() {
        this(new Idea34884Config());
    }

    public Idea34884Service(Idea34884Config config) {
        this.config = config != null ? config : new Idea34884Config();
