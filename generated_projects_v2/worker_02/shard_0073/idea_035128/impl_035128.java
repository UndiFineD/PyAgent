...
@Data
public class Idea35128Config {
    private String name = "idea_035128";
 ...
 */
@Slf4j
public class Idea35128Service {
    private static final int IDEA_ID = 35128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35128Service() {
        this(new Idea35128Config());
    }

    public Idea35128Service(Idea35128Config config) {
        this.config = config != null ? config : new Idea35128Config();
