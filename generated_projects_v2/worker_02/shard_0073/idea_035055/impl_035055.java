...
@Data
public class Idea35055Config {
    private String name = "idea_035055";
 ...
 */
@Slf4j
public class Idea35055Service {
    private static final int IDEA_ID = 35055;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35055Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35055Service() {
        this(new Idea35055Config());
    }

    public Idea35055Service(Idea35055Config config) {
        this.config = config != null ? config : new Idea35055Config();
