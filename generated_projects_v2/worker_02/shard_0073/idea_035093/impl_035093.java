...
@Data
public class Idea35093Config {
    private String name = "idea_035093";
 ...
 */
@Slf4j
public class Idea35093Service {
    private static final int IDEA_ID = 35093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35093Service() {
        this(new Idea35093Config());
    }

    public Idea35093Service(Idea35093Config config) {
        this.config = config != null ? config : new Idea35093Config();
