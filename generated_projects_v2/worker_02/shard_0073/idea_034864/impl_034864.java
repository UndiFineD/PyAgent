...
@Data
public class Idea34864Config {
    private String name = "idea_034864";
 ...
 */
@Slf4j
public class Idea34864Service {
    private static final int IDEA_ID = 34864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34864Service() {
        this(new Idea34864Config());
    }

    public Idea34864Service(Idea34864Config config) {
        this.config = config != null ? config : new Idea34864Config();
