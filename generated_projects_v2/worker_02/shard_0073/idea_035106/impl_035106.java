...
@Data
public class Idea35106Config {
    private String name = "idea_035106";
 ...
 */
@Slf4j
public class Idea35106Service {
    private static final int IDEA_ID = 35106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35106Service() {
        this(new Idea35106Config());
    }

    public Idea35106Service(Idea35106Config config) {
        this.config = config != null ? config : new Idea35106Config();
