...
@Data
public class Idea34676Config {
    private String name = "idea_034676";
 ...
 */
@Slf4j
public class Idea34676Service {
    private static final int IDEA_ID = 34676;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34676Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34676Service() {
        this(new Idea34676Config());
    }

    public Idea34676Service(Idea34676Config config) {
        this.config = config != null ? config : new Idea34676Config();
