...
@Data
public class Idea34721Config {
    private String name = "idea_034721";
 ...
 */
@Slf4j
public class Idea34721Service {
    private static final int IDEA_ID = 34721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34721Service() {
        this(new Idea34721Config());
    }

    public Idea34721Service(Idea34721Config config) {
        this.config = config != null ? config : new Idea34721Config();
