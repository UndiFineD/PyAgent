...
@Data
public class Idea34705Config {
    private String name = "idea_034705";
 ...
 */
@Slf4j
public class Idea34705Service {
    private static final int IDEA_ID = 34705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34705Service() {
        this(new Idea34705Config());
    }

    public Idea34705Service(Idea34705Config config) {
        this.config = config != null ? config : new Idea34705Config();
