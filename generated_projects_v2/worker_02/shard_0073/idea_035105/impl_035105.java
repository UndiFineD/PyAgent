...
@Data
public class Idea35105Config {
    private String name = "idea_035105";
 ...
 */
@Slf4j
public class Idea35105Service {
    private static final int IDEA_ID = 35105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35105Service() {
        this(new Idea35105Config());
    }

    public Idea35105Service(Idea35105Config config) {
        this.config = config != null ? config : new Idea35105Config();
