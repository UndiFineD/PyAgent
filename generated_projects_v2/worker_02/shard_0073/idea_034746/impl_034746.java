...
@Data
public class Idea34746Config {
    private String name = "idea_034746";
 ...
 */
@Slf4j
public class Idea34746Service {
    private static final int IDEA_ID = 34746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34746Service() {
        this(new Idea34746Config());
    }

    public Idea34746Service(Idea34746Config config) {
        this.config = config != null ? config : new Idea34746Config();
