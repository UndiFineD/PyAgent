...
@Data
public class Idea35123Config {
    private String name = "idea_035123";
 ...
 */
@Slf4j
public class Idea35123Service {
    private static final int IDEA_ID = 35123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35123Service() {
        this(new Idea35123Config());
    }

    public Idea35123Service(Idea35123Config config) {
        this.config = config != null ? config : new Idea35123Config();
