...
@Data
public class Idea34725Config {
    private String name = "idea_034725";
 ...
 */
@Slf4j
public class Idea34725Service {
    private static final int IDEA_ID = 34725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34725Service() {
        this(new Idea34725Config());
    }

    public Idea34725Service(Idea34725Config config) {
        this.config = config != null ? config : new Idea34725Config();
