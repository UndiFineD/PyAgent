...
@Data
public class Idea34713Config {
    private String name = "idea_034713";
 ...
 */
@Slf4j
public class Idea34713Service {
    private static final int IDEA_ID = 34713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34713Service() {
        this(new Idea34713Config());
    }

    public Idea34713Service(Idea34713Config config) {
        this.config = config != null ? config : new Idea34713Config();
