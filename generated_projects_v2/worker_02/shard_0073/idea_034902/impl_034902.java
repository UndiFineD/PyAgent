...
@Data
public class Idea34902Config {
    private String name = "idea_034902";
 ...
 */
@Slf4j
public class Idea34902Service {
    private static final int IDEA_ID = 34902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34902Service() {
        this(new Idea34902Config());
    }

    public Idea34902Service(Idea34902Config config) {
        this.config = config != null ? config : new Idea34902Config();
