...
@Data
public class Idea34905Config {
    private String name = "idea_034905";
 ...
 */
@Slf4j
public class Idea34905Service {
    private static final int IDEA_ID = 34905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34905Service() {
        this(new Idea34905Config());
    }

    public Idea34905Service(Idea34905Config config) {
        this.config = config != null ? config : new Idea34905Config();
