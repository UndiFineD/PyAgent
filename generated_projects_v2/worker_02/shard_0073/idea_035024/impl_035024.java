...
@Data
public class Idea35024Config {
    private String name = "idea_035024";
 ...
 */
@Slf4j
public class Idea35024Service {
    private static final int IDEA_ID = 35024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35024Service() {
        this(new Idea35024Config());
    }

    public Idea35024Service(Idea35024Config config) {
        this.config = config != null ? config : new Idea35024Config();
