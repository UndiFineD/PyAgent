...
@Data
public class Idea34770Config {
    private String name = "idea_034770";
 ...
 */
@Slf4j
public class Idea34770Service {
    private static final int IDEA_ID = 34770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34770Service() {
        this(new Idea34770Config());
    }

    public Idea34770Service(Idea34770Config config) {
        this.config = config != null ? config : new Idea34770Config();
