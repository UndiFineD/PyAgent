...
@Data
public class Idea35132Config {
    private String name = "idea_035132";
 ...
 */
@Slf4j
public class Idea35132Service {
    private static final int IDEA_ID = 35132;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35132Service() {
        this(new Idea35132Config());
    }

    public Idea35132Service(Idea35132Config config) {
        this.config = config != null ? config : new Idea35132Config();
