...
@Data
public class Idea34847Config {
    private String name = "idea_034847";
 ...
 */
@Slf4j
public class Idea34847Service {
    private static final int IDEA_ID = 34847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34847Service() {
        this(new Idea34847Config());
    }

    public Idea34847Service(Idea34847Config config) {
        this.config = config != null ? config : new Idea34847Config();
