...
@Data
public class Idea35136Config {
    private String name = "idea_035136";
 ...
 */
@Slf4j
public class Idea35136Service {
    private static final int IDEA_ID = 35136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35136Service() {
        this(new Idea35136Config());
    }

    public Idea35136Service(Idea35136Config config) {
        this.config = config != null ? config : new Idea35136Config();
