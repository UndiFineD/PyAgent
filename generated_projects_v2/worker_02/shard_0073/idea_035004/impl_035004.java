...
@Data
public class Idea35004Config {
    private String name = "idea_035004";
 ...
 */
@Slf4j
public class Idea35004Service {
    private static final int IDEA_ID = 35004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35004Service() {
        this(new Idea35004Config());
    }

    public Idea35004Service(Idea35004Config config) {
        this.config = config != null ? config : new Idea35004Config();
