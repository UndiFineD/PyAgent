...
@Data
public class Idea34678Config {
    private String name = "idea_034678";
 ...
 */
@Slf4j
public class Idea34678Service {
    private static final int IDEA_ID = 34678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34678Service() {
        this(new Idea34678Config());
    }

    public Idea34678Service(Idea34678Config config) {
        this.config = config != null ? config : new Idea34678Config();
