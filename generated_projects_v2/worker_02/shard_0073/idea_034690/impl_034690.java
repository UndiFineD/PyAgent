...
@Data
public class Idea34690Config {
    private String name = "idea_034690";
 ...
 */
@Slf4j
public class Idea34690Service {
    private static final int IDEA_ID = 34690;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34690Service() {
        this(new Idea34690Config());
    }

    public Idea34690Service(Idea34690Config config) {
        this.config = config != null ? config : new Idea34690Config();
