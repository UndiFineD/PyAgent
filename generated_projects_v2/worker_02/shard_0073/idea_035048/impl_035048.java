...
@Data
public class Idea35048Config {
    private String name = "idea_035048";
 ...
 */
@Slf4j
public class Idea35048Service {
    private static final int IDEA_ID = 35048;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35048Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35048Service() {
        this(new Idea35048Config());
    }

    public Idea35048Service(Idea35048Config config) {
        this.config = config != null ? config : new Idea35048Config();
