...
@Data
public class Idea34718Config {
    private String name = "idea_034718";
 ...
 */
@Slf4j
public class Idea34718Service {
    private static final int IDEA_ID = 34718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34718Service() {
        this(new Idea34718Config());
    }

    public Idea34718Service(Idea34718Config config) {
        this.config = config != null ? config : new Idea34718Config();
