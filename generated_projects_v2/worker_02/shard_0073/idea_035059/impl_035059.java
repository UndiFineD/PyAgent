...
@Data
public class Idea35059Config {
    private String name = "idea_035059";
 ...
 */
@Slf4j
public class Idea35059Service {
    private static final int IDEA_ID = 35059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35059Service() {
        this(new Idea35059Config());
    }

    public Idea35059Service(Idea35059Config config) {
        this.config = config != null ? config : new Idea35059Config();
