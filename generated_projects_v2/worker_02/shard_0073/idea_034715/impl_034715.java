...
@Data
public class Idea34715Config {
    private String name = "idea_034715";
 ...
 */
@Slf4j
public class Idea34715Service {
    private static final int IDEA_ID = 34715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34715Service() {
        this(new Idea34715Config());
    }

    public Idea34715Service(Idea34715Config config) {
        this.config = config != null ? config : new Idea34715Config();
