...
@Data
public class Idea34797Config {
    private String name = "idea_034797";
 ...
 */
@Slf4j
public class Idea34797Service {
    private static final int IDEA_ID = 34797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34797Service() {
        this(new Idea34797Config());
    }

    public Idea34797Service(Idea34797Config config) {
        this.config = config != null ? config : new Idea34797Config();
