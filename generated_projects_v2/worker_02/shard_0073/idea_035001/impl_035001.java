...
@Data
public class Idea35001Config {
    private String name = "idea_035001";
 ...
 */
@Slf4j
public class Idea35001Service {
    private static final int IDEA_ID = 35001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35001Service() {
        this(new Idea35001Config());
    }

    public Idea35001Service(Idea35001Config config) {
        this.config = config != null ? config : new Idea35001Config();
