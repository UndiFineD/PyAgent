...
@Data
public class Idea34727Config {
    private String name = "idea_034727";
 ...
 */
@Slf4j
public class Idea34727Service {
    private static final int IDEA_ID = 34727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34727Service() {
        this(new Idea34727Config());
    }

    public Idea34727Service(Idea34727Config config) {
        this.config = config != null ? config : new Idea34727Config();
