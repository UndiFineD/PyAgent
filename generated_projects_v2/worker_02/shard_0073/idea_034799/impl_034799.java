...
@Data
public class Idea34799Config {
    private String name = "idea_034799";
 ...
 */
@Slf4j
public class Idea34799Service {
    private static final int IDEA_ID = 34799;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34799Service() {
        this(new Idea34799Config());
    }

    public Idea34799Service(Idea34799Config config) {
        this.config = config != null ? config : new Idea34799Config();
