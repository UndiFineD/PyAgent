...
@Data
public class Idea35103Config {
    private String name = "idea_035103";
 ...
 */
@Slf4j
public class Idea35103Service {
    private static final int IDEA_ID = 35103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35103Service() {
        this(new Idea35103Config());
    }

    public Idea35103Service(Idea35103Config config) {
        this.config = config != null ? config : new Idea35103Config();
