...
@Data
public class Idea34965Config {
    private String name = "idea_034965";
 ...
 */
@Slf4j
public class Idea34965Service {
    private static final int IDEA_ID = 34965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34965Service() {
        this(new Idea34965Config());
    }

    public Idea34965Service(Idea34965Config config) {
        this.config = config != null ? config : new Idea34965Config();
