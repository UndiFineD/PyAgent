...
@Data
public class Idea34981Config {
    private String name = "idea_034981";
 ...
 */
@Slf4j
public class Idea34981Service {
    private static final int IDEA_ID = 34981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34981Service() {
        this(new Idea34981Config());
    }

    public Idea34981Service(Idea34981Config config) {
        this.config = config != null ? config : new Idea34981Config();
