...
@Data
public class Idea34767Config {
    private String name = "idea_034767";
 ...
 */
@Slf4j
public class Idea34767Service {
    private static final int IDEA_ID = 34767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34767Service() {
        this(new Idea34767Config());
    }

    public Idea34767Service(Idea34767Config config) {
        this.config = config != null ? config : new Idea34767Config();
