...
@Data
public class Idea34947Config {
    private String name = "idea_034947";
 ...
 */
@Slf4j
public class Idea34947Service {
    private static final int IDEA_ID = 34947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34947Service() {
        this(new Idea34947Config());
    }

    public Idea34947Service(Idea34947Config config) {
        this.config = config != null ? config : new Idea34947Config();
