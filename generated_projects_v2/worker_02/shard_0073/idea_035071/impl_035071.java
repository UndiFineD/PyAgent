...
@Data
public class Idea35071Config {
    private String name = "idea_035071";
 ...
 */
@Slf4j
public class Idea35071Service {
    private static final int IDEA_ID = 35071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35071Service() {
        this(new Idea35071Config());
    }

    public Idea35071Service(Idea35071Config config) {
        this.config = config != null ? config : new Idea35071Config();
