...
@Data
public class Idea34916Config {
    private String name = "idea_034916";
 ...
 */
@Slf4j
public class Idea34916Service {
    private static final int IDEA_ID = 34916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34916Service() {
        this(new Idea34916Config());
    }

    public Idea34916Service(Idea34916Config config) {
        this.config = config != null ? config : new Idea34916Config();
