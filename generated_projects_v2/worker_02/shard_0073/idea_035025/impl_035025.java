...
@Data
public class Idea35025Config {
    private String name = "idea_035025";
 ...
 */
@Slf4j
public class Idea35025Service {
    private static final int IDEA_ID = 35025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35025Service() {
        this(new Idea35025Config());
    }

    public Idea35025Service(Idea35025Config config) {
        this.config = config != null ? config : new Idea35025Config();
