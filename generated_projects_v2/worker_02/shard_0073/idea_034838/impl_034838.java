...
@Data
public class Idea34838Config {
    private String name = "idea_034838";
 ...
 */
@Slf4j
public class Idea34838Service {
    private static final int IDEA_ID = 34838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34838Service() {
        this(new Idea34838Config());
    }

    public Idea34838Service(Idea34838Config config) {
        this.config = config != null ? config : new Idea34838Config();
