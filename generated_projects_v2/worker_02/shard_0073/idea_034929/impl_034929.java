...
@Data
public class Idea34929Config {
    private String name = "idea_034929";
 ...
 */
@Slf4j
public class Idea34929Service {
    private static final int IDEA_ID = 34929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34929Service() {
        this(new Idea34929Config());
    }

    public Idea34929Service(Idea34929Config config) {
        this.config = config != null ? config : new Idea34929Config();
