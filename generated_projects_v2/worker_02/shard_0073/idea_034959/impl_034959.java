...
@Data
public class Idea34959Config {
    private String name = "idea_034959";
 ...
 */
@Slf4j
public class Idea34959Service {
    private static final int IDEA_ID = 34959;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34959Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34959Service() {
        this(new Idea34959Config());
    }

    public Idea34959Service(Idea34959Config config) {
        this.config = config != null ? config : new Idea34959Config();
