...
@Data
public class Idea35028Config {
    private String name = "idea_035028";
 ...
 */
@Slf4j
public class Idea35028Service {
    private static final int IDEA_ID = 35028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35028Service() {
        this(new Idea35028Config());
    }

    public Idea35028Service(Idea35028Config config) {
        this.config = config != null ? config : new Idea35028Config();
