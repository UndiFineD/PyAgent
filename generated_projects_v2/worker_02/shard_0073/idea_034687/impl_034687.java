...
@Data
public class Idea34687Config {
    private String name = "idea_034687";
 ...
 */
@Slf4j
public class Idea34687Service {
    private static final int IDEA_ID = 34687;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34687Service() {
        this(new Idea34687Config());
    }

    public Idea34687Service(Idea34687Config config) {
        this.config = config != null ? config : new Idea34687Config();
