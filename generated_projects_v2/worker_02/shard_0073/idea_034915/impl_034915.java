...
@Data
public class Idea34915Config {
    private String name = "idea_034915";
 ...
 */
@Slf4j
public class Idea34915Service {
    private static final int IDEA_ID = 34915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34915Service() {
        this(new Idea34915Config());
    }

    public Idea34915Service(Idea34915Config config) {
        this.config = config != null ? config : new Idea34915Config();
