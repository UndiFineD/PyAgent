...
@Data
public class Idea34790Config {
    private String name = "idea_034790";
 ...
 */
@Slf4j
public class Idea34790Service {
    private static final int IDEA_ID = 34790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34790Service() {
        this(new Idea34790Config());
    }

    public Idea34790Service(Idea34790Config config) {
        this.config = config != null ? config : new Idea34790Config();
