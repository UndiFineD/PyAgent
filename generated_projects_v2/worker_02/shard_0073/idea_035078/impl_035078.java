...
@Data
public class Idea35078Config {
    private String name = "idea_035078";
 ...
 */
@Slf4j
public class Idea35078Service {
    private static final int IDEA_ID = 35078;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35078Service() {
        this(new Idea35078Config());
    }

    public Idea35078Service(Idea35078Config config) {
        this.config = config != null ? config : new Idea35078Config();
