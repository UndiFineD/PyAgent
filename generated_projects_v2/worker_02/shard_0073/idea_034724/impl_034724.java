...
@Data
public class Idea34724Config {
    private String name = "idea_034724";
 ...
 */
@Slf4j
public class Idea34724Service {
    private static final int IDEA_ID = 34724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34724Service() {
        this(new Idea34724Config());
    }

    public Idea34724Service(Idea34724Config config) {
        this.config = config != null ? config : new Idea34724Config();
