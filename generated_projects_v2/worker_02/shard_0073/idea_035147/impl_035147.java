...
@Data
public class Idea35147Config {
    private String name = "idea_035147";
 ...
 */
@Slf4j
public class Idea35147Service {
    private static final int IDEA_ID = 35147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35147Service() {
        this(new Idea35147Config());
    }

    public Idea35147Service(Idea35147Config config) {
        this.config = config != null ? config : new Idea35147Config();
