...
@Data
public class Idea34940Config {
    private String name = "idea_034940";
 ...
 */
@Slf4j
public class Idea34940Service {
    private static final int IDEA_ID = 34940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34940Service() {
        this(new Idea34940Config());
    }

    public Idea34940Service(Idea34940Config config) {
        this.config = config != null ? config : new Idea34940Config();
