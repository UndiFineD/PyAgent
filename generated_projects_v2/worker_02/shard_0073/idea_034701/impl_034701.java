...
@Data
public class Idea34701Config {
    private String name = "idea_034701";
 ...
 */
@Slf4j
public class Idea34701Service {
    private static final int IDEA_ID = 34701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34701Service() {
        this(new Idea34701Config());
    }

    public Idea34701Service(Idea34701Config config) {
        this.config = config != null ? config : new Idea34701Config();
