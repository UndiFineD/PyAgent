...
@Data
public class Idea34963Config {
    private String name = "idea_034963";
 ...
 */
@Slf4j
public class Idea34963Service {
    private static final int IDEA_ID = 34963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34963Service() {
        this(new Idea34963Config());
    }

    public Idea34963Service(Idea34963Config config) {
        this.config = config != null ? config : new Idea34963Config();
