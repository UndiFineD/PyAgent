...
@Data
public class Idea34706Config {
    private String name = "idea_034706";
 ...
 */
@Slf4j
public class Idea34706Service {
    private static final int IDEA_ID = 34706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34706Service() {
        this(new Idea34706Config());
    }

    public Idea34706Service(Idea34706Config config) {
        this.config = config != null ? config : new Idea34706Config();
