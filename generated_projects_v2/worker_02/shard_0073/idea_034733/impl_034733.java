...
@Data
public class Idea34733Config {
    private String name = "idea_034733";
 ...
 */
@Slf4j
public class Idea34733Service {
    private static final int IDEA_ID = 34733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34733Service() {
        this(new Idea34733Config());
    }

    public Idea34733Service(Idea34733Config config) {
        this.config = config != null ? config : new Idea34733Config();
