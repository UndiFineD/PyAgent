...
@Data
public class Idea35033Config {
    private String name = "idea_035033";
 ...
 */
@Slf4j
public class Idea35033Service {
    private static final int IDEA_ID = 35033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35033Service() {
        this(new Idea35033Config());
    }

    public Idea35033Service(Idea35033Config config) {
        this.config = config != null ? config : new Idea35033Config();
