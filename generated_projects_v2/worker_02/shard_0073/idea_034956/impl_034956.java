...
@Data
public class Idea34956Config {
    private String name = "idea_034956";
 ...
 */
@Slf4j
public class Idea34956Service {
    private static final int IDEA_ID = 34956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34956Service() {
        this(new Idea34956Config());
    }

    public Idea34956Service(Idea34956Config config) {
        this.config = config != null ? config : new Idea34956Config();
