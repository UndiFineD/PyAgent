...
@Data
public class Idea34900Config {
    private String name = "idea_034900";
 ...
 */
@Slf4j
public class Idea34900Service {
    private static final int IDEA_ID = 34900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34900Service() {
        this(new Idea34900Config());
    }

    public Idea34900Service(Idea34900Config config) {
        this.config = config != null ? config : new Idea34900Config();
