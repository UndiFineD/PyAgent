...
@Data
public class Idea34976Config {
    private String name = "idea_034976";
 ...
 */
@Slf4j
public class Idea34976Service {
    private static final int IDEA_ID = 34976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34976Service() {
        this(new Idea34976Config());
    }

    public Idea34976Service(Idea34976Config config) {
        this.config = config != null ? config : new Idea34976Config();
