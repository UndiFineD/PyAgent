...
@Data
public class Idea35027Config {
    private String name = "idea_035027";
 ...
 */
@Slf4j
public class Idea35027Service {
    private static final int IDEA_ID = 35027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35027Service() {
        this(new Idea35027Config());
    }

    public Idea35027Service(Idea35027Config config) {
        this.config = config != null ? config : new Idea35027Config();
