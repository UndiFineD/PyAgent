...
@Data
public class Idea35064Config {
    private String name = "idea_035064";
 ...
 */
@Slf4j
public class Idea35064Service {
    private static final int IDEA_ID = 35064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35064Service() {
        this(new Idea35064Config());
    }

    public Idea35064Service(Idea35064Config config) {
        this.config = config != null ? config : new Idea35064Config();
