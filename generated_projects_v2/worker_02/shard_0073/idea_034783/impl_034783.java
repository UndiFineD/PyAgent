...
@Data
public class Idea34783Config {
    private String name = "idea_034783";
 ...
 */
@Slf4j
public class Idea34783Service {
    private static final int IDEA_ID = 34783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34783Service() {
        this(new Idea34783Config());
    }

    public Idea34783Service(Idea34783Config config) {
        this.config = config != null ? config : new Idea34783Config();
