...
@Data
public class Idea35121Config {
    private String name = "idea_035121";
 ...
 */
@Slf4j
public class Idea35121Service {
    private static final int IDEA_ID = 35121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35121Service() {
        this(new Idea35121Config());
    }

    public Idea35121Service(Idea35121Config config) {
        this.config = config != null ? config : new Idea35121Config();
