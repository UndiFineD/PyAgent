...
@Data
public class Idea34861Config {
    private String name = "idea_034861";
 ...
 */
@Slf4j
public class Idea34861Service {
    private static final int IDEA_ID = 34861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34861Service() {
        this(new Idea34861Config());
    }

    public Idea34861Service(Idea34861Config config) {
        this.config = config != null ? config : new Idea34861Config();
