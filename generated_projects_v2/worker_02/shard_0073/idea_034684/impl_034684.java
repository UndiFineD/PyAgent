...
@Data
public class Idea34684Config {
    private String name = "idea_034684";
 ...
 */
@Slf4j
public class Idea34684Service {
    private static final int IDEA_ID = 34684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34684Service() {
        this(new Idea34684Config());
    }

    public Idea34684Service(Idea34684Config config) {
        this.config = config != null ? config : new Idea34684Config();
