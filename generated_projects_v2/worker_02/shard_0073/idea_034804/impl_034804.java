...
@Data
public class Idea34804Config {
    private String name = "idea_034804";
 ...
 */
@Slf4j
public class Idea34804Service {
    private static final int IDEA_ID = 34804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34804Service() {
        this(new Idea34804Config());
    }

    public Idea34804Service(Idea34804Config config) {
        this.config = config != null ? config : new Idea34804Config();
