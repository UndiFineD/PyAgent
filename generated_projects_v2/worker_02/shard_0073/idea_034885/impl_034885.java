...
@Data
public class Idea34885Config {
    private String name = "idea_034885";
 ...
 */
@Slf4j
public class Idea34885Service {
    private static final int IDEA_ID = 34885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34885Service() {
        this(new Idea34885Config());
    }

    public Idea34885Service(Idea34885Config config) {
        this.config = config != null ? config : new Idea34885Config();
