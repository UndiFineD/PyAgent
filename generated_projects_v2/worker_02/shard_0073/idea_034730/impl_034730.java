...
@Data
public class Idea34730Config {
    private String name = "idea_034730";
 ...
 */
@Slf4j
public class Idea34730Service {
    private static final int IDEA_ID = 34730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34730Service() {
        this(new Idea34730Config());
    }

    public Idea34730Service(Idea34730Config config) {
        this.config = config != null ? config : new Idea34730Config();
