...
@Data
public class Idea34867Config {
    private String name = "idea_034867";
 ...
 */
@Slf4j
public class Idea34867Service {
    private static final int IDEA_ID = 34867;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34867Service() {
        this(new Idea34867Config());
    }

    public Idea34867Service(Idea34867Config config) {
        this.config = config != null ? config : new Idea34867Config();
