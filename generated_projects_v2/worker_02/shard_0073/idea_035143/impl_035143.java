...
@Data
public class Idea35143Config {
    private String name = "idea_035143";
 ...
 */
@Slf4j
public class Idea35143Service {
    private static final int IDEA_ID = 35143;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35143Service() {
        this(new Idea35143Config());
    }

    public Idea35143Service(Idea35143Config config) {
        this.config = config != null ? config : new Idea35143Config();
