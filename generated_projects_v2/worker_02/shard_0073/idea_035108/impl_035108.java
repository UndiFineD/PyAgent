...
@Data
public class Idea35108Config {
    private String name = "idea_035108";
 ...
 */
@Slf4j
public class Idea35108Service {
    private static final int IDEA_ID = 35108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35108Service() {
        this(new Idea35108Config());
    }

    public Idea35108Service(Idea35108Config config) {
        this.config = config != null ? config : new Idea35108Config();
