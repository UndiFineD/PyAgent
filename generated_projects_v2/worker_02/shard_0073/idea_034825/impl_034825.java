...
@Data
public class Idea34825Config {
    private String name = "idea_034825";
 ...
 */
@Slf4j
public class Idea34825Service {
    private static final int IDEA_ID = 34825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34825Service() {
        this(new Idea34825Config());
    }

    public Idea34825Service(Idea34825Config config) {
        this.config = config != null ? config : new Idea34825Config();
