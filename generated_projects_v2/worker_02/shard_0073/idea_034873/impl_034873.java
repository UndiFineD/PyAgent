...
@Data
public class Idea34873Config {
    private String name = "idea_034873";
 ...
 */
@Slf4j
public class Idea34873Service {
    private static final int IDEA_ID = 34873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34873Service() {
        this(new Idea34873Config());
    }

    public Idea34873Service(Idea34873Config config) {
        this.config = config != null ? config : new Idea34873Config();
