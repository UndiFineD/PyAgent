...
@Data
public class Idea34744Config {
    private String name = "idea_034744";
 ...
 */
@Slf4j
public class Idea34744Service {
    private static final int IDEA_ID = 34744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34744Service() {
        this(new Idea34744Config());
    }

    public Idea34744Service(Idea34744Config config) {
        this.config = config != null ? config : new Idea34744Config();
