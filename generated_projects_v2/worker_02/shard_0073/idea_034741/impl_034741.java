...
@Data
public class Idea34741Config {
    private String name = "idea_034741";
 ...
 */
@Slf4j
public class Idea34741Service {
    private static final int IDEA_ID = 34741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34741Service() {
        this(new Idea34741Config());
    }

    public Idea34741Service(Idea34741Config config) {
        this.config = config != null ? config : new Idea34741Config();
