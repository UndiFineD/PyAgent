...
@Data
public class Idea34977Config {
    private String name = "idea_034977";
 ...
 */
@Slf4j
public class Idea34977Service {
    private static final int IDEA_ID = 34977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34977Service() {
        this(new Idea34977Config());
    }

    public Idea34977Service(Idea34977Config config) {
        this.config = config != null ? config : new Idea34977Config();
