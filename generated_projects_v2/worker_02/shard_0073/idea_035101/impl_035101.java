...
@Data
public class Idea35101Config {
    private String name = "idea_035101";
 ...
 */
@Slf4j
public class Idea35101Service {
    private static final int IDEA_ID = 35101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35101Service() {
        this(new Idea35101Config());
    }

    public Idea35101Service(Idea35101Config config) {
        this.config = config != null ? config : new Idea35101Config();
