...
@Data
public class Idea35052Config {
    private String name = "idea_035052";
 ...
 */
@Slf4j
public class Idea35052Service {
    private static final int IDEA_ID = 35052;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35052Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35052Service() {
        this(new Idea35052Config());
    }

    public Idea35052Service(Idea35052Config config) {
        this.config = config != null ? config : new Idea35052Config();
