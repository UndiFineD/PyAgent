...
@Data
public class Idea34928Config {
    private String name = "idea_034928";
 ...
 */
@Slf4j
public class Idea34928Service {
    private static final int IDEA_ID = 34928;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34928Service() {
        this(new Idea34928Config());
    }

    public Idea34928Service(Idea34928Config config) {
        this.config = config != null ? config : new Idea34928Config();
