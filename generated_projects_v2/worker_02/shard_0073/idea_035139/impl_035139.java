...
@Data
public class Idea35139Config {
    private String name = "idea_035139";
 ...
 */
@Slf4j
public class Idea35139Service {
    private static final int IDEA_ID = 35139;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35139Service() {
        this(new Idea35139Config());
    }

    public Idea35139Service(Idea35139Config config) {
        this.config = config != null ? config : new Idea35139Config();
