...
@Data
public class Idea34685Config {
    private String name = "idea_034685";
 ...
 */
@Slf4j
public class Idea34685Service {
    private static final int IDEA_ID = 34685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34685Service() {
        this(new Idea34685Config());
    }

    public Idea34685Service(Idea34685Config config) {
        this.config = config != null ? config : new Idea34685Config();
