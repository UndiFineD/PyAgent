...
@Data
public class Idea35120Config {
    private String name = "idea_035120";
 ...
 */
@Slf4j
public class Idea35120Service {
    private static final int IDEA_ID = 35120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35120Service() {
        this(new Idea35120Config());
    }

    public Idea35120Service(Idea35120Config config) {
        this.config = config != null ? config : new Idea35120Config();
