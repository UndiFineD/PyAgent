...
@Data
public class Idea34780Config {
    private String name = "idea_034780";
 ...
 */
@Slf4j
public class Idea34780Service {
    private static final int IDEA_ID = 34780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34780Service() {
        this(new Idea34780Config());
    }

    public Idea34780Service(Idea34780Config config) {
        this.config = config != null ? config : new Idea34780Config();
