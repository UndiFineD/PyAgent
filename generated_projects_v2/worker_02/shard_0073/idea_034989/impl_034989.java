...
@Data
public class Idea34989Config {
    private String name = "idea_034989";
 ...
 */
@Slf4j
public class Idea34989Service {
    private static final int IDEA_ID = 34989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34989Service() {
        this(new Idea34989Config());
    }

    public Idea34989Service(Idea34989Config config) {
        this.config = config != null ? config : new Idea34989Config();
