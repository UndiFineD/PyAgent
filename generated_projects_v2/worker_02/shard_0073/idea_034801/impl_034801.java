...
@Data
public class Idea34801Config {
    private String name = "idea_034801";
 ...
 */
@Slf4j
public class Idea34801Service {
    private static final int IDEA_ID = 34801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34801Service() {
        this(new Idea34801Config());
    }

    public Idea34801Service(Idea34801Config config) {
        this.config = config != null ? config : new Idea34801Config();
