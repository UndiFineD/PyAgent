...
@Data
public class Idea34958Config {
    private String name = "idea_034958";
 ...
 */
@Slf4j
public class Idea34958Service {
    private static final int IDEA_ID = 34958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34958Service() {
        this(new Idea34958Config());
    }

    public Idea34958Service(Idea34958Config config) {
        this.config = config != null ? config : new Idea34958Config();
