...
@Data
public class Idea34869Config {
    private String name = "idea_034869";
 ...
 */
@Slf4j
public class Idea34869Service {
    private static final int IDEA_ID = 34869;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34869Service() {
        this(new Idea34869Config());
    }

    public Idea34869Service(Idea34869Config config) {
        this.config = config != null ? config : new Idea34869Config();
