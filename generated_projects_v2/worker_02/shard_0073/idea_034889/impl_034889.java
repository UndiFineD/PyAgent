...
@Data
public class Idea34889Config {
    private String name = "idea_034889";
 ...
 */
@Slf4j
public class Idea34889Service {
    private static final int IDEA_ID = 34889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34889Service() {
        this(new Idea34889Config());
    }

    public Idea34889Service(Idea34889Config config) {
        this.config = config != null ? config : new Idea34889Config();
