...
@Data
public class Idea34996Config {
    private String name = "idea_034996";
 ...
 */
@Slf4j
public class Idea34996Service {
    private static final int IDEA_ID = 34996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34996Service() {
        this(new Idea34996Config());
    }

    public Idea34996Service(Idea34996Config config) {
        this.config = config != null ? config : new Idea34996Config();
