...
@Data
public class Idea34731Config {
    private String name = "idea_034731";
 ...
 */
@Slf4j
public class Idea34731Service {
    private static final int IDEA_ID = 34731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34731Service() {
        this(new Idea34731Config());
    }

    public Idea34731Service(Idea34731Config config) {
        this.config = config != null ? config : new Idea34731Config();
