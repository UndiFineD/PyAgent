...
@Data
public class Idea34821Config {
    private String name = "idea_034821";
 ...
 */
@Slf4j
public class Idea34821Service {
    private static final int IDEA_ID = 34821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34821Service() {
        this(new Idea34821Config());
    }

    public Idea34821Service(Idea34821Config config) {
        this.config = config != null ? config : new Idea34821Config();
