...
@Data
public class Idea35018Config {
    private String name = "idea_035018";
 ...
 */
@Slf4j
public class Idea35018Service {
    private static final int IDEA_ID = 35018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35018Service() {
        this(new Idea35018Config());
    }

    public Idea35018Service(Idea35018Config config) {
        this.config = config != null ? config : new Idea35018Config();
