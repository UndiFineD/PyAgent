...
@Data
public class Idea35042Config {
    private String name = "idea_035042";
 ...
 */
@Slf4j
public class Idea35042Service {
    private static final int IDEA_ID = 35042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35042Service() {
        this(new Idea35042Config());
    }

    public Idea35042Service(Idea35042Config config) {
        this.config = config != null ? config : new Idea35042Config();
