...
@Data
public class Idea35110Config {
    private String name = "idea_035110";
 ...
 */
@Slf4j
public class Idea35110Service {
    private static final int IDEA_ID = 35110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35110Service() {
        this(new Idea35110Config());
    }

    public Idea35110Service(Idea35110Config config) {
        this.config = config != null ? config : new Idea35110Config();
