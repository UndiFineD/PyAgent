...
@Data
public class Idea35122Config {
    private String name = "idea_035122";
 ...
 */
@Slf4j
public class Idea35122Service {
    private static final int IDEA_ID = 35122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35122Service() {
        this(new Idea35122Config());
    }

    public Idea35122Service(Idea35122Config config) {
        this.config = config != null ? config : new Idea35122Config();
