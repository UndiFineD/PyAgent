...
@Data
public class Idea34736Config {
    private String name = "idea_034736";
 ...
 */
@Slf4j
public class Idea34736Service {
    private static final int IDEA_ID = 34736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34736Service() {
        this(new Idea34736Config());
    }

    public Idea34736Service(Idea34736Config config) {
        this.config = config != null ? config : new Idea34736Config();
