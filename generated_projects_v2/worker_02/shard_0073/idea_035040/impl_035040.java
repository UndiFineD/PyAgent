...
@Data
public class Idea35040Config {
    private String name = "idea_035040";
 ...
 */
@Slf4j
public class Idea35040Service {
    private static final int IDEA_ID = 35040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35040Service() {
        this(new Idea35040Config());
    }

    public Idea35040Service(Idea35040Config config) {
        this.config = config != null ? config : new Idea35040Config();
