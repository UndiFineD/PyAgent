...
@Data
public class Idea34739Config {
    private String name = "idea_034739";
 ...
 */
@Slf4j
public class Idea34739Service {
    private static final int IDEA_ID = 34739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34739Service() {
        this(new Idea34739Config());
    }

    public Idea34739Service(Idea34739Config config) {
        this.config = config != null ? config : new Idea34739Config();
