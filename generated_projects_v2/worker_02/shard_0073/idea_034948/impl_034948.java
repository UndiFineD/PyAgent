...
@Data
public class Idea34948Config {
    private String name = "idea_034948";
 ...
 */
@Slf4j
public class Idea34948Service {
    private static final int IDEA_ID = 34948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34948Service() {
        this(new Idea34948Config());
    }

    public Idea34948Service(Idea34948Config config) {
        this.config = config != null ? config : new Idea34948Config();
