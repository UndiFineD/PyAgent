...
@Data
public class Idea34910Config {
    private String name = "idea_034910";
 ...
 */
@Slf4j
public class Idea34910Service {
    private static final int IDEA_ID = 34910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34910Service() {
        this(new Idea34910Config());
    }

    public Idea34910Service(Idea34910Config config) {
        this.config = config != null ? config : new Idea34910Config();
