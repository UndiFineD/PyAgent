...
@Data
public class Idea34968Config {
    private String name = "idea_034968";
 ...
 */
@Slf4j
public class Idea34968Service {
    private static final int IDEA_ID = 34968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34968Service() {
        this(new Idea34968Config());
    }

    public Idea34968Service(Idea34968Config config) {
        this.config = config != null ? config : new Idea34968Config();
