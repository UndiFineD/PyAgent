...
@Data
public class Idea35089Config {
    private String name = "idea_035089";
 ...
 */
@Slf4j
public class Idea35089Service {
    private static final int IDEA_ID = 35089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35089Service() {
        this(new Idea35089Config());
    }

    public Idea35089Service(Idea35089Config config) {
        this.config = config != null ? config : new Idea35089Config();
