...
@Data
public class Idea34857Config {
    private String name = "idea_034857";
 ...
 */
@Slf4j
public class Idea34857Service {
    private static final int IDEA_ID = 34857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34857Service() {
        this(new Idea34857Config());
    }

    public Idea34857Service(Idea34857Config config) {
        this.config = config != null ? config : new Idea34857Config();
