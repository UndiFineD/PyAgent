...
@Data
public class Idea34711Config {
    private String name = "idea_034711";
 ...
 */
@Slf4j
public class Idea34711Service {
    private static final int IDEA_ID = 34711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34711Service() {
        this(new Idea34711Config());
    }

    public Idea34711Service(Idea34711Config config) {
        this.config = config != null ? config : new Idea34711Config();
