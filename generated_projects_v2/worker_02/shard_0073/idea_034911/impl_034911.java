...
@Data
public class Idea34911Config {
    private String name = "idea_034911";
 ...
 */
@Slf4j
public class Idea34911Service {
    private static final int IDEA_ID = 34911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34911Service() {
        this(new Idea34911Config());
    }

    public Idea34911Service(Idea34911Config config) {
        this.config = config != null ? config : new Idea34911Config();
