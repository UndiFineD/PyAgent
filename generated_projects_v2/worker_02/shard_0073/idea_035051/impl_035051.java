...
@Data
public class Idea35051Config {
    private String name = "idea_035051";
 ...
 */
@Slf4j
public class Idea35051Service {
    private static final int IDEA_ID = 35051;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35051Service() {
        this(new Idea35051Config());
    }

    public Idea35051Service(Idea35051Config config) {
        this.config = config != null ? config : new Idea35051Config();
