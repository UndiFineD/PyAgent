...
@Data
public class Idea34962Config {
    private String name = "idea_034962";
 ...
 */
@Slf4j
public class Idea34962Service {
    private static final int IDEA_ID = 34962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34962Service() {
        this(new Idea34962Config());
    }

    public Idea34962Service(Idea34962Config config) {
        this.config = config != null ? config : new Idea34962Config();
