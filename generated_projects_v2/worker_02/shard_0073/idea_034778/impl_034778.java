...
@Data
public class Idea34778Config {
    private String name = "idea_034778";
 ...
 */
@Slf4j
public class Idea34778Service {
    private static final int IDEA_ID = 34778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34778Service() {
        this(new Idea34778Config());
    }

    public Idea34778Service(Idea34778Config config) {
        this.config = config != null ? config : new Idea34778Config();
