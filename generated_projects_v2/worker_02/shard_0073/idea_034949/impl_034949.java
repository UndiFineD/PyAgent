...
@Data
public class Idea34949Config {
    private String name = "idea_034949";
 ...
 */
@Slf4j
public class Idea34949Service {
    private static final int IDEA_ID = 34949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34949Service() {
        this(new Idea34949Config());
    }

    public Idea34949Service(Idea34949Config config) {
        this.config = config != null ? config : new Idea34949Config();
