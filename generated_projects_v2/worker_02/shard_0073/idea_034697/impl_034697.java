...
@Data
public class Idea34697Config {
    private String name = "idea_034697";
 ...
 */
@Slf4j
public class Idea34697Service {
    private static final int IDEA_ID = 34697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34697Service() {
        this(new Idea34697Config());
    }

    public Idea34697Service(Idea34697Config config) {
        this.config = config != null ? config : new Idea34697Config();
