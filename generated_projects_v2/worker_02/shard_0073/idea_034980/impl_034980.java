...
@Data
public class Idea34980Config {
    private String name = "idea_034980";
 ...
 */
@Slf4j
public class Idea34980Service {
    private static final int IDEA_ID = 34980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34980Service() {
        this(new Idea34980Config());
    }

    public Idea34980Service(Idea34980Config config) {
        this.config = config != null ? config : new Idea34980Config();
