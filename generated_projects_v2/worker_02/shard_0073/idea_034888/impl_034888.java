...
@Data
public class Idea34888Config {
    private String name = "idea_034888";
 ...
 */
@Slf4j
public class Idea34888Service {
    private static final int IDEA_ID = 34888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34888Service() {
        this(new Idea34888Config());
    }

    public Idea34888Service(Idea34888Config config) {
        this.config = config != null ? config : new Idea34888Config();
