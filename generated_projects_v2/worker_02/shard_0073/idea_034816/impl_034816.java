...
@Data
public class Idea34816Config {
    private String name = "idea_034816";
 ...
 */
@Slf4j
public class Idea34816Service {
    private static final int IDEA_ID = 34816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34816Service() {
        this(new Idea34816Config());
    }

    public Idea34816Service(Idea34816Config config) {
        this.config = config != null ? config : new Idea34816Config();
