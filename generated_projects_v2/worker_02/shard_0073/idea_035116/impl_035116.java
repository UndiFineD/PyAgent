...
@Data
public class Idea35116Config {
    private String name = "idea_035116";
 ...
 */
@Slf4j
public class Idea35116Service {
    private static final int IDEA_ID = 35116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35116Service() {
        this(new Idea35116Config());
    }

    public Idea35116Service(Idea35116Config config) {
        this.config = config != null ? config : new Idea35116Config();
