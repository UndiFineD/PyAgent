...
@Data
public class Idea34961Config {
    private String name = "idea_034961";
 ...
 */
@Slf4j
public class Idea34961Service {
    private static final int IDEA_ID = 34961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34961Service() {
        this(new Idea34961Config());
    }

    public Idea34961Service(Idea34961Config config) {
        this.config = config != null ? config : new Idea34961Config();
