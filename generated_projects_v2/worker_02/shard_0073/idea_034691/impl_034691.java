...
@Data
public class Idea34691Config {
    private String name = "idea_034691";
 ...
 */
@Slf4j
public class Idea34691Service {
    private static final int IDEA_ID = 34691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34691Service() {
        this(new Idea34691Config());
    }

    public Idea34691Service(Idea34691Config config) {
        this.config = config != null ? config : new Idea34691Config();
