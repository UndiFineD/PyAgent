...
@Data
public class Idea35126Config {
    private String name = "idea_035126";
 ...
 */
@Slf4j
public class Idea35126Service {
    private static final int IDEA_ID = 35126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35126Service() {
        this(new Idea35126Config());
    }

    public Idea35126Service(Idea35126Config config) {
        this.config = config != null ? config : new Idea35126Config();
