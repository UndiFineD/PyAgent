...
@Data
public class Idea34890Config {
    private String name = "idea_034890";
 ...
 */
@Slf4j
public class Idea34890Service {
    private static final int IDEA_ID = 34890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34890Service() {
        this(new Idea34890Config());
    }

    public Idea34890Service(Idea34890Config config) {
        this.config = config != null ? config : new Idea34890Config();
