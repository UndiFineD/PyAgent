...
@Data
public class Idea35100Config {
    private String name = "idea_035100";
 ...
 */
@Slf4j
public class Idea35100Service {
    private static final int IDEA_ID = 35100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35100Service() {
        this(new Idea35100Config());
    }

    public Idea35100Service(Idea35100Config config) {
        this.config = config != null ? config : new Idea35100Config();
