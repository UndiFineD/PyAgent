...
@Data
public class Idea34904Config {
    private String name = "idea_034904";
 ...
 */
@Slf4j
public class Idea34904Service {
    private static final int IDEA_ID = 34904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34904Service() {
        this(new Idea34904Config());
    }

    public Idea34904Service(Idea34904Config config) {
        this.config = config != null ? config : new Idea34904Config();
