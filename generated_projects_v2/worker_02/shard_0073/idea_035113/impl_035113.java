...
@Data
public class Idea35113Config {
    private String name = "idea_035113";
 ...
 */
@Slf4j
public class Idea35113Service {
    private static final int IDEA_ID = 35113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35113Service() {
        this(new Idea35113Config());
    }

    public Idea35113Service(Idea35113Config config) {
        this.config = config != null ? config : new Idea35113Config();
