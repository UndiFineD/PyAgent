...
@Data
public class Idea35114Config {
    private String name = "idea_035114";
 ...
 */
@Slf4j
public class Idea35114Service {
    private static final int IDEA_ID = 35114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35114Service() {
        this(new Idea35114Config());
    }

    public Idea35114Service(Idea35114Config config) {
        this.config = config != null ? config : new Idea35114Config();
