...
@Data
public class Idea35092Config {
    private String name = "idea_035092";
 ...
 */
@Slf4j
public class Idea35092Service {
    private static final int IDEA_ID = 35092;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35092Service() {
        this(new Idea35092Config());
    }

    public Idea35092Service(Idea35092Config config) {
        this.config = config != null ? config : new Idea35092Config();
