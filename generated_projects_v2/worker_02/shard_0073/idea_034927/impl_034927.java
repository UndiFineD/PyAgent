...
@Data
public class Idea34927Config {
    private String name = "idea_034927";
 ...
 */
@Slf4j
public class Idea34927Service {
    private static final int IDEA_ID = 34927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34927Service() {
        this(new Idea34927Config());
    }

    public Idea34927Service(Idea34927Config config) {
        this.config = config != null ? config : new Idea34927Config();
