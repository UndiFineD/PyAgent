...
@Data
public class Idea34695Config {
    private String name = "idea_034695";
 ...
 */
@Slf4j
public class Idea34695Service {
    private static final int IDEA_ID = 34695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34695Service() {
        this(new Idea34695Config());
    }

    public Idea34695Service(Idea34695Config config) {
        this.config = config != null ? config : new Idea34695Config();
