...
@Data
public class Idea34806Config {
    private String name = "idea_034806";
 ...
 */
@Slf4j
public class Idea34806Service {
    private static final int IDEA_ID = 34806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34806Service() {
        this(new Idea34806Config());
    }

    public Idea34806Service(Idea34806Config config) {
        this.config = config != null ? config : new Idea34806Config();
