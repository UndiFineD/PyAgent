...
@Data
public class Idea35102Config {
    private String name = "idea_035102";
 ...
 */
@Slf4j
public class Idea35102Service {
    private static final int IDEA_ID = 35102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35102Service() {
        this(new Idea35102Config());
    }

    public Idea35102Service(Idea35102Config config) {
        this.config = config != null ? config : new Idea35102Config();
