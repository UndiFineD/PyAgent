...
@Data
public class Idea34791Config {
    private String name = "idea_034791";
 ...
 */
@Slf4j
public class Idea34791Service {
    private static final int IDEA_ID = 34791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34791Service() {
        this(new Idea34791Config());
    }

    public Idea34791Service(Idea34791Config config) {
        this.config = config != null ? config : new Idea34791Config();
