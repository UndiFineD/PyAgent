...
@Data
public class Idea34887Config {
    private String name = "idea_034887";
 ...
 */
@Slf4j
public class Idea34887Service {
    private static final int IDEA_ID = 34887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34887Service() {
        this(new Idea34887Config());
    }

    public Idea34887Service(Idea34887Config config) {
        this.config = config != null ? config : new Idea34887Config();
