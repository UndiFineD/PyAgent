...
@Data
public class Idea35010Config {
    private String name = "idea_035010";
 ...
 */
@Slf4j
public class Idea35010Service {
    private static final int IDEA_ID = 35010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35010Service() {
        this(new Idea35010Config());
    }

    public Idea35010Service(Idea35010Config config) {
        this.config = config != null ? config : new Idea35010Config();
