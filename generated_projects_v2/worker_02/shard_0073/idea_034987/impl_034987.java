...
@Data
public class Idea34987Config {
    private String name = "idea_034987";
 ...
 */
@Slf4j
public class Idea34987Service {
    private static final int IDEA_ID = 34987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34987Service() {
        this(new Idea34987Config());
    }

    public Idea34987Service(Idea34987Config config) {
        this.config = config != null ? config : new Idea34987Config();
