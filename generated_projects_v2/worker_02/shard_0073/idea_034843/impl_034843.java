...
@Data
public class Idea34843Config {
    private String name = "idea_034843";
 ...
 */
@Slf4j
public class Idea34843Service {
    private static final int IDEA_ID = 34843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34843Service() {
        this(new Idea34843Config());
    }

    public Idea34843Service(Idea34843Config config) {
        this.config = config != null ? config : new Idea34843Config();
