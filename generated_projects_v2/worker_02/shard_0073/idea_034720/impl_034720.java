...
@Data
public class Idea34720Config {
    private String name = "idea_034720";
 ...
 */
@Slf4j
public class Idea34720Service {
    private static final int IDEA_ID = 34720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34720Service() {
        this(new Idea34720Config());
    }

    public Idea34720Service(Idea34720Config config) {
        this.config = config != null ? config : new Idea34720Config();
