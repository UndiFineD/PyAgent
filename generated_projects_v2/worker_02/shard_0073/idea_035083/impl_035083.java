...
@Data
public class Idea35083Config {
    private String name = "idea_035083";
 ...
 */
@Slf4j
public class Idea35083Service {
    private static final int IDEA_ID = 35083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35083Service() {
        this(new Idea35083Config());
    }

    public Idea35083Service(Idea35083Config config) {
        this.config = config != null ? config : new Idea35083Config();
