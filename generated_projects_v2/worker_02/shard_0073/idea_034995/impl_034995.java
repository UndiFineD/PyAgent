...
@Data
public class Idea34995Config {
    private String name = "idea_034995";
 ...
 */
@Slf4j
public class Idea34995Service {
    private static final int IDEA_ID = 34995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34995Service() {
        this(new Idea34995Config());
    }

    public Idea34995Service(Idea34995Config config) {
        this.config = config != null ? config : new Idea34995Config();
