...
@Data
public class Idea34860Config {
    private String name = "idea_034860";
 ...
 */
@Slf4j
public class Idea34860Service {
    private static final int IDEA_ID = 34860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34860Service() {
        this(new Idea34860Config());
    }

    public Idea34860Service(Idea34860Config config) {
        this.config = config != null ? config : new Idea34860Config();
