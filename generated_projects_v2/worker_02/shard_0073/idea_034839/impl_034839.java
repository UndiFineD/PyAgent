...
@Data
public class Idea34839Config {
    private String name = "idea_034839";
 ...
 */
@Slf4j
public class Idea34839Service {
    private static final int IDEA_ID = 34839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34839Service() {
        this(new Idea34839Config());
    }

    public Idea34839Service(Idea34839Config config) {
        this.config = config != null ? config : new Idea34839Config();
