...
@Data
public class Idea34774Config {
    private String name = "idea_034774";
 ...
 */
@Slf4j
public class Idea34774Service {
    private static final int IDEA_ID = 34774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34774Service() {
        this(new Idea34774Config());
    }

    public Idea34774Service(Idea34774Config config) {
        this.config = config != null ? config : new Idea34774Config();
