...
@Data
public class Idea35073Config {
    private String name = "idea_035073";
 ...
 */
@Slf4j
public class Idea35073Service {
    private static final int IDEA_ID = 35073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35073Service() {
        this(new Idea35073Config());
    }

    public Idea35073Service(Idea35073Config config) {
        this.config = config != null ? config : new Idea35073Config();
