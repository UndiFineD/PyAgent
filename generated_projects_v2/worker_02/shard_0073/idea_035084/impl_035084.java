...
@Data
public class Idea35084Config {
    private String name = "idea_035084";
 ...
 */
@Slf4j
public class Idea35084Service {
    private static final int IDEA_ID = 35084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea35084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea35084Service() {
        this(new Idea35084Config());
    }

    public Idea35084Service(Idea35084Config config) {
        this.config = config != null ? config : new Idea35084Config();
