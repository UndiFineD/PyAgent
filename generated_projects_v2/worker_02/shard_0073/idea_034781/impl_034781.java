...
@Data
public class Idea34781Config {
    private String name = "idea_034781";
 ...
 */
@Slf4j
public class Idea34781Service {
    private static final int IDEA_ID = 34781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34781Service() {
        this(new Idea34781Config());
    }

    public Idea34781Service(Idea34781Config config) {
        this.config = config != null ? config : new Idea34781Config();
