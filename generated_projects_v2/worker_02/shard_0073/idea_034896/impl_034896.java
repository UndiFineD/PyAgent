...
@Data
public class Idea34896Config {
    private String name = "idea_034896";
 ...
 */
@Slf4j
public class Idea34896Service {
    private static final int IDEA_ID = 34896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea34896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea34896Service() {
        this(new Idea34896Config());
    }

    public Idea34896Service(Idea34896Config config) {
        this.config = config != null ? config : new Idea34896Config();
