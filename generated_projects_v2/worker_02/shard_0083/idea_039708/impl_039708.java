...
@Data
public class Idea39708Config {
    private String name = "idea_039708";
 ...
 */
@Slf4j
public class Idea39708Service {
    private static final int IDEA_ID = 39708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39708Service() {
        this(new Idea39708Config());
    }

    public Idea39708Service(Idea39708Config config) {
        this.config = config != null ? config : new Idea39708Config();
