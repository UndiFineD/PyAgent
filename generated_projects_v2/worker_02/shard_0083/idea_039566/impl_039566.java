...
@Data
public class Idea39566Config {
    private String name = "idea_039566";
 ...
 */
@Slf4j
public class Idea39566Service {
    private static final int IDEA_ID = 39566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39566Service() {
        this(new Idea39566Config());
    }

    public Idea39566Service(Idea39566Config config) {
        this.config = config != null ? config : new Idea39566Config();
