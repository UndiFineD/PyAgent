...
@Data
public class Idea39758Config {
    private String name = "idea_039758";
 ...
 */
@Slf4j
public class Idea39758Service {
    private static final int IDEA_ID = 39758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39758Service() {
        this(new Idea39758Config());
    }

    public Idea39758Service(Idea39758Config config) {
        this.config = config != null ? config : new Idea39758Config();
