...
@Data
public class Idea39762Config {
    private String name = "idea_039762";
 ...
 */
@Slf4j
public class Idea39762Service {
    private static final int IDEA_ID = 39762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39762Service() {
        this(new Idea39762Config());
    }

    public Idea39762Service(Idea39762Config config) {
        this.config = config != null ? config : new Idea39762Config();
