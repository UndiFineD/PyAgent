...
@Data
public class Idea39751Config {
    private String name = "idea_039751";
 ...
 */
@Slf4j
public class Idea39751Service {
    private static final int IDEA_ID = 39751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39751Service() {
        this(new Idea39751Config());
    }

    public Idea39751Service(Idea39751Config config) {
        this.config = config != null ? config : new Idea39751Config();
