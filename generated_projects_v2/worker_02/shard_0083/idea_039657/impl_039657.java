...
@Data
public class Idea39657Config {
    private String name = "idea_039657";
 ...
 */
@Slf4j
public class Idea39657Service {
    private static final int IDEA_ID = 39657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39657Service() {
        this(new Idea39657Config());
    }

    public Idea39657Service(Idea39657Config config) {
        this.config = config != null ? config : new Idea39657Config();
