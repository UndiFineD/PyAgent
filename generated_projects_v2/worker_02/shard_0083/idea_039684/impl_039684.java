...
@Data
public class Idea39684Config {
    private String name = "idea_039684";
 ...
 */
@Slf4j
public class Idea39684Service {
    private static final int IDEA_ID = 39684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39684Service() {
        this(new Idea39684Config());
    }

    public Idea39684Service(Idea39684Config config) {
        this.config = config != null ? config : new Idea39684Config();
