...
@Data
public class Idea39723Config {
    private String name = "idea_039723";
 ...
 */
@Slf4j
public class Idea39723Service {
    private static final int IDEA_ID = 39723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39723Service() {
        this(new Idea39723Config());
    }

    public Idea39723Service(Idea39723Config config) {
        this.config = config != null ? config : new Idea39723Config();
