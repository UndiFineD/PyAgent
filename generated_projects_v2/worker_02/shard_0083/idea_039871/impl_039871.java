...
@Data
public class Idea39871Config {
    private String name = "idea_039871";
 ...
 */
@Slf4j
public class Idea39871Service {
    private static final int IDEA_ID = 39871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39871Service() {
        this(new Idea39871Config());
    }

    public Idea39871Service(Idea39871Config config) {
        this.config = config != null ? config : new Idea39871Config();
