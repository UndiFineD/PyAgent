...
@Data
public class Idea39850Config {
    private String name = "idea_039850";
 ...
 */
@Slf4j
public class Idea39850Service {
    private static final int IDEA_ID = 39850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39850Service() {
        this(new Idea39850Config());
    }

    public Idea39850Service(Idea39850Config config) {
        this.config = config != null ? config : new Idea39850Config();
