...
@Data
public class Idea39766Config {
    private String name = "idea_039766";
 ...
 */
@Slf4j
public class Idea39766Service {
    private static final int IDEA_ID = 39766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39766Service() {
        this(new Idea39766Config());
    }

    public Idea39766Service(Idea39766Config config) {
        this.config = config != null ? config : new Idea39766Config();
