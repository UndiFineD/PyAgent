...
@Data
public class Idea39769Config {
    private String name = "idea_039769";
 ...
 */
@Slf4j
public class Idea39769Service {
    private static final int IDEA_ID = 39769;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39769Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39769Service() {
        this(new Idea39769Config());
    }

    public Idea39769Service(Idea39769Config config) {
        this.config = config != null ? config : new Idea39769Config();
