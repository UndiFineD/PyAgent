...
@Data
public class Idea39523Config {
    private String name = "idea_039523";
 ...
 */
@Slf4j
public class Idea39523Service {
    private static final int IDEA_ID = 39523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39523Service() {
        this(new Idea39523Config());
    }

    public Idea39523Service(Idea39523Config config) {
        this.config = config != null ? config : new Idea39523Config();
