...
@Data
public class Idea39721Config {
    private String name = "idea_039721";
 ...
 */
@Slf4j
public class Idea39721Service {
    private static final int IDEA_ID = 39721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39721Service() {
        this(new Idea39721Config());
    }

    public Idea39721Service(Idea39721Config config) {
        this.config = config != null ? config : new Idea39721Config();
