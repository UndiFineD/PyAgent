...
@Data
public class Idea39799Config {
    private String name = "idea_039799";
 ...
 */
@Slf4j
public class Idea39799Service {
    private static final int IDEA_ID = 39799;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39799Service() {
        this(new Idea39799Config());
    }

    public Idea39799Service(Idea39799Config config) {
        this.config = config != null ? config : new Idea39799Config();
