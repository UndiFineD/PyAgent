...
@Data
public class Idea39749Config {
    private String name = "idea_039749";
 ...
 */
@Slf4j
public class Idea39749Service {
    private static final int IDEA_ID = 39749;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39749Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39749Service() {
        this(new Idea39749Config());
    }

    public Idea39749Service(Idea39749Config config) {
        this.config = config != null ? config : new Idea39749Config();
