...
@Data
public class Idea39525Config {
    private String name = "idea_039525";
 ...
 */
@Slf4j
public class Idea39525Service {
    private static final int IDEA_ID = 39525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39525Service() {
        this(new Idea39525Config());
    }

    public Idea39525Service(Idea39525Config config) {
        this.config = config != null ? config : new Idea39525Config();
