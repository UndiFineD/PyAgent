...
@Data
public class Idea39881Config {
    private String name = "idea_039881";
 ...
 */
@Slf4j
public class Idea39881Service {
    private static final int IDEA_ID = 39881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39881Service() {
        this(new Idea39881Config());
    }

    public Idea39881Service(Idea39881Config config) {
        this.config = config != null ? config : new Idea39881Config();
