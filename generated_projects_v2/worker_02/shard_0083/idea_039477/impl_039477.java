...
@Data
public class Idea39477Config {
    private String name = "idea_039477";
 ...
 */
@Slf4j
public class Idea39477Service {
    private static final int IDEA_ID = 39477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39477Service() {
        this(new Idea39477Config());
    }

    public Idea39477Service(Idea39477Config config) {
        this.config = config != null ? config : new Idea39477Config();
