...
@Data
public class Idea39670Config {
    private String name = "idea_039670";
 ...
 */
@Slf4j
public class Idea39670Service {
    private static final int IDEA_ID = 39670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39670Service() {
        this(new Idea39670Config());
    }

    public Idea39670Service(Idea39670Config config) {
        this.config = config != null ? config : new Idea39670Config();
