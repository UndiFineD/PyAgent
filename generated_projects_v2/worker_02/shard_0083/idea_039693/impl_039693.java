...
@Data
public class Idea39693Config {
    private String name = "idea_039693";
 ...
 */
@Slf4j
public class Idea39693Service {
    private static final int IDEA_ID = 39693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39693Service() {
        this(new Idea39693Config());
    }

    public Idea39693Service(Idea39693Config config) {
        this.config = config != null ? config : new Idea39693Config();
