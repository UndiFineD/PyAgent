...
@Data
public class Idea39702Config {
    private String name = "idea_039702";
 ...
 */
@Slf4j
public class Idea39702Service {
    private static final int IDEA_ID = 39702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39702Service() {
        this(new Idea39702Config());
    }

    public Idea39702Service(Idea39702Config config) {
        this.config = config != null ? config : new Idea39702Config();
