...
@Data
public class Idea39587Config {
    private String name = "idea_039587";
 ...
 */
@Slf4j
public class Idea39587Service {
    private static final int IDEA_ID = 39587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39587Service() {
        this(new Idea39587Config());
    }

    public Idea39587Service(Idea39587Config config) {
        this.config = config != null ? config : new Idea39587Config();
