...
@Data
public class Idea39777Config {
    private String name = "idea_039777";
 ...
 */
@Slf4j
public class Idea39777Service {
    private static final int IDEA_ID = 39777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39777Service() {
        this(new Idea39777Config());
    }

    public Idea39777Service(Idea39777Config config) {
        this.config = config != null ? config : new Idea39777Config();
