...
@Data
public class Idea39621Config {
    private String name = "idea_039621";
 ...
 */
@Slf4j
public class Idea39621Service {
    private static final int IDEA_ID = 39621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39621Service() {
        this(new Idea39621Config());
    }

    public Idea39621Service(Idea39621Config config) {
        this.config = config != null ? config : new Idea39621Config();
