...
@Data
public class Idea39703Config {
    private String name = "idea_039703";
 ...
 */
@Slf4j
public class Idea39703Service {
    private static final int IDEA_ID = 39703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39703Service() {
        this(new Idea39703Config());
    }

    public Idea39703Service(Idea39703Config config) {
        this.config = config != null ? config : new Idea39703Config();
