...
@Data
public class Idea39895Config {
    private String name = "idea_039895";
 ...
 */
@Slf4j
public class Idea39895Service {
    private static final int IDEA_ID = 39895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39895Service() {
        this(new Idea39895Config());
    }

    public Idea39895Service(Idea39895Config config) {
        this.config = config != null ? config : new Idea39895Config();
