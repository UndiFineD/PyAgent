...
@Data
public class Idea39822Config {
    private String name = "idea_039822";
 ...
 */
@Slf4j
public class Idea39822Service {
    private static final int IDEA_ID = 39822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39822Service() {
        this(new Idea39822Config());
    }

    public Idea39822Service(Idea39822Config config) {
        this.config = config != null ? config : new Idea39822Config();
