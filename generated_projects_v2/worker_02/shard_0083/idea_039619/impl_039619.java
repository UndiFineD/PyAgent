...
@Data
public class Idea39619Config {
    private String name = "idea_039619";
 ...
 */
@Slf4j
public class Idea39619Service {
    private static final int IDEA_ID = 39619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39619Service() {
        this(new Idea39619Config());
    }

    public Idea39619Service(Idea39619Config config) {
        this.config = config != null ? config : new Idea39619Config();
