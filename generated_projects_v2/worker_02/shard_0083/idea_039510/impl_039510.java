...
@Data
public class Idea39510Config {
    private String name = "idea_039510";
 ...
 */
@Slf4j
public class Idea39510Service {
    private static final int IDEA_ID = 39510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39510Service() {
        this(new Idea39510Config());
    }

    public Idea39510Service(Idea39510Config config) {
        this.config = config != null ? config : new Idea39510Config();
