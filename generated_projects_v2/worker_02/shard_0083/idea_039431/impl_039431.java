...
@Data
public class Idea39431Config {
    private String name = "idea_039431";
 ...
 */
@Slf4j
public class Idea39431Service {
    private static final int IDEA_ID = 39431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39431Service() {
        this(new Idea39431Config());
    }

    public Idea39431Service(Idea39431Config config) {
        this.config = config != null ? config : new Idea39431Config();
