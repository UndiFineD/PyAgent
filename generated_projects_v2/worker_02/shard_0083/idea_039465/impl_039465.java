...
@Data
public class Idea39465Config {
    private String name = "idea_039465";
 ...
 */
@Slf4j
public class Idea39465Service {
    private static final int IDEA_ID = 39465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39465Service() {
        this(new Idea39465Config());
    }

    public Idea39465Service(Idea39465Config config) {
        this.config = config != null ? config : new Idea39465Config();
