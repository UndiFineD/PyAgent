...
@Data
public class Idea39808Config {
    private String name = "idea_039808";
 ...
 */
@Slf4j
public class Idea39808Service {
    private static final int IDEA_ID = 39808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39808Service() {
        this(new Idea39808Config());
    }

    public Idea39808Service(Idea39808Config config) {
        this.config = config != null ? config : new Idea39808Config();
