...
@Data
public class Idea39857Config {
    private String name = "idea_039857";
 ...
 */
@Slf4j
public class Idea39857Service {
    private static final int IDEA_ID = 39857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39857Service() {
        this(new Idea39857Config());
    }

    public Idea39857Service(Idea39857Config config) {
        this.config = config != null ? config : new Idea39857Config();
