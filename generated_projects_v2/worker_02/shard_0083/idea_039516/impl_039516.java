...
@Data
public class Idea39516Config {
    private String name = "idea_039516";
 ...
 */
@Slf4j
public class Idea39516Service {
    private static final int IDEA_ID = 39516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39516Service() {
        this(new Idea39516Config());
    }

    public Idea39516Service(Idea39516Config config) {
        this.config = config != null ? config : new Idea39516Config();
