...
@Data
public class Idea39825Config {
    private String name = "idea_039825";
 ...
 */
@Slf4j
public class Idea39825Service {
    private static final int IDEA_ID = 39825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39825Service() {
        this(new Idea39825Config());
    }

    public Idea39825Service(Idea39825Config config) {
        this.config = config != null ? config : new Idea39825Config();
