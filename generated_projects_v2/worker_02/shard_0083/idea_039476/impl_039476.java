...
@Data
public class Idea39476Config {
    private String name = "idea_039476";
 ...
 */
@Slf4j
public class Idea39476Service {
    private static final int IDEA_ID = 39476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39476Service() {
        this(new Idea39476Config());
    }

    public Idea39476Service(Idea39476Config config) {
        this.config = config != null ? config : new Idea39476Config();
