...
@Data
public class Idea39663Config {
    private String name = "idea_039663";
 ...
 */
@Slf4j
public class Idea39663Service {
    private static final int IDEA_ID = 39663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39663Service() {
        this(new Idea39663Config());
    }

    public Idea39663Service(Idea39663Config config) {
        this.config = config != null ? config : new Idea39663Config();
