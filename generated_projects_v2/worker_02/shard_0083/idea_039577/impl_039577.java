...
@Data
public class Idea39577Config {
    private String name = "idea_039577";
 ...
 */
@Slf4j
public class Idea39577Service {
    private static final int IDEA_ID = 39577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39577Service() {
        this(new Idea39577Config());
    }

    public Idea39577Service(Idea39577Config config) {
        this.config = config != null ? config : new Idea39577Config();
