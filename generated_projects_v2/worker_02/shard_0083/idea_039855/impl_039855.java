...
@Data
public class Idea39855Config {
    private String name = "idea_039855";
 ...
 */
@Slf4j
public class Idea39855Service {
    private static final int IDEA_ID = 39855;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39855Service() {
        this(new Idea39855Config());
    }

    public Idea39855Service(Idea39855Config config) {
        this.config = config != null ? config : new Idea39855Config();
