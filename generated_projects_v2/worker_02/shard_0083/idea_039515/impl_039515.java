...
@Data
public class Idea39515Config {
    private String name = "idea_039515";
 ...
 */
@Slf4j
public class Idea39515Service {
    private static final int IDEA_ID = 39515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39515Service() {
        this(new Idea39515Config());
    }

    public Idea39515Service(Idea39515Config config) {
        this.config = config != null ? config : new Idea39515Config();
