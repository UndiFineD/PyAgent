...
@Data
public class Idea39691Config {
    private String name = "idea_039691";
 ...
 */
@Slf4j
public class Idea39691Service {
    private static final int IDEA_ID = 39691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39691Service() {
        this(new Idea39691Config());
    }

    public Idea39691Service(Idea39691Config config) {
        this.config = config != null ? config : new Idea39691Config();
