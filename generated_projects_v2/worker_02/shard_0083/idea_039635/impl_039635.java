...
@Data
public class Idea39635Config {
    private String name = "idea_039635";
 ...
 */
@Slf4j
public class Idea39635Service {
    private static final int IDEA_ID = 39635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39635Service() {
        this(new Idea39635Config());
    }

    public Idea39635Service(Idea39635Config config) {
        this.config = config != null ? config : new Idea39635Config();
