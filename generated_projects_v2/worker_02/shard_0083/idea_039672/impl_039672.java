...
@Data
public class Idea39672Config {
    private String name = "idea_039672";
 ...
 */
@Slf4j
public class Idea39672Service {
    private static final int IDEA_ID = 39672;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39672Service() {
        this(new Idea39672Config());
    }

    public Idea39672Service(Idea39672Config config) {
        this.config = config != null ? config : new Idea39672Config();
