...
@Data
public class Idea39718Config {
    private String name = "idea_039718";
 ...
 */
@Slf4j
public class Idea39718Service {
    private static final int IDEA_ID = 39718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39718Service() {
        this(new Idea39718Config());
    }

    public Idea39718Service(Idea39718Config config) {
        this.config = config != null ? config : new Idea39718Config();
