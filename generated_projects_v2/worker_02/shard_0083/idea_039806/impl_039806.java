...
@Data
public class Idea39806Config {
    private String name = "idea_039806";
 ...
 */
@Slf4j
public class Idea39806Service {
    private static final int IDEA_ID = 39806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39806Service() {
        this(new Idea39806Config());
    }

    public Idea39806Service(Idea39806Config config) {
        this.config = config != null ? config : new Idea39806Config();
