...
@Data
public class Idea39820Config {
    private String name = "idea_039820";
 ...
 */
@Slf4j
public class Idea39820Service {
    private static final int IDEA_ID = 39820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39820Service() {
        this(new Idea39820Config());
    }

    public Idea39820Service(Idea39820Config config) {
        this.config = config != null ? config : new Idea39820Config();
