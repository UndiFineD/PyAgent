...
@Data
public class Idea39632Config {
    private String name = "idea_039632";
 ...
 */
@Slf4j
public class Idea39632Service {
    private static final int IDEA_ID = 39632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39632Service() {
        this(new Idea39632Config());
    }

    public Idea39632Service(Idea39632Config config) {
        this.config = config != null ? config : new Idea39632Config();
