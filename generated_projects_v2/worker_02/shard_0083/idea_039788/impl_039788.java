...
@Data
public class Idea39788Config {
    private String name = "idea_039788";
 ...
 */
@Slf4j
public class Idea39788Service {
    private static final int IDEA_ID = 39788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39788Service() {
        this(new Idea39788Config());
    }

    public Idea39788Service(Idea39788Config config) {
        this.config = config != null ? config : new Idea39788Config();
