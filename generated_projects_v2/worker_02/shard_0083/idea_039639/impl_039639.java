...
@Data
public class Idea39639Config {
    private String name = "idea_039639";
 ...
 */
@Slf4j
public class Idea39639Service {
    private static final int IDEA_ID = 39639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39639Service() {
        this(new Idea39639Config());
    }

    public Idea39639Service(Idea39639Config config) {
        this.config = config != null ? config : new Idea39639Config();
