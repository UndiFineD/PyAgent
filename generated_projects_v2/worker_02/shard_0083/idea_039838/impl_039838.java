...
@Data
public class Idea39838Config {
    private String name = "idea_039838";
 ...
 */
@Slf4j
public class Idea39838Service {
    private static final int IDEA_ID = 39838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39838Service() {
        this(new Idea39838Config());
    }

    public Idea39838Service(Idea39838Config config) {
        this.config = config != null ? config : new Idea39838Config();
