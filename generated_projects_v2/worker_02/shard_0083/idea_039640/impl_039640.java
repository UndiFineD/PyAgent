...
@Data
public class Idea39640Config {
    private String name = "idea_039640";
 ...
 */
@Slf4j
public class Idea39640Service {
    private static final int IDEA_ID = 39640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39640Service() {
        this(new Idea39640Config());
    }

    public Idea39640Service(Idea39640Config config) {
        this.config = config != null ? config : new Idea39640Config();
