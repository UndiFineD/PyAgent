...
@Data
public class Idea39748Config {
    private String name = "idea_039748";
 ...
 */
@Slf4j
public class Idea39748Service {
    private static final int IDEA_ID = 39748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39748Service() {
        this(new Idea39748Config());
    }

    public Idea39748Service(Idea39748Config config) {
        this.config = config != null ? config : new Idea39748Config();
