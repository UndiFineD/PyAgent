...
@Data
public class Idea39736Config {
    private String name = "idea_039736";
 ...
 */
@Slf4j
public class Idea39736Service {
    private static final int IDEA_ID = 39736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39736Service() {
        this(new Idea39736Config());
    }

    public Idea39736Service(Idea39736Config config) {
        this.config = config != null ? config : new Idea39736Config();
