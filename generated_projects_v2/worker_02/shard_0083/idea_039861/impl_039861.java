...
@Data
public class Idea39861Config {
    private String name = "idea_039861";
 ...
 */
@Slf4j
public class Idea39861Service {
    private static final int IDEA_ID = 39861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39861Service() {
        this(new Idea39861Config());
    }

    public Idea39861Service(Idea39861Config config) {
        this.config = config != null ? config : new Idea39861Config();
