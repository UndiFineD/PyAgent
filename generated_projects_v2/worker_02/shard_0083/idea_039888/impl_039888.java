...
@Data
public class Idea39888Config {
    private String name = "idea_039888";
 ...
 */
@Slf4j
public class Idea39888Service {
    private static final int IDEA_ID = 39888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39888Service() {
        this(new Idea39888Config());
    }

    public Idea39888Service(Idea39888Config config) {
        this.config = config != null ? config : new Idea39888Config();
