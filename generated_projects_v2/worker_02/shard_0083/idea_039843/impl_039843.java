...
@Data
public class Idea39843Config {
    private String name = "idea_039843";
 ...
 */
@Slf4j
public class Idea39843Service {
    private static final int IDEA_ID = 39843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39843Service() {
        this(new Idea39843Config());
    }

    public Idea39843Service(Idea39843Config config) {
        this.config = config != null ? config : new Idea39843Config();
