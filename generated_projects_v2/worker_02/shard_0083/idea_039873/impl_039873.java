...
@Data
public class Idea39873Config {
    private String name = "idea_039873";
 ...
 */
@Slf4j
public class Idea39873Service {
    private static final int IDEA_ID = 39873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39873Service() {
        this(new Idea39873Config());
    }

    public Idea39873Service(Idea39873Config config) {
        this.config = config != null ? config : new Idea39873Config();
