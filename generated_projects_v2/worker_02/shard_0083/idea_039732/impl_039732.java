...
@Data
public class Idea39732Config {
    private String name = "idea_039732";
 ...
 */
@Slf4j
public class Idea39732Service {
    private static final int IDEA_ID = 39732;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39732Service() {
        this(new Idea39732Config());
    }

    public Idea39732Service(Idea39732Config config) {
        this.config = config != null ? config : new Idea39732Config();
