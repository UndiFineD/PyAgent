...
@Data
public class Idea39740Config {
    private String name = "idea_039740";
 ...
 */
@Slf4j
public class Idea39740Service {
    private static final int IDEA_ID = 39740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39740Service() {
        this(new Idea39740Config());
    }

    public Idea39740Service(Idea39740Config config) {
        this.config = config != null ? config : new Idea39740Config();
