...
@Data
public class Idea39854Config {
    private String name = "idea_039854";
 ...
 */
@Slf4j
public class Idea39854Service {
    private static final int IDEA_ID = 39854;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39854Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39854Service() {
        this(new Idea39854Config());
    }

    public Idea39854Service(Idea39854Config config) {
        this.config = config != null ? config : new Idea39854Config();
