...
@Data
public class Idea39467Config {
    private String name = "idea_039467";
 ...
 */
@Slf4j
public class Idea39467Service {
    private static final int IDEA_ID = 39467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39467Service() {
        this(new Idea39467Config());
    }

    public Idea39467Service(Idea39467Config config) {
        this.config = config != null ? config : new Idea39467Config();
