...
@Data
public class Idea39604Config {
    private String name = "idea_039604";
 ...
 */
@Slf4j
public class Idea39604Service {
    private static final int IDEA_ID = 39604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39604Service() {
        this(new Idea39604Config());
    }

    public Idea39604Service(Idea39604Config config) {
        this.config = config != null ? config : new Idea39604Config();
