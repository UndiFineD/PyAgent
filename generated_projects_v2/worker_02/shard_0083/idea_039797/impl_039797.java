...
@Data
public class Idea39797Config {
    private String name = "idea_039797";
 ...
 */
@Slf4j
public class Idea39797Service {
    private static final int IDEA_ID = 39797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39797Service() {
        this(new Idea39797Config());
    }

    public Idea39797Service(Idea39797Config config) {
        this.config = config != null ? config : new Idea39797Config();
