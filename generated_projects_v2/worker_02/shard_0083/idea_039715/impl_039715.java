...
@Data
public class Idea39715Config {
    private String name = "idea_039715";
 ...
 */
@Slf4j
public class Idea39715Service {
    private static final int IDEA_ID = 39715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39715Service() {
        this(new Idea39715Config());
    }

    public Idea39715Service(Idea39715Config config) {
        this.config = config != null ? config : new Idea39715Config();
