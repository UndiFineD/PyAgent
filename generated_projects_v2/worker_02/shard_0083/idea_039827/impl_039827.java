...
@Data
public class Idea39827Config {
    private String name = "idea_039827";
 ...
 */
@Slf4j
public class Idea39827Service {
    private static final int IDEA_ID = 39827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39827Service() {
        this(new Idea39827Config());
    }

    public Idea39827Service(Idea39827Config config) {
        this.config = config != null ? config : new Idea39827Config();
