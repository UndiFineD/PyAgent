...
@Data
public class Idea39572Config {
    private String name = "idea_039572";
 ...
 */
@Slf4j
public class Idea39572Service {
    private static final int IDEA_ID = 39572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39572Service() {
        this(new Idea39572Config());
    }

    public Idea39572Service(Idea39572Config config) {
        this.config = config != null ? config : new Idea39572Config();
