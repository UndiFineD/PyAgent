...
@Data
public class Idea39864Config {
    private String name = "idea_039864";
 ...
 */
@Slf4j
public class Idea39864Service {
    private static final int IDEA_ID = 39864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39864Service() {
        this(new Idea39864Config());
    }

    public Idea39864Service(Idea39864Config config) {
        this.config = config != null ? config : new Idea39864Config();
