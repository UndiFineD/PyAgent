...
@Data
public class Idea39731Config {
    private String name = "idea_039731";
 ...
 */
@Slf4j
public class Idea39731Service {
    private static final int IDEA_ID = 39731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39731Service() {
        this(new Idea39731Config());
    }

    public Idea39731Service(Idea39731Config config) {
        this.config = config != null ? config : new Idea39731Config();
