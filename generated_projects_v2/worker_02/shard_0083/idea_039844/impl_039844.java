...
@Data
public class Idea39844Config {
    private String name = "idea_039844";
 ...
 */
@Slf4j
public class Idea39844Service {
    private static final int IDEA_ID = 39844;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39844Service() {
        this(new Idea39844Config());
    }

    public Idea39844Service(Idea39844Config config) {
        this.config = config != null ? config : new Idea39844Config();
