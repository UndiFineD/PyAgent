...
@Data
public class Idea39877Config {
    private String name = "idea_039877";
 ...
 */
@Slf4j
public class Idea39877Service {
    private static final int IDEA_ID = 39877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39877Service() {
        this(new Idea39877Config());
    }

    public Idea39877Service(Idea39877Config config) {
        this.config = config != null ? config : new Idea39877Config();
