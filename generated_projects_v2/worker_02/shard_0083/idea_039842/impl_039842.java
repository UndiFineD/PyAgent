...
@Data
public class Idea39842Config {
    private String name = "idea_039842";
 ...
 */
@Slf4j
public class Idea39842Service {
    private static final int IDEA_ID = 39842;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39842Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39842Service() {
        this(new Idea39842Config());
    }

    public Idea39842Service(Idea39842Config config) {
        this.config = config != null ? config : new Idea39842Config();
