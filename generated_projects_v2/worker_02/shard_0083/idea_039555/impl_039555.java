...
@Data
public class Idea39555Config {
    private String name = "idea_039555";
 ...
 */
@Slf4j
public class Idea39555Service {
    private static final int IDEA_ID = 39555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39555Service() {
        this(new Idea39555Config());
    }

    public Idea39555Service(Idea39555Config config) {
        this.config = config != null ? config : new Idea39555Config();
