...
@Data
public class Idea39874Config {
    private String name = "idea_039874";
 ...
 */
@Slf4j
public class Idea39874Service {
    private static final int IDEA_ID = 39874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39874Service() {
        this(new Idea39874Config());
    }

    public Idea39874Service(Idea39874Config config) {
        this.config = config != null ? config : new Idea39874Config();
