...
@Data
public class Idea39563Config {
    private String name = "idea_039563";
 ...
 */
@Slf4j
public class Idea39563Service {
    private static final int IDEA_ID = 39563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39563Service() {
        this(new Idea39563Config());
    }

    public Idea39563Service(Idea39563Config config) {
        this.config = config != null ? config : new Idea39563Config();
