...
@Data
public class Idea39750Config {
    private String name = "idea_039750";
 ...
 */
@Slf4j
public class Idea39750Service {
    private static final int IDEA_ID = 39750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39750Service() {
        this(new Idea39750Config());
    }

    public Idea39750Service(Idea39750Config config) {
        this.config = config != null ? config : new Idea39750Config();
