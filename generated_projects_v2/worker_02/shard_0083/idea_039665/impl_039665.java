...
@Data
public class Idea39665Config {
    private String name = "idea_039665";
 ...
 */
@Slf4j
public class Idea39665Service {
    private static final int IDEA_ID = 39665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39665Service() {
        this(new Idea39665Config());
    }

    public Idea39665Service(Idea39665Config config) {
        this.config = config != null ? config : new Idea39665Config();
