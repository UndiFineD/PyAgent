...
@Data
public class Idea39821Config {
    private String name = "idea_039821";
 ...
 */
@Slf4j
public class Idea39821Service {
    private static final int IDEA_ID = 39821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39821Service() {
        this(new Idea39821Config());
    }

    public Idea39821Service(Idea39821Config config) {
        this.config = config != null ? config : new Idea39821Config();
