...
@Data
public class Idea39778Config {
    private String name = "idea_039778";
 ...
 */
@Slf4j
public class Idea39778Service {
    private static final int IDEA_ID = 39778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39778Service() {
        this(new Idea39778Config());
    }

    public Idea39778Service(Idea39778Config config) {
        this.config = config != null ? config : new Idea39778Config();
