...
@Data
public class Idea39816Config {
    private String name = "idea_039816";
 ...
 */
@Slf4j
public class Idea39816Service {
    private static final int IDEA_ID = 39816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39816Service() {
        this(new Idea39816Config());
    }

    public Idea39816Service(Idea39816Config config) {
        this.config = config != null ? config : new Idea39816Config();
