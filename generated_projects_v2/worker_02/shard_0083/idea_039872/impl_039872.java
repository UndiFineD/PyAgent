...
@Data
public class Idea39872Config {
    private String name = "idea_039872";
 ...
 */
@Slf4j
public class Idea39872Service {
    private static final int IDEA_ID = 39872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39872Service() {
        this(new Idea39872Config());
    }

    public Idea39872Service(Idea39872Config config) {
        this.config = config != null ? config : new Idea39872Config();
