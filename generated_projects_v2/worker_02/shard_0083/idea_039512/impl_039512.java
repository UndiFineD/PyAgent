...
@Data
public class Idea39512Config {
    private String name = "idea_039512";
 ...
 */
@Slf4j
public class Idea39512Service {
    private static final int IDEA_ID = 39512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39512Service() {
        this(new Idea39512Config());
    }

    public Idea39512Service(Idea39512Config config) {
        this.config = config != null ? config : new Idea39512Config();
