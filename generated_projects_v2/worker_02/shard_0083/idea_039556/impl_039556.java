...
@Data
public class Idea39556Config {
    private String name = "idea_039556";
 ...
 */
@Slf4j
public class Idea39556Service {
    private static final int IDEA_ID = 39556;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39556Service() {
        this(new Idea39556Config());
    }

    public Idea39556Service(Idea39556Config config) {
        this.config = config != null ? config : new Idea39556Config();
