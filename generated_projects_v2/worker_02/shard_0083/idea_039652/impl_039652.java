...
@Data
public class Idea39652Config {
    private String name = "idea_039652";
 ...
 */
@Slf4j
public class Idea39652Service {
    private static final int IDEA_ID = 39652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39652Service() {
        this(new Idea39652Config());
    }

    public Idea39652Service(Idea39652Config config) {
        this.config = config != null ? config : new Idea39652Config();
