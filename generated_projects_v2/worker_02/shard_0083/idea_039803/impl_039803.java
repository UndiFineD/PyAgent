...
@Data
public class Idea39803Config {
    private String name = "idea_039803";
 ...
 */
@Slf4j
public class Idea39803Service {
    private static final int IDEA_ID = 39803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39803Service() {
        this(new Idea39803Config());
    }

    public Idea39803Service(Idea39803Config config) {
        this.config = config != null ? config : new Idea39803Config();
