...
@Data
public class Idea39646Config {
    private String name = "idea_039646";
 ...
 */
@Slf4j
public class Idea39646Service {
    private static final int IDEA_ID = 39646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39646Service() {
        this(new Idea39646Config());
    }

    public Idea39646Service(Idea39646Config config) {
        this.config = config != null ? config : new Idea39646Config();
