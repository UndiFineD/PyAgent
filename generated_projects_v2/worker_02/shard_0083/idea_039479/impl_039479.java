...
@Data
public class Idea39479Config {
    private String name = "idea_039479";
 ...
 */
@Slf4j
public class Idea39479Service {
    private static final int IDEA_ID = 39479;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39479Service() {
        this(new Idea39479Config());
    }

    public Idea39479Service(Idea39479Config config) {
        this.config = config != null ? config : new Idea39479Config();
