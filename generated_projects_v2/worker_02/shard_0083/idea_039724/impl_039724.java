...
@Data
public class Idea39724Config {
    private String name = "idea_039724";
 ...
 */
@Slf4j
public class Idea39724Service {
    private static final int IDEA_ID = 39724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39724Service() {
        this(new Idea39724Config());
    }

    public Idea39724Service(Idea39724Config config) {
        this.config = config != null ? config : new Idea39724Config();
