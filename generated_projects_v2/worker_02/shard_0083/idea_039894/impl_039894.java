...
@Data
public class Idea39894Config {
    private String name = "idea_039894";
 ...
 */
@Slf4j
public class Idea39894Service {
    private static final int IDEA_ID = 39894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39894Service() {
        this(new Idea39894Config());
    }

    public Idea39894Service(Idea39894Config config) {
        this.config = config != null ? config : new Idea39894Config();
