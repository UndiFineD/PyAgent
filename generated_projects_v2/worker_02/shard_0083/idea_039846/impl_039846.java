...
@Data
public class Idea39846Config {
    private String name = "idea_039846";
 ...
 */
@Slf4j
public class Idea39846Service {
    private static final int IDEA_ID = 39846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39846Service() {
        this(new Idea39846Config());
    }

    public Idea39846Service(Idea39846Config config) {
        this.config = config != null ? config : new Idea39846Config();
