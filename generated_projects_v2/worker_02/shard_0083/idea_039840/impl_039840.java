...
@Data
public class Idea39840Config {
    private String name = "idea_039840";
 ...
 */
@Slf4j
public class Idea39840Service {
    private static final int IDEA_ID = 39840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39840Service() {
        this(new Idea39840Config());
    }

    public Idea39840Service(Idea39840Config config) {
        this.config = config != null ? config : new Idea39840Config();
