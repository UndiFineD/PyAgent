...
@Data
public class Idea39730Config {
    private String name = "idea_039730";
 ...
 */
@Slf4j
public class Idea39730Service {
    private static final int IDEA_ID = 39730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39730Service() {
        this(new Idea39730Config());
    }

    public Idea39730Service(Idea39730Config config) {
        this.config = config != null ? config : new Idea39730Config();
