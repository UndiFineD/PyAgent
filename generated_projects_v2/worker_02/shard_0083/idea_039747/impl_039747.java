...
@Data
public class Idea39747Config {
    private String name = "idea_039747";
 ...
 */
@Slf4j
public class Idea39747Service {
    private static final int IDEA_ID = 39747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39747Service() {
        this(new Idea39747Config());
    }

    public Idea39747Service(Idea39747Config config) {
        this.config = config != null ? config : new Idea39747Config();
