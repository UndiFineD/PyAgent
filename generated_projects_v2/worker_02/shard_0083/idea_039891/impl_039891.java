...
@Data
public class Idea39891Config {
    private String name = "idea_039891";
 ...
 */
@Slf4j
public class Idea39891Service {
    private static final int IDEA_ID = 39891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39891Service() {
        this(new Idea39891Config());
    }

    public Idea39891Service(Idea39891Config config) {
        this.config = config != null ? config : new Idea39891Config();
