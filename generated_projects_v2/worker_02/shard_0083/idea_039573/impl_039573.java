...
@Data
public class Idea39573Config {
    private String name = "idea_039573";
 ...
 */
@Slf4j
public class Idea39573Service {
    private static final int IDEA_ID = 39573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39573Service() {
        this(new Idea39573Config());
    }

    public Idea39573Service(Idea39573Config config) {
        this.config = config != null ? config : new Idea39573Config();
