...
@Data
public class Idea39714Config {
    private String name = "idea_039714";
 ...
 */
@Slf4j
public class Idea39714Service {
    private static final int IDEA_ID = 39714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39714Service() {
        this(new Idea39714Config());
    }

    public Idea39714Service(Idea39714Config config) {
        this.config = config != null ? config : new Idea39714Config();
