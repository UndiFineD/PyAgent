...
@Data
public class Idea39858Config {
    private String name = "idea_039858";
 ...
 */
@Slf4j
public class Idea39858Service {
    private static final int IDEA_ID = 39858;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39858Service() {
        this(new Idea39858Config());
    }

    public Idea39858Service(Idea39858Config config) {
        this.config = config != null ? config : new Idea39858Config();
