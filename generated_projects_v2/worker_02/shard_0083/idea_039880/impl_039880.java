...
@Data
public class Idea39880Config {
    private String name = "idea_039880";
 ...
 */
@Slf4j
public class Idea39880Service {
    private static final int IDEA_ID = 39880;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39880Service() {
        this(new Idea39880Config());
    }

    public Idea39880Service(Idea39880Config config) {
        this.config = config != null ? config : new Idea39880Config();
