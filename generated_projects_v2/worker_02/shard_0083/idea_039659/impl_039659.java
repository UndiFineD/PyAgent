...
@Data
public class Idea39659Config {
    private String name = "idea_039659";
 ...
 */
@Slf4j
public class Idea39659Service {
    private static final int IDEA_ID = 39659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39659Service() {
        this(new Idea39659Config());
    }

    public Idea39659Service(Idea39659Config config) {
        this.config = config != null ? config : new Idea39659Config();
