...
@Data
public class Idea39607Config {
    private String name = "idea_039607";
 ...
 */
@Slf4j
public class Idea39607Service {
    private static final int IDEA_ID = 39607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39607Service() {
        this(new Idea39607Config());
    }

    public Idea39607Service(Idea39607Config config) {
        this.config = config != null ? config : new Idea39607Config();
