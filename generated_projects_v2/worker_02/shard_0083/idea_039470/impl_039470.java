...
@Data
public class Idea39470Config {
    private String name = "idea_039470";
 ...
 */
@Slf4j
public class Idea39470Service {
    private static final int IDEA_ID = 39470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39470Service() {
        this(new Idea39470Config());
    }

    public Idea39470Service(Idea39470Config config) {
        this.config = config != null ? config : new Idea39470Config();
