...
@Data
public class Idea39776Config {
    private String name = "idea_039776";
 ...
 */
@Slf4j
public class Idea39776Service {
    private static final int IDEA_ID = 39776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39776Service() {
        this(new Idea39776Config());
    }

    public Idea39776Service(Idea39776Config config) {
        this.config = config != null ? config : new Idea39776Config();
