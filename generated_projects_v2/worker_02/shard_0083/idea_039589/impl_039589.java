...
@Data
public class Idea39589Config {
    private String name = "idea_039589";
 ...
 */
@Slf4j
public class Idea39589Service {
    private static final int IDEA_ID = 39589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39589Service() {
        this(new Idea39589Config());
    }

    public Idea39589Service(Idea39589Config config) {
        this.config = config != null ? config : new Idea39589Config();
