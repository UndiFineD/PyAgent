...
@Data
public class Idea39627Config {
    private String name = "idea_039627";
 ...
 */
@Slf4j
public class Idea39627Service {
    private static final int IDEA_ID = 39627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39627Service() {
        this(new Idea39627Config());
    }

    public Idea39627Service(Idea39627Config config) {
        this.config = config != null ? config : new Idea39627Config();
