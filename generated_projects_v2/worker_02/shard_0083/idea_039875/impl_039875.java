...
@Data
public class Idea39875Config {
    private String name = "idea_039875";
 ...
 */
@Slf4j
public class Idea39875Service {
    private static final int IDEA_ID = 39875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39875Service() {
        this(new Idea39875Config());
    }

    public Idea39875Service(Idea39875Config config) {
        this.config = config != null ? config : new Idea39875Config();
