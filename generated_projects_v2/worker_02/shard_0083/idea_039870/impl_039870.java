...
@Data
public class Idea39870Config {
    private String name = "idea_039870";
 ...
 */
@Slf4j
public class Idea39870Service {
    private static final int IDEA_ID = 39870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39870Service() {
        this(new Idea39870Config());
    }

    public Idea39870Service(Idea39870Config config) {
        this.config = config != null ? config : new Idea39870Config();
