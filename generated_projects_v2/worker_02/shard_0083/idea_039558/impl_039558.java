...
@Data
public class Idea39558Config {
    private String name = "idea_039558";
 ...
 */
@Slf4j
public class Idea39558Service {
    private static final int IDEA_ID = 39558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39558Service() {
        this(new Idea39558Config());
    }

    public Idea39558Service(Idea39558Config config) {
        this.config = config != null ? config : new Idea39558Config();
