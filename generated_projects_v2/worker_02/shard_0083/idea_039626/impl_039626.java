...
@Data
public class Idea39626Config {
    private String name = "idea_039626";
 ...
 */
@Slf4j
public class Idea39626Service {
    private static final int IDEA_ID = 39626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39626Service() {
        this(new Idea39626Config());
    }

    public Idea39626Service(Idea39626Config config) {
        this.config = config != null ? config : new Idea39626Config();
