...
@Data
public class Idea39716Config {
    private String name = "idea_039716";
 ...
 */
@Slf4j
public class Idea39716Service {
    private static final int IDEA_ID = 39716;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39716Service() {
        this(new Idea39716Config());
    }

    public Idea39716Service(Idea39716Config config) {
        this.config = config != null ? config : new Idea39716Config();
