...
@Data
public class Idea39811Config {
    private String name = "idea_039811";
 ...
 */
@Slf4j
public class Idea39811Service {
    private static final int IDEA_ID = 39811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39811Service() {
        this(new Idea39811Config());
    }

    public Idea39811Service(Idea39811Config config) {
        this.config = config != null ? config : new Idea39811Config();
