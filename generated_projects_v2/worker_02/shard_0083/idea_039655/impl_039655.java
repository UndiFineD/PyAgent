...
@Data
public class Idea39655Config {
    private String name = "idea_039655";
 ...
 */
@Slf4j
public class Idea39655Service {
    private static final int IDEA_ID = 39655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39655Service() {
        this(new Idea39655Config());
    }

    public Idea39655Service(Idea39655Config config) {
        this.config = config != null ? config : new Idea39655Config();
