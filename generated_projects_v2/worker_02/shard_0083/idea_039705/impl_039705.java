...
@Data
public class Idea39705Config {
    private String name = "idea_039705";
 ...
 */
@Slf4j
public class Idea39705Service {
    private static final int IDEA_ID = 39705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39705Service() {
        this(new Idea39705Config());
    }

    public Idea39705Service(Idea39705Config config) {
        this.config = config != null ? config : new Idea39705Config();
