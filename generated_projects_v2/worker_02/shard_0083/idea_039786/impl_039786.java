...
@Data
public class Idea39786Config {
    private String name = "idea_039786";
 ...
 */
@Slf4j
public class Idea39786Service {
    private static final int IDEA_ID = 39786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39786Service() {
        this(new Idea39786Config());
    }

    public Idea39786Service(Idea39786Config config) {
        this.config = config != null ? config : new Idea39786Config();
