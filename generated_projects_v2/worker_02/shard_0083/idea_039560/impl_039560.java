...
@Data
public class Idea39560Config {
    private String name = "idea_039560";
 ...
 */
@Slf4j
public class Idea39560Service {
    private static final int IDEA_ID = 39560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39560Service() {
        this(new Idea39560Config());
    }

    public Idea39560Service(Idea39560Config config) {
        this.config = config != null ? config : new Idea39560Config();
