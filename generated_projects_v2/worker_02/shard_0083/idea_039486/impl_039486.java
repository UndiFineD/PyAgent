...
@Data
public class Idea39486Config {
    private String name = "idea_039486";
 ...
 */
@Slf4j
public class Idea39486Service {
    private static final int IDEA_ID = 39486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39486Service() {
        this(new Idea39486Config());
    }

    public Idea39486Service(Idea39486Config config) {
        this.config = config != null ? config : new Idea39486Config();
