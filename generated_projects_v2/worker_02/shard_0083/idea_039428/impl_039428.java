...
@Data
public class Idea39428Config {
    private String name = "idea_039428";
 ...
 */
@Slf4j
public class Idea39428Service {
    private static final int IDEA_ID = 39428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39428Service() {
        this(new Idea39428Config());
    }

    public Idea39428Service(Idea39428Config config) {
        this.config = config != null ? config : new Idea39428Config();
