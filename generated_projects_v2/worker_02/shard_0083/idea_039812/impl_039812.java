...
@Data
public class Idea39812Config {
    private String name = "idea_039812";
 ...
 */
@Slf4j
public class Idea39812Service {
    private static final int IDEA_ID = 39812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39812Service() {
        this(new Idea39812Config());
    }

    public Idea39812Service(Idea39812Config config) {
        this.config = config != null ? config : new Idea39812Config();
