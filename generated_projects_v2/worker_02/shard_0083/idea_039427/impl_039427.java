...
@Data
public class Idea39427Config {
    private String name = "idea_039427";
 ...
 */
@Slf4j
public class Idea39427Service {
    private static final int IDEA_ID = 39427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39427Service() {
        this(new Idea39427Config());
    }

    public Idea39427Service(Idea39427Config config) {
        this.config = config != null ? config : new Idea39427Config();
