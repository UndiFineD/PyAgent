...
@Data
public class Idea39641Config {
    private String name = "idea_039641";
 ...
 */
@Slf4j
public class Idea39641Service {
    private static final int IDEA_ID = 39641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39641Service() {
        this(new Idea39641Config());
    }

    public Idea39641Service(Idea39641Config config) {
        this.config = config != null ? config : new Idea39641Config();
