...
@Data
public class Idea39698Config {
    private String name = "idea_039698";
 ...
 */
@Slf4j
public class Idea39698Service {
    private static final int IDEA_ID = 39698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39698Service() {
        this(new Idea39698Config());
    }

    public Idea39698Service(Idea39698Config config) {
        this.config = config != null ? config : new Idea39698Config();
