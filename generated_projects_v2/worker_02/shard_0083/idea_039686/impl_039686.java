...
@Data
public class Idea39686Config {
    private String name = "idea_039686";
 ...
 */
@Slf4j
public class Idea39686Service {
    private static final int IDEA_ID = 39686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39686Service() {
        this(new Idea39686Config());
    }

    public Idea39686Service(Idea39686Config config) {
        this.config = config != null ? config : new Idea39686Config();
