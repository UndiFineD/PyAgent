...
@Data
public class Idea39774Config {
    private String name = "idea_039774";
 ...
 */
@Slf4j
public class Idea39774Service {
    private static final int IDEA_ID = 39774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39774Service() {
        this(new Idea39774Config());
    }

    public Idea39774Service(Idea39774Config config) {
        this.config = config != null ? config : new Idea39774Config();
