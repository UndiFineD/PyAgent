...
@Data
public class Idea39463Config {
    private String name = "idea_039463";
 ...
 */
@Slf4j
public class Idea39463Service {
    private static final int IDEA_ID = 39463;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39463Service() {
        this(new Idea39463Config());
    }

    public Idea39463Service(Idea39463Config config) {
        this.config = config != null ? config : new Idea39463Config();
