...
@Data
public class Idea39564Config {
    private String name = "idea_039564";
 ...
 */
@Slf4j
public class Idea39564Service {
    private static final int IDEA_ID = 39564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39564Service() {
        this(new Idea39564Config());
    }

    public Idea39564Service(Idea39564Config config) {
        this.config = config != null ? config : new Idea39564Config();
