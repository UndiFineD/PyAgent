...
@Data
public class Idea39649Config {
    private String name = "idea_039649";
 ...
 */
@Slf4j
public class Idea39649Service {
    private static final int IDEA_ID = 39649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39649Service() {
        this(new Idea39649Config());
    }

    public Idea39649Service(Idea39649Config config) {
        this.config = config != null ? config : new Idea39649Config();
