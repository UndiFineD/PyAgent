...
@Data
public class Idea39694Config {
    private String name = "idea_039694";
 ...
 */
@Slf4j
public class Idea39694Service {
    private static final int IDEA_ID = 39694;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39694Service() {
        this(new Idea39694Config());
    }

    public Idea39694Service(Idea39694Config config) {
        this.config = config != null ? config : new Idea39694Config();
