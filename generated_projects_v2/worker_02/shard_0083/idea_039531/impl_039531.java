...
@Data
public class Idea39531Config {
    private String name = "idea_039531";
 ...
 */
@Slf4j
public class Idea39531Service {
    private static final int IDEA_ID = 39531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39531Service() {
        this(new Idea39531Config());
    }

    public Idea39531Service(Idea39531Config config) {
        this.config = config != null ? config : new Idea39531Config();
