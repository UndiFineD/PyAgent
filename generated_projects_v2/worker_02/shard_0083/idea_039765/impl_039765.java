...
@Data
public class Idea39765Config {
    private String name = "idea_039765";
 ...
 */
@Slf4j
public class Idea39765Service {
    private static final int IDEA_ID = 39765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39765Service() {
        this(new Idea39765Config());
    }

    public Idea39765Service(Idea39765Config config) {
        this.config = config != null ? config : new Idea39765Config();
