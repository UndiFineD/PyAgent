...
@Data
public class Idea39432Config {
    private String name = "idea_039432";
 ...
 */
@Slf4j
public class Idea39432Service {
    private static final int IDEA_ID = 39432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39432Service() {
        this(new Idea39432Config());
    }

    public Idea39432Service(Idea39432Config config) {
        this.config = config != null ? config : new Idea39432Config();
