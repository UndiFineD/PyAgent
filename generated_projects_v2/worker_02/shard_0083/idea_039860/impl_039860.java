...
@Data
public class Idea39860Config {
    private String name = "idea_039860";
 ...
 */
@Slf4j
public class Idea39860Service {
    private static final int IDEA_ID = 39860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39860Service() {
        this(new Idea39860Config());
    }

    public Idea39860Service(Idea39860Config config) {
        this.config = config != null ? config : new Idea39860Config();
