...
@Data
public class Idea39890Config {
    private String name = "idea_039890";
 ...
 */
@Slf4j
public class Idea39890Service {
    private static final int IDEA_ID = 39890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39890Service() {
        this(new Idea39890Config());
    }

    public Idea39890Service(Idea39890Config config) {
        this.config = config != null ? config : new Idea39890Config();
