...
@Data
public class Idea39847Config {
    private String name = "idea_039847";
 ...
 */
@Slf4j
public class Idea39847Service {
    private static final int IDEA_ID = 39847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39847Service() {
        this(new Idea39847Config());
    }

    public Idea39847Service(Idea39847Config config) {
        this.config = config != null ? config : new Idea39847Config();
