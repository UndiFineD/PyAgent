...
@Data
public class Idea39487Config {
    private String name = "idea_039487";
 ...
 */
@Slf4j
public class Idea39487Service {
    private static final int IDEA_ID = 39487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39487Service() {
        this(new Idea39487Config());
    }

    public Idea39487Service(Idea39487Config config) {
        this.config = config != null ? config : new Idea39487Config();
