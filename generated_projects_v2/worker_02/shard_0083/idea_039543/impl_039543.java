...
@Data
public class Idea39543Config {
    private String name = "idea_039543";
 ...
 */
@Slf4j
public class Idea39543Service {
    private static final int IDEA_ID = 39543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39543Service() {
        this(new Idea39543Config());
    }

    public Idea39543Service(Idea39543Config config) {
        this.config = config != null ? config : new Idea39543Config();
