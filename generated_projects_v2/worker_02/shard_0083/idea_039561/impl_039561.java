...
@Data
public class Idea39561Config {
    private String name = "idea_039561";
 ...
 */
@Slf4j
public class Idea39561Service {
    private static final int IDEA_ID = 39561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39561Service() {
        this(new Idea39561Config());
    }

    public Idea39561Service(Idea39561Config config) {
        this.config = config != null ? config : new Idea39561Config();
