...
@Data
public class Idea39616Config {
    private String name = "idea_039616";
 ...
 */
@Slf4j
public class Idea39616Service {
    private static final int IDEA_ID = 39616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39616Service() {
        this(new Idea39616Config());
    }

    public Idea39616Service(Idea39616Config config) {
        this.config = config != null ? config : new Idea39616Config();
