...
@Data
public class Idea39507Config {
    private String name = "idea_039507";
 ...
 */
@Slf4j
public class Idea39507Service {
    private static final int IDEA_ID = 39507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39507Service() {
        this(new Idea39507Config());
    }

    public Idea39507Service(Idea39507Config config) {
        this.config = config != null ? config : new Idea39507Config();
