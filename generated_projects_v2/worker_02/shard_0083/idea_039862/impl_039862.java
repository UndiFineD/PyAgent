...
@Data
public class Idea39862Config {
    private String name = "idea_039862";
 ...
 */
@Slf4j
public class Idea39862Service {
    private static final int IDEA_ID = 39862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39862Service() {
        this(new Idea39862Config());
    }

    public Idea39862Service(Idea39862Config config) {
        this.config = config != null ? config : new Idea39862Config();
