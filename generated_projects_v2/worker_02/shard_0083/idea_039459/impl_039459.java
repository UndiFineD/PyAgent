...
@Data
public class Idea39459Config {
    private String name = "idea_039459";
 ...
 */
@Slf4j
public class Idea39459Service {
    private static final int IDEA_ID = 39459;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39459Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39459Service() {
        this(new Idea39459Config());
    }

    public Idea39459Service(Idea39459Config config) {
        this.config = config != null ? config : new Idea39459Config();
