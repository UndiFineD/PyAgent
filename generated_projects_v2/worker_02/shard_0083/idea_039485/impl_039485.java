...
@Data
public class Idea39485Config {
    private String name = "idea_039485";
 ...
 */
@Slf4j
public class Idea39485Service {
    private static final int IDEA_ID = 39485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39485Service() {
        this(new Idea39485Config());
    }

    public Idea39485Service(Idea39485Config config) {
        this.config = config != null ? config : new Idea39485Config();
