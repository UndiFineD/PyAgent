...
@Data
public class Idea39683Config {
    private String name = "idea_039683";
 ...
 */
@Slf4j
public class Idea39683Service {
    private static final int IDEA_ID = 39683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39683Service() {
        this(new Idea39683Config());
    }

    public Idea39683Service(Idea39683Config config) {
        this.config = config != null ? config : new Idea39683Config();
