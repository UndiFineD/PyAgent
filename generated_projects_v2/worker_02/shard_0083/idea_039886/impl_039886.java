...
@Data
public class Idea39886Config {
    private String name = "idea_039886";
 ...
 */
@Slf4j
public class Idea39886Service {
    private static final int IDEA_ID = 39886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39886Service() {
        this(new Idea39886Config());
    }

    public Idea39886Service(Idea39886Config config) {
        this.config = config != null ? config : new Idea39886Config();
