...
@Data
public class Idea39876Config {
    private String name = "idea_039876";
 ...
 */
@Slf4j
public class Idea39876Service {
    private static final int IDEA_ID = 39876;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39876Service() {
        this(new Idea39876Config());
    }

    public Idea39876Service(Idea39876Config config) {
        this.config = config != null ? config : new Idea39876Config();
