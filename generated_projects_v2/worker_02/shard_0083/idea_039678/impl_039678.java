...
@Data
public class Idea39678Config {
    private String name = "idea_039678";
 ...
 */
@Slf4j
public class Idea39678Service {
    private static final int IDEA_ID = 39678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39678Service() {
        this(new Idea39678Config());
    }

    public Idea39678Service(Idea39678Config config) {
        this.config = config != null ? config : new Idea39678Config();
