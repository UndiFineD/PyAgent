...
@Data
public class Idea39509Config {
    private String name = "idea_039509";
 ...
 */
@Slf4j
public class Idea39509Service {
    private static final int IDEA_ID = 39509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39509Service() {
        this(new Idea39509Config());
    }

    public Idea39509Service(Idea39509Config config) {
        this.config = config != null ? config : new Idea39509Config();
