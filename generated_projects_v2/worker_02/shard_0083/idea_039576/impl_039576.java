...
@Data
public class Idea39576Config {
    private String name = "idea_039576";
 ...
 */
@Slf4j
public class Idea39576Service {
    private static final int IDEA_ID = 39576;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39576Service() {
        this(new Idea39576Config());
    }

    public Idea39576Service(Idea39576Config config) {
        this.config = config != null ? config : new Idea39576Config();
