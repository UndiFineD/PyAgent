...
@Data
public class Idea39570Config {
    private String name = "idea_039570";
 ...
 */
@Slf4j
public class Idea39570Service {
    private static final int IDEA_ID = 39570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39570Service() {
        this(new Idea39570Config());
    }

    public Idea39570Service(Idea39570Config config) {
        this.config = config != null ? config : new Idea39570Config();
