...
@Data
public class Idea39757Config {
    private String name = "idea_039757";
 ...
 */
@Slf4j
public class Idea39757Service {
    private static final int IDEA_ID = 39757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39757Service() {
        this(new Idea39757Config());
    }

    public Idea39757Service(Idea39757Config config) {
        this.config = config != null ? config : new Idea39757Config();
