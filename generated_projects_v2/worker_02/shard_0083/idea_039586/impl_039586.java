...
@Data
public class Idea39586Config {
    private String name = "idea_039586";
 ...
 */
@Slf4j
public class Idea39586Service {
    private static final int IDEA_ID = 39586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39586Service() {
        this(new Idea39586Config());
    }

    public Idea39586Service(Idea39586Config config) {
        this.config = config != null ? config : new Idea39586Config();
