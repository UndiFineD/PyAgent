...
@Data
public class Idea39823Config {
    private String name = "idea_039823";
 ...
 */
@Slf4j
public class Idea39823Service {
    private static final int IDEA_ID = 39823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39823Service() {
        this(new Idea39823Config());
    }

    public Idea39823Service(Idea39823Config config) {
        this.config = config != null ? config : new Idea39823Config();
