...
@Data
public class Idea39834Config {
    private String name = "idea_039834";
 ...
 */
@Slf4j
public class Idea39834Service {
    private static final int IDEA_ID = 39834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39834Service() {
        this(new Idea39834Config());
    }

    public Idea39834Service(Idea39834Config config) {
        this.config = config != null ? config : new Idea39834Config();
