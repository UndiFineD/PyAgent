...
@Data
public class Idea39602Config {
    private String name = "idea_039602";
 ...
 */
@Slf4j
public class Idea39602Service {
    private static final int IDEA_ID = 39602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39602Service() {
        this(new Idea39602Config());
    }

    public Idea39602Service(Idea39602Config config) {
        this.config = config != null ? config : new Idea39602Config();
