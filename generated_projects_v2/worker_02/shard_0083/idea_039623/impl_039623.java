...
@Data
public class Idea39623Config {
    private String name = "idea_039623";
 ...
 */
@Slf4j
public class Idea39623Service {
    private static final int IDEA_ID = 39623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39623Service() {
        this(new Idea39623Config());
    }

    public Idea39623Service(Idea39623Config config) {
        this.config = config != null ? config : new Idea39623Config();
