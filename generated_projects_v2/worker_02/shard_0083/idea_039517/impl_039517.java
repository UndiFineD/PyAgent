...
@Data
public class Idea39517Config {
    private String name = "idea_039517";
 ...
 */
@Slf4j
public class Idea39517Service {
    private static final int IDEA_ID = 39517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39517Service() {
        this(new Idea39517Config());
    }

    public Idea39517Service(Idea39517Config config) {
        this.config = config != null ? config : new Idea39517Config();
