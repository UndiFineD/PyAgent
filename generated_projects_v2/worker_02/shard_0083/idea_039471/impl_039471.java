...
@Data
public class Idea39471Config {
    private String name = "idea_039471";
 ...
 */
@Slf4j
public class Idea39471Service {
    private static final int IDEA_ID = 39471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39471Service() {
        this(new Idea39471Config());
    }

    public Idea39471Service(Idea39471Config config) {
        this.config = config != null ? config : new Idea39471Config();
