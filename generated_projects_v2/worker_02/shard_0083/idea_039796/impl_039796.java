...
@Data
public class Idea39796Config {
    private String name = "idea_039796";
 ...
 */
@Slf4j
public class Idea39796Service {
    private static final int IDEA_ID = 39796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39796Service() {
        this(new Idea39796Config());
    }

    public Idea39796Service(Idea39796Config config) {
        this.config = config != null ? config : new Idea39796Config();
