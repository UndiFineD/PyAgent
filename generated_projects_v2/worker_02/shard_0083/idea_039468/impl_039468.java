...
@Data
public class Idea39468Config {
    private String name = "idea_039468";
 ...
 */
@Slf4j
public class Idea39468Service {
    private static final int IDEA_ID = 39468;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39468Service() {
        this(new Idea39468Config());
    }

    public Idea39468Service(Idea39468Config config) {
        this.config = config != null ? config : new Idea39468Config();
