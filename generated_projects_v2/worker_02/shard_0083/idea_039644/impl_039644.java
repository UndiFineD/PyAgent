...
@Data
public class Idea39644Config {
    private String name = "idea_039644";
 ...
 */
@Slf4j
public class Idea39644Service {
    private static final int IDEA_ID = 39644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39644Service() {
        this(new Idea39644Config());
    }

    public Idea39644Service(Idea39644Config config) {
        this.config = config != null ? config : new Idea39644Config();
