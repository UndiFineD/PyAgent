...
@Data
public class Idea39699Config {
    private String name = "idea_039699";
 ...
 */
@Slf4j
public class Idea39699Service {
    private static final int IDEA_ID = 39699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39699Service() {
        this(new Idea39699Config());
    }

    public Idea39699Service(Idea39699Config config) {
        this.config = config != null ? config : new Idea39699Config();
