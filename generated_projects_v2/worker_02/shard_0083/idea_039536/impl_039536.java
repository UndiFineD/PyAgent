...
@Data
public class Idea39536Config {
    private String name = "idea_039536";
 ...
 */
@Slf4j
public class Idea39536Service {
    private static final int IDEA_ID = 39536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39536Service() {
        this(new Idea39536Config());
    }

    public Idea39536Service(Idea39536Config config) {
        this.config = config != null ? config : new Idea39536Config();
