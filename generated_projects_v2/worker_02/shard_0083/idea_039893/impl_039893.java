...
@Data
public class Idea39893Config {
    private String name = "idea_039893";
 ...
 */
@Slf4j
public class Idea39893Service {
    private static final int IDEA_ID = 39893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39893Service() {
        this(new Idea39893Config());
    }

    public Idea39893Service(Idea39893Config config) {
        this.config = config != null ? config : new Idea39893Config();
