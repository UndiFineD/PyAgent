...
@Data
public class Idea39584Config {
    private String name = "idea_039584";
 ...
 */
@Slf4j
public class Idea39584Service {
    private static final int IDEA_ID = 39584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39584Service() {
        this(new Idea39584Config());
    }

    public Idea39584Service(Idea39584Config config) {
        this.config = config != null ? config : new Idea39584Config();
