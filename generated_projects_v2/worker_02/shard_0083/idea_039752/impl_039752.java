...
@Data
public class Idea39752Config {
    private String name = "idea_039752";
 ...
 */
@Slf4j
public class Idea39752Service {
    private static final int IDEA_ID = 39752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39752Service() {
        this(new Idea39752Config());
    }

    public Idea39752Service(Idea39752Config config) {
        this.config = config != null ? config : new Idea39752Config();
