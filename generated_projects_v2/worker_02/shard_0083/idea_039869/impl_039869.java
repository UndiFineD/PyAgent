...
@Data
public class Idea39869Config {
    private String name = "idea_039869";
 ...
 */
@Slf4j
public class Idea39869Service {
    private static final int IDEA_ID = 39869;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39869Service() {
        this(new Idea39869Config());
    }

    public Idea39869Service(Idea39869Config config) {
        this.config = config != null ? config : new Idea39869Config();
