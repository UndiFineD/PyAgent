...
@Data
public class Idea39707Config {
    private String name = "idea_039707";
 ...
 */
@Slf4j
public class Idea39707Service {
    private static final int IDEA_ID = 39707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39707Service() {
        this(new Idea39707Config());
    }

    public Idea39707Service(Idea39707Config config) {
        this.config = config != null ? config : new Idea39707Config();
