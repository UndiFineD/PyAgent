...
@Data
public class Idea39629Config {
    private String name = "idea_039629";
 ...
 */
@Slf4j
public class Idea39629Service {
    private static final int IDEA_ID = 39629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39629Service() {
        this(new Idea39629Config());
    }

    public Idea39629Service(Idea39629Config config) {
        this.config = config != null ? config : new Idea39629Config();
