...
@Data
public class Idea39606Config {
    private String name = "idea_039606";
 ...
 */
@Slf4j
public class Idea39606Service {
    private static final int IDEA_ID = 39606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39606Service() {
        this(new Idea39606Config());
    }

    public Idea39606Service(Idea39606Config config) {
        this.config = config != null ? config : new Idea39606Config();
