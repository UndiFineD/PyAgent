...
@Data
public class Idea39760Config {
    private String name = "idea_039760";
 ...
 */
@Slf4j
public class Idea39760Service {
    private static final int IDEA_ID = 39760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39760Service() {
        this(new Idea39760Config());
    }

    public Idea39760Service(Idea39760Config config) {
        this.config = config != null ? config : new Idea39760Config();
