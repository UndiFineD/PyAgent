...
@Data
public class Idea39625Config {
    private String name = "idea_039625";
 ...
 */
@Slf4j
public class Idea39625Service {
    private static final int IDEA_ID = 39625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39625Service() {
        this(new Idea39625Config());
    }

    public Idea39625Service(Idea39625Config config) {
        this.config = config != null ? config : new Idea39625Config();
