...
@Data
public class Idea39498Config {
    private String name = "idea_039498";
 ...
 */
@Slf4j
public class Idea39498Service {
    private static final int IDEA_ID = 39498;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39498Service() {
        this(new Idea39498Config());
    }

    public Idea39498Service(Idea39498Config config) {
        this.config = config != null ? config : new Idea39498Config();
