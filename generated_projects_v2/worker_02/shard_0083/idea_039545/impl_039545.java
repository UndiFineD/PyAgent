...
@Data
public class Idea39545Config {
    private String name = "idea_039545";
 ...
 */
@Slf4j
public class Idea39545Service {
    private static final int IDEA_ID = 39545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39545Service() {
        this(new Idea39545Config());
    }

    public Idea39545Service(Idea39545Config config) {
        this.config = config != null ? config : new Idea39545Config();
