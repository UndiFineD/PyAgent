...
@Data
public class Idea39688Config {
    private String name = "idea_039688";
 ...
 */
@Slf4j
public class Idea39688Service {
    private static final int IDEA_ID = 39688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39688Service() {
        this(new Idea39688Config());
    }

    public Idea39688Service(Idea39688Config config) {
        this.config = config != null ? config : new Idea39688Config();
