...
@Data
public class Idea39453Config {
    private String name = "idea_039453";
 ...
 */
@Slf4j
public class Idea39453Service {
    private static final int IDEA_ID = 39453;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39453Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39453Service() {
        this(new Idea39453Config());
    }

    public Idea39453Service(Idea39453Config config) {
        this.config = config != null ? config : new Idea39453Config();
