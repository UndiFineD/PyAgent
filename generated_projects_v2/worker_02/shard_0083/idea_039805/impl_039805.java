...
@Data
public class Idea39805Config {
    private String name = "idea_039805";
 ...
 */
@Slf4j
public class Idea39805Service {
    private static final int IDEA_ID = 39805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39805Service() {
        this(new Idea39805Config());
    }

    public Idea39805Service(Idea39805Config config) {
        this.config = config != null ? config : new Idea39805Config();
