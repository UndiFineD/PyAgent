...
@Data
public class Idea39535Config {
    private String name = "idea_039535";
 ...
 */
@Slf4j
public class Idea39535Service {
    private static final int IDEA_ID = 39535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39535Service() {
        this(new Idea39535Config());
    }

    public Idea39535Service(Idea39535Config config) {
        this.config = config != null ? config : new Idea39535Config();
