...
@Data
public class Idea39617Config {
    private String name = "idea_039617";
 ...
 */
@Slf4j
public class Idea39617Service {
    private static final int IDEA_ID = 39617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39617Service() {
        this(new Idea39617Config());
    }

    public Idea39617Service(Idea39617Config config) {
        this.config = config != null ? config : new Idea39617Config();
