...
@Data
public class Idea39643Config {
    private String name = "idea_039643";
 ...
 */
@Slf4j
public class Idea39643Service {
    private static final int IDEA_ID = 39643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39643Service() {
        this(new Idea39643Config());
    }

    public Idea39643Service(Idea39643Config config) {
        this.config = config != null ? config : new Idea39643Config();
