...
@Data
public class Idea39571Config {
    private String name = "idea_039571";
 ...
 */
@Slf4j
public class Idea39571Service {
    private static final int IDEA_ID = 39571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39571Service() {
        this(new Idea39571Config());
    }

    public Idea39571Service(Idea39571Config config) {
        this.config = config != null ? config : new Idea39571Config();
