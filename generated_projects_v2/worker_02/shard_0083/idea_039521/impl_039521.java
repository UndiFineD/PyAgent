...
@Data
public class Idea39521Config {
    private String name = "idea_039521";
 ...
 */
@Slf4j
public class Idea39521Service {
    private static final int IDEA_ID = 39521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39521Service() {
        this(new Idea39521Config());
    }

    public Idea39521Service(Idea39521Config config) {
        this.config = config != null ? config : new Idea39521Config();
