...
@Data
public class Idea39600Config {
    private String name = "idea_039600";
 ...
 */
@Slf4j
public class Idea39600Service {
    private static final int IDEA_ID = 39600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39600Service() {
        this(new Idea39600Config());
    }

    public Idea39600Service(Idea39600Config config) {
        this.config = config != null ? config : new Idea39600Config();
