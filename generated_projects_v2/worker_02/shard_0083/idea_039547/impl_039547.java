...
@Data
public class Idea39547Config {
    private String name = "idea_039547";
 ...
 */
@Slf4j
public class Idea39547Service {
    private static final int IDEA_ID = 39547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39547Service() {
        this(new Idea39547Config());
    }

    public Idea39547Service(Idea39547Config config) {
        this.config = config != null ? config : new Idea39547Config();
