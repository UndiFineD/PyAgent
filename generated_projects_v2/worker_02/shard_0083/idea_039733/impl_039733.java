...
@Data
public class Idea39733Config {
    private String name = "idea_039733";
 ...
 */
@Slf4j
public class Idea39733Service {
    private static final int IDEA_ID = 39733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39733Service() {
        this(new Idea39733Config());
    }

    public Idea39733Service(Idea39733Config config) {
        this.config = config != null ? config : new Idea39733Config();
