...
@Data
public class Idea39781Config {
    private String name = "idea_039781";
 ...
 */
@Slf4j
public class Idea39781Service {
    private static final int IDEA_ID = 39781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39781Service() {
        this(new Idea39781Config());
    }

    public Idea39781Service(Idea39781Config config) {
        this.config = config != null ? config : new Idea39781Config();
