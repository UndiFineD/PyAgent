...
@Data
public class Idea39451Config {
    private String name = "idea_039451";
 ...
 */
@Slf4j
public class Idea39451Service {
    private static final int IDEA_ID = 39451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39451Service() {
        this(new Idea39451Config());
    }

    public Idea39451Service(Idea39451Config config) {
        this.config = config != null ? config : new Idea39451Config();
