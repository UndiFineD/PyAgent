...
@Data
public class Idea39605Config {
    private String name = "idea_039605";
 ...
 */
@Slf4j
public class Idea39605Service {
    private static final int IDEA_ID = 39605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39605Service() {
        this(new Idea39605Config());
    }

    public Idea39605Service(Idea39605Config config) {
        this.config = config != null ? config : new Idea39605Config();
