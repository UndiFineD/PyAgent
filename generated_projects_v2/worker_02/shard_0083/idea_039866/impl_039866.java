...
@Data
public class Idea39866Config {
    private String name = "idea_039866";
 ...
 */
@Slf4j
public class Idea39866Service {
    private static final int IDEA_ID = 39866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39866Service() {
        this(new Idea39866Config());
    }

    public Idea39866Service(Idea39866Config config) {
        this.config = config != null ? config : new Idea39866Config();
