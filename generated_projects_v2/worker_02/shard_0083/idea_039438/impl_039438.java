...
@Data
public class Idea39438Config {
    private String name = "idea_039438";
 ...
 */
@Slf4j
public class Idea39438Service {
    private static final int IDEA_ID = 39438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39438Service() {
        this(new Idea39438Config());
    }

    public Idea39438Service(Idea39438Config config) {
        this.config = config != null ? config : new Idea39438Config();
