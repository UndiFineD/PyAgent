...
@Data
public class Idea39557Config {
    private String name = "idea_039557";
 ...
 */
@Slf4j
public class Idea39557Service {
    private static final int IDEA_ID = 39557;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39557Service() {
        this(new Idea39557Config());
    }

    public Idea39557Service(Idea39557Config config) {
        this.config = config != null ? config : new Idea39557Config();
