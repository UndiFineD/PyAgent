...
@Data
public class Idea39710Config {
    private String name = "idea_039710";
 ...
 */
@Slf4j
public class Idea39710Service {
    private static final int IDEA_ID = 39710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39710Service() {
        this(new Idea39710Config());
    }

    public Idea39710Service(Idea39710Config config) {
        this.config = config != null ? config : new Idea39710Config();
