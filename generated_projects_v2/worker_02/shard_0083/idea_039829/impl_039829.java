...
@Data
public class Idea39829Config {
    private String name = "idea_039829";
 ...
 */
@Slf4j
public class Idea39829Service {
    private static final int IDEA_ID = 39829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39829Service() {
        this(new Idea39829Config());
    }

    public Idea39829Service(Idea39829Config config) {
        this.config = config != null ? config : new Idea39829Config();
