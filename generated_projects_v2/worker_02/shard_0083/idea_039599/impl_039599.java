...
@Data
public class Idea39599Config {
    private String name = "idea_039599";
 ...
 */
@Slf4j
public class Idea39599Service {
    private static final int IDEA_ID = 39599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39599Service() {
        this(new Idea39599Config());
    }

    public Idea39599Service(Idea39599Config config) {
        this.config = config != null ? config : new Idea39599Config();
