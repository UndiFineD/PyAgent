...
@Data
public class Idea39591Config {
    private String name = "idea_039591";
 ...
 */
@Slf4j
public class Idea39591Service {
    private static final int IDEA_ID = 39591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39591Service() {
        this(new Idea39591Config());
    }

    public Idea39591Service(Idea39591Config config) {
        this.config = config != null ? config : new Idea39591Config();
