...
@Data
public class Idea39642Config {
    private String name = "idea_039642";
 ...
 */
@Slf4j
public class Idea39642Service {
    private static final int IDEA_ID = 39642;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39642Service() {
        this(new Idea39642Config());
    }

    public Idea39642Service(Idea39642Config config) {
        this.config = config != null ? config : new Idea39642Config();
