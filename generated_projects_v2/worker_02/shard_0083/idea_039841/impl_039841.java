...
@Data
public class Idea39841Config {
    private String name = "idea_039841";
 ...
 */
@Slf4j
public class Idea39841Service {
    private static final int IDEA_ID = 39841;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39841Service() {
        this(new Idea39841Config());
    }

    public Idea39841Service(Idea39841Config config) {
        this.config = config != null ? config : new Idea39841Config();
