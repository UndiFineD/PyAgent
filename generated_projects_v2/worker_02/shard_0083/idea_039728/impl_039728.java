...
@Data
public class Idea39728Config {
    private String name = "idea_039728";
 ...
 */
@Slf4j
public class Idea39728Service {
    private static final int IDEA_ID = 39728;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39728Service() {
        this(new Idea39728Config());
    }

    public Idea39728Service(Idea39728Config config) {
        this.config = config != null ? config : new Idea39728Config();
