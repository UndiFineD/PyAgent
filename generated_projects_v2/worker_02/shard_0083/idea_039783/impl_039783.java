...
@Data
public class Idea39783Config {
    private String name = "idea_039783";
 ...
 */
@Slf4j
public class Idea39783Service {
    private static final int IDEA_ID = 39783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39783Service() {
        this(new Idea39783Config());
    }

    public Idea39783Service(Idea39783Config config) {
        this.config = config != null ? config : new Idea39783Config();
