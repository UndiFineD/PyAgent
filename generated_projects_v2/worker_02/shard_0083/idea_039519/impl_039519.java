...
@Data
public class Idea39519Config {
    private String name = "idea_039519";
 ...
 */
@Slf4j
public class Idea39519Service {
    private static final int IDEA_ID = 39519;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39519Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39519Service() {
        this(new Idea39519Config());
    }

    public Idea39519Service(Idea39519Config config) {
        this.config = config != null ? config : new Idea39519Config();
