...
@Data
public class Idea39505Config {
    private String name = "idea_039505";
 ...
 */
@Slf4j
public class Idea39505Service {
    private static final int IDEA_ID = 39505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39505Service() {
        this(new Idea39505Config());
    }

    public Idea39505Service(Idea39505Config config) {
        this.config = config != null ? config : new Idea39505Config();
