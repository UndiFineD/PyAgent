...
@Data
public class Idea39624Config {
    private String name = "idea_039624";
 ...
 */
@Slf4j
public class Idea39624Service {
    private static final int IDEA_ID = 39624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39624Service() {
        this(new Idea39624Config());
    }

    public Idea39624Service(Idea39624Config config) {
        this.config = config != null ? config : new Idea39624Config();
