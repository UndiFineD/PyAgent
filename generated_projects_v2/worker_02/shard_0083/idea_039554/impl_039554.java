...
@Data
public class Idea39554Config {
    private String name = "idea_039554";
 ...
 */
@Slf4j
public class Idea39554Service {
    private static final int IDEA_ID = 39554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39554Service() {
        this(new Idea39554Config());
    }

    public Idea39554Service(Idea39554Config config) {
        this.config = config != null ? config : new Idea39554Config();
