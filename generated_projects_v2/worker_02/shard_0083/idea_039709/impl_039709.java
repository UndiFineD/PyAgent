...
@Data
public class Idea39709Config {
    private String name = "idea_039709";
 ...
 */
@Slf4j
public class Idea39709Service {
    private static final int IDEA_ID = 39709;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39709Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39709Service() {
        this(new Idea39709Config());
    }

    public Idea39709Service(Idea39709Config config) {
        this.config = config != null ? config : new Idea39709Config();
