...
@Data
public class Idea39667Config {
    private String name = "idea_039667";
 ...
 */
@Slf4j
public class Idea39667Service {
    private static final int IDEA_ID = 39667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39667Service() {
        this(new Idea39667Config());
    }

    public Idea39667Service(Idea39667Config config) {
        this.config = config != null ? config : new Idea39667Config();
