...
@Data
public class Idea39810Config {
    private String name = "idea_039810";
 ...
 */
@Slf4j
public class Idea39810Service {
    private static final int IDEA_ID = 39810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39810Service() {
        this(new Idea39810Config());
    }

    public Idea39810Service(Idea39810Config config) {
        this.config = config != null ? config : new Idea39810Config();
