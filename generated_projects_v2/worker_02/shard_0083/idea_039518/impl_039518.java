...
@Data
public class Idea39518Config {
    private String name = "idea_039518";
 ...
 */
@Slf4j
public class Idea39518Service {
    private static final int IDEA_ID = 39518;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39518Service() {
        this(new Idea39518Config());
    }

    public Idea39518Service(Idea39518Config config) {
        this.config = config != null ? config : new Idea39518Config();
