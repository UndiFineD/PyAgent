...
@Data
public class Idea39530Config {
    private String name = "idea_039530";
 ...
 */
@Slf4j
public class Idea39530Service {
    private static final int IDEA_ID = 39530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39530Service() {
        this(new Idea39530Config());
    }

    public Idea39530Service(Idea39530Config config) {
        this.config = config != null ? config : new Idea39530Config();
