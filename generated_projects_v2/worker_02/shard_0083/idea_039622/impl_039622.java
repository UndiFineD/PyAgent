...
@Data
public class Idea39622Config {
    private String name = "idea_039622";
 ...
 */
@Slf4j
public class Idea39622Service {
    private static final int IDEA_ID = 39622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39622Service() {
        this(new Idea39622Config());
    }

    public Idea39622Service(Idea39622Config config) {
        this.config = config != null ? config : new Idea39622Config();
