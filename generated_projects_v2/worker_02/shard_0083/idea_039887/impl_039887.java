...
@Data
public class Idea39887Config {
    private String name = "idea_039887";
 ...
 */
@Slf4j
public class Idea39887Service {
    private static final int IDEA_ID = 39887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39887Service() {
        this(new Idea39887Config());
    }

    public Idea39887Service(Idea39887Config config) {
        this.config = config != null ? config : new Idea39887Config();
