...
@Data
public class Idea39764Config {
    private String name = "idea_039764";
 ...
 */
@Slf4j
public class Idea39764Service {
    private static final int IDEA_ID = 39764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39764Service() {
        this(new Idea39764Config());
    }

    public Idea39764Service(Idea39764Config config) {
        this.config = config != null ? config : new Idea39764Config();
