...
@Data
public class Idea39611Config {
    private String name = "idea_039611";
 ...
 */
@Slf4j
public class Idea39611Service {
    private static final int IDEA_ID = 39611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39611Service() {
        this(new Idea39611Config());
    }

    public Idea39611Service(Idea39611Config config) {
        this.config = config != null ? config : new Idea39611Config();
