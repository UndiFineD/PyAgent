...
@Data
public class Idea39540Config {
    private String name = "idea_039540";
 ...
 */
@Slf4j
public class Idea39540Service {
    private static final int IDEA_ID = 39540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39540Service() {
        this(new Idea39540Config());
    }

    public Idea39540Service(Idea39540Config config) {
        this.config = config != null ? config : new Idea39540Config();
