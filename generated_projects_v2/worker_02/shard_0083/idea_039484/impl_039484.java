...
@Data
public class Idea39484Config {
    private String name = "idea_039484";
 ...
 */
@Slf4j
public class Idea39484Service {
    private static final int IDEA_ID = 39484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39484Service() {
        this(new Idea39484Config());
    }

    public Idea39484Service(Idea39484Config config) {
        this.config = config != null ? config : new Idea39484Config();
