...
@Data
public class Idea39618Config {
    private String name = "idea_039618";
 ...
 */
@Slf4j
public class Idea39618Service {
    private static final int IDEA_ID = 39618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39618Service() {
        this(new Idea39618Config());
    }

    public Idea39618Service(Idea39618Config config) {
        this.config = config != null ? config : new Idea39618Config();
