...
@Data
public class Idea39794Config {
    private String name = "idea_039794";
 ...
 */
@Slf4j
public class Idea39794Service {
    private static final int IDEA_ID = 39794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39794Service() {
        this(new Idea39794Config());
    }

    public Idea39794Service(Idea39794Config config) {
        this.config = config != null ? config : new Idea39794Config();
