...
@Data
public class Idea39592Config {
    private String name = "idea_039592";
 ...
 */
@Slf4j
public class Idea39592Service {
    private static final int IDEA_ID = 39592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39592Service() {
        this(new Idea39592Config());
    }

    public Idea39592Service(Idea39592Config config) {
        this.config = config != null ? config : new Idea39592Config();
