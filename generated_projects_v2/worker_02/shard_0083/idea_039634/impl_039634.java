...
@Data
public class Idea39634Config {
    private String name = "idea_039634";
 ...
 */
@Slf4j
public class Idea39634Service {
    private static final int IDEA_ID = 39634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39634Service() {
        this(new Idea39634Config());
    }

    public Idea39634Service(Idea39634Config config) {
        this.config = config != null ? config : new Idea39634Config();
