...
@Data
public class Idea39436Config {
    private String name = "idea_039436";
 ...
 */
@Slf4j
public class Idea39436Service {
    private static final int IDEA_ID = 39436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39436Service() {
        this(new Idea39436Config());
    }

    public Idea39436Service(Idea39436Config config) {
        this.config = config != null ? config : new Idea39436Config();
