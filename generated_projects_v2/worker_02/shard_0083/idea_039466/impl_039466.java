...
@Data
public class Idea39466Config {
    private String name = "idea_039466";
 ...
 */
@Slf4j
public class Idea39466Service {
    private static final int IDEA_ID = 39466;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39466Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39466Service() {
        this(new Idea39466Config());
    }

    public Idea39466Service(Idea39466Config config) {
        this.config = config != null ? config : new Idea39466Config();
