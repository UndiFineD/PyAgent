...
@Data
public class Idea39596Config {
    private String name = "idea_039596";
 ...
 */
@Slf4j
public class Idea39596Service {
    private static final int IDEA_ID = 39596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39596Service() {
        this(new Idea39596Config());
    }

    public Idea39596Service(Idea39596Config config) {
        this.config = config != null ? config : new Idea39596Config();
