...
@Data
public class Idea39700Config {
    private String name = "idea_039700";
 ...
 */
@Slf4j
public class Idea39700Service {
    private static final int IDEA_ID = 39700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39700Service() {
        this(new Idea39700Config());
    }

    public Idea39700Service(Idea39700Config config) {
        this.config = config != null ? config : new Idea39700Config();
