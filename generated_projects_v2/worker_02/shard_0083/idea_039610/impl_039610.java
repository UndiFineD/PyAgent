...
@Data
public class Idea39610Config {
    private String name = "idea_039610";
 ...
 */
@Slf4j
public class Idea39610Service {
    private static final int IDEA_ID = 39610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39610Service() {
        this(new Idea39610Config());
    }

    public Idea39610Service(Idea39610Config config) {
        this.config = config != null ? config : new Idea39610Config();
