...
@Data
public class Idea39462Config {
    private String name = "idea_039462";
 ...
 */
@Slf4j
public class Idea39462Service {
    private static final int IDEA_ID = 39462;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39462Service() {
        this(new Idea39462Config());
    }

    public Idea39462Service(Idea39462Config config) {
        this.config = config != null ? config : new Idea39462Config();
