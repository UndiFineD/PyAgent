...
@Data
public class Idea39780Config {
    private String name = "idea_039780";
 ...
 */
@Slf4j
public class Idea39780Service {
    private static final int IDEA_ID = 39780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea39780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea39780Service() {
        this(new Idea39780Config());
    }

    public Idea39780Service(Idea39780Config config) {
        this.config = config != null ? config : new Idea39780Config();
