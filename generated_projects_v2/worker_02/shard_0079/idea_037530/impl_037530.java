...
@Data
public class Idea37530Config {
    private String name = "idea_037530";
 ...
 */
@Slf4j
public class Idea37530Service {
    private static final int IDEA_ID = 37530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37530Service() {
        this(new Idea37530Config());
    }

    public Idea37530Service(Idea37530Config config) {
        this.config = config != null ? config : new Idea37530Config();
