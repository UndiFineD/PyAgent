...
@Data
public class Idea37970Config {
    private String name = "idea_037970";
 ...
 */
@Slf4j
public class Idea37970Service {
    private static final int IDEA_ID = 37970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37970Service() {
        this(new Idea37970Config());
    }

    public Idea37970Service(Idea37970Config config) {
        this.config = config != null ? config : new Idea37970Config();
