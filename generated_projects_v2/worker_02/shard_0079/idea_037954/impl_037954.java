...
@Data
public class Idea37954Config {
    private String name = "idea_037954";
 ...
 */
@Slf4j
public class Idea37954Service {
    private static final int IDEA_ID = 37954;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37954Service() {
        this(new Idea37954Config());
    }

    public Idea37954Service(Idea37954Config config) {
        this.config = config != null ? config : new Idea37954Config();
