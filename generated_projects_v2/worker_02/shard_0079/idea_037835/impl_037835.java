...
@Data
public class Idea37835Config {
    private String name = "idea_037835";
 ...
 */
@Slf4j
public class Idea37835Service {
    private static final int IDEA_ID = 37835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37835Service() {
        this(new Idea37835Config());
    }

    public Idea37835Service(Idea37835Config config) {
        this.config = config != null ? config : new Idea37835Config();
