...
@Data
public class Idea37943Config {
    private String name = "idea_037943";
 ...
 */
@Slf4j
public class Idea37943Service {
    private static final int IDEA_ID = 37943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37943Service() {
        this(new Idea37943Config());
    }

    public Idea37943Service(Idea37943Config config) {
        this.config = config != null ? config : new Idea37943Config();
