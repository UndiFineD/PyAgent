...
@Data
public class Idea37843Config {
    private String name = "idea_037843";
 ...
 */
@Slf4j
public class Idea37843Service {
    private static final int IDEA_ID = 37843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37843Service() {
        this(new Idea37843Config());
    }

    public Idea37843Service(Idea37843Config config) {
        this.config = config != null ? config : new Idea37843Config();
