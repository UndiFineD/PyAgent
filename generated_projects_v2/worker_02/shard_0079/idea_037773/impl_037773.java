...
@Data
public class Idea37773Config {
    private String name = "idea_037773";
 ...
 */
@Slf4j
public class Idea37773Service {
    private static final int IDEA_ID = 37773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37773Service() {
        this(new Idea37773Config());
    }

    public Idea37773Service(Idea37773Config config) {
        this.config = config != null ? config : new Idea37773Config();
