...
@Data
public class Idea37883Config {
    private String name = "idea_037883";
 ...
 */
@Slf4j
public class Idea37883Service {
    private static final int IDEA_ID = 37883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37883Service() {
        this(new Idea37883Config());
    }

    public Idea37883Service(Idea37883Config config) {
        this.config = config != null ? config : new Idea37883Config();
