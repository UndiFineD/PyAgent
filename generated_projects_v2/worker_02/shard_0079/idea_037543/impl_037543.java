...
@Data
public class Idea37543Config {
    private String name = "idea_037543";
 ...
 */
@Slf4j
public class Idea37543Service {
    private static final int IDEA_ID = 37543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37543Service() {
        this(new Idea37543Config());
    }

    public Idea37543Service(Idea37543Config config) {
        this.config = config != null ? config : new Idea37543Config();
