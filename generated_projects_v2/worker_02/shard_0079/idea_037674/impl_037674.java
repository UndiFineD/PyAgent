...
@Data
public class Idea37674Config {
    private String name = "idea_037674";
 ...
 */
@Slf4j
public class Idea37674Service {
    private static final int IDEA_ID = 37674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37674Service() {
        this(new Idea37674Config());
    }

    public Idea37674Service(Idea37674Config config) {
        this.config = config != null ? config : new Idea37674Config();
