...
@Data
public class Idea37784Config {
    private String name = "idea_037784";
 ...
 */
@Slf4j
public class Idea37784Service {
    private static final int IDEA_ID = 37784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37784Service() {
        this(new Idea37784Config());
    }

    public Idea37784Service(Idea37784Config config) {
        this.config = config != null ? config : new Idea37784Config();
