...
@Data
public class Idea37746Config {
    private String name = "idea_037746";
 ...
 */
@Slf4j
public class Idea37746Service {
    private static final int IDEA_ID = 37746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37746Service() {
        this(new Idea37746Config());
    }

    public Idea37746Service(Idea37746Config config) {
        this.config = config != null ? config : new Idea37746Config();
