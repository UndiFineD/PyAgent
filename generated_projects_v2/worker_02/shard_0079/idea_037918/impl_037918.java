...
@Data
public class Idea37918Config {
    private String name = "idea_037918";
 ...
 */
@Slf4j
public class Idea37918Service {
    private static final int IDEA_ID = 37918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37918Service() {
        this(new Idea37918Config());
    }

    public Idea37918Service(Idea37918Config config) {
        this.config = config != null ? config : new Idea37918Config();
