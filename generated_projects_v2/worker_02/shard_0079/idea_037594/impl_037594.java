...
@Data
public class Idea37594Config {
    private String name = "idea_037594";
 ...
 */
@Slf4j
public class Idea37594Service {
    private static final int IDEA_ID = 37594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37594Service() {
        this(new Idea37594Config());
    }

    public Idea37594Service(Idea37594Config config) {
        this.config = config != null ? config : new Idea37594Config();
