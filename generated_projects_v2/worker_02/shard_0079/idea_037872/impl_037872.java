...
@Data
public class Idea37872Config {
    private String name = "idea_037872";
 ...
 */
@Slf4j
public class Idea37872Service {
    private static final int IDEA_ID = 37872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37872Service() {
        this(new Idea37872Config());
    }

    public Idea37872Service(Idea37872Config config) {
        this.config = config != null ? config : new Idea37872Config();
