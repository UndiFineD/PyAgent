...
@Data
public class Idea37892Config {
    private String name = "idea_037892";
 ...
 */
@Slf4j
public class Idea37892Service {
    private static final int IDEA_ID = 37892;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37892Service() {
        this(new Idea37892Config());
    }

    public Idea37892Service(Idea37892Config config) {
        this.config = config != null ? config : new Idea37892Config();
