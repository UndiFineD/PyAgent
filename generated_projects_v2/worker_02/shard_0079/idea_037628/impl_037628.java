...
@Data
public class Idea37628Config {
    private String name = "idea_037628";
 ...
 */
@Slf4j
public class Idea37628Service {
    private static final int IDEA_ID = 37628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37628Service() {
        this(new Idea37628Config());
    }

    public Idea37628Service(Idea37628Config config) {
        this.config = config != null ? config : new Idea37628Config();
