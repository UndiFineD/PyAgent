...
@Data
public class Idea37552Config {
    private String name = "idea_037552";
 ...
 */
@Slf4j
public class Idea37552Service {
    private static final int IDEA_ID = 37552;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37552Service() {
        this(new Idea37552Config());
    }

    public Idea37552Service(Idea37552Config config) {
        this.config = config != null ? config : new Idea37552Config();
