...
@Data
public class Idea37727Config {
    private String name = "idea_037727";
 ...
 */
@Slf4j
public class Idea37727Service {
    private static final int IDEA_ID = 37727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37727Service() {
        this(new Idea37727Config());
    }

    public Idea37727Service(Idea37727Config config) {
        this.config = config != null ? config : new Idea37727Config();
