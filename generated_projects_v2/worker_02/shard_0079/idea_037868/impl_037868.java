...
@Data
public class Idea37868Config {
    private String name = "idea_037868";
 ...
 */
@Slf4j
public class Idea37868Service {
    private static final int IDEA_ID = 37868;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37868Service() {
        this(new Idea37868Config());
    }

    public Idea37868Service(Idea37868Config config) {
        this.config = config != null ? config : new Idea37868Config();
