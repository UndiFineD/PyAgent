...
@Data
public class Idea37994Config {
    private String name = "idea_037994";
 ...
 */
@Slf4j
public class Idea37994Service {
    private static final int IDEA_ID = 37994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37994Service() {
        this(new Idea37994Config());
    }

    public Idea37994Service(Idea37994Config config) {
        this.config = config != null ? config : new Idea37994Config();
