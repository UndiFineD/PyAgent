...
@Data
public class Idea37906Config {
    private String name = "idea_037906";
 ...
 */
@Slf4j
public class Idea37906Service {
    private static final int IDEA_ID = 37906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37906Service() {
        this(new Idea37906Config());
    }

    public Idea37906Service(Idea37906Config config) {
        this.config = config != null ? config : new Idea37906Config();
