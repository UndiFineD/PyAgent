...
@Data
public class Idea37582Config {
    private String name = "idea_037582";
 ...
 */
@Slf4j
public class Idea37582Service {
    private static final int IDEA_ID = 37582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37582Service() {
        this(new Idea37582Config());
    }

    public Idea37582Service(Idea37582Config config) {
        this.config = config != null ? config : new Idea37582Config();
