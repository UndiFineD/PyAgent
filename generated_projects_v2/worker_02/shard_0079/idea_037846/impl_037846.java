...
@Data
public class Idea37846Config {
    private String name = "idea_037846";
 ...
 */
@Slf4j
public class Idea37846Service {
    private static final int IDEA_ID = 37846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37846Service() {
        this(new Idea37846Config());
    }

    public Idea37846Service(Idea37846Config config) {
        this.config = config != null ? config : new Idea37846Config();
