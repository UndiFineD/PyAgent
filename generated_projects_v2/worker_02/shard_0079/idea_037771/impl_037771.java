...
@Data
public class Idea37771Config {
    private String name = "idea_037771";
 ...
 */
@Slf4j
public class Idea37771Service {
    private static final int IDEA_ID = 37771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37771Service() {
        this(new Idea37771Config());
    }

    public Idea37771Service(Idea37771Config config) {
        this.config = config != null ? config : new Idea37771Config();
