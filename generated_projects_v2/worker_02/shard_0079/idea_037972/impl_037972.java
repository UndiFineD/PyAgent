...
@Data
public class Idea37972Config {
    private String name = "idea_037972";
 ...
 */
@Slf4j
public class Idea37972Service {
    private static final int IDEA_ID = 37972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37972Service() {
        this(new Idea37972Config());
    }

    public Idea37972Service(Idea37972Config config) {
        this.config = config != null ? config : new Idea37972Config();
