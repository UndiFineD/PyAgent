...
@Data
public class Idea37772Config {
    private String name = "idea_037772";
 ...
 */
@Slf4j
public class Idea37772Service {
    private static final int IDEA_ID = 37772;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37772Service() {
        this(new Idea37772Config());
    }

    public Idea37772Service(Idea37772Config config) {
        this.config = config != null ? config : new Idea37772Config();
