...
@Data
public class Idea37967Config {
    private String name = "idea_037967";
 ...
 */
@Slf4j
public class Idea37967Service {
    private static final int IDEA_ID = 37967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37967Service() {
        this(new Idea37967Config());
    }

    public Idea37967Service(Idea37967Config config) {
        this.config = config != null ? config : new Idea37967Config();
