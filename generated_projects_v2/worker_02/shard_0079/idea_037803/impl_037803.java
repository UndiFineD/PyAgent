...
@Data
public class Idea37803Config {
    private String name = "idea_037803";
 ...
 */
@Slf4j
public class Idea37803Service {
    private static final int IDEA_ID = 37803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37803Service() {
        this(new Idea37803Config());
    }

    public Idea37803Service(Idea37803Config config) {
        this.config = config != null ? config : new Idea37803Config();
