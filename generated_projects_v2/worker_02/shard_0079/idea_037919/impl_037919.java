...
@Data
public class Idea37919Config {
    private String name = "idea_037919";
 ...
 */
@Slf4j
public class Idea37919Service {
    private static final int IDEA_ID = 37919;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37919Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37919Service() {
        this(new Idea37919Config());
    }

    public Idea37919Service(Idea37919Config config) {
        this.config = config != null ? config : new Idea37919Config();
