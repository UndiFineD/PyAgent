...
@Data
public class Idea37996Config {
    private String name = "idea_037996";
 ...
 */
@Slf4j
public class Idea37996Service {
    private static final int IDEA_ID = 37996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37996Service() {
        this(new Idea37996Config());
    }

    public Idea37996Service(Idea37996Config config) {
        this.config = config != null ? config : new Idea37996Config();
