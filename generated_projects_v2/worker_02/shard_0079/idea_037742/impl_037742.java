...
@Data
public class Idea37742Config {
    private String name = "idea_037742";
 ...
 */
@Slf4j
public class Idea37742Service {
    private static final int IDEA_ID = 37742;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37742Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37742Service() {
        this(new Idea37742Config());
    }

    public Idea37742Service(Idea37742Config config) {
        this.config = config != null ? config : new Idea37742Config();
