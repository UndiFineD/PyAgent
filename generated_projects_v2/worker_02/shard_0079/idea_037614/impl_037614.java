...
@Data
public class Idea37614Config {
    private String name = "idea_037614";
 ...
 */
@Slf4j
public class Idea37614Service {
    private static final int IDEA_ID = 37614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37614Service() {
        this(new Idea37614Config());
    }

    public Idea37614Service(Idea37614Config config) {
        this.config = config != null ? config : new Idea37614Config();
