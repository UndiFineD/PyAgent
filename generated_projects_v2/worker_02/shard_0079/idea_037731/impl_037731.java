...
@Data
public class Idea37731Config {
    private String name = "idea_037731";
 ...
 */
@Slf4j
public class Idea37731Service {
    private static final int IDEA_ID = 37731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37731Service() {
        this(new Idea37731Config());
    }

    public Idea37731Service(Idea37731Config config) {
        this.config = config != null ? config : new Idea37731Config();
