...
@Data
public class Idea37854Config {
    private String name = "idea_037854";
 ...
 */
@Slf4j
public class Idea37854Service {
    private static final int IDEA_ID = 37854;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37854Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37854Service() {
        this(new Idea37854Config());
    }

    public Idea37854Service(Idea37854Config config) {
        this.config = config != null ? config : new Idea37854Config();
