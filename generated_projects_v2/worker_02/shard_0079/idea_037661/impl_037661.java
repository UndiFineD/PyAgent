...
@Data
public class Idea37661Config {
    private String name = "idea_037661";
 ...
 */
@Slf4j
public class Idea37661Service {
    private static final int IDEA_ID = 37661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37661Service() {
        this(new Idea37661Config());
    }

    public Idea37661Service(Idea37661Config config) {
        this.config = config != null ? config : new Idea37661Config();
