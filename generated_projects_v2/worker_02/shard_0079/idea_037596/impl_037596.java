...
@Data
public class Idea37596Config {
    private String name = "idea_037596";
 ...
 */
@Slf4j
public class Idea37596Service {
    private static final int IDEA_ID = 37596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37596Service() {
        this(new Idea37596Config());
    }

    public Idea37596Service(Idea37596Config config) {
        this.config = config != null ? config : new Idea37596Config();
