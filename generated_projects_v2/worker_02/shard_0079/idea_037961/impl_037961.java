...
@Data
public class Idea37961Config {
    private String name = "idea_037961";
 ...
 */
@Slf4j
public class Idea37961Service {
    private static final int IDEA_ID = 37961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37961Service() {
        this(new Idea37961Config());
    }

    public Idea37961Service(Idea37961Config config) {
        this.config = config != null ? config : new Idea37961Config();
