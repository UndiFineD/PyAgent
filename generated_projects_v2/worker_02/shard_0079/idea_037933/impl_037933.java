...
@Data
public class Idea37933Config {
    private String name = "idea_037933";
 ...
 */
@Slf4j
public class Idea37933Service {
    private static final int IDEA_ID = 37933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37933Service() {
        this(new Idea37933Config());
    }

    public Idea37933Service(Idea37933Config config) {
        this.config = config != null ? config : new Idea37933Config();
