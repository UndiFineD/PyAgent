...
@Data
public class Idea37560Config {
    private String name = "idea_037560";
 ...
 */
@Slf4j
public class Idea37560Service {
    private static final int IDEA_ID = 37560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37560Service() {
        this(new Idea37560Config());
    }

    public Idea37560Service(Idea37560Config config) {
        this.config = config != null ? config : new Idea37560Config();
