...
@Data
public class Idea37989Config {
    private String name = "idea_037989";
 ...
 */
@Slf4j
public class Idea37989Service {
    private static final int IDEA_ID = 37989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37989Service() {
        this(new Idea37989Config());
    }

    public Idea37989Service(Idea37989Config config) {
        this.config = config != null ? config : new Idea37989Config();
