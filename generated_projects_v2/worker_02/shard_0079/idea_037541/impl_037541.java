...
@Data
public class Idea37541Config {
    private String name = "idea_037541";
 ...
 */
@Slf4j
public class Idea37541Service {
    private static final int IDEA_ID = 37541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37541Service() {
        this(new Idea37541Config());
    }

    public Idea37541Service(Idea37541Config config) {
        this.config = config != null ? config : new Idea37541Config();
