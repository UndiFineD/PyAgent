...
@Data
public class Idea37708Config {
    private String name = "idea_037708";
 ...
 */
@Slf4j
public class Idea37708Service {
    private static final int IDEA_ID = 37708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37708Service() {
        this(new Idea37708Config());
    }

    public Idea37708Service(Idea37708Config config) {
        this.config = config != null ? config : new Idea37708Config();
