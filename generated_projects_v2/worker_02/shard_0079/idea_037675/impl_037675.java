...
@Data
public class Idea37675Config {
    private String name = "idea_037675";
 ...
 */
@Slf4j
public class Idea37675Service {
    private static final int IDEA_ID = 37675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37675Service() {
        this(new Idea37675Config());
    }

    public Idea37675Service(Idea37675Config config) {
        this.config = config != null ? config : new Idea37675Config();
