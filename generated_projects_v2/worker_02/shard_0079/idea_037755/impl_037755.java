...
@Data
public class Idea37755Config {
    private String name = "idea_037755";
 ...
 */
@Slf4j
public class Idea37755Service {
    private static final int IDEA_ID = 37755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37755Service() {
        this(new Idea37755Config());
    }

    public Idea37755Service(Idea37755Config config) {
        this.config = config != null ? config : new Idea37755Config();
