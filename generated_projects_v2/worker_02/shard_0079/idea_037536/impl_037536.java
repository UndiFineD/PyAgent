...
@Data
public class Idea37536Config {
    private String name = "idea_037536";
 ...
 */
@Slf4j
public class Idea37536Service {
    private static final int IDEA_ID = 37536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37536Service() {
        this(new Idea37536Config());
    }

    public Idea37536Service(Idea37536Config config) {
        this.config = config != null ? config : new Idea37536Config();
