...
@Data
public class Idea37641Config {
    private String name = "idea_037641";
 ...
 */
@Slf4j
public class Idea37641Service {
    private static final int IDEA_ID = 37641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37641Service() {
        this(new Idea37641Config());
    }

    public Idea37641Service(Idea37641Config config) {
        this.config = config != null ? config : new Idea37641Config();
