...
@Data
public class Idea37826Config {
    private String name = "idea_037826";
 ...
 */
@Slf4j
public class Idea37826Service {
    private static final int IDEA_ID = 37826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37826Service() {
        this(new Idea37826Config());
    }

    public Idea37826Service(Idea37826Config config) {
        this.config = config != null ? config : new Idea37826Config();
