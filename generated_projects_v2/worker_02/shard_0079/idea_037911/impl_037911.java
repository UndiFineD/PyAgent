...
@Data
public class Idea37911Config {
    private String name = "idea_037911";
 ...
 */
@Slf4j
public class Idea37911Service {
    private static final int IDEA_ID = 37911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37911Service() {
        this(new Idea37911Config());
    }

    public Idea37911Service(Idea37911Config config) {
        this.config = config != null ? config : new Idea37911Config();
