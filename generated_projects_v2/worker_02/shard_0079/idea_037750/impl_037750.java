...
@Data
public class Idea37750Config {
    private String name = "idea_037750";
 ...
 */
@Slf4j
public class Idea37750Service {
    private static final int IDEA_ID = 37750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37750Service() {
        this(new Idea37750Config());
    }

    public Idea37750Service(Idea37750Config config) {
        this.config = config != null ? config : new Idea37750Config();
