...
@Data
public class Idea37653Config {
    private String name = "idea_037653";
 ...
 */
@Slf4j
public class Idea37653Service {
    private static final int IDEA_ID = 37653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37653Service() {
        this(new Idea37653Config());
    }

    public Idea37653Service(Idea37653Config config) {
        this.config = config != null ? config : new Idea37653Config();
