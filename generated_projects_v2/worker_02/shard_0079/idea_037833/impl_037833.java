...
@Data
public class Idea37833Config {
    private String name = "idea_037833";
 ...
 */
@Slf4j
public class Idea37833Service {
    private static final int IDEA_ID = 37833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37833Service() {
        this(new Idea37833Config());
    }

    public Idea37833Service(Idea37833Config config) {
        this.config = config != null ? config : new Idea37833Config();
