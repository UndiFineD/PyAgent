...
@Data
public class Idea37821Config {
    private String name = "idea_037821";
 ...
 */
@Slf4j
public class Idea37821Service {
    private static final int IDEA_ID = 37821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37821Service() {
        this(new Idea37821Config());
    }

    public Idea37821Service(Idea37821Config config) {
        this.config = config != null ? config : new Idea37821Config();
