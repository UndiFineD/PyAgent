...
@Data
public class Idea37605Config {
    private String name = "idea_037605";
 ...
 */
@Slf4j
public class Idea37605Service {
    private static final int IDEA_ID = 37605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37605Service() {
        this(new Idea37605Config());
    }

    public Idea37605Service(Idea37605Config config) {
        this.config = config != null ? config : new Idea37605Config();
