...
@Data
public class Idea37780Config {
    private String name = "idea_037780";
 ...
 */
@Slf4j
public class Idea37780Service {
    private static final int IDEA_ID = 37780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37780Service() {
        this(new Idea37780Config());
    }

    public Idea37780Service(Idea37780Config config) {
        this.config = config != null ? config : new Idea37780Config();
