...
@Data
public class Idea37774Config {
    private String name = "idea_037774";
 ...
 */
@Slf4j
public class Idea37774Service {
    private static final int IDEA_ID = 37774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37774Service() {
        this(new Idea37774Config());
    }

    public Idea37774Service(Idea37774Config config) {
        this.config = config != null ? config : new Idea37774Config();
