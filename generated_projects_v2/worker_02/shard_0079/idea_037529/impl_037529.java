...
@Data
public class Idea37529Config {
    private String name = "idea_037529";
 ...
 */
@Slf4j
public class Idea37529Service {
    private static final int IDEA_ID = 37529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37529Service() {
        this(new Idea37529Config());
    }

    public Idea37529Service(Idea37529Config config) {
        this.config = config != null ? config : new Idea37529Config();
