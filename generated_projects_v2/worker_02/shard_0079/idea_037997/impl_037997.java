...
@Data
public class Idea37997Config {
    private String name = "idea_037997";
 ...
 */
@Slf4j
public class Idea37997Service {
    private static final int IDEA_ID = 37997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37997Service() {
        this(new Idea37997Config());
    }

    public Idea37997Service(Idea37997Config config) {
        this.config = config != null ? config : new Idea37997Config();
