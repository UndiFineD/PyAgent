...
@Data
public class Idea37669Config {
    private String name = "idea_037669";
 ...
 */
@Slf4j
public class Idea37669Service {
    private static final int IDEA_ID = 37669;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37669Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37669Service() {
        this(new Idea37669Config());
    }

    public Idea37669Service(Idea37669Config config) {
        this.config = config != null ? config : new Idea37669Config();
