...
@Data
public class Idea37600Config {
    private String name = "idea_037600";
 ...
 */
@Slf4j
public class Idea37600Service {
    private static final int IDEA_ID = 37600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37600Service() {
        this(new Idea37600Config());
    }

    public Idea37600Service(Idea37600Config config) {
        this.config = config != null ? config : new Idea37600Config();
