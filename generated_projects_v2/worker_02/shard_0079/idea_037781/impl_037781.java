...
@Data
public class Idea37781Config {
    private String name = "idea_037781";
 ...
 */
@Slf4j
public class Idea37781Service {
    private static final int IDEA_ID = 37781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37781Service() {
        this(new Idea37781Config());
    }

    public Idea37781Service(Idea37781Config config) {
        this.config = config != null ? config : new Idea37781Config();
