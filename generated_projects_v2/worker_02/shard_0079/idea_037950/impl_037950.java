...
@Data
public class Idea37950Config {
    private String name = "idea_037950";
 ...
 */
@Slf4j
public class Idea37950Service {
    private static final int IDEA_ID = 37950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37950Service() {
        this(new Idea37950Config());
    }

    public Idea37950Service(Idea37950Config config) {
        this.config = config != null ? config : new Idea37950Config();
