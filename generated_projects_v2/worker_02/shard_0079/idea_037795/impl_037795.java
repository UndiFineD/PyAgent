...
@Data
public class Idea37795Config {
    private String name = "idea_037795";
 ...
 */
@Slf4j
public class Idea37795Service {
    private static final int IDEA_ID = 37795;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37795Service() {
        this(new Idea37795Config());
    }

    public Idea37795Service(Idea37795Config config) {
        this.config = config != null ? config : new Idea37795Config();
