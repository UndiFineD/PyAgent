...
@Data
public class Idea37765Config {
    private String name = "idea_037765";
 ...
 */
@Slf4j
public class Idea37765Service {
    private static final int IDEA_ID = 37765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37765Service() {
        this(new Idea37765Config());
    }

    public Idea37765Service(Idea37765Config config) {
        this.config = config != null ? config : new Idea37765Config();
