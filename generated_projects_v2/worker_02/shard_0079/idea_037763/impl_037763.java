...
@Data
public class Idea37763Config {
    private String name = "idea_037763";
 ...
 */
@Slf4j
public class Idea37763Service {
    private static final int IDEA_ID = 37763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37763Service() {
        this(new Idea37763Config());
    }

    public Idea37763Service(Idea37763Config config) {
        this.config = config != null ? config : new Idea37763Config();
