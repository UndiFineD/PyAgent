...
@Data
public class Idea37891Config {
    private String name = "idea_037891";
 ...
 */
@Slf4j
public class Idea37891Service {
    private static final int IDEA_ID = 37891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37891Service() {
        this(new Idea37891Config());
    }

    public Idea37891Service(Idea37891Config config) {
        this.config = config != null ? config : new Idea37891Config();
