...
@Data
public class Idea37748Config {
    private String name = "idea_037748";
 ...
 */
@Slf4j
public class Idea37748Service {
    private static final int IDEA_ID = 37748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37748Service() {
        this(new Idea37748Config());
    }

    public Idea37748Service(Idea37748Config config) {
        this.config = config != null ? config : new Idea37748Config();
