...
@Data
public class Idea37958Config {
    private String name = "idea_037958";
 ...
 */
@Slf4j
public class Idea37958Service {
    private static final int IDEA_ID = 37958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37958Service() {
        this(new Idea37958Config());
    }

    public Idea37958Service(Idea37958Config config) {
        this.config = config != null ? config : new Idea37958Config();
