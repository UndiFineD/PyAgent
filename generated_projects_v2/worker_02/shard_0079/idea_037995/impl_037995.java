...
@Data
public class Idea37995Config {
    private String name = "idea_037995";
 ...
 */
@Slf4j
public class Idea37995Service {
    private static final int IDEA_ID = 37995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37995Service() {
        this(new Idea37995Config());
    }

    public Idea37995Service(Idea37995Config config) {
        this.config = config != null ? config : new Idea37995Config();
