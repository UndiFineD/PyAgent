...
@Data
public class Idea37988Config {
    private String name = "idea_037988";
 ...
 */
@Slf4j
public class Idea37988Service {
    private static final int IDEA_ID = 37988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37988Service() {
        this(new Idea37988Config());
    }

    public Idea37988Service(Idea37988Config config) {
        this.config = config != null ? config : new Idea37988Config();
