...
@Data
public class Idea37959Config {
    private String name = "idea_037959";
 ...
 */
@Slf4j
public class Idea37959Service {
    private static final int IDEA_ID = 37959;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37959Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37959Service() {
        this(new Idea37959Config());
    }

    public Idea37959Service(Idea37959Config config) {
        this.config = config != null ? config : new Idea37959Config();
