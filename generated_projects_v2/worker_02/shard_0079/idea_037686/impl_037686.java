...
@Data
public class Idea37686Config {
    private String name = "idea_037686";
 ...
 */
@Slf4j
public class Idea37686Service {
    private static final int IDEA_ID = 37686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37686Service() {
        this(new Idea37686Config());
    }

    public Idea37686Service(Idea37686Config config) {
        this.config = config != null ? config : new Idea37686Config();
