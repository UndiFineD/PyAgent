...
@Data
public class Idea37887Config {
    private String name = "idea_037887";
 ...
 */
@Slf4j
public class Idea37887Service {
    private static final int IDEA_ID = 37887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37887Service() {
        this(new Idea37887Config());
    }

    public Idea37887Service(Idea37887Config config) {
        this.config = config != null ? config : new Idea37887Config();
