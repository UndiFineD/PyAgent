...
@Data
public class Idea37702Config {
    private String name = "idea_037702";
 ...
 */
@Slf4j
public class Idea37702Service {
    private static final int IDEA_ID = 37702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37702Service() {
        this(new Idea37702Config());
    }

    public Idea37702Service(Idea37702Config config) {
        this.config = config != null ? config : new Idea37702Config();
