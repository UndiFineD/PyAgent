...
@Data
public class Idea37932Config {
    private String name = "idea_037932";
 ...
 */
@Slf4j
public class Idea37932Service {
    private static final int IDEA_ID = 37932;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37932Service() {
        this(new Idea37932Config());
    }

    public Idea37932Service(Idea37932Config config) {
        this.config = config != null ? config : new Idea37932Config();
