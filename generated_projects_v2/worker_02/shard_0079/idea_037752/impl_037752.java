...
@Data
public class Idea37752Config {
    private String name = "idea_037752";
 ...
 */
@Slf4j
public class Idea37752Service {
    private static final int IDEA_ID = 37752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37752Service() {
        this(new Idea37752Config());
    }

    public Idea37752Service(Idea37752Config config) {
        this.config = config != null ? config : new Idea37752Config();
