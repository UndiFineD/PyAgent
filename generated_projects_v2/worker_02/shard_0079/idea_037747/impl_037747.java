...
@Data
public class Idea37747Config {
    private String name = "idea_037747";
 ...
 */
@Slf4j
public class Idea37747Service {
    private static final int IDEA_ID = 37747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37747Service() {
        this(new Idea37747Config());
    }

    public Idea37747Service(Idea37747Config config) {
        this.config = config != null ? config : new Idea37747Config();
