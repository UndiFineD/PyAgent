...
@Data
public class Idea37937Config {
    private String name = "idea_037937";
 ...
 */
@Slf4j
public class Idea37937Service {
    private static final int IDEA_ID = 37937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37937Service() {
        this(new Idea37937Config());
    }

    public Idea37937Service(Idea37937Config config) {
        this.config = config != null ? config : new Idea37937Config();
