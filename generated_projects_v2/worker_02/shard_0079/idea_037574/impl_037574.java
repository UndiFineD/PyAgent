...
@Data
public class Idea37574Config {
    private String name = "idea_037574";
 ...
 */
@Slf4j
public class Idea37574Service {
    private static final int IDEA_ID = 37574;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37574Service() {
        this(new Idea37574Config());
    }

    public Idea37574Service(Idea37574Config config) {
        this.config = config != null ? config : new Idea37574Config();
