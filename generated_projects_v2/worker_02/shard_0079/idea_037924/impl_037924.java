...
@Data
public class Idea37924Config {
    private String name = "idea_037924";
 ...
 */
@Slf4j
public class Idea37924Service {
    private static final int IDEA_ID = 37924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37924Service() {
        this(new Idea37924Config());
    }

    public Idea37924Service(Idea37924Config config) {
        this.config = config != null ? config : new Idea37924Config();
