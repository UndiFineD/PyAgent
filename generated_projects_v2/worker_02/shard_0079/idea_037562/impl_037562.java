...
@Data
public class Idea37562Config {
    private String name = "idea_037562";
 ...
 */
@Slf4j
public class Idea37562Service {
    private static final int IDEA_ID = 37562;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37562Service() {
        this(new Idea37562Config());
    }

    public Idea37562Service(Idea37562Config config) {
        this.config = config != null ? config : new Idea37562Config();
