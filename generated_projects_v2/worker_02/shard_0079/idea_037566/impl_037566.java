...
@Data
public class Idea37566Config {
    private String name = "idea_037566";
 ...
 */
@Slf4j
public class Idea37566Service {
    private static final int IDEA_ID = 37566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37566Service() {
        this(new Idea37566Config());
    }

    public Idea37566Service(Idea37566Config config) {
        this.config = config != null ? config : new Idea37566Config();
