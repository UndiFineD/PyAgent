...
@Data
public class Idea37902Config {
    private String name = "idea_037902";
 ...
 */
@Slf4j
public class Idea37902Service {
    private static final int IDEA_ID = 37902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37902Service() {
        this(new Idea37902Config());
    }

    public Idea37902Service(Idea37902Config config) {
        this.config = config != null ? config : new Idea37902Config();
