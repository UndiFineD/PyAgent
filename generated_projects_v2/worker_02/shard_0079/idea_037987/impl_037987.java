...
@Data
public class Idea37987Config {
    private String name = "idea_037987";
 ...
 */
@Slf4j
public class Idea37987Service {
    private static final int IDEA_ID = 37987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37987Service() {
        this(new Idea37987Config());
    }

    public Idea37987Service(Idea37987Config config) {
        this.config = config != null ? config : new Idea37987Config();
