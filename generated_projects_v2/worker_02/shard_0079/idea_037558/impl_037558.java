...
@Data
public class Idea37558Config {
    private String name = "idea_037558";
 ...
 */
@Slf4j
public class Idea37558Service {
    private static final int IDEA_ID = 37558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37558Service() {
        this(new Idea37558Config());
    }

    public Idea37558Service(Idea37558Config config) {
        this.config = config != null ? config : new Idea37558Config();
