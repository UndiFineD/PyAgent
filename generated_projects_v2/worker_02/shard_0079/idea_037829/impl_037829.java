...
@Data
public class Idea37829Config {
    private String name = "idea_037829";
 ...
 */
@Slf4j
public class Idea37829Service {
    private static final int IDEA_ID = 37829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37829Service() {
        this(new Idea37829Config());
    }

    public Idea37829Service(Idea37829Config config) {
        this.config = config != null ? config : new Idea37829Config();
