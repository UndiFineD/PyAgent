...
@Data
public class Idea37759Config {
    private String name = "idea_037759";
 ...
 */
@Slf4j
public class Idea37759Service {
    private static final int IDEA_ID = 37759;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37759Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37759Service() {
        this(new Idea37759Config());
    }

    public Idea37759Service(Idea37759Config config) {
        this.config = config != null ? config : new Idea37759Config();
