...
@Data
public class Idea37945Config {
    private String name = "idea_037945";
 ...
 */
@Slf4j
public class Idea37945Service {
    private static final int IDEA_ID = 37945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37945Service() {
        this(new Idea37945Config());
    }

    public Idea37945Service(Idea37945Config config) {
        this.config = config != null ? config : new Idea37945Config();
