...
@Data
public class Idea37886Config {
    private String name = "idea_037886";
 ...
 */
@Slf4j
public class Idea37886Service {
    private static final int IDEA_ID = 37886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37886Service() {
        this(new Idea37886Config());
    }

    public Idea37886Service(Idea37886Config config) {
        this.config = config != null ? config : new Idea37886Config();
