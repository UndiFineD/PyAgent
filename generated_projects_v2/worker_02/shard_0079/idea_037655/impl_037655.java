...
@Data
public class Idea37655Config {
    private String name = "idea_037655";
 ...
 */
@Slf4j
public class Idea37655Service {
    private static final int IDEA_ID = 37655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37655Service() {
        this(new Idea37655Config());
    }

    public Idea37655Service(Idea37655Config config) {
        this.config = config != null ? config : new Idea37655Config();
