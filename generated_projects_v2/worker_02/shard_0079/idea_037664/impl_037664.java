...
@Data
public class Idea37664Config {
    private String name = "idea_037664";
 ...
 */
@Slf4j
public class Idea37664Service {
    private static final int IDEA_ID = 37664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37664Service() {
        this(new Idea37664Config());
    }

    public Idea37664Service(Idea37664Config config) {
        this.config = config != null ? config : new Idea37664Config();
