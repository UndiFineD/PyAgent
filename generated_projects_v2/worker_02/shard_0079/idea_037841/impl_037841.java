...
@Data
public class Idea37841Config {
    private String name = "idea_037841";
 ...
 */
@Slf4j
public class Idea37841Service {
    private static final int IDEA_ID = 37841;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37841Service() {
        this(new Idea37841Config());
    }

    public Idea37841Service(Idea37841Config config) {
        this.config = config != null ? config : new Idea37841Config();
