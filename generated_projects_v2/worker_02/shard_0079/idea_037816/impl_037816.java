...
@Data
public class Idea37816Config {
    private String name = "idea_037816";
 ...
 */
@Slf4j
public class Idea37816Service {
    private static final int IDEA_ID = 37816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37816Service() {
        this(new Idea37816Config());
    }

    public Idea37816Service(Idea37816Config config) {
        this.config = config != null ? config : new Idea37816Config();
