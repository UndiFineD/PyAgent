...
@Data
public class Idea37935Config {
    private String name = "idea_037935";
 ...
 */
@Slf4j
public class Idea37935Service {
    private static final int IDEA_ID = 37935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37935Service() {
        this(new Idea37935Config());
    }

    public Idea37935Service(Idea37935Config config) {
        this.config = config != null ? config : new Idea37935Config();
