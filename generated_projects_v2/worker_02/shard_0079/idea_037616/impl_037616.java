...
@Data
public class Idea37616Config {
    private String name = "idea_037616";
 ...
 */
@Slf4j
public class Idea37616Service {
    private static final int IDEA_ID = 37616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37616Service() {
        this(new Idea37616Config());
    }

    public Idea37616Service(Idea37616Config config) {
        this.config = config != null ? config : new Idea37616Config();
