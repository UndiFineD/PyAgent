...
@Data
public class Idea37978Config {
    private String name = "idea_037978";
 ...
 */
@Slf4j
public class Idea37978Service {
    private static final int IDEA_ID = 37978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37978Service() {
        this(new Idea37978Config());
    }

    public Idea37978Service(Idea37978Config config) {
        this.config = config != null ? config : new Idea37978Config();
