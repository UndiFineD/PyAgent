...
@Data
public class Idea37648Config {
    private String name = "idea_037648";
 ...
 */
@Slf4j
public class Idea37648Service {
    private static final int IDEA_ID = 37648;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37648Service() {
        this(new Idea37648Config());
    }

    public Idea37648Service(Idea37648Config config) {
        this.config = config != null ? config : new Idea37648Config();
