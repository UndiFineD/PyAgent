...
@Data
public class Idea37794Config {
    private String name = "idea_037794";
 ...
 */
@Slf4j
public class Idea37794Service {
    private static final int IDEA_ID = 37794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37794Service() {
        this(new Idea37794Config());
    }

    public Idea37794Service(Idea37794Config config) {
        this.config = config != null ? config : new Idea37794Config();
