...
@Data
public class Idea37815Config {
    private String name = "idea_037815";
 ...
 */
@Slf4j
public class Idea37815Service {
    private static final int IDEA_ID = 37815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37815Service() {
        this(new Idea37815Config());
    }

    public Idea37815Service(Idea37815Config config) {
        this.config = config != null ? config : new Idea37815Config();
