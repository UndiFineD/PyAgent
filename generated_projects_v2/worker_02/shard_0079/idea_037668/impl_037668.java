...
@Data
public class Idea37668Config {
    private String name = "idea_037668";
 ...
 */
@Slf4j
public class Idea37668Service {
    private static final int IDEA_ID = 37668;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37668Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37668Service() {
        this(new Idea37668Config());
    }

    public Idea37668Service(Idea37668Config config) {
        this.config = config != null ? config : new Idea37668Config();
