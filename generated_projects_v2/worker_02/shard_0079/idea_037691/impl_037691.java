...
@Data
public class Idea37691Config {
    private String name = "idea_037691";
 ...
 */
@Slf4j
public class Idea37691Service {
    private static final int IDEA_ID = 37691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37691Service() {
        this(new Idea37691Config());
    }

    public Idea37691Service(Idea37691Config config) {
        this.config = config != null ? config : new Idea37691Config();
