...
@Data
public class Idea37903Config {
    private String name = "idea_037903";
 ...
 */
@Slf4j
public class Idea37903Service {
    private static final int IDEA_ID = 37903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37903Service() {
        this(new Idea37903Config());
    }

    public Idea37903Service(Idea37903Config config) {
        this.config = config != null ? config : new Idea37903Config();
