...
@Data
public class Idea37928Config {
    private String name = "idea_037928";
 ...
 */
@Slf4j
public class Idea37928Service {
    private static final int IDEA_ID = 37928;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37928Service() {
        this(new Idea37928Config());
    }

    public Idea37928Service(Idea37928Config config) {
        this.config = config != null ? config : new Idea37928Config();
