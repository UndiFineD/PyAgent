...
@Data
public class Idea37540Config {
    private String name = "idea_037540";
 ...
 */
@Slf4j
public class Idea37540Service {
    private static final int IDEA_ID = 37540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37540Service() {
        this(new Idea37540Config());
    }

    public Idea37540Service(Idea37540Config config) {
        this.config = config != null ? config : new Idea37540Config();
