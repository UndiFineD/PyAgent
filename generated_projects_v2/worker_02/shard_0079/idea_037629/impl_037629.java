...
@Data
public class Idea37629Config {
    private String name = "idea_037629";
 ...
 */
@Slf4j
public class Idea37629Service {
    private static final int IDEA_ID = 37629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37629Service() {
        this(new Idea37629Config());
    }

    public Idea37629Service(Idea37629Config config) {
        this.config = config != null ? config : new Idea37629Config();
