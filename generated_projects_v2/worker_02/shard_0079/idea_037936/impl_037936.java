...
@Data
public class Idea37936Config {
    private String name = "idea_037936";
 ...
 */
@Slf4j
public class Idea37936Service {
    private static final int IDEA_ID = 37936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37936Service() {
        this(new Idea37936Config());
    }

    public Idea37936Service(Idea37936Config config) {
        this.config = config != null ? config : new Idea37936Config();
