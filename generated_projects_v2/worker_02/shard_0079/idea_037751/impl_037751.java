...
@Data
public class Idea37751Config {
    private String name = "idea_037751";
 ...
 */
@Slf4j
public class Idea37751Service {
    private static final int IDEA_ID = 37751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37751Service() {
        this(new Idea37751Config());
    }

    public Idea37751Service(Idea37751Config config) {
        this.config = config != null ? config : new Idea37751Config();
