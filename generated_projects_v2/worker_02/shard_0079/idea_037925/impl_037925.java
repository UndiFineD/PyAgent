...
@Data
public class Idea37925Config {
    private String name = "idea_037925";
 ...
 */
@Slf4j
public class Idea37925Service {
    private static final int IDEA_ID = 37925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37925Service() {
        this(new Idea37925Config());
    }

    public Idea37925Service(Idea37925Config config) {
        this.config = config != null ? config : new Idea37925Config();
