...
@Data
public class Idea37564Config {
    private String name = "idea_037564";
 ...
 */
@Slf4j
public class Idea37564Service {
    private static final int IDEA_ID = 37564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37564Service() {
        this(new Idea37564Config());
    }

    public Idea37564Service(Idea37564Config config) {
        this.config = config != null ? config : new Idea37564Config();
