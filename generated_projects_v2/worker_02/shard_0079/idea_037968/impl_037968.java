...
@Data
public class Idea37968Config {
    private String name = "idea_037968";
 ...
 */
@Slf4j
public class Idea37968Service {
    private static final int IDEA_ID = 37968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37968Service() {
        this(new Idea37968Config());
    }

    public Idea37968Service(Idea37968Config config) {
        this.config = config != null ? config : new Idea37968Config();
