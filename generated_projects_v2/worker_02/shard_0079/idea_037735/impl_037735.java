...
@Data
public class Idea37735Config {
    private String name = "idea_037735";
 ...
 */
@Slf4j
public class Idea37735Service {
    private static final int IDEA_ID = 37735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37735Service() {
        this(new Idea37735Config());
    }

    public Idea37735Service(Idea37735Config config) {
        this.config = config != null ? config : new Idea37735Config();
