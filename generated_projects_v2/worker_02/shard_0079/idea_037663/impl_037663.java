...
@Data
public class Idea37663Config {
    private String name = "idea_037663";
 ...
 */
@Slf4j
public class Idea37663Service {
    private static final int IDEA_ID = 37663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37663Service() {
        this(new Idea37663Config());
    }

    public Idea37663Service(Idea37663Config config) {
        this.config = config != null ? config : new Idea37663Config();
