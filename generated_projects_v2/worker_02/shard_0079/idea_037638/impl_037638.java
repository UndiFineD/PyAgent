...
@Data
public class Idea37638Config {
    private String name = "idea_037638";
 ...
 */
@Slf4j
public class Idea37638Service {
    private static final int IDEA_ID = 37638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37638Service() {
        this(new Idea37638Config());
    }

    public Idea37638Service(Idea37638Config config) {
        this.config = config != null ? config : new Idea37638Config();
