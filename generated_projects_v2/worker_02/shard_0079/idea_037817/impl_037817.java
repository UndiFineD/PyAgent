...
@Data
public class Idea37817Config {
    private String name = "idea_037817";
 ...
 */
@Slf4j
public class Idea37817Service {
    private static final int IDEA_ID = 37817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37817Service() {
        this(new Idea37817Config());
    }

    public Idea37817Service(Idea37817Config config) {
        this.config = config != null ? config : new Idea37817Config();
