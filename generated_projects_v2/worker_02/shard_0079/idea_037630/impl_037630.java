...
@Data
public class Idea37630Config {
    private String name = "idea_037630";
 ...
 */
@Slf4j
public class Idea37630Service {
    private static final int IDEA_ID = 37630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37630Service() {
        this(new Idea37630Config());
    }

    public Idea37630Service(Idea37630Config config) {
        this.config = config != null ? config : new Idea37630Config();
