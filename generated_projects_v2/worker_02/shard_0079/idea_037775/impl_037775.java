...
@Data
public class Idea37775Config {
    private String name = "idea_037775";
 ...
 */
@Slf4j
public class Idea37775Service {
    private static final int IDEA_ID = 37775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37775Service() {
        this(new Idea37775Config());
    }

    public Idea37775Service(Idea37775Config config) {
        this.config = config != null ? config : new Idea37775Config();
