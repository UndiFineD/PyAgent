...
@Data
public class Idea37917Config {
    private String name = "idea_037917";
 ...
 */
@Slf4j
public class Idea37917Service {
    private static final int IDEA_ID = 37917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37917Service() {
        this(new Idea37917Config());
    }

    public Idea37917Service(Idea37917Config config) {
        this.config = config != null ? config : new Idea37917Config();
