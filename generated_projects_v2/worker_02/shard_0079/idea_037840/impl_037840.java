...
@Data
public class Idea37840Config {
    private String name = "idea_037840";
 ...
 */
@Slf4j
public class Idea37840Service {
    private static final int IDEA_ID = 37840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37840Service() {
        this(new Idea37840Config());
    }

    public Idea37840Service(Idea37840Config config) {
        this.config = config != null ? config : new Idea37840Config();
