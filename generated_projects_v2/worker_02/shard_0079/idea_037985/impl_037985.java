...
@Data
public class Idea37985Config {
    private String name = "idea_037985";
 ...
 */
@Slf4j
public class Idea37985Service {
    private static final int IDEA_ID = 37985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37985Service() {
        this(new Idea37985Config());
    }

    public Idea37985Service(Idea37985Config config) {
        this.config = config != null ? config : new Idea37985Config();
