...
@Data
public class Idea37788Config {
    private String name = "idea_037788";
 ...
 */
@Slf4j
public class Idea37788Service {
    private static final int IDEA_ID = 37788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37788Service() {
        this(new Idea37788Config());
    }

    public Idea37788Service(Idea37788Config config) {
        this.config = config != null ? config : new Idea37788Config();
