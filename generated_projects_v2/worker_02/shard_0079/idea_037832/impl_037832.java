...
@Data
public class Idea37832Config {
    private String name = "idea_037832";
 ...
 */
@Slf4j
public class Idea37832Service {
    private static final int IDEA_ID = 37832;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37832Service() {
        this(new Idea37832Config());
    }

    public Idea37832Service(Idea37832Config config) {
        this.config = config != null ? config : new Idea37832Config();
