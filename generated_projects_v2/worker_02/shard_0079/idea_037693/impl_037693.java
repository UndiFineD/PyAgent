...
@Data
public class Idea37693Config {
    private String name = "idea_037693";
 ...
 */
@Slf4j
public class Idea37693Service {
    private static final int IDEA_ID = 37693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37693Service() {
        this(new Idea37693Config());
    }

    public Idea37693Service(Idea37693Config config) {
        this.config = config != null ? config : new Idea37693Config();
