...
@Data
public class Idea37837Config {
    private String name = "idea_037837";
 ...
 */
@Slf4j
public class Idea37837Service {
    private static final int IDEA_ID = 37837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37837Service() {
        this(new Idea37837Config());
    }

    public Idea37837Service(Idea37837Config config) {
        this.config = config != null ? config : new Idea37837Config();
