...
@Data
public class Idea37551Config {
    private String name = "idea_037551";
 ...
 */
@Slf4j
public class Idea37551Service {
    private static final int IDEA_ID = 37551;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37551Service() {
        this(new Idea37551Config());
    }

    public Idea37551Service(Idea37551Config config) {
        this.config = config != null ? config : new Idea37551Config();
