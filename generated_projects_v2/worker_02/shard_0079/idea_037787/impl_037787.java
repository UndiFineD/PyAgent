...
@Data
public class Idea37787Config {
    private String name = "idea_037787";
 ...
 */
@Slf4j
public class Idea37787Service {
    private static final int IDEA_ID = 37787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37787Service() {
        this(new Idea37787Config());
    }

    public Idea37787Service(Idea37787Config config) {
        this.config = config != null ? config : new Idea37787Config();
