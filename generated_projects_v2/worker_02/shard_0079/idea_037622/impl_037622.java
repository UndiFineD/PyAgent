...
@Data
public class Idea37622Config {
    private String name = "idea_037622";
 ...
 */
@Slf4j
public class Idea37622Service {
    private static final int IDEA_ID = 37622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37622Service() {
        this(new Idea37622Config());
    }

    public Idea37622Service(Idea37622Config config) {
        this.config = config != null ? config : new Idea37622Config();
