...
@Data
public class Idea37880Config {
    private String name = "idea_037880";
 ...
 */
@Slf4j
public class Idea37880Service {
    private static final int IDEA_ID = 37880;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37880Service() {
        this(new Idea37880Config());
    }

    public Idea37880Service(Idea37880Config config) {
        this.config = config != null ? config : new Idea37880Config();
