...
@Data
public class Idea37808Config {
    private String name = "idea_037808";
 ...
 */
@Slf4j
public class Idea37808Service {
    private static final int IDEA_ID = 37808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37808Service() {
        this(new Idea37808Config());
    }

    public Idea37808Service(Idea37808Config config) {
        this.config = config != null ? config : new Idea37808Config();
