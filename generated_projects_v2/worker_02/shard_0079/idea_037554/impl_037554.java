...
@Data
public class Idea37554Config {
    private String name = "idea_037554";
 ...
 */
@Slf4j
public class Idea37554Service {
    private static final int IDEA_ID = 37554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37554Service() {
        this(new Idea37554Config());
    }

    public Idea37554Service(Idea37554Config config) {
        this.config = config != null ? config : new Idea37554Config();
