...
@Data
public class Idea37827Config {
    private String name = "idea_037827";
 ...
 */
@Slf4j
public class Idea37827Service {
    private static final int IDEA_ID = 37827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37827Service() {
        this(new Idea37827Config());
    }

    public Idea37827Service(Idea37827Config config) {
        this.config = config != null ? config : new Idea37827Config();
