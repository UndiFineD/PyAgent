...
@Data
public class Idea37818Config {
    private String name = "idea_037818";
 ...
 */
@Slf4j
public class Idea37818Service {
    private static final int IDEA_ID = 37818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37818Service() {
        this(new Idea37818Config());
    }

    public Idea37818Service(Idea37818Config config) {
        this.config = config != null ? config : new Idea37818Config();
