...
@Data
public class Idea37729Config {
    private String name = "idea_037729";
 ...
 */
@Slf4j
public class Idea37729Service {
    private static final int IDEA_ID = 37729;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37729Service() {
        this(new Idea37729Config());
    }

    public Idea37729Service(Idea37729Config config) {
        this.config = config != null ? config : new Idea37729Config();
