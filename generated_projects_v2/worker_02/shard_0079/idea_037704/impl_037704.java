...
@Data
public class Idea37704Config {
    private String name = "idea_037704";
 ...
 */
@Slf4j
public class Idea37704Service {
    private static final int IDEA_ID = 37704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37704Service() {
        this(new Idea37704Config());
    }

    public Idea37704Service(Idea37704Config config) {
        this.config = config != null ? config : new Idea37704Config();
