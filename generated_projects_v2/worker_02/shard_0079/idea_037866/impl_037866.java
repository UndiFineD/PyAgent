...
@Data
public class Idea37866Config {
    private String name = "idea_037866";
 ...
 */
@Slf4j
public class Idea37866Service {
    private static final int IDEA_ID = 37866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37866Service() {
        this(new Idea37866Config());
    }

    public Idea37866Service(Idea37866Config config) {
        this.config = config != null ? config : new Idea37866Config();
