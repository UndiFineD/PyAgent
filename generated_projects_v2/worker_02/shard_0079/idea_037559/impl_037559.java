...
@Data
public class Idea37559Config {
    private String name = "idea_037559";
 ...
 */
@Slf4j
public class Idea37559Service {
    private static final int IDEA_ID = 37559;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37559Service() {
        this(new Idea37559Config());
    }

    public Idea37559Service(Idea37559Config config) {
        this.config = config != null ? config : new Idea37559Config();
