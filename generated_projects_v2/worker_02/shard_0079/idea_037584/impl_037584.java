...
@Data
public class Idea37584Config {
    private String name = "idea_037584";
 ...
 */
@Slf4j
public class Idea37584Service {
    private static final int IDEA_ID = 37584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37584Service() {
        this(new Idea37584Config());
    }

    public Idea37584Service(Idea37584Config config) {
        this.config = config != null ? config : new Idea37584Config();
