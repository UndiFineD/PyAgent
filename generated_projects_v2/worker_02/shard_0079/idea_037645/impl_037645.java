...
@Data
public class Idea37645Config {
    private String name = "idea_037645";
 ...
 */
@Slf4j
public class Idea37645Service {
    private static final int IDEA_ID = 37645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37645Service() {
        this(new Idea37645Config());
    }

    public Idea37645Service(Idea37645Config config) {
        this.config = config != null ? config : new Idea37645Config();
