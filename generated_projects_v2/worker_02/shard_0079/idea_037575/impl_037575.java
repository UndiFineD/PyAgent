...
@Data
public class Idea37575Config {
    private String name = "idea_037575";
 ...
 */
@Slf4j
public class Idea37575Service {
    private static final int IDEA_ID = 37575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37575Service() {
        this(new Idea37575Config());
    }

    public Idea37575Service(Idea37575Config config) {
        this.config = config != null ? config : new Idea37575Config();
