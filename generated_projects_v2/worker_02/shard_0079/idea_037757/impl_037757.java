...
@Data
public class Idea37757Config {
    private String name = "idea_037757";
 ...
 */
@Slf4j
public class Idea37757Service {
    private static final int IDEA_ID = 37757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37757Service() {
        this(new Idea37757Config());
    }

    public Idea37757Service(Idea37757Config config) {
        this.config = config != null ? config : new Idea37757Config();
