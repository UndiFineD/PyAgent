...
@Data
public class Idea37694Config {
    private String name = "idea_037694";
 ...
 */
@Slf4j
public class Idea37694Service {
    private static final int IDEA_ID = 37694;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37694Service() {
        this(new Idea37694Config());
    }

    public Idea37694Service(Idea37694Config config) {
        this.config = config != null ? config : new Idea37694Config();
