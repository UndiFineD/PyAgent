...
@Data
public class Idea37723Config {
    private String name = "idea_037723";
 ...
 */
@Slf4j
public class Idea37723Service {
    private static final int IDEA_ID = 37723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37723Service() {
        this(new Idea37723Config());
    }

    public Idea37723Service(Idea37723Config config) {
        this.config = config != null ? config : new Idea37723Config();
