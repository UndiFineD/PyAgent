...
@Data
public class Idea37707Config {
    private String name = "idea_037707";
 ...
 */
@Slf4j
public class Idea37707Service {
    private static final int IDEA_ID = 37707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37707Service() {
        this(new Idea37707Config());
    }

    public Idea37707Service(Idea37707Config config) {
        this.config = config != null ? config : new Idea37707Config();
