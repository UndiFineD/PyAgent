...
@Data
public class Idea37980Config {
    private String name = "idea_037980";
 ...
 */
@Slf4j
public class Idea37980Service {
    private static final int IDEA_ID = 37980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37980Service() {
        this(new Idea37980Config());
    }

    public Idea37980Service(Idea37980Config config) {
        this.config = config != null ? config : new Idea37980Config();
