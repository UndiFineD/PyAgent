...
@Data
public class Idea37864Config {
    private String name = "idea_037864";
 ...
 */
@Slf4j
public class Idea37864Service {
    private static final int IDEA_ID = 37864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37864Service() {
        this(new Idea37864Config());
    }

    public Idea37864Service(Idea37864Config config) {
        this.config = config != null ? config : new Idea37864Config();
