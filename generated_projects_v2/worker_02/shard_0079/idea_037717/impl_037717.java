...
@Data
public class Idea37717Config {
    private String name = "idea_037717";
 ...
 */
@Slf4j
public class Idea37717Service {
    private static final int IDEA_ID = 37717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37717Service() {
        this(new Idea37717Config());
    }

    public Idea37717Service(Idea37717Config config) {
        this.config = config != null ? config : new Idea37717Config();
