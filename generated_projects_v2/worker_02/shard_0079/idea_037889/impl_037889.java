...
@Data
public class Idea37889Config {
    private String name = "idea_037889";
 ...
 */
@Slf4j
public class Idea37889Service {
    private static final int IDEA_ID = 37889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37889Service() {
        this(new Idea37889Config());
    }

    public Idea37889Service(Idea37889Config config) {
        this.config = config != null ? config : new Idea37889Config();
