...
@Data
public class Idea37617Config {
    private String name = "idea_037617";
 ...
 */
@Slf4j
public class Idea37617Service {
    private static final int IDEA_ID = 37617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37617Service() {
        this(new Idea37617Config());
    }

    public Idea37617Service(Idea37617Config config) {
        this.config = config != null ? config : new Idea37617Config();
