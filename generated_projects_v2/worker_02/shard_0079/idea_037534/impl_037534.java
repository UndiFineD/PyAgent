...
@Data
public class Idea37534Config {
    private String name = "idea_037534";
 ...
 */
@Slf4j
public class Idea37534Service {
    private static final int IDEA_ID = 37534;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37534Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37534Service() {
        this(new Idea37534Config());
    }

    public Idea37534Service(Idea37534Config config) {
        this.config = config != null ? config : new Idea37534Config();
