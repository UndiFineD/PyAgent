...
@Data
public class Idea37527Config {
    private String name = "idea_037527";
 ...
 */
@Slf4j
public class Idea37527Service {
    private static final int IDEA_ID = 37527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37527Service() {
        this(new Idea37527Config());
    }

    public Idea37527Service(Idea37527Config config) {
        this.config = config != null ? config : new Idea37527Config();
