...
@Data
public class Idea37619Config {
    private String name = "idea_037619";
 ...
 */
@Slf4j
public class Idea37619Service {
    private static final int IDEA_ID = 37619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37619Service() {
        this(new Idea37619Config());
    }

    public Idea37619Service(Idea37619Config config) {
        this.config = config != null ? config : new Idea37619Config();
