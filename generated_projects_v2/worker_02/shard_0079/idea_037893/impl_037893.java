...
@Data
public class Idea37893Config {
    private String name = "idea_037893";
 ...
 */
@Slf4j
public class Idea37893Service {
    private static final int IDEA_ID = 37893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37893Service() {
        this(new Idea37893Config());
    }

    public Idea37893Service(Idea37893Config config) {
        this.config = config != null ? config : new Idea37893Config();
