...
@Data
public class Idea37677Config {
    private String name = "idea_037677";
 ...
 */
@Slf4j
public class Idea37677Service {
    private static final int IDEA_ID = 37677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37677Service() {
        this(new Idea37677Config());
    }

    public Idea37677Service(Idea37677Config config) {
        this.config = config != null ? config : new Idea37677Config();
