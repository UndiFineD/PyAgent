...
@Data
public class Idea37938Config {
    private String name = "idea_037938";
 ...
 */
@Slf4j
public class Idea37938Service {
    private static final int IDEA_ID = 37938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37938Service() {
        this(new Idea37938Config());
    }

    public Idea37938Service(Idea37938Config config) {
        this.config = config != null ? config : new Idea37938Config();
