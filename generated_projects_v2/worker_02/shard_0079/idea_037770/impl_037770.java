...
@Data
public class Idea37770Config {
    private String name = "idea_037770";
 ...
 */
@Slf4j
public class Idea37770Service {
    private static final int IDEA_ID = 37770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37770Service() {
        this(new Idea37770Config());
    }

    public Idea37770Service(Idea37770Config config) {
        this.config = config != null ? config : new Idea37770Config();
