...
@Data
public class Idea37871Config {
    private String name = "idea_037871";
 ...
 */
@Slf4j
public class Idea37871Service {
    private static final int IDEA_ID = 37871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37871Service() {
        this(new Idea37871Config());
    }

    public Idea37871Service(Idea37871Config config) {
        this.config = config != null ? config : new Idea37871Config();
