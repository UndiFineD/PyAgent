...
@Data
public class Idea37797Config {
    private String name = "idea_037797";
 ...
 */
@Slf4j
public class Idea37797Service {
    private static final int IDEA_ID = 37797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37797Service() {
        this(new Idea37797Config());
    }

    public Idea37797Service(Idea37797Config config) {
        this.config = config != null ? config : new Idea37797Config();
