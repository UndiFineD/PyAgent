...
@Data
public class Idea37561Config {
    private String name = "idea_037561";
 ...
 */
@Slf4j
public class Idea37561Service {
    private static final int IDEA_ID = 37561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37561Service() {
        this(new Idea37561Config());
    }

    public Idea37561Service(Idea37561Config config) {
        this.config = config != null ? config : new Idea37561Config();
