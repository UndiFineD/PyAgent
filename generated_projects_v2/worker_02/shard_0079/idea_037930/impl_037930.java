...
@Data
public class Idea37930Config {
    private String name = "idea_037930";
 ...
 */
@Slf4j
public class Idea37930Service {
    private static final int IDEA_ID = 37930;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37930Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37930Service() {
        this(new Idea37930Config());
    }

    public Idea37930Service(Idea37930Config config) {
        this.config = config != null ? config : new Idea37930Config();
