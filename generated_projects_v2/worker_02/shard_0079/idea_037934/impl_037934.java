...
@Data
public class Idea37934Config {
    private String name = "idea_037934";
 ...
 */
@Slf4j
public class Idea37934Service {
    private static final int IDEA_ID = 37934;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37934Service() {
        this(new Idea37934Config());
    }

    public Idea37934Service(Idea37934Config config) {
        this.config = config != null ? config : new Idea37934Config();
