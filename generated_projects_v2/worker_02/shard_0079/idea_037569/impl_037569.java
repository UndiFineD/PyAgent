...
@Data
public class Idea37569Config {
    private String name = "idea_037569";
 ...
 */
@Slf4j
public class Idea37569Service {
    private static final int IDEA_ID = 37569;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37569Service() {
        this(new Idea37569Config());
    }

    public Idea37569Service(Idea37569Config config) {
        this.config = config != null ? config : new Idea37569Config();
