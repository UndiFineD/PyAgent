...
@Data
public class Idea37905Config {
    private String name = "idea_037905";
 ...
 */
@Slf4j
public class Idea37905Service {
    private static final int IDEA_ID = 37905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37905Service() {
        this(new Idea37905Config());
    }

    public Idea37905Service(Idea37905Config config) {
        this.config = config != null ? config : new Idea37905Config();
