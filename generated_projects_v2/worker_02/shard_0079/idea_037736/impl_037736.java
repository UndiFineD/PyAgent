...
@Data
public class Idea37736Config {
    private String name = "idea_037736";
 ...
 */
@Slf4j
public class Idea37736Service {
    private static final int IDEA_ID = 37736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37736Service() {
        this(new Idea37736Config());
    }

    public Idea37736Service(Idea37736Config config) {
        this.config = config != null ? config : new Idea37736Config();
