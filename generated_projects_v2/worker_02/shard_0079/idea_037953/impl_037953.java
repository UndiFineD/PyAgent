...
@Data
public class Idea37953Config {
    private String name = "idea_037953";
 ...
 */
@Slf4j
public class Idea37953Service {
    private static final int IDEA_ID = 37953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37953Service() {
        this(new Idea37953Config());
    }

    public Idea37953Service(Idea37953Config config) {
        this.config = config != null ? config : new Idea37953Config();
