...
@Data
public class Idea37952Config {
    private String name = "idea_037952";
 ...
 */
@Slf4j
public class Idea37952Service {
    private static final int IDEA_ID = 37952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37952Service() {
        this(new Idea37952Config());
    }

    public Idea37952Service(Idea37952Config config) {
        this.config = config != null ? config : new Idea37952Config();
