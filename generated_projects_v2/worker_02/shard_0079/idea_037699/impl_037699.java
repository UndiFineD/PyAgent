...
@Data
public class Idea37699Config {
    private String name = "idea_037699";
 ...
 */
@Slf4j
public class Idea37699Service {
    private static final int IDEA_ID = 37699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37699Service() {
        this(new Idea37699Config());
    }

    public Idea37699Service(Idea37699Config config) {
        this.config = config != null ? config : new Idea37699Config();
