...
@Data
public class Idea37713Config {
    private String name = "idea_037713";
 ...
 */
@Slf4j
public class Idea37713Service {
    private static final int IDEA_ID = 37713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37713Service() {
        this(new Idea37713Config());
    }

    public Idea37713Service(Idea37713Config config) {
        this.config = config != null ? config : new Idea37713Config();
