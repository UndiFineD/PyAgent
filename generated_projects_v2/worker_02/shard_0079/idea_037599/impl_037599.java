...
@Data
public class Idea37599Config {
    private String name = "idea_037599";
 ...
 */
@Slf4j
public class Idea37599Service {
    private static final int IDEA_ID = 37599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37599Service() {
        this(new Idea37599Config());
    }

    public Idea37599Service(Idea37599Config config) {
        this.config = config != null ? config : new Idea37599Config();
