...
@Data
public class Idea37587Config {
    private String name = "idea_037587";
 ...
 */
@Slf4j
public class Idea37587Service {
    private static final int IDEA_ID = 37587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37587Service() {
        this(new Idea37587Config());
    }

    public Idea37587Service(Idea37587Config config) {
        this.config = config != null ? config : new Idea37587Config();
