...
@Data
public class Idea37806Config {
    private String name = "idea_037806";
 ...
 */
@Slf4j
public class Idea37806Service {
    private static final int IDEA_ID = 37806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37806Service() {
        this(new Idea37806Config());
    }

    public Idea37806Service(Idea37806Config config) {
        this.config = config != null ? config : new Idea37806Config();
