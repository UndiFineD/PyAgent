...
@Data
public class Idea37853Config {
    private String name = "idea_037853";
 ...
 */
@Slf4j
public class Idea37853Service {
    private static final int IDEA_ID = 37853;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37853Service() {
        this(new Idea37853Config());
    }

    public Idea37853Service(Idea37853Config config) {
        this.config = config != null ? config : new Idea37853Config();
