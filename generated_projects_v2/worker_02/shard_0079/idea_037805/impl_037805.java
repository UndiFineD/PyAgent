...
@Data
public class Idea37805Config {
    private String name = "idea_037805";
 ...
 */
@Slf4j
public class Idea37805Service {
    private static final int IDEA_ID = 37805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37805Service() {
        this(new Idea37805Config());
    }

    public Idea37805Service(Idea37805Config config) {
        this.config = config != null ? config : new Idea37805Config();
