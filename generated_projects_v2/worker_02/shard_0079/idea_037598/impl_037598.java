...
@Data
public class Idea37598Config {
    private String name = "idea_037598";
 ...
 */
@Slf4j
public class Idea37598Service {
    private static final int IDEA_ID = 37598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37598Service() {
        this(new Idea37598Config());
    }

    public Idea37598Service(Idea37598Config config) {
        this.config = config != null ? config : new Idea37598Config();
