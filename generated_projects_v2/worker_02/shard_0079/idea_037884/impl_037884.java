...
@Data
public class Idea37884Config {
    private String name = "idea_037884";
 ...
 */
@Slf4j
public class Idea37884Service {
    private static final int IDEA_ID = 37884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37884Service() {
        this(new Idea37884Config());
    }

    public Idea37884Service(Idea37884Config config) {
        this.config = config != null ? config : new Idea37884Config();
