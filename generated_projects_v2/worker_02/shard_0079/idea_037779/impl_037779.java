...
@Data
public class Idea37779Config {
    private String name = "idea_037779";
 ...
 */
@Slf4j
public class Idea37779Service {
    private static final int IDEA_ID = 37779;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37779Service() {
        this(new Idea37779Config());
    }

    public Idea37779Service(Idea37779Config config) {
        this.config = config != null ? config : new Idea37779Config();
