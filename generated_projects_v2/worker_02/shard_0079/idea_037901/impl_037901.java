...
@Data
public class Idea37901Config {
    private String name = "idea_037901";
 ...
 */
@Slf4j
public class Idea37901Service {
    private static final int IDEA_ID = 37901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37901Service() {
        this(new Idea37901Config());
    }

    public Idea37901Service(Idea37901Config config) {
        this.config = config != null ? config : new Idea37901Config();
