...
@Data
public class Idea37646Config {
    private String name = "idea_037646";
 ...
 */
@Slf4j
public class Idea37646Service {
    private static final int IDEA_ID = 37646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37646Service() {
        this(new Idea37646Config());
    }

    public Idea37646Service(Idea37646Config config) {
        this.config = config != null ? config : new Idea37646Config();
