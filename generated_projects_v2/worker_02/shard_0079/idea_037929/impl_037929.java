...
@Data
public class Idea37929Config {
    private String name = "idea_037929";
 ...
 */
@Slf4j
public class Idea37929Service {
    private static final int IDEA_ID = 37929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37929Service() {
        this(new Idea37929Config());
    }

    public Idea37929Service(Idea37929Config config) {
        this.config = config != null ? config : new Idea37929Config();
