...
@Data
public class Idea37639Config {
    private String name = "idea_037639";
 ...
 */
@Slf4j
public class Idea37639Service {
    private static final int IDEA_ID = 37639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37639Service() {
        this(new Idea37639Config());
    }

    public Idea37639Service(Idea37639Config config) {
        this.config = config != null ? config : new Idea37639Config();
