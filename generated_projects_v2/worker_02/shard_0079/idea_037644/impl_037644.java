...
@Data
public class Idea37644Config {
    private String name = "idea_037644";
 ...
 */
@Slf4j
public class Idea37644Service {
    private static final int IDEA_ID = 37644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37644Service() {
        this(new Idea37644Config());
    }

    public Idea37644Service(Idea37644Config config) {
        this.config = config != null ? config : new Idea37644Config();
