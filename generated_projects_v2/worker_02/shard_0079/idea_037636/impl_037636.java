...
@Data
public class Idea37636Config {
    private String name = "idea_037636";
 ...
 */
@Slf4j
public class Idea37636Service {
    private static final int IDEA_ID = 37636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37636Service() {
        this(new Idea37636Config());
    }

    public Idea37636Service(Idea37636Config config) {
        this.config = config != null ? config : new Idea37636Config();
