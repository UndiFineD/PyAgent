...
@Data
public class Idea37565Config {
    private String name = "idea_037565";
 ...
 */
@Slf4j
public class Idea37565Service {
    private static final int IDEA_ID = 37565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37565Service() {
        this(new Idea37565Config());
    }

    public Idea37565Service(Idea37565Config config) {
        this.config = config != null ? config : new Idea37565Config();
