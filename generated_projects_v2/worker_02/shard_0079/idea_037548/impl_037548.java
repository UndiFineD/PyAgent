...
@Data
public class Idea37548Config {
    private String name = "idea_037548";
 ...
 */
@Slf4j
public class Idea37548Service {
    private static final int IDEA_ID = 37548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37548Service() {
        this(new Idea37548Config());
    }

    public Idea37548Service(Idea37548Config config) {
        this.config = config != null ? config : new Idea37548Config();
