...
@Data
public class Idea37845Config {
    private String name = "idea_037845";
 ...
 */
@Slf4j
public class Idea37845Service {
    private static final int IDEA_ID = 37845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37845Service() {
        this(new Idea37845Config());
    }

    public Idea37845Service(Idea37845Config config) {
        this.config = config != null ? config : new Idea37845Config();
