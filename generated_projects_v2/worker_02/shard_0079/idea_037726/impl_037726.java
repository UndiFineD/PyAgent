...
@Data
public class Idea37726Config {
    private String name = "idea_037726";
 ...
 */
@Slf4j
public class Idea37726Service {
    private static final int IDEA_ID = 37726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37726Service() {
        this(new Idea37726Config());
    }

    public Idea37726Service(Idea37726Config config) {
        this.config = config != null ? config : new Idea37726Config();
