...
@Data
public class Idea37539Config {
    private String name = "idea_037539";
 ...
 */
@Slf4j
public class Idea37539Service {
    private static final int IDEA_ID = 37539;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37539Service() {
        this(new Idea37539Config());
    }

    public Idea37539Service(Idea37539Config config) {
        this.config = config != null ? config : new Idea37539Config();
