...
@Data
public class Idea37568Config {
    private String name = "idea_037568";
 ...
 */
@Slf4j
public class Idea37568Service {
    private static final int IDEA_ID = 37568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37568Service() {
        this(new Idea37568Config());
    }

    public Idea37568Service(Idea37568Config config) {
        this.config = config != null ? config : new Idea37568Config();
