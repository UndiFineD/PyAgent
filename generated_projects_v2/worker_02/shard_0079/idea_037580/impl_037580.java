...
@Data
public class Idea37580Config {
    private String name = "idea_037580";
 ...
 */
@Slf4j
public class Idea37580Service {
    private static final int IDEA_ID = 37580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37580Service() {
        this(new Idea37580Config());
    }

    public Idea37580Service(Idea37580Config config) {
        this.config = config != null ? config : new Idea37580Config();
