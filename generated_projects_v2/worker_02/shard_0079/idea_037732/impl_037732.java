...
@Data
public class Idea37732Config {
    private String name = "idea_037732";
 ...
 */
@Slf4j
public class Idea37732Service {
    private static final int IDEA_ID = 37732;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37732Service() {
        this(new Idea37732Config());
    }

    public Idea37732Service(Idea37732Config config) {
        this.config = config != null ? config : new Idea37732Config();
