...
@Data
public class Idea37974Config {
    private String name = "idea_037974";
 ...
 */
@Slf4j
public class Idea37974Service {
    private static final int IDEA_ID = 37974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37974Service() {
        this(new Idea37974Config());
    }

    public Idea37974Service(Idea37974Config config) {
        this.config = config != null ? config : new Idea37974Config();
