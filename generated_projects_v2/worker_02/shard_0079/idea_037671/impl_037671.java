...
@Data
public class Idea37671Config {
    private String name = "idea_037671";
 ...
 */
@Slf4j
public class Idea37671Service {
    private static final int IDEA_ID = 37671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37671Service() {
        this(new Idea37671Config());
    }

    public Idea37671Service(Idea37671Config config) {
        this.config = config != null ? config : new Idea37671Config();
