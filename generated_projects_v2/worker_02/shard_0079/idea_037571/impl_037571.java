...
@Data
public class Idea37571Config {
    private String name = "idea_037571";
 ...
 */
@Slf4j
public class Idea37571Service {
    private static final int IDEA_ID = 37571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37571Service() {
        this(new Idea37571Config());
    }

    public Idea37571Service(Idea37571Config config) {
        this.config = config != null ? config : new Idea37571Config();
