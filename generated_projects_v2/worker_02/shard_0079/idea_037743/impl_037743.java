...
@Data
public class Idea37743Config {
    private String name = "idea_037743";
 ...
 */
@Slf4j
public class Idea37743Service {
    private static final int IDEA_ID = 37743;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37743Service() {
        this(new Idea37743Config());
    }

    public Idea37743Service(Idea37743Config config) {
        this.config = config != null ? config : new Idea37743Config();
