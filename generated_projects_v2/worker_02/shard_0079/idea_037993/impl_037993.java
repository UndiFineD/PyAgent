...
@Data
public class Idea37993Config {
    private String name = "idea_037993";
 ...
 */
@Slf4j
public class Idea37993Service {
    private static final int IDEA_ID = 37993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37993Service() {
        this(new Idea37993Config());
    }

    public Idea37993Service(Idea37993Config config) {
        this.config = config != null ? config : new Idea37993Config();
