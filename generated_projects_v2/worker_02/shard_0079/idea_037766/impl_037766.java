...
@Data
public class Idea37766Config {
    private String name = "idea_037766";
 ...
 */
@Slf4j
public class Idea37766Service {
    private static final int IDEA_ID = 37766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37766Service() {
        this(new Idea37766Config());
    }

    public Idea37766Service(Idea37766Config config) {
        this.config = config != null ? config : new Idea37766Config();
