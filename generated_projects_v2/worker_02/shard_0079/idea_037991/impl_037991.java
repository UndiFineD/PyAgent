...
@Data
public class Idea37991Config {
    private String name = "idea_037991";
 ...
 */
@Slf4j
public class Idea37991Service {
    private static final int IDEA_ID = 37991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37991Service() {
        this(new Idea37991Config());
    }

    public Idea37991Service(Idea37991Config config) {
        this.config = config != null ? config : new Idea37991Config();
