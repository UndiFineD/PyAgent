...
@Data
public class Idea37525Config {
    private String name = "idea_037525";
 ...
 */
@Slf4j
public class Idea37525Service {
    private static final int IDEA_ID = 37525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37525Service() {
        this(new Idea37525Config());
    }

    public Idea37525Service(Idea37525Config config) {
        this.config = config != null ? config : new Idea37525Config();
