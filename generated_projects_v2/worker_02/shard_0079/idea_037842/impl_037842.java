...
@Data
public class Idea37842Config {
    private String name = "idea_037842";
 ...
 */
@Slf4j
public class Idea37842Service {
    private static final int IDEA_ID = 37842;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37842Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37842Service() {
        this(new Idea37842Config());
    }

    public Idea37842Service(Idea37842Config config) {
        this.config = config != null ? config : new Idea37842Config();
