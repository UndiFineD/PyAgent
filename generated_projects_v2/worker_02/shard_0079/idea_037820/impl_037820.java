...
@Data
public class Idea37820Config {
    private String name = "idea_037820";
 ...
 */
@Slf4j
public class Idea37820Service {
    private static final int IDEA_ID = 37820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37820Service() {
        this(new Idea37820Config());
    }

    public Idea37820Service(Idea37820Config config) {
        this.config = config != null ? config : new Idea37820Config();
