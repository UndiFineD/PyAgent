...
@Data
public class Idea37890Config {
    private String name = "idea_037890";
 ...
 */
@Slf4j
public class Idea37890Service {
    private static final int IDEA_ID = 37890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37890Service() {
        this(new Idea37890Config());
    }

    public Idea37890Service(Idea37890Config config) {
        this.config = config != null ? config : new Idea37890Config();
