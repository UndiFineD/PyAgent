...
@Data
public class Idea37665Config {
    private String name = "idea_037665";
 ...
 */
@Slf4j
public class Idea37665Service {
    private static final int IDEA_ID = 37665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37665Service() {
        this(new Idea37665Config());
    }

    public Idea37665Service(Idea37665Config config) {
        this.config = config != null ? config : new Idea37665Config();
