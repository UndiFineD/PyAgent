...
@Data
public class Idea37608Config {
    private String name = "idea_037608";
 ...
 */
@Slf4j
public class Idea37608Service {
    private static final int IDEA_ID = 37608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37608Service() {
        this(new Idea37608Config());
    }

    public Idea37608Service(Idea37608Config config) {
        this.config = config != null ? config : new Idea37608Config();
