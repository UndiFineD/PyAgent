...
@Data
public class Idea37790Config {
    private String name = "idea_037790";
 ...
 */
@Slf4j
public class Idea37790Service {
    private static final int IDEA_ID = 37790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37790Service() {
        this(new Idea37790Config());
    }

    public Idea37790Service(Idea37790Config config) {
        this.config = config != null ? config : new Idea37790Config();
