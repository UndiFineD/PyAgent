...
@Data
public class Idea37698Config {
    private String name = "idea_037698";
 ...
 */
@Slf4j
public class Idea37698Service {
    private static final int IDEA_ID = 37698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37698Service() {
        this(new Idea37698Config());
    }

    public Idea37698Service(Idea37698Config config) {
        this.config = config != null ? config : new Idea37698Config();
