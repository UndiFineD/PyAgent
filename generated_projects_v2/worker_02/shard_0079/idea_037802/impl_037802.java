...
@Data
public class Idea37802Config {
    private String name = "idea_037802";
 ...
 */
@Slf4j
public class Idea37802Service {
    private static final int IDEA_ID = 37802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37802Service() {
        this(new Idea37802Config());
    }

    public Idea37802Service(Idea37802Config config) {
        this.config = config != null ? config : new Idea37802Config();
