...
@Data
public class Idea37857Config {
    private String name = "idea_037857";
 ...
 */
@Slf4j
public class Idea37857Service {
    private static final int IDEA_ID = 37857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37857Service() {
        this(new Idea37857Config());
    }

    public Idea37857Service(Idea37857Config config) {
        this.config = config != null ? config : new Idea37857Config();
