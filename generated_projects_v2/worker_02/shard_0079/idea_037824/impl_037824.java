...
@Data
public class Idea37824Config {
    private String name = "idea_037824";
 ...
 */
@Slf4j
public class Idea37824Service {
    private static final int IDEA_ID = 37824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37824Service() {
        this(new Idea37824Config());
    }

    public Idea37824Service(Idea37824Config config) {
        this.config = config != null ? config : new Idea37824Config();
