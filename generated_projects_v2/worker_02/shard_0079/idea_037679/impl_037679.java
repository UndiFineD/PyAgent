...
@Data
public class Idea37679Config {
    private String name = "idea_037679";
 ...
 */
@Slf4j
public class Idea37679Service {
    private static final int IDEA_ID = 37679;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37679Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37679Service() {
        this(new Idea37679Config());
    }

    public Idea37679Service(Idea37679Config config) {
        this.config = config != null ? config : new Idea37679Config();
