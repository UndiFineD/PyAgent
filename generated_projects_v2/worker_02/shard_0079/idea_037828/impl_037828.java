...
@Data
public class Idea37828Config {
    private String name = "idea_037828";
 ...
 */
@Slf4j
public class Idea37828Service {
    private static final int IDEA_ID = 37828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37828Service() {
        this(new Idea37828Config());
    }

    public Idea37828Service(Idea37828Config config) {
        this.config = config != null ? config : new Idea37828Config();
