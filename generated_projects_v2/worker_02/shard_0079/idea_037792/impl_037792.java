...
@Data
public class Idea37792Config {
    private String name = "idea_037792";
 ...
 */
@Slf4j
public class Idea37792Service {
    private static final int IDEA_ID = 37792;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37792Service() {
        this(new Idea37792Config());
    }

    public Idea37792Service(Idea37792Config config) {
        this.config = config != null ? config : new Idea37792Config();
