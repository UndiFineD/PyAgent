...
@Data
public class Idea37613Config {
    private String name = "idea_037613";
 ...
 */
@Slf4j
public class Idea37613Service {
    private static final int IDEA_ID = 37613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37613Service() {
        this(new Idea37613Config());
    }

    public Idea37613Service(Idea37613Config config) {
        this.config = config != null ? config : new Idea37613Config();
