...
@Data
public class Idea37975Config {
    private String name = "idea_037975";
 ...
 */
@Slf4j
public class Idea37975Service {
    private static final int IDEA_ID = 37975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37975Service() {
        this(new Idea37975Config());
    }

    public Idea37975Service(Idea37975Config config) {
        this.config = config != null ? config : new Idea37975Config();
