...
@Data
public class Idea37537Config {
    private String name = "idea_037537";
 ...
 */
@Slf4j
public class Idea37537Service {
    private static final int IDEA_ID = 37537;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37537Service() {
        this(new Idea37537Config());
    }

    public Idea37537Service(Idea37537Config config) {
        this.config = config != null ? config : new Idea37537Config();
