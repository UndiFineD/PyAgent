...
@Data
public class Idea37662Config {
    private String name = "idea_037662";
 ...
 */
@Slf4j
public class Idea37662Service {
    private static final int IDEA_ID = 37662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37662Service() {
        this(new Idea37662Config());
    }

    public Idea37662Service(Idea37662Config config) {
        this.config = config != null ? config : new Idea37662Config();
