...
@Data
public class Idea37910Config {
    private String name = "idea_037910";
 ...
 */
@Slf4j
public class Idea37910Service {
    private static final int IDEA_ID = 37910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37910Service() {
        this(new Idea37910Config());
    }

    public Idea37910Service(Idea37910Config config) {
        this.config = config != null ? config : new Idea37910Config();
