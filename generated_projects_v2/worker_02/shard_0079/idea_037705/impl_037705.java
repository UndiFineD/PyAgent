...
@Data
public class Idea37705Config {
    private String name = "idea_037705";
 ...
 */
@Slf4j
public class Idea37705Service {
    private static final int IDEA_ID = 37705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37705Service() {
        this(new Idea37705Config());
    }

    public Idea37705Service(Idea37705Config config) {
        this.config = config != null ? config : new Idea37705Config();
