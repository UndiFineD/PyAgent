...
@Data
public class Idea37926Config {
    private String name = "idea_037926";
 ...
 */
@Slf4j
public class Idea37926Service {
    private static final int IDEA_ID = 37926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37926Service() {
        this(new Idea37926Config());
    }

    public Idea37926Service(Idea37926Config config) {
        this.config = config != null ? config : new Idea37926Config();
