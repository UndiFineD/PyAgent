...
@Data
public class Idea37643Config {
    private String name = "idea_037643";
 ...
 */
@Slf4j
public class Idea37643Service {
    private static final int IDEA_ID = 37643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37643Service() {
        this(new Idea37643Config());
    }

    public Idea37643Service(Idea37643Config config) {
        this.config = config != null ? config : new Idea37643Config();
