...
@Data
public class Idea37542Config {
    private String name = "idea_037542";
 ...
 */
@Slf4j
public class Idea37542Service {
    private static final int IDEA_ID = 37542;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37542Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37542Service() {
        this(new Idea37542Config());
    }

    public Idea37542Service(Idea37542Config config) {
        this.config = config != null ? config : new Idea37542Config();
