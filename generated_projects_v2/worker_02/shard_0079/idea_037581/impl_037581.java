...
@Data
public class Idea37581Config {
    private String name = "idea_037581";
 ...
 */
@Slf4j
public class Idea37581Service {
    private static final int IDEA_ID = 37581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37581Service() {
        this(new Idea37581Config());
    }

    public Idea37581Service(Idea37581Config config) {
        this.config = config != null ? config : new Idea37581Config();
