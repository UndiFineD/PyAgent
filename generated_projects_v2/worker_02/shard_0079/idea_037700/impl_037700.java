...
@Data
public class Idea37700Config {
    private String name = "idea_037700";
 ...
 */
@Slf4j
public class Idea37700Service {
    private static final int IDEA_ID = 37700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37700Service() {
        this(new Idea37700Config());
    }

    public Idea37700Service(Idea37700Config config) {
        this.config = config != null ? config : new Idea37700Config();
