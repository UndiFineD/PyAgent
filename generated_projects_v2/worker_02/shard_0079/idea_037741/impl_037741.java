...
@Data
public class Idea37741Config {
    private String name = "idea_037741";
 ...
 */
@Slf4j
public class Idea37741Service {
    private static final int IDEA_ID = 37741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37741Service() {
        this(new Idea37741Config());
    }

    public Idea37741Service(Idea37741Config config) {
        this.config = config != null ? config : new Idea37741Config();
