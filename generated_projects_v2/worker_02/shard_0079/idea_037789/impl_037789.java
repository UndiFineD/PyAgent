...
@Data
public class Idea37789Config {
    private String name = "idea_037789";
 ...
 */
@Slf4j
public class Idea37789Service {
    private static final int IDEA_ID = 37789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37789Service() {
        this(new Idea37789Config());
    }

    public Idea37789Service(Idea37789Config config) {
        this.config = config != null ? config : new Idea37789Config();
