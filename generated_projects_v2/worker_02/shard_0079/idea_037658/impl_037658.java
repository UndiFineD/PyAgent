...
@Data
public class Idea37658Config {
    private String name = "idea_037658";
 ...
 */
@Slf4j
public class Idea37658Service {
    private static final int IDEA_ID = 37658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37658Service() {
        this(new Idea37658Config());
    }

    public Idea37658Service(Idea37658Config config) {
        this.config = config != null ? config : new Idea37658Config();
