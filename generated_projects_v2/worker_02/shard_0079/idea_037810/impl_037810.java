...
@Data
public class Idea37810Config {
    private String name = "idea_037810";
 ...
 */
@Slf4j
public class Idea37810Service {
    private static final int IDEA_ID = 37810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37810Service() {
        this(new Idea37810Config());
    }

    public Idea37810Service(Idea37810Config config) {
        this.config = config != null ? config : new Idea37810Config();
