...
@Data
public class Idea37760Config {
    private String name = "idea_037760";
 ...
 */
@Slf4j
public class Idea37760Service {
    private static final int IDEA_ID = 37760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37760Service() {
        this(new Idea37760Config());
    }

    public Idea37760Service(Idea37760Config config) {
        this.config = config != null ? config : new Idea37760Config();
