...
@Data
public class Idea37591Config {
    private String name = "idea_037591";
 ...
 */
@Slf4j
public class Idea37591Service {
    private static final int IDEA_ID = 37591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37591Service() {
        this(new Idea37591Config());
    }

    public Idea37591Service(Idea37591Config config) {
        this.config = config != null ? config : new Idea37591Config();
