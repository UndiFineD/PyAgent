...
@Data
public class Idea37878Config {
    private String name = "idea_037878";
 ...
 */
@Slf4j
public class Idea37878Service {
    private static final int IDEA_ID = 37878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37878Service() {
        this(new Idea37878Config());
    }

    public Idea37878Service(Idea37878Config config) {
        this.config = config != null ? config : new Idea37878Config();
