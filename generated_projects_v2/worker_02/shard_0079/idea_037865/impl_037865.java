...
@Data
public class Idea37865Config {
    private String name = "idea_037865";
 ...
 */
@Slf4j
public class Idea37865Service {
    private static final int IDEA_ID = 37865;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37865Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37865Service() {
        this(new Idea37865Config());
    }

    public Idea37865Service(Idea37865Config config) {
        this.config = config != null ? config : new Idea37865Config();
