...
@Data
public class Idea37920Config {
    private String name = "idea_037920";
 ...
 */
@Slf4j
public class Idea37920Service {
    private static final int IDEA_ID = 37920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37920Service() {
        this(new Idea37920Config());
    }

    public Idea37920Service(Idea37920Config config) {
        this.config = config != null ? config : new Idea37920Config();
