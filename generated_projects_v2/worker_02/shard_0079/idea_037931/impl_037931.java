...
@Data
public class Idea37931Config {
    private String name = "idea_037931";
 ...
 */
@Slf4j
public class Idea37931Service {
    private static final int IDEA_ID = 37931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37931Service() {
        this(new Idea37931Config());
    }

    public Idea37931Service(Idea37931Config config) {
        this.config = config != null ? config : new Idea37931Config();
