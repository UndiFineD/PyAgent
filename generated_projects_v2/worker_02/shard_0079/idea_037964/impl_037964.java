...
@Data
public class Idea37964Config {
    private String name = "idea_037964";
 ...
 */
@Slf4j
public class Idea37964Service {
    private static final int IDEA_ID = 37964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37964Service() {
        this(new Idea37964Config());
    }

    public Idea37964Service(Idea37964Config config) {
        this.config = config != null ? config : new Idea37964Config();
