...
@Data
public class Idea37650Config {
    private String name = "idea_037650";
 ...
 */
@Slf4j
public class Idea37650Service {
    private static final int IDEA_ID = 37650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37650Service() {
        this(new Idea37650Config());
    }

    public Idea37650Service(Idea37650Config config) {
        this.config = config != null ? config : new Idea37650Config();
