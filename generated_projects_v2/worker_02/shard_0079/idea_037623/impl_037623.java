...
@Data
public class Idea37623Config {
    private String name = "idea_037623";
 ...
 */
@Slf4j
public class Idea37623Service {
    private static final int IDEA_ID = 37623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37623Service() {
        this(new Idea37623Config());
    }

    public Idea37623Service(Idea37623Config config) {
        this.config = config != null ? config : new Idea37623Config();
