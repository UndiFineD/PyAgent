...
@Data
public class Idea37860Config {
    private String name = "idea_037860";
 ...
 */
@Slf4j
public class Idea37860Service {
    private static final int IDEA_ID = 37860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37860Service() {
        this(new Idea37860Config());
    }

    public Idea37860Service(Idea37860Config config) {
        this.config = config != null ? config : new Idea37860Config();
