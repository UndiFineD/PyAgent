...
@Data
public class Idea37654Config {
    private String name = "idea_037654";
 ...
 */
@Slf4j
public class Idea37654Service {
    private static final int IDEA_ID = 37654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37654Service() {
        this(new Idea37654Config());
    }

    public Idea37654Service(Idea37654Config config) {
        this.config = config != null ? config : new Idea37654Config();
