...
@Data
public class Idea37966Config {
    private String name = "idea_037966";
 ...
 */
@Slf4j
public class Idea37966Service {
    private static final int IDEA_ID = 37966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37966Service() {
        this(new Idea37966Config());
    }

    public Idea37966Service(Idea37966Config config) {
        this.config = config != null ? config : new Idea37966Config();
