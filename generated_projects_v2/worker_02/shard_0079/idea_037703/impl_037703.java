...
@Data
public class Idea37703Config {
    private String name = "idea_037703";
 ...
 */
@Slf4j
public class Idea37703Service {
    private static final int IDEA_ID = 37703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37703Service() {
        this(new Idea37703Config());
    }

    public Idea37703Service(Idea37703Config config) {
        this.config = config != null ? config : new Idea37703Config();
