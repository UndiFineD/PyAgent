...
@Data
public class Idea37992Config {
    private String name = "idea_037992";
 ...
 */
@Slf4j
public class Idea37992Service {
    private static final int IDEA_ID = 37992;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37992Service() {
        this(new Idea37992Config());
    }

    public Idea37992Service(Idea37992Config config) {
        this.config = config != null ? config : new Idea37992Config();
