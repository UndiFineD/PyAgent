...
@Data
public class Idea37739Config {
    private String name = "idea_037739";
 ...
 */
@Slf4j
public class Idea37739Service {
    private static final int IDEA_ID = 37739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37739Service() {
        this(new Idea37739Config());
    }

    public Idea37739Service(Idea37739Config config) {
        this.config = config != null ? config : new Idea37739Config();
