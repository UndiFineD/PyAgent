...
@Data
public class Idea37557Config {
    private String name = "idea_037557";
 ...
 */
@Slf4j
public class Idea37557Service {
    private static final int IDEA_ID = 37557;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37557Service() {
        this(new Idea37557Config());
    }

    public Idea37557Service(Idea37557Config config) {
        this.config = config != null ? config : new Idea37557Config();
