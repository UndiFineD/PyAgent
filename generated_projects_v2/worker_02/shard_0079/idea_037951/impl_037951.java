...
@Data
public class Idea37951Config {
    private String name = "idea_037951";
 ...
 */
@Slf4j
public class Idea37951Service {
    private static final int IDEA_ID = 37951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37951Service() {
        this(new Idea37951Config());
    }

    public Idea37951Service(Idea37951Config config) {
        this.config = config != null ? config : new Idea37951Config();
