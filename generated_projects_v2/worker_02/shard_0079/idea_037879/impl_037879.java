...
@Data
public class Idea37879Config {
    private String name = "idea_037879";
 ...
 */
@Slf4j
public class Idea37879Service {
    private static final int IDEA_ID = 37879;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37879Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37879Service() {
        this(new Idea37879Config());
    }

    public Idea37879Service(Idea37879Config config) {
        this.config = config != null ? config : new Idea37879Config();
