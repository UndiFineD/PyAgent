...
@Data
public class Idea37555Config {
    private String name = "idea_037555";
 ...
 */
@Slf4j
public class Idea37555Service {
    private static final int IDEA_ID = 37555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37555Service() {
        this(new Idea37555Config());
    }

    public Idea37555Service(Idea37555Config config) {
        this.config = config != null ? config : new Idea37555Config();
