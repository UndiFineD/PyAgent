...
@Data
public class Idea37800Config {
    private String name = "idea_037800";
 ...
 */
@Slf4j
public class Idea37800Service {
    private static final int IDEA_ID = 37800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37800Service() {
        this(new Idea37800Config());
    }

    public Idea37800Service(Idea37800Config config) {
        this.config = config != null ? config : new Idea37800Config();
