...
@Data
public class Idea37949Config {
    private String name = "idea_037949";
 ...
 */
@Slf4j
public class Idea37949Service {
    private static final int IDEA_ID = 37949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37949Service() {
        this(new Idea37949Config());
    }

    public Idea37949Service(Idea37949Config config) {
        this.config = config != null ? config : new Idea37949Config();
