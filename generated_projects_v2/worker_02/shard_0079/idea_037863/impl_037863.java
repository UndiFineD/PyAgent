...
@Data
public class Idea37863Config {
    private String name = "idea_037863";
 ...
 */
@Slf4j
public class Idea37863Service {
    private static final int IDEA_ID = 37863;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37863Service() {
        this(new Idea37863Config());
    }

    public Idea37863Service(Idea37863Config config) {
        this.config = config != null ? config : new Idea37863Config();
