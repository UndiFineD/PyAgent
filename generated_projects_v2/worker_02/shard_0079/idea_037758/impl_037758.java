...
@Data
public class Idea37758Config {
    private String name = "idea_037758";
 ...
 */
@Slf4j
public class Idea37758Service {
    private static final int IDEA_ID = 37758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37758Service() {
        this(new Idea37758Config());
    }

    public Idea37758Service(Idea37758Config config) {
        this.config = config != null ? config : new Idea37758Config();
