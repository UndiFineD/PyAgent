...
@Data
public class Idea37855Config {
    private String name = "idea_037855";
 ...
 */
@Slf4j
public class Idea37855Service {
    private static final int IDEA_ID = 37855;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37855Service() {
        this(new Idea37855Config());
    }

    public Idea37855Service(Idea37855Config config) {
        this.config = config != null ? config : new Idea37855Config();
