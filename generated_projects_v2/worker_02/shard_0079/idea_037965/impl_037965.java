...
@Data
public class Idea37965Config {
    private String name = "idea_037965";
 ...
 */
@Slf4j
public class Idea37965Service {
    private static final int IDEA_ID = 37965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37965Service() {
        this(new Idea37965Config());
    }

    public Idea37965Service(Idea37965Config config) {
        this.config = config != null ? config : new Idea37965Config();
