...
@Data
public class Idea37652Config {
    private String name = "idea_037652";
 ...
 */
@Slf4j
public class Idea37652Service {
    private static final int IDEA_ID = 37652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37652Service() {
        this(new Idea37652Config());
    }

    public Idea37652Service(Idea37652Config config) {
        this.config = config != null ? config : new Idea37652Config();
