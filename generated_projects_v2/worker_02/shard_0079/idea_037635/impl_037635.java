...
@Data
public class Idea37635Config {
    private String name = "idea_037635";
 ...
 */
@Slf4j
public class Idea37635Service {
    private static final int IDEA_ID = 37635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea37635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea37635Service() {
        this(new Idea37635Config());
    }

    public Idea37635Service(Idea37635Config config) {
        this.config = config != null ? config : new Idea37635Config();
