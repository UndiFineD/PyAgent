...
@Data
public class Idea38488Config {
    private String name = "idea_038488";
 ...
 */
@Slf4j
public class Idea38488Service {
    private static final int IDEA_ID = 38488;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38488Service() {
        this(new Idea38488Config());
    }

    public Idea38488Service(Idea38488Config config) {
        this.config = config != null ? config : new Idea38488Config();
