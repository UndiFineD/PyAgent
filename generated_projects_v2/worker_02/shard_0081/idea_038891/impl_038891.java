...
@Data
public class Idea38891Config {
    private String name = "idea_038891";
 ...
 */
@Slf4j
public class Idea38891Service {
    private static final int IDEA_ID = 38891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38891Service() {
        this(new Idea38891Config());
    }

    public Idea38891Service(Idea38891Config config) {
        this.config = config != null ? config : new Idea38891Config();
