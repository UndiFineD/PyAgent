...
@Data
public class Idea38540Config {
    private String name = "idea_038540";
 ...
 */
@Slf4j
public class Idea38540Service {
    private static final int IDEA_ID = 38540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38540Service() {
        this(new Idea38540Config());
    }

    public Idea38540Service(Idea38540Config config) {
        this.config = config != null ? config : new Idea38540Config();
