...
@Data
public class Idea38853Config {
    private String name = "idea_038853";
 ...
 */
@Slf4j
public class Idea38853Service {
    private static final int IDEA_ID = 38853;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38853Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38853Service() {
        this(new Idea38853Config());
    }

    public Idea38853Service(Idea38853Config config) {
        this.config = config != null ? config : new Idea38853Config();
