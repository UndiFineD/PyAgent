...
@Data
public class Idea38573Config {
    private String name = "idea_038573";
 ...
 */
@Slf4j
public class Idea38573Service {
    private static final int IDEA_ID = 38573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38573Service() {
        this(new Idea38573Config());
    }

    public Idea38573Service(Idea38573Config config) {
        this.config = config != null ? config : new Idea38573Config();
