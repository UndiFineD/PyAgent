...
@Data
public class Idea38948Config {
    private String name = "idea_038948";
 ...
 */
@Slf4j
public class Idea38948Service {
    private static final int IDEA_ID = 38948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38948Service() {
        this(new Idea38948Config());
    }

    public Idea38948Service(Idea38948Config config) {
        this.config = config != null ? config : new Idea38948Config();
