...
@Data
public class Idea38690Config {
    private String name = "idea_038690";
 ...
 */
@Slf4j
public class Idea38690Service {
    private static final int IDEA_ID = 38690;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38690Service() {
        this(new Idea38690Config());
    }

    public Idea38690Service(Idea38690Config config) {
        this.config = config != null ? config : new Idea38690Config();
