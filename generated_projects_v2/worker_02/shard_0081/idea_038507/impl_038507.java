...
@Data
public class Idea38507Config {
    private String name = "idea_038507";
 ...
 */
@Slf4j
public class Idea38507Service {
    private static final int IDEA_ID = 38507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38507Service() {
        this(new Idea38507Config());
    }

    public Idea38507Service(Idea38507Config config) {
        this.config = config != null ? config : new Idea38507Config();
