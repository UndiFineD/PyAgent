...
@Data
public class Idea38520Config {
    private String name = "idea_038520";
 ...
 */
@Slf4j
public class Idea38520Service {
    private static final int IDEA_ID = 38520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38520Service() {
        this(new Idea38520Config());
    }

    public Idea38520Service(Idea38520Config config) {
        this.config = config != null ? config : new Idea38520Config();
