...
@Data
public class Idea38558Config {
    private String name = "idea_038558";
 ...
 */
@Slf4j
public class Idea38558Service {
    private static final int IDEA_ID = 38558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38558Service() {
        this(new Idea38558Config());
    }

    public Idea38558Service(Idea38558Config config) {
        this.config = config != null ? config : new Idea38558Config();
