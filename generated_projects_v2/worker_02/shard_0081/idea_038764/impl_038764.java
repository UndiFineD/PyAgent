...
@Data
public class Idea38764Config {
    private String name = "idea_038764";
 ...
 */
@Slf4j
public class Idea38764Service {
    private static final int IDEA_ID = 38764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38764Service() {
        this(new Idea38764Config());
    }

    public Idea38764Service(Idea38764Config config) {
        this.config = config != null ? config : new Idea38764Config();
