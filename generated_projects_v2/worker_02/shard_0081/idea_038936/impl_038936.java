...
@Data
public class Idea38936Config {
    private String name = "idea_038936";
 ...
 */
@Slf4j
public class Idea38936Service {
    private static final int IDEA_ID = 38936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38936Service() {
        this(new Idea38936Config());
    }

    public Idea38936Service(Idea38936Config config) {
        this.config = config != null ? config : new Idea38936Config();
