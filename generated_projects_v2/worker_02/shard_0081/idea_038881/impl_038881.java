...
@Data
public class Idea38881Config {
    private String name = "idea_038881";
 ...
 */
@Slf4j
public class Idea38881Service {
    private static final int IDEA_ID = 38881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38881Service() {
        this(new Idea38881Config());
    }

    public Idea38881Service(Idea38881Config config) {
        this.config = config != null ? config : new Idea38881Config();
