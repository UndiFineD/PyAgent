...
@Data
public class Idea38864Config {
    private String name = "idea_038864";
 ...
 */
@Slf4j
public class Idea38864Service {
    private static final int IDEA_ID = 38864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38864Service() {
        this(new Idea38864Config());
    }

    public Idea38864Service(Idea38864Config config) {
        this.config = config != null ? config : new Idea38864Config();
