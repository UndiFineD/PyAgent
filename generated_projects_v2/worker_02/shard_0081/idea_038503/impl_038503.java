...
@Data
public class Idea38503Config {
    private String name = "idea_038503";
 ...
 */
@Slf4j
public class Idea38503Service {
    private static final int IDEA_ID = 38503;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38503Service() {
        this(new Idea38503Config());
    }

    public Idea38503Service(Idea38503Config config) {
        this.config = config != null ? config : new Idea38503Config();
