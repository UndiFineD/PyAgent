...
@Data
public class Idea38711Config {
    private String name = "idea_038711";
 ...
 */
@Slf4j
public class Idea38711Service {
    private static final int IDEA_ID = 38711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38711Service() {
        this(new Idea38711Config());
    }

    public Idea38711Service(Idea38711Config config) {
        this.config = config != null ? config : new Idea38711Config();
