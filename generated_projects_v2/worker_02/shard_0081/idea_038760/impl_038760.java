...
@Data
public class Idea38760Config {
    private String name = "idea_038760";
 ...
 */
@Slf4j
public class Idea38760Service {
    private static final int IDEA_ID = 38760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38760Service() {
        this(new Idea38760Config());
    }

    public Idea38760Service(Idea38760Config config) {
        this.config = config != null ? config : new Idea38760Config();
