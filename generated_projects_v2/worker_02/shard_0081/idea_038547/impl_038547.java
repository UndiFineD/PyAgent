...
@Data
public class Idea38547Config {
    private String name = "idea_038547";
 ...
 */
@Slf4j
public class Idea38547Service {
    private static final int IDEA_ID = 38547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38547Service() {
        this(new Idea38547Config());
    }

    public Idea38547Service(Idea38547Config config) {
        this.config = config != null ? config : new Idea38547Config();
