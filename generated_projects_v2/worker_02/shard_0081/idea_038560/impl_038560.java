...
@Data
public class Idea38560Config {
    private String name = "idea_038560";
 ...
 */
@Slf4j
public class Idea38560Service {
    private static final int IDEA_ID = 38560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38560Service() {
        this(new Idea38560Config());
    }

    public Idea38560Service(Idea38560Config config) {
        this.config = config != null ? config : new Idea38560Config();
