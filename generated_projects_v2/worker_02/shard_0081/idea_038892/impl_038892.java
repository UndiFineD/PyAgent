...
@Data
public class Idea38892Config {
    private String name = "idea_038892";
 ...
 */
@Slf4j
public class Idea38892Service {
    private static final int IDEA_ID = 38892;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38892Service() {
        this(new Idea38892Config());
    }

    public Idea38892Service(Idea38892Config config) {
        this.config = config != null ? config : new Idea38892Config();
