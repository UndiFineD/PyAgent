...
@Data
public class Idea38484Config {
    private String name = "idea_038484";
 ...
 */
@Slf4j
public class Idea38484Service {
    private static final int IDEA_ID = 38484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38484Service() {
        this(new Idea38484Config());
    }

    public Idea38484Service(Idea38484Config config) {
        this.config = config != null ? config : new Idea38484Config();
