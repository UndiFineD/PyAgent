...
@Data
public class Idea38553Config {
    private String name = "idea_038553";
 ...
 */
@Slf4j
public class Idea38553Service {
    private static final int IDEA_ID = 38553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38553Service() {
        this(new Idea38553Config());
    }

    public Idea38553Service(Idea38553Config config) {
        this.config = config != null ? config : new Idea38553Config();
