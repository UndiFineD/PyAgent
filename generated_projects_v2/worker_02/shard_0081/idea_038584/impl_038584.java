...
@Data
public class Idea38584Config {
    private String name = "idea_038584";
 ...
 */
@Slf4j
public class Idea38584Service {
    private static final int IDEA_ID = 38584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38584Service() {
        this(new Idea38584Config());
    }

    public Idea38584Service(Idea38584Config config) {
        this.config = config != null ? config : new Idea38584Config();
