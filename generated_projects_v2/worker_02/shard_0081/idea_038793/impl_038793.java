...
@Data
public class Idea38793Config {
    private String name = "idea_038793";
 ...
 */
@Slf4j
public class Idea38793Service {
    private static final int IDEA_ID = 38793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38793Service() {
        this(new Idea38793Config());
    }

    public Idea38793Service(Idea38793Config config) {
        this.config = config != null ? config : new Idea38793Config();
