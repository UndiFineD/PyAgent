...
@Data
public class Idea38571Config {
    private String name = "idea_038571";
 ...
 */
@Slf4j
public class Idea38571Service {
    private static final int IDEA_ID = 38571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38571Service() {
        this(new Idea38571Config());
    }

    public Idea38571Service(Idea38571Config config) {
        this.config = config != null ? config : new Idea38571Config();
