...
@Data
public class Idea38774Config {
    private String name = "idea_038774";
 ...
 */
@Slf4j
public class Idea38774Service {
    private static final int IDEA_ID = 38774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38774Service() {
        this(new Idea38774Config());
    }

    public Idea38774Service(Idea38774Config config) {
        this.config = config != null ? config : new Idea38774Config();
