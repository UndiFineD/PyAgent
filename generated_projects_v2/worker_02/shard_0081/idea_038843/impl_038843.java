...
@Data
public class Idea38843Config {
    private String name = "idea_038843";
 ...
 */
@Slf4j
public class Idea38843Service {
    private static final int IDEA_ID = 38843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38843Service() {
        this(new Idea38843Config());
    }

    public Idea38843Service(Idea38843Config config) {
        this.config = config != null ? config : new Idea38843Config();
