...
@Data
public class Idea38638Config {
    private String name = "idea_038638";
 ...
 */
@Slf4j
public class Idea38638Service {
    private static final int IDEA_ID = 38638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38638Service() {
        this(new Idea38638Config());
    }

    public Idea38638Service(Idea38638Config config) {
        this.config = config != null ? config : new Idea38638Config();
