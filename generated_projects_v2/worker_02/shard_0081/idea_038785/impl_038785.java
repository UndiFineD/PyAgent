...
@Data
public class Idea38785Config {
    private String name = "idea_038785";
 ...
 */
@Slf4j
public class Idea38785Service {
    private static final int IDEA_ID = 38785;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38785Service() {
        this(new Idea38785Config());
    }

    public Idea38785Service(Idea38785Config config) {
        this.config = config != null ? config : new Idea38785Config();
