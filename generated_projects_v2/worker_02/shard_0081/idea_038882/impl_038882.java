...
@Data
public class Idea38882Config {
    private String name = "idea_038882";
 ...
 */
@Slf4j
public class Idea38882Service {
    private static final int IDEA_ID = 38882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38882Service() {
        this(new Idea38882Config());
    }

    public Idea38882Service(Idea38882Config config) {
        this.config = config != null ? config : new Idea38882Config();
