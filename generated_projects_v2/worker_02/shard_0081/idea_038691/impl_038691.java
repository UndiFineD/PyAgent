...
@Data
public class Idea38691Config {
    private String name = "idea_038691";
 ...
 */
@Slf4j
public class Idea38691Service {
    private static final int IDEA_ID = 38691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38691Service() {
        this(new Idea38691Config());
    }

    public Idea38691Service(Idea38691Config config) {
        this.config = config != null ? config : new Idea38691Config();
