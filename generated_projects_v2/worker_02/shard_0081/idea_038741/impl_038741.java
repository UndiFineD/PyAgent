...
@Data
public class Idea38741Config {
    private String name = "idea_038741";
 ...
 */
@Slf4j
public class Idea38741Service {
    private static final int IDEA_ID = 38741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38741Service() {
        this(new Idea38741Config());
    }

    public Idea38741Service(Idea38741Config config) {
        this.config = config != null ? config : new Idea38741Config();
