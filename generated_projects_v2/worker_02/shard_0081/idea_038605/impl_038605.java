...
@Data
public class Idea38605Config {
    private String name = "idea_038605";
 ...
 */
@Slf4j
public class Idea38605Service {
    private static final int IDEA_ID = 38605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38605Service() {
        this(new Idea38605Config());
    }

    public Idea38605Service(Idea38605Config config) {
        this.config = config != null ? config : new Idea38605Config();
