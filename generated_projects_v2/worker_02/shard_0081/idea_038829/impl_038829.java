...
@Data
public class Idea38829Config {
    private String name = "idea_038829";
 ...
 */
@Slf4j
public class Idea38829Service {
    private static final int IDEA_ID = 38829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38829Service() {
        this(new Idea38829Config());
    }

    public Idea38829Service(Idea38829Config config) {
        this.config = config != null ? config : new Idea38829Config();
