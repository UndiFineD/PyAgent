...
@Data
public class Idea38555Config {
    private String name = "idea_038555";
 ...
 */
@Slf4j
public class Idea38555Service {
    private static final int IDEA_ID = 38555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38555Service() {
        this(new Idea38555Config());
    }

    public Idea38555Service(Idea38555Config config) {
        this.config = config != null ? config : new Idea38555Config();
