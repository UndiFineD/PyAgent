...
@Data
public class Idea38689Config {
    private String name = "idea_038689";
 ...
 */
@Slf4j
public class Idea38689Service {
    private static final int IDEA_ID = 38689;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38689Service() {
        this(new Idea38689Config());
    }

    public Idea38689Service(Idea38689Config config) {
        this.config = config != null ? config : new Idea38689Config();
