...
@Data
public class Idea38932Config {
    private String name = "idea_038932";
 ...
 */
@Slf4j
public class Idea38932Service {
    private static final int IDEA_ID = 38932;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38932Service() {
        this(new Idea38932Config());
    }

    public Idea38932Service(Idea38932Config config) {
        this.config = config != null ? config : new Idea38932Config();
