...
@Data
public class Idea38808Config {
    private String name = "idea_038808";
 ...
 */
@Slf4j
public class Idea38808Service {
    private static final int IDEA_ID = 38808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38808Service() {
        this(new Idea38808Config());
    }

    public Idea38808Service(Idea38808Config config) {
        this.config = config != null ? config : new Idea38808Config();
