...
@Data
public class Idea38601Config {
    private String name = "idea_038601";
 ...
 */
@Slf4j
public class Idea38601Service {
    private static final int IDEA_ID = 38601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38601Service() {
        this(new Idea38601Config());
    }

    public Idea38601Service(Idea38601Config config) {
        this.config = config != null ? config : new Idea38601Config();
