...
@Data
public class Idea38877Config {
    private String name = "idea_038877";
 ...
 */
@Slf4j
public class Idea38877Service {
    private static final int IDEA_ID = 38877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38877Service() {
        this(new Idea38877Config());
    }

    public Idea38877Service(Idea38877Config config) {
        this.config = config != null ? config : new Idea38877Config();
