...
@Data
public class Idea38940Config {
    private String name = "idea_038940";
 ...
 */
@Slf4j
public class Idea38940Service {
    private static final int IDEA_ID = 38940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38940Service() {
        this(new Idea38940Config());
    }

    public Idea38940Service(Idea38940Config config) {
        this.config = config != null ? config : new Idea38940Config();
