...
@Data
public class Idea38619Config {
    private String name = "idea_038619";
 ...
 */
@Slf4j
public class Idea38619Service {
    private static final int IDEA_ID = 38619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38619Service() {
        this(new Idea38619Config());
    }

    public Idea38619Service(Idea38619Config config) {
        this.config = config != null ? config : new Idea38619Config();
