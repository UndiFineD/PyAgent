...
@Data
public class Idea38835Config {
    private String name = "idea_038835";
 ...
 */
@Slf4j
public class Idea38835Service {
    private static final int IDEA_ID = 38835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38835Service() {
        this(new Idea38835Config());
    }

    public Idea38835Service(Idea38835Config config) {
        this.config = config != null ? config : new Idea38835Config();
