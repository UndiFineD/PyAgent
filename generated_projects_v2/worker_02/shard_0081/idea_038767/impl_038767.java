...
@Data
public class Idea38767Config {
    private String name = "idea_038767";
 ...
 */
@Slf4j
public class Idea38767Service {
    private static final int IDEA_ID = 38767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38767Service() {
        this(new Idea38767Config());
    }

    public Idea38767Service(Idea38767Config config) {
        this.config = config != null ? config : new Idea38767Config();
