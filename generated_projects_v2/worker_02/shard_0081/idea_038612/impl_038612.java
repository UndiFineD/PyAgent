...
@Data
public class Idea38612Config {
    private String name = "idea_038612";
 ...
 */
@Slf4j
public class Idea38612Service {
    private static final int IDEA_ID = 38612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38612Service() {
        this(new Idea38612Config());
    }

    public Idea38612Service(Idea38612Config config) {
        this.config = config != null ? config : new Idea38612Config();
