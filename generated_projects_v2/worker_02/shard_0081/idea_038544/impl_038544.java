...
@Data
public class Idea38544Config {
    private String name = "idea_038544";
 ...
 */
@Slf4j
public class Idea38544Service {
    private static final int IDEA_ID = 38544;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38544Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38544Service() {
        this(new Idea38544Config());
    }

    public Idea38544Service(Idea38544Config config) {
        this.config = config != null ? config : new Idea38544Config();
