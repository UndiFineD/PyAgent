...
@Data
public class Idea38478Config {
    private String name = "idea_038478";
 ...
 */
@Slf4j
public class Idea38478Service {
    private static final int IDEA_ID = 38478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38478Service() {
        this(new Idea38478Config());
    }

    public Idea38478Service(Idea38478Config config) {
        this.config = config != null ? config : new Idea38478Config();
