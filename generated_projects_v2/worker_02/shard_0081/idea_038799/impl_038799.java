...
@Data
public class Idea38799Config {
    private String name = "idea_038799";
 ...
 */
@Slf4j
public class Idea38799Service {
    private static final int IDEA_ID = 38799;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38799Service() {
        this(new Idea38799Config());
    }

    public Idea38799Service(Idea38799Config config) {
        this.config = config != null ? config : new Idea38799Config();
