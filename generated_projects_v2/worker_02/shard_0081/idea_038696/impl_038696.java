...
@Data
public class Idea38696Config {
    private String name = "idea_038696";
 ...
 */
@Slf4j
public class Idea38696Service {
    private static final int IDEA_ID = 38696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38696Service() {
        this(new Idea38696Config());
    }

    public Idea38696Service(Idea38696Config config) {
        this.config = config != null ? config : new Idea38696Config();
