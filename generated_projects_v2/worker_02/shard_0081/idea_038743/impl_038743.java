...
@Data
public class Idea38743Config {
    private String name = "idea_038743";
 ...
 */
@Slf4j
public class Idea38743Service {
    private static final int IDEA_ID = 38743;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38743Service() {
        this(new Idea38743Config());
    }

    public Idea38743Service(Idea38743Config config) {
        this.config = config != null ? config : new Idea38743Config();
