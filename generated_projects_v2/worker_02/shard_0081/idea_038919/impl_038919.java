...
@Data
public class Idea38919Config {
    private String name = "idea_038919";
 ...
 */
@Slf4j
public class Idea38919Service {
    private static final int IDEA_ID = 38919;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38919Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38919Service() {
        this(new Idea38919Config());
    }

    public Idea38919Service(Idea38919Config config) {
        this.config = config != null ? config : new Idea38919Config();
