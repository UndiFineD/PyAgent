...
@Data
public class Idea38548Config {
    private String name = "idea_038548";
 ...
 */
@Slf4j
public class Idea38548Service {
    private static final int IDEA_ID = 38548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38548Service() {
        this(new Idea38548Config());
    }

    public Idea38548Service(Idea38548Config config) {
        this.config = config != null ? config : new Idea38548Config();
