...
@Data
public class Idea38794Config {
    private String name = "idea_038794";
 ...
 */
@Slf4j
public class Idea38794Service {
    private static final int IDEA_ID = 38794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38794Service() {
        this(new Idea38794Config());
    }

    public Idea38794Service(Idea38794Config config) {
        this.config = config != null ? config : new Idea38794Config();
