...
@Data
public class Idea38552Config {
    private String name = "idea_038552";
 ...
 */
@Slf4j
public class Idea38552Service {
    private static final int IDEA_ID = 38552;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38552Service() {
        this(new Idea38552Config());
    }

    public Idea38552Service(Idea38552Config config) {
        this.config = config != null ? config : new Idea38552Config();
