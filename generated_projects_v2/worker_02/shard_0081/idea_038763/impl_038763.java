...
@Data
public class Idea38763Config {
    private String name = "idea_038763";
 ...
 */
@Slf4j
public class Idea38763Service {
    private static final int IDEA_ID = 38763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38763Service() {
        this(new Idea38763Config());
    }

    public Idea38763Service(Idea38763Config config) {
        this.config = config != null ? config : new Idea38763Config();
