...
@Data
public class Idea38786Config {
    private String name = "idea_038786";
 ...
 */
@Slf4j
public class Idea38786Service {
    private static final int IDEA_ID = 38786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38786Service() {
        this(new Idea38786Config());
    }

    public Idea38786Service(Idea38786Config config) {
        this.config = config != null ? config : new Idea38786Config();
