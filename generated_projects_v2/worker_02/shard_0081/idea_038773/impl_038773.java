...
@Data
public class Idea38773Config {
    private String name = "idea_038773";
 ...
 */
@Slf4j
public class Idea38773Service {
    private static final int IDEA_ID = 38773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38773Service() {
        this(new Idea38773Config());
    }

    public Idea38773Service(Idea38773Config config) {
        this.config = config != null ? config : new Idea38773Config();
