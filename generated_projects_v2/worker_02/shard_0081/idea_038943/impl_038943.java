...
@Data
public class Idea38943Config {
    private String name = "idea_038943";
 ...
 */
@Slf4j
public class Idea38943Service {
    private static final int IDEA_ID = 38943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38943Service() {
        this(new Idea38943Config());
    }

    public Idea38943Service(Idea38943Config config) {
        this.config = config != null ? config : new Idea38943Config();
