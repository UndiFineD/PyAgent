...
@Data
public class Idea38896Config {
    private String name = "idea_038896";
 ...
 */
@Slf4j
public class Idea38896Service {
    private static final int IDEA_ID = 38896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38896Service() {
        this(new Idea38896Config());
    }

    public Idea38896Service(Idea38896Config config) {
        this.config = config != null ? config : new Idea38896Config();
