...
@Data
public class Idea38755Config {
    private String name = "idea_038755";
 ...
 */
@Slf4j
public class Idea38755Service {
    private static final int IDEA_ID = 38755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38755Service() {
        this(new Idea38755Config());
    }

    public Idea38755Service(Idea38755Config config) {
        this.config = config != null ? config : new Idea38755Config();
