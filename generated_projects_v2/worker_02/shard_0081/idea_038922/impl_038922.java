...
@Data
public class Idea38922Config {
    private String name = "idea_038922";
 ...
 */
@Slf4j
public class Idea38922Service {
    private static final int IDEA_ID = 38922;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38922Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38922Service() {
        this(new Idea38922Config());
    }

    public Idea38922Service(Idea38922Config config) {
        this.config = config != null ? config : new Idea38922Config();
