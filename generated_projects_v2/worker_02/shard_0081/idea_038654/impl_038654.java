...
@Data
public class Idea38654Config {
    private String name = "idea_038654";
 ...
 */
@Slf4j
public class Idea38654Service {
    private static final int IDEA_ID = 38654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38654Service() {
        this(new Idea38654Config());
    }

    public Idea38654Service(Idea38654Config config) {
        this.config = config != null ? config : new Idea38654Config();
