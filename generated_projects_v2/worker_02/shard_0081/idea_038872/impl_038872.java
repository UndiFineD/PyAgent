...
@Data
public class Idea38872Config {
    private String name = "idea_038872";
 ...
 */
@Slf4j
public class Idea38872Service {
    private static final int IDEA_ID = 38872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38872Service() {
        this(new Idea38872Config());
    }

    public Idea38872Service(Idea38872Config config) {
        this.config = config != null ? config : new Idea38872Config();
