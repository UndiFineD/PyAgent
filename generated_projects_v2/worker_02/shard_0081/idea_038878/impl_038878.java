...
@Data
public class Idea38878Config {
    private String name = "idea_038878";
 ...
 */
@Slf4j
public class Idea38878Service {
    private static final int IDEA_ID = 38878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38878Service() {
        this(new Idea38878Config());
    }

    public Idea38878Service(Idea38878Config config) {
        this.config = config != null ? config : new Idea38878Config();
