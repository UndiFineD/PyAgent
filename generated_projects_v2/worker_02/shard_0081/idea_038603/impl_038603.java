...
@Data
public class Idea38603Config {
    private String name = "idea_038603";
 ...
 */
@Slf4j
public class Idea38603Service {
    private static final int IDEA_ID = 38603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38603Service() {
        this(new Idea38603Config());
    }

    public Idea38603Service(Idea38603Config config) {
        this.config = config != null ? config : new Idea38603Config();
