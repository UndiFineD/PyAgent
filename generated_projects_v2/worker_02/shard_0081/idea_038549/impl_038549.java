...
@Data
public class Idea38549Config {
    private String name = "idea_038549";
 ...
 */
@Slf4j
public class Idea38549Service {
    private static final int IDEA_ID = 38549;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38549Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38549Service() {
        this(new Idea38549Config());
    }

    public Idea38549Service(Idea38549Config config) {
        this.config = config != null ? config : new Idea38549Config();
