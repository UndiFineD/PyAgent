...
@Data
public class Idea38883Config {
    private String name = "idea_038883";
 ...
 */
@Slf4j
public class Idea38883Service {
    private static final int IDEA_ID = 38883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38883Service() {
        this(new Idea38883Config());
    }

    public Idea38883Service(Idea38883Config config) {
        this.config = config != null ? config : new Idea38883Config();
