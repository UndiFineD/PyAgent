...
@Data
public class Idea38515Config {
    private String name = "idea_038515";
 ...
 */
@Slf4j
public class Idea38515Service {
    private static final int IDEA_ID = 38515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38515Service() {
        this(new Idea38515Config());
    }

    public Idea38515Service(Idea38515Config config) {
        this.config = config != null ? config : new Idea38515Config();
