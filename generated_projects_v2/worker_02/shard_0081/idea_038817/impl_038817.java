...
@Data
public class Idea38817Config {
    private String name = "idea_038817";
 ...
 */
@Slf4j
public class Idea38817Service {
    private static final int IDEA_ID = 38817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38817Service() {
        this(new Idea38817Config());
    }

    public Idea38817Service(Idea38817Config config) {
        this.config = config != null ? config : new Idea38817Config();
