...
@Data
public class Idea38867Config {
    private String name = "idea_038867";
 ...
 */
@Slf4j
public class Idea38867Service {
    private static final int IDEA_ID = 38867;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38867Service() {
        this(new Idea38867Config());
    }

    public Idea38867Service(Idea38867Config config) {
        this.config = config != null ? config : new Idea38867Config();
