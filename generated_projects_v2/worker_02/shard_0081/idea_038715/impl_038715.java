...
@Data
public class Idea38715Config {
    private String name = "idea_038715";
 ...
 */
@Slf4j
public class Idea38715Service {
    private static final int IDEA_ID = 38715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38715Service() {
        this(new Idea38715Config());
    }

    public Idea38715Service(Idea38715Config config) {
        this.config = config != null ? config : new Idea38715Config();
