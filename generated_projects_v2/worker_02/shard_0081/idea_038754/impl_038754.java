...
@Data
public class Idea38754Config {
    private String name = "idea_038754";
 ...
 */
@Slf4j
public class Idea38754Service {
    private static final int IDEA_ID = 38754;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38754Service() {
        this(new Idea38754Config());
    }

    public Idea38754Service(Idea38754Config config) {
        this.config = config != null ? config : new Idea38754Config();
