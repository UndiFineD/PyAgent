...
@Data
public class Idea38614Config {
    private String name = "idea_038614";
 ...
 */
@Slf4j
public class Idea38614Service {
    private static final int IDEA_ID = 38614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38614Service() {
        this(new Idea38614Config());
    }

    public Idea38614Service(Idea38614Config config) {
        this.config = config != null ? config : new Idea38614Config();
