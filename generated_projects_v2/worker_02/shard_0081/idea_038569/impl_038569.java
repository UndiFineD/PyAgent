...
@Data
public class Idea38569Config {
    private String name = "idea_038569";
 ...
 */
@Slf4j
public class Idea38569Service {
    private static final int IDEA_ID = 38569;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38569Service() {
        this(new Idea38569Config());
    }

    public Idea38569Service(Idea38569Config config) {
        this.config = config != null ? config : new Idea38569Config();
