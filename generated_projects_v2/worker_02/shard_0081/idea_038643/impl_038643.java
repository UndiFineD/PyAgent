...
@Data
public class Idea38643Config {
    private String name = "idea_038643";
 ...
 */
@Slf4j
public class Idea38643Service {
    private static final int IDEA_ID = 38643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38643Service() {
        this(new Idea38643Config());
    }

    public Idea38643Service(Idea38643Config config) {
        this.config = config != null ? config : new Idea38643Config();
