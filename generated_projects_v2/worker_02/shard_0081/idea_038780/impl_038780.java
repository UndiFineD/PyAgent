...
@Data
public class Idea38780Config {
    private String name = "idea_038780";
 ...
 */
@Slf4j
public class Idea38780Service {
    private static final int IDEA_ID = 38780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38780Service() {
        this(new Idea38780Config());
    }

    public Idea38780Service(Idea38780Config config) {
        this.config = config != null ? config : new Idea38780Config();
