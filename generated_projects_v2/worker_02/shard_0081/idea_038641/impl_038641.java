...
@Data
public class Idea38641Config {
    private String name = "idea_038641";
 ...
 */
@Slf4j
public class Idea38641Service {
    private static final int IDEA_ID = 38641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38641Service() {
        this(new Idea38641Config());
    }

    public Idea38641Service(Idea38641Config config) {
        this.config = config != null ? config : new Idea38641Config();
