...
@Data
public class Idea38714Config {
    private String name = "idea_038714";
 ...
 */
@Slf4j
public class Idea38714Service {
    private static final int IDEA_ID = 38714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38714Service() {
        this(new Idea38714Config());
    }

    public Idea38714Service(Idea38714Config config) {
        this.config = config != null ? config : new Idea38714Config();
