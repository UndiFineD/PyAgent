...
@Data
public class Idea38934Config {
    private String name = "idea_038934";
 ...
 */
@Slf4j
public class Idea38934Service {
    private static final int IDEA_ID = 38934;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38934Service() {
        this(new Idea38934Config());
    }

    public Idea38934Service(Idea38934Config config) {
        this.config = config != null ? config : new Idea38934Config();
