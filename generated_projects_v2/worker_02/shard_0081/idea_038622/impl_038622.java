...
@Data
public class Idea38622Config {
    private String name = "idea_038622";
 ...
 */
@Slf4j
public class Idea38622Service {
    private static final int IDEA_ID = 38622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38622Service() {
        this(new Idea38622Config());
    }

    public Idea38622Service(Idea38622Config config) {
        this.config = config != null ? config : new Idea38622Config();
