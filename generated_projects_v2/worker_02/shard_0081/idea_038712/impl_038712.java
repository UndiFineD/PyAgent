...
@Data
public class Idea38712Config {
    private String name = "idea_038712";
 ...
 */
@Slf4j
public class Idea38712Service {
    private static final int IDEA_ID = 38712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38712Service() {
        this(new Idea38712Config());
    }

    public Idea38712Service(Idea38712Config config) {
        this.config = config != null ? config : new Idea38712Config();
