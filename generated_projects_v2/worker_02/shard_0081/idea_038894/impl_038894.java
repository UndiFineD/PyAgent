...
@Data
public class Idea38894Config {
    private String name = "idea_038894";
 ...
 */
@Slf4j
public class Idea38894Service {
    private static final int IDEA_ID = 38894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38894Service() {
        this(new Idea38894Config());
    }

    public Idea38894Service(Idea38894Config config) {
        this.config = config != null ? config : new Idea38894Config();
