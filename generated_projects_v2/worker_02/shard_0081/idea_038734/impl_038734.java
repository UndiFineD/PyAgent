...
@Data
public class Idea38734Config {
    private String name = "idea_038734";
 ...
 */
@Slf4j
public class Idea38734Service {
    private static final int IDEA_ID = 38734;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38734Service() {
        this(new Idea38734Config());
    }

    public Idea38734Service(Idea38734Config config) {
        this.config = config != null ? config : new Idea38734Config();
