...
@Data
public class Idea38575Config {
    private String name = "idea_038575";
 ...
 */
@Slf4j
public class Idea38575Service {
    private static final int IDEA_ID = 38575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38575Service() {
        this(new Idea38575Config());
    }

    public Idea38575Service(Idea38575Config config) {
        this.config = config != null ? config : new Idea38575Config();
