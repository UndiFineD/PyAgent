...
@Data
public class Idea38568Config {
    private String name = "idea_038568";
 ...
 */
@Slf4j
public class Idea38568Service {
    private static final int IDEA_ID = 38568;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38568Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38568Service() {
        this(new Idea38568Config());
    }

    public Idea38568Service(Idea38568Config config) {
        this.config = config != null ? config : new Idea38568Config();
