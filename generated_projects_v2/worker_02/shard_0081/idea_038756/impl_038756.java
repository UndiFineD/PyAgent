...
@Data
public class Idea38756Config {
    private String name = "idea_038756";
 ...
 */
@Slf4j
public class Idea38756Service {
    private static final int IDEA_ID = 38756;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38756Service() {
        this(new Idea38756Config());
    }

    public Idea38756Service(Idea38756Config config) {
        this.config = config != null ? config : new Idea38756Config();
