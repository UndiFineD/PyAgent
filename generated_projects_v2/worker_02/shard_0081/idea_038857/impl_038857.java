...
@Data
public class Idea38857Config {
    private String name = "idea_038857";
 ...
 */
@Slf4j
public class Idea38857Service {
    private static final int IDEA_ID = 38857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38857Service() {
        this(new Idea38857Config());
    }

    public Idea38857Service(Idea38857Config config) {
        this.config = config != null ? config : new Idea38857Config();
