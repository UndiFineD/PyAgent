...
@Data
public class Idea38752Config {
    private String name = "idea_038752";
 ...
 */
@Slf4j
public class Idea38752Service {
    private static final int IDEA_ID = 38752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38752Service() {
        this(new Idea38752Config());
    }

    public Idea38752Service(Idea38752Config config) {
        this.config = config != null ? config : new Idea38752Config();
