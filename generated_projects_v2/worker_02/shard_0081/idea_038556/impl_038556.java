...
@Data
public class Idea38556Config {
    private String name = "idea_038556";
 ...
 */
@Slf4j
public class Idea38556Service {
    private static final int IDEA_ID = 38556;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38556Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38556Service() {
        this(new Idea38556Config());
    }

    public Idea38556Service(Idea38556Config config) {
        this.config = config != null ? config : new Idea38556Config();
