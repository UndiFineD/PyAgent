...
@Data
public class Idea38598Config {
    private String name = "idea_038598";
 ...
 */
@Slf4j
public class Idea38598Service {
    private static final int IDEA_ID = 38598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38598Service() {
        this(new Idea38598Config());
    }

    public Idea38598Service(Idea38598Config config) {
        this.config = config != null ? config : new Idea38598Config();
