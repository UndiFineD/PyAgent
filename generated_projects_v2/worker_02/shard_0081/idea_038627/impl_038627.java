...
@Data
public class Idea38627Config {
    private String name = "idea_038627";
 ...
 */
@Slf4j
public class Idea38627Service {
    private static final int IDEA_ID = 38627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38627Service() {
        this(new Idea38627Config());
    }

    public Idea38627Service(Idea38627Config config) {
        this.config = config != null ? config : new Idea38627Config();
