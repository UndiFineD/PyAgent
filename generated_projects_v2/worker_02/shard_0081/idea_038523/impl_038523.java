...
@Data
public class Idea38523Config {
    private String name = "idea_038523";
 ...
 */
@Slf4j
public class Idea38523Service {
    private static final int IDEA_ID = 38523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38523Service() {
        this(new Idea38523Config());
    }

    public Idea38523Service(Idea38523Config config) {
        this.config = config != null ? config : new Idea38523Config();
