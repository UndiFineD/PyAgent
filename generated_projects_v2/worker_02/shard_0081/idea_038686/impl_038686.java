...
@Data
public class Idea38686Config {
    private String name = "idea_038686";
 ...
 */
@Slf4j
public class Idea38686Service {
    private static final int IDEA_ID = 38686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38686Service() {
        this(new Idea38686Config());
    }

    public Idea38686Service(Idea38686Config config) {
        this.config = config != null ? config : new Idea38686Config();
