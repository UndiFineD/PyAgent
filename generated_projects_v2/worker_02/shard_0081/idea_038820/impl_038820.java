...
@Data
public class Idea38820Config {
    private String name = "idea_038820";
 ...
 */
@Slf4j
public class Idea38820Service {
    private static final int IDEA_ID = 38820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38820Service() {
        this(new Idea38820Config());
    }

    public Idea38820Service(Idea38820Config config) {
        this.config = config != null ? config : new Idea38820Config();
