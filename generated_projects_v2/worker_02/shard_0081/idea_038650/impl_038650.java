...
@Data
public class Idea38650Config {
    private String name = "idea_038650";
 ...
 */
@Slf4j
public class Idea38650Service {
    private static final int IDEA_ID = 38650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38650Service() {
        this(new Idea38650Config());
    }

    public Idea38650Service(Idea38650Config config) {
        this.config = config != null ? config : new Idea38650Config();
