...
@Data
public class Idea38565Config {
    private String name = "idea_038565";
 ...
 */
@Slf4j
public class Idea38565Service {
    private static final int IDEA_ID = 38565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38565Service() {
        this(new Idea38565Config());
    }

    public Idea38565Service(Idea38565Config config) {
        this.config = config != null ? config : new Idea38565Config();
