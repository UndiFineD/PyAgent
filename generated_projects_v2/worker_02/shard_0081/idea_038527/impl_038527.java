...
@Data
public class Idea38527Config {
    private String name = "idea_038527";
 ...
 */
@Slf4j
public class Idea38527Service {
    private static final int IDEA_ID = 38527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38527Service() {
        this(new Idea38527Config());
    }

    public Idea38527Service(Idea38527Config config) {
        this.config = config != null ? config : new Idea38527Config();
