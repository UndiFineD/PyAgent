...
@Data
public class Idea38554Config {
    private String name = "idea_038554";
 ...
 */
@Slf4j
public class Idea38554Service {
    private static final int IDEA_ID = 38554;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38554Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38554Service() {
        this(new Idea38554Config());
    }

    public Idea38554Service(Idea38554Config config) {
        this.config = config != null ? config : new Idea38554Config();
