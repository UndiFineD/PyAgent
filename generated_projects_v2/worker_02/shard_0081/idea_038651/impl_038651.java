...
@Data
public class Idea38651Config {
    private String name = "idea_038651";
 ...
 */
@Slf4j
public class Idea38651Service {
    private static final int IDEA_ID = 38651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38651Service() {
        this(new Idea38651Config());
    }

    public Idea38651Service(Idea38651Config config) {
        this.config = config != null ? config : new Idea38651Config();
