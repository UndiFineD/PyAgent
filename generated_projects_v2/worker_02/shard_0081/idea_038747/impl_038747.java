...
@Data
public class Idea38747Config {
    private String name = "idea_038747";
 ...
 */
@Slf4j
public class Idea38747Service {
    private static final int IDEA_ID = 38747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38747Service() {
        this(new Idea38747Config());
    }

    public Idea38747Service(Idea38747Config config) {
        this.config = config != null ? config : new Idea38747Config();
