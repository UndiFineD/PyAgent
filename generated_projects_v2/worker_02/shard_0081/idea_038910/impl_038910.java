...
@Data
public class Idea38910Config {
    private String name = "idea_038910";
 ...
 */
@Slf4j
public class Idea38910Service {
    private static final int IDEA_ID = 38910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38910Service() {
        this(new Idea38910Config());
    }

    public Idea38910Service(Idea38910Config config) {
        this.config = config != null ? config : new Idea38910Config();
