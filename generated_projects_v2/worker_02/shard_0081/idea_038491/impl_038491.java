...
@Data
public class Idea38491Config {
    private String name = "idea_038491";
 ...
 */
@Slf4j
public class Idea38491Service {
    private static final int IDEA_ID = 38491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38491Service() {
        this(new Idea38491Config());
    }

    public Idea38491Service(Idea38491Config config) {
        this.config = config != null ? config : new Idea38491Config();
