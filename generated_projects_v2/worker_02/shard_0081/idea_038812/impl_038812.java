...
@Data
public class Idea38812Config {
    private String name = "idea_038812";
 ...
 */
@Slf4j
public class Idea38812Service {
    private static final int IDEA_ID = 38812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38812Service() {
        this(new Idea38812Config());
    }

    public Idea38812Service(Idea38812Config config) {
        this.config = config != null ? config : new Idea38812Config();
