...
@Data
public class Idea38567Config {
    private String name = "idea_038567";
 ...
 */
@Slf4j
public class Idea38567Service {
    private static final int IDEA_ID = 38567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38567Service() {
        this(new Idea38567Config());
    }

    public Idea38567Service(Idea38567Config config) {
        this.config = config != null ? config : new Idea38567Config();
