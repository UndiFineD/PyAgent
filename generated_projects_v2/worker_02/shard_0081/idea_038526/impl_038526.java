...
@Data
public class Idea38526Config {
    private String name = "idea_038526";
 ...
 */
@Slf4j
public class Idea38526Service {
    private static final int IDEA_ID = 38526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38526Service() {
        this(new Idea38526Config());
    }

    public Idea38526Service(Idea38526Config config) {
        this.config = config != null ? config : new Idea38526Config();
