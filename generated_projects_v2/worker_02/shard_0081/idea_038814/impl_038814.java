...
@Data
public class Idea38814Config {
    private String name = "idea_038814";
 ...
 */
@Slf4j
public class Idea38814Service {
    private static final int IDEA_ID = 38814;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38814Service() {
        this(new Idea38814Config());
    }

    public Idea38814Service(Idea38814Config config) {
        this.config = config != null ? config : new Idea38814Config();
