...
@Data
public class Idea38477Config {
    private String name = "idea_038477";
 ...
 */
@Slf4j
public class Idea38477Service {
    private static final int IDEA_ID = 38477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38477Service() {
        this(new Idea38477Config());
    }

    public Idea38477Service(Idea38477Config config) {
        this.config = config != null ? config : new Idea38477Config();
