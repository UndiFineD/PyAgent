...
@Data
public class Idea38834Config {
    private String name = "idea_038834";
 ...
 */
@Slf4j
public class Idea38834Service {
    private static final int IDEA_ID = 38834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38834Service() {
        this(new Idea38834Config());
    }

    public Idea38834Service(Idea38834Config config) {
        this.config = config != null ? config : new Idea38834Config();
