...
@Data
public class Idea38876Config {
    private String name = "idea_038876";
 ...
 */
@Slf4j
public class Idea38876Service {
    private static final int IDEA_ID = 38876;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38876Service() {
        this(new Idea38876Config());
    }

    public Idea38876Service(Idea38876Config config) {
        this.config = config != null ? config : new Idea38876Config();
