...
@Data
public class Idea38618Config {
    private String name = "idea_038618";
 ...
 */
@Slf4j
public class Idea38618Service {
    private static final int IDEA_ID = 38618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38618Service() {
        this(new Idea38618Config());
    }

    public Idea38618Service(Idea38618Config config) {
        this.config = config != null ? config : new Idea38618Config();
