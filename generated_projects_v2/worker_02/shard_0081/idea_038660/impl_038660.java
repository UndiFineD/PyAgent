...
@Data
public class Idea38660Config {
    private String name = "idea_038660";
 ...
 */
@Slf4j
public class Idea38660Service {
    private static final int IDEA_ID = 38660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38660Service() {
        this(new Idea38660Config());
    }

    public Idea38660Service(Idea38660Config config) {
        this.config = config != null ? config : new Idea38660Config();
