...
@Data
public class Idea38670Config {
    private String name = "idea_038670";
 ...
 */
@Slf4j
public class Idea38670Service {
    private static final int IDEA_ID = 38670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38670Service() {
        this(new Idea38670Config());
    }

    public Idea38670Service(Idea38670Config config) {
        this.config = config != null ? config : new Idea38670Config();
