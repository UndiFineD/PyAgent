...
@Data
public class Idea38693Config {
    private String name = "idea_038693";
 ...
 */
@Slf4j
public class Idea38693Service {
    private static final int IDEA_ID = 38693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38693Service() {
        this(new Idea38693Config());
    }

    public Idea38693Service(Idea38693Config config) {
        this.config = config != null ? config : new Idea38693Config();
