...
@Data
public class Idea38825Config {
    private String name = "idea_038825";
 ...
 */
@Slf4j
public class Idea38825Service {
    private static final int IDEA_ID = 38825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38825Service() {
        this(new Idea38825Config());
    }

    public Idea38825Service(Idea38825Config config) {
        this.config = config != null ? config : new Idea38825Config();
