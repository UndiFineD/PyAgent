...
@Data
public class Idea38563Config {
    private String name = "idea_038563";
 ...
 */
@Slf4j
public class Idea38563Service {
    private static final int IDEA_ID = 38563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38563Service() {
        this(new Idea38563Config());
    }

    public Idea38563Service(Idea38563Config config) {
        this.config = config != null ? config : new Idea38563Config();
