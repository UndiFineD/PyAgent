...
@Data
public class Idea38519Config {
    private String name = "idea_038519";
 ...
 */
@Slf4j
public class Idea38519Service {
    private static final int IDEA_ID = 38519;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38519Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38519Service() {
        this(new Idea38519Config());
    }

    public Idea38519Service(Idea38519Config config) {
        this.config = config != null ? config : new Idea38519Config();
