...
@Data
public class Idea38900Config {
    private String name = "idea_038900";
 ...
 */
@Slf4j
public class Idea38900Service {
    private static final int IDEA_ID = 38900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38900Service() {
        this(new Idea38900Config());
    }

    public Idea38900Service(Idea38900Config config) {
        this.config = config != null ? config : new Idea38900Config();
