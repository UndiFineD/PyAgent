...
@Data
public class Idea38828Config {
    private String name = "idea_038828";
 ...
 */
@Slf4j
public class Idea38828Service {
    private static final int IDEA_ID = 38828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38828Service() {
        this(new Idea38828Config());
    }

    public Idea38828Service(Idea38828Config config) {
        this.config = config != null ? config : new Idea38828Config();
