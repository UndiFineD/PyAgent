...
@Data
public class Idea38557Config {
    private String name = "idea_038557";
 ...
 */
@Slf4j
public class Idea38557Service {
    private static final int IDEA_ID = 38557;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38557Service() {
        this(new Idea38557Config());
    }

    public Idea38557Service(Idea38557Config config) {
        this.config = config != null ? config : new Idea38557Config();
