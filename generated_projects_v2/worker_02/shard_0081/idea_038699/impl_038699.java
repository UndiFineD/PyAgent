...
@Data
public class Idea38699Config {
    private String name = "idea_038699";
 ...
 */
@Slf4j
public class Idea38699Service {
    private static final int IDEA_ID = 38699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38699Service() {
        this(new Idea38699Config());
    }

    public Idea38699Service(Idea38699Config config) {
        this.config = config != null ? config : new Idea38699Config();
