...
@Data
public class Idea38599Config {
    private String name = "idea_038599";
 ...
 */
@Slf4j
public class Idea38599Service {
    private static final int IDEA_ID = 38599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38599Service() {
        this(new Idea38599Config());
    }

    public Idea38599Service(Idea38599Config config) {
        this.config = config != null ? config : new Idea38599Config();
