...
@Data
public class Idea38510Config {
    private String name = "idea_038510";
 ...
 */
@Slf4j
public class Idea38510Service {
    private static final int IDEA_ID = 38510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38510Service() {
        this(new Idea38510Config());
    }

    public Idea38510Service(Idea38510Config config) {
        this.config = config != null ? config : new Idea38510Config();
