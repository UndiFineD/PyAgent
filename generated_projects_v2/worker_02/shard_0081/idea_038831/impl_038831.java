...
@Data
public class Idea38831Config {
    private String name = "idea_038831";
 ...
 */
@Slf4j
public class Idea38831Service {
    private static final int IDEA_ID = 38831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38831Service() {
        this(new Idea38831Config());
    }

    public Idea38831Service(Idea38831Config config) {
        this.config = config != null ? config : new Idea38831Config();
