...
@Data
public class Idea38652Config {
    private String name = "idea_038652";
 ...
 */
@Slf4j
public class Idea38652Service {
    private static final int IDEA_ID = 38652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38652Service() {
        this(new Idea38652Config());
    }

    public Idea38652Service(Idea38652Config config) {
        this.config = config != null ? config : new Idea38652Config();
