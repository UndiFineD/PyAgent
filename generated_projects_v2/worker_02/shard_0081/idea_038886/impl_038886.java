...
@Data
public class Idea38886Config {
    private String name = "idea_038886";
 ...
 */
@Slf4j
public class Idea38886Service {
    private static final int IDEA_ID = 38886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38886Service() {
        this(new Idea38886Config());
    }

    public Idea38886Service(Idea38886Config config) {
        this.config = config != null ? config : new Idea38886Config();
