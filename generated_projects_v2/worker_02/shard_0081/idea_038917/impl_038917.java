...
@Data
public class Idea38917Config {
    private String name = "idea_038917";
 ...
 */
@Slf4j
public class Idea38917Service {
    private static final int IDEA_ID = 38917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38917Service() {
        this(new Idea38917Config());
    }

    public Idea38917Service(Idea38917Config config) {
        this.config = config != null ? config : new Idea38917Config();
