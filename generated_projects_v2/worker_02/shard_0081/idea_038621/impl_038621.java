...
@Data
public class Idea38621Config {
    private String name = "idea_038621";
 ...
 */
@Slf4j
public class Idea38621Service {
    private static final int IDEA_ID = 38621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38621Service() {
        this(new Idea38621Config());
    }

    public Idea38621Service(Idea38621Config config) {
        this.config = config != null ? config : new Idea38621Config();
