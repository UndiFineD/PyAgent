...
@Data
public class Idea38512Config {
    private String name = "idea_038512";
 ...
 */
@Slf4j
public class Idea38512Service {
    private static final int IDEA_ID = 38512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38512Service() {
        this(new Idea38512Config());
    }

    public Idea38512Service(Idea38512Config config) {
        this.config = config != null ? config : new Idea38512Config();
