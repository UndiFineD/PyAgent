...
@Data
public class Idea38659Config {
    private String name = "idea_038659";
 ...
 */
@Slf4j
public class Idea38659Service {
    private static final int IDEA_ID = 38659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38659Service() {
        this(new Idea38659Config());
    }

    public Idea38659Service(Idea38659Config config) {
        this.config = config != null ? config : new Idea38659Config();
