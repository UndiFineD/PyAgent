...
@Data
public class Idea38942Config {
    private String name = "idea_038942";
 ...
 */
@Slf4j
public class Idea38942Service {
    private static final int IDEA_ID = 38942;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38942Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38942Service() {
        this(new Idea38942Config());
    }

    public Idea38942Service(Idea38942Config config) {
        this.config = config != null ? config : new Idea38942Config();
