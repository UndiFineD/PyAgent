...
@Data
public class Idea38508Config {
    private String name = "idea_038508";
 ...
 */
@Slf4j
public class Idea38508Service {
    private static final int IDEA_ID = 38508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38508Service() {
        this(new Idea38508Config());
    }

    public Idea38508Service(Idea38508Config config) {
        this.config = config != null ? config : new Idea38508Config();
