...
@Data
public class Idea38492Config {
    private String name = "idea_038492";
 ...
 */
@Slf4j
public class Idea38492Service {
    private static final int IDEA_ID = 38492;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38492Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38492Service() {
        this(new Idea38492Config());
    }

    public Idea38492Service(Idea38492Config config) {
        this.config = config != null ? config : new Idea38492Config();
