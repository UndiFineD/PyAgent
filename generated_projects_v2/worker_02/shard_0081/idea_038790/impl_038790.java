...
@Data
public class Idea38790Config {
    private String name = "idea_038790";
 ...
 */
@Slf4j
public class Idea38790Service {
    private static final int IDEA_ID = 38790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38790Service() {
        this(new Idea38790Config());
    }

    public Idea38790Service(Idea38790Config config) {
        this.config = config != null ? config : new Idea38790Config();
