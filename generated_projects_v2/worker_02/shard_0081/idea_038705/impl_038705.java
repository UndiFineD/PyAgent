...
@Data
public class Idea38705Config {
    private String name = "idea_038705";
 ...
 */
@Slf4j
public class Idea38705Service {
    private static final int IDEA_ID = 38705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38705Service() {
        this(new Idea38705Config());
    }

    public Idea38705Service(Idea38705Config config) {
        this.config = config != null ? config : new Idea38705Config();
