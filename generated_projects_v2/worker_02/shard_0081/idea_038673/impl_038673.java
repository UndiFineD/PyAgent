...
@Data
public class Idea38673Config {
    private String name = "idea_038673";
 ...
 */
@Slf4j
public class Idea38673Service {
    private static final int IDEA_ID = 38673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38673Service() {
        this(new Idea38673Config());
    }

    public Idea38673Service(Idea38673Config config) {
        this.config = config != null ? config : new Idea38673Config();
