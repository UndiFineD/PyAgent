...
@Data
public class Idea38531Config {
    private String name = "idea_038531";
 ...
 */
@Slf4j
public class Idea38531Service {
    private static final int IDEA_ID = 38531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38531Service() {
        this(new Idea38531Config());
    }

    public Idea38531Service(Idea38531Config config) {
        this.config = config != null ? config : new Idea38531Config();
