...
@Data
public class Idea38626Config {
    private String name = "idea_038626";
 ...
 */
@Slf4j
public class Idea38626Service {
    private static final int IDEA_ID = 38626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38626Service() {
        this(new Idea38626Config());
    }

    public Idea38626Service(Idea38626Config config) {
        this.config = config != null ? config : new Idea38626Config();
