...
@Data
public class Idea38646Config {
    private String name = "idea_038646";
 ...
 */
@Slf4j
public class Idea38646Service {
    private static final int IDEA_ID = 38646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38646Service() {
        this(new Idea38646Config());
    }

    public Idea38646Service(Idea38646Config config) {
        this.config = config != null ? config : new Idea38646Config();
