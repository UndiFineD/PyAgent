...
@Data
public class Idea38708Config {
    private String name = "idea_038708";
 ...
 */
@Slf4j
public class Idea38708Service {
    private static final int IDEA_ID = 38708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38708Service() {
        this(new Idea38708Config());
    }

    public Idea38708Service(Idea38708Config config) {
        this.config = config != null ? config : new Idea38708Config();
