...
@Data
public class Idea38602Config {
    private String name = "idea_038602";
 ...
 */
@Slf4j
public class Idea38602Service {
    private static final int IDEA_ID = 38602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38602Service() {
        this(new Idea38602Config());
    }

    public Idea38602Service(Idea38602Config config) {
        this.config = config != null ? config : new Idea38602Config();
