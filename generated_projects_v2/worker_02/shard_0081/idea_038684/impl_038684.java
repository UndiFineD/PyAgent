...
@Data
public class Idea38684Config {
    private String name = "idea_038684";
 ...
 */
@Slf4j
public class Idea38684Service {
    private static final int IDEA_ID = 38684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38684Service() {
        this(new Idea38684Config());
    }

    public Idea38684Service(Idea38684Config config) {
        this.config = config != null ? config : new Idea38684Config();
