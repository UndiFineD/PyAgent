...
@Data
public class Idea38522Config {
    private String name = "idea_038522";
 ...
 */
@Slf4j
public class Idea38522Service {
    private static final int IDEA_ID = 38522;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38522Service() {
        this(new Idea38522Config());
    }

    public Idea38522Service(Idea38522Config config) {
        this.config = config != null ? config : new Idea38522Config();
