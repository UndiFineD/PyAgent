...
@Data
public class Idea38581Config {
    private String name = "idea_038581";
 ...
 */
@Slf4j
public class Idea38581Service {
    private static final int IDEA_ID = 38581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38581Service() {
        this(new Idea38581Config());
    }

    public Idea38581Service(Idea38581Config config) {
        this.config = config != null ? config : new Idea38581Config();
