...
@Data
public class Idea38858Config {
    private String name = "idea_038858";
 ...
 */
@Slf4j
public class Idea38858Service {
    private static final int IDEA_ID = 38858;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38858Service() {
        this(new Idea38858Config());
    }

    public Idea38858Service(Idea38858Config config) {
        this.config = config != null ? config : new Idea38858Config();
