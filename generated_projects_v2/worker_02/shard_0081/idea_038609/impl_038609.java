...
@Data
public class Idea38609Config {
    private String name = "idea_038609";
 ...
 */
@Slf4j
public class Idea38609Service {
    private static final int IDEA_ID = 38609;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38609Service() {
        this(new Idea38609Config());
    }

    public Idea38609Service(Idea38609Config config) {
        this.config = config != null ? config : new Idea38609Config();
