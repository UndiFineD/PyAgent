...
@Data
public class Idea38541Config {
    private String name = "idea_038541";
 ...
 */
@Slf4j
public class Idea38541Service {
    private static final int IDEA_ID = 38541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38541Service() {
        this(new Idea38541Config());
    }

    public Idea38541Service(Idea38541Config config) {
        this.config = config != null ? config : new Idea38541Config();
