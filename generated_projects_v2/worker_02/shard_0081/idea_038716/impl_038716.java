...
@Data
public class Idea38716Config {
    private String name = "idea_038716";
 ...
 */
@Slf4j
public class Idea38716Service {
    private static final int IDEA_ID = 38716;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38716Service() {
        this(new Idea38716Config());
    }

    public Idea38716Service(Idea38716Config config) {
        this.config = config != null ? config : new Idea38716Config();
