...
@Data
public class Idea38781Config {
    private String name = "idea_038781";
 ...
 */
@Slf4j
public class Idea38781Service {
    private static final int IDEA_ID = 38781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38781Service() {
        this(new Idea38781Config());
    }

    public Idea38781Service(Idea38781Config config) {
        this.config = config != null ? config : new Idea38781Config();
