...
@Data
public class Idea38644Config {
    private String name = "idea_038644";
 ...
 */
@Slf4j
public class Idea38644Service {
    private static final int IDEA_ID = 38644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38644Service() {
        this(new Idea38644Config());
    }

    public Idea38644Service(Idea38644Config config) {
        this.config = config != null ? config : new Idea38644Config();
