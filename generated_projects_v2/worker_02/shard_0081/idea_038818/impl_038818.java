...
@Data
public class Idea38818Config {
    private String name = "idea_038818";
 ...
 */
@Slf4j
public class Idea38818Service {
    private static final int IDEA_ID = 38818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38818Service() {
        this(new Idea38818Config());
    }

    public Idea38818Service(Idea38818Config config) {
        this.config = config != null ? config : new Idea38818Config();
