...
@Data
public class Idea38805Config {
    private String name = "idea_038805";
 ...
 */
@Slf4j
public class Idea38805Service {
    private static final int IDEA_ID = 38805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38805Service() {
        this(new Idea38805Config());
    }

    public Idea38805Service(Idea38805Config config) {
        this.config = config != null ? config : new Idea38805Config();
