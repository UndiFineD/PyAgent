...
@Data
public class Idea38802Config {
    private String name = "idea_038802";
 ...
 */
@Slf4j
public class Idea38802Service {
    private static final int IDEA_ID = 38802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38802Service() {
        this(new Idea38802Config());
    }

    public Idea38802Service(Idea38802Config config) {
        this.config = config != null ? config : new Idea38802Config();
