...
@Data
public class Idea38597Config {
    private String name = "idea_038597";
 ...
 */
@Slf4j
public class Idea38597Service {
    private static final int IDEA_ID = 38597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38597Service() {
        this(new Idea38597Config());
    }

    public Idea38597Service(Idea38597Config config) {
        this.config = config != null ? config : new Idea38597Config();
