...
@Data
public class Idea38678Config {
    private String name = "idea_038678";
 ...
 */
@Slf4j
public class Idea38678Service {
    private static final int IDEA_ID = 38678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38678Service() {
        this(new Idea38678Config());
    }

    public Idea38678Service(Idea38678Config config) {
        this.config = config != null ? config : new Idea38678Config();
