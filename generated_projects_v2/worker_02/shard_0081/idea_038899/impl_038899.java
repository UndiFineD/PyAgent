...
@Data
public class Idea38899Config {
    private String name = "idea_038899";
 ...
 */
@Slf4j
public class Idea38899Service {
    private static final int IDEA_ID = 38899;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38899Service() {
        this(new Idea38899Config());
    }

    public Idea38899Service(Idea38899Config config) {
        this.config = config != null ? config : new Idea38899Config();
