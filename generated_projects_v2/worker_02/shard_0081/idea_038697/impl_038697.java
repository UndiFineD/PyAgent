...
@Data
public class Idea38697Config {
    private String name = "idea_038697";
 ...
 */
@Slf4j
public class Idea38697Service {
    private static final int IDEA_ID = 38697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38697Service() {
        this(new Idea38697Config());
    }

    public Idea38697Service(Idea38697Config config) {
        this.config = config != null ? config : new Idea38697Config();
