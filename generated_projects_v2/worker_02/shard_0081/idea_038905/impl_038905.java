...
@Data
public class Idea38905Config {
    private String name = "idea_038905";
 ...
 */
@Slf4j
public class Idea38905Service {
    private static final int IDEA_ID = 38905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38905Service() {
        this(new Idea38905Config());
    }

    public Idea38905Service(Idea38905Config config) {
        this.config = config != null ? config : new Idea38905Config();
