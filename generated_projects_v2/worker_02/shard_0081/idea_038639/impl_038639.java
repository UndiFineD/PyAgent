...
@Data
public class Idea38639Config {
    private String name = "idea_038639";
 ...
 */
@Slf4j
public class Idea38639Service {
    private static final int IDEA_ID = 38639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38639Service() {
        this(new Idea38639Config());
    }

    public Idea38639Service(Idea38639Config config) {
        this.config = config != null ? config : new Idea38639Config();
