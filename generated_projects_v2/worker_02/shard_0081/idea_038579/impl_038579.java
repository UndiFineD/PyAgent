...
@Data
public class Idea38579Config {
    private String name = "idea_038579";
 ...
 */
@Slf4j
public class Idea38579Service {
    private static final int IDEA_ID = 38579;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38579Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38579Service() {
        this(new Idea38579Config());
    }

    public Idea38579Service(Idea38579Config config) {
        this.config = config != null ? config : new Idea38579Config();
