...
@Data
public class Idea38530Config {
    private String name = "idea_038530";
 ...
 */
@Slf4j
public class Idea38530Service {
    private static final int IDEA_ID = 38530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38530Service() {
        this(new Idea38530Config());
    }

    public Idea38530Service(Idea38530Config config) {
        this.config = config != null ? config : new Idea38530Config();
