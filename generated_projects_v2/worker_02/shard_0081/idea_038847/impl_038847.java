...
@Data
public class Idea38847Config {
    private String name = "idea_038847";
 ...
 */
@Slf4j
public class Idea38847Service {
    private static final int IDEA_ID = 38847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38847Service() {
        this(new Idea38847Config());
    }

    public Idea38847Service(Idea38847Config config) {
        this.config = config != null ? config : new Idea38847Config();
