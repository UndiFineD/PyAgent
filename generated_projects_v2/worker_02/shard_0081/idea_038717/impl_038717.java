...
@Data
public class Idea38717Config {
    private String name = "idea_038717";
 ...
 */
@Slf4j
public class Idea38717Service {
    private static final int IDEA_ID = 38717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38717Service() {
        this(new Idea38717Config());
    }

    public Idea38717Service(Idea38717Config config) {
        this.config = config != null ? config : new Idea38717Config();
