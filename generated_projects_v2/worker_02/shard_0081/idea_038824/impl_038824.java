...
@Data
public class Idea38824Config {
    private String name = "idea_038824";
 ...
 */
@Slf4j
public class Idea38824Service {
    private static final int IDEA_ID = 38824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38824Service() {
        this(new Idea38824Config());
    }

    public Idea38824Service(Idea38824Config config) {
        this.config = config != null ? config : new Idea38824Config();
