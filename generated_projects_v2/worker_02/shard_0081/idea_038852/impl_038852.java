...
@Data
public class Idea38852Config {
    private String name = "idea_038852";
 ...
 */
@Slf4j
public class Idea38852Service {
    private static final int IDEA_ID = 38852;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38852Service() {
        this(new Idea38852Config());
    }

    public Idea38852Service(Idea38852Config config) {
        this.config = config != null ? config : new Idea38852Config();
