...
@Data
public class Idea38811Config {
    private String name = "idea_038811";
 ...
 */
@Slf4j
public class Idea38811Service {
    private static final int IDEA_ID = 38811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38811Service() {
        this(new Idea38811Config());
    }

    public Idea38811Service(Idea38811Config config) {
        this.config = config != null ? config : new Idea38811Config();
