...
@Data
public class Idea38879Config {
    private String name = "idea_038879";
 ...
 */
@Slf4j
public class Idea38879Service {
    private static final int IDEA_ID = 38879;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38879Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38879Service() {
        this(new Idea38879Config());
    }

    public Idea38879Service(Idea38879Config config) {
        this.config = config != null ? config : new Idea38879Config();
