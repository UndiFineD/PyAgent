...
@Data
public class Idea38923Config {
    private String name = "idea_038923";
 ...
 */
@Slf4j
public class Idea38923Service {
    private static final int IDEA_ID = 38923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38923Service() {
        this(new Idea38923Config());
    }

    public Idea38923Service(Idea38923Config config) {
        this.config = config != null ? config : new Idea38923Config();
