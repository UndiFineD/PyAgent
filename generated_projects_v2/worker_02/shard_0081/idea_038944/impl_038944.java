...
@Data
public class Idea38944Config {
    private String name = "idea_038944";
 ...
 */
@Slf4j
public class Idea38944Service {
    private static final int IDEA_ID = 38944;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38944Service() {
        this(new Idea38944Config());
    }

    public Idea38944Service(Idea38944Config config) {
        this.config = config != null ? config : new Idea38944Config();
