...
@Data
public class Idea38514Config {
    private String name = "idea_038514";
 ...
 */
@Slf4j
public class Idea38514Service {
    private static final int IDEA_ID = 38514;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38514Service() {
        this(new Idea38514Config());
    }

    public Idea38514Service(Idea38514Config config) {
        this.config = config != null ? config : new Idea38514Config();
