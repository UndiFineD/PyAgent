...
@Data
public class Idea38931Config {
    private String name = "idea_038931";
 ...
 */
@Slf4j
public class Idea38931Service {
    private static final int IDEA_ID = 38931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38931Service() {
        this(new Idea38931Config());
    }

    public Idea38931Service(Idea38931Config config) {
        this.config = config != null ? config : new Idea38931Config();
