...
@Data
public class Idea38475Config {
    private String name = "idea_038475";
 ...
 */
@Slf4j
public class Idea38475Service {
    private static final int IDEA_ID = 38475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38475Service() {
        this(new Idea38475Config());
    }

    public Idea38475Service(Idea38475Config config) {
        this.config = config != null ? config : new Idea38475Config();
