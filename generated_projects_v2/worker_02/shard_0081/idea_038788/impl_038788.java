...
@Data
public class Idea38788Config {
    private String name = "idea_038788";
 ...
 */
@Slf4j
public class Idea38788Service {
    private static final int IDEA_ID = 38788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38788Service() {
        this(new Idea38788Config());
    }

    public Idea38788Service(Idea38788Config config) {
        this.config = config != null ? config : new Idea38788Config();
