...
@Data
public class Idea38592Config {
    private String name = "idea_038592";
 ...
 */
@Slf4j
public class Idea38592Service {
    private static final int IDEA_ID = 38592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38592Service() {
        this(new Idea38592Config());
    }

    public Idea38592Service(Idea38592Config config) {
        this.config = config != null ? config : new Idea38592Config();
