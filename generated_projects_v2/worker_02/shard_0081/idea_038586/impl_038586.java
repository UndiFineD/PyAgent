...
@Data
public class Idea38586Config {
    private String name = "idea_038586";
 ...
 */
@Slf4j
public class Idea38586Service {
    private static final int IDEA_ID = 38586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38586Service() {
        this(new Idea38586Config());
    }

    public Idea38586Service(Idea38586Config config) {
        this.config = config != null ? config : new Idea38586Config();
