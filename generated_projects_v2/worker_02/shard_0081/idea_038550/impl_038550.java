...
@Data
public class Idea38550Config {
    private String name = "idea_038550";
 ...
 */
@Slf4j
public class Idea38550Service {
    private static final int IDEA_ID = 38550;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38550Service() {
        this(new Idea38550Config());
    }

    public Idea38550Service(Idea38550Config config) {
        this.config = config != null ? config : new Idea38550Config();
