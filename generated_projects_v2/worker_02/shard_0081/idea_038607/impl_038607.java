...
@Data
public class Idea38607Config {
    private String name = "idea_038607";
 ...
 */
@Slf4j
public class Idea38607Service {
    private static final int IDEA_ID = 38607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38607Service() {
        this(new Idea38607Config());
    }

    public Idea38607Service(Idea38607Config config) {
        this.config = config != null ? config : new Idea38607Config();
