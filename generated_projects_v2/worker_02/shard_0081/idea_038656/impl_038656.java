...
@Data
public class Idea38656Config {
    private String name = "idea_038656";
 ...
 */
@Slf4j
public class Idea38656Service {
    private static final int IDEA_ID = 38656;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38656Service() {
        this(new Idea38656Config());
    }

    public Idea38656Service(Idea38656Config config) {
        this.config = config != null ? config : new Idea38656Config();
