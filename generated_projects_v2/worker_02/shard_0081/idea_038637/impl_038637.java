...
@Data
public class Idea38637Config {
    private String name = "idea_038637";
 ...
 */
@Slf4j
public class Idea38637Service {
    private static final int IDEA_ID = 38637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38637Service() {
        this(new Idea38637Config());
    }

    public Idea38637Service(Idea38637Config config) {
        this.config = config != null ? config : new Idea38637Config();
