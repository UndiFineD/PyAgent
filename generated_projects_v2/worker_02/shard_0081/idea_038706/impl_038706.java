...
@Data
public class Idea38706Config {
    private String name = "idea_038706";
 ...
 */
@Slf4j
public class Idea38706Service {
    private static final int IDEA_ID = 38706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38706Service() {
        this(new Idea38706Config());
    }

    public Idea38706Service(Idea38706Config config) {
        this.config = config != null ? config : new Idea38706Config();
