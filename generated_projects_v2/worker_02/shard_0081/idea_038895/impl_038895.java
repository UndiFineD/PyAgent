...
@Data
public class Idea38895Config {
    private String name = "idea_038895";
 ...
 */
@Slf4j
public class Idea38895Service {
    private static final int IDEA_ID = 38895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38895Service() {
        this(new Idea38895Config());
    }

    public Idea38895Service(Idea38895Config config) {
        this.config = config != null ? config : new Idea38895Config();
