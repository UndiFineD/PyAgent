...
@Data
public class Idea38590Config {
    private String name = "idea_038590";
 ...
 */
@Slf4j
public class Idea38590Service {
    private static final int IDEA_ID = 38590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38590Service() {
        this(new Idea38590Config());
    }

    public Idea38590Service(Idea38590Config config) {
        this.config = config != null ? config : new Idea38590Config();
