...
@Data
public class Idea38913Config {
    private String name = "idea_038913";
 ...
 */
@Slf4j
public class Idea38913Service {
    private static final int IDEA_ID = 38913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38913Service() {
        this(new Idea38913Config());
    }

    public Idea38913Service(Idea38913Config config) {
        this.config = config != null ? config : new Idea38913Config();
