...
@Data
public class Idea38804Config {
    private String name = "idea_038804";
 ...
 */
@Slf4j
public class Idea38804Service {
    private static final int IDEA_ID = 38804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38804Service() {
        this(new Idea38804Config());
    }

    public Idea38804Service(Idea38804Config config) {
        this.config = config != null ? config : new Idea38804Config();
