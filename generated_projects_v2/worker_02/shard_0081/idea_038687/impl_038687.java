...
@Data
public class Idea38687Config {
    private String name = "idea_038687";
 ...
 */
@Slf4j
public class Idea38687Service {
    private static final int IDEA_ID = 38687;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38687Service() {
        this(new Idea38687Config());
    }

    public Idea38687Service(Idea38687Config config) {
        this.config = config != null ? config : new Idea38687Config();
