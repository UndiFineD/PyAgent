...
@Data
public class Idea38542Config {
    private String name = "idea_038542";
 ...
 */
@Slf4j
public class Idea38542Service {
    private static final int IDEA_ID = 38542;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38542Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38542Service() {
        this(new Idea38542Config());
    }

    public Idea38542Service(Idea38542Config config) {
        this.config = config != null ? config : new Idea38542Config();
