...
@Data
public class Idea38529Config {
    private String name = "idea_038529";
 ...
 */
@Slf4j
public class Idea38529Service {
    private static final int IDEA_ID = 38529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38529Service() {
        this(new Idea38529Config());
    }

    public Idea38529Service(Idea38529Config config) {
        this.config = config != null ? config : new Idea38529Config();
