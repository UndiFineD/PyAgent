...
@Data
public class Idea38479Config {
    private String name = "idea_038479";
 ...
 */
@Slf4j
public class Idea38479Service {
    private static final int IDEA_ID = 38479;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38479Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38479Service() {
        this(new Idea38479Config());
    }

    public Idea38479Service(Idea38479Config config) {
        this.config = config != null ? config : new Idea38479Config();
