...
@Data
public class Idea38918Config {
    private String name = "idea_038918";
 ...
 */
@Slf4j
public class Idea38918Service {
    private static final int IDEA_ID = 38918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38918Service() {
        this(new Idea38918Config());
    }

    public Idea38918Service(Idea38918Config config) {
        this.config = config != null ? config : new Idea38918Config();
