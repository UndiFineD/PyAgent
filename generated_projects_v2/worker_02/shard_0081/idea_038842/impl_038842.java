...
@Data
public class Idea38842Config {
    private String name = "idea_038842";
 ...
 */
@Slf4j
public class Idea38842Service {
    private static final int IDEA_ID = 38842;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38842Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38842Service() {
        this(new Idea38842Config());
    }

    public Idea38842Service(Idea38842Config config) {
        this.config = config != null ? config : new Idea38842Config();
