...
@Data
public class Idea38869Config {
    private String name = "idea_038869";
 ...
 */
@Slf4j
public class Idea38869Service {
    private static final int IDEA_ID = 38869;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38869Service() {
        this(new Idea38869Config());
    }

    public Idea38869Service(Idea38869Config config) {
        this.config = config != null ? config : new Idea38869Config();
