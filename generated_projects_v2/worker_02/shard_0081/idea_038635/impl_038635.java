...
@Data
public class Idea38635Config {
    private String name = "idea_038635";
 ...
 */
@Slf4j
public class Idea38635Service {
    private static final int IDEA_ID = 38635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38635Service() {
        this(new Idea38635Config());
    }

    public Idea38635Service(Idea38635Config config) {
        this.config = config != null ? config : new Idea38635Config();
