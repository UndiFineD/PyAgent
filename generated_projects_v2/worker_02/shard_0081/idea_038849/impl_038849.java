...
@Data
public class Idea38849Config {
    private String name = "idea_038849";
 ...
 */
@Slf4j
public class Idea38849Service {
    private static final int IDEA_ID = 38849;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38849Service() {
        this(new Idea38849Config());
    }

    public Idea38849Service(Idea38849Config config) {
        this.config = config != null ? config : new Idea38849Config();
