...
@Data
public class Idea38595Config {
    private String name = "idea_038595";
 ...
 */
@Slf4j
public class Idea38595Service {
    private static final int IDEA_ID = 38595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38595Service() {
        this(new Idea38595Config());
    }

    public Idea38595Service(Idea38595Config config) {
        this.config = config != null ? config : new Idea38595Config();
