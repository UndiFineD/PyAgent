...
@Data
public class Idea38819Config {
    private String name = "idea_038819";
 ...
 */
@Slf4j
public class Idea38819Service {
    private static final int IDEA_ID = 38819;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38819Service() {
        this(new Idea38819Config());
    }

    public Idea38819Service(Idea38819Config config) {
        this.config = config != null ? config : new Idea38819Config();
