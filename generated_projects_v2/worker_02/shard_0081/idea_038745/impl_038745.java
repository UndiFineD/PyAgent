...
@Data
public class Idea38745Config {
    private String name = "idea_038745";
 ...
 */
@Slf4j
public class Idea38745Service {
    private static final int IDEA_ID = 38745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38745Service() {
        this(new Idea38745Config());
    }

    public Idea38745Service(Idea38745Config config) {
        this.config = config != null ? config : new Idea38745Config();
