...
@Data
public class Idea38935Config {
    private String name = "idea_038935";
 ...
 */
@Slf4j
public class Idea38935Service {
    private static final int IDEA_ID = 38935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38935Service() {
        this(new Idea38935Config());
    }

    public Idea38935Service(Idea38935Config config) {
        this.config = config != null ? config : new Idea38935Config();
