...
@Data
public class Idea38868Config {
    private String name = "idea_038868";
 ...
 */
@Slf4j
public class Idea38868Service {
    private static final int IDEA_ID = 38868;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38868Service() {
        this(new Idea38868Config());
    }

    public Idea38868Service(Idea38868Config config) {
        this.config = config != null ? config : new Idea38868Config();
