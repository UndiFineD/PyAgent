...
@Data
public class Idea38613Config {
    private String name = "idea_038613";
 ...
 */
@Slf4j
public class Idea38613Service {
    private static final int IDEA_ID = 38613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38613Service() {
        this(new Idea38613Config());
    }

    public Idea38613Service(Idea38613Config config) {
        this.config = config != null ? config : new Idea38613Config();
