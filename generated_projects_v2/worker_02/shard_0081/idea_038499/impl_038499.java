...
@Data
public class Idea38499Config {
    private String name = "idea_038499";
 ...
 */
@Slf4j
public class Idea38499Service {
    private static final int IDEA_ID = 38499;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38499Service() {
        this(new Idea38499Config());
    }

    public Idea38499Service(Idea38499Config config) {
        this.config = config != null ? config : new Idea38499Config();
