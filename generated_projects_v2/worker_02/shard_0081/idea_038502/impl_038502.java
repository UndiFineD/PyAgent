...
@Data
public class Idea38502Config {
    private String name = "idea_038502";
 ...
 */
@Slf4j
public class Idea38502Service {
    private static final int IDEA_ID = 38502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38502Service() {
        this(new Idea38502Config());
    }

    public Idea38502Service(Idea38502Config config) {
        this.config = config != null ? config : new Idea38502Config();
