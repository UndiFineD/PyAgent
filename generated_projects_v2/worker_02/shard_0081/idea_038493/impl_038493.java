...
@Data
public class Idea38493Config {
    private String name = "idea_038493";
 ...
 */
@Slf4j
public class Idea38493Service {
    private static final int IDEA_ID = 38493;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38493Service() {
        this(new Idea38493Config());
    }

    public Idea38493Service(Idea38493Config config) {
        this.config = config != null ? config : new Idea38493Config();
