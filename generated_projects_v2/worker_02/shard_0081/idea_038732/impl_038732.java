...
@Data
public class Idea38732Config {
    private String name = "idea_038732";
 ...
 */
@Slf4j
public class Idea38732Service {
    private static final int IDEA_ID = 38732;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38732Service() {
        this(new Idea38732Config());
    }

    public Idea38732Service(Idea38732Config config) {
        this.config = config != null ? config : new Idea38732Config();
