...
@Data
public class Idea38657Config {
    private String name = "idea_038657";
 ...
 */
@Slf4j
public class Idea38657Service {
    private static final int IDEA_ID = 38657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38657Service() {
        this(new Idea38657Config());
    }

    public Idea38657Service(Idea38657Config config) {
        this.config = config != null ? config : new Idea38657Config();
