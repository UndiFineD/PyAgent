...
@Data
public class Idea38776Config {
    private String name = "idea_038776";
 ...
 */
@Slf4j
public class Idea38776Service {
    private static final int IDEA_ID = 38776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38776Service() {
        this(new Idea38776Config());
    }

    public Idea38776Service(Idea38776Config config) {
        this.config = config != null ? config : new Idea38776Config();
