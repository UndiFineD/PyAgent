...
@Data
public class Idea38625Config {
    private String name = "idea_038625";
 ...
 */
@Slf4j
public class Idea38625Service {
    private static final int IDEA_ID = 38625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38625Service() {
        this(new Idea38625Config());
    }

    public Idea38625Service(Idea38625Config config) {
        this.config = config != null ? config : new Idea38625Config();
