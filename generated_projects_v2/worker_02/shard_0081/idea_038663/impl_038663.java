...
@Data
public class Idea38663Config {
    private String name = "idea_038663";
 ...
 */
@Slf4j
public class Idea38663Service {
    private static final int IDEA_ID = 38663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38663Service() {
        this(new Idea38663Config());
    }

    public Idea38663Service(Idea38663Config config) {
        this.config = config != null ? config : new Idea38663Config();
