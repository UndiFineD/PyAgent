...
@Data
public class Idea38695Config {
    private String name = "idea_038695";
 ...
 */
@Slf4j
public class Idea38695Service {
    private static final int IDEA_ID = 38695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38695Service() {
        this(new Idea38695Config());
    }

    public Idea38695Service(Idea38695Config config) {
        this.config = config != null ? config : new Idea38695Config();
