...
@Data
public class Idea38912Config {
    private String name = "idea_038912";
 ...
 */
@Slf4j
public class Idea38912Service {
    private static final int IDEA_ID = 38912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38912Service() {
        this(new Idea38912Config());
    }

    public Idea38912Service(Idea38912Config config) {
        this.config = config != null ? config : new Idea38912Config();
