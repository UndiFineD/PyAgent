...
@Data
public class Idea38729Config {
    private String name = "idea_038729";
 ...
 */
@Slf4j
public class Idea38729Service {
    private static final int IDEA_ID = 38729;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38729Service() {
        this(new Idea38729Config());
    }

    public Idea38729Service(Idea38729Config config) {
        this.config = config != null ? config : new Idea38729Config();
