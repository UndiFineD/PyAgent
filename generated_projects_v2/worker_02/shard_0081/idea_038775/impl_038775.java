...
@Data
public class Idea38775Config {
    private String name = "idea_038775";
 ...
 */
@Slf4j
public class Idea38775Service {
    private static final int IDEA_ID = 38775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38775Service() {
        this(new Idea38775Config());
    }

    public Idea38775Service(Idea38775Config config) {
        this.config = config != null ? config : new Idea38775Config();
