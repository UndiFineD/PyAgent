...
@Data
public class Idea38600Config {
    private String name = "idea_038600";
 ...
 */
@Slf4j
public class Idea38600Service {
    private static final int IDEA_ID = 38600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38600Service() {
        this(new Idea38600Config());
    }

    public Idea38600Service(Idea38600Config config) {
        this.config = config != null ? config : new Idea38600Config();
