...
@Data
public class Idea38551Config {
    private String name = "idea_038551";
 ...
 */
@Slf4j
public class Idea38551Service {
    private static final int IDEA_ID = 38551;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38551Service() {
        this(new Idea38551Config());
    }

    public Idea38551Service(Idea38551Config config) {
        this.config = config != null ? config : new Idea38551Config();
