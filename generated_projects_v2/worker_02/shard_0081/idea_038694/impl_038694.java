...
@Data
public class Idea38694Config {
    private String name = "idea_038694";
 ...
 */
@Slf4j
public class Idea38694Service {
    private static final int IDEA_ID = 38694;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38694Service() {
        this(new Idea38694Config());
    }

    public Idea38694Service(Idea38694Config config) {
        this.config = config != null ? config : new Idea38694Config();
