...
@Data
public class Idea38887Config {
    private String name = "idea_038887";
 ...
 */
@Slf4j
public class Idea38887Service {
    private static final int IDEA_ID = 38887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38887Service() {
        this(new Idea38887Config());
    }

    public Idea38887Service(Idea38887Config config) {
        this.config = config != null ? config : new Idea38887Config();
