...
@Data
public class Idea38803Config {
    private String name = "idea_038803";
 ...
 */
@Slf4j
public class Idea38803Service {
    private static final int IDEA_ID = 38803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38803Service() {
        this(new Idea38803Config());
    }

    public Idea38803Service(Idea38803Config config) {
        this.config = config != null ? config : new Idea38803Config();
