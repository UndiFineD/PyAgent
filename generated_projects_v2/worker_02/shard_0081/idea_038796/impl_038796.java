...
@Data
public class Idea38796Config {
    private String name = "idea_038796";
 ...
 */
@Slf4j
public class Idea38796Service {
    private static final int IDEA_ID = 38796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38796Service() {
        this(new Idea38796Config());
    }

    public Idea38796Service(Idea38796Config config) {
        this.config = config != null ? config : new Idea38796Config();
