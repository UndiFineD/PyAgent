...
@Data
public class Idea38685Config {
    private String name = "idea_038685";
 ...
 */
@Slf4j
public class Idea38685Service {
    private static final int IDEA_ID = 38685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38685Service() {
        this(new Idea38685Config());
    }

    public Idea38685Service(Idea38685Config config) {
        this.config = config != null ? config : new Idea38685Config();
