...
@Data
public class Idea38521Config {
    private String name = "idea_038521";
 ...
 */
@Slf4j
public class Idea38521Service {
    private static final int IDEA_ID = 38521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38521Service() {
        this(new Idea38521Config());
    }

    public Idea38521Service(Idea38521Config config) {
        this.config = config != null ? config : new Idea38521Config();
