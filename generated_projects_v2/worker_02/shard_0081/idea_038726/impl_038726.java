...
@Data
public class Idea38726Config {
    private String name = "idea_038726";
 ...
 */
@Slf4j
public class Idea38726Service {
    private static final int IDEA_ID = 38726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38726Service() {
        this(new Idea38726Config());
    }

    public Idea38726Service(Idea38726Config config) {
        this.config = config != null ? config : new Idea38726Config();
