...
@Data
public class Idea38722Config {
    private String name = "idea_038722";
 ...
 */
@Slf4j
public class Idea38722Service {
    private static final int IDEA_ID = 38722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38722Service() {
        this(new Idea38722Config());
    }

    public Idea38722Service(Idea38722Config config) {
        this.config = config != null ? config : new Idea38722Config();
