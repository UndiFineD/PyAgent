...
@Data
public class Idea38840Config {
    private String name = "idea_038840";
 ...
 */
@Slf4j
public class Idea38840Service {
    private static final int IDEA_ID = 38840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38840Service() {
        this(new Idea38840Config());
    }

    public Idea38840Service(Idea38840Config config) {
        this.config = config != null ? config : new Idea38840Config();
