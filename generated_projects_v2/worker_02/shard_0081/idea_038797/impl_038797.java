...
@Data
public class Idea38797Config {
    private String name = "idea_038797";
 ...
 */
@Slf4j
public class Idea38797Service {
    private static final int IDEA_ID = 38797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38797Service() {
        this(new Idea38797Config());
    }

    public Idea38797Service(Idea38797Config config) {
        this.config = config != null ? config : new Idea38797Config();
