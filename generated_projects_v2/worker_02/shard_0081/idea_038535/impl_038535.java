...
@Data
public class Idea38535Config {
    private String name = "idea_038535";
 ...
 */
@Slf4j
public class Idea38535Service {
    private static final int IDEA_ID = 38535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38535Service() {
        this(new Idea38535Config());
    }

    public Idea38535Service(Idea38535Config config) {
        this.config = config != null ? config : new Idea38535Config();
