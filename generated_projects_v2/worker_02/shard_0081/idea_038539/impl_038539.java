...
@Data
public class Idea38539Config {
    private String name = "idea_038539";
 ...
 */
@Slf4j
public class Idea38539Service {
    private static final int IDEA_ID = 38539;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38539Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38539Service() {
        this(new Idea38539Config());
    }

    public Idea38539Service(Idea38539Config config) {
        this.config = config != null ? config : new Idea38539Config();
