...
@Data
public class Idea38885Config {
    private String name = "idea_038885";
 ...
 */
@Slf4j
public class Idea38885Service {
    private static final int IDEA_ID = 38885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38885Service() {
        this(new Idea38885Config());
    }

    public Idea38885Service(Idea38885Config config) {
        this.config = config != null ? config : new Idea38885Config();
