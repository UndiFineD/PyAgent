...
@Data
public class Idea38628Config {
    private String name = "idea_038628";
 ...
 */
@Slf4j
public class Idea38628Service {
    private static final int IDEA_ID = 38628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38628Service() {
        this(new Idea38628Config());
    }

    public Idea38628Service(Idea38628Config config) {
        this.config = config != null ? config : new Idea38628Config();
