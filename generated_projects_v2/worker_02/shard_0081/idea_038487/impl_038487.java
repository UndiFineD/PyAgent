...
@Data
public class Idea38487Config {
    private String name = "idea_038487";
 ...
 */
@Slf4j
public class Idea38487Service {
    private static final int IDEA_ID = 38487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38487Service() {
        this(new Idea38487Config());
    }

    public Idea38487Service(Idea38487Config config) {
        this.config = config != null ? config : new Idea38487Config();
