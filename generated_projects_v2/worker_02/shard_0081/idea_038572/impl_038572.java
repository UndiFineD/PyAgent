...
@Data
public class Idea38572Config {
    private String name = "idea_038572";
 ...
 */
@Slf4j
public class Idea38572Service {
    private static final int IDEA_ID = 38572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38572Service() {
        this(new Idea38572Config());
    }

    public Idea38572Service(Idea38572Config config) {
        this.config = config != null ? config : new Idea38572Config();
