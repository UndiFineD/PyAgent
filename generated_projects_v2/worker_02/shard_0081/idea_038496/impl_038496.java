...
@Data
public class Idea38496Config {
    private String name = "idea_038496";
 ...
 */
@Slf4j
public class Idea38496Service {
    private static final int IDEA_ID = 38496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38496Service() {
        this(new Idea38496Config());
    }

    public Idea38496Service(Idea38496Config config) {
        this.config = config != null ? config : new Idea38496Config();
