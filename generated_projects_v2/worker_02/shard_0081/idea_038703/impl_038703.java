...
@Data
public class Idea38703Config {
    private String name = "idea_038703";
 ...
 */
@Slf4j
public class Idea38703Service {
    private static final int IDEA_ID = 38703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38703Service() {
        this(new Idea38703Config());
    }

    public Idea38703Service(Idea38703Config config) {
        this.config = config != null ? config : new Idea38703Config();
