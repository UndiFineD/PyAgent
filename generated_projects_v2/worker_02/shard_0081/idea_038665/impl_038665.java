...
@Data
public class Idea38665Config {
    private String name = "idea_038665";
 ...
 */
@Slf4j
public class Idea38665Service {
    private static final int IDEA_ID = 38665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38665Service() {
        this(new Idea38665Config());
    }

    public Idea38665Service(Idea38665Config config) {
        this.config = config != null ? config : new Idea38665Config();
