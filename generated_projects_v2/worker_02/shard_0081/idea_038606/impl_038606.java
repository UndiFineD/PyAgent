...
@Data
public class Idea38606Config {
    private String name = "idea_038606";
 ...
 */
@Slf4j
public class Idea38606Service {
    private static final int IDEA_ID = 38606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38606Service() {
        this(new Idea38606Config());
    }

    public Idea38606Service(Idea38606Config config) {
        this.config = config != null ? config : new Idea38606Config();
