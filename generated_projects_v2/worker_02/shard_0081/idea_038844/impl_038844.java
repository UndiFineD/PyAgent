...
@Data
public class Idea38844Config {
    private String name = "idea_038844";
 ...
 */
@Slf4j
public class Idea38844Service {
    private static final int IDEA_ID = 38844;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38844Service() {
        this(new Idea38844Config());
    }

    public Idea38844Service(Idea38844Config config) {
        this.config = config != null ? config : new Idea38844Config();
