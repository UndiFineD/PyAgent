...
@Data
public class Idea38810Config {
    private String name = "idea_038810";
 ...
 */
@Slf4j
public class Idea38810Service {
    private static final int IDEA_ID = 38810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea38810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea38810Service() {
        this(new Idea38810Config());
    }

    public Idea38810Service(Idea38810Config config) {
        this.config = config != null ? config : new Idea38810Config();
