...
@Data
public class Idea30812Config {
    private String name = "idea_030812";
 ...
 */
@Slf4j
public class Idea30812Service {
    private static final int IDEA_ID = 30812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30812Service() {
        this(new Idea30812Config());
    }

    public Idea30812Service(Idea30812Config config) {
        this.config = config != null ? config : new Idea30812Config();
