...
@Data
public class Idea30400Config {
    private String name = "idea_030400";
 ...
 */
@Slf4j
public class Idea30400Service {
    private static final int IDEA_ID = 30400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30400Service() {
        this(new Idea30400Config());
    }

    public Idea30400Service(Idea30400Config config) {
        this.config = config != null ? config : new Idea30400Config();
