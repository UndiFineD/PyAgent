...
@Data
public class Idea30836Config {
    private String name = "idea_030836";
 ...
 */
@Slf4j
public class Idea30836Service {
    private static final int IDEA_ID = 30836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30836Service() {
        this(new Idea30836Config());
    }

    public Idea30836Service(Idea30836Config config) {
        this.config = config != null ? config : new Idea30836Config();
