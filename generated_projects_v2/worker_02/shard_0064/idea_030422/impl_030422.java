...
@Data
public class Idea30422Config {
    private String name = "idea_030422";
 ...
 */
@Slf4j
public class Idea30422Service {
    private static final int IDEA_ID = 30422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30422Service() {
        this(new Idea30422Config());
    }

    public Idea30422Service(Idea30422Config config) {
        this.config = config != null ? config : new Idea30422Config();
