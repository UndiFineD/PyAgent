...
@Data
public class Idea30739Config {
    private String name = "idea_030739";
 ...
 */
@Slf4j
public class Idea30739Service {
    private static final int IDEA_ID = 30739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30739Service() {
        this(new Idea30739Config());
    }

    public Idea30739Service(Idea30739Config config) {
        this.config = config != null ? config : new Idea30739Config();
