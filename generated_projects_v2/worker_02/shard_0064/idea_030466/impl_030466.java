...
@Data
public class Idea30466Config {
    private String name = "idea_030466";
 ...
 */
@Slf4j
public class Idea30466Service {
    private static final int IDEA_ID = 30466;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30466Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30466Service() {
        this(new Idea30466Config());
    }

    public Idea30466Service(Idea30466Config config) {
        this.config = config != null ? config : new Idea30466Config();
