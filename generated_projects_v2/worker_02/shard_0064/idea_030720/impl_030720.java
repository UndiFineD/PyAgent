...
@Data
public class Idea30720Config {
    private String name = "idea_030720";
 ...
 */
@Slf4j
public class Idea30720Service {
    private static final int IDEA_ID = 30720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30720Service() {
        this(new Idea30720Config());
    }

    public Idea30720Service(Idea30720Config config) {
        this.config = config != null ? config : new Idea30720Config();
