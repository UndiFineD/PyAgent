...
@Data
public class Idea30823Config {
    private String name = "idea_030823";
 ...
 */
@Slf4j
public class Idea30823Service {
    private static final int IDEA_ID = 30823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30823Service() {
        this(new Idea30823Config());
    }

    public Idea30823Service(Idea30823Config config) {
        this.config = config != null ? config : new Idea30823Config();
