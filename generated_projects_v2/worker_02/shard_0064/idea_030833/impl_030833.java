...
@Data
public class Idea30833Config {
    private String name = "idea_030833";
 ...
 */
@Slf4j
public class Idea30833Service {
    private static final int IDEA_ID = 30833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30833Service() {
        this(new Idea30833Config());
    }

    public Idea30833Service(Idea30833Config config) {
        this.config = config != null ? config : new Idea30833Config();
