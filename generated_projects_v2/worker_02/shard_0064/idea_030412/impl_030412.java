...
@Data
public class Idea30412Config {
    private String name = "idea_030412";
 ...
 */
@Slf4j
public class Idea30412Service {
    private static final int IDEA_ID = 30412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30412Service() {
        this(new Idea30412Config());
    }

    public Idea30412Service(Idea30412Config config) {
        this.config = config != null ? config : new Idea30412Config();
