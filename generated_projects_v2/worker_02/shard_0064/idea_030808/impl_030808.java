...
@Data
public class Idea30808Config {
    private String name = "idea_030808";
 ...
 */
@Slf4j
public class Idea30808Service {
    private static final int IDEA_ID = 30808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30808Service() {
        this(new Idea30808Config());
    }

    public Idea30808Service(Idea30808Config config) {
        this.config = config != null ? config : new Idea30808Config();
