...
@Data
public class Idea30735Config {
    private String name = "idea_030735";
 ...
 */
@Slf4j
public class Idea30735Service {
    private static final int IDEA_ID = 30735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30735Service() {
        this(new Idea30735Config());
    }

    public Idea30735Service(Idea30735Config config) {
        this.config = config != null ? config : new Idea30735Config();
