...
@Data
public class Idea30526Config {
    private String name = "idea_030526";
 ...
 */
@Slf4j
public class Idea30526Service {
    private static final int IDEA_ID = 30526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30526Service() {
        this(new Idea30526Config());
    }

    public Idea30526Service(Idea30526Config config) {
        this.config = config != null ? config : new Idea30526Config();
