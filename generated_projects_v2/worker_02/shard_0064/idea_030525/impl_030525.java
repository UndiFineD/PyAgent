...
@Data
public class Idea30525Config {
    private String name = "idea_030525";
 ...
 */
@Slf4j
public class Idea30525Service {
    private static final int IDEA_ID = 30525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30525Service() {
        this(new Idea30525Config());
    }

    public Idea30525Service(Idea30525Config config) {
        this.config = config != null ? config : new Idea30525Config();
