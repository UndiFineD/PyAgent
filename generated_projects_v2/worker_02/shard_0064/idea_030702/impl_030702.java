...
@Data
public class Idea30702Config {
    private String name = "idea_030702";
 ...
 */
@Slf4j
public class Idea30702Service {
    private static final int IDEA_ID = 30702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30702Service() {
        this(new Idea30702Config());
    }

    public Idea30702Service(Idea30702Config config) {
        this.config = config != null ? config : new Idea30702Config();
