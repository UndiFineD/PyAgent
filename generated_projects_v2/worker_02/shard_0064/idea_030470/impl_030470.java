...
@Data
public class Idea30470Config {
    private String name = "idea_030470";
 ...
 */
@Slf4j
public class Idea30470Service {
    private static final int IDEA_ID = 30470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30470Service() {
        this(new Idea30470Config());
    }

    public Idea30470Service(Idea30470Config config) {
        this.config = config != null ? config : new Idea30470Config();
