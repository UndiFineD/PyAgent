...
@Data
public class Idea30597Config {
    private String name = "idea_030597";
 ...
 */
@Slf4j
public class Idea30597Service {
    private static final int IDEA_ID = 30597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30597Service() {
        this(new Idea30597Config());
    }

    public Idea30597Service(Idea30597Config config) {
        this.config = config != null ? config : new Idea30597Config();
