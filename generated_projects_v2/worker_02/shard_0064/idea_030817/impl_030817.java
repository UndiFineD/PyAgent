...
@Data
public class Idea30817Config {
    private String name = "idea_030817";
 ...
 */
@Slf4j
public class Idea30817Service {
    private static final int IDEA_ID = 30817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30817Service() {
        this(new Idea30817Config());
    }

    public Idea30817Service(Idea30817Config config) {
        this.config = config != null ? config : new Idea30817Config();
