...
@Data
public class Idea30697Config {
    private String name = "idea_030697";
 ...
 */
@Slf4j
public class Idea30697Service {
    private static final int IDEA_ID = 30697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30697Service() {
        this(new Idea30697Config());
    }

    public Idea30697Service(Idea30697Config config) {
        this.config = config != null ? config : new Idea30697Config();
