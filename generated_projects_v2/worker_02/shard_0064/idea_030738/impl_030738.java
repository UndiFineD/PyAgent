...
@Data
public class Idea30738Config {
    private String name = "idea_030738";
 ...
 */
@Slf4j
public class Idea30738Service {
    private static final int IDEA_ID = 30738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30738Service() {
        this(new Idea30738Config());
    }

    public Idea30738Service(Idea30738Config config) {
        this.config = config != null ? config : new Idea30738Config();
