...
@Data
public class Idea30604Config {
    private String name = "idea_030604";
 ...
 */
@Slf4j
public class Idea30604Service {
    private static final int IDEA_ID = 30604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30604Service() {
        this(new Idea30604Config());
    }

    public Idea30604Service(Idea30604Config config) {
        this.config = config != null ? config : new Idea30604Config();
