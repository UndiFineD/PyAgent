...
@Data
public class Idea30460Config {
    private String name = "idea_030460";
 ...
 */
@Slf4j
public class Idea30460Service {
    private static final int IDEA_ID = 30460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30460Service() {
        this(new Idea30460Config());
    }

    public Idea30460Service(Idea30460Config config) {
        this.config = config != null ? config : new Idea30460Config();
