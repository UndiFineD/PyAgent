...
@Data
public class Idea30620Config {
    private String name = "idea_030620";
 ...
 */
@Slf4j
public class Idea30620Service {
    private static final int IDEA_ID = 30620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30620Service() {
        this(new Idea30620Config());
    }

    public Idea30620Service(Idea30620Config config) {
        this.config = config != null ? config : new Idea30620Config();
