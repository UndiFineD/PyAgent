...
@Data
public class Idea30703Config {
    private String name = "idea_030703";
 ...
 */
@Slf4j
public class Idea30703Service {
    private static final int IDEA_ID = 30703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30703Service() {
        this(new Idea30703Config());
    }

    public Idea30703Service(Idea30703Config config) {
        this.config = config != null ? config : new Idea30703Config();
