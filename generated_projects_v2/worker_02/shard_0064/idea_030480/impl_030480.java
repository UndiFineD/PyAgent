...
@Data
public class Idea30480Config {
    private String name = "idea_030480";
 ...
 */
@Slf4j
public class Idea30480Service {
    private static final int IDEA_ID = 30480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30480Service() {
        this(new Idea30480Config());
    }

    public Idea30480Service(Idea30480Config config) {
        this.config = config != null ? config : new Idea30480Config();
