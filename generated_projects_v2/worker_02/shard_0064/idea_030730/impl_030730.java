...
@Data
public class Idea30730Config {
    private String name = "idea_030730";
 ...
 */
@Slf4j
public class Idea30730Service {
    private static final int IDEA_ID = 30730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30730Service() {
        this(new Idea30730Config());
    }

    public Idea30730Service(Idea30730Config config) {
        this.config = config != null ? config : new Idea30730Config();
