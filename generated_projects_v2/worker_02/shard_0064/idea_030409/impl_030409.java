...
@Data
public class Idea30409Config {
    private String name = "idea_030409";
 ...
 */
@Slf4j
public class Idea30409Service {
    private static final int IDEA_ID = 30409;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30409Service() {
        this(new Idea30409Config());
    }

    public Idea30409Service(Idea30409Config config) {
        this.config = config != null ? config : new Idea30409Config();
