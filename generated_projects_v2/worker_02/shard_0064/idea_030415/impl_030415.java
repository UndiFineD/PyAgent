...
@Data
public class Idea30415Config {
    private String name = "idea_030415";
 ...
 */
@Slf4j
public class Idea30415Service {
    private static final int IDEA_ID = 30415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30415Service() {
        this(new Idea30415Config());
    }

    public Idea30415Service(Idea30415Config config) {
        this.config = config != null ? config : new Idea30415Config();
