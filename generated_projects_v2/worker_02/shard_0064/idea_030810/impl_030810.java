...
@Data
public class Idea30810Config {
    private String name = "idea_030810";
 ...
 */
@Slf4j
public class Idea30810Service {
    private static final int IDEA_ID = 30810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30810Service() {
        this(new Idea30810Config());
    }

    public Idea30810Service(Idea30810Config config) {
        this.config = config != null ? config : new Idea30810Config();
