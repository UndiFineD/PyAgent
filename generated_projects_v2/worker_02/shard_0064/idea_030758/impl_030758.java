...
@Data
public class Idea30758Config {
    private String name = "idea_030758";
 ...
 */
@Slf4j
public class Idea30758Service {
    private static final int IDEA_ID = 30758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30758Service() {
        this(new Idea30758Config());
    }

    public Idea30758Service(Idea30758Config config) {
        this.config = config != null ? config : new Idea30758Config();
