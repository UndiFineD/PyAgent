...
@Data
public class Idea30670Config {
    private String name = "idea_030670";
 ...
 */
@Slf4j
public class Idea30670Service {
    private static final int IDEA_ID = 30670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30670Service() {
        this(new Idea30670Config());
    }

    public Idea30670Service(Idea30670Config config) {
        this.config = config != null ? config : new Idea30670Config();
