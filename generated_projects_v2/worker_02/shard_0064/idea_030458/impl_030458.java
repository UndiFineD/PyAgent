...
@Data
public class Idea30458Config {
    private String name = "idea_030458";
 ...
 */
@Slf4j
public class Idea30458Service {
    private static final int IDEA_ID = 30458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30458Service() {
        this(new Idea30458Config());
    }

    public Idea30458Service(Idea30458Config config) {
        this.config = config != null ? config : new Idea30458Config();
