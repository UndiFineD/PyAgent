...
@Data
public class Idea30678Config {
    private String name = "idea_030678";
 ...
 */
@Slf4j
public class Idea30678Service {
    private static final int IDEA_ID = 30678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30678Service() {
        this(new Idea30678Config());
    }

    public Idea30678Service(Idea30678Config config) {
        this.config = config != null ? config : new Idea30678Config();
