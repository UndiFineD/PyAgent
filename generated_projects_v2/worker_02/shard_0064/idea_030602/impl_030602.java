...
@Data
public class Idea30602Config {
    private String name = "idea_030602";
 ...
 */
@Slf4j
public class Idea30602Service {
    private static final int IDEA_ID = 30602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30602Service() {
        this(new Idea30602Config());
    }

    public Idea30602Service(Idea30602Config config) {
        this.config = config != null ? config : new Idea30602Config();
