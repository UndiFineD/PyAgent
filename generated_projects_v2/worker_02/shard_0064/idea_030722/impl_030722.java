...
@Data
public class Idea30722Config {
    private String name = "idea_030722";
 ...
 */
@Slf4j
public class Idea30722Service {
    private static final int IDEA_ID = 30722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30722Service() {
        this(new Idea30722Config());
    }

    public Idea30722Service(Idea30722Config config) {
        this.config = config != null ? config : new Idea30722Config();
