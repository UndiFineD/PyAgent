...
@Data
public class Idea30491Config {
    private String name = "idea_030491";
 ...
 */
@Slf4j
public class Idea30491Service {
    private static final int IDEA_ID = 30491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30491Service() {
        this(new Idea30491Config());
    }

    public Idea30491Service(Idea30491Config config) {
        this.config = config != null ? config : new Idea30491Config();
