...
@Data
public class Idea30873Config {
    private String name = "idea_030873";
 ...
 */
@Slf4j
public class Idea30873Service {
    private static final int IDEA_ID = 30873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30873Service() {
        this(new Idea30873Config());
    }

    public Idea30873Service(Idea30873Config config) {
        this.config = config != null ? config : new Idea30873Config();
