...
@Data
public class Idea30527Config {
    private String name = "idea_030527";
 ...
 */
@Slf4j
public class Idea30527Service {
    private static final int IDEA_ID = 30527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30527Service() {
        this(new Idea30527Config());
    }

    public Idea30527Service(Idea30527Config config) {
        this.config = config != null ? config : new Idea30527Config();
