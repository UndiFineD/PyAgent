...
@Data
public class Idea30727Config {
    private String name = "idea_030727";
 ...
 */
@Slf4j
public class Idea30727Service {
    private static final int IDEA_ID = 30727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30727Service() {
        this(new Idea30727Config());
    }

    public Idea30727Service(Idea30727Config config) {
        this.config = config != null ? config : new Idea30727Config();
