...
@Data
public class Idea30646Config {
    private String name = "idea_030646";
 ...
 */
@Slf4j
public class Idea30646Service {
    private static final int IDEA_ID = 30646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30646Service() {
        this(new Idea30646Config());
    }

    public Idea30646Service(Idea30646Config config) {
        this.config = config != null ? config : new Idea30646Config();
