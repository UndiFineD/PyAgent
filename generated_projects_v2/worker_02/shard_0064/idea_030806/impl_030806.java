...
@Data
public class Idea30806Config {
    private String name = "idea_030806";
 ...
 */
@Slf4j
public class Idea30806Service {
    private static final int IDEA_ID = 30806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30806Service() {
        this(new Idea30806Config());
    }

    public Idea30806Service(Idea30806Config config) {
        this.config = config != null ? config : new Idea30806Config();
