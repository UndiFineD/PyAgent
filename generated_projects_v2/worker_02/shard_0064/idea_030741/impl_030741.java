...
@Data
public class Idea30741Config {
    private String name = "idea_030741";
 ...
 */
@Slf4j
public class Idea30741Service {
    private static final int IDEA_ID = 30741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30741Service() {
        this(new Idea30741Config());
    }

    public Idea30741Service(Idea30741Config config) {
        this.config = config != null ? config : new Idea30741Config();
