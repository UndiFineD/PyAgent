...
@Data
public class Idea30562Config {
    private String name = "idea_030562";
 ...
 */
@Slf4j
public class Idea30562Service {
    private static final int IDEA_ID = 30562;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30562Service() {
        this(new Idea30562Config());
    }

    public Idea30562Service(Idea30562Config config) {
        this.config = config != null ? config : new Idea30562Config();
