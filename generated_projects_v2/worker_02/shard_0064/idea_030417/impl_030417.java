...
@Data
public class Idea30417Config {
    private String name = "idea_030417";
 ...
 */
@Slf4j
public class Idea30417Service {
    private static final int IDEA_ID = 30417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30417Service() {
        this(new Idea30417Config());
    }

    public Idea30417Service(Idea30417Config config) {
        this.config = config != null ? config : new Idea30417Config();
