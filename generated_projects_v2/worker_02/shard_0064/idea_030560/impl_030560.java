...
@Data
public class Idea30560Config {
    private String name = "idea_030560";
 ...
 */
@Slf4j
public class Idea30560Service {
    private static final int IDEA_ID = 30560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30560Service() {
        this(new Idea30560Config());
    }

    public Idea30560Service(Idea30560Config config) {
        this.config = config != null ? config : new Idea30560Config();
