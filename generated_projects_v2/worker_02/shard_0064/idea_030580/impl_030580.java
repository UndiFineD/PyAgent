...
@Data
public class Idea30580Config {
    private String name = "idea_030580";
 ...
 */
@Slf4j
public class Idea30580Service {
    private static final int IDEA_ID = 30580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30580Service() {
        this(new Idea30580Config());
    }

    public Idea30580Service(Idea30580Config config) {
        this.config = config != null ? config : new Idea30580Config();
