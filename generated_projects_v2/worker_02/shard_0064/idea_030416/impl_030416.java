...
@Data
public class Idea30416Config {
    private String name = "idea_030416";
 ...
 */
@Slf4j
public class Idea30416Service {
    private static final int IDEA_ID = 30416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30416Service() {
        this(new Idea30416Config());
    }

    public Idea30416Service(Idea30416Config config) {
        this.config = config != null ? config : new Idea30416Config();
