...
@Data
public class Idea30615Config {
    private String name = "idea_030615";
 ...
 */
@Slf4j
public class Idea30615Service {
    private static final int IDEA_ID = 30615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30615Service() {
        this(new Idea30615Config());
    }

    public Idea30615Service(Idea30615Config config) {
        this.config = config != null ? config : new Idea30615Config();
