...
@Data
public class Idea30636Config {
    private String name = "idea_030636";
 ...
 */
@Slf4j
public class Idea30636Service {
    private static final int IDEA_ID = 30636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30636Service() {
        this(new Idea30636Config());
    }

    public Idea30636Service(Idea30636Config config) {
        this.config = config != null ? config : new Idea30636Config();
