...
@Data
public class Idea30586Config {
    private String name = "idea_030586";
 ...
 */
@Slf4j
public class Idea30586Service {
    private static final int IDEA_ID = 30586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30586Service() {
        this(new Idea30586Config());
    }

    public Idea30586Service(Idea30586Config config) {
        this.config = config != null ? config : new Idea30586Config();
