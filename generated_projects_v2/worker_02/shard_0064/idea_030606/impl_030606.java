...
@Data
public class Idea30606Config {
    private String name = "idea_030606";
 ...
 */
@Slf4j
public class Idea30606Service {
    private static final int IDEA_ID = 30606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30606Service() {
        this(new Idea30606Config());
    }

    public Idea30606Service(Idea30606Config config) {
        this.config = config != null ? config : new Idea30606Config();
