...
@Data
public class Idea30590Config {
    private String name = "idea_030590";
 ...
 */
@Slf4j
public class Idea30590Service {
    private static final int IDEA_ID = 30590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30590Service() {
        this(new Idea30590Config());
    }

    public Idea30590Service(Idea30590Config config) {
        this.config = config != null ? config : new Idea30590Config();
