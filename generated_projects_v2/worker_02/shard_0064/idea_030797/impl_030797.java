...
@Data
public class Idea30797Config {
    private String name = "idea_030797";
 ...
 */
@Slf4j
public class Idea30797Service {
    private static final int IDEA_ID = 30797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30797Service() {
        this(new Idea30797Config());
    }

    public Idea30797Service(Idea30797Config config) {
        this.config = config != null ? config : new Idea30797Config();
