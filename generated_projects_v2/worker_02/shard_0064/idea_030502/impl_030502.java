...
@Data
public class Idea30502Config {
    private String name = "idea_030502";
 ...
 */
@Slf4j
public class Idea30502Service {
    private static final int IDEA_ID = 30502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30502Service() {
        this(new Idea30502Config());
    }

    public Idea30502Service(Idea30502Config config) {
        this.config = config != null ? config : new Idea30502Config();
