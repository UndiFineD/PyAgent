...
@Data
public class Idea30665Config {
    private String name = "idea_030665";
 ...
 */
@Slf4j
public class Idea30665Service {
    private static final int IDEA_ID = 30665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30665Service() {
        this(new Idea30665Config());
    }

    public Idea30665Service(Idea30665Config config) {
        this.config = config != null ? config : new Idea30665Config();
