...
@Data
public class Idea30708Config {
    private String name = "idea_030708";
 ...
 */
@Slf4j
public class Idea30708Service {
    private static final int IDEA_ID = 30708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30708Service() {
        this(new Idea30708Config());
    }

    public Idea30708Service(Idea30708Config config) {
        this.config = config != null ? config : new Idea30708Config();
