...
@Data
public class Idea30671Config {
    private String name = "idea_030671";
 ...
 */
@Slf4j
public class Idea30671Service {
    private static final int IDEA_ID = 30671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30671Service() {
        this(new Idea30671Config());
    }

    public Idea30671Service(Idea30671Config config) {
        this.config = config != null ? config : new Idea30671Config();
