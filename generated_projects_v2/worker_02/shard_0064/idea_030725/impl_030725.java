...
@Data
public class Idea30725Config {
    private String name = "idea_030725";
 ...
 */
@Slf4j
public class Idea30725Service {
    private static final int IDEA_ID = 30725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30725Service() {
        this(new Idea30725Config());
    }

    public Idea30725Service(Idea30725Config config) {
        this.config = config != null ? config : new Idea30725Config();
