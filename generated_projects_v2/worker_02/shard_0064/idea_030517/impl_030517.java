...
@Data
public class Idea30517Config {
    private String name = "idea_030517";
 ...
 */
@Slf4j
public class Idea30517Service {
    private static final int IDEA_ID = 30517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30517Service() {
        this(new Idea30517Config());
    }

    public Idea30517Service(Idea30517Config config) {
        this.config = config != null ? config : new Idea30517Config();
