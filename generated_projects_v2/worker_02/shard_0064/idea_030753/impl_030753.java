...
@Data
public class Idea30753Config {
    private String name = "idea_030753";
 ...
 */
@Slf4j
public class Idea30753Service {
    private static final int IDEA_ID = 30753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30753Service() {
        this(new Idea30753Config());
    }

    public Idea30753Service(Idea30753Config config) {
        this.config = config != null ? config : new Idea30753Config();
