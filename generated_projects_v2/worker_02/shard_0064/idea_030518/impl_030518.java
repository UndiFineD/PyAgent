...
@Data
public class Idea30518Config {
    private String name = "idea_030518";
 ...
 */
@Slf4j
public class Idea30518Service {
    private static final int IDEA_ID = 30518;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30518Service() {
        this(new Idea30518Config());
    }

    public Idea30518Service(Idea30518Config config) {
        this.config = config != null ? config : new Idea30518Config();
