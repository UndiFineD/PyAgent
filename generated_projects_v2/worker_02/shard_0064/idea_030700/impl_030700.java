...
@Data
public class Idea30700Config {
    private String name = "idea_030700";
 ...
 */
@Slf4j
public class Idea30700Service {
    private static final int IDEA_ID = 30700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30700Service() {
        this(new Idea30700Config());
    }

    public Idea30700Service(Idea30700Config config) {
        this.config = config != null ? config : new Idea30700Config();
