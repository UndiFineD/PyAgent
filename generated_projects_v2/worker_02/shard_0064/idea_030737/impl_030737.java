...
@Data
public class Idea30737Config {
    private String name = "idea_030737";
 ...
 */
@Slf4j
public class Idea30737Service {
    private static final int IDEA_ID = 30737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30737Service() {
        this(new Idea30737Config());
    }

    public Idea30737Service(Idea30737Config config) {
        this.config = config != null ? config : new Idea30737Config();
