...
@Data
public class Idea30767Config {
    private String name = "idea_030767";
 ...
 */
@Slf4j
public class Idea30767Service {
    private static final int IDEA_ID = 30767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30767Service() {
        this(new Idea30767Config());
    }

    public Idea30767Service(Idea30767Config config) {
        this.config = config != null ? config : new Idea30767Config();
