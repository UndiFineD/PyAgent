...
@Data
public class Idea30798Config {
    private String name = "idea_030798";
 ...
 */
@Slf4j
public class Idea30798Service {
    private static final int IDEA_ID = 30798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30798Service() {
        this(new Idea30798Config());
    }

    public Idea30798Service(Idea30798Config config) {
        this.config = config != null ? config : new Idea30798Config();
