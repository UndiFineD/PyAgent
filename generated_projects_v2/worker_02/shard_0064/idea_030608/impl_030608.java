...
@Data
public class Idea30608Config {
    private String name = "idea_030608";
 ...
 */
@Slf4j
public class Idea30608Service {
    private static final int IDEA_ID = 30608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30608Service() {
        this(new Idea30608Config());
    }

    public Idea30608Service(Idea30608Config config) {
        this.config = config != null ? config : new Idea30608Config();
