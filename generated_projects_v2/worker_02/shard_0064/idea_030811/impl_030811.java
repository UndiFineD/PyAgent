...
@Data
public class Idea30811Config {
    private String name = "idea_030811";
 ...
 */
@Slf4j
public class Idea30811Service {
    private static final int IDEA_ID = 30811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30811Service() {
        this(new Idea30811Config());
    }

    public Idea30811Service(Idea30811Config config) {
        this.config = config != null ? config : new Idea30811Config();
