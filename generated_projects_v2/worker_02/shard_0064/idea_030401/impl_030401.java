...
@Data
public class Idea30401Config {
    private String name = "idea_030401";
 ...
 */
@Slf4j
public class Idea30401Service {
    private static final int IDEA_ID = 30401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30401Service() {
        this(new Idea30401Config());
    }

    public Idea30401Service(Idea30401Config config) {
        this.config = config != null ? config : new Idea30401Config();
