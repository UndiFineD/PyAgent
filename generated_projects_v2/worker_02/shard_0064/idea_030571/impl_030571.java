...
@Data
public class Idea30571Config {
    private String name = "idea_030571";
 ...
 */
@Slf4j
public class Idea30571Service {
    private static final int IDEA_ID = 30571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30571Service() {
        this(new Idea30571Config());
    }

    public Idea30571Service(Idea30571Config config) {
        this.config = config != null ? config : new Idea30571Config();
