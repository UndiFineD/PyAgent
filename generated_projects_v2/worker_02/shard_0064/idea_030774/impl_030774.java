...
@Data
public class Idea30774Config {
    private String name = "idea_030774";
 ...
 */
@Slf4j
public class Idea30774Service {
    private static final int IDEA_ID = 30774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30774Service() {
        this(new Idea30774Config());
    }

    public Idea30774Service(Idea30774Config config) {
        this.config = config != null ? config : new Idea30774Config();
