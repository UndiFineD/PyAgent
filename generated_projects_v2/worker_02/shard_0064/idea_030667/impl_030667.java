...
@Data
public class Idea30667Config {
    private String name = "idea_030667";
 ...
 */
@Slf4j
public class Idea30667Service {
    private static final int IDEA_ID = 30667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30667Service() {
        this(new Idea30667Config());
    }

    public Idea30667Service(Idea30667Config config) {
        this.config = config != null ? config : new Idea30667Config();
