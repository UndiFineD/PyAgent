...
@Data
public class Idea30573Config {
    private String name = "idea_030573";
 ...
 */
@Slf4j
public class Idea30573Service {
    private static final int IDEA_ID = 30573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30573Service() {
        this(new Idea30573Config());
    }

    public Idea30573Service(Idea30573Config config) {
        this.config = config != null ? config : new Idea30573Config();
