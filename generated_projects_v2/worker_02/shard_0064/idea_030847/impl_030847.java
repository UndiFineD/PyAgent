...
@Data
public class Idea30847Config {
    private String name = "idea_030847";
 ...
 */
@Slf4j
public class Idea30847Service {
    private static final int IDEA_ID = 30847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30847Service() {
        this(new Idea30847Config());
    }

    public Idea30847Service(Idea30847Config config) {
        this.config = config != null ? config : new Idea30847Config();
