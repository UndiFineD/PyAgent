...
@Data
public class Idea30585Config {
    private String name = "idea_030585";
 ...
 */
@Slf4j
public class Idea30585Service {
    private static final int IDEA_ID = 30585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30585Service() {
        this(new Idea30585Config());
    }

    public Idea30585Service(Idea30585Config config) {
        this.config = config != null ? config : new Idea30585Config();
