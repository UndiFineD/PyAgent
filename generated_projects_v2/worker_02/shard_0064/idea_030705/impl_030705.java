...
@Data
public class Idea30705Config {
    private String name = "idea_030705";
 ...
 */
@Slf4j
public class Idea30705Service {
    private static final int IDEA_ID = 30705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30705Service() {
        this(new Idea30705Config());
    }

    public Idea30705Service(Idea30705Config config) {
        this.config = config != null ? config : new Idea30705Config();
