...
@Data
public class Idea30433Config {
    private String name = "idea_030433";
 ...
 */
@Slf4j
public class Idea30433Service {
    private static final int IDEA_ID = 30433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30433Service() {
        this(new Idea30433Config());
    }

    public Idea30433Service(Idea30433Config config) {
        this.config = config != null ? config : new Idea30433Config();
