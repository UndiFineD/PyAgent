...
@Data
public class Idea30715Config {
    private String name = "idea_030715";
 ...
 */
@Slf4j
public class Idea30715Service {
    private static final int IDEA_ID = 30715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30715Service() {
        this(new Idea30715Config());
    }

    public Idea30715Service(Idea30715Config config) {
        this.config = config != null ? config : new Idea30715Config();
