...
@Data
public class Idea30593Config {
    private String name = "idea_030593";
 ...
 */
@Slf4j
public class Idea30593Service {
    private static final int IDEA_ID = 30593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30593Service() {
        this(new Idea30593Config());
    }

    public Idea30593Service(Idea30593Config config) {
        this.config = config != null ? config : new Idea30593Config();
