...
@Data
public class Idea30839Config {
    private String name = "idea_030839";
 ...
 */
@Slf4j
public class Idea30839Service {
    private static final int IDEA_ID = 30839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30839Service() {
        this(new Idea30839Config());
    }

    public Idea30839Service(Idea30839Config config) {
        this.config = config != null ? config : new Idea30839Config();
