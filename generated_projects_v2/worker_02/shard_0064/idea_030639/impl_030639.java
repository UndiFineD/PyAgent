...
@Data
public class Idea30639Config {
    private String name = "idea_030639";
 ...
 */
@Slf4j
public class Idea30639Service {
    private static final int IDEA_ID = 30639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30639Service() {
        this(new Idea30639Config());
    }

    public Idea30639Service(Idea30639Config config) {
        this.config = config != null ? config : new Idea30639Config();
