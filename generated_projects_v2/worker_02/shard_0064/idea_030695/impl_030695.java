...
@Data
public class Idea30695Config {
    private String name = "idea_030695";
 ...
 */
@Slf4j
public class Idea30695Service {
    private static final int IDEA_ID = 30695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30695Service() {
        this(new Idea30695Config());
    }

    public Idea30695Service(Idea30695Config config) {
        this.config = config != null ? config : new Idea30695Config();
