...
@Data
public class Idea30789Config {
    private String name = "idea_030789";
 ...
 */
@Slf4j
public class Idea30789Service {
    private static final int IDEA_ID = 30789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30789Service() {
        this(new Idea30789Config());
    }

    public Idea30789Service(Idea30789Config config) {
        this.config = config != null ? config : new Idea30789Config();
