...
@Data
public class Idea30485Config {
    private String name = "idea_030485";
 ...
 */
@Slf4j
public class Idea30485Service {
    private static final int IDEA_ID = 30485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30485Service() {
        this(new Idea30485Config());
    }

    public Idea30485Service(Idea30485Config config) {
        this.config = config != null ? config : new Idea30485Config();
