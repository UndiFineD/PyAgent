...
@Data
public class Idea30707Config {
    private String name = "idea_030707";
 ...
 */
@Slf4j
public class Idea30707Service {
    private static final int IDEA_ID = 30707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30707Service() {
        this(new Idea30707Config());
    }

    public Idea30707Service(Idea30707Config config) {
        this.config = config != null ? config : new Idea30707Config();
