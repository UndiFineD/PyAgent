...
@Data
public class Idea30423Config {
    private String name = "idea_030423";
 ...
 */
@Slf4j
public class Idea30423Service {
    private static final int IDEA_ID = 30423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30423Service() {
        this(new Idea30423Config());
    }

    public Idea30423Service(Idea30423Config config) {
        this.config = config != null ? config : new Idea30423Config();
