...
@Data
public class Idea30706Config {
    private String name = "idea_030706";
 ...
 */
@Slf4j
public class Idea30706Service {
    private static final int IDEA_ID = 30706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30706Service() {
        this(new Idea30706Config());
    }

    public Idea30706Service(Idea30706Config config) {
        this.config = config != null ? config : new Idea30706Config();
