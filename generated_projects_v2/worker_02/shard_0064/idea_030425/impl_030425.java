...
@Data
public class Idea30425Config {
    private String name = "idea_030425";
 ...
 */
@Slf4j
public class Idea30425Service {
    private static final int IDEA_ID = 30425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30425Service() {
        this(new Idea30425Config());
    }

    public Idea30425Service(Idea30425Config config) {
        this.config = config != null ? config : new Idea30425Config();
