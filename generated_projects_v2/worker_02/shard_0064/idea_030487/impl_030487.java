...
@Data
public class Idea30487Config {
    private String name = "idea_030487";
 ...
 */
@Slf4j
public class Idea30487Service {
    private static final int IDEA_ID = 30487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30487Service() {
        this(new Idea30487Config());
    }

    public Idea30487Service(Idea30487Config config) {
        this.config = config != null ? config : new Idea30487Config();
