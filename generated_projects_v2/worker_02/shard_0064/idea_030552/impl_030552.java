...
@Data
public class Idea30552Config {
    private String name = "idea_030552";
 ...
 */
@Slf4j
public class Idea30552Service {
    private static final int IDEA_ID = 30552;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30552Service() {
        this(new Idea30552Config());
    }

    public Idea30552Service(Idea30552Config config) {
        this.config = config != null ? config : new Idea30552Config();
