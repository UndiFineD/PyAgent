...
@Data
public class Idea30872Config {
    private String name = "idea_030872";
 ...
 */
@Slf4j
public class Idea30872Service {
    private static final int IDEA_ID = 30872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30872Service() {
        this(new Idea30872Config());
    }

    public Idea30872Service(Idea30872Config config) {
        this.config = config != null ? config : new Idea30872Config();
