...
@Data
public class Idea30424Config {
    private String name = "idea_030424";
 ...
 */
@Slf4j
public class Idea30424Service {
    private static final int IDEA_ID = 30424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30424Service() {
        this(new Idea30424Config());
    }

    public Idea30424Service(Idea30424Config config) {
        this.config = config != null ? config : new Idea30424Config();
