...
@Data
public class Idea30673Config {
    private String name = "idea_030673";
 ...
 */
@Slf4j
public class Idea30673Service {
    private static final int IDEA_ID = 30673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30673Service() {
        this(new Idea30673Config());
    }

    public Idea30673Service(Idea30673Config config) {
        this.config = config != null ? config : new Idea30673Config();
