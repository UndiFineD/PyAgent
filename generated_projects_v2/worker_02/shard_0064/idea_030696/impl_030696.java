...
@Data
public class Idea30696Config {
    private String name = "idea_030696";
 ...
 */
@Slf4j
public class Idea30696Service {
    private static final int IDEA_ID = 30696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30696Service() {
        this(new Idea30696Config());
    }

    public Idea30696Service(Idea30696Config config) {
        this.config = config != null ? config : new Idea30696Config();
