...
@Data
public class Idea30610Config {
    private String name = "idea_030610";
 ...
 */
@Slf4j
public class Idea30610Service {
    private static final int IDEA_ID = 30610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30610Service() {
        this(new Idea30610Config());
    }

    public Idea30610Service(Idea30610Config config) {
        this.config = config != null ? config : new Idea30610Config();
