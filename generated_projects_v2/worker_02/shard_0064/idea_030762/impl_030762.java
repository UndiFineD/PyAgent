...
@Data
public class Idea30762Config {
    private String name = "idea_030762";
 ...
 */
@Slf4j
public class Idea30762Service {
    private static final int IDEA_ID = 30762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30762Service() {
        this(new Idea30762Config());
    }

    public Idea30762Service(Idea30762Config config) {
        this.config = config != null ? config : new Idea30762Config();
