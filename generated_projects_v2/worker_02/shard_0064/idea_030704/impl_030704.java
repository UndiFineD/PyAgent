...
@Data
public class Idea30704Config {
    private String name = "idea_030704";
 ...
 */
@Slf4j
public class Idea30704Service {
    private static final int IDEA_ID = 30704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30704Service() {
        this(new Idea30704Config());
    }

    public Idea30704Service(Idea30704Config config) {
        this.config = config != null ? config : new Idea30704Config();
