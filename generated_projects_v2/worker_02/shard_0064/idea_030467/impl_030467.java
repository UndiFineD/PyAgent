...
@Data
public class Idea30467Config {
    private String name = "idea_030467";
 ...
 */
@Slf4j
public class Idea30467Service {
    private static final int IDEA_ID = 30467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30467Service() {
        this(new Idea30467Config());
    }

    public Idea30467Service(Idea30467Config config) {
        this.config = config != null ? config : new Idea30467Config();
