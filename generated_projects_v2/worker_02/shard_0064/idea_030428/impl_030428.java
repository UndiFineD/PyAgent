...
@Data
public class Idea30428Config {
    private String name = "idea_030428";
 ...
 */
@Slf4j
public class Idea30428Service {
    private static final int IDEA_ID = 30428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30428Service() {
        this(new Idea30428Config());
    }

    public Idea30428Service(Idea30428Config config) {
        this.config = config != null ? config : new Idea30428Config();
