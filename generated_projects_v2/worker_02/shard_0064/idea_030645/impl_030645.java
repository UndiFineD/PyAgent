...
@Data
public class Idea30645Config {
    private String name = "idea_030645";
 ...
 */
@Slf4j
public class Idea30645Service {
    private static final int IDEA_ID = 30645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30645Service() {
        this(new Idea30645Config());
    }

    public Idea30645Service(Idea30645Config config) {
        this.config = config != null ? config : new Idea30645Config();
