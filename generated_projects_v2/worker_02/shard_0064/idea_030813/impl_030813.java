...
@Data
public class Idea30813Config {
    private String name = "idea_030813";
 ...
 */
@Slf4j
public class Idea30813Service {
    private static final int IDEA_ID = 30813;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30813Service() {
        this(new Idea30813Config());
    }

    public Idea30813Service(Idea30813Config config) {
        this.config = config != null ? config : new Idea30813Config();
