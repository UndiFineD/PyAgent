...
@Data
public class Idea30859Config {
    private String name = "idea_030859";
 ...
 */
@Slf4j
public class Idea30859Service {
    private static final int IDEA_ID = 30859;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30859Service() {
        this(new Idea30859Config());
    }

    public Idea30859Service(Idea30859Config config) {
        this.config = config != null ? config : new Idea30859Config();
