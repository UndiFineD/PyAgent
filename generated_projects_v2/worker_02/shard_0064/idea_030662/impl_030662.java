...
@Data
public class Idea30662Config {
    private String name = "idea_030662";
 ...
 */
@Slf4j
public class Idea30662Service {
    private static final int IDEA_ID = 30662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30662Service() {
        this(new Idea30662Config());
    }

    public Idea30662Service(Idea30662Config config) {
        this.config = config != null ? config : new Idea30662Config();
