...
@Data
public class Idea30522Config {
    private String name = "idea_030522";
 ...
 */
@Slf4j
public class Idea30522Service {
    private static final int IDEA_ID = 30522;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30522Service() {
        this(new Idea30522Config());
    }

    public Idea30522Service(Idea30522Config config) {
        this.config = config != null ? config : new Idea30522Config();
