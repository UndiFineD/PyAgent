...
@Data
public class Idea30655Config {
    private String name = "idea_030655";
 ...
 */
@Slf4j
public class Idea30655Service {
    private static final int IDEA_ID = 30655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30655Service() {
        this(new Idea30655Config());
    }

    public Idea30655Service(Idea30655Config config) {
        this.config = config != null ? config : new Idea30655Config();
