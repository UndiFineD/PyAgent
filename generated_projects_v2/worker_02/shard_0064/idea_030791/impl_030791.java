...
@Data
public class Idea30791Config {
    private String name = "idea_030791";
 ...
 */
@Slf4j
public class Idea30791Service {
    private static final int IDEA_ID = 30791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30791Service() {
        this(new Idea30791Config());
    }

    public Idea30791Service(Idea30791Config config) {
        this.config = config != null ? config : new Idea30791Config();
