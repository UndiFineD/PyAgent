...
@Data
public class Idea30713Config {
    private String name = "idea_030713";
 ...
 */
@Slf4j
public class Idea30713Service {
    private static final int IDEA_ID = 30713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30713Service() {
        this(new Idea30713Config());
    }

    public Idea30713Service(Idea30713Config config) {
        this.config = config != null ? config : new Idea30713Config();
