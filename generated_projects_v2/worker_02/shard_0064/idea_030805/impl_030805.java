...
@Data
public class Idea30805Config {
    private String name = "idea_030805";
 ...
 */
@Slf4j
public class Idea30805Service {
    private static final int IDEA_ID = 30805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30805Service() {
        this(new Idea30805Config());
    }

    public Idea30805Service(Idea30805Config config) {
        this.config = config != null ? config : new Idea30805Config();
