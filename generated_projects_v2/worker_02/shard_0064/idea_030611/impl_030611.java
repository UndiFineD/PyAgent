...
@Data
public class Idea30611Config {
    private String name = "idea_030611";
 ...
 */
@Slf4j
public class Idea30611Service {
    private static final int IDEA_ID = 30611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30611Service() {
        this(new Idea30611Config());
    }

    public Idea30611Service(Idea30611Config config) {
        this.config = config != null ? config : new Idea30611Config();
