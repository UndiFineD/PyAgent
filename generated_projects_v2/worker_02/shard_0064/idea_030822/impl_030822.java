...
@Data
public class Idea30822Config {
    private String name = "idea_030822";
 ...
 */
@Slf4j
public class Idea30822Service {
    private static final int IDEA_ID = 30822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30822Service() {
        this(new Idea30822Config());
    }

    public Idea30822Service(Idea30822Config config) {
        this.config = config != null ? config : new Idea30822Config();
