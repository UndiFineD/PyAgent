...
@Data
public class Idea30581Config {
    private String name = "idea_030581";
 ...
 */
@Slf4j
public class Idea30581Service {
    private static final int IDEA_ID = 30581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30581Service() {
        this(new Idea30581Config());
    }

    public Idea30581Service(Idea30581Config config) {
        this.config = config != null ? config : new Idea30581Config();
