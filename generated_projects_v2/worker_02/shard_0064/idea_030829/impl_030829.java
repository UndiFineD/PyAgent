...
@Data
public class Idea30829Config {
    private String name = "idea_030829";
 ...
 */
@Slf4j
public class Idea30829Service {
    private static final int IDEA_ID = 30829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30829Service() {
        this(new Idea30829Config());
    }

    public Idea30829Service(Idea30829Config config) {
        this.config = config != null ? config : new Idea30829Config();
