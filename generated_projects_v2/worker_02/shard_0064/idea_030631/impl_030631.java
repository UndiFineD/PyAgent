...
@Data
public class Idea30631Config {
    private String name = "idea_030631";
 ...
 */
@Slf4j
public class Idea30631Service {
    private static final int IDEA_ID = 30631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30631Service() {
        this(new Idea30631Config());
    }

    public Idea30631Service(Idea30631Config config) {
        this.config = config != null ? config : new Idea30631Config();
