...
@Data
public class Idea30630Config {
    private String name = "idea_030630";
 ...
 */
@Slf4j
public class Idea30630Service {
    private static final int IDEA_ID = 30630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30630Service() {
        this(new Idea30630Config());
    }

    public Idea30630Service(Idea30630Config config) {
        this.config = config != null ? config : new Idea30630Config();
