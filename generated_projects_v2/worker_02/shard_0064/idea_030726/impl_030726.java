...
@Data
public class Idea30726Config {
    private String name = "idea_030726";
 ...
 */
@Slf4j
public class Idea30726Service {
    private static final int IDEA_ID = 30726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30726Service() {
        this(new Idea30726Config());
    }

    public Idea30726Service(Idea30726Config config) {
        this.config = config != null ? config : new Idea30726Config();
