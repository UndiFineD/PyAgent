...
@Data
public class Idea30403Config {
    private String name = "idea_030403";
 ...
 */
@Slf4j
public class Idea30403Service {
    private static final int IDEA_ID = 30403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30403Service() {
        this(new Idea30403Config());
    }

    public Idea30403Service(Idea30403Config config) {
        this.config = config != null ? config : new Idea30403Config();
