...
@Data
public class Idea30860Config {
    private String name = "idea_030860";
 ...
 */
@Slf4j
public class Idea30860Service {
    private static final int IDEA_ID = 30860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30860Service() {
        this(new Idea30860Config());
    }

    public Idea30860Service(Idea30860Config config) {
        this.config = config != null ? config : new Idea30860Config();
