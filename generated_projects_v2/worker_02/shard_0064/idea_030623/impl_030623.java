...
@Data
public class Idea30623Config {
    private String name = "idea_030623";
 ...
 */
@Slf4j
public class Idea30623Service {
    private static final int IDEA_ID = 30623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30623Service() {
        this(new Idea30623Config());
    }

    public Idea30623Service(Idea30623Config config) {
        this.config = config != null ? config : new Idea30623Config();
