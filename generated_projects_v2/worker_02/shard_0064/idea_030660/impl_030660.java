...
@Data
public class Idea30660Config {
    private String name = "idea_030660";
 ...
 */
@Slf4j
public class Idea30660Service {
    private static final int IDEA_ID = 30660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30660Service() {
        this(new Idea30660Config());
    }

    public Idea30660Service(Idea30660Config config) {
        this.config = config != null ? config : new Idea30660Config();
