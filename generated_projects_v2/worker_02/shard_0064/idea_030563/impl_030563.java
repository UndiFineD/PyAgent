...
@Data
public class Idea30563Config {
    private String name = "idea_030563";
 ...
 */
@Slf4j
public class Idea30563Service {
    private static final int IDEA_ID = 30563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30563Service() {
        this(new Idea30563Config());
    }

    public Idea30563Service(Idea30563Config config) {
        this.config = config != null ? config : new Idea30563Config();
