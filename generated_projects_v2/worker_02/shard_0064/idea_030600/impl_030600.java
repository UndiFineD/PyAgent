...
@Data
public class Idea30600Config {
    private String name = "idea_030600";
 ...
 */
@Slf4j
public class Idea30600Service {
    private static final int IDEA_ID = 30600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30600Service() {
        this(new Idea30600Config());
    }

    public Idea30600Service(Idea30600Config config) {
        this.config = config != null ? config : new Idea30600Config();
