...
@Data
public class Idea30800Config {
    private String name = "idea_030800";
 ...
 */
@Slf4j
public class Idea30800Service {
    private static final int IDEA_ID = 30800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30800Service() {
        this(new Idea30800Config());
    }

    public Idea30800Service(Idea30800Config config) {
        this.config = config != null ? config : new Idea30800Config();
