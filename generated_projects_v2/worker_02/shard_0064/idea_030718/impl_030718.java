...
@Data
public class Idea30718Config {
    private String name = "idea_030718";
 ...
 */
@Slf4j
public class Idea30718Service {
    private static final int IDEA_ID = 30718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30718Service() {
        this(new Idea30718Config());
    }

    public Idea30718Service(Idea30718Config config) {
        this.config = config != null ? config : new Idea30718Config();
