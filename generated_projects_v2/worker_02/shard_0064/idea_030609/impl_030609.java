...
@Data
public class Idea30609Config {
    private String name = "idea_030609";
 ...
 */
@Slf4j
public class Idea30609Service {
    private static final int IDEA_ID = 30609;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30609Service() {
        this(new Idea30609Config());
    }

    public Idea30609Service(Idea30609Config config) {
        this.config = config != null ? config : new Idea30609Config();
