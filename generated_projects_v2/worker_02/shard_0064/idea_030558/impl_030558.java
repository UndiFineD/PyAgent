...
@Data
public class Idea30558Config {
    private String name = "idea_030558";
 ...
 */
@Slf4j
public class Idea30558Service {
    private static final int IDEA_ID = 30558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30558Service() {
        this(new Idea30558Config());
    }

    public Idea30558Service(Idea30558Config config) {
        this.config = config != null ? config : new Idea30558Config();
