...
@Data
public class Idea30714Config {
    private String name = "idea_030714";
 ...
 */
@Slf4j
public class Idea30714Service {
    private static final int IDEA_ID = 30714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30714Service() {
        this(new Idea30714Config());
    }

    public Idea30714Service(Idea30714Config config) {
        this.config = config != null ? config : new Idea30714Config();
