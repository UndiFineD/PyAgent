...
@Data
public class Idea30588Config {
    private String name = "idea_030588";
 ...
 */
@Slf4j
public class Idea30588Service {
    private static final int IDEA_ID = 30588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30588Service() {
        this(new Idea30588Config());
    }

    public Idea30588Service(Idea30588Config config) {
        this.config = config != null ? config : new Idea30588Config();
