...
@Data
public class Idea30407Config {
    private String name = "idea_030407";
 ...
 */
@Slf4j
public class Idea30407Service {
    private static final int IDEA_ID = 30407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30407Service() {
        this(new Idea30407Config());
    }

    public Idea30407Service(Idea30407Config config) {
        this.config = config != null ? config : new Idea30407Config();
