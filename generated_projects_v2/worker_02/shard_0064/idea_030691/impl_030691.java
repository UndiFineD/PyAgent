...
@Data
public class Idea30691Config {
    private String name = "idea_030691";
 ...
 */
@Slf4j
public class Idea30691Service {
    private static final int IDEA_ID = 30691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30691Service() {
        this(new Idea30691Config());
    }

    public Idea30691Service(Idea30691Config config) {
        this.config = config != null ? config : new Idea30691Config();
