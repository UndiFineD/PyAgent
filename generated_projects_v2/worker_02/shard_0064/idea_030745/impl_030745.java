...
@Data
public class Idea30745Config {
    private String name = "idea_030745";
 ...
 */
@Slf4j
public class Idea30745Service {
    private static final int IDEA_ID = 30745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30745Service() {
        this(new Idea30745Config());
    }

    public Idea30745Service(Idea30745Config config) {
        this.config = config != null ? config : new Idea30745Config();
