...
@Data
public class Idea30405Config {
    private String name = "idea_030405";
 ...
 */
@Slf4j
public class Idea30405Service {
    private static final int IDEA_ID = 30405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30405Service() {
        this(new Idea30405Config());
    }

    public Idea30405Service(Idea30405Config config) {
        this.config = config != null ? config : new Idea30405Config();
