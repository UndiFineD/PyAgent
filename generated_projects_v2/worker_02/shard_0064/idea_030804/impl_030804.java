...
@Data
public class Idea30804Config {
    private String name = "idea_030804";
 ...
 */
@Slf4j
public class Idea30804Service {
    private static final int IDEA_ID = 30804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30804Service() {
        this(new Idea30804Config());
    }

    public Idea30804Service(Idea30804Config config) {
        this.config = config != null ? config : new Idea30804Config();
