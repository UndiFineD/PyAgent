...
@Data
public class Idea30587Config {
    private String name = "idea_030587";
 ...
 */
@Slf4j
public class Idea30587Service {
    private static final int IDEA_ID = 30587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30587Service() {
        this(new Idea30587Config());
    }

    public Idea30587Service(Idea30587Config config) {
        this.config = config != null ? config : new Idea30587Config();
