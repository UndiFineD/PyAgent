...
@Data
public class Idea30701Config {
    private String name = "idea_030701";
 ...
 */
@Slf4j
public class Idea30701Service {
    private static final int IDEA_ID = 30701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30701Service() {
        this(new Idea30701Config());
    }

    public Idea30701Service(Idea30701Config config) {
        this.config = config != null ? config : new Idea30701Config();
