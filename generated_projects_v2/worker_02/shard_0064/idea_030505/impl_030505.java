...
@Data
public class Idea30505Config {
    private String name = "idea_030505";
 ...
 */
@Slf4j
public class Idea30505Service {
    private static final int IDEA_ID = 30505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30505Service() {
        this(new Idea30505Config());
    }

    public Idea30505Service(Idea30505Config config) {
        this.config = config != null ? config : new Idea30505Config();
