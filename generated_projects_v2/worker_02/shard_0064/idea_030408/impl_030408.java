...
@Data
public class Idea30408Config {
    private String name = "idea_030408";
 ...
 */
@Slf4j
public class Idea30408Service {
    private static final int IDEA_ID = 30408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30408Service() {
        this(new Idea30408Config());
    }

    public Idea30408Service(Idea30408Config config) {
        this.config = config != null ? config : new Idea30408Config();
