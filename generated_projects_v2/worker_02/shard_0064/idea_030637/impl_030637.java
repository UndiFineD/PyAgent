...
@Data
public class Idea30637Config {
    private String name = "idea_030637";
 ...
 */
@Slf4j
public class Idea30637Service {
    private static final int IDEA_ID = 30637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30637Service() {
        this(new Idea30637Config());
    }

    public Idea30637Service(Idea30637Config config) {
        this.config = config != null ? config : new Idea30637Config();
