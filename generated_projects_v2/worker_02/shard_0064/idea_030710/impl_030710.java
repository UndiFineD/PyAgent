...
@Data
public class Idea30710Config {
    private String name = "idea_030710";
 ...
 */
@Slf4j
public class Idea30710Service {
    private static final int IDEA_ID = 30710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30710Service() {
        this(new Idea30710Config());
    }

    public Idea30710Service(Idea30710Config config) {
        this.config = config != null ? config : new Idea30710Config();
