...
@Data
public class Idea30541Config {
    private String name = "idea_030541";
 ...
 */
@Slf4j
public class Idea30541Service {
    private static final int IDEA_ID = 30541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30541Service() {
        this(new Idea30541Config());
    }

    public Idea30541Service(Idea30541Config config) {
        this.config = config != null ? config : new Idea30541Config();
