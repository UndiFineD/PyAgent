...
@Data
public class Idea30421Config {
    private String name = "idea_030421";
 ...
 */
@Slf4j
public class Idea30421Service {
    private static final int IDEA_ID = 30421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30421Service() {
        this(new Idea30421Config());
    }

    public Idea30421Service(Idea30421Config config) {
        this.config = config != null ? config : new Idea30421Config();
