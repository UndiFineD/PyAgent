...
@Data
public class Idea30824Config {
    private String name = "idea_030824";
 ...
 */
@Slf4j
public class Idea30824Service {
    private static final int IDEA_ID = 30824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30824Service() {
        this(new Idea30824Config());
    }

    public Idea30824Service(Idea30824Config config) {
        this.config = config != null ? config : new Idea30824Config();
