...
@Data
public class Idea30784Config {
    private String name = "idea_030784";
 ...
 */
@Slf4j
public class Idea30784Service {
    private static final int IDEA_ID = 30784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30784Service() {
        this(new Idea30784Config());
    }

    public Idea30784Service(Idea30784Config config) {
        this.config = config != null ? config : new Idea30784Config();
