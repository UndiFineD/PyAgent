...
@Data
public class Idea30771Config {
    private String name = "idea_030771";
 ...
 */
@Slf4j
public class Idea30771Service {
    private static final int IDEA_ID = 30771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30771Service() {
        this(new Idea30771Config());
    }

    public Idea30771Service(Idea30771Config config) {
        this.config = config != null ? config : new Idea30771Config();
