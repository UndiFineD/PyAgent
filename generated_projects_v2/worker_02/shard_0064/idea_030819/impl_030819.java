...
@Data
public class Idea30819Config {
    private String name = "idea_030819";
 ...
 */
@Slf4j
public class Idea30819Service {
    private static final int IDEA_ID = 30819;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30819Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30819Service() {
        this(new Idea30819Config());
    }

    public Idea30819Service(Idea30819Config config) {
        this.config = config != null ? config : new Idea30819Config();
