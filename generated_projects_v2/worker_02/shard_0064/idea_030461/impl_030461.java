...
@Data
public class Idea30461Config {
    private String name = "idea_030461";
 ...
 */
@Slf4j
public class Idea30461Service {
    private static final int IDEA_ID = 30461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea30461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea30461Service() {
        this(new Idea30461Config());
    }

    public Idea30461Service(Idea30461Config config) {
        this.config = config != null ? config : new Idea30461Config();
