...
@Data
public class Idea32723Config {
    private String name = "idea_032723";
 ...
 */
@Slf4j
public class Idea32723Service {
    private static final int IDEA_ID = 32723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32723Service() {
        this(new Idea32723Config());
    }

    public Idea32723Service(Idea32723Config config) {
        this.config = config != null ? config : new Idea32723Config();
