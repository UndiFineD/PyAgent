...
@Data
public class Idea32567Config {
    private String name = "idea_032567";
 ...
 */
@Slf4j
public class Idea32567Service {
    private static final int IDEA_ID = 32567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32567Service() {
        this(new Idea32567Config());
    }

    public Idea32567Service(Idea32567Config config) {
        this.config = config != null ? config : new Idea32567Config();
