...
@Data
public class Idea32743Config {
    private String name = "idea_032743";
 ...
 */
@Slf4j
public class Idea32743Service {
    private static final int IDEA_ID = 32743;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32743Service() {
        this(new Idea32743Config());
    }

    public Idea32743Service(Idea32743Config config) {
        this.config = config != null ? config : new Idea32743Config();
