...
@Data
public class Idea32327Config {
    private String name = "idea_032327";
 ...
 */
@Slf4j
public class Idea32327Service {
    private static final int IDEA_ID = 32327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32327Service() {
        this(new Idea32327Config());
    }

    public Idea32327Service(Idea32327Config config) {
        this.config = config != null ? config : new Idea32327Config();
