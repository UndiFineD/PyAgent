...
@Data
public class Idea32547Config {
    private String name = "idea_032547";
 ...
 */
@Slf4j
public class Idea32547Service {
    private static final int IDEA_ID = 32547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32547Service() {
        this(new Idea32547Config());
    }

    public Idea32547Service(Idea32547Config config) {
        this.config = config != null ? config : new Idea32547Config();
