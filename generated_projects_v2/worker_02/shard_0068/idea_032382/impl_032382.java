...
@Data
public class Idea32382Config {
    private String name = "idea_032382";
 ...
 */
@Slf4j
public class Idea32382Service {
    private static final int IDEA_ID = 32382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32382Service() {
        this(new Idea32382Config());
    }

    public Idea32382Service(Idea32382Config config) {
        this.config = config != null ? config : new Idea32382Config();
