...
@Data
public class Idea32508Config {
    private String name = "idea_032508";
 ...
 */
@Slf4j
public class Idea32508Service {
    private static final int IDEA_ID = 32508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32508Service() {
        this(new Idea32508Config());
    }

    public Idea32508Service(Idea32508Config config) {
        this.config = config != null ? config : new Idea32508Config();
