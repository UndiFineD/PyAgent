...
@Data
public class Idea32316Config {
    private String name = "idea_032316";
 ...
 */
@Slf4j
public class Idea32316Service {
    private static final int IDEA_ID = 32316;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32316Service() {
        this(new Idea32316Config());
    }

    public Idea32316Service(Idea32316Config config) {
        this.config = config != null ? config : new Idea32316Config();
