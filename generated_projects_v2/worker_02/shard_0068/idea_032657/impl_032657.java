...
@Data
public class Idea32657Config {
    private String name = "idea_032657";
 ...
 */
@Slf4j
public class Idea32657Service {
    private static final int IDEA_ID = 32657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32657Service() {
        this(new Idea32657Config());
    }

    public Idea32657Service(Idea32657Config config) {
        this.config = config != null ? config : new Idea32657Config();
