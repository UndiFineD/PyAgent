...
@Data
public class Idea32326Config {
    private String name = "idea_032326";
 ...
 */
@Slf4j
public class Idea32326Service {
    private static final int IDEA_ID = 32326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32326Service() {
        this(new Idea32326Config());
    }

    public Idea32326Service(Idea32326Config config) {
        this.config = config != null ? config : new Idea32326Config();
