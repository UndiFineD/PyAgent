...
@Data
public class Idea32498Config {
    private String name = "idea_032498";
 ...
 */
@Slf4j
public class Idea32498Service {
    private static final int IDEA_ID = 32498;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32498Service() {
        this(new Idea32498Config());
    }

    public Idea32498Service(Idea32498Config config) {
        this.config = config != null ? config : new Idea32498Config();
