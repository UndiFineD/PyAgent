...
@Data
public class Idea32601Config {
    private String name = "idea_032601";
 ...
 */
@Slf4j
public class Idea32601Service {
    private static final int IDEA_ID = 32601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32601Service() {
        this(new Idea32601Config());
    }

    public Idea32601Service(Idea32601Config config) {
        this.config = config != null ? config : new Idea32601Config();
