...
@Data
public class Idea32583Config {
    private String name = "idea_032583";
 ...
 */
@Slf4j
public class Idea32583Service {
    private static final int IDEA_ID = 32583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32583Service() {
        this(new Idea32583Config());
    }

    public Idea32583Service(Idea32583Config config) {
        this.config = config != null ? config : new Idea32583Config();
