...
@Data
public class Idea32767Config {
    private String name = "idea_032767";
 ...
 */
@Slf4j
public class Idea32767Service {
    private static final int IDEA_ID = 32767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32767Service() {
        this(new Idea32767Config());
    }

    public Idea32767Service(Idea32767Config config) {
        this.config = config != null ? config : new Idea32767Config();
