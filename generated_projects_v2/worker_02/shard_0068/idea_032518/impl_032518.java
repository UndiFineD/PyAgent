...
@Data
public class Idea32518Config {
    private String name = "idea_032518";
 ...
 */
@Slf4j
public class Idea32518Service {
    private static final int IDEA_ID = 32518;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32518Service() {
        this(new Idea32518Config());
    }

    public Idea32518Service(Idea32518Config config) {
        this.config = config != null ? config : new Idea32518Config();
