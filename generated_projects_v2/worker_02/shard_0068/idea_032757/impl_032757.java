...
@Data
public class Idea32757Config {
    private String name = "idea_032757";
 ...
 */
@Slf4j
public class Idea32757Service {
    private static final int IDEA_ID = 32757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32757Service() {
        this(new Idea32757Config());
    }

    public Idea32757Service(Idea32757Config config) {
        this.config = config != null ? config : new Idea32757Config();
