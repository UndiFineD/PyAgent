...
@Data
public class Idea32472Config {
    private String name = "idea_032472";
 ...
 */
@Slf4j
public class Idea32472Service {
    private static final int IDEA_ID = 32472;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32472Service() {
        this(new Idea32472Config());
    }

    public Idea32472Service(Idea32472Config config) {
        this.config = config != null ? config : new Idea32472Config();
