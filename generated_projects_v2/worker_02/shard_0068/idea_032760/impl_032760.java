...
@Data
public class Idea32760Config {
    private String name = "idea_032760";
 ...
 */
@Slf4j
public class Idea32760Service {
    private static final int IDEA_ID = 32760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32760Service() {
        this(new Idea32760Config());
    }

    public Idea32760Service(Idea32760Config config) {
        this.config = config != null ? config : new Idea32760Config();
