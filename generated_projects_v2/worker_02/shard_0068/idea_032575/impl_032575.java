...
@Data
public class Idea32575Config {
    private String name = "idea_032575";
 ...
 */
@Slf4j
public class Idea32575Service {
    private static final int IDEA_ID = 32575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32575Service() {
        this(new Idea32575Config());
    }

    public Idea32575Service(Idea32575Config config) {
        this.config = config != null ? config : new Idea32575Config();
