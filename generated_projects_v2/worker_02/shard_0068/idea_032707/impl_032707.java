...
@Data
public class Idea32707Config {
    private String name = "idea_032707";
 ...
 */
@Slf4j
public class Idea32707Service {
    private static final int IDEA_ID = 32707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32707Service() {
        this(new Idea32707Config());
    }

    public Idea32707Service(Idea32707Config config) {
        this.config = config != null ? config : new Idea32707Config();
