...
@Data
public class Idea32630Config {
    private String name = "idea_032630";
 ...
 */
@Slf4j
public class Idea32630Service {
    private static final int IDEA_ID = 32630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32630Service() {
        this(new Idea32630Config());
    }

    public Idea32630Service(Idea32630Config config) {
        this.config = config != null ? config : new Idea32630Config();
