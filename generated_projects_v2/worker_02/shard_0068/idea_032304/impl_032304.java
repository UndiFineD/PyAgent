...
@Data
public class Idea32304Config {
    private String name = "idea_032304";
 ...
 */
@Slf4j
public class Idea32304Service {
    private static final int IDEA_ID = 32304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32304Service() {
        this(new Idea32304Config());
    }

    public Idea32304Service(Idea32304Config config) {
        this.config = config != null ? config : new Idea32304Config();
