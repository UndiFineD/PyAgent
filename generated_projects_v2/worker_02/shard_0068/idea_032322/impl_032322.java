...
@Data
public class Idea32322Config {
    private String name = "idea_032322";
 ...
 */
@Slf4j
public class Idea32322Service {
    private static final int IDEA_ID = 32322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32322Service() {
        this(new Idea32322Config());
    }

    public Idea32322Service(Idea32322Config config) {
        this.config = config != null ? config : new Idea32322Config();
