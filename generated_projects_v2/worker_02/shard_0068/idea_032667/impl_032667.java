...
@Data
public class Idea32667Config {
    private String name = "idea_032667";
 ...
 */
@Slf4j
public class Idea32667Service {
    private static final int IDEA_ID = 32667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32667Service() {
        this(new Idea32667Config());
    }

    public Idea32667Service(Idea32667Config config) {
        this.config = config != null ? config : new Idea32667Config();
