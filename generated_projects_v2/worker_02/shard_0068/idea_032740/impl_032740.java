...
@Data
public class Idea32740Config {
    private String name = "idea_032740";
 ...
 */
@Slf4j
public class Idea32740Service {
    private static final int IDEA_ID = 32740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32740Service() {
        this(new Idea32740Config());
    }

    public Idea32740Service(Idea32740Config config) {
        this.config = config != null ? config : new Idea32740Config();
