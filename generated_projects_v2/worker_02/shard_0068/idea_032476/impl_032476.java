...
@Data
public class Idea32476Config {
    private String name = "idea_032476";
 ...
 */
@Slf4j
public class Idea32476Service {
    private static final int IDEA_ID = 32476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32476Service() {
        this(new Idea32476Config());
    }

    public Idea32476Service(Idea32476Config config) {
        this.config = config != null ? config : new Idea32476Config();
