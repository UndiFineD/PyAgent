...
@Data
public class Idea32648Config {
    private String name = "idea_032648";
 ...
 */
@Slf4j
public class Idea32648Service {
    private static final int IDEA_ID = 32648;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32648Service() {
        this(new Idea32648Config());
    }

    public Idea32648Service(Idea32648Config config) {
        this.config = config != null ? config : new Idea32648Config();
