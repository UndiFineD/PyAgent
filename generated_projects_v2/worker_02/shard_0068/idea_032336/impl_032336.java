...
@Data
public class Idea32336Config {
    private String name = "idea_032336";
 ...
 */
@Slf4j
public class Idea32336Service {
    private static final int IDEA_ID = 32336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32336Service() {
        this(new Idea32336Config());
    }

    public Idea32336Service(Idea32336Config config) {
        this.config = config != null ? config : new Idea32336Config();
