...
@Data
public class Idea32553Config {
    private String name = "idea_032553";
 ...
 */
@Slf4j
public class Idea32553Service {
    private static final int IDEA_ID = 32553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32553Service() {
        this(new Idea32553Config());
    }

    public Idea32553Service(Idea32553Config config) {
        this.config = config != null ? config : new Idea32553Config();
