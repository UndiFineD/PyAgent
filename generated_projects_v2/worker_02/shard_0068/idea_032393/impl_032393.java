...
@Data
public class Idea32393Config {
    private String name = "idea_032393";
 ...
 */
@Slf4j
public class Idea32393Service {
    private static final int IDEA_ID = 32393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32393Service() {
        this(new Idea32393Config());
    }

    public Idea32393Service(Idea32393Config config) {
        this.config = config != null ? config : new Idea32393Config();
