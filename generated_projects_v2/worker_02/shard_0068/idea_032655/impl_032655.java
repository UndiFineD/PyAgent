...
@Data
public class Idea32655Config {
    private String name = "idea_032655";
 ...
 */
@Slf4j
public class Idea32655Service {
    private static final int IDEA_ID = 32655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32655Service() {
        this(new Idea32655Config());
    }

    public Idea32655Service(Idea32655Config config) {
        this.config = config != null ? config : new Idea32655Config();
