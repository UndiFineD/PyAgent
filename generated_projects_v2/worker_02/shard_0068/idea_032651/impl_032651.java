...
@Data
public class Idea32651Config {
    private String name = "idea_032651";
 ...
 */
@Slf4j
public class Idea32651Service {
    private static final int IDEA_ID = 32651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32651Service() {
        this(new Idea32651Config());
    }

    public Idea32651Service(Idea32651Config config) {
        this.config = config != null ? config : new Idea32651Config();
