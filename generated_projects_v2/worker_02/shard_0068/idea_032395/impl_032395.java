...
@Data
public class Idea32395Config {
    private String name = "idea_032395";
 ...
 */
@Slf4j
public class Idea32395Service {
    private static final int IDEA_ID = 32395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32395Service() {
        this(new Idea32395Config());
    }

    public Idea32395Service(Idea32395Config config) {
        this.config = config != null ? config : new Idea32395Config();
