...
@Data
public class Idea32377Config {
    private String name = "idea_032377";
 ...
 */
@Slf4j
public class Idea32377Service {
    private static final int IDEA_ID = 32377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32377Service() {
        this(new Idea32377Config());
    }

    public Idea32377Service(Idea32377Config config) {
        this.config = config != null ? config : new Idea32377Config();
