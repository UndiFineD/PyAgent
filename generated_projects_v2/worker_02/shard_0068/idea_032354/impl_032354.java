...
@Data
public class Idea32354Config {
    private String name = "idea_032354";
 ...
 */
@Slf4j
public class Idea32354Service {
    private static final int IDEA_ID = 32354;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32354Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32354Service() {
        this(new Idea32354Config());
    }

    public Idea32354Service(Idea32354Config config) {
        this.config = config != null ? config : new Idea32354Config();
