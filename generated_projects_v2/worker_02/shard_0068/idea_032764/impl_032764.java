...
@Data
public class Idea32764Config {
    private String name = "idea_032764";
 ...
 */
@Slf4j
public class Idea32764Service {
    private static final int IDEA_ID = 32764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32764Service() {
        this(new Idea32764Config());
    }

    public Idea32764Service(Idea32764Config config) {
        this.config = config != null ? config : new Idea32764Config();
