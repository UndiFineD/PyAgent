...
@Data
public class Idea32661Config {
    private String name = "idea_032661";
 ...
 */
@Slf4j
public class Idea32661Service {
    private static final int IDEA_ID = 32661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32661Service() {
        this(new Idea32661Config());
    }

    public Idea32661Service(Idea32661Config config) {
        this.config = config != null ? config : new Idea32661Config();
