...
@Data
public class Idea32503Config {
    private String name = "idea_032503";
 ...
 */
@Slf4j
public class Idea32503Service {
    private static final int IDEA_ID = 32503;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32503Service() {
        this(new Idea32503Config());
    }

    public Idea32503Service(Idea32503Config config) {
        this.config = config != null ? config : new Idea32503Config();
