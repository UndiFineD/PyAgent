...
@Data
public class Idea32621Config {
    private String name = "idea_032621";
 ...
 */
@Slf4j
public class Idea32621Service {
    private static final int IDEA_ID = 32621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32621Service() {
        this(new Idea32621Config());
    }

    public Idea32621Service(Idea32621Config config) {
        this.config = config != null ? config : new Idea32621Config();
