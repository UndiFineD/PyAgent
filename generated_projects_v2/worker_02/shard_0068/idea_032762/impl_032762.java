...
@Data
public class Idea32762Config {
    private String name = "idea_032762";
 ...
 */
@Slf4j
public class Idea32762Service {
    private static final int IDEA_ID = 32762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32762Service() {
        this(new Idea32762Config());
    }

    public Idea32762Service(Idea32762Config config) {
        this.config = config != null ? config : new Idea32762Config();
