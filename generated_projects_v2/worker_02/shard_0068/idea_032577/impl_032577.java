...
@Data
public class Idea32577Config {
    private String name = "idea_032577";
 ...
 */
@Slf4j
public class Idea32577Service {
    private static final int IDEA_ID = 32577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32577Service() {
        this(new Idea32577Config());
    }

    public Idea32577Service(Idea32577Config config) {
        this.config = config != null ? config : new Idea32577Config();
