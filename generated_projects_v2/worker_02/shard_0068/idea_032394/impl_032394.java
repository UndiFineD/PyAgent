...
@Data
public class Idea32394Config {
    private String name = "idea_032394";
 ...
 */
@Slf4j
public class Idea32394Service {
    private static final int IDEA_ID = 32394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32394Service() {
        this(new Idea32394Config());
    }

    public Idea32394Service(Idea32394Config config) {
        this.config = config != null ? config : new Idea32394Config();
