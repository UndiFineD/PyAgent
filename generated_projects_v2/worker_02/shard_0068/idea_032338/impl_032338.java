...
@Data
public class Idea32338Config {
    private String name = "idea_032338";
 ...
 */
@Slf4j
public class Idea32338Service {
    private static final int IDEA_ID = 32338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32338Service() {
        this(new Idea32338Config());
    }

    public Idea32338Service(Idea32338Config config) {
        this.config = config != null ? config : new Idea32338Config();
