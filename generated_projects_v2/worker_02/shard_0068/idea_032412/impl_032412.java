...
@Data
public class Idea32412Config {
    private String name = "idea_032412";
 ...
 */
@Slf4j
public class Idea32412Service {
    private static final int IDEA_ID = 32412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32412Service() {
        this(new Idea32412Config());
    }

    public Idea32412Service(Idea32412Config config) {
        this.config = config != null ? config : new Idea32412Config();
