...
@Data
public class Idea32431Config {
    private String name = "idea_032431";
 ...
 */
@Slf4j
public class Idea32431Service {
    private static final int IDEA_ID = 32431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32431Service() {
        this(new Idea32431Config());
    }

    public Idea32431Service(Idea32431Config config) {
        this.config = config != null ? config : new Idea32431Config();
