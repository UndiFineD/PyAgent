...
@Data
public class Idea32678Config {
    private String name = "idea_032678";
 ...
 */
@Slf4j
public class Idea32678Service {
    private static final int IDEA_ID = 32678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32678Service() {
        this(new Idea32678Config());
    }

    public Idea32678Service(Idea32678Config config) {
        this.config = config != null ? config : new Idea32678Config();
