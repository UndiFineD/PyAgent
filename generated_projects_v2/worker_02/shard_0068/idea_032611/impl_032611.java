...
@Data
public class Idea32611Config {
    private String name = "idea_032611";
 ...
 */
@Slf4j
public class Idea32611Service {
    private static final int IDEA_ID = 32611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32611Service() {
        this(new Idea32611Config());
    }

    public Idea32611Service(Idea32611Config config) {
        this.config = config != null ? config : new Idea32611Config();
