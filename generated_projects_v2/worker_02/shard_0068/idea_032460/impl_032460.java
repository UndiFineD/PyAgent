...
@Data
public class Idea32460Config {
    private String name = "idea_032460";
 ...
 */
@Slf4j
public class Idea32460Service {
    private static final int IDEA_ID = 32460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32460Service() {
        this(new Idea32460Config());
    }

    public Idea32460Service(Idea32460Config config) {
        this.config = config != null ? config : new Idea32460Config();
