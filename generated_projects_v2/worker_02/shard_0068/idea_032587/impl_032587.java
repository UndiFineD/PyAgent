...
@Data
public class Idea32587Config {
    private String name = "idea_032587";
 ...
 */
@Slf4j
public class Idea32587Service {
    private static final int IDEA_ID = 32587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32587Service() {
        this(new Idea32587Config());
    }

    public Idea32587Service(Idea32587Config config) {
        this.config = config != null ? config : new Idea32587Config();
