...
@Data
public class Idea32608Config {
    private String name = "idea_032608";
 ...
 */
@Slf4j
public class Idea32608Service {
    private static final int IDEA_ID = 32608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32608Service() {
        this(new Idea32608Config());
    }

    public Idea32608Service(Idea32608Config config) {
        this.config = config != null ? config : new Idea32608Config();
