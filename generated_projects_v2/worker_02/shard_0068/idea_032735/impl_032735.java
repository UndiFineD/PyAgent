...
@Data
public class Idea32735Config {
    private String name = "idea_032735";
 ...
 */
@Slf4j
public class Idea32735Service {
    private static final int IDEA_ID = 32735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32735Service() {
        this(new Idea32735Config());
    }

    public Idea32735Service(Idea32735Config config) {
        this.config = config != null ? config : new Idea32735Config();
