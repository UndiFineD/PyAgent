...
@Data
public class Idea32507Config {
    private String name = "idea_032507";
 ...
 */
@Slf4j
public class Idea32507Service {
    private static final int IDEA_ID = 32507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32507Service() {
        this(new Idea32507Config());
    }

    public Idea32507Service(Idea32507Config config) {
        this.config = config != null ? config : new Idea32507Config();
