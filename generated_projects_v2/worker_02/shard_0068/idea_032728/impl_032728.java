...
@Data
public class Idea32728Config {
    private String name = "idea_032728";
 ...
 */
@Slf4j
public class Idea32728Service {
    private static final int IDEA_ID = 32728;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32728Service() {
        this(new Idea32728Config());
    }

    public Idea32728Service(Idea32728Config config) {
        this.config = config != null ? config : new Idea32728Config();
