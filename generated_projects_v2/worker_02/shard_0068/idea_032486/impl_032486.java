...
@Data
public class Idea32486Config {
    private String name = "idea_032486";
 ...
 */
@Slf4j
public class Idea32486Service {
    private static final int IDEA_ID = 32486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32486Service() {
        this(new Idea32486Config());
    }

    public Idea32486Service(Idea32486Config config) {
        this.config = config != null ? config : new Idea32486Config();
