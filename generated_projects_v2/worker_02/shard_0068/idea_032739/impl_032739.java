...
@Data
public class Idea32739Config {
    private String name = "idea_032739";
 ...
 */
@Slf4j
public class Idea32739Service {
    private static final int IDEA_ID = 32739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32739Service() {
        this(new Idea32739Config());
    }

    public Idea32739Service(Idea32739Config config) {
        this.config = config != null ? config : new Idea32739Config();
