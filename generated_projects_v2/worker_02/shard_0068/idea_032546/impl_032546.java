...
@Data
public class Idea32546Config {
    private String name = "idea_032546";
 ...
 */
@Slf4j
public class Idea32546Service {
    private static final int IDEA_ID = 32546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32546Service() {
        this(new Idea32546Config());
    }

    public Idea32546Service(Idea32546Config config) {
        this.config = config != null ? config : new Idea32546Config();
