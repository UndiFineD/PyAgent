...
@Data
public class Idea32565Config {
    private String name = "idea_032565";
 ...
 */
@Slf4j
public class Idea32565Service {
    private static final int IDEA_ID = 32565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32565Service() {
        this(new Idea32565Config());
    }

    public Idea32565Service(Idea32565Config config) {
        this.config = config != null ? config : new Idea32565Config();
