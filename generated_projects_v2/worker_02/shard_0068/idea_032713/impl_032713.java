...
@Data
public class Idea32713Config {
    private String name = "idea_032713";
 ...
 */
@Slf4j
public class Idea32713Service {
    private static final int IDEA_ID = 32713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32713Service() {
        this(new Idea32713Config());
    }

    public Idea32713Service(Idea32713Config config) {
        this.config = config != null ? config : new Idea32713Config();
