...
@Data
public class Idea32665Config {
    private String name = "idea_032665";
 ...
 */
@Slf4j
public class Idea32665Service {
    private static final int IDEA_ID = 32665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32665Service() {
        this(new Idea32665Config());
    }

    public Idea32665Service(Idea32665Config config) {
        this.config = config != null ? config : new Idea32665Config();
