...
@Data
public class Idea32541Config {
    private String name = "idea_032541";
 ...
 */
@Slf4j
public class Idea32541Service {
    private static final int IDEA_ID = 32541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32541Service() {
        this(new Idea32541Config());
    }

    public Idea32541Service(Idea32541Config config) {
        this.config = config != null ? config : new Idea32541Config();
