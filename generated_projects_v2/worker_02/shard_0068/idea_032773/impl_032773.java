...
@Data
public class Idea32773Config {
    private String name = "idea_032773";
 ...
 */
@Slf4j
public class Idea32773Service {
    private static final int IDEA_ID = 32773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32773Service() {
        this(new Idea32773Config());
    }

    public Idea32773Service(Idea32773Config config) {
        this.config = config != null ? config : new Idea32773Config();
