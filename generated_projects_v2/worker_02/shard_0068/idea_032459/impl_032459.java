...
@Data
public class Idea32459Config {
    private String name = "idea_032459";
 ...
 */
@Slf4j
public class Idea32459Service {
    private static final int IDEA_ID = 32459;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32459Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32459Service() {
        this(new Idea32459Config());
    }

    public Idea32459Service(Idea32459Config config) {
        this.config = config != null ? config : new Idea32459Config();
