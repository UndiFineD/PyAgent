...
@Data
public class Idea32727Config {
    private String name = "idea_032727";
 ...
 */
@Slf4j
public class Idea32727Service {
    private static final int IDEA_ID = 32727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32727Service() {
        this(new Idea32727Config());
    }

    public Idea32727Service(Idea32727Config config) {
        this.config = config != null ? config : new Idea32727Config();
