...
@Data
public class Idea32370Config {
    private String name = "idea_032370";
 ...
 */
@Slf4j
public class Idea32370Service {
    private static final int IDEA_ID = 32370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32370Service() {
        this(new Idea32370Config());
    }

    public Idea32370Service(Idea32370Config config) {
        this.config = config != null ? config : new Idea32370Config();
