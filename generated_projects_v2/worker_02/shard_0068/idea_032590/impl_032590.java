...
@Data
public class Idea32590Config {
    private String name = "idea_032590";
 ...
 */
@Slf4j
public class Idea32590Service {
    private static final int IDEA_ID = 32590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32590Service() {
        this(new Idea32590Config());
    }

    public Idea32590Service(Idea32590Config config) {
        this.config = config != null ? config : new Idea32590Config();
