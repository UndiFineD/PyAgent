...
@Data
public class Idea32574Config {
    private String name = "idea_032574";
 ...
 */
@Slf4j
public class Idea32574Service {
    private static final int IDEA_ID = 32574;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32574Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32574Service() {
        this(new Idea32574Config());
    }

    public Idea32574Service(Idea32574Config config) {
        this.config = config != null ? config : new Idea32574Config();
