...
@Data
public class Idea32474Config {
    private String name = "idea_032474";
 ...
 */
@Slf4j
public class Idea32474Service {
    private static final int IDEA_ID = 32474;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32474Service() {
        this(new Idea32474Config());
    }

    public Idea32474Service(Idea32474Config config) {
        this.config = config != null ? config : new Idea32474Config();
