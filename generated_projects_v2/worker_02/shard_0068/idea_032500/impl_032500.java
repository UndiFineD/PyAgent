...
@Data
public class Idea32500Config {
    private String name = "idea_032500";
 ...
 */
@Slf4j
public class Idea32500Service {
    private static final int IDEA_ID = 32500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32500Service() {
        this(new Idea32500Config());
    }

    public Idea32500Service(Idea32500Config config) {
        this.config = config != null ? config : new Idea32500Config();
