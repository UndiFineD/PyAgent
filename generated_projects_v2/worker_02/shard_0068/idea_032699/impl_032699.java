...
@Data
public class Idea32699Config {
    private String name = "idea_032699";
 ...
 */
@Slf4j
public class Idea32699Service {
    private static final int IDEA_ID = 32699;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32699Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32699Service() {
        this(new Idea32699Config());
    }

    public Idea32699Service(Idea32699Config config) {
        this.config = config != null ? config : new Idea32699Config();
