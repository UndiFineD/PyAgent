...
@Data
public class Idea32416Config {
    private String name = "idea_032416";
 ...
 */
@Slf4j
public class Idea32416Service {
    private static final int IDEA_ID = 32416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32416Service() {
        this(new Idea32416Config());
    }

    public Idea32416Service(Idea32416Config config) {
        this.config = config != null ? config : new Idea32416Config();
