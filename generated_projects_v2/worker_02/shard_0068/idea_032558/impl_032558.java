...
@Data
public class Idea32558Config {
    private String name = "idea_032558";
 ...
 */
@Slf4j
public class Idea32558Service {
    private static final int IDEA_ID = 32558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32558Service() {
        this(new Idea32558Config());
    }

    public Idea32558Service(Idea32558Config config) {
        this.config = config != null ? config : new Idea32558Config();
