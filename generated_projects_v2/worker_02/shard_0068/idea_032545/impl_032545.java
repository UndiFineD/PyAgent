...
@Data
public class Idea32545Config {
    private String name = "idea_032545";
 ...
 */
@Slf4j
public class Idea32545Service {
    private static final int IDEA_ID = 32545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32545Service() {
        this(new Idea32545Config());
    }

    public Idea32545Service(Idea32545Config config) {
        this.config = config != null ? config : new Idea32545Config();
