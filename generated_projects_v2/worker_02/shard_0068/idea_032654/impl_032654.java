...
@Data
public class Idea32654Config {
    private String name = "idea_032654";
 ...
 */
@Slf4j
public class Idea32654Service {
    private static final int IDEA_ID = 32654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32654Service() {
        this(new Idea32654Config());
    }

    public Idea32654Service(Idea32654Config config) {
        this.config = config != null ? config : new Idea32654Config();
