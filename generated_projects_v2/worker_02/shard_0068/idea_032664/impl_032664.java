...
@Data
public class Idea32664Config {
    private String name = "idea_032664";
 ...
 */
@Slf4j
public class Idea32664Service {
    private static final int IDEA_ID = 32664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32664Service() {
        this(new Idea32664Config());
    }

    public Idea32664Service(Idea32664Config config) {
        this.config = config != null ? config : new Idea32664Config();
