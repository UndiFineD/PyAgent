...
@Data
public class Idea32543Config {
    private String name = "idea_032543";
 ...
 */
@Slf4j
public class Idea32543Service {
    private static final int IDEA_ID = 32543;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32543Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32543Service() {
        this(new Idea32543Config());
    }

    public Idea32543Service(Idea32543Config config) {
        this.config = config != null ? config : new Idea32543Config();
