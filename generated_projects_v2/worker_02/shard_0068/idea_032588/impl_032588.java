...
@Data
public class Idea32588Config {
    private String name = "idea_032588";
 ...
 */
@Slf4j
public class Idea32588Service {
    private static final int IDEA_ID = 32588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32588Service() {
        this(new Idea32588Config());
    }

    public Idea32588Service(Idea32588Config config) {
        this.config = config != null ? config : new Idea32588Config();
