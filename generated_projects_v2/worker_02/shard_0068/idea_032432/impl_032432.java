...
@Data
public class Idea32432Config {
    private String name = "idea_032432";
 ...
 */
@Slf4j
public class Idea32432Service {
    private static final int IDEA_ID = 32432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32432Service() {
        this(new Idea32432Config());
    }

    public Idea32432Service(Idea32432Config config) {
        this.config = config != null ? config : new Idea32432Config();
