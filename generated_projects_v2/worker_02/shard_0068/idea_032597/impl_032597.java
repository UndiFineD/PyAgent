...
@Data
public class Idea32597Config {
    private String name = "idea_032597";
 ...
 */
@Slf4j
public class Idea32597Service {
    private static final int IDEA_ID = 32597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32597Service() {
        this(new Idea32597Config());
    }

    public Idea32597Service(Idea32597Config config) {
        this.config = config != null ? config : new Idea32597Config();
