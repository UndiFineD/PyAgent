...
@Data
public class Idea32495Config {
    private String name = "idea_032495";
 ...
 */
@Slf4j
public class Idea32495Service {
    private static final int IDEA_ID = 32495;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32495Service() {
        this(new Idea32495Config());
    }

    public Idea32495Service(Idea32495Config config) {
        this.config = config != null ? config : new Idea32495Config();
