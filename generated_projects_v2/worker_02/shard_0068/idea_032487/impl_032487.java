...
@Data
public class Idea32487Config {
    private String name = "idea_032487";
 ...
 */
@Slf4j
public class Idea32487Service {
    private static final int IDEA_ID = 32487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32487Service() {
        this(new Idea32487Config());
    }

    public Idea32487Service(Idea32487Config config) {
        this.config = config != null ? config : new Idea32487Config();
