...
@Data
public class Idea32730Config {
    private String name = "idea_032730";
 ...
 */
@Slf4j
public class Idea32730Service {
    private static final int IDEA_ID = 32730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32730Service() {
        this(new Idea32730Config());
    }

    public Idea32730Service(Idea32730Config config) {
        this.config = config != null ? config : new Idea32730Config();
