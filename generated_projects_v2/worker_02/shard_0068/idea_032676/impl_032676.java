...
@Data
public class Idea32676Config {
    private String name = "idea_032676";
 ...
 */
@Slf4j
public class Idea32676Service {
    private static final int IDEA_ID = 32676;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32676Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32676Service() {
        this(new Idea32676Config());
    }

    public Idea32676Service(Idea32676Config config) {
        this.config = config != null ? config : new Idea32676Config();
