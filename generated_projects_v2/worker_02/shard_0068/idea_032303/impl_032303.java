...
@Data
public class Idea32303Config {
    private String name = "idea_032303";
 ...
 */
@Slf4j
public class Idea32303Service {
    private static final int IDEA_ID = 32303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32303Service() {
        this(new Idea32303Config());
    }

    public Idea32303Service(Idea32303Config config) {
        this.config = config != null ? config : new Idea32303Config();
