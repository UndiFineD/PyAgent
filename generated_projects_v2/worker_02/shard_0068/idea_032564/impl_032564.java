...
@Data
public class Idea32564Config {
    private String name = "idea_032564";
 ...
 */
@Slf4j
public class Idea32564Service {
    private static final int IDEA_ID = 32564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32564Service() {
        this(new Idea32564Config());
    }

    public Idea32564Service(Idea32564Config config) {
        this.config = config != null ? config : new Idea32564Config();
