...
@Data
public class Idea32662Config {
    private String name = "idea_032662";
 ...
 */
@Slf4j
public class Idea32662Service {
    private static final int IDEA_ID = 32662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32662Service() {
        this(new Idea32662Config());
    }

    public Idea32662Service(Idea32662Config config) {
        this.config = config != null ? config : new Idea32662Config();
