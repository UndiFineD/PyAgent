...
@Data
public class Idea32423Config {
    private String name = "idea_032423";
 ...
 */
@Slf4j
public class Idea32423Service {
    private static final int IDEA_ID = 32423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32423Service() {
        this(new Idea32423Config());
    }

    public Idea32423Service(Idea32423Config config) {
        this.config = config != null ? config : new Idea32423Config();
