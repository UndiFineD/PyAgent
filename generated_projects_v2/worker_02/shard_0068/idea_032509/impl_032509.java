...
@Data
public class Idea32509Config {
    private String name = "idea_032509";
 ...
 */
@Slf4j
public class Idea32509Service {
    private static final int IDEA_ID = 32509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32509Service() {
        this(new Idea32509Config());
    }

    public Idea32509Service(Idea32509Config config) {
        this.config = config != null ? config : new Idea32509Config();
