...
@Data
public class Idea32528Config {
    private String name = "idea_032528";
 ...
 */
@Slf4j
public class Idea32528Service {
    private static final int IDEA_ID = 32528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32528Service() {
        this(new Idea32528Config());
    }

    public Idea32528Service(Idea32528Config config) {
        this.config = config != null ? config : new Idea32528Config();
