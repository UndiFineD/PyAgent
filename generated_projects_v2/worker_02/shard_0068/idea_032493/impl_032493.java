...
@Data
public class Idea32493Config {
    private String name = "idea_032493";
 ...
 */
@Slf4j
public class Idea32493Service {
    private static final int IDEA_ID = 32493;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32493Service() {
        this(new Idea32493Config());
    }

    public Idea32493Service(Idea32493Config config) {
        this.config = config != null ? config : new Idea32493Config();
