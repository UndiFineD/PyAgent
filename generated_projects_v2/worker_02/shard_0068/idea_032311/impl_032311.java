...
@Data
public class Idea32311Config {
    private String name = "idea_032311";
 ...
 */
@Slf4j
public class Idea32311Service {
    private static final int IDEA_ID = 32311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32311Service() {
        this(new Idea32311Config());
    }

    public Idea32311Service(Idea32311Config config) {
        this.config = config != null ? config : new Idea32311Config();
