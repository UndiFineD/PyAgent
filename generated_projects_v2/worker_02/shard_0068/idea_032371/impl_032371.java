...
@Data
public class Idea32371Config {
    private String name = "idea_032371";
 ...
 */
@Slf4j
public class Idea32371Service {
    private static final int IDEA_ID = 32371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32371Service() {
        this(new Idea32371Config());
    }

    public Idea32371Service(Idea32371Config config) {
        this.config = config != null ? config : new Idea32371Config();
