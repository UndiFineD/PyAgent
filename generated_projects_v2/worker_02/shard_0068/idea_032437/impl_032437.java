...
@Data
public class Idea32437Config {
    private String name = "idea_032437";
 ...
 */
@Slf4j
public class Idea32437Service {
    private static final int IDEA_ID = 32437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32437Service() {
        this(new Idea32437Config());
    }

    public Idea32437Service(Idea32437Config config) {
        this.config = config != null ? config : new Idea32437Config();
