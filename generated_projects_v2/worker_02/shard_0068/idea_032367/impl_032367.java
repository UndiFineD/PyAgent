...
@Data
public class Idea32367Config {
    private String name = "idea_032367";
 ...
 */
@Slf4j
public class Idea32367Service {
    private static final int IDEA_ID = 32367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32367Service() {
        this(new Idea32367Config());
    }

    public Idea32367Service(Idea32367Config config) {
        this.config = config != null ? config : new Idea32367Config();
