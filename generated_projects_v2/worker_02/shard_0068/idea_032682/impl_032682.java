...
@Data
public class Idea32682Config {
    private String name = "idea_032682";
 ...
 */
@Slf4j
public class Idea32682Service {
    private static final int IDEA_ID = 32682;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32682Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32682Service() {
        this(new Idea32682Config());
    }

    public Idea32682Service(Idea32682Config config) {
        this.config = config != null ? config : new Idea32682Config();
