...
@Data
public class Idea32373Config {
    private String name = "idea_032373";
 ...
 */
@Slf4j
public class Idea32373Service {
    private static final int IDEA_ID = 32373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32373Service() {
        this(new Idea32373Config());
    }

    public Idea32373Service(Idea32373Config config) {
        this.config = config != null ? config : new Idea32373Config();
