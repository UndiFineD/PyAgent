...
@Data
public class Idea32631Config {
    private String name = "idea_032631";
 ...
 */
@Slf4j
public class Idea32631Service {
    private static final int IDEA_ID = 32631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32631Service() {
        this(new Idea32631Config());
    }

    public Idea32631Service(Idea32631Config config) {
        this.config = config != null ? config : new Idea32631Config();
