...
@Data
public class Idea32512Config {
    private String name = "idea_032512";
 ...
 */
@Slf4j
public class Idea32512Service {
    private static final int IDEA_ID = 32512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32512Service() {
        this(new Idea32512Config());
    }

    public Idea32512Service(Idea32512Config config) {
        this.config = config != null ? config : new Idea32512Config();
