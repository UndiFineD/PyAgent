...
@Data
public class Idea32652Config {
    private String name = "idea_032652";
 ...
 */
@Slf4j
public class Idea32652Service {
    private static final int IDEA_ID = 32652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32652Service() {
        this(new Idea32652Config());
    }

    public Idea32652Service(Idea32652Config config) {
        this.config = config != null ? config : new Idea32652Config();
