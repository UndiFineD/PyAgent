...
@Data
public class Idea32677Config {
    private String name = "idea_032677";
 ...
 */
@Slf4j
public class Idea32677Service {
    private static final int IDEA_ID = 32677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32677Service() {
        this(new Idea32677Config());
    }

    public Idea32677Service(Idea32677Config config) {
        this.config = config != null ? config : new Idea32677Config();
