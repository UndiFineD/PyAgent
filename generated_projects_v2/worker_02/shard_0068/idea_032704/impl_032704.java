...
@Data
public class Idea32704Config {
    private String name = "idea_032704";
 ...
 */
@Slf4j
public class Idea32704Service {
    private static final int IDEA_ID = 32704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32704Service() {
        this(new Idea32704Config());
    }

    public Idea32704Service(Idea32704Config config) {
        this.config = config != null ? config : new Idea32704Config();
