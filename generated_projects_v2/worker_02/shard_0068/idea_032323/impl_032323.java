...
@Data
public class Idea32323Config {
    private String name = "idea_032323";
 ...
 */
@Slf4j
public class Idea32323Service {
    private static final int IDEA_ID = 32323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32323Service() {
        this(new Idea32323Config());
    }

    public Idea32323Service(Idea32323Config config) {
        this.config = config != null ? config : new Idea32323Config();
