...
@Data
public class Idea32301Config {
    private String name = "idea_032301";
 ...
 */
@Slf4j
public class Idea32301Service {
    private static final int IDEA_ID = 32301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32301Service() {
        this(new Idea32301Config());
    }

    public Idea32301Service(Idea32301Config config) {
        this.config = config != null ? config : new Idea32301Config();
