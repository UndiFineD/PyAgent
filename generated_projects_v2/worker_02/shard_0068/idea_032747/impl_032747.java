...
@Data
public class Idea32747Config {
    private String name = "idea_032747";
 ...
 */
@Slf4j
public class Idea32747Service {
    private static final int IDEA_ID = 32747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32747Service() {
        this(new Idea32747Config());
    }

    public Idea32747Service(Idea32747Config config) {
        this.config = config != null ? config : new Idea32747Config();
