...
@Data
public class Idea32559Config {
    private String name = "idea_032559";
 ...
 */
@Slf4j
public class Idea32559Service {
    private static final int IDEA_ID = 32559;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32559Service() {
        this(new Idea32559Config());
    }

    public Idea32559Service(Idea32559Config config) {
        this.config = config != null ? config : new Idea32559Config();
