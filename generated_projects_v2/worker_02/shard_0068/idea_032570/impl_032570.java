...
@Data
public class Idea32570Config {
    private String name = "idea_032570";
 ...
 */
@Slf4j
public class Idea32570Service {
    private static final int IDEA_ID = 32570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32570Service() {
        this(new Idea32570Config());
    }

    public Idea32570Service(Idea32570Config config) {
        this.config = config != null ? config : new Idea32570Config();
