...
@Data
public class Idea32360Config {
    private String name = "idea_032360";
 ...
 */
@Slf4j
public class Idea32360Service {
    private static final int IDEA_ID = 32360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32360Service() {
        this(new Idea32360Config());
    }

    public Idea32360Service(Idea32360Config config) {
        this.config = config != null ? config : new Idea32360Config();
