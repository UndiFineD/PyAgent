...
@Data
public class Idea32402Config {
    private String name = "idea_032402";
 ...
 */
@Slf4j
public class Idea32402Service {
    private static final int IDEA_ID = 32402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32402Service() {
        this(new Idea32402Config());
    }

    public Idea32402Service(Idea32402Config config) {
        this.config = config != null ? config : new Idea32402Config();
