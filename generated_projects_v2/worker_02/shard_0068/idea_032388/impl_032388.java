...
@Data
public class Idea32388Config {
    private String name = "idea_032388";
 ...
 */
@Slf4j
public class Idea32388Service {
    private static final int IDEA_ID = 32388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32388Service() {
        this(new Idea32388Config());
    }

    public Idea32388Service(Idea32388Config config) {
        this.config = config != null ? config : new Idea32388Config();
