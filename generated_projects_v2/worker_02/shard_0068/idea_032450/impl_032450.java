...
@Data
public class Idea32450Config {
    private String name = "idea_032450";
 ...
 */
@Slf4j
public class Idea32450Service {
    private static final int IDEA_ID = 32450;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32450Service() {
        this(new Idea32450Config());
    }

    public Idea32450Service(Idea32450Config config) {
        this.config = config != null ? config : new Idea32450Config();
