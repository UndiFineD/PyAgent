...
@Data
public class Idea32378Config {
    private String name = "idea_032378";
 ...
 */
@Slf4j
public class Idea32378Service {
    private static final int IDEA_ID = 32378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32378Service() {
        this(new Idea32378Config());
    }

    public Idea32378Service(Idea32378Config config) {
        this.config = config != null ? config : new Idea32378Config();
