...
@Data
public class Idea32376Config {
    private String name = "idea_032376";
 ...
 */
@Slf4j
public class Idea32376Service {
    private static final int IDEA_ID = 32376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32376Service() {
        this(new Idea32376Config());
    }

    public Idea32376Service(Idea32376Config config) {
        this.config = config != null ? config : new Idea32376Config();
