...
@Data
public class Idea32439Config {
    private String name = "idea_032439";
 ...
 */
@Slf4j
public class Idea32439Service {
    private static final int IDEA_ID = 32439;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32439Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32439Service() {
        this(new Idea32439Config());
    }

    public Idea32439Service(Idea32439Config config) {
        this.config = config != null ? config : new Idea32439Config();
