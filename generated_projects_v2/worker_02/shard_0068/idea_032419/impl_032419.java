...
@Data
public class Idea32419Config {
    private String name = "idea_032419";
 ...
 */
@Slf4j
public class Idea32419Service {
    private static final int IDEA_ID = 32419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32419Service() {
        this(new Idea32419Config());
    }

    public Idea32419Service(Idea32419Config config) {
        this.config = config != null ? config : new Idea32419Config();
