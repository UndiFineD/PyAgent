...
@Data
public class Idea32420Config {
    private String name = "idea_032420";
 ...
 */
@Slf4j
public class Idea32420Service {
    private static final int IDEA_ID = 32420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32420Service() {
        this(new Idea32420Config());
    }

    public Idea32420Service(Idea32420Config config) {
        this.config = config != null ? config : new Idea32420Config();
