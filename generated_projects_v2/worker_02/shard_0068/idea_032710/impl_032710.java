...
@Data
public class Idea32710Config {
    private String name = "idea_032710";
 ...
 */
@Slf4j
public class Idea32710Service {
    private static final int IDEA_ID = 32710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32710Service() {
        this(new Idea32710Config());
    }

    public Idea32710Service(Idea32710Config config) {
        this.config = config != null ? config : new Idea32710Config();
