...
@Data
public class Idea32406Config {
    private String name = "idea_032406";
 ...
 */
@Slf4j
public class Idea32406Service {
    private static final int IDEA_ID = 32406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32406Service() {
        this(new Idea32406Config());
    }

    public Idea32406Service(Idea32406Config config) {
        this.config = config != null ? config : new Idea32406Config();
