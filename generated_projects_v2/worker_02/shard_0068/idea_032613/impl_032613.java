...
@Data
public class Idea32613Config {
    private String name = "idea_032613";
 ...
 */
@Slf4j
public class Idea32613Service {
    private static final int IDEA_ID = 32613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32613Service() {
        this(new Idea32613Config());
    }

    public Idea32613Service(Idea32613Config config) {
        this.config = config != null ? config : new Idea32613Config();
