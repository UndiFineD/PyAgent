...
@Data
public class Idea32475Config {
    private String name = "idea_032475";
 ...
 */
@Slf4j
public class Idea32475Service {
    private static final int IDEA_ID = 32475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32475Service() {
        this(new Idea32475Config());
    }

    public Idea32475Service(Idea32475Config config) {
        this.config = config != null ? config : new Idea32475Config();
