...
@Data
public class Idea32471Config {
    private String name = "idea_032471";
 ...
 */
@Slf4j
public class Idea32471Service {
    private static final int IDEA_ID = 32471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32471Service() {
        this(new Idea32471Config());
    }

    public Idea32471Service(Idea32471Config config) {
        this.config = config != null ? config : new Idea32471Config();
