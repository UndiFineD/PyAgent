...
@Data
public class Idea32591Config {
    private String name = "idea_032591";
 ...
 */
@Slf4j
public class Idea32591Service {
    private static final int IDEA_ID = 32591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32591Service() {
        this(new Idea32591Config());
    }

    public Idea32591Service(Idea32591Config config) {
        this.config = config != null ? config : new Idea32591Config();
