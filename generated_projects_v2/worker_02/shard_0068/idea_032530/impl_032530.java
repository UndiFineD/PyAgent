...
@Data
public class Idea32530Config {
    private String name = "idea_032530";
 ...
 */
@Slf4j
public class Idea32530Service {
    private static final int IDEA_ID = 32530;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32530Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32530Service() {
        this(new Idea32530Config());
    }

    public Idea32530Service(Idea32530Config config) {
        this.config = config != null ? config : new Idea32530Config();
