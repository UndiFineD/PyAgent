...
@Data
public class Idea32329Config {
    private String name = "idea_032329";
 ...
 */
@Slf4j
public class Idea32329Service {
    private static final int IDEA_ID = 32329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32329Service() {
        this(new Idea32329Config());
    }

    public Idea32329Service(Idea32329Config config) {
        this.config = config != null ? config : new Idea32329Config();
