...
@Data
public class Idea32709Config {
    private String name = "idea_032709";
 ...
 */
@Slf4j
public class Idea32709Service {
    private static final int IDEA_ID = 32709;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32709Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32709Service() {
        this(new Idea32709Config());
    }

    public Idea32709Service(Idea32709Config config) {
        this.config = config != null ? config : new Idea32709Config();
