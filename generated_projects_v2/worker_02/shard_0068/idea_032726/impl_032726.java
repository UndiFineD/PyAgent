...
@Data
public class Idea32726Config {
    private String name = "idea_032726";
 ...
 */
@Slf4j
public class Idea32726Service {
    private static final int IDEA_ID = 32726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32726Service() {
        this(new Idea32726Config());
    }

    public Idea32726Service(Idea32726Config config) {
        this.config = config != null ? config : new Idea32726Config();
