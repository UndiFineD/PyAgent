...
@Data
public class Idea32352Config {
    private String name = "idea_032352";
 ...
 */
@Slf4j
public class Idea32352Service {
    private static final int IDEA_ID = 32352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32352Service() {
        this(new Idea32352Config());
    }

    public Idea32352Service(Idea32352Config config) {
        this.config = config != null ? config : new Idea32352Config();
