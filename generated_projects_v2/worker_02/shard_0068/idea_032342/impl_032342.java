...
@Data
public class Idea32342Config {
    private String name = "idea_032342";
 ...
 */
@Slf4j
public class Idea32342Service {
    private static final int IDEA_ID = 32342;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32342Service() {
        this(new Idea32342Config());
    }

    public Idea32342Service(Idea32342Config config) {
        this.config = config != null ? config : new Idea32342Config();
