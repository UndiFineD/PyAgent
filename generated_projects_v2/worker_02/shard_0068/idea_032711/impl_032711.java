...
@Data
public class Idea32711Config {
    private String name = "idea_032711";
 ...
 */
@Slf4j
public class Idea32711Service {
    private static final int IDEA_ID = 32711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32711Service() {
        this(new Idea32711Config());
    }

    public Idea32711Service(Idea32711Config config) {
        this.config = config != null ? config : new Idea32711Config();
