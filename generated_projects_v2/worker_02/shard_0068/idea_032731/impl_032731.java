...
@Data
public class Idea32731Config {
    private String name = "idea_032731";
 ...
 */
@Slf4j
public class Idea32731Service {
    private static final int IDEA_ID = 32731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32731Service() {
        this(new Idea32731Config());
    }

    public Idea32731Service(Idea32731Config config) {
        this.config = config != null ? config : new Idea32731Config();
