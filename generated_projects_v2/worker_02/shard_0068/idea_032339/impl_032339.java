...
@Data
public class Idea32339Config {
    private String name = "idea_032339";
 ...
 */
@Slf4j
public class Idea32339Service {
    private static final int IDEA_ID = 32339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32339Service() {
        this(new Idea32339Config());
    }

    public Idea32339Service(Idea32339Config config) {
        this.config = config != null ? config : new Idea32339Config();
