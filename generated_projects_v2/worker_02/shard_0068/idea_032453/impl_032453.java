...
@Data
public class Idea32453Config {
    private String name = "idea_032453";
 ...
 */
@Slf4j
public class Idea32453Service {
    private static final int IDEA_ID = 32453;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32453Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32453Service() {
        this(new Idea32453Config());
    }

    public Idea32453Service(Idea32453Config config) {
        this.config = config != null ? config : new Idea32453Config();
