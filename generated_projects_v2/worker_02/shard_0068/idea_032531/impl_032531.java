...
@Data
public class Idea32531Config {
    private String name = "idea_032531";
 ...
 */
@Slf4j
public class Idea32531Service {
    private static final int IDEA_ID = 32531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32531Service() {
        this(new Idea32531Config());
    }

    public Idea32531Service(Idea32531Config config) {
        this.config = config != null ? config : new Idea32531Config();
