...
@Data
public class Idea32496Config {
    private String name = "idea_032496";
 ...
 */
@Slf4j
public class Idea32496Service {
    private static final int IDEA_ID = 32496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32496Service() {
        this(new Idea32496Config());
    }

    public Idea32496Service(Idea32496Config config) {
        this.config = config != null ? config : new Idea32496Config();
