...
@Data
public class Idea32689Config {
    private String name = "idea_032689";
 ...
 */
@Slf4j
public class Idea32689Service {
    private static final int IDEA_ID = 32689;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32689Service() {
        this(new Idea32689Config());
    }

    public Idea32689Service(Idea32689Config config) {
        this.config = config != null ? config : new Idea32689Config();
