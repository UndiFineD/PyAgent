...
@Data
public class Idea32604Config {
    private String name = "idea_032604";
 ...
 */
@Slf4j
public class Idea32604Service {
    private static final int IDEA_ID = 32604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32604Service() {
        this(new Idea32604Config());
    }

    public Idea32604Service(Idea32604Config config) {
        this.config = config != null ? config : new Idea32604Config();
