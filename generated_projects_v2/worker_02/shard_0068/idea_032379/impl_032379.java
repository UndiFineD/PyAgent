...
@Data
public class Idea32379Config {
    private String name = "idea_032379";
 ...
 */
@Slf4j
public class Idea32379Service {
    private static final int IDEA_ID = 32379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32379Service() {
        this(new Idea32379Config());
    }

    public Idea32379Service(Idea32379Config config) {
        this.config = config != null ? config : new Idea32379Config();
