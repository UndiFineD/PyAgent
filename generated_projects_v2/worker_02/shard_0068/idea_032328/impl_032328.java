...
@Data
public class Idea32328Config {
    private String name = "idea_032328";
 ...
 */
@Slf4j
public class Idea32328Service {
    private static final int IDEA_ID = 32328;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32328Service() {
        this(new Idea32328Config());
    }

    public Idea32328Service(Idea32328Config config) {
        this.config = config != null ? config : new Idea32328Config();
