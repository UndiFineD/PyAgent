...
@Data
public class Idea32350Config {
    private String name = "idea_032350";
 ...
 */
@Slf4j
public class Idea32350Service {
    private static final int IDEA_ID = 32350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32350Service() {
        this(new Idea32350Config());
    }

    public Idea32350Service(Idea32350Config config) {
        this.config = config != null ? config : new Idea32350Config();
