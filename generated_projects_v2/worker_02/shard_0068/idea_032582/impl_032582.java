...
@Data
public class Idea32582Config {
    private String name = "idea_032582";
 ...
 */
@Slf4j
public class Idea32582Service {
    private static final int IDEA_ID = 32582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32582Service() {
        this(new Idea32582Config());
    }

    public Idea32582Service(Idea32582Config config) {
        this.config = config != null ? config : new Idea32582Config();
