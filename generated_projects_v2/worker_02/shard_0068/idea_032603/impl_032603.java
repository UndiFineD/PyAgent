...
@Data
public class Idea32603Config {
    private String name = "idea_032603";
 ...
 */
@Slf4j
public class Idea32603Service {
    private static final int IDEA_ID = 32603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32603Service() {
        this(new Idea32603Config());
    }

    public Idea32603Service(Idea32603Config config) {
        this.config = config != null ? config : new Idea32603Config();
