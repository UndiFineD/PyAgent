...
@Data
public class Idea32405Config {
    private String name = "idea_032405";
 ...
 */
@Slf4j
public class Idea32405Service {
    private static final int IDEA_ID = 32405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32405Service() {
        this(new Idea32405Config());
    }

    public Idea32405Service(Idea32405Config config) {
        this.config = config != null ? config : new Idea32405Config();
