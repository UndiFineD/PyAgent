...
@Data
public class Idea32477Config {
    private String name = "idea_032477";
 ...
 */
@Slf4j
public class Idea32477Service {
    private static final int IDEA_ID = 32477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32477Service() {
        this(new Idea32477Config());
    }

    public Idea32477Service(Idea32477Config config) {
        this.config = config != null ? config : new Idea32477Config();
