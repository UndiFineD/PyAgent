...
@Data
public class Idea32653Config {
    private String name = "idea_032653";
 ...
 */
@Slf4j
public class Idea32653Service {
    private static final int IDEA_ID = 32653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32653Service() {
        this(new Idea32653Config());
    }

    public Idea32653Service(Idea32653Config config) {
        this.config = config != null ? config : new Idea32653Config();
