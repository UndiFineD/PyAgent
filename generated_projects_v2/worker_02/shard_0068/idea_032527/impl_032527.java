...
@Data
public class Idea32527Config {
    private String name = "idea_032527";
 ...
 */
@Slf4j
public class Idea32527Service {
    private static final int IDEA_ID = 32527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32527Service() {
        this(new Idea32527Config());
    }

    public Idea32527Service(Idea32527Config config) {
        this.config = config != null ? config : new Idea32527Config();
