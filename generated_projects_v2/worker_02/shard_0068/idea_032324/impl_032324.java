...
@Data
public class Idea32324Config {
    private String name = "idea_032324";
 ...
 */
@Slf4j
public class Idea32324Service {
    private static final int IDEA_ID = 32324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32324Service() {
        this(new Idea32324Config());
    }

    public Idea32324Service(Idea32324Config config) {
        this.config = config != null ? config : new Idea32324Config();
