...
@Data
public class Idea32383Config {
    private String name = "idea_032383";
 ...
 */
@Slf4j
public class Idea32383Service {
    private static final int IDEA_ID = 32383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32383Service() {
        this(new Idea32383Config());
    }

    public Idea32383Service(Idea32383Config config) {
        this.config = config != null ? config : new Idea32383Config();
