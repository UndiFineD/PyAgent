...
@Data
public class Idea32434Config {
    private String name = "idea_032434";
 ...
 */
@Slf4j
public class Idea32434Service {
    private static final int IDEA_ID = 32434;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32434Service() {
        this(new Idea32434Config());
    }

    public Idea32434Service(Idea32434Config config) {
        this.config = config != null ? config : new Idea32434Config();
