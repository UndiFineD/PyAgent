...
@Data
public class Idea32670Config {
    private String name = "idea_032670";
 ...
 */
@Slf4j
public class Idea32670Service {
    private static final int IDEA_ID = 32670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32670Service() {
        this(new Idea32670Config());
    }

    public Idea32670Service(Idea32670Config config) {
        this.config = config != null ? config : new Idea32670Config();
