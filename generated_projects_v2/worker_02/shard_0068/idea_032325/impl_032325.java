...
@Data
public class Idea32325Config {
    private String name = "idea_032325";
 ...
 */
@Slf4j
public class Idea32325Service {
    private static final int IDEA_ID = 32325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32325Service() {
        this(new Idea32325Config());
    }

    public Idea32325Service(Idea32325Config config) {
        this.config = config != null ? config : new Idea32325Config();
