...
@Data
public class Idea32589Config {
    private String name = "idea_032589";
 ...
 */
@Slf4j
public class Idea32589Service {
    private static final int IDEA_ID = 32589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32589Service() {
        this(new Idea32589Config());
    }

    public Idea32589Service(Idea32589Config config) {
        this.config = config != null ? config : new Idea32589Config();
