...
@Data
public class Idea32573Config {
    private String name = "idea_032573";
 ...
 */
@Slf4j
public class Idea32573Service {
    private static final int IDEA_ID = 32573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32573Service() {
        this(new Idea32573Config());
    }

    public Idea32573Service(Idea32573Config config) {
        this.config = config != null ? config : new Idea32573Config();
