...
@Data
public class Idea32411Config {
    private String name = "idea_032411";
 ...
 */
@Slf4j
public class Idea32411Service {
    private static final int IDEA_ID = 32411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32411Service() {
        this(new Idea32411Config());
    }

    public Idea32411Service(Idea32411Config config) {
        this.config = config != null ? config : new Idea32411Config();
