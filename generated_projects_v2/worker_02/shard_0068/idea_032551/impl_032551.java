...
@Data
public class Idea32551Config {
    private String name = "idea_032551";
 ...
 */
@Slf4j
public class Idea32551Service {
    private static final int IDEA_ID = 32551;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32551Service() {
        this(new Idea32551Config());
    }

    public Idea32551Service(Idea32551Config config) {
        this.config = config != null ? config : new Idea32551Config();
