...
@Data
public class Idea32415Config {
    private String name = "idea_032415";
 ...
 */
@Slf4j
public class Idea32415Service {
    private static final int IDEA_ID = 32415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32415Service() {
        this(new Idea32415Config());
    }

    public Idea32415Service(Idea32415Config config) {
        this.config = config != null ? config : new Idea32415Config();
