...
@Data
public class Idea32521Config {
    private String name = "idea_032521";
 ...
 */
@Slf4j
public class Idea32521Service {
    private static final int IDEA_ID = 32521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32521Service() {
        this(new Idea32521Config());
    }

    public Idea32521Service(Idea32521Config config) {
        this.config = config != null ? config : new Idea32521Config();
