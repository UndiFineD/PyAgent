...
@Data
public class Idea32506Config {
    private String name = "idea_032506";
 ...
 */
@Slf4j
public class Idea32506Service {
    private static final int IDEA_ID = 32506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32506Service() {
        this(new Idea32506Config());
    }

    public Idea32506Service(Idea32506Config config) {
        this.config = config != null ? config : new Idea32506Config();
