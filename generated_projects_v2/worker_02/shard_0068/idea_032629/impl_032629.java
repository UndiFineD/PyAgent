...
@Data
public class Idea32629Config {
    private String name = "idea_032629";
 ...
 */
@Slf4j
public class Idea32629Service {
    private static final int IDEA_ID = 32629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32629Service() {
        this(new Idea32629Config());
    }

    public Idea32629Service(Idea32629Config config) {
        this.config = config != null ? config : new Idea32629Config();
