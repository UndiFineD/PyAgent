...
@Data
public class Idea32536Config {
    private String name = "idea_032536";
 ...
 */
@Slf4j
public class Idea32536Service {
    private static final int IDEA_ID = 32536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32536Service() {
        this(new Idea32536Config());
    }

    public Idea32536Service(Idea32536Config config) {
        this.config = config != null ? config : new Idea32536Config();
