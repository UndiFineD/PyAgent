...
@Data
public class Idea32732Config {
    private String name = "idea_032732";
 ...
 */
@Slf4j
public class Idea32732Service {
    private static final int IDEA_ID = 32732;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32732Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32732Service() {
        this(new Idea32732Config());
    }

    public Idea32732Service(Idea32732Config config) {
        this.config = config != null ? config : new Idea32732Config();
