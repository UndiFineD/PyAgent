...
@Data
public class Idea32306Config {
    private String name = "idea_032306";
 ...
 */
@Slf4j
public class Idea32306Service {
    private static final int IDEA_ID = 32306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32306Service() {
        this(new Idea32306Config());
    }

    public Idea32306Service(Idea32306Config config) {
        this.config = config != null ? config : new Idea32306Config();
