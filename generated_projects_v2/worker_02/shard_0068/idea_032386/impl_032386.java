...
@Data
public class Idea32386Config {
    private String name = "idea_032386";
 ...
 */
@Slf4j
public class Idea32386Service {
    private static final int IDEA_ID = 32386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32386Service() {
        this(new Idea32386Config());
    }

    public Idea32386Service(Idea32386Config config) {
        this.config = config != null ? config : new Idea32386Config();
