...
@Data
public class Idea32753Config {
    private String name = "idea_032753";
 ...
 */
@Slf4j
public class Idea32753Service {
    private static final int IDEA_ID = 32753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32753Service() {
        this(new Idea32753Config());
    }

    public Idea32753Service(Idea32753Config config) {
        this.config = config != null ? config : new Idea32753Config();
