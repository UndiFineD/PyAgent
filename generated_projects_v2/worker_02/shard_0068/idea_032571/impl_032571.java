...
@Data
public class Idea32571Config {
    private String name = "idea_032571";
 ...
 */
@Slf4j
public class Idea32571Service {
    private static final int IDEA_ID = 32571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32571Service() {
        this(new Idea32571Config());
    }

    public Idea32571Service(Idea32571Config config) {
        this.config = config != null ? config : new Idea32571Config();
