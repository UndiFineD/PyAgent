...
@Data
public class Idea32449Config {
    private String name = "idea_032449";
 ...
 */
@Slf4j
public class Idea32449Service {
    private static final int IDEA_ID = 32449;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32449Service() {
        this(new Idea32449Config());
    }

    public Idea32449Service(Idea32449Config config) {
        this.config = config != null ? config : new Idea32449Config();
