...
@Data
public class Idea32389Config {
    private String name = "idea_032389";
 ...
 */
@Slf4j
public class Idea32389Service {
    private static final int IDEA_ID = 32389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32389Service() {
        this(new Idea32389Config());
    }

    public Idea32389Service(Idea32389Config config) {
        this.config = config != null ? config : new Idea32389Config();
