...
@Data
public class Idea32408Config {
    private String name = "idea_032408";
 ...
 */
@Slf4j
public class Idea32408Service {
    private static final int IDEA_ID = 32408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32408Service() {
        this(new Idea32408Config());
    }

    public Idea32408Service(Idea32408Config config) {
        this.config = config != null ? config : new Idea32408Config();
