...
@Data
public class Idea32314Config {
    private String name = "idea_032314";
 ...
 */
@Slf4j
public class Idea32314Service {
    private static final int IDEA_ID = 32314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32314Service() {
        this(new Idea32314Config());
    }

    public Idea32314Service(Idea32314Config config) {
        this.config = config != null ? config : new Idea32314Config();
