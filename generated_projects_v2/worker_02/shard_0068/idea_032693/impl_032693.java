...
@Data
public class Idea32693Config {
    private String name = "idea_032693";
 ...
 */
@Slf4j
public class Idea32693Service {
    private static final int IDEA_ID = 32693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32693Service() {
        this(new Idea32693Config());
    }

    public Idea32693Service(Idea32693Config config) {
        this.config = config != null ? config : new Idea32693Config();
