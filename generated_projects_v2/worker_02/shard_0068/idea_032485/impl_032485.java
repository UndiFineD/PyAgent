...
@Data
public class Idea32485Config {
    private String name = "idea_032485";
 ...
 */
@Slf4j
public class Idea32485Service {
    private static final int IDEA_ID = 32485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32485Service() {
        this(new Idea32485Config());
    }

    public Idea32485Service(Idea32485Config config) {
        this.config = config != null ? config : new Idea32485Config();
