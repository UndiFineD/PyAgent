...
@Data
public class Idea32397Config {
    private String name = "idea_032397";
 ...
 */
@Slf4j
public class Idea32397Service {
    private static final int IDEA_ID = 32397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32397Service() {
        this(new Idea32397Config());
    }

    public Idea32397Service(Idea32397Config config) {
        this.config = config != null ? config : new Idea32397Config();
