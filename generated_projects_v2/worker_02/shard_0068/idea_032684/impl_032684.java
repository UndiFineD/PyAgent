...
@Data
public class Idea32684Config {
    private String name = "idea_032684";
 ...
 */
@Slf4j
public class Idea32684Service {
    private static final int IDEA_ID = 32684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32684Service() {
        this(new Idea32684Config());
    }

    public Idea32684Service(Idea32684Config config) {
        this.config = config != null ? config : new Idea32684Config();
