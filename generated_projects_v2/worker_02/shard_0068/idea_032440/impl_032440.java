...
@Data
public class Idea32440Config {
    private String name = "idea_032440";
 ...
 */
@Slf4j
public class Idea32440Service {
    private static final int IDEA_ID = 32440;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32440Service() {
        this(new Idea32440Config());
    }

    public Idea32440Service(Idea32440Config config) {
        this.config = config != null ? config : new Idea32440Config();
