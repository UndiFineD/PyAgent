...
@Data
public class Idea32598Config {
    private String name = "idea_032598";
 ...
 */
@Slf4j
public class Idea32598Service {
    private static final int IDEA_ID = 32598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32598Service() {
        this(new Idea32598Config());
    }

    public Idea32598Service(Idea32598Config config) {
        this.config = config != null ? config : new Idea32598Config();
