...
@Data
public class Idea32481Config {
    private String name = "idea_032481";
 ...
 */
@Slf4j
public class Idea32481Service {
    private static final int IDEA_ID = 32481;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32481Service() {
        this(new Idea32481Config());
    }

    public Idea32481Service(Idea32481Config config) {
        this.config = config != null ? config : new Idea32481Config();
