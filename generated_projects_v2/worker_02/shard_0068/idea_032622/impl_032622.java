...
@Data
public class Idea32622Config {
    private String name = "idea_032622";
 ...
 */
@Slf4j
public class Idea32622Service {
    private static final int IDEA_ID = 32622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32622Service() {
        this(new Idea32622Config());
    }

    public Idea32622Service(Idea32622Config config) {
        this.config = config != null ? config : new Idea32622Config();
