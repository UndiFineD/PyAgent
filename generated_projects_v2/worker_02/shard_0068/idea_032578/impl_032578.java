...
@Data
public class Idea32578Config {
    private String name = "idea_032578";
 ...
 */
@Slf4j
public class Idea32578Service {
    private static final int IDEA_ID = 32578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32578Service() {
        this(new Idea32578Config());
    }

    public Idea32578Service(Idea32578Config config) {
        this.config = config != null ? config : new Idea32578Config();
