...
@Data
public class Idea32690Config {
    private String name = "idea_032690";
 ...
 */
@Slf4j
public class Idea32690Service {
    private static final int IDEA_ID = 32690;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32690Service() {
        this(new Idea32690Config());
    }

    public Idea32690Service(Idea32690Config config) {
        this.config = config != null ? config : new Idea32690Config();
