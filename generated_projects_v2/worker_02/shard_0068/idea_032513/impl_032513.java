...
@Data
public class Idea32513Config {
    private String name = "idea_032513";
 ...
 */
@Slf4j
public class Idea32513Service {
    private static final int IDEA_ID = 32513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32513Service() {
        this(new Idea32513Config());
    }

    public Idea32513Service(Idea32513Config config) {
        this.config = config != null ? config : new Idea32513Config();
