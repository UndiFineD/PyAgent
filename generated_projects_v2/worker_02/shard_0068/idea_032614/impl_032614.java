...
@Data
public class Idea32614Config {
    private String name = "idea_032614";
 ...
 */
@Slf4j
public class Idea32614Service {
    private static final int IDEA_ID = 32614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32614Service() {
        this(new Idea32614Config());
    }

    public Idea32614Service(Idea32614Config config) {
        this.config = config != null ? config : new Idea32614Config();
