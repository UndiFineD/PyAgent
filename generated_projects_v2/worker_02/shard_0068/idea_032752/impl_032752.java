...
@Data
public class Idea32752Config {
    private String name = "idea_032752";
 ...
 */
@Slf4j
public class Idea32752Service {
    private static final int IDEA_ID = 32752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32752Service() {
        this(new Idea32752Config());
    }

    public Idea32752Service(Idea32752Config config) {
        this.config = config != null ? config : new Idea32752Config();
