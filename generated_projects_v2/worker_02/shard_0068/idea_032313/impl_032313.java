...
@Data
public class Idea32313Config {
    private String name = "idea_032313";
 ...
 */
@Slf4j
public class Idea32313Service {
    private static final int IDEA_ID = 32313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32313Service() {
        this(new Idea32313Config());
    }

    public Idea32313Service(Idea32313Config config) {
        this.config = config != null ? config : new Idea32313Config();
