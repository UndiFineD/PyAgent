...
@Data
public class Idea32442Config {
    private String name = "idea_032442";
 ...
 */
@Slf4j
public class Idea32442Service {
    private static final int IDEA_ID = 32442;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32442Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32442Service() {
        this(new Idea32442Config());
    }

    public Idea32442Service(Idea32442Config config) {
        this.config = config != null ? config : new Idea32442Config();
