...
@Data
public class Idea32646Config {
    private String name = "idea_032646";
 ...
 */
@Slf4j
public class Idea32646Service {
    private static final int IDEA_ID = 32646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32646Service() {
        this(new Idea32646Config());
    }

    public Idea32646Service(Idea32646Config config) {
        this.config = config != null ? config : new Idea32646Config();
