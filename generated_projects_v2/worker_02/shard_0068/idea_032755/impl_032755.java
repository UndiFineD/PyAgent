...
@Data
public class Idea32755Config {
    private String name = "idea_032755";
 ...
 */
@Slf4j
public class Idea32755Service {
    private static final int IDEA_ID = 32755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32755Service() {
        this(new Idea32755Config());
    }

    public Idea32755Service(Idea32755Config config) {
        this.config = config != null ? config : new Idea32755Config();
