...
@Data
public class Idea32467Config {
    private String name = "idea_032467";
 ...
 */
@Slf4j
public class Idea32467Service {
    private static final int IDEA_ID = 32467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32467Service() {
        this(new Idea32467Config());
    }

    public Idea32467Service(Idea32467Config config) {
        this.config = config != null ? config : new Idea32467Config();
