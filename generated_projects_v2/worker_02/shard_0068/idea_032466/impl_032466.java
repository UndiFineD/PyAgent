...
@Data
public class Idea32466Config {
    private String name = "idea_032466";
 ...
 */
@Slf4j
public class Idea32466Service {
    private static final int IDEA_ID = 32466;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32466Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32466Service() {
        this(new Idea32466Config());
    }

    public Idea32466Service(Idea32466Config config) {
        this.config = config != null ? config : new Idea32466Config();
