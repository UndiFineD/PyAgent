...
@Data
public class Idea32359Config {
    private String name = "idea_032359";
 ...
 */
@Slf4j
public class Idea32359Service {
    private static final int IDEA_ID = 32359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32359Service() {
        this(new Idea32359Config());
    }

    public Idea32359Service(Idea32359Config config) {
        this.config = config != null ? config : new Idea32359Config();
