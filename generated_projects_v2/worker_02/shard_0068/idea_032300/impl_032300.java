...
@Data
public class Idea32300Config {
    private String name = "idea_032300";
 ...
 */
@Slf4j
public class Idea32300Service {
    private static final int IDEA_ID = 32300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32300Service() {
        this(new Idea32300Config());
    }

    public Idea32300Service(Idea32300Config config) {
        this.config = config != null ? config : new Idea32300Config();
