...
@Data
public class Idea32458Config {
    private String name = "idea_032458";
 ...
 */
@Slf4j
public class Idea32458Service {
    private static final int IDEA_ID = 32458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32458Service() {
        this(new Idea32458Config());
    }

    public Idea32458Service(Idea32458Config config) {
        this.config = config != null ? config : new Idea32458Config();
