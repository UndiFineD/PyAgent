...
@Data
public class Idea32721Config {
    private String name = "idea_032721";
 ...
 */
@Slf4j
public class Idea32721Service {
    private static final int IDEA_ID = 32721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32721Service() {
        this(new Idea32721Config());
    }

    public Idea32721Service(Idea32721Config config) {
        this.config = config != null ? config : new Idea32721Config();
