...
@Data
public class Idea32505Config {
    private String name = "idea_032505";
 ...
 */
@Slf4j
public class Idea32505Service {
    private static final int IDEA_ID = 32505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32505Service() {
        this(new Idea32505Config());
    }

    public Idea32505Service(Idea32505Config config) {
        this.config = config != null ? config : new Idea32505Config();
