...
@Data
public class Idea32663Config {
    private String name = "idea_032663";
 ...
 */
@Slf4j
public class Idea32663Service {
    private static final int IDEA_ID = 32663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32663Service() {
        this(new Idea32663Config());
    }

    public Idea32663Service(Idea32663Config config) {
        this.config = config != null ? config : new Idea32663Config();
