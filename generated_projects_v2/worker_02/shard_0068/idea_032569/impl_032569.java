...
@Data
public class Idea32569Config {
    private String name = "idea_032569";
 ...
 */
@Slf4j
public class Idea32569Service {
    private static final int IDEA_ID = 32569;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32569Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32569Service() {
        this(new Idea32569Config());
    }

    public Idea32569Service(Idea32569Config config) {
        this.config = config != null ? config : new Idea32569Config();
