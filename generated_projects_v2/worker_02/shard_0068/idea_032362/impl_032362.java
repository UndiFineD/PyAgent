...
@Data
public class Idea32362Config {
    private String name = "idea_032362";
 ...
 */
@Slf4j
public class Idea32362Service {
    private static final int IDEA_ID = 32362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32362Service() {
        this(new Idea32362Config());
    }

    public Idea32362Service(Idea32362Config config) {
        this.config = config != null ? config : new Idea32362Config();
