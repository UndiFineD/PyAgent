...
@Data
public class Idea32540Config {
    private String name = "idea_032540";
 ...
 */
@Slf4j
public class Idea32540Service {
    private static final int IDEA_ID = 32540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32540Service() {
        this(new Idea32540Config());
    }

    public Idea32540Service(Idea32540Config config) {
        this.config = config != null ? config : new Idea32540Config();
