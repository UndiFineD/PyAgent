...
@Data
public class Idea32353Config {
    private String name = "idea_032353";
 ...
 */
@Slf4j
public class Idea32353Service {
    private static final int IDEA_ID = 32353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32353Service() {
        this(new Idea32353Config());
    }

    public Idea32353Service(Idea32353Config config) {
        this.config = config != null ? config : new Idea32353Config();
