...
@Data
public class Idea32576Config {
    private String name = "idea_032576";
 ...
 */
@Slf4j
public class Idea32576Service {
    private static final int IDEA_ID = 32576;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32576Service() {
        this(new Idea32576Config());
    }

    public Idea32576Service(Idea32576Config config) {
        this.config = config != null ? config : new Idea32576Config();
