...
@Data
public class Idea32605Config {
    private String name = "idea_032605";
 ...
 */
@Slf4j
public class Idea32605Service {
    private static final int IDEA_ID = 32605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32605Service() {
        this(new Idea32605Config());
    }

    public Idea32605Service(Idea32605Config config) {
        this.config = config != null ? config : new Idea32605Config();
