...
@Data
public class Idea32770Config {
    private String name = "idea_032770";
 ...
 */
@Slf4j
public class Idea32770Service {
    private static final int IDEA_ID = 32770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32770Service() {
        this(new Idea32770Config());
    }

    public Idea32770Service(Idea32770Config config) {
        this.config = config != null ? config : new Idea32770Config();
