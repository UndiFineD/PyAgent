...
@Data
public class Idea32600Config {
    private String name = "idea_032600";
 ...
 */
@Slf4j
public class Idea32600Service {
    private static final int IDEA_ID = 32600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32600Service() {
        this(new Idea32600Config());
    }

    public Idea32600Service(Idea32600Config config) {
        this.config = config != null ? config : new Idea32600Config();
