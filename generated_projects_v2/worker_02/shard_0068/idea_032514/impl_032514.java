...
@Data
public class Idea32514Config {
    private String name = "idea_032514";
 ...
 */
@Slf4j
public class Idea32514Service {
    private static final int IDEA_ID = 32514;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32514Service() {
        this(new Idea32514Config());
    }

    public Idea32514Service(Idea32514Config config) {
        this.config = config != null ? config : new Idea32514Config();
