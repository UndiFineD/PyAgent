...
@Data
public class Idea32599Config {
    private String name = "idea_032599";
 ...
 */
@Slf4j
public class Idea32599Service {
    private static final int IDEA_ID = 32599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32599Service() {
        this(new Idea32599Config());
    }

    public Idea32599Service(Idea32599Config config) {
        this.config = config != null ? config : new Idea32599Config();
