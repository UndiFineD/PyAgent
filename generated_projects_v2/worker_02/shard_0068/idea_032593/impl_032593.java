...
@Data
public class Idea32593Config {
    private String name = "idea_032593";
 ...
 */
@Slf4j
public class Idea32593Service {
    private static final int IDEA_ID = 32593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32593Service() {
        this(new Idea32593Config());
    }

    public Idea32593Service(Idea32593Config config) {
        this.config = config != null ? config : new Idea32593Config();
