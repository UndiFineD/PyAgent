...
@Data
public class Idea32421Config {
    private String name = "idea_032421";
 ...
 */
@Slf4j
public class Idea32421Service {
    private static final int IDEA_ID = 32421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32421Service() {
        this(new Idea32421Config());
    }

    public Idea32421Service(Idea32421Config config) {
        this.config = config != null ? config : new Idea32421Config();
