...
@Data
public class Idea32464Config {
    private String name = "idea_032464";
 ...
 */
@Slf4j
public class Idea32464Service {
    private static final int IDEA_ID = 32464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32464Service() {
        this(new Idea32464Config());
    }

    public Idea32464Service(Idea32464Config config) {
        this.config = config != null ? config : new Idea32464Config();
