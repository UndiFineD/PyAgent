...
@Data
public class Idea32602Config {
    private String name = "idea_032602";
 ...
 */
@Slf4j
public class Idea32602Service {
    private static final int IDEA_ID = 32602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32602Service() {
        this(new Idea32602Config());
    }

    public Idea32602Service(Idea32602Config config) {
        this.config = config != null ? config : new Idea32602Config();
