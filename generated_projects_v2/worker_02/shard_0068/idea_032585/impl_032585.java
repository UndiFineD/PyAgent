...
@Data
public class Idea32585Config {
    private String name = "idea_032585";
 ...
 */
@Slf4j
public class Idea32585Service {
    private static final int IDEA_ID = 32585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32585Service() {
        this(new Idea32585Config());
    }

    public Idea32585Service(Idea32585Config config) {
        this.config = config != null ? config : new Idea32585Config();
