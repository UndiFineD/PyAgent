...
@Data
public class Idea32729Config {
    private String name = "idea_032729";
 ...
 */
@Slf4j
public class Idea32729Service {
    private static final int IDEA_ID = 32729;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32729Service() {
        this(new Idea32729Config());
    }

    public Idea32729Service(Idea32729Config config) {
        this.config = config != null ? config : new Idea32729Config();
