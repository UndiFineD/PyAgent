...
@Data
public class Idea32320Config {
    private String name = "idea_032320";
 ...
 */
@Slf4j
public class Idea32320Service {
    private static final int IDEA_ID = 32320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32320Service() {
        this(new Idea32320Config());
    }

    public Idea32320Service(Idea32320Config config) {
        this.config = config != null ? config : new Idea32320Config();
