...
@Data
public class Idea32744Config {
    private String name = "idea_032744";
 ...
 */
@Slf4j
public class Idea32744Service {
    private static final int IDEA_ID = 32744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32744Service() {
        this(new Idea32744Config());
    }

    public Idea32744Service(Idea32744Config config) {
        this.config = config != null ? config : new Idea32744Config();
