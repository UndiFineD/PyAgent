...
@Data
public class Idea32422Config {
    private String name = "idea_032422";
 ...
 */
@Slf4j
public class Idea32422Service {
    private static final int IDEA_ID = 32422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32422Service() {
        this(new Idea32422Config());
    }

    public Idea32422Service(Idea32422Config config) {
        this.config = config != null ? config : new Idea32422Config();
