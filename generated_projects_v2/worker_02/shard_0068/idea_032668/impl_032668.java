...
@Data
public class Idea32668Config {
    private String name = "idea_032668";
 ...
 */
@Slf4j
public class Idea32668Service {
    private static final int IDEA_ID = 32668;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32668Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32668Service() {
        this(new Idea32668Config());
    }

    public Idea32668Service(Idea32668Config config) {
        this.config = config != null ? config : new Idea32668Config();
