...
@Data
public class Idea32624Config {
    private String name = "idea_032624";
 ...
 */
@Slf4j
public class Idea32624Service {
    private static final int IDEA_ID = 32624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32624Service() {
        this(new Idea32624Config());
    }

    public Idea32624Service(Idea32624Config config) {
        this.config = config != null ? config : new Idea32624Config();
