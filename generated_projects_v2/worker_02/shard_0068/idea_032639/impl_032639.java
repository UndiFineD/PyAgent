...
@Data
public class Idea32639Config {
    private String name = "idea_032639";
 ...
 */
@Slf4j
public class Idea32639Service {
    private static final int IDEA_ID = 32639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32639Service() {
        this(new Idea32639Config());
    }

    public Idea32639Service(Idea32639Config config) {
        this.config = config != null ? config : new Idea32639Config();
