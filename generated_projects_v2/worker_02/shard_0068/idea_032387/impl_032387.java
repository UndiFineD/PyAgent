...
@Data
public class Idea32387Config {
    private String name = "idea_032387";
 ...
 */
@Slf4j
public class Idea32387Service {
    private static final int IDEA_ID = 32387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32387Service() {
        this(new Idea32387Config());
    }

    public Idea32387Service(Idea32387Config config) {
        this.config = config != null ? config : new Idea32387Config();
