...
@Data
public class Idea32424Config {
    private String name = "idea_032424";
 ...
 */
@Slf4j
public class Idea32424Service {
    private static final int IDEA_ID = 32424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32424Service() {
        this(new Idea32424Config());
    }

    public Idea32424Service(Idea32424Config config) {
        this.config = config != null ? config : new Idea32424Config();
