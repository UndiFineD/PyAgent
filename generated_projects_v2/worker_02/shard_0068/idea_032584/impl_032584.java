...
@Data
public class Idea32584Config {
    private String name = "idea_032584";
 ...
 */
@Slf4j
public class Idea32584Service {
    private static final int IDEA_ID = 32584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32584Service() {
        this(new Idea32584Config());
    }

    public Idea32584Service(Idea32584Config config) {
        this.config = config != null ? config : new Idea32584Config();
