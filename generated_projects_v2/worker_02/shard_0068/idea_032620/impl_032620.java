...
@Data
public class Idea32620Config {
    private String name = "idea_032620";
 ...
 */
@Slf4j
public class Idea32620Service {
    private static final int IDEA_ID = 32620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32620Service() {
        this(new Idea32620Config());
    }

    public Idea32620Service(Idea32620Config config) {
        this.config = config != null ? config : new Idea32620Config();
