...
@Data
public class Idea32749Config {
    private String name = "idea_032749";
 ...
 */
@Slf4j
public class Idea32749Service {
    private static final int IDEA_ID = 32749;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32749Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32749Service() {
        this(new Idea32749Config());
    }

    public Idea32749Service(Idea32749Config config) {
        this.config = config != null ? config : new Idea32749Config();
