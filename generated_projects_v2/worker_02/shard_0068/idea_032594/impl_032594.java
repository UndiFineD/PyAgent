...
@Data
public class Idea32594Config {
    private String name = "idea_032594";
 ...
 */
@Slf4j
public class Idea32594Service {
    private static final int IDEA_ID = 32594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32594Service() {
        this(new Idea32594Config());
    }

    public Idea32594Service(Idea32594Config config) {
        this.config = config != null ? config : new Idea32594Config();
