...
@Data
public class Idea32461Config {
    private String name = "idea_032461";
 ...
 */
@Slf4j
public class Idea32461Service {
    private static final int IDEA_ID = 32461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32461Service() {
        this(new Idea32461Config());
    }

    public Idea32461Service(Idea32461Config config) {
        this.config = config != null ? config : new Idea32461Config();
