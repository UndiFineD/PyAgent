...
@Data
public class Idea32718Config {
    private String name = "idea_032718";
 ...
 */
@Slf4j
public class Idea32718Service {
    private static final int IDEA_ID = 32718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32718Service() {
        this(new Idea32718Config());
    }

    public Idea32718Service(Idea32718Config config) {
        this.config = config != null ? config : new Idea32718Config();
