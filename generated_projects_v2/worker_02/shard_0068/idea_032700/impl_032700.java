...
@Data
public class Idea32700Config {
    private String name = "idea_032700";
 ...
 */
@Slf4j
public class Idea32700Service {
    private static final int IDEA_ID = 32700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32700Service() {
        this(new Idea32700Config());
    }

    public Idea32700Service(Idea32700Config config) {
        this.config = config != null ? config : new Idea32700Config();
