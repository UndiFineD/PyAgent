...
@Data
public class Idea32347Config {
    private String name = "idea_032347";
 ...
 */
@Slf4j
public class Idea32347Service {
    private static final int IDEA_ID = 32347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32347Service() {
        this(new Idea32347Config());
    }

    public Idea32347Service(Idea32347Config config) {
        this.config = config != null ? config : new Idea32347Config();
