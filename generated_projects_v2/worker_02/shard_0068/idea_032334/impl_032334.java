...
@Data
public class Idea32334Config {
    private String name = "idea_032334";
 ...
 */
@Slf4j
public class Idea32334Service {
    private static final int IDEA_ID = 32334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32334Service() {
        this(new Idea32334Config());
    }

    public Idea32334Service(Idea32334Config config) {
        this.config = config != null ? config : new Idea32334Config();
