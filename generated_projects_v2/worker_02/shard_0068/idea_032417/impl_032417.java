...
@Data
public class Idea32417Config {
    private String name = "idea_032417";
 ...
 */
@Slf4j
public class Idea32417Service {
    private static final int IDEA_ID = 32417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32417Service() {
        this(new Idea32417Config());
    }

    public Idea32417Service(Idea32417Config config) {
        this.config = config != null ? config : new Idea32417Config();
