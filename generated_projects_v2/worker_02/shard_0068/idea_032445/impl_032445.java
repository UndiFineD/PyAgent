...
@Data
public class Idea32445Config {
    private String name = "idea_032445";
 ...
 */
@Slf4j
public class Idea32445Service {
    private static final int IDEA_ID = 32445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32445Service() {
        this(new Idea32445Config());
    }

    public Idea32445Service(Idea32445Config config) {
        this.config = config != null ? config : new Idea32445Config();
