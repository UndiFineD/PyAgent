...
@Data
public class Idea32380Config {
    private String name = "idea_032380";
 ...
 */
@Slf4j
public class Idea32380Service {
    private static final int IDEA_ID = 32380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32380Service() {
        this(new Idea32380Config());
    }

    public Idea32380Service(Idea32380Config config) {
        this.config = config != null ? config : new Idea32380Config();
