...
@Data
public class Idea32698Config {
    private String name = "idea_032698";
 ...
 */
@Slf4j
public class Idea32698Service {
    private static final int IDEA_ID = 32698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32698Service() {
        this(new Idea32698Config());
    }

    public Idea32698Service(Idea32698Config config) {
        this.config = config != null ? config : new Idea32698Config();
