...
@Data
public class Idea32538Config {
    private String name = "idea_032538";
 ...
 */
@Slf4j
public class Idea32538Service {
    private static final int IDEA_ID = 32538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32538Service() {
        this(new Idea32538Config());
    }

    public Idea32538Service(Idea32538Config config) {
        this.config = config != null ? config : new Idea32538Config();
