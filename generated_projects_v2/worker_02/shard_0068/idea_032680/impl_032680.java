...
@Data
public class Idea32680Config {
    private String name = "idea_032680";
 ...
 */
@Slf4j
public class Idea32680Service {
    private static final int IDEA_ID = 32680;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32680Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32680Service() {
        this(new Idea32680Config());
    }

    public Idea32680Service(Idea32680Config config) {
        this.config = config != null ? config : new Idea32680Config();
