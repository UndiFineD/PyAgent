...
@Data
public class Idea40928Config {
    private String name = "idea_040928";
 ...
 */
@Slf4j
public class Idea40928Service {
    private static final int IDEA_ID = 40928;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40928Service() {
        this(new Idea40928Config());
    }

    public Idea40928Service(Idea40928Config config) {
        this.config = config != null ? config : new Idea40928Config();
