...
@Data
public class Idea41092Config {
    private String name = "idea_041092";
 ...
 */
@Slf4j
public class Idea41092Service {
    private static final int IDEA_ID = 41092;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41092Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41092Service() {
        this(new Idea41092Config());
    }

    public Idea41092Service(Idea41092Config config) {
        this.config = config != null ? config : new Idea41092Config();
