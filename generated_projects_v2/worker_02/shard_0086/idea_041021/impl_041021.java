...
@Data
public class Idea41021Config {
    private String name = "idea_041021";
 ...
 */
@Slf4j
public class Idea41021Service {
    private static final int IDEA_ID = 41021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41021Service() {
        this(new Idea41021Config());
    }

    public Idea41021Service(Idea41021Config config) {
        this.config = config != null ? config : new Idea41021Config();
