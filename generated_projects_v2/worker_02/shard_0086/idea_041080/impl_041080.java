...
@Data
public class Idea41080Config {
    private String name = "idea_041080";
 ...
 */
@Slf4j
public class Idea41080Service {
    private static final int IDEA_ID = 41080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41080Service() {
        this(new Idea41080Config());
    }

    public Idea41080Service(Idea41080Config config) {
        this.config = config != null ? config : new Idea41080Config();
