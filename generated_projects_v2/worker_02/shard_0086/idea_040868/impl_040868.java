...
@Data
public class Idea40868Config {
    private String name = "idea_040868";
 ...
 */
@Slf4j
public class Idea40868Service {
    private static final int IDEA_ID = 40868;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40868Service() {
        this(new Idea40868Config());
    }

    public Idea40868Service(Idea40868Config config) {
        this.config = config != null ? config : new Idea40868Config();
