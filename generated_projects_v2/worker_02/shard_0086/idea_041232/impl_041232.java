...
@Data
public class Idea41232Config {
    private String name = "idea_041232";
 ...
 */
@Slf4j
public class Idea41232Service {
    private static final int IDEA_ID = 41232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41232Service() {
        this(new Idea41232Config());
    }

    public Idea41232Service(Idea41232Config config) {
        this.config = config != null ? config : new Idea41232Config();
