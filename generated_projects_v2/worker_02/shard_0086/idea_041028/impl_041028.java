...
@Data
public class Idea41028Config {
    private String name = "idea_041028";
 ...
 */
@Slf4j
public class Idea41028Service {
    private static final int IDEA_ID = 41028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41028Service() {
        this(new Idea41028Config());
    }

    public Idea41028Service(Idea41028Config config) {
        this.config = config != null ? config : new Idea41028Config();
