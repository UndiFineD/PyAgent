...
@Data
public class Idea40940Config {
    private String name = "idea_040940";
 ...
 */
@Slf4j
public class Idea40940Service {
    private static final int IDEA_ID = 40940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40940Service() {
        this(new Idea40940Config());
    }

    public Idea40940Service(Idea40940Config config) {
        this.config = config != null ? config : new Idea40940Config();
