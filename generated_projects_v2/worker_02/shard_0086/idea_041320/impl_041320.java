...
@Data
public class Idea41320Config {
    private String name = "idea_041320";
 ...
 */
@Slf4j
public class Idea41320Service {
    private static final int IDEA_ID = 41320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41320Service() {
        this(new Idea41320Config());
    }

    public Idea41320Service(Idea41320Config config) {
        this.config = config != null ? config : new Idea41320Config();
