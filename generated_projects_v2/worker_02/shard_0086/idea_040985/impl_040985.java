...
@Data
public class Idea40985Config {
    private String name = "idea_040985";
 ...
 */
@Slf4j
public class Idea40985Service {
    private static final int IDEA_ID = 40985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40985Service() {
        this(new Idea40985Config());
    }

    public Idea40985Service(Idea40985Config config) {
        this.config = config != null ? config : new Idea40985Config();
