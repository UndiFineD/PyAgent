...
@Data
public class Idea41059Config {
    private String name = "idea_041059";
 ...
 */
@Slf4j
public class Idea41059Service {
    private static final int IDEA_ID = 41059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41059Service() {
        this(new Idea41059Config());
    }

    public Idea41059Service(Idea41059Config config) {
        this.config = config != null ? config : new Idea41059Config();
