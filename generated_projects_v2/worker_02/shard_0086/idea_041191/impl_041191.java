...
@Data
public class Idea41191Config {
    private String name = "idea_041191";
 ...
 */
@Slf4j
public class Idea41191Service {
    private static final int IDEA_ID = 41191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41191Service() {
        this(new Idea41191Config());
    }

    public Idea41191Service(Idea41191Config config) {
        this.config = config != null ? config : new Idea41191Config();
