...
@Data
public class Idea40921Config {
    private String name = "idea_040921";
 ...
 */
@Slf4j
public class Idea40921Service {
    private static final int IDEA_ID = 40921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40921Service() {
        this(new Idea40921Config());
    }

    public Idea40921Service(Idea40921Config config) {
        this.config = config != null ? config : new Idea40921Config();
