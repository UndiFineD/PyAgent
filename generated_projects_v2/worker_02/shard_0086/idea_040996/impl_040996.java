...
@Data
public class Idea40996Config {
    private String name = "idea_040996";
 ...
 */
@Slf4j
public class Idea40996Service {
    private static final int IDEA_ID = 40996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40996Service() {
        this(new Idea40996Config());
    }

    public Idea40996Service(Idea40996Config config) {
        this.config = config != null ? config : new Idea40996Config();
