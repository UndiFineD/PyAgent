...
@Data
public class Idea41088Config {
    private String name = "idea_041088";
 ...
 */
@Slf4j
public class Idea41088Service {
    private static final int IDEA_ID = 41088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41088Service() {
        this(new Idea41088Config());
    }

    public Idea41088Service(Idea41088Config config) {
        this.config = config != null ? config : new Idea41088Config();
