...
@Data
public class Idea40866Config {
    private String name = "idea_040866";
 ...
 */
@Slf4j
public class Idea40866Service {
    private static final int IDEA_ID = 40866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40866Service() {
        this(new Idea40866Config());
    }

    public Idea40866Service(Idea40866Config config) {
        this.config = config != null ? config : new Idea40866Config();
