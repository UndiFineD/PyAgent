...
@Data
public class Idea41207Config {
    private String name = "idea_041207";
 ...
 */
@Slf4j
public class Idea41207Service {
    private static final int IDEA_ID = 41207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41207Service() {
        this(new Idea41207Config());
    }

    public Idea41207Service(Idea41207Config config) {
        this.config = config != null ? config : new Idea41207Config();
