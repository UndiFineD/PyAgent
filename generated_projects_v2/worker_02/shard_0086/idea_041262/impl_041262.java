...
@Data
public class Idea41262Config {
    private String name = "idea_041262";
 ...
 */
@Slf4j
public class Idea41262Service {
    private static final int IDEA_ID = 41262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41262Service() {
        this(new Idea41262Config());
    }

    public Idea41262Service(Idea41262Config config) {
        this.config = config != null ? config : new Idea41262Config();
