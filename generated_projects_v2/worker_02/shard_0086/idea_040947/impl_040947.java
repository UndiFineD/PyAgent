...
@Data
public class Idea40947Config {
    private String name = "idea_040947";
 ...
 */
@Slf4j
public class Idea40947Service {
    private static final int IDEA_ID = 40947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40947Service() {
        this(new Idea40947Config());
    }

    public Idea40947Service(Idea40947Config config) {
        this.config = config != null ? config : new Idea40947Config();
