...
@Data
public class Idea41250Config {
    private String name = "idea_041250";
 ...
 */
@Slf4j
public class Idea41250Service {
    private static final int IDEA_ID = 41250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41250Service() {
        this(new Idea41250Config());
    }

    public Idea41250Service(Idea41250Config config) {
        this.config = config != null ? config : new Idea41250Config();
