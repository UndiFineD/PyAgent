...
@Data
public class Idea41141Config {
    private String name = "idea_041141";
 ...
 */
@Slf4j
public class Idea41141Service {
    private static final int IDEA_ID = 41141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41141Service() {
        this(new Idea41141Config());
    }

    public Idea41141Service(Idea41141Config config) {
        this.config = config != null ? config : new Idea41141Config();
