...
@Data
public class Idea41321Config {
    private String name = "idea_041321";
 ...
 */
@Slf4j
public class Idea41321Service {
    private static final int IDEA_ID = 41321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41321Service() {
        this(new Idea41321Config());
    }

    public Idea41321Service(Idea41321Config config) {
        this.config = config != null ? config : new Idea41321Config();
