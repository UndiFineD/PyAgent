...
@Data
public class Idea41076Config {
    private String name = "idea_041076";
 ...
 */
@Slf4j
public class Idea41076Service {
    private static final int IDEA_ID = 41076;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41076Service() {
        this(new Idea41076Config());
    }

    public Idea41076Service(Idea41076Config config) {
        this.config = config != null ? config : new Idea41076Config();
