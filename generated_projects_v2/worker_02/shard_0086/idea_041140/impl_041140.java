...
@Data
public class Idea41140Config {
    private String name = "idea_041140";
 ...
 */
@Slf4j
public class Idea41140Service {
    private static final int IDEA_ID = 41140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41140Service() {
        this(new Idea41140Config());
    }

    public Idea41140Service(Idea41140Config config) {
        this.config = config != null ? config : new Idea41140Config();
