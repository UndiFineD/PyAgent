...
@Data
public class Idea40957Config {
    private String name = "idea_040957";
 ...
 */
@Slf4j
public class Idea40957Service {
    private static final int IDEA_ID = 40957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40957Service() {
        this(new Idea40957Config());
    }

    public Idea40957Service(Idea40957Config config) {
        this.config = config != null ? config : new Idea40957Config();
