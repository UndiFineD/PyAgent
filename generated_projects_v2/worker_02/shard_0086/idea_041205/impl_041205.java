...
@Data
public class Idea41205Config {
    private String name = "idea_041205";
 ...
 */
@Slf4j
public class Idea41205Service {
    private static final int IDEA_ID = 41205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41205Service() {
        this(new Idea41205Config());
    }

    public Idea41205Service(Idea41205Config config) {
        this.config = config != null ? config : new Idea41205Config();
