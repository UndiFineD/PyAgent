...
@Data
public class Idea40948Config {
    private String name = "idea_040948";
 ...
 */
@Slf4j
public class Idea40948Service {
    private static final int IDEA_ID = 40948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40948Service() {
        this(new Idea40948Config());
    }

    public Idea40948Service(Idea40948Config config) {
        this.config = config != null ? config : new Idea40948Config();
