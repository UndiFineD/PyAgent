...
@Data
public class Idea40997Config {
    private String name = "idea_040997";
 ...
 */
@Slf4j
public class Idea40997Service {
    private static final int IDEA_ID = 40997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40997Service() {
        this(new Idea40997Config());
    }

    public Idea40997Service(Idea40997Config config) {
        this.config = config != null ? config : new Idea40997Config();
