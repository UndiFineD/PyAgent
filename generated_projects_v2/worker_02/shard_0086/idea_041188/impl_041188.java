...
@Data
public class Idea41188Config {
    private String name = "idea_041188";
 ...
 */
@Slf4j
public class Idea41188Service {
    private static final int IDEA_ID = 41188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41188Service() {
        this(new Idea41188Config());
    }

    public Idea41188Service(Idea41188Config config) {
        this.config = config != null ? config : new Idea41188Config();
