...
@Data
public class Idea40899Config {
    private String name = "idea_040899";
 ...
 */
@Slf4j
public class Idea40899Service {
    private static final int IDEA_ID = 40899;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40899Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40899Service() {
        this(new Idea40899Config());
    }

    public Idea40899Service(Idea40899Config config) {
        this.config = config != null ? config : new Idea40899Config();
