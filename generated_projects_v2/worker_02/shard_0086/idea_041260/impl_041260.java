...
@Data
public class Idea41260Config {
    private String name = "idea_041260";
 ...
 */
@Slf4j
public class Idea41260Service {
    private static final int IDEA_ID = 41260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41260Service() {
        this(new Idea41260Config());
    }

    public Idea41260Service(Idea41260Config config) {
        this.config = config != null ? config : new Idea41260Config();
