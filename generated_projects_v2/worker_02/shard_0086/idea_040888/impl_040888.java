...
@Data
public class Idea40888Config {
    private String name = "idea_040888";
 ...
 */
@Slf4j
public class Idea40888Service {
    private static final int IDEA_ID = 40888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40888Service() {
        this(new Idea40888Config());
    }

    public Idea40888Service(Idea40888Config config) {
        this.config = config != null ? config : new Idea40888Config();
