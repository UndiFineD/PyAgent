...
@Data
public class Idea41023Config {
    private String name = "idea_041023";
 ...
 */
@Slf4j
public class Idea41023Service {
    private static final int IDEA_ID = 41023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41023Service() {
        this(new Idea41023Config());
    }

    public Idea41023Service(Idea41023Config config) {
        this.config = config != null ? config : new Idea41023Config();
