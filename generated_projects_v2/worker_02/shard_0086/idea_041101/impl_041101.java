...
@Data
public class Idea41101Config {
    private String name = "idea_041101";
 ...
 */
@Slf4j
public class Idea41101Service {
    private static final int IDEA_ID = 41101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41101Service() {
        this(new Idea41101Config());
    }

    public Idea41101Service(Idea41101Config config) {
        this.config = config != null ? config : new Idea41101Config();
