...
@Data
public class Idea40946Config {
    private String name = "idea_040946";
 ...
 */
@Slf4j
public class Idea40946Service {
    private static final int IDEA_ID = 40946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40946Service() {
        this(new Idea40946Config());
    }

    public Idea40946Service(Idea40946Config config) {
        this.config = config != null ? config : new Idea40946Config();
