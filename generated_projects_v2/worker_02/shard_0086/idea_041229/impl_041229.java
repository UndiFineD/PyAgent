...
@Data
public class Idea41229Config {
    private String name = "idea_041229";
 ...
 */
@Slf4j
public class Idea41229Service {
    private static final int IDEA_ID = 41229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41229Service() {
        this(new Idea41229Config());
    }

    public Idea41229Service(Idea41229Config config) {
        this.config = config != null ? config : new Idea41229Config();
