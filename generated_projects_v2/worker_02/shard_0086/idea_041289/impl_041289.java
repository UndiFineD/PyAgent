...
@Data
public class Idea41289Config {
    private String name = "idea_041289";
 ...
 */
@Slf4j
public class Idea41289Service {
    private static final int IDEA_ID = 41289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41289Service() {
        this(new Idea41289Config());
    }

    public Idea41289Service(Idea41289Config config) {
        this.config = config != null ? config : new Idea41289Config();
