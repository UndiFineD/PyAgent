...
@Data
public class Idea40977Config {
    private String name = "idea_040977";
 ...
 */
@Slf4j
public class Idea40977Service {
    private static final int IDEA_ID = 40977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40977Service() {
        this(new Idea40977Config());
    }

    public Idea40977Service(Idea40977Config config) {
        this.config = config != null ? config : new Idea40977Config();
