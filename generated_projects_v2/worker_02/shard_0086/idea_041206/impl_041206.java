...
@Data
public class Idea41206Config {
    private String name = "idea_041206";
 ...
 */
@Slf4j
public class Idea41206Service {
    private static final int IDEA_ID = 41206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41206Service() {
        this(new Idea41206Config());
    }

    public Idea41206Service(Idea41206Config config) {
        this.config = config != null ? config : new Idea41206Config();
