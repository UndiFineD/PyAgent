...
@Data
public class Idea41103Config {
    private String name = "idea_041103";
 ...
 */
@Slf4j
public class Idea41103Service {
    private static final int IDEA_ID = 41103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41103Service() {
        this(new Idea41103Config());
    }

    public Idea41103Service(Idea41103Config config) {
        this.config = config != null ? config : new Idea41103Config();
