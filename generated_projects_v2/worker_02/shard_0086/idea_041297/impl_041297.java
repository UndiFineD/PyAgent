...
@Data
public class Idea41297Config {
    private String name = "idea_041297";
 ...
 */
@Slf4j
public class Idea41297Service {
    private static final int IDEA_ID = 41297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41297Service() {
        this(new Idea41297Config());
    }

    public Idea41297Service(Idea41297Config config) {
        this.config = config != null ? config : new Idea41297Config();
