...
@Data
public class Idea41134Config {
    private String name = "idea_041134";
 ...
 */
@Slf4j
public class Idea41134Service {
    private static final int IDEA_ID = 41134;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41134Service() {
        this(new Idea41134Config());
    }

    public Idea41134Service(Idea41134Config config) {
        this.config = config != null ? config : new Idea41134Config();
