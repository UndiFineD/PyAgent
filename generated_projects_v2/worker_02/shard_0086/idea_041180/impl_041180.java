...
@Data
public class Idea41180Config {
    private String name = "idea_041180";
 ...
 */
@Slf4j
public class Idea41180Service {
    private static final int IDEA_ID = 41180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41180Service() {
        this(new Idea41180Config());
    }

    public Idea41180Service(Idea41180Config config) {
        this.config = config != null ? config : new Idea41180Config();
