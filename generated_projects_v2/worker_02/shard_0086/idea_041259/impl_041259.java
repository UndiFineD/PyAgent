...
@Data
public class Idea41259Config {
    private String name = "idea_041259";
 ...
 */
@Slf4j
public class Idea41259Service {
    private static final int IDEA_ID = 41259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41259Service() {
        this(new Idea41259Config());
    }

    public Idea41259Service(Idea41259Config config) {
        this.config = config != null ? config : new Idea41259Config();
