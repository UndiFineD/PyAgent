...
@Data
public class Idea40983Config {
    private String name = "idea_040983";
 ...
 */
@Slf4j
public class Idea40983Service {
    private static final int IDEA_ID = 40983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40983Service() {
        this(new Idea40983Config());
    }

    public Idea40983Service(Idea40983Config config) {
        this.config = config != null ? config : new Idea40983Config();
