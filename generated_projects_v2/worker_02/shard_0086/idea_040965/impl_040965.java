...
@Data
public class Idea40965Config {
    private String name = "idea_040965";
 ...
 */
@Slf4j
public class Idea40965Service {
    private static final int IDEA_ID = 40965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40965Service() {
        this(new Idea40965Config());
    }

    public Idea40965Service(Idea40965Config config) {
        this.config = config != null ? config : new Idea40965Config();
