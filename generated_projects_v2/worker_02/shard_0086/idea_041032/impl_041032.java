...
@Data
public class Idea41032Config {
    private String name = "idea_041032";
 ...
 */
@Slf4j
public class Idea41032Service {
    private static final int IDEA_ID = 41032;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41032Service() {
        this(new Idea41032Config());
    }

    public Idea41032Service(Idea41032Config config) {
        this.config = config != null ? config : new Idea41032Config();
