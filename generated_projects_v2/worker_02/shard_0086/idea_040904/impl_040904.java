...
@Data
public class Idea40904Config {
    private String name = "idea_040904";
 ...
 */
@Slf4j
public class Idea40904Service {
    private static final int IDEA_ID = 40904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40904Service() {
        this(new Idea40904Config());
    }

    public Idea40904Service(Idea40904Config config) {
        this.config = config != null ? config : new Idea40904Config();
