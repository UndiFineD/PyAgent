...
@Data
public class Idea41139Config {
    private String name = "idea_041139";
 ...
 */
@Slf4j
public class Idea41139Service {
    private static final int IDEA_ID = 41139;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41139Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41139Service() {
        this(new Idea41139Config());
    }

    public Idea41139Service(Idea41139Config config) {
        this.config = config != null ? config : new Idea41139Config();
