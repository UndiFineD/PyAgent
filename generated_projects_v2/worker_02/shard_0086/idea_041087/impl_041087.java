...
@Data
public class Idea41087Config {
    private String name = "idea_041087";
 ...
 */
@Slf4j
public class Idea41087Service {
    private static final int IDEA_ID = 41087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41087Service() {
        this(new Idea41087Config());
    }

    public Idea41087Service(Idea41087Config config) {
        this.config = config != null ? config : new Idea41087Config();
