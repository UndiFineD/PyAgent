...
@Data
public class Idea41057Config {
    private String name = "idea_041057";
 ...
 */
@Slf4j
public class Idea41057Service {
    private static final int IDEA_ID = 41057;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41057Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41057Service() {
        this(new Idea41057Config());
    }

    public Idea41057Service(Idea41057Config config) {
        this.config = config != null ? config : new Idea41057Config();
