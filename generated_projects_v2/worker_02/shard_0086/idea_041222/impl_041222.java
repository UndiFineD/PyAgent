...
@Data
public class Idea41222Config {
    private String name = "idea_041222";
 ...
 */
@Slf4j
public class Idea41222Service {
    private static final int IDEA_ID = 41222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41222Service() {
        this(new Idea41222Config());
    }

    public Idea41222Service(Idea41222Config config) {
        this.config = config != null ? config : new Idea41222Config();
