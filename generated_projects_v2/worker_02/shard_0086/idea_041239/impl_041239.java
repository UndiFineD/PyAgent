...
@Data
public class Idea41239Config {
    private String name = "idea_041239";
 ...
 */
@Slf4j
public class Idea41239Service {
    private static final int IDEA_ID = 41239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41239Service() {
        this(new Idea41239Config());
    }

    public Idea41239Service(Idea41239Config config) {
        this.config = config != null ? config : new Idea41239Config();
