...
@Data
public class Idea40877Config {
    private String name = "idea_040877";
 ...
 */
@Slf4j
public class Idea40877Service {
    private static final int IDEA_ID = 40877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40877Service() {
        this(new Idea40877Config());
    }

    public Idea40877Service(Idea40877Config config) {
        this.config = config != null ? config : new Idea40877Config();
