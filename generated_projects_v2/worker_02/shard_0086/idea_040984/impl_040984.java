...
@Data
public class Idea40984Config {
    private String name = "idea_040984";
 ...
 */
@Slf4j
public class Idea40984Service {
    private static final int IDEA_ID = 40984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40984Service() {
        this(new Idea40984Config());
    }

    public Idea40984Service(Idea40984Config config) {
        this.config = config != null ? config : new Idea40984Config();
