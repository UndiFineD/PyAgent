...
@Data
public class Idea41003Config {
    private String name = "idea_041003";
 ...
 */
@Slf4j
public class Idea41003Service {
    private static final int IDEA_ID = 41003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41003Service() {
        this(new Idea41003Config());
    }

    public Idea41003Service(Idea41003Config config) {
        this.config = config != null ? config : new Idea41003Config();
