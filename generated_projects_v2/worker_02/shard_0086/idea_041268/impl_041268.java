...
@Data
public class Idea41268Config {
    private String name = "idea_041268";
 ...
 */
@Slf4j
public class Idea41268Service {
    private static final int IDEA_ID = 41268;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41268Service() {
        this(new Idea41268Config());
    }

    public Idea41268Service(Idea41268Config config) {
        this.config = config != null ? config : new Idea41268Config();
