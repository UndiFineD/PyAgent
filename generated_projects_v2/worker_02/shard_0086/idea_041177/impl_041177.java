...
@Data
public class Idea41177Config {
    private String name = "idea_041177";
 ...
 */
@Slf4j
public class Idea41177Service {
    private static final int IDEA_ID = 41177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41177Service() {
        this(new Idea41177Config());
    }

    public Idea41177Service(Idea41177Config config) {
        this.config = config != null ? config : new Idea41177Config();
