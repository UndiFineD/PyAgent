...
@Data
public class Idea41298Config {
    private String name = "idea_041298";
 ...
 */
@Slf4j
public class Idea41298Service {
    private static final int IDEA_ID = 41298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41298Service() {
        this(new Idea41298Config());
    }

    public Idea41298Service(Idea41298Config config) {
        this.config = config != null ? config : new Idea41298Config();
