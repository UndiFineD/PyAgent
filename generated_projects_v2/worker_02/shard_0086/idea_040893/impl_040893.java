...
@Data
public class Idea40893Config {
    private String name = "idea_040893";
 ...
 */
@Slf4j
public class Idea40893Service {
    private static final int IDEA_ID = 40893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40893Service() {
        this(new Idea40893Config());
    }

    public Idea40893Service(Idea40893Config config) {
        this.config = config != null ? config : new Idea40893Config();
