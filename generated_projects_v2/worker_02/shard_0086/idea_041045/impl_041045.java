...
@Data
public class Idea41045Config {
    private String name = "idea_041045";
 ...
 */
@Slf4j
public class Idea41045Service {
    private static final int IDEA_ID = 41045;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41045Service() {
        this(new Idea41045Config());
    }

    public Idea41045Service(Idea41045Config config) {
        this.config = config != null ? config : new Idea41045Config();
