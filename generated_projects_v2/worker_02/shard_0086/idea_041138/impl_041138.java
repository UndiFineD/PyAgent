...
@Data
public class Idea41138Config {
    private String name = "idea_041138";
 ...
 */
@Slf4j
public class Idea41138Service {
    private static final int IDEA_ID = 41138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41138Service() {
        this(new Idea41138Config());
    }

    public Idea41138Service(Idea41138Config config) {
        this.config = config != null ? config : new Idea41138Config();
