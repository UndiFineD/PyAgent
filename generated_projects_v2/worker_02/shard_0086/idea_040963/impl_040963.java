...
@Data
public class Idea40963Config {
    private String name = "idea_040963";
 ...
 */
@Slf4j
public class Idea40963Service {
    private static final int IDEA_ID = 40963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40963Service() {
        this(new Idea40963Config());
    }

    public Idea40963Service(Idea40963Config config) {
        this.config = config != null ? config : new Idea40963Config();
