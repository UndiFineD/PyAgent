...
@Data
public class Idea41157Config {
    private String name = "idea_041157";
 ...
 */
@Slf4j
public class Idea41157Service {
    private static final int IDEA_ID = 41157;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41157Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41157Service() {
        this(new Idea41157Config());
    }

    public Idea41157Service(Idea41157Config config) {
        this.config = config != null ? config : new Idea41157Config();
