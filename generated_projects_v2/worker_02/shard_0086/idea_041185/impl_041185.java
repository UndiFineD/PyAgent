...
@Data
public class Idea41185Config {
    private String name = "idea_041185";
 ...
 */
@Slf4j
public class Idea41185Service {
    private static final int IDEA_ID = 41185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41185Service() {
        this(new Idea41185Config());
    }

    public Idea41185Service(Idea41185Config config) {
        this.config = config != null ? config : new Idea41185Config();
