...
@Data
public class Idea40878Config {
    private String name = "idea_040878";
 ...
 */
@Slf4j
public class Idea40878Service {
    private static final int IDEA_ID = 40878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40878Service() {
        this(new Idea40878Config());
    }

    public Idea40878Service(Idea40878Config config) {
        this.config = config != null ? config : new Idea40878Config();
