...
@Data
public class Idea40911Config {
    private String name = "idea_040911";
 ...
 */
@Slf4j
public class Idea40911Service {
    private static final int IDEA_ID = 40911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40911Service() {
        this(new Idea40911Config());
    }

    public Idea40911Service(Idea40911Config config) {
        this.config = config != null ? config : new Idea40911Config();
