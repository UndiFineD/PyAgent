...
@Data
public class Idea41117Config {
    private String name = "idea_041117";
 ...
 */
@Slf4j
public class Idea41117Service {
    private static final int IDEA_ID = 41117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41117Service() {
        this(new Idea41117Config());
    }

    public Idea41117Service(Idea41117Config config) {
        this.config = config != null ? config : new Idea41117Config();
