...
@Data
public class Idea40972Config {
    private String name = "idea_040972";
 ...
 */
@Slf4j
public class Idea40972Service {
    private static final int IDEA_ID = 40972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40972Service() {
        this(new Idea40972Config());
    }

    public Idea40972Service(Idea40972Config config) {
        this.config = config != null ? config : new Idea40972Config();
