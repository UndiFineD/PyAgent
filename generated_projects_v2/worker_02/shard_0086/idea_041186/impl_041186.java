...
@Data
public class Idea41186Config {
    private String name = "idea_041186";
 ...
 */
@Slf4j
public class Idea41186Service {
    private static final int IDEA_ID = 41186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41186Service() {
        this(new Idea41186Config());
    }

    public Idea41186Service(Idea41186Config config) {
        this.config = config != null ? config : new Idea41186Config();
