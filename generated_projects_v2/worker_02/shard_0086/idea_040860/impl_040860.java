...
@Data
public class Idea40860Config {
    private String name = "idea_040860";
 ...
 */
@Slf4j
public class Idea40860Service {
    private static final int IDEA_ID = 40860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40860Service() {
        this(new Idea40860Config());
    }

    public Idea40860Service(Idea40860Config config) {
        this.config = config != null ? config : new Idea40860Config();
