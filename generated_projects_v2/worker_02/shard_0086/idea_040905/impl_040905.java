...
@Data
public class Idea40905Config {
    private String name = "idea_040905";
 ...
 */
@Slf4j
public class Idea40905Service {
    private static final int IDEA_ID = 40905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40905Service() {
        this(new Idea40905Config());
    }

    public Idea40905Service(Idea40905Config config) {
        this.config = config != null ? config : new Idea40905Config();
