...
@Data
public class Idea40950Config {
    private String name = "idea_040950";
 ...
 */
@Slf4j
public class Idea40950Service {
    private static final int IDEA_ID = 40950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40950Service() {
        this(new Idea40950Config());
    }

    public Idea40950Service(Idea40950Config config) {
        this.config = config != null ? config : new Idea40950Config();
