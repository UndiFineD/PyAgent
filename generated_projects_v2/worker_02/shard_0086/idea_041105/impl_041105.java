...
@Data
public class Idea41105Config {
    private String name = "idea_041105";
 ...
 */
@Slf4j
public class Idea41105Service {
    private static final int IDEA_ID = 41105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41105Service() {
        this(new Idea41105Config());
    }

    public Idea41105Service(Idea41105Config config) {
        this.config = config != null ? config : new Idea41105Config();
