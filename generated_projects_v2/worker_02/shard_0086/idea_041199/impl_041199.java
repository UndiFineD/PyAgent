...
@Data
public class Idea41199Config {
    private String name = "idea_041199";
 ...
 */
@Slf4j
public class Idea41199Service {
    private static final int IDEA_ID = 41199;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41199Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41199Service() {
        this(new Idea41199Config());
    }

    public Idea41199Service(Idea41199Config config) {
        this.config = config != null ? config : new Idea41199Config();
