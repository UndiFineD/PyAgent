...
@Data
public class Idea40951Config {
    private String name = "idea_040951";
 ...
 */
@Slf4j
public class Idea40951Service {
    private static final int IDEA_ID = 40951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40951Service() {
        this(new Idea40951Config());
    }

    public Idea40951Service(Idea40951Config config) {
        this.config = config != null ? config : new Idea40951Config();
