...
@Data
public class Idea40969Config {
    private String name = "idea_040969";
 ...
 */
@Slf4j
public class Idea40969Service {
    private static final int IDEA_ID = 40969;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40969Service() {
        this(new Idea40969Config());
    }

    public Idea40969Service(Idea40969Config config) {
        this.config = config != null ? config : new Idea40969Config();
