...
@Data
public class Idea41304Config {
    private String name = "idea_041304";
 ...
 */
@Slf4j
public class Idea41304Service {
    private static final int IDEA_ID = 41304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41304Service() {
        this(new Idea41304Config());
    }

    public Idea41304Service(Idea41304Config config) {
        this.config = config != null ? config : new Idea41304Config();
