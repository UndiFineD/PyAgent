...
@Data
public class Idea41210Config {
    private String name = "idea_041210";
 ...
 */
@Slf4j
public class Idea41210Service {
    private static final int IDEA_ID = 41210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41210Service() {
        this(new Idea41210Config());
    }

    public Idea41210Service(Idea41210Config config) {
        this.config = config != null ? config : new Idea41210Config();
