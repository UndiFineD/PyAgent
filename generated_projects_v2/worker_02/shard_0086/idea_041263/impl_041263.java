...
@Data
public class Idea41263Config {
    private String name = "idea_041263";
 ...
 */
@Slf4j
public class Idea41263Service {
    private static final int IDEA_ID = 41263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41263Service() {
        this(new Idea41263Config());
    }

    public Idea41263Service(Idea41263Config config) {
        this.config = config != null ? config : new Idea41263Config();
