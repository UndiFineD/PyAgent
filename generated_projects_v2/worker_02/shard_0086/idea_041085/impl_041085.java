...
@Data
public class Idea41085Config {
    private String name = "idea_041085";
 ...
 */
@Slf4j
public class Idea41085Service {
    private static final int IDEA_ID = 41085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41085Service() {
        this(new Idea41085Config());
    }

    public Idea41085Service(Idea41085Config config) {
        this.config = config != null ? config : new Idea41085Config();
