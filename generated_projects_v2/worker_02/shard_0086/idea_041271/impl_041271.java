...
@Data
public class Idea41271Config {
    private String name = "idea_041271";
 ...
 */
@Slf4j
public class Idea41271Service {
    private static final int IDEA_ID = 41271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41271Service() {
        this(new Idea41271Config());
    }

    public Idea41271Service(Idea41271Config config) {
        this.config = config != null ? config : new Idea41271Config();
