...
@Data
public class Idea41194Config {
    private String name = "idea_041194";
 ...
 */
@Slf4j
public class Idea41194Service {
    private static final int IDEA_ID = 41194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41194Service() {
        this(new Idea41194Config());
    }

    public Idea41194Service(Idea41194Config config) {
        this.config = config != null ? config : new Idea41194Config();
