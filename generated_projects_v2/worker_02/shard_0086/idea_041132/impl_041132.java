...
@Data
public class Idea41132Config {
    private String name = "idea_041132";
 ...
 */
@Slf4j
public class Idea41132Service {
    private static final int IDEA_ID = 41132;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41132Service() {
        this(new Idea41132Config());
    }

    public Idea41132Service(Idea41132Config config) {
        this.config = config != null ? config : new Idea41132Config();
