...
@Data
public class Idea41142Config {
    private String name = "idea_041142";
 ...
 */
@Slf4j
public class Idea41142Service {
    private static final int IDEA_ID = 41142;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41142Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41142Service() {
        this(new Idea41142Config());
    }

    public Idea41142Service(Idea41142Config config) {
        this.config = config != null ? config : new Idea41142Config();
