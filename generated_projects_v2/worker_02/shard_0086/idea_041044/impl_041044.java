...
@Data
public class Idea41044Config {
    private String name = "idea_041044";
 ...
 */
@Slf4j
public class Idea41044Service {
    private static final int IDEA_ID = 41044;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41044Service() {
        this(new Idea41044Config());
    }

    public Idea41044Service(Idea41044Config config) {
        this.config = config != null ? config : new Idea41044Config();
