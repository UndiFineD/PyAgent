...
@Data
public class Idea41154Config {
    private String name = "idea_041154";
 ...
 */
@Slf4j
public class Idea41154Service {
    private static final int IDEA_ID = 41154;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41154Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41154Service() {
        this(new Idea41154Config());
    }

    public Idea41154Service(Idea41154Config config) {
        this.config = config != null ? config : new Idea41154Config();
