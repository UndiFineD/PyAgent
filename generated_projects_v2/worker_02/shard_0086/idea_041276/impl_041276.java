...
@Data
public class Idea41276Config {
    private String name = "idea_041276";
 ...
 */
@Slf4j
public class Idea41276Service {
    private static final int IDEA_ID = 41276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41276Service() {
        this(new Idea41276Config());
    }

    public Idea41276Service(Idea41276Config config) {
        this.config = config != null ? config : new Idea41276Config();
