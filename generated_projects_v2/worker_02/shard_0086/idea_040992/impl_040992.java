...
@Data
public class Idea40992Config {
    private String name = "idea_040992";
 ...
 */
@Slf4j
public class Idea40992Service {
    private static final int IDEA_ID = 40992;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40992Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40992Service() {
        this(new Idea40992Config());
    }

    public Idea40992Service(Idea40992Config config) {
        this.config = config != null ? config : new Idea40992Config();
