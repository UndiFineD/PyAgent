...
@Data
public class Idea41179Config {
    private String name = "idea_041179";
 ...
 */
@Slf4j
public class Idea41179Service {
    private static final int IDEA_ID = 41179;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41179Service() {
        this(new Idea41179Config());
    }

    public Idea41179Service(Idea41179Config config) {
        this.config = config != null ? config : new Idea41179Config();
