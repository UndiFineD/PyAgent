...
@Data
public class Idea40910Config {
    private String name = "idea_040910";
 ...
 */
@Slf4j
public class Idea40910Service {
    private static final int IDEA_ID = 40910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40910Service() {
        this(new Idea40910Config());
    }

    public Idea40910Service(Idea40910Config config) {
        this.config = config != null ? config : new Idea40910Config();
