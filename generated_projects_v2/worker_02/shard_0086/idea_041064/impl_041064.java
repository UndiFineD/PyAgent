...
@Data
public class Idea41064Config {
    private String name = "idea_041064";
 ...
 */
@Slf4j
public class Idea41064Service {
    private static final int IDEA_ID = 41064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41064Service() {
        this(new Idea41064Config());
    }

    public Idea41064Service(Idea41064Config config) {
        this.config = config != null ? config : new Idea41064Config();
