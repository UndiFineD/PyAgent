...
@Data
public class Idea41095Config {
    private String name = "idea_041095";
 ...
 */
@Slf4j
public class Idea41095Service {
    private static final int IDEA_ID = 41095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41095Service() {
        this(new Idea41095Config());
    }

    public Idea41095Service(Idea41095Config config) {
        this.config = config != null ? config : new Idea41095Config();
