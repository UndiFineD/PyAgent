...
@Data
public class Idea41323Config {
    private String name = "idea_041323";
 ...
 */
@Slf4j
public class Idea41323Service {
    private static final int IDEA_ID = 41323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41323Service() {
        this(new Idea41323Config());
    }

    public Idea41323Service(Idea41323Config config) {
        this.config = config != null ? config : new Idea41323Config();
