...
@Data
public class Idea41100Config {
    private String name = "idea_041100";
 ...
 */
@Slf4j
public class Idea41100Service {
    private static final int IDEA_ID = 41100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41100Service() {
        this(new Idea41100Config());
    }

    public Idea41100Service(Idea41100Config config) {
        this.config = config != null ? config : new Idea41100Config();
