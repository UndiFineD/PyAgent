...
@Data
public class Idea41026Config {
    private String name = "idea_041026";
 ...
 */
@Slf4j
public class Idea41026Service {
    private static final int IDEA_ID = 41026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41026Service() {
        this(new Idea41026Config());
    }

    public Idea41026Service(Idea41026Config config) {
        this.config = config != null ? config : new Idea41026Config();
