...
@Data
public class Idea41084Config {
    private String name = "idea_041084";
 ...
 */
@Slf4j
public class Idea41084Service {
    private static final int IDEA_ID = 41084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41084Service() {
        this(new Idea41084Config());
    }

    public Idea41084Service(Idea41084Config config) {
        this.config = config != null ? config : new Idea41084Config();
