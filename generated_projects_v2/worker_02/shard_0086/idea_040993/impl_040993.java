...
@Data
public class Idea40993Config {
    private String name = "idea_040993";
 ...
 */
@Slf4j
public class Idea40993Service {
    private static final int IDEA_ID = 40993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40993Service() {
        this(new Idea40993Config());
    }

    public Idea40993Service(Idea40993Config config) {
        this.config = config != null ? config : new Idea40993Config();
