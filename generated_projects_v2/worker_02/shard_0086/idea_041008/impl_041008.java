...
@Data
public class Idea41008Config {
    private String name = "idea_041008";
 ...
 */
@Slf4j
public class Idea41008Service {
    private static final int IDEA_ID = 41008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41008Service() {
        this(new Idea41008Config());
    }

    public Idea41008Service(Idea41008Config config) {
        this.config = config != null ? config : new Idea41008Config();
