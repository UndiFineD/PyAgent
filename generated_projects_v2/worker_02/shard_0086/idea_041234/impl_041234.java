...
@Data
public class Idea41234Config {
    private String name = "idea_041234";
 ...
 */
@Slf4j
public class Idea41234Service {
    private static final int IDEA_ID = 41234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41234Service() {
        this(new Idea41234Config());
    }

    public Idea41234Service(Idea41234Config config) {
        this.config = config != null ? config : new Idea41234Config();
