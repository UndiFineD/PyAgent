...
@Data
public class Idea40890Config {
    private String name = "idea_040890";
 ...
 */
@Slf4j
public class Idea40890Service {
    private static final int IDEA_ID = 40890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40890Service() {
        this(new Idea40890Config());
    }

    public Idea40890Service(Idea40890Config config) {
        this.config = config != null ? config : new Idea40890Config();
