...
@Data
public class Idea41034Config {
    private String name = "idea_041034";
 ...
 */
@Slf4j
public class Idea41034Service {
    private static final int IDEA_ID = 41034;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41034Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41034Service() {
        this(new Idea41034Config());
    }

    public Idea41034Service(Idea41034Config config) {
        this.config = config != null ? config : new Idea41034Config();
