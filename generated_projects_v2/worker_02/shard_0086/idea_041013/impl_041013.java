...
@Data
public class Idea41013Config {
    private String name = "idea_041013";
 ...
 */
@Slf4j
public class Idea41013Service {
    private static final int IDEA_ID = 41013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41013Service() {
        this(new Idea41013Config());
    }

    public Idea41013Service(Idea41013Config config) {
        this.config = config != null ? config : new Idea41013Config();
