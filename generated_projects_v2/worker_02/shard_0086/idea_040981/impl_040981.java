...
@Data
public class Idea40981Config {
    private String name = "idea_040981";
 ...
 */
@Slf4j
public class Idea40981Service {
    private static final int IDEA_ID = 40981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40981Service() {
        this(new Idea40981Config());
    }

    public Idea40981Service(Idea40981Config config) {
        this.config = config != null ? config : new Idea40981Config();
