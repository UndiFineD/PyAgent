...
@Data
public class Idea41282Config {
    private String name = "idea_041282";
 ...
 */
@Slf4j
public class Idea41282Service {
    private static final int IDEA_ID = 41282;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41282Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41282Service() {
        this(new Idea41282Config());
    }

    public Idea41282Service(Idea41282Config config) {
        this.config = config != null ? config : new Idea41282Config();
