...
@Data
public class Idea41307Config {
    private String name = "idea_041307";
 ...
 */
@Slf4j
public class Idea41307Service {
    private static final int IDEA_ID = 41307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41307Service() {
        this(new Idea41307Config());
    }

    public Idea41307Service(Idea41307Config config) {
        this.config = config != null ? config : new Idea41307Config();
