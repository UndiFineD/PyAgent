...
@Data
public class Idea41176Config {
    private String name = "idea_041176";
 ...
 */
@Slf4j
public class Idea41176Service {
    private static final int IDEA_ID = 41176;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41176Service() {
        this(new Idea41176Config());
    }

    public Idea41176Service(Idea41176Config config) {
        this.config = config != null ? config : new Idea41176Config();
