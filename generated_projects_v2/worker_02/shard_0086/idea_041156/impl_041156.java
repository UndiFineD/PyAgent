...
@Data
public class Idea41156Config {
    private String name = "idea_041156";
 ...
 */
@Slf4j
public class Idea41156Service {
    private static final int IDEA_ID = 41156;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41156Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41156Service() {
        this(new Idea41156Config());
    }

    public Idea41156Service(Idea41156Config config) {
        this.config = config != null ? config : new Idea41156Config();
