...
@Data
public class Idea40915Config {
    private String name = "idea_040915";
 ...
 */
@Slf4j
public class Idea40915Service {
    private static final int IDEA_ID = 40915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40915Service() {
        this(new Idea40915Config());
    }

    public Idea40915Service(Idea40915Config config) {
        this.config = config != null ? config : new Idea40915Config();
