...
@Data
public class Idea41014Config {
    private String name = "idea_041014";
 ...
 */
@Slf4j
public class Idea41014Service {
    private static final int IDEA_ID = 41014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41014Service() {
        this(new Idea41014Config());
    }

    public Idea41014Service(Idea41014Config config) {
        this.config = config != null ? config : new Idea41014Config();
