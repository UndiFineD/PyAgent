...
@Data
public class Idea41203Config {
    private String name = "idea_041203";
 ...
 */
@Slf4j
public class Idea41203Service {
    private static final int IDEA_ID = 41203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41203Service() {
        this(new Idea41203Config());
    }

    public Idea41203Service(Idea41203Config config) {
        this.config = config != null ? config : new Idea41203Config();
