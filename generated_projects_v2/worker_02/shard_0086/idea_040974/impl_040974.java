...
@Data
public class Idea40974Config {
    private String name = "idea_040974";
 ...
 */
@Slf4j
public class Idea40974Service {
    private static final int IDEA_ID = 40974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40974Service() {
        this(new Idea40974Config());
    }

    public Idea40974Service(Idea40974Config config) {
        this.config = config != null ? config : new Idea40974Config();
