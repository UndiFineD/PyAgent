...
@Data
public class Idea41077Config {
    private String name = "idea_041077";
 ...
 */
@Slf4j
public class Idea41077Service {
    private static final int IDEA_ID = 41077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41077Service() {
        this(new Idea41077Config());
    }

    public Idea41077Service(Idea41077Config config) {
        this.config = config != null ? config : new Idea41077Config();
