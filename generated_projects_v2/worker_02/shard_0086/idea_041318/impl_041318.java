...
@Data
public class Idea41318Config {
    private String name = "idea_041318";
 ...
 */
@Slf4j
public class Idea41318Service {
    private static final int IDEA_ID = 41318;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41318Service() {
        this(new Idea41318Config());
    }

    public Idea41318Service(Idea41318Config config) {
        this.config = config != null ? config : new Idea41318Config();
