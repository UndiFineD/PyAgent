...
@Data
public class Idea40924Config {
    private String name = "idea_040924";
 ...
 */
@Slf4j
public class Idea40924Service {
    private static final int IDEA_ID = 40924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40924Service() {
        this(new Idea40924Config());
    }

    public Idea40924Service(Idea40924Config config) {
        this.config = config != null ? config : new Idea40924Config();
