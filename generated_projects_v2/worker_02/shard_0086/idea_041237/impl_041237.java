...
@Data
public class Idea41237Config {
    private String name = "idea_041237";
 ...
 */
@Slf4j
public class Idea41237Service {
    private static final int IDEA_ID = 41237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41237Service() {
        this(new Idea41237Config());
    }

    public Idea41237Service(Idea41237Config config) {
        this.config = config != null ? config : new Idea41237Config();
