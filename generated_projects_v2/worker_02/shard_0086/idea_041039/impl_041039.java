...
@Data
public class Idea41039Config {
    private String name = "idea_041039";
 ...
 */
@Slf4j
public class Idea41039Service {
    private static final int IDEA_ID = 41039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41039Service() {
        this(new Idea41039Config());
    }

    public Idea41039Service(Idea41039Config config) {
        this.config = config != null ? config : new Idea41039Config();
