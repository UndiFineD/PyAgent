...
@Data
public class Idea41118Config {
    private String name = "idea_041118";
 ...
 */
@Slf4j
public class Idea41118Service {
    private static final int IDEA_ID = 41118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41118Service() {
        this(new Idea41118Config());
    }

    public Idea41118Service(Idea41118Config config) {
        this.config = config != null ? config : new Idea41118Config();
