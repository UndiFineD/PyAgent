...
@Data
public class Idea41158Config {
    private String name = "idea_041158";
 ...
 */
@Slf4j
public class Idea41158Service {
    private static final int IDEA_ID = 41158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41158Service() {
        this(new Idea41158Config());
    }

    public Idea41158Service(Idea41158Config config) {
        this.config = config != null ? config : new Idea41158Config();
