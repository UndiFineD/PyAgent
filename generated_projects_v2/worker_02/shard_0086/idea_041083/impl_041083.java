...
@Data
public class Idea41083Config {
    private String name = "idea_041083";
 ...
 */
@Slf4j
public class Idea41083Service {
    private static final int IDEA_ID = 41083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41083Service() {
        this(new Idea41083Config());
    }

    public Idea41083Service(Idea41083Config config) {
        this.config = config != null ? config : new Idea41083Config();
