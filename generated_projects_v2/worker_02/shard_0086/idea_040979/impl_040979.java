...
@Data
public class Idea40979Config {
    private String name = "idea_040979";
 ...
 */
@Slf4j
public class Idea40979Service {
    private static final int IDEA_ID = 40979;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40979Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40979Service() {
        this(new Idea40979Config());
    }

    public Idea40979Service(Idea40979Config config) {
        this.config = config != null ? config : new Idea40979Config();
