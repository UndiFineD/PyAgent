...
@Data
public class Idea41114Config {
    private String name = "idea_041114";
 ...
 */
@Slf4j
public class Idea41114Service {
    private static final int IDEA_ID = 41114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41114Service() {
        this(new Idea41114Config());
    }

    public Idea41114Service(Idea41114Config config) {
        this.config = config != null ? config : new Idea41114Config();
