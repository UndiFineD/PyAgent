...
@Data
public class Idea41238Config {
    private String name = "idea_041238";
 ...
 */
@Slf4j
public class Idea41238Service {
    private static final int IDEA_ID = 41238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41238Service() {
        this(new Idea41238Config());
    }

    public Idea41238Service(Idea41238Config config) {
        this.config = config != null ? config : new Idea41238Config();
