...
@Data
public class Idea41038Config {
    private String name = "idea_041038";
 ...
 */
@Slf4j
public class Idea41038Service {
    private static final int IDEA_ID = 41038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41038Service() {
        this(new Idea41038Config());
    }

    public Idea41038Service(Idea41038Config config) {
        this.config = config != null ? config : new Idea41038Config();
