...
@Data
public class Idea40971Config {
    private String name = "idea_040971";
 ...
 */
@Slf4j
public class Idea40971Service {
    private static final int IDEA_ID = 40971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40971Service() {
        this(new Idea40971Config());
    }

    public Idea40971Service(Idea40971Config config) {
        this.config = config != null ? config : new Idea40971Config();
