...
@Data
public class Idea41195Config {
    private String name = "idea_041195";
 ...
 */
@Slf4j
public class Idea41195Service {
    private static final int IDEA_ID = 41195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41195Service() {
        this(new Idea41195Config());
    }

    public Idea41195Service(Idea41195Config config) {
        this.config = config != null ? config : new Idea41195Config();
