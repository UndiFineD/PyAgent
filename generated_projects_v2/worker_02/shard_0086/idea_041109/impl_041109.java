...
@Data
public class Idea41109Config {
    private String name = "idea_041109";
 ...
 */
@Slf4j
public class Idea41109Service {
    private static final int IDEA_ID = 41109;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41109Service() {
        this(new Idea41109Config());
    }

    public Idea41109Service(Idea41109Config config) {
        this.config = config != null ? config : new Idea41109Config();
