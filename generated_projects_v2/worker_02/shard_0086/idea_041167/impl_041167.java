...
@Data
public class Idea41167Config {
    private String name = "idea_041167";
 ...
 */
@Slf4j
public class Idea41167Service {
    private static final int IDEA_ID = 41167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41167Service() {
        this(new Idea41167Config());
    }

    public Idea41167Service(Idea41167Config config) {
        this.config = config != null ? config : new Idea41167Config();
