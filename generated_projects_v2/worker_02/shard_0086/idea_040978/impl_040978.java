...
@Data
public class Idea40978Config {
    private String name = "idea_040978";
 ...
 */
@Slf4j
public class Idea40978Service {
    private static final int IDEA_ID = 40978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40978Service() {
        this(new Idea40978Config());
    }

    public Idea40978Service(Idea40978Config config) {
        this.config = config != null ? config : new Idea40978Config();
