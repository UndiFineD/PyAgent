...
@Data
public class Idea41283Config {
    private String name = "idea_041283";
 ...
 */
@Slf4j
public class Idea41283Service {
    private static final int IDEA_ID = 41283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41283Service() {
        this(new Idea41283Config());
    }

    public Idea41283Service(Idea41283Config config) {
        this.config = config != null ? config : new Idea41283Config();
