...
@Data
public class Idea40968Config {
    private String name = "idea_040968";
 ...
 */
@Slf4j
public class Idea40968Service {
    private static final int IDEA_ID = 40968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40968Service() {
        this(new Idea40968Config());
    }

    public Idea40968Service(Idea40968Config config) {
        this.config = config != null ? config : new Idea40968Config();
