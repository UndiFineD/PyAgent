...
@Data
public class Idea41089Config {
    private String name = "idea_041089";
 ...
 */
@Slf4j
public class Idea41089Service {
    private static final int IDEA_ID = 41089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41089Service() {
        this(new Idea41089Config());
    }

    public Idea41089Service(Idea41089Config config) {
        this.config = config != null ? config : new Idea41089Config();
