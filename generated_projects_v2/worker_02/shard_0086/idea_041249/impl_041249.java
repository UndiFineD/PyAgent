...
@Data
public class Idea41249Config {
    private String name = "idea_041249";
 ...
 */
@Slf4j
public class Idea41249Service {
    private static final int IDEA_ID = 41249;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41249Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41249Service() {
        this(new Idea41249Config());
    }

    public Idea41249Service(Idea41249Config config) {
        this.config = config != null ? config : new Idea41249Config();
