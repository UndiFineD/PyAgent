...
@Data
public class Idea40994Config {
    private String name = "idea_040994";
 ...
 */
@Slf4j
public class Idea40994Service {
    private static final int IDEA_ID = 40994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40994Service() {
        this(new Idea40994Config());
    }

    public Idea40994Service(Idea40994Config config) {
        this.config = config != null ? config : new Idea40994Config();
