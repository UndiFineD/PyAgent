...
@Data
public class Idea41113Config {
    private String name = "idea_041113";
 ...
 */
@Slf4j
public class Idea41113Service {
    private static final int IDEA_ID = 41113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41113Service() {
        this(new Idea41113Config());
    }

    public Idea41113Service(Idea41113Config config) {
        this.config = config != null ? config : new Idea41113Config();
