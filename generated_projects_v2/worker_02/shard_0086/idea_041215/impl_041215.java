...
@Data
public class Idea41215Config {
    private String name = "idea_041215";
 ...
 */
@Slf4j
public class Idea41215Service {
    private static final int IDEA_ID = 41215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41215Service() {
        this(new Idea41215Config());
    }

    public Idea41215Service(Idea41215Config config) {
        this.config = config != null ? config : new Idea41215Config();
