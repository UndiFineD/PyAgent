...
@Data
public class Idea40855Config {
    private String name = "idea_040855";
 ...
 */
@Slf4j
public class Idea40855Service {
    private static final int IDEA_ID = 40855;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40855Service() {
        this(new Idea40855Config());
    }

    public Idea40855Service(Idea40855Config config) {
        this.config = config != null ? config : new Idea40855Config();
