...
@Data
public class Idea40982Config {
    private String name = "idea_040982";
 ...
 */
@Slf4j
public class Idea40982Service {
    private static final int IDEA_ID = 40982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40982Service() {
        this(new Idea40982Config());
    }

    public Idea40982Service(Idea40982Config config) {
        this.config = config != null ? config : new Idea40982Config();
