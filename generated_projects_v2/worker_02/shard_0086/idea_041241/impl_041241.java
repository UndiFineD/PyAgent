...
@Data
public class Idea41241Config {
    private String name = "idea_041241";
 ...
 */
@Slf4j
public class Idea41241Service {
    private static final int IDEA_ID = 41241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41241Service() {
        this(new Idea41241Config());
    }

    public Idea41241Service(Idea41241Config config) {
        this.config = config != null ? config : new Idea41241Config();
