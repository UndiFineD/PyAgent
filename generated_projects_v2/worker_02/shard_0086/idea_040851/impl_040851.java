...
@Data
public class Idea40851Config {
    private String name = "idea_040851";
 ...
 */
@Slf4j
public class Idea40851Service {
    private static final int IDEA_ID = 40851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40851Service() {
        this(new Idea40851Config());
    }

    public Idea40851Service(Idea40851Config config) {
        this.config = config != null ? config : new Idea40851Config();
