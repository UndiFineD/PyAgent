...
@Data
public class Idea41192Config {
    private String name = "idea_041192";
 ...
 */
@Slf4j
public class Idea41192Service {
    private static final int IDEA_ID = 41192;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41192Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41192Service() {
        this(new Idea41192Config());
    }

    public Idea41192Service(Idea41192Config config) {
        this.config = config != null ? config : new Idea41192Config();
