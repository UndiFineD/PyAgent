...
@Data
public class Idea41124Config {
    private String name = "idea_041124";
 ...
 */
@Slf4j
public class Idea41124Service {
    private static final int IDEA_ID = 41124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41124Service() {
        this(new Idea41124Config());
    }

    public Idea41124Service(Idea41124Config config) {
        this.config = config != null ? config : new Idea41124Config();
