...
@Data
public class Idea41012Config {
    private String name = "idea_041012";
 ...
 */
@Slf4j
public class Idea41012Service {
    private static final int IDEA_ID = 41012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41012Service() {
        this(new Idea41012Config());
    }

    public Idea41012Service(Idea41012Config config) {
        this.config = config != null ? config : new Idea41012Config();
