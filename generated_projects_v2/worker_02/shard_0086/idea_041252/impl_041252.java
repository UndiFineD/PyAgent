...
@Data
public class Idea41252Config {
    private String name = "idea_041252";
 ...
 */
@Slf4j
public class Idea41252Service {
    private static final int IDEA_ID = 41252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41252Service() {
        this(new Idea41252Config());
    }

    public Idea41252Service(Idea41252Config config) {
        this.config = config != null ? config : new Idea41252Config();
