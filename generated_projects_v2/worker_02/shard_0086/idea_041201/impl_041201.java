...
@Data
public class Idea41201Config {
    private String name = "idea_041201";
 ...
 */
@Slf4j
public class Idea41201Service {
    private static final int IDEA_ID = 41201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41201Service() {
        this(new Idea41201Config());
    }

    public Idea41201Service(Idea41201Config config) {
        this.config = config != null ? config : new Idea41201Config();
