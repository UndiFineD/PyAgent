...
@Data
public class Idea41242Config {
    private String name = "idea_041242";
 ...
 */
@Slf4j
public class Idea41242Service {
    private static final int IDEA_ID = 41242;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41242Service() {
        this(new Idea41242Config());
    }

    public Idea41242Service(Idea41242Config config) {
        this.config = config != null ? config : new Idea41242Config();
