...
@Data
public class Idea41302Config {
    private String name = "idea_041302";
 ...
 */
@Slf4j
public class Idea41302Service {
    private static final int IDEA_ID = 41302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41302Service() {
        this(new Idea41302Config());
    }

    public Idea41302Service(Idea41302Config config) {
        this.config = config != null ? config : new Idea41302Config();
