...
@Data
public class Idea41063Config {
    private String name = "idea_041063";
 ...
 */
@Slf4j
public class Idea41063Service {
    private static final int IDEA_ID = 41063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41063Service() {
        this(new Idea41063Config());
    }

    public Idea41063Service(Idea41063Config config) {
        this.config = config != null ? config : new Idea41063Config();
