...
@Data
public class Idea41306Config {
    private String name = "idea_041306";
 ...
 */
@Slf4j
public class Idea41306Service {
    private static final int IDEA_ID = 41306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41306Service() {
        this(new Idea41306Config());
    }

    public Idea41306Service(Idea41306Config config) {
        this.config = config != null ? config : new Idea41306Config();
