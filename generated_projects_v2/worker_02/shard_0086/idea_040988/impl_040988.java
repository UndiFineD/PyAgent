...
@Data
public class Idea40988Config {
    private String name = "idea_040988";
 ...
 */
@Slf4j
public class Idea40988Service {
    private static final int IDEA_ID = 40988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40988Service() {
        this(new Idea40988Config());
    }

    public Idea40988Service(Idea40988Config config) {
        this.config = config != null ? config : new Idea40988Config();
