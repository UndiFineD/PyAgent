...
@Data
public class Idea41041Config {
    private String name = "idea_041041";
 ...
 */
@Slf4j
public class Idea41041Service {
    private static final int IDEA_ID = 41041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41041Service() {
        this(new Idea41041Config());
    }

    public Idea41041Service(Idea41041Config config) {
        this.config = config != null ? config : new Idea41041Config();
