...
@Data
public class Idea40986Config {
    private String name = "idea_040986";
 ...
 */
@Slf4j
public class Idea40986Service {
    private static final int IDEA_ID = 40986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40986Service() {
        this(new Idea40986Config());
    }

    public Idea40986Service(Idea40986Config config) {
        this.config = config != null ? config : new Idea40986Config();
