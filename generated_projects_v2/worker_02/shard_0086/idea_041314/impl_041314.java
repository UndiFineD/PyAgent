...
@Data
public class Idea41314Config {
    private String name = "idea_041314";
 ...
 */
@Slf4j
public class Idea41314Service {
    private static final int IDEA_ID = 41314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41314Service() {
        this(new Idea41314Config());
    }

    public Idea41314Service(Idea41314Config config) {
        this.config = config != null ? config : new Idea41314Config();
