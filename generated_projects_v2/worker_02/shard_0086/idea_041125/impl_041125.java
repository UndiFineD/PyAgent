...
@Data
public class Idea41125Config {
    private String name = "idea_041125";
 ...
 */
@Slf4j
public class Idea41125Service {
    private static final int IDEA_ID = 41125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41125Service() {
        this(new Idea41125Config());
    }

    public Idea41125Service(Idea41125Config config) {
        this.config = config != null ? config : new Idea41125Config();
