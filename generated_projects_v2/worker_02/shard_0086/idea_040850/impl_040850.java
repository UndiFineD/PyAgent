...
@Data
public class Idea40850Config {
    private String name = "idea_040850";
 ...
 */
@Slf4j
public class Idea40850Service {
    private static final int IDEA_ID = 40850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40850Service() {
        this(new Idea40850Config());
    }

    public Idea40850Service(Idea40850Config config) {
        this.config = config != null ? config : new Idea40850Config();
