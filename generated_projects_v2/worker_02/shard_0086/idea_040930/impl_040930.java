...
@Data
public class Idea40930Config {
    private String name = "idea_040930";
 ...
 */
@Slf4j
public class Idea40930Service {
    private static final int IDEA_ID = 40930;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40930Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40930Service() {
        this(new Idea40930Config());
    }

    public Idea40930Service(Idea40930Config config) {
        this.config = config != null ? config : new Idea40930Config();
