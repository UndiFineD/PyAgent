...
@Data
public class Idea40995Config {
    private String name = "idea_040995";
 ...
 */
@Slf4j
public class Idea40995Service {
    private static final int IDEA_ID = 40995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40995Service() {
        this(new Idea40995Config());
    }

    public Idea40995Service(Idea40995Config config) {
        this.config = config != null ? config : new Idea40995Config();
