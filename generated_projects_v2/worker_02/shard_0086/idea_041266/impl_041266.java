...
@Data
public class Idea41266Config {
    private String name = "idea_041266";
 ...
 */
@Slf4j
public class Idea41266Service {
    private static final int IDEA_ID = 41266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41266Service() {
        this(new Idea41266Config());
    }

    public Idea41266Service(Idea41266Config config) {
        this.config = config != null ? config : new Idea41266Config();
