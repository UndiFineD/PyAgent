...
@Data
public class Idea41272Config {
    private String name = "idea_041272";
 ...
 */
@Slf4j
public class Idea41272Service {
    private static final int IDEA_ID = 41272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41272Service() {
        this(new Idea41272Config());
    }

    public Idea41272Service(Idea41272Config config) {
        this.config = config != null ? config : new Idea41272Config();
