...
@Data
public class Idea40887Config {
    private String name = "idea_040887";
 ...
 */
@Slf4j
public class Idea40887Service {
    private static final int IDEA_ID = 40887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40887Service() {
        this(new Idea40887Config());
    }

    public Idea40887Service(Idea40887Config config) {
        this.config = config != null ? config : new Idea40887Config();
