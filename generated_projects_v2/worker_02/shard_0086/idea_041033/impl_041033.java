...
@Data
public class Idea41033Config {
    private String name = "idea_041033";
 ...
 */
@Slf4j
public class Idea41033Service {
    private static final int IDEA_ID = 41033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41033Service() {
        this(new Idea41033Config());
    }

    public Idea41033Service(Idea41033Config config) {
        this.config = config != null ? config : new Idea41033Config();
