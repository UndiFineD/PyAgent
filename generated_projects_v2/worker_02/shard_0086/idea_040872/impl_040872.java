...
@Data
public class Idea40872Config {
    private String name = "idea_040872";
 ...
 */
@Slf4j
public class Idea40872Service {
    private static final int IDEA_ID = 40872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40872Service() {
        this(new Idea40872Config());
    }

    public Idea40872Service(Idea40872Config config) {
        this.config = config != null ? config : new Idea40872Config();
