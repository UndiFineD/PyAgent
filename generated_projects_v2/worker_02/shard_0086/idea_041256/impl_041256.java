...
@Data
public class Idea41256Config {
    private String name = "idea_041256";
 ...
 */
@Slf4j
public class Idea41256Service {
    private static final int IDEA_ID = 41256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41256Service() {
        this(new Idea41256Config());
    }

    public Idea41256Service(Idea41256Config config) {
        this.config = config != null ? config : new Idea41256Config();
