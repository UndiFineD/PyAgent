...
@Data
public class Idea41274Config {
    private String name = "idea_041274";
 ...
 */
@Slf4j
public class Idea41274Service {
    private static final int IDEA_ID = 41274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41274Service() {
        this(new Idea41274Config());
    }

    public Idea41274Service(Idea41274Config config) {
        this.config = config != null ? config : new Idea41274Config();
