...
@Data
public class Idea40931Config {
    private String name = "idea_040931";
 ...
 */
@Slf4j
public class Idea40931Service {
    private static final int IDEA_ID = 40931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40931Service() {
        this(new Idea40931Config());
    }

    public Idea40931Service(Idea40931Config config) {
        this.config = config != null ? config : new Idea40931Config();
