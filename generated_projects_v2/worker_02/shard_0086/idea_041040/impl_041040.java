...
@Data
public class Idea41040Config {
    private String name = "idea_041040";
 ...
 */
@Slf4j
public class Idea41040Service {
    private static final int IDEA_ID = 41040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41040Service() {
        this(new Idea41040Config());
    }

    public Idea41040Service(Idea41040Config config) {
        this.config = config != null ? config : new Idea41040Config();
