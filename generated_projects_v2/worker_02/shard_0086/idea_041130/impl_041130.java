...
@Data
public class Idea41130Config {
    private String name = "idea_041130";
 ...
 */
@Slf4j
public class Idea41130Service {
    private static final int IDEA_ID = 41130;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41130Service() {
        this(new Idea41130Config());
    }

    public Idea41130Service(Idea41130Config config) {
        this.config = config != null ? config : new Idea41130Config();
