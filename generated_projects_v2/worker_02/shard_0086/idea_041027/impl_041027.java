...
@Data
public class Idea41027Config {
    private String name = "idea_041027";
 ...
 */
@Slf4j
public class Idea41027Service {
    private static final int IDEA_ID = 41027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41027Service() {
        this(new Idea41027Config());
    }

    public Idea41027Service(Idea41027Config config) {
        this.config = config != null ? config : new Idea41027Config();
