...
@Data
public class Idea41144Config {
    private String name = "idea_041144";
 ...
 */
@Slf4j
public class Idea41144Service {
    private static final int IDEA_ID = 41144;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41144Service() {
        this(new Idea41144Config());
    }

    public Idea41144Service(Idea41144Config config) {
        this.config = config != null ? config : new Idea41144Config();
