...
@Data
public class Idea41196Config {
    private String name = "idea_041196";
 ...
 */
@Slf4j
public class Idea41196Service {
    private static final int IDEA_ID = 41196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41196Service() {
        this(new Idea41196Config());
    }

    public Idea41196Service(Idea41196Config config) {
        this.config = config != null ? config : new Idea41196Config();
