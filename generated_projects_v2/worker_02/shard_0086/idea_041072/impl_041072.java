...
@Data
public class Idea41072Config {
    private String name = "idea_041072";
 ...
 */
@Slf4j
public class Idea41072Service {
    private static final int IDEA_ID = 41072;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41072Service() {
        this(new Idea41072Config());
    }

    public Idea41072Service(Idea41072Config config) {
        this.config = config != null ? config : new Idea41072Config();
