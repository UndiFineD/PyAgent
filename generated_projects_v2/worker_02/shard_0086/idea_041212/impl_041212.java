...
@Data
public class Idea41212Config {
    private String name = "idea_041212";
 ...
 */
@Slf4j
public class Idea41212Service {
    private static final int IDEA_ID = 41212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41212Service() {
        this(new Idea41212Config());
    }

    public Idea41212Service(Idea41212Config config) {
        this.config = config != null ? config : new Idea41212Config();
