...
@Data
public class Idea40863Config {
    private String name = "idea_040863";
 ...
 */
@Slf4j
public class Idea40863Service {
    private static final int IDEA_ID = 40863;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40863Service() {
        this(new Idea40863Config());
    }

    public Idea40863Service(Idea40863Config config) {
        this.config = config != null ? config : new Idea40863Config();
