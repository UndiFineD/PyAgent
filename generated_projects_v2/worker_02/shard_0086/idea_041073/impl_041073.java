...
@Data
public class Idea41073Config {
    private String name = "idea_041073";
 ...
 */
@Slf4j
public class Idea41073Service {
    private static final int IDEA_ID = 41073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41073Service() {
        this(new Idea41073Config());
    }

    public Idea41073Service(Idea41073Config config) {
        this.config = config != null ? config : new Idea41073Config();
