...
@Data
public class Idea40923Config {
    private String name = "idea_040923";
 ...
 */
@Slf4j
public class Idea40923Service {
    private static final int IDEA_ID = 40923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40923Service() {
        this(new Idea40923Config());
    }

    public Idea40923Service(Idea40923Config config) {
        this.config = config != null ? config : new Idea40923Config();
