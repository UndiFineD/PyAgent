...
@Data
public class Idea41090Config {
    private String name = "idea_041090";
 ...
 */
@Slf4j
public class Idea41090Service {
    private static final int IDEA_ID = 41090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41090Service() {
        this(new Idea41090Config());
    }

    public Idea41090Service(Idea41090Config config) {
        this.config = config != null ? config : new Idea41090Config();
