...
@Data
public class Idea40975Config {
    private String name = "idea_040975";
 ...
 */
@Slf4j
public class Idea40975Service {
    private static final int IDEA_ID = 40975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40975Service() {
        this(new Idea40975Config());
    }

    public Idea40975Service(Idea40975Config config) {
        this.config = config != null ? config : new Idea40975Config();
