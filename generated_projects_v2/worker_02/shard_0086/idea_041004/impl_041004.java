...
@Data
public class Idea41004Config {
    private String name = "idea_041004";
 ...
 */
@Slf4j
public class Idea41004Service {
    private static final int IDEA_ID = 41004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41004Service() {
        this(new Idea41004Config());
    }

    public Idea41004Service(Idea41004Config config) {
        this.config = config != null ? config : new Idea41004Config();
