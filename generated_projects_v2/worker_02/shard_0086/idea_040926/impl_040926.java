...
@Data
public class Idea40926Config {
    private String name = "idea_040926";
 ...
 */
@Slf4j
public class Idea40926Service {
    private static final int IDEA_ID = 40926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40926Service() {
        this(new Idea40926Config());
    }

    public Idea40926Service(Idea40926Config config) {
        this.config = config != null ? config : new Idea40926Config();
