...
@Data
public class Idea40973Config {
    private String name = "idea_040973";
 ...
 */
@Slf4j
public class Idea40973Service {
    private static final int IDEA_ID = 40973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40973Service() {
        this(new Idea40973Config());
    }

    public Idea40973Service(Idea40973Config config) {
        this.config = config != null ? config : new Idea40973Config();
