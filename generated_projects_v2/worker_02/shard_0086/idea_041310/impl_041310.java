...
@Data
public class Idea41310Config {
    private String name = "idea_041310";
 ...
 */
@Slf4j
public class Idea41310Service {
    private static final int IDEA_ID = 41310;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41310Service() {
        this(new Idea41310Config());
    }

    public Idea41310Service(Idea41310Config config) {
        this.config = config != null ? config : new Idea41310Config();
