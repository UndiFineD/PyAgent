...
@Data
public class Idea41147Config {
    private String name = "idea_041147";
 ...
 */
@Slf4j
public class Idea41147Service {
    private static final int IDEA_ID = 41147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41147Service() {
        this(new Idea41147Config());
    }

    public Idea41147Service(Idea41147Config config) {
        this.config = config != null ? config : new Idea41147Config();
