...
@Data
public class Idea40938Config {
    private String name = "idea_040938";
 ...
 */
@Slf4j
public class Idea40938Service {
    private static final int IDEA_ID = 40938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40938Service() {
        this(new Idea40938Config());
    }

    public Idea40938Service(Idea40938Config config) {
        this.config = config != null ? config : new Idea40938Config();
