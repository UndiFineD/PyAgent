...
@Data
public class Idea40927Config {
    private String name = "idea_040927";
 ...
 */
@Slf4j
public class Idea40927Service {
    private static final int IDEA_ID = 40927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40927Service() {
        this(new Idea40927Config());
    }

    public Idea40927Service(Idea40927Config config) {
        this.config = config != null ? config : new Idea40927Config();
