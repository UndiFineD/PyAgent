...
@Data
public class Idea40976Config {
    private String name = "idea_040976";
 ...
 */
@Slf4j
public class Idea40976Service {
    private static final int IDEA_ID = 40976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40976Service() {
        this(new Idea40976Config());
    }

    public Idea40976Service(Idea40976Config config) {
        this.config = config != null ? config : new Idea40976Config();
