...
@Data
public class Idea41243Config {
    private String name = "idea_041243";
 ...
 */
@Slf4j
public class Idea41243Service {
    private static final int IDEA_ID = 41243;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41243Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41243Service() {
        this(new Idea41243Config());
    }

    public Idea41243Service(Idea41243Config config) {
        this.config = config != null ? config : new Idea41243Config();
