...
@Data
public class Idea40918Config {
    private String name = "idea_040918";
 ...
 */
@Slf4j
public class Idea40918Service {
    private static final int IDEA_ID = 40918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40918Service() {
        this(new Idea40918Config());
    }

    public Idea40918Service(Idea40918Config config) {
        this.config = config != null ? config : new Idea40918Config();
