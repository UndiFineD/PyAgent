...
@Data
public class Idea41240Config {
    private String name = "idea_041240";
 ...
 */
@Slf4j
public class Idea41240Service {
    private static final int IDEA_ID = 41240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41240Service() {
        this(new Idea41240Config());
    }

    public Idea41240Service(Idea41240Config config) {
        this.config = config != null ? config : new Idea41240Config();
