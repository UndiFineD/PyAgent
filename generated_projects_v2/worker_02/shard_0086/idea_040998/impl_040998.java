...
@Data
public class Idea40998Config {
    private String name = "idea_040998";
 ...
 */
@Slf4j
public class Idea40998Service {
    private static final int IDEA_ID = 40998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40998Service() {
        this(new Idea40998Config());
    }

    public Idea40998Service(Idea40998Config config) {
        this.config = config != null ? config : new Idea40998Config();
