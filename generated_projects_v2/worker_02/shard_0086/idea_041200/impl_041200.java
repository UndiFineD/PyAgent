...
@Data
public class Idea41200Config {
    private String name = "idea_041200";
 ...
 */
@Slf4j
public class Idea41200Service {
    private static final int IDEA_ID = 41200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41200Service() {
        this(new Idea41200Config());
    }

    public Idea41200Service(Idea41200Config config) {
        this.config = config != null ? config : new Idea41200Config();
