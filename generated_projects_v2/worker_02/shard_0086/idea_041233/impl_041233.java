...
@Data
public class Idea41233Config {
    private String name = "idea_041233";
 ...
 */
@Slf4j
public class Idea41233Service {
    private static final int IDEA_ID = 41233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41233Service() {
        this(new Idea41233Config());
    }

    public Idea41233Service(Idea41233Config config) {
        this.config = config != null ? config : new Idea41233Config();
