...
@Data
public class Idea41216Config {
    private String name = "idea_041216";
 ...
 */
@Slf4j
public class Idea41216Service {
    private static final int IDEA_ID = 41216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41216Service() {
        this(new Idea41216Config());
    }

    public Idea41216Service(Idea41216Config config) {
        this.config = config != null ? config : new Idea41216Config();
