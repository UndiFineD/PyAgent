...
@Data
public class Idea41116Config {
    private String name = "idea_041116";
 ...
 */
@Slf4j
public class Idea41116Service {
    private static final int IDEA_ID = 41116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41116Service() {
        this(new Idea41116Config());
    }

    public Idea41116Service(Idea41116Config config) {
        this.config = config != null ? config : new Idea41116Config();
