...
@Data
public class Idea41155Config {
    private String name = "idea_041155";
 ...
 */
@Slf4j
public class Idea41155Service {
    private static final int IDEA_ID = 41155;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41155Service() {
        this(new Idea41155Config());
    }

    public Idea41155Service(Idea41155Config config) {
        this.config = config != null ? config : new Idea41155Config();
