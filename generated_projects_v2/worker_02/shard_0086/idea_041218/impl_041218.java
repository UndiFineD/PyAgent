...
@Data
public class Idea41218Config {
    private String name = "idea_041218";
 ...
 */
@Slf4j
public class Idea41218Service {
    private static final int IDEA_ID = 41218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41218Service() {
        this(new Idea41218Config());
    }

    public Idea41218Service(Idea41218Config config) {
        this.config = config != null ? config : new Idea41218Config();
