...
@Data
public class Idea41020Config {
    private String name = "idea_041020";
 ...
 */
@Slf4j
public class Idea41020Service {
    private static final int IDEA_ID = 41020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41020Service() {
        this(new Idea41020Config());
    }

    public Idea41020Service(Idea41020Config config) {
        this.config = config != null ? config : new Idea41020Config();
