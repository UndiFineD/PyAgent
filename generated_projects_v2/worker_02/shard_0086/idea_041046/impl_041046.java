...
@Data
public class Idea41046Config {
    private String name = "idea_041046";
 ...
 */
@Slf4j
public class Idea41046Service {
    private static final int IDEA_ID = 41046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41046Service() {
        this(new Idea41046Config());
    }

    public Idea41046Service(Idea41046Config config) {
        this.config = config != null ? config : new Idea41046Config();
