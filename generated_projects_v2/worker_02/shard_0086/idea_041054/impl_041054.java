...
@Data
public class Idea41054Config {
    private String name = "idea_041054";
 ...
 */
@Slf4j
public class Idea41054Service {
    private static final int IDEA_ID = 41054;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41054Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41054Service() {
        this(new Idea41054Config());
    }

    public Idea41054Service(Idea41054Config config) {
        this.config = config != null ? config : new Idea41054Config();
