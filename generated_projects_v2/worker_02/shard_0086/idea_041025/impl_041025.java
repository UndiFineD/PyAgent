...
@Data
public class Idea41025Config {
    private String name = "idea_041025";
 ...
 */
@Slf4j
public class Idea41025Service {
    private static final int IDEA_ID = 41025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41025Service() {
        this(new Idea41025Config());
    }

    public Idea41025Service(Idea41025Config config) {
        this.config = config != null ? config : new Idea41025Config();
