...
@Data
public class Idea41094Config {
    private String name = "idea_041094";
 ...
 */
@Slf4j
public class Idea41094Service {
    private static final int IDEA_ID = 41094;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41094Service() {
        this(new Idea41094Config());
    }

    public Idea41094Service(Idea41094Config config) {
        this.config = config != null ? config : new Idea41094Config();
