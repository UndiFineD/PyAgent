...
@Data
public class Idea40858Config {
    private String name = "idea_040858";
 ...
 */
@Slf4j
public class Idea40858Service {
    private static final int IDEA_ID = 40858;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40858Service() {
        this(new Idea40858Config());
    }

    public Idea40858Service(Idea40858Config config) {
        this.config = config != null ? config : new Idea40858Config();
