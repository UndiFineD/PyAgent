...
@Data
public class Idea41296Config {
    private String name = "idea_041296";
 ...
 */
@Slf4j
public class Idea41296Service {
    private static final int IDEA_ID = 41296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41296Service() {
        this(new Idea41296Config());
    }

    public Idea41296Service(Idea41296Config config) {
        this.config = config != null ? config : new Idea41296Config();
