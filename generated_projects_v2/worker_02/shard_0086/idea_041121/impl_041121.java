...
@Data
public class Idea41121Config {
    private String name = "idea_041121";
 ...
 */
@Slf4j
public class Idea41121Service {
    private static final int IDEA_ID = 41121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41121Service() {
        this(new Idea41121Config());
    }

    public Idea41121Service(Idea41121Config config) {
        this.config = config != null ? config : new Idea41121Config();
