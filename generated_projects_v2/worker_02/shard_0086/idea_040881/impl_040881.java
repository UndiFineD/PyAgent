...
@Data
public class Idea40881Config {
    private String name = "idea_040881";
 ...
 */
@Slf4j
public class Idea40881Service {
    private static final int IDEA_ID = 40881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40881Service() {
        this(new Idea40881Config());
    }

    public Idea40881Service(Idea40881Config config) {
        this.config = config != null ? config : new Idea40881Config();
