...
@Data
public class Idea41319Config {
    private String name = "idea_041319";
 ...
 */
@Slf4j
public class Idea41319Service {
    private static final int IDEA_ID = 41319;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41319Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41319Service() {
        this(new Idea41319Config());
    }

    public Idea41319Service(Idea41319Config config) {
        this.config = config != null ? config : new Idea41319Config();
