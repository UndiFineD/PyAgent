...
@Data
public class Idea40884Config {
    private String name = "idea_040884";
 ...
 */
@Slf4j
public class Idea40884Service {
    private static final int IDEA_ID = 40884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40884Service() {
        this(new Idea40884Config());
    }

    public Idea40884Service(Idea40884Config config) {
        this.config = config != null ? config : new Idea40884Config();
