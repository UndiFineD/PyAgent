...
@Data
public class Idea41217Config {
    private String name = "idea_041217";
 ...
 */
@Slf4j
public class Idea41217Service {
    private static final int IDEA_ID = 41217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41217Service() {
        this(new Idea41217Config());
    }

    public Idea41217Service(Idea41217Config config) {
        this.config = config != null ? config : new Idea41217Config();
