...
@Data
public class Idea41042Config {
    private String name = "idea_041042";
 ...
 */
@Slf4j
public class Idea41042Service {
    private static final int IDEA_ID = 41042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41042Service() {
        this(new Idea41042Config());
    }

    public Idea41042Service(Idea41042Config config) {
        this.config = config != null ? config : new Idea41042Config();
