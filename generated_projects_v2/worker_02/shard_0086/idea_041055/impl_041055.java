...
@Data
public class Idea41055Config {
    private String name = "idea_041055";
 ...
 */
@Slf4j
public class Idea41055Service {
    private static final int IDEA_ID = 41055;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41055Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41055Service() {
        this(new Idea41055Config());
    }

    public Idea41055Service(Idea41055Config config) {
        this.config = config != null ? config : new Idea41055Config();
