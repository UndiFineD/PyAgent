...
@Data
public class Idea40892Config {
    private String name = "idea_040892";
 ...
 */
@Slf4j
public class Idea40892Service {
    private static final int IDEA_ID = 40892;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40892Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40892Service() {
        this(new Idea40892Config());
    }

    public Idea40892Service(Idea40892Config config) {
        this.config = config != null ? config : new Idea40892Config();
