...
@Data
public class Idea40870Config {
    private String name = "idea_040870";
 ...
 */
@Slf4j
public class Idea40870Service {
    private static final int IDEA_ID = 40870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40870Service() {
        this(new Idea40870Config());
    }

    public Idea40870Service(Idea40870Config config) {
        this.config = config != null ? config : new Idea40870Config();
