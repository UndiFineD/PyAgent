...
@Data
public class Idea41110Config {
    private String name = "idea_041110";
 ...
 */
@Slf4j
public class Idea41110Service {
    private static final int IDEA_ID = 41110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41110Service() {
        this(new Idea41110Config());
    }

    public Idea41110Service(Idea41110Config config) {
        this.config = config != null ? config : new Idea41110Config();
