...
@Data
public class Idea41111Config {
    private String name = "idea_041111";
 ...
 */
@Slf4j
public class Idea41111Service {
    private static final int IDEA_ID = 41111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41111Service() {
        this(new Idea41111Config());
    }

    public Idea41111Service(Idea41111Config config) {
        this.config = config != null ? config : new Idea41111Config();
