...
@Data
public class Idea40987Config {
    private String name = "idea_040987";
 ...
 */
@Slf4j
public class Idea40987Service {
    private static final int IDEA_ID = 40987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40987Service() {
        this(new Idea40987Config());
    }

    public Idea40987Service(Idea40987Config config) {
        this.config = config != null ? config : new Idea40987Config();
