...
@Data
public class Idea41301Config {
    private String name = "idea_041301";
 ...
 */
@Slf4j
public class Idea41301Service {
    private static final int IDEA_ID = 41301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41301Service() {
        this(new Idea41301Config());
    }

    public Idea41301Service(Idea41301Config config) {
        this.config = config != null ? config : new Idea41301Config();
