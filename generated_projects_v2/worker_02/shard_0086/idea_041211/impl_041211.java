...
@Data
public class Idea41211Config {
    private String name = "idea_041211";
 ...
 */
@Slf4j
public class Idea41211Service {
    private static final int IDEA_ID = 41211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41211Service() {
        this(new Idea41211Config());
    }

    public Idea41211Service(Idea41211Config config) {
        this.config = config != null ? config : new Idea41211Config();
