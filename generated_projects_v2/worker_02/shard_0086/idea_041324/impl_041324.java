...
@Data
public class Idea41324Config {
    private String name = "idea_041324";
 ...
 */
@Slf4j
public class Idea41324Service {
    private static final int IDEA_ID = 41324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41324Service() {
        this(new Idea41324Config());
    }

    public Idea41324Service(Idea41324Config config) {
        this.config = config != null ? config : new Idea41324Config();
