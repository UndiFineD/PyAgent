...
@Data
public class Idea40880Config {
    private String name = "idea_040880";
 ...
 */
@Slf4j
public class Idea40880Service {
    private static final int IDEA_ID = 40880;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40880Service() {
        this(new Idea40880Config());
    }

    public Idea40880Service(Idea40880Config config) {
        this.config = config != null ? config : new Idea40880Config();
