...
@Data
public class Idea40939Config {
    private String name = "idea_040939";
 ...
 */
@Slf4j
public class Idea40939Service {
    private static final int IDEA_ID = 40939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40939Service() {
        this(new Idea40939Config());
    }

    public Idea40939Service(Idea40939Config config) {
        this.config = config != null ? config : new Idea40939Config();
