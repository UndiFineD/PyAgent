...
@Data
public class Idea40906Config {
    private String name = "idea_040906";
 ...
 */
@Slf4j
public class Idea40906Service {
    private static final int IDEA_ID = 40906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40906Service() {
        this(new Idea40906Config());
    }

    public Idea40906Service(Idea40906Config config) {
        this.config = config != null ? config : new Idea40906Config();
