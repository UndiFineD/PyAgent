...
@Data
public class Idea41136Config {
    private String name = "idea_041136";
 ...
 */
@Slf4j
public class Idea41136Service {
    private static final int IDEA_ID = 41136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41136Service() {
        this(new Idea41136Config());
    }

    public Idea41136Service(Idea41136Config config) {
        this.config = config != null ? config : new Idea41136Config();
