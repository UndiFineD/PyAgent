...
@Data
public class Idea41208Config {
    private String name = "idea_041208";
 ...
 */
@Slf4j
public class Idea41208Service {
    private static final int IDEA_ID = 41208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41208Service() {
        this(new Idea41208Config());
    }

    public Idea41208Service(Idea41208Config config) {
        this.config = config != null ? config : new Idea41208Config();
