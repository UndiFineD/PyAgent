...
@Data
public class Idea41166Config {
    private String name = "idea_041166";
 ...
 */
@Slf4j
public class Idea41166Service {
    private static final int IDEA_ID = 41166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41166Service() {
        this(new Idea41166Config());
    }

    public Idea41166Service(Idea41166Config config) {
        this.config = config != null ? config : new Idea41166Config();
