...
@Data
public class Idea40897Config {
    private String name = "idea_040897";
 ...
 */
@Slf4j
public class Idea40897Service {
    private static final int IDEA_ID = 40897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40897Service() {
        this(new Idea40897Config());
    }

    public Idea40897Service(Idea40897Config config) {
        this.config = config != null ? config : new Idea40897Config();
