...
@Data
public class Idea40873Config {
    private String name = "idea_040873";
 ...
 */
@Slf4j
public class Idea40873Service {
    private static final int IDEA_ID = 40873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40873Service() {
        this(new Idea40873Config());
    }

    public Idea40873Service(Idea40873Config config) {
        this.config = config != null ? config : new Idea40873Config();
