...
@Data
public class Idea41190Config {
    private String name = "idea_041190";
 ...
 */
@Slf4j
public class Idea41190Service {
    private static final int IDEA_ID = 41190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41190Service() {
        this(new Idea41190Config());
    }

    public Idea41190Service(Idea41190Config config) {
        this.config = config != null ? config : new Idea41190Config();
