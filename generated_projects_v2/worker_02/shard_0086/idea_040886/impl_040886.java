...
@Data
public class Idea40886Config {
    private String name = "idea_040886";
 ...
 */
@Slf4j
public class Idea40886Service {
    private static final int IDEA_ID = 40886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40886Service() {
        this(new Idea40886Config());
    }

    public Idea40886Service(Idea40886Config config) {
        this.config = config != null ? config : new Idea40886Config();
