...
@Data
public class Idea40859Config {
    private String name = "idea_040859";
 ...
 */
@Slf4j
public class Idea40859Service {
    private static final int IDEA_ID = 40859;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40859Service() {
        this(new Idea40859Config());
    }

    public Idea40859Service(Idea40859Config config) {
        this.config = config != null ? config : new Idea40859Config();
