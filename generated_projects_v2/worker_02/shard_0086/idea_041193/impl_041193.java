...
@Data
public class Idea41193Config {
    private String name = "idea_041193";
 ...
 */
@Slf4j
public class Idea41193Service {
    private static final int IDEA_ID = 41193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41193Service() {
        this(new Idea41193Config());
    }

    public Idea41193Service(Idea41193Config config) {
        this.config = config != null ? config : new Idea41193Config();
