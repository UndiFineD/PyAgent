...
@Data
public class Idea40945Config {
    private String name = "idea_040945";
 ...
 */
@Slf4j
public class Idea40945Service {
    private static final int IDEA_ID = 40945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40945Service() {
        this(new Idea40945Config());
    }

    public Idea40945Service(Idea40945Config config) {
        this.config = config != null ? config : new Idea40945Config();
