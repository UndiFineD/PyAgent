...
@Data
public class Idea40952Config {
    private String name = "idea_040952";
 ...
 */
@Slf4j
public class Idea40952Service {
    private static final int IDEA_ID = 40952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40952Service() {
        this(new Idea40952Config());
    }

    public Idea40952Service(Idea40952Config config) {
        this.config = config != null ? config : new Idea40952Config();
