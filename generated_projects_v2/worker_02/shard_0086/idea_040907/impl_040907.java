...
@Data
public class Idea40907Config {
    private String name = "idea_040907";
 ...
 */
@Slf4j
public class Idea40907Service {
    private static final int IDEA_ID = 40907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40907Service() {
        this(new Idea40907Config());
    }

    public Idea40907Service(Idea40907Config config) {
        this.config = config != null ? config : new Idea40907Config();
