...
@Data
public class Idea41226Config {
    private String name = "idea_041226";
 ...
 */
@Slf4j
public class Idea41226Service {
    private static final int IDEA_ID = 41226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41226Service() {
        this(new Idea41226Config());
    }

    public Idea41226Service(Idea41226Config config) {
        this.config = config != null ? config : new Idea41226Config();
