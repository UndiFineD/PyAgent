...
@Data
public class Idea40943Config {
    private String name = "idea_040943";
 ...
 */
@Slf4j
public class Idea40943Service {
    private static final int IDEA_ID = 40943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40943Service() {
        this(new Idea40943Config());
    }

    public Idea40943Service(Idea40943Config config) {
        this.config = config != null ? config : new Idea40943Config();
