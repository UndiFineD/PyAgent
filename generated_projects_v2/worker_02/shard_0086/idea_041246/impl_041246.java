...
@Data
public class Idea41246Config {
    private String name = "idea_041246";
 ...
 */
@Slf4j
public class Idea41246Service {
    private static final int IDEA_ID = 41246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41246Service() {
        this(new Idea41246Config());
    }

    public Idea41246Service(Idea41246Config config) {
        this.config = config != null ? config : new Idea41246Config();
