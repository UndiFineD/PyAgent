...
@Data
public class Idea41102Config {
    private String name = "idea_041102";
 ...
 */
@Slf4j
public class Idea41102Service {
    private static final int IDEA_ID = 41102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41102Service() {
        this(new Idea41102Config());
    }

    public Idea41102Service(Idea41102Config config) {
        this.config = config != null ? config : new Idea41102Config();
