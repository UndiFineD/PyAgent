...
@Data
public class Idea41016Config {
    private String name = "idea_041016";
 ...
 */
@Slf4j
public class Idea41016Service {
    private static final int IDEA_ID = 41016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41016Service() {
        this(new Idea41016Config());
    }

    public Idea41016Service(Idea41016Config config) {
        this.config = config != null ? config : new Idea41016Config();
