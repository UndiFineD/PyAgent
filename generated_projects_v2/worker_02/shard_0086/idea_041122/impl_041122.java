...
@Data
public class Idea41122Config {
    private String name = "idea_041122";
 ...
 */
@Slf4j
public class Idea41122Service {
    private static final int IDEA_ID = 41122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41122Service() {
        this(new Idea41122Config());
    }

    public Idea41122Service(Idea41122Config config) {
        this.config = config != null ? config : new Idea41122Config();
