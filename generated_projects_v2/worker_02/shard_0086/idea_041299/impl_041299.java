...
@Data
public class Idea41299Config {
    private String name = "idea_041299";
 ...
 */
@Slf4j
public class Idea41299Service {
    private static final int IDEA_ID = 41299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41299Service() {
        this(new Idea41299Config());
    }

    public Idea41299Service(Idea41299Config config) {
        this.config = config != null ? config : new Idea41299Config();
