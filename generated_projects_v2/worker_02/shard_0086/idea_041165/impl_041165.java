...
@Data
public class Idea41165Config {
    private String name = "idea_041165";
 ...
 */
@Slf4j
public class Idea41165Service {
    private static final int IDEA_ID = 41165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41165Service() {
        this(new Idea41165Config());
    }

    public Idea41165Service(Idea41165Config config) {
        this.config = config != null ? config : new Idea41165Config();
