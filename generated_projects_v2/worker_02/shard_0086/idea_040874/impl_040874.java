...
@Data
public class Idea40874Config {
    private String name = "idea_040874";
 ...
 */
@Slf4j
public class Idea40874Service {
    private static final int IDEA_ID = 40874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40874Service() {
        this(new Idea40874Config());
    }

    public Idea40874Service(Idea40874Config config) {
        this.config = config != null ? config : new Idea40874Config();
