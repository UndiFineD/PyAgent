...
@Data
public class Idea40953Config {
    private String name = "idea_040953";
 ...
 */
@Slf4j
public class Idea40953Service {
    private static final int IDEA_ID = 40953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40953Service() {
        this(new Idea40953Config());
    }

    public Idea40953Service(Idea40953Config config) {
        this.config = config != null ? config : new Idea40953Config();
