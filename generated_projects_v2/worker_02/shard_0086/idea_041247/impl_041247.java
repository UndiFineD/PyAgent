...
@Data
public class Idea41247Config {
    private String name = "idea_041247";
 ...
 */
@Slf4j
public class Idea41247Service {
    private static final int IDEA_ID = 41247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41247Service() {
        this(new Idea41247Config());
    }

    public Idea41247Service(Idea41247Config config) {
        this.config = config != null ? config : new Idea41247Config();
