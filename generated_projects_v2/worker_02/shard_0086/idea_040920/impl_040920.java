...
@Data
public class Idea40920Config {
    private String name = "idea_040920";
 ...
 */
@Slf4j
public class Idea40920Service {
    private static final int IDEA_ID = 40920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40920Service() {
        this(new Idea40920Config());
    }

    public Idea40920Service(Idea40920Config config) {
        this.config = config != null ? config : new Idea40920Config();
