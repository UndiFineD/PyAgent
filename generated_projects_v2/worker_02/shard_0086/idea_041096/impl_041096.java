...
@Data
public class Idea41096Config {
    private String name = "idea_041096";
 ...
 */
@Slf4j
public class Idea41096Service {
    private static final int IDEA_ID = 41096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41096Service() {
        this(new Idea41096Config());
    }

    public Idea41096Service(Idea41096Config config) {
        this.config = config != null ? config : new Idea41096Config();
