...
@Data
public class Idea41010Config {
    private String name = "idea_041010";
 ...
 */
@Slf4j
public class Idea41010Service {
    private static final int IDEA_ID = 41010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41010Service() {
        this(new Idea41010Config());
    }

    public Idea41010Service(Idea41010Config config) {
        this.config = config != null ? config : new Idea41010Config();
