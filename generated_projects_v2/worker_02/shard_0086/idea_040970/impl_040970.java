...
@Data
public class Idea40970Config {
    private String name = "idea_040970";
 ...
 */
@Slf4j
public class Idea40970Service {
    private static final int IDEA_ID = 40970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea40970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea40970Service() {
        this(new Idea40970Config());
    }

    public Idea40970Service(Idea40970Config config) {
        this.config = config != null ? config : new Idea40970Config();
