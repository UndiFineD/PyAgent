...
@Data
public class Idea41066Config {
    private String name = "idea_041066";
 ...
 */
@Slf4j
public class Idea41066Service {
    private static final int IDEA_ID = 41066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea41066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea41066Service() {
        this(new Idea41066Config());
    }

    public Idea41066Service(Idea41066Config config) {
        this.config = config != null ? config : new Idea41066Config();
