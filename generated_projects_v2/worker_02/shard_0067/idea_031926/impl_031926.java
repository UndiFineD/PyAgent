...
@Data
public class Idea31926Config {
    private String name = "idea_031926";
 ...
 */
@Slf4j
public class Idea31926Service {
    private static final int IDEA_ID = 31926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31926Service() {
        this(new Idea31926Config());
    }

    public Idea31926Service(Idea31926Config config) {
        this.config = config != null ? config : new Idea31926Config();
