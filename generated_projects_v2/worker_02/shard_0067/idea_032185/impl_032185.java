...
@Data
public class Idea32185Config {
    private String name = "idea_032185";
 ...
 */
@Slf4j
public class Idea32185Service {
    private static final int IDEA_ID = 32185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32185Service() {
        this(new Idea32185Config());
    }

    public Idea32185Service(Idea32185Config config) {
        this.config = config != null ? config : new Idea32185Config();
