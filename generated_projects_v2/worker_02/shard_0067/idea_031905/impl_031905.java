...
@Data
public class Idea31905Config {
    private String name = "idea_031905";
 ...
 */
@Slf4j
public class Idea31905Service {
    private static final int IDEA_ID = 31905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31905Service() {
        this(new Idea31905Config());
    }

    public Idea31905Service(Idea31905Config config) {
        this.config = config != null ? config : new Idea31905Config();
