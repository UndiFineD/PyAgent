...
@Data
public class Idea32075Config {
    private String name = "idea_032075";
 ...
 */
@Slf4j
public class Idea32075Service {
    private static final int IDEA_ID = 32075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32075Service() {
        this(new Idea32075Config());
    }

    public Idea32075Service(Idea32075Config config) {
        this.config = config != null ? config : new Idea32075Config();
