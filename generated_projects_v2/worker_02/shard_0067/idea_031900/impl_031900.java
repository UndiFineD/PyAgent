...
@Data
public class Idea31900Config {
    private String name = "idea_031900";
 ...
 */
@Slf4j
public class Idea31900Service {
    private static final int IDEA_ID = 31900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31900Service() {
        this(new Idea31900Config());
    }

    public Idea31900Service(Idea31900Config config) {
        this.config = config != null ? config : new Idea31900Config();
