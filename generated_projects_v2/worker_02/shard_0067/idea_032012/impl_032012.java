...
@Data
public class Idea32012Config {
    private String name = "idea_032012";
 ...
 */
@Slf4j
public class Idea32012Service {
    private static final int IDEA_ID = 32012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32012Service() {
        this(new Idea32012Config());
    }

    public Idea32012Service(Idea32012Config config) {
        this.config = config != null ? config : new Idea32012Config();
