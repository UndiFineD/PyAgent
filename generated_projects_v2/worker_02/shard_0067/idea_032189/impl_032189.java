...
@Data
public class Idea32189Config {
    private String name = "idea_032189";
 ...
 */
@Slf4j
public class Idea32189Service {
    private static final int IDEA_ID = 32189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32189Service() {
        this(new Idea32189Config());
    }

    public Idea32189Service(Idea32189Config config) {
        this.config = config != null ? config : new Idea32189Config();
