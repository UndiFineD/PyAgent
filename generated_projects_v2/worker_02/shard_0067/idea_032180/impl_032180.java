...
@Data
public class Idea32180Config {
    private String name = "idea_032180";
 ...
 */
@Slf4j
public class Idea32180Service {
    private static final int IDEA_ID = 32180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32180Service() {
        this(new Idea32180Config());
    }

    public Idea32180Service(Idea32180Config config) {
        this.config = config != null ? config : new Idea32180Config();
