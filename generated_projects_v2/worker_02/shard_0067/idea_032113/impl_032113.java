...
@Data
public class Idea32113Config {
    private String name = "idea_032113";
 ...
 */
@Slf4j
public class Idea32113Service {
    private static final int IDEA_ID = 32113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32113Service() {
        this(new Idea32113Config());
    }

    public Idea32113Service(Idea32113Config config) {
        this.config = config != null ? config : new Idea32113Config();
