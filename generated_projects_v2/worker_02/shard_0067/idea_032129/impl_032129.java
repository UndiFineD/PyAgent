...
@Data
public class Idea32129Config {
    private String name = "idea_032129";
 ...
 */
@Slf4j
public class Idea32129Service {
    private static final int IDEA_ID = 32129;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32129Service() {
        this(new Idea32129Config());
    }

    public Idea32129Service(Idea32129Config config) {
        this.config = config != null ? config : new Idea32129Config();
