...
@Data
public class Idea32229Config {
    private String name = "idea_032229";
 ...
 */
@Slf4j
public class Idea32229Service {
    private static final int IDEA_ID = 32229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32229Service() {
        this(new Idea32229Config());
    }

    public Idea32229Service(Idea32229Config config) {
        this.config = config != null ? config : new Idea32229Config();
