...
@Data
public class Idea31939Config {
    private String name = "idea_031939";
 ...
 */
@Slf4j
public class Idea31939Service {
    private static final int IDEA_ID = 31939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31939Service() {
        this(new Idea31939Config());
    }

    public Idea31939Service(Idea31939Config config) {
        this.config = config != null ? config : new Idea31939Config();
