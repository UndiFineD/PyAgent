...
@Data
public class Idea31904Config {
    private String name = "idea_031904";
 ...
 */
@Slf4j
public class Idea31904Service {
    private static final int IDEA_ID = 31904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31904Service() {
        this(new Idea31904Config());
    }

    public Idea31904Service(Idea31904Config config) {
        this.config = config != null ? config : new Idea31904Config();
