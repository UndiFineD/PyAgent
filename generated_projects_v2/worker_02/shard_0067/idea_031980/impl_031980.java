...
@Data
public class Idea31980Config {
    private String name = "idea_031980";
 ...
 */
@Slf4j
public class Idea31980Service {
    private static final int IDEA_ID = 31980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31980Service() {
        this(new Idea31980Config());
    }

    public Idea31980Service(Idea31980Config config) {
        this.config = config != null ? config : new Idea31980Config();
