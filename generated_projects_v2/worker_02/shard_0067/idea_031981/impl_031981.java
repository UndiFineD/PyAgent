...
@Data
public class Idea31981Config {
    private String name = "idea_031981";
 ...
 */
@Slf4j
public class Idea31981Service {
    private static final int IDEA_ID = 31981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31981Service() {
        this(new Idea31981Config());
    }

    public Idea31981Service(Idea31981Config config) {
        this.config = config != null ? config : new Idea31981Config();
