...
@Data
public class Idea31962Config {
    private String name = "idea_031962";
 ...
 */
@Slf4j
public class Idea31962Service {
    private static final int IDEA_ID = 31962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31962Service() {
        this(new Idea31962Config());
    }

    public Idea31962Service(Idea31962Config config) {
        this.config = config != null ? config : new Idea31962Config();
