...
@Data
public class Idea32214Config {
    private String name = "idea_032214";
 ...
 */
@Slf4j
public class Idea32214Service {
    private static final int IDEA_ID = 32214;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32214Service() {
        this(new Idea32214Config());
    }

    public Idea32214Service(Idea32214Config config) {
        this.config = config != null ? config : new Idea32214Config();
