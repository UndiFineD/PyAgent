...
@Data
public class Idea32198Config {
    private String name = "idea_032198";
 ...
 */
@Slf4j
public class Idea32198Service {
    private static final int IDEA_ID = 32198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32198Service() {
        this(new Idea32198Config());
    }

    public Idea32198Service(Idea32198Config config) {
        this.config = config != null ? config : new Idea32198Config();
