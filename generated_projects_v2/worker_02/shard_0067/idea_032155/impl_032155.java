...
@Data
public class Idea32155Config {
    private String name = "idea_032155";
 ...
 */
@Slf4j
public class Idea32155Service {
    private static final int IDEA_ID = 32155;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32155Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32155Service() {
        this(new Idea32155Config());
    }

    public Idea32155Service(Idea32155Config config) {
        this.config = config != null ? config : new Idea32155Config();
