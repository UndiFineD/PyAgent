...
@Data
public class Idea32067Config {
    private String name = "idea_032067";
 ...
 */
@Slf4j
public class Idea32067Service {
    private static final int IDEA_ID = 32067;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32067Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32067Service() {
        this(new Idea32067Config());
    }

    public Idea32067Service(Idea32067Config config) {
        this.config = config != null ? config : new Idea32067Config();
