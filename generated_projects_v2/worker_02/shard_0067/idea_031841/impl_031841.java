...
@Data
public class Idea31841Config {
    private String name = "idea_031841";
 ...
 */
@Slf4j
public class Idea31841Service {
    private static final int IDEA_ID = 31841;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31841Service() {
        this(new Idea31841Config());
    }

    public Idea31841Service(Idea31841Config config) {
        this.config = config != null ? config : new Idea31841Config();
