...
@Data
public class Idea31867Config {
    private String name = "idea_031867";
 ...
 */
@Slf4j
public class Idea31867Service {
    private static final int IDEA_ID = 31867;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31867Service() {
        this(new Idea31867Config());
    }

    public Idea31867Service(Idea31867Config config) {
        this.config = config != null ? config : new Idea31867Config();
