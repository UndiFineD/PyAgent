...
@Data
public class Idea31907Config {
    private String name = "idea_031907";
 ...
 */
@Slf4j
public class Idea31907Service {
    private static final int IDEA_ID = 31907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31907Service() {
        this(new Idea31907Config());
    }

    public Idea31907Service(Idea31907Config config) {
        this.config = config != null ? config : new Idea31907Config();
