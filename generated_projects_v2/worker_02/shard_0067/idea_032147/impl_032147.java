...
@Data
public class Idea32147Config {
    private String name = "idea_032147";
 ...
 */
@Slf4j
public class Idea32147Service {
    private static final int IDEA_ID = 32147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32147Service() {
        this(new Idea32147Config());
    }

    public Idea32147Service(Idea32147Config config) {
        this.config = config != null ? config : new Idea32147Config();
