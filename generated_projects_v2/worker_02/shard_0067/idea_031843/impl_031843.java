...
@Data
public class Idea31843Config {
    private String name = "idea_031843";
 ...
 */
@Slf4j
public class Idea31843Service {
    private static final int IDEA_ID = 31843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31843Service() {
        this(new Idea31843Config());
    }

    public Idea31843Service(Idea31843Config config) {
        this.config = config != null ? config : new Idea31843Config();
