...
@Data
public class Idea32236Config {
    private String name = "idea_032236";
 ...
 */
@Slf4j
public class Idea32236Service {
    private static final int IDEA_ID = 32236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32236Service() {
        this(new Idea32236Config());
    }

    public Idea32236Service(Idea32236Config config) {
        this.config = config != null ? config : new Idea32236Config();
