...
@Data
public class Idea32100Config {
    private String name = "idea_032100";
 ...
 */
@Slf4j
public class Idea32100Service {
    private static final int IDEA_ID = 32100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32100Service() {
        this(new Idea32100Config());
    }

    public Idea32100Service(Idea32100Config config) {
        this.config = config != null ? config : new Idea32100Config();
