...
@Data
public class Idea32181Config {
    private String name = "idea_032181";
 ...
 */
@Slf4j
public class Idea32181Service {
    private static final int IDEA_ID = 32181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32181Service() {
        this(new Idea32181Config());
    }

    public Idea32181Service(Idea32181Config config) {
        this.config = config != null ? config : new Idea32181Config();
