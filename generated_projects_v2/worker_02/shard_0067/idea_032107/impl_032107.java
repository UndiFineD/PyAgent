...
@Data
public class Idea32107Config {
    private String name = "idea_032107";
 ...
 */
@Slf4j
public class Idea32107Service {
    private static final int IDEA_ID = 32107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32107Service() {
        this(new Idea32107Config());
    }

    public Idea32107Service(Idea32107Config config) {
        this.config = config != null ? config : new Idea32107Config();
