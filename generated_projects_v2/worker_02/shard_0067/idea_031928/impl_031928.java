...
@Data
public class Idea31928Config {
    private String name = "idea_031928";
 ...
 */
@Slf4j
public class Idea31928Service {
    private static final int IDEA_ID = 31928;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31928Service() {
        this(new Idea31928Config());
    }

    public Idea31928Service(Idea31928Config config) {
        this.config = config != null ? config : new Idea31928Config();
