...
@Data
public class Idea32272Config {
    private String name = "idea_032272";
 ...
 */
@Slf4j
public class Idea32272Service {
    private static final int IDEA_ID = 32272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32272Service() {
        this(new Idea32272Config());
    }

    public Idea32272Service(Idea32272Config config) {
        this.config = config != null ? config : new Idea32272Config();
