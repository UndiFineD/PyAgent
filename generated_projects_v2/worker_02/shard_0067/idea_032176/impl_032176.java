...
@Data
public class Idea32176Config {
    private String name = "idea_032176";
 ...
 */
@Slf4j
public class Idea32176Service {
    private static final int IDEA_ID = 32176;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32176Service() {
        this(new Idea32176Config());
    }

    public Idea32176Service(Idea32176Config config) {
        this.config = config != null ? config : new Idea32176Config();
