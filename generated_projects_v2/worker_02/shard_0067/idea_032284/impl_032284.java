...
@Data
public class Idea32284Config {
    private String name = "idea_032284";
 ...
 */
@Slf4j
public class Idea32284Service {
    private static final int IDEA_ID = 32284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32284Service() {
        this(new Idea32284Config());
    }

    public Idea32284Service(Idea32284Config config) {
        this.config = config != null ? config : new Idea32284Config();
