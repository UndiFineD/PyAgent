...
@Data
public class Idea32277Config {
    private String name = "idea_032277";
 ...
 */
@Slf4j
public class Idea32277Service {
    private static final int IDEA_ID = 32277;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32277Service() {
        this(new Idea32277Config());
    }

    public Idea32277Service(Idea32277Config config) {
        this.config = config != null ? config : new Idea32277Config();
