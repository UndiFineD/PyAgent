...
@Data
public class Idea32165Config {
    private String name = "idea_032165";
 ...
 */
@Slf4j
public class Idea32165Service {
    private static final int IDEA_ID = 32165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32165Service() {
        this(new Idea32165Config());
    }

    public Idea32165Service(Idea32165Config config) {
        this.config = config != null ? config : new Idea32165Config();
