...
@Data
public class Idea32184Config {
    private String name = "idea_032184";
 ...
 */
@Slf4j
public class Idea32184Service {
    private static final int IDEA_ID = 32184;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32184Service() {
        this(new Idea32184Config());
    }

    public Idea32184Service(Idea32184Config config) {
        this.config = config != null ? config : new Idea32184Config();
