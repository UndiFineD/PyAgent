...
@Data
public class Idea32240Config {
    private String name = "idea_032240";
 ...
 */
@Slf4j
public class Idea32240Service {
    private static final int IDEA_ID = 32240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32240Service() {
        this(new Idea32240Config());
    }

    public Idea32240Service(Idea32240Config config) {
        this.config = config != null ? config : new Idea32240Config();
