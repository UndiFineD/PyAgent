...
@Data
public class Idea31931Config {
    private String name = "idea_031931";
 ...
 */
@Slf4j
public class Idea31931Service {
    private static final int IDEA_ID = 31931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31931Service() {
        this(new Idea31931Config());
    }

    public Idea31931Service(Idea31931Config config) {
        this.config = config != null ? config : new Idea31931Config();
