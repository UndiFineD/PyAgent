...
@Data
public class Idea32274Config {
    private String name = "idea_032274";
 ...
 */
@Slf4j
public class Idea32274Service {
    private static final int IDEA_ID = 32274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32274Service() {
        this(new Idea32274Config());
    }

    public Idea32274Service(Idea32274Config config) {
        this.config = config != null ? config : new Idea32274Config();
