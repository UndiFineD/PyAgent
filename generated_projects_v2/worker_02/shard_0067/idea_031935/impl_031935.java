...
@Data
public class Idea31935Config {
    private String name = "idea_031935";
 ...
 */
@Slf4j
public class Idea31935Service {
    private static final int IDEA_ID = 31935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31935Service() {
        this(new Idea31935Config());
    }

    public Idea31935Service(Idea31935Config config) {
        this.config = config != null ? config : new Idea31935Config();
