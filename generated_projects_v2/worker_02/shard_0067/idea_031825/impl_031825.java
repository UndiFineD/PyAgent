...
@Data
public class Idea31825Config {
    private String name = "idea_031825";
 ...
 */
@Slf4j
public class Idea31825Service {
    private static final int IDEA_ID = 31825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31825Service() {
        this(new Idea31825Config());
    }

    public Idea31825Service(Idea31825Config config) {
        this.config = config != null ? config : new Idea31825Config();
