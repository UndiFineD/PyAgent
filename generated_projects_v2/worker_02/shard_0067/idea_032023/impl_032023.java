...
@Data
public class Idea32023Config {
    private String name = "idea_032023";
 ...
 */
@Slf4j
public class Idea32023Service {
    private static final int IDEA_ID = 32023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32023Service() {
        this(new Idea32023Config());
    }

    public Idea32023Service(Idea32023Config config) {
        this.config = config != null ? config : new Idea32023Config();
