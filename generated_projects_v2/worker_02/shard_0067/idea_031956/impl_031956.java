...
@Data
public class Idea31956Config {
    private String name = "idea_031956";
 ...
 */
@Slf4j
public class Idea31956Service {
    private static final int IDEA_ID = 31956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31956Service() {
        this(new Idea31956Config());
    }

    public Idea31956Service(Idea31956Config config) {
        this.config = config != null ? config : new Idea31956Config();
