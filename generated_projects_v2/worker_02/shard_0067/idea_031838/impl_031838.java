...
@Data
public class Idea31838Config {
    private String name = "idea_031838";
 ...
 */
@Slf4j
public class Idea31838Service {
    private static final int IDEA_ID = 31838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31838Service() {
        this(new Idea31838Config());
    }

    public Idea31838Service(Idea31838Config config) {
        this.config = config != null ? config : new Idea31838Config();
