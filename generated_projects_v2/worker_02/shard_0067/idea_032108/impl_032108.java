...
@Data
public class Idea32108Config {
    private String name = "idea_032108";
 ...
 */
@Slf4j
public class Idea32108Service {
    private static final int IDEA_ID = 32108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32108Service() {
        this(new Idea32108Config());
    }

    public Idea32108Service(Idea32108Config config) {
        this.config = config != null ? config : new Idea32108Config();
