...
@Data
public class Idea32197Config {
    private String name = "idea_032197";
 ...
 */
@Slf4j
public class Idea32197Service {
    private static final int IDEA_ID = 32197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32197Service() {
        this(new Idea32197Config());
    }

    public Idea32197Service(Idea32197Config config) {
        this.config = config != null ? config : new Idea32197Config();
