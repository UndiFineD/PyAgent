...
@Data
public class Idea32020Config {
    private String name = "idea_032020";
 ...
 */
@Slf4j
public class Idea32020Service {
    private static final int IDEA_ID = 32020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32020Service() {
        this(new Idea32020Config());
    }

    public Idea32020Service(Idea32020Config config) {
        this.config = config != null ? config : new Idea32020Config();
