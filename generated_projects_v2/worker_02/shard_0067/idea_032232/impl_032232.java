...
@Data
public class Idea32232Config {
    private String name = "idea_032232";
 ...
 */
@Slf4j
public class Idea32232Service {
    private static final int IDEA_ID = 32232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32232Service() {
        this(new Idea32232Config());
    }

    public Idea32232Service(Idea32232Config config) {
        this.config = config != null ? config : new Idea32232Config();
