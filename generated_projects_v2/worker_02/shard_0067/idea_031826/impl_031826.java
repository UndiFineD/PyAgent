...
@Data
public class Idea31826Config {
    private String name = "idea_031826";
 ...
 */
@Slf4j
public class Idea31826Service {
    private static final int IDEA_ID = 31826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31826Service() {
        this(new Idea31826Config());
    }

    public Idea31826Service(Idea31826Config config) {
        this.config = config != null ? config : new Idea31826Config();
