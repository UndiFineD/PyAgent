...
@Data
public class Idea31903Config {
    private String name = "idea_031903";
 ...
 */
@Slf4j
public class Idea31903Service {
    private static final int IDEA_ID = 31903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31903Service() {
        this(new Idea31903Config());
    }

    public Idea31903Service(Idea31903Config config) {
        this.config = config != null ? config : new Idea31903Config();
