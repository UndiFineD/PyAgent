...
@Data
public class Idea32239Config {
    private String name = "idea_032239";
 ...
 */
@Slf4j
public class Idea32239Service {
    private static final int IDEA_ID = 32239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32239Service() {
        this(new Idea32239Config());
    }

    public Idea32239Service(Idea32239Config config) {
        this.config = config != null ? config : new Idea32239Config();
