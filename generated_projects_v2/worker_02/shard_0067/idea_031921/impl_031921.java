...
@Data
public class Idea31921Config {
    private String name = "idea_031921";
 ...
 */
@Slf4j
public class Idea31921Service {
    private static final int IDEA_ID = 31921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31921Service() {
        this(new Idea31921Config());
    }

    public Idea31921Service(Idea31921Config config) {
        this.config = config != null ? config : new Idea31921Config();
