...
@Data
public class Idea32072Config {
    private String name = "idea_032072";
 ...
 */
@Slf4j
public class Idea32072Service {
    private static final int IDEA_ID = 32072;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32072Service() {
        this(new Idea32072Config());
    }

    public Idea32072Service(Idea32072Config config) {
        this.config = config != null ? config : new Idea32072Config();
