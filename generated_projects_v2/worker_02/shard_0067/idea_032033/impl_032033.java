...
@Data
public class Idea32033Config {
    private String name = "idea_032033";
 ...
 */
@Slf4j
public class Idea32033Service {
    private static final int IDEA_ID = 32033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32033Service() {
        this(new Idea32033Config());
    }

    public Idea32033Service(Idea32033Config config) {
        this.config = config != null ? config : new Idea32033Config();
