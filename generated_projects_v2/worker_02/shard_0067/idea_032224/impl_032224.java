...
@Data
public class Idea32224Config {
    private String name = "idea_032224";
 ...
 */
@Slf4j
public class Idea32224Service {
    private static final int IDEA_ID = 32224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32224Service() {
        this(new Idea32224Config());
    }

    public Idea32224Service(Idea32224Config config) {
        this.config = config != null ? config : new Idea32224Config();
