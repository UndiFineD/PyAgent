...
@Data
public class Idea31957Config {
    private String name = "idea_031957";
 ...
 */
@Slf4j
public class Idea31957Service {
    private static final int IDEA_ID = 31957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31957Service() {
        this(new Idea31957Config());
    }

    public Idea31957Service(Idea31957Config config) {
        this.config = config != null ? config : new Idea31957Config();
