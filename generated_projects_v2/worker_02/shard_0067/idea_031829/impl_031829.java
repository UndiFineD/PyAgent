...
@Data
public class Idea31829Config {
    private String name = "idea_031829";
 ...
 */
@Slf4j
public class Idea31829Service {
    private static final int IDEA_ID = 31829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31829Service() {
        this(new Idea31829Config());
    }

    public Idea31829Service(Idea31829Config config) {
        this.config = config != null ? config : new Idea31829Config();
