...
@Data
public class Idea31955Config {
    private String name = "idea_031955";
 ...
 */
@Slf4j
public class Idea31955Service {
    private static final int IDEA_ID = 31955;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31955Service() {
        this(new Idea31955Config());
    }

    public Idea31955Service(Idea31955Config config) {
        this.config = config != null ? config : new Idea31955Config();
