...
@Data
public class Idea32278Config {
    private String name = "idea_032278";
 ...
 */
@Slf4j
public class Idea32278Service {
    private static final int IDEA_ID = 32278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32278Service() {
        this(new Idea32278Config());
    }

    public Idea32278Service(Idea32278Config config) {
        this.config = config != null ? config : new Idea32278Config();
