...
@Data
public class Idea31963Config {
    private String name = "idea_031963";
 ...
 */
@Slf4j
public class Idea31963Service {
    private static final int IDEA_ID = 31963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31963Service() {
        this(new Idea31963Config());
    }

    public Idea31963Service(Idea31963Config config) {
        this.config = config != null ? config : new Idea31963Config();
