...
@Data
public class Idea32071Config {
    private String name = "idea_032071";
 ...
 */
@Slf4j
public class Idea32071Service {
    private static final int IDEA_ID = 32071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32071Service() {
        this(new Idea32071Config());
    }

    public Idea32071Service(Idea32071Config config) {
        this.config = config != null ? config : new Idea32071Config();
