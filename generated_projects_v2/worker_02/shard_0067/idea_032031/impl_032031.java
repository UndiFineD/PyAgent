...
@Data
public class Idea32031Config {
    private String name = "idea_032031";
 ...
 */
@Slf4j
public class Idea32031Service {
    private static final int IDEA_ID = 32031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32031Service() {
        this(new Idea32031Config());
    }

    public Idea32031Service(Idea32031Config config) {
        this.config = config != null ? config : new Idea32031Config();
