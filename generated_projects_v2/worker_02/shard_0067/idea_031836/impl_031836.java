...
@Data
public class Idea31836Config {
    private String name = "idea_031836";
 ...
 */
@Slf4j
public class Idea31836Service {
    private static final int IDEA_ID = 31836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31836Service() {
        this(new Idea31836Config());
    }

    public Idea31836Service(Idea31836Config config) {
        this.config = config != null ? config : new Idea31836Config();
