...
@Data
public class Idea32275Config {
    private String name = "idea_032275";
 ...
 */
@Slf4j
public class Idea32275Service {
    private static final int IDEA_ID = 32275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32275Service() {
        this(new Idea32275Config());
    }

    public Idea32275Service(Idea32275Config config) {
        this.config = config != null ? config : new Idea32275Config();
