...
@Data
public class Idea31993Config {
    private String name = "idea_031993";
 ...
 */
@Slf4j
public class Idea31993Service {
    private static final int IDEA_ID = 31993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31993Service() {
        this(new Idea31993Config());
    }

    public Idea31993Service(Idea31993Config config) {
        this.config = config != null ? config : new Idea31993Config();
