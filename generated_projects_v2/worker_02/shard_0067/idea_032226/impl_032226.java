...
@Data
public class Idea32226Config {
    private String name = "idea_032226";
 ...
 */
@Slf4j
public class Idea32226Service {
    private static final int IDEA_ID = 32226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32226Service() {
        this(new Idea32226Config());
    }

    public Idea32226Service(Idea32226Config config) {
        this.config = config != null ? config : new Idea32226Config();
