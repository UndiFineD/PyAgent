...
@Data
public class Idea32013Config {
    private String name = "idea_032013";
 ...
 */
@Slf4j
public class Idea32013Service {
    private static final int IDEA_ID = 32013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32013Service() {
        this(new Idea32013Config());
    }

    public Idea32013Service(Idea32013Config config) {
        this.config = config != null ? config : new Idea32013Config();
