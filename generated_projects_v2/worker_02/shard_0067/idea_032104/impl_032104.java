...
@Data
public class Idea32104Config {
    private String name = "idea_032104";
 ...
 */
@Slf4j
public class Idea32104Service {
    private static final int IDEA_ID = 32104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32104Service() {
        this(new Idea32104Config());
    }

    public Idea32104Service(Idea32104Config config) {
        this.config = config != null ? config : new Idea32104Config();
