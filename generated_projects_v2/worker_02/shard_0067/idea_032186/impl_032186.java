...
@Data
public class Idea32186Config {
    private String name = "idea_032186";
 ...
 */
@Slf4j
public class Idea32186Service {
    private static final int IDEA_ID = 32186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32186Service() {
        this(new Idea32186Config());
    }

    public Idea32186Service(Idea32186Config config) {
        this.config = config != null ? config : new Idea32186Config();
