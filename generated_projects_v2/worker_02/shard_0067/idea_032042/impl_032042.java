...
@Data
public class Idea32042Config {
    private String name = "idea_032042";
 ...
 */
@Slf4j
public class Idea32042Service {
    private static final int IDEA_ID = 32042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32042Service() {
        this(new Idea32042Config());
    }

    public Idea32042Service(Idea32042Config config) {
        this.config = config != null ? config : new Idea32042Config();
