...
@Data
public class Idea32291Config {
    private String name = "idea_032291";
 ...
 */
@Slf4j
public class Idea32291Service {
    private static final int IDEA_ID = 32291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32291Service() {
        this(new Idea32291Config());
    }

    public Idea32291Service(Idea32291Config config) {
        this.config = config != null ? config : new Idea32291Config();
