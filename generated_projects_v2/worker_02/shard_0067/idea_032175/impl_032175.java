...
@Data
public class Idea32175Config {
    private String name = "idea_032175";
 ...
 */
@Slf4j
public class Idea32175Service {
    private static final int IDEA_ID = 32175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32175Service() {
        this(new Idea32175Config());
    }

    public Idea32175Service(Idea32175Config config) {
        this.config = config != null ? config : new Idea32175Config();
