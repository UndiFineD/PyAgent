...
@Data
public class Idea32296Config {
    private String name = "idea_032296";
 ...
 */
@Slf4j
public class Idea32296Service {
    private static final int IDEA_ID = 32296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32296Service() {
        this(new Idea32296Config());
    }

    public Idea32296Service(Idea32296Config config) {
        this.config = config != null ? config : new Idea32296Config();
