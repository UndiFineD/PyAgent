...
@Data
public class Idea31911Config {
    private String name = "idea_031911";
 ...
 */
@Slf4j
public class Idea31911Service {
    private static final int IDEA_ID = 31911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31911Service() {
        this(new Idea31911Config());
    }

    public Idea31911Service(Idea31911Config config) {
        this.config = config != null ? config : new Idea31911Config();
