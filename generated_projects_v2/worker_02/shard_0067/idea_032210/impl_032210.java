...
@Data
public class Idea32210Config {
    private String name = "idea_032210";
 ...
 */
@Slf4j
public class Idea32210Service {
    private static final int IDEA_ID = 32210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32210Service() {
        this(new Idea32210Config());
    }

    public Idea32210Service(Idea32210Config config) {
        this.config = config != null ? config : new Idea32210Config();
