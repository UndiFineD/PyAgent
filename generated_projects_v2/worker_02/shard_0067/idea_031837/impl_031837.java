...
@Data
public class Idea31837Config {
    private String name = "idea_031837";
 ...
 */
@Slf4j
public class Idea31837Service {
    private static final int IDEA_ID = 31837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31837Service() {
        this(new Idea31837Config());
    }

    public Idea31837Service(Idea31837Config config) {
        this.config = config != null ? config : new Idea31837Config();
