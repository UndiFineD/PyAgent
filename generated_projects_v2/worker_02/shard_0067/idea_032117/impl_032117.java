...
@Data
public class Idea32117Config {
    private String name = "idea_032117";
 ...
 */
@Slf4j
public class Idea32117Service {
    private static final int IDEA_ID = 32117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32117Service() {
        this(new Idea32117Config());
    }

    public Idea32117Service(Idea32117Config config) {
        this.config = config != null ? config : new Idea32117Config();
