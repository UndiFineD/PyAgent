...
@Data
public class Idea32040Config {
    private String name = "idea_032040";
 ...
 */
@Slf4j
public class Idea32040Service {
    private static final int IDEA_ID = 32040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32040Service() {
        this(new Idea32040Config());
    }

    public Idea32040Service(Idea32040Config config) {
        this.config = config != null ? config : new Idea32040Config();
