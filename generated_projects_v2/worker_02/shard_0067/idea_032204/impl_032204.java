...
@Data
public class Idea32204Config {
    private String name = "idea_032204";
 ...
 */
@Slf4j
public class Idea32204Service {
    private static final int IDEA_ID = 32204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32204Service() {
        this(new Idea32204Config());
    }

    public Idea32204Service(Idea32204Config config) {
        this.config = config != null ? config : new Idea32204Config();
