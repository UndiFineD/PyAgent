...
@Data
public class Idea32004Config {
    private String name = "idea_032004";
 ...
 */
@Slf4j
public class Idea32004Service {
    private static final int IDEA_ID = 32004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32004Service() {
        this(new Idea32004Config());
    }

    public Idea32004Service(Idea32004Config config) {
        this.config = config != null ? config : new Idea32004Config();
