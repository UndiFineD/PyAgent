...
@Data
public class Idea32179Config {
    private String name = "idea_032179";
 ...
 */
@Slf4j
public class Idea32179Service {
    private static final int IDEA_ID = 32179;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32179Service() {
        this(new Idea32179Config());
    }

    public Idea32179Service(Idea32179Config config) {
        this.config = config != null ? config : new Idea32179Config();
