...
@Data
public class Idea32055Config {
    private String name = "idea_032055";
 ...
 */
@Slf4j
public class Idea32055Service {
    private static final int IDEA_ID = 32055;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32055Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32055Service() {
        this(new Idea32055Config());
    }

    public Idea32055Service(Idea32055Config config) {
        this.config = config != null ? config : new Idea32055Config();
