...
@Data
public class Idea32202Config {
    private String name = "idea_032202";
 ...
 */
@Slf4j
public class Idea32202Service {
    private static final int IDEA_ID = 32202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32202Service() {
        this(new Idea32202Config());
    }

    public Idea32202Service(Idea32202Config config) {
        this.config = config != null ? config : new Idea32202Config();
