...
@Data
public class Idea32171Config {
    private String name = "idea_032171";
 ...
 */
@Slf4j
public class Idea32171Service {
    private static final int IDEA_ID = 32171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32171Service() {
        this(new Idea32171Config());
    }

    public Idea32171Service(Idea32171Config config) {
        this.config = config != null ? config : new Idea32171Config();
