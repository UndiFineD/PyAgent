...
@Data
public class Idea31925Config {
    private String name = "idea_031925";
 ...
 */
@Slf4j
public class Idea31925Service {
    private static final int IDEA_ID = 31925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31925Service() {
        this(new Idea31925Config());
    }

    public Idea31925Service(Idea31925Config config) {
        this.config = config != null ? config : new Idea31925Config();
