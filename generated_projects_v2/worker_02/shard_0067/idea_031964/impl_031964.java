...
@Data
public class Idea31964Config {
    private String name = "idea_031964";
 ...
 */
@Slf4j
public class Idea31964Service {
    private static final int IDEA_ID = 31964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31964Service() {
        this(new Idea31964Config());
    }

    public Idea31964Service(Idea31964Config config) {
        this.config = config != null ? config : new Idea31964Config();
