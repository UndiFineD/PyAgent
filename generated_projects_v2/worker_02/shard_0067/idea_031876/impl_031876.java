...
@Data
public class Idea31876Config {
    private String name = "idea_031876";
 ...
 */
@Slf4j
public class Idea31876Service {
    private static final int IDEA_ID = 31876;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31876Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31876Service() {
        this(new Idea31876Config());
    }

    public Idea31876Service(Idea31876Config config) {
        this.config = config != null ? config : new Idea31876Config();
