...
@Data
public class Idea31871Config {
    private String name = "idea_031871";
 ...
 */
@Slf4j
public class Idea31871Service {
    private static final int IDEA_ID = 31871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31871Service() {
        this(new Idea31871Config());
    }

    public Idea31871Service(Idea31871Config config) {
        this.config = config != null ? config : new Idea31871Config();
