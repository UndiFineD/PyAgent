...
@Data
public class Idea32127Config {
    private String name = "idea_032127";
 ...
 */
@Slf4j
public class Idea32127Service {
    private static final int IDEA_ID = 32127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32127Service() {
        this(new Idea32127Config());
    }

    public Idea32127Service(Idea32127Config config) {
        this.config = config != null ? config : new Idea32127Config();
