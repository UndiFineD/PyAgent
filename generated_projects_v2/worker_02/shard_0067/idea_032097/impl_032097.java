...
@Data
public class Idea32097Config {
    private String name = "idea_032097";
 ...
 */
@Slf4j
public class Idea32097Service {
    private static final int IDEA_ID = 32097;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32097Service() {
        this(new Idea32097Config());
    }

    public Idea32097Service(Idea32097Config config) {
        this.config = config != null ? config : new Idea32097Config();
