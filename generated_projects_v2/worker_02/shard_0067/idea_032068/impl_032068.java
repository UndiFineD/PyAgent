...
@Data
public class Idea32068Config {
    private String name = "idea_032068";
 ...
 */
@Slf4j
public class Idea32068Service {
    private static final int IDEA_ID = 32068;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32068Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32068Service() {
        this(new Idea32068Config());
    }

    public Idea32068Service(Idea32068Config config) {
        this.config = config != null ? config : new Idea32068Config();
