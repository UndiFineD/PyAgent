...
@Data
public class Idea31872Config {
    private String name = "idea_031872";
 ...
 */
@Slf4j
public class Idea31872Service {
    private static final int IDEA_ID = 31872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31872Service() {
        this(new Idea31872Config());
    }

    public Idea31872Service(Idea31872Config config) {
        this.config = config != null ? config : new Idea31872Config();
