...
@Data
public class Idea31945Config {
    private String name = "idea_031945";
 ...
 */
@Slf4j
public class Idea31945Service {
    private static final int IDEA_ID = 31945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31945Service() {
        this(new Idea31945Config());
    }

    public Idea31945Service(Idea31945Config config) {
        this.config = config != null ? config : new Idea31945Config();
