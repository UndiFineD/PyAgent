...
@Data
public class Idea31937Config {
    private String name = "idea_031937";
 ...
 */
@Slf4j
public class Idea31937Service {
    private static final int IDEA_ID = 31937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31937Service() {
        this(new Idea31937Config());
    }

    public Idea31937Service(Idea31937Config config) {
        this.config = config != null ? config : new Idea31937Config();
