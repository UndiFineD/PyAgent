...
@Data
public class Idea32085Config {
    private String name = "idea_032085";
 ...
 */
@Slf4j
public class Idea32085Service {
    private static final int IDEA_ID = 32085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32085Service() {
        this(new Idea32085Config());
    }

    public Idea32085Service(Idea32085Config config) {
        this.config = config != null ? config : new Idea32085Config();
