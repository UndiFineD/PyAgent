...
@Data
public class Idea31827Config {
    private String name = "idea_031827";
 ...
 */
@Slf4j
public class Idea31827Service {
    private static final int IDEA_ID = 31827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31827Service() {
        this(new Idea31827Config());
    }

    public Idea31827Service(Idea31827Config config) {
        this.config = config != null ? config : new Idea31827Config();
