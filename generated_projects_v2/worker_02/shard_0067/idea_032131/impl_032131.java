...
@Data
public class Idea32131Config {
    private String name = "idea_032131";
 ...
 */
@Slf4j
public class Idea32131Service {
    private static final int IDEA_ID = 32131;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32131Service() {
        this(new Idea32131Config());
    }

    public Idea32131Service(Idea32131Config config) {
        this.config = config != null ? config : new Idea32131Config();
