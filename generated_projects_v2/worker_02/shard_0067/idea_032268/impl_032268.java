...
@Data
public class Idea32268Config {
    private String name = "idea_032268";
 ...
 */
@Slf4j
public class Idea32268Service {
    private static final int IDEA_ID = 32268;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32268Service() {
        this(new Idea32268Config());
    }

    public Idea32268Service(Idea32268Config config) {
        this.config = config != null ? config : new Idea32268Config();
