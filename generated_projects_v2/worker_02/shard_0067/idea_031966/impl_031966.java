...
@Data
public class Idea31966Config {
    private String name = "idea_031966";
 ...
 */
@Slf4j
public class Idea31966Service {
    private static final int IDEA_ID = 31966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31966Service() {
        this(new Idea31966Config());
    }

    public Idea31966Service(Idea31966Config config) {
        this.config = config != null ? config : new Idea31966Config();
