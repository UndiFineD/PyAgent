...
@Data
public class Idea32032Config {
    private String name = "idea_032032";
 ...
 */
@Slf4j
public class Idea32032Service {
    private static final int IDEA_ID = 32032;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32032Service() {
        this(new Idea32032Config());
    }

    public Idea32032Service(Idea32032Config config) {
        this.config = config != null ? config : new Idea32032Config();
