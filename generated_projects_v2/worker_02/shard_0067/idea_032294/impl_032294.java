...
@Data
public class Idea32294Config {
    private String name = "idea_032294";
 ...
 */
@Slf4j
public class Idea32294Service {
    private static final int IDEA_ID = 32294;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32294Service() {
        this(new Idea32294Config());
    }

    public Idea32294Service(Idea32294Config config) {
        this.config = config != null ? config : new Idea32294Config();
