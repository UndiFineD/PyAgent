...
@Data
public class Idea31848Config {
    private String name = "idea_031848";
 ...
 */
@Slf4j
public class Idea31848Service {
    private static final int IDEA_ID = 31848;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31848Service() {
        this(new Idea31848Config());
    }

    public Idea31848Service(Idea31848Config config) {
        this.config = config != null ? config : new Idea31848Config();
