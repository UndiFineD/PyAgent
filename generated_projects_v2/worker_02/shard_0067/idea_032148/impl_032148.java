...
@Data
public class Idea32148Config {
    private String name = "idea_032148";
 ...
 */
@Slf4j
public class Idea32148Service {
    private static final int IDEA_ID = 32148;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32148Service() {
        this(new Idea32148Config());
    }

    public Idea32148Service(Idea32148Config config) {
        this.config = config != null ? config : new Idea32148Config();
