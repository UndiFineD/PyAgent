...
@Data
public class Idea31839Config {
    private String name = "idea_031839";
 ...
 */
@Slf4j
public class Idea31839Service {
    private static final int IDEA_ID = 31839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31839Service() {
        this(new Idea31839Config());
    }

    public Idea31839Service(Idea31839Config config) {
        this.config = config != null ? config : new Idea31839Config();
