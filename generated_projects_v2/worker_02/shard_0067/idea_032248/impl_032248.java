...
@Data
public class Idea32248Config {
    private String name = "idea_032248";
 ...
 */
@Slf4j
public class Idea32248Service {
    private static final int IDEA_ID = 32248;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32248Service() {
        this(new Idea32248Config());
    }

    public Idea32248Service(Idea32248Config config) {
        this.config = config != null ? config : new Idea32248Config();
