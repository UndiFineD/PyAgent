...
@Data
public class Idea32064Config {
    private String name = "idea_032064";
 ...
 */
@Slf4j
public class Idea32064Service {
    private static final int IDEA_ID = 32064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32064Service() {
        this(new Idea32064Config());
    }

    public Idea32064Service(Idea32064Config config) {
        this.config = config != null ? config : new Idea32064Config();
