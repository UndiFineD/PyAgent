...
@Data
public class Idea32205Config {
    private String name = "idea_032205";
 ...
 */
@Slf4j
public class Idea32205Service {
    private static final int IDEA_ID = 32205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32205Service() {
        this(new Idea32205Config());
    }

    public Idea32205Service(Idea32205Config config) {
        this.config = config != null ? config : new Idea32205Config();
