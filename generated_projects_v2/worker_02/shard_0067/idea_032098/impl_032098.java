...
@Data
public class Idea32098Config {
    private String name = "idea_032098";
 ...
 */
@Slf4j
public class Idea32098Service {
    private static final int IDEA_ID = 32098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32098Service() {
        this(new Idea32098Config());
    }

    public Idea32098Service(Idea32098Config config) {
        this.config = config != null ? config : new Idea32098Config();
