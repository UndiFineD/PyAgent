...
@Data
public class Idea31916Config {
    private String name = "idea_031916";
 ...
 */
@Slf4j
public class Idea31916Service {
    private static final int IDEA_ID = 31916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31916Service() {
        this(new Idea31916Config());
    }

    public Idea31916Service(Idea31916Config config) {
        this.config = config != null ? config : new Idea31916Config();
