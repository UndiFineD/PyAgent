...
@Data
public class Idea32126Config {
    private String name = "idea_032126";
 ...
 */
@Slf4j
public class Idea32126Service {
    private static final int IDEA_ID = 32126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32126Service() {
        this(new Idea32126Config());
    }

    public Idea32126Service(Idea32126Config config) {
        this.config = config != null ? config : new Idea32126Config();
