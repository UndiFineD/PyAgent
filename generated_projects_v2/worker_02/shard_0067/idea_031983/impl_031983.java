...
@Data
public class Idea31983Config {
    private String name = "idea_031983";
 ...
 */
@Slf4j
public class Idea31983Service {
    private static final int IDEA_ID = 31983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31983Service() {
        this(new Idea31983Config());
    }

    public Idea31983Service(Idea31983Config config) {
        this.config = config != null ? config : new Idea31983Config();
