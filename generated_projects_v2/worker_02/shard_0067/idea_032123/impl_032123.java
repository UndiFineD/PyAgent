...
@Data
public class Idea32123Config {
    private String name = "idea_032123";
 ...
 */
@Slf4j
public class Idea32123Service {
    private static final int IDEA_ID = 32123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32123Service() {
        this(new Idea32123Config());
    }

    public Idea32123Service(Idea32123Config config) {
        this.config = config != null ? config : new Idea32123Config();
