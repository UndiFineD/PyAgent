...
@Data
public class Idea32233Config {
    private String name = "idea_032233";
 ...
 */
@Slf4j
public class Idea32233Service {
    private static final int IDEA_ID = 32233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32233Service() {
        this(new Idea32233Config());
    }

    public Idea32233Service(Idea32233Config config) {
        this.config = config != null ? config : new Idea32233Config();
