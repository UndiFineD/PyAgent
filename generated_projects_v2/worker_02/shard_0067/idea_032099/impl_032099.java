...
@Data
public class Idea32099Config {
    private String name = "idea_032099";
 ...
 */
@Slf4j
public class Idea32099Service {
    private static final int IDEA_ID = 32099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32099Service() {
        this(new Idea32099Config());
    }

    public Idea32099Service(Idea32099Config config) {
        this.config = config != null ? config : new Idea32099Config();
