...
@Data
public class Idea32261Config {
    private String name = "idea_032261";
 ...
 */
@Slf4j
public class Idea32261Service {
    private static final int IDEA_ID = 32261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32261Service() {
        this(new Idea32261Config());
    }

    public Idea32261Service(Idea32261Config config) {
        this.config = config != null ? config : new Idea32261Config();
