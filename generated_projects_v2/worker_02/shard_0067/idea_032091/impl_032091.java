...
@Data
public class Idea32091Config {
    private String name = "idea_032091";
 ...
 */
@Slf4j
public class Idea32091Service {
    private static final int IDEA_ID = 32091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32091Service() {
        this(new Idea32091Config());
    }

    public Idea32091Service(Idea32091Config config) {
        this.config = config != null ? config : new Idea32091Config();
