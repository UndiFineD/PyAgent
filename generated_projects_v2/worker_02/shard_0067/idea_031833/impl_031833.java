...
@Data
public class Idea31833Config {
    private String name = "idea_031833";
 ...
 */
@Slf4j
public class Idea31833Service {
    private static final int IDEA_ID = 31833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31833Service() {
        this(new Idea31833Config());
    }

    public Idea31833Service(Idea31833Config config) {
        this.config = config != null ? config : new Idea31833Config();
