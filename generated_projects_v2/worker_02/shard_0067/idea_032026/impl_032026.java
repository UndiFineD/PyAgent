...
@Data
public class Idea32026Config {
    private String name = "idea_032026";
 ...
 */
@Slf4j
public class Idea32026Service {
    private static final int IDEA_ID = 32026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32026Service() {
        this(new Idea32026Config());
    }

    public Idea32026Service(Idea32026Config config) {
        this.config = config != null ? config : new Idea32026Config();
