...
@Data
public class Idea32215Config {
    private String name = "idea_032215";
 ...
 */
@Slf4j
public class Idea32215Service {
    private static final int IDEA_ID = 32215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32215Service() {
        this(new Idea32215Config());
    }

    public Idea32215Service(Idea32215Config config) {
        this.config = config != null ? config : new Idea32215Config();
