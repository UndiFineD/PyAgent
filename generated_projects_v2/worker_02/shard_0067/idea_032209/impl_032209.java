...
@Data
public class Idea32209Config {
    private String name = "idea_032209";
 ...
 */
@Slf4j
public class Idea32209Service {
    private static final int IDEA_ID = 32209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32209Service() {
        this(new Idea32209Config());
    }

    public Idea32209Service(Idea32209Config config) {
        this.config = config != null ? config : new Idea32209Config();
