...
@Data
public class Idea31982Config {
    private String name = "idea_031982";
 ...
 */
@Slf4j
public class Idea31982Service {
    private static final int IDEA_ID = 31982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31982Service() {
        this(new Idea31982Config());
    }

    public Idea31982Service(Idea31982Config config) {
        this.config = config != null ? config : new Idea31982Config();
