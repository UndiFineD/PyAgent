...
@Data
public class Idea32295Config {
    private String name = "idea_032295";
 ...
 */
@Slf4j
public class Idea32295Service {
    private static final int IDEA_ID = 32295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32295Service() {
        this(new Idea32295Config());
    }

    public Idea32295Service(Idea32295Config config) {
        this.config = config != null ? config : new Idea32295Config();
