...
@Data
public class Idea32006Config {
    private String name = "idea_032006";
 ...
 */
@Slf4j
public class Idea32006Service {
    private static final int IDEA_ID = 32006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32006Service() {
        this(new Idea32006Config());
    }

    public Idea32006Service(Idea32006Config config) {
        this.config = config != null ? config : new Idea32006Config();
