...
@Data
public class Idea32086Config {
    private String name = "idea_032086";
 ...
 */
@Slf4j
public class Idea32086Service {
    private static final int IDEA_ID = 32086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32086Service() {
        this(new Idea32086Config());
    }

    public Idea32086Service(Idea32086Config config) {
        this.config = config != null ? config : new Idea32086Config();
