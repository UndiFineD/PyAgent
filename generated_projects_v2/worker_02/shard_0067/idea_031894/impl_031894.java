...
@Data
public class Idea31894Config {
    private String name = "idea_031894";
 ...
 */
@Slf4j
public class Idea31894Service {
    private static final int IDEA_ID = 31894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31894Service() {
        this(new Idea31894Config());
    }

    public Idea31894Service(Idea31894Config config) {
        this.config = config != null ? config : new Idea31894Config();
