...
@Data
public class Idea32228Config {
    private String name = "idea_032228";
 ...
 */
@Slf4j
public class Idea32228Service {
    private static final int IDEA_ID = 32228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32228Service() {
        this(new Idea32228Config());
    }

    public Idea32228Service(Idea32228Config config) {
        this.config = config != null ? config : new Idea32228Config();
