...
@Data
public class Idea32081Config {
    private String name = "idea_032081";
 ...
 */
@Slf4j
public class Idea32081Service {
    private static final int IDEA_ID = 32081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32081Service() {
        this(new Idea32081Config());
    }

    public Idea32081Service(Idea32081Config config) {
        this.config = config != null ? config : new Idea32081Config();
