...
@Data
public class Idea32125Config {
    private String name = "idea_032125";
 ...
 */
@Slf4j
public class Idea32125Service {
    private static final int IDEA_ID = 32125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32125Service() {
        this(new Idea32125Config());
    }

    public Idea32125Service(Idea32125Config config) {
        this.config = config != null ? config : new Idea32125Config();
