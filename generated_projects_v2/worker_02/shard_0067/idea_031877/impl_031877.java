...
@Data
public class Idea31877Config {
    private String name = "idea_031877";
 ...
 */
@Slf4j
public class Idea31877Service {
    private static final int IDEA_ID = 31877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31877Service() {
        this(new Idea31877Config());
    }

    public Idea31877Service(Idea31877Config config) {
        this.config = config != null ? config : new Idea31877Config();
