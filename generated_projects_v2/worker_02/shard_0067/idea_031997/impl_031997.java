...
@Data
public class Idea31997Config {
    private String name = "idea_031997";
 ...
 */
@Slf4j
public class Idea31997Service {
    private static final int IDEA_ID = 31997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31997Service() {
        this(new Idea31997Config());
    }

    public Idea31997Service(Idea31997Config config) {
        this.config = config != null ? config : new Idea31997Config();
