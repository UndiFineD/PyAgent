...
@Data
public class Idea32245Config {
    private String name = "idea_032245";
 ...
 */
@Slf4j
public class Idea32245Service {
    private static final int IDEA_ID = 32245;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32245Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32245Service() {
        this(new Idea32245Config());
    }

    public Idea32245Service(Idea32245Config config) {
        this.config = config != null ? config : new Idea32245Config();
