...
@Data
public class Idea32231Config {
    private String name = "idea_032231";
 ...
 */
@Slf4j
public class Idea32231Service {
    private static final int IDEA_ID = 32231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32231Service() {
        this(new Idea32231Config());
    }

    public Idea32231Service(Idea32231Config config) {
        this.config = config != null ? config : new Idea32231Config();
