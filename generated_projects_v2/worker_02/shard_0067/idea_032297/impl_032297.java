...
@Data
public class Idea32297Config {
    private String name = "idea_032297";
 ...
 */
@Slf4j
public class Idea32297Service {
    private static final int IDEA_ID = 32297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32297Service() {
        this(new Idea32297Config());
    }

    public Idea32297Service(Idea32297Config config) {
        this.config = config != null ? config : new Idea32297Config();
