...
@Data
public class Idea32242Config {
    private String name = "idea_032242";
 ...
 */
@Slf4j
public class Idea32242Service {
    private static final int IDEA_ID = 32242;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32242Service() {
        this(new Idea32242Config());
    }

    public Idea32242Service(Idea32242Config config) {
        this.config = config != null ? config : new Idea32242Config();
