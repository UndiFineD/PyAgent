...
@Data
public class Idea31885Config {
    private String name = "idea_031885";
 ...
 */
@Slf4j
public class Idea31885Service {
    private static final int IDEA_ID = 31885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31885Service() {
        this(new Idea31885Config());
    }

    public Idea31885Service(Idea31885Config config) {
        this.config = config != null ? config : new Idea31885Config();
