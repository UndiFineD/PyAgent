...
@Data
public class Idea32211Config {
    private String name = "idea_032211";
 ...
 */
@Slf4j
public class Idea32211Service {
    private static final int IDEA_ID = 32211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32211Service() {
        this(new Idea32211Config());
    }

    public Idea32211Service(Idea32211Config config) {
        this.config = config != null ? config : new Idea32211Config();
