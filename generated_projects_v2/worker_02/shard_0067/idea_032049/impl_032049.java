...
@Data
public class Idea32049Config {
    private String name = "idea_032049";
 ...
 */
@Slf4j
public class Idea32049Service {
    private static final int IDEA_ID = 32049;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32049Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32049Service() {
        this(new Idea32049Config());
    }

    public Idea32049Service(Idea32049Config config) {
        this.config = config != null ? config : new Idea32049Config();
