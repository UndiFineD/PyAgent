...
@Data
public class Idea32106Config {
    private String name = "idea_032106";
 ...
 */
@Slf4j
public class Idea32106Service {
    private static final int IDEA_ID = 32106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32106Service() {
        this(new Idea32106Config());
    }

    public Idea32106Service(Idea32106Config config) {
        this.config = config != null ? config : new Idea32106Config();
