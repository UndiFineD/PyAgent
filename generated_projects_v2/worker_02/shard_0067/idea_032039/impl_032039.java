...
@Data
public class Idea32039Config {
    private String name = "idea_032039";
 ...
 */
@Slf4j
public class Idea32039Service {
    private static final int IDEA_ID = 32039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32039Service() {
        this(new Idea32039Config());
    }

    public Idea32039Service(Idea32039Config config) {
        this.config = config != null ? config : new Idea32039Config();
