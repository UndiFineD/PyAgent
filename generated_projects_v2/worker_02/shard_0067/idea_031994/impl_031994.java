...
@Data
public class Idea31994Config {
    private String name = "idea_031994";
 ...
 */
@Slf4j
public class Idea31994Service {
    private static final int IDEA_ID = 31994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31994Service() {
        this(new Idea31994Config());
    }

    public Idea31994Service(Idea31994Config config) {
        this.config = config != null ? config : new Idea31994Config();
