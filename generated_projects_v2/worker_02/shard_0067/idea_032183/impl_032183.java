...
@Data
public class Idea32183Config {
    private String name = "idea_032183";
 ...
 */
@Slf4j
public class Idea32183Service {
    private static final int IDEA_ID = 32183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32183Service() {
        this(new Idea32183Config());
    }

    public Idea32183Service(Idea32183Config config) {
        this.config = config != null ? config : new Idea32183Config();
