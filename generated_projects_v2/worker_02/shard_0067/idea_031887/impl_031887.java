...
@Data
public class Idea31887Config {
    private String name = "idea_031887";
 ...
 */
@Slf4j
public class Idea31887Service {
    private static final int IDEA_ID = 31887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31887Service() {
        this(new Idea31887Config());
    }

    public Idea31887Service(Idea31887Config config) {
        this.config = config != null ? config : new Idea31887Config();
