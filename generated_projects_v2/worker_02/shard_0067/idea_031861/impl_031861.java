...
@Data
public class Idea31861Config {
    private String name = "idea_031861";
 ...
 */
@Slf4j
public class Idea31861Service {
    private static final int IDEA_ID = 31861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31861Service() {
        this(new Idea31861Config());
    }

    public Idea31861Service(Idea31861Config config) {
        this.config = config != null ? config : new Idea31861Config();
