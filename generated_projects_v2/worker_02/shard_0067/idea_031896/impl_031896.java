...
@Data
public class Idea31896Config {
    private String name = "idea_031896";
 ...
 */
@Slf4j
public class Idea31896Service {
    private static final int IDEA_ID = 31896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31896Service() {
        this(new Idea31896Config());
    }

    public Idea31896Service(Idea31896Config config) {
        this.config = config != null ? config : new Idea31896Config();
