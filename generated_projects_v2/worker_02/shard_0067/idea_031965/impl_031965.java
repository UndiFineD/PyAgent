...
@Data
public class Idea31965Config {
    private String name = "idea_031965";
 ...
 */
@Slf4j
public class Idea31965Service {
    private static final int IDEA_ID = 31965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31965Service() {
        this(new Idea31965Config());
    }

    public Idea31965Service(Idea31965Config config) {
        this.config = config != null ? config : new Idea31965Config();
