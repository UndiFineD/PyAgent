...
@Data
public class Idea32246Config {
    private String name = "idea_032246";
 ...
 */
@Slf4j
public class Idea32246Service {
    private static final int IDEA_ID = 32246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32246Service() {
        this(new Idea32246Config());
    }

    public Idea32246Service(Idea32246Config config) {
        this.config = config != null ? config : new Idea32246Config();
