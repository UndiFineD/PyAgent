...
@Data
public class Idea32137Config {
    private String name = "idea_032137";
 ...
 */
@Slf4j
public class Idea32137Service {
    private static final int IDEA_ID = 32137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32137Service() {
        this(new Idea32137Config());
    }

    public Idea32137Service(Idea32137Config config) {
        this.config = config != null ? config : new Idea32137Config();
