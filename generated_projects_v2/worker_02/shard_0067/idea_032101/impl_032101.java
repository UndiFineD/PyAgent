...
@Data
public class Idea32101Config {
    private String name = "idea_032101";
 ...
 */
@Slf4j
public class Idea32101Service {
    private static final int IDEA_ID = 32101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32101Service() {
        this(new Idea32101Config());
    }

    public Idea32101Service(Idea32101Config config) {
        this.config = config != null ? config : new Idea32101Config();
