...
@Data
public class Idea31874Config {
    private String name = "idea_031874";
 ...
 */
@Slf4j
public class Idea31874Service {
    private static final int IDEA_ID = 31874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31874Service() {
        this(new Idea31874Config());
    }

    public Idea31874Service(Idea31874Config config) {
        this.config = config != null ? config : new Idea31874Config();
