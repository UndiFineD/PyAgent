...
@Data
public class Idea32299Config {
    private String name = "idea_032299";
 ...
 */
@Slf4j
public class Idea32299Service {
    private static final int IDEA_ID = 32299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32299Service() {
        this(new Idea32299Config());
    }

    public Idea32299Service(Idea32299Config config) {
        this.config = config != null ? config : new Idea32299Config();
