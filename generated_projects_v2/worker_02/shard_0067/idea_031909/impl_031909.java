...
@Data
public class Idea31909Config {
    private String name = "idea_031909";
 ...
 */
@Slf4j
public class Idea31909Service {
    private static final int IDEA_ID = 31909;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31909Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31909Service() {
        this(new Idea31909Config());
    }

    public Idea31909Service(Idea31909Config config) {
        this.config = config != null ? config : new Idea31909Config();
