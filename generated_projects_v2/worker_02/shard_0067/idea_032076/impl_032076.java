...
@Data
public class Idea32076Config {
    private String name = "idea_032076";
 ...
 */
@Slf4j
public class Idea32076Service {
    private static final int IDEA_ID = 32076;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32076Service() {
        this(new Idea32076Config());
    }

    public Idea32076Service(Idea32076Config config) {
        this.config = config != null ? config : new Idea32076Config();
