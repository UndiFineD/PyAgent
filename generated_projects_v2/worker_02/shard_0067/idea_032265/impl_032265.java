...
@Data
public class Idea32265Config {
    private String name = "idea_032265";
 ...
 */
@Slf4j
public class Idea32265Service {
    private static final int IDEA_ID = 32265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32265Service() {
        this(new Idea32265Config());
    }

    public Idea32265Service(Idea32265Config config) {
        this.config = config != null ? config : new Idea32265Config();
