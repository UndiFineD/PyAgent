...
@Data
public class Idea32043Config {
    private String name = "idea_032043";
 ...
 */
@Slf4j
public class Idea32043Service {
    private static final int IDEA_ID = 32043;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32043Service() {
        this(new Idea32043Config());
    }

    public Idea32043Service(Idea32043Config config) {
        this.config = config != null ? config : new Idea32043Config();
