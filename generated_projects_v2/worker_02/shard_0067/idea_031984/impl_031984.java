...
@Data
public class Idea31984Config {
    private String name = "idea_031984";
 ...
 */
@Slf4j
public class Idea31984Service {
    private static final int IDEA_ID = 31984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31984Service() {
        this(new Idea31984Config());
    }

    public Idea31984Service(Idea31984Config config) {
        this.config = config != null ? config : new Idea31984Config();
