...
@Data
public class Idea32047Config {
    private String name = "idea_032047";
 ...
 */
@Slf4j
public class Idea32047Service {
    private static final int IDEA_ID = 32047;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32047Service() {
        this(new Idea32047Config());
    }

    public Idea32047Service(Idea32047Config config) {
        this.config = config != null ? config : new Idea32047Config();
