...
@Data
public class Idea32025Config {
    private String name = "idea_032025";
 ...
 */
@Slf4j
public class Idea32025Service {
    private static final int IDEA_ID = 32025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32025Service() {
        this(new Idea32025Config());
    }

    public Idea32025Service(Idea32025Config config) {
        this.config = config != null ? config : new Idea32025Config();
