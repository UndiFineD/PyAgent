...
@Data
public class Idea32095Config {
    private String name = "idea_032095";
 ...
 */
@Slf4j
public class Idea32095Service {
    private static final int IDEA_ID = 32095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32095Service() {
        this(new Idea32095Config());
    }

    public Idea32095Service(Idea32095Config config) {
        this.config = config != null ? config : new Idea32095Config();
