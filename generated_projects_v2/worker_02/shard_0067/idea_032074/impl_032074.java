...
@Data
public class Idea32074Config {
    private String name = "idea_032074";
 ...
 */
@Slf4j
public class Idea32074Service {
    private static final int IDEA_ID = 32074;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32074Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32074Service() {
        this(new Idea32074Config());
    }

    public Idea32074Service(Idea32074Config config) {
        this.config = config != null ? config : new Idea32074Config();
