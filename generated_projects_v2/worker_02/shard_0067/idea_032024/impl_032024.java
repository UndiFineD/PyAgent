...
@Data
public class Idea32024Config {
    private String name = "idea_032024";
 ...
 */
@Slf4j
public class Idea32024Service {
    private static final int IDEA_ID = 32024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32024Service() {
        this(new Idea32024Config());
    }

    public Idea32024Service(Idea32024Config config) {
        this.config = config != null ? config : new Idea32024Config();
