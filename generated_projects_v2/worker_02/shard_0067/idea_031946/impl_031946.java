...
@Data
public class Idea31946Config {
    private String name = "idea_031946";
 ...
 */
@Slf4j
public class Idea31946Service {
    private static final int IDEA_ID = 31946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31946Service() {
        this(new Idea31946Config());
    }

    public Idea31946Service(Idea31946Config config) {
        this.config = config != null ? config : new Idea31946Config();
