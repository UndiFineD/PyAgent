...
@Data
public class Idea32124Config {
    private String name = "idea_032124";
 ...
 */
@Slf4j
public class Idea32124Service {
    private static final int IDEA_ID = 32124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32124Service() {
        this(new Idea32124Config());
    }

    public Idea32124Service(Idea32124Config config) {
        this.config = config != null ? config : new Idea32124Config();
