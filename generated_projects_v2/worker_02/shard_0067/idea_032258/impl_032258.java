...
@Data
public class Idea32258Config {
    private String name = "idea_032258";
 ...
 */
@Slf4j
public class Idea32258Service {
    private static final int IDEA_ID = 32258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32258Service() {
        this(new Idea32258Config());
    }

    public Idea32258Service(Idea32258Config config) {
        this.config = config != null ? config : new Idea32258Config();
