...
@Data
public class Idea31850Config {
    private String name = "idea_031850";
 ...
 */
@Slf4j
public class Idea31850Service {
    private static final int IDEA_ID = 31850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31850Service() {
        this(new Idea31850Config());
    }

    public Idea31850Service(Idea31850Config config) {
        this.config = config != null ? config : new Idea31850Config();
