...
@Data
public class Idea32230Config {
    private String name = "idea_032230";
 ...
 */
@Slf4j
public class Idea32230Service {
    private static final int IDEA_ID = 32230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32230Service() {
        this(new Idea32230Config());
    }

    public Idea32230Service(Idea32230Config config) {
        this.config = config != null ? config : new Idea32230Config();
