...
@Data
public class Idea32253Config {
    private String name = "idea_032253";
 ...
 */
@Slf4j
public class Idea32253Service {
    private static final int IDEA_ID = 32253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32253Service() {
        this(new Idea32253Config());
    }

    public Idea32253Service(Idea32253Config config) {
        this.config = config != null ? config : new Idea32253Config();
