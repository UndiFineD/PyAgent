...
@Data
public class Idea31996Config {
    private String name = "idea_031996";
 ...
 */
@Slf4j
public class Idea31996Service {
    private static final int IDEA_ID = 31996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31996Service() {
        this(new Idea31996Config());
    }

    public Idea31996Service(Idea31996Config config) {
        this.config = config != null ? config : new Idea31996Config();
