...
@Data
public class Idea32257Config {
    private String name = "idea_032257";
 ...
 */
@Slf4j
public class Idea32257Service {
    private static final int IDEA_ID = 32257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32257Service() {
        this(new Idea32257Config());
    }

    public Idea32257Service(Idea32257Config config) {
        this.config = config != null ? config : new Idea32257Config();
