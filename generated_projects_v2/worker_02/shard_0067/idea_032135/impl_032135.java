...
@Data
public class Idea32135Config {
    private String name = "idea_032135";
 ...
 */
@Slf4j
public class Idea32135Service {
    private static final int IDEA_ID = 32135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32135Service() {
        this(new Idea32135Config());
    }

    public Idea32135Service(Idea32135Config config) {
        this.config = config != null ? config : new Idea32135Config();
