...
@Data
public class Idea32241Config {
    private String name = "idea_032241";
 ...
 */
@Slf4j
public class Idea32241Service {
    private static final int IDEA_ID = 32241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32241Service() {
        this(new Idea32241Config());
    }

    public Idea32241Service(Idea32241Config config) {
        this.config = config != null ? config : new Idea32241Config();
