...
@Data
public class Idea32132Config {
    private String name = "idea_032132";
 ...
 */
@Slf4j
public class Idea32132Service {
    private static final int IDEA_ID = 32132;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32132Service() {
        this(new Idea32132Config());
    }

    public Idea32132Service(Idea32132Config config) {
        this.config = config != null ? config : new Idea32132Config();
