...
@Data
public class Idea32213Config {
    private String name = "idea_032213";
 ...
 */
@Slf4j
public class Idea32213Service {
    private static final int IDEA_ID = 32213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32213Service() {
        this(new Idea32213Config());
    }

    public Idea32213Service(Idea32213Config config) {
        this.config = config != null ? config : new Idea32213Config();
