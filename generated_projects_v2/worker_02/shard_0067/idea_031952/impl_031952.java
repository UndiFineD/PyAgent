...
@Data
public class Idea31952Config {
    private String name = "idea_031952";
 ...
 */
@Slf4j
public class Idea31952Service {
    private static final int IDEA_ID = 31952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31952Service() {
        this(new Idea31952Config());
    }

    public Idea31952Service(Idea31952Config config) {
        this.config = config != null ? config : new Idea31952Config();
