...
@Data
public class Idea32203Config {
    private String name = "idea_032203";
 ...
 */
@Slf4j
public class Idea32203Service {
    private static final int IDEA_ID = 32203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32203Service() {
        this(new Idea32203Config());
    }

    public Idea32203Service(Idea32203Config config) {
        this.config = config != null ? config : new Idea32203Config();
