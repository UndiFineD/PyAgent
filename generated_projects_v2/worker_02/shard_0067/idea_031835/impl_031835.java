...
@Data
public class Idea31835Config {
    private String name = "idea_031835";
 ...
 */
@Slf4j
public class Idea31835Service {
    private static final int IDEA_ID = 31835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31835Service() {
        this(new Idea31835Config());
    }

    public Idea31835Service(Idea31835Config config) {
        this.config = config != null ? config : new Idea31835Config();
