...
@Data
public class Idea31860Config {
    private String name = "idea_031860";
 ...
 */
@Slf4j
public class Idea31860Service {
    private static final int IDEA_ID = 31860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31860Service() {
        this(new Idea31860Config());
    }

    public Idea31860Service(Idea31860Config config) {
        this.config = config != null ? config : new Idea31860Config();
