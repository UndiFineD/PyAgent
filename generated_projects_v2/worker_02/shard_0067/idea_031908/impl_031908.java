...
@Data
public class Idea31908Config {
    private String name = "idea_031908";
 ...
 */
@Slf4j
public class Idea31908Service {
    private static final int IDEA_ID = 31908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31908Service() {
        this(new Idea31908Config());
    }

    public Idea31908Service(Idea31908Config config) {
        this.config = config != null ? config : new Idea31908Config();
