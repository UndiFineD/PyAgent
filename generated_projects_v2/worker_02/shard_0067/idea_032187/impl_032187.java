...
@Data
public class Idea32187Config {
    private String name = "idea_032187";
 ...
 */
@Slf4j
public class Idea32187Service {
    private static final int IDEA_ID = 32187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32187Service() {
        this(new Idea32187Config());
    }

    public Idea32187Service(Idea32187Config config) {
        this.config = config != null ? config : new Idea32187Config();
