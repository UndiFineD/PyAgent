...
@Data
public class Idea31973Config {
    private String name = "idea_031973";
 ...
 */
@Slf4j
public class Idea31973Service {
    private static final int IDEA_ID = 31973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31973Service() {
        this(new Idea31973Config());
    }

    public Idea31973Service(Idea31973Config config) {
        this.config = config != null ? config : new Idea31973Config();
