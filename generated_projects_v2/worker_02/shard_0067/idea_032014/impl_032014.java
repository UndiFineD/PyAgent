...
@Data
public class Idea32014Config {
    private String name = "idea_032014";
 ...
 */
@Slf4j
public class Idea32014Service {
    private static final int IDEA_ID = 32014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32014Service() {
        this(new Idea32014Config());
    }

    public Idea32014Service(Idea32014Config config) {
        this.config = config != null ? config : new Idea32014Config();
