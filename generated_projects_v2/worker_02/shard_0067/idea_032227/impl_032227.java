...
@Data
public class Idea32227Config {
    private String name = "idea_032227";
 ...
 */
@Slf4j
public class Idea32227Service {
    private static final int IDEA_ID = 32227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32227Service() {
        this(new Idea32227Config());
    }

    public Idea32227Service(Idea32227Config config) {
        this.config = config != null ? config : new Idea32227Config();
