...
@Data
public class Idea31895Config {
    private String name = "idea_031895";
 ...
 */
@Slf4j
public class Idea31895Service {
    private static final int IDEA_ID = 31895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31895Service() {
        this(new Idea31895Config());
    }

    public Idea31895Service(Idea31895Config config) {
        this.config = config != null ? config : new Idea31895Config();
