...
@Data
public class Idea32048Config {
    private String name = "idea_032048";
 ...
 */
@Slf4j
public class Idea32048Service {
    private static final int IDEA_ID = 32048;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32048Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32048Service() {
        this(new Idea32048Config());
    }

    public Idea32048Service(Idea32048Config config) {
        this.config = config != null ? config : new Idea32048Config();
