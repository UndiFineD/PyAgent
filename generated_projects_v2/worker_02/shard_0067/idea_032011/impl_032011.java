...
@Data
public class Idea32011Config {
    private String name = "idea_032011";
 ...
 */
@Slf4j
public class Idea32011Service {
    private static final int IDEA_ID = 32011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32011Service() {
        this(new Idea32011Config());
    }

    public Idea32011Service(Idea32011Config config) {
        this.config = config != null ? config : new Idea32011Config();
