...
@Data
public class Idea31832Config {
    private String name = "idea_031832";
 ...
 */
@Slf4j
public class Idea31832Service {
    private static final int IDEA_ID = 31832;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31832Service() {
        this(new Idea31832Config());
    }

    public Idea31832Service(Idea31832Config config) {
        this.config = config != null ? config : new Idea31832Config();
