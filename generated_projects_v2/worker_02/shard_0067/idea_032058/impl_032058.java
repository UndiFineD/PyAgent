...
@Data
public class Idea32058Config {
    private String name = "idea_032058";
 ...
 */
@Slf4j
public class Idea32058Service {
    private static final int IDEA_ID = 32058;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32058Service() {
        this(new Idea32058Config());
    }

    public Idea32058Service(Idea32058Config config) {
        this.config = config != null ? config : new Idea32058Config();
