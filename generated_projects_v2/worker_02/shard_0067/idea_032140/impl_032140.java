...
@Data
public class Idea32140Config {
    private String name = "idea_032140";
 ...
 */
@Slf4j
public class Idea32140Service {
    private static final int IDEA_ID = 32140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32140Service() {
        this(new Idea32140Config());
    }

    public Idea32140Service(Idea32140Config config) {
        this.config = config != null ? config : new Idea32140Config();
