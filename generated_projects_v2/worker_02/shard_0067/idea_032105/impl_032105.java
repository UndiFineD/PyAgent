...
@Data
public class Idea32105Config {
    private String name = "idea_032105";
 ...
 */
@Slf4j
public class Idea32105Service {
    private static final int IDEA_ID = 32105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32105Service() {
        this(new Idea32105Config());
    }

    public Idea32105Service(Idea32105Config config) {
        this.config = config != null ? config : new Idea32105Config();
