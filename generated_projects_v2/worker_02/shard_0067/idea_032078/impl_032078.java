...
@Data
public class Idea32078Config {
    private String name = "idea_032078";
 ...
 */
@Slf4j
public class Idea32078Service {
    private static final int IDEA_ID = 32078;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32078Service() {
        this(new Idea32078Config());
    }

    public Idea32078Service(Idea32078Config config) {
        this.config = config != null ? config : new Idea32078Config();
