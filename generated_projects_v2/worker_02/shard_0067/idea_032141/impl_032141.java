...
@Data
public class Idea32141Config {
    private String name = "idea_032141";
 ...
 */
@Slf4j
public class Idea32141Service {
    private static final int IDEA_ID = 32141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32141Service() {
        this(new Idea32141Config());
    }

    public Idea32141Service(Idea32141Config config) {
        this.config = config != null ? config : new Idea32141Config();
