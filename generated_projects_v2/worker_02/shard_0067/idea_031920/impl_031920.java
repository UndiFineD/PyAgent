...
@Data
public class Idea31920Config {
    private String name = "idea_031920";
 ...
 */
@Slf4j
public class Idea31920Service {
    private static final int IDEA_ID = 31920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea31920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea31920Service() {
        this(new Idea31920Config());
    }

    public Idea31920Service(Idea31920Config config) {
        this.config = config != null ? config : new Idea31920Config();
