...
@Data
public class Idea32082Config {
    private String name = "idea_032082";
 ...
 */
@Slf4j
public class Idea32082Service {
    private static final int IDEA_ID = 32082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32082Service() {
        this(new Idea32082Config());
    }

    public Idea32082Service(Idea32082Config config) {
        this.config = config != null ? config : new Idea32082Config();
