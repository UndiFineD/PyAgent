...
@Data
public class Idea32190Config {
    private String name = "idea_032190";
 ...
 */
@Slf4j
public class Idea32190Service {
    private static final int IDEA_ID = 32190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32190Service() {
        this(new Idea32190Config());
    }

    public Idea32190Service(Idea32190Config config) {
        this.config = config != null ? config : new Idea32190Config();
