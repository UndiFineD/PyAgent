...
@Data
public class Idea32016Config {
    private String name = "idea_032016";
 ...
 */
@Slf4j
public class Idea32016Service {
    private static final int IDEA_ID = 32016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32016Service() {
        this(new Idea32016Config());
    }

    public Idea32016Service(Idea32016Config config) {
        this.config = config != null ? config : new Idea32016Config();
