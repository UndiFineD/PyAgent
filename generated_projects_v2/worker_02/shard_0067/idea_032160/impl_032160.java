...
@Data
public class Idea32160Config {
    private String name = "idea_032160";
 ...
 */
@Slf4j
public class Idea32160Service {
    private static final int IDEA_ID = 32160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32160Service() {
        this(new Idea32160Config());
    }

    public Idea32160Service(Idea32160Config config) {
        this.config = config != null ? config : new Idea32160Config();
