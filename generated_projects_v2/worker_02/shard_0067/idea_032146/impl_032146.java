...
@Data
public class Idea32146Config {
    private String name = "idea_032146";
 ...
 */
@Slf4j
public class Idea32146Service {
    private static final int IDEA_ID = 32146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea32146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea32146Service() {
        this(new Idea32146Config());
    }

    public Idea32146Service(Idea32146Config config) {
        this.config = config != null ? config : new Idea32146Config();
