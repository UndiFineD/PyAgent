...
@Data
public class Idea44102Config {
    private String name = "idea_044102";
 ...
 */
@Slf4j
public class Idea44102Service {
    private static final int IDEA_ID = 44102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44102Service() {
        this(new Idea44102Config());
    }

    public Idea44102Service(Idea44102Config config) {
        this.config = config != null ? config : new Idea44102Config();
