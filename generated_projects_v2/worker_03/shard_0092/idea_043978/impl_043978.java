...
@Data
public class Idea43978Config {
    private String name = "idea_043978";
 ...
 */
@Slf4j
public class Idea43978Service {
    private static final int IDEA_ID = 43978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43978Service() {
        this(new Idea43978Config());
    }

    public Idea43978Service(Idea43978Config config) {
        this.config = config != null ? config : new Idea43978Config();
