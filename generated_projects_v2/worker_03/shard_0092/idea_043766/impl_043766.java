...
@Data
public class Idea43766Config {
    private String name = "idea_043766";
 ...
 */
@Slf4j
public class Idea43766Service {
    private static final int IDEA_ID = 43766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43766Service() {
        this(new Idea43766Config());
    }

    public Idea43766Service(Idea43766Config config) {
        this.config = config != null ? config : new Idea43766Config();
