...
@Data
public class Idea43856Config {
    private String name = "idea_043856";
 ...
 */
@Slf4j
public class Idea43856Service {
    private static final int IDEA_ID = 43856;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43856Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43856Service() {
        this(new Idea43856Config());
    }

    public Idea43856Service(Idea43856Config config) {
        this.config = config != null ? config : new Idea43856Config();
