...
@Data
public class Idea44040Config {
    private String name = "idea_044040";
 ...
 */
@Slf4j
public class Idea44040Service {
    private static final int IDEA_ID = 44040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44040Service() {
        this(new Idea44040Config());
    }

    public Idea44040Service(Idea44040Config config) {
        this.config = config != null ? config : new Idea44040Config();
