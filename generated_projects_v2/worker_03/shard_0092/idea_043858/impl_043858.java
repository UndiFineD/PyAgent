...
@Data
public class Idea43858Config {
    private String name = "idea_043858";
 ...
 */
@Slf4j
public class Idea43858Service {
    private static final int IDEA_ID = 43858;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43858Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43858Service() {
        this(new Idea43858Config());
    }

    public Idea43858Service(Idea43858Config config) {
        this.config = config != null ? config : new Idea43858Config();
