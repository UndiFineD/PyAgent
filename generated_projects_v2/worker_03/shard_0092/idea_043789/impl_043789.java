...
@Data
public class Idea43789Config {
    private String name = "idea_043789";
 ...
 */
@Slf4j
public class Idea43789Service {
    private static final int IDEA_ID = 43789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43789Service() {
        this(new Idea43789Config());
    }

    public Idea43789Service(Idea43789Config config) {
        this.config = config != null ? config : new Idea43789Config();
