...
@Data
public class Idea43957Config {
    private String name = "idea_043957";
 ...
 */
@Slf4j
public class Idea43957Service {
    private static final int IDEA_ID = 43957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43957Service() {
        this(new Idea43957Config());
    }

    public Idea43957Service(Idea43957Config config) {
        this.config = config != null ? config : new Idea43957Config();
