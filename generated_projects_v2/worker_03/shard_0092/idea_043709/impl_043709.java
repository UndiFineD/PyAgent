...
@Data
public class Idea43709Config {
    private String name = "idea_043709";
 ...
 */
@Slf4j
public class Idea43709Service {
    private static final int IDEA_ID = 43709;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43709Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43709Service() {
        this(new Idea43709Config());
    }

    public Idea43709Service(Idea43709Config config) {
        this.config = config != null ? config : new Idea43709Config();
