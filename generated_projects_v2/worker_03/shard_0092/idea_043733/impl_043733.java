...
@Data
public class Idea43733Config {
    private String name = "idea_043733";
 ...
 */
@Slf4j
public class Idea43733Service {
    private static final int IDEA_ID = 43733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43733Service() {
        this(new Idea43733Config());
    }

    public Idea43733Service(Idea43733Config config) {
        this.config = config != null ? config : new Idea43733Config();
