...
@Data
public class Idea44011Config {
    private String name = "idea_044011";
 ...
 */
@Slf4j
public class Idea44011Service {
    private static final int IDEA_ID = 44011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44011Service() {
        this(new Idea44011Config());
    }

    public Idea44011Service(Idea44011Config config) {
        this.config = config != null ? config : new Idea44011Config();
