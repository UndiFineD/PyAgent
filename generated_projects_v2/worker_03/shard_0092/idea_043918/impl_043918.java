...
@Data
public class Idea43918Config {
    private String name = "idea_043918";
 ...
 */
@Slf4j
public class Idea43918Service {
    private static final int IDEA_ID = 43918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43918Service() {
        this(new Idea43918Config());
    }

    public Idea43918Service(Idea43918Config config) {
        this.config = config != null ? config : new Idea43918Config();
