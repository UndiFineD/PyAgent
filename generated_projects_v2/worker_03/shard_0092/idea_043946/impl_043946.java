...
@Data
public class Idea43946Config {
    private String name = "idea_043946";
 ...
 */
@Slf4j
public class Idea43946Service {
    private static final int IDEA_ID = 43946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43946Service() {
        this(new Idea43946Config());
    }

    public Idea43946Service(Idea43946Config config) {
        this.config = config != null ? config : new Idea43946Config();
