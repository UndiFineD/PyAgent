...
@Data
public class Idea44081Config {
    private String name = "idea_044081";
 ...
 */
@Slf4j
public class Idea44081Service {
    private static final int IDEA_ID = 44081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44081Service() {
        this(new Idea44081Config());
    }

    public Idea44081Service(Idea44081Config config) {
        this.config = config != null ? config : new Idea44081Config();
