...
@Data
public class Idea43704Config {
    private String name = "idea_043704";
 ...
 */
@Slf4j
public class Idea43704Service {
    private static final int IDEA_ID = 43704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43704Service() {
        this(new Idea43704Config());
    }

    public Idea43704Service(Idea43704Config config) {
        this.config = config != null ? config : new Idea43704Config();
