...
@Data
public class Idea44090Config {
    private String name = "idea_044090";
 ...
 */
@Slf4j
public class Idea44090Service {
    private static final int IDEA_ID = 44090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44090Service() {
        this(new Idea44090Config());
    }

    public Idea44090Service(Idea44090Config config) {
        this.config = config != null ? config : new Idea44090Config();
