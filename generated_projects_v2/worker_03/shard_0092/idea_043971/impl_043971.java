...
@Data
public class Idea43971Config {
    private String name = "idea_043971";
 ...
 */
@Slf4j
public class Idea43971Service {
    private static final int IDEA_ID = 43971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43971Service() {
        this(new Idea43971Config());
    }

    public Idea43971Service(Idea43971Config config) {
        this.config = config != null ? config : new Idea43971Config();
