...
@Data
public class Idea44028Config {
    private String name = "idea_044028";
 ...
 */
@Slf4j
public class Idea44028Service {
    private static final int IDEA_ID = 44028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44028Service() {
        this(new Idea44028Config());
    }

    public Idea44028Service(Idea44028Config config) {
        this.config = config != null ? config : new Idea44028Config();
