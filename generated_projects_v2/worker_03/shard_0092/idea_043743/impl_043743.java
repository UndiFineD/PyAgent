...
@Data
public class Idea43743Config {
    private String name = "idea_043743";
 ...
 */
@Slf4j
public class Idea43743Service {
    private static final int IDEA_ID = 43743;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43743Service() {
        this(new Idea43743Config());
    }

    public Idea43743Service(Idea43743Config config) {
        this.config = config != null ? config : new Idea43743Config();
