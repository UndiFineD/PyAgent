...
@Data
public class Idea43914Config {
    private String name = "idea_043914";
 ...
 */
@Slf4j
public class Idea43914Service {
    private static final int IDEA_ID = 43914;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43914Service() {
        this(new Idea43914Config());
    }

    public Idea43914Service(Idea43914Config config) {
        this.config = config != null ? config : new Idea43914Config();
