...
@Data
public class Idea43833Config {
    private String name = "idea_043833";
 ...
 */
@Slf4j
public class Idea43833Service {
    private static final int IDEA_ID = 43833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43833Service() {
        this(new Idea43833Config());
    }

    public Idea43833Service(Idea43833Config config) {
        this.config = config != null ? config : new Idea43833Config();
