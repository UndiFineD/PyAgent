...
@Data
public class Idea43783Config {
    private String name = "idea_043783";
 ...
 */
@Slf4j
public class Idea43783Service {
    private static final int IDEA_ID = 43783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43783Service() {
        this(new Idea43783Config());
    }

    public Idea43783Service(Idea43783Config config) {
        this.config = config != null ? config : new Idea43783Config();
