...
@Data
public class Idea43870Config {
    private String name = "idea_043870";
 ...
 */
@Slf4j
public class Idea43870Service {
    private static final int IDEA_ID = 43870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43870Service() {
        this(new Idea43870Config());
    }

    public Idea43870Service(Idea43870Config config) {
        this.config = config != null ? config : new Idea43870Config();
