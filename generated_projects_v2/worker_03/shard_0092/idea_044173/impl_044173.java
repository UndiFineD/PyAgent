...
@Data
public class Idea44173Config {
    private String name = "idea_044173";
 ...
 */
@Slf4j
public class Idea44173Service {
    private static final int IDEA_ID = 44173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44173Service() {
        this(new Idea44173Config());
    }

    public Idea44173Service(Idea44173Config config) {
        this.config = config != null ? config : new Idea44173Config();
