...
@Data
public class Idea43861Config {
    private String name = "idea_043861";
 ...
 */
@Slf4j
public class Idea43861Service {
    private static final int IDEA_ID = 43861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43861Service() {
        this(new Idea43861Config());
    }

    public Idea43861Service(Idea43861Config config) {
        this.config = config != null ? config : new Idea43861Config();
