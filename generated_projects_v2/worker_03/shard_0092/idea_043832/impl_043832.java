...
@Data
public class Idea43832Config {
    private String name = "idea_043832";
 ...
 */
@Slf4j
public class Idea43832Service {
    private static final int IDEA_ID = 43832;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43832Service() {
        this(new Idea43832Config());
    }

    public Idea43832Service(Idea43832Config config) {
        this.config = config != null ? config : new Idea43832Config();
