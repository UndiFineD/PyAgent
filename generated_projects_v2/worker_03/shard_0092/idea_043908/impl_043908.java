...
@Data
public class Idea43908Config {
    private String name = "idea_043908";
 ...
 */
@Slf4j
public class Idea43908Service {
    private static final int IDEA_ID = 43908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43908Service() {
        this(new Idea43908Config());
    }

    public Idea43908Service(Idea43908Config config) {
        this.config = config != null ? config : new Idea43908Config();
