...
@Data
public class Idea44122Config {
    private String name = "idea_044122";
 ...
 */
@Slf4j
public class Idea44122Service {
    private static final int IDEA_ID = 44122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44122Service() {
        this(new Idea44122Config());
    }

    public Idea44122Service(Idea44122Config config) {
        this.config = config != null ? config : new Idea44122Config();
