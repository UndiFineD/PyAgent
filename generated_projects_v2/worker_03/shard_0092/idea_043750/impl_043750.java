...
@Data
public class Idea43750Config {
    private String name = "idea_043750";
 ...
 */
@Slf4j
public class Idea43750Service {
    private static final int IDEA_ID = 43750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43750Service() {
        this(new Idea43750Config());
    }

    public Idea43750Service(Idea43750Config config) {
        this.config = config != null ? config : new Idea43750Config();
