...
@Data
public class Idea43836Config {
    private String name = "idea_043836";
 ...
 */
@Slf4j
public class Idea43836Service {
    private static final int IDEA_ID = 43836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43836Service() {
        this(new Idea43836Config());
    }

    public Idea43836Service(Idea43836Config config) {
        this.config = config != null ? config : new Idea43836Config();
