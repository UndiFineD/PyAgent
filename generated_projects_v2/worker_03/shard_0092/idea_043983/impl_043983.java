...
@Data
public class Idea43983Config {
    private String name = "idea_043983";
 ...
 */
@Slf4j
public class Idea43983Service {
    private static final int IDEA_ID = 43983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43983Service() {
        this(new Idea43983Config());
    }

    public Idea43983Service(Idea43983Config config) {
        this.config = config != null ? config : new Idea43983Config();
