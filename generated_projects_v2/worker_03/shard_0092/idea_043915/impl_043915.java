...
@Data
public class Idea43915Config {
    private String name = "idea_043915";
 ...
 */
@Slf4j
public class Idea43915Service {
    private static final int IDEA_ID = 43915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43915Service() {
        this(new Idea43915Config());
    }

    public Idea43915Service(Idea43915Config config) {
        this.config = config != null ? config : new Idea43915Config();
