...
@Data
public class Idea43729Config {
    private String name = "idea_043729";
 ...
 */
@Slf4j
public class Idea43729Service {
    private static final int IDEA_ID = 43729;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43729Service() {
        this(new Idea43729Config());
    }

    public Idea43729Service(Idea43729Config config) {
        this.config = config != null ? config : new Idea43729Config();
