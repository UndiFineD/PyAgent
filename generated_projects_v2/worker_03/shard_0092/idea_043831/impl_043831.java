...
@Data
public class Idea43831Config {
    private String name = "idea_043831";
 ...
 */
@Slf4j
public class Idea43831Service {
    private static final int IDEA_ID = 43831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43831Service() {
        this(new Idea43831Config());
    }

    public Idea43831Service(Idea43831Config config) {
        this.config = config != null ? config : new Idea43831Config();
