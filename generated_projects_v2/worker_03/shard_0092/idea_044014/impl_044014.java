...
@Data
public class Idea44014Config {
    private String name = "idea_044014";
 ...
 */
@Slf4j
public class Idea44014Service {
    private static final int IDEA_ID = 44014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44014Service() {
        this(new Idea44014Config());
    }

    public Idea44014Service(Idea44014Config config) {
        this.config = config != null ? config : new Idea44014Config();
