...
@Data
public class Idea43762Config {
    private String name = "idea_043762";
 ...
 */
@Slf4j
public class Idea43762Service {
    private static final int IDEA_ID = 43762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43762Service() {
        this(new Idea43762Config());
    }

    public Idea43762Service(Idea43762Config config) {
        this.config = config != null ? config : new Idea43762Config();
