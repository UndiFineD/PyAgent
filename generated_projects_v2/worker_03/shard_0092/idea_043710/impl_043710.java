...
@Data
public class Idea43710Config {
    private String name = "idea_043710";
 ...
 */
@Slf4j
public class Idea43710Service {
    private static final int IDEA_ID = 43710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43710Service() {
        this(new Idea43710Config());
    }

    public Idea43710Service(Idea43710Config config) {
        this.config = config != null ? config : new Idea43710Config();
