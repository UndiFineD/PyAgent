...
@Data
public class Idea43923Config {
    private String name = "idea_043923";
 ...
 */
@Slf4j
public class Idea43923Service {
    private static final int IDEA_ID = 43923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43923Service() {
        this(new Idea43923Config());
    }

    public Idea43923Service(Idea43923Config config) {
        this.config = config != null ? config : new Idea43923Config();
