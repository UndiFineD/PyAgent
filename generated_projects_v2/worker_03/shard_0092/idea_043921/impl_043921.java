...
@Data
public class Idea43921Config {
    private String name = "idea_043921";
 ...
 */
@Slf4j
public class Idea43921Service {
    private static final int IDEA_ID = 43921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43921Service() {
        this(new Idea43921Config());
    }

    public Idea43921Service(Idea43921Config config) {
        this.config = config != null ? config : new Idea43921Config();
