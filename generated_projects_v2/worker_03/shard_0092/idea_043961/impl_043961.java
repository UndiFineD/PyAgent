...
@Data
public class Idea43961Config {
    private String name = "idea_043961";
 ...
 */
@Slf4j
public class Idea43961Service {
    private static final int IDEA_ID = 43961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43961Service() {
        this(new Idea43961Config());
    }

    public Idea43961Service(Idea43961Config config) {
        this.config = config != null ? config : new Idea43961Config();
