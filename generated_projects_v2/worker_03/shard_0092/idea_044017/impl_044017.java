...
@Data
public class Idea44017Config {
    private String name = "idea_044017";
 ...
 */
@Slf4j
public class Idea44017Service {
    private static final int IDEA_ID = 44017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44017Service() {
        this(new Idea44017Config());
    }

    public Idea44017Service(Idea44017Config config) {
        this.config = config != null ? config : new Idea44017Config();
