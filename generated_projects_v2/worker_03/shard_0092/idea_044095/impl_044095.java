...
@Data
public class Idea44095Config {
    private String name = "idea_044095";
 ...
 */
@Slf4j
public class Idea44095Service {
    private static final int IDEA_ID = 44095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44095Service() {
        this(new Idea44095Config());
    }

    public Idea44095Service(Idea44095Config config) {
        this.config = config != null ? config : new Idea44095Config();
