...
@Data
public class Idea43840Config {
    private String name = "idea_043840";
 ...
 */
@Slf4j
public class Idea43840Service {
    private static final int IDEA_ID = 43840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43840Service() {
        this(new Idea43840Config());
    }

    public Idea43840Service(Idea43840Config config) {
        this.config = config != null ? config : new Idea43840Config();
