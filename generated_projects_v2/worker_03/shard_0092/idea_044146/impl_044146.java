...
@Data
public class Idea44146Config {
    private String name = "idea_044146";
 ...
 */
@Slf4j
public class Idea44146Service {
    private static final int IDEA_ID = 44146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44146Service() {
        this(new Idea44146Config());
    }

    public Idea44146Service(Idea44146Config config) {
        this.config = config != null ? config : new Idea44146Config();
