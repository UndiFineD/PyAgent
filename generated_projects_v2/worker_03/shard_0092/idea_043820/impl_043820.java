...
@Data
public class Idea43820Config {
    private String name = "idea_043820";
 ...
 */
@Slf4j
public class Idea43820Service {
    private static final int IDEA_ID = 43820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43820Service() {
        this(new Idea43820Config());
    }

    public Idea43820Service(Idea43820Config config) {
        this.config = config != null ? config : new Idea43820Config();
