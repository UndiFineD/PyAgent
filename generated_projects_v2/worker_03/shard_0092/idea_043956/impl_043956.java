...
@Data
public class Idea43956Config {
    private String name = "idea_043956";
 ...
 */
@Slf4j
public class Idea43956Service {
    private static final int IDEA_ID = 43956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43956Service() {
        this(new Idea43956Config());
    }

    public Idea43956Service(Idea43956Config config) {
        this.config = config != null ? config : new Idea43956Config();
