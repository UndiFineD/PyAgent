...
@Data
public class Idea43937Config {
    private String name = "idea_043937";
 ...
 */
@Slf4j
public class Idea43937Service {
    private static final int IDEA_ID = 43937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43937Service() {
        this(new Idea43937Config());
    }

    public Idea43937Service(Idea43937Config config) {
        this.config = config != null ? config : new Idea43937Config();
