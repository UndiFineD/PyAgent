...
@Data
public class Idea43791Config {
    private String name = "idea_043791";
 ...
 */
@Slf4j
public class Idea43791Service {
    private static final int IDEA_ID = 43791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43791Service() {
        this(new Idea43791Config());
    }

    public Idea43791Service(Idea43791Config config) {
        this.config = config != null ? config : new Idea43791Config();
