...
@Data
public class Idea43815Config {
    private String name = "idea_043815";
 ...
 */
@Slf4j
public class Idea43815Service {
    private static final int IDEA_ID = 43815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43815Service() {
        this(new Idea43815Config());
    }

    public Idea43815Service(Idea43815Config config) {
        this.config = config != null ? config : new Idea43815Config();
