...
@Data
public class Idea43886Config {
    private String name = "idea_043886";
 ...
 */
@Slf4j
public class Idea43886Service {
    private static final int IDEA_ID = 43886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43886Service() {
        this(new Idea43886Config());
    }

    public Idea43886Service(Idea43886Config config) {
        this.config = config != null ? config : new Idea43886Config();
