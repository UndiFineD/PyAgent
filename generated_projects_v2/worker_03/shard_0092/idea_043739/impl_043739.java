...
@Data
public class Idea43739Config {
    private String name = "idea_043739";
 ...
 */
@Slf4j
public class Idea43739Service {
    private static final int IDEA_ID = 43739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43739Service() {
        this(new Idea43739Config());
    }

    public Idea43739Service(Idea43739Config config) {
        this.config = config != null ? config : new Idea43739Config();
