...
@Data
public class Idea43720Config {
    private String name = "idea_043720";
 ...
 */
@Slf4j
public class Idea43720Service {
    private static final int IDEA_ID = 43720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43720Service() {
        this(new Idea43720Config());
    }

    public Idea43720Service(Idea43720Config config) {
        this.config = config != null ? config : new Idea43720Config();
