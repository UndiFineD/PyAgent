...
@Data
public class Idea43738Config {
    private String name = "idea_043738";
 ...
 */
@Slf4j
public class Idea43738Service {
    private static final int IDEA_ID = 43738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43738Service() {
        this(new Idea43738Config());
    }

    public Idea43738Service(Idea43738Config config) {
        this.config = config != null ? config : new Idea43738Config();
