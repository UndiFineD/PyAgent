...
@Data
public class Idea44137Config {
    private String name = "idea_044137";
 ...
 */
@Slf4j
public class Idea44137Service {
    private static final int IDEA_ID = 44137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44137Service() {
        this(new Idea44137Config());
    }

    public Idea44137Service(Idea44137Config config) {
        this.config = config != null ? config : new Idea44137Config();
