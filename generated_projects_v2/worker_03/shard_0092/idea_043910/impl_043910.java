...
@Data
public class Idea43910Config {
    private String name = "idea_043910";
 ...
 */
@Slf4j
public class Idea43910Service {
    private static final int IDEA_ID = 43910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43910Service() {
        this(new Idea43910Config());
    }

    public Idea43910Service(Idea43910Config config) {
        this.config = config != null ? config : new Idea43910Config();
