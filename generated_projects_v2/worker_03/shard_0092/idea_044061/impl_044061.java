...
@Data
public class Idea44061Config {
    private String name = "idea_044061";
 ...
 */
@Slf4j
public class Idea44061Service {
    private static final int IDEA_ID = 44061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44061Service() {
        this(new Idea44061Config());
    }

    public Idea44061Service(Idea44061Config config) {
        this.config = config != null ? config : new Idea44061Config();
