...
@Data
public class Idea44107Config {
    private String name = "idea_044107";
 ...
 */
@Slf4j
public class Idea44107Service {
    private static final int IDEA_ID = 44107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44107Service() {
        this(new Idea44107Config());
    }

    public Idea44107Service(Idea44107Config config) {
        this.config = config != null ? config : new Idea44107Config();
