...
@Data
public class Idea43936Config {
    private String name = "idea_043936";
 ...
 */
@Slf4j
public class Idea43936Service {
    private static final int IDEA_ID = 43936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43936Service() {
        this(new Idea43936Config());
    }

    public Idea43936Service(Idea43936Config config) {
        this.config = config != null ? config : new Idea43936Config();
