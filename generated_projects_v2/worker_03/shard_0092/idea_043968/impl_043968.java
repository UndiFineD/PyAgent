...
@Data
public class Idea43968Config {
    private String name = "idea_043968";
 ...
 */
@Slf4j
public class Idea43968Service {
    private static final int IDEA_ID = 43968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43968Service() {
        this(new Idea43968Config());
    }

    public Idea43968Service(Idea43968Config config) {
        this.config = config != null ? config : new Idea43968Config();
