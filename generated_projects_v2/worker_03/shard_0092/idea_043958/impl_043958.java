...
@Data
public class Idea43958Config {
    private String name = "idea_043958";
 ...
 */
@Slf4j
public class Idea43958Service {
    private static final int IDEA_ID = 43958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43958Service() {
        this(new Idea43958Config());
    }

    public Idea43958Service(Idea43958Config config) {
        this.config = config != null ? config : new Idea43958Config();
