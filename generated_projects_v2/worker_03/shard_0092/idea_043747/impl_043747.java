...
@Data
public class Idea43747Config {
    private String name = "idea_043747";
 ...
 */
@Slf4j
public class Idea43747Service {
    private static final int IDEA_ID = 43747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43747Service() {
        this(new Idea43747Config());
    }

    public Idea43747Service(Idea43747Config config) {
        this.config = config != null ? config : new Idea43747Config();
