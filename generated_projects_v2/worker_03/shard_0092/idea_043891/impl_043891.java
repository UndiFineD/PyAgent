...
@Data
public class Idea43891Config {
    private String name = "idea_043891";
 ...
 */
@Slf4j
public class Idea43891Service {
    private static final int IDEA_ID = 43891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43891Service() {
        this(new Idea43891Config());
    }

    public Idea43891Service(Idea43891Config config) {
        this.config = config != null ? config : new Idea43891Config();
