...
@Data
public class Idea43852Config {
    private String name = "idea_043852";
 ...
 */
@Slf4j
public class Idea43852Service {
    private static final int IDEA_ID = 43852;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43852Service() {
        this(new Idea43852Config());
    }

    public Idea43852Service(Idea43852Config config) {
        this.config = config != null ? config : new Idea43852Config();
