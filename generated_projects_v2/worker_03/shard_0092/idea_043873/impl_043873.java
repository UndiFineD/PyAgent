...
@Data
public class Idea43873Config {
    private String name = "idea_043873";
 ...
 */
@Slf4j
public class Idea43873Service {
    private static final int IDEA_ID = 43873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43873Service() {
        this(new Idea43873Config());
    }

    public Idea43873Service(Idea43873Config config) {
        this.config = config != null ? config : new Idea43873Config();
