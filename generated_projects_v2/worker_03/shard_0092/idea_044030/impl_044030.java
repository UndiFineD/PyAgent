...
@Data
public class Idea44030Config {
    private String name = "idea_044030";
 ...
 */
@Slf4j
public class Idea44030Service {
    private static final int IDEA_ID = 44030;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44030Service() {
        this(new Idea44030Config());
    }

    public Idea44030Service(Idea44030Config config) {
        this.config = config != null ? config : new Idea44030Config();
