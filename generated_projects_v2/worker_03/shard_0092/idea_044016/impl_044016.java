...
@Data
public class Idea44016Config {
    private String name = "idea_044016";
 ...
 */
@Slf4j
public class Idea44016Service {
    private static final int IDEA_ID = 44016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44016Service() {
        this(new Idea44016Config());
    }

    public Idea44016Service(Idea44016Config config) {
        this.config = config != null ? config : new Idea44016Config();
