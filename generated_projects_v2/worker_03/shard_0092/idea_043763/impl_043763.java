...
@Data
public class Idea43763Config {
    private String name = "idea_043763";
 ...
 */
@Slf4j
public class Idea43763Service {
    private static final int IDEA_ID = 43763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43763Service() {
        this(new Idea43763Config());
    }

    public Idea43763Service(Idea43763Config config) {
        this.config = config != null ? config : new Idea43763Config();
