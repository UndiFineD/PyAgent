...
@Data
public class Idea43925Config {
    private String name = "idea_043925";
 ...
 */
@Slf4j
public class Idea43925Service {
    private static final int IDEA_ID = 43925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43925Service() {
        this(new Idea43925Config());
    }

    public Idea43925Service(Idea43925Config config) {
        this.config = config != null ? config : new Idea43925Config();
