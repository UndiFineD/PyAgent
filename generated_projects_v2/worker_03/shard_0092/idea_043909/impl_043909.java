...
@Data
public class Idea43909Config {
    private String name = "idea_043909";
 ...
 */
@Slf4j
public class Idea43909Service {
    private static final int IDEA_ID = 43909;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43909Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43909Service() {
        this(new Idea43909Config());
    }

    public Idea43909Service(Idea43909Config config) {
        this.config = config != null ? config : new Idea43909Config();
