...
@Data
public class Idea43839Config {
    private String name = "idea_043839";
 ...
 */
@Slf4j
public class Idea43839Service {
    private static final int IDEA_ID = 43839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43839Service() {
        this(new Idea43839Config());
    }

    public Idea43839Service(Idea43839Config config) {
        this.config = config != null ? config : new Idea43839Config();
