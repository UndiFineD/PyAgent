...
@Data
public class Idea44025Config {
    private String name = "idea_044025";
 ...
 */
@Slf4j
public class Idea44025Service {
    private static final int IDEA_ID = 44025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44025Service() {
        this(new Idea44025Config());
    }

    public Idea44025Service(Idea44025Config config) {
        this.config = config != null ? config : new Idea44025Config();
