...
@Data
public class Idea44084Config {
    private String name = "idea_044084";
 ...
 */
@Slf4j
public class Idea44084Service {
    private static final int IDEA_ID = 44084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44084Service() {
        this(new Idea44084Config());
    }

    public Idea44084Service(Idea44084Config config) {
        this.config = config != null ? config : new Idea44084Config();
