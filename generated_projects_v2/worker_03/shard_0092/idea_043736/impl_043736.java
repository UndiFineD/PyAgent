...
@Data
public class Idea43736Config {
    private String name = "idea_043736";
 ...
 */
@Slf4j
public class Idea43736Service {
    private static final int IDEA_ID = 43736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43736Service() {
        this(new Idea43736Config());
    }

    public Idea43736Service(Idea43736Config config) {
        this.config = config != null ? config : new Idea43736Config();
