...
@Data
public class Idea43902Config {
    private String name = "idea_043902";
 ...
 */
@Slf4j
public class Idea43902Service {
    private static final int IDEA_ID = 43902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43902Service() {
        this(new Idea43902Config());
    }

    public Idea43902Service(Idea43902Config config) {
        this.config = config != null ? config : new Idea43902Config();
