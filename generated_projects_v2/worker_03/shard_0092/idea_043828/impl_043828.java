...
@Data
public class Idea43828Config {
    private String name = "idea_043828";
 ...
 */
@Slf4j
public class Idea43828Service {
    private static final int IDEA_ID = 43828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43828Service() {
        this(new Idea43828Config());
    }

    public Idea43828Service(Idea43828Config config) {
        this.config = config != null ? config : new Idea43828Config();
