...
@Data
public class Idea43753Config {
    private String name = "idea_043753";
 ...
 */
@Slf4j
public class Idea43753Service {
    private static final int IDEA_ID = 43753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43753Service() {
        this(new Idea43753Config());
    }

    public Idea43753Service(Idea43753Config config) {
        this.config = config != null ? config : new Idea43753Config();
