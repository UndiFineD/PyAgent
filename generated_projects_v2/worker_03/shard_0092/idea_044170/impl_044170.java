...
@Data
public class Idea44170Config {
    private String name = "idea_044170";
 ...
 */
@Slf4j
public class Idea44170Service {
    private static final int IDEA_ID = 44170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44170Service() {
        this(new Idea44170Config());
    }

    public Idea44170Service(Idea44170Config config) {
        this.config = config != null ? config : new Idea44170Config();
