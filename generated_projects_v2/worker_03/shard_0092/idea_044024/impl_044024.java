...
@Data
public class Idea44024Config {
    private String name = "idea_044024";
 ...
 */
@Slf4j
public class Idea44024Service {
    private static final int IDEA_ID = 44024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44024Service() {
        this(new Idea44024Config());
    }

    public Idea44024Service(Idea44024Config config) {
        this.config = config != null ? config : new Idea44024Config();
