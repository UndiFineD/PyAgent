...
@Data
public class Idea44063Config {
    private String name = "idea_044063";
 ...
 */
@Slf4j
public class Idea44063Service {
    private static final int IDEA_ID = 44063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44063Service() {
        this(new Idea44063Config());
    }

    public Idea44063Service(Idea44063Config config) {
        this.config = config != null ? config : new Idea44063Config();
