...
@Data
public class Idea44105Config {
    private String name = "idea_044105";
 ...
 */
@Slf4j
public class Idea44105Service {
    private static final int IDEA_ID = 44105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44105Service() {
        this(new Idea44105Config());
    }

    public Idea44105Service(Idea44105Config config) {
        this.config = config != null ? config : new Idea44105Config();
