...
@Data
public class Idea43794Config {
    private String name = "idea_043794";
 ...
 */
@Slf4j
public class Idea43794Service {
    private static final int IDEA_ID = 43794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43794Service() {
        this(new Idea43794Config());
    }

    public Idea43794Service(Idea43794Config config) {
        this.config = config != null ? config : new Idea43794Config();
