...
@Data
public class Idea43982Config {
    private String name = "idea_043982";
 ...
 */
@Slf4j
public class Idea43982Service {
    private static final int IDEA_ID = 43982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43982Service() {
        this(new Idea43982Config());
    }

    public Idea43982Service(Idea43982Config config) {
        this.config = config != null ? config : new Idea43982Config();
