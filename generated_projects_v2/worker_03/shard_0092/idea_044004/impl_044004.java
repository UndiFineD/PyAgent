...
@Data
public class Idea44004Config {
    private String name = "idea_044004";
 ...
 */
@Slf4j
public class Idea44004Service {
    private static final int IDEA_ID = 44004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44004Service() {
        this(new Idea44004Config());
    }

    public Idea44004Service(Idea44004Config config) {
        this.config = config != null ? config : new Idea44004Config();
