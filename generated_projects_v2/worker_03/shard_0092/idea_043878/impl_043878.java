...
@Data
public class Idea43878Config {
    private String name = "idea_043878";
 ...
 */
@Slf4j
public class Idea43878Service {
    private static final int IDEA_ID = 43878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43878Service() {
        this(new Idea43878Config());
    }

    public Idea43878Service(Idea43878Config config) {
        this.config = config != null ? config : new Idea43878Config();
