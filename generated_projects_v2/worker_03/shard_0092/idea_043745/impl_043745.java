...
@Data
public class Idea43745Config {
    private String name = "idea_043745";
 ...
 */
@Slf4j
public class Idea43745Service {
    private static final int IDEA_ID = 43745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43745Service() {
        this(new Idea43745Config());
    }

    public Idea43745Service(Idea43745Config config) {
        this.config = config != null ? config : new Idea43745Config();
