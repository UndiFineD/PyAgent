...
@Data
public class Idea44168Config {
    private String name = "idea_044168";
 ...
 */
@Slf4j
public class Idea44168Service {
    private static final int IDEA_ID = 44168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44168Service() {
        this(new Idea44168Config());
    }

    public Idea44168Service(Idea44168Config config) {
        this.config = config != null ? config : new Idea44168Config();
