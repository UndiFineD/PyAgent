...
@Data
public class Idea43767Config {
    private String name = "idea_043767";
 ...
 */
@Slf4j
public class Idea43767Service {
    private static final int IDEA_ID = 43767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43767Service() {
        this(new Idea43767Config());
    }

    public Idea43767Service(Idea43767Config config) {
        this.config = config != null ? config : new Idea43767Config();
