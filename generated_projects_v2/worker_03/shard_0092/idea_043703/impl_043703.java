...
@Data
public class Idea43703Config {
    private String name = "idea_043703";
 ...
 */
@Slf4j
public class Idea43703Service {
    private static final int IDEA_ID = 43703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43703Service() {
        this(new Idea43703Config());
    }

    public Idea43703Service(Idea43703Config config) {
        this.config = config != null ? config : new Idea43703Config();
