...
@Data
public class Idea43917Config {
    private String name = "idea_043917";
 ...
 */
@Slf4j
public class Idea43917Service {
    private static final int IDEA_ID = 43917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43917Service() {
        this(new Idea43917Config());
    }

    public Idea43917Service(Idea43917Config config) {
        this.config = config != null ? config : new Idea43917Config();
