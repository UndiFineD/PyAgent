...
@Data
public class Idea43822Config {
    private String name = "idea_043822";
 ...
 */
@Slf4j
public class Idea43822Service {
    private static final int IDEA_ID = 43822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43822Service() {
        this(new Idea43822Config());
    }

    public Idea43822Service(Idea43822Config config) {
        this.config = config != null ? config : new Idea43822Config();
