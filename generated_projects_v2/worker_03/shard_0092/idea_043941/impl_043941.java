...
@Data
public class Idea43941Config {
    private String name = "idea_043941";
 ...
 */
@Slf4j
public class Idea43941Service {
    private static final int IDEA_ID = 43941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43941Service() {
        this(new Idea43941Config());
    }

    public Idea43941Service(Idea43941Config config) {
        this.config = config != null ? config : new Idea43941Config();
