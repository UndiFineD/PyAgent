...
@Data
public class Idea43827Config {
    private String name = "idea_043827";
 ...
 */
@Slf4j
public class Idea43827Service {
    private static final int IDEA_ID = 43827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43827Service() {
        this(new Idea43827Config());
    }

    public Idea43827Service(Idea43827Config config) {
        this.config = config != null ? config : new Idea43827Config();
