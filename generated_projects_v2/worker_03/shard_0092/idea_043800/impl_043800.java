...
@Data
public class Idea43800Config {
    private String name = "idea_043800";
 ...
 */
@Slf4j
public class Idea43800Service {
    private static final int IDEA_ID = 43800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43800Service() {
        this(new Idea43800Config());
    }

    public Idea43800Service(Idea43800Config config) {
        this.config = config != null ? config : new Idea43800Config();
