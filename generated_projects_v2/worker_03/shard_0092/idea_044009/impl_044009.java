...
@Data
public class Idea44009Config {
    private String name = "idea_044009";
 ...
 */
@Slf4j
public class Idea44009Service {
    private static final int IDEA_ID = 44009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44009Service() {
        this(new Idea44009Config());
    }

    public Idea44009Service(Idea44009Config config) {
        this.config = config != null ? config : new Idea44009Config();
