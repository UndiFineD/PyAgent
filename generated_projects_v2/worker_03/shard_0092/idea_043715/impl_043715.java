...
@Data
public class Idea43715Config {
    private String name = "idea_043715";
 ...
 */
@Slf4j
public class Idea43715Service {
    private static final int IDEA_ID = 43715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43715Service() {
        this(new Idea43715Config());
    }

    public Idea43715Service(Idea43715Config config) {
        this.config = config != null ? config : new Idea43715Config();
