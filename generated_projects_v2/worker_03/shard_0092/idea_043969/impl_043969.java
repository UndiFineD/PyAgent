...
@Data
public class Idea43969Config {
    private String name = "idea_043969";
 ...
 */
@Slf4j
public class Idea43969Service {
    private static final int IDEA_ID = 43969;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43969Service() {
        this(new Idea43969Config());
    }

    public Idea43969Service(Idea43969Config config) {
        this.config = config != null ? config : new Idea43969Config();
