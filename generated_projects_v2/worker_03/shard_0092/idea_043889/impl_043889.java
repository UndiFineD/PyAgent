...
@Data
public class Idea43889Config {
    private String name = "idea_043889";
 ...
 */
@Slf4j
public class Idea43889Service {
    private static final int IDEA_ID = 43889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43889Service() {
        this(new Idea43889Config());
    }

    public Idea43889Service(Idea43889Config config) {
        this.config = config != null ? config : new Idea43889Config();
