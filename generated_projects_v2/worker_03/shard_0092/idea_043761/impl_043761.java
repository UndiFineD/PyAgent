...
@Data
public class Idea43761Config {
    private String name = "idea_043761";
 ...
 */
@Slf4j
public class Idea43761Service {
    private static final int IDEA_ID = 43761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43761Service() {
        this(new Idea43761Config());
    }

    public Idea43761Service(Idea43761Config config) {
        this.config = config != null ? config : new Idea43761Config();
