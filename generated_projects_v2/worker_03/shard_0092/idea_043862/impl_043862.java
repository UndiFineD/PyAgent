...
@Data
public class Idea43862Config {
    private String name = "idea_043862";
 ...
 */
@Slf4j
public class Idea43862Service {
    private static final int IDEA_ID = 43862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43862Service() {
        this(new Idea43862Config());
    }

    public Idea43862Service(Idea43862Config config) {
        this.config = config != null ? config : new Idea43862Config();
