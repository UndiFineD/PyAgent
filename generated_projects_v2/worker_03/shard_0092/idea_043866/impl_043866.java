...
@Data
public class Idea43866Config {
    private String name = "idea_043866";
 ...
 */
@Slf4j
public class Idea43866Service {
    private static final int IDEA_ID = 43866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43866Service() {
        this(new Idea43866Config());
    }

    public Idea43866Service(Idea43866Config config) {
        this.config = config != null ? config : new Idea43866Config();
