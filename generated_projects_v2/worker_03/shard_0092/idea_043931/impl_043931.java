...
@Data
public class Idea43931Config {
    private String name = "idea_043931";
 ...
 */
@Slf4j
public class Idea43931Service {
    private static final int IDEA_ID = 43931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43931Service() {
        this(new Idea43931Config());
    }

    public Idea43931Service(Idea43931Config config) {
        this.config = config != null ? config : new Idea43931Config();
