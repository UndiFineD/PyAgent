...
@Data
public class Idea43713Config {
    private String name = "idea_043713";
 ...
 */
@Slf4j
public class Idea43713Service {
    private static final int IDEA_ID = 43713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43713Service() {
        this(new Idea43713Config());
    }

    public Idea43713Service(Idea43713Config config) {
        this.config = config != null ? config : new Idea43713Config();
