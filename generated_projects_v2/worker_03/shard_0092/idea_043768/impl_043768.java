...
@Data
public class Idea43768Config {
    private String name = "idea_043768";
 ...
 */
@Slf4j
public class Idea43768Service {
    private static final int IDEA_ID = 43768;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43768Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43768Service() {
        this(new Idea43768Config());
    }

    public Idea43768Service(Idea43768Config config) {
        this.config = config != null ? config : new Idea43768Config();
