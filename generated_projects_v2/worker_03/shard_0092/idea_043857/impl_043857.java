...
@Data
public class Idea43857Config {
    private String name = "idea_043857";
 ...
 */
@Slf4j
public class Idea43857Service {
    private static final int IDEA_ID = 43857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43857Service() {
        this(new Idea43857Config());
    }

    public Idea43857Service(Idea43857Config config) {
        this.config = config != null ? config : new Idea43857Config();
