...
@Data
public class Idea43837Config {
    private String name = "idea_043837";
 ...
 */
@Slf4j
public class Idea43837Service {
    private static final int IDEA_ID = 43837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43837Service() {
        this(new Idea43837Config());
    }

    public Idea43837Service(Idea43837Config config) {
        this.config = config != null ? config : new Idea43837Config();
