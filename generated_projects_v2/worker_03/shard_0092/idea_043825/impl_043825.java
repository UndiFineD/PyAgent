...
@Data
public class Idea43825Config {
    private String name = "idea_043825";
 ...
 */
@Slf4j
public class Idea43825Service {
    private static final int IDEA_ID = 43825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43825Service() {
        this(new Idea43825Config());
    }

    public Idea43825Service(Idea43825Config config) {
        this.config = config != null ? config : new Idea43825Config();
