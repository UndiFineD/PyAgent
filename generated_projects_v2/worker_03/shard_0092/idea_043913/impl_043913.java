...
@Data
public class Idea43913Config {
    private String name = "idea_043913";
 ...
 */
@Slf4j
public class Idea43913Service {
    private static final int IDEA_ID = 43913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43913Service() {
        this(new Idea43913Config());
    }

    public Idea43913Service(Idea43913Config config) {
        this.config = config != null ? config : new Idea43913Config();
