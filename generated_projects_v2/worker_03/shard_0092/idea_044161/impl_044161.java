...
@Data
public class Idea44161Config {
    private String name = "idea_044161";
 ...
 */
@Slf4j
public class Idea44161Service {
    private static final int IDEA_ID = 44161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44161Service() {
        this(new Idea44161Config());
    }

    public Idea44161Service(Idea44161Config config) {
        this.config = config != null ? config : new Idea44161Config();
