...
@Data
public class Idea43989Config {
    private String name = "idea_043989";
 ...
 */
@Slf4j
public class Idea43989Service {
    private static final int IDEA_ID = 43989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43989Service() {
        this(new Idea43989Config());
    }

    public Idea43989Service(Idea43989Config config) {
        this.config = config != null ? config : new Idea43989Config();
