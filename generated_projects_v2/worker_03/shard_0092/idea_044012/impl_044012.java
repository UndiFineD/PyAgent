...
@Data
public class Idea44012Config {
    private String name = "idea_044012";
 ...
 */
@Slf4j
public class Idea44012Service {
    private static final int IDEA_ID = 44012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44012Service() {
        this(new Idea44012Config());
    }

    public Idea44012Service(Idea44012Config config) {
        this.config = config != null ? config : new Idea44012Config();
