...
@Data
public class Idea44006Config {
    private String name = "idea_044006";
 ...
 */
@Slf4j
public class Idea44006Service {
    private static final int IDEA_ID = 44006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44006Service() {
        this(new Idea44006Config());
    }

    public Idea44006Service(Idea44006Config config) {
        this.config = config != null ? config : new Idea44006Config();
