...
@Data
public class Idea43955Config {
    private String name = "idea_043955";
 ...
 */
@Slf4j
public class Idea43955Service {
    private static final int IDEA_ID = 43955;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43955Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43955Service() {
        this(new Idea43955Config());
    }

    public Idea43955Service(Idea43955Config config) {
        this.config = config != null ? config : new Idea43955Config();
