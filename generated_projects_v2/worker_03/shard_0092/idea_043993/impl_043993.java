...
@Data
public class Idea43993Config {
    private String name = "idea_043993";
 ...
 */
@Slf4j
public class Idea43993Service {
    private static final int IDEA_ID = 43993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43993Service() {
        this(new Idea43993Config());
    }

    public Idea43993Service(Idea43993Config config) {
        this.config = config != null ? config : new Idea43993Config();
