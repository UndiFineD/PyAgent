...
@Data
public class Idea44044Config {
    private String name = "idea_044044";
 ...
 */
@Slf4j
public class Idea44044Service {
    private static final int IDEA_ID = 44044;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44044Service() {
        this(new Idea44044Config());
    }

    public Idea44044Service(Idea44044Config config) {
        this.config = config != null ? config : new Idea44044Config();
