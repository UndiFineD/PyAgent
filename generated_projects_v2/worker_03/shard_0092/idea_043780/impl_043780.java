...
@Data
public class Idea43780Config {
    private String name = "idea_043780";
 ...
 */
@Slf4j
public class Idea43780Service {
    private static final int IDEA_ID = 43780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43780Service() {
        this(new Idea43780Config());
    }

    public Idea43780Service(Idea43780Config config) {
        this.config = config != null ? config : new Idea43780Config();
