...
@Data
public class Idea43752Config {
    private String name = "idea_043752";
 ...
 */
@Slf4j
public class Idea43752Service {
    private static final int IDEA_ID = 43752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43752Service() {
        this(new Idea43752Config());
    }

    public Idea43752Service(Idea43752Config config) {
        this.config = config != null ? config : new Idea43752Config();
