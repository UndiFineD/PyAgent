...
@Data
public class Idea43755Config {
    private String name = "idea_043755";
 ...
 */
@Slf4j
public class Idea43755Service {
    private static final int IDEA_ID = 43755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43755Service() {
        this(new Idea43755Config());
    }

    public Idea43755Service(Idea43755Config config) {
        this.config = config != null ? config : new Idea43755Config();
