...
@Data
public class Idea44160Config {
    private String name = "idea_044160";
 ...
 */
@Slf4j
public class Idea44160Service {
    private static final int IDEA_ID = 44160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44160Service() {
        this(new Idea44160Config());
    }

    public Idea44160Service(Idea44160Config config) {
        this.config = config != null ? config : new Idea44160Config();
