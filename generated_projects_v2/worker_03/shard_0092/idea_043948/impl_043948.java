...
@Data
public class Idea43948Config {
    private String name = "idea_043948";
 ...
 */
@Slf4j
public class Idea43948Service {
    private static final int IDEA_ID = 43948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43948Service() {
        this(new Idea43948Config());
    }

    public Idea43948Service(Idea43948Config config) {
        this.config = config != null ? config : new Idea43948Config();
