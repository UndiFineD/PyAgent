...
@Data
public class Idea43740Config {
    private String name = "idea_043740";
 ...
 */
@Slf4j
public class Idea43740Service {
    private static final int IDEA_ID = 43740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43740Service() {
        this(new Idea43740Config());
    }

    public Idea43740Service(Idea43740Config config) {
        this.config = config != null ? config : new Idea43740Config();
