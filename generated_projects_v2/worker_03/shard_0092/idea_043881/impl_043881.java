...
@Data
public class Idea43881Config {
    private String name = "idea_043881";
 ...
 */
@Slf4j
public class Idea43881Service {
    private static final int IDEA_ID = 43881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43881Service() {
        this(new Idea43881Config());
    }

    public Idea43881Service(Idea43881Config config) {
        this.config = config != null ? config : new Idea43881Config();
