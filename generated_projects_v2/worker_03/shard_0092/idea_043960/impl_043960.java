...
@Data
public class Idea43960Config {
    private String name = "idea_043960";
 ...
 */
@Slf4j
public class Idea43960Service {
    private static final int IDEA_ID = 43960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43960Service() {
        this(new Idea43960Config());
    }

    public Idea43960Service(Idea43960Config config) {
        this.config = config != null ? config : new Idea43960Config();
