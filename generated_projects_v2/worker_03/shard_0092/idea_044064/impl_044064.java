...
@Data
public class Idea44064Config {
    private String name = "idea_044064";
 ...
 */
@Slf4j
public class Idea44064Service {
    private static final int IDEA_ID = 44064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44064Service() {
        this(new Idea44064Config());
    }

    public Idea44064Service(Idea44064Config config) {
        this.config = config != null ? config : new Idea44064Config();
