...
@Data
public class Idea44103Config {
    private String name = "idea_044103";
 ...
 */
@Slf4j
public class Idea44103Service {
    private static final int IDEA_ID = 44103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44103Service() {
        this(new Idea44103Config());
    }

    public Idea44103Service(Idea44103Config config) {
        this.config = config != null ? config : new Idea44103Config();
