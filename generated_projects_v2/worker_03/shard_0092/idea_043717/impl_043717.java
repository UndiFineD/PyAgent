...
@Data
public class Idea43717Config {
    private String name = "idea_043717";
 ...
 */
@Slf4j
public class Idea43717Service {
    private static final int IDEA_ID = 43717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43717Service() {
        this(new Idea43717Config());
    }

    public Idea43717Service(Idea43717Config config) {
        this.config = config != null ? config : new Idea43717Config();
