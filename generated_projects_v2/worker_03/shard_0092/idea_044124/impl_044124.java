...
@Data
public class Idea44124Config {
    private String name = "idea_044124";
 ...
 */
@Slf4j
public class Idea44124Service {
    private static final int IDEA_ID = 44124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44124Service() {
        this(new Idea44124Config());
    }

    public Idea44124Service(Idea44124Config config) {
        this.config = config != null ? config : new Idea44124Config();
