...
@Data
public class Idea43846Config {
    private String name = "idea_043846";
 ...
 */
@Slf4j
public class Idea43846Service {
    private static final int IDEA_ID = 43846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43846Service() {
        this(new Idea43846Config());
    }

    public Idea43846Service(Idea43846Config config) {
        this.config = config != null ? config : new Idea43846Config();
