...
@Data
public class Idea44007Config {
    private String name = "idea_044007";
 ...
 */
@Slf4j
public class Idea44007Service {
    private static final int IDEA_ID = 44007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44007Service() {
        this(new Idea44007Config());
    }

    public Idea44007Service(Idea44007Config config) {
        this.config = config != null ? config : new Idea44007Config();
