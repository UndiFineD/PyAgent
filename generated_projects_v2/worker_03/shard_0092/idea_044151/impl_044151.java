...
@Data
public class Idea44151Config {
    private String name = "idea_044151";
 ...
 */
@Slf4j
public class Idea44151Service {
    private static final int IDEA_ID = 44151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44151Service() {
        this(new Idea44151Config());
    }

    public Idea44151Service(Idea44151Config config) {
        this.config = config != null ? config : new Idea44151Config();
