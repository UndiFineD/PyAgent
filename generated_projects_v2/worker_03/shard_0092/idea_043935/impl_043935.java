...
@Data
public class Idea43935Config {
    private String name = "idea_043935";
 ...
 */
@Slf4j
public class Idea43935Service {
    private static final int IDEA_ID = 43935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43935Service() {
        this(new Idea43935Config());
    }

    public Idea43935Service(Idea43935Config config) {
        this.config = config != null ? config : new Idea43935Config();
