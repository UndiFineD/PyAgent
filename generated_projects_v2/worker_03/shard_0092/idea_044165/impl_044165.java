...
@Data
public class Idea44165Config {
    private String name = "idea_044165";
 ...
 */
@Slf4j
public class Idea44165Service {
    private static final int IDEA_ID = 44165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44165Service() {
        this(new Idea44165Config());
    }

    public Idea44165Service(Idea44165Config config) {
        this.config = config != null ? config : new Idea44165Config();
