...
@Data
public class Idea43705Config {
    private String name = "idea_043705";
 ...
 */
@Slf4j
public class Idea43705Service {
    private static final int IDEA_ID = 43705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43705Service() {
        this(new Idea43705Config());
    }

    public Idea43705Service(Idea43705Config config) {
        this.config = config != null ? config : new Idea43705Config();
