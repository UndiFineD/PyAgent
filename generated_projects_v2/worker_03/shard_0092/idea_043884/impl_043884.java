...
@Data
public class Idea43884Config {
    private String name = "idea_043884";
 ...
 */
@Slf4j
public class Idea43884Service {
    private static final int IDEA_ID = 43884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43884Service() {
        this(new Idea43884Config());
    }

    public Idea43884Service(Idea43884Config config) {
        this.config = config != null ? config : new Idea43884Config();
