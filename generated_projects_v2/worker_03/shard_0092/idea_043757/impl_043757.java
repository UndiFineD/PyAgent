...
@Data
public class Idea43757Config {
    private String name = "idea_043757";
 ...
 */
@Slf4j
public class Idea43757Service {
    private static final int IDEA_ID = 43757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43757Service() {
        this(new Idea43757Config());
    }

    public Idea43757Service(Idea43757Config config) {
        this.config = config != null ? config : new Idea43757Config();
