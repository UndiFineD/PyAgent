...
@Data
public class Idea43912Config {
    private String name = "idea_043912";
 ...
 */
@Slf4j
public class Idea43912Service {
    private static final int IDEA_ID = 43912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43912Service() {
        this(new Idea43912Config());
    }

    public Idea43912Service(Idea43912Config config) {
        this.config = config != null ? config : new Idea43912Config();
