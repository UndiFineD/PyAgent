...
@Data
public class Idea43901Config {
    private String name = "idea_043901";
 ...
 */
@Slf4j
public class Idea43901Service {
    private static final int IDEA_ID = 43901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43901Service() {
        this(new Idea43901Config());
    }

    public Idea43901Service(Idea43901Config config) {
        this.config = config != null ? config : new Idea43901Config();
