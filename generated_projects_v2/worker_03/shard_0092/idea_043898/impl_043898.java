...
@Data
public class Idea43898Config {
    private String name = "idea_043898";
 ...
 */
@Slf4j
public class Idea43898Service {
    private static final int IDEA_ID = 43898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43898Service() {
        this(new Idea43898Config());
    }

    public Idea43898Service(Idea43898Config config) {
        this.config = config != null ? config : new Idea43898Config();
