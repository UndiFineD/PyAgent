...
@Data
public class Idea44000Config {
    private String name = "idea_044000";
 ...
 */
@Slf4j
public class Idea44000Service {
    private static final int IDEA_ID = 44000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44000Service() {
        this(new Idea44000Config());
    }

    public Idea44000Service(Idea44000Config config) {
        this.config = config != null ? config : new Idea44000Config();
