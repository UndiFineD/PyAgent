...
@Data
public class Idea43880Config {
    private String name = "idea_043880";
 ...
 */
@Slf4j
public class Idea43880Service {
    private static final int IDEA_ID = 43880;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43880Service() {
        this(new Idea43880Config());
    }

    public Idea43880Service(Idea43880Config config) {
        this.config = config != null ? config : new Idea43880Config();
