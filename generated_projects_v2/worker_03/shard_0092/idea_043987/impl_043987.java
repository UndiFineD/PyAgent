...
@Data
public class Idea43987Config {
    private String name = "idea_043987";
 ...
 */
@Slf4j
public class Idea43987Service {
    private static final int IDEA_ID = 43987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43987Service() {
        this(new Idea43987Config());
    }

    public Idea43987Service(Idea43987Config config) {
        this.config = config != null ? config : new Idea43987Config();
