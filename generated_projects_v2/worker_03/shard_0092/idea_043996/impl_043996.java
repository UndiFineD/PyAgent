...
@Data
public class Idea43996Config {
    private String name = "idea_043996";
 ...
 */
@Slf4j
public class Idea43996Service {
    private static final int IDEA_ID = 43996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43996Service() {
        this(new Idea43996Config());
    }

    public Idea43996Service(Idea43996Config config) {
        this.config = config != null ? config : new Idea43996Config();
