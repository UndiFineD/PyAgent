...
@Data
public class Idea43906Config {
    private String name = "idea_043906";
 ...
 */
@Slf4j
public class Idea43906Service {
    private static final int IDEA_ID = 43906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43906Service() {
        this(new Idea43906Config());
    }

    public Idea43906Service(Idea43906Config config) {
        this.config = config != null ? config : new Idea43906Config();
