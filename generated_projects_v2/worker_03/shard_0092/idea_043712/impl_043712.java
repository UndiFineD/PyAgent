...
@Data
public class Idea43712Config {
    private String name = "idea_043712";
 ...
 */
@Slf4j
public class Idea43712Service {
    private static final int IDEA_ID = 43712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43712Service() {
        this(new Idea43712Config());
    }

    public Idea43712Service(Idea43712Config config) {
        this.config = config != null ? config : new Idea43712Config();
