...
@Data
public class Idea43964Config {
    private String name = "idea_043964";
 ...
 */
@Slf4j
public class Idea43964Service {
    private static final int IDEA_ID = 43964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43964Service() {
        this(new Idea43964Config());
    }

    public Idea43964Service(Idea43964Config config) {
        this.config = config != null ? config : new Idea43964Config();
