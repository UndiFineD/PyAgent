...
@Data
public class Idea43802Config {
    private String name = "idea_043802";
 ...
 */
@Slf4j
public class Idea43802Service {
    private static final int IDEA_ID = 43802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43802Service() {
        this(new Idea43802Config());
    }

    public Idea43802Service(Idea43802Config config) {
        this.config = config != null ? config : new Idea43802Config();
