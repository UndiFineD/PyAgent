...
@Data
public class Idea43974Config {
    private String name = "idea_043974";
 ...
 */
@Slf4j
public class Idea43974Service {
    private static final int IDEA_ID = 43974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43974Service() {
        this(new Idea43974Config());
    }

    public Idea43974Service(Idea43974Config config) {
        this.config = config != null ? config : new Idea43974Config();
