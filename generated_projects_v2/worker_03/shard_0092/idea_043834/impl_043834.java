...
@Data
public class Idea43834Config {
    private String name = "idea_043834";
 ...
 */
@Slf4j
public class Idea43834Service {
    private static final int IDEA_ID = 43834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43834Service() {
        this(new Idea43834Config());
    }

    public Idea43834Service(Idea43834Config config) {
        this.config = config != null ? config : new Idea43834Config();
