...
@Data
public class Idea44075Config {
    private String name = "idea_044075";
 ...
 */
@Slf4j
public class Idea44075Service {
    private static final int IDEA_ID = 44075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44075Service() {
        this(new Idea44075Config());
    }

    public Idea44075Service(Idea44075Config config) {
        this.config = config != null ? config : new Idea44075Config();
