...
@Data
public class Idea43843Config {
    private String name = "idea_043843";
 ...
 */
@Slf4j
public class Idea43843Service {
    private static final int IDEA_ID = 43843;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43843Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43843Service() {
        this(new Idea43843Config());
    }

    public Idea43843Service(Idea43843Config config) {
        this.config = config != null ? config : new Idea43843Config();
