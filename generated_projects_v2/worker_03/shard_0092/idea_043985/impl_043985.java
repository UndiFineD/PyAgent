...
@Data
public class Idea43985Config {
    private String name = "idea_043985";
 ...
 */
@Slf4j
public class Idea43985Service {
    private static final int IDEA_ID = 43985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43985Service() {
        this(new Idea43985Config());
    }

    public Idea43985Service(Idea43985Config config) {
        this.config = config != null ? config : new Idea43985Config();
