...
@Data
public class Idea43945Config {
    private String name = "idea_043945";
 ...
 */
@Slf4j
public class Idea43945Service {
    private static final int IDEA_ID = 43945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43945Service() {
        this(new Idea43945Config());
    }

    public Idea43945Service(Idea43945Config config) {
        this.config = config != null ? config : new Idea43945Config();
