...
@Data
public class Idea44121Config {
    private String name = "idea_044121";
 ...
 */
@Slf4j
public class Idea44121Service {
    private static final int IDEA_ID = 44121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44121Service() {
        this(new Idea44121Config());
    }

    public Idea44121Service(Idea44121Config config) {
        this.config = config != null ? config : new Idea44121Config();
