...
@Data
public class Idea43875Config {
    private String name = "idea_043875";
 ...
 */
@Slf4j
public class Idea43875Service {
    private static final int IDEA_ID = 43875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43875Service() {
        this(new Idea43875Config());
    }

    public Idea43875Service(Idea43875Config config) {
        this.config = config != null ? config : new Idea43875Config();
