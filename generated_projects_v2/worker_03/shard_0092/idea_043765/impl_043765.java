...
@Data
public class Idea43765Config {
    private String name = "idea_043765";
 ...
 */
@Slf4j
public class Idea43765Service {
    private static final int IDEA_ID = 43765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43765Service() {
        this(new Idea43765Config());
    }

    public Idea43765Service(Idea43765Config config) {
        this.config = config != null ? config : new Idea43765Config();
