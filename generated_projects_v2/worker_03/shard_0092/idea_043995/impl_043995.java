...
@Data
public class Idea43995Config {
    private String name = "idea_043995";
 ...
 */
@Slf4j
public class Idea43995Service {
    private static final int IDEA_ID = 43995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43995Service() {
        this(new Idea43995Config());
    }

    public Idea43995Service(Idea43995Config config) {
        this.config = config != null ? config : new Idea43995Config();
