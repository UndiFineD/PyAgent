...
@Data
public class Idea43844Config {
    private String name = "idea_043844";
 ...
 */
@Slf4j
public class Idea43844Service {
    private static final int IDEA_ID = 43844;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43844Service() {
        this(new Idea43844Config());
    }

    public Idea43844Service(Idea43844Config config) {
        this.config = config != null ? config : new Idea43844Config();
