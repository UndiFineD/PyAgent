...
@Data
public class Idea43805Config {
    private String name = "idea_043805";
 ...
 */
@Slf4j
public class Idea43805Service {
    private static final int IDEA_ID = 43805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43805Service() {
        this(new Idea43805Config());
    }

    public Idea43805Service(Idea43805Config config) {
        this.config = config != null ? config : new Idea43805Config();
