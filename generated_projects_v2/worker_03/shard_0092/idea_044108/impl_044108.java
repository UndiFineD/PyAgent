...
@Data
public class Idea44108Config {
    private String name = "idea_044108";
 ...
 */
@Slf4j
public class Idea44108Service {
    private static final int IDEA_ID = 44108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44108Service() {
        this(new Idea44108Config());
    }

    public Idea44108Service(Idea44108Config config) {
        this.config = config != null ? config : new Idea44108Config();
