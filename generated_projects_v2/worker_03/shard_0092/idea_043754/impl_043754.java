...
@Data
public class Idea43754Config {
    private String name = "idea_043754";
 ...
 */
@Slf4j
public class Idea43754Service {
    private static final int IDEA_ID = 43754;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43754Service() {
        this(new Idea43754Config());
    }

    public Idea43754Service(Idea43754Config config) {
        this.config = config != null ? config : new Idea43754Config();
