...
@Data
public class Idea44005Config {
    private String name = "idea_044005";
 ...
 */
@Slf4j
public class Idea44005Service {
    private static final int IDEA_ID = 44005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44005Service() {
        this(new Idea44005Config());
    }

    public Idea44005Service(Idea44005Config config) {
        this.config = config != null ? config : new Idea44005Config();
