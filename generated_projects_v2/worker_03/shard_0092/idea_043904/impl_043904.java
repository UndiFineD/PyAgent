...
@Data
public class Idea43904Config {
    private String name = "idea_043904";
 ...
 */
@Slf4j
public class Idea43904Service {
    private static final int IDEA_ID = 43904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43904Service() {
        this(new Idea43904Config());
    }

    public Idea43904Service(Idea43904Config config) {
        this.config = config != null ? config : new Idea43904Config();
