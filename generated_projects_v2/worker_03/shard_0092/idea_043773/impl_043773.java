...
@Data
public class Idea43773Config {
    private String name = "idea_043773";
 ...
 */
@Slf4j
public class Idea43773Service {
    private static final int IDEA_ID = 43773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43773Service() {
        this(new Idea43773Config());
    }

    public Idea43773Service(Idea43773Config config) {
        this.config = config != null ? config : new Idea43773Config();
