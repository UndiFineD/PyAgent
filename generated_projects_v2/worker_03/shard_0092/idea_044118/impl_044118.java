...
@Data
public class Idea44118Config {
    private String name = "idea_044118";
 ...
 */
@Slf4j
public class Idea44118Service {
    private static final int IDEA_ID = 44118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44118Service() {
        this(new Idea44118Config());
    }

    public Idea44118Service(Idea44118Config config) {
        this.config = config != null ? config : new Idea44118Config();
