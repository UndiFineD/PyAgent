...
@Data
public class Idea43999Config {
    private String name = "idea_043999";
 ...
 */
@Slf4j
public class Idea43999Service {
    private static final int IDEA_ID = 43999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43999Service() {
        this(new Idea43999Config());
    }

    public Idea43999Service(Idea43999Config config) {
        this.config = config != null ? config : new Idea43999Config();
