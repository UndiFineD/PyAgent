...
@Data
public class Idea43890Config {
    private String name = "idea_043890";
 ...
 */
@Slf4j
public class Idea43890Service {
    private static final int IDEA_ID = 43890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43890Service() {
        this(new Idea43890Config());
    }

    public Idea43890Service(Idea43890Config config) {
        this.config = config != null ? config : new Idea43890Config();
