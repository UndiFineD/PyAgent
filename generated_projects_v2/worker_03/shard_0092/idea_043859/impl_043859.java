...
@Data
public class Idea43859Config {
    private String name = "idea_043859";
 ...
 */
@Slf4j
public class Idea43859Service {
    private static final int IDEA_ID = 43859;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43859Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43859Service() {
        this(new Idea43859Config());
    }

    public Idea43859Service(Idea43859Config config) {
        this.config = config != null ? config : new Idea43859Config();
