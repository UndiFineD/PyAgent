...
@Data
public class Idea43804Config {
    private String name = "idea_043804";
 ...
 */
@Slf4j
public class Idea43804Service {
    private static final int IDEA_ID = 43804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43804Service() {
        this(new Idea43804Config());
    }

    public Idea43804Service(Idea43804Config config) {
        this.config = config != null ? config : new Idea43804Config();
