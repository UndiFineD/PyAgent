...
@Data
public class Idea43963Config {
    private String name = "idea_043963";
 ...
 */
@Slf4j
public class Idea43963Service {
    private static final int IDEA_ID = 43963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43963Service() {
        this(new Idea43963Config());
    }

    public Idea43963Service(Idea43963Config config) {
        this.config = config != null ? config : new Idea43963Config();
