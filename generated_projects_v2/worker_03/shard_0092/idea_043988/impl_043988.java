...
@Data
public class Idea43988Config {
    private String name = "idea_043988";
 ...
 */
@Slf4j
public class Idea43988Service {
    private static final int IDEA_ID = 43988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43988Service() {
        this(new Idea43988Config());
    }

    public Idea43988Service(Idea43988Config config) {
        this.config = config != null ? config : new Idea43988Config();
