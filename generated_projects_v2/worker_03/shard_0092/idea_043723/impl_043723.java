...
@Data
public class Idea43723Config {
    private String name = "idea_043723";
 ...
 */
@Slf4j
public class Idea43723Service {
    private static final int IDEA_ID = 43723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43723Service() {
        this(new Idea43723Config());
    }

    public Idea43723Service(Idea43723Config config) {
        this.config = config != null ? config : new Idea43723Config();
