...
@Data
public class Idea43888Config {
    private String name = "idea_043888";
 ...
 */
@Slf4j
public class Idea43888Service {
    private static final int IDEA_ID = 43888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43888Service() {
        this(new Idea43888Config());
    }

    public Idea43888Service(Idea43888Config config) {
        this.config = config != null ? config : new Idea43888Config();
