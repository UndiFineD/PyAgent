...
@Data
public class Idea44023Config {
    private String name = "idea_044023";
 ...
 */
@Slf4j
public class Idea44023Service {
    private static final int IDEA_ID = 44023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44023Service() {
        this(new Idea44023Config());
    }

    public Idea44023Service(Idea44023Config config) {
        this.config = config != null ? config : new Idea44023Config();
