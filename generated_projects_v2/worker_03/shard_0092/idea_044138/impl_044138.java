...
@Data
public class Idea44138Config {
    private String name = "idea_044138";
 ...
 */
@Slf4j
public class Idea44138Service {
    private static final int IDEA_ID = 44138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44138Service() {
        this(new Idea44138Config());
    }

    public Idea44138Service(Idea44138Config config) {
        this.config = config != null ? config : new Idea44138Config();
