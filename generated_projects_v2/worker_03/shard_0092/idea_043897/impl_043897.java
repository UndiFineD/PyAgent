...
@Data
public class Idea43897Config {
    private String name = "idea_043897";
 ...
 */
@Slf4j
public class Idea43897Service {
    private static final int IDEA_ID = 43897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43897Service() {
        this(new Idea43897Config());
    }

    public Idea43897Service(Idea43897Config config) {
        this.config = config != null ? config : new Idea43897Config();
