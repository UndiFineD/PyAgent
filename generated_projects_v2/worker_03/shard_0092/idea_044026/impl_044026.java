...
@Data
public class Idea44026Config {
    private String name = "idea_044026";
 ...
 */
@Slf4j
public class Idea44026Service {
    private static final int IDEA_ID = 44026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44026Service() {
        this(new Idea44026Config());
    }

    public Idea44026Service(Idea44026Config config) {
        this.config = config != null ? config : new Idea44026Config();
