...
@Data
public class Idea44120Config {
    private String name = "idea_044120";
 ...
 */
@Slf4j
public class Idea44120Service {
    private static final int IDEA_ID = 44120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44120Service() {
        this(new Idea44120Config());
    }

    public Idea44120Service(Idea44120Config config) {
        this.config = config != null ? config : new Idea44120Config();
