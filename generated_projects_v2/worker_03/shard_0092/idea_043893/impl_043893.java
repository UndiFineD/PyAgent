...
@Data
public class Idea43893Config {
    private String name = "idea_043893";
 ...
 */
@Slf4j
public class Idea43893Service {
    private static final int IDEA_ID = 43893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43893Service() {
        this(new Idea43893Config());
    }

    public Idea43893Service(Idea43893Config config) {
        this.config = config != null ? config : new Idea43893Config();
