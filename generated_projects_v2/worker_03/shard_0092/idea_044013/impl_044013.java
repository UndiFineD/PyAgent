...
@Data
public class Idea44013Config {
    private String name = "idea_044013";
 ...
 */
@Slf4j
public class Idea44013Service {
    private static final int IDEA_ID = 44013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44013Service() {
        this(new Idea44013Config());
    }

    public Idea44013Service(Idea44013Config config) {
        this.config = config != null ? config : new Idea44013Config();
