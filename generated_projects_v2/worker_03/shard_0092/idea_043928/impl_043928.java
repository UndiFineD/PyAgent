...
@Data
public class Idea43928Config {
    private String name = "idea_043928";
 ...
 */
@Slf4j
public class Idea43928Service {
    private static final int IDEA_ID = 43928;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43928Service() {
        this(new Idea43928Config());
    }

    public Idea43928Service(Idea43928Config config) {
        this.config = config != null ? config : new Idea43928Config();
