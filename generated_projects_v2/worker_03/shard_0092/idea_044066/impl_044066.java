...
@Data
public class Idea44066Config {
    private String name = "idea_044066";
 ...
 */
@Slf4j
public class Idea44066Service {
    private static final int IDEA_ID = 44066;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44066Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44066Service() {
        this(new Idea44066Config());
    }

    public Idea44066Service(Idea44066Config config) {
        this.config = config != null ? config : new Idea44066Config();
