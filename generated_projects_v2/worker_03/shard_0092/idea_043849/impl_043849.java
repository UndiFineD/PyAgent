...
@Data
public class Idea43849Config {
    private String name = "idea_043849";
 ...
 */
@Slf4j
public class Idea43849Service {
    private static final int IDEA_ID = 43849;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43849Service() {
        this(new Idea43849Config());
    }

    public Idea43849Service(Idea43849Config config) {
        this.config = config != null ? config : new Idea43849Config();
