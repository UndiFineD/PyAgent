...
@Data
public class Idea43701Config {
    private String name = "idea_043701";
 ...
 */
@Slf4j
public class Idea43701Service {
    private static final int IDEA_ID = 43701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43701Service() {
        this(new Idea43701Config());
    }

    public Idea43701Service(Idea43701Config config) {
        this.config = config != null ? config : new Idea43701Config();
