...
@Data
public class Idea44087Config {
    private String name = "idea_044087";
 ...
 */
@Slf4j
public class Idea44087Service {
    private static final int IDEA_ID = 44087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44087Service() {
        this(new Idea44087Config());
    }

    public Idea44087Service(Idea44087Config config) {
        this.config = config != null ? config : new Idea44087Config();
