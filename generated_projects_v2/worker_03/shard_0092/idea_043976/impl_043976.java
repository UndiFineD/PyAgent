...
@Data
public class Idea43976Config {
    private String name = "idea_043976";
 ...
 */
@Slf4j
public class Idea43976Service {
    private static final int IDEA_ID = 43976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43976Service() {
        this(new Idea43976Config());
    }

    public Idea43976Service(Idea43976Config config) {
        this.config = config != null ? config : new Idea43976Config();
