...
@Data
public class Idea43811Config {
    private String name = "idea_043811";
 ...
 */
@Slf4j
public class Idea43811Service {
    private static final int IDEA_ID = 43811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43811Service() {
        this(new Idea43811Config());
    }

    public Idea43811Service(Idea43811Config config) {
        this.config = config != null ? config : new Idea43811Config();
