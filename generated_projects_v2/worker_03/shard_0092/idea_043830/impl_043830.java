...
@Data
public class Idea43830Config {
    private String name = "idea_043830";
 ...
 */
@Slf4j
public class Idea43830Service {
    private static final int IDEA_ID = 43830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43830Service() {
        this(new Idea43830Config());
    }

    public Idea43830Service(Idea43830Config config) {
        this.config = config != null ? config : new Idea43830Config();
