...
@Data
public class Idea43775Config {
    private String name = "idea_043775";
 ...
 */
@Slf4j
public class Idea43775Service {
    private static final int IDEA_ID = 43775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43775Service() {
        this(new Idea43775Config());
    }

    public Idea43775Service(Idea43775Config config) {
        this.config = config != null ? config : new Idea43775Config();
