...
@Data
public class Idea43730Config {
    private String name = "idea_043730";
 ...
 */
@Slf4j
public class Idea43730Service {
    private static final int IDEA_ID = 43730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43730Service() {
        this(new Idea43730Config());
    }

    public Idea43730Service(Idea43730Config config) {
        this.config = config != null ? config : new Idea43730Config();
