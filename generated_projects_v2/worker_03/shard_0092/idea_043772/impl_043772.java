...
@Data
public class Idea43772Config {
    private String name = "idea_043772";
 ...
 */
@Slf4j
public class Idea43772Service {
    private static final int IDEA_ID = 43772;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43772Service() {
        this(new Idea43772Config());
    }

    public Idea43772Service(Idea43772Config config) {
        this.config = config != null ? config : new Idea43772Config();
