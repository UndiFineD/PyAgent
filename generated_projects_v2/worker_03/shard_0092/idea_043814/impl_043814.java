...
@Data
public class Idea43814Config {
    private String name = "idea_043814";
 ...
 */
@Slf4j
public class Idea43814Service {
    private static final int IDEA_ID = 43814;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43814Service() {
        this(new Idea43814Config());
    }

    public Idea43814Service(Idea43814Config config) {
        this.config = config != null ? config : new Idea43814Config();
