...
@Data
public class Idea43954Config {
    private String name = "idea_043954";
 ...
 */
@Slf4j
public class Idea43954Service {
    private static final int IDEA_ID = 43954;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43954Service() {
        this(new Idea43954Config());
    }

    public Idea43954Service(Idea43954Config config) {
        this.config = config != null ? config : new Idea43954Config();
