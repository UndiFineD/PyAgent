...
@Data
public class Idea43924Config {
    private String name = "idea_043924";
 ...
 */
@Slf4j
public class Idea43924Service {
    private static final int IDEA_ID = 43924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43924Service() {
        this(new Idea43924Config());
    }

    public Idea43924Service(Idea43924Config config) {
        this.config = config != null ? config : new Idea43924Config();
