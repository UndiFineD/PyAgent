...
@Data
public class Idea43977Config {
    private String name = "idea_043977";
 ...
 */
@Slf4j
public class Idea43977Service {
    private static final int IDEA_ID = 43977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43977Service() {
        this(new Idea43977Config());
    }

    public Idea43977Service(Idea43977Config config) {
        this.config = config != null ? config : new Idea43977Config();
