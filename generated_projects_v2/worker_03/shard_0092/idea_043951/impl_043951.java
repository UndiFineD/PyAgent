...
@Data
public class Idea43951Config {
    private String name = "idea_043951";
 ...
 */
@Slf4j
public class Idea43951Service {
    private static final int IDEA_ID = 43951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43951Service() {
        this(new Idea43951Config());
    }

    public Idea43951Service(Idea43951Config config) {
        this.config = config != null ? config : new Idea43951Config();
