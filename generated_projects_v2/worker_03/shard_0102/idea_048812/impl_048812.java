...
@Data
public class Idea48812Config {
    private String name = "idea_048812";
 ...
 */
@Slf4j
public class Idea48812Service {
    private static final int IDEA_ID = 48812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48812Service() {
        this(new Idea48812Config());
    }

    public Idea48812Service(Idea48812Config config) {
        this.config = config != null ? config : new Idea48812Config();
