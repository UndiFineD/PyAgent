...
@Data
public class Idea48661Config {
    private String name = "idea_048661";
 ...
 */
@Slf4j
public class Idea48661Service {
    private static final int IDEA_ID = 48661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48661Service() {
        this(new Idea48661Config());
    }

    public Idea48661Service(Idea48661Config config) {
        this.config = config != null ? config : new Idea48661Config();
