...
@Data
public class Idea48854Config {
    private String name = "idea_048854";
 ...
 */
@Slf4j
public class Idea48854Service {
    private static final int IDEA_ID = 48854;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48854Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48854Service() {
        this(new Idea48854Config());
    }

    public Idea48854Service(Idea48854Config config) {
        this.config = config != null ? config : new Idea48854Config();
