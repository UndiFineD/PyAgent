...
@Data
public class Idea48633Config {
    private String name = "idea_048633";
 ...
 */
@Slf4j
public class Idea48633Service {
    private static final int IDEA_ID = 48633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48633Service() {
        this(new Idea48633Config());
    }

    public Idea48633Service(Idea48633Config config) {
        this.config = config != null ? config : new Idea48633Config();
