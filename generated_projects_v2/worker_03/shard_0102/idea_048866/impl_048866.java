...
@Data
public class Idea48866Config {
    private String name = "idea_048866";
 ...
 */
@Slf4j
public class Idea48866Service {
    private static final int IDEA_ID = 48866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48866Service() {
        this(new Idea48866Config());
    }

    public Idea48866Service(Idea48866Config config) {
        this.config = config != null ? config : new Idea48866Config();
