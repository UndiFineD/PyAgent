...
@Data
public class Idea48480Config {
    private String name = "idea_048480";
 ...
 */
@Slf4j
public class Idea48480Service {
    private static final int IDEA_ID = 48480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48480Service() {
        this(new Idea48480Config());
    }

    public Idea48480Service(Idea48480Config config) {
        this.config = config != null ? config : new Idea48480Config();
