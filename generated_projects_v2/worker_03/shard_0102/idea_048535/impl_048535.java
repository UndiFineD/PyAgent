...
@Data
public class Idea48535Config {
    private String name = "idea_048535";
 ...
 */
@Slf4j
public class Idea48535Service {
    private static final int IDEA_ID = 48535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48535Service() {
        this(new Idea48535Config());
    }

    public Idea48535Service(Idea48535Config config) {
        this.config = config != null ? config : new Idea48535Config();
