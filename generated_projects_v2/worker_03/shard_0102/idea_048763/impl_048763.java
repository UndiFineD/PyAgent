...
@Data
public class Idea48763Config {
    private String name = "idea_048763";
 ...
 */
@Slf4j
public class Idea48763Service {
    private static final int IDEA_ID = 48763;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48763Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48763Service() {
        this(new Idea48763Config());
    }

    public Idea48763Service(Idea48763Config config) {
        this.config = config != null ? config : new Idea48763Config();
