...
@Data
public class Idea48712Config {
    private String name = "idea_048712";
 ...
 */
@Slf4j
public class Idea48712Service {
    private static final int IDEA_ID = 48712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48712Service() {
        this(new Idea48712Config());
    }

    public Idea48712Service(Idea48712Config config) {
        this.config = config != null ? config : new Idea48712Config();
