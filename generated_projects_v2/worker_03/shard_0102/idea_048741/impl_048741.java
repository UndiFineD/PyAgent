...
@Data
public class Idea48741Config {
    private String name = "idea_048741";
 ...
 */
@Slf4j
public class Idea48741Service {
    private static final int IDEA_ID = 48741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48741Service() {
        this(new Idea48741Config());
    }

    public Idea48741Service(Idea48741Config config) {
        this.config = config != null ? config : new Idea48741Config();
