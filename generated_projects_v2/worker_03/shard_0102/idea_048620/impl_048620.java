...
@Data
public class Idea48620Config {
    private String name = "idea_048620";
 ...
 */
@Slf4j
public class Idea48620Service {
    private static final int IDEA_ID = 48620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48620Service() {
        this(new Idea48620Config());
    }

    public Idea48620Service(Idea48620Config config) {
        this.config = config != null ? config : new Idea48620Config();
