...
@Data
public class Idea48872Config {
    private String name = "idea_048872";
 ...
 */
@Slf4j
public class Idea48872Service {
    private static final int IDEA_ID = 48872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48872Service() {
        this(new Idea48872Config());
    }

    public Idea48872Service(Idea48872Config config) {
        this.config = config != null ? config : new Idea48872Config();
