...
@Data
public class Idea48486Config {
    private String name = "idea_048486";
 ...
 */
@Slf4j
public class Idea48486Service {
    private static final int IDEA_ID = 48486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48486Service() {
        this(new Idea48486Config());
    }

    public Idea48486Service(Idea48486Config config) {
        this.config = config != null ? config : new Idea48486Config();
