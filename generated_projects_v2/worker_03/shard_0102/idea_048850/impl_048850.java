...
@Data
public class Idea48850Config {
    private String name = "idea_048850";
 ...
 */
@Slf4j
public class Idea48850Service {
    private static final int IDEA_ID = 48850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48850Service() {
        this(new Idea48850Config());
    }

    public Idea48850Service(Idea48850Config config) {
        this.config = config != null ? config : new Idea48850Config();
