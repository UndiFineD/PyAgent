...
@Data
public class Idea48825Config {
    private String name = "idea_048825";
 ...
 */
@Slf4j
public class Idea48825Service {
    private static final int IDEA_ID = 48825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48825Service() {
        this(new Idea48825Config());
    }

    public Idea48825Service(Idea48825Config config) {
        this.config = config != null ? config : new Idea48825Config();
