...
@Data
public class Idea48715Config {
    private String name = "idea_048715";
 ...
 */
@Slf4j
public class Idea48715Service {
    private static final int IDEA_ID = 48715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48715Service() {
        this(new Idea48715Config());
    }

    public Idea48715Service(Idea48715Config config) {
        this.config = config != null ? config : new Idea48715Config();
