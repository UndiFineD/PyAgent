...
@Data
public class Idea48823Config {
    private String name = "idea_048823";
 ...
 */
@Slf4j
public class Idea48823Service {
    private static final int IDEA_ID = 48823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48823Service() {
        this(new Idea48823Config());
    }

    public Idea48823Service(Idea48823Config config) {
        this.config = config != null ? config : new Idea48823Config();
