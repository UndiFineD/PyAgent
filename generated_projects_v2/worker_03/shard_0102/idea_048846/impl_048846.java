...
@Data
public class Idea48846Config {
    private String name = "idea_048846";
 ...
 */
@Slf4j
public class Idea48846Service {
    private static final int IDEA_ID = 48846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48846Service() {
        this(new Idea48846Config());
    }

    public Idea48846Service(Idea48846Config config) {
        this.config = config != null ? config : new Idea48846Config();
