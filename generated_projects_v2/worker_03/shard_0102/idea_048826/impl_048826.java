...
@Data
public class Idea48826Config {
    private String name = "idea_048826";
 ...
 */
@Slf4j
public class Idea48826Service {
    private static final int IDEA_ID = 48826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48826Service() {
        this(new Idea48826Config());
    }

    public Idea48826Service(Idea48826Config config) {
        this.config = config != null ? config : new Idea48826Config();
