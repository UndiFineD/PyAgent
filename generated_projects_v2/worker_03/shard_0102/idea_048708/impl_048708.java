...
@Data
public class Idea48708Config {
    private String name = "idea_048708";
 ...
 */
@Slf4j
public class Idea48708Service {
    private static final int IDEA_ID = 48708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48708Service() {
        this(new Idea48708Config());
    }

    public Idea48708Service(Idea48708Config config) {
        this.config = config != null ? config : new Idea48708Config();
