...
@Data
public class Idea48821Config {
    private String name = "idea_048821";
 ...
 */
@Slf4j
public class Idea48821Service {
    private static final int IDEA_ID = 48821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48821Service() {
        this(new Idea48821Config());
    }

    public Idea48821Service(Idea48821Config config) {
        this.config = config != null ? config : new Idea48821Config();
