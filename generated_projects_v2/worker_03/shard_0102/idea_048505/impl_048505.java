...
@Data
public class Idea48505Config {
    private String name = "idea_048505";
 ...
 */
@Slf4j
public class Idea48505Service {
    private static final int IDEA_ID = 48505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48505Service() {
        this(new Idea48505Config());
    }

    public Idea48505Service(Idea48505Config config) {
        this.config = config != null ? config : new Idea48505Config();
