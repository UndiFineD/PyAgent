...
@Data
public class Idea48632Config {
    private String name = "idea_048632";
 ...
 */
@Slf4j
public class Idea48632Service {
    private static final int IDEA_ID = 48632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48632Service() {
        this(new Idea48632Config());
    }

    public Idea48632Service(Idea48632Config config) {
        this.config = config != null ? config : new Idea48632Config();
