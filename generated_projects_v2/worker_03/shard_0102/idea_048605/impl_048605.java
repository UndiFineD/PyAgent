...
@Data
public class Idea48605Config {
    private String name = "idea_048605";
 ...
 */
@Slf4j
public class Idea48605Service {
    private static final int IDEA_ID = 48605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48605Service() {
        this(new Idea48605Config());
    }

    public Idea48605Service(Idea48605Config config) {
        this.config = config != null ? config : new Idea48605Config();
