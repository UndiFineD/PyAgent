...
@Data
public class Idea48701Config {
    private String name = "idea_048701";
 ...
 */
@Slf4j
public class Idea48701Service {
    private static final int IDEA_ID = 48701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48701Service() {
        this(new Idea48701Config());
    }

    public Idea48701Service(Idea48701Config config) {
        this.config = config != null ? config : new Idea48701Config();
