...
@Data
public class Idea48460Config {
    private String name = "idea_048460";
 ...
 */
@Slf4j
public class Idea48460Service {
    private static final int IDEA_ID = 48460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48460Service() {
        this(new Idea48460Config());
    }

    public Idea48460Service(Idea48460Config config) {
        this.config = config != null ? config : new Idea48460Config();
