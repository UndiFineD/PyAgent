...
@Data
public class Idea48511Config {
    private String name = "idea_048511";
 ...
 */
@Slf4j
public class Idea48511Service {
    private static final int IDEA_ID = 48511;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48511Service() {
        this(new Idea48511Config());
    }

    public Idea48511Service(Idea48511Config config) {
        this.config = config != null ? config : new Idea48511Config();
