...
@Data
public class Idea48580Config {
    private String name = "idea_048580";
 ...
 */
@Slf4j
public class Idea48580Service {
    private static final int IDEA_ID = 48580;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48580Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48580Service() {
        this(new Idea48580Config());
    }

    public Idea48580Service(Idea48580Config config) {
        this.config = config != null ? config : new Idea48580Config();
