...
@Data
public class Idea48477Config {
    private String name = "idea_048477";
 ...
 */
@Slf4j
public class Idea48477Service {
    private static final int IDEA_ID = 48477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48477Service() {
        this(new Idea48477Config());
    }

    public Idea48477Service(Idea48477Config config) {
        this.config = config != null ? config : new Idea48477Config();
