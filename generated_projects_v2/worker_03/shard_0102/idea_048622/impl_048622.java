...
@Data
public class Idea48622Config {
    private String name = "idea_048622";
 ...
 */
@Slf4j
public class Idea48622Service {
    private static final int IDEA_ID = 48622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48622Service() {
        this(new Idea48622Config());
    }

    public Idea48622Service(Idea48622Config config) {
        this.config = config != null ? config : new Idea48622Config();
