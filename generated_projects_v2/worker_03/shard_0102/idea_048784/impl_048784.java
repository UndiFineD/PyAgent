...
@Data
public class Idea48784Config {
    private String name = "idea_048784";
 ...
 */
@Slf4j
public class Idea48784Service {
    private static final int IDEA_ID = 48784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48784Service() {
        this(new Idea48784Config());
    }

    public Idea48784Service(Idea48784Config config) {
        this.config = config != null ? config : new Idea48784Config();
