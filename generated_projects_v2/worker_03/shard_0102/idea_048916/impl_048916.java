...
@Data
public class Idea48916Config {
    private String name = "idea_048916";
 ...
 */
@Slf4j
public class Idea48916Service {
    private static final int IDEA_ID = 48916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48916Service() {
        this(new Idea48916Config());
    }

    public Idea48916Service(Idea48916Config config) {
        this.config = config != null ? config : new Idea48916Config();
