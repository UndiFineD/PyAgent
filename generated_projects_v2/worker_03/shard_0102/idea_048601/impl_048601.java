...
@Data
public class Idea48601Config {
    private String name = "idea_048601";
 ...
 */
@Slf4j
public class Idea48601Service {
    private static final int IDEA_ID = 48601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48601Service() {
        this(new Idea48601Config());
    }

    public Idea48601Service(Idea48601Config config) {
        this.config = config != null ? config : new Idea48601Config();
