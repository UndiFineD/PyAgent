...
@Data
public class Idea48906Config {
    private String name = "idea_048906";
 ...
 */
@Slf4j
public class Idea48906Service {
    private static final int IDEA_ID = 48906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48906Service() {
        this(new Idea48906Config());
    }

    public Idea48906Service(Idea48906Config config) {
        this.config = config != null ? config : new Idea48906Config();
