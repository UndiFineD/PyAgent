...
@Data
public class Idea48845Config {
    private String name = "idea_048845";
 ...
 */
@Slf4j
public class Idea48845Service {
    private static final int IDEA_ID = 48845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48845Service() {
        this(new Idea48845Config());
    }

    public Idea48845Service(Idea48845Config config) {
        this.config = config != null ? config : new Idea48845Config();
