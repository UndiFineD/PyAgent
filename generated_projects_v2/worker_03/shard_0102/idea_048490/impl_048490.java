...
@Data
public class Idea48490Config {
    private String name = "idea_048490";
 ...
 */
@Slf4j
public class Idea48490Service {
    private static final int IDEA_ID = 48490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48490Service() {
        this(new Idea48490Config());
    }

    public Idea48490Service(Idea48490Config config) {
        this.config = config != null ? config : new Idea48490Config();
