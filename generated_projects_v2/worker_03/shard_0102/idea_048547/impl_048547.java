...
@Data
public class Idea48547Config {
    private String name = "idea_048547";
 ...
 */
@Slf4j
public class Idea48547Service {
    private static final int IDEA_ID = 48547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48547Service() {
        this(new Idea48547Config());
    }

    public Idea48547Service(Idea48547Config config) {
        this.config = config != null ? config : new Idea48547Config();
