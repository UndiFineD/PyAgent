...
@Data
public class Idea48887Config {
    private String name = "idea_048887";
 ...
 */
@Slf4j
public class Idea48887Service {
    private static final int IDEA_ID = 48887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48887Service() {
        this(new Idea48887Config());
    }

    public Idea48887Service(Idea48887Config config) {
        this.config = config != null ? config : new Idea48887Config();
