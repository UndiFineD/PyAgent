...
@Data
public class Idea48718Config {
    private String name = "idea_048718";
 ...
 */
@Slf4j
public class Idea48718Service {
    private static final int IDEA_ID = 48718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48718Service() {
        this(new Idea48718Config());
    }

    public Idea48718Service(Idea48718Config config) {
        this.config = config != null ? config : new Idea48718Config();
