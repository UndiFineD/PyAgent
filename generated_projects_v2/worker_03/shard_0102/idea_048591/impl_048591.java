...
@Data
public class Idea48591Config {
    private String name = "idea_048591";
 ...
 */
@Slf4j
public class Idea48591Service {
    private static final int IDEA_ID = 48591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48591Service() {
        this(new Idea48591Config());
    }

    public Idea48591Service(Idea48591Config config) {
        this.config = config != null ? config : new Idea48591Config();
