...
@Data
public class Idea48917Config {
    private String name = "idea_048917";
 ...
 */
@Slf4j
public class Idea48917Service {
    private static final int IDEA_ID = 48917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48917Service() {
        this(new Idea48917Config());
    }

    public Idea48917Service(Idea48917Config config) {
        this.config = config != null ? config : new Idea48917Config();
