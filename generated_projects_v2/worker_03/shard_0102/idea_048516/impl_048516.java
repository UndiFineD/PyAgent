...
@Data
public class Idea48516Config {
    private String name = "idea_048516";
 ...
 */
@Slf4j
public class Idea48516Service {
    private static final int IDEA_ID = 48516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48516Service() {
        this(new Idea48516Config());
    }

    public Idea48516Service(Idea48516Config config) {
        this.config = config != null ? config : new Idea48516Config();
