...
@Data
public class Idea48464Config {
    private String name = "idea_048464";
 ...
 */
@Slf4j
public class Idea48464Service {
    private static final int IDEA_ID = 48464;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48464Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48464Service() {
        this(new Idea48464Config());
    }

    public Idea48464Service(Idea48464Config config) {
        this.config = config != null ? config : new Idea48464Config();
