...
@Data
public class Idea48703Config {
    private String name = "idea_048703";
 ...
 */
@Slf4j
public class Idea48703Service {
    private static final int IDEA_ID = 48703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48703Service() {
        this(new Idea48703Config());
    }

    public Idea48703Service(Idea48703Config config) {
        this.config = config != null ? config : new Idea48703Config();
