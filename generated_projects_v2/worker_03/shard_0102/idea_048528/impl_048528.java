...
@Data
public class Idea48528Config {
    private String name = "idea_048528";
 ...
 */
@Slf4j
public class Idea48528Service {
    private static final int IDEA_ID = 48528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48528Service() {
        this(new Idea48528Config());
    }

    public Idea48528Service(Idea48528Config config) {
        this.config = config != null ? config : new Idea48528Config();
