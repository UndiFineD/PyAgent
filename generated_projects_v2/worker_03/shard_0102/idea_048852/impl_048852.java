...
@Data
public class Idea48852Config {
    private String name = "idea_048852";
 ...
 */
@Slf4j
public class Idea48852Service {
    private static final int IDEA_ID = 48852;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48852Service() {
        this(new Idea48852Config());
    }

    public Idea48852Service(Idea48852Config config) {
        this.config = config != null ? config : new Idea48852Config();
