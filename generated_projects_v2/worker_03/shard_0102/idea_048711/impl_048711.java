...
@Data
public class Idea48711Config {
    private String name = "idea_048711";
 ...
 */
@Slf4j
public class Idea48711Service {
    private static final int IDEA_ID = 48711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48711Service() {
        this(new Idea48711Config());
    }

    public Idea48711Service(Idea48711Config config) {
        this.config = config != null ? config : new Idea48711Config();
