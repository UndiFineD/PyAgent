...
@Data
public class Idea48648Config {
    private String name = "idea_048648";
 ...
 */
@Slf4j
public class Idea48648Service {
    private static final int IDEA_ID = 48648;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48648Service() {
        this(new Idea48648Config());
    }

    public Idea48648Service(Idea48648Config config) {
        this.config = config != null ? config : new Idea48648Config();
