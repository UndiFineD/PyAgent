...
@Data
public class Idea48790Config {
    private String name = "idea_048790";
 ...
 */
@Slf4j
public class Idea48790Service {
    private static final int IDEA_ID = 48790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48790Service() {
        this(new Idea48790Config());
    }

    public Idea48790Service(Idea48790Config config) {
        this.config = config != null ? config : new Idea48790Config();
