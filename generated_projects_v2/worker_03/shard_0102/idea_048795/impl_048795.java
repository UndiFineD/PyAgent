...
@Data
public class Idea48795Config {
    private String name = "idea_048795";
 ...
 */
@Slf4j
public class Idea48795Service {
    private static final int IDEA_ID = 48795;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48795Service() {
        this(new Idea48795Config());
    }

    public Idea48795Service(Idea48795Config config) {
        this.config = config != null ? config : new Idea48795Config();
