...
@Data
public class Idea48833Config {
    private String name = "idea_048833";
 ...
 */
@Slf4j
public class Idea48833Service {
    private static final int IDEA_ID = 48833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48833Service() {
        this(new Idea48833Config());
    }

    public Idea48833Service(Idea48833Config config) {
        this.config = config != null ? config : new Idea48833Config();
