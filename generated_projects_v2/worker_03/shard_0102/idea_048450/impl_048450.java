...
@Data
public class Idea48450Config {
    private String name = "idea_048450";
 ...
 */
@Slf4j
public class Idea48450Service {
    private static final int IDEA_ID = 48450;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48450Service() {
        this(new Idea48450Config());
    }

    public Idea48450Service(Idea48450Config config) {
        this.config = config != null ? config : new Idea48450Config();
