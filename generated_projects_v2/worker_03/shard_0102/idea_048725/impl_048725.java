...
@Data
public class Idea48725Config {
    private String name = "idea_048725";
 ...
 */
@Slf4j
public class Idea48725Service {
    private static final int IDEA_ID = 48725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48725Service() {
        this(new Idea48725Config());
    }

    public Idea48725Service(Idea48725Config config) {
        this.config = config != null ? config : new Idea48725Config();
