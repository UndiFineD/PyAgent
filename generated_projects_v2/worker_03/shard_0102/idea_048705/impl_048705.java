...
@Data
public class Idea48705Config {
    private String name = "idea_048705";
 ...
 */
@Slf4j
public class Idea48705Service {
    private static final int IDEA_ID = 48705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48705Service() {
        this(new Idea48705Config());
    }

    public Idea48705Service(Idea48705Config config) {
        this.config = config != null ? config : new Idea48705Config();
