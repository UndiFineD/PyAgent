...
@Data
public class Idea48901Config {
    private String name = "idea_048901";
 ...
 */
@Slf4j
public class Idea48901Service {
    private static final int IDEA_ID = 48901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48901Service() {
        this(new Idea48901Config());
    }

    public Idea48901Service(Idea48901Config config) {
        this.config = config != null ? config : new Idea48901Config();
