...
@Data
public class Idea48911Config {
    private String name = "idea_048911";
 ...
 */
@Slf4j
public class Idea48911Service {
    private static final int IDEA_ID = 48911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48911Service() {
        this(new Idea48911Config());
    }

    public Idea48911Service(Idea48911Config config) {
        this.config = config != null ? config : new Idea48911Config();
