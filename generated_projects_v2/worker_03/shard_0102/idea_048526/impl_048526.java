...
@Data
public class Idea48526Config {
    private String name = "idea_048526";
 ...
 */
@Slf4j
public class Idea48526Service {
    private static final int IDEA_ID = 48526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48526Service() {
        this(new Idea48526Config());
    }

    public Idea48526Service(Idea48526Config config) {
        this.config = config != null ? config : new Idea48526Config();
