...
@Data
public class Idea48635Config {
    private String name = "idea_048635";
 ...
 */
@Slf4j
public class Idea48635Service {
    private static final int IDEA_ID = 48635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48635Service() {
        this(new Idea48635Config());
    }

    public Idea48635Service(Idea48635Config config) {
        this.config = config != null ? config : new Idea48635Config();
