...
@Data
public class Idea48513Config {
    private String name = "idea_048513";
 ...
 */
@Slf4j
public class Idea48513Service {
    private static final int IDEA_ID = 48513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48513Service() {
        this(new Idea48513Config());
    }

    public Idea48513Service(Idea48513Config config) {
        this.config = config != null ? config : new Idea48513Config();
