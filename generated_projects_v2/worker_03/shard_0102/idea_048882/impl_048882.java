...
@Data
public class Idea48882Config {
    private String name = "idea_048882";
 ...
 */
@Slf4j
public class Idea48882Service {
    private static final int IDEA_ID = 48882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48882Service() {
        this(new Idea48882Config());
    }

    public Idea48882Service(Idea48882Config config) {
        this.config = config != null ? config : new Idea48882Config();
