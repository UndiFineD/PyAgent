...
@Data
public class Idea48525Config {
    private String name = "idea_048525";
 ...
 */
@Slf4j
public class Idea48525Service {
    private static final int IDEA_ID = 48525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48525Service() {
        this(new Idea48525Config());
    }

    public Idea48525Service(Idea48525Config config) {
        this.config = config != null ? config : new Idea48525Config();
