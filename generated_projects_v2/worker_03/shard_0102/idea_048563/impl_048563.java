...
@Data
public class Idea48563Config {
    private String name = "idea_048563";
 ...
 */
@Slf4j
public class Idea48563Service {
    private static final int IDEA_ID = 48563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48563Service() {
        this(new Idea48563Config());
    }

    public Idea48563Service(Idea48563Config config) {
        this.config = config != null ? config : new Idea48563Config();
