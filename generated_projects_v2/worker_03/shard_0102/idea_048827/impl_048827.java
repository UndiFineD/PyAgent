...
@Data
public class Idea48827Config {
    private String name = "idea_048827";
 ...
 */
@Slf4j
public class Idea48827Service {
    private static final int IDEA_ID = 48827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48827Service() {
        this(new Idea48827Config());
    }

    public Idea48827Service(Idea48827Config config) {
        this.config = config != null ? config : new Idea48827Config();
