...
@Data
public class Idea48571Config {
    private String name = "idea_048571";
 ...
 */
@Slf4j
public class Idea48571Service {
    private static final int IDEA_ID = 48571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48571Service() {
        this(new Idea48571Config());
    }

    public Idea48571Service(Idea48571Config config) {
        this.config = config != null ? config : new Idea48571Config();
