...
@Data
public class Idea48707Config {
    private String name = "idea_048707";
 ...
 */
@Slf4j
public class Idea48707Service {
    private static final int IDEA_ID = 48707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48707Service() {
        this(new Idea48707Config());
    }

    public Idea48707Service(Idea48707Config config) {
        this.config = config != null ? config : new Idea48707Config();
