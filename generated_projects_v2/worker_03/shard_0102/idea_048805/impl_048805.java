...
@Data
public class Idea48805Config {
    private String name = "idea_048805";
 ...
 */
@Slf4j
public class Idea48805Service {
    private static final int IDEA_ID = 48805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48805Service() {
        this(new Idea48805Config());
    }

    public Idea48805Service(Idea48805Config config) {
        this.config = config != null ? config : new Idea48805Config();
