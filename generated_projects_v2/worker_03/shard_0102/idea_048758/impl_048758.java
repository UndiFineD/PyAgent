...
@Data
public class Idea48758Config {
    private String name = "idea_048758";
 ...
 */
@Slf4j
public class Idea48758Service {
    private static final int IDEA_ID = 48758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48758Service() {
        this(new Idea48758Config());
    }

    public Idea48758Service(Idea48758Config config) {
        this.config = config != null ? config : new Idea48758Config();
