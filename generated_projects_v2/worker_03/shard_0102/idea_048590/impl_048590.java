...
@Data
public class Idea48590Config {
    private String name = "idea_048590";
 ...
 */
@Slf4j
public class Idea48590Service {
    private static final int IDEA_ID = 48590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48590Service() {
        this(new Idea48590Config());
    }

    public Idea48590Service(Idea48590Config config) {
        this.config = config != null ? config : new Idea48590Config();
