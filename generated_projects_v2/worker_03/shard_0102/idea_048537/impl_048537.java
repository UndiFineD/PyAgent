...
@Data
public class Idea48537Config {
    private String name = "idea_048537";
 ...
 */
@Slf4j
public class Idea48537Service {
    private static final int IDEA_ID = 48537;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48537Service() {
        this(new Idea48537Config());
    }

    public Idea48537Service(Idea48537Config config) {
        this.config = config != null ? config : new Idea48537Config();
