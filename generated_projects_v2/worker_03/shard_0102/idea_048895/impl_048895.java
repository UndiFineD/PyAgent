...
@Data
public class Idea48895Config {
    private String name = "idea_048895";
 ...
 */
@Slf4j
public class Idea48895Service {
    private static final int IDEA_ID = 48895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48895Service() {
        this(new Idea48895Config());
    }

    public Idea48895Service(Idea48895Config config) {
        this.config = config != null ? config : new Idea48895Config();
