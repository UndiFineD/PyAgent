...
@Data
public class Idea48849Config {
    private String name = "idea_048849";
 ...
 */
@Slf4j
public class Idea48849Service {
    private static final int IDEA_ID = 48849;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48849Service() {
        this(new Idea48849Config());
    }

    public Idea48849Service(Idea48849Config config) {
        this.config = config != null ? config : new Idea48849Config();
