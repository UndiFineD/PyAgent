...
@Data
public class Idea48651Config {
    private String name = "idea_048651";
 ...
 */
@Slf4j
public class Idea48651Service {
    private static final int IDEA_ID = 48651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48651Service() {
        this(new Idea48651Config());
    }

    public Idea48651Service(Idea48651Config config) {
        this.config = config != null ? config : new Idea48651Config();
