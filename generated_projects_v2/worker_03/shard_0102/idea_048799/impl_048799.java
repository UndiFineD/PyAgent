...
@Data
public class Idea48799Config {
    private String name = "idea_048799";
 ...
 */
@Slf4j
public class Idea48799Service {
    private static final int IDEA_ID = 48799;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48799Service() {
        this(new Idea48799Config());
    }

    public Idea48799Service(Idea48799Config config) {
        this.config = config != null ? config : new Idea48799Config();
