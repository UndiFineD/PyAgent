...
@Data
public class Idea48915Config {
    private String name = "idea_048915";
 ...
 */
@Slf4j
public class Idea48915Service {
    private static final int IDEA_ID = 48915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48915Service() {
        this(new Idea48915Config());
    }

    public Idea48915Service(Idea48915Config config) {
        this.config = config != null ? config : new Idea48915Config();
