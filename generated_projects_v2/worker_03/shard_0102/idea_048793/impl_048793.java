...
@Data
public class Idea48793Config {
    private String name = "idea_048793";
 ...
 */
@Slf4j
public class Idea48793Service {
    private static final int IDEA_ID = 48793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48793Service() {
        this(new Idea48793Config());
    }

    public Idea48793Service(Idea48793Config config) {
        this.config = config != null ? config : new Idea48793Config();
