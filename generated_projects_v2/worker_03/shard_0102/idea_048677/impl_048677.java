...
@Data
public class Idea48677Config {
    private String name = "idea_048677";
 ...
 */
@Slf4j
public class Idea48677Service {
    private static final int IDEA_ID = 48677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48677Service() {
        this(new Idea48677Config());
    }

    public Idea48677Service(Idea48677Config config) {
        this.config = config != null ? config : new Idea48677Config();
