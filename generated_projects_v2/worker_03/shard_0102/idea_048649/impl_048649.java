...
@Data
public class Idea48649Config {
    private String name = "idea_048649";
 ...
 */
@Slf4j
public class Idea48649Service {
    private static final int IDEA_ID = 48649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48649Service() {
        this(new Idea48649Config());
    }

    public Idea48649Service(Idea48649Config config) {
        this.config = config != null ? config : new Idea48649Config();
