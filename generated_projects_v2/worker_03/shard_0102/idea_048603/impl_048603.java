...
@Data
public class Idea48603Config {
    private String name = "idea_048603";
 ...
 */
@Slf4j
public class Idea48603Service {
    private static final int IDEA_ID = 48603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48603Service() {
        this(new Idea48603Config());
    }

    public Idea48603Service(Idea48603Config config) {
        this.config = config != null ? config : new Idea48603Config();
