...
@Data
public class Idea48753Config {
    private String name = "idea_048753";
 ...
 */
@Slf4j
public class Idea48753Service {
    private static final int IDEA_ID = 48753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48753Service() {
        this(new Idea48753Config());
    }

    public Idea48753Service(Idea48753Config config) {
        this.config = config != null ? config : new Idea48753Config();
