...
@Data
public class Idea48731Config {
    private String name = "idea_048731";
 ...
 */
@Slf4j
public class Idea48731Service {
    private static final int IDEA_ID = 48731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48731Service() {
        this(new Idea48731Config());
    }

    public Idea48731Service(Idea48731Config config) {
        this.config = config != null ? config : new Idea48731Config();
