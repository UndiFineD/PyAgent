...
@Data
public class Idea48577Config {
    private String name = "idea_048577";
 ...
 */
@Slf4j
public class Idea48577Service {
    private static final int IDEA_ID = 48577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48577Service() {
        this(new Idea48577Config());
    }

    public Idea48577Service(Idea48577Config config) {
        this.config = config != null ? config : new Idea48577Config();
