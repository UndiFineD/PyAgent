...
@Data
public class Idea48730Config {
    private String name = "idea_048730";
 ...
 */
@Slf4j
public class Idea48730Service {
    private static final int IDEA_ID = 48730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48730Service() {
        this(new Idea48730Config());
    }

    public Idea48730Service(Idea48730Config config) {
        this.config = config != null ? config : new Idea48730Config();
