...
@Data
public class Idea48782Config {
    private String name = "idea_048782";
 ...
 */
@Slf4j
public class Idea48782Service {
    private static final int IDEA_ID = 48782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48782Service() {
        this(new Idea48782Config());
    }

    public Idea48782Service(Idea48782Config config) {
        this.config = config != null ? config : new Idea48782Config();
