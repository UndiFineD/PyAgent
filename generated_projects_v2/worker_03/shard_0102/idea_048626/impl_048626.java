...
@Data
public class Idea48626Config {
    private String name = "idea_048626";
 ...
 */
@Slf4j
public class Idea48626Service {
    private static final int IDEA_ID = 48626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48626Service() {
        this(new Idea48626Config());
    }

    public Idea48626Service(Idea48626Config config) {
        this.config = config != null ? config : new Idea48626Config();
