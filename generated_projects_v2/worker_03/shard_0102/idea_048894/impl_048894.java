...
@Data
public class Idea48894Config {
    private String name = "idea_048894";
 ...
 */
@Slf4j
public class Idea48894Service {
    private static final int IDEA_ID = 48894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48894Service() {
        this(new Idea48894Config());
    }

    public Idea48894Service(Idea48894Config config) {
        this.config = config != null ? config : new Idea48894Config();
