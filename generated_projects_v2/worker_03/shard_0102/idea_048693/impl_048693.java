...
@Data
public class Idea48693Config {
    private String name = "idea_048693";
 ...
 */
@Slf4j
public class Idea48693Service {
    private static final int IDEA_ID = 48693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48693Service() {
        this(new Idea48693Config());
    }

    public Idea48693Service(Idea48693Config config) {
        this.config = config != null ? config : new Idea48693Config();
