...
@Data
public class Idea48721Config {
    private String name = "idea_048721";
 ...
 */
@Slf4j
public class Idea48721Service {
    private static final int IDEA_ID = 48721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48721Service() {
        this(new Idea48721Config());
    }

    public Idea48721Service(Idea48721Config config) {
        this.config = config != null ? config : new Idea48721Config();
