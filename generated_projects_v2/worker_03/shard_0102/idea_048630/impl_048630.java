...
@Data
public class Idea48630Config {
    private String name = "idea_048630";
 ...
 */
@Slf4j
public class Idea48630Service {
    private static final int IDEA_ID = 48630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48630Service() {
        this(new Idea48630Config());
    }

    public Idea48630Service(Idea48630Config config) {
        this.config = config != null ? config : new Idea48630Config();
