...
@Data
public class Idea48471Config {
    private String name = "idea_048471";
 ...
 */
@Slf4j
public class Idea48471Service {
    private static final int IDEA_ID = 48471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48471Service() {
        this(new Idea48471Config());
    }

    public Idea48471Service(Idea48471Config config) {
        this.config = config != null ? config : new Idea48471Config();
