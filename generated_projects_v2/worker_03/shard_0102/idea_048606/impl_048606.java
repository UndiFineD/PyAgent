...
@Data
public class Idea48606Config {
    private String name = "idea_048606";
 ...
 */
@Slf4j
public class Idea48606Service {
    private static final int IDEA_ID = 48606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48606Service() {
        this(new Idea48606Config());
    }

    public Idea48606Service(Idea48606Config config) {
        this.config = config != null ? config : new Idea48606Config();
