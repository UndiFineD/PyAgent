...
@Data
public class Idea48820Config {
    private String name = "idea_048820";
 ...
 */
@Slf4j
public class Idea48820Service {
    private static final int IDEA_ID = 48820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48820Service() {
        this(new Idea48820Config());
    }

    public Idea48820Service(Idea48820Config config) {
        this.config = config != null ? config : new Idea48820Config();
