...
@Data
public class Idea48517Config {
    private String name = "idea_048517";
 ...
 */
@Slf4j
public class Idea48517Service {
    private static final int IDEA_ID = 48517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48517Service() {
        this(new Idea48517Config());
    }

    public Idea48517Service(Idea48517Config config) {
        this.config = config != null ? config : new Idea48517Config();
