...
@Data
public class Idea48746Config {
    private String name = "idea_048746";
 ...
 */
@Slf4j
public class Idea48746Service {
    private static final int IDEA_ID = 48746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48746Service() {
        this(new Idea48746Config());
    }

    public Idea48746Service(Idea48746Config config) {
        this.config = config != null ? config : new Idea48746Config();
