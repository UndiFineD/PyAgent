...
@Data
public class Idea48487Config {
    private String name = "idea_048487";
 ...
 */
@Slf4j
public class Idea48487Service {
    private static final int IDEA_ID = 48487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48487Service() {
        this(new Idea48487Config());
    }

    public Idea48487Service(Idea48487Config config) {
        this.config = config != null ? config : new Idea48487Config();
