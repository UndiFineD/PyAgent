...
@Data
public class Idea48600Config {
    private String name = "idea_048600";
 ...
 */
@Slf4j
public class Idea48600Service {
    private static final int IDEA_ID = 48600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48600Service() {
        this(new Idea48600Config());
    }

    public Idea48600Service(Idea48600Config config) {
        this.config = config != null ? config : new Idea48600Config();
