...
@Data
public class Idea48484Config {
    private String name = "idea_048484";
 ...
 */
@Slf4j
public class Idea48484Service {
    private static final int IDEA_ID = 48484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48484Service() {
        this(new Idea48484Config());
    }

    public Idea48484Service(Idea48484Config config) {
        this.config = config != null ? config : new Idea48484Config();
