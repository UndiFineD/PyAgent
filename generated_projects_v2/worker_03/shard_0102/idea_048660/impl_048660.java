...
@Data
public class Idea48660Config {
    private String name = "idea_048660";
 ...
 */
@Slf4j
public class Idea48660Service {
    private static final int IDEA_ID = 48660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48660Service() {
        this(new Idea48660Config());
    }

    public Idea48660Service(Idea48660Config config) {
        this.config = config != null ? config : new Idea48660Config();
