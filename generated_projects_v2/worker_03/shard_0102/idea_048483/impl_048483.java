...
@Data
public class Idea48483Config {
    private String name = "idea_048483";
 ...
 */
@Slf4j
public class Idea48483Service {
    private static final int IDEA_ID = 48483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48483Service() {
        this(new Idea48483Config());
    }

    public Idea48483Service(Idea48483Config config) {
        this.config = config != null ? config : new Idea48483Config();
