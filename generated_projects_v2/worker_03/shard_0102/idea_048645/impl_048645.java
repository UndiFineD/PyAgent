...
@Data
public class Idea48645Config {
    private String name = "idea_048645";
 ...
 */
@Slf4j
public class Idea48645Service {
    private static final int IDEA_ID = 48645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48645Service() {
        this(new Idea48645Config());
    }

    public Idea48645Service(Idea48645Config config) {
        this.config = config != null ? config : new Idea48645Config();
