...
@Data
public class Idea48616Config {
    private String name = "idea_048616";
 ...
 */
@Slf4j
public class Idea48616Service {
    private static final int IDEA_ID = 48616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48616Service() {
        this(new Idea48616Config());
    }

    public Idea48616Service(Idea48616Config config) {
        this.config = config != null ? config : new Idea48616Config();
