...
@Data
public class Idea48683Config {
    private String name = "idea_048683";
 ...
 */
@Slf4j
public class Idea48683Service {
    private static final int IDEA_ID = 48683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48683Service() {
        this(new Idea48683Config());
    }

    public Idea48683Service(Idea48683Config config) {
        this.config = config != null ? config : new Idea48683Config();
