...
@Data
public class Idea48713Config {
    private String name = "idea_048713";
 ...
 */
@Slf4j
public class Idea48713Service {
    private static final int IDEA_ID = 48713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48713Service() {
        this(new Idea48713Config());
    }

    public Idea48713Service(Idea48713Config config) {
        this.config = config != null ? config : new Idea48713Config();
