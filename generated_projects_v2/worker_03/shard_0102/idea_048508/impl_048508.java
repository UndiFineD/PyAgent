...
@Data
public class Idea48508Config {
    private String name = "idea_048508";
 ...
 */
@Slf4j
public class Idea48508Service {
    private static final int IDEA_ID = 48508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48508Service() {
        this(new Idea48508Config());
    }

    public Idea48508Service(Idea48508Config config) {
        this.config = config != null ? config : new Idea48508Config();
