...
@Data
public class Idea48566Config {
    private String name = "idea_048566";
 ...
 */
@Slf4j
public class Idea48566Service {
    private static final int IDEA_ID = 48566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48566Service() {
        this(new Idea48566Config());
    }

    public Idea48566Service(Idea48566Config config) {
        this.config = config != null ? config : new Idea48566Config();
