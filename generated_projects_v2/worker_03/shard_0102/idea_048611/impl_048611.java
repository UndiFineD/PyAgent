...
@Data
public class Idea48611Config {
    private String name = "idea_048611";
 ...
 */
@Slf4j
public class Idea48611Service {
    private static final int IDEA_ID = 48611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48611Service() {
        this(new Idea48611Config());
    }

    public Idea48611Service(Idea48611Config config) {
        this.config = config != null ? config : new Idea48611Config();
