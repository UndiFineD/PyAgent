...
@Data
public class Idea48567Config {
    private String name = "idea_048567";
 ...
 */
@Slf4j
public class Idea48567Service {
    private static final int IDEA_ID = 48567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48567Service() {
        this(new Idea48567Config());
    }

    public Idea48567Service(Idea48567Config config) {
        this.config = config != null ? config : new Idea48567Config();
