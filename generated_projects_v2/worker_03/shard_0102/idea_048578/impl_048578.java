...
@Data
public class Idea48578Config {
    private String name = "idea_048578";
 ...
 */
@Slf4j
public class Idea48578Service {
    private static final int IDEA_ID = 48578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48578Service() {
        this(new Idea48578Config());
    }

    public Idea48578Service(Idea48578Config config) {
        this.config = config != null ? config : new Idea48578Config();
