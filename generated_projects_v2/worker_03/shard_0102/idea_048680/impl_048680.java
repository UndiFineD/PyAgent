...
@Data
public class Idea48680Config {
    private String name = "idea_048680";
 ...
 */
@Slf4j
public class Idea48680Service {
    private static final int IDEA_ID = 48680;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48680Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48680Service() {
        this(new Idea48680Config());
    }

    public Idea48680Service(Idea48680Config config) {
        this.config = config != null ? config : new Idea48680Config();
