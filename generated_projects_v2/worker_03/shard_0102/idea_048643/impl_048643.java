...
@Data
public class Idea48643Config {
    private String name = "idea_048643";
 ...
 */
@Slf4j
public class Idea48643Service {
    private static final int IDEA_ID = 48643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48643Service() {
        this(new Idea48643Config());
    }

    public Idea48643Service(Idea48643Config config) {
        this.config = config != null ? config : new Idea48643Config();
