...
@Data
public class Idea48809Config {
    private String name = "idea_048809";
 ...
 */
@Slf4j
public class Idea48809Service {
    private static final int IDEA_ID = 48809;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48809Service() {
        this(new Idea48809Config());
    }

    public Idea48809Service(Idea48809Config config) {
        this.config = config != null ? config : new Idea48809Config();
