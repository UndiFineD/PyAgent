...
@Data
public class Idea48654Config {
    private String name = "idea_048654";
 ...
 */
@Slf4j
public class Idea48654Service {
    private static final int IDEA_ID = 48654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48654Service() {
        this(new Idea48654Config());
    }

    public Idea48654Service(Idea48654Config config) {
        this.config = config != null ? config : new Idea48654Config();
