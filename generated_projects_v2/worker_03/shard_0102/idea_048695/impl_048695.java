...
@Data
public class Idea48695Config {
    private String name = "idea_048695";
 ...
 */
@Slf4j
public class Idea48695Service {
    private static final int IDEA_ID = 48695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48695Service() {
        this(new Idea48695Config());
    }

    public Idea48695Service(Idea48695Config config) {
        this.config = config != null ? config : new Idea48695Config();
