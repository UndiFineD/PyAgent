...
@Data
public class Idea48585Config {
    private String name = "idea_048585";
 ...
 */
@Slf4j
public class Idea48585Service {
    private static final int IDEA_ID = 48585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48585Service() {
        this(new Idea48585Config());
    }

    public Idea48585Service(Idea48585Config config) {
        this.config = config != null ? config : new Idea48585Config();
