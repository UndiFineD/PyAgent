...
@Data
public class Idea48592Config {
    private String name = "idea_048592";
 ...
 */
@Slf4j
public class Idea48592Service {
    private static final int IDEA_ID = 48592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48592Service() {
        this(new Idea48592Config());
    }

    public Idea48592Service(Idea48592Config config) {
        this.config = config != null ? config : new Idea48592Config();
