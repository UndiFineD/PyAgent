...
@Data
public class Idea48667Config {
    private String name = "idea_048667";
 ...
 */
@Slf4j
public class Idea48667Service {
    private static final int IDEA_ID = 48667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48667Service() {
        this(new Idea48667Config());
    }

    public Idea48667Service(Idea48667Config config) {
        this.config = config != null ? config : new Idea48667Config();
