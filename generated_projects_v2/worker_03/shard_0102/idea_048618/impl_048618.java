...
@Data
public class Idea48618Config {
    private String name = "idea_048618";
 ...
 */
@Slf4j
public class Idea48618Service {
    private static final int IDEA_ID = 48618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48618Service() {
        this(new Idea48618Config());
    }

    public Idea48618Service(Idea48618Config config) {
        this.config = config != null ? config : new Idea48618Config();
