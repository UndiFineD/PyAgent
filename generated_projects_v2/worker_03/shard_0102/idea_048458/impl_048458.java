...
@Data
public class Idea48458Config {
    private String name = "idea_048458";
 ...
 */
@Slf4j
public class Idea48458Service {
    private static final int IDEA_ID = 48458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48458Service() {
        this(new Idea48458Config());
    }

    public Idea48458Service(Idea48458Config config) {
        this.config = config != null ? config : new Idea48458Config();
