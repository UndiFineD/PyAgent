...
@Data
public class Idea48818Config {
    private String name = "idea_048818";
 ...
 */
@Slf4j
public class Idea48818Service {
    private static final int IDEA_ID = 48818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48818Service() {
        this(new Idea48818Config());
    }

    public Idea48818Service(Idea48818Config config) {
        this.config = config != null ? config : new Idea48818Config();
