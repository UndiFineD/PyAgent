...
@Data
public class Idea48801Config {
    private String name = "idea_048801";
 ...
 */
@Slf4j
public class Idea48801Service {
    private static final int IDEA_ID = 48801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48801Service() {
        this(new Idea48801Config());
    }

    public Idea48801Service(Idea48801Config config) {
        this.config = config != null ? config : new Idea48801Config();
