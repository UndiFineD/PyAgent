...
@Data
public class Idea48662Config {
    private String name = "idea_048662";
 ...
 */
@Slf4j
public class Idea48662Service {
    private static final int IDEA_ID = 48662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48662Service() {
        this(new Idea48662Config());
    }

    public Idea48662Service(Idea48662Config config) {
        this.config = config != null ? config : new Idea48662Config();
