...
@Data
public class Idea48573Config {
    private String name = "idea_048573";
 ...
 */
@Slf4j
public class Idea48573Service {
    private static final int IDEA_ID = 48573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48573Service() {
        this(new Idea48573Config());
    }

    public Idea48573Service(Idea48573Config config) {
        this.config = config != null ? config : new Idea48573Config();
