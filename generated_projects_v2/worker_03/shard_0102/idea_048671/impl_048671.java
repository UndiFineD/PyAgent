...
@Data
public class Idea48671Config {
    private String name = "idea_048671";
 ...
 */
@Slf4j
public class Idea48671Service {
    private static final int IDEA_ID = 48671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48671Service() {
        this(new Idea48671Config());
    }

    public Idea48671Service(Idea48671Config config) {
        this.config = config != null ? config : new Idea48671Config();
