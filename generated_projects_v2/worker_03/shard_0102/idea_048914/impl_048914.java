...
@Data
public class Idea48914Config {
    private String name = "idea_048914";
 ...
 */
@Slf4j
public class Idea48914Service {
    private static final int IDEA_ID = 48914;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48914Service() {
        this(new Idea48914Config());
    }

    public Idea48914Service(Idea48914Config config) {
        this.config = config != null ? config : new Idea48914Config();
