...
@Data
public class Idea48575Config {
    private String name = "idea_048575";
 ...
 */
@Slf4j
public class Idea48575Service {
    private static final int IDEA_ID = 48575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48575Service() {
        this(new Idea48575Config());
    }

    public Idea48575Service(Idea48575Config config) {
        this.config = config != null ? config : new Idea48575Config();
