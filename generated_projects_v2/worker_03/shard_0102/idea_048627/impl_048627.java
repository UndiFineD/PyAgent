...
@Data
public class Idea48627Config {
    private String name = "idea_048627";
 ...
 */
@Slf4j
public class Idea48627Service {
    private static final int IDEA_ID = 48627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48627Service() {
        this(new Idea48627Config());
    }

    public Idea48627Service(Idea48627Config config) {
        this.config = config != null ? config : new Idea48627Config();
