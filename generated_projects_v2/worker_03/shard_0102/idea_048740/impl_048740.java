...
@Data
public class Idea48740Config {
    private String name = "idea_048740";
 ...
 */
@Slf4j
public class Idea48740Service {
    private static final int IDEA_ID = 48740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48740Service() {
        this(new Idea48740Config());
    }

    public Idea48740Service(Idea48740Config config) {
        this.config = config != null ? config : new Idea48740Config();
