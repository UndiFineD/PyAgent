...
@Data
public class Idea48738Config {
    private String name = "idea_048738";
 ...
 */
@Slf4j
public class Idea48738Service {
    private static final int IDEA_ID = 48738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48738Service() {
        this(new Idea48738Config());
    }

    public Idea48738Service(Idea48738Config config) {
        this.config = config != null ? config : new Idea48738Config();
