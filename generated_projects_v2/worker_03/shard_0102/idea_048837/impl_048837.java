...
@Data
public class Idea48837Config {
    private String name = "idea_048837";
 ...
 */
@Slf4j
public class Idea48837Service {
    private static final int IDEA_ID = 48837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48837Service() {
        this(new Idea48837Config());
    }

    public Idea48837Service(Idea48837Config config) {
        this.config = config != null ? config : new Idea48837Config();
