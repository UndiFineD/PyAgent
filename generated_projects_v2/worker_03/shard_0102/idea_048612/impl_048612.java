...
@Data
public class Idea48612Config {
    private String name = "idea_048612";
 ...
 */
@Slf4j
public class Idea48612Service {
    private static final int IDEA_ID = 48612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48612Service() {
        this(new Idea48612Config());
    }

    public Idea48612Service(Idea48612Config config) {
        this.config = config != null ? config : new Idea48612Config();
