...
@Data
public class Idea48839Config {
    private String name = "idea_048839";
 ...
 */
@Slf4j
public class Idea48839Service {
    private static final int IDEA_ID = 48839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48839Service() {
        this(new Idea48839Config());
    }

    public Idea48839Service(Idea48839Config config) {
        this.config = config != null ? config : new Idea48839Config();
