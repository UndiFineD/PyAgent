...
@Data
public class Idea48900Config {
    private String name = "idea_048900";
 ...
 */
@Slf4j
public class Idea48900Service {
    private static final int IDEA_ID = 48900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48900Service() {
        this(new Idea48900Config());
    }

    public Idea48900Service(Idea48900Config config) {
        this.config = config != null ? config : new Idea48900Config();
