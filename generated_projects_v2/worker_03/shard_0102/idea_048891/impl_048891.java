...
@Data
public class Idea48891Config {
    private String name = "idea_048891";
 ...
 */
@Slf4j
public class Idea48891Service {
    private static final int IDEA_ID = 48891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48891Service() {
        this(new Idea48891Config());
    }

    public Idea48891Service(Idea48891Config config) {
        this.config = config != null ? config : new Idea48891Config();
