...
@Data
public class Idea48752Config {
    private String name = "idea_048752";
 ...
 */
@Slf4j
public class Idea48752Service {
    private static final int IDEA_ID = 48752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48752Service() {
        this(new Idea48752Config());
    }

    public Idea48752Service(Idea48752Config config) {
        this.config = config != null ? config : new Idea48752Config();
