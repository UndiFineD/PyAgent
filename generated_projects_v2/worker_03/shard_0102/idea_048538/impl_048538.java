...
@Data
public class Idea48538Config {
    private String name = "idea_048538";
 ...
 */
@Slf4j
public class Idea48538Service {
    private static final int IDEA_ID = 48538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48538Service() {
        this(new Idea48538Config());
    }

    public Idea48538Service(Idea48538Config config) {
        this.config = config != null ? config : new Idea48538Config();
