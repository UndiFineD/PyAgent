...
@Data
public class Idea48800Config {
    private String name = "idea_048800";
 ...
 */
@Slf4j
public class Idea48800Service {
    private static final int IDEA_ID = 48800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48800Service() {
        this(new Idea48800Config());
    }

    public Idea48800Service(Idea48800Config config) {
        this.config = config != null ? config : new Idea48800Config();
