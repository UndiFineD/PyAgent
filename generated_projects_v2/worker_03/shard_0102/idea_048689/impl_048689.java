...
@Data
public class Idea48689Config {
    private String name = "idea_048689";
 ...
 */
@Slf4j
public class Idea48689Service {
    private static final int IDEA_ID = 48689;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48689Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48689Service() {
        this(new Idea48689Config());
    }

    public Idea48689Service(Idea48689Config config) {
        this.config = config != null ? config : new Idea48689Config();
