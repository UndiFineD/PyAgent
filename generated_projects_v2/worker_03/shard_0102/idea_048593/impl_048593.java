...
@Data
public class Idea48593Config {
    private String name = "idea_048593";
 ...
 */
@Slf4j
public class Idea48593Service {
    private static final int IDEA_ID = 48593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48593Service() {
        this(new Idea48593Config());
    }

    public Idea48593Service(Idea48593Config config) {
        this.config = config != null ? config : new Idea48593Config();
