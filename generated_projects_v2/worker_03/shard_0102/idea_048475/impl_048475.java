...
@Data
public class Idea48475Config {
    private String name = "idea_048475";
 ...
 */
@Slf4j
public class Idea48475Service {
    private static final int IDEA_ID = 48475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48475Service() {
        this(new Idea48475Config());
    }

    public Idea48475Service(Idea48475Config config) {
        this.config = config != null ? config : new Idea48475Config();
