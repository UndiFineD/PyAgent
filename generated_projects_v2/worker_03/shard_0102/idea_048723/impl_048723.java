...
@Data
public class Idea48723Config {
    private String name = "idea_048723";
 ...
 */
@Slf4j
public class Idea48723Service {
    private static final int IDEA_ID = 48723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48723Service() {
        this(new Idea48723Config());
    }

    public Idea48723Service(Idea48723Config config) {
        this.config = config != null ? config : new Idea48723Config();
