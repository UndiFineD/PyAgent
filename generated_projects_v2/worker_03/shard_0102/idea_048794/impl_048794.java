...
@Data
public class Idea48794Config {
    private String name = "idea_048794";
 ...
 */
@Slf4j
public class Idea48794Service {
    private static final int IDEA_ID = 48794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48794Service() {
        this(new Idea48794Config());
    }

    public Idea48794Service(Idea48794Config config) {
        this.config = config != null ? config : new Idea48794Config();
