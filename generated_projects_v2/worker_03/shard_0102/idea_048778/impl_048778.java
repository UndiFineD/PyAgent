...
@Data
public class Idea48778Config {
    private String name = "idea_048778";
 ...
 */
@Slf4j
public class Idea48778Service {
    private static final int IDEA_ID = 48778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48778Service() {
        this(new Idea48778Config());
    }

    public Idea48778Service(Idea48778Config config) {
        this.config = config != null ? config : new Idea48778Config();
