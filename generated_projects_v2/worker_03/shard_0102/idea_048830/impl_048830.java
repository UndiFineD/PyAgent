...
@Data
public class Idea48830Config {
    private String name = "idea_048830";
 ...
 */
@Slf4j
public class Idea48830Service {
    private static final int IDEA_ID = 48830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48830Service() {
        this(new Idea48830Config());
    }

    public Idea48830Service(Idea48830Config config) {
        this.config = config != null ? config : new Idea48830Config();
