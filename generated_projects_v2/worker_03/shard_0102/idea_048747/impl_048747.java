...
@Data
public class Idea48747Config {
    private String name = "idea_048747";
 ...
 */
@Slf4j
public class Idea48747Service {
    private static final int IDEA_ID = 48747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48747Service() {
        this(new Idea48747Config());
    }

    public Idea48747Service(Idea48747Config config) {
        this.config = config != null ? config : new Idea48747Config();
