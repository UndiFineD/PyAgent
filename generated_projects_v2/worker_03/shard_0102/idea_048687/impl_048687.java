...
@Data
public class Idea48687Config {
    private String name = "idea_048687";
 ...
 */
@Slf4j
public class Idea48687Service {
    private static final int IDEA_ID = 48687;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48687Service() {
        this(new Idea48687Config());
    }

    public Idea48687Service(Idea48687Config config) {
        this.config = config != null ? config : new Idea48687Config();
