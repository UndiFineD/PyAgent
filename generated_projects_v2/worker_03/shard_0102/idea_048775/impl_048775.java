...
@Data
public class Idea48775Config {
    private String name = "idea_048775";
 ...
 */
@Slf4j
public class Idea48775Service {
    private static final int IDEA_ID = 48775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48775Service() {
        this(new Idea48775Config());
    }

    public Idea48775Service(Idea48775Config config) {
        this.config = config != null ? config : new Idea48775Config();
