...
@Data
public class Idea48905Config {
    private String name = "idea_048905";
 ...
 */
@Slf4j
public class Idea48905Service {
    private static final int IDEA_ID = 48905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48905Service() {
        this(new Idea48905Config());
    }

    public Idea48905Service(Idea48905Config config) {
        this.config = config != null ? config : new Idea48905Config();
