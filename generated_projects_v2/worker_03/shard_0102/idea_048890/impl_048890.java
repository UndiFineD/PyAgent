...
@Data
public class Idea48890Config {
    private String name = "idea_048890";
 ...
 */
@Slf4j
public class Idea48890Service {
    private static final int IDEA_ID = 48890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48890Service() {
        this(new Idea48890Config());
    }

    public Idea48890Service(Idea48890Config config) {
        this.config = config != null ? config : new Idea48890Config();
