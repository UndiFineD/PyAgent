...
@Data
public class Idea48807Config {
    private String name = "idea_048807";
 ...
 */
@Slf4j
public class Idea48807Service {
    private static final int IDEA_ID = 48807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48807Service() {
        this(new Idea48807Config());
    }

    public Idea48807Service(Idea48807Config config) {
        this.config = config != null ? config : new Idea48807Config();
