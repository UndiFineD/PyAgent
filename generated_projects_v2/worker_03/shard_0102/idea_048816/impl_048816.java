...
@Data
public class Idea48816Config {
    private String name = "idea_048816";
 ...
 */
@Slf4j
public class Idea48816Service {
    private static final int IDEA_ID = 48816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48816Service() {
        this(new Idea48816Config());
    }

    public Idea48816Service(Idea48816Config config) {
        this.config = config != null ? config : new Idea48816Config();
