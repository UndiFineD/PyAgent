...
@Data
public class Idea48560Config {
    private String name = "idea_048560";
 ...
 */
@Slf4j
public class Idea48560Service {
    private static final int IDEA_ID = 48560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48560Service() {
        this(new Idea48560Config());
    }

    public Idea48560Service(Idea48560Config config) {
        this.config = config != null ? config : new Idea48560Config();
