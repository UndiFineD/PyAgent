...
@Data
public class Idea48877Config {
    private String name = "idea_048877";
 ...
 */
@Slf4j
public class Idea48877Service {
    private static final int IDEA_ID = 48877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48877Service() {
        this(new Idea48877Config());
    }

    public Idea48877Service(Idea48877Config config) {
        this.config = config != null ? config : new Idea48877Config();
