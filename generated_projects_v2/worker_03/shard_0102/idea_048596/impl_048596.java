...
@Data
public class Idea48596Config {
    private String name = "idea_048596";
 ...
 */
@Slf4j
public class Idea48596Service {
    private static final int IDEA_ID = 48596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48596Service() {
        this(new Idea48596Config());
    }

    public Idea48596Service(Idea48596Config config) {
        this.config = config != null ? config : new Idea48596Config();
