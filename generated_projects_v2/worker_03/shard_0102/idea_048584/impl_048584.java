...
@Data
public class Idea48584Config {
    private String name = "idea_048584";
 ...
 */
@Slf4j
public class Idea48584Service {
    private static final int IDEA_ID = 48584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48584Service() {
        this(new Idea48584Config());
    }

    public Idea48584Service(Idea48584Config config) {
        this.config = config != null ? config : new Idea48584Config();
