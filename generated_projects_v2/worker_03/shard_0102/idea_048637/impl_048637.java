...
@Data
public class Idea48637Config {
    private String name = "idea_048637";
 ...
 */
@Slf4j
public class Idea48637Service {
    private static final int IDEA_ID = 48637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48637Service() {
        this(new Idea48637Config());
    }

    public Idea48637Service(Idea48637Config config) {
        this.config = config != null ? config : new Idea48637Config();
