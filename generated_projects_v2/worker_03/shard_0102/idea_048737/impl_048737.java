...
@Data
public class Idea48737Config {
    private String name = "idea_048737";
 ...
 */
@Slf4j
public class Idea48737Service {
    private static final int IDEA_ID = 48737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48737Service() {
        this(new Idea48737Config());
    }

    public Idea48737Service(Idea48737Config config) {
        this.config = config != null ? config : new Idea48737Config();
