...
@Data
public class Idea48631Config {
    private String name = "idea_048631";
 ...
 */
@Slf4j
public class Idea48631Service {
    private static final int IDEA_ID = 48631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48631Service() {
        this(new Idea48631Config());
    }

    public Idea48631Service(Idea48631Config config) {
        this.config = config != null ? config : new Idea48631Config();
