...
@Data
public class Idea48533Config {
    private String name = "idea_048533";
 ...
 */
@Slf4j
public class Idea48533Service {
    private static final int IDEA_ID = 48533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48533Service() {
        this(new Idea48533Config());
    }

    public Idea48533Service(Idea48533Config config) {
        this.config = config != null ? config : new Idea48533Config();
