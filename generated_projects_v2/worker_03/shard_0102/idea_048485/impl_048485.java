...
@Data
public class Idea48485Config {
    private String name = "idea_048485";
 ...
 */
@Slf4j
public class Idea48485Service {
    private static final int IDEA_ID = 48485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48485Service() {
        this(new Idea48485Config());
    }

    public Idea48485Service(Idea48485Config config) {
        this.config = config != null ? config : new Idea48485Config();
