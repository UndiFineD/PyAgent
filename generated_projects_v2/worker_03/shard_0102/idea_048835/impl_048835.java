...
@Data
public class Idea48835Config {
    private String name = "idea_048835";
 ...
 */
@Slf4j
public class Idea48835Service {
    private static final int IDEA_ID = 48835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48835Service() {
        this(new Idea48835Config());
    }

    public Idea48835Service(Idea48835Config config) {
        this.config = config != null ? config : new Idea48835Config();
