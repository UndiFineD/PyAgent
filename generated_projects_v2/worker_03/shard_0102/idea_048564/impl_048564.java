...
@Data
public class Idea48564Config {
    private String name = "idea_048564";
 ...
 */
@Slf4j
public class Idea48564Service {
    private static final int IDEA_ID = 48564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48564Service() {
        this(new Idea48564Config());
    }

    public Idea48564Service(Idea48564Config config) {
        this.config = config != null ? config : new Idea48564Config();
