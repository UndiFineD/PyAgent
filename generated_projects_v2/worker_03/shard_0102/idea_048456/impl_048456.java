...
@Data
public class Idea48456Config {
    private String name = "idea_048456";
 ...
 */
@Slf4j
public class Idea48456Service {
    private static final int IDEA_ID = 48456;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48456Service() {
        this(new Idea48456Config());
    }

    public Idea48456Service(Idea48456Config config) {
        this.config = config != null ? config : new Idea48456Config();
