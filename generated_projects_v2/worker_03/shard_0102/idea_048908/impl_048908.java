...
@Data
public class Idea48908Config {
    private String name = "idea_048908";
 ...
 */
@Slf4j
public class Idea48908Service {
    private static final int IDEA_ID = 48908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48908Service() {
        this(new Idea48908Config());
    }

    public Idea48908Service(Idea48908Config config) {
        this.config = config != null ? config : new Idea48908Config();
