...
@Data
public class Idea48523Config {
    private String name = "idea_048523";
 ...
 */
@Slf4j
public class Idea48523Service {
    private static final int IDEA_ID = 48523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48523Service() {
        this(new Idea48523Config());
    }

    public Idea48523Service(Idea48523Config config) {
        this.config = config != null ? config : new Idea48523Config();
