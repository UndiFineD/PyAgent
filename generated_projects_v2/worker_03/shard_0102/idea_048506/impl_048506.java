...
@Data
public class Idea48506Config {
    private String name = "idea_048506";
 ...
 */
@Slf4j
public class Idea48506Service {
    private static final int IDEA_ID = 48506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48506Service() {
        this(new Idea48506Config());
    }

    public Idea48506Service(Idea48506Config config) {
        this.config = config != null ? config : new Idea48506Config();
