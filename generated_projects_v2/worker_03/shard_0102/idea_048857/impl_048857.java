...
@Data
public class Idea48857Config {
    private String name = "idea_048857";
 ...
 */
@Slf4j
public class Idea48857Service {
    private static final int IDEA_ID = 48857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48857Service() {
        this(new Idea48857Config());
    }

    public Idea48857Service(Idea48857Config config) {
        this.config = config != null ? config : new Idea48857Config();
