...
@Data
public class Idea48678Config {
    private String name = "idea_048678";
 ...
 */
@Slf4j
public class Idea48678Service {
    private static final int IDEA_ID = 48678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48678Service() {
        this(new Idea48678Config());
    }

    public Idea48678Service(Idea48678Config config) {
        this.config = config != null ? config : new Idea48678Config();
