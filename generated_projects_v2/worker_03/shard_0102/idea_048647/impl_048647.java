...
@Data
public class Idea48647Config {
    private String name = "idea_048647";
 ...
 */
@Slf4j
public class Idea48647Service {
    private static final int IDEA_ID = 48647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48647Service() {
        this(new Idea48647Config());
    }

    public Idea48647Service(Idea48647Config config) {
        this.config = config != null ? config : new Idea48647Config();
