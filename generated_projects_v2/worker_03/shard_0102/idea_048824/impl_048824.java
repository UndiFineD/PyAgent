...
@Data
public class Idea48824Config {
    private String name = "idea_048824";
 ...
 */
@Slf4j
public class Idea48824Service {
    private static final int IDEA_ID = 48824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48824Service() {
        this(new Idea48824Config());
    }

    public Idea48824Service(Idea48824Config config) {
        this.config = config != null ? config : new Idea48824Config();
