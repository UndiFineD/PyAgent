...
@Data
public class Idea48750Config {
    private String name = "idea_048750";
 ...
 */
@Slf4j
public class Idea48750Service {
    private static final int IDEA_ID = 48750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48750Service() {
        this(new Idea48750Config());
    }

    public Idea48750Service(Idea48750Config config) {
        this.config = config != null ? config : new Idea48750Config();
