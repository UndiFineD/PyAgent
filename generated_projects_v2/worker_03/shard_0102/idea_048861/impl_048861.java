...
@Data
public class Idea48861Config {
    private String name = "idea_048861";
 ...
 */
@Slf4j
public class Idea48861Service {
    private static final int IDEA_ID = 48861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48861Service() {
        this(new Idea48861Config());
    }

    public Idea48861Service(Idea48861Config config) {
        this.config = config != null ? config : new Idea48861Config();
