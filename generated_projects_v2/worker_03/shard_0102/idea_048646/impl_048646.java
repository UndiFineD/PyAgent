...
@Data
public class Idea48646Config {
    private String name = "idea_048646";
 ...
 */
@Slf4j
public class Idea48646Service {
    private static final int IDEA_ID = 48646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48646Service() {
        this(new Idea48646Config());
    }

    public Idea48646Service(Idea48646Config config) {
        this.config = config != null ? config : new Idea48646Config();
