...
@Data
public class Idea48634Config {
    private String name = "idea_048634";
 ...
 */
@Slf4j
public class Idea48634Service {
    private static final int IDEA_ID = 48634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48634Service() {
        this(new Idea48634Config());
    }

    public Idea48634Service(Idea48634Config config) {
        this.config = config != null ? config : new Idea48634Config();
