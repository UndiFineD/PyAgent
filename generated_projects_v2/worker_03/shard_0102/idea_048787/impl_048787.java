...
@Data
public class Idea48787Config {
    private String name = "idea_048787";
 ...
 */
@Slf4j
public class Idea48787Service {
    private static final int IDEA_ID = 48787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48787Service() {
        this(new Idea48787Config());
    }

    public Idea48787Service(Idea48787Config config) {
        this.config = config != null ? config : new Idea48787Config();
