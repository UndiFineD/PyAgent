...
@Data
public class Idea48494Config {
    private String name = "idea_048494";
 ...
 */
@Slf4j
public class Idea48494Service {
    private static final int IDEA_ID = 48494;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48494Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48494Service() {
        this(new Idea48494Config());
    }

    public Idea48494Service(Idea48494Config config) {
        this.config = config != null ? config : new Idea48494Config();
