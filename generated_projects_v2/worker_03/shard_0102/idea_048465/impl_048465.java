...
@Data
public class Idea48465Config {
    private String name = "idea_048465";
 ...
 */
@Slf4j
public class Idea48465Service {
    private static final int IDEA_ID = 48465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48465Service() {
        this(new Idea48465Config());
    }

    public Idea48465Service(Idea48465Config config) {
        this.config = config != null ? config : new Idea48465Config();
