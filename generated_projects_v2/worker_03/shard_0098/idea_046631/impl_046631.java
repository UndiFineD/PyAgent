...
@Data
public class Idea46631Config {
    private String name = "idea_046631";
 ...
 */
@Slf4j
public class Idea46631Service {
    private static final int IDEA_ID = 46631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46631Service() {
        this(new Idea46631Config());
    }

    public Idea46631Service(Idea46631Config config) {
        this.config = config != null ? config : new Idea46631Config();
