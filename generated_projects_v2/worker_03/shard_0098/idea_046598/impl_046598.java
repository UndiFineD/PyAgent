...
@Data
public class Idea46598Config {
    private String name = "idea_046598";
 ...
 */
@Slf4j
public class Idea46598Service {
    private static final int IDEA_ID = 46598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46598Service() {
        this(new Idea46598Config());
    }

    public Idea46598Service(Idea46598Config config) {
        this.config = config != null ? config : new Idea46598Config();
