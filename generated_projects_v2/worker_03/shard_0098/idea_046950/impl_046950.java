...
@Data
public class Idea46950Config {
    private String name = "idea_046950";
 ...
 */
@Slf4j
public class Idea46950Service {
    private static final int IDEA_ID = 46950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46950Service() {
        this(new Idea46950Config());
    }

    public Idea46950Service(Idea46950Config config) {
        this.config = config != null ? config : new Idea46950Config();
