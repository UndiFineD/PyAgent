...
@Data
public class Idea46745Config {
    private String name = "idea_046745";
 ...
 */
@Slf4j
public class Idea46745Service {
    private static final int IDEA_ID = 46745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46745Service() {
        this(new Idea46745Config());
    }

    public Idea46745Service(Idea46745Config config) {
        this.config = config != null ? config : new Idea46745Config();
