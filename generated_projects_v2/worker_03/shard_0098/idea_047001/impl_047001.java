...
@Data
public class Idea47001Config {
    private String name = "idea_047001";
 ...
 */
@Slf4j
public class Idea47001Service {
    private static final int IDEA_ID = 47001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47001Service() {
        this(new Idea47001Config());
    }

    public Idea47001Service(Idea47001Config config) {
        this.config = config != null ? config : new Idea47001Config();
