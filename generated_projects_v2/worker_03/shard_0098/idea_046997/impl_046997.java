...
@Data
public class Idea46997Config {
    private String name = "idea_046997";
 ...
 */
@Slf4j
public class Idea46997Service {
    private static final int IDEA_ID = 46997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46997Service() {
        this(new Idea46997Config());
    }

    public Idea46997Service(Idea46997Config config) {
        this.config = config != null ? config : new Idea46997Config();
