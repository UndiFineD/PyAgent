...
@Data
public class Idea46964Config {
    private String name = "idea_046964";
 ...
 */
@Slf4j
public class Idea46964Service {
    private static final int IDEA_ID = 46964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46964Service() {
        this(new Idea46964Config());
    }

    public Idea46964Service(Idea46964Config config) {
        this.config = config != null ? config : new Idea46964Config();
