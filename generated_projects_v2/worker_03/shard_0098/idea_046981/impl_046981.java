...
@Data
public class Idea46981Config {
    private String name = "idea_046981";
 ...
 */
@Slf4j
public class Idea46981Service {
    private static final int IDEA_ID = 46981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46981Service() {
        this(new Idea46981Config());
    }

    public Idea46981Service(Idea46981Config config) {
        this.config = config != null ? config : new Idea46981Config();
