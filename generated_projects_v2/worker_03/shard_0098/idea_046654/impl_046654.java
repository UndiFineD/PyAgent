...
@Data
public class Idea46654Config {
    private String name = "idea_046654";
 ...
 */
@Slf4j
public class Idea46654Service {
    private static final int IDEA_ID = 46654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46654Service() {
        this(new Idea46654Config());
    }

    public Idea46654Service(Idea46654Config config) {
        this.config = config != null ? config : new Idea46654Config();
