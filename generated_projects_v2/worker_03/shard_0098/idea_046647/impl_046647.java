...
@Data
public class Idea46647Config {
    private String name = "idea_046647";
 ...
 */
@Slf4j
public class Idea46647Service {
    private static final int IDEA_ID = 46647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46647Service() {
        this(new Idea46647Config());
    }

    public Idea46647Service(Idea46647Config config) {
        this.config = config != null ? config : new Idea46647Config();
