...
@Data
public class Idea46908Config {
    private String name = "idea_046908";
 ...
 */
@Slf4j
public class Idea46908Service {
    private static final int IDEA_ID = 46908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46908Service() {
        this(new Idea46908Config());
    }

    public Idea46908Service(Idea46908Config config) {
        this.config = config != null ? config : new Idea46908Config();
