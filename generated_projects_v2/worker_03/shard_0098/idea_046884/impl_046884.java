...
@Data
public class Idea46884Config {
    private String name = "idea_046884";
 ...
 */
@Slf4j
public class Idea46884Service {
    private static final int IDEA_ID = 46884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46884Service() {
        this(new Idea46884Config());
    }

    public Idea46884Service(Idea46884Config config) {
        this.config = config != null ? config : new Idea46884Config();
