...
@Data
public class Idea46978Config {
    private String name = "idea_046978";
 ...
 */
@Slf4j
public class Idea46978Service {
    private static final int IDEA_ID = 46978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46978Service() {
        this(new Idea46978Config());
    }

    public Idea46978Service(Idea46978Config config) {
        this.config = config != null ? config : new Idea46978Config();
