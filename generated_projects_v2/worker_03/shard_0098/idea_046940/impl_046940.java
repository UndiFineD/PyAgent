...
@Data
public class Idea46940Config {
    private String name = "idea_046940";
 ...
 */
@Slf4j
public class Idea46940Service {
    private static final int IDEA_ID = 46940;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46940Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46940Service() {
        this(new Idea46940Config());
    }

    public Idea46940Service(Idea46940Config config) {
        this.config = config != null ? config : new Idea46940Config();
