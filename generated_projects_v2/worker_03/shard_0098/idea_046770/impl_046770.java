...
@Data
public class Idea46770Config {
    private String name = "idea_046770";
 ...
 */
@Slf4j
public class Idea46770Service {
    private static final int IDEA_ID = 46770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46770Service() {
        this(new Idea46770Config());
    }

    public Idea46770Service(Idea46770Config config) {
        this.config = config != null ? config : new Idea46770Config();
