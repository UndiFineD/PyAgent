...
@Data
public class Idea46604Config {
    private String name = "idea_046604";
 ...
 */
@Slf4j
public class Idea46604Service {
    private static final int IDEA_ID = 46604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46604Service() {
        this(new Idea46604Config());
    }

    public Idea46604Service(Idea46604Config config) {
        this.config = config != null ? config : new Idea46604Config();
