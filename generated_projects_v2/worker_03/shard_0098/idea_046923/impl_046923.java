...
@Data
public class Idea46923Config {
    private String name = "idea_046923";
 ...
 */
@Slf4j
public class Idea46923Service {
    private static final int IDEA_ID = 46923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46923Service() {
        this(new Idea46923Config());
    }

    public Idea46923Service(Idea46923Config config) {
        this.config = config != null ? config : new Idea46923Config();
