...
@Data
public class Idea46764Config {
    private String name = "idea_046764";
 ...
 */
@Slf4j
public class Idea46764Service {
    private static final int IDEA_ID = 46764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46764Service() {
        this(new Idea46764Config());
    }

    public Idea46764Service(Idea46764Config config) {
        this.config = config != null ? config : new Idea46764Config();
