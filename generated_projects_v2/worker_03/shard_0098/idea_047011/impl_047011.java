...
@Data
public class Idea47011Config {
    private String name = "idea_047011";
 ...
 */
@Slf4j
public class Idea47011Service {
    private static final int IDEA_ID = 47011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47011Service() {
        this(new Idea47011Config());
    }

    public Idea47011Service(Idea47011Config config) {
        this.config = config != null ? config : new Idea47011Config();
