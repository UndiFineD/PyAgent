...
@Data
public class Idea46809Config {
    private String name = "idea_046809";
 ...
 */
@Slf4j
public class Idea46809Service {
    private static final int IDEA_ID = 46809;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46809Service() {
        this(new Idea46809Config());
    }

    public Idea46809Service(Idea46809Config config) {
        this.config = config != null ? config : new Idea46809Config();
