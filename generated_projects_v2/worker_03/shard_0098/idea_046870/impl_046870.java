...
@Data
public class Idea46870Config {
    private String name = "idea_046870";
 ...
 */
@Slf4j
public class Idea46870Service {
    private static final int IDEA_ID = 46870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46870Service() {
        this(new Idea46870Config());
    }

    public Idea46870Service(Idea46870Config config) {
        this.config = config != null ? config : new Idea46870Config();
