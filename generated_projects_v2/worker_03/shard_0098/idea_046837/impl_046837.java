...
@Data
public class Idea46837Config {
    private String name = "idea_046837";
 ...
 */
@Slf4j
public class Idea46837Service {
    private static final int IDEA_ID = 46837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46837Service() {
        this(new Idea46837Config());
    }

    public Idea46837Service(Idea46837Config config) {
        this.config = config != null ? config : new Idea46837Config();
