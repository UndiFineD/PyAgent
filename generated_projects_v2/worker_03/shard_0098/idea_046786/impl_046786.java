...
@Data
public class Idea46786Config {
    private String name = "idea_046786";
 ...
 */
@Slf4j
public class Idea46786Service {
    private static final int IDEA_ID = 46786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46786Service() {
        this(new Idea46786Config());
    }

    public Idea46786Service(Idea46786Config config) {
        this.config = config != null ? config : new Idea46786Config();
