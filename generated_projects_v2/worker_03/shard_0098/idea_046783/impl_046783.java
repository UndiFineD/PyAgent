...
@Data
public class Idea46783Config {
    private String name = "idea_046783";
 ...
 */
@Slf4j
public class Idea46783Service {
    private static final int IDEA_ID = 46783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46783Service() {
        this(new Idea46783Config());
    }

    public Idea46783Service(Idea46783Config config) {
        this.config = config != null ? config : new Idea46783Config();
