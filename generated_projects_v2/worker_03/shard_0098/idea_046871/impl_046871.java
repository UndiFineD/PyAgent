...
@Data
public class Idea46871Config {
    private String name = "idea_046871";
 ...
 */
@Slf4j
public class Idea46871Service {
    private static final int IDEA_ID = 46871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46871Service() {
        this(new Idea46871Config());
    }

    public Idea46871Service(Idea46871Config config) {
        this.config = config != null ? config : new Idea46871Config();
