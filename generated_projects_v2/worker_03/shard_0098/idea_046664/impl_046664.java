...
@Data
public class Idea46664Config {
    private String name = "idea_046664";
 ...
 */
@Slf4j
public class Idea46664Service {
    private static final int IDEA_ID = 46664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46664Service() {
        this(new Idea46664Config());
    }

    public Idea46664Service(Idea46664Config config) {
        this.config = config != null ? config : new Idea46664Config();
