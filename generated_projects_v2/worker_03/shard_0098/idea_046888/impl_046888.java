...
@Data
public class Idea46888Config {
    private String name = "idea_046888";
 ...
 */
@Slf4j
public class Idea46888Service {
    private static final int IDEA_ID = 46888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46888Service() {
        this(new Idea46888Config());
    }

    public Idea46888Service(Idea46888Config config) {
        this.config = config != null ? config : new Idea46888Config();
