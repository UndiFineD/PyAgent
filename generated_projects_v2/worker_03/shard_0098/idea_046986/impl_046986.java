...
@Data
public class Idea46986Config {
    private String name = "idea_046986";
 ...
 */
@Slf4j
public class Idea46986Service {
    private static final int IDEA_ID = 46986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46986Service() {
        this(new Idea46986Config());
    }

    public Idea46986Service(Idea46986Config config) {
        this.config = config != null ? config : new Idea46986Config();
