...
@Data
public class Idea46643Config {
    private String name = "idea_046643";
 ...
 */
@Slf4j
public class Idea46643Service {
    private static final int IDEA_ID = 46643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46643Service() {
        this(new Idea46643Config());
    }

    public Idea46643Service(Idea46643Config config) {
        this.config = config != null ? config : new Idea46643Config();
