...
@Data
public class Idea46793Config {
    private String name = "idea_046793";
 ...
 */
@Slf4j
public class Idea46793Service {
    private static final int IDEA_ID = 46793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46793Service() {
        this(new Idea46793Config());
    }

    public Idea46793Service(Idea46793Config config) {
        this.config = config != null ? config : new Idea46793Config();
