...
@Data
public class Idea46622Config {
    private String name = "idea_046622";
 ...
 */
@Slf4j
public class Idea46622Service {
    private static final int IDEA_ID = 46622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46622Service() {
        this(new Idea46622Config());
    }

    public Idea46622Service(Idea46622Config config) {
        this.config = config != null ? config : new Idea46622Config();
