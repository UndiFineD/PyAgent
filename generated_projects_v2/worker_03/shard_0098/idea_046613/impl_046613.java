...
@Data
public class Idea46613Config {
    private String name = "idea_046613";
 ...
 */
@Slf4j
public class Idea46613Service {
    private static final int IDEA_ID = 46613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46613Service() {
        this(new Idea46613Config());
    }

    public Idea46613Service(Idea46613Config config) {
        this.config = config != null ? config : new Idea46613Config();
