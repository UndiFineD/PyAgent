...
@Data
public class Idea46586Config {
    private String name = "idea_046586";
 ...
 */
@Slf4j
public class Idea46586Service {
    private static final int IDEA_ID = 46586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46586Service() {
        this(new Idea46586Config());
    }

    public Idea46586Service(Idea46586Config config) {
        this.config = config != null ? config : new Idea46586Config();
