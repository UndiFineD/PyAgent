...
@Data
public class Idea46802Config {
    private String name = "idea_046802";
 ...
 */
@Slf4j
public class Idea46802Service {
    private static final int IDEA_ID = 46802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46802Service() {
        this(new Idea46802Config());
    }

    public Idea46802Service(Idea46802Config config) {
        this.config = config != null ? config : new Idea46802Config();
