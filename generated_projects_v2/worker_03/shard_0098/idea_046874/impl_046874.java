...
@Data
public class Idea46874Config {
    private String name = "idea_046874";
 ...
 */
@Slf4j
public class Idea46874Service {
    private static final int IDEA_ID = 46874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46874Service() {
        this(new Idea46874Config());
    }

    public Idea46874Service(Idea46874Config config) {
        this.config = config != null ? config : new Idea46874Config();
