...
@Data
public class Idea46916Config {
    private String name = "idea_046916";
 ...
 */
@Slf4j
public class Idea46916Service {
    private static final int IDEA_ID = 46916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46916Service() {
        this(new Idea46916Config());
    }

    public Idea46916Service(Idea46916Config config) {
        this.config = config != null ? config : new Idea46916Config();
