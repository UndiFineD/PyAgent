...
@Data
public class Idea46703Config {
    private String name = "idea_046703";
 ...
 */
@Slf4j
public class Idea46703Service {
    private static final int IDEA_ID = 46703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46703Service() {
        this(new Idea46703Config());
    }

    public Idea46703Service(Idea46703Config config) {
        this.config = config != null ? config : new Idea46703Config();
