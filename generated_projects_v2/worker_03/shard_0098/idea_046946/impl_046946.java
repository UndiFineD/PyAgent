...
@Data
public class Idea46946Config {
    private String name = "idea_046946";
 ...
 */
@Slf4j
public class Idea46946Service {
    private static final int IDEA_ID = 46946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46946Service() {
        this(new Idea46946Config());
    }

    public Idea46946Service(Idea46946Config config) {
        this.config = config != null ? config : new Idea46946Config();
