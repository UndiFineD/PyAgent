...
@Data
public class Idea46610Config {
    private String name = "idea_046610";
 ...
 */
@Slf4j
public class Idea46610Service {
    private static final int IDEA_ID = 46610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46610Service() {
        this(new Idea46610Config());
    }

    public Idea46610Service(Idea46610Config config) {
        this.config = config != null ? config : new Idea46610Config();
