...
@Data
public class Idea46603Config {
    private String name = "idea_046603";
 ...
 */
@Slf4j
public class Idea46603Service {
    private static final int IDEA_ID = 46603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46603Service() {
        this(new Idea46603Config());
    }

    public Idea46603Service(Idea46603Config config) {
        this.config = config != null ? config : new Idea46603Config();
