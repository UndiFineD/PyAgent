...
@Data
public class Idea46784Config {
    private String name = "idea_046784";
 ...
 */
@Slf4j
public class Idea46784Service {
    private static final int IDEA_ID = 46784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46784Service() {
        this(new Idea46784Config());
    }

    public Idea46784Service(Idea46784Config config) {
        this.config = config != null ? config : new Idea46784Config();
