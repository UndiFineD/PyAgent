...
@Data
public class Idea46960Config {
    private String name = "idea_046960";
 ...
 */
@Slf4j
public class Idea46960Service {
    private static final int IDEA_ID = 46960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46960Service() {
        this(new Idea46960Config());
    }

    public Idea46960Service(Idea46960Config config) {
        this.config = config != null ? config : new Idea46960Config();
