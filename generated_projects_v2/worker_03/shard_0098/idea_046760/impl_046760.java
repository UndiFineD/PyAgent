...
@Data
public class Idea46760Config {
    private String name = "idea_046760";
 ...
 */
@Slf4j
public class Idea46760Service {
    private static final int IDEA_ID = 46760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46760Service() {
        this(new Idea46760Config());
    }

    public Idea46760Service(Idea46760Config config) {
        this.config = config != null ? config : new Idea46760Config();
