...
@Data
public class Idea47002Config {
    private String name = "idea_047002";
 ...
 */
@Slf4j
public class Idea47002Service {
    private static final int IDEA_ID = 47002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47002Service() {
        this(new Idea47002Config());
    }

    public Idea47002Service(Idea47002Config config) {
        this.config = config != null ? config : new Idea47002Config();
