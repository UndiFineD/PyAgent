...
@Data
public class Idea46708Config {
    private String name = "idea_046708";
 ...
 */
@Slf4j
public class Idea46708Service {
    private static final int IDEA_ID = 46708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46708Service() {
        this(new Idea46708Config());
    }

    public Idea46708Service(Idea46708Config config) {
        this.config = config != null ? config : new Idea46708Config();
