...
@Data
public class Idea46922Config {
    private String name = "idea_046922";
 ...
 */
@Slf4j
public class Idea46922Service {
    private static final int IDEA_ID = 46922;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46922Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46922Service() {
        this(new Idea46922Config());
    }

    public Idea46922Service(Idea46922Config config) {
        this.config = config != null ? config : new Idea46922Config();
