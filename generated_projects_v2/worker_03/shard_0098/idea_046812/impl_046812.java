...
@Data
public class Idea46812Config {
    private String name = "idea_046812";
 ...
 */
@Slf4j
public class Idea46812Service {
    private static final int IDEA_ID = 46812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46812Service() {
        this(new Idea46812Config());
    }

    public Idea46812Service(Idea46812Config config) {
        this.config = config != null ? config : new Idea46812Config();
