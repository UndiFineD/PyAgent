...
@Data
public class Idea46739Config {
    private String name = "idea_046739";
 ...
 */
@Slf4j
public class Idea46739Service {
    private static final int IDEA_ID = 46739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46739Service() {
        this(new Idea46739Config());
    }

    public Idea46739Service(Idea46739Config config) {
        this.config = config != null ? config : new Idea46739Config();
