...
@Data
public class Idea46943Config {
    private String name = "idea_046943";
 ...
 */
@Slf4j
public class Idea46943Service {
    private static final int IDEA_ID = 46943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46943Service() {
        this(new Idea46943Config());
    }

    public Idea46943Service(Idea46943Config config) {
        this.config = config != null ? config : new Idea46943Config();
