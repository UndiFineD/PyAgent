...
@Data
public class Idea46553Config {
    private String name = "idea_046553";
 ...
 */
@Slf4j
public class Idea46553Service {
    private static final int IDEA_ID = 46553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46553Service() {
        this(new Idea46553Config());
    }

    public Idea46553Service(Idea46553Config config) {
        this.config = config != null ? config : new Idea46553Config();
