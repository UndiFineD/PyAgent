...
@Data
public class Idea46619Config {
    private String name = "idea_046619";
 ...
 */
@Slf4j
public class Idea46619Service {
    private static final int IDEA_ID = 46619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46619Service() {
        this(new Idea46619Config());
    }

    public Idea46619Service(Idea46619Config config) {
        this.config = config != null ? config : new Idea46619Config();
