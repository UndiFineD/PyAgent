...
@Data
public class Idea46773Config {
    private String name = "idea_046773";
 ...
 */
@Slf4j
public class Idea46773Service {
    private static final int IDEA_ID = 46773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46773Service() {
        this(new Idea46773Config());
    }

    public Idea46773Service(Idea46773Config config) {
        this.config = config != null ? config : new Idea46773Config();
