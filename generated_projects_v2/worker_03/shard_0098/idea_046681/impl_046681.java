...
@Data
public class Idea46681Config {
    private String name = "idea_046681";
 ...
 */
@Slf4j
public class Idea46681Service {
    private static final int IDEA_ID = 46681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46681Service() {
        this(new Idea46681Config());
    }

    public Idea46681Service(Idea46681Config config) {
        this.config = config != null ? config : new Idea46681Config();
