...
@Data
public class Idea46824Config {
    private String name = "idea_046824";
 ...
 */
@Slf4j
public class Idea46824Service {
    private static final int IDEA_ID = 46824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46824Service() {
        this(new Idea46824Config());
    }

    public Idea46824Service(Idea46824Config config) {
        this.config = config != null ? config : new Idea46824Config();
