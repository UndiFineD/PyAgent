...
@Data
public class Idea46935Config {
    private String name = "idea_046935";
 ...
 */
@Slf4j
public class Idea46935Service {
    private static final int IDEA_ID = 46935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46935Service() {
        this(new Idea46935Config());
    }

    public Idea46935Service(Idea46935Config config) {
        this.config = config != null ? config : new Idea46935Config();
