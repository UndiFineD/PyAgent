...
@Data
public class Idea46618Config {
    private String name = "idea_046618";
 ...
 */
@Slf4j
public class Idea46618Service {
    private static final int IDEA_ID = 46618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46618Service() {
        this(new Idea46618Config());
    }

    public Idea46618Service(Idea46618Config config) {
        this.config = config != null ? config : new Idea46618Config();
