...
@Data
public class Idea46751Config {
    private String name = "idea_046751";
 ...
 */
@Slf4j
public class Idea46751Service {
    private static final int IDEA_ID = 46751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46751Service() {
        this(new Idea46751Config());
    }

    public Idea46751Service(Idea46751Config config) {
        this.config = config != null ? config : new Idea46751Config();
