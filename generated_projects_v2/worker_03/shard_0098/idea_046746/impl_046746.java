...
@Data
public class Idea46746Config {
    private String name = "idea_046746";
 ...
 */
@Slf4j
public class Idea46746Service {
    private static final int IDEA_ID = 46746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46746Service() {
        this(new Idea46746Config());
    }

    public Idea46746Service(Idea46746Config config) {
        this.config = config != null ? config : new Idea46746Config();
