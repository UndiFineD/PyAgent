...
@Data
public class Idea46838Config {
    private String name = "idea_046838";
 ...
 */
@Slf4j
public class Idea46838Service {
    private static final int IDEA_ID = 46838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46838Service() {
        this(new Idea46838Config());
    }

    public Idea46838Service(Idea46838Config config) {
        this.config = config != null ? config : new Idea46838Config();
