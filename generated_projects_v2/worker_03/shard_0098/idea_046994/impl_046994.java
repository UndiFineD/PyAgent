...
@Data
public class Idea46994Config {
    private String name = "idea_046994";
 ...
 */
@Slf4j
public class Idea46994Service {
    private static final int IDEA_ID = 46994;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46994Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46994Service() {
        this(new Idea46994Config());
    }

    public Idea46994Service(Idea46994Config config) {
        this.config = config != null ? config : new Idea46994Config();
