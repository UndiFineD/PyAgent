...
@Data
public class Idea46833Config {
    private String name = "idea_046833";
 ...
 */
@Slf4j
public class Idea46833Service {
    private static final int IDEA_ID = 46833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46833Service() {
        this(new Idea46833Config());
    }

    public Idea46833Service(Idea46833Config config) {
        this.config = config != null ? config : new Idea46833Config();
