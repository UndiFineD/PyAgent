...
@Data
public class Idea46762Config {
    private String name = "idea_046762";
 ...
 */
@Slf4j
public class Idea46762Service {
    private static final int IDEA_ID = 46762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46762Service() {
        this(new Idea46762Config());
    }

    public Idea46762Service(Idea46762Config config) {
        this.config = config != null ? config : new Idea46762Config();
