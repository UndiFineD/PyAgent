...
@Data
public class Idea46589Config {
    private String name = "idea_046589";
 ...
 */
@Slf4j
public class Idea46589Service {
    private static final int IDEA_ID = 46589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46589Service() {
        this(new Idea46589Config());
    }

    public Idea46589Service(Idea46589Config config) {
        this.config = config != null ? config : new Idea46589Config();
