...
@Data
public class Idea46952Config {
    private String name = "idea_046952";
 ...
 */
@Slf4j
public class Idea46952Service {
    private static final int IDEA_ID = 46952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46952Service() {
        this(new Idea46952Config());
    }

    public Idea46952Service(Idea46952Config config) {
        this.config = config != null ? config : new Idea46952Config();
