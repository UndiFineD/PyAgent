...
@Data
public class Idea46707Config {
    private String name = "idea_046707";
 ...
 */
@Slf4j
public class Idea46707Service {
    private static final int IDEA_ID = 46707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46707Service() {
        this(new Idea46707Config());
    }

    public Idea46707Service(Idea46707Config config) {
        this.config = config != null ? config : new Idea46707Config();
