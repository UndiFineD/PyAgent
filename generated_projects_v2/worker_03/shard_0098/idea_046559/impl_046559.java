...
@Data
public class Idea46559Config {
    private String name = "idea_046559";
 ...
 */
@Slf4j
public class Idea46559Service {
    private static final int IDEA_ID = 46559;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46559Service() {
        this(new Idea46559Config());
    }

    public Idea46559Service(Idea46559Config config) {
        this.config = config != null ? config : new Idea46559Config();
