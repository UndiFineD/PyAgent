...
@Data
public class Idea46635Config {
    private String name = "idea_046635";
 ...
 */
@Slf4j
public class Idea46635Service {
    private static final int IDEA_ID = 46635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46635Service() {
        this(new Idea46635Config());
    }

    public Idea46635Service(Idea46635Config config) {
        this.config = config != null ? config : new Idea46635Config();
