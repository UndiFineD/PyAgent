...
@Data
public class Idea46939Config {
    private String name = "idea_046939";
 ...
 */
@Slf4j
public class Idea46939Service {
    private static final int IDEA_ID = 46939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46939Service() {
        this(new Idea46939Config());
    }

    public Idea46939Service(Idea46939Config config) {
        this.config = config != null ? config : new Idea46939Config();
