...
@Data
public class Idea46555Config {
    private String name = "idea_046555";
 ...
 */
@Slf4j
public class Idea46555Service {
    private static final int IDEA_ID = 46555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46555Service() {
        this(new Idea46555Config());
    }

    public Idea46555Service(Idea46555Config config) {
        this.config = config != null ? config : new Idea46555Config();
