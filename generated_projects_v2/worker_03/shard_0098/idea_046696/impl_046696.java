...
@Data
public class Idea46696Config {
    private String name = "idea_046696";
 ...
 */
@Slf4j
public class Idea46696Service {
    private static final int IDEA_ID = 46696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46696Service() {
        this(new Idea46696Config());
    }

    public Idea46696Service(Idea46696Config config) {
        this.config = config != null ? config : new Idea46696Config();
