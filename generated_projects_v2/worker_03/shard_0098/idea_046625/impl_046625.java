...
@Data
public class Idea46625Config {
    private String name = "idea_046625";
 ...
 */
@Slf4j
public class Idea46625Service {
    private static final int IDEA_ID = 46625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46625Service() {
        this(new Idea46625Config());
    }

    public Idea46625Service(Idea46625Config config) {
        this.config = config != null ? config : new Idea46625Config();
