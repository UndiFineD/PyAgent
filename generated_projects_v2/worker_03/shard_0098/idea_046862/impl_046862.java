...
@Data
public class Idea46862Config {
    private String name = "idea_046862";
 ...
 */
@Slf4j
public class Idea46862Service {
    private static final int IDEA_ID = 46862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46862Service() {
        this(new Idea46862Config());
    }

    public Idea46862Service(Idea46862Config config) {
        this.config = config != null ? config : new Idea46862Config();
