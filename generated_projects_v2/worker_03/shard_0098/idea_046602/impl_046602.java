...
@Data
public class Idea46602Config {
    private String name = "idea_046602";
 ...
 */
@Slf4j
public class Idea46602Service {
    private static final int IDEA_ID = 46602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46602Service() {
        this(new Idea46602Config());
    }

    public Idea46602Service(Idea46602Config config) {
        this.config = config != null ? config : new Idea46602Config();
