...
@Data
public class Idea46627Config {
    private String name = "idea_046627";
 ...
 */
@Slf4j
public class Idea46627Service {
    private static final int IDEA_ID = 46627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46627Service() {
        this(new Idea46627Config());
    }

    public Idea46627Service(Idea46627Config config) {
        this.config = config != null ? config : new Idea46627Config();
