...
@Data
public class Idea47017Config {
    private String name = "idea_047017";
 ...
 */
@Slf4j
public class Idea47017Service {
    private static final int IDEA_ID = 47017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47017Service() {
        this(new Idea47017Config());
    }

    public Idea47017Service(Idea47017Config config) {
        this.config = config != null ? config : new Idea47017Config();
