...
@Data
public class Idea46864Config {
    private String name = "idea_046864";
 ...
 */
@Slf4j
public class Idea46864Service {
    private static final int IDEA_ID = 46864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46864Service() {
        this(new Idea46864Config());
    }

    public Idea46864Service(Idea46864Config config) {
        this.config = config != null ? config : new Idea46864Config();
