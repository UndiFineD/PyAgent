...
@Data
public class Idea46815Config {
    private String name = "idea_046815";
 ...
 */
@Slf4j
public class Idea46815Service {
    private static final int IDEA_ID = 46815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46815Service() {
        this(new Idea46815Config());
    }

    public Idea46815Service(Idea46815Config config) {
        this.config = config != null ? config : new Idea46815Config();
