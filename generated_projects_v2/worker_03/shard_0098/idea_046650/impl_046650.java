...
@Data
public class Idea46650Config {
    private String name = "idea_046650";
 ...
 */
@Slf4j
public class Idea46650Service {
    private static final int IDEA_ID = 46650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46650Service() {
        this(new Idea46650Config());
    }

    public Idea46650Service(Idea46650Config config) {
        this.config = config != null ? config : new Idea46650Config();
