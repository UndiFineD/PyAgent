...
@Data
public class Idea47006Config {
    private String name = "idea_047006";
 ...
 */
@Slf4j
public class Idea47006Service {
    private static final int IDEA_ID = 47006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47006Service() {
        this(new Idea47006Config());
    }

    public Idea47006Service(Idea47006Config config) {
        this.config = config != null ? config : new Idea47006Config();
