...
@Data
public class Idea46662Config {
    private String name = "idea_046662";
 ...
 */
@Slf4j
public class Idea46662Service {
    private static final int IDEA_ID = 46662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46662Service() {
        this(new Idea46662Config());
    }

    public Idea46662Service(Idea46662Config config) {
        this.config = config != null ? config : new Idea46662Config();
