...
@Data
public class Idea46902Config {
    private String name = "idea_046902";
 ...
 */
@Slf4j
public class Idea46902Service {
    private static final int IDEA_ID = 46902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46902Service() {
        this(new Idea46902Config());
    }

    public Idea46902Service(Idea46902Config config) {
        this.config = config != null ? config : new Idea46902Config();
