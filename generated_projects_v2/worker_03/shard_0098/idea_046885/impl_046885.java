...
@Data
public class Idea46885Config {
    private String name = "idea_046885";
 ...
 */
@Slf4j
public class Idea46885Service {
    private static final int IDEA_ID = 46885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46885Service() {
        this(new Idea46885Config());
    }

    public Idea46885Service(Idea46885Config config) {
        this.config = config != null ? config : new Idea46885Config();
