...
@Data
public class Idea46887Config {
    private String name = "idea_046887";
 ...
 */
@Slf4j
public class Idea46887Service {
    private static final int IDEA_ID = 46887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46887Service() {
        this(new Idea46887Config());
    }

    public Idea46887Service(Idea46887Config config) {
        this.config = config != null ? config : new Idea46887Config();
