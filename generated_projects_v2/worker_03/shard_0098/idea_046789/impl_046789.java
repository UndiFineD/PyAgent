...
@Data
public class Idea46789Config {
    private String name = "idea_046789";
 ...
 */
@Slf4j
public class Idea46789Service {
    private static final int IDEA_ID = 46789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46789Service() {
        this(new Idea46789Config());
    }

    public Idea46789Service(Idea46789Config config) {
        this.config = config != null ? config : new Idea46789Config();
