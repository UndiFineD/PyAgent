...
@Data
public class Idea46875Config {
    private String name = "idea_046875";
 ...
 */
@Slf4j
public class Idea46875Service {
    private static final int IDEA_ID = 46875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46875Service() {
        this(new Idea46875Config());
    }

    public Idea46875Service(Idea46875Config config) {
        this.config = config != null ? config : new Idea46875Config();
