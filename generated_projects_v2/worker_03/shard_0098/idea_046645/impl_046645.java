...
@Data
public class Idea46645Config {
    private String name = "idea_046645";
 ...
 */
@Slf4j
public class Idea46645Service {
    private static final int IDEA_ID = 46645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46645Service() {
        this(new Idea46645Config());
    }

    public Idea46645Service(Idea46645Config config) {
        this.config = config != null ? config : new Idea46645Config();
