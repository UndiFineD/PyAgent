...
@Data
public class Idea46757Config {
    private String name = "idea_046757";
 ...
 */
@Slf4j
public class Idea46757Service {
    private static final int IDEA_ID = 46757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46757Service() {
        this(new Idea46757Config());
    }

    public Idea46757Service(Idea46757Config config) {
        this.config = config != null ? config : new Idea46757Config();
