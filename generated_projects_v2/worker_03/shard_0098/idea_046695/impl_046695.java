...
@Data
public class Idea46695Config {
    private String name = "idea_046695";
 ...
 */
@Slf4j
public class Idea46695Service {
    private static final int IDEA_ID = 46695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46695Service() {
        this(new Idea46695Config());
    }

    public Idea46695Service(Idea46695Config config) {
        this.config = config != null ? config : new Idea46695Config();
