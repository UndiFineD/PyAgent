...
@Data
public class Idea46711Config {
    private String name = "idea_046711";
 ...
 */
@Slf4j
public class Idea46711Service {
    private static final int IDEA_ID = 46711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46711Service() {
        this(new Idea46711Config());
    }

    public Idea46711Service(Idea46711Config config) {
        this.config = config != null ? config : new Idea46711Config();
