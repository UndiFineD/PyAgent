...
@Data
public class Idea46984Config {
    private String name = "idea_046984";
 ...
 */
@Slf4j
public class Idea46984Service {
    private static final int IDEA_ID = 46984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46984Service() {
        this(new Idea46984Config());
    }

    public Idea46984Service(Idea46984Config config) {
        this.config = config != null ? config : new Idea46984Config();
