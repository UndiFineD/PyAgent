...
@Data
public class Idea46925Config {
    private String name = "idea_046925";
 ...
 */
@Slf4j
public class Idea46925Service {
    private static final int IDEA_ID = 46925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46925Service() {
        this(new Idea46925Config());
    }

    public Idea46925Service(Idea46925Config config) {
        this.config = config != null ? config : new Idea46925Config();
