...
@Data
public class Idea46949Config {
    private String name = "idea_046949";
 ...
 */
@Slf4j
public class Idea46949Service {
    private static final int IDEA_ID = 46949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46949Service() {
        this(new Idea46949Config());
    }

    public Idea46949Service(Idea46949Config config) {
        this.config = config != null ? config : new Idea46949Config();
