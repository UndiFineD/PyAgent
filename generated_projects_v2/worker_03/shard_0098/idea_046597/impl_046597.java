...
@Data
public class Idea46597Config {
    private String name = "idea_046597";
 ...
 */
@Slf4j
public class Idea46597Service {
    private static final int IDEA_ID = 46597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46597Service() {
        this(new Idea46597Config());
    }

    public Idea46597Service(Idea46597Config config) {
        this.config = config != null ? config : new Idea46597Config();
