...
@Data
public class Idea46944Config {
    private String name = "idea_046944";
 ...
 */
@Slf4j
public class Idea46944Service {
    private static final int IDEA_ID = 46944;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46944Service() {
        this(new Idea46944Config());
    }

    public Idea46944Service(Idea46944Config config) {
        this.config = config != null ? config : new Idea46944Config();
