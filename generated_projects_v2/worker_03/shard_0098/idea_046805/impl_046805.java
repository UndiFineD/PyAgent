...
@Data
public class Idea46805Config {
    private String name = "idea_046805";
 ...
 */
@Slf4j
public class Idea46805Service {
    private static final int IDEA_ID = 46805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46805Service() {
        this(new Idea46805Config());
    }

    public Idea46805Service(Idea46805Config config) {
        this.config = config != null ? config : new Idea46805Config();
