...
@Data
public class Idea46724Config {
    private String name = "idea_046724";
 ...
 */
@Slf4j
public class Idea46724Service {
    private static final int IDEA_ID = 46724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46724Service() {
        this(new Idea46724Config());
    }

    public Idea46724Service(Idea46724Config config) {
        this.config = config != null ? config : new Idea46724Config();
