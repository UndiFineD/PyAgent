...
@Data
public class Idea46566Config {
    private String name = "idea_046566";
 ...
 */
@Slf4j
public class Idea46566Service {
    private static final int IDEA_ID = 46566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46566Service() {
        this(new Idea46566Config());
    }

    public Idea46566Service(Idea46566Config config) {
        this.config = config != null ? config : new Idea46566Config();
