...
@Data
public class Idea46590Config {
    private String name = "idea_046590";
 ...
 */
@Slf4j
public class Idea46590Service {
    private static final int IDEA_ID = 46590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46590Service() {
        this(new Idea46590Config());
    }

    public Idea46590Service(Idea46590Config config) {
        this.config = config != null ? config : new Idea46590Config();
