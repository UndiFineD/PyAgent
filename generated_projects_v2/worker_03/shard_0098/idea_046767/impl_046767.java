...
@Data
public class Idea46767Config {
    private String name = "idea_046767";
 ...
 */
@Slf4j
public class Idea46767Service {
    private static final int IDEA_ID = 46767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46767Service() {
        this(new Idea46767Config());
    }

    public Idea46767Service(Idea46767Config config) {
        this.config = config != null ? config : new Idea46767Config();
