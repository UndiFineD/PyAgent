...
@Data
public class Idea46993Config {
    private String name = "idea_046993";
 ...
 */
@Slf4j
public class Idea46993Service {
    private static final int IDEA_ID = 46993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46993Service() {
        this(new Idea46993Config());
    }

    public Idea46993Service(Idea46993Config config) {
        this.config = config != null ? config : new Idea46993Config();
