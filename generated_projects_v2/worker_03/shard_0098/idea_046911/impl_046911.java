...
@Data
public class Idea46911Config {
    private String name = "idea_046911";
 ...
 */
@Slf4j
public class Idea46911Service {
    private static final int IDEA_ID = 46911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46911Service() {
        this(new Idea46911Config());
    }

    public Idea46911Service(Idea46911Config config) {
        this.config = config != null ? config : new Idea46911Config();
