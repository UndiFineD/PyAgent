...
@Data
public class Idea46890Config {
    private String name = "idea_046890";
 ...
 */
@Slf4j
public class Idea46890Service {
    private static final int IDEA_ID = 46890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46890Service() {
        this(new Idea46890Config());
    }

    public Idea46890Service(Idea46890Config config) {
        this.config = config != null ? config : new Idea46890Config();
