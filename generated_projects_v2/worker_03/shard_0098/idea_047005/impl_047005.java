...
@Data
public class Idea47005Config {
    private String name = "idea_047005";
 ...
 */
@Slf4j
public class Idea47005Service {
    private static final int IDEA_ID = 47005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47005Service() {
        this(new Idea47005Config());
    }

    public Idea47005Service(Idea47005Config config) {
        this.config = config != null ? config : new Idea47005Config();
