...
@Data
public class Idea46761Config {
    private String name = "idea_046761";
 ...
 */
@Slf4j
public class Idea46761Service {
    private static final int IDEA_ID = 46761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46761Service() {
        this(new Idea46761Config());
    }

    public Idea46761Service(Idea46761Config config) {
        this.config = config != null ? config : new Idea46761Config();
