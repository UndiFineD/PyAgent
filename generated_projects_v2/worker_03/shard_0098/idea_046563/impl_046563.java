...
@Data
public class Idea46563Config {
    private String name = "idea_046563";
 ...
 */
@Slf4j
public class Idea46563Service {
    private static final int IDEA_ID = 46563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46563Service() {
        this(new Idea46563Config());
    }

    public Idea46563Service(Idea46563Config config) {
        this.config = config != null ? config : new Idea46563Config();
