...
@Data
public class Idea46611Config {
    private String name = "idea_046611";
 ...
 */
@Slf4j
public class Idea46611Service {
    private static final int IDEA_ID = 46611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46611Service() {
        this(new Idea46611Config());
    }

    public Idea46611Service(Idea46611Config config) {
        this.config = config != null ? config : new Idea46611Config();
