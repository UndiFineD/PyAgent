...
@Data
public class Idea46626Config {
    private String name = "idea_046626";
 ...
 */
@Slf4j
public class Idea46626Service {
    private static final int IDEA_ID = 46626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46626Service() {
        this(new Idea46626Config());
    }

    public Idea46626Service(Idea46626Config config) {
        this.config = config != null ? config : new Idea46626Config();
