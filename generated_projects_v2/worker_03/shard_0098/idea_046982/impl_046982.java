...
@Data
public class Idea46982Config {
    private String name = "idea_046982";
 ...
 */
@Slf4j
public class Idea46982Service {
    private static final int IDEA_ID = 46982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46982Service() {
        this(new Idea46982Config());
    }

    public Idea46982Service(Idea46982Config config) {
        this.config = config != null ? config : new Idea46982Config();
