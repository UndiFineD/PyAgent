...
@Data
public class Idea46860Config {
    private String name = "idea_046860";
 ...
 */
@Slf4j
public class Idea46860Service {
    private static final int IDEA_ID = 46860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46860Service() {
        this(new Idea46860Config());
    }

    public Idea46860Service(Idea46860Config config) {
        this.config = config != null ? config : new Idea46860Config();
