...
@Data
public class Idea46829Config {
    private String name = "idea_046829";
 ...
 */
@Slf4j
public class Idea46829Service {
    private static final int IDEA_ID = 46829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46829Service() {
        this(new Idea46829Config());
    }

    public Idea46829Service(Idea46829Config config) {
        this.config = config != null ? config : new Idea46829Config();
