...
@Data
public class Idea46644Config {
    private String name = "idea_046644";
 ...
 */
@Slf4j
public class Idea46644Service {
    private static final int IDEA_ID = 46644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46644Service() {
        this(new Idea46644Config());
    }

    public Idea46644Service(Idea46644Config config) {
        this.config = config != null ? config : new Idea46644Config();
