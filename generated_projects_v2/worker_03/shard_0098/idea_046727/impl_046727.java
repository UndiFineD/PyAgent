...
@Data
public class Idea46727Config {
    private String name = "idea_046727";
 ...
 */
@Slf4j
public class Idea46727Service {
    private static final int IDEA_ID = 46727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46727Service() {
        this(new Idea46727Config());
    }

    public Idea46727Service(Idea46727Config config) {
        this.config = config != null ? config : new Idea46727Config();
