...
@Data
public class Idea46915Config {
    private String name = "idea_046915";
 ...
 */
@Slf4j
public class Idea46915Service {
    private static final int IDEA_ID = 46915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46915Service() {
        this(new Idea46915Config());
    }

    public Idea46915Service(Idea46915Config config) {
        this.config = config != null ? config : new Idea46915Config();
