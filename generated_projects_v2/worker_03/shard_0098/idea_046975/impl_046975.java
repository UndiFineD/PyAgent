...
@Data
public class Idea46975Config {
    private String name = "idea_046975";
 ...
 */
@Slf4j
public class Idea46975Service {
    private static final int IDEA_ID = 46975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46975Service() {
        this(new Idea46975Config());
    }

    public Idea46975Service(Idea46975Config config) {
        this.config = config != null ? config : new Idea46975Config();
