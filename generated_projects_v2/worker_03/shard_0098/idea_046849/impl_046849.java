...
@Data
public class Idea46849Config {
    private String name = "idea_046849";
 ...
 */
@Slf4j
public class Idea46849Service {
    private static final int IDEA_ID = 46849;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46849Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46849Service() {
        this(new Idea46849Config());
    }

    public Idea46849Service(Idea46849Config config) {
        this.config = config != null ? config : new Idea46849Config();
