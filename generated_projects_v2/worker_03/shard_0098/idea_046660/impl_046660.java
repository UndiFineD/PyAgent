...
@Data
public class Idea46660Config {
    private String name = "idea_046660";
 ...
 */
@Slf4j
public class Idea46660Service {
    private static final int IDEA_ID = 46660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46660Service() {
        this(new Idea46660Config());
    }

    public Idea46660Service(Idea46660Config config) {
        this.config = config != null ? config : new Idea46660Config();
