...
@Data
public class Idea46672Config {
    private String name = "idea_046672";
 ...
 */
@Slf4j
public class Idea46672Service {
    private static final int IDEA_ID = 46672;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46672Service() {
        this(new Idea46672Config());
    }

    public Idea46672Service(Idea46672Config config) {
        this.config = config != null ? config : new Idea46672Config();
