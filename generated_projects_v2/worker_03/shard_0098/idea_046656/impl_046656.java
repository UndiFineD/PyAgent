...
@Data
public class Idea46656Config {
    private String name = "idea_046656";
 ...
 */
@Slf4j
public class Idea46656Service {
    private static final int IDEA_ID = 46656;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46656Service() {
        this(new Idea46656Config());
    }

    public Idea46656Service(Idea46656Config config) {
        this.config = config != null ? config : new Idea46656Config();
