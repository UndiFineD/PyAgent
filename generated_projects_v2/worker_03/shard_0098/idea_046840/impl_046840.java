...
@Data
public class Idea46840Config {
    private String name = "idea_046840";
 ...
 */
@Slf4j
public class Idea46840Service {
    private static final int IDEA_ID = 46840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46840Service() {
        this(new Idea46840Config());
    }

    public Idea46840Service(Idea46840Config config) {
        this.config = config != null ? config : new Idea46840Config();
