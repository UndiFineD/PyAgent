...
@Data
public class Idea46750Config {
    private String name = "idea_046750";
 ...
 */
@Slf4j
public class Idea46750Service {
    private static final int IDEA_ID = 46750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46750Service() {
        this(new Idea46750Config());
    }

    public Idea46750Service(Idea46750Config config) {
        this.config = config != null ? config : new Idea46750Config();
