...
@Data
public class Idea46971Config {
    private String name = "idea_046971";
 ...
 */
@Slf4j
public class Idea46971Service {
    private static final int IDEA_ID = 46971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46971Service() {
        this(new Idea46971Config());
    }

    public Idea46971Service(Idea46971Config config) {
        this.config = config != null ? config : new Idea46971Config();
