...
@Data
public class Idea46966Config {
    private String name = "idea_046966";
 ...
 */
@Slf4j
public class Idea46966Service {
    private static final int IDEA_ID = 46966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46966Service() {
        this(new Idea46966Config());
    }

    public Idea46966Service(Idea46966Config config) {
        this.config = config != null ? config : new Idea46966Config();
