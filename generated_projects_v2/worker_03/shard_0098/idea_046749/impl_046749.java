...
@Data
public class Idea46749Config {
    private String name = "idea_046749";
 ...
 */
@Slf4j
public class Idea46749Service {
    private static final int IDEA_ID = 46749;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46749Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46749Service() {
        this(new Idea46749Config());
    }

    public Idea46749Service(Idea46749Config config) {
        this.config = config != null ? config : new Idea46749Config();
