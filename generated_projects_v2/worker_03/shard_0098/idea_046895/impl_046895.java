...
@Data
public class Idea46895Config {
    private String name = "idea_046895";
 ...
 */
@Slf4j
public class Idea46895Service {
    private static final int IDEA_ID = 46895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46895Service() {
        this(new Idea46895Config());
    }

    public Idea46895Service(Idea46895Config config) {
        this.config = config != null ? config : new Idea46895Config();
