...
@Data
public class Idea46848Config {
    private String name = "idea_046848";
 ...
 */
@Slf4j
public class Idea46848Service {
    private static final int IDEA_ID = 46848;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46848Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46848Service() {
        this(new Idea46848Config());
    }

    public Idea46848Service(Idea46848Config config) {
        this.config = config != null ? config : new Idea46848Config();
