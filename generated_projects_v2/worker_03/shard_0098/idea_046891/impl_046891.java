...
@Data
public class Idea46891Config {
    private String name = "idea_046891";
 ...
 */
@Slf4j
public class Idea46891Service {
    private static final int IDEA_ID = 46891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46891Service() {
        this(new Idea46891Config());
    }

    public Idea46891Service(Idea46891Config config) {
        this.config = config != null ? config : new Idea46891Config();
