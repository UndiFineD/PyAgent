...
@Data
public class Idea46961Config {
    private String name = "idea_046961";
 ...
 */
@Slf4j
public class Idea46961Service {
    private static final int IDEA_ID = 46961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46961Service() {
        this(new Idea46961Config());
    }

    public Idea46961Service(Idea46961Config config) {
        this.config = config != null ? config : new Idea46961Config();
