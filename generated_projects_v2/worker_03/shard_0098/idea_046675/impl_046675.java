...
@Data
public class Idea46675Config {
    private String name = "idea_046675";
 ...
 */
@Slf4j
public class Idea46675Service {
    private static final int IDEA_ID = 46675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46675Service() {
        this(new Idea46675Config());
    }

    public Idea46675Service(Idea46675Config config) {
        this.config = config != null ? config : new Idea46675Config();
