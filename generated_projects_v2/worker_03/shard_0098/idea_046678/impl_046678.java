...
@Data
public class Idea46678Config {
    private String name = "idea_046678";
 ...
 */
@Slf4j
public class Idea46678Service {
    private static final int IDEA_ID = 46678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46678Service() {
        this(new Idea46678Config());
    }

    public Idea46678Service(Idea46678Config config) {
        this.config = config != null ? config : new Idea46678Config();
