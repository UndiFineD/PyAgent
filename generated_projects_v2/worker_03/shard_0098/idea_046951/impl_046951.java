...
@Data
public class Idea46951Config {
    private String name = "idea_046951";
 ...
 */
@Slf4j
public class Idea46951Service {
    private static final int IDEA_ID = 46951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46951Service() {
        this(new Idea46951Config());
    }

    public Idea46951Service(Idea46951Config config) {
        this.config = config != null ? config : new Idea46951Config();
