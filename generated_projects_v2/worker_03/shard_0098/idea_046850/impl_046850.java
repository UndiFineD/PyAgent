...
@Data
public class Idea46850Config {
    private String name = "idea_046850";
 ...
 */
@Slf4j
public class Idea46850Service {
    private static final int IDEA_ID = 46850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46850Service() {
        this(new Idea46850Config());
    }

    public Idea46850Service(Idea46850Config config) {
        this.config = config != null ? config : new Idea46850Config();
