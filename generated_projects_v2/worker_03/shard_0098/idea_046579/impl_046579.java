...
@Data
public class Idea46579Config {
    private String name = "idea_046579";
 ...
 */
@Slf4j
public class Idea46579Service {
    private static final int IDEA_ID = 46579;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46579Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46579Service() {
        this(new Idea46579Config());
    }

    public Idea46579Service(Idea46579Config config) {
        this.config = config != null ? config : new Idea46579Config();
