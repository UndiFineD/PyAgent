...
@Data
public class Idea46823Config {
    private String name = "idea_046823";
 ...
 */
@Slf4j
public class Idea46823Service {
    private static final int IDEA_ID = 46823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46823Service() {
        this(new Idea46823Config());
    }

    public Idea46823Service(Idea46823Config config) {
        this.config = config != null ? config : new Idea46823Config();
