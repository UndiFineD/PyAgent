...
@Data
public class Idea46720Config {
    private String name = "idea_046720";
 ...
 */
@Slf4j
public class Idea46720Service {
    private static final int IDEA_ID = 46720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46720Service() {
        this(new Idea46720Config());
    }

    public Idea46720Service(Idea46720Config config) {
        this.config = config != null ? config : new Idea46720Config();
