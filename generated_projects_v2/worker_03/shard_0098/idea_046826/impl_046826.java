...
@Data
public class Idea46826Config {
    private String name = "idea_046826";
 ...
 */
@Slf4j
public class Idea46826Service {
    private static final int IDEA_ID = 46826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46826Service() {
        this(new Idea46826Config());
    }

    public Idea46826Service(Idea46826Config config) {
        this.config = config != null ? config : new Idea46826Config();
