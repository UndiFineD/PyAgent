...
@Data
public class Idea46882Config {
    private String name = "idea_046882";
 ...
 */
@Slf4j
public class Idea46882Service {
    private static final int IDEA_ID = 46882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46882Service() {
        this(new Idea46882Config());
    }

    public Idea46882Service(Idea46882Config config) {
        this.config = config != null ? config : new Idea46882Config();
