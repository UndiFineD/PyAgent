...
@Data
public class Idea46599Config {
    private String name = "idea_046599";
 ...
 */
@Slf4j
public class Idea46599Service {
    private static final int IDEA_ID = 46599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46599Service() {
        this(new Idea46599Config());
    }

    public Idea46599Service(Idea46599Config config) {
        this.config = config != null ? config : new Idea46599Config();
