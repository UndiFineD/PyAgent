...
@Data
public class Idea46709Config {
    private String name = "idea_046709";
 ...
 */
@Slf4j
public class Idea46709Service {
    private static final int IDEA_ID = 46709;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46709Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46709Service() {
        this(new Idea46709Config());
    }

    public Idea46709Service(Idea46709Config config) {
        this.config = config != null ? config : new Idea46709Config();
