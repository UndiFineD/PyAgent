...
@Data
public class Idea46733Config {
    private String name = "idea_046733";
 ...
 */
@Slf4j
public class Idea46733Service {
    private static final int IDEA_ID = 46733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46733Service() {
        this(new Idea46733Config());
    }

    public Idea46733Service(Idea46733Config config) {
        this.config = config != null ? config : new Idea46733Config();
