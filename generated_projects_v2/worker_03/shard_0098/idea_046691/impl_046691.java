...
@Data
public class Idea46691Config {
    private String name = "idea_046691";
 ...
 */
@Slf4j
public class Idea46691Service {
    private static final int IDEA_ID = 46691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46691Service() {
        this(new Idea46691Config());
    }

    public Idea46691Service(Idea46691Config config) {
        this.config = config != null ? config : new Idea46691Config();
