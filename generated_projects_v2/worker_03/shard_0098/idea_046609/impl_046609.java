...
@Data
public class Idea46609Config {
    private String name = "idea_046609";
 ...
 */
@Slf4j
public class Idea46609Service {
    private static final int IDEA_ID = 46609;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46609Service() {
        this(new Idea46609Config());
    }

    public Idea46609Service(Idea46609Config config) {
        this.config = config != null ? config : new Idea46609Config();
