...
@Data
public class Idea46896Config {
    private String name = "idea_046896";
 ...
 */
@Slf4j
public class Idea46896Service {
    private static final int IDEA_ID = 46896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46896Service() {
        this(new Idea46896Config());
    }

    public Idea46896Service(Idea46896Config config) {
        this.config = config != null ? config : new Idea46896Config();
