...
@Data
public class Idea46913Config {
    private String name = "idea_046913";
 ...
 */
@Slf4j
public class Idea46913Service {
    private static final int IDEA_ID = 46913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46913Service() {
        this(new Idea46913Config());
    }

    public Idea46913Service(Idea46913Config config) {
        this.config = config != null ? config : new Idea46913Config();
