...
@Data
public class Idea46937Config {
    private String name = "idea_046937";
 ...
 */
@Slf4j
public class Idea46937Service {
    private static final int IDEA_ID = 46937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46937Service() {
        this(new Idea46937Config());
    }

    public Idea46937Service(Idea46937Config config) {
        this.config = config != null ? config : new Idea46937Config();
