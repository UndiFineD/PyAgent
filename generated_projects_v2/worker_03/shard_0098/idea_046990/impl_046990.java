...
@Data
public class Idea46990Config {
    private String name = "idea_046990";
 ...
 */
@Slf4j
public class Idea46990Service {
    private static final int IDEA_ID = 46990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46990Service() {
        this(new Idea46990Config());
    }

    public Idea46990Service(Idea46990Config config) {
        this.config = config != null ? config : new Idea46990Config();
