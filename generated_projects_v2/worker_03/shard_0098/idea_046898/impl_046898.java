...
@Data
public class Idea46898Config {
    private String name = "idea_046898";
 ...
 */
@Slf4j
public class Idea46898Service {
    private static final int IDEA_ID = 46898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46898Service() {
        this(new Idea46898Config());
    }

    public Idea46898Service(Idea46898Config config) {
        this.config = config != null ? config : new Idea46898Config();
