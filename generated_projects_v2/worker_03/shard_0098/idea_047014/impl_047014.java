...
@Data
public class Idea47014Config {
    private String name = "idea_047014";
 ...
 */
@Slf4j
public class Idea47014Service {
    private static final int IDEA_ID = 47014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47014Service() {
        this(new Idea47014Config());
    }

    public Idea47014Service(Idea47014Config config) {
        this.config = config != null ? config : new Idea47014Config();
