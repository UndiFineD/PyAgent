...
@Data
public class Idea46747Config {
    private String name = "idea_046747";
 ...
 */
@Slf4j
public class Idea46747Service {
    private static final int IDEA_ID = 46747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46747Service() {
        this(new Idea46747Config());
    }

    public Idea46747Service(Idea46747Config config) {
        this.config = config != null ? config : new Idea46747Config();
