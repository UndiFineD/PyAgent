...
@Data
public class Idea46562Config {
    private String name = "idea_046562";
 ...
 */
@Slf4j
public class Idea46562Service {
    private static final int IDEA_ID = 46562;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46562Service() {
        this(new Idea46562Config());
    }

    public Idea46562Service(Idea46562Config config) {
        this.config = config != null ? config : new Idea46562Config();
