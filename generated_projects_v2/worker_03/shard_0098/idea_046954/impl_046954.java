...
@Data
public class Idea46954Config {
    private String name = "idea_046954";
 ...
 */
@Slf4j
public class Idea46954Service {
    private static final int IDEA_ID = 46954;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46954Service() {
        this(new Idea46954Config());
    }

    public Idea46954Service(Idea46954Config config) {
        this.config = config != null ? config : new Idea46954Config();
