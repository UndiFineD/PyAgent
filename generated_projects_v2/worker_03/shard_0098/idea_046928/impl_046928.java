...
@Data
public class Idea46928Config {
    private String name = "idea_046928";
 ...
 */
@Slf4j
public class Idea46928Service {
    private static final int IDEA_ID = 46928;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46928Service() {
        this(new Idea46928Config());
    }

    public Idea46928Service(Idea46928Config config) {
        this.config = config != null ? config : new Idea46928Config();
