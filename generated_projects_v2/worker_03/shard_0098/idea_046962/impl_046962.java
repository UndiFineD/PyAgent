...
@Data
public class Idea46962Config {
    private String name = "idea_046962";
 ...
 */
@Slf4j
public class Idea46962Service {
    private static final int IDEA_ID = 46962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46962Service() {
        this(new Idea46962Config());
    }

    public Idea46962Service(Idea46962Config config) {
        this.config = config != null ? config : new Idea46962Config();
