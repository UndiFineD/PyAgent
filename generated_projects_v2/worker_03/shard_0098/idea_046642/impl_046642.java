...
@Data
public class Idea46642Config {
    private String name = "idea_046642";
 ...
 */
@Slf4j
public class Idea46642Service {
    private static final int IDEA_ID = 46642;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46642Service() {
        this(new Idea46642Config());
    }

    public Idea46642Service(Idea46642Config config) {
        this.config = config != null ? config : new Idea46642Config();
