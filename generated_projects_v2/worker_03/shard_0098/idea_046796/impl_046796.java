...
@Data
public class Idea46796Config {
    private String name = "idea_046796";
 ...
 */
@Slf4j
public class Idea46796Service {
    private static final int IDEA_ID = 46796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46796Service() {
        this(new Idea46796Config());
    }

    public Idea46796Service(Idea46796Config config) {
        this.config = config != null ? config : new Idea46796Config();
