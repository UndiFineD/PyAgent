...
@Data
public class Idea46577Config {
    private String name = "idea_046577";
 ...
 */
@Slf4j
public class Idea46577Service {
    private static final int IDEA_ID = 46577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46577Service() {
        this(new Idea46577Config());
    }

    public Idea46577Service(Idea46577Config config) {
        this.config = config != null ? config : new Idea46577Config();
