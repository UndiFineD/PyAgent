...
@Data
public class Idea46801Config {
    private String name = "idea_046801";
 ...
 */
@Slf4j
public class Idea46801Service {
    private static final int IDEA_ID = 46801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46801Service() {
        this(new Idea46801Config());
    }

    public Idea46801Service(Idea46801Config config) {
        this.config = config != null ? config : new Idea46801Config();
