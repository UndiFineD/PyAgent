...
@Data
public class Idea46578Config {
    private String name = "idea_046578";
 ...
 */
@Slf4j
public class Idea46578Service {
    private static final int IDEA_ID = 46578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46578Service() {
        this(new Idea46578Config());
    }

    public Idea46578Service(Idea46578Config config) {
        this.config = config != null ? config : new Idea46578Config();
