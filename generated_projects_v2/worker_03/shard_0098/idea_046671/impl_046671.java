...
@Data
public class Idea46671Config {
    private String name = "idea_046671";
 ...
 */
@Slf4j
public class Idea46671Service {
    private static final int IDEA_ID = 46671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46671Service() {
        this(new Idea46671Config());
    }

    public Idea46671Service(Idea46671Config config) {
        this.config = config != null ? config : new Idea46671Config();
