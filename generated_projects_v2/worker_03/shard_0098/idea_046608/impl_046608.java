...
@Data
public class Idea46608Config {
    private String name = "idea_046608";
 ...
 */
@Slf4j
public class Idea46608Service {
    private static final int IDEA_ID = 46608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46608Service() {
        this(new Idea46608Config());
    }

    public Idea46608Service(Idea46608Config config) {
        this.config = config != null ? config : new Idea46608Config();
