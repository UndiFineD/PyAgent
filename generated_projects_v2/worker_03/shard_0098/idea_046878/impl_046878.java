...
@Data
public class Idea46878Config {
    private String name = "idea_046878";
 ...
 */
@Slf4j
public class Idea46878Service {
    private static final int IDEA_ID = 46878;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46878Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46878Service() {
        this(new Idea46878Config());
    }

    public Idea46878Service(Idea46878Config config) {
        this.config = config != null ? config : new Idea46878Config();
