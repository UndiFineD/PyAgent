...
@Data
public class Idea46795Config {
    private String name = "idea_046795";
 ...
 */
@Slf4j
public class Idea46795Service {
    private static final int IDEA_ID = 46795;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46795Service() {
        this(new Idea46795Config());
    }

    public Idea46795Service(Idea46795Config config) {
        this.config = config != null ? config : new Idea46795Config();
