...
@Data
public class Idea46835Config {
    private String name = "idea_046835";
 ...
 */
@Slf4j
public class Idea46835Service {
    private static final int IDEA_ID = 46835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46835Service() {
        this(new Idea46835Config());
    }

    public Idea46835Service(Idea46835Config config) {
        this.config = config != null ? config : new Idea46835Config();
