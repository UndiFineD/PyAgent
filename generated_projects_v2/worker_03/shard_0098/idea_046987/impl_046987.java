...
@Data
public class Idea46987Config {
    private String name = "idea_046987";
 ...
 */
@Slf4j
public class Idea46987Service {
    private static final int IDEA_ID = 46987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46987Service() {
        this(new Idea46987Config());
    }

    public Idea46987Service(Idea46987Config config) {
        this.config = config != null ? config : new Idea46987Config();
