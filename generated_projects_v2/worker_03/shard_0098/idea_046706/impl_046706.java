...
@Data
public class Idea46706Config {
    private String name = "idea_046706";
 ...
 */
@Slf4j
public class Idea46706Service {
    private static final int IDEA_ID = 46706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46706Service() {
        this(new Idea46706Config());
    }

    public Idea46706Service(Idea46706Config config) {
        this.config = config != null ? config : new Idea46706Config();
