...
@Data
public class Idea46738Config {
    private String name = "idea_046738";
 ...
 */
@Slf4j
public class Idea46738Service {
    private static final int IDEA_ID = 46738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46738Service() {
        this(new Idea46738Config());
    }

    public Idea46738Service(Idea46738Config config) {
        this.config = config != null ? config : new Idea46738Config();
