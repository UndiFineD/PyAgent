...
@Data
public class Idea46693Config {
    private String name = "idea_046693";
 ...
 */
@Slf4j
public class Idea46693Service {
    private static final int IDEA_ID = 46693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46693Service() {
        this(new Idea46693Config());
    }

    public Idea46693Service(Idea46693Config config) {
        this.config = config != null ? config : new Idea46693Config();
