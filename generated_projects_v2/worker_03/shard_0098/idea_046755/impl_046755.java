...
@Data
public class Idea46755Config {
    private String name = "idea_046755";
 ...
 */
@Slf4j
public class Idea46755Service {
    private static final int IDEA_ID = 46755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46755Service() {
        this(new Idea46755Config());
    }

    public Idea46755Service(Idea46755Config config) {
        this.config = config != null ? config : new Idea46755Config();
