...
@Data
public class Idea46847Config {
    private String name = "idea_046847";
 ...
 */
@Slf4j
public class Idea46847Service {
    private static final int IDEA_ID = 46847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46847Service() {
        this(new Idea46847Config());
    }

    public Idea46847Service(Idea46847Config config) {
        this.config = config != null ? config : new Idea46847Config();
