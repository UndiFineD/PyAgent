...
@Data
public class Idea46777Config {
    private String name = "idea_046777";
 ...
 */
@Slf4j
public class Idea46777Service {
    private static final int IDEA_ID = 46777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46777Service() {
        this(new Idea46777Config());
    }

    public Idea46777Service(Idea46777Config config) {
        this.config = config != null ? config : new Idea46777Config();
