...
@Data
public class Idea46996Config {
    private String name = "idea_046996";
 ...
 */
@Slf4j
public class Idea46996Service {
    private static final int IDEA_ID = 46996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46996Service() {
        this(new Idea46996Config());
    }

    public Idea46996Service(Idea46996Config config) {
        this.config = config != null ? config : new Idea46996Config();
