...
@Data
public class Idea46616Config {
    private String name = "idea_046616";
 ...
 */
@Slf4j
public class Idea46616Service {
    private static final int IDEA_ID = 46616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46616Service() {
        this(new Idea46616Config());
    }

    public Idea46616Service(Idea46616Config config) {
        this.config = config != null ? config : new Idea46616Config();
