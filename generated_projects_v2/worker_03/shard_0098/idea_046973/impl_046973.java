...
@Data
public class Idea46973Config {
    private String name = "idea_046973";
 ...
 */
@Slf4j
public class Idea46973Service {
    private static final int IDEA_ID = 46973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46973Service() {
        this(new Idea46973Config());
    }

    public Idea46973Service(Idea46973Config config) {
        this.config = config != null ? config : new Idea46973Config();
