...
@Data
public class Idea46821Config {
    private String name = "idea_046821";
 ...
 */
@Slf4j
public class Idea46821Service {
    private static final int IDEA_ID = 46821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46821Service() {
        this(new Idea46821Config());
    }

    public Idea46821Service(Idea46821Config config) {
        this.config = config != null ? config : new Idea46821Config();
