...
@Data
public class Idea46822Config {
    private String name = "idea_046822";
 ...
 */
@Slf4j
public class Idea46822Service {
    private static final int IDEA_ID = 46822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46822Service() {
        this(new Idea46822Config());
    }

    public Idea46822Service(Idea46822Config config) {
        this.config = config != null ? config : new Idea46822Config();
