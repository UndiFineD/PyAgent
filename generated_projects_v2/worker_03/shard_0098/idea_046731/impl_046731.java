...
@Data
public class Idea46731Config {
    private String name = "idea_046731";
 ...
 */
@Slf4j
public class Idea46731Service {
    private static final int IDEA_ID = 46731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46731Service() {
        this(new Idea46731Config());
    }

    public Idea46731Service(Idea46731Config config) {
        this.config = config != null ? config : new Idea46731Config();
