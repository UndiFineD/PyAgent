...
@Data
public class Idea46797Config {
    private String name = "idea_046797";
 ...
 */
@Slf4j
public class Idea46797Service {
    private static final int IDEA_ID = 46797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46797Service() {
        this(new Idea46797Config());
    }

    public Idea46797Service(Idea46797Config config) {
        this.config = config != null ? config : new Idea46797Config();
