...
@Data
public class Idea46927Config {
    private String name = "idea_046927";
 ...
 */
@Slf4j
public class Idea46927Service {
    private static final int IDEA_ID = 46927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46927Service() {
        this(new Idea46927Config());
    }

    public Idea46927Service(Idea46927Config config) {
        this.config = config != null ? config : new Idea46927Config();
