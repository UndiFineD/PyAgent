...
@Data
public class Idea46641Config {
    private String name = "idea_046641";
 ...
 */
@Slf4j
public class Idea46641Service {
    private static final int IDEA_ID = 46641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46641Service() {
        this(new Idea46641Config());
    }

    public Idea46641Service(Idea46641Config config) {
        this.config = config != null ? config : new Idea46641Config();
