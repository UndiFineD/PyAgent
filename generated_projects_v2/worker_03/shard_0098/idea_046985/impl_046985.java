...
@Data
public class Idea46985Config {
    private String name = "idea_046985";
 ...
 */
@Slf4j
public class Idea46985Service {
    private static final int IDEA_ID = 46985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46985Service() {
        this(new Idea46985Config());
    }

    public Idea46985Service(Idea46985Config config) {
        this.config = config != null ? config : new Idea46985Config();
