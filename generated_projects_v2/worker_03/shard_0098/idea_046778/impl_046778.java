...
@Data
public class Idea46778Config {
    private String name = "idea_046778";
 ...
 */
@Slf4j
public class Idea46778Service {
    private static final int IDEA_ID = 46778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46778Service() {
        this(new Idea46778Config());
    }

    public Idea46778Service(Idea46778Config config) {
        this.config = config != null ? config : new Idea46778Config();
