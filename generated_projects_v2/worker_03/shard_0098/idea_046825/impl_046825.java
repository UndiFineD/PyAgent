...
@Data
public class Idea46825Config {
    private String name = "idea_046825";
 ...
 */
@Slf4j
public class Idea46825Service {
    private static final int IDEA_ID = 46825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46825Service() {
        this(new Idea46825Config());
    }

    public Idea46825Service(Idea46825Config config) {
        this.config = config != null ? config : new Idea46825Config();
