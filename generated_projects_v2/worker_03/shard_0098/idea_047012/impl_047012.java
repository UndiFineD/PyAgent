...
@Data
public class Idea47012Config {
    private String name = "idea_047012";
 ...
 */
@Slf4j
public class Idea47012Service {
    private static final int IDEA_ID = 47012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47012Service() {
        this(new Idea47012Config());
    }

    public Idea47012Service(Idea47012Config config) {
        this.config = config != null ? config : new Idea47012Config();
