...
@Data
public class Idea46582Config {
    private String name = "idea_046582";
 ...
 */
@Slf4j
public class Idea46582Service {
    private static final int IDEA_ID = 46582;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46582Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46582Service() {
        this(new Idea46582Config());
    }

    public Idea46582Service(Idea46582Config config) {
        this.config = config != null ? config : new Idea46582Config();
