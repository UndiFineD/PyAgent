...
@Data
public class Idea46788Config {
    private String name = "idea_046788";
 ...
 */
@Slf4j
public class Idea46788Service {
    private static final int IDEA_ID = 46788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46788Service() {
        this(new Idea46788Config());
    }

    public Idea46788Service(Idea46788Config config) {
        this.config = config != null ? config : new Idea46788Config();
