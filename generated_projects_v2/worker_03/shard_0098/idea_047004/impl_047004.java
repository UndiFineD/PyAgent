...
@Data
public class Idea47004Config {
    private String name = "idea_047004";
 ...
 */
@Slf4j
public class Idea47004Service {
    private static final int IDEA_ID = 47004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47004Service() {
        this(new Idea47004Config());
    }

    public Idea47004Service(Idea47004Config config) {
        this.config = config != null ? config : new Idea47004Config();
