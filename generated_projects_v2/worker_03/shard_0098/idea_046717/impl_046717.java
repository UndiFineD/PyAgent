...
@Data
public class Idea46717Config {
    private String name = "idea_046717";
 ...
 */
@Slf4j
public class Idea46717Service {
    private static final int IDEA_ID = 46717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46717Service() {
        this(new Idea46717Config());
    }

    public Idea46717Service(Idea46717Config config) {
        this.config = config != null ? config : new Idea46717Config();
