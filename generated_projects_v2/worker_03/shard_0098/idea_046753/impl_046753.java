...
@Data
public class Idea46753Config {
    private String name = "idea_046753";
 ...
 */
@Slf4j
public class Idea46753Service {
    private static final int IDEA_ID = 46753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46753Service() {
        this(new Idea46753Config());
    }

    public Idea46753Service(Idea46753Config config) {
        this.config = config != null ? config : new Idea46753Config();
