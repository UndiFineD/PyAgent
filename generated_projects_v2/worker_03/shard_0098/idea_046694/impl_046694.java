...
@Data
public class Idea46694Config {
    private String name = "idea_046694";
 ...
 */
@Slf4j
public class Idea46694Service {
    private static final int IDEA_ID = 46694;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46694Service() {
        this(new Idea46694Config());
    }

    public Idea46694Service(Idea46694Config config) {
        this.config = config != null ? config : new Idea46694Config();
