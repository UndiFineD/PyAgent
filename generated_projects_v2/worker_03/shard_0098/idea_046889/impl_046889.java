...
@Data
public class Idea46889Config {
    private String name = "idea_046889";
 ...
 */
@Slf4j
public class Idea46889Service {
    private static final int IDEA_ID = 46889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46889Service() {
        this(new Idea46889Config());
    }

    public Idea46889Service(Idea46889Config config) {
        this.config = config != null ? config : new Idea46889Config();
