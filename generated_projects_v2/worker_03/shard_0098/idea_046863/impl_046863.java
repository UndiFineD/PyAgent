...
@Data
public class Idea46863Config {
    private String name = "idea_046863";
 ...
 */
@Slf4j
public class Idea46863Service {
    private static final int IDEA_ID = 46863;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46863Service() {
        this(new Idea46863Config());
    }

    public Idea46863Service(Idea46863Config config) {
        this.config = config != null ? config : new Idea46863Config();
