...
@Data
public class Idea46905Config {
    private String name = "idea_046905";
 ...
 */
@Slf4j
public class Idea46905Service {
    private static final int IDEA_ID = 46905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46905Service() {
        this(new Idea46905Config());
    }

    public Idea46905Service(Idea46905Config config) {
        this.config = config != null ? config : new Idea46905Config();
