...
@Data
public class Idea46735Config {
    private String name = "idea_046735";
 ...
 */
@Slf4j
public class Idea46735Service {
    private static final int IDEA_ID = 46735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46735Service() {
        this(new Idea46735Config());
    }

    public Idea46735Service(Idea46735Config config) {
        this.config = config != null ? config : new Idea46735Config();
