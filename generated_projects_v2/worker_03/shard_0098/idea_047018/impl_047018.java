...
@Data
public class Idea47018Config {
    private String name = "idea_047018";
 ...
 */
@Slf4j
public class Idea47018Service {
    private static final int IDEA_ID = 47018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47018Service() {
        this(new Idea47018Config());
    }

    public Idea47018Service(Idea47018Config config) {
        this.config = config != null ? config : new Idea47018Config();
