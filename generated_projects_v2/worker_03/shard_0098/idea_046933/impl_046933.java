...
@Data
public class Idea46933Config {
    private String name = "idea_046933";
 ...
 */
@Slf4j
public class Idea46933Service {
    private static final int IDEA_ID = 46933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46933Service() {
        this(new Idea46933Config());
    }

    public Idea46933Service(Idea46933Config config) {
        this.config = config != null ? config : new Idea46933Config();
