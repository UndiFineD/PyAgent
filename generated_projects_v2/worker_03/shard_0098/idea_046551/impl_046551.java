...
@Data
public class Idea46551Config {
    private String name = "idea_046551";
 ...
 */
@Slf4j
public class Idea46551Service {
    private static final int IDEA_ID = 46551;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46551Service() {
        this(new Idea46551Config());
    }

    public Idea46551Service(Idea46551Config config) {
        this.config = config != null ? config : new Idea46551Config();
