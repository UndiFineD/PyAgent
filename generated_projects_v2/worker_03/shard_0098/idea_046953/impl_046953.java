...
@Data
public class Idea46953Config {
    private String name = "idea_046953";
 ...
 */
@Slf4j
public class Idea46953Service {
    private static final int IDEA_ID = 46953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46953Service() {
        this(new Idea46953Config());
    }

    public Idea46953Service(Idea46953Config config) {
        this.config = config != null ? config : new Idea46953Config();
