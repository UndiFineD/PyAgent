...
@Data
public class Idea46839Config {
    private String name = "idea_046839";
 ...
 */
@Slf4j
public class Idea46839Service {
    private static final int IDEA_ID = 46839;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46839Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46839Service() {
        this(new Idea46839Config());
    }

    public Idea46839Service(Idea46839Config config) {
        this.config = config != null ? config : new Idea46839Config();
