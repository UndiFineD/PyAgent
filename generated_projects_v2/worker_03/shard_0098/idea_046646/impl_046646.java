...
@Data
public class Idea46646Config {
    private String name = "idea_046646";
 ...
 */
@Slf4j
public class Idea46646Service {
    private static final int IDEA_ID = 46646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46646Service() {
        this(new Idea46646Config());
    }

    public Idea46646Service(Idea46646Config config) {
        this.config = config != null ? config : new Idea46646Config();
