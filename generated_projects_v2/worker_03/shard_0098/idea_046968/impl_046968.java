...
@Data
public class Idea46968Config {
    private String name = "idea_046968";
 ...
 */
@Slf4j
public class Idea46968Service {
    private static final int IDEA_ID = 46968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46968Service() {
        this(new Idea46968Config());
    }

    public Idea46968Service(Idea46968Config config) {
        this.config = config != null ? config : new Idea46968Config();
