...
@Data
public class Idea46636Config {
    private String name = "idea_046636";
 ...
 */
@Slf4j
public class Idea46636Service {
    private static final int IDEA_ID = 46636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46636Service() {
        this(new Idea46636Config());
    }

    public Idea46636Service(Idea46636Config config) {
        this.config = config != null ? config : new Idea46636Config();
