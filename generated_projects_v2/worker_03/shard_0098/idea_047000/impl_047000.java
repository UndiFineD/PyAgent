...
@Data
public class Idea47000Config {
    private String name = "idea_047000";
 ...
 */
@Slf4j
public class Idea47000Service {
    private static final int IDEA_ID = 47000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47000Service() {
        this(new Idea47000Config());
    }

    public Idea47000Service(Idea47000Config config) {
        this.config = config != null ? config : new Idea47000Config();
