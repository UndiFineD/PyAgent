...
@Data
public class Idea46904Config {
    private String name = "idea_046904";
 ...
 */
@Slf4j
public class Idea46904Service {
    private static final int IDEA_ID = 46904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46904Service() {
        this(new Idea46904Config());
    }

    public Idea46904Service(Idea46904Config config) {
        this.config = config != null ? config : new Idea46904Config();
