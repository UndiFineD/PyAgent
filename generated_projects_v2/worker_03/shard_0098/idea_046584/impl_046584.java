...
@Data
public class Idea46584Config {
    private String name = "idea_046584";
 ...
 */
@Slf4j
public class Idea46584Service {
    private static final int IDEA_ID = 46584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46584Service() {
        this(new Idea46584Config());
    }

    public Idea46584Service(Idea46584Config config) {
        this.config = config != null ? config : new Idea46584Config();
