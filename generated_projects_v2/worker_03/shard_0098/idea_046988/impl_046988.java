...
@Data
public class Idea46988Config {
    private String name = "idea_046988";
 ...
 */
@Slf4j
public class Idea46988Service {
    private static final int IDEA_ID = 46988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46988Service() {
        this(new Idea46988Config());
    }

    public Idea46988Service(Idea46988Config config) {
        this.config = config != null ? config : new Idea46988Config();
