...
@Data
public class Idea46640Config {
    private String name = "idea_046640";
 ...
 */
@Slf4j
public class Idea46640Service {
    private static final int IDEA_ID = 46640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46640Service() {
        this(new Idea46640Config());
    }

    public Idea46640Service(Idea46640Config config) {
        this.config = config != null ? config : new Idea46640Config();
