...
@Data
public class Idea46866Config {
    private String name = "idea_046866";
 ...
 */
@Slf4j
public class Idea46866Service {
    private static final int IDEA_ID = 46866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46866Service() {
        this(new Idea46866Config());
    }

    public Idea46866Service(Idea46866Config config) {
        this.config = config != null ? config : new Idea46866Config();
