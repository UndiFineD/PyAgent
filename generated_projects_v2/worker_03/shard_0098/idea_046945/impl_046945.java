...
@Data
public class Idea46945Config {
    private String name = "idea_046945";
 ...
 */
@Slf4j
public class Idea46945Service {
    private static final int IDEA_ID = 46945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46945Service() {
        this(new Idea46945Config());
    }

    public Idea46945Service(Idea46945Config config) {
        this.config = config != null ? config : new Idea46945Config();
