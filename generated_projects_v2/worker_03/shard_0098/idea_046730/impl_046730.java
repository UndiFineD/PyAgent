...
@Data
public class Idea46730Config {
    private String name = "idea_046730";
 ...
 */
@Slf4j
public class Idea46730Service {
    private static final int IDEA_ID = 46730;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46730Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46730Service() {
        this(new Idea46730Config());
    }

    public Idea46730Service(Idea46730Config config) {
        this.config = config != null ? config : new Idea46730Config();
