...
@Data
public class Idea46629Config {
    private String name = "idea_046629";
 ...
 */
@Slf4j
public class Idea46629Service {
    private static final int IDEA_ID = 46629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46629Service() {
        this(new Idea46629Config());
    }

    public Idea46629Service(Idea46629Config config) {
        this.config = config != null ? config : new Idea46629Config();
