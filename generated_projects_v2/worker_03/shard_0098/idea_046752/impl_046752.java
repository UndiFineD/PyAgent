...
@Data
public class Idea46752Config {
    private String name = "idea_046752";
 ...
 */
@Slf4j
public class Idea46752Service {
    private static final int IDEA_ID = 46752;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46752Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46752Service() {
        this(new Idea46752Config());
    }

    public Idea46752Service(Idea46752Config config) {
        this.config = config != null ? config : new Idea46752Config();
