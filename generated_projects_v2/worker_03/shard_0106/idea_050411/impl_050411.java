...
@Data
public class Idea50411Config {
    private String name = "idea_050411";
 ...
 */
@Slf4j
public class Idea50411Service {
    private static final int IDEA_ID = 50411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50411Service() {
        this(new Idea50411Config());
    }

    public Idea50411Service(Idea50411Config config) {
        this.config = config != null ? config : new Idea50411Config();
