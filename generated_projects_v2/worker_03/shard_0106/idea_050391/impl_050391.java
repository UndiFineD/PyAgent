...
@Data
public class Idea50391Config {
    private String name = "idea_050391";
 ...
 */
@Slf4j
public class Idea50391Service {
    private static final int IDEA_ID = 50391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50391Service() {
        this(new Idea50391Config());
    }

    public Idea50391Service(Idea50391Config config) {
        this.config = config != null ? config : new Idea50391Config();
