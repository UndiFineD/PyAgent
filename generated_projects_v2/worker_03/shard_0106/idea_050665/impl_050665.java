...
@Data
public class Idea50665Config {
    private String name = "idea_050665";
 ...
 */
@Slf4j
public class Idea50665Service {
    private static final int IDEA_ID = 50665;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50665Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50665Service() {
        this(new Idea50665Config());
    }

    public Idea50665Service(Idea50665Config config) {
        this.config = config != null ? config : new Idea50665Config();
