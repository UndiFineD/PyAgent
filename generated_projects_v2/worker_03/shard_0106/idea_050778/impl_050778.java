...
@Data
public class Idea50778Config {
    private String name = "idea_050778";
 ...
 */
@Slf4j
public class Idea50778Service {
    private static final int IDEA_ID = 50778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50778Service() {
        this(new Idea50778Config());
    }

    public Idea50778Service(Idea50778Config config) {
        this.config = config != null ? config : new Idea50778Config();
