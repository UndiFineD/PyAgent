...
@Data
public class Idea50429Config {
    private String name = "idea_050429";
 ...
 */
@Slf4j
public class Idea50429Service {
    private static final int IDEA_ID = 50429;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50429Service() {
        this(new Idea50429Config());
    }

    public Idea50429Service(Idea50429Config config) {
        this.config = config != null ? config : new Idea50429Config();
