...
@Data
public class Idea50815Config {
    private String name = "idea_050815";
 ...
 */
@Slf4j
public class Idea50815Service {
    private static final int IDEA_ID = 50815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50815Service() {
        this(new Idea50815Config());
    }

    public Idea50815Service(Idea50815Config config) {
        this.config = config != null ? config : new Idea50815Config();
