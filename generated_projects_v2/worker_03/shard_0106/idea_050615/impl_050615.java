...
@Data
public class Idea50615Config {
    private String name = "idea_050615";
 ...
 */
@Slf4j
public class Idea50615Service {
    private static final int IDEA_ID = 50615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50615Service() {
        this(new Idea50615Config());
    }

    public Idea50615Service(Idea50615Config config) {
        this.config = config != null ? config : new Idea50615Config();
