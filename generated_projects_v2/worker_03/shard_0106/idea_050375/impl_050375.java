...
@Data
public class Idea50375Config {
    private String name = "idea_050375";
 ...
 */
@Slf4j
public class Idea50375Service {
    private static final int IDEA_ID = 50375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50375Service() {
        this(new Idea50375Config());
    }

    public Idea50375Service(Idea50375Config config) {
        this.config = config != null ? config : new Idea50375Config();
