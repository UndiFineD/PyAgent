...
@Data
public class Idea50775Config {
    private String name = "idea_050775";
 ...
 */
@Slf4j
public class Idea50775Service {
    private static final int IDEA_ID = 50775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50775Service() {
        this(new Idea50775Config());
    }

    public Idea50775Service(Idea50775Config config) {
        this.config = config != null ? config : new Idea50775Config();
