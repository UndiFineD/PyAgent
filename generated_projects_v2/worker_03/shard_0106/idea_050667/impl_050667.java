...
@Data
public class Idea50667Config {
    private String name = "idea_050667";
 ...
 */
@Slf4j
public class Idea50667Service {
    private static final int IDEA_ID = 50667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50667Service() {
        this(new Idea50667Config());
    }

    public Idea50667Service(Idea50667Config config) {
        this.config = config != null ? config : new Idea50667Config();
