...
@Data
public class Idea50393Config {
    private String name = "idea_050393";
 ...
 */
@Slf4j
public class Idea50393Service {
    private static final int IDEA_ID = 50393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50393Service() {
        this(new Idea50393Config());
    }

    public Idea50393Service(Idea50393Config config) {
        this.config = config != null ? config : new Idea50393Config();
