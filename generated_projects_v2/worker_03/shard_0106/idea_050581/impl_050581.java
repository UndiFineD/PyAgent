...
@Data
public class Idea50581Config {
    private String name = "idea_050581";
 ...
 */
@Slf4j
public class Idea50581Service {
    private static final int IDEA_ID = 50581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50581Service() {
        this(new Idea50581Config());
    }

    public Idea50581Service(Idea50581Config config) {
        this.config = config != null ? config : new Idea50581Config();
