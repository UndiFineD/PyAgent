...
@Data
public class Idea50433Config {
    private String name = "idea_050433";
 ...
 */
@Slf4j
public class Idea50433Service {
    private static final int IDEA_ID = 50433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50433Service() {
        this(new Idea50433Config());
    }

    public Idea50433Service(Idea50433Config config) {
        this.config = config != null ? config : new Idea50433Config();
