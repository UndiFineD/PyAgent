...
@Data
public class Idea50462Config {
    private String name = "idea_050462";
 ...
 */
@Slf4j
public class Idea50462Service {
    private static final int IDEA_ID = 50462;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50462Service() {
        this(new Idea50462Config());
    }

    public Idea50462Service(Idea50462Config config) {
        this.config = config != null ? config : new Idea50462Config();
