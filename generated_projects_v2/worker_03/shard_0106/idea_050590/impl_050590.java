...
@Data
public class Idea50590Config {
    private String name = "idea_050590";
 ...
 */
@Slf4j
public class Idea50590Service {
    private static final int IDEA_ID = 50590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50590Service() {
        this(new Idea50590Config());
    }

    public Idea50590Service(Idea50590Config config) {
        this.config = config != null ? config : new Idea50590Config();
