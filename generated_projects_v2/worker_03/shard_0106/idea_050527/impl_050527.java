...
@Data
public class Idea50527Config {
    private String name = "idea_050527";
 ...
 */
@Slf4j
public class Idea50527Service {
    private static final int IDEA_ID = 50527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50527Service() {
        this(new Idea50527Config());
    }

    public Idea50527Service(Idea50527Config config) {
        this.config = config != null ? config : new Idea50527Config();
