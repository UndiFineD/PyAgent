...
@Data
public class Idea50505Config {
    private String name = "idea_050505";
 ...
 */
@Slf4j
public class Idea50505Service {
    private static final int IDEA_ID = 50505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50505Service() {
        this(new Idea50505Config());
    }

    public Idea50505Service(Idea50505Config config) {
        this.config = config != null ? config : new Idea50505Config();
