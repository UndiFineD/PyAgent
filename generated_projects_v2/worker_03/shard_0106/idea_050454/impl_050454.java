...
@Data
public class Idea50454Config {
    private String name = "idea_050454";
 ...
 */
@Slf4j
public class Idea50454Service {
    private static final int IDEA_ID = 50454;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50454Service() {
        this(new Idea50454Config());
    }

    public Idea50454Service(Idea50454Config config) {
        this.config = config != null ? config : new Idea50454Config();
