...
@Data
public class Idea50366Config {
    private String name = "idea_050366";
 ...
 */
@Slf4j
public class Idea50366Service {
    private static final int IDEA_ID = 50366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50366Service() {
        this(new Idea50366Config());
    }

    public Idea50366Service(Idea50366Config config) {
        this.config = config != null ? config : new Idea50366Config();
