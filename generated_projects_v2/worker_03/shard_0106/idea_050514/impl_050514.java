...
@Data
public class Idea50514Config {
    private String name = "idea_050514";
 ...
 */
@Slf4j
public class Idea50514Service {
    private static final int IDEA_ID = 50514;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50514Service() {
        this(new Idea50514Config());
    }

    public Idea50514Service(Idea50514Config config) {
        this.config = config != null ? config : new Idea50514Config();
