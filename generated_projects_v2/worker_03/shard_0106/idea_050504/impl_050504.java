...
@Data
public class Idea50504Config {
    private String name = "idea_050504";
 ...
 */
@Slf4j
public class Idea50504Service {
    private static final int IDEA_ID = 50504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50504Service() {
        this(new Idea50504Config());
    }

    public Idea50504Service(Idea50504Config config) {
        this.config = config != null ? config : new Idea50504Config();
