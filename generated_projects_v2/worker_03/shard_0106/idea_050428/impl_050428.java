...
@Data
public class Idea50428Config {
    private String name = "idea_050428";
 ...
 */
@Slf4j
public class Idea50428Service {
    private static final int IDEA_ID = 50428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50428Service() {
        this(new Idea50428Config());
    }

    public Idea50428Service(Idea50428Config config) {
        this.config = config != null ? config : new Idea50428Config();
