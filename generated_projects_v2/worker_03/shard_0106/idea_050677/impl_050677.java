...
@Data
public class Idea50677Config {
    private String name = "idea_050677";
 ...
 */
@Slf4j
public class Idea50677Service {
    private static final int IDEA_ID = 50677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50677Service() {
        this(new Idea50677Config());
    }

    public Idea50677Service(Idea50677Config config) {
        this.config = config != null ? config : new Idea50677Config();
