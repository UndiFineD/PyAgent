...
@Data
public class Idea50358Config {
    private String name = "idea_050358";
 ...
 */
@Slf4j
public class Idea50358Service {
    private static final int IDEA_ID = 50358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50358Service() {
        this(new Idea50358Config());
    }

    public Idea50358Service(Idea50358Config config) {
        this.config = config != null ? config : new Idea50358Config();
