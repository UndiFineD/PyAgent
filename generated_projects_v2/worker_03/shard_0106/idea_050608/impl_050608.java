...
@Data
public class Idea50608Config {
    private String name = "idea_050608";
 ...
 */
@Slf4j
public class Idea50608Service {
    private static final int IDEA_ID = 50608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50608Service() {
        this(new Idea50608Config());
    }

    public Idea50608Service(Idea50608Config config) {
        this.config = config != null ? config : new Idea50608Config();
