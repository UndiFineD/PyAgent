...
@Data
public class Idea50381Config {
    private String name = "idea_050381";
 ...
 */
@Slf4j
public class Idea50381Service {
    private static final int IDEA_ID = 50381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50381Service() {
        this(new Idea50381Config());
    }

    public Idea50381Service(Idea50381Config config) {
        this.config = config != null ? config : new Idea50381Config();
