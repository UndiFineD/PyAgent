...
@Data
public class Idea50602Config {
    private String name = "idea_050602";
 ...
 */
@Slf4j
public class Idea50602Service {
    private static final int IDEA_ID = 50602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50602Service() {
        this(new Idea50602Config());
    }

    public Idea50602Service(Idea50602Config config) {
        this.config = config != null ? config : new Idea50602Config();
