...
@Data
public class Idea50619Config {
    private String name = "idea_050619";
 ...
 */
@Slf4j
public class Idea50619Service {
    private static final int IDEA_ID = 50619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50619Service() {
        this(new Idea50619Config());
    }

    public Idea50619Service(Idea50619Config config) {
        this.config = config != null ? config : new Idea50619Config();
