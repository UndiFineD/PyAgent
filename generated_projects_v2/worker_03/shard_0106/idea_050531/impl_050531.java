...
@Data
public class Idea50531Config {
    private String name = "idea_050531";
 ...
 */
@Slf4j
public class Idea50531Service {
    private static final int IDEA_ID = 50531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50531Service() {
        this(new Idea50531Config());
    }

    public Idea50531Service(Idea50531Config config) {
        this.config = config != null ? config : new Idea50531Config();
