...
@Data
public class Idea50806Config {
    private String name = "idea_050806";
 ...
 */
@Slf4j
public class Idea50806Service {
    private static final int IDEA_ID = 50806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50806Service() {
        this(new Idea50806Config());
    }

    public Idea50806Service(Idea50806Config config) {
        this.config = config != null ? config : new Idea50806Config();
