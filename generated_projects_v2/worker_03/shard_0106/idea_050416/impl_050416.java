...
@Data
public class Idea50416Config {
    private String name = "idea_050416";
 ...
 */
@Slf4j
public class Idea50416Service {
    private static final int IDEA_ID = 50416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50416Service() {
        this(new Idea50416Config());
    }

    public Idea50416Service(Idea50416Config config) {
        this.config = config != null ? config : new Idea50416Config();
