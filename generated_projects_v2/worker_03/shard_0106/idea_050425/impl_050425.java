...
@Data
public class Idea50425Config {
    private String name = "idea_050425";
 ...
 */
@Slf4j
public class Idea50425Service {
    private static final int IDEA_ID = 50425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50425Service() {
        this(new Idea50425Config());
    }

    public Idea50425Service(Idea50425Config config) {
        this.config = config != null ? config : new Idea50425Config();
