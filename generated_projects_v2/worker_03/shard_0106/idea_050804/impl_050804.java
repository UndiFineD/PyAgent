...
@Data
public class Idea50804Config {
    private String name = "idea_050804";
 ...
 */
@Slf4j
public class Idea50804Service {
    private static final int IDEA_ID = 50804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50804Service() {
        this(new Idea50804Config());
    }

    public Idea50804Service(Idea50804Config config) {
        this.config = config != null ? config : new Idea50804Config();
