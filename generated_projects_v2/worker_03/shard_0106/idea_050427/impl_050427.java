...
@Data
public class Idea50427Config {
    private String name = "idea_050427";
 ...
 */
@Slf4j
public class Idea50427Service {
    private static final int IDEA_ID = 50427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50427Service() {
        this(new Idea50427Config());
    }

    public Idea50427Service(Idea50427Config config) {
        this.config = config != null ? config : new Idea50427Config();
