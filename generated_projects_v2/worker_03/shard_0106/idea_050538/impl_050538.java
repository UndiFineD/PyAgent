...
@Data
public class Idea50538Config {
    private String name = "idea_050538";
 ...
 */
@Slf4j
public class Idea50538Service {
    private static final int IDEA_ID = 50538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50538Service() {
        this(new Idea50538Config());
    }

    public Idea50538Service(Idea50538Config config) {
        this.config = config != null ? config : new Idea50538Config();
