...
@Data
public class Idea50360Config {
    private String name = "idea_050360";
 ...
 */
@Slf4j
public class Idea50360Service {
    private static final int IDEA_ID = 50360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50360Service() {
        this(new Idea50360Config());
    }

    public Idea50360Service(Idea50360Config config) {
        this.config = config != null ? config : new Idea50360Config();
