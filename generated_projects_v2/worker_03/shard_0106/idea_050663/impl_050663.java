...
@Data
public class Idea50663Config {
    private String name = "idea_050663";
 ...
 */
@Slf4j
public class Idea50663Service {
    private static final int IDEA_ID = 50663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50663Service() {
        this(new Idea50663Config());
    }

    public Idea50663Service(Idea50663Config config) {
        this.config = config != null ? config : new Idea50663Config();
