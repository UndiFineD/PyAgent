...
@Data
public class Idea50725Config {
    private String name = "idea_050725";
 ...
 */
@Slf4j
public class Idea50725Service {
    private static final int IDEA_ID = 50725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50725Service() {
        this(new Idea50725Config());
    }

    public Idea50725Service(Idea50725Config config) {
        this.config = config != null ? config : new Idea50725Config();
