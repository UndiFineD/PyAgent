...
@Data
public class Idea50614Config {
    private String name = "idea_050614";
 ...
 */
@Slf4j
public class Idea50614Service {
    private static final int IDEA_ID = 50614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50614Service() {
        this(new Idea50614Config());
    }

    public Idea50614Service(Idea50614Config config) {
        this.config = config != null ? config : new Idea50614Config();
