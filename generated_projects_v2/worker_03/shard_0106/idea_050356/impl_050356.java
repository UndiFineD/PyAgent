...
@Data
public class Idea50356Config {
    private String name = "idea_050356";
 ...
 */
@Slf4j
public class Idea50356Service {
    private static final int IDEA_ID = 50356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50356Service() {
        this(new Idea50356Config());
    }

    public Idea50356Service(Idea50356Config config) {
        this.config = config != null ? config : new Idea50356Config();
