...
@Data
public class Idea50420Config {
    private String name = "idea_050420";
 ...
 */
@Slf4j
public class Idea50420Service {
    private static final int IDEA_ID = 50420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50420Service() {
        this(new Idea50420Config());
    }

    public Idea50420Service(Idea50420Config config) {
        this.config = config != null ? config : new Idea50420Config();
