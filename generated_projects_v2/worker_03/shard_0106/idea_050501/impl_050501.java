...
@Data
public class Idea50501Config {
    private String name = "idea_050501";
 ...
 */
@Slf4j
public class Idea50501Service {
    private static final int IDEA_ID = 50501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50501Service() {
        this(new Idea50501Config());
    }

    public Idea50501Service(Idea50501Config config) {
        this.config = config != null ? config : new Idea50501Config();
