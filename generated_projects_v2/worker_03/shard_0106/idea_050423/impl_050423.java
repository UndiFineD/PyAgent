...
@Data
public class Idea50423Config {
    private String name = "idea_050423";
 ...
 */
@Slf4j
public class Idea50423Service {
    private static final int IDEA_ID = 50423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50423Service() {
        this(new Idea50423Config());
    }

    public Idea50423Service(Idea50423Config config) {
        this.config = config != null ? config : new Idea50423Config();
