...
@Data
public class Idea50647Config {
    private String name = "idea_050647";
 ...
 */
@Slf4j
public class Idea50647Service {
    private static final int IDEA_ID = 50647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50647Service() {
        this(new Idea50647Config());
    }

    public Idea50647Service(Idea50647Config config) {
        this.config = config != null ? config : new Idea50647Config();
