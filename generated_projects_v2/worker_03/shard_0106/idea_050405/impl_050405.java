...
@Data
public class Idea50405Config {
    private String name = "idea_050405";
 ...
 */
@Slf4j
public class Idea50405Service {
    private static final int IDEA_ID = 50405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50405Service() {
        this(new Idea50405Config());
    }

    public Idea50405Service(Idea50405Config config) {
        this.config = config != null ? config : new Idea50405Config();
