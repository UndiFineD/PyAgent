...
@Data
public class Idea50805Config {
    private String name = "idea_050805";
 ...
 */
@Slf4j
public class Idea50805Service {
    private static final int IDEA_ID = 50805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50805Service() {
        this(new Idea50805Config());
    }

    public Idea50805Service(Idea50805Config config) {
        this.config = config != null ? config : new Idea50805Config();
