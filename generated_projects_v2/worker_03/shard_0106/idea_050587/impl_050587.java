...
@Data
public class Idea50587Config {
    private String name = "idea_050587";
 ...
 */
@Slf4j
public class Idea50587Service {
    private static final int IDEA_ID = 50587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50587Service() {
        this(new Idea50587Config());
    }

    public Idea50587Service(Idea50587Config config) {
        this.config = config != null ? config : new Idea50587Config();
