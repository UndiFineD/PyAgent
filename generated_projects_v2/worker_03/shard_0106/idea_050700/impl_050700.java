...
@Data
public class Idea50700Config {
    private String name = "idea_050700";
 ...
 */
@Slf4j
public class Idea50700Service {
    private static final int IDEA_ID = 50700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50700Service() {
        this(new Idea50700Config());
    }

    public Idea50700Service(Idea50700Config config) {
        this.config = config != null ? config : new Idea50700Config();
