...
@Data
public class Idea50357Config {
    private String name = "idea_050357";
 ...
 */
@Slf4j
public class Idea50357Service {
    private static final int IDEA_ID = 50357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50357Service() {
        this(new Idea50357Config());
    }

    public Idea50357Service(Idea50357Config config) {
        this.config = config != null ? config : new Idea50357Config();
