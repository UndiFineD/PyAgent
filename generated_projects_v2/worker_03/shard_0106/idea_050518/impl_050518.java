...
@Data
public class Idea50518Config {
    private String name = "idea_050518";
 ...
 */
@Slf4j
public class Idea50518Service {
    private static final int IDEA_ID = 50518;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50518Service() {
        this(new Idea50518Config());
    }

    public Idea50518Service(Idea50518Config config) {
        this.config = config != null ? config : new Idea50518Config();
