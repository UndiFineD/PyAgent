...
@Data
public class Idea50626Config {
    private String name = "idea_050626";
 ...
 */
@Slf4j
public class Idea50626Service {
    private static final int IDEA_ID = 50626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50626Service() {
        this(new Idea50626Config());
    }

    public Idea50626Service(Idea50626Config config) {
        this.config = config != null ? config : new Idea50626Config();
