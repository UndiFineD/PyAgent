...
@Data
public class Idea50611Config {
    private String name = "idea_050611";
 ...
 */
@Slf4j
public class Idea50611Service {
    private static final int IDEA_ID = 50611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50611Service() {
        this(new Idea50611Config());
    }

    public Idea50611Service(Idea50611Config config) {
        this.config = config != null ? config : new Idea50611Config();
