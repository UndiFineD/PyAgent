...
@Data
public class Idea50398Config {
    private String name = "idea_050398";
 ...
 */
@Slf4j
public class Idea50398Service {
    private static final int IDEA_ID = 50398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50398Service() {
        this(new Idea50398Config());
    }

    public Idea50398Service(Idea50398Config config) {
        this.config = config != null ? config : new Idea50398Config();
