...
@Data
public class Idea50795Config {
    private String name = "idea_050795";
 ...
 */
@Slf4j
public class Idea50795Service {
    private static final int IDEA_ID = 50795;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50795Service() {
        this(new Idea50795Config());
    }

    public Idea50795Service(Idea50795Config config) {
        this.config = config != null ? config : new Idea50795Config();
