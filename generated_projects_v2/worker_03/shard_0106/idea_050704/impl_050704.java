...
@Data
public class Idea50704Config {
    private String name = "idea_050704";
 ...
 */
@Slf4j
public class Idea50704Service {
    private static final int IDEA_ID = 50704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50704Service() {
        this(new Idea50704Config());
    }

    public Idea50704Service(Idea50704Config config) {
        this.config = config != null ? config : new Idea50704Config();
