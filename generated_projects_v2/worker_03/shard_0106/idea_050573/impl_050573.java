...
@Data
public class Idea50573Config {
    private String name = "idea_050573";
 ...
 */
@Slf4j
public class Idea50573Service {
    private static final int IDEA_ID = 50573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50573Service() {
        this(new Idea50573Config());
    }

    public Idea50573Service(Idea50573Config config) {
        this.config = config != null ? config : new Idea50573Config();
