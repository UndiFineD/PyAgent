...
@Data
public class Idea50383Config {
    private String name = "idea_050383";
 ...
 */
@Slf4j
public class Idea50383Service {
    private static final int IDEA_ID = 50383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50383Service() {
        this(new Idea50383Config());
    }

    public Idea50383Service(Idea50383Config config) {
        this.config = config != null ? config : new Idea50383Config();
