...
@Data
public class Idea50798Config {
    private String name = "idea_050798";
 ...
 */
@Slf4j
public class Idea50798Service {
    private static final int IDEA_ID = 50798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50798Service() {
        this(new Idea50798Config());
    }

    public Idea50798Service(Idea50798Config config) {
        this.config = config != null ? config : new Idea50798Config();
