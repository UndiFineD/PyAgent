...
@Data
public class Idea50418Config {
    private String name = "idea_050418";
 ...
 */
@Slf4j
public class Idea50418Service {
    private static final int IDEA_ID = 50418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50418Service() {
        this(new Idea50418Config());
    }

    public Idea50418Service(Idea50418Config config) {
        this.config = config != null ? config : new Idea50418Config();
