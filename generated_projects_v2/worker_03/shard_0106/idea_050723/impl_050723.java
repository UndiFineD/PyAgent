...
@Data
public class Idea50723Config {
    private String name = "idea_050723";
 ...
 */
@Slf4j
public class Idea50723Service {
    private static final int IDEA_ID = 50723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50723Service() {
        this(new Idea50723Config());
    }

    public Idea50723Service(Idea50723Config config) {
        this.config = config != null ? config : new Idea50723Config();
