...
@Data
public class Idea50421Config {
    private String name = "idea_050421";
 ...
 */
@Slf4j
public class Idea50421Service {
    private static final int IDEA_ID = 50421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50421Service() {
        this(new Idea50421Config());
    }

    public Idea50421Service(Idea50421Config config) {
        this.config = config != null ? config : new Idea50421Config();
