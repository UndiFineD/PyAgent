...
@Data
public class Idea50521Config {
    private String name = "idea_050521";
 ...
 */
@Slf4j
public class Idea50521Service {
    private static final int IDEA_ID = 50521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50521Service() {
        this(new Idea50521Config());
    }

    public Idea50521Service(Idea50521Config config) {
        this.config = config != null ? config : new Idea50521Config();
