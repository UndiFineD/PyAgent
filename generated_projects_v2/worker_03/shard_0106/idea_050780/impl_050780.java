...
@Data
public class Idea50780Config {
    private String name = "idea_050780";
 ...
 */
@Slf4j
public class Idea50780Service {
    private static final int IDEA_ID = 50780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50780Service() {
        this(new Idea50780Config());
    }

    public Idea50780Service(Idea50780Config config) {
        this.config = config != null ? config : new Idea50780Config();
