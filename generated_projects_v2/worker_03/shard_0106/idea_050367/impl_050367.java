...
@Data
public class Idea50367Config {
    private String name = "idea_050367";
 ...
 */
@Slf4j
public class Idea50367Service {
    private static final int IDEA_ID = 50367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50367Service() {
        this(new Idea50367Config());
    }

    public Idea50367Service(Idea50367Config config) {
        this.config = config != null ? config : new Idea50367Config();
