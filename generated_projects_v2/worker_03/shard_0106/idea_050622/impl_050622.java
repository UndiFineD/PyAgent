...
@Data
public class Idea50622Config {
    private String name = "idea_050622";
 ...
 */
@Slf4j
public class Idea50622Service {
    private static final int IDEA_ID = 50622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50622Service() {
        this(new Idea50622Config());
    }

    public Idea50622Service(Idea50622Config config) {
        this.config = config != null ? config : new Idea50622Config();
