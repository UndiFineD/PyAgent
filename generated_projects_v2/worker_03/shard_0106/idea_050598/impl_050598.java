...
@Data
public class Idea50598Config {
    private String name = "idea_050598";
 ...
 */
@Slf4j
public class Idea50598Service {
    private static final int IDEA_ID = 50598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50598Service() {
        this(new Idea50598Config());
    }

    public Idea50598Service(Idea50598Config config) {
        this.config = config != null ? config : new Idea50598Config();
