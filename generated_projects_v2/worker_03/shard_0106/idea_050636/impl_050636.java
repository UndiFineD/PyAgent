...
@Data
public class Idea50636Config {
    private String name = "idea_050636";
 ...
 */
@Slf4j
public class Idea50636Service {
    private static final int IDEA_ID = 50636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50636Service() {
        this(new Idea50636Config());
    }

    public Idea50636Service(Idea50636Config config) {
        this.config = config != null ? config : new Idea50636Config();
