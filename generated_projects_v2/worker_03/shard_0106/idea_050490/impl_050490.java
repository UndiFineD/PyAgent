...
@Data
public class Idea50490Config {
    private String name = "idea_050490";
 ...
 */
@Slf4j
public class Idea50490Service {
    private static final int IDEA_ID = 50490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50490Service() {
        this(new Idea50490Config());
    }

    public Idea50490Service(Idea50490Config config) {
        this.config = config != null ? config : new Idea50490Config();
