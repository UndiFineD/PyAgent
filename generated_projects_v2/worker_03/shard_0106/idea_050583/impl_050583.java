...
@Data
public class Idea50583Config {
    private String name = "idea_050583";
 ...
 */
@Slf4j
public class Idea50583Service {
    private static final int IDEA_ID = 50583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50583Service() {
        this(new Idea50583Config());
    }

    public Idea50583Service(Idea50583Config config) {
        this.config = config != null ? config : new Idea50583Config();
