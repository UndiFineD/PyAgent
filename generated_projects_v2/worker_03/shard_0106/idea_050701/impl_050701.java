...
@Data
public class Idea50701Config {
    private String name = "idea_050701";
 ...
 */
@Slf4j
public class Idea50701Service {
    private static final int IDEA_ID = 50701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50701Service() {
        this(new Idea50701Config());
    }

    public Idea50701Service(Idea50701Config config) {
        this.config = config != null ? config : new Idea50701Config();
