...
@Data
public class Idea50603Config {
    private String name = "idea_050603";
 ...
 */
@Slf4j
public class Idea50603Service {
    private static final int IDEA_ID = 50603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50603Service() {
        this(new Idea50603Config());
    }

    public Idea50603Service(Idea50603Config config) {
        this.config = config != null ? config : new Idea50603Config();
