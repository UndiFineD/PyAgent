...
@Data
public class Idea50385Config {
    private String name = "idea_050385";
 ...
 */
@Slf4j
public class Idea50385Service {
    private static final int IDEA_ID = 50385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50385Service() {
        this(new Idea50385Config());
    }

    public Idea50385Service(Idea50385Config config) {
        this.config = config != null ? config : new Idea50385Config();
