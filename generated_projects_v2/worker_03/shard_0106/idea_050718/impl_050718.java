...
@Data
public class Idea50718Config {
    private String name = "idea_050718";
 ...
 */
@Slf4j
public class Idea50718Service {
    private static final int IDEA_ID = 50718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50718Service() {
        this(new Idea50718Config());
    }

    public Idea50718Service(Idea50718Config config) {
        this.config = config != null ? config : new Idea50718Config();
