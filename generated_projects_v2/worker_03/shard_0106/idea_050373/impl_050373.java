...
@Data
public class Idea50373Config {
    private String name = "idea_050373";
 ...
 */
@Slf4j
public class Idea50373Service {
    private static final int IDEA_ID = 50373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50373Service() {
        this(new Idea50373Config());
    }

    public Idea50373Service(Idea50373Config config) {
        this.config = config != null ? config : new Idea50373Config();
