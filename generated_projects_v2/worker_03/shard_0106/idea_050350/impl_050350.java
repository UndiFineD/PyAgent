...
@Data
public class Idea50350Config {
    private String name = "idea_050350";
 ...
 */
@Slf4j
public class Idea50350Service {
    private static final int IDEA_ID = 50350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50350Service() {
        this(new Idea50350Config());
    }

    public Idea50350Service(Idea50350Config config) {
        this.config = config != null ? config : new Idea50350Config();
