...
@Data
public class Idea50541Config {
    private String name = "idea_050541";
 ...
 */
@Slf4j
public class Idea50541Service {
    private static final int IDEA_ID = 50541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50541Service() {
        this(new Idea50541Config());
    }

    public Idea50541Service(Idea50541Config config) {
        this.config = config != null ? config : new Idea50541Config();
