...
@Data
public class Idea50801Config {
    private String name = "idea_050801";
 ...
 */
@Slf4j
public class Idea50801Service {
    private static final int IDEA_ID = 50801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50801Service() {
        this(new Idea50801Config());
    }

    public Idea50801Service(Idea50801Config config) {
        this.config = config != null ? config : new Idea50801Config();
