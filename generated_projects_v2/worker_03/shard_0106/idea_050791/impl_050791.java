...
@Data
public class Idea50791Config {
    private String name = "idea_050791";
 ...
 */
@Slf4j
public class Idea50791Service {
    private static final int IDEA_ID = 50791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50791Service() {
        this(new Idea50791Config());
    }

    public Idea50791Service(Idea50791Config config) {
        this.config = config != null ? config : new Idea50791Config();
