...
@Data
public class Idea50361Config {
    private String name = "idea_050361";
 ...
 */
@Slf4j
public class Idea50361Service {
    private static final int IDEA_ID = 50361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50361Service() {
        this(new Idea50361Config());
    }

    public Idea50361Service(Idea50361Config config) {
        this.config = config != null ? config : new Idea50361Config();
