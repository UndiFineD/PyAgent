...
@Data
public class Idea50599Config {
    private String name = "idea_050599";
 ...
 */
@Slf4j
public class Idea50599Service {
    private static final int IDEA_ID = 50599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50599Service() {
        this(new Idea50599Config());
    }

    public Idea50599Service(Idea50599Config config) {
        this.config = config != null ? config : new Idea50599Config();
