...
@Data
public class Idea50641Config {
    private String name = "idea_050641";
 ...
 */
@Slf4j
public class Idea50641Service {
    private static final int IDEA_ID = 50641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50641Service() {
        this(new Idea50641Config());
    }

    public Idea50641Service(Idea50641Config config) {
        this.config = config != null ? config : new Idea50641Config();
