...
@Data
public class Idea50726Config {
    private String name = "idea_050726";
 ...
 */
@Slf4j
public class Idea50726Service {
    private static final int IDEA_ID = 50726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50726Service() {
        this(new Idea50726Config());
    }

    public Idea50726Service(Idea50726Config config) {
        this.config = config != null ? config : new Idea50726Config();
