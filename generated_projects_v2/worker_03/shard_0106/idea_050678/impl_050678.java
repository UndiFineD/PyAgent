...
@Data
public class Idea50678Config {
    private String name = "idea_050678";
 ...
 */
@Slf4j
public class Idea50678Service {
    private static final int IDEA_ID = 50678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50678Service() {
        this(new Idea50678Config());
    }

    public Idea50678Service(Idea50678Config config) {
        this.config = config != null ? config : new Idea50678Config();
