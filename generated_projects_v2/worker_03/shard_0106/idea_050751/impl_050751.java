...
@Data
public class Idea50751Config {
    private String name = "idea_050751";
 ...
 */
@Slf4j
public class Idea50751Service {
    private static final int IDEA_ID = 50751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50751Service() {
        this(new Idea50751Config());
    }

    public Idea50751Service(Idea50751Config config) {
        this.config = config != null ? config : new Idea50751Config();
