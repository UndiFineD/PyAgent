...
@Data
public class Idea50685Config {
    private String name = "idea_050685";
 ...
 */
@Slf4j
public class Idea50685Service {
    private static final int IDEA_ID = 50685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50685Service() {
        this(new Idea50685Config());
    }

    public Idea50685Service(Idea50685Config config) {
        this.config = config != null ? config : new Idea50685Config();
