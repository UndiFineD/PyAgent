...
@Data
public class Idea50633Config {
    private String name = "idea_050633";
 ...
 */
@Slf4j
public class Idea50633Service {
    private static final int IDEA_ID = 50633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50633Service() {
        this(new Idea50633Config());
    }

    public Idea50633Service(Idea50633Config config) {
        this.config = config != null ? config : new Idea50633Config();
