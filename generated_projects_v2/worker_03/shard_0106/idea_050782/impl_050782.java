...
@Data
public class Idea50782Config {
    private String name = "idea_050782";
 ...
 */
@Slf4j
public class Idea50782Service {
    private static final int IDEA_ID = 50782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50782Service() {
        this(new Idea50782Config());
    }

    public Idea50782Service(Idea50782Config config) {
        this.config = config != null ? config : new Idea50782Config();
