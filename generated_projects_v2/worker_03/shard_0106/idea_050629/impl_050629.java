...
@Data
public class Idea50629Config {
    private String name = "idea_050629";
 ...
 */
@Slf4j
public class Idea50629Service {
    private static final int IDEA_ID = 50629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50629Service() {
        this(new Idea50629Config());
    }

    public Idea50629Service(Idea50629Config config) {
        this.config = config != null ? config : new Idea50629Config();
