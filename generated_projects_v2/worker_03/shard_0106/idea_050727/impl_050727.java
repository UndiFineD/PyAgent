...
@Data
public class Idea50727Config {
    private String name = "idea_050727";
 ...
 */
@Slf4j
public class Idea50727Service {
    private static final int IDEA_ID = 50727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50727Service() {
        this(new Idea50727Config());
    }

    public Idea50727Service(Idea50727Config config) {
        this.config = config != null ? config : new Idea50727Config();
