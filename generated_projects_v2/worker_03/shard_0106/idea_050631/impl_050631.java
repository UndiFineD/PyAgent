...
@Data
public class Idea50631Config {
    private String name = "idea_050631";
 ...
 */
@Slf4j
public class Idea50631Service {
    private static final int IDEA_ID = 50631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50631Service() {
        this(new Idea50631Config());
    }

    public Idea50631Service(Idea50631Config config) {
        this.config = config != null ? config : new Idea50631Config();
