...
@Data
public class Idea50787Config {
    private String name = "idea_050787";
 ...
 */
@Slf4j
public class Idea50787Service {
    private static final int IDEA_ID = 50787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50787Service() {
        this(new Idea50787Config());
    }

    public Idea50787Service(Idea50787Config config) {
        this.config = config != null ? config : new Idea50787Config();
