...
@Data
public class Idea50384Config {
    private String name = "idea_050384";
 ...
 */
@Slf4j
public class Idea50384Service {
    private static final int IDEA_ID = 50384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50384Service() {
        this(new Idea50384Config());
    }

    public Idea50384Service(Idea50384Config config) {
        this.config = config != null ? config : new Idea50384Config();
