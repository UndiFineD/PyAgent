...
@Data
public class Idea50823Config {
    private String name = "idea_050823";
 ...
 */
@Slf4j
public class Idea50823Service {
    private static final int IDEA_ID = 50823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50823Service() {
        this(new Idea50823Config());
    }

    public Idea50823Service(Idea50823Config config) {
        this.config = config != null ? config : new Idea50823Config();
