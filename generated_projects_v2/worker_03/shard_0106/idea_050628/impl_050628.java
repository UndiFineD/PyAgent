...
@Data
public class Idea50628Config {
    private String name = "idea_050628";
 ...
 */
@Slf4j
public class Idea50628Service {
    private static final int IDEA_ID = 50628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50628Service() {
        this(new Idea50628Config());
    }

    public Idea50628Service(Idea50628Config config) {
        this.config = config != null ? config : new Idea50628Config();
