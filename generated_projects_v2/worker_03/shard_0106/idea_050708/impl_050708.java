...
@Data
public class Idea50708Config {
    private String name = "idea_050708";
 ...
 */
@Slf4j
public class Idea50708Service {
    private static final int IDEA_ID = 50708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50708Service() {
        this(new Idea50708Config());
    }

    public Idea50708Service(Idea50708Config config) {
        this.config = config != null ? config : new Idea50708Config();
