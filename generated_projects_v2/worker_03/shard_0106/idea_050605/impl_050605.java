...
@Data
public class Idea50605Config {
    private String name = "idea_050605";
 ...
 */
@Slf4j
public class Idea50605Service {
    private static final int IDEA_ID = 50605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50605Service() {
        this(new Idea50605Config());
    }

    public Idea50605Service(Idea50605Config config) {
        this.config = config != null ? config : new Idea50605Config();
