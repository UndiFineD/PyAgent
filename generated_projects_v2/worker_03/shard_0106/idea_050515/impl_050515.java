...
@Data
public class Idea50515Config {
    private String name = "idea_050515";
 ...
 */
@Slf4j
public class Idea50515Service {
    private static final int IDEA_ID = 50515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50515Service() {
        this(new Idea50515Config());
    }

    public Idea50515Service(Idea50515Config config) {
        this.config = config != null ? config : new Idea50515Config();
