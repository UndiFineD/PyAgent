...
@Data
public class Idea50512Config {
    private String name = "idea_050512";
 ...
 */
@Slf4j
public class Idea50512Service {
    private static final int IDEA_ID = 50512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50512Service() {
        this(new Idea50512Config());
    }

    public Idea50512Service(Idea50512Config config) {
        this.config = config != null ? config : new Idea50512Config();
