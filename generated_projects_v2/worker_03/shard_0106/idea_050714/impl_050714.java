...
@Data
public class Idea50714Config {
    private String name = "idea_050714";
 ...
 */
@Slf4j
public class Idea50714Service {
    private static final int IDEA_ID = 50714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50714Service() {
        this(new Idea50714Config());
    }

    public Idea50714Service(Idea50714Config config) {
        this.config = config != null ? config : new Idea50714Config();
