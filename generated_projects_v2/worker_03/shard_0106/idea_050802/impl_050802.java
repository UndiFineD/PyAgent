...
@Data
public class Idea50802Config {
    private String name = "idea_050802";
 ...
 */
@Slf4j
public class Idea50802Service {
    private static final int IDEA_ID = 50802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50802Service() {
        this(new Idea50802Config());
    }

    public Idea50802Service(Idea50802Config config) {
        this.config = config != null ? config : new Idea50802Config();
