...
@Data
public class Idea50638Config {
    private String name = "idea_050638";
 ...
 */
@Slf4j
public class Idea50638Service {
    private static final int IDEA_ID = 50638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50638Service() {
        this(new Idea50638Config());
    }

    public Idea50638Service(Idea50638Config config) {
        this.config = config != null ? config : new Idea50638Config();
