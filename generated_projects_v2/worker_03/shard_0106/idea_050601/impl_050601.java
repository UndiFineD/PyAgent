...
@Data
public class Idea50601Config {
    private String name = "idea_050601";
 ...
 */
@Slf4j
public class Idea50601Service {
    private static final int IDEA_ID = 50601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50601Service() {
        this(new Idea50601Config());
    }

    public Idea50601Service(Idea50601Config config) {
        this.config = config != null ? config : new Idea50601Config();
