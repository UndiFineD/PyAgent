...
@Data
public class Idea50365Config {
    private String name = "idea_050365";
 ...
 */
@Slf4j
public class Idea50365Service {
    private static final int IDEA_ID = 50365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50365Service() {
        this(new Idea50365Config());
    }

    public Idea50365Service(Idea50365Config config) {
        this.config = config != null ? config : new Idea50365Config();
