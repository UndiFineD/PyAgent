...
@Data
public class Idea50566Config {
    private String name = "idea_050566";
 ...
 */
@Slf4j
public class Idea50566Service {
    private static final int IDEA_ID = 50566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50566Service() {
        this(new Idea50566Config());
    }

    public Idea50566Service(Idea50566Config config) {
        this.config = config != null ? config : new Idea50566Config();
