...
@Data
public class Idea50612Config {
    private String name = "idea_050612";
 ...
 */
@Slf4j
public class Idea50612Service {
    private static final int IDEA_ID = 50612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50612Service() {
        this(new Idea50612Config());
    }

    public Idea50612Service(Idea50612Config config) {
        this.config = config != null ? config : new Idea50612Config();
