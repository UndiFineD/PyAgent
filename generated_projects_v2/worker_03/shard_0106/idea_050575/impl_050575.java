...
@Data
public class Idea50575Config {
    private String name = "idea_050575";
 ...
 */
@Slf4j
public class Idea50575Service {
    private static final int IDEA_ID = 50575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50575Service() {
        this(new Idea50575Config());
    }

    public Idea50575Service(Idea50575Config config) {
        this.config = config != null ? config : new Idea50575Config();
