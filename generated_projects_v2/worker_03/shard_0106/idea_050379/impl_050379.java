...
@Data
public class Idea50379Config {
    private String name = "idea_050379";
 ...
 */
@Slf4j
public class Idea50379Service {
    private static final int IDEA_ID = 50379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50379Service() {
        this(new Idea50379Config());
    }

    public Idea50379Service(Idea50379Config config) {
        this.config = config != null ? config : new Idea50379Config();
