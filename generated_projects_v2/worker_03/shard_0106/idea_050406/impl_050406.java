...
@Data
public class Idea50406Config {
    private String name = "idea_050406";
 ...
 */
@Slf4j
public class Idea50406Service {
    private static final int IDEA_ID = 50406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50406Service() {
        this(new Idea50406Config());
    }

    public Idea50406Service(Idea50406Config config) {
        this.config = config != null ? config : new Idea50406Config();
