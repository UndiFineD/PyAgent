...
@Data
public class Idea50451Config {
    private String name = "idea_050451";
 ...
 */
@Slf4j
public class Idea50451Service {
    private static final int IDEA_ID = 50451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50451Service() {
        this(new Idea50451Config());
    }

    public Idea50451Service(Idea50451Config config) {
        this.config = config != null ? config : new Idea50451Config();
