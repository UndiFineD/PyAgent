...
@Data
public class Idea50400Config {
    private String name = "idea_050400";
 ...
 */
@Slf4j
public class Idea50400Service {
    private static final int IDEA_ID = 50400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50400Service() {
        this(new Idea50400Config());
    }

    public Idea50400Service(Idea50400Config config) {
        this.config = config != null ? config : new Idea50400Config();
