...
@Data
public class Idea50370Config {
    private String name = "idea_050370";
 ...
 */
@Slf4j
public class Idea50370Service {
    private static final int IDEA_ID = 50370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50370Service() {
        this(new Idea50370Config());
    }

    public Idea50370Service(Idea50370Config config) {
        this.config = config != null ? config : new Idea50370Config();
