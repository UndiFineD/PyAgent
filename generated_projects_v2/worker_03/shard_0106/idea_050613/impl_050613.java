...
@Data
public class Idea50613Config {
    private String name = "idea_050613";
 ...
 */
@Slf4j
public class Idea50613Service {
    private static final int IDEA_ID = 50613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50613Service() {
        this(new Idea50613Config());
    }

    public Idea50613Service(Idea50613Config config) {
        this.config = config != null ? config : new Idea50613Config();
