...
@Data
public class Idea50621Config {
    private String name = "idea_050621";
 ...
 */
@Slf4j
public class Idea50621Service {
    private static final int IDEA_ID = 50621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50621Service() {
        this(new Idea50621Config());
    }

    public Idea50621Service(Idea50621Config config) {
        this.config = config != null ? config : new Idea50621Config();
