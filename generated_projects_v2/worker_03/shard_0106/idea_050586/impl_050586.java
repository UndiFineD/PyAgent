...
@Data
public class Idea50586Config {
    private String name = "idea_050586";
 ...
 */
@Slf4j
public class Idea50586Service {
    private static final int IDEA_ID = 50586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50586Service() {
        this(new Idea50586Config());
    }

    public Idea50586Service(Idea50586Config config) {
        this.config = config != null ? config : new Idea50586Config();
