...
@Data
public class Idea50652Config {
    private String name = "idea_050652";
 ...
 */
@Slf4j
public class Idea50652Service {
    private static final int IDEA_ID = 50652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50652Service() {
        this(new Idea50652Config());
    }

    public Idea50652Service(Idea50652Config config) {
        this.config = config != null ? config : new Idea50652Config();
