...
@Data
public class Idea50576Config {
    private String name = "idea_050576";
 ...
 */
@Slf4j
public class Idea50576Service {
    private static final int IDEA_ID = 50576;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50576Service() {
        this(new Idea50576Config());
    }

    public Idea50576Service(Idea50576Config config) {
        this.config = config != null ? config : new Idea50576Config();
