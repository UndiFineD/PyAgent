...
@Data
public class Idea50422Config {
    private String name = "idea_050422";
 ...
 */
@Slf4j
public class Idea50422Service {
    private static final int IDEA_ID = 50422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50422Service() {
        this(new Idea50422Config());
    }

    public Idea50422Service(Idea50422Config config) {
        this.config = config != null ? config : new Idea50422Config();
