...
@Data
public class Idea50493Config {
    private String name = "idea_050493";
 ...
 */
@Slf4j
public class Idea50493Service {
    private static final int IDEA_ID = 50493;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50493Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50493Service() {
        this(new Idea50493Config());
    }

    public Idea50493Service(Idea50493Config config) {
        this.config = config != null ? config : new Idea50493Config();
