...
@Data
public class Idea50821Config {
    private String name = "idea_050821";
 ...
 */
@Slf4j
public class Idea50821Service {
    private static final int IDEA_ID = 50821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50821Service() {
        this(new Idea50821Config());
    }

    public Idea50821Service(Idea50821Config config) {
        this.config = config != null ? config : new Idea50821Config();
