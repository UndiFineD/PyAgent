...
@Data
public class Idea50394Config {
    private String name = "idea_050394";
 ...
 */
@Slf4j
public class Idea50394Service {
    private static final int IDEA_ID = 50394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50394Service() {
        this(new Idea50394Config());
    }

    public Idea50394Service(Idea50394Config config) {
        this.config = config != null ? config : new Idea50394Config();
