...
@Data
public class Idea50392Config {
    private String name = "idea_050392";
 ...
 */
@Slf4j
public class Idea50392Service {
    private static final int IDEA_ID = 50392;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50392Service() {
        this(new Idea50392Config());
    }

    public Idea50392Service(Idea50392Config config) {
        this.config = config != null ? config : new Idea50392Config();
