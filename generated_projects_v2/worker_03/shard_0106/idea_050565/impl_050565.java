...
@Data
public class Idea50565Config {
    private String name = "idea_050565";
 ...
 */
@Slf4j
public class Idea50565Service {
    private static final int IDEA_ID = 50565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50565Service() {
        this(new Idea50565Config());
    }

    public Idea50565Service(Idea50565Config config) {
        this.config = config != null ? config : new Idea50565Config();
