...
@Data
public class Idea50511Config {
    private String name = "idea_050511";
 ...
 */
@Slf4j
public class Idea50511Service {
    private static final int IDEA_ID = 50511;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50511Service() {
        this(new Idea50511Config());
    }

    public Idea50511Service(Idea50511Config config) {
        this.config = config != null ? config : new Idea50511Config();
