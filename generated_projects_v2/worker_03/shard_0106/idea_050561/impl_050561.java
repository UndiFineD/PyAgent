...
@Data
public class Idea50561Config {
    private String name = "idea_050561";
 ...
 */
@Slf4j
public class Idea50561Service {
    private static final int IDEA_ID = 50561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50561Service() {
        this(new Idea50561Config());
    }

    public Idea50561Service(Idea50561Config config) {
        this.config = config != null ? config : new Idea50561Config();
