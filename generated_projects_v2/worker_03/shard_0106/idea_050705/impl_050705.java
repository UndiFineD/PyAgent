...
@Data
public class Idea50705Config {
    private String name = "idea_050705";
 ...
 */
@Slf4j
public class Idea50705Service {
    private static final int IDEA_ID = 50705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50705Service() {
        this(new Idea50705Config());
    }

    public Idea50705Service(Idea50705Config config) {
        this.config = config != null ? config : new Idea50705Config();
