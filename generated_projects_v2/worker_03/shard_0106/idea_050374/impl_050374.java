...
@Data
public class Idea50374Config {
    private String name = "idea_050374";
 ...
 */
@Slf4j
public class Idea50374Service {
    private static final int IDEA_ID = 50374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50374Service() {
        this(new Idea50374Config());
    }

    public Idea50374Service(Idea50374Config config) {
        this.config = config != null ? config : new Idea50374Config();
