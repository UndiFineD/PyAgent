...
@Data
public class Idea50363Config {
    private String name = "idea_050363";
 ...
 */
@Slf4j
public class Idea50363Service {
    private static final int IDEA_ID = 50363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50363Service() {
        this(new Idea50363Config());
    }

    public Idea50363Service(Idea50363Config config) {
        this.config = config != null ? config : new Idea50363Config();
