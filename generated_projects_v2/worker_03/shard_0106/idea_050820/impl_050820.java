...
@Data
public class Idea50820Config {
    private String name = "idea_050820";
 ...
 */
@Slf4j
public class Idea50820Service {
    private static final int IDEA_ID = 50820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50820Service() {
        this(new Idea50820Config());
    }

    public Idea50820Service(Idea50820Config config) {
        this.config = config != null ? config : new Idea50820Config();
