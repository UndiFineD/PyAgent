...
@Data
public class Idea50489Config {
    private String name = "idea_050489";
 ...
 */
@Slf4j
public class Idea50489Service {
    private static final int IDEA_ID = 50489;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50489Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50489Service() {
        this(new Idea50489Config());
    }

    public Idea50489Service(Idea50489Config config) {
        this.config = config != null ? config : new Idea50489Config();
