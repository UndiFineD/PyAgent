...
@Data
public class Idea50627Config {
    private String name = "idea_050627";
 ...
 */
@Slf4j
public class Idea50627Service {
    private static final int IDEA_ID = 50627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50627Service() {
        this(new Idea50627Config());
    }

    public Idea50627Service(Idea50627Config config) {
        this.config = config != null ? config : new Idea50627Config();
