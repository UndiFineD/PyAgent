...
@Data
public class Idea50604Config {
    private String name = "idea_050604";
 ...
 */
@Slf4j
public class Idea50604Service {
    private static final int IDEA_ID = 50604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50604Service() {
        this(new Idea50604Config());
    }

    public Idea50604Service(Idea50604Config config) {
        this.config = config != null ? config : new Idea50604Config();
