...
@Data
public class Idea50623Config {
    private String name = "idea_050623";
 ...
 */
@Slf4j
public class Idea50623Service {
    private static final int IDEA_ID = 50623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50623Service() {
        this(new Idea50623Config());
    }

    public Idea50623Service(Idea50623Config config) {
        this.config = config != null ? config : new Idea50623Config();
