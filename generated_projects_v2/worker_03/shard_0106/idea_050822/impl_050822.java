...
@Data
public class Idea50822Config {
    private String name = "idea_050822";
 ...
 */
@Slf4j
public class Idea50822Service {
    private static final int IDEA_ID = 50822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50822Service() {
        this(new Idea50822Config());
    }

    public Idea50822Service(Idea50822Config config) {
        this.config = config != null ? config : new Idea50822Config();
