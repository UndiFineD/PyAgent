...
@Data
public class Idea50620Config {
    private String name = "idea_050620";
 ...
 */
@Slf4j
public class Idea50620Service {
    private static final int IDEA_ID = 50620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50620Service() {
        this(new Idea50620Config());
    }

    public Idea50620Service(Idea50620Config config) {
        this.config = config != null ? config : new Idea50620Config();
