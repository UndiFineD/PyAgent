...
@Data
public class Idea50500Config {
    private String name = "idea_050500";
 ...
 */
@Slf4j
public class Idea50500Service {
    private static final int IDEA_ID = 50500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50500Service() {
        this(new Idea50500Config());
    }

    public Idea50500Service(Idea50500Config config) {
        this.config = config != null ? config : new Idea50500Config();
