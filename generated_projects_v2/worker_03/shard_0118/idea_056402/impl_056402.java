...
@Data
public class Idea56402Config {
    private String name = "idea_056402";
 ...
 */
@Slf4j
public class Idea56402Service {
    private static final int IDEA_ID = 56402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56402Service() {
        this(new Idea56402Config());
    }

    public Idea56402Service(Idea56402Config config) {
        this.config = config != null ? config : new Idea56402Config();
