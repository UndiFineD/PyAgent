...
@Data
public class Idea56522Config {
    private String name = "idea_056522";
 ...
 */
@Slf4j
public class Idea56522Service {
    private static final int IDEA_ID = 56522;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56522Service() {
        this(new Idea56522Config());
    }

    public Idea56522Service(Idea56522Config config) {
        this.config = config != null ? config : new Idea56522Config();
