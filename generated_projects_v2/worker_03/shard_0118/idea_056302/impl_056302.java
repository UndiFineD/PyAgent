...
@Data
public class Idea56302Config {
    private String name = "idea_056302";
 ...
 */
@Slf4j
public class Idea56302Service {
    private static final int IDEA_ID = 56302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56302Service() {
        this(new Idea56302Config());
    }

    public Idea56302Service(Idea56302Config config) {
        this.config = config != null ? config : new Idea56302Config();
