...
@Data
public class Idea56297Config {
    private String name = "idea_056297";
 ...
 */
@Slf4j
public class Idea56297Service {
    private static final int IDEA_ID = 56297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56297Service() {
        this(new Idea56297Config());
    }

    public Idea56297Service(Idea56297Config config) {
        this.config = config != null ? config : new Idea56297Config();
