...
@Data
public class Idea56177Config {
    private String name = "idea_056177";
 ...
 */
@Slf4j
public class Idea56177Service {
    private static final int IDEA_ID = 56177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56177Service() {
        this(new Idea56177Config());
    }

    public Idea56177Service(Idea56177Config config) {
        this.config = config != null ? config : new Idea56177Config();
