...
@Data
public class Idea56135Config {
    private String name = "idea_056135";
 ...
 */
@Slf4j
public class Idea56135Service {
    private static final int IDEA_ID = 56135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56135Service() {
        this(new Idea56135Config());
    }

    public Idea56135Service(Idea56135Config config) {
        this.config = config != null ? config : new Idea56135Config();
