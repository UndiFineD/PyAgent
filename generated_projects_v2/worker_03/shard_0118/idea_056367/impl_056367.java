...
@Data
public class Idea56367Config {
    private String name = "idea_056367";
 ...
 */
@Slf4j
public class Idea56367Service {
    private static final int IDEA_ID = 56367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56367Service() {
        this(new Idea56367Config());
    }

    public Idea56367Service(Idea56367Config config) {
        this.config = config != null ? config : new Idea56367Config();
