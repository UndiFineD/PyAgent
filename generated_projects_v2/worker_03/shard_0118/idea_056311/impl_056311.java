...
@Data
public class Idea56311Config {
    private String name = "idea_056311";
 ...
 */
@Slf4j
public class Idea56311Service {
    private static final int IDEA_ID = 56311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56311Service() {
        this(new Idea56311Config());
    }

    public Idea56311Service(Idea56311Config config) {
        this.config = config != null ? config : new Idea56311Config();
