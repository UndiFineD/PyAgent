...
@Data
public class Idea56436Config {
    private String name = "idea_056436";
 ...
 */
@Slf4j
public class Idea56436Service {
    private static final int IDEA_ID = 56436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56436Service() {
        this(new Idea56436Config());
    }

    public Idea56436Service(Idea56436Config config) {
        this.config = config != null ? config : new Idea56436Config();
