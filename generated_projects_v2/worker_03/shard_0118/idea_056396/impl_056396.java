...
@Data
public class Idea56396Config {
    private String name = "idea_056396";
 ...
 */
@Slf4j
public class Idea56396Service {
    private static final int IDEA_ID = 56396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56396Service() {
        this(new Idea56396Config());
    }

    public Idea56396Service(Idea56396Config config) {
        this.config = config != null ? config : new Idea56396Config();
