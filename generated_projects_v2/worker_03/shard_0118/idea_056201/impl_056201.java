...
@Data
public class Idea56201Config {
    private String name = "idea_056201";
 ...
 */
@Slf4j
public class Idea56201Service {
    private static final int IDEA_ID = 56201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56201Service() {
        this(new Idea56201Config());
    }

    public Idea56201Service(Idea56201Config config) {
        this.config = config != null ? config : new Idea56201Config();
