...
@Data
public class Idea56200Config {
    private String name = "idea_056200";
 ...
 */
@Slf4j
public class Idea56200Service {
    private static final int IDEA_ID = 56200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56200Service() {
        this(new Idea56200Config());
    }

    public Idea56200Service(Idea56200Config config) {
        this.config = config != null ? config : new Idea56200Config();
