...
@Data
public class Idea56431Config {
    private String name = "idea_056431";
 ...
 */
@Slf4j
public class Idea56431Service {
    private static final int IDEA_ID = 56431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56431Service() {
        this(new Idea56431Config());
    }

    public Idea56431Service(Idea56431Config config) {
        this.config = config != null ? config : new Idea56431Config();
