...
@Data
public class Idea56421Config {
    private String name = "idea_056421";
 ...
 */
@Slf4j
public class Idea56421Service {
    private static final int IDEA_ID = 56421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56421Service() {
        this(new Idea56421Config());
    }

    public Idea56421Service(Idea56421Config config) {
        this.config = config != null ? config : new Idea56421Config();
