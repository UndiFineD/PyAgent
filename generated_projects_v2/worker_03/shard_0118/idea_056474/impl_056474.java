...
@Data
public class Idea56474Config {
    private String name = "idea_056474";
 ...
 */
@Slf4j
public class Idea56474Service {
    private static final int IDEA_ID = 56474;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56474Service() {
        this(new Idea56474Config());
    }

    public Idea56474Service(Idea56474Config config) {
        this.config = config != null ? config : new Idea56474Config();
