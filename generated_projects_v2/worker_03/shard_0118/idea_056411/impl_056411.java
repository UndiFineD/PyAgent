...
@Data
public class Idea56411Config {
    private String name = "idea_056411";
 ...
 */
@Slf4j
public class Idea56411Service {
    private static final int IDEA_ID = 56411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56411Service() {
        this(new Idea56411Config());
    }

    public Idea56411Service(Idea56411Config config) {
        this.config = config != null ? config : new Idea56411Config();
