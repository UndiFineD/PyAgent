...
@Data
public class Idea56433Config {
    private String name = "idea_056433";
 ...
 */
@Slf4j
public class Idea56433Service {
    private static final int IDEA_ID = 56433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56433Service() {
        this(new Idea56433Config());
    }

    public Idea56433Service(Idea56433Config config) {
        this.config = config != null ? config : new Idea56433Config();
