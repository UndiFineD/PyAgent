...
@Data
public class Idea56307Config {
    private String name = "idea_056307";
 ...
 */
@Slf4j
public class Idea56307Service {
    private static final int IDEA_ID = 56307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56307Service() {
        this(new Idea56307Config());
    }

    public Idea56307Service(Idea56307Config config) {
        this.config = config != null ? config : new Idea56307Config();
