...
@Data
public class Idea56237Config {
    private String name = "idea_056237";
 ...
 */
@Slf4j
public class Idea56237Service {
    private static final int IDEA_ID = 56237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56237Service() {
        this(new Idea56237Config());
    }

    public Idea56237Service(Idea56237Config config) {
        this.config = config != null ? config : new Idea56237Config();
