...
@Data
public class Idea56408Config {
    private String name = "idea_056408";
 ...
 */
@Slf4j
public class Idea56408Service {
    private static final int IDEA_ID = 56408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56408Service() {
        this(new Idea56408Config());
    }

    public Idea56408Service(Idea56408Config config) {
        this.config = config != null ? config : new Idea56408Config();
