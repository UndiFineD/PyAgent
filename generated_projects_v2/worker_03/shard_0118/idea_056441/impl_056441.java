...
@Data
public class Idea56441Config {
    private String name = "idea_056441";
 ...
 */
@Slf4j
public class Idea56441Service {
    private static final int IDEA_ID = 56441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56441Service() {
        this(new Idea56441Config());
    }

    public Idea56441Service(Idea56441Config config) {
        this.config = config != null ? config : new Idea56441Config();
