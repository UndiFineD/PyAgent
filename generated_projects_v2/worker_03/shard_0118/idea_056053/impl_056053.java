...
@Data
public class Idea56053Config {
    private String name = "idea_056053";
 ...
 */
@Slf4j
public class Idea56053Service {
    private static final int IDEA_ID = 56053;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56053Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56053Service() {
        this(new Idea56053Config());
    }

    public Idea56053Service(Idea56053Config config) {
        this.config = config != null ? config : new Idea56053Config();
