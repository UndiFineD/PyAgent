...
@Data
public class Idea56335Config {
    private String name = "idea_056335";
 ...
 */
@Slf4j
public class Idea56335Service {
    private static final int IDEA_ID = 56335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56335Service() {
        this(new Idea56335Config());
    }

    public Idea56335Service(Idea56335Config config) {
        this.config = config != null ? config : new Idea56335Config();
