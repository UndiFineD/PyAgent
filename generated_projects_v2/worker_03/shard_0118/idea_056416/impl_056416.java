...
@Data
public class Idea56416Config {
    private String name = "idea_056416";
 ...
 */
@Slf4j
public class Idea56416Service {
    private static final int IDEA_ID = 56416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56416Service() {
        this(new Idea56416Config());
    }

    public Idea56416Service(Idea56416Config config) {
        this.config = config != null ? config : new Idea56416Config();
