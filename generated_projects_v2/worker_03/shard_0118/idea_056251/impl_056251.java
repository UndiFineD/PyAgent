...
@Data
public class Idea56251Config {
    private String name = "idea_056251";
 ...
 */
@Slf4j
public class Idea56251Service {
    private static final int IDEA_ID = 56251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56251Service() {
        this(new Idea56251Config());
    }

    public Idea56251Service(Idea56251Config config) {
        this.config = config != null ? config : new Idea56251Config();
