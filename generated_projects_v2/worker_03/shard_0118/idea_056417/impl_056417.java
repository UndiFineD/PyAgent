...
@Data
public class Idea56417Config {
    private String name = "idea_056417";
 ...
 */
@Slf4j
public class Idea56417Service {
    private static final int IDEA_ID = 56417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56417Service() {
        this(new Idea56417Config());
    }

    public Idea56417Service(Idea56417Config config) {
        this.config = config != null ? config : new Idea56417Config();
