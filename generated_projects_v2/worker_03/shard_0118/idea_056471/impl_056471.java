...
@Data
public class Idea56471Config {
    private String name = "idea_056471";
 ...
 */
@Slf4j
public class Idea56471Service {
    private static final int IDEA_ID = 56471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56471Service() {
        this(new Idea56471Config());
    }

    public Idea56471Service(Idea56471Config config) {
        this.config = config != null ? config : new Idea56471Config();
