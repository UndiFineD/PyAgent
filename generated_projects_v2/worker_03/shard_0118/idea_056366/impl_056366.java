...
@Data
public class Idea56366Config {
    private String name = "idea_056366";
 ...
 */
@Slf4j
public class Idea56366Service {
    private static final int IDEA_ID = 56366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56366Service() {
        this(new Idea56366Config());
    }

    public Idea56366Service(Idea56366Config config) {
        this.config = config != null ? config : new Idea56366Config();
