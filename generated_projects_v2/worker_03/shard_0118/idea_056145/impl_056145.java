...
@Data
public class Idea56145Config {
    private String name = "idea_056145";
 ...
 */
@Slf4j
public class Idea56145Service {
    private static final int IDEA_ID = 56145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56145Service() {
        this(new Idea56145Config());
    }

    public Idea56145Service(Idea56145Config config) {
        this.config = config != null ? config : new Idea56145Config();
