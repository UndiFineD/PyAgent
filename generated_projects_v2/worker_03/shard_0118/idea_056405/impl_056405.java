...
@Data
public class Idea56405Config {
    private String name = "idea_056405";
 ...
 */
@Slf4j
public class Idea56405Service {
    private static final int IDEA_ID = 56405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56405Service() {
        this(new Idea56405Config());
    }

    public Idea56405Service(Idea56405Config config) {
        this.config = config != null ? config : new Idea56405Config();
