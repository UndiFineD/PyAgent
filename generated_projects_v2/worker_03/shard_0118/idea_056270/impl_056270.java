...
@Data
public class Idea56270Config {
    private String name = "idea_056270";
 ...
 */
@Slf4j
public class Idea56270Service {
    private static final int IDEA_ID = 56270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56270Service() {
        this(new Idea56270Config());
    }

    public Idea56270Service(Idea56270Config config) {
        this.config = config != null ? config : new Idea56270Config();
