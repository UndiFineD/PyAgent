...
@Data
public class Idea56387Config {
    private String name = "idea_056387";
 ...
 */
@Slf4j
public class Idea56387Service {
    private static final int IDEA_ID = 56387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56387Service() {
        this(new Idea56387Config());
    }

    public Idea56387Service(Idea56387Config config) {
        this.config = config != null ? config : new Idea56387Config();
