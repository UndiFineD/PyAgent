...
@Data
public class Idea56090Config {
    private String name = "idea_056090";
 ...
 */
@Slf4j
public class Idea56090Service {
    private static final int IDEA_ID = 56090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56090Service() {
        this(new Idea56090Config());
    }

    public Idea56090Service(Idea56090Config config) {
        this.config = config != null ? config : new Idea56090Config();
