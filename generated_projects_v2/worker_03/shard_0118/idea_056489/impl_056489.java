...
@Data
public class Idea56489Config {
    private String name = "idea_056489";
 ...
 */
@Slf4j
public class Idea56489Service {
    private static final int IDEA_ID = 56489;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56489Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56489Service() {
        this(new Idea56489Config());
    }

    public Idea56489Service(Idea56489Config config) {
        this.config = config != null ? config : new Idea56489Config();
