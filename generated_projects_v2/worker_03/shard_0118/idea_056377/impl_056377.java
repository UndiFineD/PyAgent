...
@Data
public class Idea56377Config {
    private String name = "idea_056377";
 ...
 */
@Slf4j
public class Idea56377Service {
    private static final int IDEA_ID = 56377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56377Service() {
        this(new Idea56377Config());
    }

    public Idea56377Service(Idea56377Config config) {
        this.config = config != null ? config : new Idea56377Config();
