...
@Data
public class Idea56194Config {
    private String name = "idea_056194";
 ...
 */
@Slf4j
public class Idea56194Service {
    private static final int IDEA_ID = 56194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56194Service() {
        this(new Idea56194Config());
    }

    public Idea56194Service(Idea56194Config config) {
        this.config = config != null ? config : new Idea56194Config();
