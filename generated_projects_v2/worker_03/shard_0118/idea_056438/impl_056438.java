...
@Data
public class Idea56438Config {
    private String name = "idea_056438";
 ...
 */
@Slf4j
public class Idea56438Service {
    private static final int IDEA_ID = 56438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56438Service() {
        this(new Idea56438Config());
    }

    public Idea56438Service(Idea56438Config config) {
        this.config = config != null ? config : new Idea56438Config();
