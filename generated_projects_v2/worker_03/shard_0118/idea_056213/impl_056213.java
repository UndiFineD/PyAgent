...
@Data
public class Idea56213Config {
    private String name = "idea_056213";
 ...
 */
@Slf4j
public class Idea56213Service {
    private static final int IDEA_ID = 56213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56213Service() {
        this(new Idea56213Config());
    }

    public Idea56213Service(Idea56213Config config) {
        this.config = config != null ? config : new Idea56213Config();
