...
@Data
public class Idea56476Config {
    private String name = "idea_056476";
 ...
 */
@Slf4j
public class Idea56476Service {
    private static final int IDEA_ID = 56476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56476Service() {
        this(new Idea56476Config());
    }

    public Idea56476Service(Idea56476Config config) {
        this.config = config != null ? config : new Idea56476Config();
