...
@Data
public class Idea56331Config {
    private String name = "idea_056331";
 ...
 */
@Slf4j
public class Idea56331Service {
    private static final int IDEA_ID = 56331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56331Service() {
        this(new Idea56331Config());
    }

    public Idea56331Service(Idea56331Config config) {
        this.config = config != null ? config : new Idea56331Config();
