...
@Data
public class Idea56274Config {
    private String name = "idea_056274";
 ...
 */
@Slf4j
public class Idea56274Service {
    private static final int IDEA_ID = 56274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56274Service() {
        this(new Idea56274Config());
    }

    public Idea56274Service(Idea56274Config config) {
        this.config = config != null ? config : new Idea56274Config();
