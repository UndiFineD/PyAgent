...
@Data
public class Idea56395Config {
    private String name = "idea_056395";
 ...
 */
@Slf4j
public class Idea56395Service {
    private static final int IDEA_ID = 56395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56395Service() {
        this(new Idea56395Config());
    }

    public Idea56395Service(Idea56395Config config) {
        this.config = config != null ? config : new Idea56395Config();
