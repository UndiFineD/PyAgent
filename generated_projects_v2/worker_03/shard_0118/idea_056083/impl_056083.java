...
@Data
public class Idea56083Config {
    private String name = "idea_056083";
 ...
 */
@Slf4j
public class Idea56083Service {
    private static final int IDEA_ID = 56083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56083Service() {
        this(new Idea56083Config());
    }

    public Idea56083Service(Idea56083Config config) {
        this.config = config != null ? config : new Idea56083Config();
