...
@Data
public class Idea56374Config {
    private String name = "idea_056374";
 ...
 */
@Slf4j
public class Idea56374Service {
    private static final int IDEA_ID = 56374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56374Service() {
        this(new Idea56374Config());
    }

    public Idea56374Service(Idea56374Config config) {
        this.config = config != null ? config : new Idea56374Config();
