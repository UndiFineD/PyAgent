...
@Data
public class Idea56401Config {
    private String name = "idea_056401";
 ...
 */
@Slf4j
public class Idea56401Service {
    private static final int IDEA_ID = 56401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56401Service() {
        this(new Idea56401Config());
    }

    public Idea56401Service(Idea56401Config config) {
        this.config = config != null ? config : new Idea56401Config();
