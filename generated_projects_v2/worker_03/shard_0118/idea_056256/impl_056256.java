...
@Data
public class Idea56256Config {
    private String name = "idea_056256";
 ...
 */
@Slf4j
public class Idea56256Service {
    private static final int IDEA_ID = 56256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56256Service() {
        this(new Idea56256Config());
    }

    public Idea56256Service(Idea56256Config config) {
        this.config = config != null ? config : new Idea56256Config();
