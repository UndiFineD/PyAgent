...
@Data
public class Idea56407Config {
    private String name = "idea_056407";
 ...
 */
@Slf4j
public class Idea56407Service {
    private static final int IDEA_ID = 56407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56407Service() {
        this(new Idea56407Config());
    }

    public Idea56407Service(Idea56407Config config) {
        this.config = config != null ? config : new Idea56407Config();
