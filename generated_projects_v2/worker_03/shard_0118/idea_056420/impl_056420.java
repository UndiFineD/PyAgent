...
@Data
public class Idea56420Config {
    private String name = "idea_056420";
 ...
 */
@Slf4j
public class Idea56420Service {
    private static final int IDEA_ID = 56420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56420Service() {
        this(new Idea56420Config());
    }

    public Idea56420Service(Idea56420Config config) {
        this.config = config != null ? config : new Idea56420Config();
