...
@Data
public class Idea56512Config {
    private String name = "idea_056512";
 ...
 */
@Slf4j
public class Idea56512Service {
    private static final int IDEA_ID = 56512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56512Service() {
        this(new Idea56512Config());
    }

    public Idea56512Service(Idea56512Config config) {
        this.config = config != null ? config : new Idea56512Config();
