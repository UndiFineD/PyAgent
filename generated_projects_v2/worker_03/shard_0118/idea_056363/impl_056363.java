...
@Data
public class Idea56363Config {
    private String name = "idea_056363";
 ...
 */
@Slf4j
public class Idea56363Service {
    private static final int IDEA_ID = 56363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56363Service() {
        this(new Idea56363Config());
    }

    public Idea56363Service(Idea56363Config config) {
        this.config = config != null ? config : new Idea56363Config();
