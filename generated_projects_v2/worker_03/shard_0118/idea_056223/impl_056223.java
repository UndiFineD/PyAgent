...
@Data
public class Idea56223Config {
    private String name = "idea_056223";
 ...
 */
@Slf4j
public class Idea56223Service {
    private static final int IDEA_ID = 56223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56223Service() {
        this(new Idea56223Config());
    }

    public Idea56223Service(Idea56223Config config) {
        this.config = config != null ? config : new Idea56223Config();
