...
@Data
public class Idea56196Config {
    private String name = "idea_056196";
 ...
 */
@Slf4j
public class Idea56196Service {
    private static final int IDEA_ID = 56196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56196Service() {
        this(new Idea56196Config());
    }

    public Idea56196Service(Idea56196Config config) {
        this.config = config != null ? config : new Idea56196Config();
