...
@Data
public class Idea56451Config {
    private String name = "idea_056451";
 ...
 */
@Slf4j
public class Idea56451Service {
    private static final int IDEA_ID = 56451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56451Service() {
        this(new Idea56451Config());
    }

    public Idea56451Service(Idea56451Config config) {
        this.config = config != null ? config : new Idea56451Config();
