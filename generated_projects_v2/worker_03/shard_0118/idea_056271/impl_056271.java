...
@Data
public class Idea56271Config {
    private String name = "idea_056271";
 ...
 */
@Slf4j
public class Idea56271Service {
    private static final int IDEA_ID = 56271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56271Service() {
        this(new Idea56271Config());
    }

    public Idea56271Service(Idea56271Config config) {
        this.config = config != null ? config : new Idea56271Config();
