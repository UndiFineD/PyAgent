...
@Data
public class Idea56375Config {
    private String name = "idea_056375";
 ...
 */
@Slf4j
public class Idea56375Service {
    private static final int IDEA_ID = 56375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56375Service() {
        this(new Idea56375Config());
    }

    public Idea56375Service(Idea56375Config config) {
        this.config = config != null ? config : new Idea56375Config();
