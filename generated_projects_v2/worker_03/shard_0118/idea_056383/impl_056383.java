...
@Data
public class Idea56383Config {
    private String name = "idea_056383";
 ...
 */
@Slf4j
public class Idea56383Service {
    private static final int IDEA_ID = 56383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56383Service() {
        this(new Idea56383Config());
    }

    public Idea56383Service(Idea56383Config config) {
        this.config = config != null ? config : new Idea56383Config();
