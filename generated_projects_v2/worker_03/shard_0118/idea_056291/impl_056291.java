...
@Data
public class Idea56291Config {
    private String name = "idea_056291";
 ...
 */
@Slf4j
public class Idea56291Service {
    private static final int IDEA_ID = 56291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56291Service() {
        this(new Idea56291Config());
    }

    public Idea56291Service(Idea56291Config config) {
        this.config = config != null ? config : new Idea56291Config();
