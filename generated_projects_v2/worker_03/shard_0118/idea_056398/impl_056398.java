...
@Data
public class Idea56398Config {
    private String name = "idea_056398";
 ...
 */
@Slf4j
public class Idea56398Service {
    private static final int IDEA_ID = 56398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56398Service() {
        this(new Idea56398Config());
    }

    public Idea56398Service(Idea56398Config config) {
        this.config = config != null ? config : new Idea56398Config();
