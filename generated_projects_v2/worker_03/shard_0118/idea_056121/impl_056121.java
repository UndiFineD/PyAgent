...
@Data
public class Idea56121Config {
    private String name = "idea_056121";
 ...
 */
@Slf4j
public class Idea56121Service {
    private static final int IDEA_ID = 56121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56121Service() {
        this(new Idea56121Config());
    }

    public Idea56121Service(Idea56121Config config) {
        this.config = config != null ? config : new Idea56121Config();
