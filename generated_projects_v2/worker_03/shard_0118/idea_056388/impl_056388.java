...
@Data
public class Idea56388Config {
    private String name = "idea_056388";
 ...
 */
@Slf4j
public class Idea56388Service {
    private static final int IDEA_ID = 56388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56388Service() {
        this(new Idea56388Config());
    }

    public Idea56388Service(Idea56388Config config) {
        this.config = config != null ? config : new Idea56388Config();
