...
@Data
public class Idea56189Config {
    private String name = "idea_056189";
 ...
 */
@Slf4j
public class Idea56189Service {
    private static final int IDEA_ID = 56189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56189Service() {
        this(new Idea56189Config());
    }

    public Idea56189Service(Idea56189Config config) {
        this.config = config != null ? config : new Idea56189Config();
