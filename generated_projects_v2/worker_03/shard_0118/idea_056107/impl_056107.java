...
@Data
public class Idea56107Config {
    private String name = "idea_056107";
 ...
 */
@Slf4j
public class Idea56107Service {
    private static final int IDEA_ID = 56107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56107Service() {
        this(new Idea56107Config());
    }

    public Idea56107Service(Idea56107Config config) {
        this.config = config != null ? config : new Idea56107Config();
