...
@Data
public class Idea56370Config {
    private String name = "idea_056370";
 ...
 */
@Slf4j
public class Idea56370Service {
    private static final int IDEA_ID = 56370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56370Service() {
        this(new Idea56370Config());
    }

    public Idea56370Service(Idea56370Config config) {
        this.config = config != null ? config : new Idea56370Config();
