...
@Data
public class Idea56236Config {
    private String name = "idea_056236";
 ...
 */
@Slf4j
public class Idea56236Service {
    private static final int IDEA_ID = 56236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56236Service() {
        this(new Idea56236Config());
    }

    public Idea56236Service(Idea56236Config config) {
        this.config = config != null ? config : new Idea56236Config();
