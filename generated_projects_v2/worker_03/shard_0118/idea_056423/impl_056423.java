...
@Data
public class Idea56423Config {
    private String name = "idea_056423";
 ...
 */
@Slf4j
public class Idea56423Service {
    private static final int IDEA_ID = 56423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56423Service() {
        this(new Idea56423Config());
    }

    public Idea56423Service(Idea56423Config config) {
        this.config = config != null ? config : new Idea56423Config();
