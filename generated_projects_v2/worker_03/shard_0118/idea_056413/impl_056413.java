...
@Data
public class Idea56413Config {
    private String name = "idea_056413";
 ...
 */
@Slf4j
public class Idea56413Service {
    private static final int IDEA_ID = 56413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56413Service() {
        this(new Idea56413Config());
    }

    public Idea56413Service(Idea56413Config config) {
        this.config = config != null ? config : new Idea56413Config();
