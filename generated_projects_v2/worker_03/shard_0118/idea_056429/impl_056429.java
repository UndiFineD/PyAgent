...
@Data
public class Idea56429Config {
    private String name = "idea_056429";
 ...
 */
@Slf4j
public class Idea56429Service {
    private static final int IDEA_ID = 56429;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56429Service() {
        this(new Idea56429Config());
    }

    public Idea56429Service(Idea56429Config config) {
        this.config = config != null ? config : new Idea56429Config();
