...
@Data
public class Idea56054Config {
    private String name = "idea_056054";
 ...
 */
@Slf4j
public class Idea56054Service {
    private static final int IDEA_ID = 56054;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56054Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56054Service() {
        this(new Idea56054Config());
    }

    public Idea56054Service(Idea56054Config config) {
        this.config = config != null ? config : new Idea56054Config();
