...
@Data
public class Idea56456Config {
    private String name = "idea_056456";
 ...
 */
@Slf4j
public class Idea56456Service {
    private static final int IDEA_ID = 56456;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56456Service() {
        this(new Idea56456Config());
    }

    public Idea56456Service(Idea56456Config config) {
        this.config = config != null ? config : new Idea56456Config();
