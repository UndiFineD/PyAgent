...
@Data
public class Idea56458Config {
    private String name = "idea_056458";
 ...
 */
@Slf4j
public class Idea56458Service {
    private static final int IDEA_ID = 56458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56458Service() {
        this(new Idea56458Config());
    }

    public Idea56458Service(Idea56458Config config) {
        this.config = config != null ? config : new Idea56458Config();
