...
@Data
public class Idea56365Config {
    private String name = "idea_056365";
 ...
 */
@Slf4j
public class Idea56365Service {
    private static final int IDEA_ID = 56365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56365Service() {
        this(new Idea56365Config());
    }

    public Idea56365Service(Idea56365Config config) {
        this.config = config != null ? config : new Idea56365Config();
