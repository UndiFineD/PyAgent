...
@Data
public class Idea56127Config {
    private String name = "idea_056127";
 ...
 */
@Slf4j
public class Idea56127Service {
    private static final int IDEA_ID = 56127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56127Service() {
        this(new Idea56127Config());
    }

    public Idea56127Service(Idea56127Config config) {
        this.config = config != null ? config : new Idea56127Config();
