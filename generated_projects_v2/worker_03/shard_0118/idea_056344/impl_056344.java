...
@Data
public class Idea56344Config {
    private String name = "idea_056344";
 ...
 */
@Slf4j
public class Idea56344Service {
    private static final int IDEA_ID = 56344;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56344Service() {
        this(new Idea56344Config());
    }

    public Idea56344Service(Idea56344Config config) {
        this.config = config != null ? config : new Idea56344Config();
