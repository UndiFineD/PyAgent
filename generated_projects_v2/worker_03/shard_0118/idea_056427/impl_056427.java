...
@Data
public class Idea56427Config {
    private String name = "idea_056427";
 ...
 */
@Slf4j
public class Idea56427Service {
    private static final int IDEA_ID = 56427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56427Service() {
        this(new Idea56427Config());
    }

    public Idea56427Service(Idea56427Config config) {
        this.config = config != null ? config : new Idea56427Config();
