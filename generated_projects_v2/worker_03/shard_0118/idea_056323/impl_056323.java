...
@Data
public class Idea56323Config {
    private String name = "idea_056323";
 ...
 */
@Slf4j
public class Idea56323Service {
    private static final int IDEA_ID = 56323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56323Service() {
        this(new Idea56323Config());
    }

    public Idea56323Service(Idea56323Config config) {
        this.config = config != null ? config : new Idea56323Config();
