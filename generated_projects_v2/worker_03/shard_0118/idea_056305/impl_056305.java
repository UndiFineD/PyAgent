...
@Data
public class Idea56305Config {
    private String name = "idea_056305";
 ...
 */
@Slf4j
public class Idea56305Service {
    private static final int IDEA_ID = 56305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56305Service() {
        this(new Idea56305Config());
    }

    public Idea56305Service(Idea56305Config config) {
        this.config = config != null ? config : new Idea56305Config();
