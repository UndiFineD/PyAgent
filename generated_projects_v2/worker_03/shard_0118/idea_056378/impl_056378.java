...
@Data
public class Idea56378Config {
    private String name = "idea_056378";
 ...
 */
@Slf4j
public class Idea56378Service {
    private static final int IDEA_ID = 56378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56378Service() {
        this(new Idea56378Config());
    }

    public Idea56378Service(Idea56378Config config) {
        this.config = config != null ? config : new Idea56378Config();
