...
@Data
public class Idea56222Config {
    private String name = "idea_056222";
 ...
 */
@Slf4j
public class Idea56222Service {
    private static final int IDEA_ID = 56222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56222Service() {
        this(new Idea56222Config());
    }

    public Idea56222Service(Idea56222Config config) {
        this.config = config != null ? config : new Idea56222Config();
