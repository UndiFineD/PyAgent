...
@Data
public class Idea56080Config {
    private String name = "idea_056080";
 ...
 */
@Slf4j
public class Idea56080Service {
    private static final int IDEA_ID = 56080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56080Service() {
        this(new Idea56080Config());
    }

    public Idea56080Service(Idea56080Config config) {
        this.config = config != null ? config : new Idea56080Config();
