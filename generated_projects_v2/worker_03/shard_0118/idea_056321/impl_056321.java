...
@Data
public class Idea56321Config {
    private String name = "idea_056321";
 ...
 */
@Slf4j
public class Idea56321Service {
    private static final int IDEA_ID = 56321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56321Service() {
        this(new Idea56321Config());
    }

    public Idea56321Service(Idea56321Config config) {
        this.config = config != null ? config : new Idea56321Config();
