...
@Data
public class Idea56096Config {
    private String name = "idea_056096";
 ...
 */
@Slf4j
public class Idea56096Service {
    private static final int IDEA_ID = 56096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56096Service() {
        this(new Idea56096Config());
    }

    public Idea56096Service(Idea56096Config config) {
        this.config = config != null ? config : new Idea56096Config();
