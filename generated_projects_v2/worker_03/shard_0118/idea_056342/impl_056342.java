...
@Data
public class Idea56342Config {
    private String name = "idea_056342";
 ...
 */
@Slf4j
public class Idea56342Service {
    private static final int IDEA_ID = 56342;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56342Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56342Service() {
        this(new Idea56342Config());
    }

    public Idea56342Service(Idea56342Config config) {
        this.config = config != null ? config : new Idea56342Config();
