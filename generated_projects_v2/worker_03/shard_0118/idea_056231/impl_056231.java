...
@Data
public class Idea56231Config {
    private String name = "idea_056231";
 ...
 */
@Slf4j
public class Idea56231Service {
    private static final int IDEA_ID = 56231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56231Service() {
        this(new Idea56231Config());
    }

    public Idea56231Service(Idea56231Config config) {
        this.config = config != null ? config : new Idea56231Config();
