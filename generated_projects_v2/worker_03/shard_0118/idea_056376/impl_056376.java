...
@Data
public class Idea56376Config {
    private String name = "idea_056376";
 ...
 */
@Slf4j
public class Idea56376Service {
    private static final int IDEA_ID = 56376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56376Service() {
        this(new Idea56376Config());
    }

    public Idea56376Service(Idea56376Config config) {
        this.config = config != null ? config : new Idea56376Config();
