...
@Data
public class Idea56101Config {
    private String name = "idea_056101";
 ...
 */
@Slf4j
public class Idea56101Service {
    private static final int IDEA_ID = 56101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56101Service() {
        this(new Idea56101Config());
    }

    public Idea56101Service(Idea56101Config config) {
        this.config = config != null ? config : new Idea56101Config();
