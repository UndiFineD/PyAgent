...
@Data
public class Idea56325Config {
    private String name = "idea_056325";
 ...
 */
@Slf4j
public class Idea56325Service {
    private static final int IDEA_ID = 56325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56325Service() {
        this(new Idea56325Config());
    }

    public Idea56325Service(Idea56325Config config) {
        this.config = config != null ? config : new Idea56325Config();
