...
@Data
public class Idea56069Config {
    private String name = "idea_056069";
 ...
 */
@Slf4j
public class Idea56069Service {
    private static final int IDEA_ID = 56069;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56069Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56069Service() {
        this(new Idea56069Config());
    }

    public Idea56069Service(Idea56069Config config) {
        this.config = config != null ? config : new Idea56069Config();
