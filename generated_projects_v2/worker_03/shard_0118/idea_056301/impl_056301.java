...
@Data
public class Idea56301Config {
    private String name = "idea_056301";
 ...
 */
@Slf4j
public class Idea56301Service {
    private static final int IDEA_ID = 56301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56301Service() {
        this(new Idea56301Config());
    }

    public Idea56301Service(Idea56301Config config) {
        this.config = config != null ? config : new Idea56301Config();
