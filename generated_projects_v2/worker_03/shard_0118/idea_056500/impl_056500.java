...
@Data
public class Idea56500Config {
    private String name = "idea_056500";
 ...
 */
@Slf4j
public class Idea56500Service {
    private static final int IDEA_ID = 56500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56500Service() {
        this(new Idea56500Config());
    }

    public Idea56500Service(Idea56500Config config) {
        this.config = config != null ? config : new Idea56500Config();
