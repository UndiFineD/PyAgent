...
@Data
public class Idea56418Config {
    private String name = "idea_056418";
 ...
 */
@Slf4j
public class Idea56418Service {
    private static final int IDEA_ID = 56418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56418Service() {
        this(new Idea56418Config());
    }

    public Idea56418Service(Idea56418Config config) {
        this.config = config != null ? config : new Idea56418Config();
