...
@Data
public class Idea56357Config {
    private String name = "idea_056357";
 ...
 */
@Slf4j
public class Idea56357Service {
    private static final int IDEA_ID = 56357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56357Service() {
        this(new Idea56357Config());
    }

    public Idea56357Service(Idea56357Config config) {
        this.config = config != null ? config : new Idea56357Config();
