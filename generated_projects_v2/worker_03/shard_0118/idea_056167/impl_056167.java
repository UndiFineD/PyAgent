...
@Data
public class Idea56167Config {
    private String name = "idea_056167";
 ...
 */
@Slf4j
public class Idea56167Service {
    private static final int IDEA_ID = 56167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56167Service() {
        this(new Idea56167Config());
    }

    public Idea56167Service(Idea56167Config config) {
        this.config = config != null ? config : new Idea56167Config();
