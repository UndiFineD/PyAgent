...
@Data
public class Idea56327Config {
    private String name = "idea_056327";
 ...
 */
@Slf4j
public class Idea56327Service {
    private static final int IDEA_ID = 56327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56327Service() {
        this(new Idea56327Config());
    }

    public Idea56327Service(Idea56327Config config) {
        this.config = config != null ? config : new Idea56327Config();
