...
@Data
public class Idea47966Config {
    private String name = "idea_047966";
 ...
 */
@Slf4j
public class Idea47966Service {
    private static final int IDEA_ID = 47966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47966Service() {
        this(new Idea47966Config());
    }

    public Idea47966Service(Idea47966Config config) {
        this.config = config != null ? config : new Idea47966Config();
