...
@Data
public class Idea47731Config {
    private String name = "idea_047731";
 ...
 */
@Slf4j
public class Idea47731Service {
    private static final int IDEA_ID = 47731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47731Service() {
        this(new Idea47731Config());
    }

    public Idea47731Service(Idea47731Config config) {
        this.config = config != null ? config : new Idea47731Config();
