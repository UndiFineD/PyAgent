...
@Data
public class Idea47884Config {
    private String name = "idea_047884";
 ...
 */
@Slf4j
public class Idea47884Service {
    private static final int IDEA_ID = 47884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47884Service() {
        this(new Idea47884Config());
    }

    public Idea47884Service(Idea47884Config config) {
        this.config = config != null ? config : new Idea47884Config();
