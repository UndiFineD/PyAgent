...
@Data
public class Idea47765Config {
    private String name = "idea_047765";
 ...
 */
@Slf4j
public class Idea47765Service {
    private static final int IDEA_ID = 47765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47765Service() {
        this(new Idea47765Config());
    }

    public Idea47765Service(Idea47765Config config) {
        this.config = config != null ? config : new Idea47765Config();
