...
@Data
public class Idea47787Config {
    private String name = "idea_047787";
 ...
 */
@Slf4j
public class Idea47787Service {
    private static final int IDEA_ID = 47787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47787Service() {
        this(new Idea47787Config());
    }

    public Idea47787Service(Idea47787Config config) {
        this.config = config != null ? config : new Idea47787Config();
