...
@Data
public class Idea47559Config {
    private String name = "idea_047559";
 ...
 */
@Slf4j
public class Idea47559Service {
    private static final int IDEA_ID = 47559;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47559Service() {
        this(new Idea47559Config());
    }

    public Idea47559Service(Idea47559Config config) {
        this.config = config != null ? config : new Idea47559Config();
