...
@Data
public class Idea47526Config {
    private String name = "idea_047526";
 ...
 */
@Slf4j
public class Idea47526Service {
    private static final int IDEA_ID = 47526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47526Service() {
        this(new Idea47526Config());
    }

    public Idea47526Service(Idea47526Config config) {
        this.config = config != null ? config : new Idea47526Config();
