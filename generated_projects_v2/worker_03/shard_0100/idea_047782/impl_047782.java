...
@Data
public class Idea47782Config {
    private String name = "idea_047782";
 ...
 */
@Slf4j
public class Idea47782Service {
    private static final int IDEA_ID = 47782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47782Service() {
        this(new Idea47782Config());
    }

    public Idea47782Service(Idea47782Config config) {
        this.config = config != null ? config : new Idea47782Config();
