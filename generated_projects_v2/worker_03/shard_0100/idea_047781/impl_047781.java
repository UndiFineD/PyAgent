...
@Data
public class Idea47781Config {
    private String name = "idea_047781";
 ...
 */
@Slf4j
public class Idea47781Service {
    private static final int IDEA_ID = 47781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47781Service() {
        this(new Idea47781Config());
    }

    public Idea47781Service(Idea47781Config config) {
        this.config = config != null ? config : new Idea47781Config();
