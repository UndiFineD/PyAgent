...
@Data
public class Idea47644Config {
    private String name = "idea_047644";
 ...
 */
@Slf4j
public class Idea47644Service {
    private static final int IDEA_ID = 47644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47644Service() {
        this(new Idea47644Config());
    }

    public Idea47644Service(Idea47644Config config) {
        this.config = config != null ? config : new Idea47644Config();
