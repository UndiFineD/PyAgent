...
@Data
public class Idea47826Config {
    private String name = "idea_047826";
 ...
 */
@Slf4j
public class Idea47826Service {
    private static final int IDEA_ID = 47826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47826Service() {
        this(new Idea47826Config());
    }

    public Idea47826Service(Idea47826Config config) {
        this.config = config != null ? config : new Idea47826Config();
