...
@Data
public class Idea47746Config {
    private String name = "idea_047746";
 ...
 */
@Slf4j
public class Idea47746Service {
    private static final int IDEA_ID = 47746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47746Service() {
        this(new Idea47746Config());
    }

    public Idea47746Service(Idea47746Config config) {
        this.config = config != null ? config : new Idea47746Config();
