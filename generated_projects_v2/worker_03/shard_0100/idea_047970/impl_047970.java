...
@Data
public class Idea47970Config {
    private String name = "idea_047970";
 ...
 */
@Slf4j
public class Idea47970Service {
    private static final int IDEA_ID = 47970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47970Service() {
        this(new Idea47970Config());
    }

    public Idea47970Service(Idea47970Config config) {
        this.config = config != null ? config : new Idea47970Config();
