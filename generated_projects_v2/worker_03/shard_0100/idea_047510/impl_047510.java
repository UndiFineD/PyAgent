...
@Data
public class Idea47510Config {
    private String name = "idea_047510";
 ...
 */
@Slf4j
public class Idea47510Service {
    private static final int IDEA_ID = 47510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47510Service() {
        this(new Idea47510Config());
    }

    public Idea47510Service(Idea47510Config config) {
        this.config = config != null ? config : new Idea47510Config();
