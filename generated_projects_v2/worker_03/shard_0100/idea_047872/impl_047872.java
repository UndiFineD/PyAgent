...
@Data
public class Idea47872Config {
    private String name = "idea_047872";
 ...
 */
@Slf4j
public class Idea47872Service {
    private static final int IDEA_ID = 47872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47872Service() {
        this(new Idea47872Config());
    }

    public Idea47872Service(Idea47872Config config) {
        this.config = config != null ? config : new Idea47872Config();
