...
@Data
public class Idea47723Config {
    private String name = "idea_047723";
 ...
 */
@Slf4j
public class Idea47723Service {
    private static final int IDEA_ID = 47723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47723Service() {
        this(new Idea47723Config());
    }

    public Idea47723Service(Idea47723Config config) {
        this.config = config != null ? config : new Idea47723Config();
