...
@Data
public class Idea47586Config {
    private String name = "idea_047586";
 ...
 */
@Slf4j
public class Idea47586Service {
    private static final int IDEA_ID = 47586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47586Service() {
        this(new Idea47586Config());
    }

    public Idea47586Service(Idea47586Config config) {
        this.config = config != null ? config : new Idea47586Config();
