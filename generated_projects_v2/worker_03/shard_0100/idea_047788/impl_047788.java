...
@Data
public class Idea47788Config {
    private String name = "idea_047788";
 ...
 */
@Slf4j
public class Idea47788Service {
    private static final int IDEA_ID = 47788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47788Service() {
        this(new Idea47788Config());
    }

    public Idea47788Service(Idea47788Config config) {
        this.config = config != null ? config : new Idea47788Config();
