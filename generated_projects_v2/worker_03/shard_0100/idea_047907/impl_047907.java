...
@Data
public class Idea47907Config {
    private String name = "idea_047907";
 ...
 */
@Slf4j
public class Idea47907Service {
    private static final int IDEA_ID = 47907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47907Service() {
        this(new Idea47907Config());
    }

    public Idea47907Service(Idea47907Config config) {
        this.config = config != null ? config : new Idea47907Config();
