...
@Data
public class Idea47840Config {
    private String name = "idea_047840";
 ...
 */
@Slf4j
public class Idea47840Service {
    private static final int IDEA_ID = 47840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47840Service() {
        this(new Idea47840Config());
    }

    public Idea47840Service(Idea47840Config config) {
        this.config = config != null ? config : new Idea47840Config();
