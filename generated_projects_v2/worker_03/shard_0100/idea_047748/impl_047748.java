...
@Data
public class Idea47748Config {
    private String name = "idea_047748";
 ...
 */
@Slf4j
public class Idea47748Service {
    private static final int IDEA_ID = 47748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47748Service() {
        this(new Idea47748Config());
    }

    public Idea47748Service(Idea47748Config config) {
        this.config = config != null ? config : new Idea47748Config();
