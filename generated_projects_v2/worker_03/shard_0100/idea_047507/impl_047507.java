...
@Data
public class Idea47507Config {
    private String name = "idea_047507";
 ...
 */
@Slf4j
public class Idea47507Service {
    private static final int IDEA_ID = 47507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47507Service() {
        this(new Idea47507Config());
    }

    public Idea47507Service(Idea47507Config config) {
        this.config = config != null ? config : new Idea47507Config();
