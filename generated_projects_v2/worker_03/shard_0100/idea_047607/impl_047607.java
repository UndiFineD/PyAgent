...
@Data
public class Idea47607Config {
    private String name = "idea_047607";
 ...
 */
@Slf4j
public class Idea47607Service {
    private static final int IDEA_ID = 47607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47607Service() {
        this(new Idea47607Config());
    }

    public Idea47607Service(Idea47607Config config) {
        this.config = config != null ? config : new Idea47607Config();
