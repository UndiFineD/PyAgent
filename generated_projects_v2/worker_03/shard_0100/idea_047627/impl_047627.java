...
@Data
public class Idea47627Config {
    private String name = "idea_047627";
 ...
 */
@Slf4j
public class Idea47627Service {
    private static final int IDEA_ID = 47627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47627Service() {
        this(new Idea47627Config());
    }

    public Idea47627Service(Idea47627Config config) {
        this.config = config != null ? config : new Idea47627Config();
