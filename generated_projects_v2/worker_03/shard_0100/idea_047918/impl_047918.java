...
@Data
public class Idea47918Config {
    private String name = "idea_047918";
 ...
 */
@Slf4j
public class Idea47918Service {
    private static final int IDEA_ID = 47918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47918Service() {
        this(new Idea47918Config());
    }

    public Idea47918Service(Idea47918Config config) {
        this.config = config != null ? config : new Idea47918Config();
