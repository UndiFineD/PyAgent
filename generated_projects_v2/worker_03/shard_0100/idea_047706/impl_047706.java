...
@Data
public class Idea47706Config {
    private String name = "idea_047706";
 ...
 */
@Slf4j
public class Idea47706Service {
    private static final int IDEA_ID = 47706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47706Service() {
        this(new Idea47706Config());
    }

    public Idea47706Service(Idea47706Config config) {
        this.config = config != null ? config : new Idea47706Config();
