...
@Data
public class Idea47666Config {
    private String name = "idea_047666";
 ...
 */
@Slf4j
public class Idea47666Service {
    private static final int IDEA_ID = 47666;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47666Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47666Service() {
        this(new Idea47666Config());
    }

    public Idea47666Service(Idea47666Config config) {
        this.config = config != null ? config : new Idea47666Config();
