...
@Data
public class Idea47729Config {
    private String name = "idea_047729";
 ...
 */
@Slf4j
public class Idea47729Service {
    private static final int IDEA_ID = 47729;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47729Service() {
        this(new Idea47729Config());
    }

    public Idea47729Service(Idea47729Config config) {
        this.config = config != null ? config : new Idea47729Config();
