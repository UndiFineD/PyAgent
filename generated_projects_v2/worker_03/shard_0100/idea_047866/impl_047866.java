...
@Data
public class Idea47866Config {
    private String name = "idea_047866";
 ...
 */
@Slf4j
public class Idea47866Service {
    private static final int IDEA_ID = 47866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47866Service() {
        this(new Idea47866Config());
    }

    public Idea47866Service(Idea47866Config config) {
        this.config = config != null ? config : new Idea47866Config();
