...
@Data
public class Idea47738Config {
    private String name = "idea_047738";
 ...
 */
@Slf4j
public class Idea47738Service {
    private static final int IDEA_ID = 47738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47738Service() {
        this(new Idea47738Config());
    }

    public Idea47738Service(Idea47738Config config) {
        this.config = config != null ? config : new Idea47738Config();
