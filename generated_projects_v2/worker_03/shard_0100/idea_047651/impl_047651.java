...
@Data
public class Idea47651Config {
    private String name = "idea_047651";
 ...
 */
@Slf4j
public class Idea47651Service {
    private static final int IDEA_ID = 47651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47651Service() {
        this(new Idea47651Config());
    }

    public Idea47651Service(Idea47651Config config) {
        this.config = config != null ? config : new Idea47651Config();
