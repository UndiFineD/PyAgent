...
@Data
public class Idea47659Config {
    private String name = "idea_047659";
 ...
 */
@Slf4j
public class Idea47659Service {
    private static final int IDEA_ID = 47659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47659Service() {
        this(new Idea47659Config());
    }

    public Idea47659Service(Idea47659Config config) {
        this.config = config != null ? config : new Idea47659Config();
