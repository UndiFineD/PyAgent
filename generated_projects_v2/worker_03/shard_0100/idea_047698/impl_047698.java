...
@Data
public class Idea47698Config {
    private String name = "idea_047698";
 ...
 */
@Slf4j
public class Idea47698Service {
    private static final int IDEA_ID = 47698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47698Service() {
        this(new Idea47698Config());
    }

    public Idea47698Service(Idea47698Config config) {
        this.config = config != null ? config : new Idea47698Config();
