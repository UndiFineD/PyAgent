...
@Data
public class Idea47564Config {
    private String name = "idea_047564";
 ...
 */
@Slf4j
public class Idea47564Service {
    private static final int IDEA_ID = 47564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47564Service() {
        this(new Idea47564Config());
    }

    public Idea47564Service(Idea47564Config config) {
        this.config = config != null ? config : new Idea47564Config();
