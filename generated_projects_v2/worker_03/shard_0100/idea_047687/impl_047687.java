...
@Data
public class Idea47687Config {
    private String name = "idea_047687";
 ...
 */
@Slf4j
public class Idea47687Service {
    private static final int IDEA_ID = 47687;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47687Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47687Service() {
        this(new Idea47687Config());
    }

    public Idea47687Service(Idea47687Config config) {
        this.config = config != null ? config : new Idea47687Config();
