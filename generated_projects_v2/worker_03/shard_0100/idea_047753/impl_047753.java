...
@Data
public class Idea47753Config {
    private String name = "idea_047753";
 ...
 */
@Slf4j
public class Idea47753Service {
    private static final int IDEA_ID = 47753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47753Service() {
        this(new Idea47753Config());
    }

    public Idea47753Service(Idea47753Config config) {
        this.config = config != null ? config : new Idea47753Config();
