...
@Data
public class Idea47971Config {
    private String name = "idea_047971";
 ...
 */
@Slf4j
public class Idea47971Service {
    private static final int IDEA_ID = 47971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47971Service() {
        this(new Idea47971Config());
    }

    public Idea47971Service(Idea47971Config config) {
        this.config = config != null ? config : new Idea47971Config();
