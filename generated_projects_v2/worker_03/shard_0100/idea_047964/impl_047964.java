...
@Data
public class Idea47964Config {
    private String name = "idea_047964";
 ...
 */
@Slf4j
public class Idea47964Service {
    private static final int IDEA_ID = 47964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47964Service() {
        this(new Idea47964Config());
    }

    public Idea47964Service(Idea47964Config config) {
        this.config = config != null ? config : new Idea47964Config();
