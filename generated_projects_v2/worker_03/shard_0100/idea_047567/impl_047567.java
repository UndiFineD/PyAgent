...
@Data
public class Idea47567Config {
    private String name = "idea_047567";
 ...
 */
@Slf4j
public class Idea47567Service {
    private static final int IDEA_ID = 47567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47567Service() {
        this(new Idea47567Config());
    }

    public Idea47567Service(Idea47567Config config) {
        this.config = config != null ? config : new Idea47567Config();
