...
@Data
public class Idea47798Config {
    private String name = "idea_047798";
 ...
 */
@Slf4j
public class Idea47798Service {
    private static final int IDEA_ID = 47798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47798Service() {
        this(new Idea47798Config());
    }

    public Idea47798Service(Idea47798Config config) {
        this.config = config != null ? config : new Idea47798Config();
