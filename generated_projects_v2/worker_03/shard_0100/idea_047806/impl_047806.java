...
@Data
public class Idea47806Config {
    private String name = "idea_047806";
 ...
 */
@Slf4j
public class Idea47806Service {
    private static final int IDEA_ID = 47806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47806Service() {
        this(new Idea47806Config());
    }

    public Idea47806Service(Idea47806Config config) {
        this.config = config != null ? config : new Idea47806Config();
