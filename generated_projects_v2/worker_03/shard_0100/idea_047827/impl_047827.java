...
@Data
public class Idea47827Config {
    private String name = "idea_047827";
 ...
 */
@Slf4j
public class Idea47827Service {
    private static final int IDEA_ID = 47827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47827Service() {
        this(new Idea47827Config());
    }

    public Idea47827Service(Idea47827Config config) {
        this.config = config != null ? config : new Idea47827Config();
