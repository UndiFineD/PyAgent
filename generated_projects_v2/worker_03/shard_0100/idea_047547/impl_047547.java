...
@Data
public class Idea47547Config {
    private String name = "idea_047547";
 ...
 */
@Slf4j
public class Idea47547Service {
    private static final int IDEA_ID = 47547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47547Service() {
        this(new Idea47547Config());
    }

    public Idea47547Service(Idea47547Config config) {
        this.config = config != null ? config : new Idea47547Config();
