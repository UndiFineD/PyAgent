...
@Data
public class Idea47555Config {
    private String name = "idea_047555";
 ...
 */
@Slf4j
public class Idea47555Service {
    private static final int IDEA_ID = 47555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47555Service() {
        this(new Idea47555Config());
    }

    public Idea47555Service(Idea47555Config config) {
        this.config = config != null ? config : new Idea47555Config();
