...
@Data
public class Idea47685Config {
    private String name = "idea_047685";
 ...
 */
@Slf4j
public class Idea47685Service {
    private static final int IDEA_ID = 47685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47685Service() {
        this(new Idea47685Config());
    }

    public Idea47685Service(Idea47685Config config) {
        this.config = config != null ? config : new Idea47685Config();
