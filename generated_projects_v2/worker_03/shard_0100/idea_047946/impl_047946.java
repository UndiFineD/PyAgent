...
@Data
public class Idea47946Config {
    private String name = "idea_047946";
 ...
 */
@Slf4j
public class Idea47946Service {
    private static final int IDEA_ID = 47946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47946Service() {
        this(new Idea47946Config());
    }

    public Idea47946Service(Idea47946Config config) {
        this.config = config != null ? config : new Idea47946Config();
