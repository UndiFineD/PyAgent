...
@Data
public class Idea47967Config {
    private String name = "idea_047967";
 ...
 */
@Slf4j
public class Idea47967Service {
    private static final int IDEA_ID = 47967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47967Service() {
        this(new Idea47967Config());
    }

    public Idea47967Service(Idea47967Config config) {
        this.config = config != null ? config : new Idea47967Config();
