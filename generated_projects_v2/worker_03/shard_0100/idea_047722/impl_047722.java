...
@Data
public class Idea47722Config {
    private String name = "idea_047722";
 ...
 */
@Slf4j
public class Idea47722Service {
    private static final int IDEA_ID = 47722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47722Service() {
        this(new Idea47722Config());
    }

    public Idea47722Service(Idea47722Config config) {
        this.config = config != null ? config : new Idea47722Config();
