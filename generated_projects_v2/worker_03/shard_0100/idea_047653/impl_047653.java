...
@Data
public class Idea47653Config {
    private String name = "idea_047653";
 ...
 */
@Slf4j
public class Idea47653Service {
    private static final int IDEA_ID = 47653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47653Service() {
        this(new Idea47653Config());
    }

    public Idea47653Service(Idea47653Config config) {
        this.config = config != null ? config : new Idea47653Config();
