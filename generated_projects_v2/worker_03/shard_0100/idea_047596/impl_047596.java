...
@Data
public class Idea47596Config {
    private String name = "idea_047596";
 ...
 */
@Slf4j
public class Idea47596Service {
    private static final int IDEA_ID = 47596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47596Service() {
        this(new Idea47596Config());
    }

    public Idea47596Service(Idea47596Config config) {
        this.config = config != null ? config : new Idea47596Config();
