...
@Data
public class Idea47935Config {
    private String name = "idea_047935";
 ...
 */
@Slf4j
public class Idea47935Service {
    private static final int IDEA_ID = 47935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47935Service() {
        this(new Idea47935Config());
    }

    public Idea47935Service(Idea47935Config config) {
        this.config = config != null ? config : new Idea47935Config();
