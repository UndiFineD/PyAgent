...
@Data
public class Idea47893Config {
    private String name = "idea_047893";
 ...
 */
@Slf4j
public class Idea47893Service {
    private static final int IDEA_ID = 47893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47893Service() {
        this(new Idea47893Config());
    }

    public Idea47893Service(Idea47893Config config) {
        this.config = config != null ? config : new Idea47893Config();
