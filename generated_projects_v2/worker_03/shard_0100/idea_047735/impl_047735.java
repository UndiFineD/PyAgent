...
@Data
public class Idea47735Config {
    private String name = "idea_047735";
 ...
 */
@Slf4j
public class Idea47735Service {
    private static final int IDEA_ID = 47735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47735Service() {
        this(new Idea47735Config());
    }

    public Idea47735Service(Idea47735Config config) {
        this.config = config != null ? config : new Idea47735Config();
