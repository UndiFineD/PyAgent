...
@Data
public class Idea47508Config {
    private String name = "idea_047508";
 ...
 */
@Slf4j
public class Idea47508Service {
    private static final int IDEA_ID = 47508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47508Service() {
        this(new Idea47508Config());
    }

    public Idea47508Service(Idea47508Config config) {
        this.config = config != null ? config : new Idea47508Config();
