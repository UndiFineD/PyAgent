...
@Data
public class Idea47640Config {
    private String name = "idea_047640";
 ...
 */
@Slf4j
public class Idea47640Service {
    private static final int IDEA_ID = 47640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47640Service() {
        this(new Idea47640Config());
    }

    public Idea47640Service(Idea47640Config config) {
        this.config = config != null ? config : new Idea47640Config();
