...
@Data
public class Idea47809Config {
    private String name = "idea_047809";
 ...
 */
@Slf4j
public class Idea47809Service {
    private static final int IDEA_ID = 47809;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47809Service() {
        this(new Idea47809Config());
    }

    public Idea47809Service(Idea47809Config config) {
        this.config = config != null ? config : new Idea47809Config();
