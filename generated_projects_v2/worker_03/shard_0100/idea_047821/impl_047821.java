...
@Data
public class Idea47821Config {
    private String name = "idea_047821";
 ...
 */
@Slf4j
public class Idea47821Service {
    private static final int IDEA_ID = 47821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47821Service() {
        this(new Idea47821Config());
    }

    public Idea47821Service(Idea47821Config config) {
        this.config = config != null ? config : new Idea47821Config();
