...
@Data
public class Idea47570Config {
    private String name = "idea_047570";
 ...
 */
@Slf4j
public class Idea47570Service {
    private static final int IDEA_ID = 47570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47570Service() {
        this(new Idea47570Config());
    }

    public Idea47570Service(Idea47570Config config) {
        this.config = config != null ? config : new Idea47570Config();
