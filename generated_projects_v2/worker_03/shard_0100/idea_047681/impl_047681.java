...
@Data
public class Idea47681Config {
    private String name = "idea_047681";
 ...
 */
@Slf4j
public class Idea47681Service {
    private static final int IDEA_ID = 47681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47681Service() {
        this(new Idea47681Config());
    }

    public Idea47681Service(Idea47681Config config) {
        this.config = config != null ? config : new Idea47681Config();
