...
@Data
public class Idea47654Config {
    private String name = "idea_047654";
 ...
 */
@Slf4j
public class Idea47654Service {
    private static final int IDEA_ID = 47654;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47654Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47654Service() {
        this(new Idea47654Config());
    }

    public Idea47654Service(Idea47654Config config) {
        this.config = config != null ? config : new Idea47654Config();
