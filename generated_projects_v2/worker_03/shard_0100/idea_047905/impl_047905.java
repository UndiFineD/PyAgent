...
@Data
public class Idea47905Config {
    private String name = "idea_047905";
 ...
 */
@Slf4j
public class Idea47905Service {
    private static final int IDEA_ID = 47905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47905Service() {
        this(new Idea47905Config());
    }

    public Idea47905Service(Idea47905Config config) {
        this.config = config != null ? config : new Idea47905Config();
