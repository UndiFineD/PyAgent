...
@Data
public class Idea47535Config {
    private String name = "idea_047535";
 ...
 */
@Slf4j
public class Idea47535Service {
    private static final int IDEA_ID = 47535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47535Service() {
        this(new Idea47535Config());
    }

    public Idea47535Service(Idea47535Config config) {
        this.config = config != null ? config : new Idea47535Config();
