...
@Data
public class Idea47790Config {
    private String name = "idea_047790";
 ...
 */
@Slf4j
public class Idea47790Service {
    private static final int IDEA_ID = 47790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47790Service() {
        this(new Idea47790Config());
    }

    public Idea47790Service(Idea47790Config config) {
        this.config = config != null ? config : new Idea47790Config();
