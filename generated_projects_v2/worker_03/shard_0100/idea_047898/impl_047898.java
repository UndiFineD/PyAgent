...
@Data
public class Idea47898Config {
    private String name = "idea_047898";
 ...
 */
@Slf4j
public class Idea47898Service {
    private static final int IDEA_ID = 47898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47898Service() {
        this(new Idea47898Config());
    }

    public Idea47898Service(Idea47898Config config) {
        this.config = config != null ? config : new Idea47898Config();
