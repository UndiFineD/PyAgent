...
@Data
public class Idea47628Config {
    private String name = "idea_047628";
 ...
 */
@Slf4j
public class Idea47628Service {
    private static final int IDEA_ID = 47628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47628Service() {
        this(new Idea47628Config());
    }

    public Idea47628Service(Idea47628Config config) {
        this.config = config != null ? config : new Idea47628Config();
