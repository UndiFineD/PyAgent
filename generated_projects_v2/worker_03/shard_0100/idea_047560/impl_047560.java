...
@Data
public class Idea47560Config {
    private String name = "idea_047560";
 ...
 */
@Slf4j
public class Idea47560Service {
    private static final int IDEA_ID = 47560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47560Service() {
        this(new Idea47560Config());
    }

    public Idea47560Service(Idea47560Config config) {
        this.config = config != null ? config : new Idea47560Config();
