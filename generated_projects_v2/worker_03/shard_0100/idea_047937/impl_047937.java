...
@Data
public class Idea47937Config {
    private String name = "idea_047937";
 ...
 */
@Slf4j
public class Idea47937Service {
    private static final int IDEA_ID = 47937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47937Service() {
        this(new Idea47937Config());
    }

    public Idea47937Service(Idea47937Config config) {
        this.config = config != null ? config : new Idea47937Config();
