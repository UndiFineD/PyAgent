...
@Data
public class Idea47578Config {
    private String name = "idea_047578";
 ...
 */
@Slf4j
public class Idea47578Service {
    private static final int IDEA_ID = 47578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47578Service() {
        this(new Idea47578Config());
    }

    public Idea47578Service(Idea47578Config config) {
        this.config = config != null ? config : new Idea47578Config();
