...
@Data
public class Idea47815Config {
    private String name = "idea_047815";
 ...
 */
@Slf4j
public class Idea47815Service {
    private static final int IDEA_ID = 47815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47815Service() {
        this(new Idea47815Config());
    }

    public Idea47815Service(Idea47815Config config) {
        this.config = config != null ? config : new Idea47815Config();
