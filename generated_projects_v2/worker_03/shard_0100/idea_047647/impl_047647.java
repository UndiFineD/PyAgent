...
@Data
public class Idea47647Config {
    private String name = "idea_047647";
 ...
 */
@Slf4j
public class Idea47647Service {
    private static final int IDEA_ID = 47647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47647Service() {
        this(new Idea47647Config());
    }

    public Idea47647Service(Idea47647Config config) {
        this.config = config != null ? config : new Idea47647Config();
