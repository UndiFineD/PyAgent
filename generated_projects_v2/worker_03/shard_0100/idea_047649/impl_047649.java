...
@Data
public class Idea47649Config {
    private String name = "idea_047649";
 ...
 */
@Slf4j
public class Idea47649Service {
    private static final int IDEA_ID = 47649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47649Service() {
        this(new Idea47649Config());
    }

    public Idea47649Service(Idea47649Config config) {
        this.config = config != null ? config : new Idea47649Config();
