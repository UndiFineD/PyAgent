...
@Data
public class Idea47537Config {
    private String name = "idea_047537";
 ...
 */
@Slf4j
public class Idea47537Service {
    private static final int IDEA_ID = 47537;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47537Service() {
        this(new Idea47537Config());
    }

    public Idea47537Service(Idea47537Config config) {
        this.config = config != null ? config : new Idea47537Config();
