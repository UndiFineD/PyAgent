...
@Data
public class Idea47785Config {
    private String name = "idea_047785";
 ...
 */
@Slf4j
public class Idea47785Service {
    private static final int IDEA_ID = 47785;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47785Service() {
        this(new Idea47785Config());
    }

    public Idea47785Service(Idea47785Config config) {
        this.config = config != null ? config : new Idea47785Config();
