...
@Data
public class Idea47846Config {
    private String name = "idea_047846";
 ...
 */
@Slf4j
public class Idea47846Service {
    private static final int IDEA_ID = 47846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47846Service() {
        this(new Idea47846Config());
    }

    public Idea47846Service(Idea47846Config config) {
        this.config = config != null ? config : new Idea47846Config();
