...
@Data
public class Idea47917Config {
    private String name = "idea_047917";
 ...
 */
@Slf4j
public class Idea47917Service {
    private static final int IDEA_ID = 47917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47917Service() {
        this(new Idea47917Config());
    }

    public Idea47917Service(Idea47917Config config) {
        this.config = config != null ? config : new Idea47917Config();
