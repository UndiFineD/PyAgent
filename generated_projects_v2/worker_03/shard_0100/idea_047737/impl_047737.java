...
@Data
public class Idea47737Config {
    private String name = "idea_047737";
 ...
 */
@Slf4j
public class Idea47737Service {
    private static final int IDEA_ID = 47737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47737Service() {
        this(new Idea47737Config());
    }

    public Idea47737Service(Idea47737Config config) {
        this.config = config != null ? config : new Idea47737Config();
