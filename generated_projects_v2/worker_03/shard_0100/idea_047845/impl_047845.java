...
@Data
public class Idea47845Config {
    private String name = "idea_047845";
 ...
 */
@Slf4j
public class Idea47845Service {
    private static final int IDEA_ID = 47845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47845Service() {
        this(new Idea47845Config());
    }

    public Idea47845Service(Idea47845Config config) {
        this.config = config != null ? config : new Idea47845Config();
