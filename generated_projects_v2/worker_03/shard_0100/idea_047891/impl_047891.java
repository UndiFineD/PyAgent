...
@Data
public class Idea47891Config {
    private String name = "idea_047891";
 ...
 */
@Slf4j
public class Idea47891Service {
    private static final int IDEA_ID = 47891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47891Service() {
        this(new Idea47891Config());
    }

    public Idea47891Service(Idea47891Config config) {
        this.config = config != null ? config : new Idea47891Config();
