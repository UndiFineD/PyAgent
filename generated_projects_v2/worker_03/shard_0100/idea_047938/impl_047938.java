...
@Data
public class Idea47938Config {
    private String name = "idea_047938";
 ...
 */
@Slf4j
public class Idea47938Service {
    private static final int IDEA_ID = 47938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47938Service() {
        this(new Idea47938Config());
    }

    public Idea47938Service(Idea47938Config config) {
        this.config = config != null ? config : new Idea47938Config();
