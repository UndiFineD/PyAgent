...
@Data
public class Idea47903Config {
    private String name = "idea_047903";
 ...
 */
@Slf4j
public class Idea47903Service {
    private static final int IDEA_ID = 47903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47903Service() {
        this(new Idea47903Config());
    }

    public Idea47903Service(Idea47903Config config) {
        this.config = config != null ? config : new Idea47903Config();
