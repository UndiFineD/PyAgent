...
@Data
public class Idea47873Config {
    private String name = "idea_047873";
 ...
 */
@Slf4j
public class Idea47873Service {
    private static final int IDEA_ID = 47873;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47873Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47873Service() {
        this(new Idea47873Config());
    }

    public Idea47873Service(Idea47873Config config) {
        this.config = config != null ? config : new Idea47873Config();
