...
@Data
public class Idea47740Config {
    private String name = "idea_047740";
 ...
 */
@Slf4j
public class Idea47740Service {
    private static final int IDEA_ID = 47740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47740Service() {
        this(new Idea47740Config());
    }

    public Idea47740Service(Idea47740Config config) {
        this.config = config != null ? config : new Idea47740Config();
