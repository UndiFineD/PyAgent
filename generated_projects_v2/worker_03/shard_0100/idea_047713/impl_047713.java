...
@Data
public class Idea47713Config {
    private String name = "idea_047713";
 ...
 */
@Slf4j
public class Idea47713Service {
    private static final int IDEA_ID = 47713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47713Service() {
        this(new Idea47713Config());
    }

    public Idea47713Service(Idea47713Config config) {
        this.config = config != null ? config : new Idea47713Config();
