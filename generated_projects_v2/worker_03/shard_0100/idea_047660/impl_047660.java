...
@Data
public class Idea47660Config {
    private String name = "idea_047660";
 ...
 */
@Slf4j
public class Idea47660Service {
    private static final int IDEA_ID = 47660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47660Service() {
        this(new Idea47660Config());
    }

    public Idea47660Service(Idea47660Config config) {
        this.config = config != null ? config : new Idea47660Config();
