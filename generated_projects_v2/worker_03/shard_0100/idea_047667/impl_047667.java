...
@Data
public class Idea47667Config {
    private String name = "idea_047667";
 ...
 */
@Slf4j
public class Idea47667Service {
    private static final int IDEA_ID = 47667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47667Service() {
        this(new Idea47667Config());
    }

    public Idea47667Service(Idea47667Config config) {
        this.config = config != null ? config : new Idea47667Config();
