...
@Data
public class Idea47583Config {
    private String name = "idea_047583";
 ...
 */
@Slf4j
public class Idea47583Service {
    private static final int IDEA_ID = 47583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47583Service() {
        this(new Idea47583Config());
    }

    public Idea47583Service(Idea47583Config config) {
        this.config = config != null ? config : new Idea47583Config();
