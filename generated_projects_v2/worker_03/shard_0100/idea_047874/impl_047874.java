...
@Data
public class Idea47874Config {
    private String name = "idea_047874";
 ...
 */
@Slf4j
public class Idea47874Service {
    private static final int IDEA_ID = 47874;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47874Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47874Service() {
        this(new Idea47874Config());
    }

    public Idea47874Service(Idea47874Config config) {
        this.config = config != null ? config : new Idea47874Config();
