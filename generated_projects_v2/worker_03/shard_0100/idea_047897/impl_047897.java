...
@Data
public class Idea47897Config {
    private String name = "idea_047897";
 ...
 */
@Slf4j
public class Idea47897Service {
    private static final int IDEA_ID = 47897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47897Service() {
        this(new Idea47897Config());
    }

    public Idea47897Service(Idea47897Config config) {
        this.config = config != null ? config : new Idea47897Config();
