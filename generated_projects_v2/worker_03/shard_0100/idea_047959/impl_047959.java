...
@Data
public class Idea47959Config {
    private String name = "idea_047959";
 ...
 */
@Slf4j
public class Idea47959Service {
    private static final int IDEA_ID = 47959;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47959Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47959Service() {
        this(new Idea47959Config());
    }

    public Idea47959Service(Idea47959Config config) {
        this.config = config != null ? config : new Idea47959Config();
