...
@Data
public class Idea47875Config {
    private String name = "idea_047875";
 ...
 */
@Slf4j
public class Idea47875Service {
    private static final int IDEA_ID = 47875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47875Service() {
        this(new Idea47875Config());
    }

    public Idea47875Service(Idea47875Config config) {
        this.config = config != null ? config : new Idea47875Config();
