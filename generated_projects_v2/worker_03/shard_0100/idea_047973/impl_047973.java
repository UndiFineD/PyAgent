...
@Data
public class Idea47973Config {
    private String name = "idea_047973";
 ...
 */
@Slf4j
public class Idea47973Service {
    private static final int IDEA_ID = 47973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47973Service() {
        this(new Idea47973Config());
    }

    public Idea47973Service(Idea47973Config config) {
        this.config = config != null ? config : new Idea47973Config();
