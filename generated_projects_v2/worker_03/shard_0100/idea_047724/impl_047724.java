...
@Data
public class Idea47724Config {
    private String name = "idea_047724";
 ...
 */
@Slf4j
public class Idea47724Service {
    private static final int IDEA_ID = 47724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47724Service() {
        this(new Idea47724Config());
    }

    public Idea47724Service(Idea47724Config config) {
        this.config = config != null ? config : new Idea47724Config();
