...
@Data
public class Idea47650Config {
    private String name = "idea_047650";
 ...
 */
@Slf4j
public class Idea47650Service {
    private static final int IDEA_ID = 47650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47650Service() {
        this(new Idea47650Config());
    }

    public Idea47650Service(Idea47650Config config) {
        this.config = config != null ? config : new Idea47650Config();
