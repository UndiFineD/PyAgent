...
@Data
public class Idea47960Config {
    private String name = "idea_047960";
 ...
 */
@Slf4j
public class Idea47960Service {
    private static final int IDEA_ID = 47960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47960Service() {
        this(new Idea47960Config());
    }

    public Idea47960Service(Idea47960Config config) {
        this.config = config != null ? config : new Idea47960Config();
