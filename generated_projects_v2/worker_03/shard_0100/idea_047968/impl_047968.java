...
@Data
public class Idea47968Config {
    private String name = "idea_047968";
 ...
 */
@Slf4j
public class Idea47968Service {
    private static final int IDEA_ID = 47968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47968Service() {
        this(new Idea47968Config());
    }

    public Idea47968Service(Idea47968Config config) {
        this.config = config != null ? config : new Idea47968Config();
