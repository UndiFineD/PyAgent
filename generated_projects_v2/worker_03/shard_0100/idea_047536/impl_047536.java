...
@Data
public class Idea47536Config {
    private String name = "idea_047536";
 ...
 */
@Slf4j
public class Idea47536Service {
    private static final int IDEA_ID = 47536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47536Service() {
        this(new Idea47536Config());
    }

    public Idea47536Service(Idea47536Config config) {
        this.config = config != null ? config : new Idea47536Config();
