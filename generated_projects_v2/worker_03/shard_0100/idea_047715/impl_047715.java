...
@Data
public class Idea47715Config {
    private String name = "idea_047715";
 ...
 */
@Slf4j
public class Idea47715Service {
    private static final int IDEA_ID = 47715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47715Service() {
        this(new Idea47715Config());
    }

    public Idea47715Service(Idea47715Config config) {
        this.config = config != null ? config : new Idea47715Config();
