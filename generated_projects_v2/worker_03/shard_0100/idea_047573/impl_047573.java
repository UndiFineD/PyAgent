...
@Data
public class Idea47573Config {
    private String name = "idea_047573";
 ...
 */
@Slf4j
public class Idea47573Service {
    private static final int IDEA_ID = 47573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47573Service() {
        this(new Idea47573Config());
    }

    public Idea47573Service(Idea47573Config config) {
        this.config = config != null ? config : new Idea47573Config();
