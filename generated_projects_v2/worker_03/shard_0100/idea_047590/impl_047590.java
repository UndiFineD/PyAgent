...
@Data
public class Idea47590Config {
    private String name = "idea_047590";
 ...
 */
@Slf4j
public class Idea47590Service {
    private static final int IDEA_ID = 47590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47590Service() {
        this(new Idea47590Config());
    }

    public Idea47590Service(Idea47590Config config) {
        this.config = config != null ? config : new Idea47590Config();
