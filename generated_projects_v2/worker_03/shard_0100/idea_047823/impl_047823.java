...
@Data
public class Idea47823Config {
    private String name = "idea_047823";
 ...
 */
@Slf4j
public class Idea47823Service {
    private static final int IDEA_ID = 47823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47823Service() {
        this(new Idea47823Config());
    }

    public Idea47823Service(Idea47823Config config) {
        this.config = config != null ? config : new Idea47823Config();
