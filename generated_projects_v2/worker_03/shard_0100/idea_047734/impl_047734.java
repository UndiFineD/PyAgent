...
@Data
public class Idea47734Config {
    private String name = "idea_047734";
 ...
 */
@Slf4j
public class Idea47734Service {
    private static final int IDEA_ID = 47734;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47734Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47734Service() {
        this(new Idea47734Config());
    }

    public Idea47734Service(Idea47734Config config) {
        this.config = config != null ? config : new Idea47734Config();
