...
@Data
public class Idea47702Config {
    private String name = "idea_047702";
 ...
 */
@Slf4j
public class Idea47702Service {
    private static final int IDEA_ID = 47702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47702Service() {
        this(new Idea47702Config());
    }

    public Idea47702Service(Idea47702Config config) {
        this.config = config != null ? config : new Idea47702Config();
