...
@Data
public class Idea47915Config {
    private String name = "idea_047915";
 ...
 */
@Slf4j
public class Idea47915Service {
    private static final int IDEA_ID = 47915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47915Service() {
        this(new Idea47915Config());
    }

    public Idea47915Service(Idea47915Config config) {
        this.config = config != null ? config : new Idea47915Config();
