...
@Data
public class Idea47637Config {
    private String name = "idea_047637";
 ...
 */
@Slf4j
public class Idea47637Service {
    private static final int IDEA_ID = 47637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47637Service() {
        this(new Idea47637Config());
    }

    public Idea47637Service(Idea47637Config config) {
        this.config = config != null ? config : new Idea47637Config();
