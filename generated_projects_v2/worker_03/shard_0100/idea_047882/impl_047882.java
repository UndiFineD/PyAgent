...
@Data
public class Idea47882Config {
    private String name = "idea_047882";
 ...
 */
@Slf4j
public class Idea47882Service {
    private static final int IDEA_ID = 47882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47882Service() {
        this(new Idea47882Config());
    }

    public Idea47882Service(Idea47882Config config) {
        this.config = config != null ? config : new Idea47882Config();
