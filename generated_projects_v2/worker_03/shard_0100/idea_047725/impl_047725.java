...
@Data
public class Idea47725Config {
    private String name = "idea_047725";
 ...
 */
@Slf4j
public class Idea47725Service {
    private static final int IDEA_ID = 47725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47725Service() {
        this(new Idea47725Config());
    }

    public Idea47725Service(Idea47725Config config) {
        this.config = config != null ? config : new Idea47725Config();
