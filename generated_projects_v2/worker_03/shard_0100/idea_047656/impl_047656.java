...
@Data
public class Idea47656Config {
    private String name = "idea_047656";
 ...
 */
@Slf4j
public class Idea47656Service {
    private static final int IDEA_ID = 47656;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47656Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47656Service() {
        this(new Idea47656Config());
    }

    public Idea47656Service(Idea47656Config config) {
        this.config = config != null ? config : new Idea47656Config();
