...
@Data
public class Idea47802Config {
    private String name = "idea_047802";
 ...
 */
@Slf4j
public class Idea47802Service {
    private static final int IDEA_ID = 47802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47802Service() {
        this(new Idea47802Config());
    }

    public Idea47802Service(Idea47802Config config) {
        this.config = config != null ? config : new Idea47802Config();
