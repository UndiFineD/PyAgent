...
@Data
public class Idea47626Config {
    private String name = "idea_047626";
 ...
 */
@Slf4j
public class Idea47626Service {
    private static final int IDEA_ID = 47626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47626Service() {
        this(new Idea47626Config());
    }

    public Idea47626Service(Idea47626Config config) {
        this.config = config != null ? config : new Idea47626Config();
