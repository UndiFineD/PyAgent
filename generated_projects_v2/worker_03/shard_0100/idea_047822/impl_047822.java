...
@Data
public class Idea47822Config {
    private String name = "idea_047822";
 ...
 */
@Slf4j
public class Idea47822Service {
    private static final int IDEA_ID = 47822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47822Service() {
        this(new Idea47822Config());
    }

    public Idea47822Service(Idea47822Config config) {
        this.config = config != null ? config : new Idea47822Config();
