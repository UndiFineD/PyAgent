...
@Data
public class Idea47886Config {
    private String name = "idea_047886";
 ...
 */
@Slf4j
public class Idea47886Service {
    private static final int IDEA_ID = 47886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47886Service() {
        this(new Idea47886Config());
    }

    public Idea47886Service(Idea47886Config config) {
        this.config = config != null ? config : new Idea47886Config();
