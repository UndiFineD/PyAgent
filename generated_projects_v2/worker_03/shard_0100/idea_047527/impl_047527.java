...
@Data
public class Idea47527Config {
    private String name = "idea_047527";
 ...
 */
@Slf4j
public class Idea47527Service {
    private static final int IDEA_ID = 47527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47527Service() {
        this(new Idea47527Config());
    }

    public Idea47527Service(Idea47527Config config) {
        this.config = config != null ? config : new Idea47527Config();
