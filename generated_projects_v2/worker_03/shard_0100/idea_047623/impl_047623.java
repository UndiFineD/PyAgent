...
@Data
public class Idea47623Config {
    private String name = "idea_047623";
 ...
 */
@Slf4j
public class Idea47623Service {
    private static final int IDEA_ID = 47623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47623Service() {
        this(new Idea47623Config());
    }

    public Idea47623Service(Idea47623Config config) {
        this.config = config != null ? config : new Idea47623Config();
