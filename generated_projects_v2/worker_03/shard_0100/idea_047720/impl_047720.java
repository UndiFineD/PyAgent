...
@Data
public class Idea47720Config {
    private String name = "idea_047720";
 ...
 */
@Slf4j
public class Idea47720Service {
    private static final int IDEA_ID = 47720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47720Service() {
        this(new Idea47720Config());
    }

    public Idea47720Service(Idea47720Config config) {
        this.config = config != null ? config : new Idea47720Config();
