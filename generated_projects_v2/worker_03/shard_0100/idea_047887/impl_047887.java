...
@Data
public class Idea47887Config {
    private String name = "idea_047887";
 ...
 */
@Slf4j
public class Idea47887Service {
    private static final int IDEA_ID = 47887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47887Service() {
        this(new Idea47887Config());
    }

    public Idea47887Service(Idea47887Config config) {
        this.config = config != null ? config : new Idea47887Config();
