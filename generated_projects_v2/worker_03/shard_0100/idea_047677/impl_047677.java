...
@Data
public class Idea47677Config {
    private String name = "idea_047677";
 ...
 */
@Slf4j
public class Idea47677Service {
    private static final int IDEA_ID = 47677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47677Service() {
        this(new Idea47677Config());
    }

    public Idea47677Service(Idea47677Config config) {
        this.config = config != null ? config : new Idea47677Config();
