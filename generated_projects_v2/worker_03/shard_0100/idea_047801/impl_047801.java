...
@Data
public class Idea47801Config {
    private String name = "idea_047801";
 ...
 */
@Slf4j
public class Idea47801Service {
    private static final int IDEA_ID = 47801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47801Service() {
        this(new Idea47801Config());
    }

    public Idea47801Service(Idea47801Config config) {
        this.config = config != null ? config : new Idea47801Config();
