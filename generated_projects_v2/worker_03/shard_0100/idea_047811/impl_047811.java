...
@Data
public class Idea47811Config {
    private String name = "idea_047811";
 ...
 */
@Slf4j
public class Idea47811Service {
    private static final int IDEA_ID = 47811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47811Service() {
        this(new Idea47811Config());
    }

    public Idea47811Service(Idea47811Config config) {
        this.config = config != null ? config : new Idea47811Config();
