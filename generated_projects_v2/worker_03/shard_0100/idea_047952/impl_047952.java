...
@Data
public class Idea47952Config {
    private String name = "idea_047952";
 ...
 */
@Slf4j
public class Idea47952Service {
    private static final int IDEA_ID = 47952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47952Service() {
        this(new Idea47952Config());
    }

    public Idea47952Service(Idea47952Config config) {
        this.config = config != null ? config : new Idea47952Config();
