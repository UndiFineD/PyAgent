...
@Data
public class Idea47587Config {
    private String name = "idea_047587";
 ...
 */
@Slf4j
public class Idea47587Service {
    private static final int IDEA_ID = 47587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47587Service() {
        this(new Idea47587Config());
    }

    public Idea47587Service(Idea47587Config config) {
        this.config = config != null ? config : new Idea47587Config();
