...
@Data
public class Idea47624Config {
    private String name = "idea_047624";
 ...
 */
@Slf4j
public class Idea47624Service {
    private static final int IDEA_ID = 47624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47624Service() {
        this(new Idea47624Config());
    }

    public Idea47624Service(Idea47624Config config) {
        this.config = config != null ? config : new Idea47624Config();
