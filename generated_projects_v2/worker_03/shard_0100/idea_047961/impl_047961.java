...
@Data
public class Idea47961Config {
    private String name = "idea_047961";
 ...
 */
@Slf4j
public class Idea47961Service {
    private static final int IDEA_ID = 47961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47961Service() {
        this(new Idea47961Config());
    }

    public Idea47961Service(Idea47961Config config) {
        this.config = config != null ? config : new Idea47961Config();
