...
@Data
public class Idea47772Config {
    private String name = "idea_047772";
 ...
 */
@Slf4j
public class Idea47772Service {
    private static final int IDEA_ID = 47772;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47772Service() {
        this(new Idea47772Config());
    }

    public Idea47772Service(Idea47772Config config) {
        this.config = config != null ? config : new Idea47772Config();
