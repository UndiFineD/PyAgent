...
@Data
public class Idea47522Config {
    private String name = "idea_047522";
 ...
 */
@Slf4j
public class Idea47522Service {
    private static final int IDEA_ID = 47522;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47522Service() {
        this(new Idea47522Config());
    }

    public Idea47522Service(Idea47522Config config) {
        this.config = config != null ? config : new Idea47522Config();
