...
@Data
public class Idea47838Config {
    private String name = "idea_047838";
 ...
 */
@Slf4j
public class Idea47838Service {
    private static final int IDEA_ID = 47838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47838Service() {
        this(new Idea47838Config());
    }

    public Idea47838Service(Idea47838Config config) {
        this.config = config != null ? config : new Idea47838Config();
