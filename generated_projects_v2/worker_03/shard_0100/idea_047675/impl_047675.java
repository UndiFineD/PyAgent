...
@Data
public class Idea47675Config {
    private String name = "idea_047675";
 ...
 */
@Slf4j
public class Idea47675Service {
    private static final int IDEA_ID = 47675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47675Service() {
        this(new Idea47675Config());
    }

    public Idea47675Service(Idea47675Config config) {
        this.config = config != null ? config : new Idea47675Config();
