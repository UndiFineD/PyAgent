...
@Data
public class Idea47920Config {
    private String name = "idea_047920";
 ...
 */
@Slf4j
public class Idea47920Service {
    private static final int IDEA_ID = 47920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47920Service() {
        this(new Idea47920Config());
    }

    public Idea47920Service(Idea47920Config config) {
        this.config = config != null ? config : new Idea47920Config();
