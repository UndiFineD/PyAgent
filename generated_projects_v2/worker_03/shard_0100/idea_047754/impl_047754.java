...
@Data
public class Idea47754Config {
    private String name = "idea_047754";
 ...
 */
@Slf4j
public class Idea47754Service {
    private static final int IDEA_ID = 47754;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47754Service() {
        this(new Idea47754Config());
    }

    public Idea47754Service(Idea47754Config config) {
        this.config = config != null ? config : new Idea47754Config();
