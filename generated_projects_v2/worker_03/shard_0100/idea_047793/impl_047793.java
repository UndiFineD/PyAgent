...
@Data
public class Idea47793Config {
    private String name = "idea_047793";
 ...
 */
@Slf4j
public class Idea47793Service {
    private static final int IDEA_ID = 47793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47793Service() {
        this(new Idea47793Config());
    }

    public Idea47793Service(Idea47793Config config) {
        this.config = config != null ? config : new Idea47793Config();
