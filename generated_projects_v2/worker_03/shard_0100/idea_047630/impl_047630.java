...
@Data
public class Idea47630Config {
    private String name = "idea_047630";
 ...
 */
@Slf4j
public class Idea47630Service {
    private static final int IDEA_ID = 47630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47630Service() {
        this(new Idea47630Config());
    }

    public Idea47630Service(Idea47630Config config) {
        this.config = config != null ? config : new Idea47630Config();
