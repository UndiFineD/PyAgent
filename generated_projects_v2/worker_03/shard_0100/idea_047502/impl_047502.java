...
@Data
public class Idea47502Config {
    private String name = "idea_047502";
 ...
 */
@Slf4j
public class Idea47502Service {
    private static final int IDEA_ID = 47502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47502Service() {
        this(new Idea47502Config());
    }

    public Idea47502Service(Idea47502Config config) {
        this.config = config != null ? config : new Idea47502Config();
