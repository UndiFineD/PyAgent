...
@Data
public class Idea47741Config {
    private String name = "idea_047741";
 ...
 */
@Slf4j
public class Idea47741Service {
    private static final int IDEA_ID = 47741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47741Service() {
        this(new Idea47741Config());
    }

    public Idea47741Service(Idea47741Config config) {
        this.config = config != null ? config : new Idea47741Config();
