...
@Data
public class Idea47786Config {
    private String name = "idea_047786";
 ...
 */
@Slf4j
public class Idea47786Service {
    private static final int IDEA_ID = 47786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47786Service() {
        this(new Idea47786Config());
    }

    public Idea47786Service(Idea47786Config config) {
        this.config = config != null ? config : new Idea47786Config();
