...
@Data
public class Idea47704Config {
    private String name = "idea_047704";
 ...
 */
@Slf4j
public class Idea47704Service {
    private static final int IDEA_ID = 47704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47704Service() {
        this(new Idea47704Config());
    }

    public Idea47704Service(Idea47704Config config) {
        this.config = config != null ? config : new Idea47704Config();
