...
@Data
public class Idea47671Config {
    private String name = "idea_047671";
 ...
 */
@Slf4j
public class Idea47671Service {
    private static final int IDEA_ID = 47671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47671Service() {
        this(new Idea47671Config());
    }

    public Idea47671Service(Idea47671Config config) {
        this.config = config != null ? config : new Idea47671Config();
