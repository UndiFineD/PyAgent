...
@Data
public class Idea47645Config {
    private String name = "idea_047645";
 ...
 */
@Slf4j
public class Idea47645Service {
    private static final int IDEA_ID = 47645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47645Service() {
        this(new Idea47645Config());
    }

    public Idea47645Service(Idea47645Config config) {
        this.config = config != null ? config : new Idea47645Config();
