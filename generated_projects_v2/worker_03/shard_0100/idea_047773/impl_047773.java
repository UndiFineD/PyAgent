...
@Data
public class Idea47773Config {
    private String name = "idea_047773";
 ...
 */
@Slf4j
public class Idea47773Service {
    private static final int IDEA_ID = 47773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47773Service() {
        this(new Idea47773Config());
    }

    public Idea47773Service(Idea47773Config config) {
        this.config = config != null ? config : new Idea47773Config();
