...
@Data
public class Idea47774Config {
    private String name = "idea_047774";
 ...
 */
@Slf4j
public class Idea47774Service {
    private static final int IDEA_ID = 47774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47774Service() {
        this(new Idea47774Config());
    }

    public Idea47774Service(Idea47774Config config) {
        this.config = config != null ? config : new Idea47774Config();
