...
@Data
public class Idea47716Config {
    private String name = "idea_047716";
 ...
 */
@Slf4j
public class Idea47716Service {
    private static final int IDEA_ID = 47716;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47716Service() {
        this(new Idea47716Config());
    }

    public Idea47716Service(Idea47716Config config) {
        this.config = config != null ? config : new Idea47716Config();
