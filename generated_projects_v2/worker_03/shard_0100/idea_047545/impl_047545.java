...
@Data
public class Idea47545Config {
    private String name = "idea_047545";
 ...
 */
@Slf4j
public class Idea47545Service {
    private static final int IDEA_ID = 47545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47545Service() {
        this(new Idea47545Config());
    }

    public Idea47545Service(Idea47545Config config) {
        this.config = config != null ? config : new Idea47545Config();
