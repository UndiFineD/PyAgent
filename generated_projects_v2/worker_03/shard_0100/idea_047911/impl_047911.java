...
@Data
public class Idea47911Config {
    private String name = "idea_047911";
 ...
 */
@Slf4j
public class Idea47911Service {
    private static final int IDEA_ID = 47911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47911Service() {
        this(new Idea47911Config());
    }

    public Idea47911Service(Idea47911Config config) {
        this.config = config != null ? config : new Idea47911Config();
