...
@Data
public class Idea47733Config {
    private String name = "idea_047733";
 ...
 */
@Slf4j
public class Idea47733Service {
    private static final int IDEA_ID = 47733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47733Service() {
        this(new Idea47733Config());
    }

    public Idea47733Service(Idea47733Config config) {
        this.config = config != null ? config : new Idea47733Config();
