...
@Data
public class Idea47836Config {
    private String name = "idea_047836";
 ...
 */
@Slf4j
public class Idea47836Service {
    private static final int IDEA_ID = 47836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47836Service() {
        this(new Idea47836Config());
    }

    public Idea47836Service(Idea47836Config config) {
        this.config = config != null ? config : new Idea47836Config();
