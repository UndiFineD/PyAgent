...
@Data
public class Idea47513Config {
    private String name = "idea_047513";
 ...
 */
@Slf4j
public class Idea47513Service {
    private static final int IDEA_ID = 47513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47513Service() {
        this(new Idea47513Config());
    }

    public Idea47513Service(Idea47513Config config) {
        this.config = config != null ? config : new Idea47513Config();
