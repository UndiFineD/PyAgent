...
@Data
public class Idea47598Config {
    private String name = "idea_047598";
 ...
 */
@Slf4j
public class Idea47598Service {
    private static final int IDEA_ID = 47598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47598Service() {
        this(new Idea47598Config());
    }

    public Idea47598Service(Idea47598Config config) {
        this.config = config != null ? config : new Idea47598Config();
