...
@Data
public class Idea47515Config {
    private String name = "idea_047515";
 ...
 */
@Slf4j
public class Idea47515Service {
    private static final int IDEA_ID = 47515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47515Service() {
        this(new Idea47515Config());
    }

    public Idea47515Service(Idea47515Config config) {
        this.config = config != null ? config : new Idea47515Config();
