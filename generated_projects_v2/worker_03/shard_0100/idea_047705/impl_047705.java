...
@Data
public class Idea47705Config {
    private String name = "idea_047705";
 ...
 */
@Slf4j
public class Idea47705Service {
    private static final int IDEA_ID = 47705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47705Service() {
        this(new Idea47705Config());
    }

    public Idea47705Service(Idea47705Config config) {
        this.config = config != null ? config : new Idea47705Config();
