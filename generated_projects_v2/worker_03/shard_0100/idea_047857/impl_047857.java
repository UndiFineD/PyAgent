...
@Data
public class Idea47857Config {
    private String name = "idea_047857";
 ...
 */
@Slf4j
public class Idea47857Service {
    private static final int IDEA_ID = 47857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47857Service() {
        this(new Idea47857Config());
    }

    public Idea47857Service(Idea47857Config config) {
        this.config = config != null ? config : new Idea47857Config();
