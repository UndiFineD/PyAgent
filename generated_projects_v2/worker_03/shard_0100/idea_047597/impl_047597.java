...
@Data
public class Idea47597Config {
    private String name = "idea_047597";
 ...
 */
@Slf4j
public class Idea47597Service {
    private static final int IDEA_ID = 47597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47597Service() {
        this(new Idea47597Config());
    }

    public Idea47597Service(Idea47597Config config) {
        this.config = config != null ? config : new Idea47597Config();
