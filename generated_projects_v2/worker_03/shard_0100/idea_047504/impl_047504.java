...
@Data
public class Idea47504Config {
    private String name = "idea_047504";
 ...
 */
@Slf4j
public class Idea47504Service {
    private static final int IDEA_ID = 47504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47504Service() {
        this(new Idea47504Config());
    }

    public Idea47504Service(Idea47504Config config) {
        this.config = config != null ? config : new Idea47504Config();
