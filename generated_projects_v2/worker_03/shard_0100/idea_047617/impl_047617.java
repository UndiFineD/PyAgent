...
@Data
public class Idea47617Config {
    private String name = "idea_047617";
 ...
 */
@Slf4j
public class Idea47617Service {
    private static final int IDEA_ID = 47617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47617Service() {
        this(new Idea47617Config());
    }

    public Idea47617Service(Idea47617Config config) {
        this.config = config != null ? config : new Idea47617Config();
