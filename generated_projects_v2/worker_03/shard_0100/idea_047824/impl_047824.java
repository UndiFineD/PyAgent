...
@Data
public class Idea47824Config {
    private String name = "idea_047824";
 ...
 */
@Slf4j
public class Idea47824Service {
    private static final int IDEA_ID = 47824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47824Service() {
        this(new Idea47824Config());
    }

    public Idea47824Service(Idea47824Config config) {
        this.config = config != null ? config : new Idea47824Config();
