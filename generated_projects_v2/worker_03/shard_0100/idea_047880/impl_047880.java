...
@Data
public class Idea47880Config {
    private String name = "idea_047880";
 ...
 */
@Slf4j
public class Idea47880Service {
    private static final int IDEA_ID = 47880;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47880Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47880Service() {
        this(new Idea47880Config());
    }

    public Idea47880Service(Idea47880Config config) {
        this.config = config != null ? config : new Idea47880Config();
