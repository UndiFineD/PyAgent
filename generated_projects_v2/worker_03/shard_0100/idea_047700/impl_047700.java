...
@Data
public class Idea47700Config {
    private String name = "idea_047700";
 ...
 */
@Slf4j
public class Idea47700Service {
    private static final int IDEA_ID = 47700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47700Service() {
        this(new Idea47700Config());
    }

    public Idea47700Service(Idea47700Config config) {
        this.config = config != null ? config : new Idea47700Config();
