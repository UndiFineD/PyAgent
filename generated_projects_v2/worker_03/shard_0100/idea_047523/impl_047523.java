...
@Data
public class Idea47523Config {
    private String name = "idea_047523";
 ...
 */
@Slf4j
public class Idea47523Service {
    private static final int IDEA_ID = 47523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47523Service() {
        this(new Idea47523Config());
    }

    public Idea47523Service(Idea47523Config config) {
        this.config = config != null ? config : new Idea47523Config();
