...
@Data
public class Idea47531Config {
    private String name = "idea_047531";
 ...
 */
@Slf4j
public class Idea47531Service {
    private static final int IDEA_ID = 47531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47531Service() {
        this(new Idea47531Config());
    }

    public Idea47531Service(Idea47531Config config) {
        this.config = config != null ? config : new Idea47531Config();
