...
@Data
public class Idea47805Config {
    private String name = "idea_047805";
 ...
 */
@Slf4j
public class Idea47805Service {
    private static final int IDEA_ID = 47805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47805Service() {
        this(new Idea47805Config());
    }

    public Idea47805Service(Idea47805Config config) {
        this.config = config != null ? config : new Idea47805Config();
