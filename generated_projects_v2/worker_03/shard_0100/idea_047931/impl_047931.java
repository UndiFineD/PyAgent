...
@Data
public class Idea47931Config {
    private String name = "idea_047931";
 ...
 */
@Slf4j
public class Idea47931Service {
    private static final int IDEA_ID = 47931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47931Service() {
        this(new Idea47931Config());
    }

    public Idea47931Service(Idea47931Config config) {
        this.config = config != null ? config : new Idea47931Config();
