...
@Data
public class Idea47831Config {
    private String name = "idea_047831";
 ...
 */
@Slf4j
public class Idea47831Service {
    private static final int IDEA_ID = 47831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47831Service() {
        this(new Idea47831Config());
    }

    public Idea47831Service(Idea47831Config config) {
        this.config = config != null ? config : new Idea47831Config();
