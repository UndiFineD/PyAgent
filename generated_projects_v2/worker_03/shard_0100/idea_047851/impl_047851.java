...
@Data
public class Idea47851Config {
    private String name = "idea_047851";
 ...
 */
@Slf4j
public class Idea47851Service {
    private static final int IDEA_ID = 47851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47851Service() {
        this(new Idea47851Config());
    }

    public Idea47851Service(Idea47851Config config) {
        this.config = config != null ? config : new Idea47851Config();
