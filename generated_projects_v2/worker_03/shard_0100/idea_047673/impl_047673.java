...
@Data
public class Idea47673Config {
    private String name = "idea_047673";
 ...
 */
@Slf4j
public class Idea47673Service {
    private static final int IDEA_ID = 47673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47673Service() {
        this(new Idea47673Config());
    }

    public Idea47673Service(Idea47673Config config) {
        this.config = config != null ? config : new Idea47673Config();
