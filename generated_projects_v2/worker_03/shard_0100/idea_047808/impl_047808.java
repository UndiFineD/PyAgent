...
@Data
public class Idea47808Config {
    private String name = "idea_047808";
 ...
 */
@Slf4j
public class Idea47808Service {
    private static final int IDEA_ID = 47808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47808Service() {
        this(new Idea47808Config());
    }

    public Idea47808Service(Idea47808Config config) {
        this.config = config != null ? config : new Idea47808Config();
