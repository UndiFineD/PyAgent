...
@Data
public class Idea47615Config {
    private String name = "idea_047615";
 ...
 */
@Slf4j
public class Idea47615Service {
    private static final int IDEA_ID = 47615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47615Service() {
        this(new Idea47615Config());
    }

    public Idea47615Service(Idea47615Config config) {
        this.config = config != null ? config : new Idea47615Config();
