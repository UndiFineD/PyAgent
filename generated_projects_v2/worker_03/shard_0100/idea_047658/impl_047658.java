...
@Data
public class Idea47658Config {
    private String name = "idea_047658";
 ...
 */
@Slf4j
public class Idea47658Service {
    private static final int IDEA_ID = 47658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47658Service() {
        this(new Idea47658Config());
    }

    public Idea47658Service(Idea47658Config config) {
        this.config = config != null ? config : new Idea47658Config();
