...
@Data
public class Idea47546Config {
    private String name = "idea_047546";
 ...
 */
@Slf4j
public class Idea47546Service {
    private static final int IDEA_ID = 47546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47546Service() {
        this(new Idea47546Config());
    }

    public Idea47546Service(Idea47546Config config) {
        this.config = config != null ? config : new Idea47546Config();
