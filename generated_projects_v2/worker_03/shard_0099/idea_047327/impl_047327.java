...
@Data
public class Idea47327Config {
    private String name = "idea_047327";
 ...
 */
@Slf4j
public class Idea47327Service {
    private static final int IDEA_ID = 47327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47327Service() {
        this(new Idea47327Config());
    }

    public Idea47327Service(Idea47327Config config) {
        this.config = config != null ? config : new Idea47327Config();
