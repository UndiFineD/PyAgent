...
@Data
public class Idea47238Config {
    private String name = "idea_047238";
 ...
 */
@Slf4j
public class Idea47238Service {
    private static final int IDEA_ID = 47238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47238Service() {
        this(new Idea47238Config());
    }

    public Idea47238Service(Idea47238Config config) {
        this.config = config != null ? config : new Idea47238Config();
