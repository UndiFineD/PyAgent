...
@Data
public class Idea47374Config {
    private String name = "idea_047374";
 ...
 */
@Slf4j
public class Idea47374Service {
    private static final int IDEA_ID = 47374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47374Service() {
        this(new Idea47374Config());
    }

    public Idea47374Service(Idea47374Config config) {
        this.config = config != null ? config : new Idea47374Config();
