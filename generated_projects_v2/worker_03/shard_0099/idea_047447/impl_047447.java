...
@Data
public class Idea47447Config {
    private String name = "idea_047447";
 ...
 */
@Slf4j
public class Idea47447Service {
    private static final int IDEA_ID = 47447;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47447Service() {
        this(new Idea47447Config());
    }

    public Idea47447Service(Idea47447Config config) {
        this.config = config != null ? config : new Idea47447Config();
