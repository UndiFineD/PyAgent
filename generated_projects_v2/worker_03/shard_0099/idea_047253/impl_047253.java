...
@Data
public class Idea47253Config {
    private String name = "idea_047253";
 ...
 */
@Slf4j
public class Idea47253Service {
    private static final int IDEA_ID = 47253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47253Service() {
        this(new Idea47253Config());
    }

    public Idea47253Service(Idea47253Config config) {
        this.config = config != null ? config : new Idea47253Config();
