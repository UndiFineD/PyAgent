...
@Data
public class Idea47362Config {
    private String name = "idea_047362";
 ...
 */
@Slf4j
public class Idea47362Service {
    private static final int IDEA_ID = 47362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47362Service() {
        this(new Idea47362Config());
    }

    public Idea47362Service(Idea47362Config config) {
        this.config = config != null ? config : new Idea47362Config();
