...
@Data
public class Idea47444Config {
    private String name = "idea_047444";
 ...
 */
@Slf4j
public class Idea47444Service {
    private static final int IDEA_ID = 47444;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47444Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47444Service() {
        this(new Idea47444Config());
    }

    public Idea47444Service(Idea47444Config config) {
        this.config = config != null ? config : new Idea47444Config();
