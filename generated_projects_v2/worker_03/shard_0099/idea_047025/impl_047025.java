...
@Data
public class Idea47025Config {
    private String name = "idea_047025";
 ...
 */
@Slf4j
public class Idea47025Service {
    private static final int IDEA_ID = 47025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47025Service() {
        this(new Idea47025Config());
    }

    public Idea47025Service(Idea47025Config config) {
        this.config = config != null ? config : new Idea47025Config();
