...
@Data
public class Idea47160Config {
    private String name = "idea_047160";
 ...
 */
@Slf4j
public class Idea47160Service {
    private static final int IDEA_ID = 47160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47160Service() {
        this(new Idea47160Config());
    }

    public Idea47160Service(Idea47160Config config) {
        this.config = config != null ? config : new Idea47160Config();
