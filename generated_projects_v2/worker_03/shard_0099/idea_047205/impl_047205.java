...
@Data
public class Idea47205Config {
    private String name = "idea_047205";
 ...
 */
@Slf4j
public class Idea47205Service {
    private static final int IDEA_ID = 47205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47205Service() {
        this(new Idea47205Config());
    }

    public Idea47205Service(Idea47205Config config) {
        this.config = config != null ? config : new Idea47205Config();
