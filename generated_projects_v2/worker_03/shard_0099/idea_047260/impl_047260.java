...
@Data
public class Idea47260Config {
    private String name = "idea_047260";
 ...
 */
@Slf4j
public class Idea47260Service {
    private static final int IDEA_ID = 47260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47260Service() {
        this(new Idea47260Config());
    }

    public Idea47260Service(Idea47260Config config) {
        this.config = config != null ? config : new Idea47260Config();
