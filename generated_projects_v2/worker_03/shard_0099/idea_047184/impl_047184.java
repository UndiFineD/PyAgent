...
@Data
public class Idea47184Config {
    private String name = "idea_047184";
 ...
 */
@Slf4j
public class Idea47184Service {
    private static final int IDEA_ID = 47184;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47184Service() {
        this(new Idea47184Config());
    }

    public Idea47184Service(Idea47184Config config) {
        this.config = config != null ? config : new Idea47184Config();
