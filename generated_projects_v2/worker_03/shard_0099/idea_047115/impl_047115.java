...
@Data
public class Idea47115Config {
    private String name = "idea_047115";
 ...
 */
@Slf4j
public class Idea47115Service {
    private static final int IDEA_ID = 47115;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47115Service() {
        this(new Idea47115Config());
    }

    public Idea47115Service(Idea47115Config config) {
        this.config = config != null ? config : new Idea47115Config();
