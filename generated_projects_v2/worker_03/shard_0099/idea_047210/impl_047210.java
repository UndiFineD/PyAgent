...
@Data
public class Idea47210Config {
    private String name = "idea_047210";
 ...
 */
@Slf4j
public class Idea47210Service {
    private static final int IDEA_ID = 47210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47210Service() {
        this(new Idea47210Config());
    }

    public Idea47210Service(Idea47210Config config) {
        this.config = config != null ? config : new Idea47210Config();
