...
@Data
public class Idea47281Config {
    private String name = "idea_047281";
 ...
 */
@Slf4j
public class Idea47281Service {
    private static final int IDEA_ID = 47281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47281Service() {
        this(new Idea47281Config());
    }

    public Idea47281Service(Idea47281Config config) {
        this.config = config != null ? config : new Idea47281Config();
