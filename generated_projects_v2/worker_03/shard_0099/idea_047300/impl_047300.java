...
@Data
public class Idea47300Config {
    private String name = "idea_047300";
 ...
 */
@Slf4j
public class Idea47300Service {
    private static final int IDEA_ID = 47300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47300Service() {
        this(new Idea47300Config());
    }

    public Idea47300Service(Idea47300Config config) {
        this.config = config != null ? config : new Idea47300Config();
