...
@Data
public class Idea47287Config {
    private String name = "idea_047287";
 ...
 */
@Slf4j
public class Idea47287Service {
    private static final int IDEA_ID = 47287;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47287Service() {
        this(new Idea47287Config());
    }

    public Idea47287Service(Idea47287Config config) {
        this.config = config != null ? config : new Idea47287Config();
