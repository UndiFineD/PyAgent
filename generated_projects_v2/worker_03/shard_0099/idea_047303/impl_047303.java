...
@Data
public class Idea47303Config {
    private String name = "idea_047303";
 ...
 */
@Slf4j
public class Idea47303Service {
    private static final int IDEA_ID = 47303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47303Service() {
        this(new Idea47303Config());
    }

    public Idea47303Service(Idea47303Config config) {
        this.config = config != null ? config : new Idea47303Config();
