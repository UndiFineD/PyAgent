...
@Data
public class Idea47125Config {
    private String name = "idea_047125";
 ...
 */
@Slf4j
public class Idea47125Service {
    private static final int IDEA_ID = 47125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47125Service() {
        this(new Idea47125Config());
    }

    public Idea47125Service(Idea47125Config config) {
        this.config = config != null ? config : new Idea47125Config();
