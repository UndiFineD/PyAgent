...
@Data
public class Idea47460Config {
    private String name = "idea_047460";
 ...
 */
@Slf4j
public class Idea47460Service {
    private static final int IDEA_ID = 47460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47460Service() {
        this(new Idea47460Config());
    }

    public Idea47460Service(Idea47460Config config) {
        this.config = config != null ? config : new Idea47460Config();
