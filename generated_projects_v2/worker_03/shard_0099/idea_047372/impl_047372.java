...
@Data
public class Idea47372Config {
    private String name = "idea_047372";
 ...
 */
@Slf4j
public class Idea47372Service {
    private static final int IDEA_ID = 47372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47372Service() {
        this(new Idea47372Config());
    }

    public Idea47372Service(Idea47372Config config) {
        this.config = config != null ? config : new Idea47372Config();
