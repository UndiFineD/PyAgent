...
@Data
public class Idea47152Config {
    private String name = "idea_047152";
 ...
 */
@Slf4j
public class Idea47152Service {
    private static final int IDEA_ID = 47152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47152Service() {
        this(new Idea47152Config());
    }

    public Idea47152Service(Idea47152Config config) {
        this.config = config != null ? config : new Idea47152Config();
