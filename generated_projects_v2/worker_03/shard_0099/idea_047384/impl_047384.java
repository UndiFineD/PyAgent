...
@Data
public class Idea47384Config {
    private String name = "idea_047384";
 ...
 */
@Slf4j
public class Idea47384Service {
    private static final int IDEA_ID = 47384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47384Service() {
        this(new Idea47384Config());
    }

    public Idea47384Service(Idea47384Config config) {
        this.config = config != null ? config : new Idea47384Config();
