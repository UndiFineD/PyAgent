...
@Data
public class Idea47425Config {
    private String name = "idea_047425";
 ...
 */
@Slf4j
public class Idea47425Service {
    private static final int IDEA_ID = 47425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47425Service() {
        this(new Idea47425Config());
    }

    public Idea47425Service(Idea47425Config config) {
        this.config = config != null ? config : new Idea47425Config();
