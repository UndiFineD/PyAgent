...
@Data
public class Idea47151Config {
    private String name = "idea_047151";
 ...
 */
@Slf4j
public class Idea47151Service {
    private static final int IDEA_ID = 47151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47151Service() {
        this(new Idea47151Config());
    }

    public Idea47151Service(Idea47151Config config) {
        this.config = config != null ? config : new Idea47151Config();
