...
@Data
public class Idea47269Config {
    private String name = "idea_047269";
 ...
 */
@Slf4j
public class Idea47269Service {
    private static final int IDEA_ID = 47269;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47269Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47269Service() {
        this(new Idea47269Config());
    }

    public Idea47269Service(Idea47269Config config) {
        this.config = config != null ? config : new Idea47269Config();
