...
@Data
public class Idea47395Config {
    private String name = "idea_047395";
 ...
 */
@Slf4j
public class Idea47395Service {
    private static final int IDEA_ID = 47395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47395Service() {
        this(new Idea47395Config());
    }

    public Idea47395Service(Idea47395Config config) {
        this.config = config != null ? config : new Idea47395Config();
