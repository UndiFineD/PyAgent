...
@Data
public class Idea47402Config {
    private String name = "idea_047402";
 ...
 */
@Slf4j
public class Idea47402Service {
    private static final int IDEA_ID = 47402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47402Service() {
        this(new Idea47402Config());
    }

    public Idea47402Service(Idea47402Config config) {
        this.config = config != null ? config : new Idea47402Config();
