...
@Data
public class Idea47370Config {
    private String name = "idea_047370";
 ...
 */
@Slf4j
public class Idea47370Service {
    private static final int IDEA_ID = 47370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47370Service() {
        this(new Idea47370Config());
    }

    public Idea47370Service(Idea47370Config config) {
        this.config = config != null ? config : new Idea47370Config();
