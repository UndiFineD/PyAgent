...
@Data
public class Idea47472Config {
    private String name = "idea_047472";
 ...
 */
@Slf4j
public class Idea47472Service {
    private static final int IDEA_ID = 47472;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47472Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47472Service() {
        this(new Idea47472Config());
    }

    public Idea47472Service(Idea47472Config config) {
        this.config = config != null ? config : new Idea47472Config();
