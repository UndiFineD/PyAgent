...
@Data
public class Idea47033Config {
    private String name = "idea_047033";
 ...
 */
@Slf4j
public class Idea47033Service {
    private static final int IDEA_ID = 47033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47033Service() {
        this(new Idea47033Config());
    }

    public Idea47033Service(Idea47033Config config) {
        this.config = config != null ? config : new Idea47033Config();
