...
@Data
public class Idea47206Config {
    private String name = "idea_047206";
 ...
 */
@Slf4j
public class Idea47206Service {
    private static final int IDEA_ID = 47206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47206Service() {
        this(new Idea47206Config());
    }

    public Idea47206Service(Idea47206Config config) {
        this.config = config != null ? config : new Idea47206Config();
