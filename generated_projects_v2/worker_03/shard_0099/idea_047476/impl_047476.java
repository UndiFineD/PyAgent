...
@Data
public class Idea47476Config {
    private String name = "idea_047476";
 ...
 */
@Slf4j
public class Idea47476Service {
    private static final int IDEA_ID = 47476;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47476Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47476Service() {
        this(new Idea47476Config());
    }

    public Idea47476Service(Idea47476Config config) {
        this.config = config != null ? config : new Idea47476Config();
