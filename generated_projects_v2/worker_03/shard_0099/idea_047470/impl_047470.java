...
@Data
public class Idea47470Config {
    private String name = "idea_047470";
 ...
 */
@Slf4j
public class Idea47470Service {
    private static final int IDEA_ID = 47470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47470Service() {
        this(new Idea47470Config());
    }

    public Idea47470Service(Idea47470Config config) {
        this.config = config != null ? config : new Idea47470Config();
