...
@Data
public class Idea47364Config {
    private String name = "idea_047364";
 ...
 */
@Slf4j
public class Idea47364Service {
    private static final int IDEA_ID = 47364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47364Service() {
        this(new Idea47364Config());
    }

    public Idea47364Service(Idea47364Config config) {
        this.config = config != null ? config : new Idea47364Config();
