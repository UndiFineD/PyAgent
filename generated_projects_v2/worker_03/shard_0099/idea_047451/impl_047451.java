...
@Data
public class Idea47451Config {
    private String name = "idea_047451";
 ...
 */
@Slf4j
public class Idea47451Service {
    private static final int IDEA_ID = 47451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47451Service() {
        this(new Idea47451Config());
    }

    public Idea47451Service(Idea47451Config config) {
        this.config = config != null ? config : new Idea47451Config();
