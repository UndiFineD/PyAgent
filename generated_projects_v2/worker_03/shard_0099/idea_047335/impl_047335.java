...
@Data
public class Idea47335Config {
    private String name = "idea_047335";
 ...
 */
@Slf4j
public class Idea47335Service {
    private static final int IDEA_ID = 47335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47335Service() {
        this(new Idea47335Config());
    }

    public Idea47335Service(Idea47335Config config) {
        this.config = config != null ? config : new Idea47335Config();
