...
@Data
public class Idea47103Config {
    private String name = "idea_047103";
 ...
 */
@Slf4j
public class Idea47103Service {
    private static final int IDEA_ID = 47103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47103Service() {
        this(new Idea47103Config());
    }

    public Idea47103Service(Idea47103Config config) {
        this.config = config != null ? config : new Idea47103Config();
