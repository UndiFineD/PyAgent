...
@Data
public class Idea47408Config {
    private String name = "idea_047408";
 ...
 */
@Slf4j
public class Idea47408Service {
    private static final int IDEA_ID = 47408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47408Service() {
        this(new Idea47408Config());
    }

    public Idea47408Service(Idea47408Config config) {
        this.config = config != null ? config : new Idea47408Config();
