...
@Data
public class Idea47361Config {
    private String name = "idea_047361";
 ...
 */
@Slf4j
public class Idea47361Service {
    private static final int IDEA_ID = 47361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47361Service() {
        this(new Idea47361Config());
    }

    public Idea47361Service(Idea47361Config config) {
        this.config = config != null ? config : new Idea47361Config();
