...
@Data
public class Idea47298Config {
    private String name = "idea_047298";
 ...
 */
@Slf4j
public class Idea47298Service {
    private static final int IDEA_ID = 47298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47298Service() {
        this(new Idea47298Config());
    }

    public Idea47298Service(Idea47298Config config) {
        this.config = config != null ? config : new Idea47298Config();
