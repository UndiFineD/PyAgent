...
@Data
public class Idea47475Config {
    private String name = "idea_047475";
 ...
 */
@Slf4j
public class Idea47475Service {
    private static final int IDEA_ID = 47475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47475Service() {
        this(new Idea47475Config());
    }

    public Idea47475Service(Idea47475Config config) {
        this.config = config != null ? config : new Idea47475Config();
