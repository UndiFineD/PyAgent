...
@Data
public class Idea47112Config {
    private String name = "idea_047112";
 ...
 */
@Slf4j
public class Idea47112Service {
    private static final int IDEA_ID = 47112;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47112Service() {
        this(new Idea47112Config());
    }

    public Idea47112Service(Idea47112Config config) {
        this.config = config != null ? config : new Idea47112Config();
