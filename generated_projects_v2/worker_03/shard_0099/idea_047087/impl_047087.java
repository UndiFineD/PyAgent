...
@Data
public class Idea47087Config {
    private String name = "idea_047087";
 ...
 */
@Slf4j
public class Idea47087Service {
    private static final int IDEA_ID = 47087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47087Service() {
        this(new Idea47087Config());
    }

    public Idea47087Service(Idea47087Config config) {
        this.config = config != null ? config : new Idea47087Config();
