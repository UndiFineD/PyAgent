...
@Data
public class Idea47061Config {
    private String name = "idea_047061";
 ...
 */
@Slf4j
public class Idea47061Service {
    private static final int IDEA_ID = 47061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47061Service() {
        this(new Idea47061Config());
    }

    public Idea47061Service(Idea47061Config config) {
        this.config = config != null ? config : new Idea47061Config();
