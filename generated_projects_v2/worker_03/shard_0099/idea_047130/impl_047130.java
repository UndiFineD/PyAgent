...
@Data
public class Idea47130Config {
    private String name = "idea_047130";
 ...
 */
@Slf4j
public class Idea47130Service {
    private static final int IDEA_ID = 47130;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47130Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47130Service() {
        this(new Idea47130Config());
    }

    public Idea47130Service(Idea47130Config config) {
        this.config = config != null ? config : new Idea47130Config();
