...
@Data
public class Idea47324Config {
    private String name = "idea_047324";
 ...
 */
@Slf4j
public class Idea47324Service {
    private static final int IDEA_ID = 47324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47324Service() {
        this(new Idea47324Config());
    }

    public Idea47324Service(Idea47324Config config) {
        this.config = config != null ? config : new Idea47324Config();
