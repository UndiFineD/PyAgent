...
@Data
public class Idea47337Config {
    private String name = "idea_047337";
 ...
 */
@Slf4j
public class Idea47337Service {
    private static final int IDEA_ID = 47337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47337Service() {
        this(new Idea47337Config());
    }

    public Idea47337Service(Idea47337Config config) {
        this.config = config != null ? config : new Idea47337Config();
