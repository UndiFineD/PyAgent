...
@Data
public class Idea47456Config {
    private String name = "idea_047456";
 ...
 */
@Slf4j
public class Idea47456Service {
    private static final int IDEA_ID = 47456;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47456Service() {
        this(new Idea47456Config());
    }

    public Idea47456Service(Idea47456Config config) {
        this.config = config != null ? config : new Idea47456Config();
