...
@Data
public class Idea47336Config {
    private String name = "idea_047336";
 ...
 */
@Slf4j
public class Idea47336Service {
    private static final int IDEA_ID = 47336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47336Service() {
        this(new Idea47336Config());
    }

    public Idea47336Service(Idea47336Config config) {
        this.config = config != null ? config : new Idea47336Config();
