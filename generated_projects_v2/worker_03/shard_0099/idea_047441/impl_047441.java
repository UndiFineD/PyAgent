...
@Data
public class Idea47441Config {
    private String name = "idea_047441";
 ...
 */
@Slf4j
public class Idea47441Service {
    private static final int IDEA_ID = 47441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47441Service() {
        this(new Idea47441Config());
    }

    public Idea47441Service(Idea47441Config config) {
        this.config = config != null ? config : new Idea47441Config();
