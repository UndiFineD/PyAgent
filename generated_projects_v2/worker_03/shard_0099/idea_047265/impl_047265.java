...
@Data
public class Idea47265Config {
    private String name = "idea_047265";
 ...
 */
@Slf4j
public class Idea47265Service {
    private static final int IDEA_ID = 47265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47265Service() {
        this(new Idea47265Config());
    }

    public Idea47265Service(Idea47265Config config) {
        this.config = config != null ? config : new Idea47265Config();
