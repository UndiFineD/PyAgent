...
@Data
public class Idea47136Config {
    private String name = "idea_047136";
 ...
 */
@Slf4j
public class Idea47136Service {
    private static final int IDEA_ID = 47136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47136Service() {
        this(new Idea47136Config());
    }

    public Idea47136Service(Idea47136Config config) {
        this.config = config != null ? config : new Idea47136Config();
