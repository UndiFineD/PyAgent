...
@Data
public class Idea47128Config {
    private String name = "idea_047128";
 ...
 */
@Slf4j
public class Idea47128Service {
    private static final int IDEA_ID = 47128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47128Service() {
        this(new Idea47128Config());
    }

    public Idea47128Service(Idea47128Config config) {
        this.config = config != null ? config : new Idea47128Config();
