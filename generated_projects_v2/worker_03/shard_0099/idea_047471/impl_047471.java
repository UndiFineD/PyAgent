...
@Data
public class Idea47471Config {
    private String name = "idea_047471";
 ...
 */
@Slf4j
public class Idea47471Service {
    private static final int IDEA_ID = 47471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47471Service() {
        this(new Idea47471Config());
    }

    public Idea47471Service(Idea47471Config config) {
        this.config = config != null ? config : new Idea47471Config();
