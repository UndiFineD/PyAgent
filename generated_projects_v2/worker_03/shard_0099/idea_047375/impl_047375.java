...
@Data
public class Idea47375Config {
    private String name = "idea_047375";
 ...
 */
@Slf4j
public class Idea47375Service {
    private static final int IDEA_ID = 47375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47375Service() {
        this(new Idea47375Config());
    }

    public Idea47375Service(Idea47375Config config) {
        this.config = config != null ? config : new Idea47375Config();
