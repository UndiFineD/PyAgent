...
@Data
public class Idea47124Config {
    private String name = "idea_047124";
 ...
 */
@Slf4j
public class Idea47124Service {
    private static final int IDEA_ID = 47124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47124Service() {
        this(new Idea47124Config());
    }

    public Idea47124Service(Idea47124Config config) {
        this.config = config != null ? config : new Idea47124Config();
