...
@Data
public class Idea47422Config {
    private String name = "idea_047422";
 ...
 */
@Slf4j
public class Idea47422Service {
    private static final int IDEA_ID = 47422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47422Service() {
        this(new Idea47422Config());
    }

    public Idea47422Service(Idea47422Config config) {
        this.config = config != null ? config : new Idea47422Config();
