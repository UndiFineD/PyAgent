...
@Data
public class Idea47458Config {
    private String name = "idea_047458";
 ...
 */
@Slf4j
public class Idea47458Service {
    private static final int IDEA_ID = 47458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47458Service() {
        this(new Idea47458Config());
    }

    public Idea47458Service(Idea47458Config config) {
        this.config = config != null ? config : new Idea47458Config();
