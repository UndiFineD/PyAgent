...
@Data
public class Idea47403Config {
    private String name = "idea_047403";
 ...
 */
@Slf4j
public class Idea47403Service {
    private static final int IDEA_ID = 47403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47403Service() {
        this(new Idea47403Config());
    }

    public Idea47403Service(Idea47403Config config) {
        this.config = config != null ? config : new Idea47403Config();
