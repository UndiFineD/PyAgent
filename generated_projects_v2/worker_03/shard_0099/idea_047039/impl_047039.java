...
@Data
public class Idea47039Config {
    private String name = "idea_047039";
 ...
 */
@Slf4j
public class Idea47039Service {
    private static final int IDEA_ID = 47039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47039Service() {
        this(new Idea47039Config());
    }

    public Idea47039Service(Idea47039Config config) {
        this.config = config != null ? config : new Idea47039Config();
