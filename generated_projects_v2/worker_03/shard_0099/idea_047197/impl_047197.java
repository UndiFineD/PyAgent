...
@Data
public class Idea47197Config {
    private String name = "idea_047197";
 ...
 */
@Slf4j
public class Idea47197Service {
    private static final int IDEA_ID = 47197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47197Service() {
        this(new Idea47197Config());
    }

    public Idea47197Service(Idea47197Config config) {
        this.config = config != null ? config : new Idea47197Config();
