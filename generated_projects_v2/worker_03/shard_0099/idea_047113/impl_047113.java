...
@Data
public class Idea47113Config {
    private String name = "idea_047113";
 ...
 */
@Slf4j
public class Idea47113Service {
    private static final int IDEA_ID = 47113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47113Service() {
        this(new Idea47113Config());
    }

    public Idea47113Service(Idea47113Config config) {
        this.config = config != null ? config : new Idea47113Config();
