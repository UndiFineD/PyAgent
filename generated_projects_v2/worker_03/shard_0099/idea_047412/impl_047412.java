...
@Data
public class Idea47412Config {
    private String name = "idea_047412";
 ...
 */
@Slf4j
public class Idea47412Service {
    private static final int IDEA_ID = 47412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47412Service() {
        this(new Idea47412Config());
    }

    public Idea47412Service(Idea47412Config config) {
        this.config = config != null ? config : new Idea47412Config();
