...
@Data
public class Idea47420Config {
    private String name = "idea_047420";
 ...
 */
@Slf4j
public class Idea47420Service {
    private static final int IDEA_ID = 47420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47420Service() {
        this(new Idea47420Config());
    }

    public Idea47420Service(Idea47420Config config) {
        this.config = config != null ? config : new Idea47420Config();
