...
@Data
public class Idea47236Config {
    private String name = "idea_047236";
 ...
 */
@Slf4j
public class Idea47236Service {
    private static final int IDEA_ID = 47236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47236Service() {
        this(new Idea47236Config());
    }

    public Idea47236Service(Idea47236Config config) {
        this.config = config != null ? config : new Idea47236Config();
