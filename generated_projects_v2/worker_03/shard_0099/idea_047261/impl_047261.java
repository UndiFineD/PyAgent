...
@Data
public class Idea47261Config {
    private String name = "idea_047261";
 ...
 */
@Slf4j
public class Idea47261Service {
    private static final int IDEA_ID = 47261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47261Service() {
        this(new Idea47261Config());
    }

    public Idea47261Service(Idea47261Config config) {
        this.config = config != null ? config : new Idea47261Config();
