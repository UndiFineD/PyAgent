...
@Data
public class Idea47440Config {
    private String name = "idea_047440";
 ...
 */
@Slf4j
public class Idea47440Service {
    private static final int IDEA_ID = 47440;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47440Service() {
        this(new Idea47440Config());
    }

    public Idea47440Service(Idea47440Config config) {
        this.config = config != null ? config : new Idea47440Config();
