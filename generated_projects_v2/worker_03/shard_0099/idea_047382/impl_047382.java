...
@Data
public class Idea47382Config {
    private String name = "idea_047382";
 ...
 */
@Slf4j
public class Idea47382Service {
    private static final int IDEA_ID = 47382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47382Service() {
        this(new Idea47382Config());
    }

    public Idea47382Service(Idea47382Config config) {
        this.config = config != null ? config : new Idea47382Config();
