...
@Data
public class Idea47345Config {
    private String name = "idea_047345";
 ...
 */
@Slf4j
public class Idea47345Service {
    private static final int IDEA_ID = 47345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47345Service() {
        this(new Idea47345Config());
    }

    public Idea47345Service(Idea47345Config config) {
        this.config = config != null ? config : new Idea47345Config();
