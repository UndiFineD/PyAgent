...
@Data
public class Idea47228Config {
    private String name = "idea_047228";
 ...
 */
@Slf4j
public class Idea47228Service {
    private static final int IDEA_ID = 47228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47228Service() {
        this(new Idea47228Config());
    }

    public Idea47228Service(Idea47228Config config) {
        this.config = config != null ? config : new Idea47228Config();
