...
@Data
public class Idea47497Config {
    private String name = "idea_047497";
 ...
 */
@Slf4j
public class Idea47497Service {
    private static final int IDEA_ID = 47497;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47497Service() {
        this(new Idea47497Config());
    }

    public Idea47497Service(Idea47497Config config) {
        this.config = config != null ? config : new Idea47497Config();
