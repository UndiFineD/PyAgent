...
@Data
public class Idea47306Config {
    private String name = "idea_047306";
 ...
 */
@Slf4j
public class Idea47306Service {
    private static final int IDEA_ID = 47306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47306Service() {
        this(new Idea47306Config());
    }

    public Idea47306Service(Idea47306Config config) {
        this.config = config != null ? config : new Idea47306Config();
