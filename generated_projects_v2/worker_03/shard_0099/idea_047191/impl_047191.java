...
@Data
public class Idea47191Config {
    private String name = "idea_047191";
 ...
 */
@Slf4j
public class Idea47191Service {
    private static final int IDEA_ID = 47191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47191Service() {
        this(new Idea47191Config());
    }

    public Idea47191Service(Idea47191Config config) {
        this.config = config != null ? config : new Idea47191Config();
