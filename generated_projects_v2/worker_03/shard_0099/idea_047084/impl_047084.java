...
@Data
public class Idea47084Config {
    private String name = "idea_047084";
 ...
 */
@Slf4j
public class Idea47084Service {
    private static final int IDEA_ID = 47084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47084Service() {
        this(new Idea47084Config());
    }

    public Idea47084Service(Idea47084Config config) {
        this.config = config != null ? config : new Idea47084Config();
