...
@Data
public class Idea47177Config {
    private String name = "idea_047177";
 ...
 */
@Slf4j
public class Idea47177Service {
    private static final int IDEA_ID = 47177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47177Service() {
        this(new Idea47177Config());
    }

    public Idea47177Service(Idea47177Config config) {
        this.config = config != null ? config : new Idea47177Config();
