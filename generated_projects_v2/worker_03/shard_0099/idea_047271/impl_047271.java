...
@Data
public class Idea47271Config {
    private String name = "idea_047271";
 ...
 */
@Slf4j
public class Idea47271Service {
    private static final int IDEA_ID = 47271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47271Service() {
        this(new Idea47271Config());
    }

    public Idea47271Service(Idea47271Config config) {
        this.config = config != null ? config : new Idea47271Config();
