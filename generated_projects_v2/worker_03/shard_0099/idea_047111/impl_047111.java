...
@Data
public class Idea47111Config {
    private String name = "idea_047111";
 ...
 */
@Slf4j
public class Idea47111Service {
    private static final int IDEA_ID = 47111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47111Service() {
        this(new Idea47111Config());
    }

    public Idea47111Service(Idea47111Config config) {
        this.config = config != null ? config : new Idea47111Config();
