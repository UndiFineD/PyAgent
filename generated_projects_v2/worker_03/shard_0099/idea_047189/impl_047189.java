...
@Data
public class Idea47189Config {
    private String name = "idea_047189";
 ...
 */
@Slf4j
public class Idea47189Service {
    private static final int IDEA_ID = 47189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47189Service() {
        this(new Idea47189Config());
    }

    public Idea47189Service(Idea47189Config config) {
        this.config = config != null ? config : new Idea47189Config();
