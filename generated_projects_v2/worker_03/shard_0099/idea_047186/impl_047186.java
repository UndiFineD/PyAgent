...
@Data
public class Idea47186Config {
    private String name = "idea_047186";
 ...
 */
@Slf4j
public class Idea47186Service {
    private static final int IDEA_ID = 47186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47186Service() {
        this(new Idea47186Config());
    }

    public Idea47186Service(Idea47186Config config) {
        this.config = config != null ? config : new Idea47186Config();
