...
@Data
public class Idea47436Config {
    private String name = "idea_047436";
 ...
 */
@Slf4j
public class Idea47436Service {
    private static final int IDEA_ID = 47436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47436Service() {
        this(new Idea47436Config());
    }

    public Idea47436Service(Idea47436Config config) {
        this.config = config != null ? config : new Idea47436Config();
