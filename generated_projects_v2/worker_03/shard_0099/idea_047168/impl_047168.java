...
@Data
public class Idea47168Config {
    private String name = "idea_047168";
 ...
 */
@Slf4j
public class Idea47168Service {
    private static final int IDEA_ID = 47168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47168Service() {
        this(new Idea47168Config());
    }

    public Idea47168Service(Idea47168Config config) {
        this.config = config != null ? config : new Idea47168Config();
