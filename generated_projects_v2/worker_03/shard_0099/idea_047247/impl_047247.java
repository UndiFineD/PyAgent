...
@Data
public class Idea47247Config {
    private String name = "idea_047247";
 ...
 */
@Slf4j
public class Idea47247Service {
    private static final int IDEA_ID = 47247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47247Service() {
        this(new Idea47247Config());
    }

    public Idea47247Service(Idea47247Config config) {
        this.config = config != null ? config : new Idea47247Config();
