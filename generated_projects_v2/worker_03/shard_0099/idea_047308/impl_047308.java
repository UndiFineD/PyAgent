...
@Data
public class Idea47308Config {
    private String name = "idea_047308";
 ...
 */
@Slf4j
public class Idea47308Service {
    private static final int IDEA_ID = 47308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47308Service() {
        this(new Idea47308Config());
    }

    public Idea47308Service(Idea47308Config config) {
        this.config = config != null ? config : new Idea47308Config();
