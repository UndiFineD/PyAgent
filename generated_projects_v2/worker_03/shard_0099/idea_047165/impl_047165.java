...
@Data
public class Idea47165Config {
    private String name = "idea_047165";
 ...
 */
@Slf4j
public class Idea47165Service {
    private static final int IDEA_ID = 47165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47165Service() {
        this(new Idea47165Config());
    }

    public Idea47165Service(Idea47165Config config) {
        this.config = config != null ? config : new Idea47165Config();
