...
@Data
public class Idea47288Config {
    private String name = "idea_047288";
 ...
 */
@Slf4j
public class Idea47288Service {
    private static final int IDEA_ID = 47288;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47288Service() {
        this(new Idea47288Config());
    }

    public Idea47288Service(Idea47288Config config) {
        this.config = config != null ? config : new Idea47288Config();
