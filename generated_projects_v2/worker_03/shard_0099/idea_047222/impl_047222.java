...
@Data
public class Idea47222Config {
    private String name = "idea_047222";
 ...
 */
@Slf4j
public class Idea47222Service {
    private static final int IDEA_ID = 47222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47222Service() {
        this(new Idea47222Config());
    }

    public Idea47222Service(Idea47222Config config) {
        this.config = config != null ? config : new Idea47222Config();
