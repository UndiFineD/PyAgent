...
@Data
public class Idea47226Config {
    private String name = "idea_047226";
 ...
 */
@Slf4j
public class Idea47226Service {
    private static final int IDEA_ID = 47226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47226Service() {
        this(new Idea47226Config());
    }

    public Idea47226Service(Idea47226Config config) {
        this.config = config != null ? config : new Idea47226Config();
