...
@Data
public class Idea47416Config {
    private String name = "idea_047416";
 ...
 */
@Slf4j
public class Idea47416Service {
    private static final int IDEA_ID = 47416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47416Service() {
        this(new Idea47416Config());
    }

    public Idea47416Service(Idea47416Config config) {
        this.config = config != null ? config : new Idea47416Config();
