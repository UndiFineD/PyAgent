...
@Data
public class Idea47250Config {
    private String name = "idea_047250";
 ...
 */
@Slf4j
public class Idea47250Service {
    private static final int IDEA_ID = 47250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47250Service() {
        this(new Idea47250Config());
    }

    public Idea47250Service(Idea47250Config config) {
        this.config = config != null ? config : new Idea47250Config();
