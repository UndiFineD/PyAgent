...
@Data
public class Idea47135Config {
    private String name = "idea_047135";
 ...
 */
@Slf4j
public class Idea47135Service {
    private static final int IDEA_ID = 47135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47135Service() {
        this(new Idea47135Config());
    }

    public Idea47135Service(Idea47135Config config) {
        this.config = config != null ? config : new Idea47135Config();
