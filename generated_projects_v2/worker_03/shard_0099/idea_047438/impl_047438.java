...
@Data
public class Idea47438Config {
    private String name = "idea_047438";
 ...
 */
@Slf4j
public class Idea47438Service {
    private static final int IDEA_ID = 47438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47438Service() {
        this(new Idea47438Config());
    }

    public Idea47438Service(Idea47438Config config) {
        this.config = config != null ? config : new Idea47438Config();
