...
@Data
public class Idea47311Config {
    private String name = "idea_047311";
 ...
 */
@Slf4j
public class Idea47311Service {
    private static final int IDEA_ID = 47311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47311Service() {
        this(new Idea47311Config());
    }

    public Idea47311Service(Idea47311Config config) {
        this.config = config != null ? config : new Idea47311Config();
