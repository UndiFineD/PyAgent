...
@Data
public class Idea47215Config {
    private String name = "idea_047215";
 ...
 */
@Slf4j
public class Idea47215Service {
    private static final int IDEA_ID = 47215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47215Service() {
        this(new Idea47215Config());
    }

    public Idea47215Service(Idea47215Config config) {
        this.config = config != null ? config : new Idea47215Config();
