...
@Data
public class Idea47133Config {
    private String name = "idea_047133";
 ...
 */
@Slf4j
public class Idea47133Service {
    private static final int IDEA_ID = 47133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47133Service() {
        this(new Idea47133Config());
    }

    public Idea47133Service(Idea47133Config config) {
        this.config = config != null ? config : new Idea47133Config();
