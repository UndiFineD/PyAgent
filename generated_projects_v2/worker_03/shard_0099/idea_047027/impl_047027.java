...
@Data
public class Idea47027Config {
    private String name = "idea_047027";
 ...
 */
@Slf4j
public class Idea47027Service {
    private static final int IDEA_ID = 47027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47027Service() {
        this(new Idea47027Config());
    }

    public Idea47027Service(Idea47027Config config) {
        this.config = config != null ? config : new Idea47027Config();
