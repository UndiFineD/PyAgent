...
@Data
public class Idea47126Config {
    private String name = "idea_047126";
 ...
 */
@Slf4j
public class Idea47126Service {
    private static final int IDEA_ID = 47126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47126Service() {
        this(new Idea47126Config());
    }

    public Idea47126Service(Idea47126Config config) {
        this.config = config != null ? config : new Idea47126Config();
