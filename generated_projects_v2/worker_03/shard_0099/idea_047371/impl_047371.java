...
@Data
public class Idea47371Config {
    private String name = "idea_047371";
 ...
 */
@Slf4j
public class Idea47371Service {
    private static final int IDEA_ID = 47371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47371Service() {
        this(new Idea47371Config());
    }

    public Idea47371Service(Idea47371Config config) {
        this.config = config != null ? config : new Idea47371Config();
