...
@Data
public class Idea47122Config {
    private String name = "idea_047122";
 ...
 */
@Slf4j
public class Idea47122Service {
    private static final int IDEA_ID = 47122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47122Service() {
        this(new Idea47122Config());
    }

    public Idea47122Service(Idea47122Config config) {
        this.config = config != null ? config : new Idea47122Config();
