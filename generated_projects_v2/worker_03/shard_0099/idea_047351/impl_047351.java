...
@Data
public class Idea47351Config {
    private String name = "idea_047351";
 ...
 */
@Slf4j
public class Idea47351Service {
    private static final int IDEA_ID = 47351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47351Service() {
        this(new Idea47351Config());
    }

    public Idea47351Service(Idea47351Config config) {
        this.config = config != null ? config : new Idea47351Config();
