...
@Data
public class Idea47179Config {
    private String name = "idea_047179";
 ...
 */
@Slf4j
public class Idea47179Service {
    private static final int IDEA_ID = 47179;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47179Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47179Service() {
        this(new Idea47179Config());
    }

    public Idea47179Service(Idea47179Config config) {
        this.config = config != null ? config : new Idea47179Config();
