...
@Data
public class Idea47164Config {
    private String name = "idea_047164";
 ...
 */
@Slf4j
public class Idea47164Service {
    private static final int IDEA_ID = 47164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47164Service() {
        this(new Idea47164Config());
    }

    public Idea47164Service(Idea47164Config config) {
        this.config = config != null ? config : new Idea47164Config();
