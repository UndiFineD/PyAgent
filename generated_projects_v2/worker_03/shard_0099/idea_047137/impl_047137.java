...
@Data
public class Idea47137Config {
    private String name = "idea_047137";
 ...
 */
@Slf4j
public class Idea47137Service {
    private static final int IDEA_ID = 47137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47137Service() {
        this(new Idea47137Config());
    }

    public Idea47137Service(Idea47137Config config) {
        this.config = config != null ? config : new Idea47137Config();
