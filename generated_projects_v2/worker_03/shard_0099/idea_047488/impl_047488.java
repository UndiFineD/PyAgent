...
@Data
public class Idea47488Config {
    private String name = "idea_047488";
 ...
 */
@Slf4j
public class Idea47488Service {
    private static final int IDEA_ID = 47488;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47488Service() {
        this(new Idea47488Config());
    }

    public Idea47488Service(Idea47488Config config) {
        this.config = config != null ? config : new Idea47488Config();
