...
@Data
public class Idea47363Config {
    private String name = "idea_047363";
 ...
 */
@Slf4j
public class Idea47363Service {
    private static final int IDEA_ID = 47363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47363Service() {
        this(new Idea47363Config());
    }

    public Idea47363Service(Idea47363Config config) {
        this.config = config != null ? config : new Idea47363Config();
