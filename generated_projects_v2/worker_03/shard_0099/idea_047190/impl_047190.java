...
@Data
public class Idea47190Config {
    private String name = "idea_047190";
 ...
 */
@Slf4j
public class Idea47190Service {
    private static final int IDEA_ID = 47190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47190Service() {
        this(new Idea47190Config());
    }

    public Idea47190Service(Idea47190Config config) {
        this.config = config != null ? config : new Idea47190Config();
