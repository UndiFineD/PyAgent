...
@Data
public class Idea47085Config {
    private String name = "idea_047085";
 ...
 */
@Slf4j
public class Idea47085Service {
    private static final int IDEA_ID = 47085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47085Service() {
        this(new Idea47085Config());
    }

    public Idea47085Service(Idea47085Config config) {
        this.config = config != null ? config : new Idea47085Config();
