...
@Data
public class Idea47077Config {
    private String name = "idea_047077";
 ...
 */
@Slf4j
public class Idea47077Service {
    private static final int IDEA_ID = 47077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47077Service() {
        this(new Idea47077Config());
    }

    public Idea47077Service(Idea47077Config config) {
        this.config = config != null ? config : new Idea47077Config();
