...
@Data
public class Idea47175Config {
    private String name = "idea_047175";
 ...
 */
@Slf4j
public class Idea47175Service {
    private static final int IDEA_ID = 47175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47175Service() {
        this(new Idea47175Config());
    }

    public Idea47175Service(Idea47175Config config) {
        this.config = config != null ? config : new Idea47175Config();
