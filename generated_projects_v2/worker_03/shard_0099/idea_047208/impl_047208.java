...
@Data
public class Idea47208Config {
    private String name = "idea_047208";
 ...
 */
@Slf4j
public class Idea47208Service {
    private static final int IDEA_ID = 47208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47208Service() {
        this(new Idea47208Config());
    }

    public Idea47208Service(Idea47208Config config) {
        this.config = config != null ? config : new Idea47208Config();
