...
@Data
public class Idea47221Config {
    private String name = "idea_047221";
 ...
 */
@Slf4j
public class Idea47221Service {
    private static final int IDEA_ID = 47221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47221Service() {
        this(new Idea47221Config());
    }

    public Idea47221Service(Idea47221Config config) {
        this.config = config != null ? config : new Idea47221Config();
