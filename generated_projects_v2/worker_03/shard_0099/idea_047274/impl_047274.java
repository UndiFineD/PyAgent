...
@Data
public class Idea47274Config {
    private String name = "idea_047274";
 ...
 */
@Slf4j
public class Idea47274Service {
    private static final int IDEA_ID = 47274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47274Service() {
        this(new Idea47274Config());
    }

    public Idea47274Service(Idea47274Config config) {
        this.config = config != null ? config : new Idea47274Config();
