...
@Data
public class Idea47480Config {
    private String name = "idea_047480";
 ...
 */
@Slf4j
public class Idea47480Service {
    private static final int IDEA_ID = 47480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47480Service() {
        this(new Idea47480Config());
    }

    public Idea47480Service(Idea47480Config config) {
        this.config = config != null ? config : new Idea47480Config();
