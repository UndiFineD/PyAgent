...
@Data
public class Idea47483Config {
    private String name = "idea_047483";
 ...
 */
@Slf4j
public class Idea47483Service {
    private static final int IDEA_ID = 47483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47483Service() {
        this(new Idea47483Config());
    }

    public Idea47483Service(Idea47483Config config) {
        this.config = config != null ? config : new Idea47483Config();
