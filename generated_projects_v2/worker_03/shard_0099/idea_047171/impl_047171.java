...
@Data
public class Idea47171Config {
    private String name = "idea_047171";
 ...
 */
@Slf4j
public class Idea47171Service {
    private static final int IDEA_ID = 47171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47171Service() {
        this(new Idea47171Config());
    }

    public Idea47171Service(Idea47171Config config) {
        this.config = config != null ? config : new Idea47171Config();
