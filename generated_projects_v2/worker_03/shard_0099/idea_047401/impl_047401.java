...
@Data
public class Idea47401Config {
    private String name = "idea_047401";
 ...
 */
@Slf4j
public class Idea47401Service {
    private static final int IDEA_ID = 47401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47401Service() {
        this(new Idea47401Config());
    }

    public Idea47401Service(Idea47401Config config) {
        this.config = config != null ? config : new Idea47401Config();
