...
@Data
public class Idea47452Config {
    private String name = "idea_047452";
 ...
 */
@Slf4j
public class Idea47452Service {
    private static final int IDEA_ID = 47452;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47452Service() {
        this(new Idea47452Config());
    }

    public Idea47452Service(Idea47452Config config) {
        this.config = config != null ? config : new Idea47452Config();
