...
@Data
public class Idea47338Config {
    private String name = "idea_047338";
 ...
 */
@Slf4j
public class Idea47338Service {
    private static final int IDEA_ID = 47338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47338Service() {
        this(new Idea47338Config());
    }

    public Idea47338Service(Idea47338Config config) {
        this.config = config != null ? config : new Idea47338Config();
