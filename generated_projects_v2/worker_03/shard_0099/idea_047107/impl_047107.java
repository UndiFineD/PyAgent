...
@Data
public class Idea47107Config {
    private String name = "idea_047107";
 ...
 */
@Slf4j
public class Idea47107Service {
    private static final int IDEA_ID = 47107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47107Service() {
        this(new Idea47107Config());
    }

    public Idea47107Service(Idea47107Config config) {
        this.config = config != null ? config : new Idea47107Config();
