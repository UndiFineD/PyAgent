...
@Data
public class Idea47376Config {
    private String name = "idea_047376";
 ...
 */
@Slf4j
public class Idea47376Service {
    private static final int IDEA_ID = 47376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47376Service() {
        this(new Idea47376Config());
    }

    public Idea47376Service(Idea47376Config config) {
        this.config = config != null ? config : new Idea47376Config();
