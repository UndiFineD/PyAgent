...
@Data
public class Idea47378Config {
    private String name = "idea_047378";
 ...
 */
@Slf4j
public class Idea47378Service {
    private static final int IDEA_ID = 47378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47378Service() {
        this(new Idea47378Config());
    }

    public Idea47378Service(Idea47378Config config) {
        this.config = config != null ? config : new Idea47378Config();
