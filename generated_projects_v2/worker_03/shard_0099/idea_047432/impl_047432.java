...
@Data
public class Idea47432Config {
    private String name = "idea_047432";
 ...
 */
@Slf4j
public class Idea47432Service {
    private static final int IDEA_ID = 47432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47432Service() {
        this(new Idea47432Config());
    }

    public Idea47432Service(Idea47432Config config) {
        this.config = config != null ? config : new Idea47432Config();
