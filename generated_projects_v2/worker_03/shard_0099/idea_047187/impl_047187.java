...
@Data
public class Idea47187Config {
    private String name = "idea_047187";
 ...
 */
@Slf4j
public class Idea47187Service {
    private static final int IDEA_ID = 47187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47187Service() {
        this(new Idea47187Config());
    }

    public Idea47187Service(Idea47187Config config) {
        this.config = config != null ? config : new Idea47187Config();
