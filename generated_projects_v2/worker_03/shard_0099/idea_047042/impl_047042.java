...
@Data
public class Idea47042Config {
    private String name = "idea_047042";
 ...
 */
@Slf4j
public class Idea47042Service {
    private static final int IDEA_ID = 47042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47042Service() {
        this(new Idea47042Config());
    }

    public Idea47042Service(Idea47042Config config) {
        this.config = config != null ? config : new Idea47042Config();
