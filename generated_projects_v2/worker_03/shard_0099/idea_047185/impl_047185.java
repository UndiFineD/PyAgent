...
@Data
public class Idea47185Config {
    private String name = "idea_047185";
 ...
 */
@Slf4j
public class Idea47185Service {
    private static final int IDEA_ID = 47185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47185Service() {
        this(new Idea47185Config());
    }

    public Idea47185Service(Idea47185Config config) {
        this.config = config != null ? config : new Idea47185Config();
