...
@Data
public class Idea47134Config {
    private String name = "idea_047134";
 ...
 */
@Slf4j
public class Idea47134Service {
    private static final int IDEA_ID = 47134;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47134Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47134Service() {
        this(new Idea47134Config());
    }

    public Idea47134Service(Idea47134Config config) {
        this.config = config != null ? config : new Idea47134Config();
