...
@Data
public class Idea47046Config {
    private String name = "idea_047046";
 ...
 */
@Slf4j
public class Idea47046Service {
    private static final int IDEA_ID = 47046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47046Service() {
        this(new Idea47046Config());
    }

    public Idea47046Service(Idea47046Config config) {
        this.config = config != null ? config : new Idea47046Config();
