...
@Data
public class Idea47468Config {
    private String name = "idea_047468";
 ...
 */
@Slf4j
public class Idea47468Service {
    private static final int IDEA_ID = 47468;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47468Service() {
        this(new Idea47468Config());
    }

    public Idea47468Service(Idea47468Config config) {
        this.config = config != null ? config : new Idea47468Config();
