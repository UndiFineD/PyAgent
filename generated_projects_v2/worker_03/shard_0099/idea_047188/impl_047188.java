...
@Data
public class Idea47188Config {
    private String name = "idea_047188";
 ...
 */
@Slf4j
public class Idea47188Service {
    private static final int IDEA_ID = 47188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47188Service() {
        this(new Idea47188Config());
    }

    public Idea47188Service(Idea47188Config config) {
        this.config = config != null ? config : new Idea47188Config();
