...
@Data
public class Idea47264Config {
    private String name = "idea_047264";
 ...
 */
@Slf4j
public class Idea47264Service {
    private static final int IDEA_ID = 47264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47264Service() {
        this(new Idea47264Config());
    }

    public Idea47264Service(Idea47264Config config) {
        this.config = config != null ? config : new Idea47264Config();
