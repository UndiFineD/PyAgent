...
@Data
public class Idea47326Config {
    private String name = "idea_047326";
 ...
 */
@Slf4j
public class Idea47326Service {
    private static final int IDEA_ID = 47326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47326Service() {
        this(new Idea47326Config());
    }

    public Idea47326Service(Idea47326Config config) {
        this.config = config != null ? config : new Idea47326Config();
