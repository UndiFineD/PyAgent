...
@Data
public class Idea47426Config {
    private String name = "idea_047426";
 ...
 */
@Slf4j
public class Idea47426Service {
    private static final int IDEA_ID = 47426;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47426Service() {
        this(new Idea47426Config());
    }

    public Idea47426Service(Idea47426Config config) {
        this.config = config != null ? config : new Idea47426Config();
