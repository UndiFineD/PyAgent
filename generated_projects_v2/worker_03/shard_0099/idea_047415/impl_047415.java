...
@Data
public class Idea47415Config {
    private String name = "idea_047415";
 ...
 */
@Slf4j
public class Idea47415Service {
    private static final int IDEA_ID = 47415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47415Service() {
        this(new Idea47415Config());
    }

    public Idea47415Service(Idea47415Config config) {
        this.config = config != null ? config : new Idea47415Config();
