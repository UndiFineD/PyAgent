...
@Data
public class Idea47063Config {
    private String name = "idea_047063";
 ...
 */
@Slf4j
public class Idea47063Service {
    private static final int IDEA_ID = 47063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47063Service() {
        this(new Idea47063Config());
    }

    public Idea47063Service(Idea47063Config config) {
        this.config = config != null ? config : new Idea47063Config();
