...
@Data
public class Idea47178Config {
    private String name = "idea_047178";
 ...
 */
@Slf4j
public class Idea47178Service {
    private static final int IDEA_ID = 47178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47178Service() {
        this(new Idea47178Config());
    }

    public Idea47178Service(Idea47178Config config) {
        this.config = config != null ? config : new Idea47178Config();
