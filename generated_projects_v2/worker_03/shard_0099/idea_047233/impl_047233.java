...
@Data
public class Idea47233Config {
    private String name = "idea_047233";
 ...
 */
@Slf4j
public class Idea47233Service {
    private static final int IDEA_ID = 47233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47233Service() {
        this(new Idea47233Config());
    }

    public Idea47233Service(Idea47233Config config) {
        this.config = config != null ? config : new Idea47233Config();
