...
@Data
public class Idea47396Config {
    private String name = "idea_047396";
 ...
 */
@Slf4j
public class Idea47396Service {
    private static final int IDEA_ID = 47396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47396Service() {
        this(new Idea47396Config());
    }

    public Idea47396Service(Idea47396Config config) {
        this.config = config != null ? config : new Idea47396Config();
