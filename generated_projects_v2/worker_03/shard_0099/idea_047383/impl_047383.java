...
@Data
public class Idea47383Config {
    private String name = "idea_047383";
 ...
 */
@Slf4j
public class Idea47383Service {
    private static final int IDEA_ID = 47383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47383Service() {
        this(new Idea47383Config());
    }

    public Idea47383Service(Idea47383Config config) {
        this.config = config != null ? config : new Idea47383Config();
