...
@Data
public class Idea47474Config {
    private String name = "idea_047474";
 ...
 */
@Slf4j
public class Idea47474Service {
    private static final int IDEA_ID = 47474;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47474Service() {
        this(new Idea47474Config());
    }

    public Idea47474Service(Idea47474Config config) {
        this.config = config != null ? config : new Idea47474Config();
