...
@Data
public class Idea47386Config {
    private String name = "idea_047386";
 ...
 */
@Slf4j
public class Idea47386Service {
    private static final int IDEA_ID = 47386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47386Service() {
        this(new Idea47386Config());
    }

    public Idea47386Service(Idea47386Config config) {
        this.config = config != null ? config : new Idea47386Config();
