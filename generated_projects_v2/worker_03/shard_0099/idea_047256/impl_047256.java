...
@Data
public class Idea47256Config {
    private String name = "idea_047256";
 ...
 */
@Slf4j
public class Idea47256Service {
    private static final int IDEA_ID = 47256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47256Service() {
        this(new Idea47256Config());
    }

    public Idea47256Service(Idea47256Config config) {
        this.config = config != null ? config : new Idea47256Config();
