...
@Data
public class Idea47433Config {
    private String name = "idea_047433";
 ...
 */
@Slf4j
public class Idea47433Service {
    private static final int IDEA_ID = 47433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47433Service() {
        this(new Idea47433Config());
    }

    public Idea47433Service(Idea47433Config config) {
        this.config = config != null ? config : new Idea47433Config();
