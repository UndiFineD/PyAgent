...
@Data
public class Idea47411Config {
    private String name = "idea_047411";
 ...
 */
@Slf4j
public class Idea47411Service {
    private static final int IDEA_ID = 47411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47411Service() {
        this(new Idea47411Config());
    }

    public Idea47411Service(Idea47411Config config) {
        this.config = config != null ? config : new Idea47411Config();
