...
@Data
public class Idea47195Config {
    private String name = "idea_047195";
 ...
 */
@Slf4j
public class Idea47195Service {
    private static final int IDEA_ID = 47195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47195Service() {
        this(new Idea47195Config());
    }

    public Idea47195Service(Idea47195Config config) {
        this.config = config != null ? config : new Idea47195Config();
