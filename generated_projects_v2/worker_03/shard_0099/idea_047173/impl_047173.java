...
@Data
public class Idea47173Config {
    private String name = "idea_047173";
 ...
 */
@Slf4j
public class Idea47173Service {
    private static final int IDEA_ID = 47173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47173Service() {
        this(new Idea47173Config());
    }

    public Idea47173Service(Idea47173Config config) {
        this.config = config != null ? config : new Idea47173Config();
