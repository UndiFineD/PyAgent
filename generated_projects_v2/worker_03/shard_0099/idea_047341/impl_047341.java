...
@Data
public class Idea47341Config {
    private String name = "idea_047341";
 ...
 */
@Slf4j
public class Idea47341Service {
    private static final int IDEA_ID = 47341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47341Service() {
        this(new Idea47341Config());
    }

    public Idea47341Service(Idea47341Config config) {
        this.config = config != null ? config : new Idea47341Config();
