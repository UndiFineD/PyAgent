...
@Data
public class Idea47390Config {
    private String name = "idea_047390";
 ...
 */
@Slf4j
public class Idea47390Service {
    private static final int IDEA_ID = 47390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47390Service() {
        this(new Idea47390Config());
    }

    public Idea47390Service(Idea47390Config config) {
        this.config = config != null ? config : new Idea47390Config();
