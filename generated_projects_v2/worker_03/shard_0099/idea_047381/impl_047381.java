...
@Data
public class Idea47381Config {
    private String name = "idea_047381";
 ...
 */
@Slf4j
public class Idea47381Service {
    private static final int IDEA_ID = 47381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47381Service() {
        this(new Idea47381Config());
    }

    public Idea47381Service(Idea47381Config config) {
        this.config = config != null ? config : new Idea47381Config();
