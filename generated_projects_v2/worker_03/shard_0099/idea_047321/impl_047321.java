...
@Data
public class Idea47321Config {
    private String name = "idea_047321";
 ...
 */
@Slf4j
public class Idea47321Service {
    private static final int IDEA_ID = 47321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47321Service() {
        this(new Idea47321Config());
    }

    public Idea47321Service(Idea47321Config config) {
        this.config = config != null ? config : new Idea47321Config();
