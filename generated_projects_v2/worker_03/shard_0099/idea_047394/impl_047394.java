...
@Data
public class Idea47394Config {
    private String name = "idea_047394";
 ...
 */
@Slf4j
public class Idea47394Service {
    private static final int IDEA_ID = 47394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47394Service() {
        this(new Idea47394Config());
    }

    public Idea47394Service(Idea47394Config config) {
        this.config = config != null ? config : new Idea47394Config();
