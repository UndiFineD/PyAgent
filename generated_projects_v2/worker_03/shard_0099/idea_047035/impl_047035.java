...
@Data
public class Idea47035Config {
    private String name = "idea_047035";
 ...
 */
@Slf4j
public class Idea47035Service {
    private static final int IDEA_ID = 47035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47035Service() {
        this(new Idea47035Config());
    }

    public Idea47035Service(Idea47035Config config) {
        this.config = config != null ? config : new Idea47035Config();
