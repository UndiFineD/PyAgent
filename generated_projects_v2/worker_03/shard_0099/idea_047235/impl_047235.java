...
@Data
public class Idea47235Config {
    private String name = "idea_047235";
 ...
 */
@Slf4j
public class Idea47235Service {
    private static final int IDEA_ID = 47235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47235Service() {
        this(new Idea47235Config());
    }

    public Idea47235Service(Idea47235Config config) {
        this.config = config != null ? config : new Idea47235Config();
