...
@Data
public class Idea47410Config {
    private String name = "idea_047410";
 ...
 */
@Slf4j
public class Idea47410Service {
    private static final int IDEA_ID = 47410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47410Service() {
        this(new Idea47410Config());
    }

    public Idea47410Service(Idea47410Config config) {
        this.config = config != null ? config : new Idea47410Config();
