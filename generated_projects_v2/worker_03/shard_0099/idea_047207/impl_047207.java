...
@Data
public class Idea47207Config {
    private String name = "idea_047207";
 ...
 */
@Slf4j
public class Idea47207Service {
    private static final int IDEA_ID = 47207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47207Service() {
        this(new Idea47207Config());
    }

    public Idea47207Service(Idea47207Config config) {
        this.config = config != null ? config : new Idea47207Config();
