...
@Data
public class Idea47350Config {
    private String name = "idea_047350";
 ...
 */
@Slf4j
public class Idea47350Service {
    private static final int IDEA_ID = 47350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47350Service() {
        this(new Idea47350Config());
    }

    public Idea47350Service(Idea47350Config config) {
        this.config = config != null ? config : new Idea47350Config();
