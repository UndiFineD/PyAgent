...
@Data
public class Idea47348Config {
    private String name = "idea_047348";
 ...
 */
@Slf4j
public class Idea47348Service {
    private static final int IDEA_ID = 47348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47348Service() {
        this(new Idea47348Config());
    }

    public Idea47348Service(Idea47348Config config) {
        this.config = config != null ? config : new Idea47348Config();
