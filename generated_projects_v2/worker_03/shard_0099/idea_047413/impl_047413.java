...
@Data
public class Idea47413Config {
    private String name = "idea_047413";
 ...
 */
@Slf4j
public class Idea47413Service {
    private static final int IDEA_ID = 47413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47413Service() {
        this(new Idea47413Config());
    }

    public Idea47413Service(Idea47413Config config) {
        this.config = config != null ? config : new Idea47413Config();
