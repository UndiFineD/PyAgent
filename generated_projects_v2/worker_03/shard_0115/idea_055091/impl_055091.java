...
@Data
public class Idea55091Config {
    private String name = "idea_055091";
 ...
 */
@Slf4j
public class Idea55091Service {
    private static final int IDEA_ID = 55091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55091Service() {
        this(new Idea55091Config());
    }

    public Idea55091Service(Idea55091Config config) {
        this.config = config != null ? config : new Idea55091Config();
