...
@Data
public class Idea54634Config {
    private String name = "idea_054634";
 ...
 */
@Slf4j
public class Idea54634Service {
    private static final int IDEA_ID = 54634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54634Service() {
        this(new Idea54634Config());
    }

    public Idea54634Service(Idea54634Config config) {
        this.config = config != null ? config : new Idea54634Config();
