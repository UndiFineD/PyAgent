...
@Data
public class Idea54956Config {
    private String name = "idea_054956";
 ...
 */
@Slf4j
public class Idea54956Service {
    private static final int IDEA_ID = 54956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54956Service() {
        this(new Idea54956Config());
    }

    public Idea54956Service(Idea54956Config config) {
        this.config = config != null ? config : new Idea54956Config();
