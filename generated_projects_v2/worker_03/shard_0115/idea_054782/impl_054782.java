...
@Data
public class Idea54782Config {
    private String name = "idea_054782";
 ...
 */
@Slf4j
public class Idea54782Service {
    private static final int IDEA_ID = 54782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54782Service() {
        this(new Idea54782Config());
    }

    public Idea54782Service(Idea54782Config config) {
        this.config = config != null ? config : new Idea54782Config();
