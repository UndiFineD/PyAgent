...
@Data
public class Idea55006Config {
    private String name = "idea_055006";
 ...
 */
@Slf4j
public class Idea55006Service {
    private static final int IDEA_ID = 55006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55006Service() {
        this(new Idea55006Config());
    }

    public Idea55006Service(Idea55006Config config) {
        this.config = config != null ? config : new Idea55006Config();
