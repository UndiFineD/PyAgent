...
@Data
public class Idea55012Config {
    private String name = "idea_055012";
 ...
 */
@Slf4j
public class Idea55012Service {
    private static final int IDEA_ID = 55012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55012Service() {
        this(new Idea55012Config());
    }

    public Idea55012Service(Idea55012Config config) {
        this.config = config != null ? config : new Idea55012Config();
