...
@Data
public class Idea54771Config {
    private String name = "idea_054771";
 ...
 */
@Slf4j
public class Idea54771Service {
    private static final int IDEA_ID = 54771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54771Service() {
        this(new Idea54771Config());
    }

    public Idea54771Service(Idea54771Config config) {
        this.config = config != null ? config : new Idea54771Config();
