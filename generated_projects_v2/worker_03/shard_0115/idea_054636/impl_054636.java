...
@Data
public class Idea54636Config {
    private String name = "idea_054636";
 ...
 */
@Slf4j
public class Idea54636Service {
    private static final int IDEA_ID = 54636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54636Service() {
        this(new Idea54636Config());
    }

    public Idea54636Service(Idea54636Config config) {
        this.config = config != null ? config : new Idea54636Config();
