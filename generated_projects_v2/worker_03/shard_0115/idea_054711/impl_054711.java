...
@Data
public class Idea54711Config {
    private String name = "idea_054711";
 ...
 */
@Slf4j
public class Idea54711Service {
    private static final int IDEA_ID = 54711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54711Service() {
        this(new Idea54711Config());
    }

    public Idea54711Service(Idea54711Config config) {
        this.config = config != null ? config : new Idea54711Config();
