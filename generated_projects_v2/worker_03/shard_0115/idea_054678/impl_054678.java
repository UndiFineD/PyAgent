...
@Data
public class Idea54678Config {
    private String name = "idea_054678";
 ...
 */
@Slf4j
public class Idea54678Service {
    private static final int IDEA_ID = 54678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54678Service() {
        this(new Idea54678Config());
    }

    public Idea54678Service(Idea54678Config config) {
        this.config = config != null ? config : new Idea54678Config();
