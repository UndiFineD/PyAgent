...
@Data
public class Idea54897Config {
    private String name = "idea_054897";
 ...
 */
@Slf4j
public class Idea54897Service {
    private static final int IDEA_ID = 54897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54897Service() {
        this(new Idea54897Config());
    }

    public Idea54897Service(Idea54897Config config) {
        this.config = config != null ? config : new Idea54897Config();
