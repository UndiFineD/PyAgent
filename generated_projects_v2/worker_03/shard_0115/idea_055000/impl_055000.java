...
@Data
public class Idea55000Config {
    private String name = "idea_055000";
 ...
 */
@Slf4j
public class Idea55000Service {
    private static final int IDEA_ID = 55000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55000Service() {
        this(new Idea55000Config());
    }

    public Idea55000Service(Idea55000Config config) {
        this.config = config != null ? config : new Idea55000Config();
