...
@Data
public class Idea54725Config {
    private String name = "idea_054725";
 ...
 */
@Slf4j
public class Idea54725Service {
    private static final int IDEA_ID = 54725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54725Service() {
        this(new Idea54725Config());
    }

    public Idea54725Service(Idea54725Config config) {
        this.config = config != null ? config : new Idea54725Config();
