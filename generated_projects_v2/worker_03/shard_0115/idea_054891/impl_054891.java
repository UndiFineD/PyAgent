...
@Data
public class Idea54891Config {
    private String name = "idea_054891";
 ...
 */
@Slf4j
public class Idea54891Service {
    private static final int IDEA_ID = 54891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54891Service() {
        this(new Idea54891Config());
    }

    public Idea54891Service(Idea54891Config config) {
        this.config = config != null ? config : new Idea54891Config();
