...
@Data
public class Idea54847Config {
    private String name = "idea_054847";
 ...
 */
@Slf4j
public class Idea54847Service {
    private static final int IDEA_ID = 54847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54847Service() {
        this(new Idea54847Config());
    }

    public Idea54847Service(Idea54847Config config) {
        this.config = config != null ? config : new Idea54847Config();
