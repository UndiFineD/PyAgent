...
@Data
public class Idea55016Config {
    private String name = "idea_055016";
 ...
 */
@Slf4j
public class Idea55016Service {
    private static final int IDEA_ID = 55016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55016Service() {
        this(new Idea55016Config());
    }

    public Idea55016Service(Idea55016Config config) {
        this.config = config != null ? config : new Idea55016Config();
