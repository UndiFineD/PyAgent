...
@Data
public class Idea55042Config {
    private String name = "idea_055042";
 ...
 */
@Slf4j
public class Idea55042Service {
    private static final int IDEA_ID = 55042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55042Service() {
        this(new Idea55042Config());
    }

    public Idea55042Service(Idea55042Config config) {
        this.config = config != null ? config : new Idea55042Config();
