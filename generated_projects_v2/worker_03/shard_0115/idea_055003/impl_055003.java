...
@Data
public class Idea55003Config {
    private String name = "idea_055003";
 ...
 */
@Slf4j
public class Idea55003Service {
    private static final int IDEA_ID = 55003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55003Service() {
        this(new Idea55003Config());
    }

    public Idea55003Service(Idea55003Config config) {
        this.config = config != null ? config : new Idea55003Config();
