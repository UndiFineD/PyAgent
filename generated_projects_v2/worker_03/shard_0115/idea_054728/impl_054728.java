...
@Data
public class Idea54728Config {
    private String name = "idea_054728";
 ...
 */
@Slf4j
public class Idea54728Service {
    private static final int IDEA_ID = 54728;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54728Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54728Service() {
        this(new Idea54728Config());
    }

    public Idea54728Service(Idea54728Config config) {
        this.config = config != null ? config : new Idea54728Config();
