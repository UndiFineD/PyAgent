...
@Data
public class Idea54637Config {
    private String name = "idea_054637";
 ...
 */
@Slf4j
public class Idea54637Service {
    private static final int IDEA_ID = 54637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54637Service() {
        this(new Idea54637Config());
    }

    public Idea54637Service(Idea54637Config config) {
        this.config = config != null ? config : new Idea54637Config();
