...
@Data
public class Idea55022Config {
    private String name = "idea_055022";
 ...
 */
@Slf4j
public class Idea55022Service {
    private static final int IDEA_ID = 55022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55022Service() {
        this(new Idea55022Config());
    }

    public Idea55022Service(Idea55022Config config) {
        this.config = config != null ? config : new Idea55022Config();
