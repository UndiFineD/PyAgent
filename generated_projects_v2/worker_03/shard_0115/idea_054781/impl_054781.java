...
@Data
public class Idea54781Config {
    private String name = "idea_054781";
 ...
 */
@Slf4j
public class Idea54781Service {
    private static final int IDEA_ID = 54781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54781Service() {
        this(new Idea54781Config());
    }

    public Idea54781Service(Idea54781Config config) {
        this.config = config != null ? config : new Idea54781Config();
