...
@Data
public class Idea55024Config {
    private String name = "idea_055024";
 ...
 */
@Slf4j
public class Idea55024Service {
    private static final int IDEA_ID = 55024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55024Service() {
        this(new Idea55024Config());
    }

    public Idea55024Service(Idea55024Config config) {
        this.config = config != null ? config : new Idea55024Config();
