...
@Data
public class Idea55015Config {
    private String name = "idea_055015";
 ...
 */
@Slf4j
public class Idea55015Service {
    private static final int IDEA_ID = 55015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55015Service() {
        this(new Idea55015Config());
    }

    public Idea55015Service(Idea55015Config config) {
        this.config = config != null ? config : new Idea55015Config();
