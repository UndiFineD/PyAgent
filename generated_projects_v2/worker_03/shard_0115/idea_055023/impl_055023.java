...
@Data
public class Idea55023Config {
    private String name = "idea_055023";
 ...
 */
@Slf4j
public class Idea55023Service {
    private static final int IDEA_ID = 55023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55023Service() {
        this(new Idea55023Config());
    }

    public Idea55023Service(Idea55023Config config) {
        this.config = config != null ? config : new Idea55023Config();
