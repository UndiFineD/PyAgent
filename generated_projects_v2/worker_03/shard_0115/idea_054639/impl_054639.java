...
@Data
public class Idea54639Config {
    private String name = "idea_054639";
 ...
 */
@Slf4j
public class Idea54639Service {
    private static final int IDEA_ID = 54639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54639Service() {
        this(new Idea54639Config());
    }

    public Idea54639Service(Idea54639Config config) {
        this.config = config != null ? config : new Idea54639Config();
