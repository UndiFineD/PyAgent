...
@Data
public class Idea54915Config {
    private String name = "idea_054915";
 ...
 */
@Slf4j
public class Idea54915Service {
    private static final int IDEA_ID = 54915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54915Service() {
        this(new Idea54915Config());
    }

    public Idea54915Service(Idea54915Config config) {
        this.config = config != null ? config : new Idea54915Config();
