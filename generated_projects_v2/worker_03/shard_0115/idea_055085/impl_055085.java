...
@Data
public class Idea55085Config {
    private String name = "idea_055085";
 ...
 */
@Slf4j
public class Idea55085Service {
    private static final int IDEA_ID = 55085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55085Service() {
        this(new Idea55085Config());
    }

    public Idea55085Service(Idea55085Config config) {
        this.config = config != null ? config : new Idea55085Config();
