...
@Data
public class Idea55070Config {
    private String name = "idea_055070";
 ...
 */
@Slf4j
public class Idea55070Service {
    private static final int IDEA_ID = 55070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55070Service() {
        this(new Idea55070Config());
    }

    public Idea55070Service(Idea55070Config config) {
        this.config = config != null ? config : new Idea55070Config();
