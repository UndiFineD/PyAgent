...
@Data
public class Idea55014Config {
    private String name = "idea_055014";
 ...
 */
@Slf4j
public class Idea55014Service {
    private static final int IDEA_ID = 55014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55014Service() {
        this(new Idea55014Config());
    }

    public Idea55014Service(Idea55014Config config) {
        this.config = config != null ? config : new Idea55014Config();
