...
@Data
public class Idea54797Config {
    private String name = "idea_054797";
 ...
 */
@Slf4j
public class Idea54797Service {
    private static final int IDEA_ID = 54797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54797Service() {
        this(new Idea54797Config());
    }

    public Idea54797Service(Idea54797Config config) {
        this.config = config != null ? config : new Idea54797Config();
