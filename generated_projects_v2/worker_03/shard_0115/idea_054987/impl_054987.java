...
@Data
public class Idea54987Config {
    private String name = "idea_054987";
 ...
 */
@Slf4j
public class Idea54987Service {
    private static final int IDEA_ID = 54987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54987Service() {
        this(new Idea54987Config());
    }

    public Idea54987Service(Idea54987Config config) {
        this.config = config != null ? config : new Idea54987Config();
