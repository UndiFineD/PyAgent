...
@Data
public class Idea55053Config {
    private String name = "idea_055053";
 ...
 */
@Slf4j
public class Idea55053Service {
    private static final int IDEA_ID = 55053;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55053Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55053Service() {
        this(new Idea55053Config());
    }

    public Idea55053Service(Idea55053Config config) {
        this.config = config != null ? config : new Idea55053Config();
