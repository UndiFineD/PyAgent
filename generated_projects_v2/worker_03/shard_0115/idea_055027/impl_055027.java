...
@Data
public class Idea55027Config {
    private String name = "idea_055027";
 ...
 */
@Slf4j
public class Idea55027Service {
    private static final int IDEA_ID = 55027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55027Service() {
        this(new Idea55027Config());
    }

    public Idea55027Service(Idea55027Config config) {
        this.config = config != null ? config : new Idea55027Config();
