...
@Data
public class Idea55033Config {
    private String name = "idea_055033";
 ...
 */
@Slf4j
public class Idea55033Service {
    private static final int IDEA_ID = 55033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55033Service() {
        this(new Idea55033Config());
    }

    public Idea55033Service(Idea55033Config config) {
        this.config = config != null ? config : new Idea55033Config();
