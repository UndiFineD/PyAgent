...
@Data
public class Idea55036Config {
    private String name = "idea_055036";
 ...
 */
@Slf4j
public class Idea55036Service {
    private static final int IDEA_ID = 55036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55036Service() {
        this(new Idea55036Config());
    }

    public Idea55036Service(Idea55036Config config) {
        this.config = config != null ? config : new Idea55036Config();
