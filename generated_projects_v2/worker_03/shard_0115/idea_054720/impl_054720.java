...
@Data
public class Idea54720Config {
    private String name = "idea_054720";
 ...
 */
@Slf4j
public class Idea54720Service {
    private static final int IDEA_ID = 54720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54720Service() {
        this(new Idea54720Config());
    }

    public Idea54720Service(Idea54720Config config) {
        this.config = config != null ? config : new Idea54720Config();
