...
@Data
public class Idea54638Config {
    private String name = "idea_054638";
 ...
 */
@Slf4j
public class Idea54638Service {
    private static final int IDEA_ID = 54638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54638Service() {
        this(new Idea54638Config());
    }

    public Idea54638Service(Idea54638Config config) {
        this.config = config != null ? config : new Idea54638Config();
