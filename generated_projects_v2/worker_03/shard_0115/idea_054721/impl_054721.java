...
@Data
public class Idea54721Config {
    private String name = "idea_054721";
 ...
 */
@Slf4j
public class Idea54721Service {
    private static final int IDEA_ID = 54721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54721Service() {
        this(new Idea54721Config());
    }

    public Idea54721Service(Idea54721Config config) {
        this.config = config != null ? config : new Idea54721Config();
