...
@Data
public class Idea54973Config {
    private String name = "idea_054973";
 ...
 */
@Slf4j
public class Idea54973Service {
    private static final int IDEA_ID = 54973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54973Service() {
        this(new Idea54973Config());
    }

    public Idea54973Service(Idea54973Config config) {
        this.config = config != null ? config : new Idea54973Config();
