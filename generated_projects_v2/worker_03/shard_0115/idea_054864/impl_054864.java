...
@Data
public class Idea54864Config {
    private String name = "idea_054864";
 ...
 */
@Slf4j
public class Idea54864Service {
    private static final int IDEA_ID = 54864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54864Service() {
        this(new Idea54864Config());
    }

    public Idea54864Service(Idea54864Config config) {
        this.config = config != null ? config : new Idea54864Config();
