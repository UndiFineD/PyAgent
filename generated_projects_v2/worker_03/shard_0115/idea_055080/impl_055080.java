...
@Data
public class Idea55080Config {
    private String name = "idea_055080";
 ...
 */
@Slf4j
public class Idea55080Service {
    private static final int IDEA_ID = 55080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55080Service() {
        this(new Idea55080Config());
    }

    public Idea55080Service(Idea55080Config config) {
        this.config = config != null ? config : new Idea55080Config();
