...
@Data
public class Idea54780Config {
    private String name = "idea_054780";
 ...
 */
@Slf4j
public class Idea54780Service {
    private static final int IDEA_ID = 54780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54780Service() {
        this(new Idea54780Config());
    }

    public Idea54780Service(Idea54780Config config) {
        this.config = config != null ? config : new Idea54780Config();
