...
@Data
public class Idea55008Config {
    private String name = "idea_055008";
 ...
 */
@Slf4j
public class Idea55008Service {
    private static final int IDEA_ID = 55008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55008Service() {
        this(new Idea55008Config());
    }

    public Idea55008Service(Idea55008Config config) {
        this.config = config != null ? config : new Idea55008Config();
