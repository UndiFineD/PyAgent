...
@Data
public class Idea54647Config {
    private String name = "idea_054647";
 ...
 */
@Slf4j
public class Idea54647Service {
    private static final int IDEA_ID = 54647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54647Service() {
        this(new Idea54647Config());
    }

    public Idea54647Service(Idea54647Config config) {
        this.config = config != null ? config : new Idea54647Config();
