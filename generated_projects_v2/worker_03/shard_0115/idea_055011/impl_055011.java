...
@Data
public class Idea55011Config {
    private String name = "idea_055011";
 ...
 */
@Slf4j
public class Idea55011Service {
    private static final int IDEA_ID = 55011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55011Service() {
        this(new Idea55011Config());
    }

    public Idea55011Service(Idea55011Config config) {
        this.config = config != null ? config : new Idea55011Config();
