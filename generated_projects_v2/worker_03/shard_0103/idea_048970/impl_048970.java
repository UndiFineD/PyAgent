...
@Data
public class Idea48970Config {
    private String name = "idea_048970";
 ...
 */
@Slf4j
public class Idea48970Service {
    private static final int IDEA_ID = 48970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48970Service() {
        this(new Idea48970Config());
    }

    public Idea48970Service(Idea48970Config config) {
        this.config = config != null ? config : new Idea48970Config();
