...
@Data
public class Idea48938Config {
    private String name = "idea_048938";
 ...
 */
@Slf4j
public class Idea48938Service {
    private static final int IDEA_ID = 48938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48938Service() {
        this(new Idea48938Config());
    }

    public Idea48938Service(Idea48938Config config) {
        this.config = config != null ? config : new Idea48938Config();
