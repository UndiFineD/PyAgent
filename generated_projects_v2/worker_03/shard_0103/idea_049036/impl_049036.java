...
@Data
public class Idea49036Config {
    private String name = "idea_049036";
 ...
 */
@Slf4j
public class Idea49036Service {
    private static final int IDEA_ID = 49036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49036Service() {
        this(new Idea49036Config());
    }

    public Idea49036Service(Idea49036Config config) {
        this.config = config != null ? config : new Idea49036Config();
