...
@Data
public class Idea49243Config {
    private String name = "idea_049243";
 ...
 */
@Slf4j
public class Idea49243Service {
    private static final int IDEA_ID = 49243;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49243Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49243Service() {
        this(new Idea49243Config());
    }

    public Idea49243Service(Idea49243Config config) {
        this.config = config != null ? config : new Idea49243Config();
