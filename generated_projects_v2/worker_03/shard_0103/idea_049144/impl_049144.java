...
@Data
public class Idea49144Config {
    private String name = "idea_049144";
 ...
 */
@Slf4j
public class Idea49144Service {
    private static final int IDEA_ID = 49144;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49144Service() {
        this(new Idea49144Config());
    }

    public Idea49144Service(Idea49144Config config) {
        this.config = config != null ? config : new Idea49144Config();
