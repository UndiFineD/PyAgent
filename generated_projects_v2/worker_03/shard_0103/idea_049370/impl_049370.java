...
@Data
public class Idea49370Config {
    private String name = "idea_049370";
 ...
 */
@Slf4j
public class Idea49370Service {
    private static final int IDEA_ID = 49370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49370Service() {
        this(new Idea49370Config());
    }

    public Idea49370Service(Idea49370Config config) {
        this.config = config != null ? config : new Idea49370Config();
