...
@Data
public class Idea49121Config {
    private String name = "idea_049121";
 ...
 */
@Slf4j
public class Idea49121Service {
    private static final int IDEA_ID = 49121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49121Service() {
        this(new Idea49121Config());
    }

    public Idea49121Service(Idea49121Config config) {
        this.config = config != null ? config : new Idea49121Config();
