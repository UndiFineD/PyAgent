...
@Data
public class Idea49380Config {
    private String name = "idea_049380";
 ...
 */
@Slf4j
public class Idea49380Service {
    private static final int IDEA_ID = 49380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49380Service() {
        this(new Idea49380Config());
    }

    public Idea49380Service(Idea49380Config config) {
        this.config = config != null ? config : new Idea49380Config();
