...
@Data
public class Idea49323Config {
    private String name = "idea_049323";
 ...
 */
@Slf4j
public class Idea49323Service {
    private static final int IDEA_ID = 49323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49323Service() {
        this(new Idea49323Config());
    }

    public Idea49323Service(Idea49323Config config) {
        this.config = config != null ? config : new Idea49323Config();
