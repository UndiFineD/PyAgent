...
@Data
public class Idea49396Config {
    private String name = "idea_049396";
 ...
 */
@Slf4j
public class Idea49396Service {
    private static final int IDEA_ID = 49396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49396Service() {
        this(new Idea49396Config());
    }

    public Idea49396Service(Idea49396Config config) {
        this.config = config != null ? config : new Idea49396Config();
