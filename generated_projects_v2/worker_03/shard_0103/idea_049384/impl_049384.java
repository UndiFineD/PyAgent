...
@Data
public class Idea49384Config {
    private String name = "idea_049384";
 ...
 */
@Slf4j
public class Idea49384Service {
    private static final int IDEA_ID = 49384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49384Service() {
        this(new Idea49384Config());
    }

    public Idea49384Service(Idea49384Config config) {
        this.config = config != null ? config : new Idea49384Config();
