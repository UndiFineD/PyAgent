...
@Data
public class Idea48961Config {
    private String name = "idea_048961";
 ...
 */
@Slf4j
public class Idea48961Service {
    private static final int IDEA_ID = 48961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48961Service() {
        this(new Idea48961Config());
    }

    public Idea48961Service(Idea48961Config config) {
        this.config = config != null ? config : new Idea48961Config();
