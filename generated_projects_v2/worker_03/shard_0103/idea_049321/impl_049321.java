...
@Data
public class Idea49321Config {
    private String name = "idea_049321";
 ...
 */
@Slf4j
public class Idea49321Service {
    private static final int IDEA_ID = 49321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49321Service() {
        this(new Idea49321Config());
    }

    public Idea49321Service(Idea49321Config config) {
        this.config = config != null ? config : new Idea49321Config();
