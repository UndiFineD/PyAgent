...
@Data
public class Idea48933Config {
    private String name = "idea_048933";
 ...
 */
@Slf4j
public class Idea48933Service {
    private static final int IDEA_ID = 48933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48933Service() {
        this(new Idea48933Config());
    }

    public Idea48933Service(Idea48933Config config) {
        this.config = config != null ? config : new Idea48933Config();
