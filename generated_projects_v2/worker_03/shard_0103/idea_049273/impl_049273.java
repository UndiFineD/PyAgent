...
@Data
public class Idea49273Config {
    private String name = "idea_049273";
 ...
 */
@Slf4j
public class Idea49273Service {
    private static final int IDEA_ID = 49273;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49273Service() {
        this(new Idea49273Config());
    }

    public Idea49273Service(Idea49273Config config) {
        this.config = config != null ? config : new Idea49273Config();
