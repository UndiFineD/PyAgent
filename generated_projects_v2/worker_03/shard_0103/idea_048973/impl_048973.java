...
@Data
public class Idea48973Config {
    private String name = "idea_048973";
 ...
 */
@Slf4j
public class Idea48973Service {
    private static final int IDEA_ID = 48973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48973Service() {
        this(new Idea48973Config());
    }

    public Idea48973Service(Idea48973Config config) {
        this.config = config != null ? config : new Idea48973Config();
