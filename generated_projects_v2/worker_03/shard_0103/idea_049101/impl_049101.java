...
@Data
public class Idea49101Config {
    private String name = "idea_049101";
 ...
 */
@Slf4j
public class Idea49101Service {
    private static final int IDEA_ID = 49101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49101Service() {
        this(new Idea49101Config());
    }

    public Idea49101Service(Idea49101Config config) {
        this.config = config != null ? config : new Idea49101Config();
