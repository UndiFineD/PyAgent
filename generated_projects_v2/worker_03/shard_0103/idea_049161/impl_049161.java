...
@Data
public class Idea49161Config {
    private String name = "idea_049161";
 ...
 */
@Slf4j
public class Idea49161Service {
    private static final int IDEA_ID = 49161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49161Service() {
        this(new Idea49161Config());
    }

    public Idea49161Service(Idea49161Config config) {
        this.config = config != null ? config : new Idea49161Config();
