...
@Data
public class Idea49375Config {
    private String name = "idea_049375";
 ...
 */
@Slf4j
public class Idea49375Service {
    private static final int IDEA_ID = 49375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49375Service() {
        this(new Idea49375Config());
    }

    public Idea49375Service(Idea49375Config config) {
        this.config = config != null ? config : new Idea49375Config();
