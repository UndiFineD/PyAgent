...
@Data
public class Idea49325Config {
    private String name = "idea_049325";
 ...
 */
@Slf4j
public class Idea49325Service {
    private static final int IDEA_ID = 49325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49325Service() {
        this(new Idea49325Config());
    }

    public Idea49325Service(Idea49325Config config) {
        this.config = config != null ? config : new Idea49325Config();
