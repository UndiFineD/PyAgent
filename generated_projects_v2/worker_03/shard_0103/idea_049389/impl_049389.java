...
@Data
public class Idea49389Config {
    private String name = "idea_049389";
 ...
 */
@Slf4j
public class Idea49389Service {
    private static final int IDEA_ID = 49389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49389Service() {
        this(new Idea49389Config());
    }

    public Idea49389Service(Idea49389Config config) {
        this.config = config != null ? config : new Idea49389Config();
