...
@Data
public class Idea49020Config {
    private String name = "idea_049020";
 ...
 */
@Slf4j
public class Idea49020Service {
    private static final int IDEA_ID = 49020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49020Service() {
        this(new Idea49020Config());
    }

    public Idea49020Service(Idea49020Config config) {
        this.config = config != null ? config : new Idea49020Config();
