...
@Data
public class Idea49257Config {
    private String name = "idea_049257";
 ...
 */
@Slf4j
public class Idea49257Service {
    private static final int IDEA_ID = 49257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49257Service() {
        this(new Idea49257Config());
    }

    public Idea49257Service(Idea49257Config config) {
        this.config = config != null ? config : new Idea49257Config();
