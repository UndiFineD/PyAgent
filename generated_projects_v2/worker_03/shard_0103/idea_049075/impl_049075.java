...
@Data
public class Idea49075Config {
    private String name = "idea_049075";
 ...
 */
@Slf4j
public class Idea49075Service {
    private static final int IDEA_ID = 49075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49075Service() {
        this(new Idea49075Config());
    }

    public Idea49075Service(Idea49075Config config) {
        this.config = config != null ? config : new Idea49075Config();
