...
@Data
public class Idea49225Config {
    private String name = "idea_049225";
 ...
 */
@Slf4j
public class Idea49225Service {
    private static final int IDEA_ID = 49225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49225Service() {
        this(new Idea49225Config());
    }

    public Idea49225Service(Idea49225Config config) {
        this.config = config != null ? config : new Idea49225Config();
