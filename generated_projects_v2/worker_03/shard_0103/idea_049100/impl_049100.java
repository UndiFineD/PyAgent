...
@Data
public class Idea49100Config {
    private String name = "idea_049100";
 ...
 */
@Slf4j
public class Idea49100Service {
    private static final int IDEA_ID = 49100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49100Service() {
        this(new Idea49100Config());
    }

    public Idea49100Service(Idea49100Config config) {
        this.config = config != null ? config : new Idea49100Config();
