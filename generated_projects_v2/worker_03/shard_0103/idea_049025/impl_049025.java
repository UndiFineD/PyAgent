...
@Data
public class Idea49025Config {
    private String name = "idea_049025";
 ...
 */
@Slf4j
public class Idea49025Service {
    private static final int IDEA_ID = 49025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49025Service() {
        this(new Idea49025Config());
    }

    public Idea49025Service(Idea49025Config config) {
        this.config = config != null ? config : new Idea49025Config();
