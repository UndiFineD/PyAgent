...
@Data
public class Idea49001Config {
    private String name = "idea_049001";
 ...
 */
@Slf4j
public class Idea49001Service {
    private static final int IDEA_ID = 49001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49001Service() {
        this(new Idea49001Config());
    }

    public Idea49001Service(Idea49001Config config) {
        this.config = config != null ? config : new Idea49001Config();
