...
@Data
public class Idea49007Config {
    private String name = "idea_049007";
 ...
 */
@Slf4j
public class Idea49007Service {
    private static final int IDEA_ID = 49007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49007Service() {
        this(new Idea49007Config());
    }

    public Idea49007Service(Idea49007Config config) {
        this.config = config != null ? config : new Idea49007Config();
