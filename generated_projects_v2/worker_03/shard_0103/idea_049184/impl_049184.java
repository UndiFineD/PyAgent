...
@Data
public class Idea49184Config {
    private String name = "idea_049184";
 ...
 */
@Slf4j
public class Idea49184Service {
    private static final int IDEA_ID = 49184;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49184Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49184Service() {
        this(new Idea49184Config());
    }

    public Idea49184Service(Idea49184Config config) {
        this.config = config != null ? config : new Idea49184Config();
