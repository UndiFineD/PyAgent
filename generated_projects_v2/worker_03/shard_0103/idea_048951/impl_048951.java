...
@Data
public class Idea48951Config {
    private String name = "idea_048951";
 ...
 */
@Slf4j
public class Idea48951Service {
    private static final int IDEA_ID = 48951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48951Service() {
        this(new Idea48951Config());
    }

    public Idea48951Service(Idea48951Config config) {
        this.config = config != null ? config : new Idea48951Config();
