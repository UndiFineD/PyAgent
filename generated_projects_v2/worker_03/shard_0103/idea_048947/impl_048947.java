...
@Data
public class Idea48947Config {
    private String name = "idea_048947";
 ...
 */
@Slf4j
public class Idea48947Service {
    private static final int IDEA_ID = 48947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48947Service() {
        this(new Idea48947Config());
    }

    public Idea48947Service(Idea48947Config config) {
        this.config = config != null ? config : new Idea48947Config();
