...
@Data
public class Idea49035Config {
    private String name = "idea_049035";
 ...
 */
@Slf4j
public class Idea49035Service {
    private static final int IDEA_ID = 49035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49035Service() {
        this(new Idea49035Config());
    }

    public Idea49035Service(Idea49035Config config) {
        this.config = config != null ? config : new Idea49035Config();
