...
@Data
public class Idea49005Config {
    private String name = "idea_049005";
 ...
 */
@Slf4j
public class Idea49005Service {
    private static final int IDEA_ID = 49005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49005Service() {
        this(new Idea49005Config());
    }

    public Idea49005Service(Idea49005Config config) {
        this.config = config != null ? config : new Idea49005Config();
