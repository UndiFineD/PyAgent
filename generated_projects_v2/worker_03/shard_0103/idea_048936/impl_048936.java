...
@Data
public class Idea48936Config {
    private String name = "idea_048936";
 ...
 */
@Slf4j
public class Idea48936Service {
    private static final int IDEA_ID = 48936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48936Service() {
        this(new Idea48936Config());
    }

    public Idea48936Service(Idea48936Config config) {
        this.config = config != null ? config : new Idea48936Config();
