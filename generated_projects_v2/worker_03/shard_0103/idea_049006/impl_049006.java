...
@Data
public class Idea49006Config {
    private String name = "idea_049006";
 ...
 */
@Slf4j
public class Idea49006Service {
    private static final int IDEA_ID = 49006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49006Service() {
        this(new Idea49006Config());
    }

    public Idea49006Service(Idea49006Config config) {
        this.config = config != null ? config : new Idea49006Config();
