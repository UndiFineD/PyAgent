...
@Data
public class Idea49015Config {
    private String name = "idea_049015";
 ...
 */
@Slf4j
public class Idea49015Service {
    private static final int IDEA_ID = 49015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49015Service() {
        this(new Idea49015Config());
    }

    public Idea49015Service(Idea49015Config config) {
        this.config = config != null ? config : new Idea49015Config();
