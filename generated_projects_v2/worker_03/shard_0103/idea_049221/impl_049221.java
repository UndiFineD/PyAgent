...
@Data
public class Idea49221Config {
    private String name = "idea_049221";
 ...
 */
@Slf4j
public class Idea49221Service {
    private static final int IDEA_ID = 49221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49221Service() {
        this(new Idea49221Config());
    }

    public Idea49221Service(Idea49221Config config) {
        this.config = config != null ? config : new Idea49221Config();
