...
@Data
public class Idea49197Config {
    private String name = "idea_049197";
 ...
 */
@Slf4j
public class Idea49197Service {
    private static final int IDEA_ID = 49197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49197Service() {
        this(new Idea49197Config());
    }

    public Idea49197Service(Idea49197Config config) {
        this.config = config != null ? config : new Idea49197Config();
