...
@Data
public class Idea49024Config {
    private String name = "idea_049024";
 ...
 */
@Slf4j
public class Idea49024Service {
    private static final int IDEA_ID = 49024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49024Service() {
        this(new Idea49024Config());
    }

    public Idea49024Service(Idea49024Config config) {
        this.config = config != null ? config : new Idea49024Config();
