...
@Data
public class Idea48980Config {
    private String name = "idea_048980";
 ...
 */
@Slf4j
public class Idea48980Service {
    private static final int IDEA_ID = 48980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48980Service() {
        this(new Idea48980Config());
    }

    public Idea48980Service(Idea48980Config config) {
        this.config = config != null ? config : new Idea48980Config();
