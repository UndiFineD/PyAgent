...
@Data
public class Idea49365Config {
    private String name = "idea_049365";
 ...
 */
@Slf4j
public class Idea49365Service {
    private static final int IDEA_ID = 49365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49365Service() {
        this(new Idea49365Config());
    }

    public Idea49365Service(Idea49365Config config) {
        this.config = config != null ? config : new Idea49365Config();
