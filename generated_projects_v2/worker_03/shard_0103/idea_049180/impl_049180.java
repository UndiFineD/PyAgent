...
@Data
public class Idea49180Config {
    private String name = "idea_049180";
 ...
 */
@Slf4j
public class Idea49180Service {
    private static final int IDEA_ID = 49180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49180Service() {
        this(new Idea49180Config());
    }

    public Idea49180Service(Idea49180Config config) {
        this.config = config != null ? config : new Idea49180Config();
