...
@Data
public class Idea49033Config {
    private String name = "idea_049033";
 ...
 */
@Slf4j
public class Idea49033Service {
    private static final int IDEA_ID = 49033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49033Service() {
        this(new Idea49033Config());
    }

    public Idea49033Service(Idea49033Config config) {
        this.config = config != null ? config : new Idea49033Config();
