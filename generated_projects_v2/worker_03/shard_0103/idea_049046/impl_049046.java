...
@Data
public class Idea49046Config {
    private String name = "idea_049046";
 ...
 */
@Slf4j
public class Idea49046Service {
    private static final int IDEA_ID = 49046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49046Service() {
        this(new Idea49046Config());
    }

    public Idea49046Service(Idea49046Config config) {
        this.config = config != null ? config : new Idea49046Config();
