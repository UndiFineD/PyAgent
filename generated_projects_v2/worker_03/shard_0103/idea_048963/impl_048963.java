...
@Data
public class Idea48963Config {
    private String name = "idea_048963";
 ...
 */
@Slf4j
public class Idea48963Service {
    private static final int IDEA_ID = 48963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48963Service() {
        this(new Idea48963Config());
    }

    public Idea48963Service(Idea48963Config config) {
        this.config = config != null ? config : new Idea48963Config();
