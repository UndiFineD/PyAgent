...
@Data
public class Idea49211Config {
    private String name = "idea_049211";
 ...
 */
@Slf4j
public class Idea49211Service {
    private static final int IDEA_ID = 49211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49211Service() {
        this(new Idea49211Config());
    }

    public Idea49211Service(Idea49211Config config) {
        this.config = config != null ? config : new Idea49211Config();
