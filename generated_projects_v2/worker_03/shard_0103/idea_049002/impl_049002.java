...
@Data
public class Idea49002Config {
    private String name = "idea_049002";
 ...
 */
@Slf4j
public class Idea49002Service {
    private static final int IDEA_ID = 49002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49002Service() {
        this(new Idea49002Config());
    }

    public Idea49002Service(Idea49002Config config) {
        this.config = config != null ? config : new Idea49002Config();
