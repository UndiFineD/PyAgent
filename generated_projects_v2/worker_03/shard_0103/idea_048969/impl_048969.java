...
@Data
public class Idea48969Config {
    private String name = "idea_048969";
 ...
 */
@Slf4j
public class Idea48969Service {
    private static final int IDEA_ID = 48969;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48969Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48969Service() {
        this(new Idea48969Config());
    }

    public Idea48969Service(Idea48969Config config) {
        this.config = config != null ? config : new Idea48969Config();
