...
@Data
public class Idea49140Config {
    private String name = "idea_049140";
 ...
 */
@Slf4j
public class Idea49140Service {
    private static final int IDEA_ID = 49140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49140Service() {
        this(new Idea49140Config());
    }

    public Idea49140Service(Idea49140Config config) {
        this.config = config != null ? config : new Idea49140Config();
