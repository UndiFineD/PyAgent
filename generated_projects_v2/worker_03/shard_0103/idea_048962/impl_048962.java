...
@Data
public class Idea48962Config {
    private String name = "idea_048962";
 ...
 */
@Slf4j
public class Idea48962Service {
    private static final int IDEA_ID = 48962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48962Service() {
        this(new Idea48962Config());
    }

    public Idea48962Service(Idea48962Config config) {
        this.config = config != null ? config : new Idea48962Config();
