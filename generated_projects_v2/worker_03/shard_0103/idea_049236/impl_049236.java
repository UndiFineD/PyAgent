...
@Data
public class Idea49236Config {
    private String name = "idea_049236";
 ...
 */
@Slf4j
public class Idea49236Service {
    private static final int IDEA_ID = 49236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49236Service() {
        this(new Idea49236Config());
    }

    public Idea49236Service(Idea49236Config config) {
        this.config = config != null ? config : new Idea49236Config();
