...
@Data
public class Idea49151Config {
    private String name = "idea_049151";
 ...
 */
@Slf4j
public class Idea49151Service {
    private static final int IDEA_ID = 49151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49151Service() {
        this(new Idea49151Config());
    }

    public Idea49151Service(Idea49151Config config) {
        this.config = config != null ? config : new Idea49151Config();
