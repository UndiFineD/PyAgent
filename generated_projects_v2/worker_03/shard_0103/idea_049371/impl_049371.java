...
@Data
public class Idea49371Config {
    private String name = "idea_049371";
 ...
 */
@Slf4j
public class Idea49371Service {
    private static final int IDEA_ID = 49371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49371Service() {
        this(new Idea49371Config());
    }

    public Idea49371Service(Idea49371Config config) {
        this.config = config != null ? config : new Idea49371Config();
