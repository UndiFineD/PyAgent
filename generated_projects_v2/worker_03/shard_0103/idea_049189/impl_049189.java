...
@Data
public class Idea49189Config {
    private String name = "idea_049189";
 ...
 */
@Slf4j
public class Idea49189Service {
    private static final int IDEA_ID = 49189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49189Service() {
        this(new Idea49189Config());
    }

    public Idea49189Service(Idea49189Config config) {
        this.config = config != null ? config : new Idea49189Config();
