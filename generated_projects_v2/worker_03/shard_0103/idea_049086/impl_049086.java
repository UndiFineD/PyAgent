...
@Data
public class Idea49086Config {
    private String name = "idea_049086";
 ...
 */
@Slf4j
public class Idea49086Service {
    private static final int IDEA_ID = 49086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49086Service() {
        this(new Idea49086Config());
    }

    public Idea49086Service(Idea49086Config config) {
        this.config = config != null ? config : new Idea49086Config();
