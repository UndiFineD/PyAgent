...
@Data
public class Idea49202Config {
    private String name = "idea_049202";
 ...
 */
@Slf4j
public class Idea49202Service {
    private static final int IDEA_ID = 49202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49202Service() {
        this(new Idea49202Config());
    }

    public Idea49202Service(Idea49202Config config) {
        this.config = config != null ? config : new Idea49202Config();
