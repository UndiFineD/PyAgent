...
@Data
public class Idea49187Config {
    private String name = "idea_049187";
 ...
 */
@Slf4j
public class Idea49187Service {
    private static final int IDEA_ID = 49187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49187Service() {
        this(new Idea49187Config());
    }

    public Idea49187Service(Idea49187Config config) {
        this.config = config != null ? config : new Idea49187Config();
