...
@Data
public class Idea48983Config {
    private String name = "idea_048983";
 ...
 */
@Slf4j
public class Idea48983Service {
    private static final int IDEA_ID = 48983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48983Service() {
        this(new Idea48983Config());
    }

    public Idea48983Service(Idea48983Config config) {
        this.config = config != null ? config : new Idea48983Config();
