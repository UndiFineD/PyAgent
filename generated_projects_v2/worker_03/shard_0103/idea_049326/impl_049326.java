...
@Data
public class Idea49326Config {
    private String name = "idea_049326";
 ...
 */
@Slf4j
public class Idea49326Service {
    private static final int IDEA_ID = 49326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49326Service() {
        this(new Idea49326Config());
    }

    public Idea49326Service(Idea49326Config config) {
        this.config = config != null ? config : new Idea49326Config();
