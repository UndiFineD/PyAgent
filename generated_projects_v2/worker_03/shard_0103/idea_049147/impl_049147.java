...
@Data
public class Idea49147Config {
    private String name = "idea_049147";
 ...
 */
@Slf4j
public class Idea49147Service {
    private static final int IDEA_ID = 49147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49147Service() {
        this(new Idea49147Config());
    }

    public Idea49147Service(Idea49147Config config) {
        this.config = config != null ? config : new Idea49147Config();
