...
@Data
public class Idea49251Config {
    private String name = "idea_049251";
 ...
 */
@Slf4j
public class Idea49251Service {
    private static final int IDEA_ID = 49251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49251Service() {
        this(new Idea49251Config());
    }

    public Idea49251Service(Idea49251Config config) {
        this.config = config != null ? config : new Idea49251Config();
