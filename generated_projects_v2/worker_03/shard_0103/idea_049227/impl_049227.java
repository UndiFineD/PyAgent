...
@Data
public class Idea49227Config {
    private String name = "idea_049227";
 ...
 */
@Slf4j
public class Idea49227Service {
    private static final int IDEA_ID = 49227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49227Service() {
        this(new Idea49227Config());
    }

    public Idea49227Service(Idea49227Config config) {
        this.config = config != null ? config : new Idea49227Config();
