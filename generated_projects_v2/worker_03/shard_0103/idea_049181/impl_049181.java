...
@Data
public class Idea49181Config {
    private String name = "idea_049181";
 ...
 */
@Slf4j
public class Idea49181Service {
    private static final int IDEA_ID = 49181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49181Service() {
        this(new Idea49181Config());
    }

    public Idea49181Service(Idea49181Config config) {
        this.config = config != null ? config : new Idea49181Config();
