...
@Data
public class Idea48925Config {
    private String name = "idea_048925";
 ...
 */
@Slf4j
public class Idea48925Service {
    private static final int IDEA_ID = 48925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48925Service() {
        this(new Idea48925Config());
    }

    public Idea48925Service(Idea48925Config config) {
        this.config = config != null ? config : new Idea48925Config();
