...
@Data
public class Idea49105Config {
    private String name = "idea_049105";
 ...
 */
@Slf4j
public class Idea49105Service {
    private static final int IDEA_ID = 49105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49105Service() {
        this(new Idea49105Config());
    }

    public Idea49105Service(Idea49105Config config) {
        this.config = config != null ? config : new Idea49105Config();
