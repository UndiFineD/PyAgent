...
@Data
public class Idea49087Config {
    private String name = "idea_049087";
 ...
 */
@Slf4j
public class Idea49087Service {
    private static final int IDEA_ID = 49087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49087Service() {
        this(new Idea49087Config());
    }

    public Idea49087Service(Idea49087Config config) {
        this.config = config != null ? config : new Idea49087Config();
