...
@Data
public class Idea49388Config {
    private String name = "idea_049388";
 ...
 */
@Slf4j
public class Idea49388Service {
    private static final int IDEA_ID = 49388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49388Service() {
        this(new Idea49388Config());
    }

    public Idea49388Service(Idea49388Config config) {
        this.config = config != null ? config : new Idea49388Config();
