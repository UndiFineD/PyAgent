...
@Data
public class Idea49188Config {
    private String name = "idea_049188";
 ...
 */
@Slf4j
public class Idea49188Service {
    private static final int IDEA_ID = 49188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49188Service() {
        this(new Idea49188Config());
    }

    public Idea49188Service(Idea49188Config config) {
        this.config = config != null ? config : new Idea49188Config();
