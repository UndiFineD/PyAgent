...
@Data
public class Idea49306Config {
    private String name = "idea_049306";
 ...
 */
@Slf4j
public class Idea49306Service {
    private static final int IDEA_ID = 49306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49306Service() {
        this(new Idea49306Config());
    }

    public Idea49306Service(Idea49306Config config) {
        this.config = config != null ? config : new Idea49306Config();
