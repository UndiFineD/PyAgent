...
@Data
public class Idea49027Config {
    private String name = "idea_049027";
 ...
 */
@Slf4j
public class Idea49027Service {
    private static final int IDEA_ID = 49027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49027Service() {
        this(new Idea49027Config());
    }

    public Idea49027Service(Idea49027Config config) {
        this.config = config != null ? config : new Idea49027Config();
