...
@Data
public class Idea49193Config {
    private String name = "idea_049193";
 ...
 */
@Slf4j
public class Idea49193Service {
    private static final int IDEA_ID = 49193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49193Service() {
        this(new Idea49193Config());
    }

    public Idea49193Service(Idea49193Config config) {
        this.config = config != null ? config : new Idea49193Config();
