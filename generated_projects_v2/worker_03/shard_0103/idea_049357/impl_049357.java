...
@Data
public class Idea49357Config {
    private String name = "idea_049357";
 ...
 */
@Slf4j
public class Idea49357Service {
    private static final int IDEA_ID = 49357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49357Service() {
        this(new Idea49357Config());
    }

    public Idea49357Service(Idea49357Config config) {
        this.config = config != null ? config : new Idea49357Config();
