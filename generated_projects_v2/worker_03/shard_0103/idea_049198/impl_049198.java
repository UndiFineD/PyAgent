...
@Data
public class Idea49198Config {
    private String name = "idea_049198";
 ...
 */
@Slf4j
public class Idea49198Service {
    private static final int IDEA_ID = 49198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49198Service() {
        this(new Idea49198Config());
    }

    public Idea49198Service(Idea49198Config config) {
        this.config = config != null ? config : new Idea49198Config();
