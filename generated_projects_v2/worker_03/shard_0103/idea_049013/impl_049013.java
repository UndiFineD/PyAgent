...
@Data
public class Idea49013Config {
    private String name = "idea_049013";
 ...
 */
@Slf4j
public class Idea49013Service {
    private static final int IDEA_ID = 49013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49013Service() {
        this(new Idea49013Config());
    }

    public Idea49013Service(Idea49013Config config) {
        this.config = config != null ? config : new Idea49013Config();
