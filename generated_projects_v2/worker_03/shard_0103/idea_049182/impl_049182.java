...
@Data
public class Idea49182Config {
    private String name = "idea_049182";
 ...
 */
@Slf4j
public class Idea49182Service {
    private static final int IDEA_ID = 49182;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49182Service() {
        this(new Idea49182Config());
    }

    public Idea49182Service(Idea49182Config config) {
        this.config = config != null ? config : new Idea49182Config();
