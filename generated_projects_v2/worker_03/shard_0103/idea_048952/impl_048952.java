...
@Data
public class Idea48952Config {
    private String name = "idea_048952";
 ...
 */
@Slf4j
public class Idea48952Service {
    private static final int IDEA_ID = 48952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48952Service() {
        this(new Idea48952Config());
    }

    public Idea48952Service(Idea48952Config config) {
        this.config = config != null ? config : new Idea48952Config();
