...
@Data
public class Idea49060Config {
    private String name = "idea_049060";
 ...
 */
@Slf4j
public class Idea49060Service {
    private static final int IDEA_ID = 49060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49060Service() {
        this(new Idea49060Config());
    }

    public Idea49060Service(Idea49060Config config) {
        this.config = config != null ? config : new Idea49060Config();
