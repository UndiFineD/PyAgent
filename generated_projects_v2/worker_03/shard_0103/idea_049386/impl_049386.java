...
@Data
public class Idea49386Config {
    private String name = "idea_049386";
 ...
 */
@Slf4j
public class Idea49386Service {
    private static final int IDEA_ID = 49386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49386Service() {
        this(new Idea49386Config());
    }

    public Idea49386Service(Idea49386Config config) {
        this.config = config != null ? config : new Idea49386Config();
