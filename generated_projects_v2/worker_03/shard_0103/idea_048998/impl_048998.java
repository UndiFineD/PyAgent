...
@Data
public class Idea48998Config {
    private String name = "idea_048998";
 ...
 */
@Slf4j
public class Idea48998Service {
    private static final int IDEA_ID = 48998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48998Service() {
        this(new Idea48998Config());
    }

    public Idea48998Service(Idea48998Config config) {
        this.config = config != null ? config : new Idea48998Config();
