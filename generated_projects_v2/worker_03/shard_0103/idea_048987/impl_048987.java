...
@Data
public class Idea48987Config {
    private String name = "idea_048987";
 ...
 */
@Slf4j
public class Idea48987Service {
    private static final int IDEA_ID = 48987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48987Service() {
        this(new Idea48987Config());
    }

    public Idea48987Service(Idea48987Config config) {
        this.config = config != null ? config : new Idea48987Config();
