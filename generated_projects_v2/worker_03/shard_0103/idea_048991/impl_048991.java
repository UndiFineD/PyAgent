...
@Data
public class Idea48991Config {
    private String name = "idea_048991";
 ...
 */
@Slf4j
public class Idea48991Service {
    private static final int IDEA_ID = 48991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48991Service() {
        this(new Idea48991Config());
    }

    public Idea48991Service(Idea48991Config config) {
        this.config = config != null ? config : new Idea48991Config();
