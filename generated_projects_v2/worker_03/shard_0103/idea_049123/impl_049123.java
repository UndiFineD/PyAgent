...
@Data
public class Idea49123Config {
    private String name = "idea_049123";
 ...
 */
@Slf4j
public class Idea49123Service {
    private static final int IDEA_ID = 49123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49123Service() {
        this(new Idea49123Config());
    }

    public Idea49123Service(Idea49123Config config) {
        this.config = config != null ? config : new Idea49123Config();
