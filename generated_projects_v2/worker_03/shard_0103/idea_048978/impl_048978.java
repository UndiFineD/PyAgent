...
@Data
public class Idea48978Config {
    private String name = "idea_048978";
 ...
 */
@Slf4j
public class Idea48978Service {
    private static final int IDEA_ID = 48978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48978Service() {
        this(new Idea48978Config());
    }

    public Idea48978Service(Idea48978Config config) {
        this.config = config != null ? config : new Idea48978Config();
