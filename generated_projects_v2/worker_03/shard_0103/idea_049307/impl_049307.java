...
@Data
public class Idea49307Config {
    private String name = "idea_049307";
 ...
 */
@Slf4j
public class Idea49307Service {
    private static final int IDEA_ID = 49307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49307Service() {
        this(new Idea49307Config());
    }

    public Idea49307Service(Idea49307Config config) {
        this.config = config != null ? config : new Idea49307Config();
