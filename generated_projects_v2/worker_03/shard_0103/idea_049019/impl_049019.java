...
@Data
public class Idea49019Config {
    private String name = "idea_049019";
 ...
 */
@Slf4j
public class Idea49019Service {
    private static final int IDEA_ID = 49019;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49019Service() {
        this(new Idea49019Config());
    }

    public Idea49019Service(Idea49019Config config) {
        this.config = config != null ? config : new Idea49019Config();
