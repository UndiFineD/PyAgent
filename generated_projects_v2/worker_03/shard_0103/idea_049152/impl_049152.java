...
@Data
public class Idea49152Config {
    private String name = "idea_049152";
 ...
 */
@Slf4j
public class Idea49152Service {
    private static final int IDEA_ID = 49152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49152Service() {
        this(new Idea49152Config());
    }

    public Idea49152Service(Idea49152Config config) {
        this.config = config != null ? config : new Idea49152Config();
