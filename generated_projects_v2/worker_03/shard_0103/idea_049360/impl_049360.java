...
@Data
public class Idea49360Config {
    private String name = "idea_049360";
 ...
 */
@Slf4j
public class Idea49360Service {
    private static final int IDEA_ID = 49360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49360Service() {
        this(new Idea49360Config());
    }

    public Idea49360Service(Idea49360Config config) {
        this.config = config != null ? config : new Idea49360Config();
