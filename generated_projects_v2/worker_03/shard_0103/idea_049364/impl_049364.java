...
@Data
public class Idea49364Config {
    private String name = "idea_049364";
 ...
 */
@Slf4j
public class Idea49364Service {
    private static final int IDEA_ID = 49364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49364Service() {
        this(new Idea49364Config());
    }

    public Idea49364Service(Idea49364Config config) {
        this.config = config != null ? config : new Idea49364Config();
