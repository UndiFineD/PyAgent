...
@Data
public class Idea48997Config {
    private String name = "idea_048997";
 ...
 */
@Slf4j
public class Idea48997Service {
    private static final int IDEA_ID = 48997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48997Service() {
        this(new Idea48997Config());
    }

    public Idea48997Service(Idea48997Config config) {
        this.config = config != null ? config : new Idea48997Config();
