...
@Data
public class Idea49004Config {
    private String name = "idea_049004";
 ...
 */
@Slf4j
public class Idea49004Service {
    private static final int IDEA_ID = 49004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49004Service() {
        this(new Idea49004Config());
    }

    public Idea49004Service(Idea49004Config config) {
        this.config = config != null ? config : new Idea49004Config();
