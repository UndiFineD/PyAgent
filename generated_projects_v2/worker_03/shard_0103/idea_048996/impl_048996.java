...
@Data
public class Idea48996Config {
    private String name = "idea_048996";
 ...
 */
@Slf4j
public class Idea48996Service {
    private static final int IDEA_ID = 48996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48996Service() {
        this(new Idea48996Config());
    }

    public Idea48996Service(Idea48996Config config) {
        this.config = config != null ? config : new Idea48996Config();
