...
@Data
public class Idea49099Config {
    private String name = "idea_049099";
 ...
 */
@Slf4j
public class Idea49099Service {
    private static final int IDEA_ID = 49099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49099Service() {
        this(new Idea49099Config());
    }

    public Idea49099Service(Idea49099Config config) {
        this.config = config != null ? config : new Idea49099Config();
