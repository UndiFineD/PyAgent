...
@Data
public class Idea48966Config {
    private String name = "idea_048966";
 ...
 */
@Slf4j
public class Idea48966Service {
    private static final int IDEA_ID = 48966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48966Service() {
        this(new Idea48966Config());
    }

    public Idea48966Service(Idea48966Config config) {
        this.config = config != null ? config : new Idea48966Config();
