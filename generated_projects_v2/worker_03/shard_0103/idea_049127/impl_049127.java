...
@Data
public class Idea49127Config {
    private String name = "idea_049127";
 ...
 */
@Slf4j
public class Idea49127Service {
    private static final int IDEA_ID = 49127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49127Service() {
        this(new Idea49127Config());
    }

    public Idea49127Service(Idea49127Config config) {
        this.config = config != null ? config : new Idea49127Config();
