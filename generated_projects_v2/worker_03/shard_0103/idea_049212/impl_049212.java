...
@Data
public class Idea49212Config {
    private String name = "idea_049212";
 ...
 */
@Slf4j
public class Idea49212Service {
    private static final int IDEA_ID = 49212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49212Service() {
        this(new Idea49212Config());
    }

    public Idea49212Service(Idea49212Config config) {
        this.config = config != null ? config : new Idea49212Config();
