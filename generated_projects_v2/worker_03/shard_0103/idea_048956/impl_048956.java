...
@Data
public class Idea48956Config {
    private String name = "idea_048956";
 ...
 */
@Slf4j
public class Idea48956Service {
    private static final int IDEA_ID = 48956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48956Service() {
        this(new Idea48956Config());
    }

    public Idea48956Service(Idea48956Config config) {
        this.config = config != null ? config : new Idea48956Config();
