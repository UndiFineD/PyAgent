...
@Data
public class Idea49040Config {
    private String name = "idea_049040";
 ...
 */
@Slf4j
public class Idea49040Service {
    private static final int IDEA_ID = 49040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49040Service() {
        this(new Idea49040Config());
    }

    public Idea49040Service(Idea49040Config config) {
        this.config = config != null ? config : new Idea49040Config();
