...
@Data
public class Idea49125Config {
    private String name = "idea_049125";
 ...
 */
@Slf4j
public class Idea49125Service {
    private static final int IDEA_ID = 49125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49125Service() {
        this(new Idea49125Config());
    }

    public Idea49125Service(Idea49125Config config) {
        this.config = config != null ? config : new Idea49125Config();
