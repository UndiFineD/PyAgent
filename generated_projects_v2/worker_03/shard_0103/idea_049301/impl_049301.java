...
@Data
public class Idea49301Config {
    private String name = "idea_049301";
 ...
 */
@Slf4j
public class Idea49301Service {
    private static final int IDEA_ID = 49301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49301Service() {
        this(new Idea49301Config());
    }

    public Idea49301Service(Idea49301Config config) {
        this.config = config != null ? config : new Idea49301Config();
