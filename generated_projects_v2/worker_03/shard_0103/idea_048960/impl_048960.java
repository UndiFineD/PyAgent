...
@Data
public class Idea48960Config {
    private String name = "idea_048960";
 ...
 */
@Slf4j
public class Idea48960Service {
    private static final int IDEA_ID = 48960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48960Service() {
        this(new Idea48960Config());
    }

    public Idea48960Service(Idea48960Config config) {
        this.config = config != null ? config : new Idea48960Config();
