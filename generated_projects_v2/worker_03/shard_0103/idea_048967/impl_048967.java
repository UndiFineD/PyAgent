...
@Data
public class Idea48967Config {
    private String name = "idea_048967";
 ...
 */
@Slf4j
public class Idea48967Service {
    private static final int IDEA_ID = 48967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48967Service() {
        this(new Idea48967Config());
    }

    public Idea48967Service(Idea48967Config config) {
        this.config = config != null ? config : new Idea48967Config();
