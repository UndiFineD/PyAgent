...
@Data
public class Idea49337Config {
    private String name = "idea_049337";
 ...
 */
@Slf4j
public class Idea49337Service {
    private static final int IDEA_ID = 49337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49337Service() {
        this(new Idea49337Config());
    }

    public Idea49337Service(Idea49337Config config) {
        this.config = config != null ? config : new Idea49337Config();
