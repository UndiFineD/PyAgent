...
@Data
public class Idea49261Config {
    private String name = "idea_049261";
 ...
 */
@Slf4j
public class Idea49261Service {
    private static final int IDEA_ID = 49261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49261Service() {
        this(new Idea49261Config());
    }

    public Idea49261Service(Idea49261Config config) {
        this.config = config != null ? config : new Idea49261Config();
