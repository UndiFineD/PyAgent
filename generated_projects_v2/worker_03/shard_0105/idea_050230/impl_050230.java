...
@Data
public class Idea50230Config {
    private String name = "idea_050230";
 ...
 */
@Slf4j
public class Idea50230Service {
    private static final int IDEA_ID = 50230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50230Service() {
        this(new Idea50230Config());
    }

    public Idea50230Service(Idea50230Config config) {
        this.config = config != null ? config : new Idea50230Config();
