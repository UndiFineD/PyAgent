...
@Data
public class Idea50116Config {
    private String name = "idea_050116";
 ...
 */
@Slf4j
public class Idea50116Service {
    private static final int IDEA_ID = 50116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50116Service() {
        this(new Idea50116Config());
    }

    public Idea50116Service(Idea50116Config config) {
        this.config = config != null ? config : new Idea50116Config();
