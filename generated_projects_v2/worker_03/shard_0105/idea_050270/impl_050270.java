...
@Data
public class Idea50270Config {
    private String name = "idea_050270";
 ...
 */
@Slf4j
public class Idea50270Service {
    private static final int IDEA_ID = 50270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50270Service() {
        this(new Idea50270Config());
    }

    public Idea50270Service(Idea50270Config config) {
        this.config = config != null ? config : new Idea50270Config();
