...
@Data
public class Idea50221Config {
    private String name = "idea_050221";
 ...
 */
@Slf4j
public class Idea50221Service {
    private static final int IDEA_ID = 50221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50221Service() {
        this(new Idea50221Config());
    }

    public Idea50221Service(Idea50221Config config) {
        this.config = config != null ? config : new Idea50221Config();
