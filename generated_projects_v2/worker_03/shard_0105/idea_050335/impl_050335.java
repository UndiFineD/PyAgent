...
@Data
public class Idea50335Config {
    private String name = "idea_050335";
 ...
 */
@Slf4j
public class Idea50335Service {
    private static final int IDEA_ID = 50335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50335Service() {
        this(new Idea50335Config());
    }

    public Idea50335Service(Idea50335Config config) {
        this.config = config != null ? config : new Idea50335Config();
