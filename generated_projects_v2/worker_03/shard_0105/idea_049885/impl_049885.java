...
@Data
public class Idea49885Config {
    private String name = "idea_049885";
 ...
 */
@Slf4j
public class Idea49885Service {
    private static final int IDEA_ID = 49885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49885Service() {
        this(new Idea49885Config());
    }

    public Idea49885Service(Idea49885Config config) {
        this.config = config != null ? config : new Idea49885Config();
