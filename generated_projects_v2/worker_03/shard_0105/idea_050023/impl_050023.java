...
@Data
public class Idea50023Config {
    private String name = "idea_050023";
 ...
 */
@Slf4j
public class Idea50023Service {
    private static final int IDEA_ID = 50023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50023Service() {
        this(new Idea50023Config());
    }

    public Idea50023Service(Idea50023Config config) {
        this.config = config != null ? config : new Idea50023Config();
