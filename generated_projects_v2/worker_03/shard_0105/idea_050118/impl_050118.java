...
@Data
public class Idea50118Config {
    private String name = "idea_050118";
 ...
 */
@Slf4j
public class Idea50118Service {
    private static final int IDEA_ID = 50118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50118Service() {
        this(new Idea50118Config());
    }

    public Idea50118Service(Idea50118Config config) {
        this.config = config != null ? config : new Idea50118Config();
