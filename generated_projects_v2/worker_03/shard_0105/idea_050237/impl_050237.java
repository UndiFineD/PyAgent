...
@Data
public class Idea50237Config {
    private String name = "idea_050237";
 ...
 */
@Slf4j
public class Idea50237Service {
    private static final int IDEA_ID = 50237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50237Service() {
        this(new Idea50237Config());
    }

    public Idea50237Service(Idea50237Config config) {
        this.config = config != null ? config : new Idea50237Config();
