...
@Data
public class Idea50224Config {
    private String name = "idea_050224";
 ...
 */
@Slf4j
public class Idea50224Service {
    private static final int IDEA_ID = 50224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50224Service() {
        this(new Idea50224Config());
    }

    public Idea50224Service(Idea50224Config config) {
        this.config = config != null ? config : new Idea50224Config();
