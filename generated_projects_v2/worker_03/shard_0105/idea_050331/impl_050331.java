...
@Data
public class Idea50331Config {
    private String name = "idea_050331";
 ...
 */
@Slf4j
public class Idea50331Service {
    private static final int IDEA_ID = 50331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50331Service() {
        this(new Idea50331Config());
    }

    public Idea50331Service(Idea50331Config config) {
        this.config = config != null ? config : new Idea50331Config();
