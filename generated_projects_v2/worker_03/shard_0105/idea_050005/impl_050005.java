...
@Data
public class Idea50005Config {
    private String name = "idea_050005";
 ...
 */
@Slf4j
public class Idea50005Service {
    private static final int IDEA_ID = 50005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50005Service() {
        this(new Idea50005Config());
    }

    public Idea50005Service(Idea50005Config config) {
        this.config = config != null ? config : new Idea50005Config();
