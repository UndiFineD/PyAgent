...
@Data
public class Idea50103Config {
    private String name = "idea_050103";
 ...
 */
@Slf4j
public class Idea50103Service {
    private static final int IDEA_ID = 50103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50103Service() {
        this(new Idea50103Config());
    }

    public Idea50103Service(Idea50103Config config) {
        this.config = config != null ? config : new Idea50103Config();
