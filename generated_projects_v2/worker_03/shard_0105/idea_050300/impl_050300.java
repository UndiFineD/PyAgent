...
@Data
public class Idea50300Config {
    private String name = "idea_050300";
 ...
 */
@Slf4j
public class Idea50300Service {
    private static final int IDEA_ID = 50300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50300Service() {
        this(new Idea50300Config());
    }

    public Idea50300Service(Idea50300Config config) {
        this.config = config != null ? config : new Idea50300Config();
