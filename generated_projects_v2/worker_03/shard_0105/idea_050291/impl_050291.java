...
@Data
public class Idea50291Config {
    private String name = "idea_050291";
 ...
 */
@Slf4j
public class Idea50291Service {
    private static final int IDEA_ID = 50291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50291Service() {
        this(new Idea50291Config());
    }

    public Idea50291Service(Idea50291Config config) {
        this.config = config != null ? config : new Idea50291Config();
