...
@Data
public class Idea50187Config {
    private String name = "idea_050187";
 ...
 */
@Slf4j
public class Idea50187Service {
    private static final int IDEA_ID = 50187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50187Service() {
        this(new Idea50187Config());
    }

    public Idea50187Service(Idea50187Config config) {
        this.config = config != null ? config : new Idea50187Config();
