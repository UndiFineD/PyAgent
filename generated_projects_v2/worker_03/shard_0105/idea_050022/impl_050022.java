...
@Data
public class Idea50022Config {
    private String name = "idea_050022";
 ...
 */
@Slf4j
public class Idea50022Service {
    private static final int IDEA_ID = 50022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50022Service() {
        this(new Idea50022Config());
    }

    public Idea50022Service(Idea50022Config config) {
        this.config = config != null ? config : new Idea50022Config();
