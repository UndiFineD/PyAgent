...
@Data
public class Idea50316Config {
    private String name = "idea_050316";
 ...
 */
@Slf4j
public class Idea50316Service {
    private static final int IDEA_ID = 50316;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50316Service() {
        this(new Idea50316Config());
    }

    public Idea50316Service(Idea50316Config config) {
        this.config = config != null ? config : new Idea50316Config();
