...
@Data
public class Idea50347Config {
    private String name = "idea_050347";
 ...
 */
@Slf4j
public class Idea50347Service {
    private static final int IDEA_ID = 50347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50347Service() {
        this(new Idea50347Config());
    }

    public Idea50347Service(Idea50347Config config) {
        this.config = config != null ? config : new Idea50347Config();
