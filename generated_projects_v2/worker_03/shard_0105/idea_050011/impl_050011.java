...
@Data
public class Idea50011Config {
    private String name = "idea_050011";
 ...
 */
@Slf4j
public class Idea50011Service {
    private static final int IDEA_ID = 50011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50011Service() {
        this(new Idea50011Config());
    }

    public Idea50011Service(Idea50011Config config) {
        this.config = config != null ? config : new Idea50011Config();
