...
@Data
public class Idea50177Config {
    private String name = "idea_050177";
 ...
 */
@Slf4j
public class Idea50177Service {
    private static final int IDEA_ID = 50177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50177Service() {
        this(new Idea50177Config());
    }

    public Idea50177Service(Idea50177Config config) {
        this.config = config != null ? config : new Idea50177Config();
