...
@Data
public class Idea50239Config {
    private String name = "idea_050239";
 ...
 */
@Slf4j
public class Idea50239Service {
    private static final int IDEA_ID = 50239;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50239Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50239Service() {
        this(new Idea50239Config());
    }

    public Idea50239Service(Idea50239Config config) {
        this.config = config != null ? config : new Idea50239Config();
