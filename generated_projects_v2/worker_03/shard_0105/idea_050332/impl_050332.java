...
@Data
public class Idea50332Config {
    private String name = "idea_050332";
 ...
 */
@Slf4j
public class Idea50332Service {
    private static final int IDEA_ID = 50332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50332Service() {
        this(new Idea50332Config());
    }

    public Idea50332Service(Idea50332Config config) {
        this.config = config != null ? config : new Idea50332Config();
