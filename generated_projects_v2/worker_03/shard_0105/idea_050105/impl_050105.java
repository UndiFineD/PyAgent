...
@Data
public class Idea50105Config {
    private String name = "idea_050105";
 ...
 */
@Slf4j
public class Idea50105Service {
    private static final int IDEA_ID = 50105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50105Service() {
        this(new Idea50105Config());
    }

    public Idea50105Service(Idea50105Config config) {
        this.config = config != null ? config : new Idea50105Config();
