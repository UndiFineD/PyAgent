...
@Data
public class Idea49949Config {
    private String name = "idea_049949";
 ...
 */
@Slf4j
public class Idea49949Service {
    private static final int IDEA_ID = 49949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49949Service() {
        this(new Idea49949Config());
    }

    public Idea49949Service(Idea49949Config config) {
        this.config = config != null ? config : new Idea49949Config();
