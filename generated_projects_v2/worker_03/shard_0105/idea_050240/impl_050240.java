...
@Data
public class Idea50240Config {
    private String name = "idea_050240";
 ...
 */
@Slf4j
public class Idea50240Service {
    private static final int IDEA_ID = 50240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50240Service() {
        this(new Idea50240Config());
    }

    public Idea50240Service(Idea50240Config config) {
        this.config = config != null ? config : new Idea50240Config();
