...
@Data
public class Idea50004Config {
    private String name = "idea_050004";
 ...
 */
@Slf4j
public class Idea50004Service {
    private static final int IDEA_ID = 50004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50004Service() {
        this(new Idea50004Config());
    }

    public Idea50004Service(Idea50004Config config) {
        this.config = config != null ? config : new Idea50004Config();
