...
@Data
public class Idea50229Config {
    private String name = "idea_050229";
 ...
 */
@Slf4j
public class Idea50229Service {
    private static final int IDEA_ID = 50229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50229Service() {
        this(new Idea50229Config());
    }

    public Idea50229Service(Idea50229Config config) {
        this.config = config != null ? config : new Idea50229Config();
