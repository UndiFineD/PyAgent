...
@Data
public class Idea50176Config {
    private String name = "idea_050176";
 ...
 */
@Slf4j
public class Idea50176Service {
    private static final int IDEA_ID = 50176;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50176Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50176Service() {
        this(new Idea50176Config());
    }

    public Idea50176Service(Idea50176Config config) {
        this.config = config != null ? config : new Idea50176Config();
