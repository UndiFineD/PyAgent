...
@Data
public class Idea50216Config {
    private String name = "idea_050216";
 ...
 */
@Slf4j
public class Idea50216Service {
    private static final int IDEA_ID = 50216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50216Service() {
        this(new Idea50216Config());
    }

    public Idea50216Service(Idea50216Config config) {
        this.config = config != null ? config : new Idea50216Config();
