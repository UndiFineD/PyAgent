...
@Data
public class Idea50277Config {
    private String name = "idea_050277";
 ...
 */
@Slf4j
public class Idea50277Service {
    private static final int IDEA_ID = 50277;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50277Service() {
        this(new Idea50277Config());
    }

    public Idea50277Service(Idea50277Config config) {
        this.config = config != null ? config : new Idea50277Config();
