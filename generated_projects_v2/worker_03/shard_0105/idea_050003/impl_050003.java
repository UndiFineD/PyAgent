...
@Data
public class Idea50003Config {
    private String name = "idea_050003";
 ...
 */
@Slf4j
public class Idea50003Service {
    private static final int IDEA_ID = 50003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50003Service() {
        this(new Idea50003Config());
    }

    public Idea50003Service(Idea50003Config config) {
        this.config = config != null ? config : new Idea50003Config();
