...
@Data
public class Idea50014Config {
    private String name = "idea_050014";
 ...
 */
@Slf4j
public class Idea50014Service {
    private static final int IDEA_ID = 50014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50014Service() {
        this(new Idea50014Config());
    }

    public Idea50014Service(Idea50014Config config) {
        this.config = config != null ? config : new Idea50014Config();
