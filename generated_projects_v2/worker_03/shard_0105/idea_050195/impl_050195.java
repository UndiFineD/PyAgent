...
@Data
public class Idea50195Config {
    private String name = "idea_050195";
 ...
 */
@Slf4j
public class Idea50195Service {
    private static final int IDEA_ID = 50195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50195Service() {
        this(new Idea50195Config());
    }

    public Idea50195Service(Idea50195Config config) {
        this.config = config != null ? config : new Idea50195Config();
