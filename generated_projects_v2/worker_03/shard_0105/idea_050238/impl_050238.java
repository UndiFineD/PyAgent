...
@Data
public class Idea50238Config {
    private String name = "idea_050238";
 ...
 */
@Slf4j
public class Idea50238Service {
    private static final int IDEA_ID = 50238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50238Service() {
        this(new Idea50238Config());
    }

    public Idea50238Service(Idea50238Config config) {
        this.config = config != null ? config : new Idea50238Config();
