...
@Data
public class Idea50102Config {
    private String name = "idea_050102";
 ...
 */
@Slf4j
public class Idea50102Service {
    private static final int IDEA_ID = 50102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50102Service() {
        this(new Idea50102Config());
    }

    public Idea50102Service(Idea50102Config config) {
        this.config = config != null ? config : new Idea50102Config();
