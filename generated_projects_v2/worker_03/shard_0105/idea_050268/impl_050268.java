...
@Data
public class Idea50268Config {
    private String name = "idea_050268";
 ...
 */
@Slf4j
public class Idea50268Service {
    private static final int IDEA_ID = 50268;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50268Service() {
        this(new Idea50268Config());
    }

    public Idea50268Service(Idea50268Config config) {
        this.config = config != null ? config : new Idea50268Config();
