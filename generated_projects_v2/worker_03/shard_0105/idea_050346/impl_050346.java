...
@Data
public class Idea50346Config {
    private String name = "idea_050346";
 ...
 */
@Slf4j
public class Idea50346Service {
    private static final int IDEA_ID = 50346;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50346Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50346Service() {
        this(new Idea50346Config());
    }

    public Idea50346Service(Idea50346Config config) {
        this.config = config != null ? config : new Idea50346Config();
