...
@Data
public class Idea50039Config {
    private String name = "idea_050039";
 ...
 */
@Slf4j
public class Idea50039Service {
    private static final int IDEA_ID = 50039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50039Service() {
        this(new Idea50039Config());
    }

    public Idea50039Service(Idea50039Config config) {
        this.config = config != null ? config : new Idea50039Config();
