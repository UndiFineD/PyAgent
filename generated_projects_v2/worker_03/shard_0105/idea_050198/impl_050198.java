...
@Data
public class Idea50198Config {
    private String name = "idea_050198";
 ...
 */
@Slf4j
public class Idea50198Service {
    private static final int IDEA_ID = 50198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50198Service() {
        this(new Idea50198Config());
    }

    public Idea50198Service(Idea50198Config config) {
        this.config = config != null ? config : new Idea50198Config();
