...
@Data
public class Idea50236Config {
    private String name = "idea_050236";
 ...
 */
@Slf4j
public class Idea50236Service {
    private static final int IDEA_ID = 50236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50236Service() {
        this(new Idea50236Config());
    }

    public Idea50236Service(Idea50236Config config) {
        this.config = config != null ? config : new Idea50236Config();
