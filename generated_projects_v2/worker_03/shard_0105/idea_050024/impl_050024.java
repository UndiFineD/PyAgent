...
@Data
public class Idea50024Config {
    private String name = "idea_050024";
 ...
 */
@Slf4j
public class Idea50024Service {
    private static final int IDEA_ID = 50024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50024Service() {
        this(new Idea50024Config());
    }

    public Idea50024Service(Idea50024Config config) {
        this.config = config != null ? config : new Idea50024Config();
