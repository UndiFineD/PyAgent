...
@Data
public class Idea50226Config {
    private String name = "idea_050226";
 ...
 */
@Slf4j
public class Idea50226Service {
    private static final int IDEA_ID = 50226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50226Service() {
        this(new Idea50226Config());
    }

    public Idea50226Service(Idea50226Config config) {
        this.config = config != null ? config : new Idea50226Config();
