...
@Data
public class Idea50127Config {
    private String name = "idea_050127";
 ...
 */
@Slf4j
public class Idea50127Service {
    private static final int IDEA_ID = 50127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50127Service() {
        this(new Idea50127Config());
    }

    public Idea50127Service(Idea50127Config config) {
        this.config = config != null ? config : new Idea50127Config();
