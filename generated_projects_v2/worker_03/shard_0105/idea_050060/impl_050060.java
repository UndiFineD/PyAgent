...
@Data
public class Idea50060Config {
    private String name = "idea_050060";
 ...
 */
@Slf4j
public class Idea50060Service {
    private static final int IDEA_ID = 50060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50060Service() {
        this(new Idea50060Config());
    }

    public Idea50060Service(Idea50060Config config) {
        this.config = config != null ? config : new Idea50060Config();
