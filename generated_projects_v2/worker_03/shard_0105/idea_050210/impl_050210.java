...
@Data
public class Idea50210Config {
    private String name = "idea_050210";
 ...
 */
@Slf4j
public class Idea50210Service {
    private static final int IDEA_ID = 50210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50210Service() {
        this(new Idea50210Config());
    }

    public Idea50210Service(Idea50210Config config) {
        this.config = config != null ? config : new Idea50210Config();
