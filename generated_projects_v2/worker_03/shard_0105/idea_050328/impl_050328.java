...
@Data
public class Idea50328Config {
    private String name = "idea_050328";
 ...
 */
@Slf4j
public class Idea50328Service {
    private static final int IDEA_ID = 50328;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50328Service() {
        this(new Idea50328Config());
    }

    public Idea50328Service(Idea50328Config config) {
        this.config = config != null ? config : new Idea50328Config();
