...
@Data
public class Idea50329Config {
    private String name = "idea_050329";
 ...
 */
@Slf4j
public class Idea50329Service {
    private static final int IDEA_ID = 50329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50329Service() {
        this(new Idea50329Config());
    }

    public Idea50329Service(Idea50329Config config) {
        this.config = config != null ? config : new Idea50329Config();
