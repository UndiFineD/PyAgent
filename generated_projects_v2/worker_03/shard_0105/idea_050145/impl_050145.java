...
@Data
public class Idea50145Config {
    private String name = "idea_050145";
 ...
 */
@Slf4j
public class Idea50145Service {
    private static final int IDEA_ID = 50145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50145Service() {
        this(new Idea50145Config());
    }

    public Idea50145Service(Idea50145Config config) {
        this.config = config != null ? config : new Idea50145Config();
