...
@Data
public class Idea50099Config {
    private String name = "idea_050099";
 ...
 */
@Slf4j
public class Idea50099Service {
    private static final int IDEA_ID = 50099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50099Service() {
        this(new Idea50099Config());
    }

    public Idea50099Service(Idea50099Config config) {
        this.config = config != null ? config : new Idea50099Config();
