...
@Data
public class Idea50326Config {
    private String name = "idea_050326";
 ...
 */
@Slf4j
public class Idea50326Service {
    private static final int IDEA_ID = 50326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50326Service() {
        this(new Idea50326Config());
    }

    public Idea50326Service(Idea50326Config config) {
        this.config = config != null ? config : new Idea50326Config();
