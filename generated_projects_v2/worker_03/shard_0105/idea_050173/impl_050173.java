...
@Data
public class Idea50173Config {
    private String name = "idea_050173";
 ...
 */
@Slf4j
public class Idea50173Service {
    private static final int IDEA_ID = 50173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50173Service() {
        this(new Idea50173Config());
    }

    public Idea50173Service(Idea50173Config config) {
        this.config = config != null ? config : new Idea50173Config();
