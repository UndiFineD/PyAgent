...
@Data
public class Idea50025Config {
    private String name = "idea_050025";
 ...
 */
@Slf4j
public class Idea50025Service {
    private static final int IDEA_ID = 50025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50025Service() {
        this(new Idea50025Config());
    }

    public Idea50025Service(Idea50025Config config) {
        this.config = config != null ? config : new Idea50025Config();
