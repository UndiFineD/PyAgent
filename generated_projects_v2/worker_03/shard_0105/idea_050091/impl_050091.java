...
@Data
public class Idea50091Config {
    private String name = "idea_050091";
 ...
 */
@Slf4j
public class Idea50091Service {
    private static final int IDEA_ID = 50091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50091Service() {
        this(new Idea50091Config());
    }

    public Idea50091Service(Idea50091Config config) {
        this.config = config != null ? config : new Idea50091Config();
