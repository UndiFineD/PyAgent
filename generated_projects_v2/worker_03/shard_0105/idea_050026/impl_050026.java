...
@Data
public class Idea50026Config {
    private String name = "idea_050026";
 ...
 */
@Slf4j
public class Idea50026Service {
    private static final int IDEA_ID = 50026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50026Service() {
        this(new Idea50026Config());
    }

    public Idea50026Service(Idea50026Config config) {
        this.config = config != null ? config : new Idea50026Config();
