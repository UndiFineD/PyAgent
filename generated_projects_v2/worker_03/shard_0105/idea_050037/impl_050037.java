...
@Data
public class Idea50037Config {
    private String name = "idea_050037";
 ...
 */
@Slf4j
public class Idea50037Service {
    private static final int IDEA_ID = 50037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50037Service() {
        this(new Idea50037Config());
    }

    public Idea50037Service(Idea50037Config config) {
        this.config = config != null ? config : new Idea50037Config();
