...
@Data
public class Idea50171Config {
    private String name = "idea_050171";
 ...
 */
@Slf4j
public class Idea50171Service {
    private static final int IDEA_ID = 50171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50171Service() {
        this(new Idea50171Config());
    }

    public Idea50171Service(Idea50171Config config) {
        this.config = config != null ? config : new Idea50171Config();
