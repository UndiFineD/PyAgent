...
@Data
public class Idea50340Config {
    private String name = "idea_050340";
 ...
 */
@Slf4j
public class Idea50340Service {
    private static final int IDEA_ID = 50340;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50340Service() {
        this(new Idea50340Config());
    }

    public Idea50340Service(Idea50340Config config) {
        this.config = config != null ? config : new Idea50340Config();
