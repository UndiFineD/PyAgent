...
@Data
public class Idea50323Config {
    private String name = "idea_050323";
 ...
 */
@Slf4j
public class Idea50323Service {
    private static final int IDEA_ID = 50323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50323Service() {
        this(new Idea50323Config());
    }

    public Idea50323Service(Idea50323Config config) {
        this.config = config != null ? config : new Idea50323Config();
