...
@Data
public class Idea50220Config {
    private String name = "idea_050220";
 ...
 */
@Slf4j
public class Idea50220Service {
    private static final int IDEA_ID = 50220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50220Service() {
        this(new Idea50220Config());
    }

    public Idea50220Service(Idea50220Config config) {
        this.config = config != null ? config : new Idea50220Config();
