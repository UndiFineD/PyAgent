...
@Data
public class Idea50016Config {
    private String name = "idea_050016";
 ...
 */
@Slf4j
public class Idea50016Service {
    private static final int IDEA_ID = 50016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50016Service() {
        this(new Idea50016Config());
    }

    public Idea50016Service(Idea50016Config config) {
        this.config = config != null ? config : new Idea50016Config();
