...
@Data
public class Idea50128Config {
    private String name = "idea_050128";
 ...
 */
@Slf4j
public class Idea50128Service {
    private static final int IDEA_ID = 50128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50128Service() {
        this(new Idea50128Config());
    }

    public Idea50128Service(Idea50128Config config) {
        this.config = config != null ? config : new Idea50128Config();
