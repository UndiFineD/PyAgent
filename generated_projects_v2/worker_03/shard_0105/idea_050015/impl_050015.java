...
@Data
public class Idea50015Config {
    private String name = "idea_050015";
 ...
 */
@Slf4j
public class Idea50015Service {
    private static final int IDEA_ID = 50015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50015Service() {
        this(new Idea50015Config());
    }

    public Idea50015Service(Idea50015Config config) {
        this.config = config != null ? config : new Idea50015Config();
