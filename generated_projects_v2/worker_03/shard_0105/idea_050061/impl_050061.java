...
@Data
public class Idea50061Config {
    private String name = "idea_050061";
 ...
 */
@Slf4j
public class Idea50061Service {
    private static final int IDEA_ID = 50061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50061Service() {
        this(new Idea50061Config());
    }

    public Idea50061Service(Idea50061Config config) {
        this.config = config != null ? config : new Idea50061Config();
