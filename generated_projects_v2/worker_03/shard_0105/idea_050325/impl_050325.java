...
@Data
public class Idea50325Config {
    private String name = "idea_050325";
 ...
 */
@Slf4j
public class Idea50325Service {
    private static final int IDEA_ID = 50325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50325Service() {
        this(new Idea50325Config());
    }

    public Idea50325Service(Idea50325Config config) {
        this.config = config != null ? config : new Idea50325Config();
