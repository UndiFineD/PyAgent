...
@Data
public class Idea49926Config {
    private String name = "idea_049926";
 ...
 */
@Slf4j
public class Idea49926Service {
    private static final int IDEA_ID = 49926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49926Service() {
        this(new Idea49926Config());
    }

    public Idea49926Service(Idea49926Config config) {
        this.config = config != null ? config : new Idea49926Config();
