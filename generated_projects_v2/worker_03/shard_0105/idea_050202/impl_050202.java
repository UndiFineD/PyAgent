...
@Data
public class Idea50202Config {
    private String name = "idea_050202";
 ...
 */
@Slf4j
public class Idea50202Service {
    private static final int IDEA_ID = 50202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50202Service() {
        this(new Idea50202Config());
    }

    public Idea50202Service(Idea50202Config config) {
        this.config = config != null ? config : new Idea50202Config();
