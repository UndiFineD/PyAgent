...
@Data
public class Idea50087Config {
    private String name = "idea_050087";
 ...
 */
@Slf4j
public class Idea50087Service {
    private static final int IDEA_ID = 50087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50087Service() {
        this(new Idea50087Config());
    }

    public Idea50087Service(Idea50087Config config) {
        this.config = config != null ? config : new Idea50087Config();
