...
@Data
public class Idea50021Config {
    private String name = "idea_050021";
 ...
 */
@Slf4j
public class Idea50021Service {
    private static final int IDEA_ID = 50021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50021Service() {
        this(new Idea50021Config());
    }

    public Idea50021Service(Idea50021Config config) {
        this.config = config != null ? config : new Idea50021Config();
