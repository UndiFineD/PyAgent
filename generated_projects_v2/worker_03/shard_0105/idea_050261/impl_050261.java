...
@Data
public class Idea50261Config {
    private String name = "idea_050261";
 ...
 */
@Slf4j
public class Idea50261Service {
    private static final int IDEA_ID = 50261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50261Service() {
        this(new Idea50261Config());
    }

    public Idea50261Service(Idea50261Config config) {
        this.config = config != null ? config : new Idea50261Config();
