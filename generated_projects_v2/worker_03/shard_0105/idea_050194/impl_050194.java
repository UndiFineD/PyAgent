...
@Data
public class Idea50194Config {
    private String name = "idea_050194";
 ...
 */
@Slf4j
public class Idea50194Service {
    private static final int IDEA_ID = 50194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50194Service() {
        this(new Idea50194Config());
    }

    public Idea50194Service(Idea50194Config config) {
        this.config = config != null ? config : new Idea50194Config();
