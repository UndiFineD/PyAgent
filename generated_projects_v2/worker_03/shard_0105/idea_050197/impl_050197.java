...
@Data
public class Idea50197Config {
    private String name = "idea_050197";
 ...
 */
@Slf4j
public class Idea50197Service {
    private static final int IDEA_ID = 50197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50197Service() {
        this(new Idea50197Config());
    }

    public Idea50197Service(Idea50197Config config) {
        this.config = config != null ? config : new Idea50197Config();
