...
@Data
public class Idea50318Config {
    private String name = "idea_050318";
 ...
 */
@Slf4j
public class Idea50318Service {
    private static final int IDEA_ID = 50318;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50318Service() {
        this(new Idea50318Config());
    }

    public Idea50318Service(Idea50318Config config) {
        this.config = config != null ? config : new Idea50318Config();
