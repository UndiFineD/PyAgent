...
@Data
public class Idea50234Config {
    private String name = "idea_050234";
 ...
 */
@Slf4j
public class Idea50234Service {
    private static final int IDEA_ID = 50234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50234Service() {
        this(new Idea50234Config());
    }

    public Idea50234Service(Idea50234Config config) {
        this.config = config != null ? config : new Idea50234Config();
