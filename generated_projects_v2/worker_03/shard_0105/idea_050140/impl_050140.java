...
@Data
public class Idea50140Config {
    private String name = "idea_050140";
 ...
 */
@Slf4j
public class Idea50140Service {
    private static final int IDEA_ID = 50140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50140Service() {
        this(new Idea50140Config());
    }

    public Idea50140Service(Idea50140Config config) {
        this.config = config != null ? config : new Idea50140Config();
