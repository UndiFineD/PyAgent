...
@Data
public class Idea49973Config {
    private String name = "idea_049973";
 ...
 */
@Slf4j
public class Idea49973Service {
    private static final int IDEA_ID = 49973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49973Service() {
        this(new Idea49973Config());
    }

    public Idea49973Service(Idea49973Config config) {
        this.config = config != null ? config : new Idea49973Config();
