...
@Data
public class Idea50006Config {
    private String name = "idea_050006";
 ...
 */
@Slf4j
public class Idea50006Service {
    private static final int IDEA_ID = 50006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50006Service() {
        this(new Idea50006Config());
    }

    public Idea50006Service(Idea50006Config config) {
        this.config = config != null ? config : new Idea50006Config();
