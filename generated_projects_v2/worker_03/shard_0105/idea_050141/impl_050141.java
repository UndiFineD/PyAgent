...
@Data
public class Idea50141Config {
    private String name = "idea_050141";
 ...
 */
@Slf4j
public class Idea50141Service {
    private static final int IDEA_ID = 50141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50141Service() {
        this(new Idea50141Config());
    }

    public Idea50141Service(Idea50141Config config) {
        this.config = config != null ? config : new Idea50141Config();
