...
@Data
public class Idea50114Config {
    private String name = "idea_050114";
 ...
 */
@Slf4j
public class Idea50114Service {
    private static final int IDEA_ID = 50114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50114Service() {
        this(new Idea50114Config());
    }

    public Idea50114Service(Idea50114Config config) {
        this.config = config != null ? config : new Idea50114Config();
