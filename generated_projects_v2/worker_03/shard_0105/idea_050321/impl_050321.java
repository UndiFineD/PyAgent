...
@Data
public class Idea50321Config {
    private String name = "idea_050321";
 ...
 */
@Slf4j
public class Idea50321Service {
    private static final int IDEA_ID = 50321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50321Service() {
        this(new Idea50321Config());
    }

    public Idea50321Service(Idea50321Config config) {
        this.config = config != null ? config : new Idea50321Config();
