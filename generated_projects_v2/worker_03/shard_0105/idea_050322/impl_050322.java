...
@Data
public class Idea50322Config {
    private String name = "idea_050322";
 ...
 */
@Slf4j
public class Idea50322Service {
    private static final int IDEA_ID = 50322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50322Service() {
        this(new Idea50322Config());
    }

    public Idea50322Service(Idea50322Config config) {
        this.config = config != null ? config : new Idea50322Config();
