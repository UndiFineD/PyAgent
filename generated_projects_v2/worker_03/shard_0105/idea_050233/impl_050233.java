...
@Data
public class Idea50233Config {
    private String name = "idea_050233";
 ...
 */
@Slf4j
public class Idea50233Service {
    private static final int IDEA_ID = 50233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50233Service() {
        this(new Idea50233Config());
    }

    public Idea50233Service(Idea50233Config config) {
        this.config = config != null ? config : new Idea50233Config();
