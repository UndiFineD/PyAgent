...
@Data
public class Idea50010Config {
    private String name = "idea_050010";
 ...
 */
@Slf4j
public class Idea50010Service {
    private static final int IDEA_ID = 50010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50010Service() {
        this(new Idea50010Config());
    }

    public Idea50010Service(Idea50010Config config) {
        this.config = config != null ? config : new Idea50010Config();
