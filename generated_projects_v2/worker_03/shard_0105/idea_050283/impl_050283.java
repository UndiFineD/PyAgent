...
@Data
public class Idea50283Config {
    private String name = "idea_050283";
 ...
 */
@Slf4j
public class Idea50283Service {
    private static final int IDEA_ID = 50283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50283Service() {
        this(new Idea50283Config());
    }

    public Idea50283Service(Idea50283Config config) {
        this.config = config != null ? config : new Idea50283Config();
