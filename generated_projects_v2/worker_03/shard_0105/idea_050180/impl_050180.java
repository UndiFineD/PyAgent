...
@Data
public class Idea50180Config {
    private String name = "idea_050180";
 ...
 */
@Slf4j
public class Idea50180Service {
    private static final int IDEA_ID = 50180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50180Service() {
        this(new Idea50180Config());
    }

    public Idea50180Service(Idea50180Config config) {
        this.config = config != null ? config : new Idea50180Config();
