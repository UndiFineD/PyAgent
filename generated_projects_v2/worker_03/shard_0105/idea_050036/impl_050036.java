...
@Data
public class Idea50036Config {
    private String name = "idea_050036";
 ...
 */
@Slf4j
public class Idea50036Service {
    private static final int IDEA_ID = 50036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50036Service() {
        this(new Idea50036Config());
    }

    public Idea50036Service(Idea50036Config config) {
        this.config = config != null ? config : new Idea50036Config();
