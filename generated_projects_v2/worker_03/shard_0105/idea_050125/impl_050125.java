...
@Data
public class Idea50125Config {
    private String name = "idea_050125";
 ...
 */
@Slf4j
public class Idea50125Service {
    private static final int IDEA_ID = 50125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50125Service() {
        this(new Idea50125Config());
    }

    public Idea50125Service(Idea50125Config config) {
        this.config = config != null ? config : new Idea50125Config();
