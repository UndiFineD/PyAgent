...
@Data
public class Idea49978Config {
    private String name = "idea_049978";
 ...
 */
@Slf4j
public class Idea49978Service {
    private static final int IDEA_ID = 49978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49978Service() {
        this(new Idea49978Config());
    }

    public Idea49978Service(Idea49978Config config) {
        this.config = config != null ? config : new Idea49978Config();
