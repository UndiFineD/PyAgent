...
@Data
public class Idea49937Config {
    private String name = "idea_049937";
 ...
 */
@Slf4j
public class Idea49937Service {
    private static final int IDEA_ID = 49937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49937Service() {
        this(new Idea49937Config());
    }

    public Idea49937Service(Idea49937Config config) {
        this.config = config != null ? config : new Idea49937Config();
