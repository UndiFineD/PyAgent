...
@Data
public class Idea50205Config {
    private String name = "idea_050205";
 ...
 */
@Slf4j
public class Idea50205Service {
    private static final int IDEA_ID = 50205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50205Service() {
        this(new Idea50205Config());
    }

    public Idea50205Service(Idea50205Config config) {
        this.config = config != null ? config : new Idea50205Config();
