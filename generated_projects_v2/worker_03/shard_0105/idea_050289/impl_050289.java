...
@Data
public class Idea50289Config {
    private String name = "idea_050289";
 ...
 */
@Slf4j
public class Idea50289Service {
    private static final int IDEA_ID = 50289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50289Service() {
        this(new Idea50289Config());
    }

    public Idea50289Service(Idea50289Config config) {
        this.config = config != null ? config : new Idea50289Config();
