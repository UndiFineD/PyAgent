...
@Data
public class Idea50189Config {
    private String name = "idea_050189";
 ...
 */
@Slf4j
public class Idea50189Service {
    private static final int IDEA_ID = 50189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50189Service() {
        this(new Idea50189Config());
    }

    public Idea50189Service(Idea50189Config config) {
        this.config = config != null ? config : new Idea50189Config();
