...
@Data
public class Idea50083Config {
    private String name = "idea_050083";
 ...
 */
@Slf4j
public class Idea50083Service {
    private static final int IDEA_ID = 50083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50083Service() {
        this(new Idea50083Config());
    }

    public Idea50083Service(Idea50083Config config) {
        this.config = config != null ? config : new Idea50083Config();
