...
@Data
public class Idea50033Config {
    private String name = "idea_050033";
 ...
 */
@Slf4j
public class Idea50033Service {
    private static final int IDEA_ID = 50033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50033Service() {
        this(new Idea50033Config());
    }

    public Idea50033Service(Idea50033Config config) {
        this.config = config != null ? config : new Idea50033Config();
