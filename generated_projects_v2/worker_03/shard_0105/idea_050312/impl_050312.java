...
@Data
public class Idea50312Config {
    private String name = "idea_050312";
 ...
 */
@Slf4j
public class Idea50312Service {
    private static final int IDEA_ID = 50312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50312Service() {
        this(new Idea50312Config());
    }

    public Idea50312Service(Idea50312Config config) {
        this.config = config != null ? config : new Idea50312Config();
