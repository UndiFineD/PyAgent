...
@Data
public class Idea50000Config {
    private String name = "idea_050000";
 ...
 */
@Slf4j
public class Idea50000Service {
    private static final int IDEA_ID = 50000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50000Service() {
        this(new Idea50000Config());
    }

    public Idea50000Service(Idea50000Config config) {
        this.config = config != null ? config : new Idea50000Config();
