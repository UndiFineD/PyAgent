...
@Data
public class Idea50303Config {
    private String name = "idea_050303";
 ...
 */
@Slf4j
public class Idea50303Service {
    private static final int IDEA_ID = 50303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50303Service() {
        this(new Idea50303Config());
    }

    public Idea50303Service(Idea50303Config config) {
        this.config = config != null ? config : new Idea50303Config();
