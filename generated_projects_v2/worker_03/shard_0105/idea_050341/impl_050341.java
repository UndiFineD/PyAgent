...
@Data
public class Idea50341Config {
    private String name = "idea_050341";
 ...
 */
@Slf4j
public class Idea50341Service {
    private static final int IDEA_ID = 50341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50341Service() {
        this(new Idea50341Config());
    }

    public Idea50341Service(Idea50341Config config) {
        this.config = config != null ? config : new Idea50341Config();
