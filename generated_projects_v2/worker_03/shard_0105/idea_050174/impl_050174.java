...
@Data
public class Idea50174Config {
    private String name = "idea_050174";
 ...
 */
@Slf4j
public class Idea50174Service {
    private static final int IDEA_ID = 50174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50174Service() {
        this(new Idea50174Config());
    }

    public Idea50174Service(Idea50174Config config) {
        this.config = config != null ? config : new Idea50174Config();
