...
@Data
public class Idea50275Config {
    private String name = "idea_050275";
 ...
 */
@Slf4j
public class Idea50275Service {
    private static final int IDEA_ID = 50275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50275Service() {
        this(new Idea50275Config());
    }

    public Idea50275Service(Idea50275Config config) {
        this.config = config != null ? config : new Idea50275Config();
