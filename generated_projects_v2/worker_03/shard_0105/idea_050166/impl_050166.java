...
@Data
public class Idea50166Config {
    private String name = "idea_050166";
 ...
 */
@Slf4j
public class Idea50166Service {
    private static final int IDEA_ID = 50166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50166Service() {
        this(new Idea50166Config());
    }

    public Idea50166Service(Idea50166Config config) {
        this.config = config != null ? config : new Idea50166Config();
