...
@Data
public class Idea50330Config {
    private String name = "idea_050330";
 ...
 */
@Slf4j
public class Idea50330Service {
    private static final int IDEA_ID = 50330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50330Service() {
        this(new Idea50330Config());
    }

    public Idea50330Service(Idea50330Config config) {
        this.config = config != null ? config : new Idea50330Config();
