...
@Data
public class Idea50203Config {
    private String name = "idea_050203";
 ...
 */
@Slf4j
public class Idea50203Service {
    private static final int IDEA_ID = 50203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50203Service() {
        this(new Idea50203Config());
    }

    public Idea50203Service(Idea50203Config config) {
        this.config = config != null ? config : new Idea50203Config();
