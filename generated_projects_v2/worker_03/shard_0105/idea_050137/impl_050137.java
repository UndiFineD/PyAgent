...
@Data
public class Idea50137Config {
    private String name = "idea_050137";
 ...
 */
@Slf4j
public class Idea50137Service {
    private static final int IDEA_ID = 50137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50137Service() {
        this(new Idea50137Config());
    }

    public Idea50137Service(Idea50137Config config) {
        this.config = config != null ? config : new Idea50137Config();
