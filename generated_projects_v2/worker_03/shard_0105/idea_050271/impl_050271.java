...
@Data
public class Idea50271Config {
    private String name = "idea_050271";
 ...
 */
@Slf4j
public class Idea50271Service {
    private static final int IDEA_ID = 50271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50271Service() {
        this(new Idea50271Config());
    }

    public Idea50271Service(Idea50271Config config) {
        this.config = config != null ? config : new Idea50271Config();
