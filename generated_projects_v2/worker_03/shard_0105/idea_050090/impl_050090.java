...
@Data
public class Idea50090Config {
    private String name = "idea_050090";
 ...
 */
@Slf4j
public class Idea50090Service {
    private static final int IDEA_ID = 50090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50090Service() {
        this(new Idea50090Config());
    }

    public Idea50090Service(Idea50090Config config) {
        this.config = config != null ? config : new Idea50090Config();
