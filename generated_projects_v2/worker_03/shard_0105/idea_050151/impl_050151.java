...
@Data
public class Idea50151Config {
    private String name = "idea_050151";
 ...
 */
@Slf4j
public class Idea50151Service {
    private static final int IDEA_ID = 50151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50151Service() {
        this(new Idea50151Config());
    }

    public Idea50151Service(Idea50151Config config) {
        this.config = config != null ? config : new Idea50151Config();
