...
@Data
public class Idea50337Config {
    private String name = "idea_050337";
 ...
 */
@Slf4j
public class Idea50337Service {
    private static final int IDEA_ID = 50337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50337Service() {
        this(new Idea50337Config());
    }

    public Idea50337Service(Idea50337Config config) {
        this.config = config != null ? config : new Idea50337Config();
