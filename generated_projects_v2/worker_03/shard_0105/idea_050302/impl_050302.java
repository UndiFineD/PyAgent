...
@Data
public class Idea50302Config {
    private String name = "idea_050302";
 ...
 */
@Slf4j
public class Idea50302Service {
    private static final int IDEA_ID = 50302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50302Service() {
        this(new Idea50302Config());
    }

    public Idea50302Service(Idea50302Config config) {
        this.config = config != null ? config : new Idea50302Config();
