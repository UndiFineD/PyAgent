...
@Data
public class Idea50167Config {
    private String name = "idea_050167";
 ...
 */
@Slf4j
public class Idea50167Service {
    private static final int IDEA_ID = 50167;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50167Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50167Service() {
        this(new Idea50167Config());
    }

    public Idea50167Service(Idea50167Config config) {
        this.config = config != null ? config : new Idea50167Config();
