...
@Data
public class Idea50206Config {
    private String name = "idea_050206";
 ...
 */
@Slf4j
public class Idea50206Service {
    private static final int IDEA_ID = 50206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50206Service() {
        this(new Idea50206Config());
    }

    public Idea50206Service(Idea50206Config config) {
        this.config = config != null ? config : new Idea50206Config();
