...
@Data
public class Idea50227Config {
    private String name = "idea_050227";
 ...
 */
@Slf4j
public class Idea50227Service {
    private static final int IDEA_ID = 50227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50227Service() {
        this(new Idea50227Config());
    }

    public Idea50227Service(Idea50227Config config) {
        this.config = config != null ? config : new Idea50227Config();
