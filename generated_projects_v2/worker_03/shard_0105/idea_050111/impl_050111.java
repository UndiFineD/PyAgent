...
@Data
public class Idea50111Config {
    private String name = "idea_050111";
 ...
 */
@Slf4j
public class Idea50111Service {
    private static final int IDEA_ID = 50111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50111Service() {
        this(new Idea50111Config());
    }

    public Idea50111Service(Idea50111Config config) {
        this.config = config != null ? config : new Idea50111Config();
