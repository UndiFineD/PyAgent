...
@Data
public class Idea50076Config {
    private String name = "idea_050076";
 ...
 */
@Slf4j
public class Idea50076Service {
    private static final int IDEA_ID = 50076;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50076Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50076Service() {
        this(new Idea50076Config());
    }

    public Idea50076Service(Idea50076Config config) {
        this.config = config != null ? config : new Idea50076Config();
