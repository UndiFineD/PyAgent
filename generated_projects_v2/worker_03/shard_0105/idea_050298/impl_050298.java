...
@Data
public class Idea50298Config {
    private String name = "idea_050298";
 ...
 */
@Slf4j
public class Idea50298Service {
    private static final int IDEA_ID = 50298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50298Service() {
        this(new Idea50298Config());
    }

    public Idea50298Service(Idea50298Config config) {
        this.config = config != null ? config : new Idea50298Config();
