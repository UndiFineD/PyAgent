...
@Data
public class Idea50214Config {
    private String name = "idea_050214";
 ...
 */
@Slf4j
public class Idea50214Service {
    private static final int IDEA_ID = 50214;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50214Service() {
        this(new Idea50214Config());
    }

    public Idea50214Service(Idea50214Config config) {
        this.config = config != null ? config : new Idea50214Config();
