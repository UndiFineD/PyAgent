...
@Data
public class Idea50320Config {
    private String name = "idea_050320";
 ...
 */
@Slf4j
public class Idea50320Service {
    private static final int IDEA_ID = 50320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50320Service() {
        this(new Idea50320Config());
    }

    public Idea50320Service(Idea50320Config config) {
        this.config = config != null ? config : new Idea50320Config();
