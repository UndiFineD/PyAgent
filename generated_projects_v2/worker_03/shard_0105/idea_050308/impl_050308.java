...
@Data
public class Idea50308Config {
    private String name = "idea_050308";
 ...
 */
@Slf4j
public class Idea50308Service {
    private static final int IDEA_ID = 50308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50308Service() {
        this(new Idea50308Config());
    }

    public Idea50308Service(Idea50308Config config) {
        this.config = config != null ? config : new Idea50308Config();
