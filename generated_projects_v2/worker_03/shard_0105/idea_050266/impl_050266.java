...
@Data
public class Idea50266Config {
    private String name = "idea_050266";
 ...
 */
@Slf4j
public class Idea50266Service {
    private static final int IDEA_ID = 50266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50266Service() {
        this(new Idea50266Config());
    }

    public Idea50266Service(Idea50266Config config) {
        this.config = config != null ? config : new Idea50266Config();
