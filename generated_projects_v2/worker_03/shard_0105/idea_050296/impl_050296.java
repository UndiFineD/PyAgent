...
@Data
public class Idea50296Config {
    private String name = "idea_050296";
 ...
 */
@Slf4j
public class Idea50296Service {
    private static final int IDEA_ID = 50296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50296Service() {
        this(new Idea50296Config());
    }

    public Idea50296Service(Idea50296Config config) {
        this.config = config != null ? config : new Idea50296Config();
