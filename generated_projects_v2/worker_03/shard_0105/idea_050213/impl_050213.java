...
@Data
public class Idea50213Config {
    private String name = "idea_050213";
 ...
 */
@Slf4j
public class Idea50213Service {
    private static final int IDEA_ID = 50213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50213Service() {
        this(new Idea50213Config());
    }

    public Idea50213Service(Idea50213Config config) {
        this.config = config != null ? config : new Idea50213Config();
