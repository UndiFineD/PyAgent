...
@Data
public class Idea50112Config {
    private String name = "idea_050112";
 ...
 */
@Slf4j
public class Idea50112Service {
    private static final int IDEA_ID = 50112;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50112Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50112Service() {
        this(new Idea50112Config());
    }

    public Idea50112Service(Idea50112Config config) {
        this.config = config != null ? config : new Idea50112Config();
