...
@Data
public class Idea50311Config {
    private String name = "idea_050311";
 ...
 */
@Slf4j
public class Idea50311Service {
    private static final int IDEA_ID = 50311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50311Service() {
        this(new Idea50311Config());
    }

    public Idea50311Service(Idea50311Config config) {
        this.config = config != null ? config : new Idea50311Config();
