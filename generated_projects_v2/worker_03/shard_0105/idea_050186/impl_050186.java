...
@Data
public class Idea50186Config {
    private String name = "idea_050186";
 ...
 */
@Slf4j
public class Idea50186Service {
    private static final int IDEA_ID = 50186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50186Service() {
        this(new Idea50186Config());
    }

    public Idea50186Service(Idea50186Config config) {
        this.config = config != null ? config : new Idea50186Config();
