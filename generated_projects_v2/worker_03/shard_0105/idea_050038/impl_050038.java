...
@Data
public class Idea50038Config {
    private String name = "idea_050038";
 ...
 */
@Slf4j
public class Idea50038Service {
    private static final int IDEA_ID = 50038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50038Service() {
        this(new Idea50038Config());
    }

    public Idea50038Service(Idea50038Config config) {
        this.config = config != null ? config : new Idea50038Config();
