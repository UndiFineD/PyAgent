...
@Data
public class Idea50138Config {
    private String name = "idea_050138";
 ...
 */
@Slf4j
public class Idea50138Service {
    private static final int IDEA_ID = 50138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50138Service() {
        this(new Idea50138Config());
    }

    public Idea50138Service(Idea50138Config config) {
        this.config = config != null ? config : new Idea50138Config();
