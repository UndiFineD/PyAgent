...
@Data
public class Idea50309Config {
    private String name = "idea_050309";
 ...
 */
@Slf4j
public class Idea50309Service {
    private static final int IDEA_ID = 50309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50309Service() {
        this(new Idea50309Config());
    }

    public Idea50309Service(Idea50309Config config) {
        this.config = config != null ? config : new Idea50309Config();
