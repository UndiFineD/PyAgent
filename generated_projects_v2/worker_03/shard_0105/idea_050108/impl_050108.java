...
@Data
public class Idea50108Config {
    private String name = "idea_050108";
 ...
 */
@Slf4j
public class Idea50108Service {
    private static final int IDEA_ID = 50108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50108Service() {
        this(new Idea50108Config());
    }

    public Idea50108Service(Idea50108Config config) {
        this.config = config != null ? config : new Idea50108Config();
