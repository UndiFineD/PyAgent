...
@Data
public class Idea50147Config {
    private String name = "idea_050147";
 ...
 */
@Slf4j
public class Idea50147Service {
    private static final int IDEA_ID = 50147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50147Service() {
        this(new Idea50147Config());
    }

    public Idea50147Service(Idea50147Config config) {
        this.config = config != null ? config : new Idea50147Config();
