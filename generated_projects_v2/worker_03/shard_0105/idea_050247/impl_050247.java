...
@Data
public class Idea50247Config {
    private String name = "idea_050247";
 ...
 */
@Slf4j
public class Idea50247Service {
    private static final int IDEA_ID = 50247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50247Service() {
        this(new Idea50247Config());
    }

    public Idea50247Service(Idea50247Config config) {
        this.config = config != null ? config : new Idea50247Config();
