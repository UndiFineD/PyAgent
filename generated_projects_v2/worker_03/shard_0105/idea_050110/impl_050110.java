...
@Data
public class Idea50110Config {
    private String name = "idea_050110";
 ...
 */
@Slf4j
public class Idea50110Service {
    private static final int IDEA_ID = 50110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50110Service() {
        this(new Idea50110Config());
    }

    public Idea50110Service(Idea50110Config config) {
        this.config = config != null ? config : new Idea50110Config();
