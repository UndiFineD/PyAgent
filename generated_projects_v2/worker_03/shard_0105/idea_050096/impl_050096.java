...
@Data
public class Idea50096Config {
    private String name = "idea_050096";
 ...
 */
@Slf4j
public class Idea50096Service {
    private static final int IDEA_ID = 50096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50096Service() {
        this(new Idea50096Config());
    }

    public Idea50096Service(Idea50096Config config) {
        this.config = config != null ? config : new Idea50096Config();
