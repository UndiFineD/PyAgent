...
@Data
public class Idea49936Config {
    private String name = "idea_049936";
 ...
 */
@Slf4j
public class Idea49936Service {
    private static final int IDEA_ID = 49936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49936Service() {
        this(new Idea49936Config());
    }

    public Idea49936Service(Idea49936Config config) {
        this.config = config != null ? config : new Idea49936Config();
