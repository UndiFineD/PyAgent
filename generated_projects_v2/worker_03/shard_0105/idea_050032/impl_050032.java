...
@Data
public class Idea50032Config {
    private String name = "idea_050032";
 ...
 */
@Slf4j
public class Idea50032Service {
    private static final int IDEA_ID = 50032;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50032Service() {
        this(new Idea50032Config());
    }

    public Idea50032Service(Idea50032Config config) {
        this.config = config != null ? config : new Idea50032Config();
