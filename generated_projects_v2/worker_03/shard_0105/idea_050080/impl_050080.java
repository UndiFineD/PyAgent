...
@Data
public class Idea50080Config {
    private String name = "idea_050080";
 ...
 */
@Slf4j
public class Idea50080Service {
    private static final int IDEA_ID = 50080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50080Service() {
        this(new Idea50080Config());
    }

    public Idea50080Service(Idea50080Config config) {
        this.config = config != null ? config : new Idea50080Config();
