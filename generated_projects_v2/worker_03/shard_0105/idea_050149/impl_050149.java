...
@Data
public class Idea50149Config {
    private String name = "idea_050149";
 ...
 */
@Slf4j
public class Idea50149Service {
    private static final int IDEA_ID = 50149;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50149Service() {
        this(new Idea50149Config());
    }

    public Idea50149Service(Idea50149Config config) {
        this.config = config != null ? config : new Idea50149Config();
