...
@Data
public class Idea50086Config {
    private String name = "idea_050086";
 ...
 */
@Slf4j
public class Idea50086Service {
    private static final int IDEA_ID = 50086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50086Service() {
        this(new Idea50086Config());
    }

    public Idea50086Service(Idea50086Config config) {
        this.config = config != null ? config : new Idea50086Config();
