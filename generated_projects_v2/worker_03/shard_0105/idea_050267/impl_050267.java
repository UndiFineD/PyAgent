...
@Data
public class Idea50267Config {
    private String name = "idea_050267";
 ...
 */
@Slf4j
public class Idea50267Service {
    private static final int IDEA_ID = 50267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50267Service() {
        this(new Idea50267Config());
    }

    public Idea50267Service(Idea50267Config config) {
        this.config = config != null ? config : new Idea50267Config();
