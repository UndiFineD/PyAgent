...
@Data
public class Idea42993Config {
    private String name = "idea_042993";
 ...
 */
@Slf4j
public class Idea42993Service {
    private static final int IDEA_ID = 42993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42993Service() {
        this(new Idea42993Config());
    }

    public Idea42993Service(Idea42993Config config) {
        this.config = config != null ? config : new Idea42993Config();
