...
@Data
public class Idea42980Config {
    private String name = "idea_042980";
 ...
 */
@Slf4j
public class Idea42980Service {
    private static final int IDEA_ID = 42980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42980Service() {
        this(new Idea42980Config());
    }

    public Idea42980Service(Idea42980Config config) {
        this.config = config != null ? config : new Idea42980Config();
