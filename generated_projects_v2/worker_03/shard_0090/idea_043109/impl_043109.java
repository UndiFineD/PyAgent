...
@Data
public class Idea43109Config {
    private String name = "idea_043109";
 ...
 */
@Slf4j
public class Idea43109Service {
    private static final int IDEA_ID = 43109;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43109Service() {
        this(new Idea43109Config());
    }

    public Idea43109Service(Idea43109Config config) {
        this.config = config != null ? config : new Idea43109Config();
