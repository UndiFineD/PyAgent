...
@Data
public class Idea43211Config {
    private String name = "idea_043211";
 ...
 */
@Slf4j
public class Idea43211Service {
    private static final int IDEA_ID = 43211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43211Service() {
        this(new Idea43211Config());
    }

    public Idea43211Service(Idea43211Config config) {
        this.config = config != null ? config : new Idea43211Config();
