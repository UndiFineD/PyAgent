...
@Data
public class Idea43012Config {
    private String name = "idea_043012";
 ...
 */
@Slf4j
public class Idea43012Service {
    private static final int IDEA_ID = 43012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43012Service() {
        this(new Idea43012Config());
    }

    public Idea43012Service(Idea43012Config config) {
        this.config = config != null ? config : new Idea43012Config();
