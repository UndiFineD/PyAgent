...
@Data
public class Idea42898Config {
    private String name = "idea_042898";
 ...
 */
@Slf4j
public class Idea42898Service {
    private static final int IDEA_ID = 42898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42898Service() {
        this(new Idea42898Config());
    }

    public Idea42898Service(Idea42898Config config) {
        this.config = config != null ? config : new Idea42898Config();
