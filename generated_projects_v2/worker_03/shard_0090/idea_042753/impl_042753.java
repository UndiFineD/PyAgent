...
@Data
public class Idea42753Config {
    private String name = "idea_042753";
 ...
 */
@Slf4j
public class Idea42753Service {
    private static final int IDEA_ID = 42753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42753Service() {
        this(new Idea42753Config());
    }

    public Idea42753Service(Idea42753Config config) {
        this.config = config != null ? config : new Idea42753Config();
