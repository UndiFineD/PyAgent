...
@Data
public class Idea43124Config {
    private String name = "idea_043124";
 ...
 */
@Slf4j
public class Idea43124Service {
    private static final int IDEA_ID = 43124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43124Service() {
        this(new Idea43124Config());
    }

    public Idea43124Service(Idea43124Config config) {
        this.config = config != null ? config : new Idea43124Config();
