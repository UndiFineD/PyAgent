...
@Data
public class Idea43035Config {
    private String name = "idea_043035";
 ...
 */
@Slf4j
public class Idea43035Service {
    private static final int IDEA_ID = 43035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43035Service() {
        this(new Idea43035Config());
    }

    public Idea43035Service(Idea43035Config config) {
        this.config = config != null ? config : new Idea43035Config();
