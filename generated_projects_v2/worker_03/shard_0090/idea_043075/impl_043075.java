...
@Data
public class Idea43075Config {
    private String name = "idea_043075";
 ...
 */
@Slf4j
public class Idea43075Service {
    private static final int IDEA_ID = 43075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43075Service() {
        this(new Idea43075Config());
    }

    public Idea43075Service(Idea43075Config config) {
        this.config = config != null ? config : new Idea43075Config();
