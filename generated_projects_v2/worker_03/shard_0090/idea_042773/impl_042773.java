...
@Data
public class Idea42773Config {
    private String name = "idea_042773";
 ...
 */
@Slf4j
public class Idea42773Service {
    private static final int IDEA_ID = 42773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42773Service() {
        this(new Idea42773Config());
    }

    public Idea42773Service(Idea42773Config config) {
        this.config = config != null ? config : new Idea42773Config();
