...
@Data
public class Idea42965Config {
    private String name = "idea_042965";
 ...
 */
@Slf4j
public class Idea42965Service {
    private static final int IDEA_ID = 42965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42965Service() {
        this(new Idea42965Config());
    }

    public Idea42965Service(Idea42965Config config) {
        this.config = config != null ? config : new Idea42965Config();
