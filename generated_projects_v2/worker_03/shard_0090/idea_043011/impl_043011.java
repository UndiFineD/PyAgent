...
@Data
public class Idea43011Config {
    private String name = "idea_043011";
 ...
 */
@Slf4j
public class Idea43011Service {
    private static final int IDEA_ID = 43011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43011Service() {
        this(new Idea43011Config());
    }

    public Idea43011Service(Idea43011Config config) {
        this.config = config != null ? config : new Idea43011Config();
