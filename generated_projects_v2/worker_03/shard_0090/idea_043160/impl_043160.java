...
@Data
public class Idea43160Config {
    private String name = "idea_043160";
 ...
 */
@Slf4j
public class Idea43160Service {
    private static final int IDEA_ID = 43160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43160Service() {
        this(new Idea43160Config());
    }

    public Idea43160Service(Idea43160Config config) {
        this.config = config != null ? config : new Idea43160Config();
