...
@Data
public class Idea43107Config {
    private String name = "idea_043107";
 ...
 */
@Slf4j
public class Idea43107Service {
    private static final int IDEA_ID = 43107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43107Service() {
        this(new Idea43107Config());
    }

    public Idea43107Service(Idea43107Config config) {
        this.config = config != null ? config : new Idea43107Config();
