...
@Data
public class Idea43017Config {
    private String name = "idea_043017";
 ...
 */
@Slf4j
public class Idea43017Service {
    private static final int IDEA_ID = 43017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43017Service() {
        this(new Idea43017Config());
    }

    public Idea43017Service(Idea43017Config config) {
        this.config = config != null ? config : new Idea43017Config();
