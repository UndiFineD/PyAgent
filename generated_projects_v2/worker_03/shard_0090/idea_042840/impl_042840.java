...
@Data
public class Idea42840Config {
    private String name = "idea_042840";
 ...
 */
@Slf4j
public class Idea42840Service {
    private static final int IDEA_ID = 42840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42840Service() {
        this(new Idea42840Config());
    }

    public Idea42840Service(Idea42840Config config) {
        this.config = config != null ? config : new Idea42840Config();
