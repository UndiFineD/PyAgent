...
@Data
public class Idea43098Config {
    private String name = "idea_043098";
 ...
 */
@Slf4j
public class Idea43098Service {
    private static final int IDEA_ID = 43098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43098Service() {
        this(new Idea43098Config());
    }

    public Idea43098Service(Idea43098Config config) {
        this.config = config != null ? config : new Idea43098Config();
