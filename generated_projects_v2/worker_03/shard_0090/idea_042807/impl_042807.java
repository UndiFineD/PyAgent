...
@Data
public class Idea42807Config {
    private String name = "idea_042807";
 ...
 */
@Slf4j
public class Idea42807Service {
    private static final int IDEA_ID = 42807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42807Service() {
        this(new Idea42807Config());
    }

    public Idea42807Service(Idea42807Config config) {
        this.config = config != null ? config : new Idea42807Config();
