...
@Data
public class Idea43014Config {
    private String name = "idea_043014";
 ...
 */
@Slf4j
public class Idea43014Service {
    private static final int IDEA_ID = 43014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43014Service() {
        this(new Idea43014Config());
    }

    public Idea43014Service(Idea43014Config config) {
        this.config = config != null ? config : new Idea43014Config();
