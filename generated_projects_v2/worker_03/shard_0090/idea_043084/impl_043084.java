...
@Data
public class Idea43084Config {
    private String name = "idea_043084";
 ...
 */
@Slf4j
public class Idea43084Service {
    private static final int IDEA_ID = 43084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43084Service() {
        this(new Idea43084Config());
    }

    public Idea43084Service(Idea43084Config config) {
        this.config = config != null ? config : new Idea43084Config();
