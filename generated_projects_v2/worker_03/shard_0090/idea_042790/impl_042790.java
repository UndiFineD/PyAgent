...
@Data
public class Idea42790Config {
    private String name = "idea_042790";
 ...
 */
@Slf4j
public class Idea42790Service {
    private static final int IDEA_ID = 42790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42790Service() {
        this(new Idea42790Config());
    }

    public Idea42790Service(Idea42790Config config) {
        this.config = config != null ? config : new Idea42790Config();
