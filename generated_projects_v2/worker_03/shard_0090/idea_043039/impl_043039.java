...
@Data
public class Idea43039Config {
    private String name = "idea_043039";
 ...
 */
@Slf4j
public class Idea43039Service {
    private static final int IDEA_ID = 43039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43039Service() {
        this(new Idea43039Config());
    }

    public Idea43039Service(Idea43039Config config) {
        this.config = config != null ? config : new Idea43039Config();
