...
@Data
public class Idea43045Config {
    private String name = "idea_043045";
 ...
 */
@Slf4j
public class Idea43045Service {
    private static final int IDEA_ID = 43045;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43045Service() {
        this(new Idea43045Config());
    }

    public Idea43045Service(Idea43045Config config) {
        this.config = config != null ? config : new Idea43045Config();
