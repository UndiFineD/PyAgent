...
@Data
public class Idea43114Config {
    private String name = "idea_043114";
 ...
 */
@Slf4j
public class Idea43114Service {
    private static final int IDEA_ID = 43114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43114Service() {
        this(new Idea43114Config());
    }

    public Idea43114Service(Idea43114Config config) {
        this.config = config != null ? config : new Idea43114Config();
