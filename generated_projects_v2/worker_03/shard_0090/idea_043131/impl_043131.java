...
@Data
public class Idea43131Config {
    private String name = "idea_043131";
 ...
 */
@Slf4j
public class Idea43131Service {
    private static final int IDEA_ID = 43131;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43131Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43131Service() {
        this(new Idea43131Config());
    }

    public Idea43131Service(Idea43131Config config) {
        this.config = config != null ? config : new Idea43131Config();
