...
@Data
public class Idea42784Config {
    private String name = "idea_042784";
 ...
 */
@Slf4j
public class Idea42784Service {
    private static final int IDEA_ID = 42784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42784Service() {
        this(new Idea42784Config());
    }

    public Idea42784Service(Idea42784Config config) {
        this.config = config != null ? config : new Idea42784Config();
