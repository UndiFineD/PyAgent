...
@Data
public class Idea43198Config {
    private String name = "idea_043198";
 ...
 */
@Slf4j
public class Idea43198Service {
    private static final int IDEA_ID = 43198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43198Service() {
        this(new Idea43198Config());
    }

    public Idea43198Service(Idea43198Config config) {
        this.config = config != null ? config : new Idea43198Config();
