...
@Data
public class Idea42806Config {
    private String name = "idea_042806";
 ...
 */
@Slf4j
public class Idea42806Service {
    private static final int IDEA_ID = 42806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42806Service() {
        this(new Idea42806Config());
    }

    public Idea42806Service(Idea42806Config config) {
        this.config = config != null ? config : new Idea42806Config();
