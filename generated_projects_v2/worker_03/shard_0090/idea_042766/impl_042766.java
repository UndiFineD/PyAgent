...
@Data
public class Idea42766Config {
    private String name = "idea_042766";
 ...
 */
@Slf4j
public class Idea42766Service {
    private static final int IDEA_ID = 42766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42766Service() {
        this(new Idea42766Config());
    }

    public Idea42766Service(Idea42766Config config) {
        this.config = config != null ? config : new Idea42766Config();
