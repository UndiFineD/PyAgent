...
@Data
public class Idea42936Config {
    private String name = "idea_042936";
 ...
 */
@Slf4j
public class Idea42936Service {
    private static final int IDEA_ID = 42936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42936Service() {
        this(new Idea42936Config());
    }

    public Idea42936Service(Idea42936Config config) {
        this.config = config != null ? config : new Idea42936Config();
