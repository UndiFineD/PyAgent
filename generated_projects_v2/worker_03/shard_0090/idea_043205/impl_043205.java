...
@Data
public class Idea43205Config {
    private String name = "idea_043205";
 ...
 */
@Slf4j
public class Idea43205Service {
    private static final int IDEA_ID = 43205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43205Service() {
        this(new Idea43205Config());
    }

    public Idea43205Service(Idea43205Config config) {
        this.config = config != null ? config : new Idea43205Config();
