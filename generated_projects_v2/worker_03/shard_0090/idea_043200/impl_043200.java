...
@Data
public class Idea43200Config {
    private String name = "idea_043200";
 ...
 */
@Slf4j
public class Idea43200Service {
    private static final int IDEA_ID = 43200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43200Service() {
        this(new Idea43200Config());
    }

    public Idea43200Service(Idea43200Config config) {
        this.config = config != null ? config : new Idea43200Config();
