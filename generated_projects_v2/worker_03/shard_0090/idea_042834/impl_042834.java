...
@Data
public class Idea42834Config {
    private String name = "idea_042834";
 ...
 */
@Slf4j
public class Idea42834Service {
    private static final int IDEA_ID = 42834;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42834Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42834Service() {
        this(new Idea42834Config());
    }

    public Idea42834Service(Idea42834Config config) {
        this.config = config != null ? config : new Idea42834Config();
