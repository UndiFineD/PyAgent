...
@Data
public class Idea43003Config {
    private String name = "idea_043003";
 ...
 */
@Slf4j
public class Idea43003Service {
    private static final int IDEA_ID = 43003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43003Service() {
        this(new Idea43003Config());
    }

    public Idea43003Service(Idea43003Config config) {
        this.config = config != null ? config : new Idea43003Config();
