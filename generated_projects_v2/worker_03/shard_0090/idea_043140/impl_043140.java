...
@Data
public class Idea43140Config {
    private String name = "idea_043140";
 ...
 */
@Slf4j
public class Idea43140Service {
    private static final int IDEA_ID = 43140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43140Service() {
        this(new Idea43140Config());
    }

    public Idea43140Service(Idea43140Config config) {
        this.config = config != null ? config : new Idea43140Config();
