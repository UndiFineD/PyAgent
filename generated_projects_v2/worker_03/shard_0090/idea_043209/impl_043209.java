...
@Data
public class Idea43209Config {
    private String name = "idea_043209";
 ...
 */
@Slf4j
public class Idea43209Service {
    private static final int IDEA_ID = 43209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43209Service() {
        this(new Idea43209Config());
    }

    public Idea43209Service(Idea43209Config config) {
        this.config = config != null ? config : new Idea43209Config();
