...
@Data
public class Idea42837Config {
    private String name = "idea_042837";
 ...
 */
@Slf4j
public class Idea42837Service {
    private static final int IDEA_ID = 42837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42837Service() {
        this(new Idea42837Config());
    }

    public Idea42837Service(Idea42837Config config) {
        this.config = config != null ? config : new Idea42837Config();
