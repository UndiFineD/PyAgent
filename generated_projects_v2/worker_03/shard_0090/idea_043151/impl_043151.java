...
@Data
public class Idea43151Config {
    private String name = "idea_043151";
 ...
 */
@Slf4j
public class Idea43151Service {
    private static final int IDEA_ID = 43151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43151Service() {
        this(new Idea43151Config());
    }

    public Idea43151Service(Idea43151Config config) {
        this.config = config != null ? config : new Idea43151Config();
