...
@Data
public class Idea43218Config {
    private String name = "idea_043218";
 ...
 */
@Slf4j
public class Idea43218Service {
    private static final int IDEA_ID = 43218;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43218Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43218Service() {
        this(new Idea43218Config());
    }

    public Idea43218Service(Idea43218Config config) {
        this.config = config != null ? config : new Idea43218Config();
