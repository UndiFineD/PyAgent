...
@Data
public class Idea43201Config {
    private String name = "idea_043201";
 ...
 */
@Slf4j
public class Idea43201Service {
    private static final int IDEA_ID = 43201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43201Service() {
        this(new Idea43201Config());
    }

    public Idea43201Service(Idea43201Config config) {
        this.config = config != null ? config : new Idea43201Config();
