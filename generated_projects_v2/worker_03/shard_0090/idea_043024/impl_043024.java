...
@Data
public class Idea43024Config {
    private String name = "idea_043024";
 ...
 */
@Slf4j
public class Idea43024Service {
    private static final int IDEA_ID = 43024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43024Service() {
        this(new Idea43024Config());
    }

    public Idea43024Service(Idea43024Config config) {
        this.config = config != null ? config : new Idea43024Config();
