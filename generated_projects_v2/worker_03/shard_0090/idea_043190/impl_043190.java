...
@Data
public class Idea43190Config {
    private String name = "idea_043190";
 ...
 */
@Slf4j
public class Idea43190Service {
    private static final int IDEA_ID = 43190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43190Service() {
        this(new Idea43190Config());
    }

    public Idea43190Service(Idea43190Config config) {
        this.config = config != null ? config : new Idea43190Config();
