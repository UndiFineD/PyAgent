...
@Data
public class Idea42937Config {
    private String name = "idea_042937";
 ...
 */
@Slf4j
public class Idea42937Service {
    private static final int IDEA_ID = 42937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42937Service() {
        this(new Idea42937Config());
    }

    public Idea42937Service(Idea42937Config config) {
        this.config = config != null ? config : new Idea42937Config();
