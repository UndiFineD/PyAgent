...
@Data
public class Idea43204Config {
    private String name = "idea_043204";
 ...
 */
@Slf4j
public class Idea43204Service {
    private static final int IDEA_ID = 43204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43204Service() {
        this(new Idea43204Config());
    }

    public Idea43204Service(Idea43204Config config) {
        this.config = config != null ? config : new Idea43204Config();
