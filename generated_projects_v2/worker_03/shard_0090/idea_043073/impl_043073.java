...
@Data
public class Idea43073Config {
    private String name = "idea_043073";
 ...
 */
@Slf4j
public class Idea43073Service {
    private static final int IDEA_ID = 43073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43073Service() {
        this(new Idea43073Config());
    }

    public Idea43073Service(Idea43073Config config) {
        this.config = config != null ? config : new Idea43073Config();
