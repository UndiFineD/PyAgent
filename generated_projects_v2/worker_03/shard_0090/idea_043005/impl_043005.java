...
@Data
public class Idea43005Config {
    private String name = "idea_043005";
 ...
 */
@Slf4j
public class Idea43005Service {
    private static final int IDEA_ID = 43005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43005Service() {
        this(new Idea43005Config());
    }

    public Idea43005Service(Idea43005Config config) {
        this.config = config != null ? config : new Idea43005Config();
