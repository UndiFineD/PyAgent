...
@Data
public class Idea43104Config {
    private String name = "idea_043104";
 ...
 */
@Slf4j
public class Idea43104Service {
    private static final int IDEA_ID = 43104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43104Service() {
        this(new Idea43104Config());
    }

    public Idea43104Service(Idea43104Config config) {
        this.config = config != null ? config : new Idea43104Config();
