...
@Data
public class Idea42991Config {
    private String name = "idea_042991";
 ...
 */
@Slf4j
public class Idea42991Service {
    private static final int IDEA_ID = 42991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42991Service() {
        this(new Idea42991Config());
    }

    public Idea42991Service(Idea42991Config config) {
        this.config = config != null ? config : new Idea42991Config();
