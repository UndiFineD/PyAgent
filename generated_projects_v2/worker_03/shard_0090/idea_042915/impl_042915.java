...
@Data
public class Idea42915Config {
    private String name = "idea_042915";
 ...
 */
@Slf4j
public class Idea42915Service {
    private static final int IDEA_ID = 42915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42915Service() {
        this(new Idea42915Config());
    }

    public Idea42915Service(Idea42915Config config) {
        this.config = config != null ? config : new Idea42915Config();
