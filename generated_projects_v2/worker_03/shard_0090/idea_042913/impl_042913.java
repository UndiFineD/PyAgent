...
@Data
public class Idea42913Config {
    private String name = "idea_042913";
 ...
 */
@Slf4j
public class Idea42913Service {
    private static final int IDEA_ID = 42913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42913Service() {
        this(new Idea42913Config());
    }

    public Idea42913Service(Idea42913Config config) {
        this.config = config != null ? config : new Idea42913Config();
