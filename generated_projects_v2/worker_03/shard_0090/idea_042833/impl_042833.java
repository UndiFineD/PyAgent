...
@Data
public class Idea42833Config {
    private String name = "idea_042833";
 ...
 */
@Slf4j
public class Idea42833Service {
    private static final int IDEA_ID = 42833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42833Service() {
        this(new Idea42833Config());
    }

    public Idea42833Service(Idea42833Config config) {
        this.config = config != null ? config : new Idea42833Config();
