...
@Data
public class Idea42845Config {
    private String name = "idea_042845";
 ...
 */
@Slf4j
public class Idea42845Service {
    private static final int IDEA_ID = 42845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42845Service() {
        this(new Idea42845Config());
    }

    public Idea42845Service(Idea42845Config config) {
        this.config = config != null ? config : new Idea42845Config();
