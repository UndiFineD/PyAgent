...
@Data
public class Idea43100Config {
    private String name = "idea_043100";
 ...
 */
@Slf4j
public class Idea43100Service {
    private static final int IDEA_ID = 43100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43100Service() {
        this(new Idea43100Config());
    }

    public Idea43100Service(Idea43100Config config) {
        this.config = config != null ? config : new Idea43100Config();
