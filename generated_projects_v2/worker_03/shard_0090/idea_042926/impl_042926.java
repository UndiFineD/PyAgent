...
@Data
public class Idea42926Config {
    private String name = "idea_042926";
 ...
 */
@Slf4j
public class Idea42926Service {
    private static final int IDEA_ID = 42926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42926Service() {
        this(new Idea42926Config());
    }

    public Idea42926Service(Idea42926Config config) {
        this.config = config != null ? config : new Idea42926Config();
