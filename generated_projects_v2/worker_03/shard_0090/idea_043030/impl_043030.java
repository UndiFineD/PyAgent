...
@Data
public class Idea43030Config {
    private String name = "idea_043030";
 ...
 */
@Slf4j
public class Idea43030Service {
    private static final int IDEA_ID = 43030;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43030Service() {
        this(new Idea43030Config());
    }

    public Idea43030Service(Idea43030Config config) {
        this.config = config != null ? config : new Idea43030Config();
