...
@Data
public class Idea42797Config {
    private String name = "idea_042797";
 ...
 */
@Slf4j
public class Idea42797Service {
    private static final int IDEA_ID = 42797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42797Service() {
        this(new Idea42797Config());
    }

    public Idea42797Service(Idea42797Config config) {
        this.config = config != null ? config : new Idea42797Config();
