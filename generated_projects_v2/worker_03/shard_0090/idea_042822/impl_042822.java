...
@Data
public class Idea42822Config {
    private String name = "idea_042822";
 ...
 */
@Slf4j
public class Idea42822Service {
    private static final int IDEA_ID = 42822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42822Service() {
        this(new Idea42822Config());
    }

    public Idea42822Service(Idea42822Config config) {
        this.config = config != null ? config : new Idea42822Config();
