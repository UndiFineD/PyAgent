...
@Data
public class Idea42835Config {
    private String name = "idea_042835";
 ...
 */
@Slf4j
public class Idea42835Service {
    private static final int IDEA_ID = 42835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42835Service() {
        this(new Idea42835Config());
    }

    public Idea42835Service(Idea42835Config config) {
        this.config = config != null ? config : new Idea42835Config();
