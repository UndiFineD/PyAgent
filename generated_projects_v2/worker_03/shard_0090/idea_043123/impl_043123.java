...
@Data
public class Idea43123Config {
    private String name = "idea_043123";
 ...
 */
@Slf4j
public class Idea43123Service {
    private static final int IDEA_ID = 43123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43123Service() {
        this(new Idea43123Config());
    }

    public Idea43123Service(Idea43123Config config) {
        this.config = config != null ? config : new Idea43123Config();
