...
@Data
public class Idea43061Config {
    private String name = "idea_043061";
 ...
 */
@Slf4j
public class Idea43061Service {
    private static final int IDEA_ID = 43061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43061Service() {
        this(new Idea43061Config());
    }

    public Idea43061Service(Idea43061Config config) {
        this.config = config != null ? config : new Idea43061Config();
