...
@Data
public class Idea43221Config {
    private String name = "idea_043221";
 ...
 */
@Slf4j
public class Idea43221Service {
    private static final int IDEA_ID = 43221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43221Service() {
        this(new Idea43221Config());
    }

    public Idea43221Service(Idea43221Config config) {
        this.config = config != null ? config : new Idea43221Config();
