...
@Data
public class Idea43212Config {
    private String name = "idea_043212";
 ...
 */
@Slf4j
public class Idea43212Service {
    private static final int IDEA_ID = 43212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43212Service() {
        this(new Idea43212Config());
    }

    public Idea43212Service(Idea43212Config config) {
        this.config = config != null ? config : new Idea43212Config();
