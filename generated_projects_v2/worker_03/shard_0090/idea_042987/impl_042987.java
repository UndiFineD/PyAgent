...
@Data
public class Idea42987Config {
    private String name = "idea_042987";
 ...
 */
@Slf4j
public class Idea42987Service {
    private static final int IDEA_ID = 42987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42987Service() {
        this(new Idea42987Config());
    }

    public Idea42987Service(Idea42987Config config) {
        this.config = config != null ? config : new Idea42987Config();
