...
@Data
public class Idea42762Config {
    private String name = "idea_042762";
 ...
 */
@Slf4j
public class Idea42762Service {
    private static final int IDEA_ID = 42762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42762Service() {
        this(new Idea42762Config());
    }

    public Idea42762Service(Idea42762Config config) {
        this.config = config != null ? config : new Idea42762Config();
