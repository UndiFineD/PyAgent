...
@Data
public class Idea42941Config {
    private String name = "idea_042941";
 ...
 */
@Slf4j
public class Idea42941Service {
    private static final int IDEA_ID = 42941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42941Service() {
        this(new Idea42941Config());
    }

    public Idea42941Service(Idea42941Config config) {
        this.config = config != null ? config : new Idea42941Config();
