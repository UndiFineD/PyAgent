...
@Data
public class Idea42802Config {
    private String name = "idea_042802";
 ...
 */
@Slf4j
public class Idea42802Service {
    private static final int IDEA_ID = 42802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42802Service() {
        this(new Idea42802Config());
    }

    public Idea42802Service(Idea42802Config config) {
        this.config = config != null ? config : new Idea42802Config();
