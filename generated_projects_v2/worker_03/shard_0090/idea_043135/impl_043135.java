...
@Data
public class Idea43135Config {
    private String name = "idea_043135";
 ...
 */
@Slf4j
public class Idea43135Service {
    private static final int IDEA_ID = 43135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43135Service() {
        this(new Idea43135Config());
    }

    public Idea43135Service(Idea43135Config config) {
        this.config = config != null ? config : new Idea43135Config();
