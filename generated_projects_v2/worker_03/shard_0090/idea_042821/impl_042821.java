...
@Data
public class Idea42821Config {
    private String name = "idea_042821";
 ...
 */
@Slf4j
public class Idea42821Service {
    private static final int IDEA_ID = 42821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42821Service() {
        this(new Idea42821Config());
    }

    public Idea42821Service(Idea42821Config config) {
        this.config = config != null ? config : new Idea42821Config();
