...
@Data
public class Idea42887Config {
    private String name = "idea_042887";
 ...
 */
@Slf4j
public class Idea42887Service {
    private static final int IDEA_ID = 42887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42887Service() {
        this(new Idea42887Config());
    }

    public Idea42887Service(Idea42887Config config) {
        this.config = config != null ? config : new Idea42887Config();
