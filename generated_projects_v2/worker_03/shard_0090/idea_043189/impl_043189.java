...
@Data
public class Idea43189Config {
    private String name = "idea_043189";
 ...
 */
@Slf4j
public class Idea43189Service {
    private static final int IDEA_ID = 43189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43189Service() {
        this(new Idea43189Config());
    }

    public Idea43189Service(Idea43189Config config) {
        this.config = config != null ? config : new Idea43189Config();
