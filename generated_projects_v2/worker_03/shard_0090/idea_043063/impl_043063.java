...
@Data
public class Idea43063Config {
    private String name = "idea_043063";
 ...
 */
@Slf4j
public class Idea43063Service {
    private static final int IDEA_ID = 43063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43063Service() {
        this(new Idea43063Config());
    }

    public Idea43063Service(Idea43063Config config) {
        this.config = config != null ? config : new Idea43063Config();
