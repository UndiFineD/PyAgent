...
@Data
public class Idea42838Config {
    private String name = "idea_042838";
 ...
 */
@Slf4j
public class Idea42838Service {
    private static final int IDEA_ID = 42838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42838Service() {
        this(new Idea42838Config());
    }

    public Idea42838Service(Idea42838Config config) {
        this.config = config != null ? config : new Idea42838Config();
