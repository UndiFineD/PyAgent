...
@Data
public class Idea42984Config {
    private String name = "idea_042984";
 ...
 */
@Slf4j
public class Idea42984Service {
    private static final int IDEA_ID = 42984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42984Service() {
        this(new Idea42984Config());
    }

    public Idea42984Service(Idea42984Config config) {
        this.config = config != null ? config : new Idea42984Config();
