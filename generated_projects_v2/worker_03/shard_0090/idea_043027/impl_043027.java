...
@Data
public class Idea43027Config {
    private String name = "idea_043027";
 ...
 */
@Slf4j
public class Idea43027Service {
    private static final int IDEA_ID = 43027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43027Service() {
        this(new Idea43027Config());
    }

    public Idea43027Service(Idea43027Config config) {
        this.config = config != null ? config : new Idea43027Config();
