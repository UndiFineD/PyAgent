...
@Data
public class Idea42872Config {
    private String name = "idea_042872";
 ...
 */
@Slf4j
public class Idea42872Service {
    private static final int IDEA_ID = 42872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42872Service() {
        this(new Idea42872Config());
    }

    public Idea42872Service(Idea42872Config config) {
        this.config = config != null ? config : new Idea42872Config();
