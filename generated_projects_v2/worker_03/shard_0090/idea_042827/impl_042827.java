...
@Data
public class Idea42827Config {
    private String name = "idea_042827";
 ...
 */
@Slf4j
public class Idea42827Service {
    private static final int IDEA_ID = 42827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42827Service() {
        this(new Idea42827Config());
    }

    public Idea42827Service(Idea42827Config config) {
        this.config = config != null ? config : new Idea42827Config();
