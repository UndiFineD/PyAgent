...
@Data
public class Idea42778Config {
    private String name = "idea_042778";
 ...
 */
@Slf4j
public class Idea42778Service {
    private static final int IDEA_ID = 42778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42778Service() {
        this(new Idea42778Config());
    }

    public Idea42778Service(Idea42778Config config) {
        this.config = config != null ? config : new Idea42778Config();
