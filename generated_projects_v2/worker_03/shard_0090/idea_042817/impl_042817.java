...
@Data
public class Idea42817Config {
    private String name = "idea_042817";
 ...
 */
@Slf4j
public class Idea42817Service {
    private static final int IDEA_ID = 42817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42817Service() {
        this(new Idea42817Config());
    }

    public Idea42817Service(Idea42817Config config) {
        this.config = config != null ? config : new Idea42817Config();
