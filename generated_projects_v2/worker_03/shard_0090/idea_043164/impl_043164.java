...
@Data
public class Idea43164Config {
    private String name = "idea_043164";
 ...
 */
@Slf4j
public class Idea43164Service {
    private static final int IDEA_ID = 43164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43164Service() {
        this(new Idea43164Config());
    }

    public Idea43164Service(Idea43164Config config) {
        this.config = config != null ? config : new Idea43164Config();
