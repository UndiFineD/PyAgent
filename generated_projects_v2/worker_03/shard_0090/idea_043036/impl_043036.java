...
@Data
public class Idea43036Config {
    private String name = "idea_043036";
 ...
 */
@Slf4j
public class Idea43036Service {
    private static final int IDEA_ID = 43036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43036Service() {
        this(new Idea43036Config());
    }

    public Idea43036Service(Idea43036Config config) {
        this.config = config != null ? config : new Idea43036Config();
