...
@Data
public class Idea43021Config {
    private String name = "idea_043021";
 ...
 */
@Slf4j
public class Idea43021Service {
    private static final int IDEA_ID = 43021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43021Service() {
        this(new Idea43021Config());
    }

    public Idea43021Service(Idea43021Config config) {
        this.config = config != null ? config : new Idea43021Config();
