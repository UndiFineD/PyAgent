...
@Data
public class Idea42961Config {
    private String name = "idea_042961";
 ...
 */
@Slf4j
public class Idea42961Service {
    private static final int IDEA_ID = 42961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42961Service() {
        this(new Idea42961Config());
    }

    public Idea42961Service(Idea42961Config config) {
        this.config = config != null ? config : new Idea42961Config();
