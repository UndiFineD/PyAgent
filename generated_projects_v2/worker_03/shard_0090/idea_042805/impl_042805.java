...
@Data
public class Idea42805Config {
    private String name = "idea_042805";
 ...
 */
@Slf4j
public class Idea42805Service {
    private static final int IDEA_ID = 42805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42805Service() {
        this(new Idea42805Config());
    }

    public Idea42805Service(Idea42805Config config) {
        this.config = config != null ? config : new Idea42805Config();
