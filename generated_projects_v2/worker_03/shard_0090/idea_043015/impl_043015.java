...
@Data
public class Idea43015Config {
    private String name = "idea_043015";
 ...
 */
@Slf4j
public class Idea43015Service {
    private static final int IDEA_ID = 43015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43015Service() {
        this(new Idea43015Config());
    }

    public Idea43015Service(Idea43015Config config) {
        this.config = config != null ? config : new Idea43015Config();
