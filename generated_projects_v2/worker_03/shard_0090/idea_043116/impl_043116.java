...
@Data
public class Idea43116Config {
    private String name = "idea_043116";
 ...
 */
@Slf4j
public class Idea43116Service {
    private static final int IDEA_ID = 43116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43116Service() {
        this(new Idea43116Config());
    }

    public Idea43116Service(Idea43116Config config) {
        this.config = config != null ? config : new Idea43116Config();
