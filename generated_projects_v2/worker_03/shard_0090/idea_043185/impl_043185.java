...
@Data
public class Idea43185Config {
    private String name = "idea_043185";
 ...
 */
@Slf4j
public class Idea43185Service {
    private static final int IDEA_ID = 43185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43185Service() {
        this(new Idea43185Config());
    }

    public Idea43185Service(Idea43185Config config) {
        this.config = config != null ? config : new Idea43185Config();
