...
@Data
public class Idea42861Config {
    private String name = "idea_042861";
 ...
 */
@Slf4j
public class Idea42861Service {
    private static final int IDEA_ID = 42861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42861Service() {
        this(new Idea42861Config());
    }

    public Idea42861Service(Idea42861Config config) {
        this.config = config != null ? config : new Idea42861Config();
