...
@Data
public class Idea43141Config {
    private String name = "idea_043141";
 ...
 */
@Slf4j
public class Idea43141Service {
    private static final int IDEA_ID = 43141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43141Service() {
        this(new Idea43141Config());
    }

    public Idea43141Service(Idea43141Config config) {
        this.config = config != null ? config : new Idea43141Config();
