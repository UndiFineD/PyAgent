...
@Data
public class Idea43028Config {
    private String name = "idea_043028";
 ...
 */
@Slf4j
public class Idea43028Service {
    private static final int IDEA_ID = 43028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43028Service() {
        this(new Idea43028Config());
    }

    public Idea43028Service(Idea43028Config config) {
        this.config = config != null ? config : new Idea43028Config();
