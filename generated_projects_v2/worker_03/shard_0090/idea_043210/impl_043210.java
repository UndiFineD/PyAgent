...
@Data
public class Idea43210Config {
    private String name = "idea_043210";
 ...
 */
@Slf4j
public class Idea43210Service {
    private static final int IDEA_ID = 43210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43210Service() {
        this(new Idea43210Config());
    }

    public Idea43210Service(Idea43210Config config) {
        this.config = config != null ? config : new Idea43210Config();
