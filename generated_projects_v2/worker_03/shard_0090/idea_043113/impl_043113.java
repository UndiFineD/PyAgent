...
@Data
public class Idea43113Config {
    private String name = "idea_043113";
 ...
 */
@Slf4j
public class Idea43113Service {
    private static final int IDEA_ID = 43113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43113Service() {
        this(new Idea43113Config());
    }

    public Idea43113Service(Idea43113Config config) {
        this.config = config != null ? config : new Idea43113Config();
