...
@Data
public class Idea42950Config {
    private String name = "idea_042950";
 ...
 */
@Slf4j
public class Idea42950Service {
    private static final int IDEA_ID = 42950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42950Service() {
        this(new Idea42950Config());
    }

    public Idea42950Service(Idea42950Config config) {
        this.config = config != null ? config : new Idea42950Config();
