...
@Data
public class Idea43111Config {
    private String name = "idea_043111";
 ...
 */
@Slf4j
public class Idea43111Service {
    private static final int IDEA_ID = 43111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43111Service() {
        this(new Idea43111Config());
    }

    public Idea43111Service(Idea43111Config config) {
        this.config = config != null ? config : new Idea43111Config();
