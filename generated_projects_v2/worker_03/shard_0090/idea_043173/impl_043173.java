...
@Data
public class Idea43173Config {
    private String name = "idea_043173";
 ...
 */
@Slf4j
public class Idea43173Service {
    private static final int IDEA_ID = 43173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43173Service() {
        this(new Idea43173Config());
    }

    public Idea43173Service(Idea43173Config config) {
        this.config = config != null ? config : new Idea43173Config();
