...
@Data
public class Idea42825Config {
    private String name = "idea_042825";
 ...
 */
@Slf4j
public class Idea42825Service {
    private static final int IDEA_ID = 42825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42825Service() {
        this(new Idea42825Config());
    }

    public Idea42825Service(Idea42825Config config) {
        this.config = config != null ? config : new Idea42825Config();
