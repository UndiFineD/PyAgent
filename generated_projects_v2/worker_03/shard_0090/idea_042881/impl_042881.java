...
@Data
public class Idea42881Config {
    private String name = "idea_042881";
 ...
 */
@Slf4j
public class Idea42881Service {
    private static final int IDEA_ID = 42881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42881Service() {
        this(new Idea42881Config());
    }

    public Idea42881Service(Idea42881Config config) {
        this.config = config != null ? config : new Idea42881Config();
