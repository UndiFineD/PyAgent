...
@Data
public class Idea42951Config {
    private String name = "idea_042951";
 ...
 */
@Slf4j
public class Idea42951Service {
    private static final int IDEA_ID = 42951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42951Service() {
        this(new Idea42951Config());
    }

    public Idea42951Service(Idea42951Config config) {
        this.config = config != null ? config : new Idea42951Config();
