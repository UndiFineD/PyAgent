...
@Data
public class Idea43146Config {
    private String name = "idea_043146";
 ...
 */
@Slf4j
public class Idea43146Service {
    private static final int IDEA_ID = 43146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43146Service() {
        this(new Idea43146Config());
    }

    public Idea43146Service(Idea43146Config config) {
        this.config = config != null ? config : new Idea43146Config();
