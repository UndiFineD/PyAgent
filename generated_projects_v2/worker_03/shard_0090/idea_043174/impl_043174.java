...
@Data
public class Idea43174Config {
    private String name = "idea_043174";
 ...
 */
@Slf4j
public class Idea43174Service {
    private static final int IDEA_ID = 43174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43174Service() {
        this(new Idea43174Config());
    }

    public Idea43174Service(Idea43174Config config) {
        this.config = config != null ? config : new Idea43174Config();
