...
@Data
public class Idea42828Config {
    private String name = "idea_042828";
 ...
 */
@Slf4j
public class Idea42828Service {
    private static final int IDEA_ID = 42828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42828Service() {
        this(new Idea42828Config());
    }

    public Idea42828Service(Idea42828Config config) {
        this.config = config != null ? config : new Idea42828Config();
