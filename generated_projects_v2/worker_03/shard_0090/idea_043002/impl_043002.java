...
@Data
public class Idea43002Config {
    private String name = "idea_043002";
 ...
 */
@Slf4j
public class Idea43002Service {
    private static final int IDEA_ID = 43002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43002Service() {
        this(new Idea43002Config());
    }

    public Idea43002Service(Idea43002Config config) {
        this.config = config != null ? config : new Idea43002Config();
