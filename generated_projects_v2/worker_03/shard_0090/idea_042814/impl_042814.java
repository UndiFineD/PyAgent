...
@Data
public class Idea42814Config {
    private String name = "idea_042814";
 ...
 */
@Slf4j
public class Idea42814Service {
    private static final int IDEA_ID = 42814;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42814Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42814Service() {
        this(new Idea42814Config());
    }

    public Idea42814Service(Idea42814Config config) {
        this.config = config != null ? config : new Idea42814Config();
