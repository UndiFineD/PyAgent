...
@Data
public class Idea42946Config {
    private String name = "idea_042946";
 ...
 */
@Slf4j
public class Idea42946Service {
    private static final int IDEA_ID = 42946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42946Service() {
        this(new Idea42946Config());
    }

    public Idea42946Service(Idea42946Config config) {
        this.config = config != null ? config : new Idea42946Config();
