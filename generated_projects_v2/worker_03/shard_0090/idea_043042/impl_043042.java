...
@Data
public class Idea43042Config {
    private String name = "idea_043042";
 ...
 */
@Slf4j
public class Idea43042Service {
    private static final int IDEA_ID = 43042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43042Service() {
        this(new Idea43042Config());
    }

    public Idea43042Service(Idea43042Config config) {
        this.config = config != null ? config : new Idea43042Config();
