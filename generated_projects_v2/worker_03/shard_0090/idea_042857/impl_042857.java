...
@Data
public class Idea42857Config {
    private String name = "idea_042857";
 ...
 */
@Slf4j
public class Idea42857Service {
    private static final int IDEA_ID = 42857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42857Service() {
        this(new Idea42857Config());
    }

    public Idea42857Service(Idea42857Config config) {
        this.config = config != null ? config : new Idea42857Config();
