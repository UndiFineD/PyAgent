...
@Data
public class Idea43158Config {
    private String name = "idea_043158";
 ...
 */
@Slf4j
public class Idea43158Service {
    private static final int IDEA_ID = 43158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43158Service() {
        this(new Idea43158Config());
    }

    public Idea43158Service(Idea43158Config config) {
        this.config = config != null ? config : new Idea43158Config();
