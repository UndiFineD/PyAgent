...
@Data
public class Idea42760Config {
    private String name = "idea_042760";
 ...
 */
@Slf4j
public class Idea42760Service {
    private static final int IDEA_ID = 42760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42760Service() {
        this(new Idea42760Config());
    }

    public Idea42760Service(Idea42760Config config) {
        this.config = config != null ? config : new Idea42760Config();
