...
@Data
public class Idea43120Config {
    private String name = "idea_043120";
 ...
 */
@Slf4j
public class Idea43120Service {
    private static final int IDEA_ID = 43120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43120Service() {
        this(new Idea43120Config());
    }

    public Idea43120Service(Idea43120Config config) {
        this.config = config != null ? config : new Idea43120Config();
