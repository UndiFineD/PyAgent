...
@Data
public class Idea42972Config {
    private String name = "idea_042972";
 ...
 */
@Slf4j
public class Idea42972Service {
    private static final int IDEA_ID = 42972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42972Service() {
        this(new Idea42972Config());
    }

    public Idea42972Service(Idea42972Config config) {
        this.config = config != null ? config : new Idea42972Config();
