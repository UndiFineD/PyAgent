...
@Data
public class Idea43214Config {
    private String name = "idea_043214";
 ...
 */
@Slf4j
public class Idea43214Service {
    private static final int IDEA_ID = 43214;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43214Service() {
        this(new Idea43214Config());
    }

    public Idea43214Service(Idea43214Config config) {
        this.config = config != null ? config : new Idea43214Config();
