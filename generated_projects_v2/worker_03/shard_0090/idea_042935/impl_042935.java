...
@Data
public class Idea42935Config {
    private String name = "idea_042935";
 ...
 */
@Slf4j
public class Idea42935Service {
    private static final int IDEA_ID = 42935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42935Service() {
        this(new Idea42935Config());
    }

    public Idea42935Service(Idea42935Config config) {
        this.config = config != null ? config : new Idea42935Config();
