...
@Data
public class Idea42767Config {
    private String name = "idea_042767";
 ...
 */
@Slf4j
public class Idea42767Service {
    private static final int IDEA_ID = 42767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42767Service() {
        this(new Idea42767Config());
    }

    public Idea42767Service(Idea42767Config config) {
        this.config = config != null ? config : new Idea42767Config();
