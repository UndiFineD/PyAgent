...
@Data
public class Idea42812Config {
    private String name = "idea_042812";
 ...
 */
@Slf4j
public class Idea42812Service {
    private static final int IDEA_ID = 42812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42812Service() {
        this(new Idea42812Config());
    }

    public Idea42812Service(Idea42812Config config) {
        this.config = config != null ? config : new Idea42812Config();
