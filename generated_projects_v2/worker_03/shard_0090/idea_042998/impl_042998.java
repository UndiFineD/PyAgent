...
@Data
public class Idea42998Config {
    private String name = "idea_042998";
 ...
 */
@Slf4j
public class Idea42998Service {
    private static final int IDEA_ID = 42998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42998Service() {
        this(new Idea42998Config());
    }

    public Idea42998Service(Idea42998Config config) {
        this.config = config != null ? config : new Idea42998Config();
