...
@Data
public class Idea42810Config {
    private String name = "idea_042810";
 ...
 */
@Slf4j
public class Idea42810Service {
    private static final int IDEA_ID = 42810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42810Service() {
        this(new Idea42810Config());
    }

    public Idea42810Service(Idea42810Config config) {
        this.config = config != null ? config : new Idea42810Config();
