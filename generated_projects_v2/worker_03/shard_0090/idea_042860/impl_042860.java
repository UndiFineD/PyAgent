...
@Data
public class Idea42860Config {
    private String name = "idea_042860";
 ...
 */
@Slf4j
public class Idea42860Service {
    private static final int IDEA_ID = 42860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42860Service() {
        this(new Idea42860Config());
    }

    public Idea42860Service(Idea42860Config config) {
        this.config = config != null ? config : new Idea42860Config();
