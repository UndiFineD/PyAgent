...
@Data
public class Idea43093Config {
    private String name = "idea_043093";
 ...
 */
@Slf4j
public class Idea43093Service {
    private static final int IDEA_ID = 43093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43093Service() {
        this(new Idea43093Config());
    }

    public Idea43093Service(Idea43093Config config) {
        this.config = config != null ? config : new Idea43093Config();
