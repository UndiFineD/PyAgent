...
@Data
public class Idea43217Config {
    private String name = "idea_043217";
 ...
 */
@Slf4j
public class Idea43217Service {
    private static final int IDEA_ID = 43217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43217Service() {
        this(new Idea43217Config());
    }

    public Idea43217Service(Idea43217Config config) {
        this.config = config != null ? config : new Idea43217Config();
