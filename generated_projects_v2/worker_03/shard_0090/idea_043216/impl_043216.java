...
@Data
public class Idea43216Config {
    private String name = "idea_043216";
 ...
 */
@Slf4j
public class Idea43216Service {
    private static final int IDEA_ID = 43216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43216Service() {
        this(new Idea43216Config());
    }

    public Idea43216Service(Idea43216Config config) {
        this.config = config != null ? config : new Idea43216Config();
