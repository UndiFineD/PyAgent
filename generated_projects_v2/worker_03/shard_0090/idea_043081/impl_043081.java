...
@Data
public class Idea43081Config {
    private String name = "idea_043081";
 ...
 */
@Slf4j
public class Idea43081Service {
    private static final int IDEA_ID = 43081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43081Service() {
        this(new Idea43081Config());
    }

    public Idea43081Service(Idea43081Config config) {
        this.config = config != null ? config : new Idea43081Config();
