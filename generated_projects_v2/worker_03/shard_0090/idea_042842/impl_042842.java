...
@Data
public class Idea42842Config {
    private String name = "idea_042842";
 ...
 */
@Slf4j
public class Idea42842Service {
    private static final int IDEA_ID = 42842;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42842Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42842Service() {
        this(new Idea42842Config());
    }

    public Idea42842Service(Idea42842Config config) {
        this.config = config != null ? config : new Idea42842Config();
