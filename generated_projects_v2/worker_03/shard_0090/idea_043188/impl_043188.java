...
@Data
public class Idea43188Config {
    private String name = "idea_043188";
 ...
 */
@Slf4j
public class Idea43188Service {
    private static final int IDEA_ID = 43188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43188Service() {
        this(new Idea43188Config());
    }

    public Idea43188Service(Idea43188Config config) {
        this.config = config != null ? config : new Idea43188Config();
