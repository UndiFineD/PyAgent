...
@Data
public class Idea43078Config {
    private String name = "idea_043078";
 ...
 */
@Slf4j
public class Idea43078Service {
    private static final int IDEA_ID = 43078;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43078Service() {
        this(new Idea43078Config());
    }

    public Idea43078Service(Idea43078Config config) {
        this.config = config != null ? config : new Idea43078Config();
