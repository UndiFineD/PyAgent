...
@Data
public class Idea43147Config {
    private String name = "idea_043147";
 ...
 */
@Slf4j
public class Idea43147Service {
    private static final int IDEA_ID = 43147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43147Service() {
        this(new Idea43147Config());
    }

    public Idea43147Service(Idea43147Config config) {
        this.config = config != null ? config : new Idea43147Config();
