...
@Data
public class Idea43026Config {
    private String name = "idea_043026";
 ...
 */
@Slf4j
public class Idea43026Service {
    private static final int IDEA_ID = 43026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43026Service() {
        this(new Idea43026Config());
    }

    public Idea43026Service(Idea43026Config config) {
        this.config = config != null ? config : new Idea43026Config();
