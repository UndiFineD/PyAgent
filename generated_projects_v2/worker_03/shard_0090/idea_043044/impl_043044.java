...
@Data
public class Idea43044Config {
    private String name = "idea_043044";
 ...
 */
@Slf4j
public class Idea43044Service {
    private static final int IDEA_ID = 43044;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43044Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43044Service() {
        this(new Idea43044Config());
    }

    public Idea43044Service(Idea43044Config config) {
        this.config = config != null ? config : new Idea43044Config();
