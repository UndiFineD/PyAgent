...
@Data
public class Idea43208Config {
    private String name = "idea_043208";
 ...
 */
@Slf4j
public class Idea43208Service {
    private static final int IDEA_ID = 43208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43208Service() {
        this(new Idea43208Config());
    }

    public Idea43208Service(Idea43208Config config) {
        this.config = config != null ? config : new Idea43208Config();
