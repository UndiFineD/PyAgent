...
@Data
public class Idea42782Config {
    private String name = "idea_042782";
 ...
 */
@Slf4j
public class Idea42782Service {
    private static final int IDEA_ID = 42782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42782Service() {
        this(new Idea42782Config());
    }

    public Idea42782Service(Idea42782Config config) {
        this.config = config != null ? config : new Idea42782Config();
