...
@Data
public class Idea42885Config {
    private String name = "idea_042885";
 ...
 */
@Slf4j
public class Idea42885Service {
    private static final int IDEA_ID = 42885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42885Service() {
        this(new Idea42885Config());
    }

    public Idea42885Service(Idea42885Config config) {
        this.config = config != null ? config : new Idea42885Config();
