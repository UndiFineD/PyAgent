...
@Data
public class Idea43031Config {
    private String name = "idea_043031";
 ...
 */
@Slf4j
public class Idea43031Service {
    private static final int IDEA_ID = 43031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43031Service() {
        this(new Idea43031Config());
    }

    public Idea43031Service(Idea43031Config config) {
        this.config = config != null ? config : new Idea43031Config();
