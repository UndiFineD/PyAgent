...
@Data
public class Idea43091Config {
    private String name = "idea_043091";
 ...
 */
@Slf4j
public class Idea43091Service {
    private static final int IDEA_ID = 43091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43091Service() {
        this(new Idea43091Config());
    }

    public Idea43091Service(Idea43091Config config) {
        this.config = config != null ? config : new Idea43091Config();
