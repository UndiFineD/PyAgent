...
@Data
public class Idea43121Config {
    private String name = "idea_043121";
 ...
 */
@Slf4j
public class Idea43121Service {
    private static final int IDEA_ID = 43121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43121Service() {
        this(new Idea43121Config());
    }

    public Idea43121Service(Idea43121Config config) {
        this.config = config != null ? config : new Idea43121Config();
