...
@Data
public class Idea43086Config {
    private String name = "idea_043086";
 ...
 */
@Slf4j
public class Idea43086Service {
    private static final int IDEA_ID = 43086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43086Service() {
        this(new Idea43086Config());
    }

    public Idea43086Service(Idea43086Config config) {
        this.config = config != null ? config : new Idea43086Config();
