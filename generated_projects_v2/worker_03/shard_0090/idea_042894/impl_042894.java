...
@Data
public class Idea42894Config {
    private String name = "idea_042894";
 ...
 */
@Slf4j
public class Idea42894Service {
    private static final int IDEA_ID = 42894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42894Service() {
        this(new Idea42894Config());
    }

    public Idea42894Service(Idea42894Config config) {
        this.config = config != null ? config : new Idea42894Config();
