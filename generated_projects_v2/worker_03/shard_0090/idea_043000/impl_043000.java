...
@Data
public class Idea43000Config {
    private String name = "idea_043000";
 ...
 */
@Slf4j
public class Idea43000Service {
    private static final int IDEA_ID = 43000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43000Service() {
        this(new Idea43000Config());
    }

    public Idea43000Service(Idea43000Config config) {
        this.config = config != null ? config : new Idea43000Config();
