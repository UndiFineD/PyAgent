...
@Data
public class Idea43103Config {
    private String name = "idea_043103";
 ...
 */
@Slf4j
public class Idea43103Service {
    private static final int IDEA_ID = 43103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43103Service() {
        this(new Idea43103Config());
    }

    public Idea43103Service(Idea43103Config config) {
        this.config = config != null ? config : new Idea43103Config();
