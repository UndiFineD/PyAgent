...
@Data
public class Idea42933Config {
    private String name = "idea_042933";
 ...
 */
@Slf4j
public class Idea42933Service {
    private static final int IDEA_ID = 42933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42933Service() {
        this(new Idea42933Config());
    }

    public Idea42933Service(Idea42933Config config) {
        this.config = config != null ? config : new Idea42933Config();
