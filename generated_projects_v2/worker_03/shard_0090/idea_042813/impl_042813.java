...
@Data
public class Idea42813Config {
    private String name = "idea_042813";
 ...
 */
@Slf4j
public class Idea42813Service {
    private static final int IDEA_ID = 42813;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42813Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42813Service() {
        this(new Idea42813Config());
    }

    public Idea42813Service(Idea42813Config config) {
        this.config = config != null ? config : new Idea42813Config();
