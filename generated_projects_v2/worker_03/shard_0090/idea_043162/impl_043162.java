...
@Data
public class Idea43162Config {
    private String name = "idea_043162";
 ...
 */
@Slf4j
public class Idea43162Service {
    private static final int IDEA_ID = 43162;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43162Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43162Service() {
        this(new Idea43162Config());
    }

    public Idea43162Service(Idea43162Config config) {
        this.config = config != null ? config : new Idea43162Config();
