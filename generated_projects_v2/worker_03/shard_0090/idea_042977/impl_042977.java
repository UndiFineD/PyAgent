...
@Data
public class Idea42977Config {
    private String name = "idea_042977";
 ...
 */
@Slf4j
public class Idea42977Service {
    private static final int IDEA_ID = 42977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42977Service() {
        this(new Idea42977Config());
    }

    public Idea42977Service(Idea42977Config config) {
        this.config = config != null ? config : new Idea42977Config();
