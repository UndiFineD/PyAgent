...
@Data
public class Idea42988Config {
    private String name = "idea_042988";
 ...
 */
@Slf4j
public class Idea42988Service {
    private static final int IDEA_ID = 42988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42988Service() {
        this(new Idea42988Config());
    }

    public Idea42988Service(Idea42988Config config) {
        this.config = config != null ? config : new Idea42988Config();
