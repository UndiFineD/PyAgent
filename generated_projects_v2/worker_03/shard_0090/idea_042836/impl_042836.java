...
@Data
public class Idea42836Config {
    private String name = "idea_042836";
 ...
 */
@Slf4j
public class Idea42836Service {
    private static final int IDEA_ID = 42836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42836Service() {
        this(new Idea42836Config());
    }

    public Idea42836Service(Idea42836Config config) {
        this.config = config != null ? config : new Idea42836Config();
