...
@Data
public class Idea43077Config {
    private String name = "idea_043077";
 ...
 */
@Slf4j
public class Idea43077Service {
    private static final int IDEA_ID = 43077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43077Service() {
        this(new Idea43077Config());
    }

    public Idea43077Service(Idea43077Config config) {
        this.config = config != null ? config : new Idea43077Config();
