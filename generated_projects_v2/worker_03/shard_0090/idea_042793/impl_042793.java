...
@Data
public class Idea42793Config {
    private String name = "idea_042793";
 ...
 */
@Slf4j
public class Idea42793Service {
    private static final int IDEA_ID = 42793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42793Service() {
        this(new Idea42793Config());
    }

    public Idea42793Service(Idea42793Config config) {
        this.config = config != null ? config : new Idea42793Config();
