...
@Data
public class Idea43206Config {
    private String name = "idea_043206";
 ...
 */
@Slf4j
public class Idea43206Service {
    private static final int IDEA_ID = 43206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43206Service() {
        this(new Idea43206Config());
    }

    public Idea43206Service(Idea43206Config config) {
        this.config = config != null ? config : new Idea43206Config();
