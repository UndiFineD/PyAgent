...
@Data
public class Idea42976Config {
    private String name = "idea_042976";
 ...
 */
@Slf4j
public class Idea42976Service {
    private static final int IDEA_ID = 42976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42976Service() {
        this(new Idea42976Config());
    }

    public Idea42976Service(Idea42976Config config) {
        this.config = config != null ? config : new Idea42976Config();
