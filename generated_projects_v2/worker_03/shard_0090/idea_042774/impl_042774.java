...
@Data
public class Idea42774Config {
    private String name = "idea_042774";
 ...
 */
@Slf4j
public class Idea42774Service {
    private static final int IDEA_ID = 42774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42774Service() {
        this(new Idea42774Config());
    }

    public Idea42774Service(Idea42774Config config) {
        this.config = config != null ? config : new Idea42774Config();
