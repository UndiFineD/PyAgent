...
@Data
public class Idea42755Config {
    private String name = "idea_042755";
 ...
 */
@Slf4j
public class Idea42755Service {
    private static final int IDEA_ID = 42755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42755Service() {
        this(new Idea42755Config());
    }

    public Idea42755Service(Idea42755Config config) {
        this.config = config != null ? config : new Idea42755Config();
