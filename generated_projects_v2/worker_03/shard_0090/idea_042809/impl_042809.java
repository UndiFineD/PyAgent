...
@Data
public class Idea42809Config {
    private String name = "idea_042809";
 ...
 */
@Slf4j
public class Idea42809Service {
    private static final int IDEA_ID = 42809;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42809Service() {
        this(new Idea42809Config());
    }

    public Idea42809Service(Idea42809Config config) {
        this.config = config != null ? config : new Idea42809Config();
