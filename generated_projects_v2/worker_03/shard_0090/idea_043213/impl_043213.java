...
@Data
public class Idea43213Config {
    private String name = "idea_043213";
 ...
 */
@Slf4j
public class Idea43213Service {
    private static final int IDEA_ID = 43213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43213Service() {
        this(new Idea43213Config());
    }

    public Idea43213Service(Idea43213Config config) {
        this.config = config != null ? config : new Idea43213Config();
