...
@Data
public class Idea42781Config {
    private String name = "idea_042781";
 ...
 */
@Slf4j
public class Idea42781Service {
    private static final int IDEA_ID = 42781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42781Service() {
        this(new Idea42781Config());
    }

    public Idea42781Service(Idea42781Config config) {
        this.config = config != null ? config : new Idea42781Config();
