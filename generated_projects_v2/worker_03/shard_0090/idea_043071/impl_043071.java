...
@Data
public class Idea43071Config {
    private String name = "idea_043071";
 ...
 */
@Slf4j
public class Idea43071Service {
    private static final int IDEA_ID = 43071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43071Service() {
        this(new Idea43071Config());
    }

    public Idea43071Service(Idea43071Config config) {
        this.config = config != null ? config : new Idea43071Config();
