...
@Data
public class Idea42820Config {
    private String name = "idea_042820";
 ...
 */
@Slf4j
public class Idea42820Service {
    private static final int IDEA_ID = 42820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42820Service() {
        this(new Idea42820Config());
    }

    public Idea42820Service(Idea42820Config config) {
        this.config = config != null ? config : new Idea42820Config();
