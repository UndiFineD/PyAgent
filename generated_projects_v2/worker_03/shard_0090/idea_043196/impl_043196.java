...
@Data
public class Idea43196Config {
    private String name = "idea_043196";
 ...
 */
@Slf4j
public class Idea43196Service {
    private static final int IDEA_ID = 43196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43196Service() {
        this(new Idea43196Config());
    }

    public Idea43196Service(Idea43196Config config) {
        this.config = config != null ? config : new Idea43196Config();
