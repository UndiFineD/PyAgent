...
@Data
public class Idea43004Config {
    private String name = "idea_043004";
 ...
 */
@Slf4j
public class Idea43004Service {
    private static final int IDEA_ID = 43004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43004Service() {
        this(new Idea43004Config());
    }

    public Idea43004Service(Idea43004Config config) {
        this.config = config != null ? config : new Idea43004Config();
