...
@Data
public class Idea43203Config {
    private String name = "idea_043203";
 ...
 */
@Slf4j
public class Idea43203Service {
    private static final int IDEA_ID = 43203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43203Service() {
        this(new Idea43203Config());
    }

    public Idea43203Service(Idea43203Config config) {
        this.config = config != null ? config : new Idea43203Config();
