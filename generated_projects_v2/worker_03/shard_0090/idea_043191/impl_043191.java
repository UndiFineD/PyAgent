...
@Data
public class Idea43191Config {
    private String name = "idea_043191";
 ...
 */
@Slf4j
public class Idea43191Service {
    private static final int IDEA_ID = 43191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43191Service() {
        this(new Idea43191Config());
    }

    public Idea43191Service(Idea43191Config config) {
        this.config = config != null ? config : new Idea43191Config();
