...
@Data
public class Idea42808Config {
    private String name = "idea_042808";
 ...
 */
@Slf4j
public class Idea42808Service {
    private static final int IDEA_ID = 42808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42808Service() {
        this(new Idea42808Config());
    }

    public Idea42808Service(Idea42808Config config) {
        this.config = config != null ? config : new Idea42808Config();
