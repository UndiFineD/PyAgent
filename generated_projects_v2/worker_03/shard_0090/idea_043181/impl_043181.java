...
@Data
public class Idea43181Config {
    private String name = "idea_043181";
 ...
 */
@Slf4j
public class Idea43181Service {
    private static final int IDEA_ID = 43181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43181Service() {
        this(new Idea43181Config());
    }

    public Idea43181Service(Idea43181Config config) {
        this.config = config != null ? config : new Idea43181Config();
