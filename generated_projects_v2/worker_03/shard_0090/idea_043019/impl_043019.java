...
@Data
public class Idea43019Config {
    private String name = "idea_043019";
 ...
 */
@Slf4j
public class Idea43019Service {
    private static final int IDEA_ID = 43019;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43019Service() {
        this(new Idea43019Config());
    }

    public Idea43019Service(Idea43019Config config) {
        this.config = config != null ? config : new Idea43019Config();
