...
@Data
public class Idea42750Config {
    private String name = "idea_042750";
 ...
 */
@Slf4j
public class Idea42750Service {
    private static final int IDEA_ID = 42750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42750Service() {
        this(new Idea42750Config());
    }

    public Idea42750Service(Idea42750Config config) {
        this.config = config != null ? config : new Idea42750Config();
