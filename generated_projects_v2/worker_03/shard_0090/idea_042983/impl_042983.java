...
@Data
public class Idea42983Config {
    private String name = "idea_042983";
 ...
 */
@Slf4j
public class Idea42983Service {
    private static final int IDEA_ID = 42983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42983Service() {
        this(new Idea42983Config());
    }

    public Idea42983Service(Idea42983Config config) {
        this.config = config != null ? config : new Idea42983Config();
