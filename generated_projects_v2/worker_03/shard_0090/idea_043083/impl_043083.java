...
@Data
public class Idea43083Config {
    private String name = "idea_043083";
 ...
 */
@Slf4j
public class Idea43083Service {
    private static final int IDEA_ID = 43083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43083Service() {
        this(new Idea43083Config());
    }

    public Idea43083Service(Idea43083Config config) {
        this.config = config != null ? config : new Idea43083Config();
