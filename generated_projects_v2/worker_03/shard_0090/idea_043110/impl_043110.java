...
@Data
public class Idea43110Config {
    private String name = "idea_043110";
 ...
 */
@Slf4j
public class Idea43110Service {
    private static final int IDEA_ID = 43110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43110Service() {
        this(new Idea43110Config());
    }

    public Idea43110Service(Idea43110Config config) {
        this.config = config != null ? config : new Idea43110Config();
