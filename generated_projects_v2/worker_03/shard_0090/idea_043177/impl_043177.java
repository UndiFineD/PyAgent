...
@Data
public class Idea43177Config {
    private String name = "idea_043177";
 ...
 */
@Slf4j
public class Idea43177Service {
    private static final int IDEA_ID = 43177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43177Service() {
        this(new Idea43177Config());
    }

    public Idea43177Service(Idea43177Config config) {
        this.config = config != null ? config : new Idea43177Config();
