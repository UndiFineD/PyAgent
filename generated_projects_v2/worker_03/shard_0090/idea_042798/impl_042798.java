...
@Data
public class Idea42798Config {
    private String name = "idea_042798";
 ...
 */
@Slf4j
public class Idea42798Service {
    private static final int IDEA_ID = 42798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42798Service() {
        this(new Idea42798Config());
    }

    public Idea42798Service(Idea42798Config config) {
        this.config = config != null ? config : new Idea42798Config();
