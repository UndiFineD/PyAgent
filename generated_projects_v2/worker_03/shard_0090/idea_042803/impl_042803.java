...
@Data
public class Idea42803Config {
    private String name = "idea_042803";
 ...
 */
@Slf4j
public class Idea42803Service {
    private static final int IDEA_ID = 42803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42803Service() {
        this(new Idea42803Config());
    }

    public Idea42803Service(Idea42803Config config) {
        this.config = config != null ? config : new Idea42803Config();
