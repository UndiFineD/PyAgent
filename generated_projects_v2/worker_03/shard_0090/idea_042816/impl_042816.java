...
@Data
public class Idea42816Config {
    private String name = "idea_042816";
 ...
 */
@Slf4j
public class Idea42816Service {
    private static final int IDEA_ID = 42816;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42816Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42816Service() {
        this(new Idea42816Config());
    }

    public Idea42816Service(Idea42816Config config) {
        this.config = config != null ? config : new Idea42816Config();
