...
@Data
public class Idea43102Config {
    private String name = "idea_043102";
 ...
 */
@Slf4j
public class Idea43102Service {
    private static final int IDEA_ID = 43102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43102Service() {
        this(new Idea43102Config());
    }

    public Idea43102Service(Idea43102Config config) {
        this.config = config != null ? config : new Idea43102Config();
