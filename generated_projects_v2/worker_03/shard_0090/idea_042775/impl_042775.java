...
@Data
public class Idea42775Config {
    private String name = "idea_042775";
 ...
 */
@Slf4j
public class Idea42775Service {
    private static final int IDEA_ID = 42775;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42775Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42775Service() {
        this(new Idea42775Config());
    }

    public Idea42775Service(Idea42775Config config) {
        this.config = config != null ? config : new Idea42775Config();
