...
@Data
public class Idea42852Config {
    private String name = "idea_042852";
 ...
 */
@Slf4j
public class Idea42852Service {
    private static final int IDEA_ID = 42852;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42852Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42852Service() {
        this(new Idea42852Config());
    }

    public Idea42852Service(Idea42852Config config) {
        this.config = config != null ? config : new Idea42852Config();
