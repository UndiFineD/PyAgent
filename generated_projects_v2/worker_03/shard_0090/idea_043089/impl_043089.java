...
@Data
public class Idea43089Config {
    private String name = "idea_043089";
 ...
 */
@Slf4j
public class Idea43089Service {
    private static final int IDEA_ID = 43089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43089Service() {
        this(new Idea43089Config());
    }

    public Idea43089Service(Idea43089Config config) {
        this.config = config != null ? config : new Idea43089Config();
