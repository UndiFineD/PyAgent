...
@Data
public class Idea43224Config {
    private String name = "idea_043224";
 ...
 */
@Slf4j
public class Idea43224Service {
    private static final int IDEA_ID = 43224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43224Service() {
        this(new Idea43224Config());
    }

    public Idea43224Service(Idea43224Config config) {
        this.config = config != null ? config : new Idea43224Config();
