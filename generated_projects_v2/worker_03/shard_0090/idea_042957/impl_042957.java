...
@Data
public class Idea42957Config {
    private String name = "idea_042957";
 ...
 */
@Slf4j
public class Idea42957Service {
    private static final int IDEA_ID = 42957;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42957Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42957Service() {
        this(new Idea42957Config());
    }

    public Idea42957Service(Idea42957Config config) {
        this.config = config != null ? config : new Idea42957Config();
