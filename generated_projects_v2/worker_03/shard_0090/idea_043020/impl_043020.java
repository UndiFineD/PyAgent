...
@Data
public class Idea43020Config {
    private String name = "idea_043020";
 ...
 */
@Slf4j
public class Idea43020Service {
    private static final int IDEA_ID = 43020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43020Service() {
        this(new Idea43020Config());
    }

    public Idea43020Service(Idea43020Config config) {
        this.config = config != null ? config : new Idea43020Config();
