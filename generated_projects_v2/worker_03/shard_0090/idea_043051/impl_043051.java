...
@Data
public class Idea43051Config {
    private String name = "idea_043051";
 ...
 */
@Slf4j
public class Idea43051Service {
    private static final int IDEA_ID = 43051;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43051Service() {
        this(new Idea43051Config());
    }

    public Idea43051Service(Idea43051Config config) {
        this.config = config != null ? config : new Idea43051Config();
