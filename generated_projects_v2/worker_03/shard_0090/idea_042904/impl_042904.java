...
@Data
public class Idea42904Config {
    private String name = "idea_042904";
 ...
 */
@Slf4j
public class Idea42904Service {
    private static final int IDEA_ID = 42904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42904Service() {
        this(new Idea42904Config());
    }

    public Idea42904Service(Idea42904Config config) {
        this.config = config != null ? config : new Idea42904Config();
