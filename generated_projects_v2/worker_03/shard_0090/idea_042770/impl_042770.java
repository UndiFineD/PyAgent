...
@Data
public class Idea42770Config {
    private String name = "idea_042770";
 ...
 */
@Slf4j
public class Idea42770Service {
    private static final int IDEA_ID = 42770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42770Service() {
        this(new Idea42770Config());
    }

    public Idea42770Service(Idea42770Config config) {
        this.config = config != null ? config : new Idea42770Config();
