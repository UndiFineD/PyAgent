...
@Data
public class Idea43038Config {
    private String name = "idea_043038";
 ...
 */
@Slf4j
public class Idea43038Service {
    private static final int IDEA_ID = 43038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43038Service() {
        this(new Idea43038Config());
    }

    public Idea43038Service(Idea43038Config config) {
        this.config = config != null ? config : new Idea43038Config();
