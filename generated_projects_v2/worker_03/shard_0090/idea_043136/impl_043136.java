...
@Data
public class Idea43136Config {
    private String name = "idea_043136";
 ...
 */
@Slf4j
public class Idea43136Service {
    private static final int IDEA_ID = 43136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43136Service() {
        this(new Idea43136Config());
    }

    public Idea43136Service(Idea43136Config config) {
        this.config = config != null ? config : new Idea43136Config();
