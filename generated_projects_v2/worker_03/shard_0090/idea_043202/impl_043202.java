...
@Data
public class Idea43202Config {
    private String name = "idea_043202";
 ...
 */
@Slf4j
public class Idea43202Service {
    private static final int IDEA_ID = 43202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43202Service() {
        this(new Idea43202Config());
    }

    public Idea43202Service(Idea43202Config config) {
        this.config = config != null ? config : new Idea43202Config();
