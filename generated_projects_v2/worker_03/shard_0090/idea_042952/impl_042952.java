...
@Data
public class Idea42952Config {
    private String name = "idea_042952";
 ...
 */
@Slf4j
public class Idea42952Service {
    private static final int IDEA_ID = 42952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42952Service() {
        this(new Idea42952Config());
    }

    public Idea42952Service(Idea42952Config config) {
        this.config = config != null ? config : new Idea42952Config();
