...
@Data
public class Idea43175Config {
    private String name = "idea_043175";
 ...
 */
@Slf4j
public class Idea43175Service {
    private static final int IDEA_ID = 43175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43175Service() {
        this(new Idea43175Config());
    }

    public Idea43175Service(Idea43175Config config) {
        this.config = config != null ? config : new Idea43175Config();
