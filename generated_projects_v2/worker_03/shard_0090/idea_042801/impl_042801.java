...
@Data
public class Idea42801Config {
    private String name = "idea_042801";
 ...
 */
@Slf4j
public class Idea42801Service {
    private static final int IDEA_ID = 42801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea42801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea42801Service() {
        this(new Idea42801Config());
    }

    public Idea42801Service(Idea42801Config config) {
        this.config = config != null ? config : new Idea42801Config();
