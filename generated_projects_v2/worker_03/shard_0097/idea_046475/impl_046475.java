...
@Data
public class Idea46475Config {
    private String name = "idea_046475";
 ...
 */
@Slf4j
public class Idea46475Service {
    private static final int IDEA_ID = 46475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46475Service() {
        this(new Idea46475Config());
    }

    public Idea46475Service(Idea46475Config config) {
        this.config = config != null ? config : new Idea46475Config();
