...
@Data
public class Idea46122Config {
    private String name = "idea_046122";
 ...
 */
@Slf4j
public class Idea46122Service {
    private static final int IDEA_ID = 46122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46122Service() {
        this(new Idea46122Config());
    }

    public Idea46122Service(Idea46122Config config) {
        this.config = config != null ? config : new Idea46122Config();
