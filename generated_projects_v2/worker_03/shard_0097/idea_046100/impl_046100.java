...
@Data
public class Idea46100Config {
    private String name = "idea_046100";
 ...
 */
@Slf4j
public class Idea46100Service {
    private static final int IDEA_ID = 46100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46100Service() {
        this(new Idea46100Config());
    }

    public Idea46100Service(Idea46100Config config) {
        this.config = config != null ? config : new Idea46100Config();
