...
@Data
public class Idea46113Config {
    private String name = "idea_046113";
 ...
 */
@Slf4j
public class Idea46113Service {
    private static final int IDEA_ID = 46113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46113Service() {
        this(new Idea46113Config());
    }

    public Idea46113Service(Idea46113Config config) {
        this.config = config != null ? config : new Idea46113Config();
