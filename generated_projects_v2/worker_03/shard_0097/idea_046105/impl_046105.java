...
@Data
public class Idea46105Config {
    private String name = "idea_046105";
 ...
 */
@Slf4j
public class Idea46105Service {
    private static final int IDEA_ID = 46105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46105Service() {
        this(new Idea46105Config());
    }

    public Idea46105Service(Idea46105Config config) {
        this.config = config != null ? config : new Idea46105Config();
