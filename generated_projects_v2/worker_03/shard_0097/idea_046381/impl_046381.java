...
@Data
public class Idea46381Config {
    private String name = "idea_046381";
 ...
 */
@Slf4j
public class Idea46381Service {
    private static final int IDEA_ID = 46381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46381Service() {
        this(new Idea46381Config());
    }

    public Idea46381Service(Idea46381Config config) {
        this.config = config != null ? config : new Idea46381Config();
