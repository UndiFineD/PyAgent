...
@Data
public class Idea46165Config {
    private String name = "idea_046165";
 ...
 */
@Slf4j
public class Idea46165Service {
    private static final int IDEA_ID = 46165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46165Service() {
        this(new Idea46165Config());
    }

    public Idea46165Service(Idea46165Config config) {
        this.config = config != null ? config : new Idea46165Config();
