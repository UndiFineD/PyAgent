...
@Data
public class Idea46477Config {
    private String name = "idea_046477";
 ...
 */
@Slf4j
public class Idea46477Service {
    private static final int IDEA_ID = 46477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46477Service() {
        this(new Idea46477Config());
    }

    public Idea46477Service(Idea46477Config config) {
        this.config = config != null ? config : new Idea46477Config();
