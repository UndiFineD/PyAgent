...
@Data
public class Idea46371Config {
    private String name = "idea_046371";
 ...
 */
@Slf4j
public class Idea46371Service {
    private static final int IDEA_ID = 46371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46371Service() {
        this(new Idea46371Config());
    }

    public Idea46371Service(Idea46371Config config) {
        this.config = config != null ? config : new Idea46371Config();
