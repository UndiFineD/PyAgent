...
@Data
public class Idea46237Config {
    private String name = "idea_046237";
 ...
 */
@Slf4j
public class Idea46237Service {
    private static final int IDEA_ID = 46237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46237Service() {
        this(new Idea46237Config());
    }

    public Idea46237Service(Idea46237Config config) {
        this.config = config != null ? config : new Idea46237Config();
