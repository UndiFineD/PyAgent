...
@Data
public class Idea46316Config {
    private String name = "idea_046316";
 ...
 */
@Slf4j
public class Idea46316Service {
    private static final int IDEA_ID = 46316;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46316Service() {
        this(new Idea46316Config());
    }

    public Idea46316Service(Idea46316Config config) {
        this.config = config != null ? config : new Idea46316Config();
