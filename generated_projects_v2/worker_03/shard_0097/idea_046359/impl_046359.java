...
@Data
public class Idea46359Config {
    private String name = "idea_046359";
 ...
 */
@Slf4j
public class Idea46359Service {
    private static final int IDEA_ID = 46359;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46359Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46359Service() {
        this(new Idea46359Config());
    }

    public Idea46359Service(Idea46359Config config) {
        this.config = config != null ? config : new Idea46359Config();
