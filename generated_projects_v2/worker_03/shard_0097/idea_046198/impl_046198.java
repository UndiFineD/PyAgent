...
@Data
public class Idea46198Config {
    private String name = "idea_046198";
 ...
 */
@Slf4j
public class Idea46198Service {
    private static final int IDEA_ID = 46198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46198Service() {
        this(new Idea46198Config());
    }

    public Idea46198Service(Idea46198Config config) {
        this.config = config != null ? config : new Idea46198Config();
