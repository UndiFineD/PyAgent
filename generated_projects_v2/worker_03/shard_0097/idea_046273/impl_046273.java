...
@Data
public class Idea46273Config {
    private String name = "idea_046273";
 ...
 */
@Slf4j
public class Idea46273Service {
    private static final int IDEA_ID = 46273;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46273Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46273Service() {
        this(new Idea46273Config());
    }

    public Idea46273Service(Idea46273Config config) {
        this.config = config != null ? config : new Idea46273Config();
