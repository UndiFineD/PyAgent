...
@Data
public class Idea46259Config {
    private String name = "idea_046259";
 ...
 */
@Slf4j
public class Idea46259Service {
    private static final int IDEA_ID = 46259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46259Service() {
        this(new Idea46259Config());
    }

    public Idea46259Service(Idea46259Config config) {
        this.config = config != null ? config : new Idea46259Config();
