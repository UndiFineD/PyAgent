...
@Data
public class Idea46503Config {
    private String name = "idea_046503";
 ...
 */
@Slf4j
public class Idea46503Service {
    private static final int IDEA_ID = 46503;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46503Service() {
        this(new Idea46503Config());
    }

    public Idea46503Service(Idea46503Config config) {
        this.config = config != null ? config : new Idea46503Config();
