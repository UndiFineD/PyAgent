...
@Data
public class Idea46265Config {
    private String name = "idea_046265";
 ...
 */
@Slf4j
public class Idea46265Service {
    private static final int IDEA_ID = 46265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46265Service() {
        this(new Idea46265Config());
    }

    public Idea46265Service(Idea46265Config config) {
        this.config = config != null ? config : new Idea46265Config();
