...
@Data
public class Idea46160Config {
    private String name = "idea_046160";
 ...
 */
@Slf4j
public class Idea46160Service {
    private static final int IDEA_ID = 46160;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46160Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46160Service() {
        this(new Idea46160Config());
    }

    public Idea46160Service(Idea46160Config config) {
        this.config = config != null ? config : new Idea46160Config();
