...
@Data
public class Idea46451Config {
    private String name = "idea_046451";
 ...
 */
@Slf4j
public class Idea46451Service {
    private static final int IDEA_ID = 46451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46451Service() {
        this(new Idea46451Config());
    }

    public Idea46451Service(Idea46451Config config) {
        this.config = config != null ? config : new Idea46451Config();
