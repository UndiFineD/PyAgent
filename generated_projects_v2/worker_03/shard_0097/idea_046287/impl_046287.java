...
@Data
public class Idea46287Config {
    private String name = "idea_046287";
 ...
 */
@Slf4j
public class Idea46287Service {
    private static final int IDEA_ID = 46287;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46287Service() {
        this(new Idea46287Config());
    }

    public Idea46287Service(Idea46287Config config) {
        this.config = config != null ? config : new Idea46287Config();
