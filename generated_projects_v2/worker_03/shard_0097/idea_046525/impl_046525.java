...
@Data
public class Idea46525Config {
    private String name = "idea_046525";
 ...
 */
@Slf4j
public class Idea46525Service {
    private static final int IDEA_ID = 46525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46525Service() {
        this(new Idea46525Config());
    }

    public Idea46525Service(Idea46525Config config) {
        this.config = config != null ? config : new Idea46525Config();
