...
@Data
public class Idea46163Config {
    private String name = "idea_046163";
 ...
 */
@Slf4j
public class Idea46163Service {
    private static final int IDEA_ID = 46163;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46163Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46163Service() {
        this(new Idea46163Config());
    }

    public Idea46163Service(Idea46163Config config) {
        this.config = config != null ? config : new Idea46163Config();
