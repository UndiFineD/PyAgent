...
@Data
public class Idea46397Config {
    private String name = "idea_046397";
 ...
 */
@Slf4j
public class Idea46397Service {
    private static final int IDEA_ID = 46397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46397Service() {
        this(new Idea46397Config());
    }

    public Idea46397Service(Idea46397Config config) {
        this.config = config != null ? config : new Idea46397Config();
