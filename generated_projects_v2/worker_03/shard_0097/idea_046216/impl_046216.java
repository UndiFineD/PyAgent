...
@Data
public class Idea46216Config {
    private String name = "idea_046216";
 ...
 */
@Slf4j
public class Idea46216Service {
    private static final int IDEA_ID = 46216;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46216Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46216Service() {
        this(new Idea46216Config());
    }

    public Idea46216Service(Idea46216Config config) {
        this.config = config != null ? config : new Idea46216Config();
