...
@Data
public class Idea46278Config {
    private String name = "idea_046278";
 ...
 */
@Slf4j
public class Idea46278Service {
    private static final int IDEA_ID = 46278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46278Service() {
        this(new Idea46278Config());
    }

    public Idea46278Service(Idea46278Config config) {
        this.config = config != null ? config : new Idea46278Config();
