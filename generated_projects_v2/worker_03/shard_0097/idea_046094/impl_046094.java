...
@Data
public class Idea46094Config {
    private String name = "idea_046094";
 ...
 */
@Slf4j
public class Idea46094Service {
    private static final int IDEA_ID = 46094;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46094Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46094Service() {
        this(new Idea46094Config());
    }

    public Idea46094Service(Idea46094Config config) {
        this.config = config != null ? config : new Idea46094Config();
