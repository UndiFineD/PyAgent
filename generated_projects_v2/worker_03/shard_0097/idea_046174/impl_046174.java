...
@Data
public class Idea46174Config {
    private String name = "idea_046174";
 ...
 */
@Slf4j
public class Idea46174Service {
    private static final int IDEA_ID = 46174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46174Service() {
        this(new Idea46174Config());
    }

    public Idea46174Service(Idea46174Config config) {
        this.config = config != null ? config : new Idea46174Config();
