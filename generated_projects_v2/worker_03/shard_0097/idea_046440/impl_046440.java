...
@Data
public class Idea46440Config {
    private String name = "idea_046440";
 ...
 */
@Slf4j
public class Idea46440Service {
    private static final int IDEA_ID = 46440;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46440Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46440Service() {
        this(new Idea46440Config());
    }

    public Idea46440Service(Idea46440Config config) {
        this.config = config != null ? config : new Idea46440Config();
