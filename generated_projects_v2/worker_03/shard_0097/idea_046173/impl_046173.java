...
@Data
public class Idea46173Config {
    private String name = "idea_046173";
 ...
 */
@Slf4j
public class Idea46173Service {
    private static final int IDEA_ID = 46173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46173Service() {
        this(new Idea46173Config());
    }

    public Idea46173Service(Idea46173Config config) {
        this.config = config != null ? config : new Idea46173Config();
