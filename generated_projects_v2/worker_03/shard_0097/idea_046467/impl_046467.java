...
@Data
public class Idea46467Config {
    private String name = "idea_046467";
 ...
 */
@Slf4j
public class Idea46467Service {
    private static final int IDEA_ID = 46467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46467Service() {
        this(new Idea46467Config());
    }

    public Idea46467Service(Idea46467Config config) {
        this.config = config != null ? config : new Idea46467Config();
