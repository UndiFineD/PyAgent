...
@Data
public class Idea46132Config {
    private String name = "idea_046132";
 ...
 */
@Slf4j
public class Idea46132Service {
    private static final int IDEA_ID = 46132;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46132Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46132Service() {
        this(new Idea46132Config());
    }

    public Idea46132Service(Idea46132Config config) {
        this.config = config != null ? config : new Idea46132Config();
