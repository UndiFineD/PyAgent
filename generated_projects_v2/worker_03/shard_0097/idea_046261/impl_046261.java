...
@Data
public class Idea46261Config {
    private String name = "idea_046261";
 ...
 */
@Slf4j
public class Idea46261Service {
    private static final int IDEA_ID = 46261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46261Service() {
        this(new Idea46261Config());
    }

    public Idea46261Service(Idea46261Config config) {
        this.config = config != null ? config : new Idea46261Config();
