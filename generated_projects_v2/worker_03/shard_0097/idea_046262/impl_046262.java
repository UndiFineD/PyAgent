...
@Data
public class Idea46262Config {
    private String name = "idea_046262";
 ...
 */
@Slf4j
public class Idea46262Service {
    private static final int IDEA_ID = 46262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46262Service() {
        this(new Idea46262Config());
    }

    public Idea46262Service(Idea46262Config config) {
        this.config = config != null ? config : new Idea46262Config();
