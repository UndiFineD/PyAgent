...
@Data
public class Idea46197Config {
    private String name = "idea_046197";
 ...
 */
@Slf4j
public class Idea46197Service {
    private static final int IDEA_ID = 46197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46197Service() {
        this(new Idea46197Config());
    }

    public Idea46197Service(Idea46197Config config) {
        this.config = config != null ? config : new Idea46197Config();
