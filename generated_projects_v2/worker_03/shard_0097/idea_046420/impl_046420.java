...
@Data
public class Idea46420Config {
    private String name = "idea_046420";
 ...
 */
@Slf4j
public class Idea46420Service {
    private static final int IDEA_ID = 46420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46420Service() {
        this(new Idea46420Config());
    }

    public Idea46420Service(Idea46420Config config) {
        this.config = config != null ? config : new Idea46420Config();
