...
@Data
public class Idea46293Config {
    private String name = "idea_046293";
 ...
 */
@Slf4j
public class Idea46293Service {
    private static final int IDEA_ID = 46293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46293Service() {
        this(new Idea46293Config());
    }

    public Idea46293Service(Idea46293Config config) {
        this.config = config != null ? config : new Idea46293Config();
