...
@Data
public class Idea46437Config {
    private String name = "idea_046437";
 ...
 */
@Slf4j
public class Idea46437Service {
    private static final int IDEA_ID = 46437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46437Service() {
        this(new Idea46437Config());
    }

    public Idea46437Service(Idea46437Config config) {
        this.config = config != null ? config : new Idea46437Config();
