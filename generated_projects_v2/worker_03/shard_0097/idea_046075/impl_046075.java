...
@Data
public class Idea46075Config {
    private String name = "idea_046075";
 ...
 */
@Slf4j
public class Idea46075Service {
    private static final int IDEA_ID = 46075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46075Service() {
        this(new Idea46075Config());
    }

    public Idea46075Service(Idea46075Config config) {
        this.config = config != null ? config : new Idea46075Config();
