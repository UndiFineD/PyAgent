...
@Data
public class Idea46229Config {
    private String name = "idea_046229";
 ...
 */
@Slf4j
public class Idea46229Service {
    private static final int IDEA_ID = 46229;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46229Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46229Service() {
        this(new Idea46229Config());
    }

    public Idea46229Service(Idea46229Config config) {
        this.config = config != null ? config : new Idea46229Config();
