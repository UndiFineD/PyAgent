...
@Data
public class Idea46540Config {
    private String name = "idea_046540";
 ...
 */
@Slf4j
public class Idea46540Service {
    private static final int IDEA_ID = 46540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46540Service() {
        this(new Idea46540Config());
    }

    public Idea46540Service(Idea46540Config config) {
        this.config = config != null ? config : new Idea46540Config();
