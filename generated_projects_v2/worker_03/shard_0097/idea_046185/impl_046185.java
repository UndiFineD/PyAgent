...
@Data
public class Idea46185Config {
    private String name = "idea_046185";
 ...
 */
@Slf4j
public class Idea46185Service {
    private static final int IDEA_ID = 46185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46185Service() {
        this(new Idea46185Config());
    }

    public Idea46185Service(Idea46185Config config) {
        this.config = config != null ? config : new Idea46185Config();
