...
@Data
public class Idea46326Config {
    private String name = "idea_046326";
 ...
 */
@Slf4j
public class Idea46326Service {
    private static final int IDEA_ID = 46326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46326Service() {
        this(new Idea46326Config());
    }

    public Idea46326Service(Idea46326Config config) {
        this.config = config != null ? config : new Idea46326Config();
