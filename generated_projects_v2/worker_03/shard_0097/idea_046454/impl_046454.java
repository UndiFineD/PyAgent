...
@Data
public class Idea46454Config {
    private String name = "idea_046454";
 ...
 */
@Slf4j
public class Idea46454Service {
    private static final int IDEA_ID = 46454;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46454Service() {
        this(new Idea46454Config());
    }

    public Idea46454Service(Idea46454Config config) {
        this.config = config != null ? config : new Idea46454Config();
