...
@Data
public class Idea46266Config {
    private String name = "idea_046266";
 ...
 */
@Slf4j
public class Idea46266Service {
    private static final int IDEA_ID = 46266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46266Service() {
        this(new Idea46266Config());
    }

    public Idea46266Service(Idea46266Config config) {
        this.config = config != null ? config : new Idea46266Config();
