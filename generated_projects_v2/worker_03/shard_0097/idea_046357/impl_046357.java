...
@Data
public class Idea46357Config {
    private String name = "idea_046357";
 ...
 */
@Slf4j
public class Idea46357Service {
    private static final int IDEA_ID = 46357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46357Service() {
        this(new Idea46357Config());
    }

    public Idea46357Service(Idea46357Config config) {
        this.config = config != null ? config : new Idea46357Config();
