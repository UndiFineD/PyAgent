...
@Data
public class Idea46413Config {
    private String name = "idea_046413";
 ...
 */
@Slf4j
public class Idea46413Service {
    private static final int IDEA_ID = 46413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46413Service() {
        this(new Idea46413Config());
    }

    public Idea46413Service(Idea46413Config config) {
        this.config = config != null ? config : new Idea46413Config();
