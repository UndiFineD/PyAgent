...
@Data
public class Idea46340Config {
    private String name = "idea_046340";
 ...
 */
@Slf4j
public class Idea46340Service {
    private static final int IDEA_ID = 46340;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46340Service() {
        this(new Idea46340Config());
    }

    public Idea46340Service(Idea46340Config config) {
        this.config = config != null ? config : new Idea46340Config();
