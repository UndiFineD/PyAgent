...
@Data
public class Idea46547Config {
    private String name = "idea_046547";
 ...
 */
@Slf4j
public class Idea46547Service {
    private static final int IDEA_ID = 46547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46547Service() {
        this(new Idea46547Config());
    }

    public Idea46547Service(Idea46547Config config) {
        this.config = config != null ? config : new Idea46547Config();
