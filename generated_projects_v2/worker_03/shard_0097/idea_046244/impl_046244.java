...
@Data
public class Idea46244Config {
    private String name = "idea_046244";
 ...
 */
@Slf4j
public class Idea46244Service {
    private static final int IDEA_ID = 46244;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46244Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46244Service() {
        this(new Idea46244Config());
    }

    public Idea46244Service(Idea46244Config config) {
        this.config = config != null ? config : new Idea46244Config();
