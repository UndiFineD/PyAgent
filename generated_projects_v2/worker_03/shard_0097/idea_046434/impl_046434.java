...
@Data
public class Idea46434Config {
    private String name = "idea_046434";
 ...
 */
@Slf4j
public class Idea46434Service {
    private static final int IDEA_ID = 46434;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46434Service() {
        this(new Idea46434Config());
    }

    public Idea46434Service(Idea46434Config config) {
        this.config = config != null ? config : new Idea46434Config();
