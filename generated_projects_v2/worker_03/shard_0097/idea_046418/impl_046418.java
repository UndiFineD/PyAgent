...
@Data
public class Idea46418Config {
    private String name = "idea_046418";
 ...
 */
@Slf4j
public class Idea46418Service {
    private static final int IDEA_ID = 46418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46418Service() {
        this(new Idea46418Config());
    }

    public Idea46418Service(Idea46418Config config) {
        this.config = config != null ? config : new Idea46418Config();
