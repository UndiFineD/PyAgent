...
@Data
public class Idea46129Config {
    private String name = "idea_046129";
 ...
 */
@Slf4j
public class Idea46129Service {
    private static final int IDEA_ID = 46129;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46129Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46129Service() {
        this(new Idea46129Config());
    }

    public Idea46129Service(Idea46129Config config) {
        this.config = config != null ? config : new Idea46129Config();
