...
@Data
public class Idea46097Config {
    private String name = "idea_046097";
 ...
 */
@Slf4j
public class Idea46097Service {
    private static final int IDEA_ID = 46097;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46097Service() {
        this(new Idea46097Config());
    }

    public Idea46097Service(Idea46097Config config) {
        this.config = config != null ? config : new Idea46097Config();
