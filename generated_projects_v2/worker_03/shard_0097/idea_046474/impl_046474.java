...
@Data
public class Idea46474Config {
    private String name = "idea_046474";
 ...
 */
@Slf4j
public class Idea46474Service {
    private static final int IDEA_ID = 46474;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46474Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46474Service() {
        this(new Idea46474Config());
    }

    public Idea46474Service(Idea46474Config config) {
        this.config = config != null ? config : new Idea46474Config();
