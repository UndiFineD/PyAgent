...
@Data
public class Idea46414Config {
    private String name = "idea_046414";
 ...
 */
@Slf4j
public class Idea46414Service {
    private static final int IDEA_ID = 46414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46414Service() {
        this(new Idea46414Config());
    }

    public Idea46414Service(Idea46414Config config) {
        this.config = config != null ? config : new Idea46414Config();
