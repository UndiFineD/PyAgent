...
@Data
public class Idea46255Config {
    private String name = "idea_046255";
 ...
 */
@Slf4j
public class Idea46255Service {
    private static final int IDEA_ID = 46255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46255Service() {
        this(new Idea46255Config());
    }

    public Idea46255Service(Idea46255Config config) {
        this.config = config != null ? config : new Idea46255Config();
