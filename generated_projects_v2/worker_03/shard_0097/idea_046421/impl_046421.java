...
@Data
public class Idea46421Config {
    private String name = "idea_046421";
 ...
 */
@Slf4j
public class Idea46421Service {
    private static final int IDEA_ID = 46421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46421Service() {
        this(new Idea46421Config());
    }

    public Idea46421Service(Idea46421Config config) {
        this.config = config != null ? config : new Idea46421Config();
