...
@Data
public class Idea46294Config {
    private String name = "idea_046294";
 ...
 */
@Slf4j
public class Idea46294Service {
    private static final int IDEA_ID = 46294;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46294Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46294Service() {
        this(new Idea46294Config());
    }

    public Idea46294Service(Idea46294Config config) {
        this.config = config != null ? config : new Idea46294Config();
