...
@Data
public class Idea46114Config {
    private String name = "idea_046114";
 ...
 */
@Slf4j
public class Idea46114Service {
    private static final int IDEA_ID = 46114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46114Service() {
        this(new Idea46114Config());
    }

    public Idea46114Service(Idea46114Config config) {
        this.config = config != null ? config : new Idea46114Config();
