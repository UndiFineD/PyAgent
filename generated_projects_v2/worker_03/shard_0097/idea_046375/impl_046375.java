...
@Data
public class Idea46375Config {
    private String name = "idea_046375";
 ...
 */
@Slf4j
public class Idea46375Service {
    private static final int IDEA_ID = 46375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46375Service() {
        this(new Idea46375Config());
    }

    public Idea46375Service(Idea46375Config config) {
        this.config = config != null ? config : new Idea46375Config();
