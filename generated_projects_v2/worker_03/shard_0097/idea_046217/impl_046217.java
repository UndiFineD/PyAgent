...
@Data
public class Idea46217Config {
    private String name = "idea_046217";
 ...
 */
@Slf4j
public class Idea46217Service {
    private static final int IDEA_ID = 46217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46217Service() {
        this(new Idea46217Config());
    }

    public Idea46217Service(Idea46217Config config) {
        this.config = config != null ? config : new Idea46217Config();
