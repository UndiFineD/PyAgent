...
@Data
public class Idea46369Config {
    private String name = "idea_046369";
 ...
 */
@Slf4j
public class Idea46369Service {
    private static final int IDEA_ID = 46369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46369Service() {
        this(new Idea46369Config());
    }

    public Idea46369Service(Idea46369Config config) {
        this.config = config != null ? config : new Idea46369Config();
