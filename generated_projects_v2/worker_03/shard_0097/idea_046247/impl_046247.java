...
@Data
public class Idea46247Config {
    private String name = "idea_046247";
 ...
 */
@Slf4j
public class Idea46247Service {
    private static final int IDEA_ID = 46247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46247Service() {
        this(new Idea46247Config());
    }

    public Idea46247Service(Idea46247Config config) {
        this.config = config != null ? config : new Idea46247Config();
