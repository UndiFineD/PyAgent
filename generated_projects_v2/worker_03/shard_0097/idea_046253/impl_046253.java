...
@Data
public class Idea46253Config {
    private String name = "idea_046253";
 ...
 */
@Slf4j
public class Idea46253Service {
    private static final int IDEA_ID = 46253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46253Service() {
        this(new Idea46253Config());
    }

    public Idea46253Service(Idea46253Config config) {
        this.config = config != null ? config : new Idea46253Config();
