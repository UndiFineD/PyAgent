...
@Data
public class Idea46109Config {
    private String name = "idea_046109";
 ...
 */
@Slf4j
public class Idea46109Service {
    private static final int IDEA_ID = 46109;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46109Service() {
        this(new Idea46109Config());
    }

    public Idea46109Service(Idea46109Config config) {
        this.config = config != null ? config : new Idea46109Config();
