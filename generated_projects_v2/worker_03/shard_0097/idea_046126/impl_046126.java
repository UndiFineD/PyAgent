...
@Data
public class Idea46126Config {
    private String name = "idea_046126";
 ...
 */
@Slf4j
public class Idea46126Service {
    private static final int IDEA_ID = 46126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46126Service() {
        this(new Idea46126Config());
    }

    public Idea46126Service(Idea46126Config config) {
        this.config = config != null ? config : new Idea46126Config();
