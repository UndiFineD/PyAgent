...
@Data
public class Idea46485Config {
    private String name = "idea_046485";
 ...
 */
@Slf4j
public class Idea46485Service {
    private static final int IDEA_ID = 46485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46485Service() {
        this(new Idea46485Config());
    }

    public Idea46485Service(Idea46485Config config) {
        this.config = config != null ? config : new Idea46485Config();
