...
@Data
public class Idea46436Config {
    private String name = "idea_046436";
 ...
 */
@Slf4j
public class Idea46436Service {
    private static final int IDEA_ID = 46436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46436Service() {
        this(new Idea46436Config());
    }

    public Idea46436Service(Idea46436Config config) {
        this.config = config != null ? config : new Idea46436Config();
