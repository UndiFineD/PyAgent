...
@Data
public class Idea46344Config {
    private String name = "idea_046344";
 ...
 */
@Slf4j
public class Idea46344Service {
    private static final int IDEA_ID = 46344;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46344Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46344Service() {
        this(new Idea46344Config());
    }

    public Idea46344Service(Idea46344Config config) {
        this.config = config != null ? config : new Idea46344Config();
