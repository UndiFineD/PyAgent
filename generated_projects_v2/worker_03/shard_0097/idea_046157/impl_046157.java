...
@Data
public class Idea46157Config {
    private String name = "idea_046157";
 ...
 */
@Slf4j
public class Idea46157Service {
    private static final int IDEA_ID = 46157;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46157Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46157Service() {
        this(new Idea46157Config());
    }

    public Idea46157Service(Idea46157Config config) {
        this.config = config != null ? config : new Idea46157Config();
