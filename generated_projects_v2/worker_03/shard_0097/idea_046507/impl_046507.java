...
@Data
public class Idea46507Config {
    private String name = "idea_046507";
 ...
 */
@Slf4j
public class Idea46507Service {
    private static final int IDEA_ID = 46507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46507Service() {
        this(new Idea46507Config());
    }

    public Idea46507Service(Idea46507Config config) {
        this.config = config != null ? config : new Idea46507Config();
