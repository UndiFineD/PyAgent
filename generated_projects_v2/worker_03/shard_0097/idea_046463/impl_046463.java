...
@Data
public class Idea46463Config {
    private String name = "idea_046463";
 ...
 */
@Slf4j
public class Idea46463Service {
    private static final int IDEA_ID = 46463;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46463Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46463Service() {
        this(new Idea46463Config());
    }

    public Idea46463Service(Idea46463Config config) {
        this.config = config != null ? config : new Idea46463Config();
