...
@Data
public class Idea46427Config {
    private String name = "idea_046427";
 ...
 */
@Slf4j
public class Idea46427Service {
    private static final int IDEA_ID = 46427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46427Service() {
        this(new Idea46427Config());
    }

    public Idea46427Service(Idea46427Config config) {
        this.config = config != null ? config : new Idea46427Config();
