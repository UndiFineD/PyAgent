...
@Data
public class Idea46394Config {
    private String name = "idea_046394";
 ...
 */
@Slf4j
public class Idea46394Service {
    private static final int IDEA_ID = 46394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46394Service() {
        this(new Idea46394Config());
    }

    public Idea46394Service(Idea46394Config config) {
        this.config = config != null ? config : new Idea46394Config();
