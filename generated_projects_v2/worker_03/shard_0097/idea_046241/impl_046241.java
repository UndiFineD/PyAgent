...
@Data
public class Idea46241Config {
    private String name = "idea_046241";
 ...
 */
@Slf4j
public class Idea46241Service {
    private static final int IDEA_ID = 46241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46241Service() {
        this(new Idea46241Config());
    }

    public Idea46241Service(Idea46241Config config) {
        this.config = config != null ? config : new Idea46241Config();
