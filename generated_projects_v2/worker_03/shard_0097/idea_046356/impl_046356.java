...
@Data
public class Idea46356Config {
    private String name = "idea_046356";
 ...
 */
@Slf4j
public class Idea46356Service {
    private static final int IDEA_ID = 46356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46356Service() {
        this(new Idea46356Config());
    }

    public Idea46356Service(Idea46356Config config) {
        this.config = config != null ? config : new Idea46356Config();
