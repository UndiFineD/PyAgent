...
@Data
public class Idea46429Config {
    private String name = "idea_046429";
 ...
 */
@Slf4j
public class Idea46429Service {
    private static final int IDEA_ID = 46429;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46429Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46429Service() {
        this(new Idea46429Config());
    }

    public Idea46429Service(Idea46429Config config) {
        this.config = config != null ? config : new Idea46429Config();
