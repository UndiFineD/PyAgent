...
@Data
public class Idea46426Config {
    private String name = "idea_046426";
 ...
 */
@Slf4j
public class Idea46426Service {
    private static final int IDEA_ID = 46426;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46426Service() {
        this(new Idea46426Config());
    }

    public Idea46426Service(Idea46426Config config) {
        this.config = config != null ? config : new Idea46426Config();
