...
@Data
public class Idea46078Config {
    private String name = "idea_046078";
 ...
 */
@Slf4j
public class Idea46078Service {
    private static final int IDEA_ID = 46078;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46078Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46078Service() {
        this(new Idea46078Config());
    }

    public Idea46078Service(Idea46078Config config) {
        this.config = config != null ? config : new Idea46078Config();
