...
@Data
public class Idea46182Config {
    private String name = "idea_046182";
 ...
 */
@Slf4j
public class Idea46182Service {
    private static final int IDEA_ID = 46182;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46182Service() {
        this(new Idea46182Config());
    }

    public Idea46182Service(Idea46182Config config) {
        this.config = config != null ? config : new Idea46182Config();
