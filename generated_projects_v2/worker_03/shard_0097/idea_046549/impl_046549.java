...
@Data
public class Idea46549Config {
    private String name = "idea_046549";
 ...
 */
@Slf4j
public class Idea46549Service {
    private static final int IDEA_ID = 46549;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46549Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46549Service() {
        this(new Idea46549Config());
    }

    public Idea46549Service(Idea46549Config config) {
        this.config = config != null ? config : new Idea46549Config();
