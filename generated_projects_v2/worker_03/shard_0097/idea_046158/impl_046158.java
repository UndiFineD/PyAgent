...
@Data
public class Idea46158Config {
    private String name = "idea_046158";
 ...
 */
@Slf4j
public class Idea46158Service {
    private static final int IDEA_ID = 46158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46158Service() {
        this(new Idea46158Config());
    }

    public Idea46158Service(Idea46158Config config) {
        this.config = config != null ? config : new Idea46158Config();
