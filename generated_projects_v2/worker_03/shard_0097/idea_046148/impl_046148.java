...
@Data
public class Idea46148Config {
    private String name = "idea_046148";
 ...
 */
@Slf4j
public class Idea46148Service {
    private static final int IDEA_ID = 46148;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46148Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46148Service() {
        this(new Idea46148Config());
    }

    public Idea46148Service(Idea46148Config config) {
        this.config = config != null ? config : new Idea46148Config();
