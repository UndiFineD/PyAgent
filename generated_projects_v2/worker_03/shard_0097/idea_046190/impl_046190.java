...
@Data
public class Idea46190Config {
    private String name = "idea_046190";
 ...
 */
@Slf4j
public class Idea46190Service {
    private static final int IDEA_ID = 46190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46190Service() {
        this(new Idea46190Config());
    }

    public Idea46190Service(Idea46190Config config) {
        this.config = config != null ? config : new Idea46190Config();
