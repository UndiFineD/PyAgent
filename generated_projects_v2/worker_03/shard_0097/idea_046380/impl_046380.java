...
@Data
public class Idea46380Config {
    private String name = "idea_046380";
 ...
 */
@Slf4j
public class Idea46380Service {
    private static final int IDEA_ID = 46380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46380Service() {
        this(new Idea46380Config());
    }

    public Idea46380Service(Idea46380Config config) {
        this.config = config != null ? config : new Idea46380Config();
