...
@Data
public class Idea46470Config {
    private String name = "idea_046470";
 ...
 */
@Slf4j
public class Idea46470Service {
    private static final int IDEA_ID = 46470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46470Service() {
        this(new Idea46470Config());
    }

    public Idea46470Service(Idea46470Config config) {
        this.config = config != null ? config : new Idea46470Config();
