...
@Data
public class Idea46486Config {
    private String name = "idea_046486";
 ...
 */
@Slf4j
public class Idea46486Service {
    private static final int IDEA_ID = 46486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46486Service() {
        this(new Idea46486Config());
    }

    public Idea46486Service(Idea46486Config config) {
        this.config = config != null ? config : new Idea46486Config();
