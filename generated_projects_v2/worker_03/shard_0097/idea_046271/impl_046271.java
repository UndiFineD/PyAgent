...
@Data
public class Idea46271Config {
    private String name = "idea_046271";
 ...
 */
@Slf4j
public class Idea46271Service {
    private static final int IDEA_ID = 46271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46271Service() {
        this(new Idea46271Config());
    }

    public Idea46271Service(Idea46271Config config) {
        this.config = config != null ? config : new Idea46271Config();
