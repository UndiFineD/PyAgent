...
@Data
public class Idea46513Config {
    private String name = "idea_046513";
 ...
 */
@Slf4j
public class Idea46513Service {
    private static final int IDEA_ID = 46513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46513Service() {
        this(new Idea46513Config());
    }

    public Idea46513Service(Idea46513Config config) {
        this.config = config != null ? config : new Idea46513Config();
