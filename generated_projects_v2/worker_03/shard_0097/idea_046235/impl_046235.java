...
@Data
public class Idea46235Config {
    private String name = "idea_046235";
 ...
 */
@Slf4j
public class Idea46235Service {
    private static final int IDEA_ID = 46235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46235Service() {
        this(new Idea46235Config());
    }

    public Idea46235Service(Idea46235Config config) {
        this.config = config != null ? config : new Idea46235Config();
