...
@Data
public class Idea46532Config {
    private String name = "idea_046532";
 ...
 */
@Slf4j
public class Idea46532Service {
    private static final int IDEA_ID = 46532;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46532Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46532Service() {
        this(new Idea46532Config());
    }

    public Idea46532Service(Idea46532Config config) {
        this.config = config != null ? config : new Idea46532Config();
