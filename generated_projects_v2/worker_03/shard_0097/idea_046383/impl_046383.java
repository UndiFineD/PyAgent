...
@Data
public class Idea46383Config {
    private String name = "idea_046383";
 ...
 */
@Slf4j
public class Idea46383Service {
    private static final int IDEA_ID = 46383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46383Service() {
        this(new Idea46383Config());
    }

    public Idea46383Service(Idea46383Config config) {
        this.config = config != null ? config : new Idea46383Config();
