...
@Data
public class Idea46491Config {
    private String name = "idea_046491";
 ...
 */
@Slf4j
public class Idea46491Service {
    private static final int IDEA_ID = 46491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46491Service() {
        this(new Idea46491Config());
    }

    public Idea46491Service(Idea46491Config config) {
        this.config = config != null ? config : new Idea46491Config();
