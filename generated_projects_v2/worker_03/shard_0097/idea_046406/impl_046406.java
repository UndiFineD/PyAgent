...
@Data
public class Idea46406Config {
    private String name = "idea_046406";
 ...
 */
@Slf4j
public class Idea46406Service {
    private static final int IDEA_ID = 46406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46406Service() {
        this(new Idea46406Config());
    }

    public Idea46406Service(Idea46406Config config) {
        this.config = config != null ? config : new Idea46406Config();
