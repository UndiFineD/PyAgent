...
@Data
public class Idea46290Config {
    private String name = "idea_046290";
 ...
 */
@Slf4j
public class Idea46290Service {
    private static final int IDEA_ID = 46290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46290Service() {
        this(new Idea46290Config());
    }

    public Idea46290Service(Idea46290Config config) {
        this.config = config != null ? config : new Idea46290Config();
