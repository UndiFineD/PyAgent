...
@Data
public class Idea46222Config {
    private String name = "idea_046222";
 ...
 */
@Slf4j
public class Idea46222Service {
    private static final int IDEA_ID = 46222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46222Service() {
        this(new Idea46222Config());
    }

    public Idea46222Service(Idea46222Config config) {
        this.config = config != null ? config : new Idea46222Config();
