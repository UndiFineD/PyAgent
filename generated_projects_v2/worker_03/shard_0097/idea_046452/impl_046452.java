...
@Data
public class Idea46452Config {
    private String name = "idea_046452";
 ...
 */
@Slf4j
public class Idea46452Service {
    private static final int IDEA_ID = 46452;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46452Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46452Service() {
        this(new Idea46452Config());
    }

    public Idea46452Service(Idea46452Config config) {
        this.config = config != null ? config : new Idea46452Config();
