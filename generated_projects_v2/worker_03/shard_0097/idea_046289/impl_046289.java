...
@Data
public class Idea46289Config {
    private String name = "idea_046289";
 ...
 */
@Slf4j
public class Idea46289Service {
    private static final int IDEA_ID = 46289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46289Service() {
        this(new Idea46289Config());
    }

    public Idea46289Service(Idea46289Config config) {
        this.config = config != null ? config : new Idea46289Config();
