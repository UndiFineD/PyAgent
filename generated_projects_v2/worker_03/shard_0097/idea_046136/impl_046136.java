...
@Data
public class Idea46136Config {
    private String name = "idea_046136";
 ...
 */
@Slf4j
public class Idea46136Service {
    private static final int IDEA_ID = 46136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46136Service() {
        this(new Idea46136Config());
    }

    public Idea46136Service(Idea46136Config config) {
        this.config = config != null ? config : new Idea46136Config();
