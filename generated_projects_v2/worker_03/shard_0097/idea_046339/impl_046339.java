...
@Data
public class Idea46339Config {
    private String name = "idea_046339";
 ...
 */
@Slf4j
public class Idea46339Service {
    private static final int IDEA_ID = 46339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46339Service() {
        this(new Idea46339Config());
    }

    public Idea46339Service(Idea46339Config config) {
        this.config = config != null ? config : new Idea46339Config();
