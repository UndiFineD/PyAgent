...
@Data
public class Idea46462Config {
    private String name = "idea_046462";
 ...
 */
@Slf4j
public class Idea46462Service {
    private static final int IDEA_ID = 46462;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46462Service() {
        this(new Idea46462Config());
    }

    public Idea46462Service(Idea46462Config config) {
        this.config = config != null ? config : new Idea46462Config();
