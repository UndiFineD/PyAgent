...
@Data
public class Idea46083Config {
    private String name = "idea_046083";
 ...
 */
@Slf4j
public class Idea46083Service {
    private static final int IDEA_ID = 46083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46083Service() {
        this(new Idea46083Config());
    }

    public Idea46083Service(Idea46083Config config) {
        this.config = config != null ? config : new Idea46083Config();
