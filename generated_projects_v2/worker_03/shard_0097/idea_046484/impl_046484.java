...
@Data
public class Idea46484Config {
    private String name = "idea_046484";
 ...
 */
@Slf4j
public class Idea46484Service {
    private static final int IDEA_ID = 46484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46484Service() {
        this(new Idea46484Config());
    }

    public Idea46484Service(Idea46484Config config) {
        this.config = config != null ? config : new Idea46484Config();
