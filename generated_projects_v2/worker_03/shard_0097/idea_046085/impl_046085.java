...
@Data
public class Idea46085Config {
    private String name = "idea_046085";
 ...
 */
@Slf4j
public class Idea46085Service {
    private static final int IDEA_ID = 46085;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46085Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46085Service() {
        this(new Idea46085Config());
    }

    public Idea46085Service(Idea46085Config config) {
        this.config = config != null ? config : new Idea46085Config();
