...
@Data
public class Idea46338Config {
    private String name = "idea_046338";
 ...
 */
@Slf4j
public class Idea46338Service {
    private static final int IDEA_ID = 46338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46338Service() {
        this(new Idea46338Config());
    }

    public Idea46338Service(Idea46338Config config) {
        this.config = config != null ? config : new Idea46338Config();
