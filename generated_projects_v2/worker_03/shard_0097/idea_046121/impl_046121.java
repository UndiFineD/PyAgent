...
@Data
public class Idea46121Config {
    private String name = "idea_046121";
 ...
 */
@Slf4j
public class Idea46121Service {
    private static final int IDEA_ID = 46121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46121Service() {
        this(new Idea46121Config());
    }

    public Idea46121Service(Idea46121Config config) {
        this.config = config != null ? config : new Idea46121Config();
