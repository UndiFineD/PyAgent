...
@Data
public class Idea46095Config {
    private String name = "idea_046095";
 ...
 */
@Slf4j
public class Idea46095Service {
    private static final int IDEA_ID = 46095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46095Service() {
        this(new Idea46095Config());
    }

    public Idea46095Service(Idea46095Config config) {
        this.config = config != null ? config : new Idea46095Config();
