...
@Data
public class Idea46325Config {
    private String name = "idea_046325";
 ...
 */
@Slf4j
public class Idea46325Service {
    private static final int IDEA_ID = 46325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46325Service() {
        this(new Idea46325Config());
    }

    public Idea46325Service(Idea46325Config config) {
        this.config = config != null ? config : new Idea46325Config();
