...
@Data
public class Idea46221Config {
    private String name = "idea_046221";
 ...
 */
@Slf4j
public class Idea46221Service {
    private static final int IDEA_ID = 46221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46221Service() {
        this(new Idea46221Config());
    }

    public Idea46221Service(Idea46221Config config) {
        this.config = config != null ? config : new Idea46221Config();
