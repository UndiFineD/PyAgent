...
@Data
public class Idea46482Config {
    private String name = "idea_046482";
 ...
 */
@Slf4j
public class Idea46482Service {
    private static final int IDEA_ID = 46482;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46482Service() {
        this(new Idea46482Config());
    }

    public Idea46482Service(Idea46482Config config) {
        this.config = config != null ? config : new Idea46482Config();
