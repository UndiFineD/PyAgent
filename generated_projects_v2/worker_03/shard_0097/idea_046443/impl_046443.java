...
@Data
public class Idea46443Config {
    private String name = "idea_046443";
 ...
 */
@Slf4j
public class Idea46443Service {
    private static final int IDEA_ID = 46443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46443Service() {
        this(new Idea46443Config());
    }

    public Idea46443Service(Idea46443Config config) {
        this.config = config != null ? config : new Idea46443Config();
