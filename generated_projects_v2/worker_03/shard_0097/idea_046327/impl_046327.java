...
@Data
public class Idea46327Config {
    private String name = "idea_046327";
 ...
 */
@Slf4j
public class Idea46327Service {
    private static final int IDEA_ID = 46327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46327Service() {
        this(new Idea46327Config());
    }

    public Idea46327Service(Idea46327Config config) {
        this.config = config != null ? config : new Idea46327Config();
