...
@Data
public class Idea46521Config {
    private String name = "idea_046521";
 ...
 */
@Slf4j
public class Idea46521Service {
    private static final int IDEA_ID = 46521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46521Service() {
        this(new Idea46521Config());
    }

    public Idea46521Service(Idea46521Config config) {
        this.config = config != null ? config : new Idea46521Config();
