...
@Data
public class Idea46251Config {
    private String name = "idea_046251";
 ...
 */
@Slf4j
public class Idea46251Service {
    private static final int IDEA_ID = 46251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46251Service() {
        this(new Idea46251Config());
    }

    public Idea46251Service(Idea46251Config config) {
        this.config = config != null ? config : new Idea46251Config();
