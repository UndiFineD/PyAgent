...
@Data
public class Idea46315Config {
    private String name = "idea_046315";
 ...
 */
@Slf4j
public class Idea46315Service {
    private static final int IDEA_ID = 46315;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46315Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46315Service() {
        this(new Idea46315Config());
    }

    public Idea46315Service(Idea46315Config config) {
        this.config = config != null ? config : new Idea46315Config();
