...
@Data
public class Idea46137Config {
    private String name = "idea_046137";
 ...
 */
@Slf4j
public class Idea46137Service {
    private static final int IDEA_ID = 46137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46137Service() {
        this(new Idea46137Config());
    }

    public Idea46137Service(Idea46137Config config) {
        this.config = config != null ? config : new Idea46137Config();
