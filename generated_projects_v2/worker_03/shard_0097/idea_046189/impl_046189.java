...
@Data
public class Idea46189Config {
    private String name = "idea_046189";
 ...
 */
@Slf4j
public class Idea46189Service {
    private static final int IDEA_ID = 46189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46189Service() {
        this(new Idea46189Config());
    }

    public Idea46189Service(Idea46189Config config) {
        this.config = config != null ? config : new Idea46189Config();
