...
@Data
public class Idea46205Config {
    private String name = "idea_046205";
 ...
 */
@Slf4j
public class Idea46205Service {
    private static final int IDEA_ID = 46205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46205Service() {
        this(new Idea46205Config());
    }

    public Idea46205Service(Idea46205Config config) {
        this.config = config != null ? config : new Idea46205Config();
