...
@Data
public class Idea46140Config {
    private String name = "idea_046140";
 ...
 */
@Slf4j
public class Idea46140Service {
    private static final int IDEA_ID = 46140;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46140Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46140Service() {
        this(new Idea46140Config());
    }

    public Idea46140Service(Idea46140Config config) {
        this.config = config != null ? config : new Idea46140Config();
