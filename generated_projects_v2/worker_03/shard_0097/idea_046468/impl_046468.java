...
@Data
public class Idea46468Config {
    private String name = "idea_046468";
 ...
 */
@Slf4j
public class Idea46468Service {
    private static final int IDEA_ID = 46468;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46468Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46468Service() {
        this(new Idea46468Config());
    }

    public Idea46468Service(Idea46468Config config) {
        this.config = config != null ? config : new Idea46468Config();
