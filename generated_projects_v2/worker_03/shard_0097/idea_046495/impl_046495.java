...
@Data
public class Idea46495Config {
    private String name = "idea_046495";
 ...
 */
@Slf4j
public class Idea46495Service {
    private static final int IDEA_ID = 46495;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46495Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46495Service() {
        this(new Idea46495Config());
    }

    public Idea46495Service(Idea46495Config config) {
        this.config = config != null ? config : new Idea46495Config();
