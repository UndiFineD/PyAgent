...
@Data
public class Idea46177Config {
    private String name = "idea_046177";
 ...
 */
@Slf4j
public class Idea46177Service {
    private static final int IDEA_ID = 46177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46177Service() {
        this(new Idea46177Config());
    }

    public Idea46177Service(Idea46177Config config) {
        this.config = config != null ? config : new Idea46177Config();
