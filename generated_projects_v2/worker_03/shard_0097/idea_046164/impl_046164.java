...
@Data
public class Idea46164Config {
    private String name = "idea_046164";
 ...
 */
@Slf4j
public class Idea46164Service {
    private static final int IDEA_ID = 46164;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46164Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46164Service() {
        this(new Idea46164Config());
    }

    public Idea46164Service(Idea46164Config config) {
        this.config = config != null ? config : new Idea46164Config();
