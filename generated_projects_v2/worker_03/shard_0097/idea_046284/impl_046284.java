...
@Data
public class Idea46284Config {
    private String name = "idea_046284";
 ...
 */
@Slf4j
public class Idea46284Service {
    private static final int IDEA_ID = 46284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46284Service() {
        this(new Idea46284Config());
    }

    public Idea46284Service(Idea46284Config config) {
        this.config = config != null ? config : new Idea46284Config();
