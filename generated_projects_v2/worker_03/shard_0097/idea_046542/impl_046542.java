...
@Data
public class Idea46542Config {
    private String name = "idea_046542";
 ...
 */
@Slf4j
public class Idea46542Service {
    private static final int IDEA_ID = 46542;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46542Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46542Service() {
        this(new Idea46542Config());
    }

    public Idea46542Service(Idea46542Config config) {
        this.config = config != null ? config : new Idea46542Config();
