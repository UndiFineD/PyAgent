...
@Data
public class Idea46415Config {
    private String name = "idea_046415";
 ...
 */
@Slf4j
public class Idea46415Service {
    private static final int IDEA_ID = 46415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46415Service() {
        this(new Idea46415Config());
    }

    public Idea46415Service(Idea46415Config config) {
        this.config = config != null ? config : new Idea46415Config();
