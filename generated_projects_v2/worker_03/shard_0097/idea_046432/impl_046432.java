...
@Data
public class Idea46432Config {
    private String name = "idea_046432";
 ...
 */
@Slf4j
public class Idea46432Service {
    private static final int IDEA_ID = 46432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46432Service() {
        this(new Idea46432Config());
    }

    public Idea46432Service(Idea46432Config config) {
        this.config = config != null ? config : new Idea46432Config();
