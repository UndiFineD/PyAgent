...
@Data
public class Idea46118Config {
    private String name = "idea_046118";
 ...
 */
@Slf4j
public class Idea46118Service {
    private static final int IDEA_ID = 46118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46118Service() {
        this(new Idea46118Config());
    }

    public Idea46118Service(Idea46118Config config) {
        this.config = config != null ? config : new Idea46118Config();
