...
@Data
public class Idea46393Config {
    private String name = "idea_046393";
 ...
 */
@Slf4j
public class Idea46393Service {
    private static final int IDEA_ID = 46393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46393Service() {
        this(new Idea46393Config());
    }

    public Idea46393Service(Idea46393Config config) {
        this.config = config != null ? config : new Idea46393Config();
