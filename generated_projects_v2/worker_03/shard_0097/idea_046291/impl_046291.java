...
@Data
public class Idea46291Config {
    private String name = "idea_046291";
 ...
 */
@Slf4j
public class Idea46291Service {
    private static final int IDEA_ID = 46291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46291Service() {
        this(new Idea46291Config());
    }

    public Idea46291Service(Idea46291Config config) {
        this.config = config != null ? config : new Idea46291Config();
