...
@Data
public class Idea46367Config {
    private String name = "idea_046367";
 ...
 */
@Slf4j
public class Idea46367Service {
    private static final int IDEA_ID = 46367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46367Service() {
        this(new Idea46367Config());
    }

    public Idea46367Service(Idea46367Config config) {
        this.config = config != null ? config : new Idea46367Config();
