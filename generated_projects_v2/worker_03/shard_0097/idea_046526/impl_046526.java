...
@Data
public class Idea46526Config {
    private String name = "idea_046526";
 ...
 */
@Slf4j
public class Idea46526Service {
    private static final int IDEA_ID = 46526;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46526Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46526Service() {
        this(new Idea46526Config());
    }

    public Idea46526Service(Idea46526Config config) {
        this.config = config != null ? config : new Idea46526Config();
