...
@Data
public class Idea46194Config {
    private String name = "idea_046194";
 ...
 */
@Slf4j
public class Idea46194Service {
    private static final int IDEA_ID = 46194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46194Service() {
        this(new Idea46194Config());
    }

    public Idea46194Service(Idea46194Config config) {
        this.config = config != null ? config : new Idea46194Config();
