...
@Data
public class Idea46478Config {
    private String name = "idea_046478";
 ...
 */
@Slf4j
public class Idea46478Service {
    private static final int IDEA_ID = 46478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46478Service() {
        this(new Idea46478Config());
    }

    public Idea46478Service(Idea46478Config config) {
        this.config = config != null ? config : new Idea46478Config();
