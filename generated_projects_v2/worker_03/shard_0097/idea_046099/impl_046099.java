...
@Data
public class Idea46099Config {
    private String name = "idea_046099";
 ...
 */
@Slf4j
public class Idea46099Service {
    private static final int IDEA_ID = 46099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46099Service() {
        this(new Idea46099Config());
    }

    public Idea46099Service(Idea46099Config config) {
        this.config = config != null ? config : new Idea46099Config();
