...
@Data
public class Idea46089Config {
    private String name = "idea_046089";
 ...
 */
@Slf4j
public class Idea46089Service {
    private static final int IDEA_ID = 46089;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46089Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46089Service() {
        this(new Idea46089Config());
    }

    public Idea46089Service(Idea46089Config config) {
        this.config = config != null ? config : new Idea46089Config();
