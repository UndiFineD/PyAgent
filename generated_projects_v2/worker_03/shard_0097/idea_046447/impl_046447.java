...
@Data
public class Idea46447Config {
    private String name = "idea_046447";
 ...
 */
@Slf4j
public class Idea46447Service {
    private static final int IDEA_ID = 46447;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46447Service() {
        this(new Idea46447Config());
    }

    public Idea46447Service(Idea46447Config config) {
        this.config = config != null ? config : new Idea46447Config();
