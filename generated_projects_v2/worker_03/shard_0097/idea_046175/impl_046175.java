...
@Data
public class Idea46175Config {
    private String name = "idea_046175";
 ...
 */
@Slf4j
public class Idea46175Service {
    private static final int IDEA_ID = 46175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46175Service() {
        this(new Idea46175Config());
    }

    public Idea46175Service(Idea46175Config config) {
        this.config = config != null ? config : new Idea46175Config();
