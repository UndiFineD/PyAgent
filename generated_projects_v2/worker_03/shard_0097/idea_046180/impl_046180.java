...
@Data
public class Idea46180Config {
    private String name = "idea_046180";
 ...
 */
@Slf4j
public class Idea46180Service {
    private static final int IDEA_ID = 46180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46180Service() {
        this(new Idea46180Config());
    }

    public Idea46180Service(Idea46180Config config) {
        this.config = config != null ? config : new Idea46180Config();
