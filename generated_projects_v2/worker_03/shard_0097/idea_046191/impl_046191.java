...
@Data
public class Idea46191Config {
    private String name = "idea_046191";
 ...
 */
@Slf4j
public class Idea46191Service {
    private static final int IDEA_ID = 46191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46191Service() {
        this(new Idea46191Config());
    }

    public Idea46191Service(Idea46191Config config) {
        this.config = config != null ? config : new Idea46191Config();
