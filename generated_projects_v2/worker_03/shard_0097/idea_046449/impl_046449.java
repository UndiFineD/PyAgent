...
@Data
public class Idea46449Config {
    private String name = "idea_046449";
 ...
 */
@Slf4j
public class Idea46449Service {
    private static final int IDEA_ID = 46449;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46449Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46449Service() {
        this(new Idea46449Config());
    }

    public Idea46449Service(Idea46449Config config) {
        this.config = config != null ? config : new Idea46449Config();
