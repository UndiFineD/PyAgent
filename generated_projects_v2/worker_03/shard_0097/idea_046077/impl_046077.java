...
@Data
public class Idea46077Config {
    private String name = "idea_046077";
 ...
 */
@Slf4j
public class Idea46077Service {
    private static final int IDEA_ID = 46077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46077Service() {
        this(new Idea46077Config());
    }

    public Idea46077Service(Idea46077Config config) {
        this.config = config != null ? config : new Idea46077Config();
