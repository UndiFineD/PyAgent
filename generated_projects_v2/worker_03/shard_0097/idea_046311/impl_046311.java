...
@Data
public class Idea46311Config {
    private String name = "idea_046311";
 ...
 */
@Slf4j
public class Idea46311Service {
    private static final int IDEA_ID = 46311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46311Service() {
        this(new Idea46311Config());
    }

    public Idea46311Service(Idea46311Config config) {
        this.config = config != null ? config : new Idea46311Config();
