...
@Data
public class Idea46548Config {
    private String name = "idea_046548";
 ...
 */
@Slf4j
public class Idea46548Service {
    private static final int IDEA_ID = 46548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46548Service() {
        this(new Idea46548Config());
    }

    public Idea46548Service(Idea46548Config config) {
        this.config = config != null ? config : new Idea46548Config();
