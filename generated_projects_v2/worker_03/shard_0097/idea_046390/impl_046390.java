...
@Data
public class Idea46390Config {
    private String name = "idea_046390";
 ...
 */
@Slf4j
public class Idea46390Service {
    private static final int IDEA_ID = 46390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46390Service() {
        this(new Idea46390Config());
    }

    public Idea46390Service(Idea46390Config config) {
        this.config = config != null ? config : new Idea46390Config();
