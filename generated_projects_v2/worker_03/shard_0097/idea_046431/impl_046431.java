...
@Data
public class Idea46431Config {
    private String name = "idea_046431";
 ...
 */
@Slf4j
public class Idea46431Service {
    private static final int IDEA_ID = 46431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46431Service() {
        this(new Idea46431Config());
    }

    public Idea46431Service(Idea46431Config config) {
        this.config = config != null ? config : new Idea46431Config();
