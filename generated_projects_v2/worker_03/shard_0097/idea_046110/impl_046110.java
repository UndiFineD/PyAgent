...
@Data
public class Idea46110Config {
    private String name = "idea_046110";
 ...
 */
@Slf4j
public class Idea46110Service {
    private static final int IDEA_ID = 46110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46110Service() {
        this(new Idea46110Config());
    }

    public Idea46110Service(Idea46110Config config) {
        this.config = config != null ? config : new Idea46110Config();
