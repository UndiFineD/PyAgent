...
@Data
public class Idea46317Config {
    private String name = "idea_046317";
 ...
 */
@Slf4j
public class Idea46317Service {
    private static final int IDEA_ID = 46317;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46317Service() {
        this(new Idea46317Config());
    }

    public Idea46317Service(Idea46317Config config) {
        this.config = config != null ? config : new Idea46317Config();
