...
@Data
public class Idea46395Config {
    private String name = "idea_046395";
 ...
 */
@Slf4j
public class Idea46395Service {
    private static final int IDEA_ID = 46395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46395Service() {
        this(new Idea46395Config());
    }

    public Idea46395Service(Idea46395Config config) {
        this.config = config != null ? config : new Idea46395Config();
