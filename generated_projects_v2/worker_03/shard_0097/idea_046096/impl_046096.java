...
@Data
public class Idea46096Config {
    private String name = "idea_046096";
 ...
 */
@Slf4j
public class Idea46096Service {
    private static final int IDEA_ID = 46096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46096Service() {
        this(new Idea46096Config());
    }

    public Idea46096Service(Idea46096Config config) {
        this.config = config != null ? config : new Idea46096Config();
