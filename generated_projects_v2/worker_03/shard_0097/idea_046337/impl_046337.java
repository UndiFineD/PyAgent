...
@Data
public class Idea46337Config {
    private String name = "idea_046337";
 ...
 */
@Slf4j
public class Idea46337Service {
    private static final int IDEA_ID = 46337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46337Service() {
        this(new Idea46337Config());
    }

    public Idea46337Service(Idea46337Config config) {
        this.config = config != null ? config : new Idea46337Config();
