...
@Data
public class Idea46213Config {
    private String name = "idea_046213";
 ...
 */
@Slf4j
public class Idea46213Service {
    private static final int IDEA_ID = 46213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46213Service() {
        this(new Idea46213Config());
    }

    public Idea46213Service(Idea46213Config config) {
        this.config = config != null ? config : new Idea46213Config();
