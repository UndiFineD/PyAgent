...
@Data
public class Idea46128Config {
    private String name = "idea_046128";
 ...
 */
@Slf4j
public class Idea46128Service {
    private static final int IDEA_ID = 46128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46128Service() {
        this(new Idea46128Config());
    }

    public Idea46128Service(Idea46128Config config) {
        this.config = config != null ? config : new Idea46128Config();
