...
@Data
public class Idea46283Config {
    private String name = "idea_046283";
 ...
 */
@Slf4j
public class Idea46283Service {
    private static final int IDEA_ID = 46283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46283Service() {
        this(new Idea46283Config());
    }

    public Idea46283Service(Idea46283Config config) {
        this.config = config != null ? config : new Idea46283Config();
