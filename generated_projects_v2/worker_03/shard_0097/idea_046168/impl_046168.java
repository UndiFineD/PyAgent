...
@Data
public class Idea46168Config {
    private String name = "idea_046168";
 ...
 */
@Slf4j
public class Idea46168Service {
    private static final int IDEA_ID = 46168;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46168Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46168Service() {
        this(new Idea46168Config());
    }

    public Idea46168Service(Idea46168Config config) {
        this.config = config != null ? config : new Idea46168Config();
