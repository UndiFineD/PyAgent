...
@Data
public class Idea46515Config {
    private String name = "idea_046515";
 ...
 */
@Slf4j
public class Idea46515Service {
    private static final int IDEA_ID = 46515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46515Service() {
        this(new Idea46515Config());
    }

    public Idea46515Service(Idea46515Config config) {
        this.config = config != null ? config : new Idea46515Config();
