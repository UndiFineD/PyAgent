...
@Data
public class Idea46489Config {
    private String name = "idea_046489";
 ...
 */
@Slf4j
public class Idea46489Service {
    private static final int IDEA_ID = 46489;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46489Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46489Service() {
        this(new Idea46489Config());
    }

    public Idea46489Service(Idea46489Config config) {
        this.config = config != null ? config : new Idea46489Config();
