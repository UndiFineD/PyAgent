...
@Data
public class Idea46442Config {
    private String name = "idea_046442";
 ...
 */
@Slf4j
public class Idea46442Service {
    private static final int IDEA_ID = 46442;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46442Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46442Service() {
        this(new Idea46442Config());
    }

    public Idea46442Service(Idea46442Config config) {
        this.config = config != null ? config : new Idea46442Config();
