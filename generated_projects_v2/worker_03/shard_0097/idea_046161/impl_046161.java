...
@Data
public class Idea46161Config {
    private String name = "idea_046161";
 ...
 */
@Slf4j
public class Idea46161Service {
    private static final int IDEA_ID = 46161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46161Service() {
        this(new Idea46161Config());
    }

    public Idea46161Service(Idea46161Config config) {
        this.config = config != null ? config : new Idea46161Config();
