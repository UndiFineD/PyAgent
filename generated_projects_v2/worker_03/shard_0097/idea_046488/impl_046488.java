...
@Data
public class Idea46488Config {
    private String name = "idea_046488";
 ...
 */
@Slf4j
public class Idea46488Service {
    private static final int IDEA_ID = 46488;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46488Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46488Service() {
        this(new Idea46488Config());
    }

    public Idea46488Service(Idea46488Config config) {
        this.config = config != null ? config : new Idea46488Config();
