...
@Data
public class Idea46514Config {
    private String name = "idea_046514";
 ...
 */
@Slf4j
public class Idea46514Service {
    private static final int IDEA_ID = 46514;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46514Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46514Service() {
        this(new Idea46514Config());
    }

    public Idea46514Service(Idea46514Config config) {
        this.config = config != null ? config : new Idea46514Config();
