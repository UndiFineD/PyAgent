...
@Data
public class Idea46360Config {
    private String name = "idea_046360";
 ...
 */
@Slf4j
public class Idea46360Service {
    private static final int IDEA_ID = 46360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46360Service() {
        this(new Idea46360Config());
    }

    public Idea46360Service(Idea46360Config config) {
        this.config = config != null ? config : new Idea46360Config();
