...
@Data
public class Idea46424Config {
    private String name = "idea_046424";
 ...
 */
@Slf4j
public class Idea46424Service {
    private static final int IDEA_ID = 46424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46424Service() {
        this(new Idea46424Config());
    }

    public Idea46424Service(Idea46424Config config) {
        this.config = config != null ? config : new Idea46424Config();
