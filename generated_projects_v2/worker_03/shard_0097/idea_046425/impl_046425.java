...
@Data
public class Idea46425Config {
    private String name = "idea_046425";
 ...
 */
@Slf4j
public class Idea46425Service {
    private static final int IDEA_ID = 46425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46425Service() {
        this(new Idea46425Config());
    }

    public Idea46425Service(Idea46425Config config) {
        this.config = config != null ? config : new Idea46425Config();
