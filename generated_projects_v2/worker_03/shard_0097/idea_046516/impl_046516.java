...
@Data
public class Idea46516Config {
    private String name = "idea_046516";
 ...
 */
@Slf4j
public class Idea46516Service {
    private static final int IDEA_ID = 46516;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46516Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46516Service() {
        this(new Idea46516Config());
    }

    public Idea46516Service(Idea46516Config config) {
        this.config = config != null ? config : new Idea46516Config();
