...
@Data
public class Idea46368Config {
    private String name = "idea_046368";
 ...
 */
@Slf4j
public class Idea46368Service {
    private static final int IDEA_ID = 46368;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46368Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46368Service() {
        this(new Idea46368Config());
    }

    public Idea46368Service(Idea46368Config config) {
        this.config = config != null ? config : new Idea46368Config();
