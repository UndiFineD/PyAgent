...
@Data
public class Idea46236Config {
    private String name = "idea_046236";
 ...
 */
@Slf4j
public class Idea46236Service {
    private static final int IDEA_ID = 46236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46236Service() {
        this(new Idea46236Config());
    }

    public Idea46236Service(Idea46236Config config) {
        this.config = config != null ? config : new Idea46236Config();
