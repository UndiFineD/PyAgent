...
@Data
public class Idea46403Config {
    private String name = "idea_046403";
 ...
 */
@Slf4j
public class Idea46403Service {
    private static final int IDEA_ID = 46403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46403Service() {
        this(new Idea46403Config());
    }

    public Idea46403Service(Idea46403Config config) {
        this.config = config != null ? config : new Idea46403Config();
