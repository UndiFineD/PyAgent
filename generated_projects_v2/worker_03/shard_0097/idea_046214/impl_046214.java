...
@Data
public class Idea46214Config {
    private String name = "idea_046214";
 ...
 */
@Slf4j
public class Idea46214Service {
    private static final int IDEA_ID = 46214;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46214Service() {
        this(new Idea46214Config());
    }

    public Idea46214Service(Idea46214Config config) {
        this.config = config != null ? config : new Idea46214Config();
