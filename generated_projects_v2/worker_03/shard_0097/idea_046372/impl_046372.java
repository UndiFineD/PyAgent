...
@Data
public class Idea46372Config {
    private String name = "idea_046372";
 ...
 */
@Slf4j
public class Idea46372Service {
    private static final int IDEA_ID = 46372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46372Service() {
        this(new Idea46372Config());
    }

    public Idea46372Service(Idea46372Config config) {
        this.config = config != null ? config : new Idea46372Config();
