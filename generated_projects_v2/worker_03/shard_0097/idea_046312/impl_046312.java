...
@Data
public class Idea46312Config {
    private String name = "idea_046312";
 ...
 */
@Slf4j
public class Idea46312Service {
    private static final int IDEA_ID = 46312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46312Service() {
        this(new Idea46312Config());
    }

    public Idea46312Service(Idea46312Config config) {
        this.config = config != null ? config : new Idea46312Config();
