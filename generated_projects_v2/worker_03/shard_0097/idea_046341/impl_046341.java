...
@Data
public class Idea46341Config {
    private String name = "idea_046341";
 ...
 */
@Slf4j
public class Idea46341Service {
    private static final int IDEA_ID = 46341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46341Service() {
        this(new Idea46341Config());
    }

    public Idea46341Service(Idea46341Config config) {
        this.config = config != null ? config : new Idea46341Config();
