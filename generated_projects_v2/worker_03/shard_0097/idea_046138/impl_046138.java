...
@Data
public class Idea46138Config {
    private String name = "idea_046138";
 ...
 */
@Slf4j
public class Idea46138Service {
    private static final int IDEA_ID = 46138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46138Service() {
        this(new Idea46138Config());
    }

    public Idea46138Service(Idea46138Config config) {
        this.config = config != null ? config : new Idea46138Config();
