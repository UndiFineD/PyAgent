...
@Data
public class Idea46183Config {
    private String name = "idea_046183";
 ...
 */
@Slf4j
public class Idea46183Service {
    private static final int IDEA_ID = 46183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46183Service() {
        this(new Idea46183Config());
    }

    public Idea46183Service(Idea46183Config config) {
        this.config = config != null ? config : new Idea46183Config();
