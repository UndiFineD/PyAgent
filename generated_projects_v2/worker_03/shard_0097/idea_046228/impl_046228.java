...
@Data
public class Idea46228Config {
    private String name = "idea_046228";
 ...
 */
@Slf4j
public class Idea46228Service {
    private static final int IDEA_ID = 46228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46228Service() {
        this(new Idea46228Config());
    }

    public Idea46228Service(Idea46228Config config) {
        this.config = config != null ? config : new Idea46228Config();
