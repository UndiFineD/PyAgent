...
@Data
public class Idea46332Config {
    private String name = "idea_046332";
 ...
 */
@Slf4j
public class Idea46332Service {
    private static final int IDEA_ID = 46332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46332Service() {
        this(new Idea46332Config());
    }

    public Idea46332Service(Idea46332Config config) {
        this.config = config != null ? config : new Idea46332Config();
