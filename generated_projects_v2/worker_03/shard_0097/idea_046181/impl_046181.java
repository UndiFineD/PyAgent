...
@Data
public class Idea46181Config {
    private String name = "idea_046181";
 ...
 */
@Slf4j
public class Idea46181Service {
    private static final int IDEA_ID = 46181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46181Service() {
        this(new Idea46181Config());
    }

    public Idea46181Service(Idea46181Config config) {
        this.config = config != null ? config : new Idea46181Config();
