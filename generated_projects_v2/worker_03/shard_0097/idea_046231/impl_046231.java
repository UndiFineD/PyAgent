...
@Data
public class Idea46231Config {
    private String name = "idea_046231";
 ...
 */
@Slf4j
public class Idea46231Service {
    private static final int IDEA_ID = 46231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46231Service() {
        this(new Idea46231Config());
    }

    public Idea46231Service(Idea46231Config config) {
        this.config = config != null ? config : new Idea46231Config();
