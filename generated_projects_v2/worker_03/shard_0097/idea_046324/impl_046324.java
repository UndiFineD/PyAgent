...
@Data
public class Idea46324Config {
    private String name = "idea_046324";
 ...
 */
@Slf4j
public class Idea46324Service {
    private static final int IDEA_ID = 46324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46324Service() {
        this(new Idea46324Config());
    }

    public Idea46324Service(Idea46324Config config) {
        this.config = config != null ? config : new Idea46324Config();
