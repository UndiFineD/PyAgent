...
@Data
public class Idea46471Config {
    private String name = "idea_046471";
 ...
 */
@Slf4j
public class Idea46471Service {
    private static final int IDEA_ID = 46471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46471Service() {
        this(new Idea46471Config());
    }

    public Idea46471Service(Idea46471Config config) {
        this.config = config != null ? config : new Idea46471Config();
