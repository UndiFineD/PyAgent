...
@Data
public class Idea46226Config {
    private String name = "idea_046226";
 ...
 */
@Slf4j
public class Idea46226Service {
    private static final int IDEA_ID = 46226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46226Service() {
        this(new Idea46226Config());
    }

    public Idea46226Service(Idea46226Config config) {
        this.config = config != null ? config : new Idea46226Config();
