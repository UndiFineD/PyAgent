...
@Data
public class Idea46527Config {
    private String name = "idea_046527";
 ...
 */
@Slf4j
public class Idea46527Service {
    private static final int IDEA_ID = 46527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46527Service() {
        this(new Idea46527Config());
    }

    public Idea46527Service(Idea46527Config config) {
        this.config = config != null ? config : new Idea46527Config();
