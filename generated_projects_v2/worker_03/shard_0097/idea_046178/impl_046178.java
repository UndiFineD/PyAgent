...
@Data
public class Idea46178Config {
    private String name = "idea_046178";
 ...
 */
@Slf4j
public class Idea46178Service {
    private static final int IDEA_ID = 46178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46178Service() {
        this(new Idea46178Config());
    }

    public Idea46178Service(Idea46178Config config) {
        this.config = config != null ? config : new Idea46178Config();
