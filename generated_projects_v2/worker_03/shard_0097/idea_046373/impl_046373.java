...
@Data
public class Idea46373Config {
    private String name = "idea_046373";
 ...
 */
@Slf4j
public class Idea46373Service {
    private static final int IDEA_ID = 46373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46373Service() {
        this(new Idea46373Config());
    }

    public Idea46373Service(Idea46373Config config) {
        this.config = config != null ? config : new Idea46373Config();
