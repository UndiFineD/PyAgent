...
@Data
public class Idea46412Config {
    private String name = "idea_046412";
 ...
 */
@Slf4j
public class Idea46412Service {
    private static final int IDEA_ID = 46412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46412Service() {
        this(new Idea46412Config());
    }

    public Idea46412Service(Idea46412Config config) {
        this.config = config != null ? config : new Idea46412Config();
