...
@Data
public class Idea46133Config {
    private String name = "idea_046133";
 ...
 */
@Slf4j
public class Idea46133Service {
    private static final int IDEA_ID = 46133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46133Service() {
        this(new Idea46133Config());
    }

    public Idea46133Service(Idea46133Config config) {
        this.config = config != null ? config : new Idea46133Config();
