...
@Data
public class Idea46207Config {
    private String name = "idea_046207";
 ...
 */
@Slf4j
public class Idea46207Service {
    private static final int IDEA_ID = 46207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46207Service() {
        this(new Idea46207Config());
    }

    public Idea46207Service(Idea46207Config config) {
        this.config = config != null ? config : new Idea46207Config();
