...
@Data
public class Idea46428Config {
    private String name = "idea_046428";
 ...
 */
@Slf4j
public class Idea46428Service {
    private static final int IDEA_ID = 46428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46428Service() {
        this(new Idea46428Config());
    }

    public Idea46428Service(Idea46428Config config) {
        this.config = config != null ? config : new Idea46428Config();
