...
@Data
public class Idea46496Config {
    private String name = "idea_046496";
 ...
 */
@Slf4j
public class Idea46496Service {
    private static final int IDEA_ID = 46496;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46496Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46496Service() {
        this(new Idea46496Config());
    }

    public Idea46496Service(Idea46496Config config) {
        this.config = config != null ? config : new Idea46496Config();
