...
@Data
public class Idea46116Config {
    private String name = "idea_046116";
 ...
 */
@Slf4j
public class Idea46116Service {
    private static final int IDEA_ID = 46116;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46116Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46116Service() {
        this(new Idea46116Config());
    }

    public Idea46116Service(Idea46116Config config) {
        this.config = config != null ? config : new Idea46116Config();
