...
@Data
public class Idea46353Config {
    private String name = "idea_046353";
 ...
 */
@Slf4j
public class Idea46353Service {
    private static final int IDEA_ID = 46353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46353Service() {
        this(new Idea46353Config());
    }

    public Idea46353Service(Idea46353Config config) {
        this.config = config != null ? config : new Idea46353Config();
