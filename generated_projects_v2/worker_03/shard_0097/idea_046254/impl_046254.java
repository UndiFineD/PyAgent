...
@Data
public class Idea46254Config {
    private String name = "idea_046254";
 ...
 */
@Slf4j
public class Idea46254Service {
    private static final int IDEA_ID = 46254;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46254Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46254Service() {
        this(new Idea46254Config());
    }

    public Idea46254Service(Idea46254Config config) {
        this.config = config != null ? config : new Idea46254Config();
