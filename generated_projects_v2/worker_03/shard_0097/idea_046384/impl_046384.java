...
@Data
public class Idea46384Config {
    private String name = "idea_046384";
 ...
 */
@Slf4j
public class Idea46384Service {
    private static final int IDEA_ID = 46384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46384Service() {
        this(new Idea46384Config());
    }

    public Idea46384Service(Idea46384Config config) {
        this.config = config != null ? config : new Idea46384Config();
