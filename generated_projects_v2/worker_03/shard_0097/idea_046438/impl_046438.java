...
@Data
public class Idea46438Config {
    private String name = "idea_046438";
 ...
 */
@Slf4j
public class Idea46438Service {
    private static final int IDEA_ID = 46438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46438Service() {
        this(new Idea46438Config());
    }

    public Idea46438Service(Idea46438Config config) {
        this.config = config != null ? config : new Idea46438Config();
