...
@Data
public class Idea46321Config {
    private String name = "idea_046321";
 ...
 */
@Slf4j
public class Idea46321Service {
    private static final int IDEA_ID = 46321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46321Service() {
        this(new Idea46321Config());
    }

    public Idea46321Service(Idea46321Config config) {
        this.config = config != null ? config : new Idea46321Config();
