...
@Data
public class Idea46523Config {
    private String name = "idea_046523";
 ...
 */
@Slf4j
public class Idea46523Service {
    private static final int IDEA_ID = 46523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46523Service() {
        this(new Idea46523Config());
    }

    public Idea46523Service(Idea46523Config config) {
        this.config = config != null ? config : new Idea46523Config();
