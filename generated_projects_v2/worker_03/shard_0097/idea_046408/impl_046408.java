...
@Data
public class Idea46408Config {
    private String name = "idea_046408";
 ...
 */
@Slf4j
public class Idea46408Service {
    private static final int IDEA_ID = 46408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46408Service() {
        this(new Idea46408Config());
    }

    public Idea46408Service(Idea46408Config config) {
        this.config = config != null ? config : new Idea46408Config();
