...
@Data
public class Idea46473Config {
    private String name = "idea_046473";
 ...
 */
@Slf4j
public class Idea46473Service {
    private static final int IDEA_ID = 46473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46473Service() {
        this(new Idea46473Config());
    }

    public Idea46473Service(Idea46473Config config) {
        this.config = config != null ? config : new Idea46473Config();
