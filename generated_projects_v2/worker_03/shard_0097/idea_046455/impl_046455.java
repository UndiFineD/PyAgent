...
@Data
public class Idea46455Config {
    private String name = "idea_046455";
 ...
 */
@Slf4j
public class Idea46455Service {
    private static final int IDEA_ID = 46455;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46455Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46455Service() {
        this(new Idea46455Config());
    }

    public Idea46455Service(Idea46455Config config) {
        this.config = config != null ? config : new Idea46455Config();
