...
@Data
public class Idea46524Config {
    private String name = "idea_046524";
 ...
 */
@Slf4j
public class Idea46524Service {
    private static final int IDEA_ID = 46524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46524Service() {
        this(new Idea46524Config());
    }

    public Idea46524Service(Idea46524Config config) {
        this.config = config != null ? config : new Idea46524Config();
