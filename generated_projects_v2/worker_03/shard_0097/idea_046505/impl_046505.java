...
@Data
public class Idea46505Config {
    private String name = "idea_046505";
 ...
 */
@Slf4j
public class Idea46505Service {
    private static final int IDEA_ID = 46505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46505Service() {
        this(new Idea46505Config());
    }

    public Idea46505Service(Idea46505Config config) {
        this.config = config != null ? config : new Idea46505Config();
