...
@Data
public class Idea46506Config {
    private String name = "idea_046506";
 ...
 */
@Slf4j
public class Idea46506Service {
    private static final int IDEA_ID = 46506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46506Service() {
        this(new Idea46506Config());
    }

    public Idea46506Service(Idea46506Config config) {
        this.config = config != null ? config : new Idea46506Config();
