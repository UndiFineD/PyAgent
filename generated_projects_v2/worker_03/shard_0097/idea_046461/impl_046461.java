...
@Data
public class Idea46461Config {
    private String name = "idea_046461";
 ...
 */
@Slf4j
public class Idea46461Service {
    private static final int IDEA_ID = 46461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46461Service() {
        this(new Idea46461Config());
    }

    public Idea46461Service(Idea46461Config config) {
        this.config = config != null ? config : new Idea46461Config();
