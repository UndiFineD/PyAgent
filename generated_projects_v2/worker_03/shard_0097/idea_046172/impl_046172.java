...
@Data
public class Idea46172Config {
    private String name = "idea_046172";
 ...
 */
@Slf4j
public class Idea46172Service {
    private static final int IDEA_ID = 46172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46172Service() {
        this(new Idea46172Config());
    }

    public Idea46172Service(Idea46172Config config) {
        this.config = config != null ? config : new Idea46172Config();
