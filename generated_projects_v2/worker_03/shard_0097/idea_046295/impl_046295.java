...
@Data
public class Idea46295Config {
    private String name = "idea_046295";
 ...
 */
@Slf4j
public class Idea46295Service {
    private static final int IDEA_ID = 46295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46295Service() {
        this(new Idea46295Config());
    }

    public Idea46295Service(Idea46295Config config) {
        this.config = config != null ? config : new Idea46295Config();
