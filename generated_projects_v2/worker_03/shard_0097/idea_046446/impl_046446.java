...
@Data
public class Idea46446Config {
    private String name = "idea_046446";
 ...
 */
@Slf4j
public class Idea46446Service {
    private static final int IDEA_ID = 46446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46446Service() {
        this(new Idea46446Config());
    }

    public Idea46446Service(Idea46446Config config) {
        this.config = config != null ? config : new Idea46446Config();
