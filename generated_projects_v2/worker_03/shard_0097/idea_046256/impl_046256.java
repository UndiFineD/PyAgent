...
@Data
public class Idea46256Config {
    private String name = "idea_046256";
 ...
 */
@Slf4j
public class Idea46256Service {
    private static final int IDEA_ID = 46256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46256Service() {
        this(new Idea46256Config());
    }

    public Idea46256Service(Idea46256Config config) {
        this.config = config != null ? config : new Idea46256Config();
