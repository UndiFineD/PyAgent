...
@Data
public class Idea46268Config {
    private String name = "idea_046268";
 ...
 */
@Slf4j
public class Idea46268Service {
    private static final int IDEA_ID = 46268;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46268Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46268Service() {
        this(new Idea46268Config());
    }

    public Idea46268Service(Idea46268Config config) {
        this.config = config != null ? config : new Idea46268Config();
