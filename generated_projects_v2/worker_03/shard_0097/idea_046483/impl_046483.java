...
@Data
public class Idea46483Config {
    private String name = "idea_046483";
 ...
 */
@Slf4j
public class Idea46483Service {
    private static final int IDEA_ID = 46483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46483Service() {
        this(new Idea46483Config());
    }

    public Idea46483Service(Idea46483Config config) {
        this.config = config != null ? config : new Idea46483Config();
