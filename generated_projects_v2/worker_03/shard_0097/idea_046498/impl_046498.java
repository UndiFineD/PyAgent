...
@Data
public class Idea46498Config {
    private String name = "idea_046498";
 ...
 */
@Slf4j
public class Idea46498Service {
    private static final int IDEA_ID = 46498;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46498Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46498Service() {
        this(new Idea46498Config());
    }

    public Idea46498Service(Idea46498Config config) {
        this.config = config != null ? config : new Idea46498Config();
