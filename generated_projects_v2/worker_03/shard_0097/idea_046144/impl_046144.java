...
@Data
public class Idea46144Config {
    private String name = "idea_046144";
 ...
 */
@Slf4j
public class Idea46144Service {
    private static final int IDEA_ID = 46144;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46144Service() {
        this(new Idea46144Config());
    }

    public Idea46144Service(Idea46144Config config) {
        this.config = config != null ? config : new Idea46144Config();
