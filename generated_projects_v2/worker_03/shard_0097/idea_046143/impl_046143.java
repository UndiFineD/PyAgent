...
@Data
public class Idea46143Config {
    private String name = "idea_046143";
 ...
 */
@Slf4j
public class Idea46143Service {
    private static final int IDEA_ID = 46143;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46143Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46143Service() {
        this(new Idea46143Config());
    }

    public Idea46143Service(Idea46143Config config) {
        this.config = config != null ? config : new Idea46143Config();
