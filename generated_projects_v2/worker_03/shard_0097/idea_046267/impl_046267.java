...
@Data
public class Idea46267Config {
    private String name = "idea_046267";
 ...
 */
@Slf4j
public class Idea46267Service {
    private static final int IDEA_ID = 46267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46267Service() {
        this(new Idea46267Config());
    }

    public Idea46267Service(Idea46267Config config) {
        this.config = config != null ? config : new Idea46267Config();
