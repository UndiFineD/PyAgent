...
@Data
public class Idea46276Config {
    private String name = "idea_046276";
 ...
 */
@Slf4j
public class Idea46276Service {
    private static final int IDEA_ID = 46276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46276Service() {
        this(new Idea46276Config());
    }

    public Idea46276Service(Idea46276Config config) {
        this.config = config != null ? config : new Idea46276Config();
