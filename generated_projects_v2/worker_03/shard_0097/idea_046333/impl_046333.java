...
@Data
public class Idea46333Config {
    private String name = "idea_046333";
 ...
 */
@Slf4j
public class Idea46333Service {
    private static final int IDEA_ID = 46333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46333Service() {
        this(new Idea46333Config());
    }

    public Idea46333Service(Idea46333Config config) {
        this.config = config != null ? config : new Idea46333Config();
