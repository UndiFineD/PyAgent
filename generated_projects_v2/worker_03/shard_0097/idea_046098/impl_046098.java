...
@Data
public class Idea46098Config {
    private String name = "idea_046098";
 ...
 */
@Slf4j
public class Idea46098Service {
    private static final int IDEA_ID = 46098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46098Service() {
        this(new Idea46098Config());
    }

    public Idea46098Service(Idea46098Config config) {
        this.config = config != null ? config : new Idea46098Config();
