...
@Data
public class Idea46351Config {
    private String name = "idea_046351";
 ...
 */
@Slf4j
public class Idea46351Service {
    private static final int IDEA_ID = 46351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46351Service() {
        this(new Idea46351Config());
    }

    public Idea46351Service(Idea46351Config config) {
        this.config = config != null ? config : new Idea46351Config();
