...
@Data
public class Idea53764Config {
    private String name = "idea_053764";
 ...
 */
@Slf4j
public class Idea53764Service {
    private static final int IDEA_ID = 53764;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53764Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53764Service() {
        this(new Idea53764Config());
    }

    public Idea53764Service(Idea53764Config config) {
        this.config = config != null ? config : new Idea53764Config();
