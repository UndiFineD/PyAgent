...
@Data
public class Idea53833Config {
    private String name = "idea_053833";
 ...
 */
@Slf4j
public class Idea53833Service {
    private static final int IDEA_ID = 53833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53833Service() {
        this(new Idea53833Config());
    }

    public Idea53833Service(Idea53833Config config) {
        this.config = config != null ? config : new Idea53833Config();
