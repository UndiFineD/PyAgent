...
@Data
public class Idea53851Config {
    private String name = "idea_053851";
 ...
 */
@Slf4j
public class Idea53851Service {
    private static final int IDEA_ID = 53851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53851Service() {
        this(new Idea53851Config());
    }

    public Idea53851Service(Idea53851Config config) {
        this.config = config != null ? config : new Idea53851Config();
