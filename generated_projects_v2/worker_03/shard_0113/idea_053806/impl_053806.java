...
@Data
public class Idea53806Config {
    private String name = "idea_053806";
 ...
 */
@Slf4j
public class Idea53806Service {
    private static final int IDEA_ID = 53806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53806Service() {
        this(new Idea53806Config());
    }

    public Idea53806Service(Idea53806Config config) {
        this.config = config != null ? config : new Idea53806Config();
