...
@Data
public class Idea53807Config {
    private String name = "idea_053807";
 ...
 */
@Slf4j
public class Idea53807Service {
    private static final int IDEA_ID = 53807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53807Service() {
        this(new Idea53807Config());
    }

    public Idea53807Service(Idea53807Config config) {
        this.config = config != null ? config : new Idea53807Config();
