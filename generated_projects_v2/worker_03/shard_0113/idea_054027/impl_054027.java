...
@Data
public class Idea54027Config {
    private String name = "idea_054027";
 ...
 */
@Slf4j
public class Idea54027Service {
    private static final int IDEA_ID = 54027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54027Service() {
        this(new Idea54027Config());
    }

    public Idea54027Service(Idea54027Config config) {
        this.config = config != null ? config : new Idea54027Config();
