...
@Data
public class Idea53721Config {
    private String name = "idea_053721";
 ...
 */
@Slf4j
public class Idea53721Service {
    private static final int IDEA_ID = 53721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53721Service() {
        this(new Idea53721Config());
    }

    public Idea53721Service(Idea53721Config config) {
        this.config = config != null ? config : new Idea53721Config();
