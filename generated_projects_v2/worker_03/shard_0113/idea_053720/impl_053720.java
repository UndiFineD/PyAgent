...
@Data
public class Idea53720Config {
    private String name = "idea_053720";
 ...
 */
@Slf4j
public class Idea53720Service {
    private static final int IDEA_ID = 53720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53720Service() {
        this(new Idea53720Config());
    }

    public Idea53720Service(Idea53720Config config) {
        this.config = config != null ? config : new Idea53720Config();
