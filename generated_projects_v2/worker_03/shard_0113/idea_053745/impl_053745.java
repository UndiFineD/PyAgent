...
@Data
public class Idea53745Config {
    private String name = "idea_053745";
 ...
 */
@Slf4j
public class Idea53745Service {
    private static final int IDEA_ID = 53745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53745Service() {
        this(new Idea53745Config());
    }

    public Idea53745Service(Idea53745Config config) {
        this.config = config != null ? config : new Idea53745Config();
