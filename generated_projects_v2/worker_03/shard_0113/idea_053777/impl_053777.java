...
@Data
public class Idea53777Config {
    private String name = "idea_053777";
 ...
 */
@Slf4j
public class Idea53777Service {
    private static final int IDEA_ID = 53777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53777Service() {
        this(new Idea53777Config());
    }

    public Idea53777Service(Idea53777Config config) {
        this.config = config != null ? config : new Idea53777Config();
