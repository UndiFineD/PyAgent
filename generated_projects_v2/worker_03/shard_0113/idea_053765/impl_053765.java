...
@Data
public class Idea53765Config {
    private String name = "idea_053765";
 ...
 */
@Slf4j
public class Idea53765Service {
    private static final int IDEA_ID = 53765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53765Service() {
        this(new Idea53765Config());
    }

    public Idea53765Service(Idea53765Config config) {
        this.config = config != null ? config : new Idea53765Config();
