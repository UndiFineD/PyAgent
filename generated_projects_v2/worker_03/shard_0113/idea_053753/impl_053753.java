...
@Data
public class Idea53753Config {
    private String name = "idea_053753";
 ...
 */
@Slf4j
public class Idea53753Service {
    private static final int IDEA_ID = 53753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53753Service() {
        this(new Idea53753Config());
    }

    public Idea53753Service(Idea53753Config config) {
        this.config = config != null ? config : new Idea53753Config();
