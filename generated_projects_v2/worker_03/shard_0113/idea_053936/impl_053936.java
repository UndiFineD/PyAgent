...
@Data
public class Idea53936Config {
    private String name = "idea_053936";
 ...
 */
@Slf4j
public class Idea53936Service {
    private static final int IDEA_ID = 53936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53936Service() {
        this(new Idea53936Config());
    }

    public Idea53936Service(Idea53936Config config) {
        this.config = config != null ? config : new Idea53936Config();
