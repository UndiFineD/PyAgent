...
@Data
public class Idea53715Config {
    private String name = "idea_053715";
 ...
 */
@Slf4j
public class Idea53715Service {
    private static final int IDEA_ID = 53715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53715Service() {
        this(new Idea53715Config());
    }

    public Idea53715Service(Idea53715Config config) {
        this.config = config != null ? config : new Idea53715Config();
