...
@Data
public class Idea54086Config {
    private String name = "idea_054086";
 ...
 */
@Slf4j
public class Idea54086Service {
    private static final int IDEA_ID = 54086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54086Service() {
        this(new Idea54086Config());
    }

    public Idea54086Service(Idea54086Config config) {
        this.config = config != null ? config : new Idea54086Config();
