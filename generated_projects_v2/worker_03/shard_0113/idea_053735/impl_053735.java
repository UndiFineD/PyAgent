...
@Data
public class Idea53735Config {
    private String name = "idea_053735";
 ...
 */
@Slf4j
public class Idea53735Service {
    private static final int IDEA_ID = 53735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53735Service() {
        this(new Idea53735Config());
    }

    public Idea53735Service(Idea53735Config config) {
        this.config = config != null ? config : new Idea53735Config();
