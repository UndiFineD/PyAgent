...
@Data
public class Idea53872Config {
    private String name = "idea_053872";
 ...
 */
@Slf4j
public class Idea53872Service {
    private static final int IDEA_ID = 53872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53872Service() {
        this(new Idea53872Config());
    }

    public Idea53872Service(Idea53872Config config) {
        this.config = config != null ? config : new Idea53872Config();
