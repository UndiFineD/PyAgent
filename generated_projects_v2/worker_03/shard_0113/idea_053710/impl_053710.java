...
@Data
public class Idea53710Config {
    private String name = "idea_053710";
 ...
 */
@Slf4j
public class Idea53710Service {
    private static final int IDEA_ID = 53710;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53710Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53710Service() {
        this(new Idea53710Config());
    }

    public Idea53710Service(Idea53710Config config) {
        this.config = config != null ? config : new Idea53710Config();
