...
@Data
public class Idea53755Config {
    private String name = "idea_053755";
 ...
 */
@Slf4j
public class Idea53755Service {
    private static final int IDEA_ID = 53755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53755Service() {
        this(new Idea53755Config());
    }

    public Idea53755Service(Idea53755Config config) {
        this.config = config != null ? config : new Idea53755Config();
