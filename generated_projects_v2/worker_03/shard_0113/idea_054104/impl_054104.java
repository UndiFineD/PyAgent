...
@Data
public class Idea54104Config {
    private String name = "idea_054104";
 ...
 */
@Slf4j
public class Idea54104Service {
    private static final int IDEA_ID = 54104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54104Service() {
        this(new Idea54104Config());
    }

    public Idea54104Service(Idea54104Config config) {
        this.config = config != null ? config : new Idea54104Config();
