...
@Data
public class Idea54090Config {
    private String name = "idea_054090";
 ...
 */
@Slf4j
public class Idea54090Service {
    private static final int IDEA_ID = 54090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54090Service() {
        this(new Idea54090Config());
    }

    public Idea54090Service(Idea54090Config config) {
        this.config = config != null ? config : new Idea54090Config();
