...
@Data
public class Idea53733Config {
    private String name = "idea_053733";
 ...
 */
@Slf4j
public class Idea53733Service {
    private static final int IDEA_ID = 53733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53733Service() {
        this(new Idea53733Config());
    }

    public Idea53733Service(Idea53733Config config) {
        this.config = config != null ? config : new Idea53733Config();
