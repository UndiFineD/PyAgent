...
@Data
public class Idea53952Config {
    private String name = "idea_053952";
 ...
 */
@Slf4j
public class Idea53952Service {
    private static final int IDEA_ID = 53952;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53952Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53952Service() {
        this(new Idea53952Config());
    }

    public Idea53952Service(Idea53952Config config) {
        this.config = config != null ? config : new Idea53952Config();
