...
@Data
public class Idea54038Config {
    private String name = "idea_054038";
 ...
 */
@Slf4j
public class Idea54038Service {
    private static final int IDEA_ID = 54038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54038Service() {
        this(new Idea54038Config());
    }

    public Idea54038Service(Idea54038Config config) {
        this.config = config != null ? config : new Idea54038Config();
