...
@Data
public class Idea53875Config {
    private String name = "idea_053875";
 ...
 */
@Slf4j
public class Idea53875Service {
    private static final int IDEA_ID = 53875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53875Service() {
        this(new Idea53875Config());
    }

    public Idea53875Service(Idea53875Config config) {
        this.config = config != null ? config : new Idea53875Config();
