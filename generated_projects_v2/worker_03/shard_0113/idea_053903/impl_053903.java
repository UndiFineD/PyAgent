...
@Data
public class Idea53903Config {
    private String name = "idea_053903";
 ...
 */
@Slf4j
public class Idea53903Service {
    private static final int IDEA_ID = 53903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53903Service() {
        this(new Idea53903Config());
    }

    public Idea53903Service(Idea53903Config config) {
        this.config = config != null ? config : new Idea53903Config();
