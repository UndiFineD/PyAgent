...
@Data
public class Idea53905Config {
    private String name = "idea_053905";
 ...
 */
@Slf4j
public class Idea53905Service {
    private static final int IDEA_ID = 53905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53905Service() {
        this(new Idea53905Config());
    }

    public Idea53905Service(Idea53905Config config) {
        this.config = config != null ? config : new Idea53905Config();
