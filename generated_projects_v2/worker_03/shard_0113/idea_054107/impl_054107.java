...
@Data
public class Idea54107Config {
    private String name = "idea_054107";
 ...
 */
@Slf4j
public class Idea54107Service {
    private static final int IDEA_ID = 54107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54107Service() {
        this(new Idea54107Config());
    }

    public Idea54107Service(Idea54107Config config) {
        this.config = config != null ? config : new Idea54107Config();
