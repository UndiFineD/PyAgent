...
@Data
public class Idea53724Config {
    private String name = "idea_053724";
 ...
 */
@Slf4j
public class Idea53724Service {
    private static final int IDEA_ID = 53724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53724Service() {
        this(new Idea53724Config());
    }

    public Idea53724Service(Idea53724Config config) {
        this.config = config != null ? config : new Idea53724Config();
