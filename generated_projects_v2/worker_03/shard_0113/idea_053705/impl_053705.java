...
@Data
public class Idea53705Config {
    private String name = "idea_053705";
 ...
 */
@Slf4j
public class Idea53705Service {
    private static final int IDEA_ID = 53705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53705Service() {
        this(new Idea53705Config());
    }

    public Idea53705Service(Idea53705Config config) {
        this.config = config != null ? config : new Idea53705Config();
