...
@Data
public class Idea53737Config {
    private String name = "idea_053737";
 ...
 */
@Slf4j
public class Idea53737Service {
    private static final int IDEA_ID = 53737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53737Service() {
        this(new Idea53737Config());
    }

    public Idea53737Service(Idea53737Config config) {
        this.config = config != null ? config : new Idea53737Config();
