...
@Data
public class Idea54017Config {
    private String name = "idea_054017";
 ...
 */
@Slf4j
public class Idea54017Service {
    private static final int IDEA_ID = 54017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54017Service() {
        this(new Idea54017Config());
    }

    public Idea54017Service(Idea54017Config config) {
        this.config = config != null ? config : new Idea54017Config();
