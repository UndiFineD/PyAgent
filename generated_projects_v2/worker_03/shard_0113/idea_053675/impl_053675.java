...
@Data
public class Idea53675Config {
    private String name = "idea_053675";
 ...
 */
@Slf4j
public class Idea53675Service {
    private static final int IDEA_ID = 53675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53675Service() {
        this(new Idea53675Config());
    }

    public Idea53675Service(Idea53675Config config) {
        this.config = config != null ? config : new Idea53675Config();
