...
@Data
public class Idea53802Config {
    private String name = "idea_053802";
 ...
 */
@Slf4j
public class Idea53802Service {
    private static final int IDEA_ID = 53802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53802Service() {
        this(new Idea53802Config());
    }

    public Idea53802Service(Idea53802Config config) {
        this.config = config != null ? config : new Idea53802Config();
