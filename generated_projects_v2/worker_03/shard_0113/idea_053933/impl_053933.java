...
@Data
public class Idea53933Config {
    private String name = "idea_053933";
 ...
 */
@Slf4j
public class Idea53933Service {
    private static final int IDEA_ID = 53933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53933Service() {
        this(new Idea53933Config());
    }

    public Idea53933Service(Idea53933Config config) {
        this.config = config != null ? config : new Idea53933Config();
