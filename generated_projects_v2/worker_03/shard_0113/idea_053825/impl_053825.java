...
@Data
public class Idea53825Config {
    private String name = "idea_053825";
 ...
 */
@Slf4j
public class Idea53825Service {
    private static final int IDEA_ID = 53825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53825Service() {
        this(new Idea53825Config());
    }

    public Idea53825Service(Idea53825Config config) {
        this.config = config != null ? config : new Idea53825Config();
