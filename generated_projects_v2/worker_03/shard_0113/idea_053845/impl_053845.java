...
@Data
public class Idea53845Config {
    private String name = "idea_053845";
 ...
 */
@Slf4j
public class Idea53845Service {
    private static final int IDEA_ID = 53845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53845Service() {
        this(new Idea53845Config());
    }

    public Idea53845Service(Idea53845Config config) {
        this.config = config != null ? config : new Idea53845Config();
