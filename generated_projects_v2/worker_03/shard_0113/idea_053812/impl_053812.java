...
@Data
public class Idea53812Config {
    private String name = "idea_053812";
 ...
 */
@Slf4j
public class Idea53812Service {
    private static final int IDEA_ID = 53812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53812Service() {
        this(new Idea53812Config());
    }

    public Idea53812Service(Idea53812Config config) {
        this.config = config != null ? config : new Idea53812Config();
