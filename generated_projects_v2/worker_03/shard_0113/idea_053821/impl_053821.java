...
@Data
public class Idea53821Config {
    private String name = "idea_053821";
 ...
 */
@Slf4j
public class Idea53821Service {
    private static final int IDEA_ID = 53821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53821Service() {
        this(new Idea53821Config());
    }

    public Idea53821Service(Idea53821Config config) {
        this.config = config != null ? config : new Idea53821Config();
