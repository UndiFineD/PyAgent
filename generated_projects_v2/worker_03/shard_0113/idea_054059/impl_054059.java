...
@Data
public class Idea54059Config {
    private String name = "idea_054059";
 ...
 */
@Slf4j
public class Idea54059Service {
    private static final int IDEA_ID = 54059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54059Service() {
        this(new Idea54059Config());
    }

    public Idea54059Service(Idea54059Config config) {
        this.config = config != null ? config : new Idea54059Config();
