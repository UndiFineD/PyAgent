...
@Data
public class Idea54021Config {
    private String name = "idea_054021";
 ...
 */
@Slf4j
public class Idea54021Service {
    private static final int IDEA_ID = 54021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54021Service() {
        this(new Idea54021Config());
    }

    public Idea54021Service(Idea54021Config config) {
        this.config = config != null ? config : new Idea54021Config();
