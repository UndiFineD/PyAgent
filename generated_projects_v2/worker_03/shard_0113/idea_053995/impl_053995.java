...
@Data
public class Idea53995Config {
    private String name = "idea_053995";
 ...
 */
@Slf4j
public class Idea53995Service {
    private static final int IDEA_ID = 53995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53995Service() {
        this(new Idea53995Config());
    }

    public Idea53995Service(Idea53995Config config) {
        this.config = config != null ? config : new Idea53995Config();
