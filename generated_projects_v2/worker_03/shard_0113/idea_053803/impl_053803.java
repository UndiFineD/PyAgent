...
@Data
public class Idea53803Config {
    private String name = "idea_053803";
 ...
 */
@Slf4j
public class Idea53803Service {
    private static final int IDEA_ID = 53803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53803Service() {
        this(new Idea53803Config());
    }

    public Idea53803Service(Idea53803Config config) {
        this.config = config != null ? config : new Idea53803Config();
