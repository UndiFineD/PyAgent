...
@Data
public class Idea53797Config {
    private String name = "idea_053797";
 ...
 */
@Slf4j
public class Idea53797Service {
    private static final int IDEA_ID = 53797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53797Service() {
        this(new Idea53797Config());
    }

    public Idea53797Service(Idea53797Config config) {
        this.config = config != null ? config : new Idea53797Config();
