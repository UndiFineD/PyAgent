...
@Data
public class Idea54137Config {
    private String name = "idea_054137";
 ...
 */
@Slf4j
public class Idea54137Service {
    private static final int IDEA_ID = 54137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54137Service() {
        this(new Idea54137Config());
    }

    public Idea54137Service(Idea54137Config config) {
        this.config = config != null ? config : new Idea54137Config();
