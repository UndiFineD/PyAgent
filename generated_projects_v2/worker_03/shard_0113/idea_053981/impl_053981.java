...
@Data
public class Idea53981Config {
    private String name = "idea_053981";
 ...
 */
@Slf4j
public class Idea53981Service {
    private static final int IDEA_ID = 53981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53981Service() {
        this(new Idea53981Config());
    }

    public Idea53981Service(Idea53981Config config) {
        this.config = config != null ? config : new Idea53981Config();
