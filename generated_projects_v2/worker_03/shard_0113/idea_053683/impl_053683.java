...
@Data
public class Idea53683Config {
    private String name = "idea_053683";
 ...
 */
@Slf4j
public class Idea53683Service {
    private static final int IDEA_ID = 53683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53683Service() {
        this(new Idea53683Config());
    }

    public Idea53683Service(Idea53683Config config) {
        this.config = config != null ? config : new Idea53683Config();
