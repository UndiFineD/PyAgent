...
@Data
public class Idea53985Config {
    private String name = "idea_053985";
 ...
 */
@Slf4j
public class Idea53985Service {
    private static final int IDEA_ID = 53985;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53985Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53985Service() {
        this(new Idea53985Config());
    }

    public Idea53985Service(Idea53985Config config) {
        this.config = config != null ? config : new Idea53985Config();
