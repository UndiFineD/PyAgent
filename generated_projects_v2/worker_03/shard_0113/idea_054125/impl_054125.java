...
@Data
public class Idea54125Config {
    private String name = "idea_054125";
 ...
 */
@Slf4j
public class Idea54125Service {
    private static final int IDEA_ID = 54125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54125Service() {
        this(new Idea54125Config());
    }

    public Idea54125Service(Idea54125Config config) {
        this.config = config != null ? config : new Idea54125Config();
