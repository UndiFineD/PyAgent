...
@Data
public class Idea53741Config {
    private String name = "idea_053741";
 ...
 */
@Slf4j
public class Idea53741Service {
    private static final int IDEA_ID = 53741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53741Service() {
        this(new Idea53741Config());
    }

    public Idea53741Service(Idea53741Config config) {
        this.config = config != null ? config : new Idea53741Config();
