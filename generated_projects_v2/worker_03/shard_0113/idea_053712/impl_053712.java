...
@Data
public class Idea53712Config {
    private String name = "idea_053712";
 ...
 */
@Slf4j
public class Idea53712Service {
    private static final int IDEA_ID = 53712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53712Service() {
        this(new Idea53712Config());
    }

    public Idea53712Service(Idea53712Config config) {
        this.config = config != null ? config : new Idea53712Config();
