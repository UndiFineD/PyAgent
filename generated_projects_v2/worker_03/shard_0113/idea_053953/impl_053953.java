...
@Data
public class Idea53953Config {
    private String name = "idea_053953";
 ...
 */
@Slf4j
public class Idea53953Service {
    private static final int IDEA_ID = 53953;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53953Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53953Service() {
        this(new Idea53953Config());
    }

    public Idea53953Service(Idea53953Config config) {
        this.config = config != null ? config : new Idea53953Config();
