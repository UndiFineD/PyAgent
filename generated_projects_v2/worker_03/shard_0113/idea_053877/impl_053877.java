...
@Data
public class Idea53877Config {
    private String name = "idea_053877";
 ...
 */
@Slf4j
public class Idea53877Service {
    private static final int IDEA_ID = 53877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53877Service() {
        this(new Idea53877Config());
    }

    public Idea53877Service(Idea53877Config config) {
        this.config = config != null ? config : new Idea53877Config();
