...
@Data
public class Idea54020Config {
    private String name = "idea_054020";
 ...
 */
@Slf4j
public class Idea54020Service {
    private static final int IDEA_ID = 54020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54020Service() {
        this(new Idea54020Config());
    }

    public Idea54020Service(Idea54020Config config) {
        this.config = config != null ? config : new Idea54020Config();
