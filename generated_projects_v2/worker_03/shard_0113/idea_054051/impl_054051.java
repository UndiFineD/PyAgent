...
@Data
public class Idea54051Config {
    private String name = "idea_054051";
 ...
 */
@Slf4j
public class Idea54051Service {
    private static final int IDEA_ID = 54051;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54051Service() {
        this(new Idea54051Config());
    }

    public Idea54051Service(Idea54051Config config) {
        this.config = config != null ? config : new Idea54051Config();
