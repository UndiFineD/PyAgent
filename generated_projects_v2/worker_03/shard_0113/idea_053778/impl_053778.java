...
@Data
public class Idea53778Config {
    private String name = "idea_053778";
 ...
 */
@Slf4j
public class Idea53778Service {
    private static final int IDEA_ID = 53778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53778Service() {
        this(new Idea53778Config());
    }

    public Idea53778Service(Idea53778Config config) {
        this.config = config != null ? config : new Idea53778Config();
