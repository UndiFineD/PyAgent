...
@Data
public class Idea53758Config {
    private String name = "idea_053758";
 ...
 */
@Slf4j
public class Idea53758Service {
    private static final int IDEA_ID = 53758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53758Service() {
        this(new Idea53758Config());
    }

    public Idea53758Service(Idea53758Config config) {
        this.config = config != null ? config : new Idea53758Config();
