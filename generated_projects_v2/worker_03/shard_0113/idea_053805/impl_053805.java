...
@Data
public class Idea53805Config {
    private String name = "idea_053805";
 ...
 */
@Slf4j
public class Idea53805Service {
    private static final int IDEA_ID = 53805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53805Service() {
        this(new Idea53805Config());
    }

    public Idea53805Service(Idea53805Config config) {
        this.config = config != null ? config : new Idea53805Config();
