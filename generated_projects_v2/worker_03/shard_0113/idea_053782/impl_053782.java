...
@Data
public class Idea53782Config {
    private String name = "idea_053782";
 ...
 */
@Slf4j
public class Idea53782Service {
    private static final int IDEA_ID = 53782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53782Service() {
        this(new Idea53782Config());
    }

    public Idea53782Service(Idea53782Config config) {
        this.config = config != null ? config : new Idea53782Config();
