...
@Data
public class Idea53760Config {
    private String name = "idea_053760";
 ...
 */
@Slf4j
public class Idea53760Service {
    private static final int IDEA_ID = 53760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53760Service() {
        this(new Idea53760Config());
    }

    public Idea53760Service(Idea53760Config config) {
        this.config = config != null ? config : new Idea53760Config();
