...
@Data
public class Idea53729Config {
    private String name = "idea_053729";
 ...
 */
@Slf4j
public class Idea53729Service {
    private static final int IDEA_ID = 53729;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53729Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53729Service() {
        this(new Idea53729Config());
    }

    public Idea53729Service(Idea53729Config config) {
        this.config = config != null ? config : new Idea53729Config();
