...
@Data
public class Idea53743Config {
    private String name = "idea_053743";
 ...
 */
@Slf4j
public class Idea53743Service {
    private static final int IDEA_ID = 53743;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53743Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53743Service() {
        this(new Idea53743Config());
    }

    public Idea53743Service(Idea53743Config config) {
        this.config = config != null ? config : new Idea53743Config();
