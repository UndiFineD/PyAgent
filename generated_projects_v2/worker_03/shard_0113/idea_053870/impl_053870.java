...
@Data
public class Idea53870Config {
    private String name = "idea_053870";
 ...
 */
@Slf4j
public class Idea53870Service {
    private static final int IDEA_ID = 53870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53870Service() {
        this(new Idea53870Config());
    }

    public Idea53870Service(Idea53870Config config) {
        this.config = config != null ? config : new Idea53870Config();
