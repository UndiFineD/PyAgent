...
@Data
public class Idea53986Config {
    private String name = "idea_053986";
 ...
 */
@Slf4j
public class Idea53986Service {
    private static final int IDEA_ID = 53986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53986Service() {
        this(new Idea53986Config());
    }

    public Idea53986Service(Idea53986Config config) {
        this.config = config != null ? config : new Idea53986Config();
