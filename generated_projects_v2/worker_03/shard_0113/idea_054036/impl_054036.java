...
@Data
public class Idea54036Config {
    private String name = "idea_054036";
 ...
 */
@Slf4j
public class Idea54036Service {
    private static final int IDEA_ID = 54036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54036Service() {
        this(new Idea54036Config());
    }

    public Idea54036Service(Idea54036Config config) {
        this.config = config != null ? config : new Idea54036Config();
