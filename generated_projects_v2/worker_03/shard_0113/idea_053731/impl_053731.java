...
@Data
public class Idea53731Config {
    private String name = "idea_053731";
 ...
 */
@Slf4j
public class Idea53731Service {
    private static final int IDEA_ID = 53731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53731Service() {
        this(new Idea53731Config());
    }

    public Idea53731Service(Idea53731Config config) {
        this.config = config != null ? config : new Idea53731Config();
