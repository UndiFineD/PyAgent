...
@Data
public class Idea53708Config {
    private String name = "idea_053708";
 ...
 */
@Slf4j
public class Idea53708Service {
    private static final int IDEA_ID = 53708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53708Service() {
        this(new Idea53708Config());
    }

    public Idea53708Service(Idea53708Config config) {
        this.config = config != null ? config : new Idea53708Config();
