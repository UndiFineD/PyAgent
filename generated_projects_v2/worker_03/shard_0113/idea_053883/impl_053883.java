...
@Data
public class Idea53883Config {
    private String name = "idea_053883";
 ...
 */
@Slf4j
public class Idea53883Service {
    private static final int IDEA_ID = 53883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53883Service() {
        this(new Idea53883Config());
    }

    public Idea53883Service(Idea53883Config config) {
        this.config = config != null ? config : new Idea53883Config();
