...
@Data
public class Idea54147Config {
    private String name = "idea_054147";
 ...
 */
@Slf4j
public class Idea54147Service {
    private static final int IDEA_ID = 54147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54147Service() {
        this(new Idea54147Config());
    }

    public Idea54147Service(Idea54147Config config) {
        this.config = config != null ? config : new Idea54147Config();
