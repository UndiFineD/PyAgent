...
@Data
public class Idea53770Config {
    private String name = "idea_053770";
 ...
 */
@Slf4j
public class Idea53770Service {
    private static final int IDEA_ID = 53770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53770Service() {
        this(new Idea53770Config());
    }

    public Idea53770Service(Idea53770Config config) {
        this.config = config != null ? config : new Idea53770Config();
