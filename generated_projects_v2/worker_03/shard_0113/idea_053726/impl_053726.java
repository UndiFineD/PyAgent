...
@Data
public class Idea53726Config {
    private String name = "idea_053726";
 ...
 */
@Slf4j
public class Idea53726Service {
    private static final int IDEA_ID = 53726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53726Service() {
        this(new Idea53726Config());
    }

    public Idea53726Service(Idea53726Config config) {
        this.config = config != null ? config : new Idea53726Config();
