...
@Data
public class Idea53811Config {
    private String name = "idea_053811";
 ...
 */
@Slf4j
public class Idea53811Service {
    private static final int IDEA_ID = 53811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53811Service() {
        this(new Idea53811Config());
    }

    public Idea53811Service(Idea53811Config config) {
        this.config = config != null ? config : new Idea53811Config();
