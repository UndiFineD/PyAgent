...
@Data
public class Idea53787Config {
    private String name = "idea_053787";
 ...
 */
@Slf4j
public class Idea53787Service {
    private static final int IDEA_ID = 53787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53787Service() {
        this(new Idea53787Config());
    }

    public Idea53787Service(Idea53787Config config) {
        this.config = config != null ? config : new Idea53787Config();
