...
@Data
public class Idea53864Config {
    private String name = "idea_053864";
 ...
 */
@Slf4j
public class Idea53864Service {
    private static final int IDEA_ID = 53864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53864Service() {
        this(new Idea53864Config());
    }

    public Idea53864Service(Idea53864Config config) {
        this.config = config != null ? config : new Idea53864Config();
