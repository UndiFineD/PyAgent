...
@Data
public class Idea53773Config {
    private String name = "idea_053773";
 ...
 */
@Slf4j
public class Idea53773Service {
    private static final int IDEA_ID = 53773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53773Service() {
        this(new Idea53773Config());
    }

    public Idea53773Service(Idea53773Config config) {
        this.config = config != null ? config : new Idea53773Config();
