...
@Data
public class Idea54141Config {
    private String name = "idea_054141";
 ...
 */
@Slf4j
public class Idea54141Service {
    private static final int IDEA_ID = 54141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54141Service() {
        this(new Idea54141Config());
    }

    public Idea54141Service(Idea54141Config config) {
        this.config = config != null ? config : new Idea54141Config();
