...
@Data
public class Idea53896Config {
    private String name = "idea_053896";
 ...
 */
@Slf4j
public class Idea53896Service {
    private static final int IDEA_ID = 53896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53896Service() {
        this(new Idea53896Config());
    }

    public Idea53896Service(Idea53896Config config) {
        this.config = config != null ? config : new Idea53896Config();
