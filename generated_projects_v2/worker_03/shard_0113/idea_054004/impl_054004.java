...
@Data
public class Idea54004Config {
    private String name = "idea_054004";
 ...
 */
@Slf4j
public class Idea54004Service {
    private static final int IDEA_ID = 54004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54004Service() {
        this(new Idea54004Config());
    }

    public Idea54004Service(Idea54004Config config) {
        this.config = config != null ? config : new Idea54004Config();
