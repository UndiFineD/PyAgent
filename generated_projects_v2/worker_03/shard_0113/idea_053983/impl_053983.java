...
@Data
public class Idea53983Config {
    private String name = "idea_053983";
 ...
 */
@Slf4j
public class Idea53983Service {
    private static final int IDEA_ID = 53983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53983Service() {
        this(new Idea53983Config());
    }

    public Idea53983Service(Idea53983Config config) {
        this.config = config != null ? config : new Idea53983Config();
