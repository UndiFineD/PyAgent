...
@Data
public class Idea53740Config {
    private String name = "idea_053740";
 ...
 */
@Slf4j
public class Idea53740Service {
    private static final int IDEA_ID = 53740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53740Service() {
        this(new Idea53740Config());
    }

    public Idea53740Service(Idea53740Config config) {
        this.config = config != null ? config : new Idea53740Config();
