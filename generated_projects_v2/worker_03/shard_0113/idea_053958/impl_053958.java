...
@Data
public class Idea53958Config {
    private String name = "idea_053958";
 ...
 */
@Slf4j
public class Idea53958Service {
    private static final int IDEA_ID = 53958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53958Service() {
        this(new Idea53958Config());
    }

    public Idea53958Service(Idea53958Config config) {
        this.config = config != null ? config : new Idea53958Config();
