...
@Data
public class Idea53827Config {
    private String name = "idea_053827";
 ...
 */
@Slf4j
public class Idea53827Service {
    private static final int IDEA_ID = 53827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53827Service() {
        this(new Idea53827Config());
    }

    public Idea53827Service(Idea53827Config config) {
        this.config = config != null ? config : new Idea53827Config();
