...
@Data
public class Idea53961Config {
    private String name = "idea_053961";
 ...
 */
@Slf4j
public class Idea53961Service {
    private static final int IDEA_ID = 53961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53961Service() {
        this(new Idea53961Config());
    }

    public Idea53961Service(Idea53961Config config) {
        this.config = config != null ? config : new Idea53961Config();
