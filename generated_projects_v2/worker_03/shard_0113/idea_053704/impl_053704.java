...
@Data
public class Idea53704Config {
    private String name = "idea_053704";
 ...
 */
@Slf4j
public class Idea53704Service {
    private static final int IDEA_ID = 53704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53704Service() {
        this(new Idea53704Config());
    }

    public Idea53704Service(Idea53704Config config) {
        this.config = config != null ? config : new Idea53704Config();
