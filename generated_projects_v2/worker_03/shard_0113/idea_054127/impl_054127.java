...
@Data
public class Idea54127Config {
    private String name = "idea_054127";
 ...
 */
@Slf4j
public class Idea54127Service {
    private static final int IDEA_ID = 54127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54127Service() {
        this(new Idea54127Config());
    }

    public Idea54127Service(Idea54127Config config) {
        this.config = config != null ? config : new Idea54127Config();
