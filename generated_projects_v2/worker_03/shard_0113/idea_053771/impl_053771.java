...
@Data
public class Idea53771Config {
    private String name = "idea_053771";
 ...
 */
@Slf4j
public class Idea53771Service {
    private static final int IDEA_ID = 53771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53771Service() {
        this(new Idea53771Config());
    }

    public Idea53771Service(Idea53771Config config) {
        this.config = config != null ? config : new Idea53771Config();
