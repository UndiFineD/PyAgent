...
@Data
public class Idea53887Config {
    private String name = "idea_053887";
 ...
 */
@Slf4j
public class Idea53887Service {
    private static final int IDEA_ID = 53887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53887Service() {
        this(new Idea53887Config());
    }

    public Idea53887Service(Idea53887Config config) {
        this.config = config != null ? config : new Idea53887Config();
