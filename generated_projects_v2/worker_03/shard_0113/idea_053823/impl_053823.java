...
@Data
public class Idea53823Config {
    private String name = "idea_053823";
 ...
 */
@Slf4j
public class Idea53823Service {
    private static final int IDEA_ID = 53823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53823Service() {
        this(new Idea53823Config());
    }

    public Idea53823Service(Idea53823Config config) {
        this.config = config != null ? config : new Idea53823Config();
