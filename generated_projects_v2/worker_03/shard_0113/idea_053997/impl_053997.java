...
@Data
public class Idea53997Config {
    private String name = "idea_053997";
 ...
 */
@Slf4j
public class Idea53997Service {
    private static final int IDEA_ID = 53997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53997Service() {
        this(new Idea53997Config());
    }

    public Idea53997Service(Idea53997Config config) {
        this.config = config != null ? config : new Idea53997Config();
