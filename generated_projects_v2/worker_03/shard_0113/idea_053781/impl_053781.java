...
@Data
public class Idea53781Config {
    private String name = "idea_053781";
 ...
 */
@Slf4j
public class Idea53781Service {
    private static final int IDEA_ID = 53781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53781Service() {
        this(new Idea53781Config());
    }

    public Idea53781Service(Idea53781Config config) {
        this.config = config != null ? config : new Idea53781Config();
