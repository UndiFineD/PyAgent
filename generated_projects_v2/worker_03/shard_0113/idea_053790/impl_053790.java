...
@Data
public class Idea53790Config {
    private String name = "idea_053790";
 ...
 */
@Slf4j
public class Idea53790Service {
    private static final int IDEA_ID = 53790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53790Service() {
        this(new Idea53790Config());
    }

    public Idea53790Service(Idea53790Config config) {
        this.config = config != null ? config : new Idea53790Config();
