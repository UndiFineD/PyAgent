...
@Data
public class Idea53678Config {
    private String name = "idea_053678";
 ...
 */
@Slf4j
public class Idea53678Service {
    private static final int IDEA_ID = 53678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53678Service() {
        this(new Idea53678Config());
    }

    public Idea53678Service(Idea53678Config config) {
        this.config = config != null ? config : new Idea53678Config();
