...
@Data
public class Idea54117Config {
    private String name = "idea_054117";
 ...
 */
@Slf4j
public class Idea54117Service {
    private static final int IDEA_ID = 54117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54117Service() {
        this(new Idea54117Config());
    }

    public Idea54117Service(Idea54117Config config) {
        this.config = config != null ? config : new Idea54117Config();
