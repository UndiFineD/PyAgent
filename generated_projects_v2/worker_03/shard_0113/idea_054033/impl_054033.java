...
@Data
public class Idea54033Config {
    private String name = "idea_054033";
 ...
 */
@Slf4j
public class Idea54033Service {
    private static final int IDEA_ID = 54033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54033Service() {
        this(new Idea54033Config());
    }

    public Idea54033Service(Idea54033Config config) {
        this.config = config != null ? config : new Idea54033Config();
