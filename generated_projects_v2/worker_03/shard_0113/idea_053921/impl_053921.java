...
@Data
public class Idea53921Config {
    private String name = "idea_053921";
 ...
 */
@Slf4j
public class Idea53921Service {
    private static final int IDEA_ID = 53921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53921Service() {
        this(new Idea53921Config());
    }

    public Idea53921Service(Idea53921Config config) {
        this.config = config != null ? config : new Idea53921Config();
