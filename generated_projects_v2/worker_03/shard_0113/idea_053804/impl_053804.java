...
@Data
public class Idea53804Config {
    private String name = "idea_053804";
 ...
 */
@Slf4j
public class Idea53804Service {
    private static final int IDEA_ID = 53804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53804Service() {
        this(new Idea53804Config());
    }

    public Idea53804Service(Idea53804Config config) {
        this.config = config != null ? config : new Idea53804Config();
