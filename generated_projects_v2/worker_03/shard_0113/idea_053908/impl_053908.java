...
@Data
public class Idea53908Config {
    private String name = "idea_053908";
 ...
 */
@Slf4j
public class Idea53908Service {
    private static final int IDEA_ID = 53908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53908Service() {
        this(new Idea53908Config());
    }

    public Idea53908Service(Idea53908Config config) {
        this.config = config != null ? config : new Idea53908Config();
