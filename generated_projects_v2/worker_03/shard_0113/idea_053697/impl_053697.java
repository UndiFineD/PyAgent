...
@Data
public class Idea53697Config {
    private String name = "idea_053697";
 ...
 */
@Slf4j
public class Idea53697Service {
    private static final int IDEA_ID = 53697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53697Service() {
        this(new Idea53697Config());
    }

    public Idea53697Service(Idea53697Config config) {
        this.config = config != null ? config : new Idea53697Config();
