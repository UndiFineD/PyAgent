...
@Data
public class Idea53951Config {
    private String name = "idea_053951";
 ...
 */
@Slf4j
public class Idea53951Service {
    private static final int IDEA_ID = 53951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53951Service() {
        this(new Idea53951Config());
    }

    public Idea53951Service(Idea53951Config config) {
        this.config = config != null ? config : new Idea53951Config();
