...
@Data
public class Idea53991Config {
    private String name = "idea_053991";
 ...
 */
@Slf4j
public class Idea53991Service {
    private static final int IDEA_ID = 53991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53991Service() {
        this(new Idea53991Config());
    }

    public Idea53991Service(Idea53991Config config) {
        this.config = config != null ? config : new Idea53991Config();
