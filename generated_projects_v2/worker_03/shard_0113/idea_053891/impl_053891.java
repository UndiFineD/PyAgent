...
@Data
public class Idea53891Config {
    private String name = "idea_053891";
 ...
 */
@Slf4j
public class Idea53891Service {
    private static final int IDEA_ID = 53891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53891Service() {
        this(new Idea53891Config());
    }

    public Idea53891Service(Idea53891Config config) {
        this.config = config != null ? config : new Idea53891Config();
