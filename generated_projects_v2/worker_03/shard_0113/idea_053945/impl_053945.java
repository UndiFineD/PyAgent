...
@Data
public class Idea53945Config {
    private String name = "idea_053945";
 ...
 */
@Slf4j
public class Idea53945Service {
    private static final int IDEA_ID = 53945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53945Service() {
        this(new Idea53945Config());
    }

    public Idea53945Service(Idea53945Config config) {
        this.config = config != null ? config : new Idea53945Config();
