...
@Data
public class Idea53792Config {
    private String name = "idea_053792";
 ...
 */
@Slf4j
public class Idea53792Service {
    private static final int IDEA_ID = 53792;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53792Service() {
        this(new Idea53792Config());
    }

    public Idea53792Service(Idea53792Config config) {
        this.config = config != null ? config : new Idea53792Config();
