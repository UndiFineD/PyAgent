...
@Data
public class Idea53685Config {
    private String name = "idea_053685";
 ...
 */
@Slf4j
public class Idea53685Service {
    private static final int IDEA_ID = 53685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53685Service() {
        this(new Idea53685Config());
    }

    public Idea53685Service(Idea53685Config config) {
        this.config = config != null ? config : new Idea53685Config();
