...
@Data
public class Idea54015Config {
    private String name = "idea_054015";
 ...
 */
@Slf4j
public class Idea54015Service {
    private static final int IDEA_ID = 54015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54015Service() {
        this(new Idea54015Config());
    }

    public Idea54015Service(Idea54015Config config) {
        this.config = config != null ? config : new Idea54015Config();
