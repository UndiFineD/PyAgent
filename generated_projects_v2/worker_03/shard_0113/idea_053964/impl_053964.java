...
@Data
public class Idea53964Config {
    private String name = "idea_053964";
 ...
 */
@Slf4j
public class Idea53964Service {
    private static final int IDEA_ID = 53964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53964Service() {
        this(new Idea53964Config());
    }

    public Idea53964Service(Idea53964Config config) {
        this.config = config != null ? config : new Idea53964Config();
