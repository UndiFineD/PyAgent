...
@Data
public class Idea53784Config {
    private String name = "idea_053784";
 ...
 */
@Slf4j
public class Idea53784Service {
    private static final int IDEA_ID = 53784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53784Service() {
        this(new Idea53784Config());
    }

    public Idea53784Service(Idea53784Config config) {
        this.config = config != null ? config : new Idea53784Config();
