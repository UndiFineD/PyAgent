...
@Data
public class Idea53931Config {
    private String name = "idea_053931";
 ...
 */
@Slf4j
public class Idea53931Service {
    private static final int IDEA_ID = 53931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53931Service() {
        this(new Idea53931Config());
    }

    public Idea53931Service(Idea53931Config config) {
        this.config = config != null ? config : new Idea53931Config();
