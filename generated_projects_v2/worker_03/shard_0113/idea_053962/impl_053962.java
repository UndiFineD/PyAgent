...
@Data
public class Idea53962Config {
    private String name = "idea_053962";
 ...
 */
@Slf4j
public class Idea53962Service {
    private static final int IDEA_ID = 53962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53962Service() {
        this(new Idea53962Config());
    }

    public Idea53962Service(Idea53962Config config) {
        this.config = config != null ? config : new Idea53962Config();
