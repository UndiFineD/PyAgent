...
@Data
public class Idea53914Config {
    private String name = "idea_053914";
 ...
 */
@Slf4j
public class Idea53914Service {
    private static final int IDEA_ID = 53914;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53914Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53914Service() {
        this(new Idea53914Config());
    }

    public Idea53914Service(Idea53914Config config) {
        this.config = config != null ? config : new Idea53914Config();
