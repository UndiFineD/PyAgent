...
@Data
public class Idea53788Config {
    private String name = "idea_053788";
 ...
 */
@Slf4j
public class Idea53788Service {
    private static final int IDEA_ID = 53788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53788Service() {
        this(new Idea53788Config());
    }

    public Idea53788Service(Idea53788Config config) {
        this.config = config != null ? config : new Idea53788Config();
