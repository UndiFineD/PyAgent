...
@Data
public class Idea53900Config {
    private String name = "idea_053900";
 ...
 */
@Slf4j
public class Idea53900Service {
    private static final int IDEA_ID = 53900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53900Service() {
        this(new Idea53900Config());
    }

    public Idea53900Service(Idea53900Config config) {
        this.config = config != null ? config : new Idea53900Config();
