...
@Data
public class Idea53937Config {
    private String name = "idea_053937";
 ...
 */
@Slf4j
public class Idea53937Service {
    private static final int IDEA_ID = 53937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53937Service() {
        this(new Idea53937Config());
    }

    public Idea53937Service(Idea53937Config config) {
        this.config = config != null ? config : new Idea53937Config();
