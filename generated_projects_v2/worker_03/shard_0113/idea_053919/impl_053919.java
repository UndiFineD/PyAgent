...
@Data
public class Idea53919Config {
    private String name = "idea_053919";
 ...
 */
@Slf4j
public class Idea53919Service {
    private static final int IDEA_ID = 53919;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53919Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53919Service() {
        this(new Idea53919Config());
    }

    public Idea53919Service(Idea53919Config config) {
        this.config = config != null ? config : new Idea53919Config();
