...
@Data
public class Idea54002Config {
    private String name = "idea_054002";
 ...
 */
@Slf4j
public class Idea54002Service {
    private static final int IDEA_ID = 54002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54002Service() {
        this(new Idea54002Config());
    }

    public Idea54002Service(Idea54002Config config) {
        this.config = config != null ? config : new Idea54002Config();
