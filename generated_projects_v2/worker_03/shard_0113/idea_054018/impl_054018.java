...
@Data
public class Idea54018Config {
    private String name = "idea_054018";
 ...
 */
@Slf4j
public class Idea54018Service {
    private static final int IDEA_ID = 54018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54018Service() {
        this(new Idea54018Config());
    }

    public Idea54018Service(Idea54018Config config) {
        this.config = config != null ? config : new Idea54018Config();
