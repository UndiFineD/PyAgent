...
@Data
public class Idea53785Config {
    private String name = "idea_053785";
 ...
 */
@Slf4j
public class Idea53785Service {
    private static final int IDEA_ID = 53785;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53785Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53785Service() {
        this(new Idea53785Config());
    }

    public Idea53785Service(Idea53785Config config) {
        this.config = config != null ? config : new Idea53785Config();
