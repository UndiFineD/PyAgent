...
@Data
public class Idea53711Config {
    private String name = "idea_053711";
 ...
 */
@Slf4j
public class Idea53711Service {
    private static final int IDEA_ID = 53711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53711Service() {
        this(new Idea53711Config());
    }

    public Idea53711Service(Idea53711Config config) {
        this.config = config != null ? config : new Idea53711Config();
