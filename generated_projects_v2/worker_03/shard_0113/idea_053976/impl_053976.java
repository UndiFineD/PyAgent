...
@Data
public class Idea53976Config {
    private String name = "idea_053976";
 ...
 */
@Slf4j
public class Idea53976Service {
    private static final int IDEA_ID = 53976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53976Service() {
        this(new Idea53976Config());
    }

    public Idea53976Service(Idea53976Config config) {
        this.config = config != null ? config : new Idea53976Config();
