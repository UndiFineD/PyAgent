...
@Data
public class Idea53966Config {
    private String name = "idea_053966";
 ...
 */
@Slf4j
public class Idea53966Service {
    private static final int IDEA_ID = 53966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53966Service() {
        this(new Idea53966Config());
    }

    public Idea53966Service(Idea53966Config config) {
        this.config = config != null ? config : new Idea53966Config();
