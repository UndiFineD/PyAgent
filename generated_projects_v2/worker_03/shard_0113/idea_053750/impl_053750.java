...
@Data
public class Idea53750Config {
    private String name = "idea_053750";
 ...
 */
@Slf4j
public class Idea53750Service {
    private static final int IDEA_ID = 53750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53750Service() {
        this(new Idea53750Config());
    }

    public Idea53750Service(Idea53750Config config) {
        this.config = config != null ? config : new Idea53750Config();
