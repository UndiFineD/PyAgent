...
@Data
public class Idea53722Config {
    private String name = "idea_053722";
 ...
 */
@Slf4j
public class Idea53722Service {
    private static final int IDEA_ID = 53722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53722Service() {
        this(new Idea53722Config());
    }

    public Idea53722Service(Idea53722Config config) {
        this.config = config != null ? config : new Idea53722Config();
