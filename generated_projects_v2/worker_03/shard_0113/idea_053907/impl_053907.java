...
@Data
public class Idea53907Config {
    private String name = "idea_053907";
 ...
 */
@Slf4j
public class Idea53907Service {
    private static final int IDEA_ID = 53907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53907Service() {
        this(new Idea53907Config());
    }

    public Idea53907Service(Idea53907Config config) {
        this.config = config != null ? config : new Idea53907Config();
