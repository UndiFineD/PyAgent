...
@Data
public class Idea53913Config {
    private String name = "idea_053913";
 ...
 */
@Slf4j
public class Idea53913Service {
    private static final int IDEA_ID = 53913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53913Service() {
        this(new Idea53913Config());
    }

    public Idea53913Service(Idea53913Config config) {
        this.config = config != null ? config : new Idea53913Config();
