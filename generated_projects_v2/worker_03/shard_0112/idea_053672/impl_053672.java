...
@Data
public class Idea53672Config {
    private String name = "idea_053672";
 ...
 */
@Slf4j
public class Idea53672Service {
    private static final int IDEA_ID = 53672;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53672Service() {
        this(new Idea53672Config());
    }

    public Idea53672Service(Idea53672Config config) {
        this.config = config != null ? config : new Idea53672Config();
