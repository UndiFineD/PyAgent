...
@Data
public class Idea53510Config {
    private String name = "idea_053510";
 ...
 */
@Slf4j
public class Idea53510Service {
    private static final int IDEA_ID = 53510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53510Service() {
        this(new Idea53510Config());
    }

    public Idea53510Service(Idea53510Config config) {
        this.config = config != null ? config : new Idea53510Config();
