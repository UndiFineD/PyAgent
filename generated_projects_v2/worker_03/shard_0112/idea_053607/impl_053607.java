...
@Data
public class Idea53607Config {
    private String name = "idea_053607";
 ...
 */
@Slf4j
public class Idea53607Service {
    private static final int IDEA_ID = 53607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53607Service() {
        this(new Idea53607Config());
    }

    public Idea53607Service(Idea53607Config config) {
        this.config = config != null ? config : new Idea53607Config();
