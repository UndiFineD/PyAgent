...
@Data
public class Idea53647Config {
    private String name = "idea_053647";
 ...
 */
@Slf4j
public class Idea53647Service {
    private static final int IDEA_ID = 53647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53647Service() {
        this(new Idea53647Config());
    }

    public Idea53647Service(Idea53647Config config) {
        this.config = config != null ? config : new Idea53647Config();
