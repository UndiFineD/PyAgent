...
@Data
public class Idea53563Config {
    private String name = "idea_053563";
 ...
 */
@Slf4j
public class Idea53563Service {
    private static final int IDEA_ID = 53563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53563Service() {
        this(new Idea53563Config());
    }

    public Idea53563Service(Idea53563Config config) {
        this.config = config != null ? config : new Idea53563Config();
