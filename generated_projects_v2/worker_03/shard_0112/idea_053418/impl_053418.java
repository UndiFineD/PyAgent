...
@Data
public class Idea53418Config {
    private String name = "idea_053418";
 ...
 */
@Slf4j
public class Idea53418Service {
    private static final int IDEA_ID = 53418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53418Service() {
        this(new Idea53418Config());
    }

    public Idea53418Service(Idea53418Config config) {
        this.config = config != null ? config : new Idea53418Config();
