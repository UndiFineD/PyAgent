...
@Data
public class Idea53338Config {
    private String name = "idea_053338";
 ...
 */
@Slf4j
public class Idea53338Service {
    private static final int IDEA_ID = 53338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53338Service() {
        this(new Idea53338Config());
    }

    public Idea53338Service(Idea53338Config config) {
        this.config = config != null ? config : new Idea53338Config();
