...
@Data
public class Idea53604Config {
    private String name = "idea_053604";
 ...
 */
@Slf4j
public class Idea53604Service {
    private static final int IDEA_ID = 53604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53604Service() {
        this(new Idea53604Config());
    }

    public Idea53604Service(Idea53604Config config) {
        this.config = config != null ? config : new Idea53604Config();
