...
@Data
public class Idea53227Config {
    private String name = "idea_053227";
 ...
 */
@Slf4j
public class Idea53227Service {
    private static final int IDEA_ID = 53227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53227Service() {
        this(new Idea53227Config());
    }

    public Idea53227Service(Idea53227Config config) {
        this.config = config != null ? config : new Idea53227Config();
