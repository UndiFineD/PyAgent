...
@Data
public class Idea53214Config {
    private String name = "idea_053214";
 ...
 */
@Slf4j
public class Idea53214Service {
    private static final int IDEA_ID = 53214;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53214Service() {
        this(new Idea53214Config());
    }

    public Idea53214Service(Idea53214Config config) {
        this.config = config != null ? config : new Idea53214Config();
