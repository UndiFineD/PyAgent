...
@Data
public class Idea53375Config {
    private String name = "idea_053375";
 ...
 */
@Slf4j
public class Idea53375Service {
    private static final int IDEA_ID = 53375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53375Service() {
        this(new Idea53375Config());
    }

    public Idea53375Service(Idea53375Config config) {
        this.config = config != null ? config : new Idea53375Config();
