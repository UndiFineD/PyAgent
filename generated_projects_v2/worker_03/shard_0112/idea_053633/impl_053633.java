...
@Data
public class Idea53633Config {
    private String name = "idea_053633";
 ...
 */
@Slf4j
public class Idea53633Service {
    private static final int IDEA_ID = 53633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53633Service() {
        this(new Idea53633Config());
    }

    public Idea53633Service(Idea53633Config config) {
        this.config = config != null ? config : new Idea53633Config();
