...
@Data
public class Idea53203Config {
    private String name = "idea_053203";
 ...
 */
@Slf4j
public class Idea53203Service {
    private static final int IDEA_ID = 53203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53203Service() {
        this(new Idea53203Config());
    }

    public Idea53203Service(Idea53203Config config) {
        this.config = config != null ? config : new Idea53203Config();
