...
@Data
public class Idea53291Config {
    private String name = "idea_053291";
 ...
 */
@Slf4j
public class Idea53291Service {
    private static final int IDEA_ID = 53291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53291Service() {
        this(new Idea53291Config());
    }

    public Idea53291Service(Idea53291Config config) {
        this.config = config != null ? config : new Idea53291Config();
