...
@Data
public class Idea53421Config {
    private String name = "idea_053421";
 ...
 */
@Slf4j
public class Idea53421Service {
    private static final int IDEA_ID = 53421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53421Service() {
        this(new Idea53421Config());
    }

    public Idea53421Service(Idea53421Config config) {
        this.config = config != null ? config : new Idea53421Config();
