...
@Data
public class Idea53373Config {
    private String name = "idea_053373";
 ...
 */
@Slf4j
public class Idea53373Service {
    private static final int IDEA_ID = 53373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53373Service() {
        this(new Idea53373Config());
    }

    public Idea53373Service(Idea53373Config config) {
        this.config = config != null ? config : new Idea53373Config();
