...
@Data
public class Idea53667Config {
    private String name = "idea_053667";
 ...
 */
@Slf4j
public class Idea53667Service {
    private static final int IDEA_ID = 53667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53667Service() {
        this(new Idea53667Config());
    }

    public Idea53667Service(Idea53667Config config) {
        this.config = config != null ? config : new Idea53667Config();
