...
@Data
public class Idea53366Config {
    private String name = "idea_053366";
 ...
 */
@Slf4j
public class Idea53366Service {
    private static final int IDEA_ID = 53366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53366Service() {
        this(new Idea53366Config());
    }

    public Idea53366Service(Idea53366Config config) {
        this.config = config != null ? config : new Idea53366Config();
