...
@Data
public class Idea53326Config {
    private String name = "idea_053326";
 ...
 */
@Slf4j
public class Idea53326Service {
    private static final int IDEA_ID = 53326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53326Service() {
        this(new Idea53326Config());
    }

    public Idea53326Service(Idea53326Config config) {
        this.config = config != null ? config : new Idea53326Config();
