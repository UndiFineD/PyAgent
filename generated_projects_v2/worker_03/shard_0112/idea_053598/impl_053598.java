...
@Data
public class Idea53598Config {
    private String name = "idea_053598";
 ...
 */
@Slf4j
public class Idea53598Service {
    private static final int IDEA_ID = 53598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53598Service() {
        this(new Idea53598Config());
    }

    public Idea53598Service(Idea53598Config config) {
        this.config = config != null ? config : new Idea53598Config();
