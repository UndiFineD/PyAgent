...
@Data
public class Idea53566Config {
    private String name = "idea_053566";
 ...
 */
@Slf4j
public class Idea53566Service {
    private static final int IDEA_ID = 53566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53566Service() {
        this(new Idea53566Config());
    }

    public Idea53566Service(Idea53566Config config) {
        this.config = config != null ? config : new Idea53566Config();
