...
@Data
public class Idea53356Config {
    private String name = "idea_053356";
 ...
 */
@Slf4j
public class Idea53356Service {
    private static final int IDEA_ID = 53356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53356Service() {
        this(new Idea53356Config());
    }

    public Idea53356Service(Idea53356Config config) {
        this.config = config != null ? config : new Idea53356Config();
