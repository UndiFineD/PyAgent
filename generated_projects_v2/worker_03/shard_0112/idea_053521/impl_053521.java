...
@Data
public class Idea53521Config {
    private String name = "idea_053521";
 ...
 */
@Slf4j
public class Idea53521Service {
    private static final int IDEA_ID = 53521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53521Service() {
        this(new Idea53521Config());
    }

    public Idea53521Service(Idea53521Config config) {
        this.config = config != null ? config : new Idea53521Config();
