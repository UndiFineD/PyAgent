...
@Data
public class Idea53461Config {
    private String name = "idea_053461";
 ...
 */
@Slf4j
public class Idea53461Service {
    private static final int IDEA_ID = 53461;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53461Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53461Service() {
        this(new Idea53461Config());
    }

    public Idea53461Service(Idea53461Config config) {
        this.config = config != null ? config : new Idea53461Config();
