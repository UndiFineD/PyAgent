...
@Data
public class Idea53283Config {
    private String name = "idea_053283";
 ...
 */
@Slf4j
public class Idea53283Service {
    private static final int IDEA_ID = 53283;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53283Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53283Service() {
        this(new Idea53283Config());
    }

    public Idea53283Service(Idea53283Config config) {
        this.config = config != null ? config : new Idea53283Config();
