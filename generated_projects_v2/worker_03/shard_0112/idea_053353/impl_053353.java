...
@Data
public class Idea53353Config {
    private String name = "idea_053353";
 ...
 */
@Slf4j
public class Idea53353Service {
    private static final int IDEA_ID = 53353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53353Service() {
        this(new Idea53353Config());
    }

    public Idea53353Service(Idea53353Config config) {
        this.config = config != null ? config : new Idea53353Config();
