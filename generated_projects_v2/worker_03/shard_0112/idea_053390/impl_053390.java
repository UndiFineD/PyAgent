...
@Data
public class Idea53390Config {
    private String name = "idea_053390";
 ...
 */
@Slf4j
public class Idea53390Service {
    private static final int IDEA_ID = 53390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53390Service() {
        this(new Idea53390Config());
    }

    public Idea53390Service(Idea53390Config config) {
        this.config = config != null ? config : new Idea53390Config();
