...
@Data
public class Idea53235Config {
    private String name = "idea_053235";
 ...
 */
@Slf4j
public class Idea53235Service {
    private static final int IDEA_ID = 53235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53235Service() {
        this(new Idea53235Config());
    }

    public Idea53235Service(Idea53235Config config) {
        this.config = config != null ? config : new Idea53235Config();
