...
@Data
public class Idea53553Config {
    private String name = "idea_053553";
 ...
 */
@Slf4j
public class Idea53553Service {
    private static final int IDEA_ID = 53553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53553Service() {
        this(new Idea53553Config());
    }

    public Idea53553Service(Idea53553Config config) {
        this.config = config != null ? config : new Idea53553Config();
