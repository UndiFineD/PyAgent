...
@Data
public class Idea53303Config {
    private String name = "idea_053303";
 ...
 */
@Slf4j
public class Idea53303Service {
    private static final int IDEA_ID = 53303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53303Service() {
        this(new Idea53303Config());
    }

    public Idea53303Service(Idea53303Config config) {
        this.config = config != null ? config : new Idea53303Config();
