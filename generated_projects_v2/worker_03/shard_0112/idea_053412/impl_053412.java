...
@Data
public class Idea53412Config {
    private String name = "idea_053412";
 ...
 */
@Slf4j
public class Idea53412Service {
    private static final int IDEA_ID = 53412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53412Service() {
        this(new Idea53412Config());
    }

    public Idea53412Service(Idea53412Config config) {
        this.config = config != null ? config : new Idea53412Config();
