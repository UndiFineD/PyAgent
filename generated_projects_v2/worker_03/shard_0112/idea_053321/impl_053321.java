...
@Data
public class Idea53321Config {
    private String name = "idea_053321";
 ...
 */
@Slf4j
public class Idea53321Service {
    private static final int IDEA_ID = 53321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53321Service() {
        this(new Idea53321Config());
    }

    public Idea53321Service(Idea53321Config config) {
        this.config = config != null ? config : new Idea53321Config();
