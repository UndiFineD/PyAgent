...
@Data
public class Idea53201Config {
    private String name = "idea_053201";
 ...
 */
@Slf4j
public class Idea53201Service {
    private static final int IDEA_ID = 53201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53201Service() {
        this(new Idea53201Config());
    }

    public Idea53201Service(Idea53201Config config) {
        this.config = config != null ? config : new Idea53201Config();
