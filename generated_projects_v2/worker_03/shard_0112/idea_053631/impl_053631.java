...
@Data
public class Idea53631Config {
    private String name = "idea_053631";
 ...
 */
@Slf4j
public class Idea53631Service {
    private static final int IDEA_ID = 53631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53631Service() {
        this(new Idea53631Config());
    }

    public Idea53631Service(Idea53631Config config) {
        this.config = config != null ? config : new Idea53631Config();
