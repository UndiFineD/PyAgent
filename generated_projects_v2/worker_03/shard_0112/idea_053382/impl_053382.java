...
@Data
public class Idea53382Config {
    private String name = "idea_053382";
 ...
 */
@Slf4j
public class Idea53382Service {
    private static final int IDEA_ID = 53382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53382Service() {
        this(new Idea53382Config());
    }

    public Idea53382Service(Idea53382Config config) {
        this.config = config != null ? config : new Idea53382Config();
