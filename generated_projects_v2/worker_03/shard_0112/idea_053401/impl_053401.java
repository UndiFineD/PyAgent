...
@Data
public class Idea53401Config {
    private String name = "idea_053401";
 ...
 */
@Slf4j
public class Idea53401Service {
    private static final int IDEA_ID = 53401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53401Service() {
        this(new Idea53401Config());
    }

    public Idea53401Service(Idea53401Config config) {
        this.config = config != null ? config : new Idea53401Config();
