...
@Data
public class Idea53300Config {
    private String name = "idea_053300";
 ...
 */
@Slf4j
public class Idea53300Service {
    private static final int IDEA_ID = 53300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53300Service() {
        this(new Idea53300Config());
    }

    public Idea53300Service(Idea53300Config config) {
        this.config = config != null ? config : new Idea53300Config();
