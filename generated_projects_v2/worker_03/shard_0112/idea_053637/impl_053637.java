...
@Data
public class Idea53637Config {
    private String name = "idea_053637";
 ...
 */
@Slf4j
public class Idea53637Service {
    private static final int IDEA_ID = 53637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53637Service() {
        this(new Idea53637Config());
    }

    public Idea53637Service(Idea53637Config config) {
        this.config = config != null ? config : new Idea53637Config();
