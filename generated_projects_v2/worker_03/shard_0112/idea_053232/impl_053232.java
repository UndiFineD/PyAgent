...
@Data
public class Idea53232Config {
    private String name = "idea_053232";
 ...
 */
@Slf4j
public class Idea53232Service {
    private static final int IDEA_ID = 53232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53232Service() {
        this(new Idea53232Config());
    }

    public Idea53232Service(Idea53232Config config) {
        this.config = config != null ? config : new Idea53232Config();
