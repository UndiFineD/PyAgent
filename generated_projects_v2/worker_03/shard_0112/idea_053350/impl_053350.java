...
@Data
public class Idea53350Config {
    private String name = "idea_053350";
 ...
 */
@Slf4j
public class Idea53350Service {
    private static final int IDEA_ID = 53350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53350Service() {
        this(new Idea53350Config());
    }

    public Idea53350Service(Idea53350Config config) {
        this.config = config != null ? config : new Idea53350Config();
