...
@Data
public class Idea53361Config {
    private String name = "idea_053361";
 ...
 */
@Slf4j
public class Idea53361Service {
    private static final int IDEA_ID = 53361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53361Service() {
        this(new Idea53361Config());
    }

    public Idea53361Service(Idea53361Config config) {
        this.config = config != null ? config : new Idea53361Config();
