...
@Data
public class Idea53424Config {
    private String name = "idea_053424";
 ...
 */
@Slf4j
public class Idea53424Service {
    private static final int IDEA_ID = 53424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53424Service() {
        this(new Idea53424Config());
    }

    public Idea53424Service(Idea53424Config config) {
        this.config = config != null ? config : new Idea53424Config();
