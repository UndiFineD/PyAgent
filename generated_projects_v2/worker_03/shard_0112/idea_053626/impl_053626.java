...
@Data
public class Idea53626Config {
    private String name = "idea_053626";
 ...
 */
@Slf4j
public class Idea53626Service {
    private static final int IDEA_ID = 53626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53626Service() {
        this(new Idea53626Config());
    }

    public Idea53626Service(Idea53626Config config) {
        this.config = config != null ? config : new Idea53626Config();
