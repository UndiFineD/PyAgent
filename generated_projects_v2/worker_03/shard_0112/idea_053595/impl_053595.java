...
@Data
public class Idea53595Config {
    private String name = "idea_053595";
 ...
 */
@Slf4j
public class Idea53595Service {
    private static final int IDEA_ID = 53595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53595Service() {
        this(new Idea53595Config());
    }

    public Idea53595Service(Idea53595Config config) {
        this.config = config != null ? config : new Idea53595Config();
