...
@Data
public class Idea53428Config {
    private String name = "idea_053428";
 ...
 */
@Slf4j
public class Idea53428Service {
    private static final int IDEA_ID = 53428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53428Service() {
        this(new Idea53428Config());
    }

    public Idea53428Service(Idea53428Config config) {
        this.config = config != null ? config : new Idea53428Config();
