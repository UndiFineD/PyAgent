...
@Data
public class Idea53220Config {
    private String name = "idea_053220";
 ...
 */
@Slf4j
public class Idea53220Service {
    private static final int IDEA_ID = 53220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53220Service() {
        this(new Idea53220Config());
    }

    public Idea53220Service(Idea53220Config config) {
        this.config = config != null ? config : new Idea53220Config();
