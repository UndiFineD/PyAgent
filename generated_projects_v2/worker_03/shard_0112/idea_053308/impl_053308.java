...
@Data
public class Idea53308Config {
    private String name = "idea_053308";
 ...
 */
@Slf4j
public class Idea53308Service {
    private static final int IDEA_ID = 53308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53308Service() {
        this(new Idea53308Config());
    }

    public Idea53308Service(Idea53308Config config) {
        this.config = config != null ? config : new Idea53308Config();
