...
@Data
public class Idea53409Config {
    private String name = "idea_053409";
 ...
 */
@Slf4j
public class Idea53409Service {
    private static final int IDEA_ID = 53409;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53409Service() {
        this(new Idea53409Config());
    }

    public Idea53409Service(Idea53409Config config) {
        this.config = config != null ? config : new Idea53409Config();
