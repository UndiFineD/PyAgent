...
@Data
public class Idea53258Config {
    private String name = "idea_053258";
 ...
 */
@Slf4j
public class Idea53258Service {
    private static final int IDEA_ID = 53258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53258Service() {
        this(new Idea53258Config());
    }

    public Idea53258Service(Idea53258Config config) {
        this.config = config != null ? config : new Idea53258Config();
