...
@Data
public class Idea53602Config {
    private String name = "idea_053602";
 ...
 */
@Slf4j
public class Idea53602Service {
    private static final int IDEA_ID = 53602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53602Service() {
        this(new Idea53602Config());
    }

    public Idea53602Service(Idea53602Config config) {
        this.config = config != null ? config : new Idea53602Config();
