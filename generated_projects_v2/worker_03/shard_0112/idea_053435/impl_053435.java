...
@Data
public class Idea53435Config {
    private String name = "idea_053435";
 ...
 */
@Slf4j
public class Idea53435Service {
    private static final int IDEA_ID = 53435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53435Service() {
        this(new Idea53435Config());
    }

    public Idea53435Service(Idea53435Config config) {
        this.config = config != null ? config : new Idea53435Config();
