...
@Data
public class Idea53304Config {
    private String name = "idea_053304";
 ...
 */
@Slf4j
public class Idea53304Service {
    private static final int IDEA_ID = 53304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53304Service() {
        this(new Idea53304Config());
    }

    public Idea53304Service(Idea53304Config config) {
        this.config = config != null ? config : new Idea53304Config();
