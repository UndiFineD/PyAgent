...
@Data
public class Idea53250Config {
    private String name = "idea_053250";
 ...
 */
@Slf4j
public class Idea53250Service {
    private static final int IDEA_ID = 53250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53250Service() {
        this(new Idea53250Config());
    }

    public Idea53250Service(Idea53250Config config) {
        this.config = config != null ? config : new Idea53250Config();
