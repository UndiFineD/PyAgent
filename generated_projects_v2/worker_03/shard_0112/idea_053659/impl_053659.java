...
@Data
public class Idea53659Config {
    private String name = "idea_053659";
 ...
 */
@Slf4j
public class Idea53659Service {
    private static final int IDEA_ID = 53659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53659Service() {
        this(new Idea53659Config());
    }

    public Idea53659Service(Idea53659Config config) {
        this.config = config != null ? config : new Idea53659Config();
