...
@Data
public class Idea53572Config {
    private String name = "idea_053572";
 ...
 */
@Slf4j
public class Idea53572Service {
    private static final int IDEA_ID = 53572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53572Service() {
        this(new Idea53572Config());
    }

    public Idea53572Service(Idea53572Config config) {
        this.config = config != null ? config : new Idea53572Config();
