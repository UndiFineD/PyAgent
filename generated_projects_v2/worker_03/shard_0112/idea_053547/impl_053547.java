...
@Data
public class Idea53547Config {
    private String name = "idea_053547";
 ...
 */
@Slf4j
public class Idea53547Service {
    private static final int IDEA_ID = 53547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53547Service() {
        this(new Idea53547Config());
    }

    public Idea53547Service(Idea53547Config config) {
        this.config = config != null ? config : new Idea53547Config();
