...
@Data
public class Idea53260Config {
    private String name = "idea_053260";
 ...
 */
@Slf4j
public class Idea53260Service {
    private static final int IDEA_ID = 53260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53260Service() {
        this(new Idea53260Config());
    }

    public Idea53260Service(Idea53260Config config) {
        this.config = config != null ? config : new Idea53260Config();
