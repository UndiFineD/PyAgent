...
@Data
public class Idea53436Config {
    private String name = "idea_053436";
 ...
 */
@Slf4j
public class Idea53436Service {
    private static final int IDEA_ID = 53436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53436Service() {
        this(new Idea53436Config());
    }

    public Idea53436Service(Idea53436Config config) {
        this.config = config != null ? config : new Idea53436Config();
