...
@Data
public class Idea53523Config {
    private String name = "idea_053523";
 ...
 */
@Slf4j
public class Idea53523Service {
    private static final int IDEA_ID = 53523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53523Service() {
        this(new Idea53523Config());
    }

    public Idea53523Service(Idea53523Config config) {
        this.config = config != null ? config : new Idea53523Config();
