...
@Data
public class Idea53233Config {
    private String name = "idea_053233";
 ...
 */
@Slf4j
public class Idea53233Service {
    private static final int IDEA_ID = 53233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53233Service() {
        this(new Idea53233Config());
    }

    public Idea53233Service(Idea53233Config config) {
        this.config = config != null ? config : new Idea53233Config();
