...
@Data
public class Idea53565Config {
    private String name = "idea_053565";
 ...
 */
@Slf4j
public class Idea53565Service {
    private static final int IDEA_ID = 53565;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53565Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53565Service() {
        this(new Idea53565Config());
    }

    public Idea53565Service(Idea53565Config config) {
        this.config = config != null ? config : new Idea53565Config();
