...
@Data
public class Idea53509Config {
    private String name = "idea_053509";
 ...
 */
@Slf4j
public class Idea53509Service {
    private static final int IDEA_ID = 53509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53509Service() {
        this(new Idea53509Config());
    }

    public Idea53509Service(Idea53509Config config) {
        this.config = config != null ? config : new Idea53509Config();
