...
@Data
public class Idea53520Config {
    private String name = "idea_053520";
 ...
 */
@Slf4j
public class Idea53520Service {
    private static final int IDEA_ID = 53520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53520Service() {
        this(new Idea53520Config());
    }

    public Idea53520Service(Idea53520Config config) {
        this.config = config != null ? config : new Idea53520Config();
