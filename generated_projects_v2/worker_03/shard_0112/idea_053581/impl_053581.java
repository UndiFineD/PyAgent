...
@Data
public class Idea53581Config {
    private String name = "idea_053581";
 ...
 */
@Slf4j
public class Idea53581Service {
    private static final int IDEA_ID = 53581;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53581Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53581Service() {
        this(new Idea53581Config());
    }

    public Idea53581Service(Idea53581Config config) {
        this.config = config != null ? config : new Idea53581Config();
