...
@Data
public class Idea53627Config {
    private String name = "idea_053627";
 ...
 */
@Slf4j
public class Idea53627Service {
    private static final int IDEA_ID = 53627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53627Service() {
        this(new Idea53627Config());
    }

    public Idea53627Service(Idea53627Config config) {
        this.config = config != null ? config : new Idea53627Config();
