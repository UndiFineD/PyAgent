...
@Data
public class Idea53635Config {
    private String name = "idea_053635";
 ...
 */
@Slf4j
public class Idea53635Service {
    private static final int IDEA_ID = 53635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53635Service() {
        this(new Idea53635Config());
    }

    public Idea53635Service(Idea53635Config config) {
        this.config = config != null ? config : new Idea53635Config();
