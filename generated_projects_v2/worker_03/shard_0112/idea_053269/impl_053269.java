...
@Data
public class Idea53269Config {
    private String name = "idea_053269";
 ...
 */
@Slf4j
public class Idea53269Service {
    private static final int IDEA_ID = 53269;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53269Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53269Service() {
        this(new Idea53269Config());
    }

    public Idea53269Service(Idea53269Config config) {
        this.config = config != null ? config : new Idea53269Config();
