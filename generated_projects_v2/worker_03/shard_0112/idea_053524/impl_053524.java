...
@Data
public class Idea53524Config {
    private String name = "idea_053524";
 ...
 */
@Slf4j
public class Idea53524Service {
    private static final int IDEA_ID = 53524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53524Service() {
        this(new Idea53524Config());
    }

    public Idea53524Service(Idea53524Config config) {
        this.config = config != null ? config : new Idea53524Config();
