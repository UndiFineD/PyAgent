...
@Data
public class Idea53663Config {
    private String name = "idea_053663";
 ...
 */
@Slf4j
public class Idea53663Service {
    private static final int IDEA_ID = 53663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53663Service() {
        this(new Idea53663Config());
    }

    public Idea53663Service(Idea53663Config config) {
        this.config = config != null ? config : new Idea53663Config();
