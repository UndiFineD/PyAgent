...
@Data
public class Idea53298Config {
    private String name = "idea_053298";
 ...
 */
@Slf4j
public class Idea53298Service {
    private static final int IDEA_ID = 53298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53298Service() {
        this(new Idea53298Config());
    }

    public Idea53298Service(Idea53298Config config) {
        this.config = config != null ? config : new Idea53298Config();
