...
@Data
public class Idea53673Config {
    private String name = "idea_053673";
 ...
 */
@Slf4j
public class Idea53673Service {
    private static final int IDEA_ID = 53673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53673Service() {
        this(new Idea53673Config());
    }

    public Idea53673Service(Idea53673Config config) {
        this.config = config != null ? config : new Idea53673Config();
