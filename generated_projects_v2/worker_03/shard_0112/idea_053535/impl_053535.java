...
@Data
public class Idea53535Config {
    private String name = "idea_053535";
 ...
 */
@Slf4j
public class Idea53535Service {
    private static final int IDEA_ID = 53535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53535Service() {
        this(new Idea53535Config());
    }

    public Idea53535Service(Idea53535Config config) {
        this.config = config != null ? config : new Idea53535Config();
