...
@Data
public class Idea53603Config {
    private String name = "idea_053603";
 ...
 */
@Slf4j
public class Idea53603Service {
    private static final int IDEA_ID = 53603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53603Service() {
        this(new Idea53603Config());
    }

    public Idea53603Service(Idea53603Config config) {
        this.config = config != null ? config : new Idea53603Config();
