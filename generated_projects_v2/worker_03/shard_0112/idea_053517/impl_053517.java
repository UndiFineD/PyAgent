...
@Data
public class Idea53517Config {
    private String name = "idea_053517";
 ...
 */
@Slf4j
public class Idea53517Service {
    private static final int IDEA_ID = 53517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53517Service() {
        this(new Idea53517Config());
    }

    public Idea53517Service(Idea53517Config config) {
        this.config = config != null ? config : new Idea53517Config();
