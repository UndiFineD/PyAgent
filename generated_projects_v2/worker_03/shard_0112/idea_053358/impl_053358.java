...
@Data
public class Idea53358Config {
    private String name = "idea_053358";
 ...
 */
@Slf4j
public class Idea53358Service {
    private static final int IDEA_ID = 53358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53358Service() {
        this(new Idea53358Config());
    }

    public Idea53358Service(Idea53358Config config) {
        this.config = config != null ? config : new Idea53358Config();
