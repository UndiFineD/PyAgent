...
@Data
public class Idea53207Config {
    private String name = "idea_053207";
 ...
 */
@Slf4j
public class Idea53207Service {
    private static final int IDEA_ID = 53207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53207Service() {
        this(new Idea53207Config());
    }

    public Idea53207Service(Idea53207Config config) {
        this.config = config != null ? config : new Idea53207Config();
