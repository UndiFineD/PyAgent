...
@Data
public class Idea53577Config {
    private String name = "idea_053577";
 ...
 */
@Slf4j
public class Idea53577Service {
    private static final int IDEA_ID = 53577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53577Service() {
        this(new Idea53577Config());
    }

    public Idea53577Service(Idea53577Config config) {
        this.config = config != null ? config : new Idea53577Config();
