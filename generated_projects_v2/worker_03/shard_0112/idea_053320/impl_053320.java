...
@Data
public class Idea53320Config {
    private String name = "idea_053320";
 ...
 */
@Slf4j
public class Idea53320Service {
    private static final int IDEA_ID = 53320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53320Service() {
        this(new Idea53320Config());
    }

    public Idea53320Service(Idea53320Config config) {
        this.config = config != null ? config : new Idea53320Config();
