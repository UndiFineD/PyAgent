...
@Data
public class Idea53470Config {
    private String name = "idea_053470";
 ...
 */
@Slf4j
public class Idea53470Service {
    private static final int IDEA_ID = 53470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53470Service() {
        this(new Idea53470Config());
    }

    public Idea53470Service(Idea53470Config config) {
        this.config = config != null ? config : new Idea53470Config();
