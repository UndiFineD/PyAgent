...
@Data
public class Idea53505Config {
    private String name = "idea_053505";
 ...
 */
@Slf4j
public class Idea53505Service {
    private static final int IDEA_ID = 53505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53505Service() {
        this(new Idea53505Config());
    }

    public Idea53505Service(Idea53505Config config) {
        this.config = config != null ? config : new Idea53505Config();
