...
@Data
public class Idea53653Config {
    private String name = "idea_053653";
 ...
 */
@Slf4j
public class Idea53653Service {
    private static final int IDEA_ID = 53653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53653Service() {
        this(new Idea53653Config());
    }

    public Idea53653Service(Idea53653Config config) {
        this.config = config != null ? config : new Idea53653Config();
