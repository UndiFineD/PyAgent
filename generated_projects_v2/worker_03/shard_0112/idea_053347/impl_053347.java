...
@Data
public class Idea53347Config {
    private String name = "idea_053347";
 ...
 */
@Slf4j
public class Idea53347Service {
    private static final int IDEA_ID = 53347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53347Service() {
        this(new Idea53347Config());
    }

    public Idea53347Service(Idea53347Config config) {
        this.config = config != null ? config : new Idea53347Config();
