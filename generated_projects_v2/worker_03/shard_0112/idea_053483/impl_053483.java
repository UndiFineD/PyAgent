...
@Data
public class Idea53483Config {
    private String name = "idea_053483";
 ...
 */
@Slf4j
public class Idea53483Service {
    private static final int IDEA_ID = 53483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53483Service() {
        this(new Idea53483Config());
    }

    public Idea53483Service(Idea53483Config config) {
        this.config = config != null ? config : new Idea53483Config();
