...
@Data
public class Idea53446Config {
    private String name = "idea_053446";
 ...
 */
@Slf4j
public class Idea53446Service {
    private static final int IDEA_ID = 53446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53446Service() {
        this(new Idea53446Config());
    }

    public Idea53446Service(Idea53446Config config) {
        this.config = config != null ? config : new Idea53446Config();
