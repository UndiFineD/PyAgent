...
@Data
public class Idea53618Config {
    private String name = "idea_053618";
 ...
 */
@Slf4j
public class Idea53618Service {
    private static final int IDEA_ID = 53618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53618Service() {
        this(new Idea53618Config());
    }

    public Idea53618Service(Idea53618Config config) {
        this.config = config != null ? config : new Idea53618Config();
