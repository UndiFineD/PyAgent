...
@Data
public class Idea53333Config {
    private String name = "idea_053333";
 ...
 */
@Slf4j
public class Idea53333Service {
    private static final int IDEA_ID = 53333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53333Service() {
        this(new Idea53333Config());
    }

    public Idea53333Service(Idea53333Config config) {
        this.config = config != null ? config : new Idea53333Config();
