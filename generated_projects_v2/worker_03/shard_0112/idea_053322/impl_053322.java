...
@Data
public class Idea53322Config {
    private String name = "idea_053322";
 ...
 */
@Slf4j
public class Idea53322Service {
    private static final int IDEA_ID = 53322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53322Service() {
        this(new Idea53322Config());
    }

    public Idea53322Service(Idea53322Config config) {
        this.config = config != null ? config : new Idea53322Config();
