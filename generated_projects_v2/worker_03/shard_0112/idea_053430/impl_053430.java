...
@Data
public class Idea53430Config {
    private String name = "idea_053430";
 ...
 */
@Slf4j
public class Idea53430Service {
    private static final int IDEA_ID = 53430;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53430Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53430Service() {
        this(new Idea53430Config());
    }

    public Idea53430Service(Idea53430Config config) {
        this.config = config != null ? config : new Idea53430Config();
