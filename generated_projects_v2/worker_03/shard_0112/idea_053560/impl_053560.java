...
@Data
public class Idea53560Config {
    private String name = "idea_053560";
 ...
 */
@Slf4j
public class Idea53560Service {
    private static final int IDEA_ID = 53560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53560Service() {
        this(new Idea53560Config());
    }

    public Idea53560Service(Idea53560Config config) {
        this.config = config != null ? config : new Idea53560Config();
