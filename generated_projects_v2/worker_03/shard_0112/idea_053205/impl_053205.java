...
@Data
public class Idea53205Config {
    private String name = "idea_053205";
 ...
 */
@Slf4j
public class Idea53205Service {
    private static final int IDEA_ID = 53205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53205Service() {
        this(new Idea53205Config());
    }

    public Idea53205Service(Idea53205Config config) {
        this.config = config != null ? config : new Idea53205Config();
