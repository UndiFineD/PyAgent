...
@Data
public class Idea53217Config {
    private String name = "idea_053217";
 ...
 */
@Slf4j
public class Idea53217Service {
    private static final int IDEA_ID = 53217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53217Service() {
        this(new Idea53217Config());
    }

    public Idea53217Service(Idea53217Config config) {
        this.config = config != null ? config : new Idea53217Config();
