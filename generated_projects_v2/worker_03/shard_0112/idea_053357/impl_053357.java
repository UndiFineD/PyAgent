...
@Data
public class Idea53357Config {
    private String name = "idea_053357";
 ...
 */
@Slf4j
public class Idea53357Service {
    private static final int IDEA_ID = 53357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53357Service() {
        this(new Idea53357Config());
    }

    public Idea53357Service(Idea53357Config config) {
        this.config = config != null ? config : new Idea53357Config();
