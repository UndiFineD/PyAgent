...
@Data
public class Idea53652Config {
    private String name = "idea_053652";
 ...
 */
@Slf4j
public class Idea53652Service {
    private static final int IDEA_ID = 53652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53652Service() {
        this(new Idea53652Config());
    }

    public Idea53652Service(Idea53652Config config) {
        this.config = config != null ? config : new Idea53652Config();
