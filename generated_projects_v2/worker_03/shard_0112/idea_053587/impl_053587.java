...
@Data
public class Idea53587Config {
    private String name = "idea_053587";
 ...
 */
@Slf4j
public class Idea53587Service {
    private static final int IDEA_ID = 53587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53587Service() {
        this(new Idea53587Config());
    }

    public Idea53587Service(Idea53587Config config) {
        this.config = config != null ? config : new Idea53587Config();
