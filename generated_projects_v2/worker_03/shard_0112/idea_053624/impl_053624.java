...
@Data
public class Idea53624Config {
    private String name = "idea_053624";
 ...
 */
@Slf4j
public class Idea53624Service {
    private static final int IDEA_ID = 53624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53624Service() {
        this(new Idea53624Config());
    }

    public Idea53624Service(Idea53624Config config) {
        this.config = config != null ? config : new Idea53624Config();
