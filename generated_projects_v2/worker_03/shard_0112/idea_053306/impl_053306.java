...
@Data
public class Idea53306Config {
    private String name = "idea_053306";
 ...
 */
@Slf4j
public class Idea53306Service {
    private static final int IDEA_ID = 53306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53306Service() {
        this(new Idea53306Config());
    }

    public Idea53306Service(Idea53306Config config) {
        this.config = config != null ? config : new Idea53306Config();
