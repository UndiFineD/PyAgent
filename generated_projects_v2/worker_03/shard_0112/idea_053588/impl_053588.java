...
@Data
public class Idea53588Config {
    private String name = "idea_053588";
 ...
 */
@Slf4j
public class Idea53588Service {
    private static final int IDEA_ID = 53588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53588Service() {
        this(new Idea53588Config());
    }

    public Idea53588Service(Idea53588Config config) {
        this.config = config != null ? config : new Idea53588Config();
