...
@Data
public class Idea53612Config {
    private String name = "idea_053612";
 ...
 */
@Slf4j
public class Idea53612Service {
    private static final int IDEA_ID = 53612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53612Service() {
        this(new Idea53612Config());
    }

    public Idea53612Service(Idea53612Config config) {
        this.config = config != null ? config : new Idea53612Config();
