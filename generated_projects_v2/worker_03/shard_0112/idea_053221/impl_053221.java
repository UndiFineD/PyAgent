...
@Data
public class Idea53221Config {
    private String name = "idea_053221";
 ...
 */
@Slf4j
public class Idea53221Service {
    private static final int IDEA_ID = 53221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53221Service() {
        this(new Idea53221Config());
    }

    public Idea53221Service(Idea53221Config config) {
        this.config = config != null ? config : new Idea53221Config();
