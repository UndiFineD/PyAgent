...
@Data
public class Idea53204Config {
    private String name = "idea_053204";
 ...
 */
@Slf4j
public class Idea53204Service {
    private static final int IDEA_ID = 53204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53204Service() {
        this(new Idea53204Config());
    }

    public Idea53204Service(Idea53204Config config) {
        this.config = config != null ? config : new Idea53204Config();
