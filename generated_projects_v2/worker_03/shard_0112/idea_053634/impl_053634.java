...
@Data
public class Idea53634Config {
    private String name = "idea_053634";
 ...
 */
@Slf4j
public class Idea53634Service {
    private static final int IDEA_ID = 53634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53634Service() {
        this(new Idea53634Config());
    }

    public Idea53634Service(Idea53634Config config) {
        this.config = config != null ? config : new Idea53634Config();
