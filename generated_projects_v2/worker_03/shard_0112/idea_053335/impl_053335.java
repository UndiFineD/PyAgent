...
@Data
public class Idea53335Config {
    private String name = "idea_053335";
 ...
 */
@Slf4j
public class Idea53335Service {
    private static final int IDEA_ID = 53335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53335Service() {
        this(new Idea53335Config());
    }

    public Idea53335Service(Idea53335Config config) {
        this.config = config != null ? config : new Idea53335Config();
