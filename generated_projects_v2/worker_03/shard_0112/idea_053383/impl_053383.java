...
@Data
public class Idea53383Config {
    private String name = "idea_053383";
 ...
 */
@Slf4j
public class Idea53383Service {
    private static final int IDEA_ID = 53383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53383Service() {
        this(new Idea53383Config());
    }

    public Idea53383Service(Idea53383Config config) {
        this.config = config != null ? config : new Idea53383Config();
