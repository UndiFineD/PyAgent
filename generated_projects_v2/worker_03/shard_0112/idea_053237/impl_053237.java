...
@Data
public class Idea53237Config {
    private String name = "idea_053237";
 ...
 */
@Slf4j
public class Idea53237Service {
    private static final int IDEA_ID = 53237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53237Service() {
        this(new Idea53237Config());
    }

    public Idea53237Service(Idea53237Config config) {
        this.config = config != null ? config : new Idea53237Config();
