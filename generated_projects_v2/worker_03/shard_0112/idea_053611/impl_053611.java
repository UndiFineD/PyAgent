...
@Data
public class Idea53611Config {
    private String name = "idea_053611";
 ...
 */
@Slf4j
public class Idea53611Service {
    private static final int IDEA_ID = 53611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53611Service() {
        this(new Idea53611Config());
    }

    public Idea53611Service(Idea53611Config config) {
        this.config = config != null ? config : new Idea53611Config();
