...
@Data
public class Idea53255Config {
    private String name = "idea_053255";
 ...
 */
@Slf4j
public class Idea53255Service {
    private static final int IDEA_ID = 53255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53255Service() {
        this(new Idea53255Config());
    }

    public Idea53255Service(Idea53255Config config) {
        this.config = config != null ? config : new Idea53255Config();
