...
@Data
public class Idea53573Config {
    private String name = "idea_053573";
 ...
 */
@Slf4j
public class Idea53573Service {
    private static final int IDEA_ID = 53573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53573Service() {
        this(new Idea53573Config());
    }

    public Idea53573Service(Idea53573Config config) {
        this.config = config != null ? config : new Idea53573Config();
