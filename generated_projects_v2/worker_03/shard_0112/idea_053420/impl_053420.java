...
@Data
public class Idea53420Config {
    private String name = "idea_053420";
 ...
 */
@Slf4j
public class Idea53420Service {
    private static final int IDEA_ID = 53420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53420Service() {
        this(new Idea53420Config());
    }

    public Idea53420Service(Idea53420Config config) {
        this.config = config != null ? config : new Idea53420Config();
