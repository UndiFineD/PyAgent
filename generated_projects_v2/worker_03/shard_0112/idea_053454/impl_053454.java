...
@Data
public class Idea53454Config {
    private String name = "idea_053454";
 ...
 */
@Slf4j
public class Idea53454Service {
    private static final int IDEA_ID = 53454;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53454Service() {
        this(new Idea53454Config());
    }

    public Idea53454Service(Idea53454Config config) {
        this.config = config != null ? config : new Idea53454Config();
