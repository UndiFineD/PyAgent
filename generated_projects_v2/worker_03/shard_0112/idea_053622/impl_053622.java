...
@Data
public class Idea53622Config {
    private String name = "idea_053622";
 ...
 */
@Slf4j
public class Idea53622Service {
    private static final int IDEA_ID = 53622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53622Service() {
        this(new Idea53622Config());
    }

    public Idea53622Service(Idea53622Config config) {
        this.config = config != null ? config : new Idea53622Config();
