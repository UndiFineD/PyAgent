...
@Data
public class Idea53387Config {
    private String name = "idea_053387";
 ...
 */
@Slf4j
public class Idea53387Service {
    private static final int IDEA_ID = 53387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53387Service() {
        this(new Idea53387Config());
    }

    public Idea53387Service(Idea53387Config config) {
        this.config = config != null ? config : new Idea53387Config();
