...
@Data
public class Idea53646Config {
    private String name = "idea_053646";
 ...
 */
@Slf4j
public class Idea53646Service {
    private static final int IDEA_ID = 53646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53646Service() {
        this(new Idea53646Config());
    }

    public Idea53646Service(Idea53646Config config) {
        this.config = config != null ? config : new Idea53646Config();
