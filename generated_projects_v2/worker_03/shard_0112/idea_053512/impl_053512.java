...
@Data
public class Idea53512Config {
    private String name = "idea_053512";
 ...
 */
@Slf4j
public class Idea53512Service {
    private static final int IDEA_ID = 53512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53512Service() {
        this(new Idea53512Config());
    }

    public Idea53512Service(Idea53512Config config) {
        this.config = config != null ? config : new Idea53512Config();
