...
@Data
public class Idea53625Config {
    private String name = "idea_053625";
 ...
 */
@Slf4j
public class Idea53625Service {
    private static final int IDEA_ID = 53625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53625Service() {
        this(new Idea53625Config());
    }

    public Idea53625Service(Idea53625Config config) {
        this.config = config != null ? config : new Idea53625Config();
