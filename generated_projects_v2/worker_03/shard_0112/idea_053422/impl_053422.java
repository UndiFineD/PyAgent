...
@Data
public class Idea53422Config {
    private String name = "idea_053422";
 ...
 */
@Slf4j
public class Idea53422Service {
    private static final int IDEA_ID = 53422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53422Service() {
        this(new Idea53422Config());
    }

    public Idea53422Service(Idea53422Config config) {
        this.config = config != null ? config : new Idea53422Config();
