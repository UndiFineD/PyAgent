...
@Data
public class Idea53606Config {
    private String name = "idea_053606";
 ...
 */
@Slf4j
public class Idea53606Service {
    private static final int IDEA_ID = 53606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53606Service() {
        this(new Idea53606Config());
    }

    public Idea53606Service(Idea53606Config config) {
        this.config = config != null ? config : new Idea53606Config();
