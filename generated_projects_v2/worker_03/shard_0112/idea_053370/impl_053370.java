...
@Data
public class Idea53370Config {
    private String name = "idea_053370";
 ...
 */
@Slf4j
public class Idea53370Service {
    private static final int IDEA_ID = 53370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53370Service() {
        this(new Idea53370Config());
    }

    public Idea53370Service(Idea53370Config config) {
        this.config = config != null ? config : new Idea53370Config();
