...
@Data
public class Idea53562Config {
    private String name = "idea_053562";
 ...
 */
@Slf4j
public class Idea53562Service {
    private static final int IDEA_ID = 53562;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53562Service() {
        this(new Idea53562Config());
    }

    public Idea53562Service(Idea53562Config config) {
        this.config = config != null ? config : new Idea53562Config();
