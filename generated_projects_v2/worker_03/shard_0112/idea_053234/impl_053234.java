...
@Data
public class Idea53234Config {
    private String name = "idea_053234";
 ...
 */
@Slf4j
public class Idea53234Service {
    private static final int IDEA_ID = 53234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53234Service() {
        this(new Idea53234Config());
    }

    public Idea53234Service(Idea53234Config config) {
        this.config = config != null ? config : new Idea53234Config();
