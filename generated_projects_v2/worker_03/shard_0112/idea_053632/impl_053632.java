...
@Data
public class Idea53632Config {
    private String name = "idea_053632";
 ...
 */
@Slf4j
public class Idea53632Service {
    private static final int IDEA_ID = 53632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53632Service() {
        this(new Idea53632Config());
    }

    public Idea53632Service(Idea53632Config config) {
        this.config = config != null ? config : new Idea53632Config();
