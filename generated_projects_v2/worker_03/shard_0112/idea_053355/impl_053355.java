...
@Data
public class Idea53355Config {
    private String name = "idea_053355";
 ...
 */
@Slf4j
public class Idea53355Service {
    private static final int IDEA_ID = 53355;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53355Service() {
        this(new Idea53355Config());
    }

    public Idea53355Service(Idea53355Config config) {
        this.config = config != null ? config : new Idea53355Config();
