...
@Data
public class Idea53660Config {
    private String name = "idea_053660";
 ...
 */
@Slf4j
public class Idea53660Service {
    private static final int IDEA_ID = 53660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53660Service() {
        this(new Idea53660Config());
    }

    public Idea53660Service(Idea53660Config config) {
        this.config = config != null ? config : new Idea53660Config();
