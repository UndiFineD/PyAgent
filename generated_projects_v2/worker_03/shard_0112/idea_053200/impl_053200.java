...
@Data
public class Idea53200Config {
    private String name = "idea_053200";
 ...
 */
@Slf4j
public class Idea53200Service {
    private static final int IDEA_ID = 53200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53200Service() {
        this(new Idea53200Config());
    }

    public Idea53200Service(Idea53200Config config) {
        this.config = config != null ? config : new Idea53200Config();
