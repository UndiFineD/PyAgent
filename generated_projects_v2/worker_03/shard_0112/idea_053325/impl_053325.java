...
@Data
public class Idea53325Config {
    private String name = "idea_053325";
 ...
 */
@Slf4j
public class Idea53325Service {
    private static final int IDEA_ID = 53325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53325Service() {
        this(new Idea53325Config());
    }

    public Idea53325Service(Idea53325Config config) {
        this.config = config != null ? config : new Idea53325Config();
