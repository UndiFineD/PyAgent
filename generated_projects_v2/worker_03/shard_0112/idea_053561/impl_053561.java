...
@Data
public class Idea53561Config {
    private String name = "idea_053561";
 ...
 */
@Slf4j
public class Idea53561Service {
    private static final int IDEA_ID = 53561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53561Service() {
        this(new Idea53561Config());
    }

    public Idea53561Service(Idea53561Config config) {
        this.config = config != null ? config : new Idea53561Config();
