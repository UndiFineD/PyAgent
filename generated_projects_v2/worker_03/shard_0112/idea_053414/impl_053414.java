...
@Data
public class Idea53414Config {
    private String name = "idea_053414";
 ...
 */
@Slf4j
public class Idea53414Service {
    private static final int IDEA_ID = 53414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53414Service() {
        this(new Idea53414Config());
    }

    public Idea53414Service(Idea53414Config config) {
        this.config = config != null ? config : new Idea53414Config();
