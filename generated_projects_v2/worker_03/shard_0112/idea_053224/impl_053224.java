...
@Data
public class Idea53224Config {
    private String name = "idea_053224";
 ...
 */
@Slf4j
public class Idea53224Service {
    private static final int IDEA_ID = 53224;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53224Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53224Service() {
        this(new Idea53224Config());
    }

    public Idea53224Service(Idea53224Config config) {
        this.config = config != null ? config : new Idea53224Config();
