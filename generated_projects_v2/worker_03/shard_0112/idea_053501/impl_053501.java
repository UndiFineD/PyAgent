...
@Data
public class Idea53501Config {
    private String name = "idea_053501";
 ...
 */
@Slf4j
public class Idea53501Service {
    private static final int IDEA_ID = 53501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53501Service() {
        this(new Idea53501Config());
    }

    public Idea53501Service(Idea53501Config config) {
        this.config = config != null ? config : new Idea53501Config();
