...
@Data
public class Idea53423Config {
    private String name = "idea_053423";
 ...
 */
@Slf4j
public class Idea53423Service {
    private static final int IDEA_ID = 53423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53423Service() {
        this(new Idea53423Config());
    }

    public Idea53423Service(Idea53423Config config) {
        this.config = config != null ? config : new Idea53423Config();
