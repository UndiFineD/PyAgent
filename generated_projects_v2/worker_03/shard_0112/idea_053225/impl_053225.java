...
@Data
public class Idea53225Config {
    private String name = "idea_053225";
 ...
 */
@Slf4j
public class Idea53225Service {
    private static final int IDEA_ID = 53225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53225Service() {
        this(new Idea53225Config());
    }

    public Idea53225Service(Idea53225Config config) {
        this.config = config != null ? config : new Idea53225Config();
