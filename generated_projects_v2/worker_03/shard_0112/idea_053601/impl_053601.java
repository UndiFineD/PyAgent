...
@Data
public class Idea53601Config {
    private String name = "idea_053601";
 ...
 */
@Slf4j
public class Idea53601Service {
    private static final int IDEA_ID = 53601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53601Service() {
        this(new Idea53601Config());
    }

    public Idea53601Service(Idea53601Config config) {
        this.config = config != null ? config : new Idea53601Config();
