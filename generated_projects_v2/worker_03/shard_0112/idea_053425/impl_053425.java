...
@Data
public class Idea53425Config {
    private String name = "idea_053425";
 ...
 */
@Slf4j
public class Idea53425Service {
    private static final int IDEA_ID = 53425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53425Service() {
        this(new Idea53425Config());
    }

    public Idea53425Service(Idea53425Config config) {
        this.config = config != null ? config : new Idea53425Config();
