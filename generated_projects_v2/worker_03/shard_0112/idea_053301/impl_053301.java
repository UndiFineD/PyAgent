...
@Data
public class Idea53301Config {
    private String name = "idea_053301";
 ...
 */
@Slf4j
public class Idea53301Service {
    private static final int IDEA_ID = 53301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53301Service() {
        this(new Idea53301Config());
    }

    public Idea53301Service(Idea53301Config config) {
        this.config = config != null ? config : new Idea53301Config();
