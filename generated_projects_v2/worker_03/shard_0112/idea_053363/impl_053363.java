...
@Data
public class Idea53363Config {
    private String name = "idea_053363";
 ...
 */
@Slf4j
public class Idea53363Service {
    private static final int IDEA_ID = 53363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53363Service() {
        this(new Idea53363Config());
    }

    public Idea53363Service(Idea53363Config config) {
        this.config = config != null ? config : new Idea53363Config();
