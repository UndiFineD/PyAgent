...
@Data
public class Idea53643Config {
    private String name = "idea_053643";
 ...
 */
@Slf4j
public class Idea53643Service {
    private static final int IDEA_ID = 53643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53643Service() {
        this(new Idea53643Config());
    }

    public Idea53643Service(Idea53643Config config) {
        this.config = config != null ? config : new Idea53643Config();
