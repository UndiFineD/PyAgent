...
@Data
public class Idea53639Config {
    private String name = "idea_053639";
 ...
 */
@Slf4j
public class Idea53639Service {
    private static final int IDEA_ID = 53639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53639Service() {
        this(new Idea53639Config());
    }

    public Idea53639Service(Idea53639Config config) {
        this.config = config != null ? config : new Idea53639Config();
