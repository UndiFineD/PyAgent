...
@Data
public class Idea53533Config {
    private String name = "idea_053533";
 ...
 */
@Slf4j
public class Idea53533Service {
    private static final int IDEA_ID = 53533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53533Service() {
        this(new Idea53533Config());
    }

    public Idea53533Service(Idea53533Config config) {
        this.config = config != null ? config : new Idea53533Config();
