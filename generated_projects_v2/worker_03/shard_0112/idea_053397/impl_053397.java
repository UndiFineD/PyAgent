...
@Data
public class Idea53397Config {
    private String name = "idea_053397";
 ...
 */
@Slf4j
public class Idea53397Service {
    private static final int IDEA_ID = 53397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53397Service() {
        this(new Idea53397Config());
    }

    public Idea53397Service(Idea53397Config config) {
        this.config = config != null ? config : new Idea53397Config();
