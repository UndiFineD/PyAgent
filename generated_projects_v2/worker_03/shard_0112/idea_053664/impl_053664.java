...
@Data
public class Idea53664Config {
    private String name = "idea_053664";
 ...
 */
@Slf4j
public class Idea53664Service {
    private static final int IDEA_ID = 53664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53664Service() {
        this(new Idea53664Config());
    }

    public Idea53664Service(Idea53664Config config) {
        this.config = config != null ? config : new Idea53664Config();
