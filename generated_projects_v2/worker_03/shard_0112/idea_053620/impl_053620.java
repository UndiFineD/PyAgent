...
@Data
public class Idea53620Config {
    private String name = "idea_053620";
 ...
 */
@Slf4j
public class Idea53620Service {
    private static final int IDEA_ID = 53620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53620Service() {
        this(new Idea53620Config());
    }

    public Idea53620Service(Idea53620Config config) {
        this.config = config != null ? config : new Idea53620Config();
