...
@Data
public class Idea53413Config {
    private String name = "idea_053413";
 ...
 */
@Slf4j
public class Idea53413Service {
    private static final int IDEA_ID = 53413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53413Service() {
        this(new Idea53413Config());
    }

    public Idea53413Service(Idea53413Config config) {
        this.config = config != null ? config : new Idea53413Config();
