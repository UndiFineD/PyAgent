...
@Data
public class Idea53364Config {
    private String name = "idea_053364";
 ...
 */
@Slf4j
public class Idea53364Service {
    private static final int IDEA_ID = 53364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53364Service() {
        this(new Idea53364Config());
    }

    public Idea53364Service(Idea53364Config config) {
        this.config = config != null ? config : new Idea53364Config();
