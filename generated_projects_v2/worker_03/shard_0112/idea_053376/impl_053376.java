...
@Data
public class Idea53376Config {
    private String name = "idea_053376";
 ...
 */
@Slf4j
public class Idea53376Service {
    private static final int IDEA_ID = 53376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53376Service() {
        this(new Idea53376Config());
    }

    public Idea53376Service(Idea53376Config config) {
        this.config = config != null ? config : new Idea53376Config();
