...
@Data
public class Idea53351Config {
    private String name = "idea_053351";
 ...
 */
@Slf4j
public class Idea53351Service {
    private static final int IDEA_ID = 53351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53351Service() {
        this(new Idea53351Config());
    }

    public Idea53351Service(Idea53351Config config) {
        this.config = config != null ? config : new Idea53351Config();
