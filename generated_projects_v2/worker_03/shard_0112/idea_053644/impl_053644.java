...
@Data
public class Idea53644Config {
    private String name = "idea_053644";
 ...
 */
@Slf4j
public class Idea53644Service {
    private static final int IDEA_ID = 53644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53644Service() {
        this(new Idea53644Config());
    }

    public Idea53644Service(Idea53644Config config) {
        this.config = config != null ? config : new Idea53644Config();
