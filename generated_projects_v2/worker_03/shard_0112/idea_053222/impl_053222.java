...
@Data
public class Idea53222Config {
    private String name = "idea_053222";
 ...
 */
@Slf4j
public class Idea53222Service {
    private static final int IDEA_ID = 53222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53222Service() {
        this(new Idea53222Config());
    }

    public Idea53222Service(Idea53222Config config) {
        this.config = config != null ? config : new Idea53222Config();
