...
@Data
public class Idea53525Config {
    private String name = "idea_053525";
 ...
 */
@Slf4j
public class Idea53525Service {
    private static final int IDEA_ID = 53525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53525Service() {
        this(new Idea53525Config());
    }

    public Idea53525Service(Idea53525Config config) {
        this.config = config != null ? config : new Idea53525Config();
