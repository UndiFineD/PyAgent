...
@Data
public class Idea53323Config {
    private String name = "idea_053323";
 ...
 */
@Slf4j
public class Idea53323Service {
    private static final int IDEA_ID = 53323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53323Service() {
        this(new Idea53323Config());
    }

    public Idea53323Service(Idea53323Config config) {
        this.config = config != null ? config : new Idea53323Config();
