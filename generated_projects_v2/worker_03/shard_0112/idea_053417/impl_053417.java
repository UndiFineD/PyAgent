...
@Data
public class Idea53417Config {
    private String name = "idea_053417";
 ...
 */
@Slf4j
public class Idea53417Service {
    private static final int IDEA_ID = 53417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53417Service() {
        this(new Idea53417Config());
    }

    public Idea53417Service(Idea53417Config config) {
        this.config = config != null ? config : new Idea53417Config();
