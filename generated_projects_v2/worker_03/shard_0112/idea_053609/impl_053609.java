...
@Data
public class Idea53609Config {
    private String name = "idea_053609";
 ...
 */
@Slf4j
public class Idea53609Service {
    private static final int IDEA_ID = 53609;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53609Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53609Service() {
        this(new Idea53609Config());
    }

    public Idea53609Service(Idea53609Config config) {
        this.config = config != null ? config : new Idea53609Config();
