...
@Data
public class Idea53451Config {
    private String name = "idea_053451";
 ...
 */
@Slf4j
public class Idea53451Service {
    private static final int IDEA_ID = 53451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53451Service() {
        this(new Idea53451Config());
    }

    public Idea53451Service(Idea53451Config config) {
        this.config = config != null ? config : new Idea53451Config();
