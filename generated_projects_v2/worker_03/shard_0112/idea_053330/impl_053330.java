...
@Data
public class Idea53330Config {
    private String name = "idea_053330";
 ...
 */
@Slf4j
public class Idea53330Service {
    private static final int IDEA_ID = 53330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53330Service() {
        this(new Idea53330Config());
    }

    public Idea53330Service(Idea53330Config config) {
        this.config = config != null ? config : new Idea53330Config();
