...
@Data
public class Idea53465Config {
    private String name = "idea_053465";
 ...
 */
@Slf4j
public class Idea53465Service {
    private static final int IDEA_ID = 53465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53465Service() {
        this(new Idea53465Config());
    }

    public Idea53465Service(Idea53465Config config) {
        this.config = config != null ? config : new Idea53465Config();
