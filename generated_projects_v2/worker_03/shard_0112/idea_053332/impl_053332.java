...
@Data
public class Idea53332Config {
    private String name = "idea_053332";
 ...
 */
@Slf4j
public class Idea53332Service {
    private static final int IDEA_ID = 53332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53332Service() {
        this(new Idea53332Config());
    }

    public Idea53332Service(Idea53332Config config) {
        this.config = config != null ? config : new Idea53332Config();
