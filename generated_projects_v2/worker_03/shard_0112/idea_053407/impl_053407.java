...
@Data
public class Idea53407Config {
    private String name = "idea_053407";
 ...
 */
@Slf4j
public class Idea53407Service {
    private static final int IDEA_ID = 53407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53407Service() {
        this(new Idea53407Config());
    }

    public Idea53407Service(Idea53407Config config) {
        this.config = config != null ? config : new Idea53407Config();
