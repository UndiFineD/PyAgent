...
@Data
public class Idea53398Config {
    private String name = "idea_053398";
 ...
 */
@Slf4j
public class Idea53398Service {
    private static final int IDEA_ID = 53398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53398Service() {
        this(new Idea53398Config());
    }

    public Idea53398Service(Idea53398Config config) {
        this.config = config != null ? config : new Idea53398Config();
