...
@Data
public class Idea53443Config {
    private String name = "idea_053443";
 ...
 */
@Slf4j
public class Idea53443Service {
    private static final int IDEA_ID = 53443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53443Service() {
        this(new Idea53443Config());
    }

    public Idea53443Service(Idea53443Config config) {
        this.config = config != null ? config : new Idea53443Config();
