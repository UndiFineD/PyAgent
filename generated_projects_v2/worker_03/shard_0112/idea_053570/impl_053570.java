...
@Data
public class Idea53570Config {
    private String name = "idea_053570";
 ...
 */
@Slf4j
public class Idea53570Service {
    private static final int IDEA_ID = 53570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53570Service() {
        this(new Idea53570Config());
    }

    public Idea53570Service(Idea53570Config config) {
        this.config = config != null ? config : new Idea53570Config();
