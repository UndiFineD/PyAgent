...
@Data
public class Idea45150Config {
    private String name = "idea_045150";
 ...
 */
@Slf4j
public class Idea45150Service {
    private static final int IDEA_ID = 45150;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45150Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45150Service() {
        this(new Idea45150Config());
    }

    public Idea45150Service(Idea45150Config config) {
        this.config = config != null ? config : new Idea45150Config();
