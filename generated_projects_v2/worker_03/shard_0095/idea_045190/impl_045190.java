...
@Data
public class Idea45190Config {
    private String name = "idea_045190";
 ...
 */
@Slf4j
public class Idea45190Service {
    private static final int IDEA_ID = 45190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45190Service() {
        this(new Idea45190Config());
    }

    public Idea45190Service(Idea45190Config config) {
        this.config = config != null ? config : new Idea45190Config();
