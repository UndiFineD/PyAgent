...
@Data
public class Idea45165Config {
    private String name = "idea_045165";
 ...
 */
@Slf4j
public class Idea45165Service {
    private static final int IDEA_ID = 45165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45165Service() {
        this(new Idea45165Config());
    }

    public Idea45165Service(Idea45165Config config) {
        this.config = config != null ? config : new Idea45165Config();
