...
@Data
public class Idea45571Config {
    private String name = "idea_045571";
 ...
 */
@Slf4j
public class Idea45571Service {
    private static final int IDEA_ID = 45571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45571Service() {
        this(new Idea45571Config());
    }

    public Idea45571Service(Idea45571Config config) {
        this.config = config != null ? config : new Idea45571Config();
