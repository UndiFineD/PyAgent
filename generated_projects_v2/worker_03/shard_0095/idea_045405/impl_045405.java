...
@Data
public class Idea45405Config {
    private String name = "idea_045405";
 ...
 */
@Slf4j
public class Idea45405Service {
    private static final int IDEA_ID = 45405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45405Service() {
        this(new Idea45405Config());
    }

    public Idea45405Service(Idea45405Config config) {
        this.config = config != null ? config : new Idea45405Config();
