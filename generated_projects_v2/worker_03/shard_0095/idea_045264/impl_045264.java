...
@Data
public class Idea45264Config {
    private String name = "idea_045264";
 ...
 */
@Slf4j
public class Idea45264Service {
    private static final int IDEA_ID = 45264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45264Service() {
        this(new Idea45264Config());
    }

    public Idea45264Service(Idea45264Config config) {
        this.config = config != null ? config : new Idea45264Config();
