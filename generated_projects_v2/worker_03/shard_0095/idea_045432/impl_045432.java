...
@Data
public class Idea45432Config {
    private String name = "idea_045432";
 ...
 */
@Slf4j
public class Idea45432Service {
    private static final int IDEA_ID = 45432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45432Service() {
        this(new Idea45432Config());
    }

    public Idea45432Service(Idea45432Config config) {
        this.config = config != null ? config : new Idea45432Config();
