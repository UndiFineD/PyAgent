...
@Data
public class Idea45502Config {
    private String name = "idea_045502";
 ...
 */
@Slf4j
public class Idea45502Service {
    private static final int IDEA_ID = 45502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45502Service() {
        this(new Idea45502Config());
    }

    public Idea45502Service(Idea45502Config config) {
        this.config = config != null ? config : new Idea45502Config();
