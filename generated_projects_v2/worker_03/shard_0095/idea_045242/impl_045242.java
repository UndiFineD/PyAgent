...
@Data
public class Idea45242Config {
    private String name = "idea_045242";
 ...
 */
@Slf4j
public class Idea45242Service {
    private static final int IDEA_ID = 45242;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45242Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45242Service() {
        this(new Idea45242Config());
    }

    public Idea45242Service(Idea45242Config config) {
        this.config = config != null ? config : new Idea45242Config();
