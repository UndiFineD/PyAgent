...
@Data
public class Idea45166Config {
    private String name = "idea_045166";
 ...
 */
@Slf4j
public class Idea45166Service {
    private static final int IDEA_ID = 45166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45166Service() {
        this(new Idea45166Config());
    }

    public Idea45166Service(Idea45166Config config) {
        this.config = config != null ? config : new Idea45166Config();
