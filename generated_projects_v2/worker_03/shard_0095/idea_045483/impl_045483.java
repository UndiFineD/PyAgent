...
@Data
public class Idea45483Config {
    private String name = "idea_045483";
 ...
 */
@Slf4j
public class Idea45483Service {
    private static final int IDEA_ID = 45483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45483Service() {
        this(new Idea45483Config());
    }

    public Idea45483Service(Idea45483Config config) {
        this.config = config != null ? config : new Idea45483Config();
