...
@Data
public class Idea45236Config {
    private String name = "idea_045236";
 ...
 */
@Slf4j
public class Idea45236Service {
    private static final int IDEA_ID = 45236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45236Service() {
        this(new Idea45236Config());
    }

    public Idea45236Service(Idea45236Config config) {
        this.config = config != null ? config : new Idea45236Config();
