...
@Data
public class Idea45362Config {
    private String name = "idea_045362";
 ...
 */
@Slf4j
public class Idea45362Service {
    private static final int IDEA_ID = 45362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45362Service() {
        this(new Idea45362Config());
    }

    public Idea45362Service(Idea45362Config config) {
        this.config = config != null ? config : new Idea45362Config();
