...
@Data
public class Idea45311Config {
    private String name = "idea_045311";
 ...
 */
@Slf4j
public class Idea45311Service {
    private static final int IDEA_ID = 45311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45311Service() {
        this(new Idea45311Config());
    }

    public Idea45311Service(Idea45311Config config) {
        this.config = config != null ? config : new Idea45311Config();
