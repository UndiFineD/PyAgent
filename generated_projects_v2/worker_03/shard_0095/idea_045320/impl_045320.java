...
@Data
public class Idea45320Config {
    private String name = "idea_045320";
 ...
 */
@Slf4j
public class Idea45320Service {
    private static final int IDEA_ID = 45320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45320Service() {
        this(new Idea45320Config());
    }

    public Idea45320Service(Idea45320Config config) {
        this.config = config != null ? config : new Idea45320Config();
