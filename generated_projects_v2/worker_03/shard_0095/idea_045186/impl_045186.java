...
@Data
public class Idea45186Config {
    private String name = "idea_045186";
 ...
 */
@Slf4j
public class Idea45186Service {
    private static final int IDEA_ID = 45186;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45186Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45186Service() {
        this(new Idea45186Config());
    }

    public Idea45186Service(Idea45186Config config) {
        this.config = config != null ? config : new Idea45186Config();
