...
@Data
public class Idea45520Config {
    private String name = "idea_045520";
 ...
 */
@Slf4j
public class Idea45520Service {
    private static final int IDEA_ID = 45520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45520Service() {
        this(new Idea45520Config());
    }

    public Idea45520Service(Idea45520Config config) {
        this.config = config != null ? config : new Idea45520Config();
