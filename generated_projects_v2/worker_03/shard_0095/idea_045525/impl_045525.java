...
@Data
public class Idea45525Config {
    private String name = "idea_045525";
 ...
 */
@Slf4j
public class Idea45525Service {
    private static final int IDEA_ID = 45525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45525Service() {
        this(new Idea45525Config());
    }

    public Idea45525Service(Idea45525Config config) {
        this.config = config != null ? config : new Idea45525Config();
