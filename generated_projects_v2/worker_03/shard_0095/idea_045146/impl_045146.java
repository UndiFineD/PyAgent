...
@Data
public class Idea45146Config {
    private String name = "idea_045146";
 ...
 */
@Slf4j
public class Idea45146Service {
    private static final int IDEA_ID = 45146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45146Service() {
        this(new Idea45146Config());
    }

    public Idea45146Service(Idea45146Config config) {
        this.config = config != null ? config : new Idea45146Config();
