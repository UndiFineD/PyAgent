...
@Data
public class Idea45411Config {
    private String name = "idea_045411";
 ...
 */
@Slf4j
public class Idea45411Service {
    private static final int IDEA_ID = 45411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45411Service() {
        this(new Idea45411Config());
    }

    public Idea45411Service(Idea45411Config config) {
        this.config = config != null ? config : new Idea45411Config();
