...
@Data
public class Idea45349Config {
    private String name = "idea_045349";
 ...
 */
@Slf4j
public class Idea45349Service {
    private static final int IDEA_ID = 45349;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45349Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45349Service() {
        this(new Idea45349Config());
    }

    public Idea45349Service(Idea45349Config config) {
        this.config = config != null ? config : new Idea45349Config();
