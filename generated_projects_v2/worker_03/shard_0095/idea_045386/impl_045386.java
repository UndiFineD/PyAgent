...
@Data
public class Idea45386Config {
    private String name = "idea_045386";
 ...
 */
@Slf4j
public class Idea45386Service {
    private static final int IDEA_ID = 45386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45386Service() {
        this(new Idea45386Config());
    }

    public Idea45386Service(Idea45386Config config) {
        this.config = config != null ? config : new Idea45386Config();
