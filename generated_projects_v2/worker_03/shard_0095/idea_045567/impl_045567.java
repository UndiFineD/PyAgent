...
@Data
public class Idea45567Config {
    private String name = "idea_045567";
 ...
 */
@Slf4j
public class Idea45567Service {
    private static final int IDEA_ID = 45567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45567Service() {
        this(new Idea45567Config());
    }

    public Idea45567Service(Idea45567Config config) {
        this.config = config != null ? config : new Idea45567Config();
