...
@Data
public class Idea45241Config {
    private String name = "idea_045241";
 ...
 */
@Slf4j
public class Idea45241Service {
    private static final int IDEA_ID = 45241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45241Service() {
        this(new Idea45241Config());
    }

    public Idea45241Service(Idea45241Config config) {
        this.config = config != null ? config : new Idea45241Config();
