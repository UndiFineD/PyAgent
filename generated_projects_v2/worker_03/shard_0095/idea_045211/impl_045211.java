...
@Data
public class Idea45211Config {
    private String name = "idea_045211";
 ...
 */
@Slf4j
public class Idea45211Service {
    private static final int IDEA_ID = 45211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45211Service() {
        this(new Idea45211Config());
    }

    public Idea45211Service(Idea45211Config config) {
        this.config = config != null ? config : new Idea45211Config();
