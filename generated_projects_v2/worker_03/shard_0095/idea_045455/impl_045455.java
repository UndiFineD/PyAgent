...
@Data
public class Idea45455Config {
    private String name = "idea_045455";
 ...
 */
@Slf4j
public class Idea45455Service {
    private static final int IDEA_ID = 45455;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45455Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45455Service() {
        this(new Idea45455Config());
    }

    public Idea45455Service(Idea45455Config config) {
        this.config = config != null ? config : new Idea45455Config();
