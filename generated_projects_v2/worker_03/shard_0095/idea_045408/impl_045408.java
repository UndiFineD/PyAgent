...
@Data
public class Idea45408Config {
    private String name = "idea_045408";
 ...
 */
@Slf4j
public class Idea45408Service {
    private static final int IDEA_ID = 45408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45408Service() {
        this(new Idea45408Config());
    }

    public Idea45408Service(Idea45408Config config) {
        this.config = config != null ? config : new Idea45408Config();
