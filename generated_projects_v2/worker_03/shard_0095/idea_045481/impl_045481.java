...
@Data
public class Idea45481Config {
    private String name = "idea_045481";
 ...
 */
@Slf4j
public class Idea45481Service {
    private static final int IDEA_ID = 45481;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45481Service() {
        this(new Idea45481Config());
    }

    public Idea45481Service(Idea45481Config config) {
        this.config = config != null ? config : new Idea45481Config();
