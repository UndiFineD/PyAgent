...
@Data
public class Idea45185Config {
    private String name = "idea_045185";
 ...
 */
@Slf4j
public class Idea45185Service {
    private static final int IDEA_ID = 45185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45185Service() {
        this(new Idea45185Config());
    }

    public Idea45185Service(Idea45185Config config) {
        this.config = config != null ? config : new Idea45185Config();
