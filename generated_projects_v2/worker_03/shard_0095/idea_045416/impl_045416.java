...
@Data
public class Idea45416Config {
    private String name = "idea_045416";
 ...
 */
@Slf4j
public class Idea45416Service {
    private static final int IDEA_ID = 45416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45416Service() {
        this(new Idea45416Config());
    }

    public Idea45416Service(Idea45416Config config) {
        this.config = config != null ? config : new Idea45416Config();
