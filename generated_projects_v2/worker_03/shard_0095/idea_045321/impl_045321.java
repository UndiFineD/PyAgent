...
@Data
public class Idea45321Config {
    private String name = "idea_045321";
 ...
 */
@Slf4j
public class Idea45321Service {
    private static final int IDEA_ID = 45321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45321Service() {
        this(new Idea45321Config());
    }

    public Idea45321Service(Idea45321Config config) {
        this.config = config != null ? config : new Idea45321Config();
