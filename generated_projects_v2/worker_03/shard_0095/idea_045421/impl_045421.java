...
@Data
public class Idea45421Config {
    private String name = "idea_045421";
 ...
 */
@Slf4j
public class Idea45421Service {
    private static final int IDEA_ID = 45421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45421Service() {
        this(new Idea45421Config());
    }

    public Idea45421Service(Idea45421Config config) {
        this.config = config != null ? config : new Idea45421Config();
