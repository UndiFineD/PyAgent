...
@Data
public class Idea45258Config {
    private String name = "idea_045258";
 ...
 */
@Slf4j
public class Idea45258Service {
    private static final int IDEA_ID = 45258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45258Service() {
        this(new Idea45258Config());
    }

    public Idea45258Service(Idea45258Config config) {
        this.config = config != null ? config : new Idea45258Config();
