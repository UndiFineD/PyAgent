...
@Data
public class Idea45387Config {
    private String name = "idea_045387";
 ...
 */
@Slf4j
public class Idea45387Service {
    private static final int IDEA_ID = 45387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45387Service() {
        this(new Idea45387Config());
    }

    public Idea45387Service(Idea45387Config config) {
        this.config = config != null ? config : new Idea45387Config();
