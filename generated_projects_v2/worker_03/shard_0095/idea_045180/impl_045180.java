...
@Data
public class Idea45180Config {
    private String name = "idea_045180";
 ...
 */
@Slf4j
public class Idea45180Service {
    private static final int IDEA_ID = 45180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45180Service() {
        this(new Idea45180Config());
    }

    public Idea45180Service(Idea45180Config config) {
        this.config = config != null ? config : new Idea45180Config();
