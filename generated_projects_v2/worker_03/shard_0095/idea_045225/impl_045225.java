...
@Data
public class Idea45225Config {
    private String name = "idea_045225";
 ...
 */
@Slf4j
public class Idea45225Service {
    private static final int IDEA_ID = 45225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45225Service() {
        this(new Idea45225Config());
    }

    public Idea45225Service(Idea45225Config config) {
        this.config = config != null ? config : new Idea45225Config();
