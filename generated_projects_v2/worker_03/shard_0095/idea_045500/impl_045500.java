...
@Data
public class Idea45500Config {
    private String name = "idea_045500";
 ...
 */
@Slf4j
public class Idea45500Service {
    private static final int IDEA_ID = 45500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45500Service() {
        this(new Idea45500Config());
    }

    public Idea45500Service(Idea45500Config config) {
        this.config = config != null ? config : new Idea45500Config();
