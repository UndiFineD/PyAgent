...
@Data
public class Idea45205Config {
    private String name = "idea_045205";
 ...
 */
@Slf4j
public class Idea45205Service {
    private static final int IDEA_ID = 45205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45205Service() {
        this(new Idea45205Config());
    }

    public Idea45205Service(Idea45205Config config) {
        this.config = config != null ? config : new Idea45205Config();
