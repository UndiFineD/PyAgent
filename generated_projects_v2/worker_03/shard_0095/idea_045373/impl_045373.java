...
@Data
public class Idea45373Config {
    private String name = "idea_045373";
 ...
 */
@Slf4j
public class Idea45373Service {
    private static final int IDEA_ID = 45373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45373Service() {
        this(new Idea45373Config());
    }

    public Idea45373Service(Idea45373Config config) {
        this.config = config != null ? config : new Idea45373Config();
