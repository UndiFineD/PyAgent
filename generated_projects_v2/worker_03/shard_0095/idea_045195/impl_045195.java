...
@Data
public class Idea45195Config {
    private String name = "idea_045195";
 ...
 */
@Slf4j
public class Idea45195Service {
    private static final int IDEA_ID = 45195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45195Service() {
        this(new Idea45195Config());
    }

    public Idea45195Service(Idea45195Config config) {
        this.config = config != null ? config : new Idea45195Config();
