...
@Data
public class Idea45173Config {
    private String name = "idea_045173";
 ...
 */
@Slf4j
public class Idea45173Service {
    private static final int IDEA_ID = 45173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45173Service() {
        this(new Idea45173Config());
    }

    public Idea45173Service(Idea45173Config config) {
        this.config = config != null ? config : new Idea45173Config();
