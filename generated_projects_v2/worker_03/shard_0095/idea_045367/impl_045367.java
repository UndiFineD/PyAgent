...
@Data
public class Idea45367Config {
    private String name = "idea_045367";
 ...
 */
@Slf4j
public class Idea45367Service {
    private static final int IDEA_ID = 45367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45367Service() {
        this(new Idea45367Config());
    }

    public Idea45367Service(Idea45367Config config) {
        this.config = config != null ? config : new Idea45367Config();
