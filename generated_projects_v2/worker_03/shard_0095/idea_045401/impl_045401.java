...
@Data
public class Idea45401Config {
    private String name = "idea_045401";
 ...
 */
@Slf4j
public class Idea45401Service {
    private static final int IDEA_ID = 45401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45401Service() {
        this(new Idea45401Config());
    }

    public Idea45401Service(Idea45401Config config) {
        this.config = config != null ? config : new Idea45401Config();
