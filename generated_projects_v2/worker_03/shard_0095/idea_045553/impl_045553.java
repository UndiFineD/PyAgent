...
@Data
public class Idea45553Config {
    private String name = "idea_045553";
 ...
 */
@Slf4j
public class Idea45553Service {
    private static final int IDEA_ID = 45553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45553Service() {
        this(new Idea45553Config());
    }

    public Idea45553Service(Idea45553Config config) {
        this.config = config != null ? config : new Idea45553Config();
