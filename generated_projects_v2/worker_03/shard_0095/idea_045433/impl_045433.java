...
@Data
public class Idea45433Config {
    private String name = "idea_045433";
 ...
 */
@Slf4j
public class Idea45433Service {
    private static final int IDEA_ID = 45433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45433Service() {
        this(new Idea45433Config());
    }

    public Idea45433Service(Idea45433Config config) {
        this.config = config != null ? config : new Idea45433Config();
