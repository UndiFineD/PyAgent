...
@Data
public class Idea45438Config {
    private String name = "idea_045438";
 ...
 */
@Slf4j
public class Idea45438Service {
    private static final int IDEA_ID = 45438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45438Service() {
        this(new Idea45438Config());
    }

    public Idea45438Service(Idea45438Config config) {
        this.config = config != null ? config : new Idea45438Config();
