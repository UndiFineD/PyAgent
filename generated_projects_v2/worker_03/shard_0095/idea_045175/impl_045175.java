...
@Data
public class Idea45175Config {
    private String name = "idea_045175";
 ...
 */
@Slf4j
public class Idea45175Service {
    private static final int IDEA_ID = 45175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45175Service() {
        this(new Idea45175Config());
    }

    public Idea45175Service(Idea45175Config config) {
        this.config = config != null ? config : new Idea45175Config();
