...
@Data
public class Idea45434Config {
    private String name = "idea_045434";
 ...
 */
@Slf4j
public class Idea45434Service {
    private static final int IDEA_ID = 45434;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45434Service() {
        this(new Idea45434Config());
    }

    public Idea45434Service(Idea45434Config config) {
        this.config = config != null ? config : new Idea45434Config();
