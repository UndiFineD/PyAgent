...
@Data
public class Idea45290Config {
    private String name = "idea_045290";
 ...
 */
@Slf4j
public class Idea45290Service {
    private static final int IDEA_ID = 45290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45290Service() {
        this(new Idea45290Config());
    }

    public Idea45290Service(Idea45290Config config) {
        this.config = config != null ? config : new Idea45290Config();
