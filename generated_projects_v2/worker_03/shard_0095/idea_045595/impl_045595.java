...
@Data
public class Idea45595Config {
    private String name = "idea_045595";
 ...
 */
@Slf4j
public class Idea45595Service {
    private static final int IDEA_ID = 45595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45595Service() {
        this(new Idea45595Config());
    }

    public Idea45595Service(Idea45595Config config) {
        this.config = config != null ? config : new Idea45595Config();
