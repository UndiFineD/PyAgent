...
@Data
public class Idea45270Config {
    private String name = "idea_045270";
 ...
 */
@Slf4j
public class Idea45270Service {
    private static final int IDEA_ID = 45270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45270Service() {
        this(new Idea45270Config());
    }

    public Idea45270Service(Idea45270Config config) {
        this.config = config != null ? config : new Idea45270Config();
