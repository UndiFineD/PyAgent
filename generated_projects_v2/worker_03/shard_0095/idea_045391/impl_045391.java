...
@Data
public class Idea45391Config {
    private String name = "idea_045391";
 ...
 */
@Slf4j
public class Idea45391Service {
    private static final int IDEA_ID = 45391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45391Service() {
        this(new Idea45391Config());
    }

    public Idea45391Service(Idea45391Config config) {
        this.config = config != null ? config : new Idea45391Config();
