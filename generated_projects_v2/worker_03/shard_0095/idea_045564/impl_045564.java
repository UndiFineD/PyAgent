...
@Data
public class Idea45564Config {
    private String name = "idea_045564";
 ...
 */
@Slf4j
public class Idea45564Service {
    private static final int IDEA_ID = 45564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45564Service() {
        this(new Idea45564Config());
    }

    public Idea45564Service(Idea45564Config config) {
        this.config = config != null ? config : new Idea45564Config();
