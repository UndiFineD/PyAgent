...
@Data
public class Idea45145Config {
    private String name = "idea_045145";
 ...
 */
@Slf4j
public class Idea45145Service {
    private static final int IDEA_ID = 45145;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45145Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45145Service() {
        this(new Idea45145Config());
    }

    public Idea45145Service(Idea45145Config config) {
        this.config = config != null ? config : new Idea45145Config();
