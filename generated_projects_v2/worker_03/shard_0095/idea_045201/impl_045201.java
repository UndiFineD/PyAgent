...
@Data
public class Idea45201Config {
    private String name = "idea_045201";
 ...
 */
@Slf4j
public class Idea45201Service {
    private static final int IDEA_ID = 45201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45201Service() {
        this(new Idea45201Config());
    }

    public Idea45201Service(Idea45201Config config) {
        this.config = config != null ? config : new Idea45201Config();
