...
@Data
public class Idea45512Config {
    private String name = "idea_045512";
 ...
 */
@Slf4j
public class Idea45512Service {
    private static final int IDEA_ID = 45512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45512Service() {
        this(new Idea45512Config());
    }

    public Idea45512Service(Idea45512Config config) {
        this.config = config != null ? config : new Idea45512Config();
