...
@Data
public class Idea45427Config {
    private String name = "idea_045427";
 ...
 */
@Slf4j
public class Idea45427Service {
    private static final int IDEA_ID = 45427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45427Service() {
        this(new Idea45427Config());
    }

    public Idea45427Service(Idea45427Config config) {
        this.config = config != null ? config : new Idea45427Config();
