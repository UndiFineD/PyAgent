...
@Data
public class Idea45357Config {
    private String name = "idea_045357";
 ...
 */
@Slf4j
public class Idea45357Service {
    private static final int IDEA_ID = 45357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45357Service() {
        this(new Idea45357Config());
    }

    public Idea45357Service(Idea45357Config config) {
        this.config = config != null ? config : new Idea45357Config();
