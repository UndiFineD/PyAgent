...
@Data
public class Idea45336Config {
    private String name = "idea_045336";
 ...
 */
@Slf4j
public class Idea45336Service {
    private static final int IDEA_ID = 45336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45336Service() {
        this(new Idea45336Config());
    }

    public Idea45336Service(Idea45336Config config) {
        this.config = config != null ? config : new Idea45336Config();
