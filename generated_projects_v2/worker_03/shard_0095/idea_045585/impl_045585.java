...
@Data
public class Idea45585Config {
    private String name = "idea_045585";
 ...
 */
@Slf4j
public class Idea45585Service {
    private static final int IDEA_ID = 45585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45585Service() {
        this(new Idea45585Config());
    }

    public Idea45585Service(Idea45585Config config) {
        this.config = config != null ? config : new Idea45585Config();
