...
@Data
public class Idea45446Config {
    private String name = "idea_045446";
 ...
 */
@Slf4j
public class Idea45446Service {
    private static final int IDEA_ID = 45446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45446Service() {
        this(new Idea45446Config());
    }

    public Idea45446Service(Idea45446Config config) {
        this.config = config != null ? config : new Idea45446Config();
