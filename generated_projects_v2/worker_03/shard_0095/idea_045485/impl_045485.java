...
@Data
public class Idea45485Config {
    private String name = "idea_045485";
 ...
 */
@Slf4j
public class Idea45485Service {
    private static final int IDEA_ID = 45485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45485Service() {
        this(new Idea45485Config());
    }

    public Idea45485Service(Idea45485Config config) {
        this.config = config != null ? config : new Idea45485Config();
