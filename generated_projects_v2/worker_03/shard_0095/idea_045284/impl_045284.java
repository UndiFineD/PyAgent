...
@Data
public class Idea45284Config {
    private String name = "idea_045284";
 ...
 */
@Slf4j
public class Idea45284Service {
    private static final int IDEA_ID = 45284;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45284Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45284Service() {
        this(new Idea45284Config());
    }

    public Idea45284Service(Idea45284Config config) {
        this.config = config != null ? config : new Idea45284Config();
