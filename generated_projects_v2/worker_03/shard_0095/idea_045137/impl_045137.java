...
@Data
public class Idea45137Config {
    private String name = "idea_045137";
 ...
 */
@Slf4j
public class Idea45137Service {
    private static final int IDEA_ID = 45137;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45137Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45137Service() {
        this(new Idea45137Config());
    }

    public Idea45137Service(Idea45137Config config) {
        this.config = config != null ? config : new Idea45137Config();
