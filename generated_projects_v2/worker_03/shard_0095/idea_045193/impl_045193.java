...
@Data
public class Idea45193Config {
    private String name = "idea_045193";
 ...
 */
@Slf4j
public class Idea45193Service {
    private static final int IDEA_ID = 45193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45193Service() {
        this(new Idea45193Config());
    }

    public Idea45193Service(Idea45193Config config) {
        this.config = config != null ? config : new Idea45193Config();
