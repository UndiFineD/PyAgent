...
@Data
public class Idea45271Config {
    private String name = "idea_045271";
 ...
 */
@Slf4j
public class Idea45271Service {
    private static final int IDEA_ID = 45271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45271Service() {
        this(new Idea45271Config());
    }

    public Idea45271Service(Idea45271Config config) {
        this.config = config != null ? config : new Idea45271Config();
