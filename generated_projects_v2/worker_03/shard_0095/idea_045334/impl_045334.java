...
@Data
public class Idea45334Config {
    private String name = "idea_045334";
 ...
 */
@Slf4j
public class Idea45334Service {
    private static final int IDEA_ID = 45334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45334Service() {
        this(new Idea45334Config());
    }

    public Idea45334Service(Idea45334Config config) {
        this.config = config != null ? config : new Idea45334Config();
