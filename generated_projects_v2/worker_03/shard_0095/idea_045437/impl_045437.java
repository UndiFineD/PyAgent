...
@Data
public class Idea45437Config {
    private String name = "idea_045437";
 ...
 */
@Slf4j
public class Idea45437Service {
    private static final int IDEA_ID = 45437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45437Service() {
        this(new Idea45437Config());
    }

    public Idea45437Service(Idea45437Config config) {
        this.config = config != null ? config : new Idea45437Config();
