...
@Data
public class Idea45591Config {
    private String name = "idea_045591";
 ...
 */
@Slf4j
public class Idea45591Service {
    private static final int IDEA_ID = 45591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45591Service() {
        this(new Idea45591Config());
    }

    public Idea45591Service(Idea45591Config config) {
        this.config = config != null ? config : new Idea45591Config();
