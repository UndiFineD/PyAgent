...
@Data
public class Idea45217Config {
    private String name = "idea_045217";
 ...
 */
@Slf4j
public class Idea45217Service {
    private static final int IDEA_ID = 45217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45217Service() {
        this(new Idea45217Config());
    }

    public Idea45217Service(Idea45217Config config) {
        this.config = config != null ? config : new Idea45217Config();
