...
@Data
public class Idea45364Config {
    private String name = "idea_045364";
 ...
 */
@Slf4j
public class Idea45364Service {
    private static final int IDEA_ID = 45364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45364Service() {
        this(new Idea45364Config());
    }

    public Idea45364Service(Idea45364Config config) {
        this.config = config != null ? config : new Idea45364Config();
