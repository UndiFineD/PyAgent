...
@Data
public class Idea45161Config {
    private String name = "idea_045161";
 ...
 */
@Slf4j
public class Idea45161Service {
    private static final int IDEA_ID = 45161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45161Service() {
        this(new Idea45161Config());
    }

    public Idea45161Service(Idea45161Config config) {
        this.config = config != null ? config : new Idea45161Config();
