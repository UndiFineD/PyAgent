...
@Data
public class Idea45325Config {
    private String name = "idea_045325";
 ...
 */
@Slf4j
public class Idea45325Service {
    private static final int IDEA_ID = 45325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45325Service() {
        this(new Idea45325Config());
    }

    public Idea45325Service(Idea45325Config config) {
        this.config = config != null ? config : new Idea45325Config();
