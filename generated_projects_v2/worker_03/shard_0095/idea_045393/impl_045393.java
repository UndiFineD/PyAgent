...
@Data
public class Idea45393Config {
    private String name = "idea_045393";
 ...
 */
@Slf4j
public class Idea45393Service {
    private static final int IDEA_ID = 45393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45393Service() {
        this(new Idea45393Config());
    }

    public Idea45393Service(Idea45393Config config) {
        this.config = config != null ? config : new Idea45393Config();
