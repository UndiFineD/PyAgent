...
@Data
public class Idea45370Config {
    private String name = "idea_045370";
 ...
 */
@Slf4j
public class Idea45370Service {
    private static final int IDEA_ID = 45370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45370Service() {
        this(new Idea45370Config());
    }

    public Idea45370Service(Idea45370Config config) {
        this.config = config != null ? config : new Idea45370Config();
