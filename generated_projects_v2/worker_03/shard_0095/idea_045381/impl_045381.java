...
@Data
public class Idea45381Config {
    private String name = "idea_045381";
 ...
 */
@Slf4j
public class Idea45381Service {
    private static final int IDEA_ID = 45381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45381Service() {
        this(new Idea45381Config());
    }

    public Idea45381Service(Idea45381Config config) {
        this.config = config != null ? config : new Idea45381Config();
