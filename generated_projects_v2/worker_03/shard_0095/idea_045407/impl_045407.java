...
@Data
public class Idea45407Config {
    private String name = "idea_045407";
 ...
 */
@Slf4j
public class Idea45407Service {
    private static final int IDEA_ID = 45407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45407Service() {
        this(new Idea45407Config());
    }

    public Idea45407Service(Idea45407Config config) {
        this.config = config != null ? config : new Idea45407Config();
