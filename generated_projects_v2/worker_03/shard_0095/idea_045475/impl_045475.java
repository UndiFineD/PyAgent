...
@Data
public class Idea45475Config {
    private String name = "idea_045475";
 ...
 */
@Slf4j
public class Idea45475Service {
    private static final int IDEA_ID = 45475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45475Service() {
        this(new Idea45475Config());
    }

    public Idea45475Service(Idea45475Config config) {
        this.config = config != null ? config : new Idea45475Config();
