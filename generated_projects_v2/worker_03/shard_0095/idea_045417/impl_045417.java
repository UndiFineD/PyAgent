...
@Data
public class Idea45417Config {
    private String name = "idea_045417";
 ...
 */
@Slf4j
public class Idea45417Service {
    private static final int IDEA_ID = 45417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45417Service() {
        this(new Idea45417Config());
    }

    public Idea45417Service(Idea45417Config config) {
        this.config = config != null ? config : new Idea45417Config();
