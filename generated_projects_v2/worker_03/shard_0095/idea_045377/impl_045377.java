...
@Data
public class Idea45377Config {
    private String name = "idea_045377";
 ...
 */
@Slf4j
public class Idea45377Service {
    private static final int IDEA_ID = 45377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45377Service() {
        this(new Idea45377Config());
    }

    public Idea45377Service(Idea45377Config config) {
        this.config = config != null ? config : new Idea45377Config();
