...
@Data
public class Idea45323Config {
    private String name = "idea_045323";
 ...
 */
@Slf4j
public class Idea45323Service {
    private static final int IDEA_ID = 45323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45323Service() {
        this(new Idea45323Config());
    }

    public Idea45323Service(Idea45323Config config) {
        this.config = config != null ? config : new Idea45323Config();
