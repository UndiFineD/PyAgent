...
@Data
public class Idea45215Config {
    private String name = "idea_045215";
 ...
 */
@Slf4j
public class Idea45215Service {
    private static final int IDEA_ID = 45215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45215Service() {
        this(new Idea45215Config());
    }

    public Idea45215Service(Idea45215Config config) {
        this.config = config != null ? config : new Idea45215Config();
