...
@Data
public class Idea45136Config {
    private String name = "idea_045136";
 ...
 */
@Slf4j
public class Idea45136Service {
    private static final int IDEA_ID = 45136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45136Service() {
        this(new Idea45136Config());
    }

    public Idea45136Service(Idea45136Config config) {
        this.config = config != null ? config : new Idea45136Config();
