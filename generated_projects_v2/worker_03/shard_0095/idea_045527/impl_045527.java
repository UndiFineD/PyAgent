...
@Data
public class Idea45527Config {
    private String name = "idea_045527";
 ...
 */
@Slf4j
public class Idea45527Service {
    private static final int IDEA_ID = 45527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45527Service() {
        this(new Idea45527Config());
    }

    public Idea45527Service(Idea45527Config config) {
        this.config = config != null ? config : new Idea45527Config();
