...
@Data
public class Idea45204Config {
    private String name = "idea_045204";
 ...
 */
@Slf4j
public class Idea45204Service {
    private static final int IDEA_ID = 45204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45204Service() {
        this(new Idea45204Config());
    }

    public Idea45204Service(Idea45204Config config) {
        this.config = config != null ? config : new Idea45204Config();
