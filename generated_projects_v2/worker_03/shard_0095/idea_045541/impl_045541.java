...
@Data
public class Idea45541Config {
    private String name = "idea_045541";
 ...
 */
@Slf4j
public class Idea45541Service {
    private static final int IDEA_ID = 45541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45541Service() {
        this(new Idea45541Config());
    }

    public Idea45541Service(Idea45541Config config) {
        this.config = config != null ? config : new Idea45541Config();
