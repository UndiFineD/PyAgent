...
@Data
public class Idea45524Config {
    private String name = "idea_045524";
 ...
 */
@Slf4j
public class Idea45524Service {
    private static final int IDEA_ID = 45524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45524Service() {
        this(new Idea45524Config());
    }

    public Idea45524Service(Idea45524Config config) {
        this.config = config != null ? config : new Idea45524Config();
