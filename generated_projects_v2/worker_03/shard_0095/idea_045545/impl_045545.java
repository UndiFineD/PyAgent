...
@Data
public class Idea45545Config {
    private String name = "idea_045545";
 ...
 */
@Slf4j
public class Idea45545Service {
    private static final int IDEA_ID = 45545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45545Service() {
        this(new Idea45545Config());
    }

    public Idea45545Service(Idea45545Config config) {
        this.config = config != null ? config : new Idea45545Config();
