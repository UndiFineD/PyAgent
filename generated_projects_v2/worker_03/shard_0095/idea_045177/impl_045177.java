...
@Data
public class Idea45177Config {
    private String name = "idea_045177";
 ...
 */
@Slf4j
public class Idea45177Service {
    private static final int IDEA_ID = 45177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45177Service() {
        this(new Idea45177Config());
    }

    public Idea45177Service(Idea45177Config config) {
        this.config = config != null ? config : new Idea45177Config();
