...
@Data
public class Idea45465Config {
    private String name = "idea_045465";
 ...
 */
@Slf4j
public class Idea45465Service {
    private static final int IDEA_ID = 45465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45465Service() {
        this(new Idea45465Config());
    }

    public Idea45465Service(Idea45465Config config) {
        this.config = config != null ? config : new Idea45465Config();
