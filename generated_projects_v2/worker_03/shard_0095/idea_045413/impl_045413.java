...
@Data
public class Idea45413Config {
    private String name = "idea_045413";
 ...
 */
@Slf4j
public class Idea45413Service {
    private static final int IDEA_ID = 45413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45413Service() {
        this(new Idea45413Config());
    }

    public Idea45413Service(Idea45413Config config) {
        this.config = config != null ? config : new Idea45413Config();
