...
@Data
public class Idea45151Config {
    private String name = "idea_045151";
 ...
 */
@Slf4j
public class Idea45151Service {
    private static final int IDEA_ID = 45151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45151Service() {
        this(new Idea45151Config());
    }

    public Idea45151Service(Idea45151Config config) {
        this.config = config != null ? config : new Idea45151Config();
