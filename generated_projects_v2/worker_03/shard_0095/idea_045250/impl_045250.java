...
@Data
public class Idea45250Config {
    private String name = "idea_045250";
 ...
 */
@Slf4j
public class Idea45250Service {
    private static final int IDEA_ID = 45250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45250Service() {
        this(new Idea45250Config());
    }

    public Idea45250Service(Idea45250Config config) {
        this.config = config != null ? config : new Idea45250Config();
