...
@Data
public class Idea45262Config {
    private String name = "idea_045262";
 ...
 */
@Slf4j
public class Idea45262Service {
    private static final int IDEA_ID = 45262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45262Service() {
        this(new Idea45262Config());
    }

    public Idea45262Service(Idea45262Config config) {
        this.config = config != null ? config : new Idea45262Config();
