...
@Data
public class Idea45382Config {
    private String name = "idea_045382";
 ...
 */
@Slf4j
public class Idea45382Service {
    private static final int IDEA_ID = 45382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45382Service() {
        this(new Idea45382Config());
    }

    public Idea45382Service(Idea45382Config config) {
        this.config = config != null ? config : new Idea45382Config();
