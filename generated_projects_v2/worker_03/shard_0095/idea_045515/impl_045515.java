...
@Data
public class Idea45515Config {
    private String name = "idea_045515";
 ...
 */
@Slf4j
public class Idea45515Service {
    private static final int IDEA_ID = 45515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45515Service() {
        this(new Idea45515Config());
    }

    public Idea45515Service(Idea45515Config config) {
        this.config = config != null ? config : new Idea45515Config();
