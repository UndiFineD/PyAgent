...
@Data
public class Idea45341Config {
    private String name = "idea_045341";
 ...
 */
@Slf4j
public class Idea45341Service {
    private static final int IDEA_ID = 45341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45341Service() {
        this(new Idea45341Config());
    }

    public Idea45341Service(Idea45341Config config) {
        this.config = config != null ? config : new Idea45341Config();
