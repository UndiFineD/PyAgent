...
@Data
public class Idea45378Config {
    private String name = "idea_045378";
 ...
 */
@Slf4j
public class Idea45378Service {
    private static final int IDEA_ID = 45378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45378Service() {
        this(new Idea45378Config());
    }

    public Idea45378Service(Idea45378Config config) {
        this.config = config != null ? config : new Idea45378Config();
