...
@Data
public class Idea45300Config {
    private String name = "idea_045300";
 ...
 */
@Slf4j
public class Idea45300Service {
    private static final int IDEA_ID = 45300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45300Service() {
        this(new Idea45300Config());
    }

    public Idea45300Service(Idea45300Config config) {
        this.config = config != null ? config : new Idea45300Config();
