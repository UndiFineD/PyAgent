...
@Data
public class Idea45577Config {
    private String name = "idea_045577";
 ...
 */
@Slf4j
public class Idea45577Service {
    private static final int IDEA_ID = 45577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45577Service() {
        this(new Idea45577Config());
    }

    public Idea45577Service(Idea45577Config config) {
        this.config = config != null ? config : new Idea45577Config();
