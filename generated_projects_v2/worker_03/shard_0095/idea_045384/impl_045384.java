...
@Data
public class Idea45384Config {
    private String name = "idea_045384";
 ...
 */
@Slf4j
public class Idea45384Service {
    private static final int IDEA_ID = 45384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45384Service() {
        this(new Idea45384Config());
    }

    public Idea45384Service(Idea45384Config config) {
        this.config = config != null ? config : new Idea45384Config();
