...
@Data
public class Idea45138Config {
    private String name = "idea_045138";
 ...
 */
@Slf4j
public class Idea45138Service {
    private static final int IDEA_ID = 45138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45138Service() {
        this(new Idea45138Config());
    }

    public Idea45138Service(Idea45138Config config) {
        this.config = config != null ? config : new Idea45138Config();
