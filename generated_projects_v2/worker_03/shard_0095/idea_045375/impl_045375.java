...
@Data
public class Idea45375Config {
    private String name = "idea_045375";
 ...
 */
@Slf4j
public class Idea45375Service {
    private static final int IDEA_ID = 45375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45375Service() {
        this(new Idea45375Config());
    }

    public Idea45375Service(Idea45375Config config) {
        this.config = config != null ? config : new Idea45375Config();
