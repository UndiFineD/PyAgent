...
@Data
public class Idea45575Config {
    private String name = "idea_045575";
 ...
 */
@Slf4j
public class Idea45575Service {
    private static final int IDEA_ID = 45575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45575Service() {
        this(new Idea45575Config());
    }

    public Idea45575Service(Idea45575Config config) {
        this.config = config != null ? config : new Idea45575Config();
