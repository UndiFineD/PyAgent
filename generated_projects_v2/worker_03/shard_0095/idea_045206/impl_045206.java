...
@Data
public class Idea45206Config {
    private String name = "idea_045206";
 ...
 */
@Slf4j
public class Idea45206Service {
    private static final int IDEA_ID = 45206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45206Service() {
        this(new Idea45206Config());
    }

    public Idea45206Service(Idea45206Config config) {
        this.config = config != null ? config : new Idea45206Config();
