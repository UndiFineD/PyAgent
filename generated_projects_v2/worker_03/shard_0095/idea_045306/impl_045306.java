...
@Data
public class Idea45306Config {
    private String name = "idea_045306";
 ...
 */
@Slf4j
public class Idea45306Service {
    private static final int IDEA_ID = 45306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45306Service() {
        this(new Idea45306Config());
    }

    public Idea45306Service(Idea45306Config config) {
        this.config = config != null ? config : new Idea45306Config();
