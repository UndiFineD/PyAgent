...
@Data
public class Idea45501Config {
    private String name = "idea_045501";
 ...
 */
@Slf4j
public class Idea45501Service {
    private static final int IDEA_ID = 45501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45501Service() {
        this(new Idea45501Config());
    }

    public Idea45501Service(Idea45501Config config) {
        this.config = config != null ? config : new Idea45501Config();
