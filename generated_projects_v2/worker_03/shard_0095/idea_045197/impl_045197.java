...
@Data
public class Idea45197Config {
    private String name = "idea_045197";
 ...
 */
@Slf4j
public class Idea45197Service {
    private static final int IDEA_ID = 45197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45197Service() {
        this(new Idea45197Config());
    }

    public Idea45197Service(Idea45197Config config) {
        this.config = config != null ? config : new Idea45197Config();
