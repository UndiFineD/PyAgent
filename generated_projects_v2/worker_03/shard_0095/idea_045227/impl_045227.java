...
@Data
public class Idea45227Config {
    private String name = "idea_045227";
 ...
 */
@Slf4j
public class Idea45227Service {
    private static final int IDEA_ID = 45227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45227Service() {
        this(new Idea45227Config());
    }

    public Idea45227Service(Idea45227Config config) {
        this.config = config != null ? config : new Idea45227Config();
