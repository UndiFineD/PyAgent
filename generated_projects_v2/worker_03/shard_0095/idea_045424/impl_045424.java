...
@Data
public class Idea45424Config {
    private String name = "idea_045424";
 ...
 */
@Slf4j
public class Idea45424Service {
    private static final int IDEA_ID = 45424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45424Service() {
        this(new Idea45424Config());
    }

    public Idea45424Service(Idea45424Config config) {
        this.config = config != null ? config : new Idea45424Config();
