...
@Data
public class Idea45135Config {
    private String name = "idea_045135";
 ...
 */
@Slf4j
public class Idea45135Service {
    private static final int IDEA_ID = 45135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45135Service() {
        this(new Idea45135Config());
    }

    public Idea45135Service(Idea45135Config config) {
        this.config = config != null ? config : new Idea45135Config();
