...
@Data
public class Idea45226Config {
    private String name = "idea_045226";
 ...
 */
@Slf4j
public class Idea45226Service {
    private static final int IDEA_ID = 45226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45226Service() {
        this(new Idea45226Config());
    }

    public Idea45226Service(Idea45226Config config) {
        this.config = config != null ? config : new Idea45226Config();
