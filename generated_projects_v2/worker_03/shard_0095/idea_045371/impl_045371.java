...
@Data
public class Idea45371Config {
    private String name = "idea_045371";
 ...
 */
@Slf4j
public class Idea45371Service {
    private static final int IDEA_ID = 45371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45371Service() {
        this(new Idea45371Config());
    }

    public Idea45371Service(Idea45371Config config) {
        this.config = config != null ? config : new Idea45371Config();
