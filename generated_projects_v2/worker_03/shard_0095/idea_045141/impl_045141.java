...
@Data
public class Idea45141Config {
    private String name = "idea_045141";
 ...
 */
@Slf4j
public class Idea45141Service {
    private static final int IDEA_ID = 45141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45141Service() {
        this(new Idea45141Config());
    }

    public Idea45141Service(Idea45141Config config) {
        this.config = config != null ? config : new Idea45141Config();
