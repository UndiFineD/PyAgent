...
@Data
public class Idea45202Config {
    private String name = "idea_045202";
 ...
 */
@Slf4j
public class Idea45202Service {
    private static final int IDEA_ID = 45202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45202Service() {
        this(new Idea45202Config());
    }

    public Idea45202Service(Idea45202Config config) {
        this.config = config != null ? config : new Idea45202Config();
