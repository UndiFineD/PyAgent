...
@Data
public class Idea45412Config {
    private String name = "idea_045412";
 ...
 */
@Slf4j
public class Idea45412Service {
    private static final int IDEA_ID = 45412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45412Service() {
        this(new Idea45412Config());
    }

    public Idea45412Service(Idea45412Config config) {
        this.config = config != null ? config : new Idea45412Config();
