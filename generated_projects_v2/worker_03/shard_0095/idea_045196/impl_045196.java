...
@Data
public class Idea45196Config {
    private String name = "idea_045196";
 ...
 */
@Slf4j
public class Idea45196Service {
    private static final int IDEA_ID = 45196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45196Service() {
        this(new Idea45196Config());
    }

    public Idea45196Service(Idea45196Config config) {
        this.config = config != null ? config : new Idea45196Config();
