...
@Data
public class Idea45372Config {
    private String name = "idea_045372";
 ...
 */
@Slf4j
public class Idea45372Service {
    private static final int IDEA_ID = 45372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45372Service() {
        this(new Idea45372Config());
    }

    public Idea45372Service(Idea45372Config config) {
        this.config = config != null ? config : new Idea45372Config();
