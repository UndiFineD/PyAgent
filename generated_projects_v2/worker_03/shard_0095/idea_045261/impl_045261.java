...
@Data
public class Idea45261Config {
    private String name = "idea_045261";
 ...
 */
@Slf4j
public class Idea45261Service {
    private static final int IDEA_ID = 45261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45261Service() {
        this(new Idea45261Config());
    }

    public Idea45261Service(Idea45261Config config) {
        this.config = config != null ? config : new Idea45261Config();
