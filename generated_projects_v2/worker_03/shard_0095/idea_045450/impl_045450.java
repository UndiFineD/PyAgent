...
@Data
public class Idea45450Config {
    private String name = "idea_045450";
 ...
 */
@Slf4j
public class Idea45450Service {
    private static final int IDEA_ID = 45450;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45450Service() {
        this(new Idea45450Config());
    }

    public Idea45450Service(Idea45450Config config) {
        this.config = config != null ? config : new Idea45450Config();
