...
@Data
public class Idea45517Config {
    private String name = "idea_045517";
 ...
 */
@Slf4j
public class Idea45517Service {
    private static final int IDEA_ID = 45517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45517Service() {
        this(new Idea45517Config());
    }

    public Idea45517Service(Idea45517Config config) {
        this.config = config != null ? config : new Idea45517Config();
