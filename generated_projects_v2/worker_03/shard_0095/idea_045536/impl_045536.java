...
@Data
public class Idea45536Config {
    private String name = "idea_045536";
 ...
 */
@Slf4j
public class Idea45536Service {
    private static final int IDEA_ID = 45536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45536Service() {
        this(new Idea45536Config());
    }

    public Idea45536Service(Idea45536Config config) {
        this.config = config != null ? config : new Idea45536Config();
