...
@Data
public class Idea45435Config {
    private String name = "idea_045435";
 ...
 */
@Slf4j
public class Idea45435Service {
    private static final int IDEA_ID = 45435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45435Service() {
        this(new Idea45435Config());
    }

    public Idea45435Service(Idea45435Config config) {
        this.config = config != null ? config : new Idea45435Config();
