...
@Data
public class Idea45511Config {
    private String name = "idea_045511";
 ...
 */
@Slf4j
public class Idea45511Service {
    private static final int IDEA_ID = 45511;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45511Service() {
        this(new Idea45511Config());
    }

    public Idea45511Service(Idea45511Config config) {
        this.config = config != null ? config : new Idea45511Config();
