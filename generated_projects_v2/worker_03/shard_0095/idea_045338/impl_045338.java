...
@Data
public class Idea45338Config {
    private String name = "idea_045338";
 ...
 */
@Slf4j
public class Idea45338Service {
    private static final int IDEA_ID = 45338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45338Service() {
        this(new Idea45338Config());
    }

    public Idea45338Service(Idea45338Config config) {
        this.config = config != null ? config : new Idea45338Config();
