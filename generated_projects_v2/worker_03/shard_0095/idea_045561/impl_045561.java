...
@Data
public class Idea45561Config {
    private String name = "idea_045561";
 ...
 */
@Slf4j
public class Idea45561Service {
    private static final int IDEA_ID = 45561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45561Service() {
        this(new Idea45561Config());
    }

    public Idea45561Service(Idea45561Config config) {
        this.config = config != null ? config : new Idea45561Config();
