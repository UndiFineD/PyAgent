...
@Data
public class Idea45596Config {
    private String name = "idea_045596";
 ...
 */
@Slf4j
public class Idea45596Service {
    private static final int IDEA_ID = 45596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45596Service() {
        this(new Idea45596Config());
    }

    public Idea45596Service(Idea45596Config config) {
        this.config = config != null ? config : new Idea45596Config();
