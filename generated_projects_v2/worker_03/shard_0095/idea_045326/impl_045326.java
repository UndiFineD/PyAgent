...
@Data
public class Idea45326Config {
    private String name = "idea_045326";
 ...
 */
@Slf4j
public class Idea45326Service {
    private static final int IDEA_ID = 45326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45326Service() {
        this(new Idea45326Config());
    }

    public Idea45326Service(Idea45326Config config) {
        this.config = config != null ? config : new Idea45326Config();
