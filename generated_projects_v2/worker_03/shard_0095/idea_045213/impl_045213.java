...
@Data
public class Idea45213Config {
    private String name = "idea_045213";
 ...
 */
@Slf4j
public class Idea45213Service {
    private static final int IDEA_ID = 45213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45213Service() {
        this(new Idea45213Config());
    }

    public Idea45213Service(Idea45213Config config) {
        this.config = config != null ? config : new Idea45213Config();
