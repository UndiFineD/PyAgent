...
@Data
public class Idea45221Config {
    private String name = "idea_045221";
 ...
 */
@Slf4j
public class Idea45221Service {
    private static final int IDEA_ID = 45221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45221Service() {
        this(new Idea45221Config());
    }

    public Idea45221Service(Idea45221Config config) {
        this.config = config != null ? config : new Idea45221Config();
