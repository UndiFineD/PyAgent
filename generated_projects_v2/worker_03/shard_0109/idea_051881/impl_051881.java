...
@Data
public class Idea51881Config {
    private String name = "idea_051881";
 ...
 */
@Slf4j
public class Idea51881Service {
    private static final int IDEA_ID = 51881;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51881Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51881Service() {
        this(new Idea51881Config());
    }

    public Idea51881Service(Idea51881Config config) {
        this.config = config != null ? config : new Idea51881Config();
