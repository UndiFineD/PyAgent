...
@Data
public class Idea51920Config {
    private String name = "idea_051920";
 ...
 */
@Slf4j
public class Idea51920Service {
    private static final int IDEA_ID = 51920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51920Service() {
        this(new Idea51920Config());
    }

    public Idea51920Service(Idea51920Config config) {
        this.config = config != null ? config : new Idea51920Config();
