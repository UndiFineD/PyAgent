...
@Data
public class Idea51968Config {
    private String name = "idea_051968";
 ...
 */
@Slf4j
public class Idea51968Service {
    private static final int IDEA_ID = 51968;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51968Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51968Service() {
        this(new Idea51968Config());
    }

    public Idea51968Service(Idea51968Config config) {
        this.config = config != null ? config : new Idea51968Config();
