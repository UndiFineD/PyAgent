...
@Data
public class Idea52147Config {
    private String name = "idea_052147";
 ...
 */
@Slf4j
public class Idea52147Service {
    private static final int IDEA_ID = 52147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52147Service() {
        this(new Idea52147Config());
    }

    public Idea52147Service(Idea52147Config config) {
        this.config = config != null ? config : new Idea52147Config();
