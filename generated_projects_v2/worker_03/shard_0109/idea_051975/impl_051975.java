...
@Data
public class Idea51975Config {
    private String name = "idea_051975";
 ...
 */
@Slf4j
public class Idea51975Service {
    private static final int IDEA_ID = 51975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51975Service() {
        this(new Idea51975Config());
    }

    public Idea51975Service(Idea51975Config config) {
        this.config = config != null ? config : new Idea51975Config();
