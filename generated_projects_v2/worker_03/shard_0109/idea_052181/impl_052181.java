...
@Data
public class Idea52181Config {
    private String name = "idea_052181";
 ...
 */
@Slf4j
public class Idea52181Service {
    private static final int IDEA_ID = 52181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52181Service() {
        this(new Idea52181Config());
    }

    public Idea52181Service(Idea52181Config config) {
        this.config = config != null ? config : new Idea52181Config();
