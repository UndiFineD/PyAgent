...
@Data
public class Idea52178Config {
    private String name = "idea_052178";
 ...
 */
@Slf4j
public class Idea52178Service {
    private static final int IDEA_ID = 52178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52178Service() {
        this(new Idea52178Config());
    }

    public Idea52178Service(Idea52178Config config) {
        this.config = config != null ? config : new Idea52178Config();
