...
@Data
public class Idea52062Config {
    private String name = "idea_052062";
 ...
 */
@Slf4j
public class Idea52062Service {
    private static final int IDEA_ID = 52062;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52062Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52062Service() {
        this(new Idea52062Config());
    }

    public Idea52062Service(Idea52062Config config) {
        this.config = config != null ? config : new Idea52062Config();
