...
@Data
public class Idea52197Config {
    private String name = "idea_052197";
 ...
 */
@Slf4j
public class Idea52197Service {
    private static final int IDEA_ID = 52197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52197Service() {
        this(new Idea52197Config());
    }

    public Idea52197Service(Idea52197Config config) {
        this.config = config != null ? config : new Idea52197Config();
