...
@Data
public class Idea51837Config {
    private String name = "idea_051837";
 ...
 */
@Slf4j
public class Idea51837Service {
    private static final int IDEA_ID = 51837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51837Service() {
        this(new Idea51837Config());
    }

    public Idea51837Service(Idea51837Config config) {
        this.config = config != null ? config : new Idea51837Config();
