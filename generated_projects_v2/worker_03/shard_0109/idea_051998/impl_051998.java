...
@Data
public class Idea51998Config {
    private String name = "idea_051998";
 ...
 */
@Slf4j
public class Idea51998Service {
    private static final int IDEA_ID = 51998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51998Service() {
        this(new Idea51998Config());
    }

    public Idea51998Service(Idea51998Config config) {
        this.config = config != null ? config : new Idea51998Config();
