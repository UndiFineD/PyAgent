...
@Data
public class Idea51990Config {
    private String name = "idea_051990";
 ...
 */
@Slf4j
public class Idea51990Service {
    private static final int IDEA_ID = 51990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51990Service() {
        this(new Idea51990Config());
    }

    public Idea51990Service(Idea51990Config config) {
        this.config = config != null ? config : new Idea51990Config();
