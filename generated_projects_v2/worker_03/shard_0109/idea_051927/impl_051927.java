...
@Data
public class Idea51927Config {
    private String name = "idea_051927";
 ...
 */
@Slf4j
public class Idea51927Service {
    private static final int IDEA_ID = 51927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51927Service() {
        this(new Idea51927Config());
    }

    public Idea51927Service(Idea51927Config config) {
        this.config = config != null ? config : new Idea51927Config();
