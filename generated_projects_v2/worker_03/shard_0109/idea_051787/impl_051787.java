...
@Data
public class Idea51787Config {
    private String name = "idea_051787";
 ...
 */
@Slf4j
public class Idea51787Service {
    private static final int IDEA_ID = 51787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51787Service() {
        this(new Idea51787Config());
    }

    public Idea51787Service(Idea51787Config config) {
        this.config = config != null ? config : new Idea51787Config();
