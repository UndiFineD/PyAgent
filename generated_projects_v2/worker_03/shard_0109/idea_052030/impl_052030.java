...
@Data
public class Idea52030Config {
    private String name = "idea_052030";
 ...
 */
@Slf4j
public class Idea52030Service {
    private static final int IDEA_ID = 52030;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52030Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52030Service() {
        this(new Idea52030Config());
    }

    public Idea52030Service(Idea52030Config config) {
        this.config = config != null ? config : new Idea52030Config();
