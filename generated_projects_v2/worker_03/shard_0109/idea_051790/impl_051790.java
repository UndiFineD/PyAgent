...
@Data
public class Idea51790Config {
    private String name = "idea_051790";
 ...
 */
@Slf4j
public class Idea51790Service {
    private static final int IDEA_ID = 51790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51790Service() {
        this(new Idea51790Config());
    }

    public Idea51790Service(Idea51790Config config) {
        this.config = config != null ? config : new Idea51790Config();
