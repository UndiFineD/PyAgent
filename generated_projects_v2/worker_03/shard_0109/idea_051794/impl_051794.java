...
@Data
public class Idea51794Config {
    private String name = "idea_051794";
 ...
 */
@Slf4j
public class Idea51794Service {
    private static final int IDEA_ID = 51794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51794Service() {
        this(new Idea51794Config());
    }

    public Idea51794Service(Idea51794Config config) {
        this.config = config != null ? config : new Idea51794Config();
