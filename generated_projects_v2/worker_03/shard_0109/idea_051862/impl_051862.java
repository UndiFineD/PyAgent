...
@Data
public class Idea51862Config {
    private String name = "idea_051862";
 ...
 */
@Slf4j
public class Idea51862Service {
    private static final int IDEA_ID = 51862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51862Service() {
        this(new Idea51862Config());
    }

    public Idea51862Service(Idea51862Config config) {
        this.config = config != null ? config : new Idea51862Config();
