...
@Data
public class Idea51932Config {
    private String name = "idea_051932";
 ...
 */
@Slf4j
public class Idea51932Service {
    private static final int IDEA_ID = 51932;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51932Service() {
        this(new Idea51932Config());
    }

    public Idea51932Service(Idea51932Config config) {
        this.config = config != null ? config : new Idea51932Config();
