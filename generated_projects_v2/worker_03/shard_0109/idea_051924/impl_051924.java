...
@Data
public class Idea51924Config {
    private String name = "idea_051924";
 ...
 */
@Slf4j
public class Idea51924Service {
    private static final int IDEA_ID = 51924;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51924Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51924Service() {
        this(new Idea51924Config());
    }

    public Idea51924Service(Idea51924Config config) {
        this.config = config != null ? config : new Idea51924Config();
