...
@Data
public class Idea51857Config {
    private String name = "idea_051857";
 ...
 */
@Slf4j
public class Idea51857Service {
    private static final int IDEA_ID = 51857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51857Service() {
        this(new Idea51857Config());
    }

    public Idea51857Service(Idea51857Config config) {
        this.config = config != null ? config : new Idea51857Config();
