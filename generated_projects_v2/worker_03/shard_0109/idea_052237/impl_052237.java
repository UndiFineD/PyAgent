...
@Data
public class Idea52237Config {
    private String name = "idea_052237";
 ...
 */
@Slf4j
public class Idea52237Service {
    private static final int IDEA_ID = 52237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52237Service() {
        this(new Idea52237Config());
    }

    public Idea52237Service(Idea52237Config config) {
        this.config = config != null ? config : new Idea52237Config();
