...
@Data
public class Idea51903Config {
    private String name = "idea_051903";
 ...
 */
@Slf4j
public class Idea51903Service {
    private static final int IDEA_ID = 51903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51903Service() {
        this(new Idea51903Config());
    }

    public Idea51903Service(Idea51903Config config) {
        this.config = config != null ? config : new Idea51903Config();
