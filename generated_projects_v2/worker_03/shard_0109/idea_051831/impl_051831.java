...
@Data
public class Idea51831Config {
    private String name = "idea_051831";
 ...
 */
@Slf4j
public class Idea51831Service {
    private static final int IDEA_ID = 51831;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51831Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51831Service() {
        this(new Idea51831Config());
    }

    public Idea51831Service(Idea51831Config config) {
        this.config = config != null ? config : new Idea51831Config();
