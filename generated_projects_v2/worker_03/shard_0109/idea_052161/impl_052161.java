...
@Data
public class Idea52161Config {
    private String name = "idea_052161";
 ...
 */
@Slf4j
public class Idea52161Service {
    private static final int IDEA_ID = 52161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52161Service() {
        this(new Idea52161Config());
    }

    public Idea52161Service(Idea52161Config config) {
        this.config = config != null ? config : new Idea52161Config();
