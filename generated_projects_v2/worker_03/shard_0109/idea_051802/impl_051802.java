...
@Data
public class Idea51802Config {
    private String name = "idea_051802";
 ...
 */
@Slf4j
public class Idea51802Service {
    private static final int IDEA_ID = 51802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51802Service() {
        this(new Idea51802Config());
    }

    public Idea51802Service(Idea51802Config config) {
        this.config = config != null ? config : new Idea51802Config();
