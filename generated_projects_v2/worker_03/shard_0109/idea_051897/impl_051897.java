...
@Data
public class Idea51897Config {
    private String name = "idea_051897";
 ...
 */
@Slf4j
public class Idea51897Service {
    private static final int IDEA_ID = 51897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51897Service() {
        this(new Idea51897Config());
    }

    public Idea51897Service(Idea51897Config config) {
        this.config = config != null ? config : new Idea51897Config();
