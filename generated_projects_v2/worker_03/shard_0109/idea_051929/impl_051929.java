...
@Data
public class Idea51929Config {
    private String name = "idea_051929";
 ...
 */
@Slf4j
public class Idea51929Service {
    private static final int IDEA_ID = 51929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51929Service() {
        this(new Idea51929Config());
    }

    public Idea51929Service(Idea51929Config config) {
        this.config = config != null ? config : new Idea51929Config();
