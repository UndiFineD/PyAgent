...
@Data
public class Idea51796Config {
    private String name = "idea_051796";
 ...
 */
@Slf4j
public class Idea51796Service {
    private static final int IDEA_ID = 51796;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51796Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51796Service() {
        this(new Idea51796Config());
    }

    public Idea51796Service(Idea51796Config config) {
        this.config = config != null ? config : new Idea51796Config();
