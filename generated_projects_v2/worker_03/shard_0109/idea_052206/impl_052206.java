...
@Data
public class Idea52206Config {
    private String name = "idea_052206";
 ...
 */
@Slf4j
public class Idea52206Service {
    private static final int IDEA_ID = 52206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52206Service() {
        this(new Idea52206Config());
    }

    public Idea52206Service(Idea52206Config config) {
        this.config = config != null ? config : new Idea52206Config();
