...
@Data
public class Idea51893Config {
    private String name = "idea_051893";
 ...
 */
@Slf4j
public class Idea51893Service {
    private static final int IDEA_ID = 51893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51893Service() {
        this(new Idea51893Config());
    }

    public Idea51893Service(Idea51893Config config) {
        this.config = config != null ? config : new Idea51893Config();
