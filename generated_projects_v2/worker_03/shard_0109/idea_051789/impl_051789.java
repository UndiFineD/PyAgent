...
@Data
public class Idea51789Config {
    private String name = "idea_051789";
 ...
 */
@Slf4j
public class Idea51789Service {
    private static final int IDEA_ID = 51789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51789Service() {
        this(new Idea51789Config());
    }

    public Idea51789Service(Idea51789Config config) {
        this.config = config != null ? config : new Idea51789Config();
