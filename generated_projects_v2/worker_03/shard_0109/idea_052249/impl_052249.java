...
@Data
public class Idea52249Config {
    private String name = "idea_052249";
 ...
 */
@Slf4j
public class Idea52249Service {
    private static final int IDEA_ID = 52249;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52249Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52249Service() {
        this(new Idea52249Config());
    }

    public Idea52249Service(Idea52249Config config) {
        this.config = config != null ? config : new Idea52249Config();
