...
@Data
public class Idea52195Config {
    private String name = "idea_052195";
 ...
 */
@Slf4j
public class Idea52195Service {
    private static final int IDEA_ID = 52195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52195Service() {
        this(new Idea52195Config());
    }

    public Idea52195Service(Idea52195Config config) {
        this.config = config != null ? config : new Idea52195Config();
