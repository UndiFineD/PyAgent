...
@Data
public class Idea51936Config {
    private String name = "idea_051936";
 ...
 */
@Slf4j
public class Idea51936Service {
    private static final int IDEA_ID = 51936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51936Service() {
        this(new Idea51936Config());
    }

    public Idea51936Service(Idea51936Config config) {
        this.config = config != null ? config : new Idea51936Config();
