...
@Data
public class Idea51786Config {
    private String name = "idea_051786";
 ...
 */
@Slf4j
public class Idea51786Service {
    private static final int IDEA_ID = 51786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51786Service() {
        this(new Idea51786Config());
    }

    public Idea51786Service(Idea51786Config config) {
        this.config = config != null ? config : new Idea51786Config();
