...
@Data
public class Idea51863Config {
    private String name = "idea_051863";
 ...
 */
@Slf4j
public class Idea51863Service {
    private static final int IDEA_ID = 51863;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51863Service() {
        this(new Idea51863Config());
    }

    public Idea51863Service(Idea51863Config config) {
        this.config = config != null ? config : new Idea51863Config();
