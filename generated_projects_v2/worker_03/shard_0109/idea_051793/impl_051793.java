...
@Data
public class Idea51793Config {
    private String name = "idea_051793";
 ...
 */
@Slf4j
public class Idea51793Service {
    private static final int IDEA_ID = 51793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51793Service() {
        this(new Idea51793Config());
    }

    public Idea51793Service(Idea51793Config config) {
        this.config = config != null ? config : new Idea51793Config();
