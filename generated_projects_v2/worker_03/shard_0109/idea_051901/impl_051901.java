...
@Data
public class Idea51901Config {
    private String name = "idea_051901";
 ...
 */
@Slf4j
public class Idea51901Service {
    private static final int IDEA_ID = 51901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51901Service() {
        this(new Idea51901Config());
    }

    public Idea51901Service(Idea51901Config config) {
        this.config = config != null ? config : new Idea51901Config();
