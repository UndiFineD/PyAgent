...
@Data
public class Idea52059Config {
    private String name = "idea_052059";
 ...
 */
@Slf4j
public class Idea52059Service {
    private static final int IDEA_ID = 52059;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52059Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52059Service() {
        this(new Idea52059Config());
    }

    public Idea52059Service(Idea52059Config config) {
        this.config = config != null ? config : new Idea52059Config();
