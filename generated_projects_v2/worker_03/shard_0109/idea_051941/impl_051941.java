...
@Data
public class Idea51941Config {
    private String name = "idea_051941";
 ...
 */
@Slf4j
public class Idea51941Service {
    private static final int IDEA_ID = 51941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51941Service() {
        this(new Idea51941Config());
    }

    public Idea51941Service(Idea51941Config config) {
        this.config = config != null ? config : new Idea51941Config();
