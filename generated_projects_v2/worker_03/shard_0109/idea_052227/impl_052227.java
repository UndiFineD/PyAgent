...
@Data
public class Idea52227Config {
    private String name = "idea_052227";
 ...
 */
@Slf4j
public class Idea52227Service {
    private static final int IDEA_ID = 52227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52227Service() {
        this(new Idea52227Config());
    }

    public Idea52227Service(Idea52227Config config) {
        this.config = config != null ? config : new Idea52227Config();
