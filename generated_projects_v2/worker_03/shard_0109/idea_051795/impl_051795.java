...
@Data
public class Idea51795Config {
    private String name = "idea_051795";
 ...
 */
@Slf4j
public class Idea51795Service {
    private static final int IDEA_ID = 51795;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51795Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51795Service() {
        this(new Idea51795Config());
    }

    public Idea51795Service(Idea51795Config config) {
        this.config = config != null ? config : new Idea51795Config();
