...
@Data
public class Idea51777Config {
    private String name = "idea_051777";
 ...
 */
@Slf4j
public class Idea51777Service {
    private static final int IDEA_ID = 51777;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51777Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51777Service() {
        this(new Idea51777Config());
    }

    public Idea51777Service(Idea51777Config config) {
        this.config = config != null ? config : new Idea51777Config();
