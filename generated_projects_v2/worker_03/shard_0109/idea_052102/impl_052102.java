...
@Data
public class Idea52102Config {
    private String name = "idea_052102";
 ...
 */
@Slf4j
public class Idea52102Service {
    private static final int IDEA_ID = 52102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52102Service() {
        this(new Idea52102Config());
    }

    public Idea52102Service(Idea52102Config config) {
        this.config = config != null ? config : new Idea52102Config();
