...
@Data
public class Idea51967Config {
    private String name = "idea_051967";
 ...
 */
@Slf4j
public class Idea51967Service {
    private static final int IDEA_ID = 51967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51967Service() {
        this(new Idea51967Config());
    }

    public Idea51967Service(Idea51967Config config) {
        this.config = config != null ? config : new Idea51967Config();
