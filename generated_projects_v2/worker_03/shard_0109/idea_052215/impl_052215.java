...
@Data
public class Idea52215Config {
    private String name = "idea_052215";
 ...
 */
@Slf4j
public class Idea52215Service {
    private static final int IDEA_ID = 52215;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52215Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52215Service() {
        this(new Idea52215Config());
    }

    public Idea52215Service(Idea52215Config config) {
        this.config = config != null ? config : new Idea52215Config();
