...
@Data
public class Idea51798Config {
    private String name = "idea_051798";
 ...
 */
@Slf4j
public class Idea51798Service {
    private static final int IDEA_ID = 51798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51798Service() {
        this(new Idea51798Config());
    }

    public Idea51798Service(Idea51798Config config) {
        this.config = config != null ? config : new Idea51798Config();
