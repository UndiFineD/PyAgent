...
@Data
public class Idea52025Config {
    private String name = "idea_052025";
 ...
 */
@Slf4j
public class Idea52025Service {
    private static final int IDEA_ID = 52025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52025Service() {
        this(new Idea52025Config());
    }

    public Idea52025Service(Idea52025Config config) {
        this.config = config != null ? config : new Idea52025Config();
