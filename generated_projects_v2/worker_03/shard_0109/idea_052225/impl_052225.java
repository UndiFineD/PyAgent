...
@Data
public class Idea52225Config {
    private String name = "idea_052225";
 ...
 */
@Slf4j
public class Idea52225Service {
    private static final int IDEA_ID = 52225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52225Service() {
        this(new Idea52225Config());
    }

    public Idea52225Service(Idea52225Config config) {
        this.config = config != null ? config : new Idea52225Config();
