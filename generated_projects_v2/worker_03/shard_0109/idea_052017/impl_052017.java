...
@Data
public class Idea52017Config {
    private String name = "idea_052017";
 ...
 */
@Slf4j
public class Idea52017Service {
    private static final int IDEA_ID = 52017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52017Service() {
        this(new Idea52017Config());
    }

    public Idea52017Service(Idea52017Config config) {
        this.config = config != null ? config : new Idea52017Config();
