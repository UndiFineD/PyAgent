...
@Data
public class Idea51821Config {
    private String name = "idea_051821";
 ...
 */
@Slf4j
public class Idea51821Service {
    private static final int IDEA_ID = 51821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51821Service() {
        this(new Idea51821Config());
    }

    public Idea51821Service(Idea51821Config config) {
        this.config = config != null ? config : new Idea51821Config();
