...
@Data
public class Idea52014Config {
    private String name = "idea_052014";
 ...
 */
@Slf4j
public class Idea52014Service {
    private static final int IDEA_ID = 52014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52014Service() {
        this(new Idea52014Config());
    }

    public Idea52014Service(Idea52014Config config) {
        this.config = config != null ? config : new Idea52014Config();
