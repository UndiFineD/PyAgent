...
@Data
public class Idea52228Config {
    private String name = "idea_052228";
 ...
 */
@Slf4j
public class Idea52228Service {
    private static final int IDEA_ID = 52228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52228Service() {
        this(new Idea52228Config());
    }

    public Idea52228Service(Idea52228Config config) {
        this.config = config != null ? config : new Idea52228Config();
