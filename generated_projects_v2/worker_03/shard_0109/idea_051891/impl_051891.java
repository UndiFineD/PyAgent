...
@Data
public class Idea51891Config {
    private String name = "idea_051891";
 ...
 */
@Slf4j
public class Idea51891Service {
    private static final int IDEA_ID = 51891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51891Service() {
        this(new Idea51891Config());
    }

    public Idea51891Service(Idea51891Config config) {
        this.config = config != null ? config : new Idea51891Config();
