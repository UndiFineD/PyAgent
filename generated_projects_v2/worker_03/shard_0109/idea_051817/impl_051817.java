...
@Data
public class Idea51817Config {
    private String name = "idea_051817";
 ...
 */
@Slf4j
public class Idea51817Service {
    private static final int IDEA_ID = 51817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51817Service() {
        this(new Idea51817Config());
    }

    public Idea51817Service(Idea51817Config config) {
        this.config = config != null ? config : new Idea51817Config();
