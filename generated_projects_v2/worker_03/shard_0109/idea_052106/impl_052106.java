...
@Data
public class Idea52106Config {
    private String name = "idea_052106";
 ...
 */
@Slf4j
public class Idea52106Service {
    private static final int IDEA_ID = 52106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52106Service() {
        this(new Idea52106Config());
    }

    public Idea52106Service(Idea52106Config config) {
        this.config = config != null ? config : new Idea52106Config();
