...
@Data
public class Idea51912Config {
    private String name = "idea_051912";
 ...
 */
@Slf4j
public class Idea51912Service {
    private static final int IDEA_ID = 51912;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51912Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51912Service() {
        this(new Idea51912Config());
    }

    public Idea51912Service(Idea51912Config config) {
        this.config = config != null ? config : new Idea51912Config();
