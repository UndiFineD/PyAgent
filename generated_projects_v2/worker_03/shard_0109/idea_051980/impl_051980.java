...
@Data
public class Idea51980Config {
    private String name = "idea_051980";
 ...
 */
@Slf4j
public class Idea51980Service {
    private static final int IDEA_ID = 51980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51980Service() {
        this(new Idea51980Config());
    }

    public Idea51980Service(Idea51980Config config) {
        this.config = config != null ? config : new Idea51980Config();
