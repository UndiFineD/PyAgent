...
@Data
public class Idea52005Config {
    private String name = "idea_052005";
 ...
 */
@Slf4j
public class Idea52005Service {
    private static final int IDEA_ID = 52005;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52005Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52005Service() {
        this(new Idea52005Config());
    }

    public Idea52005Service(Idea52005Config config) {
        this.config = config != null ? config : new Idea52005Config();
