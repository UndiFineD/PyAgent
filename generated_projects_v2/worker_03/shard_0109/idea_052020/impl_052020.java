...
@Data
public class Idea52020Config {
    private String name = "idea_052020";
 ...
 */
@Slf4j
public class Idea52020Service {
    private static final int IDEA_ID = 52020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52020Service() {
        this(new Idea52020Config());
    }

    public Idea52020Service(Idea52020Config config) {
        this.config = config != null ? config : new Idea52020Config();
