...
@Data
public class Idea51778Config {
    private String name = "idea_051778";
 ...
 */
@Slf4j
public class Idea51778Service {
    private static final int IDEA_ID = 51778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51778Service() {
        this(new Idea51778Config());
    }

    public Idea51778Service(Idea51778Config config) {
        this.config = config != null ? config : new Idea51778Config();
