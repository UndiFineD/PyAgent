...
@Data
public class Idea51895Config {
    private String name = "idea_051895";
 ...
 */
@Slf4j
public class Idea51895Service {
    private static final int IDEA_ID = 51895;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51895Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51895Service() {
        this(new Idea51895Config());
    }

    public Idea51895Service(Idea51895Config config) {
        this.config = config != null ? config : new Idea51895Config();
