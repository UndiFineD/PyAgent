...
@Data
public class Idea52015Config {
    private String name = "idea_052015";
 ...
 */
@Slf4j
public class Idea52015Service {
    private static final int IDEA_ID = 52015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52015Service() {
        this(new Idea52015Config());
    }

    public Idea52015Service(Idea52015Config config) {
        this.config = config != null ? config : new Idea52015Config();
