...
@Data
public class Idea51923Config {
    private String name = "idea_051923";
 ...
 */
@Slf4j
public class Idea51923Service {
    private static final int IDEA_ID = 51923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51923Service() {
        this(new Idea51923Config());
    }

    public Idea51923Service(Idea51923Config config) {
        this.config = config != null ? config : new Idea51923Config();
