...
@Data
public class Idea51907Config {
    private String name = "idea_051907";
 ...
 */
@Slf4j
public class Idea51907Service {
    private static final int IDEA_ID = 51907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51907Service() {
        this(new Idea51907Config());
    }

    public Idea51907Service(Idea51907Config config) {
        this.config = config != null ? config : new Idea51907Config();
