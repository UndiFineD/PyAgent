...
@Data
public class Idea52190Config {
    private String name = "idea_052190";
 ...
 */
@Slf4j
public class Idea52190Service {
    private static final int IDEA_ID = 52190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52190Service() {
        this(new Idea52190Config());
    }

    public Idea52190Service(Idea52190Config config) {
        this.config = config != null ? config : new Idea52190Config();
