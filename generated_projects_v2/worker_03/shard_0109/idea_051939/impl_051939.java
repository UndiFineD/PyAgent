...
@Data
public class Idea51939Config {
    private String name = "idea_051939";
 ...
 */
@Slf4j
public class Idea51939Service {
    private static final int IDEA_ID = 51939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51939Service() {
        this(new Idea51939Config());
    }

    public Idea51939Service(Idea51939Config config) {
        this.config = config != null ? config : new Idea51939Config();
