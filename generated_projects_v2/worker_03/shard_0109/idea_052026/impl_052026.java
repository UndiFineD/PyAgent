...
@Data
public class Idea52026Config {
    private String name = "idea_052026";
 ...
 */
@Slf4j
public class Idea52026Service {
    private static final int IDEA_ID = 52026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52026Service() {
        this(new Idea52026Config());
    }

    public Idea52026Service(Idea52026Config config) {
        this.config = config != null ? config : new Idea52026Config();
