...
@Data
public class Idea51917Config {
    private String name = "idea_051917";
 ...
 */
@Slf4j
public class Idea51917Service {
    private static final int IDEA_ID = 51917;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51917Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51917Service() {
        this(new Idea51917Config());
    }

    public Idea51917Service(Idea51917Config config) {
        this.config = config != null ? config : new Idea51917Config();
