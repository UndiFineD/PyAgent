...
@Data
public class Idea51908Config {
    private String name = "idea_051908";
 ...
 */
@Slf4j
public class Idea51908Service {
    private static final int IDEA_ID = 51908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51908Service() {
        this(new Idea51908Config());
    }

    public Idea51908Service(Idea51908Config config) {
        this.config = config != null ? config : new Idea51908Config();
