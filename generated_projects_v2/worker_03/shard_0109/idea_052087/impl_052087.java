...
@Data
public class Idea52087Config {
    private String name = "idea_052087";
 ...
 */
@Slf4j
public class Idea52087Service {
    private static final int IDEA_ID = 52087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52087Service() {
        this(new Idea52087Config());
    }

    public Idea52087Service(Idea52087Config config) {
        this.config = config != null ? config : new Idea52087Config();
