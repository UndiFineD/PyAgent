...
@Data
public class Idea51935Config {
    private String name = "idea_051935";
 ...
 */
@Slf4j
public class Idea51935Service {
    private static final int IDEA_ID = 51935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51935Service() {
        this(new Idea51935Config());
    }

    public Idea51935Service(Idea51935Config config) {
        this.config = config != null ? config : new Idea51935Config();
