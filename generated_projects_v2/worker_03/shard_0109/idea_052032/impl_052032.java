...
@Data
public class Idea52032Config {
    private String name = "idea_052032";
 ...
 */
@Slf4j
public class Idea52032Service {
    private static final int IDEA_ID = 52032;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52032Service() {
        this(new Idea52032Config());
    }

    public Idea52032Service(Idea52032Config config) {
        this.config = config != null ? config : new Idea52032Config();
