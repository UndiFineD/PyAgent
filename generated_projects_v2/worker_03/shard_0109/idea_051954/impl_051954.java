...
@Data
public class Idea51954Config {
    private String name = "idea_051954";
 ...
 */
@Slf4j
public class Idea51954Service {
    private static final int IDEA_ID = 51954;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51954Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51954Service() {
        this(new Idea51954Config());
    }

    public Idea51954Service(Idea51954Config config) {
        this.config = config != null ? config : new Idea51954Config();
