...
@Data
public class Idea52172Config {
    private String name = "idea_052172";
 ...
 */
@Slf4j
public class Idea52172Service {
    private static final int IDEA_ID = 52172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52172Service() {
        this(new Idea52172Config());
    }

    public Idea52172Service(Idea52172Config config) {
        this.config = config != null ? config : new Idea52172Config();
