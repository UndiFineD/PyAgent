...
@Data
public class Idea52152Config {
    private String name = "idea_052152";
 ...
 */
@Slf4j
public class Idea52152Service {
    private static final int IDEA_ID = 52152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52152Service() {
        this(new Idea52152Config());
    }

    public Idea52152Service(Idea52152Config config) {
        this.config = config != null ? config : new Idea52152Config();
