...
@Data
public class Idea52077Config {
    private String name = "idea_052077";
 ...
 */
@Slf4j
public class Idea52077Service {
    private static final int IDEA_ID = 52077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52077Service() {
        this(new Idea52077Config());
    }

    public Idea52077Service(Idea52077Config config) {
        this.config = config != null ? config : new Idea52077Config();
