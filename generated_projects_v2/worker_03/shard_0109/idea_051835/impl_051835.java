...
@Data
public class Idea51835Config {
    private String name = "idea_051835";
 ...
 */
@Slf4j
public class Idea51835Service {
    private static final int IDEA_ID = 51835;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51835Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51835Service() {
        this(new Idea51835Config());
    }

    public Idea51835Service(Idea51835Config config) {
        this.config = config != null ? config : new Idea51835Config();
