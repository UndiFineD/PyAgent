...
@Data
public class Idea51782Config {
    private String name = "idea_051782";
 ...
 */
@Slf4j
public class Idea51782Service {
    private static final int IDEA_ID = 51782;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51782Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51782Service() {
        this(new Idea51782Config());
    }

    public Idea51782Service(Idea51782Config config) {
        this.config = config != null ? config : new Idea51782Config();
