...
@Data
public class Idea52012Config {
    private String name = "idea_052012";
 ...
 */
@Slf4j
public class Idea52012Service {
    private static final int IDEA_ID = 52012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52012Service() {
        this(new Idea52012Config());
    }

    public Idea52012Service(Idea52012Config config) {
        this.config = config != null ? config : new Idea52012Config();
