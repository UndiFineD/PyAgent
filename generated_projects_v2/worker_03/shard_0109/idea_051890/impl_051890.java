...
@Data
public class Idea51890Config {
    private String name = "idea_051890";
 ...
 */
@Slf4j
public class Idea51890Service {
    private static final int IDEA_ID = 51890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51890Service() {
        this(new Idea51890Config());
    }

    public Idea51890Service(Idea51890Config config) {
        this.config = config != null ? config : new Idea51890Config();
