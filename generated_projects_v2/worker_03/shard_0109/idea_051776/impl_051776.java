...
@Data
public class Idea51776Config {
    private String name = "idea_051776";
 ...
 */
@Slf4j
public class Idea51776Service {
    private static final int IDEA_ID = 51776;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51776Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51776Service() {
        this(new Idea51776Config());
    }

    public Idea51776Service(Idea51776Config config) {
        this.config = config != null ? config : new Idea51776Config();
