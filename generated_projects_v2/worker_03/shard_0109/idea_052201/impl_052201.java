...
@Data
public class Idea52201Config {
    private String name = "idea_052201";
 ...
 */
@Slf4j
public class Idea52201Service {
    private static final int IDEA_ID = 52201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52201Service() {
        this(new Idea52201Config());
    }

    public Idea52201Service(Idea52201Config config) {
        this.config = config != null ? config : new Idea52201Config();
