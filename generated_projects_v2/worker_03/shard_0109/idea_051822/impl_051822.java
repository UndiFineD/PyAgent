...
@Data
public class Idea51822Config {
    private String name = "idea_051822";
 ...
 */
@Slf4j
public class Idea51822Service {
    private static final int IDEA_ID = 51822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51822Service() {
        this(new Idea51822Config());
    }

    public Idea51822Service(Idea51822Config config) {
        this.config = config != null ? config : new Idea51822Config();
