...
@Data
public class Idea52146Config {
    private String name = "idea_052146";
 ...
 */
@Slf4j
public class Idea52146Service {
    private static final int IDEA_ID = 52146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52146Service() {
        this(new Idea52146Config());
    }

    public Idea52146Service(Idea52146Config config) {
        this.config = config != null ? config : new Idea52146Config();
