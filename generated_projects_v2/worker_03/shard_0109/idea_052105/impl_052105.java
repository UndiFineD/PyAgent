...
@Data
public class Idea52105Config {
    private String name = "idea_052105";
 ...
 */
@Slf4j
public class Idea52105Service {
    private static final int IDEA_ID = 52105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52105Service() {
        this(new Idea52105Config());
    }

    public Idea52105Service(Idea52105Config config) {
        this.config = config != null ? config : new Idea52105Config();
