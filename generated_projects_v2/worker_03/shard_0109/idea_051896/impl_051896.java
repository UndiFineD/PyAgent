...
@Data
public class Idea51896Config {
    private String name = "idea_051896";
 ...
 */
@Slf4j
public class Idea51896Service {
    private static final int IDEA_ID = 51896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51896Service() {
        this(new Idea51896Config());
    }

    public Idea51896Service(Idea51896Config config) {
        this.config = config != null ? config : new Idea51896Config();
