...
@Data
public class Idea51803Config {
    private String name = "idea_051803";
 ...
 */
@Slf4j
public class Idea51803Service {
    private static final int IDEA_ID = 51803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51803Service() {
        this(new Idea51803Config());
    }

    public Idea51803Service(Idea51803Config config) {
        this.config = config != null ? config : new Idea51803Config();
