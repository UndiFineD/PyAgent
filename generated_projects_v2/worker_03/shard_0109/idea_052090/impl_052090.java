...
@Data
public class Idea52090Config {
    private String name = "idea_052090";
 ...
 */
@Slf4j
public class Idea52090Service {
    private static final int IDEA_ID = 52090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52090Service() {
        this(new Idea52090Config());
    }

    public Idea52090Service(Idea52090Config config) {
        this.config = config != null ? config : new Idea52090Config();
