...
@Data
public class Idea52122Config {
    private String name = "idea_052122";
 ...
 */
@Slf4j
public class Idea52122Service {
    private static final int IDEA_ID = 52122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52122Service() {
        this(new Idea52122Config());
    }

    public Idea52122Service(Idea52122Config config) {
        this.config = config != null ? config : new Idea52122Config();
