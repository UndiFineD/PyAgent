...
@Data
public class Idea51779Config {
    private String name = "idea_051779";
 ...
 */
@Slf4j
public class Idea51779Service {
    private static final int IDEA_ID = 51779;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51779Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51779Service() {
        this(new Idea51779Config());
    }

    public Idea51779Service(Idea51779Config config) {
        this.config = config != null ? config : new Idea51779Config();
