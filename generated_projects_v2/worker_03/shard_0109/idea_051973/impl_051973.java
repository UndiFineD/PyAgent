...
@Data
public class Idea51973Config {
    private String name = "idea_051973";
 ...
 */
@Slf4j
public class Idea51973Service {
    private static final int IDEA_ID = 51973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51973Service() {
        this(new Idea51973Config());
    }

    public Idea51973Service(Idea51973Config config) {
        this.config = config != null ? config : new Idea51973Config();
