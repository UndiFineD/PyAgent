...
@Data
public class Idea51984Config {
    private String name = "idea_051984";
 ...
 */
@Slf4j
public class Idea51984Service {
    private static final int IDEA_ID = 51984;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51984Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51984Service() {
        this(new Idea51984Config());
    }

    public Idea51984Service(Idea51984Config config) {
        this.config = config != null ? config : new Idea51984Config();
