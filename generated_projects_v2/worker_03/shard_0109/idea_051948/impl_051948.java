...
@Data
public class Idea51948Config {
    private String name = "idea_051948";
 ...
 */
@Slf4j
public class Idea51948Service {
    private static final int IDEA_ID = 51948;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51948Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51948Service() {
        this(new Idea51948Config());
    }

    public Idea51948Service(Idea51948Config config) {
        this.config = config != null ? config : new Idea51948Config();
