...
@Data
public class Idea52127Config {
    private String name = "idea_052127";
 ...
 */
@Slf4j
public class Idea52127Service {
    private static final int IDEA_ID = 52127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52127Service() {
        this(new Idea52127Config());
    }

    public Idea52127Service(Idea52127Config config) {
        this.config = config != null ? config : new Idea52127Config();
