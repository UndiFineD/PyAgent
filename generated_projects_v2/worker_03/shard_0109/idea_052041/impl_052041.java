...
@Data
public class Idea52041Config {
    private String name = "idea_052041";
 ...
 */
@Slf4j
public class Idea52041Service {
    private static final int IDEA_ID = 52041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52041Service() {
        this(new Idea52041Config());
    }

    public Idea52041Service(Idea52041Config config) {
        this.config = config != null ? config : new Idea52041Config();
