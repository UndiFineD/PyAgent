...
@Data
public class Idea51933Config {
    private String name = "idea_051933";
 ...
 */
@Slf4j
public class Idea51933Service {
    private static final int IDEA_ID = 51933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51933Service() {
        this(new Idea51933Config());
    }

    public Idea51933Service(Idea51933Config config) {
        this.config = config != null ? config : new Idea51933Config();
