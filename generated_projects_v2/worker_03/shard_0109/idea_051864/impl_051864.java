...
@Data
public class Idea51864Config {
    private String name = "idea_051864";
 ...
 */
@Slf4j
public class Idea51864Service {
    private static final int IDEA_ID = 51864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51864Service() {
        this(new Idea51864Config());
    }

    public Idea51864Service(Idea51864Config config) {
        this.config = config != null ? config : new Idea51864Config();
