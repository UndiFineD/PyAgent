...
@Data
public class Idea52241Config {
    private String name = "idea_052241";
 ...
 */
@Slf4j
public class Idea52241Service {
    private static final int IDEA_ID = 52241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52241Service() {
        this(new Idea52241Config());
    }

    public Idea52241Service(Idea52241Config config) {
        this.config = config != null ? config : new Idea52241Config();
