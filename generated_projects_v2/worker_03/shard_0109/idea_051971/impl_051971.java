...
@Data
public class Idea51971Config {
    private String name = "idea_051971";
 ...
 */
@Slf4j
public class Idea51971Service {
    private static final int IDEA_ID = 51971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51971Service() {
        this(new Idea51971Config());
    }

    public Idea51971Service(Idea51971Config config) {
        this.config = config != null ? config : new Idea51971Config();
