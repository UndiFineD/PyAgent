...
@Data
public class Idea51870Config {
    private String name = "idea_051870";
 ...
 */
@Slf4j
public class Idea51870Service {
    private static final int IDEA_ID = 51870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51870Service() {
        this(new Idea51870Config());
    }

    public Idea51870Service(Idea51870Config config) {
        this.config = config != null ? config : new Idea51870Config();
