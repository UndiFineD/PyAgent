...
@Data
public class Idea52082Config {
    private String name = "idea_052082";
 ...
 */
@Slf4j
public class Idea52082Service {
    private static final int IDEA_ID = 52082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52082Service() {
        this(new Idea52082Config());
    }

    public Idea52082Service(Idea52082Config config) {
        this.config = config != null ? config : new Idea52082Config();
