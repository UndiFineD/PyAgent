...
@Data
public class Idea51838Config {
    private String name = "idea_051838";
 ...
 */
@Slf4j
public class Idea51838Service {
    private static final int IDEA_ID = 51838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51838Service() {
        this(new Idea51838Config());
    }

    public Idea51838Service(Idea51838Config config) {
        this.config = config != null ? config : new Idea51838Config();
