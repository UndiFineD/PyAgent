...
@Data
public class Idea52220Config {
    private String name = "idea_052220";
 ...
 */
@Slf4j
public class Idea52220Service {
    private static final int IDEA_ID = 52220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52220Service() {
        this(new Idea52220Config());
    }

    public Idea52220Service(Idea52220Config config) {
        this.config = config != null ? config : new Idea52220Config();
