...
@Data
public class Idea52124Config {
    private String name = "idea_052124";
 ...
 */
@Slf4j
public class Idea52124Service {
    private static final int IDEA_ID = 52124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52124Service() {
        this(new Idea52124Config());
    }

    public Idea52124Service(Idea52124Config config) {
        this.config = config != null ? config : new Idea52124Config();
