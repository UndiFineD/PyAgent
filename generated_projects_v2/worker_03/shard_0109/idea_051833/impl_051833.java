...
@Data
public class Idea51833Config {
    private String name = "idea_051833";
 ...
 */
@Slf4j
public class Idea51833Service {
    private static final int IDEA_ID = 51833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51833Service() {
        this(new Idea51833Config());
    }

    public Idea51833Service(Idea51833Config config) {
        this.config = config != null ? config : new Idea51833Config();
