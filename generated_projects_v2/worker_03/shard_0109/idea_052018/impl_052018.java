...
@Data
public class Idea52018Config {
    private String name = "idea_052018";
 ...
 */
@Slf4j
public class Idea52018Service {
    private static final int IDEA_ID = 52018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52018Service() {
        this(new Idea52018Config());
    }

    public Idea52018Service(Idea52018Config config) {
        this.config = config != null ? config : new Idea52018Config();
