...
@Data
public class Idea52196Config {
    private String name = "idea_052196";
 ...
 */
@Slf4j
public class Idea52196Service {
    private static final int IDEA_ID = 52196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52196Service() {
        this(new Idea52196Config());
    }

    public Idea52196Service(Idea52196Config config) {
        this.config = config != null ? config : new Idea52196Config();
