...
@Data
public class Idea52189Config {
    private String name = "idea_052189";
 ...
 */
@Slf4j
public class Idea52189Service {
    private static final int IDEA_ID = 52189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52189Service() {
        this(new Idea52189Config());
    }

    public Idea52189Service(Idea52189Config config) {
        this.config = config != null ? config : new Idea52189Config();
