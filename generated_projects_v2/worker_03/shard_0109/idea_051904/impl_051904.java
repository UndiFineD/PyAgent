...
@Data
public class Idea51904Config {
    private String name = "idea_051904";
 ...
 */
@Slf4j
public class Idea51904Service {
    private static final int IDEA_ID = 51904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51904Service() {
        this(new Idea51904Config());
    }

    public Idea51904Service(Idea51904Config config) {
        this.config = config != null ? config : new Idea51904Config();
