...
@Data
public class Idea52226Config {
    private String name = "idea_052226";
 ...
 */
@Slf4j
public class Idea52226Service {
    private static final int IDEA_ID = 52226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52226Service() {
        this(new Idea52226Config());
    }

    public Idea52226Service(Idea52226Config config) {
        this.config = config != null ? config : new Idea52226Config();
