...
@Data
public class Idea52073Config {
    private String name = "idea_052073";
 ...
 */
@Slf4j
public class Idea52073Service {
    private static final int IDEA_ID = 52073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52073Service() {
        this(new Idea52073Config());
    }

    public Idea52073Service(Idea52073Config config) {
        this.config = config != null ? config : new Idea52073Config();
