...
@Data
public class Idea51805Config {
    private String name = "idea_051805";
 ...
 */
@Slf4j
public class Idea51805Service {
    private static final int IDEA_ID = 51805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51805Service() {
        this(new Idea51805Config());
    }

    public Idea51805Service(Idea51805Config config) {
        this.config = config != null ? config : new Idea51805Config();
