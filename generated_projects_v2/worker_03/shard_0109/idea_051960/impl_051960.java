...
@Data
public class Idea51960Config {
    private String name = "idea_051960";
 ...
 */
@Slf4j
public class Idea51960Service {
    private static final int IDEA_ID = 51960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51960Service() {
        this(new Idea51960Config());
    }

    public Idea51960Service(Idea51960Config config) {
        this.config = config != null ? config : new Idea51960Config();
