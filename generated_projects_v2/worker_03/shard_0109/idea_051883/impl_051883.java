...
@Data
public class Idea51883Config {
    private String name = "idea_051883";
 ...
 */
@Slf4j
public class Idea51883Service {
    private static final int IDEA_ID = 51883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51883Service() {
        this(new Idea51883Config());
    }

    public Idea51883Service(Idea51883Config config) {
        this.config = config != null ? config : new Idea51883Config();
