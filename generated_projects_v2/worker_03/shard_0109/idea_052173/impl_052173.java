...
@Data
public class Idea52173Config {
    private String name = "idea_052173";
 ...
 */
@Slf4j
public class Idea52173Service {
    private static final int IDEA_ID = 52173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52173Service() {
        this(new Idea52173Config());
    }

    public Idea52173Service(Idea52173Config config) {
        this.config = config != null ? config : new Idea52173Config();
