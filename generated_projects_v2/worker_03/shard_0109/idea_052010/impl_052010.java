...
@Data
public class Idea52010Config {
    private String name = "idea_052010";
 ...
 */
@Slf4j
public class Idea52010Service {
    private static final int IDEA_ID = 52010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52010Service() {
        this(new Idea52010Config());
    }

    public Idea52010Service(Idea52010Config config) {
        this.config = config != null ? config : new Idea52010Config();
