...
@Data
public class Idea51946Config {
    private String name = "idea_051946";
 ...
 */
@Slf4j
public class Idea51946Service {
    private static final int IDEA_ID = 51946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51946Service() {
        this(new Idea51946Config());
    }

    public Idea51946Service(Idea51946Config config) {
        this.config = config != null ? config : new Idea51946Config();
