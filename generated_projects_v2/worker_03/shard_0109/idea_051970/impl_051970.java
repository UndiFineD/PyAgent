...
@Data
public class Idea51970Config {
    private String name = "idea_051970";
 ...
 */
@Slf4j
public class Idea51970Service {
    private static final int IDEA_ID = 51970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51970Service() {
        this(new Idea51970Config());
    }

    public Idea51970Service(Idea51970Config config) {
        this.config = config != null ? config : new Idea51970Config();
