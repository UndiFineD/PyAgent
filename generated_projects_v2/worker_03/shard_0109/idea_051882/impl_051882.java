...
@Data
public class Idea51882Config {
    private String name = "idea_051882";
 ...
 */
@Slf4j
public class Idea51882Service {
    private static final int IDEA_ID = 51882;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51882Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51882Service() {
        this(new Idea51882Config());
    }

    public Idea51882Service(Idea51882Config config) {
        this.config = config != null ? config : new Idea51882Config();
