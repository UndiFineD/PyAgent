...
@Data
public class Idea51836Config {
    private String name = "idea_051836";
 ...
 */
@Slf4j
public class Idea51836Service {
    private static final int IDEA_ID = 51836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51836Service() {
        this(new Idea51836Config());
    }

    public Idea51836Service(Idea51836Config config) {
        this.config = config != null ? config : new Idea51836Config();
