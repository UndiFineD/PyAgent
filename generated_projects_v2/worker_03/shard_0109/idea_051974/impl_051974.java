...
@Data
public class Idea51974Config {
    private String name = "idea_051974";
 ...
 */
@Slf4j
public class Idea51974Service {
    private static final int IDEA_ID = 51974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51974Service() {
        this(new Idea51974Config());
    }

    public Idea51974Service(Idea51974Config config) {
        this.config = config != null ? config : new Idea51974Config();
