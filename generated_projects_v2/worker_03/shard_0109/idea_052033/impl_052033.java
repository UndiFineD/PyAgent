...
@Data
public class Idea52033Config {
    private String name = "idea_052033";
 ...
 */
@Slf4j
public class Idea52033Service {
    private static final int IDEA_ID = 52033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52033Service() {
        this(new Idea52033Config());
    }

    public Idea52033Service(Idea52033Config config) {
        this.config = config != null ? config : new Idea52033Config();
