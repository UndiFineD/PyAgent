...
@Data
public class Idea52136Config {
    private String name = "idea_052136";
 ...
 */
@Slf4j
public class Idea52136Service {
    private static final int IDEA_ID = 52136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52136Service() {
        this(new Idea52136Config());
    }

    public Idea52136Service(Idea52136Config config) {
        this.config = config != null ? config : new Idea52136Config();
