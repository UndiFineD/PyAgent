...
@Data
public class Idea52204Config {
    private String name = "idea_052204";
 ...
 */
@Slf4j
public class Idea52204Service {
    private static final int IDEA_ID = 52204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52204Service() {
        this(new Idea52204Config());
    }

    public Idea52204Service(Idea52204Config config) {
        this.config = config != null ? config : new Idea52204Config();
