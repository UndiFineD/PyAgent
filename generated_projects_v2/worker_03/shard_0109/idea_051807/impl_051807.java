...
@Data
public class Idea51807Config {
    private String name = "idea_051807";
 ...
 */
@Slf4j
public class Idea51807Service {
    private static final int IDEA_ID = 51807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51807Service() {
        this(new Idea51807Config());
    }

    public Idea51807Service(Idea51807Config config) {
        this.config = config != null ? config : new Idea51807Config();
