...
@Data
public class Idea52007Config {
    private String name = "idea_052007";
 ...
 */
@Slf4j
public class Idea52007Service {
    private static final int IDEA_ID = 52007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52007Service() {
        this(new Idea52007Config());
    }

    public Idea52007Service(Idea52007Config config) {
        this.config = config != null ? config : new Idea52007Config();
