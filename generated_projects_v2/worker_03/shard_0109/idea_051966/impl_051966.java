...
@Data
public class Idea51966Config {
    private String name = "idea_051966";
 ...
 */
@Slf4j
public class Idea51966Service {
    private static final int IDEA_ID = 51966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51966Service() {
        this(new Idea51966Config());
    }

    public Idea51966Service(Idea51966Config config) {
        this.config = config != null ? config : new Idea51966Config();
