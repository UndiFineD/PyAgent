...
@Data
public class Idea51928Config {
    private String name = "idea_051928";
 ...
 */
@Slf4j
public class Idea51928Service {
    private static final int IDEA_ID = 51928;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51928Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51928Service() {
        this(new Idea51928Config());
    }

    public Idea51928Service(Idea51928Config config) {
        this.config = config != null ? config : new Idea51928Config();
