...
@Data
public class Idea52101Config {
    private String name = "idea_052101";
 ...
 */
@Slf4j
public class Idea52101Service {
    private static final int IDEA_ID = 52101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52101Service() {
        this(new Idea52101Config());
    }

    public Idea52101Service(Idea52101Config config) {
        this.config = config != null ? config : new Idea52101Config();
