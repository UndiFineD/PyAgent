...
@Data
public class Idea52233Config {
    private String name = "idea_052233";
 ...
 */
@Slf4j
public class Idea52233Service {
    private static final int IDEA_ID = 52233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52233Service() {
        this(new Idea52233Config());
    }

    public Idea52233Service(Idea52233Config config) {
        this.config = config != null ? config : new Idea52233Config();
