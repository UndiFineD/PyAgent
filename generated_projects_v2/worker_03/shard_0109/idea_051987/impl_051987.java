...
@Data
public class Idea51987Config {
    private String name = "idea_051987";
 ...
 */
@Slf4j
public class Idea51987Service {
    private static final int IDEA_ID = 51987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51987Service() {
        this(new Idea51987Config());
    }

    public Idea51987Service(Idea51987Config config) {
        this.config = config != null ? config : new Idea51987Config();
