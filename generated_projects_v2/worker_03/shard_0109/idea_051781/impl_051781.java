...
@Data
public class Idea51781Config {
    private String name = "idea_051781";
 ...
 */
@Slf4j
public class Idea51781Service {
    private static final int IDEA_ID = 51781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51781Service() {
        this(new Idea51781Config());
    }

    public Idea51781Service(Idea51781Config config) {
        this.config = config != null ? config : new Idea51781Config();
