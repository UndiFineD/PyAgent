...
@Data
public class Idea52212Config {
    private String name = "idea_052212";
 ...
 */
@Slf4j
public class Idea52212Service {
    private static final int IDEA_ID = 52212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52212Service() {
        this(new Idea52212Config());
    }

    public Idea52212Service(Idea52212Config config) {
        this.config = config != null ? config : new Idea52212Config();
