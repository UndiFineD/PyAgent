...
@Data
public class Idea51829Config {
    private String name = "idea_051829";
 ...
 */
@Slf4j
public class Idea51829Service {
    private static final int IDEA_ID = 51829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51829Service() {
        this(new Idea51829Config());
    }

    public Idea51829Service(Idea51829Config config) {
        this.config = config != null ? config : new Idea51829Config();
