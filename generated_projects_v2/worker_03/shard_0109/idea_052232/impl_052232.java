...
@Data
public class Idea52232Config {
    private String name = "idea_052232";
 ...
 */
@Slf4j
public class Idea52232Service {
    private static final int IDEA_ID = 52232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52232Service() {
        this(new Idea52232Config());
    }

    public Idea52232Service(Idea52232Config config) {
        this.config = config != null ? config : new Idea52232Config();
