...
@Data
public class Idea52151Config {
    private String name = "idea_052151";
 ...
 */
@Slf4j
public class Idea52151Service {
    private static final int IDEA_ID = 52151;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52151Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52151Service() {
        this(new Idea52151Config());
    }

    public Idea52151Service(Idea52151Config config) {
        this.config = config != null ? config : new Idea52151Config();
