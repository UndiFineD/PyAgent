...
@Data
public class Idea52231Config {
    private String name = "idea_052231";
 ...
 */
@Slf4j
public class Idea52231Service {
    private static final int IDEA_ID = 52231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52231Service() {
        this(new Idea52231Config());
    }

    public Idea52231Service(Idea52231Config config) {
        this.config = config != null ? config : new Idea52231Config();
