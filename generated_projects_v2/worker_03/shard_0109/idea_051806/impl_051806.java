...
@Data
public class Idea51806Config {
    private String name = "idea_051806";
 ...
 */
@Slf4j
public class Idea51806Service {
    private static final int IDEA_ID = 51806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51806Service() {
        this(new Idea51806Config());
    }

    public Idea51806Service(Idea51806Config config) {
        this.config = config != null ? config : new Idea51806Config();
