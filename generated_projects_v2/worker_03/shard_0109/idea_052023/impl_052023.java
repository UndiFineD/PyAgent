...
@Data
public class Idea52023Config {
    private String name = "idea_052023";
 ...
 */
@Slf4j
public class Idea52023Service {
    private static final int IDEA_ID = 52023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52023Service() {
        this(new Idea52023Config());
    }

    public Idea52023Service(Idea52023Config config) {
        this.config = config != null ? config : new Idea52023Config();
