...
@Data
public class Idea51913Config {
    private String name = "idea_051913";
 ...
 */
@Slf4j
public class Idea51913Service {
    private static final int IDEA_ID = 51913;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51913Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51913Service() {
        this(new Idea51913Config());
    }

    public Idea51913Service(Idea51913Config config) {
        this.config = config != null ? config : new Idea51913Config();
