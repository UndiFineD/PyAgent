...
@Data
public class Idea51788Config {
    private String name = "idea_051788";
 ...
 */
@Slf4j
public class Idea51788Service {
    private static final int IDEA_ID = 51788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51788Service() {
        this(new Idea51788Config());
    }

    public Idea51788Service(Idea51788Config config) {
        this.config = config != null ? config : new Idea51788Config();
