...
@Data
public class Idea51921Config {
    private String name = "idea_051921";
 ...
 */
@Slf4j
public class Idea51921Service {
    private static final int IDEA_ID = 51921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51921Service() {
        this(new Idea51921Config());
    }

    public Idea51921Service(Idea51921Config config) {
        this.config = config != null ? config : new Idea51921Config();
