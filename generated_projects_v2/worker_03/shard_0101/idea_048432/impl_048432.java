...
@Data
public class Idea48432Config {
    private String name = "idea_048432";
 ...
 */
@Slf4j
public class Idea48432Service {
    private static final int IDEA_ID = 48432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48432Service() {
        this(new Idea48432Config());
    }

    public Idea48432Service(Idea48432Config config) {
        this.config = config != null ? config : new Idea48432Config();
