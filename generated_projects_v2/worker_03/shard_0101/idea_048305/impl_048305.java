...
@Data
public class Idea48305Config {
    private String name = "idea_048305";
 ...
 */
@Slf4j
public class Idea48305Service {
    private static final int IDEA_ID = 48305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48305Service() {
        this(new Idea48305Config());
    }

    public Idea48305Service(Idea48305Config config) {
        this.config = config != null ? config : new Idea48305Config();
