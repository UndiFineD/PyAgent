...
@Data
public class Idea48214Config {
    private String name = "idea_048214";
 ...
 */
@Slf4j
public class Idea48214Service {
    private static final int IDEA_ID = 48214;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48214Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48214Service() {
        this(new Idea48214Config());
    }

    public Idea48214Service(Idea48214Config config) {
        this.config = config != null ? config : new Idea48214Config();
