...
@Data
public class Idea48189Config {
    private String name = "idea_048189";
 ...
 */
@Slf4j
public class Idea48189Service {
    private static final int IDEA_ID = 48189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48189Service() {
        this(new Idea48189Config());
    }

    public Idea48189Service(Idea48189Config config) {
        this.config = config != null ? config : new Idea48189Config();
