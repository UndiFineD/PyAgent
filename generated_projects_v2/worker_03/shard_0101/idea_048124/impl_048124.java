...
@Data
public class Idea48124Config {
    private String name = "idea_048124";
 ...
 */
@Slf4j
public class Idea48124Service {
    private static final int IDEA_ID = 48124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48124Service() {
        this(new Idea48124Config());
    }

    public Idea48124Service(Idea48124Config config) {
        this.config = config != null ? config : new Idea48124Config();
