...
@Data
public class Idea48149Config {
    private String name = "idea_048149";
 ...
 */
@Slf4j
public class Idea48149Service {
    private static final int IDEA_ID = 48149;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48149Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48149Service() {
        this(new Idea48149Config());
    }

    public Idea48149Service(Idea48149Config config) {
        this.config = config != null ? config : new Idea48149Config();
