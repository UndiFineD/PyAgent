...
@Data
public class Idea48376Config {
    private String name = "idea_048376";
 ...
 */
@Slf4j
public class Idea48376Service {
    private static final int IDEA_ID = 48376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48376Service() {
        this(new Idea48376Config());
    }

    public Idea48376Service(Idea48376Config config) {
        this.config = config != null ? config : new Idea48376Config();
