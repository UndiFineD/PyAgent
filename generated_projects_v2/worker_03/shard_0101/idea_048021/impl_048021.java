...
@Data
public class Idea48021Config {
    private String name = "idea_048021";
 ...
 */
@Slf4j
public class Idea48021Service {
    private static final int IDEA_ID = 48021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48021Service() {
        this(new Idea48021Config());
    }

    public Idea48021Service(Idea48021Config config) {
        this.config = config != null ? config : new Idea48021Config();
