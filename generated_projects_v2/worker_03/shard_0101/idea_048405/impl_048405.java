...
@Data
public class Idea48405Config {
    private String name = "idea_048405";
 ...
 */
@Slf4j
public class Idea48405Service {
    private static final int IDEA_ID = 48405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48405Service() {
        this(new Idea48405Config());
    }

    public Idea48405Service(Idea48405Config config) {
        this.config = config != null ? config : new Idea48405Config();
