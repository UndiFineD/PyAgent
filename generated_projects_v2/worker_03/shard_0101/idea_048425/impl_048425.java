...
@Data
public class Idea48425Config {
    private String name = "idea_048425";
 ...
 */
@Slf4j
public class Idea48425Service {
    private static final int IDEA_ID = 48425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48425Service() {
        this(new Idea48425Config());
    }

    public Idea48425Service(Idea48425Config config) {
        this.config = config != null ? config : new Idea48425Config();
