...
@Data
public class Idea48343Config {
    private String name = "idea_048343";
 ...
 */
@Slf4j
public class Idea48343Service {
    private static final int IDEA_ID = 48343;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48343Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48343Service() {
        this(new Idea48343Config());
    }

    public Idea48343Service(Idea48343Config config) {
        this.config = config != null ? config : new Idea48343Config();
