...
@Data
public class Idea48201Config {
    private String name = "idea_048201";
 ...
 */
@Slf4j
public class Idea48201Service {
    private static final int IDEA_ID = 48201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48201Service() {
        this(new Idea48201Config());
    }

    public Idea48201Service(Idea48201Config config) {
        this.config = config != null ? config : new Idea48201Config();
