...
@Data
public class Idea48118Config {
    private String name = "idea_048118";
 ...
 */
@Slf4j
public class Idea48118Service {
    private static final int IDEA_ID = 48118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48118Service() {
        this(new Idea48118Config());
    }

    public Idea48118Service(Idea48118Config config) {
        this.config = config != null ? config : new Idea48118Config();
