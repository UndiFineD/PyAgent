...
@Data
public class Idea48104Config {
    private String name = "idea_048104";
 ...
 */
@Slf4j
public class Idea48104Service {
    private static final int IDEA_ID = 48104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48104Service() {
        this(new Idea48104Config());
    }

    public Idea48104Service(Idea48104Config config) {
        this.config = config != null ? config : new Idea48104Config();
