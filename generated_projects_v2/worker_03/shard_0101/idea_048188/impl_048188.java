...
@Data
public class Idea48188Config {
    private String name = "idea_048188";
 ...
 */
@Slf4j
public class Idea48188Service {
    private static final int IDEA_ID = 48188;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48188Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48188Service() {
        this(new Idea48188Config());
    }

    public Idea48188Service(Idea48188Config config) {
        this.config = config != null ? config : new Idea48188Config();
