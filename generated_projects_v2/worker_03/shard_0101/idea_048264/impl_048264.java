...
@Data
public class Idea48264Config {
    private String name = "idea_048264";
 ...
 */
@Slf4j
public class Idea48264Service {
    private static final int IDEA_ID = 48264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48264Service() {
        this(new Idea48264Config());
    }

    public Idea48264Service(Idea48264Config config) {
        this.config = config != null ? config : new Idea48264Config();
