...
@Data
public class Idea48108Config {
    private String name = "idea_048108";
 ...
 */
@Slf4j
public class Idea48108Service {
    private static final int IDEA_ID = 48108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48108Service() {
        this(new Idea48108Config());
    }

    public Idea48108Service(Idea48108Config config) {
        this.config = config != null ? config : new Idea48108Config();
