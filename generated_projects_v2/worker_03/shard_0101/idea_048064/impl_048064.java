...
@Data
public class Idea48064Config {
    private String name = "idea_048064";
 ...
 */
@Slf4j
public class Idea48064Service {
    private static final int IDEA_ID = 48064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48064Service() {
        this(new Idea48064Config());
    }

    public Idea48064Service(Idea48064Config config) {
        this.config = config != null ? config : new Idea48064Config();
