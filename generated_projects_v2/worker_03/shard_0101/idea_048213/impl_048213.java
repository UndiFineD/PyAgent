...
@Data
public class Idea48213Config {
    private String name = "idea_048213";
 ...
 */
@Slf4j
public class Idea48213Service {
    private static final int IDEA_ID = 48213;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48213Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48213Service() {
        this(new Idea48213Config());
    }

    public Idea48213Service(Idea48213Config config) {
        this.config = config != null ? config : new Idea48213Config();
