...
@Data
public class Idea48387Config {
    private String name = "idea_048387";
 ...
 */
@Slf4j
public class Idea48387Service {
    private static final int IDEA_ID = 48387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48387Service() {
        this(new Idea48387Config());
    }

    public Idea48387Service(Idea48387Config config) {
        this.config = config != null ? config : new Idea48387Config();
