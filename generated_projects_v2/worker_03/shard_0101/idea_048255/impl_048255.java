...
@Data
public class Idea48255Config {
    private String name = "idea_048255";
 ...
 */
@Slf4j
public class Idea48255Service {
    private static final int IDEA_ID = 48255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48255Service() {
        this(new Idea48255Config());
    }

    public Idea48255Service(Idea48255Config config) {
        this.config = config != null ? config : new Idea48255Config();
