...
@Data
public class Idea47997Config {
    private String name = "idea_047997";
 ...
 */
@Slf4j
public class Idea47997Service {
    private static final int IDEA_ID = 47997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47997Service() {
        this(new Idea47997Config());
    }

    public Idea47997Service(Idea47997Config config) {
        this.config = config != null ? config : new Idea47997Config();
