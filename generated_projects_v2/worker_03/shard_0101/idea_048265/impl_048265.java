...
@Data
public class Idea48265Config {
    private String name = "idea_048265";
 ...
 */
@Slf4j
public class Idea48265Service {
    private static final int IDEA_ID = 48265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48265Service() {
        this(new Idea48265Config());
    }

    public Idea48265Service(Idea48265Config config) {
        this.config = config != null ? config : new Idea48265Config();
