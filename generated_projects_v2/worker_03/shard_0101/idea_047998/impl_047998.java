...
@Data
public class Idea47998Config {
    private String name = "idea_047998";
 ...
 */
@Slf4j
public class Idea47998Service {
    private static final int IDEA_ID = 47998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47998Service() {
        this(new Idea47998Config());
    }

    public Idea47998Service(Idea47998Config config) {
        this.config = config != null ? config : new Idea47998Config();
