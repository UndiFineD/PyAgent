...
@Data
public class Idea48258Config {
    private String name = "idea_048258";
 ...
 */
@Slf4j
public class Idea48258Service {
    private static final int IDEA_ID = 48258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48258Service() {
        this(new Idea48258Config());
    }

    public Idea48258Service(Idea48258Config config) {
        this.config = config != null ? config : new Idea48258Config();
