...
@Data
public class Idea48191Config {
    private String name = "idea_048191";
 ...
 */
@Slf4j
public class Idea48191Service {
    private static final int IDEA_ID = 48191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48191Service() {
        this(new Idea48191Config());
    }

    public Idea48191Service(Idea48191Config config) {
        this.config = config != null ? config : new Idea48191Config();
