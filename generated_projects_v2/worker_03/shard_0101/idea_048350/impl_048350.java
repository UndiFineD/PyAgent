...
@Data
public class Idea48350Config {
    private String name = "idea_048350";
 ...
 */
@Slf4j
public class Idea48350Service {
    private static final int IDEA_ID = 48350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48350Service() {
        this(new Idea48350Config());
    }

    public Idea48350Service(Idea48350Config config) {
        this.config = config != null ? config : new Idea48350Config();
