...
@Data
public class Idea48240Config {
    private String name = "idea_048240";
 ...
 */
@Slf4j
public class Idea48240Service {
    private static final int IDEA_ID = 48240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48240Service() {
        this(new Idea48240Config());
    }

    public Idea48240Service(Idea48240Config config) {
        this.config = config != null ? config : new Idea48240Config();
