...
@Data
public class Idea48203Config {
    private String name = "idea_048203";
 ...
 */
@Slf4j
public class Idea48203Service {
    private static final int IDEA_ID = 48203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48203Service() {
        this(new Idea48203Config());
    }

    public Idea48203Service(Idea48203Config config) {
        this.config = config != null ? config : new Idea48203Config();
