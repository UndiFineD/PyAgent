...
@Data
public class Idea48127Config {
    private String name = "idea_048127";
 ...
 */
@Slf4j
public class Idea48127Service {
    private static final int IDEA_ID = 48127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48127Service() {
        this(new Idea48127Config());
    }

    public Idea48127Service(Idea48127Config config) {
        this.config = config != null ? config : new Idea48127Config();
