...
@Data
public class Idea48431Config {
    private String name = "idea_048431";
 ...
 */
@Slf4j
public class Idea48431Service {
    private static final int IDEA_ID = 48431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48431Service() {
        this(new Idea48431Config());
    }

    public Idea48431Service(Idea48431Config config) {
        this.config = config != null ? config : new Idea48431Config();
