...
@Data
public class Idea48418Config {
    private String name = "idea_048418";
 ...
 */
@Slf4j
public class Idea48418Service {
    private static final int IDEA_ID = 48418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48418Service() {
        this(new Idea48418Config());
    }

    public Idea48418Service(Idea48418Config config) {
        this.config = config != null ? config : new Idea48418Config();
