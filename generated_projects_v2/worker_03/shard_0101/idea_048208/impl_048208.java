...
@Data
public class Idea48208Config {
    private String name = "idea_048208";
 ...
 */
@Slf4j
public class Idea48208Service {
    private static final int IDEA_ID = 48208;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48208Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48208Service() {
        this(new Idea48208Config());
    }

    public Idea48208Service(Idea48208Config config) {
        this.config = config != null ? config : new Idea48208Config();
