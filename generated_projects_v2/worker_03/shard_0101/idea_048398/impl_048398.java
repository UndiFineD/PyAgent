...
@Data
public class Idea48398Config {
    private String name = "idea_048398";
 ...
 */
@Slf4j
public class Idea48398Service {
    private static final int IDEA_ID = 48398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48398Service() {
        this(new Idea48398Config());
    }

    public Idea48398Service(Idea48398Config config) {
        this.config = config != null ? config : new Idea48398Config();
