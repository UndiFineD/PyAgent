...
@Data
public class Idea48347Config {
    private String name = "idea_048347";
 ...
 */
@Slf4j
public class Idea48347Service {
    private static final int IDEA_ID = 48347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48347Service() {
        this(new Idea48347Config());
    }

    public Idea48347Service(Idea48347Config config) {
        this.config = config != null ? config : new Idea48347Config();
