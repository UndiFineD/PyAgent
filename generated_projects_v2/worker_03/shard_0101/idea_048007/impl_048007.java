...
@Data
public class Idea48007Config {
    private String name = "idea_048007";
 ...
 */
@Slf4j
public class Idea48007Service {
    private static final int IDEA_ID = 48007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48007Service() {
        this(new Idea48007Config());
    }

    public Idea48007Service(Idea48007Config config) {
        this.config = config != null ? config : new Idea48007Config();
