...
@Data
public class Idea48128Config {
    private String name = "idea_048128";
 ...
 */
@Slf4j
public class Idea48128Service {
    private static final int IDEA_ID = 48128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48128Service() {
        this(new Idea48128Config());
    }

    public Idea48128Service(Idea48128Config config) {
        this.config = config != null ? config : new Idea48128Config();
