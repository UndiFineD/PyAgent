...
@Data
public class Idea48421Config {
    private String name = "idea_048421";
 ...
 */
@Slf4j
public class Idea48421Service {
    private static final int IDEA_ID = 48421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48421Service() {
        this(new Idea48421Config());
    }

    public Idea48421Service(Idea48421Config config) {
        this.config = config != null ? config : new Idea48421Config();
