...
@Data
public class Idea48209Config {
    private String name = "idea_048209";
 ...
 */
@Slf4j
public class Idea48209Service {
    private static final int IDEA_ID = 48209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48209Service() {
        this(new Idea48209Config());
    }

    public Idea48209Service(Idea48209Config config) {
        this.config = config != null ? config : new Idea48209Config();
