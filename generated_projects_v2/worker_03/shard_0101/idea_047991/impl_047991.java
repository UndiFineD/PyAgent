...
@Data
public class Idea47991Config {
    private String name = "idea_047991";
 ...
 */
@Slf4j
public class Idea47991Service {
    private static final int IDEA_ID = 47991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47991Service() {
        this(new Idea47991Config());
    }

    public Idea47991Service(Idea47991Config config) {
        this.config = config != null ? config : new Idea47991Config();
