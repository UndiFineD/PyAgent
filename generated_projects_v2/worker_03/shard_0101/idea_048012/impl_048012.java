...
@Data
public class Idea48012Config {
    private String name = "idea_048012";
 ...
 */
@Slf4j
public class Idea48012Service {
    private static final int IDEA_ID = 48012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48012Service() {
        this(new Idea48012Config());
    }

    public Idea48012Service(Idea48012Config config) {
        this.config = config != null ? config : new Idea48012Config();
