...
@Data
public class Idea48281Config {
    private String name = "idea_048281";
 ...
 */
@Slf4j
public class Idea48281Service {
    private static final int IDEA_ID = 48281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48281Service() {
        this(new Idea48281Config());
    }

    public Idea48281Service(Idea48281Config config) {
        this.config = config != null ? config : new Idea48281Config();
