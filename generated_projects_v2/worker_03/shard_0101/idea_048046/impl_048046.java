...
@Data
public class Idea48046Config {
    private String name = "idea_048046";
 ...
 */
@Slf4j
public class Idea48046Service {
    private static final int IDEA_ID = 48046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48046Service() {
        this(new Idea48046Config());
    }

    public Idea48046Service(Idea48046Config config) {
        this.config = config != null ? config : new Idea48046Config();
