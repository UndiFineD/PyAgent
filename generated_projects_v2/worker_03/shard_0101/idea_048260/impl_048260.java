...
@Data
public class Idea48260Config {
    private String name = "idea_048260";
 ...
 */
@Slf4j
public class Idea48260Service {
    private static final int IDEA_ID = 48260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48260Service() {
        this(new Idea48260Config());
    }

    public Idea48260Service(Idea48260Config config) {
        this.config = config != null ? config : new Idea48260Config();
