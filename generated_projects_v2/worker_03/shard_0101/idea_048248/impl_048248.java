...
@Data
public class Idea48248Config {
    private String name = "idea_048248";
 ...
 */
@Slf4j
public class Idea48248Service {
    private static final int IDEA_ID = 48248;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48248Service() {
        this(new Idea48248Config());
    }

    public Idea48248Service(Idea48248Config config) {
        this.config = config != null ? config : new Idea48248Config();
