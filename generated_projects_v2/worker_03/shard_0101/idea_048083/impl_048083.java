...
@Data
public class Idea48083Config {
    private String name = "idea_048083";
 ...
 */
@Slf4j
public class Idea48083Service {
    private static final int IDEA_ID = 48083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48083Service() {
        this(new Idea48083Config());
    }

    public Idea48083Service(Idea48083Config config) {
        this.config = config != null ? config : new Idea48083Config();
