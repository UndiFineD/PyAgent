...
@Data
public class Idea48256Config {
    private String name = "idea_048256";
 ...
 */
@Slf4j
public class Idea48256Service {
    private static final int IDEA_ID = 48256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48256Service() {
        this(new Idea48256Config());
    }

    public Idea48256Service(Idea48256Config config) {
        this.config = config != null ? config : new Idea48256Config();
