...
@Data
public class Idea48333Config {
    private String name = "idea_048333";
 ...
 */
@Slf4j
public class Idea48333Service {
    private static final int IDEA_ID = 48333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48333Service() {
        this(new Idea48333Config());
    }

    public Idea48333Service(Idea48333Config config) {
        this.config = config != null ? config : new Idea48333Config();
