...
@Data
public class Idea48135Config {
    private String name = "idea_048135";
 ...
 */
@Slf4j
public class Idea48135Service {
    private static final int IDEA_ID = 48135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48135Service() {
        this(new Idea48135Config());
    }

    public Idea48135Service(Idea48135Config config) {
        this.config = config != null ? config : new Idea48135Config();
