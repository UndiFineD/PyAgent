...
This project implements idea 48173 from the **backend** category with:
...
```bash
python -m pytest test_idea_048173.py -v
```

## Docker

```bash
docker build -t idea-048173 .
docker run idea-048173
```
...
```
idea_048173/
├── idea_048173.py          (Python)
├── idea_048173.ts          (TypeScript)
├── idea_048173.rs          (Rust)
├── idea_048173.go          (Go)
├── idea_048173.java        (Java)
