...
@Data
public class Idea48275Config {
    private String name = "idea_048275";
 ...
 */
@Slf4j
public class Idea48275Service {
    private static final int IDEA_ID = 48275;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48275Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48275Service() {
        this(new Idea48275Config());
    }

    public Idea48275Service(Idea48275Config config) {
        this.config = config != null ? config : new Idea48275Config();
