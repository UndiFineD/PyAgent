...
@Data
public class Idea48420Config {
    private String name = "idea_048420";
 ...
 */
@Slf4j
public class Idea48420Service {
    private static final int IDEA_ID = 48420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48420Service() {
        this(new Idea48420Config());
    }

    public Idea48420Service(Idea48420Config config) {
        this.config = config != null ? config : new Idea48420Config();
