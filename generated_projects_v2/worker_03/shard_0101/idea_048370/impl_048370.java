...
@Data
public class Idea48370Config {
    private String name = "idea_048370";
 ...
 */
@Slf4j
public class Idea48370Service {
    private static final int IDEA_ID = 48370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48370Service() {
        this(new Idea48370Config());
    }

    public Idea48370Service(Idea48370Config config) {
        this.config = config != null ? config : new Idea48370Config();
