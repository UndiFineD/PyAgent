...
@Data
public class Idea48024Config {
    private String name = "idea_048024";
 ...
 */
@Slf4j
public class Idea48024Service {
    private static final int IDEA_ID = 48024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48024Service() {
        this(new Idea48024Config());
    }

    public Idea48024Service(Idea48024Config config) {
        this.config = config != null ? config : new Idea48024Config();
