...
@Data
public class Idea47986Config {
    private String name = "idea_047986";
 ...
 */
@Slf4j
public class Idea47986Service {
    private static final int IDEA_ID = 47986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47986Service() {
        this(new Idea47986Config());
    }

    public Idea47986Service(Idea47986Config config) {
        this.config = config != null ? config : new Idea47986Config();
