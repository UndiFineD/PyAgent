...
@Data
public class Idea48307Config {
    private String name = "idea_048307";
 ...
 */
@Slf4j
public class Idea48307Service {
    private static final int IDEA_ID = 48307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48307Service() {
        this(new Idea48307Config());
    }

    public Idea48307Service(Idea48307Config config) {
        this.config = config != null ? config : new Idea48307Config();
