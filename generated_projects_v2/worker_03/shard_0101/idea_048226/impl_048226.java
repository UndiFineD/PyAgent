...
@Data
public class Idea48226Config {
    private String name = "idea_048226";
 ...
 */
@Slf4j
public class Idea48226Service {
    private static final int IDEA_ID = 48226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48226Service() {
        this(new Idea48226Config());
    }

    public Idea48226Service(Idea48226Config config) {
        this.config = config != null ? config : new Idea48226Config();
