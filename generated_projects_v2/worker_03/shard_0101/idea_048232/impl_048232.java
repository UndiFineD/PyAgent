...
@Data
public class Idea48232Config {
    private String name = "idea_048232";
 ...
 */
@Slf4j
public class Idea48232Service {
    private static final int IDEA_ID = 48232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48232Service() {
        this(new Idea48232Config());
    }

    public Idea48232Service(Idea48232Config config) {
        this.config = config != null ? config : new Idea48232Config();
