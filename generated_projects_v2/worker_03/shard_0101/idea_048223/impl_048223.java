...
@Data
public class Idea48223Config {
    private String name = "idea_048223";
 ...
 */
@Slf4j
public class Idea48223Service {
    private static final int IDEA_ID = 48223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48223Service() {
        this(new Idea48223Config());
    }

    public Idea48223Service(Idea48223Config config) {
        this.config = config != null ? config : new Idea48223Config();
