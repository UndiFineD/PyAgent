...
@Data
public class Idea48015Config {
    private String name = "idea_048015";
 ...
 */
@Slf4j
public class Idea48015Service {
    private static final int IDEA_ID = 48015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48015Service() {
        this(new Idea48015Config());
    }

    public Idea48015Service(Idea48015Config config) {
        this.config = config != null ? config : new Idea48015Config();
