...
@Data
public class Idea48382Config {
    private String name = "idea_048382";
 ...
 */
@Slf4j
public class Idea48382Service {
    private static final int IDEA_ID = 48382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48382Service() {
        this(new Idea48382Config());
    }

    public Idea48382Service(Idea48382Config config) {
        this.config = config != null ? config : new Idea48382Config();
