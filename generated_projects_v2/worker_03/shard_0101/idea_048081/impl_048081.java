...
@Data
public class Idea48081Config {
    private String name = "idea_048081";
 ...
 */
@Slf4j
public class Idea48081Service {
    private static final int IDEA_ID = 48081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48081Service() {
        this(new Idea48081Config());
    }

    public Idea48081Service(Idea48081Config config) {
        this.config = config != null ? config : new Idea48081Config();
