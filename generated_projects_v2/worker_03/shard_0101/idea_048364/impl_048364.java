...
@Data
public class Idea48364Config {
    private String name = "idea_048364";
 ...
 */
@Slf4j
public class Idea48364Service {
    private static final int IDEA_ID = 48364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48364Service() {
        this(new Idea48364Config());
    }

    public Idea48364Service(Idea48364Config config) {
        this.config = config != null ? config : new Idea48364Config();
