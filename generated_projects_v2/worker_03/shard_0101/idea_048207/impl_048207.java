...
@Data
public class Idea48207Config {
    private String name = "idea_048207";
 ...
 */
@Slf4j
public class Idea48207Service {
    private static final int IDEA_ID = 48207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48207Service() {
        this(new Idea48207Config());
    }

    public Idea48207Service(Idea48207Config config) {
        this.config = config != null ? config : new Idea48207Config();
