...
@Data
public class Idea48250Config {
    private String name = "idea_048250";
 ...
 */
@Slf4j
public class Idea48250Service {
    private static final int IDEA_ID = 48250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48250Service() {
        this(new Idea48250Config());
    }

    public Idea48250Service(Idea48250Config config) {
        this.config = config != null ? config : new Idea48250Config();
