...
@Data
public class Idea48102Config {
    private String name = "idea_048102";
 ...
 */
@Slf4j
public class Idea48102Service {
    private static final int IDEA_ID = 48102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48102Service() {
        this(new Idea48102Config());
    }

    public Idea48102Service(Idea48102Config config) {
        this.config = config != null ? config : new Idea48102Config();
