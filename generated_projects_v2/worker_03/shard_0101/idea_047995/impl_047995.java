...
@Data
public class Idea47995Config {
    private String name = "idea_047995";
 ...
 */
@Slf4j
public class Idea47995Service {
    private static final int IDEA_ID = 47995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47995Service() {
        this(new Idea47995Config());
    }

    public Idea47995Service(Idea47995Config config) {
        this.config = config != null ? config : new Idea47995Config();
