...
@Data
public class Idea48236Config {
    private String name = "idea_048236";
 ...
 */
@Slf4j
public class Idea48236Service {
    private static final int IDEA_ID = 48236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48236Service() {
        this(new Idea48236Config());
    }

    public Idea48236Service(Idea48236Config config) {
        this.config = config != null ? config : new Idea48236Config();
