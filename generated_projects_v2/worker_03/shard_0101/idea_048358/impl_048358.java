...
@Data
public class Idea48358Config {
    private String name = "idea_048358";
 ...
 */
@Slf4j
public class Idea48358Service {
    private static final int IDEA_ID = 48358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48358Service() {
        this(new Idea48358Config());
    }

    public Idea48358Service(Idea48358Config config) {
        this.config = config != null ? config : new Idea48358Config();
