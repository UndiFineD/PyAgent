...
@Data
public class Idea48321Config {
    private String name = "idea_048321";
 ...
 */
@Slf4j
public class Idea48321Service {
    private static final int IDEA_ID = 48321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48321Service() {
        this(new Idea48321Config());
    }

    public Idea48321Service(Idea48321Config config) {
        this.config = config != null ? config : new Idea48321Config();
