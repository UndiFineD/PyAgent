...
@Data
public class Idea48436Config {
    private String name = "idea_048436";
 ...
 */
@Slf4j
public class Idea48436Service {
    private static final int IDEA_ID = 48436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48436Service() {
        this(new Idea48436Config());
    }

    public Idea48436Service(Idea48436Config config) {
        this.config = config != null ? config : new Idea48436Config();
