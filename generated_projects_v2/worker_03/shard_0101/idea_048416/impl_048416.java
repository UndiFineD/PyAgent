...
@Data
public class Idea48416Config {
    private String name = "idea_048416";
 ...
 */
@Slf4j
public class Idea48416Service {
    private static final int IDEA_ID = 48416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48416Service() {
        this(new Idea48416Config());
    }

    public Idea48416Service(Idea48416Config config) {
        this.config = config != null ? config : new Idea48416Config();
