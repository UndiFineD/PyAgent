...
@Data
public class Idea48170Config {
    private String name = "idea_048170";
 ...
 */
@Slf4j
public class Idea48170Service {
    private static final int IDEA_ID = 48170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48170Service() {
        this(new Idea48170Config());
    }

    public Idea48170Service(Idea48170Config config) {
        this.config = config != null ? config : new Idea48170Config();
