...
@Data
public class Idea47982Config {
    private String name = "idea_047982";
 ...
 */
@Slf4j
public class Idea47982Service {
    private static final int IDEA_ID = 47982;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47982Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47982Service() {
        this(new Idea47982Config());
    }

    public Idea47982Service(Idea47982Config config) {
        this.config = config != null ? config : new Idea47982Config();
