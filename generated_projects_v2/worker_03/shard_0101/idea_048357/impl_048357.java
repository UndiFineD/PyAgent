...
@Data
public class Idea48357Config {
    private String name = "idea_048357";
 ...
 */
@Slf4j
public class Idea48357Service {
    private static final int IDEA_ID = 48357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48357Service() {
        this(new Idea48357Config());
    }

    public Idea48357Service(Idea48357Config config) {
        this.config = config != null ? config : new Idea48357Config();
