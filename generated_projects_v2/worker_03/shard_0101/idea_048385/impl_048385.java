...
@Data
public class Idea48385Config {
    private String name = "idea_048385";
 ...
 */
@Slf4j
public class Idea48385Service {
    private static final int IDEA_ID = 48385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48385Service() {
        this(new Idea48385Config());
    }

    public Idea48385Service(Idea48385Config config) {
        this.config = config != null ? config : new Idea48385Config();
