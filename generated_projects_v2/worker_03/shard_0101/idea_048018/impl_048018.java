...
@Data
public class Idea48018Config {
    private String name = "idea_048018";
 ...
 */
@Slf4j
public class Idea48018Service {
    private static final int IDEA_ID = 48018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48018Service() {
        this(new Idea48018Config());
    }

    public Idea48018Service(Idea48018Config config) {
        this.config = config != null ? config : new Idea48018Config();
