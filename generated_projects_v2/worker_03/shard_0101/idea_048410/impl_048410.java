...
@Data
public class Idea48410Config {
    private String name = "idea_048410";
 ...
 */
@Slf4j
public class Idea48410Service {
    private static final int IDEA_ID = 48410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48410Service() {
        this(new Idea48410Config());
    }

    public Idea48410Service(Idea48410Config config) {
        this.config = config != null ? config : new Idea48410Config();
