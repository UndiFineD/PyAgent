...
@Data
public class Idea48133Config {
    private String name = "idea_048133";
 ...
 */
@Slf4j
public class Idea48133Service {
    private static final int IDEA_ID = 48133;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48133Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48133Service() {
        this(new Idea48133Config());
    }

    public Idea48133Service(Idea48133Config config) {
        this.config = config != null ? config : new Idea48133Config();
