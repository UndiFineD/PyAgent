...
@Data
public class Idea48391Config {
    private String name = "idea_048391";
 ...
 */
@Slf4j
public class Idea48391Service {
    private static final int IDEA_ID = 48391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48391Service() {
        this(new Idea48391Config());
    }

    public Idea48391Service(Idea48391Config config) {
        this.config = config != null ? config : new Idea48391Config();
