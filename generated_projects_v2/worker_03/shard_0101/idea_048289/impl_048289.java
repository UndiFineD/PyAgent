...
@Data
public class Idea48289Config {
    private String name = "idea_048289";
 ...
 */
@Slf4j
public class Idea48289Service {
    private static final int IDEA_ID = 48289;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48289Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48289Service() {
        this(new Idea48289Config());
    }

    public Idea48289Service(Idea48289Config config) {
        this.config = config != null ? config : new Idea48289Config();
