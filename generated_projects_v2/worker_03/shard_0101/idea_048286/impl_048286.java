...
@Data
public class Idea48286Config {
    private String name = "idea_048286";
 ...
 */
@Slf4j
public class Idea48286Service {
    private static final int IDEA_ID = 48286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48286Service() {
        this(new Idea48286Config());
    }

    public Idea48286Service(Idea48286Config config) {
        this.config = config != null ? config : new Idea48286Config();
