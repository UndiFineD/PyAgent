...
@Data
public class Idea48037Config {
    private String name = "idea_048037";
 ...
 */
@Slf4j
public class Idea48037Service {
    private static final int IDEA_ID = 48037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48037Service() {
        this(new Idea48037Config());
    }

    public Idea48037Service(Idea48037Config config) {
        this.config = config != null ? config : new Idea48037Config();
