...
@Data
public class Idea48262Config {
    private String name = "idea_048262";
 ...
 */
@Slf4j
public class Idea48262Service {
    private static final int IDEA_ID = 48262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48262Service() {
        this(new Idea48262Config());
    }

    public Idea48262Service(Idea48262Config config) {
        this.config = config != null ? config : new Idea48262Config();
