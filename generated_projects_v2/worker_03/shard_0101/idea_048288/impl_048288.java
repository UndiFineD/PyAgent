...
@Data
public class Idea48288Config {
    private String name = "idea_048288";
 ...
 */
@Slf4j
public class Idea48288Service {
    private static final int IDEA_ID = 48288;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48288Service() {
        this(new Idea48288Config());
    }

    public Idea48288Service(Idea48288Config config) {
        this.config = config != null ? config : new Idea48288Config();
