...
@Data
public class Idea48323Config {
    private String name = "idea_048323";
 ...
 */
@Slf4j
public class Idea48323Service {
    private static final int IDEA_ID = 48323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48323Service() {
        this(new Idea48323Config());
    }

    public Idea48323Service(Idea48323Config config) {
        this.config = config != null ? config : new Idea48323Config();
