...
@Data
public class Idea47980Config {
    private String name = "idea_047980";
 ...
 */
@Slf4j
public class Idea47980Service {
    private static final int IDEA_ID = 47980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47980Service() {
        this(new Idea47980Config());
    }

    public Idea47980Service(Idea47980Config config) {
        this.config = config != null ? config : new Idea47980Config();
