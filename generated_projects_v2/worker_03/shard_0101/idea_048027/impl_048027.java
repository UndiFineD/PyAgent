...
@Data
public class Idea48027Config {
    private String name = "idea_048027";
 ...
 */
@Slf4j
public class Idea48027Service {
    private static final int IDEA_ID = 48027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48027Service() {
        this(new Idea48027Config());
    }

    public Idea48027Service(Idea48027Config config) {
        this.config = config != null ? config : new Idea48027Config();
