...
@Data
public class Idea48353Config {
    private String name = "idea_048353";
 ...
 */
@Slf4j
public class Idea48353Service {
    private static final int IDEA_ID = 48353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48353Service() {
        this(new Idea48353Config());
    }

    public Idea48353Service(Idea48353Config config) {
        this.config = config != null ? config : new Idea48353Config();
