...
@Data
public class Idea48388Config {
    private String name = "idea_048388";
 ...
 */
@Slf4j
public class Idea48388Service {
    private static final int IDEA_ID = 48388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48388Service() {
        this(new Idea48388Config());
    }

    public Idea48388Service(Idea48388Config config) {
        this.config = config != null ? config : new Idea48388Config();
