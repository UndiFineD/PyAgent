...
@Data
public class Idea48090Config {
    private String name = "idea_048090";
 ...
 */
@Slf4j
public class Idea48090Service {
    private static final int IDEA_ID = 48090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48090Service() {
        this(new Idea48090Config());
    }

    public Idea48090Service(Idea48090Config config) {
        this.config = config != null ? config : new Idea48090Config();
