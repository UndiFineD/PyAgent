...
@Data
public class Idea48390Config {
    private String name = "idea_048390";
 ...
 */
@Slf4j
public class Idea48390Service {
    private static final int IDEA_ID = 48390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48390Service() {
        this(new Idea48390Config());
    }

    public Idea48390Service(Idea48390Config config) {
        this.config = config != null ? config : new Idea48390Config();
