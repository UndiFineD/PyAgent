...
@Data
public class Idea48172Config {
    private String name = "idea_048172";
 ...
 */
@Slf4j
public class Idea48172Service {
    private static final int IDEA_ID = 48172;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48172Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48172Service() {
        this(new Idea48172Config());
    }

    public Idea48172Service(Idea48172Config config) {
        this.config = config != null ? config : new Idea48172Config();
