...
@Data
public class Idea48338Config {
    private String name = "idea_048338";
 ...
 */
@Slf4j
public class Idea48338Service {
    private static final int IDEA_ID = 48338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48338Service() {
        this(new Idea48338Config());
    }

    public Idea48338Service(Idea48338Config config) {
        this.config = config != null ? config : new Idea48338Config();
