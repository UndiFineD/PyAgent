...
@Data
public class Idea48413Config {
    private String name = "idea_048413";
 ...
 */
@Slf4j
public class Idea48413Service {
    private static final int IDEA_ID = 48413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48413Service() {
        this(new Idea48413Config());
    }

    public Idea48413Service(Idea48413Config config) {
        this.config = config != null ? config : new Idea48413Config();
