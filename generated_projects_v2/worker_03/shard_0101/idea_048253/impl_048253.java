...
@Data
public class Idea48253Config {
    private String name = "idea_048253";
 ...
 */
@Slf4j
public class Idea48253Service {
    private static final int IDEA_ID = 48253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48253Service() {
        this(new Idea48253Config());
    }

    public Idea48253Service(Idea48253Config config) {
        this.config = config != null ? config : new Idea48253Config();
