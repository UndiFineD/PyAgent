...
@Data
public class Idea48247Config {
    private String name = "idea_048247";
 ...
 */
@Slf4j
public class Idea48247Service {
    private static final int IDEA_ID = 48247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48247Service() {
        this(new Idea48247Config());
    }

    public Idea48247Service(Idea48247Config config) {
        this.config = config != null ? config : new Idea48247Config();
