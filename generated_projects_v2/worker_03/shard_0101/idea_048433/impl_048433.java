...
@Data
public class Idea48433Config {
    private String name = "idea_048433";
 ...
 */
@Slf4j
public class Idea48433Service {
    private static final int IDEA_ID = 48433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48433Service() {
        this(new Idea48433Config());
    }

    public Idea48433Service(Idea48433Config config) {
        this.config = config != null ? config : new Idea48433Config();
