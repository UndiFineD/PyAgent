...
@Data
public class Idea48231Config {
    private String name = "idea_048231";
 ...
 */
@Slf4j
public class Idea48231Service {
    private static final int IDEA_ID = 48231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48231Service() {
        this(new Idea48231Config());
    }

    public Idea48231Service(Idea48231Config config) {
        this.config = config != null ? config : new Idea48231Config();
