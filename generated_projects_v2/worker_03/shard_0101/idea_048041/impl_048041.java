...
@Data
public class Idea48041Config {
    private String name = "idea_048041";
 ...
 */
@Slf4j
public class Idea48041Service {
    private static final int IDEA_ID = 48041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48041Service() {
        this(new Idea48041Config());
    }

    public Idea48041Service(Idea48041Config config) {
        this.config = config != null ? config : new Idea48041Config();
