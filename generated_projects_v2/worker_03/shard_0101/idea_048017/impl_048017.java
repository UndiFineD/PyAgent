...
@Data
public class Idea48017Config {
    private String name = "idea_048017";
 ...
 */
@Slf4j
public class Idea48017Service {
    private static final int IDEA_ID = 48017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48017Service() {
        this(new Idea48017Config());
    }

    public Idea48017Service(Idea48017Config config) {
        this.config = config != null ? config : new Idea48017Config();
