...
@Data
public class Idea48381Config {
    private String name = "idea_048381";
 ...
 */
@Slf4j
public class Idea48381Service {
    private static final int IDEA_ID = 48381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48381Service() {
        this(new Idea48381Config());
    }

    public Idea48381Service(Idea48381Config config) {
        this.config = config != null ? config : new Idea48381Config();
