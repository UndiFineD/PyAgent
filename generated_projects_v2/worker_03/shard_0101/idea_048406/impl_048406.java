...
@Data
public class Idea48406Config {
    private String name = "idea_048406";
 ...
 */
@Slf4j
public class Idea48406Service {
    private static final int IDEA_ID = 48406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48406Service() {
        this(new Idea48406Config());
    }

    public Idea48406Service(Idea48406Config config) {
        this.config = config != null ? config : new Idea48406Config();
