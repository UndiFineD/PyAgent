...
@Data
public class Idea48389Config {
    private String name = "idea_048389";
 ...
 */
@Slf4j
public class Idea48389Service {
    private static final int IDEA_ID = 48389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48389Service() {
        this(new Idea48389Config());
    }

    public Idea48389Service(Idea48389Config config) {
        this.config = config != null ? config : new Idea48389Config();
