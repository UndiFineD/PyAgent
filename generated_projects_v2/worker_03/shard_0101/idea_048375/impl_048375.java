...
@Data
public class Idea48375Config {
    private String name = "idea_048375";
 ...
 */
@Slf4j
public class Idea48375Service {
    private static final int IDEA_ID = 48375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48375Service() {
        this(new Idea48375Config());
    }

    public Idea48375Service(Idea48375Config config) {
        this.config = config != null ? config : new Idea48375Config();
