...
@Data
public class Idea48423Config {
    private String name = "idea_048423";
 ...
 */
@Slf4j
public class Idea48423Service {
    private static final int IDEA_ID = 48423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48423Service() {
        this(new Idea48423Config());
    }

    public Idea48423Service(Idea48423Config config) {
        this.config = config != null ? config : new Idea48423Config();
