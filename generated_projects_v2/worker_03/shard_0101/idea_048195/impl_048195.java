...
@Data
public class Idea48195Config {
    private String name = "idea_048195";
 ...
 */
@Slf4j
public class Idea48195Service {
    private static final int IDEA_ID = 48195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48195Service() {
        this(new Idea48195Config());
    }

    public Idea48195Service(Idea48195Config config) {
        this.config = config != null ? config : new Idea48195Config();
