...
@Data
public class Idea48235Config {
    private String name = "idea_048235";
 ...
 */
@Slf4j
public class Idea48235Service {
    private static final int IDEA_ID = 48235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48235Service() {
        this(new Idea48235Config());
    }

    public Idea48235Service(Idea48235Config config) {
        this.config = config != null ? config : new Idea48235Config();
