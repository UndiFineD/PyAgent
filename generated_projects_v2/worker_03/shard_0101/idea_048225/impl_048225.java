...
@Data
public class Idea48225Config {
    private String name = "idea_048225";
 ...
 */
@Slf4j
public class Idea48225Service {
    private static final int IDEA_ID = 48225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48225Service() {
        this(new Idea48225Config());
    }

    public Idea48225Service(Idea48225Config config) {
        this.config = config != null ? config : new Idea48225Config();
