...
@Data
public class Idea48443Config {
    private String name = "idea_048443";
 ...
 */
@Slf4j
public class Idea48443Service {
    private static final int IDEA_ID = 48443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48443Service() {
        this(new Idea48443Config());
    }

    public Idea48443Service(Idea48443Config config) {
        this.config = config != null ? config : new Idea48443Config();
