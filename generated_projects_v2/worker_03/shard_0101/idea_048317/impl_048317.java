...
@Data
public class Idea48317Config {
    private String name = "idea_048317";
 ...
 */
@Slf4j
public class Idea48317Service {
    private static final int IDEA_ID = 48317;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48317Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48317Service() {
        this(new Idea48317Config());
    }

    public Idea48317Service(Idea48317Config config) {
        this.config = config != null ? config : new Idea48317Config();
