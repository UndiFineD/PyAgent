...
@Data
public class Idea48200Config {
    private String name = "idea_048200";
 ...
 */
@Slf4j
public class Idea48200Service {
    private static final int IDEA_ID = 48200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48200Service() {
        this(new Idea48200Config());
    }

    public Idea48200Service(Idea48200Config config) {
        this.config = config != null ? config : new Idea48200Config();
