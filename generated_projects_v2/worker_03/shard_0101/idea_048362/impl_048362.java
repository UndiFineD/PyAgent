...
@Data
public class Idea48362Config {
    private String name = "idea_048362";
 ...
 */
@Slf4j
public class Idea48362Service {
    private static final int IDEA_ID = 48362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48362Service() {
        this(new Idea48362Config());
    }

    public Idea48362Service(Idea48362Config config) {
        this.config = config != null ? config : new Idea48362Config();
