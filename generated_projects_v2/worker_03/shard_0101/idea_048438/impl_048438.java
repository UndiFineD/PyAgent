...
@Data
public class Idea48438Config {
    private String name = "idea_048438";
 ...
 */
@Slf4j
public class Idea48438Service {
    private static final int IDEA_ID = 48438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48438Service() {
        this(new Idea48438Config());
    }

    public Idea48438Service(Idea48438Config config) {
        this.config = config != null ? config : new Idea48438Config();
