...
@Data
public class Idea48202Config {
    private String name = "idea_048202";
 ...
 */
@Slf4j
public class Idea48202Service {
    private static final int IDEA_ID = 48202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48202Service() {
        this(new Idea48202Config());
    }

    public Idea48202Service(Idea48202Config config) {
        this.config = config != null ? config : new Idea48202Config();
