...
@Data
public class Idea48394Config {
    private String name = "idea_048394";
 ...
 */
@Slf4j
public class Idea48394Service {
    private static final int IDEA_ID = 48394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48394Service() {
        this(new Idea48394Config());
    }

    public Idea48394Service(Idea48394Config config) {
        this.config = config != null ? config : new Idea48394Config();
