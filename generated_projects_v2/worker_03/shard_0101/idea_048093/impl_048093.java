...
@Data
public class Idea48093Config {
    private String name = "idea_048093";
 ...
 */
@Slf4j
public class Idea48093Service {
    private static final int IDEA_ID = 48093;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48093Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48093Service() {
        this(new Idea48093Config());
    }

    public Idea48093Service(Idea48093Config config) {
        this.config = config != null ? config : new Idea48093Config();
