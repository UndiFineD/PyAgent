...
@Data
public class Idea48365Config {
    private String name = "idea_048365";
 ...
 */
@Slf4j
public class Idea48365Service {
    private static final int IDEA_ID = 48365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48365Service() {
        this(new Idea48365Config());
    }

    public Idea48365Service(Idea48365Config config) {
        this.config = config != null ? config : new Idea48365Config();
