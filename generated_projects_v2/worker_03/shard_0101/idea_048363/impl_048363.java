...
@Data
public class Idea48363Config {
    private String name = "idea_048363";
 ...
 */
@Slf4j
public class Idea48363Service {
    private static final int IDEA_ID = 48363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48363Service() {
        this(new Idea48363Config());
    }

    public Idea48363Service(Idea48363Config config) {
        this.config = config != null ? config : new Idea48363Config();
