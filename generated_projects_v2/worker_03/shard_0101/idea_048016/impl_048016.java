...
@Data
public class Idea48016Config {
    private String name = "idea_048016";
 ...
 */
@Slf4j
public class Idea48016Service {
    private static final int IDEA_ID = 48016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48016Service() {
        this(new Idea48016Config());
    }

    public Idea48016Service(Idea48016Config config) {
        this.config = config != null ? config : new Idea48016Config();
