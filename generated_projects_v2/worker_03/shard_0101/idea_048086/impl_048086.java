...
@Data
public class Idea48086Config {
    private String name = "idea_048086";
 ...
 */
@Slf4j
public class Idea48086Service {
    private static final int IDEA_ID = 48086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48086Service() {
        this(new Idea48086Config());
    }

    public Idea48086Service(Idea48086Config config) {
        this.config = config != null ? config : new Idea48086Config();
