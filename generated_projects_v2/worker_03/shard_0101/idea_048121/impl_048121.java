...
@Data
public class Idea48121Config {
    private String name = "idea_048121";
 ...
 */
@Slf4j
public class Idea48121Service {
    private static final int IDEA_ID = 48121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48121Service() {
        this(new Idea48121Config());
    }

    public Idea48121Service(Idea48121Config config) {
        this.config = config != null ? config : new Idea48121Config();
