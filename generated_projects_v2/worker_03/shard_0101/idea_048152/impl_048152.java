...
@Data
public class Idea48152Config {
    private String name = "idea_048152";
 ...
 */
@Slf4j
public class Idea48152Service {
    private static final int IDEA_ID = 48152;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48152Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48152Service() {
        this(new Idea48152Config());
    }

    public Idea48152Service(Idea48152Config config) {
        this.config = config != null ? config : new Idea48152Config();
