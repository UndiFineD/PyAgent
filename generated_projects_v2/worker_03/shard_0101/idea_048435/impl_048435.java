...
@Data
public class Idea48435Config {
    private String name = "idea_048435";
 ...
 */
@Slf4j
public class Idea48435Service {
    private static final int IDEA_ID = 48435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48435Service() {
        this(new Idea48435Config());
    }

    public Idea48435Service(Idea48435Config config) {
        this.config = config != null ? config : new Idea48435Config();
