...
@Data
public class Idea48306Config {
    private String name = "idea_048306";
 ...
 */
@Slf4j
public class Idea48306Service {
    private static final int IDEA_ID = 48306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48306Service() {
        this(new Idea48306Config());
    }

    public Idea48306Service(Idea48306Config config) {
        this.config = config != null ? config : new Idea48306Config();
