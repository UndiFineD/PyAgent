...
@Data
public class Idea48267Config {
    private String name = "idea_048267";
 ...
 */
@Slf4j
public class Idea48267Service {
    private static final int IDEA_ID = 48267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48267Service() {
        this(new Idea48267Config());
    }

    public Idea48267Service(Idea48267Config config) {
        this.config = config != null ? config : new Idea48267Config();
