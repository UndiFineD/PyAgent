...
@Data
public class Idea48397Config {
    private String name = "idea_048397";
 ...
 */
@Slf4j
public class Idea48397Service {
    private static final int IDEA_ID = 48397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48397Service() {
        this(new Idea48397Config());
    }

    public Idea48397Service(Idea48397Config config) {
        this.config = config != null ? config : new Idea48397Config();
