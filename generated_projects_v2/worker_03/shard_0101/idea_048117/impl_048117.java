...
@Data
public class Idea48117Config {
    private String name = "idea_048117";
 ...
 */
@Slf4j
public class Idea48117Service {
    private static final int IDEA_ID = 48117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48117Service() {
        this(new Idea48117Config());
    }

    public Idea48117Service(Idea48117Config config) {
        this.config = config != null ? config : new Idea48117Config();
