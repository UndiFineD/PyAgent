...
@Data
public class Idea48014Config {
    private String name = "idea_048014";
 ...
 */
@Slf4j
public class Idea48014Service {
    private static final int IDEA_ID = 48014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48014Service() {
        this(new Idea48014Config());
    }

    public Idea48014Service(Idea48014Config config) {
        this.config = config != null ? config : new Idea48014Config();
