...
@Data
public class Idea48077Config {
    private String name = "idea_048077";
 ...
 */
@Slf4j
public class Idea48077Service {
    private static final int IDEA_ID = 48077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48077Service() {
        this(new Idea48077Config());
    }

    public Idea48077Service(Idea48077Config config) {
        this.config = config != null ? config : new Idea48077Config();
