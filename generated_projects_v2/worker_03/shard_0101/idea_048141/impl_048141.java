...
@Data
public class Idea48141Config {
    private String name = "idea_048141";
 ...
 */
@Slf4j
public class Idea48141Service {
    private static final int IDEA_ID = 48141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48141Service() {
        this(new Idea48141Config());
    }

    public Idea48141Service(Idea48141Config config) {
        this.config = config != null ? config : new Idea48141Config();
