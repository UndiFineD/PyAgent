...
@Data
public class Idea48396Config {
    private String name = "idea_048396";
 ...
 */
@Slf4j
public class Idea48396Service {
    private static final int IDEA_ID = 48396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48396Service() {
        this(new Idea48396Config());
    }

    public Idea48396Service(Idea48396Config config) {
        this.config = config != null ? config : new Idea48396Config();
