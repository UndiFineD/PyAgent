...
@Data
public class Idea48161Config {
    private String name = "idea_048161";
 ...
 */
@Slf4j
public class Idea48161Service {
    private static final int IDEA_ID = 48161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48161Service() {
        this(new Idea48161Config());
    }

    public Idea48161Service(Idea48161Config config) {
        this.config = config != null ? config : new Idea48161Config();
