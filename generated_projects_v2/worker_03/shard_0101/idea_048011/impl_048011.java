...
@Data
public class Idea48011Config {
    private String name = "idea_048011";
 ...
 */
@Slf4j
public class Idea48011Service {
    private static final int IDEA_ID = 48011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48011Service() {
        this(new Idea48011Config());
    }

    public Idea48011Service(Idea48011Config config) {
        this.config = config != null ? config : new Idea48011Config();
