...
@Data
public class Idea48026Config {
    private String name = "idea_048026";
 ...
 */
@Slf4j
public class Idea48026Service {
    private static final int IDEA_ID = 48026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48026Service() {
        this(new Idea48026Config());
    }

    public Idea48026Service(Idea48026Config config) {
        this.config = config != null ? config : new Idea48026Config();
