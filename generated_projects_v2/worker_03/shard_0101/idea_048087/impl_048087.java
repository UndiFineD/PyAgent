...
@Data
public class Idea48087Config {
    private String name = "idea_048087";
 ...
 */
@Slf4j
public class Idea48087Service {
    private static final int IDEA_ID = 48087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48087Service() {
        this(new Idea48087Config());
    }

    public Idea48087Service(Idea48087Config config) {
        this.config = config != null ? config : new Idea48087Config();
