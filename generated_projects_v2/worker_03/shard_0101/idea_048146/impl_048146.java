...
@Data
public class Idea48146Config {
    private String name = "idea_048146";
 ...
 */
@Slf4j
public class Idea48146Service {
    private static final int IDEA_ID = 48146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48146Service() {
        this(new Idea48146Config());
    }

    public Idea48146Service(Idea48146Config config) {
        this.config = config != null ? config : new Idea48146Config();
