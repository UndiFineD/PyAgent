...
@Data
public class Idea48332Config {
    private String name = "idea_048332";
 ...
 */
@Slf4j
public class Idea48332Service {
    private static final int IDEA_ID = 48332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48332Service() {
        this(new Idea48332Config());
    }

    public Idea48332Service(Idea48332Config config) {
        this.config = config != null ? config : new Idea48332Config();
