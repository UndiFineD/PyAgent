...
@Data
public class Idea48101Config {
    private String name = "idea_048101";
 ...
 */
@Slf4j
public class Idea48101Service {
    private static final int IDEA_ID = 48101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48101Service() {
        this(new Idea48101Config());
    }

    public Idea48101Service(Idea48101Config config) {
        this.config = config != null ? config : new Idea48101Config();
