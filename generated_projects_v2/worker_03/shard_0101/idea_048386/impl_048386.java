...
@Data
public class Idea48386Config {
    private String name = "idea_048386";
 ...
 */
@Slf4j
public class Idea48386Service {
    private static final int IDEA_ID = 48386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48386Service() {
        this(new Idea48386Config());
    }

    public Idea48386Service(Idea48386Config config) {
        this.config = config != null ? config : new Idea48386Config();
