...
@Data
public class Idea48367Config {
    private String name = "idea_048367";
 ...
 */
@Slf4j
public class Idea48367Service {
    private static final int IDEA_ID = 48367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48367Service() {
        this(new Idea48367Config());
    }

    public Idea48367Service(Idea48367Config config) {
        this.config = config != null ? config : new Idea48367Config();
