...
@Data
public class Idea48345Config {
    private String name = "idea_048345";
 ...
 */
@Slf4j
public class Idea48345Service {
    private static final int IDEA_ID = 48345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48345Service() {
        this(new Idea48345Config());
    }

    public Idea48345Service(Idea48345Config config) {
        this.config = config != null ? config : new Idea48345Config();
