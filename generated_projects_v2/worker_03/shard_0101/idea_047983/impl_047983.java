...
@Data
public class Idea47983Config {
    private String name = "idea_047983";
 ...
 */
@Slf4j
public class Idea47983Service {
    private static final int IDEA_ID = 47983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47983Service() {
        this(new Idea47983Config());
    }

    public Idea47983Service(Idea47983Config config) {
        this.config = config != null ? config : new Idea47983Config();
