...
@Data
public class Idea48401Config {
    private String name = "idea_048401";
 ...
 */
@Slf4j
public class Idea48401Service {
    private static final int IDEA_ID = 48401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48401Service() {
        this(new Idea48401Config());
    }

    public Idea48401Service(Idea48401Config config) {
        this.config = config != null ? config : new Idea48401Config();
