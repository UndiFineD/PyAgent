...
@Data
public class Idea48251Config {
    private String name = "idea_048251";
 ...
 */
@Slf4j
public class Idea48251Service {
    private static final int IDEA_ID = 48251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48251Service() {
        this(new Idea48251Config());
    }

    public Idea48251Service(Idea48251Config config) {
        this.config = config != null ? config : new Idea48251Config();
