...
@Data
public class Idea48335Config {
    private String name = "idea_048335";
 ...
 */
@Slf4j
public class Idea48335Service {
    private static final int IDEA_ID = 48335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48335Service() {
        this(new Idea48335Config());
    }

    public Idea48335Service(Idea48335Config config) {
        this.config = config != null ? config : new Idea48335Config();
