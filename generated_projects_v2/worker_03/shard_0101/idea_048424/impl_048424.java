...
@Data
public class Idea48424Config {
    private String name = "idea_048424";
 ...
 */
@Slf4j
public class Idea48424Service {
    private static final int IDEA_ID = 48424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48424Service() {
        this(new Idea48424Config());
    }

    public Idea48424Service(Idea48424Config config) {
        this.config = config != null ? config : new Idea48424Config();
