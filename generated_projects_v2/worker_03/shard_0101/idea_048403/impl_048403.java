...
@Data
public class Idea48403Config {
    private String name = "idea_048403";
 ...
 */
@Slf4j
public class Idea48403Service {
    private static final int IDEA_ID = 48403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48403Service() {
        this(new Idea48403Config());
    }

    public Idea48403Service(Idea48403Config config) {
        this.config = config != null ? config : new Idea48403Config();
