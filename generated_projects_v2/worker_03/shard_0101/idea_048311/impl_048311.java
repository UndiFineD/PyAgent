...
@Data
public class Idea48311Config {
    private String name = "idea_048311";
 ...
 */
@Slf4j
public class Idea48311Service {
    private static final int IDEA_ID = 48311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48311Service() {
        this(new Idea48311Config());
    }

    public Idea48311Service(Idea48311Config config) {
        this.config = config != null ? config : new Idea48311Config();
