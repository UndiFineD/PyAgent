...
@Data
public class Idea48372Config {
    private String name = "idea_048372";
 ...
 */
@Slf4j
public class Idea48372Service {
    private static final int IDEA_ID = 48372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48372Service() {
        this(new Idea48372Config());
    }

    public Idea48372Service(Idea48372Config config) {
        this.config = config != null ? config : new Idea48372Config();
