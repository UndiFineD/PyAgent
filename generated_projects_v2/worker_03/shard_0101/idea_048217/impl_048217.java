...
@Data
public class Idea48217Config {
    private String name = "idea_048217";
 ...
 */
@Slf4j
public class Idea48217Service {
    private static final int IDEA_ID = 48217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48217Service() {
        this(new Idea48217Config());
    }

    public Idea48217Service(Idea48217Config config) {
        this.config = config != null ? config : new Idea48217Config();
