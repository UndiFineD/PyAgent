...
@Data
public class Idea48422Config {
    private String name = "idea_048422";
 ...
 */
@Slf4j
public class Idea48422Service {
    private static final int IDEA_ID = 48422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48422Service() {
        this(new Idea48422Config());
    }

    public Idea48422Service(Idea48422Config config) {
        this.config = config != null ? config : new Idea48422Config();
