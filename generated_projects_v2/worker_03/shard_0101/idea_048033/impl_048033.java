...
@Data
public class Idea48033Config {
    private String name = "idea_048033";
 ...
 */
@Slf4j
public class Idea48033Service {
    private static final int IDEA_ID = 48033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48033Service() {
        this(new Idea48033Config());
    }

    public Idea48033Service(Idea48033Config config) {
        this.config = config != null ? config : new Idea48033Config();
