...
@Data
public class Idea48278Config {
    private String name = "idea_048278";
 ...
 */
@Slf4j
public class Idea48278Service {
    private static final int IDEA_ID = 48278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48278Service() {
        this(new Idea48278Config());
    }

    public Idea48278Service(Idea48278Config config) {
        this.config = config != null ? config : new Idea48278Config();
