...
@Data
public class Idea48419Config {
    private String name = "idea_048419";
 ...
 */
@Slf4j
public class Idea48419Service {
    private static final int IDEA_ID = 48419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48419Service() {
        this(new Idea48419Config());
    }

    public Idea48419Service(Idea48419Config config) {
        this.config = config != null ? config : new Idea48419Config();
