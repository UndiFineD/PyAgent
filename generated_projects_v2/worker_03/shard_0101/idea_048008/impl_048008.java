...
@Data
public class Idea48008Config {
    private String name = "idea_048008";
 ...
 */
@Slf4j
public class Idea48008Service {
    private static final int IDEA_ID = 48008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48008Service() {
        this(new Idea48008Config());
    }

    public Idea48008Service(Idea48008Config config) {
        this.config = config != null ? config : new Idea48008Config();
