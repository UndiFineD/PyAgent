...
@Data
public class Idea48241Config {
    private String name = "idea_048241";
 ...
 */
@Slf4j
public class Idea48241Service {
    private static final int IDEA_ID = 48241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48241Service() {
        this(new Idea48241Config());
    }

    public Idea48241Service(Idea48241Config config) {
        this.config = config != null ? config : new Idea48241Config();
