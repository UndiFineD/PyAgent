...
@Data
public class Idea48437Config {
    private String name = "idea_048437";
 ...
 */
@Slf4j
public class Idea48437Service {
    private static final int IDEA_ID = 48437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48437Service() {
        this(new Idea48437Config());
    }

    public Idea48437Service(Idea48437Config config) {
        this.config = config != null ? config : new Idea48437Config();
