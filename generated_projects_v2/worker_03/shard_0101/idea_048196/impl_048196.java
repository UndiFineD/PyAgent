...
@Data
public class Idea48196Config {
    private String name = "idea_048196";
 ...
 */
@Slf4j
public class Idea48196Service {
    private static final int IDEA_ID = 48196;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48196Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48196Service() {
        this(new Idea48196Config());
    }

    public Idea48196Service(Idea48196Config config) {
        this.config = config != null ? config : new Idea48196Config();
