...
@Data
public class Idea48002Config {
    private String name = "idea_048002";
 ...
 */
@Slf4j
public class Idea48002Service {
    private static final int IDEA_ID = 48002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48002Service() {
        this(new Idea48002Config());
    }

    public Idea48002Service(Idea48002Config config) {
        this.config = config != null ? config : new Idea48002Config();
