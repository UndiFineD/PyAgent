...
@Data
public class Idea48238Config {
    private String name = "idea_048238";
 ...
 */
@Slf4j
public class Idea48238Service {
    private static final int IDEA_ID = 48238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48238Service() {
        this(new Idea48238Config());
    }

    public Idea48238Service(Idea48238Config config) {
        this.config = config != null ? config : new Idea48238Config();
