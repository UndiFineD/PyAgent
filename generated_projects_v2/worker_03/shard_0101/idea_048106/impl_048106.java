...
@Data
public class Idea48106Config {
    private String name = "idea_048106";
 ...
 */
@Slf4j
public class Idea48106Service {
    private static final int IDEA_ID = 48106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48106Service() {
        this(new Idea48106Config());
    }

    public Idea48106Service(Idea48106Config config) {
        this.config = config != null ? config : new Idea48106Config();
