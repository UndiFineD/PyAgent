...
@Data
public class Idea48009Config {
    private String name = "idea_048009";
 ...
 */
@Slf4j
public class Idea48009Service {
    private static final int IDEA_ID = 48009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48009Service() {
        this(new Idea48009Config());
    }

    public Idea48009Service(Idea48009Config config) {
        this.config = config != null ? config : new Idea48009Config();
