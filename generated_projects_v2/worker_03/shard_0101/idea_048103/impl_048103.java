...
@Data
public class Idea48103Config {
    private String name = "idea_048103";
 ...
 */
@Slf4j
public class Idea48103Service {
    private static final int IDEA_ID = 48103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48103Service() {
        this(new Idea48103Config());
    }

    public Idea48103Service(Idea48103Config config) {
        this.config = config != null ? config : new Idea48103Config();
