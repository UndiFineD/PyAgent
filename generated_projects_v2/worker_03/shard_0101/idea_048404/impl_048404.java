...
@Data
public class Idea48404Config {
    private String name = "idea_048404";
 ...
 */
@Slf4j
public class Idea48404Service {
    private static final int IDEA_ID = 48404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48404Service() {
        this(new Idea48404Config());
    }

    public Idea48404Service(Idea48404Config config) {
        this.config = config != null ? config : new Idea48404Config();
