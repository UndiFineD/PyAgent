...
@Data
public class Idea48071Config {
    private String name = "idea_048071";
 ...
 */
@Slf4j
public class Idea48071Service {
    private static final int IDEA_ID = 48071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48071Service() {
        this(new Idea48071Config());
    }

    public Idea48071Service(Idea48071Config config) {
        this.config = config != null ? config : new Idea48071Config();
