...
@Data
public class Idea47988Config {
    private String name = "idea_047988";
 ...
 */
@Slf4j
public class Idea47988Service {
    private static final int IDEA_ID = 47988;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea47988Config config;
    private final Map<String, ProcessResult> cache;

    public Idea47988Service() {
        this(new Idea47988Config());
    }

    public Idea47988Service(Idea47988Config config) {
        this.config = config != null ? config : new Idea47988Config();
