...
@Data
public class Idea48060Config {
    private String name = "idea_048060";
 ...
 */
@Slf4j
public class Idea48060Service {
    private static final int IDEA_ID = 48060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48060Service() {
        this(new Idea48060Config());
    }

    public Idea48060Service(Idea48060Config config) {
        this.config = config != null ? config : new Idea48060Config();
