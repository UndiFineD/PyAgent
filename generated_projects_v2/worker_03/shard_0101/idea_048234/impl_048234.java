...
@Data
public class Idea48234Config {
    private String name = "idea_048234";
 ...
 */
@Slf4j
public class Idea48234Service {
    private static final int IDEA_ID = 48234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48234Service() {
        this(new Idea48234Config());
    }

    public Idea48234Service(Idea48234Config config) {
        this.config = config != null ? config : new Idea48234Config();
