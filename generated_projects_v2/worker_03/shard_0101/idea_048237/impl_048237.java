...
@Data
public class Idea48237Config {
    private String name = "idea_048237";
 ...
 */
@Slf4j
public class Idea48237Service {
    private static final int IDEA_ID = 48237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea48237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea48237Service() {
        this(new Idea48237Config());
    }

    public Idea48237Service(Idea48237Config config) {
        this.config = config != null ? config : new Idea48237Config();
