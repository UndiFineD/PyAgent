...
@Data
public class Idea51127Config {
    private String name = "idea_051127";
 ...
 */
@Slf4j
public class Idea51127Service {
    private static final int IDEA_ID = 51127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51127Service() {
        this(new Idea51127Config());
    }

    public Idea51127Service(Idea51127Config config) {
        this.config = config != null ? config : new Idea51127Config();
