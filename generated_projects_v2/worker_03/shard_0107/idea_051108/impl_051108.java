...
@Data
public class Idea51108Config {
    private String name = "idea_051108";
 ...
 */
@Slf4j
public class Idea51108Service {
    private static final int IDEA_ID = 51108;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51108Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51108Service() {
        this(new Idea51108Config());
    }

    public Idea51108Service(Idea51108Config config) {
        this.config = config != null ? config : new Idea51108Config();
