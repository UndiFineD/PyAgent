...
@Data
public class Idea51293Config {
    private String name = "idea_051293";
 ...
 */
@Slf4j
public class Idea51293Service {
    private static final int IDEA_ID = 51293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51293Service() {
        this(new Idea51293Config());
    }

    public Idea51293Service(Idea51293Config config) {
        this.config = config != null ? config : new Idea51293Config();
