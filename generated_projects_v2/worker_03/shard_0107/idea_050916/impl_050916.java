...
@Data
public class Idea50916Config {
    private String name = "idea_050916";
 ...
 */
@Slf4j
public class Idea50916Service {
    private static final int IDEA_ID = 50916;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50916Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50916Service() {
        this(new Idea50916Config());
    }

    public Idea50916Service(Idea50916Config config) {
        this.config = config != null ? config : new Idea50916Config();
