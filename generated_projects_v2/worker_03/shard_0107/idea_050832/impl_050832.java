...
@Data
public class Idea50832Config {
    private String name = "idea_050832";
 ...
 */
@Slf4j
public class Idea50832Service {
    private static final int IDEA_ID = 50832;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50832Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50832Service() {
        this(new Idea50832Config());
    }

    public Idea50832Service(Idea50832Config config) {
        this.config = config != null ? config : new Idea50832Config();
