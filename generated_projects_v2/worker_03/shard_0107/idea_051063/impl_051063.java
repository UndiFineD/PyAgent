...
@Data
public class Idea51063Config {
    private String name = "idea_051063";
 ...
 */
@Slf4j
public class Idea51063Service {
    private static final int IDEA_ID = 51063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51063Service() {
        this(new Idea51063Config());
    }

    public Idea51063Service(Idea51063Config config) {
        this.config = config != null ? config : new Idea51063Config();
