...
@Data
public class Idea50837Config {
    private String name = "idea_050837";
 ...
 */
@Slf4j
public class Idea50837Service {
    private static final int IDEA_ID = 50837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50837Service() {
        this(new Idea50837Config());
    }

    public Idea50837Service(Idea50837Config config) {
        this.config = config != null ? config : new Idea50837Config();
