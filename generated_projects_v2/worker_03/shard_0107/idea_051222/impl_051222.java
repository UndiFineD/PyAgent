...
@Data
public class Idea51222Config {
    private String name = "idea_051222";
 ...
 */
@Slf4j
public class Idea51222Service {
    private static final int IDEA_ID = 51222;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51222Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51222Service() {
        this(new Idea51222Config());
    }

    public Idea51222Service(Idea51222Config config) {
        this.config = config != null ? config : new Idea51222Config();
