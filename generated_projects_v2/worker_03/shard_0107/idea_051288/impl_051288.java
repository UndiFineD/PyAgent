...
@Data
public class Idea51288Config {
    private String name = "idea_051288";
 ...
 */
@Slf4j
public class Idea51288Service {
    private static final int IDEA_ID = 51288;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51288Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51288Service() {
        this(new Idea51288Config());
    }

    public Idea51288Service(Idea51288Config config) {
        this.config = config != null ? config : new Idea51288Config();
