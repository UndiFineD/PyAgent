...
@Data
public class Idea51019Config {
    private String name = "idea_051019";
 ...
 */
@Slf4j
public class Idea51019Service {
    private static final int IDEA_ID = 51019;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51019Service() {
        this(new Idea51019Config());
    }

    public Idea51019Service(Idea51019Config config) {
        this.config = config != null ? config : new Idea51019Config();
