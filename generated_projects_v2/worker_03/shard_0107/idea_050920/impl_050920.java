...
@Data
public class Idea50920Config {
    private String name = "idea_050920";
 ...
 */
@Slf4j
public class Idea50920Service {
    private static final int IDEA_ID = 50920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50920Service() {
        this(new Idea50920Config());
    }

    public Idea50920Service(Idea50920Config config) {
        this.config = config != null ? config : new Idea50920Config();
