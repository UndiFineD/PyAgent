...
@Data
public class Idea51194Config {
    private String name = "idea_051194";
 ...
 */
@Slf4j
public class Idea51194Service {
    private static final int IDEA_ID = 51194;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51194Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51194Service() {
        this(new Idea51194Config());
    }

    public Idea51194Service(Idea51194Config config) {
        this.config = config != null ? config : new Idea51194Config();
