...
@Data
public class Idea51075Config {
    private String name = "idea_051075";
 ...
 */
@Slf4j
public class Idea51075Service {
    private static final int IDEA_ID = 51075;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51075Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51075Service() {
        this(new Idea51075Config());
    }

    public Idea51075Service(Idea51075Config config) {
        this.config = config != null ? config : new Idea51075Config();
