...
@Data
public class Idea50981Config {
    private String name = "idea_050981";
 ...
 */
@Slf4j
public class Idea50981Service {
    private static final int IDEA_ID = 50981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50981Service() {
        this(new Idea50981Config());
    }

    public Idea50981Service(Idea50981Config config) {
        this.config = config != null ? config : new Idea50981Config();
