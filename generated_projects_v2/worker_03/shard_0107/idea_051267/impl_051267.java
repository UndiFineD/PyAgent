...
@Data
public class Idea51267Config {
    private String name = "idea_051267";
 ...
 */
@Slf4j
public class Idea51267Service {
    private static final int IDEA_ID = 51267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51267Service() {
        this(new Idea51267Config());
    }

    public Idea51267Service(Idea51267Config config) {
        this.config = config != null ? config : new Idea51267Config();
