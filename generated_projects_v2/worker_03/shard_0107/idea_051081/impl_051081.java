...
@Data
public class Idea51081Config {
    private String name = "idea_051081";
 ...
 */
@Slf4j
public class Idea51081Service {
    private static final int IDEA_ID = 51081;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51081Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51081Service() {
        this(new Idea51081Config());
    }

    public Idea51081Service(Idea51081Config config) {
        this.config = config != null ? config : new Idea51081Config();
