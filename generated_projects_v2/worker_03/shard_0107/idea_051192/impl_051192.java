...
@Data
public class Idea51192Config {
    private String name = "idea_051192";
 ...
 */
@Slf4j
public class Idea51192Service {
    private static final int IDEA_ID = 51192;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51192Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51192Service() {
        this(new Idea51192Config());
    }

    public Idea51192Service(Idea51192Config config) {
        this.config = config != null ? config : new Idea51192Config();
