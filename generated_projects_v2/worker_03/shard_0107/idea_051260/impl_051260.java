...
@Data
public class Idea51260Config {
    private String name = "idea_051260";
 ...
 */
@Slf4j
public class Idea51260Service {
    private static final int IDEA_ID = 51260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51260Service() {
        this(new Idea51260Config());
    }

    public Idea51260Service(Idea51260Config config) {
        this.config = config != null ? config : new Idea51260Config();
