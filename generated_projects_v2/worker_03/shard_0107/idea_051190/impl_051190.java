...
@Data
public class Idea51190Config {
    private String name = "idea_051190";
 ...
 */
@Slf4j
public class Idea51190Service {
    private static final int IDEA_ID = 51190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51190Service() {
        this(new Idea51190Config());
    }

    public Idea51190Service(Idea51190Config config) {
        this.config = config != null ? config : new Idea51190Config();
