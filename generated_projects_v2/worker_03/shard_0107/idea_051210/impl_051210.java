...
@Data
public class Idea51210Config {
    private String name = "idea_051210";
 ...
 */
@Slf4j
public class Idea51210Service {
    private static final int IDEA_ID = 51210;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51210Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51210Service() {
        this(new Idea51210Config());
    }

    public Idea51210Service(Idea51210Config config) {
        this.config = config != null ? config : new Idea51210Config();
