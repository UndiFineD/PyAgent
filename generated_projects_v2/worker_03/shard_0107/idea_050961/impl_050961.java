...
@Data
public class Idea50961Config {
    private String name = "idea_050961";
 ...
 */
@Slf4j
public class Idea50961Service {
    private static final int IDEA_ID = 50961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50961Service() {
        this(new Idea50961Config());
    }

    public Idea50961Service(Idea50961Config config) {
        this.config = config != null ? config : new Idea50961Config();
