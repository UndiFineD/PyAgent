...
@Data
public class Idea51246Config {
    private String name = "idea_051246";
 ...
 */
@Slf4j
public class Idea51246Service {
    private static final int IDEA_ID = 51246;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51246Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51246Service() {
        this(new Idea51246Config());
    }

    public Idea51246Service(Idea51246Config config) {
        this.config = config != null ? config : new Idea51246Config();
