...
@Data
public class Idea51232Config {
    private String name = "idea_051232";
 ...
 */
@Slf4j
public class Idea51232Service {
    private static final int IDEA_ID = 51232;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51232Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51232Service() {
        this(new Idea51232Config());
    }

    public Idea51232Service(Idea51232Config config) {
        this.config = config != null ? config : new Idea51232Config();
