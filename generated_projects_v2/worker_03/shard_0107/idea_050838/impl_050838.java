...
@Data
public class Idea50838Config {
    private String name = "idea_050838";
 ...
 */
@Slf4j
public class Idea50838Service {
    private static final int IDEA_ID = 50838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50838Service() {
        this(new Idea50838Config());
    }

    public Idea50838Service(Idea50838Config config) {
        this.config = config != null ? config : new Idea50838Config();
