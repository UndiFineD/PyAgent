...
@Data
public class Idea51256Config {
    private String name = "idea_051256";
 ...
 */
@Slf4j
public class Idea51256Service {
    private static final int IDEA_ID = 51256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51256Service() {
        this(new Idea51256Config());
    }

    public Idea51256Service(Idea51256Config config) {
        this.config = config != null ? config : new Idea51256Config();
