...
@Data
public class Idea51189Config {
    private String name = "idea_051189";
 ...
 */
@Slf4j
public class Idea51189Service {
    private static final int IDEA_ID = 51189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51189Service() {
        this(new Idea51189Config());
    }

    public Idea51189Service(Idea51189Config config) {
        this.config = config != null ? config : new Idea51189Config();
