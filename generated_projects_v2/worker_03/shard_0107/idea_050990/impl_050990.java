...
@Data
public class Idea50990Config {
    private String name = "idea_050990";
 ...
 */
@Slf4j
public class Idea50990Service {
    private static final int IDEA_ID = 50990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50990Service() {
        this(new Idea50990Config());
    }

    public Idea50990Service(Idea50990Config config) {
        this.config = config != null ? config : new Idea50990Config();
