...
@Data
public class Idea51111Config {
    private String name = "idea_051111";
 ...
 */
@Slf4j
public class Idea51111Service {
    private static final int IDEA_ID = 51111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51111Service() {
        this(new Idea51111Config());
    }

    public Idea51111Service(Idea51111Config config) {
        this.config = config != null ? config : new Idea51111Config();
