...
@Data
public class Idea51281Config {
    private String name = "idea_051281";
 ...
 */
@Slf4j
public class Idea51281Service {
    private static final int IDEA_ID = 51281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51281Service() {
        this(new Idea51281Config());
    }

    public Idea51281Service(Idea51281Config config) {
        this.config = config != null ? config : new Idea51281Config();
