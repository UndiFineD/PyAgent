...
@Data
public class Idea51083Config {
    private String name = "idea_051083";
 ...
 */
@Slf4j
public class Idea51083Service {
    private static final int IDEA_ID = 51083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51083Service() {
        this(new Idea51083Config());
    }

    public Idea51083Service(Idea51083Config config) {
        this.config = config != null ? config : new Idea51083Config();
