...
@Data
public class Idea51114Config {
    private String name = "idea_051114";
 ...
 */
@Slf4j
public class Idea51114Service {
    private static final int IDEA_ID = 51114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51114Service() {
        this(new Idea51114Config());
    }

    public Idea51114Service(Idea51114Config config) {
        this.config = config != null ? config : new Idea51114Config();
