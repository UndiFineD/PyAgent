...
@Data
public class Idea50889Config {
    private String name = "idea_050889";
 ...
 */
@Slf4j
public class Idea50889Service {
    private static final int IDEA_ID = 50889;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50889Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50889Service() {
        this(new Idea50889Config());
    }

    public Idea50889Service(Idea50889Config config) {
        this.config = config != null ? config : new Idea50889Config();
