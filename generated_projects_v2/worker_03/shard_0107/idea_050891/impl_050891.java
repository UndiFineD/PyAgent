...
@Data
public class Idea50891Config {
    private String name = "idea_050891";
 ...
 */
@Slf4j
public class Idea50891Service {
    private static final int IDEA_ID = 50891;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50891Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50891Service() {
        this(new Idea50891Config());
    }

    public Idea50891Service(Idea50891Config config) {
        this.config = config != null ? config : new Idea50891Config();
