...
@Data
public class Idea51231Config {
    private String name = "idea_051231";
 ...
 */
@Slf4j
public class Idea51231Service {
    private static final int IDEA_ID = 51231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51231Service() {
        this(new Idea51231Config());
    }

    public Idea51231Service(Idea51231Config config) {
        this.config = config != null ? config : new Idea51231Config();
