...
@Data
public class Idea50905Config {
    private String name = "idea_050905";
 ...
 */
@Slf4j
public class Idea50905Service {
    private static final int IDEA_ID = 50905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50905Service() {
        this(new Idea50905Config());
    }

    public Idea50905Service(Idea50905Config config) {
        this.config = config != null ? config : new Idea50905Config();
