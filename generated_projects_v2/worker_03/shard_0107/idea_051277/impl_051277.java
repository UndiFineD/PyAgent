...
@Data
public class Idea51277Config {
    private String name = "idea_051277";
 ...
 */
@Slf4j
public class Idea51277Service {
    private static final int IDEA_ID = 51277;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51277Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51277Service() {
        this(new Idea51277Config());
    }

    public Idea51277Service(Idea51277Config config) {
        this.config = config != null ? config : new Idea51277Config();
