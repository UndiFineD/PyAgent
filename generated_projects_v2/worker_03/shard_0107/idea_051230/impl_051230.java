...
@Data
public class Idea51230Config {
    private String name = "idea_051230";
 ...
 */
@Slf4j
public class Idea51230Service {
    private static final int IDEA_ID = 51230;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51230Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51230Service() {
        this(new Idea51230Config());
    }

    public Idea51230Service(Idea51230Config config) {
        this.config = config != null ? config : new Idea51230Config();
