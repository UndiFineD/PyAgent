...
@Data
public class Idea50826Config {
    private String name = "idea_050826";
 ...
 */
@Slf4j
public class Idea50826Service {
    private static final int IDEA_ID = 50826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50826Service() {
        this(new Idea50826Config());
    }

    public Idea50826Service(Idea50826Config config) {
        this.config = config != null ? config : new Idea50826Config();
