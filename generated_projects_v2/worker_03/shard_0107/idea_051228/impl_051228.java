...
@Data
public class Idea51228Config {
    private String name = "idea_051228";
 ...
 */
@Slf4j
public class Idea51228Service {
    private static final int IDEA_ID = 51228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51228Service() {
        this(new Idea51228Config());
    }

    public Idea51228Service(Idea51228Config config) {
        this.config = config != null ? config : new Idea51228Config();
