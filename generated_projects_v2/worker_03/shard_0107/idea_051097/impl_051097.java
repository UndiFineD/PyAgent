...
@Data
public class Idea51097Config {
    private String name = "idea_051097";
 ...
 */
@Slf4j
public class Idea51097Service {
    private static final int IDEA_ID = 51097;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51097Service() {
        this(new Idea51097Config());
    }

    public Idea51097Service(Idea51097Config config) {
        this.config = config != null ? config : new Idea51097Config();
