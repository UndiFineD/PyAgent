...
@Data
public class Idea51259Config {
    private String name = "idea_051259";
 ...
 */
@Slf4j
public class Idea51259Service {
    private static final int IDEA_ID = 51259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51259Service() {
        this(new Idea51259Config());
    }

    public Idea51259Service(Idea51259Config config) {
        this.config = config != null ? config : new Idea51259Config();
