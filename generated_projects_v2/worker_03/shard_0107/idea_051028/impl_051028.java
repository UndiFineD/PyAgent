...
@Data
public class Idea51028Config {
    private String name = "idea_051028";
 ...
 */
@Slf4j
public class Idea51028Service {
    private static final int IDEA_ID = 51028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51028Service() {
        this(new Idea51028Config());
    }

    public Idea51028Service(Idea51028Config config) {
        this.config = config != null ? config : new Idea51028Config();
