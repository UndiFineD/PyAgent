...
@Data
public class Idea50950Config {
    private String name = "idea_050950";
 ...
 */
@Slf4j
public class Idea50950Service {
    private static final int IDEA_ID = 50950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50950Service() {
        this(new Idea50950Config());
    }

    public Idea50950Service(Idea50950Config config) {
        this.config = config != null ? config : new Idea50950Config();
