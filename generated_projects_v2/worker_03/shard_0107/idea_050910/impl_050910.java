...
@Data
public class Idea50910Config {
    private String name = "idea_050910";
 ...
 */
@Slf4j
public class Idea50910Service {
    private static final int IDEA_ID = 50910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50910Service() {
        this(new Idea50910Config());
    }

    public Idea50910Service(Idea50910Config config) {
        this.config = config != null ? config : new Idea50910Config();
