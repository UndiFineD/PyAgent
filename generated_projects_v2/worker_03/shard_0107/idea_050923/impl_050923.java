...
@Data
public class Idea50923Config {
    private String name = "idea_050923";
 ...
 */
@Slf4j
public class Idea50923Service {
    private static final int IDEA_ID = 50923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50923Service() {
        this(new Idea50923Config());
    }

    public Idea50923Service(Idea50923Config config) {
        this.config = config != null ? config : new Idea50923Config();
