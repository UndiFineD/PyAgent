...
@Data
public class Idea51135Config {
    private String name = "idea_051135";
 ...
 */
@Slf4j
public class Idea51135Service {
    private static final int IDEA_ID = 51135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51135Service() {
        this(new Idea51135Config());
    }

    public Idea51135Service(Idea51135Config config) {
        this.config = config != null ? config : new Idea51135Config();
