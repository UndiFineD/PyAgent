...
@Data
public class Idea51121Config {
    private String name = "idea_051121";
 ...
 */
@Slf4j
public class Idea51121Service {
    private static final int IDEA_ID = 51121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51121Service() {
        this(new Idea51121Config());
    }

    public Idea51121Service(Idea51121Config config) {
        this.config = config != null ? config : new Idea51121Config();
