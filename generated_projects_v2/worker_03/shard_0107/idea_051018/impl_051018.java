...
@Data
public class Idea51018Config {
    private String name = "idea_051018";
 ...
 */
@Slf4j
public class Idea51018Service {
    private static final int IDEA_ID = 51018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51018Service() {
        this(new Idea51018Config());
    }

    public Idea51018Service(Idea51018Config config) {
        this.config = config != null ? config : new Idea51018Config();
