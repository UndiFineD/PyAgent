...
@Data
public class Idea51004Config {
    private String name = "idea_051004";
 ...
 */
@Slf4j
public class Idea51004Service {
    private static final int IDEA_ID = 51004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51004Service() {
        this(new Idea51004Config());
    }

    public Idea51004Service(Idea51004Config config) {
        this.config = config != null ? config : new Idea51004Config();
