...
@Data
public class Idea50967Config {
    private String name = "idea_050967";
 ...
 */
@Slf4j
public class Idea50967Service {
    private static final int IDEA_ID = 50967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50967Service() {
        this(new Idea50967Config());
    }

    public Idea50967Service(Idea50967Config config) {
        this.config = config != null ? config : new Idea50967Config();
