...
@Data
public class Idea50956Config {
    private String name = "idea_050956";
 ...
 */
@Slf4j
public class Idea50956Service {
    private static final int IDEA_ID = 50956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50956Service() {
        this(new Idea50956Config());
    }

    public Idea50956Service(Idea50956Config config) {
        this.config = config != null ? config : new Idea50956Config();
