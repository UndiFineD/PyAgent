...
@Data
public class Idea50918Config {
    private String name = "idea_050918";
 ...
 */
@Slf4j
public class Idea50918Service {
    private static final int IDEA_ID = 50918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50918Service() {
        this(new Idea50918Config());
    }

    public Idea50918Service(Idea50918Config config) {
        this.config = config != null ? config : new Idea50918Config();
