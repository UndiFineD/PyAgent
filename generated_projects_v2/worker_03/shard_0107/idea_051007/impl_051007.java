...
@Data
public class Idea51007Config {
    private String name = "idea_051007";
 ...
 */
@Slf4j
public class Idea51007Service {
    private static final int IDEA_ID = 51007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51007Service() {
        this(new Idea51007Config());
    }

    public Idea51007Service(Idea51007Config config) {
        this.config = config != null ? config : new Idea51007Config();
