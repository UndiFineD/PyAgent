...
@Data
public class Idea51265Config {
    private String name = "idea_051265";
 ...
 */
@Slf4j
public class Idea51265Service {
    private static final int IDEA_ID = 51265;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51265Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51265Service() {
        this(new Idea51265Config());
    }

    public Idea51265Service(Idea51265Config config) {
        this.config = config != null ? config : new Idea51265Config();
