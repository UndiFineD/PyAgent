...
@Data
public class Idea51023Config {
    private String name = "idea_051023";
 ...
 */
@Slf4j
public class Idea51023Service {
    private static final int IDEA_ID = 51023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51023Service() {
        this(new Idea51023Config());
    }

    public Idea51023Service(Idea51023Config config) {
        this.config = config != null ? config : new Idea51023Config();
