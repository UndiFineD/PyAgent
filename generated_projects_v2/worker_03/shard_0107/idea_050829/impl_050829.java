...
@Data
public class Idea50829Config {
    private String name = "idea_050829";
 ...
 */
@Slf4j
public class Idea50829Service {
    private static final int IDEA_ID = 50829;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50829Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50829Service() {
        this(new Idea50829Config());
    }

    public Idea50829Service(Idea50829Config config) {
        this.config = config != null ? config : new Idea50829Config();
