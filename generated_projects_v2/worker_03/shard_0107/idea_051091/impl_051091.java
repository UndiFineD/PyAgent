...
@Data
public class Idea51091Config {
    private String name = "idea_051091";
 ...
 */
@Slf4j
public class Idea51091Service {
    private static final int IDEA_ID = 51091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51091Service() {
        this(new Idea51091Config());
    }

    public Idea51091Service(Idea51091Config config) {
        this.config = config != null ? config : new Idea51091Config();
