...
@Data
public class Idea51185Config {
    private String name = "idea_051185";
 ...
 */
@Slf4j
public class Idea51185Service {
    private static final int IDEA_ID = 51185;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51185Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51185Service() {
        this(new Idea51185Config());
    }

    public Idea51185Service(Idea51185Config config) {
        this.config = config != null ? config : new Idea51185Config();
