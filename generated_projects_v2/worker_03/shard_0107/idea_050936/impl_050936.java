...
@Data
public class Idea50936Config {
    private String name = "idea_050936";
 ...
 */
@Slf4j
public class Idea50936Service {
    private static final int IDEA_ID = 50936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50936Service() {
        this(new Idea50936Config());
    }

    public Idea50936Service(Idea50936Config config) {
        this.config = config != null ? config : new Idea50936Config();
