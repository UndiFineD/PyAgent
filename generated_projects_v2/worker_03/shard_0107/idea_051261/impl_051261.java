...
@Data
public class Idea51261Config {
    private String name = "idea_051261";
 ...
 */
@Slf4j
public class Idea51261Service {
    private static final int IDEA_ID = 51261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51261Service() {
        this(new Idea51261Config());
    }

    public Idea51261Service(Idea51261Config config) {
        this.config = config != null ? config : new Idea51261Config();
