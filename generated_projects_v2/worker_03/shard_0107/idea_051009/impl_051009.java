...
@Data
public class Idea51009Config {
    private String name = "idea_051009";
 ...
 */
@Slf4j
public class Idea51009Service {
    private static final int IDEA_ID = 51009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51009Service() {
        this(new Idea51009Config());
    }

    public Idea51009Service(Idea51009Config config) {
        this.config = config != null ? config : new Idea51009Config();
