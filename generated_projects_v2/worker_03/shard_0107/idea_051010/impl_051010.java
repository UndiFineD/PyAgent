...
@Data
public class Idea51010Config {
    private String name = "idea_051010";
 ...
 */
@Slf4j
public class Idea51010Service {
    private static final int IDEA_ID = 51010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51010Service() {
        this(new Idea51010Config());
    }

    public Idea51010Service(Idea51010Config config) {
        this.config = config != null ? config : new Idea51010Config();
