...
@Data
public class Idea51274Config {
    private String name = "idea_051274";
 ...
 */
@Slf4j
public class Idea51274Service {
    private static final int IDEA_ID = 51274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51274Service() {
        this(new Idea51274Config());
    }

    public Idea51274Service(Idea51274Config config) {
        this.config = config != null ? config : new Idea51274Config();
