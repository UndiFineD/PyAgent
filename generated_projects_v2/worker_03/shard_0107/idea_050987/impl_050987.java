...
@Data
public class Idea50987Config {
    private String name = "idea_050987";
 ...
 */
@Slf4j
public class Idea50987Service {
    private static final int IDEA_ID = 50987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50987Service() {
        this(new Idea50987Config());
    }

    public Idea50987Service(Idea50987Config config) {
        this.config = config != null ? config : new Idea50987Config();
