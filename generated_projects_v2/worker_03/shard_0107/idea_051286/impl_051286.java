...
@Data
public class Idea51286Config {
    private String name = "idea_051286";
 ...
 */
@Slf4j
public class Idea51286Service {
    private static final int IDEA_ID = 51286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51286Service() {
        this(new Idea51286Config());
    }

    public Idea51286Service(Idea51286Config config) {
        this.config = config != null ? config : new Idea51286Config();
