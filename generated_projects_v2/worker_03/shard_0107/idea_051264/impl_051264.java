...
@Data
public class Idea51264Config {
    private String name = "idea_051264";
 ...
 */
@Slf4j
public class Idea51264Service {
    private static final int IDEA_ID = 51264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51264Service() {
        this(new Idea51264Config());
    }

    public Idea51264Service(Idea51264Config config) {
        this.config = config != null ? config : new Idea51264Config();
