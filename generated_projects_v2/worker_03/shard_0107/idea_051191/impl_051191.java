...
@Data
public class Idea51191Config {
    private String name = "idea_051191";
 ...
 */
@Slf4j
public class Idea51191Service {
    private static final int IDEA_ID = 51191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51191Service() {
        this(new Idea51191Config());
    }

    public Idea51191Service(Idea51191Config config) {
        this.config = config != null ? config : new Idea51191Config();
