...
@Data
public class Idea51258Config {
    private String name = "idea_051258";
 ...
 */
@Slf4j
public class Idea51258Service {
    private static final int IDEA_ID = 51258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51258Service() {
        this(new Idea51258Config());
    }

    public Idea51258Service(Idea51258Config config) {
        this.config = config != null ? config : new Idea51258Config();
