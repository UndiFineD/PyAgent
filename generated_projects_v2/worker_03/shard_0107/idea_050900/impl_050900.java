...
@Data
public class Idea50900Config {
    private String name = "idea_050900";
 ...
 */
@Slf4j
public class Idea50900Service {
    private static final int IDEA_ID = 50900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50900Service() {
        this(new Idea50900Config());
    }

    public Idea50900Service(Idea50900Config config) {
        this.config = config != null ? config : new Idea50900Config();
