...
@Data
public class Idea51027Config {
    private String name = "idea_051027";
 ...
 */
@Slf4j
public class Idea51027Service {
    private static final int IDEA_ID = 51027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51027Service() {
        this(new Idea51027Config());
    }

    public Idea51027Service(Idea51027Config config) {
        this.config = config != null ? config : new Idea51027Config();
