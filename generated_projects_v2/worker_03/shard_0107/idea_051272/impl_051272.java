...
@Data
public class Idea51272Config {
    private String name = "idea_051272";
 ...
 */
@Slf4j
public class Idea51272Service {
    private static final int IDEA_ID = 51272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51272Service() {
        this(new Idea51272Config());
    }

    public Idea51272Service(Idea51272Config config) {
        this.config = config != null ? config : new Idea51272Config();
