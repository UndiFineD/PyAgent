...
@Data
public class Idea51098Config {
    private String name = "idea_051098";
 ...
 */
@Slf4j
public class Idea51098Service {
    private static final int IDEA_ID = 51098;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51098Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51098Service() {
        this(new Idea51098Config());
    }

    public Idea51098Service(Idea51098Config config) {
        this.config = config != null ? config : new Idea51098Config();
