...
@Data
public class Idea51238Config {
    private String name = "idea_051238";
 ...
 */
@Slf4j
public class Idea51238Service {
    private static final int IDEA_ID = 51238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51238Service() {
        this(new Idea51238Config());
    }

    public Idea51238Service(Idea51238Config config) {
        this.config = config != null ? config : new Idea51238Config();
