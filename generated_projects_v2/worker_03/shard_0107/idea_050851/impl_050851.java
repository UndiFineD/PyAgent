...
@Data
public class Idea50851Config {
    private String name = "idea_050851";
 ...
 */
@Slf4j
public class Idea50851Service {
    private static final int IDEA_ID = 50851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50851Service() {
        this(new Idea50851Config());
    }

    public Idea50851Service(Idea50851Config config) {
        this.config = config != null ? config : new Idea50851Config();
