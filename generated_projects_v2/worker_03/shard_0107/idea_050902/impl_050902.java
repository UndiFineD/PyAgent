...
@Data
public class Idea50902Config {
    private String name = "idea_050902";
 ...
 */
@Slf4j
public class Idea50902Service {
    private static final int IDEA_ID = 50902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50902Service() {
        this(new Idea50902Config());
    }

    public Idea50902Service(Idea50902Config config) {
        this.config = config != null ? config : new Idea50902Config();
