...
@Data
public class Idea51115Config {
    private String name = "idea_051115";
 ...
 */
@Slf4j
public class Idea51115Service {
    private static final int IDEA_ID = 51115;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51115Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51115Service() {
        this(new Idea51115Config());
    }

    public Idea51115Service(Idea51115Config config) {
        this.config = config != null ? config : new Idea51115Config();
