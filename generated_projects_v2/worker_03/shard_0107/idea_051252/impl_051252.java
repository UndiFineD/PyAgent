...
@Data
public class Idea51252Config {
    private String name = "idea_051252";
 ...
 */
@Slf4j
public class Idea51252Service {
    private static final int IDEA_ID = 51252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51252Service() {
        this(new Idea51252Config());
    }

    public Idea51252Service(Idea51252Config config) {
        this.config = config != null ? config : new Idea51252Config();
