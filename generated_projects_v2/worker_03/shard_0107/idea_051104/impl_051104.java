...
@Data
public class Idea51104Config {
    private String name = "idea_051104";
 ...
 */
@Slf4j
public class Idea51104Service {
    private static final int IDEA_ID = 51104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51104Service() {
        this(new Idea51104Config());
    }

    public Idea51104Service(Idea51104Config config) {
        this.config = config != null ? config : new Idea51104Config();
