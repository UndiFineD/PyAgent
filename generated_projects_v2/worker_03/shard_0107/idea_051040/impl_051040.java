...
@Data
public class Idea51040Config {
    private String name = "idea_051040";
 ...
 */
@Slf4j
public class Idea51040Service {
    private static final int IDEA_ID = 51040;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51040Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51040Service() {
        this(new Idea51040Config());
    }

    public Idea51040Service(Idea51040Config config) {
        this.config = config != null ? config : new Idea51040Config();
