...
@Data
public class Idea50991Config {
    private String name = "idea_050991";
 ...
 */
@Slf4j
public class Idea50991Service {
    private static final int IDEA_ID = 50991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50991Service() {
        this(new Idea50991Config());
    }

    public Idea50991Service(Idea50991Config config) {
        this.config = config != null ? config : new Idea50991Config();
