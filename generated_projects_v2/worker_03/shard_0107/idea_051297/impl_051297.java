...
@Data
public class Idea51297Config {
    private String name = "idea_051297";
 ...
 */
@Slf4j
public class Idea51297Service {
    private static final int IDEA_ID = 51297;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51297Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51297Service() {
        this(new Idea51297Config());
    }

    public Idea51297Service(Idea51297Config config) {
        this.config = config != null ? config : new Idea51297Config();
