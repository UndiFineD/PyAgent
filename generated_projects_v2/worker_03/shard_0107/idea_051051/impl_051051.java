...
@Data
public class Idea51051Config {
    private String name = "idea_051051";
 ...
 */
@Slf4j
public class Idea51051Service {
    private static final int IDEA_ID = 51051;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51051Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51051Service() {
        this(new Idea51051Config());
    }

    public Idea51051Service(Idea51051Config config) {
        this.config = config != null ? config : new Idea51051Config();
