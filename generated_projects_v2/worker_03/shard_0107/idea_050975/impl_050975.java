...
@Data
public class Idea50975Config {
    private String name = "idea_050975";
 ...
 */
@Slf4j
public class Idea50975Service {
    private static final int IDEA_ID = 50975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50975Service() {
        this(new Idea50975Config());
    }

    public Idea50975Service(Idea50975Config config) {
        this.config = config != null ? config : new Idea50975Config();
