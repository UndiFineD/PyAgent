...
@Data
public class Idea51047Config {
    private String name = "idea_051047";
 ...
 */
@Slf4j
public class Idea51047Service {
    private static final int IDEA_ID = 51047;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51047Service() {
        this(new Idea51047Config());
    }

    public Idea51047Service(Idea51047Config config) {
        this.config = config != null ? config : new Idea51047Config();
