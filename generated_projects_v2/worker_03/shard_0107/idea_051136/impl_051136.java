...
@Data
public class Idea51136Config {
    private String name = "idea_051136";
 ...
 */
@Slf4j
public class Idea51136Service {
    private static final int IDEA_ID = 51136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51136Service() {
        this(new Idea51136Config());
    }

    public Idea51136Service(Idea51136Config config) {
        this.config = config != null ? config : new Idea51136Config();
