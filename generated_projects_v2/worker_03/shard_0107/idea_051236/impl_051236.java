...
@Data
public class Idea51236Config {
    private String name = "idea_051236";
 ...
 */
@Slf4j
public class Idea51236Service {
    private static final int IDEA_ID = 51236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51236Service() {
        this(new Idea51236Config());
    }

    public Idea51236Service(Idea51236Config config) {
        this.config = config != null ? config : new Idea51236Config();
