...
@Data
public class Idea50946Config {
    private String name = "idea_050946";
 ...
 */
@Slf4j
public class Idea50946Service {
    private static final int IDEA_ID = 50946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50946Service() {
        this(new Idea50946Config());
    }

    public Idea50946Service(Idea50946Config config) {
        this.config = config != null ? config : new Idea50946Config();
