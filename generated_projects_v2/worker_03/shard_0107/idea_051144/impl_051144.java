...
@Data
public class Idea51144Config {
    private String name = "idea_051144";
 ...
 */
@Slf4j
public class Idea51144Service {
    private static final int IDEA_ID = 51144;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51144Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51144Service() {
        this(new Idea51144Config());
    }

    public Idea51144Service(Idea51144Config config) {
        this.config = config != null ? config : new Idea51144Config();
