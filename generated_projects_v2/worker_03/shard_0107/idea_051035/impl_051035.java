...
@Data
public class Idea51035Config {
    private String name = "idea_051035";
 ...
 */
@Slf4j
public class Idea51035Service {
    private static final int IDEA_ID = 51035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51035Service() {
        this(new Idea51035Config());
    }

    public Idea51035Service(Idea51035Config config) {
        this.config = config != null ? config : new Idea51035Config();
