...
@Data
public class Idea50925Config {
    private String name = "idea_050925";
 ...
 */
@Slf4j
public class Idea50925Service {
    private static final int IDEA_ID = 50925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50925Service() {
        this(new Idea50925Config());
    }

    public Idea50925Service(Idea50925Config config) {
        this.config = config != null ? config : new Idea50925Config();
