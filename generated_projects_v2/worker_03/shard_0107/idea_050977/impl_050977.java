...
@Data
public class Idea50977Config {
    private String name = "idea_050977";
 ...
 */
@Slf4j
public class Idea50977Service {
    private static final int IDEA_ID = 50977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50977Service() {
        this(new Idea50977Config());
    }

    public Idea50977Service(Idea50977Config config) {
        this.config = config != null ? config : new Idea50977Config();
