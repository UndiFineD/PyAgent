...
@Data
public class Idea51251Config {
    private String name = "idea_051251";
 ...
 */
@Slf4j
public class Idea51251Service {
    private static final int IDEA_ID = 51251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51251Service() {
        this(new Idea51251Config());
    }

    public Idea51251Service(Idea51251Config config) {
        this.config = config != null ? config : new Idea51251Config();
