...
@Data
public class Idea51153Config {
    private String name = "idea_051153";
 ...
 */
@Slf4j
public class Idea51153Service {
    private static final int IDEA_ID = 51153;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51153Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51153Service() {
        this(new Idea51153Config());
    }

    public Idea51153Service(Idea51153Config config) {
        this.config = config != null ? config : new Idea51153Config();
