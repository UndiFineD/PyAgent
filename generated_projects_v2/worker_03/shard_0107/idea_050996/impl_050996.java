...
@Data
public class Idea50996Config {
    private String name = "idea_050996";
 ...
 */
@Slf4j
public class Idea50996Service {
    private static final int IDEA_ID = 50996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50996Service() {
        this(new Idea50996Config());
    }

    public Idea50996Service(Idea50996Config config) {
        this.config = config != null ? config : new Idea50996Config();
