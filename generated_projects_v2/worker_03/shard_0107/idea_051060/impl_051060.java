...
@Data
public class Idea51060Config {
    private String name = "idea_051060";
 ...
 */
@Slf4j
public class Idea51060Service {
    private static final int IDEA_ID = 51060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51060Service() {
        this(new Idea51060Config());
    }

    public Idea51060Service(Idea51060Config config) {
        this.config = config != null ? config : new Idea51060Config();
