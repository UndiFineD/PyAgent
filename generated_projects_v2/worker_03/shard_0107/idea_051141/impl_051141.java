...
@Data
public class Idea51141Config {
    private String name = "idea_051141";
 ...
 */
@Slf4j
public class Idea51141Service {
    private static final int IDEA_ID = 51141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51141Service() {
        this(new Idea51141Config());
    }

    public Idea51141Service(Idea51141Config config) {
        this.config = config != null ? config : new Idea51141Config();
