...
@Data
public class Idea51003Config {
    private String name = "idea_051003";
 ...
 */
@Slf4j
public class Idea51003Service {
    private static final int IDEA_ID = 51003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51003Service() {
        this(new Idea51003Config());
    }

    public Idea51003Service(Idea51003Config config) {
        this.config = config != null ? config : new Idea51003Config();
