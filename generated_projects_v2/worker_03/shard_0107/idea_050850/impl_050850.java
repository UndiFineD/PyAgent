...
@Data
public class Idea50850Config {
    private String name = "idea_050850";
 ...
 */
@Slf4j
public class Idea50850Service {
    private static final int IDEA_ID = 50850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50850Service() {
        this(new Idea50850Config());
    }

    public Idea50850Service(Idea50850Config config) {
        this.config = config != null ? config : new Idea50850Config();
