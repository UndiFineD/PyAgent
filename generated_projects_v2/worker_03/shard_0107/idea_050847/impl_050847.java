...
@Data
public class Idea50847Config {
    private String name = "idea_050847";
 ...
 */
@Slf4j
public class Idea50847Service {
    private static final int IDEA_ID = 50847;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50847Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50847Service() {
        this(new Idea50847Config());
    }

    public Idea50847Service(Idea50847Config config) {
        this.config = config != null ? config : new Idea50847Config();
