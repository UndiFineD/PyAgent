...
@Data
public class Idea51014Config {
    private String name = "idea_051014";
 ...
 */
@Slf4j
public class Idea51014Service {
    private static final int IDEA_ID = 51014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51014Service() {
        this(new Idea51014Config());
    }

    public Idea51014Service(Idea51014Config config) {
        this.config = config != null ? config : new Idea51014Config();
