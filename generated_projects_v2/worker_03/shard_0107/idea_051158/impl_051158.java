...
@Data
public class Idea51158Config {
    private String name = "idea_051158";
 ...
 */
@Slf4j
public class Idea51158Service {
    private static final int IDEA_ID = 51158;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51158Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51158Service() {
        this(new Idea51158Config());
    }

    public Idea51158Service(Idea51158Config config) {
        this.config = config != null ? config : new Idea51158Config();
