...
@Data
public class Idea51113Config {
    private String name = "idea_051113";
 ...
 */
@Slf4j
public class Idea51113Service {
    private static final int IDEA_ID = 51113;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51113Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51113Service() {
        this(new Idea51113Config());
    }

    public Idea51113Service(Idea51113Config config) {
        this.config = config != null ? config : new Idea51113Config();
