...
@Data
public class Idea51170Config {
    private String name = "idea_051170";
 ...
 */
@Slf4j
public class Idea51170Service {
    private static final int IDEA_ID = 51170;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51170Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51170Service() {
        this(new Idea51170Config());
    }

    public Idea51170Service(Idea51170Config config) {
        this.config = config != null ? config : new Idea51170Config();
