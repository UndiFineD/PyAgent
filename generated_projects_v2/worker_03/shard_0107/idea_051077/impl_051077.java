...
@Data
public class Idea51077Config {
    private String name = "idea_051077";
 ...
 */
@Slf4j
public class Idea51077Service {
    private static final int IDEA_ID = 51077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51077Service() {
        this(new Idea51077Config());
    }

    public Idea51077Service(Idea51077Config config) {
        this.config = config != null ? config : new Idea51077Config();
