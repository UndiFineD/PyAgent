...
@Data
public class Idea51200Config {
    private String name = "idea_051200";
 ...
 */
@Slf4j
public class Idea51200Service {
    private static final int IDEA_ID = 51200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51200Service() {
        this(new Idea51200Config());
    }

    public Idea51200Service(Idea51200Config config) {
        this.config = config != null ? config : new Idea51200Config();
