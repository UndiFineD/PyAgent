...
@Data
public class Idea51180Config {
    private String name = "idea_051180";
 ...
 */
@Slf4j
public class Idea51180Service {
    private static final int IDEA_ID = 51180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51180Service() {
        this(new Idea51180Config());
    }

    public Idea51180Service(Idea51180Config config) {
        this.config = config != null ? config : new Idea51180Config();
