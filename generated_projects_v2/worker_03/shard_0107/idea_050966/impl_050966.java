...
@Data
public class Idea50966Config {
    private String name = "idea_050966";
 ...
 */
@Slf4j
public class Idea50966Service {
    private static final int IDEA_ID = 50966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50966Service() {
        this(new Idea50966Config());
    }

    public Idea50966Service(Idea50966Config config) {
        this.config = config != null ? config : new Idea50966Config();
