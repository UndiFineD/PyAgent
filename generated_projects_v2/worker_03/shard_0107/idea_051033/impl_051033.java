...
@Data
public class Idea51033Config {
    private String name = "idea_051033";
 ...
 */
@Slf4j
public class Idea51033Service {
    private static final int IDEA_ID = 51033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51033Service() {
        this(new Idea51033Config());
    }

    public Idea51033Service(Idea51033Config config) {
        this.config = config != null ? config : new Idea51033Config();
