...
@Data
public class Idea51138Config {
    private String name = "idea_051138";
 ...
 */
@Slf4j
public class Idea51138Service {
    private static final int IDEA_ID = 51138;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51138Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51138Service() {
        this(new Idea51138Config());
    }

    public Idea51138Service(Idea51138Config config) {
        this.config = config != null ? config : new Idea51138Config();
