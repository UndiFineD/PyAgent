...
@Data
public class Idea50833Config {
    private String name = "idea_050833";
 ...
 */
@Slf4j
public class Idea50833Service {
    private static final int IDEA_ID = 50833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50833Service() {
        this(new Idea50833Config());
    }

    public Idea50833Service(Idea50833Config config) {
        this.config = config != null ? config : new Idea50833Config();
