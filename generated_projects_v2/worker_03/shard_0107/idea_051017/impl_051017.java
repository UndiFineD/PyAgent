...
@Data
public class Idea51017Config {
    private String name = "idea_051017";
 ...
 */
@Slf4j
public class Idea51017Service {
    private static final int IDEA_ID = 51017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51017Service() {
        this(new Idea51017Config());
    }

    public Idea51017Service(Idea51017Config config) {
        this.config = config != null ? config : new Idea51017Config();
