...
@Data
public class Idea51080Config {
    private String name = "idea_051080";
 ...
 */
@Slf4j
public class Idea51080Service {
    private static final int IDEA_ID = 51080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51080Service() {
        this(new Idea51080Config());
    }

    public Idea51080Service(Idea51080Config config) {
        this.config = config != null ? config : new Idea51080Config();
