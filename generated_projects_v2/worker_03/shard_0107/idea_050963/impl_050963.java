...
@Data
public class Idea50963Config {
    private String name = "idea_050963";
 ...
 */
@Slf4j
public class Idea50963Service {
    private static final int IDEA_ID = 50963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50963Service() {
        this(new Idea50963Config());
    }

    public Idea50963Service(Idea50963Config config) {
        this.config = config != null ? config : new Idea50963Config();
