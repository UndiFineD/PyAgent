...
@Data
public class Idea51211Config {
    private String name = "idea_051211";
 ...
 */
@Slf4j
public class Idea51211Service {
    private static final int IDEA_ID = 51211;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51211Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51211Service() {
        this(new Idea51211Config());
    }

    public Idea51211Service(Idea51211Config config) {
        this.config = config != null ? config : new Idea51211Config();
