...
@Data
public class Idea51247Config {
    private String name = "idea_051247";
 ...
 */
@Slf4j
public class Idea51247Service {
    private static final int IDEA_ID = 51247;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51247Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51247Service() {
        this(new Idea51247Config());
    }

    public Idea51247Service(Idea51247Config config) {
        this.config = config != null ? config : new Idea51247Config();
