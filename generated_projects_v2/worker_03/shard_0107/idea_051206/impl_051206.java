...
@Data
public class Idea51206Config {
    private String name = "idea_051206";
 ...
 */
@Slf4j
public class Idea51206Service {
    private static final int IDEA_ID = 51206;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51206Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51206Service() {
        this(new Idea51206Config());
    }

    public Idea51206Service(Idea51206Config config) {
        this.config = config != null ? config : new Idea51206Config();
