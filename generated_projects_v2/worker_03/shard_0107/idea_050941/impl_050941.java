...
@Data
public class Idea50941Config {
    private String name = "idea_050941";
 ...
 */
@Slf4j
public class Idea50941Service {
    private static final int IDEA_ID = 50941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50941Service() {
        this(new Idea50941Config());
    }

    public Idea50941Service(Idea50941Config config) {
        this.config = config != null ? config : new Idea50941Config();
