...
@Data
public class Idea51082Config {
    private String name = "idea_051082";
 ...
 */
@Slf4j
public class Idea51082Service {
    private static final int IDEA_ID = 51082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51082Service() {
        this(new Idea51082Config());
    }

    public Idea51082Service(Idea51082Config config) {
        this.config = config != null ? config : new Idea51082Config();
