...
@Data
public class Idea50921Config {
    private String name = "idea_050921";
 ...
 */
@Slf4j
public class Idea50921Service {
    private static final int IDEA_ID = 50921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50921Service() {
        this(new Idea50921Config());
    }

    public Idea50921Service(Idea50921Config config) {
        this.config = config != null ? config : new Idea50921Config();
