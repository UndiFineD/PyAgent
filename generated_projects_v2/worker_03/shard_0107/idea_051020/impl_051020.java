...
@Data
public class Idea51020Config {
    private String name = "idea_051020";
 ...
 */
@Slf4j
public class Idea51020Service {
    private static final int IDEA_ID = 51020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51020Service() {
        this(new Idea51020Config());
    }

    public Idea51020Service(Idea51020Config config) {
        this.config = config != null ? config : new Idea51020Config();
