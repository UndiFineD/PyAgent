...
@Data
public class Idea51255Config {
    private String name = "idea_051255";
 ...
 */
@Slf4j
public class Idea51255Service {
    private static final int IDEA_ID = 51255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51255Service() {
        this(new Idea51255Config());
    }

    public Idea51255Service(Idea51255Config config) {
        this.config = config != null ? config : new Idea51255Config();
