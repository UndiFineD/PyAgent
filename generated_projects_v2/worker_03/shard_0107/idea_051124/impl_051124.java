...
@Data
public class Idea51124Config {
    private String name = "idea_051124";
 ...
 */
@Slf4j
public class Idea51124Service {
    private static final int IDEA_ID = 51124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51124Service() {
        this(new Idea51124Config());
    }

    public Idea51124Service(Idea51124Config config) {
        this.config = config != null ? config : new Idea51124Config();
