...
@Data
public class Idea51202Config {
    private String name = "idea_051202";
 ...
 */
@Slf4j
public class Idea51202Service {
    private static final int IDEA_ID = 51202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51202Service() {
        this(new Idea51202Config());
    }

    public Idea51202Service(Idea51202Config config) {
        this.config = config != null ? config : new Idea51202Config();
