...
@Data
public class Idea51209Config {
    private String name = "idea_051209";
 ...
 */
@Slf4j
public class Idea51209Service {
    private static final int IDEA_ID = 51209;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51209Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51209Service() {
        this(new Idea51209Config());
    }

    public Idea51209Service(Idea51209Config config) {
        this.config = config != null ? config : new Idea51209Config();
