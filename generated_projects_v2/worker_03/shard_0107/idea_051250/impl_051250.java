...
@Data
public class Idea51250Config {
    private String name = "idea_051250";
 ...
 */
@Slf4j
public class Idea51250Service {
    private static final int IDEA_ID = 51250;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51250Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51250Service() {
        this(new Idea51250Config());
    }

    public Idea51250Service(Idea51250Config config) {
        this.config = config != null ? config : new Idea51250Config();
