...
@Data
public class Idea50971Config {
    private String name = "idea_050971";
 ...
 */
@Slf4j
public class Idea50971Service {
    private static final int IDEA_ID = 50971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50971Service() {
        this(new Idea50971Config());
    }

    public Idea50971Service(Idea50971Config config) {
        this.config = config != null ? config : new Idea50971Config();
