...
@Data
public class Idea51128Config {
    private String name = "idea_051128";
 ...
 */
@Slf4j
public class Idea51128Service {
    private static final int IDEA_ID = 51128;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51128Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51128Service() {
        this(new Idea51128Config());
    }

    public Idea51128Service(Idea51128Config config) {
        this.config = config != null ? config : new Idea51128Config();
