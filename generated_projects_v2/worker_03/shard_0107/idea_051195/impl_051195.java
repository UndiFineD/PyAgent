...
@Data
public class Idea51195Config {
    private String name = "idea_051195";
 ...
 */
@Slf4j
public class Idea51195Service {
    private static final int IDEA_ID = 51195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51195Service() {
        this(new Idea51195Config());
    }

    public Idea51195Service(Idea51195Config config) {
        this.config = config != null ? config : new Idea51195Config();
