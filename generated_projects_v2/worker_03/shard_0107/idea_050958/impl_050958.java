...
@Data
public class Idea50958Config {
    private String name = "idea_050958";
 ...
 */
@Slf4j
public class Idea50958Service {
    private static final int IDEA_ID = 50958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50958Service() {
        this(new Idea50958Config());
    }

    public Idea50958Service(Idea50958Config config) {
        this.config = config != null ? config : new Idea50958Config();
