...
@Data
public class Idea50828Config {
    private String name = "idea_050828";
 ...
 */
@Slf4j
public class Idea50828Service {
    private static final int IDEA_ID = 50828;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50828Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50828Service() {
        this(new Idea50828Config());
    }

    public Idea50828Service(Idea50828Config config) {
        this.config = config != null ? config : new Idea50828Config();
