...
@Data
public class Idea50907Config {
    private String name = "idea_050907";
 ...
 */
@Slf4j
public class Idea50907Service {
    private static final int IDEA_ID = 50907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50907Service() {
        this(new Idea50907Config());
    }

    public Idea50907Service(Idea50907Config config) {
        this.config = config != null ? config : new Idea50907Config();
