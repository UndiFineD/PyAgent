...
@Data
public class Idea51173Config {
    private String name = "idea_051173";
 ...
 */
@Slf4j
public class Idea51173Service {
    private static final int IDEA_ID = 51173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51173Service() {
        this(new Idea51173Config());
    }

    public Idea51173Service(Idea51173Config config) {
        this.config = config != null ? config : new Idea51173Config();
