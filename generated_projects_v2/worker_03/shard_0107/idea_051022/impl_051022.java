...
@Data
public class Idea51022Config {
    private String name = "idea_051022";
 ...
 */
@Slf4j
public class Idea51022Service {
    private static final int IDEA_ID = 51022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51022Service() {
        this(new Idea51022Config());
    }

    public Idea51022Service(Idea51022Config config) {
        this.config = config != null ? config : new Idea51022Config();
