...
@Data
public class Idea51207Config {
    private String name = "idea_051207";
 ...
 */
@Slf4j
public class Idea51207Service {
    private static final int IDEA_ID = 51207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51207Service() {
        this(new Idea51207Config());
    }

    public Idea51207Service(Idea51207Config config) {
        this.config = config != null ? config : new Idea51207Config();
