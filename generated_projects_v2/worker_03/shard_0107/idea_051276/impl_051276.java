...
@Data
public class Idea51276Config {
    private String name = "idea_051276";
 ...
 */
@Slf4j
public class Idea51276Service {
    private static final int IDEA_ID = 51276;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51276Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51276Service() {
        this(new Idea51276Config());
    }

    public Idea51276Service(Idea51276Config config) {
        this.config = config != null ? config : new Idea51276Config();
