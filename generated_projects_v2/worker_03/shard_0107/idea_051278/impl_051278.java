...
@Data
public class Idea51278Config {
    private String name = "idea_051278";
 ...
 */
@Slf4j
public class Idea51278Service {
    private static final int IDEA_ID = 51278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51278Service() {
        this(new Idea51278Config());
    }

    public Idea51278Service(Idea51278Config config) {
        this.config = config != null ? config : new Idea51278Config();
