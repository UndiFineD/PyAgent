...
@Data
public class Idea50870Config {
    private String name = "idea_050870";
 ...
 */
@Slf4j
public class Idea50870Service {
    private static final int IDEA_ID = 50870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50870Service() {
        this(new Idea50870Config());
    }

    public Idea50870Service(Idea50870Config config) {
        this.config = config != null ? config : new Idea50870Config();
