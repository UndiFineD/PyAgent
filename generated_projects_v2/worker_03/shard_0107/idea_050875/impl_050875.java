...
@Data
public class Idea50875Config {
    private String name = "idea_050875";
 ...
 */
@Slf4j
public class Idea50875Service {
    private static final int IDEA_ID = 50875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50875Service() {
        this(new Idea50875Config());
    }

    public Idea50875Service(Idea50875Config config) {
        this.config = config != null ? config : new Idea50875Config();
