...
@Data
public class Idea51183Config {
    private String name = "idea_051183";
 ...
 */
@Slf4j
public class Idea51183Service {
    private static final int IDEA_ID = 51183;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51183Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51183Service() {
        this(new Idea51183Config());
    }

    public Idea51183Service(Idea51183Config config) {
        this.config = config != null ? config : new Idea51183Config();
