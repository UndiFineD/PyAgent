...
@Data
public class Idea51071Config {
    private String name = "idea_051071";
 ...
 */
@Slf4j
public class Idea51071Service {
    private static final int IDEA_ID = 51071;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51071Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51071Service() {
        this(new Idea51071Config());
    }

    public Idea51071Service(Idea51071Config config) {
        this.config = config != null ? config : new Idea51071Config();
