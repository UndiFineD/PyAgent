...
@Data
public class Idea50825Config {
    private String name = "idea_050825";
 ...
 */
@Slf4j
public class Idea50825Service {
    private static final int IDEA_ID = 50825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50825Service() {
        this(new Idea50825Config());
    }

    public Idea50825Service(Idea50825Config config) {
        this.config = config != null ? config : new Idea50825Config();
