...
@Data
public class Idea50951Config {
    private String name = "idea_050951";
 ...
 */
@Slf4j
public class Idea50951Service {
    private static final int IDEA_ID = 50951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50951Service() {
        this(new Idea50951Config());
    }

    public Idea50951Service(Idea50951Config config) {
        this.config = config != null ? config : new Idea50951Config();
