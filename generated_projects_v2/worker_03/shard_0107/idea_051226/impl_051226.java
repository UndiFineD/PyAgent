...
@Data
public class Idea51226Config {
    private String name = "idea_051226";
 ...
 */
@Slf4j
public class Idea51226Service {
    private static final int IDEA_ID = 51226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51226Service() {
        this(new Idea51226Config());
    }

    public Idea51226Service(Idea51226Config config) {
        this.config = config != null ? config : new Idea51226Config();
