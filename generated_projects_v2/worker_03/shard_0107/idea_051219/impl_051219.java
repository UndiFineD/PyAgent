...
@Data
public class Idea51219Config {
    private String name = "idea_051219";
 ...
 */
@Slf4j
public class Idea51219Service {
    private static final int IDEA_ID = 51219;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51219Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51219Service() {
        this(new Idea51219Config());
    }

    public Idea51219Service(Idea51219Config config) {
        this.config = config != null ? config : new Idea51219Config();
