...
@Data
public class Idea51280Config {
    private String name = "idea_051280";
 ...
 */
@Slf4j
public class Idea51280Service {
    private static final int IDEA_ID = 51280;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51280Service() {
        this(new Idea51280Config());
    }

    public Idea51280Service(Idea51280Config config) {
        this.config = config != null ? config : new Idea51280Config();
