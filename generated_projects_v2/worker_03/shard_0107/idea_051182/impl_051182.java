...
@Data
public class Idea51182Config {
    private String name = "idea_051182";
 ...
 */
@Slf4j
public class Idea51182Service {
    private static final int IDEA_ID = 51182;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51182Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51182Service() {
        this(new Idea51182Config());
    }

    public Idea51182Service(Idea51182Config config) {
        this.config = config != null ? config : new Idea51182Config();
