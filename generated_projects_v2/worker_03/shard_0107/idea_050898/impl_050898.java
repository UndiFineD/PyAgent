...
@Data
public class Idea50898Config {
    private String name = "idea_050898";
 ...
 */
@Slf4j
public class Idea50898Service {
    private static final int IDEA_ID = 50898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50898Service() {
        this(new Idea50898Config());
    }

    public Idea50898Service(Idea50898Config config) {
        this.config = config != null ? config : new Idea50898Config();
