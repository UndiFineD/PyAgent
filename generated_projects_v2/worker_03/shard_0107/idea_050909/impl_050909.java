...
@Data
public class Idea50909Config {
    private String name = "idea_050909";
 ...
 */
@Slf4j
public class Idea50909Service {
    private static final int IDEA_ID = 50909;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50909Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50909Service() {
        this(new Idea50909Config());
    }

    public Idea50909Service(Idea50909Config config) {
        this.config = config != null ? config : new Idea50909Config();
