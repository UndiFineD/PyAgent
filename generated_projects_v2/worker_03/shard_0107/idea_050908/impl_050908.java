...
@Data
public class Idea50908Config {
    private String name = "idea_050908";
 ...
 */
@Slf4j
public class Idea50908Service {
    private static final int IDEA_ID = 50908;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50908Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50908Service() {
        this(new Idea50908Config());
    }

    public Idea50908Service(Idea50908Config config) {
        this.config = config != null ? config : new Idea50908Config();
