...
@Data
public class Idea51257Config {
    private String name = "idea_051257";
 ...
 */
@Slf4j
public class Idea51257Service {
    private static final int IDEA_ID = 51257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51257Service() {
        this(new Idea51257Config());
    }

    public Idea51257Service(Idea51257Config config) {
        this.config = config != null ? config : new Idea51257Config();
