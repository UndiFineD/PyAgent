...
@Data
public class Idea51161Config {
    private String name = "idea_051161";
 ...
 */
@Slf4j
public class Idea51161Service {
    private static final int IDEA_ID = 51161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51161Service() {
        this(new Idea51161Config());
    }

    public Idea51161Service(Idea51161Config config) {
        this.config = config != null ? config : new Idea51161Config();
