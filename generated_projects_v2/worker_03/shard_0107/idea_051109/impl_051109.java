...
@Data
public class Idea51109Config {
    private String name = "idea_051109";
 ...
 */
@Slf4j
public class Idea51109Service {
    private static final int IDEA_ID = 51109;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51109Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51109Service() {
        this(new Idea51109Config());
    }

    public Idea51109Service(Idea51109Config config) {
        this.config = config != null ? config : new Idea51109Config();
