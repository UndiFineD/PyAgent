...
@Data
public class Idea50836Config {
    private String name = "idea_050836";
 ...
 */
@Slf4j
public class Idea50836Service {
    private static final int IDEA_ID = 50836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50836Service() {
        this(new Idea50836Config());
    }

    public Idea50836Service(Idea50836Config config) {
        this.config = config != null ? config : new Idea50836Config();
