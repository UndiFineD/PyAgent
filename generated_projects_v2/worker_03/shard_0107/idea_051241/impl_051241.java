...
@Data
public class Idea51241Config {
    private String name = "idea_051241";
 ...
 */
@Slf4j
public class Idea51241Service {
    private static final int IDEA_ID = 51241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51241Service() {
        this(new Idea51241Config());
    }

    public Idea51241Service(Idea51241Config config) {
        this.config = config != null ? config : new Idea51241Config();
