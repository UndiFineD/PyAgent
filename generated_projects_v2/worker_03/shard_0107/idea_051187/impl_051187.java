...
@Data
public class Idea51187Config {
    private String name = "idea_051187";
 ...
 */
@Slf4j
public class Idea51187Service {
    private static final int IDEA_ID = 51187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51187Service() {
        this(new Idea51187Config());
    }

    public Idea51187Service(Idea51187Config config) {
        this.config = config != null ? config : new Idea51187Config();
