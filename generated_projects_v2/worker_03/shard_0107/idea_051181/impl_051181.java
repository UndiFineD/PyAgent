...
@Data
public class Idea51181Config {
    private String name = "idea_051181";
 ...
 */
@Slf4j
public class Idea51181Service {
    private static final int IDEA_ID = 51181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51181Service() {
        this(new Idea51181Config());
    }

    public Idea51181Service(Idea51181Config config) {
        this.config = config != null ? config : new Idea51181Config();
