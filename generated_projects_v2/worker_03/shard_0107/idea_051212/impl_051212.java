...
@Data
public class Idea51212Config {
    private String name = "idea_051212";
 ...
 */
@Slf4j
public class Idea51212Service {
    private static final int IDEA_ID = 51212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51212Service() {
        this(new Idea51212Config());
    }

    public Idea51212Service(Idea51212Config config) {
        this.config = config != null ? config : new Idea51212Config();
