...
@Data
public class Idea51271Config {
    private String name = "idea_051271";
 ...
 */
@Slf4j
public class Idea51271Service {
    private static final int IDEA_ID = 51271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51271Service() {
        this(new Idea51271Config());
    }

    public Idea51271Service(Idea51271Config config) {
        this.config = config != null ? config : new Idea51271Config();
