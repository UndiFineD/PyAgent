...
@Data
public class Idea51001Config {
    private String name = "idea_051001";
 ...
 */
@Slf4j
public class Idea51001Service {
    private static final int IDEA_ID = 51001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51001Service() {
        this(new Idea51001Config());
    }

    public Idea51001Service(Idea51001Config config) {
        this.config = config != null ? config : new Idea51001Config();
