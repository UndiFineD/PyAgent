...
@Data
public class Idea51290Config {
    private String name = "idea_051290";
 ...
 */
@Slf4j
public class Idea51290Service {
    private static final int IDEA_ID = 51290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51290Service() {
        this(new Idea51290Config());
    }

    public Idea51290Service(Idea51290Config config) {
        this.config = config != null ? config : new Idea51290Config();
