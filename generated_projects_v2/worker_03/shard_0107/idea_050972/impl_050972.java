...
@Data
public class Idea50972Config {
    private String name = "idea_050972";
 ...
 */
@Slf4j
public class Idea50972Service {
    private static final int IDEA_ID = 50972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50972Service() {
        this(new Idea50972Config());
    }

    public Idea50972Service(Idea50972Config config) {
        this.config = config != null ? config : new Idea50972Config();
