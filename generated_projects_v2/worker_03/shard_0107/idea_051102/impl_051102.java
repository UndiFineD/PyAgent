...
@Data
public class Idea51102Config {
    private String name = "idea_051102";
 ...
 */
@Slf4j
public class Idea51102Service {
    private static final int IDEA_ID = 51102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51102Service() {
        this(new Idea51102Config());
    }

    public Idea51102Service(Idea51102Config config) {
        this.config = config != null ? config : new Idea51102Config();
