...
@Data
public class Idea50893Config {
    private String name = "idea_050893";
 ...
 */
@Slf4j
public class Idea50893Service {
    private static final int IDEA_ID = 50893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50893Service() {
        this(new Idea50893Config());
    }

    public Idea50893Service(Idea50893Config config) {
        this.config = config != null ? config : new Idea50893Config();
