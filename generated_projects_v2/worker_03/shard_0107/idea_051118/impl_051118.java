...
@Data
public class Idea51118Config {
    private String name = "idea_051118";
 ...
 */
@Slf4j
public class Idea51118Service {
    private static final int IDEA_ID = 51118;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51118Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51118Service() {
        this(new Idea51118Config());
    }

    public Idea51118Service(Idea51118Config config) {
        this.config = config != null ? config : new Idea51118Config();
