...
@Data
public class Idea51117Config {
    private String name = "idea_051117";
 ...
 */
@Slf4j
public class Idea51117Service {
    private static final int IDEA_ID = 51117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51117Service() {
        this(new Idea51117Config());
    }

    public Idea51117Service(Idea51117Config config) {
        this.config = config != null ? config : new Idea51117Config();
