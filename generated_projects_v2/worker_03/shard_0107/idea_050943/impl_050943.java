...
@Data
public class Idea50943Config {
    private String name = "idea_050943";
 ...
 */
@Slf4j
public class Idea50943Service {
    private static final int IDEA_ID = 50943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea50943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea50943Service() {
        this(new Idea50943Config());
    }

    public Idea50943Service(Idea50943Config config) {
        this.config = config != null ? config : new Idea50943Config();
