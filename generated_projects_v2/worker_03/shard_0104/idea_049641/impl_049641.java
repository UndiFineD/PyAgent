...
@Data
public class Idea49641Config {
    private String name = "idea_049641";
 ...
 */
@Slf4j
public class Idea49641Service {
    private static final int IDEA_ID = 49641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49641Service() {
        this(new Idea49641Config());
    }

    public Idea49641Service(Idea49641Config config) {
        this.config = config != null ? config : new Idea49641Config();
