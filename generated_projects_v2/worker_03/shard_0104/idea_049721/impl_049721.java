...
@Data
public class Idea49721Config {
    private String name = "idea_049721";
 ...
 */
@Slf4j
public class Idea49721Service {
    private static final int IDEA_ID = 49721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49721Service() {
        this(new Idea49721Config());
    }

    public Idea49721Service(Idea49721Config config) {
        this.config = config != null ? config : new Idea49721Config();
