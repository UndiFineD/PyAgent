...
@Data
public class Idea49417Config {
    private String name = "idea_049417";
 ...
 */
@Slf4j
public class Idea49417Service {
    private static final int IDEA_ID = 49417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49417Service() {
        this(new Idea49417Config());
    }

    public Idea49417Service(Idea49417Config config) {
        this.config = config != null ? config : new Idea49417Config();
