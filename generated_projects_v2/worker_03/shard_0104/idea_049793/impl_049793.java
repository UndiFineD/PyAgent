...
@Data
public class Idea49793Config {
    private String name = "idea_049793";
 ...
 */
@Slf4j
public class Idea49793Service {
    private static final int IDEA_ID = 49793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49793Service() {
        this(new Idea49793Config());
    }

    public Idea49793Service(Idea49793Config config) {
        this.config = config != null ? config : new Idea49793Config();
