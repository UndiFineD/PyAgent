...
@Data
public class Idea49634Config {
    private String name = "idea_049634";
 ...
 */
@Slf4j
public class Idea49634Service {
    private static final int IDEA_ID = 49634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49634Service() {
        this(new Idea49634Config());
    }

    public Idea49634Service(Idea49634Config config) {
        this.config = config != null ? config : new Idea49634Config();
