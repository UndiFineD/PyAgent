...
@Data
public class Idea49695Config {
    private String name = "idea_049695";
 ...
 */
@Slf4j
public class Idea49695Service {
    private static final int IDEA_ID = 49695;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49695Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49695Service() {
        this(new Idea49695Config());
    }

    public Idea49695Service(Idea49695Config config) {
        this.config = config != null ? config : new Idea49695Config();
