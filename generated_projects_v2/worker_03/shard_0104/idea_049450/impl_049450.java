...
@Data
public class Idea49450Config {
    private String name = "idea_049450";
 ...
 */
@Slf4j
public class Idea49450Service {
    private static final int IDEA_ID = 49450;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49450Service() {
        this(new Idea49450Config());
    }

    public Idea49450Service(Idea49450Config config) {
        this.config = config != null ? config : new Idea49450Config();
