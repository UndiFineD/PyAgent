...
@Data
public class Idea49744Config {
    private String name = "idea_049744";
 ...
 */
@Slf4j
public class Idea49744Service {
    private static final int IDEA_ID = 49744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49744Service() {
        this(new Idea49744Config());
    }

    public Idea49744Service(Idea49744Config config) {
        this.config = config != null ? config : new Idea49744Config();
