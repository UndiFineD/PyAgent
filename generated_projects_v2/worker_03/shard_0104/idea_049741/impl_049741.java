...
@Data
public class Idea49741Config {
    private String name = "idea_049741";
 ...
 */
@Slf4j
public class Idea49741Service {
    private static final int IDEA_ID = 49741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49741Service() {
        this(new Idea49741Config());
    }

    public Idea49741Service(Idea49741Config config) {
        this.config = config != null ? config : new Idea49741Config();
