...
@Data
public class Idea49739Config {
    private String name = "idea_049739";
 ...
 */
@Slf4j
public class Idea49739Service {
    private static final int IDEA_ID = 49739;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49739Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49739Service() {
        this(new Idea49739Config());
    }

    public Idea49739Service(Idea49739Config config) {
        this.config = config != null ? config : new Idea49739Config();
