...
@Data
public class Idea49612Config {
    private String name = "idea_049612";
 ...
 */
@Slf4j
public class Idea49612Service {
    private static final int IDEA_ID = 49612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49612Service() {
        this(new Idea49612Config());
    }

    public Idea49612Service(Idea49612Config config) {
        this.config = config != null ? config : new Idea49612Config();
