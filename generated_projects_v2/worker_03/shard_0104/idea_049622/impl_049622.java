...
@Data
public class Idea49622Config {
    private String name = "idea_049622";
 ...
 */
@Slf4j
public class Idea49622Service {
    private static final int IDEA_ID = 49622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49622Service() {
        this(new Idea49622Config());
    }

    public Idea49622Service(Idea49622Config config) {
        this.config = config != null ? config : new Idea49622Config();
