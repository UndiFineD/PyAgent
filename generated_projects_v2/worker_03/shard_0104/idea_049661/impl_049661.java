...
@Data
public class Idea49661Config {
    private String name = "idea_049661";
 ...
 */
@Slf4j
public class Idea49661Service {
    private static final int IDEA_ID = 49661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49661Service() {
        this(new Idea49661Config());
    }

    public Idea49661Service(Idea49661Config config) {
        this.config = config != null ? config : new Idea49661Config();
