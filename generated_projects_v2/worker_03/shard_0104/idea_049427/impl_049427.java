...
@Data
public class Idea49427Config {
    private String name = "idea_049427";
 ...
 */
@Slf4j
public class Idea49427Service {
    private static final int IDEA_ID = 49427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49427Service() {
        this(new Idea49427Config());
    }

    public Idea49427Service(Idea49427Config config) {
        this.config = config != null ? config : new Idea49427Config();
