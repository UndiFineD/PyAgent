...
@Data
public class Idea49727Config {
    private String name = "idea_049727";
 ...
 */
@Slf4j
public class Idea49727Service {
    private static final int IDEA_ID = 49727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49727Service() {
        this(new Idea49727Config());
    }

    public Idea49727Service(Idea49727Config config) {
        this.config = config != null ? config : new Idea49727Config();
