...
@Data
public class Idea49412Config {
    private String name = "idea_049412";
 ...
 */
@Slf4j
public class Idea49412Service {
    private static final int IDEA_ID = 49412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49412Service() {
        this(new Idea49412Config());
    }

    public Idea49412Service(Idea49412Config config) {
        this.config = config != null ? config : new Idea49412Config();
