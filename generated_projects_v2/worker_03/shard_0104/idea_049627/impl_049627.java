...
@Data
public class Idea49627Config {
    private String name = "idea_049627";
 ...
 */
@Slf4j
public class Idea49627Service {
    private static final int IDEA_ID = 49627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49627Service() {
        this(new Idea49627Config());
    }

    public Idea49627Service(Idea49627Config config) {
        this.config = config != null ? config : new Idea49627Config();
