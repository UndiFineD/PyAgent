...
@Data
public class Idea49505Config {
    private String name = "idea_049505";
 ...
 */
@Slf4j
public class Idea49505Service {
    private static final int IDEA_ID = 49505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49505Service() {
        this(new Idea49505Config());
    }

    public Idea49505Service(Idea49505Config config) {
        this.config = config != null ? config : new Idea49505Config();
