...
@Data
public class Idea49480Config {
    private String name = "idea_049480";
 ...
 */
@Slf4j
public class Idea49480Service {
    private static final int IDEA_ID = 49480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49480Service() {
        this(new Idea49480Config());
    }

    public Idea49480Service(Idea49480Config config) {
        this.config = config != null ? config : new Idea49480Config();
