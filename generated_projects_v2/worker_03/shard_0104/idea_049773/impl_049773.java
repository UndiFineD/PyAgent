...
@Data
public class Idea49773Config {
    private String name = "idea_049773";
 ...
 */
@Slf4j
public class Idea49773Service {
    private static final int IDEA_ID = 49773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49773Service() {
        this(new Idea49773Config());
    }

    public Idea49773Service(Idea49773Config config) {
        this.config = config != null ? config : new Idea49773Config();
