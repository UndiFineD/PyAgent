...
@Data
public class Idea49425Config {
    private String name = "idea_049425";
 ...
 */
@Slf4j
public class Idea49425Service {
    private static final int IDEA_ID = 49425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49425Service() {
        this(new Idea49425Config());
    }

    public Idea49425Service(Idea49425Config config) {
        this.config = config != null ? config : new Idea49425Config();
