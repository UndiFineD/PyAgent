...
@Data
public class Idea49783Config {
    private String name = "idea_049783";
 ...
 */
@Slf4j
public class Idea49783Service {
    private static final int IDEA_ID = 49783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49783Service() {
        this(new Idea49783Config());
    }

    public Idea49783Service(Idea49783Config config) {
        this.config = config != null ? config : new Idea49783Config();
