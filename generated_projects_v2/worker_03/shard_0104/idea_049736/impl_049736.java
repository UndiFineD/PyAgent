...
@Data
public class Idea49736Config {
    private String name = "idea_049736";
 ...
 */
@Slf4j
public class Idea49736Service {
    private static final int IDEA_ID = 49736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49736Service() {
        this(new Idea49736Config());
    }

    public Idea49736Service(Idea49736Config config) {
        this.config = config != null ? config : new Idea49736Config();
