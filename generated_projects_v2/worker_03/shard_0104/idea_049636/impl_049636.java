...
@Data
public class Idea49636Config {
    private String name = "idea_049636";
 ...
 */
@Slf4j
public class Idea49636Service {
    private static final int IDEA_ID = 49636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49636Service() {
        this(new Idea49636Config());
    }

    public Idea49636Service(Idea49636Config config) {
        this.config = config != null ? config : new Idea49636Config();
