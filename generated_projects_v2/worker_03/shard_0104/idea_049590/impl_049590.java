...
@Data
public class Idea49590Config {
    private String name = "idea_049590";
 ...
 */
@Slf4j
public class Idea49590Service {
    private static final int IDEA_ID = 49590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49590Service() {
        this(new Idea49590Config());
    }

    public Idea49590Service(Idea49590Config config) {
        this.config = config != null ? config : new Idea49590Config();
