...
@Data
public class Idea49525Config {
    private String name = "idea_049525";
 ...
 */
@Slf4j
public class Idea49525Service {
    private static final int IDEA_ID = 49525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49525Service() {
        this(new Idea49525Config());
    }

    public Idea49525Service(Idea49525Config config) {
        this.config = config != null ? config : new Idea49525Config();
