...
@Data
public class Idea49547Config {
    private String name = "idea_049547";
 ...
 */
@Slf4j
public class Idea49547Service {
    private static final int IDEA_ID = 49547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49547Service() {
        this(new Idea49547Config());
    }

    public Idea49547Service(Idea49547Config config) {
        this.config = config != null ? config : new Idea49547Config();
