...
@Data
public class Idea49675Config {
    private String name = "idea_049675";
 ...
 */
@Slf4j
public class Idea49675Service {
    private static final int IDEA_ID = 49675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49675Service() {
        this(new Idea49675Config());
    }

    public Idea49675Service(Idea49675Config config) {
        this.config = config != null ? config : new Idea49675Config();
