...
@Data
public class Idea49611Config {
    private String name = "idea_049611";
 ...
 */
@Slf4j
public class Idea49611Service {
    private static final int IDEA_ID = 49611;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49611Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49611Service() {
        this(new Idea49611Config());
    }

    public Idea49611Service(Idea49611Config config) {
        this.config = config != null ? config : new Idea49611Config();
