...
@Data
public class Idea49606Config {
    private String name = "idea_049606";
 ...
 */
@Slf4j
public class Idea49606Service {
    private static final int IDEA_ID = 49606;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49606Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49606Service() {
        this(new Idea49606Config());
    }

    public Idea49606Service(Idea49606Config config) {
        this.config = config != null ? config : new Idea49606Config();
