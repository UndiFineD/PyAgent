...
@Data
public class Idea49536Config {
    private String name = "idea_049536";
 ...
 */
@Slf4j
public class Idea49536Service {
    private static final int IDEA_ID = 49536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49536Service() {
        this(new Idea49536Config());
    }

    public Idea49536Service(Idea49536Config config) {
        this.config = config != null ? config : new Idea49536Config();
