...
@Data
public class Idea49607Config {
    private String name = "idea_049607";
 ...
 */
@Slf4j
public class Idea49607Service {
    private static final int IDEA_ID = 49607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49607Service() {
        this(new Idea49607Config());
    }

    public Idea49607Service(Idea49607Config config) {
        this.config = config != null ? config : new Idea49607Config();
