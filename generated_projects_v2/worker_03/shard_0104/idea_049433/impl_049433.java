...
@Data
public class Idea49433Config {
    private String name = "idea_049433";
 ...
 */
@Slf4j
public class Idea49433Service {
    private static final int IDEA_ID = 49433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49433Service() {
        this(new Idea49433Config());
    }

    public Idea49433Service(Idea49433Config config) {
        this.config = config != null ? config : new Idea49433Config();
