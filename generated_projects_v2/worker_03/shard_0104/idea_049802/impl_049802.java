...
@Data
public class Idea49802Config {
    private String name = "idea_049802";
 ...
 */
@Slf4j
public class Idea49802Service {
    private static final int IDEA_ID = 49802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49802Service() {
        this(new Idea49802Config());
    }

    public Idea49802Service(Idea49802Config config) {
        this.config = config != null ? config : new Idea49802Config();
