...
@Data
public class Idea49825Config {
    private String name = "idea_049825";
 ...
 */
@Slf4j
public class Idea49825Service {
    private static final int IDEA_ID = 49825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49825Service() {
        this(new Idea49825Config());
    }

    public Idea49825Service(Idea49825Config config) {
        this.config = config != null ? config : new Idea49825Config();
