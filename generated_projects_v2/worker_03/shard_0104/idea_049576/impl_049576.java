...
@Data
public class Idea49576Config {
    private String name = "idea_049576";
 ...
 */
@Slf4j
public class Idea49576Service {
    private static final int IDEA_ID = 49576;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49576Service() {
        this(new Idea49576Config());
    }

    public Idea49576Service(Idea49576Config config) {
        this.config = config != null ? config : new Idea49576Config();
