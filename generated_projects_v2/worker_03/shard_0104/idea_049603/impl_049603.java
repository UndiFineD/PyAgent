...
@Data
public class Idea49603Config {
    private String name = "idea_049603";
 ...
 */
@Slf4j
public class Idea49603Service {
    private static final int IDEA_ID = 49603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49603Service() {
        this(new Idea49603Config());
    }

    public Idea49603Service(Idea49603Config config) {
        this.config = config != null ? config : new Idea49603Config();
