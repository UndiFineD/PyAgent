...
@Data
public class Idea49798Config {
    private String name = "idea_049798";
 ...
 */
@Slf4j
public class Idea49798Service {
    private static final int IDEA_ID = 49798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49798Service() {
        this(new Idea49798Config());
    }

    public Idea49798Service(Idea49798Config config) {
        this.config = config != null ? config : new Idea49798Config();
