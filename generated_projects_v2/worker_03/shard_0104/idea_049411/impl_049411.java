...
@Data
public class Idea49411Config {
    private String name = "idea_049411";
 ...
 */
@Slf4j
public class Idea49411Service {
    private static final int IDEA_ID = 49411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49411Service() {
        this(new Idea49411Config());
    }

    public Idea49411Service(Idea49411Config config) {
        this.config = config != null ? config : new Idea49411Config();
