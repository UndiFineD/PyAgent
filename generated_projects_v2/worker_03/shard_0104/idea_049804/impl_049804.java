...
@Data
public class Idea49804Config {
    private String name = "idea_049804";
 ...
 */
@Slf4j
public class Idea49804Service {
    private static final int IDEA_ID = 49804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49804Service() {
        this(new Idea49804Config());
    }

    public Idea49804Service(Idea49804Config config) {
        this.config = config != null ? config : new Idea49804Config();
