...
@Data
public class Idea49631Config {
    private String name = "idea_049631";
 ...
 */
@Slf4j
public class Idea49631Service {
    private static final int IDEA_ID = 49631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49631Service() {
        this(new Idea49631Config());
    }

    public Idea49631Service(Idea49631Config config) {
        this.config = config != null ? config : new Idea49631Config();
