...
@Data
public class Idea49807Config {
    private String name = "idea_049807";
 ...
 */
@Slf4j
public class Idea49807Service {
    private static final int IDEA_ID = 49807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49807Service() {
        this(new Idea49807Config());
    }

    public Idea49807Service(Idea49807Config config) {
        this.config = config != null ? config : new Idea49807Config();
