...
@Data
public class Idea49786Config {
    private String name = "idea_049786";
 ...
 */
@Slf4j
public class Idea49786Service {
    private static final int IDEA_ID = 49786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49786Service() {
        this(new Idea49786Config());
    }

    public Idea49786Service(Idea49786Config config) {
        this.config = config != null ? config : new Idea49786Config();
