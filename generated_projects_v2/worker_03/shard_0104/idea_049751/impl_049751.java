...
@Data
public class Idea49751Config {
    private String name = "idea_049751";
 ...
 */
@Slf4j
public class Idea49751Service {
    private static final int IDEA_ID = 49751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49751Service() {
        this(new Idea49751Config());
    }

    public Idea49751Service(Idea49751Config config) {
        this.config = config != null ? config : new Idea49751Config();
