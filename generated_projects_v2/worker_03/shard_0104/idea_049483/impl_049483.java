...
@Data
public class Idea49483Config {
    private String name = "idea_049483";
 ...
 */
@Slf4j
public class Idea49483Service {
    private static final int IDEA_ID = 49483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49483Service() {
        this(new Idea49483Config());
    }

    public Idea49483Service(Idea49483Config config) {
        this.config = config != null ? config : new Idea49483Config();
