...
@Data
public class Idea49635Config {
    private String name = "idea_049635";
 ...
 */
@Slf4j
public class Idea49635Service {
    private static final int IDEA_ID = 49635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49635Service() {
        this(new Idea49635Config());
    }

    public Idea49635Service(Idea49635Config config) {
        this.config = config != null ? config : new Idea49635Config();
