...
@Data
public class Idea49761Config {
    private String name = "idea_049761";
 ...
 */
@Slf4j
public class Idea49761Service {
    private static final int IDEA_ID = 49761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49761Service() {
        this(new Idea49761Config());
    }

    public Idea49761Service(Idea49761Config config) {
        this.config = config != null ? config : new Idea49761Config();
