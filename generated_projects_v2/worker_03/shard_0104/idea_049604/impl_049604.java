...
@Data
public class Idea49604Config {
    private String name = "idea_049604";
 ...
 */
@Slf4j
public class Idea49604Service {
    private static final int IDEA_ID = 49604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49604Service() {
        this(new Idea49604Config());
    }

    public Idea49604Service(Idea49604Config config) {
        this.config = config != null ? config : new Idea49604Config();
