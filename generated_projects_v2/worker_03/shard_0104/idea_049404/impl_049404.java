...
@Data
public class Idea49404Config {
    private String name = "idea_049404";
 ...
 */
@Slf4j
public class Idea49404Service {
    private static final int IDEA_ID = 49404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49404Service() {
        this(new Idea49404Config());
    }

    public Idea49404Service(Idea49404Config config) {
        this.config = config != null ? config : new Idea49404Config();
