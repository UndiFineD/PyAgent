...
@Data
public class Idea49860Config {
    private String name = "idea_049860";
 ...
 */
@Slf4j
public class Idea49860Service {
    private static final int IDEA_ID = 49860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49860Service() {
        this(new Idea49860Config());
    }

    public Idea49860Service(Idea49860Config config) {
        this.config = config != null ? config : new Idea49860Config();
