...
@Data
public class Idea49725Config {
    private String name = "idea_049725";
 ...
 */
@Slf4j
public class Idea49725Service {
    private static final int IDEA_ID = 49725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49725Service() {
        this(new Idea49725Config());
    }

    public Idea49725Service(Idea49725Config config) {
        this.config = config != null ? config : new Idea49725Config();
