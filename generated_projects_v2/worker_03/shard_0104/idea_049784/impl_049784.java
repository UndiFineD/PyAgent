...
@Data
public class Idea49784Config {
    private String name = "idea_049784";
 ...
 */
@Slf4j
public class Idea49784Service {
    private static final int IDEA_ID = 49784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49784Service() {
        this(new Idea49784Config());
    }

    public Idea49784Service(Idea49784Config config) {
        this.config = config != null ? config : new Idea49784Config();
