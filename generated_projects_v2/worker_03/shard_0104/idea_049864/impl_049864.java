...
@Data
public class Idea49864Config {
    private String name = "idea_049864";
 ...
 */
@Slf4j
public class Idea49864Service {
    private static final int IDEA_ID = 49864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49864Service() {
        this(new Idea49864Config());
    }

    public Idea49864Service(Idea49864Config config) {
        this.config = config != null ? config : new Idea49864Config();
