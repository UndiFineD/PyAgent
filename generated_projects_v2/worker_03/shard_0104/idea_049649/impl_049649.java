...
@Data
public class Idea49649Config {
    private String name = "idea_049649";
 ...
 */
@Slf4j
public class Idea49649Service {
    private static final int IDEA_ID = 49649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49649Service() {
        this(new Idea49649Config());
    }

    public Idea49649Service(Idea49649Config config) {
        this.config = config != null ? config : new Idea49649Config();
