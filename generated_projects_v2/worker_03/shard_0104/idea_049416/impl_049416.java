...
@Data
public class Idea49416Config {
    private String name = "idea_049416";
 ...
 */
@Slf4j
public class Idea49416Service {
    private static final int IDEA_ID = 49416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49416Service() {
        this(new Idea49416Config());
    }

    public Idea49416Service(Idea49416Config config) {
        this.config = config != null ? config : new Idea49416Config();
