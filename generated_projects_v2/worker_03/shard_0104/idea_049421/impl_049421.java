...
@Data
public class Idea49421Config {
    private String name = "idea_049421";
 ...
 */
@Slf4j
public class Idea49421Service {
    private static final int IDEA_ID = 49421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49421Service() {
        this(new Idea49421Config());
    }

    public Idea49421Service(Idea49421Config config) {
        this.config = config != null ? config : new Idea49421Config();
