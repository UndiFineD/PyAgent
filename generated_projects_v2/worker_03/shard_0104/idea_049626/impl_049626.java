...
@Data
public class Idea49626Config {
    private String name = "idea_049626";
 ...
 */
@Slf4j
public class Idea49626Service {
    private static final int IDEA_ID = 49626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49626Service() {
        this(new Idea49626Config());
    }

    public Idea49626Service(Idea49626Config config) {
        this.config = config != null ? config : new Idea49626Config();
