...
@Data
public class Idea49407Config {
    private String name = "idea_049407";
 ...
 */
@Slf4j
public class Idea49407Service {
    private static final int IDEA_ID = 49407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49407Service() {
        this(new Idea49407Config());
    }

    public Idea49407Service(Idea49407Config config) {
        this.config = config != null ? config : new Idea49407Config();
