...
@Data
public class Idea49827Config {
    private String name = "idea_049827";
 ...
 */
@Slf4j
public class Idea49827Service {
    private static final int IDEA_ID = 49827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49827Service() {
        this(new Idea49827Config());
    }

    public Idea49827Service(Idea49827Config config) {
        this.config = config != null ? config : new Idea49827Config();
