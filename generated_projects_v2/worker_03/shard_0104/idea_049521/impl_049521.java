...
@Data
public class Idea49521Config {
    private String name = "idea_049521";
 ...
 */
@Slf4j
public class Idea49521Service {
    private static final int IDEA_ID = 49521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49521Service() {
        this(new Idea49521Config());
    }

    public Idea49521Service(Idea49521Config config) {
        this.config = config != null ? config : new Idea49521Config();
