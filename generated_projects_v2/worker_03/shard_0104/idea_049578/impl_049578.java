...
@Data
public class Idea49578Config {
    private String name = "idea_049578";
 ...
 */
@Slf4j
public class Idea49578Service {
    private static final int IDEA_ID = 49578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea49578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea49578Service() {
        this(new Idea49578Config());
    }

    public Idea49578Service(Idea49578Config config) {
        this.config = config != null ? config : new Idea49578Config();
