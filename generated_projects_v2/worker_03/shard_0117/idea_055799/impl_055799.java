...
@Data
public class Idea55799Config {
    private String name = "idea_055799";
 ...
 */
@Slf4j
public class Idea55799Service {
    private static final int IDEA_ID = 55799;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55799Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55799Service() {
        this(new Idea55799Config());
    }

    public Idea55799Service(Idea55799Config config) {
        this.config = config != null ? config : new Idea55799Config();
