...
@Data
public class Idea55890Config {
    private String name = "idea_055890";
 ...
 */
@Slf4j
public class Idea55890Service {
    private static final int IDEA_ID = 55890;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55890Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55890Service() {
        this(new Idea55890Config());
    }

    public Idea55890Service(Idea55890Config config) {
        this.config = config != null ? config : new Idea55890Config();
