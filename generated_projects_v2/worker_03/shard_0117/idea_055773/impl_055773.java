...
@Data
public class Idea55773Config {
    private String name = "idea_055773";
 ...
 */
@Slf4j
public class Idea55773Service {
    private static final int IDEA_ID = 55773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55773Service() {
        this(new Idea55773Config());
    }

    public Idea55773Service(Idea55773Config config) {
        this.config = config != null ? config : new Idea55773Config();
