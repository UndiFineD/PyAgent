...
@Data
public class Idea55783Config {
    private String name = "idea_055783";
 ...
 */
@Slf4j
public class Idea55783Service {
    private static final int IDEA_ID = 55783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55783Service() {
        this(new Idea55783Config());
    }

    public Idea55783Service(Idea55783Config config) {
        this.config = config != null ? config : new Idea55783Config();
