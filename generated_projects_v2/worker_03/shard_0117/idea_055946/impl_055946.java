...
@Data
public class Idea55946Config {
    private String name = "idea_055946";
 ...
 */
@Slf4j
public class Idea55946Service {
    private static final int IDEA_ID = 55946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55946Service() {
        this(new Idea55946Config());
    }

    public Idea55946Service(Idea55946Config config) {
        this.config = config != null ? config : new Idea55946Config();
