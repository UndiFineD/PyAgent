...
@Data
public class Idea56004Config {
    private String name = "idea_056004";
 ...
 */
@Slf4j
public class Idea56004Service {
    private static final int IDEA_ID = 56004;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56004Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56004Service() {
        this(new Idea56004Config());
    }

    public Idea56004Service(Idea56004Config config) {
        this.config = config != null ? config : new Idea56004Config();
