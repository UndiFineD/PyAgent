...
@Data
public class Idea55765Config {
    private String name = "idea_055765";
 ...
 */
@Slf4j
public class Idea55765Service {
    private static final int IDEA_ID = 55765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55765Service() {
        this(new Idea55765Config());
    }

    public Idea55765Service(Idea55765Config config) {
        this.config = config != null ? config : new Idea55765Config();
