...
@Data
public class Idea55884Config {
    private String name = "idea_055884";
 ...
 */
@Slf4j
public class Idea55884Service {
    private static final int IDEA_ID = 55884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55884Service() {
        this(new Idea55884Config());
    }

    public Idea55884Service(Idea55884Config config) {
        this.config = config != null ? config : new Idea55884Config();
