...
@Data
public class Idea55767Config {
    private String name = "idea_055767";
 ...
 */
@Slf4j
public class Idea55767Service {
    private static final int IDEA_ID = 55767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55767Service() {
        this(new Idea55767Config());
    }

    public Idea55767Service(Idea55767Config config) {
        this.config = config != null ? config : new Idea55767Config();
