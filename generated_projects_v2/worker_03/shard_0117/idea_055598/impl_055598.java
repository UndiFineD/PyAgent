...
@Data
public class Idea55598Config {
    private String name = "idea_055598";
 ...
 */
@Slf4j
public class Idea55598Service {
    private static final int IDEA_ID = 55598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55598Service() {
        this(new Idea55598Config());
    }

    public Idea55598Service(Idea55598Config config) {
        this.config = config != null ? config : new Idea55598Config();
