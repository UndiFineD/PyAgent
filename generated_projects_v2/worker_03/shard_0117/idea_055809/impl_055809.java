...
@Data
public class Idea55809Config {
    private String name = "idea_055809";
 ...
 */
@Slf4j
public class Idea55809Service {
    private static final int IDEA_ID = 55809;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55809Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55809Service() {
        this(new Idea55809Config());
    }

    public Idea55809Service(Idea55809Config config) {
        this.config = config != null ? config : new Idea55809Config();
