...
@Data
public class Idea55805Config {
    private String name = "idea_055805";
 ...
 */
@Slf4j
public class Idea55805Service {
    private static final int IDEA_ID = 55805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55805Service() {
        this(new Idea55805Config());
    }

    public Idea55805Service(Idea55805Config config) {
        this.config = config != null ? config : new Idea55805Config();
