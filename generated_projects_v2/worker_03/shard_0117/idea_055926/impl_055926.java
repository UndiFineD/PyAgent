...
@Data
public class Idea55926Config {
    private String name = "idea_055926";
 ...
 */
@Slf4j
public class Idea55926Service {
    private static final int IDEA_ID = 55926;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55926Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55926Service() {
        this(new Idea55926Config());
    }

    public Idea55926Service(Idea55926Config config) {
        this.config = config != null ? config : new Idea55926Config();
