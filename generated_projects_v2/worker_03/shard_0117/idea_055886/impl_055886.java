...
@Data
public class Idea55886Config {
    private String name = "idea_055886";
 ...
 */
@Slf4j
public class Idea55886Service {
    private static final int IDEA_ID = 55886;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55886Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55886Service() {
        this(new Idea55886Config());
    }

    public Idea55886Service(Idea55886Config config) {
        this.config = config != null ? config : new Idea55886Config();
