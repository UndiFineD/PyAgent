...
@Data
public class Idea55963Config {
    private String name = "idea_055963";
 ...
 */
@Slf4j
public class Idea55963Service {
    private static final int IDEA_ID = 55963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55963Service() {
        this(new Idea55963Config());
    }

    public Idea55963Service(Idea55963Config config) {
        this.config = config != null ? config : new Idea55963Config();
