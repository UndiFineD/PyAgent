...
@Data
public class Idea55585Config {
    private String name = "idea_055585";
 ...
 */
@Slf4j
public class Idea55585Service {
    private static final int IDEA_ID = 55585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55585Service() {
        this(new Idea55585Config());
    }

    public Idea55585Service(Idea55585Config config) {
        this.config = config != null ? config : new Idea55585Config();
