...
@Data
public class Idea55741Config {
    private String name = "idea_055741";
 ...
 */
@Slf4j
public class Idea55741Service {
    private static final int IDEA_ID = 55741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55741Service() {
        this(new Idea55741Config());
    }

    public Idea55741Service(Idea55741Config config) {
        this.config = config != null ? config : new Idea55741Config();
