...
@Data
public class Idea55604Config {
    private String name = "idea_055604";
 ...
 */
@Slf4j
public class Idea55604Service {
    private static final int IDEA_ID = 55604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55604Service() {
        this(new Idea55604Config());
    }

    public Idea55604Service(Idea55604Config config) {
        this.config = config != null ? config : new Idea55604Config();
