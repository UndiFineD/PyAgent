...
@Data
public class Idea55987Config {
    private String name = "idea_055987";
 ...
 */
@Slf4j
public class Idea55987Service {
    private static final int IDEA_ID = 55987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55987Service() {
        this(new Idea55987Config());
    }

    public Idea55987Service(Idea55987Config config) {
        this.config = config != null ? config : new Idea55987Config();
