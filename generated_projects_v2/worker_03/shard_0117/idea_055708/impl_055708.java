...
@Data
public class Idea55708Config {
    private String name = "idea_055708";
 ...
 */
@Slf4j
public class Idea55708Service {
    private static final int IDEA_ID = 55708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55708Service() {
        this(new Idea55708Config());
    }

    public Idea55708Service(Idea55708Config config) {
        this.config = config != null ? config : new Idea55708Config();
