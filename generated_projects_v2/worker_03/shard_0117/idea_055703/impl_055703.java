...
@Data
public class Idea55703Config {
    private String name = "idea_055703";
 ...
 */
@Slf4j
public class Idea55703Service {
    private static final int IDEA_ID = 55703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55703Service() {
        this(new Idea55703Config());
    }

    public Idea55703Service(Idea55703Config config) {
        this.config = config != null ? config : new Idea55703Config();
