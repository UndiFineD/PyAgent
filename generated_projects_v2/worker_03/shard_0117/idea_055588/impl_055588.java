...
@Data
public class Idea55588Config {
    private String name = "idea_055588";
 ...
 */
@Slf4j
public class Idea55588Service {
    private static final int IDEA_ID = 55588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55588Service() {
        this(new Idea55588Config());
    }

    public Idea55588Service(Idea55588Config config) {
        this.config = config != null ? config : new Idea55588Config();
