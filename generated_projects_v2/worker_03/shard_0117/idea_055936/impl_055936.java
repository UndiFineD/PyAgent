...
@Data
public class Idea55936Config {
    private String name = "idea_055936";
 ...
 */
@Slf4j
public class Idea55936Service {
    private static final int IDEA_ID = 55936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55936Service() {
        this(new Idea55936Config());
    }

    public Idea55936Service(Idea55936Config config) {
        this.config = config != null ? config : new Idea55936Config();
