...
@Data
public class Idea55696Config {
    private String name = "idea_055696";
 ...
 */
@Slf4j
public class Idea55696Service {
    private static final int IDEA_ID = 55696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55696Service() {
        this(new Idea55696Config());
    }

    public Idea55696Service(Idea55696Config config) {
        this.config = config != null ? config : new Idea55696Config();
