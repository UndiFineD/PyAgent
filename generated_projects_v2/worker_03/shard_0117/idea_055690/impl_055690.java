...
@Data
public class Idea55690Config {
    private String name = "idea_055690";
 ...
 */
@Slf4j
public class Idea55690Service {
    private static final int IDEA_ID = 55690;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55690Service() {
        this(new Idea55690Config());
    }

    public Idea55690Service(Idea55690Config config) {
        this.config = config != null ? config : new Idea55690Config();
