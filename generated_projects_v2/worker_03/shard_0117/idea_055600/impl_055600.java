...
@Data
public class Idea55600Config {
    private String name = "idea_055600";
 ...
 */
@Slf4j
public class Idea55600Service {
    private static final int IDEA_ID = 55600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55600Service() {
        this(new Idea55600Config());
    }

    public Idea55600Service(Idea55600Config config) {
        this.config = config != null ? config : new Idea55600Config();
