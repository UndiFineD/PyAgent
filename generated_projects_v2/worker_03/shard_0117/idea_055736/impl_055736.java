...
@Data
public class Idea55736Config {
    private String name = "idea_055736";
 ...
 */
@Slf4j
public class Idea55736Service {
    private static final int IDEA_ID = 55736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55736Service() {
        this(new Idea55736Config());
    }

    public Idea55736Service(Idea55736Config config) {
        this.config = config != null ? config : new Idea55736Config();
