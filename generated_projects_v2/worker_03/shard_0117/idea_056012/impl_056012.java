...
@Data
public class Idea56012Config {
    private String name = "idea_056012";
 ...
 */
@Slf4j
public class Idea56012Service {
    private static final int IDEA_ID = 56012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56012Service() {
        this(new Idea56012Config());
    }

    public Idea56012Service(Idea56012Config config) {
        this.config = config != null ? config : new Idea56012Config();
