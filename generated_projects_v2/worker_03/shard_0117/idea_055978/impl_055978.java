...
@Data
public class Idea55978Config {
    private String name = "idea_055978";
 ...
 */
@Slf4j
public class Idea55978Service {
    private static final int IDEA_ID = 55978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55978Service() {
        this(new Idea55978Config());
    }

    public Idea55978Service(Idea55978Config config) {
        this.config = config != null ? config : new Idea55978Config();
