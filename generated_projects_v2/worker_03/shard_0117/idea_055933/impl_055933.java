...
@Data
public class Idea55933Config {
    private String name = "idea_055933";
 ...
 */
@Slf4j
public class Idea55933Service {
    private static final int IDEA_ID = 55933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55933Service() {
        this(new Idea55933Config());
    }

    public Idea55933Service(Idea55933Config config) {
        this.config = config != null ? config : new Idea55933Config();
