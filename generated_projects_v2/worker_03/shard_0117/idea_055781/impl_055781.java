...
@Data
public class Idea55781Config {
    private String name = "idea_055781";
 ...
 */
@Slf4j
public class Idea55781Service {
    private static final int IDEA_ID = 55781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55781Service() {
        this(new Idea55781Config());
    }

    public Idea55781Service(Idea55781Config config) {
        this.config = config != null ? config : new Idea55781Config();
