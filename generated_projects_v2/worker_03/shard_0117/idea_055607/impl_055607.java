...
@Data
public class Idea55607Config {
    private String name = "idea_055607";
 ...
 */
@Slf4j
public class Idea55607Service {
    private static final int IDEA_ID = 55607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55607Service() {
        this(new Idea55607Config());
    }

    public Idea55607Service(Idea55607Config config) {
        this.config = config != null ? config : new Idea55607Config();
