...
@Data
public class Idea56033Config {
    private String name = "idea_056033";
 ...
 */
@Slf4j
public class Idea56033Service {
    private static final int IDEA_ID = 56033;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56033Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56033Service() {
        this(new Idea56033Config());
    }

    public Idea56033Service(Idea56033Config config) {
        this.config = config != null ? config : new Idea56033Config();
