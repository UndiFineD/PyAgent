...
@Data
public class Idea55602Config {
    private String name = "idea_055602";
 ...
 */
@Slf4j
public class Idea55602Service {
    private static final int IDEA_ID = 55602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55602Service() {
        this(new Idea55602Config());
    }

    public Idea55602Service(Idea55602Config config) {
        this.config = config != null ? config : new Idea55602Config();
