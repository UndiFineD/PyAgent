...
@Data
public class Idea56038Config {
    private String name = "idea_056038";
 ...
 */
@Slf4j
public class Idea56038Service {
    private static final int IDEA_ID = 56038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56038Service() {
        this(new Idea56038Config());
    }

    public Idea56038Service(Idea56038Config config) {
        this.config = config != null ? config : new Idea56038Config();
