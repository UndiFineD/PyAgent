...
@Data
public class Idea55725Config {
    private String name = "idea_055725";
 ...
 */
@Slf4j
public class Idea55725Service {
    private static final int IDEA_ID = 55725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55725Service() {
        this(new Idea55725Config());
    }

    public Idea55725Service(Idea55725Config config) {
        this.config = config != null ? config : new Idea55725Config();
