...
@Data
public class Idea55737Config {
    private String name = "idea_055737";
 ...
 */
@Slf4j
public class Idea55737Service {
    private static final int IDEA_ID = 55737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55737Service() {
        this(new Idea55737Config());
    }

    public Idea55737Service(Idea55737Config config) {
        this.config = config != null ? config : new Idea55737Config();
