...
@Data
public class Idea55784Config {
    private String name = "idea_055784";
 ...
 */
@Slf4j
public class Idea55784Service {
    private static final int IDEA_ID = 55784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55784Service() {
        this(new Idea55784Config());
    }

    public Idea55784Service(Idea55784Config config) {
        this.config = config != null ? config : new Idea55784Config();
