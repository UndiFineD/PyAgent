...
@Data
public class Idea55989Config {
    private String name = "idea_055989";
 ...
 */
@Slf4j
public class Idea55989Service {
    private static final int IDEA_ID = 55989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55989Service() {
        this(new Idea55989Config());
    }

    public Idea55989Service(Idea55989Config config) {
        this.config = config != null ? config : new Idea55989Config();
