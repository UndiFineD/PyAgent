...
@Data
public class Idea55812Config {
    private String name = "idea_055812";
 ...
 */
@Slf4j
public class Idea55812Service {
    private static final int IDEA_ID = 55812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55812Service() {
        this(new Idea55812Config());
    }

    public Idea55812Service(Idea55812Config config) {
        this.config = config != null ? config : new Idea55812Config();
