...
@Data
public class Idea55956Config {
    private String name = "idea_055956";
 ...
 */
@Slf4j
public class Idea55956Service {
    private static final int IDEA_ID = 55956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55956Service() {
        this(new Idea55956Config());
    }

    public Idea55956Service(Idea55956Config config) {
        this.config = config != null ? config : new Idea55956Config();
