...
@Data
public class Idea55861Config {
    private String name = "idea_055861";
 ...
 */
@Slf4j
public class Idea55861Service {
    private static final int IDEA_ID = 55861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55861Service() {
        this(new Idea55861Config());
    }

    public Idea55861Service(Idea55861Config config) {
        this.config = config != null ? config : new Idea55861Config();
