...
@Data
public class Idea55762Config {
    private String name = "idea_055762";
 ...
 */
@Slf4j
public class Idea55762Service {
    private static final int IDEA_ID = 55762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55762Service() {
        this(new Idea55762Config());
    }

    public Idea55762Service(Idea55762Config config) {
        this.config = config != null ? config : new Idea55762Config();
