...
@Data
public class Idea55800Config {
    private String name = "idea_055800";
 ...
 */
@Slf4j
public class Idea55800Service {
    private static final int IDEA_ID = 55800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55800Service() {
        this(new Idea55800Config());
    }

    public Idea55800Service(Idea55800Config config) {
        this.config = config != null ? config : new Idea55800Config();
