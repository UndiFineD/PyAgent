...
@Data
public class Idea55855Config {
    private String name = "idea_055855";
 ...
 */
@Slf4j
public class Idea55855Service {
    private static final int IDEA_ID = 55855;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55855Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55855Service() {
        this(new Idea55855Config());
    }

    public Idea55855Service(Idea55855Config config) {
        this.config = config != null ? config : new Idea55855Config();
