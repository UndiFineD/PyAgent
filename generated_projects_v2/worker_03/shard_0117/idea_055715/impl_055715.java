...
@Data
public class Idea55715Config {
    private String name = "idea_055715";
 ...
 */
@Slf4j
public class Idea55715Service {
    private static final int IDEA_ID = 55715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55715Service() {
        this(new Idea55715Config());
    }

    public Idea55715Service(Idea55715Config config) {
        this.config = config != null ? config : new Idea55715Config();
