...
@Data
public class Idea55999Config {
    private String name = "idea_055999";
 ...
 */
@Slf4j
public class Idea55999Service {
    private static final int IDEA_ID = 55999;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55999Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55999Service() {
        this(new Idea55999Config());
    }

    public Idea55999Service(Idea55999Config config) {
        this.config = config != null ? config : new Idea55999Config();
