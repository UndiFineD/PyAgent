...
@Data
public class Idea55907Config {
    private String name = "idea_055907";
 ...
 */
@Slf4j
public class Idea55907Service {
    private static final int IDEA_ID = 55907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55907Service() {
        this(new Idea55907Config());
    }

    public Idea55907Service(Idea55907Config config) {
        this.config = config != null ? config : new Idea55907Config();
