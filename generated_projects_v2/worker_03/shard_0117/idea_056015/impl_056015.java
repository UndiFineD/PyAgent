...
@Data
public class Idea56015Config {
    private String name = "idea_056015";
 ...
 */
@Slf4j
public class Idea56015Service {
    private static final int IDEA_ID = 56015;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56015Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56015Service() {
        this(new Idea56015Config());
    }

    public Idea56015Service(Idea56015Config config) {
        this.config = config != null ? config : new Idea56015Config();
