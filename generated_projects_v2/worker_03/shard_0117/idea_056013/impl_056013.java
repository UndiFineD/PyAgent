...
@Data
public class Idea56013Config {
    private String name = "idea_056013";
 ...
 */
@Slf4j
public class Idea56013Service {
    private static final int IDEA_ID = 56013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56013Service() {
        this(new Idea56013Config());
    }

    public Idea56013Service(Idea56013Config config) {
        this.config = config != null ? config : new Idea56013Config();
