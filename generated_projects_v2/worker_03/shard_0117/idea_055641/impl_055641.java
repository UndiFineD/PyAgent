...
@Data
public class Idea55641Config {
    private String name = "idea_055641";
 ...
 */
@Slf4j
public class Idea55641Service {
    private static final int IDEA_ID = 55641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55641Service() {
        this(new Idea55641Config());
    }

    public Idea55641Service(Idea55641Config config) {
        this.config = config != null ? config : new Idea55641Config();
