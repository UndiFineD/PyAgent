...
@Data
public class Idea55645Config {
    private String name = "idea_055645";
 ...
 */
@Slf4j
public class Idea55645Service {
    private static final int IDEA_ID = 55645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55645Service() {
        this(new Idea55645Config());
    }

    public Idea55645Service(Idea55645Config config) {
        this.config = config != null ? config : new Idea55645Config();
