...
@Data
public class Idea55658Config {
    private String name = "idea_055658";
 ...
 */
@Slf4j
public class Idea55658Service {
    private static final int IDEA_ID = 55658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55658Service() {
        this(new Idea55658Config());
    }

    public Idea55658Service(Idea55658Config config) {
        this.config = config != null ? config : new Idea55658Config();
