...
@Data
public class Idea55626Config {
    private String name = "idea_055626";
 ...
 */
@Slf4j
public class Idea55626Service {
    private static final int IDEA_ID = 55626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55626Service() {
        this(new Idea55626Config());
    }

    public Idea55626Service(Idea55626Config config) {
        this.config = config != null ? config : new Idea55626Config();
