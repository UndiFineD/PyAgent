...
@Data
public class Idea55807Config {
    private String name = "idea_055807";
 ...
 */
@Slf4j
public class Idea55807Service {
    private static final int IDEA_ID = 55807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55807Service() {
        this(new Idea55807Config());
    }

    public Idea55807Service(Idea55807Config config) {
        this.config = config != null ? config : new Idea55807Config();
