...
@Data
public class Idea55827Config {
    private String name = "idea_055827";
 ...
 */
@Slf4j
public class Idea55827Service {
    private static final int IDEA_ID = 55827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55827Service() {
        this(new Idea55827Config());
    }

    public Idea55827Service(Idea55827Config config) {
        this.config = config != null ? config : new Idea55827Config();
