...
@Data
public class Idea55627Config {
    private String name = "idea_055627";
 ...
 */
@Slf4j
public class Idea55627Service {
    private static final int IDEA_ID = 55627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55627Service() {
        this(new Idea55627Config());
    }

    public Idea55627Service(Idea55627Config config) {
        this.config = config != null ? config : new Idea55627Config();
