...
@Data
public class Idea55738Config {
    private String name = "idea_055738";
 ...
 */
@Slf4j
public class Idea55738Service {
    private static final int IDEA_ID = 55738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55738Service() {
        this(new Idea55738Config());
    }

    public Idea55738Service(Idea55738Config config) {
        this.config = config != null ? config : new Idea55738Config();
