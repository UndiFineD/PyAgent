...
@Data
public class Idea55825Config {
    private String name = "idea_055825";
 ...
 */
@Slf4j
public class Idea55825Service {
    private static final int IDEA_ID = 55825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55825Service() {
        this(new Idea55825Config());
    }

    public Idea55825Service(Idea55825Config config) {
        this.config = config != null ? config : new Idea55825Config();
