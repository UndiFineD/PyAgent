...
@Data
public class Idea55727Config {
    private String name = "idea_055727";
 ...
 */
@Slf4j
public class Idea55727Service {
    private static final int IDEA_ID = 55727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55727Service() {
        this(new Idea55727Config());
    }

    public Idea55727Service(Idea55727Config config) {
        this.config = config != null ? config : new Idea55727Config();
