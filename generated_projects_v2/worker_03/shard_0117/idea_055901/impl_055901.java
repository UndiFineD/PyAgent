...
@Data
public class Idea55901Config {
    private String name = "idea_055901";
 ...
 */
@Slf4j
public class Idea55901Service {
    private static final int IDEA_ID = 55901;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55901Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55901Service() {
        this(new Idea55901Config());
    }

    public Idea55901Service(Idea55901Config config) {
        this.config = config != null ? config : new Idea55901Config();
