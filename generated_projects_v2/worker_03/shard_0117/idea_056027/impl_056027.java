...
@Data
public class Idea56027Config {
    private String name = "idea_056027";
 ...
 */
@Slf4j
public class Idea56027Service {
    private static final int IDEA_ID = 56027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56027Service() {
        this(new Idea56027Config());
    }

    public Idea56027Service(Idea56027Config config) {
        this.config = config != null ? config : new Idea56027Config();
