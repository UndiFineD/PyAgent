...
@Data
public class Idea55723Config {
    private String name = "idea_055723";
 ...
 */
@Slf4j
public class Idea55723Service {
    private static final int IDEA_ID = 55723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55723Service() {
        this(new Idea55723Config());
    }

    public Idea55723Service(Idea55723Config config) {
        this.config = config != null ? config : new Idea55723Config();
