...
@Data
public class Idea55726Config {
    private String name = "idea_055726";
 ...
 */
@Slf4j
public class Idea55726Service {
    private static final int IDEA_ID = 55726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55726Service() {
        this(new Idea55726Config());
    }

    public Idea55726Service(Idea55726Config config) {
        this.config = config != null ? config : new Idea55726Config();
