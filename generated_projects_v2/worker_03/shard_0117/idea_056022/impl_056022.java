...
@Data
public class Idea56022Config {
    private String name = "idea_056022";
 ...
 */
@Slf4j
public class Idea56022Service {
    private static final int IDEA_ID = 56022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56022Service() {
        this(new Idea56022Config());
    }

    public Idea56022Service(Idea56022Config config) {
        this.config = config != null ? config : new Idea56022Config();
