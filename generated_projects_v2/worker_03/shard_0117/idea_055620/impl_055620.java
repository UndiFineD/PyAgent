...
@Data
public class Idea55620Config {
    private String name = "idea_055620";
 ...
 */
@Slf4j
public class Idea55620Service {
    private static final int IDEA_ID = 55620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55620Service() {
        this(new Idea55620Config());
    }

    public Idea55620Service(Idea55620Config config) {
        this.config = config != null ? config : new Idea55620Config();
