...
@Data
public class Idea55685Config {
    private String name = "idea_055685";
 ...
 */
@Slf4j
public class Idea55685Service {
    private static final int IDEA_ID = 55685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55685Service() {
        this(new Idea55685Config());
    }

    public Idea55685Service(Idea55685Config config) {
        this.config = config != null ? config : new Idea55685Config();
