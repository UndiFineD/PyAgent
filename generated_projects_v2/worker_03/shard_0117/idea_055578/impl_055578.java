...
@Data
public class Idea55578Config {
    private String name = "idea_055578";
 ...
 */
@Slf4j
public class Idea55578Service {
    private static final int IDEA_ID = 55578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55578Service() {
        this(new Idea55578Config());
    }

    public Idea55578Service(Idea55578Config config) {
        this.config = config != null ? config : new Idea55578Config();
