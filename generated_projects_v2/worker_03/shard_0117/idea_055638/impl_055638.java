...
@Data
public class Idea55638Config {
    private String name = "idea_055638";
 ...
 */
@Slf4j
public class Idea55638Service {
    private static final int IDEA_ID = 55638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55638Service() {
        this(new Idea55638Config());
    }

    public Idea55638Service(Idea55638Config config) {
        this.config = config != null ? config : new Idea55638Config();
