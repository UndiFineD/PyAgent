...
@Data
public class Idea55802Config {
    private String name = "idea_055802";
 ...
 */
@Slf4j
public class Idea55802Service {
    private static final int IDEA_ID = 55802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55802Service() {
        this(new Idea55802Config());
    }

    public Idea55802Service(Idea55802Config config) {
        this.config = config != null ? config : new Idea55802Config();
