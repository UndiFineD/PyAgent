...
@Data
public class Idea55624Config {
    private String name = "idea_055624";
 ...
 */
@Slf4j
public class Idea55624Service {
    private static final int IDEA_ID = 55624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55624Service() {
        this(new Idea55624Config());
    }

    public Idea55624Service(Idea55624Config config) {
        this.config = config != null ? config : new Idea55624Config();
