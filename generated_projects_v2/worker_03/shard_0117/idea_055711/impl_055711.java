...
@Data
public class Idea55711Config {
    private String name = "idea_055711";
 ...
 */
@Slf4j
public class Idea55711Service {
    private static final int IDEA_ID = 55711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55711Service() {
        this(new Idea55711Config());
    }

    public Idea55711Service(Idea55711Config config) {
        this.config = config != null ? config : new Idea55711Config();
