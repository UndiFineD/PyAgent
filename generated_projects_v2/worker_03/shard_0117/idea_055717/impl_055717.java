...
@Data
public class Idea55717Config {
    private String name = "idea_055717";
 ...
 */
@Slf4j
public class Idea55717Service {
    private static final int IDEA_ID = 55717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55717Service() {
        this(new Idea55717Config());
    }

    public Idea55717Service(Idea55717Config config) {
        this.config = config != null ? config : new Idea55717Config();
