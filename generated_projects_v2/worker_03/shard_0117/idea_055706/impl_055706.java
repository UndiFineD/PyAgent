...
@Data
public class Idea55706Config {
    private String name = "idea_055706";
 ...
 */
@Slf4j
public class Idea55706Service {
    private static final int IDEA_ID = 55706;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55706Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55706Service() {
        this(new Idea55706Config());
    }

    public Idea55706Service(Idea55706Config config) {
        this.config = config != null ? config : new Idea55706Config();
