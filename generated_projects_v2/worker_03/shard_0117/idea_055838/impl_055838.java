...
@Data
public class Idea55838Config {
    private String name = "idea_055838";
 ...
 */
@Slf4j
public class Idea55838Service {
    private static final int IDEA_ID = 55838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55838Service() {
        this(new Idea55838Config());
    }

    public Idea55838Service(Idea55838Config config) {
        this.config = config != null ? config : new Idea55838Config();
