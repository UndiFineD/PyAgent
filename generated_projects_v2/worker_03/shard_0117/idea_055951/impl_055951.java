...
@Data
public class Idea55951Config {
    private String name = "idea_055951";
 ...
 */
@Slf4j
public class Idea55951Service {
    private static final int IDEA_ID = 55951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55951Service() {
        this(new Idea55951Config());
    }

    public Idea55951Service(Idea55951Config config) {
        this.config = config != null ? config : new Idea55951Config();
