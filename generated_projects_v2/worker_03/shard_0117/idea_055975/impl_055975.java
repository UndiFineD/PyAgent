...
@Data
public class Idea55975Config {
    private String name = "idea_055975";
 ...
 */
@Slf4j
public class Idea55975Service {
    private static final int IDEA_ID = 55975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55975Service() {
        this(new Idea55975Config());
    }

    public Idea55975Service(Idea55975Config config) {
        this.config = config != null ? config : new Idea55975Config();
