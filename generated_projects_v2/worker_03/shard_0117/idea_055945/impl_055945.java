...
@Data
public class Idea55945Config {
    private String name = "idea_055945";
 ...
 */
@Slf4j
public class Idea55945Service {
    private static final int IDEA_ID = 55945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55945Service() {
        this(new Idea55945Config());
    }

    public Idea55945Service(Idea55945Config config) {
        this.config = config != null ? config : new Idea55945Config();
