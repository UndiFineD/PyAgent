...
@Data
public class Idea55885Config {
    private String name = "idea_055885";
 ...
 */
@Slf4j
public class Idea55885Service {
    private static final int IDEA_ID = 55885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55885Service() {
        this(new Idea55885Config());
    }

    public Idea55885Service(Idea55885Config config) {
        this.config = config != null ? config : new Idea55885Config();
