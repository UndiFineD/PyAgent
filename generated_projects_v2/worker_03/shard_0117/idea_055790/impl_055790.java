...
@Data
public class Idea55790Config {
    private String name = "idea_055790";
 ...
 */
@Slf4j
public class Idea55790Service {
    private static final int IDEA_ID = 55790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55790Service() {
        this(new Idea55790Config());
    }

    public Idea55790Service(Idea55790Config config) {
        this.config = config != null ? config : new Idea55790Config();
