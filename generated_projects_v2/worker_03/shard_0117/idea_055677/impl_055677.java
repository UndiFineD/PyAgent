...
@Data
public class Idea55677Config {
    private String name = "idea_055677";
 ...
 */
@Slf4j
public class Idea55677Service {
    private static final int IDEA_ID = 55677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55677Service() {
        this(new Idea55677Config());
    }

    public Idea55677Service(Idea55677Config config) {
        this.config = config != null ? config : new Idea55677Config();
