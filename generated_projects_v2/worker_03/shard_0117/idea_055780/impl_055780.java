...
@Data
public class Idea55780Config {
    private String name = "idea_055780";
 ...
 */
@Slf4j
public class Idea55780Service {
    private static final int IDEA_ID = 55780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55780Service() {
        this(new Idea55780Config());
    }

    public Idea55780Service(Idea55780Config config) {
        this.config = config != null ? config : new Idea55780Config();
