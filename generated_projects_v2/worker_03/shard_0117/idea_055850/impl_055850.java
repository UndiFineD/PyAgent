...
@Data
public class Idea55850Config {
    private String name = "idea_055850";
 ...
 */
@Slf4j
public class Idea55850Service {
    private static final int IDEA_ID = 55850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55850Service() {
        this(new Idea55850Config());
    }

    public Idea55850Service(Idea55850Config config) {
        this.config = config != null ? config : new Idea55850Config();
