...
@Data
public class Idea55801Config {
    private String name = "idea_055801";
 ...
 */
@Slf4j
public class Idea55801Service {
    private static final int IDEA_ID = 55801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55801Service() {
        this(new Idea55801Config());
    }

    public Idea55801Service(Idea55801Config config) {
        this.config = config != null ? config : new Idea55801Config();
