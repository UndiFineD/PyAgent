...
@Data
public class Idea55960Config {
    private String name = "idea_055960";
 ...
 */
@Slf4j
public class Idea55960Service {
    private static final int IDEA_ID = 55960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55960Service() {
        this(new Idea55960Config());
    }

    public Idea55960Service(Idea55960Config config) {
        this.config = config != null ? config : new Idea55960Config();
