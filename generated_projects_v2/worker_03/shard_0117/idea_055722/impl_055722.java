...
@Data
public class Idea55722Config {
    private String name = "idea_055722";
 ...
 */
@Slf4j
public class Idea55722Service {
    private static final int IDEA_ID = 55722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55722Service() {
        this(new Idea55722Config());
    }

    public Idea55722Service(Idea55722Config config) {
        this.config = config != null ? config : new Idea55722Config();
