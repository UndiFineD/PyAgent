...
@Data
public class Idea55731Config {
    private String name = "idea_055731";
 ...
 */
@Slf4j
public class Idea55731Service {
    private static final int IDEA_ID = 55731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55731Service() {
        this(new Idea55731Config());
    }

    public Idea55731Service(Idea55731Config config) {
        this.config = config != null ? config : new Idea55731Config();
