...
@Data
public class Idea55761Config {
    private String name = "idea_055761";
 ...
 */
@Slf4j
public class Idea55761Service {
    private static final int IDEA_ID = 55761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55761Service() {
        this(new Idea55761Config());
    }

    public Idea55761Service(Idea55761Config config) {
        this.config = config != null ? config : new Idea55761Config();
