...
@Data
public class Idea55634Config {
    private String name = "idea_055634";
 ...
 */
@Slf4j
public class Idea55634Service {
    private static final int IDEA_ID = 55634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55634Service() {
        this(new Idea55634Config());
    }

    public Idea55634Service(Idea55634Config config) {
        this.config = config != null ? config : new Idea55634Config();
