...
@Data
public class Idea55721Config {
    private String name = "idea_055721";
 ...
 */
@Slf4j
public class Idea55721Service {
    private static final int IDEA_ID = 55721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55721Service() {
        this(new Idea55721Config());
    }

    public Idea55721Service(Idea55721Config config) {
        this.config = config != null ? config : new Idea55721Config();
