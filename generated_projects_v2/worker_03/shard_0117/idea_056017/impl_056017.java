...
@Data
public class Idea56017Config {
    private String name = "idea_056017";
 ...
 */
@Slf4j
public class Idea56017Service {
    private static final int IDEA_ID = 56017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56017Service() {
        this(new Idea56017Config());
    }

    public Idea56017Service(Idea56017Config config) {
        this.config = config != null ? config : new Idea56017Config();
