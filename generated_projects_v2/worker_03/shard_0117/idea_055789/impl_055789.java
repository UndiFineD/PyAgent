...
@Data
public class Idea55789Config {
    private String name = "idea_055789";
 ...
 */
@Slf4j
public class Idea55789Service {
    private static final int IDEA_ID = 55789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55789Service() {
        this(new Idea55789Config());
    }

    public Idea55789Service(Idea55789Config config) {
        this.config = config != null ? config : new Idea55789Config();
