...
@Data
public class Idea55587Config {
    private String name = "idea_055587";
 ...
 */
@Slf4j
public class Idea55587Service {
    private static final int IDEA_ID = 55587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55587Service() {
        this(new Idea55587Config());
    }

    public Idea55587Service(Idea55587Config config) {
        this.config = config != null ? config : new Idea55587Config();
