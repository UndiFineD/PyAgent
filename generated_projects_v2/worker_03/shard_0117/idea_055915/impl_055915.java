...
@Data
public class Idea55915Config {
    private String name = "idea_055915";
 ...
 */
@Slf4j
public class Idea55915Service {
    private static final int IDEA_ID = 55915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55915Service() {
        this(new Idea55915Config());
    }

    public Idea55915Service(Idea55915Config config) {
        this.config = config != null ? config : new Idea55915Config();
