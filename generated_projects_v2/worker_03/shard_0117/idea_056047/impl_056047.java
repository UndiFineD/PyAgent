...
@Data
public class Idea56047Config {
    private String name = "idea_056047";
 ...
 */
@Slf4j
public class Idea56047Service {
    private static final int IDEA_ID = 56047;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56047Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56047Service() {
        this(new Idea56047Config());
    }

    public Idea56047Service(Idea56047Config config) {
        this.config = config != null ? config : new Idea56047Config();
