...
@Data
public class Idea55590Config {
    private String name = "idea_055590";
 ...
 */
@Slf4j
public class Idea55590Service {
    private static final int IDEA_ID = 55590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55590Service() {
        this(new Idea55590Config());
    }

    public Idea55590Service(Idea55590Config config) {
        this.config = config != null ? config : new Idea55590Config();
