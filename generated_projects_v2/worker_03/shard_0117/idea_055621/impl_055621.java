...
@Data
public class Idea55621Config {
    private String name = "idea_055621";
 ...
 */
@Slf4j
public class Idea55621Service {
    private static final int IDEA_ID = 55621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55621Service() {
        this(new Idea55621Config());
    }

    public Idea55621Service(Idea55621Config config) {
        this.config = config != null ? config : new Idea55621Config();
