...
@Data
public class Idea55995Config {
    private String name = "idea_055995";
 ...
 */
@Slf4j
public class Idea55995Service {
    private static final int IDEA_ID = 55995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55995Service() {
        this(new Idea55995Config());
    }

    public Idea55995Service(Idea55995Config config) {
        this.config = config != null ? config : new Idea55995Config();
