...
@Data
public class Idea55625Config {
    private String name = "idea_055625";
 ...
 */
@Slf4j
public class Idea55625Service {
    private static final int IDEA_ID = 55625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55625Service() {
        this(new Idea55625Config());
    }

    public Idea55625Service(Idea55625Config config) {
        this.config = config != null ? config : new Idea55625Config();
