...
@Data
public class Idea56011Config {
    private String name = "idea_056011";
 ...
 */
@Slf4j
public class Idea56011Service {
    private static final int IDEA_ID = 56011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56011Service() {
        this(new Idea56011Config());
    }

    public Idea56011Service(Idea56011Config config) {
        this.config = config != null ? config : new Idea56011Config();
