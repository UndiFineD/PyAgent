...
@Data
public class Idea55766Config {
    private String name = "idea_055766";
 ...
 */
@Slf4j
public class Idea55766Service {
    private static final int IDEA_ID = 55766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55766Service() {
        this(new Idea55766Config());
    }

    public Idea55766Service(Idea55766Config config) {
        this.config = config != null ? config : new Idea55766Config();
