...
@Data
public class Idea55596Config {
    private String name = "idea_055596";
 ...
 */
@Slf4j
public class Idea55596Service {
    private static final int IDEA_ID = 55596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55596Service() {
        this(new Idea55596Config());
    }

    public Idea55596Service(Idea55596Config config) {
        this.config = config != null ? config : new Idea55596Config();
