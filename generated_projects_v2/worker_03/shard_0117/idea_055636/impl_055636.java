...
@Data
public class Idea55636Config {
    private String name = "idea_055636";
 ...
 */
@Slf4j
public class Idea55636Service {
    private static final int IDEA_ID = 55636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55636Service() {
        this(new Idea55636Config());
    }

    public Idea55636Service(Idea55636Config config) {
        this.config = config != null ? config : new Idea55636Config();
