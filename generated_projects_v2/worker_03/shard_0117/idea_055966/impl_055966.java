...
@Data
public class Idea55966Config {
    private String name = "idea_055966";
 ...
 */
@Slf4j
public class Idea55966Service {
    private static final int IDEA_ID = 55966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55966Service() {
        this(new Idea55966Config());
    }

    public Idea55966Service(Idea55966Config config) {
        this.config = config != null ? config : new Idea55966Config();
