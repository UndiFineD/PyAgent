...
@Data
public class Idea55806Config {
    private String name = "idea_055806";
 ...
 */
@Slf4j
public class Idea55806Service {
    private static final int IDEA_ID = 55806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55806Service() {
        this(new Idea55806Config());
    }

    public Idea55806Service(Idea55806Config config) {
        this.config = config != null ? config : new Idea55806Config();
