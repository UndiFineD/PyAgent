...
@Data
public class Idea55771Config {
    private String name = "idea_055771";
 ...
 */
@Slf4j
public class Idea55771Service {
    private static final int IDEA_ID = 55771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55771Service() {
        this(new Idea55771Config());
    }

    public Idea55771Service(Idea55771Config config) {
        this.config = config != null ? config : new Idea55771Config();
