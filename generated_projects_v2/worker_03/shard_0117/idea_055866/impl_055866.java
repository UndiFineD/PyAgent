...
@Data
public class Idea55866Config {
    private String name = "idea_055866";
 ...
 */
@Slf4j
public class Idea55866Service {
    private static final int IDEA_ID = 55866;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55866Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55866Service() {
        this(new Idea55866Config());
    }

    public Idea55866Service(Idea55866Config config) {
        this.config = config != null ? config : new Idea55866Config();
