...
@Data
public class Idea55860Config {
    private String name = "idea_055860";
 ...
 */
@Slf4j
public class Idea55860Service {
    private static final int IDEA_ID = 55860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55860Service() {
        this(new Idea55860Config());
    }

    public Idea55860Service(Idea55860Config config) {
        this.config = config != null ? config : new Idea55860Config();
