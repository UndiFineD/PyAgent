...
@Data
public class Idea55808Config {
    private String name = "idea_055808";
 ...
 */
@Slf4j
public class Idea55808Service {
    private static final int IDEA_ID = 55808;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55808Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55808Service() {
        this(new Idea55808Config());
    }

    public Idea55808Service(Idea55808Config config) {
        this.config = config != null ? config : new Idea55808Config();
