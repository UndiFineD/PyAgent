...
@Data
public class Idea55635Config {
    private String name = "idea_055635";
 ...
 */
@Slf4j
public class Idea55635Service {
    private static final int IDEA_ID = 55635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55635Service() {
        this(new Idea55635Config());
    }

    public Idea55635Service(Idea55635Config config) {
        this.config = config != null ? config : new Idea55635Config();
