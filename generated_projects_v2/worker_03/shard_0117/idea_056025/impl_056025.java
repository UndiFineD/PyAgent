...
@Data
public class Idea56025Config {
    private String name = "idea_056025";
 ...
 */
@Slf4j
public class Idea56025Service {
    private static final int IDEA_ID = 56025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56025Service() {
        this(new Idea56025Config());
    }

    public Idea56025Service(Idea56025Config config) {
        this.config = config != null ? config : new Idea56025Config();
