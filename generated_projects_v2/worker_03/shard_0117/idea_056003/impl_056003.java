...
@Data
public class Idea56003Config {
    private String name = "idea_056003";
 ...
 */
@Slf4j
public class Idea56003Service {
    private static final int IDEA_ID = 56003;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56003Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56003Service() {
        this(new Idea56003Config());
    }

    public Idea56003Service(Idea56003Config config) {
        this.config = config != null ? config : new Idea56003Config();
