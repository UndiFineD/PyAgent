...
@Data
public class Idea55633Config {
    private String name = "idea_055633";
 ...
 */
@Slf4j
public class Idea55633Service {
    private static final int IDEA_ID = 55633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55633Service() {
        this(new Idea55633Config());
    }

    public Idea55633Service(Idea55633Config config) {
        this.config = config != null ? config : new Idea55633Config();
