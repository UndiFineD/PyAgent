...
@Data
public class Idea55646Config {
    private String name = "idea_055646";
 ...
 */
@Slf4j
public class Idea55646Service {
    private static final int IDEA_ID = 55646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55646Service() {
        this(new Idea55646Config());
    }

    public Idea55646Service(Idea55646Config config) {
        this.config = config != null ? config : new Idea55646Config();
