...
@Data
public class Idea55791Config {
    private String name = "idea_055791";
 ...
 */
@Slf4j
public class Idea55791Service {
    private static final int IDEA_ID = 55791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55791Service() {
        this(new Idea55791Config());
    }

    public Idea55791Service(Idea55791Config config) {
        this.config = config != null ? config : new Idea55791Config();
