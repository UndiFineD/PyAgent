...
@Data
public class Idea55923Config {
    private String name = "idea_055923";
 ...
 */
@Slf4j
public class Idea55923Service {
    private static final int IDEA_ID = 55923;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55923Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55923Service() {
        this(new Idea55923Config());
    }

    public Idea55923Service(Idea55923Config config) {
        this.config = config != null ? config : new Idea55923Config();
