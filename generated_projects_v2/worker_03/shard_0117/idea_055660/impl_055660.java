...
@Data
public class Idea55660Config {
    private String name = "idea_055660";
 ...
 */
@Slf4j
public class Idea55660Service {
    private static final int IDEA_ID = 55660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55660Service() {
        this(new Idea55660Config());
    }

    public Idea55660Service(Idea55660Config config) {
        this.config = config != null ? config : new Idea55660Config();
