...
@Data
public class Idea55655Config {
    private String name = "idea_055655";
 ...
 */
@Slf4j
public class Idea55655Service {
    private static final int IDEA_ID = 55655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55655Service() {
        this(new Idea55655Config());
    }

    public Idea55655Service(Idea55655Config config) {
        this.config = config != null ? config : new Idea55655Config();
