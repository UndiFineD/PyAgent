...
@Data
public class Idea55623Config {
    private String name = "idea_055623";
 ...
 */
@Slf4j
public class Idea55623Service {
    private static final int IDEA_ID = 55623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55623Service() {
        this(new Idea55623Config());
    }

    public Idea55623Service(Idea55623Config config) {
        this.config = config != null ? config : new Idea55623Config();
