...
@Data
public class Idea55900Config {
    private String name = "idea_055900";
 ...
 */
@Slf4j
public class Idea55900Service {
    private static final int IDEA_ID = 55900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55900Service() {
        this(new Idea55900Config());
    }

    public Idea55900Service(Idea55900Config config) {
        this.config = config != null ? config : new Idea55900Config();
