...
@Data
public class Idea56031Config {
    private String name = "idea_056031";
 ...
 */
@Slf4j
public class Idea56031Service {
    private static final int IDEA_ID = 56031;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56031Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56031Service() {
        this(new Idea56031Config());
    }

    public Idea56031Service(Idea56031Config config) {
        this.config = config != null ? config : new Idea56031Config();
