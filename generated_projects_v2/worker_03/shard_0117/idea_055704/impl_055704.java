...
@Data
public class Idea55704Config {
    private String name = "idea_055704";
 ...
 */
@Slf4j
public class Idea55704Service {
    private static final int IDEA_ID = 55704;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55704Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55704Service() {
        this(new Idea55704Config());
    }

    public Idea55704Service(Idea55704Config config) {
        this.config = config != null ? config : new Idea55704Config();
