...
@Data
public class Idea44802Config {
    private String name = "idea_044802";
 ...
 */
@Slf4j
public class Idea44802Service {
    private static final int IDEA_ID = 44802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44802Service() {
        this(new Idea44802Config());
    }

    public Idea44802Service(Idea44802Config config) {
        this.config = config != null ? config : new Idea44802Config();
