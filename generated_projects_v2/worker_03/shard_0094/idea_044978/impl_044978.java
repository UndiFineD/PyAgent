...
@Data
public class Idea44978Config {
    private String name = "idea_044978";
 ...
 */
@Slf4j
public class Idea44978Service {
    private static final int IDEA_ID = 44978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44978Service() {
        this(new Idea44978Config());
    }

    public Idea44978Service(Idea44978Config config) {
        this.config = config != null ? config : new Idea44978Config();
