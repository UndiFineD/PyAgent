...
@Data
public class Idea45091Config {
    private String name = "idea_045091";
 ...
 */
@Slf4j
public class Idea45091Service {
    private static final int IDEA_ID = 45091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45091Service() {
        this(new Idea45091Config());
    }

    public Idea45091Service(Idea45091Config config) {
        this.config = config != null ? config : new Idea45091Config();
