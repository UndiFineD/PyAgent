...
@Data
public class Idea45060Config {
    private String name = "idea_045060";
 ...
 */
@Slf4j
public class Idea45060Service {
    private static final int IDEA_ID = 45060;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45060Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45060Service() {
        this(new Idea45060Config());
    }

    public Idea45060Service(Idea45060Config config) {
        this.config = config != null ? config : new Idea45060Config();
