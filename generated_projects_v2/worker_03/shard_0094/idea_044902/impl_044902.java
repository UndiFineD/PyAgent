...
@Data
public class Idea44902Config {
    private String name = "idea_044902";
 ...
 */
@Slf4j
public class Idea44902Service {
    private static final int IDEA_ID = 44902;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44902Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44902Service() {
        this(new Idea44902Config());
    }

    public Idea44902Service(Idea44902Config config) {
        this.config = config != null ? config : new Idea44902Config();
