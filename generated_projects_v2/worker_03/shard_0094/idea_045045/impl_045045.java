...
@Data
public class Idea45045Config {
    private String name = "idea_045045";
 ...
 */
@Slf4j
public class Idea45045Service {
    private static final int IDEA_ID = 45045;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45045Service() {
        this(new Idea45045Config());
    }

    public Idea45045Service(Idea45045Config config) {
        this.config = config != null ? config : new Idea45045Config();
