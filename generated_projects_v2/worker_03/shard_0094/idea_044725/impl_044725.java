...
@Data
public class Idea44725Config {
    private String name = "idea_044725";
 ...
 */
@Slf4j
public class Idea44725Service {
    private static final int IDEA_ID = 44725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44725Service() {
        this(new Idea44725Config());
    }

    public Idea44725Service(Idea44725Config config) {
        this.config = config != null ? config : new Idea44725Config();
