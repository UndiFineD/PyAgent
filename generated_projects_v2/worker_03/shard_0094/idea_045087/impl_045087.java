...
@Data
public class Idea45087Config {
    private String name = "idea_045087";
 ...
 */
@Slf4j
public class Idea45087Service {
    private static final int IDEA_ID = 45087;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45087Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45087Service() {
        this(new Idea45087Config());
    }

    public Idea45087Service(Idea45087Config config) {
        this.config = config != null ? config : new Idea45087Config();
