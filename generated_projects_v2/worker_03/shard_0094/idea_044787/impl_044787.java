...
@Data
public class Idea44787Config {
    private String name = "idea_044787";
 ...
 */
@Slf4j
public class Idea44787Service {
    private static final int IDEA_ID = 44787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44787Service() {
        this(new Idea44787Config());
    }

    public Idea44787Service(Idea44787Config config) {
        this.config = config != null ? config : new Idea44787Config();
