...
@Data
public class Idea45111Config {
    private String name = "idea_045111";
 ...
 */
@Slf4j
public class Idea45111Service {
    private static final int IDEA_ID = 45111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45111Service() {
        this(new Idea45111Config());
    }

    public Idea45111Service(Idea45111Config config) {
        this.config = config != null ? config : new Idea45111Config();
