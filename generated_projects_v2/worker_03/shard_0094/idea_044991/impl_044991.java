...
@Data
public class Idea44991Config {
    private String name = "idea_044991";
 ...
 */
@Slf4j
public class Idea44991Service {
    private static final int IDEA_ID = 44991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44991Service() {
        this(new Idea44991Config());
    }

    public Idea44991Service(Idea44991Config config) {
        this.config = config != null ? config : new Idea44991Config();
