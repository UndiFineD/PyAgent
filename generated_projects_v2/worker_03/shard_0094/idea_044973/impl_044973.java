...
@Data
public class Idea44973Config {
    private String name = "idea_044973";
 ...
 */
@Slf4j
public class Idea44973Service {
    private static final int IDEA_ID = 44973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44973Service() {
        this(new Idea44973Config());
    }

    public Idea44973Service(Idea44973Config config) {
        this.config = config != null ? config : new Idea44973Config();
