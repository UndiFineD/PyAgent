...
@Data
public class Idea44797Config {
    private String name = "idea_044797";
 ...
 */
@Slf4j
public class Idea44797Service {
    private static final int IDEA_ID = 44797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44797Service() {
        this(new Idea44797Config());
    }

    public Idea44797Service(Idea44797Config config) {
        this.config = config != null ? config : new Idea44797Config();
