...
@Data
public class Idea44827Config {
    private String name = "idea_044827";
 ...
 */
@Slf4j
public class Idea44827Service {
    private static final int IDEA_ID = 44827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44827Service() {
        this(new Idea44827Config());
    }

    public Idea44827Service(Idea44827Config config) {
        this.config = config != null ? config : new Idea44827Config();
