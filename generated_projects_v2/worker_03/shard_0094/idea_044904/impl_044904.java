...
@Data
public class Idea44904Config {
    private String name = "idea_044904";
 ...
 */
@Slf4j
public class Idea44904Service {
    private static final int IDEA_ID = 44904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44904Service() {
        this(new Idea44904Config());
    }

    public Idea44904Service(Idea44904Config config) {
        this.config = config != null ? config : new Idea44904Config();
