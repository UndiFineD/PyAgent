...
@Data
public class Idea44896Config {
    private String name = "idea_044896";
 ...
 */
@Slf4j
public class Idea44896Service {
    private static final int IDEA_ID = 44896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44896Service() {
        this(new Idea44896Config());
    }

    public Idea44896Service(Idea44896Config config) {
        this.config = config != null ? config : new Idea44896Config();
