...
@Data
public class Idea45077Config {
    private String name = "idea_045077";
 ...
 */
@Slf4j
public class Idea45077Service {
    private static final int IDEA_ID = 45077;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45077Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45077Service() {
        this(new Idea45077Config());
    }

    public Idea45077Service(Idea45077Config config) {
        this.config = config != null ? config : new Idea45077Config();
