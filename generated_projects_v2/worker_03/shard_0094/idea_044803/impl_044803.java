...
@Data
public class Idea44803Config {
    private String name = "idea_044803";
 ...
 */
@Slf4j
public class Idea44803Service {
    private static final int IDEA_ID = 44803;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44803Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44803Service() {
        this(new Idea44803Config());
    }

    public Idea44803Service(Idea44803Config config) {
        this.config = config != null ? config : new Idea44803Config();
