...
@Data
public class Idea45061Config {
    private String name = "idea_045061";
 ...
 */
@Slf4j
public class Idea45061Service {
    private static final int IDEA_ID = 45061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45061Service() {
        this(new Idea45061Config());
    }

    public Idea45061Service(Idea45061Config config) {
        this.config = config != null ? config : new Idea45061Config();
