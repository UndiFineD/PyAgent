...
@Data
public class Idea45086Config {
    private String name = "idea_045086";
 ...
 */
@Slf4j
public class Idea45086Service {
    private static final int IDEA_ID = 45086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45086Service() {
        this(new Idea45086Config());
    }

    public Idea45086Service(Idea45086Config config) {
        this.config = config != null ? config : new Idea45086Config();
