...
@Data
public class Idea45025Config {
    private String name = "idea_045025";
 ...
 */
@Slf4j
public class Idea45025Service {
    private static final int IDEA_ID = 45025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45025Service() {
        this(new Idea45025Config());
    }

    public Idea45025Service(Idea45025Config config) {
        this.config = config != null ? config : new Idea45025Config();
