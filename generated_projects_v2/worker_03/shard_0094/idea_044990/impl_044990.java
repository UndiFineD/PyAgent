...
@Data
public class Idea44990Config {
    private String name = "idea_044990";
 ...
 */
@Slf4j
public class Idea44990Service {
    private static final int IDEA_ID = 44990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44990Service() {
        this(new Idea44990Config());
    }

    public Idea44990Service(Idea44990Config config) {
        this.config = config != null ? config : new Idea44990Config();
