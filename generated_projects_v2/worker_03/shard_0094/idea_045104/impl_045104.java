...
@Data
public class Idea45104Config {
    private String name = "idea_045104";
 ...
 */
@Slf4j
public class Idea45104Service {
    private static final int IDEA_ID = 45104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45104Service() {
        this(new Idea45104Config());
    }

    public Idea45104Service(Idea45104Config config) {
        this.config = config != null ? config : new Idea45104Config();
