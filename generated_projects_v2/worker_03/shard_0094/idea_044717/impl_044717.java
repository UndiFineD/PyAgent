...
@Data
public class Idea44717Config {
    private String name = "idea_044717";
 ...
 */
@Slf4j
public class Idea44717Service {
    private static final int IDEA_ID = 44717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44717Service() {
        this(new Idea44717Config());
    }

    public Idea44717Service(Idea44717Config config) {
        this.config = config != null ? config : new Idea44717Config();
