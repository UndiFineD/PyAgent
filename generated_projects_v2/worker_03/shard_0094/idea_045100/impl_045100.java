...
@Data
public class Idea45100Config {
    private String name = "idea_045100";
 ...
 */
@Slf4j
public class Idea45100Service {
    private static final int IDEA_ID = 45100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45100Service() {
        this(new Idea45100Config());
    }

    public Idea45100Service(Idea45100Config config) {
        this.config = config != null ? config : new Idea45100Config();
