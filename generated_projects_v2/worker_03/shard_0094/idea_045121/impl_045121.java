...
@Data
public class Idea45121Config {
    private String name = "idea_045121";
 ...
 */
@Slf4j
public class Idea45121Service {
    private static final int IDEA_ID = 45121;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45121Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45121Service() {
        this(new Idea45121Config());
    }

    public Idea45121Service(Idea45121Config config) {
        this.config = config != null ? config : new Idea45121Config();
