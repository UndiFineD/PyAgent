...
@Data
public class Idea44800Config {
    private String name = "idea_044800";
 ...
 */
@Slf4j
public class Idea44800Service {
    private static final int IDEA_ID = 44800;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44800Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44800Service() {
        this(new Idea44800Config());
    }

    public Idea44800Service(Idea44800Config config) {
        this.config = config != null ? config : new Idea44800Config();
