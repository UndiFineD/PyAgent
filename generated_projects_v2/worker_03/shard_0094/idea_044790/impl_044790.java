...
@Data
public class Idea44790Config {
    private String name = "idea_044790";
 ...
 */
@Slf4j
public class Idea44790Service {
    private static final int IDEA_ID = 44790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44790Service() {
        this(new Idea44790Config());
    }

    public Idea44790Service(Idea44790Config config) {
        this.config = config != null ? config : new Idea44790Config();
