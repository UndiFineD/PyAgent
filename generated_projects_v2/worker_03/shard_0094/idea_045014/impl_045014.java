...
@Data
public class Idea45014Config {
    private String name = "idea_045014";
 ...
 */
@Slf4j
public class Idea45014Service {
    private static final int IDEA_ID = 45014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45014Service() {
        this(new Idea45014Config());
    }

    public Idea45014Service(Idea45014Config config) {
        this.config = config != null ? config : new Idea45014Config();
