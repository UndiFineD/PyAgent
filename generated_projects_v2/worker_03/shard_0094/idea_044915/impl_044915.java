...
@Data
public class Idea44915Config {
    private String name = "idea_044915";
 ...
 */
@Slf4j
public class Idea44915Service {
    private static final int IDEA_ID = 44915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44915Service() {
        this(new Idea44915Config());
    }

    public Idea44915Service(Idea44915Config config) {
        this.config = config != null ? config : new Idea44915Config();
