...
@Data
public class Idea44844Config {
    private String name = "idea_044844";
 ...
 */
@Slf4j
public class Idea44844Service {
    private static final int IDEA_ID = 44844;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44844Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44844Service() {
        this(new Idea44844Config());
    }

    public Idea44844Service(Idea44844Config config) {
        this.config = config != null ? config : new Idea44844Config();
