...
@Data
public class Idea45102Config {
    private String name = "idea_045102";
 ...
 */
@Slf4j
public class Idea45102Service {
    private static final int IDEA_ID = 45102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45102Service() {
        this(new Idea45102Config());
    }

    public Idea45102Service(Idea45102Config config) {
        this.config = config != null ? config : new Idea45102Config();
