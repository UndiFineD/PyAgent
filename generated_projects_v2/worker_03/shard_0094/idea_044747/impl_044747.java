...
@Data
public class Idea44747Config {
    private String name = "idea_044747";
 ...
 */
@Slf4j
public class Idea44747Service {
    private static final int IDEA_ID = 44747;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44747Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44747Service() {
        this(new Idea44747Config());
    }

    public Idea44747Service(Idea44747Config config) {
        this.config = config != null ? config : new Idea44747Config();
