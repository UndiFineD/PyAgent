...
@Data
public class Idea44879Config {
    private String name = "idea_044879";
 ...
 */
@Slf4j
public class Idea44879Service {
    private static final int IDEA_ID = 44879;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44879Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44879Service() {
        this(new Idea44879Config());
    }

    public Idea44879Service(Idea44879Config config) {
        this.config = config != null ? config : new Idea44879Config();
