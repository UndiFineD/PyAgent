...
@Data
public class Idea44737Config {
    private String name = "idea_044737";
 ...
 */
@Slf4j
public class Idea44737Service {
    private static final int IDEA_ID = 44737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44737Service() {
        this(new Idea44737Config());
    }

    public Idea44737Service(Idea44737Config config) {
        this.config = config != null ? config : new Idea44737Config();
