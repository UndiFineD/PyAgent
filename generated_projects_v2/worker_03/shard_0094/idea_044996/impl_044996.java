...
@Data
public class Idea44996Config {
    private String name = "idea_044996";
 ...
 */
@Slf4j
public class Idea44996Service {
    private static final int IDEA_ID = 44996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44996Service() {
        this(new Idea44996Config());
    }

    public Idea44996Service(Idea44996Config config) {
        this.config = config != null ? config : new Idea44996Config();
