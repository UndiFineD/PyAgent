...
@Data
public class Idea44731Config {
    private String name = "idea_044731";
 ...
 */
@Slf4j
public class Idea44731Service {
    private static final int IDEA_ID = 44731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44731Service() {
        this(new Idea44731Config());
    }

    public Idea44731Service(Idea44731Config config) {
        this.config = config != null ? config : new Idea44731Config();
