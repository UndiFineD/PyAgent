...
@Data
public class Idea45124Config {
    private String name = "idea_045124";
 ...
 */
@Slf4j
public class Idea45124Service {
    private static final int IDEA_ID = 45124;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45124Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45124Service() {
        this(new Idea45124Config());
    }

    public Idea45124Service(Idea45124Config config) {
        this.config = config != null ? config : new Idea45124Config();
