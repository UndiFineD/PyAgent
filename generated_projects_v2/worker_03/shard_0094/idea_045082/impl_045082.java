...
@Data
public class Idea45082Config {
    private String name = "idea_045082";
 ...
 */
@Slf4j
public class Idea45082Service {
    private static final int IDEA_ID = 45082;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45082Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45082Service() {
        this(new Idea45082Config());
    }

    public Idea45082Service(Idea45082Config config) {
        this.config = config != null ? config : new Idea45082Config();
