...
@Data
public class Idea45002Config {
    private String name = "idea_045002";
 ...
 */
@Slf4j
public class Idea45002Service {
    private static final int IDEA_ID = 45002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45002Service() {
        this(new Idea45002Config());
    }

    public Idea45002Service(Idea45002Config config) {
        this.config = config != null ? config : new Idea45002Config();
