...
@Data
public class Idea44677Config {
    private String name = "idea_044677";
 ...
 */
@Slf4j
public class Idea44677Service {
    private static final int IDEA_ID = 44677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44677Service() {
        this(new Idea44677Config());
    }

    public Idea44677Service(Idea44677Config config) {
        this.config = config != null ? config : new Idea44677Config();
