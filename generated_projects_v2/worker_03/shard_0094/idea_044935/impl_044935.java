...
@Data
public class Idea44935Config {
    private String name = "idea_044935";
 ...
 */
@Slf4j
public class Idea44935Service {
    private static final int IDEA_ID = 44935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44935Service() {
        this(new Idea44935Config());
    }

    public Idea44935Service(Idea44935Config config) {
        this.config = config != null ? config : new Idea44935Config();
