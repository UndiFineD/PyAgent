...
@Data
public class Idea45013Config {
    private String name = "idea_045013";
 ...
 */
@Slf4j
public class Idea45013Service {
    private static final int IDEA_ID = 45013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45013Service() {
        this(new Idea45013Config());
    }

    public Idea45013Service(Idea45013Config config) {
        this.config = config != null ? config : new Idea45013Config();
