...
@Data
public class Idea44830Config {
    private String name = "idea_044830";
 ...
 */
@Slf4j
public class Idea44830Service {
    private static final int IDEA_ID = 44830;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44830Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44830Service() {
        this(new Idea44830Config());
    }

    public Idea44830Service(Idea44830Config config) {
        this.config = config != null ? config : new Idea44830Config();
