...
@Data
public class Idea44784Config {
    private String name = "idea_044784";
 ...
 */
@Slf4j
public class Idea44784Service {
    private static final int IDEA_ID = 44784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44784Service() {
        this(new Idea44784Config());
    }

    public Idea44784Service(Idea44784Config config) {
        this.config = config != null ? config : new Idea44784Config();
