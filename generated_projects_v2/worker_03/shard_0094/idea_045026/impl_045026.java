...
@Data
public class Idea45026Config {
    private String name = "idea_045026";
 ...
 */
@Slf4j
public class Idea45026Service {
    private static final int IDEA_ID = 45026;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45026Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45026Service() {
        this(new Idea45026Config());
    }

    public Idea45026Service(Idea45026Config config) {
        this.config = config != null ? config : new Idea45026Config();
