...
@Data
public class Idea44857Config {
    private String name = "idea_044857";
 ...
 */
@Slf4j
public class Idea44857Service {
    private static final int IDEA_ID = 44857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44857Service() {
        this(new Idea44857Config());
    }

    public Idea44857Service(Idea44857Config config) {
        this.config = config != null ? config : new Idea44857Config();
