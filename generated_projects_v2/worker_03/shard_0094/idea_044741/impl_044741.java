...
@Data
public class Idea44741Config {
    private String name = "idea_044741";
 ...
 */
@Slf4j
public class Idea44741Service {
    private static final int IDEA_ID = 44741;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44741Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44741Service() {
        this(new Idea44741Config());
    }

    public Idea44741Service(Idea44741Config config) {
        this.config = config != null ? config : new Idea44741Config();
