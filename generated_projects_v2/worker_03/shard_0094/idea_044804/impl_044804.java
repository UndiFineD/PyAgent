...
@Data
public class Idea44804Config {
    private String name = "idea_044804";
 ...
 */
@Slf4j
public class Idea44804Service {
    private static final int IDEA_ID = 44804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44804Service() {
        this(new Idea44804Config());
    }

    public Idea44804Service(Idea44804Config config) {
        this.config = config != null ? config : new Idea44804Config();
