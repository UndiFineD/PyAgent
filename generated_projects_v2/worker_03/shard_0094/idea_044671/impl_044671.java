...
@Data
public class Idea44671Config {
    private String name = "idea_044671";
 ...
 */
@Slf4j
public class Idea44671Service {
    private static final int IDEA_ID = 44671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44671Service() {
        this(new Idea44671Config());
    }

    public Idea44671Service(Idea44671Config config) {
        this.config = config != null ? config : new Idea44671Config();
