...
@Data
public class Idea44833Config {
    private String name = "idea_044833";
 ...
 */
@Slf4j
public class Idea44833Service {
    private static final int IDEA_ID = 44833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44833Service() {
        this(new Idea44833Config());
    }

    public Idea44833Service(Idea44833Config config) {
        this.config = config != null ? config : new Idea44833Config();
