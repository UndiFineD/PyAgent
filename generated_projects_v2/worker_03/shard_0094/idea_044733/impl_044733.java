...
@Data
public class Idea44733Config {
    private String name = "idea_044733";
 ...
 */
@Slf4j
public class Idea44733Service {
    private static final int IDEA_ID = 44733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44733Service() {
        this(new Idea44733Config());
    }

    public Idea44733Service(Idea44733Config config) {
        this.config = config != null ? config : new Idea44733Config();
