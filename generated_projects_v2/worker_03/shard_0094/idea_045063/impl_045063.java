...
@Data
public class Idea45063Config {
    private String name = "idea_045063";
 ...
 */
@Slf4j
public class Idea45063Service {
    private static final int IDEA_ID = 45063;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45063Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45063Service() {
        this(new Idea45063Config());
    }

    public Idea45063Service(Idea45063Config config) {
        this.config = config != null ? config : new Idea45063Config();
