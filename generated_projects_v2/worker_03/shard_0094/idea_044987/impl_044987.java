...
@Data
public class Idea44987Config {
    private String name = "idea_044987";
 ...
 */
@Slf4j
public class Idea44987Service {
    private static final int IDEA_ID = 44987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44987Service() {
        this(new Idea44987Config());
    }

    public Idea44987Service(Idea44987Config config) {
        this.config = config != null ? config : new Idea44987Config();
