...
@Data
public class Idea45006Config {
    private String name = "idea_045006";
 ...
 */
@Slf4j
public class Idea45006Service {
    private static final int IDEA_ID = 45006;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45006Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45006Service() {
        this(new Idea45006Config());
    }

    public Idea45006Service(Idea45006Config config) {
        this.config = config != null ? config : new Idea45006Config();
