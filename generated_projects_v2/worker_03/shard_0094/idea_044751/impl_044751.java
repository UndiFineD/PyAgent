...
@Data
public class Idea44751Config {
    private String name = "idea_044751";
 ...
 */
@Slf4j
public class Idea44751Service {
    private static final int IDEA_ID = 44751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44751Service() {
        this(new Idea44751Config());
    }

    public Idea44751Service(Idea44751Config config) {
        this.config = config != null ? config : new Idea44751Config();
