...
@Data
public class Idea44944Config {
    private String name = "idea_044944";
 ...
 */
@Slf4j
public class Idea44944Service {
    private static final int IDEA_ID = 44944;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44944Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44944Service() {
        this(new Idea44944Config());
    }

    public Idea44944Service(Idea44944Config config) {
        this.config = config != null ? config : new Idea44944Config();
