...
@Data
public class Idea45095Config {
    private String name = "idea_045095";
 ...
 */
@Slf4j
public class Idea45095Service {
    private static final int IDEA_ID = 45095;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45095Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45095Service() {
        this(new Idea45095Config());
    }

    public Idea45095Service(Idea45095Config config) {
        this.config = config != null ? config : new Idea45095Config();
