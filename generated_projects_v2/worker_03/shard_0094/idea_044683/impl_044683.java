...
@Data
public class Idea44683Config {
    private String name = "idea_044683";
 ...
 */
@Slf4j
public class Idea44683Service {
    private static final int IDEA_ID = 44683;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44683Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44683Service() {
        this(new Idea44683Config());
    }

    public Idea44683Service(Idea44683Config config) {
        this.config = config != null ? config : new Idea44683Config();
