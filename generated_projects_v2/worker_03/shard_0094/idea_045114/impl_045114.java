...
@Data
public class Idea45114Config {
    private String name = "idea_045114";
 ...
 */
@Slf4j
public class Idea45114Service {
    private static final int IDEA_ID = 45114;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45114Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45114Service() {
        this(new Idea45114Config());
    }

    public Idea45114Service(Idea45114Config config) {
        this.config = config != null ? config : new Idea45114Config();
