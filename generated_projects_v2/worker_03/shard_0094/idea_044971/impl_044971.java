...
@Data
public class Idea44971Config {
    private String name = "idea_044971";
 ...
 */
@Slf4j
public class Idea44971Service {
    private static final int IDEA_ID = 44971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44971Service() {
        this(new Idea44971Config());
    }

    public Idea44971Service(Idea44971Config config) {
        this.config = config != null ? config : new Idea44971Config();
