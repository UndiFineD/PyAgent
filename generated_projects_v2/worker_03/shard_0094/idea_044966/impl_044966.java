...
@Data
public class Idea44966Config {
    private String name = "idea_044966";
 ...
 */
@Slf4j
public class Idea44966Service {
    private static final int IDEA_ID = 44966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44966Service() {
        this(new Idea44966Config());
    }

    public Idea44966Service(Idea44966Config config) {
        this.config = config != null ? config : new Idea44966Config();
