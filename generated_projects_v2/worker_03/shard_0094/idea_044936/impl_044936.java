...
@Data
public class Idea44936Config {
    private String name = "idea_044936";
 ...
 */
@Slf4j
public class Idea44936Service {
    private static final int IDEA_ID = 44936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44936Service() {
        this(new Idea44936Config());
    }

    public Idea44936Service(Idea44936Config config) {
        this.config = config != null ? config : new Idea44936Config();
