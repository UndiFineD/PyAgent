...
@Data
public class Idea44705Config {
    private String name = "idea_044705";
 ...
 */
@Slf4j
public class Idea44705Service {
    private static final int IDEA_ID = 44705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44705Service() {
        this(new Idea44705Config());
    }

    public Idea44705Service(Idea44705Config config) {
        this.config = config != null ? config : new Idea44705Config();
