...
@Data
public class Idea44937Config {
    private String name = "idea_044937";
 ...
 */
@Slf4j
public class Idea44937Service {
    private static final int IDEA_ID = 44937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44937Service() {
        this(new Idea44937Config());
    }

    public Idea44937Service(Idea44937Config config) {
        this.config = config != null ? config : new Idea44937Config();
