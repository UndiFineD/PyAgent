...
@Data
public class Idea44840Config {
    private String name = "idea_044840";
 ...
 */
@Slf4j
public class Idea44840Service {
    private static final int IDEA_ID = 44840;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44840Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44840Service() {
        this(new Idea44840Config());
    }

    public Idea44840Service(Idea44840Config config) {
        this.config = config != null ? config : new Idea44840Config();
