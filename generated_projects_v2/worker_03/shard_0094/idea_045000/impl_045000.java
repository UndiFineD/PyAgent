...
@Data
public class Idea45000Config {
    private String name = "idea_045000";
 ...
 */
@Slf4j
public class Idea45000Service {
    private static final int IDEA_ID = 45000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45000Service() {
        this(new Idea45000Config());
    }

    public Idea45000Service(Idea45000Config config) {
        this.config = config != null ? config : new Idea45000Config();
