...
@Data
public class Idea44823Config {
    private String name = "idea_044823";
 ...
 */
@Slf4j
public class Idea44823Service {
    private static final int IDEA_ID = 44823;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44823Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44823Service() {
        this(new Idea44823Config());
    }

    public Idea44823Service(Idea44823Config config) {
        this.config = config != null ? config : new Idea44823Config();
