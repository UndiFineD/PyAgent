...
@Data
public class Idea44861Config {
    private String name = "idea_044861";
 ...
 */
@Slf4j
public class Idea44861Service {
    private static final int IDEA_ID = 44861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44861Service() {
        this(new Idea44861Config());
    }

    public Idea44861Service(Idea44861Config config) {
        this.config = config != null ? config : new Idea44861Config();
