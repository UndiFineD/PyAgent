...
@Data
public class Idea44791Config {
    private String name = "idea_044791";
 ...
 */
@Slf4j
public class Idea44791Service {
    private static final int IDEA_ID = 44791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44791Service() {
        this(new Idea44791Config());
    }

    public Idea44791Service(Idea44791Config config) {
        this.config = config != null ? config : new Idea44791Config();
