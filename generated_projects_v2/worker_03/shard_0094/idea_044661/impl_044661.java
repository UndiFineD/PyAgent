...
@Data
public class Idea44661Config {
    private String name = "idea_044661";
 ...
 */
@Slf4j
public class Idea44661Service {
    private static final int IDEA_ID = 44661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44661Service() {
        this(new Idea44661Config());
    }

    public Idea44661Service(Idea44661Config config) {
        this.config = config != null ? config : new Idea44661Config();
