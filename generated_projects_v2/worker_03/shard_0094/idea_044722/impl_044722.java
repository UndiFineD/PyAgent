...
@Data
public class Idea44722Config {
    private String name = "idea_044722";
 ...
 */
@Slf4j
public class Idea44722Service {
    private static final int IDEA_ID = 44722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44722Service() {
        this(new Idea44722Config());
    }

    public Idea44722Service(Idea44722Config config) {
        this.config = config != null ? config : new Idea44722Config();
