...
@Data
public class Idea44773Config {
    private String name = "idea_044773";
 ...
 */
@Slf4j
public class Idea44773Service {
    private static final int IDEA_ID = 44773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44773Service() {
        this(new Idea44773Config());
    }

    public Idea44773Service(Idea44773Config config) {
        this.config = config != null ? config : new Idea44773Config();
