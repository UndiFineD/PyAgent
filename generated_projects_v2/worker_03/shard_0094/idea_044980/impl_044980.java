...
@Data
public class Idea44980Config {
    private String name = "idea_044980";
 ...
 */
@Slf4j
public class Idea44980Service {
    private static final int IDEA_ID = 44980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44980Service() {
        this(new Idea44980Config());
    }

    public Idea44980Service(Idea44980Config config) {
        this.config = config != null ? config : new Idea44980Config();
