...
@Data
public class Idea45018Config {
    private String name = "idea_045018";
 ...
 */
@Slf4j
public class Idea45018Service {
    private static final int IDEA_ID = 45018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45018Service() {
        this(new Idea45018Config());
    }

    public Idea45018Service(Idea45018Config config) {
        this.config = config != null ? config : new Idea45018Config();
