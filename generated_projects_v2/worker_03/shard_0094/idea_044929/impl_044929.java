...
@Data
public class Idea44929Config {
    private String name = "idea_044929";
 ...
 */
@Slf4j
public class Idea44929Service {
    private static final int IDEA_ID = 44929;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44929Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44929Service() {
        this(new Idea44929Config());
    }

    public Idea44929Service(Idea44929Config config) {
        this.config = config != null ? config : new Idea44929Config();
