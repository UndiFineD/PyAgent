...
@Data
public class Idea45084Config {
    private String name = "idea_045084";
 ...
 */
@Slf4j
public class Idea45084Service {
    private static final int IDEA_ID = 45084;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45084Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45084Service() {
        this(new Idea45084Config());
    }

    public Idea45084Service(Idea45084Config config) {
        this.config = config != null ? config : new Idea45084Config();
