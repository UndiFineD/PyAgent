...
@Data
public class Idea44900Config {
    private String name = "idea_044900";
 ...
 */
@Slf4j
public class Idea44900Service {
    private static final int IDEA_ID = 44900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44900Service() {
        this(new Idea44900Config());
    }

    public Idea44900Service(Idea44900Config config) {
        this.config = config != null ? config : new Idea44900Config();
