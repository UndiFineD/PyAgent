...
@Data
public class Idea44721Config {
    private String name = "idea_044721";
 ...
 */
@Slf4j
public class Idea44721Service {
    private static final int IDEA_ID = 44721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44721Service() {
        this(new Idea44721Config());
    }

    public Idea44721Service(Idea44721Config config) {
        this.config = config != null ? config : new Idea44721Config();
