...
@Data
public class Idea44703Config {
    private String name = "idea_044703";
 ...
 */
@Slf4j
public class Idea44703Service {
    private static final int IDEA_ID = 44703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44703Service() {
        this(new Idea44703Config());
    }

    public Idea44703Service(Idea44703Config config) {
        this.config = config != null ? config : new Idea44703Config();
