...
@Data
public class Idea45122Config {
    private String name = "idea_045122";
 ...
 */
@Slf4j
public class Idea45122Service {
    private static final int IDEA_ID = 45122;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45122Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45122Service() {
        this(new Idea45122Config());
    }

    public Idea45122Service(Idea45122Config config) {
        this.config = config != null ? config : new Idea45122Config();
