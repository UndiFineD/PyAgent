...
@Data
public class Idea45046Config {
    private String name = "idea_045046";
 ...
 */
@Slf4j
public class Idea45046Service {
    private static final int IDEA_ID = 45046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45046Service() {
        this(new Idea45046Config());
    }

    public Idea45046Service(Idea45046Config config) {
        this.config = config != null ? config : new Idea45046Config();
