...
@Data
public class Idea45099Config {
    private String name = "idea_045099";
 ...
 */
@Slf4j
public class Idea45099Service {
    private static final int IDEA_ID = 45099;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45099Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45099Service() {
        this(new Idea45099Config());
    }

    public Idea45099Service(Idea45099Config config) {
        this.config = config != null ? config : new Idea45099Config();
