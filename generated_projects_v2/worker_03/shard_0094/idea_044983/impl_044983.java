...
@Data
public class Idea44983Config {
    private String name = "idea_044983";
 ...
 */
@Slf4j
public class Idea44983Service {
    private static final int IDEA_ID = 44983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44983Service() {
        this(new Idea44983Config());
    }

    public Idea44983Service(Idea44983Config config) {
        this.config = config != null ? config : new Idea44983Config();
