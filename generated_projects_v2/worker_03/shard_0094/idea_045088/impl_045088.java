...
@Data
public class Idea45088Config {
    private String name = "idea_045088";
 ...
 */
@Slf4j
public class Idea45088Service {
    private static final int IDEA_ID = 45088;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45088Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45088Service() {
        this(new Idea45088Config());
    }

    public Idea45088Service(Idea45088Config config) {
        this.config = config != null ? config : new Idea45088Config();
