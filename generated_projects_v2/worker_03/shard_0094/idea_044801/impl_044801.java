...
@Data
public class Idea44801Config {
    private String name = "idea_044801";
 ...
 */
@Slf4j
public class Idea44801Service {
    private static final int IDEA_ID = 44801;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44801Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44801Service() {
        this(new Idea44801Config());
    }

    public Idea44801Service(Idea44801Config config) {
        this.config = config != null ? config : new Idea44801Config();
