...
@Data
public class Idea45009Config {
    private String name = "idea_045009";
 ...
 */
@Slf4j
public class Idea45009Service {
    private static final int IDEA_ID = 45009;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45009Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45009Service() {
        this(new Idea45009Config());
    }

    public Idea45009Service(Idea45009Config config) {
        this.config = config != null ? config : new Idea45009Config();
