...
@Data
public class Idea44678Config {
    private String name = "idea_044678";
 ...
 */
@Slf4j
public class Idea44678Service {
    private static final int IDEA_ID = 44678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44678Service() {
        this(new Idea44678Config());
    }

    public Idea44678Service(Idea44678Config config) {
        this.config = config != null ? config : new Idea44678Config();
