...
@Data
public class Idea44960Config {
    private String name = "idea_044960";
 ...
 */
@Slf4j
public class Idea44960Service {
    private static final int IDEA_ID = 44960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44960Service() {
        this(new Idea44960Config());
    }

    public Idea44960Service(Idea44960Config config) {
        this.config = config != null ? config : new Idea44960Config();
