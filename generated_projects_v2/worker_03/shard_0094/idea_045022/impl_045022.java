...
@Data
public class Idea45022Config {
    private String name = "idea_045022";
 ...
 */
@Slf4j
public class Idea45022Service {
    private static final int IDEA_ID = 45022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45022Service() {
        this(new Idea45022Config());
    }

    public Idea45022Service(Idea45022Config config) {
        this.config = config != null ? config : new Idea45022Config();
