...
@Data
public class Idea44820Config {
    private String name = "idea_044820";
 ...
 */
@Slf4j
public class Idea44820Service {
    private static final int IDEA_ID = 44820;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44820Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44820Service() {
        this(new Idea44820Config());
    }

    public Idea44820Service(Idea44820Config config) {
        this.config = config != null ? config : new Idea44820Config();
