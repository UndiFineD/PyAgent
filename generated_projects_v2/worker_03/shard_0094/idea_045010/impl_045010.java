...
@Data
public class Idea45010Config {
    private String name = "idea_045010";
 ...
 */
@Slf4j
public class Idea45010Service {
    private static final int IDEA_ID = 45010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45010Service() {
        this(new Idea45010Config());
    }

    public Idea45010Service(Idea45010Config config) {
        this.config = config != null ? config : new Idea45010Config();
