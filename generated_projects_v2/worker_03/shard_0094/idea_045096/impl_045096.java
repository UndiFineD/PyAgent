...
@Data
public class Idea45096Config {
    private String name = "idea_045096";
 ...
 */
@Slf4j
public class Idea45096Service {
    private static final int IDEA_ID = 45096;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45096Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45096Service() {
        this(new Idea45096Config());
    }

    public Idea45096Service(Idea45096Config config) {
        this.config = config != null ? config : new Idea45096Config();
