...
@Data
public class Idea45117Config {
    private String name = "idea_045117";
 ...
 */
@Slf4j
public class Idea45117Service {
    private static final int IDEA_ID = 45117;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45117Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45117Service() {
        this(new Idea45117Config());
    }

    public Idea45117Service(Idea45117Config config) {
        this.config = config != null ? config : new Idea45117Config();
