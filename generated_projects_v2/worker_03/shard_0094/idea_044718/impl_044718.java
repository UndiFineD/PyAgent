...
@Data
public class Idea44718Config {
    private String name = "idea_044718";
 ...
 */
@Slf4j
public class Idea44718Service {
    private static final int IDEA_ID = 44718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44718Service() {
        this(new Idea44718Config());
    }

    public Idea44718Service(Idea44718Config config) {
        this.config = config != null ? config : new Idea44718Config();
