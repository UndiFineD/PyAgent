...
@Data
public class Idea44950Config {
    private String name = "idea_044950";
 ...
 */
@Slf4j
public class Idea44950Service {
    private static final int IDEA_ID = 44950;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44950Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44950Service() {
        this(new Idea44950Config());
    }

    public Idea44950Service(Idea44950Config config) {
        this.config = config != null ? config : new Idea44950Config();
