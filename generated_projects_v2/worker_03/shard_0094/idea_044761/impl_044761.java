...
@Data
public class Idea44761Config {
    private String name = "idea_044761";
 ...
 */
@Slf4j
public class Idea44761Service {
    private static final int IDEA_ID = 44761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44761Service() {
        this(new Idea44761Config());
    }

    public Idea44761Service(Idea44761Config config) {
        this.config = config != null ? config : new Idea44761Config();
