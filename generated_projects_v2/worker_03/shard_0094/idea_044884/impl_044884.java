...
@Data
public class Idea44884Config {
    private String name = "idea_044884";
 ...
 */
@Slf4j
public class Idea44884Service {
    private static final int IDEA_ID = 44884;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44884Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44884Service() {
        this(new Idea44884Config());
    }

    public Idea44884Service(Idea44884Config config) {
        this.config = config != null ? config : new Idea44884Config();
