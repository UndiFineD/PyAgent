...
@Data
public class Idea45021Config {
    private String name = "idea_045021";
 ...
 */
@Slf4j
public class Idea45021Service {
    private static final int IDEA_ID = 45021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45021Service() {
        this(new Idea45021Config());
    }

    public Idea45021Service(Idea45021Config config) {
        this.config = config != null ? config : new Idea45021Config();
