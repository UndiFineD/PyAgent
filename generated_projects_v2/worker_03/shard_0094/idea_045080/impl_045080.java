...
@Data
public class Idea45080Config {
    private String name = "idea_045080";
 ...
 */
@Slf4j
public class Idea45080Service {
    private static final int IDEA_ID = 45080;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45080Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45080Service() {
        this(new Idea45080Config());
    }

    public Idea45080Service(Idea45080Config config) {
        this.config = config != null ? config : new Idea45080Config();
