...
@Data
public class Idea45001Config {
    private String name = "idea_045001";
 ...
 */
@Slf4j
public class Idea45001Service {
    private static final int IDEA_ID = 45001;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45001Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45001Service() {
        this(new Idea45001Config());
    }

    public Idea45001Service(Idea45001Config config) {
        this.config = config != null ? config : new Idea45001Config();
