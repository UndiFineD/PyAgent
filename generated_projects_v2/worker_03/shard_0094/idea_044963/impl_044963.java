...
@Data
public class Idea44963Config {
    private String name = "idea_044963";
 ...
 */
@Slf4j
public class Idea44963Service {
    private static final int IDEA_ID = 44963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44963Service() {
        this(new Idea44963Config());
    }

    public Idea44963Service(Idea44963Config config) {
        this.config = config != null ? config : new Idea44963Config();
