...
@Data
public class Idea45090Config {
    private String name = "idea_045090";
 ...
 */
@Slf4j
public class Idea45090Service {
    private static final int IDEA_ID = 45090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45090Service() {
        this(new Idea45090Config());
    }

    public Idea45090Service(Idea45090Config config) {
        this.config = config != null ? config : new Idea45090Config();
