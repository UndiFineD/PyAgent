...
@Data
public class Idea44841Config {
    private String name = "idea_044841";
 ...
 */
@Slf4j
public class Idea44841Service {
    private static final int IDEA_ID = 44841;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44841Service() {
        this(new Idea44841Config());
    }

    public Idea44841Service(Idea44841Config config) {
        this.config = config != null ? config : new Idea44841Config();
