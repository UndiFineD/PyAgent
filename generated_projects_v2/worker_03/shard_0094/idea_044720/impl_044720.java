...
@Data
public class Idea44720Config {
    private String name = "idea_044720";
 ...
 */
@Slf4j
public class Idea44720Service {
    private static final int IDEA_ID = 44720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44720Service() {
        this(new Idea44720Config());
    }

    public Idea44720Service(Idea44720Config config) {
        this.config = config != null ? config : new Idea44720Config();
