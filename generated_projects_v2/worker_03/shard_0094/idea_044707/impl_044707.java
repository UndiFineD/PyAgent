...
@Data
public class Idea44707Config {
    private String name = "idea_044707";
 ...
 */
@Slf4j
public class Idea44707Service {
    private static final int IDEA_ID = 44707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44707Service() {
        this(new Idea44707Config());
    }

    public Idea44707Service(Idea44707Config config) {
        this.config = config != null ? config : new Idea44707Config();
