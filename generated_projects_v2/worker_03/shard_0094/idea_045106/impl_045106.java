...
@Data
public class Idea45106Config {
    private String name = "idea_045106";
 ...
 */
@Slf4j
public class Idea45106Service {
    private static final int IDEA_ID = 45106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45106Service() {
        this(new Idea45106Config());
    }

    public Idea45106Service(Idea45106Config config) {
        this.config = config != null ? config : new Idea45106Config();
