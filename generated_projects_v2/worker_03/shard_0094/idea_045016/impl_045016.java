...
@Data
public class Idea45016Config {
    private String name = "idea_045016";
 ...
 */
@Slf4j
public class Idea45016Service {
    private static final int IDEA_ID = 45016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45016Service() {
        this(new Idea45016Config());
    }

    public Idea45016Service(Idea45016Config config) {
        this.config = config != null ? config : new Idea45016Config();
