...
@Data
public class Idea44817Config {
    private String name = "idea_044817";
 ...
 */
@Slf4j
public class Idea44817Service {
    private static final int IDEA_ID = 44817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44817Service() {
        this(new Idea44817Config());
    }

    public Idea44817Service(Idea44817Config config) {
        this.config = config != null ? config : new Idea44817Config();
