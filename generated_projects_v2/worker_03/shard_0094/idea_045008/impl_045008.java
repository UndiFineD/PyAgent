...
@Data
public class Idea45008Config {
    private String name = "idea_045008";
 ...
 */
@Slf4j
public class Idea45008Service {
    private static final int IDEA_ID = 45008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45008Service() {
        this(new Idea45008Config());
    }

    public Idea45008Service(Idea45008Config config) {
        this.config = config != null ? config : new Idea45008Config();
