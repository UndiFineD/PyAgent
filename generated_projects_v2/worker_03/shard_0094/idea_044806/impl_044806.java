...
@Data
public class Idea44806Config {
    private String name = "idea_044806";
 ...
 */
@Slf4j
public class Idea44806Service {
    private static final int IDEA_ID = 44806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44806Service() {
        this(new Idea44806Config());
    }

    public Idea44806Service(Idea44806Config config) {
        this.config = config != null ? config : new Idea44806Config();
