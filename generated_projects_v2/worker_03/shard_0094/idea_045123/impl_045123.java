...
@Data
public class Idea45123Config {
    private String name = "idea_045123";
 ...
 */
@Slf4j
public class Idea45123Service {
    private static final int IDEA_ID = 45123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45123Service() {
        this(new Idea45123Config());
    }

    public Idea45123Service(Idea45123Config config) {
        this.config = config != null ? config : new Idea45123Config();
