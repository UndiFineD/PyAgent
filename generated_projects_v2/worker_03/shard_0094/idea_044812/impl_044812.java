...
@Data
public class Idea44812Config {
    private String name = "idea_044812";
 ...
 */
@Slf4j
public class Idea44812Service {
    private static final int IDEA_ID = 44812;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44812Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44812Service() {
        this(new Idea44812Config());
    }

    public Idea44812Service(Idea44812Config config) {
        this.config = config != null ? config : new Idea44812Config();
