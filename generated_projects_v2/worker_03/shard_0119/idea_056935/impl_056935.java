...
@Data
public class Idea56935Config {
    private String name = "idea_056935";
 ...
 */
@Slf4j
public class Idea56935Service {
    private static final int IDEA_ID = 56935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56935Service() {
        this(new Idea56935Config());
    }

    public Idea56935Service(Idea56935Config config) {
        this.config = config != null ? config : new Idea56935Config();
