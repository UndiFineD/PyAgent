...
@Data
public class Idea56966Config {
    private String name = "idea_056966";
 ...
 */
@Slf4j
public class Idea56966Service {
    private static final int IDEA_ID = 56966;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56966Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56966Service() {
        this(new Idea56966Config());
    }

    public Idea56966Service(Idea56966Config config) {
        this.config = config != null ? config : new Idea56966Config();
