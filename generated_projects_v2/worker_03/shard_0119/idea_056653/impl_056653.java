...
@Data
public class Idea56653Config {
    private String name = "idea_056653";
 ...
 */
@Slf4j
public class Idea56653Service {
    private static final int IDEA_ID = 56653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56653Service() {
        this(new Idea56653Config());
    }

    public Idea56653Service(Idea56653Config config) {
        this.config = config != null ? config : new Idea56653Config();
