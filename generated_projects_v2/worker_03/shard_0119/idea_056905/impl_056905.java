...
@Data
public class Idea56905Config {
    private String name = "idea_056905";
 ...
 */
@Slf4j
public class Idea56905Service {
    private static final int IDEA_ID = 56905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56905Service() {
        this(new Idea56905Config());
    }

    public Idea56905Service(Idea56905Config config) {
        this.config = config != null ? config : new Idea56905Config();
