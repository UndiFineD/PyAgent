...
@Data
public class Idea56560Config {
    private String name = "idea_056560";
 ...
 */
@Slf4j
public class Idea56560Service {
    private static final int IDEA_ID = 56560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56560Service() {
        this(new Idea56560Config());
    }

    public Idea56560Service(Idea56560Config config) {
        this.config = config != null ? config : new Idea56560Config();
