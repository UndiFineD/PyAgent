...
@Data
public class Idea56633Config {
    private String name = "idea_056633";
 ...
 */
@Slf4j
public class Idea56633Service {
    private static final int IDEA_ID = 56633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56633Service() {
        this(new Idea56633Config());
    }

    public Idea56633Service(Idea56633Config config) {
        this.config = config != null ? config : new Idea56633Config();
