...
@Data
public class Idea56567Config {
    private String name = "idea_056567";
 ...
 */
@Slf4j
public class Idea56567Service {
    private static final int IDEA_ID = 56567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56567Service() {
        this(new Idea56567Config());
    }

    public Idea56567Service(Idea56567Config config) {
        this.config = config != null ? config : new Idea56567Config();
