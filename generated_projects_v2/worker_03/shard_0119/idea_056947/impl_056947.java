...
@Data
public class Idea56947Config {
    private String name = "idea_056947";
 ...
 */
@Slf4j
public class Idea56947Service {
    private static final int IDEA_ID = 56947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56947Service() {
        this(new Idea56947Config());
    }

    public Idea56947Service(Idea56947Config config) {
        this.config = config != null ? config : new Idea56947Config();
