...
@Data
public class Idea56594Config {
    private String name = "idea_056594";
 ...
 */
@Slf4j
public class Idea56594Service {
    private static final int IDEA_ID = 56594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56594Service() {
        this(new Idea56594Config());
    }

    public Idea56594Service(Idea56594Config config) {
        this.config = config != null ? config : new Idea56594Config();
