...
@Data
public class Idea56980Config {
    private String name = "idea_056980";
 ...
 */
@Slf4j
public class Idea56980Service {
    private static final int IDEA_ID = 56980;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56980Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56980Service() {
        this(new Idea56980Config());
    }

    public Idea56980Service(Idea56980Config config) {
        this.config = config != null ? config : new Idea56980Config();
