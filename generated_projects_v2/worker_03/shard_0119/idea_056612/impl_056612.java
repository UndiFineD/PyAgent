...
@Data
public class Idea56612Config {
    private String name = "idea_056612";
 ...
 */
@Slf4j
public class Idea56612Service {
    private static final int IDEA_ID = 56612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56612Service() {
        this(new Idea56612Config());
    }

    public Idea56612Service(Idea56612Config config) {
        this.config = config != null ? config : new Idea56612Config();
