...
@Data
public class Idea56971Config {
    private String name = "idea_056971";
 ...
 */
@Slf4j
public class Idea56971Service {
    private static final int IDEA_ID = 56971;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56971Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56971Service() {
        this(new Idea56971Config());
    }

    public Idea56971Service(Idea56971Config config) {
        this.config = config != null ? config : new Idea56971Config();
