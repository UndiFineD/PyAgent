...
@Data
public class Idea56960Config {
    private String name = "idea_056960";
 ...
 */
@Slf4j
public class Idea56960Service {
    private static final int IDEA_ID = 56960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56960Service() {
        this(new Idea56960Config());
    }

    public Idea56960Service(Idea56960Config config) {
        this.config = config != null ? config : new Idea56960Config();
