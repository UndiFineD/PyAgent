...
@Data
public class Idea56635Config {
    private String name = "idea_056635";
 ...
 */
@Slf4j
public class Idea56635Service {
    private static final int IDEA_ID = 56635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56635Service() {
        this(new Idea56635Config());
    }

    public Idea56635Service(Idea56635Config config) {
        this.config = config != null ? config : new Idea56635Config();
