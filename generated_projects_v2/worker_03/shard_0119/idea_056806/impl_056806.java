...
@Data
public class Idea56806Config {
    private String name = "idea_056806";
 ...
 */
@Slf4j
public class Idea56806Service {
    private static final int IDEA_ID = 56806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56806Service() {
        this(new Idea56806Config());
    }

    public Idea56806Service(Idea56806Config config) {
        this.config = config != null ? config : new Idea56806Config();
