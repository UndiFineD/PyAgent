...
@Data
public class Idea56789Config {
    private String name = "idea_056789";
 ...
 */
@Slf4j
public class Idea56789Service {
    private static final int IDEA_ID = 56789;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56789Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56789Service() {
        this(new Idea56789Config());
    }

    public Idea56789Service(Idea56789Config config) {
        this.config = config != null ? config : new Idea56789Config();
