...
@Data
public class Idea56822Config {
    private String name = "idea_056822";
 ...
 */
@Slf4j
public class Idea56822Service {
    private static final int IDEA_ID = 56822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56822Service() {
        this(new Idea56822Config());
    }

    public Idea56822Service(Idea56822Config config) {
        this.config = config != null ? config : new Idea56822Config();
