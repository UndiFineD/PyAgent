...
@Data
public class Idea56872Config {
    private String name = "idea_056872";
 ...
 */
@Slf4j
public class Idea56872Service {
    private static final int IDEA_ID = 56872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56872Service() {
        this(new Idea56872Config());
    }

    public Idea56872Service(Idea56872Config config) {
        this.config = config != null ? config : new Idea56872Config();
