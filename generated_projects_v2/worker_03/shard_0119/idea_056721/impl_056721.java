...
@Data
public class Idea56721Config {
    private String name = "idea_056721";
 ...
 */
@Slf4j
public class Idea56721Service {
    private static final int IDEA_ID = 56721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56721Service() {
        this(new Idea56721Config());
    }

    public Idea56721Service(Idea56721Config config) {
        this.config = config != null ? config : new Idea56721Config();
