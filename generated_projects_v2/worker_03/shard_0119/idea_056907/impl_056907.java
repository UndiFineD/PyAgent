...
@Data
public class Idea56907Config {
    private String name = "idea_056907";
 ...
 */
@Slf4j
public class Idea56907Service {
    private static final int IDEA_ID = 56907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56907Service() {
        this(new Idea56907Config());
    }

    public Idea56907Service(Idea56907Config config) {
        this.config = config != null ? config : new Idea56907Config();
