...
@Data
public class Idea56838Config {
    private String name = "idea_056838";
 ...
 */
@Slf4j
public class Idea56838Service {
    private static final int IDEA_ID = 56838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56838Service() {
        this(new Idea56838Config());
    }

    public Idea56838Service(Idea56838Config config) {
        this.config = config != null ? config : new Idea56838Config();
