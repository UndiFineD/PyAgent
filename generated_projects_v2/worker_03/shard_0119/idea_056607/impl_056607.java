...
@Data
public class Idea56607Config {
    private String name = "idea_056607";
 ...
 */
@Slf4j
public class Idea56607Service {
    private static final int IDEA_ID = 56607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56607Service() {
        this(new Idea56607Config());
    }

    public Idea56607Service(Idea56607Config config) {
        this.config = config != null ? config : new Idea56607Config();
