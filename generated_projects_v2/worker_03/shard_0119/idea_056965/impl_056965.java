...
@Data
public class Idea56965Config {
    private String name = "idea_056965";
 ...
 */
@Slf4j
public class Idea56965Service {
    private static final int IDEA_ID = 56965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56965Service() {
        this(new Idea56965Config());
    }

    public Idea56965Service(Idea56965Config config) {
        this.config = config != null ? config : new Idea56965Config();
