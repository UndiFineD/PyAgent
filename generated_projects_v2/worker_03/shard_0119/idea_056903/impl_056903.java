...
@Data
public class Idea56903Config {
    private String name = "idea_056903";
 ...
 */
@Slf4j
public class Idea56903Service {
    private static final int IDEA_ID = 56903;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56903Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56903Service() {
        this(new Idea56903Config());
    }

    public Idea56903Service(Idea56903Config config) {
        this.config = config != null ? config : new Idea56903Config();
