...
@Data
public class Idea56927Config {
    private String name = "idea_056927";
 ...
 */
@Slf4j
public class Idea56927Service {
    private static final int IDEA_ID = 56927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56927Service() {
        this(new Idea56927Config());
    }

    public Idea56927Service(Idea56927Config config) {
        this.config = config != null ? config : new Idea56927Config();
