...
@Data
public class Idea56993Config {
    private String name = "idea_056993";
 ...
 */
@Slf4j
public class Idea56993Service {
    private static final int IDEA_ID = 56993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56993Service() {
        this(new Idea56993Config());
    }

    public Idea56993Service(Idea56993Config config) {
        this.config = config != null ? config : new Idea56993Config();
