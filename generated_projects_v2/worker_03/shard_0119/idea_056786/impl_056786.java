...
@Data
public class Idea56786Config {
    private String name = "idea_056786";
 ...
 */
@Slf4j
public class Idea56786Service {
    private static final int IDEA_ID = 56786;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56786Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56786Service() {
        this(new Idea56786Config());
    }

    public Idea56786Service(Idea56786Config config) {
        this.config = config != null ? config : new Idea56786Config();
