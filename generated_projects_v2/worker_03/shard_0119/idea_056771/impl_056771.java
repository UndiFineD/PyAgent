...
@Data
public class Idea56771Config {
    private String name = "idea_056771";
 ...
 */
@Slf4j
public class Idea56771Service {
    private static final int IDEA_ID = 56771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56771Service() {
        this(new Idea56771Config());
    }

    public Idea56771Service(Idea56771Config config) {
        this.config = config != null ? config : new Idea56771Config();
