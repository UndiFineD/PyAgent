...
@Data
public class Idea56621Config {
    private String name = "idea_056621";
 ...
 */
@Slf4j
public class Idea56621Service {
    private static final int IDEA_ID = 56621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56621Service() {
        this(new Idea56621Config());
    }

    public Idea56621Service(Idea56621Config config) {
        this.config = config != null ? config : new Idea56621Config();
