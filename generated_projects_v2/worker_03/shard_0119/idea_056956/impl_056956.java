...
@Data
public class Idea56956Config {
    private String name = "idea_056956";
 ...
 */
@Slf4j
public class Idea56956Service {
    private static final int IDEA_ID = 56956;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56956Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56956Service() {
        this(new Idea56956Config());
    }

    public Idea56956Service(Idea56956Config config) {
        this.config = config != null ? config : new Idea56956Config();
