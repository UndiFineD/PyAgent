...
@Data
public class Idea56931Config {
    private String name = "idea_056931";
 ...
 */
@Slf4j
public class Idea56931Service {
    private static final int IDEA_ID = 56931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56931Service() {
        this(new Idea56931Config());
    }

    public Idea56931Service(Idea56931Config config) {
        this.config = config != null ? config : new Idea56931Config();
