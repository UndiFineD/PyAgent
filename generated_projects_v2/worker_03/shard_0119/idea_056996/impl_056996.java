...
@Data
public class Idea56996Config {
    private String name = "idea_056996";
 ...
 */
@Slf4j
public class Idea56996Service {
    private static final int IDEA_ID = 56996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56996Service() {
        this(new Idea56996Config());
    }

    public Idea56996Service(Idea56996Config config) {
        this.config = config != null ? config : new Idea56996Config();
