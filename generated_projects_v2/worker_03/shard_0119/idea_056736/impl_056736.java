...
@Data
public class Idea56736Config {
    private String name = "idea_056736";
 ...
 */
@Slf4j
public class Idea56736Service {
    private static final int IDEA_ID = 56736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56736Service() {
        this(new Idea56736Config());
    }

    public Idea56736Service(Idea56736Config config) {
        this.config = config != null ? config : new Idea56736Config();
