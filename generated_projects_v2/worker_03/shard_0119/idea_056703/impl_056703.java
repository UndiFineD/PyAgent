...
@Data
public class Idea56703Config {
    private String name = "idea_056703";
 ...
 */
@Slf4j
public class Idea56703Service {
    private static final int IDEA_ID = 56703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56703Service() {
        this(new Idea56703Config());
    }

    public Idea56703Service(Idea56703Config config) {
        this.config = config != null ? config : new Idea56703Config();
