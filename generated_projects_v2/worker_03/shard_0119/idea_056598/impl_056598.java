...
@Data
public class Idea56598Config {
    private String name = "idea_056598";
 ...
 */
@Slf4j
public class Idea56598Service {
    private static final int IDEA_ID = 56598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56598Service() {
        this(new Idea56598Config());
    }

    public Idea56598Service(Idea56598Config config) {
        this.config = config != null ? config : new Idea56598Config();
