...
@Data
public class Idea56625Config {
    private String name = "idea_056625";
 ...
 */
@Slf4j
public class Idea56625Service {
    private static final int IDEA_ID = 56625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56625Service() {
        this(new Idea56625Config());
    }

    public Idea56625Service(Idea56625Config config) {
        this.config = config != null ? config : new Idea56625Config();
