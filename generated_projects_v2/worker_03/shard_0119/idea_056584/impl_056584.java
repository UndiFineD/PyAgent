...
@Data
public class Idea56584Config {
    private String name = "idea_056584";
 ...
 */
@Slf4j
public class Idea56584Service {
    private static final int IDEA_ID = 56584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56584Service() {
        this(new Idea56584Config());
    }

    public Idea56584Service(Idea56584Config config) {
        this.config = config != null ? config : new Idea56584Config();
