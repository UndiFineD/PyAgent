...
@Data
public class Idea56733Config {
    private String name = "idea_056733";
 ...
 */
@Slf4j
public class Idea56733Service {
    private static final int IDEA_ID = 56733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56733Service() {
        this(new Idea56733Config());
    }

    public Idea56733Service(Idea56733Config config) {
        this.config = config != null ? config : new Idea56733Config();
