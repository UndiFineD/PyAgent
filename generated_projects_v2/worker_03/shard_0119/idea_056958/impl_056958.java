...
@Data
public class Idea56958Config {
    private String name = "idea_056958";
 ...
 */
@Slf4j
public class Idea56958Service {
    private static final int IDEA_ID = 56958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56958Service() {
        this(new Idea56958Config());
    }

    public Idea56958Service(Idea56958Config config) {
        this.config = config != null ? config : new Idea56958Config();
