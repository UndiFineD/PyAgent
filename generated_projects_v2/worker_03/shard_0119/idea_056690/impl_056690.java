...
@Data
public class Idea56690Config {
    private String name = "idea_056690";
 ...
 */
@Slf4j
public class Idea56690Service {
    private static final int IDEA_ID = 56690;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56690Service() {
        this(new Idea56690Config());
    }

    public Idea56690Service(Idea56690Config config) {
        this.config = config != null ? config : new Idea56690Config();
