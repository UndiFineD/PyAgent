...
@Data
public class Idea56604Config {
    private String name = "idea_056604";
 ...
 */
@Slf4j
public class Idea56604Service {
    private static final int IDEA_ID = 56604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56604Service() {
        this(new Idea56604Config());
    }

    public Idea56604Service(Idea56604Config config) {
        this.config = config != null ? config : new Idea56604Config();
