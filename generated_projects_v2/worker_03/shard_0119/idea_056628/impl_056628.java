...
@Data
public class Idea56628Config {
    private String name = "idea_056628";
 ...
 */
@Slf4j
public class Idea56628Service {
    private static final int IDEA_ID = 56628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56628Service() {
        this(new Idea56628Config());
    }

    public Idea56628Service(Idea56628Config config) {
        this.config = config != null ? config : new Idea56628Config();
