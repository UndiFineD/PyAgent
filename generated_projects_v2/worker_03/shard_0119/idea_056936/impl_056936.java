...
@Data
public class Idea56936Config {
    private String name = "idea_056936";
 ...
 */
@Slf4j
public class Idea56936Service {
    private static final int IDEA_ID = 56936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56936Service() {
        this(new Idea56936Config());
    }

    public Idea56936Service(Idea56936Config config) {
        this.config = config != null ? config : new Idea56936Config();
