...
@Data
public class Idea56827Config {
    private String name = "idea_056827";
 ...
 */
@Slf4j
public class Idea56827Service {
    private static final int IDEA_ID = 56827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56827Service() {
        this(new Idea56827Config());
    }

    public Idea56827Service(Idea56827Config config) {
        this.config = config != null ? config : new Idea56827Config();
