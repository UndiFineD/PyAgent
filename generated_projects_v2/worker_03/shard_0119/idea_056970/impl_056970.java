...
@Data
public class Idea56970Config {
    private String name = "idea_056970";
 ...
 */
@Slf4j
public class Idea56970Service {
    private static final int IDEA_ID = 56970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56970Service() {
        this(new Idea56970Config());
    }

    public Idea56970Service(Idea56970Config config) {
        this.config = config != null ? config : new Idea56970Config();
