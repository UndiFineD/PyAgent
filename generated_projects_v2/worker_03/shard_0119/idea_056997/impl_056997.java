...
@Data
public class Idea56997Config {
    private String name = "idea_056997";
 ...
 */
@Slf4j
public class Idea56997Service {
    private static final int IDEA_ID = 56997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56997Service() {
        this(new Idea56997Config());
    }

    public Idea56997Service(Idea56997Config config) {
        this.config = config != null ? config : new Idea56997Config();
