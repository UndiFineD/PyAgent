...
@Data
public class Idea56595Config {
    private String name = "idea_056595";
 ...
 */
@Slf4j
public class Idea56595Service {
    private static final int IDEA_ID = 56595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56595Service() {
        this(new Idea56595Config());
    }

    public Idea56595Service(Idea56595Config config) {
        this.config = config != null ? config : new Idea56595Config();
