...
@Data
public class Idea56731Config {
    private String name = "idea_056731";
 ...
 */
@Slf4j
public class Idea56731Service {
    private static final int IDEA_ID = 56731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56731Service() {
        this(new Idea56731Config());
    }

    public Idea56731Service(Idea56731Config config) {
        this.config = config != null ? config : new Idea56731Config();
