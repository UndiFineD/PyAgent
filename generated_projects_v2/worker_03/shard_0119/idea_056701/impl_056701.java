...
@Data
public class Idea56701Config {
    private String name = "idea_056701";
 ...
 */
@Slf4j
public class Idea56701Service {
    private static final int IDEA_ID = 56701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56701Service() {
        this(new Idea56701Config());
    }

    public Idea56701Service(Idea56701Config config) {
        this.config = config != null ? config : new Idea56701Config();
