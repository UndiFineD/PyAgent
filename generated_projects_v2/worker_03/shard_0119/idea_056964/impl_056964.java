...
@Data
public class Idea56964Config {
    private String name = "idea_056964";
 ...
 */
@Slf4j
public class Idea56964Service {
    private static final int IDEA_ID = 56964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56964Service() {
        this(new Idea56964Config());
    }

    public Idea56964Service(Idea56964Config config) {
        this.config = config != null ? config : new Idea56964Config();
