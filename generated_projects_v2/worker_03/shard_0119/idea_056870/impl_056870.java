...
@Data
public class Idea56870Config {
    private String name = "idea_056870";
 ...
 */
@Slf4j
public class Idea56870Service {
    private static final int IDEA_ID = 56870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56870Service() {
        this(new Idea56870Config());
    }

    public Idea56870Service(Idea56870Config config) {
        this.config = config != null ? config : new Idea56870Config();
