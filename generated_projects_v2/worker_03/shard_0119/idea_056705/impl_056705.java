...
@Data
public class Idea56705Config {
    private String name = "idea_056705";
 ...
 */
@Slf4j
public class Idea56705Service {
    private static final int IDEA_ID = 56705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56705Service() {
        this(new Idea56705Config());
    }

    public Idea56705Service(Idea56705Config config) {
        this.config = config != null ? config : new Idea56705Config();
