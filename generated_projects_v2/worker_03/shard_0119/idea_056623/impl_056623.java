...
@Data
public class Idea56623Config {
    private String name = "idea_056623";
 ...
 */
@Slf4j
public class Idea56623Service {
    private static final int IDEA_ID = 56623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56623Service() {
        this(new Idea56623Config());
    }

    public Idea56623Service(Idea56623Config config) {
        this.config = config != null ? config : new Idea56623Config();
