...
@Data
public class Idea56784Config {
    private String name = "idea_056784";
 ...
 */
@Slf4j
public class Idea56784Service {
    private static final int IDEA_ID = 56784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56784Service() {
        this(new Idea56784Config());
    }

    public Idea56784Service(Idea56784Config config) {
        this.config = config != null ? config : new Idea56784Config();
