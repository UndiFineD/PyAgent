...
@Data
public class Idea56978Config {
    private String name = "idea_056978";
 ...
 */
@Slf4j
public class Idea56978Service {
    private static final int IDEA_ID = 56978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56978Service() {
        this(new Idea56978Config());
    }

    public Idea56978Service(Idea56978Config config) {
        this.config = config != null ? config : new Idea56978Config();
