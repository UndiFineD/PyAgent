...
@Data
public class Idea56987Config {
    private String name = "idea_056987";
 ...
 */
@Slf4j
public class Idea56987Service {
    private static final int IDEA_ID = 56987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56987Service() {
        this(new Idea56987Config());
    }

    public Idea56987Service(Idea56987Config config) {
        this.config = config != null ? config : new Idea56987Config();
