...
@Data
public class Idea56877Config {
    private String name = "idea_056877";
 ...
 */
@Slf4j
public class Idea56877Service {
    private static final int IDEA_ID = 56877;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56877Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56877Service() {
        this(new Idea56877Config());
    }

    public Idea56877Service(Idea56877Config config) {
        this.config = config != null ? config : new Idea56877Config();
