...
@Data
public class Idea56711Config {
    private String name = "idea_056711";
 ...
 */
@Slf4j
public class Idea56711Service {
    private static final int IDEA_ID = 56711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56711Service() {
        this(new Idea56711Config());
    }

    public Idea56711Service(Idea56711Config config) {
        this.config = config != null ? config : new Idea56711Config();
