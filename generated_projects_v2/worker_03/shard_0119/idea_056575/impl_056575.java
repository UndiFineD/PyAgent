...
@Data
public class Idea56575Config {
    private String name = "idea_056575";
 ...
 */
@Slf4j
public class Idea56575Service {
    private static final int IDEA_ID = 56575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56575Service() {
        this(new Idea56575Config());
    }

    public Idea56575Service(Idea56575Config config) {
        this.config = config != null ? config : new Idea56575Config();
