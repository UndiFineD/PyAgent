...
@Data
public class Idea56600Config {
    private String name = "idea_056600";
 ...
 */
@Slf4j
public class Idea56600Service {
    private static final int IDEA_ID = 56600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56600Service() {
        this(new Idea56600Config());
    }

    public Idea56600Service(Idea56600Config config) {
        this.config = config != null ? config : new Idea56600Config();
