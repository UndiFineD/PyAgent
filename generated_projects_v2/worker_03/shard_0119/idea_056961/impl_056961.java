...
@Data
public class Idea56961Config {
    private String name = "idea_056961";
 ...
 */
@Slf4j
public class Idea56961Service {
    private static final int IDEA_ID = 56961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56961Service() {
        this(new Idea56961Config());
    }

    public Idea56961Service(Idea56961Config config) {
        this.config = config != null ? config : new Idea56961Config();
