...
@Data
public class Idea56897Config {
    private String name = "idea_056897";
 ...
 */
@Slf4j
public class Idea56897Service {
    private static final int IDEA_ID = 56897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56897Service() {
        this(new Idea56897Config());
    }

    public Idea56897Service(Idea56897Config config) {
        this.config = config != null ? config : new Idea56897Config();
