...
@Data
public class Idea56821Config {
    private String name = "idea_056821";
 ...
 */
@Slf4j
public class Idea56821Service {
    private static final int IDEA_ID = 56821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56821Service() {
        this(new Idea56821Config());
    }

    public Idea56821Service(Idea56821Config config) {
        this.config = config != null ? config : new Idea56821Config();
