...
@Data
public class Idea56977Config {
    private String name = "idea_056977";
 ...
 */
@Slf4j
public class Idea56977Service {
    private static final int IDEA_ID = 56977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56977Service() {
        this(new Idea56977Config());
    }

    public Idea56977Service(Idea56977Config config) {
        this.config = config != null ? config : new Idea56977Config();
