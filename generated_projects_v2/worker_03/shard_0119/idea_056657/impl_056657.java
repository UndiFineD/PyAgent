...
@Data
public class Idea56657Config {
    private String name = "idea_056657";
 ...
 */
@Slf4j
public class Idea56657Service {
    private static final int IDEA_ID = 56657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56657Service() {
        this(new Idea56657Config());
    }

    public Idea56657Service(Idea56657Config config) {
        this.config = config != null ? config : new Idea56657Config();
