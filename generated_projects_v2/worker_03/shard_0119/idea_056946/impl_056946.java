...
@Data
public class Idea56946Config {
    private String name = "idea_056946";
 ...
 */
@Slf4j
public class Idea56946Service {
    private static final int IDEA_ID = 56946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56946Service() {
        this(new Idea56946Config());
    }

    public Idea56946Service(Idea56946Config config) {
        this.config = config != null ? config : new Idea56946Config();
