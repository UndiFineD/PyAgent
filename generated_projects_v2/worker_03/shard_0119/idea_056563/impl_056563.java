...
@Data
public class Idea56563Config {
    private String name = "idea_056563";
 ...
 */
@Slf4j
public class Idea56563Service {
    private static final int IDEA_ID = 56563;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56563Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56563Service() {
        this(new Idea56563Config());
    }

    public Idea56563Service(Idea56563Config config) {
        this.config = config != null ? config : new Idea56563Config();
