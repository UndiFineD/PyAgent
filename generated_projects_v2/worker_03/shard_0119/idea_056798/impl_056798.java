...
@Data
public class Idea56798Config {
    private String name = "idea_056798";
 ...
 */
@Slf4j
public class Idea56798Service {
    private static final int IDEA_ID = 56798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56798Service() {
        this(new Idea56798Config());
    }

    public Idea56798Service(Idea56798Config config) {
        this.config = config != null ? config : new Idea56798Config();
