...
@Data
public class Idea56564Config {
    private String name = "idea_056564";
 ...
 */
@Slf4j
public class Idea56564Service {
    private static final int IDEA_ID = 56564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56564Service() {
        this(new Idea56564Config());
    }

    public Idea56564Service(Idea56564Config config) {
        this.config = config != null ? config : new Idea56564Config();
