...
@Data
public class Idea56596Config {
    private String name = "idea_056596";
 ...
 */
@Slf4j
public class Idea56596Service {
    private static final int IDEA_ID = 56596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56596Service() {
        this(new Idea56596Config());
    }

    public Idea56596Service(Idea56596Config config) {
        this.config = config != null ? config : new Idea56596Config();
