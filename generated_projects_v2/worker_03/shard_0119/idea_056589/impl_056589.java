...
@Data
public class Idea56589Config {
    private String name = "idea_056589";
 ...
 */
@Slf4j
public class Idea56589Service {
    private static final int IDEA_ID = 56589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56589Service() {
        this(new Idea56589Config());
    }

    public Idea56589Service(Idea56589Config config) {
        this.config = config != null ? config : new Idea56589Config();
