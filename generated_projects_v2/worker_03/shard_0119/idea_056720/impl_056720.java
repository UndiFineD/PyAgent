...
@Data
public class Idea56720Config {
    private String name = "idea_056720";
 ...
 */
@Slf4j
public class Idea56720Service {
    private static final int IDEA_ID = 56720;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56720Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56720Service() {
        this(new Idea56720Config());
    }

    public Idea56720Service(Idea56720Config config) {
        this.config = config != null ? config : new Idea56720Config();
