...
@Data
public class Idea56975Config {
    private String name = "idea_056975";
 ...
 */
@Slf4j
public class Idea56975Service {
    private static final int IDEA_ID = 56975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56975Service() {
        this(new Idea56975Config());
    }

    public Idea56975Service(Idea56975Config config) {
        this.config = config != null ? config : new Idea56975Config();
