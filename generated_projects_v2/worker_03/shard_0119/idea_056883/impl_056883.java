...
@Data
public class Idea56883Config {
    private String name = "idea_056883";
 ...
 */
@Slf4j
public class Idea56883Service {
    private static final int IDEA_ID = 56883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56883Service() {
        this(new Idea56883Config());
    }

    public Idea56883Service(Idea56883Config config) {
        this.config = config != null ? config : new Idea56883Config();
