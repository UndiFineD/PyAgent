...
@Data
public class Idea56548Config {
    private String name = "idea_056548";
 ...
 */
@Slf4j
public class Idea56548Service {
    private static final int IDEA_ID = 56548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56548Service() {
        this(new Idea56548Config());
    }

    public Idea56548Service(Idea56548Config config) {
        this.config = config != null ? config : new Idea56548Config();
