...
@Data
public class Idea56793Config {
    private String name = "idea_056793";
 ...
 */
@Slf4j
public class Idea56793Service {
    private static final int IDEA_ID = 56793;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56793Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56793Service() {
        this(new Idea56793Config());
    }

    public Idea56793Service(Idea56793Config config) {
        this.config = config != null ? config : new Idea56793Config();
