...
@Data
public class Idea56549Config {
    private String name = "idea_056549";
 ...
 */
@Slf4j
public class Idea56549Service {
    private static final int IDEA_ID = 56549;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56549Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56549Service() {
        this(new Idea56549Config());
    }

    public Idea56549Service(Idea56549Config config) {
        this.config = config != null ? config : new Idea56549Config();
