...
@Data
public class Idea56636Config {
    private String name = "idea_056636";
 ...
 */
@Slf4j
public class Idea56636Service {
    private static final int IDEA_ID = 56636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56636Service() {
        this(new Idea56636Config());
    }

    public Idea56636Service(Idea56636Config config) {
        this.config = config != null ? config : new Idea56636Config();
