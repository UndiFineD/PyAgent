...
@Data
public class Idea56825Config {
    private String name = "idea_056825";
 ...
 */
@Slf4j
public class Idea56825Service {
    private static final int IDEA_ID = 56825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56825Service() {
        this(new Idea56825Config());
    }

    public Idea56825Service(Idea56825Config config) {
        this.config = config != null ? config : new Idea56825Config();
