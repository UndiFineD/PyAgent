...
@Data
public class Idea56780Config {
    private String name = "idea_056780";
 ...
 */
@Slf4j
public class Idea56780Service {
    private static final int IDEA_ID = 56780;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56780Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56780Service() {
        this(new Idea56780Config());
    }

    public Idea56780Service(Idea56780Config config) {
        this.config = config != null ? config : new Idea56780Config();
