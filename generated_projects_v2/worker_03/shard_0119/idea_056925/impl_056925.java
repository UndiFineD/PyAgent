...
@Data
public class Idea56925Config {
    private String name = "idea_056925";
 ...
 */
@Slf4j
public class Idea56925Service {
    private static final int IDEA_ID = 56925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea56925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea56925Service() {
        this(new Idea56925Config());
    }

    public Idea56925Service(Idea56925Config config) {
        this.config = config != null ? config : new Idea56925Config();
