...
@Data
public class Idea54402Config {
    private String name = "idea_054402";
 ...
 */
@Slf4j
public class Idea54402Service {
    private static final int IDEA_ID = 54402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54402Service() {
        this(new Idea54402Config());
    }

    public Idea54402Service(Idea54402Config config) {
        this.config = config != null ? config : new Idea54402Config();
