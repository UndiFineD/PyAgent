...
@Data
public class Idea54306Config {
    private String name = "idea_054306";
 ...
 */
@Slf4j
public class Idea54306Service {
    private static final int IDEA_ID = 54306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54306Service() {
        this(new Idea54306Config());
    }

    public Idea54306Service(Idea54306Config config) {
        this.config = config != null ? config : new Idea54306Config();
