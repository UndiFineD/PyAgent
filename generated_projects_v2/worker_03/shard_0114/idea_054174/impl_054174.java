...
@Data
public class Idea54174Config {
    private String name = "idea_054174";
 ...
 */
@Slf4j
public class Idea54174Service {
    private static final int IDEA_ID = 54174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54174Service() {
        this(new Idea54174Config());
    }

    public Idea54174Service(Idea54174Config config) {
        this.config = config != null ? config : new Idea54174Config();
