...
@Data
public class Idea54420Config {
    private String name = "idea_054420";
 ...
 */
@Slf4j
public class Idea54420Service {
    private static final int IDEA_ID = 54420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54420Service() {
        this(new Idea54420Config());
    }

    public Idea54420Service(Idea54420Config config) {
        this.config = config != null ? config : new Idea54420Config();
