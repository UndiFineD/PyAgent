...
@Data
public class Idea54378Config {
    private String name = "idea_054378";
 ...
 */
@Slf4j
public class Idea54378Service {
    private static final int IDEA_ID = 54378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54378Service() {
        this(new Idea54378Config());
    }

    public Idea54378Service(Idea54378Config config) {
        this.config = config != null ? config : new Idea54378Config();
