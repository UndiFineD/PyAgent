...
@Data
public class Idea54233Config {
    private String name = "idea_054233";
 ...
 */
@Slf4j
public class Idea54233Service {
    private static final int IDEA_ID = 54233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54233Service() {
        this(new Idea54233Config());
    }

    public Idea54233Service(Idea54233Config config) {
        this.config = config != null ? config : new Idea54233Config();
