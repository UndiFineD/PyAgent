...
@Data
public class Idea54262Config {
    private String name = "idea_054262";
 ...
 */
@Slf4j
public class Idea54262Service {
    private static final int IDEA_ID = 54262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54262Service() {
        this(new Idea54262Config());
    }

    public Idea54262Service(Idea54262Config config) {
        this.config = config != null ? config : new Idea54262Config();
