...
@Data
public class Idea54199Config {
    private String name = "idea_054199";
 ...
 */
@Slf4j
public class Idea54199Service {
    private static final int IDEA_ID = 54199;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54199Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54199Service() {
        this(new Idea54199Config());
    }

    public Idea54199Service(Idea54199Config config) {
        this.config = config != null ? config : new Idea54199Config();
