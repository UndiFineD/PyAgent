...
@Data
public class Idea54191Config {
    private String name = "idea_054191";
 ...
 */
@Slf4j
public class Idea54191Service {
    private static final int IDEA_ID = 54191;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54191Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54191Service() {
        this(new Idea54191Config());
    }

    public Idea54191Service(Idea54191Config config) {
        this.config = config != null ? config : new Idea54191Config();
