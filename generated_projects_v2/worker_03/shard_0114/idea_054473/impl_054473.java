...
@Data
public class Idea54473Config {
    private String name = "idea_054473";
 ...
 */
@Slf4j
public class Idea54473Service {
    private static final int IDEA_ID = 54473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54473Service() {
        this(new Idea54473Config());
    }

    public Idea54473Service(Idea54473Config config) {
        this.config = config != null ? config : new Idea54473Config();
