...
@Data
public class Idea54417Config {
    private String name = "idea_054417";
 ...
 */
@Slf4j
public class Idea54417Service {
    private static final int IDEA_ID = 54417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54417Service() {
        this(new Idea54417Config());
    }

    public Idea54417Service(Idea54417Config config) {
        this.config = config != null ? config : new Idea54417Config();
