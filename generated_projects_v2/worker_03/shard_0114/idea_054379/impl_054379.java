...
@Data
public class Idea54379Config {
    private String name = "idea_054379";
 ...
 */
@Slf4j
public class Idea54379Service {
    private static final int IDEA_ID = 54379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54379Service() {
        this(new Idea54379Config());
    }

    public Idea54379Service(Idea54379Config config) {
        this.config = config != null ? config : new Idea54379Config();
