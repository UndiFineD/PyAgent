...
@Data
public class Idea54373Config {
    private String name = "idea_054373";
 ...
 */
@Slf4j
public class Idea54373Service {
    private static final int IDEA_ID = 54373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54373Service() {
        this(new Idea54373Config());
    }

    public Idea54373Service(Idea54373Config config) {
        this.config = config != null ? config : new Idea54373Config();
