...
@Data
public class Idea54314Config {
    private String name = "idea_054314";
 ...
 */
@Slf4j
public class Idea54314Service {
    private static final int IDEA_ID = 54314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54314Service() {
        this(new Idea54314Config());
    }

    public Idea54314Service(Idea54314Config config) {
        this.config = config != null ? config : new Idea54314Config();
