...
@Data
public class Idea54418Config {
    private String name = "idea_054418";
 ...
 */
@Slf4j
public class Idea54418Service {
    private static final int IDEA_ID = 54418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54418Service() {
        this(new Idea54418Config());
    }

    public Idea54418Service(Idea54418Config config) {
        this.config = config != null ? config : new Idea54418Config();
