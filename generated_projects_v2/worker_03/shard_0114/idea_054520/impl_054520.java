...
@Data
public class Idea54520Config {
    private String name = "idea_054520";
 ...
 */
@Slf4j
public class Idea54520Service {
    private static final int IDEA_ID = 54520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54520Service() {
        this(new Idea54520Config());
    }

    public Idea54520Service(Idea54520Config config) {
        this.config = config != null ? config : new Idea54520Config();
