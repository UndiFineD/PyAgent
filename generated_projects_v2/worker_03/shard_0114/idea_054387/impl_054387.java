...
@Data
public class Idea54387Config {
    private String name = "idea_054387";
 ...
 */
@Slf4j
public class Idea54387Service {
    private static final int IDEA_ID = 54387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54387Service() {
        this(new Idea54387Config());
    }

    public Idea54387Service(Idea54387Config config) {
        this.config = config != null ? config : new Idea54387Config();
