...
@Data
public class Idea54591Config {
    private String name = "idea_054591";
 ...
 */
@Slf4j
public class Idea54591Service {
    private static final int IDEA_ID = 54591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54591Service() {
        this(new Idea54591Config());
    }

    public Idea54591Service(Idea54591Config config) {
        this.config = config != null ? config : new Idea54591Config();
