...
@Data
public class Idea54327Config {
    private String name = "idea_054327";
 ...
 */
@Slf4j
public class Idea54327Service {
    private static final int IDEA_ID = 54327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54327Service() {
        this(new Idea54327Config());
    }

    public Idea54327Service(Idea54327Config config) {
        this.config = config != null ? config : new Idea54327Config();
