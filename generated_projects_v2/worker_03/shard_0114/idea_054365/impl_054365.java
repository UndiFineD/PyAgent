...
@Data
public class Idea54365Config {
    private String name = "idea_054365";
 ...
 */
@Slf4j
public class Idea54365Service {
    private static final int IDEA_ID = 54365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54365Service() {
        this(new Idea54365Config());
    }

    public Idea54365Service(Idea54365Config config) {
        this.config = config != null ? config : new Idea54365Config();
