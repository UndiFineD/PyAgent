...
@Data
public class Idea54584Config {
    private String name = "idea_054584";
 ...
 */
@Slf4j
public class Idea54584Service {
    private static final int IDEA_ID = 54584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54584Service() {
        this(new Idea54584Config());
    }

    public Idea54584Service(Idea54584Config config) {
        this.config = config != null ? config : new Idea54584Config();
