...
@Data
public class Idea54204Config {
    private String name = "idea_054204";
 ...
 */
@Slf4j
public class Idea54204Service {
    private static final int IDEA_ID = 54204;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54204Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54204Service() {
        this(new Idea54204Config());
    }

    public Idea54204Service(Idea54204Config config) {
        this.config = config != null ? config : new Idea54204Config();
