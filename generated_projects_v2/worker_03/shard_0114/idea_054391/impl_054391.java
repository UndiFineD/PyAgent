...
@Data
public class Idea54391Config {
    private String name = "idea_054391";
 ...
 */
@Slf4j
public class Idea54391Service {
    private static final int IDEA_ID = 54391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54391Service() {
        this(new Idea54391Config());
    }

    public Idea54391Service(Idea54391Config config) {
        this.config = config != null ? config : new Idea54391Config();
