...
@Data
public class Idea54422Config {
    private String name = "idea_054422";
 ...
 */
@Slf4j
public class Idea54422Service {
    private static final int IDEA_ID = 54422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54422Service() {
        this(new Idea54422Config());
    }

    public Idea54422Service(Idea54422Config config) {
        this.config = config != null ? config : new Idea54422Config();
