...
@Data
public class Idea54375Config {
    private String name = "idea_054375";
 ...
 */
@Slf4j
public class Idea54375Service {
    private static final int IDEA_ID = 54375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54375Service() {
        this(new Idea54375Config());
    }

    public Idea54375Service(Idea54375Config config) {
        this.config = config != null ? config : new Idea54375Config();
