...
@Data
public class Idea54578Config {
    private String name = "idea_054578";
 ...
 */
@Slf4j
public class Idea54578Service {
    private static final int IDEA_ID = 54578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54578Service() {
        this(new Idea54578Config());
    }

    public Idea54578Service(Idea54578Config config) {
        this.config = config != null ? config : new Idea54578Config();
