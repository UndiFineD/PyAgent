...
@Data
public class Idea54223Config {
    private String name = "idea_054223";
 ...
 */
@Slf4j
public class Idea54223Service {
    private static final int IDEA_ID = 54223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54223Service() {
        this(new Idea54223Config());
    }

    public Idea54223Service(Idea54223Config config) {
        this.config = config != null ? config : new Idea54223Config();
