...
@Data
public class Idea54545Config {
    private String name = "idea_054545";
 ...
 */
@Slf4j
public class Idea54545Service {
    private static final int IDEA_ID = 54545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54545Service() {
        this(new Idea54545Config());
    }

    public Idea54545Service(Idea54545Config config) {
        this.config = config != null ? config : new Idea54545Config();
