...
@Data
public class Idea54381Config {
    private String name = "idea_054381";
 ...
 */
@Slf4j
public class Idea54381Service {
    private static final int IDEA_ID = 54381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54381Service() {
        this(new Idea54381Config());
    }

    public Idea54381Service(Idea54381Config config) {
        this.config = config != null ? config : new Idea54381Config();
