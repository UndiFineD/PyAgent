...
@Data
public class Idea54171Config {
    private String name = "idea_054171";
 ...
 */
@Slf4j
public class Idea54171Service {
    private static final int IDEA_ID = 54171;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54171Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54171Service() {
        this(new Idea54171Config());
    }

    public Idea54171Service(Idea54171Config config) {
        this.config = config != null ? config : new Idea54171Config();
