...
@Data
public class Idea54333Config {
    private String name = "idea_054333";
 ...
 */
@Slf4j
public class Idea54333Service {
    private static final int IDEA_ID = 54333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54333Service() {
        this(new Idea54333Config());
    }

    public Idea54333Service(Idea54333Config config) {
        this.config = config != null ? config : new Idea54333Config();
