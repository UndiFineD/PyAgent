...
@Data
public class Idea54201Config {
    private String name = "idea_054201";
 ...
 */
@Slf4j
public class Idea54201Service {
    private static final int IDEA_ID = 54201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54201Service() {
        this(new Idea54201Config());
    }

    public Idea54201Service(Idea54201Config config) {
        this.config = config != null ? config : new Idea54201Config();
