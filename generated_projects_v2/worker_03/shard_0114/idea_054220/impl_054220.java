...
@Data
public class Idea54220Config {
    private String name = "idea_054220";
 ...
 */
@Slf4j
public class Idea54220Service {
    private static final int IDEA_ID = 54220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54220Service() {
        this(new Idea54220Config());
    }

    public Idea54220Service(Idea54220Config config) {
        this.config = config != null ? config : new Idea54220Config();
