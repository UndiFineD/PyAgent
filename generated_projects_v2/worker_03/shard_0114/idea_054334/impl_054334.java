...
@Data
public class Idea54334Config {
    private String name = "idea_054334";
 ...
 */
@Slf4j
public class Idea54334Service {
    private static final int IDEA_ID = 54334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54334Service() {
        this(new Idea54334Config());
    }

    public Idea54334Service(Idea54334Config config) {
        this.config = config != null ? config : new Idea54334Config();
