...
@Data
public class Idea54564Config {
    private String name = "idea_054564";
 ...
 */
@Slf4j
public class Idea54564Service {
    private static final int IDEA_ID = 54564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54564Service() {
        this(new Idea54564Config());
    }

    public Idea54564Service(Idea54564Config config) {
        this.config = config != null ? config : new Idea54564Config();
