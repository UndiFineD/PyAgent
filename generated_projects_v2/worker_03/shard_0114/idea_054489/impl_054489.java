...
@Data
public class Idea54489Config {
    private String name = "idea_054489";
 ...
 */
@Slf4j
public class Idea54489Service {
    private static final int IDEA_ID = 54489;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54489Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54489Service() {
        this(new Idea54489Config());
    }

    public Idea54489Service(Idea54489Config config) {
        this.config = config != null ? config : new Idea54489Config();
