...
@Data
public class Idea54414Config {
    private String name = "idea_054414";
 ...
 */
@Slf4j
public class Idea54414Service {
    private static final int IDEA_ID = 54414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54414Service() {
        this(new Idea54414Config());
    }

    public Idea54414Service(Idea54414Config config) {
        this.config = config != null ? config : new Idea54414Config();
