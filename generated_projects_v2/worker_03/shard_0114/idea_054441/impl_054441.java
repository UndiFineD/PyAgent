...
@Data
public class Idea54441Config {
    private String name = "idea_054441";
 ...
 */
@Slf4j
public class Idea54441Service {
    private static final int IDEA_ID = 54441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54441Service() {
        this(new Idea54441Config());
    }

    public Idea54441Service(Idea54441Config config) {
        this.config = config != null ? config : new Idea54441Config();
