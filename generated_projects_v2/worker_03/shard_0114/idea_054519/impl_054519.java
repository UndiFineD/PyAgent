...
@Data
public class Idea54519Config {
    private String name = "idea_054519";
 ...
 */
@Slf4j
public class Idea54519Service {
    private static final int IDEA_ID = 54519;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54519Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54519Service() {
        this(new Idea54519Config());
    }

    public Idea54519Service(Idea54519Config config) {
        this.config = config != null ? config : new Idea54519Config();
