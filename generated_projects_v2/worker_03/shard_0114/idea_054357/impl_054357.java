...
@Data
public class Idea54357Config {
    private String name = "idea_054357";
 ...
 */
@Slf4j
public class Idea54357Service {
    private static final int IDEA_ID = 54357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54357Service() {
        this(new Idea54357Config());
    }

    public Idea54357Service(Idea54357Config config) {
        this.config = config != null ? config : new Idea54357Config();
