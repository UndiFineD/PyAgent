...
@Data
public class Idea54407Config {
    private String name = "idea_054407";
 ...
 */
@Slf4j
public class Idea54407Service {
    private static final int IDEA_ID = 54407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54407Service() {
        this(new Idea54407Config());
    }

    public Idea54407Service(Idea54407Config config) {
        this.config = config != null ? config : new Idea54407Config();
