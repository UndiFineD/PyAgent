...
@Data
public class Idea54178Config {
    private String name = "idea_054178";
 ...
 */
@Slf4j
public class Idea54178Service {
    private static final int IDEA_ID = 54178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54178Service() {
        this(new Idea54178Config());
    }

    public Idea54178Service(Idea54178Config config) {
        this.config = config != null ? config : new Idea54178Config();
