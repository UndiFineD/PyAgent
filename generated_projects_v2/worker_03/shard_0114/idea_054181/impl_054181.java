...
@Data
public class Idea54181Config {
    private String name = "idea_054181";
 ...
 */
@Slf4j
public class Idea54181Service {
    private static final int IDEA_ID = 54181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54181Service() {
        this(new Idea54181Config());
    }

    public Idea54181Service(Idea54181Config config) {
        this.config = config != null ? config : new Idea54181Config();
