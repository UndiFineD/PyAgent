...
@Data
public class Idea54587Config {
    private String name = "idea_054587";
 ...
 */
@Slf4j
public class Idea54587Service {
    private static final int IDEA_ID = 54587;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea54587Config config;
    private final Map<String, ProcessResult> cache;

    public Idea54587Service() {
        this(new Idea54587Config());
    }

    public Idea54587Service(Idea54587Config config) {
        this.config = config != null ? config : new Idea54587Config();
