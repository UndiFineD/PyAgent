...
@Data
public class Idea55381Config {
    private String name = "idea_055381";
 ...
 */
@Slf4j
public class Idea55381Service {
    private static final int IDEA_ID = 55381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55381Service() {
        this(new Idea55381Config());
    }

    public Idea55381Service(Idea55381Config config) {
        this.config = config != null ? config : new Idea55381Config();
