...
@Data
public class Idea55227Config {
    private String name = "idea_055227";
 ...
 */
@Slf4j
public class Idea55227Service {
    private static final int IDEA_ID = 55227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55227Service() {
        this(new Idea55227Config());
    }

    public Idea55227Service(Idea55227Config config) {
        this.config = config != null ? config : new Idea55227Config();
