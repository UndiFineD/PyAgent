...
@Data
public class Idea55280Config {
    private String name = "idea_055280";
 ...
 */
@Slf4j
public class Idea55280Service {
    private static final int IDEA_ID = 55280;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55280Service() {
        this(new Idea55280Config());
    }

    public Idea55280Service(Idea55280Config config) {
        this.config = config != null ? config : new Idea55280Config();
