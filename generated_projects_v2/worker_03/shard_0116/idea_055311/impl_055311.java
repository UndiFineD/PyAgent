...
@Data
public class Idea55311Config {
    private String name = "idea_055311";
 ...
 */
@Slf4j
public class Idea55311Service {
    private static final int IDEA_ID = 55311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55311Service() {
        this(new Idea55311Config());
    }

    public Idea55311Service(Idea55311Config config) {
        this.config = config != null ? config : new Idea55311Config();
