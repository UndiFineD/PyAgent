...
@Data
public class Idea55231Config {
    private String name = "idea_055231";
 ...
 */
@Slf4j
public class Idea55231Service {
    private static final int IDEA_ID = 55231;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55231Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55231Service() {
        this(new Idea55231Config());
    }

    public Idea55231Service(Idea55231Config config) {
        this.config = config != null ? config : new Idea55231Config();
