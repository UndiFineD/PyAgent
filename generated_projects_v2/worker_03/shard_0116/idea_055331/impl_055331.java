...
@Data
public class Idea55331Config {
    private String name = "idea_055331";
 ...
 */
@Slf4j
public class Idea55331Service {
    private static final int IDEA_ID = 55331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55331Service() {
        this(new Idea55331Config());
    }

    public Idea55331Service(Idea55331Config config) {
        this.config = config != null ? config : new Idea55331Config();
