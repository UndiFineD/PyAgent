...
@Data
public class Idea55362Config {
    private String name = "idea_055362";
 ...
 */
@Slf4j
public class Idea55362Service {
    private static final int IDEA_ID = 55362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55362Service() {
        this(new Idea55362Config());
    }

    public Idea55362Service(Idea55362Config config) {
        this.config = config != null ? config : new Idea55362Config();
