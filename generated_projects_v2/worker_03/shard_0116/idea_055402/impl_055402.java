...
@Data
public class Idea55402Config {
    private String name = "idea_055402";
 ...
 */
@Slf4j
public class Idea55402Service {
    private static final int IDEA_ID = 55402;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55402Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55402Service() {
        this(new Idea55402Config());
    }

    public Idea55402Service(Idea55402Config config) {
        this.config = config != null ? config : new Idea55402Config();
