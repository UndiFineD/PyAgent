...
@Data
public class Idea55189Config {
    private String name = "idea_055189";
 ...
 */
@Slf4j
public class Idea55189Service {
    private static final int IDEA_ID = 55189;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55189Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55189Service() {
        this(new Idea55189Config());
    }

    public Idea55189Service(Idea55189Config config) {
        this.config = config != null ? config : new Idea55189Config();
