...
@Data
public class Idea55566Config {
    private String name = "idea_055566";
 ...
 */
@Slf4j
public class Idea55566Service {
    private static final int IDEA_ID = 55566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55566Service() {
        this(new Idea55566Config());
    }

    public Idea55566Service(Idea55566Config config) {
        this.config = config != null ? config : new Idea55566Config();
