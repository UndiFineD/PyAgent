...
@Data
public class Idea55335Config {
    private String name = "idea_055335";
 ...
 */
@Slf4j
public class Idea55335Service {
    private static final int IDEA_ID = 55335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55335Service() {
        this(new Idea55335Config());
    }

    public Idea55335Service(Idea55335Config config) {
        this.config = config != null ? config : new Idea55335Config();
