...
@Data
public class Idea55395Config {
    private String name = "idea_055395";
 ...
 */
@Slf4j
public class Idea55395Service {
    private static final int IDEA_ID = 55395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55395Service() {
        this(new Idea55395Config());
    }

    public Idea55395Service(Idea55395Config config) {
        this.config = config != null ? config : new Idea55395Config();
