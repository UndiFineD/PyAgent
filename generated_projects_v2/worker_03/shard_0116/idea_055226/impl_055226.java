...
@Data
public class Idea55226Config {
    private String name = "idea_055226";
 ...
 */
@Slf4j
public class Idea55226Service {
    private static final int IDEA_ID = 55226;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55226Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55226Service() {
        this(new Idea55226Config());
    }

    public Idea55226Service(Idea55226Config config) {
        this.config = config != null ? config : new Idea55226Config();
