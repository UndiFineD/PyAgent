...
@Data
public class Idea55123Config {
    private String name = "idea_055123";
 ...
 */
@Slf4j
public class Idea55123Service {
    private static final int IDEA_ID = 55123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55123Service() {
        this(new Idea55123Config());
    }

    public Idea55123Service(Idea55123Config config) {
        this.config = config != null ? config : new Idea55123Config();
