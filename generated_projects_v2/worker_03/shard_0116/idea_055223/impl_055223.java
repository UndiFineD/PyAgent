...
@Data
public class Idea55223Config {
    private String name = "idea_055223";
 ...
 */
@Slf4j
public class Idea55223Service {
    private static final int IDEA_ID = 55223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55223Service() {
        this(new Idea55223Config());
    }

    public Idea55223Service(Idea55223Config config) {
        this.config = config != null ? config : new Idea55223Config();
