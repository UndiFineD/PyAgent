...
@Data
public class Idea55304Config {
    private String name = "idea_055304";
 ...
 */
@Slf4j
public class Idea55304Service {
    private static final int IDEA_ID = 55304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55304Service() {
        this(new Idea55304Config());
    }

    public Idea55304Service(Idea55304Config config) {
        this.config = config != null ? config : new Idea55304Config();
