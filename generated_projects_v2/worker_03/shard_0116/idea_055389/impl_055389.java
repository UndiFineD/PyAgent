...
@Data
public class Idea55389Config {
    private String name = "idea_055389";
 ...
 */
@Slf4j
public class Idea55389Service {
    private static final int IDEA_ID = 55389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55389Service() {
        this(new Idea55389Config());
    }

    public Idea55389Service(Idea55389Config config) {
        this.config = config != null ? config : new Idea55389Config();
