...
@Data
public class Idea55300Config {
    private String name = "idea_055300";
 ...
 */
@Slf4j
public class Idea55300Service {
    private static final int IDEA_ID = 55300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55300Service() {
        this(new Idea55300Config());
    }

    public Idea55300Service(Idea55300Config config) {
        this.config = config != null ? config : new Idea55300Config();
