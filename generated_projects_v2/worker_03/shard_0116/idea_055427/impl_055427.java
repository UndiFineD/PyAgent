...
@Data
public class Idea55427Config {
    private String name = "idea_055427";
 ...
 */
@Slf4j
public class Idea55427Service {
    private static final int IDEA_ID = 55427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55427Service() {
        this(new Idea55427Config());
    }

    public Idea55427Service(Idea55427Config config) {
        this.config = config != null ? config : new Idea55427Config();
