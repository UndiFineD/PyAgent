...
@Data
public class Idea55553Config {
    private String name = "idea_055553";
 ...
 */
@Slf4j
public class Idea55553Service {
    private static final int IDEA_ID = 55553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55553Service() {
        this(new Idea55553Config());
    }

    public Idea55553Service(Idea55553Config config) {
        this.config = config != null ? config : new Idea55553Config();
