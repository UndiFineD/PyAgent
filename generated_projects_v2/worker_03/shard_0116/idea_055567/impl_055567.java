...
@Data
public class Idea55567Config {
    private String name = "idea_055567";
 ...
 */
@Slf4j
public class Idea55567Service {
    private static final int IDEA_ID = 55567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55567Service() {
        this(new Idea55567Config());
    }

    public Idea55567Service(Idea55567Config config) {
        this.config = config != null ? config : new Idea55567Config();
