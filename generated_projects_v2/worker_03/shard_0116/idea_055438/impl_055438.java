...
@Data
public class Idea55438Config {
    private String name = "idea_055438";
 ...
 */
@Slf4j
public class Idea55438Service {
    private static final int IDEA_ID = 55438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55438Service() {
        this(new Idea55438Config());
    }

    public Idea55438Service(Idea55438Config config) {
        this.config = config != null ? config : new Idea55438Config();
