...
@Data
public class Idea55141Config {
    private String name = "idea_055141";
 ...
 */
@Slf4j
public class Idea55141Service {
    private static final int IDEA_ID = 55141;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55141Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55141Service() {
        this(new Idea55141Config());
    }

    public Idea55141Service(Idea55141Config config) {
        this.config = config != null ? config : new Idea55141Config();
