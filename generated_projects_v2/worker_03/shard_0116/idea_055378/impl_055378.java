...
@Data
public class Idea55378Config {
    private String name = "idea_055378";
 ...
 */
@Slf4j
public class Idea55378Service {
    private static final int IDEA_ID = 55378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55378Service() {
        this(new Idea55378Config());
    }

    public Idea55378Service(Idea55378Config config) {
        this.config = config != null ? config : new Idea55378Config();
