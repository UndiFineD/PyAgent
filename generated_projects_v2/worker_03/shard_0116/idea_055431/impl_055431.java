...
@Data
public class Idea55431Config {
    private String name = "idea_055431";
 ...
 */
@Slf4j
public class Idea55431Service {
    private static final int IDEA_ID = 55431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55431Service() {
        this(new Idea55431Config());
    }

    public Idea55431Service(Idea55431Config config) {
        this.config = config != null ? config : new Idea55431Config();
