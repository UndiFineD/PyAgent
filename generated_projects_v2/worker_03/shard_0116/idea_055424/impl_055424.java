...
@Data
public class Idea55424Config {
    private String name = "idea_055424";
 ...
 */
@Slf4j
public class Idea55424Service {
    private static final int IDEA_ID = 55424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55424Service() {
        this(new Idea55424Config());
    }

    public Idea55424Service(Idea55424Config config) {
        this.config = config != null ? config : new Idea55424Config();
