...
@Data
public class Idea55403Config {
    private String name = "idea_055403";
 ...
 */
@Slf4j
public class Idea55403Service {
    private static final int IDEA_ID = 55403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55403Service() {
        this(new Idea55403Config());
    }

    public Idea55403Service(Idea55403Config config) {
        this.config = config != null ? config : new Idea55403Config();
