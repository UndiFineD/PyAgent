...
@Data
public class Idea55102Config {
    private String name = "idea_055102";
 ...
 */
@Slf4j
public class Idea55102Service {
    private static final int IDEA_ID = 55102;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55102Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55102Service() {
        this(new Idea55102Config());
    }

    public Idea55102Service(Idea55102Config config) {
        this.config = config != null ? config : new Idea55102Config();
