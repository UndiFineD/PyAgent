...
@Data
public class Idea55511Config {
    private String name = "idea_055511";
 ...
 */
@Slf4j
public class Idea55511Service {
    private static final int IDEA_ID = 55511;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55511Service() {
        this(new Idea55511Config());
    }

    public Idea55511Service(Idea55511Config config) {
        this.config = config != null ? config : new Idea55511Config();
