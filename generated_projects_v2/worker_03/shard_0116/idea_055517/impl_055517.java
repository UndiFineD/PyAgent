...
@Data
public class Idea55517Config {
    private String name = "idea_055517";
 ...
 */
@Slf4j
public class Idea55517Service {
    private static final int IDEA_ID = 55517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55517Service() {
        this(new Idea55517Config());
    }

    public Idea55517Service(Idea55517Config config) {
        this.config = config != null ? config : new Idea55517Config();
