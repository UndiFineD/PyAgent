...
@Data
public class Idea55401Config {
    private String name = "idea_055401";
 ...
 */
@Slf4j
public class Idea55401Service {
    private static final int IDEA_ID = 55401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55401Service() {
        this(new Idea55401Config());
    }

    public Idea55401Service(Idea55401Config config) {
        this.config = config != null ? config : new Idea55401Config();
