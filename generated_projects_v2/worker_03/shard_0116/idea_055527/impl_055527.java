...
@Data
public class Idea55527Config {
    private String name = "idea_055527";
 ...
 */
@Slf4j
public class Idea55527Service {
    private static final int IDEA_ID = 55527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55527Service() {
        this(new Idea55527Config());
    }

    public Idea55527Service(Idea55527Config config) {
        this.config = config != null ? config : new Idea55527Config();
