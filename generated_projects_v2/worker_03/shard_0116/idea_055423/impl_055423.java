...
@Data
public class Idea55423Config {
    private String name = "idea_055423";
 ...
 */
@Slf4j
public class Idea55423Service {
    private static final int IDEA_ID = 55423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55423Service() {
        this(new Idea55423Config());
    }

    public Idea55423Service(Idea55423Config config) {
        this.config = config != null ? config : new Idea55423Config();
