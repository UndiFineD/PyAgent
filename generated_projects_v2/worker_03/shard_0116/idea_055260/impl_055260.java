...
@Data
public class Idea55260Config {
    private String name = "idea_055260";
 ...
 */
@Slf4j
public class Idea55260Service {
    private static final int IDEA_ID = 55260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55260Service() {
        this(new Idea55260Config());
    }

    public Idea55260Service(Idea55260Config config) {
        this.config = config != null ? config : new Idea55260Config();
