...
@Data
public class Idea55110Config {
    private String name = "idea_055110";
 ...
 */
@Slf4j
public class Idea55110Service {
    private static final int IDEA_ID = 55110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55110Service() {
        this(new Idea55110Config());
    }

    public Idea55110Service(Idea55110Config config) {
        this.config = config != null ? config : new Idea55110Config();
