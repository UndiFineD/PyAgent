...
@Data
public class Idea55415Config {
    private String name = "idea_055415";
 ...
 */
@Slf4j
public class Idea55415Service {
    private static final int IDEA_ID = 55415;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55415Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55415Service() {
        this(new Idea55415Config());
    }

    public Idea55415Service(Idea55415Config config) {
        this.config = config != null ? config : new Idea55415Config();
