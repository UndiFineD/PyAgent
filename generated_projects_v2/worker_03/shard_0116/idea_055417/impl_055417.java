...
@Data
public class Idea55417Config {
    private String name = "idea_055417";
 ...
 */
@Slf4j
public class Idea55417Service {
    private static final int IDEA_ID = 55417;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55417Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55417Service() {
        this(new Idea55417Config());
    }

    public Idea55417Service(Idea55417Config config) {
        this.config = config != null ? config : new Idea55417Config();
