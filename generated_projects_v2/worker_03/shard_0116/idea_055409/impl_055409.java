...
@Data
public class Idea55409Config {
    private String name = "idea_055409";
 ...
 */
@Slf4j
public class Idea55409Service {
    private static final int IDEA_ID = 55409;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55409Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55409Service() {
        this(new Idea55409Config());
    }

    public Idea55409Service(Idea55409Config config) {
        this.config = config != null ? config : new Idea55409Config();
