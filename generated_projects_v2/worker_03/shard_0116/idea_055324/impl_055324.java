...
@Data
public class Idea55324Config {
    private String name = "idea_055324";
 ...
 */
@Slf4j
public class Idea55324Service {
    private static final int IDEA_ID = 55324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55324Service() {
        this(new Idea55324Config());
    }

    public Idea55324Service(Idea55324Config config) {
        this.config = config != null ? config : new Idea55324Config();
