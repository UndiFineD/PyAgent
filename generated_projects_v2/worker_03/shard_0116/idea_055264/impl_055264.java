...
@Data
public class Idea55264Config {
    private String name = "idea_055264";
 ...
 */
@Slf4j
public class Idea55264Service {
    private static final int IDEA_ID = 55264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55264Service() {
        this(new Idea55264Config());
    }

    public Idea55264Service(Idea55264Config config) {
        this.config = config != null ? config : new Idea55264Config();
