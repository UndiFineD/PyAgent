...
@Data
public class Idea55181Config {
    private String name = "idea_055181";
 ...
 */
@Slf4j
public class Idea55181Service {
    private static final int IDEA_ID = 55181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55181Service() {
        this(new Idea55181Config());
    }

    public Idea55181Service(Idea55181Config config) {
        this.config = config != null ? config : new Idea55181Config();
