...
@Data
public class Idea55509Config {
    private String name = "idea_055509";
 ...
 */
@Slf4j
public class Idea55509Service {
    private static final int IDEA_ID = 55509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55509Service() {
        this(new Idea55509Config());
    }

    public Idea55509Service(Idea55509Config config) {
        this.config = config != null ? config : new Idea55509Config();
