...
@Data
public class Idea55325Config {
    private String name = "idea_055325";
 ...
 */
@Slf4j
public class Idea55325Service {
    private static final int IDEA_ID = 55325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55325Service() {
        this(new Idea55325Config());
    }

    public Idea55325Service(Idea55325Config config) {
        this.config = config != null ? config : new Idea55325Config();
