...
@Data
public class Idea55341Config {
    private String name = "idea_055341";
 ...
 */
@Slf4j
public class Idea55341Service {
    private static final int IDEA_ID = 55341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55341Service() {
        this(new Idea55341Config());
    }

    public Idea55341Service(Idea55341Config config) {
        this.config = config != null ? config : new Idea55341Config();
