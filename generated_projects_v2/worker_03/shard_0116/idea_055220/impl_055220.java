...
@Data
public class Idea55220Config {
    private String name = "idea_055220";
 ...
 */
@Slf4j
public class Idea55220Service {
    private static final int IDEA_ID = 55220;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55220Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55220Service() {
        this(new Idea55220Config());
    }

    public Idea55220Service(Idea55220Config config) {
        this.config = config != null ? config : new Idea55220Config();
