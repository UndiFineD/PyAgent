...
@Data
public class Idea55203Config {
    private String name = "idea_055203";
 ...
 */
@Slf4j
public class Idea55203Service {
    private static final int IDEA_ID = 55203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55203Service() {
        this(new Idea55203Config());
    }

    public Idea55203Service(Idea55203Config config) {
        this.config = config != null ? config : new Idea55203Config();
