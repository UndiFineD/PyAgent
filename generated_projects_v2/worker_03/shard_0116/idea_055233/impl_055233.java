...
@Data
public class Idea55233Config {
    private String name = "idea_055233";
 ...
 */
@Slf4j
public class Idea55233Service {
    private static final int IDEA_ID = 55233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55233Service() {
        this(new Idea55233Config());
    }

    public Idea55233Service(Idea55233Config config) {
        this.config = config != null ? config : new Idea55233Config();
