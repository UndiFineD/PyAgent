...
@Data
public class Idea55521Config {
    private String name = "idea_055521";
 ...
 */
@Slf4j
public class Idea55521Service {
    private static final int IDEA_ID = 55521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55521Service() {
        this(new Idea55521Config());
    }

    public Idea55521Service(Idea55521Config config) {
        this.config = config != null ? config : new Idea55521Config();
