...
@Data
public class Idea55126Config {
    private String name = "idea_055126";
 ...
 */
@Slf4j
public class Idea55126Service {
    private static final int IDEA_ID = 55126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55126Service() {
        this(new Idea55126Config());
    }

    public Idea55126Service(Idea55126Config config) {
        this.config = config != null ? config : new Idea55126Config();
