...
@Data
public class Idea55340Config {
    private String name = "idea_055340";
 ...
 */
@Slf4j
public class Idea55340Service {
    private static final int IDEA_ID = 55340;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55340Service() {
        this(new Idea55340Config());
    }

    public Idea55340Service(Idea55340Config config) {
        this.config = config != null ? config : new Idea55340Config();
