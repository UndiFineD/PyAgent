...
@Data
public class Idea55545Config {
    private String name = "idea_055545";
 ...
 */
@Slf4j
public class Idea55545Service {
    private static final int IDEA_ID = 55545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55545Service() {
        this(new Idea55545Config());
    }

    public Idea55545Service(Idea55545Config config) {
        this.config = config != null ? config : new Idea55545Config();
