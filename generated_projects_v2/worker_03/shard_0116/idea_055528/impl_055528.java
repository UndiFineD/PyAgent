...
@Data
public class Idea55528Config {
    private String name = "idea_055528";
 ...
 */
@Slf4j
public class Idea55528Service {
    private static final int IDEA_ID = 55528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55528Service() {
        this(new Idea55528Config());
    }

    public Idea55528Service(Idea55528Config config) {
        this.config = config != null ? config : new Idea55528Config();
