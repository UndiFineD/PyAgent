...
@Data
public class Idea55404Config {
    private String name = "idea_055404";
 ...
 */
@Slf4j
public class Idea55404Service {
    private static final int IDEA_ID = 55404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55404Service() {
        this(new Idea55404Config());
    }

    public Idea55404Service(Idea55404Config config) {
        this.config = config != null ? config : new Idea55404Config();
