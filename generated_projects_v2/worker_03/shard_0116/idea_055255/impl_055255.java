...
@Data
public class Idea55255Config {
    private String name = "idea_055255";
 ...
 */
@Slf4j
public class Idea55255Service {
    private static final int IDEA_ID = 55255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55255Service() {
        this(new Idea55255Config());
    }

    public Idea55255Service(Idea55255Config config) {
        this.config = config != null ? config : new Idea55255Config();
