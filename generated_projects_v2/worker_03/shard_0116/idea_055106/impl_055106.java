...
@Data
public class Idea55106Config {
    private String name = "idea_055106";
 ...
 */
@Slf4j
public class Idea55106Service {
    private static final int IDEA_ID = 55106;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55106Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55106Service() {
        this(new Idea55106Config());
    }

    public Idea55106Service(Idea55106Config config) {
        this.config = config != null ? config : new Idea55106Config();
