...
@Data
public class Idea55261Config {
    private String name = "idea_055261";
 ...
 */
@Slf4j
public class Idea55261Service {
    private static final int IDEA_ID = 55261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55261Service() {
        this(new Idea55261Config());
    }

    public Idea55261Service(Idea55261Config config) {
        this.config = config != null ? config : new Idea55261Config();
