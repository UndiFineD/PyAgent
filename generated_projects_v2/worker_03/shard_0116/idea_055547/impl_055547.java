...
@Data
public class Idea55547Config {
    private String name = "idea_055547";
 ...
 */
@Slf4j
public class Idea55547Service {
    private static final int IDEA_ID = 55547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55547Service() {
        this(new Idea55547Config());
    }

    public Idea55547Service(Idea55547Config config) {
        this.config = config != null ? config : new Idea55547Config();
