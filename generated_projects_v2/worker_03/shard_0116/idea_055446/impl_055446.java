...
@Data
public class Idea55446Config {
    private String name = "idea_055446";
 ...
 */
@Slf4j
public class Idea55446Service {
    private static final int IDEA_ID = 55446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55446Service() {
        this(new Idea55446Config());
    }

    public Idea55446Service(Idea55446Config config) {
        this.config = config != null ? config : new Idea55446Config();
