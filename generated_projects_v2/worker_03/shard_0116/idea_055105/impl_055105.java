...
@Data
public class Idea55105Config {
    private String name = "idea_055105";
 ...
 */
@Slf4j
public class Idea55105Service {
    private static final int IDEA_ID = 55105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55105Service() {
        this(new Idea55105Config());
    }

    public Idea55105Service(Idea55105Config config) {
        this.config = config != null ? config : new Idea55105Config();
