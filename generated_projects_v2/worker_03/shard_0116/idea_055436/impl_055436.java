...
@Data
public class Idea55436Config {
    private String name = "idea_055436";
 ...
 */
@Slf4j
public class Idea55436Service {
    private static final int IDEA_ID = 55436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55436Service() {
        this(new Idea55436Config());
    }

    public Idea55436Service(Idea55436Config config) {
        this.config = config != null ? config : new Idea55436Config();
