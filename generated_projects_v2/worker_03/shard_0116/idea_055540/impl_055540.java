...
@Data
public class Idea55540Config {
    private String name = "idea_055540";
 ...
 */
@Slf4j
public class Idea55540Service {
    private static final int IDEA_ID = 55540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55540Service() {
        this(new Idea55540Config());
    }

    public Idea55540Service(Idea55540Config config) {
        this.config = config != null ? config : new Idea55540Config();
