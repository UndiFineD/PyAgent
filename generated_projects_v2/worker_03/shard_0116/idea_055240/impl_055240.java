...
@Data
public class Idea55240Config {
    private String name = "idea_055240";
 ...
 */
@Slf4j
public class Idea55240Service {
    private static final int IDEA_ID = 55240;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55240Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55240Service() {
        this(new Idea55240Config());
    }

    public Idea55240Service(Idea55240Config config) {
        this.config = config != null ? config : new Idea55240Config();
