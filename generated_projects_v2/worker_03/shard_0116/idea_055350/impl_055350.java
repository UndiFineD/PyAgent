...
@Data
public class Idea55350Config {
    private String name = "idea_055350";
 ...
 */
@Slf4j
public class Idea55350Service {
    private static final int IDEA_ID = 55350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55350Service() {
        this(new Idea55350Config());
    }

    public Idea55350Service(Idea55350Config config) {
        this.config = config != null ? config : new Idea55350Config();
