...
@Data
public class Idea55104Config {
    private String name = "idea_055104";
 ...
 */
@Slf4j
public class Idea55104Service {
    private static final int IDEA_ID = 55104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55104Service() {
        this(new Idea55104Config());
    }

    public Idea55104Service(Idea55104Config config) {
        this.config = config != null ? config : new Idea55104Config();
