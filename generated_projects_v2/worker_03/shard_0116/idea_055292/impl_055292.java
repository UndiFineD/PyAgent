...
@Data
public class Idea55292Config {
    private String name = "idea_055292";
 ...
 */
@Slf4j
public class Idea55292Service {
    private static final int IDEA_ID = 55292;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55292Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55292Service() {
        this(new Idea55292Config());
    }

    public Idea55292Service(Idea55292Config config) {
        this.config = config != null ? config : new Idea55292Config();
