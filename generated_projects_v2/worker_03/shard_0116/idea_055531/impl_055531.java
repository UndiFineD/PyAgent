...
@Data
public class Idea55531Config {
    private String name = "idea_055531";
 ...
 */
@Slf4j
public class Idea55531Service {
    private static final int IDEA_ID = 55531;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55531Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55531Service() {
        this(new Idea55531Config());
    }

    public Idea55531Service(Idea55531Config config) {
        this.config = config != null ? config : new Idea55531Config();
