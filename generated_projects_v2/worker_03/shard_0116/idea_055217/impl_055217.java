...
@Data
public class Idea55217Config {
    private String name = "idea_055217";
 ...
 */
@Slf4j
public class Idea55217Service {
    private static final int IDEA_ID = 55217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55217Service() {
        this(new Idea55217Config());
    }

    public Idea55217Service(Idea55217Config config) {
        this.config = config != null ? config : new Idea55217Config();
