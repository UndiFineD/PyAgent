...
@Data
public class Idea55570Config {
    private String name = "idea_055570";
 ...
 */
@Slf4j
public class Idea55570Service {
    private static final int IDEA_ID = 55570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55570Service() {
        this(new Idea55570Config());
    }

    public Idea55570Service(Idea55570Config config) {
        this.config = config != null ? config : new Idea55570Config();
