...
@Data
public class Idea55320Config {
    private String name = "idea_055320";
 ...
 */
@Slf4j
public class Idea55320Service {
    private static final int IDEA_ID = 55320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55320Service() {
        this(new Idea55320Config());
    }

    public Idea55320Service(Idea55320Config config) {
        this.config = config != null ? config : new Idea55320Config();
