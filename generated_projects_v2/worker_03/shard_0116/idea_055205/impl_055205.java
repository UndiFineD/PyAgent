...
@Data
public class Idea55205Config {
    private String name = "idea_055205";
 ...
 */
@Slf4j
public class Idea55205Service {
    private static final int IDEA_ID = 55205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55205Service() {
        this(new Idea55205Config());
    }

    public Idea55205Service(Idea55205Config config) {
        this.config = config != null ? config : new Idea55205Config();
