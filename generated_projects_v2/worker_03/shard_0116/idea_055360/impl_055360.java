...
@Data
public class Idea55360Config {
    private String name = "idea_055360";
 ...
 */
@Slf4j
public class Idea55360Service {
    private static final int IDEA_ID = 55360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55360Service() {
        this(new Idea55360Config());
    }

    public Idea55360Service(Idea55360Config config) {
        this.config = config != null ? config : new Idea55360Config();
