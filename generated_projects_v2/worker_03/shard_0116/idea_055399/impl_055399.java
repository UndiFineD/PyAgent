...
@Data
public class Idea55399Config {
    private String name = "idea_055399";
 ...
 */
@Slf4j
public class Idea55399Service {
    private static final int IDEA_ID = 55399;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55399Service() {
        this(new Idea55399Config());
    }

    public Idea55399Service(Idea55399Config config) {
        this.config = config != null ? config : new Idea55399Config();
