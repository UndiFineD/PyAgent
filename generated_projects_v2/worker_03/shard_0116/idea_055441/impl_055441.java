...
@Data
public class Idea55441Config {
    private String name = "idea_055441";
 ...
 */
@Slf4j
public class Idea55441Service {
    private static final int IDEA_ID = 55441;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55441Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55441Service() {
        this(new Idea55441Config());
    }

    public Idea55441Service(Idea55441Config config) {
        this.config = config != null ? config : new Idea55441Config();
