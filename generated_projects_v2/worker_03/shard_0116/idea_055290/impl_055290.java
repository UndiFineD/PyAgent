...
@Data
public class Idea55290Config {
    private String name = "idea_055290";
 ...
 */
@Slf4j
public class Idea55290Service {
    private static final int IDEA_ID = 55290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55290Service() {
        this(new Idea55290Config());
    }

    public Idea55290Service(Idea55290Config config) {
        this.config = config != null ? config : new Idea55290Config();
