...
@Data
public class Idea55120Config {
    private String name = "idea_055120";
 ...
 */
@Slf4j
public class Idea55120Service {
    private static final int IDEA_ID = 55120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55120Service() {
        this(new Idea55120Config());
    }

    public Idea55120Service(Idea55120Config config) {
        this.config = config != null ? config : new Idea55120Config();
