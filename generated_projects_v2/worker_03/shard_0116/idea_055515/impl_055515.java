...
@Data
public class Idea55515Config {
    private String name = "idea_055515";
 ...
 */
@Slf4j
public class Idea55515Service {
    private static final int IDEA_ID = 55515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55515Service() {
        this(new Idea55515Config());
    }

    public Idea55515Service(Idea55515Config config) {
        this.config = config != null ? config : new Idea55515Config();
