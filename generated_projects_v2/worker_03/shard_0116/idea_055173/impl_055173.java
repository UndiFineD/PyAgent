...
@Data
public class Idea55173Config {
    private String name = "idea_055173";
 ...
 */
@Slf4j
public class Idea55173Service {
    private static final int IDEA_ID = 55173;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55173Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55173Service() {
        this(new Idea55173Config());
    }

    public Idea55173Service(Idea55173Config config) {
        this.config = config != null ? config : new Idea55173Config();
