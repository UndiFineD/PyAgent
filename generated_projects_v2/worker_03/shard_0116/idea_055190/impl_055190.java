...
@Data
public class Idea55190Config {
    private String name = "idea_055190";
 ...
 */
@Slf4j
public class Idea55190Service {
    private static final int IDEA_ID = 55190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55190Service() {
        this(new Idea55190Config());
    }

    public Idea55190Service(Idea55190Config config) {
        this.config = config != null ? config : new Idea55190Config();
