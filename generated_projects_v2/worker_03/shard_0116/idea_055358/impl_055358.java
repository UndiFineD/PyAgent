...
@Data
public class Idea55358Config {
    private String name = "idea_055358";
 ...
 */
@Slf4j
public class Idea55358Service {
    private static final int IDEA_ID = 55358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55358Service() {
        this(new Idea55358Config());
    }

    public Idea55358Service(Idea55358Config config) {
        this.config = config != null ? config : new Idea55358Config();
