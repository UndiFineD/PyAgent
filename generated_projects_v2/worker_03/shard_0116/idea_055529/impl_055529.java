...
@Data
public class Idea55529Config {
    private String name = "idea_055529";
 ...
 */
@Slf4j
public class Idea55529Service {
    private static final int IDEA_ID = 55529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55529Service() {
        this(new Idea55529Config());
    }

    public Idea55529Service(Idea55529Config config) {
        this.config = config != null ? config : new Idea55529Config();
