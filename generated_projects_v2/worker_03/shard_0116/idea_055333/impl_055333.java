...
@Data
public class Idea55333Config {
    private String name = "idea_055333";
 ...
 */
@Slf4j
public class Idea55333Service {
    private static final int IDEA_ID = 55333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55333Service() {
        this(new Idea55333Config());
    }

    public Idea55333Service(Idea55333Config config) {
        this.config = config != null ? config : new Idea55333Config();
