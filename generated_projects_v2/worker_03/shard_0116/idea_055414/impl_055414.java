...
@Data
public class Idea55414Config {
    private String name = "idea_055414";
 ...
 */
@Slf4j
public class Idea55414Service {
    private static final int IDEA_ID = 55414;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55414Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55414Service() {
        this(new Idea55414Config());
    }

    public Idea55414Service(Idea55414Config config) {
        this.config = config != null ? config : new Idea55414Config();
