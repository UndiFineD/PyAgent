...
@Data
public class Idea55367Config {
    private String name = "idea_055367";
 ...
 */
@Slf4j
public class Idea55367Service {
    private static final int IDEA_ID = 55367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55367Service() {
        this(new Idea55367Config());
    }

    public Idea55367Service(Idea55367Config config) {
        this.config = config != null ? config : new Idea55367Config();
