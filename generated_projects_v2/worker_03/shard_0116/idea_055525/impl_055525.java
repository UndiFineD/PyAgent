...
@Data
public class Idea55525Config {
    private String name = "idea_055525";
 ...
 */
@Slf4j
public class Idea55525Service {
    private static final int IDEA_ID = 55525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55525Service() {
        this(new Idea55525Config());
    }

    public Idea55525Service(Idea55525Config config) {
        this.config = config != null ? config : new Idea55525Config();
