...
@Data
public class Idea55135Config {
    private String name = "idea_055135";
 ...
 */
@Slf4j
public class Idea55135Service {
    private static final int IDEA_ID = 55135;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55135Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55135Service() {
        this(new Idea55135Config());
    }

    public Idea55135Service(Idea55135Config config) {
        this.config = config != null ? config : new Idea55135Config();
