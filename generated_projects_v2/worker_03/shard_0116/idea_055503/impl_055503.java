...
@Data
public class Idea55503Config {
    private String name = "idea_055503";
 ...
 */
@Slf4j
public class Idea55503Service {
    private static final int IDEA_ID = 55503;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55503Service() {
        this(new Idea55503Config());
    }

    public Idea55503Service(Idea55503Config config) {
        this.config = config != null ? config : new Idea55503Config();
