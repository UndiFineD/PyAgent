...
@Data
public class Idea55326Config {
    private String name = "idea_055326";
 ...
 */
@Slf4j
public class Idea55326Service {
    private static final int IDEA_ID = 55326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55326Service() {
        this(new Idea55326Config());
    }

    public Idea55326Service(Idea55326Config config) {
        this.config = config != null ? config : new Idea55326Config();
