...
@Data
public class Idea55322Config {
    private String name = "idea_055322";
 ...
 */
@Slf4j
public class Idea55322Service {
    private static final int IDEA_ID = 55322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55322Service() {
        this(new Idea55322Config());
    }

    public Idea55322Service(Idea55322Config config) {
        this.config = config != null ? config : new Idea55322Config();
