...
@Data
public class Idea55161Config {
    private String name = "idea_055161";
 ...
 */
@Slf4j
public class Idea55161Service {
    private static final int IDEA_ID = 55161;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55161Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55161Service() {
        this(new Idea55161Config());
    }

    public Idea55161Service(Idea55161Config config) {
        this.config = config != null ? config : new Idea55161Config();
