...
@Data
public class Idea55202Config {
    private String name = "idea_055202";
 ...
 */
@Slf4j
public class Idea55202Service {
    private static final int IDEA_ID = 55202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55202Service() {
        this(new Idea55202Config());
    }

    public Idea55202Service(Idea55202Config config) {
        this.config = config != null ? config : new Idea55202Config();
