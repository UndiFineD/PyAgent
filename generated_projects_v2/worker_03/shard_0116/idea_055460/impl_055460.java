...
@Data
public class Idea55460Config {
    private String name = "idea_055460";
 ...
 */
@Slf4j
public class Idea55460Service {
    private static final int IDEA_ID = 55460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55460Service() {
        this(new Idea55460Config());
    }

    public Idea55460Service(Idea55460Config config) {
        this.config = config != null ? config : new Idea55460Config();
