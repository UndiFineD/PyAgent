...
@Data
public class Idea55555Config {
    private String name = "idea_055555";
 ...
 */
@Slf4j
public class Idea55555Service {
    private static final int IDEA_ID = 55555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55555Service() {
        this(new Idea55555Config());
    }

    public Idea55555Service(Idea55555Config config) {
        this.config = config != null ? config : new Idea55555Config();
