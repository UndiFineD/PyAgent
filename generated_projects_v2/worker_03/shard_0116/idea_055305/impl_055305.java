...
@Data
public class Idea55305Config {
    private String name = "idea_055305";
 ...
 */
@Slf4j
public class Idea55305Service {
    private static final int IDEA_ID = 55305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55305Service() {
        this(new Idea55305Config());
    }

    public Idea55305Service(Idea55305Config config) {
        this.config = config != null ? config : new Idea55305Config();
