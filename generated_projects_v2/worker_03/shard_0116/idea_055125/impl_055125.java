...
@Data
public class Idea55125Config {
    private String name = "idea_055125";
 ...
 */
@Slf4j
public class Idea55125Service {
    private static final int IDEA_ID = 55125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55125Service() {
        this(new Idea55125Config());
    }

    public Idea55125Service(Idea55125Config config) {
        this.config = config != null ? config : new Idea55125Config();
