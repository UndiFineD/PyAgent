...
@Data
public class Idea55520Config {
    private String name = "idea_055520";
 ...
 */
@Slf4j
public class Idea55520Service {
    private static final int IDEA_ID = 55520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55520Service() {
        this(new Idea55520Config());
    }

    public Idea55520Service(Idea55520Config config) {
        this.config = config != null ? config : new Idea55520Config();
