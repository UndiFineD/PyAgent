...
@Data
public class Idea55550Config {
    private String name = "idea_055550";
 ...
 */
@Slf4j
public class Idea55550Service {
    private static final int IDEA_ID = 55550;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55550Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55550Service() {
        this(new Idea55550Config());
    }

    public Idea55550Service(Idea55550Config config) {
        this.config = config != null ? config : new Idea55550Config();
