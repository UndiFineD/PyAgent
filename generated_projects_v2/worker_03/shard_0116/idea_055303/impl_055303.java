...
@Data
public class Idea55303Config {
    private String name = "idea_055303";
 ...
 */
@Slf4j
public class Idea55303Service {
    private static final int IDEA_ID = 55303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55303Service() {
        this(new Idea55303Config());
    }

    public Idea55303Service(Idea55303Config config) {
        this.config = config != null ? config : new Idea55303Config();
