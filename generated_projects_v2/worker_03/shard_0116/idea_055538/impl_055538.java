...
@Data
public class Idea55538Config {
    private String name = "idea_055538";
 ...
 */
@Slf4j
public class Idea55538Service {
    private static final int IDEA_ID = 55538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55538Service() {
        this(new Idea55538Config());
    }

    public Idea55538Service(Idea55538Config config) {
        this.config = config != null ? config : new Idea55538Config();
