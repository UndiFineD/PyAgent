...
@Data
public class Idea55375Config {
    private String name = "idea_055375";
 ...
 */
@Slf4j
public class Idea55375Service {
    private static final int IDEA_ID = 55375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55375Service() {
        this(new Idea55375Config());
    }

    public Idea55375Service(Idea55375Config config) {
        this.config = config != null ? config : new Idea55375Config();
