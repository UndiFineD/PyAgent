...
@Data
public class Idea55428Config {
    private String name = "idea_055428";
 ...
 */
@Slf4j
public class Idea55428Service {
    private static final int IDEA_ID = 55428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55428Service() {
        this(new Idea55428Config());
    }

    public Idea55428Service(Idea55428Config config) {
        this.config = config != null ? config : new Idea55428Config();
