...
@Data
public class Idea55127Config {
    private String name = "idea_055127";
 ...
 */
@Slf4j
public class Idea55127Service {
    private static final int IDEA_ID = 55127;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55127Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55127Service() {
        this(new Idea55127Config());
    }

    public Idea55127Service(Idea55127Config config) {
        this.config = config != null ? config : new Idea55127Config();
