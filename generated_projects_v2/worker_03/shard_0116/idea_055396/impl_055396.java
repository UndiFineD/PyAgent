...
@Data
public class Idea55396Config {
    private String name = "idea_055396";
 ...
 */
@Slf4j
public class Idea55396Service {
    private static final int IDEA_ID = 55396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55396Service() {
        this(new Idea55396Config());
    }

    public Idea55396Service(Idea55396Config config) {
        this.config = config != null ? config : new Idea55396Config();
