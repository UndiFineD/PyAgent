...
@Data
public class Idea55491Config {
    private String name = "idea_055491";
 ...
 */
@Slf4j
public class Idea55491Service {
    private static final int IDEA_ID = 55491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55491Service() {
        this(new Idea55491Config());
    }

    public Idea55491Service(Idea55491Config config) {
        this.config = config != null ? config : new Idea55491Config();
