...
@Data
public class Idea55241Config {
    private String name = "idea_055241";
 ...
 */
@Slf4j
public class Idea55241Service {
    private static final int IDEA_ID = 55241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55241Service() {
        this(new Idea55241Config());
    }

    public Idea55241Service(Idea55241Config config) {
        this.config = config != null ? config : new Idea55241Config();
