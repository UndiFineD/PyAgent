...
@Data
public class Idea55100Config {
    private String name = "idea_055100";
 ...
 */
@Slf4j
public class Idea55100Service {
    private static final int IDEA_ID = 55100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55100Service() {
        this(new Idea55100Config());
    }

    public Idea55100Service(Idea55100Config config) {
        this.config = config != null ? config : new Idea55100Config();
