...
@Data
public class Idea55485Config {
    private String name = "idea_055485";
 ...
 */
@Slf4j
public class Idea55485Service {
    private static final int IDEA_ID = 55485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55485Service() {
        this(new Idea55485Config());
    }

    public Idea55485Service(Idea55485Config config) {
        this.config = config != null ? config : new Idea55485Config();
