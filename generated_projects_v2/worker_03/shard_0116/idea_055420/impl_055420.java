...
@Data
public class Idea55420Config {
    private String name = "idea_055420";
 ...
 */
@Slf4j
public class Idea55420Service {
    private static final int IDEA_ID = 55420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55420Service() {
        this(new Idea55420Config());
    }

    public Idea55420Service(Idea55420Config config) {
        this.config = config != null ? config : new Idea55420Config();
