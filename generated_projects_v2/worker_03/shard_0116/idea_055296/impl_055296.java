...
@Data
public class Idea55296Config {
    private String name = "idea_055296";
 ...
 */
@Slf4j
public class Idea55296Service {
    private static final int IDEA_ID = 55296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55296Service() {
        this(new Idea55296Config());
    }

    public Idea55296Service(Idea55296Config config) {
        this.config = config != null ? config : new Idea55296Config();
