...
@Data
public class Idea55418Config {
    private String name = "idea_055418";
 ...
 */
@Slf4j
public class Idea55418Service {
    private static final int IDEA_ID = 55418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55418Service() {
        this(new Idea55418Config());
    }

    public Idea55418Service(Idea55418Config config) {
        this.config = config != null ? config : new Idea55418Config();
