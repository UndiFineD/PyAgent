...
@Data
public class Idea55364Config {
    private String name = "idea_055364";
 ...
 */
@Slf4j
public class Idea55364Service {
    private static final int IDEA_ID = 55364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55364Service() {
        this(new Idea55364Config());
    }

    public Idea55364Service(Idea55364Config config) {
        this.config = config != null ? config : new Idea55364Config();
