...
@Data
public class Idea55221Config {
    private String name = "idea_055221";
 ...
 */
@Slf4j
public class Idea55221Service {
    private static final int IDEA_ID = 55221;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55221Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55221Service() {
        this(new Idea55221Config());
    }

    public Idea55221Service(Idea55221Config config) {
        this.config = config != null ? config : new Idea55221Config();
