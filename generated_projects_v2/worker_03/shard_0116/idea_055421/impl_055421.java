...
@Data
public class Idea55421Config {
    private String name = "idea_055421";
 ...
 */
@Slf4j
public class Idea55421Service {
    private static final int IDEA_ID = 55421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55421Service() {
        this(new Idea55421Config());
    }

    public Idea55421Service(Idea55421Config config) {
        this.config = config != null ? config : new Idea55421Config();
