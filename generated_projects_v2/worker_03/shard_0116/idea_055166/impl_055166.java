...
@Data
public class Idea55166Config {
    private String name = "idea_055166";
 ...
 */
@Slf4j
public class Idea55166Service {
    private static final int IDEA_ID = 55166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55166Service() {
        this(new Idea55166Config());
    }

    public Idea55166Service(Idea55166Config config) {
        this.config = config != null ? config : new Idea55166Config();
