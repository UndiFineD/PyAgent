...
@Data
public class Idea55501Config {
    private String name = "idea_055501";
 ...
 */
@Slf4j
public class Idea55501Service {
    private static final int IDEA_ID = 55501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea55501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea55501Service() {
        this(new Idea55501Config());
    }

    public Idea55501Service(Idea55501Config config) {
        this.config = config != null ? config : new Idea55501Config();
