...
@Data
public class Idea52383Config {
    private String name = "idea_052383";
 ...
 */
@Slf4j
public class Idea52383Service {
    private static final int IDEA_ID = 52383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52383Service() {
        this(new Idea52383Config());
    }

    public Idea52383Service(Idea52383Config config) {
        this.config = config != null ? config : new Idea52383Config();
