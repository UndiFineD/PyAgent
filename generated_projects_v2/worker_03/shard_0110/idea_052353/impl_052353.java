...
@Data
public class Idea52353Config {
    private String name = "idea_052353";
 ...
 */
@Slf4j
public class Idea52353Service {
    private static final int IDEA_ID = 52353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52353Service() {
        this(new Idea52353Config());
    }

    public Idea52353Service(Idea52353Config config) {
        this.config = config != null ? config : new Idea52353Config();
