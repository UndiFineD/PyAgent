...
@Data
public class Idea52508Config {
    private String name = "idea_052508";
 ...
 */
@Slf4j
public class Idea52508Service {
    private static final int IDEA_ID = 52508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52508Service() {
        this(new Idea52508Config());
    }

    public Idea52508Service(Idea52508Config config) {
        this.config = config != null ? config : new Idea52508Config();
