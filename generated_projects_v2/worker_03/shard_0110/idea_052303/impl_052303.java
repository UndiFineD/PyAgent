...
@Data
public class Idea52303Config {
    private String name = "idea_052303";
 ...
 */
@Slf4j
public class Idea52303Service {
    private static final int IDEA_ID = 52303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52303Service() {
        this(new Idea52303Config());
    }

    public Idea52303Service(Idea52303Config config) {
        this.config = config != null ? config : new Idea52303Config();
