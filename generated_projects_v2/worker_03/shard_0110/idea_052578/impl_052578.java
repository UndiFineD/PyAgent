...
@Data
public class Idea52578Config {
    private String name = "idea_052578";
 ...
 */
@Slf4j
public class Idea52578Service {
    private static final int IDEA_ID = 52578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52578Service() {
        this(new Idea52578Config());
    }

    public Idea52578Service(Idea52578Config config) {
        this.config = config != null ? config : new Idea52578Config();
