...
@Data
public class Idea52535Config {
    private String name = "idea_052535";
 ...
 */
@Slf4j
public class Idea52535Service {
    private static final int IDEA_ID = 52535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52535Service() {
        this(new Idea52535Config());
    }

    public Idea52535Service(Idea52535Config config) {
        this.config = config != null ? config : new Idea52535Config();
