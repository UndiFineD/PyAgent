...
@Data
public class Idea52396Config {
    private String name = "idea_052396";
 ...
 */
@Slf4j
public class Idea52396Service {
    private static final int IDEA_ID = 52396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52396Service() {
        this(new Idea52396Config());
    }

    public Idea52396Service(Idea52396Config config) {
        this.config = config != null ? config : new Idea52396Config();
