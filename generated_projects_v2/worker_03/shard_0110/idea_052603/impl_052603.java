...
@Data
public class Idea52603Config {
    private String name = "idea_052603";
 ...
 */
@Slf4j
public class Idea52603Service {
    private static final int IDEA_ID = 52603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52603Service() {
        this(new Idea52603Config());
    }

    public Idea52603Service(Idea52603Config config) {
        this.config = config != null ? config : new Idea52603Config();
