...
@Data
public class Idea52523Config {
    private String name = "idea_052523";
 ...
 */
@Slf4j
public class Idea52523Service {
    private static final int IDEA_ID = 52523;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52523Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52523Service() {
        this(new Idea52523Config());
    }

    public Idea52523Service(Idea52523Config config) {
        this.config = config != null ? config : new Idea52523Config();
