...
@Data
public class Idea52491Config {
    private String name = "idea_052491";
 ...
 */
@Slf4j
public class Idea52491Service {
    private static final int IDEA_ID = 52491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52491Service() {
        this(new Idea52491Config());
    }

    public Idea52491Service(Idea52491Config config) {
        this.config = config != null ? config : new Idea52491Config();
