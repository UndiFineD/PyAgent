...
@Data
public class Idea52561Config {
    private String name = "idea_052561";
 ...
 */
@Slf4j
public class Idea52561Service {
    private static final int IDEA_ID = 52561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52561Service() {
        this(new Idea52561Config());
    }

    public Idea52561Service(Idea52561Config config) {
        this.config = config != null ? config : new Idea52561Config();
