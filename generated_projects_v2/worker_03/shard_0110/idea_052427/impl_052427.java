...
@Data
public class Idea52427Config {
    private String name = "idea_052427";
 ...
 */
@Slf4j
public class Idea52427Service {
    private static final int IDEA_ID = 52427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52427Service() {
        this(new Idea52427Config());
    }

    public Idea52427Service(Idea52427Config config) {
        this.config = config != null ? config : new Idea52427Config();
