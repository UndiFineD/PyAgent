...
@Data
public class Idea52426Config {
    private String name = "idea_052426";
 ...
 */
@Slf4j
public class Idea52426Service {
    private static final int IDEA_ID = 52426;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52426Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52426Service() {
        this(new Idea52426Config());
    }

    public Idea52426Service(Idea52426Config config) {
        this.config = config != null ? config : new Idea52426Config();
