...
@Data
public class Idea52610Config {
    private String name = "idea_052610";
 ...
 */
@Slf4j
public class Idea52610Service {
    private static final int IDEA_ID = 52610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52610Service() {
        this(new Idea52610Config());
    }

    public Idea52610Service(Idea52610Config config) {
        this.config = config != null ? config : new Idea52610Config();
