...
@Data
public class Idea52705Config {
    private String name = "idea_052705";
 ...
 */
@Slf4j
public class Idea52705Service {
    private static final int IDEA_ID = 52705;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52705Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52705Service() {
        this(new Idea52705Config());
    }

    public Idea52705Service(Idea52705Config config) {
        this.config = config != null ? config : new Idea52705Config();
