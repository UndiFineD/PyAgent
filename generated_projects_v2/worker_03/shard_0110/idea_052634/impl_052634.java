...
@Data
public class Idea52634Config {
    private String name = "idea_052634";
 ...
 */
@Slf4j
public class Idea52634Service {
    private static final int IDEA_ID = 52634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52634Service() {
        this(new Idea52634Config());
    }

    public Idea52634Service(Idea52634Config config) {
        this.config = config != null ? config : new Idea52634Config();
