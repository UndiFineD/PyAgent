...
@Data
public class Idea52509Config {
    private String name = "idea_052509";
 ...
 */
@Slf4j
public class Idea52509Service {
    private static final int IDEA_ID = 52509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52509Service() {
        this(new Idea52509Config());
    }

    public Idea52509Service(Idea52509Config config) {
        this.config = config != null ? config : new Idea52509Config();
