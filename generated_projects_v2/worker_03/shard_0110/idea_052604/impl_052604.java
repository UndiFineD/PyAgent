...
@Data
public class Idea52604Config {
    private String name = "idea_052604";
 ...
 */
@Slf4j
public class Idea52604Service {
    private static final int IDEA_ID = 52604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52604Service() {
        this(new Idea52604Config());
    }

    public Idea52604Service(Idea52604Config config) {
        this.config = config != null ? config : new Idea52604Config();
