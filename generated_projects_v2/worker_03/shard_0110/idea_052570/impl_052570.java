...
@Data
public class Idea52570Config {
    private String name = "idea_052570";
 ...
 */
@Slf4j
public class Idea52570Service {
    private static final int IDEA_ID = 52570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52570Service() {
        this(new Idea52570Config());
    }

    public Idea52570Service(Idea52570Config config) {
        this.config = config != null ? config : new Idea52570Config();
