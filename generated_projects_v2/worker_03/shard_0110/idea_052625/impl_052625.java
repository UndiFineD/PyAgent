...
@Data
public class Idea52625Config {
    private String name = "idea_052625";
 ...
 */
@Slf4j
public class Idea52625Service {
    private static final int IDEA_ID = 52625;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52625Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52625Service() {
        this(new Idea52625Config());
    }

    public Idea52625Service(Idea52625Config config) {
        this.config = config != null ? config : new Idea52625Config();
