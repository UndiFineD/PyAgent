...
@Data
public class Idea52507Config {
    private String name = "idea_052507";
 ...
 */
@Slf4j
public class Idea52507Service {
    private static final int IDEA_ID = 52507;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52507Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52507Service() {
        this(new Idea52507Config());
    }

    public Idea52507Service(Idea52507Config config) {
        this.config = config != null ? config : new Idea52507Config();
