...
@Data
public class Idea52723Config {
    private String name = "idea_052723";
 ...
 */
@Slf4j
public class Idea52723Service {
    private static final int IDEA_ID = 52723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52723Service() {
        this(new Idea52723Config());
    }

    public Idea52723Service(Idea52723Config config) {
        this.config = config != null ? config : new Idea52723Config();
