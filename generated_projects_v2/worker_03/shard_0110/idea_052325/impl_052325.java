...
@Data
public class Idea52325Config {
    private String name = "idea_052325";
 ...
 */
@Slf4j
public class Idea52325Service {
    private static final int IDEA_ID = 52325;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52325Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52325Service() {
        this(new Idea52325Config());
    }

    public Idea52325Service(Idea52325Config config) {
        this.config = config != null ? config : new Idea52325Config();
