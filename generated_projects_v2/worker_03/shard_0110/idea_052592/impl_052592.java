...
@Data
public class Idea52592Config {
    private String name = "idea_052592";
 ...
 */
@Slf4j
public class Idea52592Service {
    private static final int IDEA_ID = 52592;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52592Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52592Service() {
        this(new Idea52592Config());
    }

    public Idea52592Service(Idea52592Config config) {
        this.config = config != null ? config : new Idea52592Config();
