...
@Data
public class Idea52418Config {
    private String name = "idea_052418";
 ...
 */
@Slf4j
public class Idea52418Service {
    private static final int IDEA_ID = 52418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52418Service() {
        this(new Idea52418Config());
    }

    public Idea52418Service(Idea52418Config config) {
        this.config = config != null ? config : new Idea52418Config();
