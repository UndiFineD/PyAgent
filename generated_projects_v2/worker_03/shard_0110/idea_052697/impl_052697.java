...
@Data
public class Idea52697Config {
    private String name = "idea_052697";
 ...
 */
@Slf4j
public class Idea52697Service {
    private static final int IDEA_ID = 52697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52697Service() {
        this(new Idea52697Config());
    }

    public Idea52697Service(Idea52697Config config) {
        this.config = config != null ? config : new Idea52697Config();
