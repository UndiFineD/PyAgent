...
@Data
public class Idea52702Config {
    private String name = "idea_052702";
 ...
 */
@Slf4j
public class Idea52702Service {
    private static final int IDEA_ID = 52702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52702Service() {
        this(new Idea52702Config());
    }

    public Idea52702Service(Idea52702Config config) {
        this.config = config != null ? config : new Idea52702Config();
