...
@Data
public class Idea52545Config {
    private String name = "idea_052545";
 ...
 */
@Slf4j
public class Idea52545Service {
    private static final int IDEA_ID = 52545;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52545Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52545Service() {
        this(new Idea52545Config());
    }

    public Idea52545Service(Idea52545Config config) {
        this.config = config != null ? config : new Idea52545Config();
