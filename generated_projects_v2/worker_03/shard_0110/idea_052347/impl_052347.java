...
@Data
public class Idea52347Config {
    private String name = "idea_052347";
 ...
 */
@Slf4j
public class Idea52347Service {
    private static final int IDEA_ID = 52347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52347Service() {
        this(new Idea52347Config());
    }

    public Idea52347Service(Idea52347Config config) {
        this.config = config != null ? config : new Idea52347Config();
