...
@Data
public class Idea52372Config {
    private String name = "idea_052372";
 ...
 */
@Slf4j
public class Idea52372Service {
    private static final int IDEA_ID = 52372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52372Service() {
        this(new Idea52372Config());
    }

    public Idea52372Service(Idea52372Config config) {
        this.config = config != null ? config : new Idea52372Config();
