...
@Data
public class Idea52358Config {
    private String name = "idea_052358";
 ...
 */
@Slf4j
public class Idea52358Service {
    private static final int IDEA_ID = 52358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52358Service() {
        this(new Idea52358Config());
    }

    public Idea52358Service(Idea52358Config config) {
        this.config = config != null ? config : new Idea52358Config();
