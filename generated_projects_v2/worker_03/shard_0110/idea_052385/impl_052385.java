...
@Data
public class Idea52385Config {
    private String name = "idea_052385";
 ...
 */
@Slf4j
public class Idea52385Service {
    private static final int IDEA_ID = 52385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52385Service() {
        this(new Idea52385Config());
    }

    public Idea52385Service(Idea52385Config config) {
        this.config = config != null ? config : new Idea52385Config();
