...
@Data
public class Idea52585Config {
    private String name = "idea_052585";
 ...
 */
@Slf4j
public class Idea52585Service {
    private static final int IDEA_ID = 52585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52585Service() {
        this(new Idea52585Config());
    }

    public Idea52585Service(Idea52585Config config) {
        this.config = config != null ? config : new Idea52585Config();
