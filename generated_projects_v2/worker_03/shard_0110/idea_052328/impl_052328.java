...
@Data
public class Idea52328Config {
    private String name = "idea_052328";
 ...
 */
@Slf4j
public class Idea52328Service {
    private static final int IDEA_ID = 52328;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52328Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52328Service() {
        this(new Idea52328Config());
    }

    public Idea52328Service(Idea52328Config config) {
        this.config = config != null ? config : new Idea52328Config();
