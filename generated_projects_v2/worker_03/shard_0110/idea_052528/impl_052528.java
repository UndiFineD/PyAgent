...
@Data
public class Idea52528Config {
    private String name = "idea_052528";
 ...
 */
@Slf4j
public class Idea52528Service {
    private static final int IDEA_ID = 52528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52528Service() {
        this(new Idea52528Config());
    }

    public Idea52528Service(Idea52528Config config) {
        this.config = config != null ? config : new Idea52528Config();
