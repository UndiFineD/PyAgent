...
@Data
public class Idea52302Config {
    private String name = "idea_052302";
 ...
 */
@Slf4j
public class Idea52302Service {
    private static final int IDEA_ID = 52302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52302Service() {
        this(new Idea52302Config());
    }

    public Idea52302Service(Idea52302Config config) {
        this.config = config != null ? config : new Idea52302Config();
