...
@Data
public class Idea52377Config {
    private String name = "idea_052377";
 ...
 */
@Slf4j
public class Idea52377Service {
    private static final int IDEA_ID = 52377;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52377Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52377Service() {
        this(new Idea52377Config());
    }

    public Idea52377Service(Idea52377Config config) {
        this.config = config != null ? config : new Idea52377Config();
