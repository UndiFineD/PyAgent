...
@Data
public class Idea52717Config {
    private String name = "idea_052717";
 ...
 */
@Slf4j
public class Idea52717Service {
    private static final int IDEA_ID = 52717;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52717Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52717Service() {
        this(new Idea52717Config());
    }

    public Idea52717Service(Idea52717Config config) {
        this.config = config != null ? config : new Idea52717Config();
