...
@Data
public class Idea52645Config {
    private String name = "idea_052645";
 ...
 */
@Slf4j
public class Idea52645Service {
    private static final int IDEA_ID = 52645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52645Service() {
        this(new Idea52645Config());
    }

    public Idea52645Service(Idea52645Config config) {
        this.config = config != null ? config : new Idea52645Config();
