...
@Data
public class Idea52370Config {
    private String name = "idea_052370";
 ...
 */
@Slf4j
public class Idea52370Service {
    private static final int IDEA_ID = 52370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52370Service() {
        this(new Idea52370Config());
    }

    public Idea52370Service(Idea52370Config config) {
        this.config = config != null ? config : new Idea52370Config();
