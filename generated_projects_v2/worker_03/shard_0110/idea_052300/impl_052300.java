...
@Data
public class Idea52300Config {
    private String name = "idea_052300";
 ...
 */
@Slf4j
public class Idea52300Service {
    private static final int IDEA_ID = 52300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52300Service() {
        this(new Idea52300Config());
    }

    public Idea52300Service(Idea52300Config config) {
        this.config = config != null ? config : new Idea52300Config();
