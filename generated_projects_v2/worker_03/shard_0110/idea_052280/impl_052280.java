...
@Data
public class Idea52280Config {
    private String name = "idea_052280";
 ...
 */
@Slf4j
public class Idea52280Service {
    private static final int IDEA_ID = 52280;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52280Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52280Service() {
        this(new Idea52280Config());
    }

    public Idea52280Service(Idea52280Config config) {
        this.config = config != null ? config : new Idea52280Config();
