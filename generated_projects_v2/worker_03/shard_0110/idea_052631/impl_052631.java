...
@Data
public class Idea52631Config {
    private String name = "idea_052631";
 ...
 */
@Slf4j
public class Idea52631Service {
    private static final int IDEA_ID = 52631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52631Service() {
        this(new Idea52631Config());
    }

    public Idea52631Service(Idea52631Config config) {
        this.config = config != null ? config : new Idea52631Config();
