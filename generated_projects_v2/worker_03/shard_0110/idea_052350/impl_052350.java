...
@Data
public class Idea52350Config {
    private String name = "idea_052350";
 ...
 */
@Slf4j
public class Idea52350Service {
    private static final int IDEA_ID = 52350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52350Service() {
        this(new Idea52350Config());
    }

    public Idea52350Service(Idea52350Config config) {
        this.config = config != null ? config : new Idea52350Config();
