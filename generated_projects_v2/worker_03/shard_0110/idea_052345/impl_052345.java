...
@Data
public class Idea52345Config {
    private String name = "idea_052345";
 ...
 */
@Slf4j
public class Idea52345Service {
    private static final int IDEA_ID = 52345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52345Service() {
        this(new Idea52345Config());
    }

    public Idea52345Service(Idea52345Config config) {
        this.config = config != null ? config : new Idea52345Config();
