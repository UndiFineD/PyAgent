...
@Data
public class Idea52357Config {
    private String name = "idea_052357";
 ...
 */
@Slf4j
public class Idea52357Service {
    private static final int IDEA_ID = 52357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52357Service() {
        this(new Idea52357Config());
    }

    public Idea52357Service(Idea52357Config config) {
        this.config = config != null ? config : new Idea52357Config();
