...
@Data
public class Idea52422Config {
    private String name = "idea_052422";
 ...
 */
@Slf4j
public class Idea52422Service {
    private static final int IDEA_ID = 52422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52422Service() {
        this(new Idea52422Config());
    }

    public Idea52422Service(Idea52422Config config) {
        this.config = config != null ? config : new Idea52422Config();
