...
@Data
public class Idea52365Config {
    private String name = "idea_052365";
 ...
 */
@Slf4j
public class Idea52365Service {
    private static final int IDEA_ID = 52365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52365Service() {
        this(new Idea52365Config());
    }

    public Idea52365Service(Idea52365Config config) {
        this.config = config != null ? config : new Idea52365Config();
