...
@Data
public class Idea52600Config {
    private String name = "idea_052600";
 ...
 */
@Slf4j
public class Idea52600Service {
    private static final int IDEA_ID = 52600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52600Service() {
        this(new Idea52600Config());
    }

    public Idea52600Service(Idea52600Config config) {
        this.config = config != null ? config : new Idea52600Config();
