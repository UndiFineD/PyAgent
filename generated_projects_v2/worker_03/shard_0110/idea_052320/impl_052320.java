...
@Data
public class Idea52320Config {
    private String name = "idea_052320";
 ...
 */
@Slf4j
public class Idea52320Service {
    private static final int IDEA_ID = 52320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52320Service() {
        this(new Idea52320Config());
    }

    public Idea52320Service(Idea52320Config config) {
        this.config = config != null ? config : new Idea52320Config();
