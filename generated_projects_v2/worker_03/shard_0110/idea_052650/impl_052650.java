...
@Data
public class Idea52650Config {
    private String name = "idea_052650";
 ...
 */
@Slf4j
public class Idea52650Service {
    private static final int IDEA_ID = 52650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52650Service() {
        this(new Idea52650Config());
    }

    public Idea52650Service(Idea52650Config config) {
        this.config = config != null ? config : new Idea52650Config();
