...
@Data
public class Idea52405Config {
    private String name = "idea_052405";
 ...
 */
@Slf4j
public class Idea52405Service {
    private static final int IDEA_ID = 52405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52405Service() {
        this(new Idea52405Config());
    }

    public Idea52405Service(Idea52405Config config) {
        this.config = config != null ? config : new Idea52405Config();
