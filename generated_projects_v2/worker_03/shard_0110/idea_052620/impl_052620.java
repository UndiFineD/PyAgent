...
@Data
public class Idea52620Config {
    private String name = "idea_052620";
 ...
 */
@Slf4j
public class Idea52620Service {
    private static final int IDEA_ID = 52620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52620Service() {
        this(new Idea52620Config());
    }

    public Idea52620Service(Idea52620Config config) {
        this.config = config != null ? config : new Idea52620Config();
