...
@Data
public class Idea52465Config {
    private String name = "idea_052465";
 ...
 */
@Slf4j
public class Idea52465Service {
    private static final int IDEA_ID = 52465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52465Service() {
        this(new Idea52465Config());
    }

    public Idea52465Service(Idea52465Config config) {
        this.config = config != null ? config : new Idea52465Config();
