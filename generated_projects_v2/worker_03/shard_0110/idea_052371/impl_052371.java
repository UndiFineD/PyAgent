...
@Data
public class Idea52371Config {
    private String name = "idea_052371";
 ...
 */
@Slf4j
public class Idea52371Service {
    private static final int IDEA_ID = 52371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52371Service() {
        this(new Idea52371Config());
    }

    public Idea52371Service(Idea52371Config config) {
        this.config = config != null ? config : new Idea52371Config();
