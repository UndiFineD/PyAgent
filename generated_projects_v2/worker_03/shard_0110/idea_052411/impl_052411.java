...
@Data
public class Idea52411Config {
    private String name = "idea_052411";
 ...
 */
@Slf4j
public class Idea52411Service {
    private static final int IDEA_ID = 52411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52411Service() {
        this(new Idea52411Config());
    }

    public Idea52411Service(Idea52411Config config) {
        this.config = config != null ? config : new Idea52411Config();
