...
@Data
public class Idea52517Config {
    private String name = "idea_052517";
 ...
 */
@Slf4j
public class Idea52517Service {
    private static final int IDEA_ID = 52517;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52517Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52517Service() {
        this(new Idea52517Config());
    }

    public Idea52517Service(Idea52517Config config) {
        this.config = config != null ? config : new Idea52517Config();
