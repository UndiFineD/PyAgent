...
@Data
public class Idea52438Config {
    private String name = "idea_052438";
 ...
 */
@Slf4j
public class Idea52438Service {
    private static final int IDEA_ID = 52438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52438Service() {
        this(new Idea52438Config());
    }

    public Idea52438Service(Idea52438Config config) {
        this.config = config != null ? config : new Idea52438Config();
