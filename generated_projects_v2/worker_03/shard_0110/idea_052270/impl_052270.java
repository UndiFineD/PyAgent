...
@Data
public class Idea52270Config {
    private String name = "idea_052270";
 ...
 */
@Slf4j
public class Idea52270Service {
    private static final int IDEA_ID = 52270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52270Service() {
        this(new Idea52270Config());
    }

    public Idea52270Service(Idea52270Config config) {
        this.config = config != null ? config : new Idea52270Config();
