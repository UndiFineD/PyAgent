...
@Data
public class Idea52403Config {
    private String name = "idea_052403";
 ...
 */
@Slf4j
public class Idea52403Service {
    private static final int IDEA_ID = 52403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52403Service() {
        this(new Idea52403Config());
    }

    public Idea52403Service(Idea52403Config config) {
        this.config = config != null ? config : new Idea52403Config();
