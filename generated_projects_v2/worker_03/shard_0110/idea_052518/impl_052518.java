...
@Data
public class Idea52518Config {
    private String name = "idea_052518";
 ...
 */
@Slf4j
public class Idea52518Service {
    private static final int IDEA_ID = 52518;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52518Service() {
        this(new Idea52518Config());
    }

    public Idea52518Service(Idea52518Config config) {
        this.config = config != null ? config : new Idea52518Config();
