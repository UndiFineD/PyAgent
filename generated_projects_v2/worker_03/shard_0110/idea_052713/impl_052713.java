...
@Data
public class Idea52713Config {
    private String name = "idea_052713";
 ...
 */
@Slf4j
public class Idea52713Service {
    private static final int IDEA_ID = 52713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52713Service() {
        this(new Idea52713Config());
    }

    public Idea52713Service(Idea52713Config config) {
        this.config = config != null ? config : new Idea52713Config();
