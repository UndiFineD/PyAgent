...
@Data
public class Idea52567Config {
    private String name = "idea_052567";
 ...
 */
@Slf4j
public class Idea52567Service {
    private static final int IDEA_ID = 52567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52567Service() {
        this(new Idea52567Config());
    }

    public Idea52567Service(Idea52567Config config) {
        this.config = config != null ? config : new Idea52567Config();
