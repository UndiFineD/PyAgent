...
@Data
public class Idea52571Config {
    private String name = "idea_052571";
 ...
 */
@Slf4j
public class Idea52571Service {
    private static final int IDEA_ID = 52571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52571Service() {
        this(new Idea52571Config());
    }

    public Idea52571Service(Idea52571Config config) {
        this.config = config != null ? config : new Idea52571Config();
