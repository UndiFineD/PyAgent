...
@Data
public class Idea52583Config {
    private String name = "idea_052583";
 ...
 */
@Slf4j
public class Idea52583Service {
    private static final int IDEA_ID = 52583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52583Service() {
        this(new Idea52583Config());
    }

    public Idea52583Service(Idea52583Config config) {
        this.config = config != null ? config : new Idea52583Config();
