...
@Data
public class Idea52467Config {
    private String name = "idea_052467";
 ...
 */
@Slf4j
public class Idea52467Service {
    private static final int IDEA_ID = 52467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52467Service() {
        this(new Idea52467Config());
    }

    public Idea52467Service(Idea52467Config config) {
        this.config = config != null ? config : new Idea52467Config();
