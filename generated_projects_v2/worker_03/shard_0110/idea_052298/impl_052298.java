...
@Data
public class Idea52298Config {
    private String name = "idea_052298";
 ...
 */
@Slf4j
public class Idea52298Service {
    private static final int IDEA_ID = 52298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52298Service() {
        this(new Idea52298Config());
    }

    public Idea52298Service(Idea52298Config config) {
        this.config = config != null ? config : new Idea52298Config();
