...
@Data
public class Idea52337Config {
    private String name = "idea_052337";
 ...
 */
@Slf4j
public class Idea52337Service {
    private static final int IDEA_ID = 52337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52337Service() {
        this(new Idea52337Config());
    }

    public Idea52337Service(Idea52337Config config) {
        this.config = config != null ? config : new Idea52337Config();
