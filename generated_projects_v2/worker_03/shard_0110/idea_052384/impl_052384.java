...
@Data
public class Idea52384Config {
    private String name = "idea_052384";
 ...
 */
@Slf4j
public class Idea52384Service {
    private static final int IDEA_ID = 52384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52384Service() {
        this(new Idea52384Config());
    }

    public Idea52384Service(Idea52384Config config) {
        this.config = config != null ? config : new Idea52384Config();
