...
@Data
public class Idea52266Config {
    private String name = "idea_052266";
 ...
 */
@Slf4j
public class Idea52266Service {
    private static final int IDEA_ID = 52266;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52266Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52266Service() {
        this(new Idea52266Config());
    }

    public Idea52266Service(Idea52266Config config) {
        this.config = config != null ? config : new Idea52266Config();
