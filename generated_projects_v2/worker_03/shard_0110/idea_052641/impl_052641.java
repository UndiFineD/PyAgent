...
@Data
public class Idea52641Config {
    private String name = "idea_052641";
 ...
 */
@Slf4j
public class Idea52641Service {
    private static final int IDEA_ID = 52641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52641Service() {
        this(new Idea52641Config());
    }

    public Idea52641Service(Idea52641Config config) {
        this.config = config != null ? config : new Idea52641Config();
