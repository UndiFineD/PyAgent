...
@Data
public class Idea52711Config {
    private String name = "idea_052711";
 ...
 */
@Slf4j
public class Idea52711Service {
    private static final int IDEA_ID = 52711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52711Service() {
        this(new Idea52711Config());
    }

    public Idea52711Service(Idea52711Config config) {
        this.config = config != null ? config : new Idea52711Config();
