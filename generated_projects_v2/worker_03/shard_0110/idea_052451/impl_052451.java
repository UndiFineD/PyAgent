...
@Data
public class Idea52451Config {
    private String name = "idea_052451";
 ...
 */
@Slf4j
public class Idea52451Service {
    private static final int IDEA_ID = 52451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52451Service() {
        this(new Idea52451Config());
    }

    public Idea52451Service(Idea52451Config config) {
        this.config = config != null ? config : new Idea52451Config();
