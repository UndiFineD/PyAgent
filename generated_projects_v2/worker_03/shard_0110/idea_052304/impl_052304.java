...
@Data
public class Idea52304Config {
    private String name = "idea_052304";
 ...
 */
@Slf4j
public class Idea52304Service {
    private static final int IDEA_ID = 52304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52304Service() {
        this(new Idea52304Config());
    }

    public Idea52304Service(Idea52304Config config) {
        this.config = config != null ? config : new Idea52304Config();
