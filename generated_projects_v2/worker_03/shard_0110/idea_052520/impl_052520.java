...
@Data
public class Idea52520Config {
    private String name = "idea_052520";
 ...
 */
@Slf4j
public class Idea52520Service {
    private static final int IDEA_ID = 52520;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52520Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52520Service() {
        this(new Idea52520Config());
    }

    public Idea52520Service(Idea52520Config config) {
        this.config = config != null ? config : new Idea52520Config();
