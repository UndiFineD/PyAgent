...
@Data
public class Idea52480Config {
    private String name = "idea_052480";
 ...
 */
@Slf4j
public class Idea52480Service {
    private static final int IDEA_ID = 52480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52480Service() {
        this(new Idea52480Config());
    }

    public Idea52480Service(Idea52480Config config) {
        this.config = config != null ? config : new Idea52480Config();
