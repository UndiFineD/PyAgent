...
@Data
public class Idea52626Config {
    private String name = "idea_052626";
 ...
 */
@Slf4j
public class Idea52626Service {
    private static final int IDEA_ID = 52626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52626Service() {
        this(new Idea52626Config());
    }

    public Idea52626Service(Idea52626Config config) {
        this.config = config != null ? config : new Idea52626Config();
