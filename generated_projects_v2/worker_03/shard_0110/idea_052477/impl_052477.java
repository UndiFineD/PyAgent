...
@Data
public class Idea52477Config {
    private String name = "idea_052477";
 ...
 */
@Slf4j
public class Idea52477Service {
    private static final int IDEA_ID = 52477;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52477Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52477Service() {
        this(new Idea52477Config());
    }

    public Idea52477Service(Idea52477Config config) {
        this.config = config != null ? config : new Idea52477Config();
