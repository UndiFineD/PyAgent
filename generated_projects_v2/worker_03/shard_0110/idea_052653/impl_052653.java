...
@Data
public class Idea52653Config {
    private String name = "idea_052653";
 ...
 */
@Slf4j
public class Idea52653Service {
    private static final int IDEA_ID = 52653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52653Service() {
        this(new Idea52653Config());
    }

    public Idea52653Service(Idea52653Config config) {
        this.config = config != null ? config : new Idea52653Config();
