...
@Data
public class Idea52551Config {
    private String name = "idea_052551";
 ...
 */
@Slf4j
public class Idea52551Service {
    private static final int IDEA_ID = 52551;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52551Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52551Service() {
        this(new Idea52551Config());
    }

    public Idea52551Service(Idea52551Config config) {
        this.config = config != null ? config : new Idea52551Config();
