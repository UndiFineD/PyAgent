...
@Data
public class Idea52617Config {
    private String name = "idea_052617";
 ...
 */
@Slf4j
public class Idea52617Service {
    private static final int IDEA_ID = 52617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52617Service() {
        this(new Idea52617Config());
    }

    public Idea52617Service(Idea52617Config config) {
        this.config = config != null ? config : new Idea52617Config();
