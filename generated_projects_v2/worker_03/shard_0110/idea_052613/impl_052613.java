...
@Data
public class Idea52613Config {
    private String name = "idea_052613";
 ...
 */
@Slf4j
public class Idea52613Service {
    private static final int IDEA_ID = 52613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52613Service() {
        this(new Idea52613Config());
    }

    public Idea52613Service(Idea52613Config config) {
        this.config = config != null ? config : new Idea52613Config();
