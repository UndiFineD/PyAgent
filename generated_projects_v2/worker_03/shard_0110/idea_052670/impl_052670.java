...
@Data
public class Idea52670Config {
    private String name = "idea_052670";
 ...
 */
@Slf4j
public class Idea52670Service {
    private static final int IDEA_ID = 52670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52670Service() {
        this(new Idea52670Config());
    }

    public Idea52670Service(Idea52670Config config) {
        this.config = config != null ? config : new Idea52670Config();
