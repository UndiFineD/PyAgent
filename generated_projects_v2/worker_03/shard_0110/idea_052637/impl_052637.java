...
@Data
public class Idea52637Config {
    private String name = "idea_052637";
 ...
 */
@Slf4j
public class Idea52637Service {
    private static final int IDEA_ID = 52637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52637Service() {
        this(new Idea52637Config());
    }

    public Idea52637Service(Idea52637Config config) {
        this.config = config != null ? config : new Idea52637Config();
