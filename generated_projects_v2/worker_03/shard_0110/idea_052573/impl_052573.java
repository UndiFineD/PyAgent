...
@Data
public class Idea52573Config {
    private String name = "idea_052573";
 ...
 */
@Slf4j
public class Idea52573Service {
    private static final int IDEA_ID = 52573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52573Service() {
        this(new Idea52573Config());
    }

    public Idea52573Service(Idea52573Config config) {
        this.config = config != null ? config : new Idea52573Config();
