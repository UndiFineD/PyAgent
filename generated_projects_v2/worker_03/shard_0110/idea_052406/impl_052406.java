...
@Data
public class Idea52406Config {
    private String name = "idea_052406";
 ...
 */
@Slf4j
public class Idea52406Service {
    private static final int IDEA_ID = 52406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52406Service() {
        this(new Idea52406Config());
    }

    public Idea52406Service(Idea52406Config config) {
        this.config = config != null ? config : new Idea52406Config();
