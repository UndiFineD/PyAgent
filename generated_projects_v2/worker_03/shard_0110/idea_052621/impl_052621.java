...
@Data
public class Idea52621Config {
    private String name = "idea_052621";
 ...
 */
@Slf4j
public class Idea52621Service {
    private static final int IDEA_ID = 52621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52621Service() {
        this(new Idea52621Config());
    }

    public Idea52621Service(Idea52621Config config) {
        this.config = config != null ? config : new Idea52621Config();
