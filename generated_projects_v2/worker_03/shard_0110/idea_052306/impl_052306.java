...
@Data
public class Idea52306Config {
    private String name = "idea_052306";
 ...
 */
@Slf4j
public class Idea52306Service {
    private static final int IDEA_ID = 52306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52306Service() {
        this(new Idea52306Config());
    }

    public Idea52306Service(Idea52306Config config) {
        this.config = config != null ? config : new Idea52306Config();
