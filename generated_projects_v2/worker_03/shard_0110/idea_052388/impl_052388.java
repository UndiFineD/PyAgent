...
@Data
public class Idea52388Config {
    private String name = "idea_052388";
 ...
 */
@Slf4j
public class Idea52388Service {
    private static final int IDEA_ID = 52388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52388Service() {
        this(new Idea52388Config());
    }

    public Idea52388Service(Idea52388Config config) {
        this.config = config != null ? config : new Idea52388Config();
