...
@Data
public class Idea52586Config {
    private String name = "idea_052586";
 ...
 */
@Slf4j
public class Idea52586Service {
    private static final int IDEA_ID = 52586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52586Service() {
        this(new Idea52586Config());
    }

    public Idea52586Service(Idea52586Config config) {
        this.config = config != null ? config : new Idea52586Config();
