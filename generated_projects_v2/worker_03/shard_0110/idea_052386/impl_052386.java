...
@Data
public class Idea52386Config {
    private String name = "idea_052386";
 ...
 */
@Slf4j
public class Idea52386Service {
    private static final int IDEA_ID = 52386;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52386Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52386Service() {
        this(new Idea52386Config());
    }

    public Idea52386Service(Idea52386Config config) {
        this.config = config != null ? config : new Idea52386Config();
