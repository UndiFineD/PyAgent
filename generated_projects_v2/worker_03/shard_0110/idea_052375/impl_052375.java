...
@Data
public class Idea52375Config {
    private String name = "idea_052375";
 ...
 */
@Slf4j
public class Idea52375Service {
    private static final int IDEA_ID = 52375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52375Service() {
        this(new Idea52375Config());
    }

    public Idea52375Service(Idea52375Config config) {
        this.config = config != null ? config : new Idea52375Config();
