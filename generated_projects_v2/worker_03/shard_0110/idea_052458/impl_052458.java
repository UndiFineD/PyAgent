...
@Data
public class Idea52458Config {
    private String name = "idea_052458";
 ...
 */
@Slf4j
public class Idea52458Service {
    private static final int IDEA_ID = 52458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52458Service() {
        this(new Idea52458Config());
    }

    public Idea52458Service(Idea52458Config config) {
        this.config = config != null ? config : new Idea52458Config();
