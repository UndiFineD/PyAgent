...
@Data
public class Idea52255Config {
    private String name = "idea_052255";
 ...
 */
@Slf4j
public class Idea52255Service {
    private static final int IDEA_ID = 52255;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52255Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52255Service() {
        this(new Idea52255Config());
    }

    public Idea52255Service(Idea52255Config config) {
        this.config = config != null ? config : new Idea52255Config();
