...
@Data
public class Idea52647Config {
    private String name = "idea_052647";
 ...
 */
@Slf4j
public class Idea52647Service {
    private static final int IDEA_ID = 52647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52647Service() {
        this(new Idea52647Config());
    }

    public Idea52647Service(Idea52647Config config) {
        this.config = config != null ? config : new Idea52647Config();
