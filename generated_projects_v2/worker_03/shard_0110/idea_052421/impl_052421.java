...
@Data
public class Idea52421Config {
    private String name = "idea_052421";
 ...
 */
@Slf4j
public class Idea52421Service {
    private static final int IDEA_ID = 52421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52421Service() {
        this(new Idea52421Config());
    }

    public Idea52421Service(Idea52421Config config) {
        this.config = config != null ? config : new Idea52421Config();
