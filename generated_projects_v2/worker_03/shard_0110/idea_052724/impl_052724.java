...
@Data
public class Idea52724Config {
    private String name = "idea_052724";
 ...
 */
@Slf4j
public class Idea52724Service {
    private static final int IDEA_ID = 52724;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52724Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52724Service() {
        this(new Idea52724Config());
    }

    public Idea52724Service(Idea52724Config config) {
        this.config = config != null ? config : new Idea52724Config();
