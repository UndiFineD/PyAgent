...
@Data
public class Idea52635Config {
    private String name = "idea_052635";
 ...
 */
@Slf4j
public class Idea52635Service {
    private static final int IDEA_ID = 52635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52635Service() {
        this(new Idea52635Config());
    }

    public Idea52635Service(Idea52635Config config) {
        this.config = config != null ? config : new Idea52635Config();
