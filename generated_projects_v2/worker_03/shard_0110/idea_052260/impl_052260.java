...
@Data
public class Idea52260Config {
    private String name = "idea_052260";
 ...
 */
@Slf4j
public class Idea52260Service {
    private static final int IDEA_ID = 52260;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52260Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52260Service() {
        this(new Idea52260Config());
    }

    public Idea52260Service(Idea52260Config config) {
        this.config = config != null ? config : new Idea52260Config();
