...
@Data
public class Idea52701Config {
    private String name = "idea_052701";
 ...
 */
@Slf4j
public class Idea52701Service {
    private static final int IDEA_ID = 52701;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52701Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52701Service() {
        this(new Idea52701Config());
    }

    public Idea52701Service(Idea52701Config config) {
        this.config = config != null ? config : new Idea52701Config();
