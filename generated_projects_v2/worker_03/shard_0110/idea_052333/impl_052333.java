...
@Data
public class Idea52333Config {
    private String name = "idea_052333";
 ...
 */
@Slf4j
public class Idea52333Service {
    private static final int IDEA_ID = 52333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52333Service() {
        this(new Idea52333Config());
    }

    public Idea52333Service(Idea52333Config config) {
        this.config = config != null ? config : new Idea52333Config();
