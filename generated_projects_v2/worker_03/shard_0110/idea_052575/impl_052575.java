...
@Data
public class Idea52575Config {
    private String name = "idea_052575";
 ...
 */
@Slf4j
public class Idea52575Service {
    private static final int IDEA_ID = 52575;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52575Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52575Service() {
        this(new Idea52575Config());
    }

    public Idea52575Service(Idea52575Config config) {
        this.config = config != null ? config : new Idea52575Config();
