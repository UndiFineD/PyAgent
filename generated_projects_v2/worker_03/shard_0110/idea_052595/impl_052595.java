...
@Data
public class Idea52595Config {
    private String name = "idea_052595";
 ...
 */
@Slf4j
public class Idea52595Service {
    private static final int IDEA_ID = 52595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52595Service() {
        this(new Idea52595Config());
    }

    public Idea52595Service(Idea52595Config config) {
        this.config = config != null ? config : new Idea52595Config();
