...
@Data
public class Idea52380Config {
    private String name = "idea_052380";
 ...
 */
@Slf4j
public class Idea52380Service {
    private static final int IDEA_ID = 52380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52380Service() {
        this(new Idea52380Config());
    }

    public Idea52380Service(Idea52380Config config) {
        this.config = config != null ? config : new Idea52380Config();
