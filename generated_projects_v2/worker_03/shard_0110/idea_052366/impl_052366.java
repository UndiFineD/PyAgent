...
@Data
public class Idea52366Config {
    private String name = "idea_052366";
 ...
 */
@Slf4j
public class Idea52366Service {
    private static final int IDEA_ID = 52366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52366Service() {
        this(new Idea52366Config());
    }

    public Idea52366Service(Idea52366Config config) {
        this.config = config != null ? config : new Idea52366Config();
