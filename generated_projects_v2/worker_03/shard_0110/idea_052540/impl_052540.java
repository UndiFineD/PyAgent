...
@Data
public class Idea52540Config {
    private String name = "idea_052540";
 ...
 */
@Slf4j
public class Idea52540Service {
    private static final int IDEA_ID = 52540;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52540Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52540Service() {
        this(new Idea52540Config());
    }

    public Idea52540Service(Idea52540Config config) {
        this.config = config != null ? config : new Idea52540Config();
