...
@Data
public class Idea52524Config {
    private String name = "idea_052524";
 ...
 */
@Slf4j
public class Idea52524Service {
    private static final int IDEA_ID = 52524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52524Service() {
        this(new Idea52524Config());
    }

    public Idea52524Service(Idea52524Config config) {
        this.config = config != null ? config : new Idea52524Config();
