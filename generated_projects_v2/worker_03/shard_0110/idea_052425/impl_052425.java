...
@Data
public class Idea52425Config {
    private String name = "idea_052425";
 ...
 */
@Slf4j
public class Idea52425Service {
    private static final int IDEA_ID = 52425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52425Service() {
        this(new Idea52425Config());
    }

    public Idea52425Service(Idea52425Config config) {
        this.config = config != null ? config : new Idea52425Config();
