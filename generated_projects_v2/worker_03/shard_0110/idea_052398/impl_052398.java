...
@Data
public class Idea52398Config {
    private String name = "idea_052398";
 ...
 */
@Slf4j
public class Idea52398Service {
    private static final int IDEA_ID = 52398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52398Service() {
        this(new Idea52398Config());
    }

    public Idea52398Service(Idea52398Config config) {
        this.config = config != null ? config : new Idea52398Config();
