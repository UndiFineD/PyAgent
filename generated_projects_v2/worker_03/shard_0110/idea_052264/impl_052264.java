...
@Data
public class Idea52264Config {
    private String name = "idea_052264";
 ...
 */
@Slf4j
public class Idea52264Service {
    private static final int IDEA_ID = 52264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52264Service() {
        this(new Idea52264Config());
    }

    public Idea52264Service(Idea52264Config config) {
        this.config = config != null ? config : new Idea52264Config();
