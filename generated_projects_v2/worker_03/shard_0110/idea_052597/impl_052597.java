...
@Data
public class Idea52597Config {
    private String name = "idea_052597";
 ...
 */
@Slf4j
public class Idea52597Service {
    private static final int IDEA_ID = 52597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52597Service() {
        this(new Idea52597Config());
    }

    public Idea52597Service(Idea52597Config config) {
        this.config = config != null ? config : new Idea52597Config();
