...
@Data
public class Idea52311Config {
    private String name = "idea_052311";
 ...
 */
@Slf4j
public class Idea52311Service {
    private static final int IDEA_ID = 52311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52311Service() {
        this(new Idea52311Config());
    }

    public Idea52311Service(Idea52311Config config) {
        this.config = config != null ? config : new Idea52311Config();
