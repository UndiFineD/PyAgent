...
@Data
public class Idea52624Config {
    private String name = "idea_052624";
 ...
 */
@Slf4j
public class Idea52624Service {
    private static final int IDEA_ID = 52624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52624Service() {
        this(new Idea52624Config());
    }

    public Idea52624Service(Idea52624Config config) {
        this.config = config != null ? config : new Idea52624Config();
