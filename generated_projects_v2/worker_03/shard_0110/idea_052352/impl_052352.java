...
@Data
public class Idea52352Config {
    private String name = "idea_052352";
 ...
 */
@Slf4j
public class Idea52352Service {
    private static final int IDEA_ID = 52352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52352Service() {
        this(new Idea52352Config());
    }

    public Idea52352Service(Idea52352Config config) {
        this.config = config != null ? config : new Idea52352Config();
