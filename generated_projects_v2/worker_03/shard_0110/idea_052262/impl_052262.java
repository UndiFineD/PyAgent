...
@Data
public class Idea52262Config {
    private String name = "idea_052262";
 ...
 */
@Slf4j
public class Idea52262Service {
    private static final int IDEA_ID = 52262;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52262Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52262Service() {
        this(new Idea52262Config());
    }

    public Idea52262Service(Idea52262Config config) {
        this.config = config != null ? config : new Idea52262Config();
