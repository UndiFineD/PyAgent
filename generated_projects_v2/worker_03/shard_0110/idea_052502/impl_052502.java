...
@Data
public class Idea52502Config {
    private String name = "idea_052502";
 ...
 */
@Slf4j
public class Idea52502Service {
    private static final int IDEA_ID = 52502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52502Service() {
        this(new Idea52502Config());
    }

    public Idea52502Service(Idea52502Config config) {
        this.config = config != null ? config : new Idea52502Config();
