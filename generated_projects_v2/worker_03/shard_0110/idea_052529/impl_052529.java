...
@Data
public class Idea52529Config {
    private String name = "idea_052529";
 ...
 */
@Slf4j
public class Idea52529Service {
    private static final int IDEA_ID = 52529;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52529Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52529Service() {
        this(new Idea52529Config());
    }

    public Idea52529Service(Idea52529Config config) {
        this.config = config != null ? config : new Idea52529Config();
