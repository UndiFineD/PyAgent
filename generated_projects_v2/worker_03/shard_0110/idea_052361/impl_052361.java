...
@Data
public class Idea52361Config {
    private String name = "idea_052361";
 ...
 */
@Slf4j
public class Idea52361Service {
    private static final int IDEA_ID = 52361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52361Service() {
        this(new Idea52361Config());
    }

    public Idea52361Service(Idea52361Config config) {
        this.config = config != null ? config : new Idea52361Config();
