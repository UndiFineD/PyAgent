...
@Data
public class Idea52394Config {
    private String name = "idea_052394";
 ...
 */
@Slf4j
public class Idea52394Service {
    private static final int IDEA_ID = 52394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52394Service() {
        this(new Idea52394Config());
    }

    public Idea52394Service(Idea52394Config config) {
        this.config = config != null ? config : new Idea52394Config();
