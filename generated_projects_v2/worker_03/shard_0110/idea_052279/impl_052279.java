...
@Data
public class Idea52279Config {
    private String name = "idea_052279";
 ...
 */
@Slf4j
public class Idea52279Service {
    private static final int IDEA_ID = 52279;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52279Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52279Service() {
        this(new Idea52279Config());
    }

    public Idea52279Service(Idea52279Config config) {
        this.config = config != null ? config : new Idea52279Config();
