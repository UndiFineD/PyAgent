...
@Data
public class Idea52395Config {
    private String name = "idea_052395";
 ...
 */
@Slf4j
public class Idea52395Service {
    private static final int IDEA_ID = 52395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52395Service() {
        this(new Idea52395Config());
    }

    public Idea52395Service(Idea52395Config config) {
        this.config = config != null ? config : new Idea52395Config();
