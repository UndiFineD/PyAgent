...
@Data
public class Idea52428Config {
    private String name = "idea_052428";
 ...
 */
@Slf4j
public class Idea52428Service {
    private static final int IDEA_ID = 52428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52428Service() {
        this(new Idea52428Config());
    }

    public Idea52428Service(Idea52428Config config) {
        this.config = config != null ? config : new Idea52428Config();
