...
@Data
public class Idea52607Config {
    private String name = "idea_052607";
 ...
 */
@Slf4j
public class Idea52607Service {
    private static final int IDEA_ID = 52607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52607Service() {
        this(new Idea52607Config());
    }

    public Idea52607Service(Idea52607Config config) {
        this.config = config != null ? config : new Idea52607Config();
