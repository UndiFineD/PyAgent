...
@Data
public class Idea52651Config {
    private String name = "idea_052651";
 ...
 */
@Slf4j
public class Idea52651Service {
    private static final int IDEA_ID = 52651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52651Service() {
        this(new Idea52651Config());
    }

    public Idea52651Service(Idea52651Config config) {
        this.config = config != null ? config : new Idea52651Config();
