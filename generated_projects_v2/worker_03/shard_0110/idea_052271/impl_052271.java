...
@Data
public class Idea52271Config {
    private String name = "idea_052271";
 ...
 */
@Slf4j
public class Idea52271Service {
    private static final int IDEA_ID = 52271;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52271Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52271Service() {
        this(new Idea52271Config());
    }

    public Idea52271Service(Idea52271Config config) {
        this.config = config != null ? config : new Idea52271Config();
