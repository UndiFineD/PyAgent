...
@Data
public class Idea52462Config {
    private String name = "idea_052462";
 ...
 */
@Slf4j
public class Idea52462Service {
    private static final int IDEA_ID = 52462;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52462Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52462Service() {
        this(new Idea52462Config());
    }

    public Idea52462Service(Idea52462Config config) {
        this.config = config != null ? config : new Idea52462Config();
