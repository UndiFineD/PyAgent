...
@Data
public class Idea52374Config {
    private String name = "idea_052374";
 ...
 */
@Slf4j
public class Idea52374Service {
    private static final int IDEA_ID = 52374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52374Service() {
        this(new Idea52374Config());
    }

    public Idea52374Service(Idea52374Config config) {
        this.config = config != null ? config : new Idea52374Config();
