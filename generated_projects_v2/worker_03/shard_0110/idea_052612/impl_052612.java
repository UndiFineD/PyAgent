...
@Data
public class Idea52612Config {
    private String name = "idea_052612";
 ...
 */
@Slf4j
public class Idea52612Service {
    private static final int IDEA_ID = 52612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52612Service() {
        this(new Idea52612Config());
    }

    public Idea52612Service(Idea52612Config config) {
        this.config = config != null ? config : new Idea52612Config();
