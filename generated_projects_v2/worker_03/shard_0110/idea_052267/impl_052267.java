...
@Data
public class Idea52267Config {
    private String name = "idea_052267";
 ...
 */
@Slf4j
public class Idea52267Service {
    private static final int IDEA_ID = 52267;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52267Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52267Service() {
        this(new Idea52267Config());
    }

    public Idea52267Service(Idea52267Config config) {
        this.config = config != null ? config : new Idea52267Config();
