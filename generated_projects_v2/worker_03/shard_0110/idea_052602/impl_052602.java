...
@Data
public class Idea52602Config {
    private String name = "idea_052602";
 ...
 */
@Slf4j
public class Idea52602Service {
    private static final int IDEA_ID = 52602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52602Service() {
        this(new Idea52602Config());
    }

    public Idea52602Service(Idea52602Config config) {
        this.config = config != null ? config : new Idea52602Config();
