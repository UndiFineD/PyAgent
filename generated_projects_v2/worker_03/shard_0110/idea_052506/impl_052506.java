...
@Data
public class Idea52506Config {
    private String name = "idea_052506";
 ...
 */
@Slf4j
public class Idea52506Service {
    private static final int IDEA_ID = 52506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52506Service() {
        this(new Idea52506Config());
    }

    public Idea52506Service(Idea52506Config config) {
        this.config = config != null ? config : new Idea52506Config();
