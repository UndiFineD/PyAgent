...
@Data
public class Idea52407Config {
    private String name = "idea_052407";
 ...
 */
@Slf4j
public class Idea52407Service {
    private static final int IDEA_ID = 52407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52407Service() {
        this(new Idea52407Config());
    }

    public Idea52407Service(Idea52407Config config) {
        this.config = config != null ? config : new Idea52407Config();
