...
@Data
public class Idea52332Config {
    private String name = "idea_052332";
 ...
 */
@Slf4j
public class Idea52332Service {
    private static final int IDEA_ID = 52332;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52332Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52332Service() {
        this(new Idea52332Config());
    }

    public Idea52332Service(Idea52332Config config) {
        this.config = config != null ? config : new Idea52332Config();
