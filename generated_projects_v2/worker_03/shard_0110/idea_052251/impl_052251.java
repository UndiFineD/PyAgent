...
@Data
public class Idea52251Config {
    private String name = "idea_052251";
 ...
 */
@Slf4j
public class Idea52251Service {
    private static final int IDEA_ID = 52251;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52251Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52251Service() {
        this(new Idea52251Config());
    }

    public Idea52251Service(Idea52251Config config) {
        this.config = config != null ? config : new Idea52251Config();
