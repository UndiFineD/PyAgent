...
@Data
public class Idea52510Config {
    private String name = "idea_052510";
 ...
 */
@Slf4j
public class Idea52510Service {
    private static final int IDEA_ID = 52510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52510Service() {
        this(new Idea52510Config());
    }

    public Idea52510Service(Idea52510Config config) {
        this.config = config != null ? config : new Idea52510Config();
