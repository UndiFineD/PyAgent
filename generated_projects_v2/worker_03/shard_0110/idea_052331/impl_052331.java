...
@Data
public class Idea52331Config {
    private String name = "idea_052331";
 ...
 */
@Slf4j
public class Idea52331Service {
    private static final int IDEA_ID = 52331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52331Service() {
        this(new Idea52331Config());
    }

    public Idea52331Service(Idea52331Config config) {
        this.config = config != null ? config : new Idea52331Config();
