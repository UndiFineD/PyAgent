...
@Data
public class Idea52566Config {
    private String name = "idea_052566";
 ...
 */
@Slf4j
public class Idea52566Service {
    private static final int IDEA_ID = 52566;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52566Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52566Service() {
        this(new Idea52566Config());
    }

    public Idea52566Service(Idea52566Config config) {
        this.config = config != null ? config : new Idea52566Config();
