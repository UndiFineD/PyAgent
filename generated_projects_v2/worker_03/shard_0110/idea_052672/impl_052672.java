...
@Data
public class Idea52672Config {
    private String name = "idea_052672";
 ...
 */
@Slf4j
public class Idea52672Service {
    private static final int IDEA_ID = 52672;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52672Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52672Service() {
        this(new Idea52672Config());
    }

    public Idea52672Service(Idea52672Config config) {
        this.config = config != null ? config : new Idea52672Config();
