...
@Data
public class Idea52678Config {
    private String name = "idea_052678";
 ...
 */
@Slf4j
public class Idea52678Service {
    private static final int IDEA_ID = 52678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52678Service() {
        this(new Idea52678Config());
    }

    public Idea52678Service(Idea52678Config config) {
        this.config = config != null ? config : new Idea52678Config();
