...
@Data
public class Idea52633Config {
    private String name = "idea_052633";
 ...
 */
@Slf4j
public class Idea52633Service {
    private static final int IDEA_ID = 52633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52633Service() {
        this(new Idea52633Config());
    }

    public Idea52633Service(Idea52633Config config) {
        this.config = config != null ? config : new Idea52633Config();
