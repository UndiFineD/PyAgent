...
@Data
public class Idea52577Config {
    private String name = "idea_052577";
 ...
 */
@Slf4j
public class Idea52577Service {
    private static final int IDEA_ID = 52577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52577Service() {
        this(new Idea52577Config());
    }

    public Idea52577Service(Idea52577Config config) {
        this.config = config != null ? config : new Idea52577Config();
