...
@Data
public class Idea52591Config {
    private String name = "idea_052591";
 ...
 */
@Slf4j
public class Idea52591Service {
    private static final int IDEA_ID = 52591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52591Service() {
        this(new Idea52591Config());
    }

    public Idea52591Service(Idea52591Config config) {
        this.config = config != null ? config : new Idea52591Config();
