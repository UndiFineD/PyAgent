...
@Data
public class Idea52326Config {
    private String name = "idea_052326";
 ...
 */
@Slf4j
public class Idea52326Service {
    private static final int IDEA_ID = 52326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52326Service() {
        this(new Idea52326Config());
    }

    public Idea52326Service(Idea52326Config config) {
        this.config = config != null ? config : new Idea52326Config();
