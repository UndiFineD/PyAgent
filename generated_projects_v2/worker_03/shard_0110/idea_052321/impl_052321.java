...
@Data
public class Idea52321Config {
    private String name = "idea_052321";
 ...
 */
@Slf4j
public class Idea52321Service {
    private static final int IDEA_ID = 52321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52321Service() {
        this(new Idea52321Config());
    }

    public Idea52321Service(Idea52321Config config) {
        this.config = config != null ? config : new Idea52321Config();
