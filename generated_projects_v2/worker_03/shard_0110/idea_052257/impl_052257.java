...
@Data
public class Idea52257Config {
    private String name = "idea_052257";
 ...
 */
@Slf4j
public class Idea52257Service {
    private static final int IDEA_ID = 52257;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52257Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52257Service() {
        this(new Idea52257Config());
    }

    public Idea52257Service(Idea52257Config config) {
        this.config = config != null ? config : new Idea52257Config();
