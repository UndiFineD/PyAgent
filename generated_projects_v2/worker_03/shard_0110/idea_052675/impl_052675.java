...
@Data
public class Idea52675Config {
    private String name = "idea_052675";
 ...
 */
@Slf4j
public class Idea52675Service {
    private static final int IDEA_ID = 52675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52675Service() {
        this(new Idea52675Config());
    }

    public Idea52675Service(Idea52675Config config) {
        this.config = config != null ? config : new Idea52675Config();
