...
@Data
public class Idea52376Config {
    private String name = "idea_052376";
 ...
 */
@Slf4j
public class Idea52376Service {
    private static final int IDEA_ID = 52376;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52376Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52376Service() {
        this(new Idea52376Config());
    }

    public Idea52376Service(Idea52376Config config) {
        this.config = config != null ? config : new Idea52376Config();
