...
@Data
public class Idea52400Config {
    private String name = "idea_052400";
 ...
 */
@Slf4j
public class Idea52400Service {
    private static final int IDEA_ID = 52400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52400Service() {
        this(new Idea52400Config());
    }

    public Idea52400Service(Idea52400Config config) {
        this.config = config != null ? config : new Idea52400Config();
