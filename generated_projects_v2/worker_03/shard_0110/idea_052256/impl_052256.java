...
@Data
public class Idea52256Config {
    private String name = "idea_052256";
 ...
 */
@Slf4j
public class Idea52256Service {
    private static final int IDEA_ID = 52256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52256Service() {
        this(new Idea52256Config());
    }

    public Idea52256Service(Idea52256Config config) {
        this.config = config != null ? config : new Idea52256Config();
