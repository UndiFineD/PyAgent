...
@Data
public class Idea52460Config {
    private String name = "idea_052460";
 ...
 */
@Slf4j
public class Idea52460Service {
    private static final int IDEA_ID = 52460;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52460Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52460Service() {
        this(new Idea52460Config());
    }

    public Idea52460Service(Idea52460Config config) {
        this.config = config != null ? config : new Idea52460Config();
