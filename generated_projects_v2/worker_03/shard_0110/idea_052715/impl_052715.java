...
@Data
public class Idea52715Config {
    private String name = "idea_052715";
 ...
 */
@Slf4j
public class Idea52715Service {
    private static final int IDEA_ID = 52715;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52715Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52715Service() {
        this(new Idea52715Config());
    }

    public Idea52715Service(Idea52715Config config) {
        this.config = config != null ? config : new Idea52715Config();
