...
@Data
public class Idea52258Config {
    private String name = "idea_052258";
 ...
 */
@Slf4j
public class Idea52258Service {
    private static final int IDEA_ID = 52258;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52258Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52258Service() {
        this(new Idea52258Config());
    }

    public Idea52258Service(Idea52258Config config) {
        this.config = config != null ? config : new Idea52258Config();
