...
@Data
public class Idea52355Config {
    private String name = "idea_052355";
 ...
 */
@Slf4j
public class Idea52355Service {
    private static final int IDEA_ID = 52355;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52355Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52355Service() {
        this(new Idea52355Config());
    }

    public Idea52355Service(Idea52355Config config) {
        this.config = config != null ? config : new Idea52355Config();
