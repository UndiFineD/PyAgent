...
@Data
public class Idea52629Config {
    private String name = "idea_052629";
 ...
 */
@Slf4j
public class Idea52629Service {
    private static final int IDEA_ID = 52629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52629Service() {
        this(new Idea52629Config());
    }

    public Idea52629Service(Idea52629Config config) {
        this.config = config != null ? config : new Idea52629Config();
