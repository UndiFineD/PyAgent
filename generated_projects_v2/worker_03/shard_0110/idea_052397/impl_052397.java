...
@Data
public class Idea52397Config {
    private String name = "idea_052397";
 ...
 */
@Slf4j
public class Idea52397Service {
    private static final int IDEA_ID = 52397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52397Service() {
        this(new Idea52397Config());
    }

    public Idea52397Service(Idea52397Config config) {
        this.config = config != null ? config : new Idea52397Config();
