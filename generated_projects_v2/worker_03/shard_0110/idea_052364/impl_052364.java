...
@Data
public class Idea52364Config {
    private String name = "idea_052364";
 ...
 */
@Slf4j
public class Idea52364Service {
    private static final int IDEA_ID = 52364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52364Service() {
        this(new Idea52364Config());
    }

    public Idea52364Service(Idea52364Config config) {
        this.config = config != null ? config : new Idea52364Config();
