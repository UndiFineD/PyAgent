...
@Data
public class Idea44187Config {
    private String name = "idea_044187";
 ...
 */
@Slf4j
public class Idea44187Service {
    private static final int IDEA_ID = 44187;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44187Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44187Service() {
        this(new Idea44187Config());
    }

    public Idea44187Service(Idea44187Config config) {
        this.config = config != null ? config : new Idea44187Config();
