...
@Data
public class Idea44635Config {
    private String name = "idea_044635";
 ...
 */
@Slf4j
public class Idea44635Service {
    private static final int IDEA_ID = 44635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44635Service() {
        this(new Idea44635Config());
    }

    public Idea44635Service(Idea44635Config config) {
        this.config = config != null ? config : new Idea44635Config();
