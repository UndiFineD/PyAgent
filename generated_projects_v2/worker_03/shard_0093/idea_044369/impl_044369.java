...
@Data
public class Idea44369Config {
    private String name = "idea_044369";
 ...
 */
@Slf4j
public class Idea44369Service {
    private static final int IDEA_ID = 44369;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44369Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44369Service() {
        this(new Idea44369Config());
    }

    public Idea44369Service(Idea44369Config config) {
        this.config = config != null ? config : new Idea44369Config();
