...
@Data
public class Idea44321Config {
    private String name = "idea_044321";
 ...
 */
@Slf4j
public class Idea44321Service {
    private static final int IDEA_ID = 44321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44321Service() {
        this(new Idea44321Config());
    }

    public Idea44321Service(Idea44321Config config) {
        this.config = config != null ? config : new Idea44321Config();
