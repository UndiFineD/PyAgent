...
@Data
public class Idea44291Config {
    private String name = "idea_044291";
 ...
 */
@Slf4j
public class Idea44291Service {
    private static final int IDEA_ID = 44291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44291Service() {
        this(new Idea44291Config());
    }

    public Idea44291Service(Idea44291Config config) {
        this.config = config != null ? config : new Idea44291Config();
