...
@Data
public class Idea44406Config {
    private String name = "idea_044406";
 ...
 */
@Slf4j
public class Idea44406Service {
    private static final int IDEA_ID = 44406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44406Service() {
        this(new Idea44406Config());
    }

    public Idea44406Service(Idea44406Config config) {
        this.config = config != null ? config : new Idea44406Config();
