...
@Data
public class Idea44237Config {
    private String name = "idea_044237";
 ...
 */
@Slf4j
public class Idea44237Service {
    private static final int IDEA_ID = 44237;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44237Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44237Service() {
        this(new Idea44237Config());
    }

    public Idea44237Service(Idea44237Config config) {
        this.config = config != null ? config : new Idea44237Config();
