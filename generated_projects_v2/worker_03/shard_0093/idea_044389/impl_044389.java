...
@Data
public class Idea44389Config {
    private String name = "idea_044389";
 ...
 */
@Slf4j
public class Idea44389Service {
    private static final int IDEA_ID = 44389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44389Service() {
        this(new Idea44389Config());
    }

    public Idea44389Service(Idea44389Config config) {
        this.config = config != null ? config : new Idea44389Config();
