...
@Data
public class Idea44451Config {
    private String name = "idea_044451";
 ...
 */
@Slf4j
public class Idea44451Service {
    private static final int IDEA_ID = 44451;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44451Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44451Service() {
        this(new Idea44451Config());
    }

    public Idea44451Service(Idea44451Config config) {
        this.config = config != null ? config : new Idea44451Config();
