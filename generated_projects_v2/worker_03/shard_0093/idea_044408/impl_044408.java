...
@Data
public class Idea44408Config {
    private String name = "idea_044408";
 ...
 */
@Slf4j
public class Idea44408Service {
    private static final int IDEA_ID = 44408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44408Service() {
        this(new Idea44408Config());
    }

    public Idea44408Service(Idea44408Config config) {
        this.config = config != null ? config : new Idea44408Config();
