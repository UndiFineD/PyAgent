...
@Data
public class Idea44602Config {
    private String name = "idea_044602";
 ...
 */
@Slf4j
public class Idea44602Service {
    private static final int IDEA_ID = 44602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44602Service() {
        this(new Idea44602Config());
    }

    public Idea44602Service(Idea44602Config config) {
        this.config = config != null ? config : new Idea44602Config();
