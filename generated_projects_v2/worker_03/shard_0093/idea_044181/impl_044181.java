...
@Data
public class Idea44181Config {
    private String name = "idea_044181";
 ...
 */
@Slf4j
public class Idea44181Service {
    private static final int IDEA_ID = 44181;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44181Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44181Service() {
        this(new Idea44181Config());
    }

    public Idea44181Service(Idea44181Config config) {
        this.config = config != null ? config : new Idea44181Config();
