...
@Data
public class Idea44384Config {
    private String name = "idea_044384";
 ...
 */
@Slf4j
public class Idea44384Service {
    private static final int IDEA_ID = 44384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44384Service() {
        this(new Idea44384Config());
    }

    public Idea44384Service(Idea44384Config config) {
        this.config = config != null ? config : new Idea44384Config();
