...
@Data
public class Idea44567Config {
    private String name = "idea_044567";
 ...
 */
@Slf4j
public class Idea44567Service {
    private static final int IDEA_ID = 44567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44567Service() {
        this(new Idea44567Config());
    }

    public Idea44567Service(Idea44567Config config) {
        this.config = config != null ? config : new Idea44567Config();
