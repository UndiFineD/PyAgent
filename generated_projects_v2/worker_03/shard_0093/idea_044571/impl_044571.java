...
@Data
public class Idea44571Config {
    private String name = "idea_044571";
 ...
 */
@Slf4j
public class Idea44571Service {
    private static final int IDEA_ID = 44571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44571Service() {
        this(new Idea44571Config());
    }

    public Idea44571Service(Idea44571Config config) {
        this.config = config != null ? config : new Idea44571Config();
