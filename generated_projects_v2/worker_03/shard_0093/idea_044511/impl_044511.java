...
@Data
public class Idea44511Config {
    private String name = "idea_044511";
 ...
 */
@Slf4j
public class Idea44511Service {
    private static final int IDEA_ID = 44511;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44511Service() {
        this(new Idea44511Config());
    }

    public Idea44511Service(Idea44511Config config) {
        this.config = config != null ? config : new Idea44511Config();
