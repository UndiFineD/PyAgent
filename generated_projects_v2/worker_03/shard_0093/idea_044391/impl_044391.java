...
@Data
public class Idea44391Config {
    private String name = "idea_044391";
 ...
 */
@Slf4j
public class Idea44391Service {
    private static final int IDEA_ID = 44391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44391Service() {
        this(new Idea44391Config());
    }

    public Idea44391Service(Idea44391Config config) {
        this.config = config != null ? config : new Idea44391Config();
