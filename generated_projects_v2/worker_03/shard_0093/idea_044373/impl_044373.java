...
@Data
public class Idea44373Config {
    private String name = "idea_044373";
 ...
 */
@Slf4j
public class Idea44373Service {
    private static final int IDEA_ID = 44373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44373Service() {
        this(new Idea44373Config());
    }

    public Idea44373Service(Idea44373Config config) {
        this.config = config != null ? config : new Idea44373Config();
