...
@Data
public class Idea44341Config {
    private String name = "idea_044341";
 ...
 */
@Slf4j
public class Idea44341Service {
    private static final int IDEA_ID = 44341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44341Service() {
        this(new Idea44341Config());
    }

    public Idea44341Service(Idea44341Config config) {
        this.config = config != null ? config : new Idea44341Config();
