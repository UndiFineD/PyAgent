...
@Data
public class Idea44203Config {
    private String name = "idea_044203";
 ...
 */
@Slf4j
public class Idea44203Service {
    private static final int IDEA_ID = 44203;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44203Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44203Service() {
        this(new Idea44203Config());
    }

    public Idea44203Service(Idea44203Config config) {
        this.config = config != null ? config : new Idea44203Config();
