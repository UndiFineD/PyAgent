...
@Data
public class Idea44418Config {
    private String name = "idea_044418";
 ...
 */
@Slf4j
public class Idea44418Service {
    private static final int IDEA_ID = 44418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44418Service() {
        this(new Idea44418Config());
    }

    public Idea44418Service(Idea44418Config config) {
        this.config = config != null ? config : new Idea44418Config();
