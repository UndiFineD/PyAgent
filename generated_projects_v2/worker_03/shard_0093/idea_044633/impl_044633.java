...
@Data
public class Idea44633Config {
    private String name = "idea_044633";
 ...
 */
@Slf4j
public class Idea44633Service {
    private static final int IDEA_ID = 44633;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44633Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44633Service() {
        this(new Idea44633Config());
    }

    public Idea44633Service(Idea44633Config config) {
        this.config = config != null ? config : new Idea44633Config();
