...
@Data
public class Idea44486Config {
    private String name = "idea_044486";
 ...
 */
@Slf4j
public class Idea44486Service {
    private static final int IDEA_ID = 44486;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44486Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44486Service() {
        this(new Idea44486Config());
    }

    public Idea44486Service(Idea44486Config config) {
        this.config = config != null ? config : new Idea44486Config();
