...
@Data
public class Idea44522Config {
    private String name = "idea_044522";
 ...
 */
@Slf4j
public class Idea44522Service {
    private static final int IDEA_ID = 44522;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44522Service() {
        this(new Idea44522Config());
    }

    public Idea44522Service(Idea44522Config config) {
        this.config = config != null ? config : new Idea44522Config();
