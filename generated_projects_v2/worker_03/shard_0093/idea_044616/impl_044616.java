...
@Data
public class Idea44616Config {
    private String name = "idea_044616";
 ...
 */
@Slf4j
public class Idea44616Service {
    private static final int IDEA_ID = 44616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44616Service() {
        this(new Idea44616Config());
    }

    public Idea44616Service(Idea44616Config config) {
        this.config = config != null ? config : new Idea44616Config();
