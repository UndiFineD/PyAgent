...
@Data
public class Idea44201Config {
    private String name = "idea_044201";
 ...
 */
@Slf4j
public class Idea44201Service {
    private static final int IDEA_ID = 44201;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44201Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44201Service() {
        this(new Idea44201Config());
    }

    public Idea44201Service(Idea44201Config config) {
        this.config = config != null ? config : new Idea44201Config();
