...
@Data
public class Idea44525Config {
    private String name = "idea_044525";
 ...
 */
@Slf4j
public class Idea44525Service {
    private static final int IDEA_ID = 44525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44525Service() {
        this(new Idea44525Config());
    }

    public Idea44525Service(Idea44525Config config) {
        this.config = config != null ? config : new Idea44525Config();
