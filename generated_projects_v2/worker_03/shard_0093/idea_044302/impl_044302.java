...
@Data
public class Idea44302Config {
    private String name = "idea_044302";
 ...
 */
@Slf4j
public class Idea44302Service {
    private static final int IDEA_ID = 44302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44302Service() {
        this(new Idea44302Config());
    }

    public Idea44302Service(Idea44302Config config) {
        this.config = config != null ? config : new Idea44302Config();
