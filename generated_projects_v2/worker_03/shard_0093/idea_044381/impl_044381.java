...
@Data
public class Idea44381Config {
    private String name = "idea_044381";
 ...
 */
@Slf4j
public class Idea44381Service {
    private static final int IDEA_ID = 44381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44381Service() {
        this(new Idea44381Config());
    }

    public Idea44381Service(Idea44381Config config) {
        this.config = config != null ? config : new Idea44381Config();
