...
@Data
public class Idea44345Config {
    private String name = "idea_044345";
 ...
 */
@Slf4j
public class Idea44345Service {
    private static final int IDEA_ID = 44345;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44345Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44345Service() {
        this(new Idea44345Config());
    }

    public Idea44345Service(Idea44345Config config) {
        this.config = config != null ? config : new Idea44345Config();
