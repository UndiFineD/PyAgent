...
@Data
public class Idea44561Config {
    private String name = "idea_044561";
 ...
 */
@Slf4j
public class Idea44561Service {
    private static final int IDEA_ID = 44561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44561Service() {
        this(new Idea44561Config());
    }

    public Idea44561Service(Idea44561Config config) {
        this.config = config != null ? config : new Idea44561Config();
