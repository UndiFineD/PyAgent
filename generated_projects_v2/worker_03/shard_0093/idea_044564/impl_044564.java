...
@Data
public class Idea44564Config {
    private String name = "idea_044564";
 ...
 */
@Slf4j
public class Idea44564Service {
    private static final int IDEA_ID = 44564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44564Service() {
        this(new Idea44564Config());
    }

    public Idea44564Service(Idea44564Config config) {
        this.config = config != null ? config : new Idea44564Config();
