...
@Data
public class Idea44641Config {
    private String name = "idea_044641";
 ...
 */
@Slf4j
public class Idea44641Service {
    private static final int IDEA_ID = 44641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44641Service() {
        this(new Idea44641Config());
    }

    public Idea44641Service(Idea44641Config config) {
        this.config = config != null ? config : new Idea44641Config();
