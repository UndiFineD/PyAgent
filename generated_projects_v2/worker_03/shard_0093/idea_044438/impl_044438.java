...
@Data
public class Idea44438Config {
    private String name = "idea_044438";
 ...
 */
@Slf4j
public class Idea44438Service {
    private static final int IDEA_ID = 44438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44438Service() {
        this(new Idea44438Config());
    }

    public Idea44438Service(Idea44438Config config) {
        this.config = config != null ? config : new Idea44438Config();
