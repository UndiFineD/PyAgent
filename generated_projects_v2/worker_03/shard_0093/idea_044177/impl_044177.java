...
@Data
public class Idea44177Config {
    private String name = "idea_044177";
 ...
 */
@Slf4j
public class Idea44177Service {
    private static final int IDEA_ID = 44177;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44177Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44177Service() {
        this(new Idea44177Config());
    }

    public Idea44177Service(Idea44177Config config) {
        this.config = config != null ? config : new Idea44177Config();
