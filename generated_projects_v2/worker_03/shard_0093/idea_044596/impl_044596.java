...
@Data
public class Idea44596Config {
    private String name = "idea_044596";
 ...
 */
@Slf4j
public class Idea44596Service {
    private static final int IDEA_ID = 44596;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44596Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44596Service() {
        this(new Idea44596Config());
    }

    public Idea44596Service(Idea44596Config config) {
        this.config = config != null ? config : new Idea44596Config();
