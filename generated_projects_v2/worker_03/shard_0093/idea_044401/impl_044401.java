...
@Data
public class Idea44401Config {
    private String name = "idea_044401";
 ...
 */
@Slf4j
public class Idea44401Service {
    private static final int IDEA_ID = 44401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44401Service() {
        this(new Idea44401Config());
    }

    public Idea44401Service(Idea44401Config config) {
        this.config = config != null ? config : new Idea44401Config();
