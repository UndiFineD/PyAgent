...
@Data
public class Idea44327Config {
    private String name = "idea_044327";
 ...
 */
@Slf4j
public class Idea44327Service {
    private static final int IDEA_ID = 44327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44327Service() {
        this(new Idea44327Config());
    }

    public Idea44327Service(Idea44327Config config) {
        this.config = config != null ? config : new Idea44327Config();
