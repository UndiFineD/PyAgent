...
@Data
public class Idea44394Config {
    private String name = "idea_044394";
 ...
 */
@Slf4j
public class Idea44394Service {
    private static final int IDEA_ID = 44394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44394Service() {
        this(new Idea44394Config());
    }

    public Idea44394Service(Idea44394Config config) {
        this.config = config != null ? config : new Idea44394Config();
