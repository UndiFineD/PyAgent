...
@Data
public class Idea44610Config {
    private String name = "idea_044610";
 ...
 */
@Slf4j
public class Idea44610Service {
    private static final int IDEA_ID = 44610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44610Service() {
        this(new Idea44610Config());
    }

    public Idea44610Service(Idea44610Config config) {
        this.config = config != null ? config : new Idea44610Config();
