...
@Data
public class Idea44404Config {
    private String name = "idea_044404";
 ...
 */
@Slf4j
public class Idea44404Service {
    private static final int IDEA_ID = 44404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44404Service() {
        this(new Idea44404Config());
    }

    public Idea44404Service(Idea44404Config config) {
        this.config = config != null ? config : new Idea44404Config();
