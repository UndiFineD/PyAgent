...
@Data
public class Idea44334Config {
    private String name = "idea_044334";
 ...
 */
@Slf4j
public class Idea44334Service {
    private static final int IDEA_ID = 44334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44334Service() {
        this(new Idea44334Config());
    }

    public Idea44334Service(Idea44334Config config) {
        this.config = config != null ? config : new Idea44334Config();
