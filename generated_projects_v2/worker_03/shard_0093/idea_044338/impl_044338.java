...
@Data
public class Idea44338Config {
    private String name = "idea_044338";
 ...
 */
@Slf4j
public class Idea44338Service {
    private static final int IDEA_ID = 44338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44338Service() {
        this(new Idea44338Config());
    }

    public Idea44338Service(Idea44338Config config) {
        this.config = config != null ? config : new Idea44338Config();
