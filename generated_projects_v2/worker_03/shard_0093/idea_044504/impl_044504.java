...
@Data
public class Idea44504Config {
    private String name = "idea_044504";
 ...
 */
@Slf4j
public class Idea44504Service {
    private static final int IDEA_ID = 44504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44504Service() {
        this(new Idea44504Config());
    }

    public Idea44504Service(Idea44504Config config) {
        this.config = config != null ? config : new Idea44504Config();
