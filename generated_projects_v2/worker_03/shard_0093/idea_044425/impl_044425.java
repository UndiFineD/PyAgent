...
@Data
public class Idea44425Config {
    private String name = "idea_044425";
 ...
 */
@Slf4j
public class Idea44425Service {
    private static final int IDEA_ID = 44425;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44425Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44425Service() {
        this(new Idea44425Config());
    }

    public Idea44425Service(Idea44425Config config) {
        this.config = config != null ? config : new Idea44425Config();
