...
@Data
public class Idea44405Config {
    private String name = "idea_044405";
 ...
 */
@Slf4j
public class Idea44405Service {
    private static final int IDEA_ID = 44405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44405Service() {
        this(new Idea44405Config());
    }

    public Idea44405Service(Idea44405Config config) {
        this.config = config != null ? config : new Idea44405Config();
