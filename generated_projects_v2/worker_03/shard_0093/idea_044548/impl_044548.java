...
@Data
public class Idea44548Config {
    private String name = "idea_044548";
 ...
 */
@Slf4j
public class Idea44548Service {
    private static final int IDEA_ID = 44548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44548Service() {
        this(new Idea44548Config());
    }

    public Idea44548Service(Idea44548Config config) {
        this.config = config != null ? config : new Idea44548Config();
