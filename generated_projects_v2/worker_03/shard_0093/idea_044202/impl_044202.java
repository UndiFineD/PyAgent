...
@Data
public class Idea44202Config {
    private String name = "idea_044202";
 ...
 */
@Slf4j
public class Idea44202Service {
    private static final int IDEA_ID = 44202;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44202Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44202Service() {
        this(new Idea44202Config());
    }

    public Idea44202Service(Idea44202Config config) {
        this.config = config != null ? config : new Idea44202Config();
