...
@Data
public class Idea44420Config {
    private String name = "idea_044420";
 ...
 */
@Slf4j
public class Idea44420Service {
    private static final int IDEA_ID = 44420;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44420Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44420Service() {
        this(new Idea44420Config());
    }

    public Idea44420Service(Idea44420Config config) {
        this.config = config != null ? config : new Idea44420Config();
