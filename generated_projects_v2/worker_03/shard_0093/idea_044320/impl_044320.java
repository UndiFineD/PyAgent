...
@Data
public class Idea44320Config {
    private String name = "idea_044320";
 ...
 */
@Slf4j
public class Idea44320Service {
    private static final int IDEA_ID = 44320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44320Service() {
        this(new Idea44320Config());
    }

    public Idea44320Service(Idea44320Config config) {
        this.config = config != null ? config : new Idea44320Config();
