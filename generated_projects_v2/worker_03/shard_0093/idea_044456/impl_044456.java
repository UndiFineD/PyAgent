...
@Data
public class Idea44456Config {
    private String name = "idea_044456";
 ...
 */
@Slf4j
public class Idea44456Service {
    private static final int IDEA_ID = 44456;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44456Service() {
        this(new Idea44456Config());
    }

    public Idea44456Service(Idea44456Config config) {
        this.config = config != null ? config : new Idea44456Config();
