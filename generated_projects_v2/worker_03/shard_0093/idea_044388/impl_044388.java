...
@Data
public class Idea44388Config {
    private String name = "idea_044388";
 ...
 */
@Slf4j
public class Idea44388Service {
    private static final int IDEA_ID = 44388;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44388Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44388Service() {
        this(new Idea44388Config());
    }

    public Idea44388Service(Idea44388Config config) {
        this.config = config != null ? config : new Idea44388Config();
