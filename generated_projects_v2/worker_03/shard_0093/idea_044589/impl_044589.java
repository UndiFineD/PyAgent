...
@Data
public class Idea44589Config {
    private String name = "idea_044589";
 ...
 */
@Slf4j
public class Idea44589Service {
    private static final int IDEA_ID = 44589;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44589Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44589Service() {
        this(new Idea44589Config());
    }

    public Idea44589Service(Idea44589Config config) {
        this.config = config != null ? config : new Idea44589Config();
