...
@Data
public class Idea44424Config {
    private String name = "idea_044424";
 ...
 */
@Slf4j
public class Idea44424Service {
    private static final int IDEA_ID = 44424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44424Service() {
        this(new Idea44424Config());
    }

    public Idea44424Service(Idea44424Config config) {
        this.config = config != null ? config : new Idea44424Config();
