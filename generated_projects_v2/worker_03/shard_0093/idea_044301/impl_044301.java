...
@Data
public class Idea44301Config {
    private String name = "idea_044301";
 ...
 */
@Slf4j
public class Idea44301Service {
    private static final int IDEA_ID = 44301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44301Service() {
        this(new Idea44301Config());
    }

    public Idea44301Service(Idea44301Config config) {
        this.config = config != null ? config : new Idea44301Config();
