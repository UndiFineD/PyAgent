...
@Data
public class Idea44595Config {
    private String name = "idea_044595";
 ...
 */
@Slf4j
public class Idea44595Service {
    private static final int IDEA_ID = 44595;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44595Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44595Service() {
        this(new Idea44595Config());
    }

    public Idea44595Service(Idea44595Config config) {
        this.config = config != null ? config : new Idea44595Config();
