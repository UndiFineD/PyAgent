...
@Data
public class Idea44249Config {
    private String name = "idea_044249";
 ...
 */
@Slf4j
public class Idea44249Service {
    private static final int IDEA_ID = 44249;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44249Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44249Service() {
        this(new Idea44249Config());
    }

    public Idea44249Service(Idea44249Config config) {
        this.config = config != null ? config : new Idea44249Config();
