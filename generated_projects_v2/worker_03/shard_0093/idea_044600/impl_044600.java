...
@Data
public class Idea44600Config {
    private String name = "idea_044600";
 ...
 */
@Slf4j
public class Idea44600Service {
    private static final int IDEA_ID = 44600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44600Service() {
        this(new Idea44600Config());
    }

    public Idea44600Service(Idea44600Config config) {
        this.config = config != null ? config : new Idea44600Config();
