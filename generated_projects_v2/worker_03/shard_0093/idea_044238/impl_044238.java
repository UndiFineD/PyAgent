...
@Data
public class Idea44238Config {
    private String name = "idea_044238";
 ...
 */
@Slf4j
public class Idea44238Service {
    private static final int IDEA_ID = 44238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44238Service() {
        this(new Idea44238Config());
    }

    public Idea44238Service(Idea44238Config config) {
        this.config = config != null ? config : new Idea44238Config();
