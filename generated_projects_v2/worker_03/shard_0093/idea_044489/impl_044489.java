...
@Data
public class Idea44489Config {
    private String name = "idea_044489";
 ...
 */
@Slf4j
public class Idea44489Service {
    private static final int IDEA_ID = 44489;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44489Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44489Service() {
        this(new Idea44489Config());
    }

    public Idea44489Service(Idea44489Config config) {
        this.config = config != null ? config : new Idea44489Config();
