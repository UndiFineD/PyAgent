...
@Data
public class Idea44382Config {
    private String name = "idea_044382";
 ...
 */
@Slf4j
public class Idea44382Service {
    private static final int IDEA_ID = 44382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44382Service() {
        this(new Idea44382Config());
    }

    public Idea44382Service(Idea44382Config config) {
        this.config = config != null ? config : new Idea44382Config();
