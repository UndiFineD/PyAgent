...
@Data
public class Idea44287Config {
    private String name = "idea_044287";
 ...
 */
@Slf4j
public class Idea44287Service {
    private static final int IDEA_ID = 44287;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44287Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44287Service() {
        this(new Idea44287Config());
    }

    public Idea44287Service(Idea44287Config config) {
        this.config = config != null ? config : new Idea44287Config();
