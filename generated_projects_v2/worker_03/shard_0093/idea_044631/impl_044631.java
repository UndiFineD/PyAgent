...
@Data
public class Idea44631Config {
    private String name = "idea_044631";
 ...
 */
@Slf4j
public class Idea44631Service {
    private static final int IDEA_ID = 44631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44631Service() {
        this(new Idea44631Config());
    }

    public Idea44631Service(Idea44631Config config) {
        this.config = config != null ? config : new Idea44631Config();
