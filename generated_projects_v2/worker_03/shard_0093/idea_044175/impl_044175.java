...
@Data
public class Idea44175Config {
    private String name = "idea_044175";
 ...
 */
@Slf4j
public class Idea44175Service {
    private static final int IDEA_ID = 44175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44175Service() {
        this(new Idea44175Config());
    }

    public Idea44175Service(Idea44175Config config) {
        this.config = config != null ? config : new Idea44175Config();
