...
@Data
public class Idea44311Config {
    private String name = "idea_044311";
 ...
 */
@Slf4j
public class Idea44311Service {
    private static final int IDEA_ID = 44311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44311Service() {
        this(new Idea44311Config());
    }

    public Idea44311Service(Idea44311Config config) {
        this.config = config != null ? config : new Idea44311Config();
