...
@Data
public class Idea44333Config {
    private String name = "idea_044333";
 ...
 */
@Slf4j
public class Idea44333Service {
    private static final int IDEA_ID = 44333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44333Service() {
        this(new Idea44333Config());
    }

    public Idea44333Service(Idea44333Config config) {
        this.config = config != null ? config : new Idea44333Config();
