...
@Data
public class Idea44205Config {
    private String name = "idea_044205";
 ...
 */
@Slf4j
public class Idea44205Service {
    private static final int IDEA_ID = 44205;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44205Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44205Service() {
        this(new Idea44205Config());
    }

    public Idea44205Service(Idea44205Config config) {
        this.config = config != null ? config : new Idea44205Config();
