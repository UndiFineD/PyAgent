...
@Data
public class Idea44423Config {
    private String name = "idea_044423";
 ...
 */
@Slf4j
public class Idea44423Service {
    private static final int IDEA_ID = 44423;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44423Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44423Service() {
        this(new Idea44423Config());
    }

    public Idea44423Service(Idea44423Config config) {
        this.config = config != null ? config : new Idea44423Config();
