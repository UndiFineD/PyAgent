...
@Data
public class Idea44645Config {
    private String name = "idea_044645";
 ...
 */
@Slf4j
public class Idea44645Service {
    private static final int IDEA_ID = 44645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44645Service() {
        this(new Idea44645Config());
    }

    public Idea44645Service(Idea44645Config config) {
        this.config = config != null ? config : new Idea44645Config();
