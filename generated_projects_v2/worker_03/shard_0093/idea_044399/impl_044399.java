...
@Data
public class Idea44399Config {
    private String name = "idea_044399";
 ...
 */
@Slf4j
public class Idea44399Service {
    private static final int IDEA_ID = 44399;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44399Service() {
        this(new Idea44399Config());
    }

    public Idea44399Service(Idea44399Config config) {
        this.config = config != null ? config : new Idea44399Config();
