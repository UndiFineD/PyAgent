...
@Data
public class Idea44198Config {
    private String name = "idea_044198";
 ...
 */
@Slf4j
public class Idea44198Service {
    private static final int IDEA_ID = 44198;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44198Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44198Service() {
        this(new Idea44198Config());
    }

    public Idea44198Service(Idea44198Config config) {
        this.config = config != null ? config : new Idea44198Config();
