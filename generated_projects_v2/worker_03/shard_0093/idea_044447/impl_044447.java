...
@Data
public class Idea44447Config {
    private String name = "idea_044447";
 ...
 */
@Slf4j
public class Idea44447Service {
    private static final int IDEA_ID = 44447;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44447Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44447Service() {
        this(new Idea44447Config());
    }

    public Idea44447Service(Idea44447Config config) {
        this.config = config != null ? config : new Idea44447Config();
