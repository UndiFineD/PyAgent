...
@Data
public class Idea44573Config {
    private String name = "idea_044573";
 ...
 */
@Slf4j
public class Idea44573Service {
    private static final int IDEA_ID = 44573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44573Service() {
        this(new Idea44573Config());
    }

    public Idea44573Service(Idea44573Config config) {
        this.config = config != null ? config : new Idea44573Config();
