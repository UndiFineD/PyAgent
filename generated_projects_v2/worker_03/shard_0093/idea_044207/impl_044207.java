...
@Data
public class Idea44207Config {
    private String name = "idea_044207";
 ...
 */
@Slf4j
public class Idea44207Service {
    private static final int IDEA_ID = 44207;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44207Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44207Service() {
        this(new Idea44207Config());
    }

    public Idea44207Service(Idea44207Config config) {
        this.config = config != null ? config : new Idea44207Config();
