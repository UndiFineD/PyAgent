...
@Data
public class Idea44612Config {
    private String name = "idea_044612";
 ...
 */
@Slf4j
public class Idea44612Service {
    private static final int IDEA_ID = 44612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44612Service() {
        this(new Idea44612Config());
    }

    public Idea44612Service(Idea44612Config config) {
        this.config = config != null ? config : new Idea44612Config();
