...
@Data
public class Idea44436Config {
    private String name = "idea_044436";
 ...
 */
@Slf4j
public class Idea44436Service {
    private static final int IDEA_ID = 44436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44436Service() {
        this(new Idea44436Config());
    }

    public Idea44436Service(Idea44436Config config) {
        this.config = config != null ? config : new Idea44436Config();
