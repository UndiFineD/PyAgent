...
@Data
public class Idea44300Config {
    private String name = "idea_044300";
 ...
 */
@Slf4j
public class Idea44300Service {
    private static final int IDEA_ID = 44300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44300Service() {
        this(new Idea44300Config());
    }

    public Idea44300Service(Idea44300Config config) {
        this.config = config != null ? config : new Idea44300Config();
