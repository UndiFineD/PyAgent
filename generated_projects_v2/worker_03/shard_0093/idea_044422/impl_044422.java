...
@Data
public class Idea44422Config {
    private String name = "idea_044422";
 ...
 */
@Slf4j
public class Idea44422Service {
    private static final int IDEA_ID = 44422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44422Service() {
        this(new Idea44422Config());
    }

    public Idea44422Service(Idea44422Config config) {
        this.config = config != null ? config : new Idea44422Config();
