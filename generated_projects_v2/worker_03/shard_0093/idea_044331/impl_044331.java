...
@Data
public class Idea44331Config {
    private String name = "idea_044331";
 ...
 */
@Slf4j
public class Idea44331Service {
    private static final int IDEA_ID = 44331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44331Service() {
        this(new Idea44331Config());
    }

    public Idea44331Service(Idea44331Config config) {
        this.config = config != null ? config : new Idea44331Config();
