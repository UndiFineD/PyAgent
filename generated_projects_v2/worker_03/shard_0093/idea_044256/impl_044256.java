...
@Data
public class Idea44256Config {
    private String name = "idea_044256";
 ...
 */
@Slf4j
public class Idea44256Service {
    private static final int IDEA_ID = 44256;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44256Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44256Service() {
        this(new Idea44256Config());
    }

    public Idea44256Service(Idea44256Config config) {
        this.config = config != null ? config : new Idea44256Config();
