...
@Data
public class Idea44200Config {
    private String name = "idea_044200";
 ...
 */
@Slf4j
public class Idea44200Service {
    private static final int IDEA_ID = 44200;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44200Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44200Service() {
        this(new Idea44200Config());
    }

    public Idea44200Service(Idea44200Config config) {
        this.config = config != null ? config : new Idea44200Config();
