...
@Data
public class Idea44387Config {
    private String name = "idea_044387";
 ...
 */
@Slf4j
public class Idea44387Service {
    private static final int IDEA_ID = 44387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44387Service() {
        this(new Idea44387Config());
    }

    public Idea44387Service(Idea44387Config config) {
        this.config = config != null ? config : new Idea44387Config();
