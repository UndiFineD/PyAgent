...
@Data
public class Idea44427Config {
    private String name = "idea_044427";
 ...
 */
@Slf4j
public class Idea44427Service {
    private static final int IDEA_ID = 44427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44427Service() {
        this(new Idea44427Config());
    }

    public Idea44427Service(Idea44427Config config) {
        this.config = config != null ? config : new Idea44427Config();
