...
@Data
public class Idea44643Config {
    private String name = "idea_044643";
 ...
 */
@Slf4j
public class Idea44643Service {
    private static final int IDEA_ID = 44643;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44643Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44643Service() {
        this(new Idea44643Config());
    }

    public Idea44643Service(Idea44643Config config) {
        this.config = config != null ? config : new Idea44643Config();
