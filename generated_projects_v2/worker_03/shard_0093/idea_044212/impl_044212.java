...
@Data
public class Idea44212Config {
    private String name = "idea_044212";
 ...
 */
@Slf4j
public class Idea44212Service {
    private static final int IDEA_ID = 44212;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44212Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44212Service() {
        this(new Idea44212Config());
    }

    public Idea44212Service(Idea44212Config config) {
        this.config = config != null ? config : new Idea44212Config();
