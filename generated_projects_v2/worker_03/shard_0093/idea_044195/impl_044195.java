...
@Data
public class Idea44195Config {
    private String name = "idea_044195";
 ...
 */
@Slf4j
public class Idea44195Service {
    private static final int IDEA_ID = 44195;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44195Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44195Service() {
        this(new Idea44195Config());
    }

    public Idea44195Service(Idea44195Config config) {
        this.config = config != null ? config : new Idea44195Config();
