...
@Data
public class Idea44217Config {
    private String name = "idea_044217";
 ...
 */
@Slf4j
public class Idea44217Service {
    private static final int IDEA_ID = 44217;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44217Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44217Service() {
        this(new Idea44217Config());
    }

    public Idea44217Service(Idea44217Config config) {
        this.config = config != null ? config : new Idea44217Config();
