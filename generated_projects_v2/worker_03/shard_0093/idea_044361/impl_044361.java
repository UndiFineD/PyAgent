...
@Data
public class Idea44361Config {
    private String name = "idea_044361";
 ...
 */
@Slf4j
public class Idea44361Service {
    private static final int IDEA_ID = 44361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44361Service() {
        this(new Idea44361Config());
    }

    public Idea44361Service(Idea44361Config config) {
        this.config = config != null ? config : new Idea44361Config();
