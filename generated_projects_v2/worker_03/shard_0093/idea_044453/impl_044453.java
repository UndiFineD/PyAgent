...
@Data
public class Idea44453Config {
    private String name = "idea_044453";
 ...
 */
@Slf4j
public class Idea44453Service {
    private static final int IDEA_ID = 44453;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44453Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44453Service() {
        this(new Idea44453Config());
    }

    public Idea44453Service(Idea44453Config config) {
        this.config = config != null ? config : new Idea44453Config();
