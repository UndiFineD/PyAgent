...
@Data
public class Idea44636Config {
    private String name = "idea_044636";
 ...
 */
@Slf4j
public class Idea44636Service {
    private static final int IDEA_ID = 44636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44636Service() {
        this(new Idea44636Config());
    }

    public Idea44636Service(Idea44636Config config) {
        this.config = config != null ? config : new Idea44636Config();
