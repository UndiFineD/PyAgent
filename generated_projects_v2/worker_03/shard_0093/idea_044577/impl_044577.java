...
@Data
public class Idea44577Config {
    private String name = "idea_044577";
 ...
 */
@Slf4j
public class Idea44577Service {
    private static final int IDEA_ID = 44577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44577Service() {
        this(new Idea44577Config());
    }

    public Idea44577Service(Idea44577Config config) {
        this.config = config != null ? config : new Idea44577Config();
