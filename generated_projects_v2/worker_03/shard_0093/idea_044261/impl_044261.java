...
@Data
public class Idea44261Config {
    private String name = "idea_044261";
 ...
 */
@Slf4j
public class Idea44261Service {
    private static final int IDEA_ID = 44261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44261Service() {
        this(new Idea44261Config());
    }

    public Idea44261Service(Idea44261Config config) {
        this.config = config != null ? config : new Idea44261Config();
