...
@Data
public class Idea44390Config {
    private String name = "idea_044390";
 ...
 */
@Slf4j
public class Idea44390Service {
    private static final int IDEA_ID = 44390;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44390Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44390Service() {
        this(new Idea44390Config());
    }

    public Idea44390Service(Idea44390Config config) {
        this.config = config != null ? config : new Idea44390Config();
