...
@Data
public class Idea44228Config {
    private String name = "idea_044228";
 ...
 */
@Slf4j
public class Idea44228Service {
    private static final int IDEA_ID = 44228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44228Service() {
        this(new Idea44228Config());
    }

    public Idea44228Service(Idea44228Config config) {
        this.config = config != null ? config : new Idea44228Config();
