...
@Data
public class Idea44437Config {
    private String name = "idea_044437";
 ...
 */
@Slf4j
public class Idea44437Service {
    private static final int IDEA_ID = 44437;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44437Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44437Service() {
        this(new Idea44437Config());
    }

    public Idea44437Service(Idea44437Config config) {
        this.config = config != null ? config : new Idea44437Config();
