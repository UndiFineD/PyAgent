...
@Data
public class Idea44416Config {
    private String name = "idea_044416";
 ...
 */
@Slf4j
public class Idea44416Service {
    private static final int IDEA_ID = 44416;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44416Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44416Service() {
        this(new Idea44416Config());
    }

    public Idea44416Service(Idea44416Config config) {
        this.config = config != null ? config : new Idea44416Config();
