...
@Data
public class Idea44478Config {
    private String name = "idea_044478";
 ...
 */
@Slf4j
public class Idea44478Service {
    private static final int IDEA_ID = 44478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44478Service() {
        this(new Idea44478Config());
    }

    public Idea44478Service(Idea44478Config config) {
        this.config = config != null ? config : new Idea44478Config();
