...
@Data
public class Idea44419Config {
    private String name = "idea_044419";
 ...
 */
@Slf4j
public class Idea44419Service {
    private static final int IDEA_ID = 44419;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44419Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44419Service() {
        this(new Idea44419Config());
    }

    public Idea44419Service(Idea44419Config config) {
        this.config = config != null ? config : new Idea44419Config();
