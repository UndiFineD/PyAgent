...
@Data
public class Idea44366Config {
    private String name = "idea_044366";
 ...
 */
@Slf4j
public class Idea44366Service {
    private static final int IDEA_ID = 44366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44366Service() {
        this(new Idea44366Config());
    }

    public Idea44366Service(Idea44366Config config) {
        this.config = config != null ? config : new Idea44366Config();
