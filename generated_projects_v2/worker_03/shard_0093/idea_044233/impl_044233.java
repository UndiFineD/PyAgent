...
@Data
public class Idea44233Config {
    private String name = "idea_044233";
 ...
 */
@Slf4j
public class Idea44233Service {
    private static final int IDEA_ID = 44233;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44233Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44233Service() {
        this(new Idea44233Config());
    }

    public Idea44233Service(Idea44233Config config) {
        this.config = config != null ? config : new Idea44233Config();
