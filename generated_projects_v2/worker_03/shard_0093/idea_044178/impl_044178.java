...
@Data
public class Idea44178Config {
    private String name = "idea_044178";
 ...
 */
@Slf4j
public class Idea44178Service {
    private static final int IDEA_ID = 44178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44178Service() {
        this(new Idea44178Config());
    }

    public Idea44178Service(Idea44178Config config) {
        this.config = config != null ? config : new Idea44178Config();
