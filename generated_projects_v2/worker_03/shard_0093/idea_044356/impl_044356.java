...
@Data
public class Idea44356Config {
    private String name = "idea_044356";
 ...
 */
@Slf4j
public class Idea44356Service {
    private static final int IDEA_ID = 44356;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44356Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44356Service() {
        this(new Idea44356Config());
    }

    public Idea44356Service(Idea44356Config config) {
        this.config = config != null ? config : new Idea44356Config();
