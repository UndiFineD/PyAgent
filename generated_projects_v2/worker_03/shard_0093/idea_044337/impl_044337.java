...
@Data
public class Idea44337Config {
    private String name = "idea_044337";
 ...
 */
@Slf4j
public class Idea44337Service {
    private static final int IDEA_ID = 44337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44337Service() {
        this(new Idea44337Config());
    }

    public Idea44337Service(Idea44337Config config) {
        this.config = config != null ? config : new Idea44337Config();
