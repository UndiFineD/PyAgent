...
@Data
public class Idea44640Config {
    private String name = "idea_044640";
 ...
 */
@Slf4j
public class Idea44640Service {
    private static final int IDEA_ID = 44640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44640Service() {
        this(new Idea44640Config());
    }

    public Idea44640Service(Idea44640Config config) {
        this.config = config != null ? config : new Idea44640Config();
