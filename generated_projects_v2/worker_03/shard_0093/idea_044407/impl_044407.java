...
@Data
public class Idea44407Config {
    private String name = "idea_044407";
 ...
 */
@Slf4j
public class Idea44407Service {
    private static final int IDEA_ID = 44407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44407Service() {
        this(new Idea44407Config());
    }

    public Idea44407Service(Idea44407Config config) {
        this.config = config != null ? config : new Idea44407Config();
