...
@Data
public class Idea44371Config {
    private String name = "idea_044371";
 ...
 */
@Slf4j
public class Idea44371Service {
    private static final int IDEA_ID = 44371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44371Service() {
        this(new Idea44371Config());
    }

    public Idea44371Service(Idea44371Config config) {
        this.config = config != null ? config : new Idea44371Config();
