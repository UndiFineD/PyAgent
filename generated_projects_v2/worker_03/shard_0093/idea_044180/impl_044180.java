...
@Data
public class Idea44180Config {
    private String name = "idea_044180";
 ...
 */
@Slf4j
public class Idea44180Service {
    private static final int IDEA_ID = 44180;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44180Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44180Service() {
        this(new Idea44180Config());
    }

    public Idea44180Service(Idea44180Config config) {
        this.config = config != null ? config : new Idea44180Config();
