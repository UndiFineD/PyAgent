...
@Data
public class Idea44316Config {
    private String name = "idea_044316";
 ...
 */
@Slf4j
public class Idea44316Service {
    private static final int IDEA_ID = 44316;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44316Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44316Service() {
        this(new Idea44316Config());
    }

    public Idea44316Service(Idea44316Config config) {
        this.config = config != null ? config : new Idea44316Config();
