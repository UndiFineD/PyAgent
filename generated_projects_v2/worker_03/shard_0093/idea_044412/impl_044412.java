...
@Data
public class Idea44412Config {
    private String name = "idea_044412";
 ...
 */
@Slf4j
public class Idea44412Service {
    private static final int IDEA_ID = 44412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44412Service() {
        this(new Idea44412Config());
    }

    public Idea44412Service(Idea44412Config config) {
        this.config = config != null ? config : new Idea44412Config();
