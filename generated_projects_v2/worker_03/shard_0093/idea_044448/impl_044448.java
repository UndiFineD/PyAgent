...
@Data
public class Idea44448Config {
    private String name = "idea_044448";
 ...
 */
@Slf4j
public class Idea44448Service {
    private static final int IDEA_ID = 44448;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44448Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44448Service() {
        this(new Idea44448Config());
    }

    public Idea44448Service(Idea44448Config config) {
        this.config = config != null ? config : new Idea44448Config();
