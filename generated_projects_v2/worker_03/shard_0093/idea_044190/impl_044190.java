...
@Data
public class Idea44190Config {
    private String name = "idea_044190";
 ...
 */
@Slf4j
public class Idea44190Service {
    private static final int IDEA_ID = 44190;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44190Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44190Service() {
        this(new Idea44190Config());
    }

    public Idea44190Service(Idea44190Config config) {
        this.config = config != null ? config : new Idea44190Config();
