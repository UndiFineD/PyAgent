...
@Data
public class Idea44583Config {
    private String name = "idea_044583";
 ...
 */
@Slf4j
public class Idea44583Service {
    private static final int IDEA_ID = 44583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44583Service() {
        this(new Idea44583Config());
    }

    public Idea44583Service(Idea44583Config config) {
        this.config = config != null ? config : new Idea44583Config();
