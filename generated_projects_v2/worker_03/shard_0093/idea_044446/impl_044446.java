...
@Data
public class Idea44446Config {
    private String name = "idea_044446";
 ...
 */
@Slf4j
public class Idea44446Service {
    private static final int IDEA_ID = 44446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44446Service() {
        this(new Idea44446Config());
    }

    public Idea44446Service(Idea44446Config config) {
        this.config = config != null ? config : new Idea44446Config();
