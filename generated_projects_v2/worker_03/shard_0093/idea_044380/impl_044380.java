...
@Data
public class Idea44380Config {
    private String name = "idea_044380";
 ...
 */
@Slf4j
public class Idea44380Service {
    private static final int IDEA_ID = 44380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44380Service() {
        this(new Idea44380Config());
    }

    public Idea44380Service(Idea44380Config config) {
        this.config = config != null ? config : new Idea44380Config();
