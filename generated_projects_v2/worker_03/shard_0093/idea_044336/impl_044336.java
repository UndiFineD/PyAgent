...
@Data
public class Idea44336Config {
    private String name = "idea_044336";
 ...
 */
@Slf4j
public class Idea44336Service {
    private static final int IDEA_ID = 44336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44336Service() {
        this(new Idea44336Config());
    }

    public Idea44336Service(Idea44336Config config) {
        this.config = config != null ? config : new Idea44336Config();
