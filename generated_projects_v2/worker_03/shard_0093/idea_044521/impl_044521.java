...
@Data
public class Idea44521Config {
    private String name = "idea_044521";
 ...
 */
@Slf4j
public class Idea44521Service {
    private static final int IDEA_ID = 44521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44521Service() {
        this(new Idea44521Config());
    }

    public Idea44521Service(Idea44521Config config) {
        this.config = config != null ? config : new Idea44521Config();
