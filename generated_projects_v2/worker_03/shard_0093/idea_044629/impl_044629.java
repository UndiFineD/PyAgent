...
@Data
public class Idea44629Config {
    private String name = "idea_044629";
 ...
 */
@Slf4j
public class Idea44629Service {
    private static final int IDEA_ID = 44629;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44629Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44629Service() {
        this(new Idea44629Config());
    }

    public Idea44629Service(Idea44629Config config) {
        this.config = config != null ? config : new Idea44629Config();
