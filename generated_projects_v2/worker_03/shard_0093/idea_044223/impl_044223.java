...
@Data
public class Idea44223Config {
    private String name = "idea_044223";
 ...
 */
@Slf4j
public class Idea44223Service {
    private static final int IDEA_ID = 44223;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44223Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44223Service() {
        this(new Idea44223Config());
    }

    public Idea44223Service(Idea44223Config config) {
        this.config = config != null ? config : new Idea44223Config();
