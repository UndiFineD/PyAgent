...
@Data
public class Idea44445Config {
    private String name = "idea_044445";
 ...
 */
@Slf4j
public class Idea44445Service {
    private static final int IDEA_ID = 44445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea44445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea44445Service() {
        this(new Idea44445Config());
    }

    public Idea44445Service(Idea44445Config config) {
        this.config = config != null ? config : new Idea44445Config();
