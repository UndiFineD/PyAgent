...
@Data
public class Idea51404Config {
    private String name = "idea_051404";
 ...
 */
@Slf4j
public class Idea51404Service {
    private static final int IDEA_ID = 51404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51404Service() {
        this(new Idea51404Config());
    }

    public Idea51404Service(Idea51404Config config) {
        this.config = config != null ? config : new Idea51404Config();
