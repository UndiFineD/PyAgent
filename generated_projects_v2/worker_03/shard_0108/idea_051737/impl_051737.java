...
@Data
public class Idea51737Config {
    private String name = "idea_051737";
 ...
 */
@Slf4j
public class Idea51737Service {
    private static final int IDEA_ID = 51737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51737Service() {
        this(new Idea51737Config());
    }

    public Idea51737Service(Idea51737Config config) {
        this.config = config != null ? config : new Idea51737Config();
