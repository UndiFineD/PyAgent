...
@Data
public class Idea51387Config {
    private String name = "idea_051387";
 ...
 */
@Slf4j
public class Idea51387Service {
    private static final int IDEA_ID = 51387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51387Service() {
        this(new Idea51387Config());
    }

    public Idea51387Service(Idea51387Config config) {
        this.config = config != null ? config : new Idea51387Config();
