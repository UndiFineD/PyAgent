...
@Data
public class Idea51450Config {
    private String name = "idea_051450";
 ...
 */
@Slf4j
public class Idea51450Service {
    private static final int IDEA_ID = 51450;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51450Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51450Service() {
        this(new Idea51450Config());
    }

    public Idea51450Service(Idea51450Config config) {
        this.config = config != null ? config : new Idea51450Config();
