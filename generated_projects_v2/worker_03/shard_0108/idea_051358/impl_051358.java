...
@Data
public class Idea51358Config {
    private String name = "idea_051358";
 ...
 */
@Slf4j
public class Idea51358Service {
    private static final int IDEA_ID = 51358;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51358Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51358Service() {
        this(new Idea51358Config());
    }

    public Idea51358Service(Idea51358Config config) {
        this.config = config != null ? config : new Idea51358Config();
