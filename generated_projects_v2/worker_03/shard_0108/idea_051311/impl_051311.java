...
@Data
public class Idea51311Config {
    private String name = "idea_051311";
 ...
 */
@Slf4j
public class Idea51311Service {
    private static final int IDEA_ID = 51311;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51311Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51311Service() {
        this(new Idea51311Config());
    }

    public Idea51311Service(Idea51311Config config) {
        this.config = config != null ? config : new Idea51311Config();
