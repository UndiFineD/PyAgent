...
@Data
public class Idea51433Config {
    private String name = "idea_051433";
 ...
 */
@Slf4j
public class Idea51433Service {
    private static final int IDEA_ID = 51433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51433Service() {
        this(new Idea51433Config());
    }

    public Idea51433Service(Idea51433Config config) {
        this.config = config != null ? config : new Idea51433Config();
