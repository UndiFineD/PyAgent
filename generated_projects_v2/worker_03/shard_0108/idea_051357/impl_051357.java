...
@Data
public class Idea51357Config {
    private String name = "idea_051357";
 ...
 */
@Slf4j
public class Idea51357Service {
    private static final int IDEA_ID = 51357;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51357Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51357Service() {
        this(new Idea51357Config());
    }

    public Idea51357Service(Idea51357Config config) {
        this.config = config != null ? config : new Idea51357Config();
