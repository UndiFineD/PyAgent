...
@Data
public class Idea51662Config {
    private String name = "idea_051662";
 ...
 */
@Slf4j
public class Idea51662Service {
    private static final int IDEA_ID = 51662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51662Service() {
        this(new Idea51662Config());
    }

    public Idea51662Service(Idea51662Config config) {
        this.config = config != null ? config : new Idea51662Config();
