...
@Data
public class Idea51533Config {
    private String name = "idea_051533";
 ...
 */
@Slf4j
public class Idea51533Service {
    private static final int IDEA_ID = 51533;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51533Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51533Service() {
        this(new Idea51533Config());
    }

    public Idea51533Service(Idea51533Config config) {
        this.config = config != null ? config : new Idea51533Config();
