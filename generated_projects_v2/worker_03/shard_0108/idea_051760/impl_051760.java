...
@Data
public class Idea51760Config {
    private String name = "idea_051760";
 ...
 */
@Slf4j
public class Idea51760Service {
    private static final int IDEA_ID = 51760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51760Service() {
        this(new Idea51760Config());
    }

    public Idea51760Service(Idea51760Config config) {
        this.config = config != null ? config : new Idea51760Config();
