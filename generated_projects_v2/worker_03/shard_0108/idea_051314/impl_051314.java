...
@Data
public class Idea51314Config {
    private String name = "idea_051314";
 ...
 */
@Slf4j
public class Idea51314Service {
    private static final int IDEA_ID = 51314;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51314Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51314Service() {
        this(new Idea51314Config());
    }

    public Idea51314Service(Idea51314Config config) {
        this.config = config != null ? config : new Idea51314Config();
