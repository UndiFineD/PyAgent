...
@Data
public class Idea51585Config {
    private String name = "idea_051585";
 ...
 */
@Slf4j
public class Idea51585Service {
    private static final int IDEA_ID = 51585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51585Service() {
        this(new Idea51585Config());
    }

    public Idea51585Service(Idea51585Config config) {
        this.config = config != null ? config : new Idea51585Config();
