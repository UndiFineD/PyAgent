...
@Data
public class Idea51650Config {
    private String name = "idea_051650";
 ...
 */
@Slf4j
public class Idea51650Service {
    private static final int IDEA_ID = 51650;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51650Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51650Service() {
        this(new Idea51650Config());
    }

    public Idea51650Service(Idea51650Config config) {
        this.config = config != null ? config : new Idea51650Config();
