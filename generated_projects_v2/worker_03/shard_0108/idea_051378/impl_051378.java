...
@Data
public class Idea51378Config {
    private String name = "idea_051378";
 ...
 */
@Slf4j
public class Idea51378Service {
    private static final int IDEA_ID = 51378;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51378Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51378Service() {
        this(new Idea51378Config());
    }

    public Idea51378Service(Idea51378Config config) {
        this.config = config != null ? config : new Idea51378Config();
