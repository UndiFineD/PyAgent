...
@Data
public class Idea51738Config {
    private String name = "idea_051738";
 ...
 */
@Slf4j
public class Idea51738Service {
    private static final int IDEA_ID = 51738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51738Service() {
        this(new Idea51738Config());
    }

    public Idea51738Service(Idea51738Config config) {
        this.config = config != null ? config : new Idea51738Config();
