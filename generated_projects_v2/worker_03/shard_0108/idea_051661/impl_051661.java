...
@Data
public class Idea51661Config {
    private String name = "idea_051661";
 ...
 */
@Slf4j
public class Idea51661Service {
    private static final int IDEA_ID = 51661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51661Service() {
        this(new Idea51661Config());
    }

    public Idea51661Service(Idea51661Config config) {
        this.config = config != null ? config : new Idea51661Config();
