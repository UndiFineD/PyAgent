...
@Data
public class Idea51527Config {
    private String name = "idea_051527";
 ...
 */
@Slf4j
public class Idea51527Service {
    private static final int IDEA_ID = 51527;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51527Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51527Service() {
        this(new Idea51527Config());
    }

    public Idea51527Service(Idea51527Config config) {
        this.config = config != null ? config : new Idea51527Config();
