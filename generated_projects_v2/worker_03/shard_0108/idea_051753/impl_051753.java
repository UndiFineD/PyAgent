...
@Data
public class Idea51753Config {
    private String name = "idea_051753";
 ...
 */
@Slf4j
public class Idea51753Service {
    private static final int IDEA_ID = 51753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51753Service() {
        this(new Idea51753Config());
    }

    public Idea51753Service(Idea51753Config config) {
        this.config = config != null ? config : new Idea51753Config();
