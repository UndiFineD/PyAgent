...
@Data
public class Idea51379Config {
    private String name = "idea_051379";
 ...
 */
@Slf4j
public class Idea51379Service {
    private static final int IDEA_ID = 51379;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51379Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51379Service() {
        this(new Idea51379Config());
    }

    public Idea51379Service(Idea51379Config config) {
        this.config = config != null ? config : new Idea51379Config();
