...
@Data
public class Idea51312Config {
    private String name = "idea_051312";
 ...
 */
@Slf4j
public class Idea51312Service {
    private static final int IDEA_ID = 51312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51312Service() {
        this(new Idea51312Config());
    }

    public Idea51312Service(Idea51312Config config) {
        this.config = config != null ? config : new Idea51312Config();
