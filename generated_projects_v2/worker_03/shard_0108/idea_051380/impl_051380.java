...
@Data
public class Idea51380Config {
    private String name = "idea_051380";
 ...
 */
@Slf4j
public class Idea51380Service {
    private static final int IDEA_ID = 51380;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51380Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51380Service() {
        this(new Idea51380Config());
    }

    public Idea51380Service(Idea51380Config config) {
        this.config = config != null ? config : new Idea51380Config();
