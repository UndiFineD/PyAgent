...
@Data
public class Idea51600Config {
    private String name = "idea_051600";
 ...
 */
@Slf4j
public class Idea51600Service {
    private static final int IDEA_ID = 51600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51600Service() {
        this(new Idea51600Config());
    }

    public Idea51600Service(Idea51600Config config) {
        this.config = config != null ? config : new Idea51600Config();
