...
@Data
public class Idea51653Config {
    private String name = "idea_051653";
 ...
 */
@Slf4j
public class Idea51653Service {
    private static final int IDEA_ID = 51653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51653Service() {
        this(new Idea51653Config());
    }

    public Idea51653Service(Idea51653Config config) {
        this.config = config != null ? config : new Idea51653Config();
