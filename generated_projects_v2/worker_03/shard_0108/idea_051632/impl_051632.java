...
@Data
public class Idea51632Config {
    private String name = "idea_051632";
 ...
 */
@Slf4j
public class Idea51632Service {
    private static final int IDEA_ID = 51632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51632Service() {
        this(new Idea51632Config());
    }

    public Idea51632Service(Idea51632Config config) {
        this.config = config != null ? config : new Idea51632Config();
