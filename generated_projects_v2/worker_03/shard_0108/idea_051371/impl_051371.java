...
@Data
public class Idea51371Config {
    private String name = "idea_051371";
 ...
 */
@Slf4j
public class Idea51371Service {
    private static final int IDEA_ID = 51371;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51371Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51371Service() {
        this(new Idea51371Config());
    }

    public Idea51371Service(Idea51371Config config) {
        this.config = config != null ? config : new Idea51371Config();
