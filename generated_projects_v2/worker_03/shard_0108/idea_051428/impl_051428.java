...
@Data
public class Idea51428Config {
    private String name = "idea_051428";
 ...
 */
@Slf4j
public class Idea51428Service {
    private static final int IDEA_ID = 51428;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51428Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51428Service() {
        this(new Idea51428Config());
    }

    public Idea51428Service(Idea51428Config config) {
        this.config = config != null ? config : new Idea51428Config();
