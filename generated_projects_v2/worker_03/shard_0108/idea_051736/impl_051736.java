...
@Data
public class Idea51736Config {
    private String name = "idea_051736";
 ...
 */
@Slf4j
public class Idea51736Service {
    private static final int IDEA_ID = 51736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51736Service() {
        this(new Idea51736Config());
    }

    public Idea51736Service(Idea51736Config config) {
        this.config = config != null ? config : new Idea51736Config();
