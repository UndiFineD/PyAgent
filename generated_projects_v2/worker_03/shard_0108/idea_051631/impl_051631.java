...
@Data
public class Idea51631Config {
    private String name = "idea_051631";
 ...
 */
@Slf4j
public class Idea51631Service {
    private static final int IDEA_ID = 51631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51631Service() {
        this(new Idea51631Config());
    }

    public Idea51631Service(Idea51631Config config) {
        this.config = config != null ? config : new Idea51631Config();
