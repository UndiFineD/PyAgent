...
@Data
public class Idea51381Config {
    private String name = "idea_051381";
 ...
 */
@Slf4j
public class Idea51381Service {
    private static final int IDEA_ID = 51381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51381Service() {
        this(new Idea51381Config());
    }

    public Idea51381Service(Idea51381Config config) {
        this.config = config != null ? config : new Idea51381Config();
