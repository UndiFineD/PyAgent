...
@Data
public class Idea51707Config {
    private String name = "idea_051707";
 ...
 */
@Slf4j
public class Idea51707Service {
    private static final int IDEA_ID = 51707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51707Service() {
        this(new Idea51707Config());
    }

    public Idea51707Service(Idea51707Config config) {
        this.config = config != null ? config : new Idea51707Config();
