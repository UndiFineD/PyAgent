...
@Data
public class Idea51403Config {
    private String name = "idea_051403";
 ...
 */
@Slf4j
public class Idea51403Service {
    private static final int IDEA_ID = 51403;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51403Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51403Service() {
        this(new Idea51403Config());
    }

    public Idea51403Service(Idea51403Config config) {
        this.config = config != null ? config : new Idea51403Config();
