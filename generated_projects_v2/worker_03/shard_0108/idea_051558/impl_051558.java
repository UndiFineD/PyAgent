...
@Data
public class Idea51558Config {
    private String name = "idea_051558";
 ...
 */
@Slf4j
public class Idea51558Service {
    private static final int IDEA_ID = 51558;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51558Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51558Service() {
        this(new Idea51558Config());
    }

    public Idea51558Service(Idea51558Config config) {
        this.config = config != null ? config : new Idea51558Config();
