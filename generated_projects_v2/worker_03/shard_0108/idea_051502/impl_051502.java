...
@Data
public class Idea51502Config {
    private String name = "idea_051502";
 ...
 */
@Slf4j
public class Idea51502Service {
    private static final int IDEA_ID = 51502;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51502Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51502Service() {
        this(new Idea51502Config());
    }

    public Idea51502Service(Idea51502Config config) {
        this.config = config != null ? config : new Idea51502Config();
