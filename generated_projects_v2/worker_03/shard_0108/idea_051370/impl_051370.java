...
@Data
public class Idea51370Config {
    private String name = "idea_051370";
 ...
 */
@Slf4j
public class Idea51370Service {
    private static final int IDEA_ID = 51370;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51370Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51370Service() {
        this(new Idea51370Config());
    }

    public Idea51370Service(Idea51370Config config) {
        this.config = config != null ? config : new Idea51370Config();
