...
@Data
public class Idea51567Config {
    private String name = "idea_051567";
 ...
 */
@Slf4j
public class Idea51567Service {
    private static final int IDEA_ID = 51567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51567Service() {
        this(new Idea51567Config());
    }

    public Idea51567Service(Idea51567Config config) {
        this.config = config != null ? config : new Idea51567Config();
