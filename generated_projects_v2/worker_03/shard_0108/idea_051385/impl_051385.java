...
@Data
public class Idea51385Config {
    private String name = "idea_051385";
 ...
 */
@Slf4j
public class Idea51385Service {
    private static final int IDEA_ID = 51385;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51385Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51385Service() {
        this(new Idea51385Config());
    }

    public Idea51385Service(Idea51385Config config) {
        this.config = config != null ? config : new Idea51385Config();
