...
@Data
public class Idea51758Config {
    private String name = "idea_051758";
 ...
 */
@Slf4j
public class Idea51758Service {
    private static final int IDEA_ID = 51758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51758Service() {
        this(new Idea51758Config());
    }

    public Idea51758Service(Idea51758Config config) {
        this.config = config != null ? config : new Idea51758Config();
