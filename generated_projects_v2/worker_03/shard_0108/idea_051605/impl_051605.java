...
@Data
public class Idea51605Config {
    private String name = "idea_051605";
 ...
 */
@Slf4j
public class Idea51605Service {
    private static final int IDEA_ID = 51605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51605Service() {
        this(new Idea51605Config());
    }

    public Idea51605Service(Idea51605Config config) {
        this.config = config != null ? config : new Idea51605Config();
