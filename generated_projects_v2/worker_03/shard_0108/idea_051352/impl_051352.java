...
@Data
public class Idea51352Config {
    private String name = "idea_051352";
 ...
 */
@Slf4j
public class Idea51352Service {
    private static final int IDEA_ID = 51352;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51352Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51352Service() {
        this(new Idea51352Config());
    }

    public Idea51352Service(Idea51352Config config) {
        this.config = config != null ? config : new Idea51352Config();
