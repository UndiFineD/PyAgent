...
@Data
public class Idea51647Config {
    private String name = "idea_051647";
 ...
 */
@Slf4j
public class Idea51647Service {
    private static final int IDEA_ID = 51647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51647Service() {
        this(new Idea51647Config());
    }

    public Idea51647Service(Idea51647Config config) {
        this.config = config != null ? config : new Idea51647Config();
