...
@Data
public class Idea51398Config {
    private String name = "idea_051398";
 ...
 */
@Slf4j
public class Idea51398Service {
    private static final int IDEA_ID = 51398;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51398Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51398Service() {
        this(new Idea51398Config());
    }

    public Idea51398Service(Idea51398Config config) {
        this.config = config != null ? config : new Idea51398Config();
