...
@Data
public class Idea51413Config {
    private String name = "idea_051413";
 ...
 */
@Slf4j
public class Idea51413Service {
    private static final int IDEA_ID = 51413;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51413Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51413Service() {
        this(new Idea51413Config());
    }

    public Idea51413Service(Idea51413Config config) {
        this.config = config != null ? config : new Idea51413Config();
