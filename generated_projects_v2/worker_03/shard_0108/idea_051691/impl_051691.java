...
@Data
public class Idea51691Config {
    private String name = "idea_051691";
 ...
 */
@Slf4j
public class Idea51691Service {
    private static final int IDEA_ID = 51691;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51691Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51691Service() {
        this(new Idea51691Config());
    }

    public Idea51691Service(Idea51691Config config) {
        this.config = config != null ? config : new Idea51691Config();
