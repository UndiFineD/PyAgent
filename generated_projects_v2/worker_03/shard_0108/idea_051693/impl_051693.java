...
@Data
public class Idea51693Config {
    private String name = "idea_051693";
 ...
 */
@Slf4j
public class Idea51693Service {
    private static final int IDEA_ID = 51693;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51693Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51693Service() {
        this(new Idea51693Config());
    }

    public Idea51693Service(Idea51693Config config) {
        this.config = config != null ? config : new Idea51693Config();
