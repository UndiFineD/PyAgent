...
@Data
public class Idea51478Config {
    private String name = "idea_051478";
 ...
 */
@Slf4j
public class Idea51478Service {
    private static final int IDEA_ID = 51478;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51478Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51478Service() {
        this(new Idea51478Config());
    }

    public Idea51478Service(Idea51478Config config) {
        this.config = config != null ? config : new Idea51478Config();
