...
@Data
public class Idea51627Config {
    private String name = "idea_051627";
 ...
 */
@Slf4j
public class Idea51627Service {
    private static final int IDEA_ID = 51627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51627Service() {
        this(new Idea51627Config());
    }

    public Idea51627Service(Idea51627Config config) {
        this.config = config != null ? config : new Idea51627Config();
