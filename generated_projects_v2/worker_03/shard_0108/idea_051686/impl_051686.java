...
@Data
public class Idea51686Config {
    private String name = "idea_051686";
 ...
 */
@Slf4j
public class Idea51686Service {
    private static final int IDEA_ID = 51686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51686Service() {
        this(new Idea51686Config());
    }

    public Idea51686Service(Idea51686Config config) {
        this.config = config != null ? config : new Idea51686Config();
