...
@Data
public class Idea51603Config {
    private String name = "idea_051603";
 ...
 */
@Slf4j
public class Idea51603Service {
    private static final int IDEA_ID = 51603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51603Service() {
        this(new Idea51603Config());
    }

    public Idea51603Service(Idea51603Config config) {
        this.config = config != null ? config : new Idea51603Config();
