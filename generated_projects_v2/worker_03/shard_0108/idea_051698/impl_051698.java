...
@Data
public class Idea51698Config {
    private String name = "idea_051698";
 ...
 */
@Slf4j
public class Idea51698Service {
    private static final int IDEA_ID = 51698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51698Service() {
        this(new Idea51698Config());
    }

    public Idea51698Service(Idea51698Config config) {
        this.config = config != null ? config : new Idea51698Config();
