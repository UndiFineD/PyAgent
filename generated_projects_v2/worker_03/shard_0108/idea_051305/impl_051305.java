...
@Data
public class Idea51305Config {
    private String name = "idea_051305";
 ...
 */
@Slf4j
public class Idea51305Service {
    private static final int IDEA_ID = 51305;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51305Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51305Service() {
        this(new Idea51305Config());
    }

    public Idea51305Service(Idea51305Config config) {
        this.config = config != null ? config : new Idea51305Config();
