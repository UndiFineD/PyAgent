...
@Data
public class Idea51755Config {
    private String name = "idea_051755";
 ...
 */
@Slf4j
public class Idea51755Service {
    private static final int IDEA_ID = 51755;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51755Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51755Service() {
        this(new Idea51755Config());
    }

    public Idea51755Service(Idea51755Config config) {
        this.config = config != null ? config : new Idea51755Config();
