...
@Data
public class Idea51518Config {
    private String name = "idea_051518";
 ...
 */
@Slf4j
public class Idea51518Service {
    private static final int IDEA_ID = 51518;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51518Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51518Service() {
        this(new Idea51518Config());
    }

    public Idea51518Service(Idea51518Config config) {
        this.config = config != null ? config : new Idea51518Config();
