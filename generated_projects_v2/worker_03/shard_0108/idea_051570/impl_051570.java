...
@Data
public class Idea51570Config {
    private String name = "idea_051570";
 ...
 */
@Slf4j
public class Idea51570Service {
    private static final int IDEA_ID = 51570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51570Service() {
        this(new Idea51570Config());
    }

    public Idea51570Service(Idea51570Config config) {
        this.config = config != null ? config : new Idea51570Config();
