...
@Data
public class Idea51667Config {
    private String name = "idea_051667";
 ...
 */
@Slf4j
public class Idea51667Service {
    private static final int IDEA_ID = 51667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51667Service() {
        this(new Idea51667Config());
    }

    public Idea51667Service(Idea51667Config config) {
        this.config = config != null ? config : new Idea51667Config();
