...
@Data
public class Idea51601Config {
    private String name = "idea_051601";
 ...
 */
@Slf4j
public class Idea51601Service {
    private static final int IDEA_ID = 51601;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51601Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51601Service() {
        this(new Idea51601Config());
    }

    public Idea51601Service(Idea51601Config config) {
        this.config = config != null ? config : new Idea51601Config();
