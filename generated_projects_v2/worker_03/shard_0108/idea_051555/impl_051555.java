...
@Data
public class Idea51555Config {
    private String name = "idea_051555";
 ...
 */
@Slf4j
public class Idea51555Service {
    private static final int IDEA_ID = 51555;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51555Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51555Service() {
        this(new Idea51555Config());
    }

    public Idea51555Service(Idea51555Config config) {
        this.config = config != null ? config : new Idea51555Config();
