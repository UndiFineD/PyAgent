...
@Data
public class Idea51302Config {
    private String name = "idea_051302";
 ...
 */
@Slf4j
public class Idea51302Service {
    private static final int IDEA_ID = 51302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51302Service() {
        this(new Idea51302Config());
    }

    public Idea51302Service(Idea51302Config config) {
        this.config = config != null ? config : new Idea51302Config();
