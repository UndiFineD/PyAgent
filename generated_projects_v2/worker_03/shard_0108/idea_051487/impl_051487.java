...
@Data
public class Idea51487Config {
    private String name = "idea_051487";
 ...
 */
@Slf4j
public class Idea51487Service {
    private static final int IDEA_ID = 51487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51487Service() {
        this(new Idea51487Config());
    }

    public Idea51487Service(Idea51487Config config) {
        this.config = config != null ? config : new Idea51487Config();
