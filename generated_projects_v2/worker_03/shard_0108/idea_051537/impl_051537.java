...
@Data
public class Idea51537Config {
    private String name = "idea_051537";
 ...
 */
@Slf4j
public class Idea51537Service {
    private static final int IDEA_ID = 51537;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51537Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51537Service() {
        this(new Idea51537Config());
    }

    public Idea51537Service(Idea51537Config config) {
        this.config = config != null ? config : new Idea51537Config();
