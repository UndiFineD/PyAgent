...
@Data
public class Idea51731Config {
    private String name = "idea_051731";
 ...
 */
@Slf4j
public class Idea51731Service {
    private static final int IDEA_ID = 51731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51731Service() {
        this(new Idea51731Config());
    }

    public Idea51731Service(Idea51731Config config) {
        this.config = config != null ? config : new Idea51731Config();
