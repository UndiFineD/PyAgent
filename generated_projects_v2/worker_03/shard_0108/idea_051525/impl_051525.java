...
@Data
public class Idea51525Config {
    private String name = "idea_051525";
 ...
 */
@Slf4j
public class Idea51525Service {
    private static final int IDEA_ID = 51525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51525Service() {
        this(new Idea51525Config());
    }

    public Idea51525Service(Idea51525Config config) {
        this.config = config != null ? config : new Idea51525Config();
