...
@Data
public class Idea51536Config {
    private String name = "idea_051536";
 ...
 */
@Slf4j
public class Idea51536Service {
    private static final int IDEA_ID = 51536;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51536Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51536Service() {
        this(new Idea51536Config());
    }

    public Idea51536Service(Idea51536Config config) {
        this.config = config != null ? config : new Idea51536Config();
