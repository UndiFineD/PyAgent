...
@Data
public class Idea51364Config {
    private String name = "idea_051364";
 ...
 */
@Slf4j
public class Idea51364Service {
    private static final int IDEA_ID = 51364;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51364Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51364Service() {
        this(new Idea51364Config());
    }

    public Idea51364Service(Idea51364Config config) {
        this.config = config != null ? config : new Idea51364Config();
