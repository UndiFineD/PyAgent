...
@Data
public class Idea51697Config {
    private String name = "idea_051697";
 ...
 */
@Slf4j
public class Idea51697Service {
    private static final int IDEA_ID = 51697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51697Service() {
        this(new Idea51697Config());
    }

    public Idea51697Service(Idea51697Config config) {
        this.config = config != null ? config : new Idea51697Config();
