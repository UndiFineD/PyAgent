...
@Data
public class Idea51309Config {
    private String name = "idea_051309";
 ...
 */
@Slf4j
public class Idea51309Service {
    private static final int IDEA_ID = 51309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51309Service() {
        this(new Idea51309Config());
    }

    public Idea51309Service(Idea51309Config config) {
        this.config = config != null ? config : new Idea51309Config();
