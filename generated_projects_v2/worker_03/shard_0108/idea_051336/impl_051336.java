...
@Data
public class Idea51336Config {
    private String name = "idea_051336";
 ...
 */
@Slf4j
public class Idea51336Service {
    private static final int IDEA_ID = 51336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51336Service() {
        this(new Idea51336Config());
    }

    public Idea51336Service(Idea51336Config config) {
        this.config = config != null ? config : new Idea51336Config();
