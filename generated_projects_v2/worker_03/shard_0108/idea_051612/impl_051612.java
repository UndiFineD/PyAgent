...
@Data
public class Idea51612Config {
    private String name = "idea_051612";
 ...
 */
@Slf4j
public class Idea51612Service {
    private static final int IDEA_ID = 51612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51612Service() {
        this(new Idea51612Config());
    }

    public Idea51612Service(Idea51612Config config) {
        this.config = config != null ? config : new Idea51612Config();
