...
@Data
public class Idea51483Config {
    private String name = "idea_051483";
 ...
 */
@Slf4j
public class Idea51483Service {
    private static final int IDEA_ID = 51483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51483Service() {
        this(new Idea51483Config());
    }

    public Idea51483Service(Idea51483Config config) {
        this.config = config != null ? config : new Idea51483Config();
