...
@Data
public class Idea51774Config {
    private String name = "idea_051774";
 ...
 */
@Slf4j
public class Idea51774Service {
    private static final int IDEA_ID = 51774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51774Service() {
        this(new Idea51774Config());
    }

    public Idea51774Service(Idea51774Config config) {
        this.config = config != null ? config : new Idea51774Config();
