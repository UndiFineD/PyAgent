...
@Data
public class Idea51708Config {
    private String name = "idea_051708";
 ...
 */
@Slf4j
public class Idea51708Service {
    private static final int IDEA_ID = 51708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51708Service() {
        this(new Idea51708Config());
    }

    public Idea51708Service(Idea51708Config config) {
        this.config = config != null ? config : new Idea51708Config();
