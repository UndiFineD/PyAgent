...
@Data
public class Idea51362Config {
    private String name = "idea_051362";
 ...
 */
@Slf4j
public class Idea51362Service {
    private static final int IDEA_ID = 51362;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51362Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51362Service() {
        this(new Idea51362Config());
    }

    public Idea51362Service(Idea51362Config config) {
        this.config = config != null ? config : new Idea51362Config();
