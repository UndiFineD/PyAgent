...
@Data
public class Idea51508Config {
    private String name = "idea_051508";
 ...
 */
@Slf4j
public class Idea51508Service {
    private static final int IDEA_ID = 51508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51508Service() {
        this(new Idea51508Config());
    }

    public Idea51508Service(Idea51508Config config) {
        this.config = config != null ? config : new Idea51508Config();
