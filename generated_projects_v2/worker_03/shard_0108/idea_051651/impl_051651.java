...
@Data
public class Idea51651Config {
    private String name = "idea_051651";
 ...
 */
@Slf4j
public class Idea51651Service {
    private static final int IDEA_ID = 51651;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51651Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51651Service() {
        this(new Idea51651Config());
    }

    public Idea51651Service(Idea51651Config config) {
        this.config = config != null ? config : new Idea51651Config();
