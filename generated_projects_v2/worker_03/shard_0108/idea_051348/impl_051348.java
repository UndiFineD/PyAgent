...
@Data
public class Idea51348Config {
    private String name = "idea_051348";
 ...
 */
@Slf4j
public class Idea51348Service {
    private static final int IDEA_ID = 51348;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51348Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51348Service() {
        this(new Idea51348Config());
    }

    public Idea51348Service(Idea51348Config config) {
        this.config = config != null ? config : new Idea51348Config();
