...
@Data
public class Idea51500Config {
    private String name = "idea_051500";
 ...
 */
@Slf4j
public class Idea51500Service {
    private static final int IDEA_ID = 51500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51500Service() {
        this(new Idea51500Config());
    }

    public Idea51500Service(Idea51500Config config) {
        this.config = config != null ? config : new Idea51500Config();
