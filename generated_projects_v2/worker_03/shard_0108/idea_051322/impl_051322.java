...
@Data
public class Idea51322Config {
    private String name = "idea_051322";
 ...
 */
@Slf4j
public class Idea51322Service {
    private static final int IDEA_ID = 51322;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51322Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51322Service() {
        this(new Idea51322Config());
    }

    public Idea51322Service(Idea51322Config config) {
        this.config = config != null ? config : new Idea51322Config();
