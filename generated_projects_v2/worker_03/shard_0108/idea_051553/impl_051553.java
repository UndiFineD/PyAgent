...
@Data
public class Idea51553Config {
    private String name = "idea_051553";
 ...
 */
@Slf4j
public class Idea51553Service {
    private static final int IDEA_ID = 51553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51553Service() {
        this(new Idea51553Config());
    }

    public Idea51553Service(Idea51553Config config) {
        this.config = config != null ? config : new Idea51553Config();
