...
@Data
public class Idea51401Config {
    private String name = "idea_051401";
 ...
 */
@Slf4j
public class Idea51401Service {
    private static final int IDEA_ID = 51401;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51401Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51401Service() {
        this(new Idea51401Config());
    }

    public Idea51401Service(Idea51401Config config) {
        this.config = config != null ? config : new Idea51401Config();
