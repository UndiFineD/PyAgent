...
@Data
public class Idea51443Config {
    private String name = "idea_051443";
 ...
 */
@Slf4j
public class Idea51443Service {
    private static final int IDEA_ID = 51443;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51443Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51443Service() {
        this(new Idea51443Config());
    }

    public Idea51443Service(Idea51443Config config) {
        this.config = config != null ? config : new Idea51443Config();
