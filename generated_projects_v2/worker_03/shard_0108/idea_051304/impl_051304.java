...
@Data
public class Idea51304Config {
    private String name = "idea_051304";
 ...
 */
@Slf4j
public class Idea51304Service {
    private static final int IDEA_ID = 51304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51304Service() {
        this(new Idea51304Config());
    }

    public Idea51304Service(Idea51304Config config) {
        this.config = config != null ? config : new Idea51304Config();
