...
@Data
public class Idea51373Config {
    private String name = "idea_051373";
 ...
 */
@Slf4j
public class Idea51373Service {
    private static final int IDEA_ID = 51373;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51373Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51373Service() {
        this(new Idea51373Config());
    }

    public Idea51373Service(Idea51373Config config) {
        this.config = config != null ? config : new Idea51373Config();
