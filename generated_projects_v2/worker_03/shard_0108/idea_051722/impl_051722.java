...
@Data
public class Idea51722Config {
    private String name = "idea_051722";
 ...
 */
@Slf4j
public class Idea51722Service {
    private static final int IDEA_ID = 51722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51722Service() {
        this(new Idea51722Config());
    }

    public Idea51722Service(Idea51722Config config) {
        this.config = config != null ? config : new Idea51722Config();
