...
@Data
public class Idea51324Config {
    private String name = "idea_051324";
 ...
 */
@Slf4j
public class Idea51324Service {
    private static final int IDEA_ID = 51324;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51324Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51324Service() {
        this(new Idea51324Config());
    }

    public Idea51324Service(Idea51324Config config) {
        this.config = config != null ? config : new Idea51324Config();
