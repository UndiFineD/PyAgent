...
@Data
public class Idea51649Config {
    private String name = "idea_051649";
 ...
 */
@Slf4j
public class Idea51649Service {
    private static final int IDEA_ID = 51649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51649Service() {
        this(new Idea51649Config());
    }

    public Idea51649Service(Idea51649Config config) {
        this.config = config != null ? config : new Idea51649Config();
