...
@Data
public class Idea51622Config {
    private String name = "idea_051622";
 ...
 */
@Slf4j
public class Idea51622Service {
    private static final int IDEA_ID = 51622;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51622Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51622Service() {
        this(new Idea51622Config());
    }

    public Idea51622Service(Idea51622Config config) {
        this.config = config != null ? config : new Idea51622Config();
