...
@Data
public class Idea51577Config {
    private String name = "idea_051577";
 ...
 */
@Slf4j
public class Idea51577Service {
    private static final int IDEA_ID = 51577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51577Service() {
        this(new Idea51577Config());
    }

    public Idea51577Service(Idea51577Config config) {
        this.config = config != null ? config : new Idea51577Config();
