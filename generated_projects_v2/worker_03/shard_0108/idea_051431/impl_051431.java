...
@Data
public class Idea51431Config {
    private String name = "idea_051431";
 ...
 */
@Slf4j
public class Idea51431Service {
    private static final int IDEA_ID = 51431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51431Service() {
        this(new Idea51431Config());
    }

    public Idea51431Service(Idea51431Config config) {
        this.config = config != null ? config : new Idea51431Config();
