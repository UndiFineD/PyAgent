...
@Data
public class Idea51677Config {
    private String name = "idea_051677";
 ...
 */
@Slf4j
public class Idea51677Service {
    private static final int IDEA_ID = 51677;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51677Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51677Service() {
        this(new Idea51677Config());
    }

    public Idea51677Service(Idea51677Config config) {
        this.config = config != null ? config : new Idea51677Config();
