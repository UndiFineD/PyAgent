...
@Data
public class Idea51482Config {
    private String name = "idea_051482";
 ...
 */
@Slf4j
public class Idea51482Service {
    private static final int IDEA_ID = 51482;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51482Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51482Service() {
        this(new Idea51482Config());
    }

    public Idea51482Service(Idea51482Config config) {
        this.config = config != null ? config : new Idea51482Config();
