...
@Data
public class Idea51320Config {
    private String name = "idea_051320";
 ...
 */
@Slf4j
public class Idea51320Service {
    private static final int IDEA_ID = 51320;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51320Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51320Service() {
        this(new Idea51320Config());
    }

    public Idea51320Service(Idea51320Config config) {
        this.config = config != null ? config : new Idea51320Config();
