...
@Data
public class Idea51703Config {
    private String name = "idea_051703";
 ...
 */
@Slf4j
public class Idea51703Service {
    private static final int IDEA_ID = 51703;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51703Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51703Service() {
        this(new Idea51703Config());
    }

    public Idea51703Service(Idea51703Config config) {
        this.config = config != null ? config : new Idea51703Config();
