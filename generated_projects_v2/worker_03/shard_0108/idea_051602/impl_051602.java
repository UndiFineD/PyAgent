...
@Data
public class Idea51602Config {
    private String name = "idea_051602";
 ...
 */
@Slf4j
public class Idea51602Service {
    private static final int IDEA_ID = 51602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51602Service() {
        this(new Idea51602Config());
    }

    public Idea51602Service(Idea51602Config config) {
        this.config = config != null ? config : new Idea51602Config();
