...
@Data
public class Idea51591Config {
    private String name = "idea_051591";
 ...
 */
@Slf4j
public class Idea51591Service {
    private static final int IDEA_ID = 51591;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51591Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51591Service() {
        this(new Idea51591Config());
    }

    public Idea51591Service(Idea51591Config config) {
        this.config = config != null ? config : new Idea51591Config();
