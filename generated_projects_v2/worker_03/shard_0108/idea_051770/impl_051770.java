...
@Data
public class Idea51770Config {
    private String name = "idea_051770";
 ...
 */
@Slf4j
public class Idea51770Service {
    private static final int IDEA_ID = 51770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51770Service() {
        this(new Idea51770Config());
    }

    public Idea51770Service(Idea51770Config config) {
        this.config = config != null ? config : new Idea51770Config();
