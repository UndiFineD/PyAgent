...
@Data
public class Idea51330Config {
    private String name = "idea_051330";
 ...
 */
@Slf4j
public class Idea51330Service {
    private static final int IDEA_ID = 51330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51330Service() {
        this(new Idea51330Config());
    }

    public Idea51330Service(Idea51330Config config) {
        this.config = config != null ? config : new Idea51330Config();
