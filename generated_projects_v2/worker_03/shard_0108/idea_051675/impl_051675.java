...
@Data
public class Idea51675Config {
    private String name = "idea_051675";
 ...
 */
@Slf4j
public class Idea51675Service {
    private static final int IDEA_ID = 51675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51675Service() {
        this(new Idea51675Config());
    }

    public Idea51675Service(Idea51675Config config) {
        this.config = config != null ? config : new Idea51675Config();
