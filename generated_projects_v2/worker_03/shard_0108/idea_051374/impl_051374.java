...
@Data
public class Idea51374Config {
    private String name = "idea_051374";
 ...
 */
@Slf4j
public class Idea51374Service {
    private static final int IDEA_ID = 51374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51374Service() {
        this(new Idea51374Config());
    }

    public Idea51374Service(Idea51374Config config) {
        this.config = config != null ? config : new Idea51374Config();
