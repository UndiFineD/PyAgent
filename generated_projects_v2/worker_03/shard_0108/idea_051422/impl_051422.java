...
@Data
public class Idea51422Config {
    private String name = "idea_051422";
 ...
 */
@Slf4j
public class Idea51422Service {
    private static final int IDEA_ID = 51422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51422Service() {
        this(new Idea51422Config());
    }

    public Idea51422Service(Idea51422Config config) {
        this.config = config != null ? config : new Idea51422Config();
