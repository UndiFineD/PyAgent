...
@Data
public class Idea51718Config {
    private String name = "idea_051718";
 ...
 */
@Slf4j
public class Idea51718Service {
    private static final int IDEA_ID = 51718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51718Service() {
        this(new Idea51718Config());
    }

    public Idea51718Service(Idea51718Config config) {
        this.config = config != null ? config : new Idea51718Config();
