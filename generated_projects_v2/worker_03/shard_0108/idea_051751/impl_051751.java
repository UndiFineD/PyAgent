...
@Data
public class Idea51751Config {
    private String name = "idea_051751";
 ...
 */
@Slf4j
public class Idea51751Service {
    private static final int IDEA_ID = 51751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51751Service() {
        this(new Idea51751Config());
    }

    public Idea51751Service(Idea51751Config config) {
        this.config = config != null ? config : new Idea51751Config();
