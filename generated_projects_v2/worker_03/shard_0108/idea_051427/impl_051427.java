...
@Data
public class Idea51427Config {
    private String name = "idea_051427";
 ...
 */
@Slf4j
public class Idea51427Service {
    private static final int IDEA_ID = 51427;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51427Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51427Service() {
        this(new Idea51427Config());
    }

    public Idea51427Service(Idea51427Config config) {
        this.config = config != null ? config : new Idea51427Config();
