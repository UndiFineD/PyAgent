...
@Data
public class Idea51353Config {
    private String name = "idea_051353";
 ...
 */
@Slf4j
public class Idea51353Service {
    private static final int IDEA_ID = 51353;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51353Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51353Service() {
        this(new Idea51353Config());
    }

    public Idea51353Service(Idea51353Config config) {
        this.config = config != null ? config : new Idea51353Config();
