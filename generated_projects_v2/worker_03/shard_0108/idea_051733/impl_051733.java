...
@Data
public class Idea51733Config {
    private String name = "idea_051733";
 ...
 */
@Slf4j
public class Idea51733Service {
    private static final int IDEA_ID = 51733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51733Service() {
        this(new Idea51733Config());
    }

    public Idea51733Service(Idea51733Config config) {
        this.config = config != null ? config : new Idea51733Config();
