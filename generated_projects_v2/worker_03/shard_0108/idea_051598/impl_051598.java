...
@Data
public class Idea51598Config {
    private String name = "idea_051598";
 ...
 */
@Slf4j
public class Idea51598Service {
    private static final int IDEA_ID = 51598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51598Service() {
        this(new Idea51598Config());
    }

    public Idea51598Service(Idea51598Config config) {
        this.config = config != null ? config : new Idea51598Config();
