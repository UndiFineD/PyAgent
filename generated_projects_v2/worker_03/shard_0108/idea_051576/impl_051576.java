...
@Data
public class Idea51576Config {
    private String name = "idea_051576";
 ...
 */
@Slf4j
public class Idea51576Service {
    private static final int IDEA_ID = 51576;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51576Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51576Service() {
        this(new Idea51576Config());
    }

    public Idea51576Service(Idea51576Config config) {
        this.config = config != null ? config : new Idea51576Config();
