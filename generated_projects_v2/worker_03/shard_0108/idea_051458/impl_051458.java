...
@Data
public class Idea51458Config {
    private String name = "idea_051458";
 ...
 */
@Slf4j
public class Idea51458Service {
    private static final int IDEA_ID = 51458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51458Service() {
        this(new Idea51458Config());
    }

    public Idea51458Service(Idea51458Config config) {
        this.config = config != null ? config : new Idea51458Config();
