...
@Data
public class Idea51503Config {
    private String name = "idea_051503";
 ...
 */
@Slf4j
public class Idea51503Service {
    private static final int IDEA_ID = 51503;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51503Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51503Service() {
        this(new Idea51503Config());
    }

    public Idea51503Service(Idea51503Config config) {
        this.config = config != null ? config : new Idea51503Config();
