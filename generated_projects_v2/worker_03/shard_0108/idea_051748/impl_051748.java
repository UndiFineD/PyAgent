...
@Data
public class Idea51748Config {
    private String name = "idea_051748";
 ...
 */
@Slf4j
public class Idea51748Service {
    private static final int IDEA_ID = 51748;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51748Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51748Service() {
        this(new Idea51748Config());
    }

    public Idea51748Service(Idea51748Config config) {
        this.config = config != null ? config : new Idea51748Config();
