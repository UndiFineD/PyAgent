...
@Data
public class Idea51746Config {
    private String name = "idea_051746";
 ...
 */
@Slf4j
public class Idea51746Service {
    private static final int IDEA_ID = 51746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51746Service() {
        this(new Idea51746Config());
    }

    public Idea51746Service(Idea51746Config config) {
        this.config = config != null ? config : new Idea51746Config();
