...
@Data
public class Idea51467Config {
    private String name = "idea_051467";
 ...
 */
@Slf4j
public class Idea51467Service {
    private static final int IDEA_ID = 51467;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51467Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51467Service() {
        this(new Idea51467Config());
    }

    public Idea51467Service(Idea51467Config config) {
        this.config = config != null ? config : new Idea51467Config();
