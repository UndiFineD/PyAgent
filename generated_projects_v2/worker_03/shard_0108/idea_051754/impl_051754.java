...
@Data
public class Idea51754Config {
    private String name = "idea_051754";
 ...
 */
@Slf4j
public class Idea51754Service {
    private static final int IDEA_ID = 51754;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51754Service() {
        this(new Idea51754Config());
    }

    public Idea51754Service(Idea51754Config config) {
        this.config = config != null ? config : new Idea51754Config();
