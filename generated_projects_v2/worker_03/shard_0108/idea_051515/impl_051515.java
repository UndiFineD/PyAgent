...
@Data
public class Idea51515Config {
    private String name = "idea_051515";
 ...
 */
@Slf4j
public class Idea51515Service {
    private static final int IDEA_ID = 51515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51515Service() {
        this(new Idea51515Config());
    }

    public Idea51515Service(Idea51515Config config) {
        this.config = config != null ? config : new Idea51515Config();
