...
@Data
public class Idea51765Config {
    private String name = "idea_051765";
 ...
 */
@Slf4j
public class Idea51765Service {
    private static final int IDEA_ID = 51765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51765Service() {
        this(new Idea51765Config());
    }

    public Idea51765Service(Idea51765Config config) {
        this.config = config != null ? config : new Idea51765Config();
