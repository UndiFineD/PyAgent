...
@Data
public class Idea51546Config {
    private String name = "idea_051546";
 ...
 */
@Slf4j
public class Idea51546Service {
    private static final int IDEA_ID = 51546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51546Service() {
        this(new Idea51546Config());
    }

    public Idea51546Service(Idea51546Config config) {
        this.config = config != null ? config : new Idea51546Config();
