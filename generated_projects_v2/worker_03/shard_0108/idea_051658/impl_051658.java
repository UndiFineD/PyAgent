...
@Data
public class Idea51658Config {
    private String name = "idea_051658";
 ...
 */
@Slf4j
public class Idea51658Service {
    private static final int IDEA_ID = 51658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51658Service() {
        this(new Idea51658Config());
    }

    public Idea51658Service(Idea51658Config config) {
        this.config = config != null ? config : new Idea51658Config();
