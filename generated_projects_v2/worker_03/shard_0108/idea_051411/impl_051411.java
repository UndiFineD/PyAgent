...
@Data
public class Idea51411Config {
    private String name = "idea_051411";
 ...
 */
@Slf4j
public class Idea51411Service {
    private static final int IDEA_ID = 51411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51411Service() {
        this(new Idea51411Config());
    }

    public Idea51411Service(Idea51411Config config) {
        this.config = config != null ? config : new Idea51411Config();
