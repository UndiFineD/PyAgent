...
@Data
public class Idea51445Config {
    private String name = "idea_051445";
 ...
 */
@Slf4j
public class Idea51445Service {
    private static final int IDEA_ID = 51445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51445Service() {
        this(new Idea51445Config());
    }

    public Idea51445Service(Idea51445Config config) {
        this.config = config != null ? config : new Idea51445Config();
