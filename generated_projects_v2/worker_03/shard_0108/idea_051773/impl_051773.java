...
@Data
public class Idea51773Config {
    private String name = "idea_051773";
 ...
 */
@Slf4j
public class Idea51773Service {
    private static final int IDEA_ID = 51773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51773Service() {
        this(new Idea51773Config());
    }

    public Idea51773Service(Idea51773Config config) {
        this.config = config != null ? config : new Idea51773Config();
