...
@Data
public class Idea51610Config {
    private String name = "idea_051610";
 ...
 */
@Slf4j
public class Idea51610Service {
    private static final int IDEA_ID = 51610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51610Service() {
        this(new Idea51610Config());
    }

    public Idea51610Service(Idea51610Config config) {
        this.config = config != null ? config : new Idea51610Config();
