...
@Data
public class Idea51670Config {
    private String name = "idea_051670";
 ...
 */
@Slf4j
public class Idea51670Service {
    private static final int IDEA_ID = 51670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51670Service() {
        this(new Idea51670Config());
    }

    public Idea51670Service(Idea51670Config config) {
        this.config = config != null ? config : new Idea51670Config();
