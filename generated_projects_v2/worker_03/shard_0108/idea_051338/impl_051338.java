...
@Data
public class Idea51338Config {
    private String name = "idea_051338";
 ...
 */
@Slf4j
public class Idea51338Service {
    private static final int IDEA_ID = 51338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51338Service() {
        this(new Idea51338Config());
    }

    public Idea51338Service(Idea51338Config config) {
        this.config = config != null ? config : new Idea51338Config();
