...
@Data
public class Idea51335Config {
    private String name = "idea_051335";
 ...
 */
@Slf4j
public class Idea51335Service {
    private static final int IDEA_ID = 51335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51335Service() {
        this(new Idea51335Config());
    }

    public Idea51335Service(Idea51335Config config) {
        this.config = config != null ? config : new Idea51335Config();
