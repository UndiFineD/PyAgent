...
@Data
public class Idea51615Config {
    private String name = "idea_051615";
 ...
 */
@Slf4j
public class Idea51615Service {
    private static final int IDEA_ID = 51615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51615Service() {
        this(new Idea51615Config());
    }

    public Idea51615Service(Idea51615Config config) {
        this.config = config != null ? config : new Idea51615Config();
