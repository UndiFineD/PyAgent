...
@Data
public class Idea51646Config {
    private String name = "idea_051646";
 ...
 */
@Slf4j
public class Idea51646Service {
    private static final int IDEA_ID = 51646;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51646Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51646Service() {
        this(new Idea51646Config());
    }

    public Idea51646Service(Idea51646Config config) {
        this.config = config != null ? config : new Idea51646Config();
