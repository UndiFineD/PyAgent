...
@Data
public class Idea51635Config {
    private String name = "idea_051635";
 ...
 */
@Slf4j
public class Idea51635Service {
    private static final int IDEA_ID = 51635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51635Service() {
        this(new Idea51635Config());
    }

    public Idea51635Service(Idea51635Config config) {
        this.config = config != null ? config : new Idea51635Config();
