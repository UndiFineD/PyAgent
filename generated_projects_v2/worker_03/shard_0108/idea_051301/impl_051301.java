...
@Data
public class Idea51301Config {
    private String name = "idea_051301";
 ...
 */
@Slf4j
public class Idea51301Service {
    private static final int IDEA_ID = 51301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51301Service() {
        this(new Idea51301Config());
    }

    public Idea51301Service(Idea51301Config config) {
        this.config = config != null ? config : new Idea51301Config();
