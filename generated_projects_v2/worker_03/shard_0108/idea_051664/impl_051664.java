...
@Data
public class Idea51664Config {
    private String name = "idea_051664";
 ...
 */
@Slf4j
public class Idea51664Service {
    private static final int IDEA_ID = 51664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51664Service() {
        this(new Idea51664Config());
    }

    public Idea51664Service(Idea51664Config config) {
        this.config = config != null ? config : new Idea51664Config();
