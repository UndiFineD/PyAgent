...
@Data
public class Idea51564Config {
    private String name = "idea_051564";
 ...
 */
@Slf4j
public class Idea51564Service {
    private static final int IDEA_ID = 51564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51564Service() {
        this(new Idea51564Config());
    }

    public Idea51564Service(Idea51564Config config) {
        this.config = config != null ? config : new Idea51564Config();
