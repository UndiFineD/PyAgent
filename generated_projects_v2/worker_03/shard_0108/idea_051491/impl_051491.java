...
@Data
public class Idea51491Config {
    private String name = "idea_051491";
 ...
 */
@Slf4j
public class Idea51491Service {
    private static final int IDEA_ID = 51491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51491Service() {
        this(new Idea51491Config());
    }

    public Idea51491Service(Idea51491Config config) {
        this.config = config != null ? config : new Idea51491Config();
