...
@Data
public class Idea51642Config {
    private String name = "idea_051642";
 ...
 */
@Slf4j
public class Idea51642Service {
    private static final int IDEA_ID = 51642;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51642Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51642Service() {
        this(new Idea51642Config());
    }

    public Idea51642Service(Idea51642Config config) {
        this.config = config != null ? config : new Idea51642Config();
