...
@Data
public class Idea51613Config {
    private String name = "idea_051613";
 ...
 */
@Slf4j
public class Idea51613Service {
    private static final int IDEA_ID = 51613;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51613Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51613Service() {
        this(new Idea51613Config());
    }

    public Idea51613Service(Idea51613Config config) {
        this.config = config != null ? config : new Idea51613Config();
