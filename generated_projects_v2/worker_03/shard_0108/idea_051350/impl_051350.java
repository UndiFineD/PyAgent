...
@Data
public class Idea51350Config {
    private String name = "idea_051350";
 ...
 */
@Slf4j
public class Idea51350Service {
    private static final int IDEA_ID = 51350;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51350Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51350Service() {
        this(new Idea51350Config());
    }

    public Idea51350Service(Idea51350Config config) {
        this.config = config != null ? config : new Idea51350Config();
