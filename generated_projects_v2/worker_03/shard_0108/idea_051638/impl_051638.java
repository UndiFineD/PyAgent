...
@Data
public class Idea51638Config {
    private String name = "idea_051638";
 ...
 */
@Slf4j
public class Idea51638Service {
    private static final int IDEA_ID = 51638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51638Service() {
        this(new Idea51638Config());
    }

    public Idea51638Service(Idea51638Config config) {
        this.config = config != null ? config : new Idea51638Config();
