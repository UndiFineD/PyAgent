...
@Data
public class Idea51618Config {
    private String name = "idea_051618";
 ...
 */
@Slf4j
public class Idea51618Service {
    private static final int IDEA_ID = 51618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51618Service() {
        this(new Idea51618Config());
    }

    public Idea51618Service(Idea51618Config config) {
        this.config = config != null ? config : new Idea51618Config();
