...
@Data
public class Idea51499Config {
    private String name = "idea_051499";
 ...
 */
@Slf4j
public class Idea51499Service {
    private static final int IDEA_ID = 51499;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51499Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51499Service() {
        this(new Idea51499Config());
    }

    public Idea51499Service(Idea51499Config config) {
        this.config = config != null ? config : new Idea51499Config();
