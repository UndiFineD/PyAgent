...
@Data
public class Idea51548Config {
    private String name = "idea_051548";
 ...
 */
@Slf4j
public class Idea51548Service {
    private static final int IDEA_ID = 51548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51548Service() {
        this(new Idea51548Config());
    }

    public Idea51548Service(Idea51548Config config) {
        this.config = config != null ? config : new Idea51548Config();
