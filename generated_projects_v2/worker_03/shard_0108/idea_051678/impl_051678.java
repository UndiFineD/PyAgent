...
@Data
public class Idea51678Config {
    private String name = "idea_051678";
 ...
 */
@Slf4j
public class Idea51678Service {
    private static final int IDEA_ID = 51678;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51678Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51678Service() {
        this(new Idea51678Config());
    }

    public Idea51678Service(Idea51678Config config) {
        this.config = config != null ? config : new Idea51678Config();
