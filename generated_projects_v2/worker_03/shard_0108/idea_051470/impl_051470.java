...
@Data
public class Idea51470Config {
    private String name = "idea_051470";
 ...
 */
@Slf4j
public class Idea51470Service {
    private static final int IDEA_ID = 51470;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51470Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51470Service() {
        this(new Idea51470Config());
    }

    public Idea51470Service(Idea51470Config config) {
        this.config = config != null ? config : new Idea51470Config();
