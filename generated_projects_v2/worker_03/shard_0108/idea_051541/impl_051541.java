...
@Data
public class Idea51541Config {
    private String name = "idea_051541";
 ...
 */
@Slf4j
public class Idea51541Service {
    private static final int IDEA_ID = 51541;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51541Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51541Service() {
        this(new Idea51541Config());
    }

    public Idea51541Service(Idea51541Config config) {
        this.config = config != null ? config : new Idea51541Config();
