...
@Data
public class Idea51465Config {
    private String name = "idea_051465";
 ...
 */
@Slf4j
public class Idea51465Service {
    private static final int IDEA_ID = 51465;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51465Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51465Service() {
        this(new Idea51465Config());
    }

    public Idea51465Service(Idea51465Config config) {
        this.config = config != null ? config : new Idea51465Config();
