...
@Data
public class Idea51481Config {
    private String name = "idea_051481";
 ...
 */
@Slf4j
public class Idea51481Service {
    private static final int IDEA_ID = 51481;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51481Service() {
        this(new Idea51481Config());
    }

    public Idea51481Service(Idea51481Config config) {
        this.config = config != null ? config : new Idea51481Config();
