...
@Data
public class Idea51363Config {
    private String name = "idea_051363";
 ...
 */
@Slf4j
public class Idea51363Service {
    private static final int IDEA_ID = 51363;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51363Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51363Service() {
        this(new Idea51363Config());
    }

    public Idea51363Service(Idea51363Config config) {
        this.config = config != null ? config : new Idea51363Config();
