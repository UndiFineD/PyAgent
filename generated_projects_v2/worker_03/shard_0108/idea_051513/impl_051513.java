...
@Data
public class Idea51513Config {
    private String name = "idea_051513";
 ...
 */
@Slf4j
public class Idea51513Service {
    private static final int IDEA_ID = 51513;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51513Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51513Service() {
        this(new Idea51513Config());
    }

    public Idea51513Service(Idea51513Config config) {
        this.config = config != null ? config : new Idea51513Config();
