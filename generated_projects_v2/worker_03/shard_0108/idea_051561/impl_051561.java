...
@Data
public class Idea51561Config {
    private String name = "idea_051561";
 ...
 */
@Slf4j
public class Idea51561Service {
    private static final int IDEA_ID = 51561;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51561Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51561Service() {
        this(new Idea51561Config());
    }

    public Idea51561Service(Idea51561Config config) {
        this.config = config != null ? config : new Idea51561Config();
