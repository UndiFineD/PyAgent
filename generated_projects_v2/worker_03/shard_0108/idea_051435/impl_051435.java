...
@Data
public class Idea51435Config {
    private String name = "idea_051435";
 ...
 */
@Slf4j
public class Idea51435Service {
    private static final int IDEA_ID = 51435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51435Service() {
        this(new Idea51435Config());
    }

    public Idea51435Service(Idea51435Config config) {
        this.config = config != null ? config : new Idea51435Config();
