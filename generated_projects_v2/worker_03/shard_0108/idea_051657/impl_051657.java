...
@Data
public class Idea51657Config {
    private String name = "idea_051657";
 ...
 */
@Slf4j
public class Idea51657Service {
    private static final int IDEA_ID = 51657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51657Service() {
        this(new Idea51657Config());
    }

    public Idea51657Service(Idea51657Config config) {
        this.config = config != null ? config : new Idea51657Config();
