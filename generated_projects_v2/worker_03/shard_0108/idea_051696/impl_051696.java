...
@Data
public class Idea51696Config {
    private String name = "idea_051696";
 ...
 */
@Slf4j
public class Idea51696Service {
    private static final int IDEA_ID = 51696;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51696Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51696Service() {
        this(new Idea51696Config());
    }

    public Idea51696Service(Idea51696Config config) {
        this.config = config != null ? config : new Idea51696Config();
