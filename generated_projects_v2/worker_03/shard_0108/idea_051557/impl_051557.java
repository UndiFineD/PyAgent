...
@Data
public class Idea51557Config {
    private String name = "idea_051557";
 ...
 */
@Slf4j
public class Idea51557Service {
    private static final int IDEA_ID = 51557;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51557Service() {
        this(new Idea51557Config());
    }

    public Idea51557Service(Idea51557Config config) {
        this.config = config != null ? config : new Idea51557Config();
