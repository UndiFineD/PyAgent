...
@Data
public class Idea51538Config {
    private String name = "idea_051538";
 ...
 */
@Slf4j
public class Idea51538Service {
    private static final int IDEA_ID = 51538;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51538Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51538Service() {
        this(new Idea51538Config());
    }

    public Idea51538Service(Idea51538Config config) {
        this.config = config != null ? config : new Idea51538Config();
