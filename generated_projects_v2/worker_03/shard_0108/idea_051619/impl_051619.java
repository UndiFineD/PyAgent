...
@Data
public class Idea51619Config {
    private String name = "idea_051619";
 ...
 */
@Slf4j
public class Idea51619Service {
    private static final int IDEA_ID = 51619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51619Service() {
        this(new Idea51619Config());
    }

    public Idea51619Service(Idea51619Config config) {
        this.config = config != null ? config : new Idea51619Config();
