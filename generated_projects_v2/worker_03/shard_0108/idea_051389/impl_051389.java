...
@Data
public class Idea51389Config {
    private String name = "idea_051389";
 ...
 */
@Slf4j
public class Idea51389Service {
    private static final int IDEA_ID = 51389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51389Service() {
        this(new Idea51389Config());
    }

    public Idea51389Service(Idea51389Config config) {
        this.config = config != null ? config : new Idea51389Config();
