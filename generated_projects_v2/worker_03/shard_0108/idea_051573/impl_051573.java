...
@Data
public class Idea51573Config {
    private String name = "idea_051573";
 ...
 */
@Slf4j
public class Idea51573Service {
    private static final int IDEA_ID = 51573;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51573Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51573Service() {
        this(new Idea51573Config());
    }

    public Idea51573Service(Idea51573Config config) {
        this.config = config != null ? config : new Idea51573Config();
