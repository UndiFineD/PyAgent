...
@Data
public class Idea51714Config {
    private String name = "idea_051714";
 ...
 */
@Slf4j
public class Idea51714Service {
    private static final int IDEA_ID = 51714;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51714Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51714Service() {
        this(new Idea51714Config());
    }

    public Idea51714Service(Idea51714Config config) {
        this.config = config != null ? config : new Idea51714Config();
