...
@Data
public class Idea51617Config {
    private String name = "idea_051617";
 ...
 */
@Slf4j
public class Idea51617Service {
    private static final int IDEA_ID = 51617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51617Service() {
        this(new Idea51617Config());
    }

    public Idea51617Service(Idea51617Config config) {
        this.config = config != null ? config : new Idea51617Config();
