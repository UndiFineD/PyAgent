...
@Data
public class Idea51586Config {
    private String name = "idea_051586";
 ...
 */
@Slf4j
public class Idea51586Service {
    private static final int IDEA_ID = 51586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51586Service() {
        this(new Idea51586Config());
    }

    public Idea51586Service(Idea51586Config config) {
        this.config = config != null ? config : new Idea51586Config();
