...
@Data
public class Idea51626Config {
    private String name = "idea_051626";
 ...
 */
@Slf4j
public class Idea51626Service {
    private static final int IDEA_ID = 51626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51626Service() {
        this(new Idea51626Config());
    }

    public Idea51626Service(Idea51626Config config) {
        this.config = config != null ? config : new Idea51626Config();
