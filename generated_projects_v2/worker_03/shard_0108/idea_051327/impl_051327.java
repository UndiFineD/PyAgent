...
@Data
public class Idea51327Config {
    private String name = "idea_051327";
 ...
 */
@Slf4j
public class Idea51327Service {
    private static final int IDEA_ID = 51327;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51327Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51327Service() {
        this(new Idea51327Config());
    }

    public Idea51327Service(Idea51327Config config) {
        this.config = config != null ? config : new Idea51327Config();
