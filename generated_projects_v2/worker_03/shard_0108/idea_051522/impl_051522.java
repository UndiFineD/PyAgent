...
@Data
public class Idea51522Config {
    private String name = "idea_051522";
 ...
 */
@Slf4j
public class Idea51522Service {
    private static final int IDEA_ID = 51522;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51522Service() {
        this(new Idea51522Config());
    }

    public Idea51522Service(Idea51522Config config) {
        this.config = config != null ? config : new Idea51522Config();
