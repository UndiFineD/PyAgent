...
@Data
public class Idea51562Config {
    private String name = "idea_051562";
 ...
 */
@Slf4j
public class Idea51562Service {
    private static final int IDEA_ID = 51562;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51562Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51562Service() {
        this(new Idea51562Config());
    }

    public Idea51562Service(Idea51562Config config) {
        this.config = config != null ? config : new Idea51562Config();
