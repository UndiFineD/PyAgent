...
@Data
public class Idea51690Config {
    private String name = "idea_051690";
 ...
 */
@Slf4j
public class Idea51690Service {
    private static final int IDEA_ID = 51690;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51690Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51690Service() {
        this(new Idea51690Config());
    }

    public Idea51690Service(Idea51690Config config) {
        this.config = config != null ? config : new Idea51690Config();
