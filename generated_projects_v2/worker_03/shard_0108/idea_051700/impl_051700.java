...
@Data
public class Idea51700Config {
    private String name = "idea_051700";
 ...
 */
@Slf4j
public class Idea51700Service {
    private static final int IDEA_ID = 51700;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51700Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51700Service() {
        this(new Idea51700Config());
    }

    public Idea51700Service(Idea51700Config config) {
        this.config = config != null ? config : new Idea51700Config();
