...
@Data
public class Idea51504Config {
    private String name = "idea_051504";
 ...
 */
@Slf4j
public class Idea51504Service {
    private static final int IDEA_ID = 51504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51504Service() {
        this(new Idea51504Config());
    }

    public Idea51504Service(Idea51504Config config) {
        this.config = config != null ? config : new Idea51504Config();
