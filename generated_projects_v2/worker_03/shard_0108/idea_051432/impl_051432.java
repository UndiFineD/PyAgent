...
@Data
public class Idea51432Config {
    private String name = "idea_051432";
 ...
 */
@Slf4j
public class Idea51432Service {
    private static final int IDEA_ID = 51432;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51432Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51432Service() {
        this(new Idea51432Config());
    }

    public Idea51432Service(Idea51432Config config) {
        this.config = config != null ? config : new Idea51432Config();
