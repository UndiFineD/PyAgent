...
@Data
public class Idea51528Config {
    private String name = "idea_051528";
 ...
 */
@Slf4j
public class Idea51528Service {
    private static final int IDEA_ID = 51528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51528Service() {
        this(new Idea51528Config());
    }

    public Idea51528Service(Idea51528Config config) {
        this.config = config != null ? config : new Idea51528Config();
