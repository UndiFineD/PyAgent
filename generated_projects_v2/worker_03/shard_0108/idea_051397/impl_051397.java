...
@Data
public class Idea51397Config {
    private String name = "idea_051397";
 ...
 */
@Slf4j
public class Idea51397Service {
    private static final int IDEA_ID = 51397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51397Service() {
        this(new Idea51397Config());
    }

    public Idea51397Service(Idea51397Config config) {
        this.config = config != null ? config : new Idea51397Config();
