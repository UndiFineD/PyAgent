...
@Data
public class Idea51321Config {
    private String name = "idea_051321";
 ...
 */
@Slf4j
public class Idea51321Service {
    private static final int IDEA_ID = 51321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51321Service() {
        this(new Idea51321Config());
    }

    public Idea51321Service(Idea51321Config config) {
        this.config = config != null ? config : new Idea51321Config();
