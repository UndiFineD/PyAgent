...
@Data
public class Idea51772Config {
    private String name = "idea_051772";
 ...
 */
@Slf4j
public class Idea51772Service {
    private static final int IDEA_ID = 51772;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51772Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51772Service() {
        this(new Idea51772Config());
    }

    public Idea51772Service(Idea51772Config config) {
        this.config = config != null ? config : new Idea51772Config();
