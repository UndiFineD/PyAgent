...
@Data
public class Idea51361Config {
    private String name = "idea_051361";
 ...
 */
@Slf4j
public class Idea51361Service {
    private static final int IDEA_ID = 51361;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51361Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51361Service() {
        this(new Idea51361Config());
    }

    public Idea51361Service(Idea51361Config config) {
        this.config = config != null ? config : new Idea51361Config();
