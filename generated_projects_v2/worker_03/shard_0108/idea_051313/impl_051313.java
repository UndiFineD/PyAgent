...
@Data
public class Idea51313Config {
    private String name = "idea_051313";
 ...
 */
@Slf4j
public class Idea51313Service {
    private static final int IDEA_ID = 51313;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51313Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51313Service() {
        this(new Idea51313Config());
    }

    public Idea51313Service(Idea51313Config config) {
        this.config = config != null ? config : new Idea51313Config();
