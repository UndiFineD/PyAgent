...
@Data
public class Idea51578Config {
    private String name = "idea_051578";
 ...
 */
@Slf4j
public class Idea51578Service {
    private static final int IDEA_ID = 51578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51578Service() {
        this(new Idea51578Config());
    }

    public Idea51578Service(Idea51578Config config) {
        this.config = config != null ? config : new Idea51578Config();
