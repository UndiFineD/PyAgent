...
@Data
public class Idea51571Config {
    private String name = "idea_051571";
 ...
 */
@Slf4j
public class Idea51571Service {
    private static final int IDEA_ID = 51571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51571Service() {
        this(new Idea51571Config());
    }

    public Idea51571Service(Idea51571Config config) {
        this.config = config != null ? config : new Idea51571Config();
