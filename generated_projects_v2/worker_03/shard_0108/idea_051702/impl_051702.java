...
@Data
public class Idea51702Config {
    private String name = "idea_051702";
 ...
 */
@Slf4j
public class Idea51702Service {
    private static final int IDEA_ID = 51702;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51702Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51702Service() {
        this(new Idea51702Config());
    }

    public Idea51702Service(Idea51702Config config) {
        this.config = config != null ? config : new Idea51702Config();
