...
@Data
public class Idea51475Config {
    private String name = "idea_051475";
 ...
 */
@Slf4j
public class Idea51475Service {
    private static final int IDEA_ID = 51475;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51475Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51475Service() {
        this(new Idea51475Config());
    }

    public Idea51475Service(Idea51475Config config) {
        this.config = config != null ? config : new Idea51475Config();
