...
@Data
public class Idea51620Config {
    private String name = "idea_051620";
 ...
 */
@Slf4j
public class Idea51620Service {
    private static final int IDEA_ID = 51620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51620Service() {
        this(new Idea51620Config());
    }

    public Idea51620Service(Idea51620Config config) {
        this.config = config != null ? config : new Idea51620Config();
