...
@Data
public class Idea51757Config {
    private String name = "idea_051757";
 ...
 */
@Slf4j
public class Idea51757Service {
    private static final int IDEA_ID = 51757;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51757Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51757Service() {
        this(new Idea51757Config());
    }

    public Idea51757Service(Idea51757Config config) {
        this.config = config != null ? config : new Idea51757Config();
