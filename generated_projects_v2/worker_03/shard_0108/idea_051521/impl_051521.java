...
@Data
public class Idea51521Config {
    private String name = "idea_051521";
 ...
 */
@Slf4j
public class Idea51521Service {
    private static final int IDEA_ID = 51521;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51521Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51521Service() {
        this(new Idea51521Config());
    }

    public Idea51521Service(Idea51521Config config) {
        this.config = config != null ? config : new Idea51521Config();
