...
@Data
public class Idea51721Config {
    private String name = "idea_051721";
 ...
 */
@Slf4j
public class Idea51721Service {
    private static final int IDEA_ID = 51721;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51721Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51721Service() {
        this(new Idea51721Config());
    }

    public Idea51721Service(Idea51721Config config) {
        this.config = config != null ? config : new Idea51721Config();
