...
@Data
public class Idea51584Config {
    private String name = "idea_051584";
 ...
 */
@Slf4j
public class Idea51584Service {
    private static final int IDEA_ID = 51584;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea51584Config config;
    private final Map<String, ProcessResult> cache;

    public Idea51584Service() {
        this(new Idea51584Config());
    }

    public Idea51584Service(Idea51584Config config) {
        this.config = config != null ? config : new Idea51584Config();
