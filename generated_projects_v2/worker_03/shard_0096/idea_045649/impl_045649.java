...
@Data
public class Idea45649Config {
    private String name = "idea_045649";
 ...
 */
@Slf4j
public class Idea45649Service {
    private static final int IDEA_ID = 45649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45649Service() {
        this(new Idea45649Config());
    }

    public Idea45649Service(Idea45649Config config) {
        this.config = config != null ? config : new Idea45649Config();
