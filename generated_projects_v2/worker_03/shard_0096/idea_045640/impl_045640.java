...
@Data
public class Idea45640Config {
    private String name = "idea_045640";
 ...
 */
@Slf4j
public class Idea45640Service {
    private static final int IDEA_ID = 45640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45640Service() {
        this(new Idea45640Config());
    }

    public Idea45640Service(Idea45640Config config) {
        this.config = config != null ? config : new Idea45640Config();
