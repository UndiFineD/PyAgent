...
@Data
public class Idea45833Config {
    private String name = "idea_045833";
 ...
 */
@Slf4j
public class Idea45833Service {
    private static final int IDEA_ID = 45833;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45833Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45833Service() {
        this(new Idea45833Config());
    }

    public Idea45833Service(Idea45833Config config) {
        this.config = config != null ? config : new Idea45833Config();
