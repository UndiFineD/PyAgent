...
@Data
public class Idea45977Config {
    private String name = "idea_045977";
 ...
 */
@Slf4j
public class Idea45977Service {
    private static final int IDEA_ID = 45977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45977Service() {
        this(new Idea45977Config());
    }

    public Idea45977Service(Idea45977Config config) {
        this.config = config != null ? config : new Idea45977Config();
