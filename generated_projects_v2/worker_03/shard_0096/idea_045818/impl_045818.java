...
@Data
public class Idea45818Config {
    private String name = "idea_045818";
 ...
 */
@Slf4j
public class Idea45818Service {
    private static final int IDEA_ID = 45818;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45818Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45818Service() {
        this(new Idea45818Config());
    }

    public Idea45818Service(Idea45818Config config) {
        this.config = config != null ? config : new Idea45818Config();
