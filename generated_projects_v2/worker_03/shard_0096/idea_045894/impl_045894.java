...
@Data
public class Idea45894Config {
    private String name = "idea_045894";
 ...
 */
@Slf4j
public class Idea45894Service {
    private static final int IDEA_ID = 45894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45894Service() {
        this(new Idea45894Config());
    }

    public Idea45894Service(Idea45894Config config) {
        this.config = config != null ? config : new Idea45894Config();
