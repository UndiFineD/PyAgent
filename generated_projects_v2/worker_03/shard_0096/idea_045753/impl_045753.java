...
@Data
public class Idea45753Config {
    private String name = "idea_045753";
 ...
 */
@Slf4j
public class Idea45753Service {
    private static final int IDEA_ID = 45753;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45753Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45753Service() {
        this(new Idea45753Config());
    }

    public Idea45753Service(Idea45753Config config) {
        this.config = config != null ? config : new Idea45753Config();
