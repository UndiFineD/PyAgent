...
@Data
public class Idea45807Config {
    private String name = "idea_045807";
 ...
 */
@Slf4j
public class Idea45807Service {
    private static final int IDEA_ID = 45807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45807Service() {
        this(new Idea45807Config());
    }

    public Idea45807Service(Idea45807Config config) {
        this.config = config != null ? config : new Idea45807Config();
