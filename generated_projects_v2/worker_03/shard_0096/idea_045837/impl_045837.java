...
@Data
public class Idea45837Config {
    private String name = "idea_045837";
 ...
 */
@Slf4j
public class Idea45837Service {
    private static final int IDEA_ID = 45837;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45837Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45837Service() {
        this(new Idea45837Config());
    }

    public Idea45837Service(Idea45837Config config) {
        this.config = config != null ? config : new Idea45837Config();
