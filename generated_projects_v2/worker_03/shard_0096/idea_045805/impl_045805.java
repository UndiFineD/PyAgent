...
@Data
public class Idea45805Config {
    private String name = "idea_045805";
 ...
 */
@Slf4j
public class Idea45805Service {
    private static final int IDEA_ID = 45805;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45805Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45805Service() {
        this(new Idea45805Config());
    }

    public Idea45805Service(Idea45805Config config) {
        this.config = config != null ? config : new Idea45805Config();
