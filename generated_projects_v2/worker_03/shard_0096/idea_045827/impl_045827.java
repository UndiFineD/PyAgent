...
@Data
public class Idea45827Config {
    private String name = "idea_045827";
 ...
 */
@Slf4j
public class Idea45827Service {
    private static final int IDEA_ID = 45827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45827Service() {
        this(new Idea45827Config());
    }

    public Idea45827Service(Idea45827Config config) {
        this.config = config != null ? config : new Idea45827Config();
