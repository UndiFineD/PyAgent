...
@Data
public class Idea45684Config {
    private String name = "idea_045684";
 ...
 */
@Slf4j
public class Idea45684Service {
    private static final int IDEA_ID = 45684;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45684Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45684Service() {
        this(new Idea45684Config());
    }

    public Idea45684Service(Idea45684Config config) {
        this.config = config != null ? config : new Idea45684Config();
