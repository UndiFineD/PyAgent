...
@Data
public class Idea46042Config {
    private String name = "idea_046042";
 ...
 */
@Slf4j
public class Idea46042Service {
    private static final int IDEA_ID = 46042;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46042Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46042Service() {
        this(new Idea46042Config());
    }

    public Idea46042Service(Idea46042Config config) {
        this.config = config != null ? config : new Idea46042Config();
