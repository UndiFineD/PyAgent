...
@Data
public class Idea45648Config {
    private String name = "idea_045648";
 ...
 */
@Slf4j
public class Idea45648Service {
    private static final int IDEA_ID = 45648;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45648Service() {
        this(new Idea45648Config());
    }

    public Idea45648Service(Idea45648Config config) {
        this.config = config != null ? config : new Idea45648Config();
