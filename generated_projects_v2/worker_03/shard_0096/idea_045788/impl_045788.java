...
@Data
public class Idea45788Config {
    private String name = "idea_045788";
 ...
 */
@Slf4j
public class Idea45788Service {
    private static final int IDEA_ID = 45788;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45788Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45788Service() {
        this(new Idea45788Config());
    }

    public Idea45788Service(Idea45788Config config) {
        this.config = config != null ? config : new Idea45788Config();
