...
@Data
public class Idea45946Config {
    private String name = "idea_045946";
 ...
 */
@Slf4j
public class Idea45946Service {
    private static final int IDEA_ID = 45946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45946Service() {
        this(new Idea45946Config());
    }

    public Idea45946Service(Idea45946Config config) {
        this.config = config != null ? config : new Idea45946Config();
