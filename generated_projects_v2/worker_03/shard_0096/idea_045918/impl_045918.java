...
@Data
public class Idea45918Config {
    private String name = "idea_045918";
 ...
 */
@Slf4j
public class Idea45918Service {
    private static final int IDEA_ID = 45918;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45918Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45918Service() {
        this(new Idea45918Config());
    }

    public Idea45918Service(Idea45918Config config) {
        this.config = config != null ? config : new Idea45918Config();
