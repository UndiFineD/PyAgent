...
@Data
public class Idea45887Config {
    private String name = "idea_045887";
 ...
 */
@Slf4j
public class Idea45887Service {
    private static final int IDEA_ID = 45887;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45887Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45887Service() {
        this(new Idea45887Config());
    }

    public Idea45887Service(Idea45887Config config) {
        this.config = config != null ? config : new Idea45887Config();
