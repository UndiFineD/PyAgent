...
@Data
public class Idea45716Config {
    private String name = "idea_045716";
 ...
 */
@Slf4j
public class Idea45716Service {
    private static final int IDEA_ID = 45716;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45716Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45716Service() {
        this(new Idea45716Config());
    }

    public Idea45716Service(Idea45716Config config) {
        this.config = config != null ? config : new Idea45716Config();
