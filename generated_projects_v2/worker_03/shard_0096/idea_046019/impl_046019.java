...
@Data
public class Idea46019Config {
    private String name = "idea_046019";
 ...
 */
@Slf4j
public class Idea46019Service {
    private static final int IDEA_ID = 46019;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46019Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46019Service() {
        this(new Idea46019Config());
    }

    public Idea46019Service(Idea46019Config config) {
        this.config = config != null ? config : new Idea46019Config();
