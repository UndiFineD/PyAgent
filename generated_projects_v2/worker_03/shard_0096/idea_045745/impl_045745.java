...
@Data
public class Idea45745Config {
    private String name = "idea_045745";
 ...
 */
@Slf4j
public class Idea45745Service {
    private static final int IDEA_ID = 45745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45745Service() {
        this(new Idea45745Config());
    }

    public Idea45745Service(Idea45745Config config) {
        this.config = config != null ? config : new Idea45745Config();
