...
@Data
public class Idea46013Config {
    private String name = "idea_046013";
 ...
 */
@Slf4j
public class Idea46013Service {
    private static final int IDEA_ID = 46013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46013Service() {
        this(new Idea46013Config());
    }

    public Idea46013Service(Idea46013Config config) {
        this.config = config != null ? config : new Idea46013Config();
