...
@Data
public class Idea45937Config {
    private String name = "idea_045937";
 ...
 */
@Slf4j
public class Idea45937Service {
    private static final int IDEA_ID = 45937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45937Service() {
        this(new Idea45937Config());
    }

    public Idea45937Service(Idea45937Config config) {
        this.config = config != null ? config : new Idea45937Config();
