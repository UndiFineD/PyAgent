...
@Data
public class Idea45817Config {
    private String name = "idea_045817";
 ...
 */
@Slf4j
public class Idea45817Service {
    private static final int IDEA_ID = 45817;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45817Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45817Service() {
        this(new Idea45817Config());
    }

    public Idea45817Service(Idea45817Config config) {
        this.config = config != null ? config : new Idea45817Config();
