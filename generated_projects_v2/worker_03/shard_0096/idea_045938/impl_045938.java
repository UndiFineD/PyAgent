...
@Data
public class Idea45938Config {
    private String name = "idea_045938";
 ...
 */
@Slf4j
public class Idea45938Service {
    private static final int IDEA_ID = 45938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45938Service() {
        this(new Idea45938Config());
    }

    public Idea45938Service(Idea45938Config config) {
        this.config = config != null ? config : new Idea45938Config();
