...
@Data
public class Idea45945Config {
    private String name = "idea_045945";
 ...
 */
@Slf4j
public class Idea45945Service {
    private static final int IDEA_ID = 45945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45945Service() {
        this(new Idea45945Config());
    }

    public Idea45945Service(Idea45945Config config) {
        this.config = config != null ? config : new Idea45945Config();
