...
@Data
public class Idea45733Config {
    private String name = "idea_045733";
 ...
 */
@Slf4j
public class Idea45733Service {
    private static final int IDEA_ID = 45733;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45733Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45733Service() {
        this(new Idea45733Config());
    }

    public Idea45733Service(Idea45733Config config) {
        this.config = config != null ? config : new Idea45733Config();
