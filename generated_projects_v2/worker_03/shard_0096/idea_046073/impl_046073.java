...
@Data
public class Idea46073Config {
    private String name = "idea_046073";
 ...
 */
@Slf4j
public class Idea46073Service {
    private static final int IDEA_ID = 46073;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46073Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46073Service() {
        this(new Idea46073Config());
    }

    public Idea46073Service(Idea46073Config config) {
        this.config = config != null ? config : new Idea46073Config();
