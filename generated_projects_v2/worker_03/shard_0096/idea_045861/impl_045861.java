...
@Data
public class Idea45861Config {
    private String name = "idea_045861";
 ...
 */
@Slf4j
public class Idea45861Service {
    private static final int IDEA_ID = 45861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45861Service() {
        this(new Idea45861Config());
    }

    public Idea45861Service(Idea45861Config config) {
        this.config = config != null ? config : new Idea45861Config();
