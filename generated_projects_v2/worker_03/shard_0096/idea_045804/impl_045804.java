...
@Data
public class Idea45804Config {
    private String name = "idea_045804";
 ...
 */
@Slf4j
public class Idea45804Service {
    private static final int IDEA_ID = 45804;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45804Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45804Service() {
        this(new Idea45804Config());
    }

    public Idea45804Service(Idea45804Config config) {
        this.config = config != null ? config : new Idea45804Config();
