...
@Data
public class Idea45860Config {
    private String name = "idea_045860";
 ...
 */
@Slf4j
public class Idea45860Service {
    private static final int IDEA_ID = 45860;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45860Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45860Service() {
        this(new Idea45860Config());
    }

    public Idea45860Service(Idea45860Config config) {
        this.config = config != null ? config : new Idea45860Config();
