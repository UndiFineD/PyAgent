...
@Data
public class Idea45867Config {
    private String name = "idea_045867";
 ...
 */
@Slf4j
public class Idea45867Service {
    private static final int IDEA_ID = 45867;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45867Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45867Service() {
        this(new Idea45867Config());
    }

    public Idea45867Service(Idea45867Config config) {
        this.config = config != null ? config : new Idea45867Config();
