...
@Data
public class Idea45627Config {
    private String name = "idea_045627";
 ...
 */
@Slf4j
public class Idea45627Service {
    private static final int IDEA_ID = 45627;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45627Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45627Service() {
        this(new Idea45627Config());
    }

    public Idea45627Service(Idea45627Config config) {
        this.config = config != null ? config : new Idea45627Config();
