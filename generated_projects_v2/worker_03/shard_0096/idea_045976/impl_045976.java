...
@Data
public class Idea45976Config {
    private String name = "idea_045976";
 ...
 */
@Slf4j
public class Idea45976Service {
    private static final int IDEA_ID = 45976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45976Service() {
        this(new Idea45976Config());
    }

    public Idea45976Service(Idea45976Config config) {
        this.config = config != null ? config : new Idea45976Config();
