...
@Data
public class Idea45826Config {
    private String name = "idea_045826";
 ...
 */
@Slf4j
public class Idea45826Service {
    private static final int IDEA_ID = 45826;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45826Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45826Service() {
        this(new Idea45826Config());
    }

    public Idea45826Service(Idea45826Config config) {
        this.config = config != null ? config : new Idea45826Config();
