...
@Data
public class Idea46038Config {
    private String name = "idea_046038";
 ...
 */
@Slf4j
public class Idea46038Service {
    private static final int IDEA_ID = 46038;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46038Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46038Service() {
        this(new Idea46038Config());
    }

    public Idea46038Service(Idea46038Config config) {
        this.config = config != null ? config : new Idea46038Config();
