...
@Data
public class Idea46032Config {
    private String name = "idea_046032";
 ...
 */
@Slf4j
public class Idea46032Service {
    private static final int IDEA_ID = 46032;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46032Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46032Service() {
        this(new Idea46032Config());
    }

    public Idea46032Service(Idea46032Config config) {
        this.config = config != null ? config : new Idea46032Config();
