...
@Data
public class Idea45639Config {
    private String name = "idea_045639";
 ...
 */
@Slf4j
public class Idea45639Service {
    private static final int IDEA_ID = 45639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45639Service() {
        this(new Idea45639Config());
    }

    public Idea45639Service(Idea45639Config config) {
        this.config = config != null ? config : new Idea45639Config();
