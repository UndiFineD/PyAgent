...
@Data
public class Idea45624Config {
    private String name = "idea_045624";
 ...
 */
@Slf4j
public class Idea45624Service {
    private static final int IDEA_ID = 45624;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45624Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45624Service() {
        this(new Idea45624Config());
    }

    public Idea45624Service(Idea45624Config config) {
        this.config = config != null ? config : new Idea45624Config();
