...
@Data
public class Idea45993Config {
    private String name = "idea_045993";
 ...
 */
@Slf4j
public class Idea45993Service {
    private static final int IDEA_ID = 45993;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45993Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45993Service() {
        this(new Idea45993Config());
    }

    public Idea45993Service(Idea45993Config config) {
        this.config = config != null ? config : new Idea45993Config();
