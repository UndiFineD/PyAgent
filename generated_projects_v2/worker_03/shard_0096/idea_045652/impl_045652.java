...
@Data
public class Idea45652Config {
    private String name = "idea_045652";
 ...
 */
@Slf4j
public class Idea45652Service {
    private static final int IDEA_ID = 45652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45652Service() {
        this(new Idea45652Config());
    }

    public Idea45652Service(Idea45652Config config) {
        this.config = config != null ? config : new Idea45652Config();
