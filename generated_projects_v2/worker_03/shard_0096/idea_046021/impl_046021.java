...
@Data
public class Idea46021Config {
    private String name = "idea_046021";
 ...
 */
@Slf4j
public class Idea46021Service {
    private static final int IDEA_ID = 46021;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46021Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46021Service() {
        this(new Idea46021Config());
    }

    public Idea46021Service(Idea46021Config config) {
        this.config = config != null ? config : new Idea46021Config();
