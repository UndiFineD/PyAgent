...
@Data
public class Idea45612Config {
    private String name = "idea_045612";
 ...
 */
@Slf4j
public class Idea45612Service {
    private static final int IDEA_ID = 45612;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45612Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45612Service() {
        this(new Idea45612Config());
    }

    public Idea45612Service(Idea45612Config config) {
        this.config = config != null ? config : new Idea45612Config();
