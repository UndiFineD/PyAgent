...
@Data
public class Idea45978Config {
    private String name = "idea_045978";
 ...
 */
@Slf4j
public class Idea45978Service {
    private static final int IDEA_ID = 45978;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45978Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45978Service() {
        this(new Idea45978Config());
    }

    public Idea45978Service(Idea45978Config config) {
        this.config = config != null ? config : new Idea45978Config();
