...
@Data
public class Idea45810Config {
    private String name = "idea_045810";
 ...
 */
@Slf4j
public class Idea45810Service {
    private static final int IDEA_ID = 45810;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45810Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45810Service() {
        this(new Idea45810Config());
    }

    public Idea45810Service(Idea45810Config config) {
        this.config = config != null ? config : new Idea45810Config();
