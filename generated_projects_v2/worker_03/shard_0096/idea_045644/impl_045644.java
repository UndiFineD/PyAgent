...
@Data
public class Idea45644Config {
    private String name = "idea_045644";
 ...
 */
@Slf4j
public class Idea45644Service {
    private static final int IDEA_ID = 45644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45644Service() {
        this(new Idea45644Config());
    }

    public Idea45644Service(Idea45644Config config) {
        this.config = config != null ? config : new Idea45644Config();
