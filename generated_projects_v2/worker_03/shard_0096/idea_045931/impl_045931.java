...
@Data
public class Idea45931Config {
    private String name = "idea_045931";
 ...
 */
@Slf4j
public class Idea45931Service {
    private static final int IDEA_ID = 45931;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45931Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45931Service() {
        this(new Idea45931Config());
    }

    public Idea45931Service(Idea45931Config config) {
        this.config = config != null ? config : new Idea45931Config();
