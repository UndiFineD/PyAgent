...
@Data
public class Idea45906Config {
    private String name = "idea_045906";
 ...
 */
@Slf4j
public class Idea45906Service {
    private static final int IDEA_ID = 45906;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45906Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45906Service() {
        this(new Idea45906Config());
    }

    public Idea45906Service(Idea45906Config config) {
        this.config = config != null ? config : new Idea45906Config();
