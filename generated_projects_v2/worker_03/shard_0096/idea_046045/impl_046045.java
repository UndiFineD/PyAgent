...
@Data
public class Idea46045Config {
    private String name = "idea_046045";
 ...
 */
@Slf4j
public class Idea46045Service {
    private static final int IDEA_ID = 46045;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46045Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46045Service() {
        this(new Idea46045Config());
    }

    public Idea46045Service(Idea46045Config config) {
        this.config = config != null ? config : new Idea46045Config();
