...
@Data
public class Idea45962Config {
    private String name = "idea_045962";
 ...
 */
@Slf4j
public class Idea45962Service {
    private static final int IDEA_ID = 45962;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45962Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45962Service() {
        this(new Idea45962Config());
    }

    public Idea45962Service(Idea45962Config config) {
        this.config = config != null ? config : new Idea45962Config();
