...
@Data
public class Idea45790Config {
    private String name = "idea_045790";
 ...
 */
@Slf4j
public class Idea45790Service {
    private static final int IDEA_ID = 45790;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45790Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45790Service() {
        this(new Idea45790Config());
    }

    public Idea45790Service(Idea45790Config config) {
        this.config = config != null ? config : new Idea45790Config();
