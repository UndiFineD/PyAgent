...
@Data
public class Idea46016Config {
    private String name = "idea_046016";
 ...
 */
@Slf4j
public class Idea46016Service {
    private static final int IDEA_ID = 46016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46016Service() {
        this(new Idea46016Config());
    }

    public Idea46016Service(Idea46016Config config) {
        this.config = config != null ? config : new Idea46016Config();
