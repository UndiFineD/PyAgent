...
@Data
public class Idea45630Config {
    private String name = "idea_045630";
 ...
 */
@Slf4j
public class Idea45630Service {
    private static final int IDEA_ID = 45630;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45630Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45630Service() {
        this(new Idea45630Config());
    }

    public Idea45630Service(Idea45630Config config) {
        this.config = config != null ? config : new Idea45630Config();
