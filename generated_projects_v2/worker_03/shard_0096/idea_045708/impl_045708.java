...
@Data
public class Idea45708Config {
    private String name = "idea_045708";
 ...
 */
@Slf4j
public class Idea45708Service {
    private static final int IDEA_ID = 45708;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45708Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45708Service() {
        this(new Idea45708Config());
    }

    public Idea45708Service(Idea45708Config config) {
        this.config = config != null ? config : new Idea45708Config();
