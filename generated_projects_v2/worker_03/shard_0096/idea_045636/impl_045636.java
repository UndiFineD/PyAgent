...
@Data
public class Idea45636Config {
    private String name = "idea_045636";
 ...
 */
@Slf4j
public class Idea45636Service {
    private static final int IDEA_ID = 45636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45636Service() {
        this(new Idea45636Config());
    }

    public Idea45636Service(Idea45636Config config) {
        this.config = config != null ? config : new Idea45636Config();
