...
@Data
public class Idea45784Config {
    private String name = "idea_045784";
 ...
 */
@Slf4j
public class Idea45784Service {
    private static final int IDEA_ID = 45784;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45784Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45784Service() {
        this(new Idea45784Config());
    }

    public Idea45784Service(Idea45784Config config) {
        this.config = config != null ? config : new Idea45784Config();
