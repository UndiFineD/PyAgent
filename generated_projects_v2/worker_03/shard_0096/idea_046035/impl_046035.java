...
@Data
public class Idea46035Config {
    private String name = "idea_046035";
 ...
 */
@Slf4j
public class Idea46035Service {
    private static final int IDEA_ID = 46035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46035Service() {
        this(new Idea46035Config());
    }

    public Idea46035Service(Idea46035Config config) {
        this.config = config != null ? config : new Idea46035Config();
