...
@Data
public class Idea46037Config {
    private String name = "idea_046037";
 ...
 */
@Slf4j
public class Idea46037Service {
    private static final int IDEA_ID = 46037;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46037Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46037Service() {
        this(new Idea46037Config());
    }

    public Idea46037Service(Idea46037Config config) {
        this.config = config != null ? config : new Idea46037Config();
