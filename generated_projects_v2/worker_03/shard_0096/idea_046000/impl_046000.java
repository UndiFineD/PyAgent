...
@Data
public class Idea46000Config {
    private String name = "idea_046000";
 ...
 */
@Slf4j
public class Idea46000Service {
    private static final int IDEA_ID = 46000;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46000Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46000Service() {
        this(new Idea46000Config());
    }

    public Idea46000Service(Idea46000Config config) {
        this.config = config != null ? config : new Idea46000Config();
