...
@Data
public class Idea46008Config {
    private String name = "idea_046008";
 ...
 */
@Slf4j
public class Idea46008Service {
    private static final int IDEA_ID = 46008;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46008Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46008Service() {
        this(new Idea46008Config());
    }

    public Idea46008Service(Idea46008Config config) {
        this.config = config != null ? config : new Idea46008Config();
