...
@Data
public class Idea45727Config {
    private String name = "idea_045727";
 ...
 */
@Slf4j
public class Idea45727Service {
    private static final int IDEA_ID = 45727;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45727Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45727Service() {
        this(new Idea45727Config());
    }

    public Idea45727Service(Idea45727Config config) {
        this.config = config != null ? config : new Idea45727Config();
