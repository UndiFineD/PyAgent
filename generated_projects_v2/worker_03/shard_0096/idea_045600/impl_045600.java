...
@Data
public class Idea45600Config {
    private String name = "idea_045600";
 ...
 */
@Slf4j
public class Idea45600Service {
    private static final int IDEA_ID = 45600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45600Service() {
        this(new Idea45600Config());
    }

    public Idea45600Service(Idea45600Config config) {
        this.config = config != null ? config : new Idea45600Config();
