...
@Data
public class Idea45617Config {
    private String name = "idea_045617";
 ...
 */
@Slf4j
public class Idea45617Service {
    private static final int IDEA_ID = 45617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45617Service() {
        this(new Idea45617Config());
    }

    public Idea45617Service(Idea45617Config config) {
        this.config = config != null ? config : new Idea45617Config();
