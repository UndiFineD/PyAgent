...
@Data
public class Idea45661Config {
    private String name = "idea_045661";
 ...
 */
@Slf4j
public class Idea45661Service {
    private static final int IDEA_ID = 45661;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45661Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45661Service() {
        this(new Idea45661Config());
    }

    public Idea45661Service(Idea45661Config config) {
        this.config = config != null ? config : new Idea45661Config();
