...
@Data
public class Idea45811Config {
    private String name = "idea_045811";
 ...
 */
@Slf4j
public class Idea45811Service {
    private static final int IDEA_ID = 45811;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45811Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45811Service() {
        this(new Idea45811Config());
    }

    public Idea45811Service(Idea45811Config config) {
        this.config = config != null ? config : new Idea45811Config();
