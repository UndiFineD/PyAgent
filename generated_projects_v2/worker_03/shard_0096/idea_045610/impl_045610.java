...
@Data
public class Idea45610Config {
    private String name = "idea_045610";
 ...
 */
@Slf4j
public class Idea45610Service {
    private static final int IDEA_ID = 45610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45610Service() {
        this(new Idea45610Config());
    }

    public Idea45610Service(Idea45610Config config) {
        this.config = config != null ? config : new Idea45610Config();
