...
@Data
public class Idea45737Config {
    private String name = "idea_045737";
 ...
 */
@Slf4j
public class Idea45737Service {
    private static final int IDEA_ID = 45737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45737Service() {
        this(new Idea45737Config());
    }

    public Idea45737Service(Idea45737Config config) {
        this.config = config != null ? config : new Idea45737Config();
