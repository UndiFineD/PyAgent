...
@Data
public class Idea46011Config {
    private String name = "idea_046011";
 ...
 */
@Slf4j
public class Idea46011Service {
    private static final int IDEA_ID = 46011;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46011Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46011Service() {
        this(new Idea46011Config());
    }

    public Idea46011Service(Idea46011Config config) {
        this.config = config != null ? config : new Idea46011Config();
