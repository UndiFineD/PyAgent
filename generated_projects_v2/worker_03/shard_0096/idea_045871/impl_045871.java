...
@Data
public class Idea45871Config {
    private String name = "idea_045871";
 ...
 */
@Slf4j
public class Idea45871Service {
    private static final int IDEA_ID = 45871;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45871Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45871Service() {
        this(new Idea45871Config());
    }

    public Idea45871Service(Idea45871Config config) {
        this.config = config != null ? config : new Idea45871Config();
