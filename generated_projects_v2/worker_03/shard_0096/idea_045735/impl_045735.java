...
@Data
public class Idea45735Config {
    private String name = "idea_045735";
 ...
 */
@Slf4j
public class Idea45735Service {
    private static final int IDEA_ID = 45735;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45735Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45735Service() {
        this(new Idea45735Config());
    }

    public Idea45735Service(Idea45735Config config) {
        this.config = config != null ? config : new Idea45735Config();
