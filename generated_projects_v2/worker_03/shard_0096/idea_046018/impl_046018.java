...
@Data
public class Idea46018Config {
    private String name = "idea_046018";
 ...
 */
@Slf4j
public class Idea46018Service {
    private static final int IDEA_ID = 46018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46018Service() {
        this(new Idea46018Config());
    }

    public Idea46018Service(Idea46018Config config) {
        this.config = config != null ? config : new Idea46018Config();
