...
@Data
public class Idea45933Config {
    private String name = "idea_045933";
 ...
 */
@Slf4j
public class Idea45933Service {
    private static final int IDEA_ID = 45933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45933Service() {
        this(new Idea45933Config());
    }

    public Idea45933Service(Idea45933Config config) {
        this.config = config != null ? config : new Idea45933Config();
