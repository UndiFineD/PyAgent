...
@Data
public class Idea45707Config {
    private String name = "idea_045707";
 ...
 */
@Slf4j
public class Idea45707Service {
    private static final int IDEA_ID = 45707;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45707Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45707Service() {
        this(new Idea45707Config());
    }

    public Idea45707Service(Idea45707Config config) {
        this.config = config != null ? config : new Idea45707Config();
