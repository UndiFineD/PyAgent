...
@Data
public class Idea45947Config {
    private String name = "idea_045947";
 ...
 */
@Slf4j
public class Idea45947Service {
    private static final int IDEA_ID = 45947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45947Service() {
        this(new Idea45947Config());
    }

    public Idea45947Service(Idea45947Config config) {
        this.config = config != null ? config : new Idea45947Config();
