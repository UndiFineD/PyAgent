...
@Data
public class Idea45996Config {
    private String name = "idea_045996";
 ...
 */
@Slf4j
public class Idea45996Service {
    private static final int IDEA_ID = 45996;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45996Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45996Service() {
        this(new Idea45996Config());
    }

    public Idea45996Service(Idea45996Config config) {
        this.config = config != null ? config : new Idea45996Config();
