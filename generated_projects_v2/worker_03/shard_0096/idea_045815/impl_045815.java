...
@Data
public class Idea45815Config {
    private String name = "idea_045815";
 ...
 */
@Slf4j
public class Idea45815Service {
    private static final int IDEA_ID = 45815;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45815Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45815Service() {
        this(new Idea45815Config());
    }

    public Idea45815Service(Idea45815Config config) {
        this.config = config != null ? config : new Idea45815Config();
