...
@Data
public class Idea45802Config {
    private String name = "idea_045802";
 ...
 */
@Slf4j
public class Idea45802Service {
    private static final int IDEA_ID = 45802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45802Service() {
        this(new Idea45802Config());
    }

    public Idea45802Service(Idea45802Config config) {
        this.config = config != null ? config : new Idea45802Config();
