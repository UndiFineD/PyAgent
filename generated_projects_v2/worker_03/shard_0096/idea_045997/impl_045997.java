...
@Data
public class Idea45997Config {
    private String name = "idea_045997";
 ...
 */
@Slf4j
public class Idea45997Service {
    private static final int IDEA_ID = 45997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45997Service() {
        this(new Idea45997Config());
    }

    public Idea45997Service(Idea45997Config config) {
        this.config = config != null ? config : new Idea45997Config();
