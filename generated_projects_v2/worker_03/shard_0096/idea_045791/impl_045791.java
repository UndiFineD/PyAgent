...
@Data
public class Idea45791Config {
    private String name = "idea_045791";
 ...
 */
@Slf4j
public class Idea45791Service {
    private static final int IDEA_ID = 45791;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45791Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45791Service() {
        this(new Idea45791Config());
    }

    public Idea45791Service(Idea45791Config config) {
        this.config = config != null ? config : new Idea45791Config();
