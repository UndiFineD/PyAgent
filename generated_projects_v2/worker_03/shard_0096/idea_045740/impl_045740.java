...
@Data
public class Idea45740Config {
    private String name = "idea_045740";
 ...
 */
@Slf4j
public class Idea45740Service {
    private static final int IDEA_ID = 45740;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45740Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45740Service() {
        this(new Idea45740Config());
    }

    public Idea45740Service(Idea45740Config config) {
        this.config = config != null ? config : new Idea45740Config();
