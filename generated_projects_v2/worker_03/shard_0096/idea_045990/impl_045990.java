...
@Data
public class Idea45990Config {
    private String name = "idea_045990";
 ...
 */
@Slf4j
public class Idea45990Service {
    private static final int IDEA_ID = 45990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45990Service() {
        this(new Idea45990Config());
    }

    public Idea45990Service(Idea45990Config config) {
        this.config = config != null ? config : new Idea45990Config();
