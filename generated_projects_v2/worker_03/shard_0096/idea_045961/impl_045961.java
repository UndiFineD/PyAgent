...
@Data
public class Idea45961Config {
    private String name = "idea_045961";
 ...
 */
@Slf4j
public class Idea45961Service {
    private static final int IDEA_ID = 45961;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45961Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45961Service() {
        this(new Idea45961Config());
    }

    public Idea45961Service(Idea45961Config config) {
        this.config = config != null ? config : new Idea45961Config();
