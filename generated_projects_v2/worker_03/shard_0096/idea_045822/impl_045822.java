...
@Data
public class Idea45822Config {
    private String name = "idea_045822";
 ...
 */
@Slf4j
public class Idea45822Service {
    private static final int IDEA_ID = 45822;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45822Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45822Service() {
        this(new Idea45822Config());
    }

    public Idea45822Service(Idea45822Config config) {
        this.config = config != null ? config : new Idea45822Config();
