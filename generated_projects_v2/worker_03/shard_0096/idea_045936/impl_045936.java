...
@Data
public class Idea45936Config {
    private String name = "idea_045936";
 ...
 */
@Slf4j
public class Idea45936Service {
    private static final int IDEA_ID = 45936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45936Service() {
        this(new Idea45936Config());
    }

    public Idea45936Service(Idea45936Config config) {
        this.config = config != null ? config : new Idea45936Config();
