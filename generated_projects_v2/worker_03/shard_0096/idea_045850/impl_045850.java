...
@Data
public class Idea45850Config {
    private String name = "idea_045850";
 ...
 */
@Slf4j
public class Idea45850Service {
    private static final int IDEA_ID = 45850;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45850Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45850Service() {
        this(new Idea45850Config());
    }

    public Idea45850Service(Idea45850Config config) {
        this.config = config != null ? config : new Idea45850Config();
