...
@Data
public class Idea45698Config {
    private String name = "idea_045698";
 ...
 */
@Slf4j
public class Idea45698Service {
    private static final int IDEA_ID = 45698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45698Service() {
        this(new Idea45698Config());
    }

    public Idea45698Service(Idea45698Config config) {
        this.config = config != null ? config : new Idea45698Config();
