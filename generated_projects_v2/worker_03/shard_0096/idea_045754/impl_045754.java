...
@Data
public class Idea45754Config {
    private String name = "idea_045754";
 ...
 */
@Slf4j
public class Idea45754Service {
    private static final int IDEA_ID = 45754;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45754Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45754Service() {
        this(new Idea45754Config());
    }

    public Idea45754Service(Idea45754Config config) {
        this.config = config != null ? config : new Idea45754Config();
