...
@Data
public class Idea45927Config {
    private String name = "idea_045927";
 ...
 */
@Slf4j
public class Idea45927Service {
    private static final int IDEA_ID = 45927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45927Service() {
        this(new Idea45927Config());
    }

    public Idea45927Service(Idea45927Config config) {
        this.config = config != null ? config : new Idea45927Config();
