...
@Data
public class Idea45941Config {
    private String name = "idea_045941";
 ...
 */
@Slf4j
public class Idea45941Service {
    private static final int IDEA_ID = 45941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45941Service() {
        this(new Idea45941Config());
    }

    public Idea45941Service(Idea45941Config config) {
        this.config = config != null ? config : new Idea45941Config();
