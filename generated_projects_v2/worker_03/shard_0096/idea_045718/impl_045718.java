...
@Data
public class Idea45718Config {
    private String name = "idea_045718";
 ...
 */
@Slf4j
public class Idea45718Service {
    private static final int IDEA_ID = 45718;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45718Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45718Service() {
        this(new Idea45718Config());
    }

    public Idea45718Service(Idea45718Config config) {
        this.config = config != null ? config : new Idea45718Config();
