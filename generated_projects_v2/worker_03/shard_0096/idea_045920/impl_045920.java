...
@Data
public class Idea45920Config {
    private String name = "idea_045920";
 ...
 */
@Slf4j
public class Idea45920Service {
    private static final int IDEA_ID = 45920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45920Service() {
        this(new Idea45920Config());
    }

    public Idea45920Service(Idea45920Config config) {
        this.config = config != null ? config : new Idea45920Config();
