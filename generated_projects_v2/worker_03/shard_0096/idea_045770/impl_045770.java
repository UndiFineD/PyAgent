...
@Data
public class Idea45770Config {
    private String name = "idea_045770";
 ...
 */
@Slf4j
public class Idea45770Service {
    private static final int IDEA_ID = 45770;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45770Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45770Service() {
        this(new Idea45770Config());
    }

    public Idea45770Service(Idea45770Config config) {
        this.config = config != null ? config : new Idea45770Config();
