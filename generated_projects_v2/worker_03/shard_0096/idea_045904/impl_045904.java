...
@Data
public class Idea45904Config {
    private String name = "idea_045904";
 ...
 */
@Slf4j
public class Idea45904Service {
    private static final int IDEA_ID = 45904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45904Service() {
        this(new Idea45904Config());
    }

    public Idea45904Service(Idea45904Config config) {
        this.config = config != null ? config : new Idea45904Config();
