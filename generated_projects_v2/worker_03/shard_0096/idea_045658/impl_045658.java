...
@Data
public class Idea45658Config {
    private String name = "idea_045658";
 ...
 */
@Slf4j
public class Idea45658Service {
    private static final int IDEA_ID = 45658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45658Service() {
        this(new Idea45658Config());
    }

    public Idea45658Service(Idea45658Config config) {
        this.config = config != null ? config : new Idea45658Config();
