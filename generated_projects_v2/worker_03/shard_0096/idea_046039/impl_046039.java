...
@Data
public class Idea46039Config {
    private String name = "idea_046039";
 ...
 */
@Slf4j
public class Idea46039Service {
    private static final int IDEA_ID = 46039;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46039Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46039Service() {
        this(new Idea46039Config());
    }

    public Idea46039Service(Idea46039Config config) {
        this.config = config != null ? config : new Idea46039Config();
