...
@Data
public class Idea45607Config {
    private String name = "idea_045607";
 ...
 */
@Slf4j
public class Idea45607Service {
    private static final int IDEA_ID = 45607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45607Service() {
        this(new Idea45607Config());
    }

    public Idea45607Service(Idea45607Config config) {
        this.config = config != null ? config : new Idea45607Config();
