...
@Data
public class Idea45975Config {
    private String name = "idea_045975";
 ...
 */
@Slf4j
public class Idea45975Service {
    private static final int IDEA_ID = 45975;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45975Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45975Service() {
        this(new Idea45975Config());
    }

    public Idea45975Service(Idea45975Config config) {
        this.config = config != null ? config : new Idea45975Config();
