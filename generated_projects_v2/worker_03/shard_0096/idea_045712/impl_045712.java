...
@Data
public class Idea45712Config {
    private String name = "idea_045712";
 ...
 */
@Slf4j
public class Idea45712Service {
    private static final int IDEA_ID = 45712;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45712Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45712Service() {
        this(new Idea45712Config());
    }

    public Idea45712Service(Idea45712Config config) {
        this.config = config != null ? config : new Idea45712Config();
