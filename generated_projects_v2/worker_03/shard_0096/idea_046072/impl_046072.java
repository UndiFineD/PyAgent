...
@Data
public class Idea46072Config {
    private String name = "idea_046072";
 ...
 */
@Slf4j
public class Idea46072Service {
    private static final int IDEA_ID = 46072;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46072Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46072Service() {
        this(new Idea46072Config());
    }

    public Idea46072Service(Idea46072Config config) {
        this.config = config != null ? config : new Idea46072Config();
