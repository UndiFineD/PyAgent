...
@Data
public class Idea45870Config {
    private String name = "idea_045870";
 ...
 */
@Slf4j
public class Idea45870Service {
    private static final int IDEA_ID = 45870;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45870Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45870Service() {
        this(new Idea45870Config());
    }

    public Idea45870Service(Idea45870Config config) {
        this.config = config != null ? config : new Idea45870Config();
