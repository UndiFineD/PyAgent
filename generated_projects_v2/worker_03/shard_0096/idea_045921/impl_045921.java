...
@Data
public class Idea45921Config {
    private String name = "idea_045921";
 ...
 */
@Slf4j
public class Idea45921Service {
    private static final int IDEA_ID = 45921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45921Service() {
        this(new Idea45921Config());
    }

    public Idea45921Service(Idea45921Config config) {
        this.config = config != null ? config : new Idea45921Config();
