...
@Data
public class Idea45964Config {
    private String name = "idea_045964";
 ...
 */
@Slf4j
public class Idea45964Service {
    private static final int IDEA_ID = 45964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45964Service() {
        this(new Idea45964Config());
    }

    public Idea45964Service(Idea45964Config config) {
        this.config = config != null ? config : new Idea45964Config();
