...
@Data
public class Idea45751Config {
    private String name = "idea_045751";
 ...
 */
@Slf4j
public class Idea45751Service {
    private static final int IDEA_ID = 45751;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45751Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45751Service() {
        this(new Idea45751Config());
    }

    public Idea45751Service(Idea45751Config config) {
        this.config = config != null ? config : new Idea45751Config();
