...
@Data
public class Idea45723Config {
    private String name = "idea_045723";
 ...
 */
@Slf4j
public class Idea45723Service {
    private static final int IDEA_ID = 45723;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45723Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45723Service() {
        this(new Idea45723Config());
    }

    public Idea45723Service(Idea45723Config config) {
        this.config = config != null ? config : new Idea45723Config();
