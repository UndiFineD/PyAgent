...
@Data
public class Idea45736Config {
    private String name = "idea_045736";
 ...
 */
@Slf4j
public class Idea45736Service {
    private static final int IDEA_ID = 45736;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45736Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45736Service() {
        this(new Idea45736Config());
    }

    public Idea45736Service(Idea45736Config config) {
        this.config = config != null ? config : new Idea45736Config();
