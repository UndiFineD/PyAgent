...
@Data
public class Idea45674Config {
    private String name = "idea_045674";
 ...
 */
@Slf4j
public class Idea45674Service {
    private static final int IDEA_ID = 45674;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45674Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45674Service() {
        this(new Idea45674Config());
    }

    public Idea45674Service(Idea45674Config config) {
        this.config = config != null ? config : new Idea45674Config();
