...
@Data
public class Idea45773Config {
    private String name = "idea_045773";
 ...
 */
@Slf4j
public class Idea45773Service {
    private static final int IDEA_ID = 45773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45773Service() {
        this(new Idea45773Config());
    }

    public Idea45773Service(Idea45773Config config) {
        this.config = config != null ? config : new Idea45773Config();
