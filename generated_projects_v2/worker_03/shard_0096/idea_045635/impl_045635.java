...
@Data
public class Idea45635Config {
    private String name = "idea_045635";
 ...
 */
@Slf4j
public class Idea45635Service {
    private static final int IDEA_ID = 45635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45635Service() {
        this(new Idea45635Config());
    }

    public Idea45635Service(Idea45635Config config) {
        this.config = config != null ? config : new Idea45635Config();
