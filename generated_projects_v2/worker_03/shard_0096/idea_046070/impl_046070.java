...
@Data
public class Idea46070Config {
    private String name = "idea_046070";
 ...
 */
@Slf4j
public class Idea46070Service {
    private static final int IDEA_ID = 46070;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46070Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46070Service() {
        this(new Idea46070Config());
    }

    public Idea46070Service(Idea46070Config config) {
        this.config = config != null ? config : new Idea46070Config();
