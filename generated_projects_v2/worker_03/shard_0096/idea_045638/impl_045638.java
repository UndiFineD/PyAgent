...
@Data
public class Idea45638Config {
    private String name = "idea_045638";
 ...
 */
@Slf4j
public class Idea45638Service {
    private static final int IDEA_ID = 45638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45638Service() {
        this(new Idea45638Config());
    }

    public Idea45638Service(Idea45638Config config) {
        this.config = config != null ? config : new Idea45638Config();
