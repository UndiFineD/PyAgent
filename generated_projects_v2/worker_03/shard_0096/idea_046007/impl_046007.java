...
@Data
public class Idea46007Config {
    private String name = "idea_046007";
 ...
 */
@Slf4j
public class Idea46007Service {
    private static final int IDEA_ID = 46007;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46007Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46007Service() {
        this(new Idea46007Config());
    }

    public Idea46007Service(Idea46007Config config) {
        this.config = config != null ? config : new Idea46007Config();
