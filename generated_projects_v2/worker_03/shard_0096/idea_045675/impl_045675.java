...
@Data
public class Idea45675Config {
    private String name = "idea_045675";
 ...
 */
@Slf4j
public class Idea45675Service {
    private static final int IDEA_ID = 45675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45675Service() {
        this(new Idea45675Config());
    }

    public Idea45675Service(Idea45675Config config) {
        this.config = config != null ? config : new Idea45675Config();
