...
@Data
public class Idea45670Config {
    private String name = "idea_045670";
 ...
 */
@Slf4j
public class Idea45670Service {
    private static final int IDEA_ID = 45670;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45670Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45670Service() {
        this(new Idea45670Config());
    }

    public Idea45670Service(Idea45670Config config) {
        this.config = config != null ? config : new Idea45670Config();
