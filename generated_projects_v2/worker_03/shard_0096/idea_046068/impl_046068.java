...
@Data
public class Idea46068Config {
    private String name = "idea_046068";
 ...
 */
@Slf4j
public class Idea46068Service {
    private static final int IDEA_ID = 46068;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46068Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46068Service() {
        this(new Idea46068Config());
    }

    public Idea46068Service(Idea46068Config config) {
        this.config = config != null ? config : new Idea46068Config();
