...
@Data
public class Idea45711Config {
    private String name = "idea_045711";
 ...
 */
@Slf4j
public class Idea45711Service {
    private static final int IDEA_ID = 45711;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45711Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45711Service() {
        this(new Idea45711Config());
    }

    public Idea45711Service(Idea45711Config config) {
        this.config = config != null ? config : new Idea45711Config();
