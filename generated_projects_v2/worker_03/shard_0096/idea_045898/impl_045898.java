...
@Data
public class Idea45898Config {
    private String name = "idea_045898";
 ...
 */
@Slf4j
public class Idea45898Service {
    private static final int IDEA_ID = 45898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45898Service() {
        this(new Idea45898Config());
    }

    public Idea45898Service(Idea45898Config config) {
        this.config = config != null ? config : new Idea45898Config();
