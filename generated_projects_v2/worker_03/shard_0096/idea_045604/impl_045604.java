...
@Data
public class Idea45604Config {
    private String name = "idea_045604";
 ...
 */
@Slf4j
public class Idea45604Service {
    private static final int IDEA_ID = 45604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45604Service() {
        this(new Idea45604Config());
    }

    public Idea45604Service(Idea45604Config config) {
        this.config = config != null ? config : new Idea45604Config();
