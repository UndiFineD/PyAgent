...
@Data
public class Idea45915Config {
    private String name = "idea_045915";
 ...
 */
@Slf4j
public class Idea45915Service {
    private static final int IDEA_ID = 45915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45915Service() {
        this(new Idea45915Config());
    }

    public Idea45915Service(Idea45915Config config) {
        this.config = config != null ? config : new Idea45915Config();
