...
@Data
public class Idea45869Config {
    private String name = "idea_045869";
 ...
 */
@Slf4j
public class Idea45869Service {
    private static final int IDEA_ID = 45869;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45869Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45869Service() {
        this(new Idea45869Config());
    }

    public Idea45869Service(Idea45869Config config) {
        this.config = config != null ? config : new Idea45869Config();
