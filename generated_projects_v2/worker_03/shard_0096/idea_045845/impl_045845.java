...
@Data
public class Idea45845Config {
    private String name = "idea_045845";
 ...
 */
@Slf4j
public class Idea45845Service {
    private static final int IDEA_ID = 45845;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45845Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45845Service() {
        this(new Idea45845Config());
    }

    public Idea45845Service(Idea45845Config config) {
        this.config = config != null ? config : new Idea45845Config();
