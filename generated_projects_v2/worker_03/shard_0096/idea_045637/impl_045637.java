...
@Data
public class Idea45637Config {
    private String name = "idea_045637";
 ...
 */
@Slf4j
public class Idea45637Service {
    private static final int IDEA_ID = 45637;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45637Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45637Service() {
        this(new Idea45637Config());
    }

    public Idea45637Service(Idea45637Config config) {
        this.config = config != null ? config : new Idea45637Config();
