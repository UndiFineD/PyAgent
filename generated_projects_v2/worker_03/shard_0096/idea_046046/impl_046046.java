...
@Data
public class Idea46046Config {
    private String name = "idea_046046";
 ...
 */
@Slf4j
public class Idea46046Service {
    private static final int IDEA_ID = 46046;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46046Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46046Service() {
        this(new Idea46046Config());
    }

    public Idea46046Service(Idea46046Config config) {
        this.config = config != null ? config : new Idea46046Config();
