...
@Data
public class Idea45602Config {
    private String name = "idea_045602";
 ...
 */
@Slf4j
public class Idea45602Service {
    private static final int IDEA_ID = 45602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45602Service() {
        this(new Idea45602Config());
    }

    public Idea45602Service(Idea45602Config config) {
        this.config = config != null ? config : new Idea45602Config();
