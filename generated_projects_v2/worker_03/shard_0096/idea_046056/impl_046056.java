...
@Data
public class Idea46056Config {
    private String name = "idea_046056";
 ...
 */
@Slf4j
public class Idea46056Service {
    private static final int IDEA_ID = 46056;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46056Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46056Service() {
        this(new Idea46056Config());
    }

    public Idea46056Service(Idea46056Config config) {
        this.config = config != null ? config : new Idea46056Config();
