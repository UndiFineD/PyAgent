...
@Data
public class Idea45897Config {
    private String name = "idea_045897";
 ...
 */
@Slf4j
public class Idea45897Service {
    private static final int IDEA_ID = 45897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45897Service() {
        this(new Idea45897Config());
    }

    public Idea45897Service(Idea45897Config config) {
        this.config = config != null ? config : new Idea45897Config();
