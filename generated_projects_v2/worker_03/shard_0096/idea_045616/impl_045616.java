...
@Data
public class Idea45616Config {
    private String name = "idea_045616";
 ...
 */
@Slf4j
public class Idea45616Service {
    private static final int IDEA_ID = 45616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45616Service() {
        this(new Idea45616Config());
    }

    public Idea45616Service(Idea45616Config config) {
        this.config = config != null ? config : new Idea45616Config();
