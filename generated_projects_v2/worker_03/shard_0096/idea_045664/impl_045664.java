...
@Data
public class Idea45664Config {
    private String name = "idea_045664";
 ...
 */
@Slf4j
public class Idea45664Service {
    private static final int IDEA_ID = 45664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45664Service() {
        this(new Idea45664Config());
    }

    public Idea45664Service(Idea45664Config config) {
        this.config = config != null ? config : new Idea45664Config();
