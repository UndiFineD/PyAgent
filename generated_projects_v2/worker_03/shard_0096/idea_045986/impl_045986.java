...
@Data
public class Idea45986Config {
    private String name = "idea_045986";
 ...
 */
@Slf4j
public class Idea45986Service {
    private static final int IDEA_ID = 45986;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45986Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45986Service() {
        this(new Idea45986Config());
    }

    public Idea45986Service(Idea45986Config config) {
        this.config = config != null ? config : new Idea45986Config();
