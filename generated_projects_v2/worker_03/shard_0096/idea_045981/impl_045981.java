...
@Data
public class Idea45981Config {
    private String name = "idea_045981";
 ...
 */
@Slf4j
public class Idea45981Service {
    private static final int IDEA_ID = 45981;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45981Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45981Service() {
        this(new Idea45981Config());
    }

    public Idea45981Service(Idea45981Config config) {
        this.config = config != null ? config : new Idea45981Config();
