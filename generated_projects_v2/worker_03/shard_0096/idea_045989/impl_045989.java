...
@Data
public class Idea45989Config {
    private String name = "idea_045989";
 ...
 */
@Slf4j
public class Idea45989Service {
    private static final int IDEA_ID = 45989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45989Service() {
        this(new Idea45989Config());
    }

    public Idea45989Service(Idea45989Config config) {
        this.config = config != null ? config : new Idea45989Config();
