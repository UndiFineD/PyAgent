...
@Data
public class Idea46041Config {
    private String name = "idea_046041";
 ...
 */
@Slf4j
public class Idea46041Service {
    private static final int IDEA_ID = 46041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46041Service() {
        this(new Idea46041Config());
    }

    public Idea46041Service(Idea46041Config config) {
        this.config = config != null ? config : new Idea46041Config();
