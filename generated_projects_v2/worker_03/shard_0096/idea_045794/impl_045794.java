...
@Data
public class Idea45794Config {
    private String name = "idea_045794";
 ...
 */
@Slf4j
public class Idea45794Service {
    private static final int IDEA_ID = 45794;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45794Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45794Service() {
        this(new Idea45794Config());
    }

    public Idea45794Service(Idea45794Config config) {
        this.config = config != null ? config : new Idea45794Config();
