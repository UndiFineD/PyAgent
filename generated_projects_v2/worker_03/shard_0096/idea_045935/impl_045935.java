...
@Data
public class Idea45935Config {
    private String name = "idea_045935";
 ...
 */
@Slf4j
public class Idea45935Service {
    private static final int IDEA_ID = 45935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45935Service() {
        this(new Idea45935Config());
    }

    public Idea45935Service(Idea45935Config config) {
        this.config = config != null ? config : new Idea45935Config();
