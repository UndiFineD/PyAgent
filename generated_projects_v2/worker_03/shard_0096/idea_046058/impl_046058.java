...
@Data
public class Idea46058Config {
    private String name = "idea_046058";
 ...
 */
@Slf4j
public class Idea46058Service {
    private static final int IDEA_ID = 46058;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46058Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46058Service() {
        this(new Idea46058Config());
    }

    public Idea46058Service(Idea46058Config config) {
        this.config = config != null ? config : new Idea46058Config();
