...
@Data
public class Idea45760Config {
    private String name = "idea_045760";
 ...
 */
@Slf4j
public class Idea45760Service {
    private static final int IDEA_ID = 45760;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45760Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45760Service() {
        this(new Idea45760Config());
    }

    public Idea45760Service(Idea45760Config config) {
        this.config = config != null ? config : new Idea45760Config();
