...
@Data
public class Idea45756Config {
    private String name = "idea_045756";
 ...
 */
@Slf4j
public class Idea45756Service {
    private static final int IDEA_ID = 45756;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45756Service() {
        this(new Idea45756Config());
    }

    public Idea45756Service(Idea45756Config config) {
        this.config = config != null ? config : new Idea45756Config();
