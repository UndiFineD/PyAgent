...
@Data
public class Idea45951Config {
    private String name = "idea_045951";
 ...
 */
@Slf4j
public class Idea45951Service {
    private static final int IDEA_ID = 45951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45951Service() {
        this(new Idea45951Config());
    }

    public Idea45951Service(Idea45951Config config) {
        this.config = config != null ? config : new Idea45951Config();
