...
@Data
public class Idea45910Config {
    private String name = "idea_045910";
 ...
 */
@Slf4j
public class Idea45910Service {
    private static final int IDEA_ID = 45910;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45910Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45910Service() {
        this(new Idea45910Config());
    }

    public Idea45910Service(Idea45910Config config) {
        this.config = config != null ? config : new Idea45910Config();
