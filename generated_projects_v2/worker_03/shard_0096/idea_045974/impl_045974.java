...
@Data
public class Idea45974Config {
    private String name = "idea_045974";
 ...
 */
@Slf4j
public class Idea45974Service {
    private static final int IDEA_ID = 45974;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45974Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45974Service() {
        this(new Idea45974Config());
    }

    public Idea45974Service(Idea45974Config config) {
        this.config = config != null ? config : new Idea45974Config();
