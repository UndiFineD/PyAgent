...
@Data
public class Idea45925Config {
    private String name = "idea_045925";
 ...
 */
@Slf4j
public class Idea45925Service {
    private static final int IDEA_ID = 45925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45925Service() {
        this(new Idea45925Config());
    }

    public Idea45925Service(Idea45925Config config) {
        this.config = config != null ? config : new Idea45925Config();
