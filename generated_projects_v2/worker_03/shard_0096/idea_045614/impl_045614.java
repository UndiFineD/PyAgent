...
@Data
public class Idea45614Config {
    private String name = "idea_045614";
 ...
 */
@Slf4j
public class Idea45614Service {
    private static final int IDEA_ID = 45614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45614Service() {
        this(new Idea45614Config());
    }

    public Idea45614Service(Idea45614Config config) {
        this.config = config != null ? config : new Idea45614Config();
