...
@Data
public class Idea45738Config {
    private String name = "idea_045738";
 ...
 */
@Slf4j
public class Idea45738Service {
    private static final int IDEA_ID = 45738;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45738Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45738Service() {
        this(new Idea45738Config());
    }

    public Idea45738Service(Idea45738Config config) {
        this.config = config != null ? config : new Idea45738Config();
