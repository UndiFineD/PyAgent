...
@Data
public class Idea45907Config {
    private String name = "idea_045907";
 ...
 */
@Slf4j
public class Idea45907Service {
    private static final int IDEA_ID = 45907;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45907Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45907Service() {
        this(new Idea45907Config());
    }

    public Idea45907Service(Idea45907Config config) {
        this.config = config != null ? config : new Idea45907Config();
