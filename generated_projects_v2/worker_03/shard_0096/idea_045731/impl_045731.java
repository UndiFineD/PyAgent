...
@Data
public class Idea45731Config {
    private String name = "idea_045731";
 ...
 */
@Slf4j
public class Idea45731Service {
    private static final int IDEA_ID = 45731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45731Service() {
        this(new Idea45731Config());
    }

    public Idea45731Service(Idea45731Config config) {
        this.config = config != null ? config : new Idea45731Config();
