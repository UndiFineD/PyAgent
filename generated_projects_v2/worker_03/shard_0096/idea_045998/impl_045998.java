...
@Data
public class Idea45998Config {
    private String name = "idea_045998";
 ...
 */
@Slf4j
public class Idea45998Service {
    private static final int IDEA_ID = 45998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45998Service() {
        this(new Idea45998Config());
    }

    public Idea45998Service(Idea45998Config config) {
        this.config = config != null ? config : new Idea45998Config();
