...
@Data
public class Idea45797Config {
    private String name = "idea_045797";
 ...
 */
@Slf4j
public class Idea45797Service {
    private static final int IDEA_ID = 45797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45797Service() {
        this(new Idea45797Config());
    }

    public Idea45797Service(Idea45797Config config) {
        this.config = config != null ? config : new Idea45797Config();
