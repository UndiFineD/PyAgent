...
@Data
public class Idea46012Config {
    private String name = "idea_046012";
 ...
 */
@Slf4j
public class Idea46012Service {
    private static final int IDEA_ID = 46012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46012Service() {
        this(new Idea46012Config());
    }

    public Idea46012Service(Idea46012Config config) {
        this.config = config != null ? config : new Idea46012Config();
