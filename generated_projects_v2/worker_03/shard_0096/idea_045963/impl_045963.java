...
@Data
public class Idea45963Config {
    private String name = "idea_045963";
 ...
 */
@Slf4j
public class Idea45963Service {
    private static final int IDEA_ID = 45963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45963Service() {
        this(new Idea45963Config());
    }

    public Idea45963Service(Idea45963Config config) {
        this.config = config != null ? config : new Idea45963Config();
