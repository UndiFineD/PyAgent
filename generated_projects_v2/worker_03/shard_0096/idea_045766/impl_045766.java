...
@Data
public class Idea45766Config {
    private String name = "idea_045766";
 ...
 */
@Slf4j
public class Idea45766Service {
    private static final int IDEA_ID = 45766;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45766Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45766Service() {
        this(new Idea45766Config());
    }

    public Idea45766Service(Idea45766Config config) {
        this.config = config != null ? config : new Idea45766Config();
