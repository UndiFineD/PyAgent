...
@Data
public class Idea45787Config {
    private String name = "idea_045787";
 ...
 */
@Slf4j
public class Idea45787Service {
    private static final int IDEA_ID = 45787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45787Service() {
        this(new Idea45787Config());
    }

    public Idea45787Service(Idea45787Config config) {
        this.config = config != null ? config : new Idea45787Config();
