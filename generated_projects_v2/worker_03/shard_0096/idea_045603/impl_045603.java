...
@Data
public class Idea45603Config {
    private String name = "idea_045603";
 ...
 */
@Slf4j
public class Idea45603Service {
    private static final int IDEA_ID = 45603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45603Service() {
        this(new Idea45603Config());
    }

    public Idea45603Service(Idea45603Config config) {
        this.config = config != null ? config : new Idea45603Config();
