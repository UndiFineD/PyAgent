...
@Data
public class Idea45883Config {
    private String name = "idea_045883";
 ...
 */
@Slf4j
public class Idea45883Service {
    private static final int IDEA_ID = 45883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45883Service() {
        this(new Idea45883Config());
    }

    public Idea45883Service(Idea45883Config config) {
        this.config = config != null ? config : new Idea45883Config();
