...
@Data
public class Idea45744Config {
    private String name = "idea_045744";
 ...
 */
@Slf4j
public class Idea45744Service {
    private static final int IDEA_ID = 45744;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45744Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45744Service() {
        this(new Idea45744Config());
    }

    public Idea45744Service(Idea45744Config config) {
        this.config = config != null ? config : new Idea45744Config();
