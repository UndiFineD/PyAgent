...
@Data
public class Idea45838Config {
    private String name = "idea_045838";
 ...
 */
@Slf4j
public class Idea45838Service {
    private static final int IDEA_ID = 45838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45838Service() {
        this(new Idea45838Config());
    }

    public Idea45838Service(Idea45838Config config) {
        this.config = config != null ? config : new Idea45838Config();
