...
@Data
public class Idea45713Config {
    private String name = "idea_045713";
 ...
 */
@Slf4j
public class Idea45713Service {
    private static final int IDEA_ID = 45713;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45713Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45713Service() {
        this(new Idea45713Config());
    }

    public Idea45713Service(Idea45713Config config) {
        this.config = config != null ? config : new Idea45713Config();
