...
@Data
public class Idea45634Config {
    private String name = "idea_045634";
 ...
 */
@Slf4j
public class Idea45634Service {
    private static final int IDEA_ID = 45634;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45634Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45634Service() {
        this(new Idea45634Config());
    }

    public Idea45634Service(Idea45634Config config) {
        this.config = config != null ? config : new Idea45634Config();
