...
@Data
public class Idea45679Config {
    private String name = "idea_045679";
 ...
 */
@Slf4j
public class Idea45679Service {
    private static final int IDEA_ID = 45679;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45679Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45679Service() {
        this(new Idea45679Config());
    }

    public Idea45679Service(Idea45679Config config) {
        this.config = config != null ? config : new Idea45679Config();
