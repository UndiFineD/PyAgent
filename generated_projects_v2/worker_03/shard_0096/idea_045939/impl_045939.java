...
@Data
public class Idea45939Config {
    private String name = "idea_045939";
 ...
 */
@Slf4j
public class Idea45939Service {
    private static final int IDEA_ID = 45939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45939Service() {
        this(new Idea45939Config());
    }

    public Idea45939Service(Idea45939Config config) {
        this.config = config != null ? config : new Idea45939Config();
