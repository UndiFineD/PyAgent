...
@Data
public class Idea45846Config {
    private String name = "idea_045846";
 ...
 */
@Slf4j
public class Idea45846Service {
    private static final int IDEA_ID = 45846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45846Service() {
        this(new Idea45846Config());
    }

    public Idea45846Service(Idea45846Config config) {
        this.config = config != null ? config : new Idea45846Config();
