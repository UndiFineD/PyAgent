...
@Data
public class Idea45841Config {
    private String name = "idea_045841";
 ...
 */
@Slf4j
public class Idea45841Service {
    private static final int IDEA_ID = 45841;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45841Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45841Service() {
        this(new Idea45841Config());
    }

    public Idea45841Service(Idea45841Config config) {
        this.config = config != null ? config : new Idea45841Config();
