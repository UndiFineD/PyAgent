...
@Data
public class Idea45905Config {
    private String name = "idea_045905";
 ...
 */
@Slf4j
public class Idea45905Service {
    private static final int IDEA_ID = 45905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45905Service() {
        this(new Idea45905Config());
    }

    public Idea45905Service(Idea45905Config config) {
        this.config = config != null ? config : new Idea45905Config();
