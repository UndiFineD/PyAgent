...
@Data
public class Idea45725Config {
    private String name = "idea_045725";
 ...
 */
@Slf4j
public class Idea45725Service {
    private static final int IDEA_ID = 45725;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45725Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45725Service() {
        this(new Idea45725Config());
    }

    public Idea45725Service(Idea45725Config config) {
        this.config = config != null ? config : new Idea45725Config();
