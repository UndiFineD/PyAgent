...
@Data
public class Idea46064Config {
    private String name = "idea_046064";
 ...
 */
@Slf4j
public class Idea46064Service {
    private static final int IDEA_ID = 46064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea46064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea46064Service() {
        this(new Idea46064Config());
    }

    public Idea46064Service(Idea46064Config config) {
        this.config = config != null ? config : new Idea46064Config();
