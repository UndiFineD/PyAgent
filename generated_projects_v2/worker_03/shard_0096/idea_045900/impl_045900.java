...
@Data
public class Idea45900Config {
    private String name = "idea_045900";
 ...
 */
@Slf4j
public class Idea45900Service {
    private static final int IDEA_ID = 45900;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea45900Config config;
    private final Map<String, ProcessResult> cache;

    public Idea45900Service() {
        this(new Idea45900Config());
    }

    public Idea45900Service(Idea45900Config config) {
        this.config = config != null ? config : new Idea45900Config();
