...
@Data
public class Idea43621Config {
    private String name = "idea_043621";
 ...
 */
@Slf4j
public class Idea43621Service {
    private static final int IDEA_ID = 43621;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43621Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43621Service() {
        this(new Idea43621Config());
    }

    public Idea43621Service(Idea43621Config config) {
        this.config = config != null ? config : new Idea43621Config();
