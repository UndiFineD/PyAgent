...
@Data
public class Idea43321Config {
    private String name = "idea_043321";
 ...
 */
@Slf4j
public class Idea43321Service {
    private static final int IDEA_ID = 43321;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43321Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43321Service() {
        this(new Idea43321Config());
    }

    public Idea43321Service(Idea43321Config config) {
        this.config = config != null ? config : new Idea43321Config();
