...
@Data
public class Idea43410Config {
    private String name = "idea_043410";
 ...
 */
@Slf4j
public class Idea43410Service {
    private static final int IDEA_ID = 43410;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43410Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43410Service() {
        this(new Idea43410Config());
    }

    public Idea43410Service(Idea43410Config config) {
        this.config = config != null ? config : new Idea43410Config();
