...
@Data
public class Idea43340Config {
    private String name = "idea_043340";
 ...
 */
@Slf4j
public class Idea43340Service {
    private static final int IDEA_ID = 43340;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43340Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43340Service() {
        this(new Idea43340Config());
    }

    public Idea43340Service(Idea43340Config config) {
        this.config = config != null ? config : new Idea43340Config();
