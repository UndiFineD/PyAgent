...
@Data
public class Idea43272Config {
    private String name = "idea_043272";
 ...
 */
@Slf4j
public class Idea43272Service {
    private static final int IDEA_ID = 43272;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43272Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43272Service() {
        this(new Idea43272Config());
    }

    public Idea43272Service(Idea43272Config config) {
        this.config = config != null ? config : new Idea43272Config();
