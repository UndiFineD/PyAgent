...
@Data
public class Idea43528Config {
    private String name = "idea_043528";
 ...
 */
@Slf4j
public class Idea43528Service {
    private static final int IDEA_ID = 43528;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43528Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43528Service() {
        this(new Idea43528Config());
    }

    public Idea43528Service(Idea43528Config config) {
        this.config = config != null ? config : new Idea43528Config();
