...
@Data
public class Idea43259Config {
    private String name = "idea_043259";
 ...
 */
@Slf4j
public class Idea43259Service {
    private static final int IDEA_ID = 43259;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43259Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43259Service() {
        this(new Idea43259Config());
    }

    public Idea43259Service(Idea43259Config config) {
        this.config = config != null ? config : new Idea43259Config();
