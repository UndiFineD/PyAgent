...
@Data
public class Idea43382Config {
    private String name = "idea_043382";
 ...
 */
@Slf4j
public class Idea43382Service {
    private static final int IDEA_ID = 43382;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43382Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43382Service() {
        this(new Idea43382Config());
    }

    public Idea43382Service(Idea43382Config config) {
        this.config = config != null ? config : new Idea43382Config();
