...
@Data
public class Idea43248Config {
    private String name = "idea_043248";
 ...
 */
@Slf4j
public class Idea43248Service {
    private static final int IDEA_ID = 43248;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43248Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43248Service() {
        this(new Idea43248Config());
    }

    public Idea43248Service(Idea43248Config config) {
        this.config = config != null ? config : new Idea43248Config();
