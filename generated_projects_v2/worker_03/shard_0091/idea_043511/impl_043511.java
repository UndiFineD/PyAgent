...
@Data
public class Idea43511Config {
    private String name = "idea_043511";
 ...
 */
@Slf4j
public class Idea43511Service {
    private static final int IDEA_ID = 43511;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43511Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43511Service() {
        this(new Idea43511Config());
    }

    public Idea43511Service(Idea43511Config config) {
        this.config = config != null ? config : new Idea43511Config();
