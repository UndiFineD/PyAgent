...
@Data
public class Idea43309Config {
    private String name = "idea_043309";
 ...
 */
@Slf4j
public class Idea43309Service {
    private static final int IDEA_ID = 43309;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43309Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43309Service() {
        this(new Idea43309Config());
    }

    public Idea43309Service(Idea43309Config config) {
        this.config = config != null ? config : new Idea43309Config();
