...
@Data
public class Idea43318Config {
    private String name = "idea_043318";
 ...
 */
@Slf4j
public class Idea43318Service {
    private static final int IDEA_ID = 43318;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43318Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43318Service() {
        this(new Idea43318Config());
    }

    public Idea43318Service(Idea43318Config config) {
        this.config = config != null ? config : new Idea43318Config();
