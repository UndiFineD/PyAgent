...
@Data
public class Idea43375Config {
    private String name = "idea_043375";
 ...
 */
@Slf4j
public class Idea43375Service {
    private static final int IDEA_ID = 43375;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43375Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43375Service() {
        this(new Idea43375Config());
    }

    public Idea43375Service(Idea43375Config config) {
        this.config = config != null ? config : new Idea43375Config();
