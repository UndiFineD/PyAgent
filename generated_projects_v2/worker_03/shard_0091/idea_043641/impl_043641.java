...
@Data
public class Idea43641Config {
    private String name = "idea_043641";
 ...
 */
@Slf4j
public class Idea43641Service {
    private static final int IDEA_ID = 43641;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43641Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43641Service() {
        this(new Idea43641Config());
    }

    public Idea43641Service(Idea43641Config config) {
        this.config = config != null ? config : new Idea43641Config();
