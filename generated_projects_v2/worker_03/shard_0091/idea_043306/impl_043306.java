...
@Data
public class Idea43306Config {
    private String name = "idea_043306";
 ...
 */
@Slf4j
public class Idea43306Service {
    private static final int IDEA_ID = 43306;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43306Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43306Service() {
        this(new Idea43306Config());
    }

    public Idea43306Service(Idea43306Config config) {
        this.config = config != null ? config : new Idea43306Config();
