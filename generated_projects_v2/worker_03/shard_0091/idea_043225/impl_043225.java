...
@Data
public class Idea43225Config {
    private String name = "idea_043225";
 ...
 */
@Slf4j
public class Idea43225Service {
    private static final int IDEA_ID = 43225;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43225Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43225Service() {
        this(new Idea43225Config());
    }

    public Idea43225Service(Idea43225Config config) {
        this.config = config != null ? config : new Idea43225Config();
