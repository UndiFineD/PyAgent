...
@Data
public class Idea43487Config {
    private String name = "idea_043487";
 ...
 */
@Slf4j
public class Idea43487Service {
    private static final int IDEA_ID = 43487;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43487Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43487Service() {
        this(new Idea43487Config());
    }

    public Idea43487Service(Idea43487Config config) {
        this.config = config != null ? config : new Idea43487Config();
