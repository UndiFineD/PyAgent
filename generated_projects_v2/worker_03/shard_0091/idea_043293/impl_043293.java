...
@Data
public class Idea43293Config {
    private String name = "idea_043293";
 ...
 */
@Slf4j
public class Idea43293Service {
    private static final int IDEA_ID = 43293;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43293Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43293Service() {
        this(new Idea43293Config());
    }

    public Idea43293Service(Idea43293Config config) {
        this.config = config != null ? config : new Idea43293Config();
