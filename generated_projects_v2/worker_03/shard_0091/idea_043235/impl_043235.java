...
@Data
public class Idea43235Config {
    private String name = "idea_043235";
 ...
 */
@Slf4j
public class Idea43235Service {
    private static final int IDEA_ID = 43235;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43235Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43235Service() {
        this(new Idea43235Config());
    }

    public Idea43235Service(Idea43235Config config) {
        this.config = config != null ? config : new Idea43235Config();
