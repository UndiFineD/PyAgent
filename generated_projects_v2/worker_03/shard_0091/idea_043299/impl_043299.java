...
@Data
public class Idea43299Config {
    private String name = "idea_043299";
 ...
 */
@Slf4j
public class Idea43299Service {
    private static final int IDEA_ID = 43299;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43299Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43299Service() {
        this(new Idea43299Config());
    }

    public Idea43299Service(Idea43299Config config) {
        this.config = config != null ? config : new Idea43299Config();
