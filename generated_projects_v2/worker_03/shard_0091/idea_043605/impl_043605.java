...
@Data
public class Idea43605Config {
    private String name = "idea_043605";
 ...
 */
@Slf4j
public class Idea43605Service {
    private static final int IDEA_ID = 43605;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43605Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43605Service() {
        this(new Idea43605Config());
    }

    public Idea43605Service(Idea43605Config config) {
        this.config = config != null ? config : new Idea43605Config();
