...
@Data
public class Idea43411Config {
    private String name = "idea_043411";
 ...
 */
@Slf4j
public class Idea43411Service {
    private static final int IDEA_ID = 43411;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43411Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43411Service() {
        this(new Idea43411Config());
    }

    public Idea43411Service(Idea43411Config config) {
        this.config = config != null ? config : new Idea43411Config();
