...
@Data
public class Idea43645Config {
    private String name = "idea_043645";
 ...
 */
@Slf4j
public class Idea43645Service {
    private static final int IDEA_ID = 43645;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43645Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43645Service() {
        this(new Idea43645Config());
    }

    public Idea43645Service(Idea43645Config config) {
        this.config = config != null ? config : new Idea43645Config();
