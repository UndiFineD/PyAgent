...
@Data
public class Idea43620Config {
    private String name = "idea_043620";
 ...
 */
@Slf4j
public class Idea43620Service {
    private static final int IDEA_ID = 43620;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43620Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43620Service() {
        this(new Idea43620Config());
    }

    public Idea43620Service(Idea43620Config config) {
        this.config = config != null ? config : new Idea43620Config();
