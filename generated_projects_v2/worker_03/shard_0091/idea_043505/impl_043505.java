...
@Data
public class Idea43505Config {
    private String name = "idea_043505";
 ...
 */
@Slf4j
public class Idea43505Service {
    private static final int IDEA_ID = 43505;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43505Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43505Service() {
        this(new Idea43505Config());
    }

    public Idea43505Service(Idea43505Config config) {
        this.config = config != null ? config : new Idea43505Config();
