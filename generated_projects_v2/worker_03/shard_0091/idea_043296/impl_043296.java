...
@Data
public class Idea43296Config {
    private String name = "idea_043296";
 ...
 */
@Slf4j
public class Idea43296Service {
    private static final int IDEA_ID = 43296;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43296Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43296Service() {
        this(new Idea43296Config());
    }

    public Idea43296Service(Idea43296Config config) {
        this.config = config != null ? config : new Idea43296Config();
