...
@Data
public class Idea43391Config {
    private String name = "idea_043391";
 ...
 */
@Slf4j
public class Idea43391Service {
    private static final int IDEA_ID = 43391;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43391Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43391Service() {
        this(new Idea43391Config());
    }

    public Idea43391Service(Idea43391Config config) {
        this.config = config != null ? config : new Idea43391Config();
