...
@Data
public class Idea43655Config {
    private String name = "idea_043655";
 ...
 */
@Slf4j
public class Idea43655Service {
    private static final int IDEA_ID = 43655;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43655Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43655Service() {
        this(new Idea43655Config());
    }

    public Idea43655Service(Idea43655Config config) {
        this.config = config != null ? config : new Idea43655Config();
