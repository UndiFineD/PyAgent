...
@Data
public class Idea43644Config {
    private String name = "idea_043644";
 ...
 */
@Slf4j
public class Idea43644Service {
    private static final int IDEA_ID = 43644;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43644Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43644Service() {
        this(new Idea43644Config());
    }

    public Idea43644Service(Idea43644Config config) {
        this.config = config != null ? config : new Idea43644Config();
