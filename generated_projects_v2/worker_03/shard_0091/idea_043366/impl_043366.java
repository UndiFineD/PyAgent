...
@Data
public class Idea43366Config {
    private String name = "idea_043366";
 ...
 */
@Slf4j
public class Idea43366Service {
    private static final int IDEA_ID = 43366;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43366Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43366Service() {
        this(new Idea43366Config());
    }

    public Idea43366Service(Idea43366Config config) {
        this.config = config != null ? config : new Idea43366Config();
