...
@Data
public class Idea43334Config {
    private String name = "idea_043334";
 ...
 */
@Slf4j
public class Idea43334Service {
    private static final int IDEA_ID = 43334;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43334Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43334Service() {
        this(new Idea43334Config());
    }

    public Idea43334Service(Idea43334Config config) {
        this.config = config != null ? config : new Idea43334Config();
