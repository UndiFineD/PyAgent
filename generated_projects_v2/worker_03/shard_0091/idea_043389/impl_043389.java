...
@Data
public class Idea43389Config {
    private String name = "idea_043389";
 ...
 */
@Slf4j
public class Idea43389Service {
    private static final int IDEA_ID = 43389;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43389Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43389Service() {
        this(new Idea43389Config());
    }

    public Idea43389Service(Idea43389Config config) {
        this.config = config != null ? config : new Idea43389Config();
