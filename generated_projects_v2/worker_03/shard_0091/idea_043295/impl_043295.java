...
@Data
public class Idea43295Config {
    private String name = "idea_043295";
 ...
 */
@Slf4j
public class Idea43295Service {
    private static final int IDEA_ID = 43295;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43295Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43295Service() {
        this(new Idea43295Config());
    }

    public Idea43295Service(Idea43295Config config) {
        this.config = config != null ? config : new Idea43295Config();
