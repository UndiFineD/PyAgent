...
@Data
public class Idea43564Config {
    private String name = "idea_043564";
 ...
 */
@Slf4j
public class Idea43564Service {
    private static final int IDEA_ID = 43564;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43564Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43564Service() {
        this(new Idea43564Config());
    }

    public Idea43564Service(Idea43564Config config) {
        this.config = config != null ? config : new Idea43564Config();
