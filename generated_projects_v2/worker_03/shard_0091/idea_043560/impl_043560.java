...
@Data
public class Idea43560Config {
    private String name = "idea_043560";
 ...
 */
@Slf4j
public class Idea43560Service {
    private static final int IDEA_ID = 43560;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43560Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43560Service() {
        this(new Idea43560Config());
    }

    public Idea43560Service(Idea43560Config config) {
        this.config = config != null ? config : new Idea43560Config();
