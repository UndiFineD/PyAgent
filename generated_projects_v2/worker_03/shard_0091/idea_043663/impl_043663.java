...
@Data
public class Idea43663Config {
    private String name = "idea_043663";
 ...
 */
@Slf4j
public class Idea43663Service {
    private static final int IDEA_ID = 43663;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43663Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43663Service() {
        this(new Idea43663Config());
    }

    public Idea43663Service(Idea43663Config config) {
        this.config = config != null ? config : new Idea43663Config();
