...
@Data
public class Idea43657Config {
    private String name = "idea_043657";
 ...
 */
@Slf4j
public class Idea43657Service {
    private static final int IDEA_ID = 43657;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43657Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43657Service() {
        this(new Idea43657Config());
    }

    public Idea43657Service(Idea43657Config config) {
        this.config = config != null ? config : new Idea43657Config();
