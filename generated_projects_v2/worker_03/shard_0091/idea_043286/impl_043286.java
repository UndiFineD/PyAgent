...
@Data
public class Idea43286Config {
    private String name = "idea_043286";
 ...
 */
@Slf4j
public class Idea43286Service {
    private static final int IDEA_ID = 43286;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43286Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43286Service() {
        this(new Idea43286Config());
    }

    public Idea43286Service(Idea43286Config config) {
        this.config = config != null ? config : new Idea43286Config();
