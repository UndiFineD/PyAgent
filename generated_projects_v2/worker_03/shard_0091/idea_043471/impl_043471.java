...
@Data
public class Idea43471Config {
    private String name = "idea_043471";
 ...
 */
@Slf4j
public class Idea43471Service {
    private static final int IDEA_ID = 43471;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43471Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43471Service() {
        this(new Idea43471Config());
    }

    public Idea43471Service(Idea43471Config config) {
        this.config = config != null ? config : new Idea43471Config();
