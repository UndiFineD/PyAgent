...
@Data
public class Idea43458Config {
    private String name = "idea_043458";
 ...
 */
@Slf4j
public class Idea43458Service {
    private static final int IDEA_ID = 43458;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43458Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43458Service() {
        this(new Idea43458Config());
    }

    public Idea43458Service(Idea43458Config config) {
        this.config = config != null ? config : new Idea43458Config();
