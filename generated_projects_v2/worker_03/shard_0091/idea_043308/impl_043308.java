...
@Data
public class Idea43308Config {
    private String name = "idea_043308";
 ...
 */
@Slf4j
public class Idea43308Service {
    private static final int IDEA_ID = 43308;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43308Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43308Service() {
        this(new Idea43308Config());
    }

    public Idea43308Service(Idea43308Config config) {
        this.config = config != null ? config : new Idea43308Config();
