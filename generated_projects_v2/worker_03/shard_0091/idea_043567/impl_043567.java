...
@Data
public class Idea43567Config {
    private String name = "idea_043567";
 ...
 */
@Slf4j
public class Idea43567Service {
    private static final int IDEA_ID = 43567;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43567Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43567Service() {
        this(new Idea43567Config());
    }

    public Idea43567Service(Idea43567Config config) {
        this.config = config != null ? config : new Idea43567Config();
