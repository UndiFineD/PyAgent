...
@Data
public class Idea43234Config {
    private String name = "idea_043234";
 ...
 */
@Slf4j
public class Idea43234Service {
    private static final int IDEA_ID = 43234;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43234Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43234Service() {
        this(new Idea43234Config());
    }

    public Idea43234Service(Idea43234Config config) {
        this.config = config != null ? config : new Idea43234Config();
