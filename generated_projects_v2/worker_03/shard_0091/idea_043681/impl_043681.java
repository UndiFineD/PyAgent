...
@Data
public class Idea43681Config {
    private String name = "idea_043681";
 ...
 */
@Slf4j
public class Idea43681Service {
    private static final int IDEA_ID = 43681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43681Service() {
        this(new Idea43681Config());
    }

    public Idea43681Service(Idea43681Config config) {
        this.config = config != null ? config : new Idea43681Config();
