...
@Data
public class Idea43649Config {
    private String name = "idea_043649";
 ...
 */
@Slf4j
public class Idea43649Service {
    private static final int IDEA_ID = 43649;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43649Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43649Service() {
        this(new Idea43649Config());
    }

    public Idea43649Service(Idea43649Config config) {
        this.config = config != null ? config : new Idea43649Config();
