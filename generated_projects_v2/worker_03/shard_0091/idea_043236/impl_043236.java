...
@Data
public class Idea43236Config {
    private String name = "idea_043236";
 ...
 */
@Slf4j
public class Idea43236Service {
    private static final int IDEA_ID = 43236;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43236Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43236Service() {
        this(new Idea43236Config());
    }

    public Idea43236Service(Idea43236Config config) {
        this.config = config != null ? config : new Idea43236Config();
