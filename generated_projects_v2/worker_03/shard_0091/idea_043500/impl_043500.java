...
@Data
public class Idea43500Config {
    private String name = "idea_043500";
 ...
 */
@Slf4j
public class Idea43500Service {
    private static final int IDEA_ID = 43500;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43500Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43500Service() {
        this(new Idea43500Config());
    }

    public Idea43500Service(Idea43500Config config) {
        this.config = config != null ? config : new Idea43500Config();
