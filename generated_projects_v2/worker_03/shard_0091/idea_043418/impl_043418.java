...
@Data
public class Idea43418Config {
    private String name = "idea_043418";
 ...
 */
@Slf4j
public class Idea43418Service {
    private static final int IDEA_ID = 43418;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43418Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43418Service() {
        this(new Idea43418Config());
    }

    public Idea43418Service(Idea43418Config config) {
        this.config = config != null ? config : new Idea43418Config();
