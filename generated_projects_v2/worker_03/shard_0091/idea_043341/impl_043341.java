...
@Data
public class Idea43341Config {
    private String name = "idea_043341";
 ...
 */
@Slf4j
public class Idea43341Service {
    private static final int IDEA_ID = 43341;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43341Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43341Service() {
        this(new Idea43341Config());
    }

    public Idea43341Service(Idea43341Config config) {
        this.config = config != null ? config : new Idea43341Config();
