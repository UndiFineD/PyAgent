...
@Data
public class Idea43480Config {
    private String name = "idea_043480";
 ...
 */
@Slf4j
public class Idea43480Service {
    private static final int IDEA_ID = 43480;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43480Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43480Service() {
        this(new Idea43480Config());
    }

    public Idea43480Service(Idea43480Config config) {
        this.config = config != null ? config : new Idea43480Config();
