...
@Data
public class Idea43407Config {
    private String name = "idea_043407";
 ...
 */
@Slf4j
public class Idea43407Service {
    private static final int IDEA_ID = 43407;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43407Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43407Service() {
        this(new Idea43407Config());
    }

    public Idea43407Service(Idea43407Config config) {
        this.config = config != null ? config : new Idea43407Config();
