...
@Data
public class Idea43473Config {
    private String name = "idea_043473";
 ...
 */
@Slf4j
public class Idea43473Service {
    private static final int IDEA_ID = 43473;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43473Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43473Service() {
        this(new Idea43473Config());
    }

    public Idea43473Service(Idea43473Config config) {
        this.config = config != null ? config : new Idea43473Config();
