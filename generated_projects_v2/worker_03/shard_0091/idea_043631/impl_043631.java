...
@Data
public class Idea43631Config {
    private String name = "idea_043631";
 ...
 */
@Slf4j
public class Idea43631Service {
    private static final int IDEA_ID = 43631;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43631Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43631Service() {
        this(new Idea43631Config());
    }

    public Idea43631Service(Idea43631Config config) {
        this.config = config != null ? config : new Idea43631Config();
