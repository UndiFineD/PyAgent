...
@Data
public class Idea43433Config {
    private String name = "idea_043433";
 ...
 */
@Slf4j
public class Idea43433Service {
    private static final int IDEA_ID = 43433;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43433Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43433Service() {
        this(new Idea43433Config());
    }

    public Idea43433Service(Idea43433Config config) {
        this.config = config != null ? config : new Idea43433Config();
