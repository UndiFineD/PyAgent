...
@Data
public class Idea43623Config {
    private String name = "idea_043623";
 ...
 */
@Slf4j
public class Idea43623Service {
    private static final int IDEA_ID = 43623;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43623Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43623Service() {
        this(new Idea43623Config());
    }

    public Idea43623Service(Idea43623Config config) {
        this.config = config != null ? config : new Idea43623Config();
