...
@Data
public class Idea43508Config {
    private String name = "idea_043508";
 ...
 */
@Slf4j
public class Idea43508Service {
    private static final int IDEA_ID = 43508;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43508Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43508Service() {
        this(new Idea43508Config());
    }

    public Idea43508Service(Idea43508Config config) {
        this.config = config != null ? config : new Idea43508Config();
