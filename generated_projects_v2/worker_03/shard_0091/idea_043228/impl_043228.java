...
@Data
public class Idea43228Config {
    private String name = "idea_043228";
 ...
 */
@Slf4j
public class Idea43228Service {
    private static final int IDEA_ID = 43228;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43228Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43228Service() {
        this(new Idea43228Config());
    }

    public Idea43228Service(Idea43228Config config) {
        this.config = config != null ? config : new Idea43228Config();
