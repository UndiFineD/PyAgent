...
@Data
public class Idea43381Config {
    private String name = "idea_043381";
 ...
 */
@Slf4j
public class Idea43381Service {
    private static final int IDEA_ID = 43381;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43381Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43381Service() {
        this(new Idea43381Config());
    }

    public Idea43381Service(Idea43381Config config) {
        this.config = config != null ? config : new Idea43381Config();
