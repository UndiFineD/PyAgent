...
@Data
public class Idea43484Config {
    private String name = "idea_043484";
 ...
 */
@Slf4j
public class Idea43484Service {
    private static final int IDEA_ID = 43484;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43484Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43484Service() {
        this(new Idea43484Config());
    }

    public Idea43484Service(Idea43484Config config) {
        this.config = config != null ? config : new Idea43484Config();
