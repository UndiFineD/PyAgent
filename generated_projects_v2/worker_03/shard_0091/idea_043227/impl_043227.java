...
@Data
public class Idea43227Config {
    private String name = "idea_043227";
 ...
 */
@Slf4j
public class Idea43227Service {
    private static final int IDEA_ID = 43227;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43227Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43227Service() {
        this(new Idea43227Config());
    }

    public Idea43227Service(Idea43227Config config) {
        this.config = config != null ? config : new Idea43227Config();
