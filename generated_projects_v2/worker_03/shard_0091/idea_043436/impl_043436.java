...
@Data
public class Idea43436Config {
    private String name = "idea_043436";
 ...
 */
@Slf4j
public class Idea43436Service {
    private static final int IDEA_ID = 43436;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43436Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43436Service() {
        this(new Idea43436Config());
    }

    public Idea43436Service(Idea43436Config config) {
        this.config = config != null ? config : new Idea43436Config();
