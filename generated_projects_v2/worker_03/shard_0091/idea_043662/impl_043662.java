...
@Data
public class Idea43662Config {
    private String name = "idea_043662";
 ...
 */
@Slf4j
public class Idea43662Service {
    private static final int IDEA_ID = 43662;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43662Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43662Service() {
        this(new Idea43662Config());
    }

    public Idea43662Service(Idea43662Config config) {
        this.config = config != null ? config : new Idea43662Config();
