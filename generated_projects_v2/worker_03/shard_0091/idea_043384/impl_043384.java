...
@Data
public class Idea43384Config {
    private String name = "idea_043384";
 ...
 */
@Slf4j
public class Idea43384Service {
    private static final int IDEA_ID = 43384;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43384Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43384Service() {
        this(new Idea43384Config());
    }

    public Idea43384Service(Idea43384Config config) {
        this.config = config != null ? config : new Idea43384Config();
