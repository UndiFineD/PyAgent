...
@Data
public class Idea43405Config {
    private String name = "idea_043405";
 ...
 */
@Slf4j
public class Idea43405Service {
    private static final int IDEA_ID = 43405;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43405Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43405Service() {
        this(new Idea43405Config());
    }

    public Idea43405Service(Idea43405Config config) {
        this.config = config != null ? config : new Idea43405Config();
