...
@Data
public class Idea43330Config {
    private String name = "idea_043330";
 ...
 */
@Slf4j
public class Idea43330Service {
    private static final int IDEA_ID = 43330;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43330Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43330Service() {
        this(new Idea43330Config());
    }

    public Idea43330Service(Idea43330Config config) {
        this.config = config != null ? config : new Idea43330Config();
