...
@Data
public class Idea43338Config {
    private String name = "idea_043338";
 ...
 */
@Slf4j
public class Idea43338Service {
    private static final int IDEA_ID = 43338;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43338Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43338Service() {
        this(new Idea43338Config());
    }

    public Idea43338Service(Idea43338Config config) {
        this.config = config != null ? config : new Idea43338Config();
