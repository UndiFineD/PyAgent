...
@Data
public class Idea43525Config {
    private String name = "idea_043525";
 ...
 */
@Slf4j
public class Idea43525Service {
    private static final int IDEA_ID = 43525;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43525Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43525Service() {
        this(new Idea43525Config());
    }

    public Idea43525Service(Idea43525Config config) {
        this.config = config != null ? config : new Idea43525Config();
