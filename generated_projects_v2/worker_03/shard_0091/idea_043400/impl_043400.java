...
@Data
public class Idea43400Config {
    private String name = "idea_043400";
 ...
 */
@Slf4j
public class Idea43400Service {
    private static final int IDEA_ID = 43400;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43400Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43400Service() {
        this(new Idea43400Config());
    }

    public Idea43400Service(Idea43400Config config) {
        this.config = config != null ? config : new Idea43400Config();
