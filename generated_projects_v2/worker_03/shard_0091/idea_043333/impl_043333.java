...
@Data
public class Idea43333Config {
    private String name = "idea_043333";
 ...
 */
@Slf4j
public class Idea43333Service {
    private static final int IDEA_ID = 43333;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43333Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43333Service() {
        this(new Idea43333Config());
    }

    public Idea43333Service(Idea43333Config config) {
        this.config = config != null ? config : new Idea43333Config();
