...
@Data
public class Idea43431Config {
    private String name = "idea_043431";
 ...
 */
@Slf4j
public class Idea43431Service {
    private static final int IDEA_ID = 43431;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43431Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43431Service() {
        this(new Idea43431Config());
    }

    public Idea43431Service(Idea43431Config config) {
        this.config = config != null ? config : new Idea43431Config();
