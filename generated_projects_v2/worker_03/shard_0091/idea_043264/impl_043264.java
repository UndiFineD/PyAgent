...
@Data
public class Idea43264Config {
    private String name = "idea_043264";
 ...
 */
@Slf4j
public class Idea43264Service {
    private static final int IDEA_ID = 43264;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43264Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43264Service() {
        this(new Idea43264Config());
    }

    public Idea43264Service(Idea43264Config config) {
        this.config = config != null ? config : new Idea43264Config();
