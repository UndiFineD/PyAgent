...
@Data
public class Idea43421Config {
    private String name = "idea_043421";
 ...
 */
@Slf4j
public class Idea43421Service {
    private static final int IDEA_ID = 43421;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43421Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43421Service() {
        this(new Idea43421Config());
    }

    public Idea43421Service(Idea43421Config config) {
        this.config = config != null ? config : new Idea43421Config();
