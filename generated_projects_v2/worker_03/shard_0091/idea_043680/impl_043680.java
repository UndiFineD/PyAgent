...
@Data
public class Idea43680Config {
    private String name = "idea_043680";
 ...
 */
@Slf4j
public class Idea43680Service {
    private static final int IDEA_ID = 43680;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43680Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43680Service() {
        this(new Idea43680Config());
    }

    public Idea43680Service(Idea43680Config config) {
        this.config = config != null ? config : new Idea43680Config();
