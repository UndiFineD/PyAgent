...
@Data
public class Idea43607Config {
    private String name = "idea_043607";
 ...
 */
@Slf4j
public class Idea43607Service {
    private static final int IDEA_ID = 43607;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43607Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43607Service() {
        this(new Idea43607Config());
    }

    public Idea43607Service(Idea43607Config config) {
        this.config = config != null ? config : new Idea43607Config();
