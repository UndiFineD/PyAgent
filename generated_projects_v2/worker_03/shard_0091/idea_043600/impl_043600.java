...
@Data
public class Idea43600Config {
    private String name = "idea_043600";
 ...
 */
@Slf4j
public class Idea43600Service {
    private static final int IDEA_ID = 43600;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43600Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43600Service() {
        this(new Idea43600Config());
    }

    public Idea43600Service(Idea43600Config config) {
        this.config = config != null ? config : new Idea43600Config();
