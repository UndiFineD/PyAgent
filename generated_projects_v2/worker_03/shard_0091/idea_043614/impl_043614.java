...
@Data
public class Idea43614Config {
    private String name = "idea_043614";
 ...
 */
@Slf4j
public class Idea43614Service {
    private static final int IDEA_ID = 43614;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43614Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43614Service() {
        this(new Idea43614Config());
    }

    public Idea43614Service(Idea43614Config config) {
        this.config = config != null ? config : new Idea43614Config();
