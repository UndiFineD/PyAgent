...
@Data
public class Idea43387Config {
    private String name = "idea_043387";
 ...
 */
@Slf4j
public class Idea43387Service {
    private static final int IDEA_ID = 43387;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43387Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43387Service() {
        this(new Idea43387Config());
    }

    public Idea43387Service(Idea43387Config config) {
        this.config = config != null ? config : new Idea43387Config();
