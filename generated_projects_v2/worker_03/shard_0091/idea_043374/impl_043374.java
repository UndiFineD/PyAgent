...
@Data
public class Idea43374Config {
    private String name = "idea_043374";
 ...
 */
@Slf4j
public class Idea43374Service {
    private static final int IDEA_ID = 43374;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43374Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43374Service() {
        this(new Idea43374Config());
    }

    public Idea43374Service(Idea43374Config config) {
        this.config = config != null ? config : new Idea43374Config();
