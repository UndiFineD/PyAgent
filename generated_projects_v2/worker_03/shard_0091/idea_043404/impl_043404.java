...
@Data
public class Idea43404Config {
    private String name = "idea_043404";
 ...
 */
@Slf4j
public class Idea43404Service {
    private static final int IDEA_ID = 43404;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43404Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43404Service() {
        this(new Idea43404Config());
    }

    public Idea43404Service(Idea43404Config config) {
        this.config = config != null ? config : new Idea43404Config();
