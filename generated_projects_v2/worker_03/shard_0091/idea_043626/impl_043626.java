...
@Data
public class Idea43626Config {
    private String name = "idea_043626";
 ...
 */
@Slf4j
public class Idea43626Service {
    private static final int IDEA_ID = 43626;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43626Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43626Service() {
        this(new Idea43626Config());
    }

    public Idea43626Service(Idea43626Config config) {
        this.config = config != null ? config : new Idea43626Config();
