...
@Data
public class Idea43303Config {
    private String name = "idea_043303";
 ...
 */
@Slf4j
public class Idea43303Service {
    private static final int IDEA_ID = 43303;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43303Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43303Service() {
        this(new Idea43303Config());
    }

    public Idea43303Service(Idea43303Config config) {
        this.config = config != null ? config : new Idea43303Config();
