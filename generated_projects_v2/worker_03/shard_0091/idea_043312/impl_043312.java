...
@Data
public class Idea43312Config {
    private String name = "idea_043312";
 ...
 */
@Slf4j
public class Idea43312Service {
    private static final int IDEA_ID = 43312;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43312Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43312Service() {
        this(new Idea43312Config());
    }

    public Idea43312Service(Idea43312Config config) {
        this.config = config != null ? config : new Idea43312Config();
