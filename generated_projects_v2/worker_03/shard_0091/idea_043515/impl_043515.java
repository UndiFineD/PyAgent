...
@Data
public class Idea43515Config {
    private String name = "idea_043515";
 ...
 */
@Slf4j
public class Idea43515Service {
    private static final int IDEA_ID = 43515;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43515Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43515Service() {
        this(new Idea43515Config());
    }

    public Idea43515Service(Idea43515Config config) {
        this.config = config != null ? config : new Idea43515Config();
