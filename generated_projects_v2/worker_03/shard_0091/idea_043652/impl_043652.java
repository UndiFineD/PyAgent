...
@Data
public class Idea43652Config {
    private String name = "idea_043652";
 ...
 */
@Slf4j
public class Idea43652Service {
    private static final int IDEA_ID = 43652;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43652Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43652Service() {
        this(new Idea43652Config());
    }

    public Idea43652Service(Idea43652Config config) {
        this.config = config != null ? config : new Idea43652Config();
