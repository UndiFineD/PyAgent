...
@Data
public class Idea43639Config {
    private String name = "idea_043639";
 ...
 */
@Slf4j
public class Idea43639Service {
    private static final int IDEA_ID = 43639;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43639Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43639Service() {
        this(new Idea43639Config());
    }

    public Idea43639Service(Idea43639Config config) {
        this.config = config != null ? config : new Idea43639Config();
