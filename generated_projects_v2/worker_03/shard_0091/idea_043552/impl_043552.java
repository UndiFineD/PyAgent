...
@Data
public class Idea43552Config {
    private String name = "idea_043552";
 ...
 */
@Slf4j
public class Idea43552Service {
    private static final int IDEA_ID = 43552;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43552Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43552Service() {
        this(new Idea43552Config());
    }

    public Idea43552Service(Idea43552Config config) {
        this.config = config != null ? config : new Idea43552Config();
