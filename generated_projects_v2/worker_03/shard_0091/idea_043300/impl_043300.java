...
@Data
public class Idea43300Config {
    private String name = "idea_043300";
 ...
 */
@Slf4j
public class Idea43300Service {
    private static final int IDEA_ID = 43300;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43300Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43300Service() {
        this(new Idea43300Config());
    }

    public Idea43300Service(Idea43300Config config) {
        this.config = config != null ? config : new Idea43300Config();
