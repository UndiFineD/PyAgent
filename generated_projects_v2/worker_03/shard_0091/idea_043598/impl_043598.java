...
@Data
public class Idea43598Config {
    private String name = "idea_043598";
 ...
 */
@Slf4j
public class Idea43598Service {
    private static final int IDEA_ID = 43598;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43598Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43598Service() {
        this(new Idea43598Config());
    }

    public Idea43598Service(Idea43598Config config) {
        this.config = config != null ? config : new Idea43598Config();
