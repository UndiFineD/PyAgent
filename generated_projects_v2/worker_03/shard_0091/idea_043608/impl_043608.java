...
@Data
public class Idea43608Config {
    private String name = "idea_043608";
 ...
 */
@Slf4j
public class Idea43608Service {
    private static final int IDEA_ID = 43608;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43608Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43608Service() {
        this(new Idea43608Config());
    }

    public Idea43608Service(Idea43608Config config) {
        this.config = config != null ? config : new Idea43608Config();
