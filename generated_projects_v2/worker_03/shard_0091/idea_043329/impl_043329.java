...
@Data
public class Idea43329Config {
    private String name = "idea_043329";
 ...
 */
@Slf4j
public class Idea43329Service {
    private static final int IDEA_ID = 43329;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43329Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43329Service() {
        this(new Idea43329Config());
    }

    public Idea43329Service(Idea43329Config config) {
        this.config = config != null ? config : new Idea43329Config();
