...
@Data
public class Idea43304Config {
    private String name = "idea_043304";
 ...
 */
@Slf4j
public class Idea43304Service {
    private static final int IDEA_ID = 43304;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43304Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43304Service() {
        this(new Idea43304Config());
    }

    public Idea43304Service(Idea43304Config config) {
        this.config = config != null ? config : new Idea43304Config();
