...
@Data
public class Idea43610Config {
    private String name = "idea_043610";
 ...
 */
@Slf4j
public class Idea43610Service {
    private static final int IDEA_ID = 43610;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43610Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43610Service() {
        this(new Idea43610Config());
    }

    public Idea43610Service(Idea43610Config config) {
        this.config = config != null ? config : new Idea43610Config();
