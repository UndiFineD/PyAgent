...
@Data
public class Idea43597Config {
    private String name = "idea_043597";
 ...
 */
@Slf4j
public class Idea43597Service {
    private static final int IDEA_ID = 43597;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43597Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43597Service() {
        this(new Idea43597Config());
    }

    public Idea43597Service(Idea43597Config config) {
        this.config = config != null ? config : new Idea43597Config();
