...
@Data
public class Idea43648Config {
    private String name = "idea_043648";
 ...
 */
@Slf4j
public class Idea43648Service {
    private static final int IDEA_ID = 43648;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43648Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43648Service() {
        this(new Idea43648Config());
    }

    public Idea43648Service(Idea43648Config config) {
        this.config = config != null ? config : new Idea43648Config();
