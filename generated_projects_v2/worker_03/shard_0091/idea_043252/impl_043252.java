...
@Data
public class Idea43252Config {
    private String name = "idea_043252";
 ...
 */
@Slf4j
public class Idea43252Service {
    private static final int IDEA_ID = 43252;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43252Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43252Service() {
        this(new Idea43252Config());
    }

    public Idea43252Service(Idea43252Config config) {
        this.config = config != null ? config : new Idea43252Config();
