...
@Data
public class Idea43599Config {
    private String name = "idea_043599";
 ...
 */
@Slf4j
public class Idea43599Service {
    private static final int IDEA_ID = 43599;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43599Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43599Service() {
        this(new Idea43599Config());
    }

    public Idea43599Service(Idea43599Config config) {
        this.config = config != null ? config : new Idea43599Config();
