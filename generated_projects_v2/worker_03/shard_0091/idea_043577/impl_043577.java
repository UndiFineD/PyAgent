...
@Data
public class Idea43577Config {
    private String name = "idea_043577";
 ...
 */
@Slf4j
public class Idea43577Service {
    private static final int IDEA_ID = 43577;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43577Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43577Service() {
        this(new Idea43577Config());
    }

    public Idea43577Service(Idea43577Config config) {
        this.config = config != null ? config : new Idea43577Config();
