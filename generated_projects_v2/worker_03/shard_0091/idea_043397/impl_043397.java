...
@Data
public class Idea43397Config {
    private String name = "idea_043397";
 ...
 */
@Slf4j
public class Idea43397Service {
    private static final int IDEA_ID = 43397;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43397Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43397Service() {
        this(new Idea43397Config());
    }

    public Idea43397Service(Idea43397Config config) {
        this.config = config != null ? config : new Idea43397Config();
