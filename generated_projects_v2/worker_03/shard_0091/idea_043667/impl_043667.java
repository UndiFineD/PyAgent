...
@Data
public class Idea43667Config {
    private String name = "idea_043667";
 ...
 */
@Slf4j
public class Idea43667Service {
    private static final int IDEA_ID = 43667;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43667Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43667Service() {
        this(new Idea43667Config());
    }

    public Idea43667Service(Idea43667Config config) {
        this.config = config != null ? config : new Idea43667Config();
