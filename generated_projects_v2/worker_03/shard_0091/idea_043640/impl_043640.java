...
@Data
public class Idea43640Config {
    private String name = "idea_043640";
 ...
 */
@Slf4j
public class Idea43640Service {
    private static final int IDEA_ID = 43640;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43640Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43640Service() {
        this(new Idea43640Config());
    }

    public Idea43640Service(Idea43640Config config) {
        this.config = config != null ? config : new Idea43640Config();
