...
@Data
public class Idea43337Config {
    private String name = "idea_043337";
 ...
 */
@Slf4j
public class Idea43337Service {
    private static final int IDEA_ID = 43337;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43337Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43337Service() {
        this(new Idea43337Config());
    }

    public Idea43337Service(Idea43337Config config) {
        this.config = config != null ? config : new Idea43337Config();
