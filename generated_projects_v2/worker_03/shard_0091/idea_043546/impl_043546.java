...
@Data
public class Idea43546Config {
    private String name = "idea_043546";
 ...
 */
@Slf4j
public class Idea43546Service {
    private static final int IDEA_ID = 43546;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43546Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43546Service() {
        this(new Idea43546Config());
    }

    public Idea43546Service(Idea43546Config config) {
        this.config = config != null ? config : new Idea43546Config();
