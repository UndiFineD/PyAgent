...
@Data
public class Idea43618Config {
    private String name = "idea_043618";
 ...
 */
@Slf4j
public class Idea43618Service {
    private static final int IDEA_ID = 43618;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43618Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43618Service() {
        this(new Idea43618Config());
    }

    public Idea43618Service(Idea43618Config config) {
        this.config = config != null ? config : new Idea43618Config();
