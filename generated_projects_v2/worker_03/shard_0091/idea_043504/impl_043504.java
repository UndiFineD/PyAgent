...
@Data
public class Idea43504Config {
    private String name = "idea_043504";
 ...
 */
@Slf4j
public class Idea43504Service {
    private static final int IDEA_ID = 43504;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43504Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43504Service() {
        this(new Idea43504Config());
    }

    public Idea43504Service(Idea43504Config config) {
        this.config = config != null ? config : new Idea43504Config();
