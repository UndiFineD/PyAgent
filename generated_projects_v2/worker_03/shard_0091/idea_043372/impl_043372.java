...
@Data
public class Idea43372Config {
    private String name = "idea_043372";
 ...
 */
@Slf4j
public class Idea43372Service {
    private static final int IDEA_ID = 43372;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43372Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43372Service() {
        this(new Idea43372Config());
    }

    public Idea43372Service(Idea43372Config config) {
        this.config = config != null ? config : new Idea43372Config();
