...
@Data
public class Idea43307Config {
    private String name = "idea_043307";
 ...
 */
@Slf4j
public class Idea43307Service {
    private static final int IDEA_ID = 43307;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43307Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43307Service() {
        this(new Idea43307Config());
    }

    public Idea43307Service(Idea43307Config config) {
        this.config = config != null ? config : new Idea43307Config();
