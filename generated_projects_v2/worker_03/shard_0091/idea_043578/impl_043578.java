...
@Data
public class Idea43578Config {
    private String name = "idea_043578";
 ...
 */
@Slf4j
public class Idea43578Service {
    private static final int IDEA_ID = 43578;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43578Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43578Service() {
        this(new Idea43578Config());
    }

    public Idea43578Service(Idea43578Config config) {
        this.config = config != null ? config : new Idea43578Config();
