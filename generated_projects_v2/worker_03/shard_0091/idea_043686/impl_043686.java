...
@Data
public class Idea43686Config {
    private String name = "idea_043686";
 ...
 */
@Slf4j
public class Idea43686Service {
    private static final int IDEA_ID = 43686;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43686Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43686Service() {
        this(new Idea43686Config());
    }

    public Idea43686Service(Idea43686Config config) {
        this.config = config != null ? config : new Idea43686Config();
