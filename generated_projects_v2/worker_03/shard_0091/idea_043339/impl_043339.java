...
@Data
public class Idea43339Config {
    private String name = "idea_043339";
 ...
 */
@Slf4j
public class Idea43339Service {
    private static final int IDEA_ID = 43339;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43339Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43339Service() {
        this(new Idea43339Config());
    }

    public Idea43339Service(Idea43339Config config) {
        this.config = config != null ? config : new Idea43339Config();
