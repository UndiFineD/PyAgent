...
@Data
public class Idea43509Config {
    private String name = "idea_043509";
 ...
 */
@Slf4j
public class Idea43509Service {
    private static final int IDEA_ID = 43509;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43509Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43509Service() {
        this(new Idea43509Config());
    }

    public Idea43509Service(Idea43509Config config) {
        this.config = config != null ? config : new Idea43509Config();
