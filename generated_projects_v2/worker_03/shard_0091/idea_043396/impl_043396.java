...
@Data
public class Idea43396Config {
    private String name = "idea_043396";
 ...
 */
@Slf4j
public class Idea43396Service {
    private static final int IDEA_ID = 43396;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43396Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43396Service() {
        this(new Idea43396Config());
    }

    public Idea43396Service(Idea43396Config config) {
        this.config = config != null ? config : new Idea43396Config();
