...
@Data
public class Idea43395Config {
    private String name = "idea_043395";
 ...
 */
@Slf4j
public class Idea43395Service {
    private static final int IDEA_ID = 43395;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43395Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43395Service() {
        this(new Idea43395Config());
    }

    public Idea43395Service(Idea43395Config config) {
        this.config = config != null ? config : new Idea43395Config();
