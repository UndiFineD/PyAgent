...
@Data
public class Idea43510Config {
    private String name = "idea_043510";
 ...
 */
@Slf4j
public class Idea43510Service {
    private static final int IDEA_ID = 43510;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43510Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43510Service() {
        this(new Idea43510Config());
    }

    public Idea43510Service(Idea43510Config config) {
        this.config = config != null ? config : new Idea43510Config();
