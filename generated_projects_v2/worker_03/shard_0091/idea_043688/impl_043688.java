...
@Data
public class Idea43688Config {
    private String name = "idea_043688";
 ...
 */
@Slf4j
public class Idea43688Service {
    private static final int IDEA_ID = 43688;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43688Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43688Service() {
        this(new Idea43688Config());
    }

    public Idea43688Service(Idea43688Config config) {
        this.config = config != null ? config : new Idea43688Config();
