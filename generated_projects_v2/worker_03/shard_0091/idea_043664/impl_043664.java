...
@Data
public class Idea43664Config {
    private String name = "idea_043664";
 ...
 */
@Slf4j
public class Idea43664Service {
    private static final int IDEA_ID = 43664;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43664Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43664Service() {
        this(new Idea43664Config());
    }

    public Idea43664Service(Idea43664Config config) {
        this.config = config != null ? config : new Idea43664Config();
