...
@Data
public class Idea43659Config {
    private String name = "idea_043659";
 ...
 */
@Slf4j
public class Idea43659Service {
    private static final int IDEA_ID = 43659;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43659Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43659Service() {
        this(new Idea43659Config());
    }

    public Idea43659Service(Idea43659Config config) {
        this.config = config != null ? config : new Idea43659Config();
