...
@Data
public class Idea43274Config {
    private String name = "idea_043274";
 ...
 */
@Slf4j
public class Idea43274Service {
    private static final int IDEA_ID = 43274;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43274Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43274Service() {
        this(new Idea43274Config());
    }

    public Idea43274Service(Idea43274Config config) {
        this.config = config != null ? config : new Idea43274Config();
