...
@Data
public class Idea43241Config {
    private String name = "idea_043241";
 ...
 */
@Slf4j
public class Idea43241Service {
    private static final int IDEA_ID = 43241;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43241Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43241Service() {
        this(new Idea43241Config());
    }

    public Idea43241Service(Idea43241Config config) {
        this.config = config != null ? config : new Idea43241Config();
