...
@Data
public class Idea43336Config {
    private String name = "idea_043336";
 ...
 */
@Slf4j
public class Idea43336Service {
    private static final int IDEA_ID = 43336;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43336Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43336Service() {
        this(new Idea43336Config());
    }

    public Idea43336Service(Idea43336Config config) {
        this.config = config != null ? config : new Idea43336Config();
