...
@Data
public class Idea43298Config {
    private String name = "idea_043298";
 ...
 */
@Slf4j
public class Idea43298Service {
    private static final int IDEA_ID = 43298;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43298Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43298Service() {
        this(new Idea43298Config());
    }

    public Idea43298Service(Idea43298Config config) {
        this.config = config != null ? config : new Idea43298Config();
