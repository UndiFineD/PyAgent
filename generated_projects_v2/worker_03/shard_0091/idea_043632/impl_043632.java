...
@Data
public class Idea43632Config {
    private String name = "idea_043632";
 ...
 */
@Slf4j
public class Idea43632Service {
    private static final int IDEA_ID = 43632;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43632Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43632Service() {
        this(new Idea43632Config());
    }

    public Idea43632Service(Idea43632Config config) {
        this.config = config != null ? config : new Idea43632Config();
