...
@Data
public class Idea43603Config {
    private String name = "idea_043603";
 ...
 */
@Slf4j
public class Idea43603Service {
    private static final int IDEA_ID = 43603;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43603Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43603Service() {
        this(new Idea43603Config());
    }

    public Idea43603Service(Idea43603Config config) {
        this.config = config != null ? config : new Idea43603Config();
