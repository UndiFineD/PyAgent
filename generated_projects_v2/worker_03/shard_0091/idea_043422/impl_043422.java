...
@Data
public class Idea43422Config {
    private String name = "idea_043422";
 ...
 */
@Slf4j
public class Idea43422Service {
    private static final int IDEA_ID = 43422;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43422Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43422Service() {
        this(new Idea43422Config());
    }

    public Idea43422Service(Idea43422Config config) {
        this.config = config != null ? config : new Idea43422Config();
