...
@Data
public class Idea43593Config {
    private String name = "idea_043593";
 ...
 */
@Slf4j
public class Idea43593Service {
    private static final int IDEA_ID = 43593;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43593Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43593Service() {
        this(new Idea43593Config());
    }

    public Idea43593Service(Idea43593Config config) {
        this.config = config != null ? config : new Idea43593Config();
