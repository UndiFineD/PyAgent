...
@Data
public class Idea43270Config {
    private String name = "idea_043270";
 ...
 */
@Slf4j
public class Idea43270Service {
    private static final int IDEA_ID = 43270;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43270Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43270Service() {
        this(new Idea43270Config());
    }

    public Idea43270Service(Idea43270Config config) {
        this.config = config != null ? config : new Idea43270Config();
