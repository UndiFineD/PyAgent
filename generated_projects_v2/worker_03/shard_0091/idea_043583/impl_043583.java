...
@Data
public class Idea43583Config {
    private String name = "idea_043583";
 ...
 */
@Slf4j
public class Idea43583Service {
    private static final int IDEA_ID = 43583;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43583Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43583Service() {
        this(new Idea43583Config());
    }

    public Idea43583Service(Idea43583Config config) {
        this.config = config != null ? config : new Idea43583Config();
