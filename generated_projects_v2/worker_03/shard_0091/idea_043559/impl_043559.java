...
@Data
public class Idea43559Config {
    private String name = "idea_043559";
 ...
 */
@Slf4j
public class Idea43559Service {
    private static final int IDEA_ID = 43559;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43559Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43559Service() {
        this(new Idea43559Config());
    }

    public Idea43559Service(Idea43559Config config) {
        this.config = config != null ? config : new Idea43559Config();
