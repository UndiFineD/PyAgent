...
@Data
public class Idea43485Config {
    private String name = "idea_043485";
 ...
 */
@Slf4j
public class Idea43485Service {
    private static final int IDEA_ID = 43485;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43485Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43485Service() {
        this(new Idea43485Config());
    }

    public Idea43485Service(Idea43485Config config) {
        this.config = config != null ? config : new Idea43485Config();
