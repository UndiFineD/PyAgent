...
@Data
public class Idea43406Config {
    private String name = "idea_043406";
 ...
 */
@Slf4j
public class Idea43406Service {
    private static final int IDEA_ID = 43406;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43406Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43406Service() {
        this(new Idea43406Config());
    }

    public Idea43406Service(Idea43406Config config) {
        this.config = config != null ? config : new Idea43406Config();
