...
@Data
public class Idea43497Config {
    private String name = "idea_043497";
 ...
 */
@Slf4j
public class Idea43497Service {
    private static final int IDEA_ID = 43497;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43497Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43497Service() {
        this(new Idea43497Config());
    }

    public Idea43497Service(Idea43497Config config) {
        this.config = config != null ? config : new Idea43497Config();
