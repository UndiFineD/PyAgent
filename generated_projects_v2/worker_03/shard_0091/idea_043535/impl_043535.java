...
@Data
public class Idea43535Config {
    private String name = "idea_043535";
 ...
 */
@Slf4j
public class Idea43535Service {
    private static final int IDEA_ID = 43535;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43535Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43535Service() {
        this(new Idea43535Config());
    }

    public Idea43535Service(Idea43535Config config) {
        this.config = config != null ? config : new Idea43535Config();
