...
@Data
public class Idea43671Config {
    private String name = "idea_043671";
 ...
 */
@Slf4j
public class Idea43671Service {
    private static final int IDEA_ID = 43671;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43671Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43671Service() {
        this(new Idea43671Config());
    }

    public Idea43671Service(Idea43671Config config) {
        this.config = config != null ? config : new Idea43671Config();
