...
@Data
public class Idea43638Config {
    private String name = "idea_043638";
 ...
 */
@Slf4j
public class Idea43638Service {
    private static final int IDEA_ID = 43638;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43638Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43638Service() {
        this(new Idea43638Config());
    }

    public Idea43638Service(Idea43638Config config) {
        this.config = config != null ? config : new Idea43638Config();
