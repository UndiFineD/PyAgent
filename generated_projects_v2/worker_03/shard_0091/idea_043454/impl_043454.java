...
@Data
public class Idea43454Config {
    private String name = "idea_043454";
 ...
 */
@Slf4j
public class Idea43454Service {
    private static final int IDEA_ID = 43454;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43454Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43454Service() {
        this(new Idea43454Config());
    }

    public Idea43454Service(Idea43454Config config) {
        this.config = config != null ? config : new Idea43454Config();
