...
@Data
public class Idea43434Config {
    private String name = "idea_043434";
 ...
 */
@Slf4j
public class Idea43434Service {
    private static final int IDEA_ID = 43434;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43434Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43434Service() {
        this(new Idea43434Config());
    }

    public Idea43434Service(Idea43434Config config) {
        this.config = config != null ? config : new Idea43434Config();
