...
@Data
public class Idea43694Config {
    private String name = "idea_043694";
 ...
 */
@Slf4j
public class Idea43694Service {
    private static final int IDEA_ID = 43694;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43694Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43694Service() {
        this(new Idea43694Config());
    }

    public Idea43694Service(Idea43694Config config) {
        this.config = config != null ? config : new Idea43694Config();
