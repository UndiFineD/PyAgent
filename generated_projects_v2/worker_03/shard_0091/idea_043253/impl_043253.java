...
@Data
public class Idea43253Config {
    private String name = "idea_043253";
 ...
 */
@Slf4j
public class Idea43253Service {
    private static final int IDEA_ID = 43253;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43253Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43253Service() {
        this(new Idea43253Config());
    }

    public Idea43253Service(Idea43253Config config) {
        this.config = config != null ? config : new Idea43253Config();
