...
@Data
public class Idea43628Config {
    private String name = "idea_043628";
 ...
 */
@Slf4j
public class Idea43628Service {
    private static final int IDEA_ID = 43628;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43628Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43628Service() {
        this(new Idea43628Config());
    }

    public Idea43628Service(Idea43628Config config) {
        this.config = config != null ? config : new Idea43628Config();
