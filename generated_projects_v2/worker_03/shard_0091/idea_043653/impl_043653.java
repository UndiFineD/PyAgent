...
@Data
public class Idea43653Config {
    private String name = "idea_043653";
 ...
 */
@Slf4j
public class Idea43653Service {
    private static final int IDEA_ID = 43653;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43653Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43653Service() {
        this(new Idea43653Config());
    }

    public Idea43653Service(Idea43653Config config) {
        this.config = config != null ? config : new Idea43653Config();
