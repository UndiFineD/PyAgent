...
@Data
public class Idea43481Config {
    private String name = "idea_043481";
 ...
 */
@Slf4j
public class Idea43481Service {
    private static final int IDEA_ID = 43481;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43481Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43481Service() {
        this(new Idea43481Config());
    }

    public Idea43481Service(Idea43481Config config) {
        this.config = config != null ? config : new Idea43481Config();
