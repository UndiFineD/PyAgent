...
@Data
public class Idea43483Config {
    private String name = "idea_043483";
 ...
 */
@Slf4j
public class Idea43483Service {
    private static final int IDEA_ID = 43483;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43483Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43483Service() {
        this(new Idea43483Config());
    }

    public Idea43483Service(Idea43483Config config) {
        this.config = config != null ? config : new Idea43483Config();
