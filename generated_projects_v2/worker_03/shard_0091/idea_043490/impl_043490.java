...
@Data
public class Idea43490Config {
    private String name = "idea_043490";
 ...
 */
@Slf4j
public class Idea43490Service {
    private static final int IDEA_ID = 43490;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43490Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43490Service() {
        this(new Idea43490Config());
    }

    public Idea43490Service(Idea43490Config config) {
        this.config = config != null ? config : new Idea43490Config();
