...
@Data
public class Idea43335Config {
    private String name = "idea_043335";
 ...
 */
@Slf4j
public class Idea43335Service {
    private static final int IDEA_ID = 43335;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43335Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43335Service() {
        this(new Idea43335Config());
    }

    public Idea43335Service(Idea43335Config config) {
        this.config = config != null ? config : new Idea43335Config();
