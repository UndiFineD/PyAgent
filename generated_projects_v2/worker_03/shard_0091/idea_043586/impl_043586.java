...
@Data
public class Idea43586Config {
    private String name = "idea_043586";
 ...
 */
@Slf4j
public class Idea43586Service {
    private static final int IDEA_ID = 43586;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43586Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43586Service() {
        this(new Idea43586Config());
    }

    public Idea43586Service(Idea43586Config config) {
        this.config = config != null ? config : new Idea43586Config();
