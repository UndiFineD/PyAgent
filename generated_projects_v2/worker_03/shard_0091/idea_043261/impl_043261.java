...
@Data
public class Idea43261Config {
    private String name = "idea_043261";
 ...
 */
@Slf4j
public class Idea43261Service {
    private static final int IDEA_ID = 43261;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43261Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43261Service() {
        this(new Idea43261Config());
    }

    public Idea43261Service(Idea43261Config config) {
        this.config = config != null ? config : new Idea43261Config();
