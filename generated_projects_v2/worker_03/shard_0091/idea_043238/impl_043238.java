...
@Data
public class Idea43238Config {
    private String name = "idea_043238";
 ...
 */
@Slf4j
public class Idea43238Service {
    private static final int IDEA_ID = 43238;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43238Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43238Service() {
        this(new Idea43238Config());
    }

    public Idea43238Service(Idea43238Config config) {
        this.config = config != null ? config : new Idea43238Config();
