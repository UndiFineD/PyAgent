...
@Data
public class Idea43506Config {
    private String name = "idea_043506";
 ...
 */
@Slf4j
public class Idea43506Service {
    private static final int IDEA_ID = 43506;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43506Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43506Service() {
        this(new Idea43506Config());
    }

    public Idea43506Service(Idea43506Config config) {
        this.config = config != null ? config : new Idea43506Config();
