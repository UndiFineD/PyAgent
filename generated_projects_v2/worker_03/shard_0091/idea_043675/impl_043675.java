...
@Data
public class Idea43675Config {
    private String name = "idea_043675";
 ...
 */
@Slf4j
public class Idea43675Service {
    private static final int IDEA_ID = 43675;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43675Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43675Service() {
        this(new Idea43675Config());
    }

    public Idea43675Service(Idea43675Config config) {
        this.config = config != null ? config : new Idea43675Config();
