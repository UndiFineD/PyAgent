...
@Data
public class Idea43291Config {
    private String name = "idea_043291";
 ...
 */
@Slf4j
public class Idea43291Service {
    private static final int IDEA_ID = 43291;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43291Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43291Service() {
        this(new Idea43291Config());
    }

    public Idea43291Service(Idea43291Config config) {
        this.config = config != null ? config : new Idea43291Config();
