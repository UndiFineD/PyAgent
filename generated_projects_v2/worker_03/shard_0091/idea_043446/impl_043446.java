...
@Data
public class Idea43446Config {
    private String name = "idea_043446";
 ...
 */
@Slf4j
public class Idea43446Service {
    private static final int IDEA_ID = 43446;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43446Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43446Service() {
        this(new Idea43446Config());
    }

    public Idea43446Service(Idea43446Config config) {
        this.config = config != null ? config : new Idea43446Config();
