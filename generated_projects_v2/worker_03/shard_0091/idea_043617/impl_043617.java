...
@Data
public class Idea43617Config {
    private String name = "idea_043617";
 ...
 */
@Slf4j
public class Idea43617Service {
    private static final int IDEA_ID = 43617;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43617Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43617Service() {
        this(new Idea43617Config());
    }

    public Idea43617Service(Idea43617Config config) {
        this.config = config != null ? config : new Idea43617Config();
