...
@Data
public class Idea43616Config {
    private String name = "idea_043616";
 ...
 */
@Slf4j
public class Idea43616Service {
    private static final int IDEA_ID = 43616;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43616Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43616Service() {
        this(new Idea43616Config());
    }

    public Idea43616Service(Idea43616Config config) {
        this.config = config != null ? config : new Idea43616Config();
