...
@Data
public class Idea43570Config {
    private String name = "idea_043570";
 ...
 */
@Slf4j
public class Idea43570Service {
    private static final int IDEA_ID = 43570;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43570Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43570Service() {
        this(new Idea43570Config());
    }

    public Idea43570Service(Idea43570Config config) {
        this.config = config != null ? config : new Idea43570Config();
