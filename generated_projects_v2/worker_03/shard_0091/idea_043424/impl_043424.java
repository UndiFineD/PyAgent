...
@Data
public class Idea43424Config {
    private String name = "idea_043424";
 ...
 */
@Slf4j
public class Idea43424Service {
    private static final int IDEA_ID = 43424;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43424Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43424Service() {
        this(new Idea43424Config());
    }

    public Idea43424Service(Idea43424Config config) {
        this.config = config != null ? config : new Idea43424Config();
