...
@Data
public class Idea43323Config {
    private String name = "idea_043323";
 ...
 */
@Slf4j
public class Idea43323Service {
    private static final int IDEA_ID = 43323;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43323Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43323Service() {
        this(new Idea43323Config());
    }

    public Idea43323Service(Idea43323Config config) {
        this.config = config != null ? config : new Idea43323Config();
