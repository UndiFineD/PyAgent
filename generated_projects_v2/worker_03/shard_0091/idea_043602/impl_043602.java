...
@Data
public class Idea43602Config {
    private String name = "idea_043602";
 ...
 */
@Slf4j
public class Idea43602Service {
    private static final int IDEA_ID = 43602;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43602Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43602Service() {
        this(new Idea43602Config());
    }

    public Idea43602Service(Idea43602Config config) {
        this.config = config != null ? config : new Idea43602Config();
