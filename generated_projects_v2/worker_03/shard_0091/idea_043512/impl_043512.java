...
@Data
public class Idea43512Config {
    private String name = "idea_043512";
 ...
 */
@Slf4j
public class Idea43512Service {
    private static final int IDEA_ID = 43512;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43512Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43512Service() {
        this(new Idea43512Config());
    }

    public Idea43512Service(Idea43512Config config) {
        this.config = config != null ? config : new Idea43512Config();
