...
@Data
public class Idea43326Config {
    private String name = "idea_043326";
 ...
 */
@Slf4j
public class Idea43326Service {
    private static final int IDEA_ID = 43326;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43326Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43326Service() {
        this(new Idea43326Config());
    }

    public Idea43326Service(Idea43326Config config) {
        this.config = config != null ? config : new Idea43326Config();
