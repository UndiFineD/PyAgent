...
@Data
public class Idea43302Config {
    private String name = "idea_043302";
 ...
 */
@Slf4j
public class Idea43302Service {
    private static final int IDEA_ID = 43302;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43302Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43302Service() {
        this(new Idea43302Config());
    }

    public Idea43302Service(Idea43302Config config) {
        this.config = config != null ? config : new Idea43302Config();
