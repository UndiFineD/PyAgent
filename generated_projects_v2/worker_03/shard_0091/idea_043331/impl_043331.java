...
@Data
public class Idea43331Config {
    private String name = "idea_043331";
 ...
 */
@Slf4j
public class Idea43331Service {
    private static final int IDEA_ID = 43331;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43331Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43331Service() {
        this(new Idea43331Config());
    }

    public Idea43331Service(Idea43331Config config) {
        this.config = config != null ? config : new Idea43331Config();
