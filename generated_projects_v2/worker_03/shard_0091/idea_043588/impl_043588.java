...
@Data
public class Idea43588Config {
    private String name = "idea_043588";
 ...
 */
@Slf4j
public class Idea43588Service {
    private static final int IDEA_ID = 43588;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43588Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43588Service() {
        this(new Idea43588Config());
    }

    public Idea43588Service(Idea43588Config config) {
        this.config = config != null ? config : new Idea43588Config();
