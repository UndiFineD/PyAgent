...
@Data
public class Idea43435Config {
    private String name = "idea_043435";
 ...
 */
@Slf4j
public class Idea43435Service {
    private static final int IDEA_ID = 43435;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43435Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43435Service() {
        this(new Idea43435Config());
    }

    public Idea43435Service(Idea43435Config config) {
        this.config = config != null ? config : new Idea43435Config();
