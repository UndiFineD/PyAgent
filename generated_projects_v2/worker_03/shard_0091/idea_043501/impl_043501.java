...
@Data
public class Idea43501Config {
    private String name = "idea_043501";
 ...
 */
@Slf4j
public class Idea43501Service {
    private static final int IDEA_ID = 43501;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43501Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43501Service() {
        this(new Idea43501Config());
    }

    public Idea43501Service(Idea43501Config config) {
        this.config = config != null ? config : new Idea43501Config();
