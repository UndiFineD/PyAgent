...
@Data
public class Idea43571Config {
    private String name = "idea_043571";
 ...
 */
@Slf4j
public class Idea43571Service {
    private static final int IDEA_ID = 43571;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43571Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43571Service() {
        this(new Idea43571Config());
    }

    public Idea43571Service(Idea43571Config config) {
        this.config = config != null ? config : new Idea43571Config();
