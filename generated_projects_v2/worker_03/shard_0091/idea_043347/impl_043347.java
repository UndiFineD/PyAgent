...
@Data
public class Idea43347Config {
    private String name = "idea_043347";
 ...
 */
@Slf4j
public class Idea43347Service {
    private static final int IDEA_ID = 43347;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43347Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43347Service() {
        this(new Idea43347Config());
    }

    public Idea43347Service(Idea43347Config config) {
        this.config = config != null ? config : new Idea43347Config();
