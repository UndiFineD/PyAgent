...
@Data
public class Idea43278Config {
    private String name = "idea_043278";
 ...
 */
@Slf4j
public class Idea43278Service {
    private static final int IDEA_ID = 43278;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43278Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43278Service() {
        this(new Idea43278Config());
    }

    public Idea43278Service(Idea43278Config config) {
        this.config = config != null ? config : new Idea43278Config();
