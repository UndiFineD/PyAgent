...
@Data
public class Idea43456Config {
    private String name = "idea_043456";
 ...
 */
@Slf4j
public class Idea43456Service {
    private static final int IDEA_ID = 43456;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43456Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43456Service() {
        this(new Idea43456Config());
    }

    public Idea43456Service(Idea43456Config config) {
        this.config = config != null ? config : new Idea43456Config();
