...
@Data
public class Idea43547Config {
    private String name = "idea_043547";
 ...
 */
@Slf4j
public class Idea43547Service {
    private static final int IDEA_ID = 43547;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43547Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43547Service() {
        this(new Idea43547Config());
    }

    public Idea43547Service(Idea43547Config config) {
        this.config = config != null ? config : new Idea43547Config();
