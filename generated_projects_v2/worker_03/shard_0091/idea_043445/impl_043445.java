...
@Data
public class Idea43445Config {
    private String name = "idea_043445";
 ...
 */
@Slf4j
public class Idea43445Service {
    private static final int IDEA_ID = 43445;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43445Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43445Service() {
        this(new Idea43445Config());
    }

    public Idea43445Service(Idea43445Config config) {
        this.config = config != null ? config : new Idea43445Config();
