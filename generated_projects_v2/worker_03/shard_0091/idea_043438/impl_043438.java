...
@Data
public class Idea43438Config {
    private String name = "idea_043438";
 ...
 */
@Slf4j
public class Idea43438Service {
    private static final int IDEA_ID = 43438;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43438Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43438Service() {
        this(new Idea43438Config());
    }

    public Idea43438Service(Idea43438Config config) {
        this.config = config != null ? config : new Idea43438Config();
