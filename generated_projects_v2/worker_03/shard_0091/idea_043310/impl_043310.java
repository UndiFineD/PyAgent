...
@Data
public class Idea43310Config {
    private String name = "idea_043310";
 ...
 */
@Slf4j
public class Idea43310Service {
    private static final int IDEA_ID = 43310;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43310Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43310Service() {
        this(new Idea43310Config());
    }

    public Idea43310Service(Idea43310Config config) {
        this.config = config != null ? config : new Idea43310Config();
