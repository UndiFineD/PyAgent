...
@Data
public class Idea43263Config {
    private String name = "idea_043263";
 ...
 */
@Slf4j
public class Idea43263Service {
    private static final int IDEA_ID = 43263;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43263Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43263Service() {
        this(new Idea43263Config());
    }

    public Idea43263Service(Idea43263Config config) {
        this.config = config != null ? config : new Idea43263Config();
