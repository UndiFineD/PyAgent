...
@Data
public class Idea43399Config {
    private String name = "idea_043399";
 ...
 */
@Slf4j
public class Idea43399Service {
    private static final int IDEA_ID = 43399;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43399Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43399Service() {
        this(new Idea43399Config());
    }

    public Idea43399Service(Idea43399Config config) {
        this.config = config != null ? config : new Idea43399Config();
