...
@Data
public class Idea43367Config {
    private String name = "idea_043367";
 ...
 */
@Slf4j
public class Idea43367Service {
    private static final int IDEA_ID = 43367;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43367Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43367Service() {
        this(new Idea43367Config());
    }

    public Idea43367Service(Idea43367Config config) {
        this.config = config != null ? config : new Idea43367Config();
