...
@Data
public class Idea43585Config {
    private String name = "idea_043585";
 ...
 */
@Slf4j
public class Idea43585Service {
    private static final int IDEA_ID = 43585;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43585Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43585Service() {
        this(new Idea43585Config());
    }

    public Idea43585Service(Idea43585Config config) {
        this.config = config != null ? config : new Idea43585Config();
