...
@Data
public class Idea43408Config {
    private String name = "idea_043408";
 ...
 */
@Slf4j
public class Idea43408Service {
    private static final int IDEA_ID = 43408;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43408Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43408Service() {
        this(new Idea43408Config());
    }

    public Idea43408Service(Idea43408Config config) {
        this.config = config != null ? config : new Idea43408Config();
