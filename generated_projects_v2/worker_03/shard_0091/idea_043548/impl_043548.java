...
@Data
public class Idea43548Config {
    private String name = "idea_043548";
 ...
 */
@Slf4j
public class Idea43548Service {
    private static final int IDEA_ID = 43548;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43548Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43548Service() {
        this(new Idea43548Config());
    }

    public Idea43548Service(Idea43548Config config) {
        this.config = config != null ? config : new Idea43548Config();
