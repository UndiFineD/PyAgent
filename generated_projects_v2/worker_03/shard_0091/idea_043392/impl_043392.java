...
@Data
public class Idea43392Config {
    private String name = "idea_043392";
 ...
 */
@Slf4j
public class Idea43392Service {
    private static final int IDEA_ID = 43392;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43392Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43392Service() {
        this(new Idea43392Config());
    }

    public Idea43392Service(Idea43392Config config) {
        this.config = config != null ? config : new Idea43392Config();
