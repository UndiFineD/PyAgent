...
@Data
public class Idea43412Config {
    private String name = "idea_043412";
 ...
 */
@Slf4j
public class Idea43412Service {
    private static final int IDEA_ID = 43412;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43412Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43412Service() {
        this(new Idea43412Config());
    }

    public Idea43412Service(Idea43412Config config) {
        this.config = config != null ? config : new Idea43412Config();
