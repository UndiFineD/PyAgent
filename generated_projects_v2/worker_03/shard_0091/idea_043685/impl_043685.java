...
@Data
public class Idea43685Config {
    private String name = "idea_043685";
 ...
 */
@Slf4j
public class Idea43685Service {
    private static final int IDEA_ID = 43685;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43685Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43685Service() {
        this(new Idea43685Config());
    }

    public Idea43685Service(Idea43685Config config) {
        this.config = config != null ? config : new Idea43685Config();
