...
@Data
public class Idea43393Config {
    private String name = "idea_043393";
 ...
 */
@Slf4j
public class Idea43393Service {
    private static final int IDEA_ID = 43393;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43393Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43393Service() {
        this(new Idea43393Config());
    }

    public Idea43393Service(Idea43393Config config) {
        this.config = config != null ? config : new Idea43393Config();
