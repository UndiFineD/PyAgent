...
@Data
public class Idea43553Config {
    private String name = "idea_043553";
 ...
 */
@Slf4j
public class Idea43553Service {
    private static final int IDEA_ID = 43553;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43553Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43553Service() {
        this(new Idea43553Config());
    }

    public Idea43553Service(Idea43553Config config) {
        this.config = config != null ? config : new Idea43553Config();
