...
@Data
public class Idea43572Config {
    private String name = "idea_043572";
 ...
 */
@Slf4j
public class Idea43572Service {
    private static final int IDEA_ID = 43572;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43572Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43572Service() {
        this(new Idea43572Config());
    }

    public Idea43572Service(Idea43572Config config) {
        this.config = config != null ? config : new Idea43572Config();
