...
@Data
public class Idea43290Config {
    private String name = "idea_043290";
 ...
 */
@Slf4j
public class Idea43290Service {
    private static final int IDEA_ID = 43290;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43290Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43290Service() {
        this(new Idea43290Config());
    }

    public Idea43290Service(Idea43290Config config) {
        this.config = config != null ? config : new Idea43290Config();
