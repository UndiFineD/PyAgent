...
@Data
public class Idea43660Config {
    private String name = "idea_043660";
 ...
 */
@Slf4j
public class Idea43660Service {
    private static final int IDEA_ID = 43660;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43660Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43660Service() {
        this(new Idea43660Config());
    }

    public Idea43660Service(Idea43660Config config) {
        this.config = config != null ? config : new Idea43660Config();
