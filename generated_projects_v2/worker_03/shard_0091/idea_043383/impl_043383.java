...
@Data
public class Idea43383Config {
    private String name = "idea_043383";
 ...
 */
@Slf4j
public class Idea43383Service {
    private static final int IDEA_ID = 43383;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43383Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43383Service() {
        this(new Idea43383Config());
    }

    public Idea43383Service(Idea43383Config config) {
        this.config = config != null ? config : new Idea43383Config();
