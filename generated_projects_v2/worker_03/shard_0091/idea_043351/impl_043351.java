...
@Data
public class Idea43351Config {
    private String name = "idea_043351";
 ...
 */
@Slf4j
public class Idea43351Service {
    private static final int IDEA_ID = 43351;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43351Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43351Service() {
        this(new Idea43351Config());
    }

    public Idea43351Service(Idea43351Config config) {
        this.config = config != null ? config : new Idea43351Config();
