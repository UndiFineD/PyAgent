...
@Data
public class Idea43673Config {
    private String name = "idea_043673";
 ...
 */
@Slf4j
public class Idea43673Service {
    private static final int IDEA_ID = 43673;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43673Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43673Service() {
        this(new Idea43673Config());
    }

    public Idea43673Service(Idea43673Config config) {
        this.config = config != null ? config : new Idea43673Config();
