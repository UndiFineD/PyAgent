...
@Data
public class Idea43360Config {
    private String name = "idea_043360";
 ...
 */
@Slf4j
public class Idea43360Service {
    private static final int IDEA_ID = 43360;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43360Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43360Service() {
        this(new Idea43360Config());
    }

    public Idea43360Service(Idea43360Config config) {
        this.config = config != null ? config : new Idea43360Config();
