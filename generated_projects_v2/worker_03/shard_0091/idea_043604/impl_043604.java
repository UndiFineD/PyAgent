...
@Data
public class Idea43604Config {
    private String name = "idea_043604";
 ...
 */
@Slf4j
public class Idea43604Service {
    private static final int IDEA_ID = 43604;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43604Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43604Service() {
        this(new Idea43604Config());
    }

    public Idea43604Service(Idea43604Config config) {
        this.config = config != null ? config : new Idea43604Config();
