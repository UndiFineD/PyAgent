...
@Data
public class Idea43491Config {
    private String name = "idea_043491";
 ...
 */
@Slf4j
public class Idea43491Service {
    private static final int IDEA_ID = 43491;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43491Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43491Service() {
        this(new Idea43491Config());
    }

    public Idea43491Service(Idea43491Config config) {
        this.config = config != null ? config : new Idea43491Config();
