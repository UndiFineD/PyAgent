...
@Data
public class Idea43457Config {
    private String name = "idea_043457";
 ...
 */
@Slf4j
public class Idea43457Service {
    private static final int IDEA_ID = 43457;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43457Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43457Service() {
        this(new Idea43457Config());
    }

    public Idea43457Service(Idea43457Config config) {
        this.config = config != null ? config : new Idea43457Config();
