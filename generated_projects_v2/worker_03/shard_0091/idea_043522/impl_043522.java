...
@Data
public class Idea43522Config {
    private String name = "idea_043522";
 ...
 */
@Slf4j
public class Idea43522Service {
    private static final int IDEA_ID = 43522;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43522Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43522Service() {
        this(new Idea43522Config());
    }

    public Idea43522Service(Idea43522Config config) {
        this.config = config != null ? config : new Idea43522Config();
