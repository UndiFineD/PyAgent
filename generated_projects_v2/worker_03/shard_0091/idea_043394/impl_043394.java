...
@Data
public class Idea43394Config {
    private String name = "idea_043394";
 ...
 */
@Slf4j
public class Idea43394Service {
    private static final int IDEA_ID = 43394;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43394Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43394Service() {
        this(new Idea43394Config());
    }

    public Idea43394Service(Idea43394Config config) {
        this.config = config != null ? config : new Idea43394Config();
