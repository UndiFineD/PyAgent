...
@Data
public class Idea43594Config {
    private String name = "idea_043594";
 ...
 */
@Slf4j
public class Idea43594Service {
    private static final int IDEA_ID = 43594;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43594Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43594Service() {
        this(new Idea43594Config());
    }

    public Idea43594Service(Idea43594Config config) {
        this.config = config != null ? config : new Idea43594Config();
