...
@Data
public class Idea43557Config {
    private String name = "idea_043557";
 ...
 */
@Slf4j
public class Idea43557Service {
    private static final int IDEA_ID = 43557;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43557Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43557Service() {
        this(new Idea43557Config());
    }

    public Idea43557Service(Idea43557Config config) {
        this.config = config != null ? config : new Idea43557Config();
