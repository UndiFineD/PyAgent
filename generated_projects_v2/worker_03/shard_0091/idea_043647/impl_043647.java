...
@Data
public class Idea43647Config {
    private String name = "idea_043647";
 ...
 */
@Slf4j
public class Idea43647Service {
    private static final int IDEA_ID = 43647;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43647Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43647Service() {
        this(new Idea43647Config());
    }

    public Idea43647Service(Idea43647Config config) {
        this.config = config != null ? config : new Idea43647Config();
