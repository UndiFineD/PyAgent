...
@Data
public class Idea43301Config {
    private String name = "idea_043301";
 ...
 */
@Slf4j
public class Idea43301Service {
    private static final int IDEA_ID = 43301;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43301Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43301Service() {
        this(new Idea43301Config());
    }

    public Idea43301Service(Idea43301Config config) {
        this.config = config != null ? config : new Idea43301Config();
