...
@Data
public class Idea43658Config {
    private String name = "idea_043658";
 ...
 */
@Slf4j
public class Idea43658Service {
    private static final int IDEA_ID = 43658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43658Service() {
        this(new Idea43658Config());
    }

    public Idea43658Service(Idea43658Config config) {
        this.config = config != null ? config : new Idea43658Config();
