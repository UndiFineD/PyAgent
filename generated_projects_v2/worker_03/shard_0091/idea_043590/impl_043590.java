...
@Data
public class Idea43590Config {
    private String name = "idea_043590";
 ...
 */
@Slf4j
public class Idea43590Service {
    private static final int IDEA_ID = 43590;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43590Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43590Service() {
        this(new Idea43590Config());
    }

    public Idea43590Service(Idea43590Config config) {
        this.config = config != null ? config : new Idea43590Config();
