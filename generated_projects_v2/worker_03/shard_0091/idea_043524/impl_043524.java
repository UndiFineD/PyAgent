...
@Data
public class Idea43524Config {
    private String name = "idea_043524";
 ...
 */
@Slf4j
public class Idea43524Service {
    private static final int IDEA_ID = 43524;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43524Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43524Service() {
        this(new Idea43524Config());
    }

    public Idea43524Service(Idea43524Config config) {
        this.config = config != null ? config : new Idea43524Config();
