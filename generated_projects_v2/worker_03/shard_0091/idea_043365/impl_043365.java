...
@Data
public class Idea43365Config {
    private String name = "idea_043365";
 ...
 */
@Slf4j
public class Idea43365Service {
    private static final int IDEA_ID = 43365;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43365Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43365Service() {
        this(new Idea43365Config());
    }

    public Idea43365Service(Idea43365Config config) {
        this.config = config != null ? config : new Idea43365Config();
