...
@Data
public class Idea43281Config {
    private String name = "idea_043281";
 ...
 */
@Slf4j
public class Idea43281Service {
    private static final int IDEA_ID = 43281;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43281Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43281Service() {
        this(new Idea43281Config());
    }

    public Idea43281Service(Idea43281Config config) {
        this.config = config != null ? config : new Idea43281Config();
