...
@Data
public class Idea43615Config {
    private String name = "idea_043615";
 ...
 */
@Slf4j
public class Idea43615Service {
    private static final int IDEA_ID = 43615;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43615Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43615Service() {
        this(new Idea43615Config());
    }

    public Idea43615Service(Idea43615Config config) {
        this.config = config != null ? config : new Idea43615Config();
