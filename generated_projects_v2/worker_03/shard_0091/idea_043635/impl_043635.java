...
@Data
public class Idea43635Config {
    private String name = "idea_043635";
 ...
 */
@Slf4j
public class Idea43635Service {
    private static final int IDEA_ID = 43635;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea43635Config config;
    private final Map<String, ProcessResult> cache;

    public Idea43635Service() {
        this(new Idea43635Config());
    }

    public Idea43635Service(Idea43635Config config) {
        this.config = config != null ? config : new Idea43635Config();
