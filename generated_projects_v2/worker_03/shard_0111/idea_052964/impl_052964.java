...
@Data
public class Idea52964Config {
    private String name = "idea_052964";
 ...
 */
@Slf4j
public class Idea52964Service {
    private static final int IDEA_ID = 52964;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52964Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52964Service() {
        this(new Idea52964Config());
    }

    public Idea52964Service(Idea52964Config config) {
        this.config = config != null ? config : new Idea52964Config();
