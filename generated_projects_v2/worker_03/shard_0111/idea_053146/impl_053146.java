...
@Data
public class Idea53146Config {
    private String name = "idea_053146";
 ...
 */
@Slf4j
public class Idea53146Service {
    private static final int IDEA_ID = 53146;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53146Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53146Service() {
        this(new Idea53146Config());
    }

    public Idea53146Service(Idea53146Config config) {
        this.config = config != null ? config : new Idea53146Config();
