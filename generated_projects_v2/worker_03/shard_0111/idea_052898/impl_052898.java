...
@Data
public class Idea52898Config {
    private String name = "idea_052898";
 ...
 */
@Slf4j
public class Idea52898Service {
    private static final int IDEA_ID = 52898;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52898Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52898Service() {
        this(new Idea52898Config());
    }

    public Idea52898Service(Idea52898Config config) {
        this.config = config != null ? config : new Idea52898Config();
