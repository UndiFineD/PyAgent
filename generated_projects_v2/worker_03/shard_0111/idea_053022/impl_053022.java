...
@Data
public class Idea53022Config {
    private String name = "idea_053022";
 ...
 */
@Slf4j
public class Idea53022Service {
    private static final int IDEA_ID = 53022;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53022Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53022Service() {
        this(new Idea53022Config());
    }

    public Idea53022Service(Idea53022Config config) {
        this.config = config != null ? config : new Idea53022Config();
