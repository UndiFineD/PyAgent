...
@Data
public class Idea52976Config {
    private String name = "idea_052976";
 ...
 */
@Slf4j
public class Idea52976Service {
    private static final int IDEA_ID = 52976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52976Service() {
        this(new Idea52976Config());
    }

    public Idea52976Service(Idea52976Config config) {
        this.config = config != null ? config : new Idea52976Config();
