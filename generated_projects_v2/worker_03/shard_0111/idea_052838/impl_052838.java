...
@Data
public class Idea52838Config {
    private String name = "idea_052838";
 ...
 */
@Slf4j
public class Idea52838Service {
    private static final int IDEA_ID = 52838;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52838Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52838Service() {
        this(new Idea52838Config());
    }

    public Idea52838Service(Idea52838Config config) {
        this.config = config != null ? config : new Idea52838Config();
