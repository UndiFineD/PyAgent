...
@Data
public class Idea52927Config {
    private String name = "idea_052927";
 ...
 */
@Slf4j
public class Idea52927Service {
    private static final int IDEA_ID = 52927;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52927Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52927Service() {
        this(new Idea52927Config());
    }

    public Idea52927Service(Idea52927Config config) {
        this.config = config != null ? config : new Idea52927Config();
