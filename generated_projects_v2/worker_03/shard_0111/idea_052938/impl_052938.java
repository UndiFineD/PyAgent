...
@Data
public class Idea52938Config {
    private String name = "idea_052938";
 ...
 */
@Slf4j
public class Idea52938Service {
    private static final int IDEA_ID = 52938;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52938Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52938Service() {
        this(new Idea52938Config());
    }

    public Idea52938Service(Idea52938Config config) {
        this.config = config != null ? config : new Idea52938Config();
