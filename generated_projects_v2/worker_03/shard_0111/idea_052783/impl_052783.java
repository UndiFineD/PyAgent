...
@Data
public class Idea52783Config {
    private String name = "idea_052783";
 ...
 */
@Slf4j
public class Idea52783Service {
    private static final int IDEA_ID = 52783;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52783Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52783Service() {
        this(new Idea52783Config());
    }

    public Idea52783Service(Idea52783Config config) {
        this.config = config != null ? config : new Idea52783Config();
