...
@Data
public class Idea52737Config {
    private String name = "idea_052737";
 ...
 */
@Slf4j
public class Idea52737Service {
    private static final int IDEA_ID = 52737;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52737Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52737Service() {
        this(new Idea52737Config());
    }

    public Idea52737Service(Idea52737Config config) {
        this.config = config != null ? config : new Idea52737Config();
