...
@Data
public class Idea52821Config {
    private String name = "idea_052821";
 ...
 */
@Slf4j
public class Idea52821Service {
    private static final int IDEA_ID = 52821;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52821Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52821Service() {
        this(new Idea52821Config());
    }

    public Idea52821Service(Idea52821Config config) {
        this.config = config != null ? config : new Idea52821Config();
