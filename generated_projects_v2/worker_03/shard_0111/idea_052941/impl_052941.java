...
@Data
public class Idea52941Config {
    private String name = "idea_052941";
 ...
 */
@Slf4j
public class Idea52941Service {
    private static final int IDEA_ID = 52941;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52941Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52941Service() {
        this(new Idea52941Config());
    }

    public Idea52941Service(Idea52941Config config) {
        this.config = config != null ? config : new Idea52941Config();
