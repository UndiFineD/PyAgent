...
@Data
public class Idea52937Config {
    private String name = "idea_052937";
 ...
 */
@Slf4j
public class Idea52937Service {
    private static final int IDEA_ID = 52937;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52937Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52937Service() {
        this(new Idea52937Config());
    }

    public Idea52937Service(Idea52937Config config) {
        this.config = config != null ? config : new Idea52937Config();
