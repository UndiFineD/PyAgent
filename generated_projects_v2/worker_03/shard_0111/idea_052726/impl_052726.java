...
@Data
public class Idea52726Config {
    private String name = "idea_052726";
 ...
 */
@Slf4j
public class Idea52726Service {
    private static final int IDEA_ID = 52726;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52726Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52726Service() {
        this(new Idea52726Config());
    }

    public Idea52726Service(Idea52726Config config) {
        this.config = config != null ? config : new Idea52726Config();
