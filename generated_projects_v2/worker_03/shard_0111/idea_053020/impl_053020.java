...
@Data
public class Idea53020Config {
    private String name = "idea_053020";
 ...
 */
@Slf4j
public class Idea53020Service {
    private static final int IDEA_ID = 53020;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53020Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53020Service() {
        this(new Idea53020Config());
    }

    public Idea53020Service(Idea53020Config config) {
        this.config = config != null ? config : new Idea53020Config();
