...
@Data
public class Idea52945Config {
    private String name = "idea_052945";
 ...
 */
@Slf4j
public class Idea52945Service {
    private static final int IDEA_ID = 52945;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52945Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52945Service() {
        this(new Idea52945Config());
    }

    public Idea52945Service(Idea52945Config config) {
        this.config = config != null ? config : new Idea52945Config();
