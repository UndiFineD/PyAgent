...
@Data
public class Idea52967Config {
    private String name = "idea_052967";
 ...
 */
@Slf4j
public class Idea52967Service {
    private static final int IDEA_ID = 52967;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52967Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52967Service() {
        this(new Idea52967Config());
    }

    public Idea52967Service(Idea52967Config config) {
        this.config = config != null ? config : new Idea52967Config();
