...
@Data
public class Idea53083Config {
    private String name = "idea_053083";
 ...
 */
@Slf4j
public class Idea53083Service {
    private static final int IDEA_ID = 53083;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53083Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53083Service() {
        this(new Idea53083Config());
    }

    public Idea53083Service(Idea53083Config config) {
        this.config = config != null ? config : new Idea53083Config();
