...
@Data
public class Idea52767Config {
    private String name = "idea_052767";
 ...
 */
@Slf4j
public class Idea52767Service {
    private static final int IDEA_ID = 52767;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52767Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52767Service() {
        this(new Idea52767Config());
    }

    public Idea52767Service(Idea52767Config config) {
        this.config = config != null ? config : new Idea52767Config();
