...
@Data
public class Idea52943Config {
    private String name = "idea_052943";
 ...
 */
@Slf4j
public class Idea52943Service {
    private static final int IDEA_ID = 52943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52943Service() {
        this(new Idea52943Config());
    }

    public Idea52943Service(Idea52943Config config) {
        this.config = config != null ? config : new Idea52943Config();
