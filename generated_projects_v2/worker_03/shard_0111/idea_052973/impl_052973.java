...
@Data
public class Idea52973Config {
    private String name = "idea_052973";
 ...
 */
@Slf4j
public class Idea52973Service {
    private static final int IDEA_ID = 52973;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52973Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52973Service() {
        this(new Idea52973Config());
    }

    public Idea52973Service(Idea52973Config config) {
        this.config = config != null ? config : new Idea52973Config();
