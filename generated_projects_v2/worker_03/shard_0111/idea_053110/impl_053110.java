...
@Data
public class Idea53110Config {
    private String name = "idea_053110";
 ...
 */
@Slf4j
public class Idea53110Service {
    private static final int IDEA_ID = 53110;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53110Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53110Service() {
        this(new Idea53110Config());
    }

    public Idea53110Service(Idea53110Config config) {
        this.config = config != null ? config : new Idea53110Config();
