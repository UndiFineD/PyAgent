...
@Data
public class Idea53105Config {
    private String name = "idea_053105";
 ...
 */
@Slf4j
public class Idea53105Service {
    private static final int IDEA_ID = 53105;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53105Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53105Service() {
        this(new Idea53105Config());
    }

    public Idea53105Service(Idea53105Config config) {
        this.config = config != null ? config : new Idea53105Config();
