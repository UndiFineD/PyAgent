...
@Data
public class Idea52960Config {
    private String name = "idea_052960";
 ...
 */
@Slf4j
public class Idea52960Service {
    private static final int IDEA_ID = 52960;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52960Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52960Service() {
        this(new Idea52960Config());
    }

    public Idea52960Service(Idea52960Config config) {
        this.config = config != null ? config : new Idea52960Config();
