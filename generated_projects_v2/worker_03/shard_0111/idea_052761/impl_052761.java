...
@Data
public class Idea52761Config {
    private String name = "idea_052761";
 ...
 */
@Slf4j
public class Idea52761Service {
    private static final int IDEA_ID = 52761;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52761Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52761Service() {
        this(new Idea52761Config());
    }

    public Idea52761Service(Idea52761Config config) {
        this.config = config != null ? config : new Idea52761Config();
