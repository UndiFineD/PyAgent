...
@Data
public class Idea53100Config {
    private String name = "idea_053100";
 ...
 */
@Slf4j
public class Idea53100Service {
    private static final int IDEA_ID = 53100;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53100Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53100Service() {
        this(new Idea53100Config());
    }

    public Idea53100Service(Idea53100Config config) {
        this.config = config != null ? config : new Idea53100Config();
