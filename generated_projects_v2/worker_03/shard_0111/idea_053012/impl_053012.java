...
@Data
public class Idea53012Config {
    private String name = "idea_053012";
 ...
 */
@Slf4j
public class Idea53012Service {
    private static final int IDEA_ID = 53012;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53012Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53012Service() {
        this(new Idea53012Config());
    }

    public Idea53012Service(Idea53012Config config) {
        this.config = config != null ? config : new Idea53012Config();
