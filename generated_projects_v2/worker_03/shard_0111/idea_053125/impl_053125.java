...
@Data
public class Idea53125Config {
    private String name = "idea_053125";
 ...
 */
@Slf4j
public class Idea53125Service {
    private static final int IDEA_ID = 53125;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53125Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53125Service() {
        this(new Idea53125Config());
    }

    public Idea53125Service(Idea53125Config config) {
        this.config = config != null ? config : new Idea53125Config();
