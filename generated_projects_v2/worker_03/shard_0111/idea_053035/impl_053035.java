...
@Data
public class Idea53035Config {
    private String name = "idea_053035";
 ...
 */
@Slf4j
public class Idea53035Service {
    private static final int IDEA_ID = 53035;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53035Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53035Service() {
        this(new Idea53035Config());
    }

    public Idea53035Service(Idea53035Config config) {
        this.config = config != null ? config : new Idea53035Config();
