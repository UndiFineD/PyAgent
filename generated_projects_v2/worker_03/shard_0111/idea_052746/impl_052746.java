...
@Data
public class Idea52746Config {
    private String name = "idea_052746";
 ...
 */
@Slf4j
public class Idea52746Service {
    private static final int IDEA_ID = 52746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52746Service() {
        this(new Idea52746Config());
    }

    public Idea52746Service(Idea52746Config config) {
        this.config = config != null ? config : new Idea52746Config();
