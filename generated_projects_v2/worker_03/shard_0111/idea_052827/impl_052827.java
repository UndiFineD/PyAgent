...
@Data
public class Idea52827Config {
    private String name = "idea_052827";
 ...
 */
@Slf4j
public class Idea52827Service {
    private static final int IDEA_ID = 52827;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52827Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52827Service() {
        this(new Idea52827Config());
    }

    public Idea52827Service(Idea52827Config config) {
        this.config = config != null ? config : new Idea52827Config();
