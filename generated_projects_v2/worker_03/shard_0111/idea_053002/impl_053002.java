...
@Data
public class Idea53002Config {
    private String name = "idea_053002";
 ...
 */
@Slf4j
public class Idea53002Service {
    private static final int IDEA_ID = 53002;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53002Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53002Service() {
        this(new Idea53002Config());
    }

    public Idea53002Service(Idea53002Config config) {
        this.config = config != null ? config : new Idea53002Config();
