...
@Data
public class Idea53036Config {
    private String name = "idea_053036";
 ...
 */
@Slf4j
public class Idea53036Service {
    private static final int IDEA_ID = 53036;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53036Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53036Service() {
        this(new Idea53036Config());
    }

    public Idea53036Service(Idea53036Config config) {
        this.config = config != null ? config : new Idea53036Config();
