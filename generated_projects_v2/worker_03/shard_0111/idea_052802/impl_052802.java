...
@Data
public class Idea52802Config {
    private String name = "idea_052802";
 ...
 */
@Slf4j
public class Idea52802Service {
    private static final int IDEA_ID = 52802;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52802Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52802Service() {
        this(new Idea52802Config());
    }

    public Idea52802Service(Idea52802Config config) {
        this.config = config != null ? config : new Idea52802Config();
