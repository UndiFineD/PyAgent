...
@Data
public class Idea52965Config {
    private String name = "idea_052965";
 ...
 */
@Slf4j
public class Idea52965Service {
    private static final int IDEA_ID = 52965;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52965Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52965Service() {
        this(new Idea52965Config());
    }

    public Idea52965Service(Idea52965Config config) {
        this.config = config != null ? config : new Idea52965Config();
