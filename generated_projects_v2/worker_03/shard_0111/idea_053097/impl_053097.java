...
@Data
public class Idea53097Config {
    private String name = "idea_053097";
 ...
 */
@Slf4j
public class Idea53097Service {
    private static final int IDEA_ID = 53097;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53097Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53097Service() {
        this(new Idea53097Config());
    }

    public Idea53097Service(Idea53097Config config) {
        this.config = config != null ? config : new Idea53097Config();
