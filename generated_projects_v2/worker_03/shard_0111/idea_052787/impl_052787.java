...
@Data
public class Idea52787Config {
    private String name = "idea_052787";
 ...
 */
@Slf4j
public class Idea52787Service {
    private static final int IDEA_ID = 52787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52787Service() {
        this(new Idea52787Config());
    }

    public Idea52787Service(Idea52787Config config) {
        this.config = config != null ? config : new Idea52787Config();
