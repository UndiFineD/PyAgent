...
@Data
public class Idea52750Config {
    private String name = "idea_052750";
 ...
 */
@Slf4j
public class Idea52750Service {
    private static final int IDEA_ID = 52750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52750Service() {
        this(new Idea52750Config());
    }

    public Idea52750Service(Idea52750Config config) {
        this.config = config != null ? config : new Idea52750Config();
