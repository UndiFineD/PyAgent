...
@Data
public class Idea53147Config {
    private String name = "idea_053147";
 ...
 */
@Slf4j
public class Idea53147Service {
    private static final int IDEA_ID = 53147;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53147Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53147Service() {
        this(new Idea53147Config());
    }

    public Idea53147Service(Idea53147Config config) {
        this.config = config != null ? config : new Idea53147Config();
