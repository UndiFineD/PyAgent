...
@Data
public class Idea53103Config {
    private String name = "idea_053103";
 ...
 */
@Slf4j
public class Idea53103Service {
    private static final int IDEA_ID = 53103;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53103Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53103Service() {
        this(new Idea53103Config());
    }

    public Idea53103Service(Idea53103Config config) {
        this.config = config != null ? config : new Idea53103Config();
