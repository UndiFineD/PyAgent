...
@Data
public class Idea53111Config {
    private String name = "idea_053111";
 ...
 */
@Slf4j
public class Idea53111Service {
    private static final int IDEA_ID = 53111;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53111Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53111Service() {
        this(new Idea53111Config());
    }

    public Idea53111Service(Idea53111Config config) {
        this.config = config != null ? config : new Idea53111Config();
