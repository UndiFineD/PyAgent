...
@Data
public class Idea52998Config {
    private String name = "idea_052998";
 ...
 */
@Slf4j
public class Idea52998Service {
    private static final int IDEA_ID = 52998;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52998Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52998Service() {
        this(new Idea52998Config());
    }

    public Idea52998Service(Idea52998Config config) {
        this.config = config != null ? config : new Idea52998Config();
