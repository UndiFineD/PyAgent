...
@Data
public class Idea53061Config {
    private String name = "idea_053061";
 ...
 */
@Slf4j
public class Idea53061Service {
    private static final int IDEA_ID = 53061;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53061Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53061Service() {
        this(new Idea53061Config());
    }

    public Idea53061Service(Idea53061Config config) {
        this.config = config != null ? config : new Idea53061Config();
