...
@Data
public class Idea53018Config {
    private String name = "idea_053018";
 ...
 */
@Slf4j
public class Idea53018Service {
    private static final int IDEA_ID = 53018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53018Service() {
        this(new Idea53018Config());
    }

    public Idea53018Service(Idea53018Config config) {
        this.config = config != null ? config : new Idea53018Config();
