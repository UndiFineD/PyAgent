...
@Data
public class Idea52936Config {
    private String name = "idea_052936";
 ...
 */
@Slf4j
public class Idea52936Service {
    private static final int IDEA_ID = 52936;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52936Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52936Service() {
        this(new Idea52936Config());
    }

    public Idea52936Service(Idea52936Config config) {
        this.config = config != null ? config : new Idea52936Config();
