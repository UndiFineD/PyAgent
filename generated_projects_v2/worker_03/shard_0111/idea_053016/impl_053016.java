...
@Data
public class Idea53016Config {
    private String name = "idea_053016";
 ...
 */
@Slf4j
public class Idea53016Service {
    private static final int IDEA_ID = 53016;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53016Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53016Service() {
        this(new Idea53016Config());
    }

    public Idea53016Service(Idea53016Config config) {
        this.config = config != null ? config : new Idea53016Config();
