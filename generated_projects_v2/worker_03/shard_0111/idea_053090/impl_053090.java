...
@Data
public class Idea53090Config {
    private String name = "idea_053090";
 ...
 */
@Slf4j
public class Idea53090Service {
    private static final int IDEA_ID = 53090;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53090Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53090Service() {
        this(new Idea53090Config());
    }

    public Idea53090Service(Idea53090Config config) {
        this.config = config != null ? config : new Idea53090Config();
