...
@Data
public class Idea52883Config {
    private String name = "idea_052883";
 ...
 */
@Slf4j
public class Idea52883Service {
    private static final int IDEA_ID = 52883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52883Service() {
        this(new Idea52883Config());
    }

    public Idea52883Service(Idea52883Config config) {
        this.config = config != null ? config : new Idea52883Config();
