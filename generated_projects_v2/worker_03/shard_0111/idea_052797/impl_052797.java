...
@Data
public class Idea52797Config {
    private String name = "idea_052797";
 ...
 */
@Slf4j
public class Idea52797Service {
    private static final int IDEA_ID = 52797;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52797Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52797Service() {
        this(new Idea52797Config());
    }

    public Idea52797Service(Idea52797Config config) {
        this.config = config != null ? config : new Idea52797Config();
