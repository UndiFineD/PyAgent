...
@Data
public class Idea53178Config {
    private String name = "idea_053178";
 ...
 */
@Slf4j
public class Idea53178Service {
    private static final int IDEA_ID = 53178;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53178Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53178Service() {
        this(new Idea53178Config());
    }

    public Idea53178Service(Idea53178Config config) {
        this.config = config != null ? config : new Idea53178Config();
