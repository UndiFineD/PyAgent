...
@Data
public class Idea52921Config {
    private String name = "idea_052921";
 ...
 */
@Slf4j
public class Idea52921Service {
    private static final int IDEA_ID = 52921;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52921Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52921Service() {
        this(new Idea52921Config());
    }

    public Idea52921Service(Idea52921Config config) {
        this.config = config != null ? config : new Idea52921Config();
