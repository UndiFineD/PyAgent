...
@Data
public class Idea52970Config {
    private String name = "idea_052970";
 ...
 */
@Slf4j
public class Idea52970Service {
    private static final int IDEA_ID = 52970;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52970Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52970Service() {
        this(new Idea52970Config());
    }

    public Idea52970Service(Idea52970Config config) {
        this.config = config != null ? config : new Idea52970Config();
