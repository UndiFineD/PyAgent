...
@Data
public class Idea52997Config {
    private String name = "idea_052997";
 ...
 */
@Slf4j
public class Idea52997Service {
    private static final int IDEA_ID = 52997;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52997Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52997Service() {
        this(new Idea52997Config());
    }

    public Idea52997Service(Idea52997Config config) {
        this.config = config != null ? config : new Idea52997Config();
