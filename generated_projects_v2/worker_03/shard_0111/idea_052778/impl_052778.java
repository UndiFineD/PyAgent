...
@Data
public class Idea52778Config {
    private String name = "idea_052778";
 ...
 */
@Slf4j
public class Idea52778Service {
    private static final int IDEA_ID = 52778;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52778Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52778Service() {
        this(new Idea52778Config());
    }

    public Idea52778Service(Idea52778Config config) {
        this.config = config != null ? config : new Idea52778Config();
