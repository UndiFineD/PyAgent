...
@Data
public class Idea53101Config {
    private String name = "idea_053101";
 ...
 */
@Slf4j
public class Idea53101Service {
    private static final int IDEA_ID = 53101;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53101Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53101Service() {
        this(new Idea53101Config());
    }

    public Idea53101Service(Idea53101Config config) {
        this.config = config != null ? config : new Idea53101Config();
