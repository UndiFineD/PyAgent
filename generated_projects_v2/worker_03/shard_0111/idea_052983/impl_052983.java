...
@Data
public class Idea52983Config {
    private String name = "idea_052983";
 ...
 */
@Slf4j
public class Idea52983Service {
    private static final int IDEA_ID = 52983;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52983Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52983Service() {
        this(new Idea52983Config());
    }

    public Idea52983Service(Idea52983Config config) {
        this.config = config != null ? config : new Idea52983Config();
