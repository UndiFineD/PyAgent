...
@Data
public class Idea53197Config {
    private String name = "idea_053197";
 ...
 */
@Slf4j
public class Idea53197Service {
    private static final int IDEA_ID = 53197;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53197Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53197Service() {
        this(new Idea53197Config());
    }

    public Idea53197Service(Idea53197Config config) {
        this.config = config != null ? config : new Idea53197Config();
