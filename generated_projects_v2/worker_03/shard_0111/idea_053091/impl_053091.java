...
@Data
public class Idea53091Config {
    private String name = "idea_053091";
 ...
 */
@Slf4j
public class Idea53091Service {
    private static final int IDEA_ID = 53091;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53091Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53091Service() {
        this(new Idea53091Config());
    }

    public Idea53091Service(Idea53091Config config) {
        this.config = config != null ? config : new Idea53091Config();
