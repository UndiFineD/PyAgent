...
@Data
public class Idea52774Config {
    private String name = "idea_052774";
 ...
 */
@Slf4j
public class Idea52774Service {
    private static final int IDEA_ID = 52774;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52774Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52774Service() {
        this(new Idea52774Config());
    }

    public Idea52774Service(Idea52774Config config) {
        this.config = config != null ? config : new Idea52774Config();
