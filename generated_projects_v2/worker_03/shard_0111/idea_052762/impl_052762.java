...
@Data
public class Idea52762Config {
    private String name = "idea_052762";
 ...
 */
@Slf4j
public class Idea52762Service {
    private static final int IDEA_ID = 52762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52762Service() {
        this(new Idea52762Config());
    }

    public Idea52762Service(Idea52762Config config) {
        this.config = config != null ? config : new Idea52762Config();
