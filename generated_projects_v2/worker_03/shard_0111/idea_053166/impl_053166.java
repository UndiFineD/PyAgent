...
@Data
public class Idea53166Config {
    private String name = "idea_053166";
 ...
 */
@Slf4j
public class Idea53166Service {
    private static final int IDEA_ID = 53166;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53166Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53166Service() {
        this(new Idea53166Config());
    }

    public Idea53166Service(Idea53166Config config) {
        this.config = config != null ? config : new Idea53166Config();
