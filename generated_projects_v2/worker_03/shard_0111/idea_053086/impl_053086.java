...
@Data
public class Idea53086Config {
    private String name = "idea_053086";
 ...
 */
@Slf4j
public class Idea53086Service {
    private static final int IDEA_ID = 53086;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53086Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53086Service() {
        this(new Idea53086Config());
    }

    public Idea53086Service(Idea53086Config config) {
        this.config = config != null ? config : new Idea53086Config();
