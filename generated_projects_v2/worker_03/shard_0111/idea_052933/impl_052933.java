...
@Data
public class Idea52933Config {
    private String name = "idea_052933";
 ...
 */
@Slf4j
public class Idea52933Service {
    private static final int IDEA_ID = 52933;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52933Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52933Service() {
        this(new Idea52933Config());
    }

    public Idea52933Service(Idea52933Config config) {
        this.config = config != null ? config : new Idea52933Config();
