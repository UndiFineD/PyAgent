...
@Data
public class Idea53120Config {
    private String name = "idea_053120";
 ...
 */
@Slf4j
public class Idea53120Service {
    private static final int IDEA_ID = 53120;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53120Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53120Service() {
        this(new Idea53120Config());
    }

    public Idea53120Service(Idea53120Config config) {
        this.config = config != null ? config : new Idea53120Config();
