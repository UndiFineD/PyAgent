...
@Data
public class Idea52977Config {
    private String name = "idea_052977";
 ...
 */
@Slf4j
public class Idea52977Service {
    private static final int IDEA_ID = 52977;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52977Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52977Service() {
        this(new Idea52977Config());
    }

    public Idea52977Service(Idea52977Config config) {
        this.config = config != null ? config : new Idea52977Config();
