...
@Data
public class Idea52765Config {
    private String name = "idea_052765";
 ...
 */
@Slf4j
public class Idea52765Service {
    private static final int IDEA_ID = 52765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52765Service() {
        this(new Idea52765Config());
    }

    public Idea52765Service(Idea52765Config config) {
        this.config = config != null ? config : new Idea52765Config();
