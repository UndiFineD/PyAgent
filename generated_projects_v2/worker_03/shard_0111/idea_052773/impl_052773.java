...
@Data
public class Idea52773Config {
    private String name = "idea_052773";
 ...
 */
@Slf4j
public class Idea52773Service {
    private static final int IDEA_ID = 52773;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52773Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52773Service() {
        this(new Idea52773Config());
    }

    public Idea52773Service(Idea52773Config config) {
        this.config = config != null ? config : new Idea52773Config();
