...
@Data
public class Idea53107Config {
    private String name = "idea_053107";
 ...
 */
@Slf4j
public class Idea53107Service {
    private static final int IDEA_ID = 53107;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53107Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53107Service() {
        this(new Idea53107Config());
    }

    public Idea53107Service(Idea53107Config config) {
        this.config = config != null ? config : new Idea53107Config();
