...
@Data
public class Idea52935Config {
    private String name = "idea_052935";
 ...
 */
@Slf4j
public class Idea52935Service {
    private static final int IDEA_ID = 52935;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52935Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52935Service() {
        this(new Idea52935Config());
    }

    public Idea52935Service(Idea52935Config config) {
        this.config = config != null ? config : new Idea52935Config();
