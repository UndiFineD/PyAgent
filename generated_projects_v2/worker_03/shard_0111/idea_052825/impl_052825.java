...
@Data
public class Idea52825Config {
    private String name = "idea_052825";
 ...
 */
@Slf4j
public class Idea52825Service {
    private static final int IDEA_ID = 52825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52825Service() {
        this(new Idea52825Config());
    }

    public Idea52825Service(Idea52825Config config) {
        this.config = config != null ? config : new Idea52825Config();
