...
@Data
public class Idea53165Config {
    private String name = "idea_053165";
 ...
 */
@Slf4j
public class Idea53165Service {
    private static final int IDEA_ID = 53165;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53165Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53165Service() {
        this(new Idea53165Config());
    }

    public Idea53165Service(Idea53165Config config) {
        this.config = config != null ? config : new Idea53165Config();
