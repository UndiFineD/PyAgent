...
@Data
public class Idea53175Config {
    private String name = "idea_053175";
 ...
 */
@Slf4j
public class Idea53175Service {
    private static final int IDEA_ID = 53175;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53175Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53175Service() {
        this(new Idea53175Config());
    }

    public Idea53175Service(Idea53175Config config) {
        this.config = config != null ? config : new Idea53175Config();
