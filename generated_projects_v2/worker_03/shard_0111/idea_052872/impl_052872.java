...
@Data
public class Idea52872Config {
    private String name = "idea_052872";
 ...
 */
@Slf4j
public class Idea52872Service {
    private static final int IDEA_ID = 52872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52872Service() {
        this(new Idea52872Config());
    }

    public Idea52872Service(Idea52872Config config) {
        this.config = config != null ? config : new Idea52872Config();
