...
@Data
public class Idea53017Config {
    private String name = "idea_053017";
 ...
 */
@Slf4j
public class Idea53017Service {
    private static final int IDEA_ID = 53017;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53017Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53017Service() {
        this(new Idea53017Config());
    }

    public Idea53017Service(Idea53017Config config) {
        this.config = config != null ? config : new Idea53017Config();
