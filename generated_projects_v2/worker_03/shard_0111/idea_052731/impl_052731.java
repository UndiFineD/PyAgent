...
@Data
public class Idea52731Config {
    private String name = "idea_052731";
 ...
 */
@Slf4j
public class Idea52731Service {
    private static final int IDEA_ID = 52731;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52731Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52731Service() {
        this(new Idea52731Config());
    }

    public Idea52731Service(Idea52731Config config) {
        this.config = config != null ? config : new Idea52731Config();
