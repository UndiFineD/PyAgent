...
@Data
public class Idea53104Config {
    private String name = "idea_053104";
 ...
 */
@Slf4j
public class Idea53104Service {
    private static final int IDEA_ID = 53104;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53104Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53104Service() {
        this(new Idea53104Config());
    }

    public Idea53104Service(Idea53104Config config) {
        this.config = config != null ? config : new Idea53104Config();
