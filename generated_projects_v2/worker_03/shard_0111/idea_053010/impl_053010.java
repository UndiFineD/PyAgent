...
@Data
public class Idea53010Config {
    private String name = "idea_053010";
 ...
 */
@Slf4j
public class Idea53010Service {
    private static final int IDEA_ID = 53010;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53010Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53010Service() {
        this(new Idea53010Config());
    }

    public Idea53010Service(Idea53010Config config) {
        this.config = config != null ? config : new Idea53010Config();
