...
@Data
public class Idea52851Config {
    private String name = "idea_052851";
 ...
 */
@Slf4j
public class Idea52851Service {
    private static final int IDEA_ID = 52851;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52851Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52851Service() {
        this(new Idea52851Config());
    }

    public Idea52851Service(Idea52851Config config) {
        this.config = config != null ? config : new Idea52851Config();
