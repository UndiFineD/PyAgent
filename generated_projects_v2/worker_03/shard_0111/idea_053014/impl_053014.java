...
@Data
public class Idea53014Config {
    private String name = "idea_053014";
 ...
 */
@Slf4j
public class Idea53014Service {
    private static final int IDEA_ID = 53014;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53014Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53014Service() {
        this(new Idea53014Config());
    }

    public Idea53014Service(Idea53014Config config) {
        this.config = config != null ? config : new Idea53014Config();
