...
@Data
public class Idea52807Config {
    private String name = "idea_052807";
 ...
 */
@Slf4j
public class Idea52807Service {
    private static final int IDEA_ID = 52807;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52807Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52807Service() {
        this(new Idea52807Config());
    }

    public Idea52807Service(Idea52807Config config) {
        this.config = config != null ? config : new Idea52807Config();
