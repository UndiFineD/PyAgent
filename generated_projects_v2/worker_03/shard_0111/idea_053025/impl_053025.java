...
@Data
public class Idea53025Config {
    private String name = "idea_053025";
 ...
 */
@Slf4j
public class Idea53025Service {
    private static final int IDEA_ID = 53025;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53025Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53025Service() {
        this(new Idea53025Config());
    }

    public Idea53025Service(Idea53025Config config) {
        this.config = config != null ? config : new Idea53025Config();
