...
@Data
public class Idea52958Config {
    private String name = "idea_052958";
 ...
 */
@Slf4j
public class Idea52958Service {
    private static final int IDEA_ID = 52958;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52958Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52958Service() {
        this(new Idea52958Config());
    }

    public Idea52958Service(Idea52958Config config) {
        this.config = config != null ? config : new Idea52958Config();
