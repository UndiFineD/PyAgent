...
@Data
public class Idea52894Config {
    private String name = "idea_052894";
 ...
 */
@Slf4j
public class Idea52894Service {
    private static final int IDEA_ID = 52894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52894Service() {
        this(new Idea52894Config());
    }

    public Idea52894Service(Idea52894Config config) {
        this.config = config != null ? config : new Idea52894Config();
