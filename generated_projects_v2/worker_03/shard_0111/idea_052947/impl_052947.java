...
@Data
public class Idea52947Config {
    private String name = "idea_052947";
 ...
 */
@Slf4j
public class Idea52947Service {
    private static final int IDEA_ID = 52947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52947Service() {
        this(new Idea52947Config());
    }

    public Idea52947Service(Idea52947Config config) {
        this.config = config != null ? config : new Idea52947Config();
