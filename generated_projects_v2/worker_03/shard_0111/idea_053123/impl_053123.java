...
@Data
public class Idea53123Config {
    private String name = "idea_053123";
 ...
 */
@Slf4j
public class Idea53123Service {
    private static final int IDEA_ID = 53123;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53123Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53123Service() {
        this(new Idea53123Config());
    }

    public Idea53123Service(Idea53123Config config) {
        this.config = config != null ? config : new Idea53123Config();
