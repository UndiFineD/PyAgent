...
@Data
public class Idea53013Config {
    private String name = "idea_053013";
 ...
 */
@Slf4j
public class Idea53013Service {
    private static final int IDEA_ID = 53013;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53013Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53013Service() {
        this(new Idea53013Config());
    }

    public Idea53013Service(Idea53013Config config) {
        this.config = config != null ? config : new Idea53013Config();
