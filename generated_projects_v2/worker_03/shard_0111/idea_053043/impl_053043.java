...
@Data
public class Idea53043Config {
    private String name = "idea_053043";
 ...
 */
@Slf4j
public class Idea53043Service {
    private static final int IDEA_ID = 53043;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53043Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53043Service() {
        this(new Idea53043Config());
    }

    public Idea53043Service(Idea53043Config config) {
        this.config = config != null ? config : new Idea53043Config();
