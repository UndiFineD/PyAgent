...
@Data
public class Idea52905Config {
    private String name = "idea_052905";
 ...
 */
@Slf4j
public class Idea52905Service {
    private static final int IDEA_ID = 52905;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52905Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52905Service() {
        this(new Idea52905Config());
    }

    public Idea52905Service(Idea52905Config config) {
        this.config = config != null ? config : new Idea52905Config();
