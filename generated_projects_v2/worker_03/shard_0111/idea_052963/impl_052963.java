...
@Data
public class Idea52963Config {
    private String name = "idea_052963";
 ...
 */
@Slf4j
public class Idea52963Service {
    private static final int IDEA_ID = 52963;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52963Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52963Service() {
        this(new Idea52963Config());
    }

    public Idea52963Service(Idea52963Config config) {
        this.config = config != null ? config : new Idea52963Config();
