...
@Data
public class Idea52925Config {
    private String name = "idea_052925";
 ...
 */
@Slf4j
public class Idea52925Service {
    private static final int IDEA_ID = 52925;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52925Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52925Service() {
        this(new Idea52925Config());
    }

    public Idea52925Service(Idea52925Config config) {
        this.config = config != null ? config : new Idea52925Config();
