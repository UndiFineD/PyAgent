...
@Data
public class Idea52990Config {
    private String name = "idea_052990";
 ...
 */
@Slf4j
public class Idea52990Service {
    private static final int IDEA_ID = 52990;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52990Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52990Service() {
        this(new Idea52990Config());
    }

    public Idea52990Service(Idea52990Config config) {
        this.config = config != null ? config : new Idea52990Config();
