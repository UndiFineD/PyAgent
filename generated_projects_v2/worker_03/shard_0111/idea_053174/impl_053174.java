...
@Data
public class Idea53174Config {
    private String name = "idea_053174";
 ...
 */
@Slf4j
public class Idea53174Service {
    private static final int IDEA_ID = 53174;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53174Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53174Service() {
        this(new Idea53174Config());
    }

    public Idea53174Service(Idea53174Config config) {
        this.config = config != null ? config : new Idea53174Config();
