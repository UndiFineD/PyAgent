...
@Data
public class Idea53136Config {
    private String name = "idea_053136";
 ...
 */
@Slf4j
public class Idea53136Service {
    private static final int IDEA_ID = 53136;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53136Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53136Service() {
        this(new Idea53136Config());
    }

    public Idea53136Service(Idea53136Config config) {
        this.config = config != null ? config : new Idea53136Config();
