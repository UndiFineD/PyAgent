...
@Data
public class Idea52987Config {
    private String name = "idea_052987";
 ...
 */
@Slf4j
public class Idea52987Service {
    private static final int IDEA_ID = 52987;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52987Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52987Service() {
        this(new Idea52987Config());
    }

    public Idea52987Service(Idea52987Config config) {
        this.config = config != null ? config : new Idea52987Config();
