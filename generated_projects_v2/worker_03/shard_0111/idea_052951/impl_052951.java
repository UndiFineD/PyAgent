...
@Data
public class Idea52951Config {
    private String name = "idea_052951";
 ...
 */
@Slf4j
public class Idea52951Service {
    private static final int IDEA_ID = 52951;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52951Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52951Service() {
        this(new Idea52951Config());
    }

    public Idea52951Service(Idea52951Config config) {
        this.config = config != null ? config : new Idea52951Config();
