...
@Data
public class Idea53126Config {
    private String name = "idea_053126";
 ...
 */
@Slf4j
public class Idea53126Service {
    private static final int IDEA_ID = 53126;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53126Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53126Service() {
        this(new Idea53126Config());
    }

    public Idea53126Service(Idea53126Config config) {
        this.config = config != null ? config : new Idea53126Config();
