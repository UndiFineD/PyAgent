...
@Data
public class Idea52771Config {
    private String name = "idea_052771";
 ...
 */
@Slf4j
public class Idea52771Service {
    private static final int IDEA_ID = 52771;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52771Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52771Service() {
        this(new Idea52771Config());
    }

    public Idea52771Service(Idea52771Config config) {
        this.config = config != null ? config : new Idea52771Config();
