...
@Data
public class Idea53193Config {
    private String name = "idea_053193";
 ...
 */
@Slf4j
public class Idea53193Service {
    private static final int IDEA_ID = 53193;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53193Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53193Service() {
        this(new Idea53193Config());
    }

    public Idea53193Service(Idea53193Config config) {
        this.config = config != null ? config : new Idea53193Config();
