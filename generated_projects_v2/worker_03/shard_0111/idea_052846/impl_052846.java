...
@Data
public class Idea52846Config {
    private String name = "idea_052846";
 ...
 */
@Slf4j
public class Idea52846Service {
    private static final int IDEA_ID = 52846;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52846Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52846Service() {
        this(new Idea52846Config());
    }

    public Idea52846Service(Idea52846Config config) {
        this.config = config != null ? config : new Idea52846Config();
