...
@Data
public class Idea52972Config {
    private String name = "idea_052972";
 ...
 */
@Slf4j
public class Idea52972Service {
    private static final int IDEA_ID = 52972;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52972Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52972Service() {
        this(new Idea52972Config());
    }

    public Idea52972Service(Idea52972Config config) {
        this.config = config != null ? config : new Idea52972Config();
