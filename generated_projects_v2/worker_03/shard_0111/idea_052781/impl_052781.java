...
@Data
public class Idea52781Config {
    private String name = "idea_052781";
 ...
 */
@Slf4j
public class Idea52781Service {
    private static final int IDEA_ID = 52781;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52781Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52781Service() {
        this(new Idea52781Config());
    }

    public Idea52781Service(Idea52781Config config) {
        this.config = config != null ? config : new Idea52781Config();
