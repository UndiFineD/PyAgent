...
@Data
public class Idea53023Config {
    private String name = "idea_053023";
 ...
 */
@Slf4j
public class Idea53023Service {
    private static final int IDEA_ID = 53023;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea53023Config config;
    private final Map<String, ProcessResult> cache;

    public Idea53023Service() {
        this(new Idea53023Config());
    }

    public Idea53023Service(Idea53023Config config) {
        this.config = config != null ? config : new Idea53023Config();
