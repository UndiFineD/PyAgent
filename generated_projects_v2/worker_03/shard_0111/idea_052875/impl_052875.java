...
@Data
public class Idea52875Config {
    private String name = "idea_052875";
 ...
 */
@Slf4j
public class Idea52875Service {
    private static final int IDEA_ID = 52875;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52875Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52875Service() {
        this(new Idea52875Config());
    }

    public Idea52875Service(Idea52875Config config) {
        this.config = config != null ? config : new Idea52875Config();
