...
@Data
public class Idea52911Config {
    private String name = "idea_052911";
 ...
 */
@Slf4j
public class Idea52911Service {
    private static final int IDEA_ID = 52911;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52911Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52911Service() {
        this(new Idea52911Config());
    }

    public Idea52911Service(Idea52911Config config) {
        this.config = config != null ? config : new Idea52911Config();
