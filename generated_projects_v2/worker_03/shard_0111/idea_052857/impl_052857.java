...
@Data
public class Idea52857Config {
    private String name = "idea_052857";
 ...
 */
@Slf4j
public class Idea52857Service {
    private static final int IDEA_ID = 52857;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52857Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52857Service() {
        this(new Idea52857Config());
    }

    public Idea52857Service(Idea52857Config config) {
        this.config = config != null ? config : new Idea52857Config();
