...
@Data
public class Idea52989Config {
    private String name = "idea_052989";
 ...
 */
@Slf4j
public class Idea52989Service {
    private static final int IDEA_ID = 52989;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52989Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52989Service() {
        this(new Idea52989Config());
    }

    public Idea52989Service(Idea52989Config config) {
        this.config = config != null ? config : new Idea52989Config();
