...
@Data
public class Idea52893Config {
    private String name = "idea_052893";
 ...
 */
@Slf4j
public class Idea52893Service {
    private static final int IDEA_ID = 52893;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea52893Config config;
    private final Map<String, ProcessResult> cache;

    public Idea52893Service() {
        this(new Idea52893Config());
    }

    public Idea52893Service(Idea52893Config config) {
        this.config = config != null ? config : new Idea52893Config();
