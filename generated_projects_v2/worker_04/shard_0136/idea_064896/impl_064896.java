...
@Data
public class Idea64896Config {
    private String name = "idea_064896";
 ...
 */
@Slf4j
public class Idea64896Service {
    private static final int IDEA_ID = 64896;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64896Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64896Service() {
        this(new Idea64896Config());
    }

    public Idea64896Service(Idea64896Config config) {
        this.config = config != null ? config : new Idea64896Config();
