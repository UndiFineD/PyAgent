...
@Data
public class Idea64668Config {
    private String name = "idea_064668";
 ...
 */
@Slf4j
public class Idea64668Service {
    private static final int IDEA_ID = 64668;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64668Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64668Service() {
        this(new Idea64668Config());
    }

    public Idea64668Service(Idea64668Config config) {
        this.config = config != null ? config : new Idea64668Config();
