...
@Data
public class Idea65028Config {
    private String name = "idea_065028";
 ...
 */
@Slf4j
public class Idea65028Service {
    private static final int IDEA_ID = 65028;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65028Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65028Service() {
        this(new Idea65028Config());
    }

    public Idea65028Service(Idea65028Config config) {
        this.config = config != null ? config : new Idea65028Config();
