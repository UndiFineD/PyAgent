...
@Data
public class Idea64745Config {
    private String name = "idea_064745";
 ...
 */
@Slf4j
public class Idea64745Service {
    private static final int IDEA_ID = 64745;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64745Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64745Service() {
        this(new Idea64745Config());
    }

    public Idea64745Service(Idea64745Config config) {
        this.config = config != null ? config : new Idea64745Config();
