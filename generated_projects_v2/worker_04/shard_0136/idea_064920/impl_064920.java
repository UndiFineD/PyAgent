...
@Data
public class Idea64920Config {
    private String name = "idea_064920";
 ...
 */
@Slf4j
public class Idea64920Service {
    private static final int IDEA_ID = 64920;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64920Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64920Service() {
        this(new Idea64920Config());
    }

    public Idea64920Service(Idea64920Config config) {
        this.config = config != null ? config : new Idea64920Config();
