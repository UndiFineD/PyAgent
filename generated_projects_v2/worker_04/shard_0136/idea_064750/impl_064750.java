...
@Data
public class Idea64750Config {
    private String name = "idea_064750";
 ...
 */
@Slf4j
public class Idea64750Service {
    private static final int IDEA_ID = 64750;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64750Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64750Service() {
        this(new Idea64750Config());
    }

    public Idea64750Service(Idea64750Config config) {
        this.config = config != null ? config : new Idea64750Config();
