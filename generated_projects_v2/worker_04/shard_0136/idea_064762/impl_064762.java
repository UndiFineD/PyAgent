...
@Data
public class Idea64762Config {
    private String name = "idea_064762";
 ...
 */
@Slf4j
public class Idea64762Service {
    private static final int IDEA_ID = 64762;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64762Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64762Service() {
        this(new Idea64762Config());
    }

    public Idea64762Service(Idea64762Config config) {
        this.config = config != null ? config : new Idea64762Config();
