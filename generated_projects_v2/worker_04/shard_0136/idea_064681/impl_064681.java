...
@Data
public class Idea64681Config {
    private String name = "idea_064681";
 ...
 */
@Slf4j
public class Idea64681Service {
    private static final int IDEA_ID = 64681;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64681Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64681Service() {
        this(new Idea64681Config());
    }

    public Idea64681Service(Idea64681Config config) {
        this.config = config != null ? config : new Idea64681Config();
