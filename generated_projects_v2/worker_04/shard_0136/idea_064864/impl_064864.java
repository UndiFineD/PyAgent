...
@Data
public class Idea64864Config {
    private String name = "idea_064864";
 ...
 */
@Slf4j
public class Idea64864Service {
    private static final int IDEA_ID = 64864;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64864Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64864Service() {
        this(new Idea64864Config());
    }

    public Idea64864Service(Idea64864Config config) {
        this.config = config != null ? config : new Idea64864Config();
