...
@Data
public class Idea64943Config {
    private String name = "idea_064943";
 ...
 */
@Slf4j
public class Idea64943Service {
    private static final int IDEA_ID = 64943;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64943Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64943Service() {
        this(new Idea64943Config());
    }

    public Idea64943Service(Idea64943Config config) {
        this.config = config != null ? config : new Idea64943Config();
