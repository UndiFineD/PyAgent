...
@Data
public class Idea64885Config {
    private String name = "idea_064885";
 ...
 */
@Slf4j
public class Idea64885Service {
    private static final int IDEA_ID = 64885;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64885Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64885Service() {
        this(new Idea64885Config());
    }

    public Idea64885Service(Idea64885Config config) {
        this.config = config != null ? config : new Idea64885Config();
