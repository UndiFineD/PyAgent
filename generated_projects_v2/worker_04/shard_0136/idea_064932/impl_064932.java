...
@Data
public class Idea64932Config {
    private String name = "idea_064932";
 ...
 */
@Slf4j
public class Idea64932Service {
    private static final int IDEA_ID = 64932;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64932Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64932Service() {
        this(new Idea64932Config());
    }

    public Idea64932Service(Idea64932Config config) {
        this.config = config != null ? config : new Idea64932Config();
