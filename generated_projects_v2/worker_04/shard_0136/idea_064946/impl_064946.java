...
@Data
public class Idea64946Config {
    private String name = "idea_064946";
 ...
 */
@Slf4j
public class Idea64946Service {
    private static final int IDEA_ID = 64946;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64946Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64946Service() {
        this(new Idea64946Config());
    }

    public Idea64946Service(Idea64946Config config) {
        this.config = config != null ? config : new Idea64946Config();
