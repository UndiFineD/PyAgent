...
@Data
public class Idea64976Config {
    private String name = "idea_064976";
 ...
 */
@Slf4j
public class Idea64976Service {
    private static final int IDEA_ID = 64976;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64976Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64976Service() {
        this(new Idea64976Config());
    }

    public Idea64976Service(Idea64976Config config) {
        this.config = config != null ? config : new Idea64976Config();
