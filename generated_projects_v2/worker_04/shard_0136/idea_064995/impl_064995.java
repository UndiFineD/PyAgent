...
@Data
public class Idea64995Config {
    private String name = "idea_064995";
 ...
 */
@Slf4j
public class Idea64995Service {
    private static final int IDEA_ID = 64995;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64995Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64995Service() {
        this(new Idea64995Config());
    }

    public Idea64995Service(Idea64995Config config) {
        this.config = config != null ? config : new Idea64995Config();
