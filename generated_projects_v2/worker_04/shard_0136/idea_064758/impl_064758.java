...
@Data
public class Idea64758Config {
    private String name = "idea_064758";
 ...
 */
@Slf4j
public class Idea64758Service {
    private static final int IDEA_ID = 64758;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64758Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64758Service() {
        this(new Idea64758Config());
    }

    public Idea64758Service(Idea64758Config config) {
        this.config = config != null ? config : new Idea64758Config();
