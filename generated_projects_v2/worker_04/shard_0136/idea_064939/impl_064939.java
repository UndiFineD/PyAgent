...
@Data
public class Idea64939Config {
    private String name = "idea_064939";
 ...
 */
@Slf4j
public class Idea64939Service {
    private static final int IDEA_ID = 64939;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64939Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64939Service() {
        this(new Idea64939Config());
    }

    public Idea64939Service(Idea64939Config config) {
        this.config = config != null ? config : new Idea64939Config();
