...
@Data
public class Idea64947Config {
    private String name = "idea_064947";
 ...
 */
@Slf4j
public class Idea64947Service {
    private static final int IDEA_ID = 64947;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64947Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64947Service() {
        this(new Idea64947Config());
    }

    public Idea64947Service(Idea64947Config config) {
        this.config = config != null ? config : new Idea64947Config();
