...
@Data
public class Idea64756Config {
    private String name = "idea_064756";
 ...
 */
@Slf4j
public class Idea64756Service {
    private static final int IDEA_ID = 64756;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64756Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64756Service() {
        this(new Idea64756Config());
    }

    public Idea64756Service(Idea64756Config config) {
        this.config = config != null ? config : new Idea64756Config();
