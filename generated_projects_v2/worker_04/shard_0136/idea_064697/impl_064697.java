...
@Data
public class Idea64697Config {
    private String name = "idea_064697";
 ...
 */
@Slf4j
public class Idea64697Service {
    private static final int IDEA_ID = 64697;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64697Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64697Service() {
        this(new Idea64697Config());
    }

    public Idea64697Service(Idea64697Config config) {
        this.config = config != null ? config : new Idea64697Config();
