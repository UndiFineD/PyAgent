...
@Data
public class Idea64919Config {
    private String name = "idea_064919";
 ...
 */
@Slf4j
public class Idea64919Service {
    private static final int IDEA_ID = 64919;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64919Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64919Service() {
        this(new Idea64919Config());
    }

    public Idea64919Service(Idea64919Config config) {
        this.config = config != null ? config : new Idea64919Config();
