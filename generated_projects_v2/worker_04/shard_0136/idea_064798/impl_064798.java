...
@Data
public class Idea64798Config {
    private String name = "idea_064798";
 ...
 */
@Slf4j
public class Idea64798Service {
    private static final int IDEA_ID = 64798;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64798Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64798Service() {
        this(new Idea64798Config());
    }

    public Idea64798Service(Idea64798Config config) {
        this.config = config != null ? config : new Idea64798Config();
