...
@Data
public class Idea64619Config {
    private String name = "idea_064619";
 ...
 */
@Slf4j
public class Idea64619Service {
    private static final int IDEA_ID = 64619;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64619Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64619Service() {
        this(new Idea64619Config());
    }

    public Idea64619Service(Idea64619Config config) {
        this.config = config != null ? config : new Idea64619Config();
