...
@Data
public class Idea64904Config {
    private String name = "idea_064904";
 ...
 */
@Slf4j
public class Idea64904Service {
    private static final int IDEA_ID = 64904;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64904Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64904Service() {
        this(new Idea64904Config());
    }

    public Idea64904Service(Idea64904Config config) {
        this.config = config != null ? config : new Idea64904Config();
