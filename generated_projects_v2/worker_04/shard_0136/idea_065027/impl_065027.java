...
@Data
public class Idea65027Config {
    private String name = "idea_065027";
 ...
 */
@Slf4j
public class Idea65027Service {
    private static final int IDEA_ID = 65027;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65027Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65027Service() {
        this(new Idea65027Config());
    }

    public Idea65027Service(Idea65027Config config) {
        this.config = config != null ? config : new Idea65027Config();
