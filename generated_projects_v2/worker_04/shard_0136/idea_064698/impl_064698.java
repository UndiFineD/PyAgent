...
@Data
public class Idea64698Config {
    private String name = "idea_064698";
 ...
 */
@Slf4j
public class Idea64698Service {
    private static final int IDEA_ID = 64698;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64698Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64698Service() {
        this(new Idea64698Config());
    }

    public Idea64698Service(Idea64698Config config) {
        this.config = config != null ? config : new Idea64698Config();
