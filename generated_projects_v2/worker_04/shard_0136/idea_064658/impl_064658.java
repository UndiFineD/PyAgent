...
@Data
public class Idea64658Config {
    private String name = "idea_064658";
 ...
 */
@Slf4j
public class Idea64658Service {
    private static final int IDEA_ID = 64658;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64658Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64658Service() {
        this(new Idea64658Config());
    }

    public Idea64658Service(Idea64658Config config) {
        this.config = config != null ? config : new Idea64658Config();
