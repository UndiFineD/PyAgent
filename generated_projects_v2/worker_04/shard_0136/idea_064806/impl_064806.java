...
@Data
public class Idea64806Config {
    private String name = "idea_064806";
 ...
 */
@Slf4j
public class Idea64806Service {
    private static final int IDEA_ID = 64806;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64806Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64806Service() {
        this(new Idea64806Config());
    }

    public Idea64806Service(Idea64806Config config) {
        this.config = config != null ? config : new Idea64806Config();
