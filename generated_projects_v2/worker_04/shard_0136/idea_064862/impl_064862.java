...
@Data
public class Idea64862Config {
    private String name = "idea_064862";
 ...
 */
@Slf4j
public class Idea64862Service {
    private static final int IDEA_ID = 64862;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64862Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64862Service() {
        this(new Idea64862Config());
    }

    public Idea64862Service(Idea64862Config config) {
        this.config = config != null ? config : new Idea64862Config();
