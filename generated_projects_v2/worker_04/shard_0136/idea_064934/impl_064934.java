...
@Data
public class Idea64934Config {
    private String name = "idea_064934";
 ...
 */
@Slf4j
public class Idea64934Service {
    private static final int IDEA_ID = 64934;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64934Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64934Service() {
        this(new Idea64934Config());
    }

    public Idea64934Service(Idea64934Config config) {
        this.config = config != null ? config : new Idea64934Config();
