...
@Data
public class Idea64872Config {
    private String name = "idea_064872";
 ...
 */
@Slf4j
public class Idea64872Service {
    private static final int IDEA_ID = 64872;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64872Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64872Service() {
        this(new Idea64872Config());
    }

    public Idea64872Service(Idea64872Config config) {
        this.config = config != null ? config : new Idea64872Config();
