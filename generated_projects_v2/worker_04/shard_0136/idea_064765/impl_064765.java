...
@Data
public class Idea64765Config {
    private String name = "idea_064765";
 ...
 */
@Slf4j
public class Idea64765Service {
    private static final int IDEA_ID = 64765;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64765Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64765Service() {
        this(new Idea64765Config());
    }

    public Idea64765Service(Idea64765Config config) {
        this.config = config != null ? config : new Idea64765Config();
