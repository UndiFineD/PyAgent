...
@Data
public class Idea64991Config {
    private String name = "idea_064991";
 ...
 */
@Slf4j
public class Idea64991Service {
    private static final int IDEA_ID = 64991;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64991Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64991Service() {
        this(new Idea64991Config());
    }

    public Idea64991Service(Idea64991Config config) {
        this.config = config != null ? config : new Idea64991Config();
