...
@Data
public class Idea64863Config {
    private String name = "idea_064863";
 ...
 */
@Slf4j
public class Idea64863Service {
    private static final int IDEA_ID = 64863;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64863Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64863Service() {
        this(new Idea64863Config());
    }

    public Idea64863Service(Idea64863Config config) {
        this.config = config != null ? config : new Idea64863Config();
