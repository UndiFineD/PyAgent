...
@Data
public class Idea64868Config {
    private String name = "idea_064868";
 ...
 */
@Slf4j
public class Idea64868Service {
    private static final int IDEA_ID = 64868;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64868Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64868Service() {
        this(new Idea64868Config());
    }

    public Idea64868Service(Idea64868Config config) {
        this.config = config != null ? config : new Idea64868Config();
