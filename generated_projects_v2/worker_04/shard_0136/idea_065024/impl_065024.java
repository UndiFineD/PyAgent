...
@Data
public class Idea65024Config {
    private String name = "idea_065024";
 ...
 */
@Slf4j
public class Idea65024Service {
    private static final int IDEA_ID = 65024;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65024Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65024Service() {
        this(new Idea65024Config());
    }

    public Idea65024Service(Idea65024Config config) {
        this.config = config != null ? config : new Idea65024Config();
