...
@Data
public class Idea65018Config {
    private String name = "idea_065018";
 ...
 */
@Slf4j
public class Idea65018Service {
    private static final int IDEA_ID = 65018;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65018Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65018Service() {
        this(new Idea65018Config());
    }

    public Idea65018Service(Idea65018Config config) {
        this.config = config != null ? config : new Idea65018Config();
