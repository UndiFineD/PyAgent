...
@Data
public class Idea64949Config {
    private String name = "idea_064949";
 ...
 */
@Slf4j
public class Idea64949Service {
    private static final int IDEA_ID = 64949;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64949Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64949Service() {
        this(new Idea64949Config());
    }

    public Idea64949Service(Idea64949Config config) {
        this.config = config != null ? config : new Idea64949Config();
