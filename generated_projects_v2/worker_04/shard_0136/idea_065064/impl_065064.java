...
@Data
public class Idea65064Config {
    private String name = "idea_065064";
 ...
 */
@Slf4j
public class Idea65064Service {
    private static final int IDEA_ID = 65064;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65064Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65064Service() {
        this(new Idea65064Config());
    }

    public Idea65064Service(Idea65064Config config) {
        this.config = config != null ? config : new Idea65064Config();
