...
@Data
public class Idea64861Config {
    private String name = "idea_064861";
 ...
 */
@Slf4j
public class Idea64861Service {
    private static final int IDEA_ID = 64861;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64861Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64861Service() {
        this(new Idea64861Config());
    }

    public Idea64861Service(Idea64861Config config) {
        this.config = config != null ? config : new Idea64861Config();
