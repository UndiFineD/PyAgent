...
@Data
public class Idea64836Config {
    private String name = "idea_064836";
 ...
 */
@Slf4j
public class Idea64836Service {
    private static final int IDEA_ID = 64836;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64836Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64836Service() {
        this(new Idea64836Config());
    }

    public Idea64836Service(Idea64836Config config) {
        this.config = config != null ? config : new Idea64836Config();
