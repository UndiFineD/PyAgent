...
@Data
public class Idea64792Config {
    private String name = "idea_064792";
 ...
 */
@Slf4j
public class Idea64792Service {
    private static final int IDEA_ID = 64792;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64792Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64792Service() {
        this(new Idea64792Config());
    }

    public Idea64792Service(Idea64792Config config) {
        this.config = config != null ? config : new Idea64792Config();
