...
@Data
public class Idea64746Config {
    private String name = "idea_064746";
 ...
 */
@Slf4j
public class Idea64746Service {
    private static final int IDEA_ID = 64746;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64746Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64746Service() {
        this(new Idea64746Config());
    }

    public Idea64746Service(Idea64746Config config) {
        this.config = config != null ? config : new Idea64746Config();
