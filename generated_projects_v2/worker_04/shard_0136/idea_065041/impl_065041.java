...
@Data
public class Idea65041Config {
    private String name = "idea_065041";
 ...
 */
@Slf4j
public class Idea65041Service {
    private static final int IDEA_ID = 65041;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea65041Config config;
    private final Map<String, ProcessResult> cache;

    public Idea65041Service() {
        this(new Idea65041Config());
    }

    public Idea65041Service(Idea65041Config config) {
        this.config = config != null ? config : new Idea65041Config();
