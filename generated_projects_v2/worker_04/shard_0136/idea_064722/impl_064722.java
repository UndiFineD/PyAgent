...
@Data
public class Idea64722Config {
    private String name = "idea_064722";
 ...
 */
@Slf4j
public class Idea64722Service {
    private static final int IDEA_ID = 64722;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64722Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64722Service() {
        this(new Idea64722Config());
    }

    public Idea64722Service(Idea64722Config config) {
        this.config = config != null ? config : new Idea64722Config();
