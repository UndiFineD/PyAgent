...
@Data
public class Idea64897Config {
    private String name = "idea_064897";
 ...
 */
@Slf4j
public class Idea64897Service {
    private static final int IDEA_ID = 64897;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64897Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64897Service() {
        this(new Idea64897Config());
    }

    public Idea64897Service(Idea64897Config config) {
        this.config = config != null ? config : new Idea64897Config();
