...
@Data
public class Idea64888Config {
    private String name = "idea_064888";
 ...
 */
@Slf4j
public class Idea64888Service {
    private static final int IDEA_ID = 64888;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64888Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64888Service() {
        this(new Idea64888Config());
    }

    public Idea64888Service(Idea64888Config config) {
        this.config = config != null ? config : new Idea64888Config();
