...
@Data
public class Idea64894Config {
    private String name = "idea_064894";
 ...
 */
@Slf4j
public class Idea64894Service {
    private static final int IDEA_ID = 64894;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64894Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64894Service() {
        this(new Idea64894Config());
    }

    public Idea64894Service(Idea64894Config config) {
        this.config = config != null ? config : new Idea64894Config();
