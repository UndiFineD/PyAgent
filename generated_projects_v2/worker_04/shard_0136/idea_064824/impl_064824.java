...
@Data
public class Idea64824Config {
    private String name = "idea_064824";
 ...
 */
@Slf4j
public class Idea64824Service {
    private static final int IDEA_ID = 64824;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64824Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64824Service() {
        this(new Idea64824Config());
    }

    public Idea64824Service(Idea64824Config config) {
        this.config = config != null ? config : new Idea64824Config();
