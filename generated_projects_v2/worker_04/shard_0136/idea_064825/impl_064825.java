...
@Data
public class Idea64825Config {
    private String name = "idea_064825";
 ...
 */
@Slf4j
public class Idea64825Service {
    private static final int IDEA_ID = 64825;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64825Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64825Service() {
        this(new Idea64825Config());
    }

    public Idea64825Service(Idea64825Config config) {
        this.config = config != null ? config : new Idea64825Config();
