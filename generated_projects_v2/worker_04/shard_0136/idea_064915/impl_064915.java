...
@Data
public class Idea64915Config {
    private String name = "idea_064915";
 ...
 */
@Slf4j
public class Idea64915Service {
    private static final int IDEA_ID = 64915;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64915Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64915Service() {
        this(new Idea64915Config());
    }

    public Idea64915Service(Idea64915Config config) {
        this.config = config != null ? config : new Idea64915Config();
