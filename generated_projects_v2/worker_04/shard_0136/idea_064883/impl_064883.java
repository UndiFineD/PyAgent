...
@Data
public class Idea64883Config {
    private String name = "idea_064883";
 ...
 */
@Slf4j
public class Idea64883Service {
    private static final int IDEA_ID = 64883;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64883Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64883Service() {
        this(new Idea64883Config());
    }

    public Idea64883Service(Idea64883Config config) {
        this.config = config != null ? config : new Idea64883Config();
