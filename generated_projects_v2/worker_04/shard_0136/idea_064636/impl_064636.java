...
@Data
public class Idea64636Config {
    private String name = "idea_064636";
 ...
 */
@Slf4j
public class Idea64636Service {
    private static final int IDEA_ID = 64636;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64636Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64636Service() {
        this(new Idea64636Config());
    }

    public Idea64636Service(Idea64636Config config) {
        this.config = config != null ? config : new Idea64636Config();
