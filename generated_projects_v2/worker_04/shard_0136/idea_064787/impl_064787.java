...
@Data
public class Idea64787Config {
    private String name = "idea_064787";
 ...
 */
@Slf4j
public class Idea64787Service {
    private static final int IDEA_ID = 64787;
    private static final String CATEGORY = "backend";
    private static final String VERSION = "2.0.0";
    
    private final Idea64787Config config;
    private final Map<String, ProcessResult> cache;

    public Idea64787Service() {
        this(new Idea64787Config());
    }

    public Idea64787Service(Idea64787Config config) {
        this.config = config != null ? config : new Idea64787Config();
